...
#define CLASS_2_94811C93AE1B5EAC_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1107EEE0)
#define CLASS_2_94811C93AE1B5EAC_METHOD_2_1EB419DA7BAA94D4_OFFSET UNITYSDK_OFFSET(0x1107F010)
#define CLASS_2_94811C93AE1B5EAC_METHOD_2_96BDC4B57CCFE000_OFFSET UNITYSDK_OFFSET(0x1107EF20)
#define CLASS_2_94811C93AE1B5EAC_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1107ECD0)
#define CLASS_2_94811C93AE1B5EAC_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1107EE20)
#define CLASS_2_94811C93AE1B5EAC_TICK_OFFSET UNITYSDK_OFFSET(0x1107EE70)
#define CLASS_2_94811C93AE1B5EAC__CTOR_OFFSET UNITYSDK_OFFSET(0x1107EED0)

inline static constexpr unsigned int Class_2_94811C93AE1B5EAC_TypeDefinitionIndex = 46392;
