...
#define MARBLETRANSFORMANIMATIONHANDLE_ANIMRESET_OFFSET UNITYSDK_OFFSET(0x88C5B70)
#define MARBLETRANSFORMANIMATIONHANDLE_ANIMSTOPPLAYING_OFFSET UNITYSDK_OFFSET(0x88C3680)
#define MARBLETRANSFORMANIMATIONHANDLE_BEGINTESTANIM_OFFSET UNITYSDK_OFFSET(0x88C4930)
#define MARBLETRANSFORMANIMATIONHANDLE_BREAKACITVEANIMLOOP_OFFSET UNITYSDK_OFFSET(0x88C5100)
#define MARBLETRANSFORMANIMATIONHANDLE_CHECKANIMPLAYING_1_OFFSET UNITYSDK_OFFSET(0x88C5DB0)
#define MARBLETRANSFORMANIMATIONHANDLE_CHECKANIMPLAYING_OFFSET UNITYSDK_OFFSET(0x88C5D70)
#define MARBLETRANSFORMANIMATIONHANDLE_FINDPOINT_OFFSET UNITYSDK_OFFSET(0x88C47A0)
#define MARBLETRANSFORMANIMATIONHANDLE_INIT_OFFSET UNITYSDK_OFFSET(0x88C2CE0)
#define MARBLETRANSFORMANIMATIONHANDLE_LOOPBREAKTEST_OFFSET UNITYSDK_OFFSET(0x88C50B0)
#define MARBLETRANSFORMANIMATIONHANDLE_METHOD_5_1B59628C129E32A4_OFFSET UNITYSDK_OFFSET(0x88C49C0)
#define MARBLETRANSFORMANIMATIONHANDLE_METHOD_5_289F28027FF47717_OFFSET UNITYSDK_OFFSET(0x88C4030)
#define MARBLETRANSFORMANIMATIONHANDLE_METHOD_5_67902373518EC18A_OFFSET UNITYSDK_OFFSET(0x88C5260)
#define MARBLETRANSFORMANIMATIONHANDLE_METHOD_5_773796562D326B0E_OFFSET UNITYSDK_OFFSET(0x88C4520)
#define MARBLETRANSFORMANIMATIONHANDLE_METHOD_5_998A9DD028E004C0_OFFSET UNITYSDK_OFFSET(0x88C6010)
#define MARBLETRANSFORMANIMATIONHANDLE_METHOD_5_BA5CD3C0B7AB5DDD_OFFSET UNITYSDK_OFFSET(0x88C36D0)
#define MARBLETRANSFORMANIMATIONHANDLE_METHOD_5_C0AC14CF94069BDD_OFFSET UNITYSDK_OFFSET(0x88C5E10)
#define MARBLETRANSFORMANIMATIONHANDLE_METHOD_5_C920746CFBA5989E_OFFSET UNITYSDK_OFFSET(0x88C54C0)
#define MARBLETRANSFORMANIMATIONHANDLE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x88C6740)
#define MARBLETRANSFORMANIMATIONHANDLE_START_OFFSET UNITYSDK_OFFSET(0x88C2C90)
#define MARBLETRANSFORMANIMATIONHANDLE_TRIGGERTRANSFORMANIMATION_1_OFFSET UNITYSDK_OFFSET(0x88C5430)
#define MARBLETRANSFORMANIMATIONHANDLE_TRIGGERTRANSFORMANIMATION_2_OFFSET UNITYSDK_OFFSET(0x88C6590)
#define MARBLETRANSFORMANIMATIONHANDLE_TRIGGERTRANSFORMANIMATION_OFFSET UNITYSDK_OFFSET(0x88C53C0)
#define MARBLETRANSFORMANIMATIONHANDLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x88C2F50)
#define MARBLETRANSFORMANIMATIONHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x88C6A00)
