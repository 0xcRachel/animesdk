...
#define MARBLETRANSFORMANIMATIONHANDLE_ANIMRESET_OFFSET UNITYSDK_OFFSET(0xEE6A5F0)
#define MARBLETRANSFORMANIMATIONHANDLE_ANIMSTOPPLAYING_OFFSET UNITYSDK_OFFSET(0xEE680F0)
#define MARBLETRANSFORMANIMATIONHANDLE_BEGINTESTANIM_OFFSET UNITYSDK_OFFSET(0xEE693A0)
#define MARBLETRANSFORMANIMATIONHANDLE_BREAKACITVEANIMLOOP_OFFSET UNITYSDK_OFFSET(0xEE69B80)
#define MARBLETRANSFORMANIMATIONHANDLE_CHECKANIMPLAYING_1_OFFSET UNITYSDK_OFFSET(0xEE6A830)
#define MARBLETRANSFORMANIMATIONHANDLE_CHECKANIMPLAYING_OFFSET UNITYSDK_OFFSET(0xEE6A7F0)
#define MARBLETRANSFORMANIMATIONHANDLE_FINDPOINT_OFFSET UNITYSDK_OFFSET(0xEE69210)
#define MARBLETRANSFORMANIMATIONHANDLE_INIT_OFFSET UNITYSDK_OFFSET(0xEE67750)
#define MARBLETRANSFORMANIMATIONHANDLE_LOOPBREAKTEST_OFFSET UNITYSDK_OFFSET(0xEE69B30)
#define MARBLETRANSFORMANIMATIONHANDLE_METHOD_5_1B59628C129E32A4_OFFSET UNITYSDK_OFFSET(0xEE69430)
#define MARBLETRANSFORMANIMATIONHANDLE_METHOD_5_289F28027FF47717_OFFSET UNITYSDK_OFFSET(0xEE68AA0)
#define MARBLETRANSFORMANIMATIONHANDLE_METHOD_5_67902373518EC18A_OFFSET UNITYSDK_OFFSET(0xEE69CE0)
#define MARBLETRANSFORMANIMATIONHANDLE_METHOD_5_773796562D326B0E_OFFSET UNITYSDK_OFFSET(0xEE68F90)
#define MARBLETRANSFORMANIMATIONHANDLE_METHOD_5_998A9DD028E004C0_OFFSET UNITYSDK_OFFSET(0xEE6AA90)
#define MARBLETRANSFORMANIMATIONHANDLE_METHOD_5_BA5CD3C0B7AB5DDD_OFFSET UNITYSDK_OFFSET(0xEE68140)
#define MARBLETRANSFORMANIMATIONHANDLE_METHOD_5_C0AC14CF94069BDD_OFFSET UNITYSDK_OFFSET(0xEE6A890)
#define MARBLETRANSFORMANIMATIONHANDLE_METHOD_5_C920746CFBA5989E_OFFSET UNITYSDK_OFFSET(0xEE69F40)
#define MARBLETRANSFORMANIMATIONHANDLE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xEE6B1E0)
#define MARBLETRANSFORMANIMATIONHANDLE_START_OFFSET UNITYSDK_OFFSET(0xEE67700)
#define MARBLETRANSFORMANIMATIONHANDLE_TRIGGERTRANSFORMANIMATION_1_OFFSET UNITYSDK_OFFSET(0xEE69EB0)
#define MARBLETRANSFORMANIMATIONHANDLE_TRIGGERTRANSFORMANIMATION_2_OFFSET UNITYSDK_OFFSET(0xEE6B030)
#define MARBLETRANSFORMANIMATIONHANDLE_TRIGGERTRANSFORMANIMATION_OFFSET UNITYSDK_OFFSET(0xEE69E40)
#define MARBLETRANSFORMANIMATIONHANDLE_UPDATE_OFFSET UNITYSDK_OFFSET(0xEE679C0)
#define MARBLETRANSFORMANIMATIONHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0xEE6B4A0)
