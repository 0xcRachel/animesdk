...
#define MARBLETRANSFORMANIMATIONHANDLE_ANIMRESET_OFFSET UNITYSDK_OFFSET(0x111FB5C0)
#define MARBLETRANSFORMANIMATIONHANDLE_ANIMSTOPPLAYING_OFFSET UNITYSDK_OFFSET(0x111F9120)
#define MARBLETRANSFORMANIMATIONHANDLE_BEGINTESTANIM_OFFSET UNITYSDK_OFFSET(0x111FA380)
#define MARBLETRANSFORMANIMATIONHANDLE_BREAKACITVEANIMLOOP_OFFSET UNITYSDK_OFFSET(0x111FAB50)
#define MARBLETRANSFORMANIMATIONHANDLE_CHECKANIMPLAYING_1_OFFSET UNITYSDK_OFFSET(0x111FB800)
#define MARBLETRANSFORMANIMATIONHANDLE_CHECKANIMPLAYING_OFFSET UNITYSDK_OFFSET(0x111FB7C0)
#define MARBLETRANSFORMANIMATIONHANDLE_FINDPOINT_OFFSET UNITYSDK_OFFSET(0x111FA1F0)
#define MARBLETRANSFORMANIMATIONHANDLE_INIT_OFFSET UNITYSDK_OFFSET(0x111F8780)
#define MARBLETRANSFORMANIMATIONHANDLE_LOOPBREAKTEST_OFFSET UNITYSDK_OFFSET(0x111FAB00)
#define MARBLETRANSFORMANIMATIONHANDLE_METHOD_5_1B59628C129E32A4_OFFSET UNITYSDK_OFFSET(0x111FA410)
#define MARBLETRANSFORMANIMATIONHANDLE_METHOD_5_289F28027FF47717_OFFSET UNITYSDK_OFFSET(0x111F9AD0)
#define MARBLETRANSFORMANIMATIONHANDLE_METHOD_5_67902373518EC18A_OFFSET UNITYSDK_OFFSET(0x111FACB0)
#define MARBLETRANSFORMANIMATIONHANDLE_METHOD_5_998A9DD028E004C0_OFFSET UNITYSDK_OFFSET(0x111FBA60)
#define MARBLETRANSFORMANIMATIONHANDLE_METHOD_5_BA5CD3C0B7AB5DDD_OFFSET UNITYSDK_OFFSET(0x111F9170)
#define MARBLETRANSFORMANIMATIONHANDLE_METHOD_5_C0AC14CF94069BDD_OFFSET UNITYSDK_OFFSET(0x111FB860)
#define MARBLETRANSFORMANIMATIONHANDLE_METHOD_5_C920746CFBA5989E_OFFSET UNITYSDK_OFFSET(0x111FAF10)
#define MARBLETRANSFORMANIMATIONHANDLE_METHOD_5_E7D24A4B2E4C35B9_OFFSET UNITYSDK_OFFSET(0x111F9FC0)
#define MARBLETRANSFORMANIMATIONHANDLE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x111FC190)
#define MARBLETRANSFORMANIMATIONHANDLE_START_OFFSET UNITYSDK_OFFSET(0x111F8730)
#define MARBLETRANSFORMANIMATIONHANDLE_TRIGGERTRANSFORMANIMATION_1_OFFSET UNITYSDK_OFFSET(0x111FAE80)
#define MARBLETRANSFORMANIMATIONHANDLE_TRIGGERTRANSFORMANIMATION_2_OFFSET UNITYSDK_OFFSET(0x111FBFE0)
#define MARBLETRANSFORMANIMATIONHANDLE_TRIGGERTRANSFORMANIMATION_OFFSET UNITYSDK_OFFSET(0x111FAE10)
#define MARBLETRANSFORMANIMATIONHANDLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x111F89F0)
#define MARBLETRANSFORMANIMATIONHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x111FC450)

inline static constexpr unsigned int MarbleTransformAnimationHandle_TypeDefinitionIndex = 37090;
...
public:
	...
	::System::Void Method_5_E7D24A4B2E4C35B9(::System::String* a1, ::System::Nullable_1<::UnityEngine::Vector3> a2, ::System::Nullable_1<::UnityEngine::Quaternion> a3, ::System::Nullable_1<::UnityEngine::Vector3> a4, ::UnityEngine::Transform* a5, ::System::Action_2<::RPG::Client::MonoEffect*, ::RPG::Client::TriggerEffectCallbackParams>* a6, ::System::String* a7)
	{
		return ((::System::Void(*)(::PVOID, ::System::String*, ::System::Nullable_1<::UnityEngine::Vector3>, ::System::Nullable_1<::UnityEngine::Quaternion>, ::System::Nullable_1<::UnityEngine::Vector3>, ::UnityEngine::Transform*, ::System::Action_2<::RPG::Client::MonoEffect*, ::RPG::Client::TriggerEffectCallbackParams>*, ::System::String*))((::PBYTE)hIl2Cpp + MARBLETRANSFORMANIMATIONHANDLE_METHOD_5_E7D24A4B2E4C35B9_OFFSET))(this, a1, a2, a3, a4, a5, a6, a7);
	}
