...
#define CLASS_1_EABAA0FA9B3BC305_GET_CTRLTYPE_OFFSET UNITYSDK_OFFSET(0xFE79710)
#define CLASS_1_EABAA0FA9B3BC305_GET_DISABLECOUNT_OFFSET UNITYSDK_OFFSET(0xFE799C0)
#define CLASS_1_EABAA0FA9B3BC305_GET_OVERRIDEPROPERTIES_OFFSET UNITYSDK_OFFSET(0xFE79730)
#define CLASS_1_EABAA0FA9B3BC305_METHOD_1_00977B442F01EE68_OFFSET UNITYSDK_OFFSET(0xFE79760)
#define CLASS_1_EABAA0FA9B3BC305_METHOD_1_46019E40A12B5629_1_OFFSET UNITYSDK_OFFSET(0xFE799B0)
#define CLASS_1_EABAA0FA9B3BC305_METHOD_1_46019E40A12B5629_OFFSET UNITYSDK_OFFSET(0xFE79750)
#define CLASS_1_EABAA0FA9B3BC305_METHOD_1_B34036B3632F4773_OFFSET UNITYSDK_OFFSET(0xFE799E0)
#define CLASS_1_EABAA0FA9B3BC305_METHOD_1_C97F07D4514E1BDA_OFFSET UNITYSDK_OFFSET(0xFE79690)
#define CLASS_1_EABAA0FA9B3BC305_SET_CTRLTYPE_OFFSET UNITYSDK_OFFSET(0xFE79720)
#define CLASS_1_EABAA0FA9B3BC305_SET_DISABLECOUNT_OFFSET UNITYSDK_OFFSET(0xFE799D0)
#define CLASS_1_EABAA0FA9B3BC305_SET_OVERRIDEPROPERTIES_OFFSET UNITYSDK_OFFSET(0xFE79740)
#define CLASS_1_EABAA0FA9B3BC305__CTOR_OFFSET UNITYSDK_OFFSET(0xFE795F0)

inline static constexpr unsigned int Class_1_EABAA0FA9B3BC305_TypeDefinitionIndex = 45431;

class Class_1_EABAA0FA9B3BC305 : public ::System::Object
{
public:
	::Class_1_93251EBB84CD1CB1* _OverrideProperties_k__BackingField; // 0x10
	...
	::Class_1_93251EBB84CD1CB1* get_OverrideProperties()
	{
		return ((::Class_1_93251EBB84CD1CB1*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_EABAA0FA9B3BC305_GET_OVERRIDEPROPERTIES_OFFSET))(this);
	}

	::System::Void set_OverrideProperties(::Class_1_93251EBB84CD1CB1* value)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_93251EBB84CD1CB1*))((::PBYTE)hIl2Cpp + CLASS_1_EABAA0FA9B3BC305_SET_OVERRIDEPROPERTIES_OFFSET))(this, value);
	}
