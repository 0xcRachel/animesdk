...
#define CLASS_1_B590C31C505191E5_3_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1B25CD30)
#define CLASS_1_B590C31C505191E5_3_CLONE_OFFSET UNITYSDK_OFFSET(0x1B25C8F0)
#define CLASS_1_B590C31C505191E5_3_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1B25CA50)
#define CLASS_1_B590C31C505191E5_3_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B25C970)
#define CLASS_1_B590C31C505191E5_3_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B25CAF0)
#define CLASS_1_B590C31C505191E5_3_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1B25CE20)
#define CLASS_1_B590C31C505191E5_3_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1B25CDD0)
#define CLASS_1_B590C31C505191E5_3_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1B25C7A0)
#define CLASS_1_B590C31C505191E5_3_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1B25C940)
#define CLASS_1_B590C31C505191E5_3_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1B25C960)
#define CLASS_1_B590C31C505191E5_3_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1B25C950)
#define CLASS_1_B590C31C505191E5_3_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1B25C800)
#define CLASS_1_B590C31C505191E5_3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B25CBF0)
#define CLASS_1_B590C31C505191E5_3_WRITETO_OFFSET UNITYSDK_OFFSET(0x1B25CC50)
#define CLASS_1_B590C31C505191E5_3__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B25D000)
#define CLASS_1_B590C31C505191E5_3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B25C860)
#define CLASS_1_B590C31C505191E5_3__CTOR_OFFSET UNITYSDK_OFFSET(0x1B25C810)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B590C31C505191E5_3_TypeDefinitionIndex)->GetStaticField(0x39330);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_B590C31C505191E5_3*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_B590C31C505191E5_3*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B590C31C505191E5_3_TypeDefinitionIndex)->GetStaticField(0x39338);
	}
