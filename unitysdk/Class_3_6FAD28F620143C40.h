...
#define CLASS_3_6FAD28F620143C40_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x96CB540)
#define CLASS_3_6FAD28F620143C40__CCTOR_OFFSET UNITYSDK_OFFSET(0x96CCD30)
#define CLASS_3_6FAD28F620143C40__CTOR_OFFSET UNITYSDK_OFFSET(0x96CB490)
#define CLASS_3_6FAD28F620143C40__ONTASKBEGIN_G___ADDWEAK_1_0_OFFSET UNITYSDK_OFFSET(0x96CCB00)

inline static constexpr unsigned int Class_3_6FAD28F620143C40_TypeDefinitionIndex = 42835;
...
public:
	...
	{
		return (::System::Collections::Generic::List_1<::RPG::GameCore::AttackDamageType>**)Il2CppClass::FromTypeDefinitionIndex(Class_3_6FAD28F620143C40_TypeDefinitionIndex)->GetStaticField(0x42CA0);
	}
