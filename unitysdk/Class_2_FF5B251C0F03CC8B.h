...
#define CLASS_2_FF5B251C0F03CC8B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9C6A7D0)
#define CLASS_2_FF5B251C0F03CC8B_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x9C6A9E0)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x9C6BC40)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_262D2B4BC22B01ED_OFFSET UNITYSDK_OFFSET(0x9C6CEB0)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_27EC2C099D14356D_OFFSET UNITYSDK_OFFSET(0x9C6D260)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_32D4A70A38448E14_OFFSET UNITYSDK_OFFSET(0x9C6B360)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_3B258437A86233AC_OFFSET UNITYSDK_OFFSET(0x9C6A680)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_5C0C256643E989F8_OFFSET UNITYSDK_OFFSET(0x9C6A3E0)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_61EC2AC0BD93363E_OFFSET UNITYSDK_OFFSET(0x9C6C4B0)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_67D41ACFEF39E84E_OFFSET UNITYSDK_OFFSET(0x9C6C7F0)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_716BA667B58090A4_OFFSET UNITYSDK_OFFSET(0x9C6C570)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_7BFF16CC471B6C59_OFFSET UNITYSDK_OFFSET(0x9C6CFD0)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_7E1BADD1D133FA1C_OFFSET UNITYSDK_OFFSET(0x9C6A820)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_9186B8EB46BDAB54_OFFSET UNITYSDK_OFFSET(0x9C6C020)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x9C6A460)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_AD4C034BC86ADE53_OFFSET UNITYSDK_OFFSET(0x9C6CB80)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_B7E6ED31D1624EEC_OFFSET UNITYSDK_OFFSET(0x9C6B1C0)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_D34432C0B65E6441_OFFSET UNITYSDK_OFFSET(0x9C6B490)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_D5387FAF23786253_OFFSET UNITYSDK_OFFSET(0x9C6BCD0)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_DCC0CC5DBC127BF8_OFFSET UNITYSDK_OFFSET(0x9C6B110)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_EB522918F22FFA3B_OFFSET UNITYSDK_OFFSET(0x9C6A5B0)
#define CLASS_2_FF5B251C0F03CC8B_ONFINISHIMMEDIATELYINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x9C6B4F0)
#define CLASS_2_FF5B251C0F03CC8B_ONSKIP_OFFSET UNITYSDK_OFFSET(0x9C6A9F0)
#define CLASS_2_FF5B251C0F03CC8B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x9C6B7E0)
#define CLASS_2_FF5B251C0F03CC8B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x9C6A970)
#define CLASS_2_FF5B251C0F03CC8B_SETNEXTTASK_OFFSET UNITYSDK_OFFSET(0x9C6B790)
#define CLASS_2_FF5B251C0F03CC8B_TICK_OFFSET UNITYSDK_OFFSET(0x9C6B6F0)
#define CLASS_2_FF5B251C0F03CC8B__CTOR_OFFSET UNITYSDK_OFFSET(0x9C6A330)
#define CLASS_2_FF5B251C0F03CC8B__ONTASKBEGIN_B__11_0_OFFSET UNITYSDK_OFFSET(0x9C6D3C0)
#define CLASS_2_FF5B251C0F03CC8B___ONSCREENTRANSFERTEXTEND_B__15_0_OFFSET UNITYSDK_OFFSET(0x9C6D5C0)
#define CLASS_2_FF5B251C0F03CC8B___PROMISEKEEPTIMEOUT_B__19_0_OFFSET UNITYSDK_OFFSET(0x9C6D620)
...
public:
	...
	::Class_1_23F67DD15593C8D6* Field_2_5; // 0x28
	::RPG::Client::Promises::Promise* Field_2_10; // 0x30
	::RPG::GameCore::PlayFullScreenTransfer* Field_2_0; // 0x38
	::RPG::Client::Promises::Promise* Field_2_7; // 0x40
	::RPG::Client::Promises::Promise* Field_2_9; // 0x48
	::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_380*>* Field_2_12; // 0x50
	::System::Exception* Field_2_4; // 0x58
	::RPG::Client::Promises::Promise* Field_2_8; // 0x60
	::RPG::Client::Promises::Promise* Field_2_6; // 0x68
	::RPG::GameCore::ScreenTransferReason Field_2_11; // 0x70
