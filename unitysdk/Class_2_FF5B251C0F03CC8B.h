...
#define CLASS_2_FF5B251C0F03CC8B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13F58910)
#define CLASS_2_FF5B251C0F03CC8B_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x13F58B40)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x13F59D90)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_27EC2C099D14356D_OFFSET UNITYSDK_OFFSET(0x17B64710)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_32D4A70A38448E14_OFFSET UNITYSDK_OFFSET(0x13F594C0)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_36E52709A7D46AC2_OFFSET UNITYSDK_OFFSET(0x13F5B240)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_5C0C256643E989F8_OFFSET UNITYSDK_OFFSET(0x13F584E0)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_61EC2AC0BD93363E_OFFSET UNITYSDK_OFFSET(0x13F5A630)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_6916CB2AB9451DD7_OFFSET UNITYSDK_OFFSET(0x13F5A9B0)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_70F996834AEFED46_OFFSET UNITYSDK_OFFSET(0x13F5A170)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_7E1BADD1D133FA1C_1_OFFSET UNITYSDK_OFFSET(0x13F58960)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_7E1BADD1D133FA1C_OFFSET UNITYSDK_OFFSET(0x13F587A0)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_7FD7D34994C88765_OFFSET UNITYSDK_OFFSET(0x13F58560)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_AD4C034BC86ADE53_OFFSET UNITYSDK_OFFSET(0x13F5AD80)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_B7E6ED31D1624EEC_OFFSET UNITYSDK_OFFSET(0x13F59310)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_D2DB41A02B318F87_OFFSET UNITYSDK_OFFSET(0x13F5A6F0)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_D34432C0B65E6441_OFFSET UNITYSDK_OFFSET(0x17B646B0)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_D5387FAF23786253_OFFSET UNITYSDK_OFFSET(0x13F59E20)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_DCC0CC5DBC127BF8_OFFSET UNITYSDK_OFFSET(0x13F59260)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_EB522918F22FFA3B_OFFSET UNITYSDK_OFFSET(0x13F586D0)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_EE07004C8154E49B_OFFSET UNITYSDK_OFFSET(0x13F5B0B0)
#define CLASS_2_FF5B251C0F03CC8B_ONFINISHIMMEDIATELYINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x13F595F0)
#define CLASS_2_FF5B251C0F03CC8B_ONSKIP_OFFSET UNITYSDK_OFFSET(0x13F58B50)
#define CLASS_2_FF5B251C0F03CC8B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x13F598D0)
#define CLASS_2_FF5B251C0F03CC8B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x13F58AE0)
#define CLASS_2_FF5B251C0F03CC8B_SETNEXTTASK_OFFSET UNITYSDK_OFFSET(0x13F59880)
#define CLASS_2_FF5B251C0F03CC8B_TICK_OFFSET UNITYSDK_OFFSET(0x13F597F0)
#define CLASS_2_FF5B251C0F03CC8B__CTOR_OFFSET UNITYSDK_OFFSET(0x13F58430)
#define CLASS_2_FF5B251C0F03CC8B__ONTASKBEGIN_B__11_0_OFFSET UNITYSDK_OFFSET(0x17B64850)
#define CLASS_2_FF5B251C0F03CC8B___ONSCREENTRANSFERTEXTEND_B__15_0_OFFSET UNITYSDK_OFFSET(0x17B649C0)
#define CLASS_2_FF5B251C0F03CC8B___PROMISEKEEPTIMEOUT_B__19_0_OFFSET UNITYSDK_OFFSET(0x17B64A20)
...
public:
	...
	::RPG::GameCore::PlayFullScreenTransfer* Field_2_3; // 0x28
	::RPG::Client::Promises::Promise* Field_2_4; // 0x30
	::RPG::Client::Promises::Promise* Field_2_5; // 0x38
	::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_406*>* Field_2_6; // 0x40
	::Class_1_5F51D4049EA87B7B* Field_2_7; // 0x48
	::System::Exception* Field_2_8; // 0x50
	::RPG::GameCore::TaskContext* Field_2_9; // 0x58
	::RPG::Client::Promises::Promise* Field_2_10; // 0x60
	::RPG::Client::Promises::Promise* Field_2_11; // 0x68
	::System::Int32 Field_2_12; // 0x70
	::System::Boolean Field_2_13; // 0x74
	::System::Boolean Field_2_14; // 0x75
	::System::Boolean Field_2_15; // 0x76
	::RPG::GameCore::ScreenTransferReason Field_2_16; // 0x78
