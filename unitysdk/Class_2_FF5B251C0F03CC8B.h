...
#define CLASS_2_FF5B251C0F03CC8B_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC66EC50)
#define CLASS_2_FF5B251C0F03CC8B_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0xC66EE50)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0xC670080)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_1CCAD9E0606BF12D_OFFSET UNITYSDK_OFFSET(0xC6709B0)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_262D2B4BC22B01ED_OFFSET UNITYSDK_OFFSET(0xC6712C0)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_27EC2C099D14356D_OFFSET UNITYSDK_OFFSET(0xC671670)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_32D4A70A38448E14_OFFSET UNITYSDK_OFFSET(0xC66F7C0)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_3B258437A86233AC_OFFSET UNITYSDK_OFFSET(0xC66EB00)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_5C0C256643E989F8_OFFSET UNITYSDK_OFFSET(0xC66E860)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_61EC2AC0BD93363E_OFFSET UNITYSDK_OFFSET(0xC6708F0)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_67D41ACFEF39E84E_OFFSET UNITYSDK_OFFSET(0xC670C00)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_7BFF16CC471B6C59_OFFSET UNITYSDK_OFFSET(0xC6713E0)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_7E1BADD1D133FA1C_OFFSET UNITYSDK_OFFSET(0xC66ECA0)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_9186B8EB46BDAB54_OFFSET UNITYSDK_OFFSET(0xC670460)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xC66E8E0)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_AD4C034BC86ADE53_OFFSET UNITYSDK_OFFSET(0xC670F90)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_B7E6ED31D1624EEC_OFFSET UNITYSDK_OFFSET(0xC66F620)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_D34432C0B65E6441_OFFSET UNITYSDK_OFFSET(0xC66F8F0)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_D5387FAF23786253_OFFSET UNITYSDK_OFFSET(0xC670110)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_DCC0CC5DBC127BF8_OFFSET UNITYSDK_OFFSET(0xC66F570)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_EB522918F22FFA3B_OFFSET UNITYSDK_OFFSET(0xC66EA30)
#define CLASS_2_FF5B251C0F03CC8B_ONFINISHIMMEDIATELYINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0xC66F950)
#define CLASS_2_FF5B251C0F03CC8B_ONSKIP_OFFSET UNITYSDK_OFFSET(0xC66EE60)
#define CLASS_2_FF5B251C0F03CC8B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xC66FC30)
#define CLASS_2_FF5B251C0F03CC8B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xC66EDF0)
#define CLASS_2_FF5B251C0F03CC8B_SETNEXTTASK_OFFSET UNITYSDK_OFFSET(0xC66FBE0)
#define CLASS_2_FF5B251C0F03CC8B_TICK_OFFSET UNITYSDK_OFFSET(0xC66FB50)
#define CLASS_2_FF5B251C0F03CC8B__CTOR_OFFSET UNITYSDK_OFFSET(0xC66E7B0)
#define CLASS_2_FF5B251C0F03CC8B__ONTASKBEGIN_B__11_0_OFFSET UNITYSDK_OFFSET(0xC6717D0)
#define CLASS_2_FF5B251C0F03CC8B___ONSCREENTRANSFERTEXTEND_B__15_0_OFFSET UNITYSDK_OFFSET(0xC6719C0)
#define CLASS_2_FF5B251C0F03CC8B___PROMISEKEEPTIMEOUT_B__19_0_OFFSET UNITYSDK_OFFSET(0xC671A20)
...
public:
	...
	::RPG::GameCore::PlayFullScreenTransfer* Field_2_0; // 0x18
	::Class_1_23F67DD15593C8D6* Field_2_5; // 0x20
	::RPG::Client::Promises::Promise* Field_2_10; // 0x28
	::System::Exception* Field_2_4; // 0x30
	::RPG::Client::Promises::Promise* Field_2_9; // 0x38
	::RPG::Client::Promises::Promise* Field_2_7; // 0x40
	::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_387*>* Field_2_12; // 0x48
	::Class_1_5F51D4049EA87B7B* Field_2_1; // 0x50
	...
	::System::Boolean Field_2_14; // 0x74
	::System::Boolean Field_2_15; // 0x75
	::System::Boolean Field_2_16; // 0x76
	::RPG::GameCore::ScreenTransferReason Field_2_11; // 0x78
