...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE62_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xEDC4850)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE62_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xEDC48C0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE62_INVOKE_OFFSET UNITYSDK_OFFSET(0xEDC4840)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE62__CTOR_OFFSET UNITYSDK_OFFSET(0xEDC47D0)
