...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE42_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1273DB30)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE42_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1273DB80)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE42_INVOKE_OFFSET UNITYSDK_OFFSET(0x1273DB20)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE42__CTOR_OFFSET UNITYSDK_OFFSET(0x1273DAB0)
