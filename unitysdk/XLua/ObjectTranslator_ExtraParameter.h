...
#define XLUA_OBJECTTRANSLATOR_EXTRAPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0xFC0F0B0)

namespace XLua
{
	inline static constexpr unsigned int ObjectTranslator_ExtraParameter_TypeDefinitionIndex = 39409;
