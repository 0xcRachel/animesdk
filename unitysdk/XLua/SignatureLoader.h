...
#define XLUA_SIGNATURELOADER_LOAD_AND_VERIFY_OFFSET UNITYSDK_OFFSET(0x8C68EE0)
#define XLUA_SIGNATURELOADER_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x8C69060)
#define XLUA_SIGNATURELOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x8C68E10)
...
namespace XLua
{
	...
	public:
		...
		::System::Security::Cryptography::RSACryptoServiceProvider* rsa; // 0x18
