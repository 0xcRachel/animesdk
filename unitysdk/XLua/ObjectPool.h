...
#define XLUA_OBJECTPOOL_ADD_OFFSET UNITYSDK_OFFSET(0xF854EB0)
#define XLUA_OBJECTPOOL_CHECK_OFFSET UNITYSDK_OFFSET(0xF855110)
#define XLUA_OBJECTPOOL_CLEAR_OFFSET UNITYSDK_OFFSET(0xF854DB0)
#define XLUA_OBJECTPOOL_EXTEND_CAPACITY_OFFSET UNITYSDK_OFFSET(0xF854DE0)
#define XLUA_OBJECTPOOL_GET_ALLOCEDCOUNT_OFFSET UNITYSDK_OFFSET(0xF854D40)
#define XLUA_OBJECTPOOL_GET_ITEM_OFFSET UNITYSDK_OFFSET(0xF854D60)
#define XLUA_OBJECTPOOL_GET_OFFSET UNITYSDK_OFFSET(0xF854FF0)
#define XLUA_OBJECTPOOL_GET_SLOTSIZE_OFFSET UNITYSDK_OFFSET(0xF854D20)
#define XLUA_OBJECTPOOL_REMOVE_OFFSET UNITYSDK_OFFSET(0xF855040)
#define XLUA_OBJECTPOOL_REPLACE_OFFSET UNITYSDK_OFFSET(0xF8550C0)
#define XLUA_OBJECTPOOL_SET_ALLOCEDCOUNT_OFFSET UNITYSDK_OFFSET(0xF854D50)
#define XLUA_OBJECTPOOL_TRYGETVALUE_OFFSET UNITYSDK_OFFSET(0xF854F90)
#define XLUA_OBJECTPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0xF8553B0)

namespace XLua
{
	inline static constexpr unsigned int ObjectPool_TypeDefinitionIndex = 39505;
