...
#define XLUA_UTILS___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0xFD02780)
#define XLUA_UTILS___C__DISPLAYCLASS6_0__GENITEMSETTER_B__1_OFFSET UNITYSDK_OFFSET(0xFD11230)

namespace XLua
{
	inline static constexpr unsigned int Utils___c__DisplayClass6_0_TypeDefinitionIndex = 39536;
