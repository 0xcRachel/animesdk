...
#define XLUA_REFERENCEEQUALSCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0xFC56910)
#define XLUA_REFERENCEEQUALSCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xFC56920)
#define XLUA_REFERENCEEQUALSCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0xFC56930)

namespace XLua
{
	inline static constexpr unsigned int ReferenceEqualsComparer_TypeDefinitionIndex = 39507;
