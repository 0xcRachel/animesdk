...
#define XLUA_LUABASE_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0xEDC5470)
#define XLUA_LUABASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xEDC53F0)
#define XLUA_LUABASE_EQUALS_OFFSET UNITYSDK_OFFSET(0xEDC5760)
#define XLUA_LUABASE_FINALIZE_OFFSET UNITYSDK_OFFSET(0xEDC5380)
#define XLUA_LUABASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xEDC5D50)
#define XLUA_LUABASE_PUSH_OFFSET UNITYSDK_OFFSET(0xEDC60E0)
#define XLUA_LUABASE__CTOR_OFFSET UNITYSDK_OFFSET(0xEDC5370)
