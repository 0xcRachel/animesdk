...
#define XLUA_METHODWRAPSCACHE___C__DISPLAYCLASS11_0__CTOR_OFFSET UNITYSDK_OFFSET(0x11BE7BA0)
#define XLUA_METHODWRAPSCACHE___C__DISPLAYCLASS11_0__GETEVENTWRAP_B__0_OFFSET UNITYSDK_OFFSET(0x11BE7ED0)
...
namespace XLua
{
	...
	{
	public:
		::System::Reflection::EventInfo* eventInfo; // 0x10
