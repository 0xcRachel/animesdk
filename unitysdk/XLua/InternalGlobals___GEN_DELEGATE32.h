...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE32_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA2786A0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE32_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA2786D0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE32_INVOKE_OFFSET UNITYSDK_OFFSET(0xA278140)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE32__CTOR_OFFSET UNITYSDK_OFFSET(0xA26D8C0)
