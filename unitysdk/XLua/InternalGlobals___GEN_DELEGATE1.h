...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE1_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA26F7D0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE1_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA26F800)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE1_INVOKE_OFFSET UNITYSDK_OFFSET(0xA26F270)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE1__CTOR_OFFSET UNITYSDK_OFFSET(0xA26D4C0)
