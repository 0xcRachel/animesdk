...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE1_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xF82D750)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE1_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xF82D780)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE1_INVOKE_OFFSET UNITYSDK_OFFSET(0xF82D010)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE1__CTOR_OFFSET UNITYSDK_OFFSET(0xF82AFC0)

namespace XLua
{
	inline static constexpr unsigned int InternalGlobals___GEN_DELEGATE1_TypeDefinitionIndex = 39432;
