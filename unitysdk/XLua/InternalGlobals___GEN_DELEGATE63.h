...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE63_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA283FE0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE63_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA284010)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE63_INVOKE_OFFSET UNITYSDK_OFFSET(0xA283A80)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE63__CTOR_OFFSET UNITYSDK_OFFSET(0xA26DC80)
