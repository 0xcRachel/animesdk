...
#define XLUA_SYSGENCONFIG_GET_ADDITIONALPROPERTIES_OFFSET UNITYSDK_OFFSET(0xFCFDC00)
#define XLUA_SYSGENCONFIG_GET_GCOPTIMIZE_OFFSET UNITYSDK_OFFSET(0xFCFDA00)

namespace XLua
{
	inline static constexpr unsigned int SysGenConfig_TypeDefinitionIndex = 39465;
