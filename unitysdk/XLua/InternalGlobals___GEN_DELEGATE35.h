...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE35_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA2797D0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE35_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA279810)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE35_INVOKE_OFFSET UNITYSDK_OFFSET(0xA279250)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE35__CTOR_OFFSET UNITYSDK_OFFSET(0xA26D900)
