...
#define XLUA_LUATABLE_GETKEYS_OFFSET UNITYSDK_OFFSET(0xFF7D130)
#define XLUA_LUATABLE_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0xFF7CE20)
#define XLUA_LUATABLE_GET_ITEM_OFFSET UNITYSDK_OFFSET(0xFF7CDC0)
#define XLUA_LUATABLE_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0xFF7CEE0)
#define XLUA_LUATABLE_PUSH_OFFSET UNITYSDK_OFFSET(0xFF78650)
#define XLUA_LUATABLE_SETMETATABLE_OFFSET UNITYSDK_OFFSET(0xFF7D1B0)
#define XLUA_LUATABLE_SET_ITEM_1_OFFSET UNITYSDK_OFFSET(0xFF7CE90)
#define XLUA_LUATABLE_SET_ITEM_OFFSET UNITYSDK_OFFSET(0xFF7CDD0)
#define XLUA_LUATABLE_TOSTRING_OFFSET UNITYSDK_OFFSET(0xFF7D520)
#define XLUA_LUATABLE__CTOR_OFFSET UNITYSDK_OFFSET(0xFF7CDB0)
