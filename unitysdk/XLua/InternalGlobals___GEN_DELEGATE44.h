...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE44_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1273DD30)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE44_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1273DD80)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE44_INVOKE_OFFSET UNITYSDK_OFFSET(0x1273DD20)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE44__CTOR_OFFSET UNITYSDK_OFFSET(0x1273DCB0)
