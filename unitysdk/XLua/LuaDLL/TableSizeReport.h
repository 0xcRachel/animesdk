...
#define XLUA_LUADLL_TABLESIZEREPORT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xF841780)
#define XLUA_LUADLL_TABLESIZEREPORT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xF8417F0)
#define XLUA_LUADLL_TABLESIZEREPORT_INVOKE_OFFSET UNITYSDK_OFFSET(0xF8412B0)
#define XLUA_LUADLL_TABLESIZEREPORT__CTOR_OFFSET UNITYSDK_OFFSET(0xF841290)

namespace XLua::LuaDLL
{
	inline static constexpr unsigned int TableSizeReport_TypeDefinitionIndex = 40754;
