...
#define XLUA_LUADLL_OBJECTRELATIONSHIPREPORT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xF841180)
#define XLUA_LUADLL_OBJECTRELATIONSHIPREPORT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xF841280)
#define XLUA_LUADLL_OBJECTRELATIONSHIPREPORT_INVOKE_OFFSET UNITYSDK_OFFSET(0xF840B90)
#define XLUA_LUADLL_OBJECTRELATIONSHIPREPORT__CTOR_OFFSET UNITYSDK_OFFSET(0xF840B70)

namespace XLua::LuaDLL
{
	inline static constexpr unsigned int ObjectRelationshipReport_TypeDefinitionIndex = 40755;
