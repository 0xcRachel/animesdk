...
#define XLUA_OBJECTTRANSLATOR___C__DISPLAYCLASS6515_1__CTOR_OFFSET UNITYSDK_OFFSET(0x16EE0340)
#define XLUA_OBJECTTRANSLATOR___C__DISPLAYCLASS6515_1__GETDELEGATE_B__1_OFFSET UNITYSDK_OFFSET(0x16EE8F20)
...
namespace XLua
{
	...
	public:
		...
		::XLua::ObjectTranslator___c__DisplayClass6515_0* CS___8__locals1; // 0x18
