...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE26_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1273C440)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE26_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1273C4A0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE26_INVOKE_OFFSET UNITYSDK_OFFSET(0x1273C430)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE26__CTOR_OFFSET UNITYSDK_OFFSET(0x1273C340)
