...
#define XLUA_LUAFUNCTION_CALL_1_OFFSET UNITYSDK_OFFSET(0xF845780)
#define XLUA_LUAFUNCTION_CALL_OFFSET UNITYSDK_OFFSET(0xF846250)
#define XLUA_LUAFUNCTION_PUSH_OFFSET UNITYSDK_OFFSET(0xF846920)
#define XLUA_LUAFUNCTION_SETENV_OFFSET UNITYSDK_OFFSET(0xF846630)
#define XLUA_LUAFUNCTION_TOSTRING_OFFSET UNITYSDK_OFFSET(0xF8469D0)
#define XLUA_LUAFUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0xF846240)

namespace XLua
{
	inline static constexpr unsigned int LuaFunction_TypeDefinitionIndex = 39473;
