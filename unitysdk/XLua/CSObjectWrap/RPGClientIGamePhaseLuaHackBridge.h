...
#define XLUA_CSOBJECTWRAP_RPGCLIENTIGAMEPHASELUAHACKBRIDGE_RPG_CLIENT_IGAMEPHASELUAHACK_END_ENTER_OFFSET UNITYSDK_OFFSET(0x17E77D70)
#define XLUA_CSOBJECTWRAP_RPGCLIENTIGAMEPHASELUAHACKBRIDGE_RPG_CLIENT_IGAMEPHASELUAHACK_END_LATE_UPDATE_OFFSET UNITYSDK_OFFSET(0x17E79390)
#define XLUA_CSOBJECTWRAP_RPGCLIENTIGAMEPHASELUAHACKBRIDGE_RPG_CLIENT_IGAMEPHASELUAHACK_END_LEAVE_OFFSET UNITYSDK_OFFSET(0x17E79E80)
#define XLUA_CSOBJECTWRAP_RPGCLIENTIGAMEPHASELUAHACKBRIDGE_RPG_CLIENT_IGAMEPHASELUAHACK_END_TICK_OFFSET UNITYSDK_OFFSET(0x17E78840)
#define XLUA_CSOBJECTWRAP_RPGCLIENTIGAMEPHASELUAHACKBRIDGE_RPG_CLIENT_IGAMEPHASELUAHACK_START_ENTER_OFFSET UNITYSDK_OFFSET(0x17E77810)
#define XLUA_CSOBJECTWRAP_RPGCLIENTIGAMEPHASELUAHACKBRIDGE_RPG_CLIENT_IGAMEPHASELUAHACK_START_LATE_UPDATE_OFFSET UNITYSDK_OFFSET(0x17E78DB0)
#define XLUA_CSOBJECTWRAP_RPGCLIENTIGAMEPHASELUAHACKBRIDGE_RPG_CLIENT_IGAMEPHASELUAHACK_START_LEAVE_OFFSET UNITYSDK_OFFSET(0x17E79900)
#define XLUA_CSOBJECTWRAP_RPGCLIENTIGAMEPHASELUAHACKBRIDGE_RPG_CLIENT_IGAMEPHASELUAHACK_START_TICK_OFFSET UNITYSDK_OFFSET(0x17E78260)
#define XLUA_CSOBJECTWRAP_RPGCLIENTIGAMEPHASELUAHACKBRIDGE__CTOR_OFFSET UNITYSDK_OFFSET(0x17E77800)
#define XLUA_CSOBJECTWRAP_RPGCLIENTIGAMEPHASELUAHACKBRIDGE___CREATE_OFFSET UNITYSDK_OFFSET(0x17E777B0)
