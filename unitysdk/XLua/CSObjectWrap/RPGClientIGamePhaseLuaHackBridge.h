...
#define XLUA_CSOBJECTWRAP_RPGCLIENTIGAMEPHASELUAHACKBRIDGE_RPG_CLIENT_IGAMEPHASELUAHACK_END_ENTER_OFFSET UNITYSDK_OFFSET(0xF48D2A0)
#define XLUA_CSOBJECTWRAP_RPGCLIENTIGAMEPHASELUAHACKBRIDGE_RPG_CLIENT_IGAMEPHASELUAHACK_END_LATE_UPDATE_OFFSET UNITYSDK_OFFSET(0xF48E8C0)
#define XLUA_CSOBJECTWRAP_RPGCLIENTIGAMEPHASELUAHACKBRIDGE_RPG_CLIENT_IGAMEPHASELUAHACK_END_LEAVE_OFFSET UNITYSDK_OFFSET(0xF48F3B0)
#define XLUA_CSOBJECTWRAP_RPGCLIENTIGAMEPHASELUAHACKBRIDGE_RPG_CLIENT_IGAMEPHASELUAHACK_END_TICK_OFFSET UNITYSDK_OFFSET(0xF48DD70)
#define XLUA_CSOBJECTWRAP_RPGCLIENTIGAMEPHASELUAHACKBRIDGE_RPG_CLIENT_IGAMEPHASELUAHACK_START_ENTER_OFFSET UNITYSDK_OFFSET(0xF48CD40)
#define XLUA_CSOBJECTWRAP_RPGCLIENTIGAMEPHASELUAHACKBRIDGE_RPG_CLIENT_IGAMEPHASELUAHACK_START_LATE_UPDATE_OFFSET UNITYSDK_OFFSET(0xF48E2E0)
#define XLUA_CSOBJECTWRAP_RPGCLIENTIGAMEPHASELUAHACKBRIDGE_RPG_CLIENT_IGAMEPHASELUAHACK_START_LEAVE_OFFSET UNITYSDK_OFFSET(0xF48EE30)
#define XLUA_CSOBJECTWRAP_RPGCLIENTIGAMEPHASELUAHACKBRIDGE_RPG_CLIENT_IGAMEPHASELUAHACK_START_TICK_OFFSET UNITYSDK_OFFSET(0xF48D790)
#define XLUA_CSOBJECTWRAP_RPGCLIENTIGAMEPHASELUAHACKBRIDGE__CTOR_OFFSET UNITYSDK_OFFSET(0xF48CD30)
#define XLUA_CSOBJECTWRAP_RPGCLIENTIGAMEPHASELUAHACKBRIDGE___CREATE_OFFSET UNITYSDK_OFFSET(0xF48CCE0)

namespace XLua::CSObjectWrap
{
	inline static constexpr unsigned int RPGClientIGamePhaseLuaHackBridge_TypeDefinitionIndex = 40747;
