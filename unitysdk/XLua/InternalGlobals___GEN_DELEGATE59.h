...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE59_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA282500)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE59_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA2825A0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE59_INVOKE_OFFSET UNITYSDK_OFFSET(0xA281F60)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE59__CTOR_OFFSET UNITYSDK_OFFSET(0xA26DC00)
