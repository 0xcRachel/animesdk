...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE60_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xEDC4690)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE60_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xEDC46C0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE60_INVOKE_OFFSET UNITYSDK_OFFSET(0xEDC4680)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE60__CTOR_OFFSET UNITYSDK_OFFSET(0xEDC4610)
