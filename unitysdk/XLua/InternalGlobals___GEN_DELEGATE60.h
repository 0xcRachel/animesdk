...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE60_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA2830B0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE60_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA2830E0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE60_INVOKE_OFFSET UNITYSDK_OFFSET(0xA282B50)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE60__CTOR_OFFSET UNITYSDK_OFFSET(0xA26DC20)
