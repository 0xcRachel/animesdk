...
#define XLUA_XLUAWRAPPERMACROATTRIBUTE_GET_MACRO_OFFSET UNITYSDK_OFFSET(0x172C8BB0)
#define XLUA_XLUAWRAPPERMACROATTRIBUTE_SET_MACRO_OFFSET UNITYSDK_OFFSET(0x172C8BC0)
#define XLUA_XLUAWRAPPERMACROATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x172C8BA0)

namespace XLua
{
	inline static constexpr unsigned int XLuaWrapperMacroAttribute_TypeDefinitionIndex = 8505;
