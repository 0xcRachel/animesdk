...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE0_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA26F1E0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE0_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA26F240)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE0_INVOKE_OFFSET UNITYSDK_OFFSET(0xA26EC80)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE0__CTOR_OFFSET UNITYSDK_OFFSET(0xA26D4A0)
