...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE33_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA278C50)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE33_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA278C80)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE33_INVOKE_OFFSET UNITYSDK_OFFSET(0xA278700)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE33__CTOR_OFFSET UNITYSDK_OFFSET(0xA26D8E0)
