...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE7_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA284580)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE7_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA2845B0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE7_INVOKE_OFFSET UNITYSDK_OFFSET(0xA284020)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE7__CTOR_OFFSET UNITYSDK_OFFSET(0xA26D580)
