...
namespace XLua
{
	inline static constexpr unsigned int ObjectTranslator___c__DisplayClass6154_0_1_TypeDefinitionIndex = 39425;

	template <typename T>
	class ObjectTranslator___c__DisplayClass6154_0_1 : public ::System::Object
	{
	public:
