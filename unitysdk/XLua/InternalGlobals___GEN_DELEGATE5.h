...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE5_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xFF689F0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE5_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xFF68A20)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE5_INVOKE_OFFSET UNITYSDK_OFFSET(0xFF68490)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE5__CTOR_OFFSET UNITYSDK_OFFSET(0xFF578A0)
