...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE57_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1273EFE0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE57_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1273F010)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE57_INVOKE_OFFSET UNITYSDK_OFFSET(0x1273EFC0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE57__CTOR_OFFSET UNITYSDK_OFFSET(0x1273EF50)
