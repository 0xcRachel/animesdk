...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE27_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA276480)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE27_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA2764B0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE27_INVOKE_OFFSET UNITYSDK_OFFSET(0xA275F20)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE27__CTOR_OFFSET UNITYSDK_OFFSET(0xA26D820)
