...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE34_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA2791F0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE34_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA279220)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE34_INVOKE_OFFSET UNITYSDK_OFFSET(0xA278C90)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE34__CTOR_OFFSET UNITYSDK_OFFSET(0xA26D680)
