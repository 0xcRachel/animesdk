...
#define GEOMETRYEDIT_PRISM___C__DISPLAYCLASS36_0__CTOR_OFFSET UNITYSDK_OFFSET(0x10365930)
#define GEOMETRYEDIT_PRISM___C__DISPLAYCLASS36_0__RESETPIVOT_B__0_OFFSET UNITYSDK_OFFSET(0x103659C0)

namespace GeometryEdit
{
	inline static constexpr unsigned int Prism___c__DisplayClass36_0_TypeDefinitionIndex = 38896;
