...
#define EMBREEDEBUGTOOL_CALCULATESCENEBOUNDS_OFFSET UNITYSDK_OFFSET(0x19434310)
#define EMBREEDEBUGTOOL_CASTRAYGRID_OFFSET UNITYSDK_OFFSET(0x19434540)
#define EMBREEDEBUGTOOL_CLEANUP_OFFSET UNITYSDK_OFFSET(0x19434230)
#define EMBREEDEBUGTOOL_EXECUTEDEBUG_OFFSET UNITYSDK_OFFSET(0x19433860)
#define EMBREEDEBUGTOOL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x194364C0)
#define EMBREEDEBUGTOOL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x194365A0)
#define EMBREEDEBUGTOOL_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x194358E0)
#define EMBREEDEBUGTOOL_PRINTRESULTS_OFFSET UNITYSDK_OFFSET(0x194354E0)
#define EMBREEDEBUGTOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x19436680)
