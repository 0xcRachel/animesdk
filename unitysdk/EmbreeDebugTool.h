...
#define EMBREEDEBUGTOOL_CALCULATESCENEBOUNDS_OFFSET UNITYSDK_OFFSET(0x8371BD0)
#define EMBREEDEBUGTOOL_CASTRAYGRID_OFFSET UNITYSDK_OFFSET(0x8371E00)
#define EMBREEDEBUGTOOL_CLEANUP_OFFSET UNITYSDK_OFFSET(0x8371AF0)
#define EMBREEDEBUGTOOL_EXECUTEDEBUG_OFFSET UNITYSDK_OFFSET(0x8371120)
#define EMBREEDEBUGTOOL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x8373D80)
#define EMBREEDEBUGTOOL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x8373E60)
#define EMBREEDEBUGTOOL_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x83731A0)
#define EMBREEDEBUGTOOL_PRINTRESULTS_OFFSET UNITYSDK_OFFSET(0x8372DA0)
#define EMBREEDEBUGTOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x8373F40)
