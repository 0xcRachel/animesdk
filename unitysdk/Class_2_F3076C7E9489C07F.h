...
#define CLASS_2_F3076C7E9489C07F_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10EB2F70)
#define CLASS_2_F3076C7E9489C07F_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10EB2FB0)
#define CLASS_2_F3076C7E9489C07F_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10EB3010)
#define CLASS_2_F3076C7E9489C07F_TICK_OFFSET UNITYSDK_OFFSET(0x10EB3060)
#define CLASS_2_F3076C7E9489C07F__CTOR_OFFSET UNITYSDK_OFFSET(0x10EB2F60)

inline static constexpr unsigned int Class_2_F3076C7E9489C07F_TypeDefinitionIndex = 41918;
