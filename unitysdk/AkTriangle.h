...
#define AKTRIANGLE_CLEAR_OFFSET UNITYSDK_OFFSET(0x190E7B00)
#define AKTRIANGLE_CLONE_OFFSET UNITYSDK_OFFSET(0x190E7C60)
#define AKTRIANGLE_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x190E7640)
#define AKTRIANGLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x190E7550)
#define AKTRIANGLE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x190E75D0)
#define AKTRIANGLE_GETCPTR_OFFSET UNITYSDK_OFFSET(0x190E7440)
#define AKTRIANGLE_GETSIZEOF_OFFSET UNITYSDK_OFFSET(0x190E7BB0)
#define AKTRIANGLE_GET_POINT0_OFFSET UNITYSDK_OFFSET(0x190DE350)
#define AKTRIANGLE_GET_POINT1_OFFSET UNITYSDK_OFFSET(0x190DE400)
#define AKTRIANGLE_GET_POINT2_OFFSET UNITYSDK_OFFSET(0x190DE4B0)
#define AKTRIANGLE_GET_SURFACE_OFFSET UNITYSDK_OFFSET(0x190E7A50)
#define AKTRIANGLE_SETCPTR_OFFSET UNITYSDK_OFFSET(0x190E7490)
#define AKTRIANGLE_SET_POINT0_OFFSET UNITYSDK_OFFSET(0x190DE050)
#define AKTRIANGLE_SET_POINT1_OFFSET UNITYSDK_OFFSET(0x190DE110)
#define AKTRIANGLE_SET_POINT2_OFFSET UNITYSDK_OFFSET(0x190DE1D0)
#define AKTRIANGLE_SET_SURFACE_OFFSET UNITYSDK_OFFSET(0x190DE290)
#define AKTRIANGLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x190E77E0)
#define AKTRIANGLE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x190E7860)
#define AKTRIANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x190E7430)
