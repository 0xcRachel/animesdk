...
#define AKTRIANGLE_CLEAR_OFFSET UNITYSDK_OFFSET(0x196D5610)
#define AKTRIANGLE_CLONE_OFFSET UNITYSDK_OFFSET(0x196D5770)
#define AKTRIANGLE_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x196D5110)
#define AKTRIANGLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x196D4FF0)
#define AKTRIANGLE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x196D50A0)
#define AKTRIANGLE_GETCPTR_OFFSET UNITYSDK_OFFSET(0x196D4EB0)
#define AKTRIANGLE_GETSIZEOF_OFFSET UNITYSDK_OFFSET(0x196D56C0)
#define AKTRIANGLE_GET_POINT0_OFFSET UNITYSDK_OFFSET(0x196CBE80)
#define AKTRIANGLE_GET_POINT1_OFFSET UNITYSDK_OFFSET(0x196CBF30)
#define AKTRIANGLE_GET_POINT2_OFFSET UNITYSDK_OFFSET(0x196CBFE0)
#define AKTRIANGLE_GET_SURFACE_OFFSET UNITYSDK_OFFSET(0x196D5560)
#define AKTRIANGLE_SETCPTR_OFFSET UNITYSDK_OFFSET(0x196D4F00)
#define AKTRIANGLE_SET_POINT0_OFFSET UNITYSDK_OFFSET(0x196CBB80)
#define AKTRIANGLE_SET_POINT1_OFFSET UNITYSDK_OFFSET(0x196CBC40)
#define AKTRIANGLE_SET_POINT2_OFFSET UNITYSDK_OFFSET(0x196CBD00)
#define AKTRIANGLE_SET_SURFACE_OFFSET UNITYSDK_OFFSET(0x196CBDC0)
#define AKTRIANGLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x196D52F0)
#define AKTRIANGLE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x196D5370)
#define AKTRIANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x196D4EA0)
