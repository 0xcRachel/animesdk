...
#define CLASS_1_A966C8DDC3B81EDD_GET_CURRENTSETTINGCULLINGMODE_OFFSET UNITYSDK_OFFSET(0x1117B490)
#define CLASS_1_A966C8DDC3B81EDD_GET_INITED_OFFSET UNITYSDK_OFFSET(0x1117B460)
#define CLASS_1_A966C8DDC3B81EDD_METHOD_1_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x1117A6D0)
#define CLASS_1_A966C8DDC3B81EDD_METHOD_1_159CB55E631AFCB9_OFFSET UNITYSDK_OFFSET(0x1117AD00)
#define CLASS_1_A966C8DDC3B81EDD_METHOD_1_272068886DA88B16_OFFSET UNITYSDK_OFFSET(0x1117A5A0)
#define CLASS_1_A966C8DDC3B81EDD_METHOD_1_2746E90F93D616D2_OFFSET UNITYSDK_OFFSET(0x1117AE90)
#define CLASS_1_A966C8DDC3B81EDD_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x1117AE40)
#define CLASS_1_A966C8DDC3B81EDD_METHOD_1_5C549BF7442375BC_OFFSET UNITYSDK_OFFSET(0x1117A7D0)
#define CLASS_1_A966C8DDC3B81EDD_METHOD_1_6E4DDEEF0B5C577A_OFFSET UNITYSDK_OFFSET(0x1117AA00)
#define CLASS_1_A966C8DDC3B81EDD_METHOD_1_9241AFBCB33227AA_OFFSET UNITYSDK_OFFSET(0x1117A890)
#define CLASS_1_A966C8DDC3B81EDD_METHOD_1_B2AF81294D9C69C7_OFFSET UNITYSDK_OFFSET(0x1117AAB0)
#define CLASS_1_A966C8DDC3B81EDD_METHOD_1_C9F62A8213D2F476_OFFSET UNITYSDK_OFFSET(0x1117B480)
#define CLASS_1_A966C8DDC3B81EDD_METHOD_1_CBB7D170F77C0921_OFFSET UNITYSDK_OFFSET(0x11179E60)
#define CLASS_1_A966C8DDC3B81EDD_METHOD_1_E13B8CE7CCBC009A_OFFSET UNITYSDK_OFFSET(0x1117A4D0)
#define CLASS_1_A966C8DDC3B81EDD_METHOD_1_E5695720AB0F6E98_OFFSET UNITYSDK_OFFSET(0x1117B320)
#define CLASS_1_A966C8DDC3B81EDD_SET_CURRENTSETTINGCULLINGMODE_OFFSET UNITYSDK_OFFSET(0x1117B4A0)
#define CLASS_1_A966C8DDC3B81EDD_SET_INITED_OFFSET UNITYSDK_OFFSET(0x1117B470)
#define CLASS_1_A966C8DDC3B81EDD__CTOR_OFFSET UNITYSDK_OFFSET(0x11179D80)
...
public:
	...
	::System::Collections::Generic::List_1<::System::Single>* Field_1_6; // 0x18
	::System::Collections::Generic::List_1<::UnityEngine::Animator*>* Field_1_5; // 0x20
	::Class_2_01F4079471966D8C* Field_1_10; // 0x28
	::RPG::GameCore::PropComponent* Field_1_9; // 0x30
	::RPG::Client::CharacterMonoAvatar* Field_1_11; // 0x38
	::RPG::GameCore::GameEntity* Field_1_8; // 0x40
	::System::Boolean Field_1_1; // 0x48
	::System::Boolean _Inited_k__BackingField; // 0x49
