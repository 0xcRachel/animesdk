...
#define CLASS_1_F3EB7D0860A6C71F__ITERATE_D__1_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xDECE030)
#define CLASS_1_F3EB7D0860A6C71F__ITERATE_D__1_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_RPG_CLIENT_ACTIVITYBENEFITV2CONFIGDATA__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xDECE210)
#define CLASS_1_F3EB7D0860A6C71F__ITERATE_D__1_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_CLIENT_ACTIVITYBENEFITV2CONFIGDATA__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xDECE1A0)
#define CLASS_1_F3EB7D0860A6C71F__ITERATE_D__1_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xDECE270)
#define CLASS_1_F3EB7D0860A6C71F__ITERATE_D__1_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xDECE200)
#define CLASS_1_F3EB7D0860A6C71F__ITERATE_D__1_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xDECE1B0)
#define CLASS_1_F3EB7D0860A6C71F__ITERATE_D__1_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xDECE000)
#define CLASS_1_F3EB7D0860A6C71F__ITERATE_D__1__CTOR_OFFSET UNITYSDK_OFFSET(0xDECDE00)
#define CLASS_1_F3EB7D0860A6C71F__ITERATE_D__1___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0xDECE020)

inline static constexpr unsigned int Class_1_F3EB7D0860A6C71F__Iterate_d__1_TypeDefinitionIndex = 48710;
