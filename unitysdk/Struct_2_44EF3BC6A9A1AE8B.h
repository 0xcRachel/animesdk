...
#define STRUCT_2_44EF3BC6A9A1AE8B_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3748780)
#define STRUCT_2_44EF3BC6A9A1AE8B_EQUALS_OFFSET UNITYSDK_OFFSET(0x3748700)
#define STRUCT_2_44EF3BC6A9A1AE8B_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3748790)
#define STRUCT_2_44EF3BC6A9A1AE8B___IFIXBASEPROXY_EQUALS_OFFSET UNITYSDK_OFFSET(0x37487E0)
#define STRUCT_2_44EF3BC6A9A1AE8B___IFIXBASEPROXY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3748850)

inline static constexpr unsigned int Struct_2_44EF3BC6A9A1AE8B_TypeDefinitionIndex = 68905;
