...
#define CLASS_2_D681BCB4E8FE6FE3___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0x884C7D0)
#define CLASS_2_D681BCB4E8FE6FE3___C__DISPLAYCLASS5_0__LOADASSETASYNC_B__0_OFFSET UNITYSDK_OFFSET(0x884CEC0)

inline static constexpr unsigned int Class_2_D681BCB4E8FE6FE3___c__DisplayClass5_0_TypeDefinitionIndex = 62258;

class Class_2_D681BCB4E8FE6FE3___c__DisplayClass5_0 : public ::System::Object
{
public:
	::System::Action* callback; // 0x10
	::Class_2_D681BCB4E8FE6FE3* __4__this; // 0x18
	::System::String* asset; // 0x20
	::Class_0_16E4307DCC419505_85* contexts; // 0x28
	::Class_2_9850514C0F89B91A* entity; // 0x30
