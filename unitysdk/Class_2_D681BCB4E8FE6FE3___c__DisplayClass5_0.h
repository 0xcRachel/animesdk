...
#define CLASS_2_D681BCB4E8FE6FE3___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0x17F35E90)
#define CLASS_2_D681BCB4E8FE6FE3___C__DISPLAYCLASS5_0__LOADASSETASYNC_B__0_OFFSET UNITYSDK_OFFSET(0x17F365B0)

inline static constexpr unsigned int Class_2_D681BCB4E8FE6FE3___c__DisplayClass5_0_TypeDefinitionIndex = 71069;

class Class_2_D681BCB4E8FE6FE3___c__DisplayClass5_0 : public ::System::Object
{
public:
	::Class_2_FD51057495DB654F* entity; // 0x10
	::System::String* asset; // 0x18
	::System::Action* callback; // 0x20
	::Class_2_D681BCB4E8FE6FE3* __4__this; // 0x28
	::Class_0_16E4307DCC419505_84* contexts; // 0x30
