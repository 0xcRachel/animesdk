...
#define CLASS_1_5B567C8A01BAEDFE_359_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A8CDE60)
#define CLASS_1_5B567C8A01BAEDFE_359_CLONE_OFFSET UNITYSDK_OFFSET(0x1A8CDC70)
#define CLASS_1_5B567C8A01BAEDFE_359_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A8CDD70)
#define CLASS_1_5B567C8A01BAEDFE_359_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A8CDCE0)
#define CLASS_1_5B567C8A01BAEDFE_359_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A8CDDC0)
#define CLASS_1_5B567C8A01BAEDFE_359_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A8CDEB0)
#define CLASS_1_5B567C8A01BAEDFE_359_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A8CDE80)
#define CLASS_1_5B567C8A01BAEDFE_359_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A8CDBC0)
#define CLASS_1_5B567C8A01BAEDFE_359_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A8CDC20)
#define CLASS_1_5B567C8A01BAEDFE_359_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A8CDDF0)
#define CLASS_1_5B567C8A01BAEDFE_359_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A8CDE50)
#define CLASS_1_5B567C8A01BAEDFE_359__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A8CDF00)
#define CLASS_1_5B567C8A01BAEDFE_359__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A8CDC40)
#define CLASS_1_5B567C8A01BAEDFE_359__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8CDC30)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_359*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_359_TypeDefinitionIndex)->GetStaticField(0x5CDF0);
	}
