...
#define CLASS_1_8D4C99F920C1E42C_METHOD_1_9C6DDDA7FBC2AF1F_OFFSET UNITYSDK_OFFSET(0xBC23170)
#define CLASS_1_8D4C99F920C1E42C_METHOD_1_F56A003B1183F033_OFFSET UNITYSDK_OFFSET(0xBC22CB0)
#define CLASS_1_8D4C99F920C1E42C__CTOR_OFFSET UNITYSDK_OFFSET(0xBC22CA0)

inline static constexpr unsigned int Class_1_8D4C99F920C1E42C_TypeDefinitionIndex = 71347;
...
public:
	...
	{
		return ((::RPG::Client::LittleGame::ChenLing::CirticalTrackType(*)(::PVOID, ::Class_2_181A7F9409C60DBC*))((::PBYTE)hIl2Cpp + CLASS_1_8D4C99F920C1E42C_METHOD_1_9C6DDDA7FBC2AF1F_OFFSET))(this, a1);
	}
};
