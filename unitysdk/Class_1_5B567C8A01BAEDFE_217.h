...
#define CLASS_1_5B567C8A01BAEDFE_217_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A27DD90)
#define CLASS_1_5B567C8A01BAEDFE_217_CLONE_OFFSET UNITYSDK_OFFSET(0x1A27DBA0)
#define CLASS_1_5B567C8A01BAEDFE_217_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A27DCA0)
#define CLASS_1_5B567C8A01BAEDFE_217_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A27DC10)
#define CLASS_1_5B567C8A01BAEDFE_217_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A27DCF0)
#define CLASS_1_5B567C8A01BAEDFE_217_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A27DDE0)
#define CLASS_1_5B567C8A01BAEDFE_217_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A27DDB0)
#define CLASS_1_5B567C8A01BAEDFE_217_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A27DAF0)
#define CLASS_1_5B567C8A01BAEDFE_217_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A27DB50)
#define CLASS_1_5B567C8A01BAEDFE_217_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A27DD20)
#define CLASS_1_5B567C8A01BAEDFE_217_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A27DD80)
#define CLASS_1_5B567C8A01BAEDFE_217__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A27DE30)
#define CLASS_1_5B567C8A01BAEDFE_217__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A27DB70)
#define CLASS_1_5B567C8A01BAEDFE_217__CTOR_OFFSET UNITYSDK_OFFSET(0x1A27DB60)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_217*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_217_TypeDefinitionIndex)->GetStaticField(0x2C430);
	}
