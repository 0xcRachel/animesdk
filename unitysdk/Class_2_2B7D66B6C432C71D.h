...
#define CLASS_2_2B7D66B6C432C71D_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x8A9FF70)
#define CLASS_2_2B7D66B6C432C71D_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x8AA00B0)
#define CLASS_2_2B7D66B6C432C71D_METHOD_2_0960CAEE01038065_OFFSET UNITYSDK_OFFSET(0x8A9EE50)
#define CLASS_2_2B7D66B6C432C71D_METHOD_2_36726F9E10ADB55F_OFFSET UNITYSDK_OFFSET(0x8A9F700)
#define CLASS_2_2B7D66B6C432C71D_METHOD_2_3D813D05865A080E_OFFSET UNITYSDK_OFFSET(0x8A9EBF0)
#define CLASS_2_2B7D66B6C432C71D_METHOD_2_6B6A6C287518AB71_OFFSET UNITYSDK_OFFSET(0x8A9F640)
#define CLASS_2_2B7D66B6C432C71D_METHOD_2_83DA3EC57FF907F4_OFFSET UNITYSDK_OFFSET(0x8A9F1D0)
#define CLASS_2_2B7D66B6C432C71D_METHOD_2_8F8D080EF5D1D761_OFFSET UNITYSDK_OFFSET(0x8A9E4C0)
#define CLASS_2_2B7D66B6C432C71D_METHOD_2_93190E731E31C79A_OFFSET UNITYSDK_OFFSET(0x8A9E0A0)
#define CLASS_2_2B7D66B6C432C71D_METHOD_2_A27D06F9481FAFDB_1_OFFSET UNITYSDK_OFFSET(0x8A9FEB0)
#define CLASS_2_2B7D66B6C432C71D_METHOD_2_A27D06F9481FAFDB_2_OFFSET UNITYSDK_OFFSET(0x8A9FF10)
#define CLASS_2_2B7D66B6C432C71D_METHOD_2_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0x8A9FE50)
#define CLASS_2_2B7D66B6C432C71D_METHOD_2_A27DC2C5A103933A_OFFSET UNITYSDK_OFFSET(0x8A9E630)
#define CLASS_2_2B7D66B6C432C71D_METHOD_2_BDAC3726B2B73008_OFFSET UNITYSDK_OFFSET(0x8A9ECC0)
#define CLASS_2_2B7D66B6C432C71D_METHOD_2_C638E91FC0D3A13A_OFFSET UNITYSDK_OFFSET(0x8A9FC40)
#define CLASS_2_2B7D66B6C432C71D_METHOD_2_CE34EA208837238D_OFFSET UNITYSDK_OFFSET(0x8A9FBB0)
#define CLASS_2_2B7D66B6C432C71D_METHOD_2_F7300E87EC49A206_1_OFFSET UNITYSDK_OFFSET(0x8A9F2E0)
#define CLASS_2_2B7D66B6C432C71D_METHOD_2_F7300E87EC49A206_2_OFFSET UNITYSDK_OFFSET(0x8A9F490)
#define CLASS_2_2B7D66B6C432C71D_METHOD_2_F7300E87EC49A206_OFFSET UNITYSDK_OFFSET(0x8A9F020)
#define CLASS_2_2B7D66B6C432C71D__CTOR_OFFSET UNITYSDK_OFFSET(0x8AA01D0)
#define CLASS_2_2B7D66B6C432C71D__ONBIND_OFFSET UNITYSDK_OFFSET(0x8A9DD00)
#define CLASS_2_2B7D66B6C432C71D___IFIXBASEPROXY_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x8AA03B0)
#define CLASS_2_2B7D66B6C432C71D___IFIXBASEPROXY_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x8AA0410)
#define CLASS_2_2B7D66B6C432C71D___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0x8AA0350)

inline static constexpr unsigned int Class_2_2B7D66B6C432C71D_TypeDefinitionIndex = 59194;

class Class_2_2B7D66B6C432C71D : public ::Class_1_CA217ABF4E3B4F3F
{
public:
	::System::Collections::Generic::List_1<::Class_2_5D383A48C6769A2A*>* Field_2_6; // 0x60
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::GridFightTraitConfigBase*>* Field_2_8; // 0x68
	...
	::System::Collections::Generic::List_1<::Class_2_157110479543DAE3*>* Field_2_7; // 0x90
	::UnityEngine::UI::Button* Field_2_0; // 0x98
