...
#define CLASS_2_CFE1ACFCDDC5A59C_METHOD_2_5CD097F9288D9BC7_OFFSET UNITYSDK_OFFSET(0x10E89EA0)
#define CLASS_2_CFE1ACFCDDC5A59C__CTOR_OFFSET UNITYSDK_OFFSET(0x10E89C90)

inline static constexpr unsigned int Class_2_CFE1ACFCDDC5A59C_TypeDefinitionIndex = 62206;

class Class_2_CFE1ACFCDDC5A59C : public ::Class_1_43BD383C98B4C0C5_175
{
public:
