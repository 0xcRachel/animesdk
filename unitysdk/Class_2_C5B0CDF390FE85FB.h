...
#define CLASS_2_C5B0CDF390FE85FB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x89BBDA0)
#define CLASS_2_C5B0CDF390FE85FB_DOONENTER_OFFSET UNITYSDK_OFFSET(0x89BBDF0)
#define CLASS_2_C5B0CDF390FE85FB_DOONEXIT_OFFSET UNITYSDK_OFFSET(0x89BBE80)
#define CLASS_2_C5B0CDF390FE85FB__CTOR_OFFSET UNITYSDK_OFFSET(0x89BBD60)
#define CLASS_2_C5B0CDF390FE85FB___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x89BBF10)
#define CLASS_2_C5B0CDF390FE85FB___IFIXBASEPROXY_DOONENTER_OFFSET UNITYSDK_OFFSET(0x89BBF20)
#define CLASS_2_C5B0CDF390FE85FB___IFIXBASEPROXY_DOONEXIT_OFFSET UNITYSDK_OFFSET(0x89BBF30)
