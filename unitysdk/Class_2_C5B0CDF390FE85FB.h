...
#define CLASS_2_C5B0CDF390FE85FB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8633180)
#define CLASS_2_C5B0CDF390FE85FB_DOONENTER_OFFSET UNITYSDK_OFFSET(0x86331D0)
#define CLASS_2_C5B0CDF390FE85FB_DOONEXIT_OFFSET UNITYSDK_OFFSET(0x8633260)
#define CLASS_2_C5B0CDF390FE85FB__CTOR_OFFSET UNITYSDK_OFFSET(0x8633140)
#define CLASS_2_C5B0CDF390FE85FB___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x86332F0)
#define CLASS_2_C5B0CDF390FE85FB___IFIXBASEPROXY_DOONENTER_OFFSET UNITYSDK_OFFSET(0x8633300)
#define CLASS_2_C5B0CDF390FE85FB___IFIXBASEPROXY_DOONEXIT_OFFSET UNITYSDK_OFFSET(0x8633310)

inline static constexpr unsigned int Class_2_C5B0CDF390FE85FB_TypeDefinitionIndex = 45273;
