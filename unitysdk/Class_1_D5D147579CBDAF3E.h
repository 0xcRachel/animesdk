...
#define CLASS_1_D5D147579CBDAF3E_CLEAR_OFFSET UNITYSDK_OFFSET(0x10C8B9C0)
#define CLASS_1_D5D147579CBDAF3E_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0x10C8B3D0)
#define CLASS_1_D5D147579CBDAF3E_METHOD_1_2B9D478141E0F891_OFFSET UNITYSDK_OFFSET(0x10C8C830)
#define CLASS_1_D5D147579CBDAF3E_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x10C8C980)
#define CLASS_1_D5D147579CBDAF3E_METHOD_1_455E250D679F9642_OFFSET UNITYSDK_OFFSET(0x10C8C2B0)
#define CLASS_1_D5D147579CBDAF3E_METHOD_1_8723A000853037DA_OFFSET UNITYSDK_OFFSET(0x10C8C7B0)
#define CLASS_1_D5D147579CBDAF3E_METHOD_1_97B44ED90A2DE2AB_OFFSET UNITYSDK_OFFSET(0x10C8C570)
#define CLASS_1_D5D147579CBDAF3E_METHOD_1_9A5CF405F224D179_OFFSET UNITYSDK_OFFSET(0x10C8B410)
#define CLASS_1_D5D147579CBDAF3E_METHOD_1_B13E42FE90E0A910_OFFSET UNITYSDK_OFFSET(0x10C8B530)
#define CLASS_1_D5D147579CBDAF3E_METHOD_1_C9312916D3A31323_OFFSET UNITYSDK_OFFSET(0x10C8C520)
#define CLASS_1_D5D147579CBDAF3E_METHOD_1_CF763E7CB510BF26_OFFSET UNITYSDK_OFFSET(0x10C8BC00)
#define CLASS_1_D5D147579CBDAF3E_METHOD_1_D1CB535E9CE1A646_OFFSET UNITYSDK_OFFSET(0x10C8BFC0)
#define CLASS_1_D5D147579CBDAF3E_METHOD_1_F13C6990CE1C2126_OFFSET UNITYSDK_OFFSET(0x10C8B930)
#define CLASS_1_D5D147579CBDAF3E_METHOD_1_F978A1D172468895_OFFSET UNITYSDK_OFFSET(0x10C8BD90)
#define CLASS_1_D5D147579CBDAF3E__CCTOR_OFFSET UNITYSDK_OFFSET(0x10C8CA30)
#define CLASS_1_D5D147579CBDAF3E__CTOR_OFFSET UNITYSDK_OFFSET(0x10C8CA20)
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_D5D147579CBDAF3E_TypeDefinitionIndex)->GetStaticField(0x56D90);
	}
	static ::Il2CppArray<::System::Single>** StaticGet_Field_1_1()
	{
		return (::Il2CppArray<::System::Single>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_D5D147579CBDAF3E_TypeDefinitionIndex)->GetStaticField(0x56D98);
	}
	static ::System::Single* StaticGet_Field_1_0()
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_1_D5D147579CBDAF3E_TypeDefinitionIndex)->GetStaticField(0xF270);
	}
	static ::System::Single* StaticGet_Field_1_3()
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_1_D5D147579CBDAF3E_TypeDefinitionIndex)->GetStaticField(0xF274);
	}
	static ::System::Single* StaticGet_Field_1_2()
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_1_D5D147579CBDAF3E_TypeDefinitionIndex)->GetStaticField(0xF278);
	}
	// static const ::System::Single Field_1_4; // 0x0
	::WaterInteractor* Field_1_6; // 0x10
