...
#define AUISTATEMANAGER_CHECKINDEX_OFFSET UNITYSDK_OFFSET(0x13FF01C0)
#define AUISTATEMANAGER_FRESHSTATE_OFFSET UNITYSDK_OFFSET(0x13FF0990)
#define AUISTATEMANAGER_GETALLTAG_OFFSET UNITYSDK_OFFSET(0x13FF0060)
#define AUISTATEMANAGER_METHOD_5_134D4FD742CDB047_OFFSET UNITYSDK_OFFSET(0x13FF0440)
#define AUISTATEMANAGER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x13FF0010)
#define AUISTATEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x13FF0B70)
