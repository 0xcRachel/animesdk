...
#define AUISTATEMANAGER_CHECKINDEX_OFFSET UNITYSDK_OFFSET(0x10C0B760)
#define AUISTATEMANAGER_FRESHSTATE_OFFSET UNITYSDK_OFFSET(0x10C0BEB0)
#define AUISTATEMANAGER_GETALLTAG_OFFSET UNITYSDK_OFFSET(0x10C0B640)
#define AUISTATEMANAGER_METHOD_5_4820FAF758595035_OFFSET UNITYSDK_OFFSET(0x10C0B9E0)
#define AUISTATEMANAGER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x10C0B5F0)
#define AUISTATEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x10C0C080)
