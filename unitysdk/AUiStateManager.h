...
#define AUISTATEMANAGER_CHECKINDEX_OFFSET UNITYSDK_OFFSET(0xF95F830)
#define AUISTATEMANAGER_FRESHSTATE_OFFSET UNITYSDK_OFFSET(0xF95FF80)
#define AUISTATEMANAGER_GETALLTAG_OFFSET UNITYSDK_OFFSET(0xF95F710)
#define AUISTATEMANAGER_METHOD_5_4820FAF758595035_OFFSET UNITYSDK_OFFSET(0xF95FAB0)
#define AUISTATEMANAGER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0xF95F6C0)
#define AUISTATEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xF960150)
