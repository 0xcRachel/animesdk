...
#define CLASS_2_FCA621F56128C675_CLEAR_OFFSET UNITYSDK_OFFSET(0x15BE73C0)
#define CLASS_2_FCA621F56128C675_CREATEAVATARDATAPROVIDER_OFFSET UNITYSDK_OFFSET(0x15BE7440)
#define CLASS_2_FCA621F56128C675_CREATEEQUIPCOMPONENT_OFFSET UNITYSDK_OFFSET(0x15BE7550)
#define CLASS_2_FCA621F56128C675_CREATEEQUIPITEMS_OFFSET UNITYSDK_OFFSET(0x15BE77E0)
#define CLASS_2_FCA621F56128C675_CREATEPROPERTYPROVIDER_OFFSET UNITYSDK_OFFSET(0x15BE74C0)
#define CLASS_2_FCA621F56128C675_CREATETRAITCOMPONENT_OFFSET UNITYSDK_OFFSET(0x15BE7650)
#define CLASS_2_FCA621F56128C675_CREATETRAITS_OFFSET UNITYSDK_OFFSET(0x15BE7870)
#define CLASS_2_FCA621F56128C675_CREATEVALUECOMPONENT_OFFSET UNITYSDK_OFFSET(0x15BE76E0)
#define CLASS_2_FCA621F56128C675_CREATEVALUEMAP_OFFSET UNITYSDK_OFFSET(0x15BE7900)
#define CLASS_2_FCA621F56128C675_METHOD_2_88BBB895DF6C5669_OFFSET UNITYSDK_OFFSET(0x15BE71B0)
#define CLASS_2_FCA621F56128C675_METHOD_2_E5A5EFB9783AE9D3_OFFSET UNITYSDK_OFFSET(0x15BE7370)
#define CLASS_2_FCA621F56128C675__CTOR_OFFSET UNITYSDK_OFFSET(0x15BE79B0)
#define CLASS_2_FCA621F56128C675___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0x15BE79C0)
#define CLASS_2_FCA621F56128C675___IFIXBASEPROXY_CREATEAVATARDATAPROVIDER_OFFSET UNITYSDK_OFFSET(0x15BE7A30)
#define CLASS_2_FCA621F56128C675___IFIXBASEPROXY_CREATEEQUIPCOMPONENT_OFFSET UNITYSDK_OFFSET(0x15BE7A40)
#define CLASS_2_FCA621F56128C675___IFIXBASEPROXY_CREATETRAITCOMPONENT_OFFSET UNITYSDK_OFFSET(0x15BE7A50)
#define CLASS_2_FCA621F56128C675___IFIXBASEPROXY_CREATEVALUECOMPONENT_OFFSET UNITYSDK_OFFSET(0x15BE7A60)
#define CLASS_2_FCA621F56128C675___IFIXBASEPROXY_CREATEVALUEMAP_OFFSET UNITYSDK_OFFSET(0x15BE7A70)
...
{
public:
	::RPG::Client::GridFightBattleGameContext* Field_2_0; // 0x28
	::RPG::GameCore::BattleGridFightAvatarData* Field_2_1; // 0x30
	...
	{
		return ((::Class_0_16E4307DCC419505_788*(*)(::PVOID, ::RPG::Client::GridFightRole*))((::PBYTE)hIl2Cpp + CLASS_2_FCA621F56128C675_CREATEAVATARDATAPROVIDER_OFFSET))(this, a1);
	}

	::Class_0_16E4307DCC419505_787* CreatePropertyProvider(::RPG::Client::GridFightRole* a1)
	{
		return ((::Class_0_16E4307DCC419505_787*(*)(::PVOID, ::RPG::Client::GridFightRole*))((::PBYTE)hIl2Cpp + CLASS_2_FCA621F56128C675_CREATEPROPERTYPROVIDER_OFFSET))(this, a1);
	}
	...
	::Class_0_16E4307DCC419505_788* __iFixBaseProxy_CreateAvatarDataProvider(::RPG::Client::GridFightRole* a1)
	{
		return ((::Class_0_16E4307DCC419505_788*(*)(::PVOID, ::RPG::Client::GridFightRole*))((::PBYTE)hIl2Cpp + CLASS_2_FCA621F56128C675___IFIXBASEPROXY_CREATEAVATARDATAPROVIDER_OFFSET))(this, a1);
	}
