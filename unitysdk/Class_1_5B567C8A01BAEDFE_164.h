...
#define CLASS_1_5B567C8A01BAEDFE_164_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19C01820)
#define CLASS_1_5B567C8A01BAEDFE_164_CLONE_OFFSET UNITYSDK_OFFSET(0x19C01630)
#define CLASS_1_5B567C8A01BAEDFE_164_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19C01730)
#define CLASS_1_5B567C8A01BAEDFE_164_EQUALS_OFFSET UNITYSDK_OFFSET(0x19C016A0)
#define CLASS_1_5B567C8A01BAEDFE_164_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19C01780)
#define CLASS_1_5B567C8A01BAEDFE_164_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19C01870)
#define CLASS_1_5B567C8A01BAEDFE_164_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19C01840)
#define CLASS_1_5B567C8A01BAEDFE_164_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19C01580)
#define CLASS_1_5B567C8A01BAEDFE_164_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19C015E0)
#define CLASS_1_5B567C8A01BAEDFE_164_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19C017B0)
#define CLASS_1_5B567C8A01BAEDFE_164_WRITETO_OFFSET UNITYSDK_OFFSET(0x19C01810)
#define CLASS_1_5B567C8A01BAEDFE_164__CCTOR_OFFSET UNITYSDK_OFFSET(0x19C018C0)
#define CLASS_1_5B567C8A01BAEDFE_164__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19C01600)
#define CLASS_1_5B567C8A01BAEDFE_164__CTOR_OFFSET UNITYSDK_OFFSET(0x19C015F0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_164*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_164_TypeDefinitionIndex)->GetStaticField(0x39080);
	}
