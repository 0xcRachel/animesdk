...
#define CLASS_1_9E9BEB53C8DC281D_GET_DIALOGUEIDS_OFFSET UNITYSDK_OFFSET(0xD1F3D50)
#define CLASS_1_9E9BEB53C8DC281D_GET_ID_OFFSET UNITYSDK_OFFSET(0xD1F3CD0)
#define CLASS_1_9E9BEB53C8DC281D_GET_REQUIREMENTS_OFFSET UNITYSDK_OFFSET(0xD1F3CF0)
#define CLASS_1_9E9BEB53C8DC281D_GET_SPEAKERPOLICY_OFFSET UNITYSDK_OFFSET(0xD1F3D30)
#define CLASS_1_9E9BEB53C8DC281D_GET_VALIDAREAS_OFFSET UNITYSDK_OFFSET(0xD1F3D10)
#define CLASS_1_9E9BEB53C8DC281D_SET_DIALOGUEIDS_OFFSET UNITYSDK_OFFSET(0xD1F3D60)
#define CLASS_1_9E9BEB53C8DC281D_SET_ID_OFFSET UNITYSDK_OFFSET(0xD1F3CE0)
#define CLASS_1_9E9BEB53C8DC281D_SET_REQUIREMENTS_OFFSET UNITYSDK_OFFSET(0xD1F3D00)
#define CLASS_1_9E9BEB53C8DC281D_SET_SPEAKERPOLICY_OFFSET UNITYSDK_OFFSET(0xD1F3D40)
#define CLASS_1_9E9BEB53C8DC281D_SET_VALIDAREAS_OFFSET UNITYSDK_OFFSET(0xD1F3D20)
#define CLASS_1_9E9BEB53C8DC281D__CTOR_OFFSET UNITYSDK_OFFSET(0xD1F3D70)
...
{
public:
	::Il2CppArray<::Class_1_3745C69C00F04B7D_2*>* _Requirements_k__BackingField; // 0x10
