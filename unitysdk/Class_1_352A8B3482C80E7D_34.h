...
#define CLASS_1_352A8B3482C80E7D_34_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17A00AF0)
#define CLASS_1_352A8B3482C80E7D_34_CLONE_OFFSET UNITYSDK_OFFSET(0x17A00820)
#define CLASS_1_352A8B3482C80E7D_34_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17A00970)
#define CLASS_1_352A8B3482C80E7D_34_EQUALS_OFFSET UNITYSDK_OFFSET(0x17A008D0)
#define CLASS_1_352A8B3482C80E7D_34_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17A009D0)
#define CLASS_1_352A8B3482C80E7D_34_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x17A00C80)
#define CLASS_1_352A8B3482C80E7D_34_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x17A00C40)
#define CLASS_1_352A8B3482C80E7D_34_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x17A008B0)
#define CLASS_1_352A8B3482C80E7D_34_METHOD_1_3DACC45AC8150727_OFFSET UNITYSDK_OFFSET(0x17A008A0)
#define CLASS_1_352A8B3482C80E7D_34_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x17A008C0)
#define CLASS_1_352A8B3482C80E7D_34_METHOD_1_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x17A00890)
#define CLASS_1_352A8B3482C80E7D_34_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17A007D0)
#define CLASS_1_352A8B3482C80E7D_34_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17A00A00)
#define CLASS_1_352A8B3482C80E7D_34_WRITETO_OFFSET UNITYSDK_OFFSET(0x17A00A60)
#define CLASS_1_352A8B3482C80E7D_34__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17A007F0)
#define CLASS_1_352A8B3482C80E7D_34__CTOR_OFFSET UNITYSDK_OFFSET(0x17A007E0)

inline static constexpr unsigned int Class_1_352A8B3482C80E7D_34_TypeDefinitionIndex = 25023;
...
public:
	...
	::Enum_3_DB663931210BBC27_42 Field_1_2; // 0x18
	...
	{
		return ((::Enum_3_DB663931210BBC27_42(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_352A8B3482C80E7D_34_METHOD_1_A96DCA30C6927810_OFFSET))(this);
	}

	::System::Void Method_1_3DACC45AC8150727(::Enum_3_DB663931210BBC27_42 a1)
	{
		return ((::System::Void(*)(::PVOID, ::Enum_3_DB663931210BBC27_42))((::PBYTE)hIl2Cpp + CLASS_1_352A8B3482C80E7D_34_METHOD_1_3DACC45AC8150727_OFFSET))(this, a1);
	}
