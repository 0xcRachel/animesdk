...
#define CLASS_1_5B567C8A01BAEDFE_333_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1B26CD80)
#define CLASS_1_5B567C8A01BAEDFE_333_CLONE_OFFSET UNITYSDK_OFFSET(0x1B26CBF0)
#define CLASS_1_5B567C8A01BAEDFE_333_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1B26CC90)
#define CLASS_1_5B567C8A01BAEDFE_333_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B26CC30)
#define CLASS_1_5B567C8A01BAEDFE_333_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B26CCE0)
#define CLASS_1_5B567C8A01BAEDFE_333_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1B26CDD0)
#define CLASS_1_5B567C8A01BAEDFE_333_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1B26CDA0)
#define CLASS_1_5B567C8A01BAEDFE_333_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1B26CB70)
#define CLASS_1_5B567C8A01BAEDFE_333_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1B26CBA0)
#define CLASS_1_5B567C8A01BAEDFE_333_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B26CD10)
#define CLASS_1_5B567C8A01BAEDFE_333_WRITETO_OFFSET UNITYSDK_OFFSET(0x1B26CD70)
#define CLASS_1_5B567C8A01BAEDFE_333__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B26CE20)
#define CLASS_1_5B567C8A01BAEDFE_333__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B26CBC0)
#define CLASS_1_5B567C8A01BAEDFE_333__CTOR_OFFSET UNITYSDK_OFFSET(0x1B26CBB0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_333*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_333_TypeDefinitionIndex)->GetStaticField(0x6460);
	}
