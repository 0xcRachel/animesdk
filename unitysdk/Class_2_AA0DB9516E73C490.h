...
#define CLASS_2_AA0DB9516E73C490_CLEAR_OFFSET UNITYSDK_OFFSET(0x16A0DBA0)
#define CLASS_2_AA0DB9516E73C490_METHOD_2_07BA34678CBB667B_OFFSET UNITYSDK_OFFSET(0x16A0DD80)
#define CLASS_2_AA0DB9516E73C490_METHOD_2_0D12C41373AA4636_OFFSET UNITYSDK_OFFSET(0x16A0E0A0)
#define CLASS_2_AA0DB9516E73C490__CTOR_OFFSET UNITYSDK_OFFSET(0x16A0E390)
#define CLASS_2_AA0DB9516E73C490___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0x16A0E3B0)
...
public:
	...
	::UnityEngine::Vector3 Field_2_3; // 0x33C
	::System::Single Field_2_1; // 0x348
	::UnityEngine::Vector3 Field_2_0; // 0x34C
	::UnityEngine::Vector3 Field_2_2; // 0x358
