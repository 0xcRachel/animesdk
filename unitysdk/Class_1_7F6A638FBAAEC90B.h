...
#define CLASS_1_7F6A638FBAAEC90B_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1B25BC00)
#define CLASS_1_7F6A638FBAAEC90B_CLONE_OFFSET UNITYSDK_OFFSET(0x1B25B710)
#define CLASS_1_7F6A638FBAAEC90B_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1B25B7D0)
#define CLASS_1_7F6A638FBAAEC90B_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B25B7A0)
#define CLASS_1_7F6A638FBAAEC90B_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B25B8D0)
#define CLASS_1_7F6A638FBAAEC90B_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1B25BEC0)
#define CLASS_1_7F6A638FBAAEC90B_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1B25BDF0)
#define CLASS_1_7F6A638FBAAEC90B_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1B25B780)
#define CLASS_1_7F6A638FBAAEC90B_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1B25B750)
#define CLASS_1_7F6A638FBAAEC90B_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1B25B740)
#define CLASS_1_7F6A638FBAAEC90B_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1B25B560)
#define CLASS_1_7F6A638FBAAEC90B_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x1B25B770)
#define CLASS_1_7F6A638FBAAEC90B_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1B25B790)
#define CLASS_1_7F6A638FBAAEC90B_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1B25B760)
#define CLASS_1_7F6A638FBAAEC90B_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1B25B590)
#define CLASS_1_7F6A638FBAAEC90B_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B25BA80)
#define CLASS_1_7F6A638FBAAEC90B_WRITETO_OFFSET UNITYSDK_OFFSET(0x1B25BAE0)
#define CLASS_1_7F6A638FBAAEC90B__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B25C010)
#define CLASS_1_7F6A638FBAAEC90B__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B25B610)
#define CLASS_1_7F6A638FBAAEC90B__CTOR_OFFSET UNITYSDK_OFFSET(0x1B25B5A0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_7F6A638FBAAEC90B*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_7F6A638FBAAEC90B_TypeDefinitionIndex)->GetStaticField(0x2AFA0);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_7F6A638FBAAEC90B_TypeDefinitionIndex)->GetStaticField(0x2AFA8);
	}
	static ::Google::Protobuf::FieldCodec_1<::Class_1_668FE281FA72D3E8_4*>** StaticGet_Field_1_2()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_668FE281FA72D3E8_4*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_7F6A638FBAAEC90B_TypeDefinitionIndex)->GetStaticField(0x2AFB0);
	}
