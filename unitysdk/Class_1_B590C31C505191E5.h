...
#define CLASS_1_B590C31C505191E5_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A494F50)
#define CLASS_1_B590C31C505191E5_CLONE_OFFSET UNITYSDK_OFFSET(0x1A494BA0)
#define CLASS_1_B590C31C505191E5_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A494CB0)
#define CLASS_1_B590C31C505191E5_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A494C00)
#define CLASS_1_B590C31C505191E5_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A494D50)
#define CLASS_1_B590C31C505191E5_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A495010)
#define CLASS_1_B590C31C505191E5_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A494FC0)
#define CLASS_1_B590C31C505191E5_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1A494BD0)
#define CLASS_1_B590C31C505191E5_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A494A80)
#define CLASS_1_B590C31C505191E5_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1A494BF0)
#define CLASS_1_B590C31C505191E5_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1A494BE0)
#define CLASS_1_B590C31C505191E5_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A494AB0)
#define CLASS_1_B590C31C505191E5_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A494E50)
#define CLASS_1_B590C31C505191E5_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A494EB0)
#define CLASS_1_B590C31C505191E5__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A495140)
#define CLASS_1_B590C31C505191E5__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A494B10)
#define CLASS_1_B590C31C505191E5__CTOR_OFFSET UNITYSDK_OFFSET(0x1A494AC0)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B590C31C505191E5_TypeDefinitionIndex)->GetStaticField(0x29910);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_B590C31C505191E5*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_B590C31C505191E5*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B590C31C505191E5_TypeDefinitionIndex)->GetStaticField(0x29918);
	}
