...
#define CLASS_3_4D3F9F3A8AE3E689_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10C34770)
#define CLASS_3_4D3F9F3A8AE3E689_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10C347B0)
#define CLASS_3_4D3F9F3A8AE3E689_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10C34B00)
#define CLASS_3_4D3F9F3A8AE3E689__CTOR_OFFSET UNITYSDK_OFFSET(0x10C34740)
#define CLASS_3_4D3F9F3A8AE3E689___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10C34B50)
#define CLASS_3_4D3F9F3A8AE3E689___IFIXBASEPROXY_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10C34B90)

inline static constexpr unsigned int Class_3_4D3F9F3A8AE3E689_TypeDefinitionIndex = 41757;
