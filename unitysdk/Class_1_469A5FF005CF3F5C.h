...
#define CLASS_1_469A5FF005CF3F5C_GET_ISUSEFULLPERIOD_OFFSET UNITYSDK_OFFSET(0x113FFF40)
#define CLASS_1_469A5FF005CF3F5C_GET_OVERRIDESHAKECONFIG_OFFSET UNITYSDK_OFFSET(0x113FFF00)
#define CLASS_1_469A5FF005CF3F5C_GET_OVERRIDESHAKESCALE_OFFSET UNITYSDK_OFFSET(0x113FFEE0)
#define CLASS_1_469A5FF005CF3F5C_GET_SHAKECONFIG_OFFSET UNITYSDK_OFFSET(0x113FFE80)
#define CLASS_1_469A5FF005CF3F5C_GET_SHAKEMAXRANGE_OFFSET UNITYSDK_OFFSET(0x113FFEC0)
#define CLASS_1_469A5FF005CF3F5C_GET_SHAKESOURCESCALE_OFFSET UNITYSDK_OFFSET(0x113FFF20)
#define CLASS_1_469A5FF005CF3F5C_GET_TOBEREMOVE_OFFSET UNITYSDK_OFFSET(0x113FFEA0)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_0767ADDAA8C5C79F_OFFSET UNITYSDK_OFFSET(0x113FFF60)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_10054BB010E03EDD_OFFSET UNITYSDK_OFFSET(0x113FF8C0)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_104669F3B9019C27_OFFSET UNITYSDK_OFFSET(0x113FF5D0)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_1808E1CF7A125519_1_OFFSET UNITYSDK_OFFSET(0x113FF4F0)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x113FF490)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_27475ADD357BAB08_OFFSET UNITYSDK_OFFSET(0x113FF2A0)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x113FDE30)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_3422201382CE593B_1_OFFSET UNITYSDK_OFFSET(0x113FE380)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_3422201382CE593B_OFFSET UNITYSDK_OFFSET(0x113FE2F0)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_40E490E2772D5D75_OFFSET UNITYSDK_OFFSET(0x113FF550)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x113FDC20)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_51BAC440AEEC47A9_OFFSET UNITYSDK_OFFSET(0x113FE4B0)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_5E5FAAAE21B44BAE_OFFSET UNITYSDK_OFFSET(0x113FDCA0)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_627557CE4CD0ABB4_OFFSET UNITYSDK_OFFSET(0x113FFA20)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_728B556CCCB971DB_OFFSET UNITYSDK_OFFSET(0x113FD9D0)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_77FD543600E00498_1_OFFSET UNITYSDK_OFFSET(0x113FF3D0)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_77FD543600E00498_OFFSET UNITYSDK_OFFSET(0x113FF1E0)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_83DA3EC57FF907F4_OFFSET UNITYSDK_OFFSET(0x113FE410)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_927E8B22CB9C2007_OFFSET UNITYSDK_OFFSET(0x113FEB80)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_A14686B49BC5A8FE_OFFSET UNITYSDK_OFFSET(0x113FEE80)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_B0C9E67798485BC6_OFFSET UNITYSDK_OFFSET(0x113FE690)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_BA9C9FDB9BD04A4F_OFFSET UNITYSDK_OFFSET(0x113FFB40)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_CA6BDDCC5F7CE11E_OFFSET UNITYSDK_OFFSET(0x113FDF00)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_D1ED5E50F804F962_OFFSET UNITYSDK_OFFSET(0x113FF980)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_FA2C1734FD4CF3EF_OFFSET UNITYSDK_OFFSET(0x113FF060)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0x113FFAE0)
#define CLASS_1_469A5FF005CF3F5C_SET_ISUSEFULLPERIOD_OFFSET UNITYSDK_OFFSET(0x113FFF50)
#define CLASS_1_469A5FF005CF3F5C_SET_OVERRIDESHAKECONFIG_OFFSET UNITYSDK_OFFSET(0x113FFF10)
#define CLASS_1_469A5FF005CF3F5C_SET_OVERRIDESHAKESCALE_OFFSET UNITYSDK_OFFSET(0x113FFEF0)
#define CLASS_1_469A5FF005CF3F5C_SET_SHAKECONFIG_OFFSET UNITYSDK_OFFSET(0x113FFE90)
#define CLASS_1_469A5FF005CF3F5C_SET_SHAKEMAXRANGE_OFFSET UNITYSDK_OFFSET(0x113FFED0)
#define CLASS_1_469A5FF005CF3F5C_SET_SHAKESOURCESCALE_OFFSET UNITYSDK_OFFSET(0x113FFF30)
#define CLASS_1_469A5FF005CF3F5C_SET_TOBEREMOVE_OFFSET UNITYSDK_OFFSET(0x113FFEB0)
#define CLASS_1_469A5FF005CF3F5C__CTOR_OFFSET UNITYSDK_OFFSET(0x113FD7C0)
...
public:
	...
	::Il2CppArray<::Class_1_4194FD1D0EB8BE87*>* Field_1_26; // 0x10
	::RPG::GameCore::VCameraShakeV2* _ShakeConfig_k__BackingField; // 0x18
	::RPG::GameCore::ShakeDistanceAttenuation* Field_1_28; // 0x20
	::RPG::Client::CameraBlendCurve* Field_1_25; // 0x28
	::RPG::GameCore::GameEntity* Field_1_29; // 0x30
	::RPG::GameCore::VCameraOverrideShakeV2* _OverrideShakeConfig_k__BackingField; // 0x38
	::RPG::Client::CameraBlendCurve* Field_1_23; // 0x40
	::Il2CppArray<::Class_1_4194FD1D0EB8BE87*>* Field_1_27; // 0x48
	...
	::System::Single Field_1_13; // 0xA4
	::System::Boolean _TobeRemove_k__BackingField; // 0xA8
	::System::Boolean Field_1_7; // 0xA9
	::System::Boolean _IsUseFullPeriod_k__BackingField; // 0xAA
