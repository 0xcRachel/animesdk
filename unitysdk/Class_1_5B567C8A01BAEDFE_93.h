...
#define CLASS_1_5B567C8A01BAEDFE_93_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A3A1F40)
#define CLASS_1_5B567C8A01BAEDFE_93_CLONE_OFFSET UNITYSDK_OFFSET(0x1A3A1DB0)
#define CLASS_1_5B567C8A01BAEDFE_93_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A3A1E50)
#define CLASS_1_5B567C8A01BAEDFE_93_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A3A1DF0)
#define CLASS_1_5B567C8A01BAEDFE_93_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A3A1EA0)
#define CLASS_1_5B567C8A01BAEDFE_93_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A3A1F90)
#define CLASS_1_5B567C8A01BAEDFE_93_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A3A1F60)
#define CLASS_1_5B567C8A01BAEDFE_93_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A3A1D30)
#define CLASS_1_5B567C8A01BAEDFE_93_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A3A1D60)
#define CLASS_1_5B567C8A01BAEDFE_93_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A3A1ED0)
#define CLASS_1_5B567C8A01BAEDFE_93_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A3A1F30)
#define CLASS_1_5B567C8A01BAEDFE_93__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A3A1FE0)
#define CLASS_1_5B567C8A01BAEDFE_93__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3A1D80)
#define CLASS_1_5B567C8A01BAEDFE_93__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3A1D70)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_93*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_93_TypeDefinitionIndex)->GetStaticField(0x37030);
	}
