...
#define CLASS_1_D11346F5905C32B7_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17CC59C0)
#define CLASS_1_D11346F5905C32B7_CLONE_OFFSET UNITYSDK_OFFSET(0x17CC53D0)
#define CLASS_1_D11346F5905C32B7_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17CC54C0)
#define CLASS_1_D11346F5905C32B7_EQUALS_OFFSET UNITYSDK_OFFSET(0x17CC5490)
#define CLASS_1_D11346F5905C32B7_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17CC5650)
#define CLASS_1_D11346F5905C32B7_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x17CC5D20)
#define CLASS_1_D11346F5905C32B7_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x17CC5B70)
#define CLASS_1_D11346F5905C32B7_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x17CC5440)
#define CLASS_1_D11346F5905C32B7_METHOD_1_24748FC20F375725_1_OFFSET UNITYSDK_OFFSET(0x17CC5420)
#define CLASS_1_D11346F5905C32B7_METHOD_1_24748FC20F375725_2_OFFSET UNITYSDK_OFFSET(0x17CC5460)
#define CLASS_1_D11346F5905C32B7_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x17CC5400)
#define CLASS_1_D11346F5905C32B7_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x17CC5480)
#define CLASS_1_D11346F5905C32B7_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x17CC5450)
#define CLASS_1_D11346F5905C32B7_METHOD_1_8C8625211DA811AE_1_OFFSET UNITYSDK_OFFSET(0x17CC5430)
#define CLASS_1_D11346F5905C32B7_METHOD_1_8C8625211DA811AE_2_OFFSET UNITYSDK_OFFSET(0x17CC5470)
#define CLASS_1_D11346F5905C32B7_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x17CC5410)
#define CLASS_1_D11346F5905C32B7_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17CC5220)
#define CLASS_1_D11346F5905C32B7_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17CC57F0)
#define CLASS_1_D11346F5905C32B7_WRITETO_OFFSET UNITYSDK_OFFSET(0x17CC5850)
#define CLASS_1_D11346F5905C32B7__CCTOR_OFFSET UNITYSDK_OFFSET(0x17CC5EF0)
#define CLASS_1_D11346F5905C32B7__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17CC5270)
#define CLASS_1_D11346F5905C32B7__CTOR_OFFSET UNITYSDK_OFFSET(0x17CC5230)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_14E02E1F6D70E487_2*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_D11346F5905C32B7_TypeDefinitionIndex)->GetStaticField(0x73C0);
	}
	...
	::Class_1_3AD2528CD53B1639_3* Field_1_2; // 0x18
	::Class_1_14E02E1F6D70E487_1* Field_1_4; // 0x20
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_14E02E1F6D70E487_2*>* Field_1_11; // 0x28
	::Class_1_E3BF1E96389B67AF* Field_1_8; // 0x30
