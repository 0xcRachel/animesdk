...
#define CLASS_1_5B567C8A01BAEDFE_125_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A0A3A60)
#define CLASS_1_5B567C8A01BAEDFE_125_CLONE_OFFSET UNITYSDK_OFFSET(0x1A0A38D0)
#define CLASS_1_5B567C8A01BAEDFE_125_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A0A3970)
#define CLASS_1_5B567C8A01BAEDFE_125_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A0A3910)
#define CLASS_1_5B567C8A01BAEDFE_125_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A0A39C0)
#define CLASS_1_5B567C8A01BAEDFE_125_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A0A3AB0)
#define CLASS_1_5B567C8A01BAEDFE_125_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A0A3A80)
#define CLASS_1_5B567C8A01BAEDFE_125_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A0A3850)
#define CLASS_1_5B567C8A01BAEDFE_125_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A0A3880)
#define CLASS_1_5B567C8A01BAEDFE_125_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A0A39F0)
#define CLASS_1_5B567C8A01BAEDFE_125_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A0A3A50)
#define CLASS_1_5B567C8A01BAEDFE_125__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A0A3B00)
#define CLASS_1_5B567C8A01BAEDFE_125__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0A38A0)
#define CLASS_1_5B567C8A01BAEDFE_125__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0A3890)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_125*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_125_TypeDefinitionIndex)->GetStaticField(0x1EAC0);
	}
