...
#define SCENEPROP_SPRINGBONE_INIT_OFFSET UNITYSDK_OFFSET(0xABCA180)
#define SCENEPROP_SPRINGBONE_METHOD_5_D3129FE8DF635B48_OFFSET UNITYSDK_OFFSET(0xABCA1D0)
#define SCENEPROP_SPRINGBONE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xABCA3A0)
#define SCENEPROP_SPRINGBONE_TICK_OFFSET UNITYSDK_OFFSET(0xABCA5B0)
#define SCENEPROP_SPRINGBONE_UPDATESPRING_OFFSET UNITYSDK_OFFSET(0xABCA610)
#define SCENEPROP_SPRINGBONE__CTOR_OFFSET UNITYSDK_OFFSET(0xABCAFD0)
