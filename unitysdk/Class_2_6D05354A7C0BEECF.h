...
#define CLASS_2_6D05354A7C0BEECF__CREATETRIGGER_OFFSET UNITYSDK_OFFSET(0x10C75370)
#define CLASS_2_6D05354A7C0BEECF__CTOR_OFFSET UNITYSDK_OFFSET(0x10C74EB0)
#define CLASS_2_6D05354A7C0BEECF__GETENTITYBYRUNTIMEID_OFFSET UNITYSDK_OFFSET(0x10C757B0)
#define CLASS_2_6D05354A7C0BEECF__ONTRIGGEROUT_OFFSET UNITYSDK_OFFSET(0x10C75880)
#define CLASS_2_6D05354A7C0BEECF__TEARDOWN_OFFSET UNITYSDK_OFFSET(0x10C75210)
#define CLASS_2_6D05354A7C0BEECF___IFIXBASEPROXY__TEARDOWN_OFFSET UNITYSDK_OFFSET(0x10C759B0)

inline static constexpr unsigned int Class_2_6D05354A7C0BEECF_TypeDefinitionIndex = 62510;
