...
#define CLASS_2_6D05354A7C0BEECF__CREATETRIGGER_OFFSET UNITYSDK_OFFSET(0xB5440A0)
#define CLASS_2_6D05354A7C0BEECF__CTOR_OFFSET UNITYSDK_OFFSET(0xB543BE0)
#define CLASS_2_6D05354A7C0BEECF__GETENTITYBYRUNTIMEID_OFFSET UNITYSDK_OFFSET(0xB5443A0)
#define CLASS_2_6D05354A7C0BEECF__ONTRIGGEROUT_OFFSET UNITYSDK_OFFSET(0xB544470)
#define CLASS_2_6D05354A7C0BEECF__TEARDOWN_OFFSET UNITYSDK_OFFSET(0xB543F40)
#define CLASS_2_6D05354A7C0BEECF___IFIXBASEPROXY__TEARDOWN_OFFSET UNITYSDK_OFFSET(0xB5445A0)

inline static constexpr unsigned int Class_2_6D05354A7C0BEECF_TypeDefinitionIndex = 70520;
