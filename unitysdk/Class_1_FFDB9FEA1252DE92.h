...
#define CLASS_1_FFDB9FEA1252DE92_GET_INHERITABILITYPROPERTRIES_OFFSET UNITYSDK_OFFSET(0xCB49F80)
#define CLASS_1_FFDB9FEA1252DE92_GET_ISWOMANHERO_OFFSET UNITYSDK_OFFSET(0xCB49F40)
#define CLASS_1_FFDB9FEA1252DE92_GET_MASTERPROPERTYCALCULATOR_OFFSET UNITYSDK_OFFSET(0xCB49FC0)
#define CLASS_1_FFDB9FEA1252DE92_GET_MASTERPROPERTYCONTEXT_OFFSET UNITYSDK_OFFSET(0xCB49FA0)
#define CLASS_1_FFDB9FEA1252DE92_GET_MASTERSKILLLEVELPROVIDER_OFFSET UNITYSDK_OFFSET(0xCB49FE0)
#define CLASS_1_FFDB9FEA1252DE92_GET_SERVANTSKILLLEVELPROVIDER_OFFSET UNITYSDK_OFFSET(0xCB4A000)
#define CLASS_1_FFDB9FEA1252DE92_GET_SERVANT_OFFSET UNITYSDK_OFFSET(0xCB49F60)
#define CLASS_1_FFDB9FEA1252DE92_METHOD_1_4EC2E1ECDEE1B9F2_OFFSET UNITYSDK_OFFSET(0xCB4ABF0)
#define CLASS_1_FFDB9FEA1252DE92_METHOD_1_6990AE4D09B03418_OFFSET UNITYSDK_OFFSET(0xCB4AC80)
#define CLASS_1_FFDB9FEA1252DE92_METHOD_1_9BB88030A7F69CE7_1_OFFSET UNITYSDK_OFFSET(0xCB4A650)
#define CLASS_1_FFDB9FEA1252DE92_METHOD_1_9BB88030A7F69CE7_OFFSET UNITYSDK_OFFSET(0xCB4A020)
#define CLASS_1_FFDB9FEA1252DE92_METHOD_1_D9B0DB83645D9C63_OFFSET UNITYSDK_OFFSET(0xCB4A560)
#define CLASS_1_FFDB9FEA1252DE92_METHOD_1_F5A6034133A7B441_1_OFFSET UNITYSDK_OFFSET(0xCB4AB90)
#define CLASS_1_FFDB9FEA1252DE92_METHOD_1_F5A6034133A7B441_OFFSET UNITYSDK_OFFSET(0xCB4A5F0)
#define CLASS_1_FFDB9FEA1252DE92_METHOD_1_F89B046E1A9D2C08_1_OFFSET UNITYSDK_OFFSET(0xCB4A760)
#define CLASS_1_FFDB9FEA1252DE92_METHOD_1_F89B046E1A9D2C08_OFFSET UNITYSDK_OFFSET(0xCB4A130)
#define CLASS_1_FFDB9FEA1252DE92_SET_INHERITABILITYPROPERTRIES_OFFSET UNITYSDK_OFFSET(0xCB49F90)
#define CLASS_1_FFDB9FEA1252DE92_SET_ISWOMANHERO_OFFSET UNITYSDK_OFFSET(0xCB49F50)
#define CLASS_1_FFDB9FEA1252DE92_SET_MASTERPROPERTYCALCULATOR_OFFSET UNITYSDK_OFFSET(0xCB49FD0)
#define CLASS_1_FFDB9FEA1252DE92_SET_MASTERPROPERTYCONTEXT_OFFSET UNITYSDK_OFFSET(0xCB49FB0)
#define CLASS_1_FFDB9FEA1252DE92_SET_MASTERSKILLLEVELPROVIDER_OFFSET UNITYSDK_OFFSET(0xCB49FF0)
#define CLASS_1_FFDB9FEA1252DE92_SET_SERVANTSKILLLEVELPROVIDER_OFFSET UNITYSDK_OFFSET(0xCB4A010)
#define CLASS_1_FFDB9FEA1252DE92_SET_SERVANT_OFFSET UNITYSDK_OFFSET(0xCB49F70)
#define CLASS_1_FFDB9FEA1252DE92__CTOR_OFFSET UNITYSDK_OFFSET(0xCB4ACD0)
...
public:
	...
	::RPG::AvatarSystem::Property::IPropertyContext_1<::RPG::GameCore::FixPoint>* _MasterPropertyContext_k__BackingField; // 0x20
	::Class_0_16E4307DCC419505_360* _MasterSkillLevelProvider_k__BackingField; // 0x28
	::RPG::AvatarSystem::AvatarServant* _Servant_k__BackingField; // 0x30
	::Class_0_16E4307DCC419505_360* _ServantSkillLevelProvider_k__BackingField; // 0x38
	...
	::Class_0_16E4307DCC419505_360* get_MasterSkillLevelProvider()
	{
		return ((::Class_0_16E4307DCC419505_360*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_FFDB9FEA1252DE92_GET_MASTERSKILLLEVELPROVIDER_OFFSET))(this);
	}

	::System::Void set_MasterSkillLevelProvider(::Class_0_16E4307DCC419505_360* value)
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_360*))((::PBYTE)hIl2Cpp + CLASS_1_FFDB9FEA1252DE92_SET_MASTERSKILLLEVELPROVIDER_OFFSET))(this, value);
	}

	::Class_0_16E4307DCC419505_360* get_ServantSkillLevelProvider()
	{
		return ((::Class_0_16E4307DCC419505_360*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_FFDB9FEA1252DE92_GET_SERVANTSKILLLEVELPROVIDER_OFFSET))(this);
	}

	::System::Void set_ServantSkillLevelProvider(::Class_0_16E4307DCC419505_360* value)
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_360*))((::PBYTE)hIl2Cpp + CLASS_1_FFDB9FEA1252DE92_SET_SERVANTSKILLLEVELPROVIDER_OFFSET))(this, value);
	}
