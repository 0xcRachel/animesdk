...
#define CLASS_1_B119317995FF66B9_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19D597E0)
#define CLASS_1_B119317995FF66B9_CLONE_OFFSET UNITYSDK_OFFSET(0x19D593C0)
#define CLASS_1_B119317995FF66B9_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19D59510)
#define CLASS_1_B119317995FF66B9_EQUALS_OFFSET UNITYSDK_OFFSET(0x19D59420)
#define CLASS_1_B119317995FF66B9_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19D595C0)
#define CLASS_1_B119317995FF66B9_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19D599B0)
#define CLASS_1_B119317995FF66B9_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19D59910)
#define CLASS_1_B119317995FF66B9_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x19D59400)
#define CLASS_1_B119317995FF66B9_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19D59270)
#define CLASS_1_B119317995FF66B9_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x19D59410)
#define CLASS_1_B119317995FF66B9_METHOD_1_AD515D31D5C81878_OFFSET UNITYSDK_OFFSET(0x19D593F0)
#define CLASS_1_B119317995FF66B9_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19D592A0)
#define CLASS_1_B119317995FF66B9_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19D596B0)
#define CLASS_1_B119317995FF66B9_WRITETO_OFFSET UNITYSDK_OFFSET(0x19D59710)
#define CLASS_1_B119317995FF66B9__CCTOR_OFFSET UNITYSDK_OFFSET(0x19D59A90)
#define CLASS_1_B119317995FF66B9__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19D59300)
#define CLASS_1_B119317995FF66B9__CTOR_OFFSET UNITYSDK_OFFSET(0x19D592B0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_B119317995FF66B9*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B119317995FF66B9_TypeDefinitionIndex)->GetStaticField(0x42020);
	}
	static ::Google::Protobuf::FieldCodec_1<::Proto::PlayerAssistInfo*>** StaticGet_Field_1_3()
	{
		return (::Google::Protobuf::FieldCodec_1<::Proto::PlayerAssistInfo*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B119317995FF66B9_TypeDefinitionIndex)->GetStaticField(0x42028);
	}
	// static const ::System::Int32 Field_1_2 = 0x8; // 0x0
	// static const ::System::Int32 Field_1_5 = 0x5; // 0x0
	::Google::Protobuf::UnknownFieldSet* Field_1_1; // 0x10
	::Google::Protobuf::Collections::RepeatedField_1<::Proto::PlayerAssistInfo*>* Field_1_4; // 0x18
