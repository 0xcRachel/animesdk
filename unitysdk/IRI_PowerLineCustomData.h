...
#define IRI_POWERLINECUSTOMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x10ADC910)

inline static constexpr unsigned int IRI_PowerLineCustomData_TypeDefinitionIndex = 37460;
