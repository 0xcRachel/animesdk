...
#define CLASS_1_5B567C8A01BAEDFE_192_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1ABD4E00)
#define CLASS_1_5B567C8A01BAEDFE_192_CLONE_OFFSET UNITYSDK_OFFSET(0x1ABD4C70)
#define CLASS_1_5B567C8A01BAEDFE_192_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1ABD4D10)
#define CLASS_1_5B567C8A01BAEDFE_192_EQUALS_OFFSET UNITYSDK_OFFSET(0x1ABD4CB0)
#define CLASS_1_5B567C8A01BAEDFE_192_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1ABD4D60)
#define CLASS_1_5B567C8A01BAEDFE_192_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1ABD4E50)
#define CLASS_1_5B567C8A01BAEDFE_192_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1ABD4E20)
#define CLASS_1_5B567C8A01BAEDFE_192_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1ABD4BF0)
#define CLASS_1_5B567C8A01BAEDFE_192_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1ABD4C20)
#define CLASS_1_5B567C8A01BAEDFE_192_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1ABD4D90)
#define CLASS_1_5B567C8A01BAEDFE_192_WRITETO_OFFSET UNITYSDK_OFFSET(0x1ABD4DF0)
#define CLASS_1_5B567C8A01BAEDFE_192__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ABD4EA0)
#define CLASS_1_5B567C8A01BAEDFE_192__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1ABD4C40)
#define CLASS_1_5B567C8A01BAEDFE_192__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABD4C30)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_192*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_192_TypeDefinitionIndex)->GetStaticField(0x27C60);
	}
