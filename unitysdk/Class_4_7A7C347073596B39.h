...
#define CLASS_4_7A7C347073596B39_GETTYPEID_OFFSET UNITYSDK_OFFSET(0x118BBC40)
#define CLASS_4_7A7C347073596B39_METHOD_4_03C4FFAD29DE0852_OFFSET UNITYSDK_OFFSET(0x118BA330)
#define CLASS_4_7A7C347073596B39_METHOD_4_071850D2764E9D4C_OFFSET UNITYSDK_OFFSET(0x118BB070)
#define CLASS_4_7A7C347073596B39_METHOD_4_20FFB454FEEDDC86_OFFSET UNITYSDK_OFFSET(0x118BA830)
#define CLASS_4_7A7C347073596B39_METHOD_4_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0x118BC340)
#define CLASS_4_7A7C347073596B39_METHOD_4_5790A55946AA509D_2_OFFSET UNITYSDK_OFFSET(0x118BC3A0)
#define CLASS_4_7A7C347073596B39_METHOD_4_5790A55946AA509D_3_OFFSET UNITYSDK_OFFSET(0x118BC400)
#define CLASS_4_7A7C347073596B39_METHOD_4_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x118BC2E0)
#define CLASS_4_7A7C347073596B39_METHOD_4_6112A1276899AF0F_OFFSET UNITYSDK_OFFSET(0x118BB680)
#define CLASS_4_7A7C347073596B39_METHOD_4_74B53E9267CE3010_OFFSET UNITYSDK_OFFSET(0x118BA870)
#define CLASS_4_7A7C347073596B39_METHOD_4_847FE1E8693369EC_OFFSET UNITYSDK_OFFSET(0x118BA630)
#define CLASS_4_7A7C347073596B39_METHOD_4_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x118BB930)
#define CLASS_4_7A7C347073596B39_METHOD_4_9A91A67DCFAFF737_OFFSET UNITYSDK_OFFSET(0x118BA980)
#define CLASS_4_7A7C347073596B39_METHOD_4_D0CD9A971CA3B1CF_OFFSET UNITYSDK_OFFSET(0x118BB990)
#define CLASS_4_7A7C347073596B39_ONBEGINSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x118BBF00)
#define CLASS_4_7A7C347073596B39_ONENDSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x118BBF50)
#define CLASS_4_7A7C347073596B39_ONOBJECTENABLE_OFFSET UNITYSDK_OFFSET(0x118BBFE0)
#define CLASS_4_7A7C347073596B39_ONSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x118BBE50)
#define CLASS_4_7A7C347073596B39_ONUNSERIALIZEFINISH_OFFSET UNITYSDK_OFFSET(0x118BBE10)
#define CLASS_4_7A7C347073596B39_TICK_OFFSET UNITYSDK_OFFSET(0x118BBA40)
#define CLASS_4_7A7C347073596B39_UNSERIALIZEASYNC_OFFSET UNITYSDK_OFFSET(0x118BBC90)
#define CLASS_4_7A7C347073596B39__CCTOR_OFFSET UNITYSDK_OFFSET(0x118BC1E0)
#define CLASS_4_7A7C347073596B39__CTOR_OFFSET UNITYSDK_OFFSET(0x118BC1D0)
#define CLASS_4_7A7C347073596B39___IFIXBASEPROXY_ONBEGINSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x118BC5A0)
#define CLASS_4_7A7C347073596B39___IFIXBASEPROXY_ONENDSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x118BC610)
#define CLASS_4_7A7C347073596B39___IFIXBASEPROXY_ONOBJECTENABLE_OFFSET UNITYSDK_OFFSET(0x118BC680)
#define CLASS_4_7A7C347073596B39___IFIXBASEPROXY_ONSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x118BC530)
#define CLASS_4_7A7C347073596B39___IFIXBASEPROXY_ONUNSERIALIZEFINISH_OFFSET UNITYSDK_OFFSET(0x118BC4D0)
#define CLASS_4_7A7C347073596B39___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x118BC460)
...
public:
	...
	{
		return (::UnityEngine::Material**)Il2CppClass::FromTypeDefinitionIndex(Class_4_7A7C347073596B39_TypeDefinitionIndex)->GetStaticField(0x5E600);
	}
	static ::Il2CppArray<::UnityEngine::Rendering::BlendMode>** StaticGet_Field_4_0()
	{
		return (::Il2CppArray<::UnityEngine::Rendering::BlendMode>**)Il2CppClass::FromTypeDefinitionIndex(Class_4_7A7C347073596B39_TypeDefinitionIndex)->GetStaticField(0x5E608);
	}
	static ::Il2CppArray<::UnityEngine::Rendering::BlendMode>** StaticGet_Field_4_1()
	{
		return (::Il2CppArray<::UnityEngine::Rendering::BlendMode>**)Il2CppClass::FromTypeDefinitionIndex(Class_4_7A7C347073596B39_TypeDefinitionIndex)->GetStaticField(0x5E610);
	}
	::UnityEngine::MeshFilter* Field_4_4; // 0x48
	::UnityEngine::Material* Field_4_2; // 0x50
	::UnityEngine::Mesh* Field_4_3; // 0x58
	::UnityEngine::MeshRenderer* Field_4_5; // 0x60
