...
#define CLASS_4_7A7C347073596B39_GETTYPEID_OFFSET UNITYSDK_OFFSET(0x11613370)
#define CLASS_4_7A7C347073596B39_METHOD_4_03C4FFAD29DE0852_OFFSET UNITYSDK_OFFSET(0x11611A60)
#define CLASS_4_7A7C347073596B39_METHOD_4_071850D2764E9D4C_OFFSET UNITYSDK_OFFSET(0x116127A0)
#define CLASS_4_7A7C347073596B39_METHOD_4_20FFB454FEEDDC86_OFFSET UNITYSDK_OFFSET(0x11611F60)
#define CLASS_4_7A7C347073596B39_METHOD_4_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0x11613A70)
#define CLASS_4_7A7C347073596B39_METHOD_4_5790A55946AA509D_2_OFFSET UNITYSDK_OFFSET(0x11613AD0)
#define CLASS_4_7A7C347073596B39_METHOD_4_5790A55946AA509D_3_OFFSET UNITYSDK_OFFSET(0x11613B30)
#define CLASS_4_7A7C347073596B39_METHOD_4_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x11613A10)
#define CLASS_4_7A7C347073596B39_METHOD_4_6112A1276899AF0F_OFFSET UNITYSDK_OFFSET(0x11612DB0)
#define CLASS_4_7A7C347073596B39_METHOD_4_74B53E9267CE3010_OFFSET UNITYSDK_OFFSET(0x11611FA0)
#define CLASS_4_7A7C347073596B39_METHOD_4_847FE1E8693369EC_OFFSET UNITYSDK_OFFSET(0x11611D60)
#define CLASS_4_7A7C347073596B39_METHOD_4_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x11613060)
#define CLASS_4_7A7C347073596B39_METHOD_4_9A91A67DCFAFF737_OFFSET UNITYSDK_OFFSET(0x116120B0)
#define CLASS_4_7A7C347073596B39_METHOD_4_D0CD9A971CA3B1CF_OFFSET UNITYSDK_OFFSET(0x116130C0)
#define CLASS_4_7A7C347073596B39_ONBEGINSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x11613630)
#define CLASS_4_7A7C347073596B39_ONENDSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x11613680)
#define CLASS_4_7A7C347073596B39_ONOBJECTENABLE_OFFSET UNITYSDK_OFFSET(0x11613710)
#define CLASS_4_7A7C347073596B39_ONSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x11613580)
#define CLASS_4_7A7C347073596B39_ONUNSERIALIZEFINISH_OFFSET UNITYSDK_OFFSET(0x11613540)
#define CLASS_4_7A7C347073596B39_TICK_OFFSET UNITYSDK_OFFSET(0x11613170)
#define CLASS_4_7A7C347073596B39_UNSERIALIZEASYNC_OFFSET UNITYSDK_OFFSET(0x116133C0)
#define CLASS_4_7A7C347073596B39__CCTOR_OFFSET UNITYSDK_OFFSET(0x11613910)
#define CLASS_4_7A7C347073596B39__CTOR_OFFSET UNITYSDK_OFFSET(0x11613900)
#define CLASS_4_7A7C347073596B39___IFIXBASEPROXY_ONBEGINSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x11613CD0)
#define CLASS_4_7A7C347073596B39___IFIXBASEPROXY_ONENDSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x11613D40)
#define CLASS_4_7A7C347073596B39___IFIXBASEPROXY_ONOBJECTENABLE_OFFSET UNITYSDK_OFFSET(0x11613DB0)
#define CLASS_4_7A7C347073596B39___IFIXBASEPROXY_ONSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x11613C60)
#define CLASS_4_7A7C347073596B39___IFIXBASEPROXY_ONUNSERIALIZEFINISH_OFFSET UNITYSDK_OFFSET(0x11613C00)
#define CLASS_4_7A7C347073596B39___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x11613B90)
...
public:
	...
	{
		return (::UnityEngine::Material**)Il2CppClass::FromTypeDefinitionIndex(Class_4_7A7C347073596B39_TypeDefinitionIndex)->GetStaticField(0x2D170);
	}
	static ::Il2CppArray<::UnityEngine::Rendering::BlendMode>** StaticGet_Field_4_1()
	{
		return (::Il2CppArray<::UnityEngine::Rendering::BlendMode>**)Il2CppClass::FromTypeDefinitionIndex(Class_4_7A7C347073596B39_TypeDefinitionIndex)->GetStaticField(0x2D178);
	}
	static ::Il2CppArray<::UnityEngine::Rendering::BlendMode>** StaticGet_Field_4_0()
	{
		return (::Il2CppArray<::UnityEngine::Rendering::BlendMode>**)Il2CppClass::FromTypeDefinitionIndex(Class_4_7A7C347073596B39_TypeDefinitionIndex)->GetStaticField(0x2D180);
	}
	::UnityEngine::MeshRenderer* Field_4_5; // 0x48
	::UnityEngine::Material* Field_4_2; // 0x50
	::UnityEngine::MeshFilter* Field_4_4; // 0x58
