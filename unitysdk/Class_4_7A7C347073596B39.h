...
#define CLASS_4_7A7C347073596B39_GETTYPEID_OFFSET UNITYSDK_OFFSET(0x1035E450)
#define CLASS_4_7A7C347073596B39_METHOD_4_03C4FFAD29DE0852_OFFSET UNITYSDK_OFFSET(0x1035CB70)
#define CLASS_4_7A7C347073596B39_METHOD_4_071850D2764E9D4C_OFFSET UNITYSDK_OFFSET(0x1035D880)
#define CLASS_4_7A7C347073596B39_METHOD_4_20FFB454FEEDDC86_OFFSET UNITYSDK_OFFSET(0x1035D070)
#define CLASS_4_7A7C347073596B39_METHOD_4_44C6CCA23B6DBC57_OFFSET UNITYSDK_OFFSET(0x1035D0B0)
#define CLASS_4_7A7C347073596B39_METHOD_4_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0x1035EB50)
#define CLASS_4_7A7C347073596B39_METHOD_4_5790A55946AA509D_2_OFFSET UNITYSDK_OFFSET(0x1035EBB0)
#define CLASS_4_7A7C347073596B39_METHOD_4_5790A55946AA509D_3_OFFSET UNITYSDK_OFFSET(0x1035EC10)
#define CLASS_4_7A7C347073596B39_METHOD_4_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x1035EAF0)
#define CLASS_4_7A7C347073596B39_METHOD_4_6112A1276899AF0F_OFFSET UNITYSDK_OFFSET(0x1035DE90)
#define CLASS_4_7A7C347073596B39_METHOD_4_847FE1E8693369EC_OFFSET UNITYSDK_OFFSET(0x1035CE70)
#define CLASS_4_7A7C347073596B39_METHOD_4_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1035E140)
#define CLASS_4_7A7C347073596B39_METHOD_4_9A91A67DCFAFF737_OFFSET UNITYSDK_OFFSET(0x1035D190)
#define CLASS_4_7A7C347073596B39_METHOD_4_D0CD9A971CA3B1CF_OFFSET UNITYSDK_OFFSET(0x1035E1A0)
#define CLASS_4_7A7C347073596B39_ONBEGINSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x1035E710)
#define CLASS_4_7A7C347073596B39_ONENDSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x1035E760)
#define CLASS_4_7A7C347073596B39_ONOBJECTENABLE_OFFSET UNITYSDK_OFFSET(0x1035E7F0)
#define CLASS_4_7A7C347073596B39_ONSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x1035E660)
#define CLASS_4_7A7C347073596B39_ONUNSERIALIZEFINISH_OFFSET UNITYSDK_OFFSET(0x1035E620)
#define CLASS_4_7A7C347073596B39_TICK_OFFSET UNITYSDK_OFFSET(0x1035E250)
#define CLASS_4_7A7C347073596B39_UNSERIALIZEASYNC_OFFSET UNITYSDK_OFFSET(0x1035E4A0)
#define CLASS_4_7A7C347073596B39__CCTOR_OFFSET UNITYSDK_OFFSET(0x1035E9F0)
#define CLASS_4_7A7C347073596B39__CTOR_OFFSET UNITYSDK_OFFSET(0x1035E9E0)
#define CLASS_4_7A7C347073596B39___IFIXBASEPROXY_ONBEGINSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x1035EDB0)
#define CLASS_4_7A7C347073596B39___IFIXBASEPROXY_ONENDSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x1035EE20)
#define CLASS_4_7A7C347073596B39___IFIXBASEPROXY_ONOBJECTENABLE_OFFSET UNITYSDK_OFFSET(0x1035EE90)
#define CLASS_4_7A7C347073596B39___IFIXBASEPROXY_ONSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x1035ED40)
#define CLASS_4_7A7C347073596B39___IFIXBASEPROXY_ONUNSERIALIZEFINISH_OFFSET UNITYSDK_OFFSET(0x1035ECE0)
#define CLASS_4_7A7C347073596B39___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x1035EC70)

inline static constexpr unsigned int Class_4_7A7C347073596B39_TypeDefinitionIndex = 56417;
...
public:
	...
	{
		return (::UnityEngine::Material**)Il2CppClass::FromTypeDefinitionIndex(Class_4_7A7C347073596B39_TypeDefinitionIndex)->GetStaticField(0x3CE60);
	}
	static ::Il2CppArray<::UnityEngine::Rendering::BlendMode>** StaticGet_Field_4_1()
	{
		return (::Il2CppArray<::UnityEngine::Rendering::BlendMode>**)Il2CppClass::FromTypeDefinitionIndex(Class_4_7A7C347073596B39_TypeDefinitionIndex)->GetStaticField(0x3CE68);
	}
	static ::Il2CppArray<::UnityEngine::Rendering::BlendMode>** StaticGet_Field_4_0()
	{
		return (::Il2CppArray<::UnityEngine::Rendering::BlendMode>**)Il2CppClass::FromTypeDefinitionIndex(Class_4_7A7C347073596B39_TypeDefinitionIndex)->GetStaticField(0x3CE70);
	}
	::UnityEngine::MeshRenderer* Field_4_5; // 0x48
	::UnityEngine::MeshFilter* Field_4_4; // 0x50
	::UnityEngine::Material* Field_4_2; // 0x58
	::UnityEngine::Mesh* Field_4_3; // 0x60
	::UnityEngine::Material* Field_4_8; // 0x68
	...
	::System::Void Method_4_44C6CCA23B6DBC57(::System::Boolean a1, ::System::Boolean a2)
	{
		return ((::System::Void(*)(::PVOID, ::System::Boolean, ::System::Boolean))((::PBYTE)hIl2Cpp + CLASS_4_7A7C347073596B39_METHOD_4_44C6CCA23B6DBC57_OFFSET))(this, a1, a2);
	}
