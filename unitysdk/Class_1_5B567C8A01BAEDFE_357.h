...
#define CLASS_1_5B567C8A01BAEDFE_357_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19A4A7F0)
#define CLASS_1_5B567C8A01BAEDFE_357_CLONE_OFFSET UNITYSDK_OFFSET(0x19A4A600)
#define CLASS_1_5B567C8A01BAEDFE_357_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19A4A700)
#define CLASS_1_5B567C8A01BAEDFE_357_EQUALS_OFFSET UNITYSDK_OFFSET(0x19A4A670)
#define CLASS_1_5B567C8A01BAEDFE_357_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19A4A750)
#define CLASS_1_5B567C8A01BAEDFE_357_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19A4A840)
#define CLASS_1_5B567C8A01BAEDFE_357_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19A4A810)
#define CLASS_1_5B567C8A01BAEDFE_357_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19A4A550)
#define CLASS_1_5B567C8A01BAEDFE_357_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19A4A5B0)
#define CLASS_1_5B567C8A01BAEDFE_357_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19A4A780)
#define CLASS_1_5B567C8A01BAEDFE_357_WRITETO_OFFSET UNITYSDK_OFFSET(0x19A4A7E0)
#define CLASS_1_5B567C8A01BAEDFE_357__CCTOR_OFFSET UNITYSDK_OFFSET(0x19A4A890)
#define CLASS_1_5B567C8A01BAEDFE_357__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19A4A5D0)
#define CLASS_1_5B567C8A01BAEDFE_357__CTOR_OFFSET UNITYSDK_OFFSET(0x19A4A5C0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_357*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_357_TypeDefinitionIndex)->GetStaticField(0x3D070);
	}
