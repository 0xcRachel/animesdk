...
#define CLASS_1_B4357A1C72BABC6B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16638850)
#define CLASS_1_B4357A1C72BABC6B_GET_ALLCONTEXTS_OFFSET UNITYSDK_OFFSET(0x16638990)
#define CLASS_1_B4357A1C72BABC6B_GET_CAKERACECORE_OFFSET UNITYSDK_OFFSET(0x16638980)
#define CLASS_1_B4357A1C72BABC6B__CTOR_OFFSET UNITYSDK_OFFSET(0x16638770)
...
{
public:
	::Class_2_099B78418029B3B1_2* _cakeRaceCore_k__BackingField; // 0x10
