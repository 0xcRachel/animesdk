...
#define CLASS_1_5B567C8A01BAEDFE_317_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A06AA50)
#define CLASS_1_5B567C8A01BAEDFE_317_CLONE_OFFSET UNITYSDK_OFFSET(0x1A06A8C0)
#define CLASS_1_5B567C8A01BAEDFE_317_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A06A960)
#define CLASS_1_5B567C8A01BAEDFE_317_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A06A900)
#define CLASS_1_5B567C8A01BAEDFE_317_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A06A9B0)
#define CLASS_1_5B567C8A01BAEDFE_317_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A06AAA0)
#define CLASS_1_5B567C8A01BAEDFE_317_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A06AA70)
#define CLASS_1_5B567C8A01BAEDFE_317_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A06A840)
#define CLASS_1_5B567C8A01BAEDFE_317_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A06A870)
#define CLASS_1_5B567C8A01BAEDFE_317_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A06A9E0)
#define CLASS_1_5B567C8A01BAEDFE_317_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A06AA40)
#define CLASS_1_5B567C8A01BAEDFE_317__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A06AAF0)
#define CLASS_1_5B567C8A01BAEDFE_317__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A06A890)
#define CLASS_1_5B567C8A01BAEDFE_317__CTOR_OFFSET UNITYSDK_OFFSET(0x1A06A880)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_317*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_317_TypeDefinitionIndex)->GetStaticField(0x42280);
	}
