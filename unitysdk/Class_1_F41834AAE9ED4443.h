...
#define CLASS_1_F41834AAE9ED4443__CTOR_OFFSET UNITYSDK_OFFSET(0xAC5AE30)

inline static constexpr unsigned int Class_1_F41834AAE9ED4443_TypeDefinitionIndex = 58858;
...
public:
	...
	::RPG::GameCore::ControlSkillType Field_1_4; // 0x28
	::System::Boolean Field_1_3; // 0x2C
	::RPG::GameCore::SkillButtonAdditionalStatusType Field_1_2; // 0x30
