...
#define CLASS_1_5B567C8A01BAEDFE_44_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19C49C70)
#define CLASS_1_5B567C8A01BAEDFE_44_CLONE_OFFSET UNITYSDK_OFFSET(0x19C49A80)
#define CLASS_1_5B567C8A01BAEDFE_44_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19C49B80)
#define CLASS_1_5B567C8A01BAEDFE_44_EQUALS_OFFSET UNITYSDK_OFFSET(0x19C49AF0)
#define CLASS_1_5B567C8A01BAEDFE_44_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19C49BD0)
#define CLASS_1_5B567C8A01BAEDFE_44_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19C49CC0)
#define CLASS_1_5B567C8A01BAEDFE_44_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19C49C90)
#define CLASS_1_5B567C8A01BAEDFE_44_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19C499D0)
#define CLASS_1_5B567C8A01BAEDFE_44_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19C49A30)
#define CLASS_1_5B567C8A01BAEDFE_44_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19C49C00)
#define CLASS_1_5B567C8A01BAEDFE_44_WRITETO_OFFSET UNITYSDK_OFFSET(0x19C49C60)
#define CLASS_1_5B567C8A01BAEDFE_44__CCTOR_OFFSET UNITYSDK_OFFSET(0x19C49D10)
#define CLASS_1_5B567C8A01BAEDFE_44__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19C49A50)
#define CLASS_1_5B567C8A01BAEDFE_44__CTOR_OFFSET UNITYSDK_OFFSET(0x19C49A40)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_44*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_44_TypeDefinitionIndex)->GetStaticField(0x4EC40);
	}
