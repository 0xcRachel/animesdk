...
#define AKSPATIALAUDIOINITSETTINGS_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x18C32A10)
#define AKSPATIALAUDIOINITSETTINGS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18C32920)
#define AKSPATIALAUDIOINITSETTINGS_FINALIZE_OFFSET UNITYSDK_OFFSET(0x18C329A0)
#define AKSPATIALAUDIOINITSETTINGS_GETCPTR_OFFSET UNITYSDK_OFFSET(0x18C32810)
#define AKSPATIALAUDIOINITSETTINGS_GET_BENABLEDIFFRACTIONONREFLECTION_OFFSET UNITYSDK_OFFSET(0x18C33B20)
#define AKSPATIALAUDIOINITSETTINGS_GET_BENABLEDIRECTPATHDIFFRACTION_OFFSET UNITYSDK_OFFSET(0x18C33DE0)
#define AKSPATIALAUDIOINITSETTINGS_GET_BENABLETRANSMISSION_OFFSET UNITYSDK_OFFSET(0x18C33F50)
#define AKSPATIALAUDIOINITSETTINGS_GET_FDIFFRACTIONSHADOWATTENFACTOR_OFFSET UNITYSDK_OFFSET(0x18C33130)
#define AKSPATIALAUDIOINITSETTINGS_GET_FDIFFRACTIONSHADOWDEGREES_OFFSET UNITYSDK_OFFSET(0x18C333F0)
#define AKSPATIALAUDIOINITSETTINGS_GET_FMAXPATHLENGTH_OFFSET UNITYSDK_OFFSET(0x18C339B0)
#define AKSPATIALAUDIOINITSETTINGS_GET_FMOVEMENTTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x18C33560)
#define AKSPATIALAUDIOINITSETTINGS_GET_UDIFFRACTIONFLAGS_OFFSET UNITYSDK_OFFSET(0x18C32E60)
#define AKSPATIALAUDIOINITSETTINGS_GET_UMAXREFLECTIONORDER_OFFSET UNITYSDK_OFFSET(0x18C33840)
#define AKSPATIALAUDIOINITSETTINGS_GET_UMAXSOUNDPROPAGATIONDEPTH_OFFSET UNITYSDK_OFFSET(0x18C32CF0)
#define AKSPATIALAUDIOINITSETTINGS_GET_UNUMBEROFPRIMARYRAYS_OFFSET UNITYSDK_OFFSET(0x18C336D0)
#define AKSPATIALAUDIOINITSETTINGS_SETCPTR_OFFSET UNITYSDK_OFFSET(0x18C32860)
#define AKSPATIALAUDIOINITSETTINGS_SET_BENABLEDIFFRACTIONONREFLECTION_OFFSET UNITYSDK_OFFSET(0x18C33A60)
#define AKSPATIALAUDIOINITSETTINGS_SET_BENABLEDIRECTPATHDIFFRACTION_OFFSET UNITYSDK_OFFSET(0x18C33D20)
#define AKSPATIALAUDIOINITSETTINGS_SET_BENABLETRANSMISSION_OFFSET UNITYSDK_OFFSET(0x18C33E90)
#define AKSPATIALAUDIOINITSETTINGS_SET_FDIFFRACTIONSHADOWATTENFACTOR_OFFSET UNITYSDK_OFFSET(0x18C32F10)
#define AKSPATIALAUDIOINITSETTINGS_SET_FDIFFRACTIONSHADOWDEGREES_OFFSET UNITYSDK_OFFSET(0x18C33330)
#define AKSPATIALAUDIOINITSETTINGS_SET_FMAXPATHLENGTH_OFFSET UNITYSDK_OFFSET(0x18C338F0)
#define AKSPATIALAUDIOINITSETTINGS_SET_FMOVEMENTTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x18C334A0)
#define AKSPATIALAUDIOINITSETTINGS_SET_UDIFFRACTIONFLAGS_OFFSET UNITYSDK_OFFSET(0x18C32DA0)
#define AKSPATIALAUDIOINITSETTINGS_SET_UMAXREFLECTIONORDER_OFFSET UNITYSDK_OFFSET(0x18C33780)
#define AKSPATIALAUDIOINITSETTINGS_SET_UMAXSOUNDPROPAGATIONDEPTH_OFFSET UNITYSDK_OFFSET(0x18C32C30)
#define AKSPATIALAUDIOINITSETTINGS_SET_UNUMBEROFPRIMARYRAYS_OFFSET UNITYSDK_OFFSET(0x18C33610)
#define AKSPATIALAUDIOINITSETTINGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18C32BB0)
#define AKSPATIALAUDIOINITSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x18C32800)
