...
#define CLASS_1_CDA7391AC2DCC34A_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A945CE0)
#define CLASS_1_CDA7391AC2DCC34A_CLONE_OFFSET UNITYSDK_OFFSET(0x1A9455E0)
#define CLASS_1_CDA7391AC2DCC34A_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A945660)
#define CLASS_1_CDA7391AC2DCC34A_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A945630)
#define CLASS_1_CDA7391AC2DCC34A_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A9459A0)
#define CLASS_1_CDA7391AC2DCC34A_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A946180)
#define CLASS_1_CDA7391AC2DCC34A_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A945F40)
#define CLASS_1_CDA7391AC2DCC34A_METHOD_1_2ACF2A61FB239D23_OFFSET UNITYSDK_OFFSET(0x1A945610)
#define CLASS_1_CDA7391AC2DCC34A_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A945210)
#define CLASS_1_CDA7391AC2DCC34A_METHOD_1_6BCB722BBE18B904_1_OFFSET UNITYSDK_OFFSET(0x1A945530)
#define CLASS_1_CDA7391AC2DCC34A_METHOD_1_6BCB722BBE18B904_OFFSET UNITYSDK_OFFSET(0x1A945480)
#define CLASS_1_CDA7391AC2DCC34A_METHOD_1_7E46B904D08C26AC_OFFSET UNITYSDK_OFFSET(0x1A945420)
#define CLASS_1_CDA7391AC2DCC34A_METHOD_1_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x1A945620)
#define CLASS_1_CDA7391AC2DCC34A_METHOD_1_ECF173E3C678F858_OFFSET UNITYSDK_OFFSET(0x1A945460)
#define CLASS_1_CDA7391AC2DCC34A_METHOD_1_F45A6C563F3DF7EB_1_OFFSET UNITYSDK_OFFSET(0x1A9455B0)
#define CLASS_1_CDA7391AC2DCC34A_METHOD_1_F45A6C563F3DF7EB_OFFSET UNITYSDK_OFFSET(0x1A945500)
#define CLASS_1_CDA7391AC2DCC34A_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A945240)
#define CLASS_1_CDA7391AC2DCC34A_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A945AC0)
#define CLASS_1_CDA7391AC2DCC34A_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A945B20)
#define CLASS_1_CDA7391AC2DCC34A__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A9463B0)
#define CLASS_1_CDA7391AC2DCC34A__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A945260)
#define CLASS_1_CDA7391AC2DCC34A__CTOR_OFFSET UNITYSDK_OFFSET(0x1A945250)

inline static constexpr unsigned int Class_1_CDA7391AC2DCC34A_TypeDefinitionIndex = 32323;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_CDA7391AC2DCC34A*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_CDA7391AC2DCC34A_TypeDefinitionIndex)->GetStaticField(0x27100);
	}
