...
#define CLASS_2_F2E0C86CDCFDBD05_METHOD_2_0B7E3489D2C0938B_OFFSET UNITYSDK_OFFSET(0xFDE64C0)
#define CLASS_2_F2E0C86CDCFDBD05_METHOD_2_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xFDE67A0)
#define CLASS_2_F2E0C86CDCFDBD05_METHOD_2_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0xFDE6370)
#define CLASS_2_F2E0C86CDCFDBD05_METHOD_2_A36150C5DCC8409E_1_OFFSET UNITYSDK_OFFSET(0xFDE6470)
#define CLASS_2_F2E0C86CDCFDBD05_METHOD_2_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0xFDE6420)
#define CLASS_2_F2E0C86CDCFDBD05_METHOD_2_ADF4AD3331B4D7AD_OFFSET UNITYSDK_OFFSET(0xFDE63D0)
#define CLASS_2_F2E0C86CDCFDBD05__CTOR_1_OFFSET UNITYSDK_OFFSET(0xFDE6300)
#define CLASS_2_F2E0C86CDCFDBD05__CTOR_OFFSET UNITYSDK_OFFSET(0xFDE62E0)

inline static constexpr unsigned int Class_2_F2E0C86CDCFDBD05_TypeDefinitionIndex = 47596;

class Class_2_F2E0C86CDCFDBD05 : public ::Class_1_92608A36037A1D69
{
public:
	::RPG::Client::UIAdaptionIndentType Field_2_0; // 0x30
