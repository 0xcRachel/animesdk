...
#define CLASS_1_F35A502C9C1ED79D_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A3005B0)
#define CLASS_1_F35A502C9C1ED79D_CLONE_OFFSET UNITYSDK_OFFSET(0x1A300030)
#define CLASS_1_F35A502C9C1ED79D_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A300210)
#define CLASS_1_F35A502C9C1ED79D_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A300110)
#define CLASS_1_F35A502C9C1ED79D_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A3002D0)
#define CLASS_1_F35A502C9C1ED79D_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A300820)
#define CLASS_1_F35A502C9C1ED79D_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A3007B0)
#define CLASS_1_F35A502C9C1ED79D_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1A3000F0)
#define CLASS_1_F35A502C9C1ED79D_METHOD_1_3163C288F3AE2966_OFFSET UNITYSDK_OFFSET(0x1A300090)
#define CLASS_1_F35A502C9C1ED79D_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A2FFED0)
#define CLASS_1_F35A502C9C1ED79D_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1A3000E0)
#define CLASS_1_F35A502C9C1ED79D_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1A300100)
#define CLASS_1_F35A502C9C1ED79D_METHOD_1_C74E50CBD41F0264_1_OFFSET UNITYSDK_OFFSET(0x1A3000D0)
#define CLASS_1_F35A502C9C1ED79D_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1A3000B0)
#define CLASS_1_F35A502C9C1ED79D_METHOD_1_CE81D059476B1F49_OFFSET UNITYSDK_OFFSET(0x1A300080)
#define CLASS_1_F35A502C9C1ED79D_METHOD_1_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0x1A3000C0)
#define CLASS_1_F35A502C9C1ED79D_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1A3000A0)
#define CLASS_1_F35A502C9C1ED79D_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A2FFF30)
#define CLASS_1_F35A502C9C1ED79D_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A300400)
#define CLASS_1_F35A502C9C1ED79D_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A300460)
#define CLASS_1_F35A502C9C1ED79D__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A300940)
#define CLASS_1_F35A502C9C1ED79D__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A2FFF90)
#define CLASS_1_F35A502C9C1ED79D__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2FFF40)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_F35A502C9C1ED79D_TypeDefinitionIndex)->GetStaticField(0x48DE0);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_F35A502C9C1ED79D*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_F35A502C9C1ED79D*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_F35A502C9C1ED79D_TypeDefinitionIndex)->GetStaticField(0x48DE8);
	}
