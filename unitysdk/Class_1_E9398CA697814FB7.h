...
#define CLASS_1_E9398CA697814FB7_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17453090)
#define CLASS_1_E9398CA697814FB7_CLONE_OFFSET UNITYSDK_OFFSET(0x17452C00)
#define CLASS_1_E9398CA697814FB7_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17452CF0)
#define CLASS_1_E9398CA697814FB7_EQUALS_OFFSET UNITYSDK_OFFSET(0x17452C90)
#define CLASS_1_E9398CA697814FB7_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17452DE0)
#define CLASS_1_E9398CA697814FB7_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x17453250)
#define CLASS_1_E9398CA697814FB7_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x174531C0)
#define CLASS_1_E9398CA697814FB7_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x17452C50)
#define CLASS_1_E9398CA697814FB7_METHOD_1_217A4C673B33B3F5_OFFSET UNITYSDK_OFFSET(0x17452C80)
#define CLASS_1_E9398CA697814FB7_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x17452C70)
#define CLASS_1_E9398CA697814FB7_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x17452C60)
#define CLASS_1_E9398CA697814FB7_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17452A30)
#define CLASS_1_E9398CA697814FB7_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17452F30)
#define CLASS_1_E9398CA697814FB7_WRITETO_OFFSET UNITYSDK_OFFSET(0x17452F90)
#define CLASS_1_E9398CA697814FB7__CCTOR_OFFSET UNITYSDK_OFFSET(0x174533A0)
#define CLASS_1_E9398CA697814FB7__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17452AD0)
#define CLASS_1_E9398CA697814FB7__CTOR_OFFSET UNITYSDK_OFFSET(0x17452A40)

inline static constexpr unsigned int Class_1_E9398CA697814FB7_TypeDefinitionIndex = 22570;
...
public:
	...
	{
		return (::Google::Protobuf::Collections::MapField_2_Codec<::System::UInt32, ::Class_1_E7C4009BCC22497A_1*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E9398CA697814FB7_TypeDefinitionIndex)->GetStaticField(0x33AA0);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_4()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E9398CA697814FB7_TypeDefinitionIndex)->GetStaticField(0x33AA8);
	}
	// static const ::System::Int32 Field_1_1 = 0x1; // 0x0
	// static const ::System::Int32 Field_1_3 = 0x2; // 0x0
	// static const ::System::Int32 Field_1_6 = 0x5; // 0x0
	::Google::Protobuf::Collections::MapField_2<::System::UInt32, ::Class_1_E7C4009BCC22497A_1*>* Field_1_8; // 0x10
