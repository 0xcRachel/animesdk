...
#define CLASS_1_E9398CA697814FB7_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17AB8F70)
#define CLASS_1_E9398CA697814FB7_CLONE_OFFSET UNITYSDK_OFFSET(0x17AB8AE0)
#define CLASS_1_E9398CA697814FB7_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17AB8BD0)
#define CLASS_1_E9398CA697814FB7_EQUALS_OFFSET UNITYSDK_OFFSET(0x17AB8B70)
#define CLASS_1_E9398CA697814FB7_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17AB8CC0)
#define CLASS_1_E9398CA697814FB7_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x17AB9130)
#define CLASS_1_E9398CA697814FB7_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x17AB90A0)
#define CLASS_1_E9398CA697814FB7_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x17AB8B30)
#define CLASS_1_E9398CA697814FB7_METHOD_1_217A4C673B33B3F5_OFFSET UNITYSDK_OFFSET(0x17AB8B60)
#define CLASS_1_E9398CA697814FB7_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x17AB8B50)
#define CLASS_1_E9398CA697814FB7_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x17AB8B40)
#define CLASS_1_E9398CA697814FB7_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17AB8910)
#define CLASS_1_E9398CA697814FB7_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17AB8E10)
#define CLASS_1_E9398CA697814FB7_WRITETO_OFFSET UNITYSDK_OFFSET(0x17AB8E70)
#define CLASS_1_E9398CA697814FB7__CCTOR_OFFSET UNITYSDK_OFFSET(0x17AB9280)
#define CLASS_1_E9398CA697814FB7__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17AB89B0)
#define CLASS_1_E9398CA697814FB7__CTOR_OFFSET UNITYSDK_OFFSET(0x17AB8920)
...
public:
	...
	{
		return (::Google::Protobuf::Collections::MapField_2_Codec<::System::UInt32, ::Class_1_E7C4009BCC22497A_1*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E9398CA697814FB7_TypeDefinitionIndex)->GetStaticField(0x28760);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_4()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E9398CA697814FB7_TypeDefinitionIndex)->GetStaticField(0x28768);
	}
