...
#define CLASS_1_A2C1FA0FF16CC08A_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17BEF550)
#define CLASS_1_A2C1FA0FF16CC08A_CLONE_OFFSET UNITYSDK_OFFSET(0x17BEF120)
#define CLASS_1_A2C1FA0FF16CC08A_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17BEF270)
#define CLASS_1_A2C1FA0FF16CC08A_EQUALS_OFFSET UNITYSDK_OFFSET(0x17BEF180)
#define CLASS_1_A2C1FA0FF16CC08A_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17BEF320)
#define CLASS_1_A2C1FA0FF16CC08A_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x17BEF720)
#define CLASS_1_A2C1FA0FF16CC08A_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x17BEF680)
#define CLASS_1_A2C1FA0FF16CC08A_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x17BEF160)
#define CLASS_1_A2C1FA0FF16CC08A_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x17BEF170)
#define CLASS_1_A2C1FA0FF16CC08A_METHOD_1_959BA94B4EE67881_OFFSET UNITYSDK_OFFSET(0x17BEF150)
#define CLASS_1_A2C1FA0FF16CC08A_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17BEF000)
#define CLASS_1_A2C1FA0FF16CC08A_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17BEF410)
#define CLASS_1_A2C1FA0FF16CC08A_WRITETO_OFFSET UNITYSDK_OFFSET(0x17BEF470)
#define CLASS_1_A2C1FA0FF16CC08A__CCTOR_OFFSET UNITYSDK_OFFSET(0x17BEF800)
#define CLASS_1_A2C1FA0FF16CC08A__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17BEF060)
#define CLASS_1_A2C1FA0FF16CC08A__CTOR_OFFSET UNITYSDK_OFFSET(0x17BEF010)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Proto::PlayerSimpleInfo*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A2C1FA0FF16CC08A_TypeDefinitionIndex)->GetStaticField(0x3CD10);
	}
