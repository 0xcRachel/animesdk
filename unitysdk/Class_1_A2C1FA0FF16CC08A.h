...
#define CLASS_1_A2C1FA0FF16CC08A_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17ACA290)
#define CLASS_1_A2C1FA0FF16CC08A_CLONE_OFFSET UNITYSDK_OFFSET(0x17AC9E60)
#define CLASS_1_A2C1FA0FF16CC08A_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17AC9FB0)
#define CLASS_1_A2C1FA0FF16CC08A_EQUALS_OFFSET UNITYSDK_OFFSET(0x17AC9EC0)
#define CLASS_1_A2C1FA0FF16CC08A_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17ACA060)
#define CLASS_1_A2C1FA0FF16CC08A_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x17ACA440)
#define CLASS_1_A2C1FA0FF16CC08A_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x17ACA3A0)
#define CLASS_1_A2C1FA0FF16CC08A_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x17AC9E90)
#define CLASS_1_A2C1FA0FF16CC08A_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x17AC9EA0)
#define CLASS_1_A2C1FA0FF16CC08A_METHOD_1_959BA94B4EE67881_OFFSET UNITYSDK_OFFSET(0x17AC9EB0)
#define CLASS_1_A2C1FA0FF16CC08A_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17AC9D40)
#define CLASS_1_A2C1FA0FF16CC08A_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17ACA150)
#define CLASS_1_A2C1FA0FF16CC08A_WRITETO_OFFSET UNITYSDK_OFFSET(0x17ACA1B0)
#define CLASS_1_A2C1FA0FF16CC08A__CCTOR_OFFSET UNITYSDK_OFFSET(0x17ACA520)
#define CLASS_1_A2C1FA0FF16CC08A__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17AC9DA0)
#define CLASS_1_A2C1FA0FF16CC08A__CTOR_OFFSET UNITYSDK_OFFSET(0x17AC9D50)

inline static constexpr unsigned int Class_1_A2C1FA0FF16CC08A_TypeDefinitionIndex = 23997;

class Class_1_A2C1FA0FF16CC08A : public ::System::Object
{
public:
	static ::Google::Protobuf::FieldCodec_1<::Proto::PlayerSimpleInfo*>** StaticGet_Field_1_4()
	{
		return (::Google::Protobuf::FieldCodec_1<::Proto::PlayerSimpleInfo*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A2C1FA0FF16CC08A_TypeDefinitionIndex)->GetStaticField(0x2C200);
	}
	// static const ::System::Int32 Field_1_1 = 0xA; // 0x0
	// static const ::System::Int32 Field_1_3 = 0x9; // 0x0
	::Google::Protobuf::Collections::RepeatedField_1<::Proto::PlayerSimpleInfo*>* Field_1_5; // 0x10
