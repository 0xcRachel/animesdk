...
public:
	...
	{
		return (::System::Comparison_1<::RPG::GameCore::GameEntity*>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_E1F0F77725E0ADF0___O_TypeDefinitionIndex)->GetStaticField(0x2C860);
	}
};
