...
#define CLASS_2_79B2C08CB904DE40_LOCK_OFFSET UNITYSDK_OFFSET(0x159FBC50)
#define CLASS_2_79B2C08CB904DE40_UNLOCK_OFFSET UNITYSDK_OFFSET(0x159FBD10)
#define CLASS_2_79B2C08CB904DE40__CTOR_OFFSET UNITYSDK_OFFSET(0x159FBC40)
#define CLASS_2_79B2C08CB904DE40___IFIXBASEPROXY_LOCK_OFFSET UNITYSDK_OFFSET(0x159FBE20)
#define CLASS_2_79B2C08CB904DE40___IFIXBASEPROXY_UNLOCK_OFFSET UNITYSDK_OFFSET(0x159FBE80)

inline static constexpr unsigned int Class_2_79B2C08CB904DE40_TypeDefinitionIndex = 69823;
