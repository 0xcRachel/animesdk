...
#define CLASS_2_DABB972BBA77AD76_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8651FF0)
#define CLASS_2_DABB972BBA77AD76_METHOD_2_3150676160817918_OFFSET UNITYSDK_OFFSET(0x86525C0)
#define CLASS_2_DABB972BBA77AD76_METHOD_2_CBBEE340330E4D97_OFFSET UNITYSDK_OFFSET(0x8653350)
#define CLASS_2_DABB972BBA77AD76_METHOD_2_D47981CD6F0E1F50_OFFSET UNITYSDK_OFFSET(0x8653550)
#define CLASS_2_DABB972BBA77AD76_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x8652470)
#define CLASS_2_DABB972BBA77AD76_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x86521E0)
#define CLASS_2_DABB972BBA77AD76_TICK_OFFSET UNITYSDK_OFFSET(0x8652270)
#define CLASS_2_DABB972BBA77AD76__CTOR_OFFSET UNITYSDK_OFFSET(0x8651E10)

inline static constexpr unsigned int Class_2_DABB972BBA77AD76_TypeDefinitionIndex = 41760;

class Class_2_DABB972BBA77AD76 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::System::Collections::Generic::List_1<::Class_3_BCCE950C2E8DF1F0*>* Field_2_3; // 0x18
	::RPG::GameCore::GenericSwitchCase* Field_2_1; // 0x20
	::RPG::GameCore::TaskContext* Field_2_0; // 0x28
	::Struct_2_D3027B1CDFF61281 Field_2_2; // 0x30
	::Class_3_BCCE950C2E8DF1F0* Field_2_4; // 0x60
	...
	::System::Void Method_2_D47981CD6F0E1F50(::Class_3_BCCE950C2E8DF1F0* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_3_BCCE950C2E8DF1F0*))((::PBYTE)hIl2Cpp + CLASS_2_DABB972BBA77AD76_METHOD_2_D47981CD6F0E1F50_OFFSET))(this, a1);
	}
};
