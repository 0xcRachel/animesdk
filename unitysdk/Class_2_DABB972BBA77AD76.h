...
#define CLASS_2_DABB972BBA77AD76_DISPOSE_OFFSET UNITYSDK_OFFSET(0x101C40C0)
#define CLASS_2_DABB972BBA77AD76_METHOD_2_3150676160817918_OFFSET UNITYSDK_OFFSET(0x101C4690)
#define CLASS_2_DABB972BBA77AD76_METHOD_2_CBBEE340330E4D97_OFFSET UNITYSDK_OFFSET(0x101C5560)
#define CLASS_2_DABB972BBA77AD76_METHOD_2_D47981CD6F0E1F50_OFFSET UNITYSDK_OFFSET(0x101C5760)
#define CLASS_2_DABB972BBA77AD76_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x101C4540)
#define CLASS_2_DABB972BBA77AD76_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x101C42B0)
#define CLASS_2_DABB972BBA77AD76_TICK_OFFSET UNITYSDK_OFFSET(0x101C4340)
#define CLASS_2_DABB972BBA77AD76__CTOR_OFFSET UNITYSDK_OFFSET(0x101C3EE0)
...
public:
	...
	::RPG::GameCore::GenericSwitchCase* Field_2_1; // 0x30
	::Struct_2_D3027B1CDFF61281 Field_2_2; // 0x38
