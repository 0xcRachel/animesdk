...
#define PBDHANDLE_APPLYFORCE_OFFSET UNITYSDK_OFFSET(0x8926200)
#define PBDHANDLE_METHOD_5_5FBAD89A54D9F070_OFFSET UNITYSDK_OFFSET(0x8925850)
#define PBDHANDLE_METHOD_5_8451509F80A98FEC_OFFSET UNITYSDK_OFFSET(0x8925440)
#define PBDHANDLE_METHOD_5_A029BDEE0BC74991_OFFSET UNITYSDK_OFFSET(0x8926450)
#define PBDHANDLE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x89267A0)
#define PBDHANDLE_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x8926680)
#define PBDHANDLE_START_OFFSET UNITYSDK_OFFSET(0x8924E10)
#define PBDHANDLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x8925610)
#define PBDHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x89267F0)

inline static constexpr unsigned int PBDHandle_TypeDefinitionIndex = 37094;
