...
#define PBDHANDLE_APPLYFORCE_OFFSET UNITYSDK_OFFSET(0x15360210)
#define PBDHANDLE_METHOD_5_3B2051C60621D523_OFFSET UNITYSDK_OFFSET(0x1535F9D0)
#define PBDHANDLE_METHOD_5_4B2D0E39C5A3C698_OFFSET UNITYSDK_OFFSET(0x153604A0)
#define PBDHANDLE_METHOD_5_8451509F80A98FEC_OFFSET UNITYSDK_OFFSET(0x1535F560)
#define PBDHANDLE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x15360810)
#define PBDHANDLE_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x153606F0)
#define PBDHANDLE_START_OFFSET UNITYSDK_OFFSET(0x1535EF00)
#define PBDHANDLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1535F710)
#define PBDHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x15360860)
