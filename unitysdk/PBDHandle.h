...
#define PBDHANDLE_APPLYFORCE_OFFSET UNITYSDK_OFFSET(0x8CC23B0)
#define PBDHANDLE_METHOD_5_5FBAD89A54D9F070_OFFSET UNITYSDK_OFFSET(0x8CC1A00)
#define PBDHANDLE_METHOD_5_8451509F80A98FEC_OFFSET UNITYSDK_OFFSET(0x8CC15F0)
#define PBDHANDLE_METHOD_5_A029BDEE0BC74991_OFFSET UNITYSDK_OFFSET(0x8CC2600)
#define PBDHANDLE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x8CC2950)
#define PBDHANDLE_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x8CC2830)
#define PBDHANDLE_START_OFFSET UNITYSDK_OFFSET(0x8CC0FC0)
#define PBDHANDLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x8CC17C0)
#define PBDHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x8CC29A0)
