...
#define PBDHANDLE_APPLYFORCE_OFFSET UNITYSDK_OFFSET(0xFF97370)
#define PBDHANDLE_METHOD_5_5FBAD89A54D9F070_OFFSET UNITYSDK_OFFSET(0xFF969C0)
#define PBDHANDLE_METHOD_5_8451509F80A98FEC_OFFSET UNITYSDK_OFFSET(0xFF965B0)
#define PBDHANDLE_METHOD_5_A029BDEE0BC74991_OFFSET UNITYSDK_OFFSET(0xFF975C0)
#define PBDHANDLE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xFF97910)
#define PBDHANDLE_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0xFF977F0)
#define PBDHANDLE_START_OFFSET UNITYSDK_OFFSET(0xFF95F80)
#define PBDHANDLE_UPDATE_OFFSET UNITYSDK_OFFSET(0xFF96780)
#define PBDHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0xFF97960)
