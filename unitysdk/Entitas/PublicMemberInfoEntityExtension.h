...
#define ENTITAS_PUBLICMEMBERINFOENTITYEXTENSION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1131CA30)

namespace Entitas
{
	inline static constexpr unsigned int PublicMemberInfoEntityExtension_TypeDefinitionIndex = 9248;
