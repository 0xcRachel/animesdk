...
#define ENTITAS_CONTEXTENTITYCHANGED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x11316CD0)
#define ENTITAS_CONTEXTENTITYCHANGED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x11316D10)
#define ENTITAS_CONTEXTENTITYCHANGED_INVOKE_OFFSET UNITYSDK_OFFSET(0x113164B0)
#define ENTITAS_CONTEXTENTITYCHANGED__CTOR_OFFSET UNITYSDK_OFFSET(0x11316490)

namespace Entitas
{
	inline static constexpr unsigned int ContextEntityChanged_TypeDefinitionIndex = 9218;
