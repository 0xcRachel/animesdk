...
#define ENTITAS_COLLECTIONEXTENSION_SINGLEENTITY_OFFSET UNITYSDK_OFFSET(0x113160D0)

namespace Entitas
{
	inline static constexpr unsigned int CollectionExtension_TypeDefinitionIndex = 9245;
