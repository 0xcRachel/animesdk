...
#define ENTITAS_ENTITYCOMPONENTREPLACED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1131C360)
#define ENTITAS_ENTITYCOMPONENTREPLACED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1131C3E0)
#define ENTITAS_ENTITYCOMPONENTREPLACED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1131A4E0)
#define ENTITAS_ENTITYCOMPONENTREPLACED__CTOR_OFFSET UNITYSDK_OFFSET(0x1131C340)

namespace Entitas
{
	inline static constexpr unsigned int EntityComponentReplaced_TypeDefinitionIndex = 9235;
