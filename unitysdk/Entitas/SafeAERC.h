...
#define ENTITAS_SAFEAERC_GET_OWNERS_OFFSET UNITYSDK_OFFSET(0x11A9E360)
#define ENTITAS_SAFEAERC_GET_RETAINCOUNT_OFFSET UNITYSDK_OFFSET(0x11A9E340)
#define ENTITAS_SAFEAERC_RELEASE_OFFSET UNITYSDK_OFFSET(0x11A9E400)
#define ENTITAS_SAFEAERC_RETAIN_OFFSET UNITYSDK_OFFSET(0x11A9E370)
#define ENTITAS_SAFEAERC__CTOR_OFFSET UNITYSDK_OFFSET(0x11A9AF60)
