...
#define ENTITAS_SAFEAERC_GET_OWNERS_OFFSET UNITYSDK_OFFSET(0x1131CBE0)
#define ENTITAS_SAFEAERC_GET_RETAINCOUNT_OFFSET UNITYSDK_OFFSET(0x1131CBC0)
#define ENTITAS_SAFEAERC_RELEASE_OFFSET UNITYSDK_OFFSET(0x1131CC80)
#define ENTITAS_SAFEAERC_RETAIN_OFFSET UNITYSDK_OFFSET(0x1131CBF0)
#define ENTITAS_SAFEAERC__CTOR_OFFSET UNITYSDK_OFFSET(0x11319090)

namespace Entitas
{
	inline static constexpr unsigned int SafeAERC_TypeDefinitionIndex = 9238;
