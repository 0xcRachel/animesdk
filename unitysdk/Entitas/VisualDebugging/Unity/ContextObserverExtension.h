...
#define ENTITAS_VISUALDEBUGGING_UNITY_CONTEXTOBSERVEREXTENSION_FINDCONTEXTOBSERVER_OFFSET UNITYSDK_OFFSET(0x1131EF00)

namespace Entitas::VisualDebugging::Unity
{
	inline static constexpr unsigned int ContextObserverExtension_TypeDefinitionIndex = 9280;
