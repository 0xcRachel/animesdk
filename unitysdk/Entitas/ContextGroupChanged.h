...
#define ENTITAS_CONTEXTGROUPCHANGED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A639460)
#define ENTITAS_CONTEXTGROUPCHANGED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6394A0)
#define ENTITAS_CONTEXTGROUPCHANGED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A638EE0)
#define ENTITAS_CONTEXTGROUPCHANGED__CTOR_OFFSET UNITYSDK_OFFSET(0x1A638EC0)
