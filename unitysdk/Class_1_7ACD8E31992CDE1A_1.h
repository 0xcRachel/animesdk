...
#define CLASS_1_7ACD8E31992CDE1A_1_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10C10F60)
#define CLASS_1_7ACD8E31992CDE1A_1_GET_OVERRIDEXCLAMPDEADZONE_OFFSET UNITYSDK_OFFSET(0x10C11CE0)
#define CLASS_1_7ACD8E31992CDE1A_1_GET_OVERRIDEXCLAMPSOFTZONE_OFFSET UNITYSDK_OFFSET(0x10C11CC0)
#define CLASS_1_7ACD8E31992CDE1A_1_METHOD_1_00C7FCDD0B82BC95_OFFSET UNITYSDK_OFFSET(0x10C10BC0)
#define CLASS_1_7ACD8E31992CDE1A_1_METHOD_1_2F0F99A12DB93F30_OFFSET UNITYSDK_OFFSET(0x10C103F0)
#define CLASS_1_7ACD8E31992CDE1A_1_METHOD_1_31135BE491631E74_OFFSET UNITYSDK_OFFSET(0x10C11000)
#define CLASS_1_7ACD8E31992CDE1A_1_METHOD_1_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x10C11620)
#define CLASS_1_7ACD8E31992CDE1A_1_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x10C10FB0)
#define CLASS_1_7ACD8E31992CDE1A_1_METHOD_1_4D2A473556700CDC_OFFSET UNITYSDK_OFFSET(0x10C10440)
#define CLASS_1_7ACD8E31992CDE1A_1_METHOD_1_797A699EED121969_OFFSET UNITYSDK_OFFSET(0x10C11680)
#define CLASS_1_7ACD8E31992CDE1A_1_METHOD_1_95D40074EC7C1AA6_OFFSET UNITYSDK_OFFSET(0x10C10630)
#define CLASS_1_7ACD8E31992CDE1A_1_METHOD_1_B961D33AD47A2113_OFFSET UNITYSDK_OFFSET(0x10C108B0)
#define CLASS_1_7ACD8E31992CDE1A_1_METHOD_1_E507EE4A464914B8_OFFSET UNITYSDK_OFFSET(0x10C10D60)
#define CLASS_1_7ACD8E31992CDE1A_1_METHOD_1_FF7B2911BBACA4A9_1_OFFSET UNITYSDK_OFFSET(0x10C11560)
#define CLASS_1_7ACD8E31992CDE1A_1_METHOD_1_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0x10C115C0)
#define CLASS_1_7ACD8E31992CDE1A_1_SET_OVERRIDEXCLAMPDEADZONE_OFFSET UNITYSDK_OFFSET(0x10C11CF0)
#define CLASS_1_7ACD8E31992CDE1A_1_SET_OVERRIDEXCLAMPSOFTZONE_OFFSET UNITYSDK_OFFSET(0x10C11CD0)
#define CLASS_1_7ACD8E31992CDE1A_1__CTOR_OFFSET UNITYSDK_OFFSET(0x10C10350)

inline static constexpr unsigned int Class_1_7ACD8E31992CDE1A_1_TypeDefinitionIndex = 56958;
...
public:
	...
	::System::Nullable_1<::System::Single> _OverrideXClampDeadZone_k__BackingField; // 0x20
	::UnityEngine::Vector2 Field_1_15; // 0x28
	::UnityEngine::Vector2 Field_1_14; // 0x30
	::System::Single Field_1_5; // 0x38
	::System::Single Field_1_4; // 0x3C
	::System::Single Field_1_12; // 0x40
	::RPG::Client::SwipeCameraStateEnum Field_1_3; // 0x44
	::UnityEngine::Vector2 Field_1_11; // 0x48
	::System::Single Field_1_8; // 0x50
	::System::Nullable_1<::System::Single> _OverrideXClampSoftZone_k__BackingField; // 0x54
