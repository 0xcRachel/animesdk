...
#define AKROOM_EXIT_OFFSET UNITYSDK_OFFSET(0x18BE3AA0)
#define AKROOM_GETAKROOMID_OFFSET UNITYSDK_OFFSET(0x18BE3770)
#define AKROOM_GETID_OFFSET UNITYSDK_OFFSET(0x18BE3880)
#define AKROOM_GET_ROOMCOUNT_OFFSET UNITYSDK_OFFSET(0x18BE3950)
#define AKROOM_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x18BE5D40)
#define AKROOM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x18BE52A0)
#define AKROOM_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18BE3B60)
#define AKROOM_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x18BE5940)
#define AKROOM_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x18BE5A50)
#define AKROOM_POSTROOMTONE_OFFSET UNITYSDK_OFFSET(0x18BE5B60)
#define AKROOM_SET_ROOMCOUNT_OFFSET UNITYSDK_OFFSET(0x18BE3960)
#define AKROOM_TRYENTER_OFFSET UNITYSDK_OFFSET(0x18BE3970)
#define AKROOM__CTOR_OFFSET UNITYSDK_OFFSET(0x18BE5D90)
#define AKROOM___IFIXBASEPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18BE5EA0)
...
public:
	...
	{
		return (::System::UInt64*)Il2CppClass::FromTypeDefinitionIndex(AkRoom_TypeDefinitionIndex)->GetStaticField(0xB8C0);
	}
	static ::System::Int32* StaticGet__RoomCount_k__BackingField()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(AkRoom_TypeDefinitionIndex)->GetStaticField(0xB8C8);
	}
