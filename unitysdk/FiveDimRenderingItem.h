...
#define FIVEDIMRENDERINGITEM_AUTOCOLLECT_OFFSET UNITYSDK_OFFSET(0xFE7AFF0)
#define FIVEDIMRENDERINGITEM_CHANGEITEMSTATE_OFFSET UNITYSDK_OFFSET(0xFE7C4E0)
#define FIVEDIMRENDERINGITEM_DEBUGDITHER_OFFSET UNITYSDK_OFFSET(0xFE7DC10)
#define FIVEDIMRENDERINGITEM_DEBUGSETSHADOWSTRENGTH_OFFSET UNITYSDK_OFFSET(0xFE7DC50)
#define FIVEDIMRENDERINGITEM_DEBUGSTATECHANGE_OFFSET UNITYSDK_OFFSET(0xFE7DBD0)
#define FIVEDIMRENDERINGITEM_DISABLECUSTOMDATAASSHADOWSTRENGTH_OFFSET UNITYSDK_OFFSET(0xFE7D9A0)
#define FIVEDIMRENDERINGITEM_FORCEOPENAUTOREG_OFFSET UNITYSDK_OFFSET(0xFE7B260)
#define FIVEDIMRENDERINGITEM_METHOD_5_0BDFAC56E6B704CB_OFFSET UNITYSDK_OFFSET(0xFE7B3E0)
#define FIVEDIMRENDERINGITEM_METHOD_5_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xFE7B510)
#define FIVEDIMRENDERINGITEM_METHOD_5_D0BD1377F2594D33_1_OFFSET UNITYSDK_OFFSET(0xFE7B2F0)
#define FIVEDIMRENDERINGITEM_METHOD_5_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0xFE7B480)
#define FIVEDIMRENDERINGITEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xFE7B2A0)
#define FIVEDIMRENDERINGITEM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xFE7B390)
#define FIVEDIMRENDERINGITEM_ONENABLE_OFFSET UNITYSDK_OFFSET(0xFE7B430)
#define FIVEDIMRENDERINGITEM_REFRESHITEMSTATE_OFFSET UNITYSDK_OFFSET(0xFE7C8D0)
#define FIVEDIMRENDERINGITEM_SETDITHER_OFFSET UNITYSDK_OFFSET(0xFE7CB10)
#define FIVEDIMRENDERINGITEM_SETPANEL_OFFSET UNITYSDK_OFFSET(0xFE7B580)
#define FIVEDIMRENDERINGITEM_SETSHADOWSTRENGTH_1_OFFSET UNITYSDK_OFFSET(0xFE7D920)
#define FIVEDIMRENDERINGITEM_SETSHADOWSTRENGTH_OFFSET UNITYSDK_OFFSET(0xFE7D320)
#define FIVEDIMRENDERINGITEM_UPDATEDATA_OFFSET UNITYSDK_OFFSET(0xFE7C070)
#define FIVEDIMRENDERINGITEM__CCTOR_OFFSET UNITYSDK_OFFSET(0xFE7DD50)
#define FIVEDIMRENDERINGITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xFE7DC90)

inline static constexpr unsigned int FiveDimRenderingItem_TypeDefinitionIndex = 37069;
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(FiveDimRenderingItem_TypeDefinitionIndex)->GetStaticField(0x14030);
	}
	static ::System::Int32* StaticGet_Field_5_18()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(FiveDimRenderingItem_TypeDefinitionIndex)->GetStaticField(0x4A80);
	}
	...
	::System::Boolean Field_5_19; // 0x6D
