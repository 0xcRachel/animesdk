...
#define CLASS_2_6B967A8FF85DEF97_DISPOSE_OFFSET UNITYSDK_OFFSET(0x147C4440)
#define CLASS_2_6B967A8FF85DEF97_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x147BDF40)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_00E8D4584E39B171_OFFSET UNITYSDK_OFFSET(0x147C2270)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_01F8C9B8FEC4A2CF_OFFSET UNITYSDK_OFFSET(0x147C5170)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_20F902C5D75CEC0B_OFFSET UNITYSDK_OFFSET(0x147C11B0)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_231B70A5C4752963_OFFSET UNITYSDK_OFFSET(0x147C6310)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_2340068C22DFE332_OFFSET UNITYSDK_OFFSET(0x147C5320)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_28C532CD321F20DC_OFFSET UNITYSDK_OFFSET(0x147C37B0)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_2A8D0F3828218E1E_OFFSET UNITYSDK_OFFSET(0x147C6BD0)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_2AA27BA1D6C33879_OFFSET UNITYSDK_OFFSET(0x147C6810)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_367B9590522079D1_OFFSET UNITYSDK_OFFSET(0x147C4CA0)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_3AD0AC9143B20894_OFFSET UNITYSDK_OFFSET(0x147BF870)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x147C45A0)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_43405C47DB483091_OFFSET UNITYSDK_OFFSET(0x147BF370)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_444E41890AF6E3D9_OFFSET UNITYSDK_OFFSET(0x147C05F0)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_50BF1B0904E78DBA_OFFSET UNITYSDK_OFFSET(0x147C0C90)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0x147C33B0)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_54A7C35D9B7194C9_OFFSET UNITYSDK_OFFSET(0x147C1270)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_5D3D37F2BAE9FB65_1_OFFSET UNITYSDK_OFFSET(0x147C5F30)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_5D3D37F2BAE9FB65_OFFSET UNITYSDK_OFFSET(0x147C5880)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_5F08B426ADF31FF5_OFFSET UNITYSDK_OFFSET(0x147C2D40)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_7646FFE662147970_OFFSET UNITYSDK_OFFSET(0x147C6B80)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_7EC5F7A94360BC42_OFFSET UNITYSDK_OFFSET(0x147C1B00)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_82E992240300FB30_OFFSET UNITYSDK_OFFSET(0x147C4A70)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_85770AA57A8A2376_OFFSET UNITYSDK_OFFSET(0x147C0A20)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_939B0A8FB671683E_1_OFFSET UNITYSDK_OFFSET(0x147C6180)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_939B0A8FB671683E_OFFSET UNITYSDK_OFFSET(0x147C56F0)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_94C81405F83348DF_OFFSET UNITYSDK_OFFSET(0x147C47B0)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_A970D5A812316D0F_OFFSET UNITYSDK_OFFSET(0x147C0010)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_B03BD337C608E98D_OFFSET UNITYSDK_OFFSET(0x147C32D0)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_B1EA412ACAE87C15_OFFSET UNITYSDK_OFFSET(0x147C0690)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_B247C6D88E785B91_OFFSET UNITYSDK_OFFSET(0x147C34A0)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_B387E1AED8A8F880_OFFSET UNITYSDK_OFFSET(0x147C58F0)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_B95A2EA2A8345A6E_OFFSET UNITYSDK_OFFSET(0x147BF2E0)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_BB5C538354FD3393_OFFSET UNITYSDK_OFFSET(0x147C19B0)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_BB881F05E41D3A04_OFFSET UNITYSDK_OFFSET(0x147C03C0)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_C26623CFD2E6EAE3_OFFSET UNITYSDK_OFFSET(0x147C5C70)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_C3361B9526BEAB18_OFFSET UNITYSDK_OFFSET(0x147C3110)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0x147C6C50)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_C7BF9C1E6A78DCAB_OFFSET UNITYSDK_OFFSET(0x147C6560)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x147BF2A0)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_CF3EF672D8510D44_OFFSET UNITYSDK_OFFSET(0x147C5FA0)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_D14D1C669EDC2D6B_OFFSET UNITYSDK_OFFSET(0x147C5410)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_E092EFE670864887_OFFSET UNITYSDK_OFFSET(0x147C5670)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_E693A0026D178D8E_OFFSET UNITYSDK_OFFSET(0x147C4BD0)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_E7B666AE91ADD0C2_OFFSET UNITYSDK_OFFSET(0x147C0CF0)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_F330275D83DD93B1_OFFSET UNITYSDK_OFFSET(0x147C46E0)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_F4ADC37B63F4E9EF_OFFSET UNITYSDK_OFFSET(0x147BDE60)
#define CLASS_2_6B967A8FF85DEF97_METHOD_2_F7EDA528D89DF793_OFFSET UNITYSDK_OFFSET(0x147C6A90)
#define CLASS_2_6B967A8FF85DEF97_ONFINISHIMMEDIATELYINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x147C3700)
#define CLASS_2_6B967A8FF85DEF97_ONSKIP_OFFSET UNITYSDK_OFFSET(0x147C3350)
#define CLASS_2_6B967A8FF85DEF97_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x147BDFC0)
#define CLASS_2_6B967A8FF85DEF97_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x147C2BB0)
#define CLASS_2_6B967A8FF85DEF97_SETNEXTTASK_OFFSET UNITYSDK_OFFSET(0x147BDF50)
#define CLASS_2_6B967A8FF85DEF97_TICK_OFFSET UNITYSDK_OFFSET(0x147C2C10)
#define CLASS_2_6B967A8FF85DEF97__CCTOR_OFFSET UNITYSDK_OFFSET(0x147C6C60)
#define CLASS_2_6B967A8FF85DEF97__CTOR_OFFSET UNITYSDK_OFFSET(0x147BDE00)
#define CLASS_2_6B967A8FF85DEF97___CUTSCENEAUDIOBEGIN_B__30_1_OFFSET UNITYSDK_OFFSET(0x147C6C80)
...
public:
	...
	{
		return (::RPG::Client::RPGProfilerMarker**)Il2CppClass::FromTypeDefinitionIndex(Class_2_6B967A8FF85DEF97_TypeDefinitionIndex)->GetStaticField(0x14150);
	}
	static ::RPG::Client::RPGProfilerMarker** StaticGet_Field_2_1()
	{
		return (::RPG::Client::RPGProfilerMarker**)Il2CppClass::FromTypeDefinitionIndex(Class_2_6B967A8FF85DEF97_TypeDefinitionIndex)->GetStaticField(0x14158);
	}
	// static const ::System::Single Field_2_2; // 0x0
	// static const ::System::Int32 Field_2_3 = 0xC8; // 0x0
	::System::Collections::Generic::Dictionary_2<::System::String*, ::RPG::GameCore::GameEntity*>* Field_2_4; // 0x18
	::RPG::GameCore::VideoCaptionConfig* Field_2_5; // 0x20
	::RPG::GameCore::GameWorld* Field_2_6; // 0x28
	::RPG::GameCore::TaskContext* Field_2_7; // 0x30
	::Class_1_36264895A759B0FF* Field_2_8; // 0x38
	::RPG::GameCore::CutSceneSFXConfig* Field_2_9; // 0x40
	::UnityEngine::Playables::PlayableDirector* Field_2_10; // 0x48
	::System::Collections::Generic::List_1<::UnityEngine::Timeline::TrackAsset*>* Field_2_11; // 0x50
	::System::Collections::Generic::List_1<::UnityEngine::Animator*>* Field_2_12; // 0x58
	::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* Field_2_13; // 0x60
	::RPG::GameCore::CutSceneConfigRow* Field_2_14; // 0x68
	::RPG::GameCore::PlayTimeline* Field_2_15; // 0x70
	::Class_2_0C169F681BDD42E0* Field_2_16; // 0x78
	::Class_1_5F51D4049EA87B7B* Field_2_17; // 0x80
	::System::Int32 Field_2_18; // 0x88
	::System::UInt32 Field_2_19; // 0x8C
	::System::Double Field_2_20; // 0x90
	::System::Guid Field_2_21; // 0x98
	::System::Boolean Field_2_22; // 0xA8
	::System::Boolean Field_2_23; // 0xA9
	::System::Boolean Field_2_24; // 0xAA
	::System::Boolean Field_2_25; // 0xAB
	::System::Int32 Field_2_26; // 0xAC
	::System::Single Field_2_27; // 0xB0
	::System::Single Field_2_28; // 0xB4
	::System::Single Field_2_29; // 0xB8
	::System::UInt32 Field_2_30; // 0xBC
