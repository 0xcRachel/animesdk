...
#define ENVIROMENTSYSTEM_ENVIROGUIHEADER_METHOD_2_221AD7CB52B41597_OFFSET UNITYSDK_OFFSET(0xFB9C120)
#define ENVIROMENTSYSTEM_ENVIROGUIHEADER_METHOD_2_42B2BB88AE2FB02E_OFFSET UNITYSDK_OFFSET(0xFB9C0A0)
#define ENVIROMENTSYSTEM_ENVIROGUIHEADER__CTOR_1_OFFSET UNITYSDK_OFFSET(0xFB9C030)
#define ENVIROMENTSYSTEM_ENVIROGUIHEADER__CTOR_OFFSET UNITYSDK_OFFSET(0xFB9BBD0)
