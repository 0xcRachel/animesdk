...
#define ENVIROMENTSYSTEM_ENVIROFLOATPROPERTY_METHOD_2_0414B7E68ABA5085_OFFSET UNITYSDK_OFFSET(0xE4B5D10)
#define ENVIROMENTSYSTEM_ENVIROFLOATPROPERTY_METHOD_2_19295F9E95CC8034_OFFSET UNITYSDK_OFFSET(0xE4B5D70)
#define ENVIROMENTSYSTEM_ENVIROFLOATPROPERTY_METHOD_2_221AD7CB52B41597_OFFSET UNITYSDK_OFFSET(0xE4B5CB0)
#define ENVIROMENTSYSTEM_ENVIROFLOATPROPERTY_METHOD_2_289256236CBF6273_OFFSET UNITYSDK_OFFSET(0xE4B5C40)
#define ENVIROMENTSYSTEM_ENVIROFLOATPROPERTY_METHOD_2_28F3459B67DFCFFF_OFFSET UNITYSDK_OFFSET(0xE4B5720)
#define ENVIROMENTSYSTEM_ENVIROFLOATPROPERTY_METHOD_2_42BA9D7CE19718CB_OFFSET UNITYSDK_OFFSET(0xE4B5BD0)
#define ENVIROMENTSYSTEM_ENVIROFLOATPROPERTY_METHOD_2_5693914D0131014B_OFFSET UNITYSDK_OFFSET(0xE4B5A70)
#define ENVIROMENTSYSTEM_ENVIROFLOATPROPERTY_METHOD_2_82E992240300FB30_OFFSET UNITYSDK_OFFSET(0xE4B59E0)
#define ENVIROMENTSYSTEM_ENVIROFLOATPROPERTY_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xE4B5DC0)
#define ENVIROMENTSYSTEM_ENVIROFLOATPROPERTY_METHOD_2_CA6BDDCC5F7CE11E_OFFSET UNITYSDK_OFFSET(0xE4B5B60)
#define ENVIROMENTSYSTEM_ENVIROFLOATPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0xE4B55E0)
#define ENVIROMENTSYSTEM_ENVIROFLOATPROPERTY__CTOR_2_OFFSET UNITYSDK_OFFSET(0xE4B5690)
#define ENVIROMENTSYSTEM_ENVIROFLOATPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0xE4B5550)

namespace EnviromentSystem
{
	inline static constexpr unsigned int EnviroFloatProperty_TypeDefinitionIndex = 39306;
