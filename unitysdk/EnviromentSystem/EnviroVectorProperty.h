...
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY_METHOD_2_0414B7E68ABA5085_OFFSET UNITYSDK_OFFSET(0xFBC1360)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY_METHOD_2_19295F9E95CC8034_OFFSET UNITYSDK_OFFSET(0xFBC1310)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY_METHOD_2_221AD7CB52B41597_OFFSET UNITYSDK_OFFSET(0xFBC12B0)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY_METHOD_2_289256236CBF6273_OFFSET UNITYSDK_OFFSET(0xFBC1240)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY_METHOD_2_28F3459B67DFCFFF_OFFSET UNITYSDK_OFFSET(0xFBC0850)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY_METHOD_2_5693914D0131014B_OFFSET UNITYSDK_OFFSET(0xFBC0E00)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY_METHOD_2_5A94CFCFB167E3E2_OFFSET UNITYSDK_OFFSET(0xFBC0EF0)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY_METHOD_2_A1781348F0A89177_OFFSET UNITYSDK_OFFSET(0xFBC0D50)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xFBC13C0)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY_METHOD_2_CA6BDDCC5F7CE11E_OFFSET UNITYSDK_OFFSET(0xFBC11D0)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0xFBAE7A0)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY__CTOR_2_OFFSET UNITYSDK_OFFSET(0xFBAE890)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY__CTOR_3_OFFSET UNITYSDK_OFFSET(0xFB9BF80)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY__CTOR_4_OFFSET UNITYSDK_OFFSET(0xFBC06F0)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY__CTOR_5_OFFSET UNITYSDK_OFFSET(0xFBC07B0)
#define ENVIROMENTSYSTEM_ENVIROVECTORPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0xFBAE930)
