...
#define ENVIROMENTSYSTEM_ENVIROBOOLPROPERTY_METHOD_2_19295F9E95CC8034_OFFSET UNITYSDK_OFFSET(0xE4B4160)
#define ENVIROMENTSYSTEM_ENVIROBOOLPROPERTY_METHOD_2_221AD7CB52B41597_OFFSET UNITYSDK_OFFSET(0xE4B4100)
#define ENVIROMENTSYSTEM_ENVIROBOOLPROPERTY_METHOD_2_289256236CBF6273_OFFSET UNITYSDK_OFFSET(0xE4B4020)
#define ENVIROMENTSYSTEM_ENVIROBOOLPROPERTY_METHOD_2_28F3459B67DFCFFF_OFFSET UNITYSDK_OFFSET(0xE4B39E0)
#define ENVIROMENTSYSTEM_ENVIROBOOLPROPERTY_METHOD_2_5693914D0131014B_OFFSET UNITYSDK_OFFSET(0xE4B3DB0)
#define ENVIROMENTSYSTEM_ENVIROBOOLPROPERTY_METHOD_2_8F059A365E90744C_OFFSET UNITYSDK_OFFSET(0xE4B38E0)
#define ENVIROMENTSYSTEM_ENVIROBOOLPROPERTY_METHOD_2_A1781348F0A89177_OFFSET UNITYSDK_OFFSET(0xE4B3D00)
#define ENVIROMENTSYSTEM_ENVIROBOOLPROPERTY_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xE4B4200)
#define ENVIROMENTSYSTEM_ENVIROBOOLPROPERTY_METHOD_2_F18927F2B6DBB806_OFFSET UNITYSDK_OFFSET(0xE4B3F00)
#define ENVIROMENTSYSTEM_ENVIROBOOLPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0xE4B3830)
#define ENVIROMENTSYSTEM_ENVIROBOOLPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0xE4B3610)

namespace EnviromentSystem
{
	inline static constexpr unsigned int EnviroBoolProperty_TypeDefinitionIndex = 39302;
