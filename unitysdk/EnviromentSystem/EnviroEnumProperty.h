...
#define ENVIROMENTSYSTEM_ENVIROENUMPROPERTY_METHOD_2_0414B7E68ABA5085_OFFSET UNITYSDK_OFFSET(0xE4B54B0)
#define ENVIROMENTSYSTEM_ENVIROENUMPROPERTY_METHOD_2_19295F9E95CC8034_OFFSET UNITYSDK_OFFSET(0xE4B5460)
#define ENVIROMENTSYSTEM_ENVIROENUMPROPERTY_METHOD_2_221AD7CB52B41597_OFFSET UNITYSDK_OFFSET(0xE4B5400)
#define ENVIROMENTSYSTEM_ENVIROENUMPROPERTY_METHOD_2_289256236CBF6273_OFFSET UNITYSDK_OFFSET(0xE4B5390)
#define ENVIROMENTSYSTEM_ENVIROENUMPROPERTY_METHOD_2_28F3459B67DFCFFF_OFFSET UNITYSDK_OFFSET(0xE4B4E90)
#define ENVIROMENTSYSTEM_ENVIROENUMPROPERTY_METHOD_2_42BA9D7CE19718CB_OFFSET UNITYSDK_OFFSET(0xE4B52B0)
#define ENVIROMENTSYSTEM_ENVIROENUMPROPERTY_METHOD_2_5693914D0131014B_OFFSET UNITYSDK_OFFSET(0xE4B51D0)
#define ENVIROMENTSYSTEM_ENVIROENUMPROPERTY_METHOD_2_A1781348F0A89177_OFFSET UNITYSDK_OFFSET(0xE4B5120)
#define ENVIROMENTSYSTEM_ENVIROENUMPROPERTY_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xE4B5510)
#define ENVIROMENTSYSTEM_ENVIROENUMPROPERTY_METHOD_2_CA6BDDCC5F7CE11E_OFFSET UNITYSDK_OFFSET(0xE4B5320)
#define ENVIROMENTSYSTEM_ENVIROENUMPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0xE4B4E00)
#define ENVIROMENTSYSTEM_ENVIROENUMPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0xE4B4D60)

namespace EnviromentSystem
{
	inline static constexpr unsigned int EnviroEnumProperty_TypeDefinitionIndex = 39305;
