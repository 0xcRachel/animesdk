...
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_118F997A80166222_OFFSET UNITYSDK_OFFSET(0xC31EF10)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_1C1946CD7FEA6415_OFFSET UNITYSDK_OFFSET(0xC31F8B0)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_4A41C63BFE58D26F_OFFSET UNITYSDK_OFFSET(0xC31EBF0)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0xC31F850)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_5790A55946AA509D_2_OFFSET UNITYSDK_OFFSET(0xC31F930)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_5790A55946AA509D_3_OFFSET UNITYSDK_OFFSET(0xC31F990)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xC31F7F0)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_7F29568EA964E563_OFFSET UNITYSDK_OFFSET(0xC31ECD0)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_BEBC8F4773DC82AA_OFFSET UNITYSDK_OFFSET(0xC31EAC0)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_C027CF3DBDF58558_OFFSET UNITYSDK_OFFSET(0xC31F470)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_CA5F6DB703947009_OFFSET UNITYSDK_OFFSET(0xC31F000)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_D33218A492B26449_OFFSET UNITYSDK_OFFSET(0xC31F650)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_F730968E2645E14B_OFFSET UNITYSDK_OFFSET(0xC31EA40)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0xC31EB60)
...
namespace EnviromentSystem
{
	...
	public:
		...
		{
			return (::Class_2_3547B9D7F2C7CCA9**)Il2CppClass::FromTypeDefinitionIndex(EnviroAssetProperty_TypeDefinitionIndex)->GetStaticField(0x12AC0);
		}
