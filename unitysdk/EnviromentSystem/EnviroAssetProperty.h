...
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_0E3870FA433F9BC9_OFFSET UNITYSDK_OFFSET(0x13BADE10)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_11AC5A1FA468CD6B_OFFSET UNITYSDK_OFFSET(0x13BAD150)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0x13BADDB0)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_5790A55946AA509D_2_OFFSET UNITYSDK_OFFSET(0x13BADE90)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_5790A55946AA509D_3_OFFSET UNITYSDK_OFFSET(0x13BADEF0)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x13BADD50)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_C436A2848092EB88_OFFSET UNITYSDK_OFFSET(0x13BACD80)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_CA5F6DB703947009_OFFSET UNITYSDK_OFFSET(0x13BAD240)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_E5630A859AA24FB3_OFFSET UNITYSDK_OFFSET(0x13BACC70)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_E9EEDFB818CD2681_OFFSET UNITYSDK_OFFSET(0x13BAD7D0)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_EA7C9571288E1295_OFFSET UNITYSDK_OFFSET(0x13BADB00)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_EBAB6A35C21A2A5B_OFFSET UNITYSDK_OFFSET(0x13BACE60)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_F8C7231308CD2C82_OFFSET UNITYSDK_OFFSET(0x13BACC10)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x13BACCF0)
...
namespace EnviromentSystem
{
	...
	public:
		...
		{
			return (::Class_2_7D53347CD75A5D8B**)Il2CppClass::FromTypeDefinitionIndex(EnviroAssetProperty_TypeDefinitionIndex)->GetStaticField(0x3F4F0);
		}
		...
		::System::Void Method_2_0E3870FA433F9BC9(::EnviromentSystem::EnviromentClip_OnEnvironmentClipLoadDelegate* a1)
		{
			return ((::System::Void(*)(::PVOID, ::EnviromentSystem::EnviromentClip_OnEnvironmentClipLoadDelegate*))((::PBYTE)hIl2Cpp + ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_0E3870FA433F9BC9_OFFSET))(this, a1);
		}
