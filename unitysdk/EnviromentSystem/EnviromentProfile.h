...
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_GET_ACTIVEPROFILETRANSITIONTARGET_OFFSET UNITYSDK_OFFSET(0x13904220)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_GET_NAMEEX_OFFSET UNITYSDK_OFFSET(0x13904310)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_GET_PROFILEPATHEX_OFFSET UNITYSDK_OFFSET(0x139042F0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_01244C5D42565CB2_OFFSET UNITYSDK_OFFSET(0x1390BB60)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_0566F35F3DE56516_OFFSET UNITYSDK_OFFSET(0x1390C170)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_063ADB01C44981A7_OFFSET UNITYSDK_OFFSET(0x1390BF30)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_0C26805D60CF1959_OFFSET UNITYSDK_OFFSET(0x1390A7C0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_0C42DDDF06BF692D_OFFSET UNITYSDK_OFFSET(0x13904380)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_0DABAC67FBEEEDA6_OFFSET UNITYSDK_OFFSET(0x1390F830)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_1454625925CA73F5_OFFSET UNITYSDK_OFFSET(0x1390FD80)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_16E2C4C5C61F8FDB_OFFSET UNITYSDK_OFFSET(0x13906D80)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x1390EC40)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_1B0CF56F555C9A93_OFFSET UNITYSDK_OFFSET(0x1390EFE0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_1B214D9710BB7534_OFFSET UNITYSDK_OFFSET(0x1390FC50)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_2092EACB383790AB_OFFSET UNITYSDK_OFFSET(0x139051F0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_283228DCA08F69C7_OFFSET UNITYSDK_OFFSET(0x139045D0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_2839AE123F8ECAA7_OFFSET UNITYSDK_OFFSET(0x13904AC0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_2BA9010C7C33DCAE_OFFSET UNITYSDK_OFFSET(0x1390CF00)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_2BB7E72A7E700799_OFFSET UNITYSDK_OFFSET(0x13904790)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_2DA5E14835AEFAD5_OFFSET UNITYSDK_OFFSET(0x1390F170)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_31B71B6D307F7F0C_1_OFFSET UNITYSDK_OFFSET(0x1390EDB0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_31B71B6D307F7F0C_OFFSET UNITYSDK_OFFSET(0x1390ED20)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_33A7DE6DC0669409_OFFSET UNITYSDK_OFFSET(0x1390E4A0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_35DD9F229AF5C1D0_1_OFFSET UNITYSDK_OFFSET(0x1390F5E0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_35DD9F229AF5C1D0_OFFSET UNITYSDK_OFFSET(0x1390CD80)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_39CF31F4D7DD3B81_OFFSET UNITYSDK_OFFSET(0x1390E760)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_408445D4519BA880_OFFSET UNITYSDK_OFFSET(0x13907700)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_41206355B1BC7902_OFFSET UNITYSDK_OFFSET(0x1390DAB0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_4307B2A4B4A12C1A_1_OFFSET UNITYSDK_OFFSET(0x1390BD00)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_4307B2A4B4A12C1A_2_OFFSET UNITYSDK_OFFSET(0x1390BFE0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x13905140)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_4E4D3005862CA49B_OFFSET UNITYSDK_OFFSET(0x1390EAA0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_4FF38CFCA5B3077D_OFFSET UNITYSDK_OFFSET(0x13906FB0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_50C10B8AA13AD8D7_OFFSET UNITYSDK_OFFSET(0x13905350)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_511BD23D89CDE949_OFFSET UNITYSDK_OFFSET(0x1390A670)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_52084BFE92581342_OFFSET UNITYSDK_OFFSET(0x1390F260)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_5A0DB1B7B9BE25BD_OFFSET UNITYSDK_OFFSET(0x139041D0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_5D22ABED9373C2B3_OFFSET UNITYSDK_OFFSET(0x1390F690)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_658323AD993800CF_OFFSET UNITYSDK_OFFSET(0x139074B0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_70D35EA6595005E0_OFFSET UNITYSDK_OFFSET(0x1390BA90)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_71F6D03274B314C6_OFFSET UNITYSDK_OFFSET(0x1390DD00)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_722196BE0640FA62_OFFSET UNITYSDK_OFFSET(0x13904710)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_77FD543600E00498_OFFSET UNITYSDK_OFFSET(0x1390F1F0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_79B90490025ABC83_OFFSET UNITYSDK_OFFSET(0x1390FCA0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_7C70D627BA6F6091_OFFSET UNITYSDK_OFFSET(0x1390F8B0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_7EC8FB1E5C75BFDC_OFFSET UNITYSDK_OFFSET(0x1390E2F0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_803856DB6C5D9DB5_OFFSET UNITYSDK_OFFSET(0x139108C0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_8F537CE539CF0103_OFFSET UNITYSDK_OFFSET(0x1390F760)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_9216B801ACD0B564_OFFSET UNITYSDK_OFFSET(0x13905B30)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_98B7D142FBED6D85_OFFSET UNITYSDK_OFFSET(0x1390C090)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_9CFB8FA91400C0F7_OFFSET UNITYSDK_OFFSET(0x1390A740)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_A50B0776CACF3F3C_OFFSET UNITYSDK_OFFSET(0x1390C360)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_A8C3CD0F3AB51701_OFFSET UNITYSDK_OFFSET(0x1390F440)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_A9A048D3B4CDDD40_OFFSET UNITYSDK_OFFSET(0x1390D1D0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_AA05F99BBEDA8B55_OFFSET UNITYSDK_OFFSET(0x1390E910)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_AD7283B0EE0C18A1_OFFSET UNITYSDK_OFFSET(0x1390D580)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_AF36EBA0C8D1FBA2_OFFSET UNITYSDK_OFFSET(0x13906E50)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_B50425D0A09C6F35_OFFSET UNITYSDK_OFFSET(0x1390EE40)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_B81E7C3D0102EBE3_OFFSET UNITYSDK_OFFSET(0x1390D020)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_C137F5CD6FDEBE03_OFFSET UNITYSDK_OFFSET(0x13904180)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_C17DDF50E9F40898_OFFSET UNITYSDK_OFFSET(0x1390ECB0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_CE13F95478F90C1E_OFFSET UNITYSDK_OFFSET(0x139060E0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_D33218A492B26449_OFFSET UNITYSDK_OFFSET(0x13907760)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_D60F4BA24E06086B_OFFSET UNITYSDK_OFFSET(0x1390A6C0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_DCEDA9CA86F04212_OFFSET UNITYSDK_OFFSET(0x1390C870)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_DF3C54A5ADEABAF1_OFFSET UNITYSDK_OFFSET(0x1390F9A0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_E34FD37B13C162FC_OFFSET UNITYSDK_OFFSET(0x13908370)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_E59CAA2089D7E8B1_OFFSET UNITYSDK_OFFSET(0x1390BDB0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_ECCE25DC2E771DF4_OFFSET UNITYSDK_OFFSET(0x139027C0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_F25FA9F7CFC308C3_1_OFFSET UNITYSDK_OFFSET(0x1390C690)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_F25FA9F7CFC308C3_OFFSET UNITYSDK_OFFSET(0x1390C4B0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_F441ACB416811999_OFFSET UNITYSDK_OFFSET(0x1390D380)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_F8EC8B3D73CFFDCF_OFFSET UNITYSDK_OFFSET(0x1390E090)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_FA4F4834B590F55F_OFFSET UNITYSDK_OFFSET(0x1390D770)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x13910240)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x13910200)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_SET_ACTIVEPROFILETRANSITIONTARGET_OFFSET UNITYSDK_OFFSET(0x13904230)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_SET_NAMEEX_OFFSET UNITYSDK_OFFSET(0x13904320)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_SET_PROFILEPATHEX_OFFSET UNITYSDK_OFFSET(0x13904300)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE__CCTOR_OFFSET UNITYSDK_OFFSET(0x139109F0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x13910940)
...
namespace EnviromentSystem
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::EnviromentSystem::EnviroProperty*>**)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0x43AC0);
		}
		static ::System::Collections::Generic::Stack_1<::EnviromentSystem::EnviromentProfile*>** StaticGet__DefaultProfilePool()
		{
			return (::System::Collections::Generic::Stack_1<::EnviromentSystem::EnviromentProfile*>**)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0x43AC8);
		}
		static ::EnviromentSystem::EnviromentProfile** StaticGet__DefaultProfileTemplate()
		{
			return (::EnviromentSystem::EnviromentProfile**)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0x43AD0);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>** StaticGet__EnvPropShaderIDToIndex()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0x43AD8);
		}
		static ::System::Int32* StaticGet_ShadowDirID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0xCE70);
		}
		static ::System::Int32* StaticGet_GlobalRotMatrixID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0xCE74);
		}
		static ::System::Int32* StaticGet_TransitionRateID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0xCE78);
		}
