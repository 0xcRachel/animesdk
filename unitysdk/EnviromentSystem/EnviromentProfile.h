...
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_GET_ACTIVEPROFILETRANSITIONTARGET_OFFSET UNITYSDK_OFFSET(0xFBC5250)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_GET_NAMEEX_OFFSET UNITYSDK_OFFSET(0xFBC5330)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_GET_PROFILEPATHEX_OFFSET UNITYSDK_OFFSET(0xFBC5310)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_0C42DDDF06BF692D_OFFSET UNITYSDK_OFFSET(0xFBC53A0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_0CD37E1A46BB4FCC_OFFSET UNITYSDK_OFFSET(0xFBCDDB0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_1290EA767C459179_1_OFFSET UNITYSDK_OFFSET(0xFBCB620)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_1290EA767C459179_2_OFFSET UNITYSDK_OFFSET(0xFBCB8E0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xFBC5F10)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_16596F395C2C3A4A_OFFSET UNITYSDK_OFFSET(0xFBCCB00)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0xFBCDBB0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_1B214D9710BB7534_OFFSET UNITYSDK_OFFSET(0xFBCEA80)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_1B217C219DE4E4D3_OFFSET UNITYSDK_OFFSET(0xFBCB3D0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_1CD1133DC003C11C_OFFSET UNITYSDK_OFFSET(0xFBCB820)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_2092EACB383790AB_OFFSET UNITYSDK_OFFSET(0xFBC5FD0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_256303B15A3BB162_OFFSET UNITYSDK_OFFSET(0xFBCA240)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_25DEA5C65A602671_OFFSET UNITYSDK_OFFSET(0xFBCE600)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_283228DCA08F69C7_OFFSET UNITYSDK_OFFSET(0xFBC55F0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_2BB7E72A7E700799_OFFSET UNITYSDK_OFFSET(0xFBC57B0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_2D3246FB8DBA00A2_OFFSET UNITYSDK_OFFSET(0xFBCD020)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_2DA5E14835AEFAD5_1_OFFSET UNITYSDK_OFFSET(0xFBCE0D0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_2DA5E14835AEFAD5_OFFSET UNITYSDK_OFFSET(0xFBCE050)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_2DE3F6F38C51D0D5_OFFSET UNITYSDK_OFFSET(0xFBC88B0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_31B71B6D307F7F0C_1_OFFSET UNITYSDK_OFFSET(0xFBCDD20)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_31B71B6D307F7F0C_OFFSET UNITYSDK_OFFSET(0xFBCDC90)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_3F89D6D0CF352DCB_OFFSET UNITYSDK_OFFSET(0xFBCC3F0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_4133699FD543EF18_OFFSET UNITYSDK_OFFSET(0xFBCE150)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_4369EE669C507F5C_OFFSET UNITYSDK_OFFSET(0xFBCC960)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_483AE288ACA59A28_OFFSET UNITYSDK_OFFSET(0xFBC7AD0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_511BD23D89CDE949_OFFSET UNITYSDK_OFFSET(0xFBCA1F0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_5A0DB1B7B9BE25BD_OFFSET UNITYSDK_OFFSET(0xFBC5200)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_5D0554B490BC6FF6_OFFSET UNITYSDK_OFFSET(0xFBC75F0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_5D22ABED9373C2B3_OFFSET UNITYSDK_OFFSET(0xFBCE500)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_6236233B0854D237_OFFSET UNITYSDK_OFFSET(0xFBCD790)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_645B476F801026A7_OFFSET UNITYSDK_OFFSET(0xFBCD390)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_67E299A3526254D2_OFFSET UNITYSDK_OFFSET(0xFBC73D0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_704FAC4600717444_OFFSET UNITYSDK_OFFSET(0xFBC5AE0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_71BB36629F6C4A15_OFFSET UNITYSDK_OFFSET(0xFBCB9A0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_722196BE0640FA62_OFFSET UNITYSDK_OFFSET(0xFBC5730)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_7998F8CA1E002410_OFFSET UNITYSDK_OFFSET(0xFBC74A0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_79B90490025ABC83_OFFSET UNITYSDK_OFFSET(0xFBCEAD0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_7C70D627BA6F6091_OFFSET UNITYSDK_OFFSET(0xFBCE720)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_803856DB6C5D9DB5_OFFSET UNITYSDK_OFFSET(0xFBCF8F0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_8542E37E74FDE1B5_OFFSET UNITYSDK_OFFSET(0xFBC64C0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_8761657B32BF0480_OFFSET UNITYSDK_OFFSET(0xFBC6A60)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_8B37A17B7A3F06D8_OFFSET UNITYSDK_OFFSET(0xFBCE810)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_90F05812FB1D34BE_OFFSET UNITYSDK_OFFSET(0xFBCDA50)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_9314BCB9CF01326C_OFFSET UNITYSDK_OFFSET(0xFBCD8F0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_9B1F2653496E5C47_OFFSET UNITYSDK_OFFSET(0xFBC7D20)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_9E466DEA0B216BA9_OFFSET UNITYSDK_OFFSET(0xFBCC7C0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_9FE9E59BEF999D1D_OFFSET UNITYSDK_OFFSET(0xFBCCE20)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_A738D0DFE2533F04_OFFSET UNITYSDK_OFFSET(0xFBCDF10)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_A79B4A90655C12CD_OFFSET UNITYSDK_OFFSET(0xFBCA340)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_AEDF24558C1E3059_OFFSET UNITYSDK_OFFSET(0xFBCC500)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_AFF7609F18B1F51B_OFFSET UNITYSDK_OFFSET(0xFBCC660)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_B69ABBBCD36242AB_OFFSET UNITYSDK_OFFSET(0xFBC38F0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_B71CEDD370D1BF83_1_OFFSET UNITYSDK_OFFSET(0xFBCE430)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_B71CEDD370D1BF83_OFFSET UNITYSDK_OFFSET(0xFB915A0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_B8988AFA2C9F74D0_OFFSET UNITYSDK_OFFSET(0xFBC6130)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_BFEA4306648173E8_OFFSET UNITYSDK_OFFSET(0xFBCE6A0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_C137F5CD6FDEBE03_OFFSET UNITYSDK_OFFSET(0xFBC51B0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_C17DDF50E9F40898_OFFSET UNITYSDK_OFFSET(0xFBCDC20)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_CC71F10E35F0F1C2_1_OFFSET UNITYSDK_OFFSET(0xFBCBD80)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_CC71F10E35F0F1C2_OFFSET UNITYSDK_OFFSET(0xFBCBBC0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_D87A7D8243E04FD7_OFFSET UNITYSDK_OFFSET(0xFBCB6E0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_DA42B87A2F252530_OFFSET UNITYSDK_OFFSET(0xFBCA2C0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_DB915699370309DA_OFFSET UNITYSDK_OFFSET(0xFBCEBC0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_DBA44A18873D9728_OFFSET UNITYSDK_OFFSET(0xFB94300)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_DCEDA9CA86F04212_OFFSET UNITYSDK_OFFSET(0xFBCBF40)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_DEBCE28D42BF738B_OFFSET UNITYSDK_OFFSET(0xFBAFC10)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_E06E94B84B302469_OFFSET UNITYSDK_OFFSET(0xFBC7CC0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_E3ADA5CA2C064E44_OFFSET UNITYSDK_OFFSET(0xFBCB4A0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_F226A06C0CBED3A7_OFFSET UNITYSDK_OFFSET(0xFBCE2E0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_F40B7BA720D3CFD0_OFFSET UNITYSDK_OFFSET(0xFBCBA90)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_FD3047E2A8A3FB19_OFFSET UNITYSDK_OFFSET(0xFBCD4F0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xFBCF010)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xFBCEFD0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_SET_ACTIVEPROFILETRANSITIONTARGET_OFFSET UNITYSDK_OFFSET(0xFBC5260)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_SET_NAMEEX_OFFSET UNITYSDK_OFFSET(0xFBC5340)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_SET_PROFILEPATHEX_OFFSET UNITYSDK_OFFSET(0xFBC5320)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE__CCTOR_OFFSET UNITYSDK_OFFSET(0xFBCFA20)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0xFBCF970)
...
namespace EnviromentSystem
{
	...
	public:
		...
		{
			return (::EnviromentSystem::EnviromentProfile**)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0x10900);
		}
		static ::System::Collections::Generic::Stack_1<::EnviromentSystem::EnviromentProfile*>** StaticGet__DefaultProfilePool()
		{
			return (::System::Collections::Generic::Stack_1<::EnviromentSystem::EnviromentProfile*>**)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0x10908);
		}
		static ::System::Collections::Generic::List_1<::EnviromentSystem::EnviroProperty*>** StaticGet__LoadResources()
		{
			return (::System::Collections::Generic::List_1<::EnviromentSystem::EnviroProperty*>**)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0x10910);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>** StaticGet__EnvPropShaderIDToIndex()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0x10918);
		}
		static ::System::Int32* StaticGet_ShadowDirID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0x5B30);
		}
		static ::System::Int32* StaticGet_TransitionRateID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0x5B34);
		}
		static ::System::Int32* StaticGet_GlobalRotMatrixID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0x5B38);
		}
		...
		::System::Void Method_3_2DE3F6F38C51D0D5(::Class_0_16E4307DCC419505_293* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_293*))((::PBYTE)hIl2Cpp + ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_2DE3F6F38C51D0D5_OFFSET))(this, a1);
		}
