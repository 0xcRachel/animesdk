...
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_GET_ACTIVEPROFILETRANSITIONTARGET_OFFSET UNITYSDK_OFFSET(0xE4E4480)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_GET_NAMEEX_OFFSET UNITYSDK_OFFSET(0xE4E4560)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_GET_PROFILEPATHEX_OFFSET UNITYSDK_OFFSET(0xE4E4540)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_0C42DDDF06BF692D_OFFSET UNITYSDK_OFFSET(0xE4E45D0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_0CD37E1A46BB4FCC_OFFSET UNITYSDK_OFFSET(0xE4ED5B0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_1290EA767C459179_1_OFFSET UNITYSDK_OFFSET(0xE4EAAB0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_1290EA767C459179_2_OFFSET UNITYSDK_OFFSET(0xE4EAD70)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xE4E5140)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_16596F395C2C3A4A_OFFSET UNITYSDK_OFFSET(0xE4EC100)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0xE4ED3B0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_1B214D9710BB7534_OFFSET UNITYSDK_OFFSET(0xE4EE280)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_1B217C219DE4E4D3_OFFSET UNITYSDK_OFFSET(0xE4EA860)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_1CD1133DC003C11C_OFFSET UNITYSDK_OFFSET(0xE4EACB0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_2092EACB383790AB_OFFSET UNITYSDK_OFFSET(0xE4E5200)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_256303B15A3BB162_OFFSET UNITYSDK_OFFSET(0xE4E96D0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_25DEA5C65A602671_OFFSET UNITYSDK_OFFSET(0xE4EDE00)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_283228DCA08F69C7_OFFSET UNITYSDK_OFFSET(0xE4E4820)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_2BB7E72A7E700799_OFFSET UNITYSDK_OFFSET(0xE4E49E0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_2D3246FB8DBA00A2_OFFSET UNITYSDK_OFFSET(0xE4EC620)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_2DA5E14835AEFAD5_1_OFFSET UNITYSDK_OFFSET(0xE4ED8D0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_2DA5E14835AEFAD5_OFFSET UNITYSDK_OFFSET(0xE4ED850)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_31B71B6D307F7F0C_1_OFFSET UNITYSDK_OFFSET(0xE4ED520)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_31B71B6D307F7F0C_OFFSET UNITYSDK_OFFSET(0xE4ED490)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_3F89D6D0CF352DCB_OFFSET UNITYSDK_OFFSET(0xE4EB9F0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_4133699FD543EF18_OFFSET UNITYSDK_OFFSET(0xE4ED950)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_4369EE669C507F5C_OFFSET UNITYSDK_OFFSET(0xE4EBF60)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_483AE288ACA59A28_OFFSET UNITYSDK_OFFSET(0xE4E6D20)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_511BD23D89CDE949_OFFSET UNITYSDK_OFFSET(0xE4E9680)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_5A0DB1B7B9BE25BD_OFFSET UNITYSDK_OFFSET(0xE4E4430)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_5D0554B490BC6FF6_OFFSET UNITYSDK_OFFSET(0xE4E6840)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_5D22ABED9373C2B3_OFFSET UNITYSDK_OFFSET(0xE4EDD00)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_6236233B0854D237_OFFSET UNITYSDK_OFFSET(0xE4ECF90)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_645B476F801026A7_OFFSET UNITYSDK_OFFSET(0xE4ECB90)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_67E299A3526254D2_OFFSET UNITYSDK_OFFSET(0xE4E6620)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_704FAC4600717444_OFFSET UNITYSDK_OFFSET(0xE4E4D10)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_71BB36629F6C4A15_OFFSET UNITYSDK_OFFSET(0xE4EAE30)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_722196BE0640FA62_OFFSET UNITYSDK_OFFSET(0xE4E4960)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_7998F8CA1E002410_OFFSET UNITYSDK_OFFSET(0xE4E66F0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_79B90490025ABC83_OFFSET UNITYSDK_OFFSET(0xE4EE2D0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_7C70D627BA6F6091_OFFSET UNITYSDK_OFFSET(0xE4EDF20)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_803856DB6C5D9DB5_OFFSET UNITYSDK_OFFSET(0xE4EF0F0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_8542E37E74FDE1B5_OFFSET UNITYSDK_OFFSET(0xE4E56F0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_8761657B32BF0480_OFFSET UNITYSDK_OFFSET(0xE4E5CB0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_8B37A17B7A3F06D8_OFFSET UNITYSDK_OFFSET(0xE4EE010)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_90F05812FB1D34BE_OFFSET UNITYSDK_OFFSET(0xE4ED250)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_9314BCB9CF01326C_OFFSET UNITYSDK_OFFSET(0xE4ED0F0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_9B1F2653496E5C47_OFFSET UNITYSDK_OFFSET(0xE4E6F70)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_9E466DEA0B216BA9_OFFSET UNITYSDK_OFFSET(0xE4EBDC0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_9FE9E59BEF999D1D_OFFSET UNITYSDK_OFFSET(0xE4EC420)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_A738D0DFE2533F04_OFFSET UNITYSDK_OFFSET(0xE4ED710)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_A79B4A90655C12CD_OFFSET UNITYSDK_OFFSET(0xE4E97D0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_AEDF24558C1E3059_OFFSET UNITYSDK_OFFSET(0xE4EBB00)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_AFF7609F18B1F51B_OFFSET UNITYSDK_OFFSET(0xE4EBC60)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_B69ABBBCD36242AB_OFFSET UNITYSDK_OFFSET(0xE4E2B20)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_B71CEDD370D1BF83_1_OFFSET UNITYSDK_OFFSET(0xE4EDC30)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_B71CEDD370D1BF83_OFFSET UNITYSDK_OFFSET(0xE4EB880)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_B8988AFA2C9F74D0_OFFSET UNITYSDK_OFFSET(0xE4E5360)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_BFEA4306648173E8_OFFSET UNITYSDK_OFFSET(0xE4EDEA0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_C137F5CD6FDEBE03_OFFSET UNITYSDK_OFFSET(0xE4E43E0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_C17DDF50E9F40898_OFFSET UNITYSDK_OFFSET(0xE4ED420)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_CC71F10E35F0F1C2_1_OFFSET UNITYSDK_OFFSET(0xE4EB210)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_CC71F10E35F0F1C2_OFFSET UNITYSDK_OFFSET(0xE4EB050)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_CEEBAE1B999F370D_OFFSET UNITYSDK_OFFSET(0xE4E7B00)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_D87A7D8243E04FD7_OFFSET UNITYSDK_OFFSET(0xE4EAB70)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_DA42B87A2F252530_OFFSET UNITYSDK_OFFSET(0xE4E9750)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_DB915699370309DA_OFFSET UNITYSDK_OFFSET(0xE4EE3C0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_DBA44A18873D9728_OFFSET UNITYSDK_OFFSET(0xE4EC990)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_DCEDA9CA86F04212_OFFSET UNITYSDK_OFFSET(0xE4EB3D0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_DEBCE28D42BF738B_OFFSET UNITYSDK_OFFSET(0xE4CE450)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_E06E94B84B302469_OFFSET UNITYSDK_OFFSET(0xE4E6F10)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_E3ADA5CA2C064E44_OFFSET UNITYSDK_OFFSET(0xE4EA930)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_F226A06C0CBED3A7_OFFSET UNITYSDK_OFFSET(0xE4EDAE0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_F40B7BA720D3CFD0_OFFSET UNITYSDK_OFFSET(0xE4EAF20)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_FD3047E2A8A3FB19_OFFSET UNITYSDK_OFFSET(0xE4ECCF0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xE4EE810)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xE4EE7D0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_SET_ACTIVEPROFILETRANSITIONTARGET_OFFSET UNITYSDK_OFFSET(0xE4E4490)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_SET_NAMEEX_OFFSET UNITYSDK_OFFSET(0xE4E4570)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_SET_PROFILEPATHEX_OFFSET UNITYSDK_OFFSET(0xE4E4550)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE__CCTOR_OFFSET UNITYSDK_OFFSET(0xE4EF220)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0xE4EF170)

namespace EnviromentSystem
{
	inline static constexpr unsigned int EnviromentProfile_TypeDefinitionIndex = 39293;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::EnviromentSystem::EnviroProperty*>**)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0x44BE0);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>** StaticGet__EnvPropShaderIDToIndex()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0x44BE8);
		}
		static ::System::Collections::Generic::Stack_1<::EnviromentSystem::EnviromentProfile*>** StaticGet__DefaultProfilePool()
		{
			return (::System::Collections::Generic::Stack_1<::EnviromentSystem::EnviromentProfile*>**)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0x44BF0);
		}
		static ::EnviromentSystem::EnviromentProfile** StaticGet__DefaultProfileTemplate()
		{
			return (::EnviromentSystem::EnviromentProfile**)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0x44BF8);
		}
		static ::System::Int32* StaticGet_GlobalRotMatrixID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0xFF90);
		}
		static ::System::Int32* StaticGet_ShadowDirID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0xFF94);
		}
		static ::System::Int32* StaticGet_TransitionRateID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0xFF98);
		}
		...
		{
			return ((::Class_0_16E4307DCC419505_260*(*)(::PVOID))((::PBYTE)hIl2Cpp + ENVIROMENTSYSTEM_ENVIROMENTPROFILE_GET_ACTIVEPROFILETRANSITIONTARGET_OFFSET))(this);
		}

		::System::Void set_ActiveProfileTransitionTarget(::Class_0_16E4307DCC419505_260* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_260*))((::PBYTE)hIl2Cpp + ENVIROMENTSYSTEM_ENVIROMENTPROFILE_SET_ACTIVEPROFILETRANSITIONTARGET_OFFSET))(this, a1);
		}
		...
		::System::Void Method_3_CEEBAE1B999F370D(::Class_0_16E4307DCC419505_260* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_260*))((::PBYTE)hIl2Cpp + ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_CEEBAE1B999F370D_OFFSET))(this, a1);
		}
		...
		::System::Void Method_3_A79B4A90655C12CD(::Class_0_16E4307DCC419505_260* a1, ::EnviromentSystem::EnviromentClip_OnEnvironmentClipLoadDelegate* a2)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_260*, ::EnviromentSystem::EnviromentClip_OnEnvironmentClipLoadDelegate*))((::PBYTE)hIl2Cpp + ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_A79B4A90655C12CD_OFFSET))(this, a1, a2);
		}
		...
		::System::Void Method_3_DB915699370309DA(::Class_0_16E4307DCC419505_260* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_260*))((::PBYTE)hIl2Cpp + ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_DB915699370309DA_OFFSET))(this, a1);
		}
