...
#define ENVIROMENTSYSTEM_ENVIROLIGHTQUALITYFALLBACKGROUP_METHOD_3_26CAE11E3FF3D896_OFFSET UNITYSDK_OFFSET(0xC33DD80)
#define ENVIROMENTSYSTEM_ENVIROLIGHTQUALITYFALLBACKGROUP_METHOD_3_4B0274957BFBA3A3_OFFSET UNITYSDK_OFFSET(0xC33D440)
#define ENVIROMENTSYSTEM_ENVIROLIGHTQUALITYFALLBACKGROUP_METHOD_3_793FFA9A76FE6840_OFFSET UNITYSDK_OFFSET(0xC33DDF0)
#define ENVIROMENTSYSTEM_ENVIROLIGHTQUALITYFALLBACKGROUP_METHOD_3_E83461C42980F950_OFFSET UNITYSDK_OFFSET(0xC33CC30)
#define ENVIROMENTSYSTEM_ENVIROLIGHTQUALITYFALLBACKGROUP__CCTOR_OFFSET UNITYSDK_OFFSET(0xC33DA50)
#define ENVIROMENTSYSTEM_ENVIROLIGHTQUALITYFALLBACKGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xC33C9A0)
...
namespace EnviromentSystem
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::EnviromentSystem::EnviromentPropertiesID, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(EnviroLightQualityFallbackGroup_TypeDefinitionIndex)->GetStaticField(0x13530);
		}
