...
#define ENVIROMENTSYSTEM_ENVIROWEATHERCLIP_METHOD_2_06D8B02BA841B626_OFFSET UNITYSDK_OFFSET(0xE4E0550)
#define ENVIROMENTSYSTEM_ENVIROWEATHERCLIP_METHOD_2_8EE0DEE68564597C_OFFSET UNITYSDK_OFFSET(0xE4E0600)
#define ENVIROMENTSYSTEM_ENVIROWEATHERCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xE4E05F0)

namespace EnviromentSystem
{
	inline static constexpr unsigned int EnviroWeatherClip_TypeDefinitionIndex = 39288;
