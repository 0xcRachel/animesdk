...
#define CLASS_1_355A2207C3B7A99D_100_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A7EF0D0)
#define CLASS_1_355A2207C3B7A99D_100_CLONE_OFFSET UNITYSDK_OFFSET(0x1A7EECE0)
#define CLASS_1_355A2207C3B7A99D_100_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A7EEE30)
#define CLASS_1_355A2207C3B7A99D_100_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A7EED80)
#define CLASS_1_355A2207C3B7A99D_100_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A7EEED0)
#define CLASS_1_355A2207C3B7A99D_100_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A7EF220)
#define CLASS_1_355A2207C3B7A99D_100_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A7EF130)
#define CLASS_1_355A2207C3B7A99D_100_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x1A7EED60)
#define CLASS_1_355A2207C3B7A99D_100_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A7EEC20)
#define CLASS_1_355A2207C3B7A99D_100_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x1A7EED70)
#define CLASS_1_355A2207C3B7A99D_100_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A7EEC50)
#define CLASS_1_355A2207C3B7A99D_100_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A7EF010)
#define CLASS_1_355A2207C3B7A99D_100_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A7EF070)
#define CLASS_1_355A2207C3B7A99D_100__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A7EF3F0)
#define CLASS_1_355A2207C3B7A99D_100__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A7EEC70)
#define CLASS_1_355A2207C3B7A99D_100__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7EEC60)

inline static constexpr unsigned int Class_1_355A2207C3B7A99D_100_TypeDefinitionIndex = 31347;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_355A2207C3B7A99D_100*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_355A2207C3B7A99D_100_TypeDefinitionIndex)->GetStaticField(0x4FCB0);
	}
	...
	{
		return ((::Class_1_7E9AC8675DA072FB_3*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_355A2207C3B7A99D_100_METHOD_1_24748FC20F375725_OFFSET))(this);
	}

	::System::Void Method_1_8C8625211DA811AE(::Class_1_7E9AC8675DA072FB_3* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_7E9AC8675DA072FB_3*))((::PBYTE)hIl2Cpp + CLASS_1_355A2207C3B7A99D_100_METHOD_1_8C8625211DA811AE_OFFSET))(this, a1);
	}
