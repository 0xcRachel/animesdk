...
#define CLASS_3_ED823159C0D529ED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1793EE30)
#define CLASS_3_ED823159C0D529ED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1793EEC0)
#define CLASS_3_ED823159C0D529ED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1793EAA0)
#define CLASS_3_ED823159C0D529ED__CTOR_OFFSET UNITYSDK_OFFSET(0x1793EA80)
