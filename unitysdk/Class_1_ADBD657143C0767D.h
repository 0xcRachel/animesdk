...
#define CLASS_1_ADBD657143C0767D_GET_CURSORPOS_OFFSET UNITYSDK_OFFSET(0xA40CB60)
#define CLASS_1_ADBD657143C0767D_GET_ISPRESSJOYSTICK_OFFSET UNITYSDK_OFFSET(0xA40CB90)
#define CLASS_1_ADBD657143C0767D_GET_JOYSTICKINPUT_OFFSET UNITYSDK_OFFSET(0xA40CBB0)
#define CLASS_1_ADBD657143C0767D_GET_TOUCHINPUT_OFFSET UNITYSDK_OFFSET(0xA40CBE0)
#define CLASS_1_ADBD657143C0767D_METHOD_1_078D85152011B919_OFFSET UNITYSDK_OFFSET(0xA40BFB0)
#define CLASS_1_ADBD657143C0767D_METHOD_1_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xA40C8B0)
#define CLASS_1_ADBD657143C0767D_METHOD_1_28F815C49D235C59_OFFSET UNITYSDK_OFFSET(0xA40BAA0)
#define CLASS_1_ADBD657143C0767D_METHOD_1_354CB9B459B0C5D5_OFFSET UNITYSDK_OFFSET(0xA40BF30)
#define CLASS_1_ADBD657143C0767D_METHOD_1_4D2A473556700CDC_1_OFFSET UNITYSDK_OFFSET(0xA40C560)
#define CLASS_1_ADBD657143C0767D_METHOD_1_4D2A473556700CDC_OFFSET UNITYSDK_OFFSET(0xA40C000)
#define CLASS_1_ADBD657143C0767D_METHOD_1_56CE4AFC5339F746_OFFSET UNITYSDK_OFFSET(0xA40C510)
#define CLASS_1_ADBD657143C0767D_METHOD_1_85E657E328490B3B_OFFSET UNITYSDK_OFFSET(0xA40B9D0)
#define CLASS_1_ADBD657143C0767D_METHOD_1_8BD11CDEA7D5139F_OFFSET UNITYSDK_OFFSET(0xA40C9F0)
#define CLASS_1_ADBD657143C0767D_METHOD_1_9D967D80C41C7781_1_OFFSET UNITYSDK_OFFSET(0xA40CF60)
#define CLASS_1_ADBD657143C0767D_METHOD_1_9D967D80C41C7781_2_OFFSET UNITYSDK_OFFSET(0xA40CFB0)
#define CLASS_1_ADBD657143C0767D_METHOD_1_9D967D80C41C7781_OFFSET UNITYSDK_OFFSET(0xA40CF10)
#define CLASS_1_ADBD657143C0767D_METHOD_1_AA1355730928EC40_OFFSET UNITYSDK_OFFSET(0xA40CD40)
#define CLASS_1_ADBD657143C0767D_METHOD_1_B12B4E4A39A083D2_OFFSET UNITYSDK_OFFSET(0xA40BDD0)
#define CLASS_1_ADBD657143C0767D_METHOD_1_C638E91FC0D3A13A_OFFSET UNITYSDK_OFFSET(0xA40C350)
#define CLASS_1_ADBD657143C0767D_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xA40CCE0)
#define CLASS_1_ADBD657143C0767D_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA40BA50)
#define CLASS_1_ADBD657143C0767D_METHOD_1_D20BF56E36607D54_1_OFFSET UNITYSDK_OFFSET(0xA40B980)
#define CLASS_1_ADBD657143C0767D_METHOD_1_D20BF56E36607D54_OFFSET UNITYSDK_OFFSET(0xA40B930)
#define CLASS_1_ADBD657143C0767D_METHOD_1_F3044C7F0F775E6E_OFFSET UNITYSDK_OFFSET(0xA40CC10)
#define CLASS_1_ADBD657143C0767D_SET_CURSORPOS_OFFSET UNITYSDK_OFFSET(0xA40CB80)
#define CLASS_1_ADBD657143C0767D_SET_ISPRESSJOYSTICK_OFFSET UNITYSDK_OFFSET(0xA40CBA0)
#define CLASS_1_ADBD657143C0767D_SET_JOYSTICKINPUT_OFFSET UNITYSDK_OFFSET(0xA40CBD0)
#define CLASS_1_ADBD657143C0767D_SET_TOUCHINPUT_OFFSET UNITYSDK_OFFSET(0xA40CC00)
#define CLASS_1_ADBD657143C0767D__CTOR_OFFSET UNITYSDK_OFFSET(0xA40D000)

inline static constexpr unsigned int Class_1_ADBD657143C0767D_TypeDefinitionIndex = 68225;
...
public:
	...
	::UnityEngine::Vector3 _CursorPos_k__BackingField; // 0x20
	::UnityEngine::Vector3 _JoyStickInput_k__BackingField; // 0x2C
	::System::Single Field_1_3; // 0x38
	::System::Boolean _IsPressJoyStick_k__BackingField; // 0x3C
	::HedgehogTeam::EasyTouch::EasyTouch_EvtType Field_1_8; // 0x40
