...
#define CLASS_1_2F5D295C6E3B1908_METHOD_1_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x10448310)
#define CLASS_1_2F5D295C6E3B1908_METHOD_1_5D45212808F4212D_OFFSET UNITYSDK_OFFSET(0x10448500)
#define CLASS_1_2F5D295C6E3B1908_METHOD_1_97B231C192A52EEC_OFFSET UNITYSDK_OFFSET(0x10448690)
#define CLASS_1_2F5D295C6E3B1908_METHOD_1_E9F4574478C103DE_OFFSET UNITYSDK_OFFSET(0x10448360)
#define CLASS_1_2F5D295C6E3B1908_METHOD_1_F730968E2645E14B_OFFSET UNITYSDK_OFFSET(0x10448210)

inline static constexpr unsigned int Class_1_2F5D295C6E3B1908_TypeDefinitionIndex = 44362;
...
public:
	...
	{
		return (::RPG::GameCore::CharacterSkillStatisticConfig**)Il2CppClass::FromTypeDefinitionIndex(Class_1_2F5D295C6E3B1908_TypeDefinitionIndex)->GetStaticField(0x42440);
	}
	static ::RPG::GameCore::CharacterSkillCustomStatisticConfig** StaticGet_Field_1_1()
	{
		return (::RPG::GameCore::CharacterSkillCustomStatisticConfig**)Il2CppClass::FromTypeDefinitionIndex(Class_1_2F5D295C6E3B1908_TypeDefinitionIndex)->GetStaticField(0x42448);
	}
