...
#define CLASS_1_2F5D295C6E3B1908_METHOD_1_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xA4667C0)
#define CLASS_1_2F5D295C6E3B1908_METHOD_1_5D45212808F4212D_OFFSET UNITYSDK_OFFSET(0xA4669B0)
#define CLASS_1_2F5D295C6E3B1908_METHOD_1_97B231C192A52EEC_OFFSET UNITYSDK_OFFSET(0xA466B40)
#define CLASS_1_2F5D295C6E3B1908_METHOD_1_E9F4574478C103DE_OFFSET UNITYSDK_OFFSET(0xA466810)
#define CLASS_1_2F5D295C6E3B1908_METHOD_1_F730968E2645E14B_OFFSET UNITYSDK_OFFSET(0xA4666C0)
...
public:
	...
	{
		return (::RPG::GameCore::CharacterSkillStatisticConfig**)Il2CppClass::FromTypeDefinitionIndex(Class_1_2F5D295C6E3B1908_TypeDefinitionIndex)->GetStaticField(0x41FD0);
	}
	static ::RPG::GameCore::CharacterSkillCustomStatisticConfig** StaticGet_Field_1_1()
	{
		return (::RPG::GameCore::CharacterSkillCustomStatisticConfig**)Il2CppClass::FromTypeDefinitionIndex(Class_1_2F5D295C6E3B1908_TypeDefinitionIndex)->GetStaticField(0x41FD8);
	}
