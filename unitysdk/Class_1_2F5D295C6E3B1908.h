...
#define CLASS_1_2F5D295C6E3B1908_METHOD_1_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xD51DD70)
#define CLASS_1_2F5D295C6E3B1908_METHOD_1_5D45212808F4212D_OFFSET UNITYSDK_OFFSET(0xD51DF40)
#define CLASS_1_2F5D295C6E3B1908_METHOD_1_97B231C192A52EEC_OFFSET UNITYSDK_OFFSET(0xD51E0D0)
#define CLASS_1_2F5D295C6E3B1908_METHOD_1_BF7DFCFFEEF133E7_OFFSET UNITYSDK_OFFSET(0xD51DDC0)
#define CLASS_1_2F5D295C6E3B1908_METHOD_1_F730968E2645E14B_OFFSET UNITYSDK_OFFSET(0xD51DC70)
...
public:
	...
	{
		return (::RPG::GameCore::CharacterSkillStatisticConfig**)Il2CppClass::FromTypeDefinitionIndex(Class_1_2F5D295C6E3B1908_TypeDefinitionIndex)->GetStaticField(0x69840);
	}
	static ::RPG::GameCore::CharacterSkillCustomStatisticConfig** StaticGet_Field_1_1()
	{
		return (::RPG::GameCore::CharacterSkillCustomStatisticConfig**)Il2CppClass::FromTypeDefinitionIndex(Class_1_2F5D295C6E3B1908_TypeDefinitionIndex)->GetStaticField(0x69848);
	}
