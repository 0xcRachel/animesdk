...
#define CLASS_2_AB63354E1CBC48D4_GETQUALITYFILTER_OFFSET UNITYSDK_OFFSET(0x16C1E5E0)
#define CLASS_2_AB63354E1CBC48D4_GETTYPEID_OFFSET UNITYSDK_OFFSET(0x16C1E630)
#define CLASS_2_AB63354E1CBC48D4_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x16C1E410)
#define CLASS_2_AB63354E1CBC48D4_ONBEGINSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x16C1F200)
#define CLASS_2_AB63354E1CBC48D4_ONBEGINSCENELIGHTLODFADING_OFFSET UNITYSDK_OFFSET(0x16C1F7F0)
#define CLASS_2_AB63354E1CBC48D4_ONENDSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x16C1F3F0)
#define CLASS_2_AB63354E1CBC48D4_ONENDSCENELIGHTLODFADING_OFFSET UNITYSDK_OFFSET(0x16C1F9E0)
#define CLASS_2_AB63354E1CBC48D4_ONGETFROMPOOLASYNC_OFFSET UNITYSDK_OFFSET(0x16C1E980)
#define CLASS_2_AB63354E1CBC48D4_ONOBJECTCREATEDASYNC_OFFSET UNITYSDK_OFFSET(0x16C1E9D0)
#define CLASS_2_AB63354E1CBC48D4_ONOBJECTDESTROY_OFFSET UNITYSDK_OFFSET(0x16C1E8C0)
#define CLASS_2_AB63354E1CBC48D4_ONOBJECTENABLE_OFFSET UNITYSDK_OFFSET(0x16C1EA20)
#define CLASS_2_AB63354E1CBC48D4_ONPUTTOPOOL_OFFSET UNITYSDK_OFFSET(0x16C1E940)
#define CLASS_2_AB63354E1CBC48D4_ONRELEASE_OFFSET UNITYSDK_OFFSET(0x16C1E6D0)
#define CLASS_2_AB63354E1CBC48D4_ONSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x16C1EFF0)
#define CLASS_2_AB63354E1CBC48D4_ONSCENELIGHTLODFADING_OFFSET UNITYSDK_OFFSET(0x16C1F5E0)
#define CLASS_2_AB63354E1CBC48D4_ONSETSCENELIGHTLOD_OFFSET UNITYSDK_OFFSET(0x16C1FBD0)
#define CLASS_2_AB63354E1CBC48D4_ONUNSERIALIZEFINISH_OFFSET UNITYSDK_OFFSET(0x16C1E900)
#define CLASS_2_AB63354E1CBC48D4_SETHOSTMANAGEDLIGHT_OFFSET UNITYSDK_OFFSET(0x16C1E680)
#define CLASS_2_AB63354E1CBC48D4_UNSERIALIZEASYNC_OFFSET UNITYSDK_OFFSET(0x16C1E4E0)
#define CLASS_2_AB63354E1CBC48D4__CCTOR_OFFSET UNITYSDK_OFFSET(0x16C1FDC0)
#define CLASS_2_AB63354E1CBC48D4__CTOR_OFFSET UNITYSDK_OFFSET(0x16C1E4A0)
#define CLASS_2_AB63354E1CBC48D4__UNSERIALIZEASYNC_B__6_0_OFFSET UNITYSDK_OFFSET(0x16C1FDF0)
#define CLASS_2_AB63354E1CBC48D4___IFIXBASEPROXY_GETQUALITYFILTER_OFFSET UNITYSDK_OFFSET(0x16C1FEC0)
#define CLASS_2_AB63354E1CBC48D4___IFIXBASEPROXY_ONBEGINSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x16C200A0)
#define CLASS_2_AB63354E1CBC48D4___IFIXBASEPROXY_ONBEGINSCENELIGHTLODFADING_OFFSET UNITYSDK_OFFSET(0x16C201D0)
#define CLASS_2_AB63354E1CBC48D4___IFIXBASEPROXY_ONENDSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x16C20100)
#define CLASS_2_AB63354E1CBC48D4___IFIXBASEPROXY_ONENDSCENELIGHTLODFADING_OFFSET UNITYSDK_OFFSET(0x16C20240)
#define CLASS_2_AB63354E1CBC48D4___IFIXBASEPROXY_ONOBJECTENABLE_OFFSET UNITYSDK_OFFSET(0x16C1FFE0)
#define CLASS_2_AB63354E1CBC48D4___IFIXBASEPROXY_ONSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x16C20040)
#define CLASS_2_AB63354E1CBC48D4___IFIXBASEPROXY_ONSCENELIGHTLODFADING_OFFSET UNITYSDK_OFFSET(0x16C20160)
#define CLASS_2_AB63354E1CBC48D4___IFIXBASEPROXY_ONSETSCENELIGHTLOD_OFFSET UNITYSDK_OFFSET(0x16C202B0)
#define CLASS_2_AB63354E1CBC48D4___IFIXBASEPROXY_ONUNSERIALIZEFINISH_OFFSET UNITYSDK_OFFSET(0x16C1FF80)
#define CLASS_2_AB63354E1CBC48D4___IFIXBASEPROXY_SETHOSTMANAGEDLIGHT_OFFSET UNITYSDK_OFFSET(0x16C1FF20)
...
public:
	...
	{
		return (::Class_1_AEC3A955120B8107**)Il2CppClass::FromTypeDefinitionIndex(Class_2_AB63354E1CBC48D4_TypeDefinitionIndex)->GetStaticField(0x2A270);
	}
	::UnityEngine::GameObject* Field_2_1; // 0x20
	::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_326*>* Field_2_2; // 0x28
