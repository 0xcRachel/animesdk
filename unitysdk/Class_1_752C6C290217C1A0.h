...
#define CLASS_1_752C6C290217C1A0_EXECUTE_OFFSET UNITYSDK_OFFSET(0x10431D40)
#define CLASS_1_752C6C290217C1A0_TICK_OFFSET UNITYSDK_OFFSET(0x10431EC0)
#define CLASS_1_752C6C290217C1A0__CTOR_OFFSET UNITYSDK_OFFSET(0x10431D30)

inline static constexpr unsigned int Class_1_752C6C290217C1A0_TypeDefinitionIndex = 71239;
