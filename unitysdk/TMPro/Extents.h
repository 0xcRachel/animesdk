...
#define TMPRO_EXTENTS_TOSTRING_OFFSET UNITYSDK_OFFSET(0x22594E0)
#define TMPRO_EXTENTS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1606EFC0)
#define TMPRO_EXTENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x608B90)
...
namespace TMPro
{
	...
	struct alignas(4) Extents
	{
		...
		{
			return (::TMPro::Extents*)Il2CppClass::FromTypeDefinitionIndex(Extents_TypeDefinitionIndex)->GetStaticField(0xF580);
		}
