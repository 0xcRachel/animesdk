...
#define TMPRO_EXTENTS_TOSTRING_OFFSET UNITYSDK_OFFSET(0x21128B0)
#define TMPRO_EXTENTS__CCTOR_OFFSET UNITYSDK_OFFSET(0x189155E0)
#define TMPRO_EXTENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x72D30)
...
namespace TMPro
{
	...
	struct alignas(4) Extents
	{
		...
		{
			return (::TMPro::Extents*)Il2CppClass::FromTypeDefinitionIndex(Extents_TypeDefinitionIndex)->GetStaticField(0x108D0);
		}
		static ::TMPro::Extents* StaticGet_uninitialized()
		{
			return (::TMPro::Extents*)Il2CppClass::FromTypeDefinitionIndex(Extents_TypeDefinitionIndex)->GetStaticField(0x108E0);
		}
