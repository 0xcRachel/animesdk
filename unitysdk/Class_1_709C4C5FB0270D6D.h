...
#define CLASS_1_709C4C5FB0270D6D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x847F160)
#define CLASS_1_709C4C5FB0270D6D_METHOD_1_006EF7FF09C45353_OFFSET UNITYSDK_OFFSET(0x847F6E0)
#define CLASS_1_709C4C5FB0270D6D_METHOD_1_226842F6044F973B_OFFSET UNITYSDK_OFFSET(0x847F1B0)
#define CLASS_1_709C4C5FB0270D6D_METHOD_1_654E186F29967F71_OFFSET UNITYSDK_OFFSET(0x847FED0)
#define CLASS_1_709C4C5FB0270D6D_METHOD_1_8EA3DD3D2884C0BF_OFFSET UNITYSDK_OFFSET(0x84801A0)
#define CLASS_1_709C4C5FB0270D6D_METHOD_1_9333253040407D39_OFFSET UNITYSDK_OFFSET(0x847FD60)
#define CLASS_1_709C4C5FB0270D6D_METHOD_1_A693F2E8D4F4A766_OFFSET UNITYSDK_OFFSET(0x847F2B0)
#define CLASS_1_709C4C5FB0270D6D_METHOD_1_D81224686493F7E5_OFFSET UNITYSDK_OFFSET(0x847F320)
#define CLASS_1_709C4C5FB0270D6D_METHOD_1_E9EBE847C2A79912_OFFSET UNITYSDK_OFFSET(0x847F750)
#define CLASS_1_709C4C5FB0270D6D_METHOD_1_FEDE09C198114DBE_OFFSET UNITYSDK_OFFSET(0x8480220)
#define CLASS_1_709C4C5FB0270D6D__CTOR_OFFSET UNITYSDK_OFFSET(0x847F120)

inline static constexpr unsigned int Class_1_709C4C5FB0270D6D_TypeDefinitionIndex = 44700;

class Class_1_709C4C5FB0270D6D : public ::System::Object
{
public:
	::System::Predicate_1<::RPG::GameCore::TurnBasedModifierInstance*>* Field_1_3; // 0x10
	::RPG::GameCore::AvatarDataComponent* Field_1_0; // 0x18
	::System::Collections::Generic::List_1<::Class_1_709C4C5FB0270D6D_Class_1_317CDD276CB8C912*>* Field_1_2; // 0x20
	...
	::System::Void Method_1_D81224686493F7E5(::RPG::GameCore::GameEntity* a1)
	{
		return ((::System::Void(*)(::PVOID, ::RPG::GameCore::GameEntity*))((::PBYTE)hIl2Cpp + CLASS_1_709C4C5FB0270D6D_METHOD_1_D81224686493F7E5_OFFSET))(this, a1);
	}
