...
#define CLASS_2_A12205C602394C2F_METHOD_2_4D92CAACEA159BBF_OFFSET UNITYSDK_OFFSET(0x111B25C0)
#define CLASS_2_A12205C602394C2F__CTOR_OFFSET UNITYSDK_OFFSET(0x111B2690)
#define CLASS_2_A12205C602394C2F__ONBIND_OFFSET UNITYSDK_OFFSET(0x111B24F0)
#define CLASS_2_A12205C602394C2F___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0x111B26C0)

inline static constexpr unsigned int Class_2_A12205C602394C2F_TypeDefinitionIndex = 58450;
