...
#define CLASS_3_9A11345DD0C2D5DE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11549940)
#define CLASS_3_9A11345DD0C2D5DE_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11549980)
#define CLASS_3_9A11345DD0C2D5DE__CTOR_OFFSET UNITYSDK_OFFSET(0x11549910)
#define CLASS_3_9A11345DD0C2D5DE___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11549A20)
