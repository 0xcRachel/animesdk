...
#define CLASS_1_065C3F7CC6C5F3AA_GET_DISTANCE_OFFSET UNITYSDK_OFFSET(0x898DCE0)
#define CLASS_1_065C3F7CC6C5F3AA_GET_RAYENDPOINT_OFFSET UNITYSDK_OFFSET(0x898DD60)
#define CLASS_1_065C3F7CC6C5F3AA_GET_RAYSTARTPOINT_OFFSET UNITYSDK_OFFSET(0x898DD30)
#define CLASS_1_065C3F7CC6C5F3AA_GET_TARGETDATA_OFFSET UNITYSDK_OFFSET(0x898DCC0)
#define CLASS_1_065C3F7CC6C5F3AA_GET_TARGETWPOS_OFFSET UNITYSDK_OFFSET(0x898DD00)
#define CLASS_1_065C3F7CC6C5F3AA_SET_DISTANCE_OFFSET UNITYSDK_OFFSET(0x898DCF0)
#define CLASS_1_065C3F7CC6C5F3AA_SET_RAYENDPOINT_OFFSET UNITYSDK_OFFSET(0x898DD80)
#define CLASS_1_065C3F7CC6C5F3AA_SET_RAYSTARTPOINT_OFFSET UNITYSDK_OFFSET(0x898DD50)
#define CLASS_1_065C3F7CC6C5F3AA_SET_TARGETDATA_OFFSET UNITYSDK_OFFSET(0x898DCD0)
#define CLASS_1_065C3F7CC6C5F3AA_SET_TARGETWPOS_OFFSET UNITYSDK_OFFSET(0x898DD20)
#define CLASS_1_065C3F7CC6C5F3AA__CTOR_OFFSET UNITYSDK_OFFSET(0x898DD90)

inline static constexpr unsigned int Class_1_065C3F7CC6C5F3AA_TypeDefinitionIndex = 44784;
