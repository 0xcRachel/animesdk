...
#define CLASS_3_907BDEBB9C887BCB_METHOD_3_0D823ABC5D938CCF_OFFSET UNITYSDK_OFFSET(0x118B66E0)
#define CLASS_3_907BDEBB9C887BCB_ONCLEAR_OFFSET UNITYSDK_OFFSET(0x118B6920)
#define CLASS_3_907BDEBB9C887BCB_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x118B67A0)
#define CLASS_3_907BDEBB9C887BCB__CTOR_OFFSET UNITYSDK_OFFSET(0x118B69A0)
#define CLASS_3_907BDEBB9C887BCB__ONEXECUTE_B__1_0_OFFSET UNITYSDK_OFFSET(0x118B69B0)
#define CLASS_3_907BDEBB9C887BCB___IFIXBASEPROXY_ONCLEAR_OFFSET UNITYSDK_OFFSET(0x118B6A20)
#define CLASS_3_907BDEBB9C887BCB___IFIXBASEPROXY_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x118B69C0)

inline static constexpr unsigned int Class_3_907BDEBB9C887BCB_TypeDefinitionIndex = 68735;
