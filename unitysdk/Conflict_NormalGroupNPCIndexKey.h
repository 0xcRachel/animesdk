...
#define CONFLICT_NORMALGROUPNPCINDEXKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0xD0FB0)
#define CONFLICT_NORMALGROUPNPCINDEXKEY_TOSTRING_OFFSET UNITYSDK_OFFSET(0xD1020)
#define CONFLICT_NORMALGROUPNPCINDEXKEY__CTOR_OFFSET UNITYSDK_OFFSET(0xC9EC0)
#define CONFLICT_NORMALGROUPNPCINDEXKEY___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0xD1080)

inline static constexpr unsigned int Conflict_NormalGroupNPCIndexKey_TypeDefinitionIndex = 37105;
