...
#define CLASS_1_8D4C99F920C1E42C_1_METHOD_1_F56A003B1183F033_OFFSET UNITYSDK_OFFSET(0xE11AAA0)
#define CLASS_1_8D4C99F920C1E42C_1_METHOD_1_F63D60543BB82D5F_OFFSET UNITYSDK_OFFSET(0xE11AF50)
#define CLASS_1_8D4C99F920C1E42C_1__CTOR_OFFSET UNITYSDK_OFFSET(0xE11AA90)

inline static constexpr unsigned int Class_1_8D4C99F920C1E42C_1_TypeDefinitionIndex = 71349;
...
public:
	...
	{
		return ((::RPG::Client::LittleGame::ChenLing::CirticalTrackType(*)(::PVOID, ::Class_2_181A7F9409C60DBC*))((::PBYTE)hIl2Cpp + CLASS_1_8D4C99F920C1E42C_1_METHOD_1_F63D60543BB82D5F_OFFSET))(this, a1);
	}
};
