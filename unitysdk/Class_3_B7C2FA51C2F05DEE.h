...
#define CLASS_3_B7C2FA51C2F05DEE_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1667DB90)
#define CLASS_3_B7C2FA51C2F05DEE_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1667DC80)
#define CLASS_3_B7C2FA51C2F05DEE_TICK_OFFSET UNITYSDK_OFFSET(0x1667DCD0)
#define CLASS_3_B7C2FA51C2F05DEE__CTOR_OFFSET UNITYSDK_OFFSET(0x16642F00)
#define CLASS_3_B7C2FA51C2F05DEE___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x1667DD50)
