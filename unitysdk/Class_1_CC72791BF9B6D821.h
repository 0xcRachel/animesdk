...
#define CLASS_1_CC72791BF9B6D821_METHOD_1_06C30D7357B462CB_OFFSET UNITYSDK_OFFSET(0x18784CD0)
#define CLASS_1_CC72791BF9B6D821_METHOD_1_08649C2797B37F9D_OFFSET UNITYSDK_OFFSET(0x187852F0)
#define CLASS_1_CC72791BF9B6D821_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x18785110)
#define CLASS_1_CC72791BF9B6D821_METHOD_1_419F8550AC48C463_OFFSET UNITYSDK_OFFSET(0x18784E80)
#define CLASS_1_CC72791BF9B6D821_METHOD_1_6B72D4EE8C6E907F_OFFSET UNITYSDK_OFFSET(0x18784A20)
#define CLASS_1_CC72791BF9B6D821_METHOD_1_92046C214975638E_OFFSET UNITYSDK_OFFSET(0x18785340)
#define CLASS_1_CC72791BF9B6D821_METHOD_1_AD31DD9682084C83_OFFSET UNITYSDK_OFFSET(0x187851B0)
#define CLASS_1_CC72791BF9B6D821_METHOD_1_BF74F9BB090877C2_OFFSET UNITYSDK_OFFSET(0x187849A0)
#define CLASS_1_CC72791BF9B6D821_METHOD_1_CE34EA208837238D_OFFSET UNITYSDK_OFFSET(0x18784C70)
#define CLASS_1_CC72791BF9B6D821_METHOD_1_F0E307B84478A272_OFFSET UNITYSDK_OFFSET(0x187850D0)
#define CLASS_1_CC72791BF9B6D821_METHOD_1_F2E1599CBB58B20F_OFFSET UNITYSDK_OFFSET(0x18785250)
#define CLASS_1_CC72791BF9B6D821__CCTOR_OFFSET UNITYSDK_OFFSET(0x18785710)
...
public:
	...
	{
		return (::System::Action_1<::Class_1_7A22A3DBEEDD1F80*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_CC72791BF9B6D821_TypeDefinitionIndex)->GetStaticField(0x434D0);
	}
	static ::Il2CppArray<::System::String*>** StaticGet_Field_1_4()
	{
		return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_CC72791BF9B6D821_TypeDefinitionIndex)->GetStaticField(0x434D8);
	}
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::RPG::GameCore::CommonIndexKey, ::RPG::GameCore::RogueMagicScoreRow*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_CC72791BF9B6D821_TypeDefinitionIndex)->GetStaticField(0x434E0);
	}
	static ::System::Boolean* StaticGet_Field_1_1()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_1_CC72791BF9B6D821_TypeDefinitionIndex)->GetStaticField(0xD510);
	}
	static ::System::Byte* StaticGet_Field_1_2()
	{
		return (::System::Byte*)Il2CppClass::FromTypeDefinitionIndex(Class_1_CC72791BF9B6D821_TypeDefinitionIndex)->GetStaticField(0xD511);
	}
