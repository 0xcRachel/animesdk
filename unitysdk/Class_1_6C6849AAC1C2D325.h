...
#define CLASS_1_6C6849AAC1C2D325_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x111AC810)
#define CLASS_1_6C6849AAC1C2D325_METHOD_1_DC7AE487B566916A_OFFSET UNITYSDK_OFFSET(0x111AC5A0)
#define CLASS_1_6C6849AAC1C2D325__CCTOR_OFFSET UNITYSDK_OFFSET(0x111AC930)
#define CLASS_1_6C6849AAC1C2D325__CTOR_OFFSET UNITYSDK_OFFSET(0x111AC8B0)

inline static constexpr unsigned int Class_1_6C6849AAC1C2D325_TypeDefinitionIndex = 60463;
...
public:
	...
	{
		return (::System::Collections::Generic::HashSet_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6C6849AAC1C2D325_TypeDefinitionIndex)->GetStaticField(0x48A80);
	}
