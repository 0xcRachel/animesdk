...
#define CLASS_1_0F4958EF2A5A5CBC_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A282C60)
#define CLASS_1_0F4958EF2A5A5CBC_CLONE_OFFSET UNITYSDK_OFFSET(0x1A2826C0)
#define CLASS_1_0F4958EF2A5A5CBC_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A282A00)
#define CLASS_1_0F4958EF2A5A5CBC_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A2828F0)
#define CLASS_1_0F4958EF2A5A5CBC_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A282AE0)
#define CLASS_1_0F4958EF2A5A5CBC_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A282E60)
#define CLASS_1_0F4958EF2A5A5CBC_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A282CF0)
#define CLASS_1_0F4958EF2A5A5CBC_METHOD_1_24748FC20F375725_1_OFFSET UNITYSDK_OFFSET(0x1A2828D0)
#define CLASS_1_0F4958EF2A5A5CBC_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x1A2828B0)
#define CLASS_1_0F4958EF2A5A5CBC_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A282490)
#define CLASS_1_0F4958EF2A5A5CBC_METHOD_1_8C8625211DA811AE_1_OFFSET UNITYSDK_OFFSET(0x1A2828E0)
#define CLASS_1_0F4958EF2A5A5CBC_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x1A2828C0)
#define CLASS_1_0F4958EF2A5A5CBC_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A2824F0)
#define CLASS_1_0F4958EF2A5A5CBC_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A282B80)
#define CLASS_1_0F4958EF2A5A5CBC_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A282BE0)
#define CLASS_1_0F4958EF2A5A5CBC__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A282F20)
#define CLASS_1_0F4958EF2A5A5CBC__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A282510)
#define CLASS_1_0F4958EF2A5A5CBC__CTOR_OFFSET UNITYSDK_OFFSET(0x1A282500)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_0F4958EF2A5A5CBC*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_0F4958EF2A5A5CBC_TypeDefinitionIndex)->GetStaticField(0x2C970);
	}
	// static const ::System::Int32 Field_1_2 = 0x5; // 0x0
	// static const ::System::Int32 Field_1_4 = 0xA; // 0x0
	::Google::Protobuf::UnknownFieldSet* Field_1_1; // 0x10
	::Class_1_2A186446E06353A9_1* Field_1_5; // 0x18
