...
#define CLASS_1_E657D03F0A0D98AD_GET_BOTTOM_OFFSET UNITYSDK_OFFSET(0x163C0290)
#define CLASS_1_E657D03F0A0D98AD_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x163C0260)
#define CLASS_1_E657D03F0A0D98AD_GET_LEFT_OFFSET UNITYSDK_OFFSET(0x163C0270)
#define CLASS_1_E657D03F0A0D98AD_GET_RIGHT_OFFSET UNITYSDK_OFFSET(0x163C0280)
#define CLASS_1_E657D03F0A0D98AD_GET_TOP_OFFSET UNITYSDK_OFFSET(0x163C02A0)
#define CLASS_1_E657D03F0A0D98AD_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0x163C0250)
#define CLASS_1_E657D03F0A0D98AD__CTOR_OFFSET UNITYSDK_OFFSET(0x163C02B0)
