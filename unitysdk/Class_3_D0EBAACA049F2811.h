...
#define CLASS_3_D0EBAACA049F2811_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1113D160)
#define CLASS_3_D0EBAACA049F2811_METHOD_3_3C56C1AF247AC1EC_OFFSET UNITYSDK_OFFSET(0x1113D540)
#define CLASS_3_D0EBAACA049F2811_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1113D200)
#define CLASS_3_D0EBAACA049F2811_TICK_OFFSET UNITYSDK_OFFSET(0x1113D5D0)
#define CLASS_3_D0EBAACA049F2811__CTOR_OFFSET UNITYSDK_OFFSET(0x1113D050)
#define CLASS_3_D0EBAACA049F2811___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1113D850)
#define CLASS_3_D0EBAACA049F2811___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x1113D8F0)

inline static constexpr unsigned int Class_3_D0EBAACA049F2811_TypeDefinitionIndex = 43198;

class Class_3_D0EBAACA049F2811 : public ::RPG::GameCore::ImmediateTaskBase_1<::RPG::GameCore::ReceiveDynamicSkillButtonInput*>
{
public:
	::Class_3_BCCE950C2E8DF1F0* Field_3_2; // 0x28
