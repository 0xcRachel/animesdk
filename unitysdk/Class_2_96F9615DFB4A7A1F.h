...
#define CLASS_2_96F9615DFB4A7A1F_CLEAR_OFFSET UNITYSDK_OFFSET(0xAC4BA40)
#define CLASS_2_96F9615DFB4A7A1F_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xAC4BAF0)
#define CLASS_2_96F9615DFB4A7A1F_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xAC4BAB0)
#define CLASS_2_96F9615DFB4A7A1F_GET_CHANGEPARAM_OFFSET UNITYSDK_OFFSET(0xAC4BBA0)
#define CLASS_2_96F9615DFB4A7A1F_GET_CHANGEVALUE_OFFSET UNITYSDK_OFFSET(0xAC4BB80)
#define CLASS_2_96F9615DFB4A7A1F_GET_ORIGINMODIFYVALUE_OFFSET UNITYSDK_OFFSET(0xAC4BB60)
#define CLASS_2_96F9615DFB4A7A1F_GET_PROPERTY_OFFSET UNITYSDK_OFFSET(0xAC4BB40)
#define CLASS_2_96F9615DFB4A7A1F_METHOD_2_B482A7FC5DB52470_OFFSET UNITYSDK_OFFSET(0xAC4B9B0)
#define CLASS_2_96F9615DFB4A7A1F_SET_CHANGEPARAM_OFFSET UNITYSDK_OFFSET(0xAC4BBB0)
#define CLASS_2_96F9615DFB4A7A1F_SET_CHANGEVALUE_OFFSET UNITYSDK_OFFSET(0xAC4BB90)
#define CLASS_2_96F9615DFB4A7A1F_SET_ORIGINMODIFYVALUE_OFFSET UNITYSDK_OFFSET(0xAC4BB70)
#define CLASS_2_96F9615DFB4A7A1F_SET_PROPERTY_OFFSET UNITYSDK_OFFSET(0xAC4BB50)
#define CLASS_2_96F9615DFB4A7A1F__CTOR_OFFSET UNITYSDK_OFFSET(0xAC4BBC0)
#define CLASS_2_96F9615DFB4A7A1F___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0xAC4BBD0)
...
public:
	...
	::RPG::GameCore::FixPoint _OriginModifyValue_k__BackingField; // 0x28
