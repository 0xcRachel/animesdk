...
#define CLASS_1_FB4A4ADDA7338C08_3_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A7C2E10)
#define CLASS_1_FB4A4ADDA7338C08_3_CLONE_OFFSET UNITYSDK_OFFSET(0x1A7C2A10)
#define CLASS_1_FB4A4ADDA7338C08_3_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A7C2B40)
#define CLASS_1_FB4A4ADDA7338C08_3_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A7C2A90)
#define CLASS_1_FB4A4ADDA7338C08_3_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A7C2BE0)
#define CLASS_1_FB4A4ADDA7338C08_3_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A7C2F60)
#define CLASS_1_FB4A4ADDA7338C08_3_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A7C2F00)
#define CLASS_1_FB4A4ADDA7338C08_3_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1A7C2A40)
#define CLASS_1_FB4A4ADDA7338C08_3_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1A7C2A80)
#define CLASS_1_FB4A4ADDA7338C08_3_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A7C28F0)
#define CLASS_1_FB4A4ADDA7338C08_3_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1A7C2A50)
#define CLASS_1_FB4A4ADDA7338C08_3_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1A7C2A70)
#define CLASS_1_FB4A4ADDA7338C08_3_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1A7C2A60)
#define CLASS_1_FB4A4ADDA7338C08_3_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A7C2920)
#define CLASS_1_FB4A4ADDA7338C08_3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A7C2CE0)
#define CLASS_1_FB4A4ADDA7338C08_3_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A7C2D40)
#define CLASS_1_FB4A4ADDA7338C08_3__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A7C3030)
#define CLASS_1_FB4A4ADDA7338C08_3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A7C2980)
#define CLASS_1_FB4A4ADDA7338C08_3__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7C2930)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_FB4A4ADDA7338C08_3*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_FB4A4ADDA7338C08_3_TypeDefinitionIndex)->GetStaticField(0x615B0);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_FB4A4ADDA7338C08_3_TypeDefinitionIndex)->GetStaticField(0x615B8);
	}
