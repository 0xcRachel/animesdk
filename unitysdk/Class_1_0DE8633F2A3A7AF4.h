...
#define CLASS_1_0DE8633F2A3A7AF4_GET_ABILITYCASTSYSTEM_OFFSET UNITYSDK_OFFSET(0xFCD8F90)
#define CLASS_1_0DE8633F2A3A7AF4_GET_ATTACKSYSTEM_OFFSET UNITYSDK_OFFSET(0xFCD8FA0)
#define CLASS_1_0DE8633F2A3A7AF4_GET_ATTRIBUTESERVICE_OFFSET UNITYSDK_OFFSET(0xFCD9000)
#define CLASS_1_0DE8633F2A3A7AF4_GET_DEATHSYSTEM_OFFSET UNITYSDK_OFFSET(0xFCD8FB0)
#define CLASS_1_0DE8633F2A3A7AF4_GET_DEFAULTLOGGER_OFFSET UNITYSDK_OFFSET(0xFCD9020)
#define CLASS_1_0DE8633F2A3A7AF4_GET_ENTITYFACTORYSERVICE_OFFSET UNITYSDK_OFFSET(0xFCD9010)
#define CLASS_1_0DE8633F2A3A7AF4_GET_ERRORSET_OFFSET UNITYSDK_OFFSET(0xFCD8F80)
#define CLASS_1_0DE8633F2A3A7AF4_GET_FRAME_OFFSET UNITYSDK_OFFSET(0xFCD8F60)
#define CLASS_1_0DE8633F2A3A7AF4_GET_GAMESTATESYSTEM_OFFSET UNITYSDK_OFFSET(0xFCD8FC0)
#define CLASS_1_0DE8633F2A3A7AF4_GET_ISSHOWFRAME_OFFSET UNITYSDK_OFFSET(0xFCD8F40)
#define CLASS_1_0DE8633F2A3A7AF4_GET_LOGLEVEL_OFFSET UNITYSDK_OFFSET(0xFCD8F30)
#define CLASS_1_0DE8633F2A3A7AF4_GET_SUMMONSYSTEM_OFFSET UNITYSDK_OFFSET(0xFCD8FD0)
#define CLASS_1_0DE8633F2A3A7AF4_GET_TEAMBUFFAPPLYSYSTEM_OFFSET UNITYSDK_OFFSET(0xFCD8FE0)
#define CLASS_1_0DE8633F2A3A7AF4_GET_TURNBASEDSYSTEM_OFFSET UNITYSDK_OFFSET(0xFCD8FF0)
#define CLASS_1_0DE8633F2A3A7AF4_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xFCD9490)
#define CLASS_1_0DE8633F2A3A7AF4_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xFCD9500)
#define CLASS_1_0DE8633F2A3A7AF4_METHOD_1_F7F80C1DB6B12DA7_OFFSET UNITYSDK_OFFSET(0xFCD9540)
#define CLASS_1_0DE8633F2A3A7AF4_SET_DEFAULTLOGGER_OFFSET UNITYSDK_OFFSET(0xFCD9060)
#define CLASS_1_0DE8633F2A3A7AF4_SET_FRAME_OFFSET UNITYSDK_OFFSET(0xFCD8F70)
#define CLASS_1_0DE8633F2A3A7AF4_SET_ISSHOWFRAME_OFFSET UNITYSDK_OFFSET(0xFCD8F50)
#define CLASS_1_0DE8633F2A3A7AF4__CTOR_OFFSET UNITYSDK_OFFSET(0xFCD90A0)

inline static constexpr unsigned int Class_1_0DE8633F2A3A7AF4_TypeDefinitionIndex = 71000;
...
public:
	...
	{
		return (::Class_2_D108BD1CFC10E5CA**)Il2CppClass::FromTypeDefinitionIndex(Class_1_0DE8633F2A3A7AF4_TypeDefinitionIndex)->GetStaticField(0x6C90);
	}
	::Class_3_74E033A84A8D01A9* _AbilityCastSystem_k__BackingField; // 0x10
	::System::Collections::Generic::HashSet_1<::System::String*>* _ErrorSet_k__BackingField; // 0x18
	::Class_3_89AD00E04815C359* _DeathSystem_k__BackingField; // 0x20
	::Class_3_D68DCCEFF8E7F0AA* _AttributeService_k__BackingField; // 0x28
	::Class_3_BDC277BDD9B61076* _AttackSystem_k__BackingField; // 0x30
	::Class_3_76CFD1EB9822836A* _GameStateSystem_k__BackingField; // 0x38
	::Class_3_DCB7F8B839F0C44B_3* _TeamBuffApplySystem_k__BackingField; // 0x40
	::Class_3_0F68A20F9F5DDBFF* _TurnBasedSystem_k__BackingField; // 0x48
	::Class_3_8AFABE97DEF4F04F* _EntityFactoryService_k__BackingField; // 0x50
