...
#define CLASS_1_E10F4B3B7AE0AC94_METHOD_1_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x1717EC60)
#define CLASS_1_E10F4B3B7AE0AC94_METHOD_1_76500CA2EC4CA996_OFFSET UNITYSDK_OFFSET(0x1717ECB0)
#define CLASS_1_E10F4B3B7AE0AC94_METHOD_1_F8C7231308CD2C82_OFFSET UNITYSDK_OFFSET(0x1717EBC0)

inline static constexpr unsigned int Class_1_E10F4B3B7AE0AC94_TypeDefinitionIndex = 68448;
...
public:
	...
	{
		return (::RPG::GameCore::CharacterFaceExpressionMappingConfig**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E10F4B3B7AE0AC94_TypeDefinitionIndex)->GetStaticField(0x5AA80);
	}
