...
#define ROOTMOTION_WARNING_LOG_1_OFFSET UNITYSDK_OFFSET(0x17A64B90)
#define ROOTMOTION_WARNING_LOG_OFFSET UNITYSDK_OFFSET(0x17A886D0)
...
namespace RootMotion
{
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Warning_TypeDefinitionIndex)->GetStaticField(0x80C0);
		}
