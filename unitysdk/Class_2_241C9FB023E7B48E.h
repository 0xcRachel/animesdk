...
#define CLASS_2_241C9FB023E7B48E_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD1FA070)
#define CLASS_2_241C9FB023E7B48E_METHOD_2_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xD1F9BD0)
#define CLASS_2_241C9FB023E7B48E_METHOD_2_C54EFB67E9C50C27_OFFSET UNITYSDK_OFFSET(0xD1F9DB0)
#define CLASS_2_241C9FB023E7B48E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xD1F9AF0)
#define CLASS_2_241C9FB023E7B48E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xD1F9FF0)
#define CLASS_2_241C9FB023E7B48E_TICK_OFFSET UNITYSDK_OFFSET(0xD1FA0F0)
#define CLASS_2_241C9FB023E7B48E__CTOR_OFFSET UNITYSDK_OFFSET(0xD1F9AE0)

inline static constexpr unsigned int Class_2_241C9FB023E7B48E_TypeDefinitionIndex = 45895;

class Class_2_241C9FB023E7B48E : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::MonopolyShowSwitchSpeTransition* Field_2_1; // 0x18
	::RPG::GameCore::TaskContext* Field_2_0; // 0x20
	::Class_2_9850514C0F89B91A* Field_2_2; // 0x28
