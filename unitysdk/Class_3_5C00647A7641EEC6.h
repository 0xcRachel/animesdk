...
#define CLASS_3_5C00647A7641EEC6_GET_ISSUEDATA_OFFSET UNITYSDK_OFFSET(0xFF1DB80)
#define CLASS_3_5C00647A7641EEC6_GET_ISSUEID_OFFSET UNITYSDK_OFFSET(0xFF1DB20)
#define CLASS_3_5C00647A7641EEC6_GET_ONBTNCLOSE_OFFSET UNITYSDK_OFFSET(0xFF1DB40)
#define CLASS_3_5C00647A7641EEC6_GET_ONBTNFORM_OFFSET UNITYSDK_OFFSET(0xFF1DB60)
#define CLASS_3_5C00647A7641EEC6_SET_ISSUEDATA_OFFSET UNITYSDK_OFFSET(0xFF1DB90)
#define CLASS_3_5C00647A7641EEC6_SET_ISSUEID_OFFSET UNITYSDK_OFFSET(0xFF1DB30)
#define CLASS_3_5C00647A7641EEC6_SET_ONBTNCLOSE_OFFSET UNITYSDK_OFFSET(0xFF1DB50)
#define CLASS_3_5C00647A7641EEC6_SET_ONBTNFORM_OFFSET UNITYSDK_OFFSET(0xFF1DB70)
#define CLASS_3_5C00647A7641EEC6__CTOR_OFFSET UNITYSDK_OFFSET(0xFF1D9B0)
#define CLASS_3_5C00647A7641EEC6___CTOR_B__0_0_OFFSET UNITYSDK_OFFSET(0xFF1DBA0)
#define CLASS_3_5C00647A7641EEC6___CTOR_B__0_1_OFFSET UNITYSDK_OFFSET(0xFF1DBF0)

inline static constexpr unsigned int Class_3_5C00647A7641EEC6_TypeDefinitionIndex = 68398;

class Class_3_5C00647A7641EEC6 : public ::Class_2_E77EE8BE0A609DD9
{
public:
	::Class_1_ADBE1843AD1E672A* _OnBtnClose_k__BackingField; // 0x20
	::Class_1_029A7EDCBF9933C8* Field_3_1; // 0x28
	::Class_1_ADBE1843AD1E672A* _OnBtnForm_k__BackingField; // 0x30
	::RPG::Client::MVVM::Service::LimaoNewsWindowService* Field_3_5; // 0x38
	::RPG::Client::MVVM::Model::LimaoNewsIssueData* _IssueData_k__BackingField; // 0x40
