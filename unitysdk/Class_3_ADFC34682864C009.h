...
#define CLASS_3_ADFC34682864C009_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10F33720)
#define CLASS_3_ADFC34682864C009__CTOR_OFFSET UNITYSDK_OFFSET(0x10F336F0)

inline static constexpr unsigned int Class_3_ADFC34682864C009_TypeDefinitionIndex = 42907;
