...
#define CLASS_2_A891B1E56B424A23_METHOD_2_064B58FA19436120_1_OFFSET UNITYSDK_OFFSET(0xB8D7B30)
#define CLASS_2_A891B1E56B424A23_METHOD_2_064B58FA19436120_OFFSET UNITYSDK_OFFSET(0xB8D7AC0)
#define CLASS_2_A891B1E56B424A23_METHOD_2_1A5AAB71C5435945_OFFSET UNITYSDK_OFFSET(0xB8D7C50)
#define CLASS_2_A891B1E56B424A23_METHOD_2_30B62F5CDB9079BD_OFFSET UNITYSDK_OFFSET(0xB8D7A20)
#define CLASS_2_A891B1E56B424A23_METHOD_2_775B6D644F07B554_OFFSET UNITYSDK_OFFSET(0xB8D7D30)
#define CLASS_2_A891B1E56B424A23_METHOD_2_AA94D17017C8E64E_OFFSET UNITYSDK_OFFSET(0xB8D78F0)
#define CLASS_2_A891B1E56B424A23_METHOD_2_AF769CD15806BD66_OFFSET UNITYSDK_OFFSET(0xB8D7BA0)
#define CLASS_2_A891B1E56B424A23_METHOD_2_BEBC8F4773DC82AA_OFFSET UNITYSDK_OFFSET(0xB8D7460)
#define CLASS_2_A891B1E56B424A23_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB8D8030)
#define CLASS_2_A891B1E56B424A23__ADDHANDLERS_OFFSET UNITYSDK_OFFSET(0xB8D7890)
#define CLASS_2_A891B1E56B424A23__CTOR_OFFSET UNITYSDK_OFFSET(0xB8D7040)
#define CLASS_2_A891B1E56B424A23__CUSTOMBINDVIEW_OFFSET UNITYSDK_OFFSET(0xB8D7140)
#define CLASS_2_A891B1E56B424A23__SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xB8D7520)
#define CLASS_2_A891B1E56B424A23__UNBINDVIEW_OFFSET UNITYSDK_OFFSET(0xB8D74E0)
#define CLASS_2_A891B1E56B424A23___IFIXBASEPROXY__ADDHANDLERS_OFFSET UNITYSDK_OFFSET(0xB8D8420)
#define CLASS_2_A891B1E56B424A23___IFIXBASEPROXY__CUSTOMBINDVIEW_OFFSET UNITYSDK_OFFSET(0xB8D8300)
#define CLASS_2_A891B1E56B424A23___IFIXBASEPROXY__SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xB8D83C0)
#define CLASS_2_A891B1E56B424A23___IFIXBASEPROXY__UNBINDVIEW_OFFSET UNITYSDK_OFFSET(0xB8D8360)
#define CLASS_2_A891B1E56B424A23___SETUPVIEW_B__3_0_OFFSET UNITYSDK_OFFSET(0xB8D8080)
#define CLASS_2_A891B1E56B424A23___SETUPVIEW_B__3_1_OFFSET UNITYSDK_OFFSET(0xB8D81F0)

inline static constexpr unsigned int Class_2_A891B1E56B424A23_TypeDefinitionIndex = 59783;

class Class_2_A891B1E56B424A23 : public ::RPG::Client::UIController
{
public:
	// static const ::System::Int64 Field_2_7 = 0x40000000; // 0x0
	::System::Collections::Generic::HashSet_1<::System::UInt32>* Field_2_6; // 0x180
	::System::Action_1<::System::Boolean>* Field_2_0; // 0x188
	::System::Int64 Field_2_4; // 0x190
	::System::Int64 Field_2_5; // 0x198
	::System::Boolean Field_2_1; // 0x1A0
	::System::Boolean Field_2_3; // 0x1A1
	::System::Boolean Field_2_2; // 0x1A2
