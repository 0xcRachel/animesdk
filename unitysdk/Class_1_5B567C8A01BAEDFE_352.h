...
#define CLASS_1_5B567C8A01BAEDFE_352_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1B05C790)
#define CLASS_1_5B567C8A01BAEDFE_352_CLONE_OFFSET UNITYSDK_OFFSET(0x1B05C600)
#define CLASS_1_5B567C8A01BAEDFE_352_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1B05C6A0)
#define CLASS_1_5B567C8A01BAEDFE_352_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B05C640)
#define CLASS_1_5B567C8A01BAEDFE_352_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B05C6F0)
#define CLASS_1_5B567C8A01BAEDFE_352_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1B05C7E0)
#define CLASS_1_5B567C8A01BAEDFE_352_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1B05C7B0)
#define CLASS_1_5B567C8A01BAEDFE_352_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1B05C580)
#define CLASS_1_5B567C8A01BAEDFE_352_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1B05C5B0)
#define CLASS_1_5B567C8A01BAEDFE_352_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B05C720)
#define CLASS_1_5B567C8A01BAEDFE_352_WRITETO_OFFSET UNITYSDK_OFFSET(0x1B05C780)
#define CLASS_1_5B567C8A01BAEDFE_352__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B05C830)
#define CLASS_1_5B567C8A01BAEDFE_352__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B05C5D0)
#define CLASS_1_5B567C8A01BAEDFE_352__CTOR_OFFSET UNITYSDK_OFFSET(0x1B05C5C0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_352*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_352_TypeDefinitionIndex)->GetStaticField(0x620B0);
	}
