...
#define CLASS_2_3698CD7A7AFEFDC4_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA6E73F0)
#define CLASS_2_3698CD7A7AFEFDC4_METHOD_2_53993E7C2839A69A_OFFSET UNITYSDK_OFFSET(0xA6E7430)
#define CLASS_2_3698CD7A7AFEFDC4_METHOD_2_7E3A7035A8240838_OFFSET UNITYSDK_OFFSET(0xA6E7570)
#define CLASS_2_3698CD7A7AFEFDC4_TICK_OFFSET UNITYSDK_OFFSET(0xA6E76A0)
#define CLASS_2_3698CD7A7AFEFDC4__CTOR_OFFSET UNITYSDK_OFFSET(0xA6E7850)
#define CLASS_2_3698CD7A7AFEFDC4___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0xA6E7860)

inline static constexpr unsigned int Class_2_3698CD7A7AFEFDC4_TypeDefinitionIndex = 45216;

class Class_2_3698CD7A7AFEFDC4 : public ::RPG::GameCore::GameComponentBase
{
public:
	::Class_0_16E4307DCC419505_422* Field_2_0; // 0x18
