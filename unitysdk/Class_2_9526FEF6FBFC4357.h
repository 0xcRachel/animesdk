...
#define CLASS_2_9526FEF6FBFC4357_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1428C6E0)
#define CLASS_2_9526FEF6FBFC4357_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1428C720)
#define CLASS_2_9526FEF6FBFC4357_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1428C8B0)
#define CLASS_2_9526FEF6FBFC4357_TICK_OFFSET UNITYSDK_OFFSET(0x1428C900)
#define CLASS_2_9526FEF6FBFC4357__CTOR_OFFSET UNITYSDK_OFFSET(0x1428C6D0)
