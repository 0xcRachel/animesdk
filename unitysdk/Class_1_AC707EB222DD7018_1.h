...
#define CLASS_1_AC707EB222DD7018_1_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17C4CFC0)
#define CLASS_1_AC707EB222DD7018_1_CLONE_OFFSET UNITYSDK_OFFSET(0x17C4CA40)
#define CLASS_1_AC707EB222DD7018_1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17C4CAD0)
#define CLASS_1_AC707EB222DD7018_1_EQUALS_OFFSET UNITYSDK_OFFSET(0x17C4CAA0)
#define CLASS_1_AC707EB222DD7018_1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17C4CBE0)
#define CLASS_1_AC707EB222DD7018_1_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x17C4D220)
#define CLASS_1_AC707EB222DD7018_1_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x17C4D0D0)
#define CLASS_1_AC707EB222DD7018_1_METHOD_1_6E1EC2DF63D7020F_1_OFFSET UNITYSDK_OFFSET(0x17C4CA80)
#define CLASS_1_AC707EB222DD7018_1_METHOD_1_6E1EC2DF63D7020F_2_OFFSET UNITYSDK_OFFSET(0x17C4CA90)
#define CLASS_1_AC707EB222DD7018_1_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x17C4CA70)
#define CLASS_1_AC707EB222DD7018_1_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17C4C8D0)
#define CLASS_1_AC707EB222DD7018_1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17C4CE40)
#define CLASS_1_AC707EB222DD7018_1_WRITETO_OFFSET UNITYSDK_OFFSET(0x17C4CEA0)
#define CLASS_1_AC707EB222DD7018_1__CCTOR_OFFSET UNITYSDK_OFFSET(0x17C4D3B0)
#define CLASS_1_AC707EB222DD7018_1__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17C4C980)
#define CLASS_1_AC707EB222DD7018_1__CTOR_OFFSET UNITYSDK_OFFSET(0x17C4C8E0)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_FA4F4A67B1C04320_599*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_AC707EB222DD7018_1_TypeDefinitionIndex)->GetStaticField(0x39420);
	}
	static ::Google::Protobuf::FieldCodec_1<::Class_1_FA4F4A67B1C04320_598*>** StaticGet_Field_1_8()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_FA4F4A67B1C04320_598*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_AC707EB222DD7018_1_TypeDefinitionIndex)->GetStaticField(0x39428);
	}
	static ::Google::Protobuf::FieldCodec_1<::Class_1_FA4F4A67B1C04320_600*>** StaticGet_Field_1_2()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_FA4F4A67B1C04320_600*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_AC707EB222DD7018_1_TypeDefinitionIndex)->GetStaticField(0x39430);
	}
	// static const ::System::Int32 Field_1_1 = 0x1; // 0x0
	// static const ::System::Int32 Field_1_4 = 0xF; // 0x0
	// static const ::System::Int32 Field_1_7 = 0xA; // 0x0
	::Google::Protobuf::UnknownFieldSet* Field_1_0; // 0x10
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_FA4F4A67B1C04320_598*>* Field_1_9; // 0x18
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_FA4F4A67B1C04320_599*>* Field_1_6; // 0x20
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_FA4F4A67B1C04320_600*>* Field_1_3; // 0x28
