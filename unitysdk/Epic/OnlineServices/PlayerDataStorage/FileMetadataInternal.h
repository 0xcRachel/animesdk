...
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x5DAA0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x5D7B0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_GET_FILESIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1DA90)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_GET_LASTMODIFIEDTIME_OFFSET UNITYSDK_OFFSET(0x5D910)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_GET_MD5HASH_OFFSET UNITYSDK_OFFSET(0x5D650)
...
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x5DA30)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_SET_FILENAME_OFFSET UNITYSDK_OFFSET(0x5D860)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_SET_FILESIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1D50)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_SET_LASTMODIFIEDTIME_OFFSET UNITYSDK_OFFSET(0x5D990)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_SET_MD5HASH_OFFSET UNITYSDK_OFFSET(0x5D700)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x5DA20)
