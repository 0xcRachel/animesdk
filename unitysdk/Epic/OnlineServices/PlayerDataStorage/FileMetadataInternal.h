...
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2354ED0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x2354BE0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_GET_FILESIZEBYTES_OFFSET UNITYSDK_OFFSET(0x608600)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_GET_LASTMODIFIEDTIME_OFFSET UNITYSDK_OFFSET(0x2354D40)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_GET_MD5HASH_OFFSET UNITYSDK_OFFSET(0x2354A80)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_GET_UNENCRYPTEDDATASIZEBYTES_OFFSET UNITYSDK_OFFSET(0x608A70)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x2354E60)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_SET_FILENAME_OFFSET UNITYSDK_OFFSET(0x2354C90)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_SET_FILESIZEBYTES_OFFSET UNITYSDK_OFFSET(0x878E70)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_SET_LASTMODIFIEDTIME_OFFSET UNITYSDK_OFFSET(0x2354DC0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_SET_MD5HASH_OFFSET UNITYSDK_OFFSET(0x2354B30)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x2354E50)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_SET_UNENCRYPTEDDATASIZEBYTES_OFFSET UNITYSDK_OFFSET(0x22E51C0)
