...
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x5D920)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x5D630)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_GET_FILESIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1DAE0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_GET_LASTMODIFIEDTIME_OFFSET UNITYSDK_OFFSET(0x5D790)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_GET_MD5HASH_OFFSET UNITYSDK_OFFSET(0x5D4D0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_GET_UNENCRYPTEDDATASIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1CD10)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x5D8B0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_SET_FILENAME_OFFSET UNITYSDK_OFFSET(0x5D6E0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_SET_FILESIZEBYTES_OFFSET UNITYSDK_OFFSET(0x1D50)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_SET_LASTMODIFIEDTIME_OFFSET UNITYSDK_OFFSET(0x5D810)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_SET_MD5HASH_OFFSET UNITYSDK_OFFSET(0x5D580)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_FILEMETADATAINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x5D8A0)
...
{
	inline static constexpr unsigned int FileMetadataInternal_TypeDefinitionIndex = 34884;
