...
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ADDNOTIFYCLIENTAUTHSTATUSCHANGEDOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0xDA90)
...
{
	inline static constexpr unsigned int AddNotifyClientAuthStatusChangedOptionsInternal_TypeDefinitionIndex = 35668;
