...
#define EPIC_ONLINESERVICES_UI_REPORTKEYEVENTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x22EB9E0)
#define EPIC_ONLINESERVICES_UI_REPORTKEYEVENTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x22EB970)
#define EPIC_ONLINESERVICES_UI_REPORTKEYEVENTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x22EB830)
#define EPIC_ONLINESERVICES_UI_REPORTKEYEVENTOPTIONSINTERNAL_SET_PLATFORMSPECIFICINPUTDATA_OFFSET UNITYSDK_OFFSET(0x6163C0)
