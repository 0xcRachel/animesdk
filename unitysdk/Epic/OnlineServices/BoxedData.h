...
#define EPIC_ONLINESERVICES_BOXEDDATA_GET_DATA_OFFSET UNITYSDK_OFFSET(0x82D3530)
#define EPIC_ONLINESERVICES_BOXEDDATA_SET_DATA_OFFSET UNITYSDK_OFFSET(0x82D3540)
#define EPIC_ONLINESERVICES_BOXEDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x82D3550)

namespace Epic::OnlineServices
{
	inline static constexpr unsigned int BoxedData_TypeDefinitionIndex = 34299;
