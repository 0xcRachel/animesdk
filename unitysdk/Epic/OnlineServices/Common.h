...
#define EPIC_ONLINESERVICES_COMMON_ISOPERATIONCOMPLETE_OFFSET UNITYSDK_OFFSET(0x82D3770)
#define EPIC_ONLINESERVICES_COMMON_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x82D39B0)
#define EPIC_ONLINESERVICES_COMMON_TOSTRING_2_OFFSET UNITYSDK_OFFSET(0x82D3CB0)
#define EPIC_ONLINESERVICES_COMMON_TOSTRING_OFFSET UNITYSDK_OFFSET(0x82D3880)

namespace Epic::OnlineServices
{
	inline static constexpr unsigned int Common_TypeDefinitionIndex = 34319;
