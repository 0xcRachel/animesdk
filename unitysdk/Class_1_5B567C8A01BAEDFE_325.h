...
#define CLASS_1_5B567C8A01BAEDFE_325_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A901650)
#define CLASS_1_5B567C8A01BAEDFE_325_CLONE_OFFSET UNITYSDK_OFFSET(0x1A9014C0)
#define CLASS_1_5B567C8A01BAEDFE_325_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A901560)
#define CLASS_1_5B567C8A01BAEDFE_325_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A901500)
#define CLASS_1_5B567C8A01BAEDFE_325_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A9015B0)
#define CLASS_1_5B567C8A01BAEDFE_325_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A9016A0)
#define CLASS_1_5B567C8A01BAEDFE_325_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A901670)
#define CLASS_1_5B567C8A01BAEDFE_325_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A901440)
#define CLASS_1_5B567C8A01BAEDFE_325_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A901470)
#define CLASS_1_5B567C8A01BAEDFE_325_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A9015E0)
#define CLASS_1_5B567C8A01BAEDFE_325_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A901640)
#define CLASS_1_5B567C8A01BAEDFE_325__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A9016F0)
#define CLASS_1_5B567C8A01BAEDFE_325__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A901490)
#define CLASS_1_5B567C8A01BAEDFE_325__CTOR_OFFSET UNITYSDK_OFFSET(0x1A901480)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_325*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_325_TypeDefinitionIndex)->GetStaticField(0x474D0);
	}
