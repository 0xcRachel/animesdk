...
#define CLASS_1_867B6CE75953535A_CLEAR_OFFSET UNITYSDK_OFFSET(0x161A08D0)
#define CLASS_1_867B6CE75953535A_GET_ALLCONTEXTS_OFFSET UNITYSDK_OFFSET(0x161A1440)
#define CLASS_1_867B6CE75953535A_GET_CAKERACEGAME_OFFSET UNITYSDK_OFFSET(0x161A11C0)
#define CLASS_1_867B6CE75953535A_GET_CHIMERADUELGAME_OFFSET UNITYSDK_OFFSET(0x161A11E0)
#define CLASS_1_867B6CE75953535A_GET_CHIMERAGAME_OFFSET UNITYSDK_OFFSET(0x161A1200)
#define CLASS_1_867B6CE75953535A_GET_ELFRESTAURANTGAME_OFFSET UNITYSDK_OFFSET(0x161A1220)
#define CLASS_1_867B6CE75953535A_GET_FIVEDIMGAME_OFFSET UNITYSDK_OFFSET(0x161A1240)
#define CLASS_1_867B6CE75953535A_GET_FOURROTATEVOXELGAME_OFFSET UNITYSDK_OFFSET(0x161A1260)
#define CLASS_1_867B6CE75953535A_GET_LITTLEGAMEINPUT_OFFSET UNITYSDK_OFFSET(0x161A12A0)
#define CLASS_1_867B6CE75953535A_GET_LITTLEGAME_OFFSET UNITYSDK_OFFSET(0x161A1280)
#define CLASS_1_867B6CE75953535A_GET_MARBLEGAME_OFFSET UNITYSDK_OFFSET(0x161A12C0)
#define CLASS_1_867B6CE75953535A_GET_MATCH3GAME_OFFSET UNITYSDK_OFFSET(0x161A12E0)
#define CLASS_1_867B6CE75953535A_GET_MOVIEGAMECONFIG_OFFSET UNITYSDK_OFFSET(0x161A1300)
#define CLASS_1_867B6CE75953535A_GET_MOVIEGAMESTATE_OFFSET UNITYSDK_OFFSET(0x161A1320)
#define CLASS_1_867B6CE75953535A_GET_PARKOURGAME_OFFSET UNITYSDK_OFFSET(0x161A1340)
#define CLASS_1_867B6CE75953535A_GET_PINGPONGGAME_OFFSET UNITYSDK_OFFSET(0x161A1360)
#define CLASS_1_867B6CE75953535A_GET_TIMELINECONTROLGAMECONFIG_OFFSET UNITYSDK_OFFSET(0x161A1380)
#define CLASS_1_867B6CE75953535A_GET_TIMELINECONTROLGAMESTATE_OFFSET UNITYSDK_OFFSET(0x161A13A0)
#define CLASS_1_867B6CE75953535A_GET_TIMERELAYFLAMEGAME_OFFSET UNITYSDK_OFFSET(0x161A13C0)
#define CLASS_1_867B6CE75953535A_GET_UI3DGAMECONFIG_OFFSET UNITYSDK_OFFSET(0x161A13E0)
#define CLASS_1_867B6CE75953535A_GET_UI3DGAMEINPUT_OFFSET UNITYSDK_OFFSET(0x161A1400)
#define CLASS_1_867B6CE75953535A_GET_UI3DGAMESTATE_OFFSET UNITYSDK_OFFSET(0x161A1420)
#define CLASS_1_867B6CE75953535A_METHOD_1_0C7CBCE710B3F112_OFFSET UNITYSDK_OFFSET(0x161A1180)
#define CLASS_1_867B6CE75953535A_METHOD_1_3B7145E79424FB75_OFFSET UNITYSDK_OFFSET(0x161A0920)
#define CLASS_1_867B6CE75953535A_METHOD_1_47FCE72550F759BF_OFFSET UNITYSDK_OFFSET(0x161A0A90)
#define CLASS_1_867B6CE75953535A_METHOD_1_ACE888BF6F5BC5FD_OFFSET UNITYSDK_OFFSET(0x161A22A0)
#define CLASS_1_867B6CE75953535A_SET_CAKERACEGAME_OFFSET UNITYSDK_OFFSET(0x161A11D0)
#define CLASS_1_867B6CE75953535A_SET_CHIMERADUELGAME_OFFSET UNITYSDK_OFFSET(0x161A11F0)
#define CLASS_1_867B6CE75953535A_SET_CHIMERAGAME_OFFSET UNITYSDK_OFFSET(0x161A1210)
#define CLASS_1_867B6CE75953535A_SET_ELFRESTAURANTGAME_OFFSET UNITYSDK_OFFSET(0x161A1230)
#define CLASS_1_867B6CE75953535A_SET_FIVEDIMGAME_OFFSET UNITYSDK_OFFSET(0x161A1250)
#define CLASS_1_867B6CE75953535A_SET_FOURROTATEVOXELGAME_OFFSET UNITYSDK_OFFSET(0x161A1270)
#define CLASS_1_867B6CE75953535A_SET_LITTLEGAMEINPUT_OFFSET UNITYSDK_OFFSET(0x161A12B0)
#define CLASS_1_867B6CE75953535A_SET_LITTLEGAME_OFFSET UNITYSDK_OFFSET(0x161A1290)
#define CLASS_1_867B6CE75953535A_SET_MARBLEGAME_OFFSET UNITYSDK_OFFSET(0x161A12D0)
#define CLASS_1_867B6CE75953535A_SET_MATCH3GAME_OFFSET UNITYSDK_OFFSET(0x161A12F0)
#define CLASS_1_867B6CE75953535A_SET_MOVIEGAMECONFIG_OFFSET UNITYSDK_OFFSET(0x161A1310)
#define CLASS_1_867B6CE75953535A_SET_MOVIEGAMESTATE_OFFSET UNITYSDK_OFFSET(0x161A1330)
#define CLASS_1_867B6CE75953535A_SET_PARKOURGAME_OFFSET UNITYSDK_OFFSET(0x161A1350)
#define CLASS_1_867B6CE75953535A_SET_PINGPONGGAME_OFFSET UNITYSDK_OFFSET(0x161A1370)
#define CLASS_1_867B6CE75953535A_SET_TIMELINECONTROLGAMECONFIG_OFFSET UNITYSDK_OFFSET(0x161A1390)
#define CLASS_1_867B6CE75953535A_SET_TIMELINECONTROLGAMESTATE_OFFSET UNITYSDK_OFFSET(0x161A13B0)
#define CLASS_1_867B6CE75953535A_SET_TIMERELAYFLAMEGAME_OFFSET UNITYSDK_OFFSET(0x161A13D0)
#define CLASS_1_867B6CE75953535A_SET_UI3DGAMECONFIG_OFFSET UNITYSDK_OFFSET(0x161A13F0)
#define CLASS_1_867B6CE75953535A_SET_UI3DGAMEINPUT_OFFSET UNITYSDK_OFFSET(0x161A1410)
#define CLASS_1_867B6CE75953535A_SET_UI3DGAMESTATE_OFFSET UNITYSDK_OFFSET(0x161A1430)
#define CLASS_1_867B6CE75953535A__CTOR_OFFSET UNITYSDK_OFFSET(0x161A0B30)

inline static constexpr unsigned int Class_1_867B6CE75953535A_TypeDefinitionIndex = 31445;
...
public:
	...
	{
		return (::Class_1_867B6CE75953535A**)Il2CppClass::FromTypeDefinitionIndex(Class_1_867B6CE75953535A_TypeDefinitionIndex)->GetStaticField(0x9140);
	}
	...
	::Class_2_8CE5A0FC3E91D7F4* _chimeraGame_k__BackingField; // 0x10
	::Class_2_49510E41341F97EC* _uI3DGameConfig_k__BackingField; // 0x18
	::Class_2_F47F7A3F5E97970D* _fiveDimGame_k__BackingField; // 0x20
	::Class_2_C8461ACA8308A704_1* _uI3DGameInput_k__BackingField; // 0x28
	::Class_2_CC109BC117037E72* _timeRelayFlameGame_k__BackingField; // 0x30
	::Class_2_D5BF6D0911868A14* _movieGameConfig_k__BackingField; // 0x38
	::Class_2_884D02965B14FC41* _movieGameState_k__BackingField; // 0x40
	::Class_2_099B78418029B3B1_2* _parkourGame_k__BackingField; // 0x48
	::Class_2_C8461ACA8308A704* _littleGame_k__BackingField; // 0x50
	::Class_2_ED5ACF982FC3BE02* _timelineControlGameConfig_k__BackingField; // 0x58
	::Class_2_D1523E43223DED38* _timelineControlGameState_k__BackingField; // 0x60
	::Class_2_BE574E60E64D3550* _littleGameInput_k__BackingField; // 0x68
	::Class_2_0D3C4922E3883E2B* _marbleGame_k__BackingField; // 0x70
	::Class_2_1152250B69783505* _pingPongGame_k__BackingField; // 0x78
	::Class_2_D31C9C0BB2725F41* _uI3DGameState_k__BackingField; // 0x80
	::Class_2_6AA7CA7493367EF4* _chimeraDuelGame_k__BackingField; // 0x88
	::Class_2_43D1AA62A6D00FFF* _elfRestaurantGame_k__BackingField; // 0x90
	::Class_2_AF4E89503EBBCCA0* _fourRotateVoxelGame_k__BackingField; // 0x98
	::Class_2_43A5ACD54102DE89* _match3Game_k__BackingField; // 0xA0
	::Class_2_C8461ACA8308A704_2* _cakeRaceGame_k__BackingField; // 0xA8
	...
	{
		return ((::Class_2_C8461ACA8308A704_2*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_867B6CE75953535A_GET_CAKERACEGAME_OFFSET))(this);
	}

	::System::Void set_cakeRaceGame(::Class_2_C8461ACA8308A704_2* value)
	{
		return ((::System::Void(*)(::PVOID, ::Class_2_C8461ACA8308A704_2*))((::PBYTE)hIl2Cpp + CLASS_1_867B6CE75953535A_SET_CAKERACEGAME_OFFSET))(this, value);
	}
	...
	::Class_2_43A5ACD54102DE89* get_match3Game()
	{
		return ((::Class_2_43A5ACD54102DE89*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_867B6CE75953535A_GET_MATCH3GAME_OFFSET))(this);
	}

	::System::Void set_match3Game(::Class_2_43A5ACD54102DE89* value)
	{
		return ((::System::Void(*)(::PVOID, ::Class_2_43A5ACD54102DE89*))((::PBYTE)hIl2Cpp + CLASS_1_867B6CE75953535A_SET_MATCH3GAME_OFFSET))(this, value);
	}
	...
	::Class_2_099B78418029B3B1_2* get_parkourGame()
	{
		return ((::Class_2_099B78418029B3B1_2*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_867B6CE75953535A_GET_PARKOURGAME_OFFSET))(this);
	}

	::System::Void set_parkourGame(::Class_2_099B78418029B3B1_2* value)
	{
		return ((::System::Void(*)(::PVOID, ::Class_2_099B78418029B3B1_2*))((::PBYTE)hIl2Cpp + CLASS_1_867B6CE75953535A_SET_PARKOURGAME_OFFSET))(this, value);
	}
	...
	{
		return ((::Class_2_C8461ACA8308A704_1*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_867B6CE75953535A_GET_UI3DGAMEINPUT_OFFSET))(this);
	}

	::System::Void set_uI3DGameInput(::Class_2_C8461ACA8308A704_1* value)
	{
		return ((::System::Void(*)(::PVOID, ::Class_2_C8461ACA8308A704_1*))((::PBYTE)hIl2Cpp + CLASS_1_867B6CE75953535A_SET_UI3DGAMEINPUT_OFFSET))(this, value);
	}
