...
#define CLASS_1_867B6CE75953535A_CLEAR_OFFSET UNITYSDK_OFFSET(0x1695E950)
#define CLASS_1_867B6CE75953535A_GET_ALLCONTEXTS_OFFSET UNITYSDK_OFFSET(0x1695F500)
#define CLASS_1_867B6CE75953535A_GET_CAKERACEGAME_OFFSET UNITYSDK_OFFSET(0x1695F260)
#define CLASS_1_867B6CE75953535A_GET_CHENLINGGAME_OFFSET UNITYSDK_OFFSET(0x1695F280)
#define CLASS_1_867B6CE75953535A_GET_CHIMERADUELGAME_OFFSET UNITYSDK_OFFSET(0x1695F2A0)
#define CLASS_1_867B6CE75953535A_GET_CHIMERAGAME_OFFSET UNITYSDK_OFFSET(0x1695F2C0)
#define CLASS_1_867B6CE75953535A_GET_ELFRESTAURANTGAME_OFFSET UNITYSDK_OFFSET(0x1695F2E0)
#define CLASS_1_867B6CE75953535A_GET_FIVEDIMGAME_OFFSET UNITYSDK_OFFSET(0x1695F300)
#define CLASS_1_867B6CE75953535A_GET_FOURROTATEVOXELGAME_OFFSET UNITYSDK_OFFSET(0x1695F320)
#define CLASS_1_867B6CE75953535A_GET_LITTLEGAMEINPUT_OFFSET UNITYSDK_OFFSET(0x1695F360)
#define CLASS_1_867B6CE75953535A_GET_LITTLEGAME_OFFSET UNITYSDK_OFFSET(0x1695F340)
#define CLASS_1_867B6CE75953535A_GET_MARBLEGAME_OFFSET UNITYSDK_OFFSET(0x1695F380)
#define CLASS_1_867B6CE75953535A_GET_MATCH3GAME_OFFSET UNITYSDK_OFFSET(0x1695F3A0)
#define CLASS_1_867B6CE75953535A_GET_MOVIEGAMECONFIG_OFFSET UNITYSDK_OFFSET(0x1695F3C0)
#define CLASS_1_867B6CE75953535A_GET_MOVIEGAMESTATE_OFFSET UNITYSDK_OFFSET(0x1695F3E0)
#define CLASS_1_867B6CE75953535A_GET_PARKOURGAME_OFFSET UNITYSDK_OFFSET(0x1695F400)
#define CLASS_1_867B6CE75953535A_GET_PINGPONGGAME_OFFSET UNITYSDK_OFFSET(0x1695F420)
#define CLASS_1_867B6CE75953535A_GET_TIMELINECONTROLGAMECONFIG_OFFSET UNITYSDK_OFFSET(0x1695F440)
#define CLASS_1_867B6CE75953535A_GET_TIMELINECONTROLGAMESTATE_OFFSET UNITYSDK_OFFSET(0x1695F460)
#define CLASS_1_867B6CE75953535A_GET_TIMERELAYFLAMEGAME_OFFSET UNITYSDK_OFFSET(0x1695F480)
#define CLASS_1_867B6CE75953535A_GET_UI3DGAMECONFIG_OFFSET UNITYSDK_OFFSET(0x1695F4A0)
#define CLASS_1_867B6CE75953535A_GET_UI3DGAMEINPUT_OFFSET UNITYSDK_OFFSET(0x1695F4C0)
#define CLASS_1_867B6CE75953535A_GET_UI3DGAMESTATE_OFFSET UNITYSDK_OFFSET(0x1695F4E0)
#define CLASS_1_867B6CE75953535A_METHOD_1_0C7CBCE710B3F112_OFFSET UNITYSDK_OFFSET(0x1695F220)
#define CLASS_1_867B6CE75953535A_METHOD_1_3B7145E79424FB75_OFFSET UNITYSDK_OFFSET(0x1695E9A0)
#define CLASS_1_867B6CE75953535A_METHOD_1_47FCE72550F759BF_OFFSET UNITYSDK_OFFSET(0x1695EB10)
#define CLASS_1_867B6CE75953535A_METHOD_1_ACE888BF6F5BC5FD_OFFSET UNITYSDK_OFFSET(0x1695FF80)
#define CLASS_1_867B6CE75953535A_SET_CAKERACEGAME_OFFSET UNITYSDK_OFFSET(0x1695F270)
#define CLASS_1_867B6CE75953535A_SET_CHENLINGGAME_OFFSET UNITYSDK_OFFSET(0x1695F290)
#define CLASS_1_867B6CE75953535A_SET_CHIMERADUELGAME_OFFSET UNITYSDK_OFFSET(0x1695F2B0)
#define CLASS_1_867B6CE75953535A_SET_CHIMERAGAME_OFFSET UNITYSDK_OFFSET(0x1695F2D0)
#define CLASS_1_867B6CE75953535A_SET_ELFRESTAURANTGAME_OFFSET UNITYSDK_OFFSET(0x1695F2F0)
#define CLASS_1_867B6CE75953535A_SET_FIVEDIMGAME_OFFSET UNITYSDK_OFFSET(0x1695F310)
#define CLASS_1_867B6CE75953535A_SET_FOURROTATEVOXELGAME_OFFSET UNITYSDK_OFFSET(0x1695F330)
#define CLASS_1_867B6CE75953535A_SET_LITTLEGAMEINPUT_OFFSET UNITYSDK_OFFSET(0x1695F370)
#define CLASS_1_867B6CE75953535A_SET_LITTLEGAME_OFFSET UNITYSDK_OFFSET(0x1695F350)
#define CLASS_1_867B6CE75953535A_SET_MARBLEGAME_OFFSET UNITYSDK_OFFSET(0x1695F390)
#define CLASS_1_867B6CE75953535A_SET_MATCH3GAME_OFFSET UNITYSDK_OFFSET(0x1695F3B0)
#define CLASS_1_867B6CE75953535A_SET_MOVIEGAMECONFIG_OFFSET UNITYSDK_OFFSET(0x1695F3D0)
#define CLASS_1_867B6CE75953535A_SET_MOVIEGAMESTATE_OFFSET UNITYSDK_OFFSET(0x1695F3F0)
#define CLASS_1_867B6CE75953535A_SET_PARKOURGAME_OFFSET UNITYSDK_OFFSET(0x1695F410)
#define CLASS_1_867B6CE75953535A_SET_PINGPONGGAME_OFFSET UNITYSDK_OFFSET(0x1695F430)
#define CLASS_1_867B6CE75953535A_SET_TIMELINECONTROLGAMECONFIG_OFFSET UNITYSDK_OFFSET(0x1695F450)
#define CLASS_1_867B6CE75953535A_SET_TIMELINECONTROLGAMESTATE_OFFSET UNITYSDK_OFFSET(0x1695F470)
#define CLASS_1_867B6CE75953535A_SET_TIMERELAYFLAMEGAME_OFFSET UNITYSDK_OFFSET(0x1695F490)
#define CLASS_1_867B6CE75953535A_SET_UI3DGAMECONFIG_OFFSET UNITYSDK_OFFSET(0x1695F4B0)
#define CLASS_1_867B6CE75953535A_SET_UI3DGAMEINPUT_OFFSET UNITYSDK_OFFSET(0x1695F4D0)
#define CLASS_1_867B6CE75953535A_SET_UI3DGAMESTATE_OFFSET UNITYSDK_OFFSET(0x1695F4F0)
#define CLASS_1_867B6CE75953535A__CTOR_OFFSET UNITYSDK_OFFSET(0x1695EBB0)
...
public:
	...
	{
		return (::Class_1_867B6CE75953535A**)Il2CppClass::FromTypeDefinitionIndex(Class_1_867B6CE75953535A_TypeDefinitionIndex)->GetStaticField(0xE000);
	}
	...
	::Class_2_AF4E89503EBBCCA0* _fourRotateVoxelGame_k__BackingField; // 0x10
	::Class_2_884D02965B14FC41* _movieGameState_k__BackingField; // 0x18
	::Class_2_C8461ACA8308A704* _littleGame_k__BackingField; // 0x20
	::Class_2_E9C9AAD7C711B3E3* _chenLingGame_k__BackingField; // 0x28
	::Class_2_43D1AA62A6D00FFF* _elfRestaurantGame_k__BackingField; // 0x30
	::Class_2_0D3C4922E3883E2B* _marbleGame_k__BackingField; // 0x38
	::Class_2_F47F7A3F5E97970D* _fiveDimGame_k__BackingField; // 0x40
	::Class_2_D1523E43223DED38* _timelineControlGameState_k__BackingField; // 0x48
	::Class_2_D5BF6D0911868A14* _movieGameConfig_k__BackingField; // 0x50
	::Class_2_CC109BC117037E72* _timeRelayFlameGame_k__BackingField; // 0x58
	::Class_2_1152250B69783505* _pingPongGame_k__BackingField; // 0x60
	::Class_2_ED5ACF982FC3BE02* _timelineControlGameConfig_k__BackingField; // 0x68
	::Class_2_D31C9C0BB2725F41* _uI3DGameState_k__BackingField; // 0x70
	::Class_2_BE574E60E64D3550* _littleGameInput_k__BackingField; // 0x78
	::Class_2_C8461ACA8308A704_1* _cakeRaceGame_k__BackingField; // 0x80
	::Class_2_C8461ACA8308A704_2* _uI3DGameInput_k__BackingField; // 0x88
	::Class_2_434143B198116DB9* _match3Game_k__BackingField; // 0x90
	::Class_2_8CE5A0FC3E91D7F4* _chimeraGame_k__BackingField; // 0x98
	::Class_2_6AA7CA7493367EF4* _chimeraDuelGame_k__BackingField; // 0xA0
	::Class_2_099B78418029B3B1_5* _parkourGame_k__BackingField; // 0xA8
	::Class_2_49510E41341F97EC* _uI3DGameConfig_k__BackingField; // 0xB0
