...
#define SOFA_SHORTCUTHINTCONTROL_METHOD_6_464F9487BF0D77F8_OFFSET UNITYSDK_OFFSET(0xA6980E0)
#define SOFA_SHORTCUTHINTCONTROL_METHOD_6_6E6682ED9FD6F719_OFFSET UNITYSDK_OFFSET(0xA697A60)
#define SOFA_SHORTCUTHINTCONTROL_METHOD_6_8BD6897B2A515B73_OFFSET UNITYSDK_OFFSET(0xA697C90)
#define SOFA_SHORTCUTHINTCONTROL_METHOD_6_ACE888BF6F5BC5FD_OFFSET UNITYSDK_OFFSET(0xA697560)
#define SOFA_SHORTCUTHINTCONTROL_METHOD_6_AFC8215C57A0845A_OFFSET UNITYSDK_OFFSET(0xA6978E0)
#define SOFA_SHORTCUTHINTCONTROL_METHOD_6_CCA302292204F69D_OFFSET UNITYSDK_OFFSET(0xA697E00)
#define SOFA_SHORTCUTHINTCONTROL_METHOD_6_CEE2550285AA5985_1_OFFSET UNITYSDK_OFFSET(0xA698390)
#define SOFA_SHORTCUTHINTCONTROL_METHOD_6_CEE2550285AA5985_OFFSET UNITYSDK_OFFSET(0xA698280)
#define SOFA_SHORTCUTHINTCONTROL_METHOD_6_D67C01E967FCF1F8_OFFSET UNITYSDK_OFFSET(0xA6977B0)
#define SOFA_SHORTCUTHINTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xA698530)
#define SOFA_SHORTCUTHINTCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA6974F0)
#define SOFA_SHORTCUTHINTCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xA697220)
#define SOFA_SHORTCUTHINTCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA698610)
#define SOFA_SHORTCUTHINTCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xA6985D0)

namespace Sofa
{
	inline static constexpr unsigned int ShortCutHintControl_TypeDefinitionIndex = 37602;
