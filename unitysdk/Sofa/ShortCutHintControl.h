...
#define SOFA_SHORTCUTHINTCONTROL_METHOD_6_464F9487BF0D77F8_OFFSET UNITYSDK_OFFSET(0xABDFC80)
#define SOFA_SHORTCUTHINTCONTROL_METHOD_6_6E6682ED9FD6F719_OFFSET UNITYSDK_OFFSET(0xABDF600)
#define SOFA_SHORTCUTHINTCONTROL_METHOD_6_8BD6897B2A515B73_OFFSET UNITYSDK_OFFSET(0xABDF830)
#define SOFA_SHORTCUTHINTCONTROL_METHOD_6_ACE888BF6F5BC5FD_OFFSET UNITYSDK_OFFSET(0xABDF100)
#define SOFA_SHORTCUTHINTCONTROL_METHOD_6_AFC8215C57A0845A_OFFSET UNITYSDK_OFFSET(0xABDF480)
#define SOFA_SHORTCUTHINTCONTROL_METHOD_6_CCA302292204F69D_OFFSET UNITYSDK_OFFSET(0xABDF9A0)
#define SOFA_SHORTCUTHINTCONTROL_METHOD_6_CEE2550285AA5985_1_OFFSET UNITYSDK_OFFSET(0xABDFF30)
#define SOFA_SHORTCUTHINTCONTROL_METHOD_6_CEE2550285AA5985_OFFSET UNITYSDK_OFFSET(0xABDFE20)
#define SOFA_SHORTCUTHINTCONTROL_METHOD_6_D67C01E967FCF1F8_OFFSET UNITYSDK_OFFSET(0xABDF350)
#define SOFA_SHORTCUTHINTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xABE00D0)
#define SOFA_SHORTCUTHINTCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xABDF090)
#define SOFA_SHORTCUTHINTCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xABDEDC0)
#define SOFA_SHORTCUTHINTCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xABE01B0)
#define SOFA_SHORTCUTHINTCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xABE0170)
