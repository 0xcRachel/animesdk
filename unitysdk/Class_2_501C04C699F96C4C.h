...
#define CLASS_2_501C04C699F96C4C_GET_NEEDTICK_OFFSET UNITYSDK_OFFSET(0x8D3A130)
#define CLASS_2_501C04C699F96C4C_METHOD_2_0076C796B2045359_OFFSET UNITYSDK_OFFSET(0x8D38010)
#define CLASS_2_501C04C699F96C4C_METHOD_2_019FAF8DF887E9D8_OFFSET UNITYSDK_OFFSET(0x8D37790)
#define CLASS_2_501C04C699F96C4C_METHOD_2_04C8F82349DC4E83_1_OFFSET UNITYSDK_OFFSET(0x8D3C830)
#define CLASS_2_501C04C699F96C4C_METHOD_2_04C8F82349DC4E83_OFFSET UNITYSDK_OFFSET(0x8D3C650)
#define CLASS_2_501C04C699F96C4C_METHOD_2_0BDFAC56E6B704CB_OFFSET UNITYSDK_OFFSET(0x8D37BB0)
#define CLASS_2_501C04C699F96C4C_METHOD_2_0ED51BEF22C2FF5B_OFFSET UNITYSDK_OFFSET(0x8D39050)
#define CLASS_2_501C04C699F96C4C_METHOD_2_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0x8D3D830)
#define CLASS_2_501C04C699F96C4C_METHOD_2_1ABF1CBED7A4AF0A_OFFSET UNITYSDK_OFFSET(0x8D3A1F0)
#define CLASS_2_501C04C699F96C4C_METHOD_2_1DE6433C25680F9D_OFFSET UNITYSDK_OFFSET(0x8D37D70)
#define CLASS_2_501C04C699F96C4C_METHOD_2_1E27A7B84BD57C4A_OFFSET UNITYSDK_OFFSET(0x8D3C440)
#define CLASS_2_501C04C699F96C4C_METHOD_2_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x8D3AC10)
#define CLASS_2_501C04C699F96C4C_METHOD_2_283DA224BE06DA9F_OFFSET UNITYSDK_OFFSET(0x8D39C20)
#define CLASS_2_501C04C699F96C4C_METHOD_2_284B3166B7E1035B_OFFSET UNITYSDK_OFFSET(0x8D3CEF0)
#define CLASS_2_501C04C699F96C4C_METHOD_2_30D1209326FA87FC_1_OFFSET UNITYSDK_OFFSET(0x8D3AD90)
#define CLASS_2_501C04C699F96C4C_METHOD_2_30D1209326FA87FC_2_OFFSET UNITYSDK_OFFSET(0x8D37A90)
#define CLASS_2_501C04C699F96C4C_METHOD_2_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x8D394A0)
#define CLASS_2_501C04C699F96C4C_METHOD_2_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x8D3BB00)
#define CLASS_2_501C04C699F96C4C_METHOD_2_3C111959D3BB5616_OFFSET UNITYSDK_OFFSET(0x8D3E410)
#define CLASS_2_501C04C699F96C4C_METHOD_2_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x8D3C3F0)
#define CLASS_2_501C04C699F96C4C_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x8D399E0)
#define CLASS_2_501C04C699F96C4C_METHOD_2_4593246B8A911FE1_OFFSET UNITYSDK_OFFSET(0x8D3E610)
#define CLASS_2_501C04C699F96C4C_METHOD_2_463A5CCB24F47BB6_OFFSET UNITYSDK_OFFSET(0x8D3AEE0)
#define CLASS_2_501C04C699F96C4C_METHOD_2_5035AF85CDD1C32C_OFFSET UNITYSDK_OFFSET(0x8D3D9B0)
#define CLASS_2_501C04C699F96C4C_METHOD_2_57B2EBADDC82E2F5_OFFSET UNITYSDK_OFFSET(0x8D3AD10)
#define CLASS_2_501C04C699F96C4C_METHOD_2_58E4F6A5F8FAF17F_OFFSET UNITYSDK_OFFSET(0x8D3CE30)
#define CLASS_2_501C04C699F96C4C_METHOD_2_5B0531D5B96D6B96_OFFSET UNITYSDK_OFFSET(0x8D3D750)
#define CLASS_2_501C04C699F96C4C_METHOD_2_5EE047E48143A8CA_OFFSET UNITYSDK_OFFSET(0x8D3AE80)
#define CLASS_2_501C04C699F96C4C_METHOD_2_6055A93732CC885D_OFFSET UNITYSDK_OFFSET(0x8D397D0)
#define CLASS_2_501C04C699F96C4C_METHOD_2_623EAEB8D1DF0AA1_OFFSET UNITYSDK_OFFSET(0x8D3B770)
#define CLASS_2_501C04C699F96C4C_METHOD_2_6864BF0C477F1F62_OFFSET UNITYSDK_OFFSET(0x8D3A6D0)
#define CLASS_2_501C04C699F96C4C_METHOD_2_695579C6786804DA_OFFSET UNITYSDK_OFFSET(0x8D395F0)
#define CLASS_2_501C04C699F96C4C_METHOD_2_7163BBB1CD5A2114_1_OFFSET UNITYSDK_OFFSET(0x8D3B0B0)
#define CLASS_2_501C04C699F96C4C_METHOD_2_7163BBB1CD5A2114_OFFSET UNITYSDK_OFFSET(0x8D3AFA0)
#define CLASS_2_501C04C699F96C4C_METHOD_2_793FFA9A76FE6840_OFFSET UNITYSDK_OFFSET(0x8D3EA80)
#define CLASS_2_501C04C699F96C4C_METHOD_2_7FF4BF6FF88B610E_OFFSET UNITYSDK_OFFSET(0x8D3E7E0)
#define CLASS_2_501C04C699F96C4C_METHOD_2_87318FF00D6BC7EB_OFFSET UNITYSDK_OFFSET(0x8D38BF0)
#define CLASS_2_501C04C699F96C4C_METHOD_2_8923446497E3D0C5_OFFSET UNITYSDK_OFFSET(0x8D39DD0)
#define CLASS_2_501C04C699F96C4C_METHOD_2_93A1480D2A66C53A_OFFSET UNITYSDK_OFFSET(0x8D3C2A0)
#define CLASS_2_501C04C699F96C4C_METHOD_2_952E03771D024CEE_OFFSET UNITYSDK_OFFSET(0x8D3B1C0)
#define CLASS_2_501C04C699F96C4C_METHOD_2_95A7FF7AF0E79B18_OFFSET UNITYSDK_OFFSET(0x8D3D8C0)
#define CLASS_2_501C04C699F96C4C_METHOD_2_9725A4CA0CFEC673_OFFSET UNITYSDK_OFFSET(0x8D37960)
#define CLASS_2_501C04C699F96C4C_METHOD_2_A0EFDC02874C650B_OFFSET UNITYSDK_OFFSET(0x8D3AA00)
#define CLASS_2_501C04C699F96C4C_METHOD_2_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x8D3ACC0)
#define CLASS_2_501C04C699F96C4C_METHOD_2_A693F2E8D4F4A766_OFFSET UNITYSDK_OFFSET(0x8D3BAA0)
#define CLASS_2_501C04C699F96C4C_METHOD_2_A88CDF038776FAA5_OFFSET UNITYSDK_OFFSET(0x8D3C6B0)
#define CLASS_2_501C04C699F96C4C_METHOD_2_A984848EA3E436DA_OFFSET UNITYSDK_OFFSET(0x8D3AC70)
#define CLASS_2_501C04C699F96C4C_METHOD_2_AA169839CB93802A_OFFSET UNITYSDK_OFFSET(0x8D39350)
#define CLASS_2_501C04C699F96C4C_METHOD_2_AFFF454231BE9638_OFFSET UNITYSDK_OFFSET(0x8D3E1B0)
#define CLASS_2_501C04C699F96C4C_METHOD_2_B1445E8504415D4D_OFFSET UNITYSDK_OFFSET(0x8D3E7F0)
#define CLASS_2_501C04C699F96C4C_METHOD_2_B9A97467188E4B69_1_OFFSET UNITYSDK_OFFSET(0x8D39A40)
#define CLASS_2_501C04C699F96C4C_METHOD_2_B9A97467188E4B69_OFFSET UNITYSDK_OFFSET(0x8D389F0)
#define CLASS_2_501C04C699F96C4C_METHOD_2_BD8B602BBEDF6A67_OFFSET UNITYSDK_OFFSET(0x8D3DCD0)
#define CLASS_2_501C04C699F96C4C_METHOD_2_BF6F0FF54BBF3C41_OFFSET UNITYSDK_OFFSET(0x8D3DC00)
#define CLASS_2_501C04C699F96C4C_METHOD_2_D1305BC17A89C222_OFFSET UNITYSDK_OFFSET(0x8D38830)
#define CLASS_2_501C04C699F96C4C_METHOD_2_D3129FE8DF635B48_OFFSET UNITYSDK_OFFSET(0x8D37B40)
#define CLASS_2_501C04C699F96C4C_METHOD_2_D4499A0147676A9C_OFFSET UNITYSDK_OFFSET(0x8D39220)
#define CLASS_2_501C04C699F96C4C_METHOD_2_DA1A8A25D0B64A55_OFFSET UNITYSDK_OFFSET(0x8D3E2B0)
#define CLASS_2_501C04C699F96C4C_METHOD_2_DC3142F930ECD6F8_OFFSET UNITYSDK_OFFSET(0x8D3BB50)
#define CLASS_2_501C04C699F96C4C_METHOD_2_DC715239B8B98D9C_OFFSET UNITYSDK_OFFSET(0x8D38E90)
#define CLASS_2_501C04C699F96C4C_METHOD_2_DF7CEFC0E6C5FD0D_1_OFFSET UNITYSDK_OFFSET(0x8D3C950)
#define CLASS_2_501C04C699F96C4C_METHOD_2_DF7CEFC0E6C5FD0D_2_OFFSET UNITYSDK_OFFSET(0x8D3CA10)
#define CLASS_2_501C04C699F96C4C_METHOD_2_DF7CEFC0E6C5FD0D_3_OFFSET UNITYSDK_OFFSET(0x8D3CAD0)
#define CLASS_2_501C04C699F96C4C_METHOD_2_DF7CEFC0E6C5FD0D_4_OFFSET UNITYSDK_OFFSET(0x8D3CCB0)
#define CLASS_2_501C04C699F96C4C_METHOD_2_DF7CEFC0E6C5FD0D_OFFSET UNITYSDK_OFFSET(0x8D3C890)
#define CLASS_2_501C04C699F96C4C_METHOD_2_E05ADF64DE351167_OFFSET UNITYSDK_OFFSET(0x8D3E560)
#define CLASS_2_501C04C699F96C4C_METHOD_2_ECAA253D18A27C68_OFFSET UNITYSDK_OFFSET(0x8D3A660)
#define CLASS_2_501C04C699F96C4C_METHOD_2_F62A76C6284AD01E_OFFSET UNITYSDK_OFFSET(0x8D3C4B0)
#define CLASS_2_501C04C699F96C4C_ONINIT_OFFSET UNITYSDK_OFFSET(0x8D373F0)
#define CLASS_2_501C04C699F96C4C_ONUNINIT_OFFSET UNITYSDK_OFFSET(0x8D38F40)
#define CLASS_2_501C04C699F96C4C_TICK_OFFSET UNITYSDK_OFFSET(0x8D3A140)
#define CLASS_2_501C04C699F96C4C__CCTOR_OFFSET UNITYSDK_OFFSET(0x8D3E8F0)
#define CLASS_2_501C04C699F96C4C__CTOR_OFFSET UNITYSDK_OFFSET(0x8D3E800)
#define CLASS_2_501C04C699F96C4C___IFIXBASEPROXY_ONINIT_OFFSET UNITYSDK_OFFSET(0x8D3E950)
#define CLASS_2_501C04C699F96C4C___IFIXBASEPROXY_ONUNINIT_OFFSET UNITYSDK_OFFSET(0x8D3E9B0)
#define CLASS_2_501C04C699F96C4C___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x8D3EA10)
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_2_501C04C699F96C4C_TypeDefinitionIndex)->GetStaticField(0x126C0);
	}
	static ::System::String** StaticGet_Field_2_27()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_2_501C04C699F96C4C_TypeDefinitionIndex)->GetStaticField(0x126C8);
	}
	static ::System::String** StaticGet_Field_2_26()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_2_501C04C699F96C4C_TypeDefinitionIndex)->GetStaticField(0x126D0);
	}
	static ::System::UInt32* StaticGet_Field_2_28()
	{
		return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(Class_2_501C04C699F96C4C_TypeDefinitionIndex)->GetStaticField(0x6370);
	}
	::RPG::GameCore::GameEntity* Field_2_19; // 0x20
	::Class_1_23F67DD15593C8D6* Field_2_15; // 0x28
	::RPG::GameCore::GameEntity* Field_2_1; // 0x30
	::RPG::GameCore::MazePuzzleSwitchMascotRow* Field_2_3; // 0x38
	::RPG::GameCore::SwitchMascotConfig* Field_2_4; // 0x40
	::UnityEngine::GameObject* Field_2_5; // 0x48
	::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* Field_2_13; // 0x50
	::System::Collections::Generic::Dictionary_2<::System::ValueTuple_2<::System::UInt32, ::System::UInt32>, ::Class_2_501C04C699F96C4C_Class_1_B575E19A8DC2E7A9*>* Field_2_16; // 0x58
	::RPG::Client::SwitchMascotPuzzleBoard* Field_2_0; // 0x60
	::System::Collections::Generic::List_1<::RPG::Client::MonoEffect*>* Field_2_18; // 0x68
	::RPG::Client::MonoDroneAirwallControl* Field_2_6; // 0x70
	::RPG::Client::AchievementData* Field_2_24; // 0x78
	::RPG::GameCore::AdventureCharacterController* Field_2_2; // 0x80
	::System::Single Field_2_11; // 0x88
	::System::Boolean Field_2_23; // 0x8C
	::System::Boolean Field_2_22; // 0x8D
	::System::Boolean Field_2_20; // 0x8E
	::System::Boolean Field_2_9; // 0x8F
	::System::UInt64 Field_2_7; // 0x90
