...
#define CLASS_1_9D5468144EC4C1CF_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19D0C160)
#define CLASS_1_9D5468144EC4C1CF_CLONE_OFFSET UNITYSDK_OFFSET(0x19D0BD40)
#define CLASS_1_9D5468144EC4C1CF_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19D0BEB0)
#define CLASS_1_9D5468144EC4C1CF_EQUALS_OFFSET UNITYSDK_OFFSET(0x19D0BDA0)
#define CLASS_1_9D5468144EC4C1CF_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19D0BF60)
#define CLASS_1_9D5468144EC4C1CF_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19D0C2A0)
#define CLASS_1_9D5468144EC4C1CF_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19D0C200)
#define CLASS_1_9D5468144EC4C1CF_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19D0BBD0)
#define CLASS_1_9D5468144EC4C1CF_METHOD_1_96F1CABDCC6E782E_OFFSET UNITYSDK_OFFSET(0x19D0BD90)
#define CLASS_1_9D5468144EC4C1CF_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19D0BC30)
#define CLASS_1_9D5468144EC4C1CF_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19D0C050)
#define CLASS_1_9D5468144EC4C1CF_WRITETO_OFFSET UNITYSDK_OFFSET(0x19D0C0B0)
#define CLASS_1_9D5468144EC4C1CF__CCTOR_OFFSET UNITYSDK_OFFSET(0x19D0C380)
#define CLASS_1_9D5468144EC4C1CF__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19D0BC90)
#define CLASS_1_9D5468144EC4C1CF__CTOR_OFFSET UNITYSDK_OFFSET(0x19D0BC40)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_9D5468144EC4C1CF*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_9D5468144EC4C1CF_TypeDefinitionIndex)->GetStaticField(0x60180);
	}
	static ::Google::Protobuf::FieldCodec_1<::Proto::BigDataAvatarRelicRecommend*>** StaticGet_Field_1_3()
	{
		return (::Google::Protobuf::FieldCodec_1<::Proto::BigDataAvatarRelicRecommend*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_9D5468144EC4C1CF_TypeDefinitionIndex)->GetStaticField(0x60188);
	}
