...
#define CLASS_2_E187AC3A40DB7832_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x10FCB5B0)
#define CLASS_2_E187AC3A40DB7832_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x10FCB720)
#define CLASS_2_E187AC3A40DB7832_METHOD_2_0865E94460F11643_OFFSET UNITYSDK_OFFSET(0x10FCA6B0)
#define CLASS_2_E187AC3A40DB7832_METHOD_2_0AB718BEE9EA06D7_OFFSET UNITYSDK_OFFSET(0x10FCB160)
#define CLASS_2_E187AC3A40DB7832_METHOD_2_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x10FCA4E0)
#define CLASS_2_E187AC3A40DB7832_METHOD_2_32B2368221A04800_OFFSET UNITYSDK_OFFSET(0x10FCAEF0)
#define CLASS_2_E187AC3A40DB7832_METHOD_2_374763CC1E43BA68_OFFSET UNITYSDK_OFFSET(0x10FCADF0)
#define CLASS_2_E187AC3A40DB7832_METHOD_2_3923AB821AB9D6A6_OFFSET UNITYSDK_OFFSET(0x10FCA790)
#define CLASS_2_E187AC3A40DB7832_METHOD_2_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x10FCA4F0)
#define CLASS_2_E187AC3A40DB7832_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x10FCB1F0)
#define CLASS_2_E187AC3A40DB7832_METHOD_2_4C944C3BDCE3BB8F_OFFSET UNITYSDK_OFFSET(0x10FCA8D0)
#define CLASS_2_E187AC3A40DB7832_METHOD_2_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0x10FCB970)
#define CLASS_2_E187AC3A40DB7832_METHOD_2_5790A55946AA509D_2_OFFSET UNITYSDK_OFFSET(0x10FCBA40)
#define CLASS_2_E187AC3A40DB7832_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x10FCB910)
#define CLASS_2_E187AC3A40DB7832_METHOD_2_83E98B6103702766_OFFSET UNITYSDK_OFFSET(0x10FCAD90)
#define CLASS_2_E187AC3A40DB7832_METHOD_2_87A99E4BDD8FF37B_OFFSET UNITYSDK_OFFSET(0x10FCB0A0)
#define CLASS_2_E187AC3A40DB7832_METHOD_2_96A0F0F8F3E30F20_OFFSET UNITYSDK_OFFSET(0x10FCAFD0)
#define CLASS_2_E187AC3A40DB7832_METHOD_2_A27D06F9481FAFDB_1_OFFSET UNITYSDK_OFFSET(0x10FCB2F0)
#define CLASS_2_E187AC3A40DB7832_METHOD_2_A27D06F9481FAFDB_2_OFFSET UNITYSDK_OFFSET(0x10FCB4A0)
#define CLASS_2_E187AC3A40DB7832_METHOD_2_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0x10FCB250)
#define CLASS_2_E187AC3A40DB7832_METHOD_2_A73E39DE1C239AEA_OFFSET UNITYSDK_OFFSET(0x10FCAC50)
#define CLASS_2_E187AC3A40DB7832_METHOD_2_B37C805F1A4DBCFB_OFFSET UNITYSDK_OFFSET(0x10FCA830)
#define CLASS_2_E187AC3A40DB7832_METHOD_2_BF51A7F7DC348455_OFFSET UNITYSDK_OFFSET(0x10FCAC00)
#define CLASS_2_E187AC3A40DB7832_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x10FCA610)
#define CLASS_2_E187AC3A40DB7832_METHOD_2_D5E5EC1B4538DDD1_OFFSET UNITYSDK_OFFSET(0x10FCBAA0)
#define CLASS_2_E187AC3A40DB7832_METHOD_2_DE3244AC41BC6E2A_OFFSET UNITYSDK_OFFSET(0x10FCA980)
#define CLASS_2_E187AC3A40DB7832_METHOD_2_F026F9F94BAA5E1F_OFFSET UNITYSDK_OFFSET(0x10FCAD20)
#define CLASS_2_E187AC3A40DB7832_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x10FCB3B0)
#define CLASS_2_E187AC3A40DB7832__CTOR_OFFSET UNITYSDK_OFFSET(0x10FCB870)
#define CLASS_2_E187AC3A40DB7832__ONBIND_OFFSET UNITYSDK_OFFSET(0x10FCA360)
#define CLASS_2_E187AC3A40DB7832__ONTICK_OFFSET UNITYSDK_OFFSET(0x10FCA650)
#define CLASS_2_E187AC3A40DB7832___IFIXBASEPROXY_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x10FCBB10)
#define CLASS_2_E187AC3A40DB7832___IFIXBASEPROXY_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x10FCBB70)
#define CLASS_2_E187AC3A40DB7832___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0x10FCB8B0)
#define CLASS_2_E187AC3A40DB7832___IFIXBASEPROXY__ONTICK_OFFSET UNITYSDK_OFFSET(0x10FCB9D0)

inline static constexpr unsigned int Class_2_E187AC3A40DB7832_TypeDefinitionIndex = 66661;
...
public:
	...
	::RPG::GameCore::SkillCharacterComponent* Field_2_11; // 0x68
	::UnityEngine::Transform* Field_2_3; // 0x70
	::System::Func_1<::System::Boolean>* Field_2_14; // 0x78
	::Class_2_D650D0F10A391A4C* Field_2_0; // 0x80
	...
	::RPG::GameCore::SkillData* Field_2_10; // 0xB0
