...
#define CLASS_1_23C1B7E6B450FFB8_4_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A3A1940)
#define CLASS_1_23C1B7E6B450FFB8_4_CLONE_OFFSET UNITYSDK_OFFSET(0x1A3A1400)
#define CLASS_1_23C1B7E6B450FFB8_4_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A3A1540)
#define CLASS_1_23C1B7E6B450FFB8_4_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A3A14E0)
#define CLASS_1_23C1B7E6B450FFB8_4_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A3A16B0)
#define CLASS_1_23C1B7E6B450FFB8_4_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A3A1A70)
#define CLASS_1_23C1B7E6B450FFB8_4_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A3A1A00)
#define CLASS_1_23C1B7E6B450FFB8_4_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1A3A1480)
#define CLASS_1_23C1B7E6B450FFB8_4_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A3A1340)
#define CLASS_1_23C1B7E6B450FFB8_4_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1A3A1490)
#define CLASS_1_23C1B7E6B450FFB8_4_METHOD_1_8633AE51B23EBDFD_1_OFFSET UNITYSDK_OFFSET(0x1A3A14D0)
#define CLASS_1_23C1B7E6B450FFB8_4_METHOD_1_8633AE51B23EBDFD_OFFSET UNITYSDK_OFFSET(0x1A3A14B0)
#define CLASS_1_23C1B7E6B450FFB8_4_METHOD_1_C229FF62B898C0B2_1_OFFSET UNITYSDK_OFFSET(0x1A3A14C0)
#define CLASS_1_23C1B7E6B450FFB8_4_METHOD_1_C229FF62B898C0B2_OFFSET UNITYSDK_OFFSET(0x1A3A14A0)
#define CLASS_1_23C1B7E6B450FFB8_4_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A3A13A0)
#define CLASS_1_23C1B7E6B450FFB8_4_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A3A1800)
#define CLASS_1_23C1B7E6B450FFB8_4_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A3A1860)
#define CLASS_1_23C1B7E6B450FFB8_4__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A3A1B90)
#define CLASS_1_23C1B7E6B450FFB8_4__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3A13C0)
#define CLASS_1_23C1B7E6B450FFB8_4__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3A13B0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_23C1B7E6B450FFB8_4*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_23C1B7E6B450FFB8_4_TypeDefinitionIndex)->GetStaticField(0x36F30);
	}
