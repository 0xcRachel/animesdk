...
#define CLASS_5_EA16995B33A1DEFF_1_CLONE_OFFSET UNITYSDK_OFFSET(0x106C0470)
#define CLASS_5_EA16995B33A1DEFF_1_METHOD_5_76C20C1C1323A406_OFFSET UNITYSDK_OFFSET(0x106C0250)
#define CLASS_5_EA16995B33A1DEFF_1_METHOD_5_A121432BC80DD093_OFFSET UNITYSDK_OFFSET(0x106C0000)
#define CLASS_5_EA16995B33A1DEFF_1_METHOD_5_C34A0F1A8A1B4952_OFFSET UNITYSDK_OFFSET(0x106C00B0)
#define CLASS_5_EA16995B33A1DEFF_1_REVERSE_OFFSET UNITYSDK_OFFSET(0x106C04E0)
#define CLASS_5_EA16995B33A1DEFF_1_STARTWITHTARGET_OFFSET UNITYSDK_OFFSET(0x106C0310)
#define CLASS_5_EA16995B33A1DEFF_1__CTOR_OFFSET UNITYSDK_OFFSET(0x106C0230)
#define CLASS_5_EA16995B33A1DEFF_1___IFIXBASEPROXY_CLONE_OFFSET UNITYSDK_OFFSET(0x106C0620)
#define CLASS_5_EA16995B33A1DEFF_1___IFIXBASEPROXY_REVERSE_OFFSET UNITYSDK_OFFSET(0x106C06A0)
#define CLASS_5_EA16995B33A1DEFF_1___IFIXBASEPROXY_STARTWITHTARGET_OFFSET UNITYSDK_OFFSET(0x106C0550)

inline static constexpr unsigned int Class_5_EA16995B33A1DEFF_1_TypeDefinitionIndex = 60248;
