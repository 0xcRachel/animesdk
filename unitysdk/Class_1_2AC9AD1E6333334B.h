...
#define CLASS_1_2AC9AD1E6333334B_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1AB26C00)
#define CLASS_1_2AC9AD1E6333334B_CLONE_OFFSET UNITYSDK_OFFSET(0x1AB26700)
#define CLASS_1_2AC9AD1E6333334B_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1AB267F0)
#define CLASS_1_2AC9AD1E6333334B_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AB267C0)
#define CLASS_1_2AC9AD1E6333334B_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AB26910)
#define CLASS_1_2AC9AD1E6333334B_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1AB26F30)
#define CLASS_1_2AC9AD1E6333334B_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1AB26E10)
#define CLASS_1_2AC9AD1E6333334B_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1AB267A0)
#define CLASS_1_2AC9AD1E6333334B_METHOD_1_3DACC45AC8150727_OFFSET UNITYSDK_OFFSET(0x1AB26790)
#define CLASS_1_2AC9AD1E6333334B_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1AB265A0)
#define CLASS_1_2AC9AD1E6333334B_METHOD_1_686CBC4FBD0AAA58_OFFSET UNITYSDK_OFFSET(0x1AB26740)
#define CLASS_1_2AC9AD1E6333334B_METHOD_1_6BD2A2909D8CFAD3_OFFSET UNITYSDK_OFFSET(0x1AB26730)
#define CLASS_1_2AC9AD1E6333334B_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x1AB26770)
#define CLASS_1_2AC9AD1E6333334B_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1AB267B0)
#define CLASS_1_2AC9AD1E6333334B_METHOD_1_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x1AB26780)
#define CLASS_1_2AC9AD1E6333334B_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1AB26760)
#define CLASS_1_2AC9AD1E6333334B_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1AB26750)
#define CLASS_1_2AC9AD1E6333334B_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1AB265D0)
#define CLASS_1_2AC9AD1E6333334B_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AB26A20)
#define CLASS_1_2AC9AD1E6333334B_WRITETO_OFFSET UNITYSDK_OFFSET(0x1AB26A80)
#define CLASS_1_2AC9AD1E6333334B__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AB27080)
#define CLASS_1_2AC9AD1E6333334B__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AB26620)
#define CLASS_1_2AC9AD1E6333334B__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB265E0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_2AC9AD1E6333334B*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_2AC9AD1E6333334B_TypeDefinitionIndex)->GetStaticField(0x4FA30);
	}
	static ::Google::Protobuf::FieldCodec_1<::Class_1_87B6445D24FE4E47*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_87B6445D24FE4E47*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_2AC9AD1E6333334B_TypeDefinitionIndex)->GetStaticField(0x4FA38);
	}
	...
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_87B6445D24FE4E47*>* Field_1_7; // 0x10
	::Proto::ItemList* Field_1_8; // 0x18
	::Google::Protobuf::UnknownFieldSet* Field_1_9; // 0x20
	::System::UInt32 Field_1_10; // 0x28
	::Enum_3_0A3761FE34514D6C_23 Field_1_11; // 0x2C
