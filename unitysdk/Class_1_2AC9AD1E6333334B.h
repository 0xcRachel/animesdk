...
#define CLASS_1_2AC9AD1E6333334B_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19D2C9A0)
#define CLASS_1_2AC9AD1E6333334B_CLONE_OFFSET UNITYSDK_OFFSET(0x19D2C4C0)
#define CLASS_1_2AC9AD1E6333334B_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19D2C5B0)
#define CLASS_1_2AC9AD1E6333334B_EQUALS_OFFSET UNITYSDK_OFFSET(0x19D2C580)
#define CLASS_1_2AC9AD1E6333334B_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19D2C6D0)
#define CLASS_1_2AC9AD1E6333334B_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19D2CCC0)
#define CLASS_1_2AC9AD1E6333334B_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19D2CBA0)
#define CLASS_1_2AC9AD1E6333334B_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x19D2C4F0)
#define CLASS_1_2AC9AD1E6333334B_METHOD_1_3DACC45AC8150727_OFFSET UNITYSDK_OFFSET(0x19D2C560)
#define CLASS_1_2AC9AD1E6333334B_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19D2C360)
#define CLASS_1_2AC9AD1E6333334B_METHOD_1_686CBC4FBD0AAA58_OFFSET UNITYSDK_OFFSET(0x19D2C540)
#define CLASS_1_2AC9AD1E6333334B_METHOD_1_6BD2A2909D8CFAD3_OFFSET UNITYSDK_OFFSET(0x19D2C530)
#define CLASS_1_2AC9AD1E6333334B_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x19D2C570)
#define CLASS_1_2AC9AD1E6333334B_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x19D2C500)
#define CLASS_1_2AC9AD1E6333334B_METHOD_1_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x19D2C550)
#define CLASS_1_2AC9AD1E6333334B_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x19D2C520)
#define CLASS_1_2AC9AD1E6333334B_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x19D2C510)
#define CLASS_1_2AC9AD1E6333334B_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19D2C390)
#define CLASS_1_2AC9AD1E6333334B_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19D2C7E0)
#define CLASS_1_2AC9AD1E6333334B_WRITETO_OFFSET UNITYSDK_OFFSET(0x19D2C840)
#define CLASS_1_2AC9AD1E6333334B__CCTOR_OFFSET UNITYSDK_OFFSET(0x19D2CE00)
#define CLASS_1_2AC9AD1E6333334B__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19D2C3E0)
#define CLASS_1_2AC9AD1E6333334B__CTOR_OFFSET UNITYSDK_OFFSET(0x19D2C3A0)

inline static constexpr unsigned int Class_1_2AC9AD1E6333334B_TypeDefinitionIndex = 24998;

class Class_1_2AC9AD1E6333334B : public ::System::Object
{
public:
	static ::Google::Protobuf::FieldCodec_1<::Class_1_87B6445D24FE4E47*>** StaticGet_Field_1_11()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_87B6445D24FE4E47*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_2AC9AD1E6333334B_TypeDefinitionIndex)->GetStaticField(0x15250);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_2AC9AD1E6333334B*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_2AC9AD1E6333334B*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_2AC9AD1E6333334B_TypeDefinitionIndex)->GetStaticField(0x15258);
	}
	...
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_87B6445D24FE4E47*>* Field_1_12; // 0x20
	::System::UInt32 Field_1_3; // 0x28
	::System::Boolean Field_1_5; // 0x2C
	::Enum_3_0A3761FE34514D6C_23 Field_1_9; // 0x30
