...
#define CLASS_1_5A7D22768D1A0DC0_GET_AVATARFACTORY_OFFSET UNITYSDK_OFFSET(0x10D8AD00)
#define CLASS_1_5A7D22768D1A0DC0_METHOD_1_0455E74A2C24147C_OFFSET UNITYSDK_OFFSET(0x10D8AFE0)
#define CLASS_1_5A7D22768D1A0DC0_METHOD_1_195DF386A5E6C470_OFFSET UNITYSDK_OFFSET(0x10D8AD20)
#define CLASS_1_5A7D22768D1A0DC0_METHOD_1_E582D531F4D0FF21_OFFSET UNITYSDK_OFFSET(0x10D8B210)
#define CLASS_1_5A7D22768D1A0DC0_SET_AVATARFACTORY_OFFSET UNITYSDK_OFFSET(0x10D8AD10)
#define CLASS_1_5A7D22768D1A0DC0__CTOR_OFFSET UNITYSDK_OFFSET(0x10D8B180)

inline static constexpr unsigned int Class_1_5A7D22768D1A0DC0_TypeDefinitionIndex = 49801;
...
public:
	...
	::Class_0_16E4307DCC419505_342* _AvatarFactory_k__BackingField; // 0x18
	...
	{
		return ((::Class_0_16E4307DCC419505_342*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_5A7D22768D1A0DC0_GET_AVATARFACTORY_OFFSET))(this);
	}

	::System::Void set_AvatarFactory(::Class_0_16E4307DCC419505_342* value)
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_342*))((::PBYTE)hIl2Cpp + CLASS_1_5A7D22768D1A0DC0_SET_AVATARFACTORY_OFFSET))(this, value);
	}
