...
#define HIPPLENBUILDERPETTINGGAME_METHOD_5_6478E93E26BFB642_OFFSET UNITYSDK_OFFSET(0x105480B0)
#define HIPPLENBUILDERPETTINGGAME_METHOD_5_C5B3CC9884471A9E_OFFSET UNITYSDK_OFFSET(0x10548770)
#define HIPPLENBUILDERPETTINGGAME_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x10548C00)
#define HIPPLENBUILDERPETTINGGAME_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x10548C60)
#define HIPPLENBUILDERPETTINGGAME_START_OFFSET UNITYSDK_OFFSET(0x10547670)
#define HIPPLENBUILDERPETTINGGAME_UPDATE_OFFSET UNITYSDK_OFFSET(0x105477B0)
#define HIPPLENBUILDERPETTINGGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x105490D0)

inline static constexpr unsigned int HipplenBuilderPettingGame_TypeDefinitionIndex = 37149;
