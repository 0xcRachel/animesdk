...
#define CLASS_2_496B9C806BFFADE6_DISPOSE_OFFSET UNITYSDK_OFFSET(0x969CA80)
#define CLASS_2_496B9C806BFFADE6_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x969CAC0)
#define CLASS_2_496B9C806BFFADE6_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x969CB70)
#define CLASS_2_496B9C806BFFADE6_TICK_OFFSET UNITYSDK_OFFSET(0x969CBC0)
#define CLASS_2_496B9C806BFFADE6__CTOR_OFFSET UNITYSDK_OFFSET(0x969CA70)

inline static constexpr unsigned int Class_2_496B9C806BFFADE6_TypeDefinitionIndex = 41782;
