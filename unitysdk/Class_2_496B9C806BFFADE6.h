...
#define CLASS_2_496B9C806BFFADE6_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA625B30)
#define CLASS_2_496B9C806BFFADE6_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xA625B70)
#define CLASS_2_496B9C806BFFADE6_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xA625C20)
#define CLASS_2_496B9C806BFFADE6_TICK_OFFSET UNITYSDK_OFFSET(0xA625C70)
#define CLASS_2_496B9C806BFFADE6__CTOR_OFFSET UNITYSDK_OFFSET(0xA625B20)
