...
#define CLASS_2_EF9598BA5870F583_EXECUTE_OFFSET UNITYSDK_OFFSET(0xFEC7410)
#define CLASS_2_EF9598BA5870F583_FILTER_OFFSET UNITYSDK_OFFSET(0xFEC7340)
#define CLASS_2_EF9598BA5870F583_GETTRIGGER_OFFSET UNITYSDK_OFFSET(0xFEC71A0)
#define CLASS_2_EF9598BA5870F583__CTOR_OFFSET UNITYSDK_OFFSET(0xFEC7140)

inline static constexpr unsigned int Class_2_EF9598BA5870F583_TypeDefinitionIndex = 60056;

class Class_2_EF9598BA5870F583 : public ::Entitas::ReactiveSystem_1<::Class_2_9850514C0F89B91A*>
{
public:
	::Class_0_16E4307DCC419505_900* Field_2_0; // 0x28

	::System::Void _ctor(::Class_1_867B6CE75953535A* a1, ::Class_0_16E4307DCC419505_900* a2)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_867B6CE75953535A*, ::Class_0_16E4307DCC419505_900*))((::PBYTE)hIl2Cpp + CLASS_2_EF9598BA5870F583__CTOR_OFFSET))(this, a1, a2);
	}
