...
#define CLASS_2_D162C4F79D8D8418_DISPOSE_OFFSET UNITYSDK_OFFSET(0x118C2E90)
#define CLASS_2_D162C4F79D8D8418_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x118C28D0)
#define CLASS_2_D162C4F79D8D8418_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x118C2E50)
#define CLASS_2_D162C4F79D8D8418_TICK_OFFSET UNITYSDK_OFFSET(0x118C2DF0)
#define CLASS_2_D162C4F79D8D8418__CTOR_OFFSET UNITYSDK_OFFSET(0x118C28C0)
