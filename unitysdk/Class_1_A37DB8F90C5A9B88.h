...
#define CLASS_1_A37DB8F90C5A9B88_METHOD_1_04DA404B2194E923_OFFSET UNITYSDK_OFFSET(0x169F5050)
#define CLASS_1_A37DB8F90C5A9B88_METHOD_1_61CD3163D493FB64_OFFSET UNITYSDK_OFFSET(0x169F4DD0)
#define CLASS_1_A37DB8F90C5A9B88_METHOD_1_6E57D3559C10FFA9_OFFSET UNITYSDK_OFFSET(0x169F4D80)
#define CLASS_1_A37DB8F90C5A9B88_START_OFFSET UNITYSDK_OFFSET(0x169F4D00)
#define CLASS_1_A37DB8F90C5A9B88_STOP_OFFSET UNITYSDK_OFFSET(0x169F4D40)
#define CLASS_1_A37DB8F90C5A9B88__CTOR_OFFSET UNITYSDK_OFFSET(0x169F5190)

inline static constexpr unsigned int Class_1_A37DB8F90C5A9B88_TypeDefinitionIndex = 73542;
