...
#define CLASS_2_A5ECC652BC1D6C49_DISPOSE_OFFSET UNITYSDK_OFFSET(0x83FDAC0)
#define CLASS_2_A5ECC652BC1D6C49_METHOD_2_DBE533A3E57F4B9C_OFFSET UNITYSDK_OFFSET(0x83FD7D0)
#define CLASS_2_A5ECC652BC1D6C49_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x83FD660)
#define CLASS_2_A5ECC652BC1D6C49_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x83FDA30)
#define CLASS_2_A5ECC652BC1D6C49_TICK_OFFSET UNITYSDK_OFFSET(0x83FDB40)
#define CLASS_2_A5ECC652BC1D6C49__CTOR_OFFSET UNITYSDK_OFFSET(0x83FD650)

inline static constexpr unsigned int Class_2_A5ECC652BC1D6C49_TypeDefinitionIndex = 45894;
