...
#define MOVIEGAMEASSETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x11201C60)

inline static constexpr unsigned int MovieGameAssetConfig_TypeDefinitionIndex = 37101;
