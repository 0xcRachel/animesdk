...
#define STRUCT_2_08DBFC9B3812777F_EQUALS_OFFSET UNITYSDK_OFFSET(0x1499DF0)
#define STRUCT_2_08DBFC9B3812777F_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1499E00)
#define STRUCT_2_08DBFC9B3812777F___IFIXBASEPROXY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1499E10)
