...
#define CLASS_2_9B00882C3B1056A9_DISPOSE_OFFSET UNITYSDK_OFFSET(0xFEDA5D0)
#define CLASS_2_9B00882C3B1056A9_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xFEDA610)
#define CLASS_2_9B00882C3B1056A9_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xFEDA660)
#define CLASS_2_9B00882C3B1056A9_TICK_OFFSET UNITYSDK_OFFSET(0xFEDA6B0)
#define CLASS_2_9B00882C3B1056A9__CTOR_OFFSET UNITYSDK_OFFSET(0xFEDA5C0)

inline static constexpr unsigned int Class_2_9B00882C3B1056A9_TypeDefinitionIndex = 44142;

class Class_2_9B00882C3B1056A9 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::ChessFireWaveProjectile* Field_2_0; // 0x20
