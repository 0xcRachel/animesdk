...
#define CLASS_2_BE2531E8103A0E9A_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCE4EDA0)
#define CLASS_2_BE2531E8103A0E9A_METHOD_2_0C0A3218A683115F_OFFSET UNITYSDK_OFFSET(0xCE512A0)
#define CLASS_2_BE2531E8103A0E9A_METHOD_2_28EB11670A8E5A86_OFFSET UNITYSDK_OFFSET(0xCE4F200)
#define CLASS_2_BE2531E8103A0E9A_METHOD_2_3368F1CBCE68D2D1_OFFSET UNITYSDK_OFFSET(0xCE51DB0)
#define CLASS_2_BE2531E8103A0E9A_METHOD_2_347814AF53FFFDEF_OFFSET UNITYSDK_OFFSET(0xCE51A70)
#define CLASS_2_BE2531E8103A0E9A_METHOD_2_3B258437A86233AC_OFFSET UNITYSDK_OFFSET(0xCE4F1B0)
#define CLASS_2_BE2531E8103A0E9A_METHOD_2_4D5E094CBA8FF21F_OFFSET UNITYSDK_OFFSET(0xCE521D0)
#define CLASS_2_BE2531E8103A0E9A_METHOD_2_5AFFA079DA8B20AA_OFFSET UNITYSDK_OFFSET(0xCE51C20)
#define CLASS_2_BE2531E8103A0E9A_METHOD_2_6792BDDE0B7A8419_OFFSET UNITYSDK_OFFSET(0xCE52680)
#define CLASS_2_BE2531E8103A0E9A_METHOD_2_6A704A44799D4069_OFFSET UNITYSDK_OFFSET(0xCE4EBE0)
#define CLASS_2_BE2531E8103A0E9A_METHOD_2_8735D14C38F2A99E_OFFSET UNITYSDK_OFFSET(0xCE52730)
#define CLASS_2_BE2531E8103A0E9A_METHOD_2_885DF4DA0F709E3E_OFFSET UNITYSDK_OFFSET(0xCE4EE10)
#define CLASS_2_BE2531E8103A0E9A_METHOD_2_90D019D81149A8BA_OFFSET UNITYSDK_OFFSET(0xCE52FE0)
#define CLASS_2_BE2531E8103A0E9A_METHOD_2_90EC931103FB6F31_OFFSET UNITYSDK_OFFSET(0xCE52F70)
#define CLASS_2_BE2531E8103A0E9A_METHOD_2_96E44500D1F491E7_OFFSET UNITYSDK_OFFSET(0xCE4F3A0)
#define CLASS_2_BE2531E8103A0E9A_METHOD_2_9E035F4BAE220AC2_OFFSET UNITYSDK_OFFSET(0xCE51C80)
#define CLASS_2_BE2531E8103A0E9A_METHOD_2_A4F4A9B75254E92D_OFFSET UNITYSDK_OFFSET(0xCE518F0)
#define CLASS_2_BE2531E8103A0E9A_METHOD_2_A745463C7F86C829_OFFSET UNITYSDK_OFFSET(0xCE4ED50)
#define CLASS_2_BE2531E8103A0E9A_METHOD_2_B1445E8504415D4D_OFFSET UNITYSDK_OFFSET(0xCE52F60)
#define CLASS_2_BE2531E8103A0E9A_METHOD_2_F41C701CD6A228A5_OFFSET UNITYSDK_OFFSET(0xCE51720)
#define CLASS_2_BE2531E8103A0E9A_METHOD_2_FA0119DD445A672F_OFFSET UNITYSDK_OFFSET(0xCE52CD0)
#define CLASS_2_BE2531E8103A0E9A_METHOD_2_FD2A5158841A130C_OFFSET UNITYSDK_OFFSET(0xCE52EC0)
#define CLASS_2_BE2531E8103A0E9A__CTOR_OFFSET UNITYSDK_OFFSET(0xCE52FD0)
#define CLASS_2_BE2531E8103A0E9A___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCE53050)
...
public:
	...
	{
		return (::System::Collections::Generic::List_1<::UnityEngine::Renderer*>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_BE2531E8103A0E9A_TypeDefinitionIndex)->GetStaticField(0x5C360);
	}
	static ::System::Collections::Generic::List_1<::AttachPointSet*>** StaticGet_Field_2_17()
	{
		return (::System::Collections::Generic::List_1<::AttachPointSet*>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_BE2531E8103A0E9A_TypeDefinitionIndex)->GetStaticField(0x5C368);
	}
	static ::System::Collections::Generic::List_1<::UnityEngine::MonoBehaviour*>** StaticGet_Field_2_16()
	{
		return (::System::Collections::Generic::List_1<::UnityEngine::MonoBehaviour*>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_BE2531E8103A0E9A_TypeDefinitionIndex)->GetStaticField(0x5C370);
	}
	::System::Collections::Generic::List_1<::UnityEngine::Renderer*>* Field_2_7; // 0x18
	::Class_1_9CBC71DC5240DC00* Field_2_4; // 0x20
	::UnityEngine::GameObject* Field_2_1; // 0x28
	::RPG::Client::FollowPointMapping* Field_2_14; // 0x30
	::RPG::Client::AttachPointMapping* Field_2_13; // 0x38
	::RPG::GameCore::GameEntity* Field_2_12; // 0x40
	::System::Collections::Generic::List_1<::UnityEngine::Material*>* Field_2_6; // 0x48
	::UnityEngine::Transform* Field_2_5; // 0x50
	::RPG::GameCore::CharacterOutfitComponent_CharacterOutfitInstance* Field_2_2; // 0x58
	::Il2CppArray<::RPG::Client::MonoEffectPluginCharaMaterialBlock*>* Field_2_15; // 0x60
	::Class_1_A0302E9AE0B8A2B9* Field_2_0; // 0x68
	::UnityEngine::Animator* Field_2_3; // 0x70
	::System::Single Field_2_10; // 0x78
	::System::Boolean Field_2_11; // 0x7C
	::System::Boolean Field_2_8; // 0x7D
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_2_BE2531E8103A0E9A_METHOD_2_3B258437A86233AC_OFFSET))(this);
	}
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_2_BE2531E8103A0E9A_METHOD_2_885DF4DA0F709E3E_OFFSET))(this);
	}
