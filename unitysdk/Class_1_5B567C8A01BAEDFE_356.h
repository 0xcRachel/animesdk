...
#define CLASS_1_5B567C8A01BAEDFE_356_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A8D0550)
#define CLASS_1_5B567C8A01BAEDFE_356_CLONE_OFFSET UNITYSDK_OFFSET(0x1A8D0360)
#define CLASS_1_5B567C8A01BAEDFE_356_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A8D0460)
#define CLASS_1_5B567C8A01BAEDFE_356_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A8D03D0)
#define CLASS_1_5B567C8A01BAEDFE_356_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A8D04B0)
#define CLASS_1_5B567C8A01BAEDFE_356_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A8D05A0)
#define CLASS_1_5B567C8A01BAEDFE_356_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A8D0570)
#define CLASS_1_5B567C8A01BAEDFE_356_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A8D02B0)
#define CLASS_1_5B567C8A01BAEDFE_356_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A8D0310)
#define CLASS_1_5B567C8A01BAEDFE_356_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A8D04E0)
#define CLASS_1_5B567C8A01BAEDFE_356_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A8D0540)
#define CLASS_1_5B567C8A01BAEDFE_356__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A8D05F0)
#define CLASS_1_5B567C8A01BAEDFE_356__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A8D0330)
#define CLASS_1_5B567C8A01BAEDFE_356__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8D0320)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_356*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_356_TypeDefinitionIndex)->GetStaticField(0x5D080);
	}
