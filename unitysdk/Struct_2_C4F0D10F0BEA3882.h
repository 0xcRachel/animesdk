...
#define STRUCT_2_C4F0D10F0BEA3882_GETCONTENTHASH_OFFSET UNITYSDK_OFFSET(0x200EDB0)
#define STRUCT_2_C4F0D10F0BEA3882_GETDOWNLOADRELATIVEBUNDLELOADPATH_OFFSET UNITYSDK_OFFSET(0x200EE60)
#define STRUCT_2_C4F0D10F0BEA3882_GETFILESIZE_OFFSET UNITYSDK_OFFSET(0x200ED60)
#define STRUCT_2_C4F0D10F0BEA3882_GETLOADRELATIVEBUNDLELOADPATH_OFFSET UNITYSDK_OFFSET(0x200EEF0)
#define STRUCT_2_C4F0D10F0BEA3882_GET_SUBPACKID_OFFSET UNITYSDK_OFFSET(0x68F0)
#define STRUCT_2_C4F0D10F0BEA3882_ISNEEDWRITECONTENTHASHFILE_OFFSET UNITYSDK_OFFSET(0x200EF00)
#define STRUCT_2_C4F0D10F0BEA3882_ISPATCH_OFFSET UNITYSDK_OFFSET(0x200EC10)
#define STRUCT_2_C4F0D10F0BEA3882_ISTMPFILENAMEADDFILEHASH_OFFSET UNITYSDK_OFFSET(0x200ED10)
#define STRUCT_2_C4F0D10F0BEA3882_METHOD_2_ECA28171EB4172FF_OFFSET UNITYSDK_OFFSET(0x200EE10)
#define STRUCT_2_C4F0D10F0BEA3882_SET_SUBPACKID_OFFSET UNITYSDK_OFFSET(0x26F0)
#define STRUCT_2_C4F0D10F0BEA3882_TOSTRING_OFFSET UNITYSDK_OFFSET(0x200EF50)
#define STRUCT_2_C4F0D10F0BEA3882___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x200EF60)

inline static constexpr unsigned int Struct_2_C4F0D10F0BEA3882_TypeDefinitionIndex = 31190;
...
struct alignas(4) Struct_2_C4F0D10F0BEA3882
{
	...
	{
		return ((::System::String*(*)(::PVOID))((::PBYTE)hIl2Cpp + STRUCT_2_C4F0D10F0BEA3882_METHOD_2_ECA28171EB4172FF_OFFSET))(this);
	}
