...
#define CLASS_1_D3CC73B16B410533_CLEAR_OFFSET UNITYSDK_OFFSET(0x17C82700)
#define CLASS_1_D3CC73B16B410533_ONALLOC_OFFSET UNITYSDK_OFFSET(0x17C82820)
#define CLASS_1_D3CC73B16B410533_ONRECYCLE_OFFSET UNITYSDK_OFFSET(0x17C82870)
#define CLASS_1_D3CC73B16B410533__CTOR_OFFSET UNITYSDK_OFFSET(0x17C828C0)
...
public:
	...
	::RPG::GameCore::LevelTriggerInfo* Field_1_1; // 0xA8
	::RPG::GCFreeClosure::FuncClosureR_2<::UnityEngine::Collider*, ::System::Boolean> Field_1_5; // 0xB0
	::System::String* Field_1_0; // 0x140
	::Struct_2_09B45CBFDAC5DA07 Field_1_3; // 0x148
	::Class_0_16E4307DCC419505_217* Field_1_2; // 0x168
