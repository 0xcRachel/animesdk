...
#define CLASS_3_E4A99C336B62C867_METHOD_3_73FB9DE4849AF1B5_OFFSET UNITYSDK_OFFSET(0x148B2E00)
#define CLASS_3_E4A99C336B62C867__CTOR_OFFSET UNITYSDK_OFFSET(0x148B2BF0)
#define CLASS_3_E4A99C336B62C867__REGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x148B2F00)
#define CLASS_3_E4A99C336B62C867__UNREGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x148B3040)
#define CLASS_3_E4A99C336B62C867___IFIXBASEPROXY__REGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x148B3170)
#define CLASS_3_E4A99C336B62C867___IFIXBASEPROXY__UNREGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x148B3180)
