...
#define CLASS_1_126415C60CEDDA17_1_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1B065290)
#define CLASS_1_126415C60CEDDA17_1_CLONE_OFFSET UNITYSDK_OFFSET(0x1B064F90)
#define CLASS_1_126415C60CEDDA17_1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1B065100)
#define CLASS_1_126415C60CEDDA17_1_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B065050)
#define CLASS_1_126415C60CEDDA17_1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B065170)
#define CLASS_1_126415C60CEDDA17_1_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1B0653D0)
#define CLASS_1_126415C60CEDDA17_1_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1B065390)
#define CLASS_1_126415C60CEDDA17_1_METHOD_1_3163C288F3AE2966_OFFSET UNITYSDK_OFFSET(0x1B065040)
#define CLASS_1_126415C60CEDDA17_1_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1B064ED0)
#define CLASS_1_126415C60CEDDA17_1_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1B065020)
#define CLASS_1_126415C60CEDDA17_1_METHOD_1_CE81D059476B1F49_OFFSET UNITYSDK_OFFSET(0x1B065030)
#define CLASS_1_126415C60CEDDA17_1_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1B065010)
#define CLASS_1_126415C60CEDDA17_1_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1B064F30)
#define CLASS_1_126415C60CEDDA17_1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B0651B0)
#define CLASS_1_126415C60CEDDA17_1_WRITETO_OFFSET UNITYSDK_OFFSET(0x1B065210)
#define CLASS_1_126415C60CEDDA17_1__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B065550)
#define CLASS_1_126415C60CEDDA17_1__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B064F50)
#define CLASS_1_126415C60CEDDA17_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1B064F40)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_126415C60CEDDA17_1*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_126415C60CEDDA17_1_TypeDefinitionIndex)->GetStaticField(0x629D0);
	}
