...
#define CLASS_2_0107C8345F1C32B7_GET_CURRENTACTIVITYDATA_OFFSET UNITYSDK_OFFSET(0x1423DF90)
#define CLASS_2_0107C8345F1C32B7_METHOD_2_64B6514CFF8F8D76_OFFSET UNITYSDK_OFFSET(0x1423DE90)
#define CLASS_2_0107C8345F1C32B7_METHOD_2_83DA3EC57FF907F4_OFFSET UNITYSDK_OFFSET(0x1423DEF0)
#define CLASS_2_0107C8345F1C32B7_SET_CURRENTACTIVITYDATA_OFFSET UNITYSDK_OFFSET(0x1423DFA0)
#define CLASS_2_0107C8345F1C32B7__CTOR_OFFSET UNITYSDK_OFFSET(0x1423DFB0)

inline static constexpr unsigned int Class_2_0107C8345F1C32B7_TypeDefinitionIndex = 69471;
