...
#define CLASS_1_5B567C8A01BAEDFE_126_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A257740)
#define CLASS_1_5B567C8A01BAEDFE_126_CLONE_OFFSET UNITYSDK_OFFSET(0x1A2575B0)
#define CLASS_1_5B567C8A01BAEDFE_126_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A257650)
#define CLASS_1_5B567C8A01BAEDFE_126_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A2575F0)
#define CLASS_1_5B567C8A01BAEDFE_126_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A2576A0)
#define CLASS_1_5B567C8A01BAEDFE_126_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A257790)
#define CLASS_1_5B567C8A01BAEDFE_126_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A257760)
#define CLASS_1_5B567C8A01BAEDFE_126_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A257530)
#define CLASS_1_5B567C8A01BAEDFE_126_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A257560)
#define CLASS_1_5B567C8A01BAEDFE_126_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A2576D0)
#define CLASS_1_5B567C8A01BAEDFE_126_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A257730)
#define CLASS_1_5B567C8A01BAEDFE_126__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A2577E0)
#define CLASS_1_5B567C8A01BAEDFE_126__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A257580)
#define CLASS_1_5B567C8A01BAEDFE_126__CTOR_OFFSET UNITYSDK_OFFSET(0x1A257570)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_126*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_126_TypeDefinitionIndex)->GetStaticField(0x1C6A0);
	}
