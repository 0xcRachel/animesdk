...
#define TA_LOCALLIGHTTEST_START_OFFSET UNITYSDK_OFFSET(0xE19FF30)
#define TA_LOCALLIGHTTEST_UPDATE_OFFSET UNITYSDK_OFFSET(0xE19FF80)
#define TA_LOCALLIGHTTEST__CTOR_OFFSET UNITYSDK_OFFSET(0xE1A0100)
