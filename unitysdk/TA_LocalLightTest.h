...
#define TA_LOCALLIGHTTEST_START_OFFSET UNITYSDK_OFFSET(0xE27B940)
#define TA_LOCALLIGHTTEST_UPDATE_OFFSET UNITYSDK_OFFSET(0xE27B990)
#define TA_LOCALLIGHTTEST__CTOR_OFFSET UNITYSDK_OFFSET(0xE27BB10)
