...
#define TA_LOCALLIGHTTEST_START_OFFSET UNITYSDK_OFFSET(0xAC32DA0)
#define TA_LOCALLIGHTTEST_UPDATE_OFFSET UNITYSDK_OFFSET(0xAC32DF0)
#define TA_LOCALLIGHTTEST__CTOR_OFFSET UNITYSDK_OFFSET(0xAC32F70)
