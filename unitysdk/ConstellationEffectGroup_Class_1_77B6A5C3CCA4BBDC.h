...
#define CONSTELLATIONEFFECTGROUP_CLASS_1_77B6A5C3CCA4BBDC_METHOD_1_248C354FAAB50CEE_OFFSET UNITYSDK_OFFSET(0x996D080)
#define CONSTELLATIONEFFECTGROUP_CLASS_1_77B6A5C3CCA4BBDC_METHOD_1_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x996CC20)
#define CONSTELLATIONEFFECTGROUP_CLASS_1_77B6A5C3CCA4BBDC__CTOR_OFFSET UNITYSDK_OFFSET(0x996D070)

inline static constexpr unsigned int ConstellationEffectGroup_Class_1_77B6A5C3CCA4BBDC_TypeDefinitionIndex = 37268;
