...
#define SPINESKELETONFLIPBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x17BEB1A0)

inline static constexpr unsigned int SpineSkeletonFlipBehaviour_TypeDefinitionIndex = 34132;
