...
#define CLASS_1_D09F4FAB9C64FEFA_CLEAR_OFFSET UNITYSDK_OFFSET(0x10AF2750)
#define CLASS_1_D09F4FAB9C64FEFA_METHOD_1_95EC9293FD439850_OFFSET UNITYSDK_OFFSET(0x10AF2510)
#define CLASS_1_D09F4FAB9C64FEFA_METHOD_1_D240830C442C70A4_OFFSET UNITYSDK_OFFSET(0x10AF2670)
#define CLASS_1_D09F4FAB9C64FEFA__CTOR_OFFSET UNITYSDK_OFFSET(0x10AF2840)

inline static constexpr unsigned int Class_1_D09F4FAB9C64FEFA_TypeDefinitionIndex = 68076;

class Class_1_D09F4FAB9C64FEFA : public ::System::Object
{
public:
	::Class_0_16E4307DCC419505_1038* Field_1_1; // 0x10
	::Class_0_16E4307DCC419505_1036* Field_1_2; // 0x18
