...
#define CLASS_1_5B567C8A01BAEDFE_155_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1B2C32D0)
#define CLASS_1_5B567C8A01BAEDFE_155_CLONE_OFFSET UNITYSDK_OFFSET(0x1B2C30E0)
#define CLASS_1_5B567C8A01BAEDFE_155_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1B2C31E0)
#define CLASS_1_5B567C8A01BAEDFE_155_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B2C3150)
#define CLASS_1_5B567C8A01BAEDFE_155_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B2C3230)
#define CLASS_1_5B567C8A01BAEDFE_155_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1B2C3320)
#define CLASS_1_5B567C8A01BAEDFE_155_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1B2C32F0)
#define CLASS_1_5B567C8A01BAEDFE_155_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1B2C3030)
#define CLASS_1_5B567C8A01BAEDFE_155_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1B2C3090)
#define CLASS_1_5B567C8A01BAEDFE_155_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B2C3260)
#define CLASS_1_5B567C8A01BAEDFE_155_WRITETO_OFFSET UNITYSDK_OFFSET(0x1B2C32C0)
#define CLASS_1_5B567C8A01BAEDFE_155__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B2C3370)
#define CLASS_1_5B567C8A01BAEDFE_155__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B2C30B0)
#define CLASS_1_5B567C8A01BAEDFE_155__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2C30A0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_155*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_155_TypeDefinitionIndex)->GetStaticField(0x13500);
	}
