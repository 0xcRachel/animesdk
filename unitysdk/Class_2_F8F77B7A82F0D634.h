...
#define CLASS_2_F8F77B7A82F0D634_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14993260)
#define CLASS_2_F8F77B7A82F0D634_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x149932D0)
#define CLASS_2_F8F77B7A82F0D634_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x149934C0)
#define CLASS_2_F8F77B7A82F0D634_TICK_OFFSET UNITYSDK_OFFSET(0x14993510)
#define CLASS_2_F8F77B7A82F0D634__CTOR_OFFSET UNITYSDK_OFFSET(0x149931A0)
