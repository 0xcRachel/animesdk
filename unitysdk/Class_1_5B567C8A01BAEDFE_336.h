...
#define CLASS_1_5B567C8A01BAEDFE_336_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A1E8250)
#define CLASS_1_5B567C8A01BAEDFE_336_CLONE_OFFSET UNITYSDK_OFFSET(0x1A1E8060)
#define CLASS_1_5B567C8A01BAEDFE_336_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A1E8160)
#define CLASS_1_5B567C8A01BAEDFE_336_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A1E80D0)
#define CLASS_1_5B567C8A01BAEDFE_336_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A1E81B0)
#define CLASS_1_5B567C8A01BAEDFE_336_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A1E82A0)
#define CLASS_1_5B567C8A01BAEDFE_336_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A1E8270)
#define CLASS_1_5B567C8A01BAEDFE_336_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A1E7FB0)
#define CLASS_1_5B567C8A01BAEDFE_336_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A1E8010)
#define CLASS_1_5B567C8A01BAEDFE_336_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A1E81E0)
#define CLASS_1_5B567C8A01BAEDFE_336_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A1E8240)
#define CLASS_1_5B567C8A01BAEDFE_336__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1E82F0)
#define CLASS_1_5B567C8A01BAEDFE_336__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A1E8030)
#define CLASS_1_5B567C8A01BAEDFE_336__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1E8020)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_336*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_336_TypeDefinitionIndex)->GetStaticField(0x11B30);
	}
