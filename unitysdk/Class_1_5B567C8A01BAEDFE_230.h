...
#define CLASS_1_5B567C8A01BAEDFE_230_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A3EBB30)
#define CLASS_1_5B567C8A01BAEDFE_230_CLONE_OFFSET UNITYSDK_OFFSET(0x1A3EB9A0)
#define CLASS_1_5B567C8A01BAEDFE_230_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A3EBA40)
#define CLASS_1_5B567C8A01BAEDFE_230_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A3EB9E0)
#define CLASS_1_5B567C8A01BAEDFE_230_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A3EBA90)
#define CLASS_1_5B567C8A01BAEDFE_230_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A3EBB80)
#define CLASS_1_5B567C8A01BAEDFE_230_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A3EBB50)
#define CLASS_1_5B567C8A01BAEDFE_230_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A3EB920)
#define CLASS_1_5B567C8A01BAEDFE_230_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A3EB950)
#define CLASS_1_5B567C8A01BAEDFE_230_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A3EBAC0)
#define CLASS_1_5B567C8A01BAEDFE_230_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A3EBB20)
#define CLASS_1_5B567C8A01BAEDFE_230__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A3EBBD0)
#define CLASS_1_5B567C8A01BAEDFE_230__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3EB970)
#define CLASS_1_5B567C8A01BAEDFE_230__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3EB960)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_230*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_230_TypeDefinitionIndex)->GetStaticField(0x53040);
	}
