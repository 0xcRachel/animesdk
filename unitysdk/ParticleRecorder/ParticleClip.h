...
#define PARTICLERECORDER_PARTICLECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1635FAF0)

namespace ParticleRecorder
{
	inline static constexpr unsigned int ParticleClip_TypeDefinitionIndex = 28258;
