...
#define CLASS_1_AF85D707C83D7C65_METHOD_1_5BD54ACACE8B2D70_OFFSET UNITYSDK_OFFSET(0x169F4BB0)
#define CLASS_1_AF85D707C83D7C65_METHOD_1_A0160E598AC4DBB4_OFFSET UNITYSDK_OFFSET(0x169F4B20)
#define CLASS_1_AF85D707C83D7C65__CTOR_OFFSET UNITYSDK_OFFSET(0x169F4C70)
...
{
public:
	::System::Collections::Generic::Dictionary_2<::Class_2_9C2F1FCEC1A75FFD*, ::RPG::Client::LittleGame::FourRotateVoxel::FourRotateVoxelGameViewCoord>* Field_1_2; // 0x10
	::Class_1_9B467A75B352C0A6* Field_1_4; // 0x18
	::UnityEngine::GameObject* Field_1_0; // 0x20
	::System::Collections::Generic::Dictionary_2<::RPG::Client::LittleGame::FourRotateVoxel::FourRotateVoxelGameViewCoord, ::System::Collections::Generic::List_1<::Class_2_9C2F1FCEC1A75FFD*>*>* Field_1_3; // 0x28
	::System::Collections::Generic::Dictionary_2<::RPG::Client::LittleGame::FourRotateVoxel::FourRotateVoxelLayerType, ::Class_3_79A4F66B82C02A5E*>* Field_1_1; // 0x30
