...
#define CLASS_1_F65FD1783A40C6D8_METHOD_1_42372DAD677984CB_OFFSET UNITYSDK_OFFSET(0x10B74090)
#define CLASS_1_F65FD1783A40C6D8_METHOD_1_4A470AFF92134627_OFFSET UNITYSDK_OFFSET(0x10B73A70)
#define CLASS_1_F65FD1783A40C6D8_METHOD_1_5FD4F0CCAF05C452_OFFSET UNITYSDK_OFFSET(0x10B73BB0)
#define CLASS_1_F65FD1783A40C6D8_METHOD_1_63ACC0D27D3459FE_OFFSET UNITYSDK_OFFSET(0x10B73D70)
#define CLASS_1_F65FD1783A40C6D8_METHOD_1_8F7825DAFFB9B517_OFFSET UNITYSDK_OFFSET(0x10B73FD0)
#define CLASS_1_F65FD1783A40C6D8_METHOD_1_BB93C69D78C65A48_1_OFFSET UNITYSDK_OFFSET(0x10B73ED0)
#define CLASS_1_F65FD1783A40C6D8_METHOD_1_BB93C69D78C65A48_2_OFFSET UNITYSDK_OFFSET(0x10B73F50)
#define CLASS_1_F65FD1783A40C6D8_METHOD_1_BB93C69D78C65A48_OFFSET UNITYSDK_OFFSET(0x10B73E40)
#define CLASS_1_F65FD1783A40C6D8_METHOD_1_C08FF17A469FA820_OFFSET UNITYSDK_OFFSET(0x10B73500)
#define CLASS_1_F65FD1783A40C6D8_METHOD_1_C69A20389C87A4E6_OFFSET UNITYSDK_OFFSET(0x10B73310)
#define CLASS_1_F65FD1783A40C6D8__CTOR_OFFSET UNITYSDK_OFFSET(0x10B73AB0)

inline static constexpr unsigned int Class_1_F65FD1783A40C6D8_TypeDefinitionIndex = 62063;

class Class_1_F65FD1783A40C6D8 : public ::System::Object
{
public:
	::RPG::Client::ChenLingBattle::IGamePhase* Field_1_2; // 0x10
	::RPG::Client::ChenLingBattle::IGamePhase* Field_1_3; // 0x18
	::RPG::Client::ChenLingBattle::ChenLingBattleGameContext* Field_1_6; // 0x20
	::System::Collections::Generic::Dictionary_2<::System::Type*, ::RPG::Client::ChenLingBattle::IGamePhase*>* Field_1_4; // 0x28
	::RPG::Client::ChenLingBattle::IGamePhase* Field_1_1; // 0x30
	::System::Collections::Generic::Queue_1<::Class_1_F65FD1783A40C6D8_Class_1_F9D0D949D4DE2864*>* Field_1_5; // 0x38
