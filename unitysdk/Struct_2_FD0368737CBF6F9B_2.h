...
#define STRUCT_2_FD0368737CBF6F9B_2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1496C50)
#define STRUCT_2_FD0368737CBF6F9B_2__CTOR_OFFSET UNITYSDK_OFFSET(0x29130)
#define STRUCT_2_FD0368737CBF6F9B_2___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1496CB0)
