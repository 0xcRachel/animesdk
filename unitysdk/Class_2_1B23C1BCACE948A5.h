...
#define CLASS_2_1B23C1BCACE948A5_METHOD_2_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0xF5C6D40)
#define CLASS_2_1B23C1BCACE948A5_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xF5C6CE0)
#define CLASS_2_1B23C1BCACE948A5_METHOD_2_67D41ACFEF39E84E_OFFSET UNITYSDK_OFFSET(0xF5C5D10)
#define CLASS_2_1B23C1BCACE948A5_METHOD_2_7DFB4B9C80198D98_OFFSET UNITYSDK_OFFSET(0xF5C6DA0)
#define CLASS_2_1B23C1BCACE948A5_METHOD_2_861970C5F2C21AB2_OFFSET UNITYSDK_OFFSET(0xF5C6BD0)
#define CLASS_2_1B23C1BCACE948A5_METHOD_2_A52062643A2DBAD8_OFFSET UNITYSDK_OFFSET(0xF5C61F0)
#define CLASS_2_1B23C1BCACE948A5_METHOD_2_C2245EC58D417830_OFFSET UNITYSDK_OFFSET(0xF5C63B0)
#define CLASS_2_1B23C1BCACE948A5_METHOD_2_CD8EB704BDED69B6_OFFSET UNITYSDK_OFFSET(0xF5C5CA0)
#define CLASS_2_1B23C1BCACE948A5_METHOD_2_DF249C0E36759C3F_OFFSET UNITYSDK_OFFSET(0xF5C6510)
#define CLASS_2_1B23C1BCACE948A5_METHOD_2_E07992F850E8E0FD_OFFSET UNITYSDK_OFFSET(0xF5C6600)
#define CLASS_2_1B23C1BCACE948A5__CTOR_OFFSET UNITYSDK_OFFSET(0xF5C5BC0)

inline static constexpr unsigned int Class_2_1B23C1BCACE948A5_TypeDefinitionIndex = 50501;

class Class_2_1B23C1BCACE948A5 : public ::Class_1_1835888C1E19F013
{
public:
	::UnityEngine::Collider* Field_2_8; // 0x48
	::RPG::GameCore::MonoProjectileBGCurve* Field_2_2; // 0x50
	::RPG::GameCore::BGCurveWithDetectProjectileData* Field_2_0; // 0x58
