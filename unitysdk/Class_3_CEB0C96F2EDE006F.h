...
#define CLASS_3_CEB0C96F2EDE006F_DISPOSE_OFFSET UNITYSDK_OFFSET(0xFF5D430)
#define CLASS_3_CEB0C96F2EDE006F_METHOD_3_16D69031357DF4E3_OFFSET UNITYSDK_OFFSET(0xFF5DA60)
#define CLASS_3_CEB0C96F2EDE006F_METHOD_3_E73C5CB2668778E1_OFFSET UNITYSDK_OFFSET(0xFF5D900)
#define CLASS_3_CEB0C96F2EDE006F_ONAFTERMODELARTLOAD_OFFSET UNITYSDK_OFFSET(0xFF5D650)
#define CLASS_3_CEB0C96F2EDE006F_ONBEFOREMODELARTUNLOAD_OFFSET UNITYSDK_OFFSET(0xFF5D880)
#define CLASS_3_CEB0C96F2EDE006F__CTOR_OFFSET UNITYSDK_OFFSET(0xFF5D200)
#define CLASS_3_CEB0C96F2EDE006F__PREPAREDATA_OFFSET UNITYSDK_OFFSET(0xFF5D480)
#define CLASS_3_CEB0C96F2EDE006F__REGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0xFF5D560)
#define CLASS_3_CEB0C96F2EDE006F__UNREGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0xFF5D800)
#define CLASS_3_CEB0C96F2EDE006F___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xFF5DBB0)
#define CLASS_3_CEB0C96F2EDE006F___IFIXBASEPROXY__PREPAREDATA_OFFSET UNITYSDK_OFFSET(0xFF5DC00)
#define CLASS_3_CEB0C96F2EDE006F___IFIXBASEPROXY__REGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0xFF5DC10)
#define CLASS_3_CEB0C96F2EDE006F___IFIXBASEPROXY__UNREGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0xFF5DC20)
