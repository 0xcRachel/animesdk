...
#define CLASS_2_D2681DB6C8736FD7_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8587F20)
#define CLASS_2_D2681DB6C8736FD7_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x8587F60)
#define CLASS_2_D2681DB6C8736FD7_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x8588130)
#define CLASS_2_D2681DB6C8736FD7_TICK_OFFSET UNITYSDK_OFFSET(0x8588180)
#define CLASS_2_D2681DB6C8736FD7__CTOR_OFFSET UNITYSDK_OFFSET(0x8587F10)

inline static constexpr unsigned int Class_2_D2681DB6C8736FD7_TypeDefinitionIndex = 41576;
