...
#define CLASS_2_FC72C0D3E1F3C11B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x969F730)
#define CLASS_2_FC72C0D3E1F3C11B_GET_ANIMMOTIONDELTA_OFFSET UNITYSDK_OFFSET(0x96A0BF0)
#define CLASS_2_FC72C0D3E1F3C11B_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x969F3B0)
#define CLASS_2_FC72C0D3E1F3C11B_METHOD_2_068E873219CBBD31_OFFSET UNITYSDK_OFFSET(0x969F420)
#define CLASS_2_FC72C0D3E1F3C11B_METHOD_2_06CACEC01F21D60D_OFFSET UNITYSDK_OFFSET(0x969F890)
#define CLASS_2_FC72C0D3E1F3C11B_METHOD_2_2C6826E6663451CE_OFFSET UNITYSDK_OFFSET(0x96A0C20)
#define CLASS_2_FC72C0D3E1F3C11B_METHOD_2_34D5F4DBE622AF88_OFFSET UNITYSDK_OFFSET(0x969ECC0)
#define CLASS_2_FC72C0D3E1F3C11B_METHOD_2_90EC931103FB6F31_OFFSET UNITYSDK_OFFSET(0x96A0CC0)
#define CLASS_2_FC72C0D3E1F3C11B_METHOD_2_9F5EFD520A4A7427_OFFSET UNITYSDK_OFFSET(0x96A0B80)
#define CLASS_2_FC72C0D3E1F3C11B_METHOD_2_ACCAF16FF481A760_OFFSET UNITYSDK_OFFSET(0x96A04C0)
#define CLASS_2_FC72C0D3E1F3C11B_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x969F330)
#define CLASS_2_FC72C0D3E1F3C11B_METHOD_2_EAFCF37287F5ED1C_OFFSET UNITYSDK_OFFSET(0x96A08B0)
#define CLASS_2_FC72C0D3E1F3C11B_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x969ECB0)
#define CLASS_2_FC72C0D3E1F3C11B_METHOD_2_F6C3D22EF930EB92_OFFSET UNITYSDK_OFFSET(0x969FD60)
#define CLASS_2_FC72C0D3E1F3C11B_SET_ANIMMOTIONDELTA_OFFSET UNITYSDK_OFFSET(0x96A0C10)
#define CLASS_2_FC72C0D3E1F3C11B_TICK_OFFSET UNITYSDK_OFFSET(0x969EA00)
#define CLASS_2_FC72C0D3E1F3C11B__CTOR_OFFSET UNITYSDK_OFFSET(0x96A0D20)
#define CLASS_2_FC72C0D3E1F3C11B___IFIXBASEPROXY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x96A0EA0)
#define CLASS_2_FC72C0D3E1F3C11B___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x96A0E90)

inline static constexpr unsigned int Class_2_FC72C0D3E1F3C11B_TypeDefinitionIndex = 45392;

class Class_2_FC72C0D3E1F3C11B : public ::RPG::GameCore::GameComponentBase
{
public:
	::Class_1_D62C2C8EAA687B3C* Field_2_4; // 0x18
	::Class_1_E856DAA70D46D1F2* Field_2_2; // 0x20
	::System::String* Field_2_6; // 0x28
	::System::String* Field_2_0; // 0x30
	::RPG::GameCore::GameEntity* Field_2_3; // 0x38
	::Class_1_D27BF54F25500E5F* Field_2_15; // 0x40
	::Class_1_E856DAA70D46D1F2* Field_2_7; // 0x48
	::RPG::MVector3 _AnimMotionDelta_k__BackingField; // 0x50
	...
	::RPG::GameCore::StringHash Field_2_10; // 0x88
