...
#define CLASS_2_FC72C0D3E1F3C11B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x154FDF10)
#define CLASS_2_FC72C0D3E1F3C11B_GET_ANIMMOTIONDELTA_OFFSET UNITYSDK_OFFSET(0x154FF430)
#define CLASS_2_FC72C0D3E1F3C11B_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x154FDB90)
#define CLASS_2_FC72C0D3E1F3C11B_METHOD_2_068E873219CBBD31_OFFSET UNITYSDK_OFFSET(0x154FDC00)
#define CLASS_2_FC72C0D3E1F3C11B_METHOD_2_06CACEC01F21D60D_OFFSET UNITYSDK_OFFSET(0x154FE080)
#define CLASS_2_FC72C0D3E1F3C11B_METHOD_2_2C6826E6663451CE_OFFSET UNITYSDK_OFFSET(0x154FF460)
#define CLASS_2_FC72C0D3E1F3C11B_METHOD_2_34D5F4DBE622AF88_OFFSET UNITYSDK_OFFSET(0x154FD4B0)
#define CLASS_2_FC72C0D3E1F3C11B_METHOD_2_90EC931103FB6F31_OFFSET UNITYSDK_OFFSET(0x154FF500)
#define CLASS_2_FC72C0D3E1F3C11B_METHOD_2_9F5EFD520A4A7427_OFFSET UNITYSDK_OFFSET(0x154FF3C0)
#define CLASS_2_FC72C0D3E1F3C11B_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x154FDB10)
#define CLASS_2_FC72C0D3E1F3C11B_METHOD_2_D51EA2E667E14074_OFFSET UNITYSDK_OFFSET(0x154FECD0)
#define CLASS_2_FC72C0D3E1F3C11B_METHOD_2_EAFCF37287F5ED1C_OFFSET UNITYSDK_OFFSET(0x154FF0F0)
#define CLASS_2_FC72C0D3E1F3C11B_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x154FD4A0)
#define CLASS_2_FC72C0D3E1F3C11B_METHOD_2_F6C3D22EF930EB92_OFFSET UNITYSDK_OFFSET(0x154FE580)
#define CLASS_2_FC72C0D3E1F3C11B_SET_ANIMMOTIONDELTA_OFFSET UNITYSDK_OFFSET(0x154FF450)
#define CLASS_2_FC72C0D3E1F3C11B_TICK_OFFSET UNITYSDK_OFFSET(0x154FD1F0)
#define CLASS_2_FC72C0D3E1F3C11B__CTOR_OFFSET UNITYSDK_OFFSET(0x154FF560)
#define CLASS_2_FC72C0D3E1F3C11B___IFIXBASEPROXY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x154FF6E0)
#define CLASS_2_FC72C0D3E1F3C11B___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x154FF6D0)
...
{
public:
	::Class_1_D27BF54F25500E5F* Field_2_0; // 0x18
	::System::String* Field_2_1; // 0x20
	::Class_1_E856DAA70D46D1F2* Field_2_2; // 0x28
	::RPG::GameCore::GameEntity* Field_2_3; // 0x30
	::Class_1_E856DAA70D46D1F2* Field_2_4; // 0x38
	::Class_1_CA0A06DCFA703F36* Field_2_5; // 0x40
	...
	::RPG::MVector3 _AnimMotionDelta_k__BackingField; // 0x70
