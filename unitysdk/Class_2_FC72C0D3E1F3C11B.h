...
#define CLASS_2_FC72C0D3E1F3C11B_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCB23CB0)
#define CLASS_2_FC72C0D3E1F3C11B_GET_ANIMMOTIONDELTA_OFFSET UNITYSDK_OFFSET(0xCB249F0)
#define CLASS_2_FC72C0D3E1F3C11B_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xCB23930)
#define CLASS_2_FC72C0D3E1F3C11B_METHOD_2_068E873219CBBD31_OFFSET UNITYSDK_OFFSET(0xCB239A0)
#define CLASS_2_FC72C0D3E1F3C11B_METHOD_2_06CACEC01F21D60D_OFFSET UNITYSDK_OFFSET(0xCB23E10)
#define CLASS_2_FC72C0D3E1F3C11B_METHOD_2_2C6826E6663451CE_OFFSET UNITYSDK_OFFSET(0xCB24A20)
#define CLASS_2_FC72C0D3E1F3C11B_METHOD_2_368884BBCA3D2697_OFFSET UNITYSDK_OFFSET(0xCB23230)
#define CLASS_2_FC72C0D3E1F3C11B_METHOD_2_90EC931103FB6F31_OFFSET UNITYSDK_OFFSET(0xCB24B40)
#define CLASS_2_FC72C0D3E1F3C11B_METHOD_2_9F5EFD520A4A7427_OFFSET UNITYSDK_OFFSET(0xCB24980)
#define CLASS_2_FC72C0D3E1F3C11B_METHOD_2_ACCAF16FF481A760_OFFSET UNITYSDK_OFFSET(0xCB242D0)
#define CLASS_2_FC72C0D3E1F3C11B_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xCB238B0)
#define CLASS_2_FC72C0D3E1F3C11B_METHOD_2_EAFCF37287F5ED1C_OFFSET UNITYSDK_OFFSET(0xCB246B0)
#define CLASS_2_FC72C0D3E1F3C11B_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xCB23220)
#define CLASS_2_FC72C0D3E1F3C11B_METHOD_2_F6C3D22EF930EB92_OFFSET UNITYSDK_OFFSET(0xCB1FA50)
#define CLASS_2_FC72C0D3E1F3C11B_SET_ANIMMOTIONDELTA_OFFSET UNITYSDK_OFFSET(0xCB24A10)
#define CLASS_2_FC72C0D3E1F3C11B_TICK_OFFSET UNITYSDK_OFFSET(0xCB22F70)
#define CLASS_2_FC72C0D3E1F3C11B__CTOR_OFFSET UNITYSDK_OFFSET(0xCB24BA0)
#define CLASS_2_FC72C0D3E1F3C11B___IFIXBASEPROXY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xCB24D30)
#define CLASS_2_FC72C0D3E1F3C11B___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0xCB24D20)
...
public:
	...
	::Class_1_D62C2C8EAA687B3C* Field_2_4; // 0x30
	::Class_1_D27BF54F25500E5F* Field_2_15; // 0x38
	::Class_1_E856DAA70D46D1F2* Field_2_7; // 0x40
	::Class_1_E856DAA70D46D1F2* Field_2_2; // 0x48
	::RPG::MVector3 _AnimMotionDelta_k__BackingField; // 0x50
	::System::Int32 Field_2_5; // 0x5C
	::RPG::GameCore::StringHash Field_2_10; // 0x60
