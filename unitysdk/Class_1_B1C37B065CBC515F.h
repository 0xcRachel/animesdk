...
#define CLASS_1_B1C37B065CBC515F_GET_ATKSKILLIDLIST_OFFSET UNITYSDK_OFFSET(0xE15DB40)
#define CLASS_1_B1C37B065CBC515F_GET_ENHANCEMENTS_OFFSET UNITYSDK_OFFSET(0xE15DBA0)
#define CLASS_1_B1C37B065CBC515F_GET_EXTRAADDSKILLIDLIST_OFFSET UNITYSDK_OFFSET(0xE15DB60)
#define CLASS_1_B1C37B065CBC515F_GET_INITPOSITION_OFFSET UNITYSDK_OFFSET(0xE15DA10)
#define CLASS_1_B1C37B065CBC515F_GET_ISPROMOTED_OFFSET UNITYSDK_OFFSET(0xE15DB80)
#define CLASS_1_B1C37B065CBC515F_GET_ISRANGEATTACK_OFFSET UNITYSDK_OFFSET(0xE15DB00)
#define CLASS_1_B1C37B065CBC515F_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xE15D900)
#define CLASS_1_B1C37B065CBC515F_GET_MODELPATH_OFFSET UNITYSDK_OFFSET(0xE15DAE0)
#define CLASS_1_B1C37B065CBC515F_GET_OVERRIDEMATERIALPATH_OFFSET UNITYSDK_OFFSET(0xE15DBC0)
#define CLASS_1_B1C37B065CBC515F_GET_RECOMMENDEDGRIDINDEX_OFFSET UNITYSDK_OFFSET(0xE15DC00)
#define CLASS_1_B1C37B065CBC515F_GET_SKILLIDLIST_OFFSET UNITYSDK_OFFSET(0xE15DB20)
#define CLASS_1_B1C37B065CBC515F_GET_SOLDIERID_OFFSET UNITYSDK_OFFSET(0xE15D8E0)
#define CLASS_1_B1C37B065CBC515F_GET_TEAMTYPE_OFFSET UNITYSDK_OFFSET(0xE15D970)
#define CLASS_1_B1C37B065CBC515F_GET_UNITPROFILERLIST_OFFSET UNITYSDK_OFFSET(0xE15DBE0)
#define CLASS_1_B1C37B065CBC515F_METHOD_1_0071574A21BAA896_OFFSET UNITYSDK_OFFSET(0xE15D7E0)
#define CLASS_1_B1C37B065CBC515F_METHOD_1_0C3314530441AA85_OFFSET UNITYSDK_OFFSET(0xE15DA30)
#define CLASS_1_B1C37B065CBC515F_METHOD_1_21FFA59AF169ACF7_OFFSET UNITYSDK_OFFSET(0xE15BDA0)
#define CLASS_1_B1C37B065CBC515F_METHOD_1_28EB11670A8E5A86_OFFSET UNITYSDK_OFFSET(0xE15CAF0)
#define CLASS_1_B1C37B065CBC515F_METHOD_1_394F35BBA0EE596A_OFFSET UNITYSDK_OFFSET(0xE15BB60)
#define CLASS_1_B1C37B065CBC515F_METHOD_1_3E7F7468DAE568D3_OFFSET UNITYSDK_OFFSET(0xE15D210)
#define CLASS_1_B1C37B065CBC515F_METHOD_1_51C854947DF30177_OFFSET UNITYSDK_OFFSET(0xE15D030)
#define CLASS_1_B1C37B065CBC515F_METHOD_1_6CF3795CBDFE8DD0_OFFSET UNITYSDK_OFFSET(0xE15D490)
#define CLASS_1_B1C37B065CBC515F_METHOD_1_A1AFAEA19EB263CD_OFFSET UNITYSDK_OFFSET(0xE15D990)
#define CLASS_1_B1C37B065CBC515F_METHOD_1_AA2D3E889C8A52CA_OFFSET UNITYSDK_OFFSET(0xE15D920)
#define CLASS_1_B1C37B065CBC515F_METHOD_1_ADF4AD3331B4D7AD_OFFSET UNITYSDK_OFFSET(0xE15CAA0)
#define CLASS_1_B1C37B065CBC515F_METHOD_1_AF3DE7EEF4AB88EF_OFFSET UNITYSDK_OFFSET(0xE15DC20)
#define CLASS_1_B1C37B065CBC515F_METHOD_1_BD42F13584090B7C_OFFSET UNITYSDK_OFFSET(0xE15D270)
#define CLASS_1_B1C37B065CBC515F_METHOD_1_E899E0851F0B5B3E_OFFSET UNITYSDK_OFFSET(0xE15B7F0)
#define CLASS_1_B1C37B065CBC515F_METHOD_1_EDB6701F9DBE9544_OFFSET UNITYSDK_OFFSET(0xE15D890)
#define CLASS_1_B1C37B065CBC515F_SET_ATKSKILLIDLIST_OFFSET UNITYSDK_OFFSET(0xE15DB50)
#define CLASS_1_B1C37B065CBC515F_SET_ENHANCEMENTS_OFFSET UNITYSDK_OFFSET(0xE15DBB0)
#define CLASS_1_B1C37B065CBC515F_SET_EXTRAADDSKILLIDLIST_OFFSET UNITYSDK_OFFSET(0xE15DB70)
#define CLASS_1_B1C37B065CBC515F_SET_INITPOSITION_OFFSET UNITYSDK_OFFSET(0xE15DA20)
#define CLASS_1_B1C37B065CBC515F_SET_ISPROMOTED_OFFSET UNITYSDK_OFFSET(0xE15DB90)
#define CLASS_1_B1C37B065CBC515F_SET_ISRANGEATTACK_OFFSET UNITYSDK_OFFSET(0xE15DB10)
#define CLASS_1_B1C37B065CBC515F_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0xE15D910)
#define CLASS_1_B1C37B065CBC515F_SET_MODELPATH_OFFSET UNITYSDK_OFFSET(0xE15DAF0)
#define CLASS_1_B1C37B065CBC515F_SET_OVERRIDEMATERIALPATH_OFFSET UNITYSDK_OFFSET(0xE15DBD0)
#define CLASS_1_B1C37B065CBC515F_SET_RECOMMENDEDGRIDINDEX_OFFSET UNITYSDK_OFFSET(0xE15DC10)
#define CLASS_1_B1C37B065CBC515F_SET_SKILLIDLIST_OFFSET UNITYSDK_OFFSET(0xE15DB30)
#define CLASS_1_B1C37B065CBC515F_SET_SOLDIERID_OFFSET UNITYSDK_OFFSET(0xE15D8F0)
#define CLASS_1_B1C37B065CBC515F_SET_TEAMTYPE_OFFSET UNITYSDK_OFFSET(0xE15D980)
#define CLASS_1_B1C37B065CBC515F_SET_UNITPROFILERLIST_OFFSET UNITYSDK_OFFSET(0xE15DBF0)
#define CLASS_1_B1C37B065CBC515F__CTOR_1_OFFSET UNITYSDK_OFFSET(0xE15CD70)
#define CLASS_1_B1C37B065CBC515F__CTOR_2_OFFSET UNITYSDK_OFFSET(0xE15D2D0)
#define CLASS_1_B1C37B065CBC515F__CTOR_OFFSET UNITYSDK_OFFSET(0xE15B8B0)
...
public:
	...
	::Il2CppArray<::System::UInt32>* _AtkSkillIDList_k__BackingField; // 0x18
	...
	::System::Collections::Generic::List_1<::Class_1_87D6E24AEDA0242C*>* _UnitProfilerList_k__BackingField; // 0x40
	...
	::System::Boolean _IsRangeAttack_k__BackingField; // 0x60
	::System::Boolean _IsPromoted_k__BackingField; // 0x61
