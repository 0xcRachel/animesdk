...
#define CLASS_2_C91A3154842340B5_METHOD_2_57FC422C238CCA4F_OFFSET UNITYSDK_OFFSET(0x1051FD50)
#define CLASS_2_C91A3154842340B5_METHOD_2_60543752498FF59A_OFFSET UNITYSDK_OFFSET(0x1051F570)
#define CLASS_2_C91A3154842340B5_METHOD_2_64B6514CFF8F8D76_OFFSET UNITYSDK_OFFSET(0x1051FAB0)
#define CLASS_2_C91A3154842340B5__CTOR_OFFSET UNITYSDK_OFFSET(0x1051F510)
#define CLASS_2_C91A3154842340B5__CUSTOMBINDVIEW_OFFSET UNITYSDK_OFFSET(0x1051FAE0)
#define CLASS_2_C91A3154842340B5__ONTICK_OFFSET UNITYSDK_OFFSET(0x1051FCF0)
#define CLASS_2_C91A3154842340B5__SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x1051FBB0)
#define CLASS_2_C91A3154842340B5___IFIXBASEPROXY__CUSTOMBINDVIEW_OFFSET UNITYSDK_OFFSET(0x10520040)
#define CLASS_2_C91A3154842340B5___IFIXBASEPROXY__ONTICK_OFFSET UNITYSDK_OFFSET(0x10520100)
#define CLASS_2_C91A3154842340B5___IFIXBASEPROXY__SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x105200A0)

inline static constexpr unsigned int Class_2_C91A3154842340B5_TypeDefinitionIndex = 66788;

class Class_2_C91A3154842340B5 : public ::RPG::Client::UIController
{
public:
	::System::Boolean Field_2_2; // 0x180
	::System::Single Field_2_1; // 0x184
	::System::Single Field_2_0; // 0x188
