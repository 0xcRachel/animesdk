...
#define CLASS_3_5B0237AEBE51CEDE_GET_DEFAULTPARAM_OFFSET UNITYSDK_OFFSET(0x8C13DB0)
#define CLASS_3_5B0237AEBE51CEDE_GET_FORUMVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x8C13DF0)
#define CLASS_3_5B0237AEBE51CEDE_GET_GUID_OFFSET UNITYSDK_OFFSET(0x8C13F00)
#define CLASS_3_5B0237AEBE51CEDE_GET_ISSUEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x8C13DD0)
#define CLASS_3_5B0237AEBE51CEDE_GET_ONBTNCLOSE_OFFSET UNITYSDK_OFFSET(0x8C13D50)
#define CLASS_3_5B0237AEBE51CEDE_GET_ONBTNFORM_OFFSET UNITYSDK_OFFSET(0x8C13D90)
#define CLASS_3_5B0237AEBE51CEDE_GET_ONBTNISSUE_OFFSET UNITYSDK_OFFSET(0x8C13D70)
#define CLASS_3_5B0237AEBE51CEDE_GET_SPONSORVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x8C13E10)
#define CLASS_3_5B0237AEBE51CEDE_METHOD_3_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x8C13D40)
#define CLASS_3_5B0237AEBE51CEDE_METHOD_3_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x8C13CD0)
#define CLASS_3_5B0237AEBE51CEDE_METHOD_3_2720CE40EEFCCE64_OFFSET UNITYSDK_OFFSET(0x8C13E30)
#define CLASS_3_5B0237AEBE51CEDE_METHOD_3_B3A88D7849969A71_OFFSET UNITYSDK_OFFSET(0x8C13C40)
#define CLASS_3_5B0237AEBE51CEDE_SET_DEFAULTPARAM_OFFSET UNITYSDK_OFFSET(0x8C13DC0)
#define CLASS_3_5B0237AEBE51CEDE_SET_FORUMVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x8C13E00)
#define CLASS_3_5B0237AEBE51CEDE_SET_GUID_OFFSET UNITYSDK_OFFSET(0x8C13F10)
#define CLASS_3_5B0237AEBE51CEDE_SET_ISSUEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x8C13DE0)
#define CLASS_3_5B0237AEBE51CEDE_SET_ONBTNCLOSE_OFFSET UNITYSDK_OFFSET(0x8C13D60)
#define CLASS_3_5B0237AEBE51CEDE_SET_ONBTNFORM_OFFSET UNITYSDK_OFFSET(0x8C13DA0)
#define CLASS_3_5B0237AEBE51CEDE_SET_ONBTNISSUE_OFFSET UNITYSDK_OFFSET(0x8C13D80)
#define CLASS_3_5B0237AEBE51CEDE_SET_SPONSORVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x8C13E20)
#define CLASS_3_5B0237AEBE51CEDE__CTOR_OFFSET UNITYSDK_OFFSET(0x8C137B0)
#define CLASS_3_5B0237AEBE51CEDE___CTOR_B__0_0_OFFSET UNITYSDK_OFFSET(0x8C13F20)
#define CLASS_3_5B0237AEBE51CEDE___CTOR_B__0_1_OFFSET UNITYSDK_OFFSET(0x8C14080)
#define CLASS_3_5B0237AEBE51CEDE___CTOR_B__0_2_OFFSET UNITYSDK_OFFSET(0x8C141E0)

inline static constexpr unsigned int Class_3_5B0237AEBE51CEDE_TypeDefinitionIndex = 60967;
...
public:
	...
	::Class_1_ADBE1843AD1E672A* _OnBtnIssue_k__BackingField; // 0x18
	::System::String* Field_3_15; // 0x20
	::Class_1_ADBE1843AD1E672A* _OnBtnClose_k__BackingField; // 0x28
	::RPG::Client::MVVM::Service::LimaoNewsNetworkService* Field_3_10; // 0x30
	::Class_3_290D64E8B1BFF24F* _IssueViewModel_k__BackingField; // 0x38
	::Class_1_0BA5D98E0F73DDB8* Field_3_14; // 0x40
	::RPG::Client::MVVM::Service::LimaoNewsPostService* Field_3_12; // 0x48
	::Class_1_ADBE1843AD1E672A* _OnBtnForm_k__BackingField; // 0x50
	::RPG::Client::MVVM::ViewModel::LimaoNewsWebsiteViewModelParam* _DefaultParam_k__BackingField; // 0x58
	::Class_3_D975C797957E43FF* _ForumViewModel_k__BackingField; // 0x60
	::RPG::Client::MVVM::Service::LimaoNewsWindowService* Field_3_13; // 0x68
	::RPG::Client::MVVM::Service::LimaoNewsIssueService* Field_3_11; // 0x70
	::Class_3_5D7F408520274939* _SponsorViewModel_k__BackingField; // 0x78
