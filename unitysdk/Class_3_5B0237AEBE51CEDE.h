...
#define CLASS_3_5B0237AEBE51CEDE_GET_DEFAULTPARAM_OFFSET UNITYSDK_OFFSET(0xEED1E40)
#define CLASS_3_5B0237AEBE51CEDE_GET_FORUMVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xEED1E80)
#define CLASS_3_5B0237AEBE51CEDE_GET_GUID_OFFSET UNITYSDK_OFFSET(0xEED1FA0)
#define CLASS_3_5B0237AEBE51CEDE_GET_ISSUEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xEED1E60)
#define CLASS_3_5B0237AEBE51CEDE_GET_ONBTNCLOSE_OFFSET UNITYSDK_OFFSET(0xEED1DE0)
#define CLASS_3_5B0237AEBE51CEDE_GET_ONBTNFORM_OFFSET UNITYSDK_OFFSET(0xEED1E20)
#define CLASS_3_5B0237AEBE51CEDE_GET_ONBTNISSUE_OFFSET UNITYSDK_OFFSET(0xEED1E00)
#define CLASS_3_5B0237AEBE51CEDE_GET_SPONSORVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xEED1EA0)
#define CLASS_3_5B0237AEBE51CEDE_METHOD_3_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0xEED1DD0)
#define CLASS_3_5B0237AEBE51CEDE_METHOD_3_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0xEED1D60)
#define CLASS_3_5B0237AEBE51CEDE_METHOD_3_2720CE40EEFCCE64_OFFSET UNITYSDK_OFFSET(0xEED1EC0)
#define CLASS_3_5B0237AEBE51CEDE_METHOD_3_B3A88D7849969A71_OFFSET UNITYSDK_OFFSET(0xEED1CD0)
#define CLASS_3_5B0237AEBE51CEDE_SET_DEFAULTPARAM_OFFSET UNITYSDK_OFFSET(0xEED1E50)
#define CLASS_3_5B0237AEBE51CEDE_SET_FORUMVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xEED1E90)
#define CLASS_3_5B0237AEBE51CEDE_SET_GUID_OFFSET UNITYSDK_OFFSET(0xEED1FB0)
#define CLASS_3_5B0237AEBE51CEDE_SET_ISSUEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xEED1E70)
#define CLASS_3_5B0237AEBE51CEDE_SET_ONBTNCLOSE_OFFSET UNITYSDK_OFFSET(0xEED1DF0)
#define CLASS_3_5B0237AEBE51CEDE_SET_ONBTNFORM_OFFSET UNITYSDK_OFFSET(0xEED1E30)
#define CLASS_3_5B0237AEBE51CEDE_SET_ONBTNISSUE_OFFSET UNITYSDK_OFFSET(0xEED1E10)
#define CLASS_3_5B0237AEBE51CEDE_SET_SPONSORVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xEED1EB0)
#define CLASS_3_5B0237AEBE51CEDE__CTOR_OFFSET UNITYSDK_OFFSET(0xEED1840)
#define CLASS_3_5B0237AEBE51CEDE___CTOR_B__0_0_OFFSET UNITYSDK_OFFSET(0xEED1FC0)
#define CLASS_3_5B0237AEBE51CEDE___CTOR_B__0_1_OFFSET UNITYSDK_OFFSET(0xEED20E0)
#define CLASS_3_5B0237AEBE51CEDE___CTOR_B__0_2_OFFSET UNITYSDK_OFFSET(0xEED2200)

inline static constexpr unsigned int Class_3_5B0237AEBE51CEDE_TypeDefinitionIndex = 68418;
...
public:
	...
	::RPG::Client::MVVM::Service::LimaoNewsPostService* Field_3_12; // 0x30
	::System::String* Field_3_15; // 0x38
	::RPG::Client::MVVM::ViewModel::LimaoNewsWebsiteViewModelParam* _DefaultParam_k__BackingField; // 0x40
	::Class_1_ADBE1843AD1E672A* _OnBtnClose_k__BackingField; // 0x48
	::Class_1_029A7EDCBF9933C8* Field_3_14; // 0x50
	::Class_1_ADBE1843AD1E672A* _OnBtnForm_k__BackingField; // 0x58
	::Class_3_5D7F408520274939* _SponsorViewModel_k__BackingField; // 0x60
	...
	::Class_1_ADBE1843AD1E672A* _OnBtnIssue_k__BackingField; // 0x80
