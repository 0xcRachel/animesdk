...
#define CLASS_3_6E5B2D66843DE500_DISPOSE_OFFSET UNITYSDK_OFFSET(0x104E8E90)
#define CLASS_3_6E5B2D66843DE500_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x104E8ED0)
#define CLASS_3_6E5B2D66843DE500__CTOR_OFFSET UNITYSDK_OFFSET(0x104E8E60)
#define CLASS_3_6E5B2D66843DE500___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x104E9440)

inline static constexpr unsigned int Class_3_6E5B2D66843DE500_TypeDefinitionIndex = 43285;
...
public:
	...
	{
		return (::System::Collections::Generic::List_1<::RPG::Client::ComponentAssetLoader*>**)Il2CppClass::FromTypeDefinitionIndex(Class_3_6E5B2D66843DE500_TypeDefinitionIndex)->GetStaticField(0x43D60);
	}
