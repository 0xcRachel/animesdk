...
#define MESHBOUNDDRAWER_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xEE6B7E0)
#define MESHBOUNDDRAWER_START_OFFSET UNITYSDK_OFFSET(0xEE6B4C0)
#define MESHBOUNDDRAWER__CTOR_OFFSET UNITYSDK_OFFSET(0xEE6BA30)
