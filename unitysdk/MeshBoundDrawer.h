...
#define MESHBOUNDDRAWER_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x88C6D40)
#define MESHBOUNDDRAWER_START_OFFSET UNITYSDK_OFFSET(0x88C6A20)
#define MESHBOUNDDRAWER__CTOR_OFFSET UNITYSDK_OFFSET(0x88C6F90)
