...
#define CLASS_3_3323B4893ACBCB05_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1729B450)
#define CLASS_3_3323B4893ACBCB05_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1729B4D0)
#define CLASS_3_3323B4893ACBCB05_INVOKE_OFFSET UNITYSDK_OFFSET(0x1729AF60)
#define CLASS_3_3323B4893ACBCB05__CTOR_OFFSET UNITYSDK_OFFSET(0x1729AF40)

inline static constexpr unsigned int Class_3_3323B4893ACBCB05_TypeDefinitionIndex = 8441;
