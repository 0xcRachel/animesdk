...
#define CLASS_2_C6F607C9BAC0CC8B_METHOD_2_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x1120C1A0)
#define CLASS_2_C6F607C9BAC0CC8B_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1120C210)
#define CLASS_2_C6F607C9BAC0CC8B__CTOR_OFFSET UNITYSDK_OFFSET(0x1120C2F0)

inline static constexpr unsigned int Class_2_C6F607C9BAC0CC8B_TypeDefinitionIndex = 56941;

class Class_2_C6F607C9BAC0CC8B : public ::Class_1_89D8044AB73F8F6D
{
public:
	::UnityEngine::Animation* Field_2_2; // 0x18
	::RPG::Client::PrefabLoadMeta* Field_2_3; // 0x20
