...
#define CLASS_2_89CFDCCF66B0E7A2_METHOD_2_58BEA1F06C0CB5B9_OFFSET UNITYSDK_OFFSET(0x849C600)
#define CLASS_2_89CFDCCF66B0E7A2_METHOD_2_D95C56663DD6F875_OFFSET UNITYSDK_OFFSET(0x849C7A0)
#define CLASS_2_89CFDCCF66B0E7A2__CREATETRIGGER_OFFSET UNITYSDK_OFFSET(0x849C040)
#define CLASS_2_89CFDCCF66B0E7A2__CTOR_OFFSET UNITYSDK_OFFSET(0x849B9E0)
#define CLASS_2_89CFDCCF66B0E7A2__GETENTITYBYRUNTIMEID_OFFSET UNITYSDK_OFFSET(0x849BFE0)
#define CLASS_2_89CFDCCF66B0E7A2__LOGERROR_OFFSET UNITYSDK_OFFSET(0x849BF80)
#define CLASS_2_89CFDCCF66B0E7A2__ONTRIGGERIN_OFFSET UNITYSDK_OFFSET(0x849BDE0)
#define CLASS_2_89CFDCCF66B0E7A2__ONTRIGGEROUT_OFFSET UNITYSDK_OFFSET(0x849BEA0)
#define CLASS_2_89CFDCCF66B0E7A2__TEARDOWN_OFFSET UNITYSDK_OFFSET(0x849BCB0)
#define CLASS_2_89CFDCCF66B0E7A2___IFIXBASEPROXY__LOGERROR_OFFSET UNITYSDK_OFFSET(0x849CB30)
#define CLASS_2_89CFDCCF66B0E7A2___IFIXBASEPROXY__TEARDOWN_OFFSET UNITYSDK_OFFSET(0x849CB20)

inline static constexpr unsigned int Class_2_89CFDCCF66B0E7A2_TypeDefinitionIndex = 60820;
...
public:
	...
	::System::Boolean Method_2_D95C56663DD6F875(::UnityEngine::Collider* a1)
	{
		return ((::System::Boolean(*)(::PVOID, ::UnityEngine::Collider*))((::PBYTE)hIl2Cpp + CLASS_2_89CFDCCF66B0E7A2_METHOD_2_D95C56663DD6F875_OFFSET))(this, a1);
	}
