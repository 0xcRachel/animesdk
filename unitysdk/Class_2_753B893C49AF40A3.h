...
#define CLASS_2_753B893C49AF40A3_DISPOSE_OFFSET UNITYSDK_OFFSET(0xDB78D60)
#define CLASS_2_753B893C49AF40A3_METHOD_2_5F3AE37087DCC4E1_OFFSET UNITYSDK_OFFSET(0xDB79070)
#define CLASS_2_753B893C49AF40A3_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xDB78C20)
#define CLASS_2_753B893C49AF40A3_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xDB78D10)
#define CLASS_2_753B893C49AF40A3_TICK_OFFSET UNITYSDK_OFFSET(0xDB79390)
#define CLASS_2_753B893C49AF40A3__CTOR_OFFSET UNITYSDK_OFFSET(0xDB78510)
...
{
public:
	::Class_3_E21F6DE9B7FA4D05* Field_2_13; // 0x18
	::Class_3_E21F6DE9B7FA4D05* Field_2_10; // 0x20
	::RPG::GameCore::TimeRelayFlameEventListener* Field_2_1; // 0x28
	::Class_3_E21F6DE9B7FA4D05* Field_2_14; // 0x30
	::Class_3_E21F6DE9B7FA4D05* Field_2_3; // 0x38
	::Class_3_E21F6DE9B7FA4D05* Field_2_5; // 0x40
	::RPG::GameCore::TaskContext* Field_2_0; // 0x48
	::Class_3_E21F6DE9B7FA4D05* Field_2_11; // 0x50
	::Class_3_E21F6DE9B7FA4D05* Field_2_9; // 0x58
	::Class_3_E21F6DE9B7FA4D05* Field_2_12; // 0x60
	::Class_3_E21F6DE9B7FA4D05* Field_2_8; // 0x68
	::Class_3_E21F6DE9B7FA4D05* Field_2_6; // 0x70
	::Class_3_E21F6DE9B7FA4D05* Field_2_17; // 0x78
	::Class_3_E21F6DE9B7FA4D05* Field_2_7; // 0x80
	::Class_3_E21F6DE9B7FA4D05* Field_2_4; // 0x88
	::Class_3_E21F6DE9B7FA4D05* Field_2_2; // 0x90
	::Class_3_E21F6DE9B7FA4D05* Field_2_16; // 0x98
	::Class_3_E21F6DE9B7FA4D05* Field_2_15; // 0xA0
