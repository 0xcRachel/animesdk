...
#define CLASS_2_4CDE3141C5D0D768_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1268C3D0)
#define CLASS_2_4CDE3141C5D0D768_METHOD_2_3574512695A597AB_OFFSET UNITYSDK_OFFSET(0x1268C480)
#define CLASS_2_4CDE3141C5D0D768_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1268C410)
#define CLASS_2_4CDE3141C5D0D768_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1268C6F0)
#define CLASS_2_4CDE3141C5D0D768_TICK_OFFSET UNITYSDK_OFFSET(0x1268C750)
#define CLASS_2_4CDE3141C5D0D768__CTOR_OFFSET UNITYSDK_OFFSET(0x1268C2B0)
...
public:
	...
	::Class_2_A0580152EB393340* Field_2_5; // 0x38
	::RPG::GameCore::AdvNPCAttack* Field_2_0; // 0x40
