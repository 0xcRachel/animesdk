...
#define CLASS_3_2D24947DB58B4991_DISPOSE_OFFSET UNITYSDK_OFFSET(0x106234B0)
#define CLASS_3_2D24947DB58B4991_METHOD_3_6A4ED1FCC0ADD2AB_OFFSET UNITYSDK_OFFSET(0x10624330)
#define CLASS_3_2D24947DB58B4991_METHOD_3_8EB5F47953521201_OFFSET UNITYSDK_OFFSET(0x10624230)
#define CLASS_3_2D24947DB58B4991_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x106235F0)
#define CLASS_3_2D24947DB58B4991__CTOR_OFFSET UNITYSDK_OFFSET(0x10623060)
#define CLASS_3_2D24947DB58B4991___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10624820)
...
{
public:
	::Class_3_E21F6DE9B7FA4D05* Field_3_8; // 0x28
	::Class_3_E21F6DE9B7FA4D05* Field_3_3; // 0x30
	::System::Action_1<::RPG::GameCore::GameEntity*>* Field_3_4; // 0x38
	::Class_3_E21F6DE9B7FA4D05* Field_3_2; // 0x40
	::Class_3_E21F6DE9B7FA4D05* Field_3_7; // 0x48
	::Class_3_E21F6DE9B7FA4D05* Field_3_5; // 0x50
	::Class_3_E21F6DE9B7FA4D05* Field_3_6; // 0x58
	::RPG::GameCore::AvatarChangeTemplate* Field_3_0; // 0x60
	::System::Action_1<::RPG::GameCore::GameEntity*>* Field_3_1; // 0x68
