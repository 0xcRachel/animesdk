...
#define CLASS_2_0E971291CFB8C92D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x111967A0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_0076C796B2045359_OFFSET UNITYSDK_OFFSET(0x111967F0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_03CFABC9DB480D57_OFFSET UNITYSDK_OFFSET(0x11194FD0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_09236BC3F3F40508_OFFSET UNITYSDK_OFFSET(0x11195A60)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_10054BB010E03EDD_OFFSET UNITYSDK_OFFSET(0x11197DE0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x111940A0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x11197CF0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_1C6AD2DA62FB6EB1_OFFSET UNITYSDK_OFFSET(0x11193240)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_228E3444D290BEE7_OFFSET UNITYSDK_OFFSET(0x11193180)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_25DEA5C65A602671_OFFSET UNITYSDK_OFFSET(0x111937F0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_367B9590522079D1_OFFSET UNITYSDK_OFFSET(0x111941B0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_3A599F23178B2776_OFFSET UNITYSDK_OFFSET(0x11198C10)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_3E586421BA588EFD_1_OFFSET UNITYSDK_OFFSET(0x111987A0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_3E586421BA588EFD_OFFSET UNITYSDK_OFFSET(0x11197FA0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x11193620)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_453AC1AA603124A7_OFFSET UNITYSDK_OFFSET(0x11196A60)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_4971720EADE3BC69_OFFSET UNITYSDK_OFFSET(0x11195080)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_4A41C63BFE58D26F_1_OFFSET UNITYSDK_OFFSET(0x11192D40)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_4A41C63BFE58D26F_OFFSET UNITYSDK_OFFSET(0x11195BC0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_4E8A303616E6B331_OFFSET UNITYSDK_OFFSET(0x11198410)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_4EA6B1791DACA9CC_OFFSET UNITYSDK_OFFSET(0x11193B90)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_569C8A2D03C8AA85_OFFSET UNITYSDK_OFFSET(0x11198C60)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_5FBAD89A54D9F070_OFFSET UNITYSDK_OFFSET(0x111953C0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_66CC9828DB1F478F_OFFSET UNITYSDK_OFFSET(0x11192F30)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_71A73B32B60F1C50_OFFSET UNITYSDK_OFFSET(0x11193DD0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_7DB49B5407C8FD68_OFFSET UNITYSDK_OFFSET(0x11197870)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_7E876EE9E5D4C0FD_1_OFFSET UNITYSDK_OFFSET(0x11194D30)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_7E876EE9E5D4C0FD_OFFSET UNITYSDK_OFFSET(0x11194C40)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_8594010D6A57C9BB_1_OFFSET UNITYSDK_OFFSET(0x111938C0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_8594010D6A57C9BB_OFFSET UNITYSDK_OFFSET(0x11195580)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_87FBD4C01CDE59F6_OFFSET UNITYSDK_OFFSET(0x11192980)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_8B848E52913DFCE9_OFFSET UNITYSDK_OFFSET(0x11193490)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_8F229D0FB38BDC22_OFFSET UNITYSDK_OFFSET(0x11193570)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_907E24F785836BA0_OFFSET UNITYSDK_OFFSET(0x111972E0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_90EC405A27CF7D77_OFFSET UNITYSDK_OFFSET(0x11194740)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_9681042564541CD6_1_OFFSET UNITYSDK_OFFSET(0x11197C60)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_9681042564541CD6_2_OFFSET UNITYSDK_OFFSET(0x111983A0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x11194D80)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_96980C17A8BB1F06_1_OFFSET UNITYSDK_OFFSET(0x11194CE0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_96980C17A8BB1F06_OFFSET UNITYSDK_OFFSET(0x11194C90)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0x111958D0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_9AB55F553C4AC6E8_OFFSET UNITYSDK_OFFSET(0x111949A0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_9D7B81571ADA6EDE_OFFSET UNITYSDK_OFFSET(0x111946C0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0x11195CA0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_A57FA722AB2A8938_OFFSET UNITYSDK_OFFSET(0x11192E70)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_B0472D22DF1F0462_OFFSET UNITYSDK_OFFSET(0x11199120)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_B1936CE4DA97AA45_1_OFFSET UNITYSDK_OFFSET(0x11197500)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x111977D0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_B2C0ADBFEA309440_1_OFFSET UNITYSDK_OFFSET(0x111985A0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_B2C0ADBFEA309440_OFFSET UNITYSDK_OFFSET(0x11199000)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_B6BB704B01BCC35B_1_OFFSET UNITYSDK_OFFSET(0x111986C0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_B6BB704B01BCC35B_OFFSET UNITYSDK_OFFSET(0x11192C10)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x11192E20)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x11197F50)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x11192CF0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_CCD88C0D86A5A786_OFFSET UNITYSDK_OFFSET(0x11194E00)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_CE18697B63E52504_OFFSET UNITYSDK_OFFSET(0x11195200)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x11193760)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_D4B2B3AAA187F191_OFFSET UNITYSDK_OFFSET(0x11194640)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_D7852DE078ACC1F1_1_OFFSET UNITYSDK_OFFSET(0x111979E0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_D7852DE078ACC1F1_OFFSET UNITYSDK_OFFSET(0x11195E60)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_D901EBCE84FF5911_OFFSET UNITYSDK_OFFSET(0x11197130)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_E693A0026D178D8E_OFFSET UNITYSDK_OFFSET(0x11196F70)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_ED65AE7582736594_1_OFFSET UNITYSDK_OFFSET(0x11196EB0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_ED65AE7582736594_OFFSET UNITYSDK_OFFSET(0x11196DF0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0x111975C0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_EEFAEF90788C3122_OFFSET UNITYSDK_OFFSET(0x11193680)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_F088F946AD14C0AD_OFFSET UNITYSDK_OFFSET(0x11195280)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_F37CDBD6D46274D2_1_OFFSET UNITYSDK_OFFSET(0x11195850)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x11195500)
#define CLASS_2_0E971291CFB8C92D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11196070)
#define CLASS_2_0E971291CFB8C92D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x11196490)
#define CLASS_2_0E971291CFB8C92D_TICK_OFFSET UNITYSDK_OFFSET(0x111966B0)
#define CLASS_2_0E971291CFB8C92D__CCTOR_OFFSET UNITYSDK_OFFSET(0x111991A0)
#define CLASS_2_0E971291CFB8C92D__CTOR_OFFSET UNITYSDK_OFFSET(0x11195D50)
...
public:
	...
	{
		return (::System::Action**)Il2CppClass::FromTypeDefinitionIndex(Class_2_0E971291CFB8C92D_TypeDefinitionIndex)->GetStaticField(0x283B0);
	}
	static ::System::String** StaticGet_Field_2_7()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_2_0E971291CFB8C92D_TypeDefinitionIndex)->GetStaticField(0x283B8);
	}
	static ::System::Boolean* StaticGet_Field_2_9()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_2_0E971291CFB8C92D_TypeDefinitionIndex)->GetStaticField(0xB7C0);
	}
	...
	::RPG::Client::LuaUIController* Field_2_17; // 0x18
	::System::Collections::Generic::Dictionary_2<::UnityEngine::Transform*, ::RPG::GameCore::GameEntity*>* Field_2_29; // 0x20
	::RPG::GameCore::GameEntity* Field_2_24; // 0x28
	::RPG::GameCore::GravityBallPuzzleControllerInit* Field_2_12; // 0x30
	::Class_2_D8257A310CAD757C* Field_2_13; // 0x38
	::RPG::Client::Prop::GravityBallWallController* Field_2_27; // 0x40
	::UnityEngine::GameObject* Field_2_22; // 0x48
	::Class_1_E05E7A6D9DE9138B* Field_2_21; // 0x50
	::UnityEngine::Transform* Field_2_23; // 0x58
	::RPG::GameCore::GameEntity* Field_2_25; // 0x60
	::Class_1_5F51D4049EA87B7B* Field_2_6; // 0x68
	::RPG::GameCore::TaskContext* Field_2_11; // 0x70
	::System::String* Field_2_5; // 0x78
	::RPG::Client::Prop::GravityBallBallController* Field_2_28; // 0x80
	::RPG::GameCore::GravityBallUIParam* Field_2_20; // 0x88
	::System::String* Field_2_4; // 0x90
	::RPG::GameCore::GameEntity* Field_2_26; // 0x98
	::System::Single Field_2_3; // 0xA0
	::System::Int16 Field_2_14; // 0xA4
	::System::Boolean Field_2_0; // 0xA6
	::System::Boolean Field_2_16; // 0xA7
	::Class_2_0E971291CFB8C92D_HiddenStoryControlState Field_2_2; // 0xA8
	::System::Int32 Field_2_18; // 0xAC
	::System::Single Field_2_10; // 0xB0
	::System::Single Field_2_1; // 0xB4
	::Class_2_0E971291CFB8C92D_PuzzleState Field_2_15; // 0xB8
	::System::UInt64 Field_2_19; // 0xC0
