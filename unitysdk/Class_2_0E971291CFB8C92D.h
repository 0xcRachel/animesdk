...
#define CLASS_2_0E971291CFB8C92D_DISPOSE_OFFSET UNITYSDK_OFFSET(0xFF61BC0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_0076C796B2045359_OFFSET UNITYSDK_OFFSET(0xFF61C10)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_03CFABC9DB480D57_OFFSET UNITYSDK_OFFSET(0xFF60400)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_09236BC3F3F40508_OFFSET UNITYSDK_OFFSET(0xFF60E90)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_10054BB010E03EDD_OFFSET UNITYSDK_OFFSET(0xFF63210)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xFF5F4C0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0xFF63120)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_1C6AD2DA62FB6EB1_OFFSET UNITYSDK_OFFSET(0xFF5E660)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_228E3444D290BEE7_OFFSET UNITYSDK_OFFSET(0xFF5E5B0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_25DEA5C65A602671_OFFSET UNITYSDK_OFFSET(0xFF5EC00)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_367B9590522079D1_OFFSET UNITYSDK_OFFSET(0xFF5F5D0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_3A599F23178B2776_OFFSET UNITYSDK_OFFSET(0xFF64050)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_3E586421BA588EFD_1_OFFSET UNITYSDK_OFFSET(0xFF63BE0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_3E586421BA588EFD_OFFSET UNITYSDK_OFFSET(0xFF633D0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xFF5EA30)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_453AC1AA603124A7_OFFSET UNITYSDK_OFFSET(0xFF61E80)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_4971720EADE3BC69_OFFSET UNITYSDK_OFFSET(0xFF604B0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_4A41C63BFE58D26F_1_OFFSET UNITYSDK_OFFSET(0xFF5E170)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_4A41C63BFE58D26F_OFFSET UNITYSDK_OFFSET(0xFF60FF0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_4E8A303616E6B331_OFFSET UNITYSDK_OFFSET(0xFF63850)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_4EA6B1791DACA9CC_OFFSET UNITYSDK_OFFSET(0xFF5EFA0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_569C8A2D03C8AA85_OFFSET UNITYSDK_OFFSET(0xFF640A0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_5FBAD89A54D9F070_OFFSET UNITYSDK_OFFSET(0xFF607F0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_66CC9828DB1F478F_OFFSET UNITYSDK_OFFSET(0xFF5E360)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_71A73B32B60F1C50_OFFSET UNITYSDK_OFFSET(0xFF5F1E0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_7DB49B5407C8FD68_OFFSET UNITYSDK_OFFSET(0xFF62C90)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_7E876EE9E5D4C0FD_1_OFFSET UNITYSDK_OFFSET(0xFF60160)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_7E876EE9E5D4C0FD_OFFSET UNITYSDK_OFFSET(0xFF60070)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_8594010D6A57C9BB_1_OFFSET UNITYSDK_OFFSET(0xFF5ECD0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_8594010D6A57C9BB_OFFSET UNITYSDK_OFFSET(0xFF609B0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_87FBD4C01CDE59F6_OFFSET UNITYSDK_OFFSET(0xFF5DDB0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_8B848E52913DFCE9_OFFSET UNITYSDK_OFFSET(0xFF5E8A0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_8F229D0FB38BDC22_OFFSET UNITYSDK_OFFSET(0xFF5E980)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_907E24F785836BA0_OFFSET UNITYSDK_OFFSET(0xFF62710)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_90EC405A27CF7D77_OFFSET UNITYSDK_OFFSET(0xFF5FB70)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_9681042564541CD6_1_OFFSET UNITYSDK_OFFSET(0xFF63090)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_9681042564541CD6_2_OFFSET UNITYSDK_OFFSET(0xFF637D0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xFF601B0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_96980C17A8BB1F06_1_OFFSET UNITYSDK_OFFSET(0xFF60110)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_96980C17A8BB1F06_OFFSET UNITYSDK_OFFSET(0xFF600C0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0xFF60D00)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_9AB55F553C4AC6E8_OFFSET UNITYSDK_OFFSET(0xFF5FDD0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_9D7B81571ADA6EDE_OFFSET UNITYSDK_OFFSET(0xFF5FAF0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0xFF610D0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_A57FA722AB2A8938_OFFSET UNITYSDK_OFFSET(0xFF5E2A0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_B0472D22DF1F0462_OFFSET UNITYSDK_OFFSET(0xFF64560)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_B1936CE4DA97AA45_1_OFFSET UNITYSDK_OFFSET(0xFF62930)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xFF62BF0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_B2C0ADBFEA309440_1_OFFSET UNITYSDK_OFFSET(0xFF639E0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_B2C0ADBFEA309440_OFFSET UNITYSDK_OFFSET(0xFF64440)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_B6BB704B01BCC35B_1_OFFSET UNITYSDK_OFFSET(0xFF63B00)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_B6BB704B01BCC35B_OFFSET UNITYSDK_OFFSET(0xFF5E040)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xFF5E250)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0xFF63380)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xFF5E120)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_CCD88C0D86A5A786_OFFSET UNITYSDK_OFFSET(0xFF60230)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_CE18697B63E52504_OFFSET UNITYSDK_OFFSET(0xFF60630)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0xFF5EB70)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_D4B2B3AAA187F191_OFFSET UNITYSDK_OFFSET(0xFF5FA70)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_D7852DE078ACC1F1_1_OFFSET UNITYSDK_OFFSET(0xFF62E10)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_D7852DE078ACC1F1_OFFSET UNITYSDK_OFFSET(0xFF61280)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_D901EBCE84FF5911_OFFSET UNITYSDK_OFFSET(0xFF62560)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_E693A0026D178D8E_OFFSET UNITYSDK_OFFSET(0xFF62390)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_ED65AE7582736594_1_OFFSET UNITYSDK_OFFSET(0xFF622D0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_ED65AE7582736594_OFFSET UNITYSDK_OFFSET(0xFF62210)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0xFF629F0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_EEFAEF90788C3122_OFFSET UNITYSDK_OFFSET(0xFF5EA90)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_F088F946AD14C0AD_OFFSET UNITYSDK_OFFSET(0xFF606B0)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_F37CDBD6D46274D2_1_OFFSET UNITYSDK_OFFSET(0xFF60C80)
#define CLASS_2_0E971291CFB8C92D_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0xFF60930)
#define CLASS_2_0E971291CFB8C92D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xFF61490)
#define CLASS_2_0E971291CFB8C92D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xFF618B0)
#define CLASS_2_0E971291CFB8C92D_TICK_OFFSET UNITYSDK_OFFSET(0xFF61AD0)
#define CLASS_2_0E971291CFB8C92D__CCTOR_OFFSET UNITYSDK_OFFSET(0xFF645E0)
#define CLASS_2_0E971291CFB8C92D__CTOR_OFFSET UNITYSDK_OFFSET(0xFF61180)
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_2_0E971291CFB8C92D_TypeDefinitionIndex)->GetStaticField(0x603E0);
	}
	static ::System::Action** StaticGet_Field_2_8()
	{
		return (::System::Action**)Il2CppClass::FromTypeDefinitionIndex(Class_2_0E971291CFB8C92D_TypeDefinitionIndex)->GetStaticField(0x603E8);
	}
	static ::System::Boolean* StaticGet_Field_2_9()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_2_0E971291CFB8C92D_TypeDefinitionIndex)->GetStaticField(0x10D70);
	}
	...
	::RPG::GameCore::TaskContext* Field_2_11; // 0x18
	...
	::RPG::Client::Prop::GravityBallWallController* Field_2_27; // 0x38
	::RPG::GameCore::GravityBallUIParam* Field_2_20; // 0x40
	::System::String* Field_2_5; // 0x48
	::Class_2_BD898AE9C0E88E25* Field_2_13; // 0x50
	::RPG::GameCore::GravityBallPuzzleControllerInit* Field_2_12; // 0x58
	::RPG::Client::Prop::GravityBallBallController* Field_2_28; // 0x60
	::UnityEngine::Transform* Field_2_23; // 0x68
	::Class_1_E05E7A6D9DE9138B* Field_2_21; // 0x70
	::Class_1_5F51D4049EA87B7B* Field_2_6; // 0x78
	::RPG::GameCore::GameEntity* Field_2_26; // 0x80
	::RPG::Client::LuaUIController* Field_2_17; // 0x88
	::RPG::GameCore::GameEntity* Field_2_25; // 0x90
	::RPG::GameCore::GameEntity* Field_2_24; // 0x98
	::System::Single Field_2_3; // 0xA0
	::System::Int32 Field_2_18; // 0xA4
	::System::Boolean Field_2_16; // 0xA8
	::System::Boolean Field_2_0; // 0xA9
	::System::Int16 Field_2_14; // 0xAA
	::System::UInt64 Field_2_19; // 0xB0
	::Class_2_0E971291CFB8C92D_HiddenStoryControlState Field_2_2; // 0xB8
	::System::Single Field_2_1; // 0xBC
	::System::Single Field_2_10; // 0xC0
	::Class_2_0E971291CFB8C92D_PuzzleState Field_2_15; // 0xC4
	...
	::System::Void Method_2_569C8A2D03C8AA85(::Class_0_16E4307DCC419505_382* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_382*))((::PBYTE)hIl2Cpp + CLASS_2_0E971291CFB8C92D_METHOD_2_569C8A2D03C8AA85_OFFSET))(this, a1);
	}
