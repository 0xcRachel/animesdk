...
#define CLASS_1_FE966CAF6C3A4852_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x15C829E0)
#define CLASS_1_FE966CAF6C3A4852_METHOD_1_3FACD83836441927_OFFSET UNITYSDK_OFFSET(0x15C82CB0)
#define CLASS_1_FE966CAF6C3A4852_METHOD_1_4863C96DA6A57411_OFFSET UNITYSDK_OFFSET(0x15C82B50)
#define CLASS_1_FE966CAF6C3A4852_METHOD_1_CFC95121222309BD_OFFSET UNITYSDK_OFFSET(0x15C82A60)
#define CLASS_1_FE966CAF6C3A4852_METHOD_1_EBEE0D0A222A8264_OFFSET UNITYSDK_OFFSET(0x15C82C10)
#define CLASS_1_FE966CAF6C3A4852__CTOR_OFFSET UNITYSDK_OFFSET(0x15C82D80)

inline static constexpr unsigned int Class_1_FE966CAF6C3A4852_TypeDefinitionIndex = 68569;
