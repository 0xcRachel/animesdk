...
#define CLASS_1_FD711FBD7923B1D0_CLEAR_OFFSET UNITYSDK_OFFSET(0xFF256B0)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_127D8F0899EE0E05_1_OFFSET UNITYSDK_OFFSET(0xFF25E40)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_127D8F0899EE0E05_OFFSET UNITYSDK_OFFSET(0xFF25D80)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0xFF26500)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_28C026B8C4636DE1_OFFSET UNITYSDK_OFFSET(0xFF25120)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_43A8DE046F4EECDF_OFFSET UNITYSDK_OFFSET(0xFF26190)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_459C79521BFE514E_OFFSET UNITYSDK_OFFSET(0xFF252B0)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_5323F2DF46A044DA_OFFSET UNITYSDK_OFFSET(0xFF264E0)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_54B5B5830A8571CA_OFFSET UNITYSDK_OFFSET(0xFF260F0)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_91187CD66EC46EC3_OFFSET UNITYSDK_OFFSET(0xFF250C0)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_A5D5316A3D985EE0_OFFSET UNITYSDK_OFFSET(0xFF25CE0)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_AD23FDCC7576BB32_OFFSET UNITYSDK_OFFSET(0xFF25710)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_AF36EBA0C8D1FBA2_OFFSET UNITYSDK_OFFSET(0xFF257C0)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_BED72B59CF367BE4_OFFSET UNITYSDK_OFFSET(0xFF25F20)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xFF264F0)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_FAC9AC7514103353_OFFSET UNITYSDK_OFFSET(0xFF264D0)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0xFF26470)
#define CLASS_1_FD711FBD7923B1D0__CTOR_OFFSET UNITYSDK_OFFSET(0xFF26560)

inline static constexpr unsigned int Class_1_FD711FBD7923B1D0_TypeDefinitionIndex = 47338;

class Class_1_FD711FBD7923B1D0 : public ::System::Object
{
public:
	::RPG::Client::AirlineBirdWay_CurveRange Field_1_10; // 0x10
	::RPG::Client::AirlineBirdWay_CurveRange Field_1_12; // 0x30
	::RPG::Client::AirshipBird* Field_1_2; // 0x50
	::Struct_2_BBE13FFEB7E1D73E Field_1_1; // 0x58
	::RPG::Client::AirlineBirdWay_CurveRange Field_1_11; // 0xA0
	::Class_1_FD711FBD7923B1D0_Phase Field_1_5; // 0xC0
	::System::Single Field_1_0; // 0xC4
	::Class_1_FD711FBD7923B1D0_Phase Field_1_6; // 0xC8
	::Class_1_FD711FBD7923B1D0_Phase Field_1_4; // 0xCC
	::System::Single Field_1_3; // 0xD0
	::System::Single Field_1_8; // 0xD4
	::System::Single Field_1_7; // 0xD8
	::System::Single Field_1_9; // 0xDC
