...
#define CLASS_1_FD711FBD7923B1D0_CLEAR_OFFSET UNITYSDK_OFFSET(0x1136C880)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_127D8F0899EE0E05_1_OFFSET UNITYSDK_OFFSET(0x1136D020)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_127D8F0899EE0E05_OFFSET UNITYSDK_OFFSET(0x1136CF60)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x1136D6D0)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_28C026B8C4636DE1_OFFSET UNITYSDK_OFFSET(0x1136C2F0)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_43A8DE046F4EECDF_OFFSET UNITYSDK_OFFSET(0x1136D360)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_459C79521BFE514E_OFFSET UNITYSDK_OFFSET(0x1136C480)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_5323F2DF46A044DA_OFFSET UNITYSDK_OFFSET(0x1136D6B0)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_54B5B5830A8571CA_OFFSET UNITYSDK_OFFSET(0x1136D2C0)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_91187CD66EC46EC3_OFFSET UNITYSDK_OFFSET(0x1136C290)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_A5D5316A3D985EE0_OFFSET UNITYSDK_OFFSET(0x1136CEC0)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_AD23FDCC7576BB32_OFFSET UNITYSDK_OFFSET(0x1136C8F0)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_AF36EBA0C8D1FBA2_OFFSET UNITYSDK_OFFSET(0x1136C9A0)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_BED72B59CF367BE4_OFFSET UNITYSDK_OFFSET(0x1136D0F0)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1136D6C0)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_FAC9AC7514103353_OFFSET UNITYSDK_OFFSET(0x1136D6A0)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0x1136D640)
#define CLASS_1_FD711FBD7923B1D0__CTOR_OFFSET UNITYSDK_OFFSET(0x1136D730)
...
public:
	...
	::RPG::Client::AirlineBirdWay_CurveRange Field_1_12; // 0x18
	::RPG::Client::AirlineBirdWay_CurveRange Field_1_10; // 0x38
	::Struct_2_BBE13FFEB7E1D73E Field_1_1; // 0x58
	::RPG::Client::AirlineBirdWay_CurveRange Field_1_11; // 0xA0
	::System::Single Field_1_3; // 0xC0
	::System::Single Field_1_9; // 0xC4
	::Class_1_FD711FBD7923B1D0_Phase Field_1_5; // 0xC8
	::System::Single Field_1_8; // 0xCC
	::System::Single Field_1_0; // 0xD0
	::Class_1_FD711FBD7923B1D0_Phase Field_1_6; // 0xD4
