...
#define CLASS_1_FD711FBD7923B1D0_CLEAR_OFFSET UNITYSDK_OFFSET(0xF7D1250)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_127D8F0899EE0E05_1_OFFSET UNITYSDK_OFFSET(0xF7D19E0)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_127D8F0899EE0E05_OFFSET UNITYSDK_OFFSET(0xF7D1920)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0xF7D20A0)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_28C026B8C4636DE1_OFFSET UNITYSDK_OFFSET(0xF7D0CC0)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_43A8DE046F4EECDF_OFFSET UNITYSDK_OFFSET(0xF7D1D30)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_459C79521BFE514E_OFFSET UNITYSDK_OFFSET(0xF7D0E50)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_5323F2DF46A044DA_OFFSET UNITYSDK_OFFSET(0xF7D2080)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_54B5B5830A8571CA_OFFSET UNITYSDK_OFFSET(0xF7D1C90)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_91187CD66EC46EC3_OFFSET UNITYSDK_OFFSET(0xF7D0C60)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_A5D5316A3D985EE0_OFFSET UNITYSDK_OFFSET(0xF7D1880)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_AD23FDCC7576BB32_OFFSET UNITYSDK_OFFSET(0xF7D12B0)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_AF36EBA0C8D1FBA2_OFFSET UNITYSDK_OFFSET(0xF7D1360)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_BED72B59CF367BE4_OFFSET UNITYSDK_OFFSET(0xF7D1AC0)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xF7D2090)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_FAC9AC7514103353_OFFSET UNITYSDK_OFFSET(0xF7D2070)
#define CLASS_1_FD711FBD7923B1D0_METHOD_1_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0xF7D2010)
#define CLASS_1_FD711FBD7923B1D0__CTOR_OFFSET UNITYSDK_OFFSET(0xF7D2100)
...
public:
	...
	::RPG::Client::AirlineBirdWay_CurveRange Field_1_10; // 0x18
	::RPG::Client::AirlineBirdWay_CurveRange Field_1_12; // 0x38
	::Struct_2_BBE13FFEB7E1D73E Field_1_1; // 0x58
	::RPG::Client::AirlineBirdWay_CurveRange Field_1_11; // 0xA0
	::Class_1_FD711FBD7923B1D0_Phase Field_1_4; // 0xC0
	::Class_1_FD711FBD7923B1D0_Phase Field_1_6; // 0xC4
	::System::Single Field_1_7; // 0xC8
	::System::Single Field_1_3; // 0xCC
	::System::Single Field_1_8; // 0xD0
	::System::Single Field_1_0; // 0xD4
	::Class_1_FD711FBD7923B1D0_Phase Field_1_5; // 0xD8
