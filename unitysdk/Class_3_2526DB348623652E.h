...
#define CLASS_3_2526DB348623652E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x86038E0)
#define CLASS_3_2526DB348623652E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x8603930)
#define CLASS_3_2526DB348623652E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x8603A80)
#define CLASS_3_2526DB348623652E_TICK_OFFSET UNITYSDK_OFFSET(0x8603A20)
#define CLASS_3_2526DB348623652E__CTOR_OFFSET UNITYSDK_OFFSET(0x8603850)
#define CLASS_3_2526DB348623652E___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8603B10)
#define CLASS_3_2526DB348623652E___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x8603B60)

inline static constexpr unsigned int Class_3_2526DB348623652E_TypeDefinitionIndex = 41191;
