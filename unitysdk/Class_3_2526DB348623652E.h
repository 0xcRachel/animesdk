...
#define CLASS_3_2526DB348623652E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17C67AC0)
#define CLASS_3_2526DB348623652E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17C67B10)
#define CLASS_3_2526DB348623652E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x17C67C60)
#define CLASS_3_2526DB348623652E_TICK_OFFSET UNITYSDK_OFFSET(0x17C67C00)
#define CLASS_3_2526DB348623652E__CTOR_OFFSET UNITYSDK_OFFSET(0x17C67A30)
#define CLASS_3_2526DB348623652E___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17C67D00)
#define CLASS_3_2526DB348623652E___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x17C67D50)
