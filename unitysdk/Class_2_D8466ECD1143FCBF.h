...
#define CLASS_2_D8466ECD1143FCBF_METHOD_2_9A4B8D8B70CE3845_OFFSET UNITYSDK_OFFSET(0xD4BCED0)
#define CLASS_2_D8466ECD1143FCBF__CTOR_OFFSET UNITYSDK_OFFSET(0xD4BCF30)
#define CLASS_2_D8466ECD1143FCBF__ONBIND_OFFSET UNITYSDK_OFFSET(0xD4BCE50)
#define CLASS_2_D8466ECD1143FCBF___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0xD4BCF60)

inline static constexpr unsigned int Class_2_D8466ECD1143FCBF_TypeDefinitionIndex = 65992;
