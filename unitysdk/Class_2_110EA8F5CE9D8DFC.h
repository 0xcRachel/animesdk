...
#define CLASS_2_110EA8F5CE9D8DFC_DISPOSE_OFFSET UNITYSDK_OFFSET(0x103B1A50)
#define CLASS_2_110EA8F5CE9D8DFC_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x103B1A90)
#define CLASS_2_110EA8F5CE9D8DFC_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x103B1C20)
#define CLASS_2_110EA8F5CE9D8DFC_TICK_OFFSET UNITYSDK_OFFSET(0x103B1C70)
#define CLASS_2_110EA8F5CE9D8DFC__CTOR_OFFSET UNITYSDK_OFFSET(0x103B1A40)

inline static constexpr unsigned int Class_2_110EA8F5CE9D8DFC_TypeDefinitionIndex = 46269;
