...
#define MICROSOFT_WIN32_WIN32NATIVE_GETCURRENTPROCESSID_OFFSET UNITYSDK_OFFSET(0x161779D0)
#define MICROSOFT_WIN32_WIN32NATIVE_GETMESSAGE_OFFSET UNITYSDK_OFFSET(0x161778F0)
#define MICROSOFT_WIN32_WIN32NATIVE_MAKEHRFROMERRORCODE_OFFSET UNITYSDK_OFFSET(0x161779C0)
