...
#define CLASS_1_5B567C8A01BAEDFE_152_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A146450)
#define CLASS_1_5B567C8A01BAEDFE_152_CLONE_OFFSET UNITYSDK_OFFSET(0x1A146260)
#define CLASS_1_5B567C8A01BAEDFE_152_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A146360)
#define CLASS_1_5B567C8A01BAEDFE_152_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A1462D0)
#define CLASS_1_5B567C8A01BAEDFE_152_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A1463B0)
#define CLASS_1_5B567C8A01BAEDFE_152_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A1464A0)
#define CLASS_1_5B567C8A01BAEDFE_152_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A146470)
#define CLASS_1_5B567C8A01BAEDFE_152_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A1461B0)
#define CLASS_1_5B567C8A01BAEDFE_152_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A146210)
#define CLASS_1_5B567C8A01BAEDFE_152_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A1463E0)
#define CLASS_1_5B567C8A01BAEDFE_152_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A146440)
#define CLASS_1_5B567C8A01BAEDFE_152__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1464F0)
#define CLASS_1_5B567C8A01BAEDFE_152__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A146230)
#define CLASS_1_5B567C8A01BAEDFE_152__CTOR_OFFSET UNITYSDK_OFFSET(0x1A146220)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_152*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_152_TypeDefinitionIndex)->GetStaticField(0x103F0);
	}
