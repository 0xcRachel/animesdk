...
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x8780350)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_166FCE95AF172ABC_OFFSET UNITYSDK_OFFSET(0x877FDE0)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_23EFCEB999C1D825_OFFSET UNITYSDK_OFFSET(0x8781A40)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x8780610)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x87805B0)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x8780550)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_434D975D1E08E041_OFFSET UNITYSDK_OFFSET(0x8780A30)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0x877FF30)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_5903A6947D49E37C_OFFSET UNITYSDK_OFFSET(0x8780AA0)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_79830F666EE579C0_OFFSET UNITYSDK_OFFSET(0x8780400)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_9999F3E4D60BFCCC_OFFSET UNITYSDK_OFFSET(0x8781440)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x8781600)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_CA6BDDCC5F7CE11E_OFFSET UNITYSDK_OFFSET(0x8780660)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_D3129FE8DF635B48_OFFSET UNITYSDK_OFFSET(0x8781670)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_DBDE806671808CE7_OFFSET UNITYSDK_OFFSET(0x87809B0)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_E8F71BC8471C5469_OFFSET UNITYSDK_OFFSET(0x877FED0)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_EB89FD9C9EC162AB_OFFSET UNITYSDK_OFFSET(0x87806F0)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_EF17FAB3022DE07B_1_OFFSET UNITYSDK_OFFSET(0x8780FF0)
#define CLASS_1_7AAE8FA406499FBF_METHOD_1_EF17FAB3022DE07B_OFFSET UNITYSDK_OFFSET(0x8780B90)
#define CLASS_1_7AAE8FA406499FBF__CTOR_OFFSET UNITYSDK_OFFSET(0x877FDF0)

inline static constexpr unsigned int Class_1_7AAE8FA406499FBF_TypeDefinitionIndex = 58569;

class Class_1_7AAE8FA406499FBF : public ::System::Object
{
public:
	::Class_1_BCECFCD0C8771868* Field_1_6; // 0x10
	::Class_1_BCECFCD0C8771868* Field_1_9; // 0x18
	::RPG::Client::MonoEmoPlayableGraph* Field_1_2; // 0x20
	::UnityEngine::Animator* Field_1_1; // 0x28
	::UnityEngine::AnimationClip* Field_1_17; // 0x30
	::System::String* Field_1_0; // 0x38
	::UnityEngine::AnimationClip* Field_1_18; // 0x40
	::UnityEngine::AnimationClip* Field_1_15; // 0x48
	::UnityEngine::AnimationClip* Field_1_14; // 0x50
	::Class_1_BCECFCD0C8771868* Field_1_5; // 0x58
	::UnityEngine::AnimationClip* Field_1_16; // 0x60
	::Class_1_BCECFCD0C8771868* Field_1_11; // 0x68
	::Class_1_BCECFCD0C8771868* Field_1_8; // 0x70
	::System::Int32 Field_1_19; // 0x78
	::System::Single Field_1_23; // 0x7C
	::System::Single Field_1_24; // 0x80
	::System::Single Field_1_20; // 0x84
	::UnityEngine::Animations::AnimationPlayableOutput Field_1_12; // 0x88
	::UnityEngine::Animations::AnimationPlayableOutput Field_1_4; // 0x98
	::UnityEngine::Animations::AnimationPlayableOutput Field_1_10; // 0xA8
	::UnityEngine::Animations::AnimationPlayableOutput Field_1_7; // 0xB8
	::System::Single Field_1_22; // 0xC8
	::System::Single Field_1_21; // 0xCC
	::UnityEngine::Animations::AnimationLayerMixerPlayable Field_1_13; // 0xD0
