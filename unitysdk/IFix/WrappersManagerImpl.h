...
#define IFIX_WRAPPERSMANAGERIMPL_CREATEBRIDGE_OFFSET UNITYSDK_OFFSET(0xF427740)
#define IFIX_WRAPPERSMANAGERIMPL_CREATEDELEGATE_OFFSET UNITYSDK_OFFSET(0xF427650)
#define IFIX_WRAPPERSMANAGERIMPL_CREATEWRAPPER_OFFSET UNITYSDK_OFFSET(0xF4276E0)
#define IFIX_WRAPPERSMANAGERIMPL_GETPATCH_OFFSET UNITYSDK_OFFSET(0xF4275C0)
#define IFIX_WRAPPERSMANAGERIMPL_INITWRAPPERARRAY_OFFSET UNITYSDK_OFFSET(0xF427710)
#define IFIX_WRAPPERSMANAGERIMPL_ISPATCHED_OFFSET UNITYSDK_OFFSET(0xF427600)
#define IFIX_WRAPPERSMANAGERIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0xF4275B0)

namespace IFix
{
	inline static constexpr unsigned int WrappersManagerImpl_TypeDefinitionIndex = 72698;
