...
#define IFIX_CORE_REFLECTIONMETHODINVOKER_GET_DECLARINGTYPE_OFFSET UNITYSDK_OFFSET(0x15449B00)
#define IFIX_CORE_REFLECTIONMETHODINVOKER_INVOKE_OFFSET UNITYSDK_OFFSET(0x15449B40)
#define IFIX_CORE_REFLECTIONMETHODINVOKER__CTOR_OFFSET UNITYSDK_OFFSET(0x15449390)

namespace IFix::Core
{
	inline static constexpr unsigned int ReflectionMethodInvoker_TypeDefinitionIndex = 9340;

	class ReflectionMethodInvoker : public ::System::Object
	{
	public:
		::Il2CppArray<::System::Boolean>* refFlags; // 0x10
		::System::Type* returnType; // 0x18
		::Il2CppArray<::System::Type*>* rawTypes; // 0x20
		::System::Reflection::ConstructorInfo* ctor; // 0x28
		::System::Reflection::MethodBase* method; // 0x30
		::System::Type* mDeclaringType; // 0x38
		::Il2CppArray<::System::Boolean>* outFlags; // 0x40
		::IFix::Core::TypeInfo* retTypeInfo; // 0x48
		::System::Boolean isNullableValue; // 0x50
		::System::Boolean hasThis; // 0x51
		::System::Boolean hasReturn; // 0x52
