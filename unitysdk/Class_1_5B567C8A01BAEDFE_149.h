...
#define CLASS_1_5B567C8A01BAEDFE_149_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19C22010)
#define CLASS_1_5B567C8A01BAEDFE_149_CLONE_OFFSET UNITYSDK_OFFSET(0x19C21E20)
#define CLASS_1_5B567C8A01BAEDFE_149_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19C21F20)
#define CLASS_1_5B567C8A01BAEDFE_149_EQUALS_OFFSET UNITYSDK_OFFSET(0x19C21E90)
#define CLASS_1_5B567C8A01BAEDFE_149_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19C21F70)
#define CLASS_1_5B567C8A01BAEDFE_149_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19C22060)
#define CLASS_1_5B567C8A01BAEDFE_149_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19C22030)
#define CLASS_1_5B567C8A01BAEDFE_149_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19C21D70)
#define CLASS_1_5B567C8A01BAEDFE_149_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19C21DD0)
#define CLASS_1_5B567C8A01BAEDFE_149_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19C21FA0)
#define CLASS_1_5B567C8A01BAEDFE_149_WRITETO_OFFSET UNITYSDK_OFFSET(0x19C22000)
#define CLASS_1_5B567C8A01BAEDFE_149__CCTOR_OFFSET UNITYSDK_OFFSET(0x19C220B0)
#define CLASS_1_5B567C8A01BAEDFE_149__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19C21DF0)
#define CLASS_1_5B567C8A01BAEDFE_149__CTOR_OFFSET UNITYSDK_OFFSET(0x19C21DE0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_149*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_149_TypeDefinitionIndex)->GetStaticField(0x5A640);
	}
