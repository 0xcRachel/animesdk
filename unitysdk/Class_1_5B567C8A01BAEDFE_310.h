...
#define CLASS_1_5B567C8A01BAEDFE_310_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19C18390)
#define CLASS_1_5B567C8A01BAEDFE_310_CLONE_OFFSET UNITYSDK_OFFSET(0x19C18200)
#define CLASS_1_5B567C8A01BAEDFE_310_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19C182A0)
#define CLASS_1_5B567C8A01BAEDFE_310_EQUALS_OFFSET UNITYSDK_OFFSET(0x19C18240)
#define CLASS_1_5B567C8A01BAEDFE_310_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19C182F0)
#define CLASS_1_5B567C8A01BAEDFE_310_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19C183E0)
#define CLASS_1_5B567C8A01BAEDFE_310_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19C183B0)
#define CLASS_1_5B567C8A01BAEDFE_310_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19C18180)
#define CLASS_1_5B567C8A01BAEDFE_310_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19C181B0)
#define CLASS_1_5B567C8A01BAEDFE_310_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19C18320)
#define CLASS_1_5B567C8A01BAEDFE_310_WRITETO_OFFSET UNITYSDK_OFFSET(0x19C18380)
#define CLASS_1_5B567C8A01BAEDFE_310__CCTOR_OFFSET UNITYSDK_OFFSET(0x19C18430)
#define CLASS_1_5B567C8A01BAEDFE_310__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19C181D0)
#define CLASS_1_5B567C8A01BAEDFE_310__CTOR_OFFSET UNITYSDK_OFFSET(0x19C181C0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_310*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_310_TypeDefinitionIndex)->GetStaticField(0x3AE60);
	}
