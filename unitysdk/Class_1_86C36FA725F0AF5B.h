...
#define CLASS_1_86C36FA725F0AF5B_GET_MULTIPLEPATHCONFIGREPOSITORY_OFFSET UNITYSDK_OFFSET(0xD4EC6D0)
#define CLASS_1_86C36FA725F0AF5B_GET_PROPERTYCALCULATOR_OFFSET UNITYSDK_OFFSET(0xD4EC6B0)
#define CLASS_1_86C36FA725F0AF5B_GET_SERVANTREPOSITORY_OFFSET UNITYSDK_OFFSET(0xD4EC670)
#define CLASS_1_86C36FA725F0AF5B_GET_SERVANTSKILLREPOSITORY_OFFSET UNITYSDK_OFFSET(0xD4EC690)
#define CLASS_1_86C36FA725F0AF5B_METHOD_1_0F4B0D4257A65E23_OFFSET UNITYSDK_OFFSET(0xD4ECAC0)
#define CLASS_1_86C36FA725F0AF5B_METHOD_1_3C5F8E3777877644_OFFSET UNITYSDK_OFFSET(0xD4EC9A0)
#define CLASS_1_86C36FA725F0AF5B_METHOD_1_4A6A1943BE9D6C19_OFFSET UNITYSDK_OFFSET(0xD4ECCB0)
#define CLASS_1_86C36FA725F0AF5B_METHOD_1_95A45E456041E511_OFFSET UNITYSDK_OFFSET(0xD4ECA30)
#define CLASS_1_86C36FA725F0AF5B_METHOD_1_DA51D85034074E83_OFFSET UNITYSDK_OFFSET(0xD4EC6F0)
#define CLASS_1_86C36FA725F0AF5B_SET_MULTIPLEPATHCONFIGREPOSITORY_OFFSET UNITYSDK_OFFSET(0xD4EC6E0)
#define CLASS_1_86C36FA725F0AF5B_SET_PROPERTYCALCULATOR_OFFSET UNITYSDK_OFFSET(0xD4EC6C0)
#define CLASS_1_86C36FA725F0AF5B_SET_SERVANTREPOSITORY_OFFSET UNITYSDK_OFFSET(0xD4EC680)
#define CLASS_1_86C36FA725F0AF5B_SET_SERVANTSKILLREPOSITORY_OFFSET UNITYSDK_OFFSET(0xD4EC6A0)
#define CLASS_1_86C36FA725F0AF5B__CTOR_OFFSET UNITYSDK_OFFSET(0xD4ECEC0)
...
{
public:
	::Class_1_10B66F9FBD70F037* _MultiplePathConfigRepository_k__BackingField; // 0x10
	...
	::Class_1_F86E0BB362A55B9C* Method_1_DA51D85034074E83(::Struct_2_BC950E36747FB4C9& a1, ::Class_0_16E4307DCC419505_367* a2, ::RPG::AvatarSystem::Property::IPropertyContext_1<::RPG::GameCore::FixPoint>* a3, ::Class_0_16E4307DCC419505_368* a4, ::Il2CppArray<::Class_0_16E4307DCC419505_367*>* a5)
	{
		return ((::Class_1_F86E0BB362A55B9C*(*)(::PVOID, ::Struct_2_BC950E36747FB4C9&, ::Class_0_16E4307DCC419505_367*, ::RPG::AvatarSystem::Property::IPropertyContext_1<::RPG::GameCore::FixPoint>*, ::Class_0_16E4307DCC419505_368*, ::Il2CppArray<::Class_0_16E4307DCC419505_367*>*))((::PBYTE)hIl2Cpp + CLASS_1_86C36FA725F0AF5B_METHOD_1_DA51D85034074E83_OFFSET))(this, a1, a2, a3, a4, a5);
	}
