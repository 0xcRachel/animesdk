...
#define CLASS_1_B8CEC01F5C43CB98_GET_TARGETREGION_OFFSET UNITYSDK_OFFSET(0x10C813A0)
#define CLASS_1_B8CEC01F5C43CB98_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x10C813C0)
#define CLASS_1_B8CEC01F5C43CB98_METHOD_1_4C27DE82B2DFE27A_OFFSET UNITYSDK_OFFSET(0x10C81280)
#define CLASS_1_B8CEC01F5C43CB98_METHOD_1_6270D564028DED48_OFFSET UNITYSDK_OFFSET(0x10C809E0)
#define CLASS_1_B8CEC01F5C43CB98_METHOD_1_6288DC7D79FB18A9_OFFSET UNITYSDK_OFFSET(0x10C81420)
#define CLASS_1_B8CEC01F5C43CB98_METHOD_1_9C56B419ED8389BC_OFFSET UNITYSDK_OFFSET(0x10C80DC0)
#define CLASS_1_B8CEC01F5C43CB98_METHOD_1_9CA5A80F6B5B9E01_OFFSET UNITYSDK_OFFSET(0x10C81370)
#define CLASS_1_B8CEC01F5C43CB98_METHOD_1_A8CB5027BF8B913B_1_OFFSET UNITYSDK_OFFSET(0x10C81000)
#define CLASS_1_B8CEC01F5C43CB98_METHOD_1_A8CB5027BF8B913B_OFFSET UNITYSDK_OFFSET(0x10C80B40)
#define CLASS_1_B8CEC01F5C43CB98_METHOD_1_AA2D3E889C8A52CA_OFFSET UNITYSDK_OFFSET(0x10C81320)
#define CLASS_1_B8CEC01F5C43CB98_METHOD_1_BFA17A8366EA8C77_OFFSET UNITYSDK_OFFSET(0x10C80810)
#define CLASS_1_B8CEC01F5C43CB98_METHOD_1_D64FD9A228A1C4E0_OFFSET UNITYSDK_OFFSET(0x10C80FA0)
#define CLASS_1_B8CEC01F5C43CB98_METHOD_1_F0E307B84478A272_OFFSET UNITYSDK_OFFSET(0x10C81380)
#define CLASS_1_B8CEC01F5C43CB98_METHOD_1_F978A1D172468895_OFFSET UNITYSDK_OFFSET(0x10C80880)
#define CLASS_1_B8CEC01F5C43CB98_METHOD_1_FB4BE762B6186C23_OFFSET UNITYSDK_OFFSET(0x10C81430)
#define CLASS_1_B8CEC01F5C43CB98_SET_TARGETREGION_OFFSET UNITYSDK_OFFSET(0x10C813B0)
#define CLASS_1_B8CEC01F5C43CB98__CTOR_OFFSET UNITYSDK_OFFSET(0x10C80390)
...
{
public:
	::Class_1_ECBCF86CDE61CBCA* _TargetRegion_k__BackingField; // 0x10
	::Class_1_ECBCF86CDE61CBCA* Field_1_1; // 0x18
	::UnityEngine::GameObject* Field_1_3; // 0x20
	::System::Collections::Generic::List_1<::RPG::Client::RuntimeRegionVolume*>* Field_1_5; // 0x28
	::System::Collections::Generic::List_1<::RPG::Client::RuntimeRegionVolume*>* Field_1_4; // 0x30
	::RPG::GameCore::StageRegionConnection* Field_1_2; // 0x38
