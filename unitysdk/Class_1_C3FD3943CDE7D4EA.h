...
#define CLASS_1_C3FD3943CDE7D4EA__CTOR_OFFSET UNITYSDK_OFFSET(0xD870870)

inline static constexpr unsigned int Class_1_C3FD3943CDE7D4EA_TypeDefinitionIndex = 42455;

class Class_1_C3FD3943CDE7D4EA : public ::System::Object
{
public:
	::RPG::GameCore::TaskContext* Field_1_0; // 0x10
	::Class_1_843DD6330B22E422* Field_1_2; // 0x18
	::RPG::GameCore::DamageByAttackProperty* Field_1_1; // 0x20
