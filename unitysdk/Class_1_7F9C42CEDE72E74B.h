...
#define CLASS_1_7F9C42CEDE72E74B_CLEAR_OFFSET UNITYSDK_OFFSET(0x1202FCD0)
#define CLASS_1_7F9C42CEDE72E74B__CTOR_OFFSET UNITYSDK_OFFSET(0x1202FD20)
...
public:
	...
	::RPG::GameCore::ElationPointModifyFunction Field_1_3; // 0x28
