...
#define CLASS_3_2710B1AB57C713F9_EVALUATE_OFFSET UNITYSDK_OFFSET(0x96C8D20)
#define CLASS_3_2710B1AB57C713F9__CTOR_OFFSET UNITYSDK_OFFSET(0x96C8CC0)

inline static constexpr unsigned int Class_3_2710B1AB57C713F9_TypeDefinitionIndex = 41164;
