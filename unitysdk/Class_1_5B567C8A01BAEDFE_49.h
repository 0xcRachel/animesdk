...
#define CLASS_1_5B567C8A01BAEDFE_49_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A364560)
#define CLASS_1_5B567C8A01BAEDFE_49_CLONE_OFFSET UNITYSDK_OFFSET(0x1A364370)
#define CLASS_1_5B567C8A01BAEDFE_49_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A364470)
#define CLASS_1_5B567C8A01BAEDFE_49_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A3643E0)
#define CLASS_1_5B567C8A01BAEDFE_49_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A3644C0)
#define CLASS_1_5B567C8A01BAEDFE_49_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A3645B0)
#define CLASS_1_5B567C8A01BAEDFE_49_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A364580)
#define CLASS_1_5B567C8A01BAEDFE_49_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A3642C0)
#define CLASS_1_5B567C8A01BAEDFE_49_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A364320)
#define CLASS_1_5B567C8A01BAEDFE_49_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A3644F0)
#define CLASS_1_5B567C8A01BAEDFE_49_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A364550)
#define CLASS_1_5B567C8A01BAEDFE_49__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A364600)
#define CLASS_1_5B567C8A01BAEDFE_49__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A364340)
#define CLASS_1_5B567C8A01BAEDFE_49__CTOR_OFFSET UNITYSDK_OFFSET(0x1A364330)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_49*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_49_TypeDefinitionIndex)->GetStaticField(0x35EB0);
	}
