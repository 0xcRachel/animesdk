...
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_SRDEBUGSERVICE___C__DISPLAYCLASS45_0__CTOR_OFFSET UNITYSDK_OFFSET(0x17C43550)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_SRDEBUGSERVICE___C__DISPLAYCLASS45_0__SHOWBUGREPORTSHEET_B__0_OFFSET UNITYSDK_OFFSET(0x17C43AA0)

namespace SRDebugger::Services::Implementation
{
	inline static constexpr unsigned int SRDebugService___c__DisplayClass45_0_TypeDefinitionIndex = 28858;
