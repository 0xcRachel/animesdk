...
#define SRDEBUGGER_OPTIONDEFINITIONINITPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x17C32190)

namespace SRDebugger
{
	inline static constexpr unsigned int OptionDefinitionInitParams_TypeDefinitionIndex = 28725;
