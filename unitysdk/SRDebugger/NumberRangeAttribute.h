...
#define SRDEBUGGER_NUMBERRANGEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x17C32430)

namespace SRDebugger
{
	inline static constexpr unsigned int NumberRangeAttribute_TypeDefinitionIndex = 28730;
