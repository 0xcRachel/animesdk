...
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE__ENDOFFRAMECOROUTINE_D__20_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x17C33BA0)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE__ENDOFFRAMECOROUTINE_D__20_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x17C33C30)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE__ENDOFFRAMECOROUTINE_D__20_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x17C33C90)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE__ENDOFFRAMECOROUTINE_D__20_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x17C33C40)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE__ENDOFFRAMECOROUTINE_D__20_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17C33B90)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE__ENDOFFRAMECOROUTINE_D__20__CTOR_OFFSET UNITYSDK_OFFSET(0x17C33A40)

namespace SRDebugger::Profiler
{
	inline static constexpr unsigned int SRPProfilerService__EndOfFrameCoroutine_d__20_TypeDefinitionIndex = 28866;
