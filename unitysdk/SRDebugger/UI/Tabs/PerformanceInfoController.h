...
#define SRDEBUGGER_UI_TABS_PERFORMANCEINFOCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA6819E0)

namespace SRDebugger::UI::Tabs
{
	inline static constexpr unsigned int PerformanceInfoController_TypeDefinitionIndex = 37624;
