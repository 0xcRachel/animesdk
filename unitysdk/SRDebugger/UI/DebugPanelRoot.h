...
#define SRDEBUGGER_UI_DEBUGPANELROOT_CLOSEANDDESTROY_OFFSET UNITYSDK_OFFSET(0x17C55480)
#define SRDEBUGGER_UI_DEBUGPANELROOT_CLOSE_OFFSET UNITYSDK_OFFSET(0x17C55300)
#define SRDEBUGGER_UI_DEBUGPANELROOT__CTOR_OFFSET UNITYSDK_OFFSET(0x17C55500)

namespace SRDebugger::UI
{
	inline static constexpr unsigned int DebugPanelRoot_TypeDefinitionIndex = 28754;
