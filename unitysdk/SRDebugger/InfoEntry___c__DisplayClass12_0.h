...
#define SRDEBUGGER_INFOENTRY___C__DISPLAYCLASS12_0__CREATE_B__0_OFFSET UNITYSDK_OFFSET(0x17C2E3E0)
#define SRDEBUGGER_INFOENTRY___C__DISPLAYCLASS12_0__CTOR_OFFSET UNITYSDK_OFFSET(0x17C2E3D0)

namespace SRDebugger
{
	inline static constexpr unsigned int InfoEntry___c__DisplayClass12_0_TypeDefinitionIndex = 28740;
