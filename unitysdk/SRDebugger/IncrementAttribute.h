...
#define SRDEBUGGER_INCREMENTATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x17C2E190)

namespace SRDebugger
{
	inline static constexpr unsigned int IncrementAttribute_TypeDefinitionIndex = 28731;
