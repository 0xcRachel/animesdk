...
#define CLASS_2_7A8F7ACF0C7369F4_METHOD_2_FBF2CB29FD3B55E6_OFFSET UNITYSDK_OFFSET(0xEA04820)
#define CLASS_2_7A8F7ACF0C7369F4__CHECKNEEDREBUILD_OFFSET UNITYSDK_OFFSET(0xEA04870)
#define CLASS_2_7A8F7ACF0C7369F4__CTOR_OFFSET UNITYSDK_OFFSET(0xEA040C0)
#define CLASS_2_7A8F7ACF0C7369F4__REBUILD_OFFSET UNITYSDK_OFFSET(0xEA04160)

inline static constexpr unsigned int Class_2_7A8F7ACF0C7369F4_TypeDefinitionIndex = 69189;
...
{
public:
	::RPG::Client::ActivityIdleLive::IdleLiveBaseTeamInfo* Field_2_2; // 0x20
	::RPG::Client::ActivityIdleLive::IIdleLiveAvatarData* Field_2_0; // 0x28
	::RPG::Client::ActivityIdleLive::SpEquipSlotInfo* Field_2_1; // 0x30
