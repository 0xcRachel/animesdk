...
#define AKEVENTTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x18BBF760)
#define AKEVENTTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18BBFC20)
#define AKEVENTTRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x18BBFD00)
