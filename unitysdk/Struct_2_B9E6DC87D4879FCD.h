...
#define STRUCT_2_B9E6DC87D4879FCD_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3931C40)
#define STRUCT_2_B9E6DC87D4879FCD_EQUALS_OFFSET UNITYSDK_OFFSET(0x3931B80)
#define STRUCT_2_B9E6DC87D4879FCD_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3931C50)
#define STRUCT_2_B9E6DC87D4879FCD_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3931B70)
#define STRUCT_2_B9E6DC87D4879FCD__CTOR_1_OFFSET UNITYSDK_OFFSET(0x38842A0)
#define STRUCT_2_B9E6DC87D4879FCD__CTOR_2_OFFSET UNITYSDK_OFFSET(0x6CA9D0)
#define STRUCT_2_B9E6DC87D4879FCD__CTOR_OFFSET UNITYSDK_OFFSET(0x3931B50)
#define STRUCT_2_B9E6DC87D4879FCD___IFIXBASEPROXY_EQUALS_OFFSET UNITYSDK_OFFSET(0x3931DC0)
#define STRUCT_2_B9E6DC87D4879FCD___IFIXBASEPROXY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3931E10)
#define STRUCT_2_B9E6DC87D4879FCD___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3931D60)
