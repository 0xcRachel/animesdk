...
#define STRUCT_2_B9E6DC87D4879FCD_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x2386C50)
#define STRUCT_2_B9E6DC87D4879FCD_EQUALS_OFFSET UNITYSDK_OFFSET(0x2386B90)
#define STRUCT_2_B9E6DC87D4879FCD_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2386C60)
#define STRUCT_2_B9E6DC87D4879FCD_TOSTRING_OFFSET UNITYSDK_OFFSET(0x2386B80)
#define STRUCT_2_B9E6DC87D4879FCD__CTOR_1_OFFSET UNITYSDK_OFFSET(0x22DF8E0)
#define STRUCT_2_B9E6DC87D4879FCD__CTOR_2_OFFSET UNITYSDK_OFFSET(0x2386B70)
#define STRUCT_2_B9E6DC87D4879FCD__CTOR_OFFSET UNITYSDK_OFFSET(0x2386B50)
#define STRUCT_2_B9E6DC87D4879FCD___IFIXBASEPROXY_EQUALS_OFFSET UNITYSDK_OFFSET(0x2386DE0)
#define STRUCT_2_B9E6DC87D4879FCD___IFIXBASEPROXY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2386E30)
#define STRUCT_2_B9E6DC87D4879FCD___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x2386D80)
