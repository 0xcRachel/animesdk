...
#define CLASS_2_FC54E400239290F6__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1839CB90)
#define CLASS_2_FC54E400239290F6__CTOR_OFFSET UNITYSDK_OFFSET(0x18396440)
...
public:
	...
	::Class_1_60B5E5A0CB5606E4* Field_2_1; // 0xA0
