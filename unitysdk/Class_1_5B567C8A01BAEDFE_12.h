...
#define CLASS_1_5B567C8A01BAEDFE_12_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A9F49E0)
#define CLASS_1_5B567C8A01BAEDFE_12_CLONE_OFFSET UNITYSDK_OFFSET(0x1A9F47F0)
#define CLASS_1_5B567C8A01BAEDFE_12_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A9F48F0)
#define CLASS_1_5B567C8A01BAEDFE_12_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A9F4860)
#define CLASS_1_5B567C8A01BAEDFE_12_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A9F4940)
#define CLASS_1_5B567C8A01BAEDFE_12_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A9F4A30)
#define CLASS_1_5B567C8A01BAEDFE_12_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A9F4A00)
#define CLASS_1_5B567C8A01BAEDFE_12_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A9F4740)
#define CLASS_1_5B567C8A01BAEDFE_12_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A9F47A0)
#define CLASS_1_5B567C8A01BAEDFE_12_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A9F4970)
#define CLASS_1_5B567C8A01BAEDFE_12_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A9F49D0)
#define CLASS_1_5B567C8A01BAEDFE_12__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A9F4A80)
#define CLASS_1_5B567C8A01BAEDFE_12__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A9F47C0)
#define CLASS_1_5B567C8A01BAEDFE_12__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9F47B0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_12*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_12_TypeDefinitionIndex)->GetStaticField(0x19730);
	}
