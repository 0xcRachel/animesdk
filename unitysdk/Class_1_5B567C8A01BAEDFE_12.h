...
#define CLASS_1_5B567C8A01BAEDFE_12_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A215950)
#define CLASS_1_5B567C8A01BAEDFE_12_CLONE_OFFSET UNITYSDK_OFFSET(0x1A215760)
#define CLASS_1_5B567C8A01BAEDFE_12_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A215860)
#define CLASS_1_5B567C8A01BAEDFE_12_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A2157D0)
#define CLASS_1_5B567C8A01BAEDFE_12_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A2158B0)
#define CLASS_1_5B567C8A01BAEDFE_12_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A2159A0)
#define CLASS_1_5B567C8A01BAEDFE_12_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A215970)
#define CLASS_1_5B567C8A01BAEDFE_12_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A2156B0)
#define CLASS_1_5B567C8A01BAEDFE_12_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A215710)
#define CLASS_1_5B567C8A01BAEDFE_12_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A2158E0)
#define CLASS_1_5B567C8A01BAEDFE_12_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A215940)
#define CLASS_1_5B567C8A01BAEDFE_12__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A2159F0)
#define CLASS_1_5B567C8A01BAEDFE_12__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A215730)
#define CLASS_1_5B567C8A01BAEDFE_12__CTOR_OFFSET UNITYSDK_OFFSET(0x1A215720)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_12*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_12_TypeDefinitionIndex)->GetStaticField(0x5B3F0);
	}
