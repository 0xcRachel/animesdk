...
#define STAGEHARMONYAUDIOLINKSLOT_METHOD_2_276036CDF4BFF5A6_OFFSET UNITYSDK_OFFSET(0xA69FA10)
#define STAGEHARMONYAUDIOLINKSLOT_METHOD_2_68EA3BA68D4429F2_OFFSET UNITYSDK_OFFSET(0xA6A05F0)
#define STAGEHARMONYAUDIOLINKSLOT_METHOD_2_8AC834FE1A022C85_OFFSET UNITYSDK_OFFSET(0xA6A0410)
#define STAGEHARMONYAUDIOLINKSLOT_METHOD_2_9EE008B846B09278_OFFSET UNITYSDK_OFFSET(0xA6A0110)
#define STAGEHARMONYAUDIOLINKSLOT_METHOD_2_B15E763C95CF0A5B_OFFSET UNITYSDK_OFFSET(0xA69FBD0)
#define STAGEHARMONYAUDIOLINKSLOT_METHOD_2_C187F11607643D3C_OFFSET UNITYSDK_OFFSET(0xA69FF20)
#define STAGEHARMONYAUDIOLINKSLOT_METHOD_2_D95535B895BF708F_OFFSET UNITYSDK_OFFSET(0xA69FDD0)
#define STAGEHARMONYAUDIOLINKSLOT__CTOR_OFFSET UNITYSDK_OFFSET(0xA6A06E0)

inline static constexpr unsigned int StageHarmonyAudioLinkSlot_TypeDefinitionIndex = 37432;
