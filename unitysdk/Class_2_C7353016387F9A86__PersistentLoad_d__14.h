...
#define CLASS_2_C7353016387F9A86__PERSISTENTLOAD_D__14_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1057EA70)
#define CLASS_2_C7353016387F9A86__PERSISTENTLOAD_D__14_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1057EAB0)
#define CLASS_2_C7353016387F9A86__PERSISTENTLOAD_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1057EB10)
#define CLASS_2_C7353016387F9A86__PERSISTENTLOAD_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1057EAC0)
#define CLASS_2_C7353016387F9A86__PERSISTENTLOAD_D__14_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1057EA60)
#define CLASS_2_C7353016387F9A86__PERSISTENTLOAD_D__14__CTOR_OFFSET UNITYSDK_OFFSET(0x1057D9D0)

inline static constexpr unsigned int Class_2_C7353016387F9A86__PersistentLoad_d__14_TypeDefinitionIndex = 58795;
