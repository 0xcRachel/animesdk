...
#define CLASS_1_9A39EBB29EC3EFA8_METHOD_1_03A81715BD2AFEF3_OFFSET UNITYSDK_OFFSET(0x1146FC00)
#define CLASS_1_9A39EBB29EC3EFA8_METHOD_1_1A8D14D8A3D8DD4C_OFFSET UNITYSDK_OFFSET(0x1146FAF0)
#define CLASS_1_9A39EBB29EC3EFA8_METHOD_1_252C6B30C5B591C3_OFFSET UNITYSDK_OFFSET(0x1146FF50)
#define CLASS_1_9A39EBB29EC3EFA8_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x11470080)
#define CLASS_1_9A39EBB29EC3EFA8_METHOD_1_5C00367CEE393898_OFFSET UNITYSDK_OFFSET(0x1146FFB0)
#define CLASS_1_9A39EBB29EC3EFA8_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1146FF10)
#define CLASS_1_9A39EBB29EC3EFA8__CCTOR_OFFSET UNITYSDK_OFFSET(0x11470120)
#define CLASS_1_9A39EBB29EC3EFA8__CTOR_OFFSET UNITYSDK_OFFSET(0x1146F9C0)

inline static constexpr unsigned int Class_1_9A39EBB29EC3EFA8_TypeDefinitionIndex = 60715;
...
public:
	...
	{
		return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_9A39EBB29EC3EFA8_TypeDefinitionIndex)->GetStaticField(0xA200);
	}
	::Class_1_F3EDFB7664C753E1* Field_1_1; // 0x10
	::Class_1_F3EDFB7664C753E1* Field_1_3; // 0x18
	::Class_1_F3EDFB7664C753E1* Field_1_4; // 0x20
	::System::Collections::Generic::Dictionary_2<::System::String*, ::Class_1_8F355422BD450641*>* Field_1_7; // 0x28
	::Class_1_F3EDFB7664C753E1* Field_1_2; // 0x30
