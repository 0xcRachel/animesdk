...
#define CLASS_1_5B567C8A01BAEDFE_111_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A0B8E90)
#define CLASS_1_5B567C8A01BAEDFE_111_CLONE_OFFSET UNITYSDK_OFFSET(0x1A0B8D00)
#define CLASS_1_5B567C8A01BAEDFE_111_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A0B8DA0)
#define CLASS_1_5B567C8A01BAEDFE_111_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A0B8D40)
#define CLASS_1_5B567C8A01BAEDFE_111_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A0B8DF0)
#define CLASS_1_5B567C8A01BAEDFE_111_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A0B8EE0)
#define CLASS_1_5B567C8A01BAEDFE_111_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A0B8EB0)
#define CLASS_1_5B567C8A01BAEDFE_111_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A0B8C80)
#define CLASS_1_5B567C8A01BAEDFE_111_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A0B8CB0)
#define CLASS_1_5B567C8A01BAEDFE_111_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A0B8E20)
#define CLASS_1_5B567C8A01BAEDFE_111_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A0B8E80)
#define CLASS_1_5B567C8A01BAEDFE_111__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A0B8F30)
#define CLASS_1_5B567C8A01BAEDFE_111__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0B8CD0)
#define CLASS_1_5B567C8A01BAEDFE_111__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0B8CC0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_111*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_111_TypeDefinitionIndex)->GetStaticField(0xF820);
	}
