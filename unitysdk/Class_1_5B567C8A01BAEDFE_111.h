...
#define CLASS_1_5B567C8A01BAEDFE_111_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19B6ABF0)
#define CLASS_1_5B567C8A01BAEDFE_111_CLONE_OFFSET UNITYSDK_OFFSET(0x19B6AA00)
#define CLASS_1_5B567C8A01BAEDFE_111_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19B6AB00)
#define CLASS_1_5B567C8A01BAEDFE_111_EQUALS_OFFSET UNITYSDK_OFFSET(0x19B6AA70)
#define CLASS_1_5B567C8A01BAEDFE_111_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19B6AB50)
#define CLASS_1_5B567C8A01BAEDFE_111_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19B6AC40)
#define CLASS_1_5B567C8A01BAEDFE_111_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19B6AC10)
#define CLASS_1_5B567C8A01BAEDFE_111_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19B6A950)
#define CLASS_1_5B567C8A01BAEDFE_111_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19B6A9B0)
#define CLASS_1_5B567C8A01BAEDFE_111_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19B6AB80)
#define CLASS_1_5B567C8A01BAEDFE_111_WRITETO_OFFSET UNITYSDK_OFFSET(0x19B6ABE0)
#define CLASS_1_5B567C8A01BAEDFE_111__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B6AC90)
#define CLASS_1_5B567C8A01BAEDFE_111__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19B6A9D0)
#define CLASS_1_5B567C8A01BAEDFE_111__CTOR_OFFSET UNITYSDK_OFFSET(0x19B6A9C0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_111*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_111_TypeDefinitionIndex)->GetStaticField(0x4F160);
	}
