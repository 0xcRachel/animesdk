...
#define CLASS_2_0B244BD6029F78D1_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16BE1B50)
#define CLASS_2_0B244BD6029F78D1_METHOD_2_926F1207A6BA78F5_OFFSET UNITYSDK_OFFSET(0x16BE2BF0)
#define CLASS_2_0B244BD6029F78D1_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x16BE0340)
#define CLASS_2_0B244BD6029F78D1_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x16BE1A70)
#define CLASS_2_0B244BD6029F78D1_TICK_OFFSET UNITYSDK_OFFSET(0x16BE1BA0)
#define CLASS_2_0B244BD6029F78D1__CCTOR_OFFSET UNITYSDK_OFFSET(0x16BE2DD0)
#define CLASS_2_0B244BD6029F78D1__CTOR_OFFSET UNITYSDK_OFFSET(0x16BE00B0)
...
public:
	...
	{
		return (::System::Type**)Il2CppClass::FromTypeDefinitionIndex(Class_2_0B244BD6029F78D1_TypeDefinitionIndex)->GetStaticField(0x38D50);
	}
	::System::Collections::Generic::List_1<::RPG::GameCore::Triple_3<::System::Boolean, ::RPG::GameCore::TurnBasedAbilityComponent*, ::RPG::GameCore::GameEntityList*>*>* Field_2_1; // 0x18
	::Il2CppArray<::Class_1_5F51D4049EA87B7B*>* Field_2_2; // 0x20
	::RPG::GameCore::TaskContext* Field_2_3; // 0x28
	::Class_1_07A210D994F284D8_3* Field_2_4; // 0x30
	::RPG::GameCore::TriggerParallelAbility* Field_2_5; // 0x38
