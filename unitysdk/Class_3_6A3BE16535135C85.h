...
#define CLASS_3_6A3BE16535135C85_COMBINEVALUESWITH_OFFSET UNITYSDK_OFFSET(0x166B3D20)
#define CLASS_3_6A3BE16535135C85__CTOR_1_OFFSET UNITYSDK_OFFSET(0x166B3CB0)
#define CLASS_3_6A3BE16535135C85__CTOR_OFFSET UNITYSDK_OFFSET(0x166B3C40)

inline static constexpr unsigned int Class_3_6A3BE16535135C85_TypeDefinitionIndex = 22265;
