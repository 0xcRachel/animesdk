...
#define CLASS_2_0C170AD5C4394FF1_METHOD_2_1947BC35B7A7FCB8_OFFSET UNITYSDK_OFFSET(0xE47A790)
#define CLASS_2_0C170AD5C4394FF1_METHOD_2_1B9CC121BDC8766D_OFFSET UNITYSDK_OFFSET(0xE47A380)
#define CLASS_2_0C170AD5C4394FF1_METHOD_2_3153D82DE4567702_OFFSET UNITYSDK_OFFSET(0xE47A6B0)
#define CLASS_2_0C170AD5C4394FF1_METHOD_2_46C57C13F50DE61C_OFFSET UNITYSDK_OFFSET(0xE47A620)
#define CLASS_2_0C170AD5C4394FF1_METHOD_2_82342D248FADF8D1_OFFSET UNITYSDK_OFFSET(0xE47A450)
#define CLASS_2_0C170AD5C4394FF1_METHOD_2_A86A455D6AB5B836_OFFSET UNITYSDK_OFFSET(0xE47A400)
#define CLASS_2_0C170AD5C4394FF1_METHOD_2_B4BE7CCBC65AB443_OFFSET UNITYSDK_OFFSET(0xE47A730)
#define CLASS_2_0C170AD5C4394FF1__CTOR_OFFSET UNITYSDK_OFFSET(0xE47AA60)
#define CLASS_2_0C170AD5C4394FF1__ONBIND_OFFSET UNITYSDK_OFFSET(0xE47A110)
#define CLASS_2_0C170AD5C4394FF1___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0xE47AA90)

inline static constexpr unsigned int Class_2_0C170AD5C4394FF1_TypeDefinitionIndex = 59178;
...
public:
	...
	::Class_2_50DFF4BEBCE7B7DC* Field_2_3; // 0x70
	::RPG::Client::PrefabLoadMeta* Field_2_2; // 0x78
	::UnityEngine::Animator* Field_2_4; // 0x80
	::RPG::Client::GridFightEquipItemConfig* Field_2_5; // 0x88
