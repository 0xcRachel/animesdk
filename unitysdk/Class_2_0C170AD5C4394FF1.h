...
#define CLASS_2_0C170AD5C4394FF1_METHOD_2_1947BC35B7A7FCB8_OFFSET UNITYSDK_OFFSET(0x109C5810)
#define CLASS_2_0C170AD5C4394FF1_METHOD_2_1B9CC121BDC8766D_OFFSET UNITYSDK_OFFSET(0x109C5420)
#define CLASS_2_0C170AD5C4394FF1_METHOD_2_3153D82DE4567702_OFFSET UNITYSDK_OFFSET(0x109C5730)
#define CLASS_2_0C170AD5C4394FF1_METHOD_2_46C57C13F50DE61C_OFFSET UNITYSDK_OFFSET(0x109C56B0)
#define CLASS_2_0C170AD5C4394FF1_METHOD_2_82342D248FADF8D1_OFFSET UNITYSDK_OFFSET(0x109C54F0)
#define CLASS_2_0C170AD5C4394FF1_METHOD_2_A86A455D6AB5B836_OFFSET UNITYSDK_OFFSET(0x109C54A0)
#define CLASS_2_0C170AD5C4394FF1_METHOD_2_B4BE7CCBC65AB443_OFFSET UNITYSDK_OFFSET(0x109C57B0)
#define CLASS_2_0C170AD5C4394FF1__CTOR_OFFSET UNITYSDK_OFFSET(0x109C5AF0)
#define CLASS_2_0C170AD5C4394FF1__ONBIND_OFFSET UNITYSDK_OFFSET(0x109C52B0)
#define CLASS_2_0C170AD5C4394FF1___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0x109C5B20)

inline static constexpr unsigned int Class_2_0C170AD5C4394FF1_TypeDefinitionIndex = 57559;
...
public:
	...
	::RPG::Client::GridFightEquipItemConfig* Field_2_5; // 0x68
	::UnityEngine::UI::Button* Field_2_1; // 0x70
	::Class_2_50DFF4BEBCE7B7DC* Field_2_3; // 0x78
