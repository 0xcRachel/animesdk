...
#define CLASS_2_85BE16C337B2BFD0_GET_DESTROLEID_OFFSET UNITYSDK_OFFSET(0xE588B60)
#define CLASS_2_85BE16C337B2BFD0_GET_SRCROLEID_OFFSET UNITYSDK_OFFSET(0xE588B40)
#define CLASS_2_85BE16C337B2BFD0_SET_DESTROLEID_OFFSET UNITYSDK_OFFSET(0xE588B70)
#define CLASS_2_85BE16C337B2BFD0_SET_SRCROLEID_OFFSET UNITYSDK_OFFSET(0xE588B50)
#define CLASS_2_85BE16C337B2BFD0_UPDATE_OFFSET UNITYSDK_OFFSET(0xE588A70)
#define CLASS_2_85BE16C337B2BFD0__CTOR_OFFSET UNITYSDK_OFFSET(0xE588A40)
#define CLASS_2_85BE16C337B2BFD0___IFIXBASEPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0xE588B80)
