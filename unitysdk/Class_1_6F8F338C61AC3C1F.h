...
#define CLASS_1_6F8F338C61AC3C1F_EXECUTE_OFFSET UNITYSDK_OFFSET(0xA157D70)
#define CLASS_1_6F8F338C61AC3C1F_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xA157B60)
#define CLASS_1_6F8F338C61AC3C1F_METHOD_1_19FB5FBEA9EA66CD_OFFSET UNITYSDK_OFFSET(0xA1586E0)
#define CLASS_1_6F8F338C61AC3C1F_METHOD_1_1F5E0226DAD91587_OFFSET UNITYSDK_OFFSET(0xA157A20)
#define CLASS_1_6F8F338C61AC3C1F_METHOD_1_81FEFD1B22CE37A2_OFFSET UNITYSDK_OFFSET(0xA159290)
#define CLASS_1_6F8F338C61AC3C1F_METHOD_1_8DC1E1A0FA2BFE92_OFFSET UNITYSDK_OFFSET(0xA1582F0)
#define CLASS_1_6F8F338C61AC3C1F_METHOD_1_B877181B6123B7F6_OFFSET UNITYSDK_OFFSET(0xA159990)
#define CLASS_1_6F8F338C61AC3C1F_METHOD_1_C69F10DC94E739D2_OFFSET UNITYSDK_OFFSET(0xA1597C0)
#define CLASS_1_6F8F338C61AC3C1F_TEARDOWN_OFFSET UNITYSDK_OFFSET(0xA1585F0)
#define CLASS_1_6F8F338C61AC3C1F__CTOR_OFFSET UNITYSDK_OFFSET(0xA157AA0)

inline static constexpr unsigned int Class_1_6F8F338C61AC3C1F_TypeDefinitionIndex = 61396;

class Class_1_6F8F338C61AC3C1F : public ::System::Object
{
public:
	::Class_1_C7CDAED596480153* Field_1_6; // 0x10
	::System::Collections::Generic::List_1<::System::UInt32>* Field_1_3; // 0x18
	::Class_1_C7CDAED596480153* Field_1_5; // 0x20
	::System::Collections::Generic::List_1<::Class_2_15E317187C4E8254*>* Field_1_4; // 0x28
	::Class_3_626F93E2306641CC* Field_1_0; // 0x30
