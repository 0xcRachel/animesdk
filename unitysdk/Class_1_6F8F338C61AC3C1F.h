...
#define CLASS_1_6F8F338C61AC3C1F_EXECUTE_OFFSET UNITYSDK_OFFSET(0x12691C50)
#define CLASS_1_6F8F338C61AC3C1F_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x12691A40)
#define CLASS_1_6F8F338C61AC3C1F_METHOD_1_19FB5FBEA9EA66CD_OFFSET UNITYSDK_OFFSET(0x126925C0)
#define CLASS_1_6F8F338C61AC3C1F_METHOD_1_1F5E0226DAD91587_OFFSET UNITYSDK_OFFSET(0x12691900)
#define CLASS_1_6F8F338C61AC3C1F_METHOD_1_81FEFD1B22CE37A2_OFFSET UNITYSDK_OFFSET(0x12693170)
#define CLASS_1_6F8F338C61AC3C1F_METHOD_1_8DC1E1A0FA2BFE92_OFFSET UNITYSDK_OFFSET(0x126921D0)
#define CLASS_1_6F8F338C61AC3C1F_METHOD_1_B877181B6123B7F6_OFFSET UNITYSDK_OFFSET(0x126938A0)
#define CLASS_1_6F8F338C61AC3C1F_METHOD_1_C69F10DC94E739D2_OFFSET UNITYSDK_OFFSET(0x126936D0)
#define CLASS_1_6F8F338C61AC3C1F_TEARDOWN_OFFSET UNITYSDK_OFFSET(0x126924D0)
#define CLASS_1_6F8F338C61AC3C1F__CTOR_OFFSET UNITYSDK_OFFSET(0x12691980)

inline static constexpr unsigned int Class_1_6F8F338C61AC3C1F_TypeDefinitionIndex = 71623;

class Class_1_6F8F338C61AC3C1F : public ::System::Object
{
public:
	::Class_1_C7CDAED596480153* Field_1_5; // 0x10
	::Class_1_C7CDAED596480153* Field_1_6; // 0x18
