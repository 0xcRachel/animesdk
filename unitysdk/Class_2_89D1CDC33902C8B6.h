...
#define CLASS_2_89D1CDC33902C8B6_METHOD_2_3210A5BB7D3D17EC_OFFSET UNITYSDK_OFFSET(0xFDB6AF0)
#define CLASS_2_89D1CDC33902C8B6_METHOD_2_4E22A18EF530BFA8_OFFSET UNITYSDK_OFFSET(0xFDB63F0)
#define CLASS_2_89D1CDC33902C8B6_METHOD_2_B6B43818209B48CE_OFFSET UNITYSDK_OFFSET(0xFDB6450)
#define CLASS_2_89D1CDC33902C8B6__CTOR_OFFSET UNITYSDK_OFFSET(0xFDB6C50)

inline static constexpr unsigned int Class_2_89D1CDC33902C8B6_TypeDefinitionIndex = 60999;
...
public:
	...
	::System::Boolean Method_2_B6B43818209B48CE(::Class_1_C4FD36003027AC99* a1, ::System::Collections::Generic::List_1<::Class_2_49CAB3DE74280C58*>* a2, ::RPG::GameCore::ChimeraDuelEffectConfig* a3, ::Class_1_43BD383C98B4C0C5_167*& a4)
	{
		return ((::System::Boolean(*)(::PVOID, ::Class_1_C4FD36003027AC99*, ::System::Collections::Generic::List_1<::Class_2_49CAB3DE74280C58*>*, ::RPG::GameCore::ChimeraDuelEffectConfig*, ::Class_1_43BD383C98B4C0C5_167*&))((::PBYTE)hIl2Cpp + CLASS_2_89D1CDC33902C8B6_METHOD_2_B6B43818209B48CE_OFFSET))(this, a1, a2, a3, a4);
	}
