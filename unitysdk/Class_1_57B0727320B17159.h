...
#define CLASS_1_57B0727320B17159__CTOR_OFFSET UNITYSDK_OFFSET(0x15635BE0)
...
{
public:
	::RPG::Client::LittleGameShare::LittleGameClientNetMode Field_1_1; // 0x10
	::RPG::Client::LittleGameShare::LittleGameNetMode Field_1_0; // 0x11
