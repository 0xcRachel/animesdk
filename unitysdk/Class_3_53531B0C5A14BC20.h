...
#define CLASS_3_53531B0C5A14BC20_METHOD_3_F69068FADEFBD596_OFFSET UNITYSDK_OFFSET(0x111C80C0)
#define CLASS_3_53531B0C5A14BC20__CTOR_OFFSET UNITYSDK_OFFSET(0x111C7DF0)
#define CLASS_3_53531B0C5A14BC20__REGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x111C7FA0)
#define CLASS_3_53531B0C5A14BC20__UNREGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x111C8030)
#define CLASS_3_53531B0C5A14BC20___IFIXBASEPROXY__REGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x111C8230)
#define CLASS_3_53531B0C5A14BC20___IFIXBASEPROXY__UNREGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x111C8240)

inline static constexpr unsigned int Class_3_53531B0C5A14BC20_TypeDefinitionIndex = 41853;
