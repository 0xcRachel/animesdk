...
#define CLASS_1_FAF146B3D74C3C3F_METHOD_1_8A4821B6962F6B25_OFFSET UNITYSDK_OFFSET(0x9BF0790)
#define CLASS_1_FAF146B3D74C3C3F_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9BF0720)
#define CLASS_1_FAF146B3D74C3C3F__CTOR_OFFSET UNITYSDK_OFFSET(0x9BF0710)
#define CLASS_1_FAF146B3D74C3C3F___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9BF0A40)

inline static constexpr unsigned int Class_1_FAF146B3D74C3C3F_TypeDefinitionIndex = 62428;
