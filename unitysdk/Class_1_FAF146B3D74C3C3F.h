...
#define CLASS_1_FAF146B3D74C3C3F_METHOD_1_8A4821B6962F6B25_OFFSET UNITYSDK_OFFSET(0x1164DBE0)
#define CLASS_1_FAF146B3D74C3C3F_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1164DB70)
#define CLASS_1_FAF146B3D74C3C3F__CTOR_OFFSET UNITYSDK_OFFSET(0x1164DB60)
#define CLASS_1_FAF146B3D74C3C3F___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1164DE90)

inline static constexpr unsigned int Class_1_FAF146B3D74C3C3F_TypeDefinitionIndex = 64616;
