...
#define CLASS_2_5FF2340E88CFFA8C_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11527D40)
#define CLASS_2_5FF2340E88CFFA8C_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x11527ED0)
#define CLASS_2_5FF2340E88CFFA8C_METHOD_2_0BA114B592B3A582_OFFSET UNITYSDK_OFFSET(0x11528B70)
#define CLASS_2_5FF2340E88CFFA8C_METHOD_2_0BD6A0326CCBE110_OFFSET UNITYSDK_OFFSET(0x11528440)
#define CLASS_2_5FF2340E88CFFA8C_METHOD_2_2CBE0B79DD36047E_OFFSET UNITYSDK_OFFSET(0x115289C0)
#define CLASS_2_5FF2340E88CFFA8C_METHOD_2_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x115283F0)
#define CLASS_2_5FF2340E88CFFA8C_METHOD_2_4306F3E882709A3A_OFFSET UNITYSDK_OFFSET(0x115283A0)
#define CLASS_2_5FF2340E88CFFA8C_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x11527DE0)
#define CLASS_2_5FF2340E88CFFA8C_METHOD_2_469B5B6FF2B897D9_OFFSET UNITYSDK_OFFSET(0x11528240)
#define CLASS_2_5FF2340E88CFFA8C_METHOD_2_4C288C0C3DC7B4CA_OFFSET UNITYSDK_OFFSET(0x11528DD0)
#define CLASS_2_5FF2340E88CFFA8C_METHOD_2_81855C54613E2F49_OFFSET UNITYSDK_OFFSET(0x115282B0)
#define CLASS_2_5FF2340E88CFFA8C_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x115281A0)
#define CLASS_2_5FF2340E88CFFA8C_METHOD_2_9D86A9A378EEE9C7_OFFSET UNITYSDK_OFFSET(0x11529120)
#define CLASS_2_5FF2340E88CFFA8C_METHOD_2_9F8F6511E8EF1235_OFFSET UNITYSDK_OFFSET(0x11528710)
#define CLASS_2_5FF2340E88CFFA8C_METHOD_2_A3954765C309C87A_OFFSET UNITYSDK_OFFSET(0x115284C0)
#define CLASS_2_5FF2340E88CFFA8C_METHOD_2_C436A2848092EB88_1_OFFSET UNITYSDK_OFFSET(0x115290D0)
#define CLASS_2_5FF2340E88CFFA8C_METHOD_2_C436A2848092EB88_OFFSET UNITYSDK_OFFSET(0x11529070)
#define CLASS_2_5FF2340E88CFFA8C_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x115292D0)
#define CLASS_2_5FF2340E88CFFA8C_METHOD_2_F4ADC37B63F4E9EF_OFFSET UNITYSDK_OFFSET(0x115285E0)
#define CLASS_2_5FF2340E88CFFA8C_METHOD_2_FDE09C8D62639E3E_OFFSET UNITYSDK_OFFSET(0x11528690)
#define CLASS_2_5FF2340E88CFFA8C_TICK_OFFSET UNITYSDK_OFFSET(0x11527E60)
#define CLASS_2_5FF2340E88CFFA8C__CCTOR_OFFSET UNITYSDK_OFFSET(0x115292E0)
#define CLASS_2_5FF2340E88CFFA8C__CTOR_OFFSET UNITYSDK_OFFSET(0x11527D30)
#define CLASS_2_5FF2340E88CFFA8C___BEGINFADEIN_ONLYEFFECTMODE_B__15_0_OFFSET UNITYSDK_OFFSET(0x11529330)
#define CLASS_2_5FF2340E88CFFA8C___BEGINFADEOUT_ONLYEFFECTMODE_B__16_0_OFFSET UNITYSDK_OFFSET(0x115293E0)
#define CLASS_2_5FF2340E88CFFA8C___IFIXBASEPROXY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x11529470)
#define CLASS_2_5FF2340E88CFFA8C___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x11529460)
...
public:
	...
	{
		return (::Il2CppArray<::RPG::GameCore::CharacterVisibleReason>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_5FF2340E88CFFA8C_TypeDefinitionIndex)->GetStaticField(0x361F0);
	}
	::System::String* Field_2_5; // 0x18
	::Class_1_23F67DD15593C8D6* Field_2_9; // 0x20
	::RPG::GameCore::CharacterVisibleComponent* Field_2_0; // 0x28
	::System::String* Field_2_6; // 0x30
	::System::Boolean Field_2_2; // 0x38
	::System::Nullable_1<::System::Boolean> Field_2_1; // 0x39
	::System::Boolean Field_2_8; // 0x3B
	::System::Boolean Field_2_10; // 0x3C
	::System::Boolean Field_2_4; // 0x3D
	::System::Boolean Field_2_12; // 0x3E
	::RPG::GameCore::StoryCharacterApperMode Field_2_3; // 0x40
