...
#define CLASS_2_DC9C477547B15CC2_METHOD_2_164DA41B84B6F6E5_OFFSET UNITYSDK_OFFSET(0x10398FB0)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_335AB672C838D49D_OFFSET UNITYSDK_OFFSET(0x10399750)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_373DDB49638AF10B_OFFSET UNITYSDK_OFFSET(0x10399160)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_3CFC15F4A20EC116_OFFSET UNITYSDK_OFFSET(0x10398390)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_44DA14892550A4E3_OFFSET UNITYSDK_OFFSET(0x10398660)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_53712521C2C1703A_OFFSET UNITYSDK_OFFSET(0x10398930)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_54757B8B62FBF467_OFFSET UNITYSDK_OFFSET(0x103985D0)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x103999C0)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_5835DC16FC46989B_OFFSET UNITYSDK_OFFSET(0x10398E10)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_717E5AEDA9FD8F84_OFFSET UNITYSDK_OFFSET(0x10399570)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_8564CF04F3A7AFB3_OFFSET UNITYSDK_OFFSET(0x10397E50)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_8CE0803574BB66D7_OFFSET UNITYSDK_OFFSET(0x10399210)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_9839DFE3C10E4654_OFFSET UNITYSDK_OFFSET(0x10398BE0)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_A0CFDB5F5B1DB2D6_OFFSET UNITYSDK_OFFSET(0x103984C0)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_AEA938E393CB58B0_OFFSET UNITYSDK_OFFSET(0x103982A0)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_AFC8215C57A0845A_OFFSET UNITYSDK_OFFSET(0x10399280)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_C5D09897CC7133B0_OFFSET UNITYSDK_OFFSET(0x10398460)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_C782C60E11964C7F_OFFSET UNITYSDK_OFFSET(0x10399300)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_C89A41A14F7CCD91_OFFSET UNITYSDK_OFFSET(0x10399950)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_D5E5EC1B4538DDD1_OFFSET UNITYSDK_OFFSET(0x10399A20)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_D9EF75A2D048B8A1_OFFSET UNITYSDK_OFFSET(0x103986E0)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_E0C22160558909B0_OFFSET UNITYSDK_OFFSET(0x10398310)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_EADDF1782C977BCA_OFFSET UNITYSDK_OFFSET(0x103994D0)
#define CLASS_2_DC9C477547B15CC2_ONACQUIRE_OFFSET UNITYSDK_OFFSET(0x10398D00)
#define CLASS_2_DC9C477547B15CC2_ONRETURN_OFFSET UNITYSDK_OFFSET(0x10398F00)
#define CLASS_2_DC9C477547B15CC2__CCTOR_OFFSET UNITYSDK_OFFSET(0x103998B0)
#define CLASS_2_DC9C477547B15CC2__CTOR_OFFSET UNITYSDK_OFFSET(0x10399860)
#define CLASS_2_DC9C477547B15CC2__ONBIND_OFFSET UNITYSDK_OFFSET(0x10397990)
#define CLASS_2_DC9C477547B15CC2___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0x103998F0)

inline static constexpr unsigned int Class_2_DC9C477547B15CC2_TypeDefinitionIndex = 58682;
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_2_DC9C477547B15CC2_TypeDefinitionIndex)->GetStaticField(0x5E10);
	}
	...
	::Class_2_2F628B490A34A23F* Field_2_10; // 0x88
	::UnityEngine::UI::Image* Field_2_3; // 0x90
	::RPG::Client::LocalizedText* Field_2_4; // 0x98
	::UnityEngine::ParticleSystem* Field_2_5; // 0xA0
	::UnityEngine::Animator* Field_2_8; // 0xA8
	::RPG::GameCore::GameEntity* Field_2_11; // 0xB0
	::Class_2_670DA05CE98605A7* Field_2_9; // 0xB8
	::System::Int32 Field_2_14; // 0xC0
	::Class_2_DC9C477547B15CC2_CounterType Field_2_15; // 0xC4
	::System::Boolean Field_2_20; // 0xC8
	::System::Boolean Field_2_19; // 0xC9
