...
#define CLASS_2_DC9C477547B15CC2_METHOD_2_164DA41B84B6F6E5_OFFSET UNITYSDK_OFFSET(0x13533620)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_276036CDF4BFF5A6_OFFSET UNITYSDK_OFFSET(0x13532D60)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_373DDB49638AF10B_OFFSET UNITYSDK_OFFSET(0x135337D0)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_3CFC15F4A20EC116_OFFSET UNITYSDK_OFFSET(0x135329B0)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_4E23EAF81911C9F7_OFFSET UNITYSDK_OFFSET(0x13532CE0)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_4E42C1D03BBB9919_OFFSET UNITYSDK_OFFSET(0x13533DD0)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_53712521C2C1703A_OFFSET UNITYSDK_OFFSET(0x13532FA0)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x13534030)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_5D9CF83CFC617CF9_OFFSET UNITYSDK_OFFSET(0x13533FD0)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_717E5AEDA9FD8F84_OFFSET UNITYSDK_OFFSET(0x13533BF0)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_7744894CEC41BF06_OFFSET UNITYSDK_OFFSET(0x13532BE0)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_8CE0803574BB66D7_OFFSET UNITYSDK_OFFSET(0x13533890)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_98060E4D16CBDFE4_OFFSET UNITYSDK_OFFSET(0x13533980)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_9839DFE3C10E4654_OFFSET UNITYSDK_OFFSET(0x13533240)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_A0CFDB5F5B1DB2D6_OFFSET UNITYSDK_OFFSET(0x13532AD0)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_AAD864A9DF964170_OFFSET UNITYSDK_OFFSET(0x13533470)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_AEA938E393CB58B0_OFFSET UNITYSDK_OFFSET(0x135328C0)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_AFC8215C57A0845A_OFFSET UNITYSDK_OFFSET(0x13533900)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_BB9510FC835F0664_OFFSET UNITYSDK_OFFSET(0x13532610)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_C5D09897CC7133B0_OFFSET UNITYSDK_OFFSET(0x13532A70)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_C91E5170F9E36EED_OFFSET UNITYSDK_OFFSET(0x13534090)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_E0C22160558909B0_OFFSET UNITYSDK_OFFSET(0x13532930)
#define CLASS_2_DC9C477547B15CC2_METHOD_2_EADDF1782C977BCA_OFFSET UNITYSDK_OFFSET(0x13533B50)
#define CLASS_2_DC9C477547B15CC2_ONACQUIRE_OFFSET UNITYSDK_OFFSET(0x13533360)
#define CLASS_2_DC9C477547B15CC2_ONRETURN_OFFSET UNITYSDK_OFFSET(0x13533570)
#define CLASS_2_DC9C477547B15CC2__CCTOR_OFFSET UNITYSDK_OFFSET(0x13533F30)
#define CLASS_2_DC9C477547B15CC2__CTOR_OFFSET UNITYSDK_OFFSET(0x13533EF0)
#define CLASS_2_DC9C477547B15CC2__ONBIND_OFFSET UNITYSDK_OFFSET(0x13532440)
#define CLASS_2_DC9C477547B15CC2___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0x13533F70)

inline static constexpr unsigned int Class_2_DC9C477547B15CC2_TypeDefinitionIndex = 66939;
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_2_DC9C477547B15CC2_TypeDefinitionIndex)->GetStaticField(0xB710);
	}
	// static const ::System::String* Field_2_1; // 0x0
	::UnityEngine::ParticleSystem* Field_2_2; // 0x60
	::UnityEngine::UI::Image* Field_2_3; // 0x68
	::Class_2_76CE3186892724E8* Field_2_4; // 0x70
	...
	::RPG::Client::LocalizedText* Field_2_9; // 0x98
	...
	::RPG::GameCore::EnergyBarState Field_2_16; // 0xC8
	::System::Int32 Field_2_17; // 0xCC
	::System::Boolean Field_2_18; // 0xD0
