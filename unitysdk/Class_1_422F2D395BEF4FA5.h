...
#define CLASS_1_422F2D395BEF4FA5_DISPOSE_OFFSET UNITYSDK_OFFSET(0x133FE070)
#define CLASS_1_422F2D395BEF4FA5_GET_ADJUSTTIME_OFFSET UNITYSDK_OFFSET(0x13402050)
#define CLASS_1_422F2D395BEF4FA5_GET_BEATTIME_OFFSET UNITYSDK_OFFSET(0x13401FD0)
#define CLASS_1_422F2D395BEF4FA5_GET_BOARD_OFFSET UNITYSDK_OFFSET(0x13402030)
#define CLASS_1_422F2D395BEF4FA5_GET_ISADJUST_OFFSET UNITYSDK_OFFSET(0x13402070)
#define CLASS_1_422F2D395BEF4FA5_GET_PHASE_OFFSET UNITYSDK_OFFSET(0x13402010)
#define CLASS_1_422F2D395BEF4FA5_GET_PRESSNOTE_OFFSET UNITYSDK_OFFSET(0x13402090)
#define CLASS_1_422F2D395BEF4FA5_GET_TIMELINECONFIG_OFFSET UNITYSDK_OFFSET(0x13401FF0)
#define CLASS_1_422F2D395BEF4FA5_METHOD_1_063ADB01C44981A7_OFFSET UNITYSDK_OFFSET(0x133FE400)
#define CLASS_1_422F2D395BEF4FA5_METHOD_1_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x133FEC90)
#define CLASS_1_422F2D395BEF4FA5_METHOD_1_28F4C2ABDCC41027_OFFSET UNITYSDK_OFFSET(0x133FE9F0)
#define CLASS_1_422F2D395BEF4FA5_METHOD_1_2E05D4898E2BA5A5_OFFSET UNITYSDK_OFFSET(0x13401730)
#define CLASS_1_422F2D395BEF4FA5_METHOD_1_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x13401B10)
#define CLASS_1_422F2D395BEF4FA5_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x134020B0)
#define CLASS_1_422F2D395BEF4FA5_METHOD_1_40556D2510043259_OFFSET UNITYSDK_OFFSET(0x13400680)
#define CLASS_1_422F2D395BEF4FA5_METHOD_1_45F740D50EBD16AA_OFFSET UNITYSDK_OFFSET(0x133FE630)
#define CLASS_1_422F2D395BEF4FA5_METHOD_1_4DA6D4A624E42CAB_OFFSET UNITYSDK_OFFSET(0x13401F00)
#define CLASS_1_422F2D395BEF4FA5_METHOD_1_508D4DD02D3DB74E_OFFSET UNITYSDK_OFFSET(0x133FFFB0)
#define CLASS_1_422F2D395BEF4FA5_METHOD_1_52607DE4C357D269_OFFSET UNITYSDK_OFFSET(0x13400140)
#define CLASS_1_422F2D395BEF4FA5_METHOD_1_602B796CAD5DBEDB_OFFSET UNITYSDK_OFFSET(0x13401C10)
#define CLASS_1_422F2D395BEF4FA5_METHOD_1_6B72D4EE8C6E907F_OFFSET UNITYSDK_OFFSET(0x133FED00)
#define CLASS_1_422F2D395BEF4FA5_METHOD_1_817318C744BE409A_OFFSET UNITYSDK_OFFSET(0x133FE570)
#define CLASS_1_422F2D395BEF4FA5_METHOD_1_84868B009B97FC99_OFFSET UNITYSDK_OFFSET(0x133FF570)
#define CLASS_1_422F2D395BEF4FA5_METHOD_1_897E40D1C7EB9645_OFFSET UNITYSDK_OFFSET(0x134009E0)
#define CLASS_1_422F2D395BEF4FA5_METHOD_1_9753F4D159A24514_OFFSET UNITYSDK_OFFSET(0x13400D30)
#define CLASS_1_422F2D395BEF4FA5_METHOD_1_D437D090E63BE8A7_OFFSET UNITYSDK_OFFSET(0x133FF080)
#define CLASS_1_422F2D395BEF4FA5_METHOD_1_D5BA0D4001A1E089_OFFSET UNITYSDK_OFFSET(0x134007A0)
#define CLASS_1_422F2D395BEF4FA5_METHOD_1_D64FD9A228A1C4E0_OFFSET UNITYSDK_OFFSET(0x134005E0)
#define CLASS_1_422F2D395BEF4FA5_METHOD_1_D9EF75A2D048B8A1_OFFSET UNITYSDK_OFFSET(0x133FFDD0)
#define CLASS_1_422F2D395BEF4FA5_METHOD_1_E3DA1650B07BB219_OFFSET UNITYSDK_OFFSET(0x134001E0)
#define CLASS_1_422F2D395BEF4FA5_METHOD_1_E69AA2E64A20143D_OFFSET UNITYSDK_OFFSET(0x133FF0F0)
#define CLASS_1_422F2D395BEF4FA5_METHOD_1_EE47CAE8B6BF5A56_OFFSET UNITYSDK_OFFSET(0x13401880)
#define CLASS_1_422F2D395BEF4FA5_METHOD_1_F22E917EA16961A8_OFFSET UNITYSDK_OFFSET(0x133FE7D0)
#define CLASS_1_422F2D395BEF4FA5_METHOD_1_F9F961550F954A6F_OFFSET UNITYSDK_OFFSET(0x13400F10)
#define CLASS_1_422F2D395BEF4FA5_METHOD_1_FB4BE762B6186C23_OFFSET UNITYSDK_OFFSET(0x13401FB0)
#define CLASS_1_422F2D395BEF4FA5_METHOD_1_FDE09C8D62639E3E_OFFSET UNITYSDK_OFFSET(0x133FF4E0)
#define CLASS_1_422F2D395BEF4FA5_SET_ADJUSTTIME_OFFSET UNITYSDK_OFFSET(0x13402060)
#define CLASS_1_422F2D395BEF4FA5_SET_BEATTIME_OFFSET UNITYSDK_OFFSET(0x13401FE0)
#define CLASS_1_422F2D395BEF4FA5_SET_BOARD_OFFSET UNITYSDK_OFFSET(0x13402040)
#define CLASS_1_422F2D395BEF4FA5_SET_ISADJUST_OFFSET UNITYSDK_OFFSET(0x13402080)
#define CLASS_1_422F2D395BEF4FA5_SET_PHASE_OFFSET UNITYSDK_OFFSET(0x13402020)
#define CLASS_1_422F2D395BEF4FA5_SET_PRESSNOTE_OFFSET UNITYSDK_OFFSET(0x134020A0)
#define CLASS_1_422F2D395BEF4FA5_SET_TIMELINECONFIG_OFFSET UNITYSDK_OFFSET(0x13402000)
#define CLASS_1_422F2D395BEF4FA5__CCTOR_OFFSET UNITYSDK_OFFSET(0x13402110)
#define CLASS_1_422F2D395BEF4FA5__CTOR_OFFSET UNITYSDK_OFFSET(0x133FDEF0)
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_422F2D395BEF4FA5_TypeDefinitionIndex)->GetStaticField(0x36650);
	}
	static ::System::String** StaticGet_Field_1_1()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_422F2D395BEF4FA5_TypeDefinitionIndex)->GetStaticField(0x36658);
	}
	static ::System::String** StaticGet_Field_1_2()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_422F2D395BEF4FA5_TypeDefinitionIndex)->GetStaticField(0x36660);
	}
	static ::System::Single* StaticGet_Field_1_3()
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_1_422F2D395BEF4FA5_TypeDefinitionIndex)->GetStaticField(0xAC20);
	}
	static ::System::Single* StaticGet_Field_1_4()
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_1_422F2D395BEF4FA5_TypeDefinitionIndex)->GetStaticField(0xAC24);
	}
	static ::System::Single* StaticGet_Field_1_5()
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_1_422F2D395BEF4FA5_TypeDefinitionIndex)->GetStaticField(0xAC28);
	}
	...
	::System::Collections::Generic::List_1<::Class_1_8DD407826F55E7BF*>* Field_1_9; // 0x28
	::RPG::GameCore::MusicRhythmTimelineConfig* _TimelineConfig_k__BackingField; // 0x30
	::System::Collections::Generic::List_1<::System::Int32>* Field_1_11; // 0x38
	::Class_1_04316EB8ECDF7B06* _PressNote_k__BackingField; // 0x40
	::System::Collections::Generic::List_1<::Class_1_619F886B74415EBA*>* Field_1_13; // 0x48
	::System::Collections::Generic::List_1<::Class_1_3F51724BA2A18D7F*>* Field_1_14; // 0x50
	::System::Collections::Generic::List_1<::Class_1_619F886B74415EBA*>* Field_1_15; // 0x58
	::System::Collections::Generic::List_1<::Class_1_5D89E5E082F40A4C*>* Field_1_16; // 0x60
	...
	::Class_1_422F2D395BEF4FA5_BeatType Field_1_24; // 0x80
	::System::UInt32 Field_1_25; // 0x84
	::System::Single _AdjustTime_k__BackingField; // 0x88
	::System::Single Field_1_27; // 0x8C
	::System::Double Field_1_28; // 0x90
	::System::UInt32 Field_1_29; // 0x98
	...
	::System::Boolean Field_1_34; // 0xA6
	::System::UInt32 Field_1_35; // 0xA8
	::System::Single _BeatTime_k__BackingField; // 0xAC
	::System::Int32 Field_1_37; // 0xB0
	::System::Single Field_1_38; // 0xB4
	::System::Int32 Field_1_39; // 0xB8
	::System::UInt32 Field_1_40; // 0xBC
	::System::UInt32 Field_1_41; // 0xC0
	::System::Single Field_1_42; // 0xC4
	::System::Single Field_1_43; // 0xC8
	::System::Boolean Field_1_44; // 0xCC
	::System::Boolean Field_1_45; // 0xCD
	::System::Boolean Field_1_46; // 0xCE
	::System::Boolean Field_1_47; // 0xCF
