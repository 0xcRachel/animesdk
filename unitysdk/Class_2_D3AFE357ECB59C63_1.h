...
#define CLASS_2_D3AFE357ECB59C63_1_COMPARETO_OFFSET UNITYSDK_OFFSET(0x86790D0)
#define CLASS_2_D3AFE357ECB59C63_1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8679150)
#define CLASS_2_D3AFE357ECB59C63_1__CTOR_OFFSET UNITYSDK_OFFSET(0x8679080)
#define CLASS_2_D3AFE357ECB59C63_1___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8679230)

inline static constexpr unsigned int Class_2_D3AFE357ECB59C63_1_TypeDefinitionIndex = 49227;
