...
#define CLASS_2_B319B4A0CF2C66A4_METHOD_2_2450CFC043E97F54_OFFSET UNITYSDK_OFFSET(0x13016F20)
#define CLASS_2_B319B4A0CF2C66A4_METHOD_2_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x13016D20)
#define CLASS_2_B319B4A0CF2C66A4_METHOD_2_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x13016D70)
#define CLASS_2_B319B4A0CF2C66A4_METHOD_2_3FDF2B060E99B28D_OFFSET UNITYSDK_OFFSET(0x13016C60)
#define CLASS_2_B319B4A0CF2C66A4_METHOD_2_7985FB4984C2C320_OFFSET UNITYSDK_OFFSET(0x13016B90)
#define CLASS_2_B319B4A0CF2C66A4_SYNCLOADBYTESFROMFILE_OFFSET UNITYSDK_OFFSET(0x130173C0)
#define CLASS_2_B319B4A0CF2C66A4__CTOR_OFFSET UNITYSDK_OFFSET(0x13016CC0)
#define CLASS_2_B319B4A0CF2C66A4__INITASSETLOADERPROVIDER_OFFSET UNITYSDK_OFFSET(0x13017150)
#define CLASS_2_B319B4A0CF2C66A4___IFIXBASEPROXY_SYNCLOADBYTESFROMFILE_OFFSET UNITYSDK_OFFSET(0x13017440)
#define CLASS_2_B319B4A0CF2C66A4___IFIXBASEPROXY__INITASSETLOADERPROVIDER_OFFSET UNITYSDK_OFFSET(0x13017430)
