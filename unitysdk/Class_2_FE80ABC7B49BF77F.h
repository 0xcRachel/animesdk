...
#define CLASS_2_FE80ABC7B49BF77F_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x10FA3000)
#define CLASS_2_FE80ABC7B49BF77F_GET_PUZZLEEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x10FA3050)
#define CLASS_2_FE80ABC7B49BF77F_SET_PUZZLEEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x10FA3060)
#define CLASS_2_FE80ABC7B49BF77F__CTOR_OFFSET UNITYSDK_OFFSET(0x10FA2FF0)
#define CLASS_2_FE80ABC7B49BF77F___IFIXBASEPROXY_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x10FA3070)

inline static constexpr unsigned int Class_2_FE80ABC7B49BF77F_TypeDefinitionIndex = 44479;
