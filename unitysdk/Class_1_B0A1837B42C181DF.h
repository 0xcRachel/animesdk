...
#define CLASS_1_B0A1837B42C181DF_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x15FE21C0)
#define CLASS_1_B0A1837B42C181DF_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x15FE2050)
#define CLASS_1_B0A1837B42C181DF__CCTOR_OFFSET UNITYSDK_OFFSET(0x15FE2490)
#define CLASS_1_B0A1837B42C181DF__CTOR_OFFSET UNITYSDK_OFFSET(0x15FE2480)

inline static constexpr unsigned int Class_1_B0A1837B42C181DF_TypeDefinitionIndex = 27896;
...
public:
	...
	{
		return (::Class_1_B0A1837B42C181DF**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B0A1837B42C181DF_TypeDefinitionIndex)->GetStaticField(0x33A10);
	}
