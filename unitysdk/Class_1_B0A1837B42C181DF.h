...
#define CLASS_1_B0A1837B42C181DF_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x165E0AE0)
#define CLASS_1_B0A1837B42C181DF_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x165E0960)
#define CLASS_1_B0A1837B42C181DF__CCTOR_OFFSET UNITYSDK_OFFSET(0x165E0DA0)
#define CLASS_1_B0A1837B42C181DF__CTOR_OFFSET UNITYSDK_OFFSET(0x165BF9C0)
...
public:
	...
	{
		return (::Class_1_B0A1837B42C181DF**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B0A1837B42C181DF_TypeDefinitionIndex)->GetStaticField(0x345B0);
	}
