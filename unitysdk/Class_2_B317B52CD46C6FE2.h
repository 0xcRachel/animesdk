...
#define CLASS_2_B317B52CD46C6FE2_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCD71300)
#define CLASS_2_B317B52CD46C6FE2_GET_AVATARTYPE_OFFSET UNITYSDK_OFFSET(0xCD71ED0)
#define CLASS_2_B317B52CD46C6FE2_GET_ISASSISTPLAYER_OFFSET UNITYSDK_OFFSET(0xCD72020)
#define CLASS_2_B317B52CD46C6FE2_GET_MULTIPATHAVATARTYPE_OFFSET UNITYSDK_OFFSET(0xCD72040)
#define CLASS_2_B317B52CD46C6FE2_GET_RANK_OFFSET UNITYSDK_OFFSET(0xCD72190)
#define CLASS_2_B317B52CD46C6FE2_GET_SKINID_OFFSET UNITYSDK_OFFSET(0xCD72060)
#define CLASS_2_B317B52CD46C6FE2_GET_ULTRASKILLCONFIG_OFFSET UNITYSDK_OFFSET(0xCD720E0)
#define CLASS_2_B317B52CD46C6FE2_METHOD_2_01109DD29CB4D216_OFFSET UNITYSDK_OFFSET(0xCD71C30)
#define CLASS_2_B317B52CD46C6FE2_METHOD_2_09647A0B2E37C5F4_OFFSET UNITYSDK_OFFSET(0xCD71400)
#define CLASS_2_B317B52CD46C6FE2_METHOD_2_1D4018D4200358D0_1_OFFSET UNITYSDK_OFFSET(0xCD71FC0)
#define CLASS_2_B317B52CD46C6FE2_METHOD_2_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xCD71F60)
#define CLASS_2_B317B52CD46C6FE2_METHOD_2_259B533085E399D3_OFFSET UNITYSDK_OFFSET(0xCD72080)
#define CLASS_2_B317B52CD46C6FE2_METHOD_2_3CAD92CFB876DBF6_OFFSET UNITYSDK_OFFSET(0xCD71350)
#define CLASS_2_B317B52CD46C6FE2_METHOD_2_40A5DADED4224708_OFFSET UNITYSDK_OFFSET(0xCD71870)
#define CLASS_2_B317B52CD46C6FE2_METHOD_2_49218DFB30613065_OFFSET UNITYSDK_OFFSET(0xCD71000)
#define CLASS_2_B317B52CD46C6FE2_METHOD_2_58E4F6A5F8FAF17F_OFFSET UNITYSDK_OFFSET(0xCD721B0)
#define CLASS_2_B317B52CD46C6FE2_METHOD_2_5A4377E3AE99E465_OFFSET UNITYSDK_OFFSET(0xCD709D0)
#define CLASS_2_B317B52CD46C6FE2_METHOD_2_5D0387964FCFFB35_OFFSET UNITYSDK_OFFSET(0xCD71E30)
#define CLASS_2_B317B52CD46C6FE2_METHOD_2_7F870108AD2A9F7A_OFFSET UNITYSDK_OFFSET(0xCD72100)
#define CLASS_2_B317B52CD46C6FE2_METHOD_2_9C91BF7466D5AA9A_OFFSET UNITYSDK_OFFSET(0xCD71830)
#define CLASS_2_B317B52CD46C6FE2_METHOD_2_AA2D3E889C8A52CA_OFFSET UNITYSDK_OFFSET(0xCD71F00)
#define CLASS_2_B317B52CD46C6FE2_METHOD_2_B4D164980F0D1F85_OFFSET UNITYSDK_OFFSET(0xCD71CE0)
#define CLASS_2_B317B52CD46C6FE2_METHOD_2_D754D5F3490FC4F3_OFFSET UNITYSDK_OFFSET(0xCD718C0)
#define CLASS_2_B317B52CD46C6FE2_METHOD_2_E14215CF931F6112_OFFSET UNITYSDK_OFFSET(0xCD71D70)
#define CLASS_2_B317B52CD46C6FE2_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xCD71EF0)
#define CLASS_2_B317B52CD46C6FE2_SET_AVATARTYPE_OFFSET UNITYSDK_OFFSET(0xCD71EE0)
#define CLASS_2_B317B52CD46C6FE2_SET_ISASSISTPLAYER_OFFSET UNITYSDK_OFFSET(0xCD72030)
#define CLASS_2_B317B52CD46C6FE2_SET_MULTIPATHAVATARTYPE_OFFSET UNITYSDK_OFFSET(0xCD72050)
#define CLASS_2_B317B52CD46C6FE2_SET_RANK_OFFSET UNITYSDK_OFFSET(0xCD721A0)
#define CLASS_2_B317B52CD46C6FE2_SET_SKINID_OFFSET UNITYSDK_OFFSET(0xCD72070)
#define CLASS_2_B317B52CD46C6FE2_SET_ULTRASKILLCONFIG_OFFSET UNITYSDK_OFFSET(0xCD720F0)
#define CLASS_2_B317B52CD46C6FE2__CTOR_OFFSET UNITYSDK_OFFSET(0xCD72240)
...
public:
	...
	::RPG::GameCore::IAdventurePlayerCommonRowWrap* Field_2_1; // 0x20
	::System::Collections::Generic::List_1<::Class_1_7AB88D713F5121B3_47*>* Field_2_9; // 0x28
	::RPG::GameCore::IAvatarCommonRowWrap* Field_2_7; // 0x30
	::System::Collections::Generic::Dictionary_2<::System::String*, ::RPG::GameCore::AvatarSkillRow*>* Field_2_8; // 0x38
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Int32>* Field_2_10; // 0x40
	::RPG::GameCore::AvatarUltraSkillConfigRow* _UltraSkillConfig_k__BackingField; // 0x48
