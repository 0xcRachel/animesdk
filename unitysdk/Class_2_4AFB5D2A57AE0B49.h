...
#define CLASS_2_4AFB5D2A57AE0B49_DISPOSE_OFFSET UNITYSDK_OFFSET(0x83FE700)
#define CLASS_2_4AFB5D2A57AE0B49_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x83FE740)
#define CLASS_2_4AFB5D2A57AE0B49_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x83FEBA0)
#define CLASS_2_4AFB5D2A57AE0B49_TICK_OFFSET UNITYSDK_OFFSET(0x83FEBF0)
#define CLASS_2_4AFB5D2A57AE0B49__CTOR_OFFSET UNITYSDK_OFFSET(0x83FE6F0)

inline static constexpr unsigned int Class_2_4AFB5D2A57AE0B49_TypeDefinitionIndex = 43437;
