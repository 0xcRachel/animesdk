...
#define CLASS_2_8949ED997353C59D_EXECUTE_OFFSET UNITYSDK_OFFSET(0x114DE260)
#define CLASS_2_8949ED997353C59D_FILTER_OFFSET UNITYSDK_OFFSET(0x114DE0E0)
#define CLASS_2_8949ED997353C59D_GETTRIGGER_OFFSET UNITYSDK_OFFSET(0x114DDFE0)
#define CLASS_2_8949ED997353C59D__CTOR_OFFSET UNITYSDK_OFFSET(0x114DDF90)

inline static constexpr unsigned int Class_2_8949ED997353C59D_TypeDefinitionIndex = 61813;
