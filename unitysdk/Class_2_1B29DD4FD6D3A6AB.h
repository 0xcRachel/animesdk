...
#define CLASS_2_1B29DD4FD6D3A6AB_DISPOSE_OFFSET UNITYSDK_OFFSET(0xE658DB0)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_018E23A6BFBE4F07_OFFSET UNITYSDK_OFFSET(0xE659080)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_0D64676477D5996D_OFFSET UNITYSDK_OFFSET(0xE659390)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_0FA0973E87FBD363_OFFSET UNITYSDK_OFFSET(0xE65A310)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_1AC289536ACFCBF7_OFFSET UNITYSDK_OFFSET(0xE659980)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_22C031C2E2271C85_OFFSET UNITYSDK_OFFSET(0xE6596C0)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_29861B2485680DBB_OFFSET UNITYSDK_OFFSET(0xE65A230)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_2F2AAD4F857EEAF2_OFFSET UNITYSDK_OFFSET(0xE6578E0)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_3A6BA667BEB66A7B_OFFSET UNITYSDK_OFFSET(0xE659AD0)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_40608173835C5AA5_OFFSET UNITYSDK_OFFSET(0xE656450)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_41AA181104E03F2C_OFFSET UNITYSDK_OFFSET(0xE656BD0)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_481AC0E4E3F3D73B_OFFSET UNITYSDK_OFFSET(0xE6576C0)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_50F388BA53C37D92_OFFSET UNITYSDK_OFFSET(0xE65A6D0)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_512D0C099C5FEC54_OFFSET UNITYSDK_OFFSET(0xE658A50)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_52C78C4FB0FA67B1_OFFSET UNITYSDK_OFFSET(0xE656C60)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_56E5DB6CD9DEE332_OFFSET UNITYSDK_OFFSET(0xE658CD0)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_5906F1C536BB1219_OFFSET UNITYSDK_OFFSET(0xE65A6E0)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_594946548B397366_OFFSET UNITYSDK_OFFSET(0xE659110)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_6296A4FDF807C4BF_OFFSET UNITYSDK_OFFSET(0xE659220)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_7E462A97DE7ACFDA_OFFSET UNITYSDK_OFFSET(0xE65A0D0)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_86C481A3D49D6F8C_OFFSET UNITYSDK_OFFSET(0xE659C60)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_AF769CD15806BD66_OFFSET UNITYSDK_OFFSET(0xE65A620)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_B7B7628F0F1CBB5D_OFFSET UNITYSDK_OFFSET(0xE6572D0)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_C50B93169B85DAEA_OFFSET UNITYSDK_OFFSET(0xE65A530)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xE659010)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_D99F7A1200193152_OFFSET UNITYSDK_OFFSET(0xE657530)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_DFC952E721F9A35E_OFFSET UNITYSDK_OFFSET(0xE657710)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_E34D65A3EBA8DAE3_OFFSET UNITYSDK_OFFSET(0xE65A580)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_E647A07FFD9E8CA5_OFFSET UNITYSDK_OFFSET(0xE658290)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xE65A610)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_F0E307B84478A272_OFFSET UNITYSDK_OFFSET(0xE6565A0)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_F735CB8DA6A8EFD7_OFFSET UNITYSDK_OFFSET(0xE6565D0)
#define CLASS_2_1B29DD4FD6D3A6AB_METHOD_2_FEDE09C198114DBE_OFFSET UNITYSDK_OFFSET(0xE6574E0)
#define CLASS_2_1B29DD4FD6D3A6AB_ONMODELARTLOADED_OFFSET UNITYSDK_OFFSET(0xE658E30)
#define CLASS_2_1B29DD4FD6D3A6AB_ONMODELARTUNLOADED_OFFSET UNITYSDK_OFFSET(0xE658FC0)
#define CLASS_2_1B29DD4FD6D3A6AB_TICK_OFFSET UNITYSDK_OFFSET(0xE656670)
#define CLASS_2_1B29DD4FD6D3A6AB__CCTOR_OFFSET UNITYSDK_OFFSET(0xE65A700)
#define CLASS_2_1B29DD4FD6D3A6AB__CTOR_OFFSET UNITYSDK_OFFSET(0xE6583A0)
#define CLASS_2_1B29DD4FD6D3A6AB___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0xE65A7B0)
...
public:
	...
	{
		return (::System::Collections::Generic::HashSet_1<::RPG::GameCore::GameEntity*>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_1B29DD4FD6D3A6AB_TypeDefinitionIndex)->GetStaticField(0x1BE50);
	}
	::RPG::GameCore::LevelNpcLookAtTargetInfo* Field_2_2; // 0x18
	::RPG::GameCore::OnEventCallBack* Field_2_13; // 0x20
	::RPG::Client::CharacterMonoAvatar* Field_2_7; // 0x28
	::RPG::GameCore::LevelLookAtPositionInfo* Field_2_3; // 0x30
	::System::Nullable_1<::Struct_2_4C8316D252AABDF5> Field_2_9; // 0x38
	::RPG::Client::LookAtIK* Field_2_6; // 0x60
	::RPG::GameCore::CharacterAnimZone* Field_2_5; // 0x68
	...
	::System::Collections::Generic::List_1<::System::Collections::Generic::List_1<::Struct_2_4C8316D252AABDF5>*>* Field_2_10; // 0x98
