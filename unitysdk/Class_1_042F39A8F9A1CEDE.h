...
#define CLASS_1_042F39A8F9A1CEDE_GET_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x12C6ACE0)
#define CLASS_1_042F39A8F9A1CEDE_GET_CURRENTCNT_OFFSET UNITYSDK_OFFSET(0x12C6AD00)
#define CLASS_1_042F39A8F9A1CEDE_GET_ISSHELFUNLOCK_OFFSET UNITYSDK_OFFSET(0x12C6AD20)
#define CLASS_1_042F39A8F9A1CEDE_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x12C6ACC0)
#define CLASS_1_042F39A8F9A1CEDE_GET_LOCALISVISIBLE_OFFSET UNITYSDK_OFFSET(0x12C6AD60)
#define CLASS_1_042F39A8F9A1CEDE_GET_REWARDS_OFFSET UNITYSDK_OFFSET(0x12C6AD40)
#define CLASS_1_042F39A8F9A1CEDE_SET_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x12C6ACF0)
#define CLASS_1_042F39A8F9A1CEDE_SET_CURRENTCNT_OFFSET UNITYSDK_OFFSET(0x12C6AD10)
#define CLASS_1_042F39A8F9A1CEDE_SET_ISSHELFUNLOCK_OFFSET UNITYSDK_OFFSET(0x12C6AD30)
#define CLASS_1_042F39A8F9A1CEDE_SET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x12C6ACD0)
#define CLASS_1_042F39A8F9A1CEDE_SET_LOCALISVISIBLE_OFFSET UNITYSDK_OFFSET(0x12C6AD70)
#define CLASS_1_042F39A8F9A1CEDE_SET_REWARDS_OFFSET UNITYSDK_OFFSET(0x12C6AD50)
#define CLASS_1_042F39A8F9A1CEDE__CTOR_OFFSET UNITYSDK_OFFSET(0x12C6AD80)

inline static constexpr unsigned int Class_1_042F39A8F9A1CEDE_TypeDefinitionIndex = 68512;
