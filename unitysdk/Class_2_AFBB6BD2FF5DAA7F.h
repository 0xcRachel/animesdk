...
#define CLASS_2_AFBB6BD2FF5DAA7F_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1110EAC0)
#define CLASS_2_AFBB6BD2FF5DAA7F_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1110EB00)
#define CLASS_2_AFBB6BD2FF5DAA7F_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1110EBD0)
#define CLASS_2_AFBB6BD2FF5DAA7F_TICK_OFFSET UNITYSDK_OFFSET(0x1110EC20)
#define CLASS_2_AFBB6BD2FF5DAA7F__CTOR_OFFSET UNITYSDK_OFFSET(0x1110EAB0)

inline static constexpr unsigned int Class_2_AFBB6BD2FF5DAA7F_TypeDefinitionIndex = 46299;
