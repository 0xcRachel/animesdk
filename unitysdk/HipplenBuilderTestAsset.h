...
#define HIPPLENBUILDERTESTASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1054B2A0)

inline static constexpr unsigned int HipplenBuilderTestAsset_TypeDefinitionIndex = 37176;
