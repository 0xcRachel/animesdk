...
#define CLASS_2_3B0E5F2A5B82B87F_DISPOSE_OFFSET UNITYSDK_OFFSET(0x118B9B80)
#define CLASS_2_3B0E5F2A5B82B87F_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x118B9E30)
#define CLASS_2_3B0E5F2A5B82B87F_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x118B9CC0)
#define CLASS_2_3B0E5F2A5B82B87F_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x118B9D80)
#define CLASS_2_3B0E5F2A5B82B87F_TICK_OFFSET UNITYSDK_OFFSET(0x118B9DD0)
#define CLASS_2_3B0E5F2A5B82B87F__CTOR_OFFSET UNITYSDK_OFFSET(0x118B9B70)
