...
#define CLASS_2_72710C1D0F2BEFEA_CLEARSERVERCACHE_OFFSET UNITYSDK_OFFSET(0x171B8480)
#define CLASS_2_72710C1D0F2BEFEA_GETSERVERBLOCKMANIFESTNAME_OFFSET UNITYSDK_OFFSET(0x171B82A0)
#define CLASS_2_72710C1D0F2BEFEA_GETTYPENAME_OFFSET UNITYSDK_OFFSET(0x171B7E80)
#define CLASS_2_72710C1D0F2BEFEA_GET_BASEABSOLUTEPATH_OFFSET UNITYSDK_OFFSET(0x171B7F00)
#define CLASS_2_72710C1D0F2BEFEA_GET_BLOCKMANIFESTNAME_OFFSET UNITYSDK_OFFSET(0x171B8070)
#define CLASS_2_72710C1D0F2BEFEA_GET_BLOCKVERSIONNAME_OFFSET UNITYSDK_OFFSET(0x171B8060)
#define CLASS_2_72710C1D0F2BEFEA_GET_BUNDLEMANIFESTNAME_OFFSET UNITYSDK_OFFSET(0x171B8050)
#define CLASS_2_72710C1D0F2BEFEA_GET_BUNDLEVERSIONNAME_OFFSET UNITYSDK_OFFSET(0x171B8040)
#define CLASS_2_72710C1D0F2BEFEA_GET_DEFAULTABSOLUTEPATH_OFFSET UNITYSDK_OFFSET(0x171B7ED0)
#define CLASS_2_72710C1D0F2BEFEA_GET_ISENABLE_OFFSET UNITYSDK_OFFSET(0x171B8080)
#define CLASS_2_72710C1D0F2BEFEA_GET_RELATIVEPATH_OFFSET UNITYSDK_OFFSET(0x171B8010)
#define CLASS_2_72710C1D0F2BEFEA_METHOD_2_1F55D6FEF27052D4_OFFSET UNITYSDK_OFFSET(0x171B80A0)
#define CLASS_2_72710C1D0F2BEFEA_METHOD_2_4DF4D9162AD406FC_OFFSET UNITYSDK_OFFSET(0x171B8500)
#define CLASS_2_72710C1D0F2BEFEA_METHOD_2_607DC1108DED7773_OFFSET UNITYSDK_OFFSET(0x171B8640)
#define CLASS_2_72710C1D0F2BEFEA_METHOD_2_726FF441D405FD0E_OFFSET UNITYSDK_OFFSET(0x171B8170)
#define CLASS_2_72710C1D0F2BEFEA_METHOD_2_A27577C98E9715A0_OFFSET UNITYSDK_OFFSET(0x171B88D0)
#define CLASS_2_72710C1D0F2BEFEA_METHOD_2_E815DACFC7B4951E_OFFSET UNITYSDK_OFFSET(0x171B8840)
#define CLASS_2_72710C1D0F2BEFEA_ONALLSUCCEED_OFFSET UNITYSDK_OFFSET(0x171B8B10)
#define CLASS_2_72710C1D0F2BEFEA_ONENUMBLOCKITEMS_OFFSET UNITYSDK_OFFSET(0x171B85B0)
#define CLASS_2_72710C1D0F2BEFEA_RESET_OFFSET UNITYSDK_OFFSET(0x171B83F0)
#define CLASS_2_72710C1D0F2BEFEA_SET_ISENABLE_OFFSET UNITYSDK_OFFSET(0x171B8090)
#define CLASS_2_72710C1D0F2BEFEA__CTOR_OFFSET UNITYSDK_OFFSET(0x171B8C10)
#define CLASS_2_72710C1D0F2BEFEA__LOADINDEXINFO_OFFSET UNITYSDK_OFFSET(0x171B8250)
#define CLASS_2_72710C1D0F2BEFEA___IFIXBASEPROXY_CLEARSERVERCACHE_OFFSET UNITYSDK_OFFSET(0x171B8CF0)
#define CLASS_2_72710C1D0F2BEFEA___IFIXBASEPROXY_GETSERVERBLOCKMANIFESTNAME_OFFSET UNITYSDK_OFFSET(0x171B8C50)
#define CLASS_2_72710C1D0F2BEFEA___IFIXBASEPROXY_GET_BASEABSOLUTEPATH_OFFSET UNITYSDK_OFFSET(0x171B8C40)
#define CLASS_2_72710C1D0F2BEFEA___IFIXBASEPROXY_ONENUMBLOCKITEMS_OFFSET UNITYSDK_OFFSET(0x171B8D70)
#define CLASS_2_72710C1D0F2BEFEA___IFIXBASEPROXY_RESET_OFFSET UNITYSDK_OFFSET(0x171B8C60)
