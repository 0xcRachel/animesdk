...
#define CLASS_1_BDE0598EF34BE45E_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A3C4760)
#define CLASS_1_BDE0598EF34BE45E_CLONE_OFFSET UNITYSDK_OFFSET(0x1A3C4350)
#define CLASS_1_BDE0598EF34BE45E_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A3C4530)
#define CLASS_1_BDE0598EF34BE45E_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A3C4440)
#define CLASS_1_BDE0598EF34BE45E_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A3C4610)
#define CLASS_1_BDE0598EF34BE45E_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A3C4890)
#define CLASS_1_BDE0598EF34BE45E_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A3C47F0)
#define CLASS_1_BDE0598EF34BE45E_METHOD_1_24748FC20F375725_1_OFFSET UNITYSDK_OFFSET(0x1A3C4420)
#define CLASS_1_BDE0598EF34BE45E_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x1A3C4400)
#define CLASS_1_BDE0598EF34BE45E_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A3C4260)
#define CLASS_1_BDE0598EF34BE45E_METHOD_1_8C8625211DA811AE_1_OFFSET UNITYSDK_OFFSET(0x1A3C4430)
#define CLASS_1_BDE0598EF34BE45E_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x1A3C4410)
#define CLASS_1_BDE0598EF34BE45E_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A3C4290)
#define CLASS_1_BDE0598EF34BE45E_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A3C4670)
#define CLASS_1_BDE0598EF34BE45E_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A3C46D0)
#define CLASS_1_BDE0598EF34BE45E__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A3C4950)
#define CLASS_1_BDE0598EF34BE45E__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3C42B0)
#define CLASS_1_BDE0598EF34BE45E__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3C42A0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_BDE0598EF34BE45E*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_BDE0598EF34BE45E_TypeDefinitionIndex)->GetStaticField(0x4CC00);
	}
	// static const ::System::Int32 Field_1_2 = 0xCB; // 0x0
	// static const ::System::Int32 Field_1_4 = 0x384; // 0x0
	::Google::Protobuf::UnknownFieldSet* Field_1_1; // 0x10
	::Class_1_4B52859374487DA3_2* Field_1_3; // 0x18
