...
#define CLASS_1_BDE0598EF34BE45E_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A6BAE70)
#define CLASS_1_BDE0598EF34BE45E_CLONE_OFFSET UNITYSDK_OFFSET(0x1A6BAA60)
#define CLASS_1_BDE0598EF34BE45E_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A6BAC40)
#define CLASS_1_BDE0598EF34BE45E_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A6BAB50)
#define CLASS_1_BDE0598EF34BE45E_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A6BAD20)
#define CLASS_1_BDE0598EF34BE45E_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A6BAFA0)
#define CLASS_1_BDE0598EF34BE45E_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A6BAF00)
#define CLASS_1_BDE0598EF34BE45E_METHOD_1_24748FC20F375725_1_OFFSET UNITYSDK_OFFSET(0x1A6BAB30)
#define CLASS_1_BDE0598EF34BE45E_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x1A6BAB10)
#define CLASS_1_BDE0598EF34BE45E_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A6BA970)
#define CLASS_1_BDE0598EF34BE45E_METHOD_1_8C8625211DA811AE_1_OFFSET UNITYSDK_OFFSET(0x1A6BAB40)
#define CLASS_1_BDE0598EF34BE45E_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x1A6BAB20)
#define CLASS_1_BDE0598EF34BE45E_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A6BA9A0)
#define CLASS_1_BDE0598EF34BE45E_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A6BAD80)
#define CLASS_1_BDE0598EF34BE45E_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A6BADE0)
#define CLASS_1_BDE0598EF34BE45E__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A6BB140)
#define CLASS_1_BDE0598EF34BE45E__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A6BA9C0)
#define CLASS_1_BDE0598EF34BE45E__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6BA9B0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_BDE0598EF34BE45E*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_BDE0598EF34BE45E_TypeDefinitionIndex)->GetStaticField(0x10A60);
	}
	// static const ::System::Int32 Field_1_1 = 0x5C0; // 0x0
	// static const ::System::Int32 Field_1_2 = 0x36A; // 0x0
	::Class_1_4B52859374487DA3_1* Field_1_3; // 0x10
	::Class_1_4AA6AAA49C7B466C* Field_1_4; // 0x18
