...
#define CLASS_2_EC921BDB521EAFF6_DISPOSE_OFFSET UNITYSDK_OFFSET(0xFEEAD90)
#define CLASS_2_EC921BDB521EAFF6_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xFEEAF00)
#define CLASS_2_EC921BDB521EAFF6_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xFEEAF80)
#define CLASS_2_EC921BDB521EAFF6_TICK_OFFSET UNITYSDK_OFFSET(0xFEEB000)
#define CLASS_2_EC921BDB521EAFF6__CTOR_OFFSET UNITYSDK_OFFSET(0xFEEAD80)

inline static constexpr unsigned int Class_2_EC921BDB521EAFF6_TypeDefinitionIndex = 42230;
