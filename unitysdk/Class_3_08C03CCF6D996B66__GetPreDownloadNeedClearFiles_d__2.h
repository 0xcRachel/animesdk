...
#define CLASS_3_08C03CCF6D996B66__GETPREDOWNLOADNEEDCLEARFILES_D__2_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xD4C3790)
#define CLASS_3_08C03CCF6D996B66__GETPREDOWNLOADNEEDCLEARFILES_D__2_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_TUPLE_SYSTEM_STRING_SYSTEM_BOOLEAN___GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xD4C3EE0)
#define CLASS_3_08C03CCF6D996B66__GETPREDOWNLOADNEEDCLEARFILES_D__2_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_TUPLE_SYSTEM_STRING_SYSTEM_BOOLEAN___GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD4C3E70)
#define CLASS_3_08C03CCF6D996B66__GETPREDOWNLOADNEEDCLEARFILES_D__2_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xD4C3F60)
#define CLASS_3_08C03CCF6D996B66__GETPREDOWNLOADNEEDCLEARFILES_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD4C3ED0)
#define CLASS_3_08C03CCF6D996B66__GETPREDOWNLOADNEEDCLEARFILES_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xD4C3E80)
#define CLASS_3_08C03CCF6D996B66__GETPREDOWNLOADNEEDCLEARFILES_D__2_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD4C3610)
#define CLASS_3_08C03CCF6D996B66__GETPREDOWNLOADNEEDCLEARFILES_D__2__CTOR_OFFSET UNITYSDK_OFFSET(0xD4C35C0)
#define CLASS_3_08C03CCF6D996B66__GETPREDOWNLOADNEEDCLEARFILES_D__2___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0xD4C36E0)
