...
public:
	...
	{
		return (::System::Predicate_1<::RPG::GameCore::GameEntity*>**)Il2CppClass::FromTypeDefinitionIndex(Class_3_79F61E3248BECD05___O_TypeDefinitionIndex)->GetStaticField(0x3C2B0);
	}
};
