...
#define CLASS_1_A188133F1B13F2BD_GET_DESC_OFFSET UNITYSDK_OFFSET(0x171B36C0)
#define CLASS_1_A188133F1B13F2BD_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x171B36E0)
#define CLASS_1_A188133F1B13F2BD_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x171B3650)
#define CLASS_1_A188133F1B13F2BD_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x171B3660)
#define CLASS_1_A188133F1B13F2BD_GET_NAME_OFFSET UNITYSDK_OFFSET(0x171B36A0)
#define CLASS_1_A188133F1B13F2BD_GET_PARAM_OFFSET UNITYSDK_OFFSET(0x171B3760)
#define CLASS_1_A188133F1B13F2BD_GET_RANKABILITY_OFFSET UNITYSDK_OFFSET(0x171B3720)
#define CLASS_1_A188133F1B13F2BD_GET_SKILLADDLEVELLIST_OFFSET UNITYSDK_OFFSET(0x171B3700)
#define CLASS_1_A188133F1B13F2BD_GET_TRIGGER_OFFSET UNITYSDK_OFFSET(0x171B3680)
#define CLASS_1_A188133F1B13F2BD_GET_UNLOCKCOST_OFFSET UNITYSDK_OFFSET(0x171B3740)
#define CLASS_1_A188133F1B13F2BD_SET_DESC_OFFSET UNITYSDK_OFFSET(0x171B36D0)
#define CLASS_1_A188133F1B13F2BD_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x171B36F0)
#define CLASS_1_A188133F1B13F2BD_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x171B3670)
#define CLASS_1_A188133F1B13F2BD_SET_NAME_OFFSET UNITYSDK_OFFSET(0x171B36B0)
#define CLASS_1_A188133F1B13F2BD_SET_PARAM_OFFSET UNITYSDK_OFFSET(0x171B3770)
#define CLASS_1_A188133F1B13F2BD_SET_RANKABILITY_OFFSET UNITYSDK_OFFSET(0x171B3730)
#define CLASS_1_A188133F1B13F2BD_SET_SKILLADDLEVELLIST_OFFSET UNITYSDK_OFFSET(0x171B3710)
#define CLASS_1_A188133F1B13F2BD_SET_TRIGGER_OFFSET UNITYSDK_OFFSET(0x171B3690)
#define CLASS_1_A188133F1B13F2BD_SET_UNLOCKCOST_OFFSET UNITYSDK_OFFSET(0x171B3750)
#define CLASS_1_A188133F1B13F2BD__CTOR_OFFSET UNITYSDK_OFFSET(0x171B3780)
...
public:
	...
	::System::Collections::Generic::IReadOnlyDictionary_2<::System::UInt32, ::System::UInt32>* _SkillAddLevelList_k__BackingField; // 0x18
	::Il2CppArray<::RPG::GameCore::FixPoint>* _Param_k__BackingField; // 0x20
	::Il2CppArray<::RPG::GameCore::ItemConfig*>* _UnlockCost_k__BackingField; // 0x28
	::System::String* _IconPath_k__BackingField; // 0x30
	::System::String* _Desc_k__BackingField; // 0x38
	::Il2CppArray<::System::String*>* _RankAbility_k__BackingField; // 0x40
