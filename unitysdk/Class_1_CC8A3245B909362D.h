...
#define CLASS_1_CC8A3245B909362D_METHOD_1_0C7CBCE710B3F112_OFFSET UNITYSDK_OFFSET(0x167579E0)
#define CLASS_1_CC8A3245B909362D_METHOD_1_14A0DD9050A7388E_OFFSET UNITYSDK_OFFSET(0x16757A30)
#define CLASS_1_CC8A3245B909362D_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x16757800)
#define CLASS_1_CC8A3245B909362D_METHOD_1_6B72D4EE8C6E907F_OFFSET UNITYSDK_OFFSET(0x167571C0)
#define CLASS_1_CC8A3245B909362D_METHOD_1_7AC0390B2CBE2739_OFFSET UNITYSDK_OFFSET(0x16757470)
#define CLASS_1_CC8A3245B909362D_METHOD_1_8B22A037A70B13E3_OFFSET UNITYSDK_OFFSET(0x167575F0)
#define CLASS_1_CC8A3245B909362D_METHOD_1_8F919FD82057FFF1_OFFSET UNITYSDK_OFFSET(0x16757140)
#define CLASS_1_CC8A3245B909362D_METHOD_1_AD31DD9682084C83_OFFSET UNITYSDK_OFFSET(0x167578A0)
#define CLASS_1_CC8A3245B909362D_METHOD_1_CE34EA208837238D_OFFSET UNITYSDK_OFFSET(0x16757410)
#define CLASS_1_CC8A3245B909362D_METHOD_1_F0E307B84478A272_OFFSET UNITYSDK_OFFSET(0x167577C0)
#define CLASS_1_CC8A3245B909362D_METHOD_1_F2E1599CBB58B20F_OFFSET UNITYSDK_OFFSET(0x16757940)
#define CLASS_1_CC8A3245B909362D__CCTOR_OFFSET UNITYSDK_OFFSET(0x16757D40)

inline static constexpr unsigned int Class_1_CC8A3245B909362D_TypeDefinitionIndex = 12803;
...
public:
	...
	{
		return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_CC8A3245B909362D_TypeDefinitionIndex)->GetStaticField(0x22E80);
	}
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::RPG::GameCore::CommonIndexKey, ::RPG::GameCore::MazePuzzleWolfBroRow*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_CC8A3245B909362D_TypeDefinitionIndex)->GetStaticField(0x22E88);
	}
	static ::System::Action_1<::Class_1_7A22A3DBEEDD1F80*>** StaticGet_Field_1_3()
	{
		return (::System::Action_1<::Class_1_7A22A3DBEEDD1F80*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_CC8A3245B909362D_TypeDefinitionIndex)->GetStaticField(0x22E90);
	}
	static ::System::Boolean* StaticGet_Field_1_1()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_1_CC8A3245B909362D_TypeDefinitionIndex)->GetStaticField(0x7080);
	}
	static ::System::Byte* StaticGet_Field_1_2()
	{
		return (::System::Byte*)Il2CppClass::FromTypeDefinitionIndex(Class_1_CC8A3245B909362D_TypeDefinitionIndex)->GetStaticField(0x7081);
	}
