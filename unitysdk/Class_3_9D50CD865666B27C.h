...
#define CLASS_3_9D50CD865666B27C_METHOD_3_D0B0E8495E8A13B8_OFFSET UNITYSDK_OFFSET(0x17313040)
#define CLASS_3_9D50CD865666B27C_METHOD_3_E61C16044B7481FF_OFFSET UNITYSDK_OFFSET(0x173135E0)
#define CLASS_3_9D50CD865666B27C_ONCLEAR_OFFSET UNITYSDK_OFFSET(0x173130D0)
#define CLASS_3_9D50CD865666B27C_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x17313160)
#define CLASS_3_9D50CD865666B27C__CTOR_OFFSET UNITYSDK_OFFSET(0x17313630)
#define CLASS_3_9D50CD865666B27C___IFIXBASEPROXY_ONCLEAR_OFFSET UNITYSDK_OFFSET(0x17313640)
#define CLASS_3_9D50CD865666B27C___IFIXBASEPROXY_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x173136A0)
...
public:
	...
	::UnityEngine::Vector2 Field_3_6; // 0x38
	::RPG::Client::LittleGame::Match3::OpponentRole Field_3_7; // 0x40
