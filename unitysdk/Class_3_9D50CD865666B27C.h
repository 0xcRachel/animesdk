...
#define CLASS_3_9D50CD865666B27C_METHOD_3_D0B0E8495E8A13B8_OFFSET UNITYSDK_OFFSET(0x11120B90)
#define CLASS_3_9D50CD865666B27C_METHOD_3_EBEE0D0A222A8264_OFFSET UNITYSDK_OFFSET(0x111210B0)
#define CLASS_3_9D50CD865666B27C_ONCLEAR_OFFSET UNITYSDK_OFFSET(0x11120C20)
#define CLASS_3_9D50CD865666B27C_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x11120CB0)
#define CLASS_3_9D50CD865666B27C__CTOR_OFFSET UNITYSDK_OFFSET(0x11121100)
#define CLASS_3_9D50CD865666B27C___IFIXBASEPROXY_ONCLEAR_OFFSET UNITYSDK_OFFSET(0x11121110)
#define CLASS_3_9D50CD865666B27C___IFIXBASEPROXY_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x11121170)

inline static constexpr unsigned int Class_3_9D50CD865666B27C_TypeDefinitionIndex = 52348;
...
public:
	...
	::RPG::Client::LittleGame::Match3::OpponentRole Field_3_5; // 0x38
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_3_9D50CD865666B27C_METHOD_3_EBEE0D0A222A8264_OFFSET))(this);
	}
