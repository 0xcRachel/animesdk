...
#define MONOPROGRAMMATRIXTRANSFERANIM_PCGUNIT_METHOD_1_18D3A646DDD61291_OFFSET UNITYSDK_OFFSET(0x112001D0)
#define MONOPROGRAMMATRIXTRANSFERANIM_PCGUNIT_METHOD_1_2AD04807B794EEB6_OFFSET UNITYSDK_OFFSET(0x11200A20)
#define MONOPROGRAMMATRIXTRANSFERANIM_PCGUNIT_METHOD_1_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x111FFD90)
#define MONOPROGRAMMATRIXTRANSFERANIM_PCGUNIT_METHOD_1_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x11200E00)
#define MONOPROGRAMMATRIXTRANSFERANIM_PCGUNIT_METHOD_1_B768DA94E3FD91D9_OFFSET UNITYSDK_OFFSET(0x11200080)
#define MONOPROGRAMMATRIXTRANSFERANIM_PCGUNIT_METHOD_1_FDC478E941B91C50_OFFSET UNITYSDK_OFFSET(0x11200E50)
#define MONOPROGRAMMATRIXTRANSFERANIM_PCGUNIT__CCTOR_OFFSET UNITYSDK_OFFSET(0x112010B0)
#define MONOPROGRAMMATRIXTRANSFERANIM_PCGUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x112010A0)

inline static constexpr unsigned int MonoProgramMatrixTransferAnim_PCGUnit_TypeDefinitionIndex = 37410;
...
public:
	...
	{
		return (::Il2CppArray<::UnityEngine::Vector4>**)Il2CppClass::FromTypeDefinitionIndex(MonoProgramMatrixTransferAnim_PCGUnit_TypeDefinitionIndex)->GetStaticField(0x44C10);
	}
