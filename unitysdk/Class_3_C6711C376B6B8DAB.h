...
#define CLASS_3_C6711C376B6B8DAB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10AAC550)
#define CLASS_3_C6711C376B6B8DAB_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10AAC590)
#define CLASS_3_C6711C376B6B8DAB__CTOR_OFFSET UNITYSDK_OFFSET(0x10AAC520)
#define CLASS_3_C6711C376B6B8DAB___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10AAC7C0)

inline static constexpr unsigned int Class_3_C6711C376B6B8DAB_TypeDefinitionIndex = 44147;
