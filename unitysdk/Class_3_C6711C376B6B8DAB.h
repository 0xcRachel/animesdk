...
#define CLASS_3_C6711C376B6B8DAB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8A2E540)
#define CLASS_3_C6711C376B6B8DAB_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x8A2E580)
#define CLASS_3_C6711C376B6B8DAB__CTOR_OFFSET UNITYSDK_OFFSET(0x8A2E510)
#define CLASS_3_C6711C376B6B8DAB___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8A2E7B0)
