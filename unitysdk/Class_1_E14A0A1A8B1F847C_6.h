...
#define CLASS_1_E14A0A1A8B1F847C_6_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1812F0D0)
#define CLASS_1_E14A0A1A8B1F847C_6_CLONE_OFFSET UNITYSDK_OFFSET(0x1812EC90)
#define CLASS_1_E14A0A1A8B1F847C_6_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1812EDB0)
#define CLASS_1_E14A0A1A8B1F847C_6_EQUALS_OFFSET UNITYSDK_OFFSET(0x1812ED80)
#define CLASS_1_E14A0A1A8B1F847C_6_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1812EE90)
#define CLASS_1_E14A0A1A8B1F847C_6_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1812F410)
#define CLASS_1_E14A0A1A8B1F847C_6_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1812F380)
#define CLASS_1_E14A0A1A8B1F847C_6_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1812ED20)
#define CLASS_1_E14A0A1A8B1F847C_6_METHOD_1_02A3D10A9D535169_2_OFFSET UNITYSDK_OFFSET(0x1812ED40)
#define CLASS_1_E14A0A1A8B1F847C_6_METHOD_1_02A3D10A9D535169_3_OFFSET UNITYSDK_OFFSET(0x1812ED60)
#define CLASS_1_E14A0A1A8B1F847C_6_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1812ECD0)
#define CLASS_1_E14A0A1A8B1F847C_6_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1812ED30)
#define CLASS_1_E14A0A1A8B1F847C_6_METHOD_1_7786DC814C2FC3BE_2_OFFSET UNITYSDK_OFFSET(0x1812ED50)
#define CLASS_1_E14A0A1A8B1F847C_6_METHOD_1_7786DC814C2FC3BE_3_OFFSET UNITYSDK_OFFSET(0x1812ED70)
#define CLASS_1_E14A0A1A8B1F847C_6_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1812ECE0)
#define CLASS_1_E14A0A1A8B1F847C_6_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1812ED00)
#define CLASS_1_E14A0A1A8B1F847C_6_METHOD_1_EA98AC27B86895E5_1_OFFSET UNITYSDK_OFFSET(0x1812ED10)
#define CLASS_1_E14A0A1A8B1F847C_6_METHOD_1_EA98AC27B86895E5_OFFSET UNITYSDK_OFFSET(0x1812ECC0)
#define CLASS_1_E14A0A1A8B1F847C_6_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1812ECF0)
#define CLASS_1_E14A0A1A8B1F847C_6_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1812EB70)
#define CLASS_1_E14A0A1A8B1F847C_6_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1812EF00)
#define CLASS_1_E14A0A1A8B1F847C_6_WRITETO_OFFSET UNITYSDK_OFFSET(0x1812EF60)
#define CLASS_1_E14A0A1A8B1F847C_6__CCTOR_OFFSET UNITYSDK_OFFSET(0x1812F580)
#define CLASS_1_E14A0A1A8B1F847C_6__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1812EBD0)
#define CLASS_1_E14A0A1A8B1F847C_6__CTOR_OFFSET UNITYSDK_OFFSET(0x1812EB80)
...
public:
	...
	{
		return (::Google::Protobuf::Collections::MapField_2_Codec<::System::UInt32, ::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E14A0A1A8B1F847C_6_TypeDefinitionIndex)->GetStaticField(0x419A0);
	}
	static ::Google::Protobuf::Collections::MapField_2_Codec<::System::UInt32, ::System::UInt32>** StaticGet_Field_1_9()
	{
		return (::Google::Protobuf::Collections::MapField_2_Codec<::System::UInt32, ::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E14A0A1A8B1F847C_6_TypeDefinitionIndex)->GetStaticField(0x419A8);
	}
