...
#define AKEVENT_CALLBACK_OFFSET UNITYSDK_OFFSET(0x18398700)
#define AKEVENT_GET_EVENTID_OFFSET UNITYSDK_OFFSET(0x183989D0)
#define AKEVENT_GET_M_CALLBACKDATA_OFFSET UNITYSDK_OFFSET(0x18398B90)
#define AKEVENT_GET_VALUEGUID_OFFSET UNITYSDK_OFFSET(0x18398A50)
#define AKEVENT_GET_WWISETYPE_OFFSET UNITYSDK_OFFSET(0x183986B0)
#define AKEVENT_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x18378880)
#define AKEVENT_START_OFFSET UNITYSDK_OFFSET(0x18377A10)
#define AKEVENT_STOP_1_OFFSET UNITYSDK_OFFSET(0x183988E0)
#define AKEVENT_STOP_OFFSET UNITYSDK_OFFSET(0x18398880)
#define AKEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x183791A0)
#define AKEVENT___IFIXBASEPROXY_START_OFFSET UNITYSDK_OFFSET(0x18398BA0)

inline static constexpr unsigned int AkEvent_TypeDefinitionIndex = 33669;
