...
#define AKEVENT_CALLBACK_OFFSET UNITYSDK_OFFSET(0x18BBD310)
#define AKEVENT_GET_EVENTID_OFFSET UNITYSDK_OFFSET(0x18BBD5E0)
#define AKEVENT_GET_M_CALLBACKDATA_OFFSET UNITYSDK_OFFSET(0x18BBD7A0)
#define AKEVENT_GET_VALUEGUID_OFFSET UNITYSDK_OFFSET(0x18BBD660)
#define AKEVENT_GET_WWISETYPE_OFFSET UNITYSDK_OFFSET(0x18BBD2C0)
#define AKEVENT_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x18B9E1D0)
#define AKEVENT_START_OFFSET UNITYSDK_OFFSET(0x18B9D360)
#define AKEVENT_STOP_1_OFFSET UNITYSDK_OFFSET(0x18BBD4F0)
#define AKEVENT_STOP_OFFSET UNITYSDK_OFFSET(0x18BBD490)
#define AKEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18B9EAF0)
#define AKEVENT___IFIXBASEPROXY_START_OFFSET UNITYSDK_OFFSET(0x18BBD7B0)
