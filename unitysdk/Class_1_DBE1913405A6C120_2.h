...
#define CLASS_1_DBE1913405A6C120_2_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x181ADD10)
#define CLASS_1_DBE1913405A6C120_2_CLONE_OFFSET UNITYSDK_OFFSET(0x181AD860)
#define CLASS_1_DBE1913405A6C120_2_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x181AD950)
#define CLASS_1_DBE1913405A6C120_2_EQUALS_OFFSET UNITYSDK_OFFSET(0x181AD920)
#define CLASS_1_DBE1913405A6C120_2_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x181ADA30)
#define CLASS_1_DBE1913405A6C120_2_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x181AE0E0)
#define CLASS_1_DBE1913405A6C120_2_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x181AE010)
#define CLASS_1_DBE1913405A6C120_2_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x181AD900)
#define CLASS_1_DBE1913405A6C120_2_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x181AD890)
#define CLASS_1_DBE1913405A6C120_2_METHOD_1_3DACC45AC8150727_1_OFFSET UNITYSDK_OFFSET(0x181AD8F0)
#define CLASS_1_DBE1913405A6C120_2_METHOD_1_3DACC45AC8150727_OFFSET UNITYSDK_OFFSET(0x181AD8C0)
#define CLASS_1_DBE1913405A6C120_2_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x181AD8D0)
#define CLASS_1_DBE1913405A6C120_2_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x181AD910)
#define CLASS_1_DBE1913405A6C120_2_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x181AD8A0)
#define CLASS_1_DBE1913405A6C120_2_METHOD_1_A96DCA30C6927810_1_OFFSET UNITYSDK_OFFSET(0x181AD8E0)
#define CLASS_1_DBE1913405A6C120_2_METHOD_1_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x181AD8B0)
#define CLASS_1_DBE1913405A6C120_2_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x181AD770)
#define CLASS_1_DBE1913405A6C120_2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x181ADB30)
#define CLASS_1_DBE1913405A6C120_2_WRITETO_OFFSET UNITYSDK_OFFSET(0x181ADB90)
#define CLASS_1_DBE1913405A6C120_2__CCTOR_OFFSET UNITYSDK_OFFSET(0x181AE1E0)
#define CLASS_1_DBE1913405A6C120_2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x181AD7C0)
#define CLASS_1_DBE1913405A6C120_2__CTOR_OFFSET UNITYSDK_OFFSET(0x181AD780)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_E6D4CCE1AC88574F*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_DBE1913405A6C120_2_TypeDefinitionIndex)->GetStaticField(0xC1A0);
	}
	...
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_E6D4CCE1AC88574F*>* Field_1_7; // 0x10
	::Google::Protobuf::UnknownFieldSet* Field_1_0; // 0x18
	::System::UInt32 Field_1_2; // 0x20
	::Enum_3_0A3761FE34514D6C_77 Field_1_9; // 0x24
	::System::UInt32 Field_1_11; // 0x28
	::Enum_3_0A3761FE34514D6C_78 Field_1_4; // 0x2C
