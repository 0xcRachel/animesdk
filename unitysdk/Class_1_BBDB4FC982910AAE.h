...
#define CLASS_1_BBDB4FC982910AAE_GET_GAMEINSTANCE_OFFSET UNITYSDK_OFFSET(0x14C13860)
#define CLASS_1_BBDB4FC982910AAE_GET_INSTANCECLIENT_OFFSET UNITYSDK_OFFSET(0x14C13850)
#define CLASS_1_BBDB4FC982910AAE_METHOD_1_00DB1B1197C37C43_OFFSET UNITYSDK_OFFSET(0x14C13250)
#define CLASS_1_BBDB4FC982910AAE_METHOD_1_0FFCA426B159D768_OFFSET UNITYSDK_OFFSET(0x14C13160)
#define CLASS_1_BBDB4FC982910AAE_METHOD_1_1F1C98D6DF492EBF_OFFSET UNITYSDK_OFFSET(0x14C13410)
#define CLASS_1_BBDB4FC982910AAE_METHOD_1_41EF9FDF8B1D6495_OFFSET UNITYSDK_OFFSET(0x14C12F50)
#define CLASS_1_BBDB4FC982910AAE_METHOD_1_686221D5DF498040_OFFSET UNITYSDK_OFFSET(0x14C13610)
#define CLASS_1_BBDB4FC982910AAE_METHOD_1_B5E70EA91188B770_OFFSET UNITYSDK_OFFSET(0x14C13300)
#define CLASS_1_BBDB4FC982910AAE_SET_GAMEINSTANCE_OFFSET UNITYSDK_OFFSET(0x14C13870)
#define CLASS_1_BBDB4FC982910AAE__CTOR_OFFSET UNITYSDK_OFFSET(0x14C12EA0)

inline static constexpr unsigned int Class_1_BBDB4FC982910AAE_TypeDefinitionIndex = 71121;

class Class_1_BBDB4FC982910AAE : public ::System::Object
{
public:
	::Class_3_C66DEDBB208C643C* _InstanceClient_k__BackingField; // 0x10
	::Entitas::IContext* Field_1_1; // 0x18
	::Class_0_16E4307DCC419505_30* _GameInstance_k__BackingField; // 0x20
