...
#define ATTACHPOINTSET_LATETICK_OFFSET UNITYSDK_OFFSET(0x10C0FED0)
#define ATTACHPOINTSET_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x10C102D0)
#define ATTACHPOINTSET_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x10C0FE40)
#define ATTACHPOINTSET_ONENABLE_OFFSET UNITYSDK_OFFSET(0x10C0FD00)
#define ATTACHPOINTSET_REFRESHLASTTARGETSCALE_OFFSET UNITYSDK_OFFSET(0x10C0FD90)
#define ATTACHPOINTSET_SELFDESTROY_OFFSET UNITYSDK_OFFSET(0x10C10110)
#define ATTACHPOINTSET__CTOR_OFFSET UNITYSDK_OFFSET(0x10C10320)
