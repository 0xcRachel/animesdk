...
#define ATTACHPOINTSET_LATETICK_OFFSET UNITYSDK_OFFSET(0x15BC0AE0)
#define ATTACHPOINTSET_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x15BC0EE0)
#define ATTACHPOINTSET_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x15BC0A50)
#define ATTACHPOINTSET_ONENABLE_OFFSET UNITYSDK_OFFSET(0x15BC0910)
#define ATTACHPOINTSET_REFRESHLASTTARGETSCALE_OFFSET UNITYSDK_OFFSET(0x15BC09A0)
#define ATTACHPOINTSET_SELFDESTROY_OFFSET UNITYSDK_OFFSET(0x15BC0D20)
#define ATTACHPOINTSET__CTOR_OFFSET UNITYSDK_OFFSET(0x15BC0F30)
