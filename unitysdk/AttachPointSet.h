...
#define ATTACHPOINTSET_LATETICK_OFFSET UNITYSDK_OFFSET(0x10560750)
#define ATTACHPOINTSET_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x10560B50)
#define ATTACHPOINTSET_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x105606C0)
#define ATTACHPOINTSET_ONENABLE_OFFSET UNITYSDK_OFFSET(0x10560580)
#define ATTACHPOINTSET_REFRESHLASTTARGETSCALE_OFFSET UNITYSDK_OFFSET(0x10560610)
#define ATTACHPOINTSET_SELFDESTROY_OFFSET UNITYSDK_OFFSET(0x10560990)
#define ATTACHPOINTSET__CTOR_OFFSET UNITYSDK_OFFSET(0x10560BA0)

inline static constexpr unsigned int AttachPointSet_TypeDefinitionIndex = 37190;
