...
#define ATTACHPOINTSET_LATETICK_OFFSET UNITYSDK_OFFSET(0xF963F80)
#define ATTACHPOINTSET_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xF964380)
#define ATTACHPOINTSET_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xF963EF0)
#define ATTACHPOINTSET_ONENABLE_OFFSET UNITYSDK_OFFSET(0xF963DB0)
#define ATTACHPOINTSET_REFRESHLASTTARGETSCALE_OFFSET UNITYSDK_OFFSET(0xF963E40)
#define ATTACHPOINTSET_SELFDESTROY_OFFSET UNITYSDK_OFFSET(0xF9641C0)
#define ATTACHPOINTSET__CTOR_OFFSET UNITYSDK_OFFSET(0xF9643D0)
