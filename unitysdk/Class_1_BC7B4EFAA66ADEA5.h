...
#define CLASS_1_BC7B4EFAA66ADEA5_GET__CONTEXTGETTER_OFFSET UNITYSDK_OFFSET(0x111E33B0)
#define CLASS_1_BC7B4EFAA66ADEA5_GET__QUERY_OFFSET UNITYSDK_OFFSET(0x111E33A0)
#define CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_0AF0F15474011B00_OFFSET UNITYSDK_OFFSET(0x111E5400)
#define CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_1979474406148984_OFFSET UNITYSDK_OFFSET(0x111E4FF0)
#define CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_30E3FC6ED964E3BD_OFFSET UNITYSDK_OFFSET(0x111E59F0)
#define CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_31966F1941496AC4_OFFSET UNITYSDK_OFFSET(0x111E5990)
#define CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_3708090ED3FBE87D_OFFSET UNITYSDK_OFFSET(0x111E55A0)
#define CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_43B12BF66E03E4A2_OFFSET UNITYSDK_OFFSET(0x111E3420)
#define CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_5A95A03CB271BFF5_OFFSET UNITYSDK_OFFSET(0x111E5680)
#define CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_602E588370918875_OFFSET UNITYSDK_OFFSET(0x111E4530)
#define CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_89248EBA05021FAD_OFFSET UNITYSDK_OFFSET(0x111E6350)
#define CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_8BDA5F88CEF3C27D_OFFSET UNITYSDK_OFFSET(0x111E41E0)
#define CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_8DF72CAC60C7C762_OFFSET UNITYSDK_OFFSET(0x111E4290)
#define CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_BA47C17B64C87B46_OFFSET UNITYSDK_OFFSET(0x111E33C0)
#define CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_C7ED994399BED449_OFFSET UNITYSDK_OFFSET(0x111E6120)
#define CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_C80EA6637207C680_OFFSET UNITYSDK_OFFSET(0x111E3A90)
#define CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_D26921A5C6265C4A_OFFSET UNITYSDK_OFFSET(0x111E5C80)
#define CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_DE674D8545616C69_OFFSET UNITYSDK_OFFSET(0x111E5BC0)
#define CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_E9BF19228E3C8BBF_OFFSET UNITYSDK_OFFSET(0x111E5310)
#define CLASS_1_BC7B4EFAA66ADEA5__CTOR_OFFSET UNITYSDK_OFFSET(0x111E3410)

inline static constexpr unsigned int Class_1_BC7B4EFAA66ADEA5_TypeDefinitionIndex = 61122;

class Class_1_BC7B4EFAA66ADEA5 : public ::System::Object
{
public:
	::System::Func_1<::Class_1_43BD383C98B4C0C5_168*>* __ContextGetter_k__BackingField; // 0x10
	::Class_1_C4FD36003027AC99* __Query_k__BackingField; // 0x18

	::System::Void _ctor(::Class_1_C4FD36003027AC99* a1, ::System::Func_1<::Class_1_43BD383C98B4C0C5_168*>* a2)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_C4FD36003027AC99*, ::System::Func_1<::Class_1_43BD383C98B4C0C5_168*>*))((::PBYTE)hIl2Cpp + CLASS_1_BC7B4EFAA66ADEA5__CTOR_OFFSET))(this, a1, a2);
	}
	...
	::System::Func_1<::Class_1_43BD383C98B4C0C5_168*>* get__ContextGetter()
	{
		return ((::System::Func_1<::Class_1_43BD383C98B4C0C5_168*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_BC7B4EFAA66ADEA5_GET__CONTEXTGETTER_OFFSET))(this);
	}

	::Class_1_43BD383C98B4C0C5_168* Method_1_BA47C17B64C87B46()
	{
		return ((::Class_1_43BD383C98B4C0C5_168*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_BA47C17B64C87B46_OFFSET))(this);
	}
