...
#define CLASS_1_BC7B4EFAA66ADEA5_GET__CONTEXTGETTER_OFFSET UNITYSDK_OFFSET(0x153507A0)
#define CLASS_1_BC7B4EFAA66ADEA5_GET__QUERY_OFFSET UNITYSDK_OFFSET(0x15350790)
#define CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_0AF0F15474011B00_OFFSET UNITYSDK_OFFSET(0x15352460)
#define CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_14FE70C9B9646561_OFFSET UNITYSDK_OFFSET(0x15351450)
#define CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_1979474406148984_OFFSET UNITYSDK_OFFSET(0x153520A0)
#define CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_30E3FC6ED964E3BD_OFFSET UNITYSDK_OFFSET(0x15352A30)
#define CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_31966F1941496AC4_OFFSET UNITYSDK_OFFSET(0x153529C0)
#define CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_5A95A03CB271BFF5_OFFSET UNITYSDK_OFFSET(0x15352710)
#define CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_89248EBA05021FAD_OFFSET UNITYSDK_OFFSET(0x15353360)
#define CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_8BDA5F88CEF3C27D_OFFSET UNITYSDK_OFFSET(0x153513A0)
#define CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_9B39F7D7C1FF70D6_OFFSET UNITYSDK_OFFSET(0x153507B0)
#define CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_CAEE3D6B2E39B0EA_OFFSET UNITYSDK_OFFSET(0x15353160)
#define CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_CAFFBD84B1BAEF05_OFFSET UNITYSDK_OFFSET(0x15352600)
#define CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_D26921A5C6265C4A_OFFSET UNITYSDK_OFFSET(0x15352CC0)
#define CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_DE674D8545616C69_OFFSET UNITYSDK_OFFSET(0x15352C00)
#define CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_E7AB3C27DF42F5BE_OFFSET UNITYSDK_OFFSET(0x15350820)
#define CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_E9BF19228E3C8BBF_OFFSET UNITYSDK_OFFSET(0x15352370)
#define CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_F24F4B6D6EA62A5A_OFFSET UNITYSDK_OFFSET(0x153516B0)
#define CLASS_1_BC7B4EFAA66ADEA5_METHOD_1_FA66415B48D4FEBA_OFFSET UNITYSDK_OFFSET(0x15350D20)
#define CLASS_1_BC7B4EFAA66ADEA5__CTOR_OFFSET UNITYSDK_OFFSET(0x15350810)

inline static constexpr unsigned int Class_1_BC7B4EFAA66ADEA5_TypeDefinitionIndex = 72099;

class Class_1_BC7B4EFAA66ADEA5 : public ::System::Object
{
public:
	::System::Func_1<::Class_1_43BD383C98B4C0C5_186*>* __ContextGetter_k__BackingField; // 0x10
