...
#define CLASS_2_1C9C081C3F4294E9_DISPOSE_OFFSET UNITYSDK_OFFSET(0xFF394A0)
#define CLASS_2_1C9C081C3F4294E9_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0xFF3B640)
#define CLASS_2_1C9C081C3F4294E9_GET_HASINTERACTHANDLER_OFFSET UNITYSDK_OFFSET(0xFF3B680)
#define CLASS_2_1C9C081C3F4294E9_GET_INSTANCEID_OFFSET UNITYSDK_OFFSET(0xFF3B660)
#define CLASS_2_1C9C081C3F4294E9_METHOD_2_073FCA6069BBB0A7_OFFSET UNITYSDK_OFFSET(0xFF3B2D0)
#define CLASS_2_1C9C081C3F4294E9_METHOD_2_31B86CF031D1C6B2_OFFSET UNITYSDK_OFFSET(0xFF3A500)
#define CLASS_2_1C9C081C3F4294E9_METHOD_2_3B306F16BF78C1C7_OFFSET UNITYSDK_OFFSET(0xFF39E90)
#define CLASS_2_1C9C081C3F4294E9_METHOD_2_4D49EE67173872BB_OFFSET UNITYSDK_OFFSET(0xFF397D0)
#define CLASS_2_1C9C081C3F4294E9_METHOD_2_64F3965CE4C4DB47_OFFSET UNITYSDK_OFFSET(0xFF39880)
#define CLASS_2_1C9C081C3F4294E9_METHOD_2_78C62398E94F0FB1_OFFSET UNITYSDK_OFFSET(0xFF3A950)
#define CLASS_2_1C9C081C3F4294E9_METHOD_2_81A66FB988DFA6AA_OFFSET UNITYSDK_OFFSET(0xFF3A730)
#define CLASS_2_1C9C081C3F4294E9_METHOD_2_9765352E01408D38_OFFSET UNITYSDK_OFFSET(0xFF39EF0)
#define CLASS_2_1C9C081C3F4294E9_METHOD_2_983BE009C423EFE5_OFFSET UNITYSDK_OFFSET(0xFF39390)
#define CLASS_2_1C9C081C3F4294E9_METHOD_2_98744EBA2289900B_OFFSET UNITYSDK_OFFSET(0xFF3B5E0)
#define CLASS_2_1C9C081C3F4294E9_METHOD_2_9D3D178316624130_OFFSET UNITYSDK_OFFSET(0xFF3A140)
#define CLASS_2_1C9C081C3F4294E9_METHOD_2_A76A07E68FFF9CDC_OFFSET UNITYSDK_OFFSET(0xFF392E0)
#define CLASS_2_1C9C081C3F4294E9_METHOD_2_AFC8215C57A0845A_OFFSET UNITYSDK_OFFSET(0xFF39D00)
#define CLASS_2_1C9C081C3F4294E9_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xFF3A8D0)
#define CLASS_2_1C9C081C3F4294E9_METHOD_2_C5325FA2E0D39092_OFFSET UNITYSDK_OFFSET(0xFF39BC0)
#define CLASS_2_1C9C081C3F4294E9_METHOD_2_C8D6B29192F288ED_OFFSET UNITYSDK_OFFSET(0xFF38F60)
#define CLASS_2_1C9C081C3F4294E9_METHOD_2_D78B51BFDA4B8B32_OFFSET UNITYSDK_OFFSET(0xFF3AD10)
#define CLASS_2_1C9C081C3F4294E9_METHOD_2_E24C0FFD2F80EEBC_OFFSET UNITYSDK_OFFSET(0xFF39720)
#define CLASS_2_1C9C081C3F4294E9_METHOD_2_EA53757A85D2A947_OFFSET UNITYSDK_OFFSET(0xFF3A4B0)
#define CLASS_2_1C9C081C3F4294E9_METHOD_2_EAEB1D4D15F25F77_OFFSET UNITYSDK_OFFSET(0xFF3AEC0)
#define CLASS_2_1C9C081C3F4294E9_METHOD_2_F39B85D7AB2DF81D_OFFSET UNITYSDK_OFFSET(0xFF3B400)
#define CLASS_2_1C9C081C3F4294E9_METHOD_2_F7E2157D0CAF556A_OFFSET UNITYSDK_OFFSET(0xFF39610)
#define CLASS_2_1C9C081C3F4294E9_METHOD_2_F9992ED74E58A98D_OFFSET UNITYSDK_OFFSET(0xFF3AAB0)
#define CLASS_2_1C9C081C3F4294E9_SET_GROUPID_OFFSET UNITYSDK_OFFSET(0xFF3B650)
#define CLASS_2_1C9C081C3F4294E9_SET_HASINTERACTHANDLER_OFFSET UNITYSDK_OFFSET(0xFF3B690)
#define CLASS_2_1C9C081C3F4294E9_SET_INSTANCEID_OFFSET UNITYSDK_OFFSET(0xFF3B670)
#define CLASS_2_1C9C081C3F4294E9__CTOR_OFFSET UNITYSDK_OFFSET(0xFF3B6A0)
...
public:
	...
	::RPG::GameCore::PropComponent* Field_2_12; // 0x20
	::System::String* Field_2_7; // 0x28
	::RPG::Client::MapRotationInfo* Field_2_10; // 0x30
	::RPG::GameCore::ButtonListTrigger* Field_2_20; // 0x38
	::RPG::Client::MapPropDef* Field_2_15; // 0x40
	::Class_2_36C95D73718D07B1* Field_2_9; // 0x48
	::System::String* Field_2_25; // 0x50
	::System::String* Field_2_21; // 0x58
	::System::String* Field_2_5; // 0x60
	::Class_2_5AC0D8B32AD9BFBE* Field_2_11; // 0x68
	::System::String* Field_2_22; // 0x70
	::System::String* Field_2_8; // 0x78
	::RPG::GameCore::ColliderTriggerComponent* Field_2_13; // 0x80
	::System::String* Field_2_24; // 0x88
	::System::Collections::Generic::List_1<::System::String*>* Field_2_4; // 0x90
	::RPG::Client::MapDef* Field_2_14; // 0x98
	::System::String* Field_2_23; // 0xA0
	::System::Action_1<::Class_2_1C9C081C3F4294E9_MapRotationChargerState>* Field_2_0; // 0xA8
	::RPG::Client::TextID Field_2_18; // 0xB0
	::System::UInt32 _InstanceID_k__BackingField; // 0xC0
	::System::UInt32 _GroupID_k__BackingField; // 0xC4
	::System::UInt32 Field_2_16; // 0xC8
	::System::Boolean _HasInteractHandler_k__BackingField; // 0xCC
