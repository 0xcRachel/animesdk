...
#define CLASS_1_C47576BEFCFAD595__FOREACHAI_D__30_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x888B6E0)
#define CLASS_1_C47576BEFCFAD595__FOREACHAI_D__30_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_RPG_CLIENT_PARKOURGAME_PARKOURAICHARACTER__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x888B840)
#define CLASS_1_C47576BEFCFAD595__FOREACHAI_D__30_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_CLIENT_PARKOURGAME_PARKOURAICHARACTER__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x888B7D0)
#define CLASS_1_C47576BEFCFAD595__FOREACHAI_D__30_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x888B8C0)
#define CLASS_1_C47576BEFCFAD595__FOREACHAI_D__30_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x888B830)
#define CLASS_1_C47576BEFCFAD595__FOREACHAI_D__30_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x888B7E0)
#define CLASS_1_C47576BEFCFAD595__FOREACHAI_D__30_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x888B6D0)
#define CLASS_1_C47576BEFCFAD595__FOREACHAI_D__30__CTOR_OFFSET UNITYSDK_OFFSET(0x888B6B0)

inline static constexpr unsigned int Class_1_C47576BEFCFAD595__ForEachAI_d__30_TypeDefinitionIndex = 60882;
