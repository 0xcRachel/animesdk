...
#define CLASS_3_0A64B6FBBB74CA97_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1065F530)
#define CLASS_3_0A64B6FBBB74CA97__CTOR_OFFSET UNITYSDK_OFFSET(0x1065F2F0)
...
public:
	...
	::RPG::GameCore::StringHash Field_3_2; // 0x2C
