...
#define CLASS_3_3CE615BCAFA31A47_METHOD_3_287DEB15CF6F7BD8_OFFSET UNITYSDK_OFFSET(0xFE6CE80)
#define CLASS_3_3CE615BCAFA31A47_METHOD_3_F6EB917C5A67C7BA_OFFSET UNITYSDK_OFFSET(0xFE6CD60)
#define CLASS_3_3CE615BCAFA31A47__CCTOR_OFFSET UNITYSDK_OFFSET(0xFE6CDE0)
#define CLASS_3_3CE615BCAFA31A47__CTOR_OFFSET UNITYSDK_OFFSET(0xFE6CDB0)
#define CLASS_3_3CE615BCAFA31A47__ONBIND_OFFSET UNITYSDK_OFFSET(0xFE6CA40)
#define CLASS_3_3CE615BCAFA31A47___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0xFE6CE20)

inline static constexpr unsigned int Class_3_3CE615BCAFA31A47_TypeDefinitionIndex = 65897;
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_3_3CE615BCAFA31A47_TypeDefinitionIndex)->GetStaticField(0x55B90);
	}
