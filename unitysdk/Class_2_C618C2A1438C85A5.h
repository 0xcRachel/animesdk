...
#define CLASS_2_C618C2A1438C85A5_DISPOSE_OFFSET UNITYSDK_OFFSET(0xF2D5EF0)
#define CLASS_2_C618C2A1438C85A5_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xF2D5F30)
#define CLASS_2_C618C2A1438C85A5_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xF2D60B0)
#define CLASS_2_C618C2A1438C85A5_TICK_OFFSET UNITYSDK_OFFSET(0xF2D6100)
#define CLASS_2_C618C2A1438C85A5__CTOR_OFFSET UNITYSDK_OFFSET(0xF2D5E70)
...
public:
	...
	::RPG::GameCore::SetTargetCrossHairVisible* Field_2_0; // 0x20
