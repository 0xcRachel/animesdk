...
#define CLASS_2_C618C2A1438C85A5_DISPOSE_OFFSET UNITYSDK_OFFSET(0x154DA6F0)
#define CLASS_2_C618C2A1438C85A5_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x154DA730)
#define CLASS_2_C618C2A1438C85A5_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x154DA8D0)
#define CLASS_2_C618C2A1438C85A5_TICK_OFFSET UNITYSDK_OFFSET(0x154DA920)
#define CLASS_2_C618C2A1438C85A5__CTOR_OFFSET UNITYSDK_OFFSET(0x154DA670)
...
public:
	...
	::RPG::GameCore::SetTargetCrossHairVisible* Field_2_1; // 0x20
