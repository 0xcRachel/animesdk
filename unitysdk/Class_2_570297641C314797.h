...
#define CLASS_2_570297641C314797_TRANSFORM_OFFSET UNITYSDK_OFFSET(0xDE81A80)
#define CLASS_2_570297641C314797__CTOR_OFFSET UNITYSDK_OFFSET(0xDE81A60)
...
public:
	...
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_2_570297641C314797_TypeDefinitionIndex)->GetStaticField(0xC2D0);
	}
