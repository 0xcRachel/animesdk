...
#define EASINGFUNCTION_FUNCTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8011D60)
#define EASINGFUNCTION_FUNCTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8011E00)
#define EASINGFUNCTION_FUNCTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x80118A0)
#define EASINGFUNCTION_FUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x8010D30)

inline static constexpr unsigned int EasingFunction_Function_TypeDefinitionIndex = 34166;
