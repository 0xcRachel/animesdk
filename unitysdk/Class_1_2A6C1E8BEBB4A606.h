...
#define CLASS_1_2A6C1E8BEBB4A606_METHOD_1_47FCE72550F759BF_OFFSET UNITYSDK_OFFSET(0x15C33A70)
#define CLASS_1_2A6C1E8BEBB4A606_METHOD_1_AF5F4E2A5A0E1328_OFFSET UNITYSDK_OFFSET(0x15C33E00)
#define CLASS_1_2A6C1E8BEBB4A606__CTOR_OFFSET UNITYSDK_OFFSET(0x15C33B10)
...
public:
	...
	{
		return (::Class_1_2A6C1E8BEBB4A606**)Il2CppClass::FromTypeDefinitionIndex(Class_1_2A6C1E8BEBB4A606_TypeDefinitionIndex)->GetStaticField(0x1A0B0);
	}
