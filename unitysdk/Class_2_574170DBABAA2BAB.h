...
#define CLASS_2_574170DBABAA2BAB_GET_BOSSSELECTDATA_OFFSET UNITYSDK_OFFSET(0x104C72B0)
#define CLASS_2_574170DBABAA2BAB_GET_DECAYDATA_OFFSET UNITYSDK_OFFSET(0x104C72D0)
#define CLASS_2_574170DBABAA2BAB_METHOD_2_7D932F1022BCD845_OFFSET UNITYSDK_OFFSET(0x104C71E0)
#define CLASS_2_574170DBABAA2BAB_SET_BOSSSELECTDATA_OFFSET UNITYSDK_OFFSET(0x104C72C0)
#define CLASS_2_574170DBABAA2BAB_SET_DECAYDATA_OFFSET UNITYSDK_OFFSET(0x104C72E0)
#define CLASS_2_574170DBABAA2BAB__CTOR_OFFSET UNITYSDK_OFFSET(0x104C71D0)

inline static constexpr unsigned int Class_2_574170DBABAA2BAB_TypeDefinitionIndex = 53300;
