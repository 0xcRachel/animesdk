...
#define CLASS_1_5B567C8A01BAEDFE_254_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A1A4A90)
#define CLASS_1_5B567C8A01BAEDFE_254_CLONE_OFFSET UNITYSDK_OFFSET(0x1A1A4900)
#define CLASS_1_5B567C8A01BAEDFE_254_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A1A49A0)
#define CLASS_1_5B567C8A01BAEDFE_254_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A1A4940)
#define CLASS_1_5B567C8A01BAEDFE_254_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A1A49F0)
#define CLASS_1_5B567C8A01BAEDFE_254_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A1A4AE0)
#define CLASS_1_5B567C8A01BAEDFE_254_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A1A4AB0)
#define CLASS_1_5B567C8A01BAEDFE_254_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A1A4880)
#define CLASS_1_5B567C8A01BAEDFE_254_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A1A48B0)
#define CLASS_1_5B567C8A01BAEDFE_254_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A1A4A20)
#define CLASS_1_5B567C8A01BAEDFE_254_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A1A4A80)
#define CLASS_1_5B567C8A01BAEDFE_254__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1A4B30)
#define CLASS_1_5B567C8A01BAEDFE_254__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A1A48D0)
#define CLASS_1_5B567C8A01BAEDFE_254__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1A48C0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_254*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_254_TypeDefinitionIndex)->GetStaticField(0x89C0);
	}
