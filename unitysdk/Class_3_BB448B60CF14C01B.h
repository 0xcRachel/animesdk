...
#define CLASS_3_BB448B60CF14C01B_EVALUATE_OFFSET UNITYSDK_OFFSET(0x109945C0)
#define CLASS_3_BB448B60CF14C01B__CTOR_OFFSET UNITYSDK_OFFSET(0x10994590)

inline static constexpr unsigned int Class_3_BB448B60CF14C01B_TypeDefinitionIndex = 41556;
