...
#define CLASS_1_B6B5A6C41D7C342D_GET_CHARACTERNAME_OFFSET UNITYSDK_OFFSET(0xEF06230)
#define CLASS_1_B6B5A6C41D7C342D_METHOD_1_016BE8D6A97AF8B4_OFFSET UNITYSDK_OFFSET(0xEF06260)
#define CLASS_1_B6B5A6C41D7C342D_METHOD_1_01B0017134EADCC3_OFFSET UNITYSDK_OFFSET(0xEF07450)
#define CLASS_1_B6B5A6C41D7C342D_METHOD_1_11071ED565E96CE7_OFFSET UNITYSDK_OFFSET(0xEF064F0)
#define CLASS_1_B6B5A6C41D7C342D_METHOD_1_128774387667156B_1_OFFSET UNITYSDK_OFFSET(0xEF05BD0)
#define CLASS_1_B6B5A6C41D7C342D_METHOD_1_128774387667156B_2_OFFSET UNITYSDK_OFFSET(0xEF05BF0)
#define CLASS_1_B6B5A6C41D7C342D_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0xEF05BB0)
#define CLASS_1_B6B5A6C41D7C342D_METHOD_1_12B3B9ABE1081C79_OFFSET UNITYSDK_OFFSET(0xEF06570)
#define CLASS_1_B6B5A6C41D7C342D_METHOD_1_181A405363C9A19F_OFFSET UNITYSDK_OFFSET(0xEF06220)
#define CLASS_1_B6B5A6C41D7C342D_METHOD_1_2439C7815990B9DD_OFFSET UNITYSDK_OFFSET(0xEF05C10)
#define CLASS_1_B6B5A6C41D7C342D_METHOD_1_4679E7840A7526E1_OFFSET UNITYSDK_OFFSET(0xEF05C70)
#define CLASS_1_B6B5A6C41D7C342D_METHOD_1_5DF95F1F69FA3997_OFFSET UNITYSDK_OFFSET(0xEF076A0)
#define CLASS_1_B6B5A6C41D7C342D_METHOD_1_64EEE3FEF87A70D8_OFFSET UNITYSDK_OFFSET(0xEF06B10)
#define CLASS_1_B6B5A6C41D7C342D_METHOD_1_74AC27E26D00806E_OFFSET UNITYSDK_OFFSET(0xEF07A80)
#define CLASS_1_B6B5A6C41D7C342D_METHOD_1_7D809A18C24A8D5B_OFFSET UNITYSDK_OFFSET(0xEF07B60)
#define CLASS_1_B6B5A6C41D7C342D_METHOD_1_8CEAB4B365735B82_OFFSET UNITYSDK_OFFSET(0xEF05BA0)
#define CLASS_1_B6B5A6C41D7C342D_METHOD_1_A743210993038E07_OFFSET UNITYSDK_OFFSET(0xEF075F0)
#define CLASS_1_B6B5A6C41D7C342D_METHOD_1_AA2D3E889C8A52CA_OFFSET UNITYSDK_OFFSET(0xEF05B30)
#define CLASS_1_B6B5A6C41D7C342D_METHOD_1_AF2DF7DB76141392_OFFSET UNITYSDK_OFFSET(0xEF06C00)
#define CLASS_1_B6B5A6C41D7C342D_METHOD_1_BC62B9FB87FD6A48_OFFSET UNITYSDK_OFFSET(0xEF05B90)
#define CLASS_1_B6B5A6C41D7C342D_METHOD_1_D5386D9FEC9AEC59_OFFSET UNITYSDK_OFFSET(0xEF065D0)
#define CLASS_1_B6B5A6C41D7C342D_METHOD_1_E82B049A4C803AA5_OFFSET UNITYSDK_OFFSET(0xEF06200)
#define CLASS_1_B6B5A6C41D7C342D__CTOR_OFFSET UNITYSDK_OFFSET(0xEF07DB0)
...
public:
	...
	::RPG::Client::AvatarData* Field_1_9; // 0x18
	::Class_1_0E0403D2B5AD79E8* Field_1_6; // 0x20
	::RPG::GameCore::ILBattleAvatarConfigRow* Field_1_0; // 0x28
	::System::Collections::Generic::SortedDictionary_2<::RPG::GameCore::RtAbilityProperty, ::RPG::GameCore::FixPoint>* Field_1_7; // 0x30
	::System::Collections::Generic::List_1<::RPG::GameCore::ILBattleAvatarPromotionConfigRow*>* Field_1_8; // 0x38
	::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_444*>* Field_1_4; // 0x40
