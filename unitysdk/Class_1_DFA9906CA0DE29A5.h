...
#define CLASS_1_DFA9906CA0DE29A5__CCTOR_OFFSET UNITYSDK_OFFSET(0x165BF9D0)
#define CLASS_1_DFA9906CA0DE29A5__CTOR_OFFSET UNITYSDK_OFFSET(0x165BF8A0)
...
public:
	...
	{
		return (::MessagePack::IFormatterResolver**)Il2CppClass::FromTypeDefinitionIndex(Class_1_DFA9906CA0DE29A5_TypeDefinitionIndex)->GetStaticField(0x34060);
	}
