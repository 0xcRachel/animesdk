...
#define CLASS_1_5B567C8A01BAEDFE_185_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1B1B7D40)
#define CLASS_1_5B567C8A01BAEDFE_185_CLONE_OFFSET UNITYSDK_OFFSET(0x1B1B7B50)
#define CLASS_1_5B567C8A01BAEDFE_185_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1B1B7C50)
#define CLASS_1_5B567C8A01BAEDFE_185_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B1B7BC0)
#define CLASS_1_5B567C8A01BAEDFE_185_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B1B7CA0)
#define CLASS_1_5B567C8A01BAEDFE_185_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1B1B7D90)
#define CLASS_1_5B567C8A01BAEDFE_185_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1B1B7D60)
#define CLASS_1_5B567C8A01BAEDFE_185_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1B1B7AA0)
#define CLASS_1_5B567C8A01BAEDFE_185_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1B1B7B00)
#define CLASS_1_5B567C8A01BAEDFE_185_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B1B7CD0)
#define CLASS_1_5B567C8A01BAEDFE_185_WRITETO_OFFSET UNITYSDK_OFFSET(0x1B1B7D30)
#define CLASS_1_5B567C8A01BAEDFE_185__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B1B7DE0)
#define CLASS_1_5B567C8A01BAEDFE_185__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B1B7B20)
#define CLASS_1_5B567C8A01BAEDFE_185__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1B7B10)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_185*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_185_TypeDefinitionIndex)->GetStaticField(0x56CA0);
	}
