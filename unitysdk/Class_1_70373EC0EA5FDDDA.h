...
#define CLASS_1_70373EC0EA5FDDDA_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A0A1350)
#define CLASS_1_70373EC0EA5FDDDA_CLONE_OFFSET UNITYSDK_OFFSET(0x1A0A0EF0)
#define CLASS_1_70373EC0EA5FDDDA_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A0A1040)
#define CLASS_1_70373EC0EA5FDDDA_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A0A0F50)
#define CLASS_1_70373EC0EA5FDDDA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A0A1100)
#define CLASS_1_70373EC0EA5FDDDA_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A0A1570)
#define CLASS_1_70373EC0EA5FDDDA_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A0A14C0)
#define CLASS_1_70373EC0EA5FDDDA_METHOD_1_3163C288F3AE2966_OFFSET UNITYSDK_OFFSET(0x1A0A0F30)
#define CLASS_1_70373EC0EA5FDDDA_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A0A0DD0)
#define CLASS_1_70373EC0EA5FDDDA_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x1A0A0F40)
#define CLASS_1_70373EC0EA5FDDDA_METHOD_1_CE81D059476B1F49_OFFSET UNITYSDK_OFFSET(0x1A0A0F20)
#define CLASS_1_70373EC0EA5FDDDA_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A0A0E00)
#define CLASS_1_70373EC0EA5FDDDA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A0A1210)
#define CLASS_1_70373EC0EA5FDDDA_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A0A1270)
#define CLASS_1_70373EC0EA5FDDDA__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A0A1630)
#define CLASS_1_70373EC0EA5FDDDA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0A0E50)
#define CLASS_1_70373EC0EA5FDDDA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0A0E10)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_87B6445D24FE4E47*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_70373EC0EA5FDDDA_TypeDefinitionIndex)->GetStaticField(0x1E7C0);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_70373EC0EA5FDDDA*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_70373EC0EA5FDDDA*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_70373EC0EA5FDDDA_TypeDefinitionIndex)->GetStaticField(0x1E7C8);
	}
	// static const ::System::Int32 Field_1_2 = 0xF; // 0x0
	// static const ::System::Int32 Field_1_4 = 0xE; // 0x0
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_87B6445D24FE4E47*>* Field_1_6; // 0x10
