...
#define CLASS_1_7E1E05C17C895270_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A6EACA0)
#define CLASS_1_7E1E05C17C895270_CLONE_OFFSET UNITYSDK_OFFSET(0x1A6EA5C0)
#define CLASS_1_7E1E05C17C895270_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A6EA6E0)
#define CLASS_1_7E1E05C17C895270_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A6EA6B0)
#define CLASS_1_7E1E05C17C895270_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A6EA830)
#define CLASS_1_7E1E05C17C895270_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A6EB020)
#define CLASS_1_7E1E05C17C895270_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A6EAED0)
#define CLASS_1_7E1E05C17C895270_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x1A6EA630)
#define CLASS_1_7E1E05C17C895270_METHOD_1_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x1A6EA620)
#define CLASS_1_7E1E05C17C895270_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x1A6EA600)
#define CLASS_1_7E1E05C17C895270_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1A6EA6A0)
#define CLASS_1_7E1E05C17C895270_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A6EA3B0)
#define CLASS_1_7E1E05C17C895270_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x1A6EA5F0)
#define CLASS_1_7E1E05C17C895270_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x1A6EA610)
#define CLASS_1_7E1E05C17C895270_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1A6EA690)
#define CLASS_1_7E1E05C17C895270_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1A6EA680)
#define CLASS_1_7E1E05C17C895270_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A6EA3E0)
#define CLASS_1_7E1E05C17C895270_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A6EAAA0)
#define CLASS_1_7E1E05C17C895270_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A6EAB00)
#define CLASS_1_7E1E05C17C895270__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A6EB1D0)
#define CLASS_1_7E1E05C17C895270__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A6EA470)
#define CLASS_1_7E1E05C17C895270__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6EA3F0)
...
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_7E1E05C17C895270*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_7E1E05C17C895270*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_7E1E05C17C895270_TypeDefinitionIndex)->GetStaticField(0xC580);
	}
	static ::Google::Protobuf::FieldCodec_1<::Class_1_D17272E82AE804C2_749*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_D17272E82AE804C2_749*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_7E1E05C17C895270_TypeDefinitionIndex)->GetStaticField(0xC588);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_2()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_7E1E05C17C895270_TypeDefinitionIndex)->GetStaticField(0xC590);
	}
	...
	::Class_1_C9E417278351157F_4* Field_1_11; // 0x28
