...
#define CLASS_1_DD86BEE7FF755B17_1_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1B0FB690)
#define CLASS_1_DD86BEE7FF755B17_1_CLONE_OFFSET UNITYSDK_OFFSET(0x1B0FB260)
#define CLASS_1_DD86BEE7FF755B17_1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1B0FB3B0)
#define CLASS_1_DD86BEE7FF755B17_1_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B0FB2E0)
#define CLASS_1_DD86BEE7FF755B17_1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B0FB440)
#define CLASS_1_DD86BEE7FF755B17_1_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1B0FB860)
#define CLASS_1_DD86BEE7FF755B17_1_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1B0FB810)
#define CLASS_1_DD86BEE7FF755B17_1_METHOD_1_3163C288F3AE2966_OFFSET UNITYSDK_OFFSET(0x1B0FB2D0)
#define CLASS_1_DD86BEE7FF755B17_1_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1B0FB110)
#define CLASS_1_DD86BEE7FF755B17_1_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1B0FB2B0)
#define CLASS_1_DD86BEE7FF755B17_1_METHOD_1_CE81D059476B1F49_OFFSET UNITYSDK_OFFSET(0x1B0FB2C0)
#define CLASS_1_DD86BEE7FF755B17_1_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1B0FB170)
#define CLASS_1_DD86BEE7FF755B17_1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B0FB550)
#define CLASS_1_DD86BEE7FF755B17_1_WRITETO_OFFSET UNITYSDK_OFFSET(0x1B0FB5B0)
#define CLASS_1_DD86BEE7FF755B17_1__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B0FBAC0)
#define CLASS_1_DD86BEE7FF755B17_1__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B0FB1D0)
#define CLASS_1_DD86BEE7FF755B17_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0FB180)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_DD86BEE7FF755B17_1_TypeDefinitionIndex)->GetStaticField(0x2E8C0);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_DD86BEE7FF755B17_1*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_DD86BEE7FF755B17_1*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_DD86BEE7FF755B17_1_TypeDefinitionIndex)->GetStaticField(0x2E8C8);
	}
