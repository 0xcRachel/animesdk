...
#define UNITYENGINE_CONFIGURABLEJOINT_SET_YMOTION_OFFSET UNITYSDK_OFFSET(0x18289D50)

namespace UnityEngine
{
	inline static constexpr unsigned int ConfigurableJoint_TypeDefinitionIndex = 5123;
