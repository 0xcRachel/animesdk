...
#define UNITYENGINE_UI_SCROLLRECT_REBOUNDEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1834F090)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int ScrollRect_ReboundEvent_TypeDefinitionIndex = 5598;
