...
#define UNITYENGINE_CACHE_CACHE_GETPATH_OFFSET UNITYSDK_OFFSET(0x18A05AA0)
#define UNITYENGINE_CACHE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x29140)
#define UNITYENGINE_CACHE_EQUALS_OFFSET UNITYSDK_OFFSET(0x21179E0)
...
#define UNITYENGINE_CACHE_GET_PATH_OFFSET UNITYSDK_OFFSET(0x2117A40)
