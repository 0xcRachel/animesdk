...
#define UNITYENGINE_RENDERING_BATCHANIMATIONMESHVARIANT_PREPARERESOLVERES_OFFSET UNITYSDK_OFFSET(0x1B10CD40)
#define UNITYENGINE_RENDERING_BATCHANIMATIONMESHVARIANT_SETPARTMAT_OFFSET UNITYSDK_OFFSET(0x1B10CD60)
#define UNITYENGINE_RENDERING_BATCHANIMATIONMESHVARIANT_SETPARTMESH_OFFSET UNITYSDK_OFFSET(0x1B10CD50)
