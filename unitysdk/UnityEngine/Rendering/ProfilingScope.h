...
#define UNITYENGINE_RENDERING_PROFILINGSCOPE_BEGINPROFILE_1_OFFSET UNITYSDK_OFFSET(0x195C51C0)
#define UNITYENGINE_RENDERING_PROFILINGSCOPE_BEGINPROFILE_OFFSET UNITYSDK_OFFSET(0x195C51B0)
#define UNITYENGINE_RENDERING_PROFILINGSCOPE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x5F2300)
#define UNITYENGINE_RENDERING_PROFILINGSCOPE_ENDPROFILE_OFFSET UNITYSDK_OFFSET(0x195C51D0)
#define UNITYENGINE_RENDERING_PROFILINGSCOPE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x5F2300)
#define UNITYENGINE_RENDERING_PROFILINGSCOPE__CTOR_OFFSET UNITYSDK_OFFSET(0x5F2300)
