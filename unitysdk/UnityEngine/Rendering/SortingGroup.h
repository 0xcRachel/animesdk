...
#define UNITYENGINE_RENDERING_SORTINGGROUP_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x18A5B870)
#define UNITYENGINE_RENDERING_SORTINGGROUP_GET_INVALIDSORTINGGROUPID_OFFSET UNITYSDK_OFFSET(0x18A5B7D0)
#define UNITYENGINE_RENDERING_SORTINGGROUP_GET_SORTINGGROUPID_OFFSET UNITYSDK_OFFSET(0x18A5B850)
#define UNITYENGINE_RENDERING_SORTINGGROUP_GET_SORTINGGROUPORDER_OFFSET UNITYSDK_OFFSET(0x18A5B860)
#define UNITYENGINE_RENDERING_SORTINGGROUP_GET_SORTINGLAYERID_OFFSET UNITYSDK_OFFSET(0x18A5B810)
#define UNITYENGINE_RENDERING_SORTINGGROUP_GET_SORTINGLAYERNAME_OFFSET UNITYSDK_OFFSET(0x18A5B7F0)
#define UNITYENGINE_RENDERING_SORTINGGROUP_GET_SORTINGORDER_OFFSET UNITYSDK_OFFSET(0x18A5B830)
#define UNITYENGINE_RENDERING_SORTINGGROUP_SET_SORTINGLAYERID_OFFSET UNITYSDK_OFFSET(0x18A5B820)
#define UNITYENGINE_RENDERING_SORTINGGROUP_SET_SORTINGLAYERNAME_OFFSET UNITYSDK_OFFSET(0x18A5B800)
#define UNITYENGINE_RENDERING_SORTINGGROUP_SET_SORTINGORDER_OFFSET UNITYSDK_OFFSET(0x18A5B840)
#define UNITYENGINE_RENDERING_SORTINGGROUP_UPDATEALLSORTINGGROUPS_OFFSET UNITYSDK_OFFSET(0x18A5B7E0)
#define UNITYENGINE_RENDERING_SORTINGGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x18A5B880)
