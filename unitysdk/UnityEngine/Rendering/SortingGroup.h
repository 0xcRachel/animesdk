...
#define UNITYENGINE_RENDERING_SORTINGGROUP_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x18F1F220)
#define UNITYENGINE_RENDERING_SORTINGGROUP_GET_INVALIDSORTINGGROUPID_OFFSET UNITYSDK_OFFSET(0x18F1F180)
#define UNITYENGINE_RENDERING_SORTINGGROUP_GET_SORTINGGROUPID_OFFSET UNITYSDK_OFFSET(0x18F1F200)
#define UNITYENGINE_RENDERING_SORTINGGROUP_GET_SORTINGGROUPORDER_OFFSET UNITYSDK_OFFSET(0x18F1F210)
#define UNITYENGINE_RENDERING_SORTINGGROUP_GET_SORTINGLAYERID_OFFSET UNITYSDK_OFFSET(0x18F1F1C0)
#define UNITYENGINE_RENDERING_SORTINGGROUP_GET_SORTINGLAYERNAME_OFFSET UNITYSDK_OFFSET(0x18F1F1A0)
#define UNITYENGINE_RENDERING_SORTINGGROUP_GET_SORTINGORDER_OFFSET UNITYSDK_OFFSET(0x18F1F1E0)
#define UNITYENGINE_RENDERING_SORTINGGROUP_SET_SORTINGLAYERID_OFFSET UNITYSDK_OFFSET(0x18F1F1D0)
#define UNITYENGINE_RENDERING_SORTINGGROUP_SET_SORTINGLAYERNAME_OFFSET UNITYSDK_OFFSET(0x18F1F1B0)
#define UNITYENGINE_RENDERING_SORTINGGROUP_SET_SORTINGORDER_OFFSET UNITYSDK_OFFSET(0x18F1F1F0)
#define UNITYENGINE_RENDERING_SORTINGGROUP_UPDATEALLSORTINGGROUPS_OFFSET UNITYSDK_OFFSET(0x18F1F190)
#define UNITYENGINE_RENDERING_SORTINGGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x18F1F230)
