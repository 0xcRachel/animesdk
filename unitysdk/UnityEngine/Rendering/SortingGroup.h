...
#define UNITYENGINE_RENDERING_SORTINGGROUP_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x18233410)
#define UNITYENGINE_RENDERING_SORTINGGROUP_GET_INVALIDSORTINGGROUPID_OFFSET UNITYSDK_OFFSET(0x18233370)
#define UNITYENGINE_RENDERING_SORTINGGROUP_GET_SORTINGGROUPID_OFFSET UNITYSDK_OFFSET(0x182333F0)
#define UNITYENGINE_RENDERING_SORTINGGROUP_GET_SORTINGGROUPORDER_OFFSET UNITYSDK_OFFSET(0x18233400)
#define UNITYENGINE_RENDERING_SORTINGGROUP_GET_SORTINGLAYERID_OFFSET UNITYSDK_OFFSET(0x182333B0)
#define UNITYENGINE_RENDERING_SORTINGGROUP_GET_SORTINGLAYERNAME_OFFSET UNITYSDK_OFFSET(0x18233390)
#define UNITYENGINE_RENDERING_SORTINGGROUP_GET_SORTINGORDER_OFFSET UNITYSDK_OFFSET(0x182333D0)
#define UNITYENGINE_RENDERING_SORTINGGROUP_SET_SORTINGLAYERID_OFFSET UNITYSDK_OFFSET(0x182333C0)
#define UNITYENGINE_RENDERING_SORTINGGROUP_SET_SORTINGLAYERNAME_OFFSET UNITYSDK_OFFSET(0x182333A0)
#define UNITYENGINE_RENDERING_SORTINGGROUP_SET_SORTINGORDER_OFFSET UNITYSDK_OFFSET(0x182333E0)
#define UNITYENGINE_RENDERING_SORTINGGROUP_UPDATEALLSORTINGGROUPS_OFFSET UNITYSDK_OFFSET(0x18233380)
#define UNITYENGINE_RENDERING_SORTINGGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x18233420)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int SortingGroup_TypeDefinitionIndex = 4665;
