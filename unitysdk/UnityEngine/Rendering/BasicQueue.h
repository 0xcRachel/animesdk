...
#define UNITYENGINE_RENDERING_BASICQUEUE_HASDATA_OFFSET UNITYSDK_OFFSET(0x2BE80)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int BasicQueue_TypeDefinitionIndex = 27054;
