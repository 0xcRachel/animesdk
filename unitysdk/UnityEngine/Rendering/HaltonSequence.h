...
#define UNITYENGINE_RENDERING_HALTONSEQUENCE_GET_OFFSET UNITYSDK_OFFSET(0x180D1450)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int HaltonSequence_TypeDefinitionIndex = 27155;
