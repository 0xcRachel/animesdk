...
#define UNITYENGINE_RENDERING_NOINTERPVECTOR2PARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x180D1D70)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int NoInterpVector2Parameter_TypeDefinitionIndex = 27197;
