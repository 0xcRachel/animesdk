...
#define UNITYENGINE_RENDERING_GENERATEHLSL__CTOR_OFFSET UNITYSDK_OFFSET(0x180CF680)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int GenerateHLSL_TypeDefinitionIndex = 27125;

	class GenerateHLSL : public ::System::Attribute
	{
	public:
		::System::Boolean omitStructDeclaration; // 0x10
		::System::Boolean needAccessors; // 0x11
		...
		::System::Boolean needParamDebug; // 0x1E
