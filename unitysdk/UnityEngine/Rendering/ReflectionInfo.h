...
#define UNITYENGINE_RENDERING_REFLECTIONINFO_CLEARREFLECITONINFO_OFFSET UNITYSDK_OFFSET(0x1822FE50)
#define UNITYENGINE_RENDERING_REFLECTIONINFO_SETREFLECITONINFO_OFFSET UNITYSDK_OFFSET(0x1822FE60)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int ReflectionInfo_TypeDefinitionIndex = 4582;
