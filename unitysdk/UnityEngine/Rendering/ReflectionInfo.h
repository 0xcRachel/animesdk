...
#define UNITYENGINE_RENDERING_REFLECTIONINFO_CLEARREFLECITONINFO_OFFSET UNITYSDK_OFFSET(0x18A58390)
#define UNITYENGINE_RENDERING_REFLECTIONINFO_SETREFLECITONINFO_OFFSET UNITYSDK_OFFSET(0x18A583A0)
