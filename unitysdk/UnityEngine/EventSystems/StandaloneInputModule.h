...
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_ACTIVATEMODULE_OFFSET UNITYSDK_OFFSET(0x1823A170)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_DEACTIVATEMODULE_OFFSET UNITYSDK_OFFSET(0x1823A250)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_FORCEAUTOSELECT_OFFSET UNITYSDK_OFFSET(0x1823BD80)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_GETCURRENTFOCUSEDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1823C250)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_GETRAWMOVEVECTOR_OFFSET UNITYSDK_OFFSET(0x1823B770)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_GET_ALLOWACTIVATIONONMOBILEDEVICE_OFFSET UNITYSDK_OFFSET(0x18239900)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_GET_CANCELBUTTON_OFFSET UNITYSDK_OFFSET(0x182399E0)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_GET_FORCEMODULEACTIVE_OFFSET UNITYSDK_OFFSET(0x18239920)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_GET_HORIZONTALAXIS_OFFSET UNITYSDK_OFFSET(0x18239980)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_GET_INPUTACTIONSPERSECOND_OFFSET UNITYSDK_OFFSET(0x18239940)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_GET_INPUTMODE_OFFSET UNITYSDK_OFFSET(0x182398F0)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_GET_REPEATDELAY_OFFSET UNITYSDK_OFFSET(0x18239960)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_GET_SUBMITBUTTON_OFFSET UNITYSDK_OFFSET(0x182399C0)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_GET_VERTICALAXIS_OFFSET UNITYSDK_OFFSET(0x182399A0)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_ISMODULESUPPORTED_OFFSET UNITYSDK_OFFSET(0x18239E80)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_PROCESSMOUSEEVENT_1_OFFSET UNITYSDK_OFFSET(0x1823B8A0)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_PROCESSMOUSEEVENT_OFFSET UNITYSDK_OFFSET(0x1823A600)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_PROCESSMOUSEPRESS_OFFSET UNITYSDK_OFFSET(0x1823BD90)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_PROCESSTOUCHEVENTS_OFFSET UNITYSDK_OFFSET(0x1823A430)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_PROCESSTOUCHPRESS_OFFSET UNITYSDK_OFFSET(0x1823AAD0)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_PROCESS_OFFSET UNITYSDK_OFFSET(0x1823A260)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_RELEASEMOUSE_OFFSET UNITYSDK_OFFSET(0x18239AD0)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_SENDMOVEEVENTTOSELECTEDOBJECT_OFFSET UNITYSDK_OFFSET(0x1823A610)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_SENDSUBMITEVENTTOSELECTEDOBJECT_OFFSET UNITYSDK_OFFSET(0x1823A900)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_SENDUPDATEEVENTTOSELECTEDOBJECT_OFFSET UNITYSDK_OFFSET(0x1823A310)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_SET_ALLOWACTIVATIONONMOBILEDEVICE_OFFSET UNITYSDK_OFFSET(0x18239910)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_SET_CANCELBUTTON_OFFSET UNITYSDK_OFFSET(0x182399F0)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_SET_FORCEMODULEACTIVE_OFFSET UNITYSDK_OFFSET(0x18239930)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_SET_HORIZONTALAXIS_OFFSET UNITYSDK_OFFSET(0x18239990)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_SET_INPUTACTIONSPERSECOND_OFFSET UNITYSDK_OFFSET(0x18239950)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_SET_REPEATDELAY_OFFSET UNITYSDK_OFFSET(0x18239970)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_SET_SUBMITBUTTON_OFFSET UNITYSDK_OFFSET(0x182399D0)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_SET_VERTICALAXIS_OFFSET UNITYSDK_OFFSET(0x182399B0)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_SHOULDACTIVATEMODULE_OFFSET UNITYSDK_OFFSET(0x18239EF0)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_SHOULDIGNOREEVENTSONNOFOCUS_OFFSET UNITYSDK_OFFSET(0x18239A00)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE_UPDATEMODULE_OFFSET UNITYSDK_OFFSET(0x18239A20)
#define UNITYENGINE_EVENTSYSTEMS_STANDALONEINPUTMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x18239780)
