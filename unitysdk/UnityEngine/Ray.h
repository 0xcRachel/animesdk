...
#define UNITYENGINE_RAY_GETPOINT_OFFSET UNITYSDK_OFFSET(0x201C5B0)
#define UNITYENGINE_RAY_GET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x24650)
#define UNITYENGINE_RAY_GET_ORIGIN_OFFSET UNITYSDK_OFFSET(0x24630)
#define UNITYENGINE_RAY_SET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x2045AB0)
#define UNITYENGINE_RAY_SET_ORIGIN_OFFSET UNITYSDK_OFFSET(0x72E10)
#define UNITYENGINE_RAY_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x2045B50)
#define UNITYENGINE_RAY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x2045B40)
#define UNITYENGINE_RAY__CTOR_OFFSET UNITYSDK_OFFSET(0x2045A10)

namespace UnityEngine
{
	inline static constexpr unsigned int Ray_TypeDefinitionIndex = 3880;
