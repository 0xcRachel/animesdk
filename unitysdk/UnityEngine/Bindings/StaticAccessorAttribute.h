...
#define UNITYENGINE_BINDINGS_STATICACCESSORATTRIBUTE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x182A32B0)
#define UNITYENGINE_BINDINGS_STATICACCESSORATTRIBUTE_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x182A32C0)
#define UNITYENGINE_BINDINGS_STATICACCESSORATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x182A32E0)
#define UNITYENGINE_BINDINGS_STATICACCESSORATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x182A32D0)

namespace UnityEngine::Bindings
{
	inline static constexpr unsigned int StaticAccessorAttribute_TypeDefinitionIndex = 3704;
