...
#define UNITYENGINE_MESHCOLLIDEREX_GET_MULTILAYERMASK_OFFSET UNITYSDK_OFFSET(0x18289E90)

namespace UnityEngine
{
	inline static constexpr unsigned int MeshColliderEx_TypeDefinitionIndex = 5118;
