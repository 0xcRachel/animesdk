...
#define UNITYENGINE_ANIMATORUTILITY_OPTIMIZETRANSFORMHIERARCHY_OFFSET UNITYSDK_OFFSET(0x181C6470)

namespace UnityEngine
{
	inline static constexpr unsigned int AnimatorUtility_TypeDefinitionIndex = 4940;
