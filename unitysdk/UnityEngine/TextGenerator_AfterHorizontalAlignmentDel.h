...
#define UNITYENGINE_TEXTGENERATOR_AFTERHORIZONTALALIGNMENTDEL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x182B34B0)
#define UNITYENGINE_TEXTGENERATOR_AFTERHORIZONTALALIGNMENTDEL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x182B3520)
#define UNITYENGINE_TEXTGENERATOR_AFTERHORIZONTALALIGNMENTDEL_INVOKE_OFFSET UNITYSDK_OFFSET(0x182B22B0)
#define UNITYENGINE_TEXTGENERATOR_AFTERHORIZONTALALIGNMENTDEL__CTOR_OFFSET UNITYSDK_OFFSET(0x182AEC40)

namespace UnityEngine
{
	inline static constexpr unsigned int TextGenerator_AfterHorizontalAlignmentDel_TypeDefinitionIndex = 4836;
