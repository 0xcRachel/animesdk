...
#define UNITYENGINE_MATHF_ABS_1_OFFSET UNITYSDK_OFFSET(0x18A2CD20)
#define UNITYENGINE_MATHF_ABS_OFFSET UNITYSDK_OFFSET(0x18A2CD10)
#define UNITYENGINE_MATHF_ACOS_OFFSET UNITYSDK_OFFSET(0x18A2CC90)
#define UNITYENGINE_MATHF_APPROXIMATELY_OFFSET UNITYSDK_OFFSET(0x18A2DA50)
#define UNITYENGINE_MATHF_ASIN_OFFSET UNITYSDK_OFFSET(0x18A2CC70)
#define UNITYENGINE_MATHF_ATAN2_OFFSET UNITYSDK_OFFSET(0x18A2CCD0)
#define UNITYENGINE_MATHF_ATAN_OFFSET UNITYSDK_OFFSET(0x18A2CCB0)
#define UNITYENGINE_MATHF_CEILTOINT_OFFSET UNITYSDK_OFFSET(0x18A2D540)
#define UNITYENGINE_MATHF_CEIL_OFFSET UNITYSDK_OFFSET(0x18A2D470)
#define UNITYENGINE_MATHF_CLAMP01_OFFSET UNITYSDK_OFFSET(0x18A2D680)
#define UNITYENGINE_MATHF_CLAMP_1_OFFSET UNITYSDK_OFFSET(0x18A2D670)
#define UNITYENGINE_MATHF_CLAMP_OFFSET UNITYSDK_OFFSET(0x18A2D650)
#define UNITYENGINE_MATHF_CLOSESTPOWEROFTWO_OFFSET UNITYSDK_OFFSET(0x18A2CB50)
#define UNITYENGINE_MATHF_CORRELATEDCOLORTEMPERATURETORGB_INJECTED_OFFSET UNITYSDK_OFFSET(0x18A2CBD0)
#define UNITYENGINE_MATHF_CORRELATEDCOLORTEMPERATURETORGB_OFFSET UNITYSDK_OFFSET(0x18A2CBA0)
#define UNITYENGINE_MATHF_COS_OFFSET UNITYSDK_OFFSET(0x18A2CC30)
#define UNITYENGINE_MATHF_DELTAANGLE_OFFSET UNITYSDK_OFFSET(0x18A2D930)
#define UNITYENGINE_MATHF_EXP_OFFSET UNITYSDK_OFFSET(0x18A2D360)
#define UNITYENGINE_MATHF_FLOATTOHALF_OFFSET UNITYSDK_OFFSET(0x18A2CBE0)
#define UNITYENGINE_MATHF_FLOORTOINT_OFFSET UNITYSDK_OFFSET(0x18A2D560)
#define UNITYENGINE_MATHF_FLOOR_OFFSET UNITYSDK_OFFSET(0x18A2D480)
#define UNITYENGINE_MATHF_GAMMATOLINEARSPACE_OFFSET UNITYSDK_OFFSET(0x18A2CB80)
#define UNITYENGINE_MATHF_GAMMA_OFFSET UNITYSDK_OFFSET(0x18A2D9F0)
#define UNITYENGINE_MATHF_HALFTOFLOAT_OFFSET UNITYSDK_OFFSET(0x18A2CBF0)
#define UNITYENGINE_MATHF_INVERSELERP_OFFSET UNITYSDK_OFFSET(0x18A2E380)
#define UNITYENGINE_MATHF_ISPOWEROFTWO_OFFSET UNITYSDK_OFFSET(0x18A2CB60)
#define UNITYENGINE_MATHF_LERPANGLE_OFFSET UNITYSDK_OFFSET(0x18A2D6E0)
#define UNITYENGINE_MATHF_LERPUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x18A2D6D0)
#define UNITYENGINE_MATHF_LERP_OFFSET UNITYSDK_OFFSET(0x18A2D6A0)
#define UNITYENGINE_MATHF_LINEARTOGAMMASPACE_OFFSET UNITYSDK_OFFSET(0x18A2CB90)
#define UNITYENGINE_MATHF_LINEINTERSECTION_OFFSET UNITYSDK_OFFSET(0x18A2E3C0)
#define UNITYENGINE_MATHF_LINESEGMENTINTERSECTION_OFFSET UNITYSDK_OFFSET(0x18A2E4B0)
#define UNITYENGINE_MATHF_LOG10_OFFSET UNITYSDK_OFFSET(0x18A2D450)
#define UNITYENGINE_MATHF_LOG_1_OFFSET UNITYSDK_OFFSET(0x18A2D430)
#define UNITYENGINE_MATHF_LOG_OFFSET UNITYSDK_OFFSET(0x18A2D380)
#define UNITYENGINE_MATHF_MAX_1_OFFSET UNITYSDK_OFFSET(0x18A2D040)
#define UNITYENGINE_MATHF_MAX_2_OFFSET UNITYSDK_OFFSET(0x18A2D050)
#define UNITYENGINE_MATHF_MAX_3_OFFSET UNITYSDK_OFFSET(0x18A2D060)
#define UNITYENGINE_MATHF_MAX_4_OFFSET UNITYSDK_OFFSET(0x18A2D130)
#define UNITYENGINE_MATHF_MAX_5_OFFSET UNITYSDK_OFFSET(0x18A2D140)
#define UNITYENGINE_MATHF_MAX_6_OFFSET UNITYSDK_OFFSET(0x18A2D150)
#define UNITYENGINE_MATHF_MAX_7_OFFSET UNITYSDK_OFFSET(0x18A2D170)
#define UNITYENGINE_MATHF_MAX_OFFSET UNITYSDK_OFFSET(0x18A2D030)
#define UNITYENGINE_MATHF_MIN_1_OFFSET UNITYSDK_OFFSET(0x18A2CD40)
#define UNITYENGINE_MATHF_MIN_2_OFFSET UNITYSDK_OFFSET(0x18A2CD50)
#define UNITYENGINE_MATHF_MIN_3_OFFSET UNITYSDK_OFFSET(0x18A2CD60)
#define UNITYENGINE_MATHF_MIN_4_OFFSET UNITYSDK_OFFSET(0x18A21870)
#define UNITYENGINE_MATHF_MIN_5_OFFSET UNITYSDK_OFFSET(0x18A2CE30)
#define UNITYENGINE_MATHF_MIN_6_OFFSET UNITYSDK_OFFSET(0x18A2CE40)
#define UNITYENGINE_MATHF_MIN_7_OFFSET UNITYSDK_OFFSET(0x18A2CE60)
#define UNITYENGINE_MATHF_MIN_OFFSET UNITYSDK_OFFSET(0x18A2CD30)
#define UNITYENGINE_MATHF_MOVETOWARDSANGLE_OFFSET UNITYSDK_OFFSET(0x18A2D830)
#define UNITYENGINE_MATHF_MOVETOWARDS_OFFSET UNITYSDK_OFFSET(0x18A2D7E0)
#define UNITYENGINE_MATHF_NEXTPOWEROFTWO_OFFSET UNITYSDK_OFFSET(0x18A2CB70)
#define UNITYENGINE_MATHF_PERLINNOISE_OFFSET UNITYSDK_OFFSET(0x18A2CC00)
#define UNITYENGINE_MATHF_PINGPONG_OFFSET UNITYSDK_OFFSET(0x18A2E310)
#define UNITYENGINE_MATHF_POW_OFFSET UNITYSDK_OFFSET(0x18A2D340)
#define UNITYENGINE_MATHF_RANDOMTOLONG_OFFSET UNITYSDK_OFFSET(0x18A2E5C0)
#define UNITYENGINE_MATHF_REPEAT_OFFSET UNITYSDK_OFFSET(0x18A2D790)
#define UNITYENGINE_MATHF_ROUNDTOINT_OFFSET UNITYSDK_OFFSET(0x18A2D580)
#define UNITYENGINE_MATHF_ROUND_OFFSET UNITYSDK_OFFSET(0x18A2D490)
#define UNITYENGINE_MATHF_SIGN_OFFSET UNITYSDK_OFFSET(0x18A2D630)
#define UNITYENGINE_MATHF_SIN_OFFSET UNITYSDK_OFFSET(0x18A2CC10)
#define UNITYENGINE_MATHF_SMOOTHDAMPANGLE_1_OFFSET UNITYSDK_OFFSET(0x18A2E170)
#define UNITYENGINE_MATHF_SMOOTHDAMPANGLE_2_OFFSET UNITYSDK_OFFSET(0x18A2DFC0)
#define UNITYENGINE_MATHF_SMOOTHDAMPANGLE_OFFSET UNITYSDK_OFFSET(0x18A2DE10)
#define UNITYENGINE_MATHF_SMOOTHDAMP_1_OFFSET UNITYSDK_OFFSET(0x18A2DCE0)
#define UNITYENGINE_MATHF_SMOOTHDAMP_2_OFFSET UNITYSDK_OFFSET(0x18A2DBC0)
#define UNITYENGINE_MATHF_SMOOTHDAMP_OFFSET UNITYSDK_OFFSET(0x18A2DA90)
#define UNITYENGINE_MATHF_SMOOTHSTEP_OFFSET UNITYSDK_OFFSET(0x18A2D9A0)
#define UNITYENGINE_MATHF_SQRT_OFFSET UNITYSDK_OFFSET(0x18A2CCF0)
#define UNITYENGINE_MATHF_TAN_OFFSET UNITYSDK_OFFSET(0x18A2CC50)
#define UNITYENGINE_MATHF__CCTOR_OFFSET UNITYSDK_OFFSET(0x18A2E650)
...
namespace UnityEngine
{
	...
	struct alignas(1) Mathf
	{
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Mathf_TypeDefinitionIndex)->GetStaticField(0x44F0);
		}
