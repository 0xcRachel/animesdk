...
#define UNITYENGINE_TEXTFORMATSTATEHANDLE_GETFORMATSTATE_INJECTED_OFFSET UNITYSDK_OFFSET(0x182AE530)
#define UNITYENGINE_TEXTFORMATSTATEHANDLE_GETFORMATSTATE_OFFSET UNITYSDK_OFFSET(0x182AE490)
#define UNITYENGINE_TEXTFORMATSTATEHANDLE_SETFORMATSTATE_OFFSET UNITYSDK_OFFSET(0x182AE540)
#define UNITYENGINE_TEXTFORMATSTATEHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x182AE550)

namespace UnityEngine
{
	inline static constexpr unsigned int TextFormatStateHandle_TypeDefinitionIndex = 4850;
