...
#define UNITYENGINE_PROFILING_EXPERIMENTAL_DEBUGSCREENCAPTURE_SET_RAWIMAGEDATAREFERENCE_OFFSET UNITYSDK_OFFSET(0x14A6D00)
...
{
	inline static constexpr unsigned int DebugScreenCapture_TypeDefinitionIndex = 4303;
