...
#define UNITYENGINE_GCFREECLOSURE_SVALUE_WRITERINIT___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x181F69D0)
#define UNITYENGINE_GCFREECLOSURE_SVALUE_WRITERINIT___C__CTOR_OFFSET UNITYSDK_OFFSET(0x181F6A00)
#define UNITYENGINE_GCFREECLOSURE_SVALUE_WRITERINIT___C___CCTOR_B__0_0_OFFSET UNITYSDK_OFFSET(0x181F6A10)
#define UNITYENGINE_GCFREECLOSURE_SVALUE_WRITERINIT___C___CCTOR_B__0_10_OFFSET UNITYSDK_OFFSET(0x181F6D10)
#define UNITYENGINE_GCFREECLOSURE_SVALUE_WRITERINIT___C___CCTOR_B__0_11_OFFSET UNITYSDK_OFFSET(0x181F6D50)
#define UNITYENGINE_GCFREECLOSURE_SVALUE_WRITERINIT___C___CCTOR_B__0_12_OFFSET UNITYSDK_OFFSET(0x181F6DA0)
#define UNITYENGINE_GCFREECLOSURE_SVALUE_WRITERINIT___C___CCTOR_B__0_13_OFFSET UNITYSDK_OFFSET(0x181F6DF0)
#define UNITYENGINE_GCFREECLOSURE_SVALUE_WRITERINIT___C___CCTOR_B__0_1_OFFSET UNITYSDK_OFFSET(0x181F6A60)
#define UNITYENGINE_GCFREECLOSURE_SVALUE_WRITERINIT___C___CCTOR_B__0_2_OFFSET UNITYSDK_OFFSET(0x181F6AB0)
#define UNITYENGINE_GCFREECLOSURE_SVALUE_WRITERINIT___C___CCTOR_B__0_3_OFFSET UNITYSDK_OFFSET(0x181F6B00)
#define UNITYENGINE_GCFREECLOSURE_SVALUE_WRITERINIT___C___CCTOR_B__0_4_OFFSET UNITYSDK_OFFSET(0x181F6B50)
#define UNITYENGINE_GCFREECLOSURE_SVALUE_WRITERINIT___C___CCTOR_B__0_5_OFFSET UNITYSDK_OFFSET(0x181F6BA0)
#define UNITYENGINE_GCFREECLOSURE_SVALUE_WRITERINIT___C___CCTOR_B__0_6_OFFSET UNITYSDK_OFFSET(0x181F6BF0)
#define UNITYENGINE_GCFREECLOSURE_SVALUE_WRITERINIT___C___CCTOR_B__0_7_OFFSET UNITYSDK_OFFSET(0x181F6C40)
#define UNITYENGINE_GCFREECLOSURE_SVALUE_WRITERINIT___C___CCTOR_B__0_8_OFFSET UNITYSDK_OFFSET(0x181F6C90)
#define UNITYENGINE_GCFREECLOSURE_SVALUE_WRITERINIT___C___CCTOR_B__0_9_OFFSET UNITYSDK_OFFSET(0x181F6CD0)

namespace UnityEngine::GCFreeClosure
{
	inline static constexpr unsigned int SValue_WriterInit___c_TypeDefinitionIndex = 4255;
	...
	public:
		...
		{
			return (::UnityEngine::GCFreeClosure::SValue_WriterInit___c**)Il2CppClass::FromTypeDefinitionIndex(SValue_WriterInit___c_TypeDefinitionIndex)->GetStaticField(0x1AD60);
		}
