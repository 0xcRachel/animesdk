...
#define UNITYENGINE_GCFREECLOSURE_SVALUE_WRITERINIT___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x18A1F260)
#define UNITYENGINE_GCFREECLOSURE_SVALUE_WRITERINIT___C__CTOR_OFFSET UNITYSDK_OFFSET(0x18A1F290)
#define UNITYENGINE_GCFREECLOSURE_SVALUE_WRITERINIT___C___CCTOR_B__0_0_OFFSET UNITYSDK_OFFSET(0x18A1F2A0)
#define UNITYENGINE_GCFREECLOSURE_SVALUE_WRITERINIT___C___CCTOR_B__0_10_OFFSET UNITYSDK_OFFSET(0x18A1F5A0)
#define UNITYENGINE_GCFREECLOSURE_SVALUE_WRITERINIT___C___CCTOR_B__0_11_OFFSET UNITYSDK_OFFSET(0x18A1F5E0)
#define UNITYENGINE_GCFREECLOSURE_SVALUE_WRITERINIT___C___CCTOR_B__0_12_OFFSET UNITYSDK_OFFSET(0x18A1F630)
#define UNITYENGINE_GCFREECLOSURE_SVALUE_WRITERINIT___C___CCTOR_B__0_13_OFFSET UNITYSDK_OFFSET(0x18A1F680)
#define UNITYENGINE_GCFREECLOSURE_SVALUE_WRITERINIT___C___CCTOR_B__0_1_OFFSET UNITYSDK_OFFSET(0x18A1F2F0)
#define UNITYENGINE_GCFREECLOSURE_SVALUE_WRITERINIT___C___CCTOR_B__0_2_OFFSET UNITYSDK_OFFSET(0x18A1F340)
#define UNITYENGINE_GCFREECLOSURE_SVALUE_WRITERINIT___C___CCTOR_B__0_3_OFFSET UNITYSDK_OFFSET(0x18A1F390)
#define UNITYENGINE_GCFREECLOSURE_SVALUE_WRITERINIT___C___CCTOR_B__0_4_OFFSET UNITYSDK_OFFSET(0x18A1F3E0)
#define UNITYENGINE_GCFREECLOSURE_SVALUE_WRITERINIT___C___CCTOR_B__0_5_OFFSET UNITYSDK_OFFSET(0x18A1F430)
#define UNITYENGINE_GCFREECLOSURE_SVALUE_WRITERINIT___C___CCTOR_B__0_6_OFFSET UNITYSDK_OFFSET(0x18A1F480)
#define UNITYENGINE_GCFREECLOSURE_SVALUE_WRITERINIT___C___CCTOR_B__0_7_OFFSET UNITYSDK_OFFSET(0x18A1F4D0)
#define UNITYENGINE_GCFREECLOSURE_SVALUE_WRITERINIT___C___CCTOR_B__0_8_OFFSET UNITYSDK_OFFSET(0x18A1F520)
#define UNITYENGINE_GCFREECLOSURE_SVALUE_WRITERINIT___C___CCTOR_B__0_9_OFFSET UNITYSDK_OFFSET(0x18A1F560)

namespace UnityEngine::GCFreeClosure
{
	inline static constexpr unsigned int SValue_WriterInit___c_TypeDefinitionIndex = 4277;
	...
	public:
		...
		{
			return (::UnityEngine::GCFreeClosure::SValue_WriterInit___c**)Il2CppClass::FromTypeDefinitionIndex(SValue_WriterInit___c_TypeDefinitionIndex)->GetStaticField(0x35440);
		}
