...
#define UNITYENGINE_NVIDIA_OPTIMALDLSSSETTINGSDATA_GET_MAXWIDTH_OFFSET UNITYSDK_OFFSET(0xCAE40)
...
#define UNITYENGINE_NVIDIA_OPTIMALDLSSSETTINGSDATA_GET_OUTRENDERHEIGHT_OFFSET UNITYSDK_OFFSET(0x1DAE0)
...
{
	inline static constexpr unsigned int OptimalDLSSSettingsData_TypeDefinitionIndex = 5068;
