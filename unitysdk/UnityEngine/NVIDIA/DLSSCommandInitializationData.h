...
#define UNITYENGINE_NVIDIA_DLSSCOMMANDINITIALIZATIONDATA_GET_OUTPUTRTHEIGHT_OFFSET UNITYSDK_OFFSET(0xCAE40)
...
#define UNITYENGINE_NVIDIA_DLSSCOMMANDINITIALIZATIONDATA_SETFLAG_OFFSET UNITYSDK_OFFSET(0x204F760)
...
#define UNITYENGINE_NVIDIA_DLSSCOMMANDINITIALIZATIONDATA_SET_INPUTRTWIDTH_OFFSET UNITYSDK_OFFSET(0x29250)
#define UNITYENGINE_NVIDIA_DLSSCOMMANDINITIALIZATIONDATA_SET_OUTPUTRTHEIGHT_OFFSET UNITYSDK_OFFSET(0x2036AF0)
...
{
	inline static constexpr unsigned int DLSSCommandInitializationData_TypeDefinitionIndex = 5064;
