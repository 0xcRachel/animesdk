...
#define UNITYENGINE_PROBUILDER_SHAPES_TORUS_COPYSHAPE_OFFSET UNITYSDK_OFFSET(0x15C6AA90)
#define UNITYENGINE_PROBUILDER_SHAPES_TORUS_GETCIRCLEPOINTS_1_OFFSET UNITYSDK_OFFSET(0x15C6BE20)
#define UNITYENGINE_PROBUILDER_SHAPES_TORUS_GETCIRCLEPOINTS_OFFSET UNITYSDK_OFFSET(0x15C6B830)
#define UNITYENGINE_PROBUILDER_SHAPES_TORUS_REBUILDMESH_OFFSET UNITYSDK_OFFSET(0x15C6ABB0)
#define UNITYENGINE_PROBUILDER_SHAPES_TORUS_UPDATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x15C6AB20)
#define UNITYENGINE_PROBUILDER_SHAPES_TORUS__CTOR_OFFSET UNITYSDK_OFFSET(0x15C6C350)
...
namespace UnityEngine::ProBuilder::Shapes
{
	...
	{
	public:
		::System::Single m_HorizontalCircumference; // 0x10
		::System::Int32 m_Rows; // 0x14
		::System::Int32 m_Columns; // 0x18
		::System::Single m_TubeRadius; // 0x1C
		::System::Single m_VerticalCircumference; // 0x20
