...
#define UNITYENGINE_PROBUILDER_SHAPES_SPRITE_COPYSHAPE_OFFSET UNITYSDK_OFFSET(0x188B5BB0)
#define UNITYENGINE_PROBUILDER_SHAPES_SPRITE_REBUILDMESH_OFFSET UNITYSDK_OFFSET(0x188B5BC0)
#define UNITYENGINE_PROBUILDER_SHAPES_SPRITE__CTOR_OFFSET UNITYSDK_OFFSET(0x188B5F20)
