...
#define UNITYENGINE_PROBUILDER_POLY2TRI_POINTONEDGEEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x17F9F140)

namespace UnityEngine::ProBuilder::Poly2Tri
{
	inline static constexpr unsigned int PointOnEdgeException_TypeDefinitionIndex = 28914;
