...
#define UNITYENGINE_PROBUILDER_POLY2TRI_DTSWEEPBASIN__CTOR_OFFSET UNITYSDK_OFFSET(0x17FA1520)

namespace UnityEngine::ProBuilder::Poly2Tri
{
	inline static constexpr unsigned int DTSweepBasin_TypeDefinitionIndex = 28908;
