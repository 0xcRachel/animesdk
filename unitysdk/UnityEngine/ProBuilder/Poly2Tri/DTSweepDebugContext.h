...
#define UNITYENGINE_PROBUILDER_POLY2TRI_DTSWEEPDEBUGCONTEXT_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A687400)
#define UNITYENGINE_PROBUILDER_POLY2TRI_DTSWEEPDEBUGCONTEXT_SET_ACTIVECONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1A680420)
#define UNITYENGINE_PROBUILDER_POLY2TRI_DTSWEEPDEBUGCONTEXT_SET_ACTIVENODE_OFFSET UNITYSDK_OFFSET(0x1A681640)
#define UNITYENGINE_PROBUILDER_POLY2TRI_DTSWEEPDEBUGCONTEXT_SET_ACTIVEPOINT_OFFSET UNITYSDK_OFFSET(0x1A6873B0)
#define UNITYENGINE_PROBUILDER_POLY2TRI_DTSWEEPDEBUGCONTEXT_SET_PRIMARYTRIANGLE_OFFSET UNITYSDK_OFFSET(0x1A682920)
#define UNITYENGINE_PROBUILDER_POLY2TRI_DTSWEEPDEBUGCONTEXT_SET_SECONDARYTRIANGLE_OFFSET UNITYSDK_OFFSET(0x1A684C50)
