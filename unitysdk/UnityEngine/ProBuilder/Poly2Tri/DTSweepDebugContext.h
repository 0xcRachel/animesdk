...
#define UNITYENGINE_PROBUILDER_POLY2TRI_DTSWEEPDEBUGCONTEXT_CLEAR_OFFSET UNITYSDK_OFFSET(0x17FA20D0)
#define UNITYENGINE_PROBUILDER_POLY2TRI_DTSWEEPDEBUGCONTEXT_SET_ACTIVECONSTRAINT_OFFSET UNITYSDK_OFFSET(0x17F9B0F0)
#define UNITYENGINE_PROBUILDER_POLY2TRI_DTSWEEPDEBUGCONTEXT_SET_ACTIVENODE_OFFSET UNITYSDK_OFFSET(0x17F9C310)
#define UNITYENGINE_PROBUILDER_POLY2TRI_DTSWEEPDEBUGCONTEXT_SET_ACTIVEPOINT_OFFSET UNITYSDK_OFFSET(0x17FA2080)
#define UNITYENGINE_PROBUILDER_POLY2TRI_DTSWEEPDEBUGCONTEXT_SET_PRIMARYTRIANGLE_OFFSET UNITYSDK_OFFSET(0x17F9D5F0)
#define UNITYENGINE_PROBUILDER_POLY2TRI_DTSWEEPDEBUGCONTEXT_SET_SECONDARYTRIANGLE_OFFSET UNITYSDK_OFFSET(0x17F9F920)

namespace UnityEngine::ProBuilder::Poly2Tri
{
	inline static constexpr unsigned int DTSweepDebugContext_TypeDefinitionIndex = 28911;
	...
	public:
		...
		::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* _activePoint; // 0x30
