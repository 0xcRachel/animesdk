...
#define UNITYENGINE_PROBUILDER_INTVEC3_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xFD3000)
#define UNITYENGINE_PROBUILDER_INTVEC3_EQUALS_2_OFFSET UNITYSDK_OFFSET(0xFD34F0)
#define UNITYENGINE_PROBUILDER_INTVEC3_EQUALS_OFFSET UNITYSDK_OFFSET(0xFD3000)
#define UNITYENGINE_PROBUILDER_INTVEC3_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xFD3500)
#define UNITYENGINE_PROBUILDER_INTVEC3_GET_X_OFFSET UNITYSDK_OFFSET(0x72BD60)
#define UNITYENGINE_PROBUILDER_INTVEC3_GET_Y_OFFSET UNITYSDK_OFFSET(0x72BD70)
#define UNITYENGINE_PROBUILDER_INTVEC3_GET_Z_OFFSET UNITYSDK_OFFSET(0xFD2FD0)
#define UNITYENGINE_PROBUILDER_INTVEC3_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0xC229D20)
#define UNITYENGINE_PROBUILDER_INTVEC3_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0xC22BCD0)
#define UNITYENGINE_PROBUILDER_INTVEC3_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0xC22BCC0)
#define UNITYENGINE_PROBUILDER_INTVEC3_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0xC22A700)
#define UNITYENGINE_PROBUILDER_INTVEC3_ROUND_OFFSET UNITYSDK_OFFSET(0xC22AC00)
#define UNITYENGINE_PROBUILDER_INTVEC3_TOSTRING_OFFSET UNITYSDK_OFFSET(0xFD2FF0)
#define UNITYENGINE_PROBUILDER_INTVEC3__CTOR_OFFSET UNITYSDK_OFFSET(0xFD2FE0)
