...
#define UNITYENGINE_PROBUILDER_INTVEC2_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xFD2BE0)
#define UNITYENGINE_PROBUILDER_INTVEC2_EQUALS_2_OFFSET UNITYSDK_OFFSET(0xFD2F30)
#define UNITYENGINE_PROBUILDER_INTVEC2_EQUALS_OFFSET UNITYSDK_OFFSET(0xFD2BE0)
#define UNITYENGINE_PROBUILDER_INTVEC2_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xFD2F40)
#define UNITYENGINE_PROBUILDER_INTVEC2_GET_X_OFFSET UNITYSDK_OFFSET(0x72BD60)
#define UNITYENGINE_PROBUILDER_INTVEC2_GET_Y_OFFSET UNITYSDK_OFFSET(0x72BD70)
#define UNITYENGINE_PROBUILDER_INTVEC2_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0xC228640)
#define UNITYENGINE_PROBUILDER_INTVEC2_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0xC229C00)
#define UNITYENGINE_PROBUILDER_INTVEC2_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0xC229BF0)
#define UNITYENGINE_PROBUILDER_INTVEC2_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0xC228CE0)
#define UNITYENGINE_PROBUILDER_INTVEC2_ROUND_OFFSET UNITYSDK_OFFSET(0xC229040)
#define UNITYENGINE_PROBUILDER_INTVEC2_TOSTRING_OFFSET UNITYSDK_OFFSET(0xFD2B30)
#define UNITYENGINE_PROBUILDER_INTVEC2__CTOR_OFFSET UNITYSDK_OFFSET(0x66AF20)
