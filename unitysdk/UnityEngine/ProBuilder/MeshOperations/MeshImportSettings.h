...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_MESHIMPORTSETTINGS_GET_QUADS_OFFSET UNITYSDK_OFFSET(0x18867240)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_MESHIMPORTSETTINGS_GET_SMOOTHINGANGLE_OFFSET UNITYSDK_OFFSET(0x18867280)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_MESHIMPORTSETTINGS_GET_SMOOTHING_OFFSET UNITYSDK_OFFSET(0x18867260)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_MESHIMPORTSETTINGS_SET_QUADS_OFFSET UNITYSDK_OFFSET(0x18867250)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_MESHIMPORTSETTINGS_SET_SMOOTHINGANGLE_OFFSET UNITYSDK_OFFSET(0x18867290)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_MESHIMPORTSETTINGS_SET_SMOOTHING_OFFSET UNITYSDK_OFFSET(0x18867270)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_MESHIMPORTSETTINGS_TOSTRING_OFFSET UNITYSDK_OFFSET(0x188672A0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_MESHIMPORTSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x18867360)
