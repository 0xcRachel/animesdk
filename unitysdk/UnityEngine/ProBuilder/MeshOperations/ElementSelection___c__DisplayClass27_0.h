...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION___C__DISPLAYCLASS27_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1802E890)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION___C__DISPLAYCLASS27_0__FINDHOLES_B__1_OFFSET UNITYSDK_OFFSET(0x1802EC00)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION___C__DISPLAYCLASS27_0__FINDHOLES_B__2_OFFSET UNITYSDK_OFFSET(0x1802EC30)

namespace UnityEngine::ProBuilder::MeshOperations
{
	inline static constexpr unsigned int ElementSelection___c__DisplayClass27_0_TypeDefinitionIndex = 33243;
