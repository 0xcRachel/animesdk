...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_TRIANGULATION___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC27C450)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_TRIANGULATION___C__DISPLAYCLASS8_0__TRIANGULATE_B__0_OFFSET UNITYSDK_OFFSET(0xC27C560)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_TRIANGULATION___C__DISPLAYCLASS8_0__TRIANGULATE_B__1_OFFSET UNITYSDK_OFFSET(0xC27C5E0)
