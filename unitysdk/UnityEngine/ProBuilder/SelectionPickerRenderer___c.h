...
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x15C50E10)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER___C__CTOR_OFFSET UNITYSDK_OFFSET(0x15C50E50)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER___C__GENERATEFACEPICKINGOBJECTS_B__24_0_OFFSET UNITYSDK_OFFSET(0x15C50E60)
...
namespace UnityEngine::ProBuilder
{
	...
	public:
		...
		{
			return (::System::Func_2<::UnityEngine::ProBuilder::Face*, ::System::Collections::Generic::IEnumerable_1<::System::Int32>*>**)Il2CppClass::FromTypeDefinitionIndex(SelectionPickerRenderer___c_TypeDefinitionIndex)->GetStaticField(0x519D0);
		}
		static ::UnityEngine::ProBuilder::SelectionPickerRenderer___c** StaticGet___9()
		{
			return (::UnityEngine::ProBuilder::SelectionPickerRenderer___c**)Il2CppClass::FromTypeDefinitionIndex(SelectionPickerRenderer___c_TypeDefinitionIndex)->GetStaticField(0x519D8);
		}
