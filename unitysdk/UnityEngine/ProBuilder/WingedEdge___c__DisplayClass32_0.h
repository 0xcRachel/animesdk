...
#define UNITYENGINE_PROBUILDER_WINGEDEDGE___C__DISPLAYCLASS32_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15C7DFC0)
#define UNITYENGINE_PROBUILDER_WINGEDEDGE___C__DISPLAYCLASS32_0__SORTCOMMONINDEXESBYADJACENCY_B__0_OFFSET UNITYSDK_OFFSET(0x15C7E0F0)
