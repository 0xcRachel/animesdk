...
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICMESH_SPLIT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x187A6000)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICMESH_SPLIT__CTOR_OFFSET UNITYSDK_OFFSET(0x187A6440)
...
namespace UnityEngine::Formats::Alembic::Importer
{
	...
	public:
		...
		::Unity::Collections::NativeArray_1<::UnityEngine::Vector2> uv1; // 0x30
		::Unity::Collections::NativeArray_1<::UnityEngine::Vector4> tangents; // 0x40
		...
		::UnityEngine::Vector3 size; // 0x70
		::System::Boolean active; // 0x7C
		::System::Boolean disposed; // 0x7D
		::System::Boolean velocitiesSet; // 0x7E
		::Unity::Collections::NativeArray_1<::UnityEngine::Vector3> points; // 0x80
		::Unity::Collections::NativeArray_1<::UnityEngine::Color> rgba; // 0x90
		::Unity::Collections::NativeArray_1<::UnityEngine::Vector3> zeroVelocities; // 0xA0
