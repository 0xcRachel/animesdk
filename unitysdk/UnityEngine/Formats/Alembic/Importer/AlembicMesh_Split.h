...
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICMESH_SPLIT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17F7CCA0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICMESH_SPLIT__CTOR_OFFSET UNITYSDK_OFFSET(0x17F7D0E0)

namespace UnityEngine::Formats::Alembic::Importer
{
	inline static constexpr unsigned int AlembicMesh_Split_TypeDefinitionIndex = 34087;
	...
	public:
		...
		::Unity::Collections::NativeArray_1<::UnityEngine::Vector3> points; // 0x20
		...
		::Unity::Collections::NativeArray_1<::UnityEngine::Vector3> normals; // 0x60
		::Unity::Collections::NativeArray_1<::UnityEngine::Vector2> uv1; // 0x70
		::Unity::Collections::NativeArray_1<::UnityEngine::Vector3> velocities; // 0x80
		::System::Boolean disposed; // 0x90
		::System::Boolean velocitiesSet; // 0x91
		::System::Boolean active; // 0x92
		::UnityEngine::Vector3 size; // 0x94
		::Unity::Collections::NativeArray_1<::UnityEngine::Vector4> tangents; // 0xA0
		::UnityEngine::Vector3 center; // 0xB0
		::Unity::Collections::NativeArray_1<::UnityEngine::Vector2> uv0; // 0xC0
