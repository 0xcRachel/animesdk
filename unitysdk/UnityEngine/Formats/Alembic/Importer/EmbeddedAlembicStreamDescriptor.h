...
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_EMBEDDEDALEMBICSTREAMDESCRIPTOR_CLONE_OFFSET UNITYSDK_OFFSET(0x18C0AA20)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_EMBEDDEDALEMBICSTREAMDESCRIPTOR_GET_MEDIADURATION_OFFSET UNITYSDK_OFFSET(0x18C0AA10)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_EMBEDDEDALEMBICSTREAMDESCRIPTOR_GET_MEDIAENDTIME_OFFSET UNITYSDK_OFFSET(0x18C0A9F0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_EMBEDDEDALEMBICSTREAMDESCRIPTOR_GET_MEDIASTARTTIME_OFFSET UNITYSDK_OFFSET(0x18C0A9D0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_EMBEDDEDALEMBICSTREAMDESCRIPTOR_GET_PATHTOABC_OFFSET UNITYSDK_OFFSET(0x18C0A950)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_EMBEDDEDALEMBICSTREAMDESCRIPTOR_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x18C0A9B0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_EMBEDDEDALEMBICSTREAMDESCRIPTOR_SET_MEDIAENDTIME_OFFSET UNITYSDK_OFFSET(0x18C0AA00)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_EMBEDDEDALEMBICSTREAMDESCRIPTOR_SET_MEDIASTARTTIME_OFFSET UNITYSDK_OFFSET(0x18C0A9E0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_EMBEDDEDALEMBICSTREAMDESCRIPTOR_SET_PATHTOABC_OFFSET UNITYSDK_OFFSET(0x18C0A9A0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_EMBEDDEDALEMBICSTREAMDESCRIPTOR_SET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x18C0A9C0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_EMBEDDEDALEMBICSTREAMDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x18C09690)
