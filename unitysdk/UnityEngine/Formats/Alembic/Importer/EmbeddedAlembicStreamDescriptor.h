...
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_EMBEDDEDALEMBICSTREAMDESCRIPTOR_CLONE_OFFSET UNITYSDK_OFFSET(0x17F8BBA0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_EMBEDDEDALEMBICSTREAMDESCRIPTOR_GET_MEDIADURATION_OFFSET UNITYSDK_OFFSET(0x17F8BB90)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_EMBEDDEDALEMBICSTREAMDESCRIPTOR_GET_MEDIAENDTIME_OFFSET UNITYSDK_OFFSET(0x17F8BB70)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_EMBEDDEDALEMBICSTREAMDESCRIPTOR_GET_MEDIASTARTTIME_OFFSET UNITYSDK_OFFSET(0x17F8BB50)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_EMBEDDEDALEMBICSTREAMDESCRIPTOR_GET_PATHTOABC_OFFSET UNITYSDK_OFFSET(0x17F8BAD0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_EMBEDDEDALEMBICSTREAMDESCRIPTOR_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x17F8BB30)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_EMBEDDEDALEMBICSTREAMDESCRIPTOR_SET_MEDIAENDTIME_OFFSET UNITYSDK_OFFSET(0x17F8BB80)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_EMBEDDEDALEMBICSTREAMDESCRIPTOR_SET_MEDIASTARTTIME_OFFSET UNITYSDK_OFFSET(0x17F8BB60)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_EMBEDDEDALEMBICSTREAMDESCRIPTOR_SET_PATHTOABC_OFFSET UNITYSDK_OFFSET(0x17F8BB20)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_EMBEDDEDALEMBICSTREAMDESCRIPTOR_SET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x17F8BB40)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_EMBEDDEDALEMBICSTREAMDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x17F8A800)

namespace UnityEngine::Formats::Alembic::Importer
{
	inline static constexpr unsigned int EmbeddedAlembicStreamDescriptor_TypeDefinitionIndex = 34117;
