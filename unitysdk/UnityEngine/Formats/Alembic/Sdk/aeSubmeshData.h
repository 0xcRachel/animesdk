...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AESUBMESHDATA_GET_TOPOLOGY_OFFSET UNITYSDK_OFFSET(0xCAE40)
...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AESUBMESHDATA_SET_TOPOLOGY_OFFSET UNITYSDK_OFFSET(0x2036AF0)

namespace UnityEngine::Formats::Alembic::Sdk
{
	inline static constexpr unsigned int aeSubmeshData_TypeDefinitionIndex = 34017;
