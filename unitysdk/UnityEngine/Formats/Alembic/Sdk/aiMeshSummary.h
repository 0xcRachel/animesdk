...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_CONSTANTNORMALS_OFFSET UNITYSDK_OFFSET(0x15B7190)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_CONSTANTPOINTS_OFFSET UNITYSDK_OFFSET(0x210D560)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_CONSTANTRGBA_OFFSET UNITYSDK_OFFSET(0x75890)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_CONSTANTRGB_OFFSET UNITYSDK_OFFSET(0x210D600)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_CONSTANTTANGENTS_OFFSET UNITYSDK_OFFSET(0x210D5A0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_CONSTANTUV0_OFFSET UNITYSDK_OFFSET(0x210D5C0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_CONSTANTUV1_OFFSET UNITYSDK_OFFSET(0x210D5E0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_CONSTANTVELOCITIES_OFFSET UNITYSDK_OFFSET(0x210D580)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_HASCOUNTS_OFFSET UNITYSDK_OFFSET(0x888C0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_HASINDSICES_OFFSET UNITYSDK_OFFSET(0x20DCBF0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_HASNORMALS_OFFSET UNITYSDK_OFFSET(0x14EDB20)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_HASPOINTS_OFFSET UNITYSDK_OFFSET(0x20E1150)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_HASRGBA_OFFSET UNITYSDK_OFFSET(0x210D520)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_HASRGB_OFFSET UNITYSDK_OFFSET(0x210D540)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_HASTANGENTS_OFFSET UNITYSDK_OFFSET(0x20D6C40)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_HASUV0_OFFSET UNITYSDK_OFFSET(0x20D6C50)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_HASUV1_OFFSET UNITYSDK_OFFSET(0x2105E30)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_HASVELOCITIES_OFFSET UNITYSDK_OFFSET(0x210D4C0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_TOPOLOGYVARIANCE_OFFSET UNITYSDK_OFFSET(0x59D0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_CONSTANTNORMALS_OFFSET UNITYSDK_OFFSET(0x1597C50)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_CONSTANTPOINTS_OFFSET UNITYSDK_OFFSET(0x210D570)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_CONSTANTRGBA_OFFSET UNITYSDK_OFFSET(0x758A0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_CONSTANTRGB_OFFSET UNITYSDK_OFFSET(0x210D610)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_CONSTANTTANGENTS_OFFSET UNITYSDK_OFFSET(0x210D5B0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_CONSTANTUV0_OFFSET UNITYSDK_OFFSET(0x210D5D0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_CONSTANTUV1_OFFSET UNITYSDK_OFFSET(0x210D5F0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_CONSTANTVELOCITIES_OFFSET UNITYSDK_OFFSET(0x210D590)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_HASCOUNTS_OFFSET UNITYSDK_OFFSET(0x888D0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_HASINDSICES_OFFSET UNITYSDK_OFFSET(0x210D4A0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_HASNORMALS_OFFSET UNITYSDK_OFFSET(0x210D4E0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_HASPOINTS_OFFSET UNITYSDK_OFFSET(0x210D4B0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_HASRGBA_OFFSET UNITYSDK_OFFSET(0x210D530)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_HASRGB_OFFSET UNITYSDK_OFFSET(0x210D550)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_HASTANGENTS_OFFSET UNITYSDK_OFFSET(0x210D4F0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_HASUV0_OFFSET UNITYSDK_OFFSET(0x210D500)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_HASUV1_OFFSET UNITYSDK_OFFSET(0x210D510)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_HASVELOCITIES_OFFSET UNITYSDK_OFFSET(0x210D4D0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_TOPOLOGYVARIANCE_OFFSET UNITYSDK_OFFSET(0x29130)

namespace UnityEngine::Formats::Alembic::Sdk
{
	inline static constexpr unsigned int aiMeshSummary_TypeDefinitionIndex = 34973;
