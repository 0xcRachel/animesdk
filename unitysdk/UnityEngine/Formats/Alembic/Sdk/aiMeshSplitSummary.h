...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSPLITSUMMARY_GET_VERTEXOFFSET_OFFSET UNITYSDK_OFFSET(0x793B0)
...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSPLITSUMMARY_SET_VERTEXOFFSET_OFFSET UNITYSDK_OFFSET(0x210CC60)
