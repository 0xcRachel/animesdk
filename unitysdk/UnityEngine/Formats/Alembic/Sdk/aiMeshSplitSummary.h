...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSPLITSUMMARY_GET_SUBMESHOFFSET_OFFSET UNITYSDK_OFFSET(0x1DAE0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSPLITSUMMARY_GET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0xD240)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSPLITSUMMARY_GET_VERTEXOFFSET_OFFSET UNITYSDK_OFFSET(0xCAE40)
...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSPLITSUMMARY_SET_SUBMESHCOUNT_OFFSET UNITYSDK_OFFSET(0x29250)
...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSPLITSUMMARY_SET_VERTEXOFFSET_OFFSET UNITYSDK_OFFSET(0x2036AF0)

namespace UnityEngine::Formats::Alembic::Sdk
{
	inline static constexpr unsigned int aiMeshSplitSummary_TypeDefinitionIndex = 34041;
