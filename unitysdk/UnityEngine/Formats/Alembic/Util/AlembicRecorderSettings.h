...
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_GET_ASSUMENONSKINNEDMESHESARECONSTANT_OFFSET UNITYSDK_OFFSET(0x187C1660)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_GET_CAPTURECAMERA_OFFSET UNITYSDK_OFFSET(0x187C16E0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_GET_CAPTUREMESHRENDERER_OFFSET UNITYSDK_OFFSET(0x187C1680)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_GET_CAPTUREPARTICLESYSTEM_OFFSET UNITYSDK_OFFSET(0x187C16C0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_GET_CAPTURESKINNEDMESHRENDERER_OFFSET UNITYSDK_OFFSET(0x187C16A0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_GET_DETAILEDLOG_OFFSET UNITYSDK_OFFSET(0x187C17A0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_GET_EXPORTOPTIONS_OFFSET UNITYSDK_OFFSET(0x187C1360)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_GET_FIXDELTATIME_OFFSET UNITYSDK_OFFSET(0x187C1640)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_GET_MESHCOLORS_OFFSET UNITYSDK_OFFSET(0x187C1760)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_GET_MESHNORMALS_OFFSET UNITYSDK_OFFSET(0x187C1700)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_GET_MESHSUBMESHES_OFFSET UNITYSDK_OFFSET(0x187C1780)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_GET_MESHUV0_OFFSET UNITYSDK_OFFSET(0x187C1720)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_GET_MESHUV1_OFFSET UNITYSDK_OFFSET(0x187C1740)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_GET_OUTPUTPATH_OFFSET UNITYSDK_OFFSET(0x187C1340)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_GET_SCOPE_OFFSET UNITYSDK_OFFSET(0x187C1370)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_GET_TARGETBRANCH_OFFSET UNITYSDK_OFFSET(0x187BAD00)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_SET_ASSUMENONSKINNEDMESHESARECONSTANT_OFFSET UNITYSDK_OFFSET(0x187C1670)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_SET_CAPTURECAMERA_OFFSET UNITYSDK_OFFSET(0x187C16F0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_SET_CAPTUREMESHRENDERER_OFFSET UNITYSDK_OFFSET(0x187C1690)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_SET_CAPTUREPARTICLESYSTEM_OFFSET UNITYSDK_OFFSET(0x187C16D0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_SET_CAPTURESKINNEDMESHRENDERER_OFFSET UNITYSDK_OFFSET(0x187C16B0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_SET_DETAILEDLOG_OFFSET UNITYSDK_OFFSET(0x187C17B0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_SET_FIXDELTATIME_OFFSET UNITYSDK_OFFSET(0x187C1650)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_SET_MESHCOLORS_OFFSET UNITYSDK_OFFSET(0x187C1770)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_SET_MESHNORMALS_OFFSET UNITYSDK_OFFSET(0x187C1710)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_SET_MESHSUBMESHES_OFFSET UNITYSDK_OFFSET(0x187C1790)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_SET_MESHUV0_OFFSET UNITYSDK_OFFSET(0x187C1730)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_SET_MESHUV1_OFFSET UNITYSDK_OFFSET(0x187C1750)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_SET_OUTPUTPATH_OFFSET UNITYSDK_OFFSET(0x187C1350)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_SET_SCOPE_OFFSET UNITYSDK_OFFSET(0x187C1380)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_SET_TARGETBRANCH_OFFSET UNITYSDK_OFFSET(0x187BAD50)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x187BC2A0)
