...
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_CAPTURENODE_CAPTURE_OFFSET UNITYSDK_OFFSET(0x187BC1C0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_CAPTURENODE_MARKFORCEINVISIBLE_OFFSET UNITYSDK_OFFSET(0x187BC0C0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_CAPTURENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x187BB220)
...
namespace UnityEngine::Formats::Alembic::Util
{
	...
	public:
		...
		::System::Type* componentType; // 0x18
		...
		::UnityEngine::Formats::Alembic::Util::ComponentCapturer* componentCapturer; // 0x30
