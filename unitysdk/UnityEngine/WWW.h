...
#define UNITYENGINE_WWW_DISPOSE_OFFSET UNITYSDK_OFFSET(0x183704D0)
#define UNITYENGINE_WWW_GET_ERROR_OFFSET UNITYSDK_OFFSET(0x1836FF30)
#define UNITYENGINE_WWW_GET_ISDONE_OFFSET UNITYSDK_OFFSET(0x18370050)
#define UNITYENGINE_WWW_GET_KEEPWAITING_OFFSET UNITYSDK_OFFSET(0x183704A0)
#define UNITYENGINE_WWW_GET_RESPONSEHEADERS_OFFSET UNITYSDK_OFFSET(0x18370070)
#define UNITYENGINE_WWW_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x183702D0)
#define UNITYENGINE_WWW_GET_URL_OFFSET UNITYSDK_OFFSET(0x18370480)
#define UNITYENGINE_WWW_WAITUNTILDONEIFPOSSIBLE_OFFSET UNITYSDK_OFFSET(0x18370340)
#define UNITYENGINE_WWW__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1836FC90)
#define UNITYENGINE_WWW__CTOR_OFFSET UNITYSDK_OFFSET(0x1836FC50)

namespace UnityEngine
{
	inline static constexpr unsigned int WWW_TypeDefinitionIndex = 5887;
