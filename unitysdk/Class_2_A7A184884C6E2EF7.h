...
#define CLASS_2_A7A184884C6E2EF7_DISPOSE_OFFSET UNITYSDK_OFFSET(0x89B4470)
#define CLASS_2_A7A184884C6E2EF7_METHOD_2_049407E7CFE73C8B_OFFSET UNITYSDK_OFFSET(0x89B47B0)
#define CLASS_2_A7A184884C6E2EF7_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x89B45B0)
#define CLASS_2_A7A184884C6E2EF7_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x89B4670)
#define CLASS_2_A7A184884C6E2EF7_TICK_OFFSET UNITYSDK_OFFSET(0x89B4750)
#define CLASS_2_A7A184884C6E2EF7__CTOR_OFFSET UNITYSDK_OFFSET(0x89B4460)

inline static constexpr unsigned int Class_2_A7A184884C6E2EF7_TypeDefinitionIndex = 46304;

class Class_2_A7A184884C6E2EF7 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::Class_0_16E4307DCC419505_437* Field_2_2; // 0x20
	::RPG::GameCore::ShowTutorialGuideTalk* Field_2_0; // 0x28
