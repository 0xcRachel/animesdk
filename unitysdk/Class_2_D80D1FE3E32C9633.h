...
#define CLASS_2_D80D1FE3E32C9633_METHOD_2_40E6AFCB91524816_OFFSET UNITYSDK_OFFSET(0xFC4E2E0)
#define CLASS_2_D80D1FE3E32C9633_METHOD_2_F698023FC94DE47E_OFFSET UNITYSDK_OFFSET(0xFC4E1C0)
#define CLASS_2_D80D1FE3E32C9633__CTOR_OFFSET UNITYSDK_OFFSET(0xFC4E460)
#define CLASS_2_D80D1FE3E32C9633__ONBIND_OFFSET UNITYSDK_OFFSET(0xFC4E120)
#define CLASS_2_D80D1FE3E32C9633___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0xFC4E490)

inline static constexpr unsigned int Class_2_D80D1FE3E32C9633_TypeDefinitionIndex = 66581;

class Class_2_D80D1FE3E32C9633 : public ::Class_1_CA217ABF4E3B4F3F
{
public:
	::RPG::Client::GridFightAugmentConfig* Field_2_2; // 0x60
	::RPG::Client::MonoUIColorSwitcher* Field_2_1; // 0x68
	::UnityEngine::UI::SmoothMask* Field_2_3; // 0x70
	::UnityEngine::Sprite* Field_2_4; // 0x78
	::Class_1_9015B34004B876E5* Field_2_0; // 0x80
