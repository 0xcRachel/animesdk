...
#define CLASS_2_D80D1FE3E32C9633_METHOD_2_1B9BAFE25893B138_OFFSET UNITYSDK_OFFSET(0x144413B0)
#define CLASS_2_D80D1FE3E32C9633_METHOD_2_F698023FC94DE47E_OFFSET UNITYSDK_OFFSET(0x14441290)
#define CLASS_2_D80D1FE3E32C9633__CTOR_OFFSET UNITYSDK_OFFSET(0x14441530)
#define CLASS_2_D80D1FE3E32C9633__ONBIND_OFFSET UNITYSDK_OFFSET(0x144411F0)
#define CLASS_2_D80D1FE3E32C9633___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0x14441560)

inline static constexpr unsigned int Class_2_D80D1FE3E32C9633_TypeDefinitionIndex = 67522;

class Class_2_D80D1FE3E32C9633 : public ::Class_1_CA217ABF4E3B4F3F
{
public:
	::UnityEngine::Sprite* Field_2_0; // 0x60
	::UnityEngine::UI::SmoothMask* Field_2_1; // 0x68
	::Class_1_9015B34004B876E5* Field_2_2; // 0x70
	::RPG::Client::GridFightAugmentConfig* Field_2_3; // 0x78
	::RPG::Client::MonoUIColorSwitcher* Field_2_4; // 0x80
