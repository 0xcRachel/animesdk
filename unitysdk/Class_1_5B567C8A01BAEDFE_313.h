...
#define CLASS_1_5B567C8A01BAEDFE_313_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19A3D110)
#define CLASS_1_5B567C8A01BAEDFE_313_CLONE_OFFSET UNITYSDK_OFFSET(0x19A3CF20)
#define CLASS_1_5B567C8A01BAEDFE_313_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19A3D020)
#define CLASS_1_5B567C8A01BAEDFE_313_EQUALS_OFFSET UNITYSDK_OFFSET(0x19A3CF90)
#define CLASS_1_5B567C8A01BAEDFE_313_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19A3D070)
#define CLASS_1_5B567C8A01BAEDFE_313_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19A3D160)
#define CLASS_1_5B567C8A01BAEDFE_313_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19A3D130)
#define CLASS_1_5B567C8A01BAEDFE_313_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19A3CE70)
#define CLASS_1_5B567C8A01BAEDFE_313_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19A3CED0)
#define CLASS_1_5B567C8A01BAEDFE_313_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19A3D0A0)
#define CLASS_1_5B567C8A01BAEDFE_313_WRITETO_OFFSET UNITYSDK_OFFSET(0x19A3D100)
#define CLASS_1_5B567C8A01BAEDFE_313__CCTOR_OFFSET UNITYSDK_OFFSET(0x19A3D1B0)
#define CLASS_1_5B567C8A01BAEDFE_313__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19A3CEF0)
#define CLASS_1_5B567C8A01BAEDFE_313__CTOR_OFFSET UNITYSDK_OFFSET(0x19A3CEE0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_313*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_313_TypeDefinitionIndex)->GetStaticField(0x3EB70);
	}
