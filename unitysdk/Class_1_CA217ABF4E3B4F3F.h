...
#define CLASS_1_CA217ABF4E3B4F3F_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x14A0CC70)
#define CLASS_1_CA217ABF4E3B4F3F_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x14A0CCB0)
#define CLASS_1_CA217ABF4E3B4F3F_GET_MUTEHANDLER_OFFSET UNITYSDK_OFFSET(0x14A0D070)
#define CLASS_1_CA217ABF4E3B4F3F_GET__ROOT_OFFSET UNITYSDK_OFFSET(0x14A0D080)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_03E2B9212B4B6EAF_OFFSET UNITYSDK_OFFSET(0x14A0B990)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_063ADB01C44981A7_1_OFFSET UNITYSDK_OFFSET(0x14A0B680)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_063ADB01C44981A7_OFFSET UNITYSDK_OFFSET(0x14A0A940)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_17CB1CF4F8DDCB81_OFFSET UNITYSDK_OFFSET(0x14A0C120)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x14A0A830)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_2379CA8FC73CF2DC_OFFSET UNITYSDK_OFFSET(0x14A0AF30)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_283228DCA08F69C7_OFFSET UNITYSDK_OFFSET(0x14A0A770)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_2BC47A1A90206138_OFFSET UNITYSDK_OFFSET(0x14A0C090)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x14A0B150)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_377159881B9E0AC7_OFFSET UNITYSDK_OFFSET(0x14A0BC60)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_39076DB8B566935B_OFFSET UNITYSDK_OFFSET(0x14A0B930)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x14A0AA10)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_393861C56DABFE4E_OFFSET UNITYSDK_OFFSET(0x14A0BD10)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_3E7178C5ECF017DB_1_OFFSET UNITYSDK_OFFSET(0x14A0C960)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_3E7178C5ECF017DB_2_OFFSET UNITYSDK_OFFSET(0x14A0C9B0)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x14A0C910)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_42E61940F29D91C2_OFFSET UNITYSDK_OFFSET(0x14A0C5D0)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_4307B2A4B4A12C1A_1_OFFSET UNITYSDK_OFFSET(0x14A0B0A0)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x14A0C3C0)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x14A0BB00)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_4D6D325C865EE52D_OFFSET UNITYSDK_OFFSET(0x14A0BB60)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_5022DB1DC5AA8CB4_OFFSET UNITYSDK_OFFSET(0x14A0CA90)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_5440DFB8C03469CC_OFFSET UNITYSDK_OFFSET(0x14A0AA50)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_5EA79CD11E1E5CB8_OFFSET UNITYSDK_OFFSET(0x14A0B740)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_6D44C03F490A953F_OFFSET UNITYSDK_OFFSET(0x14A0B4F0)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_6FEEEF65894B533B_1_OFFSET UNITYSDK_OFFSET(0x14A0C280)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_6FEEEF65894B533B_OFFSET UNITYSDK_OFFSET(0x14A0C1A0)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_74E2789F4C5CBA05_OFFSET UNITYSDK_OFFSET(0x14A0AE10)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_763B70E1B527E566_OFFSET UNITYSDK_OFFSET(0x14A0B2E0)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_7DD66AD8261C01D5_OFFSET UNITYSDK_OFFSET(0x14A0A5C0)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_809094DEBF13B21A_OFFSET UNITYSDK_OFFSET(0x14A0B000)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_83AE46DB8772209E_OFFSET UNITYSDK_OFFSET(0x14A0B860)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_85134B7B20E1588A_1_OFFSET UNITYSDK_OFFSET(0x14A0A520)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_85134B7B20E1588A_OFFSET UNITYSDK_OFFSET(0x14A0A360)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_86D9A88811BF5A61_OFFSET UNITYSDK_OFFSET(0x14A0B420)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_8CE0803574BB66D7_1_OFFSET UNITYSDK_OFFSET(0x14A0C760)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_8CE0803574BB66D7_OFFSET UNITYSDK_OFFSET(0x14A0A3B0)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_8F9DF3D751E1E0BF_OFFSET UNITYSDK_OFFSET(0x14A0AB70)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_A5ADA4706DA592FA_OFFSET UNITYSDK_OFFSET(0x14A0B330)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_A677FAB20724C65B_OFFSET UNITYSDK_OFFSET(0x14A0ACD0)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_AAD864A9DF964170_OFFSET UNITYSDK_OFFSET(0x14A0CBA0)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_BB2716A85BA5EF4B_OFFSET UNITYSDK_OFFSET(0x14A0C2F0)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x14A0C7F0)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x14A0C830)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_CA373AA1C7054598_3_OFFSET UNITYSDK_OFFSET(0x14A0CA50)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x14A0C720)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_D147751464BA5EBE_1_OFFSET UNITYSDK_OFFSET(0x14A0C560)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_D147751464BA5EBE_OFFSET UNITYSDK_OFFSET(0x14A0C4F0)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_D34432C0B65E6441_OFFSET UNITYSDK_OFFSET(0x14A0CB40)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_D3D56207AD0AAB7F_OFFSET UNITYSDK_OFFSET(0x14A0C210)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_D829035DEFE99EBC_OFFSET UNITYSDK_OFFSET(0x14A0B7F0)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_E9A575D18A0748D9_OFFSET UNITYSDK_OFFSET(0x14A0A570)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_EA44E6D8C8E5D7C2_OFFSET UNITYSDK_OFFSET(0x14A0BD70)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_ECA72114536D14FE_OFFSET UNITYSDK_OFFSET(0x14A0AAA0)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_EE4559E3A2F0A78B_1_OFFSET UNITYSDK_OFFSET(0x14A0C6B0)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_EE4559E3A2F0A78B_OFFSET UNITYSDK_OFFSET(0x14A0C640)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_EF63DC3FFA3153D2_OFFSET UNITYSDK_OFFSET(0x14A0BBD0)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_F8EBAFE4624A6F9F_OFFSET UNITYSDK_OFFSET(0x14A0CA00)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_F9AA2CA9B2F50D22_OFFSET UNITYSDK_OFFSET(0x14A0A420)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_FADC1F8DDBE056CA_OFFSET UNITYSDK_OFFSET(0x14A0B9D0)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_FB990163A2E62A47_OFFSET UNITYSDK_OFFSET(0x14A0C480)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_FDE09C8D62639E3E_OFFSET UNITYSDK_OFFSET(0x14A0A890)
#define CLASS_1_CA217ABF4E3B4F3F_METHOD_1_FEAD0C991DEE1FCA_OFFSET UNITYSDK_OFFSET(0x14A0ABB0)
#define CLASS_1_CA217ABF4E3B4F3F_SET__ROOT_OFFSET UNITYSDK_OFFSET(0x14A0D090)
#define CLASS_1_CA217ABF4E3B4F3F__CCTOR_OFFSET UNITYSDK_OFFSET(0x14A0D0A0)
#define CLASS_1_CA217ABF4E3B4F3F__CTOR_OFFSET UNITYSDK_OFFSET(0x14A0A2A0)
#define CLASS_1_CA217ABF4E3B4F3F__ONBIND_OFFSET UNITYSDK_OFFSET(0x14A0C7B0)
#define CLASS_1_CA217ABF4E3B4F3F__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x14A0C870)
#define CLASS_1_CA217ABF4E3B4F3F__ONTICK_OFFSET UNITYSDK_OFFSET(0x14A0C8B0)

inline static constexpr unsigned int Class_1_CA217ABF4E3B4F3F_TypeDefinitionIndex = 68199;
...
public:
	...
	{
		return (::RPG::Client::RPGProfilerMarker**)Il2CppClass::FromTypeDefinitionIndex(Class_1_CA217ABF4E3B4F3F_TypeDefinitionIndex)->GetStaticField(0x56880);
	}
	::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_1057*>* Field_1_1; // 0x10
	...
	::RPG::Client::UIController* Field_1_5; // 0x30
	::UnityEngine::Transform* __Root_k__BackingField; // 0x38
	::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_1058*>* Field_1_7; // 0x40
	::Class_1_CA217ABF4E3B4F3F* Field_1_8; // 0x48
	::System::Collections::Generic::List_1<::Class_2_FD4CAB81BEFA440B*>* Field_1_9; // 0x50
