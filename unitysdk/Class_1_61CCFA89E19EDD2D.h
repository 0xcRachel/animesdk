...
#define CLASS_1_61CCFA89E19EDD2D_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x101BCCF0)
#define CLASS_1_61CCFA89E19EDD2D_METHOD_1_00774B5C8637A4AD_OFFSET UNITYSDK_OFFSET(0x101BCD00)
#define CLASS_1_61CCFA89E19EDD2D_METHOD_1_00D1131E221027A5_OFFSET UNITYSDK_OFFSET(0x101BD4D0)
#define CLASS_1_61CCFA89E19EDD2D_METHOD_1_061739BCA68F2B1B_1_OFFSET UNITYSDK_OFFSET(0x101BDE80)
#define CLASS_1_61CCFA89E19EDD2D_METHOD_1_061739BCA68F2B1B_OFFSET UNITYSDK_OFFSET(0x101BDC50)
#define CLASS_1_61CCFA89E19EDD2D_METHOD_1_1531AF6FB28345B4_OFFSET UNITYSDK_OFFSET(0x101BE160)
#define CLASS_1_61CCFA89E19EDD2D_METHOD_1_4ECB529DECFD6AEC_OFFSET UNITYSDK_OFFSET(0x101BCFD0)
#define CLASS_1_61CCFA89E19EDD2D_METHOD_1_5CF5175CFF5F10AC_OFFSET UNITYSDK_OFFSET(0x101BE270)
#define CLASS_1_61CCFA89E19EDD2D_METHOD_1_6CBB61A49BB2C474_OFFSET UNITYSDK_OFFSET(0x101BE500)
#define CLASS_1_61CCFA89E19EDD2D_METHOD_1_745C27D4BCAC384D_OFFSET UNITYSDK_OFFSET(0x101BD120)
#define CLASS_1_61CCFA89E19EDD2D_METHOD_1_8CD3A05EB683B1A7_1_OFFSET UNITYSDK_OFFSET(0x101BE390)
#define CLASS_1_61CCFA89E19EDD2D_METHOD_1_8CD3A05EB683B1A7_OFFSET UNITYSDK_OFFSET(0x101BD850)
#define CLASS_1_61CCFA89E19EDD2D_METHOD_1_AA7047F594B773AE_OFFSET UNITYSDK_OFFSET(0x101BDA00)
#define CLASS_1_61CCFA89E19EDD2D_METHOD_1_B835618663ACD999_OFFSET UNITYSDK_OFFSET(0x101BD310)
#define CLASS_1_61CCFA89E19EDD2D_METHOD_1_EB1B0623B4BDD44D_OFFSET UNITYSDK_OFFSET(0x101BE0B0)
#define CLASS_1_61CCFA89E19EDD2D_METHOD_1_EDA7579EB3F05B46_OFFSET UNITYSDK_OFFSET(0x101BD180)
#define CLASS_1_61CCFA89E19EDD2D_METHOD_1_EF6A3193F3CB74FA_OFFSET UNITYSDK_OFFSET(0x101BD7A0)
#define CLASS_1_61CCFA89E19EDD2D__CCTOR_OFFSET UNITYSDK_OFFSET(0x101BE550)
#define CLASS_1_61CCFA89E19EDD2D__CTOR_OFFSET UNITYSDK_OFFSET(0x101BCD90)

inline static constexpr unsigned int Class_1_61CCFA89E19EDD2D_TypeDefinitionIndex = 68698;
...
public:
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::RPG::GameCore::AvatarPropertyType, ::RPG::GameCore::AvatarPropertyType>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_61CCFA89E19EDD2D_TypeDefinitionIndex)->GetStaticField(0x113C0);
	}
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::RPG::GameCore::AvatarPropertyType, ::RPG::GameCore::AttackDamageType>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_61CCFA89E19EDD2D_TypeDefinitionIndex)->GetStaticField(0x113C8);
	}
	::Class_0_16E4307DCC419505_1045* Field_1_2; // 0x10
	::RPG::GameCore::RelicSubAffixAvatarValueRow* Field_1_4; // 0x18
	::RPG::Client::RelicSmartSuit::MainPropertyMatchChecker* Field_1_5; // 0x20
	::RPG::GameCore::RelicMainAffixAvatarValueRow* Field_1_3; // 0x28
