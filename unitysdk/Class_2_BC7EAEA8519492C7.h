...
#define CLASS_2_BC7EAEA8519492C7_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10A472D0)
#define CLASS_2_BC7EAEA8519492C7_METHOD_2_049407E7CFE73C8B_OFFSET UNITYSDK_OFFSET(0x10A475F0)
#define CLASS_2_BC7EAEA8519492C7_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x10A476A0)
#define CLASS_2_BC7EAEA8519492C7_METHOD_2_FDE09C8D62639E3E_OFFSET UNITYSDK_OFFSET(0x10A47430)
#define CLASS_2_BC7EAEA8519492C7_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10A47310)
#define CLASS_2_BC7EAEA8519492C7_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10A47540)
#define CLASS_2_BC7EAEA8519492C7_TICK_OFFSET UNITYSDK_OFFSET(0x10A47590)
#define CLASS_2_BC7EAEA8519492C7__CTOR_OFFSET UNITYSDK_OFFSET(0x10A472C0)

inline static constexpr unsigned int Class_2_BC7EAEA8519492C7_TypeDefinitionIndex = 45938;

class Class_2_BC7EAEA8519492C7 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::PlayMessage* Field_2_0; // 0x20
