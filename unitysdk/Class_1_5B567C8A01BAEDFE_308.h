...
#define CLASS_1_5B567C8A01BAEDFE_308_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A0AAD10)
#define CLASS_1_5B567C8A01BAEDFE_308_CLONE_OFFSET UNITYSDK_OFFSET(0x1A0AAB80)
#define CLASS_1_5B567C8A01BAEDFE_308_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A0AAC20)
#define CLASS_1_5B567C8A01BAEDFE_308_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A0AABC0)
#define CLASS_1_5B567C8A01BAEDFE_308_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A0AAC70)
#define CLASS_1_5B567C8A01BAEDFE_308_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A0AAD60)
#define CLASS_1_5B567C8A01BAEDFE_308_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A0AAD30)
#define CLASS_1_5B567C8A01BAEDFE_308_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A0AAB00)
#define CLASS_1_5B567C8A01BAEDFE_308_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A0AAB30)
#define CLASS_1_5B567C8A01BAEDFE_308_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A0AACA0)
#define CLASS_1_5B567C8A01BAEDFE_308_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A0AAD00)
#define CLASS_1_5B567C8A01BAEDFE_308__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A0AADB0)
#define CLASS_1_5B567C8A01BAEDFE_308__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0AAB50)
#define CLASS_1_5B567C8A01BAEDFE_308__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0AAB40)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_308*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_308_TypeDefinitionIndex)->GetStaticField(0x1F300);
	}
