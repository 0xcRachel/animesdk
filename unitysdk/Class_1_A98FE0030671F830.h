...
#define CLASS_1_A98FE0030671F830_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19EE9C90)
#define CLASS_1_A98FE0030671F830_CLONE_OFFSET UNITYSDK_OFFSET(0x19EE9870)
#define CLASS_1_A98FE0030671F830_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19EE99C0)
#define CLASS_1_A98FE0030671F830_EQUALS_OFFSET UNITYSDK_OFFSET(0x19EE98D0)
#define CLASS_1_A98FE0030671F830_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19EE9A70)
#define CLASS_1_A98FE0030671F830_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19EE9E60)
#define CLASS_1_A98FE0030671F830_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19EE9DC0)
#define CLASS_1_A98FE0030671F830_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x19EE98B0)
#define CLASS_1_A98FE0030671F830_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19EE9720)
#define CLASS_1_A98FE0030671F830_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x19EE98C0)
#define CLASS_1_A98FE0030671F830_METHOD_1_959BA94B4EE67881_OFFSET UNITYSDK_OFFSET(0x19EE98A0)
#define CLASS_1_A98FE0030671F830_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19EE9750)
#define CLASS_1_A98FE0030671F830_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19EE9B60)
#define CLASS_1_A98FE0030671F830_WRITETO_OFFSET UNITYSDK_OFFSET(0x19EE9BC0)
#define CLASS_1_A98FE0030671F830__CCTOR_OFFSET UNITYSDK_OFFSET(0x19EE9F40)
#define CLASS_1_A98FE0030671F830__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19EE97B0)
#define CLASS_1_A98FE0030671F830__CTOR_OFFSET UNITYSDK_OFFSET(0x19EE9760)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Proto::PlayerSimpleInfo*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A98FE0030671F830_TypeDefinitionIndex)->GetStaticField(0x3E9E0);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_A98FE0030671F830*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_A98FE0030671F830*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A98FE0030671F830_TypeDefinitionIndex)->GetStaticField(0x3E9E8);
	}
