...
#define CLASS_1_F591FD2BDE985BAF_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x18249600)
#define CLASS_1_F591FD2BDE985BAF_CLONE_OFFSET UNITYSDK_OFFSET(0x182492B0)
#define CLASS_1_F591FD2BDE985BAF_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x18249450)
#define CLASS_1_F591FD2BDE985BAF_EQUALS_OFFSET UNITYSDK_OFFSET(0x18249380)
#define CLASS_1_F591FD2BDE985BAF_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x182494F0)
#define CLASS_1_F591FD2BDE985BAF_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x18249740)
#define CLASS_1_F591FD2BDE985BAF_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x18249660)
#define CLASS_1_F591FD2BDE985BAF_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x18249360)
#define CLASS_1_F591FD2BDE985BAF_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x18249370)
#define CLASS_1_F591FD2BDE985BAF_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x18249220)
#define CLASS_1_F591FD2BDE985BAF_TOSTRING_OFFSET UNITYSDK_OFFSET(0x18249540)
#define CLASS_1_F591FD2BDE985BAF_WRITETO_OFFSET UNITYSDK_OFFSET(0x182495A0)
#define CLASS_1_F591FD2BDE985BAF__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18249240)
#define CLASS_1_F591FD2BDE985BAF__CTOR_OFFSET UNITYSDK_OFFSET(0x18249230)
