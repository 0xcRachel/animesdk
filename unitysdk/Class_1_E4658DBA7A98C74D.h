...
#define CLASS_1_E4658DBA7A98C74D_GETSKILLROWDATABYID_OFFSET UNITYSDK_OFFSET(0x8E07BD0)
#define CLASS_1_E4658DBA7A98C74D_GETSKILLROWDATABYNAME_OFFSET UNITYSDK_OFFSET(0x8E07B80)
#define CLASS_1_E4658DBA7A98C74D_GETSKILLROWDATA_OFFSET UNITYSDK_OFFSET(0x8E07AF0)
#define CLASS_1_E4658DBA7A98C74D_GET_ACTIONICONPATH_OFFSET UNITYSDK_OFFSET(0x8E07970)
#define CLASS_1_E4658DBA7A98C74D_GET_AIPATH_OFFSET UNITYSDK_OFFSET(0x8E077F0)
#define CLASS_1_E4658DBA7A98C74D_GET_AVATARSIDEICONPATH_OFFSET UNITYSDK_OFFSET(0x8E079E0)
#define CLASS_1_E4658DBA7A98C74D_GET_CHARACTERNAME_OFFSET UNITYSDK_OFFSET(0x8E078F0)
#define CLASS_1_E4658DBA7A98C74D_GET_CONFIGID_OFFSET UNITYSDK_OFFSET(0x8E077B0)
#define CLASS_1_E4658DBA7A98C74D_GET_DAMAGETYPERESISTANCE_OFFSET UNITYSDK_OFFSET(0x8E07890)
#define CLASS_1_E4658DBA7A98C74D_GET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0x8E07870)
#define CLASS_1_E4658DBA7A98C74D_GET_HAVEACTIONDELAY_OFFSET UNITYSDK_OFFSET(0x8E078D0)
#define CLASS_1_E4658DBA7A98C74D_GET_HEADICONPATH_OFFSET UNITYSDK_OFFSET(0x8E07950)
#define CLASS_1_E4658DBA7A98C74D_GET_INTRODUCTION_OFFSET UNITYSDK_OFFSET(0x8E07910)
#define CLASS_1_E4658DBA7A98C74D_GET_JSONPATH_OFFSET UNITYSDK_OFFSET(0x8E077D0)
#define CLASS_1_E4658DBA7A98C74D_GET_JSON_OFFSET UNITYSDK_OFFSET(0x8E07790)
#define CLASS_1_E4658DBA7A98C74D_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x8E07810)
#define CLASS_1_E4658DBA7A98C74D_GET_MODELPATH_OFFSET UNITYSDK_OFFSET(0x8E07930)
#define CLASS_1_E4658DBA7A98C74D_GET_NATUREID_OFFSET UNITYSDK_OFFSET(0x8E07850)
#define CLASS_1_E4658DBA7A98C74D_GET_ROUNDICONPATH_OFFSET UNITYSDK_OFFSET(0x8E079D0)
#define CLASS_1_E4658DBA7A98C74D_GET_ROW_OFFSET UNITYSDK_OFFSET(0x8E07770)
#define CLASS_1_E4658DBA7A98C74D_GET_SIDEAVATARHEADICONPATH_OFFSET UNITYSDK_OFFSET(0x8E07990)
#define CLASS_1_E4658DBA7A98C74D_GET_SKILLROWDATAS_OFFSET UNITYSDK_OFFSET(0x8E07830)
#define CLASS_1_E4658DBA7A98C74D_GET_SOMATOTYPE_OFFSET UNITYSDK_OFFSET(0x8E079F0)
#define CLASS_1_E4658DBA7A98C74D_GET_SPNEED_OFFSET UNITYSDK_OFFSET(0x8E078B0)
#define CLASS_1_E4658DBA7A98C74D_GET_WAITINGAVATARHEADICONPATH_OFFSET UNITYSDK_OFFSET(0x8E079B0)
#define CLASS_1_E4658DBA7A98C74D_OVERRIDEDATA_OFFSET UNITYSDK_OFFSET(0x8E07A90)
#define CLASS_1_E4658DBA7A98C74D_OVERRIDEDISPLAY_OFFSET UNITYSDK_OFFSET(0x8E07A10)
#define CLASS_1_E4658DBA7A98C74D_SET_ACTIONICONPATH_OFFSET UNITYSDK_OFFSET(0x8E07980)
#define CLASS_1_E4658DBA7A98C74D_SET_AIPATH_OFFSET UNITYSDK_OFFSET(0x8E07800)
#define CLASS_1_E4658DBA7A98C74D_SET_CHARACTERNAME_OFFSET UNITYSDK_OFFSET(0x8E07900)
#define CLASS_1_E4658DBA7A98C74D_SET_CONFIGID_OFFSET UNITYSDK_OFFSET(0x8E077C0)
#define CLASS_1_E4658DBA7A98C74D_SET_DAMAGETYPERESISTANCE_OFFSET UNITYSDK_OFFSET(0x8E078A0)
#define CLASS_1_E4658DBA7A98C74D_SET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0x8E07880)
#define CLASS_1_E4658DBA7A98C74D_SET_HAVEACTIONDELAY_OFFSET UNITYSDK_OFFSET(0x8E078E0)
#define CLASS_1_E4658DBA7A98C74D_SET_HEADICONPATH_OFFSET UNITYSDK_OFFSET(0x8E07960)
#define CLASS_1_E4658DBA7A98C74D_SET_INTRODUCTION_OFFSET UNITYSDK_OFFSET(0x8E07920)
#define CLASS_1_E4658DBA7A98C74D_SET_JSONPATH_OFFSET UNITYSDK_OFFSET(0x8E077E0)
#define CLASS_1_E4658DBA7A98C74D_SET_JSON_OFFSET UNITYSDK_OFFSET(0x8E077A0)
#define CLASS_1_E4658DBA7A98C74D_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x8E07820)
#define CLASS_1_E4658DBA7A98C74D_SET_MODELPATH_OFFSET UNITYSDK_OFFSET(0x8E07940)
#define CLASS_1_E4658DBA7A98C74D_SET_NATUREID_OFFSET UNITYSDK_OFFSET(0x8E07860)
#define CLASS_1_E4658DBA7A98C74D_SET_ROW_OFFSET UNITYSDK_OFFSET(0x8E07780)
#define CLASS_1_E4658DBA7A98C74D_SET_SIDEAVATARHEADICONPATH_OFFSET UNITYSDK_OFFSET(0x8E079A0)
#define CLASS_1_E4658DBA7A98C74D_SET_SKILLROWDATAS_OFFSET UNITYSDK_OFFSET(0x8E07840)
#define CLASS_1_E4658DBA7A98C74D_SET_SOMATOTYPE_OFFSET UNITYSDK_OFFSET(0x8E07A00)
#define CLASS_1_E4658DBA7A98C74D_SET_SPNEED_OFFSET UNITYSDK_OFFSET(0x8E078C0)
#define CLASS_1_E4658DBA7A98C74D_SET_WAITINGAVATARHEADICONPATH_OFFSET UNITYSDK_OFFSET(0x8E079C0)
#define CLASS_1_E4658DBA7A98C74D__CTOR_OFFSET UNITYSDK_OFFSET(0x8E076F0)
...
public:
	...
	::RPG::GameCore::CharacterConfig* _Json_k__BackingField; // 0x20
	::System::String* _WaitingAvatarHeadIconPath_k__BackingField; // 0x28
	::System::Collections::Generic::List_1<::RPG::GameCore::ICharacterSkillRowData*>* _SkillRowDatas_k__BackingField; // 0x30
	::System::Object* _Row_k__BackingField; // 0x38
	::System::String* _SideAvatarHeadIconPath_k__BackingField; // 0x40
	::System::String* _AIPath_k__BackingField; // 0x48
	...
	::System::UInt32 _NatureID_k__BackingField; // 0x6C
	::RPG::Client::TextID _CharacterName_k__BackingField; // 0x70
	...
	::System::Boolean _HaveActionDelay_k__BackingField; // 0x9C
	::System::UInt32 _Level_k__BackingField; // 0xA0
	::RPG::GameCore::AttackDamageType _DamageType_k__BackingField; // 0xA4
