...
#define AKBANK_AWAKE_OFFSET UNITYSDK_OFFSET(0x18BA6700)
#define AKBANK_GET_BANKNAME_OFFSET UNITYSDK_OFFSET(0x18BA6CD0)
#define AKBANK_GET_VALUEGUID_OFFSET UNITYSDK_OFFSET(0x18BA6D60)
#define AKBANK_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x18BA6A40)
#define AKBANK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18BA6BF0)
#define AKBANK_START_OFFSET UNITYSDK_OFFSET(0x18BA67A0)
#define AKBANK_UNLOADBANK_OFFSET UNITYSDK_OFFSET(0x18BA6950)
#define AKBANK__CTOR_OFFSET UNITYSDK_OFFSET(0x18BA6EA0)
#define AKBANK___IFIXBASEPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0x18BA6FC0)
#define AKBANK___IFIXBASEPROXY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18BA7070)
#define AKBANK___IFIXBASEPROXY_START_OFFSET UNITYSDK_OFFSET(0x18BA6FD0)
