...
#define CLASS_2_68095187325161DE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xFEE64F0)
#define CLASS_2_68095187325161DE_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xFEE6590)
#define CLASS_2_68095187325161DE_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xFEE65E0)
#define CLASS_2_68095187325161DE_TICK_OFFSET UNITYSDK_OFFSET(0xFEE6530)
#define CLASS_2_68095187325161DE__CTOR_OFFSET UNITYSDK_OFFSET(0xFEE64E0)

inline static constexpr unsigned int Class_2_68095187325161DE_TypeDefinitionIndex = 41411;

class Class_2_68095187325161DE : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::AdvNpcSearchProp* Field_2_0; // 0x20
