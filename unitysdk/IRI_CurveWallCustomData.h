...
#define IRI_CURVEWALLCUSTOMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x10ADAE20)

inline static constexpr unsigned int IRI_CurveWallCustomData_TypeDefinitionIndex = 37120;
