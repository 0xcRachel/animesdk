...
#define CLASS_2_C189FC086B495A1E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10C2CED0)
#define CLASS_2_C189FC086B495A1E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10C2CF10)
#define CLASS_2_C189FC086B495A1E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10C2D240)
#define CLASS_2_C189FC086B495A1E_TICK_OFFSET UNITYSDK_OFFSET(0x10C2D290)
#define CLASS_2_C189FC086B495A1E__CTOR_OFFSET UNITYSDK_OFFSET(0x10C2CEA0)

inline static constexpr unsigned int Class_2_C189FC086B495A1E_TypeDefinitionIndex = 43515;

class Class_2_C189FC086B495A1E : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::StackProperty* Field_2_0; // 0x18
