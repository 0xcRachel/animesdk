...
#define AKIOSSETTINGS_GETADVANCEDSETTINGS_OFFSET UNITYSDK_OFFSET(0x18424F30)
#define AKIOSSETTINGS_GETCOMMSSETTINGS_OFFSET UNITYSDK_OFFSET(0x18424F70)
#define AKIOSSETTINGS_GETUSERSETTINGS_OFFSET UNITYSDK_OFFSET(0x18424EF0)
#define AKIOSSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x18424D80)

inline static constexpr unsigned int AkiOSSettings_TypeDefinitionIndex = 33649;
