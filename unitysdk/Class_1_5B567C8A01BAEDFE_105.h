...
#define CLASS_1_5B567C8A01BAEDFE_105_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A2E7CD0)
#define CLASS_1_5B567C8A01BAEDFE_105_CLONE_OFFSET UNITYSDK_OFFSET(0x1A2E7B40)
#define CLASS_1_5B567C8A01BAEDFE_105_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A2E7BE0)
#define CLASS_1_5B567C8A01BAEDFE_105_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A2E7B80)
#define CLASS_1_5B567C8A01BAEDFE_105_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A2E7C30)
#define CLASS_1_5B567C8A01BAEDFE_105_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A2E7D20)
#define CLASS_1_5B567C8A01BAEDFE_105_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A2E7CF0)
#define CLASS_1_5B567C8A01BAEDFE_105_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A2E7AC0)
#define CLASS_1_5B567C8A01BAEDFE_105_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A2E7AF0)
#define CLASS_1_5B567C8A01BAEDFE_105_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A2E7C60)
#define CLASS_1_5B567C8A01BAEDFE_105_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A2E7CC0)
#define CLASS_1_5B567C8A01BAEDFE_105__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A2E7D70)
#define CLASS_1_5B567C8A01BAEDFE_105__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A2E7B10)
#define CLASS_1_5B567C8A01BAEDFE_105__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2E7B00)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_105*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_105_TypeDefinitionIndex)->GetStaticField(0x4060);
	}
