...
#define CLASS_1_5B567C8A01BAEDFE_105_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1B25C530)
#define CLASS_1_5B567C8A01BAEDFE_105_CLONE_OFFSET UNITYSDK_OFFSET(0x1B25C340)
#define CLASS_1_5B567C8A01BAEDFE_105_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1B25C440)
#define CLASS_1_5B567C8A01BAEDFE_105_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B25C3B0)
#define CLASS_1_5B567C8A01BAEDFE_105_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B25C490)
#define CLASS_1_5B567C8A01BAEDFE_105_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1B25C580)
#define CLASS_1_5B567C8A01BAEDFE_105_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1B25C550)
#define CLASS_1_5B567C8A01BAEDFE_105_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1B25C290)
#define CLASS_1_5B567C8A01BAEDFE_105_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1B25C2F0)
#define CLASS_1_5B567C8A01BAEDFE_105_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B25C4C0)
#define CLASS_1_5B567C8A01BAEDFE_105_WRITETO_OFFSET UNITYSDK_OFFSET(0x1B25C520)
#define CLASS_1_5B567C8A01BAEDFE_105__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B25C5D0)
#define CLASS_1_5B567C8A01BAEDFE_105__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B25C310)
#define CLASS_1_5B567C8A01BAEDFE_105__CTOR_OFFSET UNITYSDK_OFFSET(0x1B25C300)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_105*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_105_TypeDefinitionIndex)->GetStaticField(0x392F0);
	}
