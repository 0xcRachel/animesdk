...
#define CLASS_1_5B567C8A01BAEDFE_79_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A2E5DD0)
#define CLASS_1_5B567C8A01BAEDFE_79_CLONE_OFFSET UNITYSDK_OFFSET(0x1A3F5C10)
#define CLASS_1_5B567C8A01BAEDFE_79_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A3F5D10)
#define CLASS_1_5B567C8A01BAEDFE_79_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A3F5C80)
#define CLASS_1_5B567C8A01BAEDFE_79_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A3F5D60)
#define CLASS_1_5B567C8A01BAEDFE_79_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A2E5E20)
#define CLASS_1_5B567C8A01BAEDFE_79_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A2E5DF0)
#define CLASS_1_5B567C8A01BAEDFE_79_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A3F5B60)
#define CLASS_1_5B567C8A01BAEDFE_79_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A3F5BC0)
#define CLASS_1_5B567C8A01BAEDFE_79_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A3F5D90)
#define CLASS_1_5B567C8A01BAEDFE_79_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A2E5DC0)
#define CLASS_1_5B567C8A01BAEDFE_79__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A2E5E70)
#define CLASS_1_5B567C8A01BAEDFE_79__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3F5BE0)
#define CLASS_1_5B567C8A01BAEDFE_79__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3F5BD0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_79*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_79_TypeDefinitionIndex)->GetStaticField(0x17E0);
	}
