...
#define BAMASKLAYERGRAPH_GET_OFFSET UNITYSDK_OFFSET(0x16A6B460)
#define BAMASKLAYERGRAPH_INIT_OFFSET UNITYSDK_OFFSET(0x16A6B310)
#define BAMASKLAYERGRAPH__CTOR_OFFSET UNITYSDK_OFFSET(0x16A6B470)
