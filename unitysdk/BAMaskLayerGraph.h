...
#define BAMASKLAYERGRAPH_GETGRAPH_OFFSET UNITYSDK_OFFSET(0x1523D630)
#define BAMASKLAYERGRAPH_GET_OFFSET UNITYSDK_OFFSET(0x1523D4D0)
#define BAMASKLAYERGRAPH_INIT_OFFSET UNITYSDK_OFFSET(0x1523D320)
#define BAMASKLAYERGRAPH_PLAYCLIP_OFFSET UNITYSDK_OFFSET(0x1523D4E0)
#define BAMASKLAYERGRAPH__CTOR_OFFSET UNITYSDK_OFFSET(0x1523D310)
...
public:
	...
	{
		return (::BAMaskLayerGraph**)Il2CppClass::FromTypeDefinitionIndex(BAMaskLayerGraph_TypeDefinitionIndex)->GetStaticField(0x5D700);
	}
