...
#define PLANETSCCONTROL_CLEARRENDERERS_OFFSET UNITYSDK_OFFSET(0x8A2B640)
#define PLANETSCCONTROL_COLLECTRENDERERS_OFFSET UNITYSDK_OFFSET(0x8A2B530)
#define PLANETSCCONTROL_STARTCLIP_OFFSET UNITYSDK_OFFSET(0x8A2B6B0)
#define PLANETSCCONTROL_STOPCLIP_OFFSET UNITYSDK_OFFSET(0x8A2B930)
#define PLANETSCCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0x8A2B070)
#define PLANETSCCONTROL__CCTOR_OFFSET UNITYSDK_OFFSET(0x8A2BBF0)
#define PLANETSCCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x8A2BB90)

inline static constexpr unsigned int PLaneTSCControl_TypeDefinitionIndex = 37223;
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PLaneTSCControl_TypeDefinitionIndex)->GetStaticField(0x3060);
	}
	static ::System::Int32* StaticGet_Field_5_7()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PLaneTSCControl_TypeDefinitionIndex)->GetStaticField(0x3064);
	}
	static ::System::Int32* StaticGet_Field_5_6()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PLaneTSCControl_TypeDefinitionIndex)->GetStaticField(0x3068);
	}
	static ::System::Int32* StaticGet_Field_5_8()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PLaneTSCControl_TypeDefinitionIndex)->GetStaticField(0x306C);
	}
