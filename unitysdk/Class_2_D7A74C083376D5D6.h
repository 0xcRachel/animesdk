...
#define CLASS_2_D7A74C083376D5D6_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAD63170)
#define CLASS_2_D7A74C083376D5D6_GET_OVERRIDELINEARMOVEMENTAUTODIRECTION_OFFSET UNITYSDK_OFFSET(0xAD65990)
#define CLASS_2_D7A74C083376D5D6_METHOD_2_2058ECBCF6D9089D_OFFSET UNITYSDK_OFFSET(0xAD64A00)
#define CLASS_2_D7A74C083376D5D6_METHOD_2_36E47868EF373D40_OFFSET UNITYSDK_OFFSET(0xAD63970)
#define CLASS_2_D7A74C083376D5D6_METHOD_2_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xAD64980)
#define CLASS_2_D7A74C083376D5D6_METHOD_2_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0xAD64AE0)
#define CLASS_2_D7A74C083376D5D6_METHOD_2_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0xAD64B40)
#define CLASS_2_D7A74C083376D5D6_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xAD64910)
#define CLASS_2_D7A74C083376D5D6_METHOD_2_47FCE72550F759BF_OFFSET UNITYSDK_OFFSET(0xAD64560)
#define CLASS_2_D7A74C083376D5D6_METHOD_2_5FAD56E9E208220A_OFFSET UNITYSDK_OFFSET(0xAD63340)
#define CLASS_2_D7A74C083376D5D6_METHOD_2_775B6D644F07B554_OFFSET UNITYSDK_OFFSET(0xAD632C0)
#define CLASS_2_D7A74C083376D5D6_METHOD_2_8339EF96C271882B_OFFSET UNITYSDK_OFFSET(0xAD64680)
#define CLASS_2_D7A74C083376D5D6_METHOD_2_84BC49D56C1AFB9E_OFFSET UNITYSDK_OFFSET(0xAD64DE0)
#define CLASS_2_D7A74C083376D5D6_METHOD_2_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0xAD641C0)
#define CLASS_2_D7A74C083376D5D6_METHOD_2_8C4AEC0BC1CA0CB4_OFFSET UNITYSDK_OFFSET(0xAD63C10)
#define CLASS_2_D7A74C083376D5D6_METHOD_2_BB2928BEC244DEB7_OFFSET UNITYSDK_OFFSET(0xAD64850)
#define CLASS_2_D7A74C083376D5D6_METHOD_2_DF7A42235624D777_OFFSET UNITYSDK_OFFSET(0xAD635B0)
#define CLASS_2_D7A74C083376D5D6_METHOD_2_E9A575D18A0748D9_1_OFFSET UNITYSDK_OFFSET(0xAD64A70)
#define CLASS_2_D7A74C083376D5D6_METHOD_2_E9A575D18A0748D9_OFFSET UNITYSDK_OFFSET(0xAD648A0)
#define CLASS_2_D7A74C083376D5D6_METHOD_2_EC4D30408A2C6900_OFFSET UNITYSDK_OFFSET(0xAD64BE0)
#define CLASS_2_D7A74C083376D5D6_METHOD_2_EC61075536D10822_1_OFFSET UNITYSDK_OFFSET(0xAD64790)
#define CLASS_2_D7A74C083376D5D6_METHOD_2_EC61075536D10822_OFFSET UNITYSDK_OFFSET(0xAD64720)
#define CLASS_2_D7A74C083376D5D6_METHOD_2_EC6CE26AB4985D28_OFFSET UNITYSDK_OFFSET(0xAD64800)
#define CLASS_2_D7A74C083376D5D6_METHOD_2_F8B73ECE7F883AC1_1_OFFSET UNITYSDK_OFFSET(0xAD64630)
#define CLASS_2_D7A74C083376D5D6_METHOD_2_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0xAD645E0)
#define CLASS_2_D7A74C083376D5D6_ONMODELROOTLOADED_OFFSET UNITYSDK_OFFSET(0xAD636A0)
#define CLASS_2_D7A74C083376D5D6_ONMODELROOTUNLOADED_OFFSET UNITYSDK_OFFSET(0xAD63760)
#define CLASS_2_D7A74C083376D5D6_SET_OVERRIDELINEARMOVEMENTAUTODIRECTION_OFFSET UNITYSDK_OFFSET(0xAD659A0)
#define CLASS_2_D7A74C083376D5D6_TICK_OFFSET UNITYSDK_OFFSET(0xAD637A0)
#define CLASS_2_D7A74C083376D5D6__CTOR_OFFSET UNITYSDK_OFFSET(0xAD659B0)
#define CLASS_2_D7A74C083376D5D6___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0xAD65A40)
...
public:
	...
	::Class_1_EA9900AFB4A38403* Field_2_1; // 0x20
	::Class_1_9BA88018AC303C05* Field_2_8; // 0x28
	::Class_1_8B172FAD11DD4BB5* Field_2_7; // 0x30
	::Class_1_07596D96EDE271F3* Field_2_6; // 0x38
	::Class_1_C4C2ACF3D9655BEA_27* Field_2_9; // 0x40
	::Class_1_6DE8726ADEF173A7_7* Field_2_15; // 0x48
	::Class_1_58605927BBE9A4A2* Field_2_5; // 0x50
	::RPG::GameCore::CharacterModelComponent* Field_2_3; // 0x58
	::RPG::GameCore::TransformComponent* Field_2_4; // 0x60
	::System::Func_4<::UnityEngine::Vector3, ::System::Single, ::System::Single, ::UnityEngine::Vector3>* _OverrideLinearMovementAutoDirection_k__BackingField; // 0x68
	::System::Single Field_2_11; // 0x70
	::UnityEngine::Vector3 Field_2_19; // 0x74
	::System::Single Field_2_16; // 0x80
	::System::Single Field_2_14; // 0x84
	::RPG::GameCore::AdvCharacterFloatingState Field_2_10; // 0x88
	::UnityEngine::Vector3 Field_2_20; // 0x8C
	::System::Int32 Field_2_21; // 0x98
	::UnityEngine::Quaternion Field_2_18; // 0x9C
	::System::Single Field_2_13; // 0xAC
	::RPG::GameCore::AdvCharacterRotationState Field_2_17; // 0xB0
	::UnityEngine::Vector3 Field_2_12; // 0xB4
