...
#define CLASS_3_EECDAEEEADAB2602_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8AA3A10)
#define CLASS_3_EECDAEEEADAB2602_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x8AA3910)
#define CLASS_3_EECDAEEEADAB2602_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x8AA39C0)
#define CLASS_3_EECDAEEEADAB2602_TICK_OFFSET UNITYSDK_OFFSET(0x8AA3960)
#define CLASS_3_EECDAEEEADAB2602__CTOR_OFFSET UNITYSDK_OFFSET(0x8AA3890)
#define CLASS_3_EECDAEEEADAB2602___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8AA3B40)
#define CLASS_3_EECDAEEEADAB2602___IFIXBASEPROXY_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x8AA3A50)
#define CLASS_3_EECDAEEEADAB2602___IFIXBASEPROXY_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x8AA3AD0)
#define CLASS_3_EECDAEEEADAB2602___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x8AA3A60)
