...
#define SOFTBODYIK_ADDFORCE_1_OFFSET UNITYSDK_OFFSET(0x17771230)
#define SOFTBODYIK_ADDFORCE_OFFSET UNITYSDK_OFFSET(0x17770ED0)
#define SOFTBODYIK_CHECKCURRENTOFFSET_OFFSET UNITYSDK_OFFSET(0x17771DB0)
#define SOFTBODYIK_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1776DD50)
#define SOFTBODYIK_METHOD_5_15EF20217BD059DF_OFFSET UNITYSDK_OFFSET(0x1776E4B0)
#define SOFTBODYIK_METHOD_5_19FB5FBEA9EA66CD_OFFSET UNITYSDK_OFFSET(0x1776CEE0)
#define SOFTBODYIK_METHOD_5_3FD6E53B47B68444_OFFSET UNITYSDK_OFFSET(0x177712C0)
#define SOFTBODYIK_METHOD_5_5362541F0053C52B_OFFSET UNITYSDK_OFFSET(0x1776E200)
#define SOFTBODYIK_METHOD_5_97E6634148C1D535_OFFSET UNITYSDK_OFFSET(0x1776FDB0)
#define SOFTBODYIK_METHOD_5_A9B660A656DA65E2_OFFSET UNITYSDK_OFFSET(0x1776E940)
#define SOFTBODYIK_METHOD_5_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x1776DF30)
#define SOFTBODYIK_METHOD_5_B80705A944339AA3_1_OFFSET UNITYSDK_OFFSET(0x1776F510)
#define SOFTBODYIK_METHOD_5_B80705A944339AA3_OFFSET UNITYSDK_OFFSET(0x17770690)
#define SOFTBODYIK_METHOD_5_BB881F05E41D3A04_OFFSET UNITYSDK_OFFSET(0x17770CD0)
#define SOFTBODYIK_METHOD_5_D3A7E03DEF3D4859_OFFSET UNITYSDK_OFFSET(0x1776EB50)
#define SOFTBODYIK_METHOD_5_EB49B73DCCB74433_OFFSET UNITYSDK_OFFSET(0x1776F2C0)
#define SOFTBODYIK_REINITIALIZE_OFFSET UNITYSDK_OFFSET(0x17771BC0)
#define SOFTBODYIK_RESETTOORIGINALSTATE_OFFSET UNITYSDK_OFFSET(0x17771710)
#define SOFTBODYIK_START_OFFSET UNITYSDK_OFFSET(0x1776CE90)
#define SOFTBODYIK_TESTFORCE_OFFSET UNITYSDK_OFFSET(0x17771C10)
#define SOFTBODYIK__CTOR_OFFSET UNITYSDK_OFFSET(0x17772C20)
