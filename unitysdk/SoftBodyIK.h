...
#define SOFTBODYIK_ADDFORCE_1_OFFSET UNITYSDK_OFFSET(0xA69C270)
#define SOFTBODYIK_ADDFORCE_OFFSET UNITYSDK_OFFSET(0xA69BF40)
#define SOFTBODYIK_CHECKCURRENTOFFSET_OFFSET UNITYSDK_OFFSET(0xA69CDC0)
#define SOFTBODYIK_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA699260)
#define SOFTBODYIK_METHOD_5_189B2BC70D05DE79_OFFSET UNITYSDK_OFFSET(0xA699F30)
#define SOFTBODYIK_METHOD_5_39B6E81BBB7CC0F7_OFFSET UNITYSDK_OFFSET(0xA699D40)
#define SOFTBODYIK_METHOD_5_673B7BCE3283FF95_OFFSET UNITYSDK_OFFSET(0xA69A7F0)
#define SOFTBODYIK_METHOD_5_7646FFE662147970_OFFSET UNITYSDK_OFFSET(0xA69BCF0)
#define SOFTBODYIK_METHOD_5_781FB24C8A9DE8B9_OFFSET UNITYSDK_OFFSET(0xA69A5F0)
#define SOFTBODYIK_METHOD_5_821BBDC04720A2EB_OFFSET UNITYSDK_OFFSET(0xA6986A0)
#define SOFTBODYIK_METHOD_5_8FDC33984A9371EE_OFFSET UNITYSDK_OFFSET(0xA699710)
#define SOFTBODYIK_METHOD_5_9448775AA0E0FFD8_OFFSET UNITYSDK_OFFSET(0xA69C300)
#define SOFTBODYIK_METHOD_5_A2454B6423FF9D24_OFFSET UNITYSDK_OFFSET(0xA699970)
#define SOFTBODYIK_METHOD_5_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xA699440)
#define SOFTBODYIK_METHOD_5_E2C8B6E510DEC188_OFFSET UNITYSDK_OFFSET(0xA69AF90)
#define SOFTBODYIK_METHOD_5_EE0B6EBDD7D8196C_OFFSET UNITYSDK_OFFSET(0xA69B790)
#define SOFTBODYIK_REINITIALIZE_OFFSET UNITYSDK_OFFSET(0xA69CBD0)
#define SOFTBODYIK_RESETTOORIGINALSTATE_OFFSET UNITYSDK_OFFSET(0xA69C6E0)
#define SOFTBODYIK_START_OFFSET UNITYSDK_OFFSET(0xA698650)
#define SOFTBODYIK_TESTFORCE_OFFSET UNITYSDK_OFFSET(0xA69CC20)
#define SOFTBODYIK__CTOR_OFFSET UNITYSDK_OFFSET(0xA69DA20)

inline static constexpr unsigned int SoftBodyIK_TypeDefinitionIndex = 37204;
