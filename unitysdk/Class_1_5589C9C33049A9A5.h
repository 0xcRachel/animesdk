...
#define CLASS_1_5589C9C33049A9A5_METHOD_1_0249E77AF44118ED_OFFSET UNITYSDK_OFFSET(0xD3E6440)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_06F7ACE9FB1C8082_OFFSET UNITYSDK_OFFSET(0xD3E5AE0)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_0C65D29C3029253B_OFFSET UNITYSDK_OFFSET(0xD3EA3D0)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_0DD4E0EFA987B972_OFFSET UNITYSDK_OFFSET(0xD3E70F0)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_0E8FD277F344B6A3_OFFSET UNITYSDK_OFFSET(0xD3E4190)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_1161B0E93F7E44AD_OFFSET UNITYSDK_OFFSET(0xD3E0D60)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_13230F274612BEE7_OFFSET UNITYSDK_OFFSET(0xD3DEC00)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_1E22BCFEBD868CE1_OFFSET UNITYSDK_OFFSET(0xD3EB010)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_2C4CA79B306A10BC_1_OFFSET UNITYSDK_OFFSET(0xD3E42E0)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_2C4CA79B306A10BC_OFFSET UNITYSDK_OFFSET(0xD3E40F0)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_2D5BAC6A9C01B54E_OFFSET UNITYSDK_OFFSET(0xD3EB4A0)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_3265B427FAD2DFA4_OFFSET UNITYSDK_OFFSET(0xD3EA150)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_34D62C3A30DB2CCC_OFFSET UNITYSDK_OFFSET(0xD3E8B00)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_389DD77D46E62BA5_OFFSET UNITYSDK_OFFSET(0xD3DF100)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_40E67CBB89CCD844_OFFSET UNITYSDK_OFFSET(0xD3E13A0)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_5583457303B61230_OFFSET UNITYSDK_OFFSET(0xD3E02C0)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_59CED54B012B9E98_OFFSET UNITYSDK_OFFSET(0xD3DE800)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_5BF933E10BDAEED5_OFFSET UNITYSDK_OFFSET(0xD3EACC0)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_5D6318C6D37F3318_OFFSET UNITYSDK_OFFSET(0xD3E5550)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_627D67C0054186C7_1_OFFSET UNITYSDK_OFFSET(0xD3E1200)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_627D67C0054186C7_OFFSET UNITYSDK_OFFSET(0xD3E0BC0)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_64234880CE869987_OFFSET UNITYSDK_OFFSET(0xD3E5220)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_68F4C7AD8B57681F_OFFSET UNITYSDK_OFFSET(0xD3E8A60)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_6A01BE48CAE79AE4_OFFSET UNITYSDK_OFFSET(0xD3E3700)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_6BE01179B6313199_1_OFFSET UNITYSDK_OFFSET(0xD3E3000)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_6BE01179B6313199_OFFSET UNITYSDK_OFFSET(0xD3E2A10)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_75BF251FCFD511C3_OFFSET UNITYSDK_OFFSET(0xD3E8E00)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_75F20E3AAA4A1CEF_OFFSET UNITYSDK_OFFSET(0xD3E6930)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_76060C53AC0F1320_OFFSET UNITYSDK_OFFSET(0xD3E61D0)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_781B28964D24BF78_OFFSET UNITYSDK_OFFSET(0xD3E4960)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_804A559216BD71FA_OFFSET UNITYSDK_OFFSET(0xD3E4EF0)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_810DD818C57F797D_OFFSET UNITYSDK_OFFSET(0xD3EC070)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_81A00FB59F21F39A_OFFSET UNITYSDK_OFFSET(0xD3E1450)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_828B3C0B74DFB8A6_OFFSET UNITYSDK_OFFSET(0xD3E3A20)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_88E6494389A0E18D_OFFSET UNITYSDK_OFFSET(0xD3E01E0)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_8C4201C4170903FB_OFFSET UNITYSDK_OFFSET(0xD3E5830)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_8D5A30D3C3C72786_OFFSET UNITYSDK_OFFSET(0xD3E8D30)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_918BDEB5630729B9_OFFSET UNITYSDK_OFFSET(0xD3EB180)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_93D4E4DEF7053F03_OFFSET UNITYSDK_OFFSET(0xD3E5400)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_9A905A114E858EC9_1_OFFSET UNITYSDK_OFFSET(0xD3E1320)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_9A905A114E858EC9_OFFSET UNITYSDK_OFFSET(0xD3E0CE0)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_9B78EADB6CBA8DA3_OFFSET UNITYSDK_OFFSET(0xD3E0460)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_9FCC4062A872D255_OFFSET UNITYSDK_OFFSET(0xD3EAF80)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_A0CD5E82FD180A5C_OFFSET UNITYSDK_OFFSET(0xD3E6080)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_A1F90F4B49B60010_OFFSET UNITYSDK_OFFSET(0xD3DEF00)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_A21CCBFEF665AE17_OFFSET UNITYSDK_OFFSET(0xD3E35F0)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_A54AFA66C2AE094E_OFFSET UNITYSDK_OFFSET(0xD3E1CB0)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_A703BEBEEBA84608_OFFSET UNITYSDK_OFFSET(0xD3DEFB0)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_ACDD43AD9148F1AD_OFFSET UNITYSDK_OFFSET(0xD3E1EE0)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_AF81BE78BA8873E2_OFFSET UNITYSDK_OFFSET(0xD3E0640)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_B7033E01C594201D_OFFSET UNITYSDK_OFFSET(0xD3E4380)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_B8363C17988CF476_OFFSET UNITYSDK_OFFSET(0xD3EC270)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_BB80D5CDCCF2A751_OFFSET UNITYSDK_OFFSET(0xD3E0F90)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_C3FCFEB83374757C_OFFSET UNITYSDK_OFFSET(0xD3E0B10)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_CAAF4F77CA410C4E_OFFSET UNITYSDK_OFFSET(0xD3E5CF0)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_CADC01A61694D7BE_OFFSET UNITYSDK_OFFSET(0xD3E17A0)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_CB14CB246A68B57D_OFFSET UNITYSDK_OFFSET(0xD3E1A10)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_CBC4BAA742E57AED_OFFSET UNITYSDK_OFFSET(0xD3E5760)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_D3CDDBF95A81E584_OFFSET UNITYSDK_OFFSET(0xD3E28D0)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_DA30A0B05EC94CB6_OFFSET UNITYSDK_OFFSET(0xD3DDB40)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_DA42C4445A7680B5_OFFSET UNITYSDK_OFFSET(0xD3EA830)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_DD75D6BA34547DEF_OFFSET UNITYSDK_OFFSET(0xD3E6BC0)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_EA0BA3E4AF50C583_OFFSET UNITYSDK_OFFSET(0xD3EB980)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_EDACF3D84F32DDEF_OFFSET UNITYSDK_OFFSET(0xD3E27D0)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xD3EC260)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_F026F9F94BAA5E1F_OFFSET UNITYSDK_OFFSET(0xD3EB110)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_F1A21F6053A7E0EC_OFFSET UNITYSDK_OFFSET(0xD3E7E10)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_F23402A6EF26F0BB_OFFSET UNITYSDK_OFFSET(0xD3E6DE0)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_F63FE1AA9633F811_OFFSET UNITYSDK_OFFSET(0xD3EB530)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_FAC31CE5A7DA4972_OFFSET UNITYSDK_OFFSET(0xD3DE8F0)
#define CLASS_1_5589C9C33049A9A5_METHOD_1_FC1FE8EE78A25012_OFFSET UNITYSDK_OFFSET(0xD3EB3F0)
#define CLASS_1_5589C9C33049A9A5__CCTOR_OFFSET UNITYSDK_OFFSET(0xD3EC530)
#define CLASS_1_5589C9C33049A9A5__CTOR_OFFSET UNITYSDK_OFFSET(0xD3DD8C0)

inline static constexpr unsigned int Class_1_5589C9C33049A9A5_TypeDefinitionIndex = 70459;
...
public:
	...
	{
		return (::System::Collections::Generic::List_1<::Class_2_1A8148841049062A*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5589C9C33049A9A5_TypeDefinitionIndex)->GetStaticField(0x6AB50);
	}
	static ::System::Collections::Generic::List_1<::Class_2_1A8148841049062A*>** StaticGet_Field_1_0()
	{
		return (::System::Collections::Generic::List_1<::Class_2_1A8148841049062A*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5589C9C33049A9A5_TypeDefinitionIndex)->GetStaticField(0x6AB58);
	}
	...
	::Class_3_D6E9A038FA23103A* Field_1_4; // 0x18
	::System::Collections::Generic::Dictionary_2<::RPG::Client::LittleGame::FourRotateVoxel::FourRotateVoxelGameView*, ::RPG::Client::LittleGame::FourRotateVoxel::FourRotateVoxelGameView*>* Field_1_7; // 0x20
	::System::Collections::Generic::Dictionary_2<::RPG::Client::LittleGame::FourRotateVoxel::FourRotateVoxelStructGameView*, ::System::Single>* Field_1_6; // 0x28
	::System::Collections::Generic::Dictionary_2<::RPG::Client::LittleGame::FourRotateVoxel::FourRotateVoxelStructGameView*, ::RPG::Client::LittleGame::FourRotateVoxel::FourRotateVoxelStructGameView*>* Field_1_5; // 0x30
	...
	::Class_1_4D11CE62B2BEC69E* Field_1_3; // 0x48
	...
	::System::Boolean Method_1_DD75D6BA34547DEF(::System::Collections::Generic::HashSet_1<::System::String*>* a1, ::Class_2_0C58AD91B0F4D809* a2, ::RPG::Client::LittleGame::FourRotateVoxel::FourRotateVoxelGameViewCoord a3, ::System::Boolean a4)
	{
		return ((::System::Boolean(*)(::PVOID, ::System::Collections::Generic::HashSet_1<::System::String*>*, ::Class_2_0C58AD91B0F4D809*, ::RPG::Client::LittleGame::FourRotateVoxel::FourRotateVoxelGameViewCoord, ::System::Boolean))((::PBYTE)hIl2Cpp + CLASS_1_5589C9C33049A9A5_METHOD_1_DD75D6BA34547DEF_OFFSET))(this, a1, a2, a3, a4);
	}
