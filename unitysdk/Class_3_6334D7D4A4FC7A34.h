...
#define CLASS_3_6334D7D4A4FC7A34_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17026860)
#define CLASS_3_6334D7D4A4FC7A34_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17026720)
#define CLASS_3_6334D7D4A4FC7A34_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x170267F0)
#define CLASS_3_6334D7D4A4FC7A34_TICK_OFFSET UNITYSDK_OFFSET(0x17026790)
#define CLASS_3_6334D7D4A4FC7A34__CTOR_OFFSET UNITYSDK_OFFSET(0x170266F0)
#define CLASS_3_6334D7D4A4FC7A34___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17026900)
#define CLASS_3_6334D7D4A4FC7A34___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x170268A0)
