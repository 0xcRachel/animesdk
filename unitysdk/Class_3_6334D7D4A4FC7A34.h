...
#define CLASS_3_6334D7D4A4FC7A34_DISPOSE_OFFSET UNITYSDK_OFFSET(0x83FD570)
#define CLASS_3_6334D7D4A4FC7A34_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x83FD430)
#define CLASS_3_6334D7D4A4FC7A34_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x83FD500)
#define CLASS_3_6334D7D4A4FC7A34_TICK_OFFSET UNITYSDK_OFFSET(0x83FD4A0)
#define CLASS_3_6334D7D4A4FC7A34__CTOR_OFFSET UNITYSDK_OFFSET(0x83FD400)
#define CLASS_3_6334D7D4A4FC7A34___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x83FD610)
#define CLASS_3_6334D7D4A4FC7A34___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x83FD5B0)

inline static constexpr unsigned int Class_3_6334D7D4A4FC7A34_TypeDefinitionIndex = 41267;
