...
#define CLASS_2_CDA4A166D54A5BBB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x105D92A0)
#define CLASS_2_CDA4A166D54A5BBB_METHOD_2_18982EFD3B740683_OFFSET UNITYSDK_OFFSET(0x105D95A0)
#define CLASS_2_CDA4A166D54A5BBB_METHOD_2_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0x105D9740)
#define CLASS_2_CDA4A166D54A5BBB_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x105D92E0)
#define CLASS_2_CDA4A166D54A5BBB_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x105D9800)
#define CLASS_2_CDA4A166D54A5BBB_TICK_OFFSET UNITYSDK_OFFSET(0x105D98E0)
#define CLASS_2_CDA4A166D54A5BBB__CTOR_OFFSET UNITYSDK_OFFSET(0x105D9290)
...
{
public:
	::UnityEngine::Coroutine* Field_2_3; // 0x18
	::System::String* Field_2_2; // 0x20
	::RPG::GameCore::TaskContext* Field_2_1; // 0x28
	::RPG::GameCore::SetBattleBGMState* Field_2_0; // 0x30
