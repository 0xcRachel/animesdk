...
#define CLASS_2_CDA4A166D54A5BBB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10B5BB10)
#define CLASS_2_CDA4A166D54A5BBB_METHOD_2_18982EFD3B740683_OFFSET UNITYSDK_OFFSET(0x10B5BE50)
#define CLASS_2_CDA4A166D54A5BBB_METHOD_2_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0x10B5BFF0)
#define CLASS_2_CDA4A166D54A5BBB_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10B5BB50)
#define CLASS_2_CDA4A166D54A5BBB_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10B5C0D0)
#define CLASS_2_CDA4A166D54A5BBB_TICK_OFFSET UNITYSDK_OFFSET(0x10B5C1D0)
#define CLASS_2_CDA4A166D54A5BBB__CTOR_OFFSET UNITYSDK_OFFSET(0x10B5BB00)

inline static constexpr unsigned int Class_2_CDA4A166D54A5BBB_TypeDefinitionIndex = 46135;

class Class_2_CDA4A166D54A5BBB : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::SetBattleBGMState* Field_2_0; // 0x18
