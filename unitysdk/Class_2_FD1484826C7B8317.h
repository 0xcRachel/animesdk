...
#define CLASS_2_FD1484826C7B8317_METHOD_2_14045882BC5C6CA9_OFFSET UNITYSDK_OFFSET(0x172BA9D0)
#define CLASS_2_FD1484826C7B8317_METHOD_2_A65E76E2354D0E94_OFFSET UNITYSDK_OFFSET(0x172BA8B0)
#define CLASS_2_FD1484826C7B8317__CTOR_OFFSET UNITYSDK_OFFSET(0x172BAA20)
#define CLASS_2_FD1484826C7B8317__ONBIND_OFFSET UNITYSDK_OFFSET(0x172BA7A0)
#define CLASS_2_FD1484826C7B8317___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0x172BAA50)

inline static constexpr unsigned int Class_2_FD1484826C7B8317_TypeDefinitionIndex = 67154;
