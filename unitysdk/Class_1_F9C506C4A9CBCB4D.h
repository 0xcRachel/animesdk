...
#define CLASS_1_F9C506C4A9CBCB4D_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xCD07300)
#define CLASS_1_F9C506C4A9CBCB4D_METHOD_1_49D6CC7F7A3090A6_OFFSET UNITYSDK_OFFSET(0xCD07B60)
#define CLASS_1_F9C506C4A9CBCB4D_METHOD_1_585FC7B29EB12CF9_OFFSET UNITYSDK_OFFSET(0xCD07750)
#define CLASS_1_F9C506C4A9CBCB4D_METHOD_1_655DDB722F1FDE73_OFFSET UNITYSDK_OFFSET(0xCD07490)
#define CLASS_1_F9C506C4A9CBCB4D_METHOD_1_A370720754FE8924_OFFSET UNITYSDK_OFFSET(0xCD07890)
#define CLASS_1_F9C506C4A9CBCB4D_METHOD_1_CF780FC3D0CB1833_OFFSET UNITYSDK_OFFSET(0xCD07320)
#define CLASS_1_F9C506C4A9CBCB4D_METHOD_1_D7FE3FCFB1E0B054_OFFSET UNITYSDK_OFFSET(0xCD076B0)
#define CLASS_1_F9C506C4A9CBCB4D_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xCD07310)
#define CLASS_1_F9C506C4A9CBCB4D__CTOR_OFFSET UNITYSDK_OFFSET(0xCD07410)

inline static constexpr unsigned int Class_1_F9C506C4A9CBCB4D_TypeDefinitionIndex = 68143;
...
public:
	...
	{
		return (::Class_1_F9C506C4A9CBCB4D**)Il2CppClass::FromTypeDefinitionIndex(Class_1_F9C506C4A9CBCB4D_TypeDefinitionIndex)->GetStaticField(0x2A880);
	}
