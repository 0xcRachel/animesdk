...
#define CLASS_1_F9C506C4A9CBCB4D_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x115E9910)
#define CLASS_1_F9C506C4A9CBCB4D_METHOD_1_49D6CC7F7A3090A6_OFFSET UNITYSDK_OFFSET(0x115EA170)
#define CLASS_1_F9C506C4A9CBCB4D_METHOD_1_585FC7B29EB12CF9_OFFSET UNITYSDK_OFFSET(0x115E9D60)
#define CLASS_1_F9C506C4A9CBCB4D_METHOD_1_655DDB722F1FDE73_OFFSET UNITYSDK_OFFSET(0x115E9AA0)
#define CLASS_1_F9C506C4A9CBCB4D_METHOD_1_A370720754FE8924_OFFSET UNITYSDK_OFFSET(0x115E9EA0)
#define CLASS_1_F9C506C4A9CBCB4D_METHOD_1_CF780FC3D0CB1833_OFFSET UNITYSDK_OFFSET(0x115E9930)
#define CLASS_1_F9C506C4A9CBCB4D_METHOD_1_D7FE3FCFB1E0B054_OFFSET UNITYSDK_OFFSET(0x115E9CC0)
#define CLASS_1_F9C506C4A9CBCB4D_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x115E9920)
#define CLASS_1_F9C506C4A9CBCB4D__CTOR_OFFSET UNITYSDK_OFFSET(0x115E9A20)

inline static constexpr unsigned int Class_1_F9C506C4A9CBCB4D_TypeDefinitionIndex = 60701;
...
public:
	...
	{
		return (::Class_1_F9C506C4A9CBCB4D**)Il2CppClass::FromTypeDefinitionIndex(Class_1_F9C506C4A9CBCB4D_TypeDefinitionIndex)->GetStaticField(0x2BE80);
	}
