...
#define CLASS_1_F9C506C4A9CBCB4D_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x10D21E30)
#define CLASS_1_F9C506C4A9CBCB4D_METHOD_1_49D6CC7F7A3090A6_OFFSET UNITYSDK_OFFSET(0x10D22690)
#define CLASS_1_F9C506C4A9CBCB4D_METHOD_1_585FC7B29EB12CF9_OFFSET UNITYSDK_OFFSET(0x10D22280)
#define CLASS_1_F9C506C4A9CBCB4D_METHOD_1_655DDB722F1FDE73_OFFSET UNITYSDK_OFFSET(0x10D21FC0)
#define CLASS_1_F9C506C4A9CBCB4D_METHOD_1_A370720754FE8924_OFFSET UNITYSDK_OFFSET(0x10D223C0)
#define CLASS_1_F9C506C4A9CBCB4D_METHOD_1_CF780FC3D0CB1833_OFFSET UNITYSDK_OFFSET(0x10D21E50)
#define CLASS_1_F9C506C4A9CBCB4D_METHOD_1_D7FE3FCFB1E0B054_OFFSET UNITYSDK_OFFSET(0x10D221E0)
#define CLASS_1_F9C506C4A9CBCB4D_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x10D21E40)
#define CLASS_1_F9C506C4A9CBCB4D__CTOR_OFFSET UNITYSDK_OFFSET(0x10D21F40)

inline static constexpr unsigned int Class_1_F9C506C4A9CBCB4D_TypeDefinitionIndex = 58953;
...
public:
	...
	{
		return (::Class_1_F9C506C4A9CBCB4D**)Il2CppClass::FromTypeDefinitionIndex(Class_1_F9C506C4A9CBCB4D_TypeDefinitionIndex)->GetStaticField(0x18B60);
	}
