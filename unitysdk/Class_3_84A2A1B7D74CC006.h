...
#define CLASS_3_84A2A1B7D74CC006_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10272210)
#define CLASS_3_84A2A1B7D74CC006_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10272260)
#define CLASS_3_84A2A1B7D74CC006_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10272600)
#define CLASS_3_84A2A1B7D74CC006_TICK_OFFSET UNITYSDK_OFFSET(0x10272650)
#define CLASS_3_84A2A1B7D74CC006__CTOR_OFFSET UNITYSDK_OFFSET(0x102721B0)
#define CLASS_3_84A2A1B7D74CC006___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x102727F0)
#define CLASS_3_84A2A1B7D74CC006___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x10272840)

inline static constexpr unsigned int Class_3_84A2A1B7D74CC006_TypeDefinitionIndex = 41199;
