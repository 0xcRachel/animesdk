...
#define CLASS_3_84A2A1B7D74CC006_DISPOSE_OFFSET UNITYSDK_OFFSET(0x105F84B0)
#define CLASS_3_84A2A1B7D74CC006_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x105F8500)
#define CLASS_3_84A2A1B7D74CC006_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x105F88A0)
#define CLASS_3_84A2A1B7D74CC006_TICK_OFFSET UNITYSDK_OFFSET(0x105F88F0)
#define CLASS_3_84A2A1B7D74CC006__CTOR_OFFSET UNITYSDK_OFFSET(0x105F8450)
#define CLASS_3_84A2A1B7D74CC006___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x105F8A90)
#define CLASS_3_84A2A1B7D74CC006___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x105F8AE0)
