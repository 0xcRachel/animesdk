...
#define CLASS_1_5B567C8A01BAEDFE_89_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19C21B30)
#define CLASS_1_5B567C8A01BAEDFE_89_CLONE_OFFSET UNITYSDK_OFFSET(0x19C21940)
#define CLASS_1_5B567C8A01BAEDFE_89_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19C21A40)
#define CLASS_1_5B567C8A01BAEDFE_89_EQUALS_OFFSET UNITYSDK_OFFSET(0x19C219B0)
#define CLASS_1_5B567C8A01BAEDFE_89_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19C21A90)
#define CLASS_1_5B567C8A01BAEDFE_89_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19C21B80)
#define CLASS_1_5B567C8A01BAEDFE_89_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19C21B50)
#define CLASS_1_5B567C8A01BAEDFE_89_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19C21890)
#define CLASS_1_5B567C8A01BAEDFE_89_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19C218F0)
#define CLASS_1_5B567C8A01BAEDFE_89_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19C21AC0)
#define CLASS_1_5B567C8A01BAEDFE_89_WRITETO_OFFSET UNITYSDK_OFFSET(0x19C21B20)
#define CLASS_1_5B567C8A01BAEDFE_89__CCTOR_OFFSET UNITYSDK_OFFSET(0x19C21BD0)
#define CLASS_1_5B567C8A01BAEDFE_89__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19C21910)
#define CLASS_1_5B567C8A01BAEDFE_89__CTOR_OFFSET UNITYSDK_OFFSET(0x19C21900)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_89*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_89_TypeDefinitionIndex)->GetStaticField(0x5A610);
	}
