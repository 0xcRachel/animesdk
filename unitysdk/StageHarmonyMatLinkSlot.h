...
#define STAGEHARMONYMATLINKSLOT_GET_ISSINGLERENDERER_OFFSET UNITYSDK_OFFSET(0xA6A3800)
#define STAGEHARMONYMATLINKSLOT_METHOD_2_03BFDB1C3240A55A_OFFSET UNITYSDK_OFFSET(0xA6A3810)
#define STAGEHARMONYMATLINKSLOT_METHOD_2_2C2DA449C864943D_OFFSET UNITYSDK_OFFSET(0xA6A3D00)
#define STAGEHARMONYMATLINKSLOT_METHOD_2_83C2685161B408B7_OFFSET UNITYSDK_OFFSET(0xA6A4010)
#define STAGEHARMONYMATLINKSLOT_METHOD_2_937F8473216A3162_OFFSET UNITYSDK_OFFSET(0xA6A3A30)
#define STAGEHARMONYMATLINKSLOT_METHOD_2_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xA6A39F0)
#define STAGEHARMONYMATLINKSLOT_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA6A39A0)
#define STAGEHARMONYMATLINKSLOT_METHOD_2_E879A6F7021E230E_OFFSET UNITYSDK_OFFSET(0xA6A3DD0)
#define STAGEHARMONYMATLINKSLOT_METHOD_2_FF1156DD6F26F6DC_OFFSET UNITYSDK_OFFSET(0xA6A3B90)
#define STAGEHARMONYMATLINKSLOT__CTOR_OFFSET UNITYSDK_OFFSET(0xA6A43F0)

inline static constexpr unsigned int StageHarmonyMatLinkSlot_TypeDefinitionIndex = 37444;
