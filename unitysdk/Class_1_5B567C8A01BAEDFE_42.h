...
#define CLASS_1_5B567C8A01BAEDFE_42_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A3C20A0)
#define CLASS_1_5B567C8A01BAEDFE_42_CLONE_OFFSET UNITYSDK_OFFSET(0x1A3C1F10)
#define CLASS_1_5B567C8A01BAEDFE_42_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A3C1FB0)
#define CLASS_1_5B567C8A01BAEDFE_42_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A3C1F50)
#define CLASS_1_5B567C8A01BAEDFE_42_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A3C2000)
#define CLASS_1_5B567C8A01BAEDFE_42_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A3C20F0)
#define CLASS_1_5B567C8A01BAEDFE_42_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A3C20C0)
#define CLASS_1_5B567C8A01BAEDFE_42_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A3C1E90)
#define CLASS_1_5B567C8A01BAEDFE_42_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A3C1EC0)
#define CLASS_1_5B567C8A01BAEDFE_42_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A3C2030)
#define CLASS_1_5B567C8A01BAEDFE_42_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A3C2090)
#define CLASS_1_5B567C8A01BAEDFE_42__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A3C2140)
#define CLASS_1_5B567C8A01BAEDFE_42__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3C1EE0)
#define CLASS_1_5B567C8A01BAEDFE_42__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3C1ED0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_42*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_42_TypeDefinitionIndex)->GetStaticField(0x4C960);
	}
