...
#define CLASS_3_9537C50AD930AF13_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC4E6510)
#define CLASS_3_9537C50AD930AF13_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xC4E63F0)
#define CLASS_3_9537C50AD930AF13_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xC4E64C0)
#define CLASS_3_9537C50AD930AF13_TICK_OFFSET UNITYSDK_OFFSET(0xC4E6460)
#define CLASS_3_9537C50AD930AF13__CTOR_OFFSET UNITYSDK_OFFSET(0xC4E63C0)
#define CLASS_3_9537C50AD930AF13___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC4E65B0)
#define CLASS_3_9537C50AD930AF13___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0xC4E6550)
