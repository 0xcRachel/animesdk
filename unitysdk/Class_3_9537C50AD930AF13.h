...
#define CLASS_3_9537C50AD930AF13_DISPOSE_OFFSET UNITYSDK_OFFSET(0xE3F0B40)
#define CLASS_3_9537C50AD930AF13_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xE3F0A20)
#define CLASS_3_9537C50AD930AF13_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xE3F0AF0)
#define CLASS_3_9537C50AD930AF13_TICK_OFFSET UNITYSDK_OFFSET(0xE3F0A90)
#define CLASS_3_9537C50AD930AF13__CTOR_OFFSET UNITYSDK_OFFSET(0xE3F09F0)
#define CLASS_3_9537C50AD930AF13___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xE3F0BE0)
#define CLASS_3_9537C50AD930AF13___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0xE3F0B80)
