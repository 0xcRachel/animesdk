...
#define CLASS_1_A0F9A6CFA21CA68B_GET_BONUS_OFFSET UNITYSDK_OFFSET(0x105C22C0)
#define CLASS_1_A0F9A6CFA21CA68B_GET_TRAITEFFECTID_OFFSET UNITYSDK_OFFSET(0x105C22A0)
#define CLASS_1_A0F9A6CFA21CA68B_GET_TRAITID_OFFSET UNITYSDK_OFFSET(0x105C2280)
#define CLASS_1_A0F9A6CFA21CA68B_SET_BONUS_OFFSET UNITYSDK_OFFSET(0x105C22D0)
#define CLASS_1_A0F9A6CFA21CA68B_SET_TRAITEFFECTID_OFFSET UNITYSDK_OFFSET(0x105C22B0)
#define CLASS_1_A0F9A6CFA21CA68B_SET_TRAITID_OFFSET UNITYSDK_OFFSET(0x105C2290)
#define CLASS_1_A0F9A6CFA21CA68B__CTOR_OFFSET UNITYSDK_OFFSET(0x105C22E0)

inline static constexpr unsigned int Class_1_A0F9A6CFA21CA68B_TypeDefinitionIndex = 51217;
