...
#define CLASS_1_A0F9A6CFA21CA68B_GET_BONUS_OFFSET UNITYSDK_OFFSET(0x87C48C0)
#define CLASS_1_A0F9A6CFA21CA68B_GET_TRAITEFFECTID_OFFSET UNITYSDK_OFFSET(0x87C48A0)
#define CLASS_1_A0F9A6CFA21CA68B_GET_TRAITID_OFFSET UNITYSDK_OFFSET(0x87C4880)
#define CLASS_1_A0F9A6CFA21CA68B_SET_BONUS_OFFSET UNITYSDK_OFFSET(0x87C48D0)
#define CLASS_1_A0F9A6CFA21CA68B_SET_TRAITEFFECTID_OFFSET UNITYSDK_OFFSET(0x87C48B0)
#define CLASS_1_A0F9A6CFA21CA68B_SET_TRAITID_OFFSET UNITYSDK_OFFSET(0x87C4890)
#define CLASS_1_A0F9A6CFA21CA68B__CTOR_OFFSET UNITYSDK_OFFSET(0x87C48E0)
