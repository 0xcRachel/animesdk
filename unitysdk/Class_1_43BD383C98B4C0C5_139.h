...
#define CLASS_1_43BD383C98B4C0C5_139__CTOR_OFFSET UNITYSDK_OFFSET(0x1426D9F0)
...
public:
	...
	::RPG::GameCore::StageRegionVisualState Field_1_3; // 0x24
	::RPG::Client::CompatKey Field_1_4; // 0x28
	::System::UInt32 Field_1_5; // 0x2C
	::Class_1_303D5A33D1401D59_RegionBlockVisibilityStatusPriority Field_1_6; // 0x30
	::RPG::GameCore::StageRegionVisualState Field_1_7; // 0x34
	::RPG::Client::CompatKey Field_1_8; // 0x38
	::Class_1_303D5A33D1401D59_RegionBlockVisibilityStatusPriority Field_1_9; // 0x3C
	::RPG::GameCore::StageRegionVisualState Field_1_10; // 0x40
	::RPG::GameCore::StageRegionActiveState Field_1_11; // 0x44
	::Struct_2_960171EC79068492 Field_1_12; // 0x48
	::RPG::Client::ShadowCompareDiffBucket Field_1_13; // 0x50
	::RPG::Client::RegionVisualStateV2Mode Field_1_14; // 0x54
