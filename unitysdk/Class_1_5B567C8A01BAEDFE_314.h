...
#define CLASS_1_5B567C8A01BAEDFE_314_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A7C4410)
#define CLASS_1_5B567C8A01BAEDFE_314_CLONE_OFFSET UNITYSDK_OFFSET(0x1A7C4280)
#define CLASS_1_5B567C8A01BAEDFE_314_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A7C4320)
#define CLASS_1_5B567C8A01BAEDFE_314_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A7C42C0)
#define CLASS_1_5B567C8A01BAEDFE_314_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A7C4370)
#define CLASS_1_5B567C8A01BAEDFE_314_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A7C4460)
#define CLASS_1_5B567C8A01BAEDFE_314_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A7C4430)
#define CLASS_1_5B567C8A01BAEDFE_314_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A7C4200)
#define CLASS_1_5B567C8A01BAEDFE_314_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A7C4230)
#define CLASS_1_5B567C8A01BAEDFE_314_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A7C43A0)
#define CLASS_1_5B567C8A01BAEDFE_314_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A7C4400)
#define CLASS_1_5B567C8A01BAEDFE_314__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A7C44B0)
#define CLASS_1_5B567C8A01BAEDFE_314__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A7C4250)
#define CLASS_1_5B567C8A01BAEDFE_314__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7C4240)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_314*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_314_TypeDefinitionIndex)->GetStaticField(0xC640);
	}
