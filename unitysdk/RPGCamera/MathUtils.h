...
#define RPGCAMERA_MATHUTILS_ALMOSTZERO_OFFSET UNITYSDK_OFFSET(0x19BB2250)
#define RPGCAMERA_MATHUTILS_CARTESIAN2SPHERIAL_1_OFFSET UNITYSDK_OFFSET(0x19BAE370)
#define RPGCAMERA_MATHUTILS_CARTESIAN2SPHERIAL_OFFSET UNITYSDK_OFFSET(0x19BB1FD0)
#define RPGCAMERA_MATHUTILS_GETCAMHALFSIZE_OFFSET UNITYSDK_OFFSET(0x19BB2500)
#define RPGCAMERA_MATHUTILS_LINEARLERPPOLEANGLE_OFFSET UNITYSDK_OFFSET(0x19BB22E0)
#define RPGCAMERA_MATHUTILS_NORMALIZEDROTATERADIAN_OFFSET UNITYSDK_OFFSET(0x19BACAC0)
#define RPGCAMERA_MATHUTILS_PROJECTONTOPLANE_OFFSET UNITYSDK_OFFSET(0x19BB2280)
#define RPGCAMERA_MATHUTILS_SIGNEDRADIANDIFF_OFFSET UNITYSDK_OFFSET(0x19BB2130)
#define RPGCAMERA_MATHUTILS_SLERPWITHREFERENCEUP_OFFSET UNITYSDK_OFFSET(0x19BADA50)
#define RPGCAMERA_MATHUTILS_SPHERIAL2CARTESIAN_OFFSET UNITYSDK_OFFSET(0x19BAD390)
#define RPGCAMERA_MATHUTILS_SPRINGSYSTEM1D_ACCURATE_OFFSET UNITYSDK_OFFSET(0x19BB2180)
#define RPGCAMERA_MATHUTILS_TO180ANGLE_OFFSET UNITYSDK_OFFSET(0x19BB2080)
#define RPGCAMERA_MATHUTILS_TO360ANGLE_OFFSET UNITYSDK_OFFSET(0x19BB20E0)
