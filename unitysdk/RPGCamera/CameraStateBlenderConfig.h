...
#define RPGCAMERA_CAMERASTATEBLENDERCONFIG_ADDCAMERASTATEBLENDERCONFIG_OFFSET UNITYSDK_OFFSET(0x175C0600)
#define RPGCAMERA_CAMERASTATEBLENDERCONFIG_CREATEBLENDERCFGBYPARAM_OFFSET UNITYSDK_OFFSET(0x175C07E0)
#define RPGCAMERA_CAMERASTATEBLENDERCONFIG_CREATEBLENDERCFG_OFFSET UNITYSDK_OFFSET(0x175C0580)
#define RPGCAMERA_CAMERASTATEBLENDERCONFIG_GETCAMERASTATEBLENDERCONFIG_OFFSET UNITYSDK_OFFSET(0x175C0040)
#define RPGCAMERA_CAMERASTATEBLENDERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175C05F0)
...
namespace RPGCamera
{
	...
	public:
		...
		::EasingFunction_Ease easeType; // 0x18
		::RPGCamera::CameraStateBlenderConfig_BlendType blendType; // 0x1C
		::System::Int32 fromId; // 0x20
		::RPGCamera::CameraStateBlenderConfig_PoleType poleType; // 0x24
