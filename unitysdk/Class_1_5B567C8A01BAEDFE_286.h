...
#define CLASS_1_5B567C8A01BAEDFE_286_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A6BD860)
#define CLASS_1_5B567C8A01BAEDFE_286_CLONE_OFFSET UNITYSDK_OFFSET(0x1A6BD670)
#define CLASS_1_5B567C8A01BAEDFE_286_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A6BD770)
#define CLASS_1_5B567C8A01BAEDFE_286_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A6BD6E0)
#define CLASS_1_5B567C8A01BAEDFE_286_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A6BD7C0)
#define CLASS_1_5B567C8A01BAEDFE_286_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A6BD8B0)
#define CLASS_1_5B567C8A01BAEDFE_286_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A6BD880)
#define CLASS_1_5B567C8A01BAEDFE_286_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A6BD5C0)
#define CLASS_1_5B567C8A01BAEDFE_286_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A6BD620)
#define CLASS_1_5B567C8A01BAEDFE_286_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A6BD7F0)
#define CLASS_1_5B567C8A01BAEDFE_286_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A6BD850)
#define CLASS_1_5B567C8A01BAEDFE_286__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A6BD900)
#define CLASS_1_5B567C8A01BAEDFE_286__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A6BD640)
#define CLASS_1_5B567C8A01BAEDFE_286__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6BD630)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_286*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_286_TypeDefinitionIndex)->GetStaticField(0x10DD0);
	}
