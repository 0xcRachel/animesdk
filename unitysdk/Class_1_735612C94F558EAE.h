...
#define CLASS_1_735612C94F558EAE_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x178910C0)
#define CLASS_1_735612C94F558EAE_CLONE_OFFSET UNITYSDK_OFFSET(0x17890BA0)
#define CLASS_1_735612C94F558EAE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17890CF0)
#define CLASS_1_735612C94F558EAE_EQUALS_OFFSET UNITYSDK_OFFSET(0x17890C10)
#define CLASS_1_735612C94F558EAE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17890DA0)
#define CLASS_1_735612C94F558EAE_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x178911F0)
#define CLASS_1_735612C94F558EAE_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x17891190)
#define CLASS_1_735612C94F558EAE_METHOD_1_554199E0076172C5_1_OFFSET UNITYSDK_OFFSET(0x17890C00)
#define CLASS_1_735612C94F558EAE_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x17890BF0)
#define CLASS_1_735612C94F558EAE_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17890A20)
#define CLASS_1_735612C94F558EAE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17890F80)
#define CLASS_1_735612C94F558EAE_WRITETO_OFFSET UNITYSDK_OFFSET(0x17890FE0)
#define CLASS_1_735612C94F558EAE__CCTOR_OFFSET UNITYSDK_OFFSET(0x17891330)
#define CLASS_1_735612C94F558EAE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17890AC0)
#define CLASS_1_735612C94F558EAE__CTOR_OFFSET UNITYSDK_OFFSET(0x17890A30)

inline static constexpr unsigned int Class_1_735612C94F558EAE_TypeDefinitionIndex = 22327;
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_735612C94F558EAE_TypeDefinitionIndex)->GetStaticField(0x2FCE0);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_5()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_735612C94F558EAE_TypeDefinitionIndex)->GetStaticField(0x2FCE8);
	}
