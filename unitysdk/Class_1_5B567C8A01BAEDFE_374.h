...
#define CLASS_1_5B567C8A01BAEDFE_374_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A9118A0)
#define CLASS_1_5B567C8A01BAEDFE_374_CLONE_OFFSET UNITYSDK_OFFSET(0x1A9116B0)
#define CLASS_1_5B567C8A01BAEDFE_374_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A9117B0)
#define CLASS_1_5B567C8A01BAEDFE_374_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A911720)
#define CLASS_1_5B567C8A01BAEDFE_374_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A911800)
#define CLASS_1_5B567C8A01BAEDFE_374_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A9118F0)
#define CLASS_1_5B567C8A01BAEDFE_374_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A9118C0)
#define CLASS_1_5B567C8A01BAEDFE_374_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A911600)
#define CLASS_1_5B567C8A01BAEDFE_374_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A911660)
#define CLASS_1_5B567C8A01BAEDFE_374_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A911830)
#define CLASS_1_5B567C8A01BAEDFE_374_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A911890)
#define CLASS_1_5B567C8A01BAEDFE_374__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A911940)
#define CLASS_1_5B567C8A01BAEDFE_374__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A911680)
#define CLASS_1_5B567C8A01BAEDFE_374__CTOR_OFFSET UNITYSDK_OFFSET(0x1A911670)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_374*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_374_TypeDefinitionIndex)->GetStaticField(0x1A990);
	}
