...
#define IRI_HLODDATA_GETCURRENTSTAGEMATLUTPATH_OFFSET UNITYSDK_OFFSET(0x10ADC770)
#define IRI_HLODDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x10ADC8B0)

inline static constexpr unsigned int IRI_HlodData_TypeDefinitionIndex = 37124;
