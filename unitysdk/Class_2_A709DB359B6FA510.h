...
#define CLASS_2_A709DB359B6FA510_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1006BCA0)
#define CLASS_2_A709DB359B6FA510_METHOD_2_04577AC5AE05B41B_OFFSET UNITYSDK_OFFSET(0x1006E410)
#define CLASS_2_A709DB359B6FA510_METHOD_2_0FD0EC313FAAB75A_OFFSET UNITYSDK_OFFSET(0x1006BE50)
#define CLASS_2_A709DB359B6FA510_METHOD_2_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x1006C610)
#define CLASS_2_A709DB359B6FA510_METHOD_2_1ADC5E4C222F6999_OFFSET UNITYSDK_OFFSET(0x1006CB40)
#define CLASS_2_A709DB359B6FA510_METHOD_2_243A42B6D2656CA9_OFFSET UNITYSDK_OFFSET(0x1006C3A0)
#define CLASS_2_A709DB359B6FA510_METHOD_2_2D8D297A9EEF51AC_OFFSET UNITYSDK_OFFSET(0x1006E7F0)
#define CLASS_2_A709DB359B6FA510_METHOD_2_369F47CCB61A607A_OFFSET UNITYSDK_OFFSET(0x1006C6D0)
#define CLASS_2_A709DB359B6FA510_METHOD_2_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x1006E0B0)
#define CLASS_2_A709DB359B6FA510_METHOD_2_46821F7F37665DC0_OFFSET UNITYSDK_OFFSET(0x1006CD70)
#define CLASS_2_A709DB359B6FA510_METHOD_2_479759059E440327_OFFSET UNITYSDK_OFFSET(0x1006E370)
#define CLASS_2_A709DB359B6FA510_METHOD_2_47D59A6D9D2806F9_OFFSET UNITYSDK_OFFSET(0x1006C810)
#define CLASS_2_A709DB359B6FA510_METHOD_2_5323F2DF46A044DA_OFFSET UNITYSDK_OFFSET(0x1006F0B0)
#define CLASS_2_A709DB359B6FA510_METHOD_2_5B6CC23D54F693F4_OFFSET UNITYSDK_OFFSET(0x1006E620)
#define CLASS_2_A709DB359B6FA510_METHOD_2_6055A93732CC885D_OFFSET UNITYSDK_OFFSET(0x1006D340)
#define CLASS_2_A709DB359B6FA510_METHOD_2_73981E138A7FFA15_OFFSET UNITYSDK_OFFSET(0x1006CED0)
#define CLASS_2_A709DB359B6FA510_METHOD_2_77D630694D127945_OFFSET UNITYSDK_OFFSET(0x1006EC10)
#define CLASS_2_A709DB359B6FA510_METHOD_2_8FAD57395F26ACC4_OFFSET UNITYSDK_OFFSET(0x1006E1E0)
#define CLASS_2_A709DB359B6FA510_METHOD_2_90D019D81149A8BA_OFFSET UNITYSDK_OFFSET(0x1006F330)
#define CLASS_2_A709DB359B6FA510_METHOD_2_A5FD6FF4A4D69ED8_OFFSET UNITYSDK_OFFSET(0x1006BB90)
#define CLASS_2_A709DB359B6FA510_METHOD_2_A871253BFD471C99_OFFSET UNITYSDK_OFFSET(0x1006F0C0)
#define CLASS_2_A709DB359B6FA510_METHOD_2_A95A26410788624B_OFFSET UNITYSDK_OFFSET(0x1006BC50)
#define CLASS_2_A709DB359B6FA510_METHOD_2_AA169839CB93802A_OFFSET UNITYSDK_OFFSET(0x1006CCB0)
#define CLASS_2_A709DB359B6FA510_METHOD_2_B3A88D7849969A71_OFFSET UNITYSDK_OFFSET(0x1006EBA0)
#define CLASS_2_A709DB359B6FA510_METHOD_2_BCEC6A5E82A37C9A_OFFSET UNITYSDK_OFFSET(0x1006BD10)
#define CLASS_2_A709DB359B6FA510_METHOD_2_C8D6B29192F288ED_OFFSET UNITYSDK_OFFSET(0x1006DCD0)
#define CLASS_2_A709DB359B6FA510_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1006BE10)
#define CLASS_2_A709DB359B6FA510_METHOD_2_D460587695D41831_OFFSET UNITYSDK_OFFSET(0x1006BFB0)
#define CLASS_2_A709DB359B6FA510_METHOD_2_DE25B04543C947C4_OFFSET UNITYSDK_OFFSET(0x1006DB80)
#define CLASS_2_A709DB359B6FA510_METHOD_2_F7E674C1303ACB5B_OFFSET UNITYSDK_OFFSET(0x1006E510)
#define CLASS_2_A709DB359B6FA510__CCTOR_OFFSET UNITYSDK_OFFSET(0x1006F1B0)
#define CLASS_2_A709DB359B6FA510__CTOR_OFFSET UNITYSDK_OFFSET(0x1006F1A0)
#define CLASS_2_A709DB359B6FA510__FADEINIMMEDIATELY_B__5_0_OFFSET UNITYSDK_OFFSET(0x1006F1E0)
#define CLASS_2_A709DB359B6FA510___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1006F3A0)

inline static constexpr unsigned int Class_2_A709DB359B6FA510_TypeDefinitionIndex = 55592;
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_2_A709DB359B6FA510_TypeDefinitionIndex)->GetStaticField(0xBBA0);
	}
	static ::System::Int32* StaticGet_Field_2_10()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_2_A709DB359B6FA510_TypeDefinitionIndex)->GetStaticField(0xBBA4);
	}
	::Class_1_9CBC71DC5240DC00* Field_2_3; // 0x18
	::RPG::Client::MonoEffectPluginCharaEffectBase* Field_2_4; // 0x20
	::System::Action* Field_2_8; // 0x28
	::UnityEngine::Animator* Field_2_5; // 0x30
	::Class_1_D27BF54F25500E5F* Field_2_7; // 0x38
	::Il2CppArray<::UnityEngine::Renderer*>* Field_2_2; // 0x40
	::System::Boolean Field_2_9; // 0x48
	::System::Boolean Field_2_1; // 0x49
	::System::Boolean Field_2_0; // 0x4A
