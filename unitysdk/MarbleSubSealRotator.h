...
#define MARBLESUBSEALROTATOR_CLEAR_OFFSET UNITYSDK_OFFSET(0x16B75100)
#define MARBLESUBSEALROTATOR_INIT_OFFSET UNITYSDK_OFFSET(0x16B74950)
#define MARBLESUBSEALROTATOR_METHOD_5_A5ADA4706DA592FA_OFFSET UNITYSDK_OFFSET(0x16B74AF0)
#define MARBLESUBSEALROTATOR_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x16B75220)
#define MARBLESUBSEALROTATOR_ONENABLE_OFFSET UNITYSDK_OFFSET(0x16B751D0)
#define MARBLESUBSEALROTATOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x16B75150)
#define MARBLESUBSEALROTATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x16B75270)
