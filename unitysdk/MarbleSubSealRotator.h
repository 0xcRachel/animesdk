...
#define MARBLESUBSEALROTATOR_CLEAR_OFFSET UNITYSDK_OFFSET(0x88C2B10)
#define MARBLESUBSEALROTATOR_INIT_OFFSET UNITYSDK_OFFSET(0x88C2360)
#define MARBLESUBSEALROTATOR_METHOD_5_A5ADA4706DA592FA_OFFSET UNITYSDK_OFFSET(0x88C2500)
#define MARBLESUBSEALROTATOR_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x88C2C30)
#define MARBLESUBSEALROTATOR_ONENABLE_OFFSET UNITYSDK_OFFSET(0x88C2BE0)
#define MARBLESUBSEALROTATOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x88C2B60)
#define MARBLESUBSEALROTATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x88C2C80)
