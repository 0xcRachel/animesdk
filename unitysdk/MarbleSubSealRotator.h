...
#define MARBLESUBSEALROTATOR_CLEAR_OFFSET UNITYSDK_OFFSET(0x111F85B0)
#define MARBLESUBSEALROTATOR_INIT_OFFSET UNITYSDK_OFFSET(0x111F7E00)
#define MARBLESUBSEALROTATOR_METHOD_5_A5ADA4706DA592FA_OFFSET UNITYSDK_OFFSET(0x111F7FA0)
#define MARBLESUBSEALROTATOR_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x111F86D0)
#define MARBLESUBSEALROTATOR_ONENABLE_OFFSET UNITYSDK_OFFSET(0x111F8680)
#define MARBLESUBSEALROTATOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x111F8600)
#define MARBLESUBSEALROTATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x111F8720)

inline static constexpr unsigned int MarbleSubSealRotator_TypeDefinitionIndex = 37089;
