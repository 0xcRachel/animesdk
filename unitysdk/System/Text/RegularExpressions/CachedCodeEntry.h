...
#define SYSTEM_TEXT_REGULAREXPRESSIONS_CACHEDCODEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x16B45050)
...
namespace System::Text::RegularExpressions
{
	...
	public:
		...
		::System::Text::RegularExpressions::SharedReference* _replref; // 0x40
		::System::Text::RegularExpressions::RegexRunnerFactory* _factory; // 0x48
