...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_TRYFAULTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17CFE5A0)

namespace System::Linq::Expressions::Interpreter
{
	inline static constexpr unsigned int TryFaultHandler_TypeDefinitionIndex = 3455;

	class TryFaultHandler : public ::System::Object
	{
	public:
		::System::Int32 FinallyStartIndex; // 0x10
		::System::Int32 FinallyEndIndex; // 0x14
