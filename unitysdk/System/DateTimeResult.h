...
#define SYSTEM_DATETIMERESULT_INIT_OFFSET UNITYSDK_OFFSET(0x20DBB10)
#define SYSTEM_DATETIMERESULT_SETDATE_OFFSET UNITYSDK_OFFSET(0x7B080)
#define SYSTEM_DATETIMERESULT_SETFAILURE_1_OFFSET UNITYSDK_OFFSET(0x20DBB50)
#define SYSTEM_DATETIMERESULT_SETFAILURE_OFFSET UNITYSDK_OFFSET(0x20DBB40)
