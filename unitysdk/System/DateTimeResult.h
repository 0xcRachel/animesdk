...
#define SYSTEM_DATETIMERESULT_INIT_OFFSET UNITYSDK_OFFSET(0x3821F60)
#define SYSTEM_DATETIMERESULT_SETDATE_OFFSET UNITYSDK_OFFSET(0x6C9750)
#define SYSTEM_DATETIMERESULT_SETFAILURE_1_OFFSET UNITYSDK_OFFSET(0x3821FA0)
#define SYSTEM_DATETIMERESULT_SETFAILURE_OFFSET UNITYSDK_OFFSET(0x3821F90)
