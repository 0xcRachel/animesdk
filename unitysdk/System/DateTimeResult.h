...
#define SYSTEM_DATETIMERESULT_INIT_OFFSET UNITYSDK_OFFSET(0x2006290)
#define SYSTEM_DATETIMERESULT_SETDATE_OFFSET UNITYSDK_OFFSET(0xC9EC0)
#define SYSTEM_DATETIMERESULT_SETFAILURE_1_OFFSET UNITYSDK_OFFSET(0x20062D0)
#define SYSTEM_DATETIMERESULT_SETFAILURE_OFFSET UNITYSDK_OFFSET(0x20062C0)
