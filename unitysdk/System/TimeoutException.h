...
#define SYSTEM_TIMEOUTEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1627C4A0)
#define SYSTEM_TIMEOUTEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1627C510)
#define SYSTEM_TIMEOUTEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1627C430)
