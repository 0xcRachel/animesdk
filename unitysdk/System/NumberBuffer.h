...
#define SYSTEM_NUMBERBUFFER_GET_DIGITS_OFFSET UNITYSDK_OFFSET(0x202CCD0)
#define SYSTEM_NUMBERBUFFER_GET_NUMDIGITS_OFFSET UNITYSDK_OFFSET(0x202CDB0)
#define SYSTEM_NUMBERBUFFER_GET_UNSAFEDIGITS_OFFSET UNITYSDK_OFFSET(0x202CDA0)
#define SYSTEM_NUMBERBUFFER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x202CE80)

namespace System
{
	inline static constexpr unsigned int NumberBuffer_TypeDefinitionIndex = 4868;
