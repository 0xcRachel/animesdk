...
#define SYSTEM_THREADING_SEMAPHORESLIM__WAITUNTILCOUNTORTIMEOUTASYNC_D__31_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1FFF930)
#define SYSTEM_THREADING_SEMAPHORESLIM__WAITUNTILCOUNTORTIMEOUTASYNC_D__31_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x1FF9760)

namespace System::Threading
{
	inline static constexpr unsigned int SemaphoreSlim__WaitUntilCountOrTimeoutAsync_d__31_TypeDefinitionIndex = 806;
	...
	struct alignas(8) SemaphoreSlim__WaitUntilCountOrTimeoutAsync_d__31
	{
		...
		::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::System::Boolean> __t__builder; // 0x58
