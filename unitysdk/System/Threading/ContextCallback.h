...
#define SYSTEM_THREADING_CONTEXTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15B7D8C0)
#define SYSTEM_THREADING_CONTEXTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15B7D8F0)
#define SYSTEM_THREADING_CONTEXTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x15B7D180)
#define SYSTEM_THREADING_CONTEXTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x15B7A0F0)

namespace System::Threading
{
	inline static constexpr unsigned int ContextCallback_TypeDefinitionIndex = 823;
