...
#define SYSTEM_MATH_ABSHELPER_1_OFFSET UNITYSDK_OFFSET(0x163667E0)
#define SYSTEM_MATH_ABSHELPER_OFFSET UNITYSDK_OFFSET(0x163666E0)
#define SYSTEM_MATH_ABS_1_OFFSET UNITYSDK_OFFSET(0x16366750)
#define SYSTEM_MATH_ABS_2_OFFSET UNITYSDK_OFFSET(0x16366860)
#define SYSTEM_MATH_ABS_3_OFFSET UNITYSDK_OFFSET(0x16366870)
#define SYSTEM_MATH_ABS_4_OFFSET UNITYSDK_OFFSET(0x16366880)
#define SYSTEM_MATH_ABS_OFFSET UNITYSDK_OFFSET(0x16366660)
#define SYSTEM_MATH_ACOS_OFFSET UNITYSDK_OFFSET(0x16365F30)
#define SYSTEM_MATH_ASIN_OFFSET UNITYSDK_OFFSET(0x16365F40)
#define SYSTEM_MATH_ATAN2_OFFSET UNITYSDK_OFFSET(0x16365F60)
#define SYSTEM_MATH_ATAN_OFFSET UNITYSDK_OFFSET(0x16365F50)
#define SYSTEM_MATH_CEILING_OFFSET UNITYSDK_OFFSET(0x16365F70)
#define SYSTEM_MATH_COS_OFFSET UNITYSDK_OFFSET(0x16365F80)
#define SYSTEM_MATH_EXP_OFFSET UNITYSDK_OFFSET(0x16366640)
#define SYSTEM_MATH_FLOOR_1_OFFSET UNITYSDK_OFFSET(0x16366000)
#define SYSTEM_MATH_FLOOR_OFFSET UNITYSDK_OFFSET(0x16365F90)
#define SYSTEM_MATH_INTERNALROUND_OFFSET UNITYSDK_OFFSET(0x16366010)
#define SYSTEM_MATH_INTERNALTRUNCATE_OFFSET UNITYSDK_OFFSET(0x16366260)
#define SYSTEM_MATH_LOG10_OFFSET UNITYSDK_OFFSET(0x16366630)
#define SYSTEM_MATH_LOG_1_OFFSET UNITYSDK_OFFSET(0x16366A90)
#define SYSTEM_MATH_LOG_OFFSET UNITYSDK_OFFSET(0x16366620)
#define SYSTEM_MATH_MAX_1_OFFSET UNITYSDK_OFFSET(0x1634C1E0)
#define SYSTEM_MATH_MAX_2_OFFSET UNITYSDK_OFFSET(0x16366930)
#define SYSTEM_MATH_MAX_3_OFFSET UNITYSDK_OFFSET(0x16366940)
#define SYSTEM_MATH_MAX_4_OFFSET UNITYSDK_OFFSET(0x16366950)
#define SYSTEM_MATH_MAX_5_OFFSET UNITYSDK_OFFSET(0x16366980)
#define SYSTEM_MATH_MAX_OFFSET UNITYSDK_OFFSET(0x16366920)
#define SYSTEM_MATH_MIN_1_OFFSET UNITYSDK_OFFSET(0x1634BFF0)
#define SYSTEM_MATH_MIN_2_OFFSET UNITYSDK_OFFSET(0x163669E0)
#define SYSTEM_MATH_MIN_3_OFFSET UNITYSDK_OFFSET(0x163669F0)
#define SYSTEM_MATH_MIN_4_OFFSET UNITYSDK_OFFSET(0x16366A00)
#define SYSTEM_MATH_MIN_5_OFFSET UNITYSDK_OFFSET(0x16366A40)
#define SYSTEM_MATH_MIN_OFFSET UNITYSDK_OFFSET(0x163669D0)
#define SYSTEM_MATH_POW_OFFSET UNITYSDK_OFFSET(0x16366650)
#define SYSTEM_MATH_ROUND_1_OFFSET UNITYSDK_OFFSET(0x16366350)
#define SYSTEM_MATH_ROUND_2_OFFSET UNITYSDK_OFFSET(0x163663E0)
#define SYSTEM_MATH_ROUND_3_OFFSET UNITYSDK_OFFSET(0x163663F0)
#define SYSTEM_MATH_ROUND_4_OFFSET UNITYSDK_OFFSET(0x16366500)
#define SYSTEM_MATH_ROUND_OFFSET UNITYSDK_OFFSET(0x163662A0)
#define SYSTEM_MATH_SIGN_1_OFFSET UNITYSDK_OFFSET(0x16366B50)
#define SYSTEM_MATH_SIGN_2_OFFSET UNITYSDK_OFFSET(0x16366B70)
#define SYSTEM_MATH_SIGN_3_OFFSET UNITYSDK_OFFSET(0x163661F0)
#define SYSTEM_MATH_SIGN_OFFSET UNITYSDK_OFFSET(0x16366B40)
#define SYSTEM_MATH_SIN_OFFSET UNITYSDK_OFFSET(0x16366280)
#define SYSTEM_MATH_SPLITFRACTIONDOUBLE_OFFSET UNITYSDK_OFFSET(0x163661E0)
#define SYSTEM_MATH_SQRT_OFFSET UNITYSDK_OFFSET(0x16366600)
#define SYSTEM_MATH_TAN_OFFSET UNITYSDK_OFFSET(0x16366290)
#define SYSTEM_MATH_TRUNCATE_1_OFFSET UNITYSDK_OFFSET(0x163665E0)
#define SYSTEM_MATH_TRUNCATE_OFFSET UNITYSDK_OFFSET(0x16366570)
#define SYSTEM_MATH__CCTOR_OFFSET UNITYSDK_OFFSET(0x16366C10)
...
namespace System
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Double>**)Il2CppClass::FromTypeDefinitionIndex(Math_TypeDefinitionIndex)->GetStaticField(0x7580);
		}
		static ::System::Double* StaticGet_doubleRoundLimit()
		{
			return (::System::Double*)Il2CppClass::FromTypeDefinitionIndex(Math_TypeDefinitionIndex)->GetStaticField(0x39B0);
		}
