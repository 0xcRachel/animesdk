...
#define SYSTEM_MATH_ABSHELPER_1_OFFSET UNITYSDK_OFFSET(0x1950AD10)
#define SYSTEM_MATH_ABSHELPER_OFFSET UNITYSDK_OFFSET(0x1950AC10)
#define SYSTEM_MATH_ABS_1_OFFSET UNITYSDK_OFFSET(0x1950AC80)
#define SYSTEM_MATH_ABS_2_OFFSET UNITYSDK_OFFSET(0x1950AD90)
#define SYSTEM_MATH_ABS_3_OFFSET UNITYSDK_OFFSET(0x1950ADA0)
#define SYSTEM_MATH_ABS_4_OFFSET UNITYSDK_OFFSET(0x1950ADB0)
#define SYSTEM_MATH_ABS_OFFSET UNITYSDK_OFFSET(0x1950AB90)
#define SYSTEM_MATH_ACOS_OFFSET UNITYSDK_OFFSET(0x1950A460)
#define SYSTEM_MATH_ASIN_OFFSET UNITYSDK_OFFSET(0x1950A470)
#define SYSTEM_MATH_ATAN2_OFFSET UNITYSDK_OFFSET(0x1950A490)
#define SYSTEM_MATH_ATAN_OFFSET UNITYSDK_OFFSET(0x1950A480)
#define SYSTEM_MATH_CEILING_OFFSET UNITYSDK_OFFSET(0x1950A4A0)
#define SYSTEM_MATH_COS_OFFSET UNITYSDK_OFFSET(0x1950A4B0)
#define SYSTEM_MATH_EXP_OFFSET UNITYSDK_OFFSET(0x1950AB70)
#define SYSTEM_MATH_FLOOR_1_OFFSET UNITYSDK_OFFSET(0x1950A530)
#define SYSTEM_MATH_FLOOR_OFFSET UNITYSDK_OFFSET(0x1950A4C0)
#define SYSTEM_MATH_INTERNALROUND_OFFSET UNITYSDK_OFFSET(0x1950A540)
#define SYSTEM_MATH_INTERNALTRUNCATE_OFFSET UNITYSDK_OFFSET(0x1950A790)
#define SYSTEM_MATH_LOG10_OFFSET UNITYSDK_OFFSET(0x1950AB60)
#define SYSTEM_MATH_LOG_1_OFFSET UNITYSDK_OFFSET(0x1950AFD0)
#define SYSTEM_MATH_LOG_OFFSET UNITYSDK_OFFSET(0x1950AB50)
#define SYSTEM_MATH_MAX_1_OFFSET UNITYSDK_OFFSET(0x194F1590)
#define SYSTEM_MATH_MAX_2_OFFSET UNITYSDK_OFFSET(0x1950AE60)
#define SYSTEM_MATH_MAX_3_OFFSET UNITYSDK_OFFSET(0x1950AE70)
#define SYSTEM_MATH_MAX_4_OFFSET UNITYSDK_OFFSET(0x1950AE80)
#define SYSTEM_MATH_MAX_5_OFFSET UNITYSDK_OFFSET(0x1950AE90)
#define SYSTEM_MATH_MAX_6_OFFSET UNITYSDK_OFFSET(0x1950AEC0)
#define SYSTEM_MATH_MAX_OFFSET UNITYSDK_OFFSET(0x1950AE50)
#define SYSTEM_MATH_MIN_1_OFFSET UNITYSDK_OFFSET(0x194F13A0)
#define SYSTEM_MATH_MIN_2_OFFSET UNITYSDK_OFFSET(0x1950AF20)
#define SYSTEM_MATH_MIN_3_OFFSET UNITYSDK_OFFSET(0x1950AF30)
#define SYSTEM_MATH_MIN_4_OFFSET UNITYSDK_OFFSET(0x1950AF40)
#define SYSTEM_MATH_MIN_5_OFFSET UNITYSDK_OFFSET(0x1950AF80)
#define SYSTEM_MATH_MIN_OFFSET UNITYSDK_OFFSET(0x1950AF10)
#define SYSTEM_MATH_POW_OFFSET UNITYSDK_OFFSET(0x1950AB80)
#define SYSTEM_MATH_ROUND_1_OFFSET UNITYSDK_OFFSET(0x1950A880)
#define SYSTEM_MATH_ROUND_2_OFFSET UNITYSDK_OFFSET(0x1950A910)
#define SYSTEM_MATH_ROUND_3_OFFSET UNITYSDK_OFFSET(0x1950A920)
#define SYSTEM_MATH_ROUND_4_OFFSET UNITYSDK_OFFSET(0x1950AA30)
#define SYSTEM_MATH_ROUND_OFFSET UNITYSDK_OFFSET(0x1950A7D0)
#define SYSTEM_MATH_SIGN_1_OFFSET UNITYSDK_OFFSET(0x1950B090)
#define SYSTEM_MATH_SIGN_2_OFFSET UNITYSDK_OFFSET(0x1950B0B0)
#define SYSTEM_MATH_SIGN_3_OFFSET UNITYSDK_OFFSET(0x1950A720)
#define SYSTEM_MATH_SIGN_OFFSET UNITYSDK_OFFSET(0x1950B080)
#define SYSTEM_MATH_SIN_OFFSET UNITYSDK_OFFSET(0x1950A7B0)
#define SYSTEM_MATH_SPLITFRACTIONDOUBLE_OFFSET UNITYSDK_OFFSET(0x1950A710)
#define SYSTEM_MATH_SQRT_OFFSET UNITYSDK_OFFSET(0x1950AB30)
#define SYSTEM_MATH_TAN_OFFSET UNITYSDK_OFFSET(0x1950A7C0)
#define SYSTEM_MATH_TRUNCATE_1_OFFSET UNITYSDK_OFFSET(0x1950AB10)
#define SYSTEM_MATH_TRUNCATE_OFFSET UNITYSDK_OFFSET(0x1950AAA0)
#define SYSTEM_MATH__CCTOR_OFFSET UNITYSDK_OFFSET(0x1950B150)
...
namespace System
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Double>**)Il2CppClass::FromTypeDefinitionIndex(Math_TypeDefinitionIndex)->GetStaticField(0x6A60);
		}
		static ::System::Double* StaticGet_doubleRoundLimit()
		{
			return (::System::Double*)Il2CppClass::FromTypeDefinitionIndex(Math_TypeDefinitionIndex)->GetStaticField(0x20F0);
		}
