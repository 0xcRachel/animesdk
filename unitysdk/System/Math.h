...
#define SYSTEM_MATH_ABSHELPER_1_OFFSET UNITYSDK_OFFSET(0x1A081960)
#define SYSTEM_MATH_ABSHELPER_OFFSET UNITYSDK_OFFSET(0x1A081860)
#define SYSTEM_MATH_ABS_1_OFFSET UNITYSDK_OFFSET(0x1A0818D0)
#define SYSTEM_MATH_ABS_2_OFFSET UNITYSDK_OFFSET(0x1A0819E0)
#define SYSTEM_MATH_ABS_3_OFFSET UNITYSDK_OFFSET(0x1A0819F0)
#define SYSTEM_MATH_ABS_4_OFFSET UNITYSDK_OFFSET(0x1A081A00)
#define SYSTEM_MATH_ABS_OFFSET UNITYSDK_OFFSET(0x1A0817E0)
#define SYSTEM_MATH_ACOS_OFFSET UNITYSDK_OFFSET(0x1A0810F0)
#define SYSTEM_MATH_ASIN_OFFSET UNITYSDK_OFFSET(0x1A081100)
#define SYSTEM_MATH_ATAN2_OFFSET UNITYSDK_OFFSET(0x1A081120)
#define SYSTEM_MATH_ATAN_OFFSET UNITYSDK_OFFSET(0x1A081110)
#define SYSTEM_MATH_CEILING_OFFSET UNITYSDK_OFFSET(0x1A081130)
#define SYSTEM_MATH_COS_OFFSET UNITYSDK_OFFSET(0x1A081140)
#define SYSTEM_MATH_EXP_OFFSET UNITYSDK_OFFSET(0x1A0817C0)
#define SYSTEM_MATH_FLOOR_1_OFFSET UNITYSDK_OFFSET(0x1A0811C0)
#define SYSTEM_MATH_FLOOR_OFFSET UNITYSDK_OFFSET(0x1A081150)
#define SYSTEM_MATH_INTERNALROUND_OFFSET UNITYSDK_OFFSET(0x1A0811D0)
#define SYSTEM_MATH_INTERNALTRUNCATE_OFFSET UNITYSDK_OFFSET(0x1A081410)
#define SYSTEM_MATH_LOG10_OFFSET UNITYSDK_OFFSET(0x1A0817B0)
#define SYSTEM_MATH_LOG_1_OFFSET UNITYSDK_OFFSET(0x1A081C20)
#define SYSTEM_MATH_LOG_OFFSET UNITYSDK_OFFSET(0x1A0817A0)
#define SYSTEM_MATH_MAX_1_OFFSET UNITYSDK_OFFSET(0x1A0689C0)
#define SYSTEM_MATH_MAX_2_OFFSET UNITYSDK_OFFSET(0x1A081AB0)
#define SYSTEM_MATH_MAX_3_OFFSET UNITYSDK_OFFSET(0x1A081AC0)
#define SYSTEM_MATH_MAX_4_OFFSET UNITYSDK_OFFSET(0x1A081AD0)
#define SYSTEM_MATH_MAX_5_OFFSET UNITYSDK_OFFSET(0x1A081AE0)
#define SYSTEM_MATH_MAX_6_OFFSET UNITYSDK_OFFSET(0x1A081B10)
#define SYSTEM_MATH_MAX_OFFSET UNITYSDK_OFFSET(0x1A081AA0)
#define SYSTEM_MATH_MIN_1_OFFSET UNITYSDK_OFFSET(0x1A0687D0)
#define SYSTEM_MATH_MIN_2_OFFSET UNITYSDK_OFFSET(0x1A081B70)
#define SYSTEM_MATH_MIN_3_OFFSET UNITYSDK_OFFSET(0x1A081B80)
#define SYSTEM_MATH_MIN_4_OFFSET UNITYSDK_OFFSET(0x1A081B90)
#define SYSTEM_MATH_MIN_5_OFFSET UNITYSDK_OFFSET(0x1A081BD0)
#define SYSTEM_MATH_MIN_OFFSET UNITYSDK_OFFSET(0x1A081B60)
#define SYSTEM_MATH_POW_OFFSET UNITYSDK_OFFSET(0x1A0817D0)
#define SYSTEM_MATH_ROUND_1_OFFSET UNITYSDK_OFFSET(0x1A081500)
#define SYSTEM_MATH_ROUND_2_OFFSET UNITYSDK_OFFSET(0x1A081560)
#define SYSTEM_MATH_ROUND_3_OFFSET UNITYSDK_OFFSET(0x1A081570)
#define SYSTEM_MATH_ROUND_4_OFFSET UNITYSDK_OFFSET(0x1A081680)
#define SYSTEM_MATH_ROUND_OFFSET UNITYSDK_OFFSET(0x1A081450)
#define SYSTEM_MATH_SIGN_1_OFFSET UNITYSDK_OFFSET(0x1A081CE0)
#define SYSTEM_MATH_SIGN_2_OFFSET UNITYSDK_OFFSET(0x1A081D00)
#define SYSTEM_MATH_SIGN_3_OFFSET UNITYSDK_OFFSET(0x1A0813A0)
#define SYSTEM_MATH_SIGN_OFFSET UNITYSDK_OFFSET(0x1A081CD0)
#define SYSTEM_MATH_SIN_OFFSET UNITYSDK_OFFSET(0x1A081430)
#define SYSTEM_MATH_SPLITFRACTIONDOUBLE_OFFSET UNITYSDK_OFFSET(0x1A081390)
#define SYSTEM_MATH_SQRT_OFFSET UNITYSDK_OFFSET(0x1A081780)
#define SYSTEM_MATH_TAN_OFFSET UNITYSDK_OFFSET(0x1A081440)
#define SYSTEM_MATH_TRUNCATE_1_OFFSET UNITYSDK_OFFSET(0x1A081760)
#define SYSTEM_MATH_TRUNCATE_OFFSET UNITYSDK_OFFSET(0x1A0816F0)
#define SYSTEM_MATH__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A081DA0)
...
namespace System
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Double>**)Il2CppClass::FromTypeDefinitionIndex(Math_TypeDefinitionIndex)->GetStaticField(0x95C0);
		}
		static ::System::Double* StaticGet_doubleRoundLimit()
		{
			return (::System::Double*)Il2CppClass::FromTypeDefinitionIndex(Math_TypeDefinitionIndex)->GetStaticField(0x40A0);
		}
