...
#define SYSTEM_REFLECTION_MONOASSEMBLY_GETMODULES_OFFSET UNITYSDK_OFFSET(0x19057830)
#define SYSTEM_REFLECTION_MONOASSEMBLY_GETMODULE_OFFSET UNITYSDK_OFFSET(0x19057670)
#define SYSTEM_REFLECTION_MONOASSEMBLY_GETTYPE_OFFSET UNITYSDK_OFFSET(0x190575E0)
#define SYSTEM_REFLECTION_MONOASSEMBLY__CTOR_OFFSET UNITYSDK_OFFSET(0x19057A30)
