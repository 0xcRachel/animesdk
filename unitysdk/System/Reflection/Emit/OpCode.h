...
#define SYSTEM_REFLECTION_EMIT_OPCODE_EQUALS_OFFSET UNITYSDK_OFFSET(0x22F7690)
#define SYSTEM_REFLECTION_EMIT_OPCODE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x22F7600)
#define SYSTEM_REFLECTION_EMIT_OPCODE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x22F76F0)
#define SYSTEM_REFLECTION_EMIT_OPCODE_GET_OPERANDTYPE_OFFSET UNITYSDK_OFFSET(0x22E5E00)
#define SYSTEM_REFLECTION_EMIT_OPCODE_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x1CED0F0)
#define SYSTEM_REFLECTION_EMIT_OPCODE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1904EA70)
#define SYSTEM_REFLECTION_EMIT_OPCODE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x22F76F0)
#define SYSTEM_REFLECTION_EMIT_OPCODE__CTOR_OFFSET UNITYSDK_OFFSET(0x22F75D0)
