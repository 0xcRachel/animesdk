...
#define SYSTEM_TYPESPEC_ADDMODIFIER_OFFSET UNITYSDK_OFFSET(0x15BBC2B0)
#define SYSTEM_TYPESPEC_ADDNAME_OFFSET UNITYSDK_OFFSET(0x15BBC1C0)
#define SYSTEM_TYPESPEC_BOUNDCHECK_OFFSET UNITYSDK_OFFSET(0x15BBC3D0)
#define SYSTEM_TYPESPEC_GETDISPLAYFULLNAME_OFFSET UNITYSDK_OFFSET(0x15BBA9D0)
#define SYSTEM_TYPESPEC_GETMODIFIERSTRING_OFFSET UNITYSDK_OFFSET(0x15BBADB0)
#define SYSTEM_TYPESPEC_GET_DISPLAYFULLNAME_OFFSET UNITYSDK_OFFSET(0x15BBAD80)
#define SYSTEM_TYPESPEC_GET_HASMODIFIERS_OFFSET UNITYSDK_OFFSET(0x15BBA9C0)
#define SYSTEM_TYPESPEC_PARSEDTYPEIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x15BBC280)
#define SYSTEM_TYPESPEC_PARSE_1_OFFSET UNITYSDK_OFFSET(0x15BBAF90)
#define SYSTEM_TYPESPEC_PARSE_OFFSET UNITYSDK_OFFSET(0x15BB9FD0)
#define SYSTEM_TYPESPEC_RESOLVE_OFFSET UNITYSDK_OFFSET(0x15BBA090)
#define SYSTEM_TYPESPEC_SKIPSPACE_OFFSET UNITYSDK_OFFSET(0x15BBC340)
#define SYSTEM_TYPESPEC_UNESCAPEINTERNALNAME_OFFSET UNITYSDK_OFFSET(0x15BB9630)
#define SYSTEM_TYPESPEC__CTOR_OFFSET UNITYSDK_OFFSET(0x15BBC450)
...
namespace System
{
	...
	public:
		...
		::System::Collections::Generic::List_1<::System::ModifierSpec*>* modifier_spec; // 0x30
		::System::Collections::Generic::List_1<::System::TypeIdentifier*>* nested; // 0x38
