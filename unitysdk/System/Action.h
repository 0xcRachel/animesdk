...
#define SYSTEM_ACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x166F5850)
#define SYSTEM_ACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x166F5880)
#define SYSTEM_ACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x166F55B0)
#define SYSTEM_ACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x166F5590)
