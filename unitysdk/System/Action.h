...
#define SYSTEM_ACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x161BBB20)
#define SYSTEM_ACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x161BBB50)
#define SYSTEM_ACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x161BB880)
#define SYSTEM_ACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x161BB860)
