...
#define SYSTEM_NET_HTTP_HTTPCLIENTHANDLER__SENDASYNC_D__64_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x2103530)
#define SYSTEM_NET_HTTP_HTTPCLIENTHANDLER__SENDASYNC_D__64_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0xC5FF20)
...
namespace System::Net::Http
{
	...
	struct alignas(8) HttpClientHandler__SendAsync_d__64
	{
		...
		::System::Net::Http::HttpContent* _content_5__2; // 0x28
		::System::Runtime::CompilerServices::TaskAwaiter_1<::System::Net::Http::HttpResponseMessage*> __u__4; // 0x30
		...
		::System::Runtime::CompilerServices::ConfiguredTaskAwaitable_1_ConfiguredTaskAwaiter<::System::Net::WebResponse*> __u__3; // 0x58
		::System::IO::Stream* _stream_5__3; // 0x68
		::System::Threading::CancellationTokenRegistration __7__wrap1; // 0x70
		::System::Net::Http::HttpClientHandler* __4__this; // 0x88
		::System::Net::HttpWebResponse* _wresponse_5__4; // 0x90
		::System::Threading::CancellationToken cancellationToken; // 0x98
		::System::Net::Http::HttpRequestMessage* request; // 0xA0
		::System::Net::HttpWebRequest* _wrequest_5__1; // 0xA8
