...
#define SYSTEM_NET_HTTP_HTTPCLIENT__SENDASYNCWORKER_D__47_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3924680)
#define SYSTEM_NET_HTTP_HTTPCLIENT__SENDASYNCWORKER_D__47_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x3750890)
...
namespace System::Net::Http
{
	...
	struct alignas(8) HttpClient__SendAsyncWorker_d__47
	{
		...
		::System::Threading::CancellationTokenSource* _lcts_5__2; // 0x48
