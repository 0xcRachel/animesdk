...
#define SYSTEM_NET_HEADERVARIANTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x735E0)

namespace System::Net
{
	inline static constexpr unsigned int HeaderVariantInfo_TypeDefinitionIndex = 2783;
