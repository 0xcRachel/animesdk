...
#define SYSTEM_NET_LAZYASYNCRESULT_THREADCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x17EE2030)

namespace System::Net
{
	inline static constexpr unsigned int LazyAsyncResult_ThreadContext_TypeDefinitionIndex = 2761;
