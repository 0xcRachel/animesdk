...
#define SYSTEM_NET_SECURITY_LOCALCERTSELECTIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17EED670)
#define SYSTEM_NET_SECURITY_LOCALCERTSELECTIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17EED6C0)
#define SYSTEM_NET_SECURITY_LOCALCERTSELECTIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x17EECD30)
#define SYSTEM_NET_SECURITY_LOCALCERTSELECTIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x17EECD10)

namespace System::Net::Security
{
	inline static constexpr unsigned int LocalCertSelectionCallback_TypeDefinitionIndex = 2905;
