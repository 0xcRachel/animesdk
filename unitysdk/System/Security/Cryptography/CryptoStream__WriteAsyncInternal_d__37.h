...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_CRYPTOSTREAM__WRITEASYNCINTERNAL_D__37_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x37DA450)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_CRYPTOSTREAM__WRITEASYNCINTERNAL_D__37_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x3750890)
...
namespace System::Security::Cryptography
{
	...
	struct alignas(8) CryptoStream__WriteAsyncInternal_d__37
	{
		...
		::System::Security::Cryptography::CryptoStream_HopToThreadPoolAwaitable __u__1; // 0x68
