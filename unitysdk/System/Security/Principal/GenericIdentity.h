...
#define SYSTEM_SECURITY_PRINCIPAL_GENERICIDENTITY_ADDNAMECLAIM_OFFSET UNITYSDK_OFFSET(0x15B34B20)
#define SYSTEM_SECURITY_PRINCIPAL_GENERICIDENTITY_CLONE_OFFSET UNITYSDK_OFFSET(0x15B34C30)
#define SYSTEM_SECURITY_PRINCIPAL_GENERICIDENTITY_GET_AUTHENTICATIONTYPE_OFFSET UNITYSDK_OFFSET(0x15B34D00)
#define SYSTEM_SECURITY_PRINCIPAL_GENERICIDENTITY_GET_CLAIMS_OFFSET UNITYSDK_OFFSET(0x15B34C90)
#define SYSTEM_SECURITY_PRINCIPAL_GENERICIDENTITY_GET_NAME_OFFSET UNITYSDK_OFFSET(0x15B34CF0)
#define SYSTEM_SECURITY_PRINCIPAL_GENERICIDENTITY_ONDESERIALIZEDMETHOD_OFFSET UNITYSDK_OFFSET(0x15B34D10)
#define SYSTEM_SECURITY_PRINCIPAL_GENERICIDENTITY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x15B34BD0)
#define SYSTEM_SECURITY_PRINCIPAL_GENERICIDENTITY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x15B34C00)
#define SYSTEM_SECURITY_PRINCIPAL_GENERICIDENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x15B349C0)

namespace System::Security::Principal
{
	inline static constexpr unsigned int GenericIdentity_TypeDefinitionIndex = 971;
