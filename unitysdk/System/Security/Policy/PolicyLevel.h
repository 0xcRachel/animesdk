...
#define SYSTEM_SECURITY_POLICY_POLICYLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x16DACCF0)
...
namespace System::Security::Policy
{
	...
	public:
		...
		::System::Collections::ArrayList* named_permission_sets; // 0x18
		::System::Security::SecurityElement* xml; // 0x20
		::System::Collections::ArrayList* full_trust_assemblies; // 0x28
		::System::Security::Policy::CodeGroup* root_code_group; // 0x30
		::System::String* _location; // 0x38
