...
#define SYSTEM_SECURITY_POLICY_POLICYLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x15B34980)

namespace System::Security::Policy
{
	inline static constexpr unsigned int PolicyLevel_TypeDefinitionIndex = 948;
