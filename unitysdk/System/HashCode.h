...
#define SYSTEM_HASHCODE_ADD_OFFSET UNITYSDK_OFFSET(0x1FFA4F0)
#define SYSTEM_HASHCODE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1FFA560)
#define SYSTEM_HASHCODE_GENERATEGLOBALSEED_OFFSET UNITYSDK_OFFSET(0x156ABEE0)
#define SYSTEM_HASHCODE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1FFA510)
#define SYSTEM_HASHCODE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x156AC030)
#define SYSTEM_HASHCODE_MIXEMPTYSTATE_OFFSET UNITYSDK_OFFSET(0x156AC190)
#define SYSTEM_HASHCODE_MIXFINAL_OFFSET UNITYSDK_OFFSET(0x156AC1F0)
#define SYSTEM_HASHCODE_MIXSTATE_OFFSET UNITYSDK_OFFSET(0x156AC140)
#define SYSTEM_HASHCODE_QUEUEROUND_OFFSET UNITYSDK_OFFSET(0x156AC100)
#define SYSTEM_HASHCODE_ROUND_OFFSET UNITYSDK_OFFSET(0x156AC0C0)
#define SYSTEM_HASHCODE_TOHASHCODE_OFFSET UNITYSDK_OFFSET(0x1FFA500)
#define SYSTEM_HASHCODE__CCTOR_OFFSET UNITYSDK_OFFSET(0x156AC740)

namespace System
{
	inline static constexpr unsigned int HashCode_TypeDefinitionIndex = 9852;

	struct alignas(4) HashCode
	{
		static ::System::UInt32* StaticGet_s_seed()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(HashCode_TypeDefinitionIndex)->GetStaticField(0x4E0);
		}
