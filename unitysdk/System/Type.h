...
#define SYSTEM_TYPE_BINARYSEARCH_OFFSET UNITYSDK_OFFSET(0x18DAB770)
#define SYSTEM_TYPE_CREATEBINDER_OFFSET UNITYSDK_OFFSET(0x18DA7F90)
#define SYSTEM_TYPE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x18DAC3B0)
#define SYSTEM_TYPE_EQUALS_OFFSET UNITYSDK_OFFSET(0x18DAC350)
#define SYSTEM_TYPE_FINDINTERFACES_OFFSET UNITYSDK_OFFSET(0x18DA8A90)
#define SYSTEM_TYPE_FINDMEMBERS_OFFSET UNITYSDK_OFFSET(0x18DA9440)
#define SYSTEM_TYPE_FORMATTYPENAME_1_OFFSET UNITYSDK_OFFSET(0x18DAC140)
#define SYSTEM_TYPE_FORMATTYPENAME_OFFSET UNITYSDK_OFFSET(0x18DAC120)
#define SYSTEM_TYPE_GETARRAYRANK_OFFSET UNITYSDK_OFFSET(0x18DA8160)
#define SYSTEM_TYPE_GETCONSTRUCTORS_OFFSET UNITYSDK_OFFSET(0x18DA83C0)
#define SYSTEM_TYPE_GETCONSTRUCTOR_1_OFFSET UNITYSDK_OFFSET(0x18DA82D0)
#define SYSTEM_TYPE_GETCONSTRUCTOR_2_OFFSET UNITYSDK_OFFSET(0x18DA8390)
#define SYSTEM_TYPE_GETCONSTRUCTOR_3_OFFSET UNITYSDK_OFFSET(0x18DACC50)
#define SYSTEM_TYPE_GETCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x18DA81C0)
#define SYSTEM_TYPE_GETDEFAULTMEMBERS_OFFSET UNITYSDK_OFFSET(0x18DA93F0)
#define SYSTEM_TYPE_GETENUMDATA_OFFSET UNITYSDK_OFFSET(0x18DAAB10)
#define SYSTEM_TYPE_GETENUMNAMES_OFFSET UNITYSDK_OFFSET(0x18DAAA70)
#define SYSTEM_TYPE_GETENUMNAME_OFFSET UNITYSDK_OFFSET(0x18DABA40)
#define SYSTEM_TYPE_GETENUMRAWCONSTANTVALUES_OFFSET UNITYSDK_OFFSET(0x18DAB060)
#define SYSTEM_TYPE_GETENUMUNDERLYINGTYPE_OFFSET UNITYSDK_OFFSET(0x18DAB090)
#define SYSTEM_TYPE_GETENUMVALUES_OFFSET UNITYSDK_OFFSET(0x18DAAFC0)
#define SYSTEM_TYPE_GETEVENTS_OFFSET UNITYSDK_OFFSET(0x18DA8CB0)
#define SYSTEM_TYPE_GETEVENT_OFFSET UNITYSDK_OFFSET(0x18DA8C90)
#define SYSTEM_TYPE_GETFIELDS_OFFSET UNITYSDK_OFFSET(0x18DA8A50)
#define SYSTEM_TYPE_GETFIELD_1_OFFSET UNITYSDK_OFFSET(0x18DACCA0)
#define SYSTEM_TYPE_GETFIELD_OFFSET UNITYSDK_OFFSET(0x18DA8A30)
#define SYSTEM_TYPE_GETGENERICARGUMENTS_OFFSET UNITYSDK_OFFSET(0x18DAA950)
#define SYSTEM_TYPE_GETGENERICPARAMETERCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x18DAA630)
#define SYSTEM_TYPE_GETGENERICTYPEDEFINITION_OFFSET UNITYSDK_OFFSET(0x18DAAA10)
#define SYSTEM_TYPE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x18DAC3F0)
#define SYSTEM_TYPE_GETINTERFACEMAP_OFFSET UNITYSDK_OFFSET(0x18DAC450)
#define SYSTEM_TYPE_GETINTERFACE_OFFSET UNITYSDK_OFFSET(0x18DA8A70)
#define SYSTEM_TYPE_GETMEMBERS_OFFSET UNITYSDK_OFFSET(0x18DA93D0)
#define SYSTEM_TYPE_GETMEMBER_1_OFFSET UNITYSDK_OFFSET(0x18DA9340)
#define SYSTEM_TYPE_GETMEMBER_2_OFFSET UNITYSDK_OFFSET(0x18DA9370)
#define SYSTEM_TYPE_GETMEMBER_OFFSET UNITYSDK_OFFSET(0x18DA9320)
#define SYSTEM_TYPE_GETMETHODS_OFFSET UNITYSDK_OFFSET(0x18DA8A10)
#define SYSTEM_TYPE_GETMETHOD_1_OFFSET UNITYSDK_OFFSET(0x18DA8570)
#define SYSTEM_TYPE_GETMETHOD_2_OFFSET UNITYSDK_OFFSET(0x18DA86C0)
#define SYSTEM_TYPE_GETMETHOD_3_OFFSET UNITYSDK_OFFSET(0x18DA8800)
#define SYSTEM_TYPE_GETMETHOD_4_OFFSET UNITYSDK_OFFSET(0x18DA8900)
#define SYSTEM_TYPE_GETMETHOD_5_OFFSET UNITYSDK_OFFSET(0x18DA89A0)
#define SYSTEM_TYPE_GETMETHOD_6_OFFSET UNITYSDK_OFFSET(0x18DACC00)
#define SYSTEM_TYPE_GETMETHOD_OFFSET UNITYSDK_OFFSET(0x18DA8420)
#define SYSTEM_TYPE_GETNESTEDTYPES_OFFSET UNITYSDK_OFFSET(0x18DA92E0)
#define SYSTEM_TYPE_GETNESTEDTYPE_OFFSET UNITYSDK_OFFSET(0x18DA9300)
#define SYSTEM_TYPE_GETPROPERTIES_OFFSET UNITYSDK_OFFSET(0x18DA92C0)
#define SYSTEM_TYPE_GETPROPERTY_1_OFFSET UNITYSDK_OFFSET(0x18DA8D80)
#define SYSTEM_TYPE_GETPROPERTY_2_OFFSET UNITYSDK_OFFSET(0x18DA8E60)
#define SYSTEM_TYPE_GETPROPERTY_3_OFFSET UNITYSDK_OFFSET(0x18DA8EF0)
#define SYSTEM_TYPE_GETPROPERTY_4_OFFSET UNITYSDK_OFFSET(0x18DA8FC0)
#define SYSTEM_TYPE_GETPROPERTY_5_OFFSET UNITYSDK_OFFSET(0x18DA9090)
#define SYSTEM_TYPE_GETPROPERTY_6_OFFSET UNITYSDK_OFFSET(0x18DA9160)
#define SYSTEM_TYPE_GETPROPERTY_7_OFFSET UNITYSDK_OFFSET(0x18DA9230)
#define SYSTEM_TYPE_GETPROPERTY_OFFSET UNITYSDK_OFFSET(0x18DA8CD0)
#define SYSTEM_TYPE_GETROOTELEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x18DAA5E0)
#define SYSTEM_TYPE_GETTYPEARRAY_OFFSET UNITYSDK_OFFSET(0x18DAC1E0)
#define SYSTEM_TYPE_GETTYPECODEIMPL_OFFSET UNITYSDK_OFFSET(0x18DA7ED0)
#define SYSTEM_TYPE_GETTYPECODE_OFFSET UNITYSDK_OFFSET(0x18DA7EA0)
#define SYSTEM_TYPE_GETTYPEFROMCLSID_1_OFFSET UNITYSDK_OFFSET(0x18DA7DD0)
#define SYSTEM_TYPE_GETTYPEFROMCLSID_2_OFFSET UNITYSDK_OFFSET(0x18DA7E10)
#define SYSTEM_TYPE_GETTYPEFROMCLSID_3_OFFSET UNITYSDK_OFFSET(0x18DA7E50)
#define SYSTEM_TYPE_GETTYPEFROMCLSID_OFFSET UNITYSDK_OFFSET(0x18DA7D90)
#define SYSTEM_TYPE_GETTYPEFROMHANDLE_OFFSET UNITYSDK_OFFSET(0x18D82DA0)
#define SYSTEM_TYPE_GETTYPEFROMPROGID_1_OFFSET UNITYSDK_OFFSET(0x18DA7CC0)
#define SYSTEM_TYPE_GETTYPEFROMPROGID_2_OFFSET UNITYSDK_OFFSET(0x18DA7D00)
#define SYSTEM_TYPE_GETTYPEFROMPROGID_3_OFFSET UNITYSDK_OFFSET(0x18DA7D40)
#define SYSTEM_TYPE_GETTYPEFROMPROGID_OFFSET UNITYSDK_OFFSET(0x18DA7C80)
#define SYSTEM_TYPE_GETTYPEHANDLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x18DA8090)
#define SYSTEM_TYPE_GETTYPEHANDLE_OFFSET UNITYSDK_OFFSET(0x18DA80A0)
#define SYSTEM_TYPE_GETTYPE_1_OFFSET UNITYSDK_OFFSET(0x18DA7A70)
#define SYSTEM_TYPE_GETTYPE_2_OFFSET UNITYSDK_OFFSET(0x18DA7AB0)
#define SYSTEM_TYPE_GETTYPE_3_OFFSET UNITYSDK_OFFSET(0x18DAC4B0)
#define SYSTEM_TYPE_GETTYPE_4_OFFSET UNITYSDK_OFFSET(0x18DAC660)
#define SYSTEM_TYPE_GETTYPE_5_OFFSET UNITYSDK_OFFSET(0x18DAC860)
#define SYSTEM_TYPE_GETTYPE_6_OFFSET UNITYSDK_OFFSET(0x18DAC760)
#define SYSTEM_TYPE_GETTYPE_OFFSET UNITYSDK_OFFSET(0x18DA79F0)
#define SYSTEM_TYPE_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x18DA9DE0)
#define SYSTEM_TYPE_GET_CONTAINSGENERICPARAMETERS_OFFSET UNITYSDK_OFFSET(0x18DAA4D0)
#define SYSTEM_TYPE_GET_DECLARINGMETHOD_OFFSET UNITYSDK_OFFSET(0x18DA79D0)
#define SYSTEM_TYPE_GET_DECLARINGTYPE_OFFSET UNITYSDK_OFFSET(0x18DA79C0)
#define SYSTEM_TYPE_GET_DEFAULTBINDER_OFFSET UNITYSDK_OFFSET(0x18DA7F40)
#define SYSTEM_TYPE_GET_GENERICPARAMETERATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x18DA9DF0)
#define SYSTEM_TYPE_GET_GENERICPARAMETERPOSITION_OFFSET UNITYSDK_OFFSET(0x18DAA470)
#define SYSTEM_TYPE_GET_GENERICTYPEARGUMENTS_OFFSET UNITYSDK_OFFSET(0x18DAA9B0)
#define SYSTEM_TYPE_GET_HASELEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x18DA9F90)
#define SYSTEM_TYPE_GET_HASPROXYATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x18DAA740)
#define SYSTEM_TYPE_GET_ISABSTRACT_OFFSET UNITYSDK_OFFSET(0x18DAA1E0)
#define SYSTEM_TYPE_GET_ISANSICLASS_OFFSET UNITYSDK_OFFSET(0x18DAA350)
#define SYSTEM_TYPE_GET_ISARRAY_OFFSET UNITYSDK_OFFSET(0x18DAA3D0)
#define SYSTEM_TYPE_GET_ISAUTOCLASS_OFFSET UNITYSDK_OFFSET(0x18DAA3A0)
#define SYSTEM_TYPE_GET_ISAUTOLAYOUT_OFFSET UNITYSDK_OFFSET(0x18DAA0A0)
#define SYSTEM_TYPE_GET_ISBYREF_OFFSET UNITYSDK_OFFSET(0x18DAA6C0)
#define SYSTEM_TYPE_GET_ISCLASS_OFFSET UNITYSDK_OFFSET(0x18DAA100)
#define SYSTEM_TYPE_GET_ISCOMOBJECT_OFFSET UNITYSDK_OFFSET(0x18DAA6F0)
#define SYSTEM_TYPE_GET_ISCONSTRUCTEDGENERICTYPE_OFFSET UNITYSDK_OFFSET(0x18DAA410)
#define SYSTEM_TYPE_GET_ISCONTEXTFUL_OFFSET UNITYSDK_OFFSET(0x18DAA720)
#define SYSTEM_TYPE_GET_ISENUM_OFFSET UNITYSDK_OFFSET(0x18DAA220)
#define SYSTEM_TYPE_GET_ISEXPLICITLAYOUT_OFFSET UNITYSDK_OFFSET(0x18DAA0E0)
#define SYSTEM_TYPE_GET_ISEXPORTEDTOWINDOWSRUNTIME_OFFSET UNITYSDK_OFFSET(0x18DAA710)
#define SYSTEM_TYPE_GET_ISGENERICPARAMETER_OFFSET UNITYSDK_OFFSET(0x18DAA460)
#define SYSTEM_TYPE_GET_ISGENERICTYPEDEFINITION_OFFSET UNITYSDK_OFFSET(0x18DAA400)
#define SYSTEM_TYPE_GET_ISGENERICTYPE_OFFSET UNITYSDK_OFFSET(0x18DAA3F0)
#define SYSTEM_TYPE_GET_ISIMPORT_OFFSET UNITYSDK_OFFSET(0x18DAA290)
#define SYSTEM_TYPE_GET_ISINTERFACE_OFFSET UNITYSDK_OFFSET(0x18DAA150)
#define SYSTEM_TYPE_GET_ISLAYOUTSEQUENTIAL_OFFSET UNITYSDK_OFFSET(0x18DAA0C0)
#define SYSTEM_TYPE_GET_ISMARSHALBYREF_OFFSET UNITYSDK_OFFSET(0x18DAA730)
#define SYSTEM_TYPE_GET_ISNESTEDASSEMBLY_OFFSET UNITYSDK_OFFSET(0x18DAA040)
#define SYSTEM_TYPE_GET_ISNESTEDFAMANDASSEM_OFFSET UNITYSDK_OFFSET(0x18DAA060)
#define SYSTEM_TYPE_GET_ISNESTEDFAMILY_OFFSET UNITYSDK_OFFSET(0x18DAA020)
#define SYSTEM_TYPE_GET_ISNESTEDFAMORASSEM_OFFSET UNITYSDK_OFFSET(0x18DAA080)
#define SYSTEM_TYPE_GET_ISNESTEDPRIVATE_OFFSET UNITYSDK_OFFSET(0x18DAA000)
#define SYSTEM_TYPE_GET_ISNESTEDPUBLIC_OFFSET UNITYSDK_OFFSET(0x18DA9FA0)
#define SYSTEM_TYPE_GET_ISNESTED_OFFSET UNITYSDK_OFFSET(0x18DA9DC0)
#define SYSTEM_TYPE_GET_ISNOTPUBLIC_OFFSET UNITYSDK_OFFSET(0x18DA9FE0)
#define SYSTEM_TYPE_GET_ISPOINTER_OFFSET UNITYSDK_OFFSET(0x18DAA6D0)
#define SYSTEM_TYPE_GET_ISPRIMITIVE_OFFSET UNITYSDK_OFFSET(0x18DAA6E0)
#define SYSTEM_TYPE_GET_ISPUBLIC_OFFSET UNITYSDK_OFFSET(0x18DA9FC0)
#define SYSTEM_TYPE_GET_ISSEALED_OFFSET UNITYSDK_OFFSET(0x18DAA200)
#define SYSTEM_TYPE_GET_ISSECURITYCRITICAL_OFFSET UNITYSDK_OFFSET(0x18DABBE0)
#define SYSTEM_TYPE_GET_ISSECURITYSAFECRITICAL_OFFSET UNITYSDK_OFFSET(0x18DABC30)
#define SYSTEM_TYPE_GET_ISSECURITYTRANSPARENT_OFFSET UNITYSDK_OFFSET(0x18DABC80)
#define SYSTEM_TYPE_GET_ISSERIALIZABLE_OFFSET UNITYSDK_OFFSET(0x18DAA2B0)
#define SYSTEM_TYPE_GET_ISSPECIALNAME_OFFSET UNITYSDK_OFFSET(0x18DAA270)
#define SYSTEM_TYPE_GET_ISSZARRAY_1_OFFSET UNITYSDK_OFFSET(0x18DAC600)
#define SYSTEM_TYPE_GET_ISSZARRAY_OFFSET UNITYSDK_OFFSET(0x18DAA3E0)
#define SYSTEM_TYPE_GET_ISUNICODECLASS_OFFSET UNITYSDK_OFFSET(0x18DAA370)
#define SYSTEM_TYPE_GET_ISUSERTYPE_OFFSET UNITYSDK_OFFSET(0x18DACBF0)
#define SYSTEM_TYPE_GET_ISVALUETYPE_OFFSET UNITYSDK_OFFSET(0x18DAA140)
#define SYSTEM_TYPE_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x18DA9E40)
#define SYSTEM_TYPE_GET_ISWINDOWSRUNTIMEOBJECT_OFFSET UNITYSDK_OFFSET(0x18DAA700)
#define SYSTEM_TYPE_GET_MEMBERTYPE_OFFSET UNITYSDK_OFFSET(0x18DA79B0)
#define SYSTEM_TYPE_GET_NEEDSREFLECTIONSECURITYCHECK_OFFSET UNITYSDK_OFFSET(0x18DABCD0)
#define SYSTEM_TYPE_GET_REFLECTEDTYPE_OFFSET UNITYSDK_OFFSET(0x18DA79E0)
#define SYSTEM_TYPE_GET_STRUCTLAYOUTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x18DA7B40)
#define SYSTEM_TYPE_GET_TYPEHANDLE_OFFSET UNITYSDK_OFFSET(0x18DA8040)
#define SYSTEM_TYPE_GET_TYPEINITIALIZER_OFFSET UNITYSDK_OFFSET(0x18DA83E0)
#define SYSTEM_TYPE_HASPROXYATTRIBUTEIMPL_OFFSET UNITYSDK_OFFSET(0x18DAA940)
#define SYSTEM_TYPE_IMPLEMENTINTERFACE_OFFSET UNITYSDK_OFFSET(0x18DAC060)
#define SYSTEM_TYPE_INTERNALRESOLVE_OFFSET UNITYSDK_OFFSET(0x18DACB90)
#define SYSTEM_TYPE_INTERNAL_FROM_HANDLE_OFFSET UNITYSDK_OFFSET(0x18DACCF0)
#define SYSTEM_TYPE_INTERNAL_FROM_NAME_OFFSET UNITYSDK_OFFSET(0x18DAC650)
#define SYSTEM_TYPE_INVOKEMEMBER_1_OFFSET UNITYSDK_OFFSET(0x18DA8010)
#define SYSTEM_TYPE_INVOKEMEMBER_OFFSET UNITYSDK_OFFSET(0x18DA7FD0)
#define SYSTEM_TYPE_ISASSIGNABLEFROM_OFFSET UNITYSDK_OFFSET(0x18DABE80)
#define SYSTEM_TYPE_ISCONTEXTFULIMPL_OFFSET UNITYSDK_OFFSET(0x18DAA8A0)
#define SYSTEM_TYPE_ISENUMDEFINED_OFFSET UNITYSDK_OFFSET(0x18DAB180)
#define SYSTEM_TYPE_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x18DAC110)
#define SYSTEM_TYPE_ISEXPORTEDTOWINDOWSRUNTIMEIMPL_OFFSET UNITYSDK_OFFSET(0x18DAA7F0)
#define SYSTEM_TYPE_ISINSTANCEOFTYPE_OFFSET UNITYSDK_OFFSET(0x18DABE40)
#define SYSTEM_TYPE_ISINTEGERTYPE_OFFSET UNITYSDK_OFFSET(0x18DAB5C0)
#define SYSTEM_TYPE_ISMARSHALBYREFIMPL_OFFSET UNITYSDK_OFFSET(0x18DAA8F0)
#define SYSTEM_TYPE_ISSUBCLASSOF_OFFSET UNITYSDK_OFFSET(0x18DABDF0)
#define SYSTEM_TYPE_ISVALUETYPEIMPL_OFFSET UNITYSDK_OFFSET(0x18DAA750)
#define SYSTEM_TYPE_ISWINDOWSRUNTIMEOBJECTIMPL_OFFSET UNITYSDK_OFFSET(0x18DAA7A0)
#define SYSTEM_TYPE_MAKEARRAYTYPE_1_OFFSET UNITYSDK_OFFSET(0x18DA7C30)
#define SYSTEM_TYPE_MAKEARRAYTYPE_OFFSET UNITYSDK_OFFSET(0x18DA7BE0)
#define SYSTEM_TYPE_MAKEBYREFTYPE_OFFSET UNITYSDK_OFFSET(0x18DA7B90)
#define SYSTEM_TYPE_MAKEGENERICTYPE_OFFSET UNITYSDK_OFFSET(0x18DAA840)
#define SYSTEM_TYPE_MAKEPOINTERTYPE_OFFSET UNITYSDK_OFFSET(0x18DA7AF0)
#define SYSTEM_TYPE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x18DA7EC0)
#define SYSTEM_TYPE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x18D82DD0)
#define SYSTEM_TYPE_REFLECTIONONLYGETTYPE_OFFSET UNITYSDK_OFFSET(0x18DAC920)
#define SYSTEM_TYPE_RUNTIMERESOLVE_OFFSET UNITYSDK_OFFSET(0x18DACBA0)
#define SYSTEM_TYPE_SYSTEM_RUNTIME_INTEROPSERVICES__TYPE_GETIDSOFNAMES_OFFSET UNITYSDK_OFFSET(0x18DAC560)
#define SYSTEM_TYPE_SYSTEM_RUNTIME_INTEROPSERVICES__TYPE_GETTYPEINFOCOUNT_OFFSET UNITYSDK_OFFSET(0x18DAC4C0)
#define SYSTEM_TYPE_SYSTEM_RUNTIME_INTEROPSERVICES__TYPE_GETTYPEINFO_OFFSET UNITYSDK_OFFSET(0x18DAC510)
#define SYSTEM_TYPE_SYSTEM_RUNTIME_INTEROPSERVICES__TYPE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18DAC5B0)
#define SYSTEM_TYPE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x18DAC190)
#define SYSTEM_TYPE__CCTOR_OFFSET UNITYSDK_OFFSET(0x18DACD10)
#define SYSTEM_TYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x18DA79A0)
