...
#define SYSTEM_NUINT_OP_EXPLICIT_1_OFFSET UNITYSDK_OFFSET(0x18530710)
#define SYSTEM_NUINT_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x18530700)
#define SYSTEM_NUINT_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x18530720)
#define SYSTEM_NUINT__CTOR_1_OFFSET UNITYSDK_OFFSET(0xBDC0)
#define SYSTEM_NUINT__CTOR_OFFSET UNITYSDK_OFFSET(0x20D7D60)
