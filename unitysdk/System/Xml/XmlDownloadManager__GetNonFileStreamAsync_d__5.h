...
#define SYSTEM_XML_XMLDOWNLOADMANAGER__GETNONFILESTREAMASYNC_D__5_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x2030CD0)
#define SYSTEM_XML_XMLDOWNLOADMANAGER__GETNONFILESTREAMASYNC_D__5_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x1FFA260)

namespace System::Xml
{
	inline static constexpr unsigned int XmlDownloadManager__GetNonFileStreamAsync_d__5_TypeDefinitionIndex = 1929;
	...
	struct alignas(8) XmlDownloadManager__GetNonFileStreamAsync_d__5
	{
		...
		::System::Xml::XmlDownloadManager* __4__this; // 0x30
		::System::Uri* uri; // 0x38
		...
		::System::Net::WebRequest* _req_5__1; // 0x60
