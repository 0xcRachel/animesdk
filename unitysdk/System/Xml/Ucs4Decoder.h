...
#define SYSTEM_XML_UCS4DECODER_CONVERT_OFFSET UNITYSDK_OFFSET(0x17DD8950)
#define SYSTEM_XML_UCS4DECODER_GETCHARCOUNT_OFFSET UNITYSDK_OFFSET(0x17DD8700)
#define SYSTEM_XML_UCS4DECODER_GETCHARS_OFFSET UNITYSDK_OFFSET(0x17DD8720)
#define SYSTEM_XML_UCS4DECODER_UCS4TOUTF16_OFFSET UNITYSDK_OFFSET(0x17DD8C90)
#define SYSTEM_XML_UCS4DECODER__CTOR_OFFSET UNITYSDK_OFFSET(0x17DD8D10)

namespace System::Xml
{
	inline static constexpr unsigned int Ucs4Decoder_TypeDefinitionIndex = 1940;
