...
#define SYSTEM_XML_UCS4ENCODING_GETBYTECOUNT_1_OFFSET UNITYSDK_OFFSET(0x17DD9C50)
#define SYSTEM_XML_UCS4ENCODING_GETBYTECOUNT_OFFSET UNITYSDK_OFFSET(0x17DD9BF0)
#define SYSTEM_XML_UCS4ENCODING_GETBYTES_1_OFFSET UNITYSDK_OFFSET(0x17DD9C80)
#define SYSTEM_XML_UCS4ENCODING_GETBYTES_OFFSET UNITYSDK_OFFSET(0x17DD9C70)
#define SYSTEM_XML_UCS4ENCODING_GETCHARCOUNT_1_OFFSET UNITYSDK_OFFSET(0x17DD9D10)
#define SYSTEM_XML_UCS4ENCODING_GETCHARCOUNT_OFFSET UNITYSDK_OFFSET(0x17DD9CA0)
#define SYSTEM_XML_UCS4ENCODING_GETCHARS_OFFSET UNITYSDK_OFFSET(0x17DD9CD0)
#define SYSTEM_XML_UCS4ENCODING_GETDECODER_OFFSET UNITYSDK_OFFSET(0x17DD9BE0)
#define SYSTEM_XML_UCS4ENCODING_GETENCODER_OFFSET UNITYSDK_OFFSET(0x17DD9D40)
#define SYSTEM_XML_UCS4ENCODING_GETMAXBYTECOUNT_OFFSET UNITYSDK_OFFSET(0x17DD9C90)
#define SYSTEM_XML_UCS4ENCODING_GETMAXCHARCOUNT_OFFSET UNITYSDK_OFFSET(0x17DD9CF0)
#define SYSTEM_XML_UCS4ENCODING_GET_CODEPAGE_OFFSET UNITYSDK_OFFSET(0x17DD9D00)
#define SYSTEM_XML_UCS4ENCODING_GET_UCS4_2143_OFFSET UNITYSDK_OFFSET(0x17DD9F70)
#define SYSTEM_XML_UCS4ENCODING_GET_UCS4_3412_OFFSET UNITYSDK_OFFSET(0x17DDA080)
#define SYSTEM_XML_UCS4ENCODING_GET_UCS4_BIGENDIAN_OFFSET UNITYSDK_OFFSET(0x17DD9E60)
#define SYSTEM_XML_UCS4ENCODING_GET_UCS4_LITTLEENDIAN_OFFSET UNITYSDK_OFFSET(0x17DD9D50)
#define SYSTEM_XML_UCS4ENCODING_GET_WEBNAME_OFFSET UNITYSDK_OFFSET(0x17DD9BD0)
#define SYSTEM_XML_UCS4ENCODING__CTOR_OFFSET UNITYSDK_OFFSET(0x17DDA190)

namespace System::Xml
{
	inline static constexpr unsigned int Ucs4Encoding_TypeDefinitionIndex = 1935;
