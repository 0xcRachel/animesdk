...
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTEEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x17DAB730)

namespace System::Xml::Serialization
{
	inline static constexpr unsigned int XmlAttributeEventArgs_TypeDefinitionIndex = 1965;
