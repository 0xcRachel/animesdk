...
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTEATTRIBUTE_GET_ATTRIBUTENAME_OFFSET UNITYSDK_OFFSET(0x185DAD50)
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTEATTRIBUTE_GET_DATATYPE_OFFSET UNITYSDK_OFFSET(0x185DAD70)
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTEATTRIBUTE_GET_FORM_OFFSET UNITYSDK_OFFSET(0x185DADA0)
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTEATTRIBUTE_GET_NAMESPACE_OFFSET UNITYSDK_OFFSET(0x185DADB0)
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTEATTRIBUTE_SET_DATATYPE_OFFSET UNITYSDK_OFFSET(0x185DAD90)
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x185DAD40)
