...
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTEATTRIBUTE_GET_ATTRIBUTENAME_OFFSET UNITYSDK_OFFSET(0x17DAB6C0)
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTEATTRIBUTE_GET_DATATYPE_OFFSET UNITYSDK_OFFSET(0x17DAB6E0)
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTEATTRIBUTE_GET_FORM_OFFSET UNITYSDK_OFFSET(0x17DAB710)
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTEATTRIBUTE_GET_NAMESPACE_OFFSET UNITYSDK_OFFSET(0x17DAB720)
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTEATTRIBUTE_SET_DATATYPE_OFFSET UNITYSDK_OFFSET(0x17DAB700)
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x17DAB6B0)

namespace System::Xml::Serialization
{
	inline static constexpr unsigned int XmlAttributeAttribute_TypeDefinitionIndex = 1985;
