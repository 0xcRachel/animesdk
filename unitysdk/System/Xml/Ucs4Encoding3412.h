...
#define SYSTEM_XML_UCS4ENCODING3412_GETPREAMBLE_OFFSET UNITYSDK_OFFSET(0x17DDA330)
#define SYSTEM_XML_UCS4ENCODING3412_GET_ENCODINGNAME_OFFSET UNITYSDK_OFFSET(0x17DDA2F0)
#define SYSTEM_XML_UCS4ENCODING3412__CTOR_OFFSET UNITYSDK_OFFSET(0x17DDA120)

namespace System::Xml
{
	inline static constexpr unsigned int Ucs4Encoding3412_TypeDefinitionIndex = 1939;
