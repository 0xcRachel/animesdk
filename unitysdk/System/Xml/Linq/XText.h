...
#define SYSTEM_XML_LINQ_XTEXT_APPENDTEXT_OFFSET UNITYSDK_OFFSET(0x185741E0)
#define SYSTEM_XML_LINQ_XTEXT_CLONENODE_OFFSET UNITYSDK_OFFSET(0x18574210)
#define SYSTEM_XML_LINQ_XTEXT_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x18574110)
#define SYSTEM_XML_LINQ_XTEXT_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x18574120)
#define SYSTEM_XML_LINQ_XTEXT_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1856D170)
#define SYSTEM_XML_LINQ_XTEXT_WRITETO_OFFSET UNITYSDK_OFFSET(0x18574130)
#define SYSTEM_XML_LINQ_XTEXT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1856B330)
#define SYSTEM_XML_LINQ_XTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1856B250)
