...
#define SYSTEM_XML_XMLNAMESPACEMANAGER_NAMESPACEDECLARATION_SET_OFFSET UNITYSDK_OFFSET(0x2031290)

namespace System::Xml
{
	inline static constexpr unsigned int XmlNamespaceManager_NamespaceDeclaration_TypeDefinitionIndex = 1948;
