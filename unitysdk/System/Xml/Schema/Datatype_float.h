...
#define SYSTEM_XML_SCHEMA_DATATYPE_FLOAT_COMPARE_OFFSET UNITYSDK_OFFSET(0x1859CC90)
#define SYSTEM_XML_SCHEMA_DATATYPE_FLOAT_CREATEVALUECONVERTER_OFFSET UNITYSDK_OFFSET(0x1859CB00)
#define SYSTEM_XML_SCHEMA_DATATYPE_FLOAT_GET_BUILTINWHITESPACEFACET_OFFSET UNITYSDK_OFFSET(0x1859CC80)
#define SYSTEM_XML_SCHEMA_DATATYPE_FLOAT_GET_FACETSCHECKER_OFFSET UNITYSDK_OFFSET(0x1859CB50)
#define SYSTEM_XML_SCHEMA_DATATYPE_FLOAT_GET_LISTVALUETYPE_OFFSET UNITYSDK_OFFSET(0x1859CC20)
#define SYSTEM_XML_SCHEMA_DATATYPE_FLOAT_GET_TYPECODE_OFFSET UNITYSDK_OFFSET(0x1859CBB0)
#define SYSTEM_XML_SCHEMA_DATATYPE_FLOAT_GET_VALUETYPE_OFFSET UNITYSDK_OFFSET(0x1859CBC0)
#define SYSTEM_XML_SCHEMA_DATATYPE_FLOAT_TRYPARSEVALUE_OFFSET UNITYSDK_OFFSET(0x1859CDE0)
#define SYSTEM_XML_SCHEMA_DATATYPE_FLOAT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1859CF60)
#define SYSTEM_XML_SCHEMA_DATATYPE_FLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x185939C0)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		{
			return (::System::Type**)Il2CppClass::FromTypeDefinitionIndex(Datatype_float_TypeDefinitionIndex)->GetStaticField(0x14360);
		}
		static ::System::Type** StaticGet_atomicValueType()
		{
			return (::System::Type**)Il2CppClass::FromTypeDefinitionIndex(Datatype_float_TypeDefinitionIndex)->GetStaticField(0x14368);
		}
