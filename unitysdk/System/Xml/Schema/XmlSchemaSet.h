...
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_COPYTO_OFFSET UNITYSDK_OFFSET(0x17D95090)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x17D95060)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_INTERNALVALIDATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x17D95200)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17D94D10)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET__CTOR_OFFSET UNITYSDK_OFFSET(0x17D94C50)

namespace System::Xml::Schema
{
	inline static constexpr unsigned int XmlSchemaSet_TypeDefinitionIndex = 2193;

	class XmlSchemaSet : public ::System::Object
	{
	public:
		::System::Xml::XmlReaderSettings* readerSettings; // 0x10
		::System::Xml::Schema::SchemaInfo* cachedCompiledInfo; // 0x18
		::System::Collections::Hashtable* chameleonSchemas; // 0x20
		...
		::System::Collections::Hashtable* targetNamespaces; // 0x58
