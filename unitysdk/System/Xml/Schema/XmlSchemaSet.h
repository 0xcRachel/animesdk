...
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_COPYTO_OFFSET UNITYSDK_OFFSET(0x1854E6F0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1854E6C0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_INTERNALVALIDATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x1854E860)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1854E380)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET__CTOR_OFFSET UNITYSDK_OFFSET(0x1854E2C0)
...
namespace System::Xml::Schema
{
	...
	{
	public:
		::System::Collections::Hashtable* targetNamespaces; // 0x10
		...
		::System::Xml::Schema::ValidationEventHandler* internalEventHandler; // 0x38
		::System::Xml::XmlNameTable* nameTable; // 0x40
		::System::Collections::SortedList* schemas; // 0x48
