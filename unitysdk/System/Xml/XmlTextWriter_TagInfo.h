...
#define SYSTEM_XML_XMLTEXTWRITER_TAGINFO_INIT_OFFSET UNITYSDK_OFFSET(0x2031600)

namespace System::Xml
{
	inline static constexpr unsigned int XmlTextWriter_TagInfo_TypeDefinitionIndex = 1847;
