...
#define SYSTEM_NUMBERFORMATTER_CUSTOMINFO_FORMAT_OFFSET UNITYSDK_OFFSET(0x190403C0)
#define SYSTEM_NUMBERFORMATTER_CUSTOMINFO_GETACTIVESECTION_OFFSET UNITYSDK_OFFSET(0x1903F810)
#define SYSTEM_NUMBERFORMATTER_CUSTOMINFO_PARSE_OFFSET UNITYSDK_OFFSET(0x1903FC60)
#define SYSTEM_NUMBERFORMATTER_CUSTOMINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19041310)
...
namespace System
{
	...
	public:
		...
		::System::Int32 DecimalDigits; // 0x14
		::System::Int32 IntegerHeadPos; // 0x18
		...
		::System::Boolean UseExponent; // 0x30
		::System::Boolean ExponentNegativeSignOnly; // 0x31
		::System::Boolean UseGroup; // 0x32
		::System::Int32 ExponentDigits; // 0x34
