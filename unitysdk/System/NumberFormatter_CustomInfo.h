...
#define SYSTEM_NUMBERFORMATTER_CUSTOMINFO_FORMAT_OFFSET UNITYSDK_OFFSET(0x197A3B40)
#define SYSTEM_NUMBERFORMATTER_CUSTOMINFO_GETACTIVESECTION_OFFSET UNITYSDK_OFFSET(0x197A2EC0)
#define SYSTEM_NUMBERFORMATTER_CUSTOMINFO_PARSE_OFFSET UNITYSDK_OFFSET(0x197A3240)
#define SYSTEM_NUMBERFORMATTER_CUSTOMINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x197A5010)
...
namespace System
{
	...
	public:
		...
		::System::Int32 DecimalPointPos; // 0x18
		...
		::System::Int32 ExponentTailSharpDigits; // 0x2C
		::System::Int32 Permilles; // 0x30
		::System::Int32 DecimalDigits; // 0x34
		::System::Int32 ExponentDigits; // 0x38
		::System::Int32 IntegerDigits; // 0x3C
