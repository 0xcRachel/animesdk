...
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_ADD_OFFSET UNITYSDK_OFFSET(0x193CE690)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_CLEAR_OFFSET UNITYSDK_OFFSET(0x193CE800)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_CONTAINS_OFFSET UNITYSDK_OFFSET(0x193CE680)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_COPYTO_OFFSET UNITYSDK_OFFSET(0x193CE2D0)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x193CE880)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x193CE410)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_GET_ISFIXEDSIZE_OFFSET UNITYSDK_OFFSET(0x193CE870)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x193CE860)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x193CE430)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x193CE440)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_GET_KEYS_OFFSET UNITYSDK_OFFSET(0x193CE620)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x193CE420)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_GET_VALUES_OFFSET UNITYSDK_OFFSET(0x193CE650)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_REMOVE_OFFSET UNITYSDK_OFFSET(0x193CE8C0)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x193CE4B0)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x193CE280)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x193CE270)
