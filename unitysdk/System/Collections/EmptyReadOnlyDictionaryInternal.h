...
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_ADD_OFFSET UNITYSDK_OFFSET(0x161DC010)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_CLEAR_OFFSET UNITYSDK_OFFSET(0x161DC180)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_CONTAINS_OFFSET UNITYSDK_OFFSET(0x161DC000)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_COPYTO_OFFSET UNITYSDK_OFFSET(0x161DBC50)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x161DC200)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x161DBD90)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_GET_ISFIXEDSIZE_OFFSET UNITYSDK_OFFSET(0x161DC1F0)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x161DC1E0)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x161DBDB0)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x161DBDC0)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_GET_KEYS_OFFSET UNITYSDK_OFFSET(0x161DBFA0)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x161DBDA0)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_GET_VALUES_OFFSET UNITYSDK_OFFSET(0x161DBFD0)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_REMOVE_OFFSET UNITYSDK_OFFSET(0x161DC240)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x161DBE30)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x161DBC00)
#define SYSTEM_COLLECTIONS_EMPTYREADONLYDICTIONARYINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x161DBBF0)
