...
#define SYSTEM_ENUM_COMPARETO_OFFSET UNITYSDK_OFFSET(0x162F97B0)
#define SYSTEM_ENUM_EQUALS_OFFSET UNITYSDK_OFFSET(0x162F9250)
#define SYSTEM_ENUM_FORMAT_OFFSET UNITYSDK_OFFSET(0x162F89A0)
#define SYSTEM_ENUM_GETCACHEDVALUESANDNAMES_OFFSET UNITYSDK_OFFSET(0x162F5D00)
#define SYSTEM_ENUM_GETENUMVALUESANDNAMES_OFFSET UNITYSDK_OFFSET(0x162F5E70)
#define SYSTEM_ENUM_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x162F9260)
#define SYSTEM_ENUM_GETNAMES_OFFSET UNITYSDK_OFFSET(0x162F7CA0)
#define SYSTEM_ENUM_GETNAME_OFFSET UNITYSDK_OFFSET(0x162F6350)
#define SYSTEM_ENUM_GETTYPECODE_OFFSET UNITYSDK_OFFSET(0x162F9C10)
#define SYSTEM_ENUM_GETUNDERLYINGTYPE_OFFSET UNITYSDK_OFFSET(0x162D36A0)
#define SYSTEM_ENUM_GETVALUES_OFFSET UNITYSDK_OFFSET(0x162F7C30)
#define SYSTEM_ENUM_GETVALUE_OFFSET UNITYSDK_OFFSET(0x162F8FA0)
#define SYSTEM_ENUM_GET_HASHCODE_OFFSET UNITYSDK_OFFSET(0x162F91B0)
#define SYSTEM_ENUM_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x162F9090)
#define SYSTEM_ENUM_HASFLAG_OFFSET UNITYSDK_OFFSET(0x162F9A30)
#define SYSTEM_ENUM_INTERNALBOXENUM_OFFSET UNITYSDK_OFFSET(0x162F6870)
#define SYSTEM_ENUM_INTERNALCOMPARETO_OFFSET UNITYSDK_OFFSET(0x162F67F0)
#define SYSTEM_ENUM_INTERNALFLAGSFORMAT_OFFSET UNITYSDK_OFFSET(0x162F63D0)
#define SYSTEM_ENUM_INTERNALFORMATTEDHEXSTRING_OFFSET UNITYSDK_OFFSET(0x162F5EB0)
#define SYSTEM_ENUM_INTERNALFORMAT_OFFSET UNITYSDK_OFFSET(0x162F6280)
#define SYSTEM_ENUM_INTERNALGETNAMES_OFFSET UNITYSDK_OFFSET(0x162F7CF0)
#define SYSTEM_ENUM_INTERNALGETUNDERLYINGTYPE_OFFSET UNITYSDK_OFFSET(0x162F6800)
#define SYSTEM_ENUM_INTERNALGETVALUES_OFFSET UNITYSDK_OFFSET(0x162F7C80)
#define SYSTEM_ENUM_INTERNALHASFLAG_OFFSET UNITYSDK_OFFSET(0x162F9110)
#define SYSTEM_ENUM_ISDEFINED_OFFSET UNITYSDK_OFFSET(0x162F8950)
#define SYSTEM_ENUM_PARSE_1_OFFSET UNITYSDK_OFFSET(0x162F68A0)
#define SYSTEM_ENUM_PARSE_OFFSET UNITYSDK_OFFSET(0x162E5810)
#define SYSTEM_ENUM_SYSTEM_ICONVERTIBLE_TOBOOLEAN_OFFSET UNITYSDK_OFFSET(0x162F9E80)
#define SYSTEM_ENUM_SYSTEM_ICONVERTIBLE_TOBYTE_OFFSET UNITYSDK_OFFSET(0x162FA150)
#define SYSTEM_ENUM_SYSTEM_ICONVERTIBLE_TOCHAR_OFFSET UNITYSDK_OFFSET(0x162F9F70)
#define SYSTEM_ENUM_SYSTEM_ICONVERTIBLE_TODATETIME_OFFSET UNITYSDK_OFFSET(0x162FAAD0)
#define SYSTEM_ENUM_SYSTEM_ICONVERTIBLE_TODECIMAL_OFFSET UNITYSDK_OFFSET(0x162FA9C0)
#define SYSTEM_ENUM_SYSTEM_ICONVERTIBLE_TODOUBLE_OFFSET UNITYSDK_OFFSET(0x162FA8D0)
#define SYSTEM_ENUM_SYSTEM_ICONVERTIBLE_TOINT16_OFFSET UNITYSDK_OFFSET(0x162FA240)
#define SYSTEM_ENUM_SYSTEM_ICONVERTIBLE_TOINT32_OFFSET UNITYSDK_OFFSET(0x162FA420)
#define SYSTEM_ENUM_SYSTEM_ICONVERTIBLE_TOINT64_OFFSET UNITYSDK_OFFSET(0x162FA600)
#define SYSTEM_ENUM_SYSTEM_ICONVERTIBLE_TOSBYTE_OFFSET UNITYSDK_OFFSET(0x162FA060)
#define SYSTEM_ENUM_SYSTEM_ICONVERTIBLE_TOSINGLE_OFFSET UNITYSDK_OFFSET(0x162FA7E0)
#define SYSTEM_ENUM_SYSTEM_ICONVERTIBLE_TOTYPE_OFFSET UNITYSDK_OFFSET(0x162FABA0)
#define SYSTEM_ENUM_SYSTEM_ICONVERTIBLE_TOUINT16_OFFSET UNITYSDK_OFFSET(0x162FA330)
#define SYSTEM_ENUM_SYSTEM_ICONVERTIBLE_TOUINT32_OFFSET UNITYSDK_OFFSET(0x162FA510)
#define SYSTEM_ENUM_SYSTEM_ICONVERTIBLE_TOUINT64_OFFSET UNITYSDK_OFFSET(0x162FA6F0)
#define SYSTEM_ENUM_TOOBJECT_10_OFFSET UNITYSDK_OFFSET(0x162F87F0)
#define SYSTEM_ENUM_TOOBJECT_1_OFFSET UNITYSDK_OFFSET(0x162F7E50)
#define SYSTEM_ENUM_TOOBJECT_2_OFFSET UNITYSDK_OFFSET(0x162F7FB0)
#define SYSTEM_ENUM_TOOBJECT_3_OFFSET UNITYSDK_OFFSET(0x162F7D10)
#define SYSTEM_ENUM_TOOBJECT_4_OFFSET UNITYSDK_OFFSET(0x162F83D0)
#define SYSTEM_ENUM_TOOBJECT_5_OFFSET UNITYSDK_OFFSET(0x162F8530)
#define SYSTEM_ENUM_TOOBJECT_6_OFFSET UNITYSDK_OFFSET(0x162F8270)
#define SYSTEM_ENUM_TOOBJECT_7_OFFSET UNITYSDK_OFFSET(0x162F8110)
#define SYSTEM_ENUM_TOOBJECT_8_OFFSET UNITYSDK_OFFSET(0x162F7B00)
#define SYSTEM_ENUM_TOOBJECT_9_OFFSET UNITYSDK_OFFSET(0x162F8690)
#define SYSTEM_ENUM_TOOBJECT_OFFSET UNITYSDK_OFFSET(0x162F7480)
#define SYSTEM_ENUM_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x162F93F0)
#define SYSTEM_ENUM_TOSTRING_2_OFFSET UNITYSDK_OFFSET(0x162F9400)
#define SYSTEM_ENUM_TOSTRING_3_OFFSET UNITYSDK_OFFSET(0x162F9940)
#define SYSTEM_ENUM_TOSTRING_OFFSET UNITYSDK_OFFSET(0x162F9300)
#define SYSTEM_ENUM_TOUINT64_OFFSET UNITYSDK_OFFSET(0x162F66C0)
#define SYSTEM_ENUM_TRYPARSEENUM_OFFSET UNITYSDK_OFFSET(0x162F6970)
#define SYSTEM_ENUM__CCTOR_OFFSET UNITYSDK_OFFSET(0x162FABC0)
#define SYSTEM_ENUM__CTOR_OFFSET UNITYSDK_OFFSET(0x162FABB0)
...
namespace System
{
	...
	struct alignas(8) Enum
	{
		...
		{
			return (::Il2CppArray<::System::Char>**)Il2CppClass::FromTypeDefinitionIndex(Enum_TypeDefinitionIndex)->GetStaticField(0x7360);
		}
