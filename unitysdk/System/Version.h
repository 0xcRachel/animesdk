...
#define SYSTEM_VERSION_APPENDPOSITIVENUMBER_OFFSET UNITYSDK_OFFSET(0x15BC1EA0)
#define SYSTEM_VERSION_CLONE_OFFSET UNITYSDK_OFFSET(0x15BC1360)
#define SYSTEM_VERSION_COMPARETO_1_OFFSET UNITYSDK_OFFSET(0x15BC1500)
#define SYSTEM_VERSION_COMPARETO_OFFSET UNITYSDK_OFFSET(0x15BC1390)
#define SYSTEM_VERSION_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x15BC1620)
#define SYSTEM_VERSION_EQUALS_OFFSET UNITYSDK_OFFSET(0x15BC1590)
#define SYSTEM_VERSION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x15BC16A0)
#define SYSTEM_VERSION_GET_BUILD_OFFSET UNITYSDK_OFFSET(0x15BC1340)
#define SYSTEM_VERSION_GET_MAJOR_OFFSET UNITYSDK_OFFSET(0x15BC1320)
#define SYSTEM_VERSION_GET_MINOR_OFFSET UNITYSDK_OFFSET(0x15BC1330)
#define SYSTEM_VERSION_GET_REVISION_OFFSET UNITYSDK_OFFSET(0x15BC1350)
#define SYSTEM_VERSION_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x15BC1480)
#define SYSTEM_VERSION_OP_GREATERTHANOREQUAL_OFFSET UNITYSDK_OFFSET(0x15BC2A20)
#define SYSTEM_VERSION_OP_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x15BC29E0)
#define SYSTEM_VERSION_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x15BC27C0)
#define SYSTEM_VERSION_OP_LESSTHANOREQUAL_OFFSET UNITYSDK_OFFSET(0x15BC2920)
#define SYSTEM_VERSION_OP_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x15BC2860)
#define SYSTEM_VERSION_PARSE_OFFSET UNITYSDK_OFFSET(0x15BC1240)
#define SYSTEM_VERSION_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x15BC1700)
#define SYSTEM_VERSION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x15BC16D0)
#define SYSTEM_VERSION_TRYPARSECOMPONENT_OFFSET UNITYSDK_OFFSET(0x15BC2640)
#define SYSTEM_VERSION_TRYPARSEVERSION_OFFSET UNITYSDK_OFFSET(0x15BC1F30)
#define SYSTEM_VERSION__CCTOR_OFFSET UNITYSDK_OFFSET(0x15BC2A60)
#define SYSTEM_VERSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x15BC0FF0)
#define SYSTEM_VERSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x15BC1110)
#define SYSTEM_VERSION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x15BC11E0)
#define SYSTEM_VERSION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x15BC1310)
#define SYSTEM_VERSION__CTOR_OFFSET UNITYSDK_OFFSET(0x15BC0EC0)
