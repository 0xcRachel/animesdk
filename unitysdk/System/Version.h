...
#define SYSTEM_VERSION_APPENDPOSITIVENUMBER_OFFSET UNITYSDK_OFFSET(0x1628A990)
#define SYSTEM_VERSION_CLONE_OFFSET UNITYSDK_OFFSET(0x16289E50)
#define SYSTEM_VERSION_COMPARETO_1_OFFSET UNITYSDK_OFFSET(0x16289FF0)
#define SYSTEM_VERSION_COMPARETO_OFFSET UNITYSDK_OFFSET(0x16289E80)
#define SYSTEM_VERSION_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1628A110)
#define SYSTEM_VERSION_EQUALS_OFFSET UNITYSDK_OFFSET(0x1628A080)
#define SYSTEM_VERSION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1628A190)
#define SYSTEM_VERSION_GET_BUILD_OFFSET UNITYSDK_OFFSET(0x16289E30)
#define SYSTEM_VERSION_GET_MAJOR_OFFSET UNITYSDK_OFFSET(0x16289E10)
#define SYSTEM_VERSION_GET_MINOR_OFFSET UNITYSDK_OFFSET(0x16289E20)
#define SYSTEM_VERSION_GET_REVISION_OFFSET UNITYSDK_OFFSET(0x16289E40)
#define SYSTEM_VERSION_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x16289F70)
#define SYSTEM_VERSION_OP_GREATERTHANOREQUAL_OFFSET UNITYSDK_OFFSET(0x1628B510)
#define SYSTEM_VERSION_OP_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x1628B4D0)
#define SYSTEM_VERSION_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1628B2B0)
#define SYSTEM_VERSION_OP_LESSTHANOREQUAL_OFFSET UNITYSDK_OFFSET(0x1628B410)
#define SYSTEM_VERSION_OP_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x1628B350)
#define SYSTEM_VERSION_PARSE_OFFSET UNITYSDK_OFFSET(0x16289D30)
#define SYSTEM_VERSION_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x1628A1F0)
#define SYSTEM_VERSION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1628A1C0)
#define SYSTEM_VERSION_TRYPARSECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1628B130)
#define SYSTEM_VERSION_TRYPARSEVERSION_OFFSET UNITYSDK_OFFSET(0x1628AA20)
#define SYSTEM_VERSION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1628B550)
#define SYSTEM_VERSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x16289B10)
#define SYSTEM_VERSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x16289C30)
#define SYSTEM_VERSION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x16289CD0)
#define SYSTEM_VERSION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x16289E00)
#define SYSTEM_VERSION__CTOR_OFFSET UNITYSDK_OFFSET(0x162899E0)
