...
#define SYSTEM_IO_STREAM__COPYTOASYNCINTERNAL_D__27_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x38B0990)
#define SYSTEM_IO_STREAM__COPYTOASYNCINTERNAL_D__27_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x38B09A0)
...
namespace System::IO
{
	...
	{
		::System::IO::Stream* destination; // 0x10
		::System::IO::Stream* __4__this; // 0x18
		::Il2CppArray<::System::Byte>* _buffer_5__1; // 0x20
