...
#define SYSTEM_MONOLIMITATIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x17D07C50)

namespace System
{
	inline static constexpr unsigned int MonoLimitationAttribute_TypeDefinitionIndex = 3076;
