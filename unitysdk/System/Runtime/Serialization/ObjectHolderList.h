...
#define SYSTEM_RUNTIME_SERIALIZATION_OBJECTHOLDERLIST_ADD_OFFSET UNITYSDK_OFFSET(0x1762AC70)
#define SYSTEM_RUNTIME_SERIALIZATION_OBJECTHOLDERLIST_ENLARGEARRAY_OFFSET UNITYSDK_OFFSET(0x1762AD40)
#define SYSTEM_RUNTIME_SERIALIZATION_OBJECTHOLDERLIST_GETFIXUPENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1762ADC0)
#define SYSTEM_RUNTIME_SERIALIZATION_OBJECTHOLDERLIST_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1762AE60)
#define SYSTEM_RUNTIME_SERIALIZATION_OBJECTHOLDERLIST_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1762AE50)
#define SYSTEM_RUNTIME_SERIALIZATION_OBJECTHOLDERLIST__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1762AC20)
#define SYSTEM_RUNTIME_SERIALIZATION_OBJECTHOLDERLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1762ABD0)
