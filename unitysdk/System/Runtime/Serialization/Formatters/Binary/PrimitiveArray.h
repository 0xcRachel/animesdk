...
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_PRIMITIVEARRAY_INIT_OFFSET UNITYSDK_OFFSET(0x17478A30)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_PRIMITIVEARRAY_SETVALUE_OFFSET UNITYSDK_OFFSET(0x174736C0)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_PRIMITIVEARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x17472A50)
...
namespace System::Runtime::Serialization::Formatters::Binary
{
	...
	{
	public:
		::Il2CppArray<::System::UInt64>* uint64A; // 0x10
		...
		::Il2CppArray<::System::UInt16>* uint16A; // 0x50
		::Il2CppArray<::System::UInt32>* uint32A; // 0x58
