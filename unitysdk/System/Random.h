...
#define SYSTEM_RANDOM_GETSAMPLEFORLARGERANGE_OFFSET UNITYSDK_OFFSET(0x1637B220)
#define SYSTEM_RANDOM_INTERNALSAMPLE_OFFSET UNITYSDK_OFFSET(0x1637B160)
#define SYSTEM_RANDOM_NEXTBYTES_OFFSET UNITYSDK_OFFSET(0x1637B450)
#define SYSTEM_RANDOM_NEXTDOUBLE_OFFSET UNITYSDK_OFFSET(0x1637B440)
#define SYSTEM_RANDOM_NEXT_1_OFFSET UNITYSDK_OFFSET(0x1637B260)
#define SYSTEM_RANDOM_NEXT_2_OFFSET UNITYSDK_OFFSET(0x1637B390)
#define SYSTEM_RANDOM_NEXT_OFFSET UNITYSDK_OFFSET(0x1637B210)
#define SYSTEM_RANDOM_SAMPLE_OFFSET UNITYSDK_OFFSET(0x1637B140)
#define SYSTEM_RANDOM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1637AE80)
#define SYSTEM_RANDOM__CTOR_OFFSET UNITYSDK_OFFSET(0x16376650)
