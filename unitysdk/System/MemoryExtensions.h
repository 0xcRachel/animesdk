...
#define SYSTEM_MEMORYEXTENSIONS_ASMEMORY_1_OFFSET UNITYSDK_OFFSET(0x185304F0)
#define SYSTEM_MEMORYEXTENSIONS_ASMEMORY_2_OFFSET UNITYSDK_OFFSET(0x18530590)
#define SYSTEM_MEMORYEXTENSIONS_ASMEMORY_OFFSET UNITYSDK_OFFSET(0x185304D0)
#define SYSTEM_MEMORYEXTENSIONS_ASSPAN_1_OFFSET UNITYSDK_OFFSET(0x185303A0)
#define SYSTEM_MEMORYEXTENSIONS_ASSPAN_OFFSET UNITYSDK_OFFSET(0x18530340)
#define SYSTEM_MEMORYEXTENSIONS_COMPARETOORDINALIGNORECASE_OFFSET UNITYSDK_OFFSET(0x1852FDF0)
#define SYSTEM_MEMORYEXTENSIONS_COMPARETO_OFFSET UNITYSDK_OFFSET(0x1852FF90)
#define SYSTEM_MEMORYEXTENSIONS_ENDSWITH_OFFSET UNITYSDK_OFFSET(0x18530100)
#define SYSTEM_MEMORYEXTENSIONS_EQUALSORDINALIGNORECASE_OFFSET UNITYSDK_OFFSET(0x1852FD50)
#define SYSTEM_MEMORYEXTENSIONS_EQUALS_OFFSET UNITYSDK_OFFSET(0x1852FB40)
#define SYSTEM_MEMORYEXTENSIONS_MEASURESTRINGADJUSTMENT_OFFSET UNITYSDK_OFFSET(0x18530640)
#define SYSTEM_MEMORYEXTENSIONS__CCTOR_OFFSET UNITYSDK_OFFSET(0x18530660)
