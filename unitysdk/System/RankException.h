...
#define SYSTEM_RANKEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x197ABD20)
#define SYSTEM_RANKEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x197ABD90)
#define SYSTEM_RANKEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x197ABC80)
