...
#define SYSTEM___FILTERS_FILTERATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A67E550)
#define SYSTEM___FILTERS_FILTERIGNORECASE_OFFSET UNITYSDK_OFFSET(0x1A67EAA0)
#define SYSTEM___FILTERS_FILTERNAME_OFFSET UNITYSDK_OFFSET(0x1A67E920)
#define SYSTEM___FILTERS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A67EC30)
#define SYSTEM___FILTERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A67EC20)
