...
#define SYSTEM_DIAGNOSTICS_PROCESSWAITHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x17E8C7A0)

namespace System::Diagnostics
{
	inline static constexpr unsigned int ProcessWaitHandle_TypeDefinitionIndex = 2537;
