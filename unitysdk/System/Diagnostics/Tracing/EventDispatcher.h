...
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTDISPATCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x15C07190)

namespace System::Diagnostics::Tracing
{
	inline static constexpr unsigned int EventDispatcher_TypeDefinitionIndex = 1689;
