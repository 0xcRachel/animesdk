...
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYFILTER___C__DISPLAYCLASS11_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15C01E40)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYFILTER___C__DISPLAYCLASS11_0__GETACTIVITYDYINGDELEGATE_B__0_OFFSET UNITYSDK_OFFSET(0x15C01E60)

namespace System::Diagnostics::Tracing
{
	inline static constexpr unsigned int ActivityFilter___c__DisplayClass11_0_TypeDefinitionIndex = 1683;
