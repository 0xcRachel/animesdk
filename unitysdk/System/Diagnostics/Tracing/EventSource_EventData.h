...
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_EVENTDATA_SETMETADATA_OFFSET UNITYSDK_OFFSET(0x2007670)
...
{
	inline static constexpr unsigned int EventSource_EventData_TypeDefinitionIndex = 1648;
