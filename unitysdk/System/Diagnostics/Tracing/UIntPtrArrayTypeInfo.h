...
#define SYSTEM_DIAGNOSTICS_TRACING_UINTPTRARRAYTYPEINFO_WRITEDATA_OFFSET UNITYSDK_OFFSET(0x15C2C300)
#define SYSTEM_DIAGNOSTICS_TRACING_UINTPTRARRAYTYPEINFO_WRITEMETADATA_OFFSET UNITYSDK_OFFSET(0x15C2C260)
#define SYSTEM_DIAGNOSTICS_TRACING_UINTPTRARRAYTYPEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x15C2C320)

namespace System::Diagnostics::Tracing
{
	inline static constexpr unsigned int UIntPtrArrayTypeInfo_TypeDefinitionIndex = 1623;
