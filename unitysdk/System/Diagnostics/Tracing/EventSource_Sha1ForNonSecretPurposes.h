...
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_SHA1FORNONSECRETPURPOSES_APPEND_1_OFFSET UNITYSDK_OFFSET(0x20077C0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_SHA1FORNONSECRETPURPOSES_APPEND_OFFSET UNITYSDK_OFFSET(0x2007750)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_SHA1FORNONSECRETPURPOSES_DRAIN_OFFSET UNITYSDK_OFFSET(0x20077E0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_SHA1FORNONSECRETPURPOSES_FINISH_OFFSET UNITYSDK_OFFSET(0x20077D0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_SHA1FORNONSECRETPURPOSES_ROL1_OFFSET UNITYSDK_OFFSET(0x15C21410)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_SHA1FORNONSECRETPURPOSES_ROL30_OFFSET UNITYSDK_OFFSET(0x15C21430)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_SHA1FORNONSECRETPURPOSES_ROL5_OFFSET UNITYSDK_OFFSET(0x15C21420)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_SHA1FORNONSECRETPURPOSES_START_OFFSET UNITYSDK_OFFSET(0x2007740)

namespace System::Diagnostics::Tracing
{
	inline static constexpr unsigned int EventSource_Sha1ForNonSecretPurposes_TypeDefinitionIndex = 1649;
