...
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_SHA1FORNONSECRETPURPOSES_APPEND_1_OFFSET UNITYSDK_OFFSET(0x229E230)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_SHA1FORNONSECRETPURPOSES_APPEND_OFFSET UNITYSDK_OFFSET(0x229E1C0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_SHA1FORNONSECRETPURPOSES_DRAIN_OFFSET UNITYSDK_OFFSET(0x229E250)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_SHA1FORNONSECRETPURPOSES_FINISH_OFFSET UNITYSDK_OFFSET(0x229E240)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_SHA1FORNONSECRETPURPOSES_ROL1_OFFSET UNITYSDK_OFFSET(0x17D1D7A0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_SHA1FORNONSECRETPURPOSES_ROL30_OFFSET UNITYSDK_OFFSET(0x17D1D7C0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_SHA1FORNONSECRETPURPOSES_ROL5_OFFSET UNITYSDK_OFFSET(0x17D1D7B0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_SHA1FORNONSECRETPURPOSES_START_OFFSET UNITYSDK_OFFSET(0x229E1B0)
