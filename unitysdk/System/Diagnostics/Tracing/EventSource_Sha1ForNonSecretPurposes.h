...
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_SHA1FORNONSECRETPURPOSES_APPEND_1_OFFSET UNITYSDK_OFFSET(0x20DD050)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_SHA1FORNONSECRETPURPOSES_APPEND_OFFSET UNITYSDK_OFFSET(0x20DCFE0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_SHA1FORNONSECRETPURPOSES_DRAIN_OFFSET UNITYSDK_OFFSET(0x20DD070)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_SHA1FORNONSECRETPURPOSES_FINISH_OFFSET UNITYSDK_OFFSET(0x20DD060)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_SHA1FORNONSECRETPURPOSES_ROL1_OFFSET UNITYSDK_OFFSET(0x162E9B40)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_SHA1FORNONSECRETPURPOSES_ROL30_OFFSET UNITYSDK_OFFSET(0x162E9B60)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_SHA1FORNONSECRETPURPOSES_ROL5_OFFSET UNITYSDK_OFFSET(0x162E9B50)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCE_SHA1FORNONSECRETPURPOSES_START_OFFSET UNITYSDK_OFFSET(0x20DCFD0)
