...
#define SYSTEM_DIAGNOSTICS_TRACING_TYPEANALYSIS__CTOR_OFFSET UNITYSDK_OFFSET(0x15C2B150)

namespace System::Diagnostics::Tracing
{
	inline static constexpr unsigned int TypeAnalysis_TypeDefinitionIndex = 1658;
	...
	public:
		...
		::System::Diagnostics::Tracing::EventTags tags; // 0x34
