...
#define SYSTEM_DIAGNOSTICS_TRACING_UINT32TYPEINFO_WRITEDATA_OFFSET UNITYSDK_OFFSET(0x15C2BF00)
#define SYSTEM_DIAGNOSTICS_TRACING_UINT32TYPEINFO_WRITEMETADATA_OFFSET UNITYSDK_OFFSET(0x15C2BE20)
#define SYSTEM_DIAGNOSTICS_TRACING_UINT32TYPEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x15C2BF90)

namespace System::Diagnostics::Tracing
{
	inline static constexpr unsigned int UInt32TypeInfo_TypeDefinitionIndex = 1605;
