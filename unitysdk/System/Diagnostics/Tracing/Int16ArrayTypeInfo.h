...
#define SYSTEM_DIAGNOSTICS_TRACING_INT16ARRAYTYPEINFO_WRITEDATA_OFFSET UNITYSDK_OFFSET(0x15C224F0)
#define SYSTEM_DIAGNOSTICS_TRACING_INT16ARRAYTYPEINFO_WRITEMETADATA_OFFSET UNITYSDK_OFFSET(0x15C22460)
#define SYSTEM_DIAGNOSTICS_TRACING_INT16ARRAYTYPEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x15C226A0)

namespace System::Diagnostics::Tracing
{
	inline static constexpr unsigned int Int16ArrayTypeInfo_TypeDefinitionIndex = 1616;
