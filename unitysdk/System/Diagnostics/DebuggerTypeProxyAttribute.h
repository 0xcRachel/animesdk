...
#define SYSTEM_DIAGNOSTICS_DEBUGGERTYPEPROXYATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x15BFEBC0)

namespace System::Diagnostics
{
	inline static constexpr unsigned int DebuggerTypeProxyAttribute_TypeDefinitionIndex = 1565;
