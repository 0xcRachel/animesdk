...
#define SYSTEM_CONSOLEKEYINFO_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x20032B0)
#define SYSTEM_CONSOLEKEYINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0x2003240)
#define SYSTEM_CONSOLEKEYINFO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x20032D0)
#define SYSTEM_CONSOLEKEYINFO_GET_KEYCHAR_OFFSET UNITYSDK_OFFSET(0x14E6820)
#define SYSTEM_CONSOLEKEYINFO_GET_KEY_OFFSET UNITYSDK_OFFSET(0x1DAE0)
#define SYSTEM_CONSOLEKEYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x2003190)
