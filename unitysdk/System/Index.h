...
#define SYSTEM_INDEX_EQUALS_OFFSET UNITYSDK_OFFSET(0x20D0570)
#define SYSTEM_INDEX_FROMSTART_OFFSET UNITYSDK_OFFSET(0x15DA4F30)
#define SYSTEM_INDEX_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x59D0)
#define SYSTEM_INDEX_GETOFFSET_OFFSET UNITYSDK_OFFSET(0x20D0560)
#define SYSTEM_INDEX_GET_ISFROMEND_OFFSET UNITYSDK_OFFSET(0x20D0550)
#define SYSTEM_INDEX_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x20D0540)
#define SYSTEM_INDEX_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x15DA50B0)
#define SYSTEM_INDEX_THROWVALUEARGUMENTOUTOFRANGE_NEEDNONNEGNUMEXCEPTION_OFFSET UNITYSDK_OFFSET(0x15DA4FA0)
#define SYSTEM_INDEX_TOSTRINGFROMEND_OFFSET UNITYSDK_OFFSET(0x20D0650)
#define SYSTEM_INDEX_TOSTRING_OFFSET UNITYSDK_OFFSET(0x20D05D0)
