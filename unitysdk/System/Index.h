...
#define SYSTEM_INDEX_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x632780)
#define SYSTEM_INDEX_EQUALS_OFFSET UNITYSDK_OFFSET(0x23CC190)
#define SYSTEM_INDEX_FROMSTART_OFFSET UNITYSDK_OFFSET(0x1A758B60)
#define SYSTEM_INDEX_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x608A20)
#define SYSTEM_INDEX_GETOFFSET_OFFSET UNITYSDK_OFFSET(0x23CC180)
#define SYSTEM_INDEX_GET_ISFROMEND_OFFSET UNITYSDK_OFFSET(0x2389AD0)
#define SYSTEM_INDEX_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x23CC170)
#define SYSTEM_INDEX_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1A758C80)
#define SYSTEM_INDEX_THROWVALUEARGUMENTOUTOFRANGE_NEEDNONNEGNUMEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1A758AF0)
#define SYSTEM_INDEX_TOSTRINGFROMEND_OFFSET UNITYSDK_OFFSET(0x23CC270)
#define SYSTEM_INDEX_TOSTRING_OFFSET UNITYSDK_OFFSET(0x23CC1F0)
#define SYSTEM_INDEX__CTOR_1_OFFSET UNITYSDK_OFFSET(0x6326D0)
#define SYSTEM_INDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x23CC100)
