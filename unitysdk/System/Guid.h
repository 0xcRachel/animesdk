...
#define SYSTEM_GUID_COMPARETO_1_OFFSET UNITYSDK_OFFSET(0x20DEE80)
#define SYSTEM_GUID_COMPARETO_OFFSET UNITYSDK_OFFSET(0x20DEE70)
#define SYSTEM_GUID_EATALLWHITESPACE_OFFSET UNITYSDK_OFFSET(0x163384F0)
#define SYSTEM_GUID_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x20DEDF0)
#define SYSTEM_GUID_EQUALS_OFFSET UNITYSDK_OFFSET(0x20DED70)
#define SYSTEM_GUID_FASTNEWGUIDARRAY_OFFSET UNITYSDK_OFFSET(0x16339E50)
#define SYSTEM_GUID_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x20DED40)
#define SYSTEM_GUID_GETRESULT_OFFSET UNITYSDK_OFFSET(0x20DEE60)
#define SYSTEM_GUID_HEXSTOCHARS_1_OFFSET UNITYSDK_OFFSET(0x16339C20)
#define SYSTEM_GUID_HEXSTOCHARS_OFFSET UNITYSDK_OFFSET(0x16339BA0)
#define SYSTEM_GUID_HEXTOCHAR_OFFSET UNITYSDK_OFFSET(0x16339B90)
#define SYSTEM_GUID_ISHEXPREFIX_OFFSET UNITYSDK_OFFSET(0x16338600)
#define SYSTEM_GUID_NEWGUID_OFFSET UNITYSDK_OFFSET(0x16339CD0)
#define SYSTEM_GUID_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x16339A90)
#define SYSTEM_GUID_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x16339B00)
#define SYSTEM_GUID_PARSEEXACT_OFFSET UNITYSDK_OFFSET(0x16336E00)
#define SYSTEM_GUID_PARSE_OFFSET UNITYSDK_OFFSET(0x16336CF0)
#define SYSTEM_GUID_STRINGTOINT_1_OFFSET UNITYSDK_OFFSET(0x163387E0)
#define SYSTEM_GUID_STRINGTOINT_2_OFFSET UNITYSDK_OFFSET(0x16338870)
#define SYSTEM_GUID_STRINGTOINT_OFFSET UNITYSDK_OFFSET(0x16338750)
#define SYSTEM_GUID_STRINGTOLONG_1_OFFSET UNITYSDK_OFFSET(0x163387D0)
#define SYSTEM_GUID_STRINGTOLONG_2_OFFSET UNITYSDK_OFFSET(0x16338A40)
#define SYSTEM_GUID_STRINGTOLONG_OFFSET UNITYSDK_OFFSET(0x16338A20)
#define SYSTEM_GUID_STRINGTOSHORT_1_OFFSET UNITYSDK_OFFSET(0x16338830)
#define SYSTEM_GUID_STRINGTOSHORT_2_OFFSET UNITYSDK_OFFSET(0x163387F0)
#define SYSTEM_GUID_STRINGTOSHORT_OFFSET UNITYSDK_OFFSET(0x16338780)
#define SYSTEM_GUID_TOBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x20DED20)
#define SYSTEM_GUID_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x20DEF30)
#define SYSTEM_GUID_TOSTRING_2_OFFSET UNITYSDK_OFFSET(0x20DEF30)
#define SYSTEM_GUID_TOSTRING_OFFSET UNITYSDK_OFFSET(0x20DED30)
#define SYSTEM_GUID_TRYPARSEEXACT_OFFSET UNITYSDK_OFFSET(0x163370A0)
#define SYSTEM_GUID_TRYPARSEGUIDWITHDASHES_OFFSET UNITYSDK_OFFSET(0x16337290)
#define SYSTEM_GUID_TRYPARSEGUIDWITHHEXPREFIX_OFFSET UNITYSDK_OFFSET(0x16337740)
#define SYSTEM_GUID_TRYPARSEGUIDWITHNOSTYLE_OFFSET UNITYSDK_OFFSET(0x16338090)
#define SYSTEM_GUID_TRYPARSEGUID_OFFSET UNITYSDK_OFFSET(0x16336540)
#define SYSTEM_GUID_TRYPARSE_OFFSET UNITYSDK_OFFSET(0x16336DA0)
#define SYSTEM_GUID__CCTOR_OFFSET UNITYSDK_OFFSET(0x16339FC0)
#define SYSTEM_GUID__CTOR_1_OFFSET UNITYSDK_OFFSET(0x20DEC90)
#define SYSTEM_GUID__CTOR_2_OFFSET UNITYSDK_OFFSET(0x20DED00)
#define SYSTEM_GUID__CTOR_3_OFFSET UNITYSDK_OFFSET(0x20DEC90)
#define SYSTEM_GUID__CTOR_4_OFFSET UNITYSDK_OFFSET(0x20DED10)
#define SYSTEM_GUID__CTOR_OFFSET UNITYSDK_OFFSET(0x20DEC80)
...
namespace System
{
	...
	struct alignas(4) Guid
	{
		...
		{
			return (::System::Security::Cryptography::RandomNumberGenerator**)Il2CppClass::FromTypeDefinitionIndex(Guid_TypeDefinitionIndex)->GetStaticField(0x12D0);
		}
		static ::System::Security::Cryptography::RandomNumberGenerator** StaticGet__rng()
		{
			return (::System::Security::Cryptography::RandomNumberGenerator**)Il2CppClass::FromTypeDefinitionIndex(Guid_TypeDefinitionIndex)->GetStaticField(0x12D8);
		}
		static ::System::Object** StaticGet__rngAccess()
		{
			return (::System::Object**)Il2CppClass::FromTypeDefinitionIndex(Guid_TypeDefinitionIndex)->GetStaticField(0x12E0);
		}
		static ::System::Guid* StaticGet_Empty()
		{
			return (::System::Guid*)Il2CppClass::FromTypeDefinitionIndex(Guid_TypeDefinitionIndex)->GetStaticField(0xDE0);
		}
