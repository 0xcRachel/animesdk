...
#define SYSTEM_EMPTY_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x162F5B10)
#define SYSTEM_EMPTY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x162F5B00)
#define SYSTEM_EMPTY__CCTOR_OFFSET UNITYSDK_OFFSET(0x162F5B90)
#define SYSTEM_EMPTY__CTOR_OFFSET UNITYSDK_OFFSET(0x162F5AF0)
