...
#define SYSTEM_EMPTY_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1761B620)
#define SYSTEM_EMPTY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1761B610)
#define SYSTEM_EMPTY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1761B6A0)
#define SYSTEM_EMPTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1761B600)
