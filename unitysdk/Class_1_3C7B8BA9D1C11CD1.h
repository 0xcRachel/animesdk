...
#define CLASS_1_3C7B8BA9D1C11CD1_METHOD_1_A5ADA4706DA592FA_OFFSET UNITYSDK_OFFSET(0x16174440)
#define CLASS_1_3C7B8BA9D1C11CD1_METHOD_1_CDCC31436CFEA667_OFFSET UNITYSDK_OFFSET(0x16174150)
#define CLASS_1_3C7B8BA9D1C11CD1_METHOD_1_D7852DE078ACC1F1_OFFSET UNITYSDK_OFFSET(0x16174290)
#define CLASS_1_3C7B8BA9D1C11CD1__CTOR_OFFSET UNITYSDK_OFFSET(0x16174140)

inline static constexpr unsigned int Class_1_3C7B8BA9D1C11CD1_TypeDefinitionIndex = 31745;
...
public:
	...
	::RPG::Client::LittleGame::MarbleEmojiReason Field_1_1; // 0x28
