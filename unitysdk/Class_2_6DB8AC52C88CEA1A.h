...
#define CLASS_2_6DB8AC52C88CEA1A_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCBBDF10)
#define CLASS_2_6DB8AC52C88CEA1A_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xCBBDF50)
#define CLASS_2_6DB8AC52C88CEA1A_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xCBBE080)
#define CLASS_2_6DB8AC52C88CEA1A_TICK_OFFSET UNITYSDK_OFFSET(0xCBBE0D0)
#define CLASS_2_6DB8AC52C88CEA1A__CTOR_OFFSET UNITYSDK_OFFSET(0xCBBDF00)

inline static constexpr unsigned int Class_2_6DB8AC52C88CEA1A_TypeDefinitionIndex = 42995;
