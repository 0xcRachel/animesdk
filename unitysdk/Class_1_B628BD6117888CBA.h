...
#define CLASS_1_B628BD6117888CBA_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x198A30C0)
#define CLASS_1_B628BD6117888CBA_CLONE_OFFSET UNITYSDK_OFFSET(0x198A2C90)
#define CLASS_1_B628BD6117888CBA_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x198A2DD0)
#define CLASS_1_B628BD6117888CBA_EQUALS_OFFSET UNITYSDK_OFFSET(0x198A2CF0)
#define CLASS_1_B628BD6117888CBA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x198A2EA0)
#define CLASS_1_B628BD6117888CBA_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x198A3200)
#define CLASS_1_B628BD6117888CBA_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x198A3160)
#define CLASS_1_B628BD6117888CBA_METHOD_1_4C96E9A31DDA1BDD_OFFSET UNITYSDK_OFFSET(0x198A2CC0)
#define CLASS_1_B628BD6117888CBA_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x198A2B80)
#define CLASS_1_B628BD6117888CBA_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x198A2CE0)
#define CLASS_1_B628BD6117888CBA_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x198A2CD0)
#define CLASS_1_B628BD6117888CBA_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x198A2BB0)
#define CLASS_1_B628BD6117888CBA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x198A2F80)
#define CLASS_1_B628BD6117888CBA_WRITETO_OFFSET UNITYSDK_OFFSET(0x198A2FE0)
#define CLASS_1_B628BD6117888CBA__CCTOR_OFFSET UNITYSDK_OFFSET(0x198A32C0)
#define CLASS_1_B628BD6117888CBA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x198A2C00)
#define CLASS_1_B628BD6117888CBA__CTOR_OFFSET UNITYSDK_OFFSET(0x198A2BC0)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Proto::PileItem*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B628BD6117888CBA_TypeDefinitionIndex)->GetStaticField(0x52BC0);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_B628BD6117888CBA*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_B628BD6117888CBA*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B628BD6117888CBA_TypeDefinitionIndex)->GetStaticField(0x52BC8);
	}
