...
#define CLASS_2_AAC620481781CC35_METHOD_2_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x114C5690)
#define CLASS_2_AAC620481781CC35__CREATEINTERACTTRIGGER_OFFSET UNITYSDK_OFFSET(0x114C5750)
#define CLASS_2_AAC620481781CC35__CREATEPROPMOVETRIGGER_OFFSET UNITYSDK_OFFSET(0x114C59C0)
#define CLASS_2_AAC620481781CC35__CTOR_OFFSET UNITYSDK_OFFSET(0x114C5340)
#define CLASS_2_AAC620481781CC35__ONLEVELVARCHANGE_OFFSET UNITYSDK_OFFSET(0x114C5A10)
#define CLASS_2_AAC620481781CC35__TEARDOWN_OFFSET UNITYSDK_OFFSET(0x114C56D0)
#define CLASS_2_AAC620481781CC35___CREATEINTERACTTRIGGER_B__3_0_OFFSET UNITYSDK_OFFSET(0x114C5B30)
#define CLASS_2_AAC620481781CC35___IFIXBASEPROXY__ONLEVELVARCHANGE_OFFSET UNITYSDK_OFFSET(0x114C5BF0)
#define CLASS_2_AAC620481781CC35___IFIXBASEPROXY__TEARDOWN_OFFSET UNITYSDK_OFFSET(0x114C5B70)

inline static constexpr unsigned int Class_2_AAC620481781CC35_TypeDefinitionIndex = 62488;
