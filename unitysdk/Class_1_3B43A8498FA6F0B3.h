...
#define CLASS_1_3B43A8498FA6F0B3_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x18159520)
#define CLASS_1_3B43A8498FA6F0B3_CLONE_OFFSET UNITYSDK_OFFSET(0x18158F20)
#define CLASS_1_3B43A8498FA6F0B3_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x18158FD0)
#define CLASS_1_3B43A8498FA6F0B3_EQUALS_OFFSET UNITYSDK_OFFSET(0x18158FA0)
#define CLASS_1_3B43A8498FA6F0B3_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x181590E0)
#define CLASS_1_3B43A8498FA6F0B3_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x18159840)
#define CLASS_1_3B43A8498FA6F0B3_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x181596E0)
#define CLASS_1_3B43A8498FA6F0B3_METHOD_1_3DACC45AC8150727_OFFSET UNITYSDK_OFFSET(0x18158F90)
#define CLASS_1_3B43A8498FA6F0B3_METHOD_1_6E1EC2DF63D7020F_1_OFFSET UNITYSDK_OFFSET(0x18158F60)
#define CLASS_1_3B43A8498FA6F0B3_METHOD_1_6E1EC2DF63D7020F_2_OFFSET UNITYSDK_OFFSET(0x18158F70)
#define CLASS_1_3B43A8498FA6F0B3_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x18158F50)
#define CLASS_1_3B43A8498FA6F0B3_METHOD_1_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x18158F80)
#define CLASS_1_3B43A8498FA6F0B3_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x18158D70)
#define CLASS_1_3B43A8498FA6F0B3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x18159340)
#define CLASS_1_3B43A8498FA6F0B3_WRITETO_OFFSET UNITYSDK_OFFSET(0x181593A0)
#define CLASS_1_3B43A8498FA6F0B3__CCTOR_OFFSET UNITYSDK_OFFSET(0x181599A0)
#define CLASS_1_3B43A8498FA6F0B3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18158E00)
#define CLASS_1_3B43A8498FA6F0B3__CTOR_OFFSET UNITYSDK_OFFSET(0x18158D80)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_4CF8088A158DCE25_41*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_3B43A8498FA6F0B3_TypeDefinitionIndex)->GetStaticField(0x4960);
	}
	static ::Google::Protobuf::FieldCodec_1<::Class_1_B33C6EDD7227DE6C_1*>** StaticGet_Field_1_8()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_B33C6EDD7227DE6C_1*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_3B43A8498FA6F0B3_TypeDefinitionIndex)->GetStaticField(0x4968);
	}
	static ::Google::Protobuf::FieldCodec_1<::Class_1_FA4F4A67B1C04320_437*>** StaticGet_Field_1_2()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_FA4F4A67B1C04320_437*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_3B43A8498FA6F0B3_TypeDefinitionIndex)->GetStaticField(0x4970);
	}
	...
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_B33C6EDD7227DE6C_1*>* Field_1_9; // 0x18
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_4CF8088A158DCE25_41*>* Field_1_6; // 0x20
