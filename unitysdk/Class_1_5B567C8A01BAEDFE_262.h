...
#define CLASS_1_5B567C8A01BAEDFE_262_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19FA3340)
#define CLASS_1_5B567C8A01BAEDFE_262_CLONE_OFFSET UNITYSDK_OFFSET(0x19FA3150)
#define CLASS_1_5B567C8A01BAEDFE_262_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19FA3250)
#define CLASS_1_5B567C8A01BAEDFE_262_EQUALS_OFFSET UNITYSDK_OFFSET(0x19FA31C0)
#define CLASS_1_5B567C8A01BAEDFE_262_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19FA32A0)
#define CLASS_1_5B567C8A01BAEDFE_262_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19FA3390)
#define CLASS_1_5B567C8A01BAEDFE_262_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19FA3360)
#define CLASS_1_5B567C8A01BAEDFE_262_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19FA30A0)
#define CLASS_1_5B567C8A01BAEDFE_262_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19FA3100)
#define CLASS_1_5B567C8A01BAEDFE_262_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19FA32D0)
#define CLASS_1_5B567C8A01BAEDFE_262_WRITETO_OFFSET UNITYSDK_OFFSET(0x19FA3330)
#define CLASS_1_5B567C8A01BAEDFE_262__CCTOR_OFFSET UNITYSDK_OFFSET(0x19FA33E0)
#define CLASS_1_5B567C8A01BAEDFE_262__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19FA3120)
#define CLASS_1_5B567C8A01BAEDFE_262__CTOR_OFFSET UNITYSDK_OFFSET(0x19FA3110)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_262*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_262_TypeDefinitionIndex)->GetStaticField(0x54C90);
	}
