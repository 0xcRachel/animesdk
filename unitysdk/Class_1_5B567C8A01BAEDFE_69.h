...
#define CLASS_1_5B567C8A01BAEDFE_69_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A1FB3E0)
#define CLASS_1_5B567C8A01BAEDFE_69_CLONE_OFFSET UNITYSDK_OFFSET(0x1A1FB1F0)
#define CLASS_1_5B567C8A01BAEDFE_69_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A1FB2F0)
#define CLASS_1_5B567C8A01BAEDFE_69_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A1FB260)
#define CLASS_1_5B567C8A01BAEDFE_69_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A1FB340)
#define CLASS_1_5B567C8A01BAEDFE_69_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A1FB430)
#define CLASS_1_5B567C8A01BAEDFE_69_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A1FB400)
#define CLASS_1_5B567C8A01BAEDFE_69_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A1FB140)
#define CLASS_1_5B567C8A01BAEDFE_69_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A1FB1A0)
#define CLASS_1_5B567C8A01BAEDFE_69_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A1FB370)
#define CLASS_1_5B567C8A01BAEDFE_69_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A1FB3D0)
#define CLASS_1_5B567C8A01BAEDFE_69__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1FB480)
#define CLASS_1_5B567C8A01BAEDFE_69__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A1FB1C0)
#define CLASS_1_5B567C8A01BAEDFE_69__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1FB1B0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_69*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_69_TypeDefinitionIndex)->GetStaticField(0x26900);
	}
