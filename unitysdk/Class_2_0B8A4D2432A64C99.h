...
#define CLASS_2_0B8A4D2432A64C99_METHOD_2_5D9CF83CFC617CF9_OFFSET UNITYSDK_OFFSET(0x17C5B4E0)
#define CLASS_2_0B8A4D2432A64C99_METHOD_2_8CE0803574BB66D7_OFFSET UNITYSDK_OFFSET(0x17C5B340)
#define CLASS_2_0B8A4D2432A64C99_METHOD_2_941C404C800CB723_OFFSET UNITYSDK_OFFSET(0x17C5B3A0)
#define CLASS_2_0B8A4D2432A64C99__CTOR_OFFSET UNITYSDK_OFFSET(0x17C5B450)
#define CLASS_2_0B8A4D2432A64C99__ONBIND_OFFSET UNITYSDK_OFFSET(0x17C5B2E0)
#define CLASS_2_0B8A4D2432A64C99___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0x17C5B480)

inline static constexpr unsigned int Class_2_0B8A4D2432A64C99_TypeDefinitionIndex = 67432;
