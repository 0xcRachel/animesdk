...
#define CLASS_2_6AA87DFE3140AF51_METHOD_2_02B7A9B7DE670ADB_OFFSET UNITYSDK_OFFSET(0x10318D40)
#define CLASS_2_6AA87DFE3140AF51_METHOD_2_078D85152011B919_OFFSET UNITYSDK_OFFSET(0x10318CE0)
#define CLASS_2_6AA87DFE3140AF51_METHOD_2_1B265F1038CD73C2_OFFSET UNITYSDK_OFFSET(0x10318F50)
#define CLASS_2_6AA87DFE3140AF51_METHOD_2_2177C24A5E2E46CB_OFFSET UNITYSDK_OFFSET(0x10318DA0)
#define CLASS_2_6AA87DFE3140AF51_METHOD_2_218124418542E081_OFFSET UNITYSDK_OFFSET(0x10318FB0)
#define CLASS_2_6AA87DFE3140AF51_METHOD_2_39590AB2089F9F4D_OFFSET UNITYSDK_OFFSET(0x103194B0)
#define CLASS_2_6AA87DFE3140AF51_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x10318BB0)
#define CLASS_2_6AA87DFE3140AF51_METHOD_2_9B39F7D7C1FF70D6_OFFSET UNITYSDK_OFFSET(0x103192D0)
#define CLASS_2_6AA87DFE3140AF51_METHOD_2_D09831639F615812_OFFSET UNITYSDK_OFFSET(0x10319640)
#define CLASS_2_6AA87DFE3140AF51_METHOD_2_D64FD9A228A1C4E0_OFFSET UNITYSDK_OFFSET(0x103195C0)
#define CLASS_2_6AA87DFE3140AF51_METHOD_2_E11AC65AA0DC2249_OFFSET UNITYSDK_OFFSET(0x10319350)
#define CLASS_2_6AA87DFE3140AF51_METHOD_2_F4C8B018D655630D_OFFSET UNITYSDK_OFFSET(0x103193A0)
#define CLASS_2_6AA87DFE3140AF51__CTOR_OFFSET UNITYSDK_OFFSET(0x10318B30)
#define CLASS_2_6AA87DFE3140AF51__ONBIND_OFFSET UNITYSDK_OFFSET(0x103187C0)
#define CLASS_2_6AA87DFE3140AF51__ONTICK_OFFSET UNITYSDK_OFFSET(0x10319400)
#define CLASS_2_6AA87DFE3140AF51___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0x103196A0)
#define CLASS_2_6AA87DFE3140AF51___IFIXBASEPROXY__ONTICK_OFFSET UNITYSDK_OFFSET(0x10319700)

inline static constexpr unsigned int Class_2_6AA87DFE3140AF51_TypeDefinitionIndex = 57535;
...
public:
	...
	{
		return (::System::Nullable_1<::System::Single>*)Il2CppClass::FromTypeDefinitionIndex(Class_2_6AA87DFE3140AF51_TypeDefinitionIndex)->GetStaticField(0xE550);
	}
	::System::String* Field_2_5; // 0x60
	::System::String* Field_2_6; // 0x68
	::System::String* Field_2_4; // 0x70
	::UnityEngine::Animation* Field_2_0; // 0x78
	::RPG::Client::LocalizedText* Field_2_3; // 0x80
	::System::String* Field_2_7; // 0x88
	::RPG::Client::RPGAnimationEvent* Field_2_1; // 0x90
	::RPG::Client::LocalizedText* Field_2_2; // 0x98
	::Class_1_23F67DD15593C8D6* Field_2_9; // 0xA0
	::Class_2_47C05B055FCC48B3* Field_2_8; // 0xA8
