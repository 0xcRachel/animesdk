...
#define CLASS_1_5B567C8A01BAEDFE_140_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A4495E0)
#define CLASS_1_5B567C8A01BAEDFE_140_CLONE_OFFSET UNITYSDK_OFFSET(0x1A4493F0)
#define CLASS_1_5B567C8A01BAEDFE_140_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A4494F0)
#define CLASS_1_5B567C8A01BAEDFE_140_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A449460)
#define CLASS_1_5B567C8A01BAEDFE_140_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A449540)
#define CLASS_1_5B567C8A01BAEDFE_140_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A449630)
#define CLASS_1_5B567C8A01BAEDFE_140_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A449600)
#define CLASS_1_5B567C8A01BAEDFE_140_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A449340)
#define CLASS_1_5B567C8A01BAEDFE_140_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A4493A0)
#define CLASS_1_5B567C8A01BAEDFE_140_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A449570)
#define CLASS_1_5B567C8A01BAEDFE_140_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A4495D0)
#define CLASS_1_5B567C8A01BAEDFE_140__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A449680)
#define CLASS_1_5B567C8A01BAEDFE_140__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A4493C0)
#define CLASS_1_5B567C8A01BAEDFE_140__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4493B0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_140*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_140_TypeDefinitionIndex)->GetStaticField(0xD660);
	}
