...
#define CLASS_1_5B567C8A01BAEDFE_140_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1B1BBDC0)
#define CLASS_1_5B567C8A01BAEDFE_140_CLONE_OFFSET UNITYSDK_OFFSET(0x1B1BBBD0)
#define CLASS_1_5B567C8A01BAEDFE_140_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1B1BBCD0)
#define CLASS_1_5B567C8A01BAEDFE_140_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B1BBC40)
#define CLASS_1_5B567C8A01BAEDFE_140_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B1BBD20)
#define CLASS_1_5B567C8A01BAEDFE_140_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1B1BBE10)
#define CLASS_1_5B567C8A01BAEDFE_140_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1B1BBDE0)
#define CLASS_1_5B567C8A01BAEDFE_140_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1B1BBB20)
#define CLASS_1_5B567C8A01BAEDFE_140_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1B1BBB80)
#define CLASS_1_5B567C8A01BAEDFE_140_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B1BBD50)
#define CLASS_1_5B567C8A01BAEDFE_140_WRITETO_OFFSET UNITYSDK_OFFSET(0x1B1BBDB0)
#define CLASS_1_5B567C8A01BAEDFE_140__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B1BBE60)
#define CLASS_1_5B567C8A01BAEDFE_140__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B1BBBA0)
#define CLASS_1_5B567C8A01BAEDFE_140__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1BBB90)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_140*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_140_TypeDefinitionIndex)->GetStaticField(0x56FB0);
	}
