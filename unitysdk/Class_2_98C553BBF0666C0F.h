...
#define CLASS_2_98C553BBF0666C0F_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x10411910)
#define CLASS_2_98C553BBF0666C0F_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x104119B0)
#define CLASS_2_98C553BBF0666C0F_METHOD_2_07BB339C490CE727_OFFSET UNITYSDK_OFFSET(0x10411350)
#define CLASS_2_98C553BBF0666C0F_METHOD_2_0C88AB06D46E777A_OFFSET UNITYSDK_OFFSET(0x10410710)
#define CLASS_2_98C553BBF0666C0F_METHOD_2_30A49BAAE192DEFA_OFFSET UNITYSDK_OFFSET(0x10410FB0)
#define CLASS_2_98C553BBF0666C0F_METHOD_2_56C38FA04523BC2D_OFFSET UNITYSDK_OFFSET(0x10411290)
#define CLASS_2_98C553BBF0666C0F_METHOD_2_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0x10411C80)
#define CLASS_2_98C553BBF0666C0F_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x10411C20)
#define CLASS_2_98C553BBF0666C0F_METHOD_2_9D62DE16254F5A7E_OFFSET UNITYSDK_OFFSET(0x104111A0)
#define CLASS_2_98C553BBF0666C0F_METHOD_2_C34FFE4348D9BAA0_OFFSET UNITYSDK_OFFSET(0x10411450)
#define CLASS_2_98C553BBF0666C0F_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x10410F30)
#define CLASS_2_98C553BBF0666C0F_METHOD_2_D3E111A72AFB2828_OFFSET UNITYSDK_OFFSET(0x104114E0)
#define CLASS_2_98C553BBF0666C0F_METHOD_2_F291FAB047B4807E_OFFSET UNITYSDK_OFFSET(0x10411650)
#define CLASS_2_98C553BBF0666C0F_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x10411850)
#define CLASS_2_98C553BBF0666C0F__CTOR_OFFSET UNITYSDK_OFFSET(0x10411A30)
#define CLASS_2_98C553BBF0666C0F__ONBIND_OFFSET UNITYSDK_OFFSET(0x104106D0)
#define CLASS_2_98C553BBF0666C0F__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x10410F70)
#define CLASS_2_98C553BBF0666C0F___IFIXBASEPROXY_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x10411D40)
#define CLASS_2_98C553BBF0666C0F___IFIXBASEPROXY_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x10411DA0)
#define CLASS_2_98C553BBF0666C0F___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0x10411BC0)
#define CLASS_2_98C553BBF0666C0F___IFIXBASEPROXY__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x10411CE0)

inline static constexpr unsigned int Class_2_98C553BBF0666C0F_TypeDefinitionIndex = 65987;

class Class_2_98C553BBF0666C0F : public ::Class_1_CA217ABF4E3B4F3F
{
public:
	::DamageTextStyle* Field_2_4; // 0x60
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::AttackDamageType, ::DamageTextStyle*>* Field_2_5; // 0x68
	::DamageTextStyle* Field_2_2; // 0x70
	::DamageTextStyle* Field_2_3; // 0x78
	::System::Collections::Generic::List_1<::System::Tuple_2<::RPG::Client::UIFloatingTextType, ::RPG::Client::TextID>*>* Field_2_0; // 0x80
