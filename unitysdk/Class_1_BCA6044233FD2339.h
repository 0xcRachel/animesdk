...
#define CLASS_1_BCA6044233FD2339_METHOD_1_8BBAD2F0C69AE863_OFFSET UNITYSDK_OFFSET(0xFE90FF0)
#define CLASS_1_BCA6044233FD2339_METHOD_1_DA5E75C5C463DE87_OFFSET UNITYSDK_OFFSET(0xFE91090)
#define CLASS_1_BCA6044233FD2339__CCTOR_OFFSET UNITYSDK_OFFSET(0xFE91180)
#define CLASS_1_BCA6044233FD2339__CTOR_OFFSET UNITYSDK_OFFSET(0xFE91170)

inline static constexpr unsigned int Class_1_BCA6044233FD2339_TypeDefinitionIndex = 44929;
...
public:
	...
	{
		return (::System::Collections::Generic::Queue_1<::UnityEngine::AI::NavMeshPath*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_BCA6044233FD2339_TypeDefinitionIndex)->GetStaticField(0x14620);
	}
