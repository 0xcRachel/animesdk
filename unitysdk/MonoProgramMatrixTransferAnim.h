...
#define MONOPROGRAMMATRIXTRANSFERANIM_METHOD_5_B43C848B078B3C34_OFFSET UNITYSDK_OFFSET(0x11200380)
#define MONOPROGRAMMATRIXTRANSFERANIM_METHOD_5_D460587695D41831_OFFSET UNITYSDK_OFFSET(0x111FFBD0)
#define MONOPROGRAMMATRIXTRANSFERANIM_METHOD_5_D7852DE078ACC1F1_OFFSET UNITYSDK_OFFSET(0x111FFF00)
#define MONOPROGRAMMATRIXTRANSFERANIM_ONENABLE_OFFSET UNITYSDK_OFFSET(0x11200D40)
#define MONOPROGRAMMATRIXTRANSFERANIM_UPDATE_OFFSET UNITYSDK_OFFSET(0x11200D90)
#define MONOPROGRAMMATRIXTRANSFERANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x11200DE0)

inline static constexpr unsigned int MonoProgramMatrixTransferAnim_TypeDefinitionIndex = 37407;
