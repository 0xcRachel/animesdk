...
#define CLASS_1_5B567C8A01BAEDFE_311_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A1B1E90)
#define CLASS_1_5B567C8A01BAEDFE_311_CLONE_OFFSET UNITYSDK_OFFSET(0x1A1B1D00)
#define CLASS_1_5B567C8A01BAEDFE_311_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A1B1DA0)
#define CLASS_1_5B567C8A01BAEDFE_311_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A1B1D40)
#define CLASS_1_5B567C8A01BAEDFE_311_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A1B1DF0)
#define CLASS_1_5B567C8A01BAEDFE_311_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A1B1EE0)
#define CLASS_1_5B567C8A01BAEDFE_311_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A1B1EB0)
#define CLASS_1_5B567C8A01BAEDFE_311_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A1B1C80)
#define CLASS_1_5B567C8A01BAEDFE_311_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A1B1CB0)
#define CLASS_1_5B567C8A01BAEDFE_311_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A1B1E20)
#define CLASS_1_5B567C8A01BAEDFE_311_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A1B1E80)
#define CLASS_1_5B567C8A01BAEDFE_311__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1B1F30)
#define CLASS_1_5B567C8A01BAEDFE_311__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A1B1CD0)
#define CLASS_1_5B567C8A01BAEDFE_311__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1B1CC0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_311*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_311_TypeDefinitionIndex)->GetStaticField(0x1BA10);
	}
