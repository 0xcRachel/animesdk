...
#define CLASS_2_33CACEAF75FAA6DB_METHOD_2_3256783DC4A2ADF5_OFFSET UNITYSDK_OFFSET(0xDE59630)
#define CLASS_2_33CACEAF75FAA6DB_METHOD_2_3463EEAF2913A5A3_OFFSET UNITYSDK_OFFSET(0xDE592F0)
#define CLASS_2_33CACEAF75FAA6DB_METHOD_2_3E3451FB7CD5402C_OFFSET UNITYSDK_OFFSET(0xDE58760)
#define CLASS_2_33CACEAF75FAA6DB_METHOD_2_479759059E440327_OFFSET UNITYSDK_OFFSET(0xDE59C00)
#define CLASS_2_33CACEAF75FAA6DB_METHOD_2_489E0B827662C211_OFFSET UNITYSDK_OFFSET(0xDE58B30)
#define CLASS_2_33CACEAF75FAA6DB_METHOD_2_9A431100DF90664F_OFFSET UNITYSDK_OFFSET(0xDE588A0)
#define CLASS_2_33CACEAF75FAA6DB_METHOD_2_B72C0DD7ED2095CA_OFFSET UNITYSDK_OFFSET(0xDE59080)
#define CLASS_2_33CACEAF75FAA6DB_METHOD_2_C83B2479936B63C3_OFFSET UNITYSDK_OFFSET(0xDE58140)
#define CLASS_2_33CACEAF75FAA6DB_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xDE59C90)
#define CLASS_2_33CACEAF75FAA6DB__CTOR_OFFSET UNITYSDK_OFFSET(0xDE580B0)

inline static constexpr unsigned int Class_2_33CACEAF75FAA6DB_TypeDefinitionIndex = 63373;

class Class_2_33CACEAF75FAA6DB : public ::Class_1_F65B6F8790DF074B
{
public:
	::RPG::Client::ChenLingBattleTeamSnapshot* Field_2_8; // 0x28
	::Class_1_B1C37B065CBC515F* Field_2_6; // 0x30
	::RPG::GameCore::ChenLingBattleAbility_Split* Field_2_0; // 0x38
	::Class_1_87D6E24AEDA0242C* Field_2_7; // 0x40
	::System::Single Field_2_5; // 0x48
	::System::Int32 Field_2_2; // 0x4C
	::UnityEngine::Quaternion Field_2_4; // 0x50
