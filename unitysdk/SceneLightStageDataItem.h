...
#define SCENELIGHTSTAGEDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xA681B40)

inline static constexpr unsigned int SceneLightStageDataItem_TypeDefinitionIndex = 37289;
