...
#define CLASS_1_97870C1EEE9A6A4F_DISPOSE_OFFSET UNITYSDK_OFFSET(0x105BB260)
#define CLASS_1_97870C1EEE9A6A4F__CTOR_OFFSET UNITYSDK_OFFSET(0x105BB2B0)

inline static constexpr unsigned int Class_1_97870C1EEE9A6A4F_TypeDefinitionIndex = 43880;
