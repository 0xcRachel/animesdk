...
#define CLASS_1_6AE8A317E51C99FC_CLEAR_OFFSET UNITYSDK_OFFSET(0x17C5F0C0)
#define CLASS_1_6AE8A317E51C99FC__CTOR_OFFSET UNITYSDK_OFFSET(0x17C5F130)
...
{
public:
	::Class_1_B8CD4F1CB8207431* Field_1_1; // 0x10
	::RPG::GameCore::FiveDimGravitySwitchLineConfig* Field_1_0; // 0x18
