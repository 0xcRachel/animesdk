...
#define CLASS_1_937F95F9E8467C2D_CLEAR_OFFSET UNITYSDK_OFFSET(0x15736240)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_14CC93689192A32B_OFFSET UNITYSDK_OFFSET(0x15736760)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_1991A7B40B7BA36D_OFFSET UNITYSDK_OFFSET(0x15736360)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_76BC447B9A4848CB_OFFSET UNITYSDK_OFFSET(0x15736090)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x15736F60)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_907E24F785836BA0_OFFSET UNITYSDK_OFFSET(0x15736FE0)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_976CDF5EF06E0838_OFFSET UNITYSDK_OFFSET(0x15737060)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x15736B20)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_A5624AB15FE32AEC_OFFSET UNITYSDK_OFFSET(0x15736C90)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_B8739D0DE156F9EB_OFFSET UNITYSDK_OFFSET(0x15736B70)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_C51EDA5D6F7FA146_OFFSET UNITYSDK_OFFSET(0x157363C0)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x15736C10)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x15736C50)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x15736BD0)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_D71F1E82F429310A_OFFSET UNITYSDK_OFFSET(0x15735F70)
#define CLASS_1_937F95F9E8467C2D__CCTOR_OFFSET UNITYSDK_OFFSET(0x157371F0)
#define CLASS_1_937F95F9E8467C2D__CTOR_OFFSET UNITYSDK_OFFSET(0x157371A0)
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_937F95F9E8467C2D_TypeDefinitionIndex)->GetStaticField(0x488C0);
	}
	::System::Collections::Generic::List_1<::Class_1_4E1996B50E2373CB*>* Field_1_1; // 0x10
	::RPG::GameCore::GameEntity* Field_1_2; // 0x18
	::Class_1_4E1996B50E2373CB* Field_1_3; // 0x20
	::Class_1_F65DC6656DEF8159* Field_1_4; // 0x28
	::RPG::GameCore::CharacterModelComponent* Field_1_5; // 0x30
	::RPG::GameCore::TransformComponent* Field_1_6; // 0x38
	::UnityEngine::SphereCollider* Field_1_7; // 0x40
	::System::Single Field_1_8; // 0x48
	::RPG::GameCore::TimeRewindState Field_1_9; // 0x4C
