...
#define CLASS_2_FC5C48ADFBABE99E_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBEEECD0)
#define CLASS_2_FC5C48ADFBABE99E_METHOD_2_049407E7CFE73C8B_OFFSET UNITYSDK_OFFSET(0xBEEF660)
#define CLASS_2_FC5C48ADFBABE99E_METHOD_2_2ED6C3773AA1E488_OFFSET UNITYSDK_OFFSET(0xBEEF000)
#define CLASS_2_FC5C48ADFBABE99E_METHOD_2_4EAF60B0FBDC2B64_OFFSET UNITYSDK_OFFSET(0xBEEF4C0)
#define CLASS_2_FC5C48ADFBABE99E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xBEEEE10)
#define CLASS_2_FC5C48ADFBABE99E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xBEEF280)
#define CLASS_2_FC5C48ADFBABE99E_TICK_OFFSET UNITYSDK_OFFSET(0xBEEF390)
#define CLASS_2_FC5C48ADFBABE99E__CTOR_OFFSET UNITYSDK_OFFSET(0xBEEECC0)
...
{
public:
	::Class_0_16E4307DCC419505_465* Field_2_3; // 0x18
	::RPG::GameCore::ShowTutorialGuideTalkListDialog* Field_2_0; // 0x20
	::Class_0_16E4307DCC419505_467* Field_2_2; // 0x28
