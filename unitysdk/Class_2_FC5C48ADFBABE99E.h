...
#define CLASS_2_FC5C48ADFBABE99E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x102C64F0)
#define CLASS_2_FC5C48ADFBABE99E_METHOD_2_049407E7CFE73C8B_OFFSET UNITYSDK_OFFSET(0x102C6DF0)
#define CLASS_2_FC5C48ADFBABE99E_METHOD_2_2ED6C3773AA1E488_OFFSET UNITYSDK_OFFSET(0x102C67F0)
#define CLASS_2_FC5C48ADFBABE99E_METHOD_2_4EAF60B0FBDC2B64_OFFSET UNITYSDK_OFFSET(0x102C6C50)
#define CLASS_2_FC5C48ADFBABE99E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x102C6630)
#define CLASS_2_FC5C48ADFBABE99E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x102C6A70)
#define CLASS_2_FC5C48ADFBABE99E_TICK_OFFSET UNITYSDK_OFFSET(0x102C6B50)
#define CLASS_2_FC5C48ADFBABE99E__CTOR_OFFSET UNITYSDK_OFFSET(0x102C64E0)
...
public:
	...
	::Class_0_16E4307DCC419505_546* Field_2_2; // 0x28
