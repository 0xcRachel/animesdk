...
#define CLASS_2_FC5C48ADFBABE99E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15855AE0)
#define CLASS_2_FC5C48ADFBABE99E_METHOD_2_2ED6C3773AA1E488_OFFSET UNITYSDK_OFFSET(0x15855E10)
#define CLASS_2_FC5C48ADFBABE99E_METHOD_2_4EAF60B0FBDC2B64_OFFSET UNITYSDK_OFFSET(0x15856270)
#define CLASS_2_FC5C48ADFBABE99E_METHOD_2_B386444429A36A77_OFFSET UNITYSDK_OFFSET(0x15856410)
#define CLASS_2_FC5C48ADFBABE99E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x15855C40)
#define CLASS_2_FC5C48ADFBABE99E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x15856090)
#define CLASS_2_FC5C48ADFBABE99E_TICK_OFFSET UNITYSDK_OFFSET(0x15856170)
#define CLASS_2_FC5C48ADFBABE99E__CTOR_OFFSET UNITYSDK_OFFSET(0x15855AD0)
...
{
public:
	::RPG::GameCore::ShowTutorialGuideTalkListDialog* Field_2_0; // 0x18
	::Class_0_16E4307DCC419505_568* Field_2_1; // 0x20
