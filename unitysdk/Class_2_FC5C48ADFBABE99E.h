...
#define CLASS_2_FC5C48ADFBABE99E_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB2BBBD0)
#define CLASS_2_FC5C48ADFBABE99E_METHOD_2_049407E7CFE73C8B_OFFSET UNITYSDK_OFFSET(0xB2BC490)
#define CLASS_2_FC5C48ADFBABE99E_METHOD_2_2BC55A66CB2B0118_OFFSET UNITYSDK_OFFSET(0xB2BBEE0)
#define CLASS_2_FC5C48ADFBABE99E_METHOD_2_4EAF60B0FBDC2B64_OFFSET UNITYSDK_OFFSET(0xB2BC2F0)
#define CLASS_2_FC5C48ADFBABE99E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB2BBD10)
#define CLASS_2_FC5C48ADFBABE99E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB2BC110)
#define CLASS_2_FC5C48ADFBABE99E_TICK_OFFSET UNITYSDK_OFFSET(0xB2BC1F0)
#define CLASS_2_FC5C48ADFBABE99E__CTOR_OFFSET UNITYSDK_OFFSET(0xB2BBBC0)

inline static constexpr unsigned int Class_2_FC5C48ADFBABE99E_TypeDefinitionIndex = 46303;
...
public:
	...
	::Class_0_16E4307DCC419505_439* Field_2_2; // 0x28
	::Class_0_16E4307DCC419505_437* Field_2_3; // 0x30
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_2_FC5C48ADFBABE99E_METHOD_2_2BC55A66CB2B0118_OFFSET))(this);
	}
