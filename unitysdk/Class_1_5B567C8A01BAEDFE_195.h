...
#define CLASS_1_5B567C8A01BAEDFE_195_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A4601F0)
#define CLASS_1_5B567C8A01BAEDFE_195_CLONE_OFFSET UNITYSDK_OFFSET(0x1A460060)
#define CLASS_1_5B567C8A01BAEDFE_195_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A460100)
#define CLASS_1_5B567C8A01BAEDFE_195_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A4600A0)
#define CLASS_1_5B567C8A01BAEDFE_195_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A460150)
#define CLASS_1_5B567C8A01BAEDFE_195_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A460240)
#define CLASS_1_5B567C8A01BAEDFE_195_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A460210)
#define CLASS_1_5B567C8A01BAEDFE_195_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A45FFE0)
#define CLASS_1_5B567C8A01BAEDFE_195_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A460010)
#define CLASS_1_5B567C8A01BAEDFE_195_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A460180)
#define CLASS_1_5B567C8A01BAEDFE_195_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A4601E0)
#define CLASS_1_5B567C8A01BAEDFE_195__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A460290)
#define CLASS_1_5B567C8A01BAEDFE_195__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A460030)
#define CLASS_1_5B567C8A01BAEDFE_195__CTOR_OFFSET UNITYSDK_OFFSET(0x1A460020)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_195*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_195_TypeDefinitionIndex)->GetStaticField(0x41300);
	}
