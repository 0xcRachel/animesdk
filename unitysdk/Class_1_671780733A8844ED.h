...
#define CLASS_1_671780733A8844ED_GET_IDLELIVEPROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0xECDE130)
#define CLASS_1_671780733A8844ED_METHOD_1_1187FD85F8BDC1D1_OFFSET UNITYSDK_OFFSET(0xECDF3B0)
#define CLASS_1_671780733A8844ED_METHOD_1_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0xECDE110)
#define CLASS_1_671780733A8844ED_METHOD_1_5D65BD003B831CB6_OFFSET UNITYSDK_OFFSET(0xECDE120)
#define CLASS_1_671780733A8844ED_METHOD_1_8973B92D2ACD93AC_OFFSET UNITYSDK_OFFSET(0xECDF8F0)
#define CLASS_1_671780733A8844ED_METHOD_1_D3A860C94F2DA104_OFFSET UNITYSDK_OFFSET(0xECDE980)
#define CLASS_1_671780733A8844ED_METHOD_1_DD1F80BD94ED96B3_OFFSET UNITYSDK_OFFSET(0xECDE150)
#define CLASS_1_671780733A8844ED_SET_IDLELIVEPROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0xECDE140)
#define CLASS_1_671780733A8844ED__CTOR_1_OFFSET UNITYSDK_OFFSET(0xECDE630)
#define CLASS_1_671780733A8844ED__CTOR_OFFSET UNITYSDK_OFFSET(0xECDE270)

inline static constexpr unsigned int Class_1_671780733A8844ED_TypeDefinitionIndex = 69389;

class Class_1_671780733A8844ED : public ::System::Object
{
public:
	::RPG::Client::ActivityIdleLive::IdleLiveDecimal Field_1_3; // 0x10
	::RPG::Client::ActivityIdleLive::IdleLiveDecimal Field_1_6; // 0x28
	::System::Collections::Generic::List_1<::RPG::Client::ActivityIdleLive::IdleLiveDecimal>* Field_1_8; // 0x40
	::System::String* Field_1_0; // 0x48
	::RPG::Client::ActivityIdleLive::IdleLiveDecimal Field_1_5; // 0x50
	::RPG::Client::ActivityIdleLive::IdleLiveDecimal Field_1_4; // 0x68
	::RPG::GameCore::IdleLiveAvatarPropertyType _IdleLivePropertyType_k__BackingField; // 0x80
	::System::Boolean Field_1_2; // 0x84
	::RPG::GameCore::FixPoint Field_1_7; // 0x88
	::RPG::Client::TextID Field_1_1; // 0x90
