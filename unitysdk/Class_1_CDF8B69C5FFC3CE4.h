...
#define CLASS_1_CDF8B69C5FFC3CE4_METHOD_1_0C3DC5C304CB7D42_OFFSET UNITYSDK_OFFSET(0x118C6160)
#define CLASS_1_CDF8B69C5FFC3CE4_METHOD_1_190BE5968B70A711_OFFSET UNITYSDK_OFFSET(0x118C62E0)
#define CLASS_1_CDF8B69C5FFC3CE4_METHOD_1_30B62F5CDB9079BD_OFFSET UNITYSDK_OFFSET(0x118C6470)
#define CLASS_1_CDF8B69C5FFC3CE4_METHOD_1_3B779D433D1B9409_OFFSET UNITYSDK_OFFSET(0x118C5C00)
#define CLASS_1_CDF8B69C5FFC3CE4_METHOD_1_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x118C6A70)
#define CLASS_1_CDF8B69C5FFC3CE4_METHOD_1_47BFC64AD95D6D77_OFFSET UNITYSDK_OFFSET(0x118C5010)
#define CLASS_1_CDF8B69C5FFC3CE4_METHOD_1_5A124CAF1E48B74F_OFFSET UNITYSDK_OFFSET(0x118C6C50)
#define CLASS_1_CDF8B69C5FFC3CE4_METHOD_1_777C630B90A28EF1_OFFSET UNITYSDK_OFFSET(0x118C6940)
#define CLASS_1_CDF8B69C5FFC3CE4_METHOD_1_9076BB310BB6989E_OFFSET UNITYSDK_OFFSET(0x118C6DC0)
#define CLASS_1_CDF8B69C5FFC3CE4_METHOD_1_B43C848B078B3C34_OFFSET UNITYSDK_OFFSET(0x118C5120)
#define CLASS_1_CDF8B69C5FFC3CE4_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x118C68F0)
#define CLASS_1_CDF8B69C5FFC3CE4_METHOD_1_CA4D29E38D9171A0_OFFSET UNITYSDK_OFFSET(0x118C74A0)
#define CLASS_1_CDF8B69C5FFC3CE4_METHOD_1_D7852DE078ACC1F1_OFFSET UNITYSDK_OFFSET(0x118C6AC0)
#define CLASS_1_CDF8B69C5FFC3CE4_METHOD_1_E6ADFDCAE54F8710_OFFSET UNITYSDK_OFFSET(0x118C6520)
#define CLASS_1_CDF8B69C5FFC3CE4_METHOD_1_E9A040D6645EDC32_OFFSET UNITYSDK_OFFSET(0x118C70E0)
#define CLASS_1_CDF8B69C5FFC3CE4_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x118C78B0)
#define CLASS_1_CDF8B69C5FFC3CE4_METHOD_1_F6CBC0B224F49504_OFFSET UNITYSDK_OFFSET(0x118C4D90)
#define CLASS_1_CDF8B69C5FFC3CE4__CCTOR_OFFSET UNITYSDK_OFFSET(0x118C7A50)
#define CLASS_1_CDF8B69C5FFC3CE4__CTOR_OFFSET UNITYSDK_OFFSET(0x118C78C0)

inline static constexpr unsigned int Class_1_CDF8B69C5FFC3CE4_TypeDefinitionIndex = 67059;
...
public:
	...
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_1_CDF8B69C5FFC3CE4_TypeDefinitionIndex)->GetStaticField(0xF600);
	}
