...
#define CLASS_2_AF7D1AC2A3EAA7DD_DISPOSE_OFFSET UNITYSDK_OFFSET(0x96AD780)
#define CLASS_2_AF7D1AC2A3EAA7DD_METHOD_2_043A554C8C65B8D1_OFFSET UNITYSDK_OFFSET(0x96AFA40)
#define CLASS_2_AF7D1AC2A3EAA7DD_METHOD_2_0D926A533E72C276_OFFSET UNITYSDK_OFFSET(0x96ADB90)
#define CLASS_2_AF7D1AC2A3EAA7DD_METHOD_2_18982EFD3B740683_OFFSET UNITYSDK_OFFSET(0x96ADE20)
#define CLASS_2_AF7D1AC2A3EAA7DD_METHOD_2_298236AC333160E8_OFFSET UNITYSDK_OFFSET(0x96AEE60)
#define CLASS_2_AF7D1AC2A3EAA7DD_METHOD_2_2D1808F981B590D0_OFFSET UNITYSDK_OFFSET(0x96AEB90)
#define CLASS_2_AF7D1AC2A3EAA7DD_METHOD_2_2D69DEA94F4D6D5B_OFFSET UNITYSDK_OFFSET(0x96AE9D0)
#define CLASS_2_AF7D1AC2A3EAA7DD_METHOD_2_44D79A8627DE7D79_OFFSET UNITYSDK_OFFSET(0x96AE4C0)
#define CLASS_2_AF7D1AC2A3EAA7DD_METHOD_2_459D0A4618A0FA48_OFFSET UNITYSDK_OFFSET(0x96AFA20)
#define CLASS_2_AF7D1AC2A3EAA7DD_METHOD_2_4D331AADF765164C_OFFSET UNITYSDK_OFFSET(0x96AF730)
#define CLASS_2_AF7D1AC2A3EAA7DD_METHOD_2_4E608ED8CF3CBCB8_OFFSET UNITYSDK_OFFSET(0x96AEF00)
#define CLASS_2_AF7D1AC2A3EAA7DD_METHOD_2_52607DE4C357D269_OFFSET UNITYSDK_OFFSET(0x96AF650)
#define CLASS_2_AF7D1AC2A3EAA7DD_METHOD_2_5C3494A3B250FBC5_OFFSET UNITYSDK_OFFSET(0x96AF790)
#define CLASS_2_AF7D1AC2A3EAA7DD_METHOD_2_8C4AEC0BC1CA0CB4_OFFSET UNITYSDK_OFFSET(0x96AE070)
#define CLASS_2_AF7D1AC2A3EAA7DD_METHOD_2_8E8526B4C2756CA6_OFFSET UNITYSDK_OFFSET(0x96AF5E0)
#define CLASS_2_AF7D1AC2A3EAA7DD_METHOD_2_98EF186D5BD08475_OFFSET UNITYSDK_OFFSET(0x96AD870)
#define CLASS_2_AF7D1AC2A3EAA7DD_METHOD_2_9AFCA18B112F248A_OFFSET UNITYSDK_OFFSET(0x96AF840)
#define CLASS_2_AF7D1AC2A3EAA7DD_METHOD_2_9D9CF8F6C2342EE5_OFFSET UNITYSDK_OFFSET(0x96AF8E0)
#define CLASS_2_AF7D1AC2A3EAA7DD_METHOD_2_9F8F6511E8EF1235_OFFSET UNITYSDK_OFFSET(0x96AFA30)
#define CLASS_2_AF7D1AC2A3EAA7DD_METHOD_2_A3EBE3D65878FB6E_OFFSET UNITYSDK_OFFSET(0x96AE010)
#define CLASS_2_AF7D1AC2A3EAA7DD_METHOD_2_C561FF611C07A44C_OFFSET UNITYSDK_OFFSET(0x96AE290)
#define CLASS_2_AF7D1AC2A3EAA7DD_METHOD_2_D3F0B653E0982E96_1_OFFSET UNITYSDK_OFFSET(0x96AE970)
#define CLASS_2_AF7D1AC2A3EAA7DD_METHOD_2_D3F0B653E0982E96_OFFSET UNITYSDK_OFFSET(0x96AE450)
#define CLASS_2_AF7D1AC2A3EAA7DD_METHOD_2_D5E5EC1B4538DDD1_OFFSET UNITYSDK_OFFSET(0x96AFA50)
#define CLASS_2_AF7D1AC2A3EAA7DD_METHOD_2_D6C225F121F56344_OFFSET UNITYSDK_OFFSET(0x96AE390)
#define CLASS_2_AF7D1AC2A3EAA7DD__CTOR_OFFSET UNITYSDK_OFFSET(0x96AD5F0)
#define CLASS_2_AF7D1AC2A3EAA7DD___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x96AF9A0)

inline static constexpr unsigned int Class_2_AF7D1AC2A3EAA7DD_TypeDefinitionIndex = 41390;
...
public:
	...
	::Class_1_6F4466F4D48CF248* Field_2_11; // 0x78
	::Class_3_BCCE950C2E8DF1F0* Field_2_17; // 0x80
	::Class_3_BCCE950C2E8DF1F0* Field_2_18; // 0x88
	::RPG::GameCore::TaskContext* Field_2_19; // 0x90
	::Class_1_60475C2D4D583319* Field_2_12; // 0x98
	::RPG::GameCore::ModifyAdventureCharacterRunSpeedRatio* Field_2_13; // 0xA0
	::System::Single Field_2_7; // 0xA8
	::UnityEngine::Vector3 Field_2_10; // 0xAC
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::Single, ::System::Boolean))((::PBYTE)hIl2Cpp + CLASS_2_AF7D1AC2A3EAA7DD_METHOD_2_44D79A8627DE7D79_OFFSET))(this, a1, a2);
	}
