...
#define CLASS_1_5CF1DDAFE12F0E87_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1764DF90)
#define CLASS_1_5CF1DDAFE12F0E87_CLONE_OFFSET UNITYSDK_OFFSET(0x1764DAA0)
#define CLASS_1_5CF1DDAFE12F0E87_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1764DBE0)
#define CLASS_1_5CF1DDAFE12F0E87_EQUALS_OFFSET UNITYSDK_OFFSET(0x1764DB80)
#define CLASS_1_5CF1DDAFE12F0E87_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1764DCC0)
#define CLASS_1_5CF1DDAFE12F0E87_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1764E320)
#define CLASS_1_5CF1DDAFE12F0E87_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1764E250)
#define CLASS_1_5CF1DDAFE12F0E87_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1764DB30)
#define CLASS_1_5CF1DDAFE12F0E87_METHOD_1_02A3D10A9D535169_2_OFFSET UNITYSDK_OFFSET(0x1764DB50)
#define CLASS_1_5CF1DDAFE12F0E87_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1764DB10)
#define CLASS_1_5CF1DDAFE12F0E87_METHOD_1_3DACC45AC8150727_OFFSET UNITYSDK_OFFSET(0x1764DB00)
#define CLASS_1_5CF1DDAFE12F0E87_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x1764DB70)
#define CLASS_1_5CF1DDAFE12F0E87_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1764DB40)
#define CLASS_1_5CF1DDAFE12F0E87_METHOD_1_7786DC814C2FC3BE_2_OFFSET UNITYSDK_OFFSET(0x1764DB60)
#define CLASS_1_5CF1DDAFE12F0E87_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1764DB20)
#define CLASS_1_5CF1DDAFE12F0E87_METHOD_1_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x1764DAF0)
#define CLASS_1_5CF1DDAFE12F0E87_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1764D980)
#define CLASS_1_5CF1DDAFE12F0E87_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1764DDD0)
#define CLASS_1_5CF1DDAFE12F0E87_WRITETO_OFFSET UNITYSDK_OFFSET(0x1764DE30)
#define CLASS_1_5CF1DDAFE12F0E87__CCTOR_OFFSET UNITYSDK_OFFSET(0x1764E440)
#define CLASS_1_5CF1DDAFE12F0E87__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1764D9E0)
#define CLASS_1_5CF1DDAFE12F0E87__CTOR_OFFSET UNITYSDK_OFFSET(0x1764D990)

inline static constexpr unsigned int Class_1_5CF1DDAFE12F0E87_TypeDefinitionIndex = 22546;
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_6EBEA8069CDA622C_3*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5CF1DDAFE12F0E87_TypeDefinitionIndex)->GetStaticField(0x27040);
	}
	...
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_6EBEA8069CDA622C_3*>* Field_1_11; // 0x18
	::Enum_3_01618AD0437C8486 Field_1_2; // 0x20
