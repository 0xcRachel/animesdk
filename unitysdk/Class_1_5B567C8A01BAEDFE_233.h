...
#define CLASS_1_5B567C8A01BAEDFE_233_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A8AE230)
#define CLASS_1_5B567C8A01BAEDFE_233_CLONE_OFFSET UNITYSDK_OFFSET(0x1A8AE040)
#define CLASS_1_5B567C8A01BAEDFE_233_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A8AE140)
#define CLASS_1_5B567C8A01BAEDFE_233_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A8AE0B0)
#define CLASS_1_5B567C8A01BAEDFE_233_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A8AE190)
#define CLASS_1_5B567C8A01BAEDFE_233_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A8AE280)
#define CLASS_1_5B567C8A01BAEDFE_233_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A8AE250)
#define CLASS_1_5B567C8A01BAEDFE_233_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A8ADF90)
#define CLASS_1_5B567C8A01BAEDFE_233_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A8ADFF0)
#define CLASS_1_5B567C8A01BAEDFE_233_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A8AE1C0)
#define CLASS_1_5B567C8A01BAEDFE_233_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A8AE220)
#define CLASS_1_5B567C8A01BAEDFE_233__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A8AE2D0)
#define CLASS_1_5B567C8A01BAEDFE_233__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A8AE010)
#define CLASS_1_5B567C8A01BAEDFE_233__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8AE000)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_233*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_233_TypeDefinitionIndex)->GetStaticField(0x42E80);
	}
