...
#define CLASS_2_1C6778AE6D99DECB_METHOD_2_8CE0803574BB66D7_OFFSET UNITYSDK_OFFSET(0x106C1AF0)
#define CLASS_2_1C6778AE6D99DECB_METHOD_2_941C404C800CB723_OFFSET UNITYSDK_OFFSET(0x106C1B50)
#define CLASS_2_1C6778AE6D99DECB_METHOD_2_C89A41A14F7CCD91_OFFSET UNITYSDK_OFFSET(0x106C1C90)
#define CLASS_2_1C6778AE6D99DECB__CTOR_OFFSET UNITYSDK_OFFSET(0x106C1C00)
#define CLASS_2_1C6778AE6D99DECB__ONBIND_OFFSET UNITYSDK_OFFSET(0x106C1A40)
#define CLASS_2_1C6778AE6D99DECB___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0x106C1C30)

inline static constexpr unsigned int Class_2_1C6778AE6D99DECB_TypeDefinitionIndex = 59107;
