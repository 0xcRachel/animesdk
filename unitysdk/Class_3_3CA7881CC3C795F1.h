...
#define CLASS_3_3CA7881CC3C795F1_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15E1A4F0)
#define CLASS_3_3CA7881CC3C795F1_METHOD_3_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x15E1C330)
#define CLASS_3_3CA7881CC3C795F1_METHOD_3_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x15E1C540)
#define CLASS_3_3CA7881CC3C795F1_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x15E1C6D0)
#define CLASS_3_3CA7881CC3C795F1_METHOD_3_79830F666EE579C0_OFFSET UNITYSDK_OFFSET(0x15E1B510)
#define CLASS_3_3CA7881CC3C795F1_METHOD_3_7A8604A90B40E6A9_OFFSET UNITYSDK_OFFSET(0x15E1C050)
#define CLASS_3_3CA7881CC3C795F1_METHOD_3_841E1F33C77D2AFF_OFFSET UNITYSDK_OFFSET(0x15E1B830)
#define CLASS_3_3CA7881CC3C795F1_METHOD_3_947D2B8B7863EE1B_OFFSET UNITYSDK_OFFSET(0x15E1AE20)
#define CLASS_3_3CA7881CC3C795F1_METHOD_3_9DF32A38C8C42AFC_OFFSET UNITYSDK_OFFSET(0x15E1C0F0)
#define CLASS_3_3CA7881CC3C795F1_METHOD_3_B8817F4F77EFC234_OFFSET UNITYSDK_OFFSET(0x15E1B630)
#define CLASS_3_3CA7881CC3C795F1_METHOD_3_D26AC14EBBDB9AAF_OFFSET UNITYSDK_OFFSET(0x15E1AD40)
#define CLASS_3_3CA7881CC3C795F1_METHOD_3_F79D5EC57FBF426E_OFFSET UNITYSDK_OFFSET(0x15E1BE80)
#define CLASS_3_3CA7881CC3C795F1_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x15E1A5C0)
#define CLASS_3_3CA7881CC3C795F1_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x15E1C410)
#define CLASS_3_3CA7881CC3C795F1_TICK_OFFSET UNITYSDK_OFFSET(0x15E1AEE0)
#define CLASS_3_3CA7881CC3C795F1__CCTOR_OFFSET UNITYSDK_OFFSET(0x15E1C7F0)
#define CLASS_3_3CA7881CC3C795F1__CTOR_OFFSET UNITYSDK_OFFSET(0x15E1A3C0)
#define CLASS_3_3CA7881CC3C795F1___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15E1C810)
...
public:
	...
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_3_3CA7881CC3C795F1_TypeDefinitionIndex)->GetStaticField(0x9A60);
	}
	static ::System::Single* StaticGet_Field_3_1()
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_3_3CA7881CC3C795F1_TypeDefinitionIndex)->GetStaticField(0x9A64);
	}
	static ::System::Single* StaticGet_Field_3_2()
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_3_3CA7881CC3C795F1_TypeDefinitionIndex)->GetStaticField(0x9A68);
	}
	::Class_2_9D4DD2F4235F8658* Field_3_3; // 0x30
	::Class_3_07C3C4D2990C49EE* Field_3_4; // 0x38
	::RPG::GameCore::TransformComponent* Field_3_5; // 0x40
	::RPG::GameCore::AdvSetAILeadWay* Field_3_6; // 0x48
	::Class_2_A0580152EB393340* Field_3_7; // 0x50
	...
	::RPG::GameCore::AILeadWayState Field_3_14; // 0x70
