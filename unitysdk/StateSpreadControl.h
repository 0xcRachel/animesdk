...
#define STATESPREADCONTROL_METHOD_4_C06AC8811E797798_OFFSET UNITYSDK_OFFSET(0xABED470)
#define STATESPREADCONTROL_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0xABED2A0)
#define STATESPREADCONTROL_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xABED3C0)
#define STATESPREADCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xABED590)
#define STATESPREADCONTROL___IFIXBASEPROXY_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0xABED5A0)
#define STATESPREADCONTROL___IFIXBASEPROXY_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xABED5B0)
