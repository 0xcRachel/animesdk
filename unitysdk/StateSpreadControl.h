...
#define STATESPREADCONTROL_METHOD_4_C06AC8811E797798_OFFSET UNITYSDK_OFFSET(0xA6A5900)
#define STATESPREADCONTROL_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0xA6A5730)
#define STATESPREADCONTROL_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA6A5850)
#define STATESPREADCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xA6A5A20)
#define STATESPREADCONTROL___IFIXBASEPROXY_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0xA6A5A30)
#define STATESPREADCONTROL___IFIXBASEPROXY_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA6A5A40)

inline static constexpr unsigned int StateSpreadControl_TypeDefinitionIndex = 37523;
