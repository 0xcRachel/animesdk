...
#define CLASS_1_5B567C8A01BAEDFE_300_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A1E6510)
#define CLASS_1_5B567C8A01BAEDFE_300_CLONE_OFFSET UNITYSDK_OFFSET(0x1A1E6380)
#define CLASS_1_5B567C8A01BAEDFE_300_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A1E6420)
#define CLASS_1_5B567C8A01BAEDFE_300_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A1E63C0)
#define CLASS_1_5B567C8A01BAEDFE_300_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A1E6470)
#define CLASS_1_5B567C8A01BAEDFE_300_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A1E6560)
#define CLASS_1_5B567C8A01BAEDFE_300_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A1E6530)
#define CLASS_1_5B567C8A01BAEDFE_300_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A1E6300)
#define CLASS_1_5B567C8A01BAEDFE_300_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A1E6330)
#define CLASS_1_5B567C8A01BAEDFE_300_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A1E64A0)
#define CLASS_1_5B567C8A01BAEDFE_300_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A1E6500)
#define CLASS_1_5B567C8A01BAEDFE_300__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1E65B0)
#define CLASS_1_5B567C8A01BAEDFE_300__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A1E6350)
#define CLASS_1_5B567C8A01BAEDFE_300__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1E6340)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_300*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_300_TypeDefinitionIndex)->GetStaticField(0x118E0);
	}
