...
#define CLASS_1_BD2C8496C23D4C2D_2_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17B9D150)
#define CLASS_1_BD2C8496C23D4C2D_2_CLONE_OFFSET UNITYSDK_OFFSET(0x17B9CE70)
#define CLASS_1_BD2C8496C23D4C2D_2_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17B9CFA0)
#define CLASS_1_BD2C8496C23D4C2D_2_EQUALS_OFFSET UNITYSDK_OFFSET(0x17B9CF00)
#define CLASS_1_BD2C8496C23D4C2D_2_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17B9D030)
#define CLASS_1_BD2C8496C23D4C2D_2_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x17B9D210)
#define CLASS_1_BD2C8496C23D4C2D_2_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x17B9D1C0)
#define CLASS_1_BD2C8496C23D4C2D_2_METHOD_1_4090005D9A43383B_OFFSET UNITYSDK_OFFSET(0x17B9CEF0)
#define CLASS_1_BD2C8496C23D4C2D_2_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17B9CDC0)
#define CLASS_1_BD2C8496C23D4C2D_2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17B9D070)
#define CLASS_1_BD2C8496C23D4C2D_2_WRITETO_OFFSET UNITYSDK_OFFSET(0x17B9D0D0)
#define CLASS_1_BD2C8496C23D4C2D_2__CCTOR_OFFSET UNITYSDK_OFFSET(0x17B9D2C0)
#define CLASS_1_BD2C8496C23D4C2D_2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17B9CE00)
#define CLASS_1_BD2C8496C23D4C2D_2__CTOR_OFFSET UNITYSDK_OFFSET(0x17B9CDD0)
...
public:
	...
	{
		return (::Google::Protobuf::Collections::MapField_2_Codec<::System::UInt32, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_BD2C8496C23D4C2D_2_TypeDefinitionIndex)->GetStaticField(0x46750);
	}
