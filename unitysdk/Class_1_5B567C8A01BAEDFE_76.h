...
#define CLASS_1_5B567C8A01BAEDFE_76_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1993A9D0)
#define CLASS_1_5B567C8A01BAEDFE_76_CLONE_OFFSET UNITYSDK_OFFSET(0x1993A840)
#define CLASS_1_5B567C8A01BAEDFE_76_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1993A8E0)
#define CLASS_1_5B567C8A01BAEDFE_76_EQUALS_OFFSET UNITYSDK_OFFSET(0x1993A880)
#define CLASS_1_5B567C8A01BAEDFE_76_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1993A930)
#define CLASS_1_5B567C8A01BAEDFE_76_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1993AA20)
#define CLASS_1_5B567C8A01BAEDFE_76_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1993A9F0)
#define CLASS_1_5B567C8A01BAEDFE_76_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1993A7C0)
#define CLASS_1_5B567C8A01BAEDFE_76_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1993A7F0)
#define CLASS_1_5B567C8A01BAEDFE_76_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1993A960)
#define CLASS_1_5B567C8A01BAEDFE_76_WRITETO_OFFSET UNITYSDK_OFFSET(0x1993A9C0)
#define CLASS_1_5B567C8A01BAEDFE_76__CCTOR_OFFSET UNITYSDK_OFFSET(0x1993AA70)
#define CLASS_1_5B567C8A01BAEDFE_76__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1993A810)
#define CLASS_1_5B567C8A01BAEDFE_76__CTOR_OFFSET UNITYSDK_OFFSET(0x1993A800)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_76*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_76_TypeDefinitionIndex)->GetStaticField(0x2CAA0);
	}
