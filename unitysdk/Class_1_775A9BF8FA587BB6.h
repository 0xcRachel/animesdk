...
#define CLASS_1_775A9BF8FA587BB6_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x181270F0)
#define CLASS_1_775A9BF8FA587BB6_CLONE_OFFSET UNITYSDK_OFFSET(0x18126BF0)
#define CLASS_1_775A9BF8FA587BB6_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x18126CB0)
#define CLASS_1_775A9BF8FA587BB6_EQUALS_OFFSET UNITYSDK_OFFSET(0x18126C80)
#define CLASS_1_775A9BF8FA587BB6_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x18126D70)
#define CLASS_1_775A9BF8FA587BB6_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x18127330)
#define CLASS_1_775A9BF8FA587BB6_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x181272C0)
#define CLASS_1_775A9BF8FA587BB6_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x18126C40)
#define CLASS_1_775A9BF8FA587BB6_METHOD_1_4C4B9DFE092840D4_OFFSET UNITYSDK_OFFSET(0x18126C30)
#define CLASS_1_775A9BF8FA587BB6_METHOD_1_554199E0076172C5_1_OFFSET UNITYSDK_OFFSET(0x18126C70)
#define CLASS_1_775A9BF8FA587BB6_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x18126C60)
#define CLASS_1_775A9BF8FA587BB6_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x18126C50)
#define CLASS_1_775A9BF8FA587BB6_METHOD_1_7ADD5F1F5E247E3B_OFFSET UNITYSDK_OFFSET(0x18126C20)
#define CLASS_1_775A9BF8FA587BB6_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x18126A60)
#define CLASS_1_775A9BF8FA587BB6_TOSTRING_OFFSET UNITYSDK_OFFSET(0x18126F70)
#define CLASS_1_775A9BF8FA587BB6_WRITETO_OFFSET UNITYSDK_OFFSET(0x18126FD0)
#define CLASS_1_775A9BF8FA587BB6__CCTOR_OFFSET UNITYSDK_OFFSET(0x18127460)
#define CLASS_1_775A9BF8FA587BB6__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18126B00)
#define CLASS_1_775A9BF8FA587BB6__CTOR_OFFSET UNITYSDK_OFFSET(0x18126A70)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_775A9BF8FA587BB6_TypeDefinitionIndex)->GetStaticField(0x41060);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_6()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_775A9BF8FA587BB6_TypeDefinitionIndex)->GetStaticField(0x41068);
	}
