...
#define CLASS_1_5B567C8A01BAEDFE_23_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19AAC7D0)
#define CLASS_1_5B567C8A01BAEDFE_23_CLONE_OFFSET UNITYSDK_OFFSET(0x19AAC5E0)
#define CLASS_1_5B567C8A01BAEDFE_23_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19AAC6E0)
#define CLASS_1_5B567C8A01BAEDFE_23_EQUALS_OFFSET UNITYSDK_OFFSET(0x19AAC650)
#define CLASS_1_5B567C8A01BAEDFE_23_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19AAC730)
#define CLASS_1_5B567C8A01BAEDFE_23_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19AAC820)
#define CLASS_1_5B567C8A01BAEDFE_23_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19AAC7F0)
#define CLASS_1_5B567C8A01BAEDFE_23_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19AAC530)
#define CLASS_1_5B567C8A01BAEDFE_23_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19AAC590)
#define CLASS_1_5B567C8A01BAEDFE_23_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19AAC760)
#define CLASS_1_5B567C8A01BAEDFE_23_WRITETO_OFFSET UNITYSDK_OFFSET(0x19AAC7C0)
#define CLASS_1_5B567C8A01BAEDFE_23__CCTOR_OFFSET UNITYSDK_OFFSET(0x19AAC870)
#define CLASS_1_5B567C8A01BAEDFE_23__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19AAC5B0)
#define CLASS_1_5B567C8A01BAEDFE_23__CTOR_OFFSET UNITYSDK_OFFSET(0x19AAC5A0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_23*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_23_TypeDefinitionIndex)->GetStaticField(0x2E450);
	}
