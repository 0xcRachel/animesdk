...
#define CLASS_3_DA3467C8E23483C5_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15F20AF0)
#define CLASS_3_DA3467C8E23483C5_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15F20B70)
#define CLASS_3_DA3467C8E23483C5_INVOKE_OFFSET UNITYSDK_OFFSET(0x15F20620)
#define CLASS_3_DA3467C8E23483C5__CTOR_OFFSET UNITYSDK_OFFSET(0x15F20600)

inline static constexpr unsigned int Class_3_DA3467C8E23483C5_TypeDefinitionIndex = 28076;
