...
#define CLASS_2_6E28C061C82DA711_CLEAR_OFFSET UNITYSDK_OFFSET(0x14F11E20)
#define CLASS_2_6E28C061C82DA711_CREATEEQUIPITEMS_OFFSET UNITYSDK_OFFSET(0x14F11EF0)
#define CLASS_2_6E28C061C82DA711_CREATEPROPERTYPROVIDER_OFFSET UNITYSDK_OFFSET(0x14F11EA0)
#define CLASS_2_6E28C061C82DA711_CREATETRAITS_OFFSET UNITYSDK_OFFSET(0x14F12360)
#define CLASS_2_6E28C061C82DA711_METHOD_2_617C5F75EC8B9441_OFFSET UNITYSDK_OFFSET(0x14F11C60)
#define CLASS_2_6E28C061C82DA711__CTOR_OFFSET UNITYSDK_OFFSET(0x14F123F0)
#define CLASS_2_6E28C061C82DA711___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0x14F12400)
...
public:
	...
	{
		return ((::Class_0_16E4307DCC419505_787*(*)(::PVOID, ::RPG::Client::GridFightRole*))((::PBYTE)hIl2Cpp + CLASS_2_6E28C061C82DA711_CREATEPROPERTYPROVIDER_OFFSET))(this, a1);
	}
