...
#define CLASS_1_C14F0EB0858990DF_METHOD_1_0E3C9CE42200F670_OFFSET UNITYSDK_OFFSET(0x16C08100)
#define CLASS_1_C14F0EB0858990DF__CTOR_OFFSET UNITYSDK_OFFSET(0x16C08510)
...
public:
	...
	::RPG::GameCore::RogueTournRoomType Field_1_1; // 0x24
	::RPG::Client::TextID Field_1_3; // 0x28
	::RPG::GameCore::RogueTournPersonaRoomBgColorType Field_1_2; // 0x38
