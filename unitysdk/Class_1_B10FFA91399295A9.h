...
#define CLASS_1_B10FFA91399295A9_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19B6B400)
#define CLASS_1_B10FFA91399295A9_CLONE_OFFSET UNITYSDK_OFFSET(0x19B6AFC0)
#define CLASS_1_B10FFA91399295A9_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19B6B070)
#define CLASS_1_B10FFA91399295A9_EQUALS_OFFSET UNITYSDK_OFFSET(0x19B6B040)
#define CLASS_1_B10FFA91399295A9_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19B6B170)
#define CLASS_1_B10FFA91399295A9_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19B6B610)
#define CLASS_1_B10FFA91399295A9_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19B6B520)
#define CLASS_1_B10FFA91399295A9_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x19B6AFF0)
#define CLASS_1_B10FFA91399295A9_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x19B6B010)
#define CLASS_1_B10FFA91399295A9_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19B6AE30)
#define CLASS_1_B10FFA91399295A9_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x19B6B030)
#define CLASS_1_B10FFA91399295A9_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x19B6B000)
#define CLASS_1_B10FFA91399295A9_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x19B6B020)
#define CLASS_1_B10FFA91399295A9_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19B6AE60)
#define CLASS_1_B10FFA91399295A9_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19B6B2D0)
#define CLASS_1_B10FFA91399295A9_WRITETO_OFFSET UNITYSDK_OFFSET(0x19B6B330)
#define CLASS_1_B10FFA91399295A9__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B6B780)
#define CLASS_1_B10FFA91399295A9__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19B6AEB0)
#define CLASS_1_B10FFA91399295A9__CTOR_OFFSET UNITYSDK_OFFSET(0x19B6AE70)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_B10FFA91399295A9*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B10FFA91399295A9_TypeDefinitionIndex)->GetStaticField(0x14030);
	}
	static ::Google::Protobuf::FieldCodec_1<::Class_1_E0BAE492EF64CE43*>** StaticGet_Field_1_7()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_E0BAE492EF64CE43*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B10FFA91399295A9_TypeDefinitionIndex)->GetStaticField(0x14038);
	}
