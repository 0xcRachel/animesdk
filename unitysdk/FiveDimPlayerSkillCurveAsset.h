...
#define FIVEDIMPLAYERSKILLCURVEASSET_METHOD_3_0FDE67E8BCF7203D_1_OFFSET UNITYSDK_OFFSET(0x161B5050)
#define FIVEDIMPLAYERSKILLCURVEASSET_METHOD_3_0FDE67E8BCF7203D_2_OFFSET UNITYSDK_OFFSET(0x161B5140)
#define FIVEDIMPLAYERSKILLCURVEASSET_METHOD_3_0FDE67E8BCF7203D_OFFSET UNITYSDK_OFFSET(0x161B4F60)
#define FIVEDIMPLAYERSKILLCURVEASSET_METHOD_3_20F2E478F76F0620_OFFSET UNITYSDK_OFFSET(0x161B4E70)
#define FIVEDIMPLAYERSKILLCURVEASSET_METHOD_3_C650DC783089C46A_OFFSET UNITYSDK_OFFSET(0x161B4DD0)
#define FIVEDIMPLAYERSKILLCURVEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x161B5230)

inline static constexpr unsigned int FiveDimPlayerSkillCurveAsset_TypeDefinitionIndex = 31297;
