...
#define STRUCT_2_CBA08FB52D88FCC0_GET_GAMEMODE_OFFSET UNITYSDK_OFFSET(0x72BBF0)
#define STRUCT_2_CBA08FB52D88FCC0_GET_NEWSTATE_OFFSET UNITYSDK_OFFSET(0x66B8A0)
#define STRUCT_2_CBA08FB52D88FCC0_GET_OLDSTATE_OFFSET UNITYSDK_OFFSET(0x72B7E0)
#define STRUCT_2_CBA08FB52D88FCC0__CTOR_OFFSET UNITYSDK_OFFSET(0x6C9750)

inline static constexpr unsigned int Struct_2_CBA08FB52D88FCC0_TypeDefinitionIndex = 73742;
