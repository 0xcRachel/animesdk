...
#define HIPPLENBUILDERBUFFASSET_BUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1053DEA0)

inline static constexpr unsigned int HipplenBuilderBuffAsset_BuffConfig_TypeDefinitionIndex = 37172;
