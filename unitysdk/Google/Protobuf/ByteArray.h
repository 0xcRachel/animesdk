...
#define GOOGLE_PROTOBUF_BYTEARRAY_COPY_OFFSET UNITYSDK_OFFSET(0x153D3C30)
#define GOOGLE_PROTOBUF_BYTEARRAY_REVERSE_OFFSET UNITYSDK_OFFSET(0x153D3CD0)

namespace Google::Protobuf
{
	inline static constexpr unsigned int ByteArray_TypeDefinitionIndex = 6051;
