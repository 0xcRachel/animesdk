...
#define GOOGLE_PROTOBUF_EXTENSION_GET_FIELDNUMBER_OFFSET UNITYSDK_OFFSET(0x153D95A0)

namespace Google::Protobuf
{
	inline static constexpr unsigned int Extension_TypeDefinitionIndex = 6056;
