...
#define CLASS_3_E7A54F49C408A228_METHOD_3_705C181AFDCF5689_OFFSET UNITYSDK_OFFSET(0x16E2FD20)
#define CLASS_3_E7A54F49C408A228_METHOD_3_F32CA7BD1D486055_OFFSET UNITYSDK_OFFSET(0x16E2FC90)
#define CLASS_3_E7A54F49C408A228__CTOR_OFFSET UNITYSDK_OFFSET(0x16E2FCF0)

inline static constexpr unsigned int Class_3_E7A54F49C408A228_TypeDefinitionIndex = 20366;

class Class_3_E7A54F49C408A228 : public ::RPG::GameCore::TaskConfig
{
public:
	::System::Boolean Field_3_1; // 0x18
	::System::Boolean Field_3_4; // 0x19
	::System::Boolean Field_3_0; // 0x1A
	::System::Boolean Field_3_2; // 0x1B
