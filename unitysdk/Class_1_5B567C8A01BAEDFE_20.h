...
#define CLASS_1_5B567C8A01BAEDFE_20_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19EED040)
#define CLASS_1_5B567C8A01BAEDFE_20_CLONE_OFFSET UNITYSDK_OFFSET(0x19EECE50)
#define CLASS_1_5B567C8A01BAEDFE_20_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19EECF50)
#define CLASS_1_5B567C8A01BAEDFE_20_EQUALS_OFFSET UNITYSDK_OFFSET(0x19EECEC0)
#define CLASS_1_5B567C8A01BAEDFE_20_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19EECFA0)
#define CLASS_1_5B567C8A01BAEDFE_20_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19EED090)
#define CLASS_1_5B567C8A01BAEDFE_20_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19EED060)
#define CLASS_1_5B567C8A01BAEDFE_20_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19EECDA0)
#define CLASS_1_5B567C8A01BAEDFE_20_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19EECE00)
#define CLASS_1_5B567C8A01BAEDFE_20_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19EECFD0)
#define CLASS_1_5B567C8A01BAEDFE_20_WRITETO_OFFSET UNITYSDK_OFFSET(0x19EED030)
#define CLASS_1_5B567C8A01BAEDFE_20__CCTOR_OFFSET UNITYSDK_OFFSET(0x19EED0E0)
#define CLASS_1_5B567C8A01BAEDFE_20__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19EECE20)
#define CLASS_1_5B567C8A01BAEDFE_20__CTOR_OFFSET UNITYSDK_OFFSET(0x19EECE10)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_20*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_20_TypeDefinitionIndex)->GetStaticField(0x3EDC0);
	}
