...
#define CLASS_1_855C52860E843240_GET_AVATARFACTORY_OFFSET UNITYSDK_OFFSET(0xDED6210)
#define CLASS_1_855C52860E843240_GET_AVATARPROXYFACTORY_OFFSET UNITYSDK_OFFSET(0xDED6230)
#define CLASS_1_855C52860E843240_GET_SERVERAVATARPROFILEFACTORY_OFFSET UNITYSDK_OFFSET(0xDED6250)
#define CLASS_1_855C52860E843240_METHOD_1_0B6F187DB45E7EDF_OFFSET UNITYSDK_OFFSET(0xDED69F0)
#define CLASS_1_855C52860E843240_METHOD_1_24DDBE0B1A4A8BFD_1_OFFSET UNITYSDK_OFFSET(0xDED6E60)
#define CLASS_1_855C52860E843240_METHOD_1_24DDBE0B1A4A8BFD_OFFSET UNITYSDK_OFFSET(0xDED6DA0)
#define CLASS_1_855C52860E843240_METHOD_1_381C8F6E3911CBDD_OFFSET UNITYSDK_OFFSET(0xDED6270)
#define CLASS_1_855C52860E843240_METHOD_1_4471D735DB5DDCA9_1_OFFSET UNITYSDK_OFFSET(0xDED7130)
#define CLASS_1_855C52860E843240_METHOD_1_4471D735DB5DDCA9_OFFSET UNITYSDK_OFFSET(0xDED6F20)
#define CLASS_1_855C52860E843240_METHOD_1_5D0F7C2E3D59BB96_OFFSET UNITYSDK_OFFSET(0xDED6460)
#define CLASS_1_855C52860E843240_METHOD_1_6985E2D2A0BCF409_1_OFFSET UNITYSDK_OFFSET(0xDED6770)
#define CLASS_1_855C52860E843240_METHOD_1_6985E2D2A0BCF409_OFFSET UNITYSDK_OFFSET(0xDED64F0)
#define CLASS_1_855C52860E843240_METHOD_1_88479DB0BA833117_OFFSET UNITYSDK_OFFSET(0xDED6A50)
#define CLASS_1_855C52860E843240_SET_AVATARFACTORY_OFFSET UNITYSDK_OFFSET(0xDED6220)
#define CLASS_1_855C52860E843240_SET_AVATARPROXYFACTORY_OFFSET UNITYSDK_OFFSET(0xDED6240)
#define CLASS_1_855C52860E843240_SET_SERVERAVATARPROFILEFACTORY_OFFSET UNITYSDK_OFFSET(0xDED6260)
#define CLASS_1_855C52860E843240__CTOR_OFFSET UNITYSDK_OFFSET(0xDED7340)

inline static constexpr unsigned int Class_1_855C52860E843240_TypeDefinitionIndex = 49831;

class Class_1_855C52860E843240 : public ::System::Object
{
public:
	::System::Collections::Generic::Dictionary_2<::Struct_2_019938BC9C50B169_1, ::RPG::Client::AvatarProxy*>* Field_1_0; // 0x10
	::System::Collections::Generic::Dictionary_2<::Struct_2_BC950E36747FB4C9, ::RPG::AvatarSystem::Avatar*>* Field_1_2; // 0x18
	::Class_1_152440782683448A* _AvatarProxyFactory_k__BackingField; // 0x20
	::System::Collections::Generic::Dictionary_2<::Struct_2_019938BC9C50B169_2, ::RPG::Client::AvatarProxy*>* Field_1_1; // 0x28
	::Class_2_D079E335ECA1E136* _ServerAvatarProfileFactory_k__BackingField; // 0x30
	::Class_0_16E4307DCC419505_342* _AvatarFactory_k__BackingField; // 0x38
	...
	{
		return ((::Class_0_16E4307DCC419505_342*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_855C52860E843240_GET_AVATARFACTORY_OFFSET))(this);
	}

	::System::Void set_AvatarFactory(::Class_0_16E4307DCC419505_342* value)
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_342*))((::PBYTE)hIl2Cpp + CLASS_1_855C52860E843240_SET_AVATARFACTORY_OFFSET))(this, value);
	}
