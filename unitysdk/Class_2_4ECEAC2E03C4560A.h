...
#define CLASS_2_4ECEAC2E03C4560A_BEFOREDISPOSE_OFFSET UNITYSDK_OFFSET(0x10524310)
#define CLASS_2_4ECEAC2E03C4560A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x105242D0)
#define CLASS_2_4ECEAC2E03C4560A_METHOD_2_169C5280D338BD7B_OFFSET UNITYSDK_OFFSET(0x105248F0)
#define CLASS_2_4ECEAC2E03C4560A_METHOD_2_1AD51778485AD495_OFFSET UNITYSDK_OFFSET(0x105247F0)
#define CLASS_2_4ECEAC2E03C4560A_METHOD_2_22806B2F0BB89E7E_OFFSET UNITYSDK_OFFSET(0x105233B0)
#define CLASS_2_4ECEAC2E03C4560A_METHOD_2_3899FDD7FD93BFAC_OFFSET UNITYSDK_OFFSET(0x10523C10)
#define CLASS_2_4ECEAC2E03C4560A_METHOD_2_3C6260EB9E672654_OFFSET UNITYSDK_OFFSET(0x10524980)
#define CLASS_2_4ECEAC2E03C4560A_METHOD_2_464B7FEEA3D325D3_OFFSET UNITYSDK_OFFSET(0x10523600)
#define CLASS_2_4ECEAC2E03C4560A_METHOD_2_886EE15AAE69E211_OFFSET UNITYSDK_OFFSET(0x10522D20)
#define CLASS_2_4ECEAC2E03C4560A_METHOD_2_9AFCA18B112F248A_OFFSET UNITYSDK_OFFSET(0x10524EF0)
#define CLASS_2_4ECEAC2E03C4560A_METHOD_2_A9F402EE239E6F9D_OFFSET UNITYSDK_OFFSET(0x10522AF0)
#define CLASS_2_4ECEAC2E03C4560A_METHOD_2_ABE7715DB28B2DD1_OFFSET UNITYSDK_OFFSET(0x105243F0)
#define CLASS_2_4ECEAC2E03C4560A_METHOD_2_F0E307B84478A272_OFFSET UNITYSDK_OFFSET(0x10522D00)
#define CLASS_2_4ECEAC2E03C4560A_TICK_OFFSET UNITYSDK_OFFSET(0x10524580)
#define CLASS_2_4ECEAC2E03C4560A__CTOR_OFFSET UNITYSDK_OFFSET(0x10524FD0)
#define CLASS_2_4ECEAC2E03C4560A___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x10524FE0)

inline static constexpr unsigned int Class_2_4ECEAC2E03C4560A_TypeDefinitionIndex = 60075;

class Class_2_4ECEAC2E03C4560A : public ::RPG::GameCore::GameComponentBase
{
public:
	::RPG::Client::EraFlipperManager* Field_2_9; // 0x18
	::Class_1_0CB627C4F1CDDD99* Field_2_7; // 0x20
	::RPG::GameCore::NPCComponent* Field_2_8; // 0x28
	::System::String* Field_2_3; // 0x30
	::System::String* Field_2_2; // 0x38
	::System::Nullable_1<::Class_2_4ECEAC2E03C4560A_NpcStateControlSource> Field_2_1; // 0x40
	::System::Boolean Field_2_12; // 0x48
	::Class_2_4ECEAC2E03C4560A_NpcShowState Field_2_6; // 0x4C
	::System::Nullable_1<::Class_2_4ECEAC2E03C4560A_NpcShowState> Field_2_0; // 0x50
