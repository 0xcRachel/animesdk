...
#define CLASS_1_EE2A70ED9E9B0C92_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0xE5D07C0)
#define CLASS_1_EE2A70ED9E9B0C92_TOSTRING_OFFSET UNITYSDK_OFFSET(0xE5D0860)
#define CLASS_1_EE2A70ED9E9B0C92__CTOR_OFFSET UNITYSDK_OFFSET(0xE5D07B0)
#define CLASS_1_EE2A70ED9E9B0C92___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0xE5D0910)
