...
#define CLASS_1_EE2A70ED9E9B0C92_METHOD_1_8B5756C77447A64A_OFFSET UNITYSDK_OFFSET(0x84196F0)
#define CLASS_1_EE2A70ED9E9B0C92_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8419940)
#define CLASS_1_EE2A70ED9E9B0C92__CTOR_OFFSET UNITYSDK_OFFSET(0x84196E0)
#define CLASS_1_EE2A70ED9E9B0C92___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x84199F0)

inline static constexpr unsigned int Class_1_EE2A70ED9E9B0C92_TypeDefinitionIndex = 46847;
