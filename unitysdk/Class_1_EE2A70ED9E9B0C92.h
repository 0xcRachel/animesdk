...
#define CLASS_1_EE2A70ED9E9B0C92_METHOD_1_8B5756C77447A64A_OFFSET UNITYSDK_OFFSET(0x8E2B0B0)
#define CLASS_1_EE2A70ED9E9B0C92_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8E2B300)
#define CLASS_1_EE2A70ED9E9B0C92__CTOR_OFFSET UNITYSDK_OFFSET(0x8E2B0A0)
#define CLASS_1_EE2A70ED9E9B0C92___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8E2B3B0)
