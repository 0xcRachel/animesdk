...
#define UNITY_THROWSTUB_THROWNOTSUPPORTEDEXCEPTION_OFFSET UNITYSDK_OFFSET(0x17D44330)

namespace Unity
{
	inline static constexpr unsigned int ThrowStub_TypeDefinitionIndex = 4826;
