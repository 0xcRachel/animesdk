...
#define CLASS_3_0889C2B20F5B917B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x8CD0B10)
#define CLASS_3_0889C2B20F5B917B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x8CD0C80)
#define CLASS_3_0889C2B20F5B917B_TICK_OFFSET UNITYSDK_OFFSET(0x8CD0B70)
#define CLASS_3_0889C2B20F5B917B__CTOR_OFFSET UNITYSDK_OFFSET(0x8CD0AB0)
#define CLASS_3_0889C2B20F5B917B___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x8CD0CD0)
