...
#define CLASS_3_0889C2B20F5B917B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10369630)
#define CLASS_3_0889C2B20F5B917B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x103697A0)
#define CLASS_3_0889C2B20F5B917B_TICK_OFFSET UNITYSDK_OFFSET(0x10369690)
#define CLASS_3_0889C2B20F5B917B__CTOR_OFFSET UNITYSDK_OFFSET(0x103695D0)
#define CLASS_3_0889C2B20F5B917B___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x103697F0)

inline static constexpr unsigned int Class_3_0889C2B20F5B917B_TypeDefinitionIndex = 41230;
