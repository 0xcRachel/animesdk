...
#define CLASS_3_0889C2B20F5B917B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x15FC2100)
#define CLASS_3_0889C2B20F5B917B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x15FC2270)
#define CLASS_3_0889C2B20F5B917B_TICK_OFFSET UNITYSDK_OFFSET(0x15FC2160)
#define CLASS_3_0889C2B20F5B917B__CTOR_OFFSET UNITYSDK_OFFSET(0x15FC20A0)
#define CLASS_3_0889C2B20F5B917B___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x15FC22C0)
