...
#define CLASS_1_BE77F98C85B2B14F___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1503ED50)
#define CLASS_1_BE77F98C85B2B14F___C__CREATEGAMEREFROLE_B__2_0_OFFSET UNITYSDK_OFFSET(0x1503EDA0)
#define CLASS_1_BE77F98C85B2B14F___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1503ED90)
...
public:
	...
	{
		return (::System::Func_2<::System::UInt32, ::RPG::Client::GridFightEquipItemData*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_BE77F98C85B2B14F___c_TypeDefinitionIndex)->GetStaticField(0x57050);
	}
	static ::Class_1_BE77F98C85B2B14F___c** StaticGet___9()
	{
		return (::Class_1_BE77F98C85B2B14F___c**)Il2CppClass::FromTypeDefinitionIndex(Class_1_BE77F98C85B2B14F___c_TypeDefinitionIndex)->GetStaticField(0x57058);
	}
