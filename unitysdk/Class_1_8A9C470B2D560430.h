...
#define CLASS_1_8A9C470B2D560430_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x175A0920)
#define CLASS_1_8A9C470B2D560430_CLONE_OFFSET UNITYSDK_OFFSET(0x175A0380)
#define CLASS_1_8A9C470B2D560430_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x175A04C0)
#define CLASS_1_8A9C470B2D560430_EQUALS_OFFSET UNITYSDK_OFFSET(0x175A0460)
#define CLASS_1_8A9C470B2D560430_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x175A05F0)
#define CLASS_1_8A9C470B2D560430_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x175A0B00)
#define CLASS_1_8A9C470B2D560430_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x175A0A70)
#define CLASS_1_8A9C470B2D560430_METHOD_1_3BDC77F20CA26C81_OFFSET UNITYSDK_OFFSET(0x175A0400)
#define CLASS_1_8A9C470B2D560430_METHOD_1_8380E7BF9C2E481D_OFFSET UNITYSDK_OFFSET(0x175A0410)
#define CLASS_1_8A9C470B2D560430_METHOD_1_AA645B8654F862A0_OFFSET UNITYSDK_OFFSET(0x175A03F0)
#define CLASS_1_8A9C470B2D560430_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x175A03E0)
#define CLASS_1_8A9C470B2D560430_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x175A03D0)
#define CLASS_1_8A9C470B2D560430_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x175A01C0)
#define CLASS_1_8A9C470B2D560430_TOSTRING_OFFSET UNITYSDK_OFFSET(0x175A0780)
#define CLASS_1_8A9C470B2D560430_WRITETO_OFFSET UNITYSDK_OFFSET(0x175A07E0)
#define CLASS_1_8A9C470B2D560430__CCTOR_OFFSET UNITYSDK_OFFSET(0x175A0CA0)
#define CLASS_1_8A9C470B2D560430__CTOR_1_OFFSET UNITYSDK_OFFSET(0x175A0260)
#define CLASS_1_8A9C470B2D560430__CTOR_OFFSET UNITYSDK_OFFSET(0x175A01D0)

inline static constexpr unsigned int Class_1_8A9C470B2D560430_TypeDefinitionIndex = 22474;
...
public:
	...
	{
		return (::Google::Protobuf::Collections::MapField_2_Codec<::System::String*, ::Class_1_FA4F4A67B1C04320_16*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_8A9C470B2D560430_TypeDefinitionIndex)->GetStaticField(0x14B50);
	}
	...
	{
		return ((::System::Void(*)(::PVOID, ::Google::Protobuf::ByteString*))((::PBYTE)hIl2Cpp + CLASS_1_8A9C470B2D560430_METHOD_1_8380E7BF9C2E481D_OFFSET))(this, a1);
	}
