...
#define STRUCT_2_B779786ED1CB5B0A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x381C460)
#define STRUCT_2_B779786ED1CB5B0A_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x381C3C0)
#define STRUCT_2_B779786ED1CB5B0A_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x381C4A0)
#define STRUCT_2_B779786ED1CB5B0A_RESET_OFFSET UNITYSDK_OFFSET(0x381C520)
#define STRUCT_2_B779786ED1CB5B0A_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x381C410)
#define STRUCT_2_B779786ED1CB5B0A__CTOR_OFFSET UNITYSDK_OFFSET(0x381C340)

inline static constexpr unsigned int Struct_2_B779786ED1CB5B0A_TypeDefinitionIndex = 69934;
