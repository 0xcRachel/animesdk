...
#define CLASS_1_352A8B3482C80E7D_21_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17CE3590)
#define CLASS_1_352A8B3482C80E7D_21_CLONE_OFFSET UNITYSDK_OFFSET(0x17CE32C0)
#define CLASS_1_352A8B3482C80E7D_21_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17CE3410)
#define CLASS_1_352A8B3482C80E7D_21_EQUALS_OFFSET UNITYSDK_OFFSET(0x17CE3370)
#define CLASS_1_352A8B3482C80E7D_21_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17CE3470)
#define CLASS_1_352A8B3482C80E7D_21_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x17CE3720)
#define CLASS_1_352A8B3482C80E7D_21_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x17CE36E0)
#define CLASS_1_352A8B3482C80E7D_21_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x17CE3350)
#define CLASS_1_352A8B3482C80E7D_21_METHOD_1_3DACC45AC8150727_OFFSET UNITYSDK_OFFSET(0x17CE3340)
#define CLASS_1_352A8B3482C80E7D_21_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x17CE3360)
#define CLASS_1_352A8B3482C80E7D_21_METHOD_1_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x17CE3330)
#define CLASS_1_352A8B3482C80E7D_21_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17CE3270)
#define CLASS_1_352A8B3482C80E7D_21_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17CE34A0)
#define CLASS_1_352A8B3482C80E7D_21_WRITETO_OFFSET UNITYSDK_OFFSET(0x17CE3500)
#define CLASS_1_352A8B3482C80E7D_21__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17CE3290)
#define CLASS_1_352A8B3482C80E7D_21__CTOR_OFFSET UNITYSDK_OFFSET(0x17CE3280)

inline static constexpr unsigned int Class_1_352A8B3482C80E7D_21_TypeDefinitionIndex = 24539;
...
public:
	...
	{
		return ((::Enum_3_0A3761FE34514D6C_35(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_352A8B3482C80E7D_21_METHOD_1_A96DCA30C6927810_OFFSET))(this);
	}

	::System::Void Method_1_3DACC45AC8150727(::Enum_3_0A3761FE34514D6C_35 a1)
	{
		return ((::System::Void(*)(::PVOID, ::Enum_3_0A3761FE34514D6C_35))((::PBYTE)hIl2Cpp + CLASS_1_352A8B3482C80E7D_21_METHOD_1_3DACC45AC8150727_OFFSET))(this, a1);
	}
