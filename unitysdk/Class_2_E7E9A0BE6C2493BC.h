...
#define CLASS_2_E7E9A0BE6C2493BC_METHOD_2_022B0D58A3077BF2_OFFSET UNITYSDK_OFFSET(0xD1D2FB0)
#define CLASS_2_E7E9A0BE6C2493BC_METHOD_2_15240475E6251796_OFFSET UNITYSDK_OFFSET(0xD1D39D0)
#define CLASS_2_E7E9A0BE6C2493BC_METHOD_2_29DD12396AE89C75_OFFSET UNITYSDK_OFFSET(0xD1D28E0)
#define CLASS_2_E7E9A0BE6C2493BC_METHOD_2_3DD9CDD21849C79E_OFFSET UNITYSDK_OFFSET(0xD1D1E50)
#define CLASS_2_E7E9A0BE6C2493BC_METHOD_2_53EFB6656ED62D50_OFFSET UNITYSDK_OFFSET(0xD1D1FD0)
#define CLASS_2_E7E9A0BE6C2493BC_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xD1D3D30)
#define CLASS_2_E7E9A0BE6C2493BC_METHOD_2_5CB1195CE7AFB965_OFFSET UNITYSDK_OFFSET(0xD1D36B0)
#define CLASS_2_E7E9A0BE6C2493BC_METHOD_2_723E4567D37B31D6_OFFSET UNITYSDK_OFFSET(0xD1D3660)
#define CLASS_2_E7E9A0BE6C2493BC_METHOD_2_850E0EB08CA9201F_OFFSET UNITYSDK_OFFSET(0xD1D21F0)
#define CLASS_2_E7E9A0BE6C2493BC_METHOD_2_862A46B7ADA3ADE1_OFFSET UNITYSDK_OFFSET(0xD1D33F0)
#define CLASS_2_E7E9A0BE6C2493BC_METHOD_2_A9DAF3FE2888211B_1_OFFSET UNITYSDK_OFFSET(0xD1D3890)
#define CLASS_2_E7E9A0BE6C2493BC_METHOD_2_A9DAF3FE2888211B_OFFSET UNITYSDK_OFFSET(0xD1D2EB0)
#define CLASS_2_E7E9A0BE6C2493BC_METHOD_2_BCCEF225A11BDA90_OFFSET UNITYSDK_OFFSET(0xD1D1DE0)
#define CLASS_2_E7E9A0BE6C2493BC_METHOD_2_C450A961450309C9_OFFSET UNITYSDK_OFFSET(0xD1D3340)
#define CLASS_2_E7E9A0BE6C2493BC_METHOD_2_C89A41A14F7CCD91_OFFSET UNITYSDK_OFFSET(0xD1D3CC0)
#define CLASS_2_E7E9A0BE6C2493BC_METHOD_2_CEB324AD021F471A_OFFSET UNITYSDK_OFFSET(0xD1D2790)
#define CLASS_2_E7E9A0BE6C2493BC_METHOD_2_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0xD1D3980)
#define CLASS_2_E7E9A0BE6C2493BC_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xD1D3C20)
#define CLASS_2_E7E9A0BE6C2493BC__CTOR_OFFSET UNITYSDK_OFFSET(0xD1D3C30)
#define CLASS_2_E7E9A0BE6C2493BC__ONBIND_OFFSET UNITYSDK_OFFSET(0xD1D1CC0)
#define CLASS_2_E7E9A0BE6C2493BC___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0xD1D3C60)

inline static constexpr unsigned int Class_2_E7E9A0BE6C2493BC_TypeDefinitionIndex = 57323;
...
public:
	...
	::Class_0_16E4307DCC419505_789* Field_2_1; // 0x60
	::Class_0_16E4307DCC419505_789* Field_2_0; // 0x68
	...
	::System::Void Method_2_29DD12396AE89C75(::RPG::GameCore::AvatarRowData* a1, ::RPG::GameCore::ICharacterSkillRowData* a2)
	{
		return ((::System::Void(*)(::PVOID, ::RPG::GameCore::AvatarRowData*, ::RPG::GameCore::ICharacterSkillRowData*))((::PBYTE)hIl2Cpp + CLASS_2_E7E9A0BE6C2493BC_METHOD_2_29DD12396AE89C75_OFFSET))(this, a1, a2);
	}
