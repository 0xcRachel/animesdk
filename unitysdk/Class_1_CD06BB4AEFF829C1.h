...
#define CLASS_1_CD06BB4AEFF829C1_METHOD_1_45872D1C931761E1_OFFSET UNITYSDK_OFFSET(0x10872220)
#define CLASS_1_CD06BB4AEFF829C1_METHOD_1_4F680C77B6FB93F9_OFFSET UNITYSDK_OFFSET(0x10870C50)
#define CLASS_1_CD06BB4AEFF829C1_METHOD_1_5E1B12074A48CEA4_OFFSET UNITYSDK_OFFSET(0x10871750)
#define CLASS_1_CD06BB4AEFF829C1_METHOD_1_6DBF6F974FD0BF92_OFFSET UNITYSDK_OFFSET(0x10871C60)
#define CLASS_1_CD06BB4AEFF829C1_METHOD_1_6FFDE68FDD1DA0C2_OFFSET UNITYSDK_OFFSET(0x10871530)
#define CLASS_1_CD06BB4AEFF829C1_METHOD_1_8C97CA3BAB7FB2D7_OFFSET UNITYSDK_OFFSET(0x10871E10)
#define CLASS_1_CD06BB4AEFF829C1_METHOD_1_CA4DD35AA559AD98_OFFSET UNITYSDK_OFFSET(0x10870D70)
#define CLASS_1_CD06BB4AEFF829C1_METHOD_1_D437D090E63BE8A7_OFFSET UNITYSDK_OFFSET(0x10871D90)
#define CLASS_1_CD06BB4AEFF829C1_METHOD_1_E5DFAED3D7062967_OFFSET UNITYSDK_OFFSET(0x10871EA0)
#define CLASS_1_CD06BB4AEFF829C1__CTOR_OFFSET UNITYSDK_OFFSET(0x10870C00)
#define CLASS_1_CD06BB4AEFF829C1__SPLITINTOCLUSTERS_B__14_0_OFFSET UNITYSDK_OFFSET(0x108722C0)

inline static constexpr unsigned int Class_1_CD06BB4AEFF829C1_TypeDefinitionIndex = 71400;

class Class_1_CD06BB4AEFF829C1 : public ::System::Object
{
public:
	::System::Collections::Generic::List_1<::Class_1_621BFCA8F4CDD0A1*>* Field_1_8; // 0x10
	::UnityEngine::GameObject* Field_1_9; // 0x18
	::System::Random* Field_1_10; // 0x20
