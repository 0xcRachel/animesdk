...
#define CLASS_2_BFAD27211C574C96_VIEWPREFABPATH_OFFSET UNITYSDK_OFFSET(0xA488650)
#define CLASS_2_BFAD27211C574C96__CTOR_OFFSET UNITYSDK_OFFSET(0xA488600)
#define CLASS_2_BFAD27211C574C96___IFIXBASEPROXY_VIEWPREFABPATH_OFFSET UNITYSDK_OFFSET(0xA4886C0)

inline static constexpr unsigned int Class_2_BFAD27211C574C96_TypeDefinitionIndex = 66094;
