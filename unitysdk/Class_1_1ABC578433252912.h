...
#define CLASS_1_1ABC578433252912_METHOD_1_0C7CBCE710B3F112_OFFSET UNITYSDK_OFFSET(0x166F4BB0)
#define CLASS_1_1ABC578433252912_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x166F49D0)
#define CLASS_1_1ABC578433252912_METHOD_1_5FDC2C050B7D05C7_OFFSET UNITYSDK_OFFSET(0x166F4C00)
#define CLASS_1_1ABC578433252912_METHOD_1_6B72D4EE8C6E907F_OFFSET UNITYSDK_OFFSET(0x166F43E0)
#define CLASS_1_1ABC578433252912_METHOD_1_76FA60E978B1A98A_OFFSET UNITYSDK_OFFSET(0x166F4690)
#define CLASS_1_1ABC578433252912_METHOD_1_A6D7608AD56CBD08_OFFSET UNITYSDK_OFFSET(0x166F4360)
#define CLASS_1_1ABC578433252912_METHOD_1_AD31DD9682084C83_OFFSET UNITYSDK_OFFSET(0x166F4A70)
#define CLASS_1_1ABC578433252912_METHOD_1_CE34EA208837238D_OFFSET UNITYSDK_OFFSET(0x166F4630)
#define CLASS_1_1ABC578433252912_METHOD_1_DD4F05F95AA73EA9_OFFSET UNITYSDK_OFFSET(0x166F4810)
#define CLASS_1_1ABC578433252912_METHOD_1_F0E307B84478A272_OFFSET UNITYSDK_OFFSET(0x166F4990)
#define CLASS_1_1ABC578433252912_METHOD_1_F2E1599CBB58B20F_OFFSET UNITYSDK_OFFSET(0x166F4B10)
#define CLASS_1_1ABC578433252912__CCTOR_OFFSET UNITYSDK_OFFSET(0x166F4F10)

inline static constexpr unsigned int Class_1_1ABC578433252912_TypeDefinitionIndex = 10257;
...
public:
	...
	{
		return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_1ABC578433252912_TypeDefinitionIndex)->GetStaticField(0x18B20);
	}
	static ::System::Action_1<::Class_1_7A22A3DBEEDD1F80*>** StaticGet_Field_1_3()
	{
		return (::System::Action_1<::Class_1_7A22A3DBEEDD1F80*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_1ABC578433252912_TypeDefinitionIndex)->GetStaticField(0x18B28);
	}
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::RPG::GameCore::CommonIndexKey, ::RPG::GameCore::AetherDivideActivityQuestRow*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_1ABC578433252912_TypeDefinitionIndex)->GetStaticField(0x18B30);
	}
	static ::System::Byte* StaticGet_Field_1_2()
	{
		return (::System::Byte*)Il2CppClass::FromTypeDefinitionIndex(Class_1_1ABC578433252912_TypeDefinitionIndex)->GetStaticField(0x5D80);
	}
	static ::System::Boolean* StaticGet_Field_1_1()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_1_1ABC578433252912_TypeDefinitionIndex)->GetStaticField(0x5D81);
	}
