...
#define SIMPLYGON_SPCHARTAGGREGATORSETTINGS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17B67620)
#define SIMPLYGON_SPCHARTAGGREGATORSETTINGS_SETCHARTAGGREGATORMODE_OFFSET UNITYSDK_OFFSET(0x17B67930)
#define SIMPLYGON_SPCHARTAGGREGATORSETTINGS_SETSEPARATEOVERLAPPINGCHARTS_OFFSET UNITYSDK_OFFSET(0x17B67B30)
#define SIMPLYGON_SPCHARTAGGREGATORSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x17B67350)

namespace Simplygon
{
	inline static constexpr unsigned int spChartAggregatorSettings_TypeDefinitionIndex = 28703;
