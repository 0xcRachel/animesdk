...
#define SIMPLYGON_SPCHARTAGGREGATORSETTINGS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1837FA50)
#define SIMPLYGON_SPCHARTAGGREGATORSETTINGS_SETCHARTAGGREGATORMODE_OFFSET UNITYSDK_OFFSET(0x1837FD60)
#define SIMPLYGON_SPCHARTAGGREGATORSETTINGS_SETSEPARATEOVERLAPPINGCHARTS_OFFSET UNITYSDK_OFFSET(0x1837FF60)
#define SIMPLYGON_SPCHARTAGGREGATORSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1837F780)
