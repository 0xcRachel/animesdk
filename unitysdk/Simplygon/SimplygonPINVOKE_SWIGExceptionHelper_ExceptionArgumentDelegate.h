...
#define SIMPLYGON_SIMPLYGONPINVOKE_SWIGEXCEPTIONHELPER_EXCEPTIONARGUMENTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17B65F80)
#define SIMPLYGON_SIMPLYGONPINVOKE_SWIGEXCEPTIONHELPER_EXCEPTIONARGUMENTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17B65FC0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SWIGEXCEPTIONHELPER_EXCEPTIONARGUMENTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x17B65760)
#define SIMPLYGON_SIMPLYGONPINVOKE_SWIGEXCEPTIONHELPER_EXCEPTIONARGUMENTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17B65740)

namespace Simplygon
{
	inline static constexpr unsigned int SimplygonPINVOKE_SWIGExceptionHelper_ExceptionArgumentDelegate_TypeDefinitionIndex = 28709;
