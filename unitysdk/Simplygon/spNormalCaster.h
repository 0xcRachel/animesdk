...
#define SIMPLYGON_SPNORMALCASTER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18385100)
#define SIMPLYGON_SPNORMALCASTER_GETNORMALCASTERSETTINGS_OFFSET UNITYSDK_OFFSET(0x18385F20)
#define SIMPLYGON_SPNORMALCASTER_GETOUTPUTFILEPATH_OFFSET UNITYSDK_OFFSET(0x18385AD0)
#define SIMPLYGON_SPNORMALCASTER_RUNPROCESSING_OFFSET UNITYSDK_OFFSET(0x18385D20)
#define SIMPLYGON_SPNORMALCASTER_SETMAPPINGIMAGE_OFFSET UNITYSDK_OFFSET(0x183856B0)
#define SIMPLYGON_SPNORMALCASTER_SETOUTPUTFILEPATH_OFFSET UNITYSDK_OFFSET(0x183858C0)
#define SIMPLYGON_SPNORMALCASTER_SETSOURCEMATERIALS_OFFSET UNITYSDK_OFFSET(0x183854A0)
#define SIMPLYGON_SPNORMALCASTER_SETSOURCETEXTURES_OFFSET UNITYSDK_OFFSET(0x18385290)
#define SIMPLYGON_SPNORMALCASTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18373E20)
