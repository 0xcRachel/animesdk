...
#define SIMPLYGON_SPNORMALCASTER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17B6CCD0)
#define SIMPLYGON_SPNORMALCASTER_GETNORMALCASTERSETTINGS_OFFSET UNITYSDK_OFFSET(0x17B6DAF0)
#define SIMPLYGON_SPNORMALCASTER_GETOUTPUTFILEPATH_OFFSET UNITYSDK_OFFSET(0x17B6D6A0)
#define SIMPLYGON_SPNORMALCASTER_RUNPROCESSING_OFFSET UNITYSDK_OFFSET(0x17B6D8F0)
#define SIMPLYGON_SPNORMALCASTER_SETMAPPINGIMAGE_OFFSET UNITYSDK_OFFSET(0x17B6D280)
#define SIMPLYGON_SPNORMALCASTER_SETOUTPUTFILEPATH_OFFSET UNITYSDK_OFFSET(0x17B6D490)
#define SIMPLYGON_SPNORMALCASTER_SETSOURCEMATERIALS_OFFSET UNITYSDK_OFFSET(0x17B6D070)
#define SIMPLYGON_SPNORMALCASTER_SETSOURCETEXTURES_OFFSET UNITYSDK_OFFSET(0x17B6CE60)
#define SIMPLYGON_SPNORMALCASTER__CTOR_OFFSET UNITYSDK_OFFSET(0x17B5B380)

namespace Simplygon
{
	inline static constexpr unsigned int spNormalCaster_TypeDefinitionIndex = 28686;
