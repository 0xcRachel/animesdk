...
#define SIMPLYGON_SPPROCESSINGOBJECT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18384530)
#define SIMPLYGON_SPPROCESSINGOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x18384430)
