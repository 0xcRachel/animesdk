...
#define SIMPLYGON_SPREDUCTIONPROCESSOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18387910)
#define SIMPLYGON_SPREDUCTIONPROCESSOR_GETREDUCTIONSETTINGS_OFFSET UNITYSDK_OFFSET(0x18387EB0)
#define SIMPLYGON_SPREDUCTIONPROCESSOR_RUNPROCESSING_OFFSET UNITYSDK_OFFSET(0x18387AA0)
#define SIMPLYGON_SPREDUCTIONPROCESSOR_SETSCENE_OFFSET UNITYSDK_OFFSET(0x18387CA0)
#define SIMPLYGON_SPREDUCTIONPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x183741E0)
