...
#define SIMPLYGON_SIMPLYGONPINVOKE_SWIGSTRINGHELPER_SWIGSTRINGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17B67070)
#define SIMPLYGON_SIMPLYGONPINVOKE_SWIGSTRINGHELPER_SWIGSTRINGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17B670A0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SWIGSTRINGHELPER_SWIGSTRINGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x17B66930)
#define SIMPLYGON_SIMPLYGONPINVOKE_SWIGSTRINGHELPER_SWIGSTRINGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17B66910)

namespace Simplygon
{
	inline static constexpr unsigned int SimplygonPINVOKE_SWIGStringHelper_SWIGStringDelegate_TypeDefinitionIndex = 28712;
