...
#define SIMPLYGON_SIMPLYGONPINVOKE_SWIGSTRINGHELPER_SWIGSTRINGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1837F4A0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SWIGSTRINGHELPER_SWIGSTRINGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1837F4D0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SWIGSTRINGHELPER_SWIGSTRINGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1837EF40)
#define SIMPLYGON_SIMPLYGONPINVOKE_SWIGSTRINGHELPER_SWIGSTRINGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1837EF20)
