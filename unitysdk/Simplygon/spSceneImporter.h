...
#define SIMPLYGON_SPSCENEIMPORTER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17B72580)
#define SIMPLYGON_SPSCENEIMPORTER_GETSCENE_OFFSET UNITYSDK_OFFSET(0x17B72910)
#define SIMPLYGON_SPSCENEIMPORTER_RUN_OFFSET UNITYSDK_OFFSET(0x17B72C30)
#define SIMPLYGON_SPSCENEIMPORTER_SETIMPORTFILEPATH_OFFSET UNITYSDK_OFFSET(0x17B72700)
#define SIMPLYGON_SPSCENEIMPORTER__CTOR_OFFSET UNITYSDK_OFFSET(0x17B5C5E0)

namespace Simplygon
{
	inline static constexpr unsigned int spSceneImporter_TypeDefinitionIndex = 28696;
