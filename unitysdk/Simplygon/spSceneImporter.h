...
#define SIMPLYGON_SPSCENEIMPORTER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1838A9B0)
#define SIMPLYGON_SPSCENEIMPORTER_GETSCENE_OFFSET UNITYSDK_OFFSET(0x1838AD40)
#define SIMPLYGON_SPSCENEIMPORTER_RUN_OFFSET UNITYSDK_OFFSET(0x1838B060)
#define SIMPLYGON_SPSCENEIMPORTER_SETIMPORTFILEPATH_OFFSET UNITYSDK_OFFSET(0x1838AB30)
#define SIMPLYGON_SPSCENEIMPORTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18375080)
