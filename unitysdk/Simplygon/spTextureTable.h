...
#define SIMPLYGON_SPTEXTURETABLE_ADDTEXTURE_OFFSET UNITYSDK_OFFSET(0x1838CCF0)
#define SIMPLYGON_SPTEXTURETABLE_CLEAR_OFFSET UNITYSDK_OFFSET(0x1838C8F0)
#define SIMPLYGON_SPTEXTURETABLE_COPY_OFFSET UNITYSDK_OFFSET(0x1838CAE0)
#define SIMPLYGON_SPTEXTURETABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1838C760)
#define SIMPLYGON_SPTEXTURETABLE_GETCPTR_OFFSET UNITYSDK_OFFSET(0x18380860)
#define SIMPLYGON_SPTEXTURETABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x183758E0)
