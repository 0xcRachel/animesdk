...
#define SIMPLYGON_SPPIPELINE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17B6EA30)
#define SIMPLYGON_SPPIPELINE_RUNSCENEFROMFILE_OFFSET UNITYSDK_OFFSET(0x17B6EBB0)
#define SIMPLYGON_SPPIPELINE_RUNSCENE_OFFSET UNITYSDK_OFFSET(0x17B6EDF0)
#define SIMPLYGON_SPPIPELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x17B6E930)

namespace Simplygon
{
	inline static constexpr unsigned int spPipeline_TypeDefinitionIndex = 28701;
