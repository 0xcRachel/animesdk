...
#define SIMPLYGON_SPPIPELINE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18386E60)
#define SIMPLYGON_SPPIPELINE_RUNSCENEFROMFILE_OFFSET UNITYSDK_OFFSET(0x18386FE0)
#define SIMPLYGON_SPPIPELINE_RUNSCENE_OFFSET UNITYSDK_OFFSET(0x18387220)
#define SIMPLYGON_SPPIPELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x18386D60)
