...
#define SIMPLYGON_SPCOLORCASTERSETTINGS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18381930)
#define SIMPLYGON_SPCOLORCASTERSETTINGS_SETMATERIALCHANNEL_OFFSET UNITYSDK_OFFSET(0x18381C50)
#define SIMPLYGON_SPCOLORCASTERSETTINGS_SETOUTPUTIMAGEFILEFORMAT_OFFSET UNITYSDK_OFFSET(0x18381E60)
#define SIMPLYGON_SPCOLORCASTERSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x18381660)
