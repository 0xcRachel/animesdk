...
#define SIMPLYGON_SPCOLORCASTERSETTINGS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17B69500)
#define SIMPLYGON_SPCOLORCASTERSETTINGS_SETMATERIALCHANNEL_OFFSET UNITYSDK_OFFSET(0x17B69820)
#define SIMPLYGON_SPCOLORCASTERSETTINGS_SETOUTPUTIMAGEFILEFORMAT_OFFSET UNITYSDK_OFFSET(0x17B69A30)
#define SIMPLYGON_SPCOLORCASTERSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x17B69230)

namespace Simplygon
{
	inline static constexpr unsigned int spColorCasterSettings_TypeDefinitionIndex = 28685;
