...
#define SIMPLYGON_SPNORMALCASTERSETTINGS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17B6DF10)
#define SIMPLYGON_SPNORMALCASTERSETTINGS_SETGENERATETANGENTSPACENORMALS_OFFSET UNITYSDK_OFFSET(0x17B6E4B0)
#define SIMPLYGON_SPNORMALCASTERSETTINGS_SETMATERIALCHANNEL_OFFSET UNITYSDK_OFFSET(0x17B6E0A0)
#define SIMPLYGON_SPNORMALCASTERSETTINGS_SETOUTPUTIMAGEFILEFORMAT_OFFSET UNITYSDK_OFFSET(0x17B6E2B0)
#define SIMPLYGON_SPNORMALCASTERSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x17B6DE10)

namespace Simplygon
{
	inline static constexpr unsigned int spNormalCasterSettings_TypeDefinitionIndex = 28687;
