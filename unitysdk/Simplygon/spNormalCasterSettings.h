...
#define SIMPLYGON_SPNORMALCASTERSETTINGS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18386340)
#define SIMPLYGON_SPNORMALCASTERSETTINGS_SETGENERATETANGENTSPACENORMALS_OFFSET UNITYSDK_OFFSET(0x183868E0)
#define SIMPLYGON_SPNORMALCASTERSETTINGS_SETMATERIALCHANNEL_OFFSET UNITYSDK_OFFSET(0x183864D0)
#define SIMPLYGON_SPNORMALCASTERSETTINGS_SETOUTPUTIMAGEFILEFORMAT_OFFSET UNITYSDK_OFFSET(0x183866E0)
#define SIMPLYGON_SPNORMALCASTERSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x18386240)
