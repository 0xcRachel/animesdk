...
#define SIMPLYGON_SPMATERIALCASTERSETTINGS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18381AC0)
#define SIMPLYGON_SPMATERIALCASTERSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x18381760)
