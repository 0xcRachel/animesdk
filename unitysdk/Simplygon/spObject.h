...
#define SIMPLYGON_SPOBJECT_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1837F770)
#define SIMPLYGON_SPOBJECT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18372760)
#define SIMPLYGON_SPOBJECT_FINALIZE_OFFSET UNITYSDK_OFFSET(0x18386AE0)
#define SIMPLYGON_SPOBJECT_SETNAME_OFFSET UNITYSDK_OFFSET(0x18386B50)
#define SIMPLYGON_SPOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1837F5E0)
