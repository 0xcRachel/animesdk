...
#define SIMPLYGON_SPOBJECT_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x17B67340)
#define SIMPLYGON_SPOBJECT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17B59CC0)
#define SIMPLYGON_SPOBJECT_FINALIZE_OFFSET UNITYSDK_OFFSET(0x17B6E6B0)
#define SIMPLYGON_SPOBJECT_SETNAME_OFFSET UNITYSDK_OFFSET(0x17B6E720)
#define SIMPLYGON_SPOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x17B671B0)

namespace Simplygon
{
	inline static constexpr unsigned int spObject_TypeDefinitionIndex = 28673;
