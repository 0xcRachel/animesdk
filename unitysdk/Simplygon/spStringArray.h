...
#define SIMPLYGON_SPSTRINGARRAY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1838BC50)
#define SIMPLYGON_SPSTRINGARRAY_GETCPTR_OFFSET UNITYSDK_OFFSET(0x18377250)
#define SIMPLYGON_SPSTRINGARRAY_GETITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x1838BF70)
#define SIMPLYGON_SPSTRINGARRAY_GETITEM_OFFSET UNITYSDK_OFFSET(0x1838C170)
#define SIMPLYGON_SPSTRINGARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x18376780)
