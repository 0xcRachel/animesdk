...
#define SIMPLYGON_SIMPLYGONPINVOKE_DEINITIALIZESIMPLYGON_OFFSET UNITYSDK_OFFSET(0x183782F0)
#define SIMPLYGON_SIMPLYGONPINVOKE_DELETE_SPARRAY_OFFSET UNITYSDK_OFFSET(0x18378860)
#define SIMPLYGON_SIMPLYGONPINVOKE_DELETE_SPCHARTAGGREGATORSETTINGS_OFFSET UNITYSDK_OFFSET(0x1837BA70)
#define SIMPLYGON_SIMPLYGONPINVOKE_DELETE_SPCOLORCASTERSETTINGS_OFFSET UNITYSDK_OFFSET(0x18379600)
#define SIMPLYGON_SIMPLYGONPINVOKE_DELETE_SPCOLORCASTER_OFFSET UNITYSDK_OFFSET(0x18379460)
#define SIMPLYGON_SIMPLYGONPINVOKE_DELETE_SPMAPPINGIMAGEOUTPUTMATERIALSETTINGS_OFFSET UNITYSDK_OFFSET(0x1837A490)
#define SIMPLYGON_SIMPLYGONPINVOKE_DELETE_SPMAPPINGIMAGESETTINGS_OFFSET UNITYSDK_OFFSET(0x1837A310)
#define SIMPLYGON_SIMPLYGONPINVOKE_DELETE_SPMAPPINGIMAGE_OFFSET UNITYSDK_OFFSET(0x18378DD0)
#define SIMPLYGON_SIMPLYGONPINVOKE_DELETE_SPMATERIALCASTERSETTINGS_OFFSET UNITYSDK_OFFSET(0x18378FD0)
#define SIMPLYGON_SIMPLYGONPINVOKE_DELETE_SPMATERIALCASTER_OFFSET UNITYSDK_OFFSET(0x18378F50)
#define SIMPLYGON_SIMPLYGONPINVOKE_DELETE_SPMATERIALTABLE_OFFSET UNITYSDK_OFFSET(0x18378D50)
#define SIMPLYGON_SIMPLYGONPINVOKE_DELETE_SPMATERIAL_OFFSET UNITYSDK_OFFSET(0x18378B30)
#define SIMPLYGON_SIMPLYGONPINVOKE_DELETE_SPNORMALCASTERSETTINGS_OFFSET UNITYSDK_OFFSET(0x18379CB0)
#define SIMPLYGON_SIMPLYGONPINVOKE_DELETE_SPNORMALCASTER_OFFSET UNITYSDK_OFFSET(0x18379A90)
#define SIMPLYGON_SIMPLYGONPINVOKE_DELETE_SPPIPELINESERIALIZER_OFFSET UNITYSDK_OFFSET(0x1837B8F0)
#define SIMPLYGON_SIMPLYGONPINVOKE_DELETE_SPPIPELINE_OFFSET UNITYSDK_OFFSET(0x1837B7C0)
#define SIMPLYGON_SIMPLYGONPINVOKE_DELETE_SPPROCESSINGOBJECT_OFFSET UNITYSDK_OFFSET(0x18378E50)
#define SIMPLYGON_SIMPLYGONPINVOKE_DELETE_SPREDUCTIONPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1837A6A0)
#define SIMPLYGON_SIMPLYGONPINVOKE_DELETE_SPREDUCTIONSETTINGS_OFFSET UNITYSDK_OFFSET(0x18379E80)
#define SIMPLYGON_SIMPLYGONPINVOKE_DELETE_SPREMESHINGPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1837AAB0)
#define SIMPLYGON_SIMPLYGONPINVOKE_DELETE_SPREMESHINGSETTINGS_OFFSET UNITYSDK_OFFSET(0x1837A7A0)
#define SIMPLYGON_SIMPLYGONPINVOKE_DELETE_SPSCENEEXPORTER_OFFSET UNITYSDK_OFFSET(0x1837AE60)
#define SIMPLYGON_SIMPLYGONPINVOKE_DELETE_SPSCENEIMPORTER_OFFSET UNITYSDK_OFFSET(0x1837B080)
#define SIMPLYGON_SIMPLYGONPINVOKE_DELETE_SPSCENE_OFFSET UNITYSDK_OFFSET(0x1837AC30)
#define SIMPLYGON_SIMPLYGONPINVOKE_DELETE_SPSETTINGSOBJECT_OFFSET UNITYSDK_OFFSET(0x18378ED0)
#define SIMPLYGON_SIMPLYGONPINVOKE_DELETE_SPSHADINGNODE_OFFSET UNITYSDK_OFFSET(0x1837B440)
#define SIMPLYGON_SIMPLYGONPINVOKE_DELETE_SPSHADINGTEXTURENODE_OFFSET UNITYSDK_OFFSET(0x1837B5E0)
#define SIMPLYGON_SIMPLYGONPINVOKE_DELETE_SPSTRINGARRAY_OFFSET UNITYSDK_OFFSET(0x1837BC20)
#define SIMPLYGON_SIMPLYGONPINVOKE_DELETE_SPTABLE_OFFSET UNITYSDK_OFFSET(0x18378960)
#define SIMPLYGON_SIMPLYGONPINVOKE_DELETE_SPTEXTURETABLE_OFFSET UNITYSDK_OFFSET(0x1837B3C0)
#define SIMPLYGON_SIMPLYGONPINVOKE_DELETE_SPTEXTURE_OFFSET UNITYSDK_OFFSET(0x1837B1A0)
#define SIMPLYGON_SIMPLYGONPINVOKE_DELETE_SPVALUEARRAY_OFFSET UNITYSDK_OFFSET(0x183788E0)
#define SIMPLYGON_SIMPLYGONPINVOKE_FAILED_OFFSET UNITYSDK_OFFSET(0x18377C70)
#define SIMPLYGON_SIMPLYGONPINVOKE_GETLASTINITIALIZATIONERROR_OFFSET UNITYSDK_OFFSET(0x18378560)
#define SIMPLYGON_SIMPLYGONPINVOKE_INITIALIZESIMPLYGON__SWIG_0_OFFSET UNITYSDK_OFFSET(0x18377F50)
#define SIMPLYGON_SIMPLYGONPINVOKE_INITIALIZESIMPLYGON__SWIG_1_OFFSET UNITYSDK_OFFSET(0x18378250)
#define SIMPLYGON_SIMPLYGONPINVOKE_ISIMPLYGON_CLEARERRORMESSAGES_OFFSET UNITYSDK_OFFSET(0x18377A00)
#define SIMPLYGON_SIMPLYGONPINVOKE_ISIMPLYGON_CLEARWARNINGMESSAGES_OFFSET UNITYSDK_OFFSET(0x18377790)
#define SIMPLYGON_SIMPLYGONPINVOKE_ISIMPLYGON_CREATECOLORCASTER_OFFSET UNITYSDK_OFFSET(0x18373900)
#define SIMPLYGON_SIMPLYGONPINVOKE_ISIMPLYGON_CREATEMATERIALTABLE_OFFSET UNITYSDK_OFFSET(0x18373390)
#define SIMPLYGON_SIMPLYGONPINVOKE_ISIMPLYGON_CREATEMATERIAL_OFFSET UNITYSDK_OFFSET(0x18372CD0)
#define SIMPLYGON_SIMPLYGONPINVOKE_ISIMPLYGON_CREATENORMALCASTER_OFFSET UNITYSDK_OFFSET(0x18373DA0)
#define SIMPLYGON_SIMPLYGONPINVOKE_ISIMPLYGON_CREATEPIPELINESERIALIZER_OFFSET UNITYSDK_OFFSET(0x18376260)
#define SIMPLYGON_SIMPLYGONPINVOKE_ISIMPLYGON_CREATEREDUCTIONPROCESSOR_OFFSET UNITYSDK_OFFSET(0x18374160)
#define SIMPLYGON_SIMPLYGONPINVOKE_ISIMPLYGON_CREATEREMESHINGPROCESSOR_OFFSET UNITYSDK_OFFSET(0x183745F0)
#define SIMPLYGON_SIMPLYGONPINVOKE_ISIMPLYGON_CREATESCENEEXPORTER_OFFSET UNITYSDK_OFFSET(0x18374B60)
#define SIMPLYGON_SIMPLYGONPINVOKE_ISIMPLYGON_CREATESCENEIMPORTER_OFFSET UNITYSDK_OFFSET(0x18375000)
#define SIMPLYGON_SIMPLYGONPINVOKE_ISIMPLYGON_CREATESHADINGTEXTURENODE_OFFSET UNITYSDK_OFFSET(0x18375CF0)
#define SIMPLYGON_SIMPLYGONPINVOKE_ISIMPLYGON_CREATESTRINGARRAY_OFFSET UNITYSDK_OFFSET(0x18376700)
#define SIMPLYGON_SIMPLYGONPINVOKE_ISIMPLYGON_CREATETEXTURETABLE_OFFSET UNITYSDK_OFFSET(0x18375860)
#define SIMPLYGON_SIMPLYGONPINVOKE_ISIMPLYGON_CREATETEXTURE_OFFSET UNITYSDK_OFFSET(0x183754A0)
#define SIMPLYGON_SIMPLYGONPINVOKE_ISIMPLYGON_ERROROCCURRED_OFFSET UNITYSDK_OFFSET(0x18376FC0)
#define SIMPLYGON_SIMPLYGONPINVOKE_ISIMPLYGON_GETERRORMESSAGES_OFFSET UNITYSDK_OFFSET(0x18377510)
#define SIMPLYGON_SIMPLYGONPINVOKE_ISIMPLYGON_GETWARNINGMESSAGES_OFFSET UNITYSDK_OFFSET(0x18377270)
#define SIMPLYGON_SIMPLYGONPINVOKE_ISIMPLYGON_SENDTELEMETRY_OFFSET UNITYSDK_OFFSET(0x18376A30)
#define SIMPLYGON_SIMPLYGONPINVOKE_ISIMPLYGON_WARNINGOCCURRED_OFFSET UNITYSDK_OFFSET(0x18376D40)
#define SIMPLYGON_SIMPLYGONPINVOKE_SIMPLYGON_VERSION_GET_OFFSET UNITYSDK_OFFSET(0x183786C0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPARRAY_SWIGUPCAST_OFFSET UNITYSDK_OFFSET(0x1837BCA0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPCHARTAGGREGATORSETTINGS_SETCHARTAGGREGATORMODE_OFFSET UNITYSDK_OFFSET(0x1837B970)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPCHARTAGGREGATORSETTINGS_SETSEPARATEOVERLAPPINGCHARTS_OFFSET UNITYSDK_OFFSET(0x1837B9F0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPCHARTAGGREGATORSETTINGS_SWIGUPCAST_OFFSET UNITYSDK_OFFSET(0x1837CB20)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPCOLORCASTERSETTINGS_SETMATERIALCHANNEL_OFFSET UNITYSDK_OFFSET(0x183794E0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPCOLORCASTERSETTINGS_SETOUTPUTIMAGEFILEFORMAT_OFFSET UNITYSDK_OFFSET(0x18379580)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPCOLORCASTERSETTINGS_SWIGUPCAST_OFFSET UNITYSDK_OFFSET(0x1837C220)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPCOLORCASTER_GETCOLORCASTERSETTINGS_OFFSET UNITYSDK_OFFSET(0x183793E0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPCOLORCASTER_GETOUTPUTFILEPATH_OFFSET UNITYSDK_OFFSET(0x183792A0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPCOLORCASTER_RUNPROCESSING_OFFSET UNITYSDK_OFFSET(0x18379360)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPCOLORCASTER_SETMAPPINGIMAGE_OFFSET UNITYSDK_OFFSET(0x18379170)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPCOLORCASTER_SETOUTPUTFILEPATH_OFFSET UNITYSDK_OFFSET(0x18379200)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPCOLORCASTER_SETSOURCEMATERIALS_OFFSET UNITYSDK_OFFSET(0x183790E0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPCOLORCASTER_SETSOURCETEXTURES_OFFSET UNITYSDK_OFFSET(0x18379050)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPCOLORCASTER_SWIGUPCAST_OFFSET UNITYSDK_OFFSET(0x1837C1A0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPMAPPINGIMAGEOUTPUTMATERIALSETTINGS_SETTEXTUREHEIGHT_OFFSET UNITYSDK_OFFSET(0x1837A410)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPMAPPINGIMAGEOUTPUTMATERIALSETTINGS_SETTEXTUREWIDTH_OFFSET UNITYSDK_OFFSET(0x1837A390)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPMAPPINGIMAGEOUTPUTMATERIALSETTINGS_SWIGUPCAST_OFFSET UNITYSDK_OFFSET(0x1837C4A0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPMAPPINGIMAGESETTINGS_GETCHARTAGGREGATORSETTINGS_OFFSET UNITYSDK_OFFSET(0x1837A290)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPMAPPINGIMAGESETTINGS_GETOUTPUTMATERIALSETTINGS_OFFSET UNITYSDK_OFFSET(0x18379F00)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPMAPPINGIMAGESETTINGS_SETAPPLYNEWMATERIALIDS_OFFSET UNITYSDK_OFFSET(0x1837A190)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPMAPPINGIMAGESETTINGS_SETGENERATEMAPPINGIMAGE_OFFSET UNITYSDK_OFFSET(0x18379F90)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPMAPPINGIMAGESETTINGS_SETGENERATETANGENTS_OFFSET UNITYSDK_OFFSET(0x1837A090)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPMAPPINGIMAGESETTINGS_SETGENERATETEXCOORDS_OFFSET UNITYSDK_OFFSET(0x1837A010)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPMAPPINGIMAGESETTINGS_SETTEXCOORDGENERATORTYPE_OFFSET UNITYSDK_OFFSET(0x1837A210)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPMAPPINGIMAGESETTINGS_SETUSEFULLRETEXTURING_OFFSET UNITYSDK_OFFSET(0x1837A110)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPMAPPINGIMAGESETTINGS_SWIGUPCAST_OFFSET UNITYSDK_OFFSET(0x1837C420)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPMAPPINGIMAGE_SWIGUPCAST_OFFSET UNITYSDK_OFFSET(0x1837BF20)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPMATERIALCASTERSETTINGS_SWIGUPCAST_OFFSET UNITYSDK_OFFSET(0x1837C120)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPMATERIALCASTER_SWIGUPCAST_OFFSET UNITYSDK_OFFSET(0x1837C0A0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPMATERIALTABLE_ADDMATERIAL_OFFSET UNITYSDK_OFFSET(0x18378CC0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPMATERIALTABLE_CLEAR_OFFSET UNITYSDK_OFFSET(0x18378BB0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPMATERIALTABLE_COPY_OFFSET UNITYSDK_OFFSET(0x18378C30)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPMATERIALTABLE_SWIGUPCAST_OFFSET UNITYSDK_OFFSET(0x1837BEA0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPMATERIAL_ADDMATERIALCHANNEL_OFFSET UNITYSDK_OFFSET(0x183789E0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPMATERIAL_SETSHADINGNETWORK_OFFSET UNITYSDK_OFFSET(0x18378A80)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPMATERIAL_SWIGUPCAST_OFFSET UNITYSDK_OFFSET(0x1837BE20)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPNORMALCASTERSETTINGS_SETGENERATETANGENTSPACENORMALS_OFFSET UNITYSDK_OFFSET(0x18379C30)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPNORMALCASTERSETTINGS_SETMATERIALCHANNEL_OFFSET UNITYSDK_OFFSET(0x18379B10)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPNORMALCASTERSETTINGS_SETOUTPUTIMAGEFILEFORMAT_OFFSET UNITYSDK_OFFSET(0x18379BB0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPNORMALCASTERSETTINGS_SWIGUPCAST_OFFSET UNITYSDK_OFFSET(0x1837C320)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPNORMALCASTER_GETNORMALCASTERSETTINGS_OFFSET UNITYSDK_OFFSET(0x18379A10)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPNORMALCASTER_GETOUTPUTFILEPATH_OFFSET UNITYSDK_OFFSET(0x183798D0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPNORMALCASTER_RUNPROCESSING_OFFSET UNITYSDK_OFFSET(0x18379990)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPNORMALCASTER_SETMAPPINGIMAGE_OFFSET UNITYSDK_OFFSET(0x183797A0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPNORMALCASTER_SETOUTPUTFILEPATH_OFFSET UNITYSDK_OFFSET(0x18379830)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPNORMALCASTER_SETSOURCEMATERIALS_OFFSET UNITYSDK_OFFSET(0x18379710)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPNORMALCASTER_SETSOURCETEXTURES_OFFSET UNITYSDK_OFFSET(0x18379680)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPNORMALCASTER_SWIGUPCAST_OFFSET UNITYSDK_OFFSET(0x1837C2A0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPOBJECT_SETNAME_OFFSET UNITYSDK_OFFSET(0x183787C0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPPIPELINESERIALIZER_LOADPIPELINEFROMFILE_OFFSET UNITYSDK_OFFSET(0x1837B840)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPPIPELINESERIALIZER_SWIGUPCAST_OFFSET UNITYSDK_OFFSET(0x1837CAA0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPPIPELINE_RUNSCENEFROMFILE_OFFSET UNITYSDK_OFFSET(0x1837B660)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPPIPELINE_RUNSCENE_OFFSET UNITYSDK_OFFSET(0x1837B730)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPPIPELINE_SWIGUPCAST_OFFSET UNITYSDK_OFFSET(0x1837CA20)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPPROCESSINGOBJECT_SWIGUPCAST_OFFSET UNITYSDK_OFFSET(0x1837BFA0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPREDUCTIONPROCESSOR_GETREDUCTIONSETTINGS_OFFSET UNITYSDK_OFFSET(0x1837A620)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPREDUCTIONPROCESSOR_RUNPROCESSING_OFFSET UNITYSDK_OFFSET(0x1837A510)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPREDUCTIONPROCESSOR_SETSCENE_OFFSET UNITYSDK_OFFSET(0x1837A590)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPREDUCTIONPROCESSOR_SWIGUPCAST_OFFSET UNITYSDK_OFFSET(0x1837C520)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPREDUCTIONSETTINGS_SETREDUCTIONTARGETS_OFFSET UNITYSDK_OFFSET(0x18379D30)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPREDUCTIONSETTINGS_SETREDUCTIONTARGETTRIANGLERATIO_OFFSET UNITYSDK_OFFSET(0x18379DF0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPREDUCTIONSETTINGS_SWIGUPCAST_OFFSET UNITYSDK_OFFSET(0x1837C3A0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPREMESHINGPROCESSOR_GETMAPPINGIMAGESETTINGS_OFFSET UNITYSDK_OFFSET(0x1837AA30)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPREMESHINGPROCESSOR_GETMAPPINGIMAGE_OFFSET UNITYSDK_OFFSET(0x1837A930)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPREMESHINGPROCESSOR_GETREMESHINGSETTINGS_OFFSET UNITYSDK_OFFSET(0x1837A9B0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPREMESHINGPROCESSOR_RUNPROCESSING_OFFSET UNITYSDK_OFFSET(0x1837A820)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPREMESHINGPROCESSOR_SETSCENE_OFFSET UNITYSDK_OFFSET(0x1837A8A0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPREMESHINGPROCESSOR_SWIGUPCAST_OFFSET UNITYSDK_OFFSET(0x1837C620)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPREMESHINGSETTINGS_SETONSCREENSIZE_OFFSET UNITYSDK_OFFSET(0x1837A720)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPREMESHINGSETTINGS_SWIGUPCAST_OFFSET UNITYSDK_OFFSET(0x1837C5A0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPSCENEEXPORTER_RUN_OFFSET UNITYSDK_OFFSET(0x1837ADE0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPSCENEEXPORTER_SETEXPORTFILEPATH_OFFSET UNITYSDK_OFFSET(0x1837ACB0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPSCENEEXPORTER_SETSCENE_OFFSET UNITYSDK_OFFSET(0x1837AD50)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPSCENEEXPORTER_SWIGUPCAST_OFFSET UNITYSDK_OFFSET(0x1837C720)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPSCENEIMPORTER_GETSCENE_OFFSET UNITYSDK_OFFSET(0x1837AF80)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPSCENEIMPORTER_RUN_OFFSET UNITYSDK_OFFSET(0x1837B000)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPSCENEIMPORTER_SETIMPORTFILEPATH_OFFSET UNITYSDK_OFFSET(0x1837AEE0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPSCENEIMPORTER_SWIGUPCAST_OFFSET UNITYSDK_OFFSET(0x1837C7A0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPSCENE_GETMATERIALTABLE_OFFSET UNITYSDK_OFFSET(0x1837AB30)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPSCENE_GETTEXTURETABLE_OFFSET UNITYSDK_OFFSET(0x1837ABB0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPSCENE_SWIGUPCAST_OFFSET UNITYSDK_OFFSET(0x1837C6A0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPSETTINGSOBJECT_SWIGUPCAST_OFFSET UNITYSDK_OFFSET(0x1837C020)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPSHADINGNODE_SWIGUPCAST_OFFSET UNITYSDK_OFFSET(0x1837C920)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPSHADINGTEXTURENODE_SETTEXCOORDLEVEL_OFFSET UNITYSDK_OFFSET(0x1837B560)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPSHADINGTEXTURENODE_SETTEXTURENAME_OFFSET UNITYSDK_OFFSET(0x1837B4C0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPSHADINGTEXTURENODE_SWIGUPCAST_OFFSET UNITYSDK_OFFSET(0x1837C9A0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPSTRINGARRAY_GETITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x1837BAF0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPSTRINGARRAY_GETITEM_OFFSET UNITYSDK_OFFSET(0x1837BB70)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPSTRINGARRAY_SWIGUPCAST_OFFSET UNITYSDK_OFFSET(0x1837CBA0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPTABLE_SWIGUPCAST_OFFSET UNITYSDK_OFFSET(0x1837BDA0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPTEXTURETABLE_ADDTEXTURE_OFFSET UNITYSDK_OFFSET(0x1837B330)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPTEXTURETABLE_CLEAR_OFFSET UNITYSDK_OFFSET(0x1837B220)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPTEXTURETABLE_COPY_OFFSET UNITYSDK_OFFSET(0x1837B2A0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPTEXTURETABLE_SWIGUPCAST_OFFSET UNITYSDK_OFFSET(0x1837C8A0)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPTEXTURE_SETFILEPATH_OFFSET UNITYSDK_OFFSET(0x1837B100)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPTEXTURE_SWIGUPCAST_OFFSET UNITYSDK_OFFSET(0x1837C820)
#define SIMPLYGON_SIMPLYGONPINVOKE_SPVALUEARRAY_SWIGUPCAST_OFFSET UNITYSDK_OFFSET(0x1837BD20)
#define SIMPLYGON_SIMPLYGONPINVOKE__CCTOR_OFFSET UNITYSDK_OFFSET(0x18378740)
...
namespace Simplygon
{
	...
	public:
		...
		{
			return (::Simplygon::SimplygonPINVOKE_SWIGExceptionHelper**)Il2CppClass::FromTypeDefinitionIndex(SimplygonPINVOKE_TypeDefinitionIndex)->GetStaticField(0x2B120);
		}
		static ::Simplygon::SimplygonPINVOKE_SWIGStringHelper** StaticGet_swigStringHelper()
		{
			return (::Simplygon::SimplygonPINVOKE_SWIGStringHelper**)Il2CppClass::FromTypeDefinitionIndex(SimplygonPINVOKE_TypeDefinitionIndex)->GetStaticField(0x2B128);
		}
