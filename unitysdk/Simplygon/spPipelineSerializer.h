...
#define SIMPLYGON_SPPIPELINESERIALIZER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18387460)
#define SIMPLYGON_SPPIPELINESERIALIZER_LOADPIPELINEFROMFILE_OFFSET UNITYSDK_OFFSET(0x183875E0)
#define SIMPLYGON_SPPIPELINESERIALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x183762E0)
