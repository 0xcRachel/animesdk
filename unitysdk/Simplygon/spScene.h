...
#define SIMPLYGON_SPSCENE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18389C10)
#define SIMPLYGON_SPSCENE_GETCPTR_OFFSET UNITYSDK_OFFSET(0x18387440)
#define SIMPLYGON_SPSCENE_GETMATERIALTABLE_OFFSET UNITYSDK_OFFSET(0x18389D90)
#define SIMPLYGON_SPSCENE_GETTEXTURETABLE_OFFSET UNITYSDK_OFFSET(0x18389FD0)
#define SIMPLYGON_SPSCENE__CTOR_OFFSET UNITYSDK_OFFSET(0x18389B10)
