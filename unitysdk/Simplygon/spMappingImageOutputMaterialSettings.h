...
#define SIMPLYGON_SPMAPPINGIMAGEOUTPUTMATERIALSETTINGS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17B6A080)
#define SIMPLYGON_SPMAPPINGIMAGEOUTPUTMATERIALSETTINGS_SETTEXTUREHEIGHT_OFFSET UNITYSDK_OFFSET(0x17B6A410)
#define SIMPLYGON_SPMAPPINGIMAGEOUTPUTMATERIALSETTINGS_SETTEXTUREWIDTH_OFFSET UNITYSDK_OFFSET(0x17B6A210)
#define SIMPLYGON_SPMAPPINGIMAGEOUTPUTMATERIALSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x17B69EB0)

namespace Simplygon
{
	inline static constexpr unsigned int spMappingImageOutputMaterialSettings_TypeDefinitionIndex = 28690;
