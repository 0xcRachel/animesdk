...
#define SIMPLYGON_SPSHADINGTEXTURENODE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17B730B0)
#define SIMPLYGON_SPSHADINGTEXTURENODE_SETTEXCOORDLEVEL_OFFSET UNITYSDK_OFFSET(0x17B73450)
#define SIMPLYGON_SPSHADINGTEXTURENODE_SETTEXTURENAME_OFFSET UNITYSDK_OFFSET(0x17B73240)
#define SIMPLYGON_SPSHADINGTEXTURENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x17B5D2D0)

namespace Simplygon
{
	inline static constexpr unsigned int spShadingTextureNode_TypeDefinitionIndex = 28700;
