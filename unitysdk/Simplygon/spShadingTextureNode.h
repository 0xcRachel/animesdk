...
#define SIMPLYGON_SPSHADINGTEXTURENODE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1838B4E0)
#define SIMPLYGON_SPSHADINGTEXTURENODE_SETTEXCOORDLEVEL_OFFSET UNITYSDK_OFFSET(0x1838B880)
#define SIMPLYGON_SPSHADINGTEXTURENODE_SETTEXTURENAME_OFFSET UNITYSDK_OFFSET(0x1838B670)
#define SIMPLYGON_SPSHADINGTEXTURENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x18375D70)
