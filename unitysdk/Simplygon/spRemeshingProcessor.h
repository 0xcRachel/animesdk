...
#define SIMPLYGON_SPREMESHINGPROCESSOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18388870)
#define SIMPLYGON_SPREMESHINGPROCESSOR_GETMAPPINGIMAGESETTINGS_OFFSET UNITYSDK_OFFSET(0x18389540)
#define SIMPLYGON_SPREMESHINGPROCESSOR_GETMAPPINGIMAGE_OFFSET UNITYSDK_OFFSET(0x18388E10)
#define SIMPLYGON_SPREMESHINGPROCESSOR_GETREMESHINGSETTINGS_OFFSET UNITYSDK_OFFSET(0x18389130)
#define SIMPLYGON_SPREMESHINGPROCESSOR_RUNPROCESSING_OFFSET UNITYSDK_OFFSET(0x18388A00)
#define SIMPLYGON_SPREMESHINGPROCESSOR_SETSCENE_OFFSET UNITYSDK_OFFSET(0x18388C00)
#define SIMPLYGON_SPREMESHINGPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x18374670)
