...
#define SIMPLYGON_SPSCENEEXPORTER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17B71DE0)
#define SIMPLYGON_SPSCENEEXPORTER_RUN_OFFSET UNITYSDK_OFFSET(0x17B72380)
#define SIMPLYGON_SPSCENEEXPORTER_SETEXPORTFILEPATH_OFFSET UNITYSDK_OFFSET(0x17B71F60)
#define SIMPLYGON_SPSCENEEXPORTER_SETSCENE_OFFSET UNITYSDK_OFFSET(0x17B72170)
#define SIMPLYGON_SPSCENEEXPORTER__CTOR_OFFSET UNITYSDK_OFFSET(0x17B5C140)

namespace Simplygon
{
	inline static constexpr unsigned int spSceneExporter_TypeDefinitionIndex = 28695;
