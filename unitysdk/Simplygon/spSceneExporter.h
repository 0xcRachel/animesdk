...
#define SIMPLYGON_SPSCENEEXPORTER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1838A210)
#define SIMPLYGON_SPSCENEEXPORTER_RUN_OFFSET UNITYSDK_OFFSET(0x1838A7B0)
#define SIMPLYGON_SPSCENEEXPORTER_SETEXPORTFILEPATH_OFFSET UNITYSDK_OFFSET(0x1838A390)
#define SIMPLYGON_SPSCENEEXPORTER_SETSCENE_OFFSET UNITYSDK_OFFSET(0x1838A5A0)
#define SIMPLYGON_SPSCENEEXPORTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18374BE0)
