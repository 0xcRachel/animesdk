...
#define SIMPLYGON_LOADER_GETSDKPATH_OFFSET UNITYSDK_OFFSET(0x86282C0)
#define SIMPLYGON_LOADER_INITSIMPLYGONINTERNAL_OFFSET UNITYSDK_OFFSET(0x8627B00)
#define SIMPLYGON_LOADER_INITSIMPLYGON_1_OFFSET UNITYSDK_OFFSET(0x86282A0)
#define SIMPLYGON_LOADER_INITSIMPLYGON_2_OFFSET UNITYSDK_OFFSET(0x86282B0)
#define SIMPLYGON_LOADER_INITSIMPLYGON_OFFSET UNITYSDK_OFFSET(0x8627AF0)
#define SIMPLYGON_LOADER_SETDLLDIRECTORY_OFFSET UNITYSDK_OFFSET(0x8627A20)
#define SIMPLYGON_LOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x86284D0)
