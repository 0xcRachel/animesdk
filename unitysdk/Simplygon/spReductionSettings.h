...
#define SIMPLYGON_SPREDUCTIONSETTINGS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17B6FE90)
#define SIMPLYGON_SPREDUCTIONSETTINGS_SETREDUCTIONTARGETS_OFFSET UNITYSDK_OFFSET(0x17B70020)
#define SIMPLYGON_SPREDUCTIONSETTINGS_SETREDUCTIONTARGETTRIANGLERATIO_OFFSET UNITYSDK_OFFSET(0x17B70240)
#define SIMPLYGON_SPREDUCTIONSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x17B6FCC0)

namespace Simplygon
{
	inline static constexpr unsigned int spReductionSettings_TypeDefinitionIndex = 28688;
