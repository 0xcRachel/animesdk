...
#define SIMPLYGON_SPREDUCTIONSETTINGS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x183882C0)
#define SIMPLYGON_SPREDUCTIONSETTINGS_SETREDUCTIONTARGETS_OFFSET UNITYSDK_OFFSET(0x18388450)
#define SIMPLYGON_SPREDUCTIONSETTINGS_SETREDUCTIONTARGETTRIANGLERATIO_OFFSET UNITYSDK_OFFSET(0x18388670)
#define SIMPLYGON_SPREDUCTIONSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x183880F0)
