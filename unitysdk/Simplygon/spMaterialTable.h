...
#define SIMPLYGON_SPMATERIALTABLE_ADDMATERIAL_OFFSET UNITYSDK_OFFSET(0x17B6CAB0)
#define SIMPLYGON_SPMATERIALTABLE_CLEAR_OFFSET UNITYSDK_OFFSET(0x17B6C690)
#define SIMPLYGON_SPMATERIALTABLE_COPY_OFFSET UNITYSDK_OFFSET(0x17B6C880)
#define SIMPLYGON_SPMATERIALTABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17B6C380)
#define SIMPLYGON_SPMATERIALTABLE_GETCPTR_OFFSET UNITYSDK_OFFSET(0x17B68660)
#define SIMPLYGON_SPMATERIALTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x17B5A970)

namespace Simplygon
{
	inline static constexpr unsigned int spMaterialTable_TypeDefinitionIndex = 28678;
