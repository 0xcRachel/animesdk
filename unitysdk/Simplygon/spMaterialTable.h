...
#define SIMPLYGON_SPMATERIALTABLE_ADDMATERIAL_OFFSET UNITYSDK_OFFSET(0x18384EE0)
#define SIMPLYGON_SPMATERIALTABLE_CLEAR_OFFSET UNITYSDK_OFFSET(0x18384AC0)
#define SIMPLYGON_SPMATERIALTABLE_COPY_OFFSET UNITYSDK_OFFSET(0x18384CB0)
#define SIMPLYGON_SPMATERIALTABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x183847B0)
#define SIMPLYGON_SPMATERIALTABLE_GETCPTR_OFFSET UNITYSDK_OFFSET(0x18380A90)
#define SIMPLYGON_SPMATERIALTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18373410)
