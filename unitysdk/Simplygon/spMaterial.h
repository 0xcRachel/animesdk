...
#define SIMPLYGON_SPMATERIAL_ADDMATERIALCHANNEL_OFFSET UNITYSDK_OFFSET(0x17B6BBA0)
#define SIMPLYGON_SPMATERIAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17B6BA20)
#define SIMPLYGON_SPMATERIAL_GETCPTR_OFFSET UNITYSDK_OFFSET(0x17B6BA00)
#define SIMPLYGON_SPMATERIAL_SETSHADINGNETWORK_OFFSET UNITYSDK_OFFSET(0x17B6BDB0)
#define SIMPLYGON_SPMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x17B5A2B0)

namespace Simplygon
{
	inline static constexpr unsigned int spMaterial_TypeDefinitionIndex = 28677;
