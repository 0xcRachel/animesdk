...
#define SIMPLYGON_SPMATERIAL_ADDMATERIALCHANNEL_OFFSET UNITYSDK_OFFSET(0x18383FD0)
#define SIMPLYGON_SPMATERIAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18383E50)
#define SIMPLYGON_SPMATERIAL_GETCPTR_OFFSET UNITYSDK_OFFSET(0x18383E30)
#define SIMPLYGON_SPMATERIAL_SETSHADINGNETWORK_OFFSET UNITYSDK_OFFSET(0x183841E0)
#define SIMPLYGON_SPMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x18372D50)
