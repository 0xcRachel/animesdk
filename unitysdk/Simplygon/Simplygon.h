...
#define SIMPLYGON_SIMPLYGON_DEINITIALIZESIMPLYGON_OFFSET UNITYSDK_OFFSET(0x17B59D10)
#define SIMPLYGON_SIMPLYGON_FAILED_OFFSET UNITYSDK_OFFSET(0x17B5EFE0)
#define SIMPLYGON_SIMPLYGON_GETLASTINITIALIZATIONERROR_OFFSET UNITYSDK_OFFSET(0x17B5F8D0)
#define SIMPLYGON_SIMPLYGON_INITIALIZESIMPLYGON_1_OFFSET UNITYSDK_OFFSET(0x17B5F570)
#define SIMPLYGON_SIMPLYGON_INITIALIZESIMPLYGON_OFFSET UNITYSDK_OFFSET(0x17B5F250)
#define SIMPLYGON_SIMPLYGON__CCTOR_OFFSET UNITYSDK_OFFSET(0x17B5FB40)

namespace Simplygon
{
	inline static constexpr unsigned int Simplygon_TypeDefinitionIndex = 28713;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Simplygon_TypeDefinitionIndex)->GetStaticField(0xE6F0);
		}
