...
#define SIMPLYGON_SPTEXTURE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17B73FA0)
#define SIMPLYGON_SPTEXTURE_GETCPTR_OFFSET UNITYSDK_OFFSET(0x17B73F80)
#define SIMPLYGON_SPTEXTURE_SETFILEPATH_OFFSET UNITYSDK_OFFSET(0x17B74120)
#define SIMPLYGON_SPTEXTURE__CTOR_OFFSET UNITYSDK_OFFSET(0x17B5CA80)

namespace Simplygon
{
	inline static constexpr unsigned int spTexture_TypeDefinitionIndex = 28697;
