...
#define SIMPLYGON_SPTEXTURE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1838C3D0)
#define SIMPLYGON_SPTEXTURE_GETCPTR_OFFSET UNITYSDK_OFFSET(0x1838C3B0)
#define SIMPLYGON_SPTEXTURE_SETFILEPATH_OFFSET UNITYSDK_OFFSET(0x1838C550)
#define SIMPLYGON_SPTEXTURE__CTOR_OFFSET UNITYSDK_OFFSET(0x18375520)
