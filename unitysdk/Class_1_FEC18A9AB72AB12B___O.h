...
public:
	...
	{
		return (::RPG::CustomRP::SyncLoadAssetDel**)Il2CppClass::FromTypeDefinitionIndex(Class_1_FEC18A9AB72AB12B___O_TypeDefinitionIndex)->GetStaticField(0x49020);
	}
	static ::RPG::CustomRP::ReleaseAssetDel** StaticGet__1___ReleaseAsset()
	{
		return (::RPG::CustomRP::ReleaseAssetDel**)Il2CppClass::FromTypeDefinitionIndex(Class_1_FEC18A9AB72AB12B___O_TypeDefinitionIndex)->GetStaticField(0x49028);
	}
};
