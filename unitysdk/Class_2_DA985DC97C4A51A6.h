...
#define CLASS_2_DA985DC97C4A51A6_DISPOSE_OFFSET UNITYSDK_OFFSET(0x856C6E0)
#define CLASS_2_DA985DC97C4A51A6_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x856C720)
#define CLASS_2_DA985DC97C4A51A6_ONSKIP_OFFSET UNITYSDK_OFFSET(0x856C860)
#define CLASS_2_DA985DC97C4A51A6_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x856C730)
#define CLASS_2_DA985DC97C4A51A6_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x856C790)
#define CLASS_2_DA985DC97C4A51A6_TICK_OFFSET UNITYSDK_OFFSET(0x856C7E0)
#define CLASS_2_DA985DC97C4A51A6__CTOR_OFFSET UNITYSDK_OFFSET(0x856C6D0)

inline static constexpr unsigned int Class_2_DA985DC97C4A51A6_TypeDefinitionIndex = 46480;
