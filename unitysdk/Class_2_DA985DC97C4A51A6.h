...
#define CLASS_2_DA985DC97C4A51A6_DISPOSE_OFFSET UNITYSDK_OFFSET(0xF394C20)
#define CLASS_2_DA985DC97C4A51A6_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0xF394C60)
#define CLASS_2_DA985DC97C4A51A6_ONSKIP_OFFSET UNITYSDK_OFFSET(0xF394DA0)
#define CLASS_2_DA985DC97C4A51A6_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xF394C70)
#define CLASS_2_DA985DC97C4A51A6_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xF394CD0)
#define CLASS_2_DA985DC97C4A51A6_TICK_OFFSET UNITYSDK_OFFSET(0xF394D20)
#define CLASS_2_DA985DC97C4A51A6__CTOR_OFFSET UNITYSDK_OFFSET(0xF394C10)
