...
#define CLASS_1_4D3D6EC2FF67A7B8_ADD_ONFIGHTHEARTBEATSCRSP_OFFSET UNITYSDK_OFFSET(0x113F8900)
#define CLASS_1_4D3D6EC2FF67A7B8_ADD_ONGENERALNOTIFY_OFFSET UNITYSDK_OFFSET(0x113F8840)
#define CLASS_1_4D3D6EC2FF67A7B8_ADD_ONGENERALRSP_OFFSET UNITYSDK_OFFSET(0x113F8780)
#define CLASS_1_4D3D6EC2FF67A7B8_ADD_ONSERVERCONNECTED_OFFSET UNITYSDK_OFFSET(0x113F8480)
#define CLASS_1_4D3D6EC2FF67A7B8_ADD_ONSERVERCONNECTFAIL_OFFSET UNITYSDK_OFFSET(0x113F8600)
#define CLASS_1_4D3D6EC2FF67A7B8_ADD_ONSERVERDISCONNECTED_OFFSET UNITYSDK_OFFSET(0x113F8540)
#define CLASS_1_4D3D6EC2FF67A7B8_ADD_ONSERVERSTOPPED_OFFSET UNITYSDK_OFFSET(0x113F86C0)
#define CLASS_1_4D3D6EC2FF67A7B8_DISPOSE_OFFSET UNITYSDK_OFFSET(0x113F8B70)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0x113FACD0)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_07FB94561F155CD7_OFFSET UNITYSDK_OFFSET(0x113F9AE0)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_0AE6B6F1AAE15BFE_OFFSET UNITYSDK_OFFSET(0x113FA8D0)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_0BDFAC56E6B704CB_1_OFFSET UNITYSDK_OFFSET(0x113F9F60)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_0BDFAC56E6B704CB_OFFSET UNITYSDK_OFFSET(0x113F9850)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_0D8DB2DC8B47A973_OFFSET UNITYSDK_OFFSET(0x113F89C0)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_0DD2F59010F908F5_OFFSET UNITYSDK_OFFSET(0x113F8130)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_0DF420E95D6252BE_OFFSET UNITYSDK_OFFSET(0x113F99F0)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_21AFFD96111DC5FA_OFFSET UNITYSDK_OFFSET(0x113F9BD0)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x113F8470)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_25DEA5C65A602671_1_OFFSET UNITYSDK_OFFSET(0x113F8FC0)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_25DEA5C65A602671_2_OFFSET UNITYSDK_OFFSET(0x113F9090)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_25DEA5C65A602671_OFFSET UNITYSDK_OFFSET(0x113FA6D0)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_25EC451C0EA68F53_OFFSET UNITYSDK_OFFSET(0x113F93A0)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_2BC55A66CB2B0118_OFFSET UNITYSDK_OFFSET(0x113F8ED0)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_35942D7A8A374AB0_OFFSET UNITYSDK_OFFSET(0x113F8CD0)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x113F9B90)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x113F9420)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x113F8F60)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_528BD4865C714C5C_OFFSET UNITYSDK_OFFSET(0x113F8440)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_5CEC4607322705E5_OFFSET UNITYSDK_OFFSET(0x113F83F0)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_62165C025F5C0B19_OFFSET UNITYSDK_OFFSET(0x113F8D70)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_7541FB7EB0923E08_OFFSET UNITYSDK_OFFSET(0x113FAD50)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_79D3E3D754041A2D_OFFSET UNITYSDK_OFFSET(0x113FA0D0)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_7A5B7308B791474B_OFFSET UNITYSDK_OFFSET(0x113F7F30)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_9B39F7D7C1FF70D6_OFFSET UNITYSDK_OFFSET(0x113FAC00)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_9D07C9D58517DB16_OFFSET UNITYSDK_OFFSET(0x113F8290)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_9F218BA7C451254A_OFFSET UNITYSDK_OFFSET(0x113FAB60)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_A6B0DBF2DA41C614_OFFSET UNITYSDK_OFFSET(0x113FA5D0)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_A7E8B52E9ABB8DB9_1_OFFSET UNITYSDK_OFFSET(0x113FAAE0)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_A7E8B52E9ABB8DB9_OFFSET UNITYSDK_OFFSET(0x113FA850)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_A9DAF3FE2888211B_OFFSET UNITYSDK_OFFSET(0x113F98B0)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_B22E4C20D4492593_OFFSET UNITYSDK_OFFSET(0x113F81A0)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_BA1BB49741CFDFE1_OFFSET UNITYSDK_OFFSET(0x113F9470)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_BBA49FAB086F388D_OFFSET UNITYSDK_OFFSET(0x113F9160)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_BD97C03B146A6E18_OFFSET UNITYSDK_OFFSET(0x113F9270)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x113F8C00)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_DE1C1F4DF5D06882_OFFSET UNITYSDK_OFFSET(0x113FA7C0)
#define CLASS_1_4D3D6EC2FF67A7B8_METHOD_1_F4ADC37B63F4E9EF_OFFSET UNITYSDK_OFFSET(0x113F9FC0)
#define CLASS_1_4D3D6EC2FF67A7B8_REMOVE_ONFIGHTHEARTBEATSCRSP_OFFSET UNITYSDK_OFFSET(0x113F8960)
#define CLASS_1_4D3D6EC2FF67A7B8_REMOVE_ONGENERALNOTIFY_OFFSET UNITYSDK_OFFSET(0x113F88A0)
#define CLASS_1_4D3D6EC2FF67A7B8_REMOVE_ONGENERALRSP_OFFSET UNITYSDK_OFFSET(0x113F87E0)
#define CLASS_1_4D3D6EC2FF67A7B8_REMOVE_ONSERVERCONNECTED_OFFSET UNITYSDK_OFFSET(0x113F84E0)
#define CLASS_1_4D3D6EC2FF67A7B8_REMOVE_ONSERVERCONNECTFAIL_OFFSET UNITYSDK_OFFSET(0x113F8660)
#define CLASS_1_4D3D6EC2FF67A7B8_REMOVE_ONSERVERDISCONNECTED_OFFSET UNITYSDK_OFFSET(0x113F85A0)
#define CLASS_1_4D3D6EC2FF67A7B8_REMOVE_ONSERVERSTOPPED_OFFSET UNITYSDK_OFFSET(0x113F8720)
#define CLASS_1_4D3D6EC2FF67A7B8__CTOR_OFFSET UNITYSDK_OFFSET(0x113FADE0)
...
{
public:
	::System::Action* OnServerConnectFail; // 0x10
	::Class_1_615E8BBF6B445C30* Field_1_7; // 0x18
	::Class_1_23F67DD15593C8D6* Field_1_12; // 0x20
	::System::Action_2<::System::UInt32, ::Google::Protobuf::ByteString*>* OnGeneralRsp; // 0x28
	::Class_1_69A4FCD237772492* Field_1_8; // 0x30
	::System::Action_2<::System::UInt64, ::System::Single>* OnFightHeartBeatScRsp; // 0x38
	::System::Action* OnServerStopped; // 0x40
	::System::Action_2<::System::UInt32, ::Google::Protobuf::ByteString*>* OnGeneralNotify; // 0x48
	::System::Action* OnServerConnected; // 0x50
	::System::Action* OnServerDisconnected; // 0x58
	::Class_1_B884A3F1FCD4287A* Field_1_11; // 0x60
	::Class_1_23F67DD15593C8D6* Field_1_13; // 0x68
