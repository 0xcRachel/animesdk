...
public:
	...
	{
		return (::RPG::CustomRP::SyncLoadAssetDel**)Il2CppClass::FromTypeDefinitionIndex(Class_1_638AE75D614E200B___O_TypeDefinitionIndex)->GetStaticField(0x6AEB0);
	}
	static ::RPG::CustomRP::ReleaseAssetDel** StaticGet__1___ReleaseAsset()
	{
		return (::RPG::CustomRP::ReleaseAssetDel**)Il2CppClass::FromTypeDefinitionIndex(Class_1_638AE75D614E200B___O_TypeDefinitionIndex)->GetStaticField(0x6AEB8);
	}
};
