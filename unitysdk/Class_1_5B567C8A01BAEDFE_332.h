...
#define CLASS_1_5B567C8A01BAEDFE_332_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A335730)
#define CLASS_1_5B567C8A01BAEDFE_332_CLONE_OFFSET UNITYSDK_OFFSET(0x1A335540)
#define CLASS_1_5B567C8A01BAEDFE_332_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A335640)
#define CLASS_1_5B567C8A01BAEDFE_332_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A3355B0)
#define CLASS_1_5B567C8A01BAEDFE_332_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A335690)
#define CLASS_1_5B567C8A01BAEDFE_332_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A335780)
#define CLASS_1_5B567C8A01BAEDFE_332_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A335750)
#define CLASS_1_5B567C8A01BAEDFE_332_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A335490)
#define CLASS_1_5B567C8A01BAEDFE_332_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A3354F0)
#define CLASS_1_5B567C8A01BAEDFE_332_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A3356C0)
#define CLASS_1_5B567C8A01BAEDFE_332_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A335720)
#define CLASS_1_5B567C8A01BAEDFE_332__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A3357D0)
#define CLASS_1_5B567C8A01BAEDFE_332__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A335510)
#define CLASS_1_5B567C8A01BAEDFE_332__CTOR_OFFSET UNITYSDK_OFFSET(0x1A335500)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_332*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_332_TypeDefinitionIndex)->GetStaticField(0x1B760);
	}
