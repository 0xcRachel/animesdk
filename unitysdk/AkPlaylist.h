...
#define AKPLAYLIST_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18BDAB20)
#define AKPLAYLIST_ENQUEUE_1_OFFSET UNITYSDK_OFFSET(0x18BDAF80)
#define AKPLAYLIST_ENQUEUE_2_OFFSET UNITYSDK_OFFSET(0x18BDB070)
#define AKPLAYLIST_ENQUEUE_3_OFFSET UNITYSDK_OFFSET(0x18BDB150)
#define AKPLAYLIST_ENQUEUE_4_OFFSET UNITYSDK_OFFSET(0x18BDB220)
#define AKPLAYLIST_ENQUEUE_OFFSET UNITYSDK_OFFSET(0x18BDAE70)
#define AKPLAYLIST_GETCPTR_OFFSET UNITYSDK_OFFSET(0x18BDA940)
#define AKPLAYLIST_SETCPTR_OFFSET UNITYSDK_OFFSET(0x18BDA990)
#define AKPLAYLIST__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18BDB2E0)
#define AKPLAYLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x18BDA8A0)
#define AKPLAYLIST___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18BDB3F0)
#define AKPLAYLIST___IFIXBASEPROXY_SETCPTR_OFFSET UNITYSDK_OFFSET(0x18BDB3E0)
