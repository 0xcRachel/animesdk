...
#define AKPLAYLIST_DISPOSE_OFFSET UNITYSDK_OFFSET(0x183B6090)
#define AKPLAYLIST_ENQUEUE_1_OFFSET UNITYSDK_OFFSET(0x183B64F0)
#define AKPLAYLIST_ENQUEUE_2_OFFSET UNITYSDK_OFFSET(0x183B65E0)
#define AKPLAYLIST_ENQUEUE_3_OFFSET UNITYSDK_OFFSET(0x183B66C0)
#define AKPLAYLIST_ENQUEUE_4_OFFSET UNITYSDK_OFFSET(0x183B6790)
#define AKPLAYLIST_ENQUEUE_OFFSET UNITYSDK_OFFSET(0x183B63E0)
#define AKPLAYLIST_GETCPTR_OFFSET UNITYSDK_OFFSET(0x183B5EB0)
#define AKPLAYLIST_SETCPTR_OFFSET UNITYSDK_OFFSET(0x183B5F00)
#define AKPLAYLIST__CTOR_1_OFFSET UNITYSDK_OFFSET(0x183B6850)
#define AKPLAYLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x183B5E10)
#define AKPLAYLIST___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x183B6960)
#define AKPLAYLIST___IFIXBASEPROXY_SETCPTR_OFFSET UNITYSDK_OFFSET(0x183B6950)

inline static constexpr unsigned int AkPlaylist_TypeDefinitionIndex = 33521;
