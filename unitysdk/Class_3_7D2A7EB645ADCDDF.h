...
#define CLASS_3_7D2A7EB645ADCDDF_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13F30BC0)
#define CLASS_3_7D2A7EB645ADCDDF_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x13F30A10)
#define CLASS_3_7D2A7EB645ADCDDF_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x13F30D00)
#define CLASS_3_7D2A7EB645ADCDDF_TICK_OFFSET UNITYSDK_OFFSET(0x13F30C10)
#define CLASS_3_7D2A7EB645ADCDDF__CTOR_OFFSET UNITYSDK_OFFSET(0x13F309E0)
#define CLASS_3_7D2A7EB645ADCDDF___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13F30D50)
#define CLASS_3_7D2A7EB645ADCDDF___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x13F30DA0)
