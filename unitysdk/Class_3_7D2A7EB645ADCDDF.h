...
#define CLASS_3_7D2A7EB645ADCDDF_DISPOSE_OFFSET UNITYSDK_OFFSET(0xDE78820)
#define CLASS_3_7D2A7EB645ADCDDF_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xDE78690)
#define CLASS_3_7D2A7EB645ADCDDF_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xDE78920)
#define CLASS_3_7D2A7EB645ADCDDF_TICK_OFFSET UNITYSDK_OFFSET(0xDE78870)
#define CLASS_3_7D2A7EB645ADCDDF__CTOR_OFFSET UNITYSDK_OFFSET(0xDE78660)
#define CLASS_3_7D2A7EB645ADCDDF___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xDE78970)
#define CLASS_3_7D2A7EB645ADCDDF___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0xDE789C0)
