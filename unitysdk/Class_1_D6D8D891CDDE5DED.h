...
#define CLASS_1_D6D8D891CDDE5DED_GET_ERRORCODE_OFFSET UNITYSDK_OFFSET(0x8A78410)
#define CLASS_1_D6D8D891CDDE5DED_GET_REPORTMESSAGE_OFFSET UNITYSDK_OFFSET(0x8A78430)
#define CLASS_1_D6D8D891CDDE5DED_GET_SUCCEED_OFFSET UNITYSDK_OFFSET(0x8A783F0)
#define CLASS_1_D6D8D891CDDE5DED_SET_ERRORCODE_OFFSET UNITYSDK_OFFSET(0x8A78420)
#define CLASS_1_D6D8D891CDDE5DED_SET_REPORTMESSAGE_OFFSET UNITYSDK_OFFSET(0x8A78440)
#define CLASS_1_D6D8D891CDDE5DED_SET_SUCCEED_OFFSET UNITYSDK_OFFSET(0x8A78400)
#define CLASS_1_D6D8D891CDDE5DED__CTOR_OFFSET UNITYSDK_OFFSET(0x8A78450)
