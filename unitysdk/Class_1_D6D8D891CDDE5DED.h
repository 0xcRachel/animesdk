...
#define CLASS_1_D6D8D891CDDE5DED_GET_ERRORCODE_OFFSET UNITYSDK_OFFSET(0xCD96440)
#define CLASS_1_D6D8D891CDDE5DED_GET_REPORTMESSAGE_OFFSET UNITYSDK_OFFSET(0xCD96460)
#define CLASS_1_D6D8D891CDDE5DED_GET_SUCCEED_OFFSET UNITYSDK_OFFSET(0xCD96420)
#define CLASS_1_D6D8D891CDDE5DED_SET_ERRORCODE_OFFSET UNITYSDK_OFFSET(0xCD96450)
#define CLASS_1_D6D8D891CDDE5DED_SET_REPORTMESSAGE_OFFSET UNITYSDK_OFFSET(0xCD96470)
#define CLASS_1_D6D8D891CDDE5DED_SET_SUCCEED_OFFSET UNITYSDK_OFFSET(0xCD96430)
#define CLASS_1_D6D8D891CDDE5DED__CTOR_OFFSET UNITYSDK_OFFSET(0xCD96480)
