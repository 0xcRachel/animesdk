...
#define CLASS_1_5B567C8A01BAEDFE_45_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1B08AAA0)
#define CLASS_1_5B567C8A01BAEDFE_45_CLONE_OFFSET UNITYSDK_OFFSET(0x1B08A910)
#define CLASS_1_5B567C8A01BAEDFE_45_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1B08A9B0)
#define CLASS_1_5B567C8A01BAEDFE_45_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B08A950)
#define CLASS_1_5B567C8A01BAEDFE_45_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B08AA00)
#define CLASS_1_5B567C8A01BAEDFE_45_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1B08AAF0)
#define CLASS_1_5B567C8A01BAEDFE_45_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1B08AAC0)
#define CLASS_1_5B567C8A01BAEDFE_45_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1B08A890)
#define CLASS_1_5B567C8A01BAEDFE_45_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1B08A8C0)
#define CLASS_1_5B567C8A01BAEDFE_45_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B08AA30)
#define CLASS_1_5B567C8A01BAEDFE_45_WRITETO_OFFSET UNITYSDK_OFFSET(0x1B08AA90)
#define CLASS_1_5B567C8A01BAEDFE_45__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B08AB40)
#define CLASS_1_5B567C8A01BAEDFE_45__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B08A8E0)
#define CLASS_1_5B567C8A01BAEDFE_45__CTOR_OFFSET UNITYSDK_OFFSET(0x1B08A8D0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_45*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_45_TypeDefinitionIndex)->GetStaticField(0x365D0);
	}
