...
#define CLASS_1_5B567C8A01BAEDFE_45_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A312190)
#define CLASS_1_5B567C8A01BAEDFE_45_CLONE_OFFSET UNITYSDK_OFFSET(0x1A312000)
#define CLASS_1_5B567C8A01BAEDFE_45_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A3120A0)
#define CLASS_1_5B567C8A01BAEDFE_45_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A312040)
#define CLASS_1_5B567C8A01BAEDFE_45_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A3120F0)
#define CLASS_1_5B567C8A01BAEDFE_45_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A3121E0)
#define CLASS_1_5B567C8A01BAEDFE_45_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A3121B0)
#define CLASS_1_5B567C8A01BAEDFE_45_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A311F80)
#define CLASS_1_5B567C8A01BAEDFE_45_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A311FB0)
#define CLASS_1_5B567C8A01BAEDFE_45_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A312120)
#define CLASS_1_5B567C8A01BAEDFE_45_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A312180)
#define CLASS_1_5B567C8A01BAEDFE_45__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A312230)
#define CLASS_1_5B567C8A01BAEDFE_45__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A311FD0)
#define CLASS_1_5B567C8A01BAEDFE_45__CTOR_OFFSET UNITYSDK_OFFSET(0x1A311FC0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_45*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_45_TypeDefinitionIndex)->GetStaticField(0x4AEE0);
	}
