...
#define CLASS_1_5F7C2EDC42F3AA1C_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A04BF40)
#define CLASS_1_5F7C2EDC42F3AA1C_CLONE_OFFSET UNITYSDK_OFFSET(0x1A04BAC0)
#define CLASS_1_5F7C2EDC42F3AA1C_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A04BC60)
#define CLASS_1_5F7C2EDC42F3AA1C_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A04BB40)
#define CLASS_1_5F7C2EDC42F3AA1C_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A04BD10)
#define CLASS_1_5F7C2EDC42F3AA1C_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A04C110)
#define CLASS_1_5F7C2EDC42F3AA1C_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A04C070)
#define CLASS_1_5F7C2EDC42F3AA1C_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1A04BB20)
#define CLASS_1_5F7C2EDC42F3AA1C_METHOD_1_10C86DED0B15D222_OFFSET UNITYSDK_OFFSET(0x1A04BB10)
#define CLASS_1_5F7C2EDC42F3AA1C_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A04B940)
#define CLASS_1_5F7C2EDC42F3AA1C_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1A04BB30)
#define CLASS_1_5F7C2EDC42F3AA1C_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A04B9A0)
#define CLASS_1_5F7C2EDC42F3AA1C_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A04BE00)
#define CLASS_1_5F7C2EDC42F3AA1C_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A04BE60)
#define CLASS_1_5F7C2EDC42F3AA1C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A04C1F0)
#define CLASS_1_5F7C2EDC42F3AA1C__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A04BA00)
#define CLASS_1_5F7C2EDC42F3AA1C__CTOR_OFFSET UNITYSDK_OFFSET(0x1A04B9B0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5F7C2EDC42F3AA1C*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5F7C2EDC42F3AA1C_TypeDefinitionIndex)->GetStaticField(0x53CF0);
	}
	static ::Google::Protobuf::FieldCodec_1<::Proto::RogueAdventureRoomGameplayWolfGunTarget*>** StaticGet_Field_1_3()
	{
		return (::Google::Protobuf::FieldCodec_1<::Proto::RogueAdventureRoomGameplayWolfGunTarget*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5F7C2EDC42F3AA1C_TypeDefinitionIndex)->GetStaticField(0x53CF8);
	}
