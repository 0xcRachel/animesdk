...
#define CLASS_1_5B567C8A01BAEDFE_40_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A171660)
#define CLASS_1_5B567C8A01BAEDFE_40_CLONE_OFFSET UNITYSDK_OFFSET(0x1A1714D0)
#define CLASS_1_5B567C8A01BAEDFE_40_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A171570)
#define CLASS_1_5B567C8A01BAEDFE_40_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A171510)
#define CLASS_1_5B567C8A01BAEDFE_40_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A1715C0)
#define CLASS_1_5B567C8A01BAEDFE_40_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A1716B0)
#define CLASS_1_5B567C8A01BAEDFE_40_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A171680)
#define CLASS_1_5B567C8A01BAEDFE_40_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A171450)
#define CLASS_1_5B567C8A01BAEDFE_40_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A171480)
#define CLASS_1_5B567C8A01BAEDFE_40_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A1715F0)
#define CLASS_1_5B567C8A01BAEDFE_40_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A171650)
#define CLASS_1_5B567C8A01BAEDFE_40__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A171700)
#define CLASS_1_5B567C8A01BAEDFE_40__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A1714A0)
#define CLASS_1_5B567C8A01BAEDFE_40__CTOR_OFFSET UNITYSDK_OFFSET(0x1A171490)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_40*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_40_TypeDefinitionIndex)->GetStaticField(0x163B0);
	}
