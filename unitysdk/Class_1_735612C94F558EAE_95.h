...
#define CLASS_1_735612C94F558EAE_95_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x18244470)
#define CLASS_1_735612C94F558EAE_95_CLONE_OFFSET UNITYSDK_OFFSET(0x18243FD0)
#define CLASS_1_735612C94F558EAE_95_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x182440E0)
#define CLASS_1_735612C94F558EAE_95_EQUALS_OFFSET UNITYSDK_OFFSET(0x18244020)
#define CLASS_1_735612C94F558EAE_95_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x18244190)
#define CLASS_1_735612C94F558EAE_95_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x18244560)
#define CLASS_1_735612C94F558EAE_95_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x18244500)
#define CLASS_1_735612C94F558EAE_95_METHOD_1_554199E0076172C5_1_OFFSET UNITYSDK_OFFSET(0x18244010)
#define CLASS_1_735612C94F558EAE_95_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x18244000)
#define CLASS_1_735612C94F558EAE_95_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x18243E50)
#define CLASS_1_735612C94F558EAE_95_TOSTRING_OFFSET UNITYSDK_OFFSET(0x18244370)
#define CLASS_1_735612C94F558EAE_95_WRITETO_OFFSET UNITYSDK_OFFSET(0x182443D0)
#define CLASS_1_735612C94F558EAE_95__CCTOR_OFFSET UNITYSDK_OFFSET(0x18244690)
#define CLASS_1_735612C94F558EAE_95__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18243EF0)
#define CLASS_1_735612C94F558EAE_95__CTOR_OFFSET UNITYSDK_OFFSET(0x18243E60)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_735612C94F558EAE_95_TypeDefinitionIndex)->GetStaticField(0x151F0);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_5()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_735612C94F558EAE_95_TypeDefinitionIndex)->GetStaticField(0x151F8);
	}
