...
#define CLASS_2_5388514CECCA0FC0_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD1DFBA0)
#define CLASS_2_5388514CECCA0FC0_METHOD_2_DF3BCB639F0C02DF_OFFSET UNITYSDK_OFFSET(0xD1DFEE0)
#define CLASS_2_5388514CECCA0FC0_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xD1DFC50)
#define CLASS_2_5388514CECCA0FC0_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xD1DFE10)
#define CLASS_2_5388514CECCA0FC0_SETNEXTTASK_OFFSET UNITYSDK_OFFSET(0xD1DFC00)
#define CLASS_2_5388514CECCA0FC0_TICK_OFFSET UNITYSDK_OFFSET(0xD1DFE80)
#define CLASS_2_5388514CECCA0FC0__CTOR_OFFSET UNITYSDK_OFFSET(0xD1DFB80)

inline static constexpr unsigned int Class_2_5388514CECCA0FC0_TypeDefinitionIndex = 45869;

class Class_2_5388514CECCA0FC0 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_2; // 0x18
	::RPG::Client::PerformanceManager* Field_2_3; // 0x20
