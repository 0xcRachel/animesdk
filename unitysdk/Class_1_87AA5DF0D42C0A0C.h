...
#define CLASS_1_87AA5DF0D42C0A0C_GET_MAPPINGINFONODE_OFFSET UNITYSDK_OFFSET(0xC655B60)
#define CLASS_1_87AA5DF0D42C0A0C_GET_SHORTESTPATH_OFFSET UNITYSDK_OFFSET(0xC655B80)
#define CLASS_1_87AA5DF0D42C0A0C_SET_MAPPINGINFONODE_OFFSET UNITYSDK_OFFSET(0xC655B70)
#define CLASS_1_87AA5DF0D42C0A0C_SET_SHORTESTPATH_OFFSET UNITYSDK_OFFSET(0xC655B90)
#define CLASS_1_87AA5DF0D42C0A0C__CTOR_OFFSET UNITYSDK_OFFSET(0xC655BA0)

inline static constexpr unsigned int Class_1_87AA5DF0D42C0A0C_TypeDefinitionIndex = 68820;
