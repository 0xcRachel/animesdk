...
#define CLASS_1_87AA5DF0D42C0A0C_GET_MAPPINGINFONODE_OFFSET UNITYSDK_OFFSET(0x116AC180)
#define CLASS_1_87AA5DF0D42C0A0C_GET_SHORTESTPATH_OFFSET UNITYSDK_OFFSET(0x116AC1A0)
#define CLASS_1_87AA5DF0D42C0A0C_SET_MAPPINGINFONODE_OFFSET UNITYSDK_OFFSET(0x116AC190)
#define CLASS_1_87AA5DF0D42C0A0C_SET_SHORTESTPATH_OFFSET UNITYSDK_OFFSET(0x116AC1B0)
#define CLASS_1_87AA5DF0D42C0A0C__CTOR_OFFSET UNITYSDK_OFFSET(0x116AC1C0)

inline static constexpr unsigned int Class_1_87AA5DF0D42C0A0C_TypeDefinitionIndex = 61313;
