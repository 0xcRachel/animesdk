...
#define CLASS_1_5B567C8A01BAEDFE_63_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1AFAB100)
#define CLASS_1_5B567C8A01BAEDFE_63_CLONE_OFFSET UNITYSDK_OFFSET(0x1AFAAF10)
#define CLASS_1_5B567C8A01BAEDFE_63_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1AFAB010)
#define CLASS_1_5B567C8A01BAEDFE_63_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AFAAF80)
#define CLASS_1_5B567C8A01BAEDFE_63_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AFAB060)
#define CLASS_1_5B567C8A01BAEDFE_63_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1AFAB150)
#define CLASS_1_5B567C8A01BAEDFE_63_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1AFAB120)
#define CLASS_1_5B567C8A01BAEDFE_63_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1AFAAE60)
#define CLASS_1_5B567C8A01BAEDFE_63_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1AFAAEC0)
#define CLASS_1_5B567C8A01BAEDFE_63_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AFAB090)
#define CLASS_1_5B567C8A01BAEDFE_63_WRITETO_OFFSET UNITYSDK_OFFSET(0x1AFAB0F0)
#define CLASS_1_5B567C8A01BAEDFE_63__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AFAB1A0)
#define CLASS_1_5B567C8A01BAEDFE_63__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AFAAEE0)
#define CLASS_1_5B567C8A01BAEDFE_63__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFAAED0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_63*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_63_TypeDefinitionIndex)->GetStaticField(0x25860);
	}
