...
#define CLASS_2_FC8832E22E5D1C07_METHOD_2_00B029BA6E4FB42F_OFFSET UNITYSDK_OFFSET(0xCD23320)
#define CLASS_2_FC8832E22E5D1C07_METHOD_2_97BC79BDB09179A3_OFFSET UNITYSDK_OFFSET(0xCD232B0)
#define CLASS_2_FC8832E22E5D1C07_METHOD_2_E9A5F20A5A25C0EA_OFFSET UNITYSDK_OFFSET(0xCD234F0)
#define CLASS_2_FC8832E22E5D1C07_METHOD_2_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0xCD23670)
#define CLASS_2_FC8832E22E5D1C07__CCTOR_OFFSET UNITYSDK_OFFSET(0xCD23710)
#define CLASS_2_FC8832E22E5D1C07__CTOR_OFFSET UNITYSDK_OFFSET(0xCD236E0)
#define CLASS_2_FC8832E22E5D1C07__ONBIND_OFFSET UNITYSDK_OFFSET(0xCD23210)
#define CLASS_2_FC8832E22E5D1C07___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0xCD23AA0)

inline static constexpr unsigned int Class_2_FC8832E22E5D1C07_TypeDefinitionIndex = 65866;
...
public:
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::RPG::GameCore::SilverWolf999UltraPropState, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_FC8832E22E5D1C07_TypeDefinitionIndex)->GetStaticField(0x68E70);
	}
	static ::System::Collections::Generic::Dictionary_2<::RPG::GameCore::SilverWolf999UltraPropType, ::System::String*>** StaticGet_Field_2_3()
	{
		return (::System::Collections::Generic::Dictionary_2<::RPG::GameCore::SilverWolf999UltraPropType, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_FC8832E22E5D1C07_TypeDefinitionIndex)->GetStaticField(0x68E78);
	}
