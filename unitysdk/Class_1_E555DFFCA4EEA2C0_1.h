...
#define CLASS_1_E555DFFCA4EEA2C0_1_METHOD_1_4786734FE260DA89_OFFSET UNITYSDK_OFFSET(0xEA730D0)
#define CLASS_1_E555DFFCA4EEA2C0_1_METHOD_1_505594EF44B87658_OFFSET UNITYSDK_OFFSET(0xEA72B60)
#define CLASS_1_E555DFFCA4EEA2C0_1_METHOD_1_BF3B280A16743FF2_OFFSET UNITYSDK_OFFSET(0xEA73120)
#define CLASS_1_E555DFFCA4EEA2C0_1__CTOR_OFFSET UNITYSDK_OFFSET(0xEA72B30)
...
public:
	...
	::RPG::GameCore::AvatarPropertyType Field_1_6; // 0x14
	::RPG::GameCore::AvatarPropertyType Field_1_4; // 0x18
	::RPG::GameCore::AvatarPropertyType Field_1_3; // 0x1C
	::RPG::GameCore::AvatarPropertyType Field_1_2; // 0x20
	::RPG::GameCore::AvatarPropertyType Field_1_0; // 0x24
	::RPG::GameCore::AvatarPropertyType Field_1_5; // 0x28
