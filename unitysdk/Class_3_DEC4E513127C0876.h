...
#define CLASS_3_DEC4E513127C0876_METHOD_3_8C3DB70FFBBF01C7_OFFSET UNITYSDK_OFFSET(0x89C9FF0)
#define CLASS_3_DEC4E513127C0876__CTOR_OFFSET UNITYSDK_OFFSET(0x89C9D50)
#define CLASS_3_DEC4E513127C0876__REGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x89C9ED0)
#define CLASS_3_DEC4E513127C0876__UNREGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x89C9F60)
#define CLASS_3_DEC4E513127C0876___IFIXBASEPROXY__REGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x89CA0F0)
#define CLASS_3_DEC4E513127C0876___IFIXBASEPROXY__UNREGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x89CA100)
