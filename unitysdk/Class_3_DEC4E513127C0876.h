...
#define CLASS_3_DEC4E513127C0876_METHOD_3_8C3DB70FFBBF01C7_OFFSET UNITYSDK_OFFSET(0x10C22010)
#define CLASS_3_DEC4E513127C0876__CTOR_OFFSET UNITYSDK_OFFSET(0x10C21D70)
#define CLASS_3_DEC4E513127C0876__REGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x10C21EF0)
#define CLASS_3_DEC4E513127C0876__UNREGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x10C21F80)
#define CLASS_3_DEC4E513127C0876___IFIXBASEPROXY__REGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x10C22110)
#define CLASS_3_DEC4E513127C0876___IFIXBASEPROXY__UNREGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x10C22120)

inline static constexpr unsigned int Class_3_DEC4E513127C0876_TypeDefinitionIndex = 46477;
