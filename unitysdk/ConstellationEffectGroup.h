...
#define CONSTELLATIONEFFECTGROUP_ADDALLCHILD_OFFSET UNITYSDK_OFFSET(0x996C450)
#define CONSTELLATIONEFFECTGROUP_FORCEUPDATE_OFFSET UNITYSDK_OFFSET(0x996BD80)
#define CONSTELLATIONEFFECTGROUP_METHOD_5_07280B24DFAC0CA9_OFFSET UNITYSDK_OFFSET(0x996C650)
#define CONSTELLATIONEFFECTGROUP_METHOD_5_AEBE2A217F463B51_OFFSET UNITYSDK_OFFSET(0x996CB60)
#define CONSTELLATIONEFFECTGROUP_METHOD_5_C365440D57901CE0_OFFSET UNITYSDK_OFFSET(0x996CE90)
#define CONSTELLATIONEFFECTGROUP_METHOD_5_EA3063A5CDD6F164_OFFSET UNITYSDK_OFFSET(0x996BFA0)
#define CONSTELLATIONEFFECTGROUP_METHOD_5_EC90937CEA9AFCA9_OFFSET UNITYSDK_OFFSET(0x996BDD0)
#define CONSTELLATIONEFFECTGROUP_UPDATE_OFFSET UNITYSDK_OFFSET(0x996D540)
#define CONSTELLATIONEFFECTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x996D590)

inline static constexpr unsigned int ConstellationEffectGroup_TypeDefinitionIndex = 37265;
