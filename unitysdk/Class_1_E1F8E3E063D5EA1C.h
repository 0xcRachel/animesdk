...
#define CLASS_1_E1F8E3E063D5EA1C_GET_CHENLINGDAYCOUNTSBYPHASE_OFFSET UNITYSDK_OFFSET(0x15E06B40)
#define CLASS_1_E1F8E3E063D5EA1C_GET_CURRENTGAMEDAYINDEX_OFFSET UNITYSDK_OFFSET(0x15E06B80)
#define CLASS_1_E1F8E3E063D5EA1C_GET_CURRENTGAMEDAYSTATE_OFFSET UNITYSDK_OFFSET(0x15E06BA0)
#define CLASS_1_E1F8E3E063D5EA1C_GET_CURRENTGAMEWEEKINDEX_OFFSET UNITYSDK_OFFSET(0x15E06B60)
#define CLASS_1_E1F8E3E063D5EA1C_GET_ISENDLESSMODE_OFFSET UNITYSDK_OFFSET(0x15E06B20)
#define CLASS_1_E1F8E3E063D5EA1C_GET_LEVELDATA_OFFSET UNITYSDK_OFFSET(0x15E06B00)
#define CLASS_1_E1F8E3E063D5EA1C_GET_LEVELID_OFFSET UNITYSDK_OFFSET(0x15E06AE0)
#define CLASS_1_E1F8E3E063D5EA1C_GET_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x15E06BC0)
#define CLASS_1_E1F8E3E063D5EA1C_GET_ONRESTART_OFFSET UNITYSDK_OFFSET(0x15E06BE0)
#define CLASS_1_E1F8E3E063D5EA1C_SET_CHENLINGDAYCOUNTSBYPHASE_OFFSET UNITYSDK_OFFSET(0x15E06B50)
#define CLASS_1_E1F8E3E063D5EA1C_SET_CURRENTGAMEDAYINDEX_OFFSET UNITYSDK_OFFSET(0x15E06B90)
#define CLASS_1_E1F8E3E063D5EA1C_SET_CURRENTGAMEDAYSTATE_OFFSET UNITYSDK_OFFSET(0x15E06BB0)
#define CLASS_1_E1F8E3E063D5EA1C_SET_CURRENTGAMEWEEKINDEX_OFFSET UNITYSDK_OFFSET(0x15E06B70)
#define CLASS_1_E1F8E3E063D5EA1C_SET_ISENDLESSMODE_OFFSET UNITYSDK_OFFSET(0x15E06B30)
#define CLASS_1_E1F8E3E063D5EA1C_SET_LEVELDATA_OFFSET UNITYSDK_OFFSET(0x15E06B10)
#define CLASS_1_E1F8E3E063D5EA1C_SET_LEVELID_OFFSET UNITYSDK_OFFSET(0x15E06AF0)
#define CLASS_1_E1F8E3E063D5EA1C_SET_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x15E06BD0)
#define CLASS_1_E1F8E3E063D5EA1C_SET_ONRESTART_OFFSET UNITYSDK_OFFSET(0x15E06BF0)
#define CLASS_1_E1F8E3E063D5EA1C__CTOR_OFFSET UNITYSDK_OFFSET(0x15E06C00)

inline static constexpr unsigned int Class_1_E1F8E3E063D5EA1C_TypeDefinitionIndex = 74058;
...
public:
	...
	::System::Boolean _IsEndlessMode_k__BackingField; // 0x38
	::System::UInt32 _LevelID_k__BackingField; // 0x3C
	::System::Int32 _CurrentGameWeekIndex_k__BackingField; // 0x40
