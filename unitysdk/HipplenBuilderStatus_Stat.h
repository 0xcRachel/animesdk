...
#define HIPPLENBUILDERSTATUS_STAT_GET_GRADECONFIGS_OFFSET UNITYSDK_OFFSET(0x1054B1E0)
#define HIPPLENBUILDERSTATUS_STAT_GET_ISSHOW_OFFSET UNITYSDK_OFFSET(0x1054B1C0)
#define HIPPLENBUILDERSTATUS_STAT_GET_NAMENEG_OFFSET UNITYSDK_OFFSET(0x1054AFE0)
#define HIPPLENBUILDERSTATUS_STAT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1054AFC0)
#define HIPPLENBUILDERSTATUS_STAT_GET_NEXTGRADEMIN_OFFSET UNITYSDK_OFFSET(0x1054B020)
#define HIPPLENBUILDERSTATUS_STAT_GET_NORMALIZEDVALUE_OFFSET UNITYSDK_OFFSET(0x1054B200)
#define HIPPLENBUILDERSTATUS_STAT_GET_RANGE_OFFSET UNITYSDK_OFFSET(0x1054B000)
#define HIPPLENBUILDERSTATUS_STAT_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1054A680)
#define HIPPLENBUILDERSTATUS_STAT_GET_WARNINGVALUE_OFFSET UNITYSDK_OFFSET(0x1054B1A0)
#define HIPPLENBUILDERSTATUS_STAT_METHOD_1_353DAAE369AAEE14_OFFSET UNITYSDK_OFFSET(0x1054A6A0)
#define HIPPLENBUILDERSTATUS_STAT_METHOD_1_4F2DF85F37DC818F_OFFSET UNITYSDK_OFFSET(0x1054B030)
#define HIPPLENBUILDERSTATUS_STAT_METHOD_1_E0BE53945D089B15_OFFSET UNITYSDK_OFFSET(0x1054AD00)
#define HIPPLENBUILDERSTATUS_STAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1054A660)

inline static constexpr unsigned int HipplenBuilderStatus_Stat_TypeDefinitionIndex = 37153;
