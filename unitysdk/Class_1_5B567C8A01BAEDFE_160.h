...
#define CLASS_1_5B567C8A01BAEDFE_160_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A1CC8A0)
#define CLASS_1_5B567C8A01BAEDFE_160_CLONE_OFFSET UNITYSDK_OFFSET(0x1A1CC6B0)
#define CLASS_1_5B567C8A01BAEDFE_160_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A1CC7B0)
#define CLASS_1_5B567C8A01BAEDFE_160_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A1CC720)
#define CLASS_1_5B567C8A01BAEDFE_160_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A1CC800)
#define CLASS_1_5B567C8A01BAEDFE_160_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A1CC8F0)
#define CLASS_1_5B567C8A01BAEDFE_160_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A1CC8C0)
#define CLASS_1_5B567C8A01BAEDFE_160_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A1CC600)
#define CLASS_1_5B567C8A01BAEDFE_160_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A1CC660)
#define CLASS_1_5B567C8A01BAEDFE_160_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A1CC830)
#define CLASS_1_5B567C8A01BAEDFE_160_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A1CC890)
#define CLASS_1_5B567C8A01BAEDFE_160__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1CC940)
#define CLASS_1_5B567C8A01BAEDFE_160__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A1CC680)
#define CLASS_1_5B567C8A01BAEDFE_160__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1CC670)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_160*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_160_TypeDefinitionIndex)->GetStaticField(0x5E750);
	}
