...
#define CLASS_1_5B567C8A01BAEDFE_160_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A2006C0)
#define CLASS_1_5B567C8A01BAEDFE_160_CLONE_OFFSET UNITYSDK_OFFSET(0x1A2004D0)
#define CLASS_1_5B567C8A01BAEDFE_160_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A2005D0)
#define CLASS_1_5B567C8A01BAEDFE_160_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A200540)
#define CLASS_1_5B567C8A01BAEDFE_160_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A200620)
#define CLASS_1_5B567C8A01BAEDFE_160_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A200710)
#define CLASS_1_5B567C8A01BAEDFE_160_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A2006E0)
#define CLASS_1_5B567C8A01BAEDFE_160_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A200420)
#define CLASS_1_5B567C8A01BAEDFE_160_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A200480)
#define CLASS_1_5B567C8A01BAEDFE_160_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A200650)
#define CLASS_1_5B567C8A01BAEDFE_160_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A2006B0)
#define CLASS_1_5B567C8A01BAEDFE_160__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A200760)
#define CLASS_1_5B567C8A01BAEDFE_160__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A2004A0)
#define CLASS_1_5B567C8A01BAEDFE_160__CTOR_OFFSET UNITYSDK_OFFSET(0x1A200490)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_160*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_160_TypeDefinitionIndex)->GetStaticField(0x17D20);
	}
