...
#define EFFECT_UVANIMATION_START_OFFSET UNITYSDK_OFFSET(0x13BAB480)
#define EFFECT_UVANIMATION_UPDATE_OFFSET UNITYSDK_OFFSET(0x13BAB550)
#define EFFECT_UVANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x13BAB6E0)
