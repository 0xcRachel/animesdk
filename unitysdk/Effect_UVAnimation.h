...
#define EFFECT_UVANIMATION_START_OFFSET UNITYSDK_OFFSET(0xC31D350)
#define EFFECT_UVANIMATION_UPDATE_OFFSET UNITYSDK_OFFSET(0xC31D420)
#define EFFECT_UVANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0xC31D5B0)
