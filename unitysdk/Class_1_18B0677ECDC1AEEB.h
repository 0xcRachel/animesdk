...
#define CLASS_1_18B0677ECDC1AEEB_DOFAILED_OFFSET UNITYSDK_OFFSET(0xFFA3A90)
#define CLASS_1_18B0677ECDC1AEEB_DOSUCCEED_OFFSET UNITYSDK_OFFSET(0xFFA3A50)
#define CLASS_1_18B0677ECDC1AEEB_EXECUTE_OFFSET UNITYSDK_OFFSET(0xFFA3A10)
#define CLASS_1_18B0677ECDC1AEEB_GETTYPENAME_OFFSET UNITYSDK_OFFSET(0xFFA37C0)
#define CLASS_1_18B0677ECDC1AEEB_GET_ACTIONSYSTEM_OFFSET UNITYSDK_OFFSET(0xFFA3860)
#define CLASS_1_18B0677ECDC1AEEB_GET_FAILURECOUNT_OFFSET UNITYSDK_OFFSET(0xFFA3840)
#define CLASS_1_18B0677ECDC1AEEB_GET_FINISHCOUNT_OFFSET UNITYSDK_OFFSET(0xFFA3850)
#define CLASS_1_18B0677ECDC1AEEB_GET_ID_OFFSET UNITYSDK_OFFSET(0xFFA3810)
#define CLASS_1_18B0677ECDC1AEEB_GET_ONDATAFAILED_OFFSET UNITYSDK_OFFSET(0xFFA3910)
#define CLASS_1_18B0677ECDC1AEEB_GET_ONDATASTARTING_OFFSET UNITYSDK_OFFSET(0xFFA38D0)
#define CLASS_1_18B0677ECDC1AEEB_GET_ONDATASUCCEED_OFFSET UNITYSDK_OFFSET(0xFFA38F0)
#define CLASS_1_18B0677ECDC1AEEB_GET_ONFAILED_OFFSET UNITYSDK_OFFSET(0xFFA3930)
#define CLASS_1_18B0677ECDC1AEEB_GET_ONFINISH_OFFSET UNITYSDK_OFFSET(0xFFA3950)
#define CLASS_1_18B0677ECDC1AEEB_GET_ONITEMFAILED_OFFSET UNITYSDK_OFFSET(0xFFA39B0)
#define CLASS_1_18B0677ECDC1AEEB_GET_ONITEMSTARTING_OFFSET UNITYSDK_OFFSET(0xFFA3970)
#define CLASS_1_18B0677ECDC1AEEB_GET_ONITEMSUCCEED_OFFSET UNITYSDK_OFFSET(0xFFA3990)
#define CLASS_1_18B0677ECDC1AEEB_GET_ONSTARTING_OFFSET UNITYSDK_OFFSET(0xFFA3890)
#define CLASS_1_18B0677ECDC1AEEB_GET_ONSUCCEED_OFFSET UNITYSDK_OFFSET(0xFFA38B0)
#define CLASS_1_18B0677ECDC1AEEB_GET_ROOTQUEUE_OFFSET UNITYSDK_OFFSET(0xFFA3870)
#define CLASS_1_18B0677ECDC1AEEB_GET_SUCCESSCOUNT_OFFSET UNITYSDK_OFFSET(0xFFA3830)
#define CLASS_1_18B0677ECDC1AEEB_GET_TOTALCOUNT_OFFSET UNITYSDK_OFFSET(0xFFA3820)
#define CLASS_1_18B0677ECDC1AEEB_METHOD_1_14AF5D956E81774A_OFFSET UNITYSDK_OFFSET(0xFFA5020)
#define CLASS_1_18B0677ECDC1AEEB_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0xFFA3AE0)
#define CLASS_1_18B0677ECDC1AEEB_METHOD_1_2C61108A8DA0AD73_OFFSET UNITYSDK_OFFSET(0xFFA3E40)
#define CLASS_1_18B0677ECDC1AEEB_METHOD_1_39AB6BE86BE284EE_OFFSET UNITYSDK_OFFSET(0xFFA4200)
#define CLASS_1_18B0677ECDC1AEEB_METHOD_1_3B018C5CF15BCDF6_OFFSET UNITYSDK_OFFSET(0xFFA43A0)
#define CLASS_1_18B0677ECDC1AEEB_METHOD_1_494D7FA4CA2316AD_OFFSET UNITYSDK_OFFSET(0xFFA3F00)
#define CLASS_1_18B0677ECDC1AEEB_METHOD_1_6287ACD5750B69E7_OFFSET UNITYSDK_OFFSET(0xFFA41B0)
#define CLASS_1_18B0677ECDC1AEEB_METHOD_1_7E9C4D81D04C3024_OFFSET UNITYSDK_OFFSET(0xFFA4F00)
#define CLASS_1_18B0677ECDC1AEEB_METHOD_1_9DB2C80C0CD4760B_OFFSET UNITYSDK_OFFSET(0xFFA3DC0)
#define CLASS_1_18B0677ECDC1AEEB_METHOD_1_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0xFFA4BD0)
#define CLASS_1_18B0677ECDC1AEEB_METHOD_1_C6E14CE377D03CE0_OFFSET UNITYSDK_OFFSET(0xFFA3FC0)
#define CLASS_1_18B0677ECDC1AEEB_METHOD_1_D0663CE240A6DAF4_OFFSET UNITYSDK_OFFSET(0xFFA3EB0)
#define CLASS_1_18B0677ECDC1AEEB_METHOD_1_DCAED9AAC7431412_OFFSET UNITYSDK_OFFSET(0xFFA42D0)
#define CLASS_1_18B0677ECDC1AEEB_METHOD_1_EB7112936E778817_OFFSET UNITYSDK_OFFSET(0xFFA4040)
#define CLASS_1_18B0677ECDC1AEEB_SET_ONDATAFAILED_OFFSET UNITYSDK_OFFSET(0xFFA3920)
#define CLASS_1_18B0677ECDC1AEEB_SET_ONDATASTARTING_OFFSET UNITYSDK_OFFSET(0xFFA38E0)
#define CLASS_1_18B0677ECDC1AEEB_SET_ONDATASUCCEED_OFFSET UNITYSDK_OFFSET(0xFFA3900)
#define CLASS_1_18B0677ECDC1AEEB_SET_ONFAILED_OFFSET UNITYSDK_OFFSET(0xFFA3940)
#define CLASS_1_18B0677ECDC1AEEB_SET_ONFINISH_OFFSET UNITYSDK_OFFSET(0xFFA3960)
#define CLASS_1_18B0677ECDC1AEEB_SET_ONITEMFAILED_OFFSET UNITYSDK_OFFSET(0xFFA39C0)
#define CLASS_1_18B0677ECDC1AEEB_SET_ONITEMSTARTING_OFFSET UNITYSDK_OFFSET(0xFFA3980)
#define CLASS_1_18B0677ECDC1AEEB_SET_ONITEMSUCCEED_OFFSET UNITYSDK_OFFSET(0xFFA39A0)
#define CLASS_1_18B0677ECDC1AEEB_SET_ONSTARTING_OFFSET UNITYSDK_OFFSET(0xFFA38A0)
#define CLASS_1_18B0677ECDC1AEEB_SET_ONSUCCEED_OFFSET UNITYSDK_OFFSET(0xFFA38C0)
#define CLASS_1_18B0677ECDC1AEEB_SET_ROOTQUEUE_OFFSET UNITYSDK_OFFSET(0xFFA3880)
#define CLASS_1_18B0677ECDC1AEEB_UPDATEPROGRESS_OFFSET UNITYSDK_OFFSET(0xFFA39D0)
#define CLASS_1_18B0677ECDC1AEEB__ADDERRORLOG_B__89_0_OFFSET UNITYSDK_OFFSET(0xFFA5E80)
#define CLASS_1_18B0677ECDC1AEEB__ADDPROGRESSLOG_B__90_0_OFFSET UNITYSDK_OFFSET(0xFFA6DE0)
#define CLASS_1_18B0677ECDC1AEEB__ADDPROGRESSLOG_B__90_1_OFFSET UNITYSDK_OFFSET(0xFFA6DF0)
#define CLASS_1_18B0677ECDC1AEEB__ADDPROGRESSLOG_B__90_2_OFFSET UNITYSDK_OFFSET(0xFFA7A20)
#define CLASS_1_18B0677ECDC1AEEB__ADDPROGRESSLOG_B__90_3_OFFSET UNITYSDK_OFFSET(0xFFA8F10)
#define CLASS_1_18B0677ECDC1AEEB__ADDPROGRESSLOG_B__90_4_OFFSET UNITYSDK_OFFSET(0xFFA91F0)
#define CLASS_1_18B0677ECDC1AEEB__CTOR_OFFSET UNITYSDK_OFFSET(0xFFA3B50)
...
{
public:
	::RPG::Client::ActionEvent_2<::Class_0_16E4307DCC419505_557*, ::Class_0_16E4307DCC419505_559*>* _OnDataSucceed_k__BackingField; // 0x10
	::System::String* Field_1_16; // 0x18
	::RPG::Client::ActionEvent_3<::Class_0_16E4307DCC419505_557*, ::Class_0_16E4307DCC419505_559*, ::System::Object*>* _OnItemStarting_k__BackingField; // 0x20
	::RPG::Client::ActionEvent_1<::Class_2_2690241A4D35989E*>* _OnFailed_k__BackingField; // 0x28
	::Class_1_C530CE1C0A4E2133* Field_1_1; // 0x30
	::RPG::Client::ActionEvent_2<::Class_0_16E4307DCC419505_557*, ::Class_0_16E4307DCC419505_559*>* _OnDataStarting_k__BackingField; // 0x38
	::RPG::Client::ActionEvent_1<::Class_0_16E4307DCC419505_557*>* _OnStarting_k__BackingField; // 0x40
	::RPG::Client::ActionEvent_3<::Class_0_16E4307DCC419505_557*, ::Class_0_16E4307DCC419505_559*, ::System::Object*>* _OnItemSucceed_k__BackingField; // 0x48
	::Class_1_C530CE1C0A4E2133* Field_1_2; // 0x50
	::System::String* Field_1_19; // 0x58
	::Class_1_C530CE1C0A4E2133* Field_1_5; // 0x60
	::Class_1_C530CE1C0A4E2133* Field_1_3; // 0x68
	::RPG::Client::ActionEvent_1<::Class_2_2690241A4D35989E*>* _OnDataFailed_k__BackingField; // 0x70
	::Class_1_C530CE1C0A4E2133* Field_1_4; // 0x78
	::RPG::Client::ActionEvent_4<::Class_0_16E4307DCC419505_557*, ::Class_0_16E4307DCC419505_559*, ::System::Object*, ::RPG::Client::ExeCode>* _OnFinish_k__BackingField; // 0x80
	::RPG::Client::ActionEvent_1<::Class_2_2690241A4D35989E*>* _OnItemFailed_k__BackingField; // 0x88
	::Class_1_8C3AC9786B6764EF* _RootQueue_k__BackingField; // 0x90
	::RPG::Client::ActionEvent_1<::Class_0_16E4307DCC419505_557*>* _OnSucceed_k__BackingField; // 0x98
