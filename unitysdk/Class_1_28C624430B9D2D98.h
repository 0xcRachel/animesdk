...
#define CLASS_1_28C624430B9D2D98__CTOR_OFFSET UNITYSDK_OFFSET(0xACC7650)
...
public:
	...
	::RPG::GameCore::ModifierBehaviorFlagEventType Field_1_0; // 0x18
	::RPG::GameCore::ModifierBehaviorFlag Field_1_1; // 0x1C
