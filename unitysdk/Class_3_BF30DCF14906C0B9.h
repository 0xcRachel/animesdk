...
#define CLASS_3_BF30DCF14906C0B9_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xC5E2460)
#define CLASS_3_BF30DCF14906C0B9_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xC5E24E0)
#define CLASS_3_BF30DCF14906C0B9_INVOKE_OFFSET UNITYSDK_OFFSET(0xC5E20F0)
#define CLASS_3_BF30DCF14906C0B9__CTOR_OFFSET UNITYSDK_OFFSET(0xC5E20D0)

inline static constexpr unsigned int Class_3_BF30DCF14906C0B9_TypeDefinitionIndex = 67624;
