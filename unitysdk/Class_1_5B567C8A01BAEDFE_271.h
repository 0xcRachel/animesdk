...
#define CLASS_1_5B567C8A01BAEDFE_271_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A0A7420)
#define CLASS_1_5B567C8A01BAEDFE_271_CLONE_OFFSET UNITYSDK_OFFSET(0x1A0A7230)
#define CLASS_1_5B567C8A01BAEDFE_271_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A0A7330)
#define CLASS_1_5B567C8A01BAEDFE_271_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A0A72A0)
#define CLASS_1_5B567C8A01BAEDFE_271_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A0A7380)
#define CLASS_1_5B567C8A01BAEDFE_271_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A0A7470)
#define CLASS_1_5B567C8A01BAEDFE_271_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A0A7440)
#define CLASS_1_5B567C8A01BAEDFE_271_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A0A7180)
#define CLASS_1_5B567C8A01BAEDFE_271_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A0A71E0)
#define CLASS_1_5B567C8A01BAEDFE_271_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A0A73B0)
#define CLASS_1_5B567C8A01BAEDFE_271_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A0A7410)
#define CLASS_1_5B567C8A01BAEDFE_271__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A0A74C0)
#define CLASS_1_5B567C8A01BAEDFE_271__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0A7200)
#define CLASS_1_5B567C8A01BAEDFE_271__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0A71F0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_271*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_271_TypeDefinitionIndex)->GetStaticField(0x1EFD0);
	}
