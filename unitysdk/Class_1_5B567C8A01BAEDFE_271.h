...
#define CLASS_1_5B567C8A01BAEDFE_271_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1B05AF00)
#define CLASS_1_5B567C8A01BAEDFE_271_CLONE_OFFSET UNITYSDK_OFFSET(0x1B05AD70)
#define CLASS_1_5B567C8A01BAEDFE_271_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1B05AE10)
#define CLASS_1_5B567C8A01BAEDFE_271_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B05ADB0)
#define CLASS_1_5B567C8A01BAEDFE_271_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B05AE60)
#define CLASS_1_5B567C8A01BAEDFE_271_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1B05AF50)
#define CLASS_1_5B567C8A01BAEDFE_271_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1B05AF20)
#define CLASS_1_5B567C8A01BAEDFE_271_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1B05ACF0)
#define CLASS_1_5B567C8A01BAEDFE_271_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1B05AD20)
#define CLASS_1_5B567C8A01BAEDFE_271_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B05AE90)
#define CLASS_1_5B567C8A01BAEDFE_271_WRITETO_OFFSET UNITYSDK_OFFSET(0x1B05AEF0)
#define CLASS_1_5B567C8A01BAEDFE_271__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B05AFA0)
#define CLASS_1_5B567C8A01BAEDFE_271__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B05AD40)
#define CLASS_1_5B567C8A01BAEDFE_271__CTOR_OFFSET UNITYSDK_OFFSET(0x1B05AD30)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_271*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_271_TypeDefinitionIndex)->GetStaticField(0x61F70);
	}
