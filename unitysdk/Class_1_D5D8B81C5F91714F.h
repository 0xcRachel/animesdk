...
#define CLASS_1_D5D8B81C5F91714F_DISPOSE_OFFSET UNITYSDK_OFFSET(0x172E9C00)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_0C684A75C783EBC5_OFFSET UNITYSDK_OFFSET(0x172EAEE0)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_0E46DC8C385F3B19_OFFSET UNITYSDK_OFFSET(0x172EB160)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_1E2F1551644E6AD0_OFFSET UNITYSDK_OFFSET(0x172EAC00)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_40E490E2772D5D75_OFFSET UNITYSDK_OFFSET(0x172EA8B0)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_4307B2A4B4A12C1A_1_OFFSET UNITYSDK_OFFSET(0x172EA9C0)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x172EA910)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_540DB5DAE524BF3C_OFFSET UNITYSDK_OFFSET(0x172EB100)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_6DB361889C24FBD3_OFFSET UNITYSDK_OFFSET(0x172EA710)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_96423E189D7E47C7_OFFSET UNITYSDK_OFFSET(0x172EA5F0)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_A0C3C8FB5CF273C4_OFFSET UNITYSDK_OFFSET(0x172EA070)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_B877181B6123B7F6_OFFSET UNITYSDK_OFFSET(0x172E9E00)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_C120627FFC990F63_OFFSET UNITYSDK_OFFSET(0x172EAA70)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_CDD5ADAE43D40A5C_OFFSET UNITYSDK_OFFSET(0x172EA150)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_D219743A444E7E38_OFFSET UNITYSDK_OFFSET(0x172EA290)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_EC90937CEA9AFCA9_OFFSET UNITYSDK_OFFSET(0x172EA3F0)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_F211F18433CEAF48_OFFSET UNITYSDK_OFFSET(0x172EA800)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_F75084EC8D457B45_1_OFFSET UNITYSDK_OFFSET(0x172EAB00)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_F75084EC8D457B45_OFFSET UNITYSDK_OFFSET(0x172EA4F0)
#define CLASS_1_D5D8B81C5F91714F__CCTOR_OFFSET UNITYSDK_OFFSET(0x172EB170)
#define CLASS_1_D5D8B81C5F91714F__CTOR_OFFSET UNITYSDK_OFFSET(0x172E9AE0)

inline static constexpr unsigned int Class_1_D5D8B81C5F91714F_TypeDefinitionIndex = 73058;
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_D5D8B81C5F91714F_TypeDefinitionIndex)->GetStaticField(0x11E70);
	}
	::System::String* Field_1_1; // 0x10
	::Il2CppArray<::RPG::Client::Prop::DestroyRootPuzzleChess*>* Field_1_2; // 0x18
	::UnityEngine::Transform* Field_1_3; // 0x20
	::RPG::Client::Prop::DestroyRootPuzzleBoard* Field_1_4; // 0x28
	::System::Collections::Generic::List_1<::RPG::Client::Prop::DestroyRootPuzzleChess*>* Field_1_5; // 0x30
