...
#define CLASS_2_DEB01BD38C12C6AF_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17F2A860)
#define CLASS_2_DEB01BD38C12C6AF_METHOD_2_7DD84EAFF333A1E4_OFFSET UNITYSDK_OFFSET(0x17F2AA00)
#define CLASS_2_DEB01BD38C12C6AF_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17F2A8F0)
#define CLASS_2_DEB01BD38C12C6AF_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x17F2A950)
#define CLASS_2_DEB01BD38C12C6AF_TICK_OFFSET UNITYSDK_OFFSET(0x17F2A9A0)
#define CLASS_2_DEB01BD38C12C6AF__CTOR_OFFSET UNITYSDK_OFFSET(0x17F2A7D0)
