...
#define CLASS_1_892D0C453642AC9C_DISPOSE_OFFSET UNITYSDK_OFFSET(0x102D80A0)
#define CLASS_1_892D0C453642AC9C_GET_BEGINPOSITION_OFFSET UNITYSDK_OFFSET(0x102D8BF0)
#define CLASS_1_892D0C453642AC9C_GET_DESTINATIONPOSITION_OFFSET UNITYSDK_OFFSET(0x102D8C10)
#define CLASS_1_892D0C453642AC9C_METHOD_1_561A73CC360FE0AB_OFFSET UNITYSDK_OFFSET(0x102D81B0)
#define CLASS_1_892D0C453642AC9C_METHOD_1_59FB090BEA43C095_OFFSET UNITYSDK_OFFSET(0x102D8AF0)
#define CLASS_1_892D0C453642AC9C_METHOD_1_8599237FE4129E81_OFFSET UNITYSDK_OFFSET(0x102D85B0)
#define CLASS_1_892D0C453642AC9C_METHOD_1_A51E2774D1B55326_OFFSET UNITYSDK_OFFSET(0x102D88B0)
#define CLASS_1_892D0C453642AC9C_METHOD_1_BB97A48D5BCE3F55_OFFSET UNITYSDK_OFFSET(0x102D8470)
#define CLASS_1_892D0C453642AC9C_METHOD_1_E11AC65AA0DC2249_OFFSET UNITYSDK_OFFSET(0x102D82B0)
#define CLASS_1_892D0C453642AC9C_METHOD_1_F17676F976AEF1D8_OFFSET UNITYSDK_OFFSET(0x102D8950)
#define CLASS_1_892D0C453642AC9C_SET_BEGINPOSITION_OFFSET UNITYSDK_OFFSET(0x102D8C00)
#define CLASS_1_892D0C453642AC9C_SET_DESTINATIONPOSITION_OFFSET UNITYSDK_OFFSET(0x102D8C20)
#define CLASS_1_892D0C453642AC9C__CCTOR_OFFSET UNITYSDK_OFFSET(0x102D8C30)
#define CLASS_1_892D0C453642AC9C__CTOR_OFFSET UNITYSDK_OFFSET(0x102D80F0)

inline static constexpr unsigned int Class_1_892D0C453642AC9C_TypeDefinitionIndex = 72014;
...
public:
	...
	{
		return (::UnityEngine::Vector2Int*)Il2CppClass::FromTypeDefinitionIndex(Class_1_892D0C453642AC9C_TypeDefinitionIndex)->GetStaticField(0x6770);
	}
	static ::UnityEngine::Vector2Int* StaticGet_Field_1_9()
	{
		return (::UnityEngine::Vector2Int*)Il2CppClass::FromTypeDefinitionIndex(Class_1_892D0C453642AC9C_TypeDefinitionIndex)->GetStaticField(0x6778);
	}
	static ::UnityEngine::Vector2Int* StaticGet_Field_1_10()
	{
		return (::UnityEngine::Vector2Int*)Il2CppClass::FromTypeDefinitionIndex(Class_1_892D0C453642AC9C_TypeDefinitionIndex)->GetStaticField(0x6780);
	}
	static ::UnityEngine::Vector2Int* StaticGet_Field_1_8()
	{
		return (::UnityEngine::Vector2Int*)Il2CppClass::FromTypeDefinitionIndex(Class_1_892D0C453642AC9C_TypeDefinitionIndex)->GetStaticField(0x6788);
	}
	...
	::UnityEngine::Vector2Int _BeginPosition_k__BackingField; // 0x34
