...
#define CLASS_1_5B567C8A01BAEDFE_124_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x198B0A90)
#define CLASS_1_5B567C8A01BAEDFE_124_CLONE_OFFSET UNITYSDK_OFFSET(0x198B08A0)
#define CLASS_1_5B567C8A01BAEDFE_124_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x198B09A0)
#define CLASS_1_5B567C8A01BAEDFE_124_EQUALS_OFFSET UNITYSDK_OFFSET(0x198B0910)
#define CLASS_1_5B567C8A01BAEDFE_124_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x198B09F0)
#define CLASS_1_5B567C8A01BAEDFE_124_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x198B0AE0)
#define CLASS_1_5B567C8A01BAEDFE_124_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x198B0AB0)
#define CLASS_1_5B567C8A01BAEDFE_124_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x198B07F0)
#define CLASS_1_5B567C8A01BAEDFE_124_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x198B0850)
#define CLASS_1_5B567C8A01BAEDFE_124_TOSTRING_OFFSET UNITYSDK_OFFSET(0x198B0A20)
#define CLASS_1_5B567C8A01BAEDFE_124_WRITETO_OFFSET UNITYSDK_OFFSET(0x198B0A80)
#define CLASS_1_5B567C8A01BAEDFE_124__CCTOR_OFFSET UNITYSDK_OFFSET(0x198B0B30)
#define CLASS_1_5B567C8A01BAEDFE_124__CTOR_1_OFFSET UNITYSDK_OFFSET(0x198B0870)
#define CLASS_1_5B567C8A01BAEDFE_124__CTOR_OFFSET UNITYSDK_OFFSET(0x198B0860)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_124*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_124_TypeDefinitionIndex)->GetStaticField(0x4D470);
	}
