...
#define STRUCT_2_348CBB7ABE9A08CE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x878130)
#define STRUCT_2_348CBB7ABE9A08CE_EQUALS_OFFSET UNITYSDK_OFFSET(0x8780D0)
#define STRUCT_2_348CBB7ABE9A08CE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x878140)
#define STRUCT_2_348CBB7ABE9A08CE_GET_INSTANCEID_OFFSET UNITYSDK_OFFSET(0x608600)
#define STRUCT_2_348CBB7ABE9A08CE_GET_INSTANCETYPE_OFFSET UNITYSDK_OFFSET(0x608A20)
#define STRUCT_2_348CBB7ABE9A08CE_METHOD_2_502C0C74DDECD92A_1_OFFSET UNITYSDK_OFFSET(0xB06A860)
#define STRUCT_2_348CBB7ABE9A08CE_METHOD_2_502C0C74DDECD92A_OFFSET UNITYSDK_OFFSET(0xB06A7E0)
#define STRUCT_2_348CBB7ABE9A08CE__CTOR_OFFSET UNITYSDK_OFFSET(0x6179C0)
#define STRUCT_2_348CBB7ABE9A08CE___IFIXBASEPROXY_EQUALS_OFFSET UNITYSDK_OFFSET(0x878150)
#define STRUCT_2_348CBB7ABE9A08CE___IFIXBASEPROXY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8781B0)
