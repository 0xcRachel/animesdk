...
#define STRUCT_2_348CBB7ABE9A08CE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x13EDAC0)
#define STRUCT_2_348CBB7ABE9A08CE_EQUALS_OFFSET UNITYSDK_OFFSET(0x13EDA60)
#define STRUCT_2_348CBB7ABE9A08CE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x13EDAD0)
#define STRUCT_2_348CBB7ABE9A08CE_GET_INSTANCEID_OFFSET UNITYSDK_OFFSET(0x1DAE0)
#define STRUCT_2_348CBB7ABE9A08CE_GET_INSTANCETYPE_OFFSET UNITYSDK_OFFSET(0x59D0)
#define STRUCT_2_348CBB7ABE9A08CE_METHOD_2_502C0C74DDECD92A_1_OFFSET UNITYSDK_OFFSET(0xFDAE720)
#define STRUCT_2_348CBB7ABE9A08CE_METHOD_2_502C0C74DDECD92A_OFFSET UNITYSDK_OFFSET(0xFDAE6A0)
#define STRUCT_2_348CBB7ABE9A08CE__CTOR_OFFSET UNITYSDK_OFFSET(0x74250)
#define STRUCT_2_348CBB7ABE9A08CE___IFIXBASEPROXY_EQUALS_OFFSET UNITYSDK_OFFSET(0x13EDAE0)
#define STRUCT_2_348CBB7ABE9A08CE___IFIXBASEPROXY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x13EDB40)

inline static constexpr unsigned int Struct_2_348CBB7ABE9A08CE_TypeDefinitionIndex = 40895;
