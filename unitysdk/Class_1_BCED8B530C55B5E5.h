...
#define CLASS_1_BCED8B530C55B5E5_GET_AVATARROWDATAPROVIDER_OFFSET UNITYSDK_OFFSET(0x105014E0)
#define CLASS_1_BCED8B530C55B5E5_GET_PROTOTYPE_OFFSET UNITYSDK_OFFSET(0x105014C0)
#define CLASS_1_BCED8B530C55B5E5_SET_AVATARROWDATAPROVIDER_OFFSET UNITYSDK_OFFSET(0x105014F0)
#define CLASS_1_BCED8B530C55B5E5_SET_PROTOTYPE_OFFSET UNITYSDK_OFFSET(0x105014D0)
#define CLASS_1_BCED8B530C55B5E5__CTOR_OFFSET UNITYSDK_OFFSET(0x10501500)
...
{
public:
	::Class_1_16D8E68BCE885505* _Prototype_k__BackingField; // 0x10
	::Class_0_16E4307DCC419505_363* _AvatarRowDataProvider_k__BackingField; // 0x18
