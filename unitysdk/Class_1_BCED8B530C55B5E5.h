...
#define CLASS_1_BCED8B530C55B5E5_GET_AVATARROWDATAPROVIDER_OFFSET UNITYSDK_OFFSET(0x10B420B0)
#define CLASS_1_BCED8B530C55B5E5_GET_PROTOTYPE_OFFSET UNITYSDK_OFFSET(0x10B42090)
#define CLASS_1_BCED8B530C55B5E5_SET_AVATARROWDATAPROVIDER_OFFSET UNITYSDK_OFFSET(0x10B420C0)
#define CLASS_1_BCED8B530C55B5E5_SET_PROTOTYPE_OFFSET UNITYSDK_OFFSET(0x10B420A0)
#define CLASS_1_BCED8B530C55B5E5__CTOR_OFFSET UNITYSDK_OFFSET(0x10B420D0)
...
public:
	...
	::Class_0_16E4307DCC419505_356* _AvatarRowDataProvider_k__BackingField; // 0x18
