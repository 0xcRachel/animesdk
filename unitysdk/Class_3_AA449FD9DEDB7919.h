...
#define CLASS_3_AA449FD9DEDB7919_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x118AA2A0)
#define CLASS_3_AA449FD9DEDB7919_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x118AA2D0)
#define CLASS_3_AA449FD9DEDB7919_INVOKE_OFFSET UNITYSDK_OFFSET(0x118A9D40)
#define CLASS_3_AA449FD9DEDB7919__CTOR_OFFSET UNITYSDK_OFFSET(0x118A9D20)

inline static constexpr unsigned int Class_3_AA449FD9DEDB7919_TypeDefinitionIndex = 68181;
