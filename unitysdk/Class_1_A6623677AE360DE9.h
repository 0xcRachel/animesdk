...
#define CLASS_1_A6623677AE360DE9_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19DF6B20)
#define CLASS_1_A6623677AE360DE9_CLONE_OFFSET UNITYSDK_OFFSET(0x19DF6710)
#define CLASS_1_A6623677AE360DE9_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19DF6840)
#define CLASS_1_A6623677AE360DE9_EQUALS_OFFSET UNITYSDK_OFFSET(0x19DF6790)
#define CLASS_1_A6623677AE360DE9_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19DF68E0)
#define CLASS_1_A6623677AE360DE9_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19DF6C70)
#define CLASS_1_A6623677AE360DE9_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19DF6C10)
#define CLASS_1_A6623677AE360DE9_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x19DF6750)
#define CLASS_1_A6623677AE360DE9_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x19DF6740)
#define CLASS_1_A6623677AE360DE9_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19DF65F0)
#define CLASS_1_A6623677AE360DE9_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x19DF6760)
#define CLASS_1_A6623677AE360DE9_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x19DF6780)
#define CLASS_1_A6623677AE360DE9_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x19DF6770)
#define CLASS_1_A6623677AE360DE9_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19DF6620)
#define CLASS_1_A6623677AE360DE9_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19DF69F0)
#define CLASS_1_A6623677AE360DE9_WRITETO_OFFSET UNITYSDK_OFFSET(0x19DF6A50)
#define CLASS_1_A6623677AE360DE9__CCTOR_OFFSET UNITYSDK_OFFSET(0x19DF6D60)
#define CLASS_1_A6623677AE360DE9__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19DF6680)
#define CLASS_1_A6623677AE360DE9__CTOR_OFFSET UNITYSDK_OFFSET(0x19DF6630)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_A6623677AE360DE9*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A6623677AE360DE9_TypeDefinitionIndex)->GetStaticField(0x4C770);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_3()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A6623677AE360DE9_TypeDefinitionIndex)->GetStaticField(0x4C778);
	}
