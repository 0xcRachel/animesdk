...
#define SCENEARTPREFABEXPORTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA6819F0)

inline static constexpr unsigned int SceneArtPrefabExportConfig_TypeDefinitionIndex = 37405;
