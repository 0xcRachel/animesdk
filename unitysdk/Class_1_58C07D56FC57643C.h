...
#define CLASS_1_58C07D56FC57643C__CTOR_OFFSET UNITYSDK_OFFSET(0x84D2DE0)

inline static constexpr unsigned int Class_1_58C07D56FC57643C_TypeDefinitionIndex = 55501;

class Class_1_58C07D56FC57643C : public ::System::Object
{
public:
	::EnviromentSystem::EnviromentClip_OnEnvironmentClipLoadDelegate* Field_1_3; // 0x10
	::EnviromentSystem::EnviromentProfile* Field_1_0; // 0x18
	::RPG::GameCore::EnviromentControlPriority Field_1_1; // 0x20
