...
#define CLASS_2_9EADA6C8E34FD58E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x102C21C0)
#define CLASS_2_9EADA6C8E34FD58E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x102C2200)
#define CLASS_2_9EADA6C8E34FD58E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x102C2280)
#define CLASS_2_9EADA6C8E34FD58E_TICK_OFFSET UNITYSDK_OFFSET(0x102C22D0)
#define CLASS_2_9EADA6C8E34FD58E__CTOR_OFFSET UNITYSDK_OFFSET(0x102C21B0)
...
{
public:
	::RPG::GameCore::RetrySwordTrainingFinalBattle* Field_2_0; // 0x18
