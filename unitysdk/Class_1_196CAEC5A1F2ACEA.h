...
#define CLASS_1_196CAEC5A1F2ACEA_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x195B47F0)
#define CLASS_1_196CAEC5A1F2ACEA_CLONE_OFFSET UNITYSDK_OFFSET(0x195B4450)
#define CLASS_1_196CAEC5A1F2ACEA_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x195B4570)
#define CLASS_1_196CAEC5A1F2ACEA_EQUALS_OFFSET UNITYSDK_OFFSET(0x195B4510)
#define CLASS_1_196CAEC5A1F2ACEA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x195B4660)
#define CLASS_1_196CAEC5A1F2ACEA_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x195B48F0)
#define CLASS_1_196CAEC5A1F2ACEA_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x195B48A0)
#define CLASS_1_196CAEC5A1F2ACEA_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x195B44D0)
#define CLASS_1_196CAEC5A1F2ACEA_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x195B4390)
#define CLASS_1_196CAEC5A1F2ACEA_METHOD_1_5323F2DF46A044DA_OFFSET UNITYSDK_OFFSET(0x195B44F0)
#define CLASS_1_196CAEC5A1F2ACEA_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x195B44E0)
#define CLASS_1_196CAEC5A1F2ACEA_METHOD_1_E7F1AECA7CFF8AAD_OFFSET UNITYSDK_OFFSET(0x195B4500)
#define CLASS_1_196CAEC5A1F2ACEA_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x195B43F0)
#define CLASS_1_196CAEC5A1F2ACEA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x195B4700)
#define CLASS_1_196CAEC5A1F2ACEA_WRITETO_OFFSET UNITYSDK_OFFSET(0x195B4760)
#define CLASS_1_196CAEC5A1F2ACEA__CCTOR_OFFSET UNITYSDK_OFFSET(0x195B4970)
#define CLASS_1_196CAEC5A1F2ACEA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x195B4410)
#define CLASS_1_196CAEC5A1F2ACEA__CTOR_OFFSET UNITYSDK_OFFSET(0x195B4400)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_196CAEC5A1F2ACEA*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_196CAEC5A1F2ACEA_TypeDefinitionIndex)->GetStaticField(0x17CB0);
	}
