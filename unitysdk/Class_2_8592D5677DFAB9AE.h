...
#define CLASS_2_8592D5677DFAB9AE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16C94D40)
#define CLASS_2_8592D5677DFAB9AE_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x16C94DE0)
#define CLASS_2_8592D5677DFAB9AE_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x16C94F80)
#define CLASS_2_8592D5677DFAB9AE_TICK_OFFSET UNITYSDK_OFFSET(0x16C94FD0)
#define CLASS_2_8592D5677DFAB9AE__CTOR_OFFSET UNITYSDK_OFFSET(0x16C94D00)
...
public:
	...
	::Class_1_A8AA94B0A861166B* Field_2_1; // 0x20
	::RPG::GameCore::MemoryVisionPuzzleInit* Field_2_2; // 0x28
