...
#define CLASS_1_728C80A2D475CC4E_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x180FA7F0)
#define CLASS_1_728C80A2D475CC4E_CLONE_OFFSET UNITYSDK_OFFSET(0x180FA3C0)
#define CLASS_1_728C80A2D475CC4E_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x180FA510)
#define CLASS_1_728C80A2D475CC4E_EQUALS_OFFSET UNITYSDK_OFFSET(0x180FA420)
#define CLASS_1_728C80A2D475CC4E_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x180FA5C0)
#define CLASS_1_728C80A2D475CC4E_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x180FA9C0)
#define CLASS_1_728C80A2D475CC4E_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x180FA920)
#define CLASS_1_728C80A2D475CC4E_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x180FA400)
#define CLASS_1_728C80A2D475CC4E_METHOD_1_4C96E9A31DDA1BDD_OFFSET UNITYSDK_OFFSET(0x180FA3F0)
#define CLASS_1_728C80A2D475CC4E_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x180FA410)
#define CLASS_1_728C80A2D475CC4E_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x180FA2E0)
#define CLASS_1_728C80A2D475CC4E_TOSTRING_OFFSET UNITYSDK_OFFSET(0x180FA6B0)
#define CLASS_1_728C80A2D475CC4E_WRITETO_OFFSET UNITYSDK_OFFSET(0x180FA710)
#define CLASS_1_728C80A2D475CC4E__CCTOR_OFFSET UNITYSDK_OFFSET(0x180FAA80)
#define CLASS_1_728C80A2D475CC4E__CTOR_1_OFFSET UNITYSDK_OFFSET(0x180FA330)
#define CLASS_1_728C80A2D475CC4E__CTOR_OFFSET UNITYSDK_OFFSET(0x180FA2F0)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Proto::PileItem*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_728C80A2D475CC4E_TypeDefinitionIndex)->GetStaticField(0x39100);
	}
