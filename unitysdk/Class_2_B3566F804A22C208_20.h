...
#define CLASS_2_B3566F804A22C208_20_LOCK_OFFSET UNITYSDK_OFFSET(0x8720720)
#define CLASS_2_B3566F804A22C208_20_UNLOCK_OFFSET UNITYSDK_OFFSET(0x87207E0)
#define CLASS_2_B3566F804A22C208_20__CTOR_OFFSET UNITYSDK_OFFSET(0x8720710)
#define CLASS_2_B3566F804A22C208_20___IFIXBASEPROXY_LOCK_OFFSET UNITYSDK_OFFSET(0x87208A0)
#define CLASS_2_B3566F804A22C208_20___IFIXBASEPROXY_UNLOCK_OFFSET UNITYSDK_OFFSET(0x8720910)

inline static constexpr unsigned int Class_2_B3566F804A22C208_20_TypeDefinitionIndex = 59747;
...
public:
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_262*>*))((::PBYTE)hIl2Cpp + CLASS_2_B3566F804A22C208_20__CTOR_OFFSET))(this, a1);
	}
