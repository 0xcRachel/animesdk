...
#define SCENELIGHTMANAGERCONFIGDATA_STAGEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA681AD0)

inline static constexpr unsigned int SceneLightManagerConfigData_StageData_TypeDefinitionIndex = 37288;
