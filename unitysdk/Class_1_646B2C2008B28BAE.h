...
#define CLASS_1_646B2C2008B28BAE_METHOD_1_08649C2797B37F9D_OFFSET UNITYSDK_OFFSET(0x16C1BE00)
#define CLASS_1_646B2C2008B28BAE_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x16C1BC20)
#define CLASS_1_646B2C2008B28BAE_METHOD_1_42C86F3F8CC5A3FB_OFFSET UNITYSDK_OFFSET(0x16C1B860)
#define CLASS_1_646B2C2008B28BAE_METHOD_1_663B4362EBA07144_OFFSET UNITYSDK_OFFSET(0x16C1BA10)
#define CLASS_1_646B2C2008B28BAE_METHOD_1_6B72D4EE8C6E907F_OFFSET UNITYSDK_OFFSET(0x16C1B5B0)
#define CLASS_1_646B2C2008B28BAE_METHOD_1_94653A00F0DB000A_OFFSET UNITYSDK_OFFSET(0x16C1BE50)
#define CLASS_1_646B2C2008B28BAE_METHOD_1_AD31DD9682084C83_OFFSET UNITYSDK_OFFSET(0x16C1BCC0)
#define CLASS_1_646B2C2008B28BAE_METHOD_1_CE34EA208837238D_OFFSET UNITYSDK_OFFSET(0x16C1B800)
#define CLASS_1_646B2C2008B28BAE_METHOD_1_F0E307B84478A272_OFFSET UNITYSDK_OFFSET(0x16C1BBE0)
#define CLASS_1_646B2C2008B28BAE_METHOD_1_F2E1599CBB58B20F_OFFSET UNITYSDK_OFFSET(0x16C1BD60)
#define CLASS_1_646B2C2008B28BAE_METHOD_1_FB00A707C6BD2346_OFFSET UNITYSDK_OFFSET(0x16C1B530)
#define CLASS_1_646B2C2008B28BAE__CCTOR_OFFSET UNITYSDK_OFFSET(0x16C1C1B0)

inline static constexpr unsigned int Class_1_646B2C2008B28BAE_TypeDefinitionIndex = 13366;
...
public:
	...
	{
		return (::System::Action_1<::Class_1_7A22A3DBEEDD1F80*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_646B2C2008B28BAE_TypeDefinitionIndex)->GetStaticField(0x29E40);
	}
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::RPG::GameCore::CommonIndexKey, ::RPG::GameCore::RogueAdventureRoomRow*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_646B2C2008B28BAE_TypeDefinitionIndex)->GetStaticField(0x29E48);
	}
	static ::Il2CppArray<::System::String*>** StaticGet_Field_1_4()
	{
		return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_646B2C2008B28BAE_TypeDefinitionIndex)->GetStaticField(0x29E50);
	}
	static ::System::Boolean* StaticGet_Field_1_1()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_1_646B2C2008B28BAE_TypeDefinitionIndex)->GetStaticField(0x92C0);
	}
	static ::System::Byte* StaticGet_Field_1_2()
	{
		return (::System::Byte*)Il2CppClass::FromTypeDefinitionIndex(Class_1_646B2C2008B28BAE_TypeDefinitionIndex)->GetStaticField(0x92C1);
	}
