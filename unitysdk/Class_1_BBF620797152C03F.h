...
#define CLASS_1_BBF620797152C03F_METHOD_1_CD53F45513A00C57_OFFSET UNITYSDK_OFFSET(0x10F56BC0)
#define CLASS_1_BBF620797152C03F_METHOD_1_E876C8B6D3B840A6_OFFSET UNITYSDK_OFFSET(0x10F56920)
#define CLASS_1_BBF620797152C03F__CTOR_OFFSET UNITYSDK_OFFSET(0x10F56880)

inline static constexpr unsigned int Class_1_BBF620797152C03F_TypeDefinitionIndex = 49639;
...
public:
	...
	{
		return ((::Class_0_16E4307DCC419505_543*(*)(::PVOID, ::RPG::GameCore::AvatarPropertyType))((::PBYTE)hIl2Cpp + CLASS_1_BBF620797152C03F_METHOD_1_CD53F45513A00C57_OFFSET))(this, a1);
	}
};
