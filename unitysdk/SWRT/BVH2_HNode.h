...
#define SWRT_BVH2_HNODE_GET_ISLEAF_OFFSET UNITYSDK_OFFSET(0x1B3C9D30)
#define SWRT_BVH2_HNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3C9D40)
...
namespace SWRT
{
	...
	{
	public:
		::SWRT::BVH2_HNode* LChild; // 0x10
		::SWRT::BVH2_HNode* RChild; // 0x18
