...
#define SWRT_BVH8_BUILD_OFFSET UNITYSDK_OFFSET(0x1A5504C0)
#define SWRT_BVH8_CALCULATEDECISION_OFFSET UNITYSDK_OFFSET(0x1A54FB80)
#define SWRT_BVH8_CONVERTTOCWBVH_OFFSET UNITYSDK_OFFSET(0x1A550F30)
#define SWRT_BVH8_GATHERPRIMITIVES_OFFSET UNITYSDK_OFFSET(0x1A552320)
#define SWRT_BVH8_GETCHILDREN_OFFSET UNITYSDK_OFFSET(0x1A551800)
#define SWRT_BVH8_NEXTPOWEROFTWOFLOATUNSAFE_OFFSET UNITYSDK_OFFSET(0x1A5523C0)
#define SWRT_BVH8_SORTCHILDREN_OFFSET UNITYSDK_OFFSET(0x1A551A20)
#define SWRT_BVH8__CTOR_OFFSET UNITYSDK_OFFSET(0x1A54F850)
