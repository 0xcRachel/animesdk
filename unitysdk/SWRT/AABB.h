...
#define SWRT_AABB_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x2386F40)
#define SWRT_AABB_GET_EXTENDS_OFFSET UNITYSDK_OFFSET(0x2386F80)
#define SWRT_AABB_GET_MAX_OFFSET UNITYSDK_OFFSET(0x1FF82F0)
#define SWRT_AABB_GET_MIN_OFFSET UNITYSDK_OFFSET(0x657BF0)
#define SWRT_AABB_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x223F640)
#define SWRT_AABB_SET_MAX_OFFSET UNITYSDK_OFFSET(0x1FF8310)
#define SWRT_AABB_SET_MIN_OFFSET UNITYSDK_OFFSET(0x6579B0)
#define SWRT_AABB_SURFACEAREA_OFFSET UNITYSDK_OFFSET(0x2387190)
#define SWRT_AABB_UNION_1_OFFSET UNITYSDK_OFFSET(0x1A54E6F0)
#define SWRT_AABB_UNION_OFFSET UNITYSDK_OFFSET(0x2387140)
#define SWRT_AABB__CTOR_1_OFFSET UNITYSDK_OFFSET(0x2387060)
#define SWRT_AABB__CTOR_OFFSET UNITYSDK_OFFSET(0x2386FC0)
