...
#define SWRT_BVH2_BUILD_OFFSET UNITYSDK_OFFSET(0x1B3C99B0)
#define SWRT_BVH2_CONVERTTOFNODES_OFFSET UNITYSDK_OFFSET(0x1B3C9D50)
#define SWRT_BVH2_SPLITBYSAH_OFFSET UNITYSDK_OFFSET(0x1B3C9FC0)
#define SWRT_BVH2_SPLITBYVARIANCE_OFFSET UNITYSDK_OFFSET(0x1B3CA520)
#define SWRT_BVH2__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3C9630)
