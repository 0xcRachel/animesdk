...
#define SWRT_BVH2_BUILD_OFFSET UNITYSDK_OFFSET(0x1A54EA70)
#define SWRT_BVH2_CONVERTTOFNODES_OFFSET UNITYSDK_OFFSET(0x1A54ED70)
#define SWRT_BVH2_SPLITBYSAH_OFFSET UNITYSDK_OFFSET(0x1A54EF70)
#define SWRT_BVH2_SPLITBYVARIANCE_OFFSET UNITYSDK_OFFSET(0x1A54F520)
#define SWRT_BVH2__CTOR_OFFSET UNITYSDK_OFFSET(0x1A54E780)
