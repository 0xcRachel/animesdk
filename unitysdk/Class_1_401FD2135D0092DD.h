...
#define CLASS_1_401FD2135D0092DD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xDE4A4F0)
#define CLASS_1_401FD2135D0092DD_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xDE4A7E0)
#define CLASS_1_401FD2135D0092DD_METHOD_1_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0xDE4A540)
#define CLASS_1_401FD2135D0092DD_METHOD_1_B8398A405A85F406_OFFSET UNITYSDK_OFFSET(0xDE4A440)
#define CLASS_1_401FD2135D0092DD_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xDE4A7A0)
#define CLASS_1_401FD2135D0092DD_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xDE4A860)
#define CLASS_1_401FD2135D0092DD_METHOD_1_FD3EAA6E9D492B8E_OFFSET UNITYSDK_OFFSET(0xDE4A5A0)
#define CLASS_1_401FD2135D0092DD__CTOR_OFFSET UNITYSDK_OFFSET(0xDE4A870)

inline static constexpr unsigned int Class_1_401FD2135D0092DD_TypeDefinitionIndex = 60855;

class Class_1_401FD2135D0092DD : public ::System::Object
{
public:
	::Class_1_934E35F7460E7A49* Field_1_1; // 0x10
	::Class_2_F3F43255EC92B83B* Field_1_3; // 0x18
	::Class_1_C47576BEFCFAD595* Field_1_0; // 0x20
	::RPG::GameCore::ParkourTriggerEventRow* Field_1_2; // 0x28
