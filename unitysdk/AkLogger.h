...
#define AKLOGGER_ERROR_OFFSET UNITYSDK_OFFSET(0x183A5530)
#define AKLOGGER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x183A5110)
#define AKLOGGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x183A50E0)
#define AKLOGGER_INIT_OFFSET UNITYSDK_OFFSET(0x183A5290)
#define AKLOGGER_MESSAGE_OFFSET UNITYSDK_OFFSET(0x183A52D0)
#define AKLOGGER_WARNING_OFFSET UNITYSDK_OFFSET(0x183A5400)
#define AKLOGGER_WWISEINTERNALLOGERROR_OFFSET UNITYSDK_OFFSET(0x183A4DF0)
#define AKLOGGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x183A5660)
#define AKLOGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x183A4F20)

inline static constexpr unsigned int AkLogger_TypeDefinitionIndex = 33593;
...
public:
	...
	{
		return (::AkLogger**)Il2CppClass::FromTypeDefinitionIndex(AkLogger_TypeDefinitionIndex)->GetStaticField(0x35730);
	}
