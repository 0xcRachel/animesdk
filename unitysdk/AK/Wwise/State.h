...
#define AK_WWISE_STATE_GET_OBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x18B9B1A0)
#define AK_WWISE_STATE_GET_WWISEOBJECTGROUPTYPE_OFFSET UNITYSDK_OFFSET(0x18B9B230)
#define AK_WWISE_STATE_GET_WWISEOBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x18B9B220)
#define AK_WWISE_STATE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x18B9B240)
#define AK_WWISE_STATE_SET_OBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x18B9B1B0)
#define AK_WWISE_STATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B9B3F0)
