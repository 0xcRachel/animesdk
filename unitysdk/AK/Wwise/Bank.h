...
#define AK_WWISE_BANK_GET_OBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x18B99340)
#define AK_WWISE_BANK_GET_WWISEOBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x18B993C0)
#define AK_WWISE_BANK_LOADASYNC_OFFSET UNITYSDK_OFFSET(0x18B998F0)
#define AK_WWISE_BANK_LOAD_OFFSET UNITYSDK_OFFSET(0x18B993D0)
#define AK_WWISE_BANK_SET_OBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x18B99350)
#define AK_WWISE_BANK_UNLOAD_OFFSET UNITYSDK_OFFSET(0x18B99D30)
#define AK_WWISE_BANK__CTOR_OFFSET UNITYSDK_OFFSET(0x18B99FF0)
