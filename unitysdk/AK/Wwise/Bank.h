...
#define AK_WWISE_BANK_GET_OBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x183739F0)
#define AK_WWISE_BANK_GET_WWISEOBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x18373A70)
#define AK_WWISE_BANK_LOADASYNC_OFFSET UNITYSDK_OFFSET(0x18373FA0)
#define AK_WWISE_BANK_LOAD_OFFSET UNITYSDK_OFFSET(0x18373A80)
#define AK_WWISE_BANK_SET_OBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x18373A00)
#define AK_WWISE_BANK_UNLOAD_OFFSET UNITYSDK_OFFSET(0x183743E0)
#define AK_WWISE_BANK__CTOR_OFFSET UNITYSDK_OFFSET(0x183746A0)

namespace AK::Wwise
{
	inline static constexpr unsigned int Bank_TypeDefinitionIndex = 33724;
