...
#define AK_WWISE_BANK_GET_OBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x19DBEA40)
#define AK_WWISE_BANK_GET_WWISEOBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x19DBEAC0)
#define AK_WWISE_BANK_LOADASYNC_OFFSET UNITYSDK_OFFSET(0x19DBEFA0)
#define AK_WWISE_BANK_LOAD_OFFSET UNITYSDK_OFFSET(0x19DBEAD0)
#define AK_WWISE_BANK_SET_OBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x19DBEA50)
#define AK_WWISE_BANK_UNLOAD_OFFSET UNITYSDK_OFFSET(0x19DBF390)
#define AK_WWISE_BANK__CTOR_OFFSET UNITYSDK_OFFSET(0x19DBF620)
