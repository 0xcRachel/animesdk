...
#define CLASS_1_40526AF9C8E77A0E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10C9A350)
#define CLASS_1_40526AF9C8E77A0E_METHOD_1_0865E94460F11643_1_OFFSET UNITYSDK_OFFSET(0x10C9B600)
#define CLASS_1_40526AF9C8E77A0E_METHOD_1_0865E94460F11643_OFFSET UNITYSDK_OFFSET(0x10C9AB00)
#define CLASS_1_40526AF9C8E77A0E_METHOD_1_3AC94EEB348AAF2D_OFFSET UNITYSDK_OFFSET(0x10C9AE80)
#define CLASS_1_40526AF9C8E77A0E_METHOD_1_3F348DF9DB1ACA5A_OFFSET UNITYSDK_OFFSET(0x10C9AC40)
#define CLASS_1_40526AF9C8E77A0E_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x10C9A2A0)
#define CLASS_1_40526AF9C8E77A0E_METHOD_1_472EBD1C5B8718BA_OFFSET UNITYSDK_OFFSET(0x10C9AED0)
#define CLASS_1_40526AF9C8E77A0E_METHOD_1_48A487831183C387_OFFSET UNITYSDK_OFFSET(0x10C9A550)
#define CLASS_1_40526AF9C8E77A0E_METHOD_1_4A311791F860C4DA_OFFSET UNITYSDK_OFFSET(0x10C9A450)
#define CLASS_1_40526AF9C8E77A0E_METHOD_1_4A83280585CF476A_OFFSET UNITYSDK_OFFSET(0x10C9B870)
#define CLASS_1_40526AF9C8E77A0E_METHOD_1_4D606E0EBD8E195C_OFFSET UNITYSDK_OFFSET(0x10C9B200)
#define CLASS_1_40526AF9C8E77A0E_METHOD_1_9C098719D7C455B6_OFFSET UNITYSDK_OFFSET(0x10C9B6F0)
#define CLASS_1_40526AF9C8E77A0E_METHOD_1_A984848EA3E436DA_OFFSET UNITYSDK_OFFSET(0x10C9ABF0)
#define CLASS_1_40526AF9C8E77A0E_METHOD_1_D3129FE8DF635B48_1_OFFSET UNITYSDK_OFFSET(0x10C9B320)
#define CLASS_1_40526AF9C8E77A0E_METHOD_1_D3129FE8DF635B48_OFFSET UNITYSDK_OFFSET(0x10C9A820)
#define CLASS_1_40526AF9C8E77A0E_RECEIVEMESSAGE_OFFSET UNITYSDK_OFFSET(0x10C9A3E0)
#define CLASS_1_40526AF9C8E77A0E__CTOR_OFFSET UNITYSDK_OFFSET(0x10C9BB10)
#define CLASS_1_40526AF9C8E77A0E__REQUESTKEEPOLDEQUIP_B__18_0_OFFSET UNITYSDK_OFFSET(0x10C9BBE0)
#define CLASS_1_40526AF9C8E77A0E__REQUESTREPLACEOLDEQUIP_B__25_0_OFFSET UNITYSDK_OFFSET(0x10C9BD70)
#define CLASS_1_40526AF9C8E77A0E___DOKEEPOLDEQUIP_B__20_0_OFFSET UNITYSDK_OFFSET(0x10C9BC40)
#define CLASS_1_40526AF9C8E77A0E___REQUESTDISCARDNEWEQUIP_B__28_0_OFFSET UNITYSDK_OFFSET(0x10C9BDD0)

inline static constexpr unsigned int Class_1_40526AF9C8E77A0E_TypeDefinitionIndex = 69375;

class Class_1_40526AF9C8E77A0E : public ::System::Object
{
public:
	::RPG::Client::ActivityIdleLive::PendingEquipData* Field_1_7; // 0x10
	::Class_1_A0F414D2CF643E56* Field_1_6; // 0x18
	::RPG::Client::Promises::Promise_1<::RPG::Client::ActivityIdleLive::PendingEquipData*>* Field_1_9; // 0x20
	::Class_0_16E4307DCC419505_1093* Field_1_1; // 0x28
	::Class_1_4B24D105CCEA2C22* Field_1_11; // 0x30
	::RPG::Client::Promises::Promise* Field_1_10; // 0x38
	::RPG::Client::ActivityIdleLive::IdleLiveDecimal Field_1_3; // 0x40
	::RPG::Client::ActivityIdleLive::PendingEquipData* Field_1_8; // 0x58
	::RPG::Client::ActivityIdleLive::IdleLiveDecimal Field_1_4; // 0x60
	::Class_0_16E4307DCC419505_1093* Field_1_2; // 0x78
	::Class_0_16E4307DCC419505_1093* Field_1_0; // 0x80
