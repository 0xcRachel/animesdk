...
#define CLASS_1_5B567C8A01BAEDFE_180_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19FE3050)
#define CLASS_1_5B567C8A01BAEDFE_180_CLONE_OFFSET UNITYSDK_OFFSET(0x19FE2EC0)
#define CLASS_1_5B567C8A01BAEDFE_180_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19FE2F60)
#define CLASS_1_5B567C8A01BAEDFE_180_EQUALS_OFFSET UNITYSDK_OFFSET(0x19FE2F00)
#define CLASS_1_5B567C8A01BAEDFE_180_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19FE2FB0)
#define CLASS_1_5B567C8A01BAEDFE_180_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19FE30A0)
#define CLASS_1_5B567C8A01BAEDFE_180_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19FE3070)
#define CLASS_1_5B567C8A01BAEDFE_180_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19FE2E40)
#define CLASS_1_5B567C8A01BAEDFE_180_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19FE2E70)
#define CLASS_1_5B567C8A01BAEDFE_180_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19FE2FE0)
#define CLASS_1_5B567C8A01BAEDFE_180_WRITETO_OFFSET UNITYSDK_OFFSET(0x19FE3040)
#define CLASS_1_5B567C8A01BAEDFE_180__CCTOR_OFFSET UNITYSDK_OFFSET(0x19FE30F0)
#define CLASS_1_5B567C8A01BAEDFE_180__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19FE2E90)
#define CLASS_1_5B567C8A01BAEDFE_180__CTOR_OFFSET UNITYSDK_OFFSET(0x19FE2E80)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_180*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_180_TypeDefinitionIndex)->GetStaticField(0x4A420);
	}
