...
#define CLASS_1_5B567C8A01BAEDFE_180_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1B1C8960)
#define CLASS_1_5B567C8A01BAEDFE_180_CLONE_OFFSET UNITYSDK_OFFSET(0x1B1C8770)
#define CLASS_1_5B567C8A01BAEDFE_180_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1B1C8870)
#define CLASS_1_5B567C8A01BAEDFE_180_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B1C87E0)
#define CLASS_1_5B567C8A01BAEDFE_180_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B1C88C0)
#define CLASS_1_5B567C8A01BAEDFE_180_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1B1C89B0)
#define CLASS_1_5B567C8A01BAEDFE_180_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1B1C8980)
#define CLASS_1_5B567C8A01BAEDFE_180_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1B1C86C0)
#define CLASS_1_5B567C8A01BAEDFE_180_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1B1C8720)
#define CLASS_1_5B567C8A01BAEDFE_180_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B1C88F0)
#define CLASS_1_5B567C8A01BAEDFE_180_WRITETO_OFFSET UNITYSDK_OFFSET(0x1B1C8950)
#define CLASS_1_5B567C8A01BAEDFE_180__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B1C8A00)
#define CLASS_1_5B567C8A01BAEDFE_180__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B1C8740)
#define CLASS_1_5B567C8A01BAEDFE_180__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1C8730)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_180*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_180_TypeDefinitionIndex)->GetStaticField(0x5A600);
	}
