...
#define RANDOMCARGO_AWAKE_OFFSET UNITYSDK_OFFSET(0xABC7B90)
#define RANDOMCARGO_RANDOMCARGOWITHINDEX_OFFSET UNITYSDK_OFFSET(0xABC7BE0)
#define RANDOMCARGO__CTOR_OFFSET UNITYSDK_OFFSET(0xABC7F40)
