...
#define RANDOMCARGO_AWAKE_OFFSET UNITYSDK_OFFSET(0x17753CF0)
#define RANDOMCARGO_RANDOMCARGOWITHINDEX_OFFSET UNITYSDK_OFFSET(0x17753D40)
#define RANDOMCARGO__CTOR_OFFSET UNITYSDK_OFFSET(0x177540D0)
