...
#define RANDOMCARGO_AWAKE_OFFSET UNITYSDK_OFFSET(0x16E1CCD0)
#define RANDOMCARGO_RANDOMCARGOWITHINDEX_OFFSET UNITYSDK_OFFSET(0x16E1CD20)
#define RANDOMCARGO__CTOR_OFFSET UNITYSDK_OFFSET(0x16E1D080)
