...
#define CLASS_1_5B567C8A01BAEDFE_355_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1989BBE0)
#define CLASS_1_5B567C8A01BAEDFE_355_CLONE_OFFSET UNITYSDK_OFFSET(0x1989B9F0)
#define CLASS_1_5B567C8A01BAEDFE_355_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1989BAF0)
#define CLASS_1_5B567C8A01BAEDFE_355_EQUALS_OFFSET UNITYSDK_OFFSET(0x1989BA60)
#define CLASS_1_5B567C8A01BAEDFE_355_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1989BB40)
#define CLASS_1_5B567C8A01BAEDFE_355_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1989BC30)
#define CLASS_1_5B567C8A01BAEDFE_355_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1989BC00)
#define CLASS_1_5B567C8A01BAEDFE_355_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1989B940)
#define CLASS_1_5B567C8A01BAEDFE_355_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1989B9A0)
#define CLASS_1_5B567C8A01BAEDFE_355_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1989BB70)
#define CLASS_1_5B567C8A01BAEDFE_355_WRITETO_OFFSET UNITYSDK_OFFSET(0x1989BBD0)
#define CLASS_1_5B567C8A01BAEDFE_355__CCTOR_OFFSET UNITYSDK_OFFSET(0x1989BC80)
#define CLASS_1_5B567C8A01BAEDFE_355__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1989B9C0)
#define CLASS_1_5B567C8A01BAEDFE_355__CTOR_OFFSET UNITYSDK_OFFSET(0x1989B9B0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_355*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_355_TypeDefinitionIndex)->GetStaticField(0x50E10);
	}
