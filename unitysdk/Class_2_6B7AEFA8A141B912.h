...
#define CLASS_2_6B7AEFA8A141B912_METHOD_2_0C726E1A401D0413_OFFSET UNITYSDK_OFFSET(0xED5A680)
#define CLASS_2_6B7AEFA8A141B912_METHOD_2_0CAC8436EC78EB6B_OFFSET UNITYSDK_OFFSET(0xED5A770)
#define CLASS_2_6B7AEFA8A141B912_METHOD_2_C89A41A14F7CCD91_OFFSET UNITYSDK_OFFSET(0xED5AA80)
#define CLASS_2_6B7AEFA8A141B912__CTOR_OFFSET UNITYSDK_OFFSET(0xED5A9C0)
#define CLASS_2_6B7AEFA8A141B912__ONBIND_OFFSET UNITYSDK_OFFSET(0xED5A570)
#define CLASS_2_6B7AEFA8A141B912___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0xED5AA20)

inline static constexpr unsigned int Class_2_6B7AEFA8A141B912_TypeDefinitionIndex = 66605;
...
public:
	...
	::RPG::Client::GridFightTraitEffectConfig* Field_2_5; // 0x70
	::RPG::Client::GridFightTrait* Field_2_3; // 0x78
	::RPG::Client::AnimatorButton* Field_2_1; // 0x80
	::System::Action_1<::System::Object*>* Field_2_6; // 0x88
	::RPG::Client::GridFightTraitConfigBase* Field_2_4; // 0x90
	::RPG::GameCore::BattleGridFightTeamTraitData* Field_2_2; // 0x98
