...
#define CLASS_1_25495098F569C629_1_CLEAR_OFFSET UNITYSDK_OFFSET(0x104425A0)
#define CLASS_1_25495098F569C629_1_GET_ATK_OFFSET UNITYSDK_OFFSET(0x10442B60)
#define CLASS_1_25495098F569C629_1_GET_ATTACKCD_OFFSET UNITYSDK_OFFSET(0x10442B20)
#define CLASS_1_25495098F569C629_1_GET_ATTACKRANGE_OFFSET UNITYSDK_OFFSET(0x10442B00)
#define CLASS_1_25495098F569C629_1_GET_BATTLESCALE_OFFSET UNITYSDK_OFFSET(0x10442C90)
#define CLASS_1_25495098F569C629_1_GET_CRTCHANCE_OFFSET UNITYSDK_OFFSET(0x10442BA0)
#define CLASS_1_25495098F569C629_1_GET_CRTDAMAGERATIO_OFFSET UNITYSDK_OFFSET(0x10442BC0)
#define CLASS_1_25495098F569C629_1_GET_HP_OFFSET UNITYSDK_OFFSET(0x10442B40)
#define CLASS_1_25495098F569C629_1_GET_ISPROMOTED_OFFSET UNITYSDK_OFFSET(0x10442C00)
#define CLASS_1_25495098F569C629_1_GET_MODELPATH_OFFSET UNITYSDK_OFFSET(0x10442BE0)
#define CLASS_1_25495098F569C629_1_GET_MOVESPEED_OFFSET UNITYSDK_OFFSET(0x10442B80)
#define CLASS_1_25495098F569C629_1_GET_OVERRIDEMATERIALPATH_OFFSET UNITYSDK_OFFSET(0x10442C20)
#define CLASS_1_25495098F569C629_1_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x10442C60)
#define CLASS_1_25495098F569C629_1_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x10442C40)
#define CLASS_1_25495098F569C629_1_GET_SCALE_OFFSET UNITYSDK_OFFSET(0x10442AE0)
#define CLASS_1_25495098F569C629_1_GET_SOLDIERID_OFFSET UNITYSDK_OFFSET(0x10442AA0)
#define CLASS_1_25495098F569C629_1_GET_TEAMTYPE_OFFSET UNITYSDK_OFFSET(0x10442AC0)
#define CLASS_1_25495098F569C629_1_GET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0x10442A80)
#define CLASS_1_25495098F569C629_1_METHOD_1_CF8AE51777AB7BDB_OFFSET UNITYSDK_OFFSET(0x10442790)
#define CLASS_1_25495098F569C629_1_METHOD_1_EA672F77F1086A27_OFFSET UNITYSDK_OFFSET(0x10442A30)
#define CLASS_1_25495098F569C629_1_METHOD_1_F097EB4B6A341647_OFFSET UNITYSDK_OFFSET(0x10442670)
#define CLASS_1_25495098F569C629_1_SET_ATK_OFFSET UNITYSDK_OFFSET(0x10442B70)
#define CLASS_1_25495098F569C629_1_SET_ATTACKCD_OFFSET UNITYSDK_OFFSET(0x10442B30)
#define CLASS_1_25495098F569C629_1_SET_ATTACKRANGE_OFFSET UNITYSDK_OFFSET(0x10442B10)
#define CLASS_1_25495098F569C629_1_SET_BATTLESCALE_OFFSET UNITYSDK_OFFSET(0x10442CB0)
#define CLASS_1_25495098F569C629_1_SET_CRTCHANCE_OFFSET UNITYSDK_OFFSET(0x10442BB0)
#define CLASS_1_25495098F569C629_1_SET_CRTDAMAGERATIO_OFFSET UNITYSDK_OFFSET(0x10442BD0)
#define CLASS_1_25495098F569C629_1_SET_HP_OFFSET UNITYSDK_OFFSET(0x10442B50)
#define CLASS_1_25495098F569C629_1_SET_ISPROMOTED_OFFSET UNITYSDK_OFFSET(0x10442C10)
#define CLASS_1_25495098F569C629_1_SET_MODELPATH_OFFSET UNITYSDK_OFFSET(0x10442BF0)
#define CLASS_1_25495098F569C629_1_SET_MOVESPEED_OFFSET UNITYSDK_OFFSET(0x10442B90)
#define CLASS_1_25495098F569C629_1_SET_OVERRIDEMATERIALPATH_OFFSET UNITYSDK_OFFSET(0x10442C30)
#define CLASS_1_25495098F569C629_1_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x10442C80)
#define CLASS_1_25495098F569C629_1_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x10442C50)
#define CLASS_1_25495098F569C629_1_SET_SCALE_OFFSET UNITYSDK_OFFSET(0x10442AF0)
#define CLASS_1_25495098F569C629_1_SET_SOLDIERID_OFFSET UNITYSDK_OFFSET(0x10442AB0)
#define CLASS_1_25495098F569C629_1_SET_TEAMTYPE_OFFSET UNITYSDK_OFFSET(0x10442AD0)
#define CLASS_1_25495098F569C629_1_SET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0x10442A90)
#define CLASS_1_25495098F569C629_1__CTOR_OFFSET UNITYSDK_OFFSET(0x10442780)
...
public:
	...
	::RPG::GameCore::FixPoint _AttackCD_k__BackingField; // 0x20
	::RPG::GameCore::FixPoint _MoveSpeed_k__BackingField; // 0x28
	::UnityEngine::Quaternion _Rotation_k__BackingField; // 0x30
	::System::UInt32 _SoldierID_k__BackingField; // 0x40
	::System::Int32 _UniqueID_k__BackingField; // 0x44
	::RPG::GameCore::ChenLingSoldierScale _Scale_k__BackingField; // 0x48
	::RPG::GameCore::FixPoint _HP_k__BackingField; // 0x50
	::RPG::GameCore::FixPoint _CrtChance_k__BackingField; // 0x58
	::UnityEngine::Vector3 _BattleScale_k__BackingField; // 0x60
	...
	::System::Boolean _IsPromoted_k__BackingField; // 0x84
	::RPG::GameCore::FixPoint _Atk_k__BackingField; // 0x88
	::RPG::GameCore::FixPoint _AttackRange_k__BackingField; // 0x90
