...
#define CLASS_3_EF2474EF650BEA9B_METHOD_3_22ABEDBE31B3268C_OFFSET UNITYSDK_OFFSET(0xE49C2C0)
#define CLASS_3_EF2474EF650BEA9B_METHOD_3_3422201382CE593B_OFFSET UNITYSDK_OFFSET(0xE49C830)
#define CLASS_3_EF2474EF650BEA9B_METHOD_3_E2159B107C919331_OFFSET UNITYSDK_OFFSET(0xE49C610)
#define CLASS_3_EF2474EF650BEA9B__CCTOR_OFFSET UNITYSDK_OFFSET(0xE49C8B0)
#define CLASS_3_EF2474EF650BEA9B__CTOR_1_OFFSET UNITYSDK_OFFSET(0xE49C4A0)
#define CLASS_3_EF2474EF650BEA9B__CTOR_OFFSET UNITYSDK_OFFSET(0xE49C310)
...
public:
	...
	{
		return (::UnityEngine::Gradient**)Il2CppClass::FromTypeDefinitionIndex(Class_3_EF2474EF650BEA9B_TypeDefinitionIndex)->GetStaticField(0x5C280);
	}
