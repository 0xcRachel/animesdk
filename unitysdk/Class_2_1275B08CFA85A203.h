...
#define CLASS_2_1275B08CFA85A203_DISPOSE_OFFSET UNITYSDK_OFFSET(0x105BBA00)
#define CLASS_2_1275B08CFA85A203_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x105BBA70)
#define CLASS_2_1275B08CFA85A203_ONFINISHIMMEDIATELYINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x105BC110)
#define CLASS_2_1275B08CFA85A203_ONSKIP_OFFSET UNITYSDK_OFFSET(0x105BC0C0)
#define CLASS_2_1275B08CFA85A203_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x105BBA80)
#define CLASS_2_1275B08CFA85A203_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x105BBDD0)
#define CLASS_2_1275B08CFA85A203_TICK_OFFSET UNITYSDK_OFFSET(0x105BBE50)
#define CLASS_2_1275B08CFA85A203__CTOR_OFFSET UNITYSDK_OFFSET(0x105BB950)

inline static constexpr unsigned int Class_2_1275B08CFA85A203_TypeDefinitionIndex = 45719;

class Class_2_1275B08CFA85A203 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::CharacterTriggerFreeStyleGraph* Field_2_0; // 0x18
	::System::Collections::Generic::List_1<::System::Single>* Field_2_3; // 0x20
	::RPG::GameCore::TaskContext* Field_2_1; // 0x28
	::RPG::GameCore::GameEntityList* Field_2_2; // 0x30
