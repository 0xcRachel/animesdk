...
#define CLASS_1_9E296C95827C90A8_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCDB2370)
#define CLASS_1_9E296C95827C90A8_GENSTATISTICS_OFFSET UNITYSDK_OFFSET(0xCDB23D0)
#define CLASS_1_9E296C95827C90A8_GET_PROGRESSMONITOR_OFFSET UNITYSDK_OFFSET(0xCDB26E0)
#define CLASS_1_9E296C95827C90A8_GET_REGISTERMODE_OFFSET UNITYSDK_OFFSET(0xCDB26D0)
#define CLASS_1_9E296C95827C90A8_GET__GAMEMODE_OFFSET UNITYSDK_OFFSET(0xCDB2650)
#define CLASS_1_9E296C95827C90A8_METHOD_1_B286FD8ABF100830_OFFSET UNITYSDK_OFFSET(0xCDB1EC0)
#define CLASS_1_9E296C95827C90A8_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xCDB25D0)
#define CLASS_1_9E296C95827C90A8_METHOD_1_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0xCDB2610)
#define CLASS_1_9E296C95827C90A8_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xCDB2550)
#define CLASS_1_9E296C95827C90A8_METHOD_1_DAEB67F34AF80609_1_OFFSET UNITYSDK_OFFSET(0xCDB1F60)
#define CLASS_1_9E296C95827C90A8_METHOD_1_DAEB67F34AF80609_OFFSET UNITYSDK_OFFSET(0xCDB17C0)
#define CLASS_1_9E296C95827C90A8_METHOD_1_F004EAAEA47E15E3_OFFSET UNITYSDK_OFFSET(0xCDB2670)
#define CLASS_1_9E296C95827C90A8_METHOD_1_F2818BF598780548_OFFSET UNITYSDK_OFFSET(0xCDB1740)
#define CLASS_1_9E296C95827C90A8_METHOD_1_F4E5958F2AE995E5_OFFSET UNITYSDK_OFFSET(0xCDB21E0)
#define CLASS_1_9E296C95827C90A8_METHOD_1_F7B0A9079CE9AD22_OFFSET UNITYSDK_OFFSET(0xCDB2420)
#define CLASS_1_9E296C95827C90A8_ONAFTERPLAYERCREATE_OFFSET UNITYSDK_OFFSET(0xCDB2480)
#define CLASS_1_9E296C95827C90A8_ONBATTLEINSTANCECREATED_OFFSET UNITYSDK_OFFSET(0xCDB24D0)
#define CLASS_1_9E296C95827C90A8_ONINITIALIZE_OFFSET UNITYSDK_OFFSET(0xCDB2590)
#define CLASS_1_9E296C95827C90A8_ONMAZEBUFFBINDING_OFFSET UNITYSDK_OFFSET(0xCDB2510)
#define CLASS_1_9E296C95827C90A8_SET_PROGRESSMONITOR_OFFSET UNITYSDK_OFFSET(0xCDB26F0)
#define CLASS_1_9E296C95827C90A8_SET__GAMEMODE_OFFSET UNITYSDK_OFFSET(0xCDB2660)
#define CLASS_1_9E296C95827C90A8__CTOR_OFFSET UNITYSDK_OFFSET(0xCDB2700)
...
{
public:
	::Class_1_CFAD0A6C5E25FBEF* _ProgressMonitor_k__BackingField; // 0x10
	::RPG::GameCore::TurnBasedGameMode* __GameMode_k__BackingField; // 0x18
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::EventType, ::Class_0_16E4307DCC419505_497*>* Field_1_2; // 0x20
