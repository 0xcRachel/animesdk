...
#define CLASS_2_D3061860904844A0_METHOD_2_04AF66402B9859B9_OFFSET UNITYSDK_OFFSET(0xE3A0360)
#define CLASS_2_D3061860904844A0_METHOD_2_13523FD4EA5101C4_OFFSET UNITYSDK_OFFSET(0xE3A03B0)
#define CLASS_2_D3061860904844A0_METHOD_2_62593EE2FE331D20_OFFSET UNITYSDK_OFFSET(0xE3A00A0)
#define CLASS_2_D3061860904844A0_METHOD_2_AD04CF6369F3E2B1_OFFSET UNITYSDK_OFFSET(0xE39FE60)
#define CLASS_2_D3061860904844A0_METHOD_2_D9E34E162363C06E_OFFSET UNITYSDK_OFFSET(0xE3A0430)
#define CLASS_2_D3061860904844A0_METHOD_2_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0xE39FCA0)
#define CLASS_2_D3061860904844A0_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xE3A0480)
#define CLASS_2_D3061860904844A0_ONACQUIRE_OFFSET UNITYSDK_OFFSET(0xE3A0050)
#define CLASS_2_D3061860904844A0_ONRETURN_OFFSET UNITYSDK_OFFSET(0xE39FE00)
#define CLASS_2_D3061860904844A0__CTOR_OFFSET UNITYSDK_OFFSET(0xE3A0490)
#define CLASS_2_D3061860904844A0__ONBIND_OFFSET UNITYSDK_OFFSET(0xE39FAE0)
#define CLASS_2_D3061860904844A0___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0xE3A04F0)

inline static constexpr unsigned int Class_2_D3061860904844A0_TypeDefinitionIndex = 66134;

class Class_2_D3061860904844A0 : public ::Class_1_CA217ABF4E3B4F3F
{
public:
	::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_959*>* Field_2_4; // 0x60
