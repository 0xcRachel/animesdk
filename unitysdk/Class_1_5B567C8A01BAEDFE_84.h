...
#define CLASS_1_5B567C8A01BAEDFE_84_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A0784B0)
#define CLASS_1_5B567C8A01BAEDFE_84_CLONE_OFFSET UNITYSDK_OFFSET(0x1A078320)
#define CLASS_1_5B567C8A01BAEDFE_84_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A0783C0)
#define CLASS_1_5B567C8A01BAEDFE_84_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A078360)
#define CLASS_1_5B567C8A01BAEDFE_84_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A078410)
#define CLASS_1_5B567C8A01BAEDFE_84_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A078500)
#define CLASS_1_5B567C8A01BAEDFE_84_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A0784D0)
#define CLASS_1_5B567C8A01BAEDFE_84_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A0782A0)
#define CLASS_1_5B567C8A01BAEDFE_84_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A0782D0)
#define CLASS_1_5B567C8A01BAEDFE_84_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A078440)
#define CLASS_1_5B567C8A01BAEDFE_84_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A0784A0)
#define CLASS_1_5B567C8A01BAEDFE_84__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A078550)
#define CLASS_1_5B567C8A01BAEDFE_84__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0782F0)
#define CLASS_1_5B567C8A01BAEDFE_84__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0782E0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_84*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_84_TypeDefinitionIndex)->GetStaticField(0x47140);
	}
