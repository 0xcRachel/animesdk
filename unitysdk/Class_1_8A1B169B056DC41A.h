...
#define CLASS_1_8A1B169B056DC41A_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0xAD8C830)
#define CLASS_1_8A1B169B056DC41A_METHOD_1_6279B2A89754B8E7_OFFSET UNITYSDK_OFFSET(0xAD8C580)
#define CLASS_1_8A1B169B056DC41A_METHOD_1_6DFEF4918C679AF0_OFFSET UNITYSDK_OFFSET(0xAD8C6B0)
#define CLASS_1_8A1B169B056DC41A_METHOD_1_E83C86A203FAF2A6_OFFSET UNITYSDK_OFFSET(0xAD8C7A0)
#define CLASS_1_8A1B169B056DC41A__CTOR_OFFSET UNITYSDK_OFFSET(0xAD8C8D0)

inline static constexpr unsigned int Class_1_8A1B169B056DC41A_TypeDefinitionIndex = 67874;

class Class_1_8A1B169B056DC41A : public ::System::Object
{
public:
	::RPG::Client::CrowdAnimator::CrowdPrototype* Field_1_3; // 0x10
	::System::Collections::Generic::List_1<::Class_1_7702F0FE6F5A6B65*>* Field_1_8; // 0x18
	::UnityEngine::Material* Field_1_2; // 0x20
	::UnityEngine::Material* Field_1_4; // 0x28
	::UnityEngine::Texture2D* Field_1_5; // 0x30
	::UnityEngine::Mesh* Field_1_0; // 0x38
