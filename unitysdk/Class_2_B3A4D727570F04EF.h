...
#define CLASS_2_B3A4D727570F04EF_DISPOSE_OFFSET UNITYSDK_OFFSET(0x89B8C30)
#define CLASS_2_B3A4D727570F04EF_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x89B8C70)
#define CLASS_2_B3A4D727570F04EF_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x89B8DD0)
#define CLASS_2_B3A4D727570F04EF_TICK_OFFSET UNITYSDK_OFFSET(0x89B8E20)
#define CLASS_2_B3A4D727570F04EF__CTOR_OFFSET UNITYSDK_OFFSET(0x89B8C20)

inline static constexpr unsigned int Class_2_B3A4D727570F04EF_TypeDefinitionIndex = 41991;

class Class_2_B3A4D727570F04EF : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::PropComponent* Field_2_2; // 0x18
	::RPG::GameCore::PrepareFinishMazePuzzleChallenge* Field_2_0; // 0x20
