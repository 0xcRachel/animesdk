...
#define CLASS_1_4FCC8C206307C76F_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1038FE20)
#define CLASS_1_4FCC8C206307C76F_METHOD_1_2B66C008535F8B01_OFFSET UNITYSDK_OFFSET(0x1038FBD0)
#define CLASS_1_4FCC8C206307C76F_METHOD_1_599D97DBBAB2CBCE_OFFSET UNITYSDK_OFFSET(0x1038FF80)
#define CLASS_1_4FCC8C206307C76F_METHOD_1_A124427AABD6F076_OFFSET UNITYSDK_OFFSET(0x103900F0)
#define CLASS_1_4FCC8C206307C76F_METHOD_1_A396886527012FF7_OFFSET UNITYSDK_OFFSET(0x1038FD20)
#define CLASS_1_4FCC8C206307C76F_METHOD_1_CB81EEE9CC7C2687_OFFSET UNITYSDK_OFFSET(0x1038FA00)
#define CLASS_1_4FCC8C206307C76F_METHOD_1_D072FA229F253A0B_OFFSET UNITYSDK_OFFSET(0x1038FEA0)
#define CLASS_1_4FCC8C206307C76F__CTOR_OFFSET UNITYSDK_OFFSET(0x1038FB30)

inline static constexpr unsigned int Class_1_4FCC8C206307C76F_TypeDefinitionIndex = 63554;
