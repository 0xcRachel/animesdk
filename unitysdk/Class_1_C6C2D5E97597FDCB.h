...
#define CLASS_1_C6C2D5E97597FDCB_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19D99560)
#define CLASS_1_C6C2D5E97597FDCB_CLONE_OFFSET UNITYSDK_OFFSET(0x19D98FD0)
#define CLASS_1_C6C2D5E97597FDCB_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19D99100)
#define CLASS_1_C6C2D5E97597FDCB_EQUALS_OFFSET UNITYSDK_OFFSET(0x19D990A0)
#define CLASS_1_C6C2D5E97597FDCB_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19D991D0)
#define CLASS_1_C6C2D5E97597FDCB_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19D997E0)
#define CLASS_1_C6C2D5E97597FDCB_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19D99760)
#define CLASS_1_C6C2D5E97597FDCB_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x19D99060)
#define CLASS_1_C6C2D5E97597FDCB_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x19D99030)
#define CLASS_1_C6C2D5E97597FDCB_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19D98DD0)
#define CLASS_1_C6C2D5E97597FDCB_METHOD_1_554199E0076172C5_1_OFFSET UNITYSDK_OFFSET(0x19D99050)
#define CLASS_1_C6C2D5E97597FDCB_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x19D99020)
#define CLASS_1_C6C2D5E97597FDCB_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x19D99070)
#define CLASS_1_C6C2D5E97597FDCB_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x19D99040)
#define CLASS_1_C6C2D5E97597FDCB_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x19D99090)
#define CLASS_1_C6C2D5E97597FDCB_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x19D99080)
#define CLASS_1_C6C2D5E97597FDCB_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19D98E30)
#define CLASS_1_C6C2D5E97597FDCB_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19D993B0)
#define CLASS_1_C6C2D5E97597FDCB_WRITETO_OFFSET UNITYSDK_OFFSET(0x19D99410)
#define CLASS_1_C6C2D5E97597FDCB__CCTOR_OFFSET UNITYSDK_OFFSET(0x19D99960)
#define CLASS_1_C6C2D5E97597FDCB__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19D98ED0)
#define CLASS_1_C6C2D5E97597FDCB__CTOR_OFFSET UNITYSDK_OFFSET(0x19D98E40)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_C6C2D5E97597FDCB*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_C6C2D5E97597FDCB_TypeDefinitionIndex)->GetStaticField(0x1CD20);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_3()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_C6C2D5E97597FDCB_TypeDefinitionIndex)->GetStaticField(0x1CD28);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_8()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_C6C2D5E97597FDCB_TypeDefinitionIndex)->GetStaticField(0x1CD30);
	}
