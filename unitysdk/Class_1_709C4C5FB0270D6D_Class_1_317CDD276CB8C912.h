...
#define CLASS_1_709C4C5FB0270D6D_CLASS_1_317CDD276CB8C912__CTOR_OFFSET UNITYSDK_OFFSET(0xF3FA6B0)
...
{
public:
	::RPG::GameCore::TurnBasedModifierConfig* Field_1_1; // 0x10
	::Class_2_1DB6C02CA182EEBA* Field_1_2; // 0x18
	::System::String* Field_1_0; // 0x20
	::Class_2_7AA0468CE6C1F3D7_1* Field_1_3; // 0x28
