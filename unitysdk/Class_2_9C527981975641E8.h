...
#define CLASS_2_9C527981975641E8_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8766540)
#define CLASS_2_9C527981975641E8_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x8766770)
#define CLASS_2_9C527981975641E8_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x8766590)
#define CLASS_2_9C527981975641E8_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x87666C0)
#define CLASS_2_9C527981975641E8_TICK_OFFSET UNITYSDK_OFFSET(0x8766710)
#define CLASS_2_9C527981975641E8__CTOR_OFFSET UNITYSDK_OFFSET(0x8766530)

inline static constexpr unsigned int Class_2_9C527981975641E8_TypeDefinitionIndex = 41994;

class Class_2_9C527981975641E8 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::PropComponent* Field_2_2; // 0x18
	::RPG::GameCore::PropDestruct* Field_2_0; // 0x20
