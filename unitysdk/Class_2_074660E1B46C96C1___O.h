...
public:
	...
	{
		return (::System::Comparison_1<::RPG::GameCore::GameEntity*>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_074660E1B46C96C1___O_TypeDefinitionIndex)->GetStaticField(0x40220);
	}
};
