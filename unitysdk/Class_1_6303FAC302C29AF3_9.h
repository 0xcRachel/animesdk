...
#define CLASS_1_6303FAC302C29AF3_9_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17EA9C50)
#define CLASS_1_6303FAC302C29AF3_9_CLONE_OFFSET UNITYSDK_OFFSET(0x17EA97B0)
#define CLASS_1_6303FAC302C29AF3_9_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17EA9850)
#define CLASS_1_6303FAC302C29AF3_9_EQUALS_OFFSET UNITYSDK_OFFSET(0x17EA9820)
#define CLASS_1_6303FAC302C29AF3_9_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17EA9940)
#define CLASS_1_6303FAC302C29AF3_9_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x17EA9E90)
#define CLASS_1_6303FAC302C29AF3_9_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x17EA9D90)
#define CLASS_1_6303FAC302C29AF3_9_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x17EA97E0)
#define CLASS_1_6303FAC302C29AF3_9_METHOD_1_6E1EC2DF63D7020F_1_OFFSET UNITYSDK_OFFSET(0x17EA9810)
#define CLASS_1_6303FAC302C29AF3_9_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x17EA9800)
#define CLASS_1_6303FAC302C29AF3_9_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x17EA97F0)
#define CLASS_1_6303FAC302C29AF3_9_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17EA9660)
#define CLASS_1_6303FAC302C29AF3_9_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17EA9AE0)
#define CLASS_1_6303FAC302C29AF3_9_WRITETO_OFFSET UNITYSDK_OFFSET(0x17EA9B40)
#define CLASS_1_6303FAC302C29AF3_9__CCTOR_OFFSET UNITYSDK_OFFSET(0x17EA9FA0)
#define CLASS_1_6303FAC302C29AF3_9__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17EA96D0)
#define CLASS_1_6303FAC302C29AF3_9__CTOR_OFFSET UNITYSDK_OFFSET(0x17EA9670)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_352A8B3482C80E7D_49*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6303FAC302C29AF3_9_TypeDefinitionIndex)->GetStaticField(0x2CB00);
	}
	static ::Google::Protobuf::FieldCodec_1<::Class_1_35B19D34B208E77E_22*>** StaticGet_Field_1_4()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_35B19D34B208E77E_22*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6303FAC302C29AF3_9_TypeDefinitionIndex)->GetStaticField(0x2CB08);
	}
	...
	{
		return ((::Google::Protobuf::Collections::RepeatedField_1<::Class_1_352A8B3482C80E7D_49*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_6303FAC302C29AF3_9_METHOD_1_6E1EC2DF63D7020F_1_OFFSET))(this);
	}
