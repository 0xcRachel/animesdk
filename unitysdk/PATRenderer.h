...
#define PATRENDERER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1535B8C0)
#define PATRENDERER_METHOD_5_4EA6B1791DACA9CC_OFFSET UNITYSDK_OFFSET(0x1535BC90)
#define PATRENDERER_METHOD_5_6E3DEABB1FC191BB_OFFSET UNITYSDK_OFFSET(0x1535B260)
#define PATRENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1535C110)
#define PATRENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1535B2E0)
#define PATRENDERER_RESET_OFFSET UNITYSDK_OFFSET(0x1535B330)
#define PATRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x1535C1E0)
