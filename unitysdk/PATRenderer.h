...
#define PATRENDERER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x8CBC7F0)
#define PATRENDERER_METHOD_5_4EA6B1791DACA9CC_OFFSET UNITYSDK_OFFSET(0x8CBCBC0)
#define PATRENDERER_METHOD_5_6E3DEABB1FC191BB_OFFSET UNITYSDK_OFFSET(0x8CBC0F0)
#define PATRENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x8CBD040)
#define PATRENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x8CBC170)
#define PATRENDERER_RESET_OFFSET UNITYSDK_OFFSET(0x8CBC1C0)
#define PATRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x8CBD0E0)
