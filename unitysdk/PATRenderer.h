...
#define PATRENDERER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xFF8C450)
#define PATRENDERER_METHOD_5_4EA6B1791DACA9CC_OFFSET UNITYSDK_OFFSET(0xFF8C820)
#define PATRENDERER_METHOD_5_6E3DEABB1FC191BB_OFFSET UNITYSDK_OFFSET(0xFF8BD50)
#define PATRENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xFF8CCA0)
#define PATRENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xFF8BDD0)
#define PATRENDERER_RESET_OFFSET UNITYSDK_OFFSET(0xFF8BE20)
#define PATRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0xFF8CD40)
