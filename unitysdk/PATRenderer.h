...
#define PATRENDERER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x891D5E0)
#define PATRENDERER_METHOD_5_4EA6B1791DACA9CC_OFFSET UNITYSDK_OFFSET(0x891D9B0)
#define PATRENDERER_METHOD_5_6E3DEABB1FC191BB_OFFSET UNITYSDK_OFFSET(0x891CEE0)
#define PATRENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x891DE30)
#define PATRENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x891CF60)
#define PATRENDERER_RESET_OFFSET UNITYSDK_OFFSET(0x891CFB0)
#define PATRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x891DED0)

inline static constexpr unsigned int PATRenderer_TypeDefinitionIndex = 37342;
