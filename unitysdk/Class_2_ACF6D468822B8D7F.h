...
#define CLASS_2_ACF6D468822B8D7F_DISPOSE_OFFSET UNITYSDK_OFFSET(0x114B8E10)
#define CLASS_2_ACF6D468822B8D7F_METHOD_2_01509228E3A9577B_1_OFFSET UNITYSDK_OFFSET(0x114B9040)
#define CLASS_2_ACF6D468822B8D7F_METHOD_2_01509228E3A9577B_OFFSET UNITYSDK_OFFSET(0x114B8F10)
#define CLASS_2_ACF6D468822B8D7F_METHOD_2_15F0CCBF7346C213_OFFSET UNITYSDK_OFFSET(0x114B92B0)
#define CLASS_2_ACF6D468822B8D7F_METHOD_2_61EC2AC0BD93363E_OFFSET UNITYSDK_OFFSET(0x114B9180)
#define CLASS_2_ACF6D468822B8D7F_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x114B8AE0)
#define CLASS_2_ACF6D468822B8D7F_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x114B8CA0)
#define CLASS_2_ACF6D468822B8D7F_TICK_OFFSET UNITYSDK_OFFSET(0x114B9540)
#define CLASS_2_ACF6D468822B8D7F__CTOR_OFFSET UNITYSDK_OFFSET(0x114B88A0)
...
public:
	...
	::Class_3_5775A4FEC79026BC* Field_2_6; // 0x20
	::Class_3_5775A4FEC79026BC* Field_2_8; // 0x28
	::Class_3_5775A4FEC79026BC* Field_2_2; // 0x30
	::RPG::GameCore::DronesPuzzleEventListener* Field_2_1; // 0x38
	::Class_3_5775A4FEC79026BC* Field_2_4; // 0x40
	::Class_3_5775A4FEC79026BC* Field_2_9; // 0x48
