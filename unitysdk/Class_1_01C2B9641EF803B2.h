...
#define CLASS_1_01C2B9641EF803B2_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A497A30)
#define CLASS_1_01C2B9641EF803B2_CLONE_OFFSET UNITYSDK_OFFSET(0x1A4975D0)
#define CLASS_1_01C2B9641EF803B2_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A4976A0)
#define CLASS_1_01C2B9641EF803B2_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A497670)
#define CLASS_1_01C2B9641EF803B2_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A497770)
#define CLASS_1_01C2B9641EF803B2_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A497D60)
#define CLASS_1_01C2B9641EF803B2_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A497CA0)
#define CLASS_1_01C2B9641EF803B2_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1A497620)
#define CLASS_1_01C2B9641EF803B2_METHOD_1_3DACC45AC8150727_1_OFFSET UNITYSDK_OFFSET(0x1A497650)
#define CLASS_1_01C2B9641EF803B2_METHOD_1_3DACC45AC8150727_OFFSET UNITYSDK_OFFSET(0x1A497610)
#define CLASS_1_01C2B9641EF803B2_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A4974B0)
#define CLASS_1_01C2B9641EF803B2_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x1A497660)
#define CLASS_1_01C2B9641EF803B2_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1A497630)
#define CLASS_1_01C2B9641EF803B2_METHOD_1_A96DCA30C6927810_1_OFFSET UNITYSDK_OFFSET(0x1A497640)
#define CLASS_1_01C2B9641EF803B2_METHOD_1_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x1A497600)
#define CLASS_1_01C2B9641EF803B2_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A4974E0)
#define CLASS_1_01C2B9641EF803B2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A497870)
#define CLASS_1_01C2B9641EF803B2_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A4978D0)
#define CLASS_1_01C2B9641EF803B2__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A497E40)
#define CLASS_1_01C2B9641EF803B2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A497530)
#define CLASS_1_01C2B9641EF803B2__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4974F0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_01C2B9641EF803B2*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_01C2B9641EF803B2_TypeDefinitionIndex)->GetStaticField(0x22EB0);
	}
	static ::Google::Protobuf::FieldCodec_1<::Class_1_C9DFE5EE7107C629_2*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_C9DFE5EE7107C629_2*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_01C2B9641EF803B2_TypeDefinitionIndex)->GetStaticField(0x22EB8);
	}
	...
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_C9DFE5EE7107C629_2*>* Field_1_7; // 0x18
