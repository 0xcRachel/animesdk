...
#define NEWTONSOFT_JSON_SHIMS_PRESERVEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x15DE34A0)

namespace Newtonsoft::Json::Shims
{
	inline static constexpr unsigned int PreserveAttribute_TypeDefinitionIndex = 8160;
