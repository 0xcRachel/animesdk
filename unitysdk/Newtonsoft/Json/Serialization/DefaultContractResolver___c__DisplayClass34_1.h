...
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER___C__DISPLAYCLASS34_1__CTOR_OFFSET UNITYSDK_OFFSET(0x158C0A40)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER___C__DISPLAYCLASS34_1__SETEXTENSIONDATADELEGATES_B__0_OFFSET UNITYSDK_OFFSET(0x158C7B40)
...
namespace Newtonsoft::Json::Serialization
{
	...
	public:
		...
		::Newtonsoft::Json::Serialization::DefaultContractResolver___c__DisplayClass34_0* CS___8__locals1; // 0x28
