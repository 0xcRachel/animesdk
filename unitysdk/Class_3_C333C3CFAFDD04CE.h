...
#define CLASS_3_C333C3CFAFDD04CE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x106C2550)
#define CLASS_3_C333C3CFAFDD04CE_METHOD_3_022B0D58A3077BF2_OFFSET UNITYSDK_OFFSET(0x106C24B0)
#define CLASS_3_C333C3CFAFDD04CE_METHOD_3_CC15D6CD4D3CC816_OFFSET UNITYSDK_OFFSET(0x106C2130)
#define CLASS_3_C333C3CFAFDD04CE_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x106C1D30)
#define CLASS_3_C333C3CFAFDD04CE__CTOR_OFFSET UNITYSDK_OFFSET(0x106C1D00)
#define CLASS_3_C333C3CFAFDD04CE___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x106C2650)
