...
#define CLASS_3_3C4A61C4B2F57B98_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10CB85C0)
#define CLASS_3_3C4A61C4B2F57B98_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10CB8150)
#define CLASS_3_3C4A61C4B2F57B98__CTOR_OFFSET UNITYSDK_OFFSET(0x10CB80A0)
#define CLASS_3_3C4A61C4B2F57B98__ONPAGECANCELCLOSE_OFFSET UNITYSDK_OFFSET(0x10CB83A0)
#define CLASS_3_3C4A61C4B2F57B98__ONPAGECONFIRMCLOSE_OFFSET UNITYSDK_OFFSET(0x10CB8450)
#define CLASS_3_3C4A61C4B2F57B98___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10CB8710)
#define CLASS_3_3C4A61C4B2F57B98___IFIXBASEPROXY_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10CB8640)
#define CLASS_3_3C4A61C4B2F57B98___IFIXBASEPROXY__ONPAGECANCELCLOSE_OFFSET UNITYSDK_OFFSET(0x10CB8650)
#define CLASS_3_3C4A61C4B2F57B98___IFIXBASEPROXY__ONPAGECONFIRMCLOSE_OFFSET UNITYSDK_OFFSET(0x10CB8700)
