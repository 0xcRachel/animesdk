...
#define TA_REFLECTIONTEST_DROPDOWN_OFFSET UNITYSDK_OFFSET(0xA729910)
#define TA_REFLECTIONTEST_SETCUBE_OFFSET UNITYSDK_OFFSET(0xA729FA0)
#define TA_REFLECTIONTEST_SETNONE_OFFSET UNITYSDK_OFFSET(0xA7299F0)
#define TA_REFLECTIONTEST_SETPLANERREFLECTION_OFFSET UNITYSDK_OFFSET(0xA72A100)
#define TA_REFLECTIONTEST_SETREFLECTIONPROBEBOXPROJECTION_OFFSET UNITYSDK_OFFSET(0xA729E70)
#define TA_REFLECTIONTEST_SETREFLECTIONPROBE_OFFSET UNITYSDK_OFFSET(0xA729D40)
#define TA_REFLECTIONTEST_SETSSRTRACEONCE_OFFSET UNITYSDK_OFFSET(0xA72A370)
#define TA_REFLECTIONTEST_SETSSR_OFFSET UNITYSDK_OFFSET(0xA72A230)
#define TA_REFLECTIONTEST_SLIDER_OFFSET UNITYSDK_OFFSET(0xA729850)
#define TA_REFLECTIONTEST__CTOR_OFFSET UNITYSDK_OFFSET(0xA72A450)

inline static constexpr unsigned int TA_ReflectionTest_TypeDefinitionIndex = 37339;
