...
#define CLASS_3_B582BC0A5BC956FE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xEBAE3A0)
#define CLASS_3_B582BC0A5BC956FE_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xEBAE3E0)
#define CLASS_3_B582BC0A5BC956FE__CTOR_OFFSET UNITYSDK_OFFSET(0xEBAE330)
#define CLASS_3_B582BC0A5BC956FE___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xEBAE9D0)
