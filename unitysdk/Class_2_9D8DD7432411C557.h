...
#define CLASS_2_9D8DD7432411C557_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10ED4D60)
#define CLASS_2_9D8DD7432411C557_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10ED4C50)
#define CLASS_2_9D8DD7432411C557_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10ED4D10)
#define CLASS_2_9D8DD7432411C557_TICK_OFFSET UNITYSDK_OFFSET(0x10ED4DA0)
#define CLASS_2_9D8DD7432411C557__CTOR_OFFSET UNITYSDK_OFFSET(0x10ED4C40)

inline static constexpr unsigned int Class_2_9D8DD7432411C557_TypeDefinitionIndex = 46322;

class Class_2_9D8DD7432411C557 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::StartBattleQTE* Field_2_0; // 0x20
