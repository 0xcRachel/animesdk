...
#define CARFLOWINTERSECTIONRULE_ADDCAR_OFFSET UNITYSDK_OFFSET(0x14E3DC00)
#define CARFLOWINTERSECTIONRULE_GETCARLIMIT_OFFSET UNITYSDK_OFFSET(0x14E3DD70)
#define CARFLOWINTERSECTIONRULE_GET_CARS_OFFSET UNITYSDK_OFFSET(0x14E3DBC0)
#define CARFLOWINTERSECTIONRULE_GET_CURVE_OFFSET UNITYSDK_OFFSET(0x14E3DBE0)
#define CARFLOWINTERSECTIONRULE_GET_MATH_OFFSET UNITYSDK_OFFSET(0x14E3DBA0)
#define CARFLOWINTERSECTIONRULE_REMOVECAR_OFFSET UNITYSDK_OFFSET(0x14E3DCE0)
#define CARFLOWINTERSECTIONRULE_SET_CARS_OFFSET UNITYSDK_OFFSET(0x14E3DBD0)
#define CARFLOWINTERSECTIONRULE_SET_CURVE_OFFSET UNITYSDK_OFFSET(0x14E3DBF0)
#define CARFLOWINTERSECTIONRULE_SET_MATH_OFFSET UNITYSDK_OFFSET(0x14E3DBB0)
#define CARFLOWINTERSECTIONRULE__CTOR_OFFSET UNITYSDK_OFFSET(0x14E3DEA0)
