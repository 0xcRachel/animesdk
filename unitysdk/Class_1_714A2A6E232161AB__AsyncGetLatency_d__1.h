...
#define CLASS_1_714A2A6E232161AB__ASYNCGETLATENCY_D__1_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xA6DA9D0)
#define CLASS_1_714A2A6E232161AB__ASYNCGETLATENCY_D__1_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xA6DAC70)
#define CLASS_1_714A2A6E232161AB__ASYNCGETLATENCY_D__1_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xA6DACD0)
#define CLASS_1_714A2A6E232161AB__ASYNCGETLATENCY_D__1_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xA6DAC80)
#define CLASS_1_714A2A6E232161AB__ASYNCGETLATENCY_D__1_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA6DA9C0)
#define CLASS_1_714A2A6E232161AB__ASYNCGETLATENCY_D__1__CTOR_OFFSET UNITYSDK_OFFSET(0xA6DA9B0)

inline static constexpr unsigned int Class_1_714A2A6E232161AB__AsyncGetLatency_d__1_TypeDefinitionIndex = 55107;
