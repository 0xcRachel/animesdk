...
#define CLASS_2_8E99301FCC2CEB3C_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11591070)
#define CLASS_2_8E99301FCC2CEB3C_METHOD_2_61EC2AC0BD93363E_OFFSET UNITYSDK_OFFSET(0x115912B0)
#define CLASS_2_8E99301FCC2CEB3C_METHOD_2_D94D446371432B5F_OFFSET UNITYSDK_OFFSET(0x11591450)
#define CLASS_2_8E99301FCC2CEB3C_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11591110)
#define CLASS_2_8E99301FCC2CEB3C_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x11591610)
#define CLASS_2_8E99301FCC2CEB3C_TICK_OFFSET UNITYSDK_OFFSET(0x115910B0)
#define CLASS_2_8E99301FCC2CEB3C__CTOR_OFFSET UNITYSDK_OFFSET(0x11591020)
...
public:
	...
	::RPG::GameCore::ConfirmCheckpointRecover* Field_2_0; // 0x28
