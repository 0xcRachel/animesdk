...
#define CLASS_2_B5BF53FFA523B5C8_DISPOSE_OFFSET UNITYSDK_OFFSET(0x88A1850)
#define CLASS_2_B5BF53FFA523B5C8_METHOD_2_2B6CDED0FD57C301_OFFSET UNITYSDK_OFFSET(0x88A18B0)
#define CLASS_2_B5BF53FFA523B5C8_METHOD_2_2FED925376FD83FF_OFFSET UNITYSDK_OFFSET(0x88A1AE0)
#define CLASS_2_B5BF53FFA523B5C8_METHOD_2_584A02FA9B54C648_OFFSET UNITYSDK_OFFSET(0x88A25E0)
#define CLASS_2_B5BF53FFA523B5C8_METHOD_2_7EA127DE55AAA205_OFFSET UNITYSDK_OFFSET(0x88A1A20)
#define CLASS_2_B5BF53FFA523B5C8_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x88A17B0)
#define CLASS_2_B5BF53FFA523B5C8_METHOD_2_C4B58FE69BAA9EA7_OFFSET UNITYSDK_OFFSET(0x88A1B70)
#define CLASS_2_B5BF53FFA523B5C8_METHOD_2_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x88A2570)
#define CLASS_2_B5BF53FFA523B5C8_METHOD_2_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0x88A2560)
#define CLASS_2_B5BF53FFA523B5C8_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x88A2550)
#define CLASS_2_B5BF53FFA523B5C8_METHOD_2_FEDE09C198114DBE_OFFSET UNITYSDK_OFFSET(0x88A2580)
#define CLASS_2_B5BF53FFA523B5C8_TICK_OFFSET UNITYSDK_OFFSET(0x88A1C70)
#define CLASS_2_B5BF53FFA523B5C8__CCTOR_OFFSET UNITYSDK_OFFSET(0x88A2660)
#define CLASS_2_B5BF53FFA523B5C8__CTOR_OFFSET UNITYSDK_OFFSET(0x88A2650)
#define CLASS_2_B5BF53FFA523B5C8___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x88A2780)
...
public:
	...
	{
		return (::RPG::GameCore::FixPoint*)Il2CppClass::FromTypeDefinitionIndex(Class_2_B5BF53FFA523B5C8_TypeDefinitionIndex)->GetStaticField(0x12880);
	}
	::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_423*>* Field_2_4; // 0x18
	::Class_0_16E4307DCC419505_422* Field_2_1; // 0x20
	::Class_2_EA46C5F9F8D34AB4* Field_2_3; // 0x28
	::Class_2_702836419F2A50E6* Field_2_2; // 0x30
