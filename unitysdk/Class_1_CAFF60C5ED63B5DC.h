...
#define CLASS_1_CAFF60C5ED63B5DC_CLEAR_OFFSET UNITYSDK_OFFSET(0x16144020)
#define CLASS_1_CAFF60C5ED63B5DC__CTOR_OFFSET UNITYSDK_OFFSET(0x161440A0)

inline static constexpr unsigned int Class_1_CAFF60C5ED63B5DC_TypeDefinitionIndex = 32633;

class Class_1_CAFF60C5ED63B5DC : public ::System::Object
{
public:
	::Class_1_43BD383C98B4C0C5_25* Field_1_1; // 0x10
