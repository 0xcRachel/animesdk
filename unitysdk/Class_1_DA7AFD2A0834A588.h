...
#define CLASS_1_DA7AFD2A0834A588_CLEAR_OFFSET UNITYSDK_OFFSET(0x11576630)
#define CLASS_1_DA7AFD2A0834A588__CTOR_OFFSET UNITYSDK_OFFSET(0x11576690)
...
public:
	...
	::RPG::GameCore::RedirectSkillTargetAffectTeam Field_1_4; // 0x28
