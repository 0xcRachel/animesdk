...
#define FLOATINGPROXYPARTICLE_METHOD_2_F5599B7DA8E7E53C_1_OFFSET UNITYSDK_OFFSET(0xFE848B0)
#define FLOATINGPROXYPARTICLE_METHOD_2_F5599B7DA8E7E53C_OFFSET UNITYSDK_OFFSET(0xFE854F0)
#define FLOATINGPROXYPARTICLE__CTOR_OFFSET UNITYSDK_OFFSET(0x13EF920)

inline static constexpr unsigned int FloatingProxyParticle_TypeDefinitionIndex = 37389;
