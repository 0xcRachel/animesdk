...
#define CLASS_2_3E28D6CB7A8C3FEF_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x10C26F70)
#define CLASS_2_3E28D6CB7A8C3FEF_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x10C27250)
#define CLASS_2_3E28D6CB7A8C3FEF_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x10C24550)
#define CLASS_2_3E28D6CB7A8C3FEF_GET_TRANS_OFFSET UNITYSDK_OFFSET(0x10C24570)
#define CLASS_2_3E28D6CB7A8C3FEF_METHOD_2_078D85152011B919_OFFSET UNITYSDK_OFFSET(0x10C256B0)
#define CLASS_2_3E28D6CB7A8C3FEF_METHOD_2_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0x10C26260)
#define CLASS_2_3E28D6CB7A8C3FEF_METHOD_2_1C1BE26908999AAB_OFFSET UNITYSDK_OFFSET(0x10C25C70)
#define CLASS_2_3E28D6CB7A8C3FEF_METHOD_2_283228DCA08F69C7_OFFSET UNITYSDK_OFFSET(0x10C25930)
#define CLASS_2_3E28D6CB7A8C3FEF_METHOD_2_29FD77BB738B9AAC_OFFSET UNITYSDK_OFFSET(0x10C26480)
#define CLASS_2_3E28D6CB7A8C3FEF_METHOD_2_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x10C26340)
#define CLASS_2_3E28D6CB7A8C3FEF_METHOD_2_3C98CA656474384D_OFFSET UNITYSDK_OFFSET(0x10C242F0)
#define CLASS_2_3E28D6CB7A8C3FEF_METHOD_2_424A8E8E51A30867_OFFSET UNITYSDK_OFFSET(0x10C24720)
#define CLASS_2_3E28D6CB7A8C3FEF_METHOD_2_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x10C24580)
#define CLASS_2_3E28D6CB7A8C3FEF_METHOD_2_489E0B827662C211_OFFSET UNITYSDK_OFFSET(0x10C24A10)
#define CLASS_2_3E28D6CB7A8C3FEF_METHOD_2_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0x10C27640)
#define CLASS_2_3E28D6CB7A8C3FEF_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x10C275E0)
#define CLASS_2_3E28D6CB7A8C3FEF_METHOD_2_760FD1B4F7D8B904_OFFSET UNITYSDK_OFFSET(0x10C25CE0)
#define CLASS_2_3E28D6CB7A8C3FEF_METHOD_2_78E5D10876D30BCC_OFFSET UNITYSDK_OFFSET(0x10C25600)
#define CLASS_2_3E28D6CB7A8C3FEF_METHOD_2_7DFC4B17ACBC8649_OFFSET UNITYSDK_OFFSET(0x10C26000)
#define CLASS_2_3E28D6CB7A8C3FEF_METHOD_2_8B2D6636BADD098E_OFFSET UNITYSDK_OFFSET(0x10C26050)
#define CLASS_2_3E28D6CB7A8C3FEF_METHOD_2_9DEB8DAD24825226_OFFSET UNITYSDK_OFFSET(0x10C266A0)
#define CLASS_2_3E28D6CB7A8C3FEF_METHOD_2_A27D06F9481FAFDB_1_OFFSET UNITYSDK_OFFSET(0x10C26C60)
#define CLASS_2_3E28D6CB7A8C3FEF_METHOD_2_A27D06F9481FAFDB_2_OFFSET UNITYSDK_OFFSET(0x10C26EC0)
#define CLASS_2_3E28D6CB7A8C3FEF_METHOD_2_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0x10C26BA0)
#define CLASS_2_3E28D6CB7A8C3FEF_METHOD_2_A5ADA4706DA592FA_OFFSET UNITYSDK_OFFSET(0x10C25780)
#define CLASS_2_3E28D6CB7A8C3FEF_METHOD_2_B9826750958CBF99_OFFSET UNITYSDK_OFFSET(0x10C25D40)
#define CLASS_2_3E28D6CB7A8C3FEF_METHOD_2_C1C0CB2C8B6124DE_OFFSET UNITYSDK_OFFSET(0x10C26DC0)
#define CLASS_2_3E28D6CB7A8C3FEF_METHOD_2_C832A689ED924B93_OFFSET UNITYSDK_OFFSET(0x10C25B60)
#define CLASS_2_3E28D6CB7A8C3FEF_METHOD_2_C88366FE4C360154_OFFSET UNITYSDK_OFFSET(0x10C26D20)
#define CLASS_2_3E28D6CB7A8C3FEF_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x10C26420)
#define CLASS_2_3E28D6CB7A8C3FEF_METHOD_2_CB7604B59F367726_OFFSET UNITYSDK_OFFSET(0x10C249A0)
#define CLASS_2_3E28D6CB7A8C3FEF_METHOD_2_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x10C24850)
#define CLASS_2_3E28D6CB7A8C3FEF_METHOD_2_D5E5EC1B4538DDD1_OFFSET UNITYSDK_OFFSET(0x10C276A0)
#define CLASS_2_3E28D6CB7A8C3FEF_METHOD_2_E1749789441DFDE9_OFFSET UNITYSDK_OFFSET(0x10C266F0)
#define CLASS_2_3E28D6CB7A8C3FEF_METHOD_2_F4F5C92AD8354C0C_OFFSET UNITYSDK_OFFSET(0x10C262D0)
#define CLASS_2_3E28D6CB7A8C3FEF_METHOD_2_F5710FBB9C77699E_OFFSET UNITYSDK_OFFSET(0x10C259D0)
#define CLASS_2_3E28D6CB7A8C3FEF_SET_INDEX_OFFSET UNITYSDK_OFFSET(0x10C24560)
#define CLASS_2_3E28D6CB7A8C3FEF__CCTOR_OFFSET UNITYSDK_OFFSET(0x10C27540)
#define CLASS_2_3E28D6CB7A8C3FEF__CTOR_OFFSET UNITYSDK_OFFSET(0x10C274F0)
#define CLASS_2_3E28D6CB7A8C3FEF__ONBIND_OFFSET UNITYSDK_OFFSET(0x10C23D80)
#define CLASS_2_3E28D6CB7A8C3FEF__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x10C258F0)
#define CLASS_2_3E28D6CB7A8C3FEF__ONTICK_OFFSET UNITYSDK_OFFSET(0x10C25720)
#define CLASS_2_3E28D6CB7A8C3FEF___IFIXBASEPROXY_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x10C277E0)
#define CLASS_2_3E28D6CB7A8C3FEF___IFIXBASEPROXY_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x10C27840)
#define CLASS_2_3E28D6CB7A8C3FEF___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0x10C27580)
#define CLASS_2_3E28D6CB7A8C3FEF___IFIXBASEPROXY__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x10C27780)
#define CLASS_2_3E28D6CB7A8C3FEF___IFIXBASEPROXY__ONTICK_OFFSET UNITYSDK_OFFSET(0x10C27710)

inline static constexpr unsigned int Class_2_3E28D6CB7A8C3FEF_TypeDefinitionIndex = 58836;
...
public:
	...
	{
		return (::RPG::GameCore::BattleScoringDisplayType*)Il2CppClass::FromTypeDefinitionIndex(Class_2_3E28D6CB7A8C3FEF_TypeDefinitionIndex)->GetStaticField(0xFC60);
	}
	static ::RPG::Client::TextID* StaticGet_Field_2_33()
	{
		return (::RPG::Client::TextID*)Il2CppClass::FromTypeDefinitionIndex(Class_2_3E28D6CB7A8C3FEF_TypeDefinitionIndex)->GetStaticField(0xFC68);
	}
	...
	::RPG::GameCore::LevelDataComponent* Field_2_14; // 0x68
	...
	::UnityEngine::ParticleSystem* Field_2_10; // 0x90
	::UnityEngine::AnimationState* Field_2_16; // 0x98
	::UnityEngine::Animation* Field_2_3; // 0xA0
	::UnityEngine::Transform* Field_2_7; // 0xA8
	::UnityEngine::UI::Text* Field_2_0; // 0xB0
	::UnityEngine::Transform* Field_2_5; // 0xB8
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_2_E5E41715B766E89C*>*>* Field_2_26; // 0xC0
	::UnityEngine::ParticleSystem* Field_2_9; // 0xC8
	::Il2CppArray<::Class_2_DEB067F815EC1625*>* Field_2_19; // 0xD0
	::RPG::GameCore::BattleInstance* Field_2_13; // 0xD8
	::UnityEngine::Transform* Field_2_6; // 0xE0
	::System::Single Field_2_25; // 0xE8
	::System::Int32 _Index_k__BackingField; // 0xEC
	::RPG::GameCore::ScoringShowType Field_2_23; // 0xF0
	::System::Int32 Field_2_20; // 0xF4
	::System::Int32 Field_2_21; // 0xF8
	::Class_2_3E28D6CB7A8C3FEF_AddScoreStatus Field_2_18; // 0xFC
	::System::Boolean Field_2_17; // 0x100
