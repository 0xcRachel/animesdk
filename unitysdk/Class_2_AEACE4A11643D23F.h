...
#define CLASS_2_AEACE4A11643D23F__CTOR_OFFSET UNITYSDK_OFFSET(0x10103800)
#define CLASS_2_AEACE4A11643D23F__UPDATENEWCONTACTPLAYERENTITIES_OFFSET UNITYSDK_OFFSET(0x101038D0)
#define CLASS_2_AEACE4A11643D23F__UPDATEPREVCONTACTPLAYERENTITY_OFFSET UNITYSDK_OFFSET(0x10103D10)
#define CLASS_2_AEACE4A11643D23F___IFIXBASEPROXY__UPDATENEWCONTACTPLAYERENTITIES_OFFSET UNITYSDK_OFFSET(0x10104170)
#define CLASS_2_AEACE4A11643D23F___IFIXBASEPROXY__UPDATEPREVCONTACTPLAYERENTITY_OFFSET UNITYSDK_OFFSET(0x10104180)

inline static constexpr unsigned int Class_2_AEACE4A11643D23F_TypeDefinitionIndex = 70780;

class Class_2_AEACE4A11643D23F : public ::RPG::Client::LittleGame::FiveDim::BaseContactEventSystem_1<::Class_2_9DD8A46984F1AFFD*>
{
public:
	::Class_1_24C2E7EF22229C6A* Field_2_0; // 0x20
