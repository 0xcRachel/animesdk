...
#define CLASS_1_42249E3CE1E8C832_GET_ABILITYCASTSYSTEM_OFFSET UNITYSDK_OFFSET(0x15639F30)
#define CLASS_1_42249E3CE1E8C832_GET_ATTACKSYSTEM_OFFSET UNITYSDK_OFFSET(0x15639F40)
#define CLASS_1_42249E3CE1E8C832_GET_ATTRIBUTESERVICE_OFFSET UNITYSDK_OFFSET(0x15639FA0)
#define CLASS_1_42249E3CE1E8C832_GET_DEATHSYSTEM_OFFSET UNITYSDK_OFFSET(0x15639F50)
#define CLASS_1_42249E3CE1E8C832_GET_DEFAULTLOGGER_OFFSET UNITYSDK_OFFSET(0x15639FC0)
#define CLASS_1_42249E3CE1E8C832_GET_ENTITYFACTORYSERVICE_OFFSET UNITYSDK_OFFSET(0x15639FB0)
#define CLASS_1_42249E3CE1E8C832_GET_ERRORSET_OFFSET UNITYSDK_OFFSET(0x15639F20)
#define CLASS_1_42249E3CE1E8C832_GET_FRAME_OFFSET UNITYSDK_OFFSET(0x15639F00)
#define CLASS_1_42249E3CE1E8C832_GET_GAMESTATESYSTEM_OFFSET UNITYSDK_OFFSET(0x15639F60)
#define CLASS_1_42249E3CE1E8C832_GET_ISSHOWFRAME_OFFSET UNITYSDK_OFFSET(0x15639EE0)
#define CLASS_1_42249E3CE1E8C832_GET_LOGLEVEL_OFFSET UNITYSDK_OFFSET(0x15639ED0)
#define CLASS_1_42249E3CE1E8C832_GET_SUMMONSYSTEM_OFFSET UNITYSDK_OFFSET(0x15639F70)
#define CLASS_1_42249E3CE1E8C832_GET_TEAMBUFFAPPLYSYSTEM_OFFSET UNITYSDK_OFFSET(0x15639F80)
#define CLASS_1_42249E3CE1E8C832_GET_TURNBASEDSYSTEM_OFFSET UNITYSDK_OFFSET(0x15639F90)
#define CLASS_1_42249E3CE1E8C832_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x1563A780)
#define CLASS_1_42249E3CE1E8C832_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1563A730)
#define CLASS_1_42249E3CE1E8C832_METHOD_1_F7F80C1DB6B12DA7_OFFSET UNITYSDK_OFFSET(0x1563A7C0)
#define CLASS_1_42249E3CE1E8C832_SET_DEFAULTLOGGER_OFFSET UNITYSDK_OFFSET(0x15639FD0)
#define CLASS_1_42249E3CE1E8C832_SET_FRAME_OFFSET UNITYSDK_OFFSET(0x15639F10)
#define CLASS_1_42249E3CE1E8C832_SET_ISSHOWFRAME_OFFSET UNITYSDK_OFFSET(0x15639EF0)
#define CLASS_1_42249E3CE1E8C832__CTOR_OFFSET UNITYSDK_OFFSET(0x15639FE0)

inline static constexpr unsigned int Class_1_42249E3CE1E8C832_TypeDefinitionIndex = 71938;
...
public:
	...
	{
		return (::Class_2_5CA1A9ACCB0D1579**)Il2CppClass::FromTypeDefinitionIndex(Class_1_42249E3CE1E8C832_TypeDefinitionIndex)->GetStaticField(0x11B00);
	}
	::Class_3_8AFABE97DEF4F04F* _EntityFactoryService_k__BackingField; // 0x10
	::Class_3_76CFD1EB9822836A* _GameStateSystem_k__BackingField; // 0x18
	::System::Collections::Generic::HashSet_1<::System::String*>* _ErrorSet_k__BackingField; // 0x20
	::Class_3_6308BB11B982E5EE* _SummonSystem_k__BackingField; // 0x28
	::Class_3_0F68A20F9F5DDBFF* _TurnBasedSystem_k__BackingField; // 0x30
	::Class_3_89AD00E04815C359* _DeathSystem_k__BackingField; // 0x38
	::Class_3_2E396E206DB7778F* _AttributeService_k__BackingField; // 0x40
	...
	::Class_3_DCB7F8B839F0C44B_3* _TeamBuffApplySystem_k__BackingField; // 0x58
