...
#define CLASS_1_5B567C8A01BAEDFE_191_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1B2B63E0)
#define CLASS_1_5B567C8A01BAEDFE_191_CLONE_OFFSET UNITYSDK_OFFSET(0x1B2B61F0)
#define CLASS_1_5B567C8A01BAEDFE_191_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1B2B62F0)
#define CLASS_1_5B567C8A01BAEDFE_191_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B2B6260)
#define CLASS_1_5B567C8A01BAEDFE_191_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B2B6340)
#define CLASS_1_5B567C8A01BAEDFE_191_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1B2B6430)
#define CLASS_1_5B567C8A01BAEDFE_191_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1B2B6400)
#define CLASS_1_5B567C8A01BAEDFE_191_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1B2B6140)
#define CLASS_1_5B567C8A01BAEDFE_191_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1B2B61A0)
#define CLASS_1_5B567C8A01BAEDFE_191_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B2B6370)
#define CLASS_1_5B567C8A01BAEDFE_191_WRITETO_OFFSET UNITYSDK_OFFSET(0x1B2B63D0)
#define CLASS_1_5B567C8A01BAEDFE_191__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B2B6480)
#define CLASS_1_5B567C8A01BAEDFE_191__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B2B61C0)
#define CLASS_1_5B567C8A01BAEDFE_191__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2B61B0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_191*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_191_TypeDefinitionIndex)->GetStaticField(0x12280);
	}
