...
#define CLASS_2_B3FA84AEDE7EDD25_DISPOSE_OFFSET UNITYSDK_OFFSET(0x105BD580)
#define CLASS_2_B3FA84AEDE7EDD25_METHOD_2_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0x105BD7D0)
#define CLASS_2_B3FA84AEDE7EDD25_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x105BD710)
#define CLASS_2_B3FA84AEDE7EDD25_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x105BD600)
#define CLASS_2_B3FA84AEDE7EDD25_TICK_OFFSET UNITYSDK_OFFSET(0x105BD6B0)
#define CLASS_2_B3FA84AEDE7EDD25__CTOR_OFFSET UNITYSDK_OFFSET(0x105BD450)

inline static constexpr unsigned int Class_2_B3FA84AEDE7EDD25_TypeDefinitionIndex = 42257;

class Class_2_B3FA84AEDE7EDD25 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::Client::RuntimeGroupManager* Field_2_3; // 0x18
