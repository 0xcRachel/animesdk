...
#define IRI_BASEBUILDINGCUSTOMDATA_INDEPENDENTRENDEROBJ_METHOD_1_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x111F02E0)
#define IRI_BASEBUILDINGCUSTOMDATA_INDEPENDENTRENDEROBJ_METHOD_1_7900DB25C44BBC9B_OFFSET UNITYSDK_OFFSET(0x111EFC00)
#define IRI_BASEBUILDINGCUSTOMDATA_INDEPENDENTRENDEROBJ_METHOD_1_C11C8C2B79548B66_OFFSET UNITYSDK_OFFSET(0x111EFC50)
#define IRI_BASEBUILDINGCUSTOMDATA_INDEPENDENTRENDEROBJ__CTOR_OFFSET UNITYSDK_OFFSET(0x111F0370)
