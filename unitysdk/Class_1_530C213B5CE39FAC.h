...
#define CLASS_1_530C213B5CE39FAC_GET_MIRACLE_OFFSET UNITYSDK_OFFSET(0xFCC8F30)
#define CLASS_1_530C213B5CE39FAC_GET_SOURCE_OFFSET UNITYSDK_OFFSET(0xFCC8F40)
#define CLASS_1_530C213B5CE39FAC_TOSTRING_OFFSET UNITYSDK_OFFSET(0xFCC8DD0)
#define CLASS_1_530C213B5CE39FAC_TRIGGERACTION_OFFSET UNITYSDK_OFFSET(0xFCC8E70)
#define CLASS_1_530C213B5CE39FAC__CTOR_OFFSET UNITYSDK_OFFSET(0xFCC8DC0)
#define CLASS_1_530C213B5CE39FAC___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0xFCC8F50)
