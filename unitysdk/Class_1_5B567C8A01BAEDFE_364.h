...
#define CLASS_1_5B567C8A01BAEDFE_364_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A3289E0)
#define CLASS_1_5B567C8A01BAEDFE_364_CLONE_OFFSET UNITYSDK_OFFSET(0x1A328850)
#define CLASS_1_5B567C8A01BAEDFE_364_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A3288F0)
#define CLASS_1_5B567C8A01BAEDFE_364_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A328890)
#define CLASS_1_5B567C8A01BAEDFE_364_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A328940)
#define CLASS_1_5B567C8A01BAEDFE_364_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A328A30)
#define CLASS_1_5B567C8A01BAEDFE_364_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A328A00)
#define CLASS_1_5B567C8A01BAEDFE_364_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A3287D0)
#define CLASS_1_5B567C8A01BAEDFE_364_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A328800)
#define CLASS_1_5B567C8A01BAEDFE_364_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A328970)
#define CLASS_1_5B567C8A01BAEDFE_364_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A3289D0)
#define CLASS_1_5B567C8A01BAEDFE_364__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A328A80)
#define CLASS_1_5B567C8A01BAEDFE_364__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A328820)
#define CLASS_1_5B567C8A01BAEDFE_364__CTOR_OFFSET UNITYSDK_OFFSET(0x1A328810)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_364*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_364_TypeDefinitionIndex)->GetStaticField(0x184D0);
	}
