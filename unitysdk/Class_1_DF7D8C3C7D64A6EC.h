...
#define CLASS_1_DF7D8C3C7D64A6EC_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8A79BB0)
#define CLASS_1_DF7D8C3C7D64A6EC_ENTER_OFFSET UNITYSDK_OFFSET(0x8A79730)
#define CLASS_1_DF7D8C3C7D64A6EC_GETGAMEPHASETYPE_OFFSET UNITYSDK_OFFSET(0x8A79CD0)
#define CLASS_1_DF7D8C3C7D64A6EC_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x8A79A10)
#define CLASS_1_DF7D8C3C7D64A6EC_LEAVE_OFFSET UNITYSDK_OFFSET(0x8A79B60)
#define CLASS_1_DF7D8C3C7D64A6EC_METHOD_1_0076C796B2045359_OFFSET UNITYSDK_OFFSET(0x8A79F50)
#define CLASS_1_DF7D8C3C7D64A6EC_METHOD_1_0608E01D4DD006F1_OFFSET UNITYSDK_OFFSET(0x8A79930)
#define CLASS_1_DF7D8C3C7D64A6EC_METHOD_1_078D85152011B919_OFFSET UNITYSDK_OFFSET(0x8A7A2B0)
#define CLASS_1_DF7D8C3C7D64A6EC_METHOD_1_2DC57A98C12C3B08_OFFSET UNITYSDK_OFFSET(0x8A79DE0)
#define CLASS_1_DF7D8C3C7D64A6EC_METHOD_1_5F763FD57D51C81C_OFFSET UNITYSDK_OFFSET(0x8A79D20)
#define CLASS_1_DF7D8C3C7D64A6EC_METHOD_1_6105334A729F22E3_OFFSET UNITYSDK_OFFSET(0x8A79EB0)
#define CLASS_1_DF7D8C3C7D64A6EC_METHOD_1_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0x8A7A4B0)
#define CLASS_1_DF7D8C3C7D64A6EC_METHOD_1_F8B73ECE7F883AC1_1_OFFSET UNITYSDK_OFFSET(0x8A79DA0)
#define CLASS_1_DF7D8C3C7D64A6EC_METHOD_1_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0x8A79D60)
#define CLASS_1_DF7D8C3C7D64A6EC_TICK_OFFSET UNITYSDK_OFFSET(0x8A799B0)
#define CLASS_1_DF7D8C3C7D64A6EC__CCTOR_OFFSET UNITYSDK_OFFSET(0x8A7A6A0)
#define CLASS_1_DF7D8C3C7D64A6EC__CTOR_OFFSET UNITYSDK_OFFSET(0x8A79700)
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_DF7D8C3C7D64A6EC_TypeDefinitionIndex)->GetStaticField(0x43830);
	}
	::Class_1_72FF3C03F0F06A80* Field_1_7; // 0x10
	::RPG::Client::EnvironmentSystem* Field_1_0; // 0x18
	::Class_1_004034A1FAAF468A* Field_1_9; // 0x20
	::RPG::GameCore::GameWorld* Field_1_1; // 0x28
	::UnityEngine::Camera* Field_1_5; // 0x30
	::RPG::Client::FirstViewCamera* Field_1_8; // 0x38
	::Class_1_072464205E5547B5* Field_1_6; // 0x40
	::Class_1_180D5F47839854B4* Field_1_2; // 0x48
	::RPG::Client::AdventureMapTestInitParams* Field_1_4; // 0x50
