...
#define CLASS_3_B30DA02A6C5C3D30_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xE3B8970)
#define CLASS_3_B30DA02A6C5C3D30__CTOR_OFFSET UNITYSDK_OFFSET(0xE3B8930)
#define CLASS_3_B30DA02A6C5C3D30__ONPAGECONFIRMCLOSE_OFFSET UNITYSDK_OFFSET(0xE3B8B60)
#define CLASS_3_B30DA02A6C5C3D30___IFIXBASEPROXY_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xE3B8C80)
#define CLASS_3_B30DA02A6C5C3D30___IFIXBASEPROXY__ONPAGECONFIRMCLOSE_OFFSET UNITYSDK_OFFSET(0xE3B8C90)
