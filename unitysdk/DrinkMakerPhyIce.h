...
#define DRINKMAKERPHYICE_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xAD7FBF0)
#define DRINKMAKERPHYICE_METHOD_5_0BDFAC56E6B704CB_OFFSET UNITYSDK_OFFSET(0xAD7F080)
#define DRINKMAKERPHYICE_METHOD_5_0D7638DBC93E5002_OFFSET UNITYSDK_OFFSET(0xAD7FA90)
#define DRINKMAKERPHYICE_METHOD_5_10054BB010E03EDD_OFFSET UNITYSDK_OFFSET(0xAD7F260)
#define DRINKMAKERPHYICE_METHOD_5_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0xAD7EF90)
#define DRINKMAKERPHYICE_METHOD_5_A1781348F0A89177_OFFSET UNITYSDK_OFFSET(0xAD7F730)
#define DRINKMAKERPHYICE_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xAD7FD00)
#define DRINKMAKERPHYICE_START_OFFSET UNITYSDK_OFFSET(0xAD7EE00)
#define DRINKMAKERPHYICE__CTOR_OFFSET UNITYSDK_OFFSET(0xAD80460)
