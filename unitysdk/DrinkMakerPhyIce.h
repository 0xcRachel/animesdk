...
#define DRINKMAKERPHYICE_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xB2BE420)
#define DRINKMAKERPHYICE_METHOD_5_0BDFAC56E6B704CB_OFFSET UNITYSDK_OFFSET(0xB2BD8E0)
#define DRINKMAKERPHYICE_METHOD_5_0D7638DBC93E5002_OFFSET UNITYSDK_OFFSET(0xB2BE2C0)
#define DRINKMAKERPHYICE_METHOD_5_10054BB010E03EDD_OFFSET UNITYSDK_OFFSET(0xB2BDAC0)
#define DRINKMAKERPHYICE_METHOD_5_1ABF1CBED7A4AF0A_OFFSET UNITYSDK_OFFSET(0xB2BDF90)
#define DRINKMAKERPHYICE_METHOD_5_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0xB2BD7F0)
#define DRINKMAKERPHYICE_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xB2BE530)
#define DRINKMAKERPHYICE_START_OFFSET UNITYSDK_OFFSET(0xB2BD660)
#define DRINKMAKERPHYICE__CTOR_OFFSET UNITYSDK_OFFSET(0xB2BECB0)

inline static constexpr unsigned int DrinkMakerPhyIce_TypeDefinitionIndex = 37135;
