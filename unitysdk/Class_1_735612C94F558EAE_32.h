...
#define CLASS_1_735612C94F558EAE_32_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1791B0C0)
#define CLASS_1_735612C94F558EAE_32_CLONE_OFFSET UNITYSDK_OFFSET(0x1791AC20)
#define CLASS_1_735612C94F558EAE_32_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1791AD30)
#define CLASS_1_735612C94F558EAE_32_EQUALS_OFFSET UNITYSDK_OFFSET(0x1791AC70)
#define CLASS_1_735612C94F558EAE_32_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1791ADE0)
#define CLASS_1_735612C94F558EAE_32_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1791B1B0)
#define CLASS_1_735612C94F558EAE_32_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1791B150)
#define CLASS_1_735612C94F558EAE_32_METHOD_1_554199E0076172C5_1_OFFSET UNITYSDK_OFFSET(0x1791AC60)
#define CLASS_1_735612C94F558EAE_32_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1791AC50)
#define CLASS_1_735612C94F558EAE_32_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1791AAA0)
#define CLASS_1_735612C94F558EAE_32_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1791AFC0)
#define CLASS_1_735612C94F558EAE_32_WRITETO_OFFSET UNITYSDK_OFFSET(0x1791B020)
#define CLASS_1_735612C94F558EAE_32__CCTOR_OFFSET UNITYSDK_OFFSET(0x1791B2E0)
#define CLASS_1_735612C94F558EAE_32__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1791AB40)
#define CLASS_1_735612C94F558EAE_32__CTOR_OFFSET UNITYSDK_OFFSET(0x1791AAB0)

inline static constexpr unsigned int Class_1_735612C94F558EAE_32_TypeDefinitionIndex = 24287;
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_735612C94F558EAE_32_TypeDefinitionIndex)->GetStaticField(0x37640);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_5()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_735612C94F558EAE_32_TypeDefinitionIndex)->GetStaticField(0x37648);
	}
	...
	{
		return ((::Google::Protobuf::Collections::RepeatedField_1<::System::UInt32>*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_735612C94F558EAE_32_METHOD_1_554199E0076172C5_1_OFFSET))(this);
	}
