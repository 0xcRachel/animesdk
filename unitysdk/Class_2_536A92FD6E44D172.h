...
#define CLASS_2_536A92FD6E44D172_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10EBF4C0)
#define CLASS_2_536A92FD6E44D172_METHOD_2_AC1BFDB3D2FC0C79_OFFSET UNITYSDK_OFFSET(0x10EBF670)
#define CLASS_2_536A92FD6E44D172_METHOD_2_B1936CE4DA97AA45_1_OFFSET UNITYSDK_OFFSET(0x10EBF850)
#define CLASS_2_536A92FD6E44D172_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x10EBF740)
#define CLASS_2_536A92FD6E44D172_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10EBF5C0)
#define CLASS_2_536A92FD6E44D172_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10EBF7E0)
#define CLASS_2_536A92FD6E44D172_TICK_OFFSET UNITYSDK_OFFSET(0x10EBF540)
#define CLASS_2_536A92FD6E44D172__CTOR_OFFSET UNITYSDK_OFFSET(0x10EBF0C0)

inline static constexpr unsigned int Class_2_536A92FD6E44D172_TypeDefinitionIndex = 41392;

class Class_2_536A92FD6E44D172 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::Client::CameraBlendCurve* Field_2_3; // 0x18
	::RPG::GameCore::TaskContext* Field_2_0; // 0x20
	::RPG::GameCore::AdvNpcFollowPlayer* Field_2_1; // 0x28
