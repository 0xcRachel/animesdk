...
#define CLASS_1_5B567C8A01BAEDFE_269_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1AFEB860)
#define CLASS_1_5B567C8A01BAEDFE_269_CLONE_OFFSET UNITYSDK_OFFSET(0x1AFEB6D0)
#define CLASS_1_5B567C8A01BAEDFE_269_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1AFEB770)
#define CLASS_1_5B567C8A01BAEDFE_269_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AFEB710)
#define CLASS_1_5B567C8A01BAEDFE_269_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AFEB7C0)
#define CLASS_1_5B567C8A01BAEDFE_269_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1AFEB8B0)
#define CLASS_1_5B567C8A01BAEDFE_269_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1AFEB880)
#define CLASS_1_5B567C8A01BAEDFE_269_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1AFEB650)
#define CLASS_1_5B567C8A01BAEDFE_269_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1AFEB680)
#define CLASS_1_5B567C8A01BAEDFE_269_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AFEB7F0)
#define CLASS_1_5B567C8A01BAEDFE_269_WRITETO_OFFSET UNITYSDK_OFFSET(0x1AFEB850)
#define CLASS_1_5B567C8A01BAEDFE_269__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AFEB900)
#define CLASS_1_5B567C8A01BAEDFE_269__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AFEB6A0)
#define CLASS_1_5B567C8A01BAEDFE_269__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFEB690)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_269*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_269_TypeDefinitionIndex)->GetStaticField(0x2F790);
	}
