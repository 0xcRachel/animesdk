...
#define CLASS_1_A7A4B83BB51BED0E_GET_FACESIZE_OFFSET UNITYSDK_OFFSET(0xECBE680)
#define CLASS_1_A7A4B83BB51BED0E_GET_FOGS_OFFSET UNITYSDK_OFFSET(0xECBE6A0)
#define CLASS_1_A7A4B83BB51BED0E_GET_SECTIONS_OFFSET UNITYSDK_OFFSET(0xECBE660)
#define CLASS_1_A7A4B83BB51BED0E_GET_SECTIONVERTICES_OFFSET UNITYSDK_OFFSET(0xECBE640)
#define CLASS_1_A7A4B83BB51BED0E_METHOD_1_FE8B82EDFBB3BD3F_OFFSET UNITYSDK_OFFSET(0xECBE0A0)
#define CLASS_1_A7A4B83BB51BED0E_SET_FACESIZE_OFFSET UNITYSDK_OFFSET(0xECBE690)
#define CLASS_1_A7A4B83BB51BED0E_SET_FOGS_OFFSET UNITYSDK_OFFSET(0xECBE6B0)
#define CLASS_1_A7A4B83BB51BED0E_SET_SECTIONS_OFFSET UNITYSDK_OFFSET(0xECBE670)
#define CLASS_1_A7A4B83BB51BED0E_SET_SECTIONVERTICES_OFFSET UNITYSDK_OFFSET(0xECBE650)
#define CLASS_1_A7A4B83BB51BED0E__CTOR_OFFSET UNITYSDK_OFFSET(0xECBE600)

inline static constexpr unsigned int Class_1_A7A4B83BB51BED0E_TypeDefinitionIndex = 68899;
