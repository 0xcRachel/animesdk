...
#define CLASS_1_A7A4B83BB51BED0E_GET_FACESIZE_OFFSET UNITYSDK_OFFSET(0x111C2CA0)
#define CLASS_1_A7A4B83BB51BED0E_GET_FOGS_OFFSET UNITYSDK_OFFSET(0x111C2CC0)
#define CLASS_1_A7A4B83BB51BED0E_GET_SECTIONS_OFFSET UNITYSDK_OFFSET(0x111C2C80)
#define CLASS_1_A7A4B83BB51BED0E_GET_SECTIONVERTICES_OFFSET UNITYSDK_OFFSET(0x111C2C60)
#define CLASS_1_A7A4B83BB51BED0E_METHOD_1_FE8B82EDFBB3BD3F_OFFSET UNITYSDK_OFFSET(0x111C25E0)
#define CLASS_1_A7A4B83BB51BED0E_SET_FACESIZE_OFFSET UNITYSDK_OFFSET(0x111C2CB0)
#define CLASS_1_A7A4B83BB51BED0E_SET_FOGS_OFFSET UNITYSDK_OFFSET(0x111C2CD0)
#define CLASS_1_A7A4B83BB51BED0E_SET_SECTIONS_OFFSET UNITYSDK_OFFSET(0x111C2C90)
#define CLASS_1_A7A4B83BB51BED0E_SET_SECTIONVERTICES_OFFSET UNITYSDK_OFFSET(0x111C2C70)
#define CLASS_1_A7A4B83BB51BED0E__CTOR_OFFSET UNITYSDK_OFFSET(0x111C2BB0)

inline static constexpr unsigned int Class_1_A7A4B83BB51BED0E_TypeDefinitionIndex = 59637;
