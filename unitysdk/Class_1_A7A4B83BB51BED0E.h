...
#define CLASS_1_A7A4B83BB51BED0E_GET_FACESIZE_OFFSET UNITYSDK_OFFSET(0x10CAD7E0)
#define CLASS_1_A7A4B83BB51BED0E_GET_FOGS_OFFSET UNITYSDK_OFFSET(0x10CAD800)
#define CLASS_1_A7A4B83BB51BED0E_GET_SECTIONS_OFFSET UNITYSDK_OFFSET(0x10CAD7C0)
#define CLASS_1_A7A4B83BB51BED0E_GET_SECTIONVERTICES_OFFSET UNITYSDK_OFFSET(0x10CAD7A0)
#define CLASS_1_A7A4B83BB51BED0E_METHOD_1_FE8B82EDFBB3BD3F_OFFSET UNITYSDK_OFFSET(0x10CAD200)
#define CLASS_1_A7A4B83BB51BED0E_SET_FACESIZE_OFFSET UNITYSDK_OFFSET(0x10CAD7F0)
#define CLASS_1_A7A4B83BB51BED0E_SET_FOGS_OFFSET UNITYSDK_OFFSET(0x10CAD810)
#define CLASS_1_A7A4B83BB51BED0E_SET_SECTIONS_OFFSET UNITYSDK_OFFSET(0x10CAD7D0)
#define CLASS_1_A7A4B83BB51BED0E_SET_SECTIONVERTICES_OFFSET UNITYSDK_OFFSET(0x10CAD7B0)
#define CLASS_1_A7A4B83BB51BED0E__CTOR_OFFSET UNITYSDK_OFFSET(0x10CAD760)

inline static constexpr unsigned int Class_1_A7A4B83BB51BED0E_TypeDefinitionIndex = 61393;
