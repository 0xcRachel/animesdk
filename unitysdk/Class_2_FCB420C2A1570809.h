...
#define CLASS_2_FCB420C2A1570809__CTOR_1_OFFSET UNITYSDK_OFFSET(0x16758F20)
#define CLASS_2_FCB420C2A1570809__CTOR_2_OFFSET UNITYSDK_OFFSET(0x16758F30)
#define CLASS_2_FCB420C2A1570809__CTOR_OFFSET UNITYSDK_OFFSET(0x16758F10)

inline static constexpr unsigned int Class_2_FCB420C2A1570809_TypeDefinitionIndex = 22263;
