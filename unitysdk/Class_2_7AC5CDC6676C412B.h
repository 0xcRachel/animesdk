...
#define CLASS_2_7AC5CDC6676C412B_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x10FDC640)
#define CLASS_2_7AC5CDC6676C412B_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x10FDCBB0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x10FDBF50)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_2377E17936196E10_OFFSET UNITYSDK_OFFSET(0x10FDB0C0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_3CAB3F134E5CEF52_OFFSET UNITYSDK_OFFSET(0x10FDAA90)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x10FD97C0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0x10FDD370)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x10FDD2A0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_62D8D456C60B1D9D_OFFSET UNITYSDK_OFFSET(0x10FDB150)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_67622E8270A5AACD_OFFSET UNITYSDK_OFFSET(0x10FDBEA0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_67AEFE17318883D4_OFFSET UNITYSDK_OFFSET(0x10FDA280)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_8542E37E74FDE1B5_OFFSET UNITYSDK_OFFSET(0x10FD99A0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_87A84693C939DE46_OFFSET UNITYSDK_OFFSET(0x10FDB5B0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_88BEF7B7499FDBAA_OFFSET UNITYSDK_OFFSET(0x10FDA600)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_99C9EEE541D93457_OFFSET UNITYSDK_OFFSET(0x10FDA460)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_A27D06F9481FAFDB_1_OFFSET UNITYSDK_OFFSET(0x10FDC1E0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_A27D06F9481FAFDB_2_OFFSET UNITYSDK_OFFSET(0x10FDC2F0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_A27D06F9481FAFDB_3_OFFSET UNITYSDK_OFFSET(0x10FDC400)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_A27D06F9481FAFDB_4_OFFSET UNITYSDK_OFFSET(0x10FDC5E0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0x10FDBFB0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0x10FDA3C0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_B2D0C393C5A33FA5_OFFSET UNITYSDK_OFFSET(0x10FDA560)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_B387E1AED8A8F880_OFFSET UNITYSDK_OFFSET(0x10FDB540)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_C1C0CB2C8B6124DE_1_OFFSET UNITYSDK_OFFSET(0x10FDC510)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_C1C0CB2C8B6124DE_OFFSET UNITYSDK_OFFSET(0x10FDC080)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_C3FA16B393076D2B_OFFSET UNITYSDK_OFFSET(0x10FDB030)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_CCD88C0D86A5A786_OFFSET UNITYSDK_OFFSET(0x10FD9A60)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_CF8551534BA217CC_OFFSET UNITYSDK_OFFSET(0x10FD9ED0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_DAFD4F26397DCF6C_OFFSET UNITYSDK_OFFSET(0x10FDAA00)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_DD152A1A30757DCD_OFFSET UNITYSDK_OFFSET(0x10FD99F0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_DFB53B789DEB4FB5_OFFSET UNITYSDK_OFFSET(0x10FDA2F0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_FD3B916300F77FDA_OFFSET UNITYSDK_OFFSET(0x10FD9940)
#define CLASS_2_7AC5CDC6676C412B__CTOR_OFFSET UNITYSDK_OFFSET(0x10FDD0F0)
#define CLASS_2_7AC5CDC6676C412B__ONBIND_OFFSET UNITYSDK_OFFSET(0x10FD9740)
#define CLASS_2_7AC5CDC6676C412B__ONTICK_OFFSET UNITYSDK_OFFSET(0x10FD98D0)
#define CLASS_2_7AC5CDC6676C412B__PLAYFADE_B__8_0_OFFSET UNITYSDK_OFFSET(0x10FDD200)
#define CLASS_2_7AC5CDC6676C412B___IFIXBASEPROXY_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x10FDD3D0)
#define CLASS_2_7AC5CDC6676C412B___IFIXBASEPROXY_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x10FDD430)
#define CLASS_2_7AC5CDC6676C412B___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0x10FDD240)
#define CLASS_2_7AC5CDC6676C412B___IFIXBASEPROXY__ONTICK_OFFSET UNITYSDK_OFFSET(0x10FDD300)

inline static constexpr unsigned int Class_2_7AC5CDC6676C412B_TypeDefinitionIndex = 57103;
...
public:
	...
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_0_16E4307DCC419505_775*>* Field_2_2; // 0x78
	::UnityEngine::Animation* Field_2_0; // 0x80
	::Class_1_23F67DD15593C8D6* Field_2_6; // 0x88
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::GameCore::GameEntity*>* Field_2_3; // 0x90
