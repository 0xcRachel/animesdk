...
#define CLASS_2_7AC5CDC6676C412B_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xB89F2D0)
#define CLASS_2_7AC5CDC6676C412B_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xB89F840)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xB89EBE0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_2377E17936196E10_OFFSET UNITYSDK_OFFSET(0xB89DD30)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_3CAB3F134E5CEF52_OFFSET UNITYSDK_OFFSET(0xB89D710)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xB89C470)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0xB8A0000)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xB89FF30)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_62D8D456C60B1D9D_OFFSET UNITYSDK_OFFSET(0xB89DDB0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_67AEFE17318883D4_OFFSET UNITYSDK_OFFSET(0xB89CF30)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_8542E37E74FDE1B5_OFFSET UNITYSDK_OFFSET(0xB89C650)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_87A84693C939DE46_OFFSET UNITYSDK_OFFSET(0xB89E220)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_88BEF7B7499FDBAA_OFFSET UNITYSDK_OFFSET(0xB89D2A0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_99C9EEE541D93457_OFFSET UNITYSDK_OFFSET(0xB89D100)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_A27D06F9481FAFDB_1_OFFSET UNITYSDK_OFFSET(0xB89EE70)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_A27D06F9481FAFDB_2_OFFSET UNITYSDK_OFFSET(0xB89EF80)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_A27D06F9481FAFDB_3_OFFSET UNITYSDK_OFFSET(0xB89F090)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_A27D06F9481FAFDB_4_OFFSET UNITYSDK_OFFSET(0xB89F270)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0xB89EC40)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0xB89D070)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_B2D0C393C5A33FA5_OFFSET UNITYSDK_OFFSET(0xB89D200)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_B387E1AED8A8F880_OFFSET UNITYSDK_OFFSET(0xB89E1A0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_C1C0CB2C8B6124DE_1_OFFSET UNITYSDK_OFFSET(0xB89F1A0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_C1C0CB2C8B6124DE_OFFSET UNITYSDK_OFFSET(0xB89ED10)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_C3FA16B393076D2B_OFFSET UNITYSDK_OFFSET(0xB89DCB0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_CCD88C0D86A5A786_OFFSET UNITYSDK_OFFSET(0xB89C710)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_CF8551534BA217CC_OFFSET UNITYSDK_OFFSET(0xB89CB80)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_DAFD4F26397DCF6C_OFFSET UNITYSDK_OFFSET(0xB89D690)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_DD152A1A30757DCD_OFFSET UNITYSDK_OFFSET(0xB89C6A0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_DFB53B789DEB4FB5_OFFSET UNITYSDK_OFFSET(0xB89CFA0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_F49AADE07313BF76_OFFSET UNITYSDK_OFFSET(0xB89EB10)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_FD3B916300F77FDA_OFFSET UNITYSDK_OFFSET(0xB89C5F0)
#define CLASS_2_7AC5CDC6676C412B__CTOR_OFFSET UNITYSDK_OFFSET(0xB89FD80)
#define CLASS_2_7AC5CDC6676C412B__ONBIND_OFFSET UNITYSDK_OFFSET(0xB89C340)
#define CLASS_2_7AC5CDC6676C412B__ONTICK_OFFSET UNITYSDK_OFFSET(0xB89C580)
#define CLASS_2_7AC5CDC6676C412B__PLAYFADE_B__8_0_OFFSET UNITYSDK_OFFSET(0xB89FE90)
#define CLASS_2_7AC5CDC6676C412B___IFIXBASEPROXY_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xB8A0060)
#define CLASS_2_7AC5CDC6676C412B___IFIXBASEPROXY_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xB8A00C0)
#define CLASS_2_7AC5CDC6676C412B___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0xB89FED0)
#define CLASS_2_7AC5CDC6676C412B___IFIXBASEPROXY__ONTICK_OFFSET UNITYSDK_OFFSET(0xB89FF90)

inline static constexpr unsigned int Class_2_7AC5CDC6676C412B_TypeDefinitionIndex = 58695;
...
public:
	...
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_0_16E4307DCC419505_842*>* Field_2_2; // 0x80
	::UnityEngine::Animation* Field_2_5; // 0x88
	::Class_1_23F67DD15593C8D6* Field_2_6; // 0x90
