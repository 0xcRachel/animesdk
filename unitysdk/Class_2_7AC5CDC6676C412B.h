...
#define CLASS_2_7AC5CDC6676C412B_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x102FCDF0)
#define CLASS_2_7AC5CDC6676C412B_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x102FD2A0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x102FC700)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_2377E17936196E10_OFFSET UNITYSDK_OFFSET(0x102FB870)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_3CAB3F134E5CEF52_OFFSET UNITYSDK_OFFSET(0x102FB240)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x102F9F60)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0x102FD9A0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x102FD8D0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_62D8D456C60B1D9D_OFFSET UNITYSDK_OFFSET(0x102FB900)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_67622E8270A5AACD_OFFSET UNITYSDK_OFFSET(0x102FC650)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_67AEFE17318883D4_OFFSET UNITYSDK_OFFSET(0x102FAA30)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_8542E37E74FDE1B5_OFFSET UNITYSDK_OFFSET(0x102FA150)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_87A84693C939DE46_OFFSET UNITYSDK_OFFSET(0x102FBD60)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_88BEF7B7499FDBAA_OFFSET UNITYSDK_OFFSET(0x102FADB0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_99C9EEE541D93457_OFFSET UNITYSDK_OFFSET(0x102FAC10)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_A27D06F9481FAFDB_1_OFFSET UNITYSDK_OFFSET(0x102FC990)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_A27D06F9481FAFDB_2_OFFSET UNITYSDK_OFFSET(0x102FCAA0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_A27D06F9481FAFDB_3_OFFSET UNITYSDK_OFFSET(0x102FCBB0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_A27D06F9481FAFDB_4_OFFSET UNITYSDK_OFFSET(0x102FCD90)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0x102FC760)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0x102FAB70)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_B2D0C393C5A33FA5_OFFSET UNITYSDK_OFFSET(0x102FAD10)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_B387E1AED8A8F880_OFFSET UNITYSDK_OFFSET(0x102FBCF0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_C1C0CB2C8B6124DE_1_OFFSET UNITYSDK_OFFSET(0x102FCCC0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_C1C0CB2C8B6124DE_OFFSET UNITYSDK_OFFSET(0x102FC830)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_C3FA16B393076D2B_OFFSET UNITYSDK_OFFSET(0x102FB7E0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_CCD88C0D86A5A786_OFFSET UNITYSDK_OFFSET(0x102FA210)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_CF8551534BA217CC_OFFSET UNITYSDK_OFFSET(0x102FA680)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_DAFD4F26397DCF6C_OFFSET UNITYSDK_OFFSET(0x102FB1B0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_DD152A1A30757DCD_OFFSET UNITYSDK_OFFSET(0x102FA1A0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_DFB53B789DEB4FB5_OFFSET UNITYSDK_OFFSET(0x102FAAA0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_FD3B916300F77FDA_OFFSET UNITYSDK_OFFSET(0x102FA0F0)
#define CLASS_2_7AC5CDC6676C412B__CTOR_OFFSET UNITYSDK_OFFSET(0x102FD720)
#define CLASS_2_7AC5CDC6676C412B__ONBIND_OFFSET UNITYSDK_OFFSET(0x102F9EE0)
#define CLASS_2_7AC5CDC6676C412B__ONTICK_OFFSET UNITYSDK_OFFSET(0x102FA080)
#define CLASS_2_7AC5CDC6676C412B__PLAYFADE_B__8_0_OFFSET UNITYSDK_OFFSET(0x102FD830)
#define CLASS_2_7AC5CDC6676C412B___IFIXBASEPROXY_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x102FDA00)
#define CLASS_2_7AC5CDC6676C412B___IFIXBASEPROXY_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x102FDA60)
#define CLASS_2_7AC5CDC6676C412B___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0x102FD870)
#define CLASS_2_7AC5CDC6676C412B___IFIXBASEPROXY__ONTICK_OFFSET UNITYSDK_OFFSET(0x102FD930)

inline static constexpr unsigned int Class_2_7AC5CDC6676C412B_TypeDefinitionIndex = 66019;
...
public:
	...
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_0_16E4307DCC419505_950*>* Field_2_2; // 0x88
