...
#define CLASS_2_CCD9932409DC8C95_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD51E1D0)
#define CLASS_2_CCD9932409DC8C95_METHOD_2_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xD51EA40)
#define CLASS_2_CCD9932409DC8C95_METHOD_2_87E0654B98D0D63C_OFFSET UNITYSDK_OFFSET(0xD51EB20)
#define CLASS_2_CCD9932409DC8C95_METHOD_2_B556EADFE34BD60F_OFFSET UNITYSDK_OFFSET(0xD51EBC0)
#define CLASS_2_CCD9932409DC8C95_METHOD_2_BFB7535D462E0EB4_OFFSET UNITYSDK_OFFSET(0xD51E800)
#define CLASS_2_CCD9932409DC8C95_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xD51E2D0)
#define CLASS_2_CCD9932409DC8C95_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xD51EDE0)
#define CLASS_2_CCD9932409DC8C95_TICK_OFFSET UNITYSDK_OFFSET(0xD51EE30)
#define CLASS_2_CCD9932409DC8C95__CTOR_OFFSET UNITYSDK_OFFSET(0xD51E0E0)
...
public:
	...
	::RPG::GameCore::LevelGraphComponent* Field_2_4; // 0x18
	::Class_3_E21F6DE9B7FA4D05* Field_2_2; // 0x20
	::RPG::GameCore::TaskContext* Field_2_1; // 0x28
	::Class_3_E21F6DE9B7FA4D05* Field_2_3; // 0x30
	::RPG::GameCore::HeliobusSNSQuickPost* Field_2_0; // 0x38
