...
#define CLASS_1_DE49214D160C3B72_3_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17C52050)
#define CLASS_1_DE49214D160C3B72_3_CLONE_OFFSET UNITYSDK_OFFSET(0x17C51B50)
#define CLASS_1_DE49214D160C3B72_3_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17C51BF0)
#define CLASS_1_DE49214D160C3B72_3_EQUALS_OFFSET UNITYSDK_OFFSET(0x17C51BC0)
#define CLASS_1_DE49214D160C3B72_3_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17C51CE0)
#define CLASS_1_DE49214D160C3B72_3_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x17C52240)
#define CLASS_1_DE49214D160C3B72_3_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x17C52180)
#define CLASS_1_DE49214D160C3B72_3_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x17C51B80)
#define CLASS_1_DE49214D160C3B72_3_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x17C51BB0)
#define CLASS_1_DE49214D160C3B72_3_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x17C51BA0)
#define CLASS_1_DE49214D160C3B72_3_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x17C51B90)
#define CLASS_1_DE49214D160C3B72_3_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17C51980)
#define CLASS_1_DE49214D160C3B72_3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17C51EB0)
#define CLASS_1_DE49214D160C3B72_3_WRITETO_OFFSET UNITYSDK_OFFSET(0x17C51F10)
#define CLASS_1_DE49214D160C3B72_3__CCTOR_OFFSET UNITYSDK_OFFSET(0x17C52370)
#define CLASS_1_DE49214D160C3B72_3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17C51A20)
#define CLASS_1_DE49214D160C3B72_3__CTOR_OFFSET UNITYSDK_OFFSET(0x17C51990)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_03BB5E9973FF6983*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_DE49214D160C3B72_3_TypeDefinitionIndex)->GetStaticField(0x39D60);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_7()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_DE49214D160C3B72_3_TypeDefinitionIndex)->GetStaticField(0x39D68);
	}
