...
#define CLASS_1_38EDFE5CA7B8A5B6_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x198BB520)
#define CLASS_1_38EDFE5CA7B8A5B6_CLONE_OFFSET UNITYSDK_OFFSET(0x198BB1C0)
#define CLASS_1_38EDFE5CA7B8A5B6_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x198BB360)
#define CLASS_1_38EDFE5CA7B8A5B6_EQUALS_OFFSET UNITYSDK_OFFSET(0x198BB2A0)
#define CLASS_1_38EDFE5CA7B8A5B6_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x198BB3D0)
#define CLASS_1_38EDFE5CA7B8A5B6_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x198BB6E0)
#define CLASS_1_38EDFE5CA7B8A5B6_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x198BB690)
#define CLASS_1_38EDFE5CA7B8A5B6_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x198BB240)
#define CLASS_1_38EDFE5CA7B8A5B6_METHOD_1_3163C288F3AE2966_OFFSET UNITYSDK_OFFSET(0x198BB270)
#define CLASS_1_38EDFE5CA7B8A5B6_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x198BB100)
#define CLASS_1_38EDFE5CA7B8A5B6_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x198BB250)
#define CLASS_1_38EDFE5CA7B8A5B6_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x198BB290)
#define CLASS_1_38EDFE5CA7B8A5B6_METHOD_1_CE81D059476B1F49_OFFSET UNITYSDK_OFFSET(0x198BB260)
#define CLASS_1_38EDFE5CA7B8A5B6_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x198BB280)
#define CLASS_1_38EDFE5CA7B8A5B6_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x198BB160)
#define CLASS_1_38EDFE5CA7B8A5B6_TOSTRING_OFFSET UNITYSDK_OFFSET(0x198BB420)
#define CLASS_1_38EDFE5CA7B8A5B6_WRITETO_OFFSET UNITYSDK_OFFSET(0x198BB480)
#define CLASS_1_38EDFE5CA7B8A5B6__CCTOR_OFFSET UNITYSDK_OFFSET(0x198BB780)
#define CLASS_1_38EDFE5CA7B8A5B6__CTOR_1_OFFSET UNITYSDK_OFFSET(0x198BB180)
#define CLASS_1_38EDFE5CA7B8A5B6__CTOR_OFFSET UNITYSDK_OFFSET(0x198BB170)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_38EDFE5CA7B8A5B6*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_38EDFE5CA7B8A5B6_TypeDefinitionIndex)->GetStaticField(0x4E010);
	}
