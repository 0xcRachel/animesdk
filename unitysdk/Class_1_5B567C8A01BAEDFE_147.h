...
#define CLASS_1_5B567C8A01BAEDFE_147_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A8DE760)
#define CLASS_1_5B567C8A01BAEDFE_147_CLONE_OFFSET UNITYSDK_OFFSET(0x1A8DE570)
#define CLASS_1_5B567C8A01BAEDFE_147_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A8DE670)
#define CLASS_1_5B567C8A01BAEDFE_147_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A8DE5E0)
#define CLASS_1_5B567C8A01BAEDFE_147_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A8DE6C0)
#define CLASS_1_5B567C8A01BAEDFE_147_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A8DE7B0)
#define CLASS_1_5B567C8A01BAEDFE_147_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A8DE780)
#define CLASS_1_5B567C8A01BAEDFE_147_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A8DE4C0)
#define CLASS_1_5B567C8A01BAEDFE_147_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A8DE520)
#define CLASS_1_5B567C8A01BAEDFE_147_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A8DE6F0)
#define CLASS_1_5B567C8A01BAEDFE_147_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A8DE750)
#define CLASS_1_5B567C8A01BAEDFE_147__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A8DE800)
#define CLASS_1_5B567C8A01BAEDFE_147__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A8DE540)
#define CLASS_1_5B567C8A01BAEDFE_147__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8DE530)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_147*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_147_TypeDefinitionIndex)->GetStaticField(0x5DB00);
	}
