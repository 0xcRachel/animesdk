...
#define CLASS_2_81A5344B7B5B2DAF_METHOD_2_2F2B436D8A949630_OFFSET UNITYSDK_OFFSET(0x920C700)
#define CLASS_2_81A5344B7B5B2DAF_METHOD_2_3DCAF09BEB5CADD1_OFFSET UNITYSDK_OFFSET(0x920C780)
#define CLASS_2_81A5344B7B5B2DAF_METHOD_2_8F8D080EF5D1D761_OFFSET UNITYSDK_OFFSET(0x920CAF0)
#define CLASS_2_81A5344B7B5B2DAF_METHOD_2_B9A97467188E4B69_OFFSET UNITYSDK_OFFSET(0x920C840)
#define CLASS_2_81A5344B7B5B2DAF__CTOR_OFFSET UNITYSDK_OFFSET(0x920CC60)
#define CLASS_2_81A5344B7B5B2DAF__ONBIND_OFFSET UNITYSDK_OFFSET(0x920C640)
#define CLASS_2_81A5344B7B5B2DAF___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0x920CC90)

inline static constexpr unsigned int Class_2_81A5344B7B5B2DAF_TypeDefinitionIndex = 57571;

class Class_2_81A5344B7B5B2DAF : public ::Class_1_CA217ABF4E3B4F3F
{
public:
	// static const ::System::String* Field_2_0; // 0x0
	::Class_1_6D3A625BE1D0B270* Field_2_4; // 0x60
