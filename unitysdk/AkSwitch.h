...
#define AKSWITCH_GET_GROUPGUID_OFFSET UNITYSDK_OFFSET(0x18415720)
#define AKSWITCH_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x184155E0)
#define AKSWITCH_GET_VALUEGUID_OFFSET UNITYSDK_OFFSET(0x18415640)
#define AKSWITCH_GET_VALUEID_OFFSET UNITYSDK_OFFSET(0x18415560)
#define AKSWITCH_GET_WWISETYPE_OFFSET UNITYSDK_OFFSET(0x184154A0)
#define AKSWITCH_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x184154E0)
#define AKSWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x18415880)

inline static constexpr unsigned int AkSwitch_TypeDefinitionIndex = 33704;
