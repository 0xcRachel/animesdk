...
#define CLASS_2_8B9A326D781E1653_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10521F70)
#define CLASS_2_8B9A326D781E1653_METHOD_2_1AD3CAF2B0982C3F_OFFSET UNITYSDK_OFFSET(0x10521CD0)
#define CLASS_2_8B9A326D781E1653_METHOD_2_3C93207F18E0BBCF_OFFSET UNITYSDK_OFFSET(0x10522540)
#define CLASS_2_8B9A326D781E1653_METHOD_2_6F57ADE512C06E88_OFFSET UNITYSDK_OFFSET(0x10522400)
#define CLASS_2_8B9A326D781E1653_METHOD_2_B4D726B1CCBC8947_OFFSET UNITYSDK_OFFSET(0x105226B0)
#define CLASS_2_8B9A326D781E1653_METHOD_2_D1741D8BDBC238C3_OFFSET UNITYSDK_OFFSET(0x10522350)
#define CLASS_2_8B9A326D781E1653_METHOD_2_F6C51BEA6E90101F_OFFSET UNITYSDK_OFFSET(0x10521FC0)
#define CLASS_2_8B9A326D781E1653__CTOR_OFFSET UNITYSDK_OFFSET(0x10521C70)
#define CLASS_2_8B9A326D781E1653__ONINITOWNERREF_OFFSET UNITYSDK_OFFSET(0x10521EF0)
#define CLASS_2_8B9A326D781E1653___IFIXBASEPROXY__ONINITOWNERREF_OFFSET UNITYSDK_OFFSET(0x10522710)

inline static constexpr unsigned int Class_2_8B9A326D781E1653_TypeDefinitionIndex = 44800;

class Class_2_8B9A326D781E1653 : public ::RPG::GameCore::GameComponentBase
{
public:
	::RPG::GameCore::TransformComponent* Field_2_1; // 0x18
	::System::Collections::Generic::List_1<::Class_1_9CCB4E0B2BD5996B*>* Field_2_3; // 0x20
	...
	::System::Void Method_2_6F57ADE512C06E88(::RPG::GameCore::AdvancedFollowType a1, ::RPG::GameCore::GameEntity* a2)
	{
		return ((::System::Void(*)(::PVOID, ::RPG::GameCore::AdvancedFollowType, ::RPG::GameCore::GameEntity*))((::PBYTE)hIl2Cpp + CLASS_2_8B9A326D781E1653_METHOD_2_6F57ADE512C06E88_OFFSET))(this, a1, a2);
	}

	::RPG::GameCore::FollowSideType Method_2_3C93207F18E0BBCF(::RPG::GameCore::AdvancedFollowType a1, ::RPG::GameCore::GameEntity* a2)
	{
		return ((::RPG::GameCore::FollowSideType(*)(::PVOID, ::RPG::GameCore::AdvancedFollowType, ::RPG::GameCore::GameEntity*))((::PBYTE)hIl2Cpp + CLASS_2_8B9A326D781E1653_METHOD_2_3C93207F18E0BBCF_OFFSET))(this, a1, a2);
	}
