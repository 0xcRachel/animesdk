...
#define HPATCHZ_HPATCH_HPATCHZ_OFFSET UNITYSDK_OFFSET(0x83F3320)
#define HPATCHZ_HPATCH_PATCH_OFFSET UNITYSDK_OFFSET(0x83F3410)
#define HPATCHZ_HPATCH__CTOR_OFFSET UNITYSDK_OFFSET(0x83F3420)
