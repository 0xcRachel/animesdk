...
#define HPATCHZ_HPATCH_HPATCHZ_OFFSET UNITYSDK_OFFSET(0x12C0C070)
#define HPATCHZ_HPATCH_PATCH_OFFSET UNITYSDK_OFFSET(0x12C0C160)
#define HPATCHZ_HPATCH__CTOR_OFFSET UNITYSDK_OFFSET(0x12C0C170)
