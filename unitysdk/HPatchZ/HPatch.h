...
#define HPATCHZ_HPATCH_HPATCHZ_OFFSET UNITYSDK_OFFSET(0x19C5E570)
#define HPATCHZ_HPATCH_PATCH_OFFSET UNITYSDK_OFFSET(0x19C5E660)
#define HPATCHZ_HPATCH__CTOR_OFFSET UNITYSDK_OFFSET(0x19C5E670)
