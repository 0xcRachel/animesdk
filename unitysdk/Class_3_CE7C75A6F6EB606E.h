...
#define CLASS_3_CE7C75A6F6EB606E_EVALUATE_OFFSET UNITYSDK_OFFSET(0x15F82F40)
#define CLASS_3_CE7C75A6F6EB606E__CTOR_OFFSET UNITYSDK_OFFSET(0x15F82EC0)

inline static constexpr unsigned int Class_3_CE7C75A6F6EB606E_TypeDefinitionIndex = 27932;
