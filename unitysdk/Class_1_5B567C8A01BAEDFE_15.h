...
#define CLASS_1_5B567C8A01BAEDFE_15_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19C4EE20)
#define CLASS_1_5B567C8A01BAEDFE_15_CLONE_OFFSET UNITYSDK_OFFSET(0x19C4EC30)
#define CLASS_1_5B567C8A01BAEDFE_15_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19C4ED30)
#define CLASS_1_5B567C8A01BAEDFE_15_EQUALS_OFFSET UNITYSDK_OFFSET(0x19C4ECA0)
#define CLASS_1_5B567C8A01BAEDFE_15_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19C4ED80)
#define CLASS_1_5B567C8A01BAEDFE_15_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19C4EE70)
#define CLASS_1_5B567C8A01BAEDFE_15_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19C4EE40)
#define CLASS_1_5B567C8A01BAEDFE_15_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19C4EB80)
#define CLASS_1_5B567C8A01BAEDFE_15_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19C4EBE0)
#define CLASS_1_5B567C8A01BAEDFE_15_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19C4EDB0)
#define CLASS_1_5B567C8A01BAEDFE_15_WRITETO_OFFSET UNITYSDK_OFFSET(0x19C4EE10)
#define CLASS_1_5B567C8A01BAEDFE_15__CCTOR_OFFSET UNITYSDK_OFFSET(0x19C4EEC0)
#define CLASS_1_5B567C8A01BAEDFE_15__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19C4EC00)
#define CLASS_1_5B567C8A01BAEDFE_15__CTOR_OFFSET UNITYSDK_OFFSET(0x19C4EBF0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_15*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_15_TypeDefinitionIndex)->GetStaticField(0x4F140);
	}
