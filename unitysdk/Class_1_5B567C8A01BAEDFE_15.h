...
#define CLASS_1_5B567C8A01BAEDFE_15_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A7DDDC0)
#define CLASS_1_5B567C8A01BAEDFE_15_CLONE_OFFSET UNITYSDK_OFFSET(0x1A7DDBD0)
#define CLASS_1_5B567C8A01BAEDFE_15_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A7DDCD0)
#define CLASS_1_5B567C8A01BAEDFE_15_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A7DDC40)
#define CLASS_1_5B567C8A01BAEDFE_15_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A7DDD20)
#define CLASS_1_5B567C8A01BAEDFE_15_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A7DDE10)
#define CLASS_1_5B567C8A01BAEDFE_15_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A7DDDE0)
#define CLASS_1_5B567C8A01BAEDFE_15_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A7DDB20)
#define CLASS_1_5B567C8A01BAEDFE_15_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A7DDB80)
#define CLASS_1_5B567C8A01BAEDFE_15_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A7DDD50)
#define CLASS_1_5B567C8A01BAEDFE_15_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A7DDDB0)
#define CLASS_1_5B567C8A01BAEDFE_15__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A7DDE60)
#define CLASS_1_5B567C8A01BAEDFE_15__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A7DDBA0)
#define CLASS_1_5B567C8A01BAEDFE_15__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7DDB90)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_15*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_15_TypeDefinitionIndex)->GetStaticField(0xE6A0);
	}
