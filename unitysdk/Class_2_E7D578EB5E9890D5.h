...
#define CLASS_2_E7D578EB5E9890D5_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8479B30)
#define CLASS_2_E7D578EB5E9890D5_METHOD_2_26F48F58F6BD506B_OFFSET UNITYSDK_OFFSET(0x847A040)
#define CLASS_2_E7D578EB5E9890D5_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x847A4B0)
#define CLASS_2_E7D578EB5E9890D5_METHOD_2_5AFFCF6F18A4FE2B_OFFSET UNITYSDK_OFFSET(0x847A110)
#define CLASS_2_E7D578EB5E9890D5_METHOD_2_67B6484BDDE6464B_OFFSET UNITYSDK_OFFSET(0x847AA00)
#define CLASS_2_E7D578EB5E9890D5_METHOD_2_68E340ABEC62FD31_OFFSET UNITYSDK_OFFSET(0x847B410)
#define CLASS_2_E7D578EB5E9890D5_METHOD_2_735EE20B25F86BF4_OFFSET UNITYSDK_OFFSET(0x847B3C0)
#define CLASS_2_E7D578EB5E9890D5_METHOD_2_76EE480686474477_OFFSET UNITYSDK_OFFSET(0x847A710)
#define CLASS_2_E7D578EB5E9890D5_METHOD_2_9CA35E5BF1A50E77_OFFSET UNITYSDK_OFFSET(0x8479EF0)
#define CLASS_2_E7D578EB5E9890D5_METHOD_2_A1ADC999CFACEB89_OFFSET UNITYSDK_OFFSET(0x847A5E0)
#define CLASS_2_E7D578EB5E9890D5_METHOD_2_B768DA94E3FD91D9_OFFSET UNITYSDK_OFFSET(0x847A3E0)
#define CLASS_2_E7D578EB5E9890D5_METHOD_2_EFDD2EF954C3FDB4_OFFSET UNITYSDK_OFFSET(0x8479BD0)
#define CLASS_2_E7D578EB5E9890D5_METHOD_2_F978A1D172468895_OFFSET UNITYSDK_OFFSET(0x847A1E0)
#define CLASS_2_E7D578EB5E9890D5_METHOD_2_FA99051EF61C23DD_OFFSET UNITYSDK_OFFSET(0x847AB40)
#define CLASS_2_E7D578EB5E9890D5_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x847B040)
#define CLASS_2_E7D578EB5E9890D5_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x847B1D0)
#define CLASS_2_E7D578EB5E9890D5_TICK_OFFSET UNITYSDK_OFFSET(0x847AF50)
#define CLASS_2_E7D578EB5E9890D5__CTOR_OFFSET UNITYSDK_OFFSET(0x8479650)

inline static constexpr unsigned int Class_2_E7D578EB5E9890D5_TypeDefinitionIndex = 41379;

class Class_2_E7D578EB5E9890D5 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::Class_2_A0580152EB393340* Field_2_4; // 0x18
	::RPG::GameCore::AdvNpcFollowByPlayer* Field_2_1; // 0x20
	::RPG::GameCore::AdventureCharacterController* Field_2_7; // 0x28
	::Class_1_5F51D4049EA87B7B* Field_2_2; // 0x30
	::Class_2_19E76B515E7B257C* Field_2_6; // 0x38
	::RPG::GameCore::TransformComponent* Field_2_5; // 0x40
	::Class_1_5F51D4049EA87B7B* Field_2_3; // 0x48
	::RPG::GameCore::TaskContext* Field_2_0; // 0x50
	::Il2CppArray<::RPG::GameCore::FollowByPlayerCustomRoutePoint*>* Field_2_18; // 0x58
	::System::Single Field_2_10; // 0x60
	::RPG::GameCore::CharacterMotionFlag Field_2_16; // 0x64
	::RPG::GameCore::NpcFollowByPlayerState Field_2_12; // 0x68
