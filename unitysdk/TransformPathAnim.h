...
#define TRANSFORMPATHANIM_GET_ARTBOUNDFULL_OFFSET UNITYSDK_OFFSET(0xA72BE10)
#define TRANSFORMPATHANIM_GET_ARTBOUND_OFFSET UNITYSDK_OFFSET(0xA72C250)
#define TRANSFORMPATHANIM_METHOD_5_C638E91FC0D3A13A_OFFSET UNITYSDK_OFFSET(0xA72B680)
#define TRANSFORMPATHANIM_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0xA72B810)
#define TRANSFORMPATHANIM_UPDATE_OFFSET UNITYSDK_OFFSET(0xA72B870)
#define TRANSFORMPATHANIM__CTOR_OFFSET UNITYSDK_OFFSET(0xA72C300)

inline static constexpr unsigned int TransformPathAnim_TypeDefinitionIndex = 37343;
