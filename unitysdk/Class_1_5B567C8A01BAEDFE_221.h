...
#define CLASS_1_5B567C8A01BAEDFE_221_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A2FD870)
#define CLASS_1_5B567C8A01BAEDFE_221_CLONE_OFFSET UNITYSDK_OFFSET(0x1A2FD680)
#define CLASS_1_5B567C8A01BAEDFE_221_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A2FD780)
#define CLASS_1_5B567C8A01BAEDFE_221_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A2FD6F0)
#define CLASS_1_5B567C8A01BAEDFE_221_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A2FD7D0)
#define CLASS_1_5B567C8A01BAEDFE_221_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A2FD8C0)
#define CLASS_1_5B567C8A01BAEDFE_221_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A2FD890)
#define CLASS_1_5B567C8A01BAEDFE_221_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A2FD5D0)
#define CLASS_1_5B567C8A01BAEDFE_221_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A2FD630)
#define CLASS_1_5B567C8A01BAEDFE_221_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A2FD800)
#define CLASS_1_5B567C8A01BAEDFE_221_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A2FD860)
#define CLASS_1_5B567C8A01BAEDFE_221__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A2FD910)
#define CLASS_1_5B567C8A01BAEDFE_221__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A2FD650)
#define CLASS_1_5B567C8A01BAEDFE_221__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2FD640)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_221*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_221_TypeDefinitionIndex)->GetStaticField(0x48A90);
	}
