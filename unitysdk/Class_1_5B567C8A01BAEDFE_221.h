...
#define CLASS_1_5B567C8A01BAEDFE_221_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A5213D0)
#define CLASS_1_5B567C8A01BAEDFE_221_CLONE_OFFSET UNITYSDK_OFFSET(0x1A5211E0)
#define CLASS_1_5B567C8A01BAEDFE_221_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A5212E0)
#define CLASS_1_5B567C8A01BAEDFE_221_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A521250)
#define CLASS_1_5B567C8A01BAEDFE_221_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A521330)
#define CLASS_1_5B567C8A01BAEDFE_221_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A521420)
#define CLASS_1_5B567C8A01BAEDFE_221_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A5213F0)
#define CLASS_1_5B567C8A01BAEDFE_221_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A521130)
#define CLASS_1_5B567C8A01BAEDFE_221_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A521190)
#define CLASS_1_5B567C8A01BAEDFE_221_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A521360)
#define CLASS_1_5B567C8A01BAEDFE_221_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A5213C0)
#define CLASS_1_5B567C8A01BAEDFE_221__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A521470)
#define CLASS_1_5B567C8A01BAEDFE_221__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A5211B0)
#define CLASS_1_5B567C8A01BAEDFE_221__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5211A0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_221*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_221_TypeDefinitionIndex)->GetStaticField(0x2F8F0);
	}
