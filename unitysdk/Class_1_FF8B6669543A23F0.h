...
#define CLASS_1_FF8B6669543A23F0_GET_ASYNCLATENCYWINDOWSIZE_OFFSET UNITYSDK_OFFSET(0x1093C0D0)
#define CLASS_1_FF8B6669543A23F0_GET_DEFAULTTOPN_OFFSET UNITYSDK_OFFSET(0x1093C0F0)
#define CLASS_1_FF8B6669543A23F0_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1093C0B0)
#define CLASS_1_FF8B6669543A23F0_SET_ASYNCLATENCYWINDOWSIZE_OFFSET UNITYSDK_OFFSET(0x1093C0E0)
#define CLASS_1_FF8B6669543A23F0_SET_DEFAULTTOPN_OFFSET UNITYSDK_OFFSET(0x1093C100)
#define CLASS_1_FF8B6669543A23F0_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1093C0C0)
#define CLASS_1_FF8B6669543A23F0__CTOR_OFFSET UNITYSDK_OFFSET(0x1092EDD0)

inline static constexpr unsigned int Class_1_FF8B6669543A23F0_TypeDefinitionIndex = 71339;

class Class_1_FF8B6669543A23F0 : public ::System::Object
{
public:
	::System::Int32 _AsyncLatencyWindowSize_k__BackingField; // 0x10
	::System::Int32 _DefaultTopN_k__BackingField; // 0x14
