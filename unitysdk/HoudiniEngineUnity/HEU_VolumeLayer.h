...
#define HOUDINIENGINEUNITY_HEU_VOLUMELAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x815BB70)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_VolumeLayer_TypeDefinitionIndex = 36928;
