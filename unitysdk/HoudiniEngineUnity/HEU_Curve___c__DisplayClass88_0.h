...
#define HOUDINIENGINEUNITY_HEU_CURVE___C__DISPLAYCLASS88_0__CTOR_OFFSET UNITYSDK_OFFSET(0x136A28F0)
#define HOUDINIENGINEUNITY_HEU_CURVE___C__DISPLAYCLASS88_0__UPDATECURVEINPUTFORCUSTOMATTRIBUTES_B__0_OFFSET UNITYSDK_OFFSET(0x136A4930)
#define HOUDINIENGINEUNITY_HEU_CURVE___C__DISPLAYCLASS88_0__UPDATECURVEINPUTFORCUSTOMATTRIBUTES_B__1_OFFSET UNITYSDK_OFFSET(0x136A4AF0)
#define HOUDINIENGINEUNITY_HEU_CURVE___C__DISPLAYCLASS88_0__UPDATECURVEINPUTFORCUSTOMATTRIBUTES_B__2_OFFSET UNITYSDK_OFFSET(0x136A4E40)
