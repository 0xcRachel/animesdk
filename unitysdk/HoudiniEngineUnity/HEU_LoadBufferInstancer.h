...
#define HOUDINIENGINEUNITY_HEU_LOADBUFFERINSTANCER__CTOR_OFFSET UNITYSDK_OFFSET(0x811DE60)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_LoadBufferInstancer_TypeDefinitionIndex = 36857;
	...
	public:
		...
		::Il2CppArray<::System::String*>* _instancePrefixes; // 0x48
