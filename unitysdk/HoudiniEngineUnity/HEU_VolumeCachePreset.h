...
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHEPRESET__CTOR_OFFSET UNITYSDK_OFFSET(0x815EEE0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_VolumeCachePreset_TypeDefinitionIndex = 36670;
