...
#define HOUDINIENGINEUNITY_HEU_PARTDATA___C__DISPLAYCLASS86_0__COPYCHILDGAMEOBJECTS_B__0_OFFSET UNITYSDK_OFFSET(0x81354D0)
#define HOUDINIENGINEUNITY_HEU_PARTDATA___C__DISPLAYCLASS86_0__CTOR_OFFSET UNITYSDK_OFFSET(0x81343C0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_PartData___c__DisplayClass86_0_TypeDefinitionIndex = 36707;
