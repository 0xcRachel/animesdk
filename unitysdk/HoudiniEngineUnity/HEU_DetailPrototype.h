...
#define HOUDINIENGINEUNITY_HEU_DETAILPROTOTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x8426010)
...
namespace HoudiniEngineUnity
{
	...
	public:
		...
		::UnityEngine::Color _dryColor; // 0x28
		::System::Single _bendFactor; // 0x38
		::UnityEngine::Color _healthyColor; // 0x3C
		::System::Single _minHeight; // 0x4C
		::System::Single _maxHeight; // 0x50
