...
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_HEU_LOADDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8153380)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_ThreadedTaskLoadGeo_HEU_LoadData_TypeDefinitionIndex = 36861;

	class HEU_ThreadedTaskLoadGeo_HEU_LoadData : public ::System::Object
	{
	public:
		::System::Text::StringBuilder* _logStr; // 0x10
		::HoudiniEngineUnity::HEU_SessionBase* _session; // 0x18
