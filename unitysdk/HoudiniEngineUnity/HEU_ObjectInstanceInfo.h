...
#define HOUDINIENGINEUNITY_HEU_OBJECTINSTANCEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x8121C20)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_ObjectInstanceInfo_TypeDefinitionIndex = 36701;
