...
#define HOUDINIENGINEUNITY_HEU_UNITYMATERIALINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x815A1C0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_UnityMaterialInfo_TypeDefinitionIndex = 36828;
