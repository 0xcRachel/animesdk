...
#define HOUDINIENGINEUNITY_HEU_VERTEXENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x815A9F0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_VertexEntry_TypeDefinitionIndex = 36883;
