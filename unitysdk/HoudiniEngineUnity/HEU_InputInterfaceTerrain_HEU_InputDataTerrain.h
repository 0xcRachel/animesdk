...
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACETERRAIN_HEU_INPUTDATATERRAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x8470420)
...
namespace HoudiniEngineUnity
{
	...
	public:
		...
		::UnityEngine::TerrainData* _terrainData; // 0x20
		::UnityEngine::Terrain* _terrain; // 0x28
		::HoudiniEngineUnity::HAPI_Transform _transform; // 0x30
		::System::Int32 _numPointsY; // 0x58
		::System::Int32 _numPointsX; // 0x5C
		::System::Int32 _mergeNodeID; // 0x60
		::System::Int32 _heightfieldNodeID; // 0x64
		::System::Single _heightScale; // 0x68
		::System::Single _voxelSize; // 0x6C
		::System::Int32 _heightNodeID; // 0x70
		::System::Int32 _parentNodeID; // 0x74
