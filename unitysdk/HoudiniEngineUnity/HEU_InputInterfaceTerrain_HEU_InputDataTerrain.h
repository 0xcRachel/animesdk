...
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACETERRAIN_HEU_INPUTDATATERRAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x8119510)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_InputInterfaceTerrain_HEU_InputDataTerrain_TypeDefinitionIndex = 36891;
	...
	public:
		...
		::System::Single _heightScale; // 0x70
		::System::Int32 _mergeNodeID; // 0x74
		::System::Int32 _heightNodeID; // 0x78
