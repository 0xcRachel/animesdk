...
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_APPLYTRANSFORMTO_OFFSET UNITYSDK_OFFSET(0x8428280)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_ASSIGNUNITYLAYER_OFFSET UNITYSDK_OFFSET(0x84232A0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_ASSIGNUNITYTAG_OFFSET UNITYSDK_OFFSET(0x8422F20)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_ATTACHSCRIPTWITHINVOKEFUNCTION_OFFSET UNITYSDK_OFFSET(0x842C3E0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_CHECKATTRIBUTEEXISTS_OFFSET UNITYSDK_OFFSET(0x8427B50)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_COLORTOSTRING_OFFSET UNITYSDK_OFFSET(0x842A880)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_COPYCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x842CED0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_COPYFLAGS_OFFSET UNITYSDK_OFFSET(0x8422840)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_COPYHAPITRANSFORM_OFFSET UNITYSDK_OFFSET(0x842D480)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_COPYLOCALTRANSFORMVALUES_OFFSET UNITYSDK_OFFSET(0x8428680)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_COPYWORLDTRANSFORMVALUES_OFFSET UNITYSDK_OFFSET(0x8428190)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_CREATEOUTPUTATTRIBUTEHELPER_OFFSET UNITYSDK_OFFSET(0x8428120)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_CREATEOUTPUTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x8427CD0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DESTROYBAKEDGAMEOBJECTSWITHENDNAME_OFFSET UNITYSDK_OFFSET(0x84297F0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DESTROYBAKEDGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x84297E0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DESTROYGENERATEDCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x8429380)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DESTROYGENERATEDMATERIAL_OFFSET UNITYSDK_OFFSET(0x842A2F0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DESTROYGENERATEDMESHCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x8429420)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DESTROYGENERATEDMESHMATERIALSLODGROUPS_OFFSET UNITYSDK_OFFSET(0x8429990)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DESTROYIMMEDIATE_OFFSET UNITYSDK_OFFSET(0x8422370)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DESTROYLODGROUP_OFFSET UNITYSDK_OFFSET(0x8429CB0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DESTROYMESHCOLLIDER_OFFSET UNITYSDK_OFFSET(0x842A5F0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DESTROYTERRAINCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x8429490)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DOESUNITYTAGEXIST_OFFSET UNITYSDK_OFFSET(0x842AD60)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_FINDORGENERATEHANDLES_OFFSET UNITYSDK_OFFSET(0x842C800)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETATTRIBUTECOLORSINGLE_OFFSET UNITYSDK_OFFSET(0x842C120)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETATTRIBUTEFLOATSINGLE_OFFSET UNITYSDK_OFFSET(0x842BE00)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETATTRIBUTEINFO_OFFSET UNITYSDK_OFFSET(0x8427BB0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETATTRIBUTEINTSINGLE_OFFSET UNITYSDK_OFFSET(0x842BF90)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETATTRIBUTESTRINGDATAHELPER_OFFSET UNITYSDK_OFFSET(0x84277B0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETATTRIBUTESTRINGDATA_OFFSET UNITYSDK_OFFSET(0x8427A10)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETATTRIBUTESTRINGVALUESINGLESTRICT_OFFSET UNITYSDK_OFFSET(0x842B7D0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETATTRIBUTESTRINGVALUESINGLE_OFFSET UNITYSDK_OFFSET(0x842B3A0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETCHILDGAMEOBJECTSWITHNAMEPATTERN_OFFSET UNITYSDK_OFFSET(0x8428A90)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETCHILDGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x8428770)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETGAMEOBJECTBYNAMEINPROJECTONLY_OFFSET UNITYSDK_OFFSET(0x8428FC0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETGAMEOBJECTBYNAMEINSCENE_OFFSET UNITYSDK_OFFSET(0x8429220)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETGAMEOBJECTBYNAME_OFFSET UNITYSDK_OFFSET(0x8428EA0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETHDABYGAMEOBJECTNAMEINSCENE_OFFSET UNITYSDK_OFFSET(0x84292D0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETINSTANCECHILDOBJECTS_OFFSET UNITYSDK_OFFSET(0x8428E20)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETLODTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x8429F70)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETMATERIALATTRIBUTEVALUEFROMPART_OFFSET UNITYSDK_OFFSET(0x842D600)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETNONINSTANCECHILDOBJECTS_OFFSET UNITYSDK_OFFSET(0x8428E60)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETSYSTEMTYPEBYNAME_OFFSET UNITYSDK_OFFSET(0x842B080)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETUNITYSCRIPTATTRIBUTEVALUE_OFFSET UNITYSDK_OFFSET(0x842B130)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_HASATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x842C360)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_HASVALIDINSTANCEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x8427C30)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_ISGAMEOBJECTINPROJECT_OFFSET UNITYSDK_OFFSET(0x8429170)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_ISINCAMERAVIEW_OFFSET UNITYSDK_OFFSET(0x842C770)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_ISMOUSEOVERRECT_OFFSET UNITYSDK_OFFSET(0x842B010)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_ISMOUSEWITHINSCENEVIEW_OFFSET UNITYSDK_OFFSET(0x842AF90)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_LOADTEXTUREFROMFILE_OFFSET UNITYSDK_OFFSET(0x842CEE0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_MAKESTATICIFHASATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x84235E0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_MAKETEXTURE_OFFSET UNITYSDK_OFFSET(0x842D150)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_REPLACECOLLIDERMESHFROMMESHCOLLIDER_OFFSET UNITYSDK_OFFSET(0x842D830)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_REPLACECOLLIDERMESHFROMMESHFILTER_OFFSET UNITYSDK_OFFSET(0x8422600)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_REPLACEFIRSTOCCURRENCE_OFFSET UNITYSDK_OFFSET(0x842D360)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_SETGAMEOBJECTCHILDRENCOLLIDERSTATE_OFFSET UNITYSDK_OFFSET(0x8422E80)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_SETGAMEOBJECTCHILDRENRENDERVISIBILITY_OFFSET UNITYSDK_OFFSET(0x8422D10)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_SETGAMEOBJECTCOLLIDERSTATE_OFFSET UNITYSDK_OFFSET(0x8422DB0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_SETGAMEOBJECTRENDERVISIBLITY_OFFSET UNITYSDK_OFFSET(0x8422C70)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_SETLAYER_OFFSET UNITYSDK_OFFSET(0x842AD70)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_SETLODTRANSFORMVALUES_OFFSET UNITYSDK_OFFSET(0x842A0E0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_SETPARENTWITHCLEANTRANSFORM_OFFSET UNITYSDK_OFFSET(0x842D3F0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_SETTAG_OFFSET UNITYSDK_OFFSET(0x842AE80)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_STRINGTOCOLOR_OFFSET UNITYSDK_OFFSET(0x842AC10)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_UPDATEGENERATEDATTRIBUTESTORE_OFFSET UNITYSDK_OFFSET(0x841FA70)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x842D9D0)
