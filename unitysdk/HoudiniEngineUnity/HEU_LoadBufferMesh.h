...
#define HOUDINIENGINEUNITY_HEU_LOADBUFFERMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x811DE70)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_LoadBufferMesh_TypeDefinitionIndex = 36854;
	...
	public:
		...
		::System::Boolean _bPartInstanced; // 0x38
		::System::Boolean _bGenerateUVs; // 0x39
		::System::Boolean _bGenerateNormals; // 0x3A
		::System::Boolean _bGenerateTangents; // 0x3B
