...
#define HOUDINIENGINEUNITY_HEU_LOADBUFFERMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x105231F0)
...
namespace HoudiniEngineUnity
{
	...
	public:
		...
		::System::Boolean _bPartInstanced; // 0x3C
		::System::Boolean _bGenerateTangents; // 0x3D
		::System::Boolean _bGenerateUVs; // 0x3E
