...
#define HOUDINIENGINEUNITY_HEU_ASSETSYNC_CREATETHREADEDTASK_OFFSET UNITYSDK_OFFSET(0x80B93E0)
#define HOUDINIENGINEUNITY_HEU_ASSETSYNC_INITIALIZEASSET_OFFSET UNITYSDK_OFFSET(0x80B92C0)
#define HOUDINIENGINEUNITY_HEU_ASSETSYNC_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x80B9180)
#define HOUDINIENGINEUNITY_HEU_ASSETSYNC_ONENABLE_OFFSET UNITYSDK_OFFSET(0x80B9170)
#define HOUDINIENGINEUNITY_HEU_ASSETSYNC_ONLOADCOMPLETE_OFFSET UNITYSDK_OFFSET(0x80B9560)
#define HOUDINIENGINEUNITY_HEU_ASSETSYNC_RESYNC_OFFSET UNITYSDK_OFFSET(0x80B9E50)
#define HOUDINIENGINEUNITY_HEU_ASSETSYNC_SETLOADCALLBACK_OFFSET UNITYSDK_OFFSET(0x80B9440)
#define HOUDINIENGINEUNITY_HEU_ASSETSYNC_SETUPLOADTASK_OFFSET UNITYSDK_OFFSET(0x80B94B0)
#define HOUDINIENGINEUNITY_HEU_ASSETSYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x80BA180)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_AssetSync_TypeDefinitionIndex = 36839;
