...
#define HOUDINIENGINEUNITY_HAPI_GEOINFO_GETGROUPCOUNTBYTYPE_OFFSET UNITYSDK_OFFSET(0x26530)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HAPI_GeoInfo_TypeDefinitionIndex = 36784;
