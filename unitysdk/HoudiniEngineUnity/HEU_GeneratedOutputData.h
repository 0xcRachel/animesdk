...
#define HOUDINIENGINEUNITY_HEU_GENERATEDOUTPUTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x80DC5C0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_GeneratedOutputData_TypeDefinitionIndex = 36681;
