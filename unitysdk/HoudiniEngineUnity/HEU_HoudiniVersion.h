...
#define HOUDINIENGINEUNITY_HEU_HOUDINIVERSION__CTOR_OFFSET UNITYSDK_OFFSET(0x81103F0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_HoudiniVersion_TypeDefinitionIndex = 36803;
