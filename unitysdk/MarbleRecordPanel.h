...
#define MARBLERECORDPANEL_REFRESHSEALPOS_OFFSET UNITYSDK_OFFSET(0x16B74880)
#define MARBLERECORDPANEL_SETSEALHP_OFFSET UNITYSDK_OFFSET(0x16B740D0)
#define MARBLERECORDPANEL_SETSEALVISIBLE_OFFSET UNITYSDK_OFFSET(0x16B744F0)
#define MARBLERECORDPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0x16B74940)
