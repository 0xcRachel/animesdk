...
#define MARBLERECORDPANEL_REFRESHSEALPOS_OFFSET UNITYSDK_OFFSET(0xEE66D00)
#define MARBLERECORDPANEL_SETSEALHP_OFFSET UNITYSDK_OFFSET(0xEE66570)
#define MARBLERECORDPANEL_SETSEALVISIBLE_OFFSET UNITYSDK_OFFSET(0xEE66970)
#define MARBLERECORDPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0xEE66DC0)
