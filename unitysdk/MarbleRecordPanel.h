...
#define MARBLERECORDPANEL_REFRESHSEALPOS_OFFSET UNITYSDK_OFFSET(0x111F7D30)
#define MARBLERECORDPANEL_SETSEALHP_OFFSET UNITYSDK_OFFSET(0x111F75A0)
#define MARBLERECORDPANEL_SETSEALVISIBLE_OFFSET UNITYSDK_OFFSET(0x111F79A0)
#define MARBLERECORDPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0x111F7DF0)

inline static constexpr unsigned int MarbleRecordPanel_TypeDefinitionIndex = 37088;
