...
#define MARBLERECORDPANEL_REFRESHSEALPOS_OFFSET UNITYSDK_OFFSET(0x88C2290)
#define MARBLERECORDPANEL_SETSEALHP_OFFSET UNITYSDK_OFFSET(0x88C1B00)
#define MARBLERECORDPANEL_SETSEALVISIBLE_OFFSET UNITYSDK_OFFSET(0x88C1F00)
#define MARBLERECORDPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0x88C2350)
