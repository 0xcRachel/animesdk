...
#define CARFLOWINTERSECTION_INIT_OFFSET UNITYSDK_OFFSET(0xECE5A10)
#define CARFLOWINTERSECTION_START_OFFSET UNITYSDK_OFFSET(0xECE60A0)
#define CARFLOWINTERSECTION_UPDATE_OFFSET UNITYSDK_OFFSET(0xECE60E0)
#define CARFLOWINTERSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xECE6120)
