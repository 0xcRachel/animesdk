...
#define CARFLOWINTERSECTION_INIT_OFFSET UNITYSDK_OFFSET(0xA6E1210)
#define CARFLOWINTERSECTION_START_OFFSET UNITYSDK_OFFSET(0xA6E18A0)
#define CARFLOWINTERSECTION_UPDATE_OFFSET UNITYSDK_OFFSET(0xA6E18E0)
#define CARFLOWINTERSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xA6E1920)
