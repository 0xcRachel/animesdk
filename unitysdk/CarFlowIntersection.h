...
#define CARFLOWINTERSECTION_INIT_OFFSET UNITYSDK_OFFSET(0x994EBF0)
#define CARFLOWINTERSECTION_START_OFFSET UNITYSDK_OFFSET(0x994F280)
#define CARFLOWINTERSECTION_UPDATE_OFFSET UNITYSDK_OFFSET(0x994F2C0)
#define CARFLOWINTERSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x994F300)

inline static constexpr unsigned int CarFlowIntersection_TypeDefinitionIndex = 37034;
