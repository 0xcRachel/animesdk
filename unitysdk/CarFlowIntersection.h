...
#define CARFLOWINTERSECTION_INIT_OFFSET UNITYSDK_OFFSET(0x14E3D5D0)
#define CARFLOWINTERSECTION_START_OFFSET UNITYSDK_OFFSET(0x14E3DB10)
#define CARFLOWINTERSECTION_UPDATE_OFFSET UNITYSDK_OFFSET(0x14E3DB50)
#define CARFLOWINTERSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x14E3DB90)
