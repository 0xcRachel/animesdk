...
#define CLASS_2_A952C1D935C35AF5_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1098C030)
#define CLASS_2_A952C1D935C35AF5_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1098C070)
#define CLASS_2_A952C1D935C35AF5_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1098C170)
#define CLASS_2_A952C1D935C35AF5_TICK_OFFSET UNITYSDK_OFFSET(0x1098C1C0)
#define CLASS_2_A952C1D935C35AF5__CTOR_OFFSET UNITYSDK_OFFSET(0x1098C020)

inline static constexpr unsigned int Class_2_A952C1D935C35AF5_TypeDefinitionIndex = 42029;

class Class_2_A952C1D935C35AF5 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::RestoreTrackingMission* Field_2_0; // 0x20
