...
#define CLASS_1_5B567C8A01BAEDFE_373_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A1B79A0)
#define CLASS_1_5B567C8A01BAEDFE_373_CLONE_OFFSET UNITYSDK_OFFSET(0x1A1B7810)
#define CLASS_1_5B567C8A01BAEDFE_373_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A1B78B0)
#define CLASS_1_5B567C8A01BAEDFE_373_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A1B7850)
#define CLASS_1_5B567C8A01BAEDFE_373_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A1B7900)
#define CLASS_1_5B567C8A01BAEDFE_373_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A1B79F0)
#define CLASS_1_5B567C8A01BAEDFE_373_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A1B79C0)
#define CLASS_1_5B567C8A01BAEDFE_373_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A1B7790)
#define CLASS_1_5B567C8A01BAEDFE_373_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A1B77C0)
#define CLASS_1_5B567C8A01BAEDFE_373_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A1B7930)
#define CLASS_1_5B567C8A01BAEDFE_373_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A1B7990)
#define CLASS_1_5B567C8A01BAEDFE_373__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1B7A40)
#define CLASS_1_5B567C8A01BAEDFE_373__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A1B77E0)
#define CLASS_1_5B567C8A01BAEDFE_373__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1B77D0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_373*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_373_TypeDefinitionIndex)->GetStaticField(0x1BED0);
	}
