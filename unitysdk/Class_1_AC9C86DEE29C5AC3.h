...
#define CLASS_1_AC9C86DEE29C5AC3__CTOR_OFFSET UNITYSDK_OFFSET(0x16125220)

inline static constexpr unsigned int Class_1_AC9C86DEE29C5AC3_TypeDefinitionIndex = 32656;

class Class_1_AC9C86DEE29C5AC3 : public ::System::Object
{
public:
	::RPG::GameCore::FiveDimWindowControllerComponentConfig* Field_1_0; // 0x10
	::Class_1_43BD383C98B4C0C5_26* Field_1_1; // 0x18
