...
#define CLASS_2_6303C6A71250B2C6_METHOD_2_323F95926A2F616E_OFFSET UNITYSDK_OFFSET(0x99DEF60)
#define CLASS_2_6303C6A71250B2C6_METHOD_2_DE70BFBC2BB426D0_OFFSET UNITYSDK_OFFSET(0x99DF020)
#define CLASS_2_6303C6A71250B2C6__CTOR_OFFSET UNITYSDK_OFFSET(0x99DE2A0)
#define CLASS_2_6303C6A71250B2C6__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x99DE740)
#define CLASS_2_6303C6A71250B2C6__ONEXITFINALSTEP_OFFSET UNITYSDK_OFFSET(0x99DEFD0)
#define CLASS_2_6303C6A71250B2C6__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x99DE340)
#define CLASS_2_6303C6A71250B2C6___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x99DF1A0)
#define CLASS_2_6303C6A71250B2C6___IFIXBASEPROXY__ONEXITFINALSTEP_OFFSET UNITYSDK_OFFSET(0x99DF200)
#define CLASS_2_6303C6A71250B2C6___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x99DF140)
#define CLASS_2_6303C6A71250B2C6___ONINITIALIZECOMPONENT_B__1_0_OFFSET UNITYSDK_OFFSET(0x99DF0D0)

inline static constexpr unsigned int Class_2_6303C6A71250B2C6_TypeDefinitionIndex = 60999;
...
public:
	...
	::RPG::Client::MVVM::View::LimaoNewsSubmitLevelControl* Field_2_0; // 0x50
	::RPG::Client::MonoAnimationTrigger* Field_2_5; // 0x58
	::UnityEngine::UI::Text* Field_2_4; // 0x60
	::System::Collections::Generic::List_1<::RPG::Client::MVVM::View::LimaoNewsCommentControl*>* Field_2_3; // 0x68
