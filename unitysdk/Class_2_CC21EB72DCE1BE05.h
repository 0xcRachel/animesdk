...
#define CLASS_2_CC21EB72DCE1BE05_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8766DB0)
#define CLASS_2_CC21EB72DCE1BE05_METHOD_2_A43D587A89E24E29_OFFSET UNITYSDK_OFFSET(0x8766F50)
#define CLASS_2_CC21EB72DCE1BE05_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x8766C20)
#define CLASS_2_CC21EB72DCE1BE05_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x8766CC0)
#define CLASS_2_CC21EB72DCE1BE05_TICK_OFFSET UNITYSDK_OFFSET(0x8766E70)
#define CLASS_2_CC21EB72DCE1BE05__CTOR_OFFSET UNITYSDK_OFFSET(0x8766BA0)

inline static constexpr unsigned int Class_2_CC21EB72DCE1BE05_TypeDefinitionIndex = 46550;
...
public:
	...
	::RPG::GameCore::WolfBroPuzzleFuncBtnListener* Field_2_1; // 0x28
