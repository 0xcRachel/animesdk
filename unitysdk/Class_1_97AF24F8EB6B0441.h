...
#define CLASS_1_97AF24F8EB6B0441__CTOR_OFFSET UNITYSDK_OFFSET(0x189DA4C0)
...
public:
	...
	::RPG::Client::LittleGame::SmartObjectState Field_1_3; // 0x2C
	::RPG::GameCore::LittleGameSmartObjectSlotGroup Field_1_4; // 0x30
