...
#define CLASS_1_97AF24F8EB6B0441__CTOR_OFFSET UNITYSDK_OFFSET(0x16A2D970)
...
public:
	...
	::RPG::Client::LittleGame::SmartObjectState Field_1_2; // 0x1C
	::RPG::GameCore::LittleGameEntityType Field_1_1; // 0x20
