...
#define CLASS_2_12C7257360850A2E_DISPOSE_OFFSET UNITYSDK_OFFSET(0xECCCAC0)
#define CLASS_2_12C7257360850A2E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xECCCB00)
#define CLASS_2_12C7257360850A2E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xECCCD30)
#define CLASS_2_12C7257360850A2E_TICK_OFFSET UNITYSDK_OFFSET(0xECCCD80)
#define CLASS_2_12C7257360850A2E__CTOR_OFFSET UNITYSDK_OFFSET(0xECCCAB0)
