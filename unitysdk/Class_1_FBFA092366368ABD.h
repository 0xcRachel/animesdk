...
#define CLASS_1_FBFA092366368ABD_DOFAILED_OFFSET UNITYSDK_OFFSET(0x163A9AC0)
#define CLASS_1_FBFA092366368ABD_DOSUCCEED_OFFSET UNITYSDK_OFFSET(0x163A9A80)
#define CLASS_1_FBFA092366368ABD_EXECUTE_OFFSET UNITYSDK_OFFSET(0x163A9A40)
#define CLASS_1_FBFA092366368ABD_GETTYPENAME_OFFSET UNITYSDK_OFFSET(0x163A97F0)
#define CLASS_1_FBFA092366368ABD_GET_ACTIONSYSTEM_OFFSET UNITYSDK_OFFSET(0x163A9890)
#define CLASS_1_FBFA092366368ABD_GET_FAILURECOUNT_OFFSET UNITYSDK_OFFSET(0x163A9870)
#define CLASS_1_FBFA092366368ABD_GET_FINISHCOUNT_OFFSET UNITYSDK_OFFSET(0x163A9880)
#define CLASS_1_FBFA092366368ABD_GET_ID_OFFSET UNITYSDK_OFFSET(0x163A9840)
#define CLASS_1_FBFA092366368ABD_GET_ONDATAFAILED_OFFSET UNITYSDK_OFFSET(0x163A9940)
#define CLASS_1_FBFA092366368ABD_GET_ONDATASTARTING_OFFSET UNITYSDK_OFFSET(0x163A9900)
#define CLASS_1_FBFA092366368ABD_GET_ONDATASUCCEED_OFFSET UNITYSDK_OFFSET(0x163A9920)
#define CLASS_1_FBFA092366368ABD_GET_ONFAILED_OFFSET UNITYSDK_OFFSET(0x163A9960)
#define CLASS_1_FBFA092366368ABD_GET_ONFINISH_OFFSET UNITYSDK_OFFSET(0x163A9980)
#define CLASS_1_FBFA092366368ABD_GET_ONITEMFAILED_OFFSET UNITYSDK_OFFSET(0x163A99E0)
#define CLASS_1_FBFA092366368ABD_GET_ONITEMSTARTING_OFFSET UNITYSDK_OFFSET(0x163A99A0)
#define CLASS_1_FBFA092366368ABD_GET_ONITEMSUCCEED_OFFSET UNITYSDK_OFFSET(0x163A99C0)
#define CLASS_1_FBFA092366368ABD_GET_ONSTARTING_OFFSET UNITYSDK_OFFSET(0x163A98C0)
#define CLASS_1_FBFA092366368ABD_GET_ONSUCCEED_OFFSET UNITYSDK_OFFSET(0x163A98E0)
#define CLASS_1_FBFA092366368ABD_GET_ROOTQUEUE_OFFSET UNITYSDK_OFFSET(0x163A98A0)
#define CLASS_1_FBFA092366368ABD_GET_SUCCESSCOUNT_OFFSET UNITYSDK_OFFSET(0x163A9860)
#define CLASS_1_FBFA092366368ABD_GET_TOTALCOUNT_OFFSET UNITYSDK_OFFSET(0x163A9850)
#define CLASS_1_FBFA092366368ABD_METHOD_1_03BFDB1C3240A55A_OFFSET UNITYSDK_OFFSET(0x163AAB80)
#define CLASS_1_FBFA092366368ABD_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x163A9B10)
#define CLASS_1_FBFA092366368ABD_METHOD_1_2C61108A8DA0AD73_OFFSET UNITYSDK_OFFSET(0x163A9EA0)
#define CLASS_1_FBFA092366368ABD_METHOD_1_39AB6BE86BE284EE_OFFSET UNITYSDK_OFFSET(0x163AA260)
#define CLASS_1_FBFA092366368ABD_METHOD_1_422AB1A19F04E217_OFFSET UNITYSDK_OFFSET(0x163AAF40)
#define CLASS_1_FBFA092366368ABD_METHOD_1_44D5E19630157ECE_OFFSET UNITYSDK_OFFSET(0x163AB040)
#define CLASS_1_FBFA092366368ABD_METHOD_1_47471DD3CB437601_OFFSET UNITYSDK_OFFSET(0x163AA0A0)
#define CLASS_1_FBFA092366368ABD_METHOD_1_494D7FA4CA2316AD_OFFSET UNITYSDK_OFFSET(0x163A9F60)
#define CLASS_1_FBFA092366368ABD_METHOD_1_6287ACD5750B69E7_OFFSET UNITYSDK_OFFSET(0x163AA210)
#define CLASS_1_FBFA092366368ABD_METHOD_1_9DB2C80C0CD4760B_OFFSET UNITYSDK_OFFSET(0x163A9E00)
#define CLASS_1_FBFA092366368ABD_METHOD_1_BA0B557A599693AD_OFFSET UNITYSDK_OFFSET(0x163AA330)
#define CLASS_1_FBFA092366368ABD_METHOD_1_BF2C9F6DD9492BE4_OFFSET UNITYSDK_OFFSET(0x163AA400)
#define CLASS_1_FBFA092366368ABD_METHOD_1_C6E14CE377D03CE0_OFFSET UNITYSDK_OFFSET(0x163AA020)
#define CLASS_1_FBFA092366368ABD_METHOD_1_D0663CE240A6DAF4_OFFSET UNITYSDK_OFFSET(0x163A9F10)
#define CLASS_1_FBFA092366368ABD_SET_ONDATAFAILED_OFFSET UNITYSDK_OFFSET(0x163A9950)
#define CLASS_1_FBFA092366368ABD_SET_ONDATASTARTING_OFFSET UNITYSDK_OFFSET(0x163A9910)
#define CLASS_1_FBFA092366368ABD_SET_ONDATASUCCEED_OFFSET UNITYSDK_OFFSET(0x163A9930)
#define CLASS_1_FBFA092366368ABD_SET_ONFAILED_OFFSET UNITYSDK_OFFSET(0x163A9970)
#define CLASS_1_FBFA092366368ABD_SET_ONFINISH_OFFSET UNITYSDK_OFFSET(0x163A9990)
#define CLASS_1_FBFA092366368ABD_SET_ONITEMFAILED_OFFSET UNITYSDK_OFFSET(0x163A99F0)
#define CLASS_1_FBFA092366368ABD_SET_ONITEMSTARTING_OFFSET UNITYSDK_OFFSET(0x163A99B0)
#define CLASS_1_FBFA092366368ABD_SET_ONITEMSUCCEED_OFFSET UNITYSDK_OFFSET(0x163A99D0)
#define CLASS_1_FBFA092366368ABD_SET_ONSTARTING_OFFSET UNITYSDK_OFFSET(0x163A98D0)
#define CLASS_1_FBFA092366368ABD_SET_ONSUCCEED_OFFSET UNITYSDK_OFFSET(0x163A98F0)
#define CLASS_1_FBFA092366368ABD_SET_ROOTQUEUE_OFFSET UNITYSDK_OFFSET(0x163A98B0)
#define CLASS_1_FBFA092366368ABD_UPDATEPROGRESS_OFFSET UNITYSDK_OFFSET(0x163A9A00)
#define CLASS_1_FBFA092366368ABD__ADDERRORLOG_B__89_0_OFFSET UNITYSDK_OFFSET(0x163ABD10)
#define CLASS_1_FBFA092366368ABD__ADDPROGRESSLOG_B__90_0_OFFSET UNITYSDK_OFFSET(0x163ACA90)
#define CLASS_1_FBFA092366368ABD__ADDPROGRESSLOG_B__90_1_OFFSET UNITYSDK_OFFSET(0x163ACAA0)
#define CLASS_1_FBFA092366368ABD__ADDPROGRESSLOG_B__90_2_OFFSET UNITYSDK_OFFSET(0x163AD5F0)
#define CLASS_1_FBFA092366368ABD__ADDPROGRESSLOG_B__90_3_OFFSET UNITYSDK_OFFSET(0x163AEA60)
#define CLASS_1_FBFA092366368ABD__ADDPROGRESSLOG_B__90_4_OFFSET UNITYSDK_OFFSET(0x163AED40)
#define CLASS_1_FBFA092366368ABD__CTOR_OFFSET UNITYSDK_OFFSET(0x163A9B80)
...
public:
	...
	::RPG::Client::ActionEvent_1<::Class_0_16E4307DCC419505_579*>* _OnStarting_k__BackingField; // 0x18
	::RPG::Client::ActionEvent_4<::Class_0_16E4307DCC419505_579*, ::Class_0_16E4307DCC419505_581*, ::System::Object*, ::RPG::Client::ExeCode>* _OnFinish_k__BackingField; // 0x20
	::Class_1_C530CE1C0A4E2133* Field_1_3; // 0x28
	::RPG::Client::ActionEvent_1<::Class_2_BF47C01E9CFEA39C*>* _OnItemFailed_k__BackingField; // 0x30
	::RPG::Client::ActionEvent_2<::Class_0_16E4307DCC419505_579*, ::Class_0_16E4307DCC419505_581*>* _OnDataStarting_k__BackingField; // 0x38
	::RPG::Client::ActionEvent_1<::Class_0_16E4307DCC419505_579*>* _OnSucceed_k__BackingField; // 0x40
	::RPG::Client::ActionEvent_1<::Class_2_BF47C01E9CFEA39C*>* _OnDataFailed_k__BackingField; // 0x48
	::Class_1_C530CE1C0A4E2133* Field_1_8; // 0x50
	...
	::RPG::Client::ActionEvent_2<::Class_0_16E4307DCC419505_579*, ::Class_0_16E4307DCC419505_581*>* _OnDataSucceed_k__BackingField; // 0x60
	::System::String* Field_1_11; // 0x68
	::System::String* Field_1_12; // 0x70
	::Class_1_C6B3B57B6E91674E* _RootQueue_k__BackingField; // 0x78
	::Class_1_C530CE1C0A4E2133* Field_1_14; // 0x80
	...
	::RPG::Client::ActionEvent_1<::Class_2_BF47C01E9CFEA39C*>* _OnFailed_k__BackingField; // 0xA0
