...
#define CLASS_3_8CCE4D6721C86CE0_METHOD_3_1FEC466530D44C17_OFFSET UNITYSDK_OFFSET(0x1721C230)
#define CLASS_3_8CCE4D6721C86CE0_METHOD_3_57A1D28F65E6799B_OFFSET UNITYSDK_OFFSET(0x1721C310)
#define CLASS_3_8CCE4D6721C86CE0__CTOR_OFFSET UNITYSDK_OFFSET(0x1721C270)

inline static constexpr unsigned int Class_3_8CCE4D6721C86CE0_TypeDefinitionIndex = 20245;

class Class_3_8CCE4D6721C86CE0 : public ::RPG::GameCore::TaskConfig
{
public:
	::RPG::GameCore::DynamicString* Field_3_7; // 0x18
	::RPG::GameCore::DynamicFloat* Field_3_4; // 0x20
	::RPG::GameCore::JsonEnum* Field_3_1; // 0x28
	...
	::RPG::GameCore::TargetEvaluator* Field_3_0; // 0x50
