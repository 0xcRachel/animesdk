...
#define CLASS_2_CB38D1CC30518745_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10ED8110)
#define CLASS_2_CB38D1CC30518745_METHOD_2_171A4D4799D0DC21_OFFSET UNITYSDK_OFFSET(0x10EDCFD0)
#define CLASS_2_CB38D1CC30518745_METHOD_2_277548B4528BF03C_OFFSET UNITYSDK_OFFSET(0x10EDAFF0)
#define CLASS_2_CB38D1CC30518745_METHOD_2_28EB11670A8E5A86_OFFSET UNITYSDK_OFFSET(0x10ED9380)
#define CLASS_2_CB38D1CC30518745_METHOD_2_33E2FA8E6403B93D_OFFSET UNITYSDK_OFFSET(0x10ED8AD0)
#define CLASS_2_CB38D1CC30518745_METHOD_2_3B258437A86233AC_OFFSET UNITYSDK_OFFSET(0x10EDC930)
#define CLASS_2_CB38D1CC30518745_METHOD_2_3C6EFDE37573F077_OFFSET UNITYSDK_OFFSET(0x10EDCA00)
#define CLASS_2_CB38D1CC30518745_METHOD_2_4805283D59625FD9_OFFSET UNITYSDK_OFFSET(0x10EDBF40)
#define CLASS_2_CB38D1CC30518745_METHOD_2_57D5ED2C4C06D908_OFFSET UNITYSDK_OFFSET(0x10EDA1C0)
#define CLASS_2_CB38D1CC30518745_METHOD_2_5BF49FDE1D7B935F_OFFSET UNITYSDK_OFFSET(0x10EDBD20)
#define CLASS_2_CB38D1CC30518745_METHOD_2_64752E993AF7A109_OFFSET UNITYSDK_OFFSET(0x10EDD190)
#define CLASS_2_CB38D1CC30518745_METHOD_2_67B10534C8C5ACFE_OFFSET UNITYSDK_OFFSET(0x10EDD4D0)
#define CLASS_2_CB38D1CC30518745_METHOD_2_686221D5DF498040_OFFSET UNITYSDK_OFFSET(0x10EDBCC0)
#define CLASS_2_CB38D1CC30518745_METHOD_2_7DD84EAFF333A1E4_1_OFFSET UNITYSDK_OFFSET(0x10EDAF00)
#define CLASS_2_CB38D1CC30518745_METHOD_2_7DD84EAFF333A1E4_OFFSET UNITYSDK_OFFSET(0x10EDAEB0)
#define CLASS_2_CB38D1CC30518745_METHOD_2_816ED7FC0A7FCCD1_OFFSET UNITYSDK_OFFSET(0x10ED9560)
#define CLASS_2_CB38D1CC30518745_METHOD_2_82B2BADB6C94DC6B_OFFSET UNITYSDK_OFFSET(0x10EDD440)
#define CLASS_2_CB38D1CC30518745_METHOD_2_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x10EDAD30)
#define CLASS_2_CB38D1CC30518745_METHOD_2_9D16F90644F98754_OFFSET UNITYSDK_OFFSET(0x10EDCED0)
#define CLASS_2_CB38D1CC30518745_METHOD_2_9D8893CD130270AA_OFFSET UNITYSDK_OFFSET(0x10ED8620)
#define CLASS_2_CB38D1CC30518745_METHOD_2_9E49294C33DF47C3_OFFSET UNITYSDK_OFFSET(0x10EDACD0)
#define CLASS_2_CB38D1CC30518745_METHOD_2_B43C848B078B3C34_OFFSET UNITYSDK_OFFSET(0x10EDC520)
#define CLASS_2_CB38D1CC30518745_METHOD_2_C2302C13362F016F_OFFSET UNITYSDK_OFFSET(0x10EDB7F0)
#define CLASS_2_CB38D1CC30518745_METHOD_2_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x10EDA170)
#define CLASS_2_CB38D1CC30518745_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x10ED8A50)
#define CLASS_2_CB38D1CC30518745_METHOD_2_D9F6AAE1EA9F3DF7_OFFSET UNITYSDK_OFFSET(0x10EDD7B0)
#define CLASS_2_CB38D1CC30518745_METHOD_2_DB5B319D44B0143C_OFFSET UNITYSDK_OFFSET(0x10EDD750)
#define CLASS_2_CB38D1CC30518745_METHOD_2_DB67EEFB041425EC_OFFSET UNITYSDK_OFFSET(0x10ED9BE0)
#define CLASS_2_CB38D1CC30518745_METHOD_2_F10A0D072D26C4BF_OFFSET UNITYSDK_OFFSET(0x10EDBE80)
#define CLASS_2_CB38D1CC30518745_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x10EDAF80)
#define CLASS_2_CB38D1CC30518745_METHOD_2_F7810952FE14E15C_OFFSET UNITYSDK_OFFSET(0x10EDA810)
#define CLASS_2_CB38D1CC30518745_METHOD_2_FEFB1056B17D055E_OFFSET UNITYSDK_OFFSET(0x10EDCCB0)
#define CLASS_2_CB38D1CC30518745_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10EDA290)
#define CLASS_2_CB38D1CC30518745_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10EDAC80)
#define CLASS_2_CB38D1CC30518745_TICK_OFFSET UNITYSDK_OFFSET(0x10ED87C0)
#define CLASS_2_CB38D1CC30518745__CCTOR_OFFSET UNITYSDK_OFFSET(0x10EDDA50)
#define CLASS_2_CB38D1CC30518745__CTOR_OFFSET UNITYSDK_OFFSET(0x10ED7E60)

inline static constexpr unsigned int Class_2_CB38D1CC30518745_TypeDefinitionIndex = 46075;
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_2_CB38D1CC30518745_TypeDefinitionIndex)->GetStaticField(0x33810);
	}
	static ::System::String** StaticGet_Field_2_52()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_2_CB38D1CC30518745_TypeDefinitionIndex)->GetStaticField(0x33818);
	}
	static ::System::Int32* StaticGet_Field_2_50()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_2_CB38D1CC30518745_TypeDefinitionIndex)->GetStaticField(0xC3C0);
	}
	static ::System::Int32* StaticGet_Field_2_49()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_2_CB38D1CC30518745_TypeDefinitionIndex)->GetStaticField(0xC3C4);
	}
	::System::Collections::Generic::List_1<::System::UInt32>* Field_2_21; // 0x18
	::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* Field_2_6; // 0x20
	::RPG::GameCore::AnchorInfo* Field_2_40; // 0x28
	::System::Collections::Generic::List_1<::System::UInt32>* Field_2_20; // 0x30
	::System::Collections::Generic::List_1<::Class_2_CB38D1CC30518745_Class_1_AEB398135389F96A*>* Field_2_25; // 0x38
	::System::Collections::Generic::List_1<::System::UInt32>* Field_2_19; // 0x40
	...
	::RPG::Client::IAssetOperation* Field_2_41; // 0x80
	::System::Boolean Field_2_27; // 0x88
	::System::Boolean Field_2_28; // 0x89
	::System::Boolean Field_2_17; // 0x8A
	::UnityEngine::Vector3 Field_2_43; // 0x8C
	::System::Int32 Field_2_39; // 0x98
	::Class_2_CB38D1CC30518745_Phase Field_2_26; // 0x9C
	::System::Single Field_2_12; // 0xA0
	::System::UInt32 Field_2_23; // 0xA4
	::System::Single Field_2_38; // 0xA8
	...
	::System::Single Field_2_44; // 0xE4
	::System::Boolean Field_2_14; // 0xE8
	::System::Boolean Field_2_15; // 0xE9
	::System::Boolean Field_2_24; // 0xEA
	::System::Boolean Field_2_16; // 0xEB
	::System::Single Field_2_11; // 0xEC
	::UnityEngine::Vector3 Field_2_4; // 0xF0
	::System::Single Field_2_34; // 0xFC
	::System::Single Field_2_45; // 0x100
	::UnityEngine::Vector3 Field_2_3; // 0x104
	::System::Int32 Field_2_48; // 0x110
	::System::Single Field_2_7; // 0x114
	::UnityEngine::Vector3 Field_2_2; // 0x118
