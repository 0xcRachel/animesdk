...
#define CLASS_3_F60C8A83781D2E02_DISPOSE_OFFSET UNITYSDK_OFFSET(0x114C15C0)
#define CLASS_3_F60C8A83781D2E02_EVALUATE_OFFSET UNITYSDK_OFFSET(0x114C1550)
#define CLASS_3_F60C8A83781D2E02__CTOR_OFFSET UNITYSDK_OFFSET(0x114C1480)
#define CLASS_3_F60C8A83781D2E02___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x114C1630)
