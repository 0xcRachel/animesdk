...
#define CLASS_2_B6B34A73CDC61ECA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10E4AE50)
#define CLASS_2_B6B34A73CDC61ECA_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10E4AE90)
#define CLASS_2_B6B34A73CDC61ECA_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10E4B140)
#define CLASS_2_B6B34A73CDC61ECA_TICK_OFFSET UNITYSDK_OFFSET(0x10E4B190)
#define CLASS_2_B6B34A73CDC61ECA__CTOR_OFFSET UNITYSDK_OFFSET(0x10E4AE40)

inline static constexpr unsigned int Class_2_B6B34A73CDC61ECA_TypeDefinitionIndex = 45863;

class Class_2_B6B34A73CDC61ECA : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::LeaveLoopScene* Field_2_0; // 0x18
