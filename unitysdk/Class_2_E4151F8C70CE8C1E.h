...
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_01509228E3A9577B_OFFSET UNITYSDK_OFFSET(0x10FCBF60)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_0278C58BA5A6AE4B_OFFSET UNITYSDK_OFFSET(0x10FCC190)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_071850D2764E9D4C_OFFSET UNITYSDK_OFFSET(0x10FC87B0)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_08FFEF4D9AFC80E9_OFFSET UNITYSDK_OFFSET(0x10FC9320)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_0A6D544248F11F3A_OFFSET UNITYSDK_OFFSET(0x10FCB910)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_14F96CE90F77CBB9_OFFSET UNITYSDK_OFFSET(0x10FC8320)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_17820CA3EEBFB6BE_OFFSET UNITYSDK_OFFSET(0x10FCC470)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_23B9605F2F8322B7_OFFSET UNITYSDK_OFFSET(0x10FC7810)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_2FF79950A677C64B_OFFSET UNITYSDK_OFFSET(0x10FC85C0)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_3C0F7658751C32B0_OFFSET UNITYSDK_OFFSET(0x10FC9E10)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_3D9F24E92E34F265_OFFSET UNITYSDK_OFFSET(0x10FCB1C0)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x10FC3C40)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_44E1C4BA1123578B_OFFSET UNITYSDK_OFFSET(0x10FCC200)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_464F9487BF0D77F8_OFFSET UNITYSDK_OFFSET(0x10FC2D10)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_5B2DBD7227D80209_OFFSET UNITYSDK_OFFSET(0x10FC3D30)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_6916CB2AB9451DD7_OFFSET UNITYSDK_OFFSET(0x10FC33B0)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_6CB4DA72C282A2D2_OFFSET UNITYSDK_OFFSET(0x10FC9EB0)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_73F0F3D9A8276768_OFFSET UNITYSDK_OFFSET(0x10FCB580)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_7AB000B2DA3DF7D1_OFFSET UNITYSDK_OFFSET(0x10FCB6D0)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_7FD3F31F3302F376_OFFSET UNITYSDK_OFFSET(0x10FC2B60)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_88741C1A51414A3C_OFFSET UNITYSDK_OFFSET(0x10FC2A50)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x10FC3720)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_90D019D81149A8BA_OFFSET UNITYSDK_OFFSET(0x10FCC580)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_95CDF48BEFEBA001_OFFSET UNITYSDK_OFFSET(0x10FCA3D0)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_96189EDEF38976A6_OFFSET UNITYSDK_OFFSET(0x10FC3ED0)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x10FC7A70)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_9E330D7B0B62EC19_OFFSET UNITYSDK_OFFSET(0x10FC39A0)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0x10FCA350)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_B0091B0E1DC92674_OFFSET UNITYSDK_OFFSET(0x10FCBA40)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_B08F45C7106CDB82_OFFSET UNITYSDK_OFFSET(0x10FCABF0)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_B12B4E4A39A083D2_OFFSET UNITYSDK_OFFSET(0x10FC8F20)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_B1EB734337965E73_OFFSET UNITYSDK_OFFSET(0x10FC3130)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_B7F8E0B4AF22DEA3_OFFSET UNITYSDK_OFFSET(0x10FC7EB0)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_B9A97467188E4B69_OFFSET UNITYSDK_OFFSET(0x10FC3030)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_B9BFE724809472F9_OFFSET UNITYSDK_OFFSET(0x10FCA000)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_BF5E2DCAE0BF038A_OFFSET UNITYSDK_OFFSET(0x10FC7B30)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_C2984542C0604D2C_OFFSET UNITYSDK_OFFSET(0x10FCB390)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_CD49AD78BC19D569_OFFSET UNITYSDK_OFFSET(0x10FC7FF0)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_D15F52B395531E3F_OFFSET UNITYSDK_OFFSET(0x10FC2C50)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_D5C60D4BCF120194_OFFSET UNITYSDK_OFFSET(0x10FCB800)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_DA5597481994D152_OFFSET UNITYSDK_OFFSET(0x10FC37D0)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_DB67EEFB041425EC_OFFSET UNITYSDK_OFFSET(0x10FC9680)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_F206290BA342BA13_OFFSET UNITYSDK_OFFSET(0x10FC31A0)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_F79D5EC57FBF426E_OFFSET UNITYSDK_OFFSET(0x10FC7E60)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_F9BEB44328A0ACF6_OFFSET UNITYSDK_OFFSET(0x10FCBB40)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_FC5DD04EF996966E_OFFSET UNITYSDK_OFFSET(0x10FC9A80)
#define CLASS_2_E4151F8C70CE8C1E__CTOR_OFFSET UNITYSDK_OFFSET(0x10FCC4C0)

inline static constexpr unsigned int Class_2_E4151F8C70CE8C1E_TypeDefinitionIndex = 55594;

class Class_2_E4151F8C70CE8C1E : public ::RPG::Client::BehaviorBase
{
public:
	::UnityEngine::Transform* Field_2_11; // 0x18
	::RPG::Client::AttachPointMapping* Field_2_9; // 0x20
	::UnityEngine::Transform* Field_2_10; // 0x28
	::Class_2_523C55AEA55804D8* Field_2_5; // 0x30
	::RPG::Client::NotifyHandler* Field_2_31; // 0x38
	::RPG::GameCore::TransformComponent* Field_2_6; // 0x40
	::Il2CppArray<::RPG::Client::Effect_AfterImageNew*>* Field_2_28; // 0x48
	::RPG::GameCore::GameEntity* Field_2_1; // 0x50
	::UnityEngine::Transform* Field_2_12; // 0x58
	::System::Collections::Generic::HashSet_1<::System::Int32>* Field_2_3; // 0x60
	::RPG::Client::NotifyHandler* Field_2_30; // 0x68
	::System::Collections::Generic::HashSet_1<::System::Int32>* Field_2_4; // 0x70
	::RPG::GameCore::CharacterModelComponent* Field_2_7; // 0x78
	::UnityEngine::Rigidbody* Field_2_8; // 0x80
	::System::Int32 Field_2_15; // 0x88
	::System::Single Field_2_21; // 0x8C
	::RPG::Client::ScaleFollowOption Field_2_25; // 0x90
	::UnityEngine::Vector3 Field_2_22; // 0x94
	::UnityEngine::Vector3 Field_2_29; // 0xA0
	::System::Boolean Field_2_27; // 0xAC
	::System::Boolean Field_2_0; // 0xAD
	::UnityEngine::Vector3 Field_2_19; // 0xB0
	::RPG::Client::ModelFlipOption Field_2_26; // 0xBC
	::System::Single Field_2_14; // 0xC0
	::System::Single Field_2_13; // 0xC4
	::RPG::Client::RotationFollowOption Field_2_24; // 0xC8
	::RPG::Client::PositionFollowOption Field_2_23; // 0xCC
	::UnityEngine::Vector3 Field_2_20; // 0xD0
	::System::Single Field_2_18; // 0xDC
	::UnityEngine::Vector3 Field_2_16; // 0xE0
	::UnityEngine::Vector3 Field_2_17; // 0xEC
	...
	::System::Boolean Method_2_6CB4DA72C282A2D2(::UnityEngine::ParticleSystem* a1)
	{
		return ((::System::Boolean(*)(::PVOID, ::UnityEngine::ParticleSystem*))((::PBYTE)hIl2Cpp + CLASS_2_E4151F8C70CE8C1E_METHOD_2_6CB4DA72C282A2D2_OFFSET))(this, a1);
	}
