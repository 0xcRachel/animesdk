...
#define CLASS_1_5B567C8A01BAEDFE_330_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A958200)
#define CLASS_1_5B567C8A01BAEDFE_330_CLONE_OFFSET UNITYSDK_OFFSET(0x1A958070)
#define CLASS_1_5B567C8A01BAEDFE_330_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A958110)
#define CLASS_1_5B567C8A01BAEDFE_330_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A9580B0)
#define CLASS_1_5B567C8A01BAEDFE_330_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A958160)
#define CLASS_1_5B567C8A01BAEDFE_330_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A958250)
#define CLASS_1_5B567C8A01BAEDFE_330_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A958220)
#define CLASS_1_5B567C8A01BAEDFE_330_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A957FF0)
#define CLASS_1_5B567C8A01BAEDFE_330_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A958020)
#define CLASS_1_5B567C8A01BAEDFE_330_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A958190)
#define CLASS_1_5B567C8A01BAEDFE_330_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A9581F0)
#define CLASS_1_5B567C8A01BAEDFE_330__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A9582A0)
#define CLASS_1_5B567C8A01BAEDFE_330__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A958040)
#define CLASS_1_5B567C8A01BAEDFE_330__CTOR_OFFSET UNITYSDK_OFFSET(0x1A958030)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_330*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_330_TypeDefinitionIndex)->GetStaticField(0x32070);
	}
