...
#define CLASS_1_B79BADA9978B5C30_GET_ID_OFFSET UNITYSDK_OFFSET(0x1551F920)
#define CLASS_1_B79BADA9978B5C30_METHOD_1_18A5053E0B8194D7_OFFSET UNITYSDK_OFFSET(0x1551F730)
#define CLASS_1_B79BADA9978B5C30_METHOD_1_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0x1551F2C0)
#define CLASS_1_B79BADA9978B5C30_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x1551F990)
#define CLASS_1_B79BADA9978B5C30_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x1551F350)
#define CLASS_1_B79BADA9978B5C30_METHOD_1_343609514F0B1F13_OFFSET UNITYSDK_OFFSET(0x1551EE50)
#define CLASS_1_B79BADA9978B5C30_METHOD_1_38B862BB2192EC08_OFFSET UNITYSDK_OFFSET(0x1551F940)
#define CLASS_1_B79BADA9978B5C30_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x1551F8C0)
#define CLASS_1_B79BADA9978B5C30_METHOD_1_749948B663FCCCEF_OFFSET UNITYSDK_OFFSET(0x1551F6E0)
#define CLASS_1_B79BADA9978B5C30_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x1551F870)
#define CLASS_1_B79BADA9978B5C30_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1551F830)
#define CLASS_1_B79BADA9978B5C30_METHOD_1_E67B8EE7D04609D0_1_OFFSET UNITYSDK_OFFSET(0x1551F630)
#define CLASS_1_B79BADA9978B5C30_METHOD_1_E67B8EE7D04609D0_OFFSET UNITYSDK_OFFSET(0x1551F580)
#define CLASS_1_B79BADA9978B5C30_METHOD_1_F7BA13C72A6B3F58_OFFSET UNITYSDK_OFFSET(0x1551F480)
#define CLASS_1_B79BADA9978B5C30_ONSELECT_OFFSET UNITYSDK_OFFSET(0x1551F3D0)
#define CLASS_1_B79BADA9978B5C30_SET_ID_OFFSET UNITYSDK_OFFSET(0x1551F930)
#define CLASS_1_B79BADA9978B5C30__CCTOR_OFFSET UNITYSDK_OFFSET(0x1551F9F0)
#define CLASS_1_B79BADA9978B5C30__CTOR_OFFSET UNITYSDK_OFFSET(0x1551EE40)

inline static constexpr unsigned int Class_1_B79BADA9978B5C30_TypeDefinitionIndex = 70459;
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_B79BADA9978B5C30_TypeDefinitionIndex)->GetStaticField(0xC490);
	}
	static ::System::Int32* StaticGet_Field_1_1()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_B79BADA9978B5C30_TypeDefinitionIndex)->GetStaticField(0xC494);
	}
	static ::System::Int32* StaticGet_Field_1_2()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_B79BADA9978B5C30_TypeDefinitionIndex)->GetStaticField(0xC498);
	}
	::System::Action* Field_1_3; // 0x10
	::UnityEngine::Transform* Field_1_4; // 0x18
	::UnityEngine::GameObject* Field_1_5; // 0x20
	::UnityEngine::MeshRenderer* Field_1_6; // 0x28
