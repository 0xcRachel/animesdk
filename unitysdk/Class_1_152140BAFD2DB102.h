...
#define CLASS_1_152140BAFD2DB102_DISPOSE_OFFSET UNITYSDK_OFFSET(0x878E6C0)
#define CLASS_1_152140BAFD2DB102_GET_DYNAMICSTRINGS_OFFSET UNITYSDK_OFFSET(0x878EAD0)
#define CLASS_1_152140BAFD2DB102_GET_DYNAMICVALUES_OFFSET UNITYSDK_OFFSET(0x878EAB0)
#define CLASS_1_152140BAFD2DB102_GET_ISDISPOSED_OFFSET UNITYSDK_OFFSET(0x878E6A0)
#define CLASS_1_152140BAFD2DB102_GET_ISSILENCE_OFFSET UNITYSDK_OFFSET(0x878F720)
#define CLASS_1_152140BAFD2DB102_GET_OVERRIDEELATIONPOINT_OFFSET UNITYSDK_OFFSET(0x878F890)
#define CLASS_1_152140BAFD2DB102_GET_UICONFIG_OFFSET UNITYSDK_OFFSET(0x878F740)
#define CLASS_1_152140BAFD2DB102_METHOD_1_0497C5D3794AC6EB_1_OFFSET UNITYSDK_OFFSET(0x878EC30)
#define CLASS_1_152140BAFD2DB102_METHOD_1_0497C5D3794AC6EB_OFFSET UNITYSDK_OFFSET(0x878EB70)
#define CLASS_1_152140BAFD2DB102_METHOD_1_0A0A8830B02C5A4B_OFFSET UNITYSDK_OFFSET(0x878FBC0)
#define CLASS_1_152140BAFD2DB102_METHOD_1_0B351C9F98172C23_OFFSET UNITYSDK_OFFSET(0x878F9C0)
#define CLASS_1_152140BAFD2DB102_METHOD_1_0BA114B592B3A582_OFFSET UNITYSDK_OFFSET(0x878FAF0)
#define CLASS_1_152140BAFD2DB102_METHOD_1_0D2950F07429B2A3_OFFSET UNITYSDK_OFFSET(0x878E9B0)
#define CLASS_1_152140BAFD2DB102_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x878EAF0)
#define CLASS_1_152140BAFD2DB102_METHOD_1_1D4018D4200358D0_1_OFFSET UNITYSDK_OFFSET(0x878F760)
#define CLASS_1_152140BAFD2DB102_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x878EBC0)
#define CLASS_1_152140BAFD2DB102_METHOD_1_34632499FE9F94E2_OFFSET UNITYSDK_OFFSET(0x878F560)
#define CLASS_1_152140BAFD2DB102_METHOD_1_3A06A9FC6DD7BA4B_OFFSET UNITYSDK_OFFSET(0x878F0B0)
#define CLASS_1_152140BAFD2DB102_METHOD_1_4DA6D4A624E42CAB_OFFSET UNITYSDK_OFFSET(0x878F7D0)
#define CLASS_1_152140BAFD2DB102_METHOD_1_592B8E80B912F0A9_OFFSET UNITYSDK_OFFSET(0x878EC90)
#define CLASS_1_152140BAFD2DB102_METHOD_1_76BAE81A02260DCB_OFFSET UNITYSDK_OFFSET(0x878EB60)
#define CLASS_1_152140BAFD2DB102_METHOD_1_84050C834DAE965F_OFFSET UNITYSDK_OFFSET(0x8785A80)
#define CLASS_1_152140BAFD2DB102_METHOD_1_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x878E640)
#define CLASS_1_152140BAFD2DB102_METHOD_1_9DABF00CB3BADACE_OFFSET UNITYSDK_OFFSET(0x878F370)
#define CLASS_1_152140BAFD2DB102_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x878F4B0)
#define CLASS_1_152140BAFD2DB102_METHOD_1_B504A25E7D6681AA_OFFSET UNITYSDK_OFFSET(0x878E910)
#define CLASS_1_152140BAFD2DB102_METHOD_1_C5B80D23AF6CFA39_OFFSET UNITYSDK_OFFSET(0x878EDF0)
#define CLASS_1_152140BAFD2DB102_METHOD_1_E732817546C4B7A0_OFFSET UNITYSDK_OFFSET(0x878E870)
#define CLASS_1_152140BAFD2DB102_METHOD_1_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0x878F3E0)
#define CLASS_1_152140BAFD2DB102_SET_DYNAMICSTRINGS_OFFSET UNITYSDK_OFFSET(0x878EAE0)
#define CLASS_1_152140BAFD2DB102_SET_DYNAMICVALUES_OFFSET UNITYSDK_OFFSET(0x878EAC0)
#define CLASS_1_152140BAFD2DB102_SET_ISDISPOSED_OFFSET UNITYSDK_OFFSET(0x878E6B0)
#define CLASS_1_152140BAFD2DB102_SET_ISSILENCE_OFFSET UNITYSDK_OFFSET(0x878F730)
#define CLASS_1_152140BAFD2DB102_SET_OVERRIDEELATIONPOINT_OFFSET UNITYSDK_OFFSET(0x878F8A0)
#define CLASS_1_152140BAFD2DB102_SET_UICONFIG_OFFSET UNITYSDK_OFFSET(0x878F750)
#define CLASS_1_152140BAFD2DB102__CTOR_OFFSET UNITYSDK_OFFSET(0x878F8B0)

inline static constexpr unsigned int Class_1_152140BAFD2DB102_TypeDefinitionIndex = 44010;

class Class_1_152140BAFD2DB102 : public ::System::Object
{
public:
	::System::String* Field_1_36; // 0x10
	...
	::Class_3_BCCE950C2E8DF1F0* Field_1_12; // 0x38
	::RPG::PoolList_1<::RPG::GameCore::AbilityDynamicStringInjection>* _DynamicStrings_k__BackingField; // 0x40
	::RPG::GameCore::TurnInsertActionUIConfig* _UIConfig_k__BackingField; // 0x48
	::Il2CppArray<::RPG::GameCore::ModifierBehaviorFlag>* Field_1_31; // 0x50
	::System::String* Field_1_4; // 0x58
	::System::String* Field_1_1; // 0x60
	::RPG::GameCore::GameEntity* Field_1_7; // 0x68
	::RPG::PoolList_1<::RPG::GameCore::AbilityDynamicFloatInjection>* _DynamicValues_k__BackingField; // 0x70
	::RPG::GameCore::TurnState Field_1_15; // 0x78
	...
	::RPG::GameCore::InsertActionType Field_1_0; // 0x88
	::System::Boolean Field_1_3; // 0x8C
	::System::Boolean Field_1_5; // 0x8D
	::System::Boolean _IsDisposed_k__BackingField; // 0x8E
	::System::Boolean Field_1_28; // 0x8F
	::RPG::GameCore::ControlSkillType Field_1_19; // 0x90
	::System::Boolean _IsSilence_k__BackingField; // 0x94
	::System::Boolean Field_1_32; // 0x95
	::System::Boolean Field_1_22; // 0x96
	::System::Boolean Field_1_37; // 0x97
	...
	::RPG::GameCore::ControlSkillType Method_1_E732817546C4B7A0()
	{
		return ((::RPG::GameCore::ControlSkillType(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_152140BAFD2DB102_METHOD_1_E732817546C4B7A0_OFFSET))(this);
	}
