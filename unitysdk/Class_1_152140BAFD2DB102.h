...
#define CLASS_1_152140BAFD2DB102_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1187B2C0)
#define CLASS_1_152140BAFD2DB102_GET_DYNAMICSTRINGS_OFFSET UNITYSDK_OFFSET(0x1187B6F0)
#define CLASS_1_152140BAFD2DB102_GET_DYNAMICVALUES_OFFSET UNITYSDK_OFFSET(0x1187B6D0)
#define CLASS_1_152140BAFD2DB102_GET_ISDISPOSED_OFFSET UNITYSDK_OFFSET(0x1187B2A0)
#define CLASS_1_152140BAFD2DB102_GET_ISSILENCE_OFFSET UNITYSDK_OFFSET(0x1187C340)
#define CLASS_1_152140BAFD2DB102_GET_OVERRIDEELATIONPOINT_OFFSET UNITYSDK_OFFSET(0x1187C4B0)
#define CLASS_1_152140BAFD2DB102_GET_UICONFIG_OFFSET UNITYSDK_OFFSET(0x1187C360)
#define CLASS_1_152140BAFD2DB102_METHOD_1_0497C5D3794AC6EB_1_OFFSET UNITYSDK_OFFSET(0x1187B850)
#define CLASS_1_152140BAFD2DB102_METHOD_1_0497C5D3794AC6EB_OFFSET UNITYSDK_OFFSET(0x1187B790)
#define CLASS_1_152140BAFD2DB102_METHOD_1_0A0A8830B02C5A4B_OFFSET UNITYSDK_OFFSET(0x1187C7E0)
#define CLASS_1_152140BAFD2DB102_METHOD_1_0B351C9F98172C23_OFFSET UNITYSDK_OFFSET(0x1187C5E0)
#define CLASS_1_152140BAFD2DB102_METHOD_1_0BA114B592B3A582_OFFSET UNITYSDK_OFFSET(0x1187C710)
#define CLASS_1_152140BAFD2DB102_METHOD_1_0D2950F07429B2A3_OFFSET UNITYSDK_OFFSET(0x1187B5D0)
#define CLASS_1_152140BAFD2DB102_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x1187B710)
#define CLASS_1_152140BAFD2DB102_METHOD_1_1D4018D4200358D0_1_OFFSET UNITYSDK_OFFSET(0x1187C380)
#define CLASS_1_152140BAFD2DB102_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x1187B7E0)
#define CLASS_1_152140BAFD2DB102_METHOD_1_316F73D239B25567_OFFSET UNITYSDK_OFFSET(0x1187B470)
#define CLASS_1_152140BAFD2DB102_METHOD_1_34632499FE9F94E2_OFFSET UNITYSDK_OFFSET(0x1187C180)
#define CLASS_1_152140BAFD2DB102_METHOD_1_3A06A9FC6DD7BA4B_OFFSET UNITYSDK_OFFSET(0x1187BCD0)
#define CLASS_1_152140BAFD2DB102_METHOD_1_4DA6D4A624E42CAB_OFFSET UNITYSDK_OFFSET(0x1187C3F0)
#define CLASS_1_152140BAFD2DB102_METHOD_1_592B8E80B912F0A9_OFFSET UNITYSDK_OFFSET(0x1187B8B0)
#define CLASS_1_152140BAFD2DB102_METHOD_1_76BAE81A02260DCB_OFFSET UNITYSDK_OFFSET(0x1187B780)
#define CLASS_1_152140BAFD2DB102_METHOD_1_84050C834DAE965F_OFFSET UNITYSDK_OFFSET(0x1187B0B0)
#define CLASS_1_152140BAFD2DB102_METHOD_1_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x1187B050)
#define CLASS_1_152140BAFD2DB102_METHOD_1_9DABF00CB3BADACE_OFFSET UNITYSDK_OFFSET(0x1187BF90)
#define CLASS_1_152140BAFD2DB102_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x1187C0D0)
#define CLASS_1_152140BAFD2DB102_METHOD_1_B504A25E7D6681AA_OFFSET UNITYSDK_OFFSET(0x1187B530)
#define CLASS_1_152140BAFD2DB102_METHOD_1_C5B80D23AF6CFA39_OFFSET UNITYSDK_OFFSET(0x1187BA10)
#define CLASS_1_152140BAFD2DB102_METHOD_1_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0x1187C000)
#define CLASS_1_152140BAFD2DB102_SET_DYNAMICSTRINGS_OFFSET UNITYSDK_OFFSET(0x1187B700)
#define CLASS_1_152140BAFD2DB102_SET_DYNAMICVALUES_OFFSET UNITYSDK_OFFSET(0x1187B6E0)
#define CLASS_1_152140BAFD2DB102_SET_ISDISPOSED_OFFSET UNITYSDK_OFFSET(0x1187B2B0)
#define CLASS_1_152140BAFD2DB102_SET_ISSILENCE_OFFSET UNITYSDK_OFFSET(0x1187C350)
#define CLASS_1_152140BAFD2DB102_SET_OVERRIDEELATIONPOINT_OFFSET UNITYSDK_OFFSET(0x1187C4C0)
#define CLASS_1_152140BAFD2DB102_SET_UICONFIG_OFFSET UNITYSDK_OFFSET(0x1187C370)
#define CLASS_1_152140BAFD2DB102__CTOR_OFFSET UNITYSDK_OFFSET(0x1187C4D0)
...
public:
	...
	::RPG::GameCore::TurnInsertActionUIConfig* _UIConfig_k__BackingField; // 0x20
	::RPG::GameCore::SkillData* Field_1_21; // 0x28
	...
	::Class_3_5775A4FEC79026BC* Field_1_12; // 0x50
	::RPG::GameCore::GameEntity* Field_1_11; // 0x58
	::Il2CppArray<::RPG::GameCore::ModifierBehaviorFlag>* Field_1_31; // 0x60
	::System::String* Field_1_37; // 0x68
	::System::String* Field_1_1; // 0x70
	::System::Boolean Field_1_26; // 0x78
	::System::Int32 Field_1_18; // 0x7C
	::RPG::GameCore::InsertActionType Field_1_0; // 0x80
	::System::Boolean Field_1_28; // 0x84
	::System::Boolean _IsDisposed_k__BackingField; // 0x85
	::System::Boolean Field_1_38; // 0x86
	::System::Boolean Field_1_16; // 0x87
	::System::Boolean Field_1_34; // 0x88
	::System::Boolean Field_1_6; // 0x89
	::System::Boolean Field_1_32; // 0x8A
	::System::Boolean Field_1_13; // 0x8B
	::RPG::GameCore::ControlSkillType Field_1_27; // 0x8C
	::RPG::GameCore::TurnState Field_1_15; // 0x90
	::RPG::GameCore::ControlSkillType Field_1_19; // 0x94
	::RPG::GameCore::FixPoint _OverrideElationPoint_k__BackingField; // 0x98
	::System::Boolean Field_1_22; // 0xA0
	::System::Boolean Field_1_33; // 0xA1
	::System::Boolean Field_1_35; // 0xA2
	::System::Boolean _IsSilence_k__BackingField; // 0xA3
	::System::Int32 Field_1_25; // 0xA4
	::System::Boolean Field_1_5; // 0xA8
	::System::Boolean Field_1_10; // 0xA9
	::System::Boolean Field_1_2; // 0xAA
	::System::Boolean Field_1_3; // 0xAB
