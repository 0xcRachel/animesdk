...
#define CLASS_1_152140BAFD2DB102_DISPOSE_OFFSET UNITYSDK_OFFSET(0x12434E60)
#define CLASS_1_152140BAFD2DB102_GET_DYNAMICSTRINGS_OFFSET UNITYSDK_OFFSET(0x12435410)
#define CLASS_1_152140BAFD2DB102_GET_DYNAMICVALUES_OFFSET UNITYSDK_OFFSET(0x124353F0)
#define CLASS_1_152140BAFD2DB102_GET_ISDISPOSED_OFFSET UNITYSDK_OFFSET(0x12434E40)
#define CLASS_1_152140BAFD2DB102_GET_ISSILENCE_OFFSET UNITYSDK_OFFSET(0x124360F0)
#define CLASS_1_152140BAFD2DB102_GET_OVERRIDEELATIONPOINT_OFFSET UNITYSDK_OFFSET(0x12436250)
#define CLASS_1_152140BAFD2DB102_GET_UICONFIG_OFFSET UNITYSDK_OFFSET(0x12436110)
#define CLASS_1_152140BAFD2DB102_METHOD_1_0497C5D3794AC6EB_1_OFFSET UNITYSDK_OFFSET(0x12435590)
#define CLASS_1_152140BAFD2DB102_METHOD_1_0497C5D3794AC6EB_OFFSET UNITYSDK_OFFSET(0x124354B0)
#define CLASS_1_152140BAFD2DB102_METHOD_1_0B351C9F98172C23_OFFSET UNITYSDK_OFFSET(0x124363A0)
#define CLASS_1_152140BAFD2DB102_METHOD_1_0D2950F07429B2A3_OFFSET UNITYSDK_OFFSET(0x12435290)
#define CLASS_1_152140BAFD2DB102_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x12435430)
#define CLASS_1_152140BAFD2DB102_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x12436130)
#define CLASS_1_152140BAFD2DB102_METHOD_1_2439B52C953E2E46_OFFSET UNITYSDK_OFFSET(0x124365C0)
#define CLASS_1_152140BAFD2DB102_METHOD_1_316F73D239B25567_OFFSET UNITYSDK_OFFSET(0x12435040)
#define CLASS_1_152140BAFD2DB102_METHOD_1_34632499FE9F94E2_OFFSET UNITYSDK_OFFSET(0x12435F40)
#define CLASS_1_152140BAFD2DB102_METHOD_1_3A06A9FC6DD7BA4B_OFFSET UNITYSDK_OFFSET(0x12435A90)
#define CLASS_1_152140BAFD2DB102_METHOD_1_4DA6D4A624E42CAB_OFFSET UNITYSDK_OFFSET(0x124361A0)
#define CLASS_1_152140BAFD2DB102_METHOD_1_4F9DCB69482DE0FD_OFFSET UNITYSDK_OFFSET(0x124351F0)
#define CLASS_1_152140BAFD2DB102_METHOD_1_592B8E80B912F0A9_OFFSET UNITYSDK_OFFSET(0x124355F0)
#define CLASS_1_152140BAFD2DB102_METHOD_1_76BAE81A02260DCB_OFFSET UNITYSDK_OFFSET(0x124354A0)
#define CLASS_1_152140BAFD2DB102_METHOD_1_84050C834DAE965F_OFFSET UNITYSDK_OFFSET(0x12434C40)
#define CLASS_1_152140BAFD2DB102_METHOD_1_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x12434BE0)
#define CLASS_1_152140BAFD2DB102_METHOD_1_9DABF00CB3BADACE_OFFSET UNITYSDK_OFFSET(0x12435D50)
#define CLASS_1_152140BAFD2DB102_METHOD_1_A4E49334588ED241_OFFSET UNITYSDK_OFFSET(0x12435760)
#define CLASS_1_152140BAFD2DB102_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x12435E90)
#define CLASS_1_152140BAFD2DB102_METHOD_1_C5B80D23AF6CFA39_OFFSET UNITYSDK_OFFSET(0x124357D0)
#define CLASS_1_152140BAFD2DB102_METHOD_1_D2809205008ACF99_OFFSET UNITYSDK_OFFSET(0x12435500)
#define CLASS_1_152140BAFD2DB102_METHOD_1_E3A107F868234598_OFFSET UNITYSDK_OFFSET(0x124350F0)
#define CLASS_1_152140BAFD2DB102_METHOD_1_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0x12435DC0)
#define CLASS_1_152140BAFD2DB102_METHOD_1_FA0119DD445A672F_OFFSET UNITYSDK_OFFSET(0x124364D0)
#define CLASS_1_152140BAFD2DB102_SET_DYNAMICSTRINGS_OFFSET UNITYSDK_OFFSET(0x12435420)
#define CLASS_1_152140BAFD2DB102_SET_DYNAMICVALUES_OFFSET UNITYSDK_OFFSET(0x12435400)
#define CLASS_1_152140BAFD2DB102_SET_ISDISPOSED_OFFSET UNITYSDK_OFFSET(0x12434E50)
#define CLASS_1_152140BAFD2DB102_SET_ISSILENCE_OFFSET UNITYSDK_OFFSET(0x12436100)
#define CLASS_1_152140BAFD2DB102_SET_OVERRIDEELATIONPOINT_OFFSET UNITYSDK_OFFSET(0x12436260)
#define CLASS_1_152140BAFD2DB102_SET_UICONFIG_OFFSET UNITYSDK_OFFSET(0x12436120)
#define CLASS_1_152140BAFD2DB102__CTOR_OFFSET UNITYSDK_OFFSET(0x12436270)
...
{
public:
	::System::String* Field_1_40; // 0x10
	::Class_3_E21F6DE9B7FA4D05* Field_1_12; // 0x18
	...
	::RPG::GameCore::GameEntity* Field_1_18; // 0x38
	::RPG::GameCore::SkillData* Field_1_24; // 0x40
	::RPG::PoolList_1<::RPG::GameCore::AbilityDynamicFloatInjection>* _DynamicValues_k__BackingField; // 0x48
	::RPG::GameCore::JsonEnum* Field_1_22; // 0x50
	...
	::System::String* Field_1_4; // 0x78
	::RPG::GameCore::TurnInsertActionUIConfig* _UIConfig_k__BackingField; // 0x80
	::RPG::GameCore::FixPoint _OverrideElationPoint_k__BackingField; // 0x88
	::RPG::GameCore::ControlSkillType Field_1_20; // 0x90
	::System::Int32 Field_1_19; // 0x94
	::System::Int32 Field_1_42; // 0x98
	::System::Boolean Field_1_37; // 0x9C
	::System::Boolean Field_1_6; // 0x9D
	::System::Boolean _IsDisposed_k__BackingField; // 0x9E
	::System::Boolean Field_1_3; // 0x9F
	::RPG::GameCore::InsertActionType Field_1_0; // 0xA0
	::System::Boolean Field_1_35; // 0xA4
	::System::Boolean _IsSilence_k__BackingField; // 0xA5
	::System::Boolean Field_1_2; // 0xA6
	::System::Boolean Field_1_14; // 0xA7
	::System::Boolean Field_1_38; // 0xA8
	::System::Int32 Field_1_9; // 0xAC
	::RPG::GameCore::TurnState Field_1_16; // 0xB0
	::System::Boolean Field_1_5; // 0xB4
	::System::Boolean Field_1_17; // 0xB5
	::System::Boolean Field_1_29; // 0xB6
	::System::Boolean Field_1_36; // 0xB7
	::System::Boolean Field_1_41; // 0xB8
	::System::Boolean Field_1_10; // 0xB9
	::System::Boolean Field_1_31; // 0xBA
	::System::Boolean Field_1_25; // 0xBB
	::RPG::GameCore::ControlSkillType Field_1_30; // 0xBC
	::System::Int32 Field_1_21; // 0xC0
	::Class_1_152140BAFD2DB102_GetSkillByTagType Field_1_23; // 0xC4
