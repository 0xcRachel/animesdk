...
#define CLASS_2_A326BDFCE24CAF6D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1102BA80)
#define CLASS_2_A326BDFCE24CAF6D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1102BB10)
#define CLASS_2_A326BDFCE24CAF6D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1102BAC0)
#define CLASS_2_A326BDFCE24CAF6D_TICK_OFFSET UNITYSDK_OFFSET(0x1102BD20)
#define CLASS_2_A326BDFCE24CAF6D__CTOR_OFFSET UNITYSDK_OFFSET(0x1102BA70)

inline static constexpr unsigned int Class_2_A326BDFCE24CAF6D_TypeDefinitionIndex = 43552;
