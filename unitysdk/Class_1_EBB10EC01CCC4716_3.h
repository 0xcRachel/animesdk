...
#define CLASS_1_EBB10EC01CCC4716_3_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A1D2000)
#define CLASS_1_EBB10EC01CCC4716_3_CLONE_OFFSET UNITYSDK_OFFSET(0x1A1D1910)
#define CLASS_1_EBB10EC01CCC4716_3_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A1D1AA0)
#define CLASS_1_EBB10EC01CCC4716_3_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A1D1A70)
#define CLASS_1_EBB10EC01CCC4716_3_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A1D1C40)
#define CLASS_1_EBB10EC01CCC4716_3_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A1D23C0)
#define CLASS_1_EBB10EC01CCC4716_3_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A1D2320)
#define CLASS_1_EBB10EC01CCC4716_3_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1A1D19D0)
#define CLASS_1_EBB10EC01CCC4716_3_METHOD_1_02A3D10A9D535169_2_OFFSET UNITYSDK_OFFSET(0x1A1D19F0)
#define CLASS_1_EBB10EC01CCC4716_3_METHOD_1_02A3D10A9D535169_3_OFFSET UNITYSDK_OFFSET(0x1A1D1A10)
#define CLASS_1_EBB10EC01CCC4716_3_METHOD_1_02A3D10A9D535169_4_OFFSET UNITYSDK_OFFSET(0x1A1D1A30)
#define CLASS_1_EBB10EC01CCC4716_3_METHOD_1_02A3D10A9D535169_5_OFFSET UNITYSDK_OFFSET(0x1A1D1A50)
#define CLASS_1_EBB10EC01CCC4716_3_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1A1D1970)
#define CLASS_1_EBB10EC01CCC4716_3_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A1D1880)
#define CLASS_1_EBB10EC01CCC4716_3_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1A1D19E0)
#define CLASS_1_EBB10EC01CCC4716_3_METHOD_1_7786DC814C2FC3BE_2_OFFSET UNITYSDK_OFFSET(0x1A1D1A00)
#define CLASS_1_EBB10EC01CCC4716_3_METHOD_1_7786DC814C2FC3BE_3_OFFSET UNITYSDK_OFFSET(0x1A1D1A20)
#define CLASS_1_EBB10EC01CCC4716_3_METHOD_1_7786DC814C2FC3BE_4_OFFSET UNITYSDK_OFFSET(0x1A1D1A40)
#define CLASS_1_EBB10EC01CCC4716_3_METHOD_1_7786DC814C2FC3BE_5_OFFSET UNITYSDK_OFFSET(0x1A1D1A60)
#define CLASS_1_EBB10EC01CCC4716_3_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1A1D1980)
#define CLASS_1_EBB10EC01CCC4716_3_METHOD_1_8633AE51B23EBDFD_1_OFFSET UNITYSDK_OFFSET(0x1A1D19C0)
#define CLASS_1_EBB10EC01CCC4716_3_METHOD_1_8633AE51B23EBDFD_OFFSET UNITYSDK_OFFSET(0x1A1D19A0)
#define CLASS_1_EBB10EC01CCC4716_3_METHOD_1_C229FF62B898C0B2_1_OFFSET UNITYSDK_OFFSET(0x1A1D19B0)
#define CLASS_1_EBB10EC01CCC4716_3_METHOD_1_C229FF62B898C0B2_OFFSET UNITYSDK_OFFSET(0x1A1D1990)
#define CLASS_1_EBB10EC01CCC4716_3_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A1D18B0)
#define CLASS_1_EBB10EC01CCC4716_3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A1D1DA0)
#define CLASS_1_EBB10EC01CCC4716_3_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A1D1E00)
#define CLASS_1_EBB10EC01CCC4716_3__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1D24E0)
#define CLASS_1_EBB10EC01CCC4716_3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A1D18D0)
#define CLASS_1_EBB10EC01CCC4716_3__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1D18C0)

inline static constexpr unsigned int Class_1_EBB10EC01CCC4716_3_TypeDefinitionIndex = 24281;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_EBB10EC01CCC4716_3*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_EBB10EC01CCC4716_3_TypeDefinitionIndex)->GetStaticField(0x14090);
	}
	...
	::System::UInt32 Field_1_17; // 0x18
	::System::UInt32 Field_1_15; // 0x1C
