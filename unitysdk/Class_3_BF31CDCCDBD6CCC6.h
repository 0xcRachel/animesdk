...
#define CLASS_3_BF31CDCCDBD6CCC6_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x14822C50)
#define CLASS_3_BF31CDCCDBD6CCC6_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x148234F0)
#define CLASS_3_BF31CDCCDBD6CCC6_TICK_OFFSET UNITYSDK_OFFSET(0x148233B0)
#define CLASS_3_BF31CDCCDBD6CCC6__CTOR_OFFSET UNITYSDK_OFFSET(0x14822C30)
#define CLASS_3_BF31CDCCDBD6CCC6___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x14823540)
...
{
public:
	::Class_2_FBC1E64DC5B2C441* Field_3_4; // 0x28
	::Class_2_3ABA989E5AECB261* Field_3_3; // 0x30
