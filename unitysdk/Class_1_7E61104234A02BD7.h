...
#define CLASS_1_7E61104234A02BD7__CTOR_OFFSET UNITYSDK_OFFSET(0x113F2F00)
...
public:
	...
	::RPG::GameCore::TaskContext* Field_1_6; // 0x28
	::RPG::GameCore::BattleQTEBaseConfig* Field_1_0; // 0x30
	::Class_3_5775A4FEC79026BC* Field_1_5; // 0x38
