...
#define XINPUTDOTNETPURE_GAMEPADDPAD_GET_DOWN_OFFSET UNITYSDK_OFFSET(0x1DAE0)
#define XINPUTDOTNETPURE_GAMEPADDPAD_GET_LEFT_OFFSET UNITYSDK_OFFSET(0xD240)
#define XINPUTDOTNETPURE_GAMEPADDPAD_GET_RIGHT_OFFSET UNITYSDK_OFFSET(0xCAE40)
#define XINPUTDOTNETPURE_GAMEPADDPAD_GET_UP_OFFSET UNITYSDK_OFFSET(0x59D0)
#define XINPUTDOTNETPURE_GAMEPADDPAD__CTOR_OFFSET UNITYSDK_OFFSET(0x13ED2F0)

namespace XInputDotNetPure
{
	inline static constexpr unsigned int GamePadDPad_TypeDefinitionIndex = 30491;
