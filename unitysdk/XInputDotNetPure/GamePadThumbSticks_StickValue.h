...
#define XINPUTDOTNETPURE_GAMEPADTHUMBSTICKS_STICKVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x29910)

namespace XInputDotNetPure
{
	inline static constexpr unsigned int GamePadThumbSticks_StickValue_TypeDefinitionIndex = 30493;
