...
#define XINPUTDOTNETPURE_GAMEPADTHUMBSTICKS_GET_LEFT_OFFSET UNITYSDK_OFFSET(0x5078B0)
#define XINPUTDOTNETPURE_GAMEPADTHUMBSTICKS_GET_RIGHT_OFFSET UNITYSDK_OFFSET(0x608BA0)
#define XINPUTDOTNETPURE_GAMEPADTHUMBSTICKS__CTOR_OFFSET UNITYSDK_OFFSET(0x608B90)
