...
#define CLASS_1_A2967FAA88DD8F73_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x193F5100)
#define CLASS_1_A2967FAA88DD8F73_CLONE_OFFSET UNITYSDK_OFFSET(0x193F4BA0)
#define CLASS_1_A2967FAA88DD8F73_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x193F4D70)
#define CLASS_1_A2967FAA88DD8F73_EQUALS_OFFSET UNITYSDK_OFFSET(0x193F4C80)
#define CLASS_1_A2967FAA88DD8F73_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x193F4E20)
#define CLASS_1_A2967FAA88DD8F73_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x193F5440)
#define CLASS_1_A2967FAA88DD8F73_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x193F53D0)
#define CLASS_1_A2967FAA88DD8F73_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x193F4C10)
#define CLASS_1_A2967FAA88DD8F73_METHOD_1_02A3D10A9D535169_2_OFFSET UNITYSDK_OFFSET(0x193F4C60)
#define CLASS_1_A2967FAA88DD8F73_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x193F4BF0)
#define CLASS_1_A2967FAA88DD8F73_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x193F4A40)
#define CLASS_1_A2967FAA88DD8F73_METHOD_1_4C4B9DFE092840D4_OFFSET UNITYSDK_OFFSET(0x193F4C50)
#define CLASS_1_A2967FAA88DD8F73_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x193F4C30)
#define CLASS_1_A2967FAA88DD8F73_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x193F4C20)
#define CLASS_1_A2967FAA88DD8F73_METHOD_1_7786DC814C2FC3BE_2_OFFSET UNITYSDK_OFFSET(0x193F4C70)
#define CLASS_1_A2967FAA88DD8F73_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x193F4C00)
#define CLASS_1_A2967FAA88DD8F73_METHOD_1_7ADD5F1F5E247E3B_OFFSET UNITYSDK_OFFSET(0x193F4C40)
#define CLASS_1_A2967FAA88DD8F73_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x193F4AA0)
#define CLASS_1_A2967FAA88DD8F73_TOSTRING_OFFSET UNITYSDK_OFFSET(0x193F4F50)
#define CLASS_1_A2967FAA88DD8F73_WRITETO_OFFSET UNITYSDK_OFFSET(0x193F4FB0)
#define CLASS_1_A2967FAA88DD8F73__CCTOR_OFFSET UNITYSDK_OFFSET(0x193F5570)
#define CLASS_1_A2967FAA88DD8F73__CTOR_1_OFFSET UNITYSDK_OFFSET(0x193F4B00)
#define CLASS_1_A2967FAA88DD8F73__CTOR_OFFSET UNITYSDK_OFFSET(0x193F4AB0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_A2967FAA88DD8F73*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A2967FAA88DD8F73_TypeDefinitionIndex)->GetStaticField(0x1FBB0);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_7()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A2967FAA88DD8F73_TypeDefinitionIndex)->GetStaticField(0x1FBB8);
	}
