...
#define CARFLOWROAD_ADDCAR_OFFSET UNITYSDK_OFFSET(0x9952B20)
#define CARFLOWROAD_GETCARLIMIT_OFFSET UNITYSDK_OFFSET(0x9952BB0)
#define CARFLOWROAD_GET_CARS_OFFSET UNITYSDK_OFFSET(0x9953200)
#define CARFLOWROAD_GET_CURVE_OFFSET UNITYSDK_OFFSET(0x9953220)
#define CARFLOWROAD_GET_MATH_OFFSET UNITYSDK_OFFSET(0x99531E0)
#define CARFLOWROAD_INIT_OFFSET UNITYSDK_OFFSET(0x994FF10)
#define CARFLOWROAD_REMOVECAR_OFFSET UNITYSDK_OFFSET(0x9952A90)
#define CARFLOWROAD_SET_CARS_OFFSET UNITYSDK_OFFSET(0x9953210)
#define CARFLOWROAD_SET_CURVE_OFFSET UNITYSDK_OFFSET(0x9953230)
#define CARFLOWROAD_SET_MATH_OFFSET UNITYSDK_OFFSET(0x99531F0)
#define CARFLOWROAD__CTOR_OFFSET UNITYSDK_OFFSET(0x9953240)

inline static constexpr unsigned int CarFlowRoad_TypeDefinitionIndex = 37045;
