...
#define CARFLOWROAD_ADDCAR_OFFSET UNITYSDK_OFFSET(0xA6E5140)
#define CARFLOWROAD_GETCARLIMIT_OFFSET UNITYSDK_OFFSET(0xA6E51D0)
#define CARFLOWROAD_GET_CARS_OFFSET UNITYSDK_OFFSET(0xA6E5810)
#define CARFLOWROAD_GET_CURVE_OFFSET UNITYSDK_OFFSET(0xA6E5830)
#define CARFLOWROAD_GET_MATH_OFFSET UNITYSDK_OFFSET(0xA6E57F0)
#define CARFLOWROAD_INIT_OFFSET UNITYSDK_OFFSET(0xA6E2530)
#define CARFLOWROAD_REMOVECAR_OFFSET UNITYSDK_OFFSET(0xA6E50B0)
#define CARFLOWROAD_SET_CARS_OFFSET UNITYSDK_OFFSET(0xA6E5820)
#define CARFLOWROAD_SET_CURVE_OFFSET UNITYSDK_OFFSET(0xA6E5840)
#define CARFLOWROAD_SET_MATH_OFFSET UNITYSDK_OFFSET(0xA6E5800)
#define CARFLOWROAD__CTOR_OFFSET UNITYSDK_OFFSET(0xA6E5850)
