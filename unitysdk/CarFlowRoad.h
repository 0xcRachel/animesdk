...
#define CARFLOWROAD_ADDCAR_OFFSET UNITYSDK_OFFSET(0x14E41050)
#define CARFLOWROAD_GETCARLIMIT_OFFSET UNITYSDK_OFFSET(0x14E41130)
#define CARFLOWROAD_GET_CARS_OFFSET UNITYSDK_OFFSET(0x14E41750)
#define CARFLOWROAD_GET_CURVE_OFFSET UNITYSDK_OFFSET(0x14E41770)
#define CARFLOWROAD_GET_MATH_OFFSET UNITYSDK_OFFSET(0x14E41730)
#define CARFLOWROAD_INIT_OFFSET UNITYSDK_OFFSET(0x14E3E550)
#define CARFLOWROAD_REMOVECAR_OFFSET UNITYSDK_OFFSET(0x14E40FC0)
#define CARFLOWROAD_SET_CARS_OFFSET UNITYSDK_OFFSET(0x14E41760)
#define CARFLOWROAD_SET_CURVE_OFFSET UNITYSDK_OFFSET(0x14E41780)
#define CARFLOWROAD_SET_MATH_OFFSET UNITYSDK_OFFSET(0x14E41740)
#define CARFLOWROAD__CTOR_OFFSET UNITYSDK_OFFSET(0x14E41790)
