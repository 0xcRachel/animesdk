...
#define CARFLOWROAD_ADDCAR_OFFSET UNITYSDK_OFFSET(0xECE9950)
#define CARFLOWROAD_GETCARLIMIT_OFFSET UNITYSDK_OFFSET(0xECE99E0)
#define CARFLOWROAD_GET_CARS_OFFSET UNITYSDK_OFFSET(0xECEA020)
#define CARFLOWROAD_GET_CURVE_OFFSET UNITYSDK_OFFSET(0xECEA040)
#define CARFLOWROAD_GET_MATH_OFFSET UNITYSDK_OFFSET(0xECEA000)
#define CARFLOWROAD_INIT_OFFSET UNITYSDK_OFFSET(0xECE6D30)
#define CARFLOWROAD_REMOVECAR_OFFSET UNITYSDK_OFFSET(0xECE98C0)
#define CARFLOWROAD_SET_CARS_OFFSET UNITYSDK_OFFSET(0xECEA030)
#define CARFLOWROAD_SET_CURVE_OFFSET UNITYSDK_OFFSET(0xECEA050)
#define CARFLOWROAD_SET_MATH_OFFSET UNITYSDK_OFFSET(0xECEA010)
#define CARFLOWROAD__CTOR_OFFSET UNITYSDK_OFFSET(0xECEA060)
