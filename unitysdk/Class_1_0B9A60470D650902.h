...
#define CLASS_1_0B9A60470D650902_CLEAR_OFFSET UNITYSDK_OFFSET(0xEF00230)
#define CLASS_1_0B9A60470D650902_GETUNEVALUATEDNEXTSTATE_OFFSET UNITYSDK_OFFSET(0xEF00720)
#define CLASS_1_0B9A60470D650902_GETUNITYANIMATOR_OFFSET UNITYSDK_OFFSET(0xEF007B0)
#define CLASS_1_0B9A60470D650902_GET_ANIMATORMOVECALLBACKORDER_OFFSET UNITYSDK_OFFSET(0xEF007F0)
#define CLASS_1_0B9A60470D650902_GET_ANIMATORNOTINIT_OFFSET UNITYSDK_OFFSET(0xEF00690)
#define CLASS_1_0B9A60470D650902_GET_DYNAMICANIMEVENTDATALIST_OFFSET UNITYSDK_OFFSET(0xEF006F0)
#define CLASS_1_0B9A60470D650902_GET_ENABLEANIMATORMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xEF00800)
#define CLASS_1_0B9A60470D650902_GET_NEEDRESETEVENT_OFFSET UNITYSDK_OFFSET(0xEF006B0)
#define CLASS_1_0B9A60470D650902_GET_ONANIMATIONSTATECHANGE_OFFSET UNITYSDK_OFFSET(0xEF006D0)
#define CLASS_1_0B9A60470D650902_GET_ONANIMATORMOVECALLBACKMAP_OFFSET UNITYSDK_OFFSET(0xEF00710)
#define CLASS_1_0B9A60470D650902_GET_REENTRYCOUNTER_OFFSET UNITYSDK_OFFSET(0xEF00670)
#define CLASS_1_0B9A60470D650902_GET_TASKCONTEXT_OFFSET UNITYSDK_OFFSET(0xEF005E0)
#define CLASS_1_0B9A60470D650902_GET_WORLDREF_OFFSET UNITYSDK_OFFSET(0xEF005B0)
#define CLASS_1_0B9A60470D650902_METHOD_1_1D148E040584EEBC_OFFSET UNITYSDK_OFFSET(0xEF00110)
#define CLASS_1_0B9A60470D650902_METHOD_1_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0xEF00510)
#define CLASS_1_0B9A60470D650902_METHOD_1_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0xEF00600)
#define CLASS_1_0B9A60470D650902_METHOD_1_892D0C7F01734DAA_OFFSET UNITYSDK_OFFSET(0xEF00030)
#define CLASS_1_0B9A60470D650902_METHOD_1_B1445E8504415D4D_OFFSET UNITYSDK_OFFSET(0xEF005D0)
#define CLASS_1_0B9A60470D650902_METHOD_1_F7A1793118115C9E_OFFSET UNITYSDK_OFFSET(0xEEFFE70)
#define CLASS_1_0B9A60470D650902_METHOD_1_FAC3436B3B22B430_OFFSET UNITYSDK_OFFSET(0xEF00440)
#define CLASS_1_0B9A60470D650902_ONANIMATORMOVE_OFFSET UNITYSDK_OFFSET(0xEF00810)
#define CLASS_1_0B9A60470D650902_QUERYSTATENORAMLIZEDSTARTTIME_OFFSET UNITYSDK_OFFSET(0xEF00760)
#define CLASS_1_0B9A60470D650902_SET_ANIMATORNOTINIT_OFFSET UNITYSDK_OFFSET(0xEF006A0)
#define CLASS_1_0B9A60470D650902_SET_DYNAMICANIMEVENTDATALIST_OFFSET UNITYSDK_OFFSET(0xEF00700)
#define CLASS_1_0B9A60470D650902_SET_NEEDRESETEVENT_OFFSET UNITYSDK_OFFSET(0xEF006C0)
#define CLASS_1_0B9A60470D650902_SET_ONANIMATIONSTATECHANGE_OFFSET UNITYSDK_OFFSET(0xEF006E0)
#define CLASS_1_0B9A60470D650902_SET_REENTRYCOUNTER_OFFSET UNITYSDK_OFFSET(0xEF00680)
#define CLASS_1_0B9A60470D650902_SET_TASKCONTEXT_OFFSET UNITYSDK_OFFSET(0xEF005F0)
#define CLASS_1_0B9A60470D650902_SET_WORLDREF_OFFSET UNITYSDK_OFFSET(0xEF005C0)
#define CLASS_1_0B9A60470D650902__CCTOR_OFFSET UNITYSDK_OFFSET(0xEF00BD0)
#define CLASS_1_0B9A60470D650902__CTOR_OFFSET UNITYSDK_OFFSET(0xEF00AD0)

inline static constexpr unsigned int Class_1_0B9A60470D650902_TypeDefinitionIndex = 70989;
...
public:
	...
	{
		return (::Unity::Profiling::ProfilerMarkerWithObject*)Il2CppClass::FromTypeDefinitionIndex(Class_1_0B9A60470D650902_TypeDefinitionIndex)->GetStaticField(0x2040);
	}
	::Il2CppArray<::System::String*>* Field_1_10; // 0x10
	::RPG::GameCore::TaskContext* _TaskContext_k__BackingField; // 0x18
	::Il2CppArray<::System::String*>* Field_1_11; // 0x20
	::RPG::GameCore::GameWorld* _WorldRef_k__BackingField; // 0x28
	::System::Collections::Generic::Dictionary_2<::System::String*, ::Class_0_16E4307DCC419505_386_Class_3_410EEB4A0F592FBB*>* _OnAnimatorMoveCallbackMap_k__BackingField; // 0x30
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_0_16E4307DCC419505_97*>* Field_1_15; // 0x38
	::Entitas::IEntity* Field_1_8; // 0x40
	::Class_0_16E4307DCC419505_386_Class_3_363670394F299996* _OnAnimationStateChange_k__BackingField; // 0x48
	::Class_1_FD7BA687A1A99180* Field_1_14; // 0x50
	::Struct_2_2B16FFFF87B43037 Field_1_13; // 0x58
	::UnityEngine::Animator* Field_1_12; // 0x68
	::System::Collections::Generic::List_1<::Class_1_38A5D85D4AE9F24D*>* _DynamicAnimEventDataList_k__BackingField; // 0x70
	::RPG::GameCore::GameEntity* Field_1_9; // 0x78
