...
#define STATEMOVEUP_METHOD_4_D00EFFFA316CD3C0_OFFSET UNITYSDK_OFFSET(0x14F967D0)
#define STATEMOVEUP_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x14F96390)
#define STATEMOVEUP_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x14F96440)
#define STATEMOVEUP__CTOR_OFFSET UNITYSDK_OFFSET(0x14F968A0)
#define STATEMOVEUP___IFIXBASEPROXY_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x14F968B0)
#define STATEMOVEUP___IFIXBASEPROXY_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x14F968C0)
