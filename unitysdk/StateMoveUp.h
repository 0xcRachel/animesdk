...
#define STATEMOVEUP_METHOD_4_D00EFFFA316CD3C0_OFFSET UNITYSDK_OFFSET(0xA6A5630)
#define STATEMOVEUP_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0xA6A51F0)
#define STATEMOVEUP_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA6A52A0)
#define STATEMOVEUP__CTOR_OFFSET UNITYSDK_OFFSET(0xA6A5700)
#define STATEMOVEUP___IFIXBASEPROXY_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0xA6A5710)
#define STATEMOVEUP___IFIXBASEPROXY_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA6A5720)

inline static constexpr unsigned int StateMoveUp_TypeDefinitionIndex = 37218;
