...
#define CLASS_2_C32F908D158C360E_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x88BBB00)
#define CLASS_2_C32F908D158C360E_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x88BBCB0)
#define CLASS_2_C32F908D158C360E_METHOD_2_0865E94460F11643_OFFSET UNITYSDK_OFFSET(0x88B8E70)
#define CLASS_2_C32F908D158C360E_METHOD_2_0DB65CA3858A0FF2_OFFSET UNITYSDK_OFFSET(0x88B94D0)
#define CLASS_2_C32F908D158C360E_METHOD_2_1178B2E4770EA6E3_OFFSET UNITYSDK_OFFSET(0x88B9220)
#define CLASS_2_C32F908D158C360E_METHOD_2_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x88B8750)
#define CLASS_2_C32F908D158C360E_METHOD_2_18A7BF8B592973BC_OFFSET UNITYSDK_OFFSET(0x88BA840)
#define CLASS_2_C32F908D158C360E_METHOD_2_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x88B8AC0)
#define CLASS_2_C32F908D158C360E_METHOD_2_2A908DA4CAE4354A_OFFSET UNITYSDK_OFFSET(0x88BAF10)
#define CLASS_2_C32F908D158C360E_METHOD_2_3B4774276E3D469F_OFFSET UNITYSDK_OFFSET(0x88BB4D0)
#define CLASS_2_C32F908D158C360E_METHOD_2_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x88B8AD0)
#define CLASS_2_C32F908D158C360E_METHOD_2_4EA6B1791DACA9CC_OFFSET UNITYSDK_OFFSET(0x88BA510)
#define CLASS_2_C32F908D158C360E_METHOD_2_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0x88BBF30)
#define CLASS_2_C32F908D158C360E_METHOD_2_5790A55946AA509D_2_OFFSET UNITYSDK_OFFSET(0x88BC000)
#define CLASS_2_C32F908D158C360E_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x88BBED0)
#define CLASS_2_C32F908D158C360E_METHOD_2_5BCE9210F4ACDD0B_OFFSET UNITYSDK_OFFSET(0x88BAA30)
#define CLASS_2_C32F908D158C360E_METHOD_2_676CD2ECA00B10AF_OFFSET UNITYSDK_OFFSET(0x88B9DA0)
#define CLASS_2_C32F908D158C360E_METHOD_2_6FAB972CB6DE2314_OFFSET UNITYSDK_OFFSET(0x88BA6C0)
#define CLASS_2_C32F908D158C360E_METHOD_2_735EE20B25F86BF4_OFFSET UNITYSDK_OFFSET(0x88BA2C0)
#define CLASS_2_C32F908D158C360E_METHOD_2_7DA80ED45513D178_OFFSET UNITYSDK_OFFSET(0x88BB260)
#define CLASS_2_C32F908D158C360E_METHOD_2_8BDE9AA6B337DB42_OFFSET UNITYSDK_OFFSET(0x88B8950)
#define CLASS_2_C32F908D158C360E_METHOD_2_95780ED94B90ED36_1_OFFSET UNITYSDK_OFFSET(0x88BB3B0)
#define CLASS_2_C32F908D158C360E_METHOD_2_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x88BB350)
#define CLASS_2_C32F908D158C360E_METHOD_2_9EB6EE4EAAADCD97_OFFSET UNITYSDK_OFFSET(0x88B8FF0)
#define CLASS_2_C32F908D158C360E_METHOD_2_A27D06F9481FAFDB_1_OFFSET UNITYSDK_OFFSET(0x88BB800)
#define CLASS_2_C32F908D158C360E_METHOD_2_A27D06F9481FAFDB_2_OFFSET UNITYSDK_OFFSET(0x88BB8C0)
#define CLASS_2_C32F908D158C360E_METHOD_2_A27D06F9481FAFDB_3_OFFSET UNITYSDK_OFFSET(0x88BB980)
#define CLASS_2_C32F908D158C360E_METHOD_2_A27D06F9481FAFDB_4_OFFSET UNITYSDK_OFFSET(0x88BBA40)
#define CLASS_2_C32F908D158C360E_METHOD_2_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0x88BB740)
#define CLASS_2_C32F908D158C360E_METHOD_2_ACE888BF6F5BC5FD_OFFSET UNITYSDK_OFFSET(0x88B9F40)
#define CLASS_2_C32F908D158C360E_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x88BA980)
#define CLASS_2_C32F908D158C360E_METHOD_2_B37C805F1A4DBCFB_OFFSET UNITYSDK_OFFSET(0x88B8F50)
#define CLASS_2_C32F908D158C360E_METHOD_2_B3BC933000085B6A_OFFSET UNITYSDK_OFFSET(0x88BAC80)
#define CLASS_2_C32F908D158C360E_METHOD_2_BF59FE15D48422D3_OFFSET UNITYSDK_OFFSET(0x88BB410)
#define CLASS_2_C32F908D158C360E_METHOD_2_C745B220B44025C5_OFFSET UNITYSDK_OFFSET(0x88BB570)
#define CLASS_2_C32F908D158C360E_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x88B8C00)
#define CLASS_2_C32F908D158C360E_METHOD_2_CBDC22058B67F0FE_OFFSET UNITYSDK_OFFSET(0x88B9710)
#define CLASS_2_C32F908D158C360E_METHOD_2_D77F7476BCD66744_OFFSET UNITYSDK_OFFSET(0x88B8860)
#define CLASS_2_C32F908D158C360E_METHOD_2_F206290BA342BA13_OFFSET UNITYSDK_OFFSET(0x88B8CA0)
#define CLASS_2_C32F908D158C360E_METHOD_2_F25D2DE7181D2805_1_OFFSET UNITYSDK_OFFSET(0x88BB1E0)
#define CLASS_2_C32F908D158C360E_METHOD_2_F25D2DE7181D2805_OFFSET UNITYSDK_OFFSET(0x88BAC00)
#define CLASS_2_C32F908D158C360E_METHOD_2_FB3259368AD56B95_OFFSET UNITYSDK_OFFSET(0x88BA390)
#define CLASS_2_C32F908D158C360E__CTOR_OFFSET UNITYSDK_OFFSET(0x88BBE30)
#define CLASS_2_C32F908D158C360E__ONBIND_OFFSET UNITYSDK_OFFSET(0x88B8160)
#define CLASS_2_C32F908D158C360E__ONTICK_OFFSET UNITYSDK_OFFSET(0x88B8C40)
#define CLASS_2_C32F908D158C360E___IFIXBASEPROXY_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x88BC060)
#define CLASS_2_C32F908D158C360E___IFIXBASEPROXY_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x88BC0C0)
#define CLASS_2_C32F908D158C360E___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0x88BBE70)
#define CLASS_2_C32F908D158C360E___IFIXBASEPROXY__ONTICK_OFFSET UNITYSDK_OFFSET(0x88BBF90)

inline static constexpr unsigned int Class_2_C32F908D158C360E_TypeDefinitionIndex = 59222;
...
public:
	...
	::UnityEngine::UI::Image* Field_2_7; // 0x68
	::Class_2_40491F513F4A6F01* Field_2_20; // 0x70
	::UnityEngine::Transform* Field_2_1; // 0x78
	::RPG::GameCore::SkillData* Field_2_24; // 0x80
	::RPG::Client::PrefabLoadMeta* Field_2_14; // 0x88
	::UnityEngine::ParticleSystem* Field_2_9; // 0x90
	::RPG::GameCore::SkillCharacterComponent* Field_2_30; // 0x98
	::RPG::GameCore::GameEntity* Field_2_22; // 0xA0
	::Class_2_1A0F91E4CE01E769* Field_2_4; // 0xA8
	::UnityEngine::UI::Text* Field_2_18; // 0xB0
	::RPG::GameCore::TurnBasedAbilityComponent* Field_2_29; // 0xB8
	::RPG::Client::LongPressEvent* Field_2_19; // 0xC0
	::RPG::Client::SPProgress* Field_2_6; // 0xC8
	::RPG::GameCore::BattleInstance* Field_2_23; // 0xD0
	::UnityEngine::UI::Text* Field_2_17; // 0xD8
	::UnityEngine::Transform* Field_2_15; // 0xE0
	::UnityEngine::Transform* Field_2_3; // 0xE8
	::UnityEngine::Transform* Field_2_10; // 0xF0
	::UnityEngine::Transform* Field_2_12; // 0xF8
	::RPG::GameCore::CharacterDataComponent* Field_2_28; // 0x100
	::UnityEngine::UI::Image* Field_2_11; // 0x108
	::Class_2_D650D0F10A391A4C* Field_2_0; // 0x110
	::UnityEngine::Transform* Field_2_13; // 0x118
	::Class_1_23621931BDBFAF77* Field_2_5; // 0x120
	::Class_2_5109291607DAACB4* Field_2_34; // 0x128
	::UnityEngine::Animation* Field_2_2; // 0x130
	::RPG::GameCore::SkillData* Field_2_25; // 0x138
	::UnityEngine::ParticleSystem* Field_2_8; // 0x140
