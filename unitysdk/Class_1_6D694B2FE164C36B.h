...
#define CLASS_1_6D694B2FE164C36B_METHOD_1_0C7CBCE710B3F112_OFFSET UNITYSDK_OFFSET(0x16510650)
#define CLASS_1_6D694B2FE164C36B_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x16510470)
#define CLASS_1_6D694B2FE164C36B_METHOD_1_6859AF6485DE66FB_OFFSET UNITYSDK_OFFSET(0x1650FD80)
#define CLASS_1_6D694B2FE164C36B_METHOD_1_6B72D4EE8C6E907F_OFFSET UNITYSDK_OFFSET(0x1650FE00)
#define CLASS_1_6D694B2FE164C36B_METHOD_1_7F42BA1068DDE869_OFFSET UNITYSDK_OFFSET(0x165106A0)
#define CLASS_1_6D694B2FE164C36B_METHOD_1_AD31DD9682084C83_OFFSET UNITYSDK_OFFSET(0x16510510)
#define CLASS_1_6D694B2FE164C36B_METHOD_1_B169A3A00F002578_OFFSET UNITYSDK_OFFSET(0x165100B0)
#define CLASS_1_6D694B2FE164C36B_METHOD_1_C81E70EDC28E327D_OFFSET UNITYSDK_OFFSET(0x16510260)
#define CLASS_1_6D694B2FE164C36B_METHOD_1_CE34EA208837238D_OFFSET UNITYSDK_OFFSET(0x16510050)
#define CLASS_1_6D694B2FE164C36B_METHOD_1_F0E307B84478A272_OFFSET UNITYSDK_OFFSET(0x16510430)
#define CLASS_1_6D694B2FE164C36B_METHOD_1_F2E1599CBB58B20F_OFFSET UNITYSDK_OFFSET(0x165105B0)
#define CLASS_1_6D694B2FE164C36B__CCTOR_OFFSET UNITYSDK_OFFSET(0x16510A00)

inline static constexpr unsigned int Class_1_6D694B2FE164C36B_TypeDefinitionIndex = 11283;
...
public:
	...
	{
		return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6D694B2FE164C36B_TypeDefinitionIndex)->GetStaticField(0x36C00);
	}
	static ::System::Action_1<::Class_1_7A22A3DBEEDD1F80*>** StaticGet_Field_1_3()
	{
		return (::System::Action_1<::Class_1_7A22A3DBEEDD1F80*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6D694B2FE164C36B_TypeDefinitionIndex)->GetStaticField(0x36C08);
	}
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::RPG::GameCore::CommonIndexKey, ::RPG::GameCore::SwordTrainingEffectRow*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6D694B2FE164C36B_TypeDefinitionIndex)->GetStaticField(0x36C10);
	}
	static ::System::Byte* StaticGet_Field_1_2()
	{
		return (::System::Byte*)Il2CppClass::FromTypeDefinitionIndex(Class_1_6D694B2FE164C36B_TypeDefinitionIndex)->GetStaticField(0xD400);
	}
	static ::System::Boolean* StaticGet_Field_1_1()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_1_6D694B2FE164C36B_TypeDefinitionIndex)->GetStaticField(0xD401);
	}
