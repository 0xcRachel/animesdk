...
#define AKROOMPORTAL_AWAKE_OFFSET UNITYSDK_OFFSET(0x18BE9DB0)
#define AKROOMPORTAL_CLOSEPORTAL_OFFSET UNITYSDK_OFFSET(0x18BEA0C0)
#define AKROOMPORTAL_CLOSE_OFFSET UNITYSDK_OFFSET(0x18BEA1E0)
#define AKROOMPORTAL_FILLROOMLIST_OFFSET UNITYSDK_OFFSET(0x18BEA590)
#define AKROOMPORTAL_FINDOVERLAPPINGROOMS_OFFSET UNITYSDK_OFFSET(0x18BE9BD0)
#define AKROOMPORTAL_GETID_OFFSET UNITYSDK_OFFSET(0x18BE98D0)
#define AKROOMPORTAL_GETROOM_OFFSET UNITYSDK_OFFSET(0x18BE9070)
#define AKROOMPORTAL_GET_BACKROOMID_OFFSET UNITYSDK_OFFSET(0x18BE8E00)
#define AKROOMPORTAL_GET_BACKROOM_OFFSET UNITYSDK_OFFSET(0x18BE7DA0)
#define AKROOMPORTAL_GET_FRONTROOMID_OFFSET UNITYSDK_OFFSET(0x18BE8B10)
#define AKROOMPORTAL_GET_FRONTROOM_OFFSET UNITYSDK_OFFSET(0x18BE7D30)
#define AKROOMPORTAL_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x18BE98A0)
#define AKROOMPORTAL_GET_PORTALACTIVE_OFFSET UNITYSDK_OFFSET(0x18BE8AB0)
#define AKROOMPORTAL_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x18BEA110)
#define AKROOMPORTAL_ISROOMACTIVE_OFFSET UNITYSDK_OFFSET(0x18BE8D90)
#define AKROOMPORTAL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18BEA260)
#define AKROOMPORTAL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x18BEA3F0)
#define AKROOMPORTAL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18BEA340)
#define AKROOMPORTAL_OPEN_OFFSET UNITYSDK_OFFSET(0x18BEA160)
#define AKROOMPORTAL_OVERLAPS_OFFSET UNITYSDK_OFFSET(0x18BE7E10)
#define AKROOMPORTAL_SETBACKROOM_OFFSET UNITYSDK_OFFSET(0x18BEA9C0)
#define AKROOMPORTAL_SETFRONTROOM_OFFSET UNITYSDK_OFFSET(0x18BEA920)
#define AKROOMPORTAL_SETROOMPORTAL_OFFSET UNITYSDK_OFFSET(0x18BE90E0)
#define AKROOMPORTAL_SETROOM_OFFSET UNITYSDK_OFFSET(0x18BEA880)
#define AKROOMPORTAL_SET_PORTALACTIVE_OFFSET UNITYSDK_OFFSET(0x18BE8AC0)
#define AKROOMPORTAL_START_OFFSET UNITYSDK_OFFSET(0x18BE9FB0)
#define AKROOMPORTAL_UPDATEOVERLAPPINGROOMS_OFFSET UNITYSDK_OFFSET(0x18BEAAD0)
#define AKROOMPORTAL_UPDATEROOMPORTAL_OFFSET UNITYSDK_OFFSET(0x18BE80C0)
#define AKROOMPORTAL_UPDATEROOMS_OFFSET UNITYSDK_OFFSET(0x18BE9940)
#define AKROOMPORTAL_UPDATESOUNDENGINEROOMIDS_OFFSET UNITYSDK_OFFSET(0x18BEAA60)
#define AKROOMPORTAL__CTOR_OFFSET UNITYSDK_OFFSET(0x18BEAB20)
#define AKROOMPORTAL___IFIXBASEPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0x18BEADC0)
#define AKROOMPORTAL___IFIXBASEPROXY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18BEAE70)
#define AKROOMPORTAL___IFIXBASEPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18BEAEF0)
#define AKROOMPORTAL___IFIXBASEPROXY_START_OFFSET UNITYSDK_OFFSET(0x18BEADD0)
