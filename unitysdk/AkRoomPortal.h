...
#define AKROOMPORTAL_AWAKE_OFFSET UNITYSDK_OFFSET(0x196FE330)
#define AKROOMPORTAL_CLOSEPORTAL_OFFSET UNITYSDK_OFFSET(0x196FE640)
#define AKROOMPORTAL_CLOSE_OFFSET UNITYSDK_OFFSET(0x196FE760)
#define AKROOMPORTAL_FILLROOMLIST_OFFSET UNITYSDK_OFFSET(0x196FEB10)
#define AKROOMPORTAL_FINDOVERLAPPINGROOMS_OFFSET UNITYSDK_OFFSET(0x196FE150)
#define AKROOMPORTAL_GETID_OFFSET UNITYSDK_OFFSET(0x196FDE50)
#define AKROOMPORTAL_GETROOM_OFFSET UNITYSDK_OFFSET(0x196FD5F0)
#define AKROOMPORTAL_GET_BACKROOMID_OFFSET UNITYSDK_OFFSET(0x196FD380)
#define AKROOMPORTAL_GET_BACKROOM_OFFSET UNITYSDK_OFFSET(0x196FC320)
#define AKROOMPORTAL_GET_FRONTROOMID_OFFSET UNITYSDK_OFFSET(0x196FD090)
#define AKROOMPORTAL_GET_FRONTROOM_OFFSET UNITYSDK_OFFSET(0x196FC2B0)
#define AKROOMPORTAL_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x196FDE20)
#define AKROOMPORTAL_GET_PORTALACTIVE_OFFSET UNITYSDK_OFFSET(0x196FD030)
#define AKROOMPORTAL_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x196FE690)
#define AKROOMPORTAL_ISROOMACTIVE_OFFSET UNITYSDK_OFFSET(0x196FD310)
#define AKROOMPORTAL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x196FE7E0)
#define AKROOMPORTAL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x196FE970)
#define AKROOMPORTAL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x196FE8C0)
#define AKROOMPORTAL_OPEN_OFFSET UNITYSDK_OFFSET(0x196FE6E0)
#define AKROOMPORTAL_OVERLAPS_OFFSET UNITYSDK_OFFSET(0x196FC390)
#define AKROOMPORTAL_SETBACKROOM_OFFSET UNITYSDK_OFFSET(0x196FEF40)
#define AKROOMPORTAL_SETFRONTROOM_OFFSET UNITYSDK_OFFSET(0x196FEEA0)
#define AKROOMPORTAL_SETROOMPORTAL_OFFSET UNITYSDK_OFFSET(0x196FD660)
#define AKROOMPORTAL_SETROOM_OFFSET UNITYSDK_OFFSET(0x196FEE00)
#define AKROOMPORTAL_SET_PORTALACTIVE_OFFSET UNITYSDK_OFFSET(0x196FD040)
#define AKROOMPORTAL_START_OFFSET UNITYSDK_OFFSET(0x196FE530)
#define AKROOMPORTAL_UPDATEOVERLAPPINGROOMS_OFFSET UNITYSDK_OFFSET(0x196FF050)
#define AKROOMPORTAL_UPDATEROOMPORTAL_OFFSET UNITYSDK_OFFSET(0x196FC640)
#define AKROOMPORTAL_UPDATEROOMS_OFFSET UNITYSDK_OFFSET(0x196FDEC0)
#define AKROOMPORTAL_UPDATESOUNDENGINEROOMIDS_OFFSET UNITYSDK_OFFSET(0x196FEFE0)
#define AKROOMPORTAL__CTOR_OFFSET UNITYSDK_OFFSET(0x196FF0A0)
#define AKROOMPORTAL___IFIXBASEPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0x196FF340)
#define AKROOMPORTAL___IFIXBASEPROXY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x196FF3F0)
#define AKROOMPORTAL___IFIXBASEPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x196FF470)
#define AKROOMPORTAL___IFIXBASEPROXY_START_OFFSET UNITYSDK_OFFSET(0x196FF350)
