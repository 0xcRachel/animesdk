...
#define AKROOMPORTAL_AWAKE_OFFSET UNITYSDK_OFFSET(0x183C5320)
#define AKROOMPORTAL_CLOSEPORTAL_OFFSET UNITYSDK_OFFSET(0x183C5630)
#define AKROOMPORTAL_CLOSE_OFFSET UNITYSDK_OFFSET(0x183C5750)
#define AKROOMPORTAL_FILLROOMLIST_OFFSET UNITYSDK_OFFSET(0x183C5B00)
#define AKROOMPORTAL_FINDOVERLAPPINGROOMS_OFFSET UNITYSDK_OFFSET(0x183C5140)
#define AKROOMPORTAL_GETID_OFFSET UNITYSDK_OFFSET(0x183C4E40)
#define AKROOMPORTAL_GETROOM_OFFSET UNITYSDK_OFFSET(0x183C45E0)
#define AKROOMPORTAL_GET_BACKROOMID_OFFSET UNITYSDK_OFFSET(0x183C4370)
#define AKROOMPORTAL_GET_BACKROOM_OFFSET UNITYSDK_OFFSET(0x183C3310)
#define AKROOMPORTAL_GET_FRONTROOMID_OFFSET UNITYSDK_OFFSET(0x183C4080)
#define AKROOMPORTAL_GET_FRONTROOM_OFFSET UNITYSDK_OFFSET(0x183C32A0)
#define AKROOMPORTAL_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x183C4E10)
#define AKROOMPORTAL_GET_PORTALACTIVE_OFFSET UNITYSDK_OFFSET(0x183C4020)
#define AKROOMPORTAL_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x183C5680)
#define AKROOMPORTAL_ISROOMACTIVE_OFFSET UNITYSDK_OFFSET(0x183C4300)
#define AKROOMPORTAL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x183C57D0)
#define AKROOMPORTAL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x183C5960)
#define AKROOMPORTAL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x183C58B0)
#define AKROOMPORTAL_OPEN_OFFSET UNITYSDK_OFFSET(0x183C56D0)
#define AKROOMPORTAL_OVERLAPS_OFFSET UNITYSDK_OFFSET(0x183C3380)
#define AKROOMPORTAL_SETBACKROOM_OFFSET UNITYSDK_OFFSET(0x183C5F30)
#define AKROOMPORTAL_SETFRONTROOM_OFFSET UNITYSDK_OFFSET(0x183C5E90)
#define AKROOMPORTAL_SETROOMPORTAL_OFFSET UNITYSDK_OFFSET(0x183C4650)
#define AKROOMPORTAL_SETROOM_OFFSET UNITYSDK_OFFSET(0x183C5DF0)
#define AKROOMPORTAL_SET_PORTALACTIVE_OFFSET UNITYSDK_OFFSET(0x183C4030)
#define AKROOMPORTAL_START_OFFSET UNITYSDK_OFFSET(0x183C5520)
#define AKROOMPORTAL_UPDATEOVERLAPPINGROOMS_OFFSET UNITYSDK_OFFSET(0x183C6040)
#define AKROOMPORTAL_UPDATEROOMPORTAL_OFFSET UNITYSDK_OFFSET(0x183C3630)
#define AKROOMPORTAL_UPDATEROOMS_OFFSET UNITYSDK_OFFSET(0x183C4EB0)
#define AKROOMPORTAL_UPDATESOUNDENGINEROOMIDS_OFFSET UNITYSDK_OFFSET(0x183C5FD0)
#define AKROOMPORTAL__CTOR_OFFSET UNITYSDK_OFFSET(0x183C6090)
#define AKROOMPORTAL___IFIXBASEPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0x183C6330)
#define AKROOMPORTAL___IFIXBASEPROXY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x183C63E0)
#define AKROOMPORTAL___IFIXBASEPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x183C6460)
#define AKROOMPORTAL___IFIXBASEPROXY_START_OFFSET UNITYSDK_OFFSET(0x183C6340)

inline static constexpr unsigned int AkRoomPortal_TypeDefinitionIndex = 33694;
