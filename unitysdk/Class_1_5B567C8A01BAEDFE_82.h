...
#define CLASS_1_5B567C8A01BAEDFE_82_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A4D2C20)
#define CLASS_1_5B567C8A01BAEDFE_82_CLONE_OFFSET UNITYSDK_OFFSET(0x1A4D2A30)
#define CLASS_1_5B567C8A01BAEDFE_82_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A4D2B30)
#define CLASS_1_5B567C8A01BAEDFE_82_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A4D2AA0)
#define CLASS_1_5B567C8A01BAEDFE_82_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A4D2B80)
#define CLASS_1_5B567C8A01BAEDFE_82_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A4D2C70)
#define CLASS_1_5B567C8A01BAEDFE_82_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A4D2C40)
#define CLASS_1_5B567C8A01BAEDFE_82_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A4D2980)
#define CLASS_1_5B567C8A01BAEDFE_82_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A4D29E0)
#define CLASS_1_5B567C8A01BAEDFE_82_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A4D2BB0)
#define CLASS_1_5B567C8A01BAEDFE_82_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A4D2C10)
#define CLASS_1_5B567C8A01BAEDFE_82__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A4D2CC0)
#define CLASS_1_5B567C8A01BAEDFE_82__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A4D2A00)
#define CLASS_1_5B567C8A01BAEDFE_82__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4D29F0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_82*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_82_TypeDefinitionIndex)->GetStaticField(0x9500);
	}
