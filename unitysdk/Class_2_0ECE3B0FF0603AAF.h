...
#define CLASS_2_0ECE3B0FF0603AAF_APPLY_OFFSET UNITYSDK_OFFSET(0xFE70960)
#define CLASS_2_0ECE3B0FF0603AAF_INIT_OFFSET UNITYSDK_OFFSET(0xFE709F0)
#define CLASS_2_0ECE3B0FF0603AAF_ONENVOBJENABLE_OFFSET UNITYSDK_OFFSET(0xFE70A40)
#define CLASS_2_0ECE3B0FF0603AAF_ONFADINGBEGIN_OFFSET UNITYSDK_OFFSET(0xFE70860)
#define CLASS_2_0ECE3B0FF0603AAF_ONFADINGEND_OFFSET UNITYSDK_OFFSET(0xFE708B0)
#define CLASS_2_0ECE3B0FF0603AAF_ONFADING_OFFSET UNITYSDK_OFFSET(0xFE70800)
#define CLASS_2_0ECE3B0FF0603AAF_RELEASE_OFFSET UNITYSDK_OFFSET(0xFE709B0)
#define CLASS_2_0ECE3B0FF0603AAF_TICK_OFFSET UNITYSDK_OFFSET(0xFE70900)
#define CLASS_2_0ECE3B0FF0603AAF__CTOR_OFFSET UNITYSDK_OFFSET(0xFE707B0)
#define CLASS_2_0ECE3B0FF0603AAF___IFIXBASEPROXY_APPLY_OFFSET UNITYSDK_OFFSET(0xFE70C50)
#define CLASS_2_0ECE3B0FF0603AAF___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0xFE70D50)
#define CLASS_2_0ECE3B0FF0603AAF___IFIXBASEPROXY_ONENVOBJENABLE_OFFSET UNITYSDK_OFFSET(0xFE70DC0)
#define CLASS_2_0ECE3B0FF0603AAF___IFIXBASEPROXY_ONFADINGBEGIN_OFFSET UNITYSDK_OFFSET(0xFE70B00)
#define CLASS_2_0ECE3B0FF0603AAF___IFIXBASEPROXY_ONFADINGEND_OFFSET UNITYSDK_OFFSET(0xFE70B70)
#define CLASS_2_0ECE3B0FF0603AAF___IFIXBASEPROXY_ONFADING_OFFSET UNITYSDK_OFFSET(0xFE70A90)
#define CLASS_2_0ECE3B0FF0603AAF___IFIXBASEPROXY_RELEASE_OFFSET UNITYSDK_OFFSET(0xFE70CC0)
#define CLASS_2_0ECE3B0FF0603AAF___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0xFE70BE0)

inline static constexpr unsigned int Class_2_0ECE3B0FF0603AAF_TypeDefinitionIndex = 39017;
