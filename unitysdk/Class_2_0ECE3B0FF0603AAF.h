...
#define CLASS_2_0ECE3B0FF0603AAF_APPLY_OFFSET UNITYSDK_OFFSET(0xD1B9870)
#define CLASS_2_0ECE3B0FF0603AAF_INIT_OFFSET UNITYSDK_OFFSET(0xD1B9900)
#define CLASS_2_0ECE3B0FF0603AAF_ONENVOBJENABLE_OFFSET UNITYSDK_OFFSET(0xD1B9950)
#define CLASS_2_0ECE3B0FF0603AAF_ONFADINGBEGIN_OFFSET UNITYSDK_OFFSET(0xD1B9770)
#define CLASS_2_0ECE3B0FF0603AAF_ONFADINGEND_OFFSET UNITYSDK_OFFSET(0xD1B97C0)
#define CLASS_2_0ECE3B0FF0603AAF_ONFADING_OFFSET UNITYSDK_OFFSET(0xD1B9710)
#define CLASS_2_0ECE3B0FF0603AAF_RELEASE_OFFSET UNITYSDK_OFFSET(0xD1B98C0)
#define CLASS_2_0ECE3B0FF0603AAF_TICK_OFFSET UNITYSDK_OFFSET(0xD1B9810)
#define CLASS_2_0ECE3B0FF0603AAF__CTOR_OFFSET UNITYSDK_OFFSET(0xD1B96B0)
#define CLASS_2_0ECE3B0FF0603AAF___IFIXBASEPROXY_APPLY_OFFSET UNITYSDK_OFFSET(0xD1B9B60)
#define CLASS_2_0ECE3B0FF0603AAF___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0xD1B9C60)
#define CLASS_2_0ECE3B0FF0603AAF___IFIXBASEPROXY_ONENVOBJENABLE_OFFSET UNITYSDK_OFFSET(0xD1B9CD0)
#define CLASS_2_0ECE3B0FF0603AAF___IFIXBASEPROXY_ONFADINGBEGIN_OFFSET UNITYSDK_OFFSET(0xD1B9A10)
#define CLASS_2_0ECE3B0FF0603AAF___IFIXBASEPROXY_ONFADINGEND_OFFSET UNITYSDK_OFFSET(0xD1B9A80)
#define CLASS_2_0ECE3B0FF0603AAF___IFIXBASEPROXY_ONFADING_OFFSET UNITYSDK_OFFSET(0xD1B99A0)
#define CLASS_2_0ECE3B0FF0603AAF___IFIXBASEPROXY_RELEASE_OFFSET UNITYSDK_OFFSET(0xD1B9BD0)
#define CLASS_2_0ECE3B0FF0603AAF___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0xD1B9AF0)
