...
#define CLASS_2_0ECE3B0FF0603AAF_APPLY_OFFSET UNITYSDK_OFFSET(0xC5B0E00)
#define CLASS_2_0ECE3B0FF0603AAF_INIT_OFFSET UNITYSDK_OFFSET(0xC5B0E90)
#define CLASS_2_0ECE3B0FF0603AAF_ONENVOBJENABLE_OFFSET UNITYSDK_OFFSET(0xC5B0EE0)
#define CLASS_2_0ECE3B0FF0603AAF_ONFADINGBEGIN_OFFSET UNITYSDK_OFFSET(0xC5B0D00)
#define CLASS_2_0ECE3B0FF0603AAF_ONFADINGEND_OFFSET UNITYSDK_OFFSET(0xC5B0D50)
#define CLASS_2_0ECE3B0FF0603AAF_ONFADING_OFFSET UNITYSDK_OFFSET(0xC5B0CA0)
#define CLASS_2_0ECE3B0FF0603AAF_RELEASE_OFFSET UNITYSDK_OFFSET(0xC5B0E50)
#define CLASS_2_0ECE3B0FF0603AAF_TICK_OFFSET UNITYSDK_OFFSET(0xC5B0DA0)
#define CLASS_2_0ECE3B0FF0603AAF__CTOR_OFFSET UNITYSDK_OFFSET(0xC5B0C40)
#define CLASS_2_0ECE3B0FF0603AAF___IFIXBASEPROXY_APPLY_OFFSET UNITYSDK_OFFSET(0xC5B10F0)
#define CLASS_2_0ECE3B0FF0603AAF___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0xC5B11F0)
#define CLASS_2_0ECE3B0FF0603AAF___IFIXBASEPROXY_ONENVOBJENABLE_OFFSET UNITYSDK_OFFSET(0xC5B1260)
#define CLASS_2_0ECE3B0FF0603AAF___IFIXBASEPROXY_ONFADINGBEGIN_OFFSET UNITYSDK_OFFSET(0xC5B0FA0)
#define CLASS_2_0ECE3B0FF0603AAF___IFIXBASEPROXY_ONFADINGEND_OFFSET UNITYSDK_OFFSET(0xC5B1010)
#define CLASS_2_0ECE3B0FF0603AAF___IFIXBASEPROXY_ONFADING_OFFSET UNITYSDK_OFFSET(0xC5B0F30)
#define CLASS_2_0ECE3B0FF0603AAF___IFIXBASEPROXY_RELEASE_OFFSET UNITYSDK_OFFSET(0xC5B1160)
#define CLASS_2_0ECE3B0FF0603AAF___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0xC5B1080)
