...
#define CLASS_2_D2303ADC91E85B9A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x155C7FE0)
#define CLASS_2_D2303ADC91E85B9A_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x155C8020)
#define CLASS_2_D2303ADC91E85B9A_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x155C8290)
#define CLASS_2_D2303ADC91E85B9A_TICK_OFFSET UNITYSDK_OFFSET(0x155C82E0)
#define CLASS_2_D2303ADC91E85B9A__CTOR_OFFSET UNITYSDK_OFFSET(0x155C7FD0)
