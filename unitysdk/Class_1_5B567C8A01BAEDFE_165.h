...
#define CLASS_1_5B567C8A01BAEDFE_165_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A2A02F0)
#define CLASS_1_5B567C8A01BAEDFE_165_CLONE_OFFSET UNITYSDK_OFFSET(0x1A2A0100)
#define CLASS_1_5B567C8A01BAEDFE_165_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A2A0200)
#define CLASS_1_5B567C8A01BAEDFE_165_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A2A0170)
#define CLASS_1_5B567C8A01BAEDFE_165_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A2A0250)
#define CLASS_1_5B567C8A01BAEDFE_165_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A2A0340)
#define CLASS_1_5B567C8A01BAEDFE_165_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A2A0310)
#define CLASS_1_5B567C8A01BAEDFE_165_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A2A0050)
#define CLASS_1_5B567C8A01BAEDFE_165_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A2A00B0)
#define CLASS_1_5B567C8A01BAEDFE_165_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A2A0280)
#define CLASS_1_5B567C8A01BAEDFE_165_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A2A02E0)
#define CLASS_1_5B567C8A01BAEDFE_165__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A2A0390)
#define CLASS_1_5B567C8A01BAEDFE_165__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A2A00D0)
#define CLASS_1_5B567C8A01BAEDFE_165__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2A00C0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_165*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_165_TypeDefinitionIndex)->GetStaticField(0x487A0);
	}
