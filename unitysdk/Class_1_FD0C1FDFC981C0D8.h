...
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_114781D79D91EA39_OFFSET UNITYSDK_OFFSET(0xD145A80)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_1C0A5CAB68440997_OFFSET UNITYSDK_OFFSET(0xD145A90)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xD1466B0)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_26A9E2FBA9E855C3_OFFSET UNITYSDK_OFFSET(0xD146780)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_414C8F92528E4746_OFFSET UNITYSDK_OFFSET(0xD146820)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_457E58CBA89C9A1F_OFFSET UNITYSDK_OFFSET(0xD145A20)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_51D4C4EE6EA0D8EF_OFFSET UNITYSDK_OFFSET(0xD146380)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_529667A9A98E3E14_OFFSET UNITYSDK_OFFSET(0xD145CE0)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_608DF549DA17D200_OFFSET UNITYSDK_OFFSET(0xD146D10)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_6950DFC9E62DCDC3_OFFSET UNITYSDK_OFFSET(0xD1461A0)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_6E57D3559C10FFA9_OFFSET UNITYSDK_OFFSET(0xD1460C0)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_7810D50B558ECBD7_OFFSET UNITYSDK_OFFSET(0xD147330)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_8F697642FBF3BDA7_OFFSET UNITYSDK_OFFSET(0xD146110)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_B2041A37C51A785E_OFFSET UNITYSDK_OFFSET(0xD146E70)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_B6BC1AB86061A135_OFFSET UNITYSDK_OFFSET(0xD146570)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_C53828012EF20D6F_OFFSET UNITYSDK_OFFSET(0xD1465B0)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_D6DCBD205BD366A3_OFFSET UNITYSDK_OFFSET(0xD146710)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_D978819B0A4871A0_1_OFFSET UNITYSDK_OFFSET(0xD145A60)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_D978819B0A4871A0_OFFSET UNITYSDK_OFFSET(0xD145A40)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_DC715239B8B98D9C_OFFSET UNITYSDK_OFFSET(0xD146A50)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_E876C8B6D3B840A6_OFFSET UNITYSDK_OFFSET(0xD145E70)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_EAC2737A96E071C9_OFFSET UNITYSDK_OFFSET(0xD1473B0)
#define CLASS_1_FD0C1FDFC981C0D8__CTOR_OFFSET UNITYSDK_OFFSET(0xD145B10)

inline static constexpr unsigned int Class_1_FD0C1FDFC981C0D8_TypeDefinitionIndex = 61339;

class Class_1_FD0C1FDFC981C0D8 : public ::System::Object
{
public:
	::System::Collections::Generic::List_1<::System::UInt32>* Field_1_4; // 0x10
	::System::Collections::Generic::List_1<::RPG::Client::RuntimeRegionVolume*>* Field_1_2; // 0x18
	::RPG::GameCore::LevelNavNodeInfo* Field_1_1; // 0x20
	::Class_1_BE0E97EFC15B9DBB* Field_1_0; // 0x28
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::UInt32>* Field_1_3; // 0x30
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::UInt32, ::System::UInt32))((::PBYTE)hIl2Cpp + CLASS_1_FD0C1FDFC981C0D8_METHOD_1_51D4C4EE6EA0D8EF_OFFSET))(this, a1, a2);
	}
