...
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_114781D79D91EA39_OFFSET UNITYSDK_OFFSET(0xE77C6C0)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_1C0A5CAB68440997_OFFSET UNITYSDK_OFFSET(0xE77C6D0)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xE77D220)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_26A9E2FBA9E855C3_OFFSET UNITYSDK_OFFSET(0xE77D2F0)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_414C8F92528E4746_OFFSET UNITYSDK_OFFSET(0xE77D390)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_457E58CBA89C9A1F_OFFSET UNITYSDK_OFFSET(0xE77C660)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_529667A9A98E3E14_OFFSET UNITYSDK_OFFSET(0xE77C920)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_608DF549DA17D200_OFFSET UNITYSDK_OFFSET(0xE77D870)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_6950DFC9E62DCDC3_OFFSET UNITYSDK_OFFSET(0xE77CDE0)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_6E57D3559C10FFA9_OFFSET UNITYSDK_OFFSET(0xE77CD00)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_7810D50B558ECBD7_OFFSET UNITYSDK_OFFSET(0xE77DE90)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_8F697642FBF3BDA7_OFFSET UNITYSDK_OFFSET(0xE77CD50)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_B2041A37C51A785E_OFFSET UNITYSDK_OFFSET(0xE77D9D0)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_B6BC1AB86061A135_OFFSET UNITYSDK_OFFSET(0xE77D0E0)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_C53828012EF20D6F_OFFSET UNITYSDK_OFFSET(0xE77D120)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_D6DCBD205BD366A3_OFFSET UNITYSDK_OFFSET(0xE77D280)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_D978819B0A4871A0_1_OFFSET UNITYSDK_OFFSET(0xE77C6A0)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_D978819B0A4871A0_OFFSET UNITYSDK_OFFSET(0xE77C680)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_DC715239B8B98D9C_OFFSET UNITYSDK_OFFSET(0xE77D5C0)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_E876C8B6D3B840A6_OFFSET UNITYSDK_OFFSET(0xE77CAB0)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_EAC2737A96E071C9_OFFSET UNITYSDK_OFFSET(0xE77DF10)
#define CLASS_1_FD0C1FDFC981C0D8_METHOD_1_F15878FE8A90EF23_OFFSET UNITYSDK_OFFSET(0xE77CFC0)
#define CLASS_1_FD0C1FDFC981C0D8__CTOR_OFFSET UNITYSDK_OFFSET(0xE77C750)

inline static constexpr unsigned int Class_1_FD0C1FDFC981C0D8_TypeDefinitionIndex = 68846;

class Class_1_FD0C1FDFC981C0D8 : public ::System::Object
{
public:
	::System::Collections::Generic::List_1<::RPG::Client::RuntimeRegionVolume*>* Field_1_2; // 0x10
	...
	::System::Collections::Generic::IReadOnlyList_1<::Class_0_16E4307DCC419505_1056*>* Method_1_26A9E2FBA9E855C3()
	{
		return ((::System::Collections::Generic::IReadOnlyList_1<::Class_0_16E4307DCC419505_1056*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_FD0C1FDFC981C0D8_METHOD_1_26A9E2FBA9E855C3_OFFSET))(this);
	}
