...
#define UNITYCHAN_SPRINGMANAGER_SPRINGBONECLASS__CTOR_OFFSET UNITYSDK_OFFSET(0xA7330C0)

namespace UnityChan
{
	inline static constexpr unsigned int SpringManager_SpringBoneClass_TypeDefinitionIndex = 37593;
