...
#define CLASS_1_5B567C8A01BAEDFE_92_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A4016E0)
#define CLASS_1_5B567C8A01BAEDFE_92_CLONE_OFFSET UNITYSDK_OFFSET(0x1A4014F0)
#define CLASS_1_5B567C8A01BAEDFE_92_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A4015F0)
#define CLASS_1_5B567C8A01BAEDFE_92_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A401560)
#define CLASS_1_5B567C8A01BAEDFE_92_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A401640)
#define CLASS_1_5B567C8A01BAEDFE_92_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A401730)
#define CLASS_1_5B567C8A01BAEDFE_92_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A401700)
#define CLASS_1_5B567C8A01BAEDFE_92_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A401440)
#define CLASS_1_5B567C8A01BAEDFE_92_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A4014A0)
#define CLASS_1_5B567C8A01BAEDFE_92_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A401670)
#define CLASS_1_5B567C8A01BAEDFE_92_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A4016D0)
#define CLASS_1_5B567C8A01BAEDFE_92__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A401780)
#define CLASS_1_5B567C8A01BAEDFE_92__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A4014C0)
#define CLASS_1_5B567C8A01BAEDFE_92__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4014B0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_92*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_92_TypeDefinitionIndex)->GetStaticField(0x133A0);
	}
