...
#define CLASS_2_4B74C2B59AFE0700_LOCK_OFFSET UNITYSDK_OFFSET(0x10EBACC0)
#define CLASS_2_4B74C2B59AFE0700_METHOD_2_1B9CC121BDC8766D_OFFSET UNITYSDK_OFFSET(0x10EBAD70)
#define CLASS_2_4B74C2B59AFE0700_UNLOCK_OFFSET UNITYSDK_OFFSET(0x10EBAE10)
#define CLASS_2_4B74C2B59AFE0700__CTOR_OFFSET UNITYSDK_OFFSET(0x10EBACB0)
#define CLASS_2_4B74C2B59AFE0700___IFIXBASEPROXY_LOCK_OFFSET UNITYSDK_OFFSET(0x10EBAEC0)
#define CLASS_2_4B74C2B59AFE0700___IFIXBASEPROXY_UNLOCK_OFFSET UNITYSDK_OFFSET(0x10EBAF30)

inline static constexpr unsigned int Class_2_4B74C2B59AFE0700_TypeDefinitionIndex = 59736;
...
public:
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_262*>*))((::PBYTE)hIl2Cpp + CLASS_2_4B74C2B59AFE0700__CTOR_OFFSET))(this, a1);
	}
