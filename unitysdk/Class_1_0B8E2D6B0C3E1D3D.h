...
#define CLASS_1_0B8E2D6B0C3E1D3D_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAC92370)
#define CLASS_1_0B8E2D6B0C3E1D3D_METHOD_1_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0xAC929A0)
#define CLASS_1_0B8E2D6B0C3E1D3D_METHOD_1_365B3CE7026B1EB7_OFFSET UNITYSDK_OFFSET(0xAC92720)
#define CLASS_1_0B8E2D6B0C3E1D3D_METHOD_1_96BDC4B57CCFE000_OFFSET UNITYSDK_OFFSET(0xAC925E0)
#define CLASS_1_0B8E2D6B0C3E1D3D_METHOD_1_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0xAC92A00)
#define CLASS_1_0B8E2D6B0C3E1D3D_METHOD_1_B387E1AED8A8F880_OFFSET UNITYSDK_OFFSET(0xAC92770)
#define CLASS_1_0B8E2D6B0C3E1D3D_METHOD_1_D266E35E4D15DF98_OFFSET UNITYSDK_OFFSET(0xAC92680)
#define CLASS_1_0B8E2D6B0C3E1D3D_TICK_OFFSET UNITYSDK_OFFSET(0xAC923C0)
#define CLASS_1_0B8E2D6B0C3E1D3D__CTOR_OFFSET UNITYSDK_OFFSET(0xAC92330)

inline static constexpr unsigned int Class_1_0B8E2D6B0C3E1D3D_TypeDefinitionIndex = 43700;

class Class_1_0B8E2D6B0C3E1D3D : public ::System::Object
{
public:
	::Class_1_E7811A222424F15E* Field_1_1; // 0x10
	::RPG::GameCore::AdventureSkillCharacterComponent* Field_1_3; // 0x18
