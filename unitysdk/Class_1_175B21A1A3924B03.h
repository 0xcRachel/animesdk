...
#define CLASS_1_175B21A1A3924B03_GET_RENDERERNAME_OFFSET UNITYSDK_OFFSET(0xBF22E00)
#define CLASS_1_175B21A1A3924B03_METHOD_1_3BC36FDD267A8206_OFFSET UNITYSDK_OFFSET(0xBF22F80)
#define CLASS_1_175B21A1A3924B03_METHOD_1_479759059E440327_1_OFFSET UNITYSDK_OFFSET(0xBF23380)
#define CLASS_1_175B21A1A3924B03_METHOD_1_479759059E440327_OFFSET UNITYSDK_OFFSET(0xBF231D0)
#define CLASS_1_175B21A1A3924B03_METHOD_1_B86122B0EE4F8679_OFFSET UNITYSDK_OFFSET(0xBF230F0)
#define CLASS_1_175B21A1A3924B03_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xBF22F30)
#define CLASS_1_175B21A1A3924B03_METHOD_1_F9A791B5381B18AE_OFFSET UNITYSDK_OFFSET(0xBF232B0)
#define CLASS_1_175B21A1A3924B03_SET_RENDERERNAME_OFFSET UNITYSDK_OFFSET(0xBF22E10)
#define CLASS_1_175B21A1A3924B03__CTOR_OFFSET UNITYSDK_OFFSET(0xBF22E20)

inline static constexpr unsigned int Class_1_175B21A1A3924B03_TypeDefinitionIndex = 45131;

class Class_1_175B21A1A3924B03 : public ::System::Object
{
public:
	::System::String* _RendererName_k__BackingField; // 0x10
	::Class_1_D27BF54F25500E5F* Field_1_1; // 0x18
	::RPG::Client::BaseShaderPropertyTransition* Field_1_2; // 0x20

	::System::Void _ctor(::Class_1_E32CDD50C4B344A5* a1, ::System::String* a2)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_E32CDD50C4B344A5*, ::System::String*))((::PBYTE)hIl2Cpp + CLASS_1_175B21A1A3924B03__CTOR_OFFSET))(this, a1, a2);
	}
