...
#define CLASS_1_5E6DF2E8BBFC913C_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19E63B50)
#define CLASS_1_5E6DF2E8BBFC913C_CLONE_OFFSET UNITYSDK_OFFSET(0x19E636D0)
#define CLASS_1_5E6DF2E8BBFC913C_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19E63870)
#define CLASS_1_5E6DF2E8BBFC913C_EQUALS_OFFSET UNITYSDK_OFFSET(0x19E63750)
#define CLASS_1_5E6DF2E8BBFC913C_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19E63920)
#define CLASS_1_5E6DF2E8BBFC913C_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19E63D00)
#define CLASS_1_5E6DF2E8BBFC913C_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19E63C60)
#define CLASS_1_5E6DF2E8BBFC913C_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x19E63720)
#define CLASS_1_5E6DF2E8BBFC913C_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19E63590)
#define CLASS_1_5E6DF2E8BBFC913C_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x19E63730)
#define CLASS_1_5E6DF2E8BBFC913C_METHOD_1_F9594A5160DEEC20_OFFSET UNITYSDK_OFFSET(0x19E63740)
#define CLASS_1_5E6DF2E8BBFC913C_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19E635F0)
#define CLASS_1_5E6DF2E8BBFC913C_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19E63A10)
#define CLASS_1_5E6DF2E8BBFC913C_WRITETO_OFFSET UNITYSDK_OFFSET(0x19E63A70)
#define CLASS_1_5E6DF2E8BBFC913C__CCTOR_OFFSET UNITYSDK_OFFSET(0x19E63DE0)
#define CLASS_1_5E6DF2E8BBFC913C__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19E63640)
#define CLASS_1_5E6DF2E8BBFC913C__CTOR_OFFSET UNITYSDK_OFFSET(0x19E63600)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5E6DF2E8BBFC913C*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5E6DF2E8BBFC913C_TypeDefinitionIndex)->GetStaticField(0x472A0);
	}
	static ::Google::Protobuf::FieldCodec_1<::Proto::ItemCost*>** StaticGet_Field_1_5()
	{
		return (::Google::Protobuf::FieldCodec_1<::Proto::ItemCost*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5E6DF2E8BBFC913C_TypeDefinitionIndex)->GetStaticField(0x472A8);
	}
