...
#define CLASS_3_441B7C0415B9DC03_DISPOSE_OFFSET UNITYSDK_OFFSET(0x843C4D0)
#define CLASS_3_441B7C0415B9DC03_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x843C510)
#define CLASS_3_441B7C0415B9DC03__CTOR_OFFSET UNITYSDK_OFFSET(0x843C4A0)
#define CLASS_3_441B7C0415B9DC03___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x843CAF0)

inline static constexpr unsigned int Class_3_441B7C0415B9DC03_TypeDefinitionIndex = 43453;
