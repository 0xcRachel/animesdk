...
#define EZYSLICE_PLANE_COMPUTE_1_OFFSET UNITYSDK_OFFSET(0x389D970)
#define EZYSLICE_PLANE_COMPUTE_2_OFFSET UNITYSDK_OFFSET(0x389DB80)
#define EZYSLICE_PLANE_COMPUTE_OFFSET UNITYSDK_OFFSET(0x389D7F0)
#define EZYSLICE_PLANE_GET_DIST_OFFSET UNITYSDK_OFFSET(0xFD35D0)
#define EZYSLICE_PLANE_GET_NORMAL_OFFSET UNITYSDK_OFFSET(0xFD37D0)
#define EZYSLICE_PLANE_ONDEBUGDRAW_1_OFFSET UNITYSDK_OFFSET(0x5F2300)
#define EZYSLICE_PLANE_ONDEBUGDRAW_OFFSET UNITYSDK_OFFSET(0x5F2300)
#define EZYSLICE_PLANE_SIDEOF_OFFSET UNITYSDK_OFFSET(0x389DDA0)
#define EZYSLICE_PLANE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3748C30)
#define EZYSLICE_PLANE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x389D830)
#define EZYSLICE_PLANE__CTOR_OFFSET UNITYSDK_OFFSET(0x389D7F0)
