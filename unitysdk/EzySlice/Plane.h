...
#define EZYSLICE_PLANE_COMPUTE_1_OFFSET UNITYSDK_OFFSET(0x24810)
#define EZYSLICE_PLANE_COMPUTE_2_OFFSET UNITYSDK_OFFSET(0x24A20)
#define EZYSLICE_PLANE_COMPUTE_OFFSET UNITYSDK_OFFSET(0x24670)
#define EZYSLICE_PLANE_GET_DIST_OFFSET UNITYSDK_OFFSET(0xCCB0)
#define EZYSLICE_PLANE_GET_NORMAL_OFFSET UNITYSDK_OFFSET(0x24630)
...
#define EZYSLICE_PLANE_SIDEOF_OFFSET UNITYSDK_OFFSET(0x24C40)
#define EZYSLICE_PLANE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x246B0)
#define EZYSLICE_PLANE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x246D0)
#define EZYSLICE_PLANE__CTOR_OFFSET UNITYSDK_OFFSET(0x24670)

namespace EzySlice
{
	inline static constexpr unsigned int Plane_TypeDefinitionIndex = 36996;
