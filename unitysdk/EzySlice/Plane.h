...
#define EZYSLICE_PLANE_COMPUTE_1_OFFSET UNITYSDK_OFFSET(0x22EF660)
#define EZYSLICE_PLANE_COMPUTE_2_OFFSET UNITYSDK_OFFSET(0x22EF870)
#define EZYSLICE_PLANE_COMPUTE_OFFSET UNITYSDK_OFFSET(0x22EF4E0)
#define EZYSLICE_PLANE_GET_DIST_OFFSET UNITYSDK_OFFSET(0x879EE0)
#define EZYSLICE_PLANE_GET_NORMAL_OFFSET UNITYSDK_OFFSET(0x657BF0)
#define EZYSLICE_PLANE_ONDEBUGDRAW_1_OFFSET UNITYSDK_OFFSET(0x545E40)
#define EZYSLICE_PLANE_ONDEBUGDRAW_OFFSET UNITYSDK_OFFSET(0x545E40)
#define EZYSLICE_PLANE_SIDEOF_OFFSET UNITYSDK_OFFSET(0x22EFA90)
#define EZYSLICE_PLANE__CTOR_1_OFFSET UNITYSDK_OFFSET(0xCD1D30)
#define EZYSLICE_PLANE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x22EF520)
#define EZYSLICE_PLANE__CTOR_OFFSET UNITYSDK_OFFSET(0x22EF4E0)
