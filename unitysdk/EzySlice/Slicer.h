...
#define EZYSLICE_SLICER_CREATEFROM_1_OFFSET UNITYSDK_OFFSET(0x8091930)
#define EZYSLICE_SLICER_CREATEFROM_OFFSET UNITYSDK_OFFSET(0x8091980)
#define EZYSLICE_SLICER_CREATEHULL_OFFSET UNITYSDK_OFFSET(0x8091AB0)
#define EZYSLICE_SLICER_CREATELOWERHULL_OFFSET UNITYSDK_OFFSET(0x8091A90)
#define EZYSLICE_SLICER_CREATEUPPERHULL_OFFSET UNITYSDK_OFFSET(0x8091A70)
#define EZYSLICE_SLICER_SLICE_1_OFFSET UNITYSDK_OFFSET(0x8090610)
#define EZYSLICE_SLICER_SLICE_OFFSET UNITYSDK_OFFSET(0x8090210)
#define EZYSLICE_SLICER__CTOR_OFFSET UNITYSDK_OFFSET(0x8093A30)

namespace EzySlice
{
	inline static constexpr unsigned int Slicer_TypeDefinitionIndex = 37004;
