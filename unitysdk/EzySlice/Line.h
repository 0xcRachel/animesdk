...
#define EZYSLICE_LINE_GET_DISTSQ_OFFSET UNITYSDK_OFFSET(0x245F0)
#define EZYSLICE_LINE_GET_DIST_OFFSET UNITYSDK_OFFSET(0x245A0)
#define EZYSLICE_LINE_GET_POSITIONA_OFFSET UNITYSDK_OFFSET(0x24630)
#define EZYSLICE_LINE_GET_POSITIONB_OFFSET UNITYSDK_OFFSET(0x24650)
#define EZYSLICE_LINE__CTOR_OFFSET UNITYSDK_OFFSET(0x24560)

namespace EzySlice
{
	inline static constexpr unsigned int Line_TypeDefinitionIndex = 36994;
