...
#define CLASS_2_DEDEB7A9CFC0863E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x117C5C50)
#define CLASS_2_DEDEB7A9CFC0863E_GET__COMMONCONFIG_OFFSET UNITYSDK_OFFSET(0x117C6330)
#define CLASS_2_DEDEB7A9CFC0863E_METHOD_2_086AF5E1F81FD4BC_OFFSET UNITYSDK_OFFSET(0x117C55A0)
#define CLASS_2_DEDEB7A9CFC0863E_METHOD_2_0FF711E1520484B8_OFFSET UNITYSDK_OFFSET(0x117C5740)
#define CLASS_2_DEDEB7A9CFC0863E_METHOD_2_1B9CC121BDC8766D_OFFSET UNITYSDK_OFFSET(0x117C4A90)
#define CLASS_2_DEDEB7A9CFC0863E_METHOD_2_4E4517540F7A2678_OFFSET UNITYSDK_OFFSET(0x117C54D0)
#define CLASS_2_DEDEB7A9CFC0863E_METHOD_2_66B58BEE3C528647_OFFSET UNITYSDK_OFFSET(0x117C4D80)
#define CLASS_2_DEDEB7A9CFC0863E_METHOD_2_739DB9F245C7FAD0_OFFSET UNITYSDK_OFFSET(0x117C52E0)
#define CLASS_2_DEDEB7A9CFC0863E_METHOD_2_812B27EF664F59CD_OFFSET UNITYSDK_OFFSET(0x117C6290)
#define CLASS_2_DEDEB7A9CFC0863E_METHOD_2_94CBD0C21A609187_OFFSET UNITYSDK_OFFSET(0x117C61D0)
#define CLASS_2_DEDEB7A9CFC0863E_METHOD_2_99053D1AE5A59190_OFFSET UNITYSDK_OFFSET(0x117C58E0)
#define CLASS_2_DEDEB7A9CFC0863E_METHOD_2_A4A798E0E81B27AE_OFFSET UNITYSDK_OFFSET(0x117C48B0)
#define CLASS_2_DEDEB7A9CFC0863E_METHOD_2_A6544B958241856F_OFFSET UNITYSDK_OFFSET(0x117C4AF0)
#define CLASS_2_DEDEB7A9CFC0863E_METHOD_2_CFB4683D7465D57F_OFFSET UNITYSDK_OFFSET(0x117C5DE0)
#define CLASS_2_DEDEB7A9CFC0863E_METHOD_2_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0x117C5130)
#define CLASS_2_DEDEB7A9CFC0863E_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x117C6320)
#define CLASS_2_DEDEB7A9CFC0863E_SET__COMMONCONFIG_OFFSET UNITYSDK_OFFSET(0x117C6340)
#define CLASS_2_DEDEB7A9CFC0863E_TICK_OFFSET UNITYSDK_OFFSET(0x117C5D60)
#define CLASS_2_DEDEB7A9CFC0863E__CTOR_OFFSET UNITYSDK_OFFSET(0x117C4800)
#define CLASS_2_DEDEB7A9CFC0863E___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x117C6350)

inline static constexpr unsigned int Class_2_DEDEB7A9CFC0863E_TypeDefinitionIndex = 60078;
