...
#define MINIMAPCLIPPER_GET_IMAGE_OFFSET UNITYSDK_OFFSET(0xEE6BA70)
#define MINIMAPCLIPPER_GET_MATERIALFORRENDERING_OFFSET UNITYSDK_OFFSET(0xEE6BBD0)
#define MINIMAPCLIPPER_GET_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xEE6BB20)
#define MINIMAPCLIPPER_METHOD_7_3D57569EEAF613B6_OFFSET UNITYSDK_OFFSET(0xEE6C370)
#define MINIMAPCLIPPER_METHOD_7_9C0F83425CE501BF_OFFSET UNITYSDK_OFFSET(0xEE6CFC0)
#define MINIMAPCLIPPER_MODIFYMESH_1_OFFSET UNITYSDK_OFFSET(0xEE6CE60)
#define MINIMAPCLIPPER_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0xEE6CE10)
#define MINIMAPCLIPPER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xEE6DBC0)
#define MINIMAPCLIPPER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xEE6D9E0)
#define MINIMAPCLIPPER_SETCLIPSIZE_OFFSET UNITYSDK_OFFSET(0xEE6D840)
#define MINIMAPCLIPPER_SETUVOFFSET_OFFSET UNITYSDK_OFFSET(0xEE6C1C0)
#define MINIMAPCLIPPER_SETUVSCALE_OFFSET UNITYSDK_OFFSET(0xEE6CD80)
#define MINIMAPCLIPPER__CTOR_OFFSET UNITYSDK_OFFSET(0xEE6DC20)
#define MINIMAPCLIPPER___IFIXBASEPROXY_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0xEE6DC30)
#define MINIMAPCLIPPER___IFIXBASEPROXY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xEE6DCF0)
#define MINIMAPCLIPPER___IFIXBASEPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0xEE6DC40)
