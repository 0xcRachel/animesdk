...
#define MINIMAPCLIPPER_GET_IMAGE_OFFSET UNITYSDK_OFFSET(0x111FCA20)
#define MINIMAPCLIPPER_GET_MATERIALFORRENDERING_OFFSET UNITYSDK_OFFSET(0x111FCB80)
#define MINIMAPCLIPPER_GET_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x111FCAD0)
#define MINIMAPCLIPPER_METHOD_7_9C0F83425CE501BF_OFFSET UNITYSDK_OFFSET(0x111FDE50)
#define MINIMAPCLIPPER_METHOD_7_9DC685F3E3A2FC2F_OFFSET UNITYSDK_OFFSET(0x111FD320)
#define MINIMAPCLIPPER_MODIFYMESH_1_OFFSET UNITYSDK_OFFSET(0x111FDCC0)
#define MINIMAPCLIPPER_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x111FDC70)
#define MINIMAPCLIPPER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x111FEA50)
#define MINIMAPCLIPPER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x111FE870)
#define MINIMAPCLIPPER_SETCLIPSIZE_OFFSET UNITYSDK_OFFSET(0x111FE6D0)
#define MINIMAPCLIPPER_SETUVOFFSET_OFFSET UNITYSDK_OFFSET(0x111FD170)
#define MINIMAPCLIPPER_SETUVSCALE_OFFSET UNITYSDK_OFFSET(0x111FDBE0)
#define MINIMAPCLIPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x111FEAB0)
#define MINIMAPCLIPPER___IFIXBASEPROXY_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x111FEAC0)
#define MINIMAPCLIPPER___IFIXBASEPROXY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x111FEB80)
#define MINIMAPCLIPPER___IFIXBASEPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x111FEAD0)

inline static constexpr unsigned int MiniMapClipper_TypeDefinitionIndex = 37470;
...
public:
	...
	::System::Boolean Method_7_9DC685F3E3A2FC2F()
	{
		return ((::System::Boolean(*)(::PVOID))((::PBYTE)hIl2Cpp + MINIMAPCLIPPER_METHOD_7_9DC685F3E3A2FC2F_OFFSET))(this);
	}
