...
#define MINIMAPCLIPPER_GET_IMAGE_OFFSET UNITYSDK_OFFSET(0x88C6FD0)
#define MINIMAPCLIPPER_GET_MATERIALFORRENDERING_OFFSET UNITYSDK_OFFSET(0x88C7130)
#define MINIMAPCLIPPER_GET_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x88C7080)
#define MINIMAPCLIPPER_METHOD_7_3D57569EEAF613B6_OFFSET UNITYSDK_OFFSET(0x88C78D0)
#define MINIMAPCLIPPER_METHOD_7_9C0F83425CE501BF_OFFSET UNITYSDK_OFFSET(0x88C8520)
#define MINIMAPCLIPPER_MODIFYMESH_1_OFFSET UNITYSDK_OFFSET(0x88C83C0)
#define MINIMAPCLIPPER_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x88C8370)
#define MINIMAPCLIPPER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x88C9120)
#define MINIMAPCLIPPER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x88C8F40)
#define MINIMAPCLIPPER_SETCLIPSIZE_OFFSET UNITYSDK_OFFSET(0x88C8DA0)
#define MINIMAPCLIPPER_SETUVOFFSET_OFFSET UNITYSDK_OFFSET(0x88C7720)
#define MINIMAPCLIPPER_SETUVSCALE_OFFSET UNITYSDK_OFFSET(0x88C82E0)
#define MINIMAPCLIPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x88C9180)
#define MINIMAPCLIPPER___IFIXBASEPROXY_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x88C9190)
#define MINIMAPCLIPPER___IFIXBASEPROXY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x88C9250)
#define MINIMAPCLIPPER___IFIXBASEPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x88C91A0)
