...
#define CLASS_1_68C07AD0EA256AFA___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A9DCED0)
#define CLASS_1_68C07AD0EA256AFA___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9DCF10)
#define CLASS_1_68C07AD0EA256AFA___C___CCTOR_B__38_0_OFFSET UNITYSDK_OFFSET(0x1A9DCF20)
...
public:
	...
	{
		return (::Class_1_68C07AD0EA256AFA___c**)Il2CppClass::FromTypeDefinitionIndex(Class_1_68C07AD0EA256AFA___c_TypeDefinitionIndex)->GetStaticField(0x1BA70);
	}
