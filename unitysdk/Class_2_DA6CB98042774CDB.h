...
#define CLASS_2_DA6CB98042774CDB_DISPOSE_OFFSET UNITYSDK_OFFSET(0xFDADF20)
#define CLASS_2_DA6CB98042774CDB_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0xFDADDE0)
#define CLASS_2_DA6CB98042774CDB_ONSKIP_OFFSET UNITYSDK_OFFSET(0xFDADDF0)
#define CLASS_2_DA6CB98042774CDB_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xFDAE080)
#define CLASS_2_DA6CB98042774CDB_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xFDAE1E0)
#define CLASS_2_DA6CB98042774CDB_TICK_OFFSET UNITYSDK_OFFSET(0xFDADF60)
#define CLASS_2_DA6CB98042774CDB__CTOR_OFFSET UNITYSDK_OFFSET(0xFDADDD0)

inline static constexpr unsigned int Class_2_DA6CB98042774CDB_TypeDefinitionIndex = 41599;
