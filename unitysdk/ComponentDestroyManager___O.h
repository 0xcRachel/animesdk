...
public:
	...
	{
		return (::UnityEngine::LowLevel::PlayerLoopSystem_UpdateFunction**)Il2CppClass::FromTypeDefinitionIndex(ComponentDestroyManager___O_TypeDefinitionIndex)->GetStaticField(0x5BE80);
	}
};
