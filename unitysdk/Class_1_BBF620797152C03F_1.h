...
#define CLASS_1_BBF620797152C03F_1_METHOD_1_CD53F45513A00C57_OFFSET UNITYSDK_OFFSET(0xD21A9A0)
#define CLASS_1_BBF620797152C03F_1_METHOD_1_DD39C4DB3CC4FFB9_OFFSET UNITYSDK_OFFSET(0xD21A440)
#define CLASS_1_BBF620797152C03F_1__CTOR_OFFSET UNITYSDK_OFFSET(0xD21A3A0)

inline static constexpr unsigned int Class_1_BBF620797152C03F_1_TypeDefinitionIndex = 52212;
...
public:
	...
	{
		return ((::Class_0_16E4307DCC419505_543*(*)(::PVOID, ::RPG::GameCore::AvatarPropertyType))((::PBYTE)hIl2Cpp + CLASS_1_BBF620797152C03F_1_METHOD_1_CD53F45513A00C57_OFFSET))(this, a1);
	}
};
