...
#define CLASS_1_06CDCC6A0A66BA0A_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xF594CB0)
#define CLASS_1_06CDCC6A0A66BA0A_EQUALS_OFFSET UNITYSDK_OFFSET(0xF594C20)
#define CLASS_1_06CDCC6A0A66BA0A_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xF594D90)
#define CLASS_1_06CDCC6A0A66BA0A_GET_FOURRARITYAVATARRANKLEVEL_OFFSET UNITYSDK_OFFSET(0xF594BF0)
#define CLASS_1_06CDCC6A0A66BA0A_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0xF594AC0)
#define CLASS_1_06CDCC6A0A66BA0A_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xF594AD0)
#define CLASS_1_06CDCC6A0A66BA0A_GET_LIGHTCONELEVEL_OFFSET UNITYSDK_OFFSET(0xF594BB0)
#define CLASS_1_06CDCC6A0A66BA0A_GET_LIGHTCONEPROMOTIONLEVEL_OFFSET UNITYSDK_OFFSET(0xF594BD0)
#define CLASS_1_06CDCC6A0A66BA0A_GET_PROMOTIONLEVEL_OFFSET UNITYSDK_OFFSET(0xF594AF0)
#define CLASS_1_06CDCC6A0A66BA0A_GET_RELICSET2AVERAGELEVEL_OFFSET UNITYSDK_OFFSET(0xF594B70)
#define CLASS_1_06CDCC6A0A66BA0A_GET_RELICSET2RARITY_OFFSET UNITYSDK_OFFSET(0xF594B90)
#define CLASS_1_06CDCC6A0A66BA0A_GET_RELICSET4AVERAGELEVEL_OFFSET UNITYSDK_OFFSET(0xF594B30)
#define CLASS_1_06CDCC6A0A66BA0A_GET_RELICSET4RARITY_OFFSET UNITYSDK_OFFSET(0xF594B50)
#define CLASS_1_06CDCC6A0A66BA0A_GET_TRACETREEKEY_OFFSET UNITYSDK_OFFSET(0xF594B10)
#define CLASS_1_06CDCC6A0A66BA0A_METHOD_1_3E81B089F141D6EC_1_OFFSET UNITYSDK_OFFSET(0xF594EB0)
#define CLASS_1_06CDCC6A0A66BA0A_METHOD_1_3E81B089F141D6EC_OFFSET UNITYSDK_OFFSET(0xF594DF0)
#define CLASS_1_06CDCC6A0A66BA0A_SET_FOURRARITYAVATARRANKLEVEL_OFFSET UNITYSDK_OFFSET(0xF594C00)
#define CLASS_1_06CDCC6A0A66BA0A_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0xF594AE0)
#define CLASS_1_06CDCC6A0A66BA0A_SET_LIGHTCONELEVEL_OFFSET UNITYSDK_OFFSET(0xF594BC0)
#define CLASS_1_06CDCC6A0A66BA0A_SET_LIGHTCONEPROMOTIONLEVEL_OFFSET UNITYSDK_OFFSET(0xF594BE0)
#define CLASS_1_06CDCC6A0A66BA0A_SET_PROMOTIONLEVEL_OFFSET UNITYSDK_OFFSET(0xF594B00)
#define CLASS_1_06CDCC6A0A66BA0A_SET_RELICSET2AVERAGELEVEL_OFFSET UNITYSDK_OFFSET(0xF594B80)
#define CLASS_1_06CDCC6A0A66BA0A_SET_RELICSET2RARITY_OFFSET UNITYSDK_OFFSET(0xF594BA0)
#define CLASS_1_06CDCC6A0A66BA0A_SET_RELICSET4AVERAGELEVEL_OFFSET UNITYSDK_OFFSET(0xF594B40)
#define CLASS_1_06CDCC6A0A66BA0A_SET_RELICSET4RARITY_OFFSET UNITYSDK_OFFSET(0xF594B60)
#define CLASS_1_06CDCC6A0A66BA0A_SET_TRACETREEKEY_OFFSET UNITYSDK_OFFSET(0xF594B20)
#define CLASS_1_06CDCC6A0A66BA0A__CTOR_OFFSET UNITYSDK_OFFSET(0xF594C10)
#define CLASS_1_06CDCC6A0A66BA0A___IFIXBASEPROXY_EQUALS_OFFSET UNITYSDK_OFFSET(0xF594F80)
#define CLASS_1_06CDCC6A0A66BA0A___IFIXBASEPROXY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xF594F90)
...
public:
	...
	::System::UInt32 _LightConePromotionLevel_k__BackingField; // 0x18
	...
	::System::UInt32 _RelicSet2AverageLevel_k__BackingField; // 0x28
	::RPG::GameCore::CombatPowerRelicRarityType _RelicSet4Rarity_k__BackingField; // 0x2C
	::System::UInt32 _FourRarityAvatarRankLevel_k__BackingField; // 0x30
	::System::UInt32 _RelicSet4AverageLevel_k__BackingField; // 0x34
	::Struct_2_019938BC9C50B169_7 _Identifier_k__BackingField; // 0x38
