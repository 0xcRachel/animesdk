...
#define CLASS_1_06CDCC6A0A66BA0A_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x10C5A0C0)
#define CLASS_1_06CDCC6A0A66BA0A_EQUALS_OFFSET UNITYSDK_OFFSET(0x10C5A030)
#define CLASS_1_06CDCC6A0A66BA0A_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x10C5A1A0)
#define CLASS_1_06CDCC6A0A66BA0A_GET_FOURRARITYAVATARRANKLEVEL_OFFSET UNITYSDK_OFFSET(0x10C5A000)
#define CLASS_1_06CDCC6A0A66BA0A_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x10C59ED0)
#define CLASS_1_06CDCC6A0A66BA0A_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x10C59EE0)
#define CLASS_1_06CDCC6A0A66BA0A_GET_LIGHTCONELEVEL_OFFSET UNITYSDK_OFFSET(0x10C59FC0)
#define CLASS_1_06CDCC6A0A66BA0A_GET_LIGHTCONEPROMOTIONLEVEL_OFFSET UNITYSDK_OFFSET(0x10C59FE0)
#define CLASS_1_06CDCC6A0A66BA0A_GET_PROMOTIONLEVEL_OFFSET UNITYSDK_OFFSET(0x10C59F00)
#define CLASS_1_06CDCC6A0A66BA0A_GET_RELICSET2AVERAGELEVEL_OFFSET UNITYSDK_OFFSET(0x10C59F80)
#define CLASS_1_06CDCC6A0A66BA0A_GET_RELICSET2RARITY_OFFSET UNITYSDK_OFFSET(0x10C59FA0)
#define CLASS_1_06CDCC6A0A66BA0A_GET_RELICSET4AVERAGELEVEL_OFFSET UNITYSDK_OFFSET(0x10C59F40)
#define CLASS_1_06CDCC6A0A66BA0A_GET_RELICSET4RARITY_OFFSET UNITYSDK_OFFSET(0x10C59F60)
#define CLASS_1_06CDCC6A0A66BA0A_GET_TRACETREEKEY_OFFSET UNITYSDK_OFFSET(0x10C59F20)
#define CLASS_1_06CDCC6A0A66BA0A_METHOD_1_3E81B089F141D6EC_1_OFFSET UNITYSDK_OFFSET(0x10C5A2C0)
#define CLASS_1_06CDCC6A0A66BA0A_METHOD_1_3E81B089F141D6EC_OFFSET UNITYSDK_OFFSET(0x10C5A200)
#define CLASS_1_06CDCC6A0A66BA0A_SET_FOURRARITYAVATARRANKLEVEL_OFFSET UNITYSDK_OFFSET(0x10C5A010)
#define CLASS_1_06CDCC6A0A66BA0A_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x10C59EF0)
#define CLASS_1_06CDCC6A0A66BA0A_SET_LIGHTCONELEVEL_OFFSET UNITYSDK_OFFSET(0x10C59FD0)
#define CLASS_1_06CDCC6A0A66BA0A_SET_LIGHTCONEPROMOTIONLEVEL_OFFSET UNITYSDK_OFFSET(0x10C59FF0)
#define CLASS_1_06CDCC6A0A66BA0A_SET_PROMOTIONLEVEL_OFFSET UNITYSDK_OFFSET(0x10C59F10)
#define CLASS_1_06CDCC6A0A66BA0A_SET_RELICSET2AVERAGELEVEL_OFFSET UNITYSDK_OFFSET(0x10C59F90)
#define CLASS_1_06CDCC6A0A66BA0A_SET_RELICSET2RARITY_OFFSET UNITYSDK_OFFSET(0x10C59FB0)
#define CLASS_1_06CDCC6A0A66BA0A_SET_RELICSET4AVERAGELEVEL_OFFSET UNITYSDK_OFFSET(0x10C59F50)
#define CLASS_1_06CDCC6A0A66BA0A_SET_RELICSET4RARITY_OFFSET UNITYSDK_OFFSET(0x10C59F70)
#define CLASS_1_06CDCC6A0A66BA0A_SET_TRACETREEKEY_OFFSET UNITYSDK_OFFSET(0x10C59F30)
#define CLASS_1_06CDCC6A0A66BA0A__CTOR_OFFSET UNITYSDK_OFFSET(0x10C5A020)
#define CLASS_1_06CDCC6A0A66BA0A___IFIXBASEPROXY_EQUALS_OFFSET UNITYSDK_OFFSET(0x10C5A390)
#define CLASS_1_06CDCC6A0A66BA0A___IFIXBASEPROXY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x10C5A3A0)
...
public:
	...
	::System::UInt32 _FourRarityAvatarRankLevel_k__BackingField; // 0x18
	...
	::Struct_2_019938BC9C50B169_7 _Identifier_k__BackingField; // 0x28
	::System::UInt32 _RelicSet4AverageLevel_k__BackingField; // 0x2C
	::System::UInt32 _LightConePromotionLevel_k__BackingField; // 0x30
	::System::UInt32 _Level_k__BackingField; // 0x34
	::RPG::GameCore::CombatPowerRelicRarityType _RelicSet2Rarity_k__BackingField; // 0x38
	::RPG::GameCore::CombatPowerRelicRarityType _RelicSet4Rarity_k__BackingField; // 0x3C
