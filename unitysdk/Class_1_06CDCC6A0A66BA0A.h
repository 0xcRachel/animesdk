...
#define CLASS_1_06CDCC6A0A66BA0A_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x111D3BF0)
#define CLASS_1_06CDCC6A0A66BA0A_EQUALS_OFFSET UNITYSDK_OFFSET(0x111D3B60)
#define CLASS_1_06CDCC6A0A66BA0A_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x111D3CD0)
#define CLASS_1_06CDCC6A0A66BA0A_GET_FOURRARITYAVATARRANKLEVEL_OFFSET UNITYSDK_OFFSET(0x111D3B30)
#define CLASS_1_06CDCC6A0A66BA0A_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x111D3A00)
#define CLASS_1_06CDCC6A0A66BA0A_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x111D3A10)
#define CLASS_1_06CDCC6A0A66BA0A_GET_LIGHTCONELEVEL_OFFSET UNITYSDK_OFFSET(0x111D3AF0)
#define CLASS_1_06CDCC6A0A66BA0A_GET_LIGHTCONEPROMOTIONLEVEL_OFFSET UNITYSDK_OFFSET(0x111D3B10)
#define CLASS_1_06CDCC6A0A66BA0A_GET_PROMOTIONLEVEL_OFFSET UNITYSDK_OFFSET(0x111D3A30)
#define CLASS_1_06CDCC6A0A66BA0A_GET_RELICSET2AVERAGELEVEL_OFFSET UNITYSDK_OFFSET(0x111D3AB0)
#define CLASS_1_06CDCC6A0A66BA0A_GET_RELICSET2RARITY_OFFSET UNITYSDK_OFFSET(0x111D3AD0)
#define CLASS_1_06CDCC6A0A66BA0A_GET_RELICSET4AVERAGELEVEL_OFFSET UNITYSDK_OFFSET(0x111D3A70)
#define CLASS_1_06CDCC6A0A66BA0A_GET_RELICSET4RARITY_OFFSET UNITYSDK_OFFSET(0x111D3A90)
#define CLASS_1_06CDCC6A0A66BA0A_GET_TRACETREEKEY_OFFSET UNITYSDK_OFFSET(0x111D3A50)
#define CLASS_1_06CDCC6A0A66BA0A_METHOD_1_3E81B089F141D6EC_1_OFFSET UNITYSDK_OFFSET(0x111D3DF0)
#define CLASS_1_06CDCC6A0A66BA0A_METHOD_1_3E81B089F141D6EC_OFFSET UNITYSDK_OFFSET(0x111D3D30)
#define CLASS_1_06CDCC6A0A66BA0A_SET_FOURRARITYAVATARRANKLEVEL_OFFSET UNITYSDK_OFFSET(0x111D3B40)
#define CLASS_1_06CDCC6A0A66BA0A_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x111D3A20)
#define CLASS_1_06CDCC6A0A66BA0A_SET_LIGHTCONELEVEL_OFFSET UNITYSDK_OFFSET(0x111D3B00)
#define CLASS_1_06CDCC6A0A66BA0A_SET_LIGHTCONEPROMOTIONLEVEL_OFFSET UNITYSDK_OFFSET(0x111D3B20)
#define CLASS_1_06CDCC6A0A66BA0A_SET_PROMOTIONLEVEL_OFFSET UNITYSDK_OFFSET(0x111D3A40)
#define CLASS_1_06CDCC6A0A66BA0A_SET_RELICSET2AVERAGELEVEL_OFFSET UNITYSDK_OFFSET(0x111D3AC0)
#define CLASS_1_06CDCC6A0A66BA0A_SET_RELICSET2RARITY_OFFSET UNITYSDK_OFFSET(0x111D3AE0)
#define CLASS_1_06CDCC6A0A66BA0A_SET_RELICSET4AVERAGELEVEL_OFFSET UNITYSDK_OFFSET(0x111D3A80)
#define CLASS_1_06CDCC6A0A66BA0A_SET_RELICSET4RARITY_OFFSET UNITYSDK_OFFSET(0x111D3AA0)
#define CLASS_1_06CDCC6A0A66BA0A_SET_TRACETREEKEY_OFFSET UNITYSDK_OFFSET(0x111D3A60)
#define CLASS_1_06CDCC6A0A66BA0A__CTOR_OFFSET UNITYSDK_OFFSET(0x111D3B50)
#define CLASS_1_06CDCC6A0A66BA0A___IFIXBASEPROXY_EQUALS_OFFSET UNITYSDK_OFFSET(0x111D3EC0)
#define CLASS_1_06CDCC6A0A66BA0A___IFIXBASEPROXY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x111D3ED0)

inline static constexpr unsigned int Class_1_06CDCC6A0A66BA0A_TypeDefinitionIndex = 40964;
...
public:
	...
	::System::UInt32 _RelicSet4AverageLevel_k__BackingField; // 0x20
	::System::UInt32 _LightConeLevel_k__BackingField; // 0x24
	::System::UInt32 _LightConePromotionLevel_k__BackingField; // 0x28
