...
#define CLASS_1_E8D3C253AACBAAAD_METHOD_1_BA928C31B09C0D39_OFFSET UNITYSDK_OFFSET(0x19176230)
#define CLASS_1_E8D3C253AACBAAAD__CTOR_OFFSET UNITYSDK_OFFSET(0x19176600)
...
public:
	...
	::Il2CppArray<::RPG::GameCore::LimaoNewsInterviewDecoType>* Field_1_1; // 0x18
