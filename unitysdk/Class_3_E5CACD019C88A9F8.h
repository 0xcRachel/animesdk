...
#define CLASS_3_E5CACD019C88A9F8_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB2B8950)
#define CLASS_3_E5CACD019C88A9F8_METHOD_3_34279D326BA59007_OFFSET UNITYSDK_OFFSET(0xB2B89F0)
#define CLASS_3_E5CACD019C88A9F8_METHOD_3_ACDFEAC427456543_OFFSET UNITYSDK_OFFSET(0xB2B8C20)
#define CLASS_3_E5CACD019C88A9F8_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB2B8990)
#define CLASS_3_E5CACD019C88A9F8__CTOR_OFFSET UNITYSDK_OFFSET(0xB2B8880)
#define CLASS_3_E5CACD019C88A9F8___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB2B8D20)

inline static constexpr unsigned int Class_3_E5CACD019C88A9F8_TypeDefinitionIndex = 43472;
