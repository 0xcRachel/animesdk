...
#define CLASS_3_E5CACD019C88A9F8_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10FB0090)
#define CLASS_3_E5CACD019C88A9F8_METHOD_3_15E74EE53C013940_OFFSET UNITYSDK_OFFSET(0x10FB0130)
#define CLASS_3_E5CACD019C88A9F8_METHOD_3_ACDFEAC427456543_OFFSET UNITYSDK_OFFSET(0x10FB0360)
#define CLASS_3_E5CACD019C88A9F8_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10FB00D0)
#define CLASS_3_E5CACD019C88A9F8__CTOR_OFFSET UNITYSDK_OFFSET(0x10FAFFC0)
#define CLASS_3_E5CACD019C88A9F8___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10FB0460)
...
public:
	...
	::Class_1_945ACFB1FEBC7A2C_18* Method_3_15E74EE53C013940()
	{
		return ((::Class_1_945ACFB1FEBC7A2C_18*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_3_E5CACD019C88A9F8_METHOD_3_15E74EE53C013940_OFFSET))(this);
	}
