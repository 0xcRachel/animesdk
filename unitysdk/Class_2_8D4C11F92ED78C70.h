...
#define CLASS_2_8D4C11F92ED78C70_METHOD_2_4BD2BFB48FF90060_OFFSET UNITYSDK_OFFSET(0x155C71C0)
#define CLASS_2_8D4C11F92ED78C70_METHOD_2_848FDD59AB054F3D_OFFSET UNITYSDK_OFFSET(0x155C73C0)
#define CLASS_2_8D4C11F92ED78C70__CTOR_OFFSET UNITYSDK_OFFSET(0x155C7450)
#define CLASS_2_8D4C11F92ED78C70__ONBIND_OFFSET UNITYSDK_OFFSET(0x155C7160)
#define CLASS_2_8D4C11F92ED78C70___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0x155C7480)

inline static constexpr unsigned int Class_2_8D4C11F92ED78C70_TypeDefinitionIndex = 66205;
