...
#define CLASS_2_BC84B87740DAFF4F_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10B2C920)
#define CLASS_2_BC84B87740DAFF4F_DOONENTER_OFFSET UNITYSDK_OFFSET(0x10B2CAD0)
#define CLASS_2_BC84B87740DAFF4F_DOONEXIT_OFFSET UNITYSDK_OFFSET(0x10B2D070)
#define CLASS_2_BC84B87740DAFF4F_DOONTICK_OFFSET UNITYSDK_OFFSET(0x10B2D0E0)
#define CLASS_2_BC84B87740DAFF4F_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x10B2D550)
#define CLASS_2_BC84B87740DAFF4F_GET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0x10B2D510)
#define CLASS_2_BC84B87740DAFF4F_GET_TEXTID_OFFSET UNITYSDK_OFFSET(0x10B2D530)
#define CLASS_2_BC84B87740DAFF4F_METHOD_2_1265AD26B9934ADC_OFFSET UNITYSDK_OFFSET(0x10B2D480)
#define CLASS_2_BC84B87740DAFF4F_METHOD_2_17FF7E72EFD64472_OFFSET UNITYSDK_OFFSET(0x10B2D2D0)
#define CLASS_2_BC84B87740DAFF4F_METHOD_2_256B6E165124982E_OFFSET UNITYSDK_OFFSET(0x10B2CA70)
#define CLASS_2_BC84B87740DAFF4F_METHOD_2_3E586421BA588EFD_OFFSET UNITYSDK_OFFSET(0x10B2CB30)
#define CLASS_2_BC84B87740DAFF4F_METHOD_2_7646FFE662147970_1_OFFSET UNITYSDK_OFFSET(0x10B2D220)
#define CLASS_2_BC84B87740DAFF4F_METHOD_2_7646FFE662147970_OFFSET UNITYSDK_OFFSET(0x10B2D170)
#define CLASS_2_BC84B87740DAFF4F_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x10B2C9F0)
#define CLASS_2_BC84B87740DAFF4F_METHOD_2_BF85224A16082717_OFFSET UNITYSDK_OFFSET(0x10B2C700)
#define CLASS_2_BC84B87740DAFF4F_METHOD_2_F7D9E881EE15AF45_OFFSET UNITYSDK_OFFSET(0x10B2C820)
#define CLASS_2_BC84B87740DAFF4F_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x10B2D560)
#define CLASS_2_BC84B87740DAFF4F_SET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0x10B2D520)
#define CLASS_2_BC84B87740DAFF4F_SET_TEXTID_OFFSET UNITYSDK_OFFSET(0x10B2D540)
#define CLASS_2_BC84B87740DAFF4F__CTOR_OFFSET UNITYSDK_OFFSET(0x10B2C710)
#define CLASS_2_BC84B87740DAFF4F___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10B2D570)
#define CLASS_2_BC84B87740DAFF4F___IFIXBASEPROXY_DOONENTER_OFFSET UNITYSDK_OFFSET(0x10B2D580)
#define CLASS_2_BC84B87740DAFF4F___IFIXBASEPROXY_DOONEXIT_OFFSET UNITYSDK_OFFSET(0x10B2D590)
...
public:
	...
	::Class_1_FFE03FE61A5D4B1E* Field_2_5; // 0x98
	...
	::RPG::GameCore::PropInteractionTrigger_ButtonParam* Field_2_4; // 0xC0
	::System::UInt32 _RuntimeID_k__BackingField; // 0xC8
	::System::Boolean Field_2_9; // 0xCC
	::System::Boolean Field_2_7; // 0xCD
	::System::Boolean Field_2_6; // 0xCE
	::RPG::Client::TextID _TextID_k__BackingField; // 0xD0
