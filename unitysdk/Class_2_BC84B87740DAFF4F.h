...
#define CLASS_2_BC84B87740DAFF4F_DISPOSE_OFFSET UNITYSDK_OFFSET(0x145F1A70)
#define CLASS_2_BC84B87740DAFF4F_DOONENTER_OFFSET UNITYSDK_OFFSET(0x145F1CF0)
#define CLASS_2_BC84B87740DAFF4F_DOONEXIT_OFFSET UNITYSDK_OFFSET(0x145F2290)
#define CLASS_2_BC84B87740DAFF4F_DOONTICK_OFFSET UNITYSDK_OFFSET(0x145F2300)
#define CLASS_2_BC84B87740DAFF4F_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x145F26E0)
#define CLASS_2_BC84B87740DAFF4F_GET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0x145F26A0)
#define CLASS_2_BC84B87740DAFF4F_GET_TEXTID_OFFSET UNITYSDK_OFFSET(0x145F26C0)
#define CLASS_2_BC84B87740DAFF4F_METHOD_2_1265AD26B9934ADC_OFFSET UNITYSDK_OFFSET(0x145F2610)
#define CLASS_2_BC84B87740DAFF4F_METHOD_2_1F130271093617A5_1_OFFSET UNITYSDK_OFFSET(0x145F1BC0)
#define CLASS_2_BC84B87740DAFF4F_METHOD_2_1F130271093617A5_OFFSET UNITYSDK_OFFSET(0x145F2390)
#define CLASS_2_BC84B87740DAFF4F_METHOD_2_256B6E165124982E_OFFSET UNITYSDK_OFFSET(0x145F1C90)
#define CLASS_2_BC84B87740DAFF4F_METHOD_2_6A6A96FBD090C99D_OFFSET UNITYSDK_OFFSET(0x145F1D50)
#define CLASS_2_BC84B87740DAFF4F_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x145F1B40)
#define CLASS_2_BC84B87740DAFF4F_METHOD_2_BF85224A16082717_OFFSET UNITYSDK_OFFSET(0x145F1850)
#define CLASS_2_BC84B87740DAFF4F_METHOD_2_F534E0360F42C704_OFFSET UNITYSDK_OFFSET(0x145F2460)
#define CLASS_2_BC84B87740DAFF4F_METHOD_2_F7D9E881EE15AF45_OFFSET UNITYSDK_OFFSET(0x145F1970)
#define CLASS_2_BC84B87740DAFF4F_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x145F26F0)
#define CLASS_2_BC84B87740DAFF4F_SET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0x145F26B0)
#define CLASS_2_BC84B87740DAFF4F_SET_TEXTID_OFFSET UNITYSDK_OFFSET(0x145F26D0)
#define CLASS_2_BC84B87740DAFF4F__CTOR_OFFSET UNITYSDK_OFFSET(0x145F1860)
#define CLASS_2_BC84B87740DAFF4F___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x145F2700)
#define CLASS_2_BC84B87740DAFF4F___IFIXBASEPROXY_DOONENTER_OFFSET UNITYSDK_OFFSET(0x145F2710)
#define CLASS_2_BC84B87740DAFF4F___IFIXBASEPROXY_DOONEXIT_OFFSET UNITYSDK_OFFSET(0x145F2720)
...
public:
	...
	::RPG::GameCore::PropInteractionTrigger_ButtonParam* Field_2_1; // 0x98
	::System::String* _IconPath_k__BackingField; // 0xA0
	::Class_1_FFE03FE61A5D4B1E* Field_2_3; // 0xA8
	::RPG::GameCore::GameEntity* Field_2_4; // 0xB0
	::RPG::Client::MonoCurveTriggerManager* Field_2_5; // 0xB8
	::RPG::GameCore::GameEntity* Field_2_6; // 0xC0
	::RPG::Client::TextID _TextID_k__BackingField; // 0xC8
	::System::Boolean Field_2_8; // 0xD8
	::System::Boolean Field_2_9; // 0xD9
	::System::Boolean Field_2_10; // 0xDA
