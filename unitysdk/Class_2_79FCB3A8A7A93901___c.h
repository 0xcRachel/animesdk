...
#define CLASS_2_79FCB3A8A7A93901___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x162B9AE0)
#define CLASS_2_79FCB3A8A7A93901___C__CTOR_OFFSET UNITYSDK_OFFSET(0x162B9B20)
#define CLASS_2_79FCB3A8A7A93901___C__TRYSHOWBOSSPERSISTENTTIPSPERFORMANCE_B__48_0_OFFSET UNITYSDK_OFFSET(0x162B9B30)
...
public:
	...
	{
		return (::Class_2_79FCB3A8A7A93901___c**)Il2CppClass::FromTypeDefinitionIndex(Class_2_79FCB3A8A7A93901___c_TypeDefinitionIndex)->GetStaticField(0x515F0);
	}
	static ::System::Func_2<::System::UInt32, ::RPG::GameCore::FixPoint>** StaticGet___9__48_0()
	{
		return (::System::Func_2<::System::UInt32, ::RPG::GameCore::FixPoint>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_79FCB3A8A7A93901___c_TypeDefinitionIndex)->GetStaticField(0x515F8);
	}
