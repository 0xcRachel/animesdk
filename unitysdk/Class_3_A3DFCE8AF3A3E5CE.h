...
#define CLASS_3_A3DFCE8AF3A3E5CE_METHOD_3_8C3DB70FFBBF01C7_OFFSET UNITYSDK_OFFSET(0xF2C09A0)
#define CLASS_3_A3DFCE8AF3A3E5CE_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xF2C06E0)
#define CLASS_3_A3DFCE8AF3A3E5CE__CTOR_OFFSET UNITYSDK_OFFSET(0xF2C03C0)
#define CLASS_3_A3DFCE8AF3A3E5CE__REGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0xF2C0540)
#define CLASS_3_A3DFCE8AF3A3E5CE__UNREGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0xF2C0610)
#define CLASS_3_A3DFCE8AF3A3E5CE___IFIXBASEPROXY_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xF2C0AC0)
#define CLASS_3_A3DFCE8AF3A3E5CE___IFIXBASEPROXY__REGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0xF2C0AA0)
#define CLASS_3_A3DFCE8AF3A3E5CE___IFIXBASEPROXY__UNREGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0xF2C0AB0)
