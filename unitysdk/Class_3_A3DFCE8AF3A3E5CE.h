...
#define CLASS_3_A3DFCE8AF3A3E5CE_METHOD_3_8C3DB70FFBBF01C7_OFFSET UNITYSDK_OFFSET(0x8A3B570)
#define CLASS_3_A3DFCE8AF3A3E5CE_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x8A3B2B0)
#define CLASS_3_A3DFCE8AF3A3E5CE__CTOR_OFFSET UNITYSDK_OFFSET(0x8A3AF90)
#define CLASS_3_A3DFCE8AF3A3E5CE__REGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x8A3B110)
#define CLASS_3_A3DFCE8AF3A3E5CE__UNREGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x8A3B1E0)
#define CLASS_3_A3DFCE8AF3A3E5CE___IFIXBASEPROXY_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x8A3B690)
#define CLASS_3_A3DFCE8AF3A3E5CE___IFIXBASEPROXY__REGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x8A3B670)
#define CLASS_3_A3DFCE8AF3A3E5CE___IFIXBASEPROXY__UNREGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x8A3B680)

inline static constexpr unsigned int Class_3_A3DFCE8AF3A3E5CE_TypeDefinitionIndex = 46476;
