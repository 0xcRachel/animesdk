...
#define CLASS_1_0551325621FDC7A7_DISPOSE_OFFSET UNITYSDK_OFFSET(0xE0C19A0)
#define CLASS_1_0551325621FDC7A7_METHOD_1_0C2E16DA38868706_OFFSET UNITYSDK_OFFSET(0xE0C1AD0)
#define CLASS_1_0551325621FDC7A7_METHOD_1_1B9CC121BDC8766D_OFFSET UNITYSDK_OFFSET(0xE0C1930)
#define CLASS_1_0551325621FDC7A7_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xE0C19F0)
#define CLASS_1_0551325621FDC7A7_METHOD_1_462AE28D2E76734C_OFFSET UNITYSDK_OFFSET(0xE0C1D20)
#define CLASS_1_0551325621FDC7A7_METHOD_1_8425AE8B450CC8A4_OFFSET UNITYSDK_OFFSET(0xE0C1BB0)
#define CLASS_1_0551325621FDC7A7_METHOD_1_99AE60B687EAE694_OFFSET UNITYSDK_OFFSET(0xE0C1A40)
#define CLASS_1_0551325621FDC7A7_METHOD_1_ED34DCC6F6541B09_OFFSET UNITYSDK_OFFSET(0xE0C1E40)
#define CLASS_1_0551325621FDC7A7__CCTOR_OFFSET UNITYSDK_OFFSET(0xE0C1F90)
#define CLASS_1_0551325621FDC7A7__CTOR_OFFSET UNITYSDK_OFFSET(0xE0C1800)
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_0551325621FDC7A7_TypeDefinitionIndex)->GetStaticField(0xE900);
	}
	::Il2CppArray<::System::Int32>* Field_1_2; // 0x10
	::Il2CppArray<::System::Byte>* Field_1_3; // 0x18
	::Il2CppArray<::UnityEngine::ShaderGroupAlloc>* Field_1_1; // 0x20
