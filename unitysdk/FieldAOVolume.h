...
#define FIELDAOVOLUME_METHOD_5_1290EA767C459179_1_OFFSET UNITYSDK_OFFSET(0x106618F0)
#define FIELDAOVOLUME_METHOD_5_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x10661360)
#define FIELDAOVOLUME_METHOD_5_7995D2033C97D105_OFFSET UNITYSDK_OFFSET(0x10661DF0)
#define FIELDAOVOLUME_METHOD_5_87318FF00D6BC7EB_OFFSET UNITYSDK_OFFSET(0x106614D0)
#define FIELDAOVOLUME_METHOD_5_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0x10661250)
#define FIELDAOVOLUME_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x10661D10)
#define FIELDAOVOLUME_ONENABLE_OFFSET UNITYSDK_OFFSET(0x10661A00)
#define FIELDAOVOLUME_START_OFFSET UNITYSDK_OFFSET(0x10661450)
#define FIELDAOVOLUME_UPDATEMATRIX_OFFSET UNITYSDK_OFFSET(0x10661AE0)
#define FIELDAOVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x10662210)
...
public:
	...
	{
		return (::UnityEngine::Material**)Il2CppClass::FromTypeDefinitionIndex(FieldAOVolume_TypeDefinitionIndex)->GetStaticField(0x18B10);
	}
