...
#define FIELDAOVOLUME_METHOD_5_1290EA767C459179_1_OFFSET UNITYSDK_OFFSET(0xFE7A650)
#define FIELDAOVOLUME_METHOD_5_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xFE7A0C0)
#define FIELDAOVOLUME_METHOD_5_7995D2033C97D105_OFFSET UNITYSDK_OFFSET(0xFE7AB50)
#define FIELDAOVOLUME_METHOD_5_87318FF00D6BC7EB_OFFSET UNITYSDK_OFFSET(0xFE7A230)
#define FIELDAOVOLUME_METHOD_5_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0xFE79FB0)
#define FIELDAOVOLUME_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xFE7AA70)
#define FIELDAOVOLUME_ONENABLE_OFFSET UNITYSDK_OFFSET(0xFE7A760)
#define FIELDAOVOLUME_START_OFFSET UNITYSDK_OFFSET(0xFE7A1B0)
#define FIELDAOVOLUME_UPDATEMATRIX_OFFSET UNITYSDK_OFFSET(0xFE7A840)
#define FIELDAOVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0xFE7AF70)

inline static constexpr unsigned int FieldAOVolume_TypeDefinitionIndex = 37406;
...
public:
	...
	{
		return (::UnityEngine::Material**)Il2CppClass::FromTypeDefinitionIndex(FieldAOVolume_TypeDefinitionIndex)->GetStaticField(0x14010);
	}
