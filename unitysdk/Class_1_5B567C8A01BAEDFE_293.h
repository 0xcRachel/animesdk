...
#define CLASS_1_5B567C8A01BAEDFE_293_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A1AB320)
#define CLASS_1_5B567C8A01BAEDFE_293_CLONE_OFFSET UNITYSDK_OFFSET(0x1A1AB130)
#define CLASS_1_5B567C8A01BAEDFE_293_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A1AB230)
#define CLASS_1_5B567C8A01BAEDFE_293_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A1AB1A0)
#define CLASS_1_5B567C8A01BAEDFE_293_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A1AB280)
#define CLASS_1_5B567C8A01BAEDFE_293_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A1AB370)
#define CLASS_1_5B567C8A01BAEDFE_293_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A1AB340)
#define CLASS_1_5B567C8A01BAEDFE_293_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A1AB080)
#define CLASS_1_5B567C8A01BAEDFE_293_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A1AB0E0)
#define CLASS_1_5B567C8A01BAEDFE_293_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A1AB2B0)
#define CLASS_1_5B567C8A01BAEDFE_293_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A1AB310)
#define CLASS_1_5B567C8A01BAEDFE_293__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1AB3C0)
#define CLASS_1_5B567C8A01BAEDFE_293__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A1AB100)
#define CLASS_1_5B567C8A01BAEDFE_293__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1AB0F0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_293*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_293_TypeDefinitionIndex)->GetStaticField(0x92F0);
	}
