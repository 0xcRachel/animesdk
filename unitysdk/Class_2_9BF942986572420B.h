...
#define CLASS_2_9BF942986572420B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10B48BE0)
#define CLASS_2_9BF942986572420B_GET_HEALTHLOWPLAYED_OFFSET UNITYSDK_OFFSET(0x10B4A6A0)
#define CLASS_2_9BF942986572420B_GET_SKILLREADYPLAYED_OFFSET UNITYSDK_OFFSET(0x10B4A680)
#define CLASS_2_9BF942986572420B_METHOD_2_03A756C1E337B103_OFFSET UNITYSDK_OFFSET(0x10B4A5F0)
#define CLASS_2_9BF942986572420B_METHOD_2_1DB1CBD202875DBB_OFFSET UNITYSDK_OFFSET(0x10B49720)
#define CLASS_2_9BF942986572420B_METHOD_2_1E13A8A5C0FF7D62_OFFSET UNITYSDK_OFFSET(0x10B48E00)
#define CLASS_2_9BF942986572420B_METHOD_2_2B63DE2921807645_OFFSET UNITYSDK_OFFSET(0x10B49830)
#define CLASS_2_9BF942986572420B_METHOD_2_3252C72430690445_OFFSET UNITYSDK_OFFSET(0x10B49CF0)
#define CLASS_2_9BF942986572420B_METHOD_2_39D78A8EB32A5315_OFFSET UNITYSDK_OFFSET(0x10B49AE0)
#define CLASS_2_9BF942986572420B_METHOD_2_4810D8613150D7C1_OFFSET UNITYSDK_OFFSET(0x10B492F0)
#define CLASS_2_9BF942986572420B_METHOD_2_5B0531D5B96D6B96_OFFSET UNITYSDK_OFFSET(0x10B49D70)
#define CLASS_2_9BF942986572420B_METHOD_2_799DACEAB56FE8EF_OFFSET UNITYSDK_OFFSET(0x10B4A180)
#define CLASS_2_9BF942986572420B_METHOD_2_96C88D5424560008_OFFSET UNITYSDK_OFFSET(0x10B4A460)
#define CLASS_2_9BF942986572420B_METHOD_2_9B3E928DD44EEB3D_OFFSET UNITYSDK_OFFSET(0x10B49070)
#define CLASS_2_9BF942986572420B_METHOD_2_9D0BCB90135AF1F1_OFFSET UNITYSDK_OFFSET(0x10B4A0A0)
#define CLASS_2_9BF942986572420B_METHOD_2_E64359669D8372F3_OFFSET UNITYSDK_OFFSET(0x10B49F80)
#define CLASS_2_9BF942986572420B_METHOD_2_EAA92E508F834FB8_OFFSET UNITYSDK_OFFSET(0x10B4A2A0)
#define CLASS_2_9BF942986572420B_METHOD_2_EDB0D8DA4A269034_OFFSET UNITYSDK_OFFSET(0x10B49E00)
#define CLASS_2_9BF942986572420B_SET_HEALTHLOWPLAYED_OFFSET UNITYSDK_OFFSET(0x10B4A6B0)
#define CLASS_2_9BF942986572420B_SET_SKILLREADYPLAYED_OFFSET UNITYSDK_OFFSET(0x10B4A690)
#define CLASS_2_9BF942986572420B__CTOR_OFFSET UNITYSDK_OFFSET(0x10B4A6C0)

inline static constexpr unsigned int Class_2_9BF942986572420B_TypeDefinitionIndex = 45010;

class Class_2_9BF942986572420B : public ::RPG::GameCore::GameComponentBase
{
public:
	::System::String* Field_2_9; // 0x18
	::RPG::GameCore::GridFightRoleOverrideVOConfigRow* Field_2_10; // 0x20
	::System::String* Field_2_2; // 0x28
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::GameCore::CharacterVOType>* Field_2_6; // 0x30
	...
	::System::Boolean _HealthLowPlayed_k__BackingField; // 0x4C
	::System::Boolean Field_2_3; // 0x4D
	...
	::System::Void Method_2_2B63DE2921807645(::Class_0_16E4307DCC419505_347* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_347*))((::PBYTE)hIl2Cpp + CLASS_2_9BF942986572420B_METHOD_2_2B63DE2921807645_OFFSET))(this, a1);
	}

	::System::Void Method_2_5B0531D5B96D6B96(::Class_0_16E4307DCC419505_347* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_347*))((::PBYTE)hIl2Cpp + CLASS_2_9BF942986572420B_METHOD_2_5B0531D5B96D6B96_OFFSET))(this, a1);
	}

	::System::Void Method_2_EDB0D8DA4A269034(::Class_0_16E4307DCC419505_347* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_347*))((::PBYTE)hIl2Cpp + CLASS_2_9BF942986572420B_METHOD_2_EDB0D8DA4A269034_OFFSET))(this, a1);
	}
