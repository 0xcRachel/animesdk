...
#define CLASS_1_5B567C8A01BAEDFE_30_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A2D6F80)
#define CLASS_1_5B567C8A01BAEDFE_30_CLONE_OFFSET UNITYSDK_OFFSET(0x1A2D6DF0)
#define CLASS_1_5B567C8A01BAEDFE_30_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A2D6E90)
#define CLASS_1_5B567C8A01BAEDFE_30_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A2D6E30)
#define CLASS_1_5B567C8A01BAEDFE_30_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A2D6EE0)
#define CLASS_1_5B567C8A01BAEDFE_30_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A2D6FD0)
#define CLASS_1_5B567C8A01BAEDFE_30_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A2D6FA0)
#define CLASS_1_5B567C8A01BAEDFE_30_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A2D6D70)
#define CLASS_1_5B567C8A01BAEDFE_30_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A2D6DA0)
#define CLASS_1_5B567C8A01BAEDFE_30_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A2D6F10)
#define CLASS_1_5B567C8A01BAEDFE_30_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A2D6F70)
#define CLASS_1_5B567C8A01BAEDFE_30__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A2D7020)
#define CLASS_1_5B567C8A01BAEDFE_30__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A2D6DC0)
#define CLASS_1_5B567C8A01BAEDFE_30__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2D6DB0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_30*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_30_TypeDefinitionIndex)->GetStaticField(0x3B120);
	}
