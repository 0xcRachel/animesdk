...
#define CLASS_1_5B567C8A01BAEDFE_134_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A2CEE30)
#define CLASS_1_5B567C8A01BAEDFE_134_CLONE_OFFSET UNITYSDK_OFFSET(0x1A2CEC40)
#define CLASS_1_5B567C8A01BAEDFE_134_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A2CED40)
#define CLASS_1_5B567C8A01BAEDFE_134_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A2CECB0)
#define CLASS_1_5B567C8A01BAEDFE_134_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A2CED90)
#define CLASS_1_5B567C8A01BAEDFE_134_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A2CEE80)
#define CLASS_1_5B567C8A01BAEDFE_134_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A2CEE50)
#define CLASS_1_5B567C8A01BAEDFE_134_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A2CEB90)
#define CLASS_1_5B567C8A01BAEDFE_134_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A2CEBF0)
#define CLASS_1_5B567C8A01BAEDFE_134_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A2CEDC0)
#define CLASS_1_5B567C8A01BAEDFE_134_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A2CEE20)
#define CLASS_1_5B567C8A01BAEDFE_134__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A2CEED0)
#define CLASS_1_5B567C8A01BAEDFE_134__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A2CEC10)
#define CLASS_1_5B567C8A01BAEDFE_134__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2CEC00)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_134*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_134_TypeDefinitionIndex)->GetStaticField(0x3A4A0);
	}
