...
#define PROTO_HELIOBUSCHALLENGELINEUP_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x197633B0)
#define PROTO_HELIOBUSCHALLENGELINEUP_CLONE_OFFSET UNITYSDK_OFFSET(0x19762FB0)
#define PROTO_HELIOBUSCHALLENGELINEUP_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x197630E0)
#define PROTO_HELIOBUSCHALLENGELINEUP_EQUALS_OFFSET UNITYSDK_OFFSET(0x19763030)
#define PROTO_HELIOBUSCHALLENGELINEUP_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19763180)
#define PROTO_HELIOBUSCHALLENGELINEUP_GET_AVATARIDLIST_OFFSET UNITYSDK_OFFSET(0x19762FE0)
#define PROTO_HELIOBUSCHALLENGELINEUP_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x19762FF0)
#define PROTO_HELIOBUSCHALLENGELINEUP_GET_PARSER_OFFSET UNITYSDK_OFFSET(0x19762E90)
#define PROTO_HELIOBUSCHALLENGELINEUP_GET_SKILLID_OFFSET UNITYSDK_OFFSET(0x19763010)
#define PROTO_HELIOBUSCHALLENGELINEUP_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19763580)
#define PROTO_HELIOBUSCHALLENGELINEUP_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19763520)
#define PROTO_HELIOBUSCHALLENGELINEUP_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19762EC0)
#define PROTO_HELIOBUSCHALLENGELINEUP_SET_GROUPID_OFFSET UNITYSDK_OFFSET(0x19763000)
#define PROTO_HELIOBUSCHALLENGELINEUP_SET_SKILLID_OFFSET UNITYSDK_OFFSET(0x19763020)
#define PROTO_HELIOBUSCHALLENGELINEUP_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19763280)
#define PROTO_HELIOBUSCHALLENGELINEUP_WRITETO_OFFSET UNITYSDK_OFFSET(0x197632E0)
#define PROTO_HELIOBUSCHALLENGELINEUP__CCTOR_OFFSET UNITYSDK_OFFSET(0x19763650)
#define PROTO_HELIOBUSCHALLENGELINEUP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19762F20)
#define PROTO_HELIOBUSCHALLENGELINEUP__CTOR_OFFSET UNITYSDK_OFFSET(0x19762ED0)
...
namespace Proto
{
	...
	public:
		...
		{
			return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(HeliobusChallengeLineup_TypeDefinitionIndex)->GetStaticField(0x4C130);
		}
		static ::Google::Protobuf::MessageParser_1<::Proto::HeliobusChallengeLineup*>** StaticGet__parser()
		{
			return (::Google::Protobuf::MessageParser_1<::Proto::HeliobusChallengeLineup*>**)Il2CppClass::FromTypeDefinitionIndex(HeliobusChallengeLineup_TypeDefinitionIndex)->GetStaticField(0x4C138);
		}
