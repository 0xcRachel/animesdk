...
#define PROTO_ROTATIONMAPINFOSNAPSHOT___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AB0C800)
#define PROTO_ROTATIONMAPINFOSNAPSHOT___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB0C840)
#define PROTO_ROTATIONMAPINFOSNAPSHOT___C___CCTOR_B__28_0_OFFSET UNITYSDK_OFFSET(0x1AB0C850)
...
namespace Proto
{
	...
	public:
		...
		{
			return (::Proto::RotationMapInfoSnapshot___c**)Il2CppClass::FromTypeDefinitionIndex(RotationMapInfoSnapshot___c_TypeDefinitionIndex)->GetStaticField(0x3EEF0);
		}
