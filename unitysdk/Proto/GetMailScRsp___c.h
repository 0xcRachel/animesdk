...
#define PROTO_GETMAILSCRSP___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1975C560)
#define PROTO_GETMAILSCRSP___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1975C590)
#define PROTO_GETMAILSCRSP___C___CCTOR_B__48_0_OFFSET UNITYSDK_OFFSET(0x1975C5A0)
...
namespace Proto
{
	...
	public:
		...
		{
			return (::Proto::GetMailScRsp___c**)Il2CppClass::FromTypeDefinitionIndex(GetMailScRsp___c_TypeDefinitionIndex)->GetStaticField(0x4B8B0);
		}
