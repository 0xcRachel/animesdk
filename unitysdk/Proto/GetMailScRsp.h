...
#define PROTO_GETMAILSCRSP_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17A80760)
#define PROTO_GETMAILSCRSP_CLONE_OFFSET UNITYSDK_OFFSET(0x17A80170)
#define PROTO_GETMAILSCRSP_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17A80270)
#define PROTO_GETMAILSCRSP_EQUALS_OFFSET UNITYSDK_OFFSET(0x17A80240)
#define PROTO_GETMAILSCRSP_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17A80380)
#define PROTO_GETMAILSCRSP_GET_ISEND_OFFSET UNITYSDK_OFFSET(0x17A80220)
#define PROTO_GETMAILSCRSP_GET_MAILLIST_OFFSET UNITYSDK_OFFSET(0x17A801A0)
#define PROTO_GETMAILSCRSP_GET_NOTICEMAILLIST_OFFSET UNITYSDK_OFFSET(0x17A801F0)
#define PROTO_GETMAILSCRSP_GET_RETCODE_OFFSET UNITYSDK_OFFSET(0x17A801B0)
#define PROTO_GETMAILSCRSP_GET_START_OFFSET UNITYSDK_OFFSET(0x17A801D0)
#define PROTO_GETMAILSCRSP_GET_TOTALNUM_OFFSET UNITYSDK_OFFSET(0x17A80200)
#define PROTO_GETMAILSCRSP_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x17A80B10)
#define PROTO_GETMAILSCRSP_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x17A809E0)
#define PROTO_GETMAILSCRSP_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17A80010)
#define PROTO_GETMAILSCRSP_SET_ISEND_OFFSET UNITYSDK_OFFSET(0x17A80230)
#define PROTO_GETMAILSCRSP_SET_RETCODE_OFFSET UNITYSDK_OFFSET(0x17A801C0)
#define PROTO_GETMAILSCRSP_SET_START_OFFSET UNITYSDK_OFFSET(0x17A801E0)
#define PROTO_GETMAILSCRSP_SET_TOTALNUM_OFFSET UNITYSDK_OFFSET(0x17A80210)
#define PROTO_GETMAILSCRSP_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17A80540)
#define PROTO_GETMAILSCRSP_WRITETO_OFFSET UNITYSDK_OFFSET(0x17A805A0)
#define PROTO_GETMAILSCRSP__CCTOR_OFFSET UNITYSDK_OFFSET(0x17A80C60)
#define PROTO_GETMAILSCRSP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17A80080)
#define PROTO_GETMAILSCRSP__CTOR_OFFSET UNITYSDK_OFFSET(0x17A80020)

namespace Proto
{
	inline static constexpr unsigned int GetMailScRsp_TypeDefinitionIndex = 24617;
	...
	public:
		...
		{
			return (::Google::Protobuf::FieldCodec_1<::Proto::ClientMail*>**)Il2CppClass::FromTypeDefinitionIndex(GetMailScRsp_TypeDefinitionIndex)->GetStaticField(0x1AE90);
		}
		static ::Google::Protobuf::FieldCodec_1<::Proto::ClientMail*>** StaticGet__repeated_noticeMailList_codec()
		{
			return (::Google::Protobuf::FieldCodec_1<::Proto::ClientMail*>**)Il2CppClass::FromTypeDefinitionIndex(GetMailScRsp_TypeDefinitionIndex)->GetStaticField(0x1AE98);
		}
		// static const ::System::Int32 MailListFieldNumber = 0x1; // 0x0
		// static const ::System::Int32 RetcodeFieldNumber = 0xB; // 0x0
		// static const ::System::Int32 StartFieldNumber = 0xE; // 0x0
		// static const ::System::Int32 NoticeMailListFieldNumber = 0x5; // 0x0
		// static const ::System::Int32 TotalNumFieldNumber = 0x2; // 0x0
