...
#define PROTO_PLAYERSIMPLEINFO___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A58A0E0)
#define PROTO_PLAYERSIMPLEINFO___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1A58A120)
#define PROTO_PLAYERSIMPLEINFO___C___CCTOR_B__108_0_OFFSET UNITYSDK_OFFSET(0x1A58A130)
...
namespace Proto
{
	...
	public:
		...
		{
			return (::Proto::PlayerSimpleInfo___c**)Il2CppClass::FromTypeDefinitionIndex(PlayerSimpleInfo___c_TypeDefinitionIndex)->GetStaticField(0x4E040);
		}
