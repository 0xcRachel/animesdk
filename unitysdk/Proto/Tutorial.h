...
#define PROTO_TUTORIAL_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A597690)
#define PROTO_TUTORIAL_CLONE_OFFSET UNITYSDK_OFFSET(0x1A597410)
#define PROTO_TUTORIAL_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A597510)
#define PROTO_TUTORIAL_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A5974A0)
#define PROTO_TUTORIAL_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A597570)
#define PROTO_TUTORIAL_GET_ID_OFFSET UNITYSDK_OFFSET(0x1A597480)
#define PROTO_TUTORIAL_GET_PARSER_OFFSET UNITYSDK_OFFSET(0x1A597390)
#define PROTO_TUTORIAL_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x1A597460)
#define PROTO_TUTORIAL_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A597820)
#define PROTO_TUTORIAL_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A5977E0)
#define PROTO_TUTORIAL_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A5973C0)
#define PROTO_TUTORIAL_SET_ID_OFFSET UNITYSDK_OFFSET(0x1A597490)
#define PROTO_TUTORIAL_SET_STATUS_OFFSET UNITYSDK_OFFSET(0x1A597470)
#define PROTO_TUTORIAL_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A5975A0)
#define PROTO_TUTORIAL_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A597600)
#define PROTO_TUTORIAL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A5978A0)
#define PROTO_TUTORIAL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A5973E0)
#define PROTO_TUTORIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5973D0)
...
namespace Proto
{
	...
	public:
		...
		{
			return (::Google::Protobuf::MessageParser_1<::Proto::Tutorial*>**)Il2CppClass::FromTypeDefinitionIndex(Tutorial_TypeDefinitionIndex)->GetStaticField(0x4D540);
		}
