...
#define PROTO_SHOP_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1AB11590)
#define PROTO_SHOP_CLONE_OFFSET UNITYSDK_OFFSET(0x1AB11000)
#define PROTO_SHOP_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1AB11130)
#define PROTO_SHOP_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AB11100)
#define PROTO_SHOP_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AB11230)
#define PROTO_SHOP_GET_BEGINTIME_OFFSET UNITYSDK_OFFSET(0x1AB110A0)
#define PROTO_SHOP_GET_CITYEXP_OFFSET UNITYSDK_OFFSET(0x1AB11070)
#define PROTO_SHOP_GET_CITYLEVEL_OFFSET UNITYSDK_OFFSET(0x1AB11030)
#define PROTO_SHOP_GET_CITYTAKENLEVELREWARD_OFFSET UNITYSDK_OFFSET(0x1AB110C0)
#define PROTO_SHOP_GET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x1AB110E0)
#define PROTO_SHOP_GET_GOODSLIST_OFFSET UNITYSDK_OFFSET(0x1AB11090)
#define PROTO_SHOP_GET_PARSER_OFFSET UNITYSDK_OFFSET(0x1AB10ED0)
#define PROTO_SHOP_GET_SHOPID_OFFSET UNITYSDK_OFFSET(0x1AB11050)
#define PROTO_SHOP_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1AB11AE0)
#define PROTO_SHOP_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1AB119F0)
#define PROTO_SHOP_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1AB10F00)
#define PROTO_SHOP_SET_BEGINTIME_OFFSET UNITYSDK_OFFSET(0x1AB110B0)
#define PROTO_SHOP_SET_CITYEXP_OFFSET UNITYSDK_OFFSET(0x1AB11080)
#define PROTO_SHOP_SET_CITYLEVEL_OFFSET UNITYSDK_OFFSET(0x1AB11040)
#define PROTO_SHOP_SET_CITYTAKENLEVELREWARD_OFFSET UNITYSDK_OFFSET(0x1AB110D0)
#define PROTO_SHOP_SET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x1AB110F0)
#define PROTO_SHOP_SET_SHOPID_OFFSET UNITYSDK_OFFSET(0x1AB11060)
#define PROTO_SHOP_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AB11380)
#define PROTO_SHOP_WRITETO_OFFSET UNITYSDK_OFFSET(0x1AB113E0)
#define PROTO_SHOP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AB11C40)
#define PROTO_SHOP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AB10F50)
#define PROTO_SHOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB10F10)
...
namespace Proto
{
	...
	public:
		...
		{
			return (::Google::Protobuf::MessageParser_1<::Proto::Shop*>**)Il2CppClass::FromTypeDefinitionIndex(Shop_TypeDefinitionIndex)->GetStaticField(0x26620);
		}
		static ::Google::Protobuf::FieldCodec_1<::Proto::Goods*>** StaticGet__repeated_goodsList_codec()
		{
			return (::Google::Protobuf::FieldCodec_1<::Proto::Goods*>**)Il2CppClass::FromTypeDefinitionIndex(Shop_TypeDefinitionIndex)->GetStaticField(0x26628);
		}
		...
		::System::UInt32 cityExp_; // 0x28
		::System::UInt64 cityTakenLevelReward_; // 0x30
