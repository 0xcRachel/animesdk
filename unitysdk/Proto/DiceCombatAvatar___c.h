...
#define PROTO_DICECOMBATAVATAR___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x19E3A9F0)
#define PROTO_DICECOMBATAVATAR___C__CTOR_OFFSET UNITYSDK_OFFSET(0x19E3AA20)
#define PROTO_DICECOMBATAVATAR___C___CCTOR_B__38_0_OFFSET UNITYSDK_OFFSET(0x19E3AA30)
...
namespace Proto
{
	...
	public:
		...
		{
			return (::Proto::DiceCombatAvatar___c**)Il2CppClass::FromTypeDefinitionIndex(DiceCombatAvatar___c_TypeDefinitionIndex)->GetStaticField(0x4A850);
		}
