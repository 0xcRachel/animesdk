...
#define PROTO_ITEM_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17A87490)
#define PROTO_ITEM_CLONE_OFFSET UNITYSDK_OFFSET(0x17A87040)
#define PROTO_ITEM_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17A87210)
#define PROTO_ITEM_EQUALS_OFFSET UNITYSDK_OFFSET(0x17A87170)
#define PROTO_ITEM_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17A872A0)
#define PROTO_ITEM_GET_ITEMID_OFFSET UNITYSDK_OFFSET(0x17A87150)
#define PROTO_ITEM_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x17A87130)
#define PROTO_ITEM_GET_MAINAFFIXID_OFFSET UNITYSDK_OFFSET(0x17A87110)
#define PROTO_ITEM_GET_NUM_OFFSET UNITYSDK_OFFSET(0x17A870D0)
#define PROTO_ITEM_GET_PROMOTION_OFFSET UNITYSDK_OFFSET(0x17A870B0)
#define PROTO_ITEM_GET_RANK_OFFSET UNITYSDK_OFFSET(0x17A870F0)
#define PROTO_ITEM_GET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0x17A87090)
#define PROTO_ITEM_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x17A87880)
#define PROTO_ITEM_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x17A87810)
#define PROTO_ITEM_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17A86FE0)
#define PROTO_ITEM_SET_ITEMID_OFFSET UNITYSDK_OFFSET(0x17A87160)
#define PROTO_ITEM_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x17A87140)
#define PROTO_ITEM_SET_MAINAFFIXID_OFFSET UNITYSDK_OFFSET(0x17A87120)
#define PROTO_ITEM_SET_NUM_OFFSET UNITYSDK_OFFSET(0x17A870E0)
#define PROTO_ITEM_SET_PROMOTION_OFFSET UNITYSDK_OFFSET(0x17A870C0)
#define PROTO_ITEM_SET_RANK_OFFSET UNITYSDK_OFFSET(0x17A87100)
#define PROTO_ITEM_SET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0x17A870A0)
#define PROTO_ITEM_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17A872E0)
#define PROTO_ITEM_WRITETO_OFFSET UNITYSDK_OFFSET(0x17A87340)
#define PROTO_ITEM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17A87000)
#define PROTO_ITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x17A86FF0)

namespace Proto
{
	inline static constexpr unsigned int Item_TypeDefinitionIndex = 23394;

	class Item : public ::System::Object
	{
	public:
		// static const ::System::Int32 UniqueIdFieldNumber = 0xA; // 0x0
		// static const ::System::Int32 PromotionFieldNumber = 0x9; // 0x0
		// static const ::System::Int32 NumFieldNumber = 0x6; // 0x0
		// static const ::System::Int32 RankFieldNumber = 0x7; // 0x0
		// static const ::System::Int32 MainAffixIdFieldNumber = 0xB; // 0x0
