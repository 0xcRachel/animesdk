...
#define PROTO_GETTUTORIALSCRSP___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x197611C0)
#define PROTO_GETTUTORIALSCRSP___C__CTOR_OFFSET UNITYSDK_OFFSET(0x197611F0)
#define PROTO_GETTUTORIALSCRSP___C___CCTOR_B__28_0_OFFSET UNITYSDK_OFFSET(0x19761200)
...
namespace Proto
{
	...
	public:
		...
		{
			return (::Proto::GetTutorialScRsp___c**)Il2CppClass::FromTypeDefinitionIndex(GetTutorialScRsp___c_TypeDefinitionIndex)->GetStaticField(0x4BE80);
		}
