...
#define PROTO_PILEITEM_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x197709D0)
#define PROTO_PILEITEM_CLONE_OFFSET UNITYSDK_OFFSET(0x19764590)
#define PROTO_PILEITEM_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19770890)
#define PROTO_PILEITEM_EQUALS_OFFSET UNITYSDK_OFFSET(0x19770820)
#define PROTO_PILEITEM_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19764C20)
#define PROTO_PILEITEM_GET_ITEMID_OFFSET UNITYSDK_OFFSET(0x19770800)
#define PROTO_PILEITEM_GET_ITEMNUM_OFFSET UNITYSDK_OFFSET(0x197707E0)
#define PROTO_PILEITEM_GET_PARSER_OFFSET UNITYSDK_OFFSET(0x19770770)
#define PROTO_PILEITEM_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19770AE0)
#define PROTO_PILEITEM_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19765350)
#define PROTO_PILEITEM_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x197707A0)
#define PROTO_PILEITEM_SET_ITEMID_OFFSET UNITYSDK_OFFSET(0x19770810)
#define PROTO_PILEITEM_SET_ITEMNUM_OFFSET UNITYSDK_OFFSET(0x197707F0)
#define PROTO_PILEITEM_TOSTRING_OFFSET UNITYSDK_OFFSET(0x197708F0)
#define PROTO_PILEITEM_WRITETO_OFFSET UNITYSDK_OFFSET(0x19770950)
#define PROTO_PILEITEM__CCTOR_OFFSET UNITYSDK_OFFSET(0x19770B60)
#define PROTO_PILEITEM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x197707B0)
#define PROTO_PILEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x19765340)
...
namespace Proto
{
	...
	public:
		...
		{
			return (::Google::Protobuf::MessageParser_1<::Proto::PileItem*>**)Il2CppClass::FromTypeDefinitionIndex(PileItem_TypeDefinitionIndex)->GetStaticField(0x7960);
		}
