...
#define PROTO_PILEITEM___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x19770C40)
#define PROTO_PILEITEM___C__CTOR_OFFSET UNITYSDK_OFFSET(0x19770C70)
#define PROTO_PILEITEM___C___CCTOR_B__28_0_OFFSET UNITYSDK_OFFSET(0x19770C80)
...
namespace Proto
{
	...
	public:
		...
		{
			return (::Proto::PileItem___c**)Il2CppClass::FromTypeDefinitionIndex(PileItem___c_TypeDefinitionIndex)->GetStaticField(0x4D3B0);
		}
