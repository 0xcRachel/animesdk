...
#define PROTO_SHOP___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A5929B0)
#define PROTO_SHOP___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5929E0)
#define PROTO_SHOP___C___CCTOR_B__53_0_OFFSET UNITYSDK_OFFSET(0x1A5929F0)
...
namespace Proto
{
	...
	public:
		...
		{
			return (::Proto::Shop___c**)Il2CppClass::FromTypeDefinitionIndex(Shop___c_TypeDefinitionIndex)->GetStaticField(0x4E9D0);
		}
