...
#define PROTO_GOODS_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x18298A70)
#define PROTO_GOODS_CLONE_OFFSET UNITYSDK_OFFSET(0x182986A0)
#define PROTO_GOODS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x18298830)
#define PROTO_GOODS_EQUALS_OFFSET UNITYSDK_OFFSET(0x182987A0)
#define PROTO_GOODS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x182988B0)
#define PROTO_GOODS_GET_BEGINTIME_OFFSET UNITYSDK_OFFSET(0x18298760)
#define PROTO_GOODS_GET_BUYTIMES_OFFSET UNITYSDK_OFFSET(0x18298740)
#define PROTO_GOODS_GET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x18298780)
#define PROTO_GOODS_GET_GOODSID_OFFSET UNITYSDK_OFFSET(0x18298720)
#define PROTO_GOODS_GET_ITEMID_OFFSET UNITYSDK_OFFSET(0x18298700)
#define PROTO_GOODS_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x18298E00)
#define PROTO_GOODS_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x18298DA0)
#define PROTO_GOODS_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x18298630)
#define PROTO_GOODS_SET_BEGINTIME_OFFSET UNITYSDK_OFFSET(0x18298770)
#define PROTO_GOODS_SET_BUYTIMES_OFFSET UNITYSDK_OFFSET(0x18298750)
#define PROTO_GOODS_SET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x18298790)
#define PROTO_GOODS_SET_GOODSID_OFFSET UNITYSDK_OFFSET(0x18298730)
#define PROTO_GOODS_SET_ITEMID_OFFSET UNITYSDK_OFFSET(0x18298710)
#define PROTO_GOODS_TOSTRING_OFFSET UNITYSDK_OFFSET(0x18298910)
#define PROTO_GOODS_WRITETO_OFFSET UNITYSDK_OFFSET(0x18298970)
#define PROTO_GOODS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18298650)
#define PROTO_GOODS__CTOR_OFFSET UNITYSDK_OFFSET(0x18298640)
