...
#define PROTO_GOODS_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17A853E0)
#define PROTO_GOODS_CLONE_OFFSET UNITYSDK_OFFSET(0x17A85020)
#define PROTO_GOODS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17A851A0)
#define PROTO_GOODS_EQUALS_OFFSET UNITYSDK_OFFSET(0x17A85110)
#define PROTO_GOODS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17A85220)
#define PROTO_GOODS_GET_BEGINTIME_OFFSET UNITYSDK_OFFSET(0x17A850D0)
#define PROTO_GOODS_GET_BUYTIMES_OFFSET UNITYSDK_OFFSET(0x17A85070)
#define PROTO_GOODS_GET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x17A850F0)
#define PROTO_GOODS_GET_GOODSID_OFFSET UNITYSDK_OFFSET(0x17A85090)
#define PROTO_GOODS_GET_ITEMID_OFFSET UNITYSDK_OFFSET(0x17A850B0)
#define PROTO_GOODS_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x17A85770)
#define PROTO_GOODS_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x17A85710)
#define PROTO_GOODS_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17A84FC0)
#define PROTO_GOODS_SET_BEGINTIME_OFFSET UNITYSDK_OFFSET(0x17A850E0)
#define PROTO_GOODS_SET_BUYTIMES_OFFSET UNITYSDK_OFFSET(0x17A85080)
#define PROTO_GOODS_SET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x17A85100)
#define PROTO_GOODS_SET_GOODSID_OFFSET UNITYSDK_OFFSET(0x17A850A0)
#define PROTO_GOODS_SET_ITEMID_OFFSET UNITYSDK_OFFSET(0x17A850C0)
#define PROTO_GOODS_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17A85280)
#define PROTO_GOODS_WRITETO_OFFSET UNITYSDK_OFFSET(0x17A852E0)
#define PROTO_GOODS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17A84FE0)
#define PROTO_GOODS__CTOR_OFFSET UNITYSDK_OFFSET(0x17A84FD0)

namespace Proto
{
	inline static constexpr unsigned int Goods_TypeDefinitionIndex = 26411;

	class Goods : public ::System::Object
	{
	public:
		// static const ::System::Int32 BuyTimesFieldNumber = 0x2; // 0x0
		// static const ::System::Int32 GoodsIdFieldNumber = 0x3; // 0x0
		// static const ::System::Int32 ItemIdFieldNumber = 0x8; // 0x0
		// static const ::System::Int32 BeginTimeFieldNumber = 0xE; // 0x0
