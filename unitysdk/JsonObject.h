...
#define JSONOBJECT_GETBOOL_OFFSET UNITYSDK_OFFSET(0x164356A0)
#define JSONOBJECT_GETCMD_OFFSET UNITYSDK_OFFSET(0x16435390)
#define JSONOBJECT_GETDICTVALUE_OFFSET UNITYSDK_OFFSET(0x16435400)
#define JSONOBJECT_GETENUM_OFFSET UNITYSDK_OFFSET(0x16435A60)
#define JSONOBJECT_GETFLOAT_OFFSET UNITYSDK_OFFSET(0x164358A0)
#define JSONOBJECT_GETINT_OFFSET UNITYSDK_OFFSET(0x164357A0)
#define JSONOBJECT_GETJSONDICT_OFFSET UNITYSDK_OFFSET(0x16435520)
#define JSONOBJECT_GETJSONOBJECT_OFFSET UNITYSDK_OFFSET(0x16435650)
#define JSONOBJECT_GETLISTJSONOBJECT_OFFSET UNITYSDK_OFFSET(0x16435BC0)
#define JSONOBJECT_GETSTRING_OFFSET UNITYSDK_OFFSET(0x164359A0)
#define JSONOBJECT_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x164352F0)
#define JSONOBJECT_KEYEXIST_OFFSET UNITYSDK_OFFSET(0x164354A0)
#define JSONOBJECT_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x164353E0)
#define JSONOBJECT_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x16435320)
#define JSONOBJECT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x16435270)
#define JSONOBJECT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x164352E0)
#define JSONOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x164351F0)
