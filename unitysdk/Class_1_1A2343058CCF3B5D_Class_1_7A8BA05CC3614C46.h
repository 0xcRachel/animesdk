...
#define CLASS_1_1A2343058CCF3B5D_CLASS_1_7A8BA05CC3614C46_CLEAR_OFFSET UNITYSDK_OFFSET(0xE591C10)
#define CLASS_1_1A2343058CCF3B5D_CLASS_1_7A8BA05CC3614C46_METHOD_1_D978819B0A4871A0_OFFSET UNITYSDK_OFFSET(0xE591650)
#define CLASS_1_1A2343058CCF3B5D_CLASS_1_7A8BA05CC3614C46__CTOR_OFFSET UNITYSDK_OFFSET(0xE591C60)
...
{
public:
	::RPG::GameCore::LevelLittleGameInfo* Field_1_1; // 0x10
