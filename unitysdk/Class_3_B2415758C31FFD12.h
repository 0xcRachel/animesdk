...
#define CLASS_3_B2415758C31FFD12_EVALUATE_OFFSET UNITYSDK_OFFSET(0x84FECA0)
#define CLASS_3_B2415758C31FFD12__CTOR_OFFSET UNITYSDK_OFFSET(0x84FEC70)

inline static constexpr unsigned int Class_3_B2415758C31FFD12_TypeDefinitionIndex = 42492;
