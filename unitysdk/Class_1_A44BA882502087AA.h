...
#define CLASS_1_A44BA882502087AA_GET_FACESIZE_OFFSET UNITYSDK_OFFSET(0x14A60700)
#define CLASS_1_A44BA882502087AA_GET_FOGS_OFFSET UNITYSDK_OFFSET(0x14A60720)
#define CLASS_1_A44BA882502087AA_GET_SECTIONS_OFFSET UNITYSDK_OFFSET(0x14A606E0)
#define CLASS_1_A44BA882502087AA_GET_SECTIONVERTICES_OFFSET UNITYSDK_OFFSET(0x14A606C0)
#define CLASS_1_A44BA882502087AA_METHOD_1_8A5692253C0897D8_OFFSET UNITYSDK_OFFSET(0x14A60180)
#define CLASS_1_A44BA882502087AA_SET_FACESIZE_OFFSET UNITYSDK_OFFSET(0x14A60710)
#define CLASS_1_A44BA882502087AA_SET_FOGS_OFFSET UNITYSDK_OFFSET(0x14A60730)
#define CLASS_1_A44BA882502087AA_SET_SECTIONS_OFFSET UNITYSDK_OFFSET(0x14A606F0)
#define CLASS_1_A44BA882502087AA_SET_SECTIONVERTICES_OFFSET UNITYSDK_OFFSET(0x14A606D0)
#define CLASS_1_A44BA882502087AA__CTOR_OFFSET UNITYSDK_OFFSET(0x14A60680)

inline static constexpr unsigned int Class_1_A44BA882502087AA_TypeDefinitionIndex = 69711;

class Class_1_A44BA882502087AA : public ::System::Object
{
public:
	::Il2CppArray<::RPG::MVector2>* _SectionVertices_k__BackingField; // 0x10
	::System::Collections::Generic::List_1<::RPG::Client::NavMap::FiveDim::SectionConfig*>* _Sections_k__BackingField; // 0x18
