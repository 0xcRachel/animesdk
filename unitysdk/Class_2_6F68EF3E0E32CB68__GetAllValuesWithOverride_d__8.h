...
#define CLASS_2_6F68EF3E0E32CB68__GETALLVALUESWITHOVERRIDE_D__8_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x15BD2D00)
#define CLASS_2_6F68EF3E0E32CB68__GETALLVALUESWITHOVERRIDE_D__8_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_COLLECTIONS_GENERIC_KEYVALUEPAIR_RPG_GAMECORE_STRINGHASH_RPG_GAMECORE_FIXPOINT___GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x15BD31E0)
#define CLASS_2_6F68EF3E0E32CB68__GETALLVALUESWITHOVERRIDE_D__8_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_COLLECTIONS_GENERIC_KEYVALUEPAIR_RPG_GAMECORE_STRINGHASH_RPG_GAMECORE_FIXPOINT___GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x15BD3130)
#define CLASS_2_6F68EF3E0E32CB68__GETALLVALUESWITHOVERRIDE_D__8_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x15BD3260)
#define CLASS_2_6F68EF3E0E32CB68__GETALLVALUESWITHOVERRIDE_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x15BD3190)
#define CLASS_2_6F68EF3E0E32CB68__GETALLVALUESWITHOVERRIDE_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x15BD3140)
#define CLASS_2_6F68EF3E0E32CB68__GETALLVALUESWITHOVERRIDE_D__8_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15BD2CE0)
#define CLASS_2_6F68EF3E0E32CB68__GETALLVALUESWITHOVERRIDE_D__8__CTOR_OFFSET UNITYSDK_OFFSET(0x15BD2BC0)
#define CLASS_2_6F68EF3E0E32CB68__GETALLVALUESWITHOVERRIDE_D__8___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x15BD2CF0)
...
{
public:
	::System::Collections::Generic::Dictionary_2_Enumerator<::RPG::GameCore::StringHash, ::Class_1_1C30CE192ABE4C54_Class_0_16E7307DCC43CB2C_1*> __7__wrap1; // 0x10
	::Class_2_6F68EF3E0E32CB68* __4__this; // 0x38
	::System::Collections::Generic::KeyValuePair_2<::RPG::GameCore::StringHash, ::RPG::GameCore::FixPoint> __2__current; // 0x40
	::System::Int32 __1__state; // 0x50
	::RPG::GameCore::StringHash _key_5__3; // 0x54
