...
#define CLASS_1_C96FC73F1B756C65_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A348970)
#define CLASS_1_C96FC73F1B756C65_CLONE_OFFSET UNITYSDK_OFFSET(0x1A3484E0)
#define CLASS_1_C96FC73F1B756C65_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A348640)
#define CLASS_1_C96FC73F1B756C65_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A348580)
#define CLASS_1_C96FC73F1B756C65_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A3486F0)
#define CLASS_1_C96FC73F1B756C65_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A348B40)
#define CLASS_1_C96FC73F1B756C65_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A348AE0)
#define CLASS_1_C96FC73F1B756C65_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1A348550)
#define CLASS_1_C96FC73F1B756C65_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1A348510)
#define CLASS_1_C96FC73F1B756C65_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1A348570)
#define CLASS_1_C96FC73F1B756C65_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A3483B0)
#define CLASS_1_C96FC73F1B756C65_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1A348560)
#define CLASS_1_C96FC73F1B756C65_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1A348520)
#define CLASS_1_C96FC73F1B756C65_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1A348540)
#define CLASS_1_C96FC73F1B756C65_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1A348530)
#define CLASS_1_C96FC73F1B756C65_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A3483E0)
#define CLASS_1_C96FC73F1B756C65_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A348810)
#define CLASS_1_C96FC73F1B756C65_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A348870)
#define CLASS_1_C96FC73F1B756C65__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A348C30)
#define CLASS_1_C96FC73F1B756C65__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A348440)
#define CLASS_1_C96FC73F1B756C65__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3483F0)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_C96FC73F1B756C65_TypeDefinitionIndex)->GetStaticField(0x2D3E0);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_C96FC73F1B756C65*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_C96FC73F1B756C65*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_C96FC73F1B756C65_TypeDefinitionIndex)->GetStaticField(0x2D3E8);
	}
