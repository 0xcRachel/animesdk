...
#define CLASS_2_D1390195BD020876_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xF96A4E0)
#define CLASS_2_D1390195BD020876_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xF96A6F0)
#define CLASS_2_D1390195BD020876_METHOD_2_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xF968C90)
#define CLASS_2_D1390195BD020876_METHOD_2_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0xF96ACC0)
#define CLASS_2_D1390195BD020876_METHOD_2_5790A55946AA509D_2_OFFSET UNITYSDK_OFFSET(0xF96AD20)
#define CLASS_2_D1390195BD020876_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xF96AC60)
#define CLASS_2_D1390195BD020876_METHOD_2_6F90F99189EFF687_OFFSET UNITYSDK_OFFSET(0xF969810)
#define CLASS_2_D1390195BD020876_METHOD_2_85377D41FEE05B66_OFFSET UNITYSDK_OFFSET(0xF968E00)
#define CLASS_2_D1390195BD020876_METHOD_2_B961D33AD47A2113_OFFSET UNITYSDK_OFFSET(0xF9689D0)
#define CLASS_2_D1390195BD020876_METHOD_2_D8E44F7C510402BB_1_OFFSET UNITYSDK_OFFSET(0xF96A210)
#define CLASS_2_D1390195BD020876_METHOD_2_D8E44F7C510402BB_OFFSET UNITYSDK_OFFSET(0xF96A050)
#define CLASS_2_D1390195BD020876_METHOD_2_F37CDBD6D46274D2_1_OFFSET UNITYSDK_OFFSET(0xF969FD0)
#define CLASS_2_D1390195BD020876_METHOD_2_F37CDBD6D46274D2_2_OFFSET UNITYSDK_OFFSET(0xF96A3D0)
#define CLASS_2_D1390195BD020876_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0xF969F50)
#define CLASS_2_D1390195BD020876__CTOR_OFFSET UNITYSDK_OFFSET(0xF96A8C0)
#define CLASS_2_D1390195BD020876__ONBIND_OFFSET UNITYSDK_OFFSET(0xF968050)
#define CLASS_2_D1390195BD020876___IFIXBASEPROXY_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xF96AD80)
#define CLASS_2_D1390195BD020876___IFIXBASEPROXY_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xF96ADE0)
#define CLASS_2_D1390195BD020876___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0xF96AC00)

inline static constexpr unsigned int Class_2_D1390195BD020876_TypeDefinitionIndex = 66427;

class Class_2_D1390195BD020876 : public ::Class_1_CA217ABF4E3B4F3F
{
public:
	::RPG::Client::ActivityFeverTimePileToast* Field_2_9; // 0x60
	::System::String* Field_2_22; // 0x68
	::UnityEngine::UI::Button* Field_2_0; // 0x70
	::UnityEngine::Transform* Field_2_6; // 0x78
	::UnityEngine::Transform* Field_2_8; // 0x80
	::System::String* Field_2_23; // 0x88
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::FeverTimePeriodType, ::UnityEngine::UI::SmoothMask*>* Field_2_14; // 0x90
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::FeverTimePeriodType, ::UnityEngine::Animation*>* Field_2_16; // 0x98
	::UnityEngine::UI::Button* Field_2_2; // 0xA0
	::UnityEngine::Transform* Field_2_10; // 0xA8
	::UnityEngine::Animator* Field_2_4; // 0xB0
	::UnityEngine::UI::Text* Field_2_5; // 0xB8
	::UnityEngine::UI::Button* Field_2_3; // 0xC0
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::FeverTimePeriodType, ::UnityEngine::Transform*>* Field_2_13; // 0xC8
	::RPG::GameCore::LevelUIComponent* Field_2_24; // 0xD0
	::UnityEngine::Animation* Field_2_7; // 0xD8
	::UnityEngine::UI::Text* Field_2_12; // 0xE0
	::UnityEngine::UI::Button* Field_2_1; // 0xE8
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::FeverTimePeriodType, ::RPG::Client::ProgressBar*>* Field_2_15; // 0xF0
	::UnityEngine::UI::Text* Field_2_11; // 0xF8
	::System::Boolean Field_2_20; // 0x100
	::System::UInt32 Field_2_19; // 0x104
	::System::UInt32 Field_2_18; // 0x108
	::RPG::GameCore::FeverTimePeriodType Field_2_21; // 0x10C
