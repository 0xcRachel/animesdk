...
#define CLASS_1_5B567C8A01BAEDFE_324_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A334160)
#define CLASS_1_5B567C8A01BAEDFE_324_CLONE_OFFSET UNITYSDK_OFFSET(0x1A333FD0)
#define CLASS_1_5B567C8A01BAEDFE_324_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A334070)
#define CLASS_1_5B567C8A01BAEDFE_324_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A334010)
#define CLASS_1_5B567C8A01BAEDFE_324_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A3340C0)
#define CLASS_1_5B567C8A01BAEDFE_324_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A3341B0)
#define CLASS_1_5B567C8A01BAEDFE_324_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A334180)
#define CLASS_1_5B567C8A01BAEDFE_324_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A333F50)
#define CLASS_1_5B567C8A01BAEDFE_324_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A333F80)
#define CLASS_1_5B567C8A01BAEDFE_324_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A3340F0)
#define CLASS_1_5B567C8A01BAEDFE_324_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A334150)
#define CLASS_1_5B567C8A01BAEDFE_324__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A334200)
#define CLASS_1_5B567C8A01BAEDFE_324__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A333FA0)
#define CLASS_1_5B567C8A01BAEDFE_324__CTOR_OFFSET UNITYSDK_OFFSET(0x1A333F90)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_324*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_324_TypeDefinitionIndex)->GetStaticField(0x1B640);
	}
