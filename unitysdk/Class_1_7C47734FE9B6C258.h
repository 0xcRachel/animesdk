...
#define CLASS_1_7C47734FE9B6C258_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1169AA50)
#define CLASS_1_7C47734FE9B6C258_GET_ANIMATORMOVECALLBACKORDER_OFFSET UNITYSDK_OFFSET(0x1169C120)
#define CLASS_1_7C47734FE9B6C258_GET_ENABLEANIMATORMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x1169C130)
#define CLASS_1_7C47734FE9B6C258_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x1169AF00)
#define CLASS_1_7C47734FE9B6C258_METHOD_1_2ED6C3773AA1E488_OFFSET UNITYSDK_OFFSET(0x1169BC40)
#define CLASS_1_7C47734FE9B6C258_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x1169AF60)
#define CLASS_1_7C47734FE9B6C258_METHOD_1_5739CCCE693D1FCB_OFFSET UNITYSDK_OFFSET(0x1169BBF0)
#define CLASS_1_7C47734FE9B6C258_METHOD_1_6A5C5217AEC4B770_OFFSET UNITYSDK_OFFSET(0x1169AAF0)
#define CLASS_1_7C47734FE9B6C258_METHOD_1_8A2AC7CD7EA66CAC_OFFSET UNITYSDK_OFFSET(0x1169ADD0)
#define CLASS_1_7C47734FE9B6C258_METHOD_1_93220B0E3A54D36B_OFFSET UNITYSDK_OFFSET(0x1169B4F0)
#define CLASS_1_7C47734FE9B6C258_METHOD_1_9D0688AE2E08E349_OFFSET UNITYSDK_OFFSET(0x1169B010)
#define CLASS_1_7C47734FE9B6C258_METHOD_1_AF2CFBAAD2629B3B_OFFSET UNITYSDK_OFFSET(0x1169AB70)
#define CLASS_1_7C47734FE9B6C258_METHOD_1_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0x1169B340)
#define CLASS_1_7C47734FE9B6C258_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1169C110)
#define CLASS_1_7C47734FE9B6C258_ONANIMATORMOVE_OFFSET UNITYSDK_OFFSET(0x1169BE30)
#define CLASS_1_7C47734FE9B6C258_SET_ENABLEANIMATORMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x1169C140)
#define CLASS_1_7C47734FE9B6C258__CCTOR_OFFSET UNITYSDK_OFFSET(0x1169C150)
#define CLASS_1_7C47734FE9B6C258__CTOR_OFFSET UNITYSDK_OFFSET(0x1169AA40)

inline static constexpr unsigned int Class_1_7C47734FE9B6C258_TypeDefinitionIndex = 64147;
...
public:
	...
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_1_7C47734FE9B6C258_TypeDefinitionIndex)->GetStaticField(0xBBC0);
	}
	::System::Collections::Generic::List_1<::Class_1_DA16F6EFFF969A86*>* Field_1_3; // 0x10
	::Class_3_CD04D3296DF4C842_13* Field_1_6; // 0x18
	::Struct_2_2B16FFFF87B43037 Field_1_8; // 0x20
	::RPG::GameCore::AdventureCharacterController* Field_1_7; // 0x30
	::RPG::Client::Prop::OpticalIllusionPuzzleBoard* Field_1_0; // 0x38
	::RPG::GameCore::GameEntity* Field_1_2; // 0x40
	::System::Boolean Field_1_1; // 0x48
	::System::Boolean _EnableAnimatorMoveCallback_k__BackingField; // 0x49
