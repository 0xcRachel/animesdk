...
#define CLASS_1_7C47734FE9B6C258_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16766540)
#define CLASS_1_7C47734FE9B6C258_GET_ANIMATORMOVECALLBACKORDER_OFFSET UNITYSDK_OFFSET(0x16767C60)
#define CLASS_1_7C47734FE9B6C258_GET_ENABLEANIMATORMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x16767C70)
#define CLASS_1_7C47734FE9B6C258_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x16766A30)
#define CLASS_1_7C47734FE9B6C258_METHOD_1_2ED6C3773AA1E488_OFFSET UNITYSDK_OFFSET(0x16767790)
#define CLASS_1_7C47734FE9B6C258_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x16766A90)
#define CLASS_1_7C47734FE9B6C258_METHOD_1_5739CCCE693D1FCB_OFFSET UNITYSDK_OFFSET(0x16767740)
#define CLASS_1_7C47734FE9B6C258_METHOD_1_6A5C5217AEC4B770_OFFSET UNITYSDK_OFFSET(0x167665E0)
#define CLASS_1_7C47734FE9B6C258_METHOD_1_6F73A40265D5B980_OFFSET UNITYSDK_OFFSET(0x16766B40)
#define CLASS_1_7C47734FE9B6C258_METHOD_1_93220B0E3A54D36B_OFFSET UNITYSDK_OFFSET(0x16767040)
#define CLASS_1_7C47734FE9B6C258_METHOD_1_E3ADA5CA2C064E44_OFFSET UNITYSDK_OFFSET(0x16766660)
#define CLASS_1_7C47734FE9B6C258_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x16767C50)
#define CLASS_1_7C47734FE9B6C258_METHOD_1_F2C8A9D880BBBF6E_OFFSET UNITYSDK_OFFSET(0x167668E0)
#define CLASS_1_7C47734FE9B6C258_METHOD_1_F978A1D172468895_OFFSET UNITYSDK_OFFSET(0x16766E90)
#define CLASS_1_7C47734FE9B6C258_ONANIMATORMOVE_OFFSET UNITYSDK_OFFSET(0x16767980)
#define CLASS_1_7C47734FE9B6C258_SET_ENABLEANIMATORMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x16767C80)
#define CLASS_1_7C47734FE9B6C258__CCTOR_OFFSET UNITYSDK_OFFSET(0x16767C90)
#define CLASS_1_7C47734FE9B6C258__CTOR_OFFSET UNITYSDK_OFFSET(0x16766530)

inline static constexpr unsigned int Class_1_7C47734FE9B6C258_TypeDefinitionIndex = 73216;
...
public:
	...
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_1_7C47734FE9B6C258_TypeDefinitionIndex)->GetStaticField(0x13030);
	}
	::Struct_2_2B16FFFF87B43037 Field_1_1; // 0x10
	::Class_3_CD04D3296DF4C842_13* Field_1_2; // 0x20
	::RPG::GameCore::AdventureCharacterController* Field_1_3; // 0x28
	::RPG::Client::Prop::OpticalIllusionPuzzleBoard* Field_1_4; // 0x30
	::System::Collections::Generic::List_1<::Class_1_DA16F6EFFF969A86*>* Field_1_5; // 0x38
