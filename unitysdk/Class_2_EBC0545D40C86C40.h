...
#define CLASS_2_EBC0545D40C86C40_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13943E40)
#define CLASS_2_EBC0545D40C86C40_METHOD_2_1392F93CBBAA8B7E_OFFSET UNITYSDK_OFFSET(0x139440B0)
#define CLASS_2_EBC0545D40C86C40_METHOD_2_2027AC45A69D718B_OFFSET UNITYSDK_OFFSET(0x15E1FA50)
#define CLASS_2_EBC0545D40C86C40_METHOD_2_289F28027FF47717_OFFSET UNITYSDK_OFFSET(0x13944100)
#define CLASS_2_EBC0545D40C86C40_METHOD_2_3779201892A01BB4_OFFSET UNITYSDK_OFFSET(0x15E234E0)
#define CLASS_2_EBC0545D40C86C40_METHOD_2_4D71BCFB74C16073_OFFSET UNITYSDK_OFFSET(0x15E23D50)
#define CLASS_2_EBC0545D40C86C40_METHOD_2_571362FC81B1611D_OFFSET UNITYSDK_OFFSET(0x139449F0)
#define CLASS_2_EBC0545D40C86C40_METHOD_2_6B1930E1B382906A_OFFSET UNITYSDK_OFFSET(0x15E23BF0)
#define CLASS_2_EBC0545D40C86C40_METHOD_2_6D83A9CECE1AAD66_OFFSET UNITYSDK_OFFSET(0x13944B20)
#define CLASS_2_EBC0545D40C86C40_METHOD_2_6E0D227FDEAA8A41_OFFSET UNITYSDK_OFFSET(0x15E1D370)
#define CLASS_2_EBC0545D40C86C40_METHOD_2_70FB48151596BA20_OFFSET UNITYSDK_OFFSET(0x13944620)
#define CLASS_2_EBC0545D40C86C40_METHOD_2_7B411317D337F87A_OFFSET UNITYSDK_OFFSET(0x15E20240)
#define CLASS_2_EBC0545D40C86C40_METHOD_2_92E07EF7AC627659_OFFSET UNITYSDK_OFFSET(0x15E23880)
#define CLASS_2_EBC0545D40C86C40_METHOD_2_A8FA1D5DD9DF46A1_OFFSET UNITYSDK_OFFSET(0x15E200D0)
#define CLASS_2_EBC0545D40C86C40_METHOD_2_BDD79B65A8FD0174_OFFSET UNITYSDK_OFFSET(0x15E23A30)
#define CLASS_2_EBC0545D40C86C40_METHOD_2_BE0DF5D2AA19CFE5_OFFSET UNITYSDK_OFFSET(0x15E23650)
#define CLASS_2_EBC0545D40C86C40_METHOD_2_F4B543CA35778A4F_OFFSET UNITYSDK_OFFSET(0x15E1FF90)
#define CLASS_2_EBC0545D40C86C40__CCTOR_OFFSET UNITYSDK_OFFSET(0x15E23D60)
#define CLASS_2_EBC0545D40C86C40__CTOR_OFFSET UNITYSDK_OFFSET(0x139439E0)
#define CLASS_2_EBC0545D40C86C40__GETMONOVIEW_OFFSET UNITYSDK_OFFSET(0x13944410)
#define CLASS_2_EBC0545D40C86C40__ONRELEASEVIEW_OFFSET UNITYSDK_OFFSET(0x139442D0)
#define CLASS_2_EBC0545D40C86C40___ADDREVERTALL2DVOXELINTERACTTRIGGER_B__12_0_OFFSET UNITYSDK_OFFSET(0x15E23DC0)
#define CLASS_2_EBC0545D40C86C40___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15E24000)

inline static constexpr unsigned int Class_2_EBC0545D40C86C40_TypeDefinitionIndex = 71276;
...
public:
	...
	{
		return (::System::Collections::Generic::List_1<::Class_2_B8E38BF47138A2E5*>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_EBC0545D40C86C40_TypeDefinitionIndex)->GetStaticField(0x46840);
	}
	static ::System::Int32* StaticGet_Field_2_1()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_2_EBC0545D40C86C40_TypeDefinitionIndex)->GetStaticField(0xDEA0);
	}
	::System::Collections::Generic::HashSet_1<::Class_2_B8E38BF47138A2E5*>* Field_2_2; // 0x30
	::Class_3_D6E9A038FA23103A* Field_2_3; // 0x38
	...
	::Class_1_2CDF619C23140440* Field_2_6; // 0x50
	::Class_2_31D39E0B0ADFB12E* Field_2_7; // 0x58
	::System::Collections::Generic::Dictionary_2<::FiveDimRenderingItem*, ::RPG::Client::LittleGame::FourRotateVoxel::FourRotateVoxelGameViewCoord>* Field_2_8; // 0x60
	::System::Collections::Generic::Dictionary_2<::FiveDimRenderingItem*, ::Il2CppArray<::System::Single>*>* Field_2_9; // 0x68
	::System::Collections::Generic::HashSet_1<::FiveDimRenderingPanelRuntime*>* Field_2_10; // 0x70
	::System::Collections::Generic::Dictionary_2<::FiveDimRenderingItem*, ::UnityEngine::Vector3>* Field_2_11; // 0x78
	::System::Collections::Generic::Dictionary_2<::FiveDimRenderingPanelRuntime*, ::System::ValueTuple_2<::UnityEngine::Vector3, ::UnityEngine::Quaternion>>* Field_2_12; // 0x80
