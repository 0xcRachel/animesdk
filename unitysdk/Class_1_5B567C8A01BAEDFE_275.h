...
#define CLASS_1_5B567C8A01BAEDFE_275_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A291C10)
#define CLASS_1_5B567C8A01BAEDFE_275_CLONE_OFFSET UNITYSDK_OFFSET(0x1A291A80)
#define CLASS_1_5B567C8A01BAEDFE_275_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A291B20)
#define CLASS_1_5B567C8A01BAEDFE_275_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A291AC0)
#define CLASS_1_5B567C8A01BAEDFE_275_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A291B70)
#define CLASS_1_5B567C8A01BAEDFE_275_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A291C60)
#define CLASS_1_5B567C8A01BAEDFE_275_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A291C30)
#define CLASS_1_5B567C8A01BAEDFE_275_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A291A00)
#define CLASS_1_5B567C8A01BAEDFE_275_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A291A30)
#define CLASS_1_5B567C8A01BAEDFE_275_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A291BA0)
#define CLASS_1_5B567C8A01BAEDFE_275_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A291C00)
#define CLASS_1_5B567C8A01BAEDFE_275__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A291CB0)
#define CLASS_1_5B567C8A01BAEDFE_275__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A291A50)
#define CLASS_1_5B567C8A01BAEDFE_275__CTOR_OFFSET UNITYSDK_OFFSET(0x1A291A40)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_275*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_275_TypeDefinitionIndex)->GetStaticField(0xC020);
	}
