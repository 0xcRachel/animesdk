...
#define CLASS_1_5B567C8A01BAEDFE_235_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A806AB0)
#define CLASS_1_5B567C8A01BAEDFE_235_CLONE_OFFSET UNITYSDK_OFFSET(0x1A806920)
#define CLASS_1_5B567C8A01BAEDFE_235_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A8069C0)
#define CLASS_1_5B567C8A01BAEDFE_235_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A806960)
#define CLASS_1_5B567C8A01BAEDFE_235_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A806A10)
#define CLASS_1_5B567C8A01BAEDFE_235_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A806B00)
#define CLASS_1_5B567C8A01BAEDFE_235_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A806AD0)
#define CLASS_1_5B567C8A01BAEDFE_235_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A8068A0)
#define CLASS_1_5B567C8A01BAEDFE_235_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A8068D0)
#define CLASS_1_5B567C8A01BAEDFE_235_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A806A40)
#define CLASS_1_5B567C8A01BAEDFE_235_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A806AA0)
#define CLASS_1_5B567C8A01BAEDFE_235__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A806B50)
#define CLASS_1_5B567C8A01BAEDFE_235__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A8068F0)
#define CLASS_1_5B567C8A01BAEDFE_235__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8068E0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_235*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_235_TypeDefinitionIndex)->GetStaticField(0x1A340);
	}
