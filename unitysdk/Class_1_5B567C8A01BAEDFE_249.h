...
#define CLASS_1_5B567C8A01BAEDFE_249_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A05B050)
#define CLASS_1_5B567C8A01BAEDFE_249_CLONE_OFFSET UNITYSDK_OFFSET(0x1A05AE60)
#define CLASS_1_5B567C8A01BAEDFE_249_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A05AF60)
#define CLASS_1_5B567C8A01BAEDFE_249_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A05AED0)
#define CLASS_1_5B567C8A01BAEDFE_249_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A05AFB0)
#define CLASS_1_5B567C8A01BAEDFE_249_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A05B0A0)
#define CLASS_1_5B567C8A01BAEDFE_249_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A05B070)
#define CLASS_1_5B567C8A01BAEDFE_249_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A05ADB0)
#define CLASS_1_5B567C8A01BAEDFE_249_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A05AE10)
#define CLASS_1_5B567C8A01BAEDFE_249_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A05AFE0)
#define CLASS_1_5B567C8A01BAEDFE_249_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A05B040)
#define CLASS_1_5B567C8A01BAEDFE_249__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A05B0F0)
#define CLASS_1_5B567C8A01BAEDFE_249__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A05AE30)
#define CLASS_1_5B567C8A01BAEDFE_249__CTOR_OFFSET UNITYSDK_OFFSET(0x1A05AE20)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_249*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_249_TypeDefinitionIndex)->GetStaticField(0x54F10);
	}
