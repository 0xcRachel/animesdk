...
#define CLASS_2_E8A526B5D529DBB0_7_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xE63A6B0)
#define CLASS_2_E8A526B5D529DBB0_7_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xE63A8F0)
#define CLASS_2_E8A526B5D529DBB0_7_GET_INDEX_OFFSET UNITYSDK_OFFSET(0xE6385F0)
#define CLASS_2_E8A526B5D529DBB0_7_GET_TRANS_OFFSET UNITYSDK_OFFSET(0xE638610)
#define CLASS_2_E8A526B5D529DBB0_7_METHOD_2_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xE638D90)
#define CLASS_2_E8A526B5D529DBB0_7_METHOD_2_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0xE63AFA0)
#define CLASS_2_E8A526B5D529DBB0_7_METHOD_2_5790A55946AA509D_2_OFFSET UNITYSDK_OFFSET(0xE63B000)
#define CLASS_2_E8A526B5D529DBB0_7_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xE63AF40)
#define CLASS_2_E8A526B5D529DBB0_7_METHOD_2_6EECE8924BBFC43C_OFFSET UNITYSDK_OFFSET(0xE638F00)
#define CLASS_2_E8A526B5D529DBB0_7_METHOD_2_86143FF46EAE82B7_OFFSET UNITYSDK_OFFSET(0xE63A3E0)
#define CLASS_2_E8A526B5D529DBB0_7_METHOD_2_9FD4568D5B9FCD22_OFFSET UNITYSDK_OFFSET(0xE639C50)
#define CLASS_2_E8A526B5D529DBB0_7_METHOD_2_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0xE63A5B0)
#define CLASS_2_E8A526B5D529DBB0_7_METHOD_2_D4499A0147676A9C_OFFSET UNITYSDK_OFFSET(0xE638C00)
#define CLASS_2_E8A526B5D529DBB0_7_METHOD_2_D8E44F7C510402BB_1_OFFSET UNITYSDK_OFFSET(0xE639A90)
#define CLASS_2_E8A526B5D529DBB0_7_METHOD_2_D8E44F7C510402BB_OFFSET UNITYSDK_OFFSET(0xE6398D0)
#define CLASS_2_E8A526B5D529DBB0_7_METHOD_2_F37CDBD6D46274D2_1_OFFSET UNITYSDK_OFFSET(0xE639850)
#define CLASS_2_E8A526B5D529DBB0_7_METHOD_2_F37CDBD6D46274D2_2_OFFSET UNITYSDK_OFFSET(0xE63A4A0)
#define CLASS_2_E8A526B5D529DBB0_7_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0xE6397D0)
#define CLASS_2_E8A526B5D529DBB0_7_SET_INDEX_OFFSET UNITYSDK_OFFSET(0xE638600)
#define CLASS_2_E8A526B5D529DBB0_7__CTOR_OFFSET UNITYSDK_OFFSET(0xE63AAF0)
#define CLASS_2_E8A526B5D529DBB0_7__ONBIND_OFFSET UNITYSDK_OFFSET(0xE638620)
#define CLASS_2_E8A526B5D529DBB0_7___IFIXBASEPROXY_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xE63B060)
#define CLASS_2_E8A526B5D529DBB0_7___IFIXBASEPROXY_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xE63B0C0)
#define CLASS_2_E8A526B5D529DBB0_7___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0xE63AEE0)

inline static constexpr unsigned int Class_2_E8A526B5D529DBB0_7_TypeDefinitionIndex = 66434;

class Class_2_E8A526B5D529DBB0_7 : public ::Class_1_CA217ABF4E3B4F3F
{
public:
	// static const ::System::String* Field_2_1; // 0x0
	::RPG::Client::StoryFeverPileToast* Field_2_10; // 0x60
	::System::String* Field_2_21; // 0x68
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::FeverTimePeriodType, ::UnityEngine::UI::SmoothMask*>* Field_2_15; // 0x70
	::UnityEngine::Transform* Field_2_11; // 0x78
	::UnityEngine::UI::Button* Field_2_3; // 0x80
	::UnityEngine::Animator* Field_2_4; // 0x88
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::FeverTimePeriodType, ::UnityEngine::Transform*>* Field_2_14; // 0x90
	::UnityEngine::UI::Text* Field_2_13; // 0x98
	::UnityEngine::Transform* Field_2_6; // 0xA0
	::UnityEngine::Animation* Field_2_8; // 0xA8
	::System::String* Field_2_24; // 0xB0
	::UnityEngine::Transform* Field_2_7; // 0xB8
	::UnityEngine::UI::Text* Field_2_5; // 0xC0
	::UnityEngine::UI::Text* Field_2_12; // 0xC8
	::System::String* Field_2_25; // 0xD0
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::FeverTimePeriodType, ::UnityEngine::Animation*>* Field_2_17; // 0xD8
	::RPG::GameCore::LevelUIComponent* Field_2_26; // 0xE0
	::UnityEngine::UI::Button* Field_2_2; // 0xE8
	::UnityEngine::Transform* Field_2_9; // 0xF0
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::FeverTimePeriodType, ::RPG::Client::ProgressBar*>* Field_2_16; // 0xF8
	::System::UInt32 Field_2_20; // 0x100
	::System::UInt32 Field_2_19; // 0x104
	::RPG::GameCore::FeverTimePeriodType Field_2_22; // 0x108
	::RPG::GameCore::FeverTimePeriodType Field_2_23; // 0x10C
	::System::Int32 _Index_k__BackingField; // 0x110
	::System::Int32 Field_2_18; // 0x114
