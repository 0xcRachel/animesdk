...
#define CLASS_1_5B567C8A01BAEDFE_348_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A9786D0)
#define CLASS_1_5B567C8A01BAEDFE_348_CLONE_OFFSET UNITYSDK_OFFSET(0x1A978540)
#define CLASS_1_5B567C8A01BAEDFE_348_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A9785E0)
#define CLASS_1_5B567C8A01BAEDFE_348_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A978580)
#define CLASS_1_5B567C8A01BAEDFE_348_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A978630)
#define CLASS_1_5B567C8A01BAEDFE_348_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A978720)
#define CLASS_1_5B567C8A01BAEDFE_348_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A9786F0)
#define CLASS_1_5B567C8A01BAEDFE_348_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A9784C0)
#define CLASS_1_5B567C8A01BAEDFE_348_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A9784F0)
#define CLASS_1_5B567C8A01BAEDFE_348_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A978660)
#define CLASS_1_5B567C8A01BAEDFE_348_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A9786C0)
#define CLASS_1_5B567C8A01BAEDFE_348__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A978770)
#define CLASS_1_5B567C8A01BAEDFE_348__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A978510)
#define CLASS_1_5B567C8A01BAEDFE_348__CTOR_OFFSET UNITYSDK_OFFSET(0x1A978500)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_348*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_348_TypeDefinitionIndex)->GetStaticField(0xA730);
	}
