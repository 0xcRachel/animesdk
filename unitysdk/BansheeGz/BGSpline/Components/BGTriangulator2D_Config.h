...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGTRIANGULATOR2D_CONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1657ED10)
...
namespace BansheeGz::BGSpline::Components
{
	...
	public:
		...
		::BansheeGz::BGSpline::Components::BGPpu TextureSize; // 0x28
		...
		::BansheeGz::BGSpline::Curve::BGCurve_Mode2DEnum Mode2D; // 0x44
		::UnityEngine::Vector2 ScaleUV; // 0x48
		::System::Boolean Flip; // 0x50
		::System::Boolean Closed; // 0x51
		::System::Boolean AutoFlip; // 0x52
