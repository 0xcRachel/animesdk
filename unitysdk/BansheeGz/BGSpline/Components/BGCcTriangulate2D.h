...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_GET_DOUBLESIDED_OFFSET UNITYSDK_OFFSET(0x1723A110)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_GET_ERROR_OFFSET UNITYSDK_OFFSET(0x1723A270)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_GET_FLIP_OFFSET UNITYSDK_OFFSET(0x1723A0D0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1723A340)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_GET_MESHFILTER_OFFSET UNITYSDK_OFFSET(0x1723A570)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_GET_SCALEUV_OFFSET UNITYSDK_OFFSET(0x1723A060)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_GET_UPDATEEVERYFRAME_OFFSET UNITYSDK_OFFSET(0x1723A140)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_GET_USELOCAL_OFFSET UNITYSDK_OFFSET(0x1723A260)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1723AC10)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1723ABA0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_SET_DOUBLESIDED_OFFSET UNITYSDK_OFFSET(0x1723A120)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_SET_FLIP_OFFSET UNITYSDK_OFFSET(0x1723A0E0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_SET_SCALEUV_OFFSET UNITYSDK_OFFSET(0x1723A070)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_SET_UPDATEEVERYFRAME_OFFSET UNITYSDK_OFFSET(0x1723A150)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_START_OFFSET UNITYSDK_OFFSET(0x1723A600)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_UIUPDATER_OFFSET UNITYSDK_OFFSET(0x1723A210)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_UPDATEREQUESTED_OFFSET UNITYSDK_OFFSET(0x1723B770)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_UPDATEUI_OFFSET UNITYSDK_OFFSET(0x1723A750)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1723B7B0)
