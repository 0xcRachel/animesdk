...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_GET_DOUBLESIDED_OFFSET UNITYSDK_OFFSET(0x1657E1C0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_GET_ERROR_OFFSET UNITYSDK_OFFSET(0x1657E320)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_GET_FLIP_OFFSET UNITYSDK_OFFSET(0x1657E180)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1657E3F0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_GET_MESHFILTER_OFFSET UNITYSDK_OFFSET(0x1657E620)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_GET_SCALEUV_OFFSET UNITYSDK_OFFSET(0x1657E110)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_GET_UPDATEEVERYFRAME_OFFSET UNITYSDK_OFFSET(0x1657E1F0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_GET_USELOCAL_OFFSET UNITYSDK_OFFSET(0x1657E310)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1657ECC0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1657EC50)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_SET_DOUBLESIDED_OFFSET UNITYSDK_OFFSET(0x1657E1D0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_SET_FLIP_OFFSET UNITYSDK_OFFSET(0x1657E190)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_SET_SCALEUV_OFFSET UNITYSDK_OFFSET(0x1657E120)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_SET_UPDATEEVERYFRAME_OFFSET UNITYSDK_OFFSET(0x1657E200)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_START_OFFSET UNITYSDK_OFFSET(0x1657E6B0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_UIUPDATER_OFFSET UNITYSDK_OFFSET(0x1657E2C0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_UPDATEREQUESTED_OFFSET UNITYSDK_OFFSET(0x1657F820)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_UPDATEUI_OFFSET UNITYSDK_OFFSET(0x1657E800)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1657F860)
