...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_GET_DOUBLESIDED_OFFSET UNITYSDK_OFFSET(0x15EB6410)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_GET_ERROR_OFFSET UNITYSDK_OFFSET(0x15EB6570)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_GET_FLIP_OFFSET UNITYSDK_OFFSET(0x15EB63D0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_GET_INFO_OFFSET UNITYSDK_OFFSET(0x15EB6640)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_GET_MESHFILTER_OFFSET UNITYSDK_OFFSET(0x15EB6870)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_GET_SCALEUV_OFFSET UNITYSDK_OFFSET(0x15EB6360)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_GET_UPDATEEVERYFRAME_OFFSET UNITYSDK_OFFSET(0x15EB6440)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_GET_USELOCAL_OFFSET UNITYSDK_OFFSET(0x15EB6560)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x15EB6F10)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_ONENABLE_OFFSET UNITYSDK_OFFSET(0x15EB6EA0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_SET_DOUBLESIDED_OFFSET UNITYSDK_OFFSET(0x15EB6420)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_SET_FLIP_OFFSET UNITYSDK_OFFSET(0x15EB63E0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_SET_SCALEUV_OFFSET UNITYSDK_OFFSET(0x15EB6370)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_SET_UPDATEEVERYFRAME_OFFSET UNITYSDK_OFFSET(0x15EB6450)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_START_OFFSET UNITYSDK_OFFSET(0x15EB6900)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_UIUPDATER_OFFSET UNITYSDK_OFFSET(0x15EB6510)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_UPDATEREQUESTED_OFFSET UNITYSDK_OFFSET(0x15EB7A70)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D_UPDATEUI_OFFSET UNITYSDK_OFFSET(0x15EB6A50)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRIANGULATE2D__CTOR_OFFSET UNITYSDK_OFFSET(0x15EB7AB0)

namespace BansheeGz::BGSpline::Components
{
	inline static constexpr unsigned int BGCcTriangulate2D_TypeDefinitionIndex = 27492;
