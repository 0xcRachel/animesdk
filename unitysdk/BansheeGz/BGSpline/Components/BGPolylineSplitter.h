...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_BIND_OFFSET UNITYSDK_OFFSET(0x15EB3540)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_COUNTSTRAIGHTLINES_OFFSET UNITYSDK_OFFSET(0x15EB2050)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_INITPROVIDER_OFFSET UNITYSDK_OFFSET(0x15EBB410)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER__CTOR_OFFSET UNITYSDK_OFFSET(0x15EB3520)

namespace BansheeGz::BGSpline::Components
{
	inline static constexpr unsigned int BGPolylineSplitter_TypeDefinitionIndex = 27503;

	class BGPolylineSplitter : public ::System::Object
	{
	public:
		::BansheeGz::BGSpline::Components::BGPolylineSplitter_PositionsProvider* positionsProvider; // 0x10
