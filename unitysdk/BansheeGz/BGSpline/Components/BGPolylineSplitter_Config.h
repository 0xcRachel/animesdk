...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_CONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x151F1A90)
...
namespace BansheeGz::BGSpline::Components
{
	...
	public:
		...
		::System::Boolean UseLocal; // 0x18
		::System::Boolean DoNotOptimizeStraightLines; // 0x19
		...
		::System::Int32 PartsPerSection; // 0x2C
