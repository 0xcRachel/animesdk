...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_ADDEDINEDITOR_OFFSET UNITYSDK_OFFSET(0x16582B60)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_ADD_CHANGEDVISUALIZATION_OFFSET UNITYSDK_OFFSET(0x165821C0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_APPLYAUTOSCALEWIDTH_OFFSET UNITYSDK_OFFSET(0x16582B70)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_GET_ERROR_OFFSET UNITYSDK_OFFSET(0x165822C0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_GET_INFO_OFFSET UNITYSDK_OFFSET(0x165825A0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_GET_LINERENDERER_OFFSET UNITYSDK_OFFSET(0x16582510)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_GET_SUPPORTHANDLES_OFFSET UNITYSDK_OFFSET(0x16582650)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_GET_UPDATEATSTART_OFFSET UNITYSDK_OFFSET(0x165822A0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_GET_WARNING_OFFSET UNITYSDK_OFFSET(0x16582400)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_REMOVE_CHANGEDVISUALIZATION_OFFSET UNITYSDK_OFFSET(0x16582230)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_SET_UPDATEATSTART_OFFSET UNITYSDK_OFFSET(0x165822B0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_START_OFFSET UNITYSDK_OFFSET(0x16582660)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_UPDATEREQUESTED_OFFSET UNITYSDK_OFFSET(0x16582CC0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_UPDATEUI_OFFSET UNITYSDK_OFFSET(0x16582720)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER__CCTOR_OFFSET UNITYSDK_OFFSET(0x16582DD0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x16582CF0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER__GET_ERROR_B__9_0_OFFSET UNITYSDK_OFFSET(0x16582DF0)
...
namespace BansheeGz::BGSpline::Components
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(BGCcVisualizationLineRenderer_TypeDefinitionIndex)->GetStaticField(0xBE80);
		}
