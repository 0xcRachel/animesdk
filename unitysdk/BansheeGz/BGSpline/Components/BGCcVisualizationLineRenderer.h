...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_ADDEDINEDITOR_OFFSET UNITYSDK_OFFSET(0x1723EAB0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_ADD_CHANGEDVISUALIZATION_OFFSET UNITYSDK_OFFSET(0x1723E110)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_APPLYAUTOSCALEWIDTH_OFFSET UNITYSDK_OFFSET(0x1723EAC0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_GET_ERROR_OFFSET UNITYSDK_OFFSET(0x1723E210)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1723E4F0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_GET_LINERENDERER_OFFSET UNITYSDK_OFFSET(0x1723E460)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_GET_SUPPORTHANDLES_OFFSET UNITYSDK_OFFSET(0x1723E5A0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_GET_UPDATEATSTART_OFFSET UNITYSDK_OFFSET(0x1723E1F0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_GET_WARNING_OFFSET UNITYSDK_OFFSET(0x1723E350)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_REMOVE_CHANGEDVISUALIZATION_OFFSET UNITYSDK_OFFSET(0x1723E180)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_SET_UPDATEATSTART_OFFSET UNITYSDK_OFFSET(0x1723E200)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_START_OFFSET UNITYSDK_OFFSET(0x1723E5B0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_UPDATEREQUESTED_OFFSET UNITYSDK_OFFSET(0x1723EC10)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_UPDATEUI_OFFSET UNITYSDK_OFFSET(0x1723E670)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1723ED20)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x1723EC40)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER__GET_ERROR_B__9_0_OFFSET UNITYSDK_OFFSET(0x1723ED40)
...
namespace BansheeGz::BGSpline::Components
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(BGCcVisualizationLineRenderer_TypeDefinitionIndex)->GetStaticField(0xEFE0);
		}
