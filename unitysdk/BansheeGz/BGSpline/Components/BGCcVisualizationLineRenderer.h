...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_ADDEDINEDITOR_OFFSET UNITYSDK_OFFSET(0x15EBADC0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_ADD_CHANGEDVISUALIZATION_OFFSET UNITYSDK_OFFSET(0x15EBA420)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_APPLYAUTOSCALEWIDTH_OFFSET UNITYSDK_OFFSET(0x15EBADD0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_GET_ERROR_OFFSET UNITYSDK_OFFSET(0x15EBA520)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_GET_INFO_OFFSET UNITYSDK_OFFSET(0x15EBA800)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_GET_LINERENDERER_OFFSET UNITYSDK_OFFSET(0x15EBA770)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_GET_SUPPORTHANDLES_OFFSET UNITYSDK_OFFSET(0x15EBA8B0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_GET_UPDATEATSTART_OFFSET UNITYSDK_OFFSET(0x15EBA500)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_GET_WARNING_OFFSET UNITYSDK_OFFSET(0x15EBA660)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_REMOVE_CHANGEDVISUALIZATION_OFFSET UNITYSDK_OFFSET(0x15EBA490)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_SET_UPDATEATSTART_OFFSET UNITYSDK_OFFSET(0x15EBA510)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_START_OFFSET UNITYSDK_OFFSET(0x15EBA8C0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_UPDATEREQUESTED_OFFSET UNITYSDK_OFFSET(0x15EBAF20)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER_UPDATEUI_OFFSET UNITYSDK_OFFSET(0x15EBA980)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER__CCTOR_OFFSET UNITYSDK_OFFSET(0x15EBB030)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x15EBAF50)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCVISUALIZATIONLINERENDERER__GET_ERROR_B__9_0_OFFSET UNITYSDK_OFFSET(0x15EBB050)

namespace BansheeGz::BGSpline::Components
{
	inline static constexpr unsigned int BGCcVisualizationLineRenderer_TypeDefinitionIndex = 27499;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(BGCcVisualizationLineRenderer_TypeDefinitionIndex)->GetStaticField(0x96E0);
		}
