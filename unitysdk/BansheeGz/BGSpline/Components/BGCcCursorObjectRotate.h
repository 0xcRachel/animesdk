...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_ADD_CHANGEDOBJECTROTATION_OFFSET UNITYSDK_OFFSET(0x15EABAE0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_ERROR_OFFSET UNITYSDK_OFFSET(0x15EAC010)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_HANDLESCOLOR_OFFSET UNITYSDK_OFFSET(0x15EAC280)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_HANDLESSCALE_OFFSET UNITYSDK_OFFSET(0x15EAC260)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_LERPSPEED_OFFSET UNITYSDK_OFFSET(0x15EABC00)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_OFFSETANGLE_OFFSET UNITYSDK_OFFSET(0x15EABFC0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_REVOLUTIONSAROUNDTANGENTFIELD_OFFSET UNITYSDK_OFFSET(0x15EABDC0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_REVOLUTIONSAROUNDTANGENT_OFFSET UNITYSDK_OFFSET(0x15EABE90)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_REVOLUTIONSCLOCKWISEFIELD_OFFSET UNITYSDK_OFFSET(0x15EABEC0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_REVOLUTIONSCLOCKWISE_OFFSET UNITYSDK_OFFSET(0x15EABF90)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_ROTATIONFIELD_OFFSET UNITYSDK_OFFSET(0x15EABCF0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_ROTATIONINTERPOLATION_OFFSET UNITYSDK_OFFSET(0x15EABBA0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x15EAC2A0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_SLERPSPEED_OFFSET UNITYSDK_OFFSET(0x15EABC20)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_SUPPORTHANDLESSETTINGS_OFFSET UNITYSDK_OFFSET(0x15EAC250)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_SUPPORTHANDLES_OFFSET UNITYSDK_OFFSET(0x15EAC240)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_UPCUSTOM_OFFSET UNITYSDK_OFFSET(0x15EABC40)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_UPMODE_OFFSET UNITYSDK_OFFSET(0x15EABC90)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_WARNING_OFFSET UNITYSDK_OFFSET(0x15EAC150)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_REMOVE_CHANGEDOBJECTROTATION_OFFSET UNITYSDK_OFFSET(0x15EABB40)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_HANDLESCOLOR_OFFSET UNITYSDK_OFFSET(0x15EAC290)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_HANDLESSCALE_OFFSET UNITYSDK_OFFSET(0x15EAC270)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_LERPSPEED_OFFSET UNITYSDK_OFFSET(0x15EABC10)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_OFFSETANGLE_OFFSET UNITYSDK_OFFSET(0x15EABFE0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_REVOLUTIONSAROUNDTANGENTFIELD_OFFSET UNITYSDK_OFFSET(0x15EABDD0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_REVOLUTIONSAROUNDTANGENT_OFFSET UNITYSDK_OFFSET(0x15EABEA0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_REVOLUTIONSCLOCKWISEFIELD_OFFSET UNITYSDK_OFFSET(0x15EABED0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_REVOLUTIONSCLOCKWISE_OFFSET UNITYSDK_OFFSET(0x15EABFA0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_ROTATIONFIELD_OFFSET UNITYSDK_OFFSET(0x15EABD00)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_ROTATIONINTERPOLATION_OFFSET UNITYSDK_OFFSET(0x15EABBB0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_SLERPSPEED_OFFSET UNITYSDK_OFFSET(0x15EABC30)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_UPCUSTOM_OFFSET UNITYSDK_OFFSET(0x15EABC60)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_UPMODE_OFFSET UNITYSDK_OFFSET(0x15EABCA0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_TRYTOCALCULATEROTATION_OFFSET UNITYSDK_OFFSET(0x15EAC3B0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_UPDATE_OFFSET UNITYSDK_OFFSET(0x15EAC2B0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15EAD740)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE__GET_ERROR_B__50_0_OFFSET UNITYSDK_OFFSET(0x15EAD7B0)

namespace BansheeGz::BGSpline::Components
{
	inline static constexpr unsigned int BGCcCursorObjectRotate_TypeDefinitionIndex = 27476;
