...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_ADD_CHANGEDOBJECTROTATION_OFFSET UNITYSDK_OFFSET(0x16573CB0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_ERROR_OFFSET UNITYSDK_OFFSET(0x165741E0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_HANDLESCOLOR_OFFSET UNITYSDK_OFFSET(0x16574450)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_HANDLESSCALE_OFFSET UNITYSDK_OFFSET(0x16574430)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_LERPSPEED_OFFSET UNITYSDK_OFFSET(0x16573DD0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_OFFSETANGLE_OFFSET UNITYSDK_OFFSET(0x16574190)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_REVOLUTIONSAROUNDTANGENTFIELD_OFFSET UNITYSDK_OFFSET(0x16573F90)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_REVOLUTIONSAROUNDTANGENT_OFFSET UNITYSDK_OFFSET(0x16574060)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_REVOLUTIONSCLOCKWISEFIELD_OFFSET UNITYSDK_OFFSET(0x16574090)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_REVOLUTIONSCLOCKWISE_OFFSET UNITYSDK_OFFSET(0x16574160)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_ROTATIONFIELD_OFFSET UNITYSDK_OFFSET(0x16573EC0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_ROTATIONINTERPOLATION_OFFSET UNITYSDK_OFFSET(0x16573D70)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x16574470)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_SLERPSPEED_OFFSET UNITYSDK_OFFSET(0x16573DF0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_SUPPORTHANDLESSETTINGS_OFFSET UNITYSDK_OFFSET(0x16574420)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_SUPPORTHANDLES_OFFSET UNITYSDK_OFFSET(0x16574410)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_UPCUSTOM_OFFSET UNITYSDK_OFFSET(0x16573E10)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_UPMODE_OFFSET UNITYSDK_OFFSET(0x16573E60)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_WARNING_OFFSET UNITYSDK_OFFSET(0x16574320)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_REMOVE_CHANGEDOBJECTROTATION_OFFSET UNITYSDK_OFFSET(0x16573D10)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_HANDLESCOLOR_OFFSET UNITYSDK_OFFSET(0x16574460)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_HANDLESSCALE_OFFSET UNITYSDK_OFFSET(0x16574440)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_LERPSPEED_OFFSET UNITYSDK_OFFSET(0x16573DE0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_OFFSETANGLE_OFFSET UNITYSDK_OFFSET(0x165741B0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_REVOLUTIONSAROUNDTANGENTFIELD_OFFSET UNITYSDK_OFFSET(0x16573FA0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_REVOLUTIONSAROUNDTANGENT_OFFSET UNITYSDK_OFFSET(0x16574070)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_REVOLUTIONSCLOCKWISEFIELD_OFFSET UNITYSDK_OFFSET(0x165740A0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_REVOLUTIONSCLOCKWISE_OFFSET UNITYSDK_OFFSET(0x16574170)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_ROTATIONFIELD_OFFSET UNITYSDK_OFFSET(0x16573ED0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_ROTATIONINTERPOLATION_OFFSET UNITYSDK_OFFSET(0x16573D80)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_SLERPSPEED_OFFSET UNITYSDK_OFFSET(0x16573E00)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_UPCUSTOM_OFFSET UNITYSDK_OFFSET(0x16573E30)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_UPMODE_OFFSET UNITYSDK_OFFSET(0x16573E70)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_TRYTOCALCULATEROTATION_OFFSET UNITYSDK_OFFSET(0x16574580)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_UPDATE_OFFSET UNITYSDK_OFFSET(0x16574480)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16575910)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE__GET_ERROR_B__50_0_OFFSET UNITYSDK_OFFSET(0x16575980)
