...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_ADD_CHANGEDOBJECTROTATION_OFFSET UNITYSDK_OFFSET(0x1722FC00)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_ERROR_OFFSET UNITYSDK_OFFSET(0x17230130)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_HANDLESCOLOR_OFFSET UNITYSDK_OFFSET(0x172303A0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_HANDLESSCALE_OFFSET UNITYSDK_OFFSET(0x17230380)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_LERPSPEED_OFFSET UNITYSDK_OFFSET(0x1722FD20)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_OFFSETANGLE_OFFSET UNITYSDK_OFFSET(0x172300E0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_REVOLUTIONSAROUNDTANGENTFIELD_OFFSET UNITYSDK_OFFSET(0x1722FEE0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_REVOLUTIONSAROUNDTANGENT_OFFSET UNITYSDK_OFFSET(0x1722FFB0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_REVOLUTIONSCLOCKWISEFIELD_OFFSET UNITYSDK_OFFSET(0x1722FFE0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_REVOLUTIONSCLOCKWISE_OFFSET UNITYSDK_OFFSET(0x172300B0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_ROTATIONFIELD_OFFSET UNITYSDK_OFFSET(0x1722FE10)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_ROTATIONINTERPOLATION_OFFSET UNITYSDK_OFFSET(0x1722FCC0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x172303C0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_SLERPSPEED_OFFSET UNITYSDK_OFFSET(0x1722FD40)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_SUPPORTHANDLESSETTINGS_OFFSET UNITYSDK_OFFSET(0x17230370)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_SUPPORTHANDLES_OFFSET UNITYSDK_OFFSET(0x17230360)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_UPCUSTOM_OFFSET UNITYSDK_OFFSET(0x1722FD60)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_UPMODE_OFFSET UNITYSDK_OFFSET(0x1722FDB0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_GET_WARNING_OFFSET UNITYSDK_OFFSET(0x17230270)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_REMOVE_CHANGEDOBJECTROTATION_OFFSET UNITYSDK_OFFSET(0x1722FC60)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_HANDLESCOLOR_OFFSET UNITYSDK_OFFSET(0x172303B0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_HANDLESSCALE_OFFSET UNITYSDK_OFFSET(0x17230390)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_LERPSPEED_OFFSET UNITYSDK_OFFSET(0x1722FD30)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_OFFSETANGLE_OFFSET UNITYSDK_OFFSET(0x17230100)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_REVOLUTIONSAROUNDTANGENTFIELD_OFFSET UNITYSDK_OFFSET(0x1722FEF0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_REVOLUTIONSAROUNDTANGENT_OFFSET UNITYSDK_OFFSET(0x1722FFC0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_REVOLUTIONSCLOCKWISEFIELD_OFFSET UNITYSDK_OFFSET(0x1722FFF0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_REVOLUTIONSCLOCKWISE_OFFSET UNITYSDK_OFFSET(0x172300C0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_ROTATIONFIELD_OFFSET UNITYSDK_OFFSET(0x1722FE20)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_ROTATIONINTERPOLATION_OFFSET UNITYSDK_OFFSET(0x1722FCD0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_SLERPSPEED_OFFSET UNITYSDK_OFFSET(0x1722FD50)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_UPCUSTOM_OFFSET UNITYSDK_OFFSET(0x1722FD80)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_SET_UPMODE_OFFSET UNITYSDK_OFFSET(0x1722FDC0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_TRYTOCALCULATEROTATION_OFFSET UNITYSDK_OFFSET(0x172304D0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE_UPDATE_OFFSET UNITYSDK_OFFSET(0x172303D0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17231860)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTROTATE__GET_ERROR_B__50_0_OFFSET UNITYSDK_OFFSET(0x172318D0)
