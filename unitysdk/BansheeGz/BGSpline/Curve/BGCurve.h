...
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ADDFIELDS_OFFSET UNITYSDK_OFFSET(0x1520AEE0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ADDFIELD_1_OFFSET UNITYSDK_OFFSET(0x152059F0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ADDFIELD_OFFSET UNITYSDK_OFFSET(0x152059E0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ADDPOINTS_1_OFFSET UNITYSDK_OFFSET(0x15202B00)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ADDPOINTS_2_OFFSET UNITYSDK_OFFSET(0x15202330)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ADDPOINTS_OFFSET UNITYSDK_OFFSET(0x152022F0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ADDPOINT_1_OFFSET UNITYSDK_OFFSET(0x152022E0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ADDPOINT_2_OFFSET UNITYSDK_OFFSET(0x15201E50)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ADDPOINT_OFFSET UNITYSDK_OFFSET(0x15201E20)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ADD_BEFORECHANGE_OFFSET UNITYSDK_OFFSET(0x151FEB70)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ADD_CHANGED_OFFSET UNITYSDK_OFFSET(0x151ED4C0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_APPLY2D_1_OFFSET UNITYSDK_OFFSET(0x15206F20)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_APPLY2D_2_OFFSET UNITYSDK_OFFSET(0x15207320)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_APPLY2D_OFFSET UNITYSDK_OFFSET(0x152003D0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_APPLYSNAPPING_1_OFFSET UNITYSDK_OFFSET(0x152073A0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_APPLYSNAPPING_2_OFFSET UNITYSDK_OFFSET(0x15207540)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_APPLYSNAPPING_OFFSET UNITYSDK_OFFSET(0x152007B0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_CACHEPOINTSWITHTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x15204120)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_CLEAR_OFFSET UNITYSDK_OFFSET(0x15201A40)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_CONVERTGOTOINLINE_OFFSET UNITYSDK_OFFSET(0x1520B180)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_CONVERTINLINETOGO_OFFSET UNITYSDK_OFFSET(0x1520AFC0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_CONVERTPOINTS_OFFSET UNITYSDK_OFFSET(0x151FF2F0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_CONVERT_OFFSET UNITYSDK_OFFSET(0x15209030)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_CREATEPOINTFROMLOCALPOSITION_1_OFFSET UNITYSDK_OFFSET(0x152019A0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_CREATEPOINTFROMLOCALPOSITION_OFFSET UNITYSDK_OFFSET(0x15201910)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_CREATEPOINTFROMWORLDPOSITION_1_OFFSET UNITYSDK_OFFSET(0x152017B0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_CREATEPOINTFROMWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0x152016A0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_DELETEFIELD_1_OFFSET UNITYSDK_OFFSET(0x15205DE0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_DELETEFIELD_OFFSET UNITYSDK_OFFSET(0x15205DD0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_DELETE_1_OFFSET UNITYSDK_OFFSET(0x15202DD0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_DELETE_2_OFFSET UNITYSDK_OFFSET(0x15202DE0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_DELETE_3_OFFSET UNITYSDK_OFFSET(0x15202B40)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_DELETE_4_OFFSET UNITYSDK_OFFSET(0x15202DF0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_DELETE_OFFSET UNITYSDK_OFFSET(0x15202B20)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_DESTROYIT_OFFSET UNITYSDK_OFFSET(0x15201D40)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_FIREBEFORECHANGE_OFFSET UNITYSDK_OFFSET(0x151FEE40)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_FIRECHANGE_OFFSET UNITYSDK_OFFSET(0x151FEFA0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_FIREFINALEVENT_OFFSET UNITYSDK_OFFSET(0x15208430)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_FOREACH_OFFSET UNITYSDK_OFFSET(0x15208C70)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GETFIELDSVALUES_OFFSET UNITYSDK_OFFSET(0x15205480)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GETFIELD_OFFSET UNITYSDK_OFFSET(0x152062E0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_CHANGELIST_OFFSET UNITYSDK_OFFSET(0x15201630)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_CLOSED_OFFSET UNITYSDK_OFFSET(0x151FECA0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_EVENTMODE_OFFSET UNITYSDK_OFFSET(0x152015F0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_FIELDSCOUNT_OFFSET UNITYSDK_OFFSET(0x151FEC80)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_FIELDS_OFFSET UNITYSDK_OFFSET(0x151FEC70)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_FORCECHANGEDEVENTMODE_OFFSET UNITYSDK_OFFSET(0x152013B0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_IMMEDIATECHANGEEVENTS_OFFSET UNITYSDK_OFFSET(0x15201610)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x151E6480)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_MODE2DON_OFFSET UNITYSDK_OFFSET(0x151F4CB0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_MODE2D_OFFSET UNITYSDK_OFFSET(0x152003B0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_POINTSCOUNT_OFFSET UNITYSDK_OFFSET(0x151E52D0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_POINTSMODE_OFFSET UNITYSDK_OFFSET(0x151FF2C0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_POINTS_OFFSET UNITYSDK_OFFSET(0x151EF8B0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x151FEB60)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_SNAPAXIS_OFFSET UNITYSDK_OFFSET(0x15200890)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_SNAPDISTANCE_OFFSET UNITYSDK_OFFSET(0x15200A60)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_SNAPLAYERMASK_OFFSET UNITYSDK_OFFSET(0x15201020)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_SNAPMONITORING_OFFSET UNITYSDK_OFFSET(0x152011F0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_SNAPTOBACKFACES_OFFSET UNITYSDK_OFFSET(0x15200E50)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_SNAPTRIGGERINTERACTION_OFFSET UNITYSDK_OFFSET(0x15200C80)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_SNAPTYPE_OFFSET UNITYSDK_OFFSET(0x152005E0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_SUPRESSEVENTS_OFFSET UNITYSDK_OFFSET(0x15201590)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_TRACECHANGES_OFFSET UNITYSDK_OFFSET(0x15201570)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_TRANSACTIONLEVEL_OFFSET UNITYSDK_OFFSET(0x152082D0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_USEEVENTSARGS_OFFSET UNITYSDK_OFFSET(0x152015D0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_HASFIELD_OFFSET UNITYSDK_OFFSET(0x152063C0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_INDEXOFFIELDVALUE_OFFSET UNITYSDK_OFFSET(0x152064A0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_INDEXOF_1_OFFSET UNITYSDK_OFFSET(0x15206250)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_INDEXOF_OFFSET UNITYSDK_OFFSET(0x15201D50)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ISGOMODE_OFFSET UNITYSDK_OFFSET(0x15203F20)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x15208A70)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_PRIVATETRANSFORMFORPOINTADDED_OFFSET UNITYSDK_OFFSET(0x15208E70)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_PRIVATETRANSFORMFORPOINTREMOVED_OFFSET UNITYSDK_OFFSET(0x15208F90)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_PRIVATEUPDATEFIELDSVALUESINDEXES_OFFSET UNITYSDK_OFFSET(0x15206570)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_REMOVE_BEFORECHANGE_OFFSET UNITYSDK_OFFSET(0x151FEBF0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_REMOVE_CHANGED_OFFSET UNITYSDK_OFFSET(0x151EE4A0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_REVERSE_OFFSET UNITYSDK_OFFSET(0x15204370)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SETFIELDSVALUES_OFFSET UNITYSDK_OFFSET(0x152055E0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SETPOINTSNAMES_OFFSET UNITYSDK_OFFSET(0x15203F30)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_CLOSED_OFFSET UNITYSDK_OFFSET(0x151FECB0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_EVENTMODE_OFFSET UNITYSDK_OFFSET(0x15201600)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_FORCECHANGEDEVENTMODE_OFFSET UNITYSDK_OFFSET(0x152013C0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_IMMEDIATECHANGEEVENTS_OFFSET UNITYSDK_OFFSET(0x15201620)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x15205750)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_MODE2D_OFFSET UNITYSDK_OFFSET(0x152003C0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_POINTSMODE_OFFSET UNITYSDK_OFFSET(0x151FF2D0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_SNAPAXIS_OFFSET UNITYSDK_OFFSET(0x152008A0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_SNAPDISTANCE_OFFSET UNITYSDK_OFFSET(0x15200A70)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_SNAPLAYERMASK_OFFSET UNITYSDK_OFFSET(0x15201030)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_SNAPMONITORING_OFFSET UNITYSDK_OFFSET(0x15201200)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_SNAPTOBACKFACES_OFFSET UNITYSDK_OFFSET(0x15200E60)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_SNAPTRIGGERINTERACTION_OFFSET UNITYSDK_OFFSET(0x15200C90)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_SNAPTYPE_OFFSET UNITYSDK_OFFSET(0x152005F0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_SUPRESSEVENTS_OFFSET UNITYSDK_OFFSET(0x152015A0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_TRACECHANGES_OFFSET UNITYSDK_OFFSET(0x15201580)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_USEEVENTSARGS_OFFSET UNITYSDK_OFFSET(0x152015E0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SNAPIT_OFFSET UNITYSDK_OFFSET(0x15208040)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_START_OFFSET UNITYSDK_OFFSET(0x152083B0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SWAP_OFFSET UNITYSDK_OFFSET(0x15203990)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_TOLOCALDIRECTION_OFFSET UNITYSDK_OFFSET(0x15208B90)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_TOLOCAL_OFFSET UNITYSDK_OFFSET(0x15208AB0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x15208DC0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_TOWORLDDIRECTION_OFFSET UNITYSDK_OFFSET(0x15208C00)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_TOWORLD_OFFSET UNITYSDK_OFFSET(0x15208B20)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_TRANSACTION_OFFSET UNITYSDK_OFFSET(0x15206BA0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_UPDATE_OFFSET UNITYSDK_OFFSET(0x152083C0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE__APPLY2D_B__169_0_OFFSET UNITYSDK_OFFSET(0x1520D6F0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1520D620)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1520D590)
...
namespace BansheeGz::BGSpline::Curve
{
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::RaycastHit>**)Il2CppClass::FromTypeDefinitionIndex(BGCurve_TypeDefinitionIndex)->GetStaticField(0x4E240);
		}
		static ::System::Collections::Generic::List_1<::System::Int32>** StaticGet_pointsIndexesList()
		{
			return (::System::Collections::Generic::List_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(BGCurve_TypeDefinitionIndex)->GetStaticField(0x4E248);
		}
		static ::System::Collections::Generic::List_1<::BansheeGz::BGSpline::Curve::BGCurvePointI*>** StaticGet_pointsList()
		{
			return (::System::Collections::Generic::List_1<::BansheeGz::BGSpline::Curve::BGCurvePointI*>**)Il2CppClass::FromTypeDefinitionIndex(BGCurve_TypeDefinitionIndex)->GetStaticField(0x4E250);
		}
		static ::Il2CppArray<::BansheeGz::BGSpline::Curve::BGCurvePointI*>** StaticGet_pointArray()
		{
			return (::Il2CppArray<::BansheeGz::BGSpline::Curve::BGCurvePointI*>**)Il2CppClass::FromTypeDefinitionIndex(BGCurve_TypeDefinitionIndex)->GetStaticField(0x4E258);
		}
