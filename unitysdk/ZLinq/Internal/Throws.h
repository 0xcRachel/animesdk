...
#define ZLINQ_INTERNAL_THROWS_ARGUMENTOUTOFRANGE_OFFSET UNITYSDK_OFFSET(0x184FFCD0)
#define ZLINQ_INTERNAL_THROWS_NOELEMENTS_OFFSET UNITYSDK_OFFSET(0x184FFD20)
#define ZLINQ_INTERNAL_THROWS_NOTSUPPORTEDTYPE_OFFSET UNITYSDK_OFFSET(0x184FFD70)

namespace ZLinq::Internal
{
	inline static constexpr unsigned int Throws_TypeDefinitionIndex = 6430;
