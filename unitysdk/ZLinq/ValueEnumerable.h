...
#define ZLINQ_VALUEENUMERABLE_ASVALUEENUMERABLE_OFFSET UNITYSDK_OFFSET(0x18500620)
#define ZLINQ_VALUEENUMERABLE_RANGE_OFFSET UNITYSDK_OFFSET(0x185006C0)

namespace ZLinq
{
	inline static constexpr unsigned int ValueEnumerable_TypeDefinitionIndex = 6370;
