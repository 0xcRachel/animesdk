...
#define SRDEBUG_GETDEFAULTCOPYCONSOLEITEMCALLBACK_OFFSET UNITYSDK_OFFSET(0x17C2D640)
#define SRDEBUG_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x17C2D570)
#define SRDEBUG_GET_MIHOYOASSETLOADER_OFFSET UNITYSDK_OFFSET(0x17C2D5B0)
#define SRDEBUG_INIT_OFFSET UNITYSDK_OFFSET(0x17C2D5F0)
#define SRDEBUG__CCTOR_OFFSET UNITYSDK_OFFSET(0x17C2D6F0)

inline static constexpr unsigned int SRDebug_TypeDefinitionIndex = 28717;
...
public:
	...
	{
		return (::UnityEngine::Events::UnityEvent**)Il2CppClass::FromTypeDefinitionIndex(SRDebug_TypeDefinitionIndex)->GetStaticField(0x3C6C0);
	}
	static ::System::Action_1<::SRDebugger::Services::ConsoleEntry*>** StaticGet_CopyConsoleItemCallback()
	{
		return (::System::Action_1<::SRDebugger::Services::ConsoleEntry*>**)Il2CppClass::FromTypeDefinitionIndex(SRDebug_TypeDefinitionIndex)->GetStaticField(0x3C6C8);
	}
