...
#define CINEMACHINE_DIALOGUESHOTSETTINGS_GET_EDITORCOMPOSITIONS_OFFSET UNITYSDK_OFFSET(0x28F50)
#define CINEMACHINE_DIALOGUESHOTSETTINGS_METHOD_2_ACFE687AEF20661E_OFFSET UNITYSDK_OFFSET(0xD08A0)
#define CINEMACHINE_DIALOGUESHOTSETTINGS_METHOD_2_CF7B7B17AFC7D53A_OFFSET UNITYSDK_OFFSET(0xD0920)
#define CINEMACHINE_DIALOGUESHOTSETTINGS_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xD0880)
#define CINEMACHINE_DIALOGUESHOTSETTINGS_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xD0890)
#define CINEMACHINE_DIALOGUESHOTSETTINGS_SET_EDITORCOMPOSITIONS_OFFSET UNITYSDK_OFFSET(0x28F60)
#define CINEMACHINE_DIALOGUESHOTSETTINGS__CCTOR_OFFSET UNITYSDK_OFFSET(0x99599E0)

namespace Cinemachine
{
	inline static constexpr unsigned int DialogueShotSettings_TypeDefinitionIndex = 39341;

	struct alignas(8) DialogueShotSettings
	{
		static ::Cinemachine::DialogueShotSettings* StaticGet_Default()
		{
			return (::Cinemachine::DialogueShotSettings*)Il2CppClass::FromTypeDefinitionIndex(DialogueShotSettings_TypeDefinitionIndex)->GetStaticField(0x334A0);
		}
