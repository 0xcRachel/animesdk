...
#define AKPOSITIONARRAY_ADD_OFFSET UNITYSDK_OFFSET(0x196F2500)
#define AKPOSITIONARRAY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x196F23A0)
#define AKPOSITIONARRAY_FINALIZE_OFFSET UNITYSDK_OFFSET(0x196F2400)
#define AKPOSITIONARRAY_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x196F2380)
#define AKPOSITIONARRAY_RESET_OFFSET UNITYSDK_OFFSET(0x196F24B0)
#define AKPOSITIONARRAY_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x196F2390)
#define AKPOSITIONARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x196F2340)
