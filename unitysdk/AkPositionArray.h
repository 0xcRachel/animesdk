...
#define AKPOSITIONARRAY_ADD_OFFSET UNITYSDK_OFFSET(0x1A27F150)
#define AKPOSITIONARRAY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A27EFF0)
#define AKPOSITIONARRAY_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A27F050)
#define AKPOSITIONARRAY_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A27EFD0)
#define AKPOSITIONARRAY_RESET_OFFSET UNITYSDK_OFFSET(0x1A27F100)
#define AKPOSITIONARRAY_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A27EFE0)
#define AKPOSITIONARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A27EF90)
