...
#define CLASS_3_CA807220C14CD3E3_DISPOSE_OFFSET UNITYSDK_OFFSET(0x87300B0)
#define CLASS_3_CA807220C14CD3E3_ENTER_OFFSET UNITYSDK_OFFSET(0x87301A0)
#define CLASS_3_CA807220C14CD3E3_GETGAMEPHASETYPE_OFFSET UNITYSDK_OFFSET(0x8730A00)
#define CLASS_3_CA807220C14CD3E3_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x8730780)
#define CLASS_3_CA807220C14CD3E3_LEAVE_OFFSET UNITYSDK_OFFSET(0x8730820)
#define CLASS_3_CA807220C14CD3E3_METHOD_3_8C68E2CDEEC884A6_OFFSET UNITYSDK_OFFSET(0x8730540)
#define CLASS_3_CA807220C14CD3E3_METHOD_3_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0x87303B0)
#define CLASS_3_CA807220C14CD3E3_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x87307E0)
#define CLASS_3_CA807220C14CD3E3_TICK_OFFSET UNITYSDK_OFFSET(0x8730140)
#define CLASS_3_CA807220C14CD3E3__CTOR_OFFSET UNITYSDK_OFFSET(0x872FE00)

inline static constexpr unsigned int Class_3_CA807220C14CD3E3_TypeDefinitionIndex = 48486;
