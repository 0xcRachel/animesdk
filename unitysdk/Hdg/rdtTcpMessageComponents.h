...
#define HDG_RDTTCPMESSAGECOMPONENTS_READ_OFFSET UNITYSDK_OFFSET(0x255C0)
#define HDG_RDTTCPMESSAGECOMPONENTS_WRITE_OFFSET UNITYSDK_OFFSET(0x255B0)

namespace Hdg
{
	inline static constexpr unsigned int rdtTcpMessageComponents_TypeDefinitionIndex = 36975;
