...
#define HDG_RDTDEBUG_ASSERT_OFFSET UNITYSDK_OFFSET(0x80A6EB0)
#define HDG_RDTDEBUG_DEBUG_1_OFFSET UNITYSDK_OFFSET(0x80A5240)
#define HDG_RDTDEBUG_DEBUG_OFFSET UNITYSDK_OFFSET(0x809D130)
#define HDG_RDTDEBUG_ERROR_1_OFFSET UNITYSDK_OFFSET(0x809E970)
#define HDG_RDTDEBUG_ERROR_2_OFFSET UNITYSDK_OFFSET(0x80A5B00)
#define HDG_RDTDEBUG_ERROR_OFFSET UNITYSDK_OFFSET(0x80A6D50)
#define HDG_RDTDEBUG_INFO_1_OFFSET UNITYSDK_OFFSET(0x80A6BA0)
#define HDG_RDTDEBUG_INFO_OFFSET UNITYSDK_OFFSET(0x80A6B50)
#define HDG_RDTDEBUG_LOG_1_OFFSET UNITYSDK_OFFSET(0x80A6670)
#define HDG_RDTDEBUG_LOG_2_OFFSET UNITYSDK_OFFSET(0x80A6910)
#define HDG_RDTDEBUG_LOG_OFFSET UNITYSDK_OFFSET(0x80A6350)
#define HDG_RDTDEBUG_WARNING_1_OFFSET UNITYSDK_OFFSET(0x80A6D00)
#define HDG_RDTDEBUG_WARNING_OFFSET UNITYSDK_OFFSET(0x809DDE0)
#define HDG_RDTDEBUG__CCTOR_OFFSET UNITYSDK_OFFSET(0x80A6F70)
#define HDG_RDTDEBUG__CTOR_OFFSET UNITYSDK_OFFSET(0x80A6F60)

namespace Hdg
{
	inline static constexpr unsigned int rdtDebug_TypeDefinitionIndex = 36947;
	...
	public:
		...
		{
			return (::Hdg::rdtDebug_LogLevel*)Il2CppClass::FromTypeDefinitionIndex(rdtDebug_TypeDefinitionIndex)->GetStaticField(0xCEF0);
		}
