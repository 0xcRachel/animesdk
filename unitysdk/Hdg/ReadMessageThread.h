...
#define HDG_READMESSAGETHREAD_GET_ISCONNECTED_OFFSET UNITYSDK_OFFSET(0x19C5E690)
#define HDG_READMESSAGETHREAD_ONLOSTCONNECTION_OFFSET UNITYSDK_OFFSET(0x19C5F440)
#define HDG_READMESSAGETHREAD_ONREADING_OFFSET UNITYSDK_OFFSET(0x19C5EA00)
#define HDG_READMESSAGETHREAD_STOP_OFFSET UNITYSDK_OFFSET(0x19C5E8F0)
#define HDG_READMESSAGETHREAD_THREADFUNC_OFFSET UNITYSDK_OFFSET(0x19C5E920)
#define HDG_READMESSAGETHREAD__CTOR_OFFSET UNITYSDK_OFFSET(0x19C5E6A0)
...
namespace Hdg
{
	...
	public:
		...
		::System::IO::BinaryReader* m_reader; // 0x30
