...
#define HDG_RDTSERIALIZERTEXTURE_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x80B3C20)
#define HDG_RDTSERIALIZERTEXTURE_READ_OFFSET UNITYSDK_OFFSET(0x80B3C60)
#define HDG_RDTSERIALIZERTEXTURE_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x80B3B60)
#define HDG_RDTSERIALIZERTEXTURE_WRITE_OFFSET UNITYSDK_OFFSET(0x80B3C30)
#define HDG_RDTSERIALIZERTEXTURE__CTOR_OFFSET UNITYSDK_OFFSET(0x80B3C10)

namespace Hdg
{
	inline static constexpr unsigned int rdtSerializerTexture_TypeDefinitionIndex = 36970;
