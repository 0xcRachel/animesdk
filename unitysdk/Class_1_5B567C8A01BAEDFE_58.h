...
#define CLASS_1_5B567C8A01BAEDFE_58_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A709830)
#define CLASS_1_5B567C8A01BAEDFE_58_CLONE_OFFSET UNITYSDK_OFFSET(0x1A7096A0)
#define CLASS_1_5B567C8A01BAEDFE_58_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A709740)
#define CLASS_1_5B567C8A01BAEDFE_58_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A7096E0)
#define CLASS_1_5B567C8A01BAEDFE_58_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A709790)
#define CLASS_1_5B567C8A01BAEDFE_58_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A709880)
#define CLASS_1_5B567C8A01BAEDFE_58_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A709850)
#define CLASS_1_5B567C8A01BAEDFE_58_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A709620)
#define CLASS_1_5B567C8A01BAEDFE_58_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A709650)
#define CLASS_1_5B567C8A01BAEDFE_58_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A7097C0)
#define CLASS_1_5B567C8A01BAEDFE_58_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A709820)
#define CLASS_1_5B567C8A01BAEDFE_58__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A7098D0)
#define CLASS_1_5B567C8A01BAEDFE_58__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A709670)
#define CLASS_1_5B567C8A01BAEDFE_58__CTOR_OFFSET UNITYSDK_OFFSET(0x1A709660)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_58*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_58_TypeDefinitionIndex)->GetStaticField(0x2480);
	}
