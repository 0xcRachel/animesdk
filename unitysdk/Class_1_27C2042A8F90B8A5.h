...
#define CLASS_1_27C2042A8F90B8A5_EXECUTE_OFFSET UNITYSDK_OFFSET(0x10995570)
#define CLASS_1_27C2042A8F90B8A5_METHOD_1_79FB083850EAFF8F_OFFSET UNITYSDK_OFFSET(0x10995060)
#define CLASS_1_27C2042A8F90B8A5_METHOD_1_A27DC2C5A103933A_OFFSET UNITYSDK_OFFSET(0x109954A0)
#define CLASS_1_27C2042A8F90B8A5_METHOD_1_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0x109952E0)
#define CLASS_1_27C2042A8F90B8A5_TICK_OFFSET UNITYSDK_OFFSET(0x10995740)
#define CLASS_1_27C2042A8F90B8A5__CTOR_OFFSET UNITYSDK_OFFSET(0x10995000)

inline static constexpr unsigned int Class_1_27C2042A8F90B8A5_TypeDefinitionIndex = 61193;
...
public:
	...
	::RPG::Client::LittleGame::ChimeraDuel::ChimeraDuelChimeraCache* Field_1_0; // 0x18
	::System::Collections::Generic::List_1<::Class_1_43BD383C98B4C0C5_173*>* Field_1_2; // 0x20
	::System::Collections::Generic::List_1<::RPG::Client::LittleGame::ChimeraDuel::ChimeraDuelChimeraCache*>* Field_1_1; // 0x28
	...
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_F9FBCC956DFCF137_13*, ::System::Action*))((::PBYTE)hIl2Cpp + CLASS_1_27C2042A8F90B8A5_EXECUTE_OFFSET))(this, a1, a2);
	}
