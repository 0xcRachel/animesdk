...
#define CLASS_2_D2FADB5DB88DD906_COLLECT_OFFSET UNITYSDK_OFFSET(0xB8B6800)
#define CLASS_2_D2FADB5DB88DD906_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB8B6770)
#define CLASS_2_D2FADB5DB88DD906_FLUSH_OFFSET UNITYSDK_OFFSET(0xB8B6840)
#define CLASS_2_D2FADB5DB88DD906_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0xB8B6900)
#define CLASS_2_D2FADB5DB88DD906_METHOD_2_2482F898F6C36FF8_OFFSET UNITYSDK_OFFSET(0xB8B66D0)
#define CLASS_2_D2FADB5DB88DD906_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xB8B6420)
#define CLASS_2_D2FADB5DB88DD906_METHOD_2_8A7706FE513EFB6E_OFFSET UNITYSDK_OFFSET(0xB8B6480)
#define CLASS_2_D2FADB5DB88DD906_METHOD_2_B3C3FE20F7F01305_OFFSET UNITYSDK_OFFSET(0xB8B65D0)
#define CLASS_2_D2FADB5DB88DD906_METHOD_2_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xB8B63D0)
#define CLASS_2_D2FADB5DB88DD906_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB8B67C0)
#define CLASS_2_D2FADB5DB88DD906_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xB8B68C0)
#define CLASS_2_D2FADB5DB88DD906_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB8B6880)
#define CLASS_2_D2FADB5DB88DD906_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0xB8B6910)
#define CLASS_2_D2FADB5DB88DD906__CTOR_OFFSET UNITYSDK_OFFSET(0xB8B6310)
#define CLASS_2_D2FADB5DB88DD906___IFIXBASEPROXY_COLLECT_OFFSET UNITYSDK_OFFSET(0xB8B6970)
#define CLASS_2_D2FADB5DB88DD906___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB8B6920)
#define CLASS_2_D2FADB5DB88DD906___IFIXBASEPROXY_FLUSH_OFFSET UNITYSDK_OFFSET(0xB8B69B0)
#define CLASS_2_D2FADB5DB88DD906___IFIXBASEPROXY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xB8B6A30)
#define CLASS_2_D2FADB5DB88DD906___IFIXBASEPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB8B69F0)
