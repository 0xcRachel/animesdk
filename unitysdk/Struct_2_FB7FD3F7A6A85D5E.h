...
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_0D7638DBC93E5002_OFFSET UNITYSDK_OFFSET(0x37A6310)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_1D9EE327BF7D6281_OFFSET UNITYSDK_OFFSET(0x37A6360)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_26874F67BD92CEC1_OFFSET UNITYSDK_OFFSET(0x15499C60)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_2F0F99A12DB93F30_OFFSET UNITYSDK_OFFSET(0x15493B20)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_3848E4903F0CA4C5_OFFSET UNITYSDK_OFFSET(0x154947D0)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_47C3094B9BEBAE50_OFFSET UNITYSDK_OFFSET(0x37A63F0)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_4F3148D4BAAF81F3_OFFSET UNITYSDK_OFFSET(0x154949E0)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_51AC7912135C5E23_OFFSET UNITYSDK_OFFSET(0x37A6410)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_56CE4AFC5339F746_OFFSET UNITYSDK_OFFSET(0x37A6320)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_77C7045E7324E8B8_OFFSET UNITYSDK_OFFSET(0x154943E0)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_85C81563BC6E2A2E_OFFSET UNITYSDK_OFFSET(0x15494D50)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_870AF3CD1D0A67B1_OFFSET UNITYSDK_OFFSET(0x37A6340)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_89A99D29D0BEDD89_OFFSET UNITYSDK_OFFSET(0x37A6330)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_9CFA7241D1009D47_OFFSET UNITYSDK_OFFSET(0x37A62F0)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_AC6B8E73BD3BD222_OFFSET UNITYSDK_OFFSET(0x37A6370)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_B799DB9989A18F1D_OFFSET UNITYSDK_OFFSET(0x15499EF0)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_B9686AC129B559BC_OFFSET UNITYSDK_OFFSET(0x37A6400)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_C0FF32B4D2022F8C_OFFSET UNITYSDK_OFFSET(0x15499FE0)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x37A6420)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_F151D5B81568C792_OFFSET UNITYSDK_OFFSET(0x1549A150)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_F5919FB9FE5456D1_OFFSET UNITYSDK_OFFSET(0x15493DE0)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_F620DD2FD48DDF53_OFFSET UNITYSDK_OFFSET(0x37A6350)
#define STRUCT_2_FB7FD3F7A6A85D5E__CCTOR_OFFSET UNITYSDK_OFFSET(0x1549AAB0)
#define STRUCT_2_FB7FD3F7A6A85D5E__CTOR_OFFSET UNITYSDK_OFFSET(0x37A6300)
...
struct alignas(8) Struct_2_FB7FD3F7A6A85D5E
{
	...
	{
		return (::UnityEngine::Camera**)Il2CppClass::FromTypeDefinitionIndex(Struct_2_FB7FD3F7A6A85D5E_TypeDefinitionIndex)->GetStaticField(0x46460);
	}
	static ::RPG::Client::EnvironmentSystem** StaticGet_Field_2_1()
	{
		return (::RPG::Client::EnvironmentSystem**)Il2CppClass::FromTypeDefinitionIndex(Struct_2_FB7FD3F7A6A85D5E_TypeDefinitionIndex)->GetStaticField(0x46468);
	}
	static ::RPG::Client::RefList_1<::Struct_2_FB7FD3F7A6A85D5E>** StaticGet_Field_2_2()
	{
		return (::RPG::Client::RefList_1<::Struct_2_FB7FD3F7A6A85D5E>**)Il2CppClass::FromTypeDefinitionIndex(Struct_2_FB7FD3F7A6A85D5E_TypeDefinitionIndex)->GetStaticField(0x46470);
	}
	static ::System::Single* StaticGet_Field_2_3()
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_FB7FD3F7A6A85D5E_TypeDefinitionIndex)->GetStaticField(0xDDF0);
	}
