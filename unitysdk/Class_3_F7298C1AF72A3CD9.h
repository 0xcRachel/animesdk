...
#define CLASS_3_F7298C1AF72A3CD9_METHOD_3_66810AC65E2A6AED_OFFSET UNITYSDK_OFFSET(0x9933EC0)
#define CLASS_3_F7298C1AF72A3CD9_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x96D4640)
#define CLASS_3_F7298C1AF72A3CD9_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x9933F60)
#define CLASS_3_F7298C1AF72A3CD9_TICK_OFFSET UNITYSDK_OFFSET(0x9933DF0)
#define CLASS_3_F7298C1AF72A3CD9__CTOR_OFFSET UNITYSDK_OFFSET(0x96D45B0)
#define CLASS_3_F7298C1AF72A3CD9___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x9933FF0)

inline static constexpr unsigned int Class_3_F7298C1AF72A3CD9_TypeDefinitionIndex = 41234;

class Class_3_F7298C1AF72A3CD9 : public ::RPG::GameCore::ST_Task_1<::RPG::GameCore::ST_Side_SteerToTarget*>
{
public:
	::Class_2_A5679504C4BE0B4F* Field_3_1; // 0x28
