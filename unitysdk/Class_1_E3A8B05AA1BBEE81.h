...
#define CLASS_1_E3A8B05AA1BBEE81_CLEAR_OFFSET UNITYSDK_OFFSET(0x1102BD80)
#define CLASS_1_E3A8B05AA1BBEE81_METHOD_1_538706B04C2A4407_OFFSET UNITYSDK_OFFSET(0x1102BE30)
#define CLASS_1_E3A8B05AA1BBEE81_METHOD_1_AC7CF00B57D864AB_OFFSET UNITYSDK_OFFSET(0x1102C030)
#define CLASS_1_E3A8B05AA1BBEE81_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1102BF40)
#define CLASS_1_E3A8B05AA1BBEE81__CTOR_OFFSET UNITYSDK_OFFSET(0x1102C490)
#define CLASS_1_E3A8B05AA1BBEE81___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1102C4A0)

inline static constexpr unsigned int Class_1_E3A8B05AA1BBEE81_TypeDefinitionIndex = 44009;
...
public:
	...
	::Struct_2_52A902145F5BE513_3 Field_1_6; // 0x20
