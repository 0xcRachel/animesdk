...
#define CLASS_2_C482ADB053341B9A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10AFA6E0)
#define CLASS_2_C482ADB053341B9A_METHOD_2_2984099754010F2F_OFFSET UNITYSDK_OFFSET(0x10AFAB30)
#define CLASS_2_C482ADB053341B9A_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10AFA790)
#define CLASS_2_C482ADB053341B9A_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10AFABA0)
#define CLASS_2_C482ADB053341B9A_TICK_OFFSET UNITYSDK_OFFSET(0x10AFABF0)
#define CLASS_2_C482ADB053341B9A__CTOR_OFFSET UNITYSDK_OFFSET(0x10AFA6D0)

inline static constexpr unsigned int Class_2_C482ADB053341B9A_TypeDefinitionIndex = 43111;

class Class_2_C482ADB053341B9A : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::MatchThreeDragTutorial* Field_2_0; // 0x20
