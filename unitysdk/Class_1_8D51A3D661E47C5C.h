...
#define CLASS_1_8D51A3D661E47C5C_METHOD_1_0A08BEB5A6FF1267_OFFSET UNITYSDK_OFFSET(0x14FB3610)
#define CLASS_1_8D51A3D661E47C5C_METHOD_1_112C2B8B7932F43A_OFFSET UNITYSDK_OFFSET(0x14FB3220)
#define CLASS_1_8D51A3D661E47C5C_METHOD_1_3C846407474D7238_OFFSET UNITYSDK_OFFSET(0x14FB28D0)
#define CLASS_1_8D51A3D661E47C5C_METHOD_1_7ED03BD5980B3B63_OFFSET UNITYSDK_OFFSET(0x14FB3020)
#define CLASS_1_8D51A3D661E47C5C_METHOD_1_AA7D99BFD4730824_OFFSET UNITYSDK_OFFSET(0x14FB3410)
#define CLASS_1_8D51A3D661E47C5C_METHOD_1_B232DF8FAA17CDA6_OFFSET UNITYSDK_OFFSET(0x14FB2E10)
#define CLASS_1_8D51A3D661E47C5C_METHOD_1_D1830868701D547A_OFFSET UNITYSDK_OFFSET(0x14FB2A20)
#define CLASS_1_8D51A3D661E47C5C_METHOD_1_EF7FF4D68C8A0DF5_OFFSET UNITYSDK_OFFSET(0x14FB27E0)
#define CLASS_1_8D51A3D661E47C5C_START_OFFSET UNITYSDK_OFFSET(0x14FB25F0)
#define CLASS_1_8D51A3D661E47C5C_STOP_OFFSET UNITYSDK_OFFSET(0x14FB2690)
#define CLASS_1_8D51A3D661E47C5C__CTOR_OFFSET UNITYSDK_OFFSET(0x14FB3670)

inline static constexpr unsigned int Class_1_8D51A3D661E47C5C_TypeDefinitionIndex = 73740;

class Class_1_8D51A3D661E47C5C : public ::System::Object
{
public:
	::System::Collections::Generic::Dictionary_2<::Enum_3_A35B38E5F9115A76_2, ::Class_0_16E4307DCC419505_1213*>* Field_1_0; // 0x10
	::RPG::Client::UIController* Field_1_1; // 0x18
	::System::Collections::Generic::Queue_1<::System::ValueTuple_2<::RPG::Client::ChatMessageData*, ::Class_0_16E4307DCC419505_1213*>>* Field_1_2; // 0x20
	::Class_0_16E4307DCC419505_1213* Field_1_3; // 0x28
