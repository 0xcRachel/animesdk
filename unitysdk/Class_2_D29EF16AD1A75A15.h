...
#define CLASS_2_D29EF16AD1A75A15_DISPOSE_OFFSET UNITYSDK_OFFSET(0x12C96730)
#define CLASS_2_D29EF16AD1A75A15_METHOD_2_6A535332060949F6_OFFSET UNITYSDK_OFFSET(0x12C96770)
#define CLASS_2_D29EF16AD1A75A15_METHOD_2_BEFE21FC0773CE57_OFFSET UNITYSDK_OFFSET(0x12C96D80)
#define CLASS_2_D29EF16AD1A75A15_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x12C96940)
#define CLASS_2_D29EF16AD1A75A15_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x12C97060)
#define CLASS_2_D29EF16AD1A75A15_TICK_OFFSET UNITYSDK_OFFSET(0x12C970B0)
#define CLASS_2_D29EF16AD1A75A15__CTOR_OFFSET UNITYSDK_OFFSET(0x12C96720)
...
public:
	...
	::RPG::GameCore::ShiftLocalPlayerByAnchor* Field_2_0; // 0x20
