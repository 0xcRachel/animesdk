...
#define CLASS_1_B6E0C68C7CFFEF5B_GET_ISBOSSPANEL_OFFSET UNITYSDK_OFFSET(0x14FBC8E0)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_086772AC32D6BFC9_OFFSET UNITYSDK_OFFSET(0x14FBB950)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_17F22C055863E893_1_OFFSET UNITYSDK_OFFSET(0x14FBB850)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_17F22C055863E893_2_OFFSET UNITYSDK_OFFSET(0x14FBB8D0)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_17F22C055863E893_OFFSET UNITYSDK_OFFSET(0x14FBB7D0)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x14FBB770)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_2DB9E513187D6683_OFFSET UNITYSDK_OFFSET(0x14FBBB70)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_30E7533A487BD75C_OFFSET UNITYSDK_OFFSET(0x14FBBA60)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_3845AD389B8E1E47_OFFSET UNITYSDK_OFFSET(0x14FBC7D0)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x14FBB4E0)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_4011FDBF39CB0C46_OFFSET UNITYSDK_OFFSET(0x14FBC140)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_4AADAF19CDCB660E_OFFSET UNITYSDK_OFFSET(0x14FBBCB0)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_4EC2E1ECDEE1B9F2_OFFSET UNITYSDK_OFFSET(0x14FBB6D0)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_4F1BE5A08CA439DD_OFFSET UNITYSDK_OFFSET(0x14FBC240)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_5DB6CF4A7180BD76_OFFSET UNITYSDK_OFFSET(0x14FBC3F0)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_8A76897D6A693475_OFFSET UNITYSDK_OFFSET(0x14FBBE60)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_9214CA70E05AF534_OFFSET UNITYSDK_OFFSET(0x14FBBF70)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_C51E1F14BC0C7341_OFFSET UNITYSDK_OFFSET(0x14FBB5F0)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_CA033AD137D88B69_OFFSET UNITYSDK_OFFSET(0x14FBC4B0)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x14FBB5A0)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_D14D1C669EDC2D6B_OFFSET UNITYSDK_OFFSET(0x14FBB9B0)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_DA5597481994D152_OFFSET UNITYSDK_OFFSET(0x14FBC0E0)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_DE23CE986C1A1789_OFFSET UNITYSDK_OFFSET(0x14FBB470)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_E2A306C5DD2FB440_OFFSET UNITYSDK_OFFSET(0x14FBC1C0)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_EBBD06DFB7C23A9A_OFFSET UNITYSDK_OFFSET(0x14FBC740)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_EDE51B31CB05573F_OFFSET UNITYSDK_OFFSET(0x14FBB530)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_F026F9F94BAA5E1F_OFFSET UNITYSDK_OFFSET(0x14FBC080)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_F31F0AC82813D7EB_1_OFFSET UNITYSDK_OFFSET(0x14FBBDF0)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_F31F0AC82813D7EB_OFFSET UNITYSDK_OFFSET(0x14FBBD80)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_F941B64ADF94EB92_OFFSET UNITYSDK_OFFSET(0x14FBC2C0)
#define CLASS_1_B6E0C68C7CFFEF5B_SET_ISBOSSPANEL_OFFSET UNITYSDK_OFFSET(0x14FBC8F0)
#define CLASS_1_B6E0C68C7CFFEF5B__CCTOR_OFFSET UNITYSDK_OFFSET(0x14FBC900)
#define CLASS_1_B6E0C68C7CFFEF5B__CTOR_OFFSET UNITYSDK_OFFSET(0x14FBB4D0)

inline static constexpr unsigned int Class_1_B6E0C68C7CFFEF5B_TypeDefinitionIndex = 67085;
...
public:
	...
	{
		return (::System::Collections::Generic::List_1<::RPG::GameCore::MonsterWeaknessSpecialType>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B6E0C68C7CFFEF5B_TypeDefinitionIndex)->GetStaticField(0x43410);
	}
