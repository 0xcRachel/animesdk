...
#define AKCALLBACKINFO_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x18385A60)
#define AKCALLBACKINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18385970)
#define AKCALLBACKINFO_FINALIZE_OFFSET UNITYSDK_OFFSET(0x183859F0)
#define AKCALLBACKINFO_GETCPTR_OFFSET UNITYSDK_OFFSET(0x18385860)
#define AKCALLBACKINFO_GET_GAMEOBJID_OFFSET UNITYSDK_OFFSET(0x18385CB0)
#define AKCALLBACKINFO_GET_PCOOKIE_OFFSET UNITYSDK_OFFSET(0x18385C00)
#define AKCALLBACKINFO_SETCPTR_OFFSET UNITYSDK_OFFSET(0x183858B0)
#define AKCALLBACKINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18385D60)
#define AKCALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18385850)

inline static constexpr unsigned int AkCallbackInfo_TypeDefinitionIndex = 33470;
