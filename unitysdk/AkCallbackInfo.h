...
#define AKCALLBACKINFO_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x18BAAC60)
#define AKCALLBACKINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18BAAB70)
#define AKCALLBACKINFO_FINALIZE_OFFSET UNITYSDK_OFFSET(0x18BAABF0)
#define AKCALLBACKINFO_GETCPTR_OFFSET UNITYSDK_OFFSET(0x18BAAA60)
#define AKCALLBACKINFO_GET_GAMEOBJID_OFFSET UNITYSDK_OFFSET(0x18BAAEB0)
#define AKCALLBACKINFO_GET_PCOOKIE_OFFSET UNITYSDK_OFFSET(0x18BAAE00)
#define AKCALLBACKINFO_SETCPTR_OFFSET UNITYSDK_OFFSET(0x18BAAAB0)
#define AKCALLBACKINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18BAAF60)
#define AKCALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18BAAA50)
