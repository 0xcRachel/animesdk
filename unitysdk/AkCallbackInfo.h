...
#define AKCALLBACKINFO_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x19DCFA50)
#define AKCALLBACKINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19DCF930)
#define AKCALLBACKINFO_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19DCF9E0)
#define AKCALLBACKINFO_GETCPTR_OFFSET UNITYSDK_OFFSET(0x19DCF7F0)
#define AKCALLBACKINFO_GET_GAMEOBJID_OFFSET UNITYSDK_OFFSET(0x19DCFCE0)
#define AKCALLBACKINFO_GET_PCOOKIE_OFFSET UNITYSDK_OFFSET(0x19DCFC30)
#define AKCALLBACKINFO_SETCPTR_OFFSET UNITYSDK_OFFSET(0x19DCF840)
#define AKCALLBACKINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19DCFD90)
#define AKCALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19DCF7E0)
