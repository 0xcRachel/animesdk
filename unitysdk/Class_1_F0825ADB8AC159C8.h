...
#define CLASS_1_F0825ADB8AC159C8_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A5AE010)
#define CLASS_1_F0825ADB8AC159C8_CLONE_OFFSET UNITYSDK_OFFSET(0x1A5ADB50)
#define CLASS_1_F0825ADB8AC159C8_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A5ADC80)
#define CLASS_1_F0825ADB8AC159C8_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A5ADC50)
#define CLASS_1_F0825ADB8AC159C8_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A5ADDB0)
#define CLASS_1_F0825ADB8AC159C8_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A5AE220)
#define CLASS_1_F0825ADB8AC159C8_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A5AE1C0)
#define CLASS_1_F0825ADB8AC159C8_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1A5ADC10)
#define CLASS_1_F0825ADB8AC159C8_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x1A5ADBC0)
#define CLASS_1_F0825ADB8AC159C8_METHOD_1_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x1A5ADBB0)
#define CLASS_1_F0825ADB8AC159C8_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A5ADAB0)
#define CLASS_1_F0825ADB8AC159C8_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1A5ADC20)
#define CLASS_1_F0825ADB8AC159C8_METHOD_1_8633AE51B23EBDFD_OFFSET UNITYSDK_OFFSET(0x1A5ADC40)
#define CLASS_1_F0825ADB8AC159C8_METHOD_1_C229FF62B898C0B2_OFFSET UNITYSDK_OFFSET(0x1A5ADC30)
#define CLASS_1_F0825ADB8AC159C8_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A5ADAE0)
#define CLASS_1_F0825ADB8AC159C8_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A5ADEE0)
#define CLASS_1_F0825ADB8AC159C8_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A5ADF40)
#define CLASS_1_F0825ADB8AC159C8__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A5AE460)
#define CLASS_1_F0825ADB8AC159C8__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A5ADB00)
#define CLASS_1_F0825ADB8AC159C8__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5ADAF0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_F0825ADB8AC159C8*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_F0825ADB8AC159C8_TypeDefinitionIndex)->GetStaticField(0x4FDE0);
	}
