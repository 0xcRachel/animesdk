...
#define CLASS_1_290D9E9A5FA9F40F_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x173BEF70)
#define CLASS_1_290D9E9A5FA9F40F_CLONE_OFFSET UNITYSDK_OFFSET(0x173BEB00)
#define CLASS_1_290D9E9A5FA9F40F_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x173BEBD0)
#define CLASS_1_290D9E9A5FA9F40F_EQUALS_OFFSET UNITYSDK_OFFSET(0x173BEBA0)
#define CLASS_1_290D9E9A5FA9F40F_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x173BECF0)
#define CLASS_1_290D9E9A5FA9F40F_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x173BF240)
#define CLASS_1_290D9E9A5FA9F40F_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x173BF0C0)
#define CLASS_1_290D9E9A5FA9F40F_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x173BEB40)
#define CLASS_1_290D9E9A5FA9F40F_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x173BEB80)
#define CLASS_1_290D9E9A5FA9F40F_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x173BEB30)
#define CLASS_1_290D9E9A5FA9F40F_METHOD_1_686CBC4FBD0AAA58_OFFSET UNITYSDK_OFFSET(0x173BEB70)
#define CLASS_1_290D9E9A5FA9F40F_METHOD_1_6BD2A2909D8CFAD3_OFFSET UNITYSDK_OFFSET(0x173BEB60)
#define CLASS_1_290D9E9A5FA9F40F_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x173BEB50)
#define CLASS_1_290D9E9A5FA9F40F_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x173BEB90)
#define CLASS_1_290D9E9A5FA9F40F_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x173BE9B0)
#define CLASS_1_290D9E9A5FA9F40F_TOSTRING_OFFSET UNITYSDK_OFFSET(0x173BEE10)
#define CLASS_1_290D9E9A5FA9F40F_WRITETO_OFFSET UNITYSDK_OFFSET(0x173BEE70)
#define CLASS_1_290D9E9A5FA9F40F__CCTOR_OFFSET UNITYSDK_OFFSET(0x173BF3D0)
#define CLASS_1_290D9E9A5FA9F40F__CTOR_1_OFFSET UNITYSDK_OFFSET(0x173BEA10)
#define CLASS_1_290D9E9A5FA9F40F__CTOR_OFFSET UNITYSDK_OFFSET(0x173BE9C0)

inline static constexpr unsigned int Class_1_290D9E9A5FA9F40F_TypeDefinitionIndex = 24296;
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_290D9E9A5FA9F40F_TypeDefinitionIndex)->GetStaticField(0x38850);
	}
	...
	::Class_1_123C88940E7A8432_1* Field_1_9; // 0x18
	...
	{
		return ((::Class_1_123C88940E7A8432_1*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_290D9E9A5FA9F40F_METHOD_1_24748FC20F375725_OFFSET))(this);
	}

	::System::Void Method_1_8C8625211DA811AE(::Class_1_123C88940E7A8432_1* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_123C88940E7A8432_1*))((::PBYTE)hIl2Cpp + CLASS_1_290D9E9A5FA9F40F_METHOD_1_8C8625211DA811AE_OFFSET))(this, a1);
	}
