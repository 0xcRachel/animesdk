...
#define RVO_RVOMATH_ABSSQ_OFFSET UNITYSDK_OFFSET(0x827E390)
#define RVO_RVOMATH_ABS_OFFSET UNITYSDK_OFFSET(0x827E500)
#define RVO_RVOMATH_DET_OFFSET UNITYSDK_OFFSET(0x827E360)
#define RVO_RVOMATH_DISTSQPOINTLINESEGMENT_OFFSET UNITYSDK_OFFSET(0x8280950)
#define RVO_RVOMATH_FABS_OFFSET UNITYSDK_OFFSET(0x8281950)
#define RVO_RVOMATH_LEFTOF_OFFSET UNITYSDK_OFFSET(0x82843F0)
#define RVO_RVOMATH_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x827E410)
#define RVO_RVOMATH_SQRT_OFFSET UNITYSDK_OFFSET(0x827E480)
#define RVO_RVOMATH_SQR_OFFSET UNITYSDK_OFFSET(0x827C5A0)

namespace RVO
{
	inline static constexpr unsigned int RVOMath_TypeDefinitionIndex = 34294;
