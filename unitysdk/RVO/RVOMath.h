...
#define RVO_RVOMATH_ABSSQ_OFFSET UNITYSDK_OFFSET(0x85D0940)
#define RVO_RVOMATH_ABS_OFFSET UNITYSDK_OFFSET(0x85D0AB0)
#define RVO_RVOMATH_DET_OFFSET UNITYSDK_OFFSET(0x85D0910)
#define RVO_RVOMATH_DISTSQPOINTLINESEGMENT_OFFSET UNITYSDK_OFFSET(0x85D2F00)
#define RVO_RVOMATH_FABS_OFFSET UNITYSDK_OFFSET(0x85D3F00)
#define RVO_RVOMATH_LEFTOF_OFFSET UNITYSDK_OFFSET(0x85D69A0)
#define RVO_RVOMATH_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x85D09C0)
#define RVO_RVOMATH_SQRT_OFFSET UNITYSDK_OFFSET(0x85D0A30)
#define RVO_RVOMATH_SQR_OFFSET UNITYSDK_OFFSET(0x85CEB50)
