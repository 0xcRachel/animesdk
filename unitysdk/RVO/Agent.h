...
#define RVO_AGENT_COMPUTENEIGHBORS_OFFSET UNITYSDK_OFFSET(0x175C8330)
#define RVO_AGENT_COMPUTENEWVELOCITY_OFFSET UNITYSDK_OFFSET(0x175C8580)
#define RVO_AGENT_INSERTAGENTNEIGHBOR_OFFSET UNITYSDK_OFFSET(0x175CBAD0)
#define RVO_AGENT_INSERTOBSTACLENEIGHBOR_OFFSET UNITYSDK_OFFSET(0x175CC2A0)
#define RVO_AGENT_LINEARPROGRAM1_OFFSET UNITYSDK_OFFSET(0x175CCAC0)
#define RVO_AGENT_LINEARPROGRAM2_OFFSET UNITYSDK_OFFSET(0x175CA4E0)
#define RVO_AGENT_LINEARPROGRAM3_OFFSET UNITYSDK_OFFSET(0x175CA8D0)
#define RVO_AGENT_UPDATE_OFFSET UNITYSDK_OFFSET(0x175CCA30)
#define RVO_AGENT__CTOR_OFFSET UNITYSDK_OFFSET(0x175C8240)
...
namespace RVO
{
	...
	public:
		...
		::System::Int32 id_; // 0x30
		::RVO::Vector2 prefVelocity_; // 0x34
		::System::Single height_; // 0x3C
		::System::Single timeHorizon_; // 0x40
		::System::Single maxSpeed_; // 0x44
		::System::Single timeHorizonObst_; // 0x48
