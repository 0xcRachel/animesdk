...
#define RVO_VECTORUTILS_TORVO_1_OFFSET UNITYSDK_OFFSET(0x8289500)
#define RVO_VECTORUTILS_TORVO_OFFSET UNITYSDK_OFFSET(0x82894F0)
#define RVO_VECTORUTILS_TOUNITYX0Z_OFFSET UNITYSDK_OFFSET(0x82894D0)
#define RVO_VECTORUTILS_TOUNITY_OFFSET UNITYSDK_OFFSET(0x82894C0)

namespace RVO
{
	inline static constexpr unsigned int VectorUtils_TypeDefinitionIndex = 34298;
