...
public:
	...
	{
		return (::RPG::Client::NotifyHandler**)Il2CppClass::FromTypeDefinitionIndex(Class_1_66AEEB0CC532087E___O_TypeDefinitionIndex)->GetStaticField(0x53840);
	}
	static ::RPG::Client::NotifyHandler** StaticGet__1___OnAdventureHideLoadingPage()
	{
		return (::RPG::Client::NotifyHandler**)Il2CppClass::FromTypeDefinitionIndex(Class_1_66AEEB0CC532087E___O_TypeDefinitionIndex)->GetStaticField(0x53848);
	}
};
