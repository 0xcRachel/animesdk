...
#define CLASS_2_E7BEC7A83A87308C___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x10A0DB10)
#define CLASS_2_E7BEC7A83A87308C___C__CTOR_OFFSET UNITYSDK_OFFSET(0x10A0DB50)
#define CLASS_2_E7BEC7A83A87308C___C__EVALUATE_B__1_1_OFFSET UNITYSDK_OFFSET(0x10A0DB60)
...
public:
	...
	{
		return (::System::Func_2<::RPG::Client::FateBuffData*, ::System::Int64>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_E7BEC7A83A87308C___c_TypeDefinitionIndex)->GetStaticField(0x576C0);
	}
	static ::Class_2_E7BEC7A83A87308C___c** StaticGet___9()
	{
		return (::Class_2_E7BEC7A83A87308C___c**)Il2CppClass::FromTypeDefinitionIndex(Class_2_E7BEC7A83A87308C___c_TypeDefinitionIndex)->GetStaticField(0x576C8);
	}
