...
#define CLASS_1_5B567C8A01BAEDFE_68_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1AEB9BC0)
#define CLASS_1_5B567C8A01BAEDFE_68_CLONE_OFFSET UNITYSDK_OFFSET(0x1AEB9A30)
#define CLASS_1_5B567C8A01BAEDFE_68_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1AEB9AD0)
#define CLASS_1_5B567C8A01BAEDFE_68_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AEB9A70)
#define CLASS_1_5B567C8A01BAEDFE_68_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AEB9B20)
#define CLASS_1_5B567C8A01BAEDFE_68_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1AEB9C10)
#define CLASS_1_5B567C8A01BAEDFE_68_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1AEB9BE0)
#define CLASS_1_5B567C8A01BAEDFE_68_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1AEB99B0)
#define CLASS_1_5B567C8A01BAEDFE_68_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1AEB99E0)
#define CLASS_1_5B567C8A01BAEDFE_68_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AEB9B50)
#define CLASS_1_5B567C8A01BAEDFE_68_WRITETO_OFFSET UNITYSDK_OFFSET(0x1AEB9BB0)
#define CLASS_1_5B567C8A01BAEDFE_68__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AEB9C60)
#define CLASS_1_5B567C8A01BAEDFE_68__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AEB9A00)
#define CLASS_1_5B567C8A01BAEDFE_68__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEB99F0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_68*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_68_TypeDefinitionIndex)->GetStaticField(0x3D0C0);
	}
