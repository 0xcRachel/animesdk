...
#define CLASS_1_5B567C8A01BAEDFE_26_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19C047A0)
#define CLASS_1_5B567C8A01BAEDFE_26_CLONE_OFFSET UNITYSDK_OFFSET(0x19C04610)
#define CLASS_1_5B567C8A01BAEDFE_26_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19C046B0)
#define CLASS_1_5B567C8A01BAEDFE_26_EQUALS_OFFSET UNITYSDK_OFFSET(0x19C04650)
#define CLASS_1_5B567C8A01BAEDFE_26_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19C04700)
#define CLASS_1_5B567C8A01BAEDFE_26_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19C047F0)
#define CLASS_1_5B567C8A01BAEDFE_26_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19C047C0)
#define CLASS_1_5B567C8A01BAEDFE_26_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19C04590)
#define CLASS_1_5B567C8A01BAEDFE_26_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19C045C0)
#define CLASS_1_5B567C8A01BAEDFE_26_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19C04730)
#define CLASS_1_5B567C8A01BAEDFE_26_WRITETO_OFFSET UNITYSDK_OFFSET(0x19C04790)
#define CLASS_1_5B567C8A01BAEDFE_26__CCTOR_OFFSET UNITYSDK_OFFSET(0x19C04840)
#define CLASS_1_5B567C8A01BAEDFE_26__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19C045E0)
#define CLASS_1_5B567C8A01BAEDFE_26__CTOR_OFFSET UNITYSDK_OFFSET(0x19C045D0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_26*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_26_TypeDefinitionIndex)->GetStaticField(0x39500);
	}
