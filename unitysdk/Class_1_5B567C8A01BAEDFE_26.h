...
#define CLASS_1_5B567C8A01BAEDFE_26_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1AD32CF0)
#define CLASS_1_5B567C8A01BAEDFE_26_CLONE_OFFSET UNITYSDK_OFFSET(0x1AD32B60)
#define CLASS_1_5B567C8A01BAEDFE_26_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1AD32C00)
#define CLASS_1_5B567C8A01BAEDFE_26_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AD32BA0)
#define CLASS_1_5B567C8A01BAEDFE_26_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AD32C50)
#define CLASS_1_5B567C8A01BAEDFE_26_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1AD32D40)
#define CLASS_1_5B567C8A01BAEDFE_26_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1AD32D10)
#define CLASS_1_5B567C8A01BAEDFE_26_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1AD32AE0)
#define CLASS_1_5B567C8A01BAEDFE_26_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1AD32B10)
#define CLASS_1_5B567C8A01BAEDFE_26_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AD32C80)
#define CLASS_1_5B567C8A01BAEDFE_26_WRITETO_OFFSET UNITYSDK_OFFSET(0x1AD32CE0)
#define CLASS_1_5B567C8A01BAEDFE_26__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AD32D90)
#define CLASS_1_5B567C8A01BAEDFE_26__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AD32B30)
#define CLASS_1_5B567C8A01BAEDFE_26__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD32B20)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_26*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_26_TypeDefinitionIndex)->GetStaticField(0x5CE80);
	}
