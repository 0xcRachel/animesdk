...
#define CLASS_2_F7B4A5A8B2B0CB0D_EXECUTE_OFFSET UNITYSDK_OFFSET(0x15F6B630)
#define CLASS_2_F7B4A5A8B2B0CB0D_FILTER_OFFSET UNITYSDK_OFFSET(0x15F6B530)
#define CLASS_2_F7B4A5A8B2B0CB0D_GETTRIGGER_OFFSET UNITYSDK_OFFSET(0x15F6B410)
#define CLASS_2_F7B4A5A8B2B0CB0D__CTOR_OFFSET UNITYSDK_OFFSET(0x15F6B390)
