...
#define CLASS_1_B590C31C505191E5_5_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19D72870)
#define CLASS_1_B590C31C505191E5_5_CLONE_OFFSET UNITYSDK_OFFSET(0x19D72440)
#define CLASS_1_B590C31C505191E5_5_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19D72590)
#define CLASS_1_B590C31C505191E5_5_EQUALS_OFFSET UNITYSDK_OFFSET(0x19D724C0)
#define CLASS_1_B590C31C505191E5_5_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19D72630)
#define CLASS_1_B590C31C505191E5_5_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19D72950)
#define CLASS_1_B590C31C505191E5_5_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19D72900)
#define CLASS_1_B590C31C505191E5_5_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19D722F0)
#define CLASS_1_B590C31C505191E5_5_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x19D724B0)
#define CLASS_1_B590C31C505191E5_5_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x19D724A0)
#define CLASS_1_B590C31C505191E5_5_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x19D72490)
#define CLASS_1_B590C31C505191E5_5_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19D72350)
#define CLASS_1_B590C31C505191E5_5_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19D72740)
#define CLASS_1_B590C31C505191E5_5_WRITETO_OFFSET UNITYSDK_OFFSET(0x19D727A0)
#define CLASS_1_B590C31C505191E5_5__CCTOR_OFFSET UNITYSDK_OFFSET(0x19D72A20)
#define CLASS_1_B590C31C505191E5_5__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19D723B0)
#define CLASS_1_B590C31C505191E5_5__CTOR_OFFSET UNITYSDK_OFFSET(0x19D72360)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_B590C31C505191E5_5*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B590C31C505191E5_5_TypeDefinitionIndex)->GetStaticField(0x42540);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_5()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B590C31C505191E5_5_TypeDefinitionIndex)->GetStaticField(0x42548);
	}
