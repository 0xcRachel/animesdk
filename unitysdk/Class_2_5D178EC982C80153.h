...
#define CLASS_2_5D178EC982C80153_METHOD_2_26FC99A252BCA8D6_OFFSET UNITYSDK_OFFSET(0xC2A36C0)
#define CLASS_2_5D178EC982C80153_METHOD_2_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0xC2A44F0)
#define CLASS_2_5D178EC982C80153_METHOD_2_43D99DDD80B1E30C_OFFSET UNITYSDK_OFFSET(0xC2A3E20)
#define CLASS_2_5D178EC982C80153_METHOD_2_7AEA4B2B25797605_OFFSET UNITYSDK_OFFSET(0xC2A2E50)
#define CLASS_2_5D178EC982C80153_METHOD_2_AFDBE2353EC32F1F_OFFSET UNITYSDK_OFFSET(0xC2A4690)
#define CLASS_2_5D178EC982C80153_METHOD_2_BB171E9B663A64F3_OFFSET UNITYSDK_OFFSET(0xC2A1820)
#define CLASS_2_5D178EC982C80153_METHOD_2_C26C5619A2449105_OFFSET UNITYSDK_OFFSET(0xC2A45D0)
#define CLASS_2_5D178EC982C80153_METHOD_2_C969C48EB0DAEC25_OFFSET UNITYSDK_OFFSET(0xC2A1910)
#define CLASS_2_5D178EC982C80153_METHOD_2_DF3C54A5ADEABAF1_OFFSET UNITYSDK_OFFSET(0xC2A3180)
#define CLASS_2_5D178EC982C80153_METHOD_2_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0xC2A2F80)
#define CLASS_2_5D178EC982C80153__CTOR_1_OFFSET UNITYSDK_OFFSET(0xC2A17B0)
#define CLASS_2_5D178EC982C80153__CTOR_OFFSET UNITYSDK_OFFSET(0xC2A1790)
...
{
public:
	::System::Collections::Generic::List_1<::RPG::Client::CameraFightStateCommonConfig*>* Field_2_3; // 0x38
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::VCameraState, ::RPG::Client::ICameraFightState*>* Field_2_2; // 0x40
	::Class_1_B9C702BA1E12DFA3* Field_2_1; // 0x48
	::System::Single Field_2_7; // 0x50
	::RPG::GameCore::VCameraState Field_2_0; // 0x54
	::Cinemachine::CinemachineBlendDefinition_Style Field_2_4; // 0x58
