...
#define CLASS_2_D5942D9A25263B1F__GETBUTTONS_D__8_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x10547AE0)
#define CLASS_2_D5942D9A25263B1F__GETBUTTONS_D__8_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_RPG_CLIENT_IBATTLESKILLBUTTON__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x10547CC0)
#define CLASS_2_D5942D9A25263B1F__GETBUTTONS_D__8_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_CLIENT_IBATTLESKILLBUTTON__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x10547C50)
#define CLASS_2_D5942D9A25263B1F__GETBUTTONS_D__8_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x10547D50)
#define CLASS_2_D5942D9A25263B1F__GETBUTTONS_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x10547CB0)
#define CLASS_2_D5942D9A25263B1F__GETBUTTONS_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x10547C60)
#define CLASS_2_D5942D9A25263B1F__GETBUTTONS_D__8_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10547AD0)
#define CLASS_2_D5942D9A25263B1F__GETBUTTONS_D__8__CTOR_OFFSET UNITYSDK_OFFSET(0x10546180)

inline static constexpr unsigned int Class_2_D5942D9A25263B1F__GetButtons_d__8_TypeDefinitionIndex = 58952;
