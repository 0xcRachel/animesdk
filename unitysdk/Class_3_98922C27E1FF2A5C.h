...
#define CLASS_3_98922C27E1FF2A5C_EVALUATE_OFFSET UNITYSDK_OFFSET(0x111867C0)
#define CLASS_3_98922C27E1FF2A5C__CTOR_OFFSET UNITYSDK_OFFSET(0x11186790)

inline static constexpr unsigned int Class_3_98922C27E1FF2A5C_TypeDefinitionIndex = 42559;
