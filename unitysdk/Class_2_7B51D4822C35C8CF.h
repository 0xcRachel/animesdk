...
#define CLASS_2_7B51D4822C35C8CF_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1056A760)
#define CLASS_2_7B51D4822C35C8CF_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1056A7A0)
#define CLASS_2_7B51D4822C35C8CF_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1056A9E0)
#define CLASS_2_7B51D4822C35C8CF_TICK_OFFSET UNITYSDK_OFFSET(0x1056AA30)
#define CLASS_2_7B51D4822C35C8CF__CTOR_OFFSET UNITYSDK_OFFSET(0x1056A670)

inline static constexpr unsigned int Class_2_7B51D4822C35C8CF_TypeDefinitionIndex = 43120;
