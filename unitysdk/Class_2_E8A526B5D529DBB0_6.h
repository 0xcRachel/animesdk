...
#define CLASS_2_E8A526B5D529DBB0_6_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x11183010)
#define CLASS_2_E8A526B5D529DBB0_6_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x11183280)
#define CLASS_2_E8A526B5D529DBB0_6_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x111808D0)
#define CLASS_2_E8A526B5D529DBB0_6_GET_TRANS_OFFSET UNITYSDK_OFFSET(0x111808F0)
#define CLASS_2_E8A526B5D529DBB0_6_METHOD_2_40E03D354D1ACC85_OFFSET UNITYSDK_OFFSET(0x111818D0)
#define CLASS_2_E8A526B5D529DBB0_6_METHOD_2_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x11181760)
#define CLASS_2_E8A526B5D529DBB0_6_METHOD_2_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0x11183950)
#define CLASS_2_E8A526B5D529DBB0_6_METHOD_2_5790A55946AA509D_2_OFFSET UNITYSDK_OFFSET(0x111839B0)
#define CLASS_2_E8A526B5D529DBB0_6_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x111838F0)
#define CLASS_2_E8A526B5D529DBB0_6_METHOD_2_86143FF46EAE82B7_OFFSET UNITYSDK_OFFSET(0x11182D40)
#define CLASS_2_E8A526B5D529DBB0_6_METHOD_2_9FD4568D5B9FCD22_OFFSET UNITYSDK_OFFSET(0x111825C0)
#define CLASS_2_E8A526B5D529DBB0_6_METHOD_2_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0x11182F10)
#define CLASS_2_E8A526B5D529DBB0_6_METHOD_2_D4499A0147676A9C_OFFSET UNITYSDK_OFFSET(0x111815D0)
#define CLASS_2_E8A526B5D529DBB0_6_METHOD_2_D8E44F7C510402BB_1_OFFSET UNITYSDK_OFFSET(0x11182400)
#define CLASS_2_E8A526B5D529DBB0_6_METHOD_2_D8E44F7C510402BB_OFFSET UNITYSDK_OFFSET(0x11182240)
#define CLASS_2_E8A526B5D529DBB0_6_METHOD_2_F37CDBD6D46274D2_1_OFFSET UNITYSDK_OFFSET(0x111821C0)
#define CLASS_2_E8A526B5D529DBB0_6_METHOD_2_F37CDBD6D46274D2_2_OFFSET UNITYSDK_OFFSET(0x11182E00)
#define CLASS_2_E8A526B5D529DBB0_6_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x11182140)
#define CLASS_2_E8A526B5D529DBB0_6_SET_INDEX_OFFSET UNITYSDK_OFFSET(0x111808E0)
#define CLASS_2_E8A526B5D529DBB0_6__CTOR_OFFSET UNITYSDK_OFFSET(0x111834A0)
#define CLASS_2_E8A526B5D529DBB0_6__ONBIND_OFFSET UNITYSDK_OFFSET(0x11180900)
#define CLASS_2_E8A526B5D529DBB0_6___IFIXBASEPROXY_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x11183A10)
#define CLASS_2_E8A526B5D529DBB0_6___IFIXBASEPROXY_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x11183A70)
#define CLASS_2_E8A526B5D529DBB0_6___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0x11183890)

inline static constexpr unsigned int Class_2_E8A526B5D529DBB0_6_TypeDefinitionIndex = 59057;
...
public:
	...
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::FeverTimePeriodType, ::UnityEngine::Animation*>* Field_2_17; // 0x70
	...
	::RPG::Client::StoryFeverPileToast* Field_2_10; // 0x98
	::System::String* Field_2_21; // 0xA0
	::UnityEngine::Animation* Field_2_8; // 0xA8
	::System::String* Field_2_24; // 0xB0
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::FeverTimePeriodType, ::RPG::Client::ProgressBar*>* Field_2_16; // 0xB8
	::UnityEngine::UI::Button* Field_2_2; // 0xC0
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::FeverTimePeriodType, ::UnityEngine::Transform*>* Field_2_14; // 0xC8
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::FeverTimePeriodType, ::UnityEngine::UI::SmoothMask*>* Field_2_15; // 0xD0
	::UnityEngine::Transform* Field_2_9; // 0xD8
	::UnityEngine::Transform* Field_2_11; // 0xE0
	::UnityEngine::Transform* Field_2_7; // 0xE8
	::RPG::GameCore::LevelUIComponent* Field_2_26; // 0xF0
	::UnityEngine::UI::Text* Field_2_5; // 0xF8
	...
	::System::UInt32 Field_2_20; // 0x114
