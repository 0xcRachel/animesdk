...
#define CLASS_1_DBE1913405A6C120_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17E0BB70)
#define CLASS_1_DBE1913405A6C120_CLONE_OFFSET UNITYSDK_OFFSET(0x17E0B620)
#define CLASS_1_DBE1913405A6C120_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17E0B6E0)
#define CLASS_1_DBE1913405A6C120_EQUALS_OFFSET UNITYSDK_OFFSET(0x17E0B6B0)
#define CLASS_1_DBE1913405A6C120_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17E0B7D0)
#define CLASS_1_DBE1913405A6C120_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x17E0BEB0)
#define CLASS_1_DBE1913405A6C120_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x17E0BDA0)
#define CLASS_1_DBE1913405A6C120_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x17E0B660)
#define CLASS_1_DBE1913405A6C120_METHOD_1_3DACC45AC8150727_OFFSET UNITYSDK_OFFSET(0x17E0B690)
#define CLASS_1_DBE1913405A6C120_METHOD_1_6E1EC2DF63D7020F_1_OFFSET UNITYSDK_OFFSET(0x17E0B6A0)
#define CLASS_1_DBE1913405A6C120_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x17E0B650)
#define CLASS_1_DBE1913405A6C120_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x17E0B670)
#define CLASS_1_DBE1913405A6C120_METHOD_1_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x17E0B680)
#define CLASS_1_DBE1913405A6C120_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17E0B4D0)
#define CLASS_1_DBE1913405A6C120_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17E0B990)
#define CLASS_1_DBE1913405A6C120_WRITETO_OFFSET UNITYSDK_OFFSET(0x17E0B9F0)
#define CLASS_1_DBE1913405A6C120__CCTOR_OFFSET UNITYSDK_OFFSET(0x17E0BFD0)
#define CLASS_1_DBE1913405A6C120__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17E0B540)
#define CLASS_1_DBE1913405A6C120__CTOR_OFFSET UNITYSDK_OFFSET(0x17E0B4E0)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_AC225A1BAAB9FACC_8*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_DBE1913405A6C120_TypeDefinitionIndex)->GetStaticField(0x1E9B0);
	}
	static ::Google::Protobuf::FieldCodec_1<::Class_1_9D5608F598A30CAC_31*>** StaticGet_Field_1_9()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_9D5608F598A30CAC_31*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_DBE1913405A6C120_TypeDefinitionIndex)->GetStaticField(0x1E9B8);
	}
	...
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_AC225A1BAAB9FACC_8*>* Field_1_3; // 0x18
	::Google::Protobuf::UnknownFieldSet* Field_1_0; // 0x20
	::Enum_3_0A3761FE34514D6C_62 Field_1_7; // 0x28
