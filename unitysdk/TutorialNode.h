...
#define TUTORIALNODE_ADDCHILD_OFFSET UNITYSDK_OFFSET(0xAC36670)
#define TUTORIALNODE_CLEAR_OFFSET UNITYSDK_OFFSET(0xAC36830)
#define TUTORIALNODE_COPYTO_OFFSET UNITYSDK_OFFSET(0xAC35B70)
#define TUTORIALNODE_FORCEREGISTER_OFFSET UNITYSDK_OFFSET(0xAC363B0)
#define TUTORIALNODE_GETSHOWREGISTERID_OFFSET UNITYSDK_OFFSET(0xAC35BF0)
#define TUTORIALNODE_ITUTORIALNODE_CANBEREPLACEDBY_OFFSET UNITYSDK_OFFSET(0xAC35C30)
#define TUTORIALNODE_ITUTORIALNODE_GETTRANSFORM_OFFSET UNITYSDK_OFFSET(0xAC35FB0)
#define TUTORIALNODE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xAC36A00)
#define TUTORIALNODE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xAC36BB0)
#define TUTORIALNODE_ONLIGHTWEIGHTACTIVATE_OFFSET UNITYSDK_OFFSET(0xAC36C00)
#define TUTORIALNODE_RPG_CLIENT_IPOOLABLECOMPONENT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xAC36C90)
#define TUTORIALNODE_RPG_CLIENT_IPOOLABLECOMPONENT_SPAWNED_OFFSET UNITYSDK_OFFSET(0xAC36C50)
#define TUTORIALNODE_SETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0xAC36740)
#define TUTORIALNODE_SHOWREGISTERID_OFFSET UNITYSDK_OFFSET(0xAC35A00)
#define TUTORIALNODE_START_OFFSET UNITYSDK_OFFSET(0xAC36880)
#define TUTORIALNODE_TRYREGISTER_OFFSET UNITYSDK_OFFSET(0xAC36000)
#define TUTORIALNODE_UNREGISTER_OFFSET UNITYSDK_OFFSET(0xAC36530)
#define TUTORIALNODE__CHECKPLATFORM_OFFSET UNITYSDK_OFFSET(0xAC36CE0)
#define TUTORIALNODE__CONSTRUCTID_OFFSET UNITYSDK_OFFSET(0xAC35AD0)
#define TUTORIALNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xAC36D70)
#define TUTORIALNODE__ISVALID_OFFSET UNITYSDK_OFFSET(0xAC35EA0)
#define TUTORIALNODE__SHOULDREGISTER_OFFSET UNITYSDK_OFFSET(0xAC36190)
