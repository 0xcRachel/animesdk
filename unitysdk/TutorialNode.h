...
#define TUTORIALNODE_ADDCHILD_OFFSET UNITYSDK_OFFSET(0xE27F4D0)
#define TUTORIALNODE_CLEAR_OFFSET UNITYSDK_OFFSET(0xE27F6F0)
#define TUTORIALNODE_COPYTO_OFFSET UNITYSDK_OFFSET(0xE27EA00)
#define TUTORIALNODE_FORCEREGISTER_OFFSET UNITYSDK_OFFSET(0xE27F210)
#define TUTORIALNODE_GETSHOWREGISTERID_OFFSET UNITYSDK_OFFSET(0xE27EA80)
#define TUTORIALNODE_ITUTORIALNODE_CANBEREPLACEDBY_OFFSET UNITYSDK_OFFSET(0xE27EAC0)
#define TUTORIALNODE_ITUTORIALNODE_GETTRANSFORM_OFFSET UNITYSDK_OFFSET(0xE27EE10)
#define TUTORIALNODE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xE27F8C0)
#define TUTORIALNODE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xE27FA80)
#define TUTORIALNODE_ONLIGHTWEIGHTACTIVATE_OFFSET UNITYSDK_OFFSET(0xE27FAD0)
#define TUTORIALNODE_RPG_CLIENT_IPOOLABLECOMPONENT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xE27FB60)
#define TUTORIALNODE_RPG_CLIENT_IPOOLABLECOMPONENT_SPAWNED_OFFSET UNITYSDK_OFFSET(0xE27FB20)
#define TUTORIALNODE_SETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0xE27F5E0)
#define TUTORIALNODE_SHOWREGISTERID_OFFSET UNITYSDK_OFFSET(0xE27E890)
#define TUTORIALNODE_START_OFFSET UNITYSDK_OFFSET(0xE27F740)
#define TUTORIALNODE_TRYREGISTER_OFFSET UNITYSDK_OFFSET(0xE27EE60)
#define TUTORIALNODE_UNREGISTER_OFFSET UNITYSDK_OFFSET(0xE27F390)
#define TUTORIALNODE__CHECKPLATFORM_OFFSET UNITYSDK_OFFSET(0xE27FBB0)
#define TUTORIALNODE__CONSTRUCTID_OFFSET UNITYSDK_OFFSET(0xE27E960)
#define TUTORIALNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xE27FC40)
#define TUTORIALNODE__ISVALID_OFFSET UNITYSDK_OFFSET(0xE27ED00)
#define TUTORIALNODE__SHOULDREGISTER_OFFSET UNITYSDK_OFFSET(0xE27EFF0)
