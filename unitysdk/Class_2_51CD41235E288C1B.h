...
#define CLASS_2_51CD41235E288C1B_DISPOSE_OFFSET UNITYSDK_OFFSET(0xEEA47C0)
#define CLASS_2_51CD41235E288C1B_METHOD_2_2B9D478141E0F891_OFFSET UNITYSDK_OFFSET(0xEEA4300)
#define CLASS_2_51CD41235E288C1B_METHOD_2_37D3D9A3F3244B90_OFFSET UNITYSDK_OFFSET(0xEEA4560)
#define CLASS_2_51CD41235E288C1B_METHOD_2_98511BB23D2E3748_OFFSET UNITYSDK_OFFSET(0xEEA48B0)
#define CLASS_2_51CD41235E288C1B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xEEA4070)
#define CLASS_2_51CD41235E288C1B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xEEA4800)
#define CLASS_2_51CD41235E288C1B_TICK_OFFSET UNITYSDK_OFFSET(0xEEA4850)
#define CLASS_2_51CD41235E288C1B__CTOR_OFFSET UNITYSDK_OFFSET(0xEEA4060)

inline static constexpr unsigned int Class_2_51CD41235E288C1B_TypeDefinitionIndex = 41906;

class Class_2_51CD41235E288C1B : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_2; // 0x18
	::Class_2_A48F3719AA1CF200_6* Field_2_3; // 0x20
	::RPG::GameCore::GameEntity* Field_2_0; // 0x28
	::RPG::GameCore::PlayPenaconyEndmostShowPage* Field_2_1; // 0x30
