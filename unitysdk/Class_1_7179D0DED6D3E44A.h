...
#define CLASS_1_7179D0DED6D3E44A_GETCONTENTHASH_OFFSET UNITYSDK_OFFSET(0x15E313F0)
#define CLASS_1_7179D0DED6D3E44A_GETDOWNLOADRELATIVEBUNDLELOADPATH_OFFSET UNITYSDK_OFFSET(0x15E31330)
#define CLASS_1_7179D0DED6D3E44A_GETFILESIZE_OFFSET UNITYSDK_OFFSET(0x15E313B0)
#define CLASS_1_7179D0DED6D3E44A_GETLOADRELATIVEBUNDLELOADPATH_OFFSET UNITYSDK_OFFSET(0x15E31510)
#define CLASS_1_7179D0DED6D3E44A_GET_ASSETFLAGS_OFFSET UNITYSDK_OFFSET(0x15E31240)
#define CLASS_1_7179D0DED6D3E44A_GET_BLOCKCONTENTHASH_OFFSET UNITYSDK_OFFSET(0x15E31270)
#define CLASS_1_7179D0DED6D3E44A_GET_BLOCKINDEX_OFFSET UNITYSDK_OFFSET(0x15E30F90)
#define CLASS_1_7179D0DED6D3E44A_GET_BUNDLESHORTNAME_OFFSET UNITYSDK_OFFSET(0x15E31260)
#define CLASS_1_7179D0DED6D3E44A_GET_FILESIZE_OFFSET UNITYSDK_OFFSET(0x15E0BD90)
#define CLASS_1_7179D0DED6D3E44A_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x15E31250)
#define CLASS_1_7179D0DED6D3E44A_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x15E30FB0)
#define CLASS_1_7179D0DED6D3E44A_GET_RELATIVEPATH_OFFSET UNITYSDK_OFFSET(0x15E315E0)
#define CLASS_1_7179D0DED6D3E44A_GET_SUBPACKID_OFFSET UNITYSDK_OFFSET(0x15E31220)
#define CLASS_1_7179D0DED6D3E44A_ISNEEDWRITECONTENTHASHFILE_OFFSET UNITYSDK_OFFSET(0x15E314D0)
#define CLASS_1_7179D0DED6D3E44A_ISPATCH_OFFSET UNITYSDK_OFFSET(0x15E31490)
#define CLASS_1_7179D0DED6D3E44A_ISTMPFILENAMEADDFILEHASH_OFFSET UNITYSDK_OFFSET(0x15E31450)
#define CLASS_1_7179D0DED6D3E44A_METHOD_1_262F3A7EADBD3DE2_OFFSET UNITYSDK_OFFSET(0x15E31130)
#define CLASS_1_7179D0DED6D3E44A_METHOD_1_4FD8751E0FE2002F_OFFSET UNITYSDK_OFFSET(0x15E31590)
#define CLASS_1_7179D0DED6D3E44A_METHOD_1_88B60F3B95FAA4F1_1_OFFSET UNITYSDK_OFFSET(0x15E31080)
#define CLASS_1_7179D0DED6D3E44A_METHOD_1_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x15E30FD0)
#define CLASS_1_7179D0DED6D3E44A_SET_BLOCKCONTENTHASH_OFFSET UNITYSDK_OFFSET(0x15E312C0)
#define CLASS_1_7179D0DED6D3E44A_SET_BLOCKINDEX_OFFSET UNITYSDK_OFFSET(0x15E30FA0)
#define CLASS_1_7179D0DED6D3E44A_SET_OFFSET_OFFSET UNITYSDK_OFFSET(0x15E30FC0)
#define CLASS_1_7179D0DED6D3E44A_SET_RELATIVEPATH_OFFSET UNITYSDK_OFFSET(0x15E315F0)
#define CLASS_1_7179D0DED6D3E44A_SET_SUBPACKID_OFFSET UNITYSDK_OFFSET(0x15E31230)
#define CLASS_1_7179D0DED6D3E44A_TOSTRING_OFFSET UNITYSDK_OFFSET(0x15E31600)
#define CLASS_1_7179D0DED6D3E44A__CTOR_OFFSET UNITYSDK_OFFSET(0x15E078D0)
#define CLASS_1_7179D0DED6D3E44A___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x15E316F0)

inline static constexpr unsigned int Class_1_7179D0DED6D3E44A_TypeDefinitionIndex = 31222;
...
public:
	...
	::RPG::Client::ByteHash16 Field_1_6; // 0x2C
	::RPG::Client::ByteHash16 Field_1_5; // 0x3C
	::System::UInt32 Field_1_1; // 0x4C
	::System::UInt32 Field_1_0; // 0x50
	::RPG::Client::ByteHash16 Field_1_4; // 0x54
	::RPG::Client::ByteHash16 Field_1_7; // 0x64
	::System::Int32 _SubPackId_k__BackingField; // 0x74
	::System::UInt32 _BlockIndex_k__BackingField; // 0x78
