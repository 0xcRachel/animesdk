...
#define CLASS_1_7179D0DED6D3E44A_GETCONTENTHASH_OFFSET UNITYSDK_OFFSET(0x16FA4E30)
#define CLASS_1_7179D0DED6D3E44A_GETDOWNLOADRELATIVEBUNDLELOADPATH_OFFSET UNITYSDK_OFFSET(0x16FA4D70)
#define CLASS_1_7179D0DED6D3E44A_GETFILESIZE_OFFSET UNITYSDK_OFFSET(0x16FA4DF0)
#define CLASS_1_7179D0DED6D3E44A_GETLOADRELATIVEBUNDLELOADPATH_OFFSET UNITYSDK_OFFSET(0x16FA4F50)
#define CLASS_1_7179D0DED6D3E44A_GET_ASSETFLAGS_OFFSET UNITYSDK_OFFSET(0x16FA4C80)
#define CLASS_1_7179D0DED6D3E44A_GET_BLOCKCONTENTHASH_OFFSET UNITYSDK_OFFSET(0x16FA4CB0)
#define CLASS_1_7179D0DED6D3E44A_GET_BLOCKINDEX_OFFSET UNITYSDK_OFFSET(0x16FA49D0)
#define CLASS_1_7179D0DED6D3E44A_GET_BUNDLESHORTNAME_OFFSET UNITYSDK_OFFSET(0x16FA4CA0)
#define CLASS_1_7179D0DED6D3E44A_GET_FILESIZE_OFFSET UNITYSDK_OFFSET(0x16F8F520)
#define CLASS_1_7179D0DED6D3E44A_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x16FA4C90)
#define CLASS_1_7179D0DED6D3E44A_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x16FA49F0)
#define CLASS_1_7179D0DED6D3E44A_GET_RELATIVEPATH_OFFSET UNITYSDK_OFFSET(0x16FA5020)
#define CLASS_1_7179D0DED6D3E44A_GET_SUBPACKID_OFFSET UNITYSDK_OFFSET(0x16FA4C60)
#define CLASS_1_7179D0DED6D3E44A_ISNEEDWRITECONTENTHASHFILE_OFFSET UNITYSDK_OFFSET(0x16FA4F10)
#define CLASS_1_7179D0DED6D3E44A_ISPATCH_OFFSET UNITYSDK_OFFSET(0x16FA4ED0)
#define CLASS_1_7179D0DED6D3E44A_ISTMPFILENAMEADDFILEHASH_OFFSET UNITYSDK_OFFSET(0x16FA4E90)
#define CLASS_1_7179D0DED6D3E44A_METHOD_1_262F3A7EADBD3DE2_OFFSET UNITYSDK_OFFSET(0x16FA4B70)
#define CLASS_1_7179D0DED6D3E44A_METHOD_1_4FD8751E0FE2002F_OFFSET UNITYSDK_OFFSET(0x16FA4FD0)
#define CLASS_1_7179D0DED6D3E44A_METHOD_1_88B60F3B95FAA4F1_1_OFFSET UNITYSDK_OFFSET(0x16FA4AC0)
#define CLASS_1_7179D0DED6D3E44A_METHOD_1_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x16FA4A10)
#define CLASS_1_7179D0DED6D3E44A_SET_BLOCKCONTENTHASH_OFFSET UNITYSDK_OFFSET(0x16FA4D00)
#define CLASS_1_7179D0DED6D3E44A_SET_BLOCKINDEX_OFFSET UNITYSDK_OFFSET(0x16FA49E0)
#define CLASS_1_7179D0DED6D3E44A_SET_OFFSET_OFFSET UNITYSDK_OFFSET(0x16FA4A00)
#define CLASS_1_7179D0DED6D3E44A_SET_RELATIVEPATH_OFFSET UNITYSDK_OFFSET(0x16FA5030)
#define CLASS_1_7179D0DED6D3E44A_SET_SUBPACKID_OFFSET UNITYSDK_OFFSET(0x16FA4C70)
#define CLASS_1_7179D0DED6D3E44A_TOSTRING_OFFSET UNITYSDK_OFFSET(0x16FA5040)
#define CLASS_1_7179D0DED6D3E44A__CTOR_OFFSET UNITYSDK_OFFSET(0x16FA19D0)
#define CLASS_1_7179D0DED6D3E44A___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x16FA5130)
...
public:
	...
	::RPG::Client::ByteHash16 Field_1_7; // 0x28
	::RPG::Client::ByteHash16 Field_1_6; // 0x38
	::RPG::Client::ByteHash16 Field_1_5; // 0x48
	::RPG::Client::ByteHash16 Field_1_4; // 0x58
	::System::UInt32 _Offset_k__BackingField; // 0x68
	::System::Int32 _SubPackId_k__BackingField; // 0x6C
