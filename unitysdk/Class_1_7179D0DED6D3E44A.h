...
#define CLASS_1_7179D0DED6D3E44A_GETCONTENTHASH_OFFSET UNITYSDK_OFFSET(0x1650A610)
#define CLASS_1_7179D0DED6D3E44A_GETDOWNLOADRELATIVEBUNDLELOADPATH_OFFSET UNITYSDK_OFFSET(0x1650A550)
#define CLASS_1_7179D0DED6D3E44A_GETFILESIZE_OFFSET UNITYSDK_OFFSET(0x1650A5D0)
#define CLASS_1_7179D0DED6D3E44A_GETLOADRELATIVEBUNDLELOADPATH_OFFSET UNITYSDK_OFFSET(0x1650A730)
#define CLASS_1_7179D0DED6D3E44A_GET_ASSETFLAGS_OFFSET UNITYSDK_OFFSET(0x1650A460)
#define CLASS_1_7179D0DED6D3E44A_GET_BLOCKCONTENTHASH_OFFSET UNITYSDK_OFFSET(0x1650A490)
#define CLASS_1_7179D0DED6D3E44A_GET_BLOCKINDEX_OFFSET UNITYSDK_OFFSET(0x1650A1A0)
#define CLASS_1_7179D0DED6D3E44A_GET_BUNDLESHORTNAME_OFFSET UNITYSDK_OFFSET(0x1650A480)
#define CLASS_1_7179D0DED6D3E44A_GET_FILESIZE_OFFSET UNITYSDK_OFFSET(0x1650A450)
#define CLASS_1_7179D0DED6D3E44A_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x1650A470)
#define CLASS_1_7179D0DED6D3E44A_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1650A1C0)
#define CLASS_1_7179D0DED6D3E44A_GET_RELATIVEPATH_OFFSET UNITYSDK_OFFSET(0x1650A800)
#define CLASS_1_7179D0DED6D3E44A_GET_SUBPACKID_OFFSET UNITYSDK_OFFSET(0x1650A430)
#define CLASS_1_7179D0DED6D3E44A_ISNEEDWRITECONTENTHASHFILE_OFFSET UNITYSDK_OFFSET(0x1650A6F0)
#define CLASS_1_7179D0DED6D3E44A_ISPATCH_OFFSET UNITYSDK_OFFSET(0x1650A6B0)
#define CLASS_1_7179D0DED6D3E44A_ISTMPFILENAMEADDFILEHASH_OFFSET UNITYSDK_OFFSET(0x1650A670)
#define CLASS_1_7179D0DED6D3E44A_METHOD_1_262F3A7EADBD3DE2_OFFSET UNITYSDK_OFFSET(0x1650A340)
#define CLASS_1_7179D0DED6D3E44A_METHOD_1_4FD8751E0FE2002F_OFFSET UNITYSDK_OFFSET(0x1650A7B0)
#define CLASS_1_7179D0DED6D3E44A_METHOD_1_88B60F3B95FAA4F1_1_OFFSET UNITYSDK_OFFSET(0x1650A290)
#define CLASS_1_7179D0DED6D3E44A_METHOD_1_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x1650A1E0)
#define CLASS_1_7179D0DED6D3E44A_SET_BLOCKCONTENTHASH_OFFSET UNITYSDK_OFFSET(0x1650A4E0)
#define CLASS_1_7179D0DED6D3E44A_SET_BLOCKINDEX_OFFSET UNITYSDK_OFFSET(0x1650A1B0)
#define CLASS_1_7179D0DED6D3E44A_SET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1650A1D0)
#define CLASS_1_7179D0DED6D3E44A_SET_RELATIVEPATH_OFFSET UNITYSDK_OFFSET(0x1650A810)
#define CLASS_1_7179D0DED6D3E44A_SET_SUBPACKID_OFFSET UNITYSDK_OFFSET(0x1650A440)
#define CLASS_1_7179D0DED6D3E44A_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1650A820)
#define CLASS_1_7179D0DED6D3E44A__CTOR_OFFSET UNITYSDK_OFFSET(0x164F5CB0)
#define CLASS_1_7179D0DED6D3E44A___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1650A910)
...
public:
	...
	::RPG::Client::ByteHash16 Field_1_4; // 0x2C
	::System::Int32 _SubPackId_k__BackingField; // 0x3C
	::System::UInt32 Field_1_0; // 0x40
	::System::UInt32 _BlockIndex_k__BackingField; // 0x44
	::RPG::Client::ByteHash16 Field_1_7; // 0x48
	::System::UInt32 _Offset_k__BackingField; // 0x58
	::RPG::Client::ByteHash16 Field_1_5; // 0x5C
	::RPG::Client::ByteHash16 Field_1_6; // 0x6C
