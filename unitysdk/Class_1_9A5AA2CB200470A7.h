...
#define CLASS_1_9A5AA2CB200470A7_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x18198FB0)
#define CLASS_1_9A5AA2CB200470A7_CLONE_OFFSET UNITYSDK_OFFSET(0x18198BF0)
#define CLASS_1_9A5AA2CB200470A7_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x18198CC0)
#define CLASS_1_9A5AA2CB200470A7_EQUALS_OFFSET UNITYSDK_OFFSET(0x18198C90)
#define CLASS_1_9A5AA2CB200470A7_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x18198D90)
#define CLASS_1_9A5AA2CB200470A7_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x18199280)
#define CLASS_1_9A5AA2CB200470A7_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x181991F0)
#define CLASS_1_9A5AA2CB200470A7_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x18198C70)
#define CLASS_1_9A5AA2CB200470A7_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x18198C20)
#define CLASS_1_9A5AA2CB200470A7_METHOD_1_2173B7DC51E1A95B_OFFSET UNITYSDK_OFFSET(0x18198C60)
#define CLASS_1_9A5AA2CB200470A7_METHOD_1_3DACC45AC8150727_OFFSET UNITYSDK_OFFSET(0x18198C50)
#define CLASS_1_9A5AA2CB200470A7_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x18198C80)
#define CLASS_1_9A5AA2CB200470A7_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x18198C30)
#define CLASS_1_9A5AA2CB200470A7_METHOD_1_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x18198C40)
#define CLASS_1_9A5AA2CB200470A7_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x18198B00)
#define CLASS_1_9A5AA2CB200470A7_TOSTRING_OFFSET UNITYSDK_OFFSET(0x18198E10)
#define CLASS_1_9A5AA2CB200470A7_WRITETO_OFFSET UNITYSDK_OFFSET(0x18198E70)
#define CLASS_1_9A5AA2CB200470A7__CCTOR_OFFSET UNITYSDK_OFFSET(0x18199370)
#define CLASS_1_9A5AA2CB200470A7__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18198B50)
#define CLASS_1_9A5AA2CB200470A7__CTOR_OFFSET UNITYSDK_OFFSET(0x18198B10)
...
public:
	...
	{
		return (::Google::Protobuf::Collections::MapField_2_Codec<::System::String*, ::System::Double>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_9A5AA2CB200470A7_TypeDefinitionIndex)->GetStaticField(0xDBE0);
	}
