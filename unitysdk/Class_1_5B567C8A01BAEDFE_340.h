...
#define CLASS_1_5B567C8A01BAEDFE_340_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A0F71A0)
#define CLASS_1_5B567C8A01BAEDFE_340_CLONE_OFFSET UNITYSDK_OFFSET(0x1A0F7010)
#define CLASS_1_5B567C8A01BAEDFE_340_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A0F70B0)
#define CLASS_1_5B567C8A01BAEDFE_340_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A0F7050)
#define CLASS_1_5B567C8A01BAEDFE_340_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A0F7100)
#define CLASS_1_5B567C8A01BAEDFE_340_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A0F71F0)
#define CLASS_1_5B567C8A01BAEDFE_340_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A0F71C0)
#define CLASS_1_5B567C8A01BAEDFE_340_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A0F6F90)
#define CLASS_1_5B567C8A01BAEDFE_340_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A0F6FC0)
#define CLASS_1_5B567C8A01BAEDFE_340_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A0F7130)
#define CLASS_1_5B567C8A01BAEDFE_340_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A0F7190)
#define CLASS_1_5B567C8A01BAEDFE_340__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A0F7240)
#define CLASS_1_5B567C8A01BAEDFE_340__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0F6FE0)
#define CLASS_1_5B567C8A01BAEDFE_340__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0F6FD0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_340*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_340_TypeDefinitionIndex)->GetStaticField(0x36250);
	}
