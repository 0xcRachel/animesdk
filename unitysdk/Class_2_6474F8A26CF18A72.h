...
#define CLASS_2_6474F8A26CF18A72_DISPOSE_OFFSET UNITYSDK_OFFSET(0x115F8C10)
#define CLASS_2_6474F8A26CF18A72_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x115F8C50)
#define CLASS_2_6474F8A26CF18A72_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x115F8D20)
#define CLASS_2_6474F8A26CF18A72_TICK_OFFSET UNITYSDK_OFFSET(0x115F8D70)
#define CLASS_2_6474F8A26CF18A72__CTOR_OFFSET UNITYSDK_OFFSET(0x115F8C00)
