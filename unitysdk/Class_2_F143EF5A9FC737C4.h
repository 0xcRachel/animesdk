...
#define CLASS_2_F143EF5A9FC737C4_DISPOSE_OFFSET UNITYSDK_OFFSET(0x143A03B0)
#define CLASS_2_F143EF5A9FC737C4_GETCONFIG_OFFSET UNITYSDK_OFFSET(0x143A07F0)
#define CLASS_2_F143EF5A9FC737C4_METHOD_2_9556A99C117541C9_OFFSET UNITYSDK_OFFSET(0x143A0670)
#define CLASS_2_F143EF5A9FC737C4_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x143A0410)
#define CLASS_2_F143EF5A9FC737C4_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x143A0610)
#define CLASS_2_F143EF5A9FC737C4_TICK_OFFSET UNITYSDK_OFFSET(0x143A0790)
#define CLASS_2_F143EF5A9FC737C4__CTOR_OFFSET UNITYSDK_OFFSET(0x143A03A0)
#define CLASS_2_F143EF5A9FC737C4___IFIXBASEPROXY_GETCONFIG_OFFSET UNITYSDK_OFFSET(0x143A0830)
...
{
public:
	::Class_1_2B3811E66EE856E4* Field_2_0; // 0x18
