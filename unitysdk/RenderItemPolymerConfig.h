...
#define RENDERITEMPOLYMERCONFIG_GET_ADDANIMATIONIRI_OFFSET UNITYSDK_OFFSET(0xABC87F0)
#define RENDERITEMPOLYMERCONFIG_GET_ADDSYNCPOSITIONCHILDPATH_OFFSET UNITYSDK_OFFSET(0xABC9130)
#define RENDERITEMPOLYMERCONFIG_GET_ADDSYNCPOSITIONROOTPATH_OFFSET UNITYSDK_OFFSET(0xABC7F50)
#define RENDERITEMPOLYMERCONFIG_METHOD_5_B44E223C58DE8E13_OFFSET UNITYSDK_OFFSET(0xABC8930)
#define RENDERITEMPOLYMERCONFIG_METHOD_5_F4DD08A31BA3F883_OFFSET UNITYSDK_OFFSET(0xABC84B0)
#define RENDERITEMPOLYMERCONFIG_METHOD_5_FBE22211014B40D9_OFFSET UNITYSDK_OFFSET(0xABC7FC0)
#define RENDERITEMPOLYMERCONFIG_SET_ADDANIMATIONIRI_OFFSET UNITYSDK_OFFSET(0xABC8800)
#define RENDERITEMPOLYMERCONFIG_SET_ADDSYNCPOSITIONCHILDPATH_OFFSET UNITYSDK_OFFSET(0xABC9140)
#define RENDERITEMPOLYMERCONFIG_SET_ADDSYNCPOSITIONROOTPATH_OFFSET UNITYSDK_OFFSET(0xABC7F60)
#define RENDERITEMPOLYMERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xABC92B0)
