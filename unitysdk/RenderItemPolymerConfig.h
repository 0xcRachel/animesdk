...
#define RENDERITEMPOLYMERCONFIG_GET_ADDANIMATIONIRI_OFFSET UNITYSDK_OFFSET(0x16E1D900)
#define RENDERITEMPOLYMERCONFIG_GET_ADDSYNCPOSITIONCHILDPATH_OFFSET UNITYSDK_OFFSET(0x16E1E240)
#define RENDERITEMPOLYMERCONFIG_GET_ADDSYNCPOSITIONROOTPATH_OFFSET UNITYSDK_OFFSET(0x16E1D090)
#define RENDERITEMPOLYMERCONFIG_METHOD_5_A27DC2C5A103933A_OFFSET UNITYSDK_OFFSET(0x16E1D5F0)
#define RENDERITEMPOLYMERCONFIG_METHOD_5_B44E223C58DE8E13_OFFSET UNITYSDK_OFFSET(0x16E1DA40)
#define RENDERITEMPOLYMERCONFIG_METHOD_5_FBE22211014B40D9_OFFSET UNITYSDK_OFFSET(0x16E1D100)
#define RENDERITEMPOLYMERCONFIG_SET_ADDANIMATIONIRI_OFFSET UNITYSDK_OFFSET(0x16E1D910)
#define RENDERITEMPOLYMERCONFIG_SET_ADDSYNCPOSITIONCHILDPATH_OFFSET UNITYSDK_OFFSET(0x16E1E250)
#define RENDERITEMPOLYMERCONFIG_SET_ADDSYNCPOSITIONROOTPATH_OFFSET UNITYSDK_OFFSET(0x16E1D0A0)
#define RENDERITEMPOLYMERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E1E3C0)
