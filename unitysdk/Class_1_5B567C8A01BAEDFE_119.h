...
#define CLASS_1_5B567C8A01BAEDFE_119_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A7BFD30)
#define CLASS_1_5B567C8A01BAEDFE_119_CLONE_OFFSET UNITYSDK_OFFSET(0x1A7BFB40)
#define CLASS_1_5B567C8A01BAEDFE_119_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A7BFC40)
#define CLASS_1_5B567C8A01BAEDFE_119_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A7BFBB0)
#define CLASS_1_5B567C8A01BAEDFE_119_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A7BFC90)
#define CLASS_1_5B567C8A01BAEDFE_119_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A7BFD80)
#define CLASS_1_5B567C8A01BAEDFE_119_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A7BFD50)
#define CLASS_1_5B567C8A01BAEDFE_119_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A7BFA90)
#define CLASS_1_5B567C8A01BAEDFE_119_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A7BFAF0)
#define CLASS_1_5B567C8A01BAEDFE_119_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A7BFCC0)
#define CLASS_1_5B567C8A01BAEDFE_119_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A7BFD20)
#define CLASS_1_5B567C8A01BAEDFE_119__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A7BFDD0)
#define CLASS_1_5B567C8A01BAEDFE_119__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A7BFB10)
#define CLASS_1_5B567C8A01BAEDFE_119__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7BFB00)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_119*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_119_TypeDefinitionIndex)->GetStaticField(0x61430);
	}
