...
#define CLASS_1_A27BF87A78CEBB28__CTOR_1_OFFSET UNITYSDK_OFFSET(0x171C7520)
#define CLASS_1_A27BF87A78CEBB28__CTOR_OFFSET UNITYSDK_OFFSET(0x171C7500)
...
public:
	...
	::RPG::GameCore::PhotoGraphAimIdentifyType Field_1_4; // 0x30
