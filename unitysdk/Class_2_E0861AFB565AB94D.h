...
#define CLASS_2_E0861AFB565AB94D_ISCONCERNEDWITH_OFFSET UNITYSDK_OFFSET(0x110FAD40)
#define CLASS_2_E0861AFB565AB94D_METHOD_2_0EA837295AE4519F_OFFSET UNITYSDK_OFFSET(0x110FDBC0)
#define CLASS_2_E0861AFB565AB94D_METHOD_2_3B935EDF35B815B0_OFFSET UNITYSDK_OFFSET(0x110FAE00)
#define CLASS_2_E0861AFB565AB94D_METHOD_2_4418D0C08F01D8CD_OFFSET UNITYSDK_OFFSET(0x110FB4A0)
#define CLASS_2_E0861AFB565AB94D_METHOD_2_6E57D3559C10FFA9_OFFSET UNITYSDK_OFFSET(0x110FC4C0)
#define CLASS_2_E0861AFB565AB94D_METHOD_2_96175D6DCB6FF2B9_OFFSET UNITYSDK_OFFSET(0x110FB530)
#define CLASS_2_E0861AFB565AB94D_METHOD_2_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0x110FDD60)
#define CLASS_2_E0861AFB565AB94D_METHOD_2_C3CC026A96540DAB_OFFSET UNITYSDK_OFFSET(0x110FE530)
#define CLASS_2_E0861AFB565AB94D_METHOD_2_E2CDB6B22CCEBA97_1_OFFSET UNITYSDK_OFFSET(0x110FE3E0)
#define CLASS_2_E0861AFB565AB94D_METHOD_2_E2CDB6B22CCEBA97_OFFSET UNITYSDK_OFFSET(0x110FE370)
#define CLASS_2_E0861AFB565AB94D_METHOD_2_F465313BAD423FCA_OFFSET UNITYSDK_OFFSET(0x110FDA50)
#define CLASS_2_E0861AFB565AB94D_PREUPDATEDONE_OFFSET UNITYSDK_OFFSET(0x110FDD00)
#define CLASS_2_E0861AFB565AB94D_UPDATEADDITEM_OFFSET UNITYSDK_OFFSET(0x110FB410)
#define CLASS_2_E0861AFB565AB94D_UPDATEADDROLE_OFFSET UNITYSDK_OFFSET(0x110FC260)
#define CLASS_2_E0861AFB565AB94D_UPDATEAFTER_OFFSET UNITYSDK_OFFSET(0x110FC510)
#define CLASS_2_E0861AFB565AB94D_UPDATEBEFORE_OFFSET UNITYSDK_OFFSET(0x110FA860)
#define CLASS_2_E0861AFB565AB94D_UPDATECOIN_OFFSET UNITYSDK_OFFSET(0x110FC3B0)
#define CLASS_2_E0861AFB565AB94D_UPDATEITEM_OFFSET UNITYSDK_OFFSET(0x110FADB0)
#define CLASS_2_E0861AFB565AB94D_UPDATESTART_OFFSET UNITYSDK_OFFSET(0x110FA820)
#define CLASS_2_E0861AFB565AB94D__CTOR_OFFSET UNITYSDK_OFFSET(0x110FDEB0)
#define CLASS_2_E0861AFB565AB94D___IFIXBASEPROXY_ISCONCERNEDWITH_OFFSET UNITYSDK_OFFSET(0x110FE220)
#define CLASS_2_E0861AFB565AB94D___IFIXBASEPROXY_PREUPDATEDONE_OFFSET UNITYSDK_OFFSET(0x110FE610)
#define CLASS_2_E0861AFB565AB94D___IFIXBASEPROXY_UPDATEADDITEM_OFFSET UNITYSDK_OFFSET(0x110FE300)
#define CLASS_2_E0861AFB565AB94D___IFIXBASEPROXY_UPDATEADDROLE_OFFSET UNITYSDK_OFFSET(0x110FE450)
#define CLASS_2_E0861AFB565AB94D___IFIXBASEPROXY_UPDATEAFTER_OFFSET UNITYSDK_OFFSET(0x110FE5A0)
#define CLASS_2_E0861AFB565AB94D___IFIXBASEPROXY_UPDATEBEFORE_OFFSET UNITYSDK_OFFSET(0x110FE1B0)
#define CLASS_2_E0861AFB565AB94D___IFIXBASEPROXY_UPDATECOIN_OFFSET UNITYSDK_OFFSET(0x110FE4C0)
#define CLASS_2_E0861AFB565AB94D___IFIXBASEPROXY_UPDATEITEM_OFFSET UNITYSDK_OFFSET(0x110FE290)
#define CLASS_2_E0861AFB565AB94D___IFIXBASEPROXY_UPDATESTART_OFFSET UNITYSDK_OFFSET(0x110FE150)

inline static constexpr unsigned int Class_2_E0861AFB565AB94D_TypeDefinitionIndex = 51608;
...
public:
	...
	::System::Collections::Generic::Queue_1<::RPG::Client::GridFightEquipReturnPackEvent*>* Field_2_5; // 0x20
	::System::Collections::Generic::Queue_1<::RPG::Client::GridFightForgeAddCoinEvent*>* Field_2_7; // 0x28
	::System::Collections::Generic::Queue_1<::RPG::Client::GridFightEquipDressEvent*>* Field_2_8; // 0x30
	::System::Collections::Generic::HashSet_1<::System::UInt32>* Field_2_10; // 0x38
	...
	::Enum_3_75A5C8C4100A8E33_1 Field_2_0; // 0x48
	...
	::System::Void Method_2_96175D6DCB6FF2B9(::Class_1_BD3679861BD0C676* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_BD3679861BD0C676*))((::PBYTE)hIl2Cpp + CLASS_2_E0861AFB565AB94D_METHOD_2_96175D6DCB6FF2B9_OFFSET))(this, a1);
	}

	::System::Void UpdateAddRole(::Class_1_BD3679861BD0C676* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_BD3679861BD0C676*))((::PBYTE)hIl2Cpp + CLASS_2_E0861AFB565AB94D_UPDATEADDROLE_OFFSET))(this, a1);
	}
	...
	::System::Void Method_2_E2CDB6B22CCEBA97_1(::Class_1_BD3679861BD0C676* P0)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_BD3679861BD0C676*))((::PBYTE)hIl2Cpp + CLASS_2_E0861AFB565AB94D_METHOD_2_E2CDB6B22CCEBA97_1_OFFSET))(this, P0);
	}

	::System::Void __iFixBaseProxy_UpdateAddRole(::Class_1_BD3679861BD0C676* P0)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_BD3679861BD0C676*))((::PBYTE)hIl2Cpp + CLASS_2_E0861AFB565AB94D___IFIXBASEPROXY_UPDATEADDROLE_OFFSET))(this, P0);
	}
