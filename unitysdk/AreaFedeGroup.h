...
#define AREAFEDEGROUP_GET_FADEMODE_OFFSET UNITYSDK_OFFSET(0xF962BE0)
#define AREAFEDEGROUP_METHOD_5_1F3793A40D6D0F7F_OFFSET UNITYSDK_OFFSET(0xF962DE0)
#define AREAFEDEGROUP_METHOD_5_3CCA0B8A31B650A8_OFFSET UNITYSDK_OFFSET(0xF963410)
#define AREAFEDEGROUP_ONENABLE_OFFSET UNITYSDK_OFFSET(0xF962D90)
#define AREAFEDEGROUP_SET_FADEMODE_OFFSET UNITYSDK_OFFSET(0xF962BF0)
#define AREAFEDEGROUP_UPDATE_OFFSET UNITYSDK_OFFSET(0xF9633C0)
#define AREAFEDEGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xF963880)
