...
#define AREAFEDEGROUP_GET_FADEMODE_OFFSET UNITYSDK_OFFSET(0x1055F400)
#define AREAFEDEGROUP_METHOD_5_1F3793A40D6D0F7F_OFFSET UNITYSDK_OFFSET(0x1055F620)
#define AREAFEDEGROUP_METHOD_5_3CCA0B8A31B650A8_OFFSET UNITYSDK_OFFSET(0x1055FC50)
#define AREAFEDEGROUP_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1055F5D0)
#define AREAFEDEGROUP_SET_FADEMODE_OFFSET UNITYSDK_OFFSET(0x1055F410)
#define AREAFEDEGROUP_UPDATE_OFFSET UNITYSDK_OFFSET(0x1055FC00)
#define AREAFEDEGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x105600C0)

inline static constexpr unsigned int AreaFedeGroup_TypeDefinitionIndex = 37275;
