...
#define AREAFEDEGROUP_GET_FADEMODE_OFFSET UNITYSDK_OFFSET(0x15BBF7F0)
#define AREAFEDEGROUP_METHOD_5_367B9590522079D1_OFFSET UNITYSDK_OFFSET(0x15BBFF20)
#define AREAFEDEGROUP_METHOD_5_6A0EBEECA245A27C_OFFSET UNITYSDK_OFFSET(0x15BBFA00)
#define AREAFEDEGROUP_ONENABLE_OFFSET UNITYSDK_OFFSET(0x15BBF9B0)
#define AREAFEDEGROUP_SET_FADEMODE_OFFSET UNITYSDK_OFFSET(0x15BBF800)
#define AREAFEDEGROUP_UPDATE_OFFSET UNITYSDK_OFFSET(0x15BBFED0)
#define AREAFEDEGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x15BC03E0)
