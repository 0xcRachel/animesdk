...
#define AREAFEDEGROUP_GET_FADEMODE_OFFSET UNITYSDK_OFFSET(0x10C0EB10)
#define AREAFEDEGROUP_METHOD_5_1F3793A40D6D0F7F_OFFSET UNITYSDK_OFFSET(0x10C0ED30)
#define AREAFEDEGROUP_METHOD_5_3CCA0B8A31B650A8_OFFSET UNITYSDK_OFFSET(0x10C0F360)
#define AREAFEDEGROUP_ONENABLE_OFFSET UNITYSDK_OFFSET(0x10C0ECE0)
#define AREAFEDEGROUP_SET_FADEMODE_OFFSET UNITYSDK_OFFSET(0x10C0EB20)
#define AREAFEDEGROUP_UPDATE_OFFSET UNITYSDK_OFFSET(0x10C0F310)
#define AREAFEDEGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x10C0F7D0)
