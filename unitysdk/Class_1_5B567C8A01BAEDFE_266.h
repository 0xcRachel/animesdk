...
#define CLASS_1_5B567C8A01BAEDFE_266_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1B0F3010)
#define CLASS_1_5B567C8A01BAEDFE_266_CLONE_OFFSET UNITYSDK_OFFSET(0x1B0F2E20)
#define CLASS_1_5B567C8A01BAEDFE_266_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1B0F2F20)
#define CLASS_1_5B567C8A01BAEDFE_266_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B0F2E90)
#define CLASS_1_5B567C8A01BAEDFE_266_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B0F2F70)
#define CLASS_1_5B567C8A01BAEDFE_266_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1B0F3060)
#define CLASS_1_5B567C8A01BAEDFE_266_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1B0F3030)
#define CLASS_1_5B567C8A01BAEDFE_266_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1B0F2D70)
#define CLASS_1_5B567C8A01BAEDFE_266_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1B0F2DD0)
#define CLASS_1_5B567C8A01BAEDFE_266_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B0F2FA0)
#define CLASS_1_5B567C8A01BAEDFE_266_WRITETO_OFFSET UNITYSDK_OFFSET(0x1B0F3000)
#define CLASS_1_5B567C8A01BAEDFE_266__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B0F30B0)
#define CLASS_1_5B567C8A01BAEDFE_266__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B0F2DF0)
#define CLASS_1_5B567C8A01BAEDFE_266__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0F2DE0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_266*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_266_TypeDefinitionIndex)->GetStaticField(0x2DFD0);
	}
