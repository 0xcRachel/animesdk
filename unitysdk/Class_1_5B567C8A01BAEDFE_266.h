...
#define CLASS_1_5B567C8A01BAEDFE_266_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A1DF970)
#define CLASS_1_5B567C8A01BAEDFE_266_CLONE_OFFSET UNITYSDK_OFFSET(0x1A1DF7E0)
#define CLASS_1_5B567C8A01BAEDFE_266_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A1DF880)
#define CLASS_1_5B567C8A01BAEDFE_266_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A1DF820)
#define CLASS_1_5B567C8A01BAEDFE_266_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A1DF8D0)
#define CLASS_1_5B567C8A01BAEDFE_266_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A1DF9C0)
#define CLASS_1_5B567C8A01BAEDFE_266_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A1DF990)
#define CLASS_1_5B567C8A01BAEDFE_266_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A1DF760)
#define CLASS_1_5B567C8A01BAEDFE_266_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A1DF790)
#define CLASS_1_5B567C8A01BAEDFE_266_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A1DF900)
#define CLASS_1_5B567C8A01BAEDFE_266_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A1DF960)
#define CLASS_1_5B567C8A01BAEDFE_266__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1DFA10)
#define CLASS_1_5B567C8A01BAEDFE_266__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A1DF7B0)
#define CLASS_1_5B567C8A01BAEDFE_266__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1DF7A0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_266*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_266_TypeDefinitionIndex)->GetStaticField(0x5F030);
	}
