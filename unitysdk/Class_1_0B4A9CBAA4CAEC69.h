...
#define CLASS_1_0B4A9CBAA4CAEC69__CTOR_OFFSET UNITYSDK_OFFSET(0x104BABF0)

inline static constexpr unsigned int Class_1_0B4A9CBAA4CAEC69_TypeDefinitionIndex = 44827;
...
public:
	...
	::RPG::GameCore::CharacterMotionFlag Field_1_0; // 0x18
