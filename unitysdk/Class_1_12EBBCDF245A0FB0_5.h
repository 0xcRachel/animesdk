...
#define CLASS_1_12EBBCDF245A0FB0_5_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A2B7B20)
#define CLASS_1_12EBBCDF245A0FB0_5_CLONE_OFFSET UNITYSDK_OFFSET(0x1A2B78A0)
#define CLASS_1_12EBBCDF245A0FB0_5_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A2B79D0)
#define CLASS_1_12EBBCDF245A0FB0_5_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A2B7930)
#define CLASS_1_12EBBCDF245A0FB0_5_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A2B7A30)
#define CLASS_1_12EBBCDF245A0FB0_5_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A2B7B80)
#define CLASS_1_12EBBCDF245A0FB0_5_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A2B7B50)
#define CLASS_1_12EBBCDF245A0FB0_5_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A2B77F0)
#define CLASS_1_12EBBCDF245A0FB0_5_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1A2B7920)
#define CLASS_1_12EBBCDF245A0FB0_5_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1A2B7910)
#define CLASS_1_12EBBCDF245A0FB0_5_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A2B7850)
#define CLASS_1_12EBBCDF245A0FB0_5_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A2B7A60)
#define CLASS_1_12EBBCDF245A0FB0_5_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A2B7AC0)
#define CLASS_1_12EBBCDF245A0FB0_5__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A2B7BF0)
#define CLASS_1_12EBBCDF245A0FB0_5__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A2B7870)
#define CLASS_1_12EBBCDF245A0FB0_5__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2B7860)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_12EBBCDF245A0FB0_5*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_12EBBCDF245A0FB0_5_TypeDefinitionIndex)->GetStaticField(0x266B0);
	}
