...
#define CLASS_2_F9A00379C2678C49_METHOD_2_4186C2378364AF02_OFFSET UNITYSDK_OFFSET(0x162AE3D0)
#define CLASS_2_F9A00379C2678C49_METHOD_2_5B099EFC0259C285_OFFSET UNITYSDK_OFFSET(0x162ADBF0)
#define CLASS_2_F9A00379C2678C49_METHOD_2_8DCA4BB49D9B3469_OFFSET UNITYSDK_OFFSET(0x162AE100)
#define CLASS_2_F9A00379C2678C49_METHOD_2_B3DBF903EFF6133D_OFFSET UNITYSDK_OFFSET(0x162ADCD0)
#define CLASS_2_F9A00379C2678C49_METHOD_2_CF45B637E197CFE9_OFFSET UNITYSDK_OFFSET(0x162ADFD0)
#define CLASS_2_F9A00379C2678C49__CTOR_OFFSET UNITYSDK_OFFSET(0x162ADBE0)

inline static constexpr unsigned int Class_2_F9A00379C2678C49_TypeDefinitionIndex = 32088;
...
public:
	...
	::Class_1_B470ECE8B4D9EC2E* Method_2_5B099EFC0259C285(::System::Single a1, ::System::Boolean a2, ::Class_0_16E4307DCC419505_168* a3)
	{
		return ((::Class_1_B470ECE8B4D9EC2E*(*)(::PVOID, ::System::Single, ::System::Boolean, ::Class_0_16E4307DCC419505_168*))((::PBYTE)hIl2Cpp + CLASS_2_F9A00379C2678C49_METHOD_2_5B099EFC0259C285_OFFSET))(this, a1, a2, a3);
	}
	...
	::Class_1_65ECD476422B13F6* Method_2_CF45B637E197CFE9(::RPG::Client::LittleGame::TimelineControlGameWorld_LevelGroup& a1, ::Il2CppArray<::RPG::Client::LittleGame::TimelineControlGameWorld_LevelGroupAction*>* a2)
	{
		return ((::Class_1_65ECD476422B13F6*(*)(::PVOID, ::RPG::Client::LittleGame::TimelineControlGameWorld_LevelGroup&, ::Il2CppArray<::RPG::Client::LittleGame::TimelineControlGameWorld_LevelGroupAction*>*))((::PBYTE)hIl2Cpp + CLASS_2_F9A00379C2678C49_METHOD_2_CF45B637E197CFE9_OFFSET))(this, a1, a2);
	}

	::Class_2_54AE1C44DE8123D2* Method_2_8DCA4BB49D9B3469(::Class_1_65ECD476422B13F6* a1, ::RPG::Client::LittleGame::TimelineControlGameWorld_LevelCell& a2, ::System::Nullable_1<::RPG::Client::LittleGame::TimelineControlGameWorld_LevelCellDrop> a3, ::System::Nullable_1<::RPG::Client::LittleGame::TimelineControlGameWorld_LevelCellTrigger> a4, ::System::Nullable_1<::RPG::Client::LittleGame::TimelineControlGameWorld_LevelCellSaver> a5)
	{
		return ((::Class_2_54AE1C44DE8123D2*(*)(::PVOID, ::Class_1_65ECD476422B13F6*, ::RPG::Client::LittleGame::TimelineControlGameWorld_LevelCell&, ::System::Nullable_1<::RPG::Client::LittleGame::TimelineControlGameWorld_LevelCellDrop>, ::System::Nullable_1<::RPG::Client::LittleGame::TimelineControlGameWorld_LevelCellTrigger>, ::System::Nullable_1<::RPG::Client::LittleGame::TimelineControlGameWorld_LevelCellSaver>))((::PBYTE)hIl2Cpp + CLASS_2_F9A00379C2678C49_METHOD_2_8DCA4BB49D9B3469_OFFSET))(this, a1, a2, a3, a4, a5);
	}
