...
#define CLASS_2_473C73321ACADA74_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1735C690)
#define CLASS_2_473C73321ACADA74_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1735C6D0)
#define CLASS_2_473C73321ACADA74_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1735C850)
#define CLASS_2_473C73321ACADA74_TICK_OFFSET UNITYSDK_OFFSET(0x1735C8A0)
#define CLASS_2_473C73321ACADA74__CTOR_OFFSET UNITYSDK_OFFSET(0x1735C650)
