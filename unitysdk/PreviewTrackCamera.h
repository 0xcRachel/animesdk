...
#define PREVIEWTRACKCAMERA_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x8A879C0)
#define PREVIEWTRACKCAMERA_PREVIEWCAMERA_OFFSET UNITYSDK_OFFSET(0x8A87C90)
#define PREVIEWTRACKCAMERA_STOPPREVIEWCAMERA_OFFSET UNITYSDK_OFFSET(0x8A87BC0)
#define PREVIEWTRACKCAMERA_TICK_OFFSET UNITYSDK_OFFSET(0x8A87A10)
#define PREVIEWTRACKCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x8AC8420)

inline static constexpr unsigned int PreviewTrackCamera_TypeDefinitionIndex = 37222;
