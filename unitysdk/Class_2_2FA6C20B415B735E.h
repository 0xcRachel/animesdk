...
#define CLASS_2_2FA6C20B415B735E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1055B9C0)
#define CLASS_2_2FA6C20B415B735E_METHOD_2_45066CE8D10D20A0_OFFSET UNITYSDK_OFFSET(0x1055B7C0)
#define CLASS_2_2FA6C20B415B735E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1055B660)
#define CLASS_2_2FA6C20B415B735E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1055B950)
#define CLASS_2_2FA6C20B415B735E_TICK_OFFSET UNITYSDK_OFFSET(0x1055BA30)
#define CLASS_2_2FA6C20B415B735E__CTOR_OFFSET UNITYSDK_OFFSET(0x1055B550)

inline static constexpr unsigned int Class_2_2FA6C20B415B735E_TypeDefinitionIndex = 43555;
...
public:
	...
	::RPG::GameCore::SwordTrainingCheckCanEnterGame* Field_2_0; // 0x28
