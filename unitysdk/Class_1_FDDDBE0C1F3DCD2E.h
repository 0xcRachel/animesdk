...
#define CLASS_1_FDDDBE0C1F3DCD2E_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19912650)
#define CLASS_1_FDDDBE0C1F3DCD2E_CLONE_OFFSET UNITYSDK_OFFSET(0x199121F0)
#define CLASS_1_FDDDBE0C1F3DCD2E_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x199122C0)
#define CLASS_1_FDDDBE0C1F3DCD2E_EQUALS_OFFSET UNITYSDK_OFFSET(0x19912260)
#define CLASS_1_FDDDBE0C1F3DCD2E_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19912470)
#define CLASS_1_FDDDBE0C1F3DCD2E_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19912870)
#define CLASS_1_FDDDBE0C1F3DCD2E_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x199127B0)
#define CLASS_1_FDDDBE0C1F3DCD2E_METHOD_1_2ACF2A61FB239D23_OFFSET UNITYSDK_OFFSET(0x19912240)
#define CLASS_1_FDDDBE0C1F3DCD2E_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19911FF0)
#define CLASS_1_FDDDBE0C1F3DCD2E_METHOD_1_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x19912250)
#define CLASS_1_FDDDBE0C1F3DCD2E_METHOD_1_AA935885E31AA701_OFFSET UNITYSDK_OFFSET(0x199121C0)
#define CLASS_1_FDDDBE0C1F3DCD2E_METHOD_1_EA1C8FD1B81E659E_OFFSET UNITYSDK_OFFSET(0x19912140)
#define CLASS_1_FDDDBE0C1F3DCD2E_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19912050)
#define CLASS_1_FDDDBE0C1F3DCD2E_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19912520)
#define CLASS_1_FDDDBE0C1F3DCD2E_WRITETO_OFFSET UNITYSDK_OFFSET(0x19912580)
#define CLASS_1_FDDDBE0C1F3DCD2E__CCTOR_OFFSET UNITYSDK_OFFSET(0x19912910)
#define CLASS_1_FDDDBE0C1F3DCD2E__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19912070)
#define CLASS_1_FDDDBE0C1F3DCD2E__CTOR_OFFSET UNITYSDK_OFFSET(0x19912060)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_FDDDBE0C1F3DCD2E*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_FDDDBE0C1F3DCD2E_TypeDefinitionIndex)->GetStaticField(0x13E50);
	}
