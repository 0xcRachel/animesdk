...
#define CLASS_2_7DEB23C1CE800C51_CLEAR_OFFSET UNITYSDK_OFFSET(0x15FB8AF0)
#define CLASS_2_7DEB23C1CE800C51_METHOD_2_B156C85CB0B77276_OFFSET UNITYSDK_OFFSET(0x15FB8900)
#define CLASS_2_7DEB23C1CE800C51_SWITCHSTATE_OFFSET UNITYSDK_OFFSET(0x15FB8B70)
#define CLASS_2_7DEB23C1CE800C51__CTOR_OFFSET UNITYSDK_OFFSET(0x15FB8C40)
#define CLASS_2_7DEB23C1CE800C51___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0x15FB8C60)

inline static constexpr unsigned int Class_2_7DEB23C1CE800C51_TypeDefinitionIndex = 71635;
