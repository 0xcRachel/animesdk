...
#define CLASS_2_CE9BE15B1FB0D645_METHOD_2_0869E1192F8E01DF_OFFSET UNITYSDK_OFFSET(0x16736F20)
#define CLASS_2_CE9BE15B1FB0D645_METHOD_2_19CCC07C980409E4_1_OFFSET UNITYSDK_OFFSET(0x167373E0)
#define CLASS_2_CE9BE15B1FB0D645_METHOD_2_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0x167372B0)
#define CLASS_2_CE9BE15B1FB0D645_METHOD_2_2D2FB6D1979284B0_OFFSET UNITYSDK_OFFSET(0x16737470)
#define CLASS_2_CE9BE15B1FB0D645_METHOD_2_52607DE4C357D269_OFFSET UNITYSDK_OFFSET(0x167371E0)
#define CLASS_2_CE9BE15B1FB0D645_METHOD_2_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0x16738110)
#define CLASS_2_CE9BE15B1FB0D645_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x167380B0)
#define CLASS_2_CE9BE15B1FB0D645_METHOD_2_5EBE23180774F4D5_OFFSET UNITYSDK_OFFSET(0x16736E00)
#define CLASS_2_CE9BE15B1FB0D645_METHOD_2_9A7071D23F340B6D_OFFSET UNITYSDK_OFFSET(0x167376E0)
#define CLASS_2_CE9BE15B1FB0D645_METHOD_2_C7B58231E4F61838_OFFSET UNITYSDK_OFFSET(0x16737E50)
#define CLASS_2_CE9BE15B1FB0D645_METHOD_2_C91E5170F9E36EED_OFFSET UNITYSDK_OFFSET(0x167381D0)
#define CLASS_2_CE9BE15B1FB0D645_METHOD_2_DFF4B66A65F23F6B_OFFSET UNITYSDK_OFFSET(0x167377D0)
#define CLASS_2_CE9BE15B1FB0D645_METHOD_2_E52C357E96F7A058_OFFSET UNITYSDK_OFFSET(0x16737DA0)
#define CLASS_2_CE9BE15B1FB0D645__CTOR_OFFSET UNITYSDK_OFFSET(0x16738010)
#define CLASS_2_CE9BE15B1FB0D645__ONBIND_OFFSET UNITYSDK_OFFSET(0x16736D40)
#define CLASS_2_CE9BE15B1FB0D645__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x16737320)
#define CLASS_2_CE9BE15B1FB0D645__ONTICK_OFFSET UNITYSDK_OFFSET(0x16737180)
#define CLASS_2_CE9BE15B1FB0D645___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0x16738050)
#define CLASS_2_CE9BE15B1FB0D645___IFIXBASEPROXY__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x16738230)
#define CLASS_2_CE9BE15B1FB0D645___IFIXBASEPROXY__ONTICK_OFFSET UNITYSDK_OFFSET(0x16738170)

inline static constexpr unsigned int Class_2_CE9BE15B1FB0D645_TypeDefinitionIndex = 66976;
...
public:
	...
	::RPG::GameCore::TeamDataComponent* Field_2_2; // 0x60
	::RPG::GameCore::TeamDataComponent* Field_2_3; // 0x68
	::Class_2_E4C329253233FBD0* Field_2_4; // 0x70
	::RPG::GameCore::BattleInstance* Field_2_5; // 0x78
	::RPG::Client::MonoInControlTip* Field_2_6; // 0x80
	::RPG::GameCore::EventManager* Field_2_7; // 0x88
