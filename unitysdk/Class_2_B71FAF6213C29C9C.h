...
#define CLASS_2_B71FAF6213C29C9C_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8D5B080)
#define CLASS_2_B71FAF6213C29C9C_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x8D5B0C0)
#define CLASS_2_B71FAF6213C29C9C_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x8D5B160)
#define CLASS_2_B71FAF6213C29C9C_TICK_OFFSET UNITYSDK_OFFSET(0x8D5B1B0)
#define CLASS_2_B71FAF6213C29C9C__CTOR_OFFSET UNITYSDK_OFFSET(0x8D5B070)
