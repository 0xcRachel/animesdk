...
#define CLASS_2_B71FAF6213C29C9C_DISPOSE_OFFSET UNITYSDK_OFFSET(0xFCC4F60)
#define CLASS_2_B71FAF6213C29C9C_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xFCC4FA0)
#define CLASS_2_B71FAF6213C29C9C_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xFCC5040)
#define CLASS_2_B71FAF6213C29C9C_TICK_OFFSET UNITYSDK_OFFSET(0xFCC5090)
#define CLASS_2_B71FAF6213C29C9C__CTOR_OFFSET UNITYSDK_OFFSET(0xFCC4F50)
