...
#define CLASS_1_5B567C8A01BAEDFE_97_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1ACC2700)
#define CLASS_1_5B567C8A01BAEDFE_97_CLONE_OFFSET UNITYSDK_OFFSET(0x1ACC2570)
#define CLASS_1_5B567C8A01BAEDFE_97_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1ACC2610)
#define CLASS_1_5B567C8A01BAEDFE_97_EQUALS_OFFSET UNITYSDK_OFFSET(0x1ACC25B0)
#define CLASS_1_5B567C8A01BAEDFE_97_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1ACC2660)
#define CLASS_1_5B567C8A01BAEDFE_97_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1ACC2750)
#define CLASS_1_5B567C8A01BAEDFE_97_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1ACC2720)
#define CLASS_1_5B567C8A01BAEDFE_97_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1ACC24F0)
#define CLASS_1_5B567C8A01BAEDFE_97_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1ACC2520)
#define CLASS_1_5B567C8A01BAEDFE_97_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1ACC2690)
#define CLASS_1_5B567C8A01BAEDFE_97_WRITETO_OFFSET UNITYSDK_OFFSET(0x1ACC26F0)
#define CLASS_1_5B567C8A01BAEDFE_97__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ACC27A0)
#define CLASS_1_5B567C8A01BAEDFE_97__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1ACC2540)
#define CLASS_1_5B567C8A01BAEDFE_97__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACC2530)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_97*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_97_TypeDefinitionIndex)->GetStaticField(0x6A30);
	}
