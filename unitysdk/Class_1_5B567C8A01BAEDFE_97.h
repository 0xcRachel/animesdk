...
#define CLASS_1_5B567C8A01BAEDFE_97_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19E8FC80)
#define CLASS_1_5B567C8A01BAEDFE_97_CLONE_OFFSET UNITYSDK_OFFSET(0x19E8FA90)
#define CLASS_1_5B567C8A01BAEDFE_97_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19E8FB90)
#define CLASS_1_5B567C8A01BAEDFE_97_EQUALS_OFFSET UNITYSDK_OFFSET(0x19E8FB00)
#define CLASS_1_5B567C8A01BAEDFE_97_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19E8FBE0)
#define CLASS_1_5B567C8A01BAEDFE_97_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19E8FCD0)
#define CLASS_1_5B567C8A01BAEDFE_97_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19E8FCA0)
#define CLASS_1_5B567C8A01BAEDFE_97_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19E8F9E0)
#define CLASS_1_5B567C8A01BAEDFE_97_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19E8FA40)
#define CLASS_1_5B567C8A01BAEDFE_97_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19E8FC10)
#define CLASS_1_5B567C8A01BAEDFE_97_WRITETO_OFFSET UNITYSDK_OFFSET(0x19E8FC70)
#define CLASS_1_5B567C8A01BAEDFE_97__CCTOR_OFFSET UNITYSDK_OFFSET(0x19E8FD20)
#define CLASS_1_5B567C8A01BAEDFE_97__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19E8FA60)
#define CLASS_1_5B567C8A01BAEDFE_97__CTOR_OFFSET UNITYSDK_OFFSET(0x19E8FA50)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_97*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_97_TypeDefinitionIndex)->GetStaticField(0x250F0);
	}
