...
#define AIRSHIPRANDOMFLOATING_AWAKE_OFFSET UNITYSDK_OFFSET(0x13FF1A00)
#define AIRSHIPRANDOMFLOATING_METHOD_5_8AFD856B358AA27A_OFFSET UNITYSDK_OFFSET(0x15BBE110)
#define AIRSHIPRANDOMFLOATING_METHOD_5_C34AC80B04BCFF1B_OFFSET UNITYSDK_OFFSET(0x15BBE6E0)
#define AIRSHIPRANDOMFLOATING_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x13FF1B00)
#define AIRSHIPRANDOMFLOATING_ONENABLE_OFFSET UNITYSDK_OFFSET(0x13FF1AB0)
#define AIRSHIPRANDOMFLOATING_TICK_OFFSET UNITYSDK_OFFSET(0x13FF1C10)
#define AIRSHIPRANDOMFLOATING_UPDATE_OFFSET UNITYSDK_OFFSET(0x13FF1BB0)
#define AIRSHIPRANDOMFLOATING__CTOR_OFFSET UNITYSDK_OFFSET(0x15BBE7F0)
