...
#define CLASS_1_5B567C8A01BAEDFE_304_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A7AE7A0)
#define CLASS_1_5B567C8A01BAEDFE_304_CLONE_OFFSET UNITYSDK_OFFSET(0x1A7AE5B0)
#define CLASS_1_5B567C8A01BAEDFE_304_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A7AE6B0)
#define CLASS_1_5B567C8A01BAEDFE_304_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A7AE620)
#define CLASS_1_5B567C8A01BAEDFE_304_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A7AE700)
#define CLASS_1_5B567C8A01BAEDFE_304_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A7AE7F0)
#define CLASS_1_5B567C8A01BAEDFE_304_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A7AE7C0)
#define CLASS_1_5B567C8A01BAEDFE_304_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A7AE500)
#define CLASS_1_5B567C8A01BAEDFE_304_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A7AE560)
#define CLASS_1_5B567C8A01BAEDFE_304_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A7AE730)
#define CLASS_1_5B567C8A01BAEDFE_304_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A7AE790)
#define CLASS_1_5B567C8A01BAEDFE_304__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A7AE840)
#define CLASS_1_5B567C8A01BAEDFE_304__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A7AE580)
#define CLASS_1_5B567C8A01BAEDFE_304__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7AE570)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_304*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_304_TypeDefinitionIndex)->GetStaticField(0x604C0);
	}
