...
#define CLASS_1_D33B7D6901AE39E9_CLEAR_OFFSET UNITYSDK_OFFSET(0x167EB460)
#define CLASS_1_D33B7D6901AE39E9_GET_ALLCONTEXTS_OFFSET UNITYSDK_OFFSET(0x167EC070)
#define CLASS_1_D33B7D6901AE39E9_GET_CAKERACEGAME_OFFSET UNITYSDK_OFFSET(0x167EBD90)
#define CLASS_1_D33B7D6901AE39E9_GET_CHENLINGFES_OFFSET UNITYSDK_OFFSET(0x167EBDB0)
#define CLASS_1_D33B7D6901AE39E9_GET_CHENLINGGAME_OFFSET UNITYSDK_OFFSET(0x167EBDD0)
#define CLASS_1_D33B7D6901AE39E9_GET_CHIMERADUELGAME_OFFSET UNITYSDK_OFFSET(0x167EBDF0)
#define CLASS_1_D33B7D6901AE39E9_GET_CHIMERAGAME_OFFSET UNITYSDK_OFFSET(0x167EBE10)
#define CLASS_1_D33B7D6901AE39E9_GET_ELFRESTAURANTGAME_OFFSET UNITYSDK_OFFSET(0x167EBE30)
#define CLASS_1_D33B7D6901AE39E9_GET_FIVEDIMGAME_OFFSET UNITYSDK_OFFSET(0x167EBE50)
#define CLASS_1_D33B7D6901AE39E9_GET_FOURROTATEVOXELGAME_OFFSET UNITYSDK_OFFSET(0x167EBE70)
#define CLASS_1_D33B7D6901AE39E9_GET_LITTLEGAMEINPUT_OFFSET UNITYSDK_OFFSET(0x167EBEB0)
#define CLASS_1_D33B7D6901AE39E9_GET_LITTLEGAME_OFFSET UNITYSDK_OFFSET(0x167EBE90)
#define CLASS_1_D33B7D6901AE39E9_GET_MARBLEGAME_OFFSET UNITYSDK_OFFSET(0x167EBED0)
#define CLASS_1_D33B7D6901AE39E9_GET_MATCH3GAME_OFFSET UNITYSDK_OFFSET(0x167EBEF0)
#define CLASS_1_D33B7D6901AE39E9_GET_MOVIEGAMECONFIG_OFFSET UNITYSDK_OFFSET(0x167EBF10)
#define CLASS_1_D33B7D6901AE39E9_GET_MOVIEGAMESTATE_OFFSET UNITYSDK_OFFSET(0x167EBF30)
#define CLASS_1_D33B7D6901AE39E9_GET_PARKOURGAME_OFFSET UNITYSDK_OFFSET(0x167EBF50)
#define CLASS_1_D33B7D6901AE39E9_GET_PINGPONGGAME_OFFSET UNITYSDK_OFFSET(0x167EBF70)
#define CLASS_1_D33B7D6901AE39E9_GET_PIXAIR_OFFSET UNITYSDK_OFFSET(0x167EBF90)
#define CLASS_1_D33B7D6901AE39E9_GET_TIMELINECONTROLGAMECONFIG_OFFSET UNITYSDK_OFFSET(0x167EBFB0)
#define CLASS_1_D33B7D6901AE39E9_GET_TIMELINECONTROLGAMESTATE_OFFSET UNITYSDK_OFFSET(0x167EBFD0)
#define CLASS_1_D33B7D6901AE39E9_GET_TIMERELAYFLAMEGAME_OFFSET UNITYSDK_OFFSET(0x167EBFF0)
#define CLASS_1_D33B7D6901AE39E9_GET_UI3DGAMECONFIG_OFFSET UNITYSDK_OFFSET(0x167EC010)
#define CLASS_1_D33B7D6901AE39E9_GET_UI3DGAMEINPUT_OFFSET UNITYSDK_OFFSET(0x167EC030)
#define CLASS_1_D33B7D6901AE39E9_GET_UI3DGAMESTATE_OFFSET UNITYSDK_OFFSET(0x167EC050)
#define CLASS_1_D33B7D6901AE39E9_METHOD_1_3B7145E79424FB75_OFFSET UNITYSDK_OFFSET(0x167EB4B0)
#define CLASS_1_D33B7D6901AE39E9_METHOD_1_47FCE72550F759BF_OFFSET UNITYSDK_OFFSET(0x167EB610)
#define CLASS_1_D33B7D6901AE39E9_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x167EBD80)
#define CLASS_1_D33B7D6901AE39E9_METHOD_1_DA37DFE3A5BDA9F4_OFFSET UNITYSDK_OFFSET(0x167ECD60)
#define CLASS_1_D33B7D6901AE39E9_SET_CAKERACEGAME_OFFSET UNITYSDK_OFFSET(0x167EBDA0)
#define CLASS_1_D33B7D6901AE39E9_SET_CHENLINGFES_OFFSET UNITYSDK_OFFSET(0x167EBDC0)
#define CLASS_1_D33B7D6901AE39E9_SET_CHENLINGGAME_OFFSET UNITYSDK_OFFSET(0x167EBDE0)
#define CLASS_1_D33B7D6901AE39E9_SET_CHIMERADUELGAME_OFFSET UNITYSDK_OFFSET(0x167EBE00)
#define CLASS_1_D33B7D6901AE39E9_SET_CHIMERAGAME_OFFSET UNITYSDK_OFFSET(0x167EBE20)
#define CLASS_1_D33B7D6901AE39E9_SET_ELFRESTAURANTGAME_OFFSET UNITYSDK_OFFSET(0x167EBE40)
#define CLASS_1_D33B7D6901AE39E9_SET_FIVEDIMGAME_OFFSET UNITYSDK_OFFSET(0x167EBE60)
#define CLASS_1_D33B7D6901AE39E9_SET_FOURROTATEVOXELGAME_OFFSET UNITYSDK_OFFSET(0x167EBE80)
#define CLASS_1_D33B7D6901AE39E9_SET_LITTLEGAMEINPUT_OFFSET UNITYSDK_OFFSET(0x167EBEC0)
#define CLASS_1_D33B7D6901AE39E9_SET_LITTLEGAME_OFFSET UNITYSDK_OFFSET(0x167EBEA0)
#define CLASS_1_D33B7D6901AE39E9_SET_MARBLEGAME_OFFSET UNITYSDK_OFFSET(0x167EBEE0)
#define CLASS_1_D33B7D6901AE39E9_SET_MATCH3GAME_OFFSET UNITYSDK_OFFSET(0x167EBF00)
#define CLASS_1_D33B7D6901AE39E9_SET_MOVIEGAMECONFIG_OFFSET UNITYSDK_OFFSET(0x167EBF20)
#define CLASS_1_D33B7D6901AE39E9_SET_MOVIEGAMESTATE_OFFSET UNITYSDK_OFFSET(0x167EBF40)
#define CLASS_1_D33B7D6901AE39E9_SET_PARKOURGAME_OFFSET UNITYSDK_OFFSET(0x167EBF60)
#define CLASS_1_D33B7D6901AE39E9_SET_PINGPONGGAME_OFFSET UNITYSDK_OFFSET(0x167EBF80)
#define CLASS_1_D33B7D6901AE39E9_SET_PIXAIR_OFFSET UNITYSDK_OFFSET(0x167EBFA0)
#define CLASS_1_D33B7D6901AE39E9_SET_TIMELINECONTROLGAMECONFIG_OFFSET UNITYSDK_OFFSET(0x167EBFC0)
#define CLASS_1_D33B7D6901AE39E9_SET_TIMELINECONTROLGAMESTATE_OFFSET UNITYSDK_OFFSET(0x167EBFE0)
#define CLASS_1_D33B7D6901AE39E9_SET_TIMERELAYFLAMEGAME_OFFSET UNITYSDK_OFFSET(0x167EC000)
#define CLASS_1_D33B7D6901AE39E9_SET_UI3DGAMECONFIG_OFFSET UNITYSDK_OFFSET(0x167EC020)
#define CLASS_1_D33B7D6901AE39E9_SET_UI3DGAMEINPUT_OFFSET UNITYSDK_OFFSET(0x167EC040)
#define CLASS_1_D33B7D6901AE39E9_SET_UI3DGAMESTATE_OFFSET UNITYSDK_OFFSET(0x167EC060)
#define CLASS_1_D33B7D6901AE39E9__CTOR_OFFSET UNITYSDK_OFFSET(0x167EB6B0)
...
public:
	...
	{
		return (::Class_1_D33B7D6901AE39E9**)Il2CppClass::FromTypeDefinitionIndex(Class_1_D33B7D6901AE39E9_TypeDefinitionIndex)->GetStaticField(0x2ECC0);
	}
	...
	::Class_2_9190FC5D7C3B32BD* _littleGameInput_k__BackingField; // 0x10
	::Class_2_C3AB8E04EBC33FFB* _pixAir_k__BackingField; // 0x18
	::Class_2_C8461ACA8308A704_1* _uI3DGameInput_k__BackingField; // 0x20
	::Class_2_C8461ACA8308A704_2* _cakeRaceGame_k__BackingField; // 0x28
	::Class_2_C8461ACA8308A704* _littleGame_k__BackingField; // 0x30
	::Class_2_360C00D6092F4D31* _chenLingFes_k__BackingField; // 0x38
	::Class_2_1152250B69783505* _pingPongGame_k__BackingField; // 0x40
	::Class_2_E59BCDE177AC4581* _timelineControlGameState_k__BackingField; // 0x48
	::Class_2_2090B77B5C7838F2* _chenLingGame_k__BackingField; // 0x50
	::Class_2_69AA5F2CC0126C4F* _uI3DGameConfig_k__BackingField; // 0x58
	::Class_2_40DC0E2CBD29C398* _match3Game_k__BackingField; // 0x60
	...
	::Class_2_31D39E0B0ADFB12E* _fourRotateVoxelGame_k__BackingField; // 0x90
	::Class_2_80F8710F847F1248* _elfRestaurantGame_k__BackingField; // 0x98
	::Class_2_884D02965B14FC41* _movieGameState_k__BackingField; // 0xA0
	::Class_2_ED5ACF982FC3BE02* _timelineControlGameConfig_k__BackingField; // 0xA8
	::Class_2_FB9CF047C8AEAA83* _chimeraDuelGame_k__BackingField; // 0xB0
	::Class_2_CC109BC117037E72* _timeRelayFlameGame_k__BackingField; // 0xB8
	::Class_2_2B2547BD1ECDA4D6* _chimeraGame_k__BackingField; // 0xC0
