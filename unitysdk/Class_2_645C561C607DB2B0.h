...
#define CLASS_2_645C561C607DB2B0_DISPOSE_OFFSET UNITYSDK_OFFSET(0x118819C0)
#define CLASS_2_645C561C607DB2B0_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x11881CD0)
#define CLASS_2_645C561C607DB2B0_ONSKIP_OFFSET UNITYSDK_OFFSET(0x11881A60)
#define CLASS_2_645C561C607DB2B0_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11881AB0)
#define CLASS_2_645C561C607DB2B0_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x11881A10)
#define CLASS_2_645C561C607DB2B0_TICK_OFFSET UNITYSDK_OFFSET(0x11881C50)
#define CLASS_2_645C561C607DB2B0__CTOR_OFFSET UNITYSDK_OFFSET(0x118819A0)
...
public:
	...
	::Class_1_A2D8E5AB4B623162* Field_2_3; // 0x20
	::RPG::GameCore::WaitAbilityStartTimeStamp* Field_2_0; // 0x28
