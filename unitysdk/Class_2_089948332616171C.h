...
#define CLASS_2_089948332616171C_DISPOSE_OFFSET UNITYSDK_OFFSET(0x110C8250)
#define CLASS_2_089948332616171C_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x110C8290)
#define CLASS_2_089948332616171C_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x110C82E0)
#define CLASS_2_089948332616171C_TICK_OFFSET UNITYSDK_OFFSET(0x110C8330)
#define CLASS_2_089948332616171C__CTOR_OFFSET UNITYSDK_OFFSET(0x110C8240)

inline static constexpr unsigned int Class_2_089948332616171C_TypeDefinitionIndex = 42976;

class Class_2_089948332616171C : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::DefineDynamicStringByAssistantID* Field_2_0; // 0x20
