...
#define CLASS_1_8C1FA6D12B3CF102_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB57C790)
#define CLASS_1_8C1FA6D12B3CF102_METHOD_1_20E20F1D1D8798C4_OFFSET UNITYSDK_OFFSET(0xB57CA70)
#define CLASS_1_8C1FA6D12B3CF102_METHOD_1_47680E2642F37A1B_OFFSET UNITYSDK_OFFSET(0xB57C860)
#define CLASS_1_8C1FA6D12B3CF102_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xB57C9B0)
#define CLASS_1_8C1FA6D12B3CF102_METHOD_1_B89F9C5767980F5A_OFFSET UNITYSDK_OFFSET(0xB57C300)
#define CLASS_1_8C1FA6D12B3CF102_METHOD_1_BCAE7F7048277762_OFFSET UNITYSDK_OFFSET(0xB57C730)
#define CLASS_1_8C1FA6D12B3CF102_METHOD_1_E69F3DFB7CDFE412_OFFSET UNITYSDK_OFFSET(0xB57C810)
#define CLASS_1_8C1FA6D12B3CF102__CCTOR_OFFSET UNITYSDK_OFFSET(0xB57CB40)
#define CLASS_1_8C1FA6D12B3CF102__CTOR_OFFSET UNITYSDK_OFFSET(0xB57C1D0)

inline static constexpr unsigned int Class_1_8C1FA6D12B3CF102_TypeDefinitionIndex = 68640;
...
public:
	...
	{
		return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_8C1FA6D12B3CF102_TypeDefinitionIndex)->GetStaticField(0x56A20);
	}
	::Class_1_8C1FA6D12B3CF102_Class_1_D1ADE2B301D1C0F2* Field_1_5; // 0x10
	::System::Collections::Generic::List_1<::UnityEngine::Material*>* Field_1_7; // 0x18
	::UnityEngine::GameObject* Field_1_0; // 0x20
	::Class_1_8C1FA6D12B3CF102_Class_1_D1ADE2B301D1C0F2* Field_1_4; // 0x28
	::UnityEngine::MeshRenderer* Field_1_2; // 0x30
	::Class_1_8C1FA6D12B3CF102_Class_1_D1ADE2B301D1C0F2* Field_1_3; // 0x38
	::UnityEngine::Material* Field_1_1; // 0x40
