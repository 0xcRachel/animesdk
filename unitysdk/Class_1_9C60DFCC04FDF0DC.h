...
#define CLASS_1_9C60DFCC04FDF0DC_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A741360)
#define CLASS_1_9C60DFCC04FDF0DC_CLONE_OFFSET UNITYSDK_OFFSET(0x1A740D90)
#define CLASS_1_9C60DFCC04FDF0DC_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A740E40)
#define CLASS_1_9C60DFCC04FDF0DC_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A740E10)
#define CLASS_1_9C60DFCC04FDF0DC_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A740FF0)
#define CLASS_1_9C60DFCC04FDF0DC_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A741700)
#define CLASS_1_9C60DFCC04FDF0DC_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A741510)
#define CLASS_1_9C60DFCC04FDF0DC_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1A740DC0)
#define CLASS_1_9C60DFCC04FDF0DC_METHOD_1_2ACF2A61FB239D23_OFFSET UNITYSDK_OFFSET(0x1A740DF0)
#define CLASS_1_9C60DFCC04FDF0DC_METHOD_1_358A144584A5DBFC_OFFSET UNITYSDK_OFFSET(0x1A740D10)
#define CLASS_1_9C60DFCC04FDF0DC_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A740B40)
#define CLASS_1_9C60DFCC04FDF0DC_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x1A740DE0)
#define CLASS_1_9C60DFCC04FDF0DC_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1A740DD0)
#define CLASS_1_9C60DFCC04FDF0DC_METHOD_1_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x1A740E00)
#define CLASS_1_9C60DFCC04FDF0DC_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x1A740D70)
#define CLASS_1_9C60DFCC04FDF0DC_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A740B70)
#define CLASS_1_9C60DFCC04FDF0DC_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A741190)
#define CLASS_1_9C60DFCC04FDF0DC_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A7411F0)
#define CLASS_1_9C60DFCC04FDF0DC__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A7419A0)
#define CLASS_1_9C60DFCC04FDF0DC__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A740BD0)
#define CLASS_1_9C60DFCC04FDF0DC__CTOR_OFFSET UNITYSDK_OFFSET(0x1A740B80)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_6CEA13619F869F51*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_9C60DFCC04FDF0DC_TypeDefinitionIndex)->GetStaticField(0x399A0);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_9C60DFCC04FDF0DC*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_9C60DFCC04FDF0DC*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_9C60DFCC04FDF0DC_TypeDefinitionIndex)->GetStaticField(0x399A8);
	}
	...
	::Class_1_9C60DFCC04FDF0DC_Enum_3_2E741879C8CDBAFC_25 Field_1_8; // 0x28
