...
#define CLASS_1_9C60DFCC04FDF0DC_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x199475F0)
#define CLASS_1_9C60DFCC04FDF0DC_CLONE_OFFSET UNITYSDK_OFFSET(0x19947020)
#define CLASS_1_9C60DFCC04FDF0DC_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x199470D0)
#define CLASS_1_9C60DFCC04FDF0DC_EQUALS_OFFSET UNITYSDK_OFFSET(0x199470A0)
#define CLASS_1_9C60DFCC04FDF0DC_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19947280)
#define CLASS_1_9C60DFCC04FDF0DC_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19947990)
#define CLASS_1_9C60DFCC04FDF0DC_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x199477A0)
#define CLASS_1_9C60DFCC04FDF0DC_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x19947050)
#define CLASS_1_9C60DFCC04FDF0DC_METHOD_1_2ACF2A61FB239D23_OFFSET UNITYSDK_OFFSET(0x19947080)
#define CLASS_1_9C60DFCC04FDF0DC_METHOD_1_358A144584A5DBFC_OFFSET UNITYSDK_OFFSET(0x19946FA0)
#define CLASS_1_9C60DFCC04FDF0DC_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19946DD0)
#define CLASS_1_9C60DFCC04FDF0DC_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x19947070)
#define CLASS_1_9C60DFCC04FDF0DC_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x19947060)
#define CLASS_1_9C60DFCC04FDF0DC_METHOD_1_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x19947090)
#define CLASS_1_9C60DFCC04FDF0DC_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x19947000)
#define CLASS_1_9C60DFCC04FDF0DC_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19946E00)
#define CLASS_1_9C60DFCC04FDF0DC_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19947430)
#define CLASS_1_9C60DFCC04FDF0DC_WRITETO_OFFSET UNITYSDK_OFFSET(0x19947490)
#define CLASS_1_9C60DFCC04FDF0DC__CCTOR_OFFSET UNITYSDK_OFFSET(0x19947B40)
#define CLASS_1_9C60DFCC04FDF0DC__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19946E60)
#define CLASS_1_9C60DFCC04FDF0DC__CTOR_OFFSET UNITYSDK_OFFSET(0x19946E10)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_9C60DFCC04FDF0DC*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_9C60DFCC04FDF0DC_TypeDefinitionIndex)->GetStaticField(0x7CC0);
	}
	static ::Google::Protobuf::FieldCodec_1<::Class_1_58D4E6FABD47E257*>** StaticGet_Field_1_5()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_58D4E6FABD47E257*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_9C60DFCC04FDF0DC_TypeDefinitionIndex)->GetStaticField(0x7CC8);
	}
