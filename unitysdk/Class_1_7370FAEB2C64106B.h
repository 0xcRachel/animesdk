...
#define CLASS_1_7370FAEB2C64106B_CLEAR_OFFSET UNITYSDK_OFFSET(0x16B17580)
#define CLASS_1_7370FAEB2C64106B__CTOR_OFFSET UNITYSDK_OFFSET(0x16B17640)
...
public:
	...
	::RPG::GameCore::ChimeraBattleConditionEvaluator* Field_1_7; // 0x18
