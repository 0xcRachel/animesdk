...
#define CLASS_2_4DAD3B9FE7AD7A9C_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10602F60)
#define CLASS_2_4DAD3B9FE7AD7A9C_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10602FA0)
#define CLASS_2_4DAD3B9FE7AD7A9C_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10603030)
#define CLASS_2_4DAD3B9FE7AD7A9C_TICK_OFFSET UNITYSDK_OFFSET(0x10603080)
#define CLASS_2_4DAD3B9FE7AD7A9C__CTOR_OFFSET UNITYSDK_OFFSET(0x10602F50)

inline static constexpr unsigned int Class_2_4DAD3B9FE7AD7A9C_TypeDefinitionIndex = 46172;
