...
#define CLASS_2_B8D0D905DA513A78_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11141A30)
#define CLASS_2_B8D0D905DA513A78_METHOD_2_5835DC16FC46989B_OFFSET UNITYSDK_OFFSET(0x11141FC0)
#define CLASS_2_B8D0D905DA513A78_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11141AB0)
#define CLASS_2_B8D0D905DA513A78_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x11142310)
#define CLASS_2_B8D0D905DA513A78_TICK_OFFSET UNITYSDK_OFFSET(0x11142360)
#define CLASS_2_B8D0D905DA513A78__CTOR_OFFSET UNITYSDK_OFFSET(0x111419B0)

inline static constexpr unsigned int Class_2_B8D0D905DA513A78_TypeDefinitionIndex = 42949;

class Class_2_B8D0D905DA513A78 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::Class_3_BCCE950C2E8DF1F0* Field_2_0; // 0x18
	::RPG::GameCore::CommandPartner* Field_2_1; // 0x20
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_2_B8D0D905DA513A78_METHOD_2_5835DC16FC46989B_OFFSET))(this);
	}
};
