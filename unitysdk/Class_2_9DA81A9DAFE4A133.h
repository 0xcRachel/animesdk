...
#define CLASS_2_9DA81A9DAFE4A133_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB8D3150)
#define CLASS_2_9DA81A9DAFE4A133_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB8D3190)
#define CLASS_2_9DA81A9DAFE4A133_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB8D3560)
#define CLASS_2_9DA81A9DAFE4A133_TICK_OFFSET UNITYSDK_OFFSET(0xB8D35B0)
#define CLASS_2_9DA81A9DAFE4A133__CTOR_OFFSET UNITYSDK_OFFSET(0xB8D3080)

inline static constexpr unsigned int Class_2_9DA81A9DAFE4A133_TypeDefinitionIndex = 43221;

class Class_2_9DA81A9DAFE4A133 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::RemoveDynamicEntityParam* Field_2_1; // 0x18
