...
#define CLASS_1_5B567C8A01BAEDFE_184_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A0AFA20)
#define CLASS_1_5B567C8A01BAEDFE_184_CLONE_OFFSET UNITYSDK_OFFSET(0x1A0AF830)
#define CLASS_1_5B567C8A01BAEDFE_184_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A0AF930)
#define CLASS_1_5B567C8A01BAEDFE_184_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A0AF8A0)
#define CLASS_1_5B567C8A01BAEDFE_184_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A0AF980)
#define CLASS_1_5B567C8A01BAEDFE_184_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A0AFA70)
#define CLASS_1_5B567C8A01BAEDFE_184_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A0AFA40)
#define CLASS_1_5B567C8A01BAEDFE_184_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A0AF780)
#define CLASS_1_5B567C8A01BAEDFE_184_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A0AF7E0)
#define CLASS_1_5B567C8A01BAEDFE_184_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A0AF9B0)
#define CLASS_1_5B567C8A01BAEDFE_184_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A0AFA10)
#define CLASS_1_5B567C8A01BAEDFE_184__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A0AFAC0)
#define CLASS_1_5B567C8A01BAEDFE_184__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0AF800)
#define CLASS_1_5B567C8A01BAEDFE_184__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0AF7F0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_184*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_184_TypeDefinitionIndex)->GetStaticField(0x23F50);
	}
