...
#define CLASS_3_4D7A1C7A7AE5C8DF_DISPOSE_OFFSET UNITYSDK_OFFSET(0xFF06110)
#define CLASS_3_4D7A1C7A7AE5C8DF_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xFF05C30)
#define CLASS_3_4D7A1C7A7AE5C8DF_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xFF05F50)
#define CLASS_3_4D7A1C7A7AE5C8DF_TICK_OFFSET UNITYSDK_OFFSET(0xFF05FA0)
#define CLASS_3_4D7A1C7A7AE5C8DF__CTOR_OFFSET UNITYSDK_OFFSET(0xFF05C10)
#define CLASS_3_4D7A1C7A7AE5C8DF___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xFF06170)
#define CLASS_3_4D7A1C7A7AE5C8DF___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0xFF06160)

inline static constexpr unsigned int Class_3_4D7A1C7A7AE5C8DF_TypeDefinitionIndex = 41128;
