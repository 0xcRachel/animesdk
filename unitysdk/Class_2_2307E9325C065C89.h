...
#define CLASS_2_2307E9325C065C89_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1079C620)
#define CLASS_2_2307E9325C065C89_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1079C4D0)
#define CLASS_2_2307E9325C065C89_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1079C580)
#define CLASS_2_2307E9325C065C89_TICK_OFFSET UNITYSDK_OFFSET(0x1079C5C0)
#define CLASS_2_2307E9325C065C89__CTOR_OFFSET UNITYSDK_OFFSET(0x1079C4C0)
