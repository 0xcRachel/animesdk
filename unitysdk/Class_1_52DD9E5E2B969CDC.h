...
#define CLASS_1_52DD9E5E2B969CDC_CLEAR_OFFSET UNITYSDK_OFFSET(0xD161F60)
#define CLASS_1_52DD9E5E2B969CDC_GET_AUDIENCEMOODMAPCONFIGPATH_OFFSET UNITYSDK_OFFSET(0xD161DD0)
#define CLASS_1_52DD9E5E2B969CDC_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0xD161E10)
#define CLASS_1_52DD9E5E2B969CDC_GET_CROWDVARIANTPATH_OFFSET UNITYSDK_OFFSET(0xD161DB0)
#define CLASS_1_52DD9E5E2B969CDC_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xD161E30)
#define CLASS_1_52DD9E5E2B969CDC_GET_PREFAB_OFFSET UNITYSDK_OFFSET(0xD161DF0)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_092CD57850778EFC_OFFSET UNITYSDK_OFFSET(0xD162EE0)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_13263CB5FCEC31EC_OFFSET UNITYSDK_OFFSET(0xD1625E0)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_17773E5AAC0D5C9C_OFFSET UNITYSDK_OFFSET(0xD161D40)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_1E13A8A5C0FF7D62_OFFSET UNITYSDK_OFFSET(0xD162070)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0xD162690)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_279FA27EC5CC6ADB_OFFSET UNITYSDK_OFFSET(0xD161E50)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_2F46EF9FA91E7517_OFFSET UNITYSDK_OFFSET(0xD1627A0)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_498371003099FBD4_OFFSET UNITYSDK_OFFSET(0xD161250)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_570C5557A774C69E_OFFSET UNITYSDK_OFFSET(0xD162510)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_6130BC24956B5935_OFFSET UNITYSDK_OFFSET(0xD1624C0)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_7206DC8F66A4D2A8_OFFSET UNITYSDK_OFFSET(0xD161740)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_732EDB3121B072B2_OFFSET UNITYSDK_OFFSET(0xD161560)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_83F4F6CFBC2434C6_OFFSET UNITYSDK_OFFSET(0xD162020)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_8D595942D57F40CD_OFFSET UNITYSDK_OFFSET(0xD161CC0)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_9968CD0165DD7DC7_OFFSET UNITYSDK_OFFSET(0xD162890)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_AF2CFBAAD2629B3B_OFFSET UNITYSDK_OFFSET(0xD1626F0)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_C5E8E8BC88564F4A_OFFSET UNITYSDK_OFFSET(0xD1618A0)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_DBBCAD768C3A9030_OFFSET UNITYSDK_OFFSET(0xD1610B0)
#define CLASS_1_52DD9E5E2B969CDC_SET_AUDIENCEMOODMAPCONFIGPATH_OFFSET UNITYSDK_OFFSET(0xD161DE0)
#define CLASS_1_52DD9E5E2B969CDC_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0xD161E20)
#define CLASS_1_52DD9E5E2B969CDC_SET_CROWDVARIANTPATH_OFFSET UNITYSDK_OFFSET(0xD161DC0)
#define CLASS_1_52DD9E5E2B969CDC_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xD161E40)
#define CLASS_1_52DD9E5E2B969CDC_SET_PREFAB_OFFSET UNITYSDK_OFFSET(0xD161E00)
#define CLASS_1_52DD9E5E2B969CDC__CCTOR_OFFSET UNITYSDK_OFFSET(0xD162F60)
#define CLASS_1_52DD9E5E2B969CDC__CTOR_OFFSET UNITYSDK_OFFSET(0xD162F50)
...
public:
	...
	{
		return (::System::Collections::Generic::List_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_52DD9E5E2B969CDC_TypeDefinitionIndex)->GetStaticField(0x1EE30);
	}
	// static const ::System::Single Field_1_19; // 0x0
	::RPG::Client::CrowdAnimator::CrowdVariant* _Prefab_k__BackingField; // 0x10
	::RPG::Client::AudienceGroupInstance* Field_1_6; // 0x18
	::RPG::Client::CrowdAnimator::CrowdInstance* _Instance_k__BackingField; // 0x20
	::System::String* _AudienceMoodMapConfigPath_k__BackingField; // 0x28
	::System::Collections::Generic::List_1<::Class_1_E85115A4C331A9DA*>* Field_1_3; // 0x30
	::Class_1_6B7F9A1269220FA8* Field_1_2; // 0x38
	::System::String* Field_1_5; // 0x40
	::System::String* _CrowdVariantPath_k__BackingField; // 0x48
	::System::String* Field_1_0; // 0x50
	::RPG::Client::AudienceMoodMapConfig* _Config_k__BackingField; // 0x58
	::UnityEngine::CapsuleCollider* Field_1_18; // 0x60
	::RPG::GameCore::NPCBodySize Field_1_9; // 0x68
	::System::Boolean Field_1_1; // 0x6C
	::UnityEngine::Quaternion Field_1_8; // 0x70
	::RPG::Client::AudienceStanceConfig_EPositionPoseType Field_1_10; // 0x80
	::Class_1_52DD9E5E2B969CDC_EPose Field_1_11; // 0x84
	::UnityEngine::Vector3 Field_1_7; // 0x88
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_52DD9E5E2B969CDC_METHOD_1_732EDB3121B072B2_OFFSET))(this);
	}
