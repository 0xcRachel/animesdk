...
#define SROPTIONS_NUMBERRANGEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x82B25A0)

inline static constexpr unsigned int SROptions_NumberRangeAttribute_TypeDefinitionIndex = 34160;
