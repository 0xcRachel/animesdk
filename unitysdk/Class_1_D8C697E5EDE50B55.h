...
#define CLASS_1_D8C697E5EDE50B55_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17C58030)
#define CLASS_1_D8C697E5EDE50B55_CLONE_OFFSET UNITYSDK_OFFSET(0x17C57B90)
#define CLASS_1_D8C697E5EDE50B55_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17C57C80)
#define CLASS_1_D8C697E5EDE50B55_EQUALS_OFFSET UNITYSDK_OFFSET(0x17C57C50)
#define CLASS_1_D8C697E5EDE50B55_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17C57D60)
#define CLASS_1_D8C697E5EDE50B55_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x17C583E0)
#define CLASS_1_D8C697E5EDE50B55_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x17C58310)
#define CLASS_1_D8C697E5EDE50B55_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x17C57C10)
#define CLASS_1_D8C697E5EDE50B55_METHOD_1_02A3D10A9D535169_2_OFFSET UNITYSDK_OFFSET(0x17C57C30)
#define CLASS_1_D8C697E5EDE50B55_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x17C57BF0)
#define CLASS_1_D8C697E5EDE50B55_METHOD_1_3DACC45AC8150727_OFFSET UNITYSDK_OFFSET(0x17C57BD0)
#define CLASS_1_D8C697E5EDE50B55_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x17C57C20)
#define CLASS_1_D8C697E5EDE50B55_METHOD_1_7786DC814C2FC3BE_2_OFFSET UNITYSDK_OFFSET(0x17C57C40)
#define CLASS_1_D8C697E5EDE50B55_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x17C57C00)
#define CLASS_1_D8C697E5EDE50B55_METHOD_1_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x17C57BC0)
#define CLASS_1_D8C697E5EDE50B55_METHOD_1_CF8C379558248BF8_OFFSET UNITYSDK_OFFSET(0x17C57BE0)
#define CLASS_1_D8C697E5EDE50B55_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17C57A60)
#define CLASS_1_D8C697E5EDE50B55_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17C57E60)
#define CLASS_1_D8C697E5EDE50B55_WRITETO_OFFSET UNITYSDK_OFFSET(0x17C57EC0)
#define CLASS_1_D8C697E5EDE50B55__CCTOR_OFFSET UNITYSDK_OFFSET(0x17C58500)
#define CLASS_1_D8C697E5EDE50B55__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17C57AC0)
#define CLASS_1_D8C697E5EDE50B55__CTOR_OFFSET UNITYSDK_OFFSET(0x17C57A70)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Proto::DisplayAvatarDetailInfo*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_D8C697E5EDE50B55_TypeDefinitionIndex)->GetStaticField(0x3A5D0);
	}
	...
	::Enum_3_4608E37A1B3D374A_4 Field_1_2; // 0x24
