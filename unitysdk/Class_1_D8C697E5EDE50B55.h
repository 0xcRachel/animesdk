...
#define CLASS_1_D8C697E5EDE50B55_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17607EF0)
#define CLASS_1_D8C697E5EDE50B55_CLONE_OFFSET UNITYSDK_OFFSET(0x17607A40)
#define CLASS_1_D8C697E5EDE50B55_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17607B30)
#define CLASS_1_D8C697E5EDE50B55_EQUALS_OFFSET UNITYSDK_OFFSET(0x17607B00)
#define CLASS_1_D8C697E5EDE50B55_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17607C10)
#define CLASS_1_D8C697E5EDE50B55_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x17608280)
#define CLASS_1_D8C697E5EDE50B55_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x176081B0)
#define CLASS_1_D8C697E5EDE50B55_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x17607A90)
#define CLASS_1_D8C697E5EDE50B55_METHOD_1_02A3D10A9D535169_2_OFFSET UNITYSDK_OFFSET(0x17607AE0)
#define CLASS_1_D8C697E5EDE50B55_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x17607A70)
#define CLASS_1_D8C697E5EDE50B55_METHOD_1_3DACC45AC8150727_OFFSET UNITYSDK_OFFSET(0x17607AC0)
#define CLASS_1_D8C697E5EDE50B55_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x17607AA0)
#define CLASS_1_D8C697E5EDE50B55_METHOD_1_7786DC814C2FC3BE_2_OFFSET UNITYSDK_OFFSET(0x17607AF0)
#define CLASS_1_D8C697E5EDE50B55_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x17607A80)
#define CLASS_1_D8C697E5EDE50B55_METHOD_1_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x17607AB0)
#define CLASS_1_D8C697E5EDE50B55_METHOD_1_CF8C379558248BF8_OFFSET UNITYSDK_OFFSET(0x17607AD0)
#define CLASS_1_D8C697E5EDE50B55_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17607910)
#define CLASS_1_D8C697E5EDE50B55_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17607D20)
#define CLASS_1_D8C697E5EDE50B55_WRITETO_OFFSET UNITYSDK_OFFSET(0x17607D80)
#define CLASS_1_D8C697E5EDE50B55__CCTOR_OFFSET UNITYSDK_OFFSET(0x17608390)
#define CLASS_1_D8C697E5EDE50B55__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17607970)
#define CLASS_1_D8C697E5EDE50B55__CTOR_OFFSET UNITYSDK_OFFSET(0x17607920)

inline static constexpr unsigned int Class_1_D8C697E5EDE50B55_TypeDefinitionIndex = 24015;

class Class_1_D8C697E5EDE50B55 : public ::System::Object
{
public:
	static ::Google::Protobuf::FieldCodec_1<::Proto::DisplayAvatarDetailInfo*>** StaticGet_Field_1_8()
	{
		return (::Google::Protobuf::FieldCodec_1<::Proto::DisplayAvatarDetailInfo*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_D8C697E5EDE50B55_TypeDefinitionIndex)->GetStaticField(0x1B210);
	}
	...
	::Google::Protobuf::Collections::RepeatedField_1<::Proto::DisplayAvatarDetailInfo*>* Field_1_9; // 0x10
	::Google::Protobuf::UnknownFieldSet* Field_1_0; // 0x18
	::System::UInt32 Field_1_4; // 0x20
	::System::UInt32 Field_1_11; // 0x24
	::Enum_3_4608E37A1B3D374A_4 Field_1_6; // 0x28
