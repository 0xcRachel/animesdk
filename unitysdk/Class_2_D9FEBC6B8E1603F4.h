...
#define CLASS_2_D9FEBC6B8E1603F4_GET_BATTLETARGETIDS_OFFSET UNITYSDK_OFFSET(0x17702B70)
#define CLASS_2_D9FEBC6B8E1603F4_GET_CLEARSCORE_OFFSET UNITYSDK_OFFSET(0x17702B30)
#define CLASS_2_D9FEBC6B8E1603F4_GET_FEVERMAZEBUFFIDS_OFFSET UNITYSDK_OFFSET(0x17702B50)
#define CLASS_2_D9FEBC6B8E1603F4_SET_BATTLETARGETIDS_OFFSET UNITYSDK_OFFSET(0x17702B80)
#define CLASS_2_D9FEBC6B8E1603F4_SET_CLEARSCORE_OFFSET UNITYSDK_OFFSET(0x17702B40)
#define CLASS_2_D9FEBC6B8E1603F4_SET_FEVERMAZEBUFFIDS_OFFSET UNITYSDK_OFFSET(0x17702B60)
#define CLASS_2_D9FEBC6B8E1603F4__CTOR_OFFSET UNITYSDK_OFFSET(0x17702B90)

inline static constexpr unsigned int Class_2_D9FEBC6B8E1603F4_TypeDefinitionIndex = 74104;
