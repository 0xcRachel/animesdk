...
#define AKGAMEOBJ_ADDLISTENER_OFFSET UNITYSDK_OFFSET(0x19DC80C0)
#define AKGAMEOBJ_AWAKE_OFFSET UNITYSDK_OFFSET(0x19DE5DE0)
#define AKGAMEOBJ_CHECKSTATICSTATUS_OFFSET UNITYSDK_OFFSET(0x19DE6BD0)
#define AKGAMEOBJ_GETFORWARD_OFFSET UNITYSDK_OFFSET(0x19DE7CC0)
#define AKGAMEOBJ_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x19DE79D0)
#define AKGAMEOBJ_GETUPWARD_OFFSET UNITYSDK_OFFSET(0x19DE7E80)
#define AKGAMEOBJ_GET_ISAUTOSTOP_OFFSET UNITYSDK_OFFSET(0x19DE5950)
#define AKGAMEOBJ_GET_ISUSINGDEFAULTLISTENERS_OFFSET UNITYSDK_OFFSET(0x19DE0820)
#define AKGAMEOBJ_GET_LISTENERLIST_OFFSET UNITYSDK_OFFSET(0x19DE0840)
#define AKGAMEOBJ_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19DE6EB0)
#define AKGAMEOBJ_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19DE6C10)
#define AKGAMEOBJ_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x19DE8040)
#define AKGAMEOBJ_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x19DE80B0)
#define AKGAMEOBJ_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x19DE6AC0)
#define AKGAMEOBJ_REGISTER_OFFSET UNITYSDK_OFFSET(0x19DC7CA0)
#define AKGAMEOBJ_REMOVELISTENER_OFFSET UNITYSDK_OFFSET(0x19DC8120)
#define AKGAMEOBJ_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x19DE5C90)
#define AKGAMEOBJ_SET_ISAUTOSTOP_OFFSET UNITYSDK_OFFSET(0x19DE5960)
#define AKGAMEOBJ_TICK_OFFSET UNITYSDK_OFFSET(0x19DE7280)
#define AKGAMEOBJ__CTOR_OFFSET UNITYSDK_OFFSET(0x19DE8530)
