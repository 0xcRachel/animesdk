...
#define AKGAMEOBJ_ADDLISTENER_OFFSET UNITYSDK_OFFSET(0x18BA3530)
#define AKGAMEOBJ_AWAKE_OFFSET UNITYSDK_OFFSET(0x18BC18A0)
#define AKGAMEOBJ_CHECKSTATICSTATUS_OFFSET UNITYSDK_OFFSET(0x18BC27C0)
#define AKGAMEOBJ_GETFORWARD_OFFSET UNITYSDK_OFFSET(0x18BC3750)
#define AKGAMEOBJ_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x18BC3460)
#define AKGAMEOBJ_GETUPWARD_OFFSET UNITYSDK_OFFSET(0x18BC3910)
#define AKGAMEOBJ_GET_ISAUTOSTOP_OFFSET UNITYSDK_OFFSET(0x18BC1410)
#define AKGAMEOBJ_GET_ISUSINGDEFAULTLISTENERS_OFFSET UNITYSDK_OFFSET(0x18BBC220)
#define AKGAMEOBJ_GET_LISTENERLIST_OFFSET UNITYSDK_OFFSET(0x18BBC240)
#define AKGAMEOBJ_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18BC29D0)
#define AKGAMEOBJ_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18BC2800)
#define AKGAMEOBJ_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x18BC3AD0)
#define AKGAMEOBJ_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x18BC3B40)
#define AKGAMEOBJ_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x18BC26B0)
#define AKGAMEOBJ_REGISTER_OFFSET UNITYSDK_OFFSET(0x18BA3170)
#define AKGAMEOBJ_REMOVELISTENER_OFFSET UNITYSDK_OFFSET(0x18BA3590)
#define AKGAMEOBJ_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x18BC1750)
#define AKGAMEOBJ_SET_ISAUTOSTOP_OFFSET UNITYSDK_OFFSET(0x18BC1420)
#define AKGAMEOBJ_TICK_OFFSET UNITYSDK_OFFSET(0x18BC2D10)
#define AKGAMEOBJ__CTOR_OFFSET UNITYSDK_OFFSET(0x18BC3FD0)
