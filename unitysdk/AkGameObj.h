...
#define AKGAMEOBJ_ADDLISTENER_OFFSET UNITYSDK_OFFSET(0x192AD050)
#define AKGAMEOBJ_AWAKE_OFFSET UNITYSDK_OFFSET(0x192CB490)
#define AKGAMEOBJ_CHECKSTATICSTATUS_OFFSET UNITYSDK_OFFSET(0x192CC3B0)
#define AKGAMEOBJ_GETFORWARD_OFFSET UNITYSDK_OFFSET(0x192CD340)
#define AKGAMEOBJ_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x192CD050)
#define AKGAMEOBJ_GETUPWARD_OFFSET UNITYSDK_OFFSET(0x192CD500)
#define AKGAMEOBJ_GET_ISAUTOSTOP_OFFSET UNITYSDK_OFFSET(0x192CB000)
#define AKGAMEOBJ_GET_ISUSINGDEFAULTLISTENERS_OFFSET UNITYSDK_OFFSET(0x192C5E00)
#define AKGAMEOBJ_GET_LISTENERLIST_OFFSET UNITYSDK_OFFSET(0x192C5E20)
#define AKGAMEOBJ_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x192CC5C0)
#define AKGAMEOBJ_ONENABLE_OFFSET UNITYSDK_OFFSET(0x192CC3F0)
#define AKGAMEOBJ_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x192CD6C0)
#define AKGAMEOBJ_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x192CD730)
#define AKGAMEOBJ_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x192CC2A0)
#define AKGAMEOBJ_REGISTER_OFFSET UNITYSDK_OFFSET(0x192ACC90)
#define AKGAMEOBJ_REMOVELISTENER_OFFSET UNITYSDK_OFFSET(0x192AD0B0)
#define AKGAMEOBJ_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x192CB340)
#define AKGAMEOBJ_SET_ISAUTOSTOP_OFFSET UNITYSDK_OFFSET(0x192CB010)
#define AKGAMEOBJ_TICK_OFFSET UNITYSDK_OFFSET(0x192CC900)
#define AKGAMEOBJ__CTOR_OFFSET UNITYSDK_OFFSET(0x192CDBC0)
