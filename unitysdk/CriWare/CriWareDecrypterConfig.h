...
#define CRIWARE_CRIWAREDECRYPTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x112E3880)

namespace CriWare
{
	inline static constexpr unsigned int CriWareDecrypterConfig_TypeDefinitionIndex = 30316;
