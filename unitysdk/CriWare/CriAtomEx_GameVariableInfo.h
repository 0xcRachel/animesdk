...
#define CRIWARE_CRIATOMEX_GAMEVARIABLEINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1467200)
#define CRIWARE_CRIATOMEX_GAMEVARIABLEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x14671F0)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomEx_GameVariableInfo_TypeDefinitionIndex = 30122;
