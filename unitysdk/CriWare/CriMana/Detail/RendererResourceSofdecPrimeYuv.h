...
#define CRIWARE_CRIMANA_DETAIL_RENDERERRESOURCESOFDECPRIMEYUV_ATTACHTOPLAYER_OFFSET UNITYSDK_OFFSET(0x11A57E80)
#define CRIWARE_CRIMANA_DETAIL_RENDERERRESOURCESOFDECPRIMEYUV_CONTINUEPREPARING_OFFSET UNITYSDK_OFFSET(0x11A57D80)
#define CRIWARE_CRIMANA_DETAIL_RENDERERRESOURCESOFDECPRIMEYUV_GET_ISEDITOR_OFFSET UNITYSDK_OFFSET(0x11A57970)
#define CRIWARE_CRIMANA_DETAIL_RENDERERRESOURCESOFDECPRIMEYUV_GET_NUMTEXTURESETS_OFFSET UNITYSDK_OFFSET(0x11A57870)
#define CRIWARE_CRIMANA_DETAIL_RENDERERRESOURCESOFDECPRIMEYUV_HASRENDEREDNEWFRAME_OFFSET UNITYSDK_OFFSET(0x11A57E70)
#define CRIWARE_CRIMANA_DETAIL_RENDERERRESOURCESOFDECPRIMEYUV_ISPREPARED_OFFSET UNITYSDK_OFFSET(0x11A57D70)
#define CRIWARE_CRIMANA_DETAIL_RENDERERRESOURCESOFDECPRIMEYUV_ISSUITABLE_OFFSET UNITYSDK_OFFSET(0x11A57D90)
#define CRIWARE_CRIMANA_DETAIL_RENDERERRESOURCESOFDECPRIMEYUV_ONDISPOSEMANAGED_OFFSET UNITYSDK_OFFSET(0x11A57960)
#define CRIWARE_CRIMANA_DETAIL_RENDERERRESOURCESOFDECPRIMEYUV_ONDISPOSEUNMANAGED_OFFSET UNITYSDK_OFFSET(0x11A57980)
#define CRIWARE_CRIMANA_DETAIL_RENDERERRESOURCESOFDECPRIMEYUV_ONPLAYERSTOPFORSEEK_OFFSET UNITYSDK_OFFSET(0x11A57E60)
#define CRIWARE_CRIMANA_DETAIL_RENDERERRESOURCESOFDECPRIMEYUV_UPDATEFRAME_OFFSET UNITYSDK_OFFSET(0x11A57F50)
#define CRIWARE_CRIMANA_DETAIL_RENDERERRESOURCESOFDECPRIMEYUV_UPDATEMATERIAL_OFFSET UNITYSDK_OFFSET(0x11A580C0)
#define CRIWARE_CRIMANA_DETAIL_RENDERERRESOURCESOFDECPRIMEYUV_UPDATEMOVIETEXTUREST_OFFSET UNITYSDK_OFFSET(0x11A57880)
#define CRIWARE_CRIMANA_DETAIL_RENDERERRESOURCESOFDECPRIMEYUV_UPDATETEXTURES_OFFSET UNITYSDK_OFFSET(0x11A58350)
#define CRIWARE_CRIMANA_DETAIL_RENDERERRESOURCESOFDECPRIMEYUV__CCTOR_OFFSET UNITYSDK_OFFSET(0x11A58610)
#define CRIWARE_CRIMANA_DETAIL_RENDERERRESOURCESOFDECPRIMEYUV__CTOR_OFFSET UNITYSDK_OFFSET(0x11A55B30)
...
namespace CriWare::CriMana::Detail
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(RendererResourceSofdecPrimeYuv_TypeDefinitionIndex)->GetStaticField(0xF8E0);
		}
		::Il2CppArray<::UnityEngine::Texture2D*>* textureA; // 0x28
		::Il2CppArray<::UnityEngine::Texture2D*>* textureV; // 0x30
		::Il2CppArray<::UnityEngine::Texture2D*>* textureU; // 0x38
		::Il2CppArray<::System::IntPtr>* nativeTextures; // 0x40
		::Il2CppArray<::UnityEngine::Texture2D*>* textureY; // 0x48
		::System::Int32 width; // 0x50
		::System::Boolean isStoppingForSeek; // 0x54
		::System::Boolean hasTextureUpdated; // 0x55
		::System::Int32 height; // 0x58
		::CriWare::CriMana::CodecType codecType; // 0x5C
		::System::Boolean hasRenderedNewFrame; // 0x60
		::System::Boolean useUserShader; // 0x61
		::System::Boolean isTextureReady; // 0x62
		::System::Boolean isFirstTextureReady; // 0x63
		::System::Int32 currentTextureSet; // 0x64
		::UnityEngine::Vector4 movieTextureST; // 0x68
		::UnityEngine::Vector4 movieChromaTextureST; // 0x78
		::System::Int32 playerID; // 0x88
