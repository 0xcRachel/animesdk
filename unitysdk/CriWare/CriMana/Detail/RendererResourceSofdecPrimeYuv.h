...
#define CRIWARE_CRIMANA_DETAIL_RENDERERRESOURCESOFDECPRIMEYUV_ATTACHTOPLAYER_OFFSET UNITYSDK_OFFSET(0x112D0070)
#define CRIWARE_CRIMANA_DETAIL_RENDERERRESOURCESOFDECPRIMEYUV_CONTINUEPREPARING_OFFSET UNITYSDK_OFFSET(0x112CFF70)
#define CRIWARE_CRIMANA_DETAIL_RENDERERRESOURCESOFDECPRIMEYUV_GET_ISEDITOR_OFFSET UNITYSDK_OFFSET(0x112CFB70)
#define CRIWARE_CRIMANA_DETAIL_RENDERERRESOURCESOFDECPRIMEYUV_GET_NUMTEXTURESETS_OFFSET UNITYSDK_OFFSET(0x112CFA60)
#define CRIWARE_CRIMANA_DETAIL_RENDERERRESOURCESOFDECPRIMEYUV_HASRENDEREDNEWFRAME_OFFSET UNITYSDK_OFFSET(0x112D0060)
#define CRIWARE_CRIMANA_DETAIL_RENDERERRESOURCESOFDECPRIMEYUV_ISPREPARED_OFFSET UNITYSDK_OFFSET(0x112CFF60)
#define CRIWARE_CRIMANA_DETAIL_RENDERERRESOURCESOFDECPRIMEYUV_ISSUITABLE_OFFSET UNITYSDK_OFFSET(0x112CFF80)
#define CRIWARE_CRIMANA_DETAIL_RENDERERRESOURCESOFDECPRIMEYUV_ONDISPOSEMANAGED_OFFSET UNITYSDK_OFFSET(0x112CFB60)
#define CRIWARE_CRIMANA_DETAIL_RENDERERRESOURCESOFDECPRIMEYUV_ONDISPOSEUNMANAGED_OFFSET UNITYSDK_OFFSET(0x112CFB80)
#define CRIWARE_CRIMANA_DETAIL_RENDERERRESOURCESOFDECPRIMEYUV_ONPLAYERSTOPFORSEEK_OFFSET UNITYSDK_OFFSET(0x112D0050)
#define CRIWARE_CRIMANA_DETAIL_RENDERERRESOURCESOFDECPRIMEYUV_UPDATEFRAME_OFFSET UNITYSDK_OFFSET(0x112D0140)
#define CRIWARE_CRIMANA_DETAIL_RENDERERRESOURCESOFDECPRIMEYUV_UPDATEMATERIAL_OFFSET UNITYSDK_OFFSET(0x112D02B0)
#define CRIWARE_CRIMANA_DETAIL_RENDERERRESOURCESOFDECPRIMEYUV_UPDATEMOVIETEXTUREST_OFFSET UNITYSDK_OFFSET(0x112CFA70)
#define CRIWARE_CRIMANA_DETAIL_RENDERERRESOURCESOFDECPRIMEYUV_UPDATETEXTURES_OFFSET UNITYSDK_OFFSET(0x112D0540)
#define CRIWARE_CRIMANA_DETAIL_RENDERERRESOURCESOFDECPRIMEYUV__CCTOR_OFFSET UNITYSDK_OFFSET(0x112D0800)
#define CRIWARE_CRIMANA_DETAIL_RENDERERRESOURCESOFDECPRIMEYUV__CTOR_OFFSET UNITYSDK_OFFSET(0x112CDD10)

namespace CriWare::CriMana::Detail
{
	inline static constexpr unsigned int RendererResourceSofdecPrimeYuv_TypeDefinitionIndex = 30376;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(RendererResourceSofdecPrimeYuv_TypeDefinitionIndex)->GetStaticField(0xAE60);
		}
		...
		::Il2CppArray<::UnityEngine::Texture2D*>* textureU; // 0x48
		::System::Int32 playerID; // 0x50
		::System::Int32 currentTextureSet; // 0x54
		::UnityEngine::Vector4 movieTextureST; // 0x58
		::System::Int32 height; // 0x68
		::CriWare::CriMana::CodecType codecType; // 0x6C
		::System::Boolean hasTextureUpdated; // 0x70
		::System::Boolean isStoppingForSeek; // 0x71
		::System::Boolean isTextureReady; // 0x72
		::System::Boolean isFirstTextureReady; // 0x73
		::System::Boolean useUserShader; // 0x74
		::System::Boolean hasRenderedNewFrame; // 0x75
		::System::Int32 drawTextureSet; // 0x78
		::UnityEngine::Vector4 movieChromaTextureST; // 0x7C
		::System::Int32 width; // 0x8C
