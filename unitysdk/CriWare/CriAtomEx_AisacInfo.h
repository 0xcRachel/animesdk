...
#define CRIWARE_CRIATOMEX_AISACINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1466AF0)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomEx_AisacInfo_TypeDefinitionIndex = 30126;
