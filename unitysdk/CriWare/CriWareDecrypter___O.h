...
namespace CriWare
{
	...
	public:
		...
		{
			return (::CriWare::CriWareDecrypter_CallbackFromNativeDelegate**)Il2CppClass::FromTypeDefinitionIndex(CriWareDecrypter___O_TypeDefinitionIndex)->GetStaticField(0xE460);
		}
	};
}
