...
#define CRIWARE_CRIWAREPS4_ISBGMOVERRIDDEN_OFFSET UNITYSDK_OFFSET(0x112E6CE0)
#define CRIWARE_CRIWAREPS4__CTOR_OFFSET UNITYSDK_OFFSET(0x112E6CF0)

namespace CriWare
{
	inline static constexpr unsigned int CriWarePS4_TypeDefinitionIndex = 30072;
