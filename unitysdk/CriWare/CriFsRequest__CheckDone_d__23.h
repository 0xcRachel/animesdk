...
#define CRIWARE_CRIFSREQUEST__CHECKDONE_D__23_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x112CA1D0)
#define CRIWARE_CRIFSREQUEST__CHECKDONE_D__23_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x112CA220)
#define CRIWARE_CRIFSREQUEST__CHECKDONE_D__23_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x112CA280)
#define CRIWARE_CRIFSREQUEST__CHECKDONE_D__23_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x112CA230)
#define CRIWARE_CRIFSREQUEST__CHECKDONE_D__23_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x112CA1C0)
#define CRIWARE_CRIFSREQUEST__CHECKDONE_D__23__CTOR_OFFSET UNITYSDK_OFFSET(0x112CA130)

namespace CriWare
{
	inline static constexpr unsigned int CriFsRequest__CheckDone_d__23_TypeDefinitionIndex = 30254;
