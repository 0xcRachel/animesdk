...
#define CRIWARE_CRIATOMEX_CUEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1467110)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomEx_CueInfo_TypeDefinitionIndex = 30124;
