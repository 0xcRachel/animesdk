...
#define CRIWARE_CRIATOMEXACF_CATEGORYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x14695F0)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomExAcf_CategoryInfo_TypeDefinitionIndex = 30179;
