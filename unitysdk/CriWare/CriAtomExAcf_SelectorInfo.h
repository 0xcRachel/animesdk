...
#define CRIWARE_CRIATOMEXACF_SELECTORINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1469730)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomExAcf_SelectorInfo_TypeDefinitionIndex = 30186;
