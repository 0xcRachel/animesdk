...
#define CLASS_3_2ABCC1F6EDC9A0B0_METHOD_3_D98BA75FC67827C5_OFFSET UNITYSDK_OFFSET(0x10FF1780)
#define CLASS_3_2ABCC1F6EDC9A0B0_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10FF1250)
#define CLASS_3_2ABCC1F6EDC9A0B0_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10FF1880)
#define CLASS_3_2ABCC1F6EDC9A0B0__CTOR_OFFSET UNITYSDK_OFFSET(0x10FF1220)

inline static constexpr unsigned int Class_3_2ABCC1F6EDC9A0B0_TypeDefinitionIndex = 41223;
