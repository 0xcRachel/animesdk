...
#define CLASS_2_DCAE1D6145F68C32_DISPOSE_OFFSET UNITYSDK_OFFSET(0x104E7CD0)
#define CLASS_2_DCAE1D6145F68C32_GET_POSAPDATIONTARGET_OFFSET UNITYSDK_OFFSET(0x104E91D0)
#define CLASS_2_DCAE1D6145F68C32_METHOD_2_14E83132A0D8CA04_OFFSET UNITYSDK_OFFSET(0x104E8DB0)
#define CLASS_2_DCAE1D6145F68C32_METHOD_2_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x104E8360)
#define CLASS_2_DCAE1D6145F68C32_METHOD_2_36AEAFDA089C2E0C_OFFSET UNITYSDK_OFFSET(0x104E8F40)
#define CLASS_2_DCAE1D6145F68C32_METHOD_2_3D78D2E0F9F95F07_OFFSET UNITYSDK_OFFSET(0x104E9120)
#define CLASS_2_DCAE1D6145F68C32_METHOD_2_79F82AA229668E10_OFFSET UNITYSDK_OFFSET(0x104E83E0)
#define CLASS_2_DCAE1D6145F68C32_METHOD_2_921C3C3E09D59CD4_OFFSET UNITYSDK_OFFSET(0x104E7E50)
#define CLASS_2_DCAE1D6145F68C32_METHOD_2_96A53A17AC5D0E93_OFFSET UNITYSDK_OFFSET(0x104E8310)
#define CLASS_2_DCAE1D6145F68C32_METHOD_2_AE0258B108DEC531_OFFSET UNITYSDK_OFFSET(0x104E9140)
#define CLASS_2_DCAE1D6145F68C32_METHOD_2_B40F084418F05DE4_OFFSET UNITYSDK_OFFSET(0x104E85B0)
#define CLASS_2_DCAE1D6145F68C32_METHOD_2_B6F8CAF32E7C337D_OFFSET UNITYSDK_OFFSET(0x104E7BA0)
#define CLASS_2_DCAE1D6145F68C32_METHOD_2_FA92B3E07A6BA5A6_OFFSET UNITYSDK_OFFSET(0x104E9150)
#define CLASS_2_DCAE1D6145F68C32_SET_POSAPDATIONTARGET_OFFSET UNITYSDK_OFFSET(0x104E91E0)
#define CLASS_2_DCAE1D6145F68C32_TICK_OFFSET UNITYSDK_OFFSET(0x104E7D20)
#define CLASS_2_DCAE1D6145F68C32__CTOR_OFFSET UNITYSDK_OFFSET(0x104E91F0)
#define CLASS_2_DCAE1D6145F68C32___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x104E9240)
...
public:
	...
	{
		return (::Il2CppArray<::UnityEngine::Collider*>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_DCAE1D6145F68C32_TypeDefinitionIndex)->GetStaticField(0x14E10);
	}
	::System::Action_1<::Class_2_DCAE1D6145F68C32*>* Field_2_1; // 0x18
	::RPG::GameCore::AdventureCharacterController* Field_2_8; // 0x20
	::RPG::GameCore::AdventurePositionCheckConfig* Field_2_3; // 0x28
	::System::Action_1<::Class_2_DCAE1D6145F68C32*>* Field_2_2; // 0x30
	::RPG::GameCore::GameEntity* _PosApdationTarget_k__BackingField; // 0x38
	::RPG::GameCore::CharacterVisibleComponent* Field_2_7; // 0x40
	::RPG::GameCore::TransformComponent* Field_2_6; // 0x48
	::UnityEngine::Vector3 Field_2_9; // 0x50
	::System::Int32 Field_2_5; // 0x5C
	::RPG::GameCore::CharacterAdventureSomatoType Field_2_4; // 0x60
	::System::Single Field_2_10; // 0x64
	::System::Boolean Field_2_11; // 0x68
	::Struct_2_5C05B865B0E3235A_1 Field_2_12; // 0x6C
