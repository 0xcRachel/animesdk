...
#define CLASS_2_DCAE1D6145F68C32_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10397080)
#define CLASS_2_DCAE1D6145F68C32_GET_POSAPDATIONTARGET_OFFSET UNITYSDK_OFFSET(0x10398590)
#define CLASS_2_DCAE1D6145F68C32_METHOD_2_14E83132A0D8CA04_OFFSET UNITYSDK_OFFSET(0x10398170)
#define CLASS_2_DCAE1D6145F68C32_METHOD_2_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x10397720)
#define CLASS_2_DCAE1D6145F68C32_METHOD_2_36AEAFDA089C2E0C_OFFSET UNITYSDK_OFFSET(0x10398300)
#define CLASS_2_DCAE1D6145F68C32_METHOD_2_3D78D2E0F9F95F07_OFFSET UNITYSDK_OFFSET(0x103984E0)
#define CLASS_2_DCAE1D6145F68C32_METHOD_2_79F82AA229668E10_OFFSET UNITYSDK_OFFSET(0x103977A0)
#define CLASS_2_DCAE1D6145F68C32_METHOD_2_921C3C3E09D59CD4_OFFSET UNITYSDK_OFFSET(0x10397210)
#define CLASS_2_DCAE1D6145F68C32_METHOD_2_96A53A17AC5D0E93_OFFSET UNITYSDK_OFFSET(0x103976D0)
#define CLASS_2_DCAE1D6145F68C32_METHOD_2_AE0258B108DEC531_OFFSET UNITYSDK_OFFSET(0x10398500)
#define CLASS_2_DCAE1D6145F68C32_METHOD_2_B40F084418F05DE4_OFFSET UNITYSDK_OFFSET(0x10397970)
#define CLASS_2_DCAE1D6145F68C32_METHOD_2_B6F8CAF32E7C337D_OFFSET UNITYSDK_OFFSET(0x10396F50)
#define CLASS_2_DCAE1D6145F68C32_METHOD_2_FA92B3E07A6BA5A6_OFFSET UNITYSDK_OFFSET(0x10398510)
#define CLASS_2_DCAE1D6145F68C32_SET_POSAPDATIONTARGET_OFFSET UNITYSDK_OFFSET(0x103985A0)
#define CLASS_2_DCAE1D6145F68C32_TICK_OFFSET UNITYSDK_OFFSET(0x103970E0)
#define CLASS_2_DCAE1D6145F68C32__CTOR_OFFSET UNITYSDK_OFFSET(0x103985B0)
#define CLASS_2_DCAE1D6145F68C32___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x10398600)

inline static constexpr unsigned int Class_2_DCAE1D6145F68C32_TypeDefinitionIndex = 45143;
...
public:
	...
	{
		return (::Il2CppArray<::UnityEngine::Collider*>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_DCAE1D6145F68C32_TypeDefinitionIndex)->GetStaticField(0x3E2E0);
	}
	::RPG::GameCore::GameEntity* _PosApdationTarget_k__BackingField; // 0x18
	::RPG::GameCore::CharacterVisibleComponent* Field_2_7; // 0x20
	::System::Action_1<::Class_2_DCAE1D6145F68C32*>* Field_2_1; // 0x28
	::RPG::GameCore::AdventureCharacterController* Field_2_8; // 0x30
	::System::Action_1<::Class_2_DCAE1D6145F68C32*>* Field_2_2; // 0x38
	::RPG::GameCore::TransformComponent* Field_2_6; // 0x40
	::RPG::GameCore::AdventurePositionCheckConfig* Field_2_3; // 0x48
