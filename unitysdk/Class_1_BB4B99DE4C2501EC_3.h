...
#define CLASS_1_BB4B99DE4C2501EC_3_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19C34D20)
#define CLASS_1_BB4B99DE4C2501EC_3_CLONE_OFFSET UNITYSDK_OFFSET(0x19C34750)
#define CLASS_1_BB4B99DE4C2501EC_3_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19C348C0)
#define CLASS_1_BB4B99DE4C2501EC_3_EQUALS_OFFSET UNITYSDK_OFFSET(0x19C34890)
#define CLASS_1_BB4B99DE4C2501EC_3_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19C349B0)
#define CLASS_1_BB4B99DE4C2501EC_3_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19C351E0)
#define CLASS_1_BB4B99DE4C2501EC_3_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19C35140)
#define CLASS_1_BB4B99DE4C2501EC_3_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x19C347C0)
#define CLASS_1_BB4B99DE4C2501EC_3_METHOD_1_02A3D10A9D535169_2_OFFSET UNITYSDK_OFFSET(0x19C347F0)
#define CLASS_1_BB4B99DE4C2501EC_3_METHOD_1_02A3D10A9D535169_3_OFFSET UNITYSDK_OFFSET(0x19C34810)
#define CLASS_1_BB4B99DE4C2501EC_3_METHOD_1_02A3D10A9D535169_4_OFFSET UNITYSDK_OFFSET(0x19C34830)
#define CLASS_1_BB4B99DE4C2501EC_3_METHOD_1_02A3D10A9D535169_5_OFFSET UNITYSDK_OFFSET(0x19C34870)
#define CLASS_1_BB4B99DE4C2501EC_3_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x19C34780)
#define CLASS_1_BB4B99DE4C2501EC_3_METHOD_1_3163C288F3AE2966_OFFSET UNITYSDK_OFFSET(0x19C347B0)
#define CLASS_1_BB4B99DE4C2501EC_3_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x19C347E0)
#define CLASS_1_BB4B99DE4C2501EC_3_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19C34610)
#define CLASS_1_BB4B99DE4C2501EC_3_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x19C347D0)
#define CLASS_1_BB4B99DE4C2501EC_3_METHOD_1_7786DC814C2FC3BE_2_OFFSET UNITYSDK_OFFSET(0x19C34800)
#define CLASS_1_BB4B99DE4C2501EC_3_METHOD_1_7786DC814C2FC3BE_3_OFFSET UNITYSDK_OFFSET(0x19C34820)
#define CLASS_1_BB4B99DE4C2501EC_3_METHOD_1_7786DC814C2FC3BE_4_OFFSET UNITYSDK_OFFSET(0x19C34840)
#define CLASS_1_BB4B99DE4C2501EC_3_METHOD_1_7786DC814C2FC3BE_5_OFFSET UNITYSDK_OFFSET(0x19C34880)
#define CLASS_1_BB4B99DE4C2501EC_3_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x19C34790)
#define CLASS_1_BB4B99DE4C2501EC_3_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x19C34860)
#define CLASS_1_BB4B99DE4C2501EC_3_METHOD_1_CE81D059476B1F49_OFFSET UNITYSDK_OFFSET(0x19C347A0)
#define CLASS_1_BB4B99DE4C2501EC_3_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x19C34850)
#define CLASS_1_BB4B99DE4C2501EC_3_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19C34640)
#define CLASS_1_BB4B99DE4C2501EC_3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19C34AF0)
#define CLASS_1_BB4B99DE4C2501EC_3_WRITETO_OFFSET UNITYSDK_OFFSET(0x19C34B50)
#define CLASS_1_BB4B99DE4C2501EC_3__CCTOR_OFFSET UNITYSDK_OFFSET(0x19C35370)
#define CLASS_1_BB4B99DE4C2501EC_3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19C346A0)
#define CLASS_1_BB4B99DE4C2501EC_3__CTOR_OFFSET UNITYSDK_OFFSET(0x19C34650)

inline static constexpr unsigned int Class_1_BB4B99DE4C2501EC_3_TypeDefinitionIndex = 24970;
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_BB4B99DE4C2501EC_3_TypeDefinitionIndex)->GetStaticField(0x9CB0);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_BB4B99DE4C2501EC_3*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_BB4B99DE4C2501EC_3*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_BB4B99DE4C2501EC_3_TypeDefinitionIndex)->GetStaticField(0x9CB8);
	}
	...
	static ::Google::Protobuf::MessageParser_1<::Class_1_BB4B99DE4C2501EC_3*>* Method_1_685747EAFC9F7288()
	{
		return ((::Google::Protobuf::MessageParser_1<::Class_1_BB4B99DE4C2501EC_3*>*(*)())((::PBYTE)hIl2Cpp + CLASS_1_BB4B99DE4C2501EC_3_METHOD_1_685747EAFC9F7288_OFFSET))();
	}
