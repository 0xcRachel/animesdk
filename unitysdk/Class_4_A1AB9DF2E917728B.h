...
#define CLASS_4_A1AB9DF2E917728B_METHOD_4_793FFA9A76FE6840_OFFSET UNITYSDK_OFFSET(0xCAF5AD0)
#define CLASS_4_A1AB9DF2E917728B_METHOD_4_9B8014E775FB45D6_OFFSET UNITYSDK_OFFSET(0xCAF53C0)
#define CLASS_4_A1AB9DF2E917728B_METHOD_4_AD23FDCC7576BB32_OFFSET UNITYSDK_OFFSET(0xCAF5600)
#define CLASS_4_A1AB9DF2E917728B_METHOD_4_C5316B8772B0F7ED_OFFSET UNITYSDK_OFFSET(0xCAF5920)
#define CLASS_4_A1AB9DF2E917728B_METHOD_4_DE481EE510C0F24F_OFFSET UNITYSDK_OFFSET(0xCAF51E0)
#define CLASS_4_A1AB9DF2E917728B_REVERSE_OFFSET UNITYSDK_OFFSET(0xCAF5540)
#define CLASS_4_A1AB9DF2E917728B_STARTWITHTARGET_OFFSET UNITYSDK_OFFSET(0xCAF5490)
#define CLASS_4_A1AB9DF2E917728B__CTOR_OFFSET UNITYSDK_OFFSET(0xCAF53A0)
#define CLASS_4_A1AB9DF2E917728B___IFIXBASEPROXY_REVERSE_OFFSET UNITYSDK_OFFSET(0xCAF5A30)
#define CLASS_4_A1AB9DF2E917728B___IFIXBASEPROXY_STARTWITHTARGET_OFFSET UNITYSDK_OFFSET(0xCAF5A20)

inline static constexpr unsigned int Class_4_A1AB9DF2E917728B_TypeDefinitionIndex = 67644;

class Class_4_A1AB9DF2E917728B : public ::Class_3_3F1B1DE9D9F51912
{
public:
	::Struct_2_395B739A1AC58399_1 Field_4_0; // 0x38
	::UnityEngine::Vector3 Field_4_2; // 0x5C
	::UnityEngine::Vector3 Field_4_1; // 0x68
