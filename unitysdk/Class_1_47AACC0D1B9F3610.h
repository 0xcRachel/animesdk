...
#define CLASS_1_47AACC0D1B9F3610_METHOD_1_0B6621F52739EDE5_OFFSET UNITYSDK_OFFSET(0x111353F0)
#define CLASS_1_47AACC0D1B9F3610_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0x11138150)
#define CLASS_1_47AACC0D1B9F3610_METHOD_1_16F329E8131CBCB7_OFFSET UNITYSDK_OFFSET(0x111370C0)
#define CLASS_1_47AACC0D1B9F3610_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x11137050)
#define CLASS_1_47AACC0D1B9F3610_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x11134180)
#define CLASS_1_47AACC0D1B9F3610_METHOD_1_1E60D3ABD30B7685_OFFSET UNITYSDK_OFFSET(0x111376C0)
#define CLASS_1_47AACC0D1B9F3610_METHOD_1_3A37670C2827DA9B_OFFSET UNITYSDK_OFFSET(0x111379E0)
#define CLASS_1_47AACC0D1B9F3610_METHOD_1_41CF9B9431532A25_OFFSET UNITYSDK_OFFSET(0x111341D0)
#define CLASS_1_47AACC0D1B9F3610_METHOD_1_43C44485B10C4EF3_OFFSET UNITYSDK_OFFSET(0x11137990)
#define CLASS_1_47AACC0D1B9F3610_METHOD_1_5AD578FCE9CF19D4_OFFSET UNITYSDK_OFFSET(0x11136620)
#define CLASS_1_47AACC0D1B9F3610_METHOD_1_5FBAD89A54D9F070_OFFSET UNITYSDK_OFFSET(0x111375E0)
#define CLASS_1_47AACC0D1B9F3610_METHOD_1_6112A1276899AF0F_OFFSET UNITYSDK_OFFSET(0x111372A0)
#define CLASS_1_47AACC0D1B9F3610_METHOD_1_9B1532AAD2928C7B_OFFSET UNITYSDK_OFFSET(0x11137B70)
#define CLASS_1_47AACC0D1B9F3610_METHOD_1_9E9CC6617AFDF44B_OFFSET UNITYSDK_OFFSET(0x11138090)
#define CLASS_1_47AACC0D1B9F3610_METHOD_1_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0x11138140)
#define CLASS_1_47AACC0D1B9F3610_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x11138130)
#define CLASS_1_47AACC0D1B9F3610_METHOD_1_F0E307B84478A272_OFFSET UNITYSDK_OFFSET(0x11138170)
#define CLASS_1_47AACC0D1B9F3610_METHOD_1_FA0119DD445A672F_OFFSET UNITYSDK_OFFSET(0x11136700)
#define CLASS_1_47AACC0D1B9F3610__CTOR_OFFSET UNITYSDK_OFFSET(0x11134070)

inline static constexpr unsigned int Class_1_47AACC0D1B9F3610_TypeDefinitionIndex = 55342;

class Class_1_47AACC0D1B9F3610 : public ::System::Object
{
public:
	::UnityEngine::GameObject* Field_1_2; // 0x10
	::RPG::Client::PlayableBindingControl* Field_1_15; // 0x18
	::UnityEngine::Playables::PlayableDirector* Field_1_4; // 0x20
	::RPG::Client::CloseupShotData* Field_1_1; // 0x28
	::RPG::Client::CameraDataAndFlags* Field_1_14; // 0x30
	::Cinemachine::CinemachineVirtualCameraBase* Field_1_6; // 0x38
	::UnityEngine::Transform* Field_1_7; // 0x40
	::UnityEngine::Object* Field_1_3; // 0x48
	::System::Int32 Field_1_16; // 0x50
	::System::Nullable_1<::UnityEngine::Vector3> Field_1_8; // 0x54
	::System::Nullable_1<::System::Double> Field_1_5; // 0x68
	::System::Nullable_1<::UnityEngine::Quaternion> Field_1_9; // 0x78
	::System::Nullable_1<::System::Single> Field_1_11; // 0x8C
	::System::Nullable_1<::UnityEngine::Vector3> Field_1_10; // 0x94
