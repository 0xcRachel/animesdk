...
#define CLASS_2_BAA08B02425515A4_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15422140)
#define CLASS_2_BAA08B02425515A4_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x15422180)
#define CLASS_2_BAA08B02425515A4_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x15422840)
#define CLASS_2_BAA08B02425515A4_TICK_OFFSET UNITYSDK_OFFSET(0x15422890)
#define CLASS_2_BAA08B02425515A4__CTOR_OFFSET UNITYSDK_OFFSET(0x15422130)
...
{
public:
	::RPG::GameCore::ShowAvatarHUDSpecialEffect* Field_2_0; // 0x18
