...
#define CLASS_2_FB29C7B190B1A9A1_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xE69B910)
#define CLASS_2_FB29C7B190B1A9A1_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xE69BA90)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_25DEA5C65A602671_OFFSET UNITYSDK_OFFSET(0xE69AF80)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_265E3B6BEA7EFC67_OFFSET UNITYSDK_OFFSET(0xE69A6B0)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_3C7DB26DBC02A9C6_OFFSET UNITYSDK_OFFSET(0xE69A820)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_42C3EA3461C8132A_OFFSET UNITYSDK_OFFSET(0xE69AA30)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xE69BD10)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_5FB1B9EC645AD55B_OFFSET UNITYSDK_OFFSET(0xE69A5B0)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_5FF514E44337B43F_OFFSET UNITYSDK_OFFSET(0xE69ADE0)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_771ADD86EA4F4522_OFFSET UNITYSDK_OFFSET(0xE69AB90)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_8CE0803574BB66D7_OFFSET UNITYSDK_OFFSET(0xE69A3B0)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_8EC3255570F308C5_OFFSET UNITYSDK_OFFSET(0xE69B6C0)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_9BCC17D24D0A8A13_OFFSET UNITYSDK_OFFSET(0xE69A870)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_A27D06F9481FAFDB_1_OFFSET UNITYSDK_OFFSET(0xE69B620)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_A27D06F9481FAFDB_2_OFFSET UNITYSDK_OFFSET(0xE69B790)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_A27D06F9481FAFDB_3_OFFSET UNITYSDK_OFFSET(0xE69B850)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0xE69B580)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_B4A742FFAB70D330_OFFSET UNITYSDK_OFFSET(0xE69AEF0)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_C4E2F930A41E34C0_OFFSET UNITYSDK_OFFSET(0xE69A920)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_C89A41A14F7CCD91_OFFSET UNITYSDK_OFFSET(0xE69BCA0)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_CBDC22058B67F0FE_OFFSET UNITYSDK_OFFSET(0xE69A400)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_CF2CFFBCFC8CA900_OFFSET UNITYSDK_OFFSET(0xE69B280)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_DBF1456D898098BF_OFFSET UNITYSDK_OFFSET(0xE69AB20)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_DCC1CBB07F2C3152_OFFSET UNITYSDK_OFFSET(0xE69B100)
#define CLASS_2_FB29C7B190B1A9A1__CTOR_OFFSET UNITYSDK_OFFSET(0xE69BBE0)
#define CLASS_2_FB29C7B190B1A9A1__ONBIND_OFFSET UNITYSDK_OFFSET(0xE69A310)
#define CLASS_2_FB29C7B190B1A9A1___IFIXBASEPROXY_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xE69BD70)
#define CLASS_2_FB29C7B190B1A9A1___IFIXBASEPROXY_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xE69BDD0)
#define CLASS_2_FB29C7B190B1A9A1___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0xE69BC40)

inline static constexpr unsigned int Class_2_FB29C7B190B1A9A1_TypeDefinitionIndex = 66642;
