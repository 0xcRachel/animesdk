...
#define CLASS_2_FB29C7B190B1A9A1_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xA1D7130)
#define CLASS_2_FB29C7B190B1A9A1_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xA1D72B0)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_25DEA5C65A602671_OFFSET UNITYSDK_OFFSET(0xA1D6790)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_265E3B6BEA7EFC67_OFFSET UNITYSDK_OFFSET(0xA1D5EB0)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_3C7DB26DBC02A9C6_OFFSET UNITYSDK_OFFSET(0xA1D6020)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_42C3EA3461C8132A_OFFSET UNITYSDK_OFFSET(0xA1D6240)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xA1D7530)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_5FB1B9EC645AD55B_OFFSET UNITYSDK_OFFSET(0xA1D5DC0)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_5FF514E44337B43F_OFFSET UNITYSDK_OFFSET(0xA1D65F0)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_771ADD86EA4F4522_OFFSET UNITYSDK_OFFSET(0xA1D63A0)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_8CE0803574BB66D7_OFFSET UNITYSDK_OFFSET(0xA1D5BC0)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_8EC3255570F308C5_OFFSET UNITYSDK_OFFSET(0xA1D6EE0)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_9BCC17D24D0A8A13_OFFSET UNITYSDK_OFFSET(0xA1D6080)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_A27D06F9481FAFDB_1_OFFSET UNITYSDK_OFFSET(0xA1D6E40)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_A27D06F9481FAFDB_2_OFFSET UNITYSDK_OFFSET(0xA1D6FB0)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_A27D06F9481FAFDB_3_OFFSET UNITYSDK_OFFSET(0xA1D7070)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0xA1D6DA0)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_B4A742FFAB70D330_OFFSET UNITYSDK_OFFSET(0xA1D6700)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_C4E2F930A41E34C0_OFFSET UNITYSDK_OFFSET(0xA1D6130)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_C89A41A14F7CCD91_OFFSET UNITYSDK_OFFSET(0xA1D74C0)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_CBDC22058B67F0FE_OFFSET UNITYSDK_OFFSET(0xA1D5C10)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_CF2CFFBCFC8CA900_OFFSET UNITYSDK_OFFSET(0xA1D6AA0)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_DBF1456D898098BF_OFFSET UNITYSDK_OFFSET(0xA1D6330)
#define CLASS_2_FB29C7B190B1A9A1_METHOD_2_DCC1CBB07F2C3152_OFFSET UNITYSDK_OFFSET(0xA1D6920)
#define CLASS_2_FB29C7B190B1A9A1__CTOR_OFFSET UNITYSDK_OFFSET(0xA1D7400)
#define CLASS_2_FB29C7B190B1A9A1__ONBIND_OFFSET UNITYSDK_OFFSET(0xA1D5A60)
#define CLASS_2_FB29C7B190B1A9A1___IFIXBASEPROXY_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xA1D7590)
#define CLASS_2_FB29C7B190B1A9A1___IFIXBASEPROXY_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xA1D75F0)
#define CLASS_2_FB29C7B190B1A9A1___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0xA1D7460)

inline static constexpr unsigned int Class_2_FB29C7B190B1A9A1_TypeDefinitionIndex = 59249;
