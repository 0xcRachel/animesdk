...
#define AIRSHIPSUBWAYSCHEDULE_METHOD_3_4B967A5E70FF7EE4_OFFSET UNITYSDK_OFFSET(0x1055EA30)
#define AIRSHIPSUBWAYSCHEDULE_METHOD_3_7B423B7C669FCA6E_OFFSET UNITYSDK_OFFSET(0x1055E530)
#define AIRSHIPSUBWAYSCHEDULE_METHOD_3_BA7BA85FBE4A1104_OFFSET UNITYSDK_OFFSET(0x1055E9B0)
#define AIRSHIPSUBWAYSCHEDULE_METHOD_3_D20FD81754C01453_OFFSET UNITYSDK_OFFSET(0x1055EB30)
#define AIRSHIPSUBWAYSCHEDULE_METHOD_3_F34661EBA0A0A425_OFFSET UNITYSDK_OFFSET(0x1055E7D0)
#define AIRSHIPSUBWAYSCHEDULE__CTOR_OFFSET UNITYSDK_OFFSET(0x1055EB80)

inline static constexpr unsigned int AirShipSubwaySchedule_TypeDefinitionIndex = 37057;
