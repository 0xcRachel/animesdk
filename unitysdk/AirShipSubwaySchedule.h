...
#define AIRSHIPSUBWAYSCHEDULE_METHOD_3_4B967A5E70FF7EE4_OFFSET UNITYSDK_OFFSET(0x15BBEE20)
#define AIRSHIPSUBWAYSCHEDULE_METHOD_3_5591F7FC72D87A0E_OFFSET UNITYSDK_OFFSET(0x15BBEF20)
#define AIRSHIPSUBWAYSCHEDULE_METHOD_3_7FF186C33A48A21A_OFFSET UNITYSDK_OFFSET(0x15BBE800)
#define AIRSHIPSUBWAYSCHEDULE_METHOD_3_858C6261DBD00141_OFFSET UNITYSDK_OFFSET(0x15BBEBB0)
#define AIRSHIPSUBWAYSCHEDULE_METHOD_3_BA7BA85FBE4A1104_OFFSET UNITYSDK_OFFSET(0x15BBEDA0)
#define AIRSHIPSUBWAYSCHEDULE__CTOR_OFFSET UNITYSDK_OFFSET(0x15BBEF70)
