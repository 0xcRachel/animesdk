...
#define CLASS_2_AF8E840B1182AF2A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x89442B0)
#define CLASS_2_AF8E840B1182AF2A_METHOD_2_52C18C0DA8AC23E5_OFFSET UNITYSDK_OFFSET(0x8944C90)
#define CLASS_2_AF8E840B1182AF2A_METHOD_2_67C10584F4320583_OFFSET UNITYSDK_OFFSET(0x8945030)
#define CLASS_2_AF8E840B1182AF2A_METHOD_2_6F9CFB69CAB3BEF0_OFFSET UNITYSDK_OFFSET(0x8945340)
#define CLASS_2_AF8E840B1182AF2A_METHOD_2_7FED1D13A63CADE9_OFFSET UNITYSDK_OFFSET(0x89444A0)
#define CLASS_2_AF8E840B1182AF2A_METHOD_2_9F8F6511E8EF1235_OFFSET UNITYSDK_OFFSET(0x89452C0)
#define CLASS_2_AF8E840B1182AF2A_METHOD_2_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0x8944600)
#define CLASS_2_AF8E840B1182AF2A_METHOD_2_A91086AED8314DB5_OFFSET UNITYSDK_OFFSET(0x8945140)
#define CLASS_2_AF8E840B1182AF2A_METHOD_2_CEBFF096B4C9D46B_OFFSET UNITYSDK_OFFSET(0x8945920)
#define CLASS_2_AF8E840B1182AF2A_METHOD_2_F0BD65B017F2AC0B_OFFSET UNITYSDK_OFFSET(0x89446C0)
#define CLASS_2_AF8E840B1182AF2A_METHOD_2_F0D9B6AAFF504D87_OFFSET UNITYSDK_OFFSET(0x89451B0)
#define CLASS_2_AF8E840B1182AF2A_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x8944940)
#define CLASS_2_AF8E840B1182AF2A_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x89449F0)
#define CLASS_2_AF8E840B1182AF2A_TICK_OFFSET UNITYSDK_OFFSET(0x89458B0)
#define CLASS_2_AF8E840B1182AF2A__CTOR_OFFSET UNITYSDK_OFFSET(0x8943D50)

inline static constexpr unsigned int Class_2_AF8E840B1182AF2A_TypeDefinitionIndex = 41405;

class Class_2_AF8E840B1182AF2A : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::NPCComponent* Field_2_8; // 0x18
	::RPG::GameCore::AdvNPCPatrol* Field_2_4; // 0x20
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_5F51D4049EA87B7B*>* Field_2_12; // 0x28
	::RPG::GameCore::TaskContext* Field_2_5; // 0x30
	::Class_2_A0580152EB393340* Field_2_9; // 0x38
	::Class_1_5F51D4049EA87B7B* Field_2_11; // 0x40
	::RPG::GameCore::TransformComponent* Field_2_6; // 0x48
	::Class_2_19E76B515E7B257C* Field_2_7; // 0x50
	::Class_2_6BFAFA494F2D1E4B* Field_2_10; // 0x58
	::System::Single Field_2_2; // 0x60
	::UnityEngine::Vector3 Field_2_1; // 0x64
	::RPG::GameCore::AdvNpcPatrolStatus Field_2_0; // 0x70
