...
#define CLASS_2_DBB52CC7D0865A76_GETSERVERBLOCKMANIFESTNAME_OFFSET UNITYSDK_OFFSET(0x103DAF00)
#define CLASS_2_DBB52CC7D0865A76_GETTYPENAME_OFFSET UNITYSDK_OFFSET(0x103DABC0)
#define CLASS_2_DBB52CC7D0865A76_GET_BLOCKMANIFESTNAME_OFFSET UNITYSDK_OFFSET(0x103DACD0)
#define CLASS_2_DBB52CC7D0865A76_GET_BLOCKVERSIONNAME_OFFSET UNITYSDK_OFFSET(0x103DAC90)
#define CLASS_2_DBB52CC7D0865A76_GET_BUNDLEMANIFESTNAME_OFFSET UNITYSDK_OFFSET(0x103DAC80)
#define CLASS_2_DBB52CC7D0865A76_GET_BUNDLEVERSIONNAME_OFFSET UNITYSDK_OFFSET(0x103DAC70)
#define CLASS_2_DBB52CC7D0865A76_GET_DEFAULTABSOLUTEPATH_OFFSET UNITYSDK_OFFSET(0x103DAC10)
#define CLASS_2_DBB52CC7D0865A76_GET_ISENABLE_OFFSET UNITYSDK_OFFSET(0x103DAD10)
#define CLASS_2_DBB52CC7D0865A76_GET_RELATIVEPATH_OFFSET UNITYSDK_OFFSET(0x103DAC40)
#define CLASS_2_DBB52CC7D0865A76_ONALLSUCCEED_OFFSET UNITYSDK_OFFSET(0x103DB0B0)
#define CLASS_2_DBB52CC7D0865A76_SET_ISENABLE_OFFSET UNITYSDK_OFFSET(0x103DAD20)
#define CLASS_2_DBB52CC7D0865A76__CTOR_OFFSET UNITYSDK_OFFSET(0x103DAD30)
#define CLASS_2_DBB52CC7D0865A76__LOADINDEXINFO_OFFSET UNITYSDK_OFFSET(0x103DAEB0)
#define CLASS_2_DBB52CC7D0865A76___IFIXBASEPROXY_GETSERVERBLOCKMANIFESTNAME_OFFSET UNITYSDK_OFFSET(0x103DB120)

inline static constexpr unsigned int Class_2_DBB52CC7D0865A76_TypeDefinitionIndex = 47032;
