...
#define RPG_MVECTOR3_ANGLEBETWEEN_OFFSET UNITYSDK_OFFSET(0x17A7BE00)
#define RPG_MVECTOR3_ANGLE_OFFSET UNITYSDK_OFFSET(0x17A7B390)
#define RPG_MVECTOR3_APPROXIMATELY_OFFSET UNITYSDK_OFFSET(0x17A7B7D0)
#define RPG_MVECTOR3_CLAMPMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x17A7B820)
#define RPG_MVECTOR3_CROSS_OFFSET UNITYSDK_OFFSET(0x17A7AFB0)
#define RPG_MVECTOR3_DISTANCE_OFFSET UNITYSDK_OFFSET(0x17A7B740)
#define RPG_MVECTOR3_DOT_OFFSET UNITYSDK_OFFSET(0x17A6D140)
#define RPG_MVECTOR3_EQUALS_OFFSET UNITYSDK_OFFSET(0x20FF3B0)
#define RPG_MVECTOR3_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x20FF350)
#define RPG_MVECTOR3_GET_BACK_OFFSET UNITYSDK_OFFSET(0x17A7B9F0)
#define RPG_MVECTOR3_GET_DOWN_OFFSET UNITYSDK_OFFSET(0x17A7BA30)
#define RPG_MVECTOR3_GET_FORWARD_OFFSET UNITYSDK_OFFSET(0x17A7B9D0)
#define RPG_MVECTOR3_GET_FWD_OFFSET UNITYSDK_OFFSET(0x17A7BDE0)
#define RPG_MVECTOR3_GET_ISINFINITY_OFFSET UNITYSDK_OFFSET(0x20FF180)
#define RPG_MVECTOR3_GET_ISNAN_OFFSET UNITYSDK_OFFSET(0x20FF140)
#define RPG_MVECTOR3_GET_ISNEGATIVEINFINITY_OFFSET UNITYSDK_OFFSET(0x20FF1E0)
#define RPG_MVECTOR3_GET_ISPOSITIVEINFINITY_OFFSET UNITYSDK_OFFSET(0x20FF1C0)
#define RPG_MVECTOR3_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x20FF200)
#define RPG_MVECTOR3_GET_LEFT_OFFSET UNITYSDK_OFFSET(0x17A7BA50)
#define RPG_MVECTOR3_GET_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x20FF5A0)
#define RPG_MVECTOR3_GET_NEGATIVEINFINITY_OFFSET UNITYSDK_OFFSET(0x17A7BAB0)
#define RPG_MVECTOR3_GET_NORMALIZED_OFFSET UNITYSDK_OFFSET(0x20FF500)
#define RPG_MVECTOR3_GET_ONE_OFFSET UNITYSDK_OFFSET(0x17A7B9B0)
#define RPG_MVECTOR3_GET_POSITIVEINFINITY_OFFSET UNITYSDK_OFFSET(0x17A7BA90)
#define RPG_MVECTOR3_GET_RIGHT_OFFSET UNITYSDK_OFFSET(0x17A7BA70)
#define RPG_MVECTOR3_GET_SQRMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x20FF5D0)
#define RPG_MVECTOR3_GET_UP_OFFSET UNITYSDK_OFFSET(0x17A7BA10)
#define RPG_MVECTOR3_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x17A7B990)
#define RPG_MVECTOR3_LERPUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x17A7AE00)
#define RPG_MVECTOR3_LERP_OFFSET UNITYSDK_OFFSET(0x17A7ADB0)
#define RPG_MVECTOR3_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x17A7B190)
#define RPG_MVECTOR3_MAX_OFFSET UNITYSDK_OFFSET(0x17A7B960)
#define RPG_MVECTOR3_MIN_OFFSET UNITYSDK_OFFSET(0x17A7B930)
#define RPG_MVECTOR3_MOVETOWARDS_OFFSET UNITYSDK_OFFSET(0x17A7AE40)
#define RPG_MVECTOR3_NORMALIZE_1_OFFSET UNITYSDK_OFFSET(0x20FF470)
#define RPG_MVECTOR3_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x17A6D8E0)
#define RPG_MVECTOR3_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x17A7BAD0)
#define RPG_MVECTOR3_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x17A7BBA0)
#define RPG_MVECTOR3_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x17A7BBC0)
#define RPG_MVECTOR3_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x17A7BC10)
#define RPG_MVECTOR3_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x17A7BB80)
#define RPG_MVECTOR3_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x17A7BB60)
#define RPG_MVECTOR3_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x17A7BB00)
#define RPG_MVECTOR3_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x17A7BB30)
#define RPG_MVECTOR3_PROJECTONPLANE_OFFSET UNITYSDK_OFFSET(0x17A7B2E0)
#define RPG_MVECTOR3_PROJECT_OFFSET UNITYSDK_OFFSET(0x17A7B250)
#define RPG_MVECTOR3_REFLECT_OFFSET UNITYSDK_OFFSET(0x17A7B120)
#define RPG_MVECTOR3_SCALE_1_OFFSET UNITYSDK_OFFSET(0x20FF330)
#define RPG_MVECTOR3_SCALE_OFFSET UNITYSDK_OFFSET(0x17A7AF50)
#define RPG_MVECTOR3_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x20FF280)
#define RPG_MVECTOR3_SET_OFFSET UNITYSDK_OFFSET(0x14F4C10)
#define RPG_MVECTOR3_SIGNEDANGLE_OFFSET UNITYSDK_OFFSET(0x17A7B510)
#define RPG_MVECTOR3_SQRDISTANCE_OFFSET UNITYSDK_OFFSET(0x17A7B790)
#define RPG_MVECTOR3_SQRMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x17A7B910)
#define RPG_MVECTOR3_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x20FF6A0)
#define RPG_MVECTOR3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x20FF5F0)
#define RPG_MVECTOR3__CCTOR_OFFSET UNITYSDK_OFFSET(0x17A7BF70)
#define RPG_MVECTOR3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x20FF310)
#define RPG_MVECTOR3__CTOR_OFFSET UNITYSDK_OFFSET(0x14F4C10)
