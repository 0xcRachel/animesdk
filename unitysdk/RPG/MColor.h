...
#define RPG_MCOLOR_EQUALS_OFFSET UNITYSDK_OFFSET(0x3740680)
#define RPG_MCOLOR_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x37407D0)
#define RPG_MCOLOR_METHOD_2_2C17A14F9DD6C0E3_1_OFFSET UNITYSDK_OFFSET(0x12EAAD60)
#define RPG_MCOLOR_METHOD_2_2C17A14F9DD6C0E3_2_OFFSET UNITYSDK_OFFSET(0x12EAAD80)
#define RPG_MCOLOR_METHOD_2_2C17A14F9DD6C0E3_OFFSET UNITYSDK_OFFSET(0x12EAAD40)
#define RPG_MCOLOR_METHOD_2_4B0A91863BB1C92C_1_OFFSET UNITYSDK_OFFSET(0x12EAADC0)
#define RPG_MCOLOR_METHOD_2_4B0A91863BB1C92C_2_OFFSET UNITYSDK_OFFSET(0x12EAADE0)
#define RPG_MCOLOR_METHOD_2_4B0A91863BB1C92C_OFFSET UNITYSDK_OFFSET(0x12EAADA0)
#define RPG_MCOLOR_METHOD_2_70A8AFA4B5F015AA_OFFSET UNITYSDK_OFFSET(0x12EAAD30)
#define RPG_MCOLOR_METHOD_2_73A33226BF78995D_1_OFFSET UNITYSDK_OFFSET(0x12EAAE50)
#define RPG_MCOLOR_METHOD_2_73A33226BF78995D_OFFSET UNITYSDK_OFFSET(0x12EAAE00)
#define RPG_MCOLOR_METHOD_2_992F40E2AD3811DF_OFFSET UNITYSDK_OFFSET(0x37405A0)
#define RPG_MCOLOR_METHOD_2_E571DD6924F35454_1_OFFSET UNITYSDK_OFFSET(0x12EAAF00)
#define RPG_MCOLOR_METHOD_2_E571DD6924F35454_OFFSET UNITYSDK_OFFSET(0x12EAAEA0)
#define RPG_MCOLOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3740880)
#define RPG_MCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x3740860)
