...
#define RPG_GAMECORE_TARGETMAPDUMMYENTITY_METHOD_3_0E92A3CA73FDA2CA_OFFSET UNITYSDK_OFFSET(0x16FE26F0)
#define RPG_GAMECORE_TARGETMAPDUMMYENTITY_METHOD_3_B4B4F337E8EFF897_OFFSET UNITYSDK_OFFSET(0x16FE2680)
#define RPG_GAMECORE_TARGETMAPDUMMYENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE26D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapDummyEntity_TypeDefinitionIndex = 21745;
