...
#define RPG_GAMECORE_FIVEDIMCONDITIONANYOF_METHOD_3_2711921D735A139B_OFFSET UNITYSDK_OFFSET(0x16AB7140)
#define RPG_GAMECORE_FIVEDIMCONDITIONANYOF_METHOD_3_EA885D87F6AD7A50_OFFSET UNITYSDK_OFFSET(0x16AB7180)
#define RPG_GAMECORE_FIVEDIMCONDITIONANYOF__CTOR_OFFSET UNITYSDK_OFFSET(0x16AB7170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimConditionAnyOf_TypeDefinitionIndex = 16847;
