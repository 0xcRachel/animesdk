...
#define RPG_GAMECORE_PAUSETIMEREWINDTARGETINRANGE_METHOD_3_3A7FB5361FB548CB_OFFSET UNITYSDK_OFFSET(0x16D1B9C0)
#define RPG_GAMECORE_PAUSETIMEREWINDTARGETINRANGE_METHOD_3_CF75D9082087DECC_OFFSET UNITYSDK_OFFSET(0x16D1B920)
#define RPG_GAMECORE_PAUSETIMEREWINDTARGETINRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16D1B980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PauseTimeRewindTargetInRange_TypeDefinitionIndex = 18454;
