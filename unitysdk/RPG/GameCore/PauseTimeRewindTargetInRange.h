...
#define RPG_GAMECORE_PAUSETIMEREWINDTARGETINRANGE_METHOD_3_3A7FB5361FB548CB_OFFSET UNITYSDK_OFFSET(0x19D1A910)
#define RPG_GAMECORE_PAUSETIMEREWINDTARGETINRANGE_METHOD_3_CF75D9082087DECC_OFFSET UNITYSDK_OFFSET(0x19D1A870)
#define RPG_GAMECORE_PAUSETIMEREWINDTARGETINRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19D1A8D0)
