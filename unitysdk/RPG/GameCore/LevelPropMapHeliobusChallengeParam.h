...
#define RPG_GAMECORE_LEVELPROPMAPHELIOBUSCHALLENGEPARAM_METHOD_3_AEC88C6D75322C15_OFFSET UNITYSDK_OFFSET(0x1735F4B0)
#define RPG_GAMECORE_LEVELPROPMAPHELIOBUSCHALLENGEPARAM_METHOD_3_D1ED602326974780_OFFSET UNITYSDK_OFFSET(0x1735F400)
#define RPG_GAMECORE_LEVELPROPMAPHELIOBUSCHALLENGEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1735F4A0)
