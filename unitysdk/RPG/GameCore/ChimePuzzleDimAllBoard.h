...
#define RPG_GAMECORE_CHIMEPUZZLEDIMALLBOARD_METHOD_3_69F5A1271ABD70A4_OFFSET UNITYSDK_OFFSET(0x196AC3A0)
#define RPG_GAMECORE_CHIMEPUZZLEDIMALLBOARD_METHOD_3_EAEFC9E68C221CF0_OFFSET UNITYSDK_OFFSET(0x196AC4B0)
#define RPG_GAMECORE_CHIMEPUZZLEDIMALLBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x196AC480)
