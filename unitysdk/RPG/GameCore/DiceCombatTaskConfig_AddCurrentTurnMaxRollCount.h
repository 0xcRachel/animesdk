...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ADDCURRENTTURNMAXROLLCOUNT_METHOD_3_4655EAEEDFF3E1F0_OFFSET UNITYSDK_OFFSET(0x1A096CE0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ADDCURRENTTURNMAXROLLCOUNT_METHOD_3_C4DF1EBE22527468_OFFSET UNITYSDK_OFFSET(0x1A09DD20)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ADDCURRENTTURNMAXROLLCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A096C90)
