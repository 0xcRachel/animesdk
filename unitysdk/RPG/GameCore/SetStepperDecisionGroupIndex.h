...
#define RPG_GAMECORE_SETSTEPPERDECISIONGROUPINDEX_METHOD_3_0A5A703EC0A0E311_OFFSET UNITYSDK_OFFSET(0x1A79CE80)
#define RPG_GAMECORE_SETSTEPPERDECISIONGROUPINDEX_METHOD_3_2B8661889E20143E_OFFSET UNITYSDK_OFFSET(0x1A79CF00)
#define RPG_GAMECORE_SETSTEPPERDECISIONGROUPINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1A79CED0)
