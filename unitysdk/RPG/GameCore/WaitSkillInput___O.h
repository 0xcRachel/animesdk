...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::AdventureSkillType>**)Il2CppClass::FromTypeDefinitionIndex(WaitSkillInput___O_TypeDefinitionIndex)->GetStaticField(0x12250);
		}
	};
}
