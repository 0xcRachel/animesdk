...
#define RPG_GAMECORE_SKILLTREEPOINTPRESET_METHOD_2_3411349B4067679D_OFFSET UNITYSDK_OFFSET(0x16F6E390)
#define RPG_GAMECORE_SKILLTREEPOINTPRESET__CTOR_OFFSET UNITYSDK_OFFSET(0x16F6E4E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SkillTreePointPreset_TypeDefinitionIndex = 16272;
