...
#define RPG_GAMECORE_PINGPONGENEMYPATROLCMPTCONFIG_METHOD_3_6C6DDD2755F02F2F_OFFSET UNITYSDK_OFFSET(0x174C4530)
#define RPG_GAMECORE_PINGPONGENEMYPATROLCMPTCONFIG_METHOD_3_7D37B8C78512C910_OFFSET UNITYSDK_OFFSET(0x174C45C0)
#define RPG_GAMECORE_PINGPONGENEMYPATROLCMPTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x174C45A0)
