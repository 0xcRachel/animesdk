...
#define RPG_GAMECORE_LITTLEGAMETAGCONFIG_METHOD_3_C29932943B87CA43_OFFSET UNITYSDK_OFFSET(0x16BCBE30)
#define RPG_GAMECORE_LITTLEGAMETAGCONFIG_METHOD_3_C4AE5EF6E81A4FAF_OFFSET UNITYSDK_OFFSET(0x16BD1C40)
#define RPG_GAMECORE_LITTLEGAMETAGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16BCBE10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameTagConfig_TypeDefinitionIndex = 16896;
