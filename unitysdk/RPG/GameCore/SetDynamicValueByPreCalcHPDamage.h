...
#define RPG_GAMECORE_SETDYNAMICVALUEBYPRECALCHPDAMAGE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x16F24D50)
#define RPG_GAMECORE_SETDYNAMICVALUEBYPRECALCHPDAMAGE_METHOD_4_ABCF33378AD8F7A2_OFFSET UNITYSDK_OFFSET(0x16F24D10)
#define RPG_GAMECORE_SETDYNAMICVALUEBYPRECALCHPDAMAGE_METHOD_4_FD846E23329CD814_OFFSET UNITYSDK_OFFSET(0x16F1D410)
#define RPG_GAMECORE_SETDYNAMICVALUEBYPRECALCHPDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F1D2D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByPreCalcHPDamage_TypeDefinitionIndex = 20947;
