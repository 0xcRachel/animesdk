...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERDECOMPOSEEQUIPAFTERRECYCLEROLECONFIG_METHOD_3_5B1AE0A4D110E303_OFFSET UNITYSDK_OFFSET(0x1957FEC0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERDECOMPOSEEQUIPAFTERRECYCLEROLECONFIG_METHOD_3_A0FD943351FFAA3A_OFFSET UNITYSDK_OFFSET(0x1957C4D0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERDECOMPOSEEQUIPAFTERRECYCLEROLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1957C480)
