...
#define RPG_GAMECORE_RELEASECHARACTER_METHOD_3_248D8ECB6514001A_OFFSET UNITYSDK_OFFSET(0x1759EEC0)
#define RPG_GAMECORE_RELEASECHARACTER_METHOD_3_8A6EC2537344FB23_OFFSET UNITYSDK_OFFSET(0x1759EE40)
#define RPG_GAMECORE_RELEASECHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1759EE90)
