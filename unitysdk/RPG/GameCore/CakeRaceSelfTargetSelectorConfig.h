...
#define RPG_GAMECORE_CAKERACESELFTARGETSELECTORCONFIG_METHOD_3_7E3566EF10E672AC_OFFSET UNITYSDK_OFFSET(0x16952790)
#define RPG_GAMECORE_CAKERACESELFTARGETSELECTORCONFIG_METHOD_3_E183AF4E022E7CC1_OFFSET UNITYSDK_OFFSET(0x16952810)
#define RPG_GAMECORE_CAKERACESELFTARGETSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16952800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceSelfTargetSelectorConfig_TypeDefinitionIndex = 16509;
