...
#define RPG_GAMECORE_BYISMULTITARGETCUSTOMTEAMFORMATION_METHOD_4_0C43753C4F21E75C_OFFSET UNITYSDK_OFFSET(0x19DAC390)
#define RPG_GAMECORE_BYISMULTITARGETCUSTOMTEAMFORMATION_METHOD_4_2F2D87B8766B1A0C_OFFSET UNITYSDK_OFFSET(0x19DAC590)
#define RPG_GAMECORE_BYISMULTITARGETCUSTOMTEAMFORMATION_METHOD_4_3D288FE505203321_OFFSET UNITYSDK_OFFSET(0x19DAC510)
#define RPG_GAMECORE_BYISMULTITARGETCUSTOMTEAMFORMATION_METHOD_4_6C198BA1F2172752_OFFSET UNITYSDK_OFFSET(0x19DAC2C0)
#define RPG_GAMECORE_BYISMULTITARGETCUSTOMTEAMFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x19DAC340)
