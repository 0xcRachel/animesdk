...
#define RPG_GAMECORE_STAGEHARMONYSIGNALDYNAMICDIALOGMONOSERIALIZATION_METHOD_2_CBFA81D75AE7689A_OFFSET UNITYSDK_OFFSET(0x16F86E60)
#define RPG_GAMECORE_STAGEHARMONYSIGNALDYNAMICDIALOGMONOSERIALIZATION__CTOR_OFFSET UNITYSDK_OFFSET(0x16F86FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StageHarmonySignalDynamicDialogMonoSerialization_TypeDefinitionIndex = 17214;
