...
#define RPG_GAMECORE_MODIFIERATTACHEFFECT_METHOD_3_A58919EC4501B186_OFFSET UNITYSDK_OFFSET(0x16CB37E0)
#define RPG_GAMECORE_MODIFIERATTACHEFFECT_METHOD_3_B8F31460925782A0_OFFSET UNITYSDK_OFFSET(0x16CB3750)
#define RPG_GAMECORE_MODIFIERATTACHEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x16CB37B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifierAttachEffect_TypeDefinitionIndex = 21135;
