...
#define RPG_GAMECORE_TARGETSORTBYGRIDFIGHTPOWER_METHOD_3_26DFAB84B777910B_OFFSET UNITYSDK_OFFSET(0x16FF2720)
#define RPG_GAMECORE_TARGETSORTBYGRIDFIGHTPOWER_METHOD_3_9E0586056D3A677C_OFFSET UNITYSDK_OFFSET(0x16FF0E20)
#define RPG_GAMECORE_TARGETSORTBYGRIDFIGHTPOWER__CTOR_OFFSET UNITYSDK_OFFSET(0x16FF0E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSortByGridFightPower_TypeDefinitionIndex = 21708;
