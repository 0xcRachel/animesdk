...
#define RPG_GAMECORE_ENTITYCOLLIDERCONFIG_METHOD_2_1D2B45508849A69F_OFFSET UNITYSDK_OFFSET(0x16A70C80)
#define RPG_GAMECORE_ENTITYCOLLIDERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16A70DD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EntityColliderConfig_TypeDefinitionIndex = 14908;
