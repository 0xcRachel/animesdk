...
#define RPG_GAMECORE_AVATARSKILLTREEROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x1821CCF0)
#define RPG_GAMECORE_AVATARSKILLTREEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1821D4E0)
#define RPG_GAMECORE_AVATARSKILLTREEROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x1821ECE0)
#define RPG_GAMECORE_AVATARSKILLTREEROW_RESET_OFFSET UNITYSDK_OFFSET(0x1821ED40)
#define RPG_GAMECORE_AVATARSKILLTREEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1821ED80)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::RPG::GameCore::AvatarPropertyValue*>* StatusAddList; // 0x40
		...
		::Il2CppArray<::RPG::GameCore::ItemConfig*>* MaterialList; // 0x60
		::System::String* PointDesc; // 0x68
		::System::UInt32 EnhancedID; // 0x70
		::System::Boolean DefaultUnlock; // 0x74
		::System::UInt32 Level; // 0x78
		::System::UInt32 AvatarID; // 0x7C
		::System::UInt32 PointType; // 0x80
		::RPG::GameCore::AvatarSkillTreePointTriggerKey PointTriggerKey; // 0x84
		::System::UInt32 RecommendPriority; // 0x88
		::RPG::GameCore::AvatarSkillTreeAnchorType AnchorType; // 0x8C
		::System::UInt32 MaxLevel; // 0x90
		::System::UInt32 AvatarPromotionLimit; // 0x94
		::System::UInt32 PointID; // 0x98
