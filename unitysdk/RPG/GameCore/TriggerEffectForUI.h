...
#define RPG_GAMECORE_TRIGGEREFFECTFORUI_METHOD_4_444477965FA88C33_OFFSET UNITYSDK_OFFSET(0x19116210)
#define RPG_GAMECORE_TRIGGEREFFECTFORUI_METHOD_4_47BA0C7E37299F55_OFFSET UNITYSDK_OFFSET(0x19113CE0)
#define RPG_GAMECORE_TRIGGEREFFECTFORUI__CTOR_OFFSET UNITYSDK_OFFSET(0x19113C70)
