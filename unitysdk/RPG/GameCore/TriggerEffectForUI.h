...
#define RPG_GAMECORE_TRIGGEREFFECTFORUI_METHOD_4_444477965FA88C33_OFFSET UNITYSDK_OFFSET(0x1711E0B0)
#define RPG_GAMECORE_TRIGGEREFFECTFORUI_METHOD_4_47BA0C7E37299F55_OFFSET UNITYSDK_OFFSET(0x1711BBC0)
#define RPG_GAMECORE_TRIGGEREFFECTFORUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1711BB50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerEffectForUI_TypeDefinitionIndex = 17919;
