...
#define RPG_GAMECORE_MONOPOLYASSETCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x196B2830)
#define RPG_GAMECORE_MONOPOLYASSETCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x196B2B60)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 TaxValue; // 0x18
		::System::UInt32 AssetID; // 0x1C
		::System::UInt32 BonusValue; // 0x20
		::System::UInt32 Price; // 0x24
		::System::UInt32 Level; // 0x28
		::RPG::Client::TextID AssetDesc; // 0x30
