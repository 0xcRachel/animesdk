...
#define RPG_GAMECORE_SWORDTRAININGPARTNERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16FBEC30)
#define RPG_GAMECORE_SWORDTRAININGPARTNERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16FBF540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwordTrainingPartnerRow_TypeDefinitionIndex = 11297;
