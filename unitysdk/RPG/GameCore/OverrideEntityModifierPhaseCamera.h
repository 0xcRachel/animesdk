...
#define RPG_GAMECORE_OVERRIDEENTITYMODIFIERPHASECAMERA_METHOD_3_0505474B812367DA_OFFSET UNITYSDK_OFFSET(0x18EF5D20)
#define RPG_GAMECORE_OVERRIDEENTITYMODIFIERPHASECAMERA_METHOD_3_A28636602C5A9B6D_OFFSET UNITYSDK_OFFSET(0x18EF5CA0)
#define RPG_GAMECORE_OVERRIDEENTITYMODIFIERPHASECAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x18EF5CF0)
