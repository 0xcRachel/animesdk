...
#define RPG_GAMECORE_GRIDFIGHTSUMMONBEOVERRIDECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A1C1A40)
#define RPG_GAMECORE_GRIDFIGHTSUMMONBEOVERRIDECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1C1C00)
