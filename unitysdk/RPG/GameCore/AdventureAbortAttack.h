...
#define RPG_GAMECORE_ADVENTUREABORTATTACK_METHOD_3_366090A8E0064C3D_OFFSET UNITYSDK_OFFSET(0x19BFB980)
#define RPG_GAMECORE_ADVENTUREABORTATTACK_METHOD_3_4D2618B5C2E58F71_OFFSET UNITYSDK_OFFSET(0x19BFBA90)
#define RPG_GAMECORE_ADVENTUREABORTATTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19BFBA60)
