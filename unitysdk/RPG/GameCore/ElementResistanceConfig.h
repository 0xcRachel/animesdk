...
#define RPG_GAMECORE_ELEMENTRESISTANCECONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16A5DD90)
#define RPG_GAMECORE_ELEMENTRESISTANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16A5DEE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElementResistanceConfig_TypeDefinitionIndex = 11851;
