...
#define RPG_GAMECORE_WAITGROUPUNLOAD_METHOD_3_57639384934FD674_OFFSET UNITYSDK_OFFSET(0x179104D0)
#define RPG_GAMECORE_WAITGROUPUNLOAD_METHOD_3_9A1AD4171DD0F4E5_OFFSET UNITYSDK_OFFSET(0x17910550)
#define RPG_GAMECORE_WAITGROUPUNLOAD__CTOR_OFFSET UNITYSDK_OFFSET(0x17910520)
