...
#define RPG_GAMECORE_WAITGROUPUNLOAD_METHOD_3_57639384934FD674_OFFSET UNITYSDK_OFFSET(0x1952D5C0)
#define RPG_GAMECORE_WAITGROUPUNLOAD_METHOD_3_9A1AD4171DD0F4E5_OFFSET UNITYSDK_OFFSET(0x1952D640)
#define RPG_GAMECORE_WAITGROUPUNLOAD__CTOR_OFFSET UNITYSDK_OFFSET(0x1952D610)
