...
#define RPG_GAMECORE_BYPAMONLINEFIRST_METHOD_4_AE62F6FE5F2BD499_OFFSET UNITYSDK_OFFSET(0x1693ABB0)
#define RPG_GAMECORE_BYPAMONLINEFIRST_METHOD_4_EA651D880F5B1E43_OFFSET UNITYSDK_OFFSET(0x1693AC80)
#define RPG_GAMECORE_BYPAMONLINEFIRST__CTOR_OFFSET UNITYSDK_OFFSET(0x1693AC30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByPamOnlineFirst_TypeDefinitionIndex = 17767;
