...
#define RPG_GAMECORE_BYPAMONLINEFIRST_METHOD_4_AE62F6FE5F2BD499_OFFSET UNITYSDK_OFFSET(0x1704C400)
#define RPG_GAMECORE_BYPAMONLINEFIRST_METHOD_4_EA651D880F5B1E43_OFFSET UNITYSDK_OFFSET(0x1704C4D0)
#define RPG_GAMECORE_BYPAMONLINEFIRST__CTOR_OFFSET UNITYSDK_OFFSET(0x1704C480)
