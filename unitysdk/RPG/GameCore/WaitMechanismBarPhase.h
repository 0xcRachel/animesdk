...
#define RPG_GAMECORE_WAITMECHANISMBARPHASE_METHOD_3_3A885DF37571A39F_OFFSET UNITYSDK_OFFSET(0x17155DE0)
#define RPG_GAMECORE_WAITMECHANISMBARPHASE_METHOD_3_DBA7BFF3CA43698E_OFFSET UNITYSDK_OFFSET(0x17155D60)
#define RPG_GAMECORE_WAITMECHANISMBARPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x17155DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitMechanismBarPhase_TypeDefinitionIndex = 18306;
