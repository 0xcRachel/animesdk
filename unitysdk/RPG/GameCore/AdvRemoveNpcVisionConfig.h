...
#define RPG_GAMECORE_ADVREMOVENPCVISIONCONFIG_METHOD_3_28FDF4294B61D62C_OFFSET UNITYSDK_OFFSET(0x168449D0)
#define RPG_GAMECORE_ADVREMOVENPCVISIONCONFIG_METHOD_3_DCFA5F3F87840E3D_OFFSET UNITYSDK_OFFSET(0x16844950)
#define RPG_GAMECORE_ADVREMOVENPCVISIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x168449A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvRemoveNpcVisionConfig_TypeDefinitionIndex = 18112;
