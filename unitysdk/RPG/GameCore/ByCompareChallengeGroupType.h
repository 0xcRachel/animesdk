...
#define RPG_GAMECORE_BYCOMPARECHALLENGEGROUPTYPE_METHOD_4_38221E01C628D9CC_OFFSET UNITYSDK_OFFSET(0x16907240)
#define RPG_GAMECORE_BYCOMPARECHALLENGEGROUPTYPE_METHOD_4_F130E1E1F27B0282_OFFSET UNITYSDK_OFFSET(0x16907170)
#define RPG_GAMECORE_BYCOMPARECHALLENGEGROUPTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x169071F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareChallengeGroupType_TypeDefinitionIndex = 21112;
