...
#define RPG_GAMECORE_SHOWMINIGAMEFUNCBTNEFFECT_METHOD_3_1E72AAF57604AF97_OFFSET UNITYSDK_OFFSET(0x193AD5A0)
#define RPG_GAMECORE_SHOWMINIGAMEFUNCBTNEFFECT_METHOD_3_96C50CACFC9DCB3E_OFFSET UNITYSDK_OFFSET(0x193AD620)
#define RPG_GAMECORE_SHOWMINIGAMEFUNCBTNEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x193AD5F0)
