...
#define RPG_GAMECORE_SHOWMINIGAMEFUNCBTNEFFECT_METHOD_3_1E72AAF57604AF97_OFFSET UNITYSDK_OFFSET(0x17714700)
#define RPG_GAMECORE_SHOWMINIGAMEFUNCBTNEFFECT_METHOD_3_96C50CACFC9DCB3E_OFFSET UNITYSDK_OFFSET(0x17714780)
#define RPG_GAMECORE_SHOWMINIGAMEFUNCBTNEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x17714750)
