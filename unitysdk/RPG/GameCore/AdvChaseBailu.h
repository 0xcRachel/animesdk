...
#define RPG_GAMECORE_ADVCHASEBAILU_METHOD_3_3A445E2F7AC24116_OFFSET UNITYSDK_OFFSET(0x16830080)
#define RPG_GAMECORE_ADVCHASEBAILU_METHOD_3_51A49F37820B5931_OFFSET UNITYSDK_OFFSET(0x1682FFE0)
#define RPG_GAMECORE_ADVCHASEBAILU__CTOR_OFFSET UNITYSDK_OFFSET(0x16830040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvChaseBailu_TypeDefinitionIndex = 19880;
