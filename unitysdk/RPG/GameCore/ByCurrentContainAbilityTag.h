...
#define RPG_GAMECORE_BYCURRENTCONTAINABILITYTAG_METHOD_4_380C8106CFED5251_OFFSET UNITYSDK_OFFSET(0x17032D10)
#define RPG_GAMECORE_BYCURRENTCONTAINABILITYTAG_METHOD_4_BBE265858387C0FB_OFFSET UNITYSDK_OFFSET(0x17032DE0)
#define RPG_GAMECORE_BYCURRENTCONTAINABILITYTAG__CTOR_OFFSET UNITYSDK_OFFSET(0x17032D90)
