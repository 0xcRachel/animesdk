...
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMSTRING_METHOD_4_8545FD24898AE274_OFFSET UNITYSDK_OFFSET(0x19AC3AC0)
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMSTRING_METHOD_4_F6CA23B0A39C15C6_OFFSET UNITYSDK_OFFSET(0x19AC39E0)
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x19AC3A60)
