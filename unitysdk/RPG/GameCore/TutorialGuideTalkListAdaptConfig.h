...
#define RPG_GAMECORE_TUTORIALGUIDETALKLISTADAPTCONFIG_METHOD_2_DD8925762F8F1A6C_OFFSET UNITYSDK_OFFSET(0x17135000)
#define RPG_GAMECORE_TUTORIALGUIDETALKLISTADAPTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17135240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialGuideTalkListAdaptConfig_TypeDefinitionIndex = 21878;
