...
#define RPG_GAMECORE_CHIMERADUELBACKTOENDOFTEAMNODE_METHOD_3_2CDB57E8F7C2A48A_OFFSET UNITYSDK_OFFSET(0x1A50A1B0)
#define RPG_GAMECORE_CHIMERADUELBACKTOENDOFTEAMNODE_METHOD_3_9D201C772BFA396D_OFFSET UNITYSDK_OFFSET(0x1A50A0D0)
#define RPG_GAMECORE_CHIMERADUELBACKTOENDOFTEAMNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A50A160)
