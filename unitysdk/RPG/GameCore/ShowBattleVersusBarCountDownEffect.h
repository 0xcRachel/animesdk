...
#define RPG_GAMECORE_SHOWBATTLEVERSUSBARCOUNTDOWNEFFECT_METHOD_3_5B29A9901A836962_OFFSET UNITYSDK_OFFSET(0x1770AF10)
#define RPG_GAMECORE_SHOWBATTLEVERSUSBARCOUNTDOWNEFFECT_METHOD_3_DBD666B0137F728B_OFFSET UNITYSDK_OFFSET(0x1770AE90)
#define RPG_GAMECORE_SHOWBATTLEVERSUSBARCOUNTDOWNEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1770AEE0)
