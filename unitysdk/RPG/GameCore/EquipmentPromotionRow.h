...
#define RPG_GAMECORE_EQUIPMENTPROMOTIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x171BC530)
#define RPG_GAMECORE_EQUIPMENTPROMOTIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x171BCF00)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::FixPoint BaseDefenceAdd; // 0x30
		::RPG::GameCore::FixPoint BaseHP; // 0x38
		::RPG::GameCore::FixPoint BaseHPAdd; // 0x40
		::System::UInt32 PlayerLevelRequire; // 0x48
