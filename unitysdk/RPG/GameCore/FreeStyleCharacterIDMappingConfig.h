...
#define RPG_GAMECORE_FREESTYLECHARACTERIDMAPPINGCONFIG_METHOD_2_0A1B688B71BC30ED_OFFSET UNITYSDK_OFFSET(0x16AE8960)
#define RPG_GAMECORE_FREESTYLECHARACTERIDMAPPINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16AE8A30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FreeStyleCharacterIDMappingConfig_TypeDefinitionIndex = 14677;
