...
#define RPG_GAMECORE_ROGUECHESTGRIDITEM_METHOD_2_97E00C3040E47A67_OFFSET UNITYSDK_OFFSET(0x19245C60)
#define RPG_GAMECORE_ROGUECHESTGRIDITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x19245EA0)
