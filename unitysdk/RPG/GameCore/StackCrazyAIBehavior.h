...
#define RPG_GAMECORE_STACKCRAZYAIBEHAVIOR_METHOD_3_78E5D7772DBD6962_OFFSET UNITYSDK_OFFSET(0x186020F0)
#define RPG_GAMECORE_STACKCRAZYAIBEHAVIOR_METHOD_3_A3D7A70F4E866C01_OFFSET UNITYSDK_OFFSET(0x18602170)
#define RPG_GAMECORE_STACKCRAZYAIBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x18602140)
