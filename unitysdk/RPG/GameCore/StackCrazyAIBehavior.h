...
#define RPG_GAMECORE_STACKCRAZYAIBEHAVIOR_METHOD_3_2291CAEFD736C8AB_OFFSET UNITYSDK_OFFSET(0x177756B0)
#define RPG_GAMECORE_STACKCRAZYAIBEHAVIOR_METHOD_3_59EFF42CF83D056A_OFFSET UNITYSDK_OFFSET(0x17775730)
#define RPG_GAMECORE_STACKCRAZYAIBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x17775700)
