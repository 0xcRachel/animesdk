...
#define RPG_GAMECORE_STACKCRAZYAIBEHAVIOR_METHOD_3_2291CAEFD736C8AB_OFFSET UNITYSDK_OFFSET(0x16F814F0)
#define RPG_GAMECORE_STACKCRAZYAIBEHAVIOR_METHOD_3_59EFF42CF83D056A_OFFSET UNITYSDK_OFFSET(0x16F81570)
#define RPG_GAMECORE_STACKCRAZYAIBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x16F81540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StackCrazyAIBehavior_TypeDefinitionIndex = 21324;

	class StackCrazyAIBehavior : public ::RPG::GameCore::TaskConfig
	{
	public:
		::System::String* CrazyAIBehaviorPriority; // 0x18
		::Il2CppArray<::RPG::GameCore::ControlSkillType>* ValidTypes; // 0x20
