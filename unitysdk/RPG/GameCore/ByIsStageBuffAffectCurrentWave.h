...
#define RPG_GAMECORE_BYISSTAGEBUFFAFFECTCURRENTWAVE_METHOD_4_10C7EE2E51580B5B_OFFSET UNITYSDK_OFFSET(0x19DB0F70)
#define RPG_GAMECORE_BYISSTAGEBUFFAFFECTCURRENTWAVE_METHOD_4_1A499F236759CEF4_OFFSET UNITYSDK_OFFSET(0x19DB0DB0)
#define RPG_GAMECORE_BYISSTAGEBUFFAFFECTCURRENTWAVE_METHOD_4_3BE4F4D92434300F_OFFSET UNITYSDK_OFFSET(0x19DB0EF0)
#define RPG_GAMECORE_BYISSTAGEBUFFAFFECTCURRENTWAVE_METHOD_4_B637CD89E571485E_OFFSET UNITYSDK_OFFSET(0x19DB0CE0)
#define RPG_GAMECORE_BYISSTAGEBUFFAFFECTCURRENTWAVE__CTOR_OFFSET UNITYSDK_OFFSET(0x19DB0D60)
