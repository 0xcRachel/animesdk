...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::CakeRaceComponentType>**)Il2CppClass::FromTypeDefinitionIndex(CakeRaceHasComponentPredicateConfig___O_TypeDefinitionIndex)->GetStaticField(0x12AE0);
		}
	};
}
