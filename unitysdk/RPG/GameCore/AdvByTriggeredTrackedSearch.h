...
#define RPG_GAMECORE_ADVBYTRIGGEREDTRACKEDSEARCH_METHOD_4_1169DFD3F8C43F04_OFFSET UNITYSDK_OFFSET(0x1955D030)
#define RPG_GAMECORE_ADVBYTRIGGEREDTRACKEDSEARCH_METHOD_4_1F087FC33E07F1C1_OFFSET UNITYSDK_OFFSET(0x1955CDE0)
#define RPG_GAMECORE_ADVBYTRIGGEREDTRACKEDSEARCH_METHOD_4_8403A56442D19084_OFFSET UNITYSDK_OFFSET(0x1955D0B0)
#define RPG_GAMECORE_ADVBYTRIGGEREDTRACKEDSEARCH_METHOD_4_A9099723B807619F_OFFSET UNITYSDK_OFFSET(0x1955CEB0)
#define RPG_GAMECORE_ADVBYTRIGGEREDTRACKEDSEARCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1955CE60)
