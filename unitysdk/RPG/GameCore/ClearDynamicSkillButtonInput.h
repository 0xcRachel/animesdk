...
#define RPG_GAMECORE_CLEARDYNAMICSKILLBUTTONINPUT_METHOD_3_5C0707B86D95BEEE_OFFSET UNITYSDK_OFFSET(0x170C6140)
#define RPG_GAMECORE_CLEARDYNAMICSKILLBUTTONINPUT_METHOD_3_BDFB4BBC338D755D_OFFSET UNITYSDK_OFFSET(0x170C60C0)
#define RPG_GAMECORE_CLEARDYNAMICSKILLBUTTONINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x170C6110)
