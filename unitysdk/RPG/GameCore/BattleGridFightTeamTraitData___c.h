...
#define RPG_GAMECORE_BATTLEGRIDFIGHTTEAMTRAITDATA___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xA8917D0)
#define RPG_GAMECORE_BATTLEGRIDFIGHTTEAMTRAITDATA___C__CTOR_OFFSET UNITYSDK_OFFSET(0xA891810)
#define RPG_GAMECORE_BATTLEGRIDFIGHTTEAMTRAITDATA___C__GET_MEMBERCOUNTEXCEPTDUMMY_B__10_0_OFFSET UNITYSDK_OFFSET(0xA891820)
...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::System::Func_2<::Class_1_352A8B3482C80E7D_3*, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(BattleGridFightTeamTraitData___c_TypeDefinitionIndex)->GetStaticField(0x467A0);
		}
		static ::RPG::GameCore::BattleGridFightTeamTraitData___c** StaticGet___9()
		{
			return (::RPG::GameCore::BattleGridFightTeamTraitData___c**)Il2CppClass::FromTypeDefinitionIndex(BattleGridFightTeamTraitData___c_TypeDefinitionIndex)->GetStaticField(0x467A8);
		}
