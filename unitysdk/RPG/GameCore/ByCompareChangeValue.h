...
#define RPG_GAMECORE_BYCOMPARECHANGEVALUE_METHOD_4_968F7800B6A95443_OFFSET UNITYSDK_OFFSET(0x17018550)
#define RPG_GAMECORE_BYCOMPARECHANGEVALUE_METHOD_4_E891264CFCFDFBCD_OFFSET UNITYSDK_OFFSET(0x17018480)
#define RPG_GAMECORE_BYCOMPARECHANGEVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x17018500)
