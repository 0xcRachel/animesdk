...
#define RPG_GAMECORE_BYCOMPARECHANGEVALUE_METHOD_4_968F7800B6A95443_OFFSET UNITYSDK_OFFSET(0x16907720)
#define RPG_GAMECORE_BYCOMPARECHANGEVALUE_METHOD_4_E891264CFCFDFBCD_OFFSET UNITYSDK_OFFSET(0x16907650)
#define RPG_GAMECORE_BYCOMPARECHANGEVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x169076D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareChangeValue_TypeDefinitionIndex = 20641;
