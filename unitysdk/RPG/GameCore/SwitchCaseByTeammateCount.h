...
#define RPG_GAMECORE_SWITCHCASEBYTEAMMATECOUNT_METHOD_3_2BA722572EFCCE3F_OFFSET UNITYSDK_OFFSET(0x18D88340)
#define RPG_GAMECORE_SWITCHCASEBYTEAMMATECOUNT_METHOD_3_6C86BCC2C8F1198E_OFFSET UNITYSDK_OFFSET(0x18D882B0)
#define RPG_GAMECORE_SWITCHCASEBYTEAMMATECOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x18D88310)
