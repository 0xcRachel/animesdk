...
#define RPG_GAMECORE_SWITCHCASEBYTEAMMATECOUNT_METHOD_3_6D7DCEE4C2A51517_OFFSET UNITYSDK_OFFSET(0x1985B8A0)
#define RPG_GAMECORE_SWITCHCASEBYTEAMMATECOUNT_METHOD_3_70ECD12E7B5FD2B8_OFFSET UNITYSDK_OFFSET(0x1985B930)
#define RPG_GAMECORE_SWITCHCASEBYTEAMMATECOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1985B900)
