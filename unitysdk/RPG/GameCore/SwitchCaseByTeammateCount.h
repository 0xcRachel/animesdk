...
#define RPG_GAMECORE_SWITCHCASEBYTEAMMATECOUNT_METHOD_3_2BA722572EFCCE3F_OFFSET UNITYSDK_OFFSET(0x16FB29A0)
#define RPG_GAMECORE_SWITCHCASEBYTEAMMATECOUNT_METHOD_3_6C86BCC2C8F1198E_OFFSET UNITYSDK_OFFSET(0x16FB2910)
#define RPG_GAMECORE_SWITCHCASEBYTEAMMATECOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x16FB2970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchCaseByTeammateCount_TypeDefinitionIndex = 21486;
