...
#define RPG_GAMECORE_FIELDEFFECTBUDGETCONFIG_METHOD_2_879DFB5EF16DA78C_OFFSET UNITYSDK_OFFSET(0x18D128F0)
#define RPG_GAMECORE_FIELDEFFECTBUDGETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D12C40)
