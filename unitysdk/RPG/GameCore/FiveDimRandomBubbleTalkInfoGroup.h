...
#define RPG_GAMECORE_FIVEDIMRANDOMBUBBLETALKINFOGROUP_METHOD_2_A9358C6A3FE417A3_OFFSET UNITYSDK_OFFSET(0x16AD0E60)
#define RPG_GAMECORE_FIVEDIMRANDOMBUBBLETALKINFOGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x16AD0FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimRandomBubbleTalkInfoGroup_TypeDefinitionIndex = 19163;
