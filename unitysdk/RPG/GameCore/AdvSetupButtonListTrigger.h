...
#define RPG_GAMECORE_ADVSETUPBUTTONLISTTRIGGER_METHOD_3_4DBD83528F692731_OFFSET UNITYSDK_OFFSET(0x1684A2E0)
#define RPG_GAMECORE_ADVSETUPBUTTONLISTTRIGGER_METHOD_3_87BE31F1D38B2822_OFFSET UNITYSDK_OFFSET(0x1684A240)
#define RPG_GAMECORE_ADVSETUPBUTTONLISTTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1684A2A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetupButtonListTrigger_TypeDefinitionIndex = 19821;
