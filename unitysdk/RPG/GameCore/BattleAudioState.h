...
#define RPG_GAMECORE_BATTLEAUDIOSTATE_METHOD_3_18FCD5225F36B89F_OFFSET UNITYSDK_OFFSET(0x1822FDE0)
#define RPG_GAMECORE_BATTLEAUDIOSTATE_METHOD_3_952493F0F8F4AE2B_OFFSET UNITYSDK_OFFSET(0x1822FE60)
#define RPG_GAMECORE_BATTLEAUDIOSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1822FE30)
