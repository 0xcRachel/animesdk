...
#define RPG_GAMECORE_GRIDFIGHTEQUIPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B21340)
#define RPG_GAMECORE_GRIDFIGHTEQUIPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B218C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightEquipConfigRow_TypeDefinitionIndex = 12222;

	class GridFightEquipConfigRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* EquipFuncParamList; // 0x10
		::Il2CppArray<::System::UInt32>* DressRuleParamList; // 0x18
		...
		::Il2CppArray<::System::UInt32>* EquipmentTagList; // 0x48
		::RPG::GameCore::GridFightEquipFuncType EquipFunc; // 0x50
		...
		::System::Boolean IsDisplaySpecialParam; // 0x60
