...
#define RPG_GAMECORE_GRIDFIGHTEQUIPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1956E3C0)
#define RPG_GAMECORE_GRIDFIGHTEQUIPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1956E980)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::GridFightEquipType EquipType; // 0x60
		::RPG::GameCore::GridFightEquipFuncType EquipFunc; // 0x64
		::System::Boolean IsDisplaySpecialParam; // 0x68
		::System::UInt32 ID; // 0x6C
		::RPG::GameCore::GridFightEquipCategory EquipCategory; // 0x70
		::RPG::GameCore::GridFightEquipDressType DressRule; // 0x74
