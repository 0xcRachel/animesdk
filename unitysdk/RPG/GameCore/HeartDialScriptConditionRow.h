...
#define RPG_GAMECORE_HEARTDIALSCRIPTCONDITIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B5F120)
#define RPG_GAMECORE_HEARTDIALSCRIPTCONDITIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B5F320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HeartDialScriptConditionRow_TypeDefinitionIndex = 12486;
