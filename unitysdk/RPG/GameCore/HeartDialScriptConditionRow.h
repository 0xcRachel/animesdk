...
#define RPG_GAMECORE_HEARTDIALSCRIPTCONDITIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18A674F0)
#define RPG_GAMECORE_HEARTDIALSCRIPTCONDITIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18A676F0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 MissingConditionID; // 0x24
