...
#define RPG_GAMECORE_ROGUEMAGICSTYLETYPESELECTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19EC5980)
#define RPG_GAMECORE_ROGUEMAGICSTYLETYPESELECTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19EC6090)
