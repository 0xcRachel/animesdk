...
#define RPG_GAMECORE_GRAPHICDEVICEINFO_METHOD_2_C477365CE043AF86_OFFSET UNITYSDK_OFFSET(0x16B14950)
#define RPG_GAMECORE_GRAPHICDEVICEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16B14AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GraphicDeviceInfo_TypeDefinitionIndex = 16392;
