...
#define RPG_GAMECORE_BYPAMNORMALACTION_METHOD_4_00DAE05840A18CBD_OFFSET UNITYSDK_OFFSET(0x1704BFE0)
#define RPG_GAMECORE_BYPAMNORMALACTION_METHOD_4_88EE3127DB4C2DD7_OFFSET UNITYSDK_OFFSET(0x1704C0B0)
#define RPG_GAMECORE_BYPAMNORMALACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1704C060)
