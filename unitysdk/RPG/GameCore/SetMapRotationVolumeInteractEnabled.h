...
#define RPG_GAMECORE_SETMAPROTATIONVOLUMEINTERACTENABLED_METHOD_3_7E51248E0FFADF6E_OFFSET UNITYSDK_OFFSET(0x16F33A30)
#define RPG_GAMECORE_SETMAPROTATIONVOLUMEINTERACTENABLED_METHOD_3_CCC5BD0DEBC4879F_OFFSET UNITYSDK_OFFSET(0x16F33AB0)
#define RPG_GAMECORE_SETMAPROTATIONVOLUMEINTERACTENABLED__CTOR_OFFSET UNITYSDK_OFFSET(0x16F33A80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMapRotationVolumeInteractEnabled_TypeDefinitionIndex = 18726;
