...
#define RPG_GAMECORE_GAMEPLAYSTATIC___C__DISPLAYCLASS7_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA425A50)
#define RPG_GAMECORE_GAMEPLAYSTATIC___C__DISPLAYCLASS7_0__SOLVESTANCEWEAKNESSPRESHOW_B__0_OFFSET UNITYSDK_OFFSET(0xA432C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GamePlayStatic___c__DisplayClass7_0_TypeDefinitionIndex = 46641;
