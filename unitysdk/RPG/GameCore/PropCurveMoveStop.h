...
#define RPG_GAMECORE_PROPCURVEMOVESTOP_METHOD_3_B5E2F259C77E2863_OFFSET UNITYSDK_OFFSET(0x191C0870)
#define RPG_GAMECORE_PROPCURVEMOVESTOP_METHOD_3_BFE333FCD81AB79B_OFFSET UNITYSDK_OFFSET(0x191C0940)
#define RPG_GAMECORE_PROPCURVEMOVESTOP__CTOR_OFFSET UNITYSDK_OFFSET(0x191C08F0)
