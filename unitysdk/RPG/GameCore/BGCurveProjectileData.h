...
#define RPG_GAMECORE_BGCURVEPROJECTILEDATA_METHOD_3_AF3FD6E9A78823CD_OFFSET UNITYSDK_OFFSET(0x168C5FF0)
#define RPG_GAMECORE_BGCURVEPROJECTILEDATA_METHOD_3_F4A968EF9DC91352_OFFSET UNITYSDK_OFFSET(0x168C5ED0)
#define RPG_GAMECORE_BGCURVEPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x168C5F70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BGCurveProjectileData_TypeDefinitionIndex = 14246;
