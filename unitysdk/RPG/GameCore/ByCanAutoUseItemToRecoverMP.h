...
#define RPG_GAMECORE_BYCANAUTOUSEITEMTORECOVERMP_METHOD_4_136389DBE8071417_OFFSET UNITYSDK_OFFSET(0x187CEDF0)
#define RPG_GAMECORE_BYCANAUTOUSEITEMTORECOVERMP_METHOD_4_7B77956AF30008FD_OFFSET UNITYSDK_OFFSET(0x187CED20)
#define RPG_GAMECORE_BYCANAUTOUSEITEMTORECOVERMP__CTOR_OFFSET UNITYSDK_OFFSET(0x187CEDA0)
