...
#define RPG_GAMECORE_BYCANAUTOUSEITEMTORECOVERMP_METHOD_4_136389DBE8071417_OFFSET UNITYSDK_OFFSET(0x195F3A60)
#define RPG_GAMECORE_BYCANAUTOUSEITEMTORECOVERMP_METHOD_4_7B77956AF30008FD_OFFSET UNITYSDK_OFFSET(0x195F3990)
#define RPG_GAMECORE_BYCANAUTOUSEITEMTORECOVERMP_METHOD_4_A1EFE23EB0579DC8_OFFSET UNITYSDK_OFFSET(0x195F3C20)
#define RPG_GAMECORE_BYCANAUTOUSEITEMTORECOVERMP_METHOD_4_E19E0AE201616380_OFFSET UNITYSDK_OFFSET(0x195F3BA0)
#define RPG_GAMECORE_BYCANAUTOUSEITEMTORECOVERMP__CTOR_OFFSET UNITYSDK_OFFSET(0x195F3A10)
