...
#define RPG_GAMECORE_ENABLEHUGEMONSTERHALFDITHER_METHOD_3_B737A8D406F1D6F4_OFFSET UNITYSDK_OFFSET(0x171ACB70)
#define RPG_GAMECORE_ENABLEHUGEMONSTERHALFDITHER_METHOD_3_F9EEE9669172F565_OFFSET UNITYSDK_OFFSET(0x171ACBF0)
#define RPG_GAMECORE_ENABLEHUGEMONSTERHALFDITHER__CTOR_OFFSET UNITYSDK_OFFSET(0x171ACBC0)
