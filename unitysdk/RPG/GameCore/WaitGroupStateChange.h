...
#define RPG_GAMECORE_WAITGROUPSTATECHANGE_METHOD_4_6A4BC8747647FF94_OFFSET UNITYSDK_OFFSET(0x17153C70)
#define RPG_GAMECORE_WAITGROUPSTATECHANGE_METHOD_4_FBD0BBA51FD774D8_OFFSET UNITYSDK_OFFSET(0x17153D60)
#define RPG_GAMECORE_WAITGROUPSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x17153D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitGroupStateChange_TypeDefinitionIndex = 18524;
