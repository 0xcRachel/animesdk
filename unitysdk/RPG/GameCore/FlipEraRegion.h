...
#define RPG_GAMECORE_FLIPERAREGION_METHOD_3_9892581B20FBC428_OFFSET UNITYSDK_OFFSET(0x17227230)
#define RPG_GAMECORE_FLIPERAREGION_METHOD_3_ED59EEBA3639F714_OFFSET UNITYSDK_OFFSET(0x17227340)
#define RPG_GAMECORE_FLIPERAREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x17227310)
