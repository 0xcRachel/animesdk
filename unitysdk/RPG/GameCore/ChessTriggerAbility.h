...
#define RPG_GAMECORE_CHESSTRIGGERABILITY_METHOD_3_1DBB544B84ADEB1F_OFFSET UNITYSDK_OFFSET(0x16980A40)
#define RPG_GAMECORE_CHESSTRIGGERABILITY_METHOD_3_A70CE794BF5596C0_OFFSET UNITYSDK_OFFSET(0x16980AC0)
#define RPG_GAMECORE_CHESSTRIGGERABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x16980A90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChessTriggerAbility_TypeDefinitionIndex = 21434;
