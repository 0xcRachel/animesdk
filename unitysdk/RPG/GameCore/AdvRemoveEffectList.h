...
#define RPG_GAMECORE_ADVREMOVEEFFECTLIST_METHOD_3_225832074879FED2_OFFSET UNITYSDK_OFFSET(0x168447D0)
#define RPG_GAMECORE_ADVREMOVEEFFECTLIST_METHOD_3_D5BF672589A529B0_OFFSET UNITYSDK_OFFSET(0x16844750)
#define RPG_GAMECORE_ADVREMOVEEFFECTLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x168447A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvRemoveEffectList_TypeDefinitionIndex = 19975;
