...
#define RPG_GAMECORE_ADVREMOVEEFFECTLIST_METHOD_3_225832074879FED2_OFFSET UNITYSDK_OFFSET(0x18C57C10)
#define RPG_GAMECORE_ADVREMOVEEFFECTLIST_METHOD_3_D5BF672589A529B0_OFFSET UNITYSDK_OFFSET(0x18C57B90)
#define RPG_GAMECORE_ADVREMOVEEFFECTLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x18C57BE0)
