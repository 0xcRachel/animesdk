...
#define RPG_GAMECORE_CHIMERADUELENTERTUTORIALBATTLE_METHOD_3_2D99BCE3BCA87DAC_OFFSET UNITYSDK_OFFSET(0x1698CC10)
#define RPG_GAMECORE_CHIMERADUELENTERTUTORIALBATTLE_METHOD_3_B7BFCAE89522B638_OFFSET UNITYSDK_OFFSET(0x1698CD20)
#define RPG_GAMECORE_CHIMERADUELENTERTUTORIALBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1698CCF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEnterTutorialBattle_TypeDefinitionIndex = 19381;
