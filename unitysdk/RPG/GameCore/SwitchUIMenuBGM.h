...
#define RPG_GAMECORE_SWITCHUIMENUBGM_METHOD_3_17A6D5636725895F_OFFSET UNITYSDK_OFFSET(0x177AE740)
#define RPG_GAMECORE_SWITCHUIMENUBGM_METHOD_3_48E2681717C447BB_OFFSET UNITYSDK_OFFSET(0x177AE6C0)
#define RPG_GAMECORE_SWITCHUIMENUBGM__CTOR_OFFSET UNITYSDK_OFFSET(0x177AE710)
