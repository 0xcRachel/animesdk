...
#define RPG_GAMECORE_CHENLINGBATTLELASERSPLITWITHTARGETCONFIG_METHOD_3_052C34389DDBC716_OFFSET UNITYSDK_OFFSET(0x196A1870)
#define RPG_GAMECORE_CHENLINGBATTLELASERSPLITWITHTARGETCONFIG_METHOD_3_2CAACA2A508B404F_OFFSET UNITYSDK_OFFSET(0x196A1C50)
#define RPG_GAMECORE_CHENLINGBATTLELASERSPLITWITHTARGETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x196A1860)
