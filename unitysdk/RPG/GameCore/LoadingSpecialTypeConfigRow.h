...
#define RPG_GAMECORE_LOADINGSPECIALTYPECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16BD7490)
#define RPG_GAMECORE_LOADINGSPECIALTYPECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16BD7650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoadingSpecialTypeConfigRow_TypeDefinitionIndex = 12708;
