...
#define RPG_GAMECORE_MESSAGEVIDEOROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16C894D0)
#define RPG_GAMECORE_MESSAGEVIDEOROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16C89A60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MessageVideoRow_TypeDefinitionIndex = 13132;
