...
#define RPG_GAMECORE_RTDYNAMICVALUERANGEGROUP_METHOD_2_D300F1FE46F3CECA_OFFSET UNITYSDK_OFFSET(0x18E814A0)
#define RPG_GAMECORE_RTDYNAMICVALUERANGEGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x18E816C0)
