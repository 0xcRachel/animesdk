...
#define RPG_GAMECORE_CHARACTERSCALEDATACONFIG_METHOD_2_5D827DF73B42C643_OFFSET UNITYSDK_OFFSET(0x16975830)
#define RPG_GAMECORE_CHARACTERSCALEDATACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16975900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterScaleDataConfig_TypeDefinitionIndex = 14851;
