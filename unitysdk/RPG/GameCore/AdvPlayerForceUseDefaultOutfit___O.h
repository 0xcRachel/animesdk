...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::PlayerOutfitSlotType>**)Il2CppClass::FromTypeDefinitionIndex(AdvPlayerForceUseDefaultOutfit___O_TypeDefinitionIndex)->GetStaticField(0x85D0);
		}
	};
}
