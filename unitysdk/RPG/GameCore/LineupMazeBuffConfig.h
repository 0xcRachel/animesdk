...
#define RPG_GAMECORE_LINEUPMAZEBUFFCONFIG_METHOD_2_B0A2E776730B42FA_OFFSET UNITYSDK_OFFSET(0x16BC3E30)
#define RPG_GAMECORE_LINEUPMAZEBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16BC3FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LineupMazeBuffConfig_TypeDefinitionIndex = 16268;
