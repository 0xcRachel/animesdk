...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::ChestType>**)Il2CppClass::FromTypeDefinitionIndex(MazeChestRow___O_TypeDefinitionIndex)->GetStaticField(0x456A0);
		}
	};
}
