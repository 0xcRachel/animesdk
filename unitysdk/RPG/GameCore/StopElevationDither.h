...
#define RPG_GAMECORE_STOPELEVATIONDITHER_METHOD_3_10AB5464A57C6E14_OFFSET UNITYSDK_OFFSET(0x193518C0)
#define RPG_GAMECORE_STOPELEVATIONDITHER_METHOD_3_A98C30CD0CD96205_OFFSET UNITYSDK_OFFSET(0x19351940)
#define RPG_GAMECORE_STOPELEVATIONDITHER__CTOR_OFFSET UNITYSDK_OFFSET(0x19351910)
