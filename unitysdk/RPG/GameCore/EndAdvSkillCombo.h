...
#define RPG_GAMECORE_ENDADVSKILLCOMBO_METHOD_3_20437EBCF81BDD80_OFFSET UNITYSDK_OFFSET(0x1915B350)
#define RPG_GAMECORE_ENDADVSKILLCOMBO_METHOD_3_F6245AAE72492979_OFFSET UNITYSDK_OFFSET(0x1915B3D0)
#define RPG_GAMECORE_ENDADVSKILLCOMBO__CTOR_OFFSET UNITYSDK_OFFSET(0x1915B3A0)
