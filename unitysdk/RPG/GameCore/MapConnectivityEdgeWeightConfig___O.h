...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::MapConnectivityEdgeType>**)Il2CppClass::FromTypeDefinitionIndex(MapConnectivityEdgeWeightConfig___O_TypeDefinitionIndex)->GetStaticField(0x35950);
		}
	};
}
