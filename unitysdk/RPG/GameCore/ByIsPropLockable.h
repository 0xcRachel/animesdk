...
#define RPG_GAMECORE_BYISPROPLOCKABLE_METHOD_4_1252331BDED31950_OFFSET UNITYSDK_OFFSET(0x169344A0)
#define RPG_GAMECORE_BYISPROPLOCKABLE_METHOD_4_4701642148B09233_OFFSET UNITYSDK_OFFSET(0x169345C0)
#define RPG_GAMECORE_BYISPROPLOCKABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16934540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsPropLockable_TypeDefinitionIndex = 17959;
