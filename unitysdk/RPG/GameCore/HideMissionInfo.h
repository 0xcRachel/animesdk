...
#define RPG_GAMECORE_HIDEMISSIONINFO_METHOD_3_4494C26EA81E8756_OFFSET UNITYSDK_OFFSET(0x19AC4A60)
#define RPG_GAMECORE_HIDEMISSIONINFO_METHOD_3_480F3B27221459D7_OFFSET UNITYSDK_OFFSET(0x19AC49E0)
#define RPG_GAMECORE_HIDEMISSIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19AC4A30)
