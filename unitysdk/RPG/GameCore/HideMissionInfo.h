...
#define RPG_GAMECORE_HIDEMISSIONINFO_METHOD_3_4494C26EA81E8756_OFFSET UNITYSDK_OFFSET(0x16B70070)
#define RPG_GAMECORE_HIDEMISSIONINFO_METHOD_3_480F3B27221459D7_OFFSET UNITYSDK_OFFSET(0x16B6FFF0)
#define RPG_GAMECORE_HIDEMISSIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16B70040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HideMissionInfo_TypeDefinitionIndex = 21750;
