...
#define RPG_GAMECORE_SHOWGUIDETEXTFOLLOW3D_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x16F5D410)
#define RPG_GAMECORE_SHOWGUIDETEXTFOLLOW3D_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16F5D340)
#define RPG_GAMECORE_SHOWGUIDETEXTFOLLOW3D__CTOR_OFFSET UNITYSDK_OFFSET(0x16F5D3C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowGuideTextFollow3D_TypeDefinitionIndex = 21819;
