...
#define RPG_GAMECORE_WAITPROPEVENTINBATTLE_METHOD_4_02EED219AB03BA11_OFFSET UNITYSDK_OFFSET(0x17915B50)
#define RPG_GAMECORE_WAITPROPEVENTINBATTLE_METHOD_4_1C72DDD187DFDED7_OFFSET UNITYSDK_OFFSET(0x17915C30)
#define RPG_GAMECORE_WAITPROPEVENTINBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x17915BD0)
