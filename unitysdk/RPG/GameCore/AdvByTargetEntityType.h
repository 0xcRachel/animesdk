...
#define RPG_GAMECORE_ADVBYTARGETENTITYTYPE_METHOD_4_879DDE1EEF74150C_OFFSET UNITYSDK_OFFSET(0x1955CDD0)
#define RPG_GAMECORE_ADVBYTARGETENTITYTYPE_METHOD_4_D777C87C4916508C_OFFSET UNITYSDK_OFFSET(0x1955CD10)
#define RPG_GAMECORE_ADVBYTARGETENTITYTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1955CD80)
