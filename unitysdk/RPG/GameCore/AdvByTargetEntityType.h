...
#define RPG_GAMECORE_ADVBYTARGETENTITYTYPE_METHOD_4_879DDE1EEF74150C_OFFSET UNITYSDK_OFFSET(0x18DBDF20)
#define RPG_GAMECORE_ADVBYTARGETENTITYTYPE_METHOD_4_D777C87C4916508C_OFFSET UNITYSDK_OFFSET(0x18DBDE60)
#define RPG_GAMECORE_ADVBYTARGETENTITYTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x18DBDED0)
