...
#define RPG_GAMECORE_FIGHTFESTSHOWCUTIN_METHOD_3_DE3370DB2746ACB5_OFFSET UNITYSDK_OFFSET(0x16AA3420)
#define RPG_GAMECORE_FIGHTFESTSHOWCUTIN_METHOD_3_E851689F1FD33449_OFFSET UNITYSDK_OFFSET(0x16AA34A0)
#define RPG_GAMECORE_FIGHTFESTSHOWCUTIN__CTOR_OFFSET UNITYSDK_OFFSET(0x16AA3470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FightFestShowCutIn_TypeDefinitionIndex = 20899;
