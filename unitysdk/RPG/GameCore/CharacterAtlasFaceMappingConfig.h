...
#define RPG_GAMECORE_CHARACTERATLASFACEMAPPINGCONFIG_METHOD_2_39C87D6E6793C4D7_OFFSET UNITYSDK_OFFSET(0x169685E0)
#define RPG_GAMECORE_CHARACTERATLASFACEMAPPINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x169686B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterAtlasFaceMappingConfig_TypeDefinitionIndex = 15761;
