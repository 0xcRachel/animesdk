...
#define RPG_GAMECORE_SETPROPCANBEPLAYERLOCK_METHOD_3_9A6888D117DB4127_OFFSET UNITYSDK_OFFSET(0x199C2890)
#define RPG_GAMECORE_SETPROPCANBEPLAYERLOCK_METHOD_3_C51F8F1E1BB772AF_OFFSET UNITYSDK_OFFSET(0x199C2810)
#define RPG_GAMECORE_SETPROPCANBEPLAYERLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x199C2860)
