...
#define RPG_GAMECORE_TARGETCOMPUTE_METHOD_4_8122EF1751E8610F_OFFSET UNITYSDK_OFFSET(0x177C16C0)
#define RPG_GAMECORE_TARGETCOMPUTE_METHOD_4_D80294825193200E_OFFSET UNITYSDK_OFFSET(0x177C17A0)
#define RPG_GAMECORE_TARGETCOMPUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x177C1750)
