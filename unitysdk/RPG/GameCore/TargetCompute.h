...
#define RPG_GAMECORE_TARGETCOMPUTE_METHOD_4_8122EF1751E8610F_OFFSET UNITYSDK_OFFSET(0x16FCD250)
#define RPG_GAMECORE_TARGETCOMPUTE_METHOD_4_D80294825193200E_OFFSET UNITYSDK_OFFSET(0x16FCD330)
#define RPG_GAMECORE_TARGETCOMPUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FCD2E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetCompute_TypeDefinitionIndex = 21611;
