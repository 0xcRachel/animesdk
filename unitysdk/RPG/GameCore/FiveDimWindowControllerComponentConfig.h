...
#define RPG_GAMECORE_FIVEDIMWINDOWCONTROLLERCOMPONENTCONFIG_METHOD_3_04C7843B99E70E80_OFFSET UNITYSDK_OFFSET(0x16ADAAE0)
#define RPG_GAMECORE_FIVEDIMWINDOWCONTROLLERCOMPONENTCONFIG_METHOD_3_6E9CD4921AB86DAA_OFFSET UNITYSDK_OFFSET(0x16ADAB90)
#define RPG_GAMECORE_FIVEDIMWINDOWCONTROLLERCOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16ADAB50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimWindowControllerComponentConfig_TypeDefinitionIndex = 16875;
