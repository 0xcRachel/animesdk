...
#define RPG_GAMECORE_AISTEPPERDECISIONGROUPCONFIG_METHOD_4_9BC4B801EB811E9E_OFFSET UNITYSDK_OFFSET(0x16771D60)
#define RPG_GAMECORE_AISTEPPERDECISIONGROUPCONFIG_METHOD_4_BD4C279166180CFB_OFFSET UNITYSDK_OFFSET(0x1676F810)
#define RPG_GAMECORE_AISTEPPERDECISIONGROUPCONFIG_METHOD_4_C66FCDCC115993CF_OFFSET UNITYSDK_OFFSET(0x16771DA0)
#define RPG_GAMECORE_AISTEPPERDECISIONGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1676F800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIStepperDecisionGroupConfig_TypeDefinitionIndex = 14065;
