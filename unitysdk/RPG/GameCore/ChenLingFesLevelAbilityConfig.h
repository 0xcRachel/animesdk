...
#define RPG_GAMECORE_CHENLINGFESLEVELABILITYCONFIG_METHOD_3_0DBDEFC980D86E65_OFFSET UNITYSDK_OFFSET(0x1A4FDBD0)
#define RPG_GAMECORE_CHENLINGFESLEVELABILITYCONFIG_METHOD_3_B98AC4C5CE3256B4_OFFSET UNITYSDK_OFFSET(0x1A4FBCA0)
#define RPG_GAMECORE_CHENLINGFESLEVELABILITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4FBC80)
