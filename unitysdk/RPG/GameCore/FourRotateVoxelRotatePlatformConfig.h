...
#define RPG_GAMECORE_FOURROTATEVOXELROTATEPLATFORMCONFIG_METHOD_3_68F595C9E33584AB_OFFSET UNITYSDK_OFFSET(0x1A3B8910)
#define RPG_GAMECORE_FOURROTATEVOXELROTATEPLATFORMCONFIG_METHOD_3_8B2A09255960573A_OFFSET UNITYSDK_OFFSET(0x1A3B8980)
#define RPG_GAMECORE_FOURROTATEVOXELROTATEPLATFORMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3B8960)
