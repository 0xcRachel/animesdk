...
#define RPG_GAMECORE_RELICSUBAFFIXAVATARVALUEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A2E3D40)
#define RPG_GAMECORE_RELICSUBAFFIXAVATARVALUEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2E4090)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Single HP; // 0x24
		::System::Single CriticalDamage; // 0x28
		::System::Single StatusResistance; // 0x2C
