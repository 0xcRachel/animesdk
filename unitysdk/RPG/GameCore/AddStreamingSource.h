...
#define RPG_GAMECORE_ADDSTREAMINGSOURCE_METHOD_3_4FBDA64BD154F7EB_OFFSET UNITYSDK_OFFSET(0x18DB7350)
#define RPG_GAMECORE_ADDSTREAMINGSOURCE_METHOD_3_B8A034C904CEE3C2_OFFSET UNITYSDK_OFFSET(0x18DB73D0)
#define RPG_GAMECORE_ADDSTREAMINGSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x18DB73A0)
