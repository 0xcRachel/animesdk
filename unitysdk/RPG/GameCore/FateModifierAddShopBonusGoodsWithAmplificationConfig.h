...
#define RPG_GAMECORE_FATEMODIFIERADDSHOPBONUSGOODSWITHAMPLIFICATIONCONFIG_METHOD_3_9D918FC6622A7D00_OFFSET UNITYSDK_OFFSET(0x19474890)
#define RPG_GAMECORE_FATEMODIFIERADDSHOPBONUSGOODSWITHAMPLIFICATIONCONFIG_METHOD_3_ABD2E1F1AC97E569_OFFSET UNITYSDK_OFFSET(0x194747C0)
#define RPG_GAMECORE_FATEMODIFIERADDSHOPBONUSGOODSWITHAMPLIFICATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19474840)
