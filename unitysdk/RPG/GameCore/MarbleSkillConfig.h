...
#define RPG_GAMECORE_MARBLESKILLCONFIG_METHOD_2_676C43F7ECC65BC3_OFFSET UNITYSDK_OFFSET(0x18C20380)
#define RPG_GAMECORE_MARBLESKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18C20A70)
