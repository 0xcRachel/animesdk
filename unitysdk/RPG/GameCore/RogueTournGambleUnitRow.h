...
#define RPG_GAMECORE_ROGUETOURNGAMBLEUNITROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x194054E0)
#define RPG_GAMECORE_ROGUETOURNGAMBLEUNITROW__CTOR_OFFSET UNITYSDK_OFFSET(0x194056D0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 UnitTextureParam; // 0x20
		::RPG::GameCore::RogueGambleUnitType GambleUnitType; // 0x24
