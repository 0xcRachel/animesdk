...
#define RPG_GAMECORE_ROGUETOURNGAMBLEUNITROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16EC89D0)
#define RPG_GAMECORE_ROGUETOURNGAMBLEUNITROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16EC8B70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournGambleUnitRow_TypeDefinitionIndex = 13687;
