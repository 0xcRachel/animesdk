...
#define RPG_GAMECORE_BYCOMPAREENTITYAUTHORITYSIDE_METHOD_4_166DD29DE0F0ACA9_OFFSET UNITYSDK_OFFSET(0x1690AB80)
#define RPG_GAMECORE_BYCOMPAREENTITYAUTHORITYSIDE_METHOD_4_D2BB01313E75081F_OFFSET UNITYSDK_OFFSET(0x1690AAB0)
#define RPG_GAMECORE_BYCOMPAREENTITYAUTHORITYSIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1690AB30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareEntityAuthoritySide_TypeDefinitionIndex = 19971;
