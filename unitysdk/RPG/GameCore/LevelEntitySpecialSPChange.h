...
#define RPG_GAMECORE_LEVELENTITYSPECIALSPCHANGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA4A45A0)
#define RPG_GAMECORE_LEVELENTITYSPECIALSPCHANGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA4A4550)
#define RPG_GAMECORE_LEVELENTITYSPECIALSPCHANGE_INIT_OFFSET UNITYSDK_OFFSET(0xA4A44B0)
#define RPG_GAMECORE_LEVELENTITYSPECIALSPCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0xA4A45F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelEntitySpecialSPChange_TypeDefinitionIndex = 44597;
