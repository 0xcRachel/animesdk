...
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15587AE0)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x155878C0)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK_ONFINISHIMMEDIATELYINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x155879D0)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK_ONSKIP_OFFSET UNITYSDK_OFFSET(0x155878D0)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x15587630)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x15587A30)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK_TICK_OFFSET UNITYSDK_OFFSET(0x15587A80)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x15587620)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK__ONBACKGROUNDTALKFINISH_OFFSET UNITYSDK_OFFSET(0x15587B90)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK__ONMISSIONTALKFINISH_OFFSET UNITYSDK_OFFSET(0x15587B30)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK__REMOVENOTIFY_OFFSET UNITYSDK_OFFSET(0x15587920)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK__WAITBACKGROUNDTALKFINISH_OFFSET UNITYSDK_OFFSET(0x155877E0)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK__WAITMISSIONTALKFINISH_OFFSET UNITYSDK_OFFSET(0x15587850)
