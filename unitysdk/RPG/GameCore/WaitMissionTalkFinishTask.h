...
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAB08850)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0xAB08630)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK_ONFINISHIMMEDIATELYINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0xAB08740)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK_ONSKIP_OFFSET UNITYSDK_OFFSET(0xAB08640)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xAB083A0)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xAB087A0)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK_TICK_OFFSET UNITYSDK_OFFSET(0xAB087F0)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK__CTOR_OFFSET UNITYSDK_OFFSET(0xAB08390)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK__ONBACKGROUNDTALKFINISH_OFFSET UNITYSDK_OFFSET(0xAB08900)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK__ONMISSIONTALKFINISH_OFFSET UNITYSDK_OFFSET(0xAB088A0)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK__REMOVENOTIFY_OFFSET UNITYSDK_OFFSET(0xAB08690)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK__WAITBACKGROUNDTALKFINISH_OFFSET UNITYSDK_OFFSET(0xAB08550)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK__WAITMISSIONTALKFINISH_OFFSET UNITYSDK_OFFSET(0xAB085C0)
