...
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESSUPPERGROUP_METHOD_3_42E81117D20917AE_OFFSET UNITYSDK_OFFSET(0x169BD020)
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESSUPPERGROUP_METHOD_3_FDAF493017918F69_OFFSET UNITYSDK_OFFSET(0x169BD2B0)
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESSUPPERGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x169BD010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIPostProcessUpperGroup_TypeDefinitionIndex = 14143;
