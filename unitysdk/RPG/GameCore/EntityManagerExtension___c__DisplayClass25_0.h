...
#define RPG_GAMECORE_ENTITYMANAGEREXTENSION___C__DISPLAYCLASS25_0__CLIENTCREATESTORYNPCENTITY_B__0_OFFSET UNITYSDK_OFFSET(0xFE0B650)
#define RPG_GAMECORE_ENTITYMANAGEREXTENSION___C__DISPLAYCLASS25_0__CLIENTCREATESTORYNPCENTITY_B__1_OFFSET UNITYSDK_OFFSET(0xFE0B880)
#define RPG_GAMECORE_ENTITYMANAGEREXTENSION___C__DISPLAYCLASS25_0__CLIENTCREATESTORYNPCENTITY_B__2_OFFSET UNITYSDK_OFFSET(0xFE0B8D0)
#define RPG_GAMECORE_ENTITYMANAGEREXTENSION___C__DISPLAYCLASS25_0__CTOR_OFFSET UNITYSDK_OFFSET(0xFE0B640)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::StoryCharacterRow* storyCharacterRow; // 0x20
		::Il2CppArray<::System::String*>* overrideReplaceMaterialKeyList; // 0x28
