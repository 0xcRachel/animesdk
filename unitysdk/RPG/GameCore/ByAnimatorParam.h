...
#define RPG_GAMECORE_BYANIMATORPARAM_METHOD_4_3E8F49C8E4B91C8D_OFFSET UNITYSDK_OFFSET(0x168FDA80)
#define RPG_GAMECORE_BYANIMATORPARAM_METHOD_4_71E6FB3E7E9E59D3_OFFSET UNITYSDK_OFFSET(0x168FDB50)
#define RPG_GAMECORE_BYANIMATORPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x168FDB00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByAnimatorParam_TypeDefinitionIndex = 18604;
