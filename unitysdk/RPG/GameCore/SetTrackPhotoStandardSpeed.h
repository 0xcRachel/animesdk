...
#define RPG_GAMECORE_SETTRACKPHOTOSTANDARDSPEED_METHOD_3_9A65B1F8FF91E5CE_OFFSET UNITYSDK_OFFSET(0x1A7A2830)
#define RPG_GAMECORE_SETTRACKPHOTOSTANDARDSPEED_METHOD_3_C93933A9063A72E2_OFFSET UNITYSDK_OFFSET(0x1A7A27B0)
#define RPG_GAMECORE_SETTRACKPHOTOSTANDARDSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7A2800)
