...
#define RPG_GAMECORE_BYCOMPAREMISSIONBATTLEWIN_METHOD_4_852EDC28F80B8366_OFFSET UNITYSDK_OFFSET(0x17022BC0)
#define RPG_GAMECORE_BYCOMPAREMISSIONBATTLEWIN_METHOD_4_9FAC217C9534A2E4_OFFSET UNITYSDK_OFFSET(0x17022C90)
#define RPG_GAMECORE_BYCOMPAREMISSIONBATTLEWIN__CTOR_OFFSET UNITYSDK_OFFSET(0x17022C40)
