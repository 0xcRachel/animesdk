...
#define RPG_GAMECORE_BYCOMPAREROGUEROOMSTATE_METHOD_4_EC848F924E419344_OFFSET UNITYSDK_OFFSET(0x19ACFD60)
#define RPG_GAMECORE_BYCOMPAREROGUEROOMSTATE_METHOD_4_ED5CF0421C325FCD_OFFSET UNITYSDK_OFFSET(0x19ACFC90)
#define RPG_GAMECORE_BYCOMPAREROGUEROOMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19ACFD10)
