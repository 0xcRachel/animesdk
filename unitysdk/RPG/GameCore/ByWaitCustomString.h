...
#define RPG_GAMECORE_BYWAITCUSTOMSTRING_METHOD_4_1F03EC93448E2C06_OFFSET UNITYSDK_OFFSET(0x16941F70)
#define RPG_GAMECORE_BYWAITCUSTOMSTRING_METHOD_4_FAD85F4FFF311BD8_OFFSET UNITYSDK_OFFSET(0x16941EA0)
#define RPG_GAMECORE_BYWAITCUSTOMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x16941F20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByWaitCustomString_TypeDefinitionIndex = 19329;
