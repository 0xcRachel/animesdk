...
#define RPG_GAMECORE_DAMAGEDISPLAYDATA_METHOD_2_56AE97AD92E6CF6E_OFFSET UNITYSDK_OFFSET(0x19B2A3F0)
#define RPG_GAMECORE_DAMAGEDISPLAYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19B2A9A0)
