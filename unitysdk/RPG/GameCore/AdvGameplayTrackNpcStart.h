...
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPCSTART_METHOD_3_0A5CFC36F2C044BE_OFFSET UNITYSDK_OFFSET(0x18DC6950)
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPCSTART_METHOD_3_2689B526D43AA5AA_OFFSET UNITYSDK_OFFSET(0x18DC6A60)
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPCSTART__CTOR_OFFSET UNITYSDK_OFFSET(0x18DC6A30)
