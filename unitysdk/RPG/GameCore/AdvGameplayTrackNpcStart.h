...
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPCSTART_METHOD_3_0A5CFC36F2C044BE_OFFSET UNITYSDK_OFFSET(0x16837C00)
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPCSTART_METHOD_3_2689B526D43AA5AA_OFFSET UNITYSDK_OFFSET(0x16837D10)
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPCSTART__CTOR_OFFSET UNITYSDK_OFFSET(0x16837CE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvGameplayTrackNpcStart_TypeDefinitionIndex = 19834;
