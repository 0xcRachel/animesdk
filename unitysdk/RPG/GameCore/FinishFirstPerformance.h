...
#define RPG_GAMECORE_FINISHFIRSTPERFORMANCE_METHOD_3_E0171A06E9FE6AAE_OFFSET UNITYSDK_OFFSET(0x16AA6690)
#define RPG_GAMECORE_FINISHFIRSTPERFORMANCE_METHOD_3_E45C46042F306CCF_OFFSET UNITYSDK_OFFSET(0x16AA6710)
#define RPG_GAMECORE_FINISHFIRSTPERFORMANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x16AA66E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FinishFirstPerformance_TypeDefinitionIndex = 18876;
