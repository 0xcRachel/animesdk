...
#define RPG_GAMECORE_TRYCANCELENTERREGION_METHOD_3_6CB2664263ABAAAC_OFFSET UNITYSDK_OFFSET(0x19121790)
#define RPG_GAMECORE_TRYCANCELENTERREGION_METHOD_3_F6D874473C25E338_OFFSET UNITYSDK_OFFSET(0x191218A0)
#define RPG_GAMECORE_TRYCANCELENTERREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x19121870)
