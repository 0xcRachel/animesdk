...
#define RPG_GAMECORE_ROGUETOURNBUFFROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x176726B0)
#define RPG_GAMECORE_ROGUETOURNBUFFROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17672FE0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::RogueBuffCategory RogueBuffCategory; // 0x18
		::System::UInt32 AeonID; // 0x1C
		::System::UInt32 MazeBuffLevel; // 0x20
		::System::UInt32 RogueBuffTag; // 0x24
