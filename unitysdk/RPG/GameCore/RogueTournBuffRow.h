...
#define RPG_GAMECORE_ROGUETOURNBUFFROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x193FB9C0)
#define RPG_GAMECORE_ROGUETOURNBUFFROW__CTOR_OFFSET UNITYSDK_OFFSET(0x193FC320)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 MazeBuffLevel; // 0x34
