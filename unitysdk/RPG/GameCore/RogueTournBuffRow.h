...
#define RPG_GAMECORE_ROGUETOURNBUFFROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x198297C0)
#define RPG_GAMECORE_ROGUETOURNBUFFROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1982A130)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 RogueBuffTag; // 0x1C
		::System::UInt32 AeonID; // 0x20
		::System::UInt32 RogueBuffType; // 0x24
		::System::Boolean IsInHandbook; // 0x28
