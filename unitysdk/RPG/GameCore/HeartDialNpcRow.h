...
#define RPG_GAMECORE_HEARTDIALNPCROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18A67070)
#define RPG_GAMECORE_HEARTDIALNPCROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18A67270)
