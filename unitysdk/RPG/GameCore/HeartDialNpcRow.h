...
#define RPG_GAMECORE_HEARTDIALNPCROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B5EC80)
#define RPG_GAMECORE_HEARTDIALNPCROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B5EE80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HeartDialNpcRow_TypeDefinitionIndex = 12488;

	class HeartDialNpcRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* ScriptIDList; // 0x10
		::System::UInt32 DefaultScriptID; // 0x18
