...
#define RPG_GAMECORE_HEARTDIALNPCROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x172AD360)
#define RPG_GAMECORE_HEARTDIALNPCROW__CTOR_OFFSET UNITYSDK_OFFSET(0x172AD560)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 DefaultScriptID; // 0x20
