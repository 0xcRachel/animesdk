...
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP_BINDOVERRIDESKILLS_OFFSET UNITYSDK_OFFSET(0x172670C0)
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP_BIND_OFFSET UNITYSDK_OFFSET(0x172671A0)
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP_CLEAR_OFFSET UNITYSDK_OFFSET(0x17267080)
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP_GETAVATARSTARROW_OFFSET UNITYSDK_OFFSET(0x17267320)
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP_GETID_OFFSET UNITYSDK_OFFSET(0x172673C0)
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP_GETRARITY_OFFSET UNITYSDK_OFFSET(0x17267400)
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP_GETSTARPROPERTYVALUES_OFFSET UNITYSDK_OFFSET(0x172673E0)
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP_GETSTAR_OFFSET UNITYSDK_OFFSET(0x172673B0)
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP_GET_ALLBACKENDRANKIDLIST_OFFSET UNITYSDK_OFFSET(0x172674B0)
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP_GET_ASBACKAVATAR_OFFSET UNITYSDK_OFFSET(0x17267360)
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP_GET_INHERITEDSKILLLIST_OFFSET UNITYSDK_OFFSET(0x17267470)
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP_GET_ISVALIDGRIDFIGHTAVATAR_OFFSET UNITYSDK_OFFSET(0x172672F0)
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP_GET_JSONPATH_OFFSET UNITYSDK_OFFSET(0x17267420)
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP_GET_MGRREF_OFFSET UNITYSDK_OFFSET(0x172672D0)
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP_GET_SKILLLIST_OFFSET UNITYSDK_OFFSET(0x17267370)
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP_GET__ASFRONTAVATAR_OFFSET UNITYSDK_OFFSET(0x17267170)
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP_SET_MGRREF_OFFSET UNITYSDK_OFFSET(0x172672E0)
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP__CTOR_OFFSET UNITYSDK_OFFSET(0x172674D0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::GridFightRoleStarConfigRow* _GridFightStarRow; // 0x48
