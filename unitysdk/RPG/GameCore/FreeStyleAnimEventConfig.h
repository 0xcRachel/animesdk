...
#define RPG_GAMECORE_FREESTYLEANIMEVENTCONFIG_METHOD_2_20C1AF289355777B_OFFSET UNITYSDK_OFFSET(0x172333F0)
#define RPG_GAMECORE_FREESTYLEANIMEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17233670)
