...
#define RPG_GAMECORE_BYCHECKTRIALCHARACTERDIE_METHOD_4_6DF8962DB4E5015B_OFFSET UNITYSDK_OFFSET(0x195FF210)
#define RPG_GAMECORE_BYCHECKTRIALCHARACTERDIE_METHOD_4_A6D25909D8706D7A_OFFSET UNITYSDK_OFFSET(0x195FEFD0)
#define RPG_GAMECORE_BYCHECKTRIALCHARACTERDIE_METHOD_4_D2DC705C7257DFD8_OFFSET UNITYSDK_OFFSET(0x195FF0A0)
#define RPG_GAMECORE_BYCHECKTRIALCHARACTERDIE_METHOD_4_FC2BA87B00CA8003_OFFSET UNITYSDK_OFFSET(0x195FF290)
#define RPG_GAMECORE_BYCHECKTRIALCHARACTERDIE__CTOR_OFFSET UNITYSDK_OFFSET(0x195FF050)
