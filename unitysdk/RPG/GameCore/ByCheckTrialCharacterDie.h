...
#define RPG_GAMECORE_BYCHECKTRIALCHARACTERDIE_METHOD_4_A6D25909D8706D7A_OFFSET UNITYSDK_OFFSET(0x187D45A0)
#define RPG_GAMECORE_BYCHECKTRIALCHARACTERDIE_METHOD_4_D2DC705C7257DFD8_OFFSET UNITYSDK_OFFSET(0x19ABBE00)
#define RPG_GAMECORE_BYCHECKTRIALCHARACTERDIE__CTOR_OFFSET UNITYSDK_OFFSET(0x19ABBF70)
