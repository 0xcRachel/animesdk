...
#define RPG_GAMECORE_SETUPTRAINVISITORDIALOGUE_METHOD_3_53B263736309CEEC_OFFSET UNITYSDK_OFFSET(0x16F45300)
#define RPG_GAMECORE_SETUPTRAINVISITORDIALOGUE_METHOD_3_E53F1949CBEDF678_OFFSET UNITYSDK_OFFSET(0x16F45410)
#define RPG_GAMECORE_SETUPTRAINVISITORDIALOGUE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F453E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetUpTrainVisitorDialogue_TypeDefinitionIndex = 19228;
