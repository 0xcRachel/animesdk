...
#define RPG_GAMECORE_SETUPTRAINVISITORDIALOGUE_METHOD_3_53B263736309CEEC_OFFSET UNITYSDK_OFFSET(0x19393220)
#define RPG_GAMECORE_SETUPTRAINVISITORDIALOGUE_METHOD_3_E53F1949CBEDF678_OFFSET UNITYSDK_OFFSET(0x19393330)
#define RPG_GAMECORE_SETUPTRAINVISITORDIALOGUE__CTOR_OFFSET UNITYSDK_OFFSET(0x19393300)
