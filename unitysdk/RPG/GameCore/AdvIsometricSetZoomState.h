...
#define RPG_GAMECORE_ADVISOMETRICSETZOOMSTATE_METHOD_3_0F03CFA9FAC9C2BC_OFFSET UNITYSDK_OFFSET(0x16839190)
#define RPG_GAMECORE_ADVISOMETRICSETZOOMSTATE_METHOD_3_A6C886A518863B4D_OFFSET UNITYSDK_OFFSET(0x16839110)
#define RPG_GAMECORE_ADVISOMETRICSETZOOMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16839160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvIsometricSetZoomState_TypeDefinitionIndex = 19864;
