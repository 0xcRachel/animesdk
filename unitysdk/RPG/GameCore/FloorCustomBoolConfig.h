...
#define RPG_GAMECORE_FLOORCUSTOMBOOLCONFIG_METHOD_3_87574FA4538422F7_OFFSET UNITYSDK_OFFSET(0x1A3AD9B0)
#define RPG_GAMECORE_FLOORCUSTOMBOOLCONFIG_METHOD_3_94F8B170AD1A93B8_OFFSET UNITYSDK_OFFSET(0x1A3ADB80)
#define RPG_GAMECORE_FLOORCUSTOMBOOLCONFIG_METHOD_3_A49EDBC7812C3FBB_OFFSET UNITYSDK_OFFSET(0x1A3ADB50)
#define RPG_GAMECORE_FLOORCUSTOMBOOLCONFIG_METHOD_3_DC6F62D6D4E71DC8_OFFSET UNITYSDK_OFFSET(0x1A3AD9F0)
#define RPG_GAMECORE_FLOORCUSTOMBOOLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3AD9E0)
