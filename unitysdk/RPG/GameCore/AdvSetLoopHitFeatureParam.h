...
#define RPG_GAMECORE_ADVSETLOOPHITFEATUREPARAM_METHOD_3_57433113977ACC7F_OFFSET UNITYSDK_OFFSET(0x18C5B720)
#define RPG_GAMECORE_ADVSETLOOPHITFEATUREPARAM_METHOD_3_712674993A71D23B_OFFSET UNITYSDK_OFFSET(0x18C5B6A0)
#define RPG_GAMECORE_ADVSETLOOPHITFEATUREPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x18C5B6F0)
