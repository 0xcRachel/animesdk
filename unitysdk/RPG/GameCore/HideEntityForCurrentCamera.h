...
#define RPG_GAMECORE_HIDEENTITYFORCURRENTCAMERA_METHOD_3_7824063315A2E90B_OFFSET UNITYSDK_OFFSET(0x172BDB40)
#define RPG_GAMECORE_HIDEENTITYFORCURRENTCAMERA_METHOD_3_F77749131CA6DFE2_OFFSET UNITYSDK_OFFSET(0x172BDBC0)
#define RPG_GAMECORE_HIDEENTITYFORCURRENTCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x172BDB90)
