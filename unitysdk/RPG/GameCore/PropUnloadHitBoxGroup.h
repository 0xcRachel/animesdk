...
#define RPG_GAMECORE_PROPUNLOADHITBOXGROUP_METHOD_3_6F804EACBCA5C1D9_OFFSET UNITYSDK_OFFSET(0x17586830)
#define RPG_GAMECORE_PROPUNLOADHITBOXGROUP_METHOD_3_F971C0CBAAFE6D97_OFFSET UNITYSDK_OFFSET(0x175866E0)
#define RPG_GAMECORE_PROPUNLOADHITBOXGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x175867A0)
