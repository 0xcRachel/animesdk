...
#define RPG_GAMECORE_PHASEVALUEACTIONPAIRSERIALIZATION_METHOD_2_104C5DCA44A4D120_OFFSET UNITYSDK_OFFSET(0x16D306A0)
#define RPG_GAMECORE_PHASEVALUEACTIONPAIRSERIALIZATION__CTOR_OFFSET UNITYSDK_OFFSET(0x16D30760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhaseValueActionPairSerialization_TypeDefinitionIndex = 17208;
