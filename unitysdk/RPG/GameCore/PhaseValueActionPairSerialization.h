...
#define RPG_GAMECORE_PHASEVALUEACTIONPAIRSERIALIZATION_METHOD_2_104C5DCA44A4D120_OFFSET UNITYSDK_OFFSET(0x174B86D0)
#define RPG_GAMECORE_PHASEVALUEACTIONPAIRSERIALIZATION__CTOR_OFFSET UNITYSDK_OFFSET(0x174B8790)
