...
#define RPG_GAMECORE_WAITENTITYEVENTV2_METHOD_4_5C2FF6FE759F279F_OFFSET UNITYSDK_OFFSET(0x171506B0)
#define RPG_GAMECORE_WAITENTITYEVENTV2_METHOD_4_E78BB0D8423A99E9_OFFSET UNITYSDK_OFFSET(0x171505D0)
#define RPG_GAMECORE_WAITENTITYEVENTV2__CTOR_OFFSET UNITYSDK_OFFSET(0x17150650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitEntityEventV2_TypeDefinitionIndex = 18521;
