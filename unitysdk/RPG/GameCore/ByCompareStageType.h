...
#define RPG_GAMECORE_BYCOMPARESTAGETYPE_METHOD_4_CC249D221517F756_OFFSET UNITYSDK_OFFSET(0x1691B840)
#define RPG_GAMECORE_BYCOMPARESTAGETYPE_METHOD_4_E36DFD7C7BB65228_OFFSET UNITYSDK_OFFSET(0x1691B770)
#define RPG_GAMECORE_BYCOMPARESTAGETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1691B7F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareStageType_TypeDefinitionIndex = 20717;
