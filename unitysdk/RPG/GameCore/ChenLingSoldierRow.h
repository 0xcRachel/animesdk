...
#define RPG_GAMECORE_CHENLINGSOLDIERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x196AAAB0)
#define RPG_GAMECORE_CHENLINGSOLDIERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x196AB050)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* AtkSkillIDList; // 0x18
		::System::String* SmallIconOutlinePath; // 0x20
		...
		::RPG::GameCore::ChenLingBattleInitPosition Position; // 0x78
