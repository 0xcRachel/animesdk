...
#define RPG_GAMECORE_CHENLINGSOLDIERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1709D210)
#define RPG_GAMECORE_CHENLINGSOLDIERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1709D7B0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 PromotionEffectID; // 0x80
