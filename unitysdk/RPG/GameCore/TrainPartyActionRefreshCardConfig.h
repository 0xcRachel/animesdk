...
#define RPG_GAMECORE_TRAINPARTYACTIONREFRESHCARDCONFIG_METHOD_5_129C1C071DF9A7A2_OFFSET UNITYSDK_OFFSET(0x194917E0)
#define RPG_GAMECORE_TRAINPARTYACTIONREFRESHCARDCONFIG_METHOD_5_D00C966B231B9AAB_OFFSET UNITYSDK_OFFSET(0x19491A90)
#define RPG_GAMECORE_TRAINPARTYACTIONREFRESHCARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19491790)
