...
#define RPG_GAMECORE_TOASTLOCKFUNCTION_METHOD_3_08F425259BC92574_OFFSET UNITYSDK_OFFSET(0x170F8170)
#define RPG_GAMECORE_TOASTLOCKFUNCTION_METHOD_3_2EE9E16E346192F5_OFFSET UNITYSDK_OFFSET(0x170F80F0)
#define RPG_GAMECORE_TOASTLOCKFUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x170F8140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ToastLockFunction_TypeDefinitionIndex = 18074;
