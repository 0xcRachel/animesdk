...
#define RPG_GAMECORE_AETHERDIVIDEPASSIVESKILLROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18AB9230)
#define RPG_GAMECORE_AETHERDIVIDEPASSIVESKILLROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18AB9B00)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::String* PassiveSkillDescription; // 0x10
		...
		::System::String* ItemDescription; // 0x30
