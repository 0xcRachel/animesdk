...
#define RPG_GAMECORE_REMOVEVIDEOSEQUENCE_METHOD_3_20E789A6A4C57088_OFFSET UNITYSDK_OFFSET(0x16DE1480)
#define RPG_GAMECORE_REMOVEVIDEOSEQUENCE_METHOD_3_C1892E798CA7AB7E_OFFSET UNITYSDK_OFFSET(0x16DE1400)
#define RPG_GAMECORE_REMOVEVIDEOSEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x16DE1450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveVideoSequence_TypeDefinitionIndex = 19565;
