...
#define RPG_GAMECORE_BYCONTAINCUSTOMSTRING_METHOD_4_0DB5927DFECDAAB4_OFFSET UNITYSDK_OFFSET(0x19AD8060)
#define RPG_GAMECORE_BYCONTAINCUSTOMSTRING_METHOD_4_6ADCD44BF1300457_OFFSET UNITYSDK_OFFSET(0x19AD8180)
#define RPG_GAMECORE_BYCONTAINCUSTOMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD8100)
