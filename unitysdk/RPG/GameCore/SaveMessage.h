...
#define RPG_GAMECORE_SAVEMESSAGE_METHOD_3_5126076E00495685_OFFSET UNITYSDK_OFFSET(0x176AEBD0)
#define RPG_GAMECORE_SAVEMESSAGE_METHOD_3_A4331D6A922EFAC4_OFFSET UNITYSDK_OFFSET(0x176AEC50)
#define RPG_GAMECORE_SAVEMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x176AEC20)
