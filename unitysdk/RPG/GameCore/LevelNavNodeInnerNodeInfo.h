...
#define RPG_GAMECORE_LEVELNAVNODEINNERNODEINFO_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x16BB0E10)
#define RPG_GAMECORE_LEVELNAVNODEINNERNODEINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16BB0CD0)
#define RPG_GAMECORE_LEVELNAVNODEINNERNODEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16BB0CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelNavNodeInnerNodeInfo_TypeDefinitionIndex = 15468;
