...
#define RPG_GAMECORE_BATTLESCORINGCHANGEPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0xA899490)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::Single DisplayModifyValue; // 0x10
		::System::UInt32 ScoringId; // 0x14
		::RPG::GameCore::PropertyModifyFunction ModifyFunction; // 0x18
		::System::Single DisplayNewScore; // 0x1C
		::System::Single ModifyValue; // 0x20
