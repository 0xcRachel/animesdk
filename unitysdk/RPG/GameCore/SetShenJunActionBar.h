...
#define RPG_GAMECORE_SETSHENJUNACTIONBAR_METHOD_3_46393CC2A5BF6A2E_OFFSET UNITYSDK_OFFSET(0x176F1AC0)
#define RPG_GAMECORE_SETSHENJUNACTIONBAR_METHOD_3_9679308B6CC9BDF9_OFFSET UNITYSDK_OFFSET(0x176F1A40)
#define RPG_GAMECORE_SETSHENJUNACTIONBAR__CTOR_OFFSET UNITYSDK_OFFSET(0x176F1A90)
