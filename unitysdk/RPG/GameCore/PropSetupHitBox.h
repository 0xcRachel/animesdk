...
#define RPG_GAMECORE_PROPSETUPHITBOX_METHOD_3_038E2E800516BD94_OFFSET UNITYSDK_OFFSET(0x16DB37A0)
#define RPG_GAMECORE_PROPSETUPHITBOX_METHOD_3_2BE445F52EE76510_OFFSET UNITYSDK_OFFSET(0x16DB3900)
#define RPG_GAMECORE_PROPSETUPHITBOX__CTOR_OFFSET UNITYSDK_OFFSET(0x16DB3860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropSetupHitBox_TypeDefinitionIndex = 18168;
