...
#define RPG_GAMECORE_SETEFFECTANIMATORTRIGGER_METHOD_3_C0662E5A8A1D14A6_OFFSET UNITYSDK_OFFSET(0x199B06E0)
#define RPG_GAMECORE_SETEFFECTANIMATORTRIGGER_METHOD_3_E9532BFCB05269D7_OFFSET UNITYSDK_OFFSET(0x199B0760)
#define RPG_GAMECORE_SETEFFECTANIMATORTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x199B0730)
