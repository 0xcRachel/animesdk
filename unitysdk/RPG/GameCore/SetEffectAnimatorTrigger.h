...
#define RPG_GAMECORE_SETEFFECTANIMATORTRIGGER_METHOD_3_C0662E5A8A1D14A6_OFFSET UNITYSDK_OFFSET(0x16F28A50)
#define RPG_GAMECORE_SETEFFECTANIMATORTRIGGER_METHOD_3_E9532BFCB05269D7_OFFSET UNITYSDK_OFFSET(0x16F28AD0)
#define RPG_GAMECORE_SETEFFECTANIMATORTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x16F28AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetEffectAnimatorTrigger_TypeDefinitionIndex = 20537;
