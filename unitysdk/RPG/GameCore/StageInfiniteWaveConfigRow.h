...
#define RPG_GAMECORE_STAGEINFINITEWAVECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1933C2E0)
#define RPG_GAMECORE_STAGEINFINITEWAVECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1933C5C0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Int32 MaxMonsterCount; // 0x34
