...
#define RPG_GAMECORE_WAITROGUEPICKAVATAR_METHOD_3_8A565AD67D8BB032_OFFSET UNITYSDK_OFFSET(0x1715ACD0)
#define RPG_GAMECORE_WAITROGUEPICKAVATAR_METHOD_3_E183080DA2038A32_OFFSET UNITYSDK_OFFSET(0x1715AD60)
#define RPG_GAMECORE_WAITROGUEPICKAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1715AD30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRoguePickAvatar_TypeDefinitionIndex = 18267;
