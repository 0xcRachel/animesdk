...
#define RPG_GAMECORE_ITEMCOMPOSECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18E4CC90)
#define RPG_GAMECORE_ITEMCOMPOSECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18E4D770)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* RelicList; // 0x30
		::System::UInt32 LimitValue; // 0x38
		::System::UInt32 ItemID; // 0x3C
		::RPG::GameCore::FormulaType FormulaType; // 0x40
		::System::Boolean IsShowHoldNumber; // 0x44
		::System::Boolean IsCanAcceleratedCompose; // 0x45
		...
		::RPG::GameCore::ItemComposeFuncType FuncType; // 0x5C
