...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYMAGICUNITRATIOBYCNTCONFIG_METHOD_3_A06595649527DE07_OFFSET UNITYSDK_OFFSET(0x1A4FFD60)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYMAGICUNITRATIOBYCNTCONFIG_METHOD_3_BF698B981E1C109E_OFFSET UNITYSDK_OFFSET(0x1A4FFE30)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYMAGICUNITRATIOBYCNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4FFDE0)
