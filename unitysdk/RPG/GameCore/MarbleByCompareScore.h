...
#define RPG_GAMECORE_MARBLEBYCOMPARESCORE_METHOD_4_71DFF150290C8362_OFFSET UNITYSDK_OFFSET(0x16C39390)
#define RPG_GAMECORE_MARBLEBYCOMPARESCORE_METHOD_4_D1EAB2E7744EC29F_OFFSET UNITYSDK_OFFSET(0x16C392B0)
#define RPG_GAMECORE_MARBLEBYCOMPARESCORE__CTOR_OFFSET UNITYSDK_OFFSET(0x16C39340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleByCompareScore_TypeDefinitionIndex = 15210;
