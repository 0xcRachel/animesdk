...
#define RPG_GAMECORE_PIXAIRRECOMMENDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19D436A0)
#define RPG_GAMECORE_PIXAIRRECOMMENDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19D43910)
