...
#define RPG_GAMECORE_FIVEDIMLEVELCAMERACONFIG_METHOD_4_2727BF0127F100A9_OFFSET UNITYSDK_OFFSET(0x199F5F40)
#define RPG_GAMECORE_FIVEDIMLEVELCAMERACONFIG_METHOD_4_6EF575EEFEE4E427_OFFSET UNITYSDK_OFFSET(0x199DB4C0)
#define RPG_GAMECORE_FIVEDIMLEVELCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x199DB480)
