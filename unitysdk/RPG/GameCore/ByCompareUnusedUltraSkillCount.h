...
#define RPG_GAMECORE_BYCOMPAREUNUSEDULTRASKILLCOUNT_METHOD_4_36EDF92C14D0D116_OFFSET UNITYSDK_OFFSET(0x18FFBC90)
#define RPG_GAMECORE_BYCOMPAREUNUSEDULTRASKILLCOUNT_METHOD_4_40A66FA5407AC08F_OFFSET UNITYSDK_OFFSET(0x18FFC070)
#define RPG_GAMECORE_BYCOMPAREUNUSEDULTRASKILLCOUNT_METHOD_4_7C659619090240F0_OFFSET UNITYSDK_OFFSET(0x18FFBD60)
#define RPG_GAMECORE_BYCOMPAREUNUSEDULTRASKILLCOUNT_METHOD_4_B7B41409FA4C4468_OFFSET UNITYSDK_OFFSET(0x18FFBFF0)
#define RPG_GAMECORE_BYCOMPAREUNUSEDULTRASKILLCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x18FFBD10)
