...
#define RPG_GAMECORE_STAGECONFIG_METHOD_3_1D8D7CF0E0C08194_OFFSET UNITYSDK_OFFSET(0x193383F0)
#define RPG_GAMECORE_STAGECONFIG_METHOD_3_7048059C0DA33B1C_OFFSET UNITYSDK_OFFSET(0x193375B0)
#define RPG_GAMECORE_STAGECONFIG_METHOD_3_AA3609C16455CCFE_OFFSET UNITYSDK_OFFSET(0x19335C60)
#define RPG_GAMECORE_STAGECONFIG_METHOD_3_B08C4319731B7D77_OFFSET UNITYSDK_OFFSET(0x19338430)
#define RPG_GAMECORE_STAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19335C50)
