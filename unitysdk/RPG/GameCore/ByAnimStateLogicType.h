...
#define RPG_GAMECORE_BYANIMSTATELOGICTYPE_METHOD_4_01C90884FDEE5FEA_OFFSET UNITYSDK_OFFSET(0x168FD790)
#define RPG_GAMECORE_BYANIMSTATELOGICTYPE_METHOD_4_8193A95F61FFFA39_OFFSET UNITYSDK_OFFSET(0x168FD8B0)
#define RPG_GAMECORE_BYANIMSTATELOGICTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x168FD830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByAnimStateLogicType_TypeDefinitionIndex = 20076;
