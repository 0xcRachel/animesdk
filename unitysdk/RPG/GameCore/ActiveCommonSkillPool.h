...
#define RPG_GAMECORE_ACTIVECOMMONSKILLPOOL_METHOD_3_28374D3EB610E7D1_OFFSET UNITYSDK_OFFSET(0x1677DDA0)
#define RPG_GAMECORE_ACTIVECOMMONSKILLPOOL_METHOD_3_2F0F649A86112778_OFFSET UNITYSDK_OFFSET(0x1677DE20)
#define RPG_GAMECORE_ACTIVECOMMONSKILLPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1677DDF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActiveCommonSkillPool_TypeDefinitionIndex = 20956;
