...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEVALUE_METHOD_3_6B5B2BBA448ECAB5_OFFSET UNITYSDK_OFFSET(0x1A32A3A0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEVALUE_METHOD_3_E1B31863A9FD3D00_OFFSET UNITYSDK_OFFSET(0x1A32BB10)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A32A380)
