...
#define RPG_GAMECORE_GRIDFIGHTMANAGER_WAVEKILLRECORDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA43FD70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightManager_WaveKillRecordData_TypeDefinitionIndex = 43959;
