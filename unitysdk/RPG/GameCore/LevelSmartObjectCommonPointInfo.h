...
#define RPG_GAMECORE_LEVELSMARTOBJECTCOMMONPOINTINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16BBD320)
#define RPG_GAMECORE_LEVELSMARTOBJECTCOMMONPOINTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16BBD520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelSmartObjectCommonPointInfo_TypeDefinitionIndex = 15677;
