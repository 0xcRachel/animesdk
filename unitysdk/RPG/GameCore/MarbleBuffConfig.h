...
#define RPG_GAMECORE_MARBLEBUFFCONFIG_METHOD_2_065CC8A25FF1E45C_OFFSET UNITYSDK_OFFSET(0x16C378D0)
#define RPG_GAMECORE_MARBLEBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16C37C40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleBuffConfig_TypeDefinitionIndex = 15217;
