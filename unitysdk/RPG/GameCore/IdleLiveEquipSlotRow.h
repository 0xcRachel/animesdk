...
#define RPG_GAMECORE_IDLELIVEEQUIPSLOTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19AD62B0)
#define RPG_GAMECORE_IDLELIVEEQUIPSLOTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD64D0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::IdleLiveEquipType Type; // 0x28
