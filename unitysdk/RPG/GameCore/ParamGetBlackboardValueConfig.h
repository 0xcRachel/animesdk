...
#define RPG_GAMECORE_PARAMGETBLACKBOARDVALUECONFIG_METHOD_4_2F453A2B930008BB_OFFSET UNITYSDK_OFFSET(0x1749DD90)
#define RPG_GAMECORE_PARAMGETBLACKBOARDVALUECONFIG_METHOD_4_EC9BF41640BBDD52_OFFSET UNITYSDK_OFFSET(0x1749DB90)
#define RPG_GAMECORE_PARAMGETBLACKBOARDVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1749DD10)
