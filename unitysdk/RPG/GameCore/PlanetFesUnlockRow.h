...
#define RPG_GAMECORE_PLANETFESUNLOCKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18B354D0)
#define RPG_GAMECORE_PLANETFESUNLOCKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18B35690)
