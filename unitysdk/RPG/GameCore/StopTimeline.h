...
#define RPG_GAMECORE_STOPTIMELINE_METHOD_3_068A44B628BAA65C_OFFSET UNITYSDK_OFFSET(0x17792C00)
#define RPG_GAMECORE_STOPTIMELINE_METHOD_3_515903F8FCB84DED_OFFSET UNITYSDK_OFFSET(0x17792C80)
#define RPG_GAMECORE_STOPTIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x17792C50)
