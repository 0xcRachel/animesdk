...
#define RPG_GAMECORE_STOPTIMELINE_METHOD_3_068A44B628BAA65C_OFFSET UNITYSDK_OFFSET(0x16F9F0C0)
#define RPG_GAMECORE_STOPTIMELINE_METHOD_3_515903F8FCB84DED_OFFSET UNITYSDK_OFFSET(0x16F9F140)
#define RPG_GAMECORE_STOPTIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F9F110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StopTimeline_TypeDefinitionIndex = 18417;
