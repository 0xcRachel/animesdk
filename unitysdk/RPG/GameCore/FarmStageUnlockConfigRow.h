...
#define RPG_GAMECORE_FARMSTAGEUNLOCKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x171D3760)
#define RPG_GAMECORE_FARMSTAGEUNLOCKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x171D45A0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* FarmGachaIDList; // 0x18
		::System::String* UIEntranceBgPath; // 0x20
		::System::UInt32 UIEntranceParam; // 0x28
		...
		::System::UInt32 UnlockWorldLevelEnd; // 0x38
		::System::UInt32 ID; // 0x3C
		::System::UInt32 UIEnterBattleArea; // 0x40
		::RPG::GameCore::FarmTypeConfig FarmType; // 0x44
