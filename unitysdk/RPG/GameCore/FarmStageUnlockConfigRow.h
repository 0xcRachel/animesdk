...
#define RPG_GAMECORE_FARMSTAGEUNLOCKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1946E320)
#define RPG_GAMECORE_FARMSTAGEUNLOCKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1946F160)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 OpenInAdvanceLimitUnlockID; // 0x34
		::System::UInt32 UnlockWorldLevelEnd; // 0x38
		::System::UInt32 UnlockWorldLevelStart; // 0x3C
