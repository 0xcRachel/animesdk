...
#define RPG_GAMECORE_FARMSTAGEUNLOCKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16A8FBD0)
#define RPG_GAMECORE_FARMSTAGEUNLOCKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16A909F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FarmStageUnlockConfigRow_TypeDefinitionIndex = 11390;
	...
	public:
		...
		::System::UInt32 UnlockWorldLevelStart; // 0x38
		::System::UInt32 ID; // 0x3C
		::RPG::GameCore::FarmTypeConfig FarmType; // 0x40
		::System::UInt32 OpenInAdvanceLimitUnlockID; // 0x44
