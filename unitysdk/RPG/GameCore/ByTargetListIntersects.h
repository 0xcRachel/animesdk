...
#define RPG_GAMECORE_BYTARGETLISTINTERSECTS_METHOD_4_5D555C30D15ED682_OFFSET UNITYSDK_OFFSET(0x1693FE70)
#define RPG_GAMECORE_BYTARGETLISTINTERSECTS_METHOD_4_D977D4831AB3605C_OFFSET UNITYSDK_OFFSET(0x1693FD90)
#define RPG_GAMECORE_BYTARGETLISTINTERSECTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1693FE10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByTargetListIntersects_TypeDefinitionIndex = 21515;
