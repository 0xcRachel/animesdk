...
#define RPG_GAMECORE_BYTARGETLISTINTERSECTS_METHOD_4_5D555C30D15ED682_OFFSET UNITYSDK_OFFSET(0x170516C0)
#define RPG_GAMECORE_BYTARGETLISTINTERSECTS_METHOD_4_D977D4831AB3605C_OFFSET UNITYSDK_OFFSET(0x170515E0)
#define RPG_GAMECORE_BYTARGETLISTINTERSECTS__CTOR_OFFSET UNITYSDK_OFFSET(0x17051660)
