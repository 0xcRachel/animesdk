...
#define RPG_GAMECORE_USESEQUENCEDSKILL_METHOD_3_620339A18E2A5DC0_OFFSET UNITYSDK_OFFSET(0x17140700)
#define RPG_GAMECORE_USESEQUENCEDSKILL_METHOD_3_6B76359F7C4F6A4C_OFFSET UNITYSDK_OFFSET(0x17140810)
#define RPG_GAMECORE_USESEQUENCEDSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x171407E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UseSequencedSkill_TypeDefinitionIndex = 20090;
