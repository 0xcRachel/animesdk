...
#define RPG_GAMECORE_VE_CONST_METHOD_3_2B2754A581077985_OFFSET UNITYSDK_OFFSET(0x1951A5E0)
#define RPG_GAMECORE_VE_CONST_METHOD_3_AAE8928ED547B4F0_OFFSET UNITYSDK_OFFSET(0x1951A5A0)
#define RPG_GAMECORE_VE_CONST__CTOR_OFFSET UNITYSDK_OFFSET(0x1951A5D0)
