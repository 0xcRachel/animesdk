...
#define RPG_GAMECORE_SETUPTRAINVISITORBUBBLE_METHOD_3_0930CBE4834E1E6C_OFFSET UNITYSDK_OFFSET(0x1A7A3610)
#define RPG_GAMECORE_SETUPTRAINVISITORBUBBLE_METHOD_3_9ABD81BAEC3245F8_OFFSET UNITYSDK_OFFSET(0x1A7A3720)
#define RPG_GAMECORE_SETUPTRAINVISITORBUBBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7A36F0)
