...
#define RPG_GAMECORE_CLOCKPARKRAIDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x169AE460)
#define RPG_GAMECORE_CLOCKPARKRAIDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x169AE9F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClockParkRaidRow_TypeDefinitionIndex = 10401;
