...
#define RPG_GAMECORE_SETUSETEMPORARYLOCKTARGET_METHOD_3_A43CE4B8DC109410_OFFSET UNITYSDK_OFFSET(0x1A7A39B0)
#define RPG_GAMECORE_SETUSETEMPORARYLOCKTARGET_METHOD_3_CA244DB90EE693B2_OFFSET UNITYSDK_OFFSET(0x1A7A3A30)
#define RPG_GAMECORE_SETUSETEMPORARYLOCKTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7A3A00)
