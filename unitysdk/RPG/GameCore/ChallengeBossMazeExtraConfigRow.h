...
#define RPG_GAMECORE_CHALLENGEBOSSMAZEEXTRACONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1695B480)
#define RPG_GAMECORE_CHALLENGEBOSSMAZEEXTRACONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1695B5C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChallengeBossMazeExtraConfigRow_TypeDefinitionIndex = 11744;

	class ChallengeBossMazeExtraConfigRow : public ::System::Object
	{
	public:
		::System::UInt32 ID; // 0x10
		::System::UInt32 MonsterID1; // 0x14
