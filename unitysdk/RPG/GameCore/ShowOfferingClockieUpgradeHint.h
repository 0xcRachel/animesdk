...
#define RPG_GAMECORE_SHOWOFFERINGCLOCKIEUPGRADEHINT_METHOD_3_28004F8D694353BB_OFFSET UNITYSDK_OFFSET(0x16F5F8F0)
#define RPG_GAMECORE_SHOWOFFERINGCLOCKIEUPGRADEHINT_METHOD_3_FC36E18F5E0E2154_OFFSET UNITYSDK_OFFSET(0x16F5F970)
#define RPG_GAMECORE_SHOWOFFERINGCLOCKIEUPGRADEHINT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F5F940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowOfferingClockieUpgradeHint_TypeDefinitionIndex = 19585;
