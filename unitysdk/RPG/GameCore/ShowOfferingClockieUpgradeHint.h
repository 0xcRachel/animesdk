...
#define RPG_GAMECORE_SHOWOFFERINGCLOCKIEUPGRADEHINT_METHOD_3_28004F8D694353BB_OFFSET UNITYSDK_OFFSET(0x193ADD30)
#define RPG_GAMECORE_SHOWOFFERINGCLOCKIEUPGRADEHINT_METHOD_3_FC36E18F5E0E2154_OFFSET UNITYSDK_OFFSET(0x193ADDB0)
#define RPG_GAMECORE_SHOWOFFERINGCLOCKIEUPGRADEHINT__CTOR_OFFSET UNITYSDK_OFFSET(0x193ADD80)
