...
#define RPG_GAMECORE_ACTIVITYEVOLVEBUILDCARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1886EF80)
#define RPG_GAMECORE_ACTIVITYEVOLVEBUILDCARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1886F7A0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* ItemMiniIcon; // 0x28
