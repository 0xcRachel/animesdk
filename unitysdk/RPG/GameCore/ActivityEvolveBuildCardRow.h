...
#define RPG_GAMECORE_ACTIVITYEVOLVEBUILDCARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1989AB70)
#define RPG_GAMECORE_ACTIVITYEVOLVEBUILDCARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1989B350)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 LvID; // 0x3C
		::RPG::GameCore::EvolveBuildCardType Type; // 0x40
