...
#define RPG_GAMECORE_BYISTEAMLOCATIONINDEXTYPE_METHOD_4_433B4EB9322AAFC5_OFFSET UNITYSDK_OFFSET(0x19DB4050)
#define RPG_GAMECORE_BYISTEAMLOCATIONINDEXTYPE_METHOD_4_E6A41028857FDBD2_OFFSET UNITYSDK_OFFSET(0x19DB40D0)
#define RPG_GAMECORE_BYISTEAMLOCATIONINDEXTYPE_METHOD_4_F38CD3B43677ED7F_OFFSET UNITYSDK_OFFSET(0x19DB3DE0)
#define RPG_GAMECORE_BYISTEAMLOCATIONINDEXTYPE_METHOD_4_F8A14D41C03D8219_OFFSET UNITYSDK_OFFSET(0x19DB3D00)
#define RPG_GAMECORE_BYISTEAMLOCATIONINDEXTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x19DB3D80)
