...
#define RPG_GAMECORE_WAITAUTOTRIGGERROGUEENTRANCEPROPINTERACT_METHOD_3_00B243FAB326A679_OFFSET UNITYSDK_OFFSET(0x1714D3F0)
#define RPG_GAMECORE_WAITAUTOTRIGGERROGUEENTRANCEPROPINTERACT_METHOD_3_540E8372F44340F0_OFFSET UNITYSDK_OFFSET(0x1714D370)
#define RPG_GAMECORE_WAITAUTOTRIGGERROGUEENTRANCEPROPINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x1714D3C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitAutoTriggerRogueEntrancePropInteract_TypeDefinitionIndex = 19734;
