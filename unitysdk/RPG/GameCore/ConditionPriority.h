...
#define RPG_GAMECORE_CONDITIONPRIORITY_METHOD_2_76940A5AE2D29A23_OFFSET UNITYSDK_OFFSET(0x17140450)
#define RPG_GAMECORE_CONDITIONPRIORITY__CTOR_OFFSET UNITYSDK_OFFSET(0x17140590)
