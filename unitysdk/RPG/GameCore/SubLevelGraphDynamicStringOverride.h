...
#define RPG_GAMECORE_SUBLEVELGRAPHDYNAMICSTRINGOVERRIDE_METHOD_2_5955B31903198F09_OFFSET UNITYSDK_OFFSET(0x16FA7130)
#define RPG_GAMECORE_SUBLEVELGRAPHDYNAMICSTRINGOVERRIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FA7210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SubLevelGraphDynamicStringOverride_TypeDefinitionIndex = 18516;
