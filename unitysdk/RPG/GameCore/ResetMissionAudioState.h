...
#define RPG_GAMECORE_RESETMISSIONAUDIOSTATE_METHOD_3_817BCE334BFF49BB_OFFSET UNITYSDK_OFFSET(0x175B3000)
#define RPG_GAMECORE_RESETMISSIONAUDIOSTATE_METHOD_3_8830ADF6ADCD624A_OFFSET UNITYSDK_OFFSET(0x175B2F80)
#define RPG_GAMECORE_RESETMISSIONAUDIOSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x175B2FD0)
