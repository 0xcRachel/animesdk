...
#define RPG_GAMECORE_RTTARGETFETCHMODIFIERBINDSNAPSHOT_METHOD_4_AB0DFA14DBDF23D4_OFFSET UNITYSDK_OFFSET(0x18E8A9E0)
#define RPG_GAMECORE_RTTARGETFETCHMODIFIERBINDSNAPSHOT_METHOD_4_CE7B9868D0B819EA_OFFSET UNITYSDK_OFFSET(0x18E8A8B0)
#define RPG_GAMECORE_RTTARGETFETCHMODIFIERBINDSNAPSHOT__CTOR_OFFSET UNITYSDK_OFFSET(0x18E8A960)
