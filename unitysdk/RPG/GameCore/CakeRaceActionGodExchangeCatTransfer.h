...
#define RPG_GAMECORE_CAKERACEACTIONGODEXCHANGECATTRANSFER_METHOD_3_8F1D386CD6CBD51D_OFFSET UNITYSDK_OFFSET(0x169479D0)
#define RPG_GAMECORE_CAKERACEACTIONGODEXCHANGECATTRANSFER_METHOD_3_9B9D4DF679946E68_OFFSET UNITYSDK_OFFSET(0x169494D0)
#define RPG_GAMECORE_CAKERACEACTIONGODEXCHANGECATTRANSFER__CTOR_OFFSET UNITYSDK_OFFSET(0x169479B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionGodExchangeCatTransfer_TypeDefinitionIndex = 16482;
