...
#define RPG_GAMECORE_SETPROPSPECIALVISIONCONFIG_METHOD_3_0240071B9C7AC37F_OFFSET UNITYSDK_OFFSET(0x1A7998A0)
#define RPG_GAMECORE_SETPROPSPECIALVISIONCONFIG_METHOD_3_8C056C7EC59E4D8E_OFFSET UNITYSDK_OFFSET(0x1A799820)
#define RPG_GAMECORE_SETPROPSPECIALVISIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A799870)
