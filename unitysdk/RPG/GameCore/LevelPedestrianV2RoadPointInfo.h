...
#define RPG_GAMECORE_LEVELPEDESTRIANV2ROADPOINTINFO_METHOD_2_A542E1C2451810A1_OFFSET UNITYSDK_OFFSET(0x16BBA040)
#define RPG_GAMECORE_LEVELPEDESTRIANV2ROADPOINTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16BBA1F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPedestrianV2RoadPointInfo_TypeDefinitionIndex = 15603;
