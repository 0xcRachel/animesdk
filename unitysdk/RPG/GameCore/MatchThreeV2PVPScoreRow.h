...
#define RPG_GAMECORE_MATCHTHREEV2PVPSCOREROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1999B5B0)
#define RPG_GAMECORE_MATCHTHREEV2PVPSCOREROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1999BAD0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::MatchThreeScoreFinishType FinishType; // 0x34
