...
#define RPG_GAMECORE_MESSAGEGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16C81CF0)
#define RPG_GAMECORE_MESSAGEGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16C82930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MessageGroupRow_TypeDefinitionIndex = 13123;
	...
	public:
		...
		::System::UInt32 MessageContactsID; // 0x24
