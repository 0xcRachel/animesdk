...
#define RPG_GAMECORE_ACTIVITYMULTIPLAYERCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19531C10)
#define RPG_GAMECORE_ACTIVITYMULTIPLAYERCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x195323B0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 DisplayModuleID; // 0x30
