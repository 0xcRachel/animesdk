...
#define RPG_GAMECORE_ST_CHESS_SELECTTARGET_METHOD_4_45591992B244ADA2_OFFSET UNITYSDK_OFFSET(0x16EF2890)
#define RPG_GAMECORE_ST_CHESS_SELECTTARGET_METHOD_4_FC36566CB369A2C8_OFFSET UNITYSDK_OFFSET(0x16EF27C0)
#define RPG_GAMECORE_ST_CHESS_SELECTTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x16EF2840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Chess_SelectTarget_TypeDefinitionIndex = 21447;
