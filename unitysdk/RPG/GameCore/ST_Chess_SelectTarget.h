...
#define RPG_GAMECORE_ST_CHESS_SELECTTARGET_METHOD_4_45591992B244ADA2_OFFSET UNITYSDK_OFFSET(0x17695810)
#define RPG_GAMECORE_ST_CHESS_SELECTTARGET_METHOD_4_FC36566CB369A2C8_OFFSET UNITYSDK_OFFSET(0x176A9E70)
#define RPG_GAMECORE_ST_CHESS_SELECTTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x176957C0)
