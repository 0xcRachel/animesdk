...
#define RPG_GAMECORE_WAITSTAMINACHANGE_METHOD_3_702C6D87D788BEC4_OFFSET UNITYSDK_OFFSET(0x1715D480)
#define RPG_GAMECORE_WAITSTAMINACHANGE_METHOD_3_8DCB64DC79BA7B5D_OFFSET UNITYSDK_OFFSET(0x1715D500)
#define RPG_GAMECORE_WAITSTAMINACHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1715D4D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitStaminaChange_TypeDefinitionIndex = 18272;
