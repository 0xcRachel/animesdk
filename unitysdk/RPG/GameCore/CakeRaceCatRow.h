...
#define RPG_GAMECORE_CAKERACECATROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19A80910)
#define RPG_GAMECORE_CAKERACECATROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19A81120)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::String* CatMiniIcon; // 0x10
		::Il2CppArray<::System::UInt32>* RunnerupPerformanceIDList; // 0x18
		::System::String* CatAIJson; // 0x20
		::System::String* CatIcon; // 0x28
		::System::String* CatMatPath; // 0x30
		::Il2CppArray<::System::UInt32>* TitlePerformanceIDList; // 0x38
		::Il2CppArray<::System::UInt32>* ChampionPerformanceIDList; // 0x40
		::Il2CppArray<::System::UInt32>* BetPerformanceIDList; // 0x48
		::System::String* CatPrefabPath; // 0x50
		::System::String* CatAbilityJson; // 0x58
		...
		::RPG::Client::TextID CatSkillTitle; // 0x90
		::RPG::Client::TextID CatSkillDesc; // 0xA0
		::RPG::Client::TextID CatPersonalityTitle; // 0xB0
		::RPG::Client::TextID CatName; // 0xC0
		::System::UInt32 CatID; // 0xD0
