...
#define RPG_GAMECORE_LEVELPATHWAYINFO_METHOD_4_E6AA41D8781A1A7D_OFFSET UNITYSDK_OFFSET(0x16BB2EE0)
#define RPG_GAMECORE_LEVELPATHWAYINFO_METHOD_4_FAD5CAC8DC3A8538_OFFSET UNITYSDK_OFFSET(0x16BB5940)
#define RPG_GAMECORE_LEVELPATHWAYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16BB2ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPathwayInfo_TypeDefinitionIndex = 15569;
