...
#define RPG_GAMECORE_MODIFIERCREATEENTITYPRESHOWCONFIG_METHOD_2_636C2A2069F35A3B_OFFSET UNITYSDK_OFFSET(0x19078990)
#define RPG_GAMECORE_MODIFIERCREATEENTITYPRESHOWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19078BD0)
