...
#define RPG_GAMECORE_PIXAIRLOCKACTIONCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19D427E0)
#define RPG_GAMECORE_PIXAIRLOCKACTIONCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19D42AB0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::PixAirLockActionName PermissionActionName; // 0x1C
