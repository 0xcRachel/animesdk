...
#define RPG_GAMECORE_ROGUEIMAGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16E82B80)
#define RPG_GAMECORE_ROGUEIMAGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16E83200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueImageRow_TypeDefinitionIndex = 13469;
