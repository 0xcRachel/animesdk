...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::System::Func_2<::Proto::Item*, ::RPG::Client::ItemDisplayData*>**)Il2CppClass::FromTypeDefinitionIndex(PropComponent___O_TypeDefinitionIndex)->GetStaticField(0x683F0);
		}
	};
}
