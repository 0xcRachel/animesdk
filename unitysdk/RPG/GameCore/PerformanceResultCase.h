...
#define RPG_GAMECORE_PERFORMANCERESULTCASE_METHOD_2_6CD01D029884DD86_OFFSET UNITYSDK_OFFSET(0x16D2A180)
#define RPG_GAMECORE_PERFORMANCERESULTCASE__CTOR_OFFSET UNITYSDK_OFFSET(0x16D2A310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceResultCase_TypeDefinitionIndex = 19019;
