...
#define RPG_GAMECORE_FATEBATTLESHOWARCHERUI_METHOD_3_7EC8C68B6E459212_OFFSET UNITYSDK_OFFSET(0x16A93CE0)
#define RPG_GAMECORE_FATEBATTLESHOWARCHERUI_METHOD_3_B65505FF70817A43_OFFSET UNITYSDK_OFFSET(0x16A93D60)
#define RPG_GAMECORE_FATEBATTLESHOWARCHERUI__CTOR_OFFSET UNITYSDK_OFFSET(0x16A93D30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateBattleShowArcherUI_TypeDefinitionIndex = 20976;
