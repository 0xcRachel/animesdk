...
#define RPG_GAMECORE_SETATTACHMENTVISIBILITY_METHOD_3_ABFD41CF9C1DF16F_OFFSET UNITYSDK_OFFSET(0x1A1E3720)
#define RPG_GAMECORE_SETATTACHMENTVISIBILITY_METHOD_3_E6E313A3340A8680_OFFSET UNITYSDK_OFFSET(0x1A1E3550)
#define RPG_GAMECORE_SETATTACHMENTVISIBILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1E36F0)
