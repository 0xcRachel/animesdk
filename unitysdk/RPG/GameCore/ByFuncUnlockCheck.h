...
#define RPG_GAMECORE_BYFUNCUNLOCKCHECK_METHOD_4_4B697906E3FFE90D_OFFSET UNITYSDK_OFFSET(0x19ADCFA0)
#define RPG_GAMECORE_BYFUNCUNLOCKCHECK_METHOD_4_B5CB0B4D13D4509F_OFFSET UNITYSDK_OFFSET(0x19ADCED0)
#define RPG_GAMECORE_BYFUNCUNLOCKCHECK__CTOR_OFFSET UNITYSDK_OFFSET(0x19ADCF50)
