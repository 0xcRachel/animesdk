...
#define RPG_GAMECORE_WAITFRAME_METHOD_3_5FD3031503DE9CCD_OFFSET UNITYSDK_OFFSET(0x1952C060)
#define RPG_GAMECORE_WAITFRAME_METHOD_3_622B9B2708997D6B_OFFSET UNITYSDK_OFFSET(0x1952C0F0)
#define RPG_GAMECORE_WAITFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1952C0C0)
