...
#define RPG_GAMECORE_FIVEDIMPRESSURESWITCHCONFIG_METHOD_3_5BC49B0B035A8721_OFFSET UNITYSDK_OFFSET(0x16ACDAE0)
#define RPG_GAMECORE_FIVEDIMPRESSURESWITCHCONFIG_METHOD_3_C5AA29F767DBD8A9_OFFSET UNITYSDK_OFFSET(0x16ACDA70)
#define RPG_GAMECORE_FIVEDIMPRESSURESWITCHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16ACDAC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPressureSwitchConfig_TypeDefinitionIndex = 16656;
