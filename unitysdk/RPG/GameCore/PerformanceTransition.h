...
#define RPG_GAMECORE_PERFORMANCETRANSITION_METHOD_3_79D98F6CD1A0DF2E_OFFSET UNITYSDK_OFFSET(0x16D2EBC0)
#define RPG_GAMECORE_PERFORMANCETRANSITION_METHOD_3_F89D542B0496691A_OFFSET UNITYSDK_OFFSET(0x16D2EB00)
#define RPG_GAMECORE_PERFORMANCETRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x16D2EB70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceTransition_TypeDefinitionIndex = 19500;
