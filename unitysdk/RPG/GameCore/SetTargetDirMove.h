...
#define RPG_GAMECORE_SETTARGETDIRMOVE_METHOD_3_378E7CB9136C3B37_OFFSET UNITYSDK_OFFSET(0x1938EED0)
#define RPG_GAMECORE_SETTARGETDIRMOVE_METHOD_3_BDE2DCDC0D511B31_OFFSET UNITYSDK_OFFSET(0x1938F050)
#define RPG_GAMECORE_SETTARGETDIRMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1938EFA0)
