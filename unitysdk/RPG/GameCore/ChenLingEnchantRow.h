...
#define RPG_GAMECORE_CHENLINGENCHANTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17099820)
#define RPG_GAMECORE_CHENLINGENCHANTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17099A60)
