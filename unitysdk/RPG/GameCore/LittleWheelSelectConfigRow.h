...
#define RPG_GAMECORE_LITTLEWHEELSELECTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A1303A0)
#define RPG_GAMECORE_LITTLEWHEELSELECTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A130BF0)
