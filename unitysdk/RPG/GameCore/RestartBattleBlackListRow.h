...
#define RPG_GAMECORE_RESTARTBATTLEBLACKLISTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16DE94F0)
#define RPG_GAMECORE_RESTARTBATTLEBLACKLISTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16DE9590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RestartBattleBlackListRow_TypeDefinitionIndex = 13789;
