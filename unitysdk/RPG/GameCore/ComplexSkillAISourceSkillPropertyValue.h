...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCESKILLPROPERTYVALUE_METHOD_3_0D399A5573F48198_OFFSET UNITYSDK_OFFSET(0x169C2070)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCESKILLPROPERTYVALUE_METHOD_3_CCF9C4FED467B014_OFFSET UNITYSDK_OFFSET(0x169C0DB0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCESKILLPROPERTYVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x169C0D90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceSkillPropertyValue_TypeDefinitionIndex = 14117;
