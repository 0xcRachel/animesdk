...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCESKILLPROPERTYVALUE_METHOD_3_0D399A5573F48198_OFFSET UNITYSDK_OFFSET(0x18F9B990)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCESKILLPROPERTYVALUE_METHOD_3_CCF9C4FED467B014_OFFSET UNITYSDK_OFFSET(0x18F9A4C0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCESKILLPROPERTYVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x18F9A4A0)
