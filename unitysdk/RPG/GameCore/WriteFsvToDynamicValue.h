...
#define RPG_GAMECORE_WRITEFSVTODYNAMICVALUE_METHOD_3_9E46DA249B8C8BF9_OFFSET UNITYSDK_OFFSET(0x171691B0)
#define RPG_GAMECORE_WRITEFSVTODYNAMICVALUE_METHOD_3_F1A3199CDCA92670_OFFSET UNITYSDK_OFFSET(0x17169130)
#define RPG_GAMECORE_WRITEFSVTODYNAMICVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x17169180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WriteFsvToDynamicValue_TypeDefinitionIndex = 19685;
