...
#define RPG_GAMECORE_CAKERACEACTIONCHANGECURSECTIONNORMALCELL_METHOD_3_815135E34C4F1708_OFFSET UNITYSDK_OFFSET(0x16948F60)
#define RPG_GAMECORE_CAKERACEACTIONCHANGECURSECTIONNORMALCELL_METHOD_3_97D19AA69937B701_OFFSET UNITYSDK_OFFSET(0x16946510)
#define RPG_GAMECORE_CAKERACEACTIONCHANGECURSECTIONNORMALCELL__CTOR_OFFSET UNITYSDK_OFFSET(0x169464F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionChangeCurSectionNormalCell_TypeDefinitionIndex = 16461;
