...
#define RPG_GAMECORE_BYISDAMAGELUCKCRITICAL_METHOD_4_47EF1422F9370403_OFFSET UNITYSDK_OFFSET(0x1692F410)
#define RPG_GAMECORE_BYISDAMAGELUCKCRITICAL_METHOD_4_66DCEAD8685F3359_OFFSET UNITYSDK_OFFSET(0x1692F340)
#define RPG_GAMECORE_BYISDAMAGELUCKCRITICAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1692F3C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsDamageLuckCritical_TypeDefinitionIndex = 21168;
