...
#define RPG_GAMECORE_ELFMANAGERRESTAURANT_METHOD_3_700E885577AFFAFC_OFFSET UNITYSDK_OFFSET(0x16A61190)
#define RPG_GAMECORE_ELFMANAGERRESTAURANT_METHOD_3_A4C13261FE83CAC8_OFFSET UNITYSDK_OFFSET(0x16A612A0)
#define RPG_GAMECORE_ELFMANAGERRESTAURANT__CTOR_OFFSET UNITYSDK_OFFSET(0x16A61270)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfManagerRestaurant_TypeDefinitionIndex = 19375;
