...
#define RPG_GAMECORE_CHARACTERPREFABLODINFO_METHOD_2_44B59B1151999100_OFFSET UNITYSDK_OFFSET(0x18D5FEE0)
#define RPG_GAMECORE_CHARACTERPREFABLODINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18D5FFB0)
