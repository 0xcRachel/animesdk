...
#define RPG_GAMECORE_SETCHARACTERCUSTOMTEAMFORMATION_METHOD_3_41BBE39AC0E2AE10_OFFSET UNITYSDK_OFFSET(0x16F0C1B0)
#define RPG_GAMECORE_SETCHARACTERCUSTOMTEAMFORMATION_METHOD_3_8117B2BFD656B32D_OFFSET UNITYSDK_OFFSET(0x16F0C250)
#define RPG_GAMECORE_SETCHARACTERCUSTOMTEAMFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x16F0C210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCharacterCustomTeamFormation_TypeDefinitionIndex = 20279;
