...
#define RPG_GAMECORE_WAITUICONTROLLERCLOSE_METHOD_3_F7C8B9A810480DE7_OFFSET UNITYSDK_OFFSET(0x1791C280)
#define RPG_GAMECORE_WAITUICONTROLLERCLOSE_METHOD_3_FBC97EBBDF5C0536_OFFSET UNITYSDK_OFFSET(0x1791C200)
#define RPG_GAMECORE_WAITUICONTROLLERCLOSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1791C250)
