...
#define RPG_GAMECORE_BYDAMAGESOURCECONTAINBEHAVIORFLAG_METHOD_4_2F1EC6332AD4ABC2_OFFSET UNITYSDK_OFFSET(0x16923290)
#define RPG_GAMECORE_BYDAMAGESOURCECONTAINBEHAVIORFLAG_METHOD_4_9FFD3F58B960B224_OFFSET UNITYSDK_OFFSET(0x16923360)
#define RPG_GAMECORE_BYDAMAGESOURCECONTAINBEHAVIORFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x16923310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByDamageSourceContainBehaviorFlag_TypeDefinitionIndex = 20990;
