...
#define RPG_GAMECORE_BYDAMAGESOURCECONTAINBEHAVIORFLAG_METHOD_4_1180DEB38A693A22_OFFSET UNITYSDK_OFFSET(0x19D88120)
#define RPG_GAMECORE_BYDAMAGESOURCECONTAINBEHAVIORFLAG_METHOD_4_4B5C72D1644C12AD_OFFSET UNITYSDK_OFFSET(0x19D87F90)
#define RPG_GAMECORE_BYDAMAGESOURCECONTAINBEHAVIORFLAG_METHOD_4_6260DB2F79A4C6CA_OFFSET UNITYSDK_OFFSET(0x19D881F0)
#define RPG_GAMECORE_BYDAMAGESOURCECONTAINBEHAVIORFLAG_METHOD_4_DA7E06D5DB27C18B_OFFSET UNITYSDK_OFFSET(0x19004150)
#define RPG_GAMECORE_BYDAMAGESOURCECONTAINBEHAVIORFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x19D881A0)
