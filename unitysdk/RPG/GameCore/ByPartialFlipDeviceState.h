...
#define RPG_GAMECORE_BYPARTIALFLIPDEVICESTATE_METHOD_4_6FC705433410EA36_OFFSET UNITYSDK_OFFSET(0x1693ADC0)
#define RPG_GAMECORE_BYPARTIALFLIPDEVICESTATE_METHOD_4_9B132C3FC9F78B70_OFFSET UNITYSDK_OFFSET(0x1693AE90)
#define RPG_GAMECORE_BYPARTIALFLIPDEVICESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1693AE40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByPartialFlipDeviceState_TypeDefinitionIndex = 19992;
