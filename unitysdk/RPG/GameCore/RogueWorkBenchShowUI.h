...
#define RPG_GAMECORE_ROGUEWORKBENCHSHOWUI_METHOD_3_46FAA2BF84DA4797_OFFSET UNITYSDK_OFFSET(0x176873C0)
#define RPG_GAMECORE_ROGUEWORKBENCHSHOWUI_METHOD_3_5BE551463F291B68_OFFSET UNITYSDK_OFFSET(0x17687440)
#define RPG_GAMECORE_ROGUEWORKBENCHSHOWUI__CTOR_OFFSET UNITYSDK_OFFSET(0x17687410)
