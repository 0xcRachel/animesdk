...
#define RPG_GAMECORE_SETCOLLIDERCENTERFOLLOWATTACHPOINT_METHOD_3_31A1821062F58928_OFFSET UNITYSDK_OFFSET(0x176C4240)
#define RPG_GAMECORE_SETCOLLIDERCENTERFOLLOWATTACHPOINT_METHOD_3_FEA3773D50C1954A_OFFSET UNITYSDK_OFFSET(0x176C4160)
#define RPG_GAMECORE_SETCOLLIDERCENTERFOLLOWATTACHPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x176C41E0)
