...
#define RPG_GAMECORE_SETLOADINGSTRATAGETYPE_METHOD_3_0E16831AC1DE9E45_OFFSET UNITYSDK_OFFSET(0x16F327C0)
#define RPG_GAMECORE_SETLOADINGSTRATAGETYPE_METHOD_3_1A8E79B7C454BBEE_OFFSET UNITYSDK_OFFSET(0x16F32740)
#define RPG_GAMECORE_SETLOADINGSTRATAGETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F32790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetLoadingStratageType_TypeDefinitionIndex = 19204;
