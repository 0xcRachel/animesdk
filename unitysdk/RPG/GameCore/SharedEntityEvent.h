...
#define RPG_GAMECORE_SHAREDENTITYEVENT_METHOD_2_02556C8237EF2802_OFFSET UNITYSDK_OFFSET(0x16F4CD50)
#define RPG_GAMECORE_SHAREDENTITYEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F4CF30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SharedEntityEvent_TypeDefinitionIndex = 16432;
