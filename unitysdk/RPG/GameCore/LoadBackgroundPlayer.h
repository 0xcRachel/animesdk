...
#define RPG_GAMECORE_LOADBACKGROUNDPLAYER_METHOD_3_E71936373F5BE682_OFFSET UNITYSDK_OFFSET(0x1A130C00)
#define RPG_GAMECORE_LOADBACKGROUNDPLAYER_METHOD_3_F5F5210F78AE67EB_OFFSET UNITYSDK_OFFSET(0x1A130C80)
#define RPG_GAMECORE_LOADBACKGROUNDPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A130C50)
