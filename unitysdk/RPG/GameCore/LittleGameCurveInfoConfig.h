...
#define RPG_GAMECORE_LITTLEGAMECURVEINFOCONFIG_METHOD_3_A0949AEE208F04F0_OFFSET UNITYSDK_OFFSET(0x17370DC0)
#define RPG_GAMECORE_LITTLEGAMECURVEINFOCONFIG_METHOD_3_BD459CE6711B96BC_OFFSET UNITYSDK_OFFSET(0x1736ED80)
#define RPG_GAMECORE_LITTLEGAMECURVEINFOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1736ED60)
