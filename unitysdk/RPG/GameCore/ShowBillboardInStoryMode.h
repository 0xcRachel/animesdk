...
#define RPG_GAMECORE_SHOWBILLBOARDINSTORYMODE_METHOD_3_7093FFCF01FD3BA9_OFFSET UNITYSDK_OFFSET(0x16F560E0)
#define RPG_GAMECORE_SHOWBILLBOARDINSTORYMODE_METHOD_3_E28DE956F7F0730A_OFFSET UNITYSDK_OFFSET(0x16F55F90)
#define RPG_GAMECORE_SHOWBILLBOARDINSTORYMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F56050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowBillboardInStoryMode_TypeDefinitionIndex = 18246;
