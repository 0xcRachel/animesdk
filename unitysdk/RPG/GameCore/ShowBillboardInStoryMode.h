...
#define RPG_GAMECORE_SHOWBILLBOARDINSTORYMODE_METHOD_3_7093FFCF01FD3BA9_OFFSET UNITYSDK_OFFSET(0x193A44C0)
#define RPG_GAMECORE_SHOWBILLBOARDINSTORYMODE_METHOD_3_E28DE956F7F0730A_OFFSET UNITYSDK_OFFSET(0x193A4370)
#define RPG_GAMECORE_SHOWBILLBOARDINSTORYMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x193A4430)
