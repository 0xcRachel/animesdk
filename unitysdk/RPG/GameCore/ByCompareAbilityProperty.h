...
#define RPG_GAMECORE_BYCOMPAREABILITYPROPERTY_METHOD_4_935D059FB7CE59F7_OFFSET UNITYSDK_OFFSET(0x169055D0)
#define RPG_GAMECORE_BYCOMPAREABILITYPROPERTY_METHOD_4_D8F8A703CD0E5B2B_OFFSET UNITYSDK_OFFSET(0x16905500)
#define RPG_GAMECORE_BYCOMPAREABILITYPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x16905580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareAbilityProperty_TypeDefinitionIndex = 21216;
