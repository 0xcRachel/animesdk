...
#define RPG_GAMECORE_ROGUEACTRANDOMGETROGUEMAGICUNITCONFIG_METHOD_6_7AB926F88ABF9A2F_OFFSET UNITYSDK_OFFSET(0x1A9B2670)
#define RPG_GAMECORE_ROGUEACTRANDOMGETROGUEMAGICUNITCONFIG_METHOD_6_D0574CF26355FF1A_OFFSET UNITYSDK_OFFSET(0x1A9B2890)
#define RPG_GAMECORE_ROGUEACTRANDOMGETROGUEMAGICUNITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9B27B0)
