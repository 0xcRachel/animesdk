...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_9EB2CB86795DEEF1_DelegateParseJson_1<::RPG::GameCore::AdventureModifierBehaviorFlag>**)Il2CppClass::FromTypeDefinitionIndex(ST_ByHasAdvBehaviorFlag___O_TypeDefinitionIndex)->GetStaticField(0x44730);
		}
	};
}
