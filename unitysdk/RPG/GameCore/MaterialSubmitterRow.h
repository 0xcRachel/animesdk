...
#define RPG_GAMECORE_MATERIALSUBMITTERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1999DCE0)
#define RPG_GAMECORE_MATERIALSUBMITTERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1999DF30)
