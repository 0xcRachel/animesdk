...
#define RPG_GAMECORE_TARGETMAPALLTEAMMEMBERFROMFIRSTENTITY_METHOD_3_529AD20B83CE76CE_OFFSET UNITYSDK_OFFSET(0x16FE15F0)
#define RPG_GAMECORE_TARGETMAPALLTEAMMEMBERFROMFIRSTENTITY_METHOD_3_6E5D9F1828755F1F_OFFSET UNITYSDK_OFFSET(0x16FE1580)
#define RPG_GAMECORE_TARGETMAPALLTEAMMEMBERFROMFIRSTENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE15D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapAllTeamMemberFromFirstEntity_TypeDefinitionIndex = 21662;
