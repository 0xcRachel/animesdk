...
#define RPG_GAMECORE_GRIDFIGHTFORMATIONWAVECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B25B30)
#define RPG_GAMECORE_GRIDFIGHTFORMATIONWAVECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B25D60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightFormationWaveConfigRow_TypeDefinitionIndex = 12395;
