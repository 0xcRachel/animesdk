...
#define RPG_GAMECORE_BATTLEBULLETCOMMENTITEM_METHOD_2_3FD6231EB2747C54_OFFSET UNITYSDK_OFFSET(0x1879EF60)
#define RPG_GAMECORE_BATTLEBULLETCOMMENTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1879F0D0)
