...
#define RPG_GAMECORE_LOCKORTHOGRAPHICRESET_METHOD_3_3C6365E725D03223_OFFSET UNITYSDK_OFFSET(0x1737FAD0)
#define RPG_GAMECORE_LOCKORTHOGRAPHICRESET_METHOD_3_D682325F179F371A_OFFSET UNITYSDK_OFFSET(0x1737FB50)
#define RPG_GAMECORE_LOCKORTHOGRAPHICRESET__CTOR_OFFSET UNITYSDK_OFFSET(0x1737FB20)
