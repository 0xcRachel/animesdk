...
#define RPG_GAMECORE_LOCKORTHOGRAPHICRESET_METHOD_3_3C6365E725D03223_OFFSET UNITYSDK_OFFSET(0x16BDBFF0)
#define RPG_GAMECORE_LOCKORTHOGRAPHICRESET_METHOD_3_D682325F179F371A_OFFSET UNITYSDK_OFFSET(0x16BDC070)
#define RPG_GAMECORE_LOCKORTHOGRAPHICRESET__CTOR_OFFSET UNITYSDK_OFFSET(0x16BDC040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockOrthographicReset_TypeDefinitionIndex = 18640;
