...
#define RPG_GAMECORE_MARBLEBYAND_METHOD_4_3010C2AFF4A1C870_OFFSET UNITYSDK_OFFSET(0x1739CF40)
#define RPG_GAMECORE_MARBLEBYAND_METHOD_4_DD0BA2583E82015D_OFFSET UNITYSDK_OFFSET(0x1739CE60)
#define RPG_GAMECORE_MARBLEBYAND__CTOR_OFFSET UNITYSDK_OFFSET(0x1739CEF0)
