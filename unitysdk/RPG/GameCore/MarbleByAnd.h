...
#define RPG_GAMECORE_MARBLEBYAND_METHOD_4_3010C2AFF4A1C870_OFFSET UNITYSDK_OFFSET(0x16C380D0)
#define RPG_GAMECORE_MARBLEBYAND_METHOD_4_DD0BA2583E82015D_OFFSET UNITYSDK_OFFSET(0x16C37FF0)
#define RPG_GAMECORE_MARBLEBYAND__CTOR_OFFSET UNITYSDK_OFFSET(0x16C38080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleByAnd_TypeDefinitionIndex = 15189;
