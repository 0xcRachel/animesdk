...
#define RPG_GAMECORE_SO_TRIGGERGROUPEVENT_METHOD_4_C186FBC84337057E_OFFSET UNITYSDK_OFFSET(0x16EDD120)
#define RPG_GAMECORE_SO_TRIGGERGROUPEVENT_METHOD_4_FDD3189D3DD447EF_OFFSET UNITYSDK_OFFSET(0x16EDCB70)
#define RPG_GAMECORE_SO_TRIGGERGROUPEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x16EDCB40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SO_TriggerGroupEvent_TypeDefinitionIndex = 17824;
