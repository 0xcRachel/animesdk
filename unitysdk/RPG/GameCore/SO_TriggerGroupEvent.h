...
#define RPG_GAMECORE_SO_TRIGGERGROUPEVENT_METHOD_4_C186FBC84337057E_OFFSET UNITYSDK_OFFSET(0x18E92250)
#define RPG_GAMECORE_SO_TRIGGERGROUPEVENT_METHOD_4_FDD3189D3DD447EF_OFFSET UNITYSDK_OFFSET(0x18E91CA0)
#define RPG_GAMECORE_SO_TRIGGERGROUPEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18E91C70)
