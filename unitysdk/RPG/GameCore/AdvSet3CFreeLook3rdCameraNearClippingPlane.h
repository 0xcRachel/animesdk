...
#define RPG_GAMECORE_ADVSET3CFREELOOK3RDCAMERANEARCLIPPINGPLANE_METHOD_3_080733B88959B110_OFFSET UNITYSDK_OFFSET(0x16845340)
#define RPG_GAMECORE_ADVSET3CFREELOOK3RDCAMERANEARCLIPPINGPLANE_METHOD_3_0F44AF12F413B0C9_OFFSET UNITYSDK_OFFSET(0x168452B0)
#define RPG_GAMECORE_ADVSET3CFREELOOK3RDCAMERANEARCLIPPINGPLANE__CTOR_OFFSET UNITYSDK_OFFSET(0x16845310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSet3CFreeLook3rdCameraNearClippingPlane_TypeDefinitionIndex = 18063;
