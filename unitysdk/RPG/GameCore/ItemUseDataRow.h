...
#define RPG_GAMECORE_ITEMUSEDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B99770)
#define RPG_GAMECORE_ITEMUSEDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B99D90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ItemUseDataRow_TypeDefinitionIndex = 12608;
