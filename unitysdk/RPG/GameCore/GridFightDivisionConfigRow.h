...
#define RPG_GAMECORE_GRIDFIGHTDIVISIONCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AC814B0)
#define RPG_GAMECORE_GRIDFIGHTDIVISIONCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC81800)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean IsPromotion; // 0x3C
