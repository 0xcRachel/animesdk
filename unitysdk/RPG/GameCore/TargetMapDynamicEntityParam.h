...
#define RPG_GAMECORE_TARGETMAPDYNAMICENTITYPARAM_METHOD_3_28AD7662C9671FD9_OFFSET UNITYSDK_OFFSET(0x16FE2810)
#define RPG_GAMECORE_TARGETMAPDYNAMICENTITYPARAM_METHOD_3_CC59B4EE77B2C84D_OFFSET UNITYSDK_OFFSET(0x16FE2910)
#define RPG_GAMECORE_TARGETMAPDYNAMICENTITYPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE28F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapDynamicEntityParam_TypeDefinitionIndex = 21684;
