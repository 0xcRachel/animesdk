...
#define RPG_GAMECORE_ST_SIDE_TIMER_METHOD_4_382EAB24255812C8_OFFSET UNITYSDK_OFFSET(0x176AE4B0)
#define RPG_GAMECORE_ST_SIDE_TIMER_METHOD_4_F6A121ACB11FCD22_OFFSET UNITYSDK_OFFSET(0x176A4800)
#define RPG_GAMECORE_ST_SIDE_TIMER__CTOR_OFFSET UNITYSDK_OFFSET(0x176A47B0)
