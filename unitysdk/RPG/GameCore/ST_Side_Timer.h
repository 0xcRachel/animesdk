...
#define RPG_GAMECORE_ST_SIDE_TIMER_METHOD_4_382EAB24255812C8_OFFSET UNITYSDK_OFFSET(0x16EF9120)
#define RPG_GAMECORE_ST_SIDE_TIMER_METHOD_4_F6A121ACB11FCD22_OFFSET UNITYSDK_OFFSET(0x16EECE90)
#define RPG_GAMECORE_ST_SIDE_TIMER__CTOR_OFFSET UNITYSDK_OFFSET(0x16EECE40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_Timer_TypeDefinitionIndex = 17916;
