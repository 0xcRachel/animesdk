...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEFORMULANUMPARAM_METHOD_4_474B9A07830832C8_OFFSET UNITYSDK_OFFSET(0x16F25BA0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEFORMULANUMPARAM_METHOD_4_5708F293825F9888_OFFSET UNITYSDK_OFFSET(0x16F25C30)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEFORMULANUMPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x16F25C00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueFormulaNumParam_TypeDefinitionIndex = 19421;
