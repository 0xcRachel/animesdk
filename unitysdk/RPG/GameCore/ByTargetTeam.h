...
#define RPG_GAMECORE_BYTARGETTEAM_METHOD_4_658A59B374066D91_OFFSET UNITYSDK_OFFSET(0x169408F0)
#define RPG_GAMECORE_BYTARGETTEAM_METHOD_4_F3624CEC2FCA443D_OFFSET UNITYSDK_OFFSET(0x169409C0)
#define RPG_GAMECORE_BYTARGETTEAM__CTOR_OFFSET UNITYSDK_OFFSET(0x16940970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByTargetTeam_TypeDefinitionIndex = 20192;
