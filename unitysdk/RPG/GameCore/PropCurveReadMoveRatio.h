...
#define RPG_GAMECORE_PROPCURVEREADMOVERATIO_METHOD_3_66B2D32D80EDCAC8_OFFSET UNITYSDK_OFFSET(0x16DA66B0)
#define RPG_GAMECORE_PROPCURVEREADMOVERATIO_METHOD_3_AEAC275D27100814_OFFSET UNITYSDK_OFFSET(0x16DA67A0)
#define RPG_GAMECORE_PROPCURVEREADMOVERATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x16DA6740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropCurveReadMoveRatio_TypeDefinitionIndex = 18806;
