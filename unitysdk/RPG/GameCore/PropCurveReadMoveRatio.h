...
#define RPG_GAMECORE_PROPCURVEREADMOVERATIO_METHOD_3_66B2D32D80EDCAC8_OFFSET UNITYSDK_OFFSET(0x191C0AC0)
#define RPG_GAMECORE_PROPCURVEREADMOVERATIO_METHOD_3_AEAC275D27100814_OFFSET UNITYSDK_OFFSET(0x191C0BB0)
#define RPG_GAMECORE_PROPCURVEREADMOVERATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x191C0B50)
