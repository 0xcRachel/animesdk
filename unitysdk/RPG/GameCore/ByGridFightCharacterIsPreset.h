...
#define RPG_GAMECORE_BYGRIDFIGHTCHARACTERISPRESET_METHOD_4_6927661C05269674_OFFSET UNITYSDK_OFFSET(0x16925560)
#define RPG_GAMECORE_BYGRIDFIGHTCHARACTERISPRESET_METHOD_4_79B4D91A77954336_OFFSET UNITYSDK_OFFSET(0x16925630)
#define RPG_GAMECORE_BYGRIDFIGHTCHARACTERISPRESET__CTOR_OFFSET UNITYSDK_OFFSET(0x169255E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByGridFightCharacterIsPreset_TypeDefinitionIndex = 20164;
