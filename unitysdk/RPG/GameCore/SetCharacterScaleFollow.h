...
#define RPG_GAMECORE_SETCHARACTERSCALEFOLLOW_METHOD_3_C6A0F12DFFE44EC3_OFFSET UNITYSDK_OFFSET(0x16F0D510)
#define RPG_GAMECORE_SETCHARACTERSCALEFOLLOW_METHOD_3_F385005891770F99_OFFSET UNITYSDK_OFFSET(0x16F0D590)
#define RPG_GAMECORE_SETCHARACTERSCALEFOLLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x16F0D560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCharacterScaleFollow_TypeDefinitionIndex = 20283;
