...
#define RPG_GAMECORE_OPTICALILLUSIONSETFINALPOINT_METHOD_3_065CA320F770C685_OFFSET UNITYSDK_OFFSET(0x17493D50)
#define RPG_GAMECORE_OPTICALILLUSIONSETFINALPOINT_METHOD_3_E9EF9A94CF46BB46_OFFSET UNITYSDK_OFFSET(0x17493C00)
#define RPG_GAMECORE_OPTICALILLUSIONSETFINALPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x17493CC0)
