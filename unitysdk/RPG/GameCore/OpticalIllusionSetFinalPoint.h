...
#define RPG_GAMECORE_OPTICALILLUSIONSETFINALPOINT_METHOD_3_065CA320F770C685_OFFSET UNITYSDK_OFFSET(0x16D0D490)
#define RPG_GAMECORE_OPTICALILLUSIONSETFINALPOINT_METHOD_3_E9EF9A94CF46BB46_OFFSET UNITYSDK_OFFSET(0x16D0D340)
#define RPG_GAMECORE_OPTICALILLUSIONSETFINALPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x16D0D400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OpticalIllusionSetFinalPoint_TypeDefinitionIndex = 19873;
