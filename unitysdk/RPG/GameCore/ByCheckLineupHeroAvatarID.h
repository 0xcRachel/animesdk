...
#define RPG_GAMECORE_BYCHECKLINEUPHEROAVATARID_METHOD_4_F1CECD2975A7DB92_OFFSET UNITYSDK_OFFSET(0x169026D0)
#define RPG_GAMECORE_BYCHECKLINEUPHEROAVATARID_METHOD_4_FC1B658F8E8D2D1B_OFFSET UNITYSDK_OFFSET(0x16902600)
#define RPG_GAMECORE_BYCHECKLINEUPHEROAVATARID__CTOR_OFFSET UNITYSDK_OFFSET(0x16902680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckLineupHeroAvatarID_TypeDefinitionIndex = 18596;
