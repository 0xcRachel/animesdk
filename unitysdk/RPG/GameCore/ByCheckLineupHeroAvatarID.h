...
#define RPG_GAMECORE_BYCHECKLINEUPHEROAVATARID_METHOD_4_F1CECD2975A7DB92_OFFSET UNITYSDK_OFFSET(0x195FA3C0)
#define RPG_GAMECORE_BYCHECKLINEUPHEROAVATARID_METHOD_4_FC1B658F8E8D2D1B_OFFSET UNITYSDK_OFFSET(0x195FA2F0)
#define RPG_GAMECORE_BYCHECKLINEUPHEROAVATARID__CTOR_OFFSET UNITYSDK_OFFSET(0x195FA370)
