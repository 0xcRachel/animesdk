...
#define RPG_GAMECORE_EFFECTADAPTIONCONFIG_METHOD_2_21F761EAC847EC8B_OFFSET UNITYSDK_OFFSET(0x1719CC10)
#define RPG_GAMECORE_EFFECTADAPTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1719CE40)
