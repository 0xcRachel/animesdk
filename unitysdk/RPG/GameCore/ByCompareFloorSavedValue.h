...
#define RPG_GAMECORE_BYCOMPAREFLOORSAVEDVALUE_METHOD_4_A9E27D1B3D9E87E6_OFFSET UNITYSDK_OFFSET(0x1690CAA0)
#define RPG_GAMECORE_BYCOMPAREFLOORSAVEDVALUE_METHOD_4_EE9AA4D90B96F610_OFFSET UNITYSDK_OFFSET(0x1690C9C0)
#define RPG_GAMECORE_BYCOMPAREFLOORSAVEDVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1690CA40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareFloorSavedValue_TypeDefinitionIndex = 18505;
