...
#define RPG_GAMECORE_WAITANIMSTATECHANGEV3_METHOD_4_B2CBBDEED6E14E74_OFFSET UNITYSDK_OFFSET(0x19526240)
#define RPG_GAMECORE_WAITANIMSTATECHANGEV3_METHOD_4_FACD0A6E4828D2F3_OFFSET UNITYSDK_OFFSET(0x19526320)
#define RPG_GAMECORE_WAITANIMSTATECHANGEV3__CTOR_OFFSET UNITYSDK_OFFSET(0x195262C0)
