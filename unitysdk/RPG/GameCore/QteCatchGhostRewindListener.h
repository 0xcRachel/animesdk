...
#define RPG_GAMECORE_QTECATCHGHOSTREWINDLISTENER_METHOD_3_2ACFA36BBEE28794_OFFSET UNITYSDK_OFFSET(0x16DBDDE0)
#define RPG_GAMECORE_QTECATCHGHOSTREWINDLISTENER_METHOD_3_A2BB98A2E2FC709C_OFFSET UNITYSDK_OFFSET(0x16DBDE60)
#define RPG_GAMECORE_QTECATCHGHOSTREWINDLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x16DBDE30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int QteCatchGhostRewindListener_TypeDefinitionIndex = 19697;
