...
#define RPG_GAMECORE_CONVINCEMOVENEXTTURN_METHOD_3_447D08A933C1A931_OFFSET UNITYSDK_OFFSET(0x18FA9BA0)
#define RPG_GAMECORE_CONVINCEMOVENEXTTURN_METHOD_3_97C7775B255A4EFD_OFFSET UNITYSDK_OFFSET(0x18FA9A90)
#define RPG_GAMECORE_CONVINCEMOVENEXTTURN__CTOR_OFFSET UNITYSDK_OFFSET(0x18FA9B70)
