...
#define RPG_GAMECORE_CONVINCEMOVENEXTTURN_METHOD_3_447D08A933C1A931_OFFSET UNITYSDK_OFFSET(0x1714B8F0)
#define RPG_GAMECORE_CONVINCEMOVENEXTTURN_METHOD_3_97C7775B255A4EFD_OFFSET UNITYSDK_OFFSET(0x1714B7E0)
#define RPG_GAMECORE_CONVINCEMOVENEXTTURN__CTOR_OFFSET UNITYSDK_OFFSET(0x1714B8C0)
