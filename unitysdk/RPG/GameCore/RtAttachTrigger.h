...
#define RPG_GAMECORE_RTATTACHTRIGGER_METHOD_3_6BFFC3498DFFAA0F_OFFSET UNITYSDK_OFFSET(0x19412A10)
#define RPG_GAMECORE_RTATTACHTRIGGER_METHOD_3_D608554727096ABA_OFFSET UNITYSDK_OFFSET(0x19412B30)
#define RPG_GAMECORE_RTATTACHTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x19412A50)
