...
#define RPG_GAMECORE_ST_CHESS_MAIN_MOVETOTARGET_METHOD_4_292D7181E0030C5B_OFFSET UNITYSDK_OFFSET(0x17695640)
#define RPG_GAMECORE_ST_CHESS_MAIN_MOVETOTARGET_METHOD_4_42FADC7B770604A1_OFFSET UNITYSDK_OFFSET(0x176A9DF0)
#define RPG_GAMECORE_ST_CHESS_MAIN_MOVETOTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x176955F0)
