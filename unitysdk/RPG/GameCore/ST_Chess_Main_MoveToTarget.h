...
#define RPG_GAMECORE_ST_CHESS_MAIN_MOVETOTARGET_METHOD_4_292D7181E0030C5B_OFFSET UNITYSDK_OFFSET(0x16EF26B0)
#define RPG_GAMECORE_ST_CHESS_MAIN_MOVETOTARGET_METHOD_4_42FADC7B770604A1_OFFSET UNITYSDK_OFFSET(0x16EF25E0)
#define RPG_GAMECORE_ST_CHESS_MAIN_MOVETOTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x16EF2660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Chess_Main_MoveToTarget_TypeDefinitionIndex = 21448;
