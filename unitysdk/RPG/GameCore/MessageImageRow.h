...
#define RPG_GAMECORE_MESSAGEIMAGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16C83210)
#define RPG_GAMECORE_MESSAGEIMAGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16C837B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MessageImageRow_TypeDefinitionIndex = 13130;
