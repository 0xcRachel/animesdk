...
#define RPG_GAMECORE_MESSAGEIMAGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x173E8B20)
#define RPG_GAMECORE_MESSAGEIMAGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x173E90C0)
