...
#define RPG_GAMECORE_CHESTMONSTERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16982200)
#define RPG_GAMECORE_CHESTMONSTERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x169824C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChestMonsterRow_TypeDefinitionIndex = 13110;
