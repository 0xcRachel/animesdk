...
#define RPG_GAMECORE_GRIDFIGHTROLESWITCHCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B46D20)
#define RPG_GAMECORE_GRIDFIGHTROLESWITCHCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B46EF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightRoleSwitchConfigRow_TypeDefinitionIndex = 12298;
