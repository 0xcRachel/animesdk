...
#define RPG_GAMECORE_ROTATABLEREGIONPOSE_METHOD_2_B5222EEE78360181_OFFSET UNITYSDK_OFFSET(0x17688C50)
#define RPG_GAMECORE_ROTATABLEREGIONPOSE__CTOR_OFFSET UNITYSDK_OFFSET(0x17688EA0)
