...
#define RPG_GAMECORE_WAITFLOORCUSTOMVALUECHANGEV2_METHOD_4_A59E5484C2D77690_OFFSET UNITYSDK_OFFSET(0x17151830)
#define RPG_GAMECORE_WAITFLOORCUSTOMVALUECHANGEV2_METHOD_4_D36FD4F723D3457E_OFFSET UNITYSDK_OFFSET(0x17151750)
#define RPG_GAMECORE_WAITFLOORCUSTOMVALUECHANGEV2__CTOR_OFFSET UNITYSDK_OFFSET(0x171517D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitFloorCustomValueChangeV2_TypeDefinitionIndex = 18502;
