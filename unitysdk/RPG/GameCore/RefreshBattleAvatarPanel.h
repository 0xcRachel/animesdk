...
#define RPG_GAMECORE_REFRESHBATTLEAVATARPANEL_METHOD_3_3FB3184A14DF4C49_OFFSET UNITYSDK_OFFSET(0x1759CEC0)
#define RPG_GAMECORE_REFRESHBATTLEAVATARPANEL_METHOD_3_B98B3C74BD31F93D_OFFSET UNITYSDK_OFFSET(0x1759CFD0)
#define RPG_GAMECORE_REFRESHBATTLEAVATARPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1759CFA0)
