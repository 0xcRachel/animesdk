...
#define RPG_GAMECORE_SETINWARDBUBBLEINFO_METHOD_3_03D3F53A6FE74D85_OFFSET UNITYSDK_OFFSET(0x199B8C80)
#define RPG_GAMECORE_SETINWARDBUBBLEINFO_METHOD_3_B7E7153889676F5E_OFFSET UNITYSDK_OFFSET(0x199B8C00)
#define RPG_GAMECORE_SETINWARDBUBBLEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x199B8C50)
