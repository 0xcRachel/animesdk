...
#define RPG_GAMECORE_COMPLEXSKILLAICONTAINMODIFIER_METHOD_3_73B086392C2A67BC_OFFSET UNITYSDK_OFFSET(0x17136990)
#define RPG_GAMECORE_COMPLEXSKILLAICONTAINMODIFIER_METHOD_3_A5A04FFA39A17086_OFFSET UNITYSDK_OFFSET(0x17136A00)
#define RPG_GAMECORE_COMPLEXSKILLAICONTAINMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x171369E0)
