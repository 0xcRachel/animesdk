...
#define RPG_GAMECORE_FIVEDIMVCAMERABLENDCONFIG_METHOD_2_02E8DBF4CDCFC6EA_OFFSET UNITYSDK_OFFSET(0x1A3A8530)
#define RPG_GAMECORE_FIVEDIMVCAMERABLENDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3AAB60)
