...
#define RPG_GAMECORE_DAMAGEPERFORMFINISHONSCEPTER_METHOD_4_18A33010630CCE5B_OFFSET UNITYSDK_OFFSET(0x1715C7C0)
#define RPG_GAMECORE_DAMAGEPERFORMFINISHONSCEPTER_METHOD_4_406B041D4C16506A_OFFSET UNITYSDK_OFFSET(0x1715C620)
#define RPG_GAMECORE_DAMAGEPERFORMFINISHONSCEPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1715C5F0)
