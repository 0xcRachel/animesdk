...
#define RPG_GAMECORE_RESETABILITYSTARTTIMESTAMP_METHOD_3_35648A103AEAB256_OFFSET UNITYSDK_OFFSET(0x1902CA00)
#define RPG_GAMECORE_RESETABILITYSTARTTIMESTAMP_METHOD_3_F82F32D2DC4B504A_OFFSET UNITYSDK_OFFSET(0x1902C980)
#define RPG_GAMECORE_RESETABILITYSTARTTIMESTAMP__CTOR_OFFSET UNITYSDK_OFFSET(0x1902C9D0)
