...
#define RPG_GAMECORE_SHOWBATTLEEVENTTIPS_METHOD_3_4E649A89F9AFD865_OFFSET UNITYSDK_OFFSET(0x16F54400)
#define RPG_GAMECORE_SHOWBATTLEEVENTTIPS_METHOD_3_B5C79D1685159719_OFFSET UNITYSDK_OFFSET(0x16F54480)
#define RPG_GAMECORE_SHOWBATTLEEVENTTIPS__CTOR_OFFSET UNITYSDK_OFFSET(0x16F54450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowBattleEventTips_TypeDefinitionIndex = 20596;
