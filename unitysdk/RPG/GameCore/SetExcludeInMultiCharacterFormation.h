...
#define RPG_GAMECORE_SETEXCLUDEINMULTICHARACTERFORMATION_METHOD_3_3400EC4F8D9BBFF5_OFFSET UNITYSDK_OFFSET(0x199B3AF0)
#define RPG_GAMECORE_SETEXCLUDEINMULTICHARACTERFORMATION_METHOD_3_3AD44EE2F0B0BB76_OFFSET UNITYSDK_OFFSET(0x199B3BD0)
#define RPG_GAMECORE_SETEXCLUDEINMULTICHARACTERFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x199B3B70)
