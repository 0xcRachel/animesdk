...
#define RPG_GAMECORE_CHARACTERNATUREROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16971570)
#define RPG_GAMECORE_CHARACTERNATUREROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16971B10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterNatureRow_TypeDefinitionIndex = 11780;
