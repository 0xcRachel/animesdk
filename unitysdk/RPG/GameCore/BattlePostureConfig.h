...
#define RPG_GAMECORE_BATTLEPOSTURECONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x168E2700)
#define RPG_GAMECORE_BATTLEPOSTURECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x168E2940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattlePostureConfig_TypeDefinitionIndex = 15926;
