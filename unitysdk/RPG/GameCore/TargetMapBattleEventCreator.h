...
#define RPG_GAMECORE_TARGETMAPBATTLEEVENTCREATOR_METHOD_3_891B19D4DB5C26A5_OFFSET UNITYSDK_OFFSET(0x16FE1990)
#define RPG_GAMECORE_TARGETMAPBATTLEEVENTCREATOR_METHOD_3_DE18EA9B955DA4B3_OFFSET UNITYSDK_OFFSET(0x16FE1A70)
#define RPG_GAMECORE_TARGETMAPBATTLEEVENTCREATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE1A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapBattleEventCreator_TypeDefinitionIndex = 21645;
