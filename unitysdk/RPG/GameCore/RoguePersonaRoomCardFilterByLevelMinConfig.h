...
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYLEVELMINCONFIG_METHOD_3_A8A7F5142DA3AA03_OFFSET UNITYSDK_OFFSET(0x1766C1A0)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYLEVELMINCONFIG_METHOD_3_E8F18D589E1380FF_OFFSET UNITYSDK_OFFSET(0x1766C410)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYLEVELMINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1766C190)
