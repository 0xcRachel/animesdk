...
#define RPG_GAMECORE_SETVIEWMODEENABLED_METHOD_3_0D2C9BE10736FF00_OFFSET UNITYSDK_OFFSET(0x16F45970)
#define RPG_GAMECORE_SETVIEWMODEENABLED_METHOD_3_E30D77D281644AF9_OFFSET UNITYSDK_OFFSET(0x16F459F0)
#define RPG_GAMECORE_SETVIEWMODEENABLED__CTOR_OFFSET UNITYSDK_OFFSET(0x16F459C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetViewModeEnabled_TypeDefinitionIndex = 20858;
