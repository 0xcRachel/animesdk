...
#define RPG_GAMECORE_ROGUEGAMBLEFUNCSHOWUI_METHOD_3_19FABD9F58C64E36_OFFSET UNITYSDK_OFFSET(0x19964C40)
#define RPG_GAMECORE_ROGUEGAMBLEFUNCSHOWUI_METHOD_3_36E21D30F9FD5883_OFFSET UNITYSDK_OFFSET(0x19964BC0)
#define RPG_GAMECORE_ROGUEGAMBLEFUNCSHOWUI__CTOR_OFFSET UNITYSDK_OFFSET(0x19964C10)
