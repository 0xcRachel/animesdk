...
#define RPG_GAMECORE_ROGUEGAMBLEFUNCSHOWUI_METHOD_3_19FABD9F58C64E36_OFFSET UNITYSDK_OFFSET(0x16E7F5E0)
#define RPG_GAMECORE_ROGUEGAMBLEFUNCSHOWUI_METHOD_3_36E21D30F9FD5883_OFFSET UNITYSDK_OFFSET(0x16E7F560)
#define RPG_GAMECORE_ROGUEGAMBLEFUNCSHOWUI__CTOR_OFFSET UNITYSDK_OFFSET(0x16E7F5B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueGambleFuncShowUI_TypeDefinitionIndex = 19755;
