...
#define RPG_GAMECORE_RTBYCURRENTSKILLNAME_METHOD_4_5287FAA60DF53FC4_OFFSET UNITYSDK_OFFSET(0x18E79DB0)
#define RPG_GAMECORE_RTBYCURRENTSKILLNAME_METHOD_4_9E51D711EA776EEB_OFFSET UNITYSDK_OFFSET(0x18E79C90)
#define RPG_GAMECORE_RTBYCURRENTSKILLNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x18E79D30)
