...
#define RPG_GAMECORE_JUKEBOXCONFIG_METHOD_2_EE65A48A9C8E658C_OFFSET UNITYSDK_OFFSET(0x16B9CDE0)
#define RPG_GAMECORE_JUKEBOXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16B9D000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int JukeBoxConfig_TypeDefinitionIndex = 14756;
