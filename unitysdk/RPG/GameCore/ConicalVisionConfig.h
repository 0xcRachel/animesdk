...
#define RPG_GAMECORE_CONICALVISIONCONFIG_METHOD_3_281CB1C61BA7983B_OFFSET UNITYSDK_OFFSET(0x169C6130)
#define RPG_GAMECORE_CONICALVISIONCONFIG_METHOD_3_F89CF6A3672CD537_OFFSET UNITYSDK_OFFSET(0x169C61E0)
#define RPG_GAMECORE_CONICALVISIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x169C61A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConicalVisionConfig_TypeDefinitionIndex = 17754;
