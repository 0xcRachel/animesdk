...
#define RPG_GAMECORE_CONICALVISIONCONFIG_METHOD_3_281CB1C61BA7983B_OFFSET UNITYSDK_OFFSET(0x18FA0250)
#define RPG_GAMECORE_CONICALVISIONCONFIG_METHOD_3_F89CF6A3672CD537_OFFSET UNITYSDK_OFFSET(0x18FA0300)
#define RPG_GAMECORE_CONICALVISIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18FA02C0)
