...
#define RPG_GAMECORE_BYCOMPAREPERFORMANCERESULT_METHOD_4_228CD69F1FED04A9_OFFSET UNITYSDK_OFFSET(0x16915290)
#define RPG_GAMECORE_BYCOMPAREPERFORMANCERESULT_METHOD_4_EDBE211D78919DE1_OFFSET UNITYSDK_OFFSET(0x169151C0)
#define RPG_GAMECORE_BYCOMPAREPERFORMANCERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x16915240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByComparePerformanceResult_TypeDefinitionIndex = 19579;
