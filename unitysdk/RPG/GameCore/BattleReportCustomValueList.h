...
#define RPG_GAMECORE_BATTLEREPORTCUSTOMVALUELIST_METHOD_2_D39A2D318667561C_OFFSET UNITYSDK_OFFSET(0x168E3E40)
#define RPG_GAMECORE_BATTLEREPORTCUSTOMVALUELIST__CTOR_OFFSET UNITYSDK_OFFSET(0x168E3F10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleReportCustomValueList_TypeDefinitionIndex = 15402;
