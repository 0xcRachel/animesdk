...
#define RPG_GAMECORE_SHOWSPACEZOOMAINPAGE_METHOD_3_826A7F8EA210C052_OFFSET UNITYSDK_OFFSET(0x1A00ACF0)
#define RPG_GAMECORE_SHOWSPACEZOOMAINPAGE_METHOD_3_D0960E2CF7C7FDF1_OFFSET UNITYSDK_OFFSET(0x1A00AD70)
#define RPG_GAMECORE_SHOWSPACEZOOMAINPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A00AD40)
