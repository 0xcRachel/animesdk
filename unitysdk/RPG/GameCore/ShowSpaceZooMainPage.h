...
#define RPG_GAMECORE_SHOWSPACEZOOMAINPAGE_METHOD_3_96044B4DADE250A6_OFFSET UNITYSDK_OFFSET(0x16F62FE0)
#define RPG_GAMECORE_SHOWSPACEZOOMAINPAGE_METHOD_3_B8E6A9AB5619356F_OFFSET UNITYSDK_OFFSET(0x16F62F60)
#define RPG_GAMECORE_SHOWSPACEZOOMAINPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F62FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowSpaceZooMainPage_TypeDefinitionIndex = 18713;
