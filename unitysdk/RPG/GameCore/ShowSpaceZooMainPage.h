...
#define RPG_GAMECORE_SHOWSPACEZOOMAINPAGE_METHOD_3_96044B4DADE250A6_OFFSET UNITYSDK_OFFSET(0x193B1400)
#define RPG_GAMECORE_SHOWSPACEZOOMAINPAGE_METHOD_3_B8E6A9AB5619356F_OFFSET UNITYSDK_OFFSET(0x193B1380)
#define RPG_GAMECORE_SHOWSPACEZOOMAINPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x193B13D0)
