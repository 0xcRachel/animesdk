...
#define RPG_GAMECORE_TRAINPARTYBUILDITEMDYNAMICBINDVALUE_MISSION_METHOD_3_A39850DC7EF7251E_OFFSET UNITYSDK_OFFSET(0x19492E00)
#define RPG_GAMECORE_TRAINPARTYBUILDITEMDYNAMICBINDVALUE_MISSION_METHOD_3_F57746EAB0E34422_OFFSET UNITYSDK_OFFSET(0x19492C60)
#define RPG_GAMECORE_TRAINPARTYBUILDITEMDYNAMICBINDVALUE_MISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x19492C50)
