...
#define RPG_GAMECORE_SWORDTRAININGEXAMCOMMENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16FBD320)
#define RPG_GAMECORE_SWORDTRAININGEXAMCOMMENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16FBD4E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwordTrainingExamCommentRow_TypeDefinitionIndex = 11310;
