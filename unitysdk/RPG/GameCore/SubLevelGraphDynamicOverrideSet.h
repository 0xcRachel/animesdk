...
#define RPG_GAMECORE_SUBLEVELGRAPHDYNAMICOVERRIDESET_METHOD_2_8F076A5CB43CC170_OFFSET UNITYSDK_OFFSET(0x16F96D10)
#define RPG_GAMECORE_SUBLEVELGRAPHDYNAMICOVERRIDESET__CTOR_OFFSET UNITYSDK_OFFSET(0x16FA7120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SubLevelGraphDynamicOverrideSet_TypeDefinitionIndex = 18517;
