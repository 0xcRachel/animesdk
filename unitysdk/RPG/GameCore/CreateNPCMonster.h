...
#define RPG_GAMECORE_CREATENPCMONSTER_METHOD_3_21B1B84ADBAE75F0_OFFSET UNITYSDK_OFFSET(0x17150D10)
#define RPG_GAMECORE_CREATENPCMONSTER_METHOD_3_F55C200A887EC250_OFFSET UNITYSDK_OFFSET(0x17150C80)
#define RPG_GAMECORE_CREATENPCMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x17150CE0)
