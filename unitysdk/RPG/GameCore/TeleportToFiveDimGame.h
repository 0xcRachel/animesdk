...
#define RPG_GAMECORE_TELEPORTTOFIVEDIMGAME_METHOD_3_490CBFC1FC1D19EF_OFFSET UNITYSDK_OFFSET(0x178ACC00)
#define RPG_GAMECORE_TELEPORTTOFIVEDIMGAME_METHOD_3_80CCEC55F21CD419_OFFSET UNITYSDK_OFFSET(0x1789C400)
#define RPG_GAMECORE_TELEPORTTOFIVEDIMGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1789C3D0)
