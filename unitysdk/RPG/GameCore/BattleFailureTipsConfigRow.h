...
#define RPG_GAMECORE_BATTLEFAILURETIPSCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x168DBAB0)
#define RPG_GAMECORE_BATTLEFAILURETIPSCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x168DC110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleFailureTipsConfigRow_TypeDefinitionIndex = 11677;
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* MonsterTemplateIDList; // 0x28
		::Il2CppArray<::System::UInt32>* StageIDForce; // 0x30
		::Il2CppArray<::RPG::GameCore::GameModeType>* GameModeList; // 0x38
		::Il2CppArray<::System::UInt32>* MainMissionUnfinishForce; // 0x40
		...
		::Il2CppArray<::System::UInt32>* MainMissionFinishForce; // 0x60
