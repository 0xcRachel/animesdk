...
#define RPG_GAMECORE_ENABLERANDOMTRIGGERANIMEVENT_METHOD_3_520A2EF6A2450A0A_OFFSET UNITYSDK_OFFSET(0x16A6B3C0)
#define RPG_GAMECORE_ENABLERANDOMTRIGGERANIMEVENT_METHOD_3_8A991D283B281E60_OFFSET UNITYSDK_OFFSET(0x16A6B340)
#define RPG_GAMECORE_ENABLERANDOMTRIGGERANIMEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x16A6B390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableRandomTriggerAnimEvent_TypeDefinitionIndex = 20082;
