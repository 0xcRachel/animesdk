...
#define RPG_GAMECORE_PARAMGETEXCELVALUECONFIG_METHOD_4_B3D8AEBECF0CC29E_OFFSET UNITYSDK_OFFSET(0x1749DF70)
#define RPG_GAMECORE_PARAMGETEXCELVALUECONFIG_METHOD_4_E31010E82FA3A0EC_OFFSET UNITYSDK_OFFSET(0x1749DE30)
#define RPG_GAMECORE_PARAMGETEXCELVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1749DEF0)
