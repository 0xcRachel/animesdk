...
#define RPG_GAMECORE_TARGETFETCHAIMATTARGETLIST_METHOD_4_4279B81DCECDD3CA_OFFSET UNITYSDK_OFFSET(0x177D11F0)
#define RPG_GAMECORE_TARGETFETCHAIMATTARGETLIST_METHOD_4_7C11CF74121445EE_OFFSET UNITYSDK_OFFSET(0x177C6760)
#define RPG_GAMECORE_TARGETFETCHAIMATTARGETLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x177C6710)
