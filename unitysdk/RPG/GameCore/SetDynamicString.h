...
#define RPG_GAMECORE_SETDYNAMICSTRING_METHOD_4_300CB781E0783410_OFFSET UNITYSDK_OFFSET(0x176C7820)
#define RPG_GAMECORE_SETDYNAMICSTRING_METHOD_4_6EB0A0B772EC6CE3_OFFSET UNITYSDK_OFFSET(0x176C78A0)
#define RPG_GAMECORE_SETDYNAMICSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x176C7870)
