...
#define RPG_GAMECORE_SETDYNAMICSTRING_METHOD_4_300CB781E0783410_OFFSET UNITYSDK_OFFSET(0x16F12360)
#define RPG_GAMECORE_SETDYNAMICSTRING_METHOD_4_6EB0A0B772EC6CE3_OFFSET UNITYSDK_OFFSET(0x16F123E0)
#define RPG_GAMECORE_SETDYNAMICSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x16F123B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicString_TypeDefinitionIndex = 21535;
