...
#define RPG_GAMECORE_BYISROGUETOURNCURROOMFINISH_METHOD_4_86773FAC16C8579C_OFFSET UNITYSDK_OFFSET(0x17046510)
#define RPG_GAMECORE_BYISROGUETOURNCURROOMFINISH_METHOD_4_EB2816B774EF9FD6_OFFSET UNITYSDK_OFFSET(0x17046440)
#define RPG_GAMECORE_BYISROGUETOURNCURROOMFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x170464C0)
