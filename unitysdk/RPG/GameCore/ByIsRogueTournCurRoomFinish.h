...
#define RPG_GAMECORE_BYISROGUETOURNCURROOMFINISH_METHOD_4_86773FAC16C8579C_OFFSET UNITYSDK_OFFSET(0x19A67C00)
#define RPG_GAMECORE_BYISROGUETOURNCURROOMFINISH_METHOD_4_EB2816B774EF9FD6_OFFSET UNITYSDK_OFFSET(0x19A67B30)
#define RPG_GAMECORE_BYISROGUETOURNCURROOMFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x19A67BB0)
