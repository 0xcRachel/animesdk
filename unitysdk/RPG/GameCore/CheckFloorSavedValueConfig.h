...
#define RPG_GAMECORE_CHECKFLOORSAVEDVALUECONFIG_METHOD_2_5D88991ABD5F2D20_OFFSET UNITYSDK_OFFSET(0x18D646F0)
#define RPG_GAMECORE_CHECKFLOORSAVEDVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D64840)
