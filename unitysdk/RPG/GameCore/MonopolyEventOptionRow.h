...
#define RPG_GAMECORE_MONOPOLYEVENTOPTIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x196B5F80)
#define RPG_GAMECORE_MONOPOLYEVENTOPTIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x196B68D0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::MonopolyOptionType OptionType; // 0x2C
		::System::UInt32 DiceScoreRequirement; // 0x30
		::System::UInt32 TextDisplayParam1; // 0x34
		::RPG::Client::TextID OptionBubbleTalk; // 0x38
		::RPG::Client::TextID OptionContent; // 0x48
		::RPG::Client::TextID EffectContent; // 0x58
