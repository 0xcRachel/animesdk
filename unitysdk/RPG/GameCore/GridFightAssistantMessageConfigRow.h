...
#define RPG_GAMECORE_GRIDFIGHTASSISTANTMESSAGECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AC7C360)
#define RPG_GAMECORE_GRIDFIGHTASSISTANTMESSAGECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC7C6E0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 EndDivisionID; // 0x28
		::System::Int32 ExclusiveID; // 0x2C
		::RPG::GameCore::GridFightAssistantType AssistantMessageType; // 0x30
