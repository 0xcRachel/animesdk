...
#define RPG_GAMECORE_BYRANKACTIVATED_METHOD_4_36BE7F36C2957562_OFFSET UNITYSDK_OFFSET(0x1693C930)
#define RPG_GAMECORE_BYRANKACTIVATED_METHOD_4_98636A5184255F76_OFFSET UNITYSDK_OFFSET(0x1693C860)
#define RPG_GAMECORE_BYRANKACTIVATED__CTOR_OFFSET UNITYSDK_OFFSET(0x1693C8E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByRankActivated_TypeDefinitionIndex = 20715;
