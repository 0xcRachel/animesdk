...
#define RPG_GAMECORE_ST_SIDE_NOTIFYSPECIALEVENT_METHOD_4_32302FCE013F11CA_OFFSET UNITYSDK_OFFSET(0x16EF8840)
#define RPG_GAMECORE_ST_SIDE_NOTIFYSPECIALEVENT_METHOD_4_652E3AA1137305A8_OFFSET UNITYSDK_OFFSET(0x16EEA6A0)
#define RPG_GAMECORE_ST_SIDE_NOTIFYSPECIALEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x16EEA640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_NotifySpecialEvent_TypeDefinitionIndex = 17900;
