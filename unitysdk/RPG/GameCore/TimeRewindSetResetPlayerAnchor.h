...
#define RPG_GAMECORE_TIMEREWINDSETRESETPLAYERANCHOR_METHOD_3_243787FF977EA3B3_OFFSET UNITYSDK_OFFSET(0x1789DFB0)
#define RPG_GAMECORE_TIMEREWINDSETRESETPLAYERANCHOR_METHOD_3_C02ED1E249B6C167_OFFSET UNITYSDK_OFFSET(0x178B47F0)
#define RPG_GAMECORE_TIMEREWINDSETRESETPLAYERANCHOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1789DF80)
