...
#define RPG_GAMECORE_GROUPPROPERTYCONFIG_METHOD_2_6E26656A9824F8DA_OFFSET UNITYSDK_OFFSET(0x1A1C7CF0)
#define RPG_GAMECORE_GROUPPROPERTYCONFIG_METHOD_2_724DD9EDC6AB92CC_OFFSET UNITYSDK_OFFSET(0x1A1C7F80)
#define RPG_GAMECORE_GROUPPROPERTYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1C7F70)
