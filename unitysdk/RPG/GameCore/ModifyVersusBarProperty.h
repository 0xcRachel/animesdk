...
#define RPG_GAMECORE_MODIFYVERSUSBARPROPERTY_METHOD_3_1A4469B4285A2608_OFFSET UNITYSDK_OFFSET(0x16CC3540)
#define RPG_GAMECORE_MODIFYVERSUSBARPROPERTY_METHOD_3_80B89F377FA71134_OFFSET UNITYSDK_OFFSET(0x16CC34C0)
#define RPG_GAMECORE_MODIFYVERSUSBARPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x16CC3510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyVersusBarProperty_TypeDefinitionIndex = 20826;
