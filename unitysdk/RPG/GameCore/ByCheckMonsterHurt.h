...
#define RPG_GAMECORE_BYCHECKMONSTERHURT_METHOD_4_31675C6D34F789F1_OFFSET UNITYSDK_OFFSET(0x16903DE0)
#define RPG_GAMECORE_BYCHECKMONSTERHURT_METHOD_4_6A8FB5FF143BD1F3_OFFSET UNITYSDK_OFFSET(0x16903D10)
#define RPG_GAMECORE_BYCHECKMONSTERHURT__CTOR_OFFSET UNITYSDK_OFFSET(0x16903D90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckMonsterHurt_TypeDefinitionIndex = 21107;
