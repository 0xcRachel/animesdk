...
#define RPG_GAMECORE_CHARACTERHEADRESETLOOKATSPEED_METHOD_3_7C3A523F5173E6DE_OFFSET UNITYSDK_OFFSET(0x1696FE00)
#define RPG_GAMECORE_CHARACTERHEADRESETLOOKATSPEED_METHOD_3_FDE47A0733DFEC4F_OFFSET UNITYSDK_OFFSET(0x1696FE80)
#define RPG_GAMECORE_CHARACTERHEADRESETLOOKATSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x1696FE50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterHeadResetLookAtSpeed_TypeDefinitionIndex = 18673;
