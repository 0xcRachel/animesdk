...
#define RPG_GAMECORE_ADVPLAYERPUSHDOWNPROP_METHOD_3_3C959566DABF319E_OFFSET UNITYSDK_OFFSET(0x19BEDC70)
#define RPG_GAMECORE_ADVPLAYERPUSHDOWNPROP_METHOD_3_DAF2F3C0D58D81F2_OFFSET UNITYSDK_OFFSET(0x19BEDCF0)
#define RPG_GAMECORE_ADVPLAYERPUSHDOWNPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x19BEDCC0)
