...
#define RPG_GAMECORE_ADVPLAYERPUSHDOWNPROP_METHOD_3_60179C75C48A23D0_OFFSET UNITYSDK_OFFSET(0x16842B80)
#define RPG_GAMECORE_ADVPLAYERPUSHDOWNPROP_METHOD_3_64838D4482E6F6C0_OFFSET UNITYSDK_OFFSET(0x16842C00)
#define RPG_GAMECORE_ADVPLAYERPUSHDOWNPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x16842BD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvPlayerPushDownProp_TypeDefinitionIndex = 19890;
