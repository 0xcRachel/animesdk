...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSWITCHHPANDGOLDCONFIG_METHOD_3_4577E213952E3797_OFFSET UNITYSDK_OFFSET(0x1A1A7EC0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSWITCHHPANDGOLDCONFIG_METHOD_3_FD323F837EE9599E_OFFSET UNITYSDK_OFFSET(0x1A1A7DF0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSWITCHHPANDGOLDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1A7E70)
