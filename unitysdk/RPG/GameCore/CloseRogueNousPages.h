...
#define RPG_GAMECORE_CLOSEROGUENOUSPAGES_METHOD_3_531D4BB45A931610_OFFSET UNITYSDK_OFFSET(0x169B6110)
#define RPG_GAMECORE_CLOSEROGUENOUSPAGES_METHOD_3_FC1DC1E9D3229A44_OFFSET UNITYSDK_OFFSET(0x169B6000)
#define RPG_GAMECORE_CLOSEROGUENOUSPAGES__CTOR_OFFSET UNITYSDK_OFFSET(0x169B60E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CloseRogueNousPages_TypeDefinitionIndex = 21763;
