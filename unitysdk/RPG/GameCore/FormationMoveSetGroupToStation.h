...
#define RPG_GAMECORE_FORMATIONMOVESETGROUPTOSTATION_METHOD_3_004E70F0A682D94A_OFFSET UNITYSDK_OFFSET(0x191FFA40)
#define RPG_GAMECORE_FORMATIONMOVESETGROUPTOSTATION_METHOD_3_CDEE83DB80680D85_OFFSET UNITYSDK_OFFSET(0x191FF9C0)
#define RPG_GAMECORE_FORMATIONMOVESETGROUPTOSTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x191FFA10)
