...
#define RPG_GAMECORE_FREESTYLECHARACTEREXTENDLAYERCONFIG_METHOD_2_19ED7A84CF9A14BB_OFFSET UNITYSDK_OFFSET(0x16AE86F0)
#define RPG_GAMECORE_FREESTYLECHARACTEREXTENDLAYERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16AE8820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FreeStyleCharacterExtendLayerConfig_TypeDefinitionIndex = 14674;
