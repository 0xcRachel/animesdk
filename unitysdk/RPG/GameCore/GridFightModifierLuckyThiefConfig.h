...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLUCKYTHIEFCONFIG_METHOD_3_1F31AE816BA500E2_OFFSET UNITYSDK_OFFSET(0x16B2F500)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLUCKYTHIEFCONFIG_METHOD_3_6E4355A791A266EB_OFFSET UNITYSDK_OFFSET(0x16B33540)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLUCKYTHIEFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16B2F4B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierLuckyThiefConfig_TypeDefinitionIndex = 17381;
