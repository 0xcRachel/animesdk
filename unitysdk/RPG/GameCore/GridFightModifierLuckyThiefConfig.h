...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLUCKYTHIEFCONFIG_METHOD_3_1F31AE816BA500E2_OFFSET UNITYSDK_OFFSET(0x1727C5C0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLUCKYTHIEFCONFIG_METHOD_3_6E4355A791A266EB_OFFSET UNITYSDK_OFFSET(0x1727FAC0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLUCKYTHIEFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1727C570)
