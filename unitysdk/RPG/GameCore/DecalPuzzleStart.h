...
#define RPG_GAMECORE_DECALPUZZLESTART_METHOD_3_0A511B9FFF6626A7_OFFSET UNITYSDK_OFFSET(0x169E8560)
#define RPG_GAMECORE_DECALPUZZLESTART_METHOD_3_BF52ABBFF77B30F2_OFFSET UNITYSDK_OFFSET(0x169E84C0)
#define RPG_GAMECORE_DECALPUZZLESTART__CTOR_OFFSET UNITYSDK_OFFSET(0x169E8520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DecalPuzzleStart_TypeDefinitionIndex = 18983;
