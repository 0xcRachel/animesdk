...
#define RPG_GAMECORE_DECALPUZZLESTART_METHOD_3_0A511B9FFF6626A7_OFFSET UNITYSDK_OFFSET(0x19580BF0)
#define RPG_GAMECORE_DECALPUZZLESTART_METHOD_3_BF52ABBFF77B30F2_OFFSET UNITYSDK_OFFSET(0x19580B50)
#define RPG_GAMECORE_DECALPUZZLESTART__CTOR_OFFSET UNITYSDK_OFFSET(0x19580BB0)
