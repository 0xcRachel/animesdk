...
#define RPG_GAMECORE_ADVSETNPCCONICALVISIONSCONFIG_METHOD_3_0E19A36C6AF2459D_OFFSET UNITYSDK_OFFSET(0x16848E80)
#define RPG_GAMECORE_ADVSETNPCCONICALVISIONSCONFIG_METHOD_3_E98B2782D205EB7E_OFFSET UNITYSDK_OFFSET(0x16848E00)
#define RPG_GAMECORE_ADVSETNPCCONICALVISIONSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16848E50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetNpcConicalVisionsConfig_TypeDefinitionIndex = 17756;
