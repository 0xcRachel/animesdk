...
#define RPG_GAMECORE_FIVEDIMSCROLLVIEWCONFIG_METHOD_3_7A7DC23F44E44D92_OFFSET UNITYSDK_OFFSET(0x16AD1B60)
#define RPG_GAMECORE_FIVEDIMSCROLLVIEWCONFIG_METHOD_3_7A9E306ECE7247D5_OFFSET UNITYSDK_OFFSET(0x16AD1AF0)
#define RPG_GAMECORE_FIVEDIMSCROLLVIEWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16AD1B40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimScrollViewConfig_TypeDefinitionIndex = 16638;
