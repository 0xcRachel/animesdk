...
#define RPG_GAMECORE_FIVEDIMSCROLLVIEWCONFIG_METHOD_3_7A7DC23F44E44D92_OFFSET UNITYSDK_OFFSET(0x1721C470)
#define RPG_GAMECORE_FIVEDIMSCROLLVIEWCONFIG_METHOD_3_7A9E306ECE7247D5_OFFSET UNITYSDK_OFFSET(0x1721C400)
#define RPG_GAMECORE_FIVEDIMSCROLLVIEWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1721C450)
