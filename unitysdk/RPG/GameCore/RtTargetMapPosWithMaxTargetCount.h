...
#define RPG_GAMECORE_RTTARGETMAPPOSWITHMAXTARGETCOUNT_METHOD_3_2A26C61F71C21E37_OFFSET UNITYSDK_OFFSET(0x1A160140)
#define RPG_GAMECORE_RTTARGETMAPPOSWITHMAXTARGETCOUNT_METHOD_3_31D04DB4C32E00BD_OFFSET UNITYSDK_OFFSET(0x1A15FE70)
#define RPG_GAMECORE_RTTARGETMAPPOSWITHMAXTARGETCOUNT_METHOD_3_D2FBE6CFE6D41632_OFFSET UNITYSDK_OFFSET(0x1A1601F0)
#define RPG_GAMECORE_RTTARGETMAPPOSWITHMAXTARGETCOUNT_METHOD_3_DCB7AEC85F78771A_OFFSET UNITYSDK_OFFSET(0x1A15FF90)
#define RPG_GAMECORE_RTTARGETMAPPOSWITHMAXTARGETCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A15FF20)
