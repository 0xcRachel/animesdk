...
#define RPG_GAMECORE_CHIMERADUELPARALLELNODE_METHOD_3_B9145CE905CD20BE_OFFSET UNITYSDK_OFFSET(0x16994770)
#define RPG_GAMECORE_CHIMERADUELPARALLELNODE_METHOD_3_D2FA51C858137555_OFFSET UNITYSDK_OFFSET(0x16994690)
#define RPG_GAMECORE_CHIMERADUELPARALLELNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x16994720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelParallelNode_TypeDefinitionIndex = 14426;
