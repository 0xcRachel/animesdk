...
#define RPG_GAMECORE_PILLARPUZZLEINTERACT_METHOD_3_265D1B8112A42D65_OFFSET UNITYSDK_OFFSET(0x174C25F0)
#define RPG_GAMECORE_PILLARPUZZLEINTERACT_METHOD_3_D9A6DFFE758EBC11_OFFSET UNITYSDK_OFFSET(0x174C24E0)
#define RPG_GAMECORE_PILLARPUZZLEINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x174C25C0)
