...
#define RPG_GAMECORE_PILLARPUZZLEINTERACT_METHOD_3_265D1B8112A42D65_OFFSET UNITYSDK_OFFSET(0x16D3A7A0)
#define RPG_GAMECORE_PILLARPUZZLEINTERACT_METHOD_3_D9A6DFFE758EBC11_OFFSET UNITYSDK_OFFSET(0x16D3A690)
#define RPG_GAMECORE_PILLARPUZZLEINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x16D3A770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PillarPuzzleInteract_TypeDefinitionIndex = 18150;
