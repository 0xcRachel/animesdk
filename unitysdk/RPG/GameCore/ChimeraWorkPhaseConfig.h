...
#define RPG_GAMECORE_CHIMERAWORKPHASECONFIG_METHOD_2_4228BB14C3B29235_OFFSET UNITYSDK_OFFSET(0x1A309BE0)
#define RPG_GAMECORE_CHIMERAWORKPHASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A309F30)
