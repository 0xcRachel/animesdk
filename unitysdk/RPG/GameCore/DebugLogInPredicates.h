...
#define RPG_GAMECORE_DEBUGLOGINPREDICATES_METHOD_4_5A54955D0B4E9870_OFFSET UNITYSDK_OFFSET(0x18FBFF00)
#define RPG_GAMECORE_DEBUGLOGINPREDICATES_METHOD_4_E0D47C77686CE018_OFFSET UNITYSDK_OFFSET(0x18FBFFE0)
#define RPG_GAMECORE_DEBUGLOGINPREDICATES__CTOR_OFFSET UNITYSDK_OFFSET(0x18FBFF80)
