...
#define RPG_GAMECORE_MONSTERBEHAVIOUR_METHOD_3_0739ADF5CE49F1F4_OFFSET UNITYSDK_OFFSET(0x16CD70B0)
#define RPG_GAMECORE_MONSTERBEHAVIOUR_METHOD_3_D91E736D0D7C40E4_OFFSET UNITYSDK_OFFSET(0x16CD7030)
#define RPG_GAMECORE_MONSTERBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x16CD7080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonsterBehaviour_TypeDefinitionIndex = 21751;
