...
#define RPG_GAMECORE_MONSTERBEHAVIOUR_METHOD_3_0739ADF5CE49F1F4_OFFSET UNITYSDK_OFFSET(0x190DDD10)
#define RPG_GAMECORE_MONSTERBEHAVIOUR_METHOD_3_D91E736D0D7C40E4_OFFSET UNITYSDK_OFFSET(0x190DDC90)
#define RPG_GAMECORE_MONSTERBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x190DDCE0)
