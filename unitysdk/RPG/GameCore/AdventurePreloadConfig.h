...
#define RPG_GAMECORE_ADVENTUREPRELOADCONFIG_METHOD_2_64042C79B01A5CE4_OFFSET UNITYSDK_OFFSET(0x16F6DBF0)
#define RPG_GAMECORE_ADVENTUREPRELOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F6DDF0)
