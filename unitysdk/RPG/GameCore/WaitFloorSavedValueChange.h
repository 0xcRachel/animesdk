...
#define RPG_GAMECORE_WAITFLOORSAVEDVALUECHANGE_METHOD_3_73FE11397DD8D486_OFFSET UNITYSDK_OFFSET(0x17151A20)
#define RPG_GAMECORE_WAITFLOORSAVEDVALUECHANGE_METHOD_3_980409FCC60114B5_OFFSET UNITYSDK_OFFSET(0x17151AA0)
#define RPG_GAMECORE_WAITFLOORSAVEDVALUECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x17151A70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitFloorSavedValueChange_TypeDefinitionIndex = 18507;
