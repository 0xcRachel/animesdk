...
#define RPG_GAMECORE_BYPHOTOGRAPHFOVLEVEL_METHOD_4_81926D5C6B276F97_OFFSET UNITYSDK_OFFSET(0x1693B3F0)
#define RPG_GAMECORE_BYPHOTOGRAPHFOVLEVEL_METHOD_4_88842F397F900EA9_OFFSET UNITYSDK_OFFSET(0x1693B320)
#define RPG_GAMECORE_BYPHOTOGRAPHFOVLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1693B3A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByPhotoGraphFovLevel_TypeDefinitionIndex = 19292;
