...
#define RPG_GAMECORE_TARGETSORTBYWEAKNESSMATCH_METHOD_3_27FD06F3DCC54FB2_OFFSET UNITYSDK_OFFSET(0x17135CB0)
#define RPG_GAMECORE_TARGETSORTBYWEAKNESSMATCH_METHOD_3_EB054EE9DAD10D7E_OFFSET UNITYSDK_OFFSET(0x17134CA0)
#define RPG_GAMECORE_TARGETSORTBYWEAKNESSMATCH__CTOR_OFFSET UNITYSDK_OFFSET(0x17134C80)
