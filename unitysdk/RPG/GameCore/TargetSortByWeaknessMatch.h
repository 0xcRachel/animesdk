...
#define RPG_GAMECORE_TARGETSORTBYWEAKNESSMATCH_METHOD_3_27FD06F3DCC54FB2_OFFSET UNITYSDK_OFFSET(0x16FF2BC0)
#define RPG_GAMECORE_TARGETSORTBYWEAKNESSMATCH_METHOD_3_EB054EE9DAD10D7E_OFFSET UNITYSDK_OFFSET(0x16FF1C70)
#define RPG_GAMECORE_TARGETSORTBYWEAKNESSMATCH__CTOR_OFFSET UNITYSDK_OFFSET(0x16FF1C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSortByWeaknessMatch_TypeDefinitionIndex = 21706;
