...
#define RPG_GAMECORE_ADVLOGISTICSROBOTTRIGGERLOAD_METHOD_3_AF0092D266DCC1AB_OFFSET UNITYSDK_OFFSET(0x18C4D340)
#define RPG_GAMECORE_ADVLOGISTICSROBOTTRIGGERLOAD_METHOD_3_BDD537DECE9CD737_OFFSET UNITYSDK_OFFSET(0x18C4D230)
#define RPG_GAMECORE_ADVLOGISTICSROBOTTRIGGERLOAD__CTOR_OFFSET UNITYSDK_OFFSET(0x18C4D310)
