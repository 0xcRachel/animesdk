...
#define RPG_GAMECORE_UNIQUEPROPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1713C250)
#define RPG_GAMECORE_UNIQUEPROPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1713C380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UniquePropRow_TypeDefinitionIndex = 11886;
