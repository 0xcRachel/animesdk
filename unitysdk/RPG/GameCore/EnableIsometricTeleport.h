...
#define RPG_GAMECORE_ENABLEISOMETRICTELEPORT_METHOD_3_1D6B59F84E830D15_OFFSET UNITYSDK_OFFSET(0x16A6A590)
#define RPG_GAMECORE_ENABLEISOMETRICTELEPORT_METHOD_3_DF2FBF15378DCE24_OFFSET UNITYSDK_OFFSET(0x16A6A510)
#define RPG_GAMECORE_ENABLEISOMETRICTELEPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x16A6A560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableIsometricTeleport_TypeDefinitionIndex = 19858;
