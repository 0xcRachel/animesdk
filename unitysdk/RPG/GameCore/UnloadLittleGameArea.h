...
#define RPG_GAMECORE_UNLOADLITTLEGAMEAREA_METHOD_3_94FC5B64EBD94EF0_OFFSET UNITYSDK_OFFSET(0x1713F330)
#define RPG_GAMECORE_UNLOADLITTLEGAMEAREA_METHOD_3_B624C2FE75A1A29E_OFFSET UNITYSDK_OFFSET(0x1713F480)
#define RPG_GAMECORE_UNLOADLITTLEGAMEAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x1713F3F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UnloadLittleGameArea_TypeDefinitionIndex = 18800;
