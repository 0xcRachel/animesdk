...
#define RPG_GAMECORE_UNLOADLITTLEGAMEAREA_METHOD_3_94FC5B64EBD94EF0_OFFSET UNITYSDK_OFFSET(0x19512F90)
#define RPG_GAMECORE_UNLOADLITTLEGAMEAREA_METHOD_3_B624C2FE75A1A29E_OFFSET UNITYSDK_OFFSET(0x195130E0)
#define RPG_GAMECORE_UNLOADLITTLEGAMEAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x19513050)
