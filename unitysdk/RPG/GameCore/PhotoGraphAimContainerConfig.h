...
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAINERCONFIG_METHOD_2_04DFE3C278C2F549_OFFSET UNITYSDK_OFFSET(0x18B1BD30)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAINERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18B1C2B0)
