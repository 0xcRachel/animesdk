...
#define RPG_GAMECORE_PROPDAILYICON_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16DA6F30)
#define RPG_GAMECORE_PROPDAILYICON__CTOR_OFFSET UNITYSDK_OFFSET(0x16DA70D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropDailyIcon_TypeDefinitionIndex = 11371;
