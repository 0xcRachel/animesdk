...
#define RPG_GAMECORE_TRIGGERFARMELEMENTANIMSTATE_METHOD_3_A0521901D492545F_OFFSET UNITYSDK_OFFSET(0x178DBB50)
#define RPG_GAMECORE_TRIGGERFARMELEMENTANIMSTATE_METHOD_3_E0FE990A761437C9_OFFSET UNITYSDK_OFFSET(0x178DBBF0)
#define RPG_GAMECORE_TRIGGERFARMELEMENTANIMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x178DBBB0)
