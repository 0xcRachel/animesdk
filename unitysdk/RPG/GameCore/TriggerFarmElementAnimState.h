...
#define RPG_GAMECORE_TRIGGERFARMELEMENTANIMSTATE_METHOD_3_A0521901D492545F_OFFSET UNITYSDK_OFFSET(0x1711FB70)
#define RPG_GAMECORE_TRIGGERFARMELEMENTANIMSTATE_METHOD_3_E0FE990A761437C9_OFFSET UNITYSDK_OFFSET(0x1711FC10)
#define RPG_GAMECORE_TRIGGERFARMELEMENTANIMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1711FBD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerFarmElementAnimState_TypeDefinitionIndex = 19745;
