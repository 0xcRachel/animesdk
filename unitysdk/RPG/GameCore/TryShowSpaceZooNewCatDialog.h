...
#define RPG_GAMECORE_TRYSHOWSPACEZOONEWCATDIALOG_METHOD_3_7EF957C951574DE3_OFFSET UNITYSDK_OFFSET(0x17129E10)
#define RPG_GAMECORE_TRYSHOWSPACEZOONEWCATDIALOG_METHOD_3_EE09CD3CAAEC30F7_OFFSET UNITYSDK_OFFSET(0x17129F20)
#define RPG_GAMECORE_TRYSHOWSPACEZOONEWCATDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x17129EF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TryShowSpaceZooNewCatDialog_TypeDefinitionIndex = 18714;
