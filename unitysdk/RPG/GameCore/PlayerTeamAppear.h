...
#define RPG_GAMECORE_PLAYERTEAMAPPEAR_METHOD_3_6C9F1A862BB8F8CE_OFFSET UNITYSDK_OFFSET(0x16D775B0)
#define RPG_GAMECORE_PLAYERTEAMAPPEAR_METHOD_3_A594AD8C7AC57AFF_OFFSET UNITYSDK_OFFSET(0x16D77630)
#define RPG_GAMECORE_PLAYERTEAMAPPEAR__CTOR_OFFSET UNITYSDK_OFFSET(0x16D77600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayerTeamAppear_TypeDefinitionIndex = 20613;
