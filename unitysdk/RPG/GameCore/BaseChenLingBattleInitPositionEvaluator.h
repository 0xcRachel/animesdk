...
#define RPG_GAMECORE_BASECHENLINGBATTLEINITPOSITIONEVALUATOR_METHOD_2_1DCCCD49592605B6_OFFSET UNITYSDK_OFFSET(0x16FD8BB0)
#define RPG_GAMECORE_BASECHENLINGBATTLEINITPOSITIONEVALUATOR_METHOD_2_E03EB03FC1322D92_OFFSET UNITYSDK_OFFSET(0x16FD8970)
#define RPG_GAMECORE_BASECHENLINGBATTLEINITPOSITIONEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD8C10)
