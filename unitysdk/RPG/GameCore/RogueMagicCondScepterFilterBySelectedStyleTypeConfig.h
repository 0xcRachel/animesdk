...
#define RPG_GAMECORE_ROGUEMAGICCONDSCEPTERFILTERBYSELECTEDSTYLETYPECONFIG_METHOD_7_368DD03CBB74E789_OFFSET UNITYSDK_OFFSET(0x176265C0)
#define RPG_GAMECORE_ROGUEMAGICCONDSCEPTERFILTERBYSELECTEDSTYLETYPECONFIG_METHOD_7_BCC6383707C2E41D_OFFSET UNITYSDK_OFFSET(0x17626780)
#define RPG_GAMECORE_ROGUEMAGICCONDSCEPTERFILTERBYSELECTEDSTYLETYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176266C0)
