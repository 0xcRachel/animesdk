...
#define RPG_GAMECORE_SHOWROGUETALKBG_METHOD_3_134CE06222EB946C_OFFSET UNITYSDK_OFFSET(0x17716CA0)
#define RPG_GAMECORE_SHOWROGUETALKBG_METHOD_3_857B436DFB72426D_OFFSET UNITYSDK_OFFSET(0x17716C20)
#define RPG_GAMECORE_SHOWROGUETALKBG__CTOR_OFFSET UNITYSDK_OFFSET(0x17716C70)
