...
#define RPG_GAMECORE_TARGETMAPSKILLINDICATORTARGET_METHOD_3_655FC2AE87489A59_OFFSET UNITYSDK_OFFSET(0x16FE30D0)
#define RPG_GAMECORE_TARGETMAPSKILLINDICATORTARGET_METHOD_3_B501871CBD6F1EE8_OFFSET UNITYSDK_OFFSET(0x16FE3190)
#define RPG_GAMECORE_TARGETMAPSKILLINDICATORTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE3170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapSkillIndicatorTarget_TypeDefinitionIndex = 21743;
