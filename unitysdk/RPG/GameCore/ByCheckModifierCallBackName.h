...
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKNAME_METHOD_4_677CCFB5331CFA80_OFFSET UNITYSDK_OFFSET(0x170141A0)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKNAME_METHOD_4_F165D56D331D2338_OFFSET UNITYSDK_OFFSET(0x17014270)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x17014220)
