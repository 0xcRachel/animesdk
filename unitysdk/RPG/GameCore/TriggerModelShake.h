...
#define RPG_GAMECORE_TRIGGERMODELSHAKE_METHOD_3_517FE5AA8A675291_OFFSET UNITYSDK_OFFSET(0x1911A8D0)
#define RPG_GAMECORE_TRIGGERMODELSHAKE_METHOD_3_F6C54E17558263FA_OFFSET UNITYSDK_OFFSET(0x1911A7F0)
#define RPG_GAMECORE_TRIGGERMODELSHAKE__CTOR_OFFSET UNITYSDK_OFFSET(0x1911A870)
