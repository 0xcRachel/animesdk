...
#define RPG_GAMECORE_CREATESERVANT_METHOD_3_04581EF9C04F4BB6_OFFSET UNITYSDK_OFFSET(0x18FB09E0)
#define RPG_GAMECORE_CREATESERVANT_METHOD_3_11BB7A6D8E737672_OFFSET UNITYSDK_OFFSET(0x18FB0A60)
#define RPG_GAMECORE_CREATESERVANT__CTOR_OFFSET UNITYSDK_OFFSET(0x18FB0A30)
