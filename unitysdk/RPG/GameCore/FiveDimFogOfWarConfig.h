...
#define RPG_GAMECORE_FIVEDIMFOGOFWARCONFIG_METHOD_2_4F464EFE6E5226B6_OFFSET UNITYSDK_OFFSET(0x16ABDF30)
#define RPG_GAMECORE_FIVEDIMFOGOFWARCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16ABE0D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimFogOfWarConfig_TypeDefinitionIndex = 16623;
