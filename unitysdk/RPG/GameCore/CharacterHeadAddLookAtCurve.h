...
#define RPG_GAMECORE_CHARACTERHEADADDLOOKATCURVE_METHOD_3_4A825CA9E80EB76F_OFFSET UNITYSDK_OFFSET(0x17080C90)
#define RPG_GAMECORE_CHARACTERHEADADDLOOKATCURVE_METHOD_3_FF9B2887871438EF_OFFSET UNITYSDK_OFFSET(0x17080DB0)
#define RPG_GAMECORE_CHARACTERHEADADDLOOKATCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x17080D30)
