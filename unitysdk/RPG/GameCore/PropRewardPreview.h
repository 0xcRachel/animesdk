...
#define RPG_GAMECORE_PROPREWARDPREVIEW_METHOD_3_0E9D5F2810DD604A_OFFSET UNITYSDK_OFFSET(0x16DB1800)
#define RPG_GAMECORE_PROPREWARDPREVIEW_METHOD_3_8C194FB138FB7FFB_OFFSET UNITYSDK_OFFSET(0x16DB1880)
#define RPG_GAMECORE_PROPREWARDPREVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x16DB1850)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropRewardPreview_TypeDefinitionIndex = 19721;
