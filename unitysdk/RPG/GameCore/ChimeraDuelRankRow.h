...
#define RPG_GAMECORE_CHIMERADUELRANKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16996340)
#define RPG_GAMECORE_CHIMERADUELRANKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x169969C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelRankRow_TypeDefinitionIndex = 10338;
