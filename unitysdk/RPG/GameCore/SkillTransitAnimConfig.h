...
#define RPG_GAMECORE_SKILLTRANSITANIMCONFIG_METHOD_2_9F5BFB09BA7A9AB6_OFFSET UNITYSDK_OFFSET(0x16F6E150)
#define RPG_GAMECORE_SKILLTRANSITANIMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F6E380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SkillTransitAnimConfig_TypeDefinitionIndex = 14860;
