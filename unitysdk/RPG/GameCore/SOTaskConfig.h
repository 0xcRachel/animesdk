...
#define RPG_GAMECORE_SOTASKCONFIG_METHOD_3_5FE05F69D94CF677_OFFSET UNITYSDK_OFFSET(0x16EDB490)
#define RPG_GAMECORE_SOTASKCONFIG_METHOD_3_F23728469566E01A_OFFSET UNITYSDK_OFFSET(0x16EDCDC0)
#define RPG_GAMECORE_SOTASKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16EDB360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SOTaskConfig_TypeDefinitionIndex = 17811;
