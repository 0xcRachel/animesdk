...
#define RPG_GAMECORE_SOTASKCONFIG_METHOD_3_5FE05F69D94CF677_OFFSET UNITYSDK_OFFSET(0x1768FB80)
#define RPG_GAMECORE_SOTASKCONFIG_METHOD_3_F23728469566E01A_OFFSET UNITYSDK_OFFSET(0x17691540)
#define RPG_GAMECORE_SOTASKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1768FA50)
