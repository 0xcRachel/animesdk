...
#define RPG_GAMECORE_ROGUEMAGICUNITROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19EC6830)
#define RPG_GAMECORE_ROGUEMAGICUNITROW_GETMAZEBUFF_OFFSET UNITYSDK_OFFSET(0x19EC6E40)
#define RPG_GAMECORE_ROGUEMAGICUNITROW_GET_ISACTIVEUNIT_OFFSET UNITYSDK_OFFSET(0x19EC6F50)
#define RPG_GAMECORE_ROGUEMAGICUNITROW_GET_ISPASSIVEUNIT_OFFSET UNITYSDK_OFFSET(0x19EC6F40)
#define RPG_GAMECORE_ROGUEMAGICUNITROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19EC6E30)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::FixPoint UnitBasicPower; // 0x28
		::RPG::GameCore::RogueMagicUnitCategory MagicUnitCategory; // 0x30
		::System::UInt32 MagicUnitMazeBuffID; // 0x34
		::System::UInt32 MagicUnitID; // 0x38
		::RPG::GameCore::RogueMagicMountType MagicUnitType; // 0x3C
		::RPG::GameCore::RogueMagicRangeType LimitRange; // 0x40
		::RPG::GameCore::RogueMagicSpecialType SpecialType; // 0x44
		::RPG::Client::TextID MagicUnitSimpleDesc; // 0x48
		::RPG::GameCore::RogueMagicScepterFuncType FuncType; // 0x58
		::System::UInt32 MagicUnitLevel; // 0x5C
		::RPG::GameCore::RogueMagicStyleType StyleType; // 0x60
		::System::UInt32 UnlockID; // 0x64
		::RPG::Client::TextID MagicUnitDesc; // 0x68
