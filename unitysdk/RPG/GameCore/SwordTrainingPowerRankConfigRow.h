...
#define RPG_GAMECORE_SWORDTRAININGPOWERRANKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19868060)
#define RPG_GAMECORE_SWORDTRAININGPOWERRANKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19868410)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID RankProgressName; // 0x30
		::System::UInt32 PowerRequire; // 0x40
