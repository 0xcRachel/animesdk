...
#define RPG_GAMECORE_SWORDTRAININGPOWERRANKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18D94B30)
#define RPG_GAMECORE_SWORDTRAININGPOWERRANKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18D94EE0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 PowerRequire; // 0x28
		::System::UInt32 RankGroupID; // 0x2C
		::RPG::Client::TextID RankGroupName; // 0x30
		::System::UInt32 UnlockID; // 0x40
		::System::UInt32 RankID; // 0x44
