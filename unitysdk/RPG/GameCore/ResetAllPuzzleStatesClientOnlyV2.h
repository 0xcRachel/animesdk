...
#define RPG_GAMECORE_RESETALLPUZZLESTATESCLIENTONLYV2_METHOD_3_1F00231B24AD54D4_OFFSET UNITYSDK_OFFSET(0x16DE4CB0)
#define RPG_GAMECORE_RESETALLPUZZLESTATESCLIENTONLYV2_METHOD_3_2E06855AE39F4B65_OFFSET UNITYSDK_OFFSET(0x16DE4C30)
#define RPG_GAMECORE_RESETALLPUZZLESTATESCLIENTONLYV2__CTOR_OFFSET UNITYSDK_OFFSET(0x16DE4C80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetAllPuzzleStatesClientOnlyV2_TypeDefinitionIndex = 18982;
