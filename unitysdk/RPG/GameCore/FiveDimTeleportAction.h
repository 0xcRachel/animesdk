...
#define RPG_GAMECORE_FIVEDIMTELEPORTACTION_METHOD_3_0EA890DB81AD620E_OFFSET UNITYSDK_OFFSET(0x1A3A9110)
#define RPG_GAMECORE_FIVEDIMTELEPORTACTION_METHOD_3_1BA6B0EED99DB807_OFFSET UNITYSDK_OFFSET(0x1A3A9180)
#define RPG_GAMECORE_FIVEDIMTELEPORTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3A9160)
