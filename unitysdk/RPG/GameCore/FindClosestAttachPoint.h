...
#define RPG_GAMECORE_FINDCLOSESTATTACHPOINT_METHOD_3_989F5F9A0E08994B_OFFSET UNITYSDK_OFFSET(0x171EB530)
#define RPG_GAMECORE_FINDCLOSESTATTACHPOINT_METHOD_3_B4CA7853AC6BABFE_OFFSET UNITYSDK_OFFSET(0x171EB5B0)
#define RPG_GAMECORE_FINDCLOSESTATTACHPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x171EB580)
