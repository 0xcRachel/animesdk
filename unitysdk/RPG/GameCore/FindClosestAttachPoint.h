...
#define RPG_GAMECORE_FINDCLOSESTATTACHPOINT_METHOD_3_989F5F9A0E08994B_OFFSET UNITYSDK_OFFSET(0x16AA60B0)
#define RPG_GAMECORE_FINDCLOSESTATTACHPOINT_METHOD_3_B4CA7853AC6BABFE_OFFSET UNITYSDK_OFFSET(0x16AA6130)
#define RPG_GAMECORE_FINDCLOSESTATTACHPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x16AA6100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FindClosestAttachPoint_TypeDefinitionIndex = 20102;
