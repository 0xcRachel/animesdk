...
#define RPG_GAMECORE_FANTASTICSTORYBATTLEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A400610)
#define RPG_GAMECORE_FANTASTICSTORYBATTLEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A400F00)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID BookContext; // 0x90
		...
		::System::UInt32 FinishQuest; // 0xB4
