...
#define RPG_GAMECORE_SHOWBATTLEWHITEBOXIMAGE_METHOD_3_09F544D5628DAD54_OFFSET UNITYSDK_OFFSET(0x1770B050)
#define RPG_GAMECORE_SHOWBATTLEWHITEBOXIMAGE_METHOD_3_B8B945CCA5D2DD05_OFFSET UNITYSDK_OFFSET(0x1770B0D0)
#define RPG_GAMECORE_SHOWBATTLEWHITEBOXIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1770B0A0)
