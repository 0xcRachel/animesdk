...
#define RPG_GAMECORE_WEATHERUIBASECONFIG_METHOD_2_9B5BE891BB8875C0_OFFSET UNITYSDK_OFFSET(0x1791DE50)
#define RPG_GAMECORE_WEATHERUIBASECONFIG_METHOD_2_D367DDDBC263D560_OFFSET UNITYSDK_OFFSET(0x1791E140)
#define RPG_GAMECORE_WEATHERUIBASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1791E130)
