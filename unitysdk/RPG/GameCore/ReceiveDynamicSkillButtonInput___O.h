...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::ControlSkillType>**)Il2CppClass::FromTypeDefinitionIndex(ReceiveDynamicSkillButtonInput___O_TypeDefinitionIndex)->GetStaticField(0x28730);
		}
	};
}
