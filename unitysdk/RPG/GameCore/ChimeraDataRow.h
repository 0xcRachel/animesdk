...
#define RPG_GAMECORE_CHIMERADATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16986FC0)
#define RPG_GAMECORE_CHIMERADATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x169873E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDataRow_TypeDefinitionIndex = 11798;
	...
	public:
		...
		::System::UInt32 RaritySetting; // 0x2C
		::RPG::GameCore::ChimeraHornsPartType Horn; // 0x30
		...
		::RPG::GameCore::ChimeraMaterialType Body; // 0x4C
