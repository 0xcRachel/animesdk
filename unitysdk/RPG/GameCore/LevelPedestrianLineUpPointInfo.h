...
#define RPG_GAMECORE_LEVELPEDESTRIANLINEUPPOINTINFO_METHOD_2_04110F5A0BAD8AEE_OFFSET UNITYSDK_OFFSET(0x18A3B700)
#define RPG_GAMECORE_LEVELPEDESTRIANLINEUPPOINTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18A3B9F0)
