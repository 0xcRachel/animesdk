...
#define RPG_GAMECORE_ADDWEAKNESS_METHOD_3_74DE26AF0687A086_OFFSET UNITYSDK_OFFSET(0x167C08C0)
#define RPG_GAMECORE_ADDWEAKNESS_METHOD_3_791E3E0837340BB7_OFFSET UNITYSDK_OFFSET(0x167C0940)
#define RPG_GAMECORE_ADDWEAKNESS__CTOR_OFFSET UNITYSDK_OFFSET(0x167C0910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddWeakness_TypeDefinitionIndex = 20742;
