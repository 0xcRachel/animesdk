...
#define RPG_GAMECORE_MONOPOLYPHASEREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16CCC480)
#define RPG_GAMECORE_MONOPOLYPHASEREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16CCCAD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyPhaseRewardRow_TypeDefinitionIndex = 10968;
