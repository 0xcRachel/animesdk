...
#define RPG_GAMECORE_MONOPOLYPHASEREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x186198F0)
#define RPG_GAMECORE_MONOPOLYPHASEREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18619F00)
