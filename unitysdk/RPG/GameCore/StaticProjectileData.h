...
#define RPG_GAMECORE_STATICPROJECTILEDATA_METHOD_3_DDFCA8D069601BDD_OFFSET UNITYSDK_OFFSET(0x1778C630)
#define RPG_GAMECORE_STATICPROJECTILEDATA_METHOD_3_E4D92800DEEA8B71_OFFSET UNITYSDK_OFFSET(0x1778C6A0)
#define RPG_GAMECORE_STATICPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1778C680)
