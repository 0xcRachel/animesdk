...
#define RPG_GAMECORE_STATICPROJECTILEDATA_METHOD_3_AD9757C0204F0EF2_OFFSET UNITYSDK_OFFSET(0x18D6D340)
#define RPG_GAMECORE_STATICPROJECTILEDATA_METHOD_3_E4D92800DEEA8B71_OFFSET UNITYSDK_OFFSET(0x18D6D3B0)
#define RPG_GAMECORE_STATICPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18D6D390)
