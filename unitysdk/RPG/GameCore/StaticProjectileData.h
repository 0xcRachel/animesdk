...
#define RPG_GAMECORE_STATICPROJECTILEDATA_METHOD_3_DDFCA8D069601BDD_OFFSET UNITYSDK_OFFSET(0x16F98AF0)
#define RPG_GAMECORE_STATICPROJECTILEDATA_METHOD_3_E4D92800DEEA8B71_OFFSET UNITYSDK_OFFSET(0x16F98B60)
#define RPG_GAMECORE_STATICPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16F98B40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StaticProjectileData_TypeDefinitionIndex = 14237;
