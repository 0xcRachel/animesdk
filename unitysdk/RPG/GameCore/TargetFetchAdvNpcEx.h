...
#define RPG_GAMECORE_TARGETFETCHADVNPCEX_METHOD_4_201A31293351DF6B_OFFSET UNITYSDK_OFFSET(0x16FD26D0)
#define RPG_GAMECORE_TARGETFETCHADVNPCEX_METHOD_4_C126435DE3ECF21F_OFFSET UNITYSDK_OFFSET(0x16FDAD60)
#define RPG_GAMECORE_TARGETFETCHADVNPCEX__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD2680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAdvNpcEx_TypeDefinitionIndex = 21582;
