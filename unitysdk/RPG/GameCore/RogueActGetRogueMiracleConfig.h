...
#define RPG_GAMECORE_ROGUEACTGETROGUEMIRACLECONFIG_METHOD_6_592AC72146B6EFE1_OFFSET UNITYSDK_OFFSET(0x1A9A55E0)
#define RPG_GAMECORE_ROGUEACTGETROGUEMIRACLECONFIG_METHOD_6_C49CD446119842AC_OFFSET UNITYSDK_OFFSET(0x1A9A53C0)
#define RPG_GAMECORE_ROGUEACTGETROGUEMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9A5500)
