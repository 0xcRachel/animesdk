...
#define RPG_GAMECORE_TAROTWIKITIMELINEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16FF7650)
#define RPG_GAMECORE_TAROTWIKITIMELINEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16FF78F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TarotWikiTimelineRow_TypeDefinitionIndex = 13866;
