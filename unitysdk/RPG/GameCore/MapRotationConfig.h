...
#define RPG_GAMECORE_MAPROTATIONCONFIG_METHOD_2_68418AA8712C707B_OFFSET UNITYSDK_OFFSET(0x16C2F160)
#define RPG_GAMECORE_MAPROTATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16C2F260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MapRotationConfig_TypeDefinitionIndex = 15335;
