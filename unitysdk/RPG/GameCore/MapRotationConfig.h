...
#define RPG_GAMECORE_MAPROTATIONCONFIG_METHOD_2_68418AA8712C707B_OFFSET UNITYSDK_OFFSET(0x18FDE490)
#define RPG_GAMECORE_MAPROTATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18FDE590)
