...
#define RPG_GAMECORE_QUERYHOYOTAG_METHOD_4_97D55DF78BD71683_OFFSET UNITYSDK_OFFSET(0x16DBE310)
#define RPG_GAMECORE_QUERYHOYOTAG_METHOD_4_BDCC204720CB4A3F_OFFSET UNITYSDK_OFFSET(0x16D9AC50)
#define RPG_GAMECORE_QUERYHOYOTAG__CTOR_OFFSET UNITYSDK_OFFSET(0x16D9AC00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int QueryHoyoTag_TypeDefinitionIndex = 18547;
