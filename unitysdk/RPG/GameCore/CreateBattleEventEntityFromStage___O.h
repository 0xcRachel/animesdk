...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::BattleEventEntitySubType>**)Il2CppClass::FromTypeDefinitionIndex(CreateBattleEventEntityFromStage___O_TypeDefinitionIndex)->GetStaticField(0x2C610);
		}
	};
}
