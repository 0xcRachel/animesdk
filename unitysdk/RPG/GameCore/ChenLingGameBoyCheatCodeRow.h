...
#define RPG_GAMECORE_CHENLINGGAMEBOYCHEATCODEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1709B570)
#define RPG_GAMECORE_CHENLINGGAMEBOYCHEATCODEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1709BBD0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* CorrectmapPath; // 0x20
		::System::String* GameBoyCheatCodeString; // 0x28
