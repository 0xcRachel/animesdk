...
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1733F420)
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLDATA_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1733F360)
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLDATA_METHOD_3_6528AFD77893149A_OFFSET UNITYSDK_OFFSET(0x1733F730)
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLDATA_METHOD_3_9C5A4AA76964B563_OFFSET UNITYSDK_OFFSET(0x1733F6F0)
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1733F720)
