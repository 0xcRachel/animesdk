...
#define RPG_GAMECORE_ADVNPCFOLLOWPLAYER_METHOD_3_8A63BAB2BE5507B3_OFFSET UNITYSDK_OFFSET(0x1683E1F0)
#define RPG_GAMECORE_ADVNPCFOLLOWPLAYER_METHOD_3_CC9AEFF5AD4DE287_OFFSET UNITYSDK_OFFSET(0x1683E2F0)
#define RPG_GAMECORE_ADVNPCFOLLOWPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1683E280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNpcFollowPlayer_TypeDefinitionIndex = 17742;
