...
#define RPG_GAMECORE_CUSTOMCAMERABATTLETRANSITIONSHOTCONFIG_METHOD_2_811104C20D37FFF7_OFFSET UNITYSDK_OFFSET(0x169D8DA0)
#define RPG_GAMECORE_CUSTOMCAMERABATTLETRANSITIONSHOTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x169D94C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CustomCameraBattleTransitionShotConfig_TypeDefinitionIndex = 18200;
	...
	public:
		...
		static ::System::Void Method_2_811104C20D37FFF7(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::CustomCameraBattleTransitionShotConfig*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::CustomCameraBattleTransitionShotConfig*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_CUSTOMCAMERABATTLETRANSITIONSHOTCONFIG_METHOD_2_811104C20D37FFF7_OFFSET))(a1, a2);
		}
	};
}
