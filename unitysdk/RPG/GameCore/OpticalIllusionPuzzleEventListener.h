...
#define RPG_GAMECORE_OPTICALILLUSIONPUZZLEEVENTLISTENER_METHOD_3_BF54EF27E3774E9A_OFFSET UNITYSDK_OFFSET(0x16D0CFB0)
#define RPG_GAMECORE_OPTICALILLUSIONPUZZLEEVENTLISTENER_METHOD_3_F5FCE435567054A4_OFFSET UNITYSDK_OFFSET(0x16D0CF30)
#define RPG_GAMECORE_OPTICALILLUSIONPUZZLEEVENTLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x16D0CF80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OpticalIllusionPuzzleEventListener_TypeDefinitionIndex = 19871;
