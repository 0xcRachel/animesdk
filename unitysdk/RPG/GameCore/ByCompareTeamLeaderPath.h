...
#define RPG_GAMECORE_BYCOMPARETEAMLEADERPATH_METHOD_4_E668CB18458F38FB_OFFSET UNITYSDK_OFFSET(0x1691EE70)
#define RPG_GAMECORE_BYCOMPARETEAMLEADERPATH_METHOD_4_E779B618B43B699D_OFFSET UNITYSDK_OFFSET(0x1691EF40)
#define RPG_GAMECORE_BYCOMPARETEAMLEADERPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1691EEF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareTeamLeaderPath_TypeDefinitionIndex = 19506;
