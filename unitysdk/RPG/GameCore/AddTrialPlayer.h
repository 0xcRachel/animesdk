...
#define RPG_GAMECORE_ADDTRIALPLAYER_METHOD_3_1A604D14CB7A6A3F_OFFSET UNITYSDK_OFFSET(0x19552FE0)
#define RPG_GAMECORE_ADDTRIALPLAYER_METHOD_3_20E82DC97ECBE28F_OFFSET UNITYSDK_OFFSET(0x19553070)
#define RPG_GAMECORE_ADDTRIALPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x19553040)
