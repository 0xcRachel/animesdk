...
#define RPG_GAMECORE_BYISFAKESKILLBYNAME_METHOD_4_7EB68258E8154814_OFFSET UNITYSDK_OFFSET(0x16930E70)
#define RPG_GAMECORE_BYISFAKESKILLBYNAME_METHOD_4_DB436A1AB89C214F_OFFSET UNITYSDK_OFFSET(0x16930F90)
#define RPG_GAMECORE_BYISFAKESKILLBYNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x16930F10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsFakeSkillByName_TypeDefinitionIndex = 20664;
