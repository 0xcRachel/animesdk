...
#define RPG_GAMECORE_INFINITEWAVENEXTMONSTERID_METHOD_3_0D1F0B4DB709D303_OFFSET UNITYSDK_OFFSET(0x16B80620)
#define RPG_GAMECORE_INFINITEWAVENEXTMONSTERID_METHOD_3_F037ABBC15D2C8B6_OFFSET UNITYSDK_OFFSET(0x16B806A0)
#define RPG_GAMECORE_INFINITEWAVENEXTMONSTERID__CTOR_OFFSET UNITYSDK_OFFSET(0x16B80670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InfiniteWaveNextMonsterId_TypeDefinitionIndex = 20413;
