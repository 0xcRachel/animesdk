...
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDCARDWEIGHTCONFIG_METHOD_3_53222C0D151EE8B5_OFFSET UNITYSDK_OFFSET(0x17104F40)
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDCARDWEIGHTCONFIG_METHOD_3_ADAD932C524F31B9_OFFSET UNITYSDK_OFFSET(0x17104F90)
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDCARDWEIGHTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17104F80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierAddCardWeightConfig_TypeDefinitionIndex = 16241;
