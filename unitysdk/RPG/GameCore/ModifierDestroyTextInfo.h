...
#define RPG_GAMECORE_MODIFIERDESTROYTEXTINFO_METHOD_2_9826FD26985A644A_OFFSET UNITYSDK_OFFSET(0x16CB5430)
#define RPG_GAMECORE_MODIFIERDESTROYTEXTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16CB5640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifierDestroyTextInfo_TypeDefinitionIndex = 15437;
