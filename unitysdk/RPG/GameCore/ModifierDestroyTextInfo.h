...
#define RPG_GAMECORE_MODIFIERDESTROYTEXTINFO_METHOD_2_9826FD26985A644A_OFFSET UNITYSDK_OFFSET(0x19078DE0)
#define RPG_GAMECORE_MODIFIERDESTROYTEXTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19078FF0)
