...
#define RPG_GAMECORE_ADVENABLEBUTTONS_METHOD_3_33C2AC6AB402EF2F_OFFSET UNITYSDK_OFFSET(0x16F3FCC0)
#define RPG_GAMECORE_ADVENABLEBUTTONS_METHOD_3_ADF9FAD9A9C842F2_OFFSET UNITYSDK_OFFSET(0x16F3FD40)
#define RPG_GAMECORE_ADVENABLEBUTTONS__CTOR_OFFSET UNITYSDK_OFFSET(0x16F3FD10)
