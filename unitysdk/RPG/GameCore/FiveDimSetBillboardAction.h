...
#define RPG_GAMECORE_FIVEDIMSETBILLBOARDACTION_METHOD_3_39D181CA47819778_OFFSET UNITYSDK_OFFSET(0x191EEAF0)
#define RPG_GAMECORE_FIVEDIMSETBILLBOARDACTION_METHOD_3_A844CBF3DE9D6FEC_OFFSET UNITYSDK_OFFSET(0x191EEA10)
#define RPG_GAMECORE_FIVEDIMSETBILLBOARDACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x191EEAD0)
