...
#define RPG_GAMECORE_PROPSETENTITYLODOFFSET_METHOD_3_BB6DBDA30ABA5553_OFFSET UNITYSDK_OFFSET(0x16DB1F90)
#define RPG_GAMECORE_PROPSETENTITYLODOFFSET_METHOD_3_C6A9ED10CFD9DE96_OFFSET UNITYSDK_OFFSET(0x16DB20E0)
#define RPG_GAMECORE_PROPSETENTITYLODOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x16DB2050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropSetEntityLodOffset_TypeDefinitionIndex = 19605;
