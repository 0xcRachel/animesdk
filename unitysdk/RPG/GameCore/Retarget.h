...
#define RPG_GAMECORE_RETARGET_METHOD_3_31A33CD639E3D3F3_OFFSET UNITYSDK_OFFSET(0x16DF3C70)
#define RPG_GAMECORE_RETARGET_METHOD_3_4D99723D11592024_OFFSET UNITYSDK_OFFSET(0x16DF3A10)
#define RPG_GAMECORE_RETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x16DF3BF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int Retarget_TypeDefinitionIndex = 20554;
