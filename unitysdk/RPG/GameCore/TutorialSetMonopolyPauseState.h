...
#define RPG_GAMECORE_TUTORIALSETMONOPOLYPAUSESTATE_METHOD_3_53610D296C27B10A_OFFSET UNITYSDK_OFFSET(0x17137670)
#define RPG_GAMECORE_TUTORIALSETMONOPOLYPAUSESTATE_METHOD_3_8D88FC75419F5053_OFFSET UNITYSDK_OFFSET(0x171375F0)
#define RPG_GAMECORE_TUTORIALSETMONOPOLYPAUSESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17137640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialSetMonopolyPauseState_TypeDefinitionIndex = 21843;
