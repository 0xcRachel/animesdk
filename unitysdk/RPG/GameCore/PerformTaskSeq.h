...
#define RPG_GAMECORE_PERFORMTASKSEQ_METHOD_2_7568C92F49350763_OFFSET UNITYSDK_OFFSET(0x174A50C0)
#define RPG_GAMECORE_PERFORMTASKSEQ__CTOR_OFFSET UNITYSDK_OFFSET(0x174A5190)
