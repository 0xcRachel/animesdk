...
#define RPG_GAMECORE_TARGETFETCHCHESSSKILLTARGET_METHOD_4_AEF2C3AD2544B5CF_OFFSET UNITYSDK_OFFSET(0x16FDCA60)
#define RPG_GAMECORE_TARGETFETCHCHESSSKILLTARGET_METHOD_4_C23EE6AC974B0D89_OFFSET UNITYSDK_OFFSET(0x16FD5A20)
#define RPG_GAMECORE_TARGETFETCHCHESSSKILLTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD59A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchChessSkillTarget_TypeDefinitionIndex = 21604;
