...
#define RPG_GAMECORE_TARGETFETCHCHESSSKILLTARGET_METHOD_4_AEF2C3AD2544B5CF_OFFSET UNITYSDK_OFFSET(0x177D23B0)
#define RPG_GAMECORE_TARGETFETCHCHESSSKILLTARGET_METHOD_4_C23EE6AC974B0D89_OFFSET UNITYSDK_OFFSET(0x177C86C0)
#define RPG_GAMECORE_TARGETFETCHCHESSSKILLTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x177C8640)
