...
#define RPG_GAMECORE_AIVARIABLEBOOL_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x16EA7C70)
#define RPG_GAMECORE_AIVARIABLEBOOL_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x16EA7BD0)
#define RPG_GAMECORE_AIVARIABLEBOOL_EQUALS_OFFSET UNITYSDK_OFFSET(0x16EA7B80)
#define RPG_GAMECORE_AIVARIABLEBOOL_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x16EA7D30)
#define RPG_GAMECORE_AIVARIABLEBOOL_METHOD_3_2F59C04267FE0898_1_OFFSET UNITYSDK_OFFSET(0x16EA7E20)
#define RPG_GAMECORE_AIVARIABLEBOOL_METHOD_3_2F59C04267FE0898_OFFSET UNITYSDK_OFFSET(0x16EA7DE0)
#define RPG_GAMECORE_AIVARIABLEBOOL_METHOD_3_56950E5F6703F137_OFFSET UNITYSDK_OFFSET(0x16EA7B50)
#define RPG_GAMECORE_AIVARIABLEBOOL_METHOD_3_AAB430F0C614C608_OFFSET UNITYSDK_OFFSET(0x16EA7000)
#define RPG_GAMECORE_AIVARIABLEBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x16EA6FF0)
