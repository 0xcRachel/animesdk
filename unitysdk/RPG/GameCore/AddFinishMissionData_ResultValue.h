...
#define RPG_GAMECORE_ADDFINISHMISSIONDATA_RESULTVALUE_METHOD_3_B7CEC4C5E028EE47_OFFSET UNITYSDK_OFFSET(0x18DB2470)
#define RPG_GAMECORE_ADDFINISHMISSIONDATA_RESULTVALUE_METHOD_3_F9506AD661724CD0_OFFSET UNITYSDK_OFFSET(0x18DB23F0)
#define RPG_GAMECORE_ADDFINISHMISSIONDATA_RESULTVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x18DB2440)
