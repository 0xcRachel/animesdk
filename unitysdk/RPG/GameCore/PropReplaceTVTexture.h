...
#define RPG_GAMECORE_PROPREPLACETVTEXTURE_METHOD_3_00A147880B452789_OFFSET UNITYSDK_OFFSET(0x16DB0BC0)
#define RPG_GAMECORE_PROPREPLACETVTEXTURE_METHOD_3_6FD20E8E07683532_OFFSET UNITYSDK_OFFSET(0x16DB0A40)
#define RPG_GAMECORE_PROPREPLACETVTEXTURE__CTOR_OFFSET UNITYSDK_OFFSET(0x16DB0B10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropReplaceTVTexture_TypeDefinitionIndex = 19725;
