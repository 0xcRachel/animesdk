...
#define RPG_GAMECORE_MONSTERGUIDECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16CDD890)
#define RPG_GAMECORE_MONSTERGUIDECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16CDE040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonsterGuideConfigRow_TypeDefinitionIndex = 12922;
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* DifficultyList; // 0x20
		::Il2CppArray<::System::UInt32>* TextGuideList; // 0x28
