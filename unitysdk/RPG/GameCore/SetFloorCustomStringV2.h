...
#define RPG_GAMECORE_SETFLOORCUSTOMSTRINGV2_METHOD_3_522FF3C6347D869A_OFFSET UNITYSDK_OFFSET(0x199B5E90)
#define RPG_GAMECORE_SETFLOORCUSTOMSTRINGV2_METHOD_3_83E0998B92EA3D03_OFFSET UNITYSDK_OFFSET(0x199B5F10)
#define RPG_GAMECORE_SETFLOORCUSTOMSTRINGV2__CTOR_OFFSET UNITYSDK_OFFSET(0x199B5EE0)
