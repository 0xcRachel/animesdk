...
#define RPG_GAMECORE_ENHANCEDADVENTUREPLAYERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16A6E020)
#define RPG_GAMECORE_ENHANCEDADVENTUREPLAYERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16A6E1D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnhancedAdventurePlayerRow_TypeDefinitionIndex = 11413;
