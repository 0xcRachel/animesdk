...
#define RPG_GAMECORE_ROGUEMAGICFINISH_METHOD_3_138EBE36D59461A9_OFFSET UNITYSDK_OFFSET(0x17627B60)
#define RPG_GAMECORE_ROGUEMAGICFINISH_METHOD_3_8CF0929D2B41CD9D_OFFSET UNITYSDK_OFFSET(0x17627C70)
#define RPG_GAMECORE_ROGUEMAGICFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x17627C40)
