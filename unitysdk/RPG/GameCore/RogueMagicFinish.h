...
#define RPG_GAMECORE_ROGUEMAGICFINISH_METHOD_3_138EBE36D59461A9_OFFSET UNITYSDK_OFFSET(0x16E86CF0)
#define RPG_GAMECORE_ROGUEMAGICFINISH_METHOD_3_8CF0929D2B41CD9D_OFFSET UNITYSDK_OFFSET(0x16E86E00)
#define RPG_GAMECORE_ROGUEMAGICFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x16E86DD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMagicFinish_TypeDefinitionIndex = 19766;
