...
#define RPG_GAMECORE_TALKBEHAVIORROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x199CB9D0)
#define RPG_GAMECORE_TALKBEHAVIORROW__CTOR_OFFSET UNITYSDK_OFFSET(0x199CBC60)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::ParaType ParaType; // 0x20
		::System::UInt32 BehaviorType; // 0x24
