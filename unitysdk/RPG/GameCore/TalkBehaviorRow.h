...
#define RPG_GAMECORE_TALKBEHAVIORROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19870C20)
#define RPG_GAMECORE_TALKBEHAVIORROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19870EB0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 CurrencyItem; // 0x2C
