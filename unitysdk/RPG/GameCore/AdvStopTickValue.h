...
#define RPG_GAMECORE_ADVSTOPTICKVALUE_METHOD_3_1748A6D17DB6DA3F_OFFSET UNITYSDK_OFFSET(0x1684BC90)
#define RPG_GAMECORE_ADVSTOPTICKVALUE_METHOD_3_F1D324691D98AA12_OFFSET UNITYSDK_OFFSET(0x1684BBC0)
#define RPG_GAMECORE_ADVSTOPTICKVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1684BC40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvStopTickValue_TypeDefinitionIndex = 18832;
