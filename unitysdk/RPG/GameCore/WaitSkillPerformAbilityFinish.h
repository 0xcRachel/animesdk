...
#define RPG_GAMECORE_WAITSKILLPERFORMABILITYFINISH_METHOD_3_1ECBC3CF1E96D587_OFFSET UNITYSDK_OFFSET(0x1A654B20)
#define RPG_GAMECORE_WAITSKILLPERFORMABILITYFINISH_METHOD_3_D7A604E2D55CB2FB_OFFSET UNITYSDK_OFFSET(0x1A654C30)
#define RPG_GAMECORE_WAITSKILLPERFORMABILITYFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1A654C00)
