...
#define RPG_GAMECORE_SETBATTLETARGETMULTITARGETSWITCH_METHOD_3_16BD004E14000737_OFFSET UNITYSDK_OFFSET(0x16F09750)
#define RPG_GAMECORE_SETBATTLETARGETMULTITARGETSWITCH_METHOD_3_EEC9FD3B64888686_OFFSET UNITYSDK_OFFSET(0x16F096D0)
#define RPG_GAMECORE_SETBATTLETARGETMULTITARGETSWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x16F09720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBattleTargetMultiTargetSwitch_TypeDefinitionIndex = 20851;
