...
#define RPG_GAMECORE_CHIMERABATTLESHOWBUBBLETALK_METHOD_3_6504539A644013FD_OFFSET UNITYSDK_OFFSET(0x170A8B20)
#define RPG_GAMECORE_CHIMERABATTLESHOWBUBBLETALK_METHOD_3_D454468BA59521EF_OFFSET UNITYSDK_OFFSET(0x170A7610)
#define RPG_GAMECORE_CHIMERABATTLESHOWBUBBLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x170A7600)
