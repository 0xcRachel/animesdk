...
#define RPG_GAMECORE_CHIMERABATTLESHOWBUBBLETALK_METHOD_3_6504539A644013FD_OFFSET UNITYSDK_OFFSET(0x16986950)
#define RPG_GAMECORE_CHIMERABATTLESHOWBUBBLETALK_METHOD_3_D454468BA59521EF_OFFSET UNITYSDK_OFFSET(0x16985280)
#define RPG_GAMECORE_CHIMERABATTLESHOWBUBBLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x16985270)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattleShowBubbleTalk_TypeDefinitionIndex = 14322;
