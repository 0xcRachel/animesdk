...
#define RPG_GAMECORE_FIVEDIMCLEANERBOTMOVECONFIG_METHOD_3_12B1D822B1A46381_OFFSET UNITYSDK_OFFSET(0x17200940)
#define RPG_GAMECORE_FIVEDIMCLEANERBOTMOVECONFIG_METHOD_3_B748B2E37617DB4C_OFFSET UNITYSDK_OFFSET(0x172009B0)
#define RPG_GAMECORE_FIVEDIMCLEANERBOTMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17200990)
