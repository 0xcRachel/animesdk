...
#define RPG_GAMECORE_CHIMERADUELENTITYHASANYEQUIPMENTSPREDICATE_METHOD_3_575D78C799D6E8A5_OFFSET UNITYSDK_OFFSET(0x170AF350)
#define RPG_GAMECORE_CHIMERADUELENTITYHASANYEQUIPMENTSPREDICATE_METHOD_3_CCF7A8512C1CB777_OFFSET UNITYSDK_OFFSET(0x170AF3B0)
#define RPG_GAMECORE_CHIMERADUELENTITYHASANYEQUIPMENTSPREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x170AF3A0)
