...
#define RPG_GAMECORE_CHIMERADUELENTITYHASANYEQUIPMENTSPREDICATE_METHOD_3_575D78C799D6E8A5_OFFSET UNITYSDK_OFFSET(0x196B70B0)
#define RPG_GAMECORE_CHIMERADUELENTITYHASANYEQUIPMENTSPREDICATE_METHOD_3_CCF7A8512C1CB777_OFFSET UNITYSDK_OFFSET(0x196B7110)
#define RPG_GAMECORE_CHIMERADUELENTITYHASANYEQUIPMENTSPREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x196B7100)
