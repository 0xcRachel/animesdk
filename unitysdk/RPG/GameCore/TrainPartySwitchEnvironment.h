...
#define RPG_GAMECORE_TRAINPARTYSWITCHENVIRONMENT_METHOD_3_B84BAD2293FC2FB5_OFFSET UNITYSDK_OFFSET(0x1949A720)
#define RPG_GAMECORE_TRAINPARTYSWITCHENVIRONMENT_METHOD_3_D20CA1DA481BA544_OFFSET UNITYSDK_OFFSET(0x1949A6A0)
#define RPG_GAMECORE_TRAINPARTYSWITCHENVIRONMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1949A6F0)
