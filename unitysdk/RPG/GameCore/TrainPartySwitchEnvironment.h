...
#define RPG_GAMECORE_TRAINPARTYSWITCHENVIRONMENT_METHOD_3_B84BAD2293FC2FB5_OFFSET UNITYSDK_OFFSET(0x19A2BEB0)
#define RPG_GAMECORE_TRAINPARTYSWITCHENVIRONMENT_METHOD_3_D20CA1DA481BA544_OFFSET UNITYSDK_OFFSET(0x19A2BE30)
#define RPG_GAMECORE_TRAINPARTYSWITCHENVIRONMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19A2BE80)
