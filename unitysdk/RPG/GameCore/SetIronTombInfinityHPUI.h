...
#define RPG_GAMECORE_SETIRONTOMBINFINITYHPUI_METHOD_3_1C09C519A1986B3C_OFFSET UNITYSDK_OFFSET(0x176E6700)
#define RPG_GAMECORE_SETIRONTOMBINFINITYHPUI_METHOD_3_920BFCE4D43AD2AD_OFFSET UNITYSDK_OFFSET(0x176E6780)
#define RPG_GAMECORE_SETIRONTOMBINFINITYHPUI__CTOR_OFFSET UNITYSDK_OFFSET(0x176E6750)
