...
#define RPG_GAMECORE_DRINKMAKERCHEERSGUESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16A49090)
#define RPG_GAMECORE_DRINKMAKERCHEERSGUESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16A49440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DrinkMakerCheersGuestRow_TypeDefinitionIndex = 11988;
	...
	public:
		...
		::System::UInt32 OneMoreDrinkPerformanceID; // 0x20
		::System::UInt32 DrinkID; // 0x24
		::System::UInt32 PerformanceID; // 0x28
		::System::UInt32 FinishSettlementPerformanceID; // 0x2C
		::System::UInt32 ID; // 0x30
		::RPG::Client::TextID SurpriseRequest; // 0x38
		::System::UInt32 GroupID; // 0x48
		::System::UInt32 DrinkNamePerformanceID; // 0x4C
