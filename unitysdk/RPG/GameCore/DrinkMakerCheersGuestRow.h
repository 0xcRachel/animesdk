...
#define RPG_GAMECORE_DRINKMAKERCHEERSGUESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19137BC0)
#define RPG_GAMECORE_DRINKMAKERCHEERSGUESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19137F70)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 DrinkNamePerformanceID; // 0x38
