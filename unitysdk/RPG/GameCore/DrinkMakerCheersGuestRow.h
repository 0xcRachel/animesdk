...
#define RPG_GAMECORE_DRINKMAKERCHEERSGUESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1718BBC0)
#define RPG_GAMECORE_DRINKMAKERCHEERSGUESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1718BF70)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 OneMoreDrinkPerformanceID; // 0x28
		::System::UInt32 GroupID; // 0x2C
		::System::UInt32 DrinkNamePerformanceID; // 0x30
		::System::UInt32 DrinkID; // 0x34
		::System::UInt32 FinishSettlementPerformanceID; // 0x38
