...
#define RPG_GAMECORE_DRINKMAKERCHEERSGUESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A0A6CC0)
#define RPG_GAMECORE_DRINKMAKERCHEERSGUESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0A7060)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 DrinkNamePerformanceID; // 0x20
		::RPG::Client::TextID SurpriseRequest; // 0x28
		::System::UInt32 OneMoreDrinkPerformanceID; // 0x38
		::System::UInt32 ID; // 0x3C
		::System::UInt32 GroupID; // 0x40
		::System::UInt32 FinishSettlementPerformanceID; // 0x44
		::System::UInt32 DrinkID; // 0x48
