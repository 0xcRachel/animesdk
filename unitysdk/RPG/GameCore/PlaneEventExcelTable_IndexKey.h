...
#define RPG_GAMECORE_PLANEEVENTEXCELTABLE_INDEXKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x1FFA810)
#define RPG_GAMECORE_PLANEEVENTEXCELTABLE_INDEXKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2019570)
#define RPG_GAMECORE_PLANEEVENTEXCELTABLE_INDEXKEY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x201AC00)
#define RPG_GAMECORE_PLANEEVENTEXCELTABLE_INDEXKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x74250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlaneEventExcelTable_IndexKey_TypeDefinitionIndex = 12790;
