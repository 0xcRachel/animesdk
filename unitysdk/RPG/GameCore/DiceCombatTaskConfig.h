...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_METHOD_2_74916D5CE466B341_OFFSET UNITYSDK_OFFSET(0x1959AC30)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_METHOD_2_A5257641A02F4D53_OFFSET UNITYSDK_OFFSET(0x1959ADF0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG__CCTOR_OFFSET UNITYSDK_OFFSET(0x1959AE50)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1958F840)
...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Func_2<::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::DiceCombatTaskConfig*>*>**)Il2CppClass::FromTypeDefinitionIndex(DiceCombatTaskConfig_TypeDefinitionIndex)->GetStaticField(0x1B4D0);
		}
