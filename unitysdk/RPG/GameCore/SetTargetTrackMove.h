...
#define RPG_GAMECORE_SETTARGETTRACKMOVE_METHOD_3_A000AE0433FC967E_OFFSET UNITYSDK_OFFSET(0x16F41D10)
#define RPG_GAMECORE_SETTARGETTRACKMOVE_METHOD_3_D7DEF23DB0431CC5_OFFSET UNITYSDK_OFFSET(0x16F41E30)
#define RPG_GAMECORE_SETTARGETTRACKMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F41DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTargetTrackMove_TypeDefinitionIndex = 17934;
