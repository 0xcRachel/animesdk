...
#define RPG_GAMECORE_CORRECTIONPLAYERTELEPORTPOS_METHOD_3_43FD22A46EE39BAC_OFFSET UNITYSDK_OFFSET(0x169D0D60)
#define RPG_GAMECORE_CORRECTIONPLAYERTELEPORTPOS_METHOD_3_5C40230642F6C9F6_OFFSET UNITYSDK_OFFSET(0x169D0DE0)
#define RPG_GAMECORE_CORRECTIONPLAYERTELEPORTPOS__CTOR_OFFSET UNITYSDK_OFFSET(0x169D0DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CorrectionPlayerTeleportPos_TypeDefinitionIndex = 18285;
