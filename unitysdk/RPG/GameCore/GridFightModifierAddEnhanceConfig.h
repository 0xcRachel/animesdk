...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDENHANCECONFIG_METHOD_3_D2A150140DBA3155_OFFSET UNITYSDK_OFFSET(0x19574E10)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDENHANCECONFIG_METHOD_3_E9A3DB1C5B02347C_OFFSET UNITYSDK_OFFSET(0x19574D40)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDENHANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19574DC0)
