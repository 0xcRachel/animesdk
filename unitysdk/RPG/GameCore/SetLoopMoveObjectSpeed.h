...
#define RPG_GAMECORE_SETLOOPMOVEOBJECTSPEED_METHOD_3_9A950ACF6965387E_OFFSET UNITYSDK_OFFSET(0x199BAC10)
#define RPG_GAMECORE_SETLOOPMOVEOBJECTSPEED_METHOD_3_D8BAC9E2F2A2E73D_OFFSET UNITYSDK_OFFSET(0x199BAC90)
#define RPG_GAMECORE_SETLOOPMOVEOBJECTSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x199BAC60)
