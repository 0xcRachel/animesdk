...
#define RPG_GAMECORE_SETMAINLIGHTOFFSET_METHOD_3_B1EC9FD9A7B2E713_OFFSET UNITYSDK_OFFSET(0x16F337F0)
#define RPG_GAMECORE_SETMAINLIGHTOFFSET_METHOD_3_BCD805938C37A604_OFFSET UNITYSDK_OFFSET(0x16F33870)
#define RPG_GAMECORE_SETMAINLIGHTOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x16F33840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMainLightOffset_TypeDefinitionIndex = 21058;
