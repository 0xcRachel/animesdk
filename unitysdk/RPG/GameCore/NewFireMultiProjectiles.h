...
#define RPG_GAMECORE_NEWFIREMULTIPROJECTILES_METHOD_4_4D824E7070FE6859_OFFSET UNITYSDK_OFFSET(0x1864CC50)
#define RPG_GAMECORE_NEWFIREMULTIPROJECTILES_METHOD_4_EF863CAC768C499B_OFFSET UNITYSDK_OFFSET(0x1864CCD0)
#define RPG_GAMECORE_NEWFIREMULTIPROJECTILES__CTOR_OFFSET UNITYSDK_OFFSET(0x1864CCA0)
