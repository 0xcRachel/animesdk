...
#define RPG_GAMECORE_SHOWACTIVITYPAGE_METHOD_3_66973E0AEBEF3B4A_OFFSET UNITYSDK_OFFSET(0x16F52B90)
#define RPG_GAMECORE_SHOWACTIVITYPAGE_METHOD_3_72A5EC0CE7A2B0AE_OFFSET UNITYSDK_OFFSET(0x16F52B10)
#define RPG_GAMECORE_SHOWACTIVITYPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F52B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowActivityPage_TypeDefinitionIndex = 19340;
