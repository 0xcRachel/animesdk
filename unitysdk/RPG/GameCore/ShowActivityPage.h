...
#define RPG_GAMECORE_SHOWACTIVITYPAGE_METHOD_3_66973E0AEBEF3B4A_OFFSET UNITYSDK_OFFSET(0x193A0E90)
#define RPG_GAMECORE_SHOWACTIVITYPAGE_METHOD_3_72A5EC0CE7A2B0AE_OFFSET UNITYSDK_OFFSET(0x193A0E10)
#define RPG_GAMECORE_SHOWACTIVITYPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x193A0E60)
