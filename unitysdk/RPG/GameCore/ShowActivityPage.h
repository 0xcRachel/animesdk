...
#define RPG_GAMECORE_SHOWACTIVITYPAGE_METHOD_3_66973E0AEBEF3B4A_OFFSET UNITYSDK_OFFSET(0x17708010)
#define RPG_GAMECORE_SHOWACTIVITYPAGE_METHOD_3_72A5EC0CE7A2B0AE_OFFSET UNITYSDK_OFFSET(0x17707F90)
#define RPG_GAMECORE_SHOWACTIVITYPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x17707FE0)
