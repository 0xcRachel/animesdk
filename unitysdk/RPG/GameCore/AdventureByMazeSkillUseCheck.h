...
#define RPG_GAMECORE_ADVENTUREBYMAZESKILLUSECHECK_METHOD_4_3F21A508368587A6_OFFSET UNITYSDK_OFFSET(0x16854ED0)
#define RPG_GAMECORE_ADVENTUREBYMAZESKILLUSECHECK_METHOD_4_98F78F0591A79AF8_OFFSET UNITYSDK_OFFSET(0x16854E00)
#define RPG_GAMECORE_ADVENTUREBYMAZESKILLUSECHECK__CTOR_OFFSET UNITYSDK_OFFSET(0x16854E80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureByMazeSkillUseCheck_TypeDefinitionIndex = 17795;
