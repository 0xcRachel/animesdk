...
#define RPG_GAMECORE_MUSEUMPHASEUPGRADEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x190F6730)
#define RPG_GAMECORE_MUSEUMPHASEUPGRADEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x190F6930)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 RequireStatsA; // 0x1C
