...
#define RPG_GAMECORE_MUSEUMPHASEUPGRADEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16CF0530)
#define RPG_GAMECORE_MUSEUMPHASEUPGRADEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16CF0730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MuseumPhaseUpgradeRow_TypeDefinitionIndex = 12941;
	...
	public:
		...
		::System::UInt32 RequireStatsB; // 0x20
