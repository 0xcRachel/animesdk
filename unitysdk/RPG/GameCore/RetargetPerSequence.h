...
#define RPG_GAMECORE_RETARGETPERSEQUENCE_METHOD_3_509201181B3F2507_OFFSET UNITYSDK_OFFSET(0x175C16C0)
#define RPG_GAMECORE_RETARGETPERSEQUENCE_METHOD_3_DECF24C818849F8A_OFFSET UNITYSDK_OFFSET(0x175C1740)
#define RPG_GAMECORE_RETARGETPERSEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x175C1710)
