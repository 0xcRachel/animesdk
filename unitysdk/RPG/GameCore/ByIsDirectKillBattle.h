...
#define RPG_GAMECORE_BYISDIRECTKILLBATTLE_METHOD_4_096294412AE58F5D_OFFSET UNITYSDK_OFFSET(0x1692F900)
#define RPG_GAMECORE_BYISDIRECTKILLBATTLE_METHOD_4_D5D05369782CBF17_OFFSET UNITYSDK_OFFSET(0x1692F830)
#define RPG_GAMECORE_BYISDIRECTKILLBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1692F8B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsDirectKillBattle_TypeDefinitionIndex = 20711;
