...
#define RPG_GAMECORE_ADVWAITPROPSTEEREVENTV2_METHOD_3_0028D77E674941D7_OFFSET UNITYSDK_OFFSET(0x1684D250)
#define RPG_GAMECORE_ADVWAITPROPSTEEREVENTV2_METHOD_3_EF081ADE2A2DE439_OFFSET UNITYSDK_OFFSET(0x1684D1D0)
#define RPG_GAMECORE_ADVWAITPROPSTEEREVENTV2__CTOR_OFFSET UNITYSDK_OFFSET(0x1684D220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvWaitPropSteerEventV2_TypeDefinitionIndex = 19706;
