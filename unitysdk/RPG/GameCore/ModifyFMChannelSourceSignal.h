...
#define RPG_GAMECORE_MODIFYFMCHANNELSOURCESIGNAL_METHOD_3_120D82CE4949ECE0_OFFSET UNITYSDK_OFFSET(0x196AD350)
#define RPG_GAMECORE_MODIFYFMCHANNELSOURCESIGNAL_METHOD_3_34471060C7EC2D97_OFFSET UNITYSDK_OFFSET(0x196AD3D0)
#define RPG_GAMECORE_MODIFYFMCHANNELSOURCESIGNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x196AD3A0)
