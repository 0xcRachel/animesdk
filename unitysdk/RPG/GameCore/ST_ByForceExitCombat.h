...
#define RPG_GAMECORE_ST_BYFORCEEXITCOMBAT_METHOD_4_67E9BC6DAE36AB2B_OFFSET UNITYSDK_OFFSET(0x1A17BCC0)
#define RPG_GAMECORE_ST_BYFORCEEXITCOMBAT_METHOD_4_AC8D0318805080FC_OFFSET UNITYSDK_OFFSET(0x1A17BE00)
#define RPG_GAMECORE_ST_BYFORCEEXITCOMBAT_METHOD_4_BF32453872366031_OFFSET UNITYSDK_OFFSET(0x1A17BBF0)
#define RPG_GAMECORE_ST_BYFORCEEXITCOMBAT_METHOD_4_CC7236970C20B7D4_OFFSET UNITYSDK_OFFSET(0x1A17BE80)
#define RPG_GAMECORE_ST_BYFORCEEXITCOMBAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A17BC70)
