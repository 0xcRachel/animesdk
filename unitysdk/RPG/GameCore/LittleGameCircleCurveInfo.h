...
#define RPG_GAMECORE_LITTLEGAMECIRCLECURVEINFO_METHOD_3_3243E89D0203B4A8_OFFSET UNITYSDK_OFFSET(0x16BC5E00)
#define RPG_GAMECORE_LITTLEGAMECIRCLECURVEINFO_METHOD_3_51B012D710592F19_OFFSET UNITYSDK_OFFSET(0x16BC5D00)
#define RPG_GAMECORE_LITTLEGAMECIRCLECURVEINFO_METHOD_3_5BA71826636BA9C3_OFFSET UNITYSDK_OFFSET(0x16BC5B30)
#define RPG_GAMECORE_LITTLEGAMECIRCLECURVEINFO_METHOD_3_823B0920A1E5575C_OFFSET UNITYSDK_OFFSET(0x16BC5AE0)
#define RPG_GAMECORE_LITTLEGAMECIRCLECURVEINFO_METHOD_3_8B071BD4E0283A69_OFFSET UNITYSDK_OFFSET(0x16BC5CC0)
#define RPG_GAMECORE_LITTLEGAMECIRCLECURVEINFO_METHOD_3_B5A8D91CF3B9C0BC_OFFSET UNITYSDK_OFFSET(0x16BC60D0)
#define RPG_GAMECORE_LITTLEGAMECIRCLECURVEINFO_METHOD_3_D978819B0A4871A0_OFFSET UNITYSDK_OFFSET(0x16BC5CB0)
#define RPG_GAMECORE_LITTLEGAMECIRCLECURVEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16BC5B20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameCircleCurveInfo_TypeDefinitionIndex = 16899;
