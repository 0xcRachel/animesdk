...
#define RPG_GAMECORE_HIDEHINTEFFECT_METHOD_3_247FDE585B2EB06E_OFFSET UNITYSDK_OFFSET(0x172BE3F0)
#define RPG_GAMECORE_HIDEHINTEFFECT_METHOD_3_67DC77A8DBBBA739_OFFSET UNITYSDK_OFFSET(0x172BE370)
#define RPG_GAMECORE_HIDEHINTEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x172BE3C0)
