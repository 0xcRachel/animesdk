...
#define RPG_GAMECORE_HIDEHINTEFFECT_METHOD_3_247FDE585B2EB06E_OFFSET UNITYSDK_OFFSET(0x16B6FB80)
#define RPG_GAMECORE_HIDEHINTEFFECT_METHOD_3_67DC77A8DBBBA739_OFFSET UNITYSDK_OFFSET(0x16B6FB00)
#define RPG_GAMECORE_HIDEHINTEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x16B6FB50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HideHintEffect_TypeDefinitionIndex = 18354;
