...
#define RPG_GAMECORE_PLANETFESBUSINESSDAYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x174CD350)
#define RPG_GAMECORE_PLANETFESBUSINESSDAYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x174CDB30)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 PamNum; // 0x14
		::System::UInt32 LargeBonusNum; // 0x18
		::System::UInt32 BusinessDay; // 0x1C
		::System::UInt32 NaturalDay; // 0x20
		::System::UInt32 GameNum; // 0x24
