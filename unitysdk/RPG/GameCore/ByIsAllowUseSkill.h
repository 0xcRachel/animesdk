...
#define RPG_GAMECORE_BYISALLOWUSESKILL_METHOD_4_388104DA4DF32D40_OFFSET UNITYSDK_OFFSET(0x1692C5A0)
#define RPG_GAMECORE_BYISALLOWUSESKILL_METHOD_4_84E464EA4C3A8C28_OFFSET UNITYSDK_OFFSET(0x1692C4D0)
#define RPG_GAMECORE_BYISALLOWUSESKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1692C550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsAllowUseSkill_TypeDefinitionIndex = 20710;
