...
#define RPG_GAMECORE_STOPEFFECTFOLLOWPOINT_METHOD_3_08D739B7F12C29AD_OFFSET UNITYSDK_OFFSET(0x19351660)
#define RPG_GAMECORE_STOPEFFECTFOLLOWPOINT_METHOD_3_C3B6D0D544765383_OFFSET UNITYSDK_OFFSET(0x193515C0)
#define RPG_GAMECORE_STOPEFFECTFOLLOWPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x19351620)
