...
#define RPG_GAMECORE_PAUSETOASTQUEUE_METHOD_3_9E1194DCD2698313_OFFSET UNITYSDK_OFFSET(0x16D1BE10)
#define RPG_GAMECORE_PAUSETOASTQUEUE_METHOD_3_C68E271BF73A9ECA_OFFSET UNITYSDK_OFFSET(0x16D1BE90)
#define RPG_GAMECORE_PAUSETOASTQUEUE__CTOR_OFFSET UNITYSDK_OFFSET(0x16D1BE60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PauseToastQueue_TypeDefinitionIndex = 18075;
