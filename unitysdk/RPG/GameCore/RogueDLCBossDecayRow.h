...
#define RPG_GAMECORE_ROGUEDLCBOSSDECAYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19258E70)
#define RPG_GAMECORE_ROGUEDLCBOSSDECAYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19259800)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID BossDecayDesc; // 0x48
		::System::UInt32 BossDecayID; // 0x58
