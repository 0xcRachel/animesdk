...
#define RPG_GAMECORE_ROGUETOURNMODIFYROOMPOOLITEMREMOVECONFIG_METHOD_3_0EB6E3CB16422257_OFFSET UNITYSDK_OFFSET(0x17681C80)
#define RPG_GAMECORE_ROGUETOURNMODIFYROOMPOOLITEMREMOVECONFIG_METHOD_3_B32521D1618E673B_OFFSET UNITYSDK_OFFSET(0x17681C30)
#define RPG_GAMECORE_ROGUETOURNMODIFYROOMPOOLITEMREMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17681C20)
