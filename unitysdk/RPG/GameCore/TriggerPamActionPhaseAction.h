...
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASEACTION_METHOD_3_0C94945F7FE712FA_OFFSET UNITYSDK_OFFSET(0x1911B5C0)
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASEACTION_METHOD_3_6204A0C740352CCE_OFFSET UNITYSDK_OFFSET(0x1911B4B0)
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1911B590)
