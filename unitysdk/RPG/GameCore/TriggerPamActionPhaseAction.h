...
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASEACTION_METHOD_3_0C94945F7FE712FA_OFFSET UNITYSDK_OFFSET(0x17123480)
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASEACTION_METHOD_3_6204A0C740352CCE_OFFSET UNITYSDK_OFFSET(0x17123370)
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x17123450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerPamActionPhaseAction_TypeDefinitionIndex = 17788;
