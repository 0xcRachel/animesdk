...
#define RPG_GAMECORE_RESETTEAMMATEATTACKPERFORM_METHOD_3_11C6876A19445AFF_OFFSET UNITYSDK_OFFSET(0x16DE6C80)
#define RPG_GAMECORE_RESETTEAMMATEATTACKPERFORM_METHOD_3_7FBDD77E91FDB02E_OFFSET UNITYSDK_OFFSET(0x16DE6D10)
#define RPG_GAMECORE_RESETTEAMMATEATTACKPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x16DE6CE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetTeammateAttackPerform_TypeDefinitionIndex = 20135;
