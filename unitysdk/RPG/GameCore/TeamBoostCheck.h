...
#define RPG_GAMECORE_TEAMBOOSTCHECK_METHOD_3_61E08937568C0ACF_OFFSET UNITYSDK_OFFSET(0x1947B5B0)
#define RPG_GAMECORE_TEAMBOOSTCHECK_METHOD_3_F5A048D77F91B3FE_OFFSET UNITYSDK_OFFSET(0x1947B630)
#define RPG_GAMECORE_TEAMBOOSTCHECK__CTOR_OFFSET UNITYSDK_OFFSET(0x1947B600)
