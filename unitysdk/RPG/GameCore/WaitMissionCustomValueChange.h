...
#define RPG_GAMECORE_WAITMISSIONCUSTOMVALUECHANGE_METHOD_4_A89BF22EC3BBEFED_OFFSET UNITYSDK_OFFSET(0x179124E0)
#define RPG_GAMECORE_WAITMISSIONCUSTOMVALUECHANGE_METHOD_4_F94FAD5D89AFE754_OFFSET UNITYSDK_OFFSET(0x17912400)
#define RPG_GAMECORE_WAITMISSIONCUSTOMVALUECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x17912480)
