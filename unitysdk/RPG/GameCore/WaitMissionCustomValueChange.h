...
#define RPG_GAMECORE_WAITMISSIONCUSTOMVALUECHANGE_METHOD_4_A89BF22EC3BBEFED_OFFSET UNITYSDK_OFFSET(0x17156070)
#define RPG_GAMECORE_WAITMISSIONCUSTOMVALUECHANGE_METHOD_4_F94FAD5D89AFE754_OFFSET UNITYSDK_OFFSET(0x17155F90)
#define RPG_GAMECORE_WAITMISSIONCUSTOMVALUECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x17156010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitMissionCustomValueChange_TypeDefinitionIndex = 19321;
