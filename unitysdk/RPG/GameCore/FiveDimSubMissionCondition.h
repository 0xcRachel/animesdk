...
#define RPG_GAMECORE_FIVEDIMSUBMISSIONCONDITION_METHOD_2_8A20E6DB7142BF41_OFFSET UNITYSDK_OFFSET(0x1A3A76D0)
#define RPG_GAMECORE_FIVEDIMSUBMISSIONCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3A7810)
