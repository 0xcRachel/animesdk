...
#define RPG_GAMECORE_MARBLEABSORBTEAMMATES_METHOD_3_621E7F345FCA6372_OFFSET UNITYSDK_OFFSET(0x16C36450)
#define RPG_GAMECORE_MARBLEABSORBTEAMMATES_METHOD_3_9F6CBEAF3F855286_OFFSET UNITYSDK_OFFSET(0x16C36370)
#define RPG_GAMECORE_MARBLEABSORBTEAMMATES__CTOR_OFFSET UNITYSDK_OFFSET(0x16C36400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleAbsorbTeammates_TypeDefinitionIndex = 15169;
