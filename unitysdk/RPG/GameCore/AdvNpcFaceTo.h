...
#define RPG_GAMECORE_ADVNPCFACETO_METHOD_3_3C8AC6D6EA9110D1_OFFSET UNITYSDK_OFFSET(0x1683D090)
#define RPG_GAMECORE_ADVNPCFACETO_METHOD_3_61A32E4441B12701_OFFSET UNITYSDK_OFFSET(0x1683D120)
#define RPG_GAMECORE_ADVNPCFACETO__CTOR_OFFSET UNITYSDK_OFFSET(0x1683D0F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNpcFaceTo_TypeDefinitionIndex = 18108;
