...
#define RPG_GAMECORE_STACKSTATUSRESISTANCE_METHOD_3_8FB84279E4D0530F_OFFSET UNITYSDK_OFFSET(0x16F834A0)
#define RPG_GAMECORE_STACKSTATUSRESISTANCE_METHOD_3_B59B10AC9E36F352_OFFSET UNITYSDK_OFFSET(0x16F83520)
#define RPG_GAMECORE_STACKSTATUSRESISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F834F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StackStatusResistance_TypeDefinitionIndex = 20316;
