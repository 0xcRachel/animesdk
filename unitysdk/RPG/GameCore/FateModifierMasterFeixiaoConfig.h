...
#define RPG_GAMECORE_FATEMODIFIERMASTERFEIXIAOCONFIG_METHOD_3_43ACD550EBB78A90_OFFSET UNITYSDK_OFFSET(0x171DCF00)
#define RPG_GAMECORE_FATEMODIFIERMASTERFEIXIAOCONFIG_METHOD_3_63A3B25C82BB43E9_OFFSET UNITYSDK_OFFSET(0x171DBD40)
#define RPG_GAMECORE_FATEMODIFIERMASTERFEIXIAOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171DBCF0)
