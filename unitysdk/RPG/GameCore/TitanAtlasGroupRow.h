...
#define RPG_GAMECORE_TITANATLASGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x170F79F0)
#define RPG_GAMECORE_TITANATLASGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x170F7C30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TitanAtlasGroupRow_TypeDefinitionIndex = 13905;
	...
	public:
		...
		::RPG::Client::TextID TitanGroupDesc; // 0x20
