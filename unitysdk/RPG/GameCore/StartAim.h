...
#define RPG_GAMECORE_STARTAIM_METHOD_3_87C2E1E4BEF72A07_OFFSET UNITYSDK_OFFSET(0x16F93CA0)
#define RPG_GAMECORE_STARTAIM_METHOD_3_DD0E6FB00E9A9041_OFFSET UNITYSDK_OFFSET(0x16F93D60)
#define RPG_GAMECORE_STARTAIM__CTOR_OFFSET UNITYSDK_OFFSET(0x16F93D10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartAim_TypeDefinitionIndex = 20062;
