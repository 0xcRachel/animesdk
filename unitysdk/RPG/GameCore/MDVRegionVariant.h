...
#define RPG_GAMECORE_MDVREGIONVARIANT_METHOD_2_F9BF15956122ABDA_OFFSET UNITYSDK_OFFSET(0x18FD0880)
#define RPG_GAMECORE_MDVREGIONVARIANT__CTOR_OFFSET UNITYSDK_OFFSET(0x18FD09F0)
