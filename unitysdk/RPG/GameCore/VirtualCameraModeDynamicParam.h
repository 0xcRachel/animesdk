...
#define RPG_GAMECORE_VIRTUALCAMERAMODEDYNAMICPARAM_METHOD_2_FA4D32DA7B0108D7_OFFSET UNITYSDK_OFFSET(0x17149180)
#define RPG_GAMECORE_VIRTUALCAMERAMODEDYNAMICPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x17149290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VirtualCameraModeDynamicParam_TypeDefinitionIndex = 18629;
