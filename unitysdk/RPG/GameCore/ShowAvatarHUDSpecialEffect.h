...
#define RPG_GAMECORE_SHOWAVATARHUDSPECIALEFFECT_METHOD_3_3E7D1A0EE49DE803_OFFSET UNITYSDK_OFFSET(0x17708D10)
#define RPG_GAMECORE_SHOWAVATARHUDSPECIALEFFECT_METHOD_3_A6B690297DC1E930_OFFSET UNITYSDK_OFFSET(0x17708C90)
#define RPG_GAMECORE_SHOWAVATARHUDSPECIALEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x17708CE0)
