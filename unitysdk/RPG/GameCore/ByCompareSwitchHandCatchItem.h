...
#define RPG_GAMECORE_BYCOMPARESWITCHHANDCATCHITEM_METHOD_4_3C90B5964F2EC74B_OFFSET UNITYSDK_OFFSET(0x18FF6350)
#define RPG_GAMECORE_BYCOMPARESWITCHHANDCATCHITEM_METHOD_4_7250E4D126DB68DE_OFFSET UNITYSDK_OFFSET(0x18FF62D0)
#define RPG_GAMECORE_BYCOMPARESWITCHHANDCATCHITEM_METHOD_4_7FBCAE0E248D1461_OFFSET UNITYSDK_OFFSET(0x18FF5F20)
#define RPG_GAMECORE_BYCOMPARESWITCHHANDCATCHITEM_METHOD_4_932CB330B6D01F9E_OFFSET UNITYSDK_OFFSET(0x18FF5FF0)
#define RPG_GAMECORE_BYCOMPARESWITCHHANDCATCHITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x18FF5FA0)
