...
#define RPG_GAMECORE_BYCOMPARESWITCHHANDCATCHITEM_METHOD_4_7FBCAE0E248D1461_OFFSET UNITYSDK_OFFSET(0x1691CF60)
#define RPG_GAMECORE_BYCOMPARESWITCHHANDCATCHITEM_METHOD_4_932CB330B6D01F9E_OFFSET UNITYSDK_OFFSET(0x1691D030)
#define RPG_GAMECORE_BYCOMPARESWITCHHANDCATCHITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1691CFE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareSwitchHandCatchItem_TypeDefinitionIndex = 18764;
