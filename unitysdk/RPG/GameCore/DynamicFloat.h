...
#define RPG_GAMECORE_DYNAMICFLOAT_GET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x16A55310)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_0854E9454645D1B7_OFFSET UNITYSDK_OFFSET(0x16A552B0)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_1DCC0C7F8AC23022_OFFSET UNITYSDK_OFFSET(0x16A553C0)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_28C8D0626FC9B6CE_OFFSET UNITYSDK_OFFSET(0x16A555D0)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_2A5E94F9B9A71A0B_OFFSET UNITYSDK_OFFSET(0x16A55460)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_533C5677051CA131_OFFSET UNITYSDK_OFFSET(0x16A55100)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_79908043EE0BD956_OFFSET UNITYSDK_OFFSET(0x16A35890)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_E1B33223F9F2D6BB_OFFSET UNITYSDK_OFFSET(0x16A55320)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_E83C519CAA6854AF_OFFSET UNITYSDK_OFFSET(0x16A55150)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_F06B17D67D5067C6_OFFSET UNITYSDK_OFFSET(0x16A551D0)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_F7097473EC9DE578_OFFSET UNITYSDK_OFFSET(0x16A55D10)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_FBDC5F72FD2730B3_OFFSET UNITYSDK_OFFSET(0x16A55240)
#define RPG_GAMECORE_DYNAMICFLOAT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x16A55C70)
#define RPG_GAMECORE_DYNAMICFLOAT__CCTOR_OFFSET UNITYSDK_OFFSET(0x16A56180)
#define RPG_GAMECORE_DYNAMICFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x16A553B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DynamicFloat_TypeDefinitionIndex = 22017;
	...
	public:
		...
		{
			return (::RPG::GameCore::DynamicFloat**)Il2CppClass::FromTypeDefinitionIndex(DynamicFloat_TypeDefinitionIndex)->GetStaticField(0x26670);
		}
		static ::RPG::GameCore::DynamicFloat** StaticGet_ZERO()
		{
			return (::RPG::GameCore::DynamicFloat**)Il2CppClass::FromTypeDefinitionIndex(DynamicFloat_TypeDefinitionIndex)->GetStaticField(0x26678);
		}
		static ::RPG::GameCore::DynamicFloat** StaticGet_THREESIXZERO()
		{
			return (::RPG::GameCore::DynamicFloat**)Il2CppClass::FromTypeDefinitionIndex(DynamicFloat_TypeDefinitionIndex)->GetStaticField(0x26680);
		}
		static ::RPG::GameCore::DynamicFloat** StaticGet_ONE()
		{
			return (::RPG::GameCore::DynamicFloat**)Il2CppClass::FromTypeDefinitionIndex(DynamicFloat_TypeDefinitionIndex)->GetStaticField(0x26688);
		}
