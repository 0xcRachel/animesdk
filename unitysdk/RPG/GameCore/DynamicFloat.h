...
#define RPG_GAMECORE_DYNAMICFLOAT_GET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x17197EB0)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_0854E9454645D1B7_OFFSET UNITYSDK_OFFSET(0x17197E50)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_1DCC0C7F8AC23022_OFFSET UNITYSDK_OFFSET(0x17197F60)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_28C8D0626FC9B6CE_OFFSET UNITYSDK_OFFSET(0x17198170)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_2A5E94F9B9A71A0B_OFFSET UNITYSDK_OFFSET(0x17198000)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_533C5677051CA131_OFFSET UNITYSDK_OFFSET(0x17197CA0)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_79908043EE0BD956_OFFSET UNITYSDK_OFFSET(0x17197C30)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_E1B33223F9F2D6BB_OFFSET UNITYSDK_OFFSET(0x17197EC0)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_E83C519CAA6854AF_OFFSET UNITYSDK_OFFSET(0x17197CF0)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_F06B17D67D5067C6_OFFSET UNITYSDK_OFFSET(0x17197D70)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_F7097473EC9DE578_OFFSET UNITYSDK_OFFSET(0x171988B0)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_FBDC5F72FD2730B3_OFFSET UNITYSDK_OFFSET(0x17197DE0)
#define RPG_GAMECORE_DYNAMICFLOAT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17198810)
#define RPG_GAMECORE_DYNAMICFLOAT__CCTOR_OFFSET UNITYSDK_OFFSET(0x17198D20)
#define RPG_GAMECORE_DYNAMICFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x17197F50)
...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::RPG::GameCore::DynamicFloat**)Il2CppClass::FromTypeDefinitionIndex(DynamicFloat_TypeDefinitionIndex)->GetStaticField(0x36240);
		}
		static ::RPG::GameCore::DynamicFloat** StaticGet_ZERO()
		{
			return (::RPG::GameCore::DynamicFloat**)Il2CppClass::FromTypeDefinitionIndex(DynamicFloat_TypeDefinitionIndex)->GetStaticField(0x36248);
		}
		static ::RPG::GameCore::DynamicFloat** StaticGet_ONE()
		{
			return (::RPG::GameCore::DynamicFloat**)Il2CppClass::FromTypeDefinitionIndex(DynamicFloat_TypeDefinitionIndex)->GetStaticField(0x36250);
		}
		static ::RPG::GameCore::DynamicFloat** StaticGet_THREESIXZERO()
		{
			return (::RPG::GameCore::DynamicFloat**)Il2CppClass::FromTypeDefinitionIndex(DynamicFloat_TypeDefinitionIndex)->GetStaticField(0x36258);
		}
