...
#define RPG_GAMECORE_PROPPLAYGACHAMACHINE_METHOD_3_449E1C33196F4D5B_OFFSET UNITYSDK_OFFSET(0x16DAF3F0)
#define RPG_GAMECORE_PROPPLAYGACHAMACHINE_METHOD_3_D8E97B551A003F4C_OFFSET UNITYSDK_OFFSET(0x16DAF2B0)
#define RPG_GAMECORE_PROPPLAYGACHAMACHINE__CTOR_OFFSET UNITYSDK_OFFSET(0x16DAF360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropPlayGachaMachine_TypeDefinitionIndex = 19612;
