...
#define RPG_GAMECORE_PINGPONGPATROLROUTECMPTCONFIG_METHOD_3_3DCC20A19D92D399_OFFSET UNITYSDK_OFFSET(0x174C6330)
#define RPG_GAMECORE_PINGPONGPATROLROUTECMPTCONFIG_METHOD_3_F6D074428C1F64FD_OFFSET UNITYSDK_OFFSET(0x174C62A0)
#define RPG_GAMECORE_PINGPONGPATROLROUTECMPTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x174C6310)
