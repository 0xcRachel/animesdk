...
#define RPG_GAMECORE_LEVELENTITYUSESKILL_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA4A4FA0)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA4A4F50)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_GET_INDEX_OFFSET UNITYSDK_OFFSET(0xA4A5070)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_GET_SKILLCONFIGID_OFFSET UNITYSDK_OFFSET(0xA4A5090)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_GET_SKILLID_OFFSET UNITYSDK_OFFSET(0xA4A5010)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_GET_SKILLLEVEL_OFFSET UNITYSDK_OFFSET(0xA4A50B0)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_GET_SKILLTARGETS_OFFSET UNITYSDK_OFFSET(0xA4A50D0)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_GET_SKILLTYPE_OFFSET UNITYSDK_OFFSET(0xA4A5030)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_GET_TARGETID_OFFSET UNITYSDK_OFFSET(0xA4A4FF0)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_GET_USETYPE_OFFSET UNITYSDK_OFFSET(0xA4A5050)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_INIT_OFFSET UNITYSDK_OFFSET(0xA4A4E80)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_SET_INDEX_OFFSET UNITYSDK_OFFSET(0xA4A5080)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_SET_SKILLCONFIGID_OFFSET UNITYSDK_OFFSET(0xA4A50A0)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_SET_SKILLID_OFFSET UNITYSDK_OFFSET(0xA4A5020)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_SET_SKILLLEVEL_OFFSET UNITYSDK_OFFSET(0xA4A50C0)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_SET_SKILLTARGETS_OFFSET UNITYSDK_OFFSET(0xA4A50E0)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_SET_SKILLTYPE_OFFSET UNITYSDK_OFFSET(0xA4A5040)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_SET_TARGETID_OFFSET UNITYSDK_OFFSET(0xA4A5000)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_SET_USETYPE_OFFSET UNITYSDK_OFFSET(0xA4A5060)
#define RPG_GAMECORE_LEVELENTITYUSESKILL__CTOR_OFFSET UNITYSDK_OFFSET(0xA4A50F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelEntityUseSkill_TypeDefinitionIndex = 44586;
	...
	public:
		...
		::System::UInt32 _SkillConfigID_k__BackingField; // 0x2C
		::RPG::GameCore::SkillUseType _UseType_k__BackingField; // 0x30
		::System::Int32 _Index_k__BackingField; // 0x34
		::System::UInt32 _SkillLevel_k__BackingField; // 0x38
		::RPG::GameCore::SkillType _SkillType_k__BackingField; // 0x3C
