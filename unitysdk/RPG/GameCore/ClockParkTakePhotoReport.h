...
#define RPG_GAMECORE_CLOCKPARKTAKEPHOTOREPORT_METHOD_3_266338530BFF8DDA_OFFSET UNITYSDK_OFFSET(0x169B43A0)
#define RPG_GAMECORE_CLOCKPARKTAKEPHOTOREPORT_METHOD_3_4A039404CE7EDE26_OFFSET UNITYSDK_OFFSET(0x169B44B0)
#define RPG_GAMECORE_CLOCKPARKTAKEPHOTOREPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x169B4480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClockParkTakePhotoReport_TypeDefinitionIndex = 19281;
