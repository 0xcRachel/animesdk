...
#define RPG_GAMECORE_ACTIVITYAVATARDELIVERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16781B50)
#define RPG_GAMECORE_ACTIVITYAVATARDELIVERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16781E40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityAvatarDeliverRow_TypeDefinitionIndex = 10266;

	class ActivityAvatarDeliverRow : public ::System::Object
	{
	public:
		::RPG::Client::TextID Sign; // 0x10
		::RPG::Client::TextID MailDesc; // 0x20
