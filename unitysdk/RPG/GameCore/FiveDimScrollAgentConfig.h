...
#define RPG_GAMECORE_FIVEDIMSCROLLAGENTCONFIG_METHOD_3_3376D203E55B1499_OFFSET UNITYSDK_OFFSET(0x1721BF40)
#define RPG_GAMECORE_FIVEDIMSCROLLAGENTCONFIG_METHOD_3_E9A2DA54F37FE30D_OFFSET UNITYSDK_OFFSET(0x1721C040)
#define RPG_GAMECORE_FIVEDIMSCROLLAGENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1721C020)
