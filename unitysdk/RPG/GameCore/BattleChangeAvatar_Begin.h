...
#define RPG_GAMECORE_BATTLECHANGEAVATAR_BEGIN_METHOD_3_19BC27478A940D3B_OFFSET UNITYSDK_OFFSET(0x168D0050)
#define RPG_GAMECORE_BATTLECHANGEAVATAR_BEGIN_METHOD_3_B6A5BBBE236312F3_OFFSET UNITYSDK_OFFSET(0x168D0170)
#define RPG_GAMECORE_BATTLECHANGEAVATAR_BEGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x168D00F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleChangeAvatar_Begin_TypeDefinitionIndex = 20421;
