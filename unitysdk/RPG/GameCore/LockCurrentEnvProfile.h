...
#define RPG_GAMECORE_LOCKCURRENTENVPROFILE_METHOD_3_25B94F7D989CF6CE_OFFSET UNITYSDK_OFFSET(0x19C12D50)
#define RPG_GAMECORE_LOCKCURRENTENVPROFILE_METHOD_3_417C1C8A3D43DF1F_OFFSET UNITYSDK_OFFSET(0x19C12CD0)
#define RPG_GAMECORE_LOCKCURRENTENVPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C12D20)
