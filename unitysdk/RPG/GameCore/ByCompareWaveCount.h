...
#define RPG_GAMECORE_BYCOMPAREWAVECOUNT_METHOD_4_B6340B6507636704_OFFSET UNITYSDK_OFFSET(0x170311F0)
#define RPG_GAMECORE_BYCOMPAREWAVECOUNT_METHOD_4_CB9B4E2E19D2B9B6_OFFSET UNITYSDK_OFFSET(0x17031120)
#define RPG_GAMECORE_BYCOMPAREWAVECOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x170311A0)
