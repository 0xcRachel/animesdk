...
#define RPG_GAMECORE_TUTORIALFORBIDAUTOBATTLE_METHOD_3_003546BE79ABA412_OFFSET UNITYSDK_OFFSET(0x178ECB50)
#define RPG_GAMECORE_TUTORIALFORBIDAUTOBATTLE_METHOD_3_AE04DC23BE757C7B_OFFSET UNITYSDK_OFFSET(0x178ECBD0)
#define RPG_GAMECORE_TUTORIALFORBIDAUTOBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x178ECBA0)
