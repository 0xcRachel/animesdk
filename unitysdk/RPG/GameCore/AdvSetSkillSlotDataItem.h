...
#define RPG_GAMECORE_ADVSETSKILLSLOTDATAITEM_METHOD_2_57F7C564C7633782_OFFSET UNITYSDK_OFFSET(0x18C5CE50)
#define RPG_GAMECORE_ADVSETSKILLSLOTDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x18C5D060)
