...
#define RPG_GAMECORE_EXITGAMEFLOW_METHOD_3_9622DD342725DCCC_OFFSET UNITYSDK_OFFSET(0x1A3F9B00)
#define RPG_GAMECORE_EXITGAMEFLOW_METHOD_3_F1CD6625A72C375D_OFFSET UNITYSDK_OFFSET(0x1A3F9A80)
#define RPG_GAMECORE_EXITGAMEFLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3F9AD0)
