...
#define RPG_GAMECORE_CLOCKPARKUNLOCKSCRIPT_METHOD_3_3415A13B9BD3CAF8_OFFSET UNITYSDK_OFFSET(0x169B5790)
#define RPG_GAMECORE_CLOCKPARKUNLOCKSCRIPT_METHOD_3_B676D13F5EB6E981_OFFSET UNITYSDK_OFFSET(0x169B5810)
#define RPG_GAMECORE_CLOCKPARKUNLOCKSCRIPT__CTOR_OFFSET UNITYSDK_OFFSET(0x169B57E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClockParkUnlockScript_TypeDefinitionIndex = 19282;
