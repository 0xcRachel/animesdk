...
#define RPG_GAMECORE_RECOMMENDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19015620)
#define RPG_GAMECORE_RECOMMENDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19015EB0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 OrderAfterSell; // 0x30
