...
#define RPG_GAMECORE_RECOMMENDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16DCD160)
#define RPG_GAMECORE_RECOMMENDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16DCD980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RecommendConfigRow_TypeDefinitionIndex = 13265;
	...
	public:
		...
		::System::Boolean HideAfterSell; // 0x2C
