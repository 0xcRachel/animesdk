...
#define RPG_GAMECORE_SETMUNICIPALSTREAMCENTER_METHOD_3_88FA5BDC658E816E_OFFSET UNITYSDK_OFFSET(0x16F37E60)
#define RPG_GAMECORE_SETMUNICIPALSTREAMCENTER_METHOD_3_D76EF45C4158299F_OFFSET UNITYSDK_OFFSET(0x16F37EE0)
#define RPG_GAMECORE_SETMUNICIPALSTREAMCENTER__CTOR_OFFSET UNITYSDK_OFFSET(0x16F37EB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMunicipalStreamCenter_TypeDefinitionIndex = 19914;
