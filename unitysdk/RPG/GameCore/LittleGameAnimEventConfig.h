...
#define RPG_GAMECORE_LITTLEGAMEANIMEVENTCONFIG_METHOD_3_BE47AEEA8493B7FC_OFFSET UNITYSDK_OFFSET(0x173682C0)
#define RPG_GAMECORE_LITTLEGAMEANIMEVENTCONFIG_METHOD_3_C5F851B4666CD8B6_OFFSET UNITYSDK_OFFSET(0x173683C0)
#define RPG_GAMECORE_LITTLEGAMEANIMEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17368350)
