...
#define RPG_GAMECORE_TRIGGERROGUEDIALOGUE_METHOD_3_0316CD0EC67B6802_OFFSET UNITYSDK_OFFSET(0x1911DD70)
#define RPG_GAMECORE_TRIGGERROGUEDIALOGUE_METHOD_3_9F20E502AD84592B_OFFSET UNITYSDK_OFFSET(0x1911DCF0)
#define RPG_GAMECORE_TRIGGERROGUEDIALOGUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1911DD40)
