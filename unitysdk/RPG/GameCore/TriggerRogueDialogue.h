...
#define RPG_GAMECORE_TRIGGERROGUEDIALOGUE_METHOD_3_0316CD0EC67B6802_OFFSET UNITYSDK_OFFSET(0x17125C10)
#define RPG_GAMECORE_TRIGGERROGUEDIALOGUE_METHOD_3_9F20E502AD84592B_OFFSET UNITYSDK_OFFSET(0x17125B90)
#define RPG_GAMECORE_TRIGGERROGUEDIALOGUE__CTOR_OFFSET UNITYSDK_OFFSET(0x17125BE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerRogueDialogue_TypeDefinitionIndex = 18616;
