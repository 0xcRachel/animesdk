...
#define RPG_GAMECORE_TARGETSORTBYPROPERTYRATIO_METHOD_3_1A32BDA9438001C8_OFFSET UNITYSDK_OFFSET(0x17135C10)
#define RPG_GAMECORE_TARGETSORTBYPROPERTYRATIO_METHOD_3_F68B031937003FCA_OFFSET UNITYSDK_OFFSET(0x17134920)
#define RPG_GAMECORE_TARGETSORTBYPROPERTYRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x17134900)
