...
#define RPG_GAMECORE_MATCH3_SHOWEMOJIACTION_METHOD_5_90A5AF3A1D5DAF1C_OFFSET UNITYSDK_OFFSET(0x19989870)
#define RPG_GAMECORE_MATCH3_SHOWEMOJIACTION_METHOD_5_FB7E9D84217EA6AB_OFFSET UNITYSDK_OFFSET(0x199904A0)
#define RPG_GAMECORE_MATCH3_SHOWEMOJIACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19989800)
