...
#define RPG_GAMECORE_MATCH3_SHOWEMOJIACTION_METHOD_5_B5DF3AABAE6943CA_OFFSET UNITYSDK_OFFSET(0x18C2C590)
#define RPG_GAMECORE_MATCH3_SHOWEMOJIACTION_METHOD_5_DDED07DED3590889_OFFSET UNITYSDK_OFFSET(0x18C32ED0)
#define RPG_GAMECORE_MATCH3_SHOWEMOJIACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18C2C520)
