...
#define RPG_GAMECORE_MATCH3_SHOWPOPUPDIALOGACTION_METHOD_5_3C4D82EBE65ED1A9_OFFSET UNITYSDK_OFFSET(0x18C2C800)
#define RPG_GAMECORE_MATCH3_SHOWPOPUPDIALOGACTION_METHOD_5_75817511A69FF8FE_OFFSET UNITYSDK_OFFSET(0x18C32F80)
#define RPG_GAMECORE_MATCH3_SHOWPOPUPDIALOGACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18C2C790)
