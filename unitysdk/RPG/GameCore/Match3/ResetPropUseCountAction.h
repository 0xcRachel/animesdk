...
#define RPG_GAMECORE_MATCH3_RESETPROPUSECOUNTACTION_METHOD_5_3428437EA378E41B_OFFSET UNITYSDK_OFFSET(0x173B9480)
#define RPG_GAMECORE_MATCH3_RESETPROPUSECOUNTACTION_METHOD_5_DBEE0554D4342B32_OFFSET UNITYSDK_OFFSET(0x173C03A0)
#define RPG_GAMECORE_MATCH3_RESETPROPUSECOUNTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x173B9410)
