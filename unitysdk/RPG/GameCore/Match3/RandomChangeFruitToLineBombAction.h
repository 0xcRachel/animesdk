...
#define RPG_GAMECORE_MATCH3_RANDOMCHANGEFRUITTOLINEBOMBACTION_METHOD_5_192FCB22919003DE_OFFSET UNITYSDK_OFFSET(0x173B8E30)
#define RPG_GAMECORE_MATCH3_RANDOMCHANGEFRUITTOLINEBOMBACTION_METHOD_5_BA46351B25EDB7EC_OFFSET UNITYSDK_OFFSET(0x173C0240)
#define RPG_GAMECORE_MATCH3_RANDOMCHANGEFRUITTOLINEBOMBACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x173B8DC0)
