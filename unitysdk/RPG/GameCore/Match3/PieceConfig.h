...
#define RPG_GAMECORE_MATCH3_PIECECONFIG_METHOD_2_C4895AD839409AFE_OFFSET UNITYSDK_OFFSET(0x16C5A700)
#define RPG_GAMECORE_MATCH3_PIECECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16C5A870)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int PieceConfig_TypeDefinitionIndex = 22132;
