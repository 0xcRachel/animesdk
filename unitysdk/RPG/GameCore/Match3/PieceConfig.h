...
#define RPG_GAMECORE_MATCH3_PIECECONFIG_METHOD_2_C4895AD839409AFE_OFFSET UNITYSDK_OFFSET(0x18C31D80)
#define RPG_GAMECORE_MATCH3_PIECECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18C31EF0)
