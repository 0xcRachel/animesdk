...
#define RPG_GAMECORE_MATCH3_MATCH3TRIGGERBASE_METHOD_3_4BF3AEF28061CCC3_OFFSET UNITYSDK_OFFSET(0x16C59A30)
#define RPG_GAMECORE_MATCH3_MATCH3TRIGGERBASE_METHOD_3_BB7C501AE052E965_OFFSET UNITYSDK_OFFSET(0x16C59090)
#define RPG_GAMECORE_MATCH3_MATCH3TRIGGERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x16C4F370)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int Match3TriggerBase_TypeDefinitionIndex = 22137;
