...
#define RPG_GAMECORE_MATCH3_SETSTYLEWEIGHTACTION_METHOD_5_3F041305AA8BCE19_OFFSET UNITYSDK_OFFSET(0x18C32C10)
#define RPG_GAMECORE_MATCH3_SETSTYLEWEIGHTACTION_METHOD_5_69D3C2A117464277_OFFSET UNITYSDK_OFFSET(0x18C2BBD0)
#define RPG_GAMECORE_MATCH3_SETSTYLEWEIGHTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18C2BB60)
