...
#define RPG_GAMECORE_MATCH3_SETSCOREBONUSACTION_METHOD_5_B8FC9CD481543706_OFFSET UNITYSDK_OFFSET(0x18C2B950)
#define RPG_GAMECORE_MATCH3_SETSCOREBONUSACTION_METHOD_5_EBD08443661EE41D_OFFSET UNITYSDK_OFFSET(0x18C32B60)
#define RPG_GAMECORE_MATCH3_SETSCOREBONUSACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18C2B8E0)
