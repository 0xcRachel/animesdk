...
#define RPG_GAMECORE_MATCH3_SETACTIVIZATIONAREAACTION_METHOD_5_B27F0B951EE8177C_OFFSET UNITYSDK_OFFSET(0x18C328A0)
#define RPG_GAMECORE_MATCH3_SETACTIVIZATIONAREAACTION_METHOD_5_C7D5B3655E83417A_OFFSET UNITYSDK_OFFSET(0x18C2B060)
#define RPG_GAMECORE_MATCH3_SETACTIVIZATIONAREAACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18C2AFF0)
