...
#define RPG_GAMECORE_MATCH3_APPLYCHESSBOARDTEMPLATERULEACTION_METHOD_5_2461F01E04B7274A_OFFSET UNITYSDK_OFFSET(0x18C260C0)
#define RPG_GAMECORE_MATCH3_APPLYCHESSBOARDTEMPLATERULEACTION_METHOD_5_65F7A4CF77CC63CC_OFFSET UNITYSDK_OFFSET(0x18C25FA0)
#define RPG_GAMECORE_MATCH3_APPLYCHESSBOARDTEMPLATERULEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18C26050)
