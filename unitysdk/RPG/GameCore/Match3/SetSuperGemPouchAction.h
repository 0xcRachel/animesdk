...
#define RPG_GAMECORE_MATCH3_SETSUPERGEMPOUCHACTION_METHOD_5_5925CFB2A00527AE_OFFSET UNITYSDK_OFFSET(0x18C32CC0)
#define RPG_GAMECORE_MATCH3_SETSUPERGEMPOUCHACTION_METHOD_5_6E63E02DC554E499_OFFSET UNITYSDK_OFFSET(0x18C2BE00)
#define RPG_GAMECORE_MATCH3_SETSUPERGEMPOUCHACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18C2BD90)
