...
#define RPG_GAMECORE_MATCH3_SHOWCHARACTERCUTINGROUPACTION_METHOD_5_8A0F2C36D0EDB02E_OFFSET UNITYSDK_OFFSET(0x173BA880)
#define RPG_GAMECORE_MATCH3_SHOWCHARACTERCUTINGROUPACTION_METHOD_5_DC666C895D7F50BC_OFFSET UNITYSDK_OFFSET(0x173C0DA0)
#define RPG_GAMECORE_MATCH3_SHOWCHARACTERCUTINGROUPACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x173BA810)
