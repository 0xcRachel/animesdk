...
#define RPG_GAMECORE_MATCH3_RANDOMFREEZEBOMBACTION_METHOD_5_0589B181DE51E26F_OFFSET UNITYSDK_OFFSET(0x173B9080)
#define RPG_GAMECORE_MATCH3_RANDOMFREEZEBOMBACTION_METHOD_5_E7BB0BEADF59CB19_OFFSET UNITYSDK_OFFSET(0x173C02F0)
#define RPG_GAMECORE_MATCH3_RANDOMFREEZEBOMBACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x173B9010)
