...
#define RPG_GAMECORE_MATCH3_TRYSKIPTUTORIALACTION_METHOD_5_6FC228BE0CC82B93_OFFSET UNITYSDK_OFFSET(0x173C1C10)
#define RPG_GAMECORE_MATCH3_TRYSKIPTUTORIALACTION_METHOD_5_828AED4183A8B1AA_OFFSET UNITYSDK_OFFSET(0x173C1A20)
#define RPG_GAMECORE_MATCH3_TRYSKIPTUTORIALACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x173C1BA0)
