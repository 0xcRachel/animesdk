...
#define RPG_GAMECORE_MATCH3_BIRDSKILLACTIONGENERATEBOMB_METHOD_5_3793E39D59A6C5BE_OFFSET UNITYSDK_OFFSET(0x18C26B20)
#define RPG_GAMECORE_MATCH3_BIRDSKILLACTIONGENERATEBOMB_METHOD_5_50754097DB3A1DB1_OFFSET UNITYSDK_OFFSET(0x18C26A10)
#define RPG_GAMECORE_MATCH3_BIRDSKILLACTIONGENERATEBOMB__CTOR_OFFSET UNITYSDK_OFFSET(0x18C26AB0)
