...
#define RPG_GAMECORE_MATCH3_ROUNDANDSTEPCONDITION_METHOD_5_61063213955B8018_OFFSET UNITYSDK_OFFSET(0x1998C9D0)
#define RPG_GAMECORE_MATCH3_ROUNDANDSTEPCONDITION_METHOD_5_DE2C30481A1D0514_OFFSET UNITYSDK_OFFSET(0x1998FC30)
#define RPG_GAMECORE_MATCH3_ROUNDANDSTEPCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1998C950)
