...
#define RPG_GAMECORE_MATCH3_MATCH3CHESSBOARDTEMPLATE_METHOD_2_630AE32847656A2D_OFFSET UNITYSDK_OFFSET(0x18C2D6D0)
#define RPG_GAMECORE_MATCH3_MATCH3CHESSBOARDTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C2D920)
