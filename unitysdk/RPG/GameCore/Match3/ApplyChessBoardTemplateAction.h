...
#define RPG_GAMECORE_MATCH3_APPLYCHESSBOARDTEMPLATEACTION_METHOD_5_3B8D71B1689B0B90_OFFSET UNITYSDK_OFFSET(0x18C25EB0)
#define RPG_GAMECORE_MATCH3_APPLYCHESSBOARDTEMPLATEACTION_METHOD_5_46E68DE7574D70AE_OFFSET UNITYSDK_OFFSET(0x18C25D90)
#define RPG_GAMECORE_MATCH3_APPLYCHESSBOARDTEMPLATEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18C25E40)
