...
#define RPG_GAMECORE_MATCH3_BIRDSKILLACTIONGENERATEITEMPACK_METHOD_5_07F523705A4C7B75_OFFSET UNITYSDK_OFFSET(0x18C26E30)
#define RPG_GAMECORE_MATCH3_BIRDSKILLACTIONGENERATEITEMPACK_METHOD_5_61525920204C4ED3_OFFSET UNITYSDK_OFFSET(0x18C26D20)
#define RPG_GAMECORE_MATCH3_BIRDSKILLACTIONGENERATEITEMPACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18C26DC0)
