...
#define RPG_GAMECORE_ITEMAUTOTRANSFERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B87BA0)
#define RPG_GAMECORE_ITEMAUTOTRANSFERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B87CF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ItemAutoTransferRow_TypeDefinitionIndex = 12635;
