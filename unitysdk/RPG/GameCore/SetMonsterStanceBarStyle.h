...
#define RPG_GAMECORE_SETMONSTERSTANCEBARSTYLE_METHOD_3_1D0558F10163742D_OFFSET UNITYSDK_OFFSET(0x16F375A0)
#define RPG_GAMECORE_SETMONSTERSTANCEBARSTYLE_METHOD_3_9A75D13F99772FDA_OFFSET UNITYSDK_OFFSET(0x16F37620)
#define RPG_GAMECORE_SETMONSTERSTANCEBARSTYLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F375F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMonsterStanceBarStyle_TypeDefinitionIndex = 20593;
