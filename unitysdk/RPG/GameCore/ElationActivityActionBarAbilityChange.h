...
#define RPG_GAMECORE_ELATIONACTIVITYACTIONBARABILITYCHANGE_METHOD_3_8473306A632D0B94_OFFSET UNITYSDK_OFFSET(0x16A5C1E0)
#define RPG_GAMECORE_ELATIONACTIVITYACTIONBARABILITYCHANGE_METHOD_3_98EFA70BF9DB095D_OFFSET UNITYSDK_OFFSET(0x16A5C260)
#define RPG_GAMECORE_ELATIONACTIVITYACTIONBARABILITYCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16A5C230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElationActivityActionBarAbilityChange_TypeDefinitionIndex = 20482;
