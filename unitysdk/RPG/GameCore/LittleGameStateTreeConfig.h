...
#define RPG_GAMECORE_LITTLEGAMESTATETREECONFIG_METHOD_3_77AA48EEF1F02CD7_OFFSET UNITYSDK_OFFSET(0x16BCBC20)
#define RPG_GAMECORE_LITTLEGAMESTATETREECONFIG_METHOD_3_950D5B9EEEF1A233_OFFSET UNITYSDK_OFFSET(0x16BD1BF0)
#define RPG_GAMECORE_LITTLEGAMESTATETREECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16BCBC00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameStateTreeConfig_TypeDefinitionIndex = 16895;
