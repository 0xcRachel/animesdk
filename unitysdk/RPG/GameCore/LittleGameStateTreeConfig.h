...
#define RPG_GAMECORE_LITTLEGAMESTATETREECONFIG_METHOD_3_77AA48EEF1F02CD7_OFFSET UNITYSDK_OFFSET(0x1736F6A0)
#define RPG_GAMECORE_LITTLEGAMESTATETREECONFIG_METHOD_3_950D5B9EEEF1A233_OFFSET UNITYSDK_OFFSET(0x17375660)
#define RPG_GAMECORE_LITTLEGAMESTATETREECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1736F680)
