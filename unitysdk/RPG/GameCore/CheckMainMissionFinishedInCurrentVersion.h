...
#define RPG_GAMECORE_CHECKMAINMISSIONFINISHEDINCURRENTVERSION_METHOD_3_E5CBB24922133035_OFFSET UNITYSDK_OFFSET(0x18D64E90)
#define RPG_GAMECORE_CHECKMAINMISSIONFINISHEDINCURRENTVERSION_METHOD_3_F567AF6FDE3FFE04_OFFSET UNITYSDK_OFFSET(0x18D64F10)
#define RPG_GAMECORE_CHECKMAINMISSIONFINISHEDINCURRENTVERSION__CTOR_OFFSET UNITYSDK_OFFSET(0x18D64EE0)
