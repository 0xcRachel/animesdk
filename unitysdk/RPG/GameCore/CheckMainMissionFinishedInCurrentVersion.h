...
#define RPG_GAMECORE_CHECKMAINMISSIONFINISHEDINCURRENTVERSION_METHOD_3_E5CBB24922133035_OFFSET UNITYSDK_OFFSET(0x17089F70)
#define RPG_GAMECORE_CHECKMAINMISSIONFINISHEDINCURRENTVERSION_METHOD_3_F567AF6FDE3FFE04_OFFSET UNITYSDK_OFFSET(0x17089FF0)
#define RPG_GAMECORE_CHECKMAINMISSIONFINISHEDINCURRENTVERSION__CTOR_OFFSET UNITYSDK_OFFSET(0x17089FC0)
