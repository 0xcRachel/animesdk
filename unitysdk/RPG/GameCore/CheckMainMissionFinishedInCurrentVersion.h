...
#define RPG_GAMECORE_CHECKMAINMISSIONFINISHEDINCURRENTVERSION_METHOD_3_E5CBB24922133035_OFFSET UNITYSDK_OFFSET(0x169788F0)
#define RPG_GAMECORE_CHECKMAINMISSIONFINISHEDINCURRENTVERSION_METHOD_3_F567AF6FDE3FFE04_OFFSET UNITYSDK_OFFSET(0x16978970)
#define RPG_GAMECORE_CHECKMAINMISSIONFINISHEDINCURRENTVERSION__CTOR_OFFSET UNITYSDK_OFFSET(0x16978940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CheckMainMissionFinishedInCurrentVersion_TypeDefinitionIndex = 18567;
