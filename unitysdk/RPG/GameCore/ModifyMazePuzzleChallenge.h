...
#define RPG_GAMECORE_MODIFYMAZEPUZZLECHALLENGE_METHOD_3_36AEFAC3D94EA577_OFFSET UNITYSDK_OFFSET(0x174468D0)
#define RPG_GAMECORE_MODIFYMAZEPUZZLECHALLENGE_METHOD_3_EEA6BF9E850632D8_OFFSET UNITYSDK_OFFSET(0x17446950)
#define RPG_GAMECORE_MODIFYMAZEPUZZLECHALLENGE__CTOR_OFFSET UNITYSDK_OFFSET(0x17446920)
