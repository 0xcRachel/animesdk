...
#define RPG_GAMECORE_BYHASSKILLTYPE_METHOD_4_C016AB906C6F264A_OFFSET UNITYSDK_OFFSET(0x16927ED0)
#define RPG_GAMECORE_BYHASSKILLTYPE_METHOD_4_EDA76B9D90772CAD_OFFSET UNITYSDK_OFFSET(0x16927DB0)
#define RPG_GAMECORE_BYHASSKILLTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x16927E50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHasSkillType_TypeDefinitionIndex = 20685;
