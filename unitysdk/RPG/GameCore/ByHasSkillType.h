...
#define RPG_GAMECORE_BYHASSKILLTYPE_METHOD_4_C016AB906C6F264A_OFFSET UNITYSDK_OFFSET(0x17039270)
#define RPG_GAMECORE_BYHASSKILLTYPE_METHOD_4_EDA76B9D90772CAD_OFFSET UNITYSDK_OFFSET(0x17039150)
#define RPG_GAMECORE_BYHASSKILLTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x170391F0)
