...
#define RPG_GAMECORE_PERFORMANCEREPLAY_SETGROUPPROPERTY_METHOD_3_13900B039E692EA7_OFFSET UNITYSDK_OFFSET(0x16D29F70)
#define RPG_GAMECORE_PERFORMANCEREPLAY_SETGROUPPROPERTY_METHOD_3_BFB7600C2BD496AC_OFFSET UNITYSDK_OFFSET(0x16D29FF0)
#define RPG_GAMECORE_PERFORMANCEREPLAY_SETGROUPPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x16D29FC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceReplay_SetGroupProperty_TypeDefinitionIndex = 19493;
