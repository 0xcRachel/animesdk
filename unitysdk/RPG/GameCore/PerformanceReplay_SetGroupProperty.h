...
#define RPG_GAMECORE_PERFORMANCEREPLAY_SETGROUPPROPERTY_METHOD_3_13900B039E692EA7_OFFSET UNITYSDK_OFFSET(0x174B1FA0)
#define RPG_GAMECORE_PERFORMANCEREPLAY_SETGROUPPROPERTY_METHOD_3_BFB7600C2BD496AC_OFFSET UNITYSDK_OFFSET(0x174B2020)
#define RPG_GAMECORE_PERFORMANCEREPLAY_SETGROUPPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x174B1FF0)
