...
#define RPG_GAMECORE_STACKPROPERTY_METHOD_3_6B458B21AD8B655A_OFFSET UNITYSDK_OFFSET(0x16F81D20)
#define RPG_GAMECORE_STACKPROPERTY_METHOD_3_E9DBEE011D0851D4_OFFSET UNITYSDK_OFFSET(0x16F81DA0)
#define RPG_GAMECORE_STACKPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x16F81D70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StackProperty_TypeDefinitionIndex = 21239;
