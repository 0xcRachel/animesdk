...
#define RPG_GAMECORE_NPCMONSTERTRACKQUESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16D058C0)
#define RPG_GAMECORE_NPCMONSTERTRACKQUESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16D05ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NpcMonsterTrackQuestRow_TypeDefinitionIndex = 13233;
