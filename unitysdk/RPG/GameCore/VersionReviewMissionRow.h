...
#define RPG_GAMECORE_VERSIONREVIEWMISSIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x179034C0)
#define RPG_GAMECORE_VERSIONREVIEWMISSIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17903A90)
