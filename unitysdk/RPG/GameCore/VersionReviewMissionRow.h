...
#define RPG_GAMECORE_VERSIONREVIEWMISSIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19520210)
#define RPG_GAMECORE_VERSIONREVIEWMISSIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x195207E0)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::UInt32 StoryStartEntranceID; // 0x10
		::System::UInt32 PreMainMissionID; // 0x14
		::System::UInt32 ReviewMainMissionID; // 0x18
		::System::UInt32 StoryPerformanceID; // 0x1C
