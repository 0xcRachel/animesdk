...
#define RPG_GAMECORE_VERSIONREVIEWMISSIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17147300)
#define RPG_GAMECORE_VERSIONREVIEWMISSIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17147950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VersionReviewMissionRow_TypeDefinitionIndex = 12889;
