...
#define RPG_GAMECORE_BYCOMPAREMAINMISSIONSTATE_METHOD_4_3771C9D992A84AD1_OFFSET UNITYSDK_OFFSET(0x19AC8C40)
#define RPG_GAMECORE_BYCOMPAREMAINMISSIONSTATE_METHOD_4_95B5D7115B39CE49_OFFSET UNITYSDK_OFFSET(0x19AC8B60)
#define RPG_GAMECORE_BYCOMPAREMAINMISSIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19AC8BE0)
