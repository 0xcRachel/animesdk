...
#define RPG_GAMECORE_BYCOMPAREMAINMISSIONSTATE_METHOD_4_3771C9D992A84AD1_OFFSET UNITYSDK_OFFSET(0x16911590)
#define RPG_GAMECORE_BYCOMPAREMAINMISSIONSTATE_METHOD_4_95B5D7115B39CE49_OFFSET UNITYSDK_OFFSET(0x169114B0)
#define RPG_GAMECORE_BYCOMPAREMAINMISSIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16911530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareMainMissionState_TypeDefinitionIndex = 18082;
