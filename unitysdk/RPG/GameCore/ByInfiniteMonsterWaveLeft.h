...
#define RPG_GAMECORE_BYINFINITEMONSTERWAVELEFT_METHOD_4_04838D9FB0FF0B8F_OFFSET UNITYSDK_OFFSET(0x19AE3C10)
#define RPG_GAMECORE_BYINFINITEMONSTERWAVELEFT_METHOD_4_C4EB45136157ADBD_OFFSET UNITYSDK_OFFSET(0x19AE3CF0)
#define RPG_GAMECORE_BYINFINITEMONSTERWAVELEFT__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE3C90)
