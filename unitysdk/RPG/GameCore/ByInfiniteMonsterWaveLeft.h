...
#define RPG_GAMECORE_BYINFINITEMONSTERWAVELEFT_METHOD_4_04838D9FB0FF0B8F_OFFSET UNITYSDK_OFFSET(0x19D9A9A0)
#define RPG_GAMECORE_BYINFINITEMONSTERWAVELEFT_METHOD_4_6D250800DA8C47E8_OFFSET UNITYSDK_OFFSET(0x19D9AC10)
#define RPG_GAMECORE_BYINFINITEMONSTERWAVELEFT_METHOD_4_8B9D3E4440814470_OFFSET UNITYSDK_OFFSET(0x19D9AC90)
#define RPG_GAMECORE_BYINFINITEMONSTERWAVELEFT_METHOD_4_C4EB45136157ADBD_OFFSET UNITYSDK_OFFSET(0x19D9AA80)
#define RPG_GAMECORE_BYINFINITEMONSTERWAVELEFT__CTOR_OFFSET UNITYSDK_OFFSET(0x19D9AA20)
