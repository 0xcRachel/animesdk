...
#define RPG_GAMECORE_CHESSATTACKHIT_METHOD_3_7A73BC45F86A4AB1_OFFSET UNITYSDK_OFFSET(0x1697C8B0)
#define RPG_GAMECORE_CHESSATTACKHIT_METHOD_3_F3D3DA7312C30FAE_OFFSET UNITYSDK_OFFSET(0x1697C770)
#define RPG_GAMECORE_CHESSATTACKHIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1697C820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChessAttackHit_TypeDefinitionIndex = 21432;
