...
#define RPG_GAMECORE_TARGETFETCHADVTEAMMEMBERS_METHOD_4_3706E2686308BE7B_OFFSET UNITYSDK_OFFSET(0x199DFA80)
#define RPG_GAMECORE_TARGETFETCHADVTEAMMEMBERS_METHOD_4_63315671B3CEEEAD_OFFSET UNITYSDK_OFFSET(0x199D7370)
#define RPG_GAMECORE_TARGETFETCHADVTEAMMEMBERS__CTOR_OFFSET UNITYSDK_OFFSET(0x199D7320)
