...
#define RPG_GAMECORE_TARGETFETCHADVTEAMMEMBERS_METHOD_4_3706E2686308BE7B_OFFSET UNITYSDK_OFFSET(0x16FDB540)
#define RPG_GAMECORE_TARGETFETCHADVTEAMMEMBERS_METHOD_4_63315671B3CEEEAD_OFFSET UNITYSDK_OFFSET(0x16FD34F0)
#define RPG_GAMECORE_TARGETFETCHADVTEAMMEMBERS__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD34A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAdvTeamMembers_TypeDefinitionIndex = 21568;
