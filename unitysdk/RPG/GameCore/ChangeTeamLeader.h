...
#define RPG_GAMECORE_CHANGETEAMLEADER_METHOD_3_408D85C59FCA14BB_OFFSET UNITYSDK_OFFSET(0x16967740)
#define RPG_GAMECORE_CHANGETEAMLEADER_METHOD_3_5DC8423F3999D3EB_OFFSET UNITYSDK_OFFSET(0x169676B0)
#define RPG_GAMECORE_CHANGETEAMLEADER__CTOR_OFFSET UNITYSDK_OFFSET(0x16967710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeTeamLeader_TypeDefinitionIndex = 19241;
