...
#define RPG_GAMECORE_SETFILTERVOLUMEENABLE_METHOD_3_2E5DB2CAF24C3A43_OFFSET UNITYSDK_OFFSET(0x16F2C390)
#define RPG_GAMECORE_SETFILTERVOLUMEENABLE_METHOD_3_F7AE4A335EC7C5CA_OFFSET UNITYSDK_OFFSET(0x16F2C310)
#define RPG_GAMECORE_SETFILTERVOLUMEENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F2C360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFilterVolumeEnable_TypeDefinitionIndex = 19908;
