...
#define RPG_GAMECORE_SETLEVELCHALLENGETURNLIMIT_METHOD_3_656347DAADC7C16D_OFFSET UNITYSDK_OFFSET(0x199B9EC0)
#define RPG_GAMECORE_SETLEVELCHALLENGETURNLIMIT_METHOD_3_83C5868FBDE16B6E_OFFSET UNITYSDK_OFFSET(0x199B9E40)
#define RPG_GAMECORE_SETLEVELCHALLENGETURNLIMIT__CTOR_OFFSET UNITYSDK_OFFSET(0x199B9E90)
