...
#define RPG_GAMECORE_CLIENTLOGCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x169A64B0)
#define RPG_GAMECORE_CLIENTLOGCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x169A6690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClientLogConfigRow_TypeDefinitionIndex = 12006;
