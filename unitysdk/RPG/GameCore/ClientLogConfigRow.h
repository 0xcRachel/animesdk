...
#define RPG_GAMECORE_CLIENTLOGCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x170C8630)
#define RPG_GAMECORE_CLIENTLOGCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x170C8810)
