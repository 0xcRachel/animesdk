...
#define RPG_GAMECORE_CHIMERADUELPROBABILITYNODE_METHOD_3_124DFD5F7173633E_OFFSET UNITYSDK_OFFSET(0x170B7370)
#define RPG_GAMECORE_CHIMERADUELPROBABILITYNODE_METHOD_3_5C7AC2C757C52D33_OFFSET UNITYSDK_OFFSET(0x170B7290)
#define RPG_GAMECORE_CHIMERADUELPROBABILITYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x170B7320)
