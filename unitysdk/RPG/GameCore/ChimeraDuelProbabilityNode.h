...
#define RPG_GAMECORE_CHIMERADUELPROBABILITYNODE_METHOD_3_124DFD5F7173633E_OFFSET UNITYSDK_OFFSET(0x16995610)
#define RPG_GAMECORE_CHIMERADUELPROBABILITYNODE_METHOD_3_5C7AC2C757C52D33_OFFSET UNITYSDK_OFFSET(0x16995530)
#define RPG_GAMECORE_CHIMERADUELPROBABILITYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x169955C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelProbabilityNode_TypeDefinitionIndex = 14422;
