...
#define RPG_GAMECORE_ACTIONTRIGGERACTIONWITHCONDITIONWITHFAILCONFIG_METHOD_4_5D9A33471C5FF063_OFFSET UNITYSDK_OFFSET(0x18861F30)
#define RPG_GAMECORE_ACTIONTRIGGERACTIONWITHCONDITIONWITHFAILCONFIG_METHOD_4_79D3DFB91243BE5E_OFFSET UNITYSDK_OFFSET(0x18862010)
#define RPG_GAMECORE_ACTIONTRIGGERACTIONWITHCONDITIONWITHFAILCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18861FC0)
