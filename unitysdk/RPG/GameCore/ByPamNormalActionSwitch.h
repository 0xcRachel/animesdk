...
#define RPG_GAMECORE_BYPAMNORMALACTIONSWITCH_METHOD_4_5D4766A23BCC3200_OFFSET UNITYSDK_OFFSET(0x19DBB080)
#define RPG_GAMECORE_BYPAMNORMALACTIONSWITCH_METHOD_4_7BDD93835A513158_OFFSET UNITYSDK_OFFSET(0x19DBB000)
#define RPG_GAMECORE_BYPAMNORMALACTIONSWITCH_METHOD_4_E71FC503138E632F_OFFSET UNITYSDK_OFFSET(0x19DBAEC0)
#define RPG_GAMECORE_BYPAMNORMALACTIONSWITCH_METHOD_4_FDB6515367220805_OFFSET UNITYSDK_OFFSET(0x19DBADF0)
#define RPG_GAMECORE_BYPAMNORMALACTIONSWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x19DBAE70)
