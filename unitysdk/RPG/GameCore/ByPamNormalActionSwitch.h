...
#define RPG_GAMECORE_BYPAMNORMALACTIONSWITCH_METHOD_4_E71FC503138E632F_OFFSET UNITYSDK_OFFSET(0x1693AA70)
#define RPG_GAMECORE_BYPAMNORMALACTIONSWITCH_METHOD_4_FDB6515367220805_OFFSET UNITYSDK_OFFSET(0x1693A9A0)
#define RPG_GAMECORE_BYPAMNORMALACTIONSWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1693AA20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByPamNormalActionSwitch_TypeDefinitionIndex = 17771;
