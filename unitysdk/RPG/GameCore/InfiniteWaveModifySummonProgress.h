...
#define RPG_GAMECORE_INFINITEWAVEMODIFYSUMMONPROGRESS_METHOD_3_05AB269B1C61DA92_OFFSET UNITYSDK_OFFSET(0x16B804E0)
#define RPG_GAMECORE_INFINITEWAVEMODIFYSUMMONPROGRESS_METHOD_3_92BB0C4FB111FCD6_OFFSET UNITYSDK_OFFSET(0x16B80460)
#define RPG_GAMECORE_INFINITEWAVEMODIFYSUMMONPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x16B804B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InfiniteWaveModifySummonProgress_TypeDefinitionIndex = 20939;
