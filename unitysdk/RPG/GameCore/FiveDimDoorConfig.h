...
#define RPG_GAMECORE_FIVEDIMDOORCONFIG_METHOD_3_2AAEC2282D173F5F_OFFSET UNITYSDK_OFFSET(0x16ABA130)
#define RPG_GAMECORE_FIVEDIMDOORCONFIG_METHOD_3_505EE027A7E5EC63_OFFSET UNITYSDK_OFFSET(0x16AB9EA0)
#define RPG_GAMECORE_FIVEDIMDOORCONFIG_METHOD_3_8D87B72FD1FC440D_OFFSET UNITYSDK_OFFSET(0x16AB9E10)
#define RPG_GAMECORE_FIVEDIMDOORCONFIG_METHOD_3_BB881F05E41D3A04_OFFSET UNITYSDK_OFFSET(0x16ABA1A0)
#define RPG_GAMECORE_FIVEDIMDOORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16AB9E70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimDoorConfig_TypeDefinitionIndex = 16688;
