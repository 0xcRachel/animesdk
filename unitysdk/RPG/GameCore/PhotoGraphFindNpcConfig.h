...
#define RPG_GAMECORE_PHOTOGRAPHFINDNPCCONFIG_METHOD_2_D4C62EA6FC391019_OFFSET UNITYSDK_OFFSET(0x16D36D50)
#define RPG_GAMECORE_PHOTOGRAPHFINDNPCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16D36E50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphFindNpcConfig_TypeDefinitionIndex = 19262;
