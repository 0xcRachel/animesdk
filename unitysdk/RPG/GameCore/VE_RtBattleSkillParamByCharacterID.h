...
#define RPG_GAMECORE_VE_RTBATTLESKILLPARAMBYCHARACTERID_METHOD_3_7C25BD28B3A8E07F_OFFSET UNITYSDK_OFFSET(0x1951C6A0)
#define RPG_GAMECORE_VE_RTBATTLESKILLPARAMBYCHARACTERID_METHOD_3_B97A48CB5EACBF2E_OFFSET UNITYSDK_OFFSET(0x1951C660)
#define RPG_GAMECORE_VE_RTBATTLESKILLPARAMBYCHARACTERID__CTOR_OFFSET UNITYSDK_OFFSET(0x1951C690)
