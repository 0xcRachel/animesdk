...
#define RPG_GAMECORE_FIVEDIMRESUMEMUSICACTION_METHOD_3_553BA8C7B27049C4_OFFSET UNITYSDK_OFFSET(0x1721BDC0)
#define RPG_GAMECORE_FIVEDIMRESUMEMUSICACTION_METHOD_3_658BF22C34BCAA1D_OFFSET UNITYSDK_OFFSET(0x1721BD00)
#define RPG_GAMECORE_FIVEDIMRESUMEMUSICACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1721BDA0)
