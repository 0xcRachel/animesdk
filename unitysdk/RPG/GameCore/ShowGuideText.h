...
#define RPG_GAMECORE_SHOWGUIDETEXT_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x16F5CDC0)
#define RPG_GAMECORE_SHOWGUIDETEXT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16F5CCE0)
#define RPG_GAMECORE_SHOWGUIDETEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F5CD60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowGuideText_TypeDefinitionIndex = 21813;
