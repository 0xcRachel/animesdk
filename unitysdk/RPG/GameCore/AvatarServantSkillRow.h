...
#define RPG_GAMECORE_AVATARSERVANTSKILLROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x1763FEC0)
#define RPG_GAMECORE_AVATARSERVANTSKILLROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17640CD0)
#define RPG_GAMECORE_AVATARSERVANTSKILLROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x176425E0)
#define RPG_GAMECORE_AVATARSERVANTSKILLROW_RESET_OFFSET UNITYSDK_OFFSET(0x17642640)
#define RPG_GAMECORE_AVATARSERVANTSKILLROW__CTOR_OFFSET UNITYSDK_OFFSET(0x176426B0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::AttackDamageType StanceDamageType; // 0x84
		::RPG::Client::TextID SkillName; // 0x88
		::RPG::Client::TextID SkillTag; // 0x98
		::RPG::GameCore::FixPoint SPMultipleRatio; // 0xA8
		::System::Int32 StanceDamageDisplay; // 0xB0
		::RPG::GameCore::SkillEffect SkillEffect; // 0xB4
		...
		::RPG::GameCore::FixPoint SPAdd; // 0x100
		::RPG::Client::TextID SkillNeed; // 0x108
		::System::UInt32 Level; // 0x118
