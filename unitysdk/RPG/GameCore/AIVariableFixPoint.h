...
#define RPG_GAMECORE_AIVARIABLEFIXPOINT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19882E30)
#define RPG_GAMECORE_AIVARIABLEFIXPOINT_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x19882D20)
#define RPG_GAMECORE_AIVARIABLEFIXPOINT_EQUALS_OFFSET UNITYSDK_OFFSET(0x19882CD0)
#define RPG_GAMECORE_AIVARIABLEFIXPOINT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19882EF0)
#define RPG_GAMECORE_AIVARIABLEFIXPOINT_METHOD_3_03174FDB36F50989_OFFSET UNITYSDK_OFFSET(0x19882CA0)
#define RPG_GAMECORE_AIVARIABLEFIXPOINT_METHOD_3_6F8BF55838C3F6C5_1_OFFSET UNITYSDK_OFFSET(0x19883020)
#define RPG_GAMECORE_AIVARIABLEFIXPOINT_METHOD_3_6F8BF55838C3F6C5_OFFSET UNITYSDK_OFFSET(0x19882FE0)
#define RPG_GAMECORE_AIVARIABLEFIXPOINT_METHOD_3_DF067467E6E7E848_OFFSET UNITYSDK_OFFSET(0x19882060)
#define RPG_GAMECORE_AIVARIABLEFIXPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x19882050)
