...
#define RPG_GAMECORE_RANDOMSELECTDYNAMICVALUE_METHOD_3_3304993DCF94BE18_OFFSET UNITYSDK_OFFSET(0x16DC76B0)
#define RPG_GAMECORE_RANDOMSELECTDYNAMICVALUE_METHOD_3_419FEB55404B44EB_OFFSET UNITYSDK_OFFSET(0x16DC7730)
#define RPG_GAMECORE_RANDOMSELECTDYNAMICVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x16DC7700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RandomSelectDynamicValue_TypeDefinitionIndex = 20548;
