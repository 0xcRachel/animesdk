...
#define RPG_GAMECORE_SHOWBATTLEALERT_METHOD_3_3703130F7353B5DD_OFFSET UNITYSDK_OFFSET(0x16F539B0)
#define RPG_GAMECORE_SHOWBATTLEALERT_METHOD_3_69C996B6AA39C5D4_OFFSET UNITYSDK_OFFSET(0x16F53A30)
#define RPG_GAMECORE_SHOWBATTLEALERT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F53A00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowBattleAlert_TypeDefinitionIndex = 20576;
