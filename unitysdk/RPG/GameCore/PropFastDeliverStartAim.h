...
#define RPG_GAMECORE_PROPFASTDELIVERSTARTAIM_METHOD_3_91BB5A48DD9744DB_OFFSET UNITYSDK_OFFSET(0x16DABCF0)
#define RPG_GAMECORE_PROPFASTDELIVERSTARTAIM_METHOD_3_9E2199BE99BE22E5_OFFSET UNITYSDK_OFFSET(0x16DABBA0)
#define RPG_GAMECORE_PROPFASTDELIVERSTARTAIM__CTOR_OFFSET UNITYSDK_OFFSET(0x16DABC60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropFastDeliverStartAim_TypeDefinitionIndex = 19809;
