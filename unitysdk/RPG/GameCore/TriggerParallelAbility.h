...
#define RPG_GAMECORE_TRIGGERPARALLELABILITY_METHOD_3_341605BAD5FC5F84_OFFSET UNITYSDK_OFFSET(0x171241F0)
#define RPG_GAMECORE_TRIGGERPARALLELABILITY_METHOD_3_947D33E561EE13F5_OFFSET UNITYSDK_OFFSET(0x17124270)
#define RPG_GAMECORE_TRIGGERPARALLELABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x17124240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerParallelAbility_TypeDefinitionIndex = 20329;
