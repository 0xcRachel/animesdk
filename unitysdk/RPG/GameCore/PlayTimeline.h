...
#define RPG_GAMECORE_PLAYTIMELINE_METHOD_3_DB982F5CED19516C_OFFSET UNITYSDK_OFFSET(0x16D53E30)
#define RPG_GAMECORE_PLAYTIMELINE_METHOD_3_F81839EEA09F025E_OFFSET UNITYSDK_OFFSET(0x16D53DA0)
#define RPG_GAMECORE_PLAYTIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x16D53E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayTimeline_TypeDefinitionIndex = 18416;
