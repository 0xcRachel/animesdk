...
#define RPG_GAMECORE_BYISPROPERTYVALUEMINORMAX_METHOD_4_7A8EE6DDDBC48682_OFFSET UNITYSDK_OFFSET(0x17045BD0)
#define RPG_GAMECORE_BYISPROPERTYVALUEMINORMAX_METHOD_4_E88E6D2A4B53730E_OFFSET UNITYSDK_OFFSET(0x17045CF0)
#define RPG_GAMECORE_BYISPROPERTYVALUEMINORMAX__CTOR_OFFSET UNITYSDK_OFFSET(0x17045C70)
