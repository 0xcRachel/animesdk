...
#define RPG_GAMECORE_BYISPROPERTYVALUEMINORMAX_METHOD_4_7A8EE6DDDBC48682_OFFSET UNITYSDK_OFFSET(0x169347A0)
#define RPG_GAMECORE_BYISPROPERTYVALUEMINORMAX_METHOD_4_E88E6D2A4B53730E_OFFSET UNITYSDK_OFFSET(0x169348C0)
#define RPG_GAMECORE_BYISPROPERTYVALUEMINORMAX__CTOR_OFFSET UNITYSDK_OFFSET(0x16934840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsPropertyValueMinOrMax_TypeDefinitionIndex = 20197;
