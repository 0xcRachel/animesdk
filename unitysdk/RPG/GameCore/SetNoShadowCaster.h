...
#define RPG_GAMECORE_SETNOSHADOWCASTER_METHOD_3_2A4CE371EF606860_OFFSET UNITYSDK_OFFSET(0x199C0D80)
#define RPG_GAMECORE_SETNOSHADOWCASTER_METHOD_3_D83FB2420A99D9F1_OFFSET UNITYSDK_OFFSET(0x199C0D00)
#define RPG_GAMECORE_SETNOSHADOWCASTER__CTOR_OFFSET UNITYSDK_OFFSET(0x199C0D50)
