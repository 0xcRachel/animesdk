...
#define RPG_GAMECORE_SETTARGETASSETPRELOADSTATE_METHOD_3_28AF525F2DDC4B9A_OFFSET UNITYSDK_OFFSET(0x16F3FF50)
#define RPG_GAMECORE_SETTARGETASSETPRELOADSTATE_METHOD_3_F58C7E8B644B2C5F_OFFSET UNITYSDK_OFFSET(0x16F40030)
#define RPG_GAMECORE_SETTARGETASSETPRELOADSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F3FF90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTargetAssetPreloadState_TypeDefinitionIndex = 20453;
