...
#define RPG_GAMECORE_TRYTRANSFERTOHEROROOM_METHOD_3_13D3F7FB70C6090B_OFFSET UNITYSDK_OFFSET(0x1712A2C0)
#define RPG_GAMECORE_TRYTRANSFERTOHEROROOM_METHOD_3_D298B61015178297_OFFSET UNITYSDK_OFFSET(0x1712A1B0)
#define RPG_GAMECORE_TRYTRANSFERTOHEROROOM__CTOR_OFFSET UNITYSDK_OFFSET(0x1712A290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TryTransferToHeroRoom_TypeDefinitionIndex = 19964;
