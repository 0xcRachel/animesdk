...
#define RPG_GAMECORE_BATTLESINGLECLICKQTECONFIG_METHOD_3_461578501E15FF77_OFFSET UNITYSDK_OFFSET(0x16FF3D80)
#define RPG_GAMECORE_BATTLESINGLECLICKQTECONFIG_METHOD_3_572D539EBE2CD7CF_OFFSET UNITYSDK_OFFSET(0x16FF6040)
#define RPG_GAMECORE_BATTLESINGLECLICKQTECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16FF3D70)
