...
#define RPG_GAMECORE_ADVOVERRIDEPROPBUTTONCONFIG_METHOD_3_751D6E93FC00BF89_OFFSET UNITYSDK_OFFSET(0x18C54A30)
#define RPG_GAMECORE_ADVOVERRIDEPROPBUTTONCONFIG_METHOD_3_C789B555A0B292F6_OFFSET UNITYSDK_OFFSET(0x18C54AB0)
#define RPG_GAMECORE_ADVOVERRIDEPROPBUTTONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18C54A80)
