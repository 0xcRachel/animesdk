...
#define RPG_GAMECORE_BASECHENLINGBATTLERESOURCE_METHOD_2_068FD37A1D4C1FEF_OFFSET UNITYSDK_OFFSET(0x18228A00)
#define RPG_GAMECORE_BASECHENLINGBATTLERESOURCE_METHOD_2_16A4F070C6B7895F_OFFSET UNITYSDK_OFFSET(0x18228800)
#define RPG_GAMECORE_BASECHENLINGBATTLERESOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x18228AC0)
