...
#define RPG_GAMECORE_BASECHENLINGBATTLERESOURCE_METHOD_2_068FD37A1D4C1FEF_OFFSET UNITYSDK_OFFSET(0x17653480)
#define RPG_GAMECORE_BASECHENLINGBATTLERESOURCE_METHOD_2_4ADD2245234AE4C1_OFFSET UNITYSDK_OFFSET(0x17653290)
#define RPG_GAMECORE_BASECHENLINGBATTLERESOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x17653540)
