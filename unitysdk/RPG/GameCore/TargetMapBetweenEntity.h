...
#define RPG_GAMECORE_TARGETMAPBETWEENENTITY_METHOD_3_93EC175E71EFBC56_OFFSET UNITYSDK_OFFSET(0x16FE1BB0)
#define RPG_GAMECORE_TARGETMAPBETWEENENTITY_METHOD_3_F0A7C2AA06DC8194_OFFSET UNITYSDK_OFFSET(0x16FE1AD0)
#define RPG_GAMECORE_TARGETMAPBETWEENENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE1B90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapBetweenEntity_TypeDefinitionIndex = 21737;
