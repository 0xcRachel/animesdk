...
#define RPG_GAMECORE_TEAMACTION_METHOD_3_16BCFFDAA32329EC_OFFSET UNITYSDK_OFFSET(0x170EA560)
#define RPG_GAMECORE_TEAMACTION_METHOD_3_446FB9923CAD2F4E_OFFSET UNITYSDK_OFFSET(0x170E0940)
#define RPG_GAMECORE_TEAMACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x170E0910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TeamAction_TypeDefinitionIndex = 20816;
