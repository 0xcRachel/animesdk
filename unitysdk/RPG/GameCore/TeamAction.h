...
#define RPG_GAMECORE_TEAMACTION_METHOD_3_0AC4A24F3EF167BD_OFFSET UNITYSDK_OFFSET(0x1789BA50)
#define RPG_GAMECORE_TEAMACTION_METHOD_3_A563CFCC4154A67C_OFFSET UNITYSDK_OFFSET(0x178A9AA0)
#define RPG_GAMECORE_TEAMACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1789BA20)
