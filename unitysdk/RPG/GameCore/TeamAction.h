...
#define RPG_GAMECORE_TEAMACTION_METHOD_3_16BCFFDAA32329EC_OFFSET UNITYSDK_OFFSET(0x1947B240)
#define RPG_GAMECORE_TEAMACTION_METHOD_3_446FB9923CAD2F4E_OFFSET UNITYSDK_OFFSET(0x1947B2D0)
#define RPG_GAMECORE_TEAMACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1947B2A0)
