...
#define RPG_GAMECORE_TITANATLASVOICEPOOLROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16D1E1D0)
#define RPG_GAMECORE_TITANATLASVOICEPOOLROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16D1E360)
