...
#define RPG_GAMECORE_ABORTTARGETSKILL_METHOD_3_28440225569EE360_OFFSET UNITYSDK_OFFSET(0x167752E0)
#define RPG_GAMECORE_ABORTTARGETSKILL_METHOD_3_AB730E9B18CCC682_OFFSET UNITYSDK_OFFSET(0x16775360)
#define RPG_GAMECORE_ABORTTARGETSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x16775330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AbortTargetSkill_TypeDefinitionIndex = 18763;
