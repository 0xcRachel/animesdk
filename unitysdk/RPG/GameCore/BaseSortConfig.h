...
#define RPG_GAMECORE_BASESORTCONFIG_METHOD_2_22CBCE4877AEB33A_OFFSET UNITYSDK_OFFSET(0x1822EC20)
#define RPG_GAMECORE_BASESORTCONFIG_METHOD_2_78081F4A01165F58_OFFSET UNITYSDK_OFFSET(0x1822EA90)
#define RPG_GAMECORE_BASESORTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1822EC80)
