...
#define RPG_GAMECORE_RUANMADECAKEFEATURE_EYEDECAL_METHOD_3_5FE526E169083760_OFFSET UNITYSDK_OFFSET(0x16ED8850)
#define RPG_GAMECORE_RUANMADECAKEFEATURE_EYEDECAL_METHOD_3_81F6D9FC991077E9_OFFSET UNITYSDK_OFFSET(0x16ED9120)
#define RPG_GAMECORE_RUANMADECAKEFEATURE_EYEDECAL__CTOR_OFFSET UNITYSDK_OFFSET(0x16ED8840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RuanMadeCakeFeature_EyeDecal_TypeDefinitionIndex = 15771;
