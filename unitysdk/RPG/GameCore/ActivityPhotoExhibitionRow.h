...
#define RPG_GAMECORE_ACTIVITYPHOTOEXHIBITIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x167A2A00)
#define RPG_GAMECORE_ACTIVITYPHOTOEXHIBITIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x167A2D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityPhotoExhibitionRow_TypeDefinitionIndex = 11030;
