...
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNROOMATTRIBUTECOUNTCONFIG_METHOD_6_51EA20409CEED4C5_OFFSET UNITYSDK_OFFSET(0x1981BD90)
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNROOMATTRIBUTECOUNTCONFIG_METHOD_6_C75AEDB031F3856B_OFFSET UNITYSDK_OFFSET(0x1981C040)
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNROOMATTRIBUTECOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1981BF10)
