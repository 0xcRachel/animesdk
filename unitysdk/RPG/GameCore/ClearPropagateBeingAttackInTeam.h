...
#define RPG_GAMECORE_CLEARPROPAGATEBEINGATTACKINTEAM_METHOD_3_80A519EEFF9D3BF2_OFFSET UNITYSDK_OFFSET(0x169A5070)
#define RPG_GAMECORE_CLEARPROPAGATEBEINGATTACKINTEAM_METHOD_3_D86ED7AFF6DEB95B_OFFSET UNITYSDK_OFFSET(0x169A50F0)
#define RPG_GAMECORE_CLEARPROPAGATEBEINGATTACKINTEAM__CTOR_OFFSET UNITYSDK_OFFSET(0x169A50C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearPropagateBeingAttackInTeam_TypeDefinitionIndex = 20874;
