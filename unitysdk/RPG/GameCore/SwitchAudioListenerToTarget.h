...
#define RPG_GAMECORE_SWITCHAUDIOLISTENERTOTARGET_METHOD_3_DE1A9912ACCD61F0_OFFSET UNITYSDK_OFFSET(0x16FB1580)
#define RPG_GAMECORE_SWITCHAUDIOLISTENERTOTARGET_METHOD_3_F7A0779E8B649CC1_OFFSET UNITYSDK_OFFSET(0x16FB1600)
#define RPG_GAMECORE_SWITCHAUDIOLISTENERTOTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x16FB15D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchAudioListenerToTarget_TypeDefinitionIndex = 19542;
