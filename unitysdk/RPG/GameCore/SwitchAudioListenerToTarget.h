...
#define RPG_GAMECORE_SWITCHAUDIOLISTENERTOTARGET_METHOD_3_DE1A9912ACCD61F0_OFFSET UNITYSDK_OFFSET(0x1985A2A0)
#define RPG_GAMECORE_SWITCHAUDIOLISTENERTOTARGET_METHOD_3_F7A0779E8B649CC1_OFFSET UNITYSDK_OFFSET(0x1985A320)
#define RPG_GAMECORE_SWITCHAUDIOLISTENERTOTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1985A2F0)
