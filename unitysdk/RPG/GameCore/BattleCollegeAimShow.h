...
#define RPG_GAMECORE_BATTLECOLLEGEAIMSHOW_METHOD_3_49453E63681160D7_OFFSET UNITYSDK_OFFSET(0x168D0C90)
#define RPG_GAMECORE_BATTLECOLLEGEAIMSHOW_METHOD_3_93ED30DC028A6786_OFFSET UNITYSDK_OFFSET(0x168D0D10)
#define RPG_GAMECORE_BATTLECOLLEGEAIMSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x168D0CE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleCollegeAimShow_TypeDefinitionIndex = 21395;
