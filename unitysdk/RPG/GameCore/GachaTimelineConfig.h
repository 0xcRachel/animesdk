...
#define RPG_GAMECORE_GACHATIMELINECONFIG_METHOD_2_D7F81F5E30576A82_OFFSET UNITYSDK_OFFSET(0x19C89A00)
#define RPG_GAMECORE_GACHATIMELINECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19C8C360)
