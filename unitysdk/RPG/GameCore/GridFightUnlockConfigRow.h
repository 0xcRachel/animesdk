...
#define RPG_GAMECORE_GRIDFIGHTUNLOCKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B50370)
#define RPG_GAMECORE_GRIDFIGHTUNLOCKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B50530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightUnlockConfigRow_TypeDefinitionIndex = 12354;
