...
#define RPG_GAMECORE_TRAINPARTYBUILDITEMSLOTEXT_METHOD_2_5DC72E5593BCF730_OFFSET UNITYSDK_OFFSET(0x171019D0)
#define RPG_GAMECORE_TRAINPARTYBUILDITEMSLOTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x17101B20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyBuildItemSlotExt_TypeDefinitionIndex = 14629;
