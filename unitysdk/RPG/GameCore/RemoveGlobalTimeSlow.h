...
#define RPG_GAMECORE_REMOVEGLOBALTIMESLOW_METHOD_3_04D5E4002A0EAFDD_OFFSET UNITYSDK_OFFSET(0x16DDF760)
#define RPG_GAMECORE_REMOVEGLOBALTIMESLOW_METHOD_3_3A34B6945CE0B921_OFFSET UNITYSDK_OFFSET(0x16DDF6E0)
#define RPG_GAMECORE_REMOVEGLOBALTIMESLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x16DDF730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveGlobalTimeSlow_TypeDefinitionIndex = 21542;
