...
#define RPG_GAMECORE_SETMISSIONWAYPOINT_METHOD_3_24AE18F9EDC60A25_OFFSET UNITYSDK_OFFSET(0x16F348C0)
#define RPG_GAMECORE_SETMISSIONWAYPOINT_METHOD_3_5071B28D5979FD1E_OFFSET UNITYSDK_OFFSET(0x16F34840)
#define RPG_GAMECORE_SETMISSIONWAYPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F34890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMissionWayPoint_TypeDefinitionIndex = 18562;
