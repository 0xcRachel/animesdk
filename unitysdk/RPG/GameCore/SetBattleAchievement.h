...
#define RPG_GAMECORE_SETBATTLEACHIEVEMENT_METHOD_3_20A0441BF8EA421A_OFFSET UNITYSDK_OFFSET(0x16F07C60)
#define RPG_GAMECORE_SETBATTLEACHIEVEMENT_METHOD_3_41AF54801A4E8194_OFFSET UNITYSDK_OFFSET(0x16F07D80)
#define RPG_GAMECORE_SETBATTLEACHIEVEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F07D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBattleAchievement_TypeDefinitionIndex = 20845;
