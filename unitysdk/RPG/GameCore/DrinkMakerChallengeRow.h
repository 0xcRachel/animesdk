...
#define RPG_GAMECORE_DRINKMAKERCHALLENGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16A46950)
#define RPG_GAMECORE_DRINKMAKERCHALLENGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16A46C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DrinkMakerChallengeRow_TypeDefinitionIndex = 11966;
