...
#define RPG_GAMECORE_ROGUEACTPERSONAADDINPROGRESSSTYLEEXPCONFIG_METHOD_6_8FC65DD058CDF543_OFFSET UNITYSDK_OFFSET(0x1A9A6BC0)
#define RPG_GAMECORE_ROGUEACTPERSONAADDINPROGRESSSTYLEEXPCONFIG_METHOD_6_9CD78D5EE9C04F36_OFFSET UNITYSDK_OFFSET(0x1A9A69A0)
#define RPG_GAMECORE_ROGUEACTPERSONAADDINPROGRESSSTYLEEXPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9A6AE0)
