...
#define RPG_GAMECORE_SETUPROTATABLEREGIONAIRLOCK_METHOD_3_9AFA6C38688F4A27_OFFSET UNITYSDK_OFFSET(0x176FFA20)
#define RPG_GAMECORE_SETUPROTATABLEREGIONAIRLOCK_METHOD_3_AB68F75562E37422_OFFSET UNITYSDK_OFFSET(0x176FF9A0)
#define RPG_GAMECORE_SETUPROTATABLEREGIONAIRLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x176FF9F0)
