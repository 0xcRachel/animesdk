...
#define RPG_GAMECORE_TARGETFETCHNEXTTURNOWNERENTITY_METHOD_4_7D4EBA3E2B7A783E_OFFSET UNITYSDK_OFFSET(0x16FDE290)
#define RPG_GAMECORE_TARGETFETCHNEXTTURNOWNERENTITY_METHOD_4_CB48E3CC304A5D3C_OFFSET UNITYSDK_OFFSET(0x16FD8480)
#define RPG_GAMECORE_TARGETFETCHNEXTTURNOWNERENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD8430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchNextTurnOwnerEntity_TypeDefinitionIndex = 21688;
