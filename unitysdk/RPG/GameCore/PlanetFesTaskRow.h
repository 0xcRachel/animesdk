...
#define RPG_GAMECORE_PLANETFESTASKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16D4C940)
#define RPG_GAMECORE_PLANETFESTASKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16D4CB40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlanetFesTaskRow_TypeDefinitionIndex = 11087;

	class PlanetFesTaskRow : public ::System::Object
	{
	public:
		::System::UInt32 RandomGroupID; // 0x10
