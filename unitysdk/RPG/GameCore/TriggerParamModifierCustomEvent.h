...
#define RPG_GAMECORE_TRIGGERPARAMMODIFIERCUSTOMEVENT_METHOD_3_AD558FD3033603F8_OFFSET UNITYSDK_OFFSET(0x17124790)
#define RPG_GAMECORE_TRIGGERPARAMMODIFIERCUSTOMEVENT_METHOD_3_EB976C1C80FA0427_OFFSET UNITYSDK_OFFSET(0x17124710)
#define RPG_GAMECORE_TRIGGERPARAMMODIFIERCUSTOMEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x17124760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerParamModifierCustomEvent_TypeDefinitionIndex = 21315;
