...
#define RPG_GAMECORE_LEVELCHARACTERAFTERATTACKEND_CLEAR_OFFSET UNITYSDK_OFFSET(0xA44DC40)
#define RPG_GAMECORE_LEVELCHARACTERAFTERATTACKEND_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA44DCE0)
#define RPG_GAMECORE_LEVELCHARACTERAFTERATTACKEND_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA44DC90)
#define RPG_GAMECORE_LEVELCHARACTERAFTERATTACKEND_INIT_OFFSET UNITYSDK_OFFSET(0xA44DBF0)
#define RPG_GAMECORE_LEVELCHARACTERAFTERATTACKEND__CTOR_OFFSET UNITYSDK_OFFSET(0xA44DD30)
#define RPG_GAMECORE_LEVELCHARACTERAFTERATTACKEND___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0xA44DD40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelCharacterAfterAttackEnd_TypeDefinitionIndex = 44622;
