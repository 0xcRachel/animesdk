...
#define RPG_GAMECORE_TIMEREWINDACHIEVEMENT_METHOD_2_BA1F760D09B77EE9_OFFSET UNITYSDK_OFFSET(0x16D1A0F0)
#define RPG_GAMECORE_TIMEREWINDACHIEVEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x16D1A4B0)
