...
#define RPG_GAMECORE_BYISTUTORIALFINISH_METHOD_4_54E934475116746E_OFFSET UNITYSDK_OFFSET(0x16938710)
#define RPG_GAMECORE_BYISTUTORIALFINISH_METHOD_4_88CE9E9EBC9EF094_OFFSET UNITYSDK_OFFSET(0x16938640)
#define RPG_GAMECORE_BYISTUTORIALFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x169386C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsTutorialFinish_TypeDefinitionIndex = 21837;
