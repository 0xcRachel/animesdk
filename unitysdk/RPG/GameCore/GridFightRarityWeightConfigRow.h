...
#define RPG_GAMECORE_GRIDFIGHTRARITYWEIGHTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19B84BF0)
#define RPG_GAMECORE_GRIDFIGHTRARITYWEIGHTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19B84E10)
