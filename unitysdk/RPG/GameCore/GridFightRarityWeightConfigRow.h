...
#define RPG_GAMECORE_GRIDFIGHTRARITYWEIGHTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B430F0)
#define RPG_GAMECORE_GRIDFIGHTRARITYWEIGHTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B43310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightRarityWeightConfigRow_TypeDefinitionIndex = 12362;

	class GridFightRarityWeightConfigRow : public ::System::Object
	{
	public:
		::System::UInt32 Rarity3Weight; // 0x10
		...
		::System::UInt32 Rarity2Weight; // 0x24
