...
#define RPG_GAMECORE_BYIFGROUPISOCCUPIED_METHOD_4_026AB6726CC30F17_OFFSET UNITYSDK_OFFSET(0x1692A5E0)
#define RPG_GAMECORE_BYIFGROUPISOCCUPIED_METHOD_4_CF278D7DDC4D4435_OFFSET UNITYSDK_OFFSET(0x1692A6B0)
#define RPG_GAMECORE_BYIFGROUPISOCCUPIED__CTOR_OFFSET UNITYSDK_OFFSET(0x1692A660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIfGroupIsOccupied_TypeDefinitionIndex = 18872;
