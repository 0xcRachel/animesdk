...
#define RPG_GAMECORE_BYIFGROUPISOCCUPIED_METHOD_4_026AB6726CC30F17_OFFSET UNITYSDK_OFFSET(0x1703B9B0)
#define RPG_GAMECORE_BYIFGROUPISOCCUPIED_METHOD_4_CF278D7DDC4D4435_OFFSET UNITYSDK_OFFSET(0x1703BA80)
#define RPG_GAMECORE_BYIFGROUPISOCCUPIED__CTOR_OFFSET UNITYSDK_OFFSET(0x1703BA30)
