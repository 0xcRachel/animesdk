...
#define RPG_GAMECORE_MEMBERTOMEMBERENTITYDATAADAPTER_METHOD_3_31A3A637350B2609_OFFSET UNITYSDK_OFFSET(0x19093670)
#define RPG_GAMECORE_MEMBERTOMEMBERENTITYDATAADAPTER_METHOD_3_3307833796646AEA_OFFSET UNITYSDK_OFFSET(0x190936F0)
#define RPG_GAMECORE_MEMBERTOMEMBERENTITYDATAADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x190936C0)
