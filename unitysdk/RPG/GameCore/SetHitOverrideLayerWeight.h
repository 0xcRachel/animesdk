...
#define RPG_GAMECORE_SETHITOVERRIDELAYERWEIGHT_METHOD_3_271C680D2BC839BD_OFFSET UNITYSDK_OFFSET(0x199B8010)
#define RPG_GAMECORE_SETHITOVERRIDELAYERWEIGHT_METHOD_3_DF5B36B0EDF5BE9B_OFFSET UNITYSDK_OFFSET(0x199B8090)
#define RPG_GAMECORE_SETHITOVERRIDELAYERWEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x199B8060)
