...
#define RPG_GAMECORE_SETHITOVERRIDELAYERWEIGHT_METHOD_3_271C680D2BC839BD_OFFSET UNITYSDK_OFFSET(0x16F30350)
#define RPG_GAMECORE_SETHITOVERRIDELAYERWEIGHT_METHOD_3_DF5B36B0EDF5BE9B_OFFSET UNITYSDK_OFFSET(0x16F303D0)
#define RPG_GAMECORE_SETHITOVERRIDELAYERWEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F303A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetHitOverrideLayerWeight_TypeDefinitionIndex = 20756;
