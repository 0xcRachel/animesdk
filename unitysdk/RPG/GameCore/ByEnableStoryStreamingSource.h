...
#define RPG_GAMECORE_BYENABLESTORYSTREAMINGSOURCE_METHOD_4_6F059007F4EF9717_OFFSET UNITYSDK_OFFSET(0x16924680)
#define RPG_GAMECORE_BYENABLESTORYSTREAMINGSOURCE_METHOD_4_D7199B96FFE88BFD_OFFSET UNITYSDK_OFFSET(0x169245B0)
#define RPG_GAMECORE_BYENABLESTORYSTREAMINGSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x16924630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByEnableStoryStreamingSource_TypeDefinitionIndex = 19547;
