...
#define RPG_GAMECORE_SETBTNBATTLEHINTINFO_METHOD_3_2773F621116DB1D7_OFFSET UNITYSDK_OFFSET(0x176C0500)
#define RPG_GAMECORE_SETBTNBATTLEHINTINFO_METHOD_3_5EC9E5B446C047B2_OFFSET UNITYSDK_OFFSET(0x176C0580)
#define RPG_GAMECORE_SETBTNBATTLEHINTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x176C0550)
