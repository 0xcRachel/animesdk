...
#define RPG_GAMECORE_SETBTNBATTLEHINTINFO_METHOD_3_2773F621116DB1D7_OFFSET UNITYSDK_OFFSET(0x16F0B070)
#define RPG_GAMECORE_SETBTNBATTLEHINTINFO_METHOD_3_5EC9E5B446C047B2_OFFSET UNITYSDK_OFFSET(0x16F0B0F0)
#define RPG_GAMECORE_SETBTNBATTLEHINTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16F0B0C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBtnBattleHintInfo_TypeDefinitionIndex = 21128;
