...
#define RPG_GAMECORE_ST_SIDE_LISTENFINDTREASURESTATE_METHOD_4_AF741CAD25A79E7C_OFFSET UNITYSDK_OFFSET(0x176A14A0)
#define RPG_GAMECORE_ST_SIDE_LISTENFINDTREASURESTATE_METHOD_4_D3C431E1AD8077EC_OFFSET UNITYSDK_OFFSET(0x176AD810)
#define RPG_GAMECORE_ST_SIDE_LISTENFINDTREASURESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x176A1440)
