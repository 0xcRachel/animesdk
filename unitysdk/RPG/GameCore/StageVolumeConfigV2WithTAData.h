...
#define RPG_GAMECORE_STAGEVOLUMECONFIGV2WITHTADATA_METHOD_3_1C60246782A65D45_OFFSET UNITYSDK_OFFSET(0x16F8F420)
#define RPG_GAMECORE_STAGEVOLUMECONFIGV2WITHTADATA_METHOD_3_EB635A05D0B108D0_OFFSET UNITYSDK_OFFSET(0x16F8F0B0)
#define RPG_GAMECORE_STAGEVOLUMECONFIGV2WITHTADATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16F8F0A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StageVolumeConfigV2WithTAData_TypeDefinitionIndex = 17156;
