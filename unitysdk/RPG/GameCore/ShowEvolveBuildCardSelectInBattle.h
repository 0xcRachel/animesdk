...
#define RPG_GAMECORE_SHOWEVOLVEBUILDCARDSELECTINBATTLE_METHOD_3_23FB611870D35CF4_OFFSET UNITYSDK_OFFSET(0x193A6C20)
#define RPG_GAMECORE_SHOWEVOLVEBUILDCARDSELECTINBATTLE_METHOD_3_DB91D1EC3291B225_OFFSET UNITYSDK_OFFSET(0x193A6BA0)
#define RPG_GAMECORE_SHOWEVOLVEBUILDCARDSELECTINBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x193A6BF0)
