...
#define RPG_GAMECORE_ENABLESMOOTHLOADBATTLE_METHOD_3_55CA621CDEB379B2_OFFSET UNITYSDK_OFFSET(0x1915AE00)
#define RPG_GAMECORE_ENABLESMOOTHLOADBATTLE_METHOD_3_B00DA771B7E0E0E3_OFFSET UNITYSDK_OFFSET(0x1915AD70)
#define RPG_GAMECORE_ENABLESMOOTHLOADBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1915ADD0)
