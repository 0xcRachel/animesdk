...
#define RPG_GAMECORE_BYISTEAMMATE_METHOD_4_3C2EEA3E4ADFF2E0_OFFSET UNITYSDK_OFFSET(0x19DB4710)
#define RPG_GAMECORE_BYISTEAMMATE_METHOD_4_97BE87EAD8B9A7D1_OFFSET UNITYSDK_OFFSET(0x19DB4790)
#define RPG_GAMECORE_BYISTEAMMATE_METHOD_4_A3EEA2AA2C6D8A1D_OFFSET UNITYSDK_OFFSET(0x19DB44C0)
#define RPG_GAMECORE_BYISTEAMMATE_METHOD_4_D0F207836C71B8F3_OFFSET UNITYSDK_OFFSET(0x19DB4590)
#define RPG_GAMECORE_BYISTEAMMATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19DB4540)
