...
#define RPG_GAMECORE_STAGEPREFABINFO_METHOD_2_29195A4AE874DBA1_OFFSET UNITYSDK_OFFSET(0x16F8A400)
#define RPG_GAMECORE_STAGEPREFABINFO_METHOD_2_2B2047CDA46EB222_OFFSET UNITYSDK_OFFSET(0x16F8A280)
#define RPG_GAMECORE_STAGEPREFABINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16F8A3F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StagePrefabInfo_TypeDefinitionIndex = 17102;
