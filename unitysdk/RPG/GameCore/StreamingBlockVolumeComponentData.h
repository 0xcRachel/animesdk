...
#define RPG_GAMECORE_STREAMINGBLOCKVOLUMECOMPONENTDATA_METHOD_3_2335E1EF4EA471D4_OFFSET UNITYSDK_OFFSET(0x16FA2420)
#define RPG_GAMECORE_STREAMINGBLOCKVOLUMECOMPONENTDATA_METHOD_3_2EA65B95C0E827BD_OFFSET UNITYSDK_OFFSET(0x16F8E2C0)
#define RPG_GAMECORE_STREAMINGBLOCKVOLUMECOMPONENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16F8E2B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StreamingBlockVolumeComponentData_TypeDefinitionIndex = 17128;
