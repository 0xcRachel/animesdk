...
#define RPG_GAMECORE_CHALLENGESKIPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17072AF0)
#define RPG_GAMECORE_CHALLENGESKIPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17072BF0)
