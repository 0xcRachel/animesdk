...
#define RPG_GAMECORE_REDIRECTACTIONDELAYCHANGE_METHOD_3_1E8B998B50C222F3_OFFSET UNITYSDK_OFFSET(0x16DCF760)
#define RPG_GAMECORE_REDIRECTACTIONDELAYCHANGE_METHOD_3_23CFBEA35DC688E0_OFFSET UNITYSDK_OFFSET(0x16DCF6E0)
#define RPG_GAMECORE_REDIRECTACTIONDELAYCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16DCF730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RedirectActionDelayChange_TypeDefinitionIndex = 20955;
