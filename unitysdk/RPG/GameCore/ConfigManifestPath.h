...
#define RPG_GAMECORE_CONFIGMANIFESTPATH_METHOD_2_457422A7D4EC95F3_OFFSET UNITYSDK_OFFSET(0x18F9F530)
#define RPG_GAMECORE_CONFIGMANIFESTPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x18F9FC00)
