...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICUNITSELECTDROPCONFIG_METHOD_6_4B3B592F894BF577_OFFSET UNITYSDK_OFFSET(0x1A03EAF0)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICUNITSELECTDROPCONFIG_METHOD_6_AD9C680B0A091F82_OFFSET UNITYSDK_OFFSET(0x1A03ED10)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICUNITSELECTDROPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A03EC30)
