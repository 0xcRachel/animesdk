...
#define RPG_GAMECORE_BYINTURNBASEDGAMEMODESTATE_METHOD_4_1A7B8403EF127C96_OFFSET UNITYSDK_OFFSET(0x19AE3830)
#define RPG_GAMECORE_BYINTURNBASEDGAMEMODESTATE_METHOD_4_45AE92BFBB994368_OFFSET UNITYSDK_OFFSET(0x19AE3760)
#define RPG_GAMECORE_BYINTURNBASEDGAMEMODESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE37E0)
