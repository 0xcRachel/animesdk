...
#define RPG_GAMECORE_BYINTURNBASEDGAMEMODESTATE_METHOD_4_1A7B8403EF127C96_OFFSET UNITYSDK_OFFSET(0x19D9A0D0)
#define RPG_GAMECORE_BYINTURNBASEDGAMEMODESTATE_METHOD_4_45AE92BFBB994368_OFFSET UNITYSDK_OFFSET(0x19D9A000)
#define RPG_GAMECORE_BYINTURNBASEDGAMEMODESTATE_METHOD_4_9DBE70D8909654B6_OFFSET UNITYSDK_OFFSET(0x19D9A2D0)
#define RPG_GAMECORE_BYINTURNBASEDGAMEMODESTATE_METHOD_4_B572CF049F20ADDB_OFFSET UNITYSDK_OFFSET(0x19D9A250)
#define RPG_GAMECORE_BYINTURNBASEDGAMEMODESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19D9A080)
