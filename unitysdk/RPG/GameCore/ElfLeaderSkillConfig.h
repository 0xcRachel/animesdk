...
#define RPG_GAMECORE_ELFLEADERSKILLCONFIG_METHOD_2_58561240927579D2_OFFSET UNITYSDK_OFFSET(0x1914FCE0)
#define RPG_GAMECORE_ELFLEADERSKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1914FDE0)
