...
#define RPG_GAMECORE_ADVCHARACTERFINDCHEST_METHOD_3_CA2B871BC6C32E74_OFFSET UNITYSDK_OFFSET(0x1682F790)
#define RPG_GAMECORE_ADVCHARACTERFINDCHEST_METHOD_3_F02143645F5B9BF5_OFFSET UNITYSDK_OFFSET(0x1682F710)
#define RPG_GAMECORE_ADVCHARACTERFINDCHEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1682F760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvCharacterFindChest_TypeDefinitionIndex = 18005;
