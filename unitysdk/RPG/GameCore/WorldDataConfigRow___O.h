...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::MapSpaceType>**)Il2CppClass::FromTypeDefinitionIndex(WorldDataConfigRow___O_TypeDefinitionIndex)->GetStaticField(0x12530);
		}
	};
}
