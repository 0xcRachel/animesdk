...
#define RPG_GAMECORE_AVATARGLOBALBUFFCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x168A6F00)
#define RPG_GAMECORE_AVATARGLOBALBUFFCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x168A7E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarGlobalBuffConfigRow_TypeDefinitionIndex = 11611;
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* TeamStageTypeBlackList; // 0x28
		...
		::Il2CppArray<::System::UInt32>* TeamBlackList; // 0x48
