...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGEREFFECT_METHOD_3_2190576FB863C057_OFFSET UNITYSDK_OFFSET(0x195A6E90)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGEREFFECT_METHOD_3_40430CE3115C3A81_OFFSET UNITYSDK_OFFSET(0x195A33F0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGEREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x195A33A0)
