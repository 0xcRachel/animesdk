...
#define RPG_GAMECORE_CONVINCEMOVECURRTURNOPTION_METHOD_3_7338ED8115883021_OFFSET UNITYSDK_OFFSET(0x169CF770)
#define RPG_GAMECORE_CONVINCEMOVECURRTURNOPTION_METHOD_3_7DCFA8B5C897A72D_OFFSET UNITYSDK_OFFSET(0x169CF660)
#define RPG_GAMECORE_CONVINCEMOVECURRTURNOPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x169CF740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConvinceMoveCurrTurnOption_TypeDefinitionIndex = 19482;
