...
#define RPG_GAMECORE_MODIFYAIVISIONEXCLUDETAGRUNTIME_METHOD_3_FA28B6C6F056AAEE_OFFSET UNITYSDK_OFFSET(0x16CB83D0)
#define RPG_GAMECORE_MODIFYAIVISIONEXCLUDETAGRUNTIME_METHOD_3_FE4EF4BAC650CAB1_OFFSET UNITYSDK_OFFSET(0x16CB8330)
#define RPG_GAMECORE_MODIFYAIVISIONEXCLUDETAGRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x16CB8390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyAiVisionExcludeTagRuntime_TypeDefinitionIndex = 19385;
