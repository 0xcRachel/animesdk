...
#define RPG_GAMECORE_DOFEFFECT_METHOD_3_772F293D4D6D8848_OFFSET UNITYSDK_OFFSET(0x169DC370)
#define RPG_GAMECORE_DOFEFFECT_METHOD_3_92F30A2DBD4FE77C_OFFSET UNITYSDK_OFFSET(0x169DC490)
#define RPG_GAMECORE_DOFEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x169DC410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DOFEffect_TypeDefinitionIndex = 18024;
