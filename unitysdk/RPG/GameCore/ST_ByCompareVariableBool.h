...
#define RPG_GAMECORE_ST_BYCOMPAREVARIABLEBOOL_METHOD_4_2BD23335713D87CB_OFFSET UNITYSDK_OFFSET(0x16EEE290)
#define RPG_GAMECORE_ST_BYCOMPAREVARIABLEBOOL_METHOD_4_FED3BD086D35B823_OFFSET UNITYSDK_OFFSET(0x16EEE1C0)
#define RPG_GAMECORE_ST_BYCOMPAREVARIABLEBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x16EEE240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByCompareVariableBool_TypeDefinitionIndex = 17831;
