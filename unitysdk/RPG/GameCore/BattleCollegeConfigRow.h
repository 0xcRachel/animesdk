...
#define RPG_GAMECORE_BATTLECOLLEGECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1879FF80)
#define RPG_GAMECORE_BATTLECOLLEGECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x187A04A0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 TutorialTypeGroupID; // 0x58
