...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTEROPENSHOPCONFIG_METHOD_3_06A929FBBEC362DE_OFFSET UNITYSDK_OFFSET(0x1727EC70)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTEROPENSHOPCONFIG_METHOD_3_6B3BDDCE11ACA7D7_OFFSET UNITYSDK_OFFSET(0x1727AD40)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTEROPENSHOPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1727ACF0)
