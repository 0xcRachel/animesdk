...
#define RPG_GAMECORE_CHIMERADUELNPCANIMATORCONTROLNODE_METHOD_3_D3C6374A21A777EC_OFFSET UNITYSDK_OFFSET(0x16993C50)
#define RPG_GAMECORE_CHIMERADUELNPCANIMATORCONTROLNODE_METHOD_3_F56F987565D262E3_OFFSET UNITYSDK_OFFSET(0x16993B70)
#define RPG_GAMECORE_CHIMERADUELNPCANIMATORCONTROLNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x16993C00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelNpcAnimatorControlNode_TypeDefinitionIndex = 14391;
