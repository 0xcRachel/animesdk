...
#define RPG_GAMECORE_MATCHTHREEV2LEVELROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1999AB70)
#define RPG_GAMECORE_MATCHTHREEV2LEVELROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1999B290)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::UInt32>* OpponentBattleItemMap; // 0x10
		::Il2CppArray<::System::UInt32>* RecommendBirdList; // 0x18
		...
		::Il2CppArray<::System::UInt32>* RecommendBattleItemList; // 0x38
		::System::String* LevelImage; // 0x40
		::RPG::Client::TextID LoseDesc; // 0x48
		::RPG::Client::TextID VictoryDesc; // 0x58
		::RPG::GameCore::MatchThreeV2FirstRoleType FirstType; // 0x68
		::System::UInt32 PlayerID; // 0x6C
		::System::UInt32 PreLevel; // 0x70
		::System::UInt32 PlayerBirdID; // 0x74
		::System::UInt32 OpponentID; // 0x78
		::System::UInt32 PreSubmission; // 0x7C
		::System::UInt32 MaxRatioPowerDiff; // 0x80
		::System::UInt32 LevelID; // 0x84
		::System::UInt32 OpponentBirdID; // 0x88
