...
#define RPG_GAMECORE_MUSEUMPHASEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x190F5F00)
#define RPG_GAMECORE_MUSEUMPHASEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x190F6720)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 UnlockAreaID; // 0x1C
		...
		::System::UInt32 RenewPointCost; // 0x4C
