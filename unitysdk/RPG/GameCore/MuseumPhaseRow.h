...
#define RPG_GAMECORE_MUSEUMPHASEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1863D160)
#define RPG_GAMECORE_MUSEUMPHASEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1863D920)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 UnlockAreaID; // 0x28
		::System::UInt32 PhaseQuestID; // 0x2C
