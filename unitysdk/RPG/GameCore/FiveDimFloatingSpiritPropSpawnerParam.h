...
#define RPG_GAMECORE_FIVEDIMFLOATINGSPIRITPROPSPAWNERPARAM_METHOD_3_0B74495FBC9C4293_OFFSET UNITYSDK_OFFSET(0x16ABD5E0)
#define RPG_GAMECORE_FIVEDIMFLOATINGSPIRITPROPSPAWNERPARAM_METHOD_3_611AD1FE4859374D_OFFSET UNITYSDK_OFFSET(0x16ABD5A0)
#define RPG_GAMECORE_FIVEDIMFLOATINGSPIRITPROPSPAWNERPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x16ABD5D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimFloatingSpiritPropSpawnerParam_TypeDefinitionIndex = 16676;
