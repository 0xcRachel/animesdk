...
#define RPG_GAMECORE_SETDYNAMICVALUEBYCOPYING_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1A1FB270)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCOPYING_METHOD_4_2652182A3D544CA4_OFFSET UNITYSDK_OFFSET(0x1A1FB1D0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCOPYING_METHOD_4_B61700AE79374CCF_OFFSET UNITYSDK_OFFSET(0x1A1F2DA0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCOPYING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1F2D20)
