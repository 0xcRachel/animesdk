...
#define RPG_GAMECORE_SETDYNAMICVALUEBYCOPYING_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x199A2570)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCOPYING_METHOD_4_2652182A3D544CA4_OFFSET UNITYSDK_OFFSET(0x199A2250)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCOPYING_METHOD_4_B61700AE79374CCF_OFFSET UNITYSDK_OFFSET(0x199A2370)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCOPYING__CTOR_OFFSET UNITYSDK_OFFSET(0x199A22F0)
