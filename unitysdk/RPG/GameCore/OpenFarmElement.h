...
#define RPG_GAMECORE_OPENFARMELEMENT_METHOD_3_5F4E9805F4FECFD5_OFFSET UNITYSDK_OFFSET(0x1748FFD0)
#define RPG_GAMECORE_OPENFARMELEMENT_METHOD_3_6FA023BFBDDC3213_OFFSET UNITYSDK_OFFSET(0x1748FF50)
#define RPG_GAMECORE_OPENFARMELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1748FFA0)
