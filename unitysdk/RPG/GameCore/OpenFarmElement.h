...
#define RPG_GAMECORE_OPENFARMELEMENT_METHOD_3_5F4E9805F4FECFD5_OFFSET UNITYSDK_OFFSET(0x16D09710)
#define RPG_GAMECORE_OPENFARMELEMENT_METHOD_3_6FA023BFBDDC3213_OFFSET UNITYSDK_OFFSET(0x16D09690)
#define RPG_GAMECORE_OPENFARMELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x16D096E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OpenFarmElement_TypeDefinitionIndex = 19738;
