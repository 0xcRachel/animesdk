...
#define RPG_GAMECORE_WAITSUBSTORYFINISH_METHOD_3_0F754857E3F4123E_OFFSET UNITYSDK_OFFSET(0x1715E090)
#define RPG_GAMECORE_WAITSUBSTORYFINISH_METHOD_3_AA2C66E054F0EA1E_OFFSET UNITYSDK_OFFSET(0x1715E000)
#define RPG_GAMECORE_WAITSUBSTORYFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1715E060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitSubStoryFinish_TypeDefinitionIndex = 18270;
