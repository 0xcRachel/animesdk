...
#define RPG_GAMECORE_ACTIVITYHIPPLENENDINGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1887FEE0)
#define RPG_GAMECORE_ACTIVITYHIPPLENENDINGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x188802C0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean IsShowInGuidePage; // 0x24
