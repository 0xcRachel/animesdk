...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPBATTLEREWARDCOUNTCONFIG_METHOD_3_458B3C1588BA1032_OFFSET UNITYSDK_OFFSET(0x16E9A070)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPBATTLEREWARDCOUNTCONFIG_METHOD_3_9C673E2BF44E74BB_OFFSET UNITYSDK_OFFSET(0x16EA0B40)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPBATTLEREWARDCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E9A020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyShopBattleRewardCountConfig_TypeDefinitionIndex = 16019;
