...
#define RPG_GAMECORE_CAKERACELOOKATCATBYRANK_METHOD_3_3E2015404BF1064A_OFFSET UNITYSDK_OFFSET(0x17061380)
#define RPG_GAMECORE_CAKERACELOOKATCATBYRANK_METHOD_3_72DF6D6BDE7BE683_OFFSET UNITYSDK_OFFSET(0x17061300)
#define RPG_GAMECORE_CAKERACELOOKATCATBYRANK__CTOR_OFFSET UNITYSDK_OFFSET(0x17061350)
