...
#define RPG_GAMECORE_INFECTMODIFIER_METHOD_3_39EAAC1B854EDF57_OFFSET UNITYSDK_OFFSET(0x16B7F980)
#define RPG_GAMECORE_INFECTMODIFIER_METHOD_3_CF55E60492C3430D_OFFSET UNITYSDK_OFFSET(0x16B7FAA0)
#define RPG_GAMECORE_INFECTMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x16B7FA20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InfectModifier_TypeDefinitionIndex = 20728;
