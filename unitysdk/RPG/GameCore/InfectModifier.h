...
#define RPG_GAMECORE_INFECTMODIFIER_METHOD_3_39EAAC1B854EDF57_OFFSET UNITYSDK_OFFSET(0x1888CE70)
#define RPG_GAMECORE_INFECTMODIFIER_METHOD_3_CF55E60492C3430D_OFFSET UNITYSDK_OFFSET(0x1888CF90)
#define RPG_GAMECORE_INFECTMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1888CF10)
