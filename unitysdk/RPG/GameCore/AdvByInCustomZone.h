...
#define RPG_GAMECORE_ADVBYINCUSTOMZONE_METHOD_4_9E7088E2144032D1_OFFSET UNITYSDK_OFFSET(0x16F3B4D0)
#define RPG_GAMECORE_ADVBYINCUSTOMZONE_METHOD_4_C162C7C2FEF38DE9_OFFSET UNITYSDK_OFFSET(0x16F3B5A0)
#define RPG_GAMECORE_ADVBYINCUSTOMZONE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F3B550)
