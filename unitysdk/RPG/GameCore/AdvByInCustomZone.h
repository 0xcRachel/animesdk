...
#define RPG_GAMECORE_ADVBYINCUSTOMZONE_METHOD_4_9E7088E2144032D1_OFFSET UNITYSDK_OFFSET(0x167C4AD0)
#define RPG_GAMECORE_ADVBYINCUSTOMZONE_METHOD_4_C162C7C2FEF38DE9_OFFSET UNITYSDK_OFFSET(0x167C4BA0)
#define RPG_GAMECORE_ADVBYINCUSTOMZONE__CTOR_OFFSET UNITYSDK_OFFSET(0x167C4B50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByInCustomZone_TypeDefinitionIndex = 17779;
