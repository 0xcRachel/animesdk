...
#define RPG_GAMECORE_ENTERMARBLEPVEMATCH_METHOD_3_3D7C2C93380FBE7C_OFFSET UNITYSDK_OFFSET(0x16A70600)
#define RPG_GAMECORE_ENTERMARBLEPVEMATCH_METHOD_3_88A950E283CFD55F_OFFSET UNITYSDK_OFFSET(0x16A70680)
#define RPG_GAMECORE_ENTERMARBLEPVEMATCH__CTOR_OFFSET UNITYSDK_OFFSET(0x16A70650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnterMarblePVEMatch_TypeDefinitionIndex = 19371;
