...
#define RPG_GAMECORE_SHOWPHASEUI_METHOD_3_1B4AC7E06FBC44CA_OFFSET UNITYSDK_OFFSET(0x17715470)
#define RPG_GAMECORE_SHOWPHASEUI_METHOD_3_D411BB6F6307253C_OFFSET UNITYSDK_OFFSET(0x177154F0)
#define RPG_GAMECORE_SHOWPHASEUI__CTOR_OFFSET UNITYSDK_OFFSET(0x177154C0)
