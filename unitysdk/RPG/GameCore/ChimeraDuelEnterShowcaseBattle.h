...
#define RPG_GAMECORE_CHIMERADUELENTERSHOWCASEBATTLE_METHOD_3_9F8BA3DB65776B67_OFFSET UNITYSDK_OFFSET(0x1698CA40)
#define RPG_GAMECORE_CHIMERADUELENTERSHOWCASEBATTLE_METHOD_3_AABE39ECAC05C65B_OFFSET UNITYSDK_OFFSET(0x1698CB50)
#define RPG_GAMECORE_CHIMERADUELENTERSHOWCASEBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1698CB20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEnterShowcaseBattle_TypeDefinitionIndex = 19380;
