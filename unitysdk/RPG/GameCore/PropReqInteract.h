...
#define RPG_GAMECORE_PROPREQINTERACT_METHOD_3_25E22B3538397437_OFFSET UNITYSDK_OFFSET(0x16DB0D60)
#define RPG_GAMECORE_PROPREQINTERACT_METHOD_3_8419001AFA96203C_OFFSET UNITYSDK_OFFSET(0x16DB0EB0)
#define RPG_GAMECORE_PROPREQINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x16DB0E20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropReqInteract_TypeDefinitionIndex = 19983;
