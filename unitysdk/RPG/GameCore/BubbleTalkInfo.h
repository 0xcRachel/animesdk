...
#define RPG_GAMECORE_BUBBLETALKINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x168FBDE0)
#define RPG_GAMECORE_BUBBLETALKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x168FC130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BubbleTalkInfo_TypeDefinitionIndex = 18182;
