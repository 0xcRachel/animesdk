...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYGAMBLECOSTCONFIG_METHOD_3_4AD7A8A680DC5164_OFFSET UNITYSDK_OFFSET(0x1A4FF900)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYGAMBLECOSTCONFIG_METHOD_3_650D314BAE0E81DD_OFFSET UNITYSDK_OFFSET(0x1A4FF9D0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYGAMBLECOSTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4FF980)
