...
#define RPG_GAMECORE_SHADERPROPERTYSERIALIZATION_METHOD_2_09CB9B5A106B1D66_OFFSET UNITYSDK_OFFSET(0x177000F0)
#define RPG_GAMECORE_SHADERPROPERTYSERIALIZATION__CTOR_OFFSET UNITYSDK_OFFSET(0x177003A0)
