...
#define RPG_GAMECORE_BYISINDISTRICT_METHOD_4_A519A5E7D365CC6E_OFFSET UNITYSDK_OFFSET(0x169329D0)
#define RPG_GAMECORE_BYISINDISTRICT_METHOD_4_B1B5C2BA085F136E_OFFSET UNITYSDK_OFFSET(0x16932900)
#define RPG_GAMECORE_BYISINDISTRICT__CTOR_OFFSET UNITYSDK_OFFSET(0x16932980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsInDistrict_TypeDefinitionIndex = 18385;
