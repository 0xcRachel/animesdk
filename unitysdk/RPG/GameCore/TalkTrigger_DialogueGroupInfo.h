...
#define RPG_GAMECORE_TALKTRIGGER_DIALOGUEGROUPINFO_RESET_OFFSET UNITYSDK_OFFSET(0x648810)
#define RPG_GAMECORE_TALKTRIGGER_DIALOGUEGROUPINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x648860)
#define RPG_GAMECORE_TALKTRIGGER_DIALOGUEGROUPINFO___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x648870)
