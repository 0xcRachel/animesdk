...
#define RPG_GAMECORE_TALKTRIGGER_DIALOGUEGROUPINFO_RESET_OFFSET UNITYSDK_OFFSET(0x88C30)
#define RPG_GAMECORE_TALKTRIGGER_DIALOGUEGROUPINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x88C80)
#define RPG_GAMECORE_TALKTRIGGER_DIALOGUEGROUPINFO___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x88C90)
