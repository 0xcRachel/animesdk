...
#define RPG_GAMECORE_BYCOMPAREFLOORSAVEDVALUEV2_METHOD_4_36AD62BE269B6180_OFFSET UNITYSDK_OFFSET(0x1690CCE0)
#define RPG_GAMECORE_BYCOMPAREFLOORSAVEDVALUEV2_METHOD_4_8CED1F00402D5D56_OFFSET UNITYSDK_OFFSET(0x1690CDC0)
#define RPG_GAMECORE_BYCOMPAREFLOORSAVEDVALUEV2__CTOR_OFFSET UNITYSDK_OFFSET(0x1690CD60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareFloorSavedValueV2_TypeDefinitionIndex = 18506;
