...
#define RPG_GAMECORE_SETCOMPONENTASSETLOADSTATE_METHOD_3_98D242F9951D9DCD_OFFSET UNITYSDK_OFFSET(0x176C49D0)
#define RPG_GAMECORE_SETCOMPONENTASSETLOADSTATE_METHOD_3_C13BB6FF481F2F85_OFFSET UNITYSDK_OFFSET(0x176C4AB0)
#define RPG_GAMECORE_SETCOMPONENTASSETLOADSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x176C4A50)
