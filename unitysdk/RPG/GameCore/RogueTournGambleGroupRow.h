...
#define RPG_GAMECORE_ROGUETOURNGAMBLEGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19405270)
#define RPG_GAMECORE_ROGUETOURNGAMBLEGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x194054D0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::RogueGambleMachineType GambleGroupType; // 0x30
		::System::UInt32 GambleGroupID; // 0x34
