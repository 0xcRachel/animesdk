...
#define RPG_GAMECORE_MARBLETASKCONFIG_METHOD_2_209BF5C52BDE17F7_OFFSET UNITYSDK_OFFSET(0x173AF260)
#define RPG_GAMECORE_MARBLETASKCONFIG_METHOD_2_A165820FBE30C8ED_OFFSET UNITYSDK_OFFSET(0x173AF420)
#define RPG_GAMECORE_MARBLETASKCONFIG__CCTOR_OFFSET UNITYSDK_OFFSET(0x173AF480)
#define RPG_GAMECORE_MARBLETASKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1739B1D0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Func_2<::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::MarbleTaskConfig*>*>**)Il2CppClass::FromTypeDefinitionIndex(MarbleTaskConfig_TypeDefinitionIndex)->GetStaticField(0x440A0);
		}
