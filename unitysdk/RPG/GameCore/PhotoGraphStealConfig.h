...
#define RPG_GAMECORE_PHOTOGRAPHSTEALCONFIG_METHOD_2_4F6517BBFF4D83D1_OFFSET UNITYSDK_OFFSET(0x16D38D40)
#define RPG_GAMECORE_PHOTOGRAPHSTEALCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16D39940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphStealConfig_TypeDefinitionIndex = 17067;
