...
#define RPG_GAMECORE_BYISTURNOWNERENTITY_METHOD_4_AC4F59C06CF45F10_OFFSET UNITYSDK_OFFSET(0x17049C40)
#define RPG_GAMECORE_BYISTURNOWNERENTITY_METHOD_4_E60DC3D43181C9FE_OFFSET UNITYSDK_OFFSET(0x17049D10)
#define RPG_GAMECORE_BYISTURNOWNERENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x17049CC0)
