...
#define RPG_GAMECORE_ADVSETRUSHBTNINTERACTABLE_METHOD_3_308557A1B314959B_OFFSET UNITYSDK_OFFSET(0x18C5CAC0)
#define RPG_GAMECORE_ADVSETRUSHBTNINTERACTABLE_METHOD_3_8D47425D35CD4132_OFFSET UNITYSDK_OFFSET(0x18C5CA40)
#define RPG_GAMECORE_ADVSETRUSHBTNINTERACTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C5CA90)
