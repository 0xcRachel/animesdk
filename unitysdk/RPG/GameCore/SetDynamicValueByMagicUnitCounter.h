...
#define RPG_GAMECORE_SETDYNAMICVALUEBYMAGICUNITCOUNTER_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x199A6F00)
#define RPG_GAMECORE_SETDYNAMICVALUEBYMAGICUNITCOUNTER_METHOD_4_A4415565A886D4EB_OFFSET UNITYSDK_OFFSET(0x199A6C10)
#define RPG_GAMECORE_SETDYNAMICVALUEBYMAGICUNITCOUNTER_METHOD_4_E2E0F950C900DFC3_OFFSET UNITYSDK_OFFSET(0x199A6CE0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYMAGICUNITCOUNTER__CTOR_OFFSET UNITYSDK_OFFSET(0x199A6C90)
