...
#define RPG_GAMECORE_SETULTRASKILLINNERPIEPROGRESS_METHOD_3_2D10EBDC37491616_OFFSET UNITYSDK_OFFSET(0x19392BC0)
#define RPG_GAMECORE_SETULTRASKILLINNERPIEPROGRESS_METHOD_3_A8672192B956908A_OFFSET UNITYSDK_OFFSET(0x19392C90)
#define RPG_GAMECORE_SETULTRASKILLINNERPIEPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x19392C40)
