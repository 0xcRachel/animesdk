...
#define RPG_GAMECORE_SETULTRASKILLINNERPIEPROGRESS_METHOD_3_2D10EBDC37491616_OFFSET UNITYSDK_OFFSET(0x16F44CA0)
#define RPG_GAMECORE_SETULTRASKILLINNERPIEPROGRESS_METHOD_3_A8672192B956908A_OFFSET UNITYSDK_OFFSET(0x16F44D70)
#define RPG_GAMECORE_SETULTRASKILLINNERPIEPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x16F44D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetUltraSkillInnerPieProgress_TypeDefinitionIndex = 20818;
