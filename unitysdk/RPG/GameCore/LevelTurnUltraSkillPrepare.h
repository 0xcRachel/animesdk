...
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_GETACTIVEENTITY_OFFSET UNITYSDK_OFFSET(0x19B78F40)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_GETDISABLEREADYCAMERA_OFFSET UNITYSDK_OFFSET(0x19B79020)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x19B78EB0)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_GETINSERTULTRASKILLPARAMS_OFFSET UNITYSDK_OFFSET(0x19B78F00)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_GETSKILLINDEX_OFFSET UNITYSDK_OFFSET(0x19B78F90)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x19B78E60)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_GET_ACTIONTYPE_OFFSET UNITYSDK_OFFSET(0x19B790C0)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_HASPREPAREABILITY_OFFSET UNITYSDK_OFFSET(0x19B79060)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_INIT_OFFSET UNITYSDK_OFFSET(0x19B78DF0)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE__CTOR_OFFSET UNITYSDK_OFFSET(0x19B790E0)
