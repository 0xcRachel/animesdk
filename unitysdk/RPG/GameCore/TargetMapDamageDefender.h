...
#define RPG_GAMECORE_TARGETMAPDAMAGEDEFENDER_METHOD_3_63557D0EBE19C913_OFFSET UNITYSDK_OFFSET(0x16FE2620)
#define RPG_GAMECORE_TARGETMAPDAMAGEDEFENDER_METHOD_3_D0AA79EC756516BE_OFFSET UNITYSDK_OFFSET(0x16FE2560)
#define RPG_GAMECORE_TARGETMAPDAMAGEDEFENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE2600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapDamageDefender_TypeDefinitionIndex = 21730;
