...
#define RPG_GAMECORE_ADVMARKASTAUNTPROXY_METHOD_3_6C110AD00C2AFB6E_OFFSET UNITYSDK_OFFSET(0x19BE55F0)
#define RPG_GAMECORE_ADVMARKASTAUNTPROXY_METHOD_3_F8DBA22760D83224_OFFSET UNITYSDK_OFFSET(0x19BE5570)
#define RPG_GAMECORE_ADVMARKASTAUNTPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x19BE55C0)
