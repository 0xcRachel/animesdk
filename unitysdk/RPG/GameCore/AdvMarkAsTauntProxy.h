...
#define RPG_GAMECORE_ADVMARKASTAUNTPROXY_METHOD_3_6C110AD00C2AFB6E_OFFSET UNITYSDK_OFFSET(0x18C4D7D0)
#define RPG_GAMECORE_ADVMARKASTAUNTPROXY_METHOD_3_F8DBA22760D83224_OFFSET UNITYSDK_OFFSET(0x18C4D750)
#define RPG_GAMECORE_ADVMARKASTAUNTPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x18C4D7A0)
