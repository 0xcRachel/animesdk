...
#define RPG_GAMECORE_ADVMARKASTAUNTPROXY_METHOD_3_6C110AD00C2AFB6E_OFFSET UNITYSDK_OFFSET(0x1683A390)
#define RPG_GAMECORE_ADVMARKASTAUNTPROXY_METHOD_3_F8DBA22760D83224_OFFSET UNITYSDK_OFFSET(0x1683A310)
#define RPG_GAMECORE_ADVMARKASTAUNTPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1683A360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvMarkAsTauntProxy_TypeDefinitionIndex = 18351;
