...
#define RPG_GAMECORE_GMACCOUNTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18B78FD0)
#define RPG_GAMECORE_GMACCOUNTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18B793B0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::Class_1_3745C69C00F04B7D_3*>* AvatarList; // 0x28
		...
		::System::UInt32 PlayerLevel; // 0x4C
