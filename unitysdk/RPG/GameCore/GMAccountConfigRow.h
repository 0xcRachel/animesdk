...
#define RPG_GAMECORE_GMACCOUNTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17239340)
#define RPG_GAMECORE_GMACCOUNTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17239720)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::Il2CppArray<::System::UInt32>* ItemGroupIDList; // 0x10
		::Il2CppArray<::System::UInt32>* EquipmentGroupIDList; // 0x18
		::Il2CppArray<::System::UInt32>* FinishMainMissionList; // 0x20
		::Il2CppArray<::Class_1_3745C69C00F04B7D_2*>* AvatarList; // 0x28
		::System::String* Name; // 0x30
		::Il2CppArray<::System::UInt32>* RelicGroupIDList; // 0x38
		::System::UInt32 FinishMainMissionUntil; // 0x40
