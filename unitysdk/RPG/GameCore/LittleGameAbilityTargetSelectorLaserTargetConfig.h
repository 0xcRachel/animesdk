...
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORLASERTARGETCONFIG_METHOD_3_0D690C86F78CFD16_OFFSET UNITYSDK_OFFSET(0x1A1221F0)
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORLASERTARGETCONFIG_METHOD_3_BED8C940652C9487_OFFSET UNITYSDK_OFFSET(0x1A122150)
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORLASERTARGETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1221E0)
