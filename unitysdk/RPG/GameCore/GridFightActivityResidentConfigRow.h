...
#define RPG_GAMECORE_GRIDFIGHTACTIVITYRESIDENTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AC7BA90)
#define RPG_GAMECORE_GRIDFIGHTACTIVITYRESIDENTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC7BF60)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean IsShowRemainTime; // 0x58
		::System::UInt32 ActivityID; // 0x5C
		::RPG::Client::TextID ResidentBrief; // 0x60
		::System::UInt32 SortWeight; // 0x70
