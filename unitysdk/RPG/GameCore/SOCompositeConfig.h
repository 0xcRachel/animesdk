...
#define RPG_GAMECORE_SOCOMPOSITECONFIG_METHOD_4_6BE204EFAD569F8E_OFFSET UNITYSDK_OFFSET(0x1768F7D0)
#define RPG_GAMECORE_SOCOMPOSITECONFIG_METHOD_4_F2896E765C3D892C_OFFSET UNITYSDK_OFFSET(0x1768EEE0)
#define RPG_GAMECORE_SOCOMPOSITECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1768FA20)
