...
#define RPG_GAMECORE_SOCOMPOSITECONFIG_METHOD_4_6BE204EFAD569F8E_OFFSET UNITYSDK_OFFSET(0x16EDB0E0)
#define RPG_GAMECORE_SOCOMPOSITECONFIG_METHOD_4_F2896E765C3D892C_OFFSET UNITYSDK_OFFSET(0x16EDA850)
#define RPG_GAMECORE_SOCOMPOSITECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16EDB330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SOCompositeConfig_TypeDefinitionIndex = 17812;
