...
#define RPG_GAMECORE_TRACKNAMELIST_METHOD_2_EC4F9E86676BC7A8_OFFSET UNITYSDK_OFFSET(0x1948D5D0)
#define RPG_GAMECORE_TRACKNAMELIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1948D6A0)
