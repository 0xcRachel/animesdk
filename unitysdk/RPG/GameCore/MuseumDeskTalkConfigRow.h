...
#define RPG_GAMECORE_MUSEUMDESKTALKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x190F4620)
#define RPG_GAMECORE_MUSEUMDESKTALKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x190F4DB0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::MuseumTalkTriggerType TriggerType; // 0x2C
