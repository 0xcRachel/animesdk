...
#define RPG_GAMECORE_MUSEUMDESKTALKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1863B820)
#define RPG_GAMECORE_MUSEUMDESKTALKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1863BF50)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean IsMustTriggered; // 0x28
