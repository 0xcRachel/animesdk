...
#define RPG_GAMECORE_BYCURRENTAUDIOLANGUAGE_METHOD_4_950B873C87AB3580_OFFSET UNITYSDK_OFFSET(0x16921720)
#define RPG_GAMECORE_BYCURRENTAUDIOLANGUAGE_METHOD_4_E648914BB4840DAE_OFFSET UNITYSDK_OFFSET(0x169217F0)
#define RPG_GAMECORE_BYCURRENTAUDIOLANGUAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x169217A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCurrentAudioLanguage_TypeDefinitionIndex = 21530;
