...
#define RPG_GAMECORE_STARTADVSKILLCOMBO_METHOD_3_794CACD83B714FE6_OFFSET UNITYSDK_OFFSET(0x177875B0)
#define RPG_GAMECORE_STARTADVSKILLCOMBO_METHOD_3_B2356548373E69C7_OFFSET UNITYSDK_OFFSET(0x17787630)
#define RPG_GAMECORE_STARTADVSKILLCOMBO__CTOR_OFFSET UNITYSDK_OFFSET(0x17787600)
