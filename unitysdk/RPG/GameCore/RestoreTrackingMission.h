...
#define RPG_GAMECORE_RESTORETRACKINGMISSION_METHOD_3_28630B6D5D312668_OFFSET UNITYSDK_OFFSET(0x16DF27B0)
#define RPG_GAMECORE_RESTORETRACKINGMISSION_METHOD_3_A2360D64322E251C_OFFSET UNITYSDK_OFFSET(0x16DF26A0)
#define RPG_GAMECORE_RESTORETRACKINGMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x16DF2780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RestoreTrackingMission_TypeDefinitionIndex = 18564;
