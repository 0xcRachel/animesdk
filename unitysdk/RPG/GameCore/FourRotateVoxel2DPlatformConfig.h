...
#define RPG_GAMECORE_FOURROTATEVOXEL2DPLATFORMCONFIG_METHOD_3_04D63B21D6747D8F_OFFSET UNITYSDK_OFFSET(0x16AE2C00)
#define RPG_GAMECORE_FOURROTATEVOXEL2DPLATFORMCONFIG_METHOD_3_57AF3ACA12CCB092_OFFSET UNITYSDK_OFFSET(0x16AE2C70)
#define RPG_GAMECORE_FOURROTATEVOXEL2DPLATFORMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16AE2C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxel2DPlatformConfig_TypeDefinitionIndex = 15099;
