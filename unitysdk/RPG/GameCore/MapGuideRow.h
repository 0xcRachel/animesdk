...
#define RPG_GAMECORE_MAPGUIDEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16C2C370)
#define RPG_GAMECORE_MAPGUIDEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16C2CAA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MapGuideRow_TypeDefinitionIndex = 12782;
