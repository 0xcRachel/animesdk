...
#define RPG_GAMECORE_CHESSBYCONTAINBEHAVIORFLAG_METHOD_4_167248E63CAA397C_OFFSET UNITYSDK_OFFSET(0x1697D120)
#define RPG_GAMECORE_CHESSBYCONTAINBEHAVIORFLAG_METHOD_4_F322B0F6ED576A84_OFFSET UNITYSDK_OFFSET(0x1697D050)
#define RPG_GAMECORE_CHESSBYCONTAINBEHAVIORFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1697D0D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChessByContainBehaviorFlag_TypeDefinitionIndex = 21438;
