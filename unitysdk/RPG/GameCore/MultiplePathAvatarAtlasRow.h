...
#define RPG_GAMECORE_MULTIPLEPATHAVATARATLASROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16CE81A0)
#define RPG_GAMECORE_MULTIPLEPATHAVATARATLASROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16CE8340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MultiplePathAvatarAtlasRow_TypeDefinitionIndex = 11500;
