...
#define RPG_GAMECORE_FIVEDIMENTERHIDDENAREAACTION_METHOD_3_165CAF032D89E277_OFFSET UNITYSDK_OFFSET(0x16ABB500)
#define RPG_GAMECORE_FIVEDIMENTERHIDDENAREAACTION_METHOD_3_C39D14DEE453B43A_OFFSET UNITYSDK_OFFSET(0x16ABB440)
#define RPG_GAMECORE_FIVEDIMENTERHIDDENAREAACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16ABB4E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimEnterHiddenAreaAction_TypeDefinitionIndex = 16739;
