...
#define RPG_GAMECORE_SETNPCMONSTERVISIBLE_METHOD_3_9A46FC4D7D2FF498_OFFSET UNITYSDK_OFFSET(0x199C0F60)
#define RPG_GAMECORE_SETNPCMONSTERVISIBLE_METHOD_3_EF943BE4BEFF18F1_OFFSET UNITYSDK_OFFSET(0x199C0FE0)
#define RPG_GAMECORE_SETNPCMONSTERVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x199C0FB0)
