...
#define RPG_GAMECORE_ADVNPCCOMMANDED_METHOD_3_010B5B676E6E862B_OFFSET UNITYSDK_OFFSET(0x1683CEE0)
#define RPG_GAMECORE_ADVNPCCOMMANDED_METHOD_3_6501437387659502_OFFSET UNITYSDK_OFFSET(0x1683CF60)
#define RPG_GAMECORE_ADVNPCCOMMANDED__CTOR_OFFSET UNITYSDK_OFFSET(0x1683CF30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNpcCommanded_TypeDefinitionIndex = 17750;
