...
#define RPG_GAMECORE_PERFORMANCESKIPOVERRIDEROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x18B151B0)
#define RPG_GAMECORE_PERFORMANCESKIPOVERRIDEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18B154C0)
#define RPG_GAMECORE_PERFORMANCESKIPOVERRIDEROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x18B15120)
#define RPG_GAMECORE_PERFORMANCESKIPOVERRIDEROW_RESET_OFFSET UNITYSDK_OFFSET(0x18B15180)
#define RPG_GAMECORE_PERFORMANCESKIPOVERRIDEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18B15820)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 OverrideImportantFlag; // 0x30
		::System::UInt32 PerformanceID; // 0x34
		::System::UInt32 IsConfirmRequiredToSkipFlag; // 0x38
		::System::UInt32 IsOverrideImportantFlag; // 0x3C
		::RPG::GameCore::ELevelPerformanceType PerformanceType; // 0x40
		::System::UInt32 PackID; // 0x44
