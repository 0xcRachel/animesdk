...
#define RPG_GAMECORE_FIVEDIMSETTRIGGERENABLEACTION_METHOD_3_77606EEB70D04FF0_OFFSET UNITYSDK_OFFSET(0x16AD4D20)
#define RPG_GAMECORE_FIVEDIMSETTRIGGERENABLEACTION_METHOD_3_F666462BFF6BA3A4_OFFSET UNITYSDK_OFFSET(0x16AD4BF0)
#define RPG_GAMECORE_FIVEDIMSETTRIGGERENABLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16AD4D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetTriggerEnableAction_TypeDefinitionIndex = 16771;
