...
#define RPG_GAMECORE_FIVEDIMSETTRIGGERENABLEACTION_METHOD_3_77606EEB70D04FF0_OFFSET UNITYSDK_OFFSET(0x1721FBC0)
#define RPG_GAMECORE_FIVEDIMSETTRIGGERENABLEACTION_METHOD_3_F666462BFF6BA3A4_OFFSET UNITYSDK_OFFSET(0x1721FA90)
#define RPG_GAMECORE_FIVEDIMSETTRIGGERENABLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1721FBA0)
