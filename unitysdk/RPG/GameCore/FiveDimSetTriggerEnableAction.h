...
#define RPG_GAMECORE_FIVEDIMSETTRIGGERENABLEACTION_METHOD_3_D7E1DB40F5DCB9D0_OFFSET UNITYSDK_OFFSET(0x1A3A3A30)
#define RPG_GAMECORE_FIVEDIMSETTRIGGERENABLEACTION_METHOD_3_E105A9386EF64789_OFFSET UNITYSDK_OFFSET(0x1A3A3AA0)
#define RPG_GAMECORE_FIVEDIMSETTRIGGERENABLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3A3A80)
