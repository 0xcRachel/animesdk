...
#define RPG_GAMECORE_ADDRESHAEASTEREGGMATCHRULE_METHOD_3_0E2B7B38F31D1940_OFFSET UNITYSDK_OFFSET(0x167BDCE0)
#define RPG_GAMECORE_ADDRESHAEASTEREGGMATCHRULE_METHOD_3_AEFA02796422F7F8_OFFSET UNITYSDK_OFFSET(0x167BDC60)
#define RPG_GAMECORE_ADDRESHAEASTEREGGMATCHRULE__CTOR_OFFSET UNITYSDK_OFFSET(0x167BDCB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddReShaEasterEggMatchRule_TypeDefinitionIndex = 19684;
