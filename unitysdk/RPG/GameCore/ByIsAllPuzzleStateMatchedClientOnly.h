...
#define RPG_GAMECORE_BYISALLPUZZLESTATEMATCHEDCLIENTONLY_METHOD_4_6528DDEA7129F677_OFFSET UNITYSDK_OFFSET(0x19D9BAD0)
#define RPG_GAMECORE_BYISALLPUZZLESTATEMATCHEDCLIENTONLY_METHOD_4_7C3F3873C0E09846_OFFSET UNITYSDK_OFFSET(0x19D9B7E0)
#define RPG_GAMECORE_BYISALLPUZZLESTATEMATCHEDCLIENTONLY_METHOD_4_D4A76DECA8716838_OFFSET UNITYSDK_OFFSET(0x19D9B8B0)
#define RPG_GAMECORE_BYISALLPUZZLESTATEMATCHEDCLIENTONLY_METHOD_4_EA7A7855934B3227_OFFSET UNITYSDK_OFFSET(0x19D9BB50)
#define RPG_GAMECORE_BYISALLPUZZLESTATEMATCHEDCLIENTONLY__CTOR_OFFSET UNITYSDK_OFFSET(0x19D9B860)
