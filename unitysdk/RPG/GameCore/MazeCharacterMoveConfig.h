...
#define RPG_GAMECORE_MAZECHARACTERMOVECONFIG_METHOD_2_090B4A0226475B9B_OFFSET UNITYSDK_OFFSET(0x18C45A40)
#define RPG_GAMECORE_MAZECHARACTERMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18C45B80)
