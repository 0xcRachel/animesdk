...
#define RPG_GAMECORE_FINISHROGUEAEONTALK_METHOD_3_14626B99F3DE0749_OFFSET UNITYSDK_OFFSET(0x16AA7190)
#define RPG_GAMECORE_FINISHROGUEAEONTALK_METHOD_3_8E3A8FC49C30B43D_OFFSET UNITYSDK_OFFSET(0x16AA72A0)
#define RPG_GAMECORE_FINISHROGUEAEONTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x16AA7270)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FinishRogueAeonTalk_TypeDefinitionIndex = 19553;
