...
#define RPG_GAMECORE_ADVNPCGUARDALERTDEVICEACTIVE_METHOD_3_40A7BED95134582A_OFFSET UNITYSDK_OFFSET(0x18C51F40)
#define RPG_GAMECORE_ADVNPCGUARDALERTDEVICEACTIVE_METHOD_3_945A81AFEE74707B_OFFSET UNITYSDK_OFFSET(0x18C51EC0)
#define RPG_GAMECORE_ADVNPCGUARDALERTDEVICEACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C51F10)
