...
#define RPG_GAMECORE_ADVNPCGUARDALERTDEVICEACTIVE_METHOD_3_40A7BED95134582A_OFFSET UNITYSDK_OFFSET(0x1683EB00)
#define RPG_GAMECORE_ADVNPCGUARDALERTDEVICEACTIVE_METHOD_3_945A81AFEE74707B_OFFSET UNITYSDK_OFFSET(0x1683EA80)
#define RPG_GAMECORE_ADVNPCGUARDALERTDEVICEACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1683EAD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNpcGuardAlertDeviceActive_TypeDefinitionIndex = 17748;
