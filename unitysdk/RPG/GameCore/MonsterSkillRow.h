...
#define RPG_GAMECORE_MONSTERSKILLROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x17467250)
#define RPG_GAMECORE_MONSTERSKILLROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17467A80)
#define RPG_GAMECORE_MONSTERSKILLROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x17468B90)
#define RPG_GAMECORE_MONSTERSKILLROW_RESET_OFFSET UNITYSDK_OFFSET(0x17468BF0)
#define RPG_GAMECORE_MONSTERSKILLROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17468C40)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 SortOrder; // 0x60
		::RPG::GameCore::AttackDamageType DamageType; // 0x64
		::RPG::Client::TextID SkillTag; // 0x68
		::System::UInt32 AI_CD; // 0x78
