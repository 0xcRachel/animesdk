...
#define RPG_GAMECORE_CLOCKPARKCHECKPOINTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x169AB1A0)
#define RPG_GAMECORE_CLOCKPARKCHECKPOINTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x169AB980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClockParkCheckPointRow_TypeDefinitionIndex = 10376;
	...
	public:
		...
		::System::UInt32 CheckParam3; // 0x2C
		::RPG::GameCore::ClockParkCheckPointType CheckPointType; // 0x30
