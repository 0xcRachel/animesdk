...
#define RPG_GAMECORE_CLOCKPARKCHECKPOINTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x170CD320)
#define RPG_GAMECORE_CLOCKPARKCHECKPOINTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x170CDB00)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 CheckParam2; // 0x40
