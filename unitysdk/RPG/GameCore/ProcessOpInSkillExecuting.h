...
#define RPG_GAMECORE_PROCESSOPINSKILLEXECUTING_METHOD_3_B6EC97F06089435C_OFFSET UNITYSDK_OFFSET(0x1A2D4000)
#define RPG_GAMECORE_PROCESSOPINSKILLEXECUTING_METHOD_3_BDCAF61B275BE4EA_OFFSET UNITYSDK_OFFSET(0x1A2D3F80)
#define RPG_GAMECORE_PROCESSOPINSKILLEXECUTING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2D3FD0)
