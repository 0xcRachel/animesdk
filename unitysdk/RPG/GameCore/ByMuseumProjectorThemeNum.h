...
#define RPG_GAMECORE_BYMUSEUMPROJECTORTHEMENUM_METHOD_4_25B874263C7A1DAC_OFFSET UNITYSDK_OFFSET(0x16939880)
#define RPG_GAMECORE_BYMUSEUMPROJECTORTHEMENUM_METHOD_4_5CFB784A7DC92288_OFFSET UNITYSDK_OFFSET(0x169397B0)
#define RPG_GAMECORE_BYMUSEUMPROJECTORTHEMENUM__CTOR_OFFSET UNITYSDK_OFFSET(0x16939830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByMuseumProjectorThemeNum_TypeDefinitionIndex = 18339;
