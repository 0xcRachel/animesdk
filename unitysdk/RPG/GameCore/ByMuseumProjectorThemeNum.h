...
#define RPG_GAMECORE_BYMUSEUMPROJECTORTHEMENUM_METHOD_4_25B874263C7A1DAC_OFFSET UNITYSDK_OFFSET(0x19DB8A70)
#define RPG_GAMECORE_BYMUSEUMPROJECTORTHEMENUM_METHOD_4_431ECEB49697A0AF_OFFSET UNITYSDK_OFFSET(0x19DB8CA0)
#define RPG_GAMECORE_BYMUSEUMPROJECTORTHEMENUM_METHOD_4_5CFB784A7DC92288_OFFSET UNITYSDK_OFFSET(0x19DB89A0)
#define RPG_GAMECORE_BYMUSEUMPROJECTORTHEMENUM_METHOD_4_E4F75275D4056188_OFFSET UNITYSDK_OFFSET(0x19DB8C20)
#define RPG_GAMECORE_BYMUSEUMPROJECTORTHEMENUM__CTOR_OFFSET UNITYSDK_OFFSET(0x19DB8A20)
