...
#define RPG_GAMECORE_PARKOURLEVELCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1749EDD0)
#define RPG_GAMECORE_PARKOURLEVELCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1749F450)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Single LevelRegionState; // 0x50
		::System::UInt32 NextStorySubMissionID; // 0x54
		::System::UInt32 LapCount; // 0x58
		::System::UInt32 ID; // 0x5C
		::RPG::Client::TextID Name; // 0x60
		::System::UInt32 TargetRank; // 0x70
		::System::Single MinimapAngle; // 0x74
		::System::UInt32 UnlockParam; // 0x78
