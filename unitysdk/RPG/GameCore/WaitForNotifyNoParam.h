...
#define RPG_GAMECORE_WAITFORNOTIFYNOPARAM_METHOD_3_40F3C73944094534_OFFSET UNITYSDK_OFFSET(0x1952B820)
#define RPG_GAMECORE_WAITFORNOTIFYNOPARAM_METHOD_3_F161AB0EC066D1AD_OFFSET UNITYSDK_OFFSET(0x1952B7A0)
#define RPG_GAMECORE_WAITFORNOTIFYNOPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1952B7F0)
