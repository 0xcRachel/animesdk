...
#define RPG_GAMECORE_WAITFORNOTIFYNOPARAM_METHOD_3_40F3C73944094534_OFFSET UNITYSDK_OFFSET(0x17152300)
#define RPG_GAMECORE_WAITFORNOTIFYNOPARAM_METHOD_3_F161AB0EC066D1AD_OFFSET UNITYSDK_OFFSET(0x17152280)
#define RPG_GAMECORE_WAITFORNOTIFYNOPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x171522D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitForNotifyNoParam_TypeDefinitionIndex = 18719;
