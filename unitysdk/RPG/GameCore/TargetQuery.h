...
#define RPG_GAMECORE_TARGETQUERY_METHOD_4_81D1D2118B9DF1EC_OFFSET UNITYSDK_OFFSET(0x177CDCD0)
#define RPG_GAMECORE_TARGETQUERY_METHOD_4_FD142F713EF58B3D_OFFSET UNITYSDK_OFFSET(0x177D8E30)
#define RPG_GAMECORE_TARGETQUERY__CTOR_OFFSET UNITYSDK_OFFSET(0x177CDC40)
