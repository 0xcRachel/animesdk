...
#define RPG_GAMECORE_RESTAURANTMESSAGECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A2F4C40)
#define RPG_GAMECORE_RESTAURANTMESSAGECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2F4F40)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::RestaurantSelectEventSenderType Sender; // 0x24
