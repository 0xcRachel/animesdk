...
#define RPG_GAMECORE_SETDYNAMICVALUEBYVALUEEVALUATOR_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x199AD940)
#define RPG_GAMECORE_SETDYNAMICVALUEBYVALUEEVALUATOR_METHOD_4_0B97E22B2350D1F6_OFFSET UNITYSDK_OFFSET(0x199AD790)
#define RPG_GAMECORE_SETDYNAMICVALUEBYVALUEEVALUATOR_METHOD_4_5092248C167D0A37_OFFSET UNITYSDK_OFFSET(0x199AD670)
#define RPG_GAMECORE_SETDYNAMICVALUEBYVALUEEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x199AD710)
