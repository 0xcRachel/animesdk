...
#define RPG_GAMECORE_TRIGGERCOMMONACTIVESKILLABILITY_METHOD_3_F66A0BACF26821D1_OFFSET UNITYSDK_OFFSET(0x17118E90)
#define RPG_GAMECORE_TRIGGERCOMMONACTIVESKILLABILITY_METHOD_3_FD422308C2686178_OFFSET UNITYSDK_OFFSET(0x17118F10)
#define RPG_GAMECORE_TRIGGERCOMMONACTIVESKILLABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x17118EE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerCommonActiveSkillAbility_TypeDefinitionIndex = 20340;
