...
#define RPG_GAMECORE_SHOWRUBBINGUI_METHOD_3_111172B90AE9F92D_OFFSET UNITYSDK_OFFSET(0x16F61AD0)
#define RPG_GAMECORE_SHOWRUBBINGUI_METHOD_3_9302574D5FFE5BB9_OFFSET UNITYSDK_OFFSET(0x16F619C0)
#define RPG_GAMECORE_SHOWRUBBINGUI__CTOR_OFFSET UNITYSDK_OFFSET(0x16F61AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowRubbingUI_TypeDefinitionIndex = 19818;
