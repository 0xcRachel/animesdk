...
#define RPG_GAMECORE_ADVPROPSTEER_METHOD_3_1638D92EF43D021A_OFFSET UNITYSDK_OFFSET(0x16843270)
#define RPG_GAMECORE_ADVPROPSTEER_METHOD_3_7A98378EA4F71F67_OFFSET UNITYSDK_OFFSET(0x16843120)
#define RPG_GAMECORE_ADVPROPSTEER__CTOR_OFFSET UNITYSDK_OFFSET(0x168431E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvPropSteer_TypeDefinitionIndex = 19702;
