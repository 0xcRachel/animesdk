...
#define RPG_GAMECORE_SHOWENTERPASSWORDPAGE_METHOD_3_4BF7F001F01CC6C4_OFFSET UNITYSDK_OFFSET(0x16F57B50)
#define RPG_GAMECORE_SHOWENTERPASSWORDPAGE_METHOD_3_8FEE103B7CAE3861_OFFSET UNITYSDK_OFFSET(0x16F57AD0)
#define RPG_GAMECORE_SHOWENTERPASSWORDPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F57B20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowEnterPasswordPage_TypeDefinitionIndex = 19597;
