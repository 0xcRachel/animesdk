...
#define RPG_GAMECORE_RANDOMTASK_METHOD_3_79A8FA8631057F3E_OFFSET UNITYSDK_OFFSET(0x16DC8950)
#define RPG_GAMECORE_RANDOMTASK_METHOD_3_F5C4800831608FD9_OFFSET UNITYSDK_OFFSET(0x16DC89C0)
#define RPG_GAMECORE_RANDOMTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x16DC8990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RandomTask_TypeDefinitionIndex = 19054;
