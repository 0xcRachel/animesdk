...
#define RPG_GAMECORE_RANDOMTASK_METHOD_3_DC0D7926B87552C9_OFFSET UNITYSDK_OFFSET(0x1900ED40)
#define RPG_GAMECORE_RANDOMTASK_METHOD_3_F5C4800831608FD9_OFFSET UNITYSDK_OFFSET(0x1900EDD0)
#define RPG_GAMECORE_RANDOMTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1900EDA0)
