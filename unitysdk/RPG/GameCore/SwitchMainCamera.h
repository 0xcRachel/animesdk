...
#define RPG_GAMECORE_SWITCHMAINCAMERA_METHOD_3_4AD2CCF07A23E323_OFFSET UNITYSDK_OFFSET(0x16FB5AE0)
#define RPG_GAMECORE_SWITCHMAINCAMERA_METHOD_3_A213E73CE13B65DD_OFFSET UNITYSDK_OFFSET(0x16FB5B80)
#define RPG_GAMECORE_SWITCHMAINCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x16FB5B40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchMainCamera_TypeDefinitionIndex = 21005;
