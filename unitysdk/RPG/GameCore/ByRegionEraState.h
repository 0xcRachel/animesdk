...
#define RPG_GAMECORE_BYREGIONERASTATE_METHOD_4_6D8FAEEEE555186E_OFFSET UNITYSDK_OFFSET(0x1693CE70)
#define RPG_GAMECORE_BYREGIONERASTATE_METHOD_4_B2035B0A97421840_OFFSET UNITYSDK_OFFSET(0x1693CDA0)
#define RPG_GAMECORE_BYREGIONERASTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1693CE20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByRegionEraState_TypeDefinitionIndex = 19988;
