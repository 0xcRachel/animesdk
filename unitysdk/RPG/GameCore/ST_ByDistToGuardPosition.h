...
#define RPG_GAMECORE_ST_BYDISTTOGUARDPOSITION_METHOD_4_9EB71DE4AF08487D_OFFSET UNITYSDK_OFFSET(0x1A179F40)
#define RPG_GAMECORE_ST_BYDISTTOGUARDPOSITION_METHOD_4_A764A4E4EF7394AD_OFFSET UNITYSDK_OFFSET(0x1A17A010)
#define RPG_GAMECORE_ST_BYDISTTOGUARDPOSITION_METHOD_4_F051CFC6AAA7F74E_OFFSET UNITYSDK_OFFSET(0x1A17A2A0)
#define RPG_GAMECORE_ST_BYDISTTOGUARDPOSITION_METHOD_4_F3D0C645FF75CB67_OFFSET UNITYSDK_OFFSET(0x1A17A220)
#define RPG_GAMECORE_ST_BYDISTTOGUARDPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A179FC0)
