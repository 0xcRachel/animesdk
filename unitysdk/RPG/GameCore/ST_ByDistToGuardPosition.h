...
#define RPG_GAMECORE_ST_BYDISTTOGUARDPOSITION_METHOD_4_9EB71DE4AF08487D_OFFSET UNITYSDK_OFFSET(0x16EEED40)
#define RPG_GAMECORE_ST_BYDISTTOGUARDPOSITION_METHOD_4_A764A4E4EF7394AD_OFFSET UNITYSDK_OFFSET(0x16EEEE10)
#define RPG_GAMECORE_ST_BYDISTTOGUARDPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x16EEEDC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByDistToGuardPosition_TypeDefinitionIndex = 17828;
