...
#define RPG_GAMECORE_SHADERPROPERTYCONFIG_METHOD_2_A31BC3D26F5AADD5_OFFSET UNITYSDK_OFFSET(0x193987B0)
#define RPG_GAMECORE_SHADERPROPERTYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19398A40)
