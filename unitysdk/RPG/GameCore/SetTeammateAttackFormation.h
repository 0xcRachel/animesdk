...
#define RPG_GAMECORE_SETTEAMMATEATTACKFORMATION_METHOD_3_4E5DD5DB38E1B414_OFFSET UNITYSDK_OFFSET(0x16F42E10)
#define RPG_GAMECORE_SETTEAMMATEATTACKFORMATION_METHOD_3_EB46A5933DF38AB6_OFFSET UNITYSDK_OFFSET(0x16F42EF0)
#define RPG_GAMECORE_SETTEAMMATEATTACKFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x16F42E90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTeammateAttackFormation_TypeDefinitionIndex = 20133;
