...
#define RPG_GAMECORE_SETTEAMMATEATTACKFORMATION_METHOD_3_0C5D75FA4882F0CD_OFFSET UNITYSDK_OFFSET(0x1A7A12F0)
#define RPG_GAMECORE_SETTEAMMATEATTACKFORMATION_METHOD_3_74BB182DB55BCA32_OFFSET UNITYSDK_OFFSET(0x1A7A13D0)
#define RPG_GAMECORE_SETTEAMMATEATTACKFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7A1370)
