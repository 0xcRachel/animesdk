...
#define RPG_GAMECORE_OVERRIDEMONOEFFECTCONFIG_METHOD_2_CD86C284D8078C20_OFFSET UNITYSDK_OFFSET(0x18EF6F30)
#define RPG_GAMECORE_OVERRIDEMONOEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18EF70B0)
