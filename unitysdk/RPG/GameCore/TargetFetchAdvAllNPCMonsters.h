...
#define RPG_GAMECORE_TARGETFETCHADVALLNPCMONSTERS_METHOD_4_6DD9E87A8E7E4302_OFFSET UNITYSDK_OFFSET(0x199D5500)
#define RPG_GAMECORE_TARGETFETCHADVALLNPCMONSTERS_METHOD_4_ADC3A7BB2C270FB0_OFFSET UNITYSDK_OFFSET(0x199DEC70)
#define RPG_GAMECORE_TARGETFETCHADVALLNPCMONSTERS__CTOR_OFFSET UNITYSDK_OFFSET(0x199D54B0)
