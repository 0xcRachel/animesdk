...
#define RPG_GAMECORE_TARGETFETCHADVALLNPCMONSTERS_METHOD_4_6DD9E87A8E7E4302_OFFSET UNITYSDK_OFFSET(0x1AC3D6A0)
#define RPG_GAMECORE_TARGETFETCHADVALLNPCMONSTERS_METHOD_4_6E9C21F5D38540BA_OFFSET UNITYSDK_OFFSET(0x1AC51380)
#define RPG_GAMECORE_TARGETFETCHADVALLNPCMONSTERS_METHOD_4_ADC3A7BB2C270FB0_OFFSET UNITYSDK_OFFSET(0x1AC512C0)
#define RPG_GAMECORE_TARGETFETCHADVALLNPCMONSTERS_METHOD_4_D65A2889D7F6143A_OFFSET UNITYSDK_OFFSET(0x1AC4BE20)
#define RPG_GAMECORE_TARGETFETCHADVALLNPCMONSTERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC3D650)
