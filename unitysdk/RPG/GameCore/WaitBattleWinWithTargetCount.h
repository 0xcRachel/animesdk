...
#define RPG_GAMECORE_WAITBATTLEWINWITHTARGETCOUNT_METHOD_3_143066BDA4059FB1_OFFSET UNITYSDK_OFFSET(0x1790A2E0)
#define RPG_GAMECORE_WAITBATTLEWINWITHTARGETCOUNT_METHOD_3_5070C73FCF241A86_OFFSET UNITYSDK_OFFSET(0x1790A350)
#define RPG_GAMECORE_WAITBATTLEWINWITHTARGETCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1790A320)
