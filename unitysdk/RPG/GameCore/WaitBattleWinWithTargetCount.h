...
#define RPG_GAMECORE_WAITBATTLEWINWITHTARGETCOUNT_METHOD_3_143066BDA4059FB1_OFFSET UNITYSDK_OFFSET(0x195273C0)
#define RPG_GAMECORE_WAITBATTLEWINWITHTARGETCOUNT_METHOD_3_5070C73FCF241A86_OFFSET UNITYSDK_OFFSET(0x19527430)
#define RPG_GAMECORE_WAITBATTLEWINWITHTARGETCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x19527400)
