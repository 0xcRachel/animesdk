...
#define RPG_GAMECORE_WAITUIONTOP_METHOD_3_2633D076D54ABB8B_OFFSET UNITYSDK_OFFSET(0x1791C8C0)
#define RPG_GAMECORE_WAITUIONTOP_METHOD_3_D5DEA1CD37045E22_OFFSET UNITYSDK_OFFSET(0x1791C840)
#define RPG_GAMECORE_WAITUIONTOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1791C890)
