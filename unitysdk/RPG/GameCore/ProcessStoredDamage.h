...
#define RPG_GAMECORE_PROCESSSTOREDDAMAGE_METHOD_3_4315169E7166DB2B_OFFSET UNITYSDK_OFFSET(0x17527CE0)
#define RPG_GAMECORE_PROCESSSTOREDDAMAGE_METHOD_3_D4C34EF143C1D369_OFFSET UNITYSDK_OFFSET(0x17527DD0)
#define RPG_GAMECORE_PROCESSSTOREDDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x17527D20)
