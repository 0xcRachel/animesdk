...
#define RPG_GAMECORE_LOCKTOAST_METHOD_3_9325E0556C47AFFC_OFFSET UNITYSDK_OFFSET(0x19C14FC0)
#define RPG_GAMECORE_LOCKTOAST_METHOD_3_A4DB745803B8CE8D_OFFSET UNITYSDK_OFFSET(0x19C14F40)
#define RPG_GAMECORE_LOCKTOAST__CTOR_OFFSET UNITYSDK_OFFSET(0x19C14F90)
