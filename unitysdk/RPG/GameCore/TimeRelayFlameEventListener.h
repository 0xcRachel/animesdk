...
#define RPG_GAMECORE_TIMERELAYFLAMEEVENTLISTENER_METHOD_3_17109024249BAAFC_OFFSET UNITYSDK_OFFSET(0x1789C9A0)
#define RPG_GAMECORE_TIMERELAYFLAMEEVENTLISTENER_METHOD_3_C96F472F8B1376FE_OFFSET UNITYSDK_OFFSET(0x178B1A00)
#define RPG_GAMECORE_TIMERELAYFLAMEEVENTLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1789C970)
