...
#define RPG_GAMECORE_TIMERELAYFLAMEEVENTLISTENER_METHOD_3_17109024249BAAFC_OFFSET UNITYSDK_OFFSET(0x170F2BE0)
#define RPG_GAMECORE_TIMERELAYFLAMEEVENTLISTENER_METHOD_3_C96F472F8B1376FE_OFFSET UNITYSDK_OFFSET(0x170F2B60)
#define RPG_GAMECORE_TIMERELAYFLAMEEVENTLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x170F2BB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRelayFlameEventListener_TypeDefinitionIndex = 19687;
