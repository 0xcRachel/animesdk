...
#define RPG_GAMECORE_SHOWGUIDEDETAILDIALOG_METHOD_3_4179D6A6D1DDFA52_OFFSET UNITYSDK_OFFSET(0x17710940)
#define RPG_GAMECORE_SHOWGUIDEDETAILDIALOG_METHOD_3_7D09F989BB65A33C_OFFSET UNITYSDK_OFFSET(0x177109C0)
#define RPG_GAMECORE_SHOWGUIDEDETAILDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x17710990)
