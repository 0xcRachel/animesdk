...
#define RPG_GAMECORE_PLAYNPCSINGLEBUBBLETALK_METHOD_3_9902D67DA8CAACEE_OFFSET UNITYSDK_OFFSET(0x16D50580)
#define RPG_GAMECORE_PLAYNPCSINGLEBUBBLETALK_METHOD_3_FF3195682057F645_OFFSET UNITYSDK_OFFSET(0x16D50760)
#define RPG_GAMECORE_PLAYNPCSINGLEBUBBLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x16D50680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayNPCSingleBubbleTalk_TypeDefinitionIndex = 19231;
