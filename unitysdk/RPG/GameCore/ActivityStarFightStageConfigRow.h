...
#define RPG_GAMECORE_ACTIVITYSTARFIGHTSTAGECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x167B2650)
#define RPG_GAMECORE_ACTIVITYSTARFIGHTSTAGECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x167B2880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityStarFightStageConfigRow_TypeDefinitionIndex = 11245;
	...
	public:
		...
		::RPG::GameCore::StarFightDifficulty DifficultyLevel; // 0x24
