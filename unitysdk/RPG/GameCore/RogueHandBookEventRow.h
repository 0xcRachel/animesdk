...
#define RPG_GAMECORE_ROGUEHANDBOOKEVENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19965F00)
#define RPG_GAMECORE_ROGUEHANDBOOKEVENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x199662F0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 EventHandbookID; // 0x40
		::System::UInt32 ImageID; // 0x44
