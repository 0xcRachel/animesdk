...
#define RPG_GAMECORE_TASKTEMPLATEFETCHPARAMSEQUENCE_METHOD_3_251BE854C786F840_OFFSET UNITYSDK_OFFSET(0x178A9A50)
#define RPG_GAMECORE_TASKTEMPLATEFETCHPARAMSEQUENCE_METHOD_3_90FBEEF2E3BFD039_OFFSET UNITYSDK_OFFSET(0x1789B8C0)
#define RPG_GAMECORE_TASKTEMPLATEFETCHPARAMSEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1789B890)
