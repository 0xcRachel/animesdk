...
#define RPG_GAMECORE_TASKTEMPLATEFETCHPARAMSEQUENCE_METHOD_3_251BE854C786F840_OFFSET UNITYSDK_OFFSET(0x170EA510)
#define RPG_GAMECORE_TASKTEMPLATEFETCHPARAMSEQUENCE_METHOD_3_90FBEEF2E3BFD039_OFFSET UNITYSDK_OFFSET(0x170E07B0)
#define RPG_GAMECORE_TASKTEMPLATEFETCHPARAMSEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x170E0780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TaskTemplateFetchParamSequence_TypeDefinitionIndex = 21545;
