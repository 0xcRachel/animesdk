...
#define RPG_GAMECORE_PASSENGERBEHAVIORCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18F008A0)
#define RPG_GAMECORE_PASSENGERBEHAVIORCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18F00AB0)
