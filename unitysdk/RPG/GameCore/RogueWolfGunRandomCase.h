...
#define RPG_GAMECORE_ROGUEWOLFGUNRANDOMCASE_METHOD_3_4233021C414BD2D9_OFFSET UNITYSDK_OFFSET(0x16ED2CD0)
#define RPG_GAMECORE_ROGUEWOLFGUNRANDOMCASE_METHOD_3_B44B1EB81C16ADE0_OFFSET UNITYSDK_OFFSET(0x16ED2C50)
#define RPG_GAMECORE_ROGUEWOLFGUNRANDOMCASE__CTOR_OFFSET UNITYSDK_OFFSET(0x16ED2CA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWolfGunRandomCase_TypeDefinitionIndex = 19970;
