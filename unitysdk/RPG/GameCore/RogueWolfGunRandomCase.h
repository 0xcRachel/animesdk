...
#define RPG_GAMECORE_ROGUEWOLFGUNRANDOMCASE_METHOD_3_4233021C414BD2D9_OFFSET UNITYSDK_OFFSET(0x17687290)
#define RPG_GAMECORE_ROGUEWOLFGUNRANDOMCASE_METHOD_3_B44B1EB81C16ADE0_OFFSET UNITYSDK_OFFSET(0x17687210)
#define RPG_GAMECORE_ROGUEWOLFGUNRANDOMCASE__CTOR_OFFSET UNITYSDK_OFFSET(0x17687260)
