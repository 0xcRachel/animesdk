...
#define RPG_GAMECORE_MARBLEBYISDEFENDER_METHOD_4_9B2626968487604F_OFFSET UNITYSDK_OFFSET(0x16C3AF20)
#define RPG_GAMECORE_MARBLEBYISDEFENDER_METHOD_4_E6C132454F74478F_OFFSET UNITYSDK_OFFSET(0x16C3B000)
#define RPG_GAMECORE_MARBLEBYISDEFENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x16C3AFB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleByIsDefender_TypeDefinitionIndex = 15191;
