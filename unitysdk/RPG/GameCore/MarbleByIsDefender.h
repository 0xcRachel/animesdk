...
#define RPG_GAMECORE_MARBLEBYISDEFENDER_METHOD_4_9B2626968487604F_OFFSET UNITYSDK_OFFSET(0x1739FD90)
#define RPG_GAMECORE_MARBLEBYISDEFENDER_METHOD_4_E6C132454F74478F_OFFSET UNITYSDK_OFFSET(0x1739FE70)
#define RPG_GAMECORE_MARBLEBYISDEFENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1739FE20)
