...
#define RPG_GAMECORE_RA_BYAISTATUS_METHOD_4_41D6BFFF9F1BCF78_OFFSET UNITYSDK_OFFSET(0x1758CED0)
#define RPG_GAMECORE_RA_BYAISTATUS_METHOD_4_6186FE26BBA8DD30_OFFSET UNITYSDK_OFFSET(0x1758CE00)
#define RPG_GAMECORE_RA_BYAISTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1758CE80)
