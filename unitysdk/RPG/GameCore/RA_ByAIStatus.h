...
#define RPG_GAMECORE_RA_BYAISTATUS_METHOD_4_41D6BFFF9F1BCF78_OFFSET UNITYSDK_OFFSET(0x16D9AF60)
#define RPG_GAMECORE_RA_BYAISTATUS_METHOD_4_6186FE26BBA8DD30_OFFSET UNITYSDK_OFFSET(0x16DC0B40)
#define RPG_GAMECORE_RA_BYAISTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x16D9AF10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RA_ByAIStatus_TypeDefinitionIndex = 17807;
