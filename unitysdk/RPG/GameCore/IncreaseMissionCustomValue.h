...
#define RPG_GAMECORE_INCREASEMISSIONCUSTOMVALUE_METHOD_3_014E15FB00297A7C_OFFSET UNITYSDK_OFFSET(0x1888CD00)
#define RPG_GAMECORE_INCREASEMISSIONCUSTOMVALUE_METHOD_3_0B434CC5A02F8523_OFFSET UNITYSDK_OFFSET(0x1888CC80)
#define RPG_GAMECORE_INCREASEMISSIONCUSTOMVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1888CCD0)
