...
#define RPG_GAMECORE_CHIMERADUELLEAVENODE_METHOD_3_68F3C1212D656C7E_OFFSET UNITYSDK_OFFSET(0x170B2C50)
#define RPG_GAMECORE_CHIMERADUELLEAVENODE_METHOD_3_803116249400F93C_OFFSET UNITYSDK_OFFSET(0x170B2D30)
#define RPG_GAMECORE_CHIMERADUELLEAVENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x170B2CE0)
