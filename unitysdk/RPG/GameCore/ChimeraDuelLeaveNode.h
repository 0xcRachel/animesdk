...
#define RPG_GAMECORE_CHIMERADUELLEAVENODE_METHOD_3_68F3C1212D656C7E_OFFSET UNITYSDK_OFFSET(0x169910E0)
#define RPG_GAMECORE_CHIMERADUELLEAVENODE_METHOD_3_803116249400F93C_OFFSET UNITYSDK_OFFSET(0x169911C0)
#define RPG_GAMECORE_CHIMERADUELLEAVENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x16991170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelLeaveNode_TypeDefinitionIndex = 14402;
