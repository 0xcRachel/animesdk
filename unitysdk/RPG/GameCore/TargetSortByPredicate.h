...
#define RPG_GAMECORE_TARGETSORTBYPREDICATE_METHOD_3_7458ED9591F1A647_OFFSET UNITYSDK_OFFSET(0x16FF2AB0)
#define RPG_GAMECORE_TARGETSORTBYPREDICATE_METHOD_3_89BA15031B47B4AB_OFFSET UNITYSDK_OFFSET(0x16FF16D0)
#define RPG_GAMECORE_TARGETSORTBYPREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FF16B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSortByPredicate_TypeDefinitionIndex = 21694;
