...
#define RPG_GAMECORE_SETUPMAPROTATIONVOLUME_METHOD_3_026E2CE52F6ECF59_OFFSET UNITYSDK_OFFSET(0x19FF1D60)
#define RPG_GAMECORE_SETUPMAPROTATIONVOLUME_METHOD_3_71FEB3A82670FFCA_OFFSET UNITYSDK_OFFSET(0x19FF1CE0)
#define RPG_GAMECORE_SETUPMAPROTATIONVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x19FF1D30)
