...
#define RPG_GAMECORE_SETUPMAPROTATIONVOLUME_METHOD_3_10411CBF3012EBBF_OFFSET UNITYSDK_OFFSET(0x176FEEC0)
#define RPG_GAMECORE_SETUPMAPROTATIONVOLUME_METHOD_3_E5E685C140CDA65C_OFFSET UNITYSDK_OFFSET(0x176FEE40)
#define RPG_GAMECORE_SETUPMAPROTATIONVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x176FEE90)
