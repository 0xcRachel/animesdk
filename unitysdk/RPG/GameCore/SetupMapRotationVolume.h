...
#define RPG_GAMECORE_SETUPMAPROTATIONVOLUME_METHOD_3_10411CBF3012EBBF_OFFSET UNITYSDK_OFFSET(0x16F49A30)
#define RPG_GAMECORE_SETUPMAPROTATIONVOLUME_METHOD_3_E5E685C140CDA65C_OFFSET UNITYSDK_OFFSET(0x16F499B0)
#define RPG_GAMECORE_SETUPMAPROTATIONVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x16F49A00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetupMapRotationVolume_TypeDefinitionIndex = 19962;
