...
#define RPG_GAMECORE_GRIDFIGHTEXPERTRESTRICTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AC888D0)
#define RPG_GAMECORE_GRIDFIGHTEXPERTRESTRICTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC88AC0)
