...
#define RPG_GAMECORE_DRINKMAKERCHEERSTYPETEXTMAPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16A499C0)
#define RPG_GAMECORE_DRINKMAKERCHEERSTYPETEXTMAPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16A49CB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DrinkMakerCheersTypeTextmapRow_TypeDefinitionIndex = 11980;
	...
	public:
		...
		::RPG::GameCore::DrinkMakerQuantifyTagType Type; // 0x24
