...
#define RPG_GAMECORE_USESKILLONEMORE_METHOD_3_69A4535FC7903EE0_OFFSET UNITYSDK_OFFSET(0x178FCF80)
#define RPG_GAMECORE_USESKILLONEMORE_METHOD_3_BCAC65686D1DC595_OFFSET UNITYSDK_OFFSET(0x178FCEE0)
#define RPG_GAMECORE_USESKILLONEMORE__CTOR_OFFSET UNITYSDK_OFFSET(0x178FCF40)
