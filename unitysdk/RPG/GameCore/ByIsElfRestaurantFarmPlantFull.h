...
#define RPG_GAMECORE_BYISELFRESTAURANTFARMPLANTFULL_METHOD_4_5F386FD6FF5C6D0A_OFFSET UNITYSDK_OFFSET(0x1692FA40)
#define RPG_GAMECORE_BYISELFRESTAURANTFARMPLANTFULL_METHOD_4_85AAC0512D243E30_OFFSET UNITYSDK_OFFSET(0x1692FB10)
#define RPG_GAMECORE_BYISELFRESTAURANTFARMPLANTFULL__CTOR_OFFSET UNITYSDK_OFFSET(0x1692FAC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsElfRestaurantFarmPlantFull_TypeDefinitionIndex = 21850;
