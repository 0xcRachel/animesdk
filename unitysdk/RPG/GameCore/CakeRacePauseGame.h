...
#define RPG_GAMECORE_CAKERACEPAUSEGAME_METHOD_3_0BD95B2329BED12C_OFFSET UNITYSDK_OFFSET(0x169512C0)
#define RPG_GAMECORE_CAKERACEPAUSEGAME_METHOD_3_B9D688A87F80A3BD_OFFSET UNITYSDK_OFFSET(0x16951340)
#define RPG_GAMECORE_CAKERACEPAUSEGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x16951310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRacePauseGame_TypeDefinitionIndex = 21777;
