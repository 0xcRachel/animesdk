...
#define RPG_GAMECORE_MARBLECHOOSETARGET_METHOD_3_306D02C3043328B7_OFFSET UNITYSDK_OFFSET(0x16C3C190)
#define RPG_GAMECORE_MARBLECHOOSETARGET_METHOD_3_813B1BA3435620DC_OFFSET UNITYSDK_OFFSET(0x16C3C0B0)
#define RPG_GAMECORE_MARBLECHOOSETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x16C3C140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleChooseTarget_TypeDefinitionIndex = 15165;
