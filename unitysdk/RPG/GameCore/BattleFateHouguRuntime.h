...
#define RPG_GAMECORE_BATTLEFATEHOUGURUNTIME_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA354CD0)
#define RPG_GAMECORE_BATTLEFATEHOUGURUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0xA354D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleFateHouguRuntime_TypeDefinitionIndex = 43878;
