...
#define RPG_GAMECORE_ALLEYBUFFGRIDITEMDATA_METHOD_3_529D0562E7B68B12_OFFSET UNITYSDK_OFFSET(0x16874D90)
#define RPG_GAMECORE_ALLEYBUFFGRIDITEMDATA_METHOD_3_FA715395B3D3B1B8_OFFSET UNITYSDK_OFFSET(0x16875570)
#define RPG_GAMECORE_ALLEYBUFFGRIDITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16874D80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AlleyBuffGridItemData_TypeDefinitionIndex = 14253;
