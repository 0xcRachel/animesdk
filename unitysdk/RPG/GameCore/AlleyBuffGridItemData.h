...
#define RPG_GAMECORE_ALLEYBUFFGRIDITEMDATA_METHOD_3_529D0562E7B68B12_OFFSET UNITYSDK_OFFSET(0x18AC3460)
#define RPG_GAMECORE_ALLEYBUFFGRIDITEMDATA_METHOD_3_FA715395B3D3B1B8_OFFSET UNITYSDK_OFFSET(0x18AC3C40)
#define RPG_GAMECORE_ALLEYBUFFGRIDITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18AC3450)
