...
#define RPG_GAMECORE_TRIGGERTURNPAGE_METHOD_3_DAA618FA14AE3BC3_OFFSET UNITYSDK_OFFSET(0x1911FD60)
#define RPG_GAMECORE_TRIGGERTURNPAGE_METHOD_3_DCBB455CC140C12F_OFFSET UNITYSDK_OFFSET(0x1911FC50)
#define RPG_GAMECORE_TRIGGERTURNPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1911FD30)
