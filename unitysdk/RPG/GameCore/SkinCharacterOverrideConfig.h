...
#define RPG_GAMECORE_SKINCHARACTEROVERRIDECONFIG_METHOD_2_0C4BB4EBBCE268F5_OFFSET UNITYSDK_OFFSET(0x16F6E960)
#define RPG_GAMECORE_SKINCHARACTEROVERRIDECONFIG_METHOD_2_D25FD22724C3016D_OFFSET UNITYSDK_OFFSET(0x16F6E670)
#define RPG_GAMECORE_SKINCHARACTEROVERRIDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F6E950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SkinCharacterOverrideConfig_TypeDefinitionIndex = 15762;
