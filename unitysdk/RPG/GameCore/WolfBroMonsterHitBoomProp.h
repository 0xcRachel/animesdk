...
#define RPG_GAMECORE_WOLFBROMONSTERHITBOOMPROP_METHOD_3_2BF977DE54E45BD0_OFFSET UNITYSDK_OFFSET(0x171641C0)
#define RPG_GAMECORE_WOLFBROMONSTERHITBOOMPROP_METHOD_3_445B64E3E16E6864_OFFSET UNITYSDK_OFFSET(0x171642C0)
#define RPG_GAMECORE_WOLFBROMONSTERHITBOOMPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x17164250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroMonsterHitBoomProp_TypeDefinitionIndex = 17937;
