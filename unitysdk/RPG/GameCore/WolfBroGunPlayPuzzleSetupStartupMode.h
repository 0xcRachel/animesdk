...
#define RPG_GAMECORE_WOLFBROGUNPLAYPUZZLESETUPSTARTUPMODE_METHOD_3_55BEE7ECD493A447_OFFSET UNITYSDK_OFFSET(0x17920340)
#define RPG_GAMECORE_WOLFBROGUNPLAYPUZZLESETUPSTARTUPMODE_METHOD_3_B43F89DEA0A5CBC6_OFFSET UNITYSDK_OFFSET(0x179203C0)
#define RPG_GAMECORE_WOLFBROGUNPLAYPUZZLESETUPSTARTUPMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x17920390)
