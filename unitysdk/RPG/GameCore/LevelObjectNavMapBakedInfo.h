...
#define RPG_GAMECORE_LEVELOBJECTNAVMAPBAKEDINFO_METHOD_2_139CA547CB6E6FA6_OFFSET UNITYSDK_OFFSET(0x18A3B1A0)
#define RPG_GAMECORE_LEVELOBJECTNAVMAPBAKEDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18A3B300)
