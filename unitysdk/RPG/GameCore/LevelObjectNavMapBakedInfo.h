...
#define RPG_GAMECORE_LEVELOBJECTNAVMAPBAKEDINFO_METHOD_2_139CA547CB6E6FA6_OFFSET UNITYSDK_OFFSET(0x16BB57D0)
#define RPG_GAMECORE_LEVELOBJECTNAVMAPBAKEDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16BB5930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelObjectNavMapBakedInfo_TypeDefinitionIndex = 15449;
