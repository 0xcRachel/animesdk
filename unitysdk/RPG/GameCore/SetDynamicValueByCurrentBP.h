...
#define RPG_GAMECORE_SETDYNAMICVALUEBYCURRENTBP_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x16F231B0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCURRENTBP_METHOD_4_D4F9E2EB196B42F6_OFFSET UNITYSDK_OFFSET(0x16F18FE0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCURRENTBP_METHOD_4_F1975248C08BDEFA_OFFSET UNITYSDK_OFFSET(0x16F23130)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCURRENTBP__CTOR_OFFSET UNITYSDK_OFFSET(0x16F18F80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByCurrentBP_TypeDefinitionIndex = 20764;
