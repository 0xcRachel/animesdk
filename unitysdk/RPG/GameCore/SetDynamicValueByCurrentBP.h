...
#define RPG_GAMECORE_SETDYNAMICVALUEBYCURRENTBP_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1A1FB4D0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCURRENTBP_METHOD_4_D4F9E2EB196B42F6_OFFSET UNITYSDK_OFFSET(0x1A1F34E0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCURRENTBP_METHOD_4_F1975248C08BDEFA_OFFSET UNITYSDK_OFFSET(0x1A1FB450)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCURRENTBP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1F3480)
