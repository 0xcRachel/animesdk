...
#define RPG_GAMECORE_ADVMODIFIERLISTENPHOTOGRAPH_METHOD_3_B42DE3B710F2DFCE_OFFSET UNITYSDK_OFFSET(0x18C4D9B0)
#define RPG_GAMECORE_ADVMODIFIERLISTENPHOTOGRAPH_METHOD_3_F95FB9A08E0340E2_OFFSET UNITYSDK_OFFSET(0x18C4D930)
#define RPG_GAMECORE_ADVMODIFIERLISTENPHOTOGRAPH__CTOR_OFFSET UNITYSDK_OFFSET(0x18C4D980)
