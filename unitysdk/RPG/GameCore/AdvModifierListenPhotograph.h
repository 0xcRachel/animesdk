...
#define RPG_GAMECORE_ADVMODIFIERLISTENPHOTOGRAPH_METHOD_3_B42DE3B710F2DFCE_OFFSET UNITYSDK_OFFSET(0x1683A570)
#define RPG_GAMECORE_ADVMODIFIERLISTENPHOTOGRAPH_METHOD_3_F95FB9A08E0340E2_OFFSET UNITYSDK_OFFSET(0x1683A4F0)
#define RPG_GAMECORE_ADVMODIFIERLISTENPHOTOGRAPH__CTOR_OFFSET UNITYSDK_OFFSET(0x1683A540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvModifierListenPhotograph_TypeDefinitionIndex = 19387;
