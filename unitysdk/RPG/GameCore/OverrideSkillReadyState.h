...
#define RPG_GAMECORE_OVERRIDESKILLREADYSTATE_METHOD_3_AC97774FB7ADC773_OFFSET UNITYSDK_OFFSET(0x18EF7DC0)
#define RPG_GAMECORE_OVERRIDESKILLREADYSTATE_METHOD_3_B1DB9C67C4B22D60_OFFSET UNITYSDK_OFFSET(0x18EF7D40)
#define RPG_GAMECORE_OVERRIDESKILLREADYSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18EF7D90)
