...
#define RPG_GAMECORE_OVERRIDESKILLREADYSTATE_METHOD_3_AC97774FB7ADC773_OFFSET UNITYSDK_OFFSET(0x16D12180)
#define RPG_GAMECORE_OVERRIDESKILLREADYSTATE_METHOD_3_B1DB9C67C4B22D60_OFFSET UNITYSDK_OFFSET(0x16D12100)
#define RPG_GAMECORE_OVERRIDESKILLREADYSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16D12150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OverrideSkillReadyState_TypeDefinitionIndex = 20490;
