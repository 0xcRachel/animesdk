...
#define RPG_GAMECORE_GLOBALMAININTENSITYEFFECTAUTOREVERT_METHOD_3_062B4C9387FBEBD4_OFFSET UNITYSDK_OFFSET(0x1955BD60)
#define RPG_GAMECORE_GLOBALMAININTENSITYEFFECTAUTOREVERT_METHOD_3_F5823287AD12521F_OFFSET UNITYSDK_OFFSET(0x1955BDE0)
#define RPG_GAMECORE_GLOBALMAININTENSITYEFFECTAUTOREVERT__CTOR_OFFSET UNITYSDK_OFFSET(0x1955BDB0)
