...
#define RPG_GAMECORE_UNIVERSALHOTFIXBASEPREDICATE_METHOD_4_97D2EAC174F075A4_OFFSET UNITYSDK_OFFSET(0x1713D670)
#define RPG_GAMECORE_UNIVERSALHOTFIXBASEPREDICATE_METHOD_4_B8B4575AB9CB3BDD_OFFSET UNITYSDK_OFFSET(0x1713D2D0)
#define RPG_GAMECORE_UNIVERSALHOTFIXBASEPREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1713D620)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UniversalHotFixBasePredicate_TypeDefinitionIndex = 21027;
