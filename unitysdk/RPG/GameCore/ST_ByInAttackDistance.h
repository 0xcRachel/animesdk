...
#define RPG_GAMECORE_ST_BYINATTACKDISTANCE_METHOD_4_301990978E85906C_OFFSET UNITYSDK_OFFSET(0x176A8880)
#define RPG_GAMECORE_ST_BYINATTACKDISTANCE_METHOD_4_CE9321DFFBDC3826_OFFSET UNITYSDK_OFFSET(0x176A8950)
#define RPG_GAMECORE_ST_BYINATTACKDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x176A8900)
