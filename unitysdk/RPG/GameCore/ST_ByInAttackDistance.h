...
#define RPG_GAMECORE_ST_BYINATTACKDISTANCE_METHOD_4_301990978E85906C_OFFSET UNITYSDK_OFFSET(0x16EF0F10)
#define RPG_GAMECORE_ST_BYINATTACKDISTANCE_METHOD_4_CE9321DFFBDC3826_OFFSET UNITYSDK_OFFSET(0x16EF0FE0)
#define RPG_GAMECORE_ST_BYINATTACKDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x16EF0F90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByInAttackDistance_TypeDefinitionIndex = 17834;
