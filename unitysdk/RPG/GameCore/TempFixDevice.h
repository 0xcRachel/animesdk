...
#define RPG_GAMECORE_TEMPFIXDEVICE_METHOD_2_D4E39F6680834963_OFFSET UNITYSDK_OFFSET(0x170EDE00)
#define RPG_GAMECORE_TEMPFIXDEVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x170EDED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TempFixDevice_TypeDefinitionIndex = 16396;
