...
#define RPG_GAMECORE_TARGETFETCHENEMYINATTACKRANGE_METHOD_4_4AD3EAD1F03E3CF3_OFFSET UNITYSDK_OFFSET(0x16FDD4C0)
#define RPG_GAMECORE_TARGETFETCHENEMYINATTACKRANGE_METHOD_4_5335833A85E47995_OFFSET UNITYSDK_OFFSET(0x16FD6D80)
#define RPG_GAMECORE_TARGETFETCHENEMYINATTACKRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD6D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchEnemyInAttackRange_TypeDefinitionIndex = 21607;
