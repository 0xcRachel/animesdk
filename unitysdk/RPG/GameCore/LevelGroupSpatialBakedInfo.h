...
#define RPG_GAMECORE_LEVELGROUPSPATIALBAKEDINFO_METHOD_2_DBA53ECAAF203576_OFFSET UNITYSDK_OFFSET(0x18E6A1A0)
#define RPG_GAMECORE_LEVELGROUPSPATIALBAKEDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18E6C2C0)
