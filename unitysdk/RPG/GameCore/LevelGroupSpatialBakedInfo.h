...
#define RPG_GAMECORE_LEVELGROUPSPATIALBAKEDINFO_METHOD_2_A282188E82ADF1BC_OFFSET UNITYSDK_OFFSET(0x1734C6E0)
#define RPG_GAMECORE_LEVELGROUPSPATIALBAKEDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1734E8A0)
