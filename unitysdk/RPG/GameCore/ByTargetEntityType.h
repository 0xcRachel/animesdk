...
#define RPG_GAMECORE_BYTARGETENTITYTYPE_METHOD_4_0DB6079465FD2B06_OFFSET UNITYSDK_OFFSET(0x1693E9D0)
#define RPG_GAMECORE_BYTARGETENTITYTYPE_METHOD_4_D9C5CFA706D6936A_OFFSET UNITYSDK_OFFSET(0x1693E8F0)
#define RPG_GAMECORE_BYTARGETENTITYTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1693E970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByTargetEntityType_TypeDefinitionIndex = 20671;
