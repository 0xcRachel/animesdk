...
#define RPG_GAMECORE_TARGETFETCHNORMALPAM_METHOD_4_9DD4F0CBD20A908B_OFFSET UNITYSDK_OFFSET(0x16FD8780)
#define RPG_GAMECORE_TARGETFETCHNORMALPAM_METHOD_4_B9DDACC7A11B543D_OFFSET UNITYSDK_OFFSET(0x16FDE410)
#define RPG_GAMECORE_TARGETFETCHNORMALPAM__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD8730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchNormalPam_TypeDefinitionIndex = 21583;
