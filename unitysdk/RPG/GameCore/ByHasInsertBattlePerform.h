...
#define RPG_GAMECORE_BYHASINSERTBATTLEPERFORM_METHOD_4_44169F7855CD8E92_OFFSET UNITYSDK_OFFSET(0x169272B0)
#define RPG_GAMECORE_BYHASINSERTBATTLEPERFORM_METHOD_4_7021D5950C7F2BB8_OFFSET UNITYSDK_OFFSET(0x169271E0)
#define RPG_GAMECORE_BYHASINSERTBATTLEPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x16927260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHasInsertBattlePerform_TypeDefinitionIndex = 21043;
