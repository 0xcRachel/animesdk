...
#define RPG_GAMECORE_BATTLESEEKONBGM_METHOD_3_E0657B85652BD8BA_OFFSET UNITYSDK_OFFSET(0x16FF5EC0)
#define RPG_GAMECORE_BATTLESEEKONBGM_METHOD_3_E9B88A87A5B62FB3_OFFSET UNITYSDK_OFFSET(0x16FF5F40)
#define RPG_GAMECORE_BATTLESEEKONBGM__CTOR_OFFSET UNITYSDK_OFFSET(0x16FF5F10)
