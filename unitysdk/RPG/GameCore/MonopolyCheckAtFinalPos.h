...
#define RPG_GAMECORE_MONOPOLYCHECKATFINALPOS_METHOD_3_80672602EDAD93C7_OFFSET UNITYSDK_OFFSET(0x196B3280)
#define RPG_GAMECORE_MONOPOLYCHECKATFINALPOS_METHOD_3_94051079C54CBE31_OFFSET UNITYSDK_OFFSET(0x196B3200)
#define RPG_GAMECORE_MONOPOLYCHECKATFINALPOS__CTOR_OFFSET UNITYSDK_OFFSET(0x196B3250)
