...
#define RPG_GAMECORE_ROGUECONDTRUECONFIG_METHOD_6_67BC343C6C6FB9C0_OFFSET UNITYSDK_OFFSET(0x176012B0)
#define RPG_GAMECORE_ROGUECONDTRUECONFIG_METHOD_6_EAFC963C5BFB84C4_OFFSET UNITYSDK_OFFSET(0x176010F0)
#define RPG_GAMECORE_ROGUECONDTRUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176011F0)
