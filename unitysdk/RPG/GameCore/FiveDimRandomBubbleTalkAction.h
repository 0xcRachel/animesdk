...
#define RPG_GAMECORE_FIVEDIMRANDOMBUBBLETALKACTION_METHOD_3_67EC433F0F799BEE_OFFSET UNITYSDK_OFFSET(0x16AD0CF0)
#define RPG_GAMECORE_FIVEDIMRANDOMBUBBLETALKACTION_METHOD_3_9C2859E6B82E3D82_OFFSET UNITYSDK_OFFSET(0x16AD0C80)
#define RPG_GAMECORE_FIVEDIMRANDOMBUBBLETALKACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16AD0CD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimRandomBubbleTalkAction_TypeDefinitionIndex = 16836;
