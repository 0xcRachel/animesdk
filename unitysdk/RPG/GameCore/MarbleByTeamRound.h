...
#define RPG_GAMECORE_MARBLEBYTEAMROUND_METHOD_4_7FFA11A9DD5CC16B_OFFSET UNITYSDK_OFFSET(0x16C3B870)
#define RPG_GAMECORE_MARBLEBYTEAMROUND_METHOD_4_EABE05CC888E833B_OFFSET UNITYSDK_OFFSET(0x16C3B790)
#define RPG_GAMECORE_MARBLEBYTEAMROUND__CTOR_OFFSET UNITYSDK_OFFSET(0x16C3B820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleByTeamRound_TypeDefinitionIndex = 15207;
