...
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_CLEAR_OFFSET UNITYSDK_OFFSET(0xA4AC480)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA4AC4D0)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA4AC520)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_GET_FINISHSOURCE_OFFSET UNITYSDK_OFFSET(0xA4AC590)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_GET_SILENCE_OFFSET UNITYSDK_OFFSET(0xA4AC5B0)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_GET_TURNINSERTABILITYINSTANCE_OFFSET UNITYSDK_OFFSET(0xA4AC570)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_INIT_OFFSET UNITYSDK_OFFSET(0xA4AC420)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_SET_FINISHSOURCE_OFFSET UNITYSDK_OFFSET(0xA4AC5A0)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_SET_SILENCE_OFFSET UNITYSDK_OFFSET(0xA4AC5C0)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_SET_TURNINSERTABILITYINSTANCE_OFFSET UNITYSDK_OFFSET(0xA4AC580)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT__CTOR_OFFSET UNITYSDK_OFFSET(0xA4AC5D0)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0xA4AC5E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelSingleInsertAbilityFinishOrAbort_TypeDefinitionIndex = 44580;
