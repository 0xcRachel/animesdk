...
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_CLEAR_OFFSET UNITYSDK_OFFSET(0x1920A280)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1920A2D0)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1920A320)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_GET_FINISHSOURCE_OFFSET UNITYSDK_OFFSET(0x1920A390)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_GET_SILENCE_OFFSET UNITYSDK_OFFSET(0x1920A3B0)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_GET_TURNINSERTABILITYINSTANCE_OFFSET UNITYSDK_OFFSET(0x1920A370)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_INIT_OFFSET UNITYSDK_OFFSET(0x1920A220)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_SET_FINISHSOURCE_OFFSET UNITYSDK_OFFSET(0x1920A3A0)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_SET_SILENCE_OFFSET UNITYSDK_OFFSET(0x1920A3C0)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_SET_TURNINSERTABILITYINSTANCE_OFFSET UNITYSDK_OFFSET(0x1920A380)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT__CTOR_OFFSET UNITYSDK_OFFSET(0x1920A3D0)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0x1920A3E0)
