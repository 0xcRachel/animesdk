...
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_CLEAR_OFFSET UNITYSDK_OFFSET(0xA99D0B0)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA99D100)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA99D150)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_GET_FINISHSOURCE_OFFSET UNITYSDK_OFFSET(0xA99D1C0)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_GET_SILENCE_OFFSET UNITYSDK_OFFSET(0xA99D1E0)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_GET_TURNINSERTABILITYINSTANCE_OFFSET UNITYSDK_OFFSET(0xA99D1A0)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_INIT_OFFSET UNITYSDK_OFFSET(0xA99D050)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_SET_FINISHSOURCE_OFFSET UNITYSDK_OFFSET(0xA99D1D0)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_SET_SILENCE_OFFSET UNITYSDK_OFFSET(0xA99D1F0)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_SET_TURNINSERTABILITYINSTANCE_OFFSET UNITYSDK_OFFSET(0xA99D1B0)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT__CTOR_OFFSET UNITYSDK_OFFSET(0xA99D200)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0xA99D210)
