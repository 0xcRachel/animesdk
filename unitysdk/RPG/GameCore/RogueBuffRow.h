...
#define RPG_GAMECORE_ROGUEBUFFROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16E1BC30)
#define RPG_GAMECORE_ROGUEBUFFROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16E1D480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueBuffRow_TypeDefinitionIndex = 13383;
	...
	public:
		...
		::RPG::GameCore::RogueBuffAeonType BattleEventBuffType; // 0x38
		::System::UInt32 ActivityModuleID; // 0x3C
		::System::Boolean IsShow; // 0x40
		::RPG::GameCore::RogueBuffCategory RogueBuffCategory; // 0x44
