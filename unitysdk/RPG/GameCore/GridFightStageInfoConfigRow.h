...
#define RPG_GAMECORE_GRIDFIGHTSTAGEINFOCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17299110)
#define RPG_GAMECORE_GRIDFIGHTSTAGEINFOCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x172997B0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 ThresholdPassBasicGlobalHPLose; // 0x28
		::System::UInt32 ThresholdFailGlobalHPLose; // 0x2C
		::System::UInt32 BossGlobalHPLose; // 0x30
		::System::UInt32 MinionProgressValue; // 0x34
		::System::UInt32 StageRuleID; // 0x38
		...
		::System::UInt32 WaveIndex; // 0x60
		::RPG::GameCore::FixPoint TotalTurn; // 0x68
		::RPG::GameCore::FixPoint ThresholdPosition; // 0x70
		::System::UInt32 MinionGlobalHPLose; // 0x78
		::System::UInt32 BossProgressValue; // 0x7C
