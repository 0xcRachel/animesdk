...
#define RPG_GAMECORE_GRIDFIGHTSTAGEINFOCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B4AA10)
#define RPG_GAMECORE_GRIDFIGHTSTAGEINFOCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B4B0B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightStageInfoConfigRow_TypeDefinitionIndex = 10738;
	...
	public:
		...
		::System::UInt32 EliteProgressValue; // 0x28
		::System::UInt32 MinionGlobalHPLose; // 0x2C
		...
		::System::UInt32 BossGlobalHPLose; // 0x44
		::System::UInt32 WaveIndex; // 0x48
		::System::UInt32 MinionProgressValue; // 0x4C
		::RPG::Client::TextID StageDescription; // 0x50
		::System::UInt32 EliteGlobalHPLose; // 0x60
		::System::UInt32 StageID; // 0x64
		::System::UInt32 StageRuleID; // 0x68
		::System::UInt32 BossProgressValue; // 0x6C
