...
#define RPG_GAMECORE_MAPPROPCONDITIONCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17393020)
#define RPG_GAMECORE_MAPPROPCONDITIONCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17393730)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 MiniMapIconID; // 0x28
