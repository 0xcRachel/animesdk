...
#define RPG_GAMECORE_GAMEPLAYGUIDETABCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19CAA260)
#define RPG_GAMECORE_GAMEPLAYGUIDETABCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19CAB0E0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 IntroDataID; // 0x38
