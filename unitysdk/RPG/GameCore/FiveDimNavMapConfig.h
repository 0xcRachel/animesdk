...
#define RPG_GAMECORE_FIVEDIMNAVMAPCONFIG_METHOD_2_3C12E304F9717E0D_OFFSET UNITYSDK_OFFSET(0x16ACA9A0)
#define RPG_GAMECORE_FIVEDIMNAVMAPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16ACAAE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimNavMapConfig_TypeDefinitionIndex = 16618;
