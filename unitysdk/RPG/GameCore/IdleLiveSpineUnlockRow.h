...
#define RPG_GAMECORE_IDLELIVESPINEUNLOCKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19ADB480)
#define RPG_GAMECORE_IDLELIVESPINEUNLOCKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19ADB5C0)
