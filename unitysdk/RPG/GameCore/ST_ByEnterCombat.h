...
#define RPG_GAMECORE_ST_BYENTERCOMBAT_METHOD_4_471A5980B0F9EFD4_OFFSET UNITYSDK_OFFSET(0x176A6FF0)
#define RPG_GAMECORE_ST_BYENTERCOMBAT_METHOD_4_DF058C859678E4DE_OFFSET UNITYSDK_OFFSET(0x176A70C0)
#define RPG_GAMECORE_ST_BYENTERCOMBAT__CTOR_OFFSET UNITYSDK_OFFSET(0x176A7070)
