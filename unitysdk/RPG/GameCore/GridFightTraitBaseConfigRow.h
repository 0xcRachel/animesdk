...
#define RPG_GAMECORE_GRIDFIGHTTRAITBASECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B4D5B0)
#define RPG_GAMECORE_GRIDFIGHTTRAITBASECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B4DB70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightTraitBaseConfigRow_TypeDefinitionIndex = 12432;
	...
	public:
		...
		::Il2CppArray<::RPG::GameCore::FixPoint>* BaseDescParamList; // 0x30
		::Il2CppArray<::System::UInt32>* BEIDList; // 0x38
		::System::Collections::Generic::List_1<::System::UInt32>* TraitLayerList; // 0x40
		::Il2CppArray<::System::UInt32>* TraitEffectList; // 0x48
		::RPG::Client::TextID TraitBaseSimpleDesc; // 0x50
		::System::UInt32 TraitSortPriority; // 0x60
		::RPG::Client::TextID TraitName; // 0x68
		::RPG::GameCore::GridFightTraitType TraitType; // 0x78
		::System::UInt32 SeasonID; // 0x7C
