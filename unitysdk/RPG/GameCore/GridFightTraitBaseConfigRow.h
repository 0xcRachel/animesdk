...
#define RPG_GAMECORE_GRIDFIGHTTRAITBASECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A1C2500)
#define RPG_GAMECORE_GRIDFIGHTTRAITBASECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1C2AB0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Collections::Generic::List_1<::System::UInt32>* TraitLayerList; // 0x20
		...
		::System::UInt32 TraitSortPriority; // 0x78
		::RPG::GameCore::GridFightTraitType TraitType; // 0x7C
		::System::UInt32 ID; // 0x80
		::RPG::GameCore::GridFightActivationType ActivationType; // 0x84
		::RPG::Client::TextID TraitName; // 0x88
