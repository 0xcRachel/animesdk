...
#define RPG_GAMECORE_GRIDFIGHTTRAITBASECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1729BCB0)
#define RPG_GAMECORE_GRIDFIGHTTRAITBASECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1729C270)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::GridFightTraitType TraitType; // 0x80
