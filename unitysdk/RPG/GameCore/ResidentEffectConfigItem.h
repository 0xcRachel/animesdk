...
#define RPG_GAMECORE_RESIDENTEFFECTCONFIGITEM_METHOD_2_2B2ABB4F2ED95C12_OFFSET UNITYSDK_OFFSET(0x1902FF50)
#define RPG_GAMECORE_RESIDENTEFFECTCONFIGITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x19030090)
