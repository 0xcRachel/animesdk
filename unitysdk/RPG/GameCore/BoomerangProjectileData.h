...
#define RPG_GAMECORE_BOOMERANGPROJECTILEDATA_METHOD_3_D585D8F9F99A9FC3_OFFSET UNITYSDK_OFFSET(0x168F3020)
#define RPG_GAMECORE_BOOMERANGPROJECTILEDATA_METHOD_3_D65D46D7FD9AC52B_OFFSET UNITYSDK_OFFSET(0x168F3090)
#define RPG_GAMECORE_BOOMERANGPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x168F3070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BoomerangProjectileData_TypeDefinitionIndex = 14234;
