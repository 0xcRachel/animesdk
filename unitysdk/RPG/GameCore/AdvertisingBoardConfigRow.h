...
#define RPG_GAMECORE_ADVERTISINGBOARDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18C78640)
#define RPG_GAMECORE_ADVERTISINGBOARDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18C78880)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean IsPlayerInvolved; // 0x14
		::System::Boolean IsSwitch; // 0x15
