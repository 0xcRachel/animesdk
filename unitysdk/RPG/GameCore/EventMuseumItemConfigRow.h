...
#define RPG_GAMECORE_EVENTMUSEUMITEMCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1945A190)
#define RPG_GAMECORE_EVENTMUSEUMITEMCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1945A8D0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean IsTargetReward; // 0x35
