...
#define RPG_GAMECORE_EVENTMUSEUMITEMCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19D86DD0)
#define RPG_GAMECORE_EVENTMUSEUMITEMCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19D87530)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 MuseumItemID; // 0x30
