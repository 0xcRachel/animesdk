...
#define RPG_GAMECORE_CAKERACEBUFFCONFIG_METHOD_2_867837F8BCC35FDE_OFFSET UNITYSDK_OFFSET(0x1705D250)
#define RPG_GAMECORE_CAKERACEBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1705D4F0)
