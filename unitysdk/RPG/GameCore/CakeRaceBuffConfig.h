...
#define RPG_GAMECORE_CAKERACEBUFFCONFIG_METHOD_2_867837F8BCC35FDE_OFFSET UNITYSDK_OFFSET(0x19A7FB40)
#define RPG_GAMECORE_CAKERACEBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19A7FDE0)
