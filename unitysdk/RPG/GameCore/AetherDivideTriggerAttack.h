...
#define RPG_GAMECORE_AETHERDIVIDETRIGGERATTACK_METHOD_4_99AF1A8AE3653ACB_OFFSET UNITYSDK_OFFSET(0x18BB7D30)
#define RPG_GAMECORE_AETHERDIVIDETRIGGERATTACK_METHOD_4_F2F81C45D1283741_OFFSET UNITYSDK_OFFSET(0x18BC5D10)
#define RPG_GAMECORE_AETHERDIVIDETRIGGERATTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18BB7CC0)
