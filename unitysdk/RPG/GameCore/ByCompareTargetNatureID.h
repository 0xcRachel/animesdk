...
#define RPG_GAMECORE_BYCOMPARETARGETNATUREID_METHOD_4_21350C33CE107D89_OFFSET UNITYSDK_OFFSET(0x1691E410)
#define RPG_GAMECORE_BYCOMPARETARGETNATUREID_METHOD_4_676871315DF5EF41_OFFSET UNITYSDK_OFFSET(0x1691E340)
#define RPG_GAMECORE_BYCOMPARETARGETNATUREID__CTOR_OFFSET UNITYSDK_OFFSET(0x1691E3C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareTargetNatureID_TypeDefinitionIndex = 20669;
