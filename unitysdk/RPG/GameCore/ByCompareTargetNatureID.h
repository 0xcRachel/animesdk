...
#define RPG_GAMECORE_BYCOMPARETARGETNATUREID_METHOD_4_21350C33CE107D89_OFFSET UNITYSDK_OFFSET(0x18FF8D10)
#define RPG_GAMECORE_BYCOMPARETARGETNATUREID_METHOD_4_3277D7E0D0FAA8E3_OFFSET UNITYSDK_OFFSET(0x18FF8EC0)
#define RPG_GAMECORE_BYCOMPARETARGETNATUREID_METHOD_4_5DD0BAE5CA009058_OFFSET UNITYSDK_OFFSET(0x18FF8F40)
#define RPG_GAMECORE_BYCOMPARETARGETNATUREID_METHOD_4_676871315DF5EF41_OFFSET UNITYSDK_OFFSET(0x18FF8C40)
#define RPG_GAMECORE_BYCOMPARETARGETNATUREID__CTOR_OFFSET UNITYSDK_OFFSET(0x18FF8CC0)
