...
#define RPG_GAMECORE_STAMINAEXCHANGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x193440D0)
#define RPG_GAMECORE_STAMINAEXCHANGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x193446A0)
