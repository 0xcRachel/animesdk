...
#define RPG_GAMECORE_ILBATTLEMONSTERCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18A84BE0)
#define RPG_GAMECORE_ILBATTLEMONSTERCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18A854B0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 OriginalTemplateID; // 0x7C
