...
#define RPG_GAMECORE_MARBLESETNEXTSCORE_METHOD_3_04BB698152AA94AF_OFFSET UNITYSDK_OFFSET(0x18C1FA50)
#define RPG_GAMECORE_MARBLESETNEXTSCORE_METHOD_3_4A6E79A774318A5D_OFFSET UNITYSDK_OFFSET(0x18C1FBE0)
#define RPG_GAMECORE_MARBLESETNEXTSCORE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C1FB90)
