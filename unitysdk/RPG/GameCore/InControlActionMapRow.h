...
#define RPG_GAMECORE_INCONTROLACTIONMAPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18888E30)
#define RPG_GAMECORE_INCONTROLACTIONMAPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x188895C0)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::String* defaultMouseType; // 0x10
