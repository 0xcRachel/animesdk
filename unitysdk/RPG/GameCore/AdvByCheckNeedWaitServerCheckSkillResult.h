...
#define RPG_GAMECORE_ADVBYCHECKNEEDWAITSERVERCHECKSKILLRESULT_METHOD_4_2EA159F312C36BBB_OFFSET UNITYSDK_OFFSET(0x167C2550)
#define RPG_GAMECORE_ADVBYCHECKNEEDWAITSERVERCHECKSKILLRESULT_METHOD_4_CF961F1182F6AC91_OFFSET UNITYSDK_OFFSET(0x167C2620)
#define RPG_GAMECORE_ADVBYCHECKNEEDWAITSERVERCHECKSKILLRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x167C25D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByCheckNeedWaitServerCheckSkillResult_TypeDefinitionIndex = 17981;
