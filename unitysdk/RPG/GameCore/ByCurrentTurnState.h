...
#define RPG_GAMECORE_BYCURRENTTURNSTATE_METHOD_4_033512C3B8CB9C78_OFFSET UNITYSDK_OFFSET(0x190036F0)
#define RPG_GAMECORE_BYCURRENTTURNSTATE_METHOD_4_0D9245C139B2FB77_OFFSET UNITYSDK_OFFSET(0x190039D0)
#define RPG_GAMECORE_BYCURRENTTURNSTATE_METHOD_4_3F07556FA5CA504B_OFFSET UNITYSDK_OFFSET(0x19003950)
#define RPG_GAMECORE_BYCURRENTTURNSTATE_METHOD_4_A95F28C65DA98926_OFFSET UNITYSDK_OFFSET(0x190037C0)
#define RPG_GAMECORE_BYCURRENTTURNSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19003770)
