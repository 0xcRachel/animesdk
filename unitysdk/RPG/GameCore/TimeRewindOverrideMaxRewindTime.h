...
#define RPG_GAMECORE_TIMEREWINDOVERRIDEMAXREWINDTIME_METHOD_3_0CAAFECD30EF1AC5_OFFSET UNITYSDK_OFFSET(0x178B4190)
#define RPG_GAMECORE_TIMEREWINDOVERRIDEMAXREWINDTIME_METHOD_3_EC45CCA3915C2292_OFFSET UNITYSDK_OFFSET(0x1789DDB0)
#define RPG_GAMECORE_TIMEREWINDOVERRIDEMAXREWINDTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1789DD80)
