...
#define RPG_GAMECORE_EXITTRANSITIONLOADINGUI_METHOD_3_6E15D35AC5BF59F4_OFFSET UNITYSDK_OFFSET(0x16A86E80)
#define RPG_GAMECORE_EXITTRANSITIONLOADINGUI_METHOD_3_9547DD2EBB5C4D08_OFFSET UNITYSDK_OFFSET(0x16A86D70)
#define RPG_GAMECORE_EXITTRANSITIONLOADINGUI__CTOR_OFFSET UNITYSDK_OFFSET(0x16A86E50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ExitTransitionLoadingUI_TypeDefinitionIndex = 19351;
