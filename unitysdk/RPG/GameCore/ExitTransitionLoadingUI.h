...
#define RPG_GAMECORE_EXITTRANSITIONLOADINGUI_METHOD_3_6E15D35AC5BF59F4_OFFSET UNITYSDK_OFFSET(0x1A3F9D30)
#define RPG_GAMECORE_EXITTRANSITIONLOADINGUI_METHOD_3_9547DD2EBB5C4D08_OFFSET UNITYSDK_OFFSET(0x1A3F9C20)
#define RPG_GAMECORE_EXITTRANSITIONLOADINGUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3F9D00)
