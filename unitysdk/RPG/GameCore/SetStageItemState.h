...
#define RPG_GAMECORE_SETSTAGEITEMSTATE_METHOD_3_70C8D1873FD60935_OFFSET UNITYSDK_OFFSET(0x1938C1B0)
#define RPG_GAMECORE_SETSTAGEITEMSTATE_METHOD_3_E8F3708A403D8E33_OFFSET UNITYSDK_OFFSET(0x1938C230)
#define RPG_GAMECORE_SETSTAGEITEMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1938C200)
