...
#define RPG_GAMECORE_SETSTAGEITEMSTATE_METHOD_3_70C8D1873FD60935_OFFSET UNITYSDK_OFFSET(0x16F3E290)
#define RPG_GAMECORE_SETSTAGEITEMSTATE_METHOD_3_E8F3708A403D8E33_OFFSET UNITYSDK_OFFSET(0x16F3E310)
#define RPG_GAMECORE_SETSTAGEITEMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F3E2E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetStageItemState_TypeDefinitionIndex = 19907;
