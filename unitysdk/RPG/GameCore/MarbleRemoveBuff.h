...
#define RPG_GAMECORE_MARBLEREMOVEBUFF_METHOD_3_2C94E9117EEAD3A0_OFFSET UNITYSDK_OFFSET(0x1997C660)
#define RPG_GAMECORE_MARBLEREMOVEBUFF_METHOD_3_4044CFFDFF7EFF0D_OFFSET UNITYSDK_OFFSET(0x1997C580)
#define RPG_GAMECORE_MARBLEREMOVEBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x1997C610)
