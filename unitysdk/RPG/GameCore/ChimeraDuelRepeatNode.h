...
#define RPG_GAMECORE_CHIMERADUELREPEATNODE_METHOD_3_4D0FF560C8B2059C_OFFSET UNITYSDK_OFFSET(0x169970A0)
#define RPG_GAMECORE_CHIMERADUELREPEATNODE_METHOD_3_B3310FEF4F689997_OFFSET UNITYSDK_OFFSET(0x16997180)
#define RPG_GAMECORE_CHIMERADUELREPEATNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x16997130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelRepeatNode_TypeDefinitionIndex = 14424;
