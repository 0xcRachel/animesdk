...
#define RPG_GAMECORE_CHIMERADUELREPEATNODE_METHOD_3_4D0FF560C8B2059C_OFFSET UNITYSDK_OFFSET(0x170B8FB0)
#define RPG_GAMECORE_CHIMERADUELREPEATNODE_METHOD_3_B3310FEF4F689997_OFFSET UNITYSDK_OFFSET(0x170B9090)
#define RPG_GAMECORE_CHIMERADUELREPEATNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x170B9040)
