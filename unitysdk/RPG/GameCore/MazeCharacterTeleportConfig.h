...
#define RPG_GAMECORE_MAZECHARACTERTELEPORTCONFIG_METHOD_2_50061DB4955E4DE6_OFFSET UNITYSDK_OFFSET(0x18C45B90)
#define RPG_GAMECORE_MAZECHARACTERTELEPORTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18C45D90)
