...
#define RPG_GAMECORE_ADVENTITYENABLEROOTDAMPER_METHOD_3_E86425E7B74CD1B1_OFFSET UNITYSDK_OFFSET(0x18DC2750)
#define RPG_GAMECORE_ADVENTITYENABLEROOTDAMPER_METHOD_3_FFBBBBDCCD06F60A_OFFSET UNITYSDK_OFFSET(0x18DC2820)
#define RPG_GAMECORE_ADVENTITYENABLEROOTDAMPER__CTOR_OFFSET UNITYSDK_OFFSET(0x18DC27D0)
