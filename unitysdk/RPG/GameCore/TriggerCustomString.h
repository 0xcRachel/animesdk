...
#define RPG_GAMECORE_TRIGGERCUSTOMSTRING_GET_ISCLIENTONLY_OFFSET UNITYSDK_OFFSET(0x19111B00)
#define RPG_GAMECORE_TRIGGERCUSTOMSTRING_METHOD_3_0580BEEFC66C2ECC_OFFSET UNITYSDK_OFFSET(0x19111710)
#define RPG_GAMECORE_TRIGGERCUSTOMSTRING_METHOD_3_84236F4B2910CEA0_OFFSET UNITYSDK_OFFSET(0x191118D0)
#define RPG_GAMECORE_TRIGGERCUSTOMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x191118A0)
