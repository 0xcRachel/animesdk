...
#define RPG_GAMECORE_TOGGLEUITOP_METHOD_3_23B9F6B3375735B6_OFFSET UNITYSDK_OFFSET(0x170FA6C0)
#define RPG_GAMECORE_TOGGLEUITOP_METHOD_3_41CE313E932D932D_OFFSET UNITYSDK_OFFSET(0x170FA790)
#define RPG_GAMECORE_TOGGLEUITOP__CTOR_OFFSET UNITYSDK_OFFSET(0x170FA740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ToggleUITop_TypeDefinitionIndex = 20833;
