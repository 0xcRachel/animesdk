...
#define RPG_GAMECORE_RESETTARGETLISTINDEX_METHOD_3_3FC290995FF3DCA5_OFFSET UNITYSDK_OFFSET(0x1A2EE7B0)
#define RPG_GAMECORE_RESETTARGETLISTINDEX_METHOD_3_D9C4AFB56CE4CDD9_OFFSET UNITYSDK_OFFSET(0x1A2EE8C0)
#define RPG_GAMECORE_RESETTARGETLISTINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2EE890)
