...
#define RPG_GAMECORE_CHARACTEREMOCONFIG_METHOD_2_6C3A980863AF0727_OFFSET UNITYSDK_OFFSET(0x1696E340)
#define RPG_GAMECORE_CHARACTEREMOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1696E520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterEmoConfig_TypeDefinitionIndex = 14869;
