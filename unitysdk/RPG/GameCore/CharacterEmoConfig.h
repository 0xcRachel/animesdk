...
#define RPG_GAMECORE_CHARACTEREMOCONFIG_METHOD_2_EF0F1CCF24E7E51E_OFFSET UNITYSDK_OFFSET(0x1707F9A0)
#define RPG_GAMECORE_CHARACTEREMOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1707FBA0)
