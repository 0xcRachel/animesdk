...
#define RPG_GAMECORE_BLOCKGRASSDATA_METHOD_2_C43F21D632E64B3D_OFFSET UNITYSDK_OFFSET(0x168EC060)
#define RPG_GAMECORE_BLOCKGRASSDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x168EC1F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BlockGrassData_TypeDefinitionIndex = 17112;
