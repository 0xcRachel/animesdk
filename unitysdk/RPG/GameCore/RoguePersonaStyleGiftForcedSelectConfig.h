...
#define RPG_GAMECORE_ROGUEPERSONASTYLEGIFTFORCEDSELECTCONFIG_METHOD_2_109363217ED775BE_OFFSET UNITYSDK_OFFSET(0x1AE58C20)
#define RPG_GAMECORE_ROGUEPERSONASTYLEGIFTFORCEDSELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE58C60)
