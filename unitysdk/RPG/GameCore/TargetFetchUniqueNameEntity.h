...
#define RPG_GAMECORE_TARGETFETCHUNIQUENAMEENTITY_METHOD_4_B2F009FEB93A24E1_OFFSET UNITYSDK_OFFSET(0x16FDFFA0)
#define RPG_GAMECORE_TARGETFETCHUNIQUENAMEENTITY_METHOD_4_CAECCF00305CA616_OFFSET UNITYSDK_OFFSET(0x16FE0100)
#define RPG_GAMECORE_TARGETFETCHUNIQUENAMEENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE00B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchUniqueNameEntity_TypeDefinitionIndex = 21647;
