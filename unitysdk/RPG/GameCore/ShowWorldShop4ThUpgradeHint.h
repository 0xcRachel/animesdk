...
#define RPG_GAMECORE_SHOWWORLDSHOP4THUPGRADEHINT_METHOD_3_80017438CFD7776B_OFFSET UNITYSDK_OFFSET(0x1771C6E0)
#define RPG_GAMECORE_SHOWWORLDSHOP4THUPGRADEHINT_METHOD_3_F209B95F3BF3DD84_OFFSET UNITYSDK_OFFSET(0x1771C760)
#define RPG_GAMECORE_SHOWWORLDSHOP4THUPGRADEHINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1771C730)
