...
#define RPG_GAMECORE_ADVSETWAVINGBLOCKCONTROL_METHOD_3_E0E6F386D341518A_OFFSET UNITYSDK_OFFSET(0x1684A040)
#define RPG_GAMECORE_ADVSETWAVINGBLOCKCONTROL_METHOD_3_FF42F42F7C698ED9_OFFSET UNITYSDK_OFFSET(0x1684A0C0)
#define RPG_GAMECORE_ADVSETWAVINGBLOCKCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1684A090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetWavingBlockControl_TypeDefinitionIndex = 19885;
