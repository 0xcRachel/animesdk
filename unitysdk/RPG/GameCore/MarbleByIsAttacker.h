...
#define RPG_GAMECORE_MARBLEBYISATTACKER_METHOD_4_B2A897558D566C6F_OFFSET UNITYSDK_OFFSET(0x16C3AC80)
#define RPG_GAMECORE_MARBLEBYISATTACKER_METHOD_4_D6F8E8E15D90D4AF_OFFSET UNITYSDK_OFFSET(0x16C3AD60)
#define RPG_GAMECORE_MARBLEBYISATTACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x16C3AD10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleByIsAttacker_TypeDefinitionIndex = 15190;
