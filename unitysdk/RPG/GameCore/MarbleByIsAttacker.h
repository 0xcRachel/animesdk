...
#define RPG_GAMECORE_MARBLEBYISATTACKER_METHOD_4_B2A897558D566C6F_OFFSET UNITYSDK_OFFSET(0x1739FAF0)
#define RPG_GAMECORE_MARBLEBYISATTACKER_METHOD_4_D6F8E8E15D90D4AF_OFFSET UNITYSDK_OFFSET(0x1739FBD0)
#define RPG_GAMECORE_MARBLEBYISATTACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1739FB80)
