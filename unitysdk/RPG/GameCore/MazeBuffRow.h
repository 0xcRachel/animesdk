...
#define RPG_GAMECORE_MAZEBUFFROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x16C6AF60)
#define RPG_GAMECORE_MAZEBUFFROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16C6B7B0)
#define RPG_GAMECORE_MAZEBUFFROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x16C6CD20)
#define RPG_GAMECORE_MAZEBUFFROW_RESET_OFFSET UNITYSDK_OFFSET(0x16C6CD80)
#define RPG_GAMECORE_MAZEBUFFROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16C6CDC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazeBuffRow_TypeDefinitionIndex = 12744;
	...
	public:
		...
		::System::String* InBattleBindingKey; // 0x20
		::System::String* BuffIcon; // 0x28
		::Il2CppArray<::RPG::GameCore::FixPoint>* ParamList; // 0x30
		::RPG::Client::TextID BuffDescBattle; // 0x38
		::System::UInt32 ID; // 0x48
		::System::UInt32 BuffRarity; // 0x4C
		::System::UInt32 Lv; // 0x50
		::RPG::GameCore::EnumStatusType MazeBuffIconType; // 0x54
		::System::UInt32 MazeBuffPool; // 0x58
		...
		::RPG::GameCore::MazeBuffUseType UseType; // 0x94
		::System::Boolean IsDisplayEnvInLevel; // 0x98
		::System::UInt32 BuffSeries; // 0x9C
		::RPG::GameCore::MazeBuffDisplayType DisplayType; // 0xA0
		::RPG::GameCore::MazeBuffType MazeBuffType; // 0xA4
		::System::UInt32 BuffDescParamByAvatarSkillID; // 0xA8
		::System::UInt32 LvMax; // 0xAC
