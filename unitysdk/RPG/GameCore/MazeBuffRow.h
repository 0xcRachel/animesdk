...
#define RPG_GAMECORE_MAZEBUFFROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x173D0900)
#define RPG_GAMECORE_MAZEBUFFROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x173D1150)
#define RPG_GAMECORE_MAZEBUFFROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x173D26C0)
#define RPG_GAMECORE_MAZEBUFFROW_RESET_OFFSET UNITYSDK_OFFSET(0x173D2720)
#define RPG_GAMECORE_MAZEBUFFROW__CTOR_OFFSET UNITYSDK_OFFSET(0x173D2770)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 BuffSeries; // 0x38
		::System::UInt32 MazeBuffPool; // 0x3C
		::RPG::Client::TextID BuffDesc; // 0x40
		::RPG::Client::TextID BuffSimpleDesc; // 0x50
		::RPG::Client::TextID BuffDescBattle; // 0x60
		::System::UInt32 Lv; // 0x70
		::System::UInt32 BuffRarity; // 0x74
		::RPG::Client::TextID BuffName; // 0x78
		::RPG::GameCore::MazeBuffInBattleBindingType InBattleBindingType; // 0x88
		::System::UInt32 LvMax; // 0x8C
		::System::UInt32 ID; // 0x90
		::System::Boolean IsDisplayEnvInLevel; // 0x94
		::RPG::GameCore::MazeBuffDisplayType DisplayType; // 0x98
		::System::UInt32 BuffDescParamByAvatarSkillID; // 0x9C
		::RPG::GameCore::MazeBuffUseType UseType; // 0xA0
		::RPG::GameCore::MazeBuffType MazeBuffType; // 0xA4
		::RPG::GameCore::EnumStatusType MazeBuffIconType; // 0xA8
