...
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_CANHEALHP_OFFSET UNITYSDK_OFFSET(0xA8899A0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA88A600)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_GETSUMMONERCHARACTERID_OFFSET UNITYSDK_OFFSET(0xA88C610)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_GET_ACTIVEBACKENDRANKLIST_OFFSET UNITYSDK_OFFSET(0xA8898A0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_GET_BATTLEEVENTCONFIG_OFFSET UNITYSDK_OFFSET(0xA88D070)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_GET_BATTLEEVENTJSONCONFIG_OFFSET UNITYSDK_OFFSET(0xA88AA70)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_GET_BATTLEEVENTSUBTYPE_OFFSET UNITYSDK_OFFSET(0xA88D1B0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_GET_CREATEPARAMS_OFFSET UNITYSDK_OFFSET(0xA88D210)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_GET_ENERGYBARSTATE_OFFSET UNITYSDK_OFFSET(0xA88D2D0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_GET_HASLIFE_OFFSET UNITYSDK_OFFSET(0xA88D150)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_GET_HASMODELPREFAB_OFFSET UNITYSDK_OFFSET(0xA88D0B0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_GET_MUTEDARKTEAMMODIFIERADD_OFFSET UNITYSDK_OFFSET(0xA889AC0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_GET_ONLYALLOWHEALBYSELFORSUMMONER_OFFSET UNITYSDK_OFFSET(0xA889AE0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_GET_SOURCECASTER_OFFSET UNITYSDK_OFFSET(0xA88D090)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_GET_TREATASROLEWHENBYCOMPARECHARACTERID_OFFSET UNITYSDK_OFFSET(0xA889B20)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_GET_TRIGGERALLBLOCKEDBECALLBACKS_OFFSET UNITYSDK_OFFSET(0xA889AA0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_GET_TRIGGERREDBREAKCALLBACKS_OFFSET UNITYSDK_OFFSET(0xA889B00)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_GET_TRIGGERULTRACUTIN_OFFSET UNITYSDK_OFFSET(0xA889A30)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_INITBATTLECHARACTERDATA_OFFSET UNITYSDK_OFFSET(0xA889BF0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_INITBATTLEEVENTCOMPONENT_OFFSET UNITYSDK_OFFSET(0xA88A2F0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_INITCOMPONENTBYCHARACTERROWDATA_OFFSET UNITYSDK_OFFSET(0xA889F00)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_ONABILITYCHARACTERINITIALIZED_OFFSET UNITYSDK_OFFSET(0xA88A870)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_RESETBATTLEEVENTPROPERTY_OFFSET UNITYSDK_OFFSET(0xA88AAB0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_SETACTIVITYPROPERTIES_OFFSET UNITYSDK_OFFSET(0xA88C8E0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_SETPROPERTYVALUESFROMENTITY_OFFSET UNITYSDK_OFFSET(0xA88AD40)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_SETPROPERTYVALUESFROMOVERRIDEPROPERTYCONFIG_OFFSET UNITYSDK_OFFSET(0xA88C190)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_SETPROPERTYVALUESFROMSTAGE_OFFSET UNITYSDK_OFFSET(0xA88AED0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_SETULTRACUTIN_OFFSET UNITYSDK_OFFSET(0xA889900)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_SET_BATTLEEVENTCONFIG_OFFSET UNITYSDK_OFFSET(0xA88D080)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_SET_CREATEPARAMS_OFFSET UNITYSDK_OFFSET(0xA88D220)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_SET_MUTEDARKTEAMMODIFIERADD_OFFSET UNITYSDK_OFFSET(0xA889AD0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_SET_ONLYALLOWHEALBYSELFORSUMMONER_OFFSET UNITYSDK_OFFSET(0xA889AF0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_SET_ROWDATA_OFFSET UNITYSDK_OFFSET(0xA88D230)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_SET_SOURCECASTER_OFFSET UNITYSDK_OFFSET(0xA88D0A0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_SET_TREATASROLEWHENBYCOMPARECHARACTERID_OFFSET UNITYSDK_OFFSET(0xA889B30)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_SET_TRIGGERALLBLOCKEDBECALLBACKS_OFFSET UNITYSDK_OFFSET(0xA889AB0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_SET_TRIGGERREDBREAKCALLBACKS_OFFSET UNITYSDK_OFFSET(0xA889B10)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_UPDATEENERGYBARSTATE_1_OFFSET UNITYSDK_OFFSET(0xA88C530)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_UPDATEENERGYBARSTATE_OFFSET UNITYSDK_OFFSET(0xA88C300)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_UPDATEGRIDFIGHTENERGYBARSTATE_OFFSET UNITYSDK_OFFSET(0xA889820)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0xA88D2E0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT__FULLROWDATA_OFFSET UNITYSDK_OFFSET(0xA888BB0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT__INITEVENT_OFFSET UNITYSDK_OFFSET(0xA88A430)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT__ISLIFEBINDINGTARGET_OFFSET UNITYSDK_OFFSET(0xA88C9B0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT__ONBATTLEEVENTDYING_OFFSET UNITYSDK_OFFSET(0xA88CCF0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT__ONCHARACTERDYING_OFFSET UNITYSDK_OFFSET(0xA88CA50)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT__ONCHARACTERREVIVE_OFFSET UNITYSDK_OFFSET(0xA88CE40)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT__ONCHARACTERSTAGESTATECHANGE_OFFSET UNITYSDK_OFFSET(0xA88CFC0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT__ONENTITYDIEEVENT_OFFSET UNITYSDK_OFFSET(0xA88CAD0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT__ONINITOWNERREF_OFFSET UNITYSDK_OFFSET(0xA889B40)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT__ONPREABILITYADD_OFFSET UNITYSDK_OFFSET(0xA88C920)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT__SETGRIDFIGHTBEPROPERTY_OFFSET UNITYSDK_OFFSET(0xA8883F0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT__SETUPBESERVANTPROPERTIES_OFFSET UNITYSDK_OFFSET(0xA888E60)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT__UNINITEVENT_OFFSET UNITYSDK_OFFSET(0xA88A700)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA88D360)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT___IFIXBASEPROXY_GET_HASLIFE_OFFSET UNITYSDK_OFFSET(0xA88D400)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT___IFIXBASEPROXY_INITCOMPONENTBYCHARACTERROWDATA_OFFSET UNITYSDK_OFFSET(0xA88D350)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT___IFIXBASEPROXY_ONABILITYCHARACTERINITIALIZED_OFFSET UNITYSDK_OFFSET(0xA88D3B0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT___IFIXBASEPROXY_SET_ROWDATA_OFFSET UNITYSDK_OFFSET(0xA88D420)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT___IFIXBASEPROXY__ONINITOWNERREF_OFFSET UNITYSDK_OFFSET(0xA88D2F0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::BattleEventRow* _BattleEventConfig_k__BackingField; // 0x110
		...
		::System::UInt32 WarningChallengeTurnLeft; // 0x140
		::RPG::GameCore::TeamType BattleEventTotalDamageType; // 0x144
		::System::Boolean _TriggerAllBlockedBECallbacks_k__BackingField; // 0x148
		::System::Boolean _MuteDarkTeamModifierAdd_k__BackingField; // 0x149
		::System::Boolean _TreatAsRoleWhenByCompareCharacterID_k__BackingField; // 0x14A
		::System::Boolean _TriggerRedBreakCallbacks_k__BackingField; // 0x14B
		::System::Boolean _TriggerUltraCutin; // 0x14C
		::System::Boolean _OnlyAllowHealBySelfOrSummoner_k__BackingField; // 0x14D
