...
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_CANHEALHP_OFFSET UNITYSDK_OFFSET(0x11D25DE0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11D26D40)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_GETSUMMONERCHARACTERID_OFFSET UNITYSDK_OFFSET(0x11D28D10)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_GET_ACTIVEBACKENDRANKLIST_OFFSET UNITYSDK_OFFSET(0x11D25CE0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_GET_BATTLEEVENTCONFIG_OFFSET UNITYSDK_OFFSET(0x11D29750)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_GET_BATTLEEVENTJSONCONFIG_OFFSET UNITYSDK_OFFSET(0x11D271A0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_GET_BATTLEEVENTSUBTYPE_OFFSET UNITYSDK_OFFSET(0x11D29890)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_GET_CREATEPARAMS_OFFSET UNITYSDK_OFFSET(0x11D298F0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_GET_ENERGYBARSTATE_OFFSET UNITYSDK_OFFSET(0x11D299B0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_GET_HASLIFE_OFFSET UNITYSDK_OFFSET(0x11D29830)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_GET_HASMODELPREFAB_OFFSET UNITYSDK_OFFSET(0x11D29790)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_GET_MUTEDARKTEAMMODIFIERADD_OFFSET UNITYSDK_OFFSET(0x11D25F00)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_GET_ONLYALLOWHEALBYSELFORSUMMONER_OFFSET UNITYSDK_OFFSET(0x11D25F20)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_GET_SOURCECASTER_OFFSET UNITYSDK_OFFSET(0x11D29770)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_GET_TREATASROLEWHENBYCOMPARECHARACTERID_OFFSET UNITYSDK_OFFSET(0x11D25F60)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_GET_TRIGGERALLBLOCKEDBECALLBACKS_OFFSET UNITYSDK_OFFSET(0x11D25EE0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_GET_TRIGGERREDBREAKCALLBACKS_OFFSET UNITYSDK_OFFSET(0x11D25F40)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_GET_TRIGGERULTRACUTIN_OFFSET UNITYSDK_OFFSET(0x11D25E70)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_INITBATTLECHARACTERDATA_OFFSET UNITYSDK_OFFSET(0x11D26030)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_INITBATTLEEVENTCOMPONENT_OFFSET UNITYSDK_OFFSET(0x11D26A40)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_INITCOMPONENTBYCHARACTERROWDATA_OFFSET UNITYSDK_OFFSET(0x11D26650)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_ONABILITYCHARACTERINITIALIZED_OFFSET UNITYSDK_OFFSET(0x11D26FA0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_RESETBATTLEEVENTPROPERTY_OFFSET UNITYSDK_OFFSET(0x11D271E0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_SETACTIVITYPROPERTIES_OFFSET UNITYSDK_OFFSET(0x11D28FC0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_SETPROPERTYVALUESFROMENTITY_OFFSET UNITYSDK_OFFSET(0x11D27470)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_SETPROPERTYVALUESFROMOVERRIDEPROPERTYCONFIG_OFFSET UNITYSDK_OFFSET(0x11D288F0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_SETPROPERTYVALUESFROMSTAGE_OFFSET UNITYSDK_OFFSET(0x11D27630)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_SETULTRACUTIN_OFFSET UNITYSDK_OFFSET(0x11D25D40)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_SET_BATTLEEVENTCONFIG_OFFSET UNITYSDK_OFFSET(0x11D29760)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_SET_CREATEPARAMS_OFFSET UNITYSDK_OFFSET(0x11D29900)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_SET_MUTEDARKTEAMMODIFIERADD_OFFSET UNITYSDK_OFFSET(0x11D25F10)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_SET_ONLYALLOWHEALBYSELFORSUMMONER_OFFSET UNITYSDK_OFFSET(0x11D25F30)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_SET_ROWDATA_OFFSET UNITYSDK_OFFSET(0x11D29910)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_SET_SOURCECASTER_OFFSET UNITYSDK_OFFSET(0x11D29780)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_SET_TREATASROLEWHENBYCOMPARECHARACTERID_OFFSET UNITYSDK_OFFSET(0x11D25F70)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_SET_TRIGGERALLBLOCKEDBECALLBACKS_OFFSET UNITYSDK_OFFSET(0x11D25EF0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_SET_TRIGGERREDBREAKCALLBACKS_OFFSET UNITYSDK_OFFSET(0x11D25F50)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_UPDATEENERGYBARSTATE_1_OFFSET UNITYSDK_OFFSET(0x11D28C30)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_UPDATEENERGYBARSTATE_OFFSET UNITYSDK_OFFSET(0x11D28A60)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT_UPDATEGRIDFIGHTENERGYBARSTATE_OFFSET UNITYSDK_OFFSET(0x11D25C60)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x11D299C0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT__FULLROWDATA_OFFSET UNITYSDK_OFFSET(0x11D24FF0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT__INITEVENT_OFFSET UNITYSDK_OFFSET(0x11D26B70)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT__ISLIFEBINDINGTARGET_OFFSET UNITYSDK_OFFSET(0x11D29090)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT__ONBATTLEEVENTDYING_OFFSET UNITYSDK_OFFSET(0x11D293D0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT__ONCHARACTERDYING_OFFSET UNITYSDK_OFFSET(0x11D29130)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT__ONCHARACTERREVIVE_OFFSET UNITYSDK_OFFSET(0x11D29520)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT__ONCHARACTERSTAGESTATECHANGE_OFFSET UNITYSDK_OFFSET(0x11D296A0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT__ONENTITYDIEEVENT_OFFSET UNITYSDK_OFFSET(0x11D291B0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT__ONINITOWNERREF_OFFSET UNITYSDK_OFFSET(0x11D25F80)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT__ONPREABILITYADD_OFFSET UNITYSDK_OFFSET(0x11D29000)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT__SETGRIDFIGHTBEPROPERTY_OFFSET UNITYSDK_OFFSET(0x11D24830)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT__SETUPBESERVANTPROPERTIES_OFFSET UNITYSDK_OFFSET(0x11D252A0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT__UNINITEVENT_OFFSET UNITYSDK_OFFSET(0x11D26E30)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11D29B20)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT___IFIXBASEPROXY_GET_HASLIFE_OFFSET UNITYSDK_OFFSET(0x11D29BC0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT___IFIXBASEPROXY_INITCOMPONENTBYCHARACTERROWDATA_OFFSET UNITYSDK_OFFSET(0x11D29B10)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT___IFIXBASEPROXY_ONABILITYCHARACTERINITIALIZED_OFFSET UNITYSDK_OFFSET(0x11D29B70)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT___IFIXBASEPROXY_SET_ROWDATA_OFFSET UNITYSDK_OFFSET(0x11D29BE0)
#define RPG_GAMECORE_BATTLEEVENTDATACOMPONENT___IFIXBASEPROXY__ONINITOWNERREF_OFFSET UNITYSDK_OFFSET(0x11D29AB0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Class_1_312DDC926E545863* _CreateParams_k__BackingField; // 0x118
		::RPG::GameCore::AvatarEnergyBarState* _EnergyBarState; // 0x120
		::RPG::GameCore::BattleEventRowData* _BattleEventRowData; // 0x128
		::RPG::GameCore::TurnBasedAbilityComponent* _TBAbilityRef; // 0x130
		::RPG::GameCore::GameEntity* _SourceCaster_k__BackingField; // 0x138
		::RPG::GameCore::BattleEventRow* _BattleEventConfig_k__BackingField; // 0x140
		::System::Boolean _MuteDarkTeamModifierAdd_k__BackingField; // 0x148
		::System::Boolean _TriggerRedBreakCallbacks_k__BackingField; // 0x149
		::RPG::GameCore::TeamType BattleEventTotalDamageType; // 0x14C
		::System::UInt32 WarningChallengeTurnLeft; // 0x150
		::System::Boolean _TriggerUltraCutin; // 0x154
		::System::Boolean _OnlyAllowHealBySelfOrSummoner_k__BackingField; // 0x155
		::System::Boolean _TreatAsRoleWhenByCompareCharacterID_k__BackingField; // 0x156
		::System::Boolean _TriggerAllBlockedBECallbacks_k__BackingField; // 0x157
