...
#define RPG_GAMECORE_TURNINSERTASSISTANTABILITY_METHOD_3_8D641ADFB3F7A682_OFFSET UNITYSDK_OFFSET(0x19126540)
#define RPG_GAMECORE_TURNINSERTASSISTANTABILITY_METHOD_3_BBD86DD485F877EC_OFFSET UNITYSDK_OFFSET(0x19126470)
#define RPG_GAMECORE_TURNINSERTASSISTANTABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x191264F0)
