...
#define RPG_GAMECORE_SETDYNAMICVALUEINRANGE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x16F279F0)
#define RPG_GAMECORE_SETDYNAMICVALUEINRANGE_METHOD_4_B664628F0FC75374_OFFSET UNITYSDK_OFFSET(0x16F221D0)
#define RPG_GAMECORE_SETDYNAMICVALUEINRANGE_METHOD_4_BBDF26300A5493AC_OFFSET UNITYSDK_OFFSET(0x16F27950)
#define RPG_GAMECORE_SETDYNAMICVALUEINRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F22150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueInRange_TypeDefinitionIndex = 21255;
