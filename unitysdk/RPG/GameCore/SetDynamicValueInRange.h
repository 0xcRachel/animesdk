...
#define RPG_GAMECORE_SETDYNAMICVALUEINRANGE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x176DCEB0)
#define RPG_GAMECORE_SETDYNAMICVALUEINRANGE_METHOD_4_B664628F0FC75374_OFFSET UNITYSDK_OFFSET(0x176DCC40)
#define RPG_GAMECORE_SETDYNAMICVALUEINRANGE_METHOD_4_BBDF26300A5493AC_OFFSET UNITYSDK_OFFSET(0x176DCB20)
#define RPG_GAMECORE_SETDYNAMICVALUEINRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x176DCBC0)
