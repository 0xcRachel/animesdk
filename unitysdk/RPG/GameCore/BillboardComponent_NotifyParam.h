...
#define RPG_GAMECORE_BILLBOARDCOMPONENT_NOTIFYPARAM_COPYTO_OFFSET UNITYSDK_OFFSET(0x11D3B830)
#define RPG_GAMECORE_BILLBOARDCOMPONENT_NOTIFYPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x11D3B9C0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Tuple_2<::System::String*, ::System::String*>* FiveDimSidePuzzlePanelPaths; // 0x30
		::RPG::Client::TextID TextIDName; // 0x38
		::RPG::GameCore::InwardBubbleTalkType InwardType; // 0x48
		::System::Single XOffset; // 0x4C
		::System::Single ZOffset; // 0x50
		::System::Single YOffset; // 0x54
		::RPG::Client::TextID FloatingText; // 0x58
		::RPG::Client::TextID TextTitle; // 0x68
		::System::UInt32 NPCID; // 0x78
		::System::Boolean ShowTop; // 0x7C
		::System::Boolean ShowInStoryMode; // 0x7D
		::System::Boolean IsShowFiveDimSidePuzzleChest; // 0x7E
		::RPG::Client::BillboardShowType BoardShowBit; // 0x80
