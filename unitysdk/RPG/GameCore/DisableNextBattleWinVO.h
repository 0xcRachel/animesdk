...
#define RPG_GAMECORE_DISABLENEXTBATTLEWINVO_METHOD_3_29F5003EFDABD023_OFFSET UNITYSDK_OFFSET(0x16A44650)
#define RPG_GAMECORE_DISABLENEXTBATTLEWINVO_METHOD_3_85674E7C50B8ED37_OFFSET UNITYSDK_OFFSET(0x16A44760)
#define RPG_GAMECORE_DISABLENEXTBATTLEWINVO__CTOR_OFFSET UNITYSDK_OFFSET(0x16A44730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DisableNextBattleWinVO_TypeDefinitionIndex = 18337;
