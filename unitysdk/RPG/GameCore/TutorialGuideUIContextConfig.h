...
#define RPG_GAMECORE_TUTORIALGUIDEUICONTEXTCONFIG_METHOD_2_19CC70E5D550B8E8_OFFSET UNITYSDK_OFFSET(0x1912D9B0)
#define RPG_GAMECORE_TUTORIALGUIDEUICONTEXTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1912DAC0)
