...
#define RPG_GAMECORE_RTBATTLEVCAMERACONFIGCHANGE_METHOD_4_86153E941EC50869_OFFSET UNITYSDK_OFFSET(0x18E78B00)
#define RPG_GAMECORE_RTBATTLEVCAMERACONFIGCHANGE_METHOD_4_BAB73C2A8F17EFEF_OFFSET UNITYSDK_OFFSET(0x18E78A80)
#define RPG_GAMECORE_RTBATTLEVCAMERACONFIGCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E78AD0)
