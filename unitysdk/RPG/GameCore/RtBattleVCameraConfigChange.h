...
#define RPG_GAMECORE_RTBATTLEVCAMERACONFIGCHANGE_METHOD_4_86153E941EC50869_OFFSET UNITYSDK_OFFSET(0x19419C60)
#define RPG_GAMECORE_RTBATTLEVCAMERACONFIGCHANGE_METHOD_4_BAB73C2A8F17EFEF_OFFSET UNITYSDK_OFFSET(0x19419BE0)
#define RPG_GAMECORE_RTBATTLEVCAMERACONFIGCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19419C30)
