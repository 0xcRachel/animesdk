...
#define RPG_GAMECORE_DICECOMBATCOLORFULDICESKILLCONDITIONCONFIG_METHOD_3_1507C0586E4207FF_OFFSET UNITYSDK_OFFSET(0x17172970)
#define RPG_GAMECORE_DICECOMBATCOLORFULDICESKILLCONDITIONCONFIG_METHOD_3_85BADE18EDFC0274_OFFSET UNITYSDK_OFFSET(0x17172A50)
#define RPG_GAMECORE_DICECOMBATCOLORFULDICESKILLCONDITIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17172A00)
