...
#define RPG_GAMECORE_MODIFYSHIELDMAX_METHOD_3_3EAC688FA380DA35_OFFSET UNITYSDK_OFFSET(0x19084C20)
#define RPG_GAMECORE_MODIFYSHIELDMAX_METHOD_3_9FBEB5081540B0A0_OFFSET UNITYSDK_OFFSET(0x19084B90)
#define RPG_GAMECORE_MODIFYSHIELDMAX__CTOR_OFFSET UNITYSDK_OFFSET(0x19084BF0)
