...
#define RPG_GAMECORE_PUZZLEBOXMANINBOARD_METHOD_3_0B8A6DE63D662A3C_OFFSET UNITYSDK_OFFSET(0x16DBCE50)
#define RPG_GAMECORE_PUZZLEBOXMANINBOARD_METHOD_3_6102990D591EB037_OFFSET UNITYSDK_OFFSET(0x16DBCDD0)
#define RPG_GAMECORE_PUZZLEBOXMANINBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x16DBCE20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PuzzleBoxmanInBoard_TypeDefinitionIndex = 19663;
