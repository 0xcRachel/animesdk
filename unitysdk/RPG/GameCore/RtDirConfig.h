...
#define RPG_GAMECORE_RTDIRCONFIG_METHOD_2_CF8A800990B564A7_OFFSET UNITYSDK_OFFSET(0x19425210)
#define RPG_GAMECORE_RTDIRCONFIG_METHOD_2_E183EEAD0E1702C1_OFFSET UNITYSDK_OFFSET(0x194254B0)
#define RPG_GAMECORE_RTDIRCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19425440)
