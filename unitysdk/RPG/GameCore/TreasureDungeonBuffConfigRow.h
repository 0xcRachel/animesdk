...
#define RPG_GAMECORE_TREASUREDUNGEONBUFFCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19A352D0)
#define RPG_GAMECORE_TREASUREDUNGEONBUFFCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19A358D0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean IsSaveNextFloor; // 0x58
		::System::UInt32 BattleTargetID; // 0x5C
		::System::UInt32 UseTime; // 0x60
		::System::UInt32 BuffGroupID; // 0x64
		::System::UInt32 ParamInt; // 0x68
		::RPG::GameCore::TreasureDungeonBuffType Type; // 0x6C
		::System::UInt32 TargetBounsParam; // 0x70
		::System::UInt32 DisplayRarity; // 0x74
