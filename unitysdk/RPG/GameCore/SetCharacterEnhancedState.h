...
#define RPG_GAMECORE_SETCHARACTERENHANCEDSTATE_METHOD_3_80AE678CB1019500_OFFSET UNITYSDK_OFFSET(0x16F0C6A0)
#define RPG_GAMECORE_SETCHARACTERENHANCEDSTATE_METHOD_3_8CF3D1FF02D2CF78_OFFSET UNITYSDK_OFFSET(0x16F0C770)
#define RPG_GAMECORE_SETCHARACTERENHANCEDSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F0C720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCharacterEnhancedState_TypeDefinitionIndex = 20866;
