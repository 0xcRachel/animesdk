...
#define RPG_GAMECORE_SETCHARACTERENHANCEDSTATE_METHOD_3_80AE678CB1019500_OFFSET UNITYSDK_OFFSET(0x176C1B30)
#define RPG_GAMECORE_SETCHARACTERENHANCEDSTATE_METHOD_3_8CF3D1FF02D2CF78_OFFSET UNITYSDK_OFFSET(0x176C1C00)
#define RPG_GAMECORE_SETCHARACTERENHANCEDSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x176C1BB0)
