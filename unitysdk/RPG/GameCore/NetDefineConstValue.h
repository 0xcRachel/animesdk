...
#define RPG_GAMECORE_NETDEFINECONSTVALUE_METHOD_2_2FDB7821F634F886_OFFSET UNITYSDK_OFFSET(0x1864B8D0)
#define RPG_GAMECORE_NETDEFINECONSTVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1864BFC0)
