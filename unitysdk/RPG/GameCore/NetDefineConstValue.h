...
#define RPG_GAMECORE_NETDEFINECONSTVALUE_METHOD_2_601BF670998A0249_OFFSET UNITYSDK_OFFSET(0x191041A0)
#define RPG_GAMECORE_NETDEFINECONSTVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x19104870)
