...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTITANBLESSSELECTNUMCONFIG_METHOD_3_09E0C8FA55A894D0_OFFSET UNITYSDK_OFFSET(0x16EA0E40)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTITANBLESSSELECTNUMCONFIG_METHOD_3_398F6A9ED839D529_OFFSET UNITYSDK_OFFSET(0x16E9A5B0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTITANBLESSSELECTNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E9A560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyTitanBlessSelectNumConfig_TypeDefinitionIndex = 16015;
