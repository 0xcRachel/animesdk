...
#define RPG_GAMECORE_ROGUETURNTABLEGRANTREWARD_METHOD_3_BD1A89A7DC8C20DB_OFFSET UNITYSDK_OFFSET(0x17685FF0)
#define RPG_GAMECORE_ROGUETURNTABLEGRANTREWARD_METHOD_3_CB1009E516408A2B_OFFSET UNITYSDK_OFFSET(0x17686080)
#define RPG_GAMECORE_ROGUETURNTABLEGRANTREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x17686050)
