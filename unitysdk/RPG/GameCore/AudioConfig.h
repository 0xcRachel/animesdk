...
#define RPG_GAMECORE_AUDIOCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x168945D0)
#define RPG_GAMECORE_AUDIOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16897D30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AudioConfig_TypeDefinitionIndex = 14738;
