...
#define RPG_GAMECORE_TARGETMAPPARTOWNERENTITY_METHOD_3_7F63DC0307A52E62_OFFSET UNITYSDK_OFFSET(0x16FE2D80)
#define RPG_GAMECORE_TARGETMAPPARTOWNERENTITY_METHOD_3_E3F62B146A41C110_OFFSET UNITYSDK_OFFSET(0x16FE2CA0)
#define RPG_GAMECORE_TARGETMAPPARTOWNERENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE2D60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapPartOwnerEntity_TypeDefinitionIndex = 21734;
