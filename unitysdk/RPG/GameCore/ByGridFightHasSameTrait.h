...
#define RPG_GAMECORE_BYGRIDFIGHTHASSAMETRAIT_METHOD_4_1D30321658AD8041_OFFSET UNITYSDK_OFFSET(0x19D8D9D0)
#define RPG_GAMECORE_BYGRIDFIGHTHASSAMETRAIT_METHOD_4_4A26B8A4795D9B6C_OFFSET UNITYSDK_OFFSET(0x19D8DCD0)
#define RPG_GAMECORE_BYGRIDFIGHTHASSAMETRAIT_METHOD_4_C4AEBCD6D270CE33_OFFSET UNITYSDK_OFFSET(0x19D8D8F0)
#define RPG_GAMECORE_BYGRIDFIGHTHASSAMETRAIT_METHOD_4_F80B713B7FA80917_OFFSET UNITYSDK_OFFSET(0x19D8DC50)
#define RPG_GAMECORE_BYGRIDFIGHTHASSAMETRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x19D8D970)
