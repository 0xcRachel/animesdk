...
#define RPG_GAMECORE_BYGRIDFIGHTHASSAMETRAIT_METHOD_4_1D30321658AD8041_OFFSET UNITYSDK_OFFSET(0x19ADD9E0)
#define RPG_GAMECORE_BYGRIDFIGHTHASSAMETRAIT_METHOD_4_C4AEBCD6D270CE33_OFFSET UNITYSDK_OFFSET(0x19ADD900)
#define RPG_GAMECORE_BYGRIDFIGHTHASSAMETRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x19ADD980)
