...
#define RPG_GAMECORE_MARBLEEFFECT_METHOD_2_A45D17AD26C6E668_OFFSET UNITYSDK_OFFSET(0x16C3C910)
#define RPG_GAMECORE_MARBLEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x16C3CE70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleEffect_TypeDefinitionIndex = 15220;
