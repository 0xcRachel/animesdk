...
#define RPG_GAMECORE_SYNCDITHERWITHTARGET_METHOD_3_0CB0FE25B4995FDF_OFFSET UNITYSDK_OFFSET(0x1986C4C0)
#define RPG_GAMECORE_SYNCDITHERWITHTARGET_METHOD_3_D74219A5F4CC8C80_OFFSET UNITYSDK_OFFSET(0x1986C590)
#define RPG_GAMECORE_SYNCDITHERWITHTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1986C540)
