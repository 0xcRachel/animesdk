...
#define RPG_GAMECORE_REMOVESTAGEABILITYBYNAME_METHOD_3_F3F3DBA230468BFA_OFFSET UNITYSDK_OFFSET(0x16DE0EA0)
#define RPG_GAMECORE_REMOVESTAGEABILITYBYNAME_METHOD_3_FB609807627154F3_OFFSET UNITYSDK_OFFSET(0x16DE0E20)
#define RPG_GAMECORE_REMOVESTAGEABILITYBYNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x16DE0E70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveStageAbilityByName_TypeDefinitionIndex = 20628;
