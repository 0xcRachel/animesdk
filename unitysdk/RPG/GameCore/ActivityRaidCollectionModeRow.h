...
#define RPG_GAMECORE_ACTIVITYRAIDCOLLECTIONMODEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x167AC0F0)
#define RPG_GAMECORE_ACTIVITYRAIDCOLLECTIONMODEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x167AC740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityRaidCollectionModeRow_TypeDefinitionIndex = 11180;
