...
#define RPG_GAMECORE_EVOLVEBUILDSHOPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1945DEB0)
#define RPG_GAMECORE_EVOLVEBUILDSHOPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1945E4C0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::Class_1_A88C3AAF0DD46F4C_4*>* PriceList; // 0x28
		::System::UInt32 LvMax; // 0x30
		::RPG::GameCore::EvolveBuildProtductType ShopType; // 0x34
		::RPG::Client::TextID ShopDesc; // 0x38
		::RPG::Client::TextID TotalBuff; // 0x48
		::System::UInt32 MazeBuffID; // 0x58
		::System::UInt32 ID; // 0x5C
		::RPG::GameCore::EvolveBuildSeason Season; // 0x60
		::RPG::Client::TextID Name; // 0x68
		::RPG::Client::TextID Category; // 0x78
		::RPG::Client::TextID BuffTextFormat; // 0x88
