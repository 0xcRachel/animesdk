...
#define RPG_GAMECORE_ADVDISABLENPCSYNCMOTION_METHOD_3_26D66354F298E2E1_OFFSET UNITYSDK_OFFSET(0x16831810)
#define RPG_GAMECORE_ADVDISABLENPCSYNCMOTION_METHOD_3_36A7A2D9827825CD_OFFSET UNITYSDK_OFFSET(0x16831790)
#define RPG_GAMECORE_ADVDISABLENPCSYNCMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x168317E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvDisableNpcSyncMotion_TypeDefinitionIndex = 20056;
