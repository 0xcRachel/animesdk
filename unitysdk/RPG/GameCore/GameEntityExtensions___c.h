...
#define RPG_GAMECORE_GAMEENTITYEXTENSIONS___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xA95E1E0)
#define RPG_GAMECORE_GAMEENTITYEXTENSIONS___C__CTOR_OFFSET UNITYSDK_OFFSET(0xA95E210)
#define RPG_GAMECORE_GAMEENTITYEXTENSIONS___C___CCTOR_B__84_0_OFFSET UNITYSDK_OFFSET(0xA95E220)
#define RPG_GAMECORE_GAMEENTITYEXTENSIONS___C___CCTOR_B__84_1_OFFSET UNITYSDK_OFFSET(0xA95E2D0)
#define RPG_GAMECORE_GAMEENTITYEXTENSIONS___C___CCTOR_B__84_2_OFFSET UNITYSDK_OFFSET(0xA95E370)
#define RPG_GAMECORE_GAMEENTITYEXTENSIONS___C___CCTOR_B__84_3_OFFSET UNITYSDK_OFFSET(0xA95E400)
#define RPG_GAMECORE_GAMEENTITYEXTENSIONS___C___CCTOR_B__84_4_OFFSET UNITYSDK_OFFSET(0xA95E560)
#define RPG_GAMECORE_GAMEENTITYEXTENSIONS___C___CCTOR_B__84_5_OFFSET UNITYSDK_OFFSET(0xA95E5F0)
#define RPG_GAMECORE_GAMEENTITYEXTENSIONS___C___CCTOR_B__84_6_OFFSET UNITYSDK_OFFSET(0xA95E620)
#define RPG_GAMECORE_GAMEENTITYEXTENSIONS___C___CCTOR_B__84_7_OFFSET UNITYSDK_OFFSET(0xA95E7A0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::RPG::GameCore::GameEntityExtensions___c**)Il2CppClass::FromTypeDefinitionIndex(GameEntityExtensions___c_TypeDefinitionIndex)->GetStaticField(0x48980);
		}
