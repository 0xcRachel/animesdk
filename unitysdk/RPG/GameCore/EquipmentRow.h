...
#define RPG_GAMECORE_EQUIPMENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x194537C0)
#define RPG_GAMECORE_EQUIPMENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19457B20)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 ExpProvide; // 0x4C
		::System::UInt32 MaxRank; // 0x50
		::RPG::GameCore::AvatarBaseType AvatarBaseType; // 0x54
		::System::UInt32 ExpType; // 0x58
		::System::UInt32 MaxPromotion; // 0x5C
		::RPG::Client::TextID EquipmentName; // 0x60
		::System::UInt32 EquipmentID; // 0x70
		::System::UInt32 SkillID; // 0x74
		::System::Boolean Release; // 0x78
		::RPG::GameCore::CombatPowerLightconeRarityType Rarity; // 0x7C
		::RPG::Client::TextID EquipmentDesc; // 0x80
