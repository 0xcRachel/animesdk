...
#define RPG_GAMECORE_TARGETMUTEMODIFIEREVENTSOURCE_METHOD_3_1F12EFD71BB1C8AF_OFFSET UNITYSDK_OFFSET(0x16FE3D40)
#define RPG_GAMECORE_TARGETMUTEMODIFIEREVENTSOURCE_METHOD_3_2EAEB1F33C928E20_OFFSET UNITYSDK_OFFSET(0x16FE3DC0)
#define RPG_GAMECORE_TARGETMUTEMODIFIEREVENTSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE3D90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMuteModifierEventSource_TypeDefinitionIndex = 21143;
