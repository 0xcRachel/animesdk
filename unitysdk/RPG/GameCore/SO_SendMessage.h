...
#define RPG_GAMECORE_SO_SENDMESSAGE_METHOD_4_46C48CBA06B4E9F6_OFFSET UNITYSDK_OFFSET(0x18E92160)
#define RPG_GAMECORE_SO_SENDMESSAGE_METHOD_4_FE35FABD832CA2A7_OFFSET UNITYSDK_OFFSET(0x18E91A30)
#define RPG_GAMECORE_SO_SENDMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E91A00)
