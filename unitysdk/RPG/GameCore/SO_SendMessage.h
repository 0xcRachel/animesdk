...
#define RPG_GAMECORE_SO_SENDMESSAGE_METHOD_4_46C48CBA06B4E9F6_OFFSET UNITYSDK_OFFSET(0x16EDD030)
#define RPG_GAMECORE_SO_SENDMESSAGE_METHOD_4_FE35FABD832CA2A7_OFFSET UNITYSDK_OFFSET(0x16EDC900)
#define RPG_GAMECORE_SO_SENDMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16EDC8D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SO_SendMessage_TypeDefinitionIndex = 17825;
