...
#define RPG_GAMECORE_TUTORIALDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x171300B0)
#define RPG_GAMECORE_TUTORIALDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x171307C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialDataRow_TypeDefinitionIndex = 14005;
