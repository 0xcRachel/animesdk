...
#define RPG_GAMECORE_DEVICERELATEDMONSTERASSETPRELOADCONFIG_METHOD_3_4DE8859558D61ACC_OFFSET UNITYSDK_OFFSET(0x169EF660)
#define RPG_GAMECORE_DEVICERELATEDMONSTERASSETPRELOADCONFIG_METHOD_3_88A3123F0C84C86E_OFFSET UNITYSDK_OFFSET(0x169EF960)
#define RPG_GAMECORE_DEVICERELATEDMONSTERASSETPRELOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x169EF650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DeviceRelatedMonsterAssetPreloadConfig_TypeDefinitionIndex = 14831;
