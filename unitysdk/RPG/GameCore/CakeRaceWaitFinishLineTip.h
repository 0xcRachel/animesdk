...
#define RPG_GAMECORE_CAKERACEWAITFINISHLINETIP_METHOD_3_95FC791C87CEF7DD_OFFSET UNITYSDK_OFFSET(0x170654D0)
#define RPG_GAMECORE_CAKERACEWAITFINISHLINETIP_METHOD_3_BCD8497FEBE0B1E9_OFFSET UNITYSDK_OFFSET(0x170653C0)
#define RPG_GAMECORE_CAKERACEWAITFINISHLINETIP__CTOR_OFFSET UNITYSDK_OFFSET(0x170654A0)
