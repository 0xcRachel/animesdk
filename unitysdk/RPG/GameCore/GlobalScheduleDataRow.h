...
#define RPG_GAMECORE_GLOBALSCHEDULEDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B114E0)
#define RPG_GAMECORE_GLOBALSCHEDULEDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B11680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GlobalScheduleDataRow_TypeDefinitionIndex = 13714;
