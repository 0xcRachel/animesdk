...
#define RPG_GAMECORE_MATCHTHREEV2DMGLIMITROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16C66350)
#define RPG_GAMECORE_MATCHTHREEV2DMGLIMITROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16C664C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MatchThreeV2DmgLimitRow_TypeDefinitionIndex = 10928;
