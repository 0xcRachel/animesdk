...
#define RPG_GAMECORE_ADVNPCATTACK_METHOD_3_2B9D38811822BCD7_OFFSET UNITYSDK_OFFSET(0x19BE5FB0)
#define RPG_GAMECORE_ADVNPCATTACK_METHOD_3_AD002B45D9BF2246_OFFSET UNITYSDK_OFFSET(0x19BE6040)
#define RPG_GAMECORE_ADVNPCATTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19BE6010)
