...
#define RPG_GAMECORE_REMOVESTREAMINGSOURCE_METHOD_3_C87C8628700BEF07_OFFSET UNITYSDK_OFFSET(0x190297C0)
#define RPG_GAMECORE_REMOVESTREAMINGSOURCE_METHOD_3_CE568906F0E65156_OFFSET UNITYSDK_OFFSET(0x19029740)
#define RPG_GAMECORE_REMOVESTREAMINGSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x19029790)
