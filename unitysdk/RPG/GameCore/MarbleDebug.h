...
#define RPG_GAMECORE_MARBLEDEBUG_METHOD_3_41A4F2B9983A0D76_OFFSET UNITYSDK_OFFSET(0x16C3C710)
#define RPG_GAMECORE_MARBLEDEBUG_METHOD_3_901F8BF97475293D_OFFSET UNITYSDK_OFFSET(0x16C3C5D0)
#define RPG_GAMECORE_MARBLEDEBUG__CTOR_OFFSET UNITYSDK_OFFSET(0x16C3C6C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleDebug_TypeDefinitionIndex = 15187;
