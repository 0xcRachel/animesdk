...
#define RPG_GAMECORE_ENABLESPECIFICMODIFIERSPECIALMARK_METHOD_3_8CCDC84FEBC8E88B_OFFSET UNITYSDK_OFFSET(0x16A6BF20)
#define RPG_GAMECORE_ENABLESPECIFICMODIFIERSPECIALMARK_METHOD_3_95B34571C967CEAD_OFFSET UNITYSDK_OFFSET(0x16A6BFA0)
#define RPG_GAMECORE_ENABLESPECIFICMODIFIERSPECIALMARK__CTOR_OFFSET UNITYSDK_OFFSET(0x16A6BF70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableSpecificModifierSpecialMark_TypeDefinitionIndex = 20842;
