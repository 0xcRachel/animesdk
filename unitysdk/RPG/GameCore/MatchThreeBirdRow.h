...
#define RPG_GAMECORE_MATCHTHREEBIRDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x173C3C20)
#define RPG_GAMECORE_MATCHTHREEBIRDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x173C4150)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID BirdDesc; // 0x38
		::System::UInt32 SkillID; // 0x48
		::System::UInt32 DefaultEmo; // 0x4C
		::System::UInt32 UnlockLevel; // 0x50
		::System::UInt32 DrawEmo; // 0x54
		::System::UInt32 LoseEmo; // 0x58
		::System::UInt32 BirdID; // 0x5C
		::RPG::Client::TextID BirdName; // 0x60
		::System::UInt32 WinEmo; // 0x70
