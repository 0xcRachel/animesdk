...
#define RPG_GAMECORE_MATCHTHREEBIRDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19992BB0)
#define RPG_GAMECORE_MATCHTHREEBIRDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x199930E0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 LoseEmo; // 0x34
		::System::UInt32 DrawEmo; // 0x38
		::System::UInt32 WinEmo; // 0x3C
		::System::UInt32 GuideID; // 0x40
		::RPG::Client::TextID BirdDesc; // 0x48
		::System::Boolean IsShow; // 0x58
		::System::UInt32 UnlockLevel; // 0x5C
		::System::UInt32 DefaultEmo; // 0x60
