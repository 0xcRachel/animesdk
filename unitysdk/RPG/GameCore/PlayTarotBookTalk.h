...
#define RPG_GAMECORE_PLAYTAROTBOOKTALK_METHOD_3_71DF5251EC370B16_OFFSET UNITYSDK_OFFSET(0x174DBA80)
#define RPG_GAMECORE_PLAYTAROTBOOKTALK_METHOD_3_CA1A67EBDFD237D5_OFFSET UNITYSDK_OFFSET(0x174DBA00)
#define RPG_GAMECORE_PLAYTAROTBOOKTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x174DBA50)
