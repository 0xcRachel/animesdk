...
#define RPG_GAMECORE_HELIOBUSPHASEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B66790)
#define RPG_GAMECORE_HELIOBUSPHASEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B67040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HeliobusPhaseRow_TypeDefinitionIndex = 12503;
	...
	public:
		...
		::RPG::Client::TextID Heliobus_ToDoListTitle_After; // 0x30
		::RPG::Client::TextID Heliobus_ToDoListTitle_Before; // 0x40
		::System::UInt32 PhaseFans; // 0x50
		::System::UInt32 UnlockMissionID; // 0x54
		::RPG::Client::TextID Heliobus_UpMissionDesc; // 0x58
