...
#define RPG_GAMECORE_LEVELREGIONCONNECTIVITY_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16BBC380)
#define RPG_GAMECORE_LEVELREGIONCONNECTIVITY__CTOR_OFFSET UNITYSDK_OFFSET(0x16BBC5E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelRegionConnectivity_TypeDefinitionIndex = 15684;
