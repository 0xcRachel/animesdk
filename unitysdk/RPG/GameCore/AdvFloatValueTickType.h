...
#define RPG_GAMECORE_ADVFLOATVALUETICKTYPE_METHOD_2_9750A64F52DF433B_OFFSET UNITYSDK_OFFSET(0x16835B00)
#define RPG_GAMECORE_ADVFLOATVALUETICKTYPE_METHOD_2_A185CD19061B6ED6_OFFSET UNITYSDK_OFFSET(0x16836500)
#define RPG_GAMECORE_ADVFLOATVALUETICKTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x16836560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvFloatValueTickType_TypeDefinitionIndex = 18824;
