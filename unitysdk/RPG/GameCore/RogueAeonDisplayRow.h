...
#define RPG_GAMECORE_ROGUEAEONDISPLAYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16E13960)
#define RPG_GAMECORE_ROGUEAEONDISPLAYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16E141B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAeonDisplayRow_TypeDefinitionIndex = 13479;
	...
	public:
		...
		::RPG::Client::TextID RogueAeonPathName2; // 0x50
