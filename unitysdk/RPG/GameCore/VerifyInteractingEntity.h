...
#define RPG_GAMECORE_VERIFYINTERACTINGENTITY_METHOD_3_BD178069C3DAAAC0_OFFSET UNITYSDK_OFFSET(0x1951F6F0)
#define RPG_GAMECORE_VERIFYINTERACTINGENTITY_METHOD_3_CB95EE76AADE8C18_OFFSET UNITYSDK_OFFSET(0x1951F670)
#define RPG_GAMECORE_VERIFYINTERACTINGENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1951F6C0)
