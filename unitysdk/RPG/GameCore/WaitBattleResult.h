...
#define RPG_GAMECORE_WAITBATTLERESULT_METHOD_3_03AE2FA779C07F43_OFFSET UNITYSDK_OFFSET(0x1790A0B0)
#define RPG_GAMECORE_WAITBATTLERESULT_METHOD_3_9425DF7E44C0C285_OFFSET UNITYSDK_OFFSET(0x1790A030)
#define RPG_GAMECORE_WAITBATTLERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1790A080)
