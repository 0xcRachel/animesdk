...
#define RPG_GAMECORE_ASSISTWAYPOINTPACK_METHOD_2_3571B5E4844EAD28_OFFSET UNITYSDK_OFFSET(0x16F9D6A0)
#define RPG_GAMECORE_ASSISTWAYPOINTPACK__CTOR_OFFSET UNITYSDK_OFFSET(0x16F9D8C0)
