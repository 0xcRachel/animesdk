...
#define RPG_GAMECORE_ASSISTWAYPOINTPACK_METHOD_2_3571B5E4844EAD28_OFFSET UNITYSDK_OFFSET(0x1688FC60)
#define RPG_GAMECORE_ASSISTWAYPOINTPACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1688FE80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AssistWayPointPack_TypeDefinitionIndex = 17016;
