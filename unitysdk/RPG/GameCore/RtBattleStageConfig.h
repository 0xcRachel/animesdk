...
#define RPG_GAMECORE_RTBATTLESTAGECONFIG_METHOD_2_537475945B486346_OFFSET UNITYSDK_OFFSET(0x18E772C0)
#define RPG_GAMECORE_RTBATTLESTAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18E777F0)
