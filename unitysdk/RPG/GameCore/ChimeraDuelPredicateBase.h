...
#define RPG_GAMECORE_CHIMERADUELPREDICATEBASE_METHOD_2_7EF2F4FF5908A4B0_OFFSET UNITYSDK_OFFSET(0x194C4450)
#define RPG_GAMECORE_CHIMERADUELPREDICATEBASE_METHOD_2_A2536585F11B097F_OFFSET UNITYSDK_OFFSET(0x194C4120)
#define RPG_GAMECORE_CHIMERADUELPREDICATEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x194C44B0)
