...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEBUFFSELECTCONFIG_METHOD_6_313C38EAF7CF2252_OFFSET UNITYSDK_OFFSET(0x1A9B86B0)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEBUFFSELECTCONFIG_METHOD_6_FC4016487845EEB7_OFFSET UNITYSDK_OFFSET(0x1A9B88D0)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEBUFFSELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9B87F0)
