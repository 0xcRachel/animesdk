...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_HASDICESEQUENCE_METHOD_4_B5C97371CDD670C1_OFFSET UNITYSDK_OFFSET(0x19597380)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_HASDICESEQUENCE_METHOD_4_DF1859790A515C03_OFFSET UNITYSDK_OFFSET(0x195999C0)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_HASDICESEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x195972E0)
