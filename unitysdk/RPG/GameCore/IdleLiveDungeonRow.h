...
#define RPG_GAMECORE_IDLELIVEDUNGEONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19AD4C60)
#define RPG_GAMECORE_IDLELIVEDUNGEONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD5240)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 CrystalPerHourIncrease; // 0x4C
		::RPG::Client::TextID Name; // 0x50
		::System::UInt32 ID; // 0x60
		::System::UInt32 RewardID; // 0x64
		::System::UInt32 MaxHpProgress; // 0x68
		::System::UInt32 StageID; // 0x6C
		::System::UInt32 IncomeHpProgress; // 0x70
		::System::UInt32 UnlockChapterIndex; // 0x74
		::System::UInt32 TicketPerHourIncrease; // 0x78
		::System::UInt32 BattleTime; // 0x7C
		::System::UInt32 ChestPerHourIncrease; // 0x80
