...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONAROOMCONTENTIDCONFIG_METHOD_3_DFE5C374B0CB7554_OFFSET UNITYSDK_OFFSET(0x1B345CE0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONAROOMCONTENTIDCONFIG_METHOD_3_F3FE0BED7E6DCECD_OFFSET UNITYSDK_OFFSET(0x1B33C600)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONAROOMCONTENTIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B33C5B0)
