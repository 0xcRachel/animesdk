...
#define RPG_GAMECORE_POINTGENERATORONNAVPATHCONFIG_METHOD_3_71381AF007425FC0_OFFSET UNITYSDK_OFFSET(0x17500710)
#define RPG_GAMECORE_POINTGENERATORONNAVPATHCONFIG_METHOD_3_ECCBF057757545FD_OFFSET UNITYSDK_OFFSET(0x17500560)
#define RPG_GAMECORE_POINTGENERATORONNAVPATHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17500500)
