...
#define RPG_GAMECORE_GMACCOUNTEQUIPMENTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18B793C0)
#define RPG_GAMECORE_GMACCOUNTEQUIPMENTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18B795B0)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::UInt32 ItemEquipmentLevel; // 0x10
		::System::UInt32 ItemEquipmentID; // 0x14
		::System::UInt32 ID; // 0x18
		::System::UInt32 GroupID; // 0x1C
		::System::UInt32 ItemEquipmentNum; // 0x20
