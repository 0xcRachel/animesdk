...
#define RPG_GAMECORE_TRAINPARTYSTATUSRANKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17108BC0)
#define RPG_GAMECORE_TRAINPARTYSTATUSRANKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17108D30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyStatusRankConfigRow_TypeDefinitionIndex = 13930;
