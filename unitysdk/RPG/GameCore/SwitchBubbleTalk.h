...
#define RPG_GAMECORE_SWITCHBUBBLETALK_METHOD_3_9039C7676C21521A_OFFSET UNITYSDK_OFFSET(0x1985AA90)
#define RPG_GAMECORE_SWITCHBUBBLETALK_METHOD_3_F61AFAEF7A524D23_OFFSET UNITYSDK_OFFSET(0x1985AA10)
#define RPG_GAMECORE_SWITCHBUBBLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1985AA60)
