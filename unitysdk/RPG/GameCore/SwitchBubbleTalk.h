...
#define RPG_GAMECORE_SWITCHBUBBLETALK_METHOD_3_9039C7676C21521A_OFFSET UNITYSDK_OFFSET(0x16FB1D40)
#define RPG_GAMECORE_SWITCHBUBBLETALK_METHOD_3_F61AFAEF7A524D23_OFFSET UNITYSDK_OFFSET(0x16FB1CC0)
#define RPG_GAMECORE_SWITCHBUBBLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x16FB1D10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchBubbleTalk_TypeDefinitionIndex = 19951;
