...
#define RPG_GAMECORE_MOVETOTARGETLIST_METHOD_3_439FB2BC651E184E_OFFSET UNITYSDK_OFFSET(0x16CE5CC0)
#define RPG_GAMECORE_MOVETOTARGETLIST_METHOD_3_513BE0D63C05C07A_OFFSET UNITYSDK_OFFSET(0x16CE5E70)
#define RPG_GAMECORE_MOVETOTARGETLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x16CE5D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MoveToTargetList_TypeDefinitionIndex = 20109;
