...
#define RPG_GAMECORE_ADVBYCOMPAREENHANCEDID_METHOD_4_97DD49AACD78F8E7_OFFSET UNITYSDK_OFFSET(0x16F3A1C0)
#define RPG_GAMECORE_ADVBYCOMPAREENHANCEDID_METHOD_4_C0839328241C0457_OFFSET UNITYSDK_OFFSET(0x16F3A0F0)
#define RPG_GAMECORE_ADVBYCOMPAREENHANCEDID__CTOR_OFFSET UNITYSDK_OFFSET(0x16F3A170)
