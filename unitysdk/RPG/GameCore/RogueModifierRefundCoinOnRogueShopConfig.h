...
#define RPG_GAMECORE_ROGUEMODIFIERREFUNDCOINONROGUESHOPCONFIG_METHOD_3_747F0A49EE659D80_OFFSET UNITYSDK_OFFSET(0x1764C3A0)
#define RPG_GAMECORE_ROGUEMODIFIERREFUNDCOINONROGUESHOPCONFIG_METHOD_3_82C05C7538D305E9_OFFSET UNITYSDK_OFFSET(0x1764C2D0)
#define RPG_GAMECORE_ROGUEMODIFIERREFUNDCOINONROGUESHOPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1764C350)
