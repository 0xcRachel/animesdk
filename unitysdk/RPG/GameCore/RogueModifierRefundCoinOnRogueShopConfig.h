...
#define RPG_GAMECORE_ROGUEMODIFIERREFUNDCOINONROGUESHOPCONFIG_METHOD_3_747F0A49EE659D80_OFFSET UNITYSDK_OFFSET(0x16E9B2D0)
#define RPG_GAMECORE_ROGUEMODIFIERREFUNDCOINONROGUESHOPCONFIG_METHOD_3_82C05C7538D305E9_OFFSET UNITYSDK_OFFSET(0x16EA15C0)
#define RPG_GAMECORE_ROGUEMODIFIERREFUNDCOINONROGUESHOPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E9B280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierRefundCoinOnRogueShopConfig_TypeDefinitionIndex = 16173;
