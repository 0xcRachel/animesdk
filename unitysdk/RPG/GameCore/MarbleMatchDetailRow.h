...
#define RPG_GAMECORE_MARBLEMATCHDETAILROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16C40430)
#define RPG_GAMECORE_MARBLEMATCHDETAILROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16C40580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleMatchDetailRow_TypeDefinitionIndex = 10838;
