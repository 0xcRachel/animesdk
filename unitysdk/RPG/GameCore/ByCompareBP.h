...
#define RPG_GAMECORE_BYCOMPAREBP_METHOD_4_54D45E9FA7386D4C_OFFSET UNITYSDK_OFFSET(0x169065D0)
#define RPG_GAMECORE_BYCOMPAREBP_METHOD_4_EAE488BABB89F7AC_OFFSET UNITYSDK_OFFSET(0x169064F0)
#define RPG_GAMECORE_BYCOMPAREBP__CTOR_OFFSET UNITYSDK_OFFSET(0x16906570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareBP_TypeDefinitionIndex = 20713;
