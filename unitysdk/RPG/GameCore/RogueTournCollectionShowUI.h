...
#define RPG_GAMECORE_ROGUETOURNCOLLECTIONSHOWUI_METHOD_3_0A1E739F0C99B91C_OFFSET UNITYSDK_OFFSET(0x17676340)
#define RPG_GAMECORE_ROGUETOURNCOLLECTIONSHOWUI_METHOD_3_3EB674BFD6417B7F_OFFSET UNITYSDK_OFFSET(0x176763C0)
#define RPG_GAMECORE_ROGUETOURNCOLLECTIONSHOWUI__CTOR_OFFSET UNITYSDK_OFFSET(0x17676390)
