...
#define RPG_GAMECORE_ROGUEADVENTUREROOMRAYPROCESS_METHOD_3_56ACD268BEBA407D_OFFSET UNITYSDK_OFFSET(0x19238950)
#define RPG_GAMECORE_ROGUEADVENTUREROOMRAYPROCESS_METHOD_3_F9C7918C5E106D65_OFFSET UNITYSDK_OFFSET(0x19238870)
#define RPG_GAMECORE_ROGUEADVENTUREROOMRAYPROCESS__CTOR_OFFSET UNITYSDK_OFFSET(0x192388F0)
