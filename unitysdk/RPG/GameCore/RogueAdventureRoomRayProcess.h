...
#define RPG_GAMECORE_ROGUEADVENTUREROOMRAYPROCESS_METHOD_3_56ACD268BEBA407D_OFFSET UNITYSDK_OFFSET(0x16E12580)
#define RPG_GAMECORE_ROGUEADVENTUREROOMRAYPROCESS_METHOD_3_F9C7918C5E106D65_OFFSET UNITYSDK_OFFSET(0x16E124A0)
#define RPG_GAMECORE_ROGUEADVENTUREROOMRAYPROCESS__CTOR_OFFSET UNITYSDK_OFFSET(0x16E12520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAdventureRoomRayProcess_TypeDefinitionIndex = 19937;
