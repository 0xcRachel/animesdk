...
#define RPG_GAMECORE_FIVEDIMSIMPLEPROJECTILEBAKEDMOVECONFIG_METHOD_3_52034573CA466F85_OFFSET UNITYSDK_OFFSET(0x16ACE460)
#define RPG_GAMECORE_FIVEDIMSIMPLEPROJECTILEBAKEDMOVECONFIG_METHOD_3_8481EA49A3240EF4_OFFSET UNITYSDK_OFFSET(0x16AD5030)
#define RPG_GAMECORE_FIVEDIMSIMPLEPROJECTILEBAKEDMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16ACE450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSimpleProjectileBakedMoveConfig_TypeDefinitionIndex = 15037;
