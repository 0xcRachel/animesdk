...
#define RPG_GAMECORE_PLAYTRAINPARTYSIMPLETALK_METHOD_3_002E5480C279B869_OFFSET UNITYSDK_OFFSET(0x19D595C0)
#define RPG_GAMECORE_PLAYTRAINPARTYSIMPLETALK_METHOD_3_E8265053C552FDD0_OFFSET UNITYSDK_OFFSET(0x19D59540)
#define RPG_GAMECORE_PLAYTRAINPARTYSIMPLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x19D59590)
