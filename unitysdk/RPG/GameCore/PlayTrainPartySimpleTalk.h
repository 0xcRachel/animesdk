...
#define RPG_GAMECORE_PLAYTRAINPARTYSIMPLETALK_METHOD_3_4E023831E379E8E3_OFFSET UNITYSDK_OFFSET(0x16D542F0)
#define RPG_GAMECORE_PLAYTRAINPARTYSIMPLETALK_METHOD_3_E6FB23D8460CABB2_OFFSET UNITYSDK_OFFSET(0x16D54270)
#define RPG_GAMECORE_PLAYTRAINPARTYSIMPLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x16D542C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayTrainPartySimpleTalk_TypeDefinitionIndex = 20019;
