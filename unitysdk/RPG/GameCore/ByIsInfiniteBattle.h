...
#define RPG_GAMECORE_BYISINFINITEBATTLE_METHOD_4_1DD51CA7496C7926_OFFSET UNITYSDK_OFFSET(0x169334E0)
#define RPG_GAMECORE_BYISINFINITEBATTLE_METHOD_4_B544E3689D95B9AC_OFFSET UNITYSDK_OFFSET(0x169335B0)
#define RPG_GAMECORE_BYISINFINITEBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16933560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsInfiniteBattle_TypeDefinitionIndex = 20719;
