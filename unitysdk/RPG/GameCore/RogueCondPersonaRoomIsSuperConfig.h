...
#define RPG_GAMECORE_ROGUECONDPERSONAROOMISSUPERCONFIG_METHOD_6_83F3A7F3DFED8F66_OFFSET UNITYSDK_OFFSET(0x17600D40)
#define RPG_GAMECORE_ROGUECONDPERSONAROOMISSUPERCONFIG_METHOD_6_C051934CFD1C587A_OFFSET UNITYSDK_OFFSET(0x17600B80)
#define RPG_GAMECORE_ROGUECONDPERSONAROOMISSUPERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17600C80)
