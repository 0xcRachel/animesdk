...
#define RPG_GAMECORE_SHOWROGUEHANDBOOKUI_METHOD_3_146C90A561B4663E_OFFSET UNITYSDK_OFFSET(0x193AF3C0)
#define RPG_GAMECORE_SHOWROGUEHANDBOOKUI_METHOD_3_1566CB95C1FAD752_OFFSET UNITYSDK_OFFSET(0x193AF340)
#define RPG_GAMECORE_SHOWROGUEHANDBOOKUI__CTOR_OFFSET UNITYSDK_OFFSET(0x193AF390)
