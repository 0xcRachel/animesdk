...
#define RPG_GAMECORE_CHIMERADUELPRESETTEAMCONFIG_METHOD_2_47F4F91F30990E56_OFFSET UNITYSDK_OFFSET(0x194C4640)
#define RPG_GAMECORE_CHIMERADUELPRESETTEAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x194C49C0)
