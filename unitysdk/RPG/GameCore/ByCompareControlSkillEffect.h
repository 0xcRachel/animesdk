...
#define RPG_GAMECORE_BYCOMPARECONTROLSKILLEFFECT_METHOD_4_01FCC972E4DF4357_OFFSET UNITYSDK_OFFSET(0x16908830)
#define RPG_GAMECORE_BYCOMPARECONTROLSKILLEFFECT_METHOD_4_493C6555934B486B_OFFSET UNITYSDK_OFFSET(0x16908760)
#define RPG_GAMECORE_BYCOMPARECONTROLSKILLEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x169087E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareControlSkillEffect_TypeDefinitionIndex = 20679;
