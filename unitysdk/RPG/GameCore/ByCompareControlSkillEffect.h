...
#define RPG_GAMECORE_BYCOMPARECONTROLSKILLEFFECT_METHOD_4_01FCC972E4DF4357_OFFSET UNITYSDK_OFFSET(0x17019660)
#define RPG_GAMECORE_BYCOMPARECONTROLSKILLEFFECT_METHOD_4_493C6555934B486B_OFFSET UNITYSDK_OFFSET(0x17019590)
#define RPG_GAMECORE_BYCOMPARECONTROLSKILLEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x17019610)
