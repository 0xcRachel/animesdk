...
#define RPG_GAMECORE_TARGETFETCHLATESTENTERSTAGEAVATAR_METHOD_4_10B38847DD6D6316_OFFSET UNITYSDK_OFFSET(0x199DAC60)
#define RPG_GAMECORE_TARGETFETCHLATESTENTERSTAGEAVATAR_METHOD_4_FFF4A56BFE1D7A54_OFFSET UNITYSDK_OFFSET(0x199E1970)
#define RPG_GAMECORE_TARGETFETCHLATESTENTERSTAGEAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x199DAC10)
