...
#define RPG_GAMECORE_ACTIVITYPUNKLORDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16F1A800)
#define RPG_GAMECORE_ACTIVITYPUNKLORDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16F1AD70)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 ExistTime; // 0x40
		::System::UInt32 ID; // 0x44
		::System::UInt32 AssistPoint; // 0x48
		::RPG::GameCore::PunkLordGroupType GroupType; // 0x4C
		::System::UInt32 KillPoint; // 0x50
		::System::UInt32 MonsterHP; // 0x54
		::System::UInt32 MonsterLevel; // 0x58
		::System::UInt32 PluralHP; // 0x5C
		::RPG::GameCore::PunkLordMonsterRare MonsterRare; // 0x60
