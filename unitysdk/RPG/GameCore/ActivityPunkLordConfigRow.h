...
#define RPG_GAMECORE_ACTIVITYPUNKLORDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19536400)
#define RPG_GAMECORE_ACTIVITYPUNKLORDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19536970)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 SummonPoint; // 0x28
		::System::UInt32 AssistPoint; // 0x2C
		::System::UInt32 KillPoint; // 0x30
		::System::UInt32 TurnLimit; // 0x34
		::System::UInt32 ID; // 0x38
		::System::UInt32 RaidID; // 0x3C
		::System::UInt32 PluralHP; // 0x40
		::System::UInt32 MonsterLevel; // 0x44
		::RPG::GameCore::PunkLordMonsterRare MonsterRare; // 0x48
		::System::UInt32 ExistTime; // 0x4C
		::System::UInt32 MonsterHP; // 0x50
		::RPG::Client::TextID MonsterBuff; // 0x58
		::System::UInt32 WorldLevel; // 0x68
		::RPG::GameCore::PunkLordGroupType GroupType; // 0x6C
