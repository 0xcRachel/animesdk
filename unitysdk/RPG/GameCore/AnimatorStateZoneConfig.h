...
#define RPG_GAMECORE_ANIMATORSTATEZONECONFIG_METHOD_2_B63A3F10DFA80EA3_OFFSET UNITYSDK_OFFSET(0x18AD7BE0)
#define RPG_GAMECORE_ANIMATORSTATEZONECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18AD91C0)
