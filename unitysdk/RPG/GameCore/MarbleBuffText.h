...
#define RPG_GAMECORE_MARBLEBUFFTEXT_METHOD_3_801751DAE0E58958_OFFSET UNITYSDK_OFFSET(0x1739CC50)
#define RPG_GAMECORE_MARBLEBUFFTEXT_METHOD_3_A73D56702C562A34_OFFSET UNITYSDK_OFFSET(0x1739CD30)
#define RPG_GAMECORE_MARBLEBUFFTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1739CCE0)
