...
#define RPG_GAMECORE_FIXPOINTACCUMULATOR_ADDFP_OFFSET UNITYSDK_OFFSET(0x20F1A40)
...
#define RPG_GAMECORE_FIXPOINTACCUMULATOR_RESET_OFFSET UNITYSDK_OFFSET(0x20F1AC0)
#define RPG_GAMECORE_FIXPOINTACCUMULATOR_TODECIMAL_OFFSET UNITYSDK_OFFSET(0x20F1AE0)
