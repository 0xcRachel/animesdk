...
#define RPG_GAMECORE_FIXPOINTACCUMULATOR_ADDFP_OFFSET UNITYSDK_OFFSET(0x201B390)
...
#define RPG_GAMECORE_FIXPOINTACCUMULATOR_RESET_OFFSET UNITYSDK_OFFSET(0x201B410)
#define RPG_GAMECORE_FIXPOINTACCUMULATOR_TODECIMAL_OFFSET UNITYSDK_OFFSET(0x201B430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FixPointAccumulator_TypeDefinitionIndex = 8827;
