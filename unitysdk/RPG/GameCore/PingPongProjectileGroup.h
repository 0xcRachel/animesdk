...
#define RPG_GAMECORE_PINGPONGPROJECTILEGROUP_METHOD_2_10D5366BF50916E5_OFFSET UNITYSDK_OFFSET(0x16D3E7C0)
#define RPG_GAMECORE_PINGPONGPROJECTILEGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x16D3E960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongProjectileGroup_TypeDefinitionIndex = 15299;
