...
#define RPG_GAMECORE_MODIFYSKILLPROPERTYBYTYPE_METHOD_3_930D3BA084BC89C4_OFFSET UNITYSDK_OFFSET(0x16CC1F00)
#define RPG_GAMECORE_MODIFYSKILLPROPERTYBYTYPE_METHOD_3_ADDBB4E0B3A1679A_OFFSET UNITYSDK_OFFSET(0x16CC1E30)
#define RPG_GAMECORE_MODIFYSKILLPROPERTYBYTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x16CC1EB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifySkillPropertyByType_TypeDefinitionIndex = 21233;
