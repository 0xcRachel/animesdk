...
#define RPG_GAMECORE_MODIFYSKILLPROPERTYBYTYPE_METHOD_3_930D3BA084BC89C4_OFFSET UNITYSDK_OFFSET(0x17448900)
#define RPG_GAMECORE_MODIFYSKILLPROPERTYBYTYPE_METHOD_3_ADDBB4E0B3A1679A_OFFSET UNITYSDK_OFFSET(0x17448830)
#define RPG_GAMECORE_MODIFYSKILLPROPERTYBYTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x174488B0)
