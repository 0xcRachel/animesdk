...
#define RPG_GAMECORE_CAKERACECYLINDERCOLLIDERCONFIG_METHOD_3_C43367CD5FF1C553_OFFSET UNITYSDK_OFFSET(0x1705EE30)
#define RPG_GAMECORE_CAKERACECYLINDERCOLLIDERCONFIG_METHOD_3_D660F5F8D03A3D0F_OFFSET UNITYSDK_OFFSET(0x1705EDA0)
#define RPG_GAMECORE_CAKERACECYLINDERCOLLIDERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1705EE10)
