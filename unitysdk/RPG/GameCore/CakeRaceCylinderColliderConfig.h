...
#define RPG_GAMECORE_CAKERACECYLINDERCOLLIDERCONFIG_METHOD_3_C43367CD5FF1C553_OFFSET UNITYSDK_OFFSET(0x1694CE40)
#define RPG_GAMECORE_CAKERACECYLINDERCOLLIDERCONFIG_METHOD_3_D660F5F8D03A3D0F_OFFSET UNITYSDK_OFFSET(0x1694CDB0)
#define RPG_GAMECORE_CAKERACECYLINDERCOLLIDERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1694CE20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceCylinderColliderConfig_TypeDefinitionIndex = 16550;
