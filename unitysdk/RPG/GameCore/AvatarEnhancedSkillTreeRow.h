...
#define RPG_GAMECORE_AVATARENHANCEDSKILLTREEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16FB1200)
#define RPG_GAMECORE_AVATARENHANCEDSKILLTREEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16FB15B0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID DescBefore; // 0x48
