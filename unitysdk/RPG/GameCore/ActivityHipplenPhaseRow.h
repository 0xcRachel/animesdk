...
#define RPG_GAMECORE_ACTIVITYHIPPLENPHASEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1952DF60)
#define RPG_GAMECORE_ACTIVITYHIPPLENPHASEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1952E490)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* MiniGameAreaPath; // 0x28
		::Il2CppArray<::System::UInt32>* StatRange; // 0x30
		::System::Boolean ForwardTrialClosePage; // 0x38
		::System::Boolean BackwardTrialClosePage; // 0x39
		::System::UInt32 ActionPointsTotal; // 0x3C
		::System::UInt32 TrialGameID; // 0x40
		::System::UInt32 PhaseType; // 0x44
		::RPG::Client::TextID TrailTargetDesc; // 0x48
		::System::UInt32 CycleID; // 0x58
		::System::UInt32 ForwardTrialSubMissionID; // 0x5C
		::System::UInt32 GrowthPhaseID; // 0x60
