...
#define RPG_GAMECORE_ACTIVITYHIPPLENPHASEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1679B640)
#define RPG_GAMECORE_ACTIVITYHIPPLENPHASEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1679BB90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityHipplenPhaseRow_TypeDefinitionIndex = 10760;
	...
	public:
		...
		::System::UInt32 PhaseType; // 0x3C
		::RPG::Client::TextID TrailTargetDesc; // 0x40
		::System::UInt32 TrialGameID; // 0x50
		::System::UInt32 ForwardTrialSubMissionID; // 0x54
		::System::UInt32 ActionPointsTotal; // 0x58
		::System::UInt32 GrowthPhaseID; // 0x5C
		::System::Boolean ForwardTrialClosePage; // 0x60
		::System::Boolean BackwardTrialClosePage; // 0x61
