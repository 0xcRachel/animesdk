...
#define RPG_GAMECORE_STORYPROPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16FA1EB0)
#define RPG_GAMECORE_STORYPROPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16FA20D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StoryPropRow_TypeDefinitionIndex = 13801;
