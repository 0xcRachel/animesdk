...
#define RPG_GAMECORE_BYISBODYPART_METHOD_4_3CD83BCFF5008EB6_OFFSET UNITYSDK_OFFSET(0x1692CE80)
#define RPG_GAMECORE_BYISBODYPART_METHOD_4_D5092F1293684E94_OFFSET UNITYSDK_OFFSET(0x1692D0C0)
#define RPG_GAMECORE_BYISBODYPART__CTOR_OFFSET UNITYSDK_OFFSET(0x1692D070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsBodyPart_TypeDefinitionIndex = 20992;
