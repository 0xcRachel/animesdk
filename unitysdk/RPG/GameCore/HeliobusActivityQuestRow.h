...
#define RPG_GAMECORE_HELIOBUSACTIVITYQUESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x172AEA20)
#define RPG_GAMECORE_HELIOBUSACTIVITYQUESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x172AF150)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 TypeGroupID; // 0x1C
