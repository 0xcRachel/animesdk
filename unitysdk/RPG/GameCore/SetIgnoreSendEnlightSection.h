...
#define RPG_GAMECORE_SETIGNORESENDENLIGHTSECTION_METHOD_3_22B1EB703954E9EF_OFFSET UNITYSDK_OFFSET(0x16F309F0)
#define RPG_GAMECORE_SETIGNORESENDENLIGHTSECTION_METHOD_3_5AA69F2A9B692E1E_OFFSET UNITYSDK_OFFSET(0x16F30A70)
#define RPG_GAMECORE_SETIGNORESENDENLIGHTSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16F30A40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetIgnoreSendEnlightSection_TypeDefinitionIndex = 19567;
