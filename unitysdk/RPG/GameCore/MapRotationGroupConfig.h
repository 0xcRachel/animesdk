...
#define RPG_GAMECORE_MAPROTATIONGROUPCONFIG_METHOD_2_4561D7CD54A976A0_OFFSET UNITYSDK_OFFSET(0x16C300C0)
#define RPG_GAMECORE_MAPROTATIONGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16C30280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MapRotationGroupConfig_TypeDefinitionIndex = 15352;
