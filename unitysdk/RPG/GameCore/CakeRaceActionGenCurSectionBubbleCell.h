...
#define RPG_GAMECORE_CAKERACEACTIONGENCURSECTIONBUBBLECELL_METHOD_3_194077F48C663574_OFFSET UNITYSDK_OFFSET(0x16949340)
#define RPG_GAMECORE_CAKERACEACTIONGENCURSECTIONBUBBLECELL_METHOD_3_2E1D12AB820F3A87_OFFSET UNITYSDK_OFFSET(0x16947520)
#define RPG_GAMECORE_CAKERACEACTIONGENCURSECTIONBUBBLECELL__CTOR_OFFSET UNITYSDK_OFFSET(0x16947500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionGenCurSectionBubbleCell_TypeDefinitionIndex = 16462;
