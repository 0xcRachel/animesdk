...
#define RPG_GAMECORE_ISLANDSTATECONFIG_METHOD_2_CB849C350E5A1BEC_OFFSET UNITYSDK_OFFSET(0x16B876F0)
#define RPG_GAMECORE_ISLANDSTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16B87820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IslandStateConfig_TypeDefinitionIndex = 17139;
