...
#define RPG_GAMECORE_ISLANDSTATECONFIG_METHOD_2_CB849C350E5A1BEC_OFFSET UNITYSDK_OFFSET(0x18894960)
#define RPG_GAMECORE_ISLANDSTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18894A90)
