...
#define RPG_GAMECORE_PETCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16D30480)
#define RPG_GAMECORE_PETCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16D305C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PetConfigRow_TypeDefinitionIndex = 13114;
