...
#define RPG_GAMECORE_BYRANDOMCHANCE_METHOD_4_09C6DFF233966578_OFFSET UNITYSDK_OFFSET(0x1693C300)
#define RPG_GAMECORE_BYRANDOMCHANCE_METHOD_4_F3DEF6BA0C7ADF0E_OFFSET UNITYSDK_OFFSET(0x1693C3D0)
#define RPG_GAMECORE_BYRANDOMCHANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1693C380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByRandomChance_TypeDefinitionIndex = 20645;
