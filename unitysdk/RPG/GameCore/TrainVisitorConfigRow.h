...
#define RPG_GAMECORE_TRAINVISITORCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19A2CC60)
#define RPG_GAMECORE_TRAINVISITORCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19A2E420)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID MessageCome; // 0x18
		::RPG::Client::TextID MessageLeave; // 0x28
		::System::UInt32 MissionID; // 0x38
		::System::UInt32 VisitorID; // 0x3C
		::System::UInt32 LockMissionID; // 0x40
		::System::Boolean ToastFinishMainMission; // 0x44
