...
#define RPG_GAMECORE_CHARACTEROVERRIDECONFIG_METHOD_3_2C01EA1AF3BDA280_OFFSET UNITYSDK_OFFSET(0x16972AF0)
#define RPG_GAMECORE_CHARACTEROVERRIDECONFIG_METHOD_3_B2525A63B6135506_OFFSET UNITYSDK_OFFSET(0x1696BC90)
#define RPG_GAMECORE_CHARACTEROVERRIDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1696BC80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterOverrideConfig_TypeDefinitionIndex = 14875;
