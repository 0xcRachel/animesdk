...
#define RPG_GAMECORE_ELATIONACTIONBARABILITYCHANGE_METHOD_3_902BA481967CB9E7_OFFSET UNITYSDK_OFFSET(0x1914ACF0)
#define RPG_GAMECORE_ELATIONACTIONBARABILITYCHANGE_METHOD_3_D5434E9DC65D2F9E_OFFSET UNITYSDK_OFFSET(0x1914AD70)
#define RPG_GAMECORE_ELATIONACTIONBARABILITYCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1914AD40)
