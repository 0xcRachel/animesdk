...
#define RPG_GAMECORE_ADVENTUREBEHAVIORCONFIG_METHOD_2_97816108FAF1CBF6_OFFSET UNITYSDK_OFFSET(0x18C65BE0)
#define RPG_GAMECORE_ADVENTUREBEHAVIORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18C65F90)
