...
#define RPG_GAMECORE_NPCMONSTERMARKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16CFAF50)
#define RPG_GAMECORE_NPCMONSTERMARKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16CFB0C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NPCMonsterMarkRow_TypeDefinitionIndex = 13014;
