...
#define RPG_GAMECORE_GRIDFIGHTACTIONCOPYNPCCONFIG_METHOD_6_CD747DC922583276_OFFSET UNITYSDK_OFFSET(0x17264400)
#define RPG_GAMECORE_GRIDFIGHTACTIONCOPYNPCCONFIG_METHOD_6_D707F19B91C747E5_OFFSET UNITYSDK_OFFSET(0x17264DD0)
#define RPG_GAMECORE_GRIDFIGHTACTIONCOPYNPCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17264360)
