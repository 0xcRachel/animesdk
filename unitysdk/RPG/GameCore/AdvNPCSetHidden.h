...
#define RPG_GAMECORE_ADVNPCSETHIDDEN_METHOD_3_9822F1A1724FEBAB_OFFSET UNITYSDK_OFFSET(0x18C4FB30)
#define RPG_GAMECORE_ADVNPCSETHIDDEN_METHOD_3_FC18D9AD8B46FA82_OFFSET UNITYSDK_OFFSET(0x18C4FBB0)
#define RPG_GAMECORE_ADVNPCSETHIDDEN__CTOR_OFFSET UNITYSDK_OFFSET(0x18C4FB80)
