...
#define RPG_GAMECORE_PLAYERRETURNRELICROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16D76ED0)
#define RPG_GAMECORE_PLAYERRETURNRELICROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16D77090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayerReturnRelicRow_TypeDefinitionIndex = 13200;
	...
	public:
		...
		::System::Boolean IsRelicMatchMainAffix; // 0x1C
