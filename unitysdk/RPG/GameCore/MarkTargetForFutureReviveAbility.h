...
#define RPG_GAMECORE_MARKTARGETFORFUTUREREVIVEABILITY_METHOD_3_7973221F4DB92A3F_OFFSET UNITYSDK_OFFSET(0x173B38C0)
#define RPG_GAMECORE_MARKTARGETFORFUTUREREVIVEABILITY_METHOD_3_B8FACA5C15526B0E_OFFSET UNITYSDK_OFFSET(0x173B3840)
#define RPG_GAMECORE_MARKTARGETFORFUTUREREVIVEABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x173B3890)
