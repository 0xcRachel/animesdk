...
#define RPG_GAMECORE_ROGUEACTCHANGELINEUPSPCONFIG_METHOD_6_1167672F41D9CDC5_OFFSET UNITYSDK_OFFSET(0x175C6DF0)
#define RPG_GAMECORE_ROGUEACTCHANGELINEUPSPCONFIG_METHOD_6_30092C52AD80F218_OFFSET UNITYSDK_OFFSET(0x175C7010)
#define RPG_GAMECORE_ROGUEACTCHANGELINEUPSPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175C6F30)
