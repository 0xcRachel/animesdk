...
#define RPG_GAMECORE_SETAVATARDEPART_METHOD_3_A0AC6C8334553848_OFFSET UNITYSDK_OFFSET(0x176BC650)
#define RPG_GAMECORE_SETAVATARDEPART_METHOD_3_A8D0DA75C448B4AD_OFFSET UNITYSDK_OFFSET(0x176BC720)
#define RPG_GAMECORE_SETAVATARDEPART__CTOR_OFFSET UNITYSDK_OFFSET(0x176BC6D0)
