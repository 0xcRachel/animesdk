...
#define RPG_GAMECORE_SETAVATARDEPART_METHOD_3_A0AC6C8334553848_OFFSET UNITYSDK_OFFSET(0x1A1E4210)
#define RPG_GAMECORE_SETAVATARDEPART_METHOD_3_A8D0DA75C448B4AD_OFFSET UNITYSDK_OFFSET(0x1A1E42E0)
#define RPG_GAMECORE_SETAVATARDEPART__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1E4290)
