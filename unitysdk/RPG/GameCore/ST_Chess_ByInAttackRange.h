...
#define RPG_GAMECORE_ST_CHESS_BYINATTACKRANGE_METHOD_4_4CB97EE7D6A2667E_OFFSET UNITYSDK_OFFSET(0x16EF21B0)
#define RPG_GAMECORE_ST_CHESS_BYINATTACKRANGE_METHOD_4_8C74B41CAF221880_OFFSET UNITYSDK_OFFSET(0x16EF2280)
#define RPG_GAMECORE_ST_CHESS_BYINATTACKRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16EF2230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Chess_ByInAttackRange_TypeDefinitionIndex = 21443;
