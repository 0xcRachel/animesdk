...
#define RPG_GAMECORE_EFFECTMODIFYDATA_METHOD_2_3D89A14728373C7D_OFFSET UNITYSDK_OFFSET(0x19D66240)
#define RPG_GAMECORE_EFFECTMODIFYDATA_METHOD_2_556C152397FF3202_OFFSET UNITYSDK_OFFSET(0x19D660B0)
#define RPG_GAMECORE_EFFECTMODIFYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19D66230)
