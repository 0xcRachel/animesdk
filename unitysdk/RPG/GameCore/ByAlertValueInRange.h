...
#define RPG_GAMECORE_BYALERTVALUEINRANGE_METHOD_4_661BCDFF6B4561DD_OFFSET UNITYSDK_OFFSET(0x168FC9D0)
#define RPG_GAMECORE_BYALERTVALUEINRANGE_METHOD_4_F4F631AD510D0F8D_OFFSET UNITYSDK_OFFSET(0x168FCAA0)
#define RPG_GAMECORE_BYALERTVALUEINRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x168FCA50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByAlertValueInRange_TypeDefinitionIndex = 17792;
