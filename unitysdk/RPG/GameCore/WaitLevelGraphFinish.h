...
#define RPG_GAMECORE_WAITLEVELGRAPHFINISH_METHOD_3_6C8578269E41A10A_OFFSET UNITYSDK_OFFSET(0x1952E020)
#define RPG_GAMECORE_WAITLEVELGRAPHFINISH_METHOD_3_CEA3541F965C655D_OFFSET UNITYSDK_OFFSET(0x1952DFA0)
#define RPG_GAMECORE_WAITLEVELGRAPHFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1952DFF0)
