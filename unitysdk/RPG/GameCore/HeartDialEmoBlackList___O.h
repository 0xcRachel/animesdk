...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::HeartDialEmoType>**)Il2CppClass::FromTypeDefinitionIndex(HeartDialEmoBlackList___O_TypeDefinitionIndex)->GetStaticField(0x36E80);
		}
	};
}
