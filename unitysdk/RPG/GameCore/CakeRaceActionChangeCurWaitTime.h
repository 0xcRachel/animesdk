...
#define RPG_GAMECORE_CAKERACEACTIONCHANGECURWAITTIME_METHOD_3_321A8915806F3C58_OFFSET UNITYSDK_OFFSET(0x19A7CAF0)
#define RPG_GAMECORE_CAKERACEACTIONCHANGECURWAITTIME_METHOD_3_E6CF9C6B10A6CD46_OFFSET UNITYSDK_OFFSET(0x19A7A1C0)
#define RPG_GAMECORE_CAKERACEACTIONCHANGECURWAITTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x19A7A1A0)
