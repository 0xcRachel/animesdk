...
#define RPG_GAMECORE_LEVELPROPINFO_METHOD_4_3E4A3F8653C9EDC8_OFFSET UNITYSDK_OFFSET(0x16BB3AA0)
#define RPG_GAMECORE_LEVELPROPINFO_METHOD_4_79E8BD454C31F2CD_OFFSET UNITYSDK_OFFSET(0x16BBB4C0)
#define RPG_GAMECORE_LEVELPROPINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16BB39D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPropInfo_TypeDefinitionIndex = 15578;
