...
#define RPG_GAMECORE_CALCPITCHANGLE_METHOD_3_A5F3D5A683C9F115_OFFSET UNITYSDK_OFFSET(0x169542A0)
#define RPG_GAMECORE_CALCPITCHANGLE_METHOD_3_D18007096DDFE63B_OFFSET UNITYSDK_OFFSET(0x16954320)
#define RPG_GAMECORE_CALCPITCHANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x169542F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CalcPitchAngle_TypeDefinitionIndex = 18009;
