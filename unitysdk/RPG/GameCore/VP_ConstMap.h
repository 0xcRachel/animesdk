...
#define RPG_GAMECORE_VP_CONSTMAP_METHOD_3_9B3B7077F2B5C352_OFFSET UNITYSDK_OFFSET(0x1951DB50)
#define RPG_GAMECORE_VP_CONSTMAP_METHOD_3_FDFA389EF16850B9_OFFSET UNITYSDK_OFFSET(0x1951DB90)
#define RPG_GAMECORE_VP_CONSTMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1951DB80)
