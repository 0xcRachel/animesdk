...
#define RPG_GAMECORE_MARBLEONFIELD_METHOD_3_103F44BF468FE4F9_OFFSET UNITYSDK_OFFSET(0x173A7C50)
#define RPG_GAMECORE_MARBLEONFIELD_METHOD_3_87B6914A5B4C89E2_OFFSET UNITYSDK_OFFSET(0x173A7D30)
#define RPG_GAMECORE_MARBLEONFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x173A7CE0)
