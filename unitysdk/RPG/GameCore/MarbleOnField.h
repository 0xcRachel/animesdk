...
#define RPG_GAMECORE_MARBLEONFIELD_METHOD_3_103F44BF468FE4F9_OFFSET UNITYSDK_OFFSET(0x16C42DE0)
#define RPG_GAMECORE_MARBLEONFIELD_METHOD_3_87B6914A5B4C89E2_OFFSET UNITYSDK_OFFSET(0x16C42EC0)
#define RPG_GAMECORE_MARBLEONFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x16C42E70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleOnField_TypeDefinitionIndex = 15170;
