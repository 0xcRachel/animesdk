...
#define RPG_GAMECORE_BYCOMPAREGROUPPROPERTY_METHOD_4_456639A9F315CF12_OFFSET UNITYSDK_OFFSET(0x1690DEE0)
#define RPG_GAMECORE_BYCOMPAREGROUPPROPERTY_METHOD_4_7E2080CEA49D282C_OFFSET UNITYSDK_OFFSET(0x1690DE00)
#define RPG_GAMECORE_BYCOMPAREGROUPPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1690DE80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareGroupProperty_TypeDefinitionIndex = 18529;
