...
#define RPG_GAMECORE_CLOCKPARKSPECIALMISSIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x194E1330)
#define RPG_GAMECORE_CLOCKPARKSPECIALMISSIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x194E1AE0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 SpecialMissionGotoIDAfter; // 0x20
		::System::UInt32 SpecialMissionUnlockItemID; // 0x24
		::System::UInt32 EventNum; // 0x28
		::RPG::Client::TextID EventName; // 0x30
		::System::UInt32 SpecialMissionGotoIDBefore; // 0x40
		::System::UInt32 EventScript; // 0x44
		::System::UInt32 SpecialMissionMapInfo; // 0x48
		::System::UInt32 SpecialMissionID; // 0x4C
