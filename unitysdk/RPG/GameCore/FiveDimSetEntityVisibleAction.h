...
#define RPG_GAMECORE_FIVEDIMSETENTITYVISIBLEACTION_METHOD_3_46C19EDFAAE9BAFC_OFFSET UNITYSDK_OFFSET(0x1A3A1A90)
#define RPG_GAMECORE_FIVEDIMSETENTITYVISIBLEACTION_METHOD_3_470721F925674C30_OFFSET UNITYSDK_OFFSET(0x1A3A1960)
#define RPG_GAMECORE_FIVEDIMSETENTITYVISIBLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3A1A70)
