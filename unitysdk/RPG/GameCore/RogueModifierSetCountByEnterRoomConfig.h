...
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYENTERROOMCONFIG_METHOD_3_BEB6CD6ED26693F6_OFFSET UNITYSDK_OFFSET(0x16EA2510)
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYENTERROOMCONFIG_METHOD_3_E42478DBBD6E36AF_OFFSET UNITYSDK_OFFSET(0x16E9CD10)
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYENTERROOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E9CCC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierSetCountByEnterRoomConfig_TypeDefinitionIndex = 15989;
