...
#define RPG_GAMECORE_ADVMONSTERFORBIDSELECT_METHOD_3_2826DDAAFAC35CCD_OFFSET UNITYSDK_OFFSET(0x1683AB50)
#define RPG_GAMECORE_ADVMONSTERFORBIDSELECT_METHOD_3_8F7844DD5FBF4FE1_OFFSET UNITYSDK_OFFSET(0x1683ABD0)
#define RPG_GAMECORE_ADVMONSTERFORBIDSELECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1683ABA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvMonsterForbidSelect_TypeDefinitionIndex = 19449;
