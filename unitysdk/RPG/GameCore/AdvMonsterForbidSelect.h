...
#define RPG_GAMECORE_ADVMONSTERFORBIDSELECT_METHOD_3_2826DDAAFAC35CCD_OFFSET UNITYSDK_OFFSET(0x19BE5DB0)
#define RPG_GAMECORE_ADVMONSTERFORBIDSELECT_METHOD_3_8F7844DD5FBF4FE1_OFFSET UNITYSDK_OFFSET(0x19BE5E30)
#define RPG_GAMECORE_ADVMONSTERFORBIDSELECT__CTOR_OFFSET UNITYSDK_OFFSET(0x19BE5E00)
