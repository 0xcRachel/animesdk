...
#define RPG_GAMECORE_PROPSETUPHITBOXGROUP_METHOD_3_097B2A4F7E08FE37_OFFSET UNITYSDK_OFFSET(0x191CE070)
#define RPG_GAMECORE_PROPSETUPHITBOXGROUP_METHOD_3_5207093BA1AB6923_OFFSET UNITYSDK_OFFSET(0x191CDF20)
#define RPG_GAMECORE_PROPSETUPHITBOXGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x191CDFE0)
