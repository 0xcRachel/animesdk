...
#define RPG_GAMECORE_DISABLESUMMONUNITGATHER_METHOD_3_8C23B9CE8571D888_OFFSET UNITYSDK_OFFSET(0x1A0A2A20)
#define RPG_GAMECORE_DISABLESUMMONUNITGATHER_METHOD_3_A537023C519C637E_OFFSET UNITYSDK_OFFSET(0x1A0A29A0)
#define RPG_GAMECORE_DISABLESUMMONUNITGATHER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0A29F0)
