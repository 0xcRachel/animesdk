...
#define RPG_GAMECORE_TRIGGERROGUEENTERNEXTROOM_METHOD_3_35DD831820197305_OFFSET UNITYSDK_OFFSET(0x1911DF90)
#define RPG_GAMECORE_TRIGGERROGUEENTERNEXTROOM_METHOD_3_9DD5F76A915893B1_OFFSET UNITYSDK_OFFSET(0x1911DE80)
#define RPG_GAMECORE_TRIGGERROGUEENTERNEXTROOM__CTOR_OFFSET UNITYSDK_OFFSET(0x1911DF60)
