...
#define RPG_GAMECORE_BYCOMPARECARRYMAZEBUFF_METHOD_4_670AEEE6D79F2D58_OFFSET UNITYSDK_OFFSET(0x16906EA0)
#define RPG_GAMECORE_BYCOMPARECARRYMAZEBUFF_METHOD_4_8F5972F05556A933_OFFSET UNITYSDK_OFFSET(0x16906FC0)
#define RPG_GAMECORE_BYCOMPARECARRYMAZEBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x16906F40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareCarryMazebuff_TypeDefinitionIndex = 17796;
