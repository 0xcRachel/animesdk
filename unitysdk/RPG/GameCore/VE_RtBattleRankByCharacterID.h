...
#define RPG_GAMECORE_VE_RTBATTLERANKBYCHARACTERID_METHOD_3_38C1071778EA996B_OFFSET UNITYSDK_OFFSET(0x1951C2E0)
#define RPG_GAMECORE_VE_RTBATTLERANKBYCHARACTERID_METHOD_3_F47ABDBA910641B8_OFFSET UNITYSDK_OFFSET(0x1951C320)
#define RPG_GAMECORE_VE_RTBATTLERANKBYCHARACTERID__CTOR_OFFSET UNITYSDK_OFFSET(0x1951C310)
