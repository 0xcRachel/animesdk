...
#define RPG_GAMECORE_PRELOADBATTLEEVENTBYID_METHOD_3_E9EF96BF6744C302_OFFSET UNITYSDK_OFFSET(0x1A2D0C30)
#define RPG_GAMECORE_PRELOADBATTLEEVENTBYID_METHOD_3_F8CB8197A097446B_OFFSET UNITYSDK_OFFSET(0x1A2D0CB0)
#define RPG_GAMECORE_PRELOADBATTLEEVENTBYID__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2D0C80)
