...
#define RPG_GAMECORE_WOLFBROPUZZLEFUNCBTNLISTENER_METHOD_3_01063A3E33BC0536_OFFSET UNITYSDK_OFFSET(0x17164690)
#define RPG_GAMECORE_WOLFBROPUZZLEFUNCBTNLISTENER_METHOD_3_FD05752A64A80DE7_OFFSET UNITYSDK_OFFSET(0x17164710)
#define RPG_GAMECORE_WOLFBROPUZZLEFUNCBTNLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x171646E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroPuzzleFuncBtnListener_TypeDefinitionIndex = 18943;
