...
#define RPG_GAMECORE_BYISGENDERTYPE_METHOD_4_D2C301A67DE6BA68_OFFSET UNITYSDK_OFFSET(0x17042D30)
#define RPG_GAMECORE_BYISGENDERTYPE_METHOD_4_DC9F15406B4100C6_OFFSET UNITYSDK_OFFSET(0x17042C60)
#define RPG_GAMECORE_BYISGENDERTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x17042CE0)
