...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERROUNDBEGINCONFIG_METHOD_3_22B68B3813699ADA_OFFSET UNITYSDK_OFFSET(0x16B2E000)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERROUNDBEGINCONFIG_METHOD_3_CEE4215048DD8D23_OFFSET UNITYSDK_OFFSET(0x16B328F0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERROUNDBEGINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16B2DFB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterRoundBeginConfig_TypeDefinitionIndex = 17354;
