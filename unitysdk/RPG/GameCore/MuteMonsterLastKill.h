...
#define RPG_GAMECORE_MUTEMONSTERLASTKILL_METHOD_3_2D470FA93A69D73A_OFFSET UNITYSDK_OFFSET(0x1747EDB0)
#define RPG_GAMECORE_MUTEMONSTERLASTKILL_METHOD_3_3531F65AE96C84C3_OFFSET UNITYSDK_OFFSET(0x1747EE30)
#define RPG_GAMECORE_MUTEMONSTERLASTKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1747EE00)
