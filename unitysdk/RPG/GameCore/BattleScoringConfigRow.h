...
#define RPG_GAMECORE_BATTLESCORINGCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x168E47C0)
#define RPG_GAMECORE_BATTLESCORINGCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x168E5090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleScoringConfigRow_TypeDefinitionIndex = 11692;
	...
	public:
		...
		::RPG::Client::TextID BonusSimpleDesc; // 0x28
		::System::UInt32 ScoringID; // 0x38
		::System::UInt32 BonusScore; // 0x3C
		::RPG::Client::TextID BonusDesc; // 0x40
		::RPG::Client::TextID ScoreRuleDesc; // 0x50
		::RPG::GameCore::BattleScoringType ScoringType; // 0x60
		::System::UInt32 GameModeGroup; // 0x64
