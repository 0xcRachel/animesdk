...
#define RPG_GAMECORE_BATTLESCORINGCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16FF55E0)
#define RPG_GAMECORE_BATTLESCORINGCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16FF5EB0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::BattleScoringType ScoringType; // 0x50
		::System::UInt32 ScoringID; // 0x54
