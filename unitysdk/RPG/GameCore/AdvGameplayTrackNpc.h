...
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPC_METHOD_3_95A7F496BDEA20FF_OFFSET UNITYSDK_OFFSET(0x16836FB0)
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPC_METHOD_3_E5DBEA3E7D5F0AF4_OFFSET UNITYSDK_OFFSET(0x16836E00)
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPC__CTOR_OFFSET UNITYSDK_OFFSET(0x16836E40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvGameplayTrackNpc_TypeDefinitionIndex = 19831;
