...
#define RPG_GAMECORE_ADVENTUREBYPROPSHOWINFOID_METHOD_4_267ED9E1BD401570_OFFSET UNITYSDK_OFFSET(0x168560D0)
#define RPG_GAMECORE_ADVENTUREBYPROPSHOWINFOID_METHOD_4_BAD4C89873E84214_OFFSET UNITYSDK_OFFSET(0x168561B0)
#define RPG_GAMECORE_ADVENTUREBYPROPSHOWINFOID__CTOR_OFFSET UNITYSDK_OFFSET(0x16856150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureByPropShowInfoId_TypeDefinitionIndex = 18254;
