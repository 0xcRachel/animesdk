...
#define RPG_GAMECORE_FIREMULTIPROJECTILES_METHOD_4_750C4C6A7CBF11A5_OFFSET UNITYSDK_OFFSET(0x171EE4C0)
#define RPG_GAMECORE_FIREMULTIPROJECTILES_METHOD_4_871A541457028307_OFFSET UNITYSDK_OFFSET(0x171EE440)
#define RPG_GAMECORE_FIREMULTIPROJECTILES__CTOR_OFFSET UNITYSDK_OFFSET(0x171EE490)
