...
#define RPG_GAMECORE_BATTLEAREAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x168CF4F0)
#define RPG_GAMECORE_BATTLEAREAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x168CF840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleAreaRow_TypeDefinitionIndex = 11643;
	...
	public:
		...
		::System::UInt32 UnifiedConfigID; // 0x24
		::System::UInt32 FloorID; // 0x28
		::System::UInt32 BattleAreaID; // 0x2C
		::System::UInt32 FloorBattleAreaID; // 0x30
