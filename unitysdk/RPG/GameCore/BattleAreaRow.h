...
#define RPG_GAMECORE_BATTLEAREAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1822F9B0)
#define RPG_GAMECORE_BATTLEAREAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1822FD00)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean IsLegacy; // 0x14
		::System::Boolean IsUseUnifiedConfig; // 0x15
