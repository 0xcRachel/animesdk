...
#define RPG_GAMECORE_BATTLEAREAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16FE01D0)
#define RPG_GAMECORE_BATTLEAREAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE0520)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::UInt32 UnifiedConfigID; // 0x10
		::System::UInt32 BattleAreaID; // 0x14
		::System::Boolean IsLegacy; // 0x18
		::System::Boolean IsUseUnifiedConfig; // 0x19
		...
		::System::UInt32 DimensionID; // 0x30
