...
#define RPG_GAMECORE_BATTLEAREAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1765AB20)
#define RPG_GAMECORE_BATTLEAREAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1765AE70)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean IsUseUnifiedConfig; // 0x14
		::System::Boolean IsLegacy; // 0x15
		::System::UInt32 ID; // 0x18
		::System::UInt32 FloorID; // 0x1C
		::System::UInt32 DimensionID; // 0x20
		::System::UInt32 BattleAreaID; // 0x24
		::System::UInt32 UnifiedConfigID; // 0x28
		::System::UInt32 FloorBattleAreaID; // 0x2C
