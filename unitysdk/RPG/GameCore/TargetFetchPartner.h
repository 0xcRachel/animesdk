...
#define RPG_GAMECORE_TARGETFETCHPARTNER_METHOD_4_446F09681B0C4E48_OFFSET UNITYSDK_OFFSET(0x16FDE8D0)
#define RPG_GAMECORE_TARGETFETCHPARTNER_METHOD_4_A22D8A1262A37AFC_OFFSET UNITYSDK_OFFSET(0x16FD90C0)
#define RPG_GAMECORE_TARGETFETCHPARTNER__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD9070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchPartner_TypeDefinitionIndex = 21648;
