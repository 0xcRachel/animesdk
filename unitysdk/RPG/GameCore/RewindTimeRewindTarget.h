...
#define RPG_GAMECORE_REWINDTIMEREWINDTARGET_METHOD_3_2749CF8183B8490E_OFFSET UNITYSDK_OFFSET(0x16DF7780)
#define RPG_GAMECORE_REWINDTIMEREWINDTARGET_METHOD_3_4852733CF280FA5F_OFFSET UNITYSDK_OFFSET(0x16DF7700)
#define RPG_GAMECORE_REWINDTIMEREWINDTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x16DF7750)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RewindTimeRewindTarget_TypeDefinitionIndex = 18450;
