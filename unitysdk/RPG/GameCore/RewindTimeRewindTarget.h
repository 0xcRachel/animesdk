...
#define RPG_GAMECORE_REWINDTIMEREWINDTARGET_METHOD_3_2749CF8183B8490E_OFFSET UNITYSDK_OFFSET(0x175C49C0)
#define RPG_GAMECORE_REWINDTIMEREWINDTARGET_METHOD_3_4852733CF280FA5F_OFFSET UNITYSDK_OFFSET(0x175C4940)
#define RPG_GAMECORE_REWINDTIMEREWINDTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x175C4990)
