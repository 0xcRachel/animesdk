...
#define RPG_GAMECORE_ENTITYONERAFLIPPEDLISTENER_METHOD_3_531791B1D529E117_OFFSET UNITYSDK_OFFSET(0x171B60C0)
#define RPG_GAMECORE_ENTITYONERAFLIPPEDLISTENER_METHOD_3_7770C2DB08C2B5F7_OFFSET UNITYSDK_OFFSET(0x171B6040)
#define RPG_GAMECORE_ENTITYONERAFLIPPEDLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x171B6090)
