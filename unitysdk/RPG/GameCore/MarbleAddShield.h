...
#define RPG_GAMECORE_MARBLEADDSHIELD_METHOD_3_2695C56F422933B3_OFFSET UNITYSDK_OFFSET(0x18FE6320)
#define RPG_GAMECORE_MARBLEADDSHIELD_METHOD_3_DBFE962FBA4A3588_OFFSET UNITYSDK_OFFSET(0x18FE6240)
#define RPG_GAMECORE_MARBLEADDSHIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x18FE62D0)
