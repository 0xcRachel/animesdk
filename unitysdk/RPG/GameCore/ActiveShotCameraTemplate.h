...
#define RPG_GAMECORE_ACTIVESHOTCAMERATEMPLATE_METHOD_3_B7DD1B10ABB59A5F_OFFSET UNITYSDK_OFFSET(0x16EB4D80)
#define RPG_GAMECORE_ACTIVESHOTCAMERATEMPLATE_METHOD_3_BE99036A267CCA14_OFFSET UNITYSDK_OFFSET(0x16EB4D00)
#define RPG_GAMECORE_ACTIVESHOTCAMERATEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16EB4D50)
