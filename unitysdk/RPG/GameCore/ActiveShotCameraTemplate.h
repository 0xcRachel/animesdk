...
#define RPG_GAMECORE_ACTIVESHOTCAMERATEMPLATE_METHOD_3_B7DD1B10ABB59A5F_OFFSET UNITYSDK_OFFSET(0x1677F2E0)
#define RPG_GAMECORE_ACTIVESHOTCAMERATEMPLATE_METHOD_3_BE99036A267CCA14_OFFSET UNITYSDK_OFFSET(0x1677F260)
#define RPG_GAMECORE_ACTIVESHOTCAMERATEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1677F2B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActiveShotCameraTemplate_TypeDefinitionIndex = 18627;
