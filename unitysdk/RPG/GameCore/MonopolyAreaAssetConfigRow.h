...
#define RPG_GAMECORE_MONOPOLYAREAASSETCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16CC3CB0)
#define RPG_GAMECORE_MONOPOLYAREAASSETCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16CC3ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyAreaAssetConfigRow_TypeDefinitionIndex = 10959;
