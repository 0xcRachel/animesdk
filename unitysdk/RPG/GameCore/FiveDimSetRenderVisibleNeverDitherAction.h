...
#define RPG_GAMECORE_FIVEDIMSETRENDERVISIBLENEVERDITHERACTION_METHOD_3_1D33F535CAFD6FCD_OFFSET UNITYSDK_OFFSET(0x1A3A3100)
#define RPG_GAMECORE_FIVEDIMSETRENDERVISIBLENEVERDITHERACTION_METHOD_3_9E8EAF6F0465A8A3_OFFSET UNITYSDK_OFFSET(0x1A3A3170)
#define RPG_GAMECORE_FIVEDIMSETRENDERVISIBLENEVERDITHERACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3A3150)
