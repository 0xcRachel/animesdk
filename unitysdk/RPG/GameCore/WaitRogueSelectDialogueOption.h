...
#define RPG_GAMECORE_WAITROGUESELECTDIALOGUEOPTION_METHOD_3_7BE676803410C2C1_OFFSET UNITYSDK_OFFSET(0x1715AF20)
#define RPG_GAMECORE_WAITROGUESELECTDIALOGUEOPTION_METHOD_3_B38572E55414D491_OFFSET UNITYSDK_OFFSET(0x1715AE90)
#define RPG_GAMECORE_WAITROGUESELECTDIALOGUEOPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1715AEF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRogueSelectDialogueOption_TypeDefinitionIndex = 18269;
