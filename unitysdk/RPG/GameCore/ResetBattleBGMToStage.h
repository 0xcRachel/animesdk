...
#define RPG_GAMECORE_RESETBATTLEBGMTOSTAGE_METHOD_3_93CD9AC7281E3D38_OFFSET UNITYSDK_OFFSET(0x1A2ECDA0)
#define RPG_GAMECORE_RESETBATTLEBGMTOSTAGE_METHOD_3_DA3816C81B3AF991_OFFSET UNITYSDK_OFFSET(0x1A2ECD20)
#define RPG_GAMECORE_RESETBATTLEBGMTOSTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2ECD70)
