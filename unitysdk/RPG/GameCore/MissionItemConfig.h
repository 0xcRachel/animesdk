...
#define RPG_GAMECORE_MISSIONITEMCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1969DC10)
#define RPG_GAMECORE_MISSIONITEMCONFIG_FROMJSON_OFFSET UNITYSDK_OFFSET(0x1969DD10)
#define RPG_GAMECORE_MISSIONITEMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1969DD00)
