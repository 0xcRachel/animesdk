...
#define RPG_GAMECORE_ST_MAIN_HANGUPBYLEVEL_METHOD_4_1356CE08F6769A59_OFFSET UNITYSDK_OFFSET(0x16EF6C20)
#define RPG_GAMECORE_ST_MAIN_HANGUPBYLEVEL_METHOD_4_20661BBB31F5B46E_OFFSET UNITYSDK_OFFSET(0x16EE2E50)
#define RPG_GAMECORE_ST_MAIN_HANGUPBYLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x16EE2E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_HangUpByLevel_TypeDefinitionIndex = 17886;
