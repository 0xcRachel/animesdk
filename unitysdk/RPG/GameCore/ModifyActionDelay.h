...
#define RPG_GAMECORE_MODIFYACTIONDELAY_METHOD_3_3B2C690A926408E7_OFFSET UNITYSDK_OFFSET(0x1743DCE0)
#define RPG_GAMECORE_MODIFYACTIONDELAY_METHOD_3_BBBEFDE9B734D391_OFFSET UNITYSDK_OFFSET(0x1743DC60)
#define RPG_GAMECORE_MODIFYACTIONDELAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1743DCB0)
