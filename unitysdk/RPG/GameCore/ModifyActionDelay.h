...
#define RPG_GAMECORE_MODIFYACTIONDELAY_METHOD_3_3B2C690A926408E7_OFFSET UNITYSDK_OFFSET(0x16CB7270)
#define RPG_GAMECORE_MODIFYACTIONDELAY_METHOD_3_BBBEFDE9B734D391_OFFSET UNITYSDK_OFFSET(0x16CB71F0)
#define RPG_GAMECORE_MODIFYACTIONDELAY__CTOR_OFFSET UNITYSDK_OFFSET(0x16CB7240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyActionDelay_TypeDefinitionIndex = 20341;
