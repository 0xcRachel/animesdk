...
#define RPG_GAMECORE_MODIFYACTIONDELAY_METHOD_3_3B2C690A926408E7_OFFSET UNITYSDK_OFFSET(0x1907AC00)
#define RPG_GAMECORE_MODIFYACTIONDELAY_METHOD_3_BBBEFDE9B734D391_OFFSET UNITYSDK_OFFSET(0x1907AB80)
#define RPG_GAMECORE_MODIFYACTIONDELAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1907ABD0)
