...
#define RPG_GAMECORE_PERFORMANCEDYNAMICLOADCHARACTER_METHOD_3_3A502B9172941445_OFFSET UNITYSDK_OFFSET(0x18F09B90)
#define RPG_GAMECORE_PERFORMANCEDYNAMICLOADCHARACTER_METHOD_3_DD3755E9707EF983_OFFSET UNITYSDK_OFFSET(0x18F09C10)
#define RPG_GAMECORE_PERFORMANCEDYNAMICLOADCHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18F09BE0)
