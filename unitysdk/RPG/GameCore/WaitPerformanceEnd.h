...
#define RPG_GAMECORE_WAITPERFORMANCEEND_METHOD_3_C5A2AFD131E740DD_OFFSET UNITYSDK_OFFSET(0x17157710)
#define RPG_GAMECORE_WAITPERFORMANCEEND_METHOD_3_EC7E803495F8FAE9_OFFSET UNITYSDK_OFFSET(0x17157600)
#define RPG_GAMECORE_WAITPERFORMANCEEND__CTOR_OFFSET UNITYSDK_OFFSET(0x171576E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitPerformanceEnd_TypeDefinitionIndex = 19491;
