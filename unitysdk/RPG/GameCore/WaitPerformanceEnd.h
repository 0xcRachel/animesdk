...
#define RPG_GAMECORE_WAITPERFORMANCEEND_METHOD_3_C5A2AFD131E740DD_OFFSET UNITYSDK_OFFSET(0x17913B80)
#define RPG_GAMECORE_WAITPERFORMANCEEND_METHOD_3_EC7E803495F8FAE9_OFFSET UNITYSDK_OFFSET(0x17913A70)
#define RPG_GAMECORE_WAITPERFORMANCEEND__CTOR_OFFSET UNITYSDK_OFFSET(0x17913B50)
