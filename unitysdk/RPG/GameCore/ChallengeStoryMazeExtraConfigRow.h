...
#define RPG_GAMECORE_CHALLENGESTORYMAZEEXTRACONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16962540)
#define RPG_GAMECORE_CHALLENGESTORYMAZEEXTRACONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x169626E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChallengeStoryMazeExtraConfigRow_TypeDefinitionIndex = 11776;
