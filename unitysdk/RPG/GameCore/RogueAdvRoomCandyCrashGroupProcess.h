...
#define RPG_GAMECORE_ROGUEADVROOMCANDYCRASHGROUPPROCESS_METHOD_3_0CC313E8640764DE_OFFSET UNITYSDK_OFFSET(0x1A9C94A0)
#define RPG_GAMECORE_ROGUEADVROOMCANDYCRASHGROUPPROCESS_METHOD_3_1933644EF606C5C8_OFFSET UNITYSDK_OFFSET(0x1A9C95C0)
#define RPG_GAMECORE_ROGUEADVROOMCANDYCRASHGROUPPROCESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9C9540)
