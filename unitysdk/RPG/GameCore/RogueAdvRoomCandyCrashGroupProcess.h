...
#define RPG_GAMECORE_ROGUEADVROOMCANDYCRASHGROUPPROCESS_METHOD_3_1B8F0B96E1702BA2_OFFSET UNITYSDK_OFFSET(0x16E11AD0)
#define RPG_GAMECORE_ROGUEADVROOMCANDYCRASHGROUPPROCESS_METHOD_3_6261F5445D998CF4_OFFSET UNITYSDK_OFFSET(0x16E119B0)
#define RPG_GAMECORE_ROGUEADVROOMCANDYCRASHGROUPPROCESS__CTOR_OFFSET UNITYSDK_OFFSET(0x16E11A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAdvRoomCandyCrashGroupProcess_TypeDefinitionIndex = 19940;
