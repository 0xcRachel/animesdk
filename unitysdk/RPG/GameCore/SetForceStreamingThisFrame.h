...
#define RPG_GAMECORE_SETFORCESTREAMINGTHISFRAME_METHOD_3_8369197332E34D80_OFFSET UNITYSDK_OFFSET(0x16F2E700)
#define RPG_GAMECORE_SETFORCESTREAMINGTHISFRAME_METHOD_3_96730D7615AC9C39_OFFSET UNITYSDK_OFFSET(0x16F2E680)
#define RPG_GAMECORE_SETFORCESTREAMINGTHISFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x16F2E6D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetForceStreamingThisFrame_TypeDefinitionIndex = 18880;
