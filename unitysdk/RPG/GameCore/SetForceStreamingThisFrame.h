...
#define RPG_GAMECORE_SETFORCESTREAMINGTHISFRAME_METHOD_3_8369197332E34D80_OFFSET UNITYSDK_OFFSET(0x199B6380)
#define RPG_GAMECORE_SETFORCESTREAMINGTHISFRAME_METHOD_3_96730D7615AC9C39_OFFSET UNITYSDK_OFFSET(0x199B6300)
#define RPG_GAMECORE_SETFORCESTREAMINGTHISFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x199B6350)
