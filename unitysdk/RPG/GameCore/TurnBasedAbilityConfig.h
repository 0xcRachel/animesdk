...
#define RPG_GAMECORE_TURNBASEDABILITYCONFIG_METHOD_3_BE01A5C43F987C27_OFFSET UNITYSDK_OFFSET(0x1712A670)
#define RPG_GAMECORE_TURNBASEDABILITYCONFIG_METHOD_3_CD82E4709D067670_OFFSET UNITYSDK_OFFSET(0x1712A630)
#define RPG_GAMECORE_TURNBASEDABILITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1712A660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TurnBasedAbilityConfig_TypeDefinitionIndex = 16320;
