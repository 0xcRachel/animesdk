...
#define RPG_GAMECORE_PLAYVOICE_METHOD_3_4FB2144464201507_OFFSET UNITYSDK_OFFSET(0x16D54B60)
#define RPG_GAMECORE_PLAYVOICE_METHOD_3_C57D725502E70258_OFFSET UNITYSDK_OFFSET(0x16D54BF0)
#define RPG_GAMECORE_PLAYVOICE__CTOR_OFFSET UNITYSDK_OFFSET(0x16D54BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayVoice_TypeDefinitionIndex = 18407;
