...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_ISBOSS_METHOD_4_0D1F1AA7A6A14236_OFFSET UNITYSDK_OFFSET(0x1A0949C0)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_ISBOSS_METHOD_4_6E58652D7E2AD280_OFFSET UNITYSDK_OFFSET(0x1A092CB0)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_ISBOSS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A092C60)
