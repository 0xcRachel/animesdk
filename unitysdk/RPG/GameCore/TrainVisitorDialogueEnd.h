...
#define RPG_GAMECORE_TRAINVISITORDIALOGUEEND_METHOD_3_C27005E61FB51500_OFFSET UNITYSDK_OFFSET(0x1949CBC0)
#define RPG_GAMECORE_TRAINVISITORDIALOGUEEND_METHOD_3_EA3498B933C26EB4_OFFSET UNITYSDK_OFFSET(0x1949CAB0)
#define RPG_GAMECORE_TRAINVISITORDIALOGUEEND__CTOR_OFFSET UNITYSDK_OFFSET(0x1949CB90)
