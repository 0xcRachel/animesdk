...
#define RPG_GAMECORE_TRAINVISITORDIALOGUEEND_METHOD_3_C27005E61FB51500_OFFSET UNITYSDK_OFFSET(0x1710B790)
#define RPG_GAMECORE_TRAINVISITORDIALOGUEEND_METHOD_3_EA3498B933C26EB4_OFFSET UNITYSDK_OFFSET(0x1710B680)
#define RPG_GAMECORE_TRAINVISITORDIALOGUEEND__CTOR_OFFSET UNITYSDK_OFFSET(0x1710B760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainVisitorDialogueEnd_TypeDefinitionIndex = 19229;
