...
#define RPG_GAMECORE_COMPLEXSKILLAIGETAVATARBASETYPE_METHOD_3_EBF60C546B0C1125_OFFSET UNITYSDK_OFFSET(0x171376C0)
#define RPG_GAMECORE_COMPLEXSKILLAIGETAVATARBASETYPE_METHOD_3_F3E704BAB96BC99A_OFFSET UNITYSDK_OFFSET(0x17137730)
#define RPG_GAMECORE_COMPLEXSKILLAIGETAVATARBASETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x17137710)
