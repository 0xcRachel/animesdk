...
#define RPG_GAMECORE_ELFREFRESHDATA_METHOD_3_71143DE3EE3D142B_OFFSET UNITYSDK_OFFSET(0x16A62120)
#define RPG_GAMECORE_ELFREFRESHDATA_METHOD_3_7FE8E2F055FD29B7_OFFSET UNITYSDK_OFFSET(0x16A62010)
#define RPG_GAMECORE_ELFREFRESHDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16A620F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfRefreshData_TypeDefinitionIndex = 19377;
