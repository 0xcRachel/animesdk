...
#define RPG_GAMECORE_SETCAMERACONFIGPRIORITY_METHOD_3_1B8C2CF37F7BCCA1_OFFSET UNITYSDK_OFFSET(0x176C07A0)
#define RPG_GAMECORE_SETCAMERACONFIGPRIORITY_METHOD_3_4071100F3B5A7718_OFFSET UNITYSDK_OFFSET(0x176C0720)
#define RPG_GAMECORE_SETCAMERACONFIGPRIORITY__CTOR_OFFSET UNITYSDK_OFFSET(0x176C0770)
