...
#define RPG_GAMECORE_ST_SIDE_HALTCD_METHOD_4_6C07BB4817BB9B42_OFFSET UNITYSDK_OFFSET(0x16EE7FB0)
#define RPG_GAMECORE_ST_SIDE_HALTCD_METHOD_4_B9F612BE2EF92D05_OFFSET UNITYSDK_OFFSET(0x16EF7DC0)
#define RPG_GAMECORE_ST_SIDE_HALTCD__CTOR_OFFSET UNITYSDK_OFFSET(0x16EE7F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_HaltCD_TypeDefinitionIndex = 17905;
