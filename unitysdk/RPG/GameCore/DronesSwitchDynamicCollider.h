...
#define RPG_GAMECORE_DRONESSWITCHDYNAMICCOLLIDER_METHOD_3_6B3DA8DB782A49F6_OFFSET UNITYSDK_OFFSET(0x191437B0)
#define RPG_GAMECORE_DRONESSWITCHDYNAMICCOLLIDER_METHOD_3_F0478BEDD5661BAC_OFFSET UNITYSDK_OFFSET(0x19143730)
#define RPG_GAMECORE_DRONESSWITCHDYNAMICCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x19143780)
