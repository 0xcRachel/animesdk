...
#define RPG_GAMECORE_SETBATTLEENDREASON_METHOD_3_A683074EF5BC9B44_OFFSET UNITYSDK_OFFSET(0x1A1E55B0)
#define RPG_GAMECORE_SETBATTLEENDREASON_METHOD_3_F0581368EC8A40C7_OFFSET UNITYSDK_OFFSET(0x1A1E5530)
#define RPG_GAMECORE_SETBATTLEENDREASON__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1E5580)
