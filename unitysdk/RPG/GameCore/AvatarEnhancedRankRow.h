...
#define RPG_GAMECORE_AVATARENHANCEDRANKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x181FFA80)
#define RPG_GAMECORE_AVATARENHANCEDRANKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x181FFE30)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID Comment01; // 0x40
