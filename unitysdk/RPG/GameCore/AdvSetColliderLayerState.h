...
#define RPG_GAMECORE_ADVSETCOLLIDERLAYERSTATE_METHOD_3_3D94D69EC2B566CB_OFFSET UNITYSDK_OFFSET(0x18C5A550)
#define RPG_GAMECORE_ADVSETCOLLIDERLAYERSTATE_METHOD_3_E8A9039E776AE8FA_OFFSET UNITYSDK_OFFSET(0x18C5A5D0)
#define RPG_GAMECORE_ADVSETCOLLIDERLAYERSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C5A5A0)
