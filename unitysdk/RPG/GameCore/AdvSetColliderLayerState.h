...
#define RPG_GAMECORE_ADVSETCOLLIDERLAYERSTATE_METHOD_3_3D94D69EC2B566CB_OFFSET UNITYSDK_OFFSET(0x16847110)
#define RPG_GAMECORE_ADVSETCOLLIDERLAYERSTATE_METHOD_3_E8A9039E776AE8FA_OFFSET UNITYSDK_OFFSET(0x16847190)
#define RPG_GAMECORE_ADVSETCOLLIDERLAYERSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16847160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetColliderLayerState_TypeDefinitionIndex = 18319;
