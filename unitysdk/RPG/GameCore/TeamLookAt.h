...
#define RPG_GAMECORE_TEAMLOOKAT_METHOD_3_1C8405416D93B38D_OFFSET UNITYSDK_OFFSET(0x170EC240)
#define RPG_GAMECORE_TEAMLOOKAT_METHOD_3_6420D5667890140E_OFFSET UNITYSDK_OFFSET(0x170EC1C0)
#define RPG_GAMECORE_TEAMLOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x170EC210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TeamLookAt_TypeDefinitionIndex = 20097;
