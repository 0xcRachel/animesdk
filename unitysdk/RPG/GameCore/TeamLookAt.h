...
#define RPG_GAMECORE_TEAMLOOKAT_METHOD_3_1C8405416D93B38D_OFFSET UNITYSDK_OFFSET(0x1789C1D0)
#define RPG_GAMECORE_TEAMLOOKAT_METHOD_3_6420D5667890140E_OFFSET UNITYSDK_OFFSET(0x178AB5C0)
#define RPG_GAMECORE_TEAMLOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1789C1A0)
