...
#define RPG_GAMECORE_BATTLEENTITYSKILLLEVELWHITEBOXDATA_METHOD_2_6C0245E14DA926CB_OFFSET UNITYSDK_OFFSET(0x168D3AD0)
#define RPG_GAMECORE_BATTLEENTITYSKILLLEVELWHITEBOXDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x168D3C30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleEntitySkillLevelWhiteBoxData_TypeDefinitionIndex = 20395;
