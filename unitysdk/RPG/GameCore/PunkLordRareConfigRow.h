...
#define RPG_GAMECORE_PUNKLORDRARECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16DBC510)
#define RPG_GAMECORE_PUNKLORDRARECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16DBC690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PunkLordRareConfigRow_TypeDefinitionIndex = 11161;
