...
#define RPG_GAMECORE_ADDENTITYTORELATIONGROUP_METHOD_3_148745B4066CE2B5_OFFSET UNITYSDK_OFFSET(0x16F2FF30)
#define RPG_GAMECORE_ADDENTITYTORELATIONGROUP_METHOD_3_2624F0AA5E2A96C0_OFFSET UNITYSDK_OFFSET(0x16F2FEB0)
#define RPG_GAMECORE_ADDENTITYTORELATIONGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x16F2FF00)
