...
#define RPG_GAMECORE_REWINDTIMEREWINDTARGETINRANGE_METHOD_3_220E0D3821047C67_OFFSET UNITYSDK_OFFSET(0x16DF7890)
#define RPG_GAMECORE_REWINDTIMEREWINDTARGETINRANGE_METHOD_3_B524E4EFDC289D96_OFFSET UNITYSDK_OFFSET(0x16DF7910)
#define RPG_GAMECORE_REWINDTIMEREWINDTARGETINRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16DF78E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RewindTimeRewindTargetInRange_TypeDefinitionIndex = 18451;
