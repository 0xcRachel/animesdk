...
#define RPG_GAMECORE_CHENLINGFESLEVELABILITYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A4FDC30)
#define RPG_GAMECORE_CHENLINGFESLEVELABILITYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4FDEE0)
