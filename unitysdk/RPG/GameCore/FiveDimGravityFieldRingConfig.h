...
#define RPG_GAMECORE_FIVEDIMGRAVITYFIELDRINGCONFIG_METHOD_3_114CBDD1AC21341D_OFFSET UNITYSDK_OFFSET(0x172094B0)
#define RPG_GAMECORE_FIVEDIMGRAVITYFIELDRINGCONFIG_METHOD_3_CE63A19536A4B258_OFFSET UNITYSDK_OFFSET(0x17209520)
#define RPG_GAMECORE_FIVEDIMGRAVITYFIELDRINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17209500)
