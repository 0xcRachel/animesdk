...
#define RPG_GAMECORE_RTBATTLEDAMAGEEXTRADATA_METHOD_3_0590B5B643E121B7_OFFSET UNITYSDK_OFFSET(0x19417330)
#define RPG_GAMECORE_RTBATTLEDAMAGEEXTRADATA_METHOD_3_99FD997239B2E03D_OFFSET UNITYSDK_OFFSET(0x19417500)
#define RPG_GAMECORE_RTBATTLEDAMAGEEXTRADATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19417490)
