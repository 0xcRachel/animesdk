...
#define RPG_GAMECORE_AVATARRELICRECOMMENDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1820F100)
#define RPG_GAMECORE_AVATARRELICRECOMMENDROW_GETPROPERTYTYPEARRAY_OFFSET UNITYSDK_OFFSET(0x1820FBC0)
#define RPG_GAMECORE_AVATARRELICRECOMMENDROW_GETPROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0x1820FB80)
#define RPG_GAMECORE_AVATARRELICRECOMMENDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1820FB70)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::Il2CppArray<::RPG::GameCore::AvatarPropertyType>* PropertyList3; // 0x10
		::Il2CppArray<::RPG::GameCore::AvatarPropertyType>* PropertyList4; // 0x18
		::Il2CppArray<::System::UInt32>* ScoreRankList; // 0x20
		...
		::Il2CppArray<::RPG::GameCore::AvatarPropertyType>* PropertyList5; // 0x40
		::Il2CppArray<::RPG::GameCore::RelicRecommendProperty*>* PropertyList; // 0x48
