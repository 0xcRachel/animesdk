...
#define RPG_GAMECORE_AVATARRELICRECOMMENDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1763C490)
#define RPG_GAMECORE_AVATARRELICRECOMMENDROW_GETPROPERTYTYPEARRAY_OFFSET UNITYSDK_OFFSET(0x1763CDA0)
#define RPG_GAMECORE_AVATARRELICRECOMMENDROW_GETPROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0x1763CD60)
#define RPG_GAMECORE_AVATARRELICRECOMMENDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1763CD50)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::Il2CppArray<::RPG::GameCore::AvatarPropertyType>* PropertyList6; // 0x10
		::Il2CppArray<::System::UInt32>* Set2IDList; // 0x18
		::Il2CppArray<::RPG::GameCore::AvatarPropertyType>* SubAffixPropertyList; // 0x20
		::Il2CppArray<::RPG::GameCore::RelicRecommendProperty*>* PropertyList; // 0x28
		::Il2CppArray<::System::UInt32>* ScoreRankList; // 0x30
