...
#define RPG_GAMECORE_BASEROGUEMAGICULTRAUNITSPECIALFACTOR_METHOD_2_7F7AF1E0BE356C7B_OFFSET UNITYSDK_OFFSET(0x176590A0)
#define RPG_GAMECORE_BASEROGUEMAGICULTRAUNITSPECIALFACTOR_METHOD_2_C8820E3BFD5EF1A3_OFFSET UNITYSDK_OFFSET(0x17658E90)
#define RPG_GAMECORE_BASEROGUEMAGICULTRAUNITSPECIALFACTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x17659090)
