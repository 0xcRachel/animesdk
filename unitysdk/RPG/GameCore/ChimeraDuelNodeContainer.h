...
#define RPG_GAMECORE_CHIMERADUELNODECONTAINER_METHOD_2_BCA567199E852450_OFFSET UNITYSDK_OFFSET(0x169936C0)
#define RPG_GAMECORE_CHIMERADUELNODECONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x16993900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelNodeContainer_TypeDefinitionIndex = 14385;
