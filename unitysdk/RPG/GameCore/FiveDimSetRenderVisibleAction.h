...
#define RPG_GAMECORE_FIVEDIMSETRENDERVISIBLEACTION_METHOD_3_5F10C2776F3FE1F6_OFFSET UNITYSDK_OFFSET(0x1A3A2DF0)
#define RPG_GAMECORE_FIVEDIMSETRENDERVISIBLEACTION_METHOD_3_DD778882DCA42652_OFFSET UNITYSDK_OFFSET(0x1A3A2E60)
#define RPG_GAMECORE_FIVEDIMSETRENDERVISIBLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3A2E40)
