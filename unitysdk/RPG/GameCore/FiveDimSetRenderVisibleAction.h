...
#define RPG_GAMECORE_FIVEDIMSETRENDERVISIBLEACTION_METHOD_3_230D09733F3979D5_OFFSET UNITYSDK_OFFSET(0x16AD4360)
#define RPG_GAMECORE_FIVEDIMSETRENDERVISIBLEACTION_METHOD_3_C2AC525044D3D477_OFFSET UNITYSDK_OFFSET(0x16AD42F0)
#define RPG_GAMECORE_FIVEDIMSETRENDERVISIBLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16AD4340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetRenderVisibleAction_TypeDefinitionIndex = 16767;
