...
#define RPG_GAMECORE_PLANETFESSKILLTREEPHASEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16D4C110)
#define RPG_GAMECORE_PLANETFESSKILLTREEPHASEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16D4C2C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlanetFesSkillTreePhaseRow_TypeDefinitionIndex = 11065;
