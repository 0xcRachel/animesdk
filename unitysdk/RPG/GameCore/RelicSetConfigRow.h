...
#define RPG_GAMECORE_RELICSETCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A2E2530)
#define RPG_GAMECORE_RELICSETCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2E2DB0)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::Il2CppArray<::System::UInt32>* SetSkillList; // 0x10
		...
		::System::UInt32 DisplayItemID; // 0x38
		::System::Boolean IsPlanarSuit; // 0x3C
		::System::Boolean Release; // 0x3D
