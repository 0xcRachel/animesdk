...
#define RPG_GAMECORE_PAMACTIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18EF9DC0)
#define RPG_GAMECORE_PAMACTIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18EFA280)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Int32 MaxStrengthPoint; // 0x28
		::System::Int32 MinStrengthPoint; // 0x2C
		::RPG::GameCore::PamActionType PamAction; // 0x30
