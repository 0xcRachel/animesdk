...
#define RPG_GAMECORE_CHENLINGSOLDIERUNITROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1709D7C0)
#define RPG_GAMECORE_CHENLINGSOLDIERUNITROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1709DD40)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::RPG::GameCore::FixPoint CrtDMG; // 0x10
		::RPG::GameCore::FixPoint Atk; // 0x18
		::RPG::GameCore::FixPoint Range; // 0x20
		::RPG::GameCore::FixPoint Crt; // 0x28
		::RPG::GameCore::FixPoint MoveSpd; // 0x30
		::System::Single ReadyScale; // 0x38
		::System::UInt32 SoldierID; // 0x3C
		::System::UInt32 UnitLevel; // 0x40
