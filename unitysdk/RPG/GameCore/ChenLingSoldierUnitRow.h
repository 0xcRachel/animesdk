...
#define RPG_GAMECORE_CHENLINGSOLDIERUNITROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A503340)
#define RPG_GAMECORE_CHENLINGSOLDIERUNITROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5038C0)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::RPG::GameCore::FixPoint MoveSpd; // 0x10
		::System::UInt32 UnitID; // 0x18
		::System::UInt32 SoldierID; // 0x1C
		::System::Single Scale; // 0x20
		::RPG::GameCore::FixPoint Range; // 0x28
		::System::UInt32 UnitLevel; // 0x30
		::System::Single ReadyScale; // 0x34
		...
		::RPG::GameCore::FixPoint Crt; // 0x58
