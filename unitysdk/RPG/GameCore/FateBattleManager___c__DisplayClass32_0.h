...
#define RPG_GAMECORE_FATEBATTLEMANAGER___C__DISPLAYCLASS32_0__CTOR_OFFSET UNITYSDK_OFFSET(0xFE3F9E0)
#define RPG_GAMECORE_FATEBATTLEMANAGER___C__DISPLAYCLASS32_0___APPLYFATEBUFF_B__0_OFFSET UNITYSDK_OFFSET(0xFE41800)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Class_1_A64CC8A9B1CC56C5* pFateBuffData; // 0x18
