...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEVALUEINTEAMRATIO_METHOD_3_0B6818C94A40ED23_OFFSET UNITYSDK_OFFSET(0x18F9BC10)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEVALUEINTEAMRATIO_METHOD_3_DFE5DEE1A1CFEA7B_OFFSET UNITYSDK_OFFSET(0x18F9AA90)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEVALUEINTEAMRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x18F9AA60)
