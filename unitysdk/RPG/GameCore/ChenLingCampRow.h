...
#define RPG_GAMECORE_CHENLINGCAMPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17097FB0)
#define RPG_GAMECORE_CHENLINGCAMPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x170980E0)
