...
#define RPG_GAMECORE_CHALLENGEBOSSGROUPEXTRACONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1706C430)
#define RPG_GAMECORE_CHALLENGEBOSSGROUPEXTRACONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1706CC20)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::Il2CppArray<::System::UInt32>* BuffList2; // 0x10
		::System::String* BossPatternPrefabPath; // 0x18
		...
		::System::String* ThemePosterTabPicPath; // 0x48
		::System::String* BossPositionPrefabPath2; // 0x50
		::System::String* ThemeToastPicPath; // 0x58
