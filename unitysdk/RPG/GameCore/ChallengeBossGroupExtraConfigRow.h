...
#define RPG_GAMECORE_CHALLENGEBOSSGROUPEXTRACONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19E8C080)
#define RPG_GAMECORE_CHALLENGEBOSSGROUPEXTRACONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19E8C850)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* BossPositionPrefabPath2; // 0x20
		::System::String* BossPositionPrefabPath3; // 0x28
		::System::String* BossPositionPrefabPath1; // 0x30
		::Il2CppArray<::System::UInt32>* BuffList2; // 0x38
		::System::String* ThemePosterTabPicPath; // 0x40
		::System::String* ThemeIconPicPath; // 0x48
