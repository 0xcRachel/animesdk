...
#define RPG_GAMECORE_PERFORMANCESKIPLEVELSTATEOVERRIDECONFIG_METHOD_2_A2CE69BEB7C34185_OFFSET UNITYSDK_OFFSET(0x16D2BB30)
#define RPG_GAMECORE_PERFORMANCESKIPLEVELSTATEOVERRIDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16D2BC30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceSkipLevelStateOverrideConfig_TypeDefinitionIndex = 17054;
