...
#define RPG_GAMECORE_FIVEDIMMONEYCONFIG_METHOD_3_8003324B0A1A92AA_OFFSET UNITYSDK_OFFSET(0x16AC6FA0)
#define RPG_GAMECORE_FIVEDIMMONEYCONFIG_METHOD_3_95A4DF698D8D3C9B_OFFSET UNITYSDK_OFFSET(0x16AC7010)
#define RPG_GAMECORE_FIVEDIMMONEYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16AC6FF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMoneyConfig_TypeDefinitionIndex = 16655;
