...
#define RPG_GAMECORE_SETLOOPSCENECAMERASPEED_METHOD_3_39B61FC8046D0CC4_OFFSET UNITYSDK_OFFSET(0x16F33450)
#define RPG_GAMECORE_SETLOOPSCENECAMERASPEED_METHOD_3_C671CCD5A698A68E_OFFSET UNITYSDK_OFFSET(0x16F334D0)
#define RPG_GAMECORE_SETLOOPSCENECAMERASPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x16F334A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetLoopSceneCameraSpeed_TypeDefinitionIndex = 18210;
