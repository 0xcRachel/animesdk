...
#define RPG_GAMECORE_WAITRANDOMSECOND_METHOD_3_05ED5C20F3DF4E02_OFFSET UNITYSDK_OFFSET(0x1B320B90)
#define RPG_GAMECORE_WAITRANDOMSECOND_METHOD_3_DEC8E5E47DCFFBB4_OFFSET UNITYSDK_OFFSET(0x1B320C10)
#define RPG_GAMECORE_WAITRANDOMSECOND__CTOR_OFFSET UNITYSDK_OFFSET(0x1B320BE0)
