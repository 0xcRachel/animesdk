...
#define RPG_GAMECORE_ATTACKDATA_METHOD_2_0BEDB3D7567D5618_OFFSET UNITYSDK_OFFSET(0x16F9F970)
#define RPG_GAMECORE_ATTACKDATA_METHOD_2_80498888A136FCFD_OFFSET UNITYSDK_OFFSET(0x16F9FE40)
#define RPG_GAMECORE_ATTACKDATA_SHAREBYCOPY_OFFSET UNITYSDK_OFFSET(0x16FA1020)
#define RPG_GAMECORE_ATTACKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16F9FAA0)
