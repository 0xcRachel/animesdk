...
#define RPG_GAMECORE_ROGUENOUSDICEBRANCHROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17651A20)
#define RPG_GAMECORE_ROGUENOUSDICEBRANCHROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17652690)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* SoundReRoll; // 0x18
		::Il2CppArray<::RPG::GameCore::FixPoint>* ParamValue2; // 0x20
		::System::String* BranchPrefab; // 0x28
		::Il2CppArray<::RPG::GameCore::FixPoint>* ParamValue3; // 0x30
		::System::String* DiceLightColor; // 0x38
