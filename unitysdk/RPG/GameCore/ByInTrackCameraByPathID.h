...
#define RPG_GAMECORE_BYINTRACKCAMERABYPATHID_METHOD_4_4E4A5FEE2634ECCB_OFFSET UNITYSDK_OFFSET(0x1692B2F0)
#define RPG_GAMECORE_BYINTRACKCAMERABYPATHID_METHOD_4_70648FFF2A8DB086_OFFSET UNITYSDK_OFFSET(0x1692B220)
#define RPG_GAMECORE_BYINTRACKCAMERABYPATHID__CTOR_OFFSET UNITYSDK_OFFSET(0x1692B2A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByInTrackCameraByPathID_TypeDefinitionIndex = 18638;
