...
#define RPG_GAMECORE_PHOTOGRAPHFREESTYLECONFIG_METHOD_2_364736E780DEE6D5_OFFSET UNITYSDK_OFFSET(0x16D36E60)
#define RPG_GAMECORE_PHOTOGRAPHFREESTYLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16D36F30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphFreeStyleConfig_TypeDefinitionIndex = 17059;
