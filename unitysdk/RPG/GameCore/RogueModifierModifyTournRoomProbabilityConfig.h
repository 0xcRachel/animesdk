...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTOURNROOMPROBABILITYCONFIG_METHOD_3_457E43B162D38037_OFFSET UNITYSDK_OFFSET(0x16EA0FC0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTOURNROOMPROBABILITYCONFIG_METHOD_3_BEC118AD9709AF0E_OFFSET UNITYSDK_OFFSET(0x16E9A850)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTOURNROOMPROBABILITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E9A800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyTournRoomProbabilityConfig_TypeDefinitionIndex = 16036;
