...
#define RPG_GAMECORE_MAINMISSIONPERFORMANCECONFIG_METHOD_2_D0879C0DCA636346_OFFSET UNITYSDK_OFFSET(0x19C1DB60)
#define RPG_GAMECORE_MAINMISSIONPERFORMANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19C1DC60)
