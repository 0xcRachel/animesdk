...
#define RPG_GAMECORE_STRONGCHALLENGESTAGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16FA51D0)
#define RPG_GAMECORE_STRONGCHALLENGESTAGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16FA5DF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StrongChallengeStageRow_TypeDefinitionIndex = 11254;
	...
	public:
		...
		::System::String* MonsterFigurePath; // 0x50
		...
		::System::UInt32 ClearScoreLine; // 0x74
		::RPG::Client::TextID Name; // 0x78
		::System::UInt32 PreStageID; // 0x88
