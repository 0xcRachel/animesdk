...
#define RPG_GAMECORE_STRONGCHALLENGESTAGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1984AA80)
#define RPG_GAMECORE_STRONGCHALLENGESTAGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1984B660)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* AvailableBuffList; // 0x50
		...
		::System::UInt32 PreStageID; // 0x74
		::RPG::Client::TextID Name; // 0x78
		::System::UInt32 EventID; // 0x88
		::System::UInt32 BattleAreaID; // 0x8C
		::System::UInt32 ClearScoreLine; // 0x90
		::System::UInt32 StrongChallengeStageID; // 0x94
