...
#define RPG_GAMECORE_ROGUEGUIDEACTIVITYPANELDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16E80300)
#define RPG_GAMECORE_ROGUEGUIDEACTIVITYPANELDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16E80890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueGuideActivityPanelDataRow_TypeDefinitionIndex = 13376;
