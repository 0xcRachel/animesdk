...
#define RPG_GAMECORE_ROGUEMODIFIERENABLEADVENTUREROOMEXTRAGROUPCONFIG_METHOD_3_7D16C04C2CECF45B_OFFSET UNITYSDK_OFFSET(0x199810A0)
#define RPG_GAMECORE_ROGUEMODIFIERENABLEADVENTUREROOMEXTRAGROUPCONFIG_METHOD_3_C2C138DF16C055C2_OFFSET UNITYSDK_OFFSET(0x199893B0)
#define RPG_GAMECORE_ROGUEMODIFIERENABLEADVENTUREROOMEXTRAGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19981050)
