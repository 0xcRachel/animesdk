...
#define RPG_GAMECORE_BYHAVEOBSTACLE_METHOD_4_3A1CE2DF91184804_OFFSET UNITYSDK_OFFSET(0x16929C90)
#define RPG_GAMECORE_BYHAVEOBSTACLE_METHOD_4_757A738AF90CC374_OFFSET UNITYSDK_OFFSET(0x16929BC0)
#define RPG_GAMECORE_BYHAVEOBSTACLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16929C40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHaveObstacle_TypeDefinitionIndex = 17793;
