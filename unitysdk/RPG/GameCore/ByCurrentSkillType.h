...
#define RPG_GAMECORE_BYCURRENTSKILLTYPE_METHOD_4_AD9635D8A21330A3_OFFSET UNITYSDK_OFFSET(0x16922AE0)
#define RPG_GAMECORE_BYCURRENTSKILLTYPE_METHOD_4_F5CA553289003AA7_OFFSET UNITYSDK_OFFSET(0x16922BB0)
#define RPG_GAMECORE_BYCURRENTSKILLTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x16922B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCurrentSkillType_TypeDefinitionIndex = 21174;
