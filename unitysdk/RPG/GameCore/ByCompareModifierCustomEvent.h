...
#define RPG_GAMECORE_BYCOMPAREMODIFIERCUSTOMEVENT_METHOD_4_CB3CEE0FC00186DB_OFFSET UNITYSDK_OFFSET(0x170234E0)
#define RPG_GAMECORE_BYCOMPAREMODIFIERCUSTOMEVENT_METHOD_4_EFFEAE04FBFE50B9_OFFSET UNITYSDK_OFFSET(0x170235B0)
#define RPG_GAMECORE_BYCOMPAREMODIFIERCUSTOMEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x17023560)
