...
#define RPG_GAMECORE_PARKOURTRIGGEREVENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18F00370)
#define RPG_GAMECORE_PARKOURTRIGGEREVENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18F00700)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::EParkourEventEntityType TargetType; // 0x28
