...
#define RPG_GAMECORE_BYCHECKROGUEEXPLOREWIN_METHOD_4_1A712FF116335065_OFFSET UNITYSDK_OFFSET(0x195FD860)
#define RPG_GAMECORE_BYCHECKROGUEEXPLOREWIN_METHOD_4_540CBE29523EA9B8_OFFSET UNITYSDK_OFFSET(0x195FDA70)
#define RPG_GAMECORE_BYCHECKROGUEEXPLOREWIN_METHOD_4_71C4263E1613F38F_OFFSET UNITYSDK_OFFSET(0x195FD930)
#define RPG_GAMECORE_BYCHECKROGUEEXPLOREWIN_METHOD_4_8266A3A4A71E8360_OFFSET UNITYSDK_OFFSET(0x195FDAF0)
#define RPG_GAMECORE_BYCHECKROGUEEXPLOREWIN__CTOR_OFFSET UNITYSDK_OFFSET(0x195FD8E0)
