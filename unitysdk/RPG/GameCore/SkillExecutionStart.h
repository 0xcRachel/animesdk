...
#define RPG_GAMECORE_SKILLEXECUTIONSTART_METHOD_3_5D9702C451300878_OFFSET UNITYSDK_OFFSET(0x17722D70)
#define RPG_GAMECORE_SKILLEXECUTIONSTART_METHOD_3_EA412C0BCB9298A4_OFFSET UNITYSDK_OFFSET(0x17722E80)
#define RPG_GAMECORE_SKILLEXECUTIONSTART__CTOR_OFFSET UNITYSDK_OFFSET(0x17722E50)
