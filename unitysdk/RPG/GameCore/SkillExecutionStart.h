...
#define RPG_GAMECORE_SKILLEXECUTIONSTART_METHOD_3_5D9702C451300878_OFFSET UNITYSDK_OFFSET(0x16F6D810)
#define RPG_GAMECORE_SKILLEXECUTIONSTART_METHOD_3_EA412C0BCB9298A4_OFFSET UNITYSDK_OFFSET(0x16F6D920)
#define RPG_GAMECORE_SKILLEXECUTIONSTART__CTOR_OFFSET UNITYSDK_OFFSET(0x16F6D8F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SkillExecutionStart_TypeDefinitionIndex = 20358;
