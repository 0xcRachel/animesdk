...
#define RPG_GAMECORE_ST_SIDE_TRIGGERCUSTOMSTRING_METHOD_4_25E01ECC6A8198D3_OFFSET UNITYSDK_OFFSET(0x16EED080)
#define RPG_GAMECORE_ST_SIDE_TRIGGERCUSTOMSTRING_METHOD_4_B1CD86B2E0B49BD4_OFFSET UNITYSDK_OFFSET(0x16EF91A0)
#define RPG_GAMECORE_ST_SIDE_TRIGGERCUSTOMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x16EED020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_TriggerCustomString_TypeDefinitionIndex = 17913;
