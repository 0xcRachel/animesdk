...
#define RPG_GAMECORE_MONSTERWAVEPARAMCONFIGLIST_METHOD_2_A6CFB9277F4E08B3_OFFSET UNITYSDK_OFFSET(0x186328C0)
#define RPG_GAMECORE_MONSTERWAVEPARAMCONFIGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x186329C0)
