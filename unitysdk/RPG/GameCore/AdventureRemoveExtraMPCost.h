...
#define RPG_GAMECORE_ADVENTUREREMOVEEXTRAMPCOST_METHOD_3_01F155941DF100C0_OFFSET UNITYSDK_OFFSET(0x168604E0)
#define RPG_GAMECORE_ADVENTUREREMOVEEXTRAMPCOST_METHOD_3_D31559213A1A737F_OFFSET UNITYSDK_OFFSET(0x16860460)
#define RPG_GAMECORE_ADVENTUREREMOVEEXTRAMPCOST__CTOR_OFFSET UNITYSDK_OFFSET(0x168604B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureRemoveExtraMPCost_TypeDefinitionIndex = 19447;
