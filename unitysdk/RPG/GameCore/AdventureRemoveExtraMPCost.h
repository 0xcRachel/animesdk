...
#define RPG_GAMECORE_ADVENTUREREMOVEEXTRAMPCOST_METHOD_3_01F155941DF100C0_OFFSET UNITYSDK_OFFSET(0x16F6DE80)
#define RPG_GAMECORE_ADVENTUREREMOVEEXTRAMPCOST_METHOD_3_D31559213A1A737F_OFFSET UNITYSDK_OFFSET(0x16F6DE00)
#define RPG_GAMECORE_ADVENTUREREMOVEEXTRAMPCOST__CTOR_OFFSET UNITYSDK_OFFSET(0x16F6DE50)
