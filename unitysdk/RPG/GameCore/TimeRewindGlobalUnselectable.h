...
#define RPG_GAMECORE_TIMEREWINDGLOBALUNSELECTABLE_METHOD_3_784135F9FB750B95_OFFSET UNITYSDK_OFFSET(0x178B3D80)
#define RPG_GAMECORE_TIMEREWINDGLOBALUNSELECTABLE_METHOD_3_CDDDCAB258594664_OFFSET UNITYSDK_OFFSET(0x1789D7F0)
#define RPG_GAMECORE_TIMEREWINDGLOBALUNSELECTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1789D7C0)
