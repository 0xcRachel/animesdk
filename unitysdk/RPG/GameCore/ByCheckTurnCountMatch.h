...
#define RPG_GAMECORE_BYCHECKTURNCOUNTMATCH_METHOD_4_00DEDFD03A29182A_OFFSET UNITYSDK_OFFSET(0x16904D00)
#define RPG_GAMECORE_BYCHECKTURNCOUNTMATCH_METHOD_4_B71F6D5F839ED98D_OFFSET UNITYSDK_OFFSET(0x16904DD0)
#define RPG_GAMECORE_BYCHECKTURNCOUNTMATCH__CTOR_OFFSET UNITYSDK_OFFSET(0x16904D80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckTurnCountMatch_TypeDefinitionIndex = 21110;
