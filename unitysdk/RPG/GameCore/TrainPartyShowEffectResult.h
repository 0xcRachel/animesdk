...
#define RPG_GAMECORE_TRAINPARTYSHOWEFFECTRESULT_METHOD_3_0D43C7DEFE2D51B4_OFFSET UNITYSDK_OFFSET(0x178C3B20)
#define RPG_GAMECORE_TRAINPARTYSHOWEFFECTRESULT_METHOD_3_E57F350BEA1FF800_OFFSET UNITYSDK_OFFSET(0x178C3C30)
#define RPG_GAMECORE_TRAINPARTYSHOWEFFECTRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x178C3C00)
