...
#define RPG_GAMECORE_TRAINPARTYSHOWEFFECTRESULT_METHOD_3_0D43C7DEFE2D51B4_OFFSET UNITYSDK_OFFSET(0x17107B40)
#define RPG_GAMECORE_TRAINPARTYSHOWEFFECTRESULT_METHOD_3_E57F350BEA1FF800_OFFSET UNITYSDK_OFFSET(0x17107C50)
#define RPG_GAMECORE_TRAINPARTYSHOWEFFECTRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x17107C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyShowEffectResult_TypeDefinitionIndex = 20021;
