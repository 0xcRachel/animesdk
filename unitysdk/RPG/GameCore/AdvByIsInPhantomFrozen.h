...
#define RPG_GAMECORE_ADVBYISINPHANTOMFROZEN_METHOD_4_88DFF3A54E5DC81A_OFFSET UNITYSDK_OFFSET(0x167C50E0)
#define RPG_GAMECORE_ADVBYISINPHANTOMFROZEN_METHOD_4_D9DD872FC9DD16D4_OFFSET UNITYSDK_OFFSET(0x167C5010)
#define RPG_GAMECORE_ADVBYISINPHANTOMFROZEN__CTOR_OFFSET UNITYSDK_OFFSET(0x167C5090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByIsInPhantomFrozen_TypeDefinitionIndex = 18382;
