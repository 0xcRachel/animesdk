...
#define RPG_GAMECORE_MARBLEBYHITLEFT_METHOD_4_6F76C85F504B6F87_OFFSET UNITYSDK_OFFSET(0x18FE9A70)
#define RPG_GAMECORE_MARBLEBYHITLEFT_METHOD_4_BB59E34F61C43D52_OFFSET UNITYSDK_OFFSET(0x18FE9990)
#define RPG_GAMECORE_MARBLEBYHITLEFT__CTOR_OFFSET UNITYSDK_OFFSET(0x18FE9A20)
