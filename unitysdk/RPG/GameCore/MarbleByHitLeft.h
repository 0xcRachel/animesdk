...
#define RPG_GAMECORE_MARBLEBYHITLEFT_METHOD_4_6F76C85F504B6F87_OFFSET UNITYSDK_OFFSET(0x16C3A7A0)
#define RPG_GAMECORE_MARBLEBYHITLEFT_METHOD_4_BB59E34F61C43D52_OFFSET UNITYSDK_OFFSET(0x16C3A6C0)
#define RPG_GAMECORE_MARBLEBYHITLEFT__CTOR_OFFSET UNITYSDK_OFFSET(0x16C3A750)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleByHitLeft_TypeDefinitionIndex = 15203;
