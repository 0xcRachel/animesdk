...
#define RPG_GAMECORE_ROGUECANDYCRASHCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16E1EE90)
#define RPG_GAMECORE_ROGUECANDYCRASHCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16E1F540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueCandyCrashConfigRow_TypeDefinitionIndex = 13331;

	class RogueCandyCrashConfigRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* RoundRange; // 0x10
		::System::UInt32 TotalTime; // 0x18
