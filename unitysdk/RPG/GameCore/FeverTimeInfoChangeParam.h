...
#define RPG_GAMECORE_FEVERTIMEINFOCHANGEPARAM_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x136F0450)
#define RPG_GAMECORE_FEVERTIMEINFOCHANGEPARAM_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x136F0400)
#define RPG_GAMECORE_FEVERTIMEINFOCHANGEPARAM_GET_FILLAMOUNT_OFFSET UNITYSDK_OFFSET(0x136F04A0)
#define RPG_GAMECORE_FEVERTIMEINFOCHANGEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x136F05A0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::FeverTimePeriodType PeriodType; // 0x30
		::RPG::GameCore::FixPoint CurProgress; // 0x38
		::RPG::GameCore::FixPoint ExtraCount; // 0x40
		::RPG::GameCore::FixPoint ToastDelta; // 0x48
		::System::Boolean IsLimitReached; // 0x50
