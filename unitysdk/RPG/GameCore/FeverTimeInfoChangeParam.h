...
#define RPG_GAMECORE_FEVERTIMEINFOCHANGEPARAM_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA414070)
#define RPG_GAMECORE_FEVERTIMEINFOCHANGEPARAM_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA414020)
#define RPG_GAMECORE_FEVERTIMEINFOCHANGEPARAM_GET_FILLAMOUNT_OFFSET UNITYSDK_OFFSET(0xA4140C0)
#define RPG_GAMECORE_FEVERTIMEINFOCHANGEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xA414120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FeverTimeInfoChangeParam_TypeDefinitionIndex = 44678;

	class FeverTimeInfoChangeParam : public ::Class_1_9988289E7F8AA214
	{
	public:
		::RPG::GameCore::FixPoint ToastDelta; // 0x18
		::System::Boolean IsLimitReached; // 0x20
		::RPG::GameCore::FeverTimeToastType ToastType; // 0x24
		::RPG::GameCore::FixPoint MaxProgress; // 0x28
		::RPG::GameCore::FixPoint CurProgress; // 0x30
		::RPG::GameCore::FeverTimePeriodType PeriodType; // 0x38
		::RPG::GameCore::FixPoint ExtraCount; // 0x40
