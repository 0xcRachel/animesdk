...
#define RPG_GAMECORE_TIMEREWINDENTITYANIMOVERRIDE_METHOD_2_1D6C3813E775F569_OFFSET UNITYSDK_OFFSET(0x170F54F0)
#define RPG_GAMECORE_TIMEREWINDENTITYANIMOVERRIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x170F5690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRewindEntityAnimOverride_TypeDefinitionIndex = 15871;
