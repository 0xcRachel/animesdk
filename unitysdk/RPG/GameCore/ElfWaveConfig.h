...
#define RPG_GAMECORE_ELFWAVECONFIG_METHOD_2_0680375E610F94B8_OFFSET UNITYSDK_OFFSET(0x16A644C0)
#define RPG_GAMECORE_ELFWAVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16A646D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfWaveConfig_TypeDefinitionIndex = 16577;
