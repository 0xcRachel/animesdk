...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::GridFightRoleSkillTag>**)Il2CppClass::FromTypeDefinitionIndex(GridFightRoleSkillDisplayConfigRow___O_TypeDefinitionIndex)->GetStaticField(0x35200);
		}
	};
}
