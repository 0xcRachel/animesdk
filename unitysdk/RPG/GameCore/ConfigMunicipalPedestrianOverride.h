...
#define RPG_GAMECORE_CONFIGMUNICIPALPEDESTRIANOVERRIDE_METHOD_2_4F8222307DDAA8C5_OFFSET UNITYSDK_OFFSET(0x169C5E00)
#define RPG_GAMECORE_CONFIGMUNICIPALPEDESTRIANOVERRIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x169C5F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConfigMunicipalPedestrianOverride_TypeDefinitionIndex = 15231;
