...
#define RPG_GAMECORE_PROPSWITCHMATERIAL_METHOD_3_30CCBD148FDAD1F4_OFFSET UNITYSDK_OFFSET(0x16DB8630)
#define RPG_GAMECORE_PROPSWITCHMATERIAL_METHOD_3_BD03B23894186EDF_OFFSET UNITYSDK_OFFSET(0x16DB8440)
#define RPG_GAMECORE_PROPSWITCHMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x16DB8550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropSwitchMaterial_TypeDefinitionIndex = 19810;
