...
#define RPG_GAMECORE_LITTLEGAMEENTITYCONFIG_METHOD_2_7D8866CD234979B1_OFFSET UNITYSDK_OFFSET(0x16BCD6B0)
#define RPG_GAMECORE_LITTLEGAMEENTITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16BCD860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameEntityConfig_TypeDefinitionIndex = 16885;
