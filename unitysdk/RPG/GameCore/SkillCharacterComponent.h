...
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_ADDSKILLFROMCOMMONSKILLPOOL_OFFSET UNITYSDK_OFFSET(0x9F4E180)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_ADDSKILLLAYOUT_OFFSET UNITYSDK_OFFSET(0x9F46BA0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_CHECKSKILLUSABLEBYCONTROLTYPE_OFFSET UNITYSDK_OFFSET(0x9F51870)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_CLEARSKILLLAYOUT_OFFSET UNITYSDK_OFFSET(0x9F46C00)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_COMPUTECURRENTSKILLMAINANDSUBTARGETENTITYLIST_OFFSET UNITYSDK_OFFSET(0x9F4CC00)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_COMPUTECURRENTSKILLSUBTARGETENTITYLIST_OFFSET UNITYSDK_OFFSET(0x9F4DB60)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_COMPUTECURRENTSKILLTARGETENTITYLIST_OFFSET UNITYSDK_OFFSET(0x9F4CE80)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_COMPUTESKILLMAINANDSUBTARGETENTITYLIST_OFFSET UNITYSDK_OFFSET(0x9F4CD30)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_COMPUTESKILLSUBTARGETENTITYLIST_OFFSET UNITYSDK_OFFSET(0x9F4BCA0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_COMPUTESKILLTARGETENTITYLIST_OFFSET UNITYSDK_OFFSET(0x9F4ACA0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_DEFAULTCONVERTCONTROLSKILLTYPETOUIINDEX_OFFSET UNITYSDK_OFFSET(0x9F46B00)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_DEFAULTCONVERTUIINDEXTOCONTROLSKILLTYPE_OFFSET UNITYSDK_OFFSET(0x9F46AA0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9F47470)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_FILLALLSKILLDATABYTAG_OFFSET UNITYSDK_OFFSET(0x9F56990)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_FILLALLSKILLDATA_OFFSET UNITYSDK_OFFSET(0x9F53660)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETALLALLOWSKILLIDXLIST_OFFSET UNITYSDK_OFFSET(0x9F56D80)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETCONTROLSKILLMAPPING_OFFSET UNITYSDK_OFFSET(0x9F4E0F0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETCONTROLSKILLTYPEBYSKILLINDEX_1_OFFSET UNITYSDK_OFFSET(0x9F4DF80)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETCONTROLSKILLTYPEBYSKILLINDEX_OFFSET UNITYSDK_OFFSET(0x9F4DF20)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETCONTROLSKILLTYPEBYUIINDEX_OFFSET UNITYSDK_OFFSET(0x9F46C50)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETCONTROLSKILLTYPEONCURLAYOUT_OFFSET UNITYSDK_OFFSET(0x9F46F70)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETCOOLDOWN_OFFSET UNITYSDK_OFFSET(0x9F57C40)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETCURLAYOUTKEYBYCONTROLSKILLTYPE_OFFSET UNITYSDK_OFFSET(0x9F46E60)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETCURRENTRECORDSKILLINDEX_OFFSET UNITYSDK_OFFSET(0x9F53160)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETCURRENTSKILLCONFIG_OFFSET UNITYSDK_OFFSET(0x9F52310)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETCURRENTSKILLDATA_OFFSET UNITYSDK_OFFSET(0x9F53210)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETCURRENTSKILLEXTRAUSEPARAM_OFFSET UNITYSDK_OFFSET(0x9F53110)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETCURRENTSKILLINDEX_OFFSET UNITYSDK_OFFSET(0x9F530C0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETCURRENTSKILLLAYOUT_OFFSET UNITYSDK_OFFSET(0x9F46B50)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETCURULTRASKILLDATA_OFFSET UNITYSDK_OFFSET(0x9F53610)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETDEFAULTSKILLDATABYCONTROLTYPE_OFFSET UNITYSDK_OFFSET(0x9F534A0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETELATIONSKILLDATABYSKILLDATA_OFFSET UNITYSDK_OFFSET(0x9F463E0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETELATIONSKILLDATABYTAG_OFFSET UNITYSDK_OFFSET(0x9F46090)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETELATIONSKILLDATA_OFFSET UNITYSDK_OFFSET(0x9F46310)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETFIRSTALLOWUSESKILL_OFFSET UNITYSDK_OFFSET(0x9F557C0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETFIRSTELATIONSKILLDATABYTAG_OFFSET UNITYSDK_OFFSET(0x9F46250)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETFIRSTSKILLCONFIGBYSKILLTYPE_OFFSET UNITYSDK_OFFSET(0x9F52E20)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETLEFTCASTTIMES_OFFSET UNITYSDK_OFFSET(0x9F57AC0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETMAXCASTTIMES_OFFSET UNITYSDK_OFFSET(0x9F57B80)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETSKILLACTUALATTACKERINCLUDEPRESHOWENTITY_OFFSET UNITYSDK_OFFSET(0x9F52C50)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETSKILLACTUALATTACKER_OFFSET UNITYSDK_OFFSET(0x9F4CAE0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETSKILLCONFIGBYINDEX_OFFSET UNITYSDK_OFFSET(0x9F52EC0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETSKILLDATABYCONTROLTYPE_OFFSET UNITYSDK_OFFSET(0x9F53300)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETSKILLDATABYTAG_OFFSET UNITYSDK_OFFSET(0x9F56880)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETSKILLDATABYTRIGGERKEY_OFFSET UNITYSDK_OFFSET(0x9F4DE00)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETSKILLDATAONCURLAYOUT_OFFSET UNITYSDK_OFFSET(0x9F535A0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETSKILLDATA_OFFSET UNITYSDK_OFFSET(0x9F4CF60)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETSKILLMAXHITCOUNT_OFFSET UNITYSDK_OFFSET(0x9F52F90)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETSKILLTYPEDISABLETEXT_OFFSET UNITYSDK_OFFSET(0x9F55160)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETSKILLTYPEDISABLETIP_OFFSET UNITYSDK_OFFSET(0x9F57D50)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETSPNEEDBYSKILLINDEX_OFFSET UNITYSDK_OFFSET(0x9F59530)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GETUISKILLINDEXBYCONTROLSKILLTYPE_OFFSET UNITYSDK_OFFSET(0x9F46DB0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GET_CURRENTSKILLSUBTARGETLIST_OFFSET UNITYSDK_OFFSET(0x9F59AB0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GET_CURRENTSKILLTARGETLIST_OFFSET UNITYSDK_OFFSET(0x9F59AA0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GET_ELATIONCONFIGLIST_OFFSET UNITYSDK_OFFSET(0x9F46A00)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GET_ELATIONSKILLDATALIST_OFFSET UNITYSDK_OFFSET(0x9F46A20)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GET_ELATIONUICONFIG_OFFSET UNITYSDK_OFFSET(0x9F46A30)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GET_ISIGNORESLOTFIT_OFFSET UNITYSDK_OFFSET(0x9F59B20)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GET_ISNOBPCOSTBYTASK_OFFSET UNITYSDK_OFFSET(0x9F59AE0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GET_ISNOBPCOSTSPECIALAVATAR_OFFSET UNITYSDK_OFFSET(0x9F59AC0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GET_ISNOBPCOST_OFFSET UNITYSDK_OFFSET(0x9F56D20)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GET_ISNOSPCOST_OFFSET UNITYSDK_OFFSET(0x9F59B00)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GET_ISULTRASKILLSKIPSPCHECK_OFFSET UNITYSDK_OFFSET(0x9F51E10)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GET_JSONCONFIG_OFFSET UNITYSDK_OFFSET(0x9F599A0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GET_JSONSKILLCOUNT_OFFSET UNITYSDK_OFFSET(0x9F599D0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GET_PASSIVEUSED_OFFSET UNITYSDK_OFFSET(0x9F59B40)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GET_SELFPERFORMSTATE_OFFSET UNITYSDK_OFFSET(0x9F599B0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GET_SKILLACTUALATTACKER_OFFSET UNITYSDK_OFFSET(0x9F59A60)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GET_SKILLDATALIST_OFFSET UNITYSDK_OFFSET(0x9F599C0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GET_SKILLPOINTENTITY_OFFSET UNITYSDK_OFFSET(0x9F59A40)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_GET_TASKCONTEXT_OFFSET UNITYSDK_OFFSET(0x9F59B60)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_HASNONPASSIVESKILL_OFFSET UNITYSDK_OFFSET(0x9F582F0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_HASOPINSKILL_OFFSET UNITYSDK_OFFSET(0x9F58E90)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_HASRECORDSKILL_OFFSET UNITYSDK_OFFSET(0x9F58D90)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_HASSKILLTAG_OFFSET UNITYSDK_OFFSET(0x9F584B0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_HASSKILLTYPE_OFFSET UNITYSDK_OFFSET(0x9F58420)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_INITCOMPONENT_OFFSET UNITYSDK_OFFSET(0x9F476C0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_ISALLOWUSESKILL_OFFSET UNITYSDK_OFFSET(0x9F56F50)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_ISCURRENTSKILLFINISH_OFFSET UNITYSDK_OFFSET(0x9F545E0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_ISSELFALLOWINSERTULTRA_OFFSET UNITYSDK_OFFSET(0x9F549C0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_ISSELFALLOWUSESKILL_OFFSET UNITYSDK_OFFSET(0x9F55C10)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_ISSKILLDISABLE_OFFSET UNITYSDK_OFFSET(0x9F55090)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_ISSKILLINDEXVALID_OFFSET UNITYSDK_OFFSET(0x9F4CCD0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_ISSKILLTYPEDISABLE_OFFSET UNITYSDK_OFFSET(0x9F57CD0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_MAKESKILLPERFORMWORKING_OFFSET UNITYSDK_OFFSET(0x9F54970)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_MAYREDIRECTSKILLTARGET_OFFSET UNITYSDK_OFFSET(0x9F58880)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_MODIFYSKILLDATAPROPERTY_1_OFFSET UNITYSDK_OFFSET(0x9F54550)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_MODIFYSKILLDATAPROPERTY_OFFSET UNITYSDK_OFFSET(0x9F540B0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_MODIFYSKILLSLOTPROPERTY_OFFSET UNITYSDK_OFFSET(0x9F53830)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_MODIFYSKILLTYPEPROPERTY_OFFSET UNITYSDK_OFFSET(0x9F53C50)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_ONAFTERSKILLPERFORM_OFFSET UNITYSDK_OFFSET(0x9F54650)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_ONREFRESHSELECTAIMATTARGETS_OFFSET UNITYSDK_OFFSET(0x9F58F90)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_OVERRIDEELATIONCHARACTERUICONFIG_OFFSET UNITYSDK_OFFSET(0x9F46790)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_OVERRIDEELATIONPOINTINSKILLUSE_OFFSET UNITYSDK_OFFSET(0x9F46740)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_POPSKILLTYPEDISABLE_OFFSET UNITYSDK_OFFSET(0x9F58140)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_PROCESSOPINSKILL_OFFSET UNITYSDK_OFFSET(0x9F58F40)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_PUSHSKILLTYPEDISABLE_OFFSET UNITYSDK_OFFSET(0x9F57F80)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_RECORDOPINSKILL_OFFSET UNITYSDK_OFFSET(0x9F58EE0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_RECORDUSESKILL_OFFSET UNITYSDK_OFFSET(0x9F58B60)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_REFRESHCURRENTSKILLPERFORM_OFFSET UNITYSDK_OFFSET(0x9F54700)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_RESETOVERRIDEELATIONCHARACTERUICONFIG_OFFSET UNITYSDK_OFFSET(0x9F467E0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_RPG_GAMECORE_ISKILLCHARACTERCOMPONENT_GET_CURRENTSKILLSUBTARGETLIST_OFFSET UNITYSDK_OFFSET(0x9F59A90)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_RPG_GAMECORE_ISKILLCHARACTERCOMPONENT_GET_CURRENTSKILLTARGETLIST_OFFSET UNITYSDK_OFFSET(0x9F59A80)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_SETCONTROLSKILLMAPPING_OFFSET UNITYSDK_OFFSET(0x9F4DC00)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_SETCOOLDOWN_OFFSET UNITYSDK_OFFSET(0x9F523E0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_SETCURRENTSKILLINDEX_OFFSET UNITYSDK_OFFSET(0x9F531C0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_SETLEFTCASTTIMES_OFFSET UNITYSDK_OFFSET(0x9F579E0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_SETSKILLCUSTOMTOASTPATH_OFFSET UNITYSDK_OFFSET(0x9F58AF0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_SETSKILLPERFORMFINISH_OFFSET UNITYSDK_OFFSET(0x9F57680)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_SETUPELATIONSKILLDATA_OFFSET UNITYSDK_OFFSET(0x9F464A0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_SET_ELATIONCONFIGLIST_OFFSET UNITYSDK_OFFSET(0x9F46A10)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_SET_ISIGNORESLOTFIT_OFFSET UNITYSDK_OFFSET(0x9F59B30)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_SET_ISNOBPCOSTBYTASK_OFFSET UNITYSDK_OFFSET(0x9F59AF0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_SET_ISNOBPCOSTSPECIALAVATAR_OFFSET UNITYSDK_OFFSET(0x9F59AD0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_SET_ISNOSPCOST_OFFSET UNITYSDK_OFFSET(0x9F59B10)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_SET_PASSIVEUSED_OFFSET UNITYSDK_OFFSET(0x9F59B50)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_SET_SKILLACTUALATTACKER_OFFSET UNITYSDK_OFFSET(0x9F59A70)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_SET_SKILLPOINTENTITY_OFFSET UNITYSDK_OFFSET(0x9F59A50)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_SET_TASKCONTEXT_OFFSET UNITYSDK_OFFSET(0x9F59B70)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_STACKSKILLTARGETREDIRECT_OFFSET UNITYSDK_OFFSET(0x9F585F0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_TRYGETSKILLPRECOMPUTEDRESULT_OFFSET UNITYSDK_OFFSET(0x9F49C90)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_TRYUSEPASSIVESKILL_OFFSET UNITYSDK_OFFSET(0x9F49A20)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_UNMODIFYSKILLSLOTPROPERTY_OFFSET UNITYSDK_OFFSET(0x9F53A40)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_UNMODIFYSKILLTYPEPROPERTY_OFFSET UNITYSDK_OFFSET(0x9F53E80)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_UNSTACKSKILLTARGETREDIRECT_OFFSET UNITYSDK_OFFSET(0x9F58760)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_USERECORDSKILL_OFFSET UNITYSDK_OFFSET(0x9F58DE0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_USESKILL_OFFSET UNITYSDK_OFFSET(0x9F505A0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT__ADDBPAFTERSKILLUSE_OFFSET UNITYSDK_OFFSET(0x9F52800)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT__ADDELATIONSKILLDATA_OFFSET UNITYSDK_OFFSET(0x9F466B0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT__ADDPREMODIFIERBEFOREENTRYABILITY_OFFSET UNITYSDK_OFFSET(0x9F52960)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT__ADDSKILLFROMCOMMONSKILLPOOL_G___GETROWDATAFORCOMMONSKILL_48_0_OFFSET UNITYSDK_OFFSET(0x9F502A0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT__ADDSPAFTERSKILLUSE_OFFSET UNITYSDK_OFFSET(0x9F525E0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x9F47020)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT__DECBPBEFORESKILLUSE_OFFSET UNITYSDK_OFFSET(0x9F52180)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT__DECCASTTIMEBEFORESKILLUSE_OFFSET UNITYSDK_OFFSET(0x9F52240)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT__DECSPBEFORESKILLUSE_OFFSET UNITYSDK_OFFSET(0x9F51F80)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT__GETSKILLUSEBPPOINT_OFFSET UNITYSDK_OFFSET(0x9F51E80)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT__INITEVENT_OFFSET UNITYSDK_OFFSET(0x9F49B80)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT__ISININSERTNORMALACTION_OFFSET UNITYSDK_OFFSET(0x9F56B10)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT__ONENTITYREVIVE_OFFSET UNITYSDK_OFFSET(0x9F597F0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT__ONLEVELTURNENDEVENT_OFFSET UNITYSDK_OFFSET(0x9F59680)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT__ONUSEACTIVESKILLSHOWUI_OFFSET UNITYSDK_OFFSET(0x9F52360)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT__OVERRIDEELATIONPOINTBEFORESKILLUSE_OFFSET UNITYSDK_OFFSET(0x9F46830)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT__REDIRECTSKILLTARGET_OFFSET UNITYSDK_OFFSET(0x9F4D0D0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT__REVERTOVERRIDEELATIONPOINT_OFFSET UNITYSDK_OFFSET(0x9F46920)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT__SETUPCHARACTERSKILL_OFFSET UNITYSDK_OFFSET(0x9F47770)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT__TRYLOADELATIONCONFIG_OFFSET UNITYSDK_OFFSET(0x9F46600)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT__UNINITEVENT_OFFSET UNITYSDK_OFFSET(0x9F475B0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>**)Il2CppClass::FromTypeDefinitionIndex(SkillCharacterComponent_TypeDefinitionIndex)->GetStaticField(0x692C0);
		}
		static ::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>** StaticGet__CachedSkillTargetList()
		{
			return (::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>**)Il2CppClass::FromTypeDefinitionIndex(SkillCharacterComponent_TypeDefinitionIndex)->GetStaticField(0x692C8);
		}
		static ::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>** StaticGet__CachedSkillTargetListWithSub()
		{
			return (::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>**)Il2CppClass::FromTypeDefinitionIndex(SkillCharacterComponent_TypeDefinitionIndex)->GetStaticField(0x692D0);
		}
		::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* CurrentAimAtSubTargetList; // 0x18
		...
		::Il2CppArray<::Class_1_EABAA0FA9B3BC305*>* _SkillSlots; // 0x30
		::System::Collections::Generic::List_1<::Class_1_83D980B81C9B9AFA*>* _ElationSkillDataList; // 0x38
		::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* CurrentAimAtTargetList; // 0x40
		::System::Collections::Generic::HashSet_1<::Class_1_29327D508CD1E435*>* _SkillTypeDisableSlots; // 0x48
		::RPG::GameCore::AbilityCursorInfo _recordAbilityInfo; // 0x50
		::RPG::GameCore::ElationConfigList* _ElationConfigList_k__BackingField; // 0x80
		::Il2CppArray<::Class_1_7C108062C171623D*>* _SkillTypeOverrideProperty; // 0x88
		::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* _CurrentSkillSubTargetList_k__BackingField; // 0x90
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::UInt32>* CurrentSkillTargetCharacterId; // 0x98
		::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* CurrentAimAtMainTargetList; // 0xA0
		::RPG::GameCore::TurnBasedAbilityComponent* _TBAbilityRef; // 0xA8
		::RPG::GameCore::GameEntity* _SkillActualAttacker_k__BackingField; // 0xB0
		::Il2CppArray<::System::Int32>* _SkillTypeDisableCountArr; // 0xB8
		::RPG::GameCore::CharacterDataComponent* _CharacterDataRef; // 0xC0
		::RPG::GameCore::CharacterConfig* _JsonConfigRef; // 0xC8
		::System::Collections::Generic::List_1<::System::Action_1<::RPG::GameCore::SkillData*>*>* OnSkillSetup; // 0xD0
		::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* _CurrentSkillTargetList_k__BackingField; // 0xD8
		::Class_1_FA702C103FB59536* _CurLayout; // 0xE0
		::RPG::GameCore::ElationCharacterUIConfig* _OverrideElationCharacterUIConfig; // 0xE8
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::GameCore::FixPoint>* CurrentSkillTargetDamageHP; // 0xF0
		::Class_1_F6CF5FB460BC6CBB* AutoUseUltraParams; // 0xF8
		::RPG::GameCore::TaskContext* _TaskContext_k__BackingField; // 0x100
		::System::Collections::Generic::List_1<::Class_1_DA7AFD2A0834A588*>* _SkillTargetRedirectEntries; // 0x108
		::Class_1_77E96ACE7A0E87CA* _BattleSkillToastManager; // 0x110
		::System::Single _TargetPerformTimeCounter; // 0x118
		::System::Int32 SelfWaitActiveSkillIndex; // 0x11C
		::System::Int32 _actionSkillIndex; // 0x120
		::System::Int32 _RecordSkillExtraUseParam; // 0x124
		::System::Int32 _OpIndexInSkill; // 0x128
		::System::Int32 _CurrentSkillIndex; // 0x12C
		::System::Boolean _IsNoBpCostSpecialAvatar_k__BackingField; // 0x130
		::System::Boolean CurrentSkillBreakStance; // 0x131
		::System::Boolean _IsNoSpCost_k__BackingField; // 0x132
		::System::Boolean _hasRecordSkill; // 0x133
		::RPG::GameCore::SelfSkillPerformState _SelfSkillPerformState; // 0x134
		::System::Int32 _RedirectTargetIDIncr; // 0x138
		::System::Boolean CharmAction; // 0x13C
		::System::Boolean CurrentSkillKillAllOrBoss; // 0x13D
		::System::Boolean CurrentSkillHasTriggerEffect; // 0x13E
		::System::Boolean _IsNoBpCostByTask_k__BackingField; // 0x13F
		::System::Int32 _CurrentSkillExtraUseParam; // 0x140
		::System::Boolean _isPassive; // 0x144
		::System::Boolean _hasOpInSkill; // 0x145
		::System::Boolean _AutoStandbyOnCurSkillFinish; // 0x146
		::System::Boolean _PassiveUsed_k__BackingField; // 0x147
		::System::Boolean _IsIgnoreSlotFit_k__BackingField; // 0x148
