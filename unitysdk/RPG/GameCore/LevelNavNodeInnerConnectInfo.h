...
#define RPG_GAMECORE_LEVELNAVNODEINNERCONNECTINFO_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x16BB0B10)
#define RPG_GAMECORE_LEVELNAVNODEINNERCONNECTINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16BB09D0)
#define RPG_GAMECORE_LEVELNAVNODEINNERCONNECTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16BB09C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelNavNodeInnerConnectInfo_TypeDefinitionIndex = 15470;
