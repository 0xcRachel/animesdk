...
#define RPG_GAMECORE_AIVARIABLE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x198826E0)
#define RPG_GAMECORE_AIVARIABLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x19882670)
#define RPG_GAMECORE_AIVARIABLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19882760)
#define RPG_GAMECORE_AIVARIABLE_METHOD_2_08841389B3B0EE4A_1_OFFSET UNITYSDK_OFFSET(0x19882850)
#define RPG_GAMECORE_AIVARIABLE_METHOD_2_08841389B3B0EE4A_OFFSET UNITYSDK_OFFSET(0x19882810)
#define RPG_GAMECORE_AIVARIABLE_METHOD_2_5082A76794C3F7FF_OFFSET UNITYSDK_OFFSET(0x19881C20)
#define RPG_GAMECORE_AIVARIABLE_METHOD_2_EAF0FEF732F0BB8E_OFFSET UNITYSDK_OFFSET(0x19881910)
#define RPG_GAMECORE_AIVARIABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19881C10)
