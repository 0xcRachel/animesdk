...
#define RPG_GAMECORE_AIVARIABLE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x16773190)
#define RPG_GAMECORE_AIVARIABLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x16773130)
#define RPG_GAMECORE_AIVARIABLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x16773220)
#define RPG_GAMECORE_AIVARIABLE_METHOD_2_08841389B3B0EE4A_1_OFFSET UNITYSDK_OFFSET(0x16773310)
#define RPG_GAMECORE_AIVARIABLE_METHOD_2_08841389B3B0EE4A_OFFSET UNITYSDK_OFFSET(0x167732D0)
#define RPG_GAMECORE_AIVARIABLE_METHOD_2_5082A76794C3F7FF_OFFSET UNITYSDK_OFFSET(0x167726D0)
#define RPG_GAMECORE_AIVARIABLE_METHOD_2_EAF0FEF732F0BB8E_OFFSET UNITYSDK_OFFSET(0x167723E0)
#define RPG_GAMECORE_AIVARIABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x167726C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIVariable_TypeDefinitionIndex = 14184;
