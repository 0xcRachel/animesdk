...
#define RPG_GAMECORE_CHIMERABATTLESHOWNPCTALKBUBBLE_METHOD_3_18F6BDCDAADFFFE5_OFFSET UNITYSDK_OFFSET(0x16985830)
#define RPG_GAMECORE_CHIMERABATTLESHOWNPCTALKBUBBLE_METHOD_3_7B0EE62B7997CB5D_OFFSET UNITYSDK_OFFSET(0x16986A90)
#define RPG_GAMECORE_CHIMERABATTLESHOWNPCTALKBUBBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16985820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattleShowNPCTalkBubble_TypeDefinitionIndex = 14313;
