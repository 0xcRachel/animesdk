...
#define RPG_GAMECORE_REMOVENAVMESHSTATE_METHOD_3_3C88E7A54493F6BF_OFFSET UNITYSDK_OFFSET(0x1A2E8780)
#define RPG_GAMECORE_REMOVENAVMESHSTATE_METHOD_3_7C108FE20C2D378E_OFFSET UNITYSDK_OFFSET(0x1A2E8700)
#define RPG_GAMECORE_REMOVENAVMESHSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2E8750)
