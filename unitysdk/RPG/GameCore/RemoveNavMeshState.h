...
#define RPG_GAMECORE_REMOVENAVMESHSTATE_METHOD_3_3C88E7A54493F6BF_OFFSET UNITYSDK_OFFSET(0x16DE0800)
#define RPG_GAMECORE_REMOVENAVMESHSTATE_METHOD_3_7C108FE20C2D378E_OFFSET UNITYSDK_OFFSET(0x16DE0780)
#define RPG_GAMECORE_REMOVENAVMESHSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16DE07D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveNavMeshState_TypeDefinitionIndex = 19883;
