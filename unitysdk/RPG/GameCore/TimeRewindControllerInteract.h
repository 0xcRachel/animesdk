...
#define RPG_GAMECORE_TIMEREWINDCONTROLLERINTERACT_METHOD_3_29D5FFFB74B07D3B_OFFSET UNITYSDK_OFFSET(0x170F4D30)
#define RPG_GAMECORE_TIMEREWINDCONTROLLERINTERACT_METHOD_3_EB8AB12E7EB7DF2F_OFFSET UNITYSDK_OFFSET(0x170F4E40)
#define RPG_GAMECORE_TIMEREWINDCONTROLLERINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x170F4E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRewindControllerInteract_TypeDefinitionIndex = 18445;
