...
#define RPG_GAMECORE_CHIMERAEVALUATIONCONDITION_METHOD_2_75945B8D8AA0A742_OFFSET UNITYSDK_OFFSET(0x1699AFC0)
#define RPG_GAMECORE_CHIMERAEVALUATIONCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1699B150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraEvaluationCondition_TypeDefinitionIndex = 14297;
