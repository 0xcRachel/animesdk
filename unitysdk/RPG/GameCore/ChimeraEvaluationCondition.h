...
#define RPG_GAMECORE_CHIMERAEVALUATIONCONDITION_METHOD_2_F2FAA28219EFAC89_OFFSET UNITYSDK_OFFSET(0x1A51C7D0)
#define RPG_GAMECORE_CHIMERAEVALUATIONCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A51C960)
