...
#define RPG_GAMECORE_WAITMISSIONTALKFINISH_METHOD_3_856C3D9F2B5A12BF_OFFSET UNITYSDK_OFFSET(0x17912710)
#define RPG_GAMECORE_WAITMISSIONTALKFINISH_METHOD_3_D9761DE28CC10713_OFFSET UNITYSDK_OFFSET(0x17912820)
#define RPG_GAMECORE_WAITMISSIONTALKFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x179127F0)
