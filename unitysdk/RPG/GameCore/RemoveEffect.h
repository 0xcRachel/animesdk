...
#define RPG_GAMECORE_REMOVEEFFECT_METHOD_3_8AA2D591654B57BF_OFFSET UNITYSDK_OFFSET(0x16DDE900)
#define RPG_GAMECORE_REMOVEEFFECT_METHOD_3_F29BC740264FC405_OFFSET UNITYSDK_OFFSET(0x16DDE9A0)
#define RPG_GAMECORE_REMOVEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x16DDE960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveEffect_TypeDefinitionIndex = 20531;
