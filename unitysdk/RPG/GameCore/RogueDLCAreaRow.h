...
#define RPG_GAMECORE_ROGUEDLCAREAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19EA7510)
#define RPG_GAMECORE_ROGUEDLCAREAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19EA7FB0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID AreaDescID; // 0x50
		::System::UInt32 RecommendLevel; // 0x60
		::System::UInt32 FirstReward; // 0x64
		::System::UInt32 AreaID; // 0x68
		::RPG::GameCore::RogueSubMode SubType; // 0x6C
		::RPG::GameCore::ChessRogueDifficultyType Difficulty; // 0x70
		::System::UInt32 MonsterEliteDropDisplayID; // 0x74
		::System::Boolean IsHard; // 0x78
