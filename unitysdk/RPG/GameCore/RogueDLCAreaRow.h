...
#define RPG_GAMECORE_ROGUEDLCAREAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19255790)
#define RPG_GAMECORE_ROGUEDLCAREAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19256230)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::Class_1_E71924F20B00CC55_1*>* AreaScoreMap; // 0x18
		...
		::RPG::Client::TextID AreaNameID; // 0x48
		::System::UInt32 UnlockID; // 0x58
		::System::Boolean IsHard; // 0x5C
		::RPG::Client::TextID AreaDescID; // 0x60
		::System::UInt32 MonsterEliteDropDisplayID; // 0x70
		::System::UInt32 RecommendLevel; // 0x74
		::RPG::GameCore::RogueSubMode SubType; // 0x78
