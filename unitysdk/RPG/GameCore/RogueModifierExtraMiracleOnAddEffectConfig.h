...
#define RPG_GAMECORE_ROGUEMODIFIEREXTRAMIRACLEONADDEFFECTCONFIG_METHOD_3_09E80F50801659DB_OFFSET UNITYSDK_OFFSET(0x16E9F7A0)
#define RPG_GAMECORE_ROGUEMODIFIEREXTRAMIRACLEONADDEFFECTCONFIG_METHOD_3_AD6653DED03E2652_OFFSET UNITYSDK_OFFSET(0x16E97F30)
#define RPG_GAMECORE_ROGUEMODIFIEREXTRAMIRACLEONADDEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E97EE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExtraMiracleOnAddEffectConfig_TypeDefinitionIndex = 16025;
