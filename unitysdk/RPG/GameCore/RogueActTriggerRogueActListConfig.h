...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEACTLISTCONFIG_METHOD_6_03CE19AA1E2F0B57_OFFSET UNITYSDK_OFFSET(0x1A9B7BC0)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEACTLISTCONFIG_METHOD_6_1A6597EFF3B65BE2_OFFSET UNITYSDK_OFFSET(0x1A9B7DE0)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEACTLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9B7D00)
