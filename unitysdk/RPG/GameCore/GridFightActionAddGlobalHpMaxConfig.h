...
#define RPG_GAMECORE_GRIDFIGHTACTIONADDGLOBALHPMAXCONFIG_METHOD_6_7219BE497A6A4EE4_OFFSET UNITYSDK_OFFSET(0x19561C10)
#define RPG_GAMECORE_GRIDFIGHTACTIONADDGLOBALHPMAXCONFIG_METHOD_6_D2FD965A46DAB647_OFFSET UNITYSDK_OFFSET(0x19561AA0)
#define RPG_GAMECORE_GRIDFIGHTACTIONADDGLOBALHPMAXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19561B70)
