...
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYANYCONFIG_METHOD_3_CF392BA7A16835D3_OFFSET UNITYSDK_OFFSET(0x1766C0E0)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYANYCONFIG_METHOD_3_D8026FA21552B60F_OFFSET UNITYSDK_OFFSET(0x1766C290)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYANYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1766C0D0)
