...
#define RPG_GAMECORE_BYTARGETVISIBLE_METHOD_4_E38B3BEE4734ED44_OFFSET UNITYSDK_OFFSET(0x16940B90)
#define RPG_GAMECORE_BYTARGETVISIBLE_METHOD_4_FA57737ACF91A7CA_OFFSET UNITYSDK_OFFSET(0x16940C60)
#define RPG_GAMECORE_BYTARGETVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16940C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByTargetVisible_TypeDefinitionIndex = 18396;
