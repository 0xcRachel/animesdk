...
#define RPG_GAMECORE_GRASSDATA_METHOD_2_4614DD3BAE43EF0A_OFFSET UNITYSDK_OFFSET(0x195604D0)
#define RPG_GAMECORE_GRASSDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x195607C0)
