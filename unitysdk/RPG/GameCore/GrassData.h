...
#define RPG_GAMECORE_GRASSDATA_METHOD_2_DF32A8DA9D5E4EB6_OFFSET UNITYSDK_OFFSET(0x19CAF7A0)
#define RPG_GAMECORE_GRASSDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19CAFA90)
