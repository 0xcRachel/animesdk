...
#define RPG_GAMECORE_UNIVERSALHOTFIXPREDICATEC_METHOD_5_DC227F05CDD11C50_OFFSET UNITYSDK_OFFSET(0x1713E5E0)
#define RPG_GAMECORE_UNIVERSALHOTFIXPREDICATEC_METHOD_5_EFCB24E4A3C9E61B_OFFSET UNITYSDK_OFFSET(0x1713E6B0)
#define RPG_GAMECORE_UNIVERSALHOTFIXPREDICATEC__CTOR_OFFSET UNITYSDK_OFFSET(0x1713E660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UniversalHotFixPredicateC_TypeDefinitionIndex = 21033;
