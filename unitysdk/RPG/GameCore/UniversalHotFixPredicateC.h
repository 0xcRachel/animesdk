...
#define RPG_GAMECORE_UNIVERSALHOTFIXPREDICATEC_METHOD_5_DC227F05CDD11C50_OFFSET UNITYSDK_OFFSET(0x178FAEC0)
#define RPG_GAMECORE_UNIVERSALHOTFIXPREDICATEC_METHOD_5_EFCB24E4A3C9E61B_OFFSET UNITYSDK_OFFSET(0x178F9F90)
#define RPG_GAMECORE_UNIVERSALHOTFIXPREDICATEC__CTOR_OFFSET UNITYSDK_OFFSET(0x178F9F40)
