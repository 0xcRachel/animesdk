...
#define RPG_GAMECORE_ROGUEMODIFIERTITANBLESSCIPHERCONFIG_METHOD_3_1E0B2D4B06C58A9C_OFFSET UNITYSDK_OFFSET(0x16E9D790)
#define RPG_GAMECORE_ROGUEMODIFIERTITANBLESSCIPHERCONFIG_METHOD_3_39958D0243EA67A5_OFFSET UNITYSDK_OFFSET(0x16EA2B60)
#define RPG_GAMECORE_ROGUEMODIFIERTITANBLESSCIPHERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E9D740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierTitanBlessCipherConfig_TypeDefinitionIndex = 16026;
