...
#define RPG_GAMECORE_PROPINTERACTOVERRIDEDATA01_METHOD_3_0251A7754BF5C700_OFFSET UNITYSDK_OFFSET(0x191C7470)
#define RPG_GAMECORE_PROPINTERACTOVERRIDEDATA01_METHOD_3_93C3B0CCEE802ACF_OFFSET UNITYSDK_OFFSET(0x191C73F0)
#define RPG_GAMECORE_PROPINTERACTOVERRIDEDATA01__CTOR_OFFSET UNITYSDK_OFFSET(0x191C7440)
