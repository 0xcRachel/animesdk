...
#define RPG_GAMECORE_GRIDFIGHTPORTALBUFFCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19B82600)
#define RPG_GAMECORE_GRIDFIGHTPORTALBUFFCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19B82BA0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 ShowBonusID; // 0x64
