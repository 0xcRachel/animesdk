...
#define RPG_GAMECORE_TUTORIALRESROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1912F220)
#define RPG_GAMECORE_TUTORIALRESROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1912F8E0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* ContentPath; // 0x18
