...
#define RPG_GAMECORE_COMMONSKILLPOOL_METHOD_2_5D9693405A11C60C_OFFSET UNITYSDK_OFFSET(0x194EA560)
#define RPG_GAMECORE_COMMONSKILLPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x194EA6D0)
