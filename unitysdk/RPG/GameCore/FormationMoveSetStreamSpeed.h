...
#define RPG_GAMECORE_FORMATIONMOVESETSTREAMSPEED_METHOD_3_0D200E57B862FF28_OFFSET UNITYSDK_OFFSET(0x16AE1E30)
#define RPG_GAMECORE_FORMATIONMOVESETSTREAMSPEED_METHOD_3_8B3DE2235A6F5338_OFFSET UNITYSDK_OFFSET(0x16AE1DB0)
#define RPG_GAMECORE_FORMATIONMOVESETSTREAMSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x16AE1E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FormationMoveSetStreamSpeed_TypeDefinitionIndex = 19034;
