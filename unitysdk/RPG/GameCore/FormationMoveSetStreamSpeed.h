...
#define RPG_GAMECORE_FORMATIONMOVESETSTREAMSPEED_METHOD_3_0D200E57B862FF28_OFFSET UNITYSDK_OFFSET(0x1A3B3D30)
#define RPG_GAMECORE_FORMATIONMOVESETSTREAMSPEED_METHOD_3_8B3DE2235A6F5338_OFFSET UNITYSDK_OFFSET(0x1A3B3CB0)
#define RPG_GAMECORE_FORMATIONMOVESETSTREAMSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3B3D00)
