...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERCRAFTCONFIG_METHOD_3_0FBB572199EDA5E4_OFFSET UNITYSDK_OFFSET(0x1727EA70)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERCRAFTCONFIG_METHOD_3_29F0DFC6C71FD65D_OFFSET UNITYSDK_OFFSET(0x1727A9C0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERCRAFTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1727A970)
