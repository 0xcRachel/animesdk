...
#define RPG_GAMECORE_RADIALBLUREFFECT_METHOD_3_D01B3431BA9AC6C1_OFFSET UNITYSDK_OFFSET(0x19AA4680)
#define RPG_GAMECORE_RADIALBLUREFFECT_METHOD_3_E3C802F5AAEE10D2_OFFSET UNITYSDK_OFFSET(0x19AA47A0)
#define RPG_GAMECORE_RADIALBLUREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x19AA4720)
