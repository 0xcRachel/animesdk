...
#define RPG_GAMECORE_MINIGAMEFLAPPYBIRDWAVECONFIG_METHOD_3_09F6C938873109F9_OFFSET UNITYSDK_OFFSET(0x1906DEE0)
#define RPG_GAMECORE_MINIGAMEFLAPPYBIRDWAVECONFIG_METHOD_3_8A81B2542910F0A8_OFFSET UNITYSDK_OFFSET(0x1906DE90)
#define RPG_GAMECORE_MINIGAMEFLAPPYBIRDWAVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1906DED0)
