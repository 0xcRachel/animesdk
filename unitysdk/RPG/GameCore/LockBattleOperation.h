...
#define RPG_GAMECORE_LOCKBATTLEOPERATION_METHOD_3_38D11BDB07730332_OFFSET UNITYSDK_OFFSET(0x16BDA9B0)
#define RPG_GAMECORE_LOCKBATTLEOPERATION_METHOD_3_C3862A681EBD482D_OFFSET UNITYSDK_OFFSET(0x16BDA930)
#define RPG_GAMECORE_LOCKBATTLEOPERATION__CTOR_OFFSET UNITYSDK_OFFSET(0x16BDA980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockBattleOperation_TypeDefinitionIndex = 20959;
