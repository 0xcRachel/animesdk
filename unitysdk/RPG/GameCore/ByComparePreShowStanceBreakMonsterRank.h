...
#define RPG_GAMECORE_BYCOMPAREPRESHOWSTANCEBREAKMONSTERRANK_METHOD_4_34515B86DEB1E43D_OFFSET UNITYSDK_OFFSET(0x19ACCD40)
#define RPG_GAMECORE_BYCOMPAREPRESHOWSTANCEBREAKMONSTERRANK_METHOD_4_C2ECAAFB874668B3_OFFSET UNITYSDK_OFFSET(0x19ACCE10)
#define RPG_GAMECORE_BYCOMPAREPRESHOWSTANCEBREAKMONSTERRANK__CTOR_OFFSET UNITYSDK_OFFSET(0x19ACCDC0)
