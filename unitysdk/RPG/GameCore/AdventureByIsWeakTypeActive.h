...
#define RPG_GAMECORE_ADVENTUREBYISWEAKTYPEACTIVE_METHOD_4_5A315B53650D5BA3_OFFSET UNITYSDK_OFFSET(0x16854B70)
#define RPG_GAMECORE_ADVENTUREBYISWEAKTYPEACTIVE_METHOD_4_A2657AAD4BFA65A7_OFFSET UNITYSDK_OFFSET(0x16854C40)
#define RPG_GAMECORE_ADVENTUREBYISWEAKTYPEACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x16854BF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureByIsWeakTypeActive_TypeDefinitionIndex = 18590;
