...
#define RPG_GAMECORE_WAITFIVEDIMTELEPORTFINISH_METHOD_3_032FC6AF61BDC9FA_OFFSET UNITYSDK_OFFSET(0x171510E0)
#define RPG_GAMECORE_WAITFIVEDIMTELEPORTFINISH_METHOD_3_8744FEB7414033C6_OFFSET UNITYSDK_OFFSET(0x171511F0)
#define RPG_GAMECORE_WAITFIVEDIMTELEPORTFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x171511C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitFiveDimTeleportFinish_TypeDefinitionIndex = 19059;
