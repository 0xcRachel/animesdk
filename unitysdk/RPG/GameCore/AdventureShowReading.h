...
#define RPG_GAMECORE_ADVENTURESHOWREADING_METHOD_3_9DEEDA39FF9C3752_OFFSET UNITYSDK_OFFSET(0x18BB6070)
#define RPG_GAMECORE_ADVENTURESHOWREADING_METHOD_3_A12DB97ABDD7F003_OFFSET UNITYSDK_OFFSET(0x18BB5FF0)
#define RPG_GAMECORE_ADVENTURESHOWREADING__CTOR_OFFSET UNITYSDK_OFFSET(0x18BB6040)
