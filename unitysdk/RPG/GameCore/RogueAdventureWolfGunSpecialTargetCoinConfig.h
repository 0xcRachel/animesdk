...
#define RPG_GAMECORE_ROGUEADVENTUREWOLFGUNSPECIALTARGETCOINCONFIG_METHOD_3_4AB4EC07D3FB4ADE_OFFSET UNITYSDK_OFFSET(0x16E12CA0)
#define RPG_GAMECORE_ROGUEADVENTUREWOLFGUNSPECIALTARGETCOINCONFIG_METHOD_3_A55142F5490F381A_OFFSET UNITYSDK_OFFSET(0x16E12CF0)
#define RPG_GAMECORE_ROGUEADVENTUREWOLFGUNSPECIALTARGETCOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E12CE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAdventureWolfGunSpecialTargetCoinConfig_TypeDefinitionIndex = 16077;
