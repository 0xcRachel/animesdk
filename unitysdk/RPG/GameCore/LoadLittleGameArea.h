...
#define RPG_GAMECORE_LOADLITTLEGAMEAREA_METHOD_3_51A4604A229CD756_OFFSET UNITYSDK_OFFSET(0x16BD4AB0)
#define RPG_GAMECORE_LOADLITTLEGAMEAREA_METHOD_3_E219E7BDC1551695_OFFSET UNITYSDK_OFFSET(0x16BD4C00)
#define RPG_GAMECORE_LOADLITTLEGAMEAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x16BD4B70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoadLittleGameArea_TypeDefinitionIndex = 18799;
