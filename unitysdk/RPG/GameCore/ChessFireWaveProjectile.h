...
#define RPG_GAMECORE_CHESSFIREWAVEPROJECTILE_METHOD_3_185FDE17572F8F02_OFFSET UNITYSDK_OFFSET(0x1697E300)
#define RPG_GAMECORE_CHESSFIREWAVEPROJECTILE_METHOD_3_376983363DD54C7A_OFFSET UNITYSDK_OFFSET(0x1697E390)
#define RPG_GAMECORE_CHESSFIREWAVEPROJECTILE__CTOR_OFFSET UNITYSDK_OFFSET(0x1697E360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChessFireWaveProjectile_TypeDefinitionIndex = 21429;
