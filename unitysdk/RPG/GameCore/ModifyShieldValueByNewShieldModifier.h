...
#define RPG_GAMECORE_MODIFYSHIELDVALUEBYNEWSHIELDMODIFIER_METHOD_3_55423A6816910B82_OFFSET UNITYSDK_OFFSET(0x16CC14D0)
#define RPG_GAMECORE_MODIFYSHIELDVALUEBYNEWSHIELDMODIFIER_METHOD_3_C341C0B4861FF80E_OFFSET UNITYSDK_OFFSET(0x16CC15F0)
#define RPG_GAMECORE_MODIFYSHIELDVALUEBYNEWSHIELDMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x16CC1570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyShieldValueByNewShieldModifier_TypeDefinitionIndex = 21284;
