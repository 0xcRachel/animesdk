...
#define RPG_GAMECORE_PLAYRANDOMMISSIONTALK_METHOD_4_3D02EFB04E5B9DCF_OFFSET UNITYSDK_OFFSET(0x16D51FE0)
#define RPG_GAMECORE_PLAYRANDOMMISSIONTALK_METHOD_4_4930DF5DEBFA4891_OFFSET UNITYSDK_OFFSET(0x16D51F60)
#define RPG_GAMECORE_PLAYRANDOMMISSIONTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x16D51FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayRandomMissionTalk_TypeDefinitionIndex = 21115;
