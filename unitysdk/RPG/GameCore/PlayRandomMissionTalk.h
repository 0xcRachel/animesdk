...
#define RPG_GAMECORE_PLAYRANDOMMISSIONTALK_METHOD_4_3D02EFB04E5B9DCF_OFFSET UNITYSDK_OFFSET(0x18B3A960)
#define RPG_GAMECORE_PLAYRANDOMMISSIONTALK_METHOD_4_4930DF5DEBFA4891_OFFSET UNITYSDK_OFFSET(0x18B3A8E0)
#define RPG_GAMECORE_PLAYRANDOMMISSIONTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x18B3A930)
