...
#define RPG_GAMECORE_TRIGGERMAZEMAPUI_METHOD_3_8AD7E358FC0F78AE_OFFSET UNITYSDK_OFFSET(0x17122110)
#define RPG_GAMECORE_TRIGGERMAZEMAPUI_METHOD_3_D2A2CC83D6985EE2_OFFSET UNITYSDK_OFFSET(0x17122000)
#define RPG_GAMECORE_TRIGGERMAZEMAPUI__CTOR_OFFSET UNITYSDK_OFFSET(0x171220E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerMazeMapUI_TypeDefinitionIndex = 19731;
