...
#define RPG_GAMECORE_RESTAURANTEVENTREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x175B9040)
#define RPG_GAMECORE_RESTAURANTEVENTREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x175B9330)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::RestaurantSuperEventType SuperEventType; // 0x28
