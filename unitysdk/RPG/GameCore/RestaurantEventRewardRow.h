...
#define RPG_GAMECORE_RESTAURANTEVENTREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16DEBEB0)
#define RPG_GAMECORE_RESTAURANTEVENTREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16DEC1A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RestaurantEventRewardRow_TypeDefinitionIndex = 10514;
	...
	public:
		...
		::RPG::GameCore::RestaurantSuperEventType SuperEventType; // 0x20
		::System::UInt32 ID; // 0x24
		::RPG::GameCore::RestaurantNormalEventType EventType; // 0x28
