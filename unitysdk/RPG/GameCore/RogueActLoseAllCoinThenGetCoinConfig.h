...
#define RPG_GAMECORE_ROGUEACTLOSEALLCOINTHENGETCOINCONFIG_METHOD_6_45140A48DCB4D082_OFFSET UNITYSDK_OFFSET(0x1A9A6540)
#define RPG_GAMECORE_ROGUEACTLOSEALLCOINTHENGETCOINCONFIG_METHOD_6_F5B11E79DF5C9DA7_OFFSET UNITYSDK_OFFSET(0x1A9A6760)
#define RPG_GAMECORE_ROGUEACTLOSEALLCOINTHENGETCOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9A6680)
