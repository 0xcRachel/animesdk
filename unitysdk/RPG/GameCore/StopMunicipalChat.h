...
#define RPG_GAMECORE_STOPMUNICIPALCHAT_METHOD_3_207546AA1F5A5E8A_OFFSET UNITYSDK_OFFSET(0x18D72BE0)
#define RPG_GAMECORE_STOPMUNICIPALCHAT_METHOD_3_C62659B0FE9E0A7C_OFFSET UNITYSDK_OFFSET(0x18D72C60)
#define RPG_GAMECORE_STOPMUNICIPALCHAT__CTOR_OFFSET UNITYSDK_OFFSET(0x18D72C30)
