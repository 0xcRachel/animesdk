...
#define RPG_GAMECORE_PROPTAGCOMPONENT_METHOD_2_6ACAACDD796C2F5E_OFFSET UNITYSDK_OFFSET(0x16DB8E60)
#define RPG_GAMECORE_PROPTAGCOMPONENT_METHOD_2_C6CC1D298EF0A2CA_OFFSET UNITYSDK_OFFSET(0x16DB9120)
#define RPG_GAMECORE_PROPTAGCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x16DB65E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropTagComponent_TypeDefinitionIndex = 15852;
