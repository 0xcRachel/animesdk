...
#define RPG_GAMECORE_PROPTAGCOMPONENT_METHOD_2_40545298EF9C5F67_OFFSET UNITYSDK_OFFSET(0x17584E30)
#define RPG_GAMECORE_PROPTAGCOMPONENT_METHOD_2_C6CC1D298EF0A2CA_OFFSET UNITYSDK_OFFSET(0x175850C0)
#define RPG_GAMECORE_PROPTAGCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x17582240)
