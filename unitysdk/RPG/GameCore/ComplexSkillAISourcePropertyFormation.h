...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEPROPERTYFORMATION_METHOD_3_351D982853C77160_OFFSET UNITYSDK_OFFSET(0x169C1E00)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEPROPERTYFORMATION_METHOD_3_9B2DCED85BA79087_OFFSET UNITYSDK_OFFSET(0x169C06C0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEPROPERTYFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x169C06A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourcePropertyFormation_TypeDefinitionIndex = 14108;
