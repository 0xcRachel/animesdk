...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::MazeBuffInBattleBindingType>**)Il2CppClass::FromTypeDefinitionIndex(AddMazeBuffBinding___O_TypeDefinitionIndex)->GetStaticField(0x7900);
		}
	};
}
