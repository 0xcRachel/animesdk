...
#define RPG_GAMECORE_ROGUEACTREPLACEROGUEBUFFCONFIG_METHOD_6_778C6EA9A7149246_OFFSET UNITYSDK_OFFSET(0x1A9B4BA0)
#define RPG_GAMECORE_ROGUEACTREPLACEROGUEBUFFCONFIG_METHOD_6_9D6A52ADA6B4CAD3_OFFSET UNITYSDK_OFFSET(0x1A9B4DC0)
#define RPG_GAMECORE_ROGUEACTREPLACEROGUEBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9B4CE0)
