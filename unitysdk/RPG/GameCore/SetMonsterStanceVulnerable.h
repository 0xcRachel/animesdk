...
#define RPG_GAMECORE_SETMONSTERSTANCEVULNERABLE_METHOD_3_713878F949729CC6_OFFSET UNITYSDK_OFFSET(0x176ECCE0)
#define RPG_GAMECORE_SETMONSTERSTANCEVULNERABLE_METHOD_3_AD4F4DF77D354890_OFFSET UNITYSDK_OFFSET(0x176ECD60)
#define RPG_GAMECORE_SETMONSTERSTANCEVULNERABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x176ECD30)
