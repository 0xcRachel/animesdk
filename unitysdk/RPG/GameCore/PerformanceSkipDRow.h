...
#define RPG_GAMECORE_PERFORMANCESKIPDROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x16D2B310)
#define RPG_GAMECORE_PERFORMANCESKIPDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16D2B4E0)
#define RPG_GAMECORE_PERFORMANCESKIPDROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x16D2B290)
#define RPG_GAMECORE_PERFORMANCESKIPDROW_RESET_OFFSET UNITYSDK_OFFSET(0x16D2B2F0)
#define RPG_GAMECORE_PERFORMANCESKIPDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16D2B6D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceSkipDRow_TypeDefinitionIndex = 13096;
