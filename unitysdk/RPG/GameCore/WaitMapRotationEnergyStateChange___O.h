...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::MapRotationEnergyState>**)Il2CppClass::FromTypeDefinitionIndex(WaitMapRotationEnergyStateChange___O_TypeDefinitionIndex)->GetStaticField(0x25710);
		}
	};
}
