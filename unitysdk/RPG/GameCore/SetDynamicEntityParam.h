...
#define RPG_GAMECORE_SETDYNAMICENTITYPARAM_METHOD_3_011D1A4769FE1F22_OFFSET UNITYSDK_OFFSET(0x16F11AB0)
#define RPG_GAMECORE_SETDYNAMICENTITYPARAM_METHOD_3_E473DA5A0230B331_OFFSET UNITYSDK_OFFSET(0x16F11B30)
#define RPG_GAMECORE_SETDYNAMICENTITYPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x16F11B00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicEntityParam_TypeDefinitionIndex = 20305;
