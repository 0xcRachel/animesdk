...
#define RPG_GAMECORE_SETDYNAMICENTITYPARAM_METHOD_3_011D1A4769FE1F22_OFFSET UNITYSDK_OFFSET(0x176C6F70)
#define RPG_GAMECORE_SETDYNAMICENTITYPARAM_METHOD_3_E473DA5A0230B331_OFFSET UNITYSDK_OFFSET(0x176C6FF0)
#define RPG_GAMECORE_SETDYNAMICENTITYPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x176C6FC0)
