...
#define RPG_GAMECORE_LEVELSETACTIVESKILL_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA4AC1C0)
#define RPG_GAMECORE_LEVELSETACTIVESKILL_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA4AC170)
#define RPG_GAMECORE_LEVELSETACTIVESKILL__CTOR_OFFSET UNITYSDK_OFFSET(0xA4AC210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelSetActiveSkill_TypeDefinitionIndex = 44675;
