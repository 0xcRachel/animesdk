...
#define RPG_GAMECORE_AIDECISIONBASECONFIG_METHOD_3_317B8487F57CE9A8_OFFSET UNITYSDK_OFFSET(0x1676FD50)
#define RPG_GAMECORE_AIDECISIONBASECONFIG_METHOD_3_C4B40B44F680F4D7_OFFSET UNITYSDK_OFFSET(0x1676F3E0)
#define RPG_GAMECORE_AIDECISIONBASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1676FEE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIDecisionBaseConfig_TypeDefinitionIndex = 14063;
