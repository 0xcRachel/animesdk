...
#define RPG_GAMECORE_FUNCENTRANCELISTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16AEB330)
#define RPG_GAMECORE_FUNCENTRANCELISTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16AEBA70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FuncEntranceListConfigRow_TypeDefinitionIndex = 12082;
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* FuncEntranceIDList; // 0x30
