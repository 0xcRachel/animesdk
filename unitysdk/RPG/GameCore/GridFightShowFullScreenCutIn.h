...
#define RPG_GAMECORE_GRIDFIGHTSHOWFULLSCREENCUTIN_METHOD_3_E83EB3C3E5EB4AD7_OFFSET UNITYSDK_OFFSET(0x1A1BDC10)
#define RPG_GAMECORE_GRIDFIGHTSHOWFULLSCREENCUTIN_METHOD_3_EA0EC48B19180F5E_OFFSET UNITYSDK_OFFSET(0x1A1BDC90)
#define RPG_GAMECORE_GRIDFIGHTSHOWFULLSCREENCUTIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1BDC60)
