...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_ISDEFENDER_METHOD_4_216922426D199FF4_OFFSET UNITYSDK_OFFSET(0x195983B0)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_ISDEFENDER_METHOD_4_9D139EC5C98FBDD2_OFFSET UNITYSDK_OFFSET(0x19599E00)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_ISDEFENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x19598360)
