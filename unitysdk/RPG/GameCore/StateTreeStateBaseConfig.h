...
#define RPG_GAMECORE_STATETREESTATEBASECONFIG_METHOD_2_303214653F6D0731_OFFSET UNITYSDK_OFFSET(0x16F98020)
#define RPG_GAMECORE_STATETREESTATEBASECONFIG_METHOD_2_B802D3F6E31D64C9_OFFSET UNITYSDK_OFFSET(0x16F986A0)
#define RPG_GAMECORE_STATETREESTATEBASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F97CD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StateTreeStateBaseConfig_TypeDefinitionIndex = 14075;
