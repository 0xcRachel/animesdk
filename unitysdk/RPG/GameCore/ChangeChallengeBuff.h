...
#define RPG_GAMECORE_CHANGECHALLENGEBUFF_METHOD_3_97473529E64CAAAB_OFFSET UNITYSDK_OFFSET(0x16963300)
#define RPG_GAMECORE_CHANGECHALLENGEBUFF_METHOD_3_FB3D1D35FF43B982_OFFSET UNITYSDK_OFFSET(0x16963380)
#define RPG_GAMECORE_CHANGECHALLENGEBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x16963350)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeChallengeBuff_TypeDefinitionIndex = 18255;
