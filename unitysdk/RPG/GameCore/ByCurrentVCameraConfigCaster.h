...
#define RPG_GAMECORE_BYCURRENTVCAMERACONFIGCASTER_METHOD_4_4CBA0C5C17D1D227_OFFSET UNITYSDK_OFFSET(0x19ADACA0)
#define RPG_GAMECORE_BYCURRENTVCAMERACONFIGCASTER_METHOD_4_A94DFA45E1886EE9_OFFSET UNITYSDK_OFFSET(0x19ADABD0)
#define RPG_GAMECORE_BYCURRENTVCAMERACONFIGCASTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19ADAC50)
