...
#define RPG_GAMECORE_ATTACHPRESHOWDAMAGETYPEFORSKILL_METHOD_3_3210CDD26D2E0B8D_OFFSET UNITYSDK_OFFSET(0x18BE8330)
#define RPG_GAMECORE_ATTACHPRESHOWDAMAGETYPEFORSKILL_METHOD_3_4F5310C7D85C8F6C_OFFSET UNITYSDK_OFFSET(0x18BE82B0)
#define RPG_GAMECORE_ATTACHPRESHOWDAMAGETYPEFORSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x18BE8300)
