...
#define RPG_GAMECORE_BATTLEROGUEMAGICDATA_MAGICUNIT_DEEPCLONE_OFFSET UNITYSDK_OFFSET(0xA35E410)
#define RPG_GAMECORE_BATTLEROGUEMAGICDATA_MAGICUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0xA35E4F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleRogueMagicData_MagicUnit_TypeDefinitionIndex = 44089;
