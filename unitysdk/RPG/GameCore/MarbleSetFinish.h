...
#define RPG_GAMECORE_MARBLESETFINISH_METHOD_3_6771130C752EB8FA_OFFSET UNITYSDK_OFFSET(0x16C491A0)
#define RPG_GAMECORE_MARBLESETFINISH_METHOD_3_E51B65F6FDEE6E91_OFFSET UNITYSDK_OFFSET(0x16C49060)
#define RPG_GAMECORE_MARBLESETFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x16C49150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleSetFinish_TypeDefinitionIndex = 15166;
