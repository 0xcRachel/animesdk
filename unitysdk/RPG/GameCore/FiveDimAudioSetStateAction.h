...
#define RPG_GAMECORE_FIVEDIMAUDIOSETSTATEACTION_METHOD_3_0949D313F9E5217D_OFFSET UNITYSDK_OFFSET(0x16AAC4D0)
#define RPG_GAMECORE_FIVEDIMAUDIOSETSTATEACTION_METHOD_3_969ECF64DF48BD08_OFFSET UNITYSDK_OFFSET(0x16AAC460)
#define RPG_GAMECORE_FIVEDIMAUDIOSETSTATEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16AAC4B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimAudioSetStateAction_TypeDefinitionIndex = 16791;
