...
#define RPG_GAMECORE_ROGUEDLCBLOCKINTROROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19256B60)
#define RPG_GAMECORE_ROGUEDLCBLOCKINTROROW__CTOR_OFFSET UNITYSDK_OFFSET(0x192573B0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 BlockIntroID; // 0x54
