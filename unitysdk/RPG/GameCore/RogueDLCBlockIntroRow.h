...
#define RPG_GAMECORE_ROGUEDLCBLOCKINTROROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16E6D0D0)
#define RPG_GAMECORE_ROGUEDLCBLOCKINTROROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16E6D920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDLCBlockIntroRow_TypeDefinitionIndex = 13436;
	...
	public:
		...
		::RPG::Client::TextID BlockIntroDesc; // 0x28
		::System::UInt32 Sort; // 0x38
		::System::UInt32 BlockIntroID; // 0x3C
		::System::UInt32 IntroGroup; // 0x40
		::RPG::Client::TextID BlockIntroName; // 0x48
