...
#define RPG_GAMECORE_LIMITTYPECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17363CD0)
#define RPG_GAMECORE_LIMITTYPECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17364320)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID LimitTypeDesc; // 0x18
