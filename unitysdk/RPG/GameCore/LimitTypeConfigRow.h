...
#define RPG_GAMECORE_LIMITTYPECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16BC0750)
#define RPG_GAMECORE_LIMITTYPECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16BC0DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LimitTypeConfigRow_TypeDefinitionIndex = 13727;
