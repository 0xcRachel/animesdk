...
#define RPG_GAMECORE_ST_MAIN_MOVETOTARGET_METHOD_4_5CAE1946446EE189_OFFSET UNITYSDK_OFFSET(0x16EE4110)
#define RPG_GAMECORE_ST_MAIN_MOVETOTARGET_METHOD_4_9036D5B4F45CEBF3_OFFSET UNITYSDK_OFFSET(0x16EF7080)
#define RPG_GAMECORE_ST_MAIN_MOVETOTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x16EE40B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_MoveToTarget_TypeDefinitionIndex = 17868;
