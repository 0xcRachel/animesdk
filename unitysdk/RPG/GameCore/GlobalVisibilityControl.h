...
#define RPG_GAMECORE_GLOBALVISIBILITYCONTROL_METHOD_3_8F919A33E7132401_OFFSET UNITYSDK_OFFSET(0x16B12200)
#define RPG_GAMECORE_GLOBALVISIBILITYCONTROL_METHOD_3_F082D0C12E25B64F_OFFSET UNITYSDK_OFFSET(0x16B122A0)
#define RPG_GAMECORE_GLOBALVISIBILITYCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x16B12260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GlobalVisibilityControl_TypeDefinitionIndex = 18041;
