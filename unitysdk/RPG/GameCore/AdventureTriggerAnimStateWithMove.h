...
#define RPG_GAMECORE_ADVENTURETRIGGERANIMSTATEWITHMOVE_METHOD_3_24ECD6458702E29A_OFFSET UNITYSDK_OFFSET(0x16861F60)
#define RPG_GAMECORE_ADVENTURETRIGGERANIMSTATEWITHMOVE_METHOD_3_3CE3E19114B0AAF0_OFFSET UNITYSDK_OFFSET(0x16861EC0)
#define RPG_GAMECORE_ADVENTURETRIGGERANIMSTATEWITHMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x16861F20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureTriggerAnimStateWithMove_TypeDefinitionIndex = 17948;
