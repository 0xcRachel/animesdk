...
#define RPG_GAMECORE_SETSPECIALVISIONON_METHOD_3_02EB6BBE542C65F8_OFFSET UNITYSDK_OFFSET(0x1938BD30)
#define RPG_GAMECORE_SETSPECIALVISIONON_METHOD_3_054D3AA93B8D654E_OFFSET UNITYSDK_OFFSET(0x1938BC70)
#define RPG_GAMECORE_SETSPECIALVISIONON__CTOR_OFFSET UNITYSDK_OFFSET(0x1938BCE0)
