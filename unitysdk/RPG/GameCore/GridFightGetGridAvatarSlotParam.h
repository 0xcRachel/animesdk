...
#define RPG_GAMECORE_GRIDFIGHTGETGRIDAVATARSLOTPARAM_METHOD_3_A2359270CFBAE2E4_OFFSET UNITYSDK_OFFSET(0x17272E00)
#define RPG_GAMECORE_GRIDFIGHTGETGRIDAVATARSLOTPARAM_METHOD_3_F78B4F0BCEB047C3_OFFSET UNITYSDK_OFFSET(0x17272E60)
#define RPG_GAMECORE_GRIDFIGHTGETGRIDAVATARSLOTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x17272E50)
