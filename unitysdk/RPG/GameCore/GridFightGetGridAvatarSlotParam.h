...
#define RPG_GAMECORE_GRIDFIGHTGETGRIDAVATARSLOTPARAM_METHOD_3_A2359270CFBAE2E4_OFFSET UNITYSDK_OFFSET(0x16B262E0)
#define RPG_GAMECORE_GRIDFIGHTGETGRIDAVATARSLOTPARAM_METHOD_3_F78B4F0BCEB047C3_OFFSET UNITYSDK_OFFSET(0x16B26340)
#define RPG_GAMECORE_GRIDFIGHTGETGRIDAVATARSLOTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x16B26330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightGetGridAvatarSlotParam_TypeDefinitionIndex = 17704;
