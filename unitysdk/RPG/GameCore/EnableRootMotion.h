...
#define RPG_GAMECORE_ENABLEROOTMOTION_METHOD_3_929B8A2514A8BD9B_OFFSET UNITYSDK_OFFSET(0x1915A9D0)
#define RPG_GAMECORE_ENABLEROOTMOTION_METHOD_3_EF5D74E097616932_OFFSET UNITYSDK_OFFSET(0x1915A950)
#define RPG_GAMECORE_ENABLEROOTMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1915A9A0)
