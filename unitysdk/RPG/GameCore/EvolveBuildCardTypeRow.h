...
#define RPG_GAMECORE_EVOLVEBUILDCARDTYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16A7DF20)
#define RPG_GAMECORE_EVOLVEBUILDCARDTYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16A7E130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EvolveBuildCardTypeRow_TypeDefinitionIndex = 10623;
