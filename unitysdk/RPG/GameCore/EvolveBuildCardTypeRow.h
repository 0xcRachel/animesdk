...
#define RPG_GAMECORE_EVOLVEBUILDCARDTYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x171C0CB0)
#define RPG_GAMECORE_EVOLVEBUILDCARDTYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x171C0EC0)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::String* CardBuffItemBgMid; // 0x10
