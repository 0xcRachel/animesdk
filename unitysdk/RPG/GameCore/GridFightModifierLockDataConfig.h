...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLOCKDATACONFIG_METHOD_3_3CDB8D34B48EA7D8_OFFSET UNITYSDK_OFFSET(0x1727F9C0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLOCKDATACONFIG_METHOD_3_42F76368C5F4E8F1_OFFSET UNITYSDK_OFFSET(0x1727C400)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLOCKDATACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1727C3B0)
