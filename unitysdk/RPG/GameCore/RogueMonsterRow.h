...
#define RPG_GAMECORE_ROGUEMONSTERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AE3CC80)
#define RPG_GAMECORE_ROGUEMONSTERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE3E0A0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 RogueMonsterID; // 0x1C
