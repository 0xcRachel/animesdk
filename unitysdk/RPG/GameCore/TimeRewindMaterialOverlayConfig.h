...
#define RPG_GAMECORE_TIMEREWINDMATERIALOVERLAYCONFIG_METHOD_2_DD76E8150A509C85_OFFSET UNITYSDK_OFFSET(0x170F5E90)
#define RPG_GAMECORE_TIMEREWINDMATERIALOVERLAYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x170F6040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRewindMaterialOverlayConfig_TypeDefinitionIndex = 15856;
