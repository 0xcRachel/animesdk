...
#define RPG_GAMECORE_ASSISTWAYPOINTDISTANCECONDITION_METHOD_3_64D8111335B81113_OFFSET UNITYSDK_OFFSET(0x1688E6D0)
#define RPG_GAMECORE_ASSISTWAYPOINTDISTANCECONDITION_METHOD_3_8B282298D437722E_OFFSET UNITYSDK_OFFSET(0x1688E0F0)
#define RPG_GAMECORE_ASSISTWAYPOINTDISTANCECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1688E6C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AssistWayPointDistanceCondition_TypeDefinitionIndex = 17004;
