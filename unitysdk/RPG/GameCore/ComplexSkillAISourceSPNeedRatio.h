...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCESPNEEDRATIO_METHOD_3_033ABB0B4FB581DE_OFFSET UNITYSDK_OFFSET(0x1713C610)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCESPNEEDRATIO_METHOD_3_0DFB6BCD9A96B967_OFFSET UNITYSDK_OFFSET(0x1713D900)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCESPNEEDRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x1713C5F0)
