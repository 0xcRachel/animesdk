...
#define RPG_GAMECORE_ACTIONBARSTYLESIZESETTING_METHOD_2_0864A1CB29B85CAD_OFFSET UNITYSDK_OFFSET(0x167781E0)
#define RPG_GAMECORE_ACTIONBARSTYLESIZESETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x16778C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActionBarStyleSizeSetting_TypeDefinitionIndex = 15444;
