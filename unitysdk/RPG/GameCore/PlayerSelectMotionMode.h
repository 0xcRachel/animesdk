...
#define RPG_GAMECORE_PLAYERSELECTMOTIONMODE_METHOD_3_A64066BC766EB8D7_OFFSET UNITYSDK_OFFSET(0x16D77120)
#define RPG_GAMECORE_PLAYERSELECTMOTIONMODE_METHOD_3_DE108FF4F4745684_OFFSET UNITYSDK_OFFSET(0x16D770A0)
#define RPG_GAMECORE_PLAYERSELECTMOTIONMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x16D770F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayerSelectMotionMode_TypeDefinitionIndex = 18946;
