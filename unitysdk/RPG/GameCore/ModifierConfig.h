...
#define RPG_GAMECORE_MODIFIERCONFIG_METHOD_2_BD843F105950457D_OFFSET UNITYSDK_OFFSET(0x16CB4D60)
#define RPG_GAMECORE_MODIFIERCONFIG_METHOD_2_E8D2312C4DC70C83_OFFSET UNITYSDK_OFFSET(0x16CB4A20)
#define RPG_GAMECORE_MODIFIERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16CB4D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifierConfig_TypeDefinitionIndex = 14226;
