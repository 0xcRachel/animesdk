...
#define RPG_GAMECORE_AETHERDIVIDECHALLENGELISTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18C799C0)
#define RPG_GAMECORE_AETHERDIVIDECHALLENGELISTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18C79F10)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID OpponentName; // 0x30
		...
		::RPG::GameCore::AetherDivideChallengeType ChallengeType; // 0x68
		::System::UInt32 ID; // 0x6C
		::System::UInt32 BattleAreaID; // 0x70
		::System::UInt32 MissionID; // 0x74
