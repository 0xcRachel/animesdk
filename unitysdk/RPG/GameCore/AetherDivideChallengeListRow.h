...
#define RPG_GAMECORE_AETHERDIVIDECHALLENGELISTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18BBB200)
#define RPG_GAMECORE_AETHERDIVIDECHALLENGELISTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18BBB750)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* OpponentImagePath; // 0x28
		...
		::RPG::Client::TextID Signature; // 0x40
		::System::UInt32 BattleAreaID; // 0x50
		::System::UInt32 RewardID; // 0x54
		::System::UInt32 OpponentStrength; // 0x58
