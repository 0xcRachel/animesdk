...
#define RPG_GAMECORE_AVATARENERGYBARSTATE_COPYDATAFROM_OFFSET UNITYSDK_OFFSET(0x16896CE0)
#define RPG_GAMECORE_AVATARENERGYBARSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16890820)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::EnergyBarState CurrentStatus; // 0x40
		::System::Int32 CounterType; // 0x44
