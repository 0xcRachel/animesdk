...
#define RPG_GAMECORE_GRIDFIGHTBACKENDROLEEQUIPMENTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B1B360)
#define RPG_GAMECORE_GRIDFIGHTBACKENDROLEEQUIPMENTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B1B6C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightBackendRoleEquipmentConfigRow_TypeDefinitionIndex = 12291;
