...
#define RPG_GAMECORE_LITTLEGAMENAVMAPICONCONFIG_METHOD_3_17F21F518C653705_OFFSET UNITYSDK_OFFSET(0x16BD0800)
#define RPG_GAMECORE_LITTLEGAMENAVMAPICONCONFIG_METHOD_3_85D7530ADC4F48D2_OFFSET UNITYSDK_OFFSET(0x16BCB730)
#define RPG_GAMECORE_LITTLEGAMENAVMAPICONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16BCB710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameNavMapIconConfig_TypeDefinitionIndex = 16876;
