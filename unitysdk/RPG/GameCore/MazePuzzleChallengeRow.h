...
#define RPG_GAMECORE_MAZEPUZZLECHALLENGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18C4B240)
#define RPG_GAMECORE_MAZEPUZZLECHALLENGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18C4BB20)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 MazePuzzleID; // 0x20
		::System::UInt32 IsBeginPrepare; // 0x24
		::System::UInt32 TutorialID; // 0x28
		::System::UInt32 SpecialModeID; // 0x2C
		::System::UInt32 LimitTime; // 0x30
		::System::Boolean IsTopPriority; // 0x34
		::System::Boolean IsShowToast; // 0x35
