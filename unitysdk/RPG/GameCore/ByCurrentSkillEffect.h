...
#define RPG_GAMECORE_BYCURRENTSKILLEFFECT_METHOD_4_30752953E6A2CF45_OFFSET UNITYSDK_OFFSET(0x19AD9D70)
#define RPG_GAMECORE_BYCURRENTSKILLEFFECT_METHOD_4_DBCFCA0ED9894A9E_OFFSET UNITYSDK_OFFSET(0x19AD9C90)
#define RPG_GAMECORE_BYCURRENTSKILLEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD9D10)
