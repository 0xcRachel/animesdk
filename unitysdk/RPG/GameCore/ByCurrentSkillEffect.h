...
#define RPG_GAMECORE_BYCURRENTSKILLEFFECT_METHOD_4_30752953E6A2CF45_OFFSET UNITYSDK_OFFSET(0x169221E0)
#define RPG_GAMECORE_BYCURRENTSKILLEFFECT_METHOD_4_DBCFCA0ED9894A9E_OFFSET UNITYSDK_OFFSET(0x16922100)
#define RPG_GAMECORE_BYCURRENTSKILLEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x16922180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCurrentSkillEffect_TypeDefinitionIndex = 20675;
