...
#define RPG_GAMECORE_BYCURRENTSKILLEFFECT_METHOD_4_30752953E6A2CF45_OFFSET UNITYSDK_OFFSET(0x17033580)
#define RPG_GAMECORE_BYCURRENTSKILLEFFECT_METHOD_4_DBCFCA0ED9894A9E_OFFSET UNITYSDK_OFFSET(0x170334A0)
#define RPG_GAMECORE_BYCURRENTSKILLEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x17033520)
