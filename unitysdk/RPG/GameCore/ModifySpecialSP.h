...
#define RPG_GAMECORE_MODIFYSPECIALSP_METHOD_3_247ED945856FBCCA_OFFSET UNITYSDK_OFFSET(0x196B0B40)
#define RPG_GAMECORE_MODIFYSPECIALSP_METHOD_3_B51F7BEF128B2BCA_OFFSET UNITYSDK_OFFSET(0x196B0AC0)
#define RPG_GAMECORE_MODIFYSPECIALSP__CTOR_OFFSET UNITYSDK_OFFSET(0x196B0B10)
