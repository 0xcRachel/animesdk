...
#define RPG_GAMECORE_TUTORIALGUIDEGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17132670)
#define RPG_GAMECORE_TUTORIALGUIDEGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17132EA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialGuideGroupRow_TypeDefinitionIndex = 14007;
	...
	public:
		...
		::RPG::GameCore::TutorialGuideShowType TutorialShowType; // 0x28
		::System::UInt32 GroupID; // 0x2C
		::System::UInt32 Order; // 0x30
		::System::Boolean CanReview; // 0x34
