...
#define RPG_GAMECORE_TUTORIALGUIDEGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1912A8F0)
#define RPG_GAMECORE_TUTORIALGUIDEGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1912B160)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID MessageText; // 0x30
		::System::UInt32 Order; // 0x40
		::System::UInt32 RewardID; // 0x44
		::RPG::GameCore::TutorialGuideShowType TutorialShowType; // 0x48
