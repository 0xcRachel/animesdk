...
#define RPG_GAMECORE_SETDYNAMICVALUEBYMODIFIERVALUE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x176D6D30)
#define RPG_GAMECORE_SETDYNAMICVALUEBYMODIFIERVALUE_METHOD_4_7160C3A4C31F3BE1_OFFSET UNITYSDK_OFFSET(0x176D1B40)
#define RPG_GAMECORE_SETDYNAMICVALUEBYMODIFIERVALUE_METHOD_4_76FF9BB2F2A6241B_OFFSET UNITYSDK_OFFSET(0x176D6C90)
#define RPG_GAMECORE_SETDYNAMICVALUEBYMODIFIERVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x176D1AC0)
