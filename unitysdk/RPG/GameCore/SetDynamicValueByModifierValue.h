...
#define RPG_GAMECORE_SETDYNAMICVALUEBYMODIFIERVALUE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1A1FCEC0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYMODIFIERVALUE_METHOD_4_0EA53782C015F58E_OFFSET UNITYSDK_OFFSET(0x1A1F6E80)
#define RPG_GAMECORE_SETDYNAMICVALUEBYMODIFIERVALUE_METHOD_4_F6883C17798C3D46_OFFSET UNITYSDK_OFFSET(0x1A1FCE20)
#define RPG_GAMECORE_SETDYNAMICVALUEBYMODIFIERVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1F6E00)
