...
#define RPG_GAMECORE_MAZEFLOORCONNECTIVITYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18C47A30)
#define RPG_GAMECORE_MAZEFLOORCONNECTIVITYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18C48090)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 WayPointEntityID; // 0x1C
