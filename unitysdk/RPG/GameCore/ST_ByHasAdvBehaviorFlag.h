...
#define RPG_GAMECORE_ST_BYHASADVBEHAVIORFLAG_METHOD_4_405D78EB2B57D289_OFFSET UNITYSDK_OFFSET(0x16EF0230)
#define RPG_GAMECORE_ST_BYHASADVBEHAVIORFLAG_METHOD_4_9BD1A7406A538847_OFFSET UNITYSDK_OFFSET(0x16EF0160)
#define RPG_GAMECORE_ST_BYHASADVBEHAVIORFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x16EF01E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByHasAdvBehaviorFlag_TypeDefinitionIndex = 17844;
