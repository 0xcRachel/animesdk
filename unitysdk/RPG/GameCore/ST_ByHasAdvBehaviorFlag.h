...
#define RPG_GAMECORE_ST_BYHASADVBEHAVIORFLAG_METHOD_4_04B1B832A07DF5B9_OFFSET UNITYSDK_OFFSET(0x1A17CBD0)
#define RPG_GAMECORE_ST_BYHASADVBEHAVIORFLAG_METHOD_4_1832BEB7CA9060C0_OFFSET UNITYSDK_OFFSET(0x1A17C9C0)
#define RPG_GAMECORE_ST_BYHASADVBEHAVIORFLAG_METHOD_4_71801AF12C27BCBE_OFFSET UNITYSDK_OFFSET(0x1A17C8F0)
#define RPG_GAMECORE_ST_BYHASADVBEHAVIORFLAG_METHOD_4_E50808850A26DBBD_OFFSET UNITYSDK_OFFSET(0x1A17CB50)
#define RPG_GAMECORE_ST_BYHASADVBEHAVIORFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A17C970)
