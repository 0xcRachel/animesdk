...
#define RPG_GAMECORE_CHENLINGGAMEBOYCHALLENGEPACKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1697A840)
#define RPG_GAMECORE_CHENLINGGAMEBOYCHALLENGEPACKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1697A9F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingGameBoyChallengePackRow_TypeDefinitionIndex = 12825;
	...
	public:
		...
		::System::UInt32 HardChallengeID; // 0x1C
