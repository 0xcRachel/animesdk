...
#define RPG_GAMECORE_SETBATTLEBGMSTATE_METHOD_3_0AEDD7381191F0A9_OFFSET UNITYSDK_OFFSET(0x16F08090)
#define RPG_GAMECORE_SETBATTLEBGMSTATE_METHOD_3_F319618B76782726_OFFSET UNITYSDK_OFFSET(0x16F08010)
#define RPG_GAMECORE_SETBATTLEBGMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F08060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBattleBGMState_TypeDefinitionIndex = 20621;
