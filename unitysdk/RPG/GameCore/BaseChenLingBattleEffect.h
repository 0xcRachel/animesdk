...
#define RPG_GAMECORE_BASECHENLINGBATTLEEFFECT_METHOD_2_8D586FD7A609A263_OFFSET UNITYSDK_OFFSET(0x17652670)
#define RPG_GAMECORE_BASECHENLINGBATTLEEFFECT_METHOD_2_D87231D0840AD185_OFFSET UNITYSDK_OFFSET(0x17652C20)
#define RPG_GAMECORE_BASECHENLINGBATTLEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x17652C80)
