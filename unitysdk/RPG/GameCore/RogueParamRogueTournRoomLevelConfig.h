...
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNROOMLEVELCONFIG_METHOD_6_B6CEE32F2379DC5A_OFFSET UNITYSDK_OFFSET(0x1981C880)
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNROOMLEVELCONFIG_METHOD_6_F47BCC61B0270894_OFFSET UNITYSDK_OFFSET(0x1981C5D0)
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNROOMLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1981C750)
