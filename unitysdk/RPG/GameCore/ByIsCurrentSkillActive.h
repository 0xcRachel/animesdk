...
#define RPG_GAMECORE_BYISCURRENTSKILLACTIVE_METHOD_4_27639A1F8E3F9D3F_OFFSET UNITYSDK_OFFSET(0x1692ED40)
#define RPG_GAMECORE_BYISCURRENTSKILLACTIVE_METHOD_4_B9560C5367961061_OFFSET UNITYSDK_OFFSET(0x1692EC70)
#define RPG_GAMECORE_BYISCURRENTSKILLACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1692ECF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsCurrentSkillActive_TypeDefinitionIndex = 21201;
