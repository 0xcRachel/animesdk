...
#define RPG_GAMECORE_ROGUEACTADDSTYLELEVELUPREQUIREDEXPFACTORCONFIG_METHOD_6_3936126BB97C2427_OFFSET UNITYSDK_OFFSET(0x175C5810)
#define RPG_GAMECORE_ROGUEACTADDSTYLELEVELUPREQUIREDEXPFACTORCONFIG_METHOD_6_F5EF6469B526B632_OFFSET UNITYSDK_OFFSET(0x175C5A30)
#define RPG_GAMECORE_ROGUEACTADDSTYLELEVELUPREQUIREDEXPFACTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175C5950)
