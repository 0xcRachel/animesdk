...
#define RPG_GAMECORE_ACTIONCHECKACTIONCONFIG_METHOD_4_73CE6B3C960F5826_OFFSET UNITYSDK_OFFSET(0x1885C400)
#define RPG_GAMECORE_ACTIONCHECKACTIONCONFIG_METHOD_4_D0D6C304CFE08799_OFFSET UNITYSDK_OFFSET(0x1885C4E0)
#define RPG_GAMECORE_ACTIONCHECKACTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1885C490)
