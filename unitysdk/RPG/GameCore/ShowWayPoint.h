...
#define RPG_GAMECORE_SHOWWAYPOINT_METHOD_3_9C10471920C4EB3E_OFFSET UNITYSDK_OFFSET(0x1771BD40)
#define RPG_GAMECORE_SHOWWAYPOINT_METHOD_3_DB6720C45130C2F4_OFFSET UNITYSDK_OFFSET(0x1771BC80)
#define RPG_GAMECORE_SHOWWAYPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1771BCF0)
