...
#define RPG_GAMECORE_CHIMERADUELNPCDITHERINNODE_METHOD_3_1607D27E31BF9D89_OFFSET UNITYSDK_OFFSET(0x170B5CB0)
#define RPG_GAMECORE_CHIMERADUELNPCDITHERINNODE_METHOD_3_89736B7751093BE7_OFFSET UNITYSDK_OFFSET(0x170B5BB0)
#define RPG_GAMECORE_CHIMERADUELNPCDITHERINNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x170B5C50)
