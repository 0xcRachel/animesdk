...
#define RPG_GAMECORE_ENDPROPINTERACT_METHOD_3_2276A1DBDB0C37D5_OFFSET UNITYSDK_OFFSET(0x171AF1C0)
#define RPG_GAMECORE_ENDPROPINTERACT_METHOD_3_BB4711C081826949_OFFSET UNITYSDK_OFFSET(0x171AF2D0)
#define RPG_GAMECORE_ENDPROPINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x171AF2A0)
