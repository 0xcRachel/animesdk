...
#define RPG_GAMECORE_ENDPROPINTERACT_METHOD_3_2276A1DBDB0C37D5_OFFSET UNITYSDK_OFFSET(0x16A6C7E0)
#define RPG_GAMECORE_ENDPROPINTERACT_METHOD_3_BB4711C081826949_OFFSET UNITYSDK_OFFSET(0x16A6C8F0)
#define RPG_GAMECORE_ENDPROPINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x16A6C8C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EndPropInteract_TypeDefinitionIndex = 18164;
