...
#define RPG_GAMECORE_ENDPROPINTERACT_METHOD_3_2276A1DBDB0C37D5_OFFSET UNITYSDK_OFFSET(0x1915B840)
#define RPG_GAMECORE_ENDPROPINTERACT_METHOD_3_BB4711C081826949_OFFSET UNITYSDK_OFFSET(0x1915B950)
#define RPG_GAMECORE_ENDPROPINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x1915B920)
