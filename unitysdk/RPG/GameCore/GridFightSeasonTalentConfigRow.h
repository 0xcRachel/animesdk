...
#define RPG_GAMECORE_GRIDFIGHTSEASONTALENTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A1BC8A0)
#define RPG_GAMECORE_GRIDFIGHTSEASONTALENTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1BCDA0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 IsImportant; // 0x60
