...
#define RPG_GAMECORE_SHOWTARGETHPBAR_METHOD_3_01CD460A9DF9E9C3_OFFSET UNITYSDK_OFFSET(0x17719770)
#define RPG_GAMECORE_SHOWTARGETHPBAR_METHOD_3_B384933BED98FE67_OFFSET UNITYSDK_OFFSET(0x177197F0)
#define RPG_GAMECORE_SHOWTARGETHPBAR__CTOR_OFFSET UNITYSDK_OFFSET(0x177197C0)
