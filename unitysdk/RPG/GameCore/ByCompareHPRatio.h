...
#define RPG_GAMECORE_BYCOMPAREHPRATIO_METHOD_4_1576F02E1FFDD53B_OFFSET UNITYSDK_OFFSET(0x1690E6C0)
#define RPG_GAMECORE_BYCOMPAREHPRATIO_METHOD_4_5BAAA37E5C859879_OFFSET UNITYSDK_OFFSET(0x1690E790)
#define RPG_GAMECORE_BYCOMPAREHPRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x1690E740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareHPRatio_TypeDefinitionIndex = 20651;
