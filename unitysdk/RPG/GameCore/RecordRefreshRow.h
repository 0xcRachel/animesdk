...
#define RPG_GAMECORE_RECORDREFRESHROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16DCE870)
#define RPG_GAMECORE_RECORDREFRESHROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16DCEF10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RecordRefreshRow_TypeDefinitionIndex = 13104;
