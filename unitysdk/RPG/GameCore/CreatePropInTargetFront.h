...
#define RPG_GAMECORE_CREATEPROPINTARGETFRONT_METHOD_3_2EAE2C5859E855DA_OFFSET UNITYSDK_OFFSET(0x169D5D50)
#define RPG_GAMECORE_CREATEPROPINTARGETFRONT_METHOD_3_FBE9ECC21C1941A3_OFFSET UNITYSDK_OFFSET(0x169D5E80)
#define RPG_GAMECORE_CREATEPROPINTARGETFRONT__CTOR_OFFSET UNITYSDK_OFFSET(0x169D5D90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreatePropInTargetFront_TypeDefinitionIndex = 17926;
