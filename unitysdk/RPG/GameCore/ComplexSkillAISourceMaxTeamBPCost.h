...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEMAXTEAMBPCOST_METHOD_3_3FA46FDAB29EC335_OFFSET UNITYSDK_OFFSET(0x1713B240)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEMAXTEAMBPCOST_METHOD_3_54C8D2B91CD7A8A1_OFFSET UNITYSDK_OFFSET(0x1713D3B0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEMAXTEAMBPCOST__CTOR_OFFSET UNITYSDK_OFFSET(0x1713B220)
