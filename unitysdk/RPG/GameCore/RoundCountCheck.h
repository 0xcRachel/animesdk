...
#define RPG_GAMECORE_ROUNDCOUNTCHECK_METHOD_3_84DFC81722F30E0E_OFFSET UNITYSDK_OFFSET(0x16ED4D70)
#define RPG_GAMECORE_ROUNDCOUNTCHECK_METHOD_3_BC8E0082199E5059_OFFSET UNITYSDK_OFFSET(0x16ED4DF0)
#define RPG_GAMECORE_ROUNDCOUNTCHECK__CTOR_OFFSET UNITYSDK_OFFSET(0x16ED4DC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RoundCountCheck_TypeDefinitionIndex = 20614;
