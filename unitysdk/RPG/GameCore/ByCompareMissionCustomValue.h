...
#define RPG_GAMECORE_BYCOMPAREMISSIONCUSTOMVALUE_METHOD_4_7605545FDCA9D7BA_OFFSET UNITYSDK_OFFSET(0x16911D80)
#define RPG_GAMECORE_BYCOMPAREMISSIONCUSTOMVALUE_METHOD_4_79BC103FE8AF0010_OFFSET UNITYSDK_OFFSET(0x16911CA0)
#define RPG_GAMECORE_BYCOMPAREMISSIONCUSTOMVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x16911D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareMissionCustomValue_TypeDefinitionIndex = 18216;
