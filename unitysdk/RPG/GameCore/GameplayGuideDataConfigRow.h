...
#define RPG_GAMECORE_GAMEPLAYGUIDEDATACONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19CA7160)
#define RPG_GAMECORE_GAMEPLAYGUIDEDATACONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19CA8B00)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 ShowItemAmount; // 0x30
		::System::UInt32 TabID; // 0x34
		::System::UInt32 SubType; // 0x38
