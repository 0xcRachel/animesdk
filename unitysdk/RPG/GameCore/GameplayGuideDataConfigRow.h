...
#define RPG_GAMECORE_GAMEPLAYGUIDEDATACONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17257F40)
#define RPG_GAMECORE_GAMEPLAYGUIDEDATACONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x172596D0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 ShowItemAmount; // 0x44
