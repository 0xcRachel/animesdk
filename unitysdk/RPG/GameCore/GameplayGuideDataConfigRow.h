...
#define RPG_GAMECORE_GAMEPLAYGUIDEDATACONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18B97E40)
#define RPG_GAMECORE_GAMEPLAYGUIDEDATACONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18B995B0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 MapEntranceID; // 0x3C
		::System::UInt32 ShowItemAmount; // 0x40
