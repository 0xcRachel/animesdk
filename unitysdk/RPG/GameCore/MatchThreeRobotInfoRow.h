...
#define RPG_GAMECORE_MATCHTHREEROBOTINFOROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16C63980)
#define RPG_GAMECORE_MATCHTHREEROBOTINFOROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16C63B90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MatchThreeRobotInfoRow_TypeDefinitionIndex = 10888;

	class MatchThreeRobotInfoRow : public ::System::Object
	{
	public:
		::System::String* HeadIcon; // 0x10
		::System::UInt32 RobotID; // 0x18
