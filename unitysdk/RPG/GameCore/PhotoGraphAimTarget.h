...
#define RPG_GAMECORE_PHOTOGRAPHAIMTARGET_METHOD_3_D0C823BCD30492E4_OFFSET UNITYSDK_OFFSET(0x16D34A10)
#define RPG_GAMECORE_PHOTOGRAPHAIMTARGET_METHOD_3_FEA216629C9533AA_OFFSET UNITYSDK_OFFSET(0x16D34A90)
#define RPG_GAMECORE_PHOTOGRAPHAIMTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x16D34A60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphAimTarget_TypeDefinitionIndex = 19300;
