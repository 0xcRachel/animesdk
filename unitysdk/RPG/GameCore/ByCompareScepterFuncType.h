...
#define RPG_GAMECORE_BYCOMPARESCEPTERFUNCTYPE_METHOD_4_09D2C9D48E4787C6_OFFSET UNITYSDK_OFFSET(0x18FED350)
#define RPG_GAMECORE_BYCOMPARESCEPTERFUNCTYPE_METHOD_4_2B3B8D428A8B4B2F_OFFSET UNITYSDK_OFFSET(0x18FED670)
#define RPG_GAMECORE_BYCOMPARESCEPTERFUNCTYPE_METHOD_4_BFBC711682BA2846_OFFSET UNITYSDK_OFFSET(0x18FED420)
#define RPG_GAMECORE_BYCOMPARESCEPTERFUNCTYPE_METHOD_4_CD141103C7F90C08_OFFSET UNITYSDK_OFFSET(0x18FED5F0)
#define RPG_GAMECORE_BYCOMPARESCEPTERFUNCTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x18FED3D0)
