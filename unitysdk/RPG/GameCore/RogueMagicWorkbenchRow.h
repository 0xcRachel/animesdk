...
#define RPG_GAMECORE_ROGUEMAGICWORKBENCHROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16E8B3A0)
#define RPG_GAMECORE_ROGUEMAGICWORKBENCHROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16E8B4F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMagicWorkbenchRow_TypeDefinitionIndex = 13523;
