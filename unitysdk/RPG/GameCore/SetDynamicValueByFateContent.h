...
#define RPG_GAMECORE_SETDYNAMICVALUEBYFATECONTENT_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x199A3B20)
#define RPG_GAMECORE_SETDYNAMICVALUEBYFATECONTENT_METHOD_4_5A0E313287045A20_OFFSET UNITYSDK_OFFSET(0x199A3940)
#define RPG_GAMECORE_SETDYNAMICVALUEBYFATECONTENT_METHOD_4_C9CA1B2B1BEA4888_OFFSET UNITYSDK_OFFSET(0x199A3870)
#define RPG_GAMECORE_SETDYNAMICVALUEBYFATECONTENT__CTOR_OFFSET UNITYSDK_OFFSET(0x199A38F0)
