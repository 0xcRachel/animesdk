...
#define RPG_GAMECORE_REMOVEANIMATIONCLIP_METHOD_3_7656FE9BC49539FA_OFFSET UNITYSDK_OFFSET(0x16DDDB20)
#define RPG_GAMECORE_REMOVEANIMATIONCLIP_METHOD_3_F921D07A29F5C383_OFFSET UNITYSDK_OFFSET(0x16DDDAA0)
#define RPG_GAMECORE_REMOVEANIMATIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x16DDDAF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveAnimationClip_TypeDefinitionIndex = 18051;
