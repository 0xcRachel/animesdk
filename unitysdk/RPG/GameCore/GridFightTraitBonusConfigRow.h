...
#define RPG_GAMECORE_GRIDFIGHTTRAITBONUSCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B4DD20)
#define RPG_GAMECORE_GRIDFIGHTTRAITBONUSCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B4DF50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightTraitBonusConfigRow_TypeDefinitionIndex = 12447;
