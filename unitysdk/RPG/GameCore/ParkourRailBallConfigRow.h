...
#define RPG_GAMECORE_PARKOURRAILBALLCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1749F670)
#define RPG_GAMECORE_PARKOURRAILBALLCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1749FA70)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 UpgradeBallID; // 0x44
