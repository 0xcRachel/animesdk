...
#define RPG_GAMECORE_WAITROGUESELECTBUFF_METHOD_3_234E84E2AF445F73_OFFSET UNITYSDK_OFFSET(0x1715ADF0)
#define RPG_GAMECORE_WAITROGUESELECTBUFF_METHOD_3_F866739344894223_OFFSET UNITYSDK_OFFSET(0x1715AE80)
#define RPG_GAMECORE_WAITROGUESELECTBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x1715AE50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRogueSelectBuff_TypeDefinitionIndex = 18265;
