...
#define RPG_GAMECORE_AETHERDIVIDESPIRITROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16F7ACA0)
#define RPG_GAMECORE_AETHERDIVIDESPIRITROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16F7D270)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::RPG::GameCore::AetherPassiveSkillType>* PassiveSkillSlotList; // 0x20
		::System::String* AvatarSideIconPath; // 0x28
		::System::String* AtlasAvatarHeadIconPath; // 0x30
		::System::String* TeamRightPrefabPath; // 0x38
		::System::String* SideAvatarHeadIconPath; // 0x40
		::System::String* WaitingAvatarHeadIconPath; // 0x48
		::Il2CppArray<::System::UInt32>* SkillList; // 0x50
		::System::String* TeamLeftPrefabPath; // 0x58
		::System::String* UltraSkillCutInPrefabPath; // 0x60
		::System::String* AIPath; // 0x68
		::System::String* ManikinAvatarModelPath; // 0x70
		::System::String* AvatarVOTag; // 0x78
		...
		::RPG::GameCore::FixPoint SPMax; // 0xB8
		::RPG::GameCore::AetherRarityType Rarity; // 0xC0
		::RPG::GameCore::AetherSpiritType SpiritType; // 0xC4
		::System::UInt32 AvatarID; // 0xC8
		::System::UInt32 ExpItemID; // 0xCC
		::RPG::Client::TextID SpiritDescription; // 0xD0
		::RPG::GameCore::AttackDamageType DamageType; // 0xE0
		::System::UInt32 MaxPromotion; // 0xE4
		::System::UInt32 GymLocation; // 0xE8
