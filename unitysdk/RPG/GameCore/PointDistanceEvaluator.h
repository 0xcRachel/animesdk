...
#define RPG_GAMECORE_POINTDISTANCEEVALUATOR_METHOD_4_9AD68440421D46B6_OFFSET UNITYSDK_OFFSET(0x19366BC0)
#define RPG_GAMECORE_POINTDISTANCEEVALUATOR_METHOD_4_9DB589771B0AE169_OFFSET UNITYSDK_OFFSET(0x19366C10)
#define RPG_GAMECORE_POINTDISTANCEEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19366C00)
