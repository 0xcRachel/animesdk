...
#define RPG_GAMECORE_POINTDISTANCEEVALUATOR_METHOD_4_9AD68440421D46B6_OFFSET UNITYSDK_OFFSET(0x16D77C40)
#define RPG_GAMECORE_POINTDISTANCEEVALUATOR_METHOD_4_9DB589771B0AE169_OFFSET UNITYSDK_OFFSET(0x16D77C90)
#define RPG_GAMECORE_POINTDISTANCEEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x16D77C80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PointDistanceEvaluator_TypeDefinitionIndex = 14208;
