...
#define RPG_GAMECORE_PLANETFESGAMEREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16D47840)
#define RPG_GAMECORE_PLANETFESGAMEREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16D47A30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlanetFesGameRewardRow_TypeDefinitionIndex = 11110;
