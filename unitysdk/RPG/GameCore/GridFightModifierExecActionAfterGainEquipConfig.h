...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERGAINEQUIPCONFIG_METHOD_3_91D319892816F4B2_OFFSET UNITYSDK_OFFSET(0x16B32600)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERGAINEQUIPCONFIG_METHOD_3_E8AF1B9F93AB593B_OFFSET UNITYSDK_OFFSET(0x16B32530)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERGAINEQUIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16B325B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterGainEquipConfig_TypeDefinitionIndex = 17419;
