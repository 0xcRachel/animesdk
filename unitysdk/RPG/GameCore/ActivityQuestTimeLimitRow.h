...
#define RPG_GAMECORE_ACTIVITYQUESTTIMELIMITROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16F1F490)
#define RPG_GAMECORE_ACTIVITYQUESTTIMELIMITROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16F1FCC0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::ActivityQuestUITYPE UIPanelType; // 0x34
		::RPG::Client::TextID Name; // 0x38
		::System::UInt32 ActivityID; // 0x48
		::System::UInt32 QuestTimeLimitGroupID; // 0x4C
