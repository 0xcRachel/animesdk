...
#define RPG_GAMECORE_ACTIVITYQUESTTIMELIMITROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18D9FDD0)
#define RPG_GAMECORE_ACTIVITYQUESTTIMELIMITROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18DA0640)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 QuestTimeLimitGroupID; // 0x30
