...
#define RPG_GAMECORE_PERFLOORCONFLICTRELATIVEMISSIONBAKEDDATA_METHOD_2_017942FFCECC9BC6_OFFSET UNITYSDK_OFFSET(0x18F04C60)
#define RPG_GAMECORE_PERFLOORCONFLICTRELATIVEMISSIONBAKEDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18F04DA0)
