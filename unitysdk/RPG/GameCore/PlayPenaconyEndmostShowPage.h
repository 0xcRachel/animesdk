...
#define RPG_GAMECORE_PLAYPENACONYENDMOSTSHOWPAGE_METHOD_3_94D2FDC4C4A58D19_OFFSET UNITYSDK_OFFSET(0x18B3A440)
#define RPG_GAMECORE_PLAYPENACONYENDMOSTSHOWPAGE_METHOD_3_9D6A08083FCFEBCB_OFFSET UNITYSDK_OFFSET(0x18B3A3C0)
#define RPG_GAMECORE_PLAYPENACONYENDMOSTSHOWPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B3A410)
