...
#define RPG_GAMECORE_MARBLEBYCHECKSEALLEVEL_METHOD_4_13695E74FBA45B80_OFFSET UNITYSDK_OFFSET(0x16C38C10)
#define RPG_GAMECORE_MARBLEBYCHECKSEALLEVEL_METHOD_4_D4823C9FCE1E15F6_OFFSET UNITYSDK_OFFSET(0x16C38CF0)
#define RPG_GAMECORE_MARBLEBYCHECKSEALLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x16C38CA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleByCheckSealLevel_TypeDefinitionIndex = 15206;
