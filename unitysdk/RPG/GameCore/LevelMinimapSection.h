...
#define RPG_GAMECORE_LEVELMINIMAPSECTION_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16BABC30)
#define RPG_GAMECORE_LEVELMINIMAPSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16BAC1C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelMinimapSection_TypeDefinitionIndex = 15535;
