...
#define RPG_GAMECORE_BYCOMPARESWITCHMASCOTPICKUPCOUNT_METHOD_4_190F36DD6828EDF0_OFFSET UNITYSDK_OFFSET(0x18FF6D00)
#define RPG_GAMECORE_BYCOMPARESWITCHMASCOTPICKUPCOUNT_METHOD_4_BE5D8F7A975AAA37_OFFSET UNITYSDK_OFFSET(0x18FF6EB0)
#define RPG_GAMECORE_BYCOMPARESWITCHMASCOTPICKUPCOUNT_METHOD_4_D56EFD9F90AC7CDE_OFFSET UNITYSDK_OFFSET(0x18FF6F30)
#define RPG_GAMECORE_BYCOMPARESWITCHMASCOTPICKUPCOUNT_METHOD_4_E266CA04B413A0D8_OFFSET UNITYSDK_OFFSET(0x18FF6C20)
#define RPG_GAMECORE_BYCOMPARESWITCHMASCOTPICKUPCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x18FF6CA0)
