...
#define RPG_GAMECORE_CACHEUI_METHOD_3_A07D049D2797AC3B_OFFSET UNITYSDK_OFFSET(0x16943D60)
#define RPG_GAMECORE_CACHEUI_METHOD_3_BEC4C889168D9E92_OFFSET UNITYSDK_OFFSET(0x16943DE0)
#define RPG_GAMECORE_CACHEUI__CTOR_OFFSET UNITYSDK_OFFSET(0x16943DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CacheUI_TypeDefinitionIndex = 19342;
