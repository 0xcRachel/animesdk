...
#define RPG_GAMECORE_VE_RTBATTLEPROPERTY_METHOD_3_B5FE558A80202FB9_OFFSET UNITYSDK_OFFSET(0x1951BF00)
#define RPG_GAMECORE_VE_RTBATTLEPROPERTY_METHOD_3_F9428CAD66CB4A54_OFFSET UNITYSDK_OFFSET(0x1951BEC0)
#define RPG_GAMECORE_VE_RTBATTLEPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1951BEF0)
