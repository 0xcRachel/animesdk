...
#define RPG_GAMECORE_AICUSTOMSTRINGTAGSELECTOR_METHOD_3_17CEE27A01772414_OFFSET UNITYSDK_OFFSET(0x16EA3A30)
#define RPG_GAMECORE_AICUSTOMSTRINGTAGSELECTOR_METHOD_3_89E1FE26047591DB_OFFSET UNITYSDK_OFFSET(0x16EA3A70)
#define RPG_GAMECORE_AICUSTOMSTRINGTAGSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x16EA3A60)
