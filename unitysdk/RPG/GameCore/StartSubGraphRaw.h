...
#define RPG_GAMECORE_STARTSUBGRAPHRAW_METHOD_3_417528287A40BC9C_OFFSET UNITYSDK_OFFSET(0x16F96B50)
#define RPG_GAMECORE_STARTSUBGRAPHRAW_METHOD_3_6C43293600FF5166_OFFSET UNITYSDK_OFFSET(0x16F96BD0)
#define RPG_GAMECORE_STARTSUBGRAPHRAW__CTOR_OFFSET UNITYSDK_OFFSET(0x16F96BA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartSubGraphRaw_TypeDefinitionIndex = 18518;
