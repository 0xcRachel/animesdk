...
#define RPG_GAMECORE_FIVEDIMBILLBOARDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16AB3E90)
#define RPG_GAMECORE_FIVEDIMBILLBOARDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16AB3F90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimBillboardConfigRow_TypeDefinitionIndex = 11377;
