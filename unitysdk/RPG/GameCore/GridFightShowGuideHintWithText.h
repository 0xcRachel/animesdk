...
#define RPG_GAMECORE_GRIDFIGHTSHOWGUIDEHINTWITHTEXT_METHOD_3_DE418EA7BBDDBEB5_OFFSET UNITYSDK_OFFSET(0x17297990)
#define RPG_GAMECORE_GRIDFIGHTSHOWGUIDEHINTWITHTEXT_METHOD_3_E10363977A67381C_OFFSET UNITYSDK_OFFSET(0x17297A10)
#define RPG_GAMECORE_GRIDFIGHTSHOWGUIDEHINTWITHTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x172979E0)
