...
#define RPG_GAMECORE_GRIDFIGHTSHOWGUIDEHINTWITHTEXT_METHOD_3_DE418EA7BBDDBEB5_OFFSET UNITYSDK_OFFSET(0x19B8AD90)
#define RPG_GAMECORE_GRIDFIGHTSHOWGUIDEHINTWITHTEXT_METHOD_3_E10363977A67381C_OFFSET UNITYSDK_OFFSET(0x19B8AE10)
#define RPG_GAMECORE_GRIDFIGHTSHOWGUIDEHINTWITHTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x19B8ADE0)
