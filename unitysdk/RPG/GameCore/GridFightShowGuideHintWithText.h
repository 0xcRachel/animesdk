...
#define RPG_GAMECORE_GRIDFIGHTSHOWGUIDEHINTWITHTEXT_METHOD_3_DE418EA7BBDDBEB5_OFFSET UNITYSDK_OFFSET(0x16B49290)
#define RPG_GAMECORE_GRIDFIGHTSHOWGUIDEHINTWITHTEXT_METHOD_3_E10363977A67381C_OFFSET UNITYSDK_OFFSET(0x16B49310)
#define RPG_GAMECORE_GRIDFIGHTSHOWGUIDEHINTWITHTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x16B492E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightShowGuideHintWithText_TypeDefinitionIndex = 17730;
