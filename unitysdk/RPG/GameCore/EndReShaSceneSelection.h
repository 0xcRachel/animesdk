...
#define RPG_GAMECORE_ENDRESHASCENESELECTION_METHOD_3_5D1C89515E75F13F_OFFSET UNITYSDK_OFFSET(0x1915BBE0)
#define RPG_GAMECORE_ENDRESHASCENESELECTION_METHOD_3_B1266994BFDCE593_OFFSET UNITYSDK_OFFSET(0x1915BCF0)
#define RPG_GAMECORE_ENDRESHASCENESELECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1915BCC0)
