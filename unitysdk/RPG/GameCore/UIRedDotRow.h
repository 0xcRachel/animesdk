...
#define RPG_GAMECORE_UIREDDOTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1713AB20)
#define RPG_GAMECORE_UIREDDOTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1713B1B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UIRedDotRow_TypeDefinitionIndex = 14027;
