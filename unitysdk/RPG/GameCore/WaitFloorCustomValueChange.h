...
#define RPG_GAMECORE_WAITFLOORCUSTOMVALUECHANGE_METHOD_4_1D0EA36B25BB50CE_OFFSET UNITYSDK_OFFSET(0x1B317BE0)
#define RPG_GAMECORE_WAITFLOORCUSTOMVALUECHANGE_METHOD_4_D345C4931DCBAD10_OFFSET UNITYSDK_OFFSET(0x1B317B00)
#define RPG_GAMECORE_WAITFLOORCUSTOMVALUECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B317B80)
