...
#define RPG_GAMECORE_RTABILITYCONFIG_METHOD_3_0D12E39C635B9ABB_OFFSET UNITYSDK_OFFSET(0x198403B0)
#define RPG_GAMECORE_RTABILITYCONFIG_METHOD_3_5ADC79734133A074_OFFSET UNITYSDK_OFFSET(0x19840370)
#define RPG_GAMECORE_RTABILITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x198403A0)
