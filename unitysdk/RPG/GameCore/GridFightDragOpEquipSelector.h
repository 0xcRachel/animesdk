...
#define RPG_GAMECORE_GRIDFIGHTDRAGOPEQUIPSELECTOR_METHOD_3_36107C6FE94A4571_OFFSET UNITYSDK_OFFSET(0x1726CDD0)
#define RPG_GAMECORE_GRIDFIGHTDRAGOPEQUIPSELECTOR_METHOD_3_E5EBE060FA70E49D_OFFSET UNITYSDK_OFFSET(0x1726CEA0)
#define RPG_GAMECORE_GRIDFIGHTDRAGOPEQUIPSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1726CE90)
