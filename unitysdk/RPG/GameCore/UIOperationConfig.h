...
#define RPG_GAMECORE_UIOPERATIONCONFIG_METHOD_2_714F75834766885E_OFFSET UNITYSDK_OFFSET(0x17138290)
#define RPG_GAMECORE_UIOPERATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171391C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UIOperationConfig_TypeDefinitionIndex = 21917;
