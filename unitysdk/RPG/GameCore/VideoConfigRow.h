...
#define RPG_GAMECORE_VIDEOCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x171487F0)
#define RPG_GAMECORE_VIDEOCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17148E20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VideoConfigRow_TypeDefinitionIndex = 14039;
