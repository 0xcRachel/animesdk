...
#define RPG_GAMECORE_RESOLUTIONADAPTIONCONFIGMAPPING_METHOD_2_08EFB221D70FADBA_OFFSET UNITYSDK_OFFSET(0x16DE82A0)
#define RPG_GAMECORE_RESOLUTIONADAPTIONCONFIGMAPPING__CTOR_OFFSET UNITYSDK_OFFSET(0x16DE8370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResolutionAdaptionConfigMapping_TypeDefinitionIndex = 15429;
