...
#define RPG_GAMECORE_RESOLUTIONADAPTIONCONFIGMAPPING_METHOD_2_08EFB221D70FADBA_OFFSET UNITYSDK_OFFSET(0x190309C0)
#define RPG_GAMECORE_RESOLUTIONADAPTIONCONFIGMAPPING__CTOR_OFFSET UNITYSDK_OFFSET(0x19030A90)
