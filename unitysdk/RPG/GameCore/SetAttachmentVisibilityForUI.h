...
#define RPG_GAMECORE_SETATTACHMENTVISIBILITYFORUI_METHOD_4_7FB01F5C3EA91D31_OFFSET UNITYSDK_OFFSET(0x1A1E3990)
#define RPG_GAMECORE_SETATTACHMENTVISIBILITYFORUI_METHOD_4_8483B62FEB43D756_OFFSET UNITYSDK_OFFSET(0x1A1E3BD0)
#define RPG_GAMECORE_SETATTACHMENTVISIBILITYFORUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1E3960)
