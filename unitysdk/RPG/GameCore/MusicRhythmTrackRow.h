...
#define RPG_GAMECORE_MUSICRHYTHMTRACKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16CF8120)
#define RPG_GAMECORE_MUSICRHYTHMTRACKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16CF8380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MusicRhythmTrackRow_TypeDefinitionIndex = 12996;
