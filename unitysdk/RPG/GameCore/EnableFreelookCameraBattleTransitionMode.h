...
#define RPG_GAMECORE_ENABLEFREELOOKCAMERABATTLETRANSITIONMODE_METHOD_3_DF440198004AF96A_OFFSET UNITYSDK_OFFSET(0x16A69B20)
#define RPG_GAMECORE_ENABLEFREELOOKCAMERABATTLETRANSITIONMODE_METHOD_3_EFB98A5716A30540_OFFSET UNITYSDK_OFFSET(0x16A69A80)
#define RPG_GAMECORE_ENABLEFREELOOKCAMERABATTLETRANSITIONMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x16A69AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableFreelookCameraBattleTransitionMode_TypeDefinitionIndex = 18203;
