...
#define RPG_GAMECORE_ADVTRACKNPCPLAYERHIDE_METHOD_3_342A7EC9D3299658_OFFSET UNITYSDK_OFFSET(0x1684C020)
#define RPG_GAMECORE_ADVTRACKNPCPLAYERHIDE_METHOD_3_34D232189AB271CE_OFFSET UNITYSDK_OFFSET(0x1684BFA0)
#define RPG_GAMECORE_ADVTRACKNPCPLAYERHIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1684BFF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvTrackNpcPlayerHide_TypeDefinitionIndex = 19837;
