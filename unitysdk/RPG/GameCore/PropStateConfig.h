...
#define RPG_GAMECORE_PROPSTATECONFIG_METHOD_2_BD39DAD81E3B2045_OFFSET UNITYSDK_OFFSET(0x16DB7650)
#define RPG_GAMECORE_PROPSTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16DB7A70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropStateConfig_TypeDefinitionIndex = 15844;
