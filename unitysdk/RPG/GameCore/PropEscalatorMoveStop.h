...
#define RPG_GAMECORE_PROPESCALATORMOVESTOP_METHOD_3_0B5950FDA3194282_OFFSET UNITYSDK_OFFSET(0x16DA8B20)
#define RPG_GAMECORE_PROPESCALATORMOVESTOP_METHOD_3_9ACE875DD87BDE18_OFFSET UNITYSDK_OFFSET(0x16DA8BF0)
#define RPG_GAMECORE_PROPESCALATORMOVESTOP__CTOR_OFFSET UNITYSDK_OFFSET(0x16DA8BA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropEscalatorMoveStop_TypeDefinitionIndex = 18823;
