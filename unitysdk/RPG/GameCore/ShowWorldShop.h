...
#define RPG_GAMECORE_SHOWWORLDSHOP_METHOD_3_10E6634EAB57D6D4_OFFSET UNITYSDK_OFFSET(0x16F66FA0)
#define RPG_GAMECORE_SHOWWORLDSHOP_METHOD_3_BE8191741A29BB63_OFFSET UNITYSDK_OFFSET(0x16F67020)
#define RPG_GAMECORE_SHOWWORLDSHOP__CTOR_OFFSET UNITYSDK_OFFSET(0x16F66FF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowWorldShop_TypeDefinitionIndex = 18705;
