...
#define RPG_GAMECORE_SHOWWORLDSHOP_METHOD_3_10E6634EAB57D6D4_OFFSET UNITYSDK_OFFSET(0x1771C520)
#define RPG_GAMECORE_SHOWWORLDSHOP_METHOD_3_BE8191741A29BB63_OFFSET UNITYSDK_OFFSET(0x1771C5A0)
#define RPG_GAMECORE_SHOWWORLDSHOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1771C570)
