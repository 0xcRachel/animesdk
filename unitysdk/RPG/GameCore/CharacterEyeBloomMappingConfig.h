...
#define RPG_GAMECORE_CHARACTEREYEBLOOMMAPPINGCONFIG_METHOD_2_41C2087F2111CB95_OFFSET UNITYSDK_OFFSET(0x1A13EFF0)
#define RPG_GAMECORE_CHARACTEREYEBLOOMMAPPINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A13F0D0)
