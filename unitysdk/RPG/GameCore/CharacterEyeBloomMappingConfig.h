...
#define RPG_GAMECORE_CHARACTEREYEBLOOMMAPPINGCONFIG_METHOD_2_560718F248D340AF_OFFSET UNITYSDK_OFFSET(0x18D5AED0)
#define RPG_GAMECORE_CHARACTEREYEBLOOMMAPPINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D5AFA0)
