...
#define RPG_GAMECORE_LEVELPEDESTRIANINFO_METHOD_4_B7B1C38D92F9E224_OFFSET UNITYSDK_OFFSET(0x16BB3200)
#define RPG_GAMECORE_LEVELPEDESTRIANINFO_METHOD_4_BA820AC58902E599_OFFSET UNITYSDK_OFFSET(0x16BB5D00)
#define RPG_GAMECORE_LEVELPEDESTRIANINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16BB31F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPedestrianInfo_TypeDefinitionIndex = 15601;
