...
#define RPG_GAMECORE_SETBOSSPLURALITYHP_METHOD_3_0D839C3ECD9777A9_OFFSET UNITYSDK_OFFSET(0x1A1E7A30)
#define RPG_GAMECORE_SETBOSSPLURALITYHP_METHOD_3_BEC26B70E33779F3_OFFSET UNITYSDK_OFFSET(0x1A1E7B50)
#define RPG_GAMECORE_SETBOSSPLURALITYHP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1E7AD0)
