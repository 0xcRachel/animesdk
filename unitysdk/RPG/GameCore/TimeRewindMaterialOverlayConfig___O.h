...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::TimeRewindView>**)Il2CppClass::FromTypeDefinitionIndex(TimeRewindMaterialOverlayConfig___O_TypeDefinitionIndex)->GetStaticField(0x18F40);
		}
	};
}
