...
#define RPG_GAMECORE_PERFORMANCESORTEDITEM_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16D2E040)
#define RPG_GAMECORE_PERFORMANCESORTEDITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x16D2E2D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceSortedItem_TypeDefinitionIndex = 17045;
