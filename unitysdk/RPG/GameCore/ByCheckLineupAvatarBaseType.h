...
#define RPG_GAMECORE_BYCHECKLINEUPAVATARBASETYPE_METHOD_4_665DE7D699789752_OFFSET UNITYSDK_OFFSET(0x195F9C50)
#define RPG_GAMECORE_BYCHECKLINEUPAVATARBASETYPE_METHOD_4_8DB16ED990337130_OFFSET UNITYSDK_OFFSET(0x195FA060)
#define RPG_GAMECORE_BYCHECKLINEUPAVATARBASETYPE_METHOD_4_B37505833B6C86AD_OFFSET UNITYSDK_OFFSET(0x195F9FA0)
#define RPG_GAMECORE_BYCHECKLINEUPAVATARBASETYPE_METHOD_4_C7F6C39B9EBA6D73_OFFSET UNITYSDK_OFFSET(0x195F9DB0)
#define RPG_GAMECORE_BYCHECKLINEUPAVATARBASETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x195F9D10)
