...
#define RPG_GAMECORE_BYCHECKLINEUPAVATARBASETYPE_METHOD_4_665DE7D699789752_OFFSET UNITYSDK_OFFSET(0x169022B0)
#define RPG_GAMECORE_BYCHECKLINEUPAVATARBASETYPE_METHOD_4_C7F6C39B9EBA6D73_OFFSET UNITYSDK_OFFSET(0x16902410)
#define RPG_GAMECORE_BYCHECKLINEUPAVATARBASETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x16902370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckLineupAvatarBaseType_TypeDefinitionIndex = 18595;
