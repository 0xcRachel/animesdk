...
#define RPG_GAMECORE_WAITTAKEPHOTO_METHOD_3_3A2A324479B82B67_OFFSET UNITYSDK_OFFSET(0x1715E120)
#define RPG_GAMECORE_WAITTAKEPHOTO_METHOD_3_5E3CC14D917CBD89_OFFSET UNITYSDK_OFFSET(0x1715E0A0)
#define RPG_GAMECORE_WAITTAKEPHOTO__CTOR_OFFSET UNITYSDK_OFFSET(0x1715E0F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitTakePhoto_TypeDefinitionIndex = 19817;
