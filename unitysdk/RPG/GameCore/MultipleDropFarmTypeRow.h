...
#define RPG_GAMECORE_MULTIPLEDROPFARMTYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16CE7B70)
#define RPG_GAMECORE_MULTIPLEDROPFARMTYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16CE8190)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MultipleDropFarmTypeRow_TypeDefinitionIndex = 10654;
