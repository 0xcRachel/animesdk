...
#define RPG_GAMECORE_TRAVELSHIPHIDELANDONBTN_METHOD_3_040A960E10227C35_OFFSET UNITYSDK_OFFSET(0x19107A90)
#define RPG_GAMECORE_TRAVELSHIPHIDELANDONBTN_METHOD_3_191AE080CBCD28FD_OFFSET UNITYSDK_OFFSET(0x19107940)
#define RPG_GAMECORE_TRAVELSHIPHIDELANDONBTN__CTOR_OFFSET UNITYSDK_OFFSET(0x19107A00)
