...
#define RPG_GAMECORE_TRAVELSHIPHIDELANDONBTN_METHOD_3_040A960E10227C35_OFFSET UNITYSDK_OFFSET(0x1710F990)
#define RPG_GAMECORE_TRAVELSHIPHIDELANDONBTN_METHOD_3_191AE080CBCD28FD_OFFSET UNITYSDK_OFFSET(0x1710F840)
#define RPG_GAMECORE_TRAVELSHIPHIDELANDONBTN__CTOR_OFFSET UNITYSDK_OFFSET(0x1710F900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TravelShipHideLandOnBtn_TypeDefinitionIndex = 18786;
