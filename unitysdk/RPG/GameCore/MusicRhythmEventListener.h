...
#define RPG_GAMECORE_MUSICRHYTHMEVENTLISTENER_METHOD_3_4D6A6D15249F2093_OFFSET UNITYSDK_OFFSET(0x16CF3EA0)
#define RPG_GAMECORE_MUSICRHYTHMEVENTLISTENER_METHOD_3_6F6CD1488DA8FC02_OFFSET UNITYSDK_OFFSET(0x16CF3F20)
#define RPG_GAMECORE_MUSICRHYTHMEVENTLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x16CF3EF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MusicRhythmEventListener_TypeDefinitionIndex = 19718;
