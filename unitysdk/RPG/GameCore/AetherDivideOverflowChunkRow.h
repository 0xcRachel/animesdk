...
#define RPG_GAMECORE_AETHERDIVIDEOVERFLOWCHUNKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18AB86E0)
#define RPG_GAMECORE_AETHERDIVIDEOVERFLOWCHUNKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18AB8900)
