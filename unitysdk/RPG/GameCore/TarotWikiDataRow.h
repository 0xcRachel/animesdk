...
#define RPG_GAMECORE_TAROTWIKIDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16FF7080)
#define RPG_GAMECORE_TAROTWIKIDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16FF7390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TarotWikiDataRow_TypeDefinitionIndex = 13868;
