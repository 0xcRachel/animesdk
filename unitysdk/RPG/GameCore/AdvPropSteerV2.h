...
#define RPG_GAMECORE_ADVPROPSTEERV2_METHOD_3_5AAF72D433B6F6AB_OFFSET UNITYSDK_OFFSET(0x16843620)
#define RPG_GAMECORE_ADVPROPSTEERV2_METHOD_3_DA0AE9DE623B1B89_OFFSET UNITYSDK_OFFSET(0x16843770)
#define RPG_GAMECORE_ADVPROPSTEERV2__CTOR_OFFSET UNITYSDK_OFFSET(0x168436E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvPropSteerV2_TypeDefinitionIndex = 19705;
