...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::CakeRaceBuffName>**)Il2CppClass::FromTypeDefinitionIndex(CakeRaceActionRemoveBuff___O_TypeDefinitionIndex)->GetStaticField(0x12730);
		}
	};
}
