...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSKIPBATTLECONFIG_METHOD_3_61D80A48351BD7E6_OFFSET UNITYSDK_OFFSET(0x1A1A7B50)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSKIPBATTLECONFIG_METHOD_3_EE3210C5FBA95C5F_OFFSET UNITYSDK_OFFSET(0x1A1A7C20)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSKIPBATTLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1A7BD0)
