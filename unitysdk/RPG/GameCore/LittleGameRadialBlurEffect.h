...
#define RPG_GAMECORE_LITTLEGAMERADIALBLUREFFECT_METHOD_3_437083561D49DE1C_OFFSET UNITYSDK_OFFSET(0x16BD0E00)
#define RPG_GAMECORE_LITTLEGAMERADIALBLUREFFECT_METHOD_3_46F11802D43930B8_OFFSET UNITYSDK_OFFSET(0x16BD0EC0)
#define RPG_GAMECORE_LITTLEGAMERADIALBLUREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x16BD0E70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameRadialBlurEffect_TypeDefinitionIndex = 19169;
