...
#define RPG_GAMECORE_SHOPGOODSCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1939E6C0)
#define RPG_GAMECORE_SHOPGOODSCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1939F480)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::Il2CppArray<::System::UInt32>* OnShelfValue1List; // 0x10
		::Il2CppArray<::System::UInt32>* OnShelfValue2List; // 0x18
		::Il2CppArray<::System::UInt32>* CurrencyCostList; // 0x20
		::Il2CppArray<::System::UInt32>* CurrencyList; // 0x28
		::Il2CppArray<::System::UInt32>* LimitValue1List; // 0x30
		::Il2CppArray<::System::UInt32>* LimitValue2List; // 0x38
		::RPG::GameCore::GoodsRefreshType RefreshType; // 0x40
		::System::UInt32 LimitTimes; // 0x44
		::RPG::GameCore::LimitType OnShelfType1; // 0x48
		::System::UInt32 ItemGroupID; // 0x4C
		::RPG::GameCore::LimitType LimitType2; // 0x50
		::System::UInt32 ItemCount; // 0x54
		::System::Int32 RefreshOffset; // 0x58
		::System::UInt32 CycleDays; // 0x5C
		::RPG::GameCore::LimitType LimitType1; // 0x60
		::System::UInt32 ItemID; // 0x64
		::System::Boolean IsLimitedTimePurchase; // 0x68
		::System::Boolean IsOnSale; // 0x69
		::System::Boolean IsNew; // 0x6A
		::System::UInt32 GoodsID; // 0x6C
		::System::UInt32 ShopID; // 0x70
		::RPG::GameCore::ShopGoodTag TagType; // 0x74
		::RPG::GameCore::LimitType OnShelfType2; // 0x78
		::System::UInt32 ScheduleDataID; // 0x7C
		::System::UInt32 Rank; // 0x80
		::System::UInt32 TagParam; // 0x84
		::System::UInt32 ActivityModuleID; // 0x88
		::System::UInt32 Level; // 0x8C
		::System::UInt32 GoodsSortID; // 0x90
