...
#define RPG_GAMECORE_FOURROTATEVOXELLEVELSETTINGS_METHOD_3_20045C5A9C26E043_OFFSET UNITYSDK_OFFSET(0x172311C0)
#define RPG_GAMECORE_FOURROTATEVOXELLEVELSETTINGS_METHOD_3_6D1906CEE8279282_OFFSET UNITYSDK_OFFSET(0x17231180)
#define RPG_GAMECORE_FOURROTATEVOXELLEVELSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x172311B0)
