...
#define RPG_GAMECORE_ST_MAIN_DOSKILL_METHOD_4_3F0A4055F93A9B1A_OFFSET UNITYSDK_OFFSET(0x1A17FE30)
#define RPG_GAMECORE_ST_MAIN_DOSKILL_METHOD_4_5B9CC7A7863849BD_OFFSET UNITYSDK_OFFSET(0x1A167640)
#define RPG_GAMECORE_ST_MAIN_DOSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1675F0)
