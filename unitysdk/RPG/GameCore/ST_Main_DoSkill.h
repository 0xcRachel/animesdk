...
#define RPG_GAMECORE_ST_MAIN_DOSKILL_METHOD_4_3F0A4055F93A9B1A_OFFSET UNITYSDK_OFFSET(0x16EF3160)
#define RPG_GAMECORE_ST_MAIN_DOSKILL_METHOD_4_5B9CC7A7863849BD_OFFSET UNITYSDK_OFFSET(0x16EF3230)
#define RPG_GAMECORE_ST_MAIN_DOSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x16EF31E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_DoSkill_TypeDefinitionIndex = 17858;
