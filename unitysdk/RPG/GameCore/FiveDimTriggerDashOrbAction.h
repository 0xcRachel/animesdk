...
#define RPG_GAMECORE_FIVEDIMTRIGGERDASHORBACTION_METHOD_3_2AC8DE8421593215_OFFSET UNITYSDK_OFFSET(0x1A3A9AA0)
#define RPG_GAMECORE_FIVEDIMTRIGGERDASHORBACTION_METHOD_3_86A33D6355988930_OFFSET UNITYSDK_OFFSET(0x1A3A99E0)
#define RPG_GAMECORE_FIVEDIMTRIGGERDASHORBACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3A9A80)
