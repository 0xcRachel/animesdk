...
#define RPG_GAMECORE_FIVEDIMTRIGGERDASHORBACTION_METHOD_3_2AC8DE8421593215_OFFSET UNITYSDK_OFFSET(0x191F6F00)
#define RPG_GAMECORE_FIVEDIMTRIGGERDASHORBACTION_METHOD_3_86A33D6355988930_OFFSET UNITYSDK_OFFSET(0x191F6E40)
#define RPG_GAMECORE_FIVEDIMTRIGGERDASHORBACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x191F6EE0)
