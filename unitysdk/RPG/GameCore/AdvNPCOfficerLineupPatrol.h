...
#define RPG_GAMECORE_ADVNPCOFFICERLINEUPPATROL_METHOD_3_3773C08236E86A40_OFFSET UNITYSDK_OFFSET(0x18C4EC90)
#define RPG_GAMECORE_ADVNPCOFFICERLINEUPPATROL_METHOD_3_BCF7D6823E77EF16_OFFSET UNITYSDK_OFFSET(0x18C4ED20)
#define RPG_GAMECORE_ADVNPCOFFICERLINEUPPATROL__CTOR_OFFSET UNITYSDK_OFFSET(0x18C4ECF0)
