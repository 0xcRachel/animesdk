...
#define RPG_GAMECORE_TRIGGERUINOTIFY_METHOD_3_7C3C04A9C7514BB5_OFFSET UNITYSDK_OFFSET(0x17128120)
#define RPG_GAMECORE_TRIGGERUINOTIFY_METHOD_3_F7532F9D17D30B79_OFFSET UNITYSDK_OFFSET(0x171280A0)
#define RPG_GAMECORE_TRIGGERUINOTIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x171280F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerUINotify_TypeDefinitionIndex = 20570;
