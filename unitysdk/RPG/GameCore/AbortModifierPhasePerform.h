...
#define RPG_GAMECORE_ABORTMODIFIERPHASEPERFORM_METHOD_3_014F14AA4AD61EEC_OFFSET UNITYSDK_OFFSET(0x16775110)
#define RPG_GAMECORE_ABORTMODIFIERPHASEPERFORM_METHOD_3_92DBCA80B3BA4678_OFFSET UNITYSDK_OFFSET(0x16775220)
#define RPG_GAMECORE_ABORTMODIFIERPHASEPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x167751F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AbortModifierPhasePerform_TypeDefinitionIndex = 21310;
