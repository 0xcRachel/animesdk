...
#define RPG_GAMECORE_ABORTMODIFIERPHASEPERFORM_METHOD_3_014F14AA4AD61EEC_OFFSET UNITYSDK_OFFSET(0x19884830)
#define RPG_GAMECORE_ABORTMODIFIERPHASEPERFORM_METHOD_3_92DBCA80B3BA4678_OFFSET UNITYSDK_OFFSET(0x19884940)
#define RPG_GAMECORE_ABORTMODIFIERPHASEPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x19884910)
