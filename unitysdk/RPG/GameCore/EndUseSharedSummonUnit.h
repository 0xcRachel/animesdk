...
#define RPG_GAMECORE_ENDUSESHAREDSUMMONUNIT_METHOD_3_37B5434BA997B5E3_OFFSET UNITYSDK_OFFSET(0x1915BDB0)
#define RPG_GAMECORE_ENDUSESHAREDSUMMONUNIT_METHOD_3_37DF8488625024DA_OFFSET UNITYSDK_OFFSET(0x1915BE30)
#define RPG_GAMECORE_ENDUSESHAREDSUMMONUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1915BE00)
