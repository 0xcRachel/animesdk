...
#define RPG_GAMECORE_GLOBALMARBLESKILLCONFIG_METHOD_2_AF5F4EB235EBEEC6_OFFSET UNITYSDK_OFFSET(0x17243BA0)
#define RPG_GAMECORE_GLOBALMARBLESKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1725CDF0)
