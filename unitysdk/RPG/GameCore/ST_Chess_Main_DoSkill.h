...
#define RPG_GAMECORE_ST_CHESS_MAIN_DOSKILL_METHOD_4_294B798D01F0CA4E_OFFSET UNITYSDK_OFFSET(0x16EF24D0)
#define RPG_GAMECORE_ST_CHESS_MAIN_DOSKILL_METHOD_4_625E53204A019D84_OFFSET UNITYSDK_OFFSET(0x16EF2400)
#define RPG_GAMECORE_ST_CHESS_MAIN_DOSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x16EF2480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Chess_Main_DoSkill_TypeDefinitionIndex = 21449;
