...
#define RPG_GAMECORE_FIGHTFESTPAPERINTERVIEWROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18D15AA0)
#define RPG_GAMECORE_FIGHTFESTPAPERINTERVIEWROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18D15E70)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID Info; // 0x30
		::RPG::Client::TextID Name; // 0x40
		::System::UInt32 TextJoinItemID; // 0x50
