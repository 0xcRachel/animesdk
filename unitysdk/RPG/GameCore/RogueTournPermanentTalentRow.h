...
#define RPG_GAMECORE_ROGUETOURNPERMANENTTALENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16ECD7B0)
#define RPG_GAMECORE_ROGUETOURNPERMANENTTALENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16ECDBF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournPermanentTalentRow_TypeDefinitionIndex = 13634;
