...
#define RPG_GAMECORE_STARTRESHASCENESELECTION_METHOD_3_17260249546673F2_OFFSET UNITYSDK_OFFSET(0x16F967C0)
#define RPG_GAMECORE_STARTRESHASCENESELECTION_METHOD_3_271E63C111150FCB_OFFSET UNITYSDK_OFFSET(0x16F96740)
#define RPG_GAMECORE_STARTRESHASCENESELECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16F96790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartReShaSceneSelection_TypeDefinitionIndex = 19676;
