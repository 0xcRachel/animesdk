...
#define RPG_GAMECORE_TRIGGERCUSTOMPHOTOGRAPHCONDITION_METHOD_3_75232C7FF086FA78_OFFSET UNITYSDK_OFFSET(0x17119450)
#define RPG_GAMECORE_TRIGGERCUSTOMPHOTOGRAPHCONDITION_METHOD_3_FF6D4305DE2D4827_OFFSET UNITYSDK_OFFSET(0x171193D0)
#define RPG_GAMECORE_TRIGGERCUSTOMPHOTOGRAPHCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x17119420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerCustomPhotoGraphCondition_TypeDefinitionIndex = 19270;
