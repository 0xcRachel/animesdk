...
#define RPG_GAMECORE_HIPPLENINCIDENTOPTIONSTEPCONFIG_METHOD_3_011538B22175590B_OFFSET UNITYSDK_OFFSET(0x172C3250)
#define RPG_GAMECORE_HIPPLENINCIDENTOPTIONSTEPCONFIG_METHOD_3_F4CD955283B3C0EC_OFFSET UNITYSDK_OFFSET(0x172C31F0)
#define RPG_GAMECORE_HIPPLENINCIDENTOPTIONSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x172C3240)
