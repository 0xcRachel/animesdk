...
#define RPG_GAMECORE_RESETCAMERAAXIS_METHOD_3_B56741E51E51439E_OFFSET UNITYSDK_OFFSET(0x16DE52B0)
#define RPG_GAMECORE_RESETCAMERAAXIS_METHOD_3_D9B7DF1E0EAEED0A_OFFSET UNITYSDK_OFFSET(0x16DE53C0)
#define RPG_GAMECORE_RESETCAMERAAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x16DE5390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetCameraAxis_TypeDefinitionIndex = 18049;
