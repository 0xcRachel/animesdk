...
#define RPG_GAMECORE_SETSIMULATIONSPEEDENABLE_METHOD_3_6B6F573ACD2E80E7_OFFSET UNITYSDK_OFFSET(0x16F3C940)
#define RPG_GAMECORE_SETSIMULATIONSPEEDENABLE_METHOD_3_6F701C4E9C427836_OFFSET UNITYSDK_OFFSET(0x16F3C8C0)
#define RPG_GAMECORE_SETSIMULATIONSPEEDENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F3C910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetSimulationSpeedEnable_TypeDefinitionIndex = 21478;
