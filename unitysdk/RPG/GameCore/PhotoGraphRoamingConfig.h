...
#define RPG_GAMECORE_PHOTOGRAPHROAMINGCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16D38650)
#define RPG_GAMECORE_PHOTOGRAPHROAMINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16D387F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphRoamingConfig_TypeDefinitionIndex = 17066;
