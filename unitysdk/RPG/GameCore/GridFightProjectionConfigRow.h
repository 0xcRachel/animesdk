...
#define RPG_GAMECORE_GRIDFIGHTPROJECTIONCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B426A0)
#define RPG_GAMECORE_GRIDFIGHTPROJECTIONCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B42B40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightProjectionConfigRow_TypeDefinitionIndex = 12254;
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* ActivationTraitLayerList; // 0x20
		...
		::RPG::Client::TextID ProjectionDesc; // 0x40
