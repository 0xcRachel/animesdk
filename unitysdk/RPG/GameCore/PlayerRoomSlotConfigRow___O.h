...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::SlotDisplayType>**)Il2CppClass::FromTypeDefinitionIndex(PlayerRoomSlotConfigRow___O_TypeDefinitionIndex)->GetStaticField(0x4A2B0);
		}
	};
}
