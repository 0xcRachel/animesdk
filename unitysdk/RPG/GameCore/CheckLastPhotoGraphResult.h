...
#define RPG_GAMECORE_CHECKLASTPHOTOGRAPHRESULT_METHOD_3_92A1C58714E5D015_OFFSET UNITYSDK_OFFSET(0x16978740)
#define RPG_GAMECORE_CHECKLASTPHOTOGRAPHRESULT_METHOD_3_A0DE990EEC9E1A02_OFFSET UNITYSDK_OFFSET(0x169786C0)
#define RPG_GAMECORE_CHECKLASTPHOTOGRAPHRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x16978710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CheckLastPhotoGraphResult_TypeDefinitionIndex = 19259;
