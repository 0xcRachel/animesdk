...
#define RPG_GAMECORE_BYATTACKSKILLEFFECT_METHOD_4_15A74C1456240B84_OFFSET UNITYSDK_OFFSET(0x187CDD90)
#define RPG_GAMECORE_BYATTACKSKILLEFFECT_METHOD_4_BB61979B41F8D6AC_OFFSET UNITYSDK_OFFSET(0x187CDCC0)
#define RPG_GAMECORE_BYATTACKSKILLEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x187CDD40)
