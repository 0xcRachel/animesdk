...
#define RPG_GAMECORE_BYATTACKSKILLEFFECT_METHOD_4_15A74C1456240B84_OFFSET UNITYSDK_OFFSET(0x168FE4C0)
#define RPG_GAMECORE_BYATTACKSKILLEFFECT_METHOD_4_BB61979B41F8D6AC_OFFSET UNITYSDK_OFFSET(0x168FE3F0)
#define RPG_GAMECORE_BYATTACKSKILLEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x168FE470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByAttackSkillEffect_TypeDefinitionIndex = 21182;
