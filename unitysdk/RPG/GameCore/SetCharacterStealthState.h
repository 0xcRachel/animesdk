...
#define RPG_GAMECORE_SETCHARACTERSTEALTHSTATE_METHOD_3_44EDD5E8D15BE189_OFFSET UNITYSDK_OFFSET(0x176C3450)
#define RPG_GAMECORE_SETCHARACTERSTEALTHSTATE_METHOD_3_FC8C1D164FC0AED5_OFFSET UNITYSDK_OFFSET(0x176C33D0)
#define RPG_GAMECORE_SETCHARACTERSTEALTHSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x176C3420)
