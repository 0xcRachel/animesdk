...
#define RPG_GAMECORE_SETCHARACTERSTEALTHSTATE_METHOD_3_44EDD5E8D15BE189_OFFSET UNITYSDK_OFFSET(0x16F0DFC0)
#define RPG_GAMECORE_SETCHARACTERSTEALTHSTATE_METHOD_3_FC8C1D164FC0AED5_OFFSET UNITYSDK_OFFSET(0x16F0DF40)
#define RPG_GAMECORE_SETCHARACTERSTEALTHSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F0DF90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCharacterStealthState_TypeDefinitionIndex = 20610;
