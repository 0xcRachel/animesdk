...
#define RPG_GAMECORE_LIMITFRAMEMAXTIMESTEP_METHOD_3_263C9029BA8E4E5B_OFFSET UNITYSDK_OFFSET(0x17363230)
#define RPG_GAMECORE_LIMITFRAMEMAXTIMESTEP_METHOD_3_868885340C799948_OFFSET UNITYSDK_OFFSET(0x17363190)
#define RPG_GAMECORE_LIMITFRAMEMAXTIMESTEP__CTOR_OFFSET UNITYSDK_OFFSET(0x173631F0)
