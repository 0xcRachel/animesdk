...
#define RPG_GAMECORE_SHOWEXPANDELATIONITEM_METHOD_3_77D5E206FDB79400_OFFSET UNITYSDK_OFFSET(0x16F59240)
#define RPG_GAMECORE_SHOWEXPANDELATIONITEM_METHOD_3_82E3320A0D8CD476_OFFSET UNITYSDK_OFFSET(0x16F591C0)
#define RPG_GAMECORE_SHOWEXPANDELATIONITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x16F59210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowExpandElationItem_TypeDefinitionIndex = 21036;
