...
#define RPG_GAMECORE_DEBATECOSTCHANGCE_METHOD_3_B212E94EB3E52C9C_OFFSET UNITYSDK_OFFSET(0x19B2EF20)
#define RPG_GAMECORE_DEBATECOSTCHANGCE_METHOD_3_DAEC9597FB341A0C_OFFSET UNITYSDK_OFFSET(0x19B2EFC0)
#define RPG_GAMECORE_DEBATECOSTCHANGCE__CTOR_OFFSET UNITYSDK_OFFSET(0x19B2EF80)
