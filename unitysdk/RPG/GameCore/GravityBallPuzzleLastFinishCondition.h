...
#define RPG_GAMECORE_GRAVITYBALLPUZZLELASTFINISHCONDITION_METHOD_3_CCB5B29140E7FA48_OFFSET UNITYSDK_OFFSET(0x16B15730)
#define RPG_GAMECORE_GRAVITYBALLPUZZLELASTFINISHCONDITION_METHOD_3_CCD013273C325858_OFFSET UNITYSDK_OFFSET(0x16B156B0)
#define RPG_GAMECORE_GRAVITYBALLPUZZLELASTFINISHCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x16B15700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GravityBallPuzzleLastFinishCondition_TypeDefinitionIndex = 18157;
