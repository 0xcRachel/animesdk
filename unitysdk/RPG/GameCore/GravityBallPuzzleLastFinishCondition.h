...
#define RPG_GAMECORE_GRAVITYBALLPUZZLELASTFINISHCONDITION_METHOD_3_CCB5B29140E7FA48_OFFSET UNITYSDK_OFFSET(0x17261350)
#define RPG_GAMECORE_GRAVITYBALLPUZZLELASTFINISHCONDITION_METHOD_3_CCD013273C325858_OFFSET UNITYSDK_OFFSET(0x172612D0)
#define RPG_GAMECORE_GRAVITYBALLPUZZLELASTFINISHCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x17261320)
