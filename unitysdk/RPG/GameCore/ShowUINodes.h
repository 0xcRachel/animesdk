...
#define RPG_GAMECORE_SHOWUINODES_METHOD_3_4412D9AC8C7B0047_OFFSET UNITYSDK_OFFSET(0x1771B580)
#define RPG_GAMECORE_SHOWUINODES_METHOD_3_B7BDEEEC40FEC349_OFFSET UNITYSDK_OFFSET(0x1771B600)
#define RPG_GAMECORE_SHOWUINODES__CTOR_OFFSET UNITYSDK_OFFSET(0x1771B5D0)
