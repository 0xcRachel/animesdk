...
#define RPG_GAMECORE_TRIGGERREPLACECHARACTERPRESETEFFECT_METHOD_3_39195E3400377C24_OFFSET UNITYSDK_OFFSET(0x17125630)
#define RPG_GAMECORE_TRIGGERREPLACECHARACTERPRESETEFFECT_METHOD_3_E288DF4A51329FDB_OFFSET UNITYSDK_OFFSET(0x17125780)
#define RPG_GAMECORE_TRIGGERREPLACECHARACTERPRESETEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x171256F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerReplaceCharacterPresetEffect_TypeDefinitionIndex = 18034;
