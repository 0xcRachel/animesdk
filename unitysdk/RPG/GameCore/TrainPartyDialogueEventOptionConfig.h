...
#define RPG_GAMECORE_TRAINPARTYDIALOGUEEVENTOPTIONCONFIG_METHOD_2_0B8FB17B5259CBF0_OFFSET UNITYSDK_OFFSET(0x17103870)
#define RPG_GAMECORE_TRAINPARTYDIALOGUEEVENTOPTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17103930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyDialogueEventOptionConfig_TypeDefinitionIndex = 16227;
