...
#define RPG_GAMECORE_FATEPARAMMASTERCOUNTCONFIG_METHOD_6_0777DBFC85FAFE76_OFFSET UNITYSDK_OFFSET(0x19479E20)
#define RPG_GAMECORE_FATEPARAMMASTERCOUNTCONFIG_METHOD_6_5E4C48505FCD60CA_OFFSET UNITYSDK_OFFSET(0x19479C60)
#define RPG_GAMECORE_FATEPARAMMASTERCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19479D60)
