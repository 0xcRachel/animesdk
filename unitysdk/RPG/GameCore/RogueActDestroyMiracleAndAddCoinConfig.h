...
#define RPG_GAMECORE_ROGUEACTDESTROYMIRACLEANDADDCOINCONFIG_METHOD_6_36256F6C29220974_OFFSET UNITYSDK_OFFSET(0x175C8820)
#define RPG_GAMECORE_ROGUEACTDESTROYMIRACLEANDADDCOINCONFIG_METHOD_6_BBE3833491D631D9_OFFSET UNITYSDK_OFFSET(0x175C8600)
#define RPG_GAMECORE_ROGUEACTDESTROYMIRACLEANDADDCOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175C8740)
