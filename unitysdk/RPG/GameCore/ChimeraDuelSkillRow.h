...
#define RPG_GAMECORE_CHIMERADUELSKILLROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16998330)
#define RPG_GAMECORE_CHIMERADUELSKILLROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16998800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelSkillRow_TypeDefinitionIndex = 10353;
	...
	public:
		...
		::RPG::GameCore::ChimeraDuelSkillEffectScope Type; // 0x30
		::RPG::Client::TextID Description; // 0x38
		::RPG::Client::TextID PlainDescription; // 0x48
		::System::UInt32 SkillCD; // 0x58
		::System::UInt32 Priority; // 0x5C
		::System::Boolean IsImmediate; // 0x60
		::System::Boolean HasDisplay; // 0x61
