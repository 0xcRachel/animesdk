...
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPCRESET_METHOD_3_7A903F4CC8FBE9B1_OFFSET UNITYSDK_OFFSET(0x18DC6890)
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPCRESET_METHOD_3_CDDAADFEBA948F7D_OFFSET UNITYSDK_OFFSET(0x18DC6780)
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPCRESET__CTOR_OFFSET UNITYSDK_OFFSET(0x18DC6860)
