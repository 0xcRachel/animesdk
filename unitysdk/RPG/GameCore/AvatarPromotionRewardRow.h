...
#define RPG_GAMECORE_AVATARPROMOTIONREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x168AD2D0)
#define RPG_GAMECORE_AVATARPROMOTIONREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x168AD810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarPromotionRewardRow_TypeDefinitionIndex = 11553;
