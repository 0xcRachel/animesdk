...
#define RPG_GAMECORE_AVATARPROMOTIONREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1820A680)
#define RPG_GAMECORE_AVATARPROMOTIONREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1820ABC0)
