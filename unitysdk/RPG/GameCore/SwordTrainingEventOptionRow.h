...
#define RPG_GAMECORE_SWORDTRAININGEVENTOPTIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16FBCC30)
#define RPG_GAMECORE_SWORDTRAININGEVENTOPTIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16FBCF30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwordTrainingEventOptionRow_TypeDefinitionIndex = 11322;
