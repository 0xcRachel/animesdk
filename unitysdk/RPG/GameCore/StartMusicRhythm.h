...
#define RPG_GAMECORE_STARTMUSICRHYTHM_METHOD_3_4190EFB85C39C946_OFFSET UNITYSDK_OFFSET(0x18D6A7A0)
#define RPG_GAMECORE_STARTMUSICRHYTHM_METHOD_3_D5D3C4D00444B8BF_OFFSET UNITYSDK_OFFSET(0x18D6A720)
#define RPG_GAMECORE_STARTMUSICRHYTHM__CTOR_OFFSET UNITYSDK_OFFSET(0x18D6A770)
