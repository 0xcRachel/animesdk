...
#define RPG_GAMECORE_STARTMUSICRHYTHM_METHOD_3_4190EFB85C39C946_OFFSET UNITYSDK_OFFSET(0x16F95F50)
#define RPG_GAMECORE_STARTMUSICRHYTHM_METHOD_3_D5D3C4D00444B8BF_OFFSET UNITYSDK_OFFSET(0x16F95ED0)
#define RPG_GAMECORE_STARTMUSICRHYTHM__CTOR_OFFSET UNITYSDK_OFFSET(0x16F95F20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartMusicRhythm_TypeDefinitionIndex = 19707;
