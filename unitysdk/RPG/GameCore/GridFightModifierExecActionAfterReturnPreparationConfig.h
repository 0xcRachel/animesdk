...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERRETURNPREPARATIONCONFIG_METHOD_3_0D4CE59CCD283D70_OFFSET UNITYSDK_OFFSET(0x16B2DF20)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERRETURNPREPARATIONCONFIG_METHOD_3_DBC01657D4078619_OFFSET UNITYSDK_OFFSET(0x16B32870)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERRETURNPREPARATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16B2DED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterReturnPreparationConfig_TypeDefinitionIndex = 17356;
