...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::AIStatus>**)Il2CppClass::FromTypeDefinitionIndex(ST_Side_AttachAIStatus___O_TypeDefinitionIndex)->GetStaticField(0x36720);
		}
	};
}
