...
#define RPG_GAMECORE_SETTARGETDAMAGETEXTVISIBLE_METHOD_3_6B1429BCB33EE10D_OFFSET UNITYSDK_OFFSET(0x16F40C10)
#define RPG_GAMECORE_SETTARGETDAMAGETEXTVISIBLE_METHOD_3_DDB3B3C8BF9989D1_OFFSET UNITYSDK_OFFSET(0x16F40B90)
#define RPG_GAMECORE_SETTARGETDAMAGETEXTVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F40BE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTargetDamageTextVisible_TypeDefinitionIndex = 20878;
