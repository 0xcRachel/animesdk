...
#define RPG_GAMECORE_SETTARGETDAMAGETEXTVISIBLE_METHOD_3_6B1429BCB33EE10D_OFFSET UNITYSDK_OFFSET(0x1938EB30)
#define RPG_GAMECORE_SETTARGETDAMAGETEXTVISIBLE_METHOD_3_DDB3B3C8BF9989D1_OFFSET UNITYSDK_OFFSET(0x1938EAB0)
#define RPG_GAMECORE_SETTARGETDAMAGETEXTVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1938EB00)
