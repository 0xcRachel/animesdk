...
#define RPG_GAMECORE_LOOPCGCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16C1EBE0)
#define RPG_GAMECORE_LOOPCGCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16C1F210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopCGConfigRow_TypeDefinitionIndex = 14041;
