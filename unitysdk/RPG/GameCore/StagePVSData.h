...
#define RPG_GAMECORE_STAGEPVSDATA_METHOD_2_68492FEC09882C28_OFFSET UNITYSDK_OFFSET(0x1860AE10)
#define RPG_GAMECORE_STAGEPVSDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1860B290)
