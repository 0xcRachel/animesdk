...
#define RPG_GAMECORE_UNIVERSALHOTFIXTASKA_METHOD_4_86304ECEDF030924_OFFSET UNITYSDK_OFFSET(0x1713E940)
#define RPG_GAMECORE_UNIVERSALHOTFIXTASKA_METHOD_4_AA02E339AFAD3865_OFFSET UNITYSDK_OFFSET(0x1713E8C0)
#define RPG_GAMECORE_UNIVERSALHOTFIXTASKA__CTOR_OFFSET UNITYSDK_OFFSET(0x1713E910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UniversalHotFixTaskA_TypeDefinitionIndex = 21028;
