...
#define RPG_GAMECORE_WAITPHOTOGRAPHRESULT_METHOD_3_5216EAAE171F2DFE_OFFSET UNITYSDK_OFFSET(0x19531170)
#define RPG_GAMECORE_WAITPHOTOGRAPHRESULT_METHOD_3_DC4648A1BD67ABDE_OFFSET UNITYSDK_OFFSET(0x195311F0)
#define RPG_GAMECORE_WAITPHOTOGRAPHRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x195311C0)
