...
#define RPG_GAMECORE_WAITPHOTOGRAPHRESULT_METHOD_3_5216EAAE171F2DFE_OFFSET UNITYSDK_OFFSET(0x17157C10)
#define RPG_GAMECORE_WAITPHOTOGRAPHRESULT_METHOD_3_DC4648A1BD67ABDE_OFFSET UNITYSDK_OFFSET(0x17157C90)
#define RPG_GAMECORE_WAITPHOTOGRAPHRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x17157C60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitPhotoGraphResult_TypeDefinitionIndex = 19816;
