...
#define RPG_GAMECORE_WAITPHOTOGRAPHRESULT_METHOD_3_5216EAAE171F2DFE_OFFSET UNITYSDK_OFFSET(0x17914080)
#define RPG_GAMECORE_WAITPHOTOGRAPHRESULT_METHOD_3_DC4648A1BD67ABDE_OFFSET UNITYSDK_OFFSET(0x17914100)
#define RPG_GAMECORE_WAITPHOTOGRAPHRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x179140D0)
