...
#define RPG_GAMECORE_SHOWACTIONCOUNTDOWNICON_METHOD_3_95190318CE71599D_OFFSET UNITYSDK_OFFSET(0x193A0BB0)
#define RPG_GAMECORE_SHOWACTIONCOUNTDOWNICON_METHOD_3_DE2037151DF4A5EC_OFFSET UNITYSDK_OFFSET(0x193A0C30)
#define RPG_GAMECORE_SHOWACTIONCOUNTDOWNICON__CTOR_OFFSET UNITYSDK_OFFSET(0x193A0C00)
