...
#define RPG_GAMECORE_BYCOMPAREDAMAGETAG_METHOD_4_0D263E10A7185BB5_OFFSET UNITYSDK_OFFSET(0x1701B0F0)
#define RPG_GAMECORE_BYCOMPAREDAMAGETAG_METHOD_4_2EAFD2FEC7E16393_OFFSET UNITYSDK_OFFSET(0x1701B020)
#define RPG_GAMECORE_BYCOMPAREDAMAGETAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1701B0A0)
