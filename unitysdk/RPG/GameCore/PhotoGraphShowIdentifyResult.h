...
#define RPG_GAMECORE_PHOTOGRAPHSHOWIDENTIFYRESULT_METHOD_3_267BB3982C9C1610_OFFSET UNITYSDK_OFFSET(0x16D395B0)
#define RPG_GAMECORE_PHOTOGRAPHSHOWIDENTIFYRESULT_METHOD_3_AD222197BE71947D_OFFSET UNITYSDK_OFFSET(0x16D39630)
#define RPG_GAMECORE_PHOTOGRAPHSHOWIDENTIFYRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x16D39600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphShowIdentifyResult_TypeDefinitionIndex = 19302;
