...
#define RPG_GAMECORE_PHOTOGRAPHSHOWIDENTIFYRESULT_METHOD_3_267BB3982C9C1610_OFFSET UNITYSDK_OFFSET(0x174C1400)
#define RPG_GAMECORE_PHOTOGRAPHSHOWIDENTIFYRESULT_METHOD_3_AD222197BE71947D_OFFSET UNITYSDK_OFFSET(0x174C1480)
#define RPG_GAMECORE_PHOTOGRAPHSHOWIDENTIFYRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x174C1450)
