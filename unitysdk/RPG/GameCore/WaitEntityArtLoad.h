...
#define RPG_GAMECORE_WAITENTITYARTLOAD_METHOD_3_04A79627B0DA1171_OFFSET UNITYSDK_OFFSET(0x17150160)
#define RPG_GAMECORE_WAITENTITYARTLOAD_METHOD_3_A5F2D35B64A8871D_OFFSET UNITYSDK_OFFSET(0x171500E0)
#define RPG_GAMECORE_WAITENTITYARTLOAD__CTOR_OFFSET UNITYSDK_OFFSET(0x17150130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitEntityArtLoad_TypeDefinitionIndex = 19598;
