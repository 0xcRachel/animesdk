...
#define RPG_GAMECORE_TEAMFORMATIONTEMPLATECONFIG_METHOD_2_65410C39CB76CC5D_OFFSET UNITYSDK_OFFSET(0x170EAA60)
#define RPG_GAMECORE_TEAMFORMATIONTEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x170EAB60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TeamFormationTemplateConfig_TypeDefinitionIndex = 14934;
