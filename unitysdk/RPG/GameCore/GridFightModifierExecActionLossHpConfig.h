...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONLOSSHPCONFIG_METHOD_3_6FC2DC3870F584CA_OFFSET UNITYSDK_OFFSET(0x19B6FF50)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONLOSSHPCONFIG_METHOD_3_978C02C842012C93_OFFSET UNITYSDK_OFFSET(0x19B6FE80)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONLOSSHPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B6FF00)
