...
#define RPG_GAMECORE_LEVELTURNULTRASKILLPERFORMFINISH_GETACTIVEENTITY_OFFSET UNITYSDK_OFFSET(0xA4AEB20)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPERFORMFINISH_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA4AEA90)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPERFORMFINISH_GETINSERTULTRASKILLPARAMS_OFFSET UNITYSDK_OFFSET(0xA4AEAE0)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPERFORMFINISH_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA4AEA40)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPERFORMFINISH_INIT_OFFSET UNITYSDK_OFFSET(0xA4AE9E0)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPERFORMFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0xA4AEB70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelTurnUltraSkillPerformFinish_TypeDefinitionIndex = 44558;
