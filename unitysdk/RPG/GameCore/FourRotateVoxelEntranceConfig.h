...
#define RPG_GAMECORE_FOURROTATEVOXELENTRANCECONFIG_METHOD_3_A156656FC5990219_OFFSET UNITYSDK_OFFSET(0x16AE3F20)
#define RPG_GAMECORE_FOURROTATEVOXELENTRANCECONFIG_METHOD_3_AB83FC38234AAC02_OFFSET UNITYSDK_OFFSET(0x16AE3E90)
#define RPG_GAMECORE_FOURROTATEVOXELENTRANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16AE3EF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxelEntranceConfig_TypeDefinitionIndex = 15098;
