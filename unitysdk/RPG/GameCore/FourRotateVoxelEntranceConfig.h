...
#define RPG_GAMECORE_FOURROTATEVOXELENTRANCECONFIG_METHOD_3_06A7E16DF53DDC7A_OFFSET UNITYSDK_OFFSET(0x1A3B5DD0)
#define RPG_GAMECORE_FOURROTATEVOXELENTRANCECONFIG_METHOD_3_71B985BE64C77ACF_OFFSET UNITYSDK_OFFSET(0x1A3B5D40)
#define RPG_GAMECORE_FOURROTATEVOXELENTRANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3B5DA0)
