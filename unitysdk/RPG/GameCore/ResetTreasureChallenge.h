...
#define RPG_GAMECORE_RESETTREASURECHALLENGE_METHOD_3_1BA4639635945A4C_OFFSET UNITYSDK_OFFSET(0x1A2EEEA0)
#define RPG_GAMECORE_RESETTREASURECHALLENGE_METHOD_3_B226B83761C83CD8_OFFSET UNITYSDK_OFFSET(0x1A2EEFB0)
#define RPG_GAMECORE_RESETTREASURECHALLENGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2EEF80)
