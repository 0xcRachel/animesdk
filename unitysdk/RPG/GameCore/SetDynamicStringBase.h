...
#define RPG_GAMECORE_SETDYNAMICSTRINGBASE_METHOD_3_0008672B7EDA832F_OFFSET UNITYSDK_OFFSET(0x176C7A60)
#define RPG_GAMECORE_SETDYNAMICSTRINGBASE_METHOD_3_43A631F7294671C3_OFFSET UNITYSDK_OFFSET(0x176C7BB0)
#define RPG_GAMECORE_SETDYNAMICSTRINGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x176C7A30)
