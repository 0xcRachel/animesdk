...
#define RPG_GAMECORE_DRINKMAKERGUESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16A4C510)
#define RPG_GAMECORE_DRINKMAKERGUESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16A4CDE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DrinkMakerGuestRow_TypeDefinitionIndex = 11959;
	...
	public:
		...
		::System::UInt32 FinishSubMissionID; // 0x38
		::System::UInt32 GuestID; // 0x3C
		::RPG::Client::TextID BartenderGuestName; // 0x40
		::System::UInt32 MaxFaithReward; // 0x50
		::RPG::Client::TextID BartenderGuestDesc; // 0x58
		::System::UInt32 FinishQuestID; // 0x68
		::System::UInt32 MaxFaith; // 0x6C
