...
#define RPG_GAMECORE_DRINKMAKERGUESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1718F040)
#define RPG_GAMECORE_DRINKMAKERGUESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1718F910)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::RPG::Client::TextID>* EmotionProblemList; // 0x20
		::Il2CppArray<::System::UInt32>* FavorTagList; // 0x28
		::System::String* BigIconPath; // 0x30
		::RPG::Client::TextID BartenderGuestName; // 0x38
		::System::UInt32 GuestID; // 0x48
		::System::UInt32 MaxFaith; // 0x4C
		::System::UInt32 FinishQuestID; // 0x50
		::System::UInt32 FinishSubMissionID; // 0x54
		::System::UInt32 MaxFaithReward; // 0x58
		::RPG::Client::TextID BartenderGuestDesc; // 0x60
