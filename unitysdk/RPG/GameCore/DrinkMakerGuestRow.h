...
#define RPG_GAMECORE_DRINKMAKERGUESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A0A9F90)
#define RPG_GAMECORE_DRINKMAKERGUESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0AA8B0)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::Il2CppArray<::RPG::Client::TextID>* EmotionProblemList; // 0x10
		...
		::System::UInt32 GuestID; // 0x58
		::System::UInt32 MaxFaithReward; // 0x5C
