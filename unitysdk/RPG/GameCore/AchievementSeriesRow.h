...
#define RPG_GAMECORE_ACHIEVEMENTSERIESROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16777490)
#define RPG_GAMECORE_ACHIEVEMENTSERIESROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16777CA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AchievementSeriesRow_TypeDefinitionIndex = 10216;
	...
	public:
		...
		::System::UInt32 ShowParamInt1; // 0x38
		::System::UInt32 SeriesID; // 0x3C
		::RPG::Client::TextID SeriesTitle; // 0x40
		::RPG::GameCore::ShowType ShowType; // 0x50
