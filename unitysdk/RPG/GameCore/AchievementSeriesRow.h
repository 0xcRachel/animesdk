...
#define RPG_GAMECORE_ACHIEVEMENTSERIESROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1885A850)
#define RPG_GAMECORE_ACHIEVEMENTSERIESROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1885B060)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 ShowParamInt1; // 0x3C
		::System::UInt32 SeriesID; // 0x40
		::RPG::GameCore::ShowType ShowType; // 0x44
