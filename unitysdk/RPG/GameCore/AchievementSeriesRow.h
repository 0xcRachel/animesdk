...
#define RPG_GAMECORE_ACHIEVEMENTSERIESROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16EABC90)
#define RPG_GAMECORE_ACHIEVEMENTSERIESROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16EAC4A0)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::String* SilverIconPath; // 0x10
