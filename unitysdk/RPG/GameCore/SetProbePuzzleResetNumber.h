...
#define RPG_GAMECORE_SETPROBEPUZZLERESETNUMBER_METHOD_3_0794DFF2A1E87725_OFFSET UNITYSDK_OFFSET(0x176EFCA0)
#define RPG_GAMECORE_SETPROBEPUZZLERESETNUMBER_METHOD_3_E20E7A178FC4FB23_OFFSET UNITYSDK_OFFSET(0x176EFC20)
#define RPG_GAMECORE_SETPROBEPUZZLERESETNUMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x176EFC70)
