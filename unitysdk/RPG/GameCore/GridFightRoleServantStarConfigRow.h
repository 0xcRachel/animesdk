...
#define RPG_GAMECORE_GRIDFIGHTROLESERVANTSTARCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A1BA580)
#define RPG_GAMECORE_GRIDFIGHTROLESERVANTSTARCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1BAA40)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* HPBase; // 0x20
		::Il2CppArray<::System::UInt32>* ServantShowSkiilIDList; // 0x28
		::System::String* SpeedBase; // 0x30
