...
#define RPG_GAMECORE_PERFORMANCERECALLROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x174AEFD0)
#define RPG_GAMECORE_PERFORMANCERECALLROW__CTOR_OFFSET UNITYSDK_OFFSET(0x174B06C0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 SubCategoryID; // 0x3C
		::System::Boolean isVideo; // 0x40
		::System::UInt32 CategoryID; // 0x44
		::System::UInt32 PerformanceID; // 0x48
		::System::UInt32 ImgHeightSize; // 0x4C
