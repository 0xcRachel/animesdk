...
#define RPG_GAMECORE_PERFORMANCERECALLROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18F0F0E0)
#define RPG_GAMECORE_PERFORMANCERECALLROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18F10800)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean ShowInPlayerRoom; // 0x58
		::System::Boolean isVideo; // 0x59
		::System::UInt32 SubCategoryID; // 0x5C
		::System::UInt32 CategoryID; // 0x60
		::System::UInt32 ImgHeightSize; // 0x64
