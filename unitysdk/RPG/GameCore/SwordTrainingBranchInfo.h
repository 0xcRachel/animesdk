...
#define RPG_GAMECORE_SWORDTRAININGBRANCHINFO_METHOD_2_BC59015E1500A705_OFFSET UNITYSDK_OFFSET(0x16FBBBA0)
#define RPG_GAMECORE_SWORDTRAININGBRANCHINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16FBBCD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwordTrainingBranchInfo_TypeDefinitionIndex = 18094;
