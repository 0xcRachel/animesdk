...
#define RPG_GAMECORE_ADVCHARACTERDISABLEHITBOX_METHOD_3_B3410652FC62197B_OFFSET UNITYSDK_OFFSET(0x1682F530)
#define RPG_GAMECORE_ADVCHARACTERDISABLEHITBOX_METHOD_3_BD7379288E8CF236_OFFSET UNITYSDK_OFFSET(0x1682F4B0)
#define RPG_GAMECORE_ADVCHARACTERDISABLEHITBOX__CTOR_OFFSET UNITYSDK_OFFSET(0x1682F500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvCharacterDisableHitBox_TypeDefinitionIndex = 20057;
