...
#define RPG_GAMECORE_WAITMAPPOSESWITCHERREMOVE_METHOD_4_26B6D3C242A20877_OFFSET UNITYSDK_OFFSET(0x1952EA50)
#define RPG_GAMECORE_WAITMAPPOSESWITCHERREMOVE_METHOD_4_682C968F0C19F1B5_OFFSET UNITYSDK_OFFSET(0x1952E970)
#define RPG_GAMECORE_WAITMAPPOSESWITCHERREMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1952E9F0)
