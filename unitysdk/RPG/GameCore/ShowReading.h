...
#define RPG_GAMECORE_SHOWREADING_METHOD_3_2E0F76BD1A1A9192_OFFSET UNITYSDK_OFFSET(0x16F60AF0)
#define RPG_GAMECORE_SHOWREADING_METHOD_3_987B0F0F0DE22AEB_OFFSET UNITYSDK_OFFSET(0x16F60A70)
#define RPG_GAMECORE_SHOWREADING__CTOR_OFFSET UNITYSDK_OFFSET(0x16F60AC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowReading_TypeDefinitionIndex = 18696;
