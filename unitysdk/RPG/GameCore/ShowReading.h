...
#define RPG_GAMECORE_SHOWREADING_METHOD_3_2E0F76BD1A1A9192_OFFSET UNITYSDK_OFFSET(0x17716090)
#define RPG_GAMECORE_SHOWREADING_METHOD_3_987B0F0F0DE22AEB_OFFSET UNITYSDK_OFFSET(0x17716010)
#define RPG_GAMECORE_SHOWREADING__CTOR_OFFSET UNITYSDK_OFFSET(0x17716060)
