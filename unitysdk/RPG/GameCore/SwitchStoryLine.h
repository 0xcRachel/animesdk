...
#define RPG_GAMECORE_SWITCHSTORYLINE_METHOD_3_41D97AE6CCE88BE3_OFFSET UNITYSDK_OFFSET(0x16FBA050)
#define RPG_GAMECORE_SWITCHSTORYLINE_METHOD_3_FC2EB1EE424E848A_OFFSET UNITYSDK_OFFSET(0x16FBA0D0)
#define RPG_GAMECORE_SWITCHSTORYLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FBA0A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchStoryLine_TypeDefinitionIndex = 18568;
