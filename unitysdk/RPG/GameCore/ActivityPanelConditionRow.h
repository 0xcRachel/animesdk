...
#define RPG_GAMECORE_ACTIVITYPANELCONDITIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19533290)
#define RPG_GAMECORE_ACTIVITYPANELCONDITIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x195335A0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 PanelID; // 0x20
		::System::UInt32 ShopOnlyActivityModule; // 0x24
		::System::Boolean ActivityGotoStoryLineRestore; // 0x28
		::System::UInt32 ActivityOpenActivityModule; // 0x2C
		::System::UInt32 ActivityGoto; // 0x30
