...
#define RPG_GAMECORE_VE_RTBATTLERANKPARAMBYCHARACTERID_METHOD_3_30E4F9B591B453E6_OFFSET UNITYSDK_OFFSET(0x1951C4C0)
#define RPG_GAMECORE_VE_RTBATTLERANKPARAMBYCHARACTERID_METHOD_3_EBF760DD8398F3CB_OFFSET UNITYSDK_OFFSET(0x1951C480)
#define RPG_GAMECORE_VE_RTBATTLERANKPARAMBYCHARACTERID__CTOR_OFFSET UNITYSDK_OFFSET(0x1951C4B0)
