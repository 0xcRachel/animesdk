...
#define RPG_GAMECORE_MINIGAMEFLAPPYBIRDBLOCKCONFIG_METHOD_3_38106468237C86F2_OFFSET UNITYSDK_OFFSET(0x19697A50)
#define RPG_GAMECORE_MINIGAMEFLAPPYBIRDBLOCKCONFIG_METHOD_3_E27B4FD285384774_OFFSET UNITYSDK_OFFSET(0x196979F0)
#define RPG_GAMECORE_MINIGAMEFLAPPYBIRDBLOCKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19697A40)
