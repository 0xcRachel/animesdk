...
#define RPG_GAMECORE_TARGETFETCHFARMELEMENTENTITY_METHOD_4_8307BD6EF40BB23F_OFFSET UNITYSDK_OFFSET(0x177C9C10)
#define RPG_GAMECORE_TARGETFETCHFARMELEMENTENTITY_METHOD_4_8895C50C92BA7DE1_OFFSET UNITYSDK_OFFSET(0x177D2F60)
#define RPG_GAMECORE_TARGETFETCHFARMELEMENTENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x177C9BC0)
