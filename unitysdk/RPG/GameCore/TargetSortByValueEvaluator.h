...
#define RPG_GAMECORE_TARGETSORTBYVALUEEVALUATOR_METHOD_3_703EB9A27C9FFBF1_OFFSET UNITYSDK_OFFSET(0x17135C60)
#define RPG_GAMECORE_TARGETSORTBYVALUEEVALUATOR_METHOD_3_E74B831820E0C118_OFFSET UNITYSDK_OFFSET(0x17134B20)
#define RPG_GAMECORE_TARGETSORTBYVALUEEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x17134B00)
