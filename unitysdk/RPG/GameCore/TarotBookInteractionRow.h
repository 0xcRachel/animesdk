...
#define RPG_GAMECORE_TAROTBOOKINTERACTIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16FF53B0)
#define RPG_GAMECORE_TAROTBOOKINTERACTIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16FF5AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TarotBookInteractionRow_TypeDefinitionIndex = 13860;
