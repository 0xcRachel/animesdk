...
#define RPG_GAMECORE_FIVEDIMSURFACEMAPDEFINITIONCONFIG_METHOD_2_08362A704FEF23B6_OFFSET UNITYSDK_OFFSET(0x1A3A8970)
#define RPG_GAMECORE_FIVEDIMSURFACEMAPDEFINITIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3A89B0)
