...
#define RPG_GAMECORE_FIVEDIMSURFACEMAPDEFINITIONCONFIG_METHOD_2_08362A704FEF23B6_OFFSET UNITYSDK_OFFSET(0x16AD83D0)
#define RPG_GAMECORE_FIVEDIMSURFACEMAPDEFINITIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16AD8410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSurfaceMapDefinitionConfig_TypeDefinitionIndex = 16619;
