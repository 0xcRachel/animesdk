...
#define RPG_GAMECORE_ITEMRARITYCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B951D0)
#define RPG_GAMECORE_ITEMRARITYCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B95920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ItemRarityConfigRow_TypeDefinitionIndex = 12594;
	...
	public:
		...
		::System::String* ItemRarityStarImgPath; // 0x30
		::System::String* ItemShowBgPath; // 0x38
		::System::String* FrameItemRarityBgPath; // 0x40
		::System::String* LineItemRarityColor; // 0x48
