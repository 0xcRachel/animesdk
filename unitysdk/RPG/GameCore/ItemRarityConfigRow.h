...
#define RPG_GAMECORE_ITEMRARITYCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18E56860)
#define RPG_GAMECORE_ITEMRARITYCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18E56FD0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* FrameItemRarityBgPath; // 0x18
		::System::String* FrameIconRarityPath; // 0x20
