...
#define RPG_GAMECORE_ITEMRARITYCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x188A2390)
#define RPG_GAMECORE_ITEMRARITYCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x188A2AE0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* FrameItemRarityColor; // 0x30
		::System::String* LineItemRarityColor; // 0x38
