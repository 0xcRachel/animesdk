...
#define RPG_GAMECORE_CHESSFIREPROJECTILE_METHOD_3_8407ADBB1B69A6E9_OFFSET UNITYSDK_OFFSET(0x1697DEC0)
#define RPG_GAMECORE_CHESSFIREPROJECTILE_METHOD_3_855FCB246DFE3061_OFFSET UNITYSDK_OFFSET(0x1697DF60)
#define RPG_GAMECORE_CHESSFIREPROJECTILE__CTOR_OFFSET UNITYSDK_OFFSET(0x1697DF20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChessFireProjectile_TypeDefinitionIndex = 21428;
