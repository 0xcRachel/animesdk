...
#define RPG_GAMECORE_SPECIALAVATARROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x1932A610)
#define RPG_GAMECORE_SPECIALAVATARROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1932B4D0)
#define RPG_GAMECORE_SPECIALAVATARROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x1932D710)
#define RPG_GAMECORE_SPECIALAVATARROW_RESET_OFFSET UNITYSDK_OFFSET(0x1932D770)
#define RPG_GAMECORE_SPECIALAVATARROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1932D700)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* LevelAreaPrefab; // 0x40
		::RPG::GameCore::SpecialAvatarType Type; // 0x48
		::System::UInt32 RelicPropertyTypeExtra; // 0x4C
		::System::UInt32 MainMissionID; // 0x50
		::System::UInt32 Rank; // 0x54
		::System::Boolean LockBattleInfo; // 0x58
		::System::Boolean IsProtected; // 0x59
		::System::Boolean LockMazeSkill; // 0x5A
		::System::UInt32 AvatarSkinID; // 0x5C
		::System::UInt32 EquipmentRank; // 0x60
		::System::UInt32 RelicPropertyType; // 0x64
		::System::Boolean HasJoinHint; // 0x68
		::System::Boolean IsUseWorldLevel; // 0x69
		::System::Boolean HasLeaveHint; // 0x6A
		::System::Boolean IsAutoBattle; // 0x6B
		::System::UInt32 EquipmentID; // 0x6C
		::System::UInt32 PlaneID; // 0x70
		::System::UInt32 RelicSubValue; // 0x74
		::System::UInt32 RelicMainValue; // 0x78
		::System::UInt32 WorldLevel; // 0x7C
		::System::UInt32 Promotion; // 0x80
		::System::UInt32 PlayerID; // 0x84
		::System::UInt32 Level; // 0x88
		::RPG::GameCore::SkillTreeTemplateType SkillTreeTemplate; // 0x8C
		::System::Boolean HaveActionDelay; // 0x90
		::System::Boolean DisableSwitch; // 0x91
		::System::UInt32 EquipmentPromotion; // 0x94
		::System::UInt32 AvatarID; // 0x98
		::System::UInt32 EnhancedID; // 0x9C
		::System::UInt32 EquipmentLevel; // 0xA0
		::System::UInt32 SpecialAvatarID; // 0xA4
