...
#define RPG_GAMECORE_SPECIALAVATARROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x1776D760)
#define RPG_GAMECORE_SPECIALAVATARROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1776E340)
#define RPG_GAMECORE_SPECIALAVATARROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x17770040)
#define RPG_GAMECORE_SPECIALAVATARROW_RESET_OFFSET UNITYSDK_OFFSET(0x177700A0)
#define RPG_GAMECORE_SPECIALAVATARROW__CTOR_OFFSET UNITYSDK_OFFSET(0x177700E0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean HaveActionDelay; // 0x58
		::System::UInt32 EquipmentLevel; // 0x5C
		::RPG::GameCore::SpecialAvatarType Type; // 0x60
		::System::UInt32 AvatarID; // 0x64
		::System::UInt32 AvatarSkinID; // 0x68
		::System::UInt32 Promotion; // 0x6C
		::RPG::GameCore::SkillTreeTemplateType SkillTreeTemplate; // 0x70
		::System::UInt32 Level; // 0x74
		::System::UInt32 EquipmentID; // 0x78
		::System::UInt32 RelicMainValue; // 0x7C
		::System::UInt32 WorldLevel; // 0x80
		::System::UInt32 RelicPropertyType; // 0x84
		::System::UInt32 EquipmentPromotion; // 0x88
		::System::UInt32 EquipmentRank; // 0x8C
		::System::UInt32 PlaneID; // 0x90
		::System::Boolean LockMazeSkill; // 0x94
		::System::Boolean LockBattleInfo; // 0x95
		::System::Boolean DisableSwitch; // 0x96
		::System::Boolean IsUseWorldLevel; // 0x97
		::System::UInt32 RelicSubValue; // 0x98
		::System::UInt32 Rank; // 0x9C
		::System::Boolean IsProtected; // 0xA0
		::System::Boolean IsAutoBattle; // 0xA1
		::System::Boolean HasLeaveHint; // 0xA2
		::System::Boolean HasJoinHint; // 0xA3
		::System::UInt32 RelicPropertyTypeExtra; // 0xA4
