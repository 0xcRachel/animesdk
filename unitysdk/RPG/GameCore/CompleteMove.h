...
#define RPG_GAMECORE_COMPLETEMOVE_METHOD_3_21A9ADA309925F5C_OFFSET UNITYSDK_OFFSET(0x169BA540)
#define RPG_GAMECORE_COMPLETEMOVE_METHOD_3_E1C4F5B9A6865396_OFFSET UNITYSDK_OFFSET(0x169BA470)
#define RPG_GAMECORE_COMPLETEMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x169BA4F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CompleteMove_TypeDefinitionIndex = 20110;
