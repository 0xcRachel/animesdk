...
#define RPG_GAMECORE_DICECOMBATV2SINGLEDIALOGPERFORMANCETRIGGERCONDITION_BEFORETURNPREPARE_METHOD_3_85E0B5493BA97E37_OFFSET UNITYSDK_OFFSET(0x1A0A0F70)
#define RPG_GAMECORE_DICECOMBATV2SINGLEDIALOGPERFORMANCETRIGGERCONDITION_BEFORETURNPREPARE_METHOD_3_AC6E958F98C06F83_OFFSET UNITYSDK_OFFSET(0x1A0A0C80)
#define RPG_GAMECORE_DICECOMBATV2SINGLEDIALOGPERFORMANCETRIGGERCONDITION_BEFORETURNPREPARE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0A0C70)
