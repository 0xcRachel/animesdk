...
#define RPG_GAMECORE_DICECOMBATSKILLPREVIEWCONFIG_METHOD_2_0659C8FE1CFF7AE3_OFFSET UNITYSDK_OFFSET(0x1717C250)
#define RPG_GAMECORE_DICECOMBATSKILLPREVIEWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1717C350)
