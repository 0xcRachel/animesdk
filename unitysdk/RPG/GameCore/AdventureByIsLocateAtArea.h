...
#define RPG_GAMECORE_ADVENTUREBYISLOCATEATAREA_METHOD_4_9764DCFD542A3144_OFFSET UNITYSDK_OFFSET(0x18C67D00)
#define RPG_GAMECORE_ADVENTUREBYISLOCATEATAREA_METHOD_4_F5C2609161ED58FF_OFFSET UNITYSDK_OFFSET(0x18C67E20)
#define RPG_GAMECORE_ADVENTUREBYISLOCATEATAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x18C67DA0)
