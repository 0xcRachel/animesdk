...
#define RPG_GAMECORE_PLANETFESOPTICALROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16D4B220)
#define RPG_GAMECORE_PLANETFESOPTICALROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16D4B4C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlanetFesOpticalRow_TypeDefinitionIndex = 11142;
