...
#define RPG_GAMECORE_ENABLEAUTOBLINK_METHOD_3_6E84DBBD5FEF3746_OFFSET UNITYSDK_OFFSET(0x19157940)
#define RPG_GAMECORE_ENABLEAUTOBLINK_METHOD_3_E5EC2E1EC8000410_OFFSET UNITYSDK_OFFSET(0x191579C0)
#define RPG_GAMECORE_ENABLEAUTOBLINK__CTOR_OFFSET UNITYSDK_OFFSET(0x19157990)
