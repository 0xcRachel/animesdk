...
#define RPG_GAMECORE_LOOPEXECUTETASKLIST_METHOD_3_164F54A8DD3B7AE7_OFFSET UNITYSDK_OFFSET(0x16C1F630)
#define RPG_GAMECORE_LOOPEXECUTETASKLIST_METHOD_3_B605123EC8AED8CD_OFFSET UNITYSDK_OFFSET(0x16C1F350)
#define RPG_GAMECORE_LOOPEXECUTETASKLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x16C1F5B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopExecuteTaskList_TypeDefinitionIndex = 20543;
