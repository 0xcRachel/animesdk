...
#define RPG_GAMECORE_FIVEDIMFORCERESETPLAYERACTION_METHOD_3_4B221D8A19E4C1B7_OFFSET UNITYSDK_OFFSET(0x16ABE1A0)
#define RPG_GAMECORE_FIVEDIMFORCERESETPLAYERACTION_METHOD_3_8C38319E73CBAD7A_OFFSET UNITYSDK_OFFSET(0x16ABE0E0)
#define RPG_GAMECORE_FIVEDIMFORCERESETPLAYERACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16ABE180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimForceResetPlayerAction_TypeDefinitionIndex = 16773;
