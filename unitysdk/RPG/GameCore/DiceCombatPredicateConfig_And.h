...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_AND_METHOD_4_08C611500FCA532C_OFFSET UNITYSDK_OFFSET(0x1717ACF0)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_AND_METHOD_4_8F6246FEECE5F711_OFFSET UNITYSDK_OFFSET(0x171773C0)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_AND__CTOR_OFFSET UNITYSDK_OFFSET(0x17177370)
