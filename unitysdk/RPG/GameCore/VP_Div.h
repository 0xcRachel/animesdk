...
#define RPG_GAMECORE_VP_DIV_METHOD_3_43F749C00776FDA9_OFFSET UNITYSDK_OFFSET(0x1951DD70)
#define RPG_GAMECORE_VP_DIV_METHOD_3_75CC7125958743EC_OFFSET UNITYSDK_OFFSET(0x1951DCC0)
#define RPG_GAMECORE_VP_DIV__CTOR_OFFSET UNITYSDK_OFFSET(0x1951DD60)
