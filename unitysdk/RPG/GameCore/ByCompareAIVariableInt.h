...
#define RPG_GAMECORE_BYCOMPAREAIVARIABLEINT_METHOD_4_2CCFBEBAA7AE5E40_OFFSET UNITYSDK_OFFSET(0x19ABC5A0)
#define RPG_GAMECORE_BYCOMPAREAIVARIABLEINT_METHOD_4_6114AB032100408B_OFFSET UNITYSDK_OFFSET(0x19ABC4D0)
#define RPG_GAMECORE_BYCOMPAREAIVARIABLEINT__CTOR_OFFSET UNITYSDK_OFFSET(0x19ABC550)
