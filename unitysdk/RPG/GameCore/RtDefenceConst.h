...
#define RPG_GAMECORE_RTDEFENCECONST_METHOD_2_1A728FF300468132_OFFSET UNITYSDK_OFFSET(0x18E7F820)
#define RPG_GAMECORE_RTDEFENCECONST_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x18E7F710)
#define RPG_GAMECORE_RTDEFENCECONST_METHOD_2_74D707F2BD9CAA6B_OFFSET UNITYSDK_OFFSET(0x18E7F1A0)
#define RPG_GAMECORE_RTDEFENCECONST_METHOD_2_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x18E7F790)
#define RPG_GAMECORE_RTDEFENCECONST_METHOD_2_ABE7CF9FA1B8CCA3_OFFSET UNITYSDK_OFFSET(0x18E7F8D0)
#define RPG_GAMECORE_RTDEFENCECONST_METHOD_2_B74F0266CBEA732F_1_OFFSET UNITYSDK_OFFSET(0x18E7FBD0)
#define RPG_GAMECORE_RTDEFENCECONST_METHOD_2_B74F0266CBEA732F_OFFSET UNITYSDK_OFFSET(0x18E7FB90)
#define RPG_GAMECORE_RTDEFENCECONST_METHOD_2_CAE8AAD9168F42A0_OFFSET UNITYSDK_OFFSET(0x18E7FC10)
#define RPG_GAMECORE_RTDEFENCECONST_METHOD_2_D83796106DF8E5C5_OFFSET UNITYSDK_OFFSET(0x18E7F7B0)
#define RPG_GAMECORE_RTDEFENCECONST_METHOD_2_EC24AC00C231F088_OFFSET UNITYSDK_OFFSET(0x18E7FB60)
#define RPG_GAMECORE_RTDEFENCECONST_METHOD_2_F0254ADFF2A2C22F_OFFSET UNITYSDK_OFFSET(0x18E7FA30)
#define RPG_GAMECORE_RTDEFENCECONST__CTOR_OFFSET UNITYSDK_OFFSET(0x18E7F640)
...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::RPG::GameCore::RtDefenceConst**)Il2CppClass::FromTypeDefinitionIndex(RtDefenceConst_TypeDefinitionIndex)->GetStaticField(0x35190);
		}
