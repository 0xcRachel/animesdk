...
#define RPG_GAMECORE_AIVARIABLESTRING_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x198839A0)
#define RPG_GAMECORE_AIVARIABLESTRING_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x198838F0)
#define RPG_GAMECORE_AIVARIABLESTRING_EQUALS_OFFSET UNITYSDK_OFFSET(0x198838A0)
#define RPG_GAMECORE_AIVARIABLESTRING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19883A60)
#define RPG_GAMECORE_AIVARIABLESTRING_METHOD_3_137C60875DC60289_OFFSET UNITYSDK_OFFSET(0x19882510)
#define RPG_GAMECORE_AIVARIABLESTRING_METHOD_3_6ED46C6A6D4D2AC6_OFFSET UNITYSDK_OFFSET(0x19883870)
#define RPG_GAMECORE_AIVARIABLESTRING_METHOD_3_9970F33A5835AE4F_1_OFFSET UNITYSDK_OFFSET(0x19883BF0)
#define RPG_GAMECORE_AIVARIABLESTRING_METHOD_3_9970F33A5835AE4F_OFFSET UNITYSDK_OFFSET(0x19883BB0)
#define RPG_GAMECORE_AIVARIABLESTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x19882500)
