...
#define RPG_GAMECORE_AIVARIABLESTRING_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x188575F0)
#define RPG_GAMECORE_AIVARIABLESTRING_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x18857530)
#define RPG_GAMECORE_AIVARIABLESTRING_EQUALS_OFFSET UNITYSDK_OFFSET(0x188574E0)
#define RPG_GAMECORE_AIVARIABLESTRING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x188576B0)
#define RPG_GAMECORE_AIVARIABLESTRING_METHOD_3_137C60875DC60289_OFFSET UNITYSDK_OFFSET(0x18856390)
#define RPG_GAMECORE_AIVARIABLESTRING_METHOD_3_6ED46C6A6D4D2AC6_OFFSET UNITYSDK_OFFSET(0x188574B0)
#define RPG_GAMECORE_AIVARIABLESTRING_METHOD_3_9970F33A5835AE4F_1_OFFSET UNITYSDK_OFFSET(0x18857840)
#define RPG_GAMECORE_AIVARIABLESTRING_METHOD_3_9970F33A5835AE4F_OFFSET UNITYSDK_OFFSET(0x18857800)
#define RPG_GAMECORE_AIVARIABLESTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x18856380)
