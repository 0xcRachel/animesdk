...
#define RPG_GAMECORE_GRIDFIGHTPENALTYRULECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A1B52F0)
#define RPG_GAMECORE_GRIDFIGHTPENALTYRULECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1B5680)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 ThresholdPosition; // 0x24
		...
		::System::UInt32 ThresholdFailPlayerHPPenalty; // 0x44
