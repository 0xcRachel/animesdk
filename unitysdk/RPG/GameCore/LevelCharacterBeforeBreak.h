...
#define RPG_GAMECORE_LEVELCHARACTERBEFOREBREAK_CLEAR_OFFSET UNITYSDK_OFFSET(0xA44DE20)
#define RPG_GAMECORE_LEVELCHARACTERBEFOREBREAK_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA44DEC0)
#define RPG_GAMECORE_LEVELCHARACTERBEFOREBREAK_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA44DE70)
#define RPG_GAMECORE_LEVELCHARACTERBEFOREBREAK_INIT_OFFSET UNITYSDK_OFFSET(0xA44DDB0)
#define RPG_GAMECORE_LEVELCHARACTERBEFOREBREAK__CTOR_OFFSET UNITYSDK_OFFSET(0xA44DF10)
#define RPG_GAMECORE_LEVELCHARACTERBEFOREBREAK___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0xA44DF20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelCharacterBeforeBreak_TypeDefinitionIndex = 44634;
