...
#define RPG_GAMECORE_MAINMISSIONPARTIALINFOCONFIG_METHOD_2_C1F17315E1F138F5_OFFSET UNITYSDK_OFFSET(0x18FD3430)
#define RPG_GAMECORE_MAINMISSIONPARTIALINFOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18FD3530)
