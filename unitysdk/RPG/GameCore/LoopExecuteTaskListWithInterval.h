...
#define RPG_GAMECORE_LOOPEXECUTETASKLISTWITHINTERVAL_METHOD_4_CE9610C5CBC8C2EE_OFFSET UNITYSDK_OFFSET(0x18FCE800)
#define RPG_GAMECORE_LOOPEXECUTETASKLISTWITHINTERVAL_METHOD_4_DF1F618BD86E1EFC_OFFSET UNITYSDK_OFFSET(0x18FCE600)
#define RPG_GAMECORE_LOOPEXECUTETASKLISTWITHINTERVAL__CTOR_OFFSET UNITYSDK_OFFSET(0x18FCE580)
