...
#define RPG_GAMECORE_LOOPEXECUTETASKLISTWITHINTERVAL_METHOD_4_CE9610C5CBC8C2EE_OFFSET UNITYSDK_OFFSET(0x17384830)
#define RPG_GAMECORE_LOOPEXECUTETASKLISTWITHINTERVAL_METHOD_4_DF1F618BD86E1EFC_OFFSET UNITYSDK_OFFSET(0x17384630)
#define RPG_GAMECORE_LOOPEXECUTETASKLISTWITHINTERVAL__CTOR_OFFSET UNITYSDK_OFFSET(0x173845B0)
