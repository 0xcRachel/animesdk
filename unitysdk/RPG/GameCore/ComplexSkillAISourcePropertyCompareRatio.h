...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEPROPERTYCOMPARERATIO_METHOD_3_2C8A785055FA93C6_OFFSET UNITYSDK_OFFSET(0x1713BDB0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEPROPERTYCOMPARERATIO_METHOD_3_4C6835BF10A42C2F_OFFSET UNITYSDK_OFFSET(0x1713D6E0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEPROPERTYCOMPARERATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x1713BD90)
