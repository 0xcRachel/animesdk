...
#define RPG_GAMECORE_SINGLETIMEREWINDENTITYANIMSTATEEVENTCONFIG_METHOD_3_3E11F818A1B232EA_OFFSET UNITYSDK_OFFSET(0x1771FC20)
#define RPG_GAMECORE_SINGLETIMEREWINDENTITYANIMSTATEEVENTCONFIG_METHOD_3_A8BDCC33916EF3AD_OFFSET UNITYSDK_OFFSET(0x1771FF10)
#define RPG_GAMECORE_SINGLETIMEREWINDENTITYANIMSTATEEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1771FC10)
