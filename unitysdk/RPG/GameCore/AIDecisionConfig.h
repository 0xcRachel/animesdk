...
#define RPG_GAMECORE_AIDECISIONCONFIG_METHOD_4_0410081A58D88259_OFFSET UNITYSDK_OFFSET(0x1676FF40)
#define RPG_GAMECORE_AIDECISIONCONFIG_METHOD_4_2ED7CA096FCB1D0E_OFFSET UNITYSDK_OFFSET(0x1676FF00)
#define RPG_GAMECORE_AIDECISIONCONFIG_METHOD_4_CF75B9F7101F576B_OFFSET UNITYSDK_OFFSET(0x1676F5E0)
#define RPG_GAMECORE_AIDECISIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1676F5D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIDecisionConfig_TypeDefinitionIndex = 14064;
