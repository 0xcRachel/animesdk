...
#define RPG_GAMECORE_HEARTDIALEMOBLACKLIST_METHOD_3_10DD8A4DD499BB5A_OFFSET UNITYSDK_OFFSET(0x16B5DAE0)
#define RPG_GAMECORE_HEARTDIALEMOBLACKLIST_METHOD_3_21ADAD514C2F805D_OFFSET UNITYSDK_OFFSET(0x16B5DA60)
#define RPG_GAMECORE_HEARTDIALEMOBLACKLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x16B5DAB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HeartDialEmoBlackList_TypeDefinitionIndex = 18999;
