...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIRFIREMISSLE_METHOD_4_426BB5F7C7E81B20_OFFSET UNITYSDK_OFFSET(0x1A121530)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIRFIREMISSLE_METHOD_4_BEFAE6D75EB5BBA9_OFFSET UNITYSDK_OFFSET(0x1A1215B0)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIRFIREMISSLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A121580)
