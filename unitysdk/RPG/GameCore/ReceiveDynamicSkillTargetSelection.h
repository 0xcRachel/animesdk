...
#define RPG_GAMECORE_RECEIVEDYNAMICSKILLTARGETSELECTION_METHOD_3_B3CFA5D43F18F507_OFFSET UNITYSDK_OFFSET(0x19012CE0)
#define RPG_GAMECORE_RECEIVEDYNAMICSKILLTARGETSELECTION_METHOD_3_CDFD790CFD92C689_OFFSET UNITYSDK_OFFSET(0x19012D60)
#define RPG_GAMECORE_RECEIVEDYNAMICSKILLTARGETSELECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19012D30)
