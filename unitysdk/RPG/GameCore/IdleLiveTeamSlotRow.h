...
#define RPG_GAMECORE_IDLELIVETEAMSLOTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18887620)
#define RPG_GAMECORE_IDLELIVETEAMSLOTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18887910)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::ILBattleCharacterLocation Type; // 0x38
		::RPG::GameCore::FixPoint SlotPowerFactor; // 0x40
