...
#define RPG_GAMECORE_IDLELIVETEAMSLOTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19ADC250)
#define RPG_GAMECORE_IDLELIVETEAMSLOTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19ADC540)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::RPG::Client::TextID UnlockHint; // 0x10
		::RPG::GameCore::FixPoint SlotPowerFactor; // 0x20
		::System::UInt32 UnlockID; // 0x28
		::System::UInt32 Slot; // 0x2C
