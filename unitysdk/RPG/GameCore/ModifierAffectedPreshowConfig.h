...
#define RPG_GAMECORE_MODIFIERAFFECTEDPRESHOWCONFIG_METHOD_2_3118456B80A4D68E_OFFSET UNITYSDK_OFFSET(0x17439EB0)
#define RPG_GAMECORE_MODIFIERAFFECTEDPRESHOWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1743A1A0)
