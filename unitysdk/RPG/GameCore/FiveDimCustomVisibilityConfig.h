...
#define RPG_GAMECORE_FIVEDIMCUSTOMVISIBILITYCONFIG_METHOD_3_296F3507F4BB6036_OFFSET UNITYSDK_OFFSET(0x16AB8C90)
#define RPG_GAMECORE_FIVEDIMCUSTOMVISIBILITYCONFIG_METHOD_3_60F474BD0EB5809D_OFFSET UNITYSDK_OFFSET(0x16AB8BD0)
#define RPG_GAMECORE_FIVEDIMCUSTOMVISIBILITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16AB8C40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimCustomVisibilityConfig_TypeDefinitionIndex = 16698;
