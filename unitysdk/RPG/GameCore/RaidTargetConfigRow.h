...
#define RPG_GAMECORE_RAIDTARGETCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19AA85F0)
#define RPG_GAMECORE_RAIDTARGETCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19AA8FF0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::RaidTargetType TargetType; // 0x2C
		::RPG::GameCore::ParamType ParamType; // 0x30
		::System::Boolean IsInBattle; // 0x34
		::RPG::Client::TextID TargetNameSimple; // 0x38
		::System::UInt32 TargetParam1; // 0x48
