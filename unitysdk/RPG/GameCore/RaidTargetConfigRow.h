...
#define RPG_GAMECORE_RAIDTARGETCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1900C600)
#define RPG_GAMECORE_RAIDTARGETCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1900CFB0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 TargetParam2; // 0x38
		::RPG::GameCore::RaidTargetType TargetType; // 0x3C
