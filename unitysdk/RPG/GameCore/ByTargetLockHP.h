...
#define RPG_GAMECORE_BYTARGETLOCKHP_METHOD_4_76D9186D63DAC3CA_OFFSET UNITYSDK_OFFSET(0x169401D0)
#define RPG_GAMECORE_BYTARGETLOCKHP_METHOD_4_B39726CB584BD856_OFFSET UNITYSDK_OFFSET(0x169400F0)
#define RPG_GAMECORE_BYTARGETLOCKHP__CTOR_OFFSET UNITYSDK_OFFSET(0x16940170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByTargetLockHP_TypeDefinitionIndex = 21300;
