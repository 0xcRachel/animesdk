...
#define RPG_GAMECORE_STACKREDSTANCE_METHOD_3_27ADA3143CBEE4F5_OFFSET UNITYSDK_OFFSET(0x19333730)
#define RPG_GAMECORE_STACKREDSTANCE_METHOD_3_FFB439DE3F486B6E_OFFSET UNITYSDK_OFFSET(0x193336B0)
#define RPG_GAMECORE_STACKREDSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x19333700)
