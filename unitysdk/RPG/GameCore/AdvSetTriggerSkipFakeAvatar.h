...
#define RPG_GAMECORE_ADVSETTRIGGERSKIPFAKEAVATAR_METHOD_3_17F58BF9A790CBDB_OFFSET UNITYSDK_OFFSET(0x16849E40)
#define RPG_GAMECORE_ADVSETTRIGGERSKIPFAKEAVATAR_METHOD_3_E4E584405167C39D_OFFSET UNITYSDK_OFFSET(0x16849CF0)
#define RPG_GAMECORE_ADVSETTRIGGERSKIPFAKEAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x16849DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetTriggerSkipFakeAvatar_TypeDefinitionIndex = 18309;
