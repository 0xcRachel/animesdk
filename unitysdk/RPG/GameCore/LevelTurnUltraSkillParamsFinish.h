...
#define RPG_GAMECORE_LEVELTURNULTRASKILLPARAMSFINISH_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA99F570)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPARAMSFINISH_GETINSERTULTRASKILLPARAMS_OFFSET UNITYSDK_OFFSET(0xA99F5C0)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPARAMSFINISH_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA99F520)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPARAMSFINISH_INIT_OFFSET UNITYSDK_OFFSET(0xA99F4D0)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPARAMSFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0xA99F600)
