...
#define RPG_GAMECORE_LEVELTURNULTRASKILLPARAMSFINISH_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA4AE940)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPARAMSFINISH_GETINSERTULTRASKILLPARAMS_OFFSET UNITYSDK_OFFSET(0xA4AE990)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPARAMSFINISH_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA4AE8F0)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPARAMSFINISH_INIT_OFFSET UNITYSDK_OFFSET(0xA4AE8A0)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPARAMSFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0xA4AE9D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelTurnUltraSkillParamsFinish_TypeDefinitionIndex = 44557;
