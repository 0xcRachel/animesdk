...
#define RPG_GAMECORE_MATCHTHREECREATELEVEL_METHOD_3_4866E6AA21EEA333_OFFSET UNITYSDK_OFFSET(0x173C41E0)
#define RPG_GAMECORE_MATCHTHREECREATELEVEL_METHOD_3_8E9FF66750686E24_OFFSET UNITYSDK_OFFSET(0x173C4160)
#define RPG_GAMECORE_MATCHTHREECREATELEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x173C41B0)
