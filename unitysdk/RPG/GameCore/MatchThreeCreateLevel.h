...
#define RPG_GAMECORE_MATCHTHREECREATELEVEL_METHOD_3_4866E6AA21EEA333_OFFSET UNITYSDK_OFFSET(0x18C35CC0)
#define RPG_GAMECORE_MATCHTHREECREATELEVEL_METHOD_3_8E9FF66750686E24_OFFSET UNITYSDK_OFFSET(0x18C35C40)
#define RPG_GAMECORE_MATCHTHREECREATELEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x18C35C90)
