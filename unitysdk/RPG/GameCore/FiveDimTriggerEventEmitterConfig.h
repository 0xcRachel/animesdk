...
#define RPG_GAMECORE_FIVEDIMTRIGGEREVENTEMITTERCONFIG_METHOD_3_DFCDE6EC76E14CEE_OFFSET UNITYSDK_OFFSET(0x16AD9200)
#define RPG_GAMECORE_FIVEDIMTRIGGEREVENTEMITTERCONFIG_METHOD_3_E5C7901BDF7B3CBF_OFFSET UNITYSDK_OFFSET(0x16AD9290)
#define RPG_GAMECORE_FIVEDIMTRIGGEREVENTEMITTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16AD9260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimTriggerEventEmitterConfig_TypeDefinitionIndex = 16728;
