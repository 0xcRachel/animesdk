...
#define RPG_GAMECORE_FIVEDIMTRIGGEREVENTEMITTERCONFIG_METHOD_3_0CDA0D8D622758FA_OFFSET UNITYSDK_OFFSET(0x1A3A9B00)
#define RPG_GAMECORE_FIVEDIMTRIGGEREVENTEMITTERCONFIG_METHOD_3_675DA2D9E094A000_OFFSET UNITYSDK_OFFSET(0x1A3A9CA0)
#define RPG_GAMECORE_FIVEDIMTRIGGEREVENTEMITTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3A4870)
