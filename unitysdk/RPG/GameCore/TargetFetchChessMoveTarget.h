...
#define RPG_GAMECORE_TARGETFETCHCHESSMOVETARGET_METHOD_4_196CAF261AAA51BD_OFFSET UNITYSDK_OFFSET(0x16FDC930)
#define RPG_GAMECORE_TARGETFETCHCHESSMOVETARGET_METHOD_4_98951F7E8C17894B_OFFSET UNITYSDK_OFFSET(0x16FD57E0)
#define RPG_GAMECORE_TARGETFETCHCHESSMOVETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD5760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchChessMoveTarget_TypeDefinitionIndex = 21605;
