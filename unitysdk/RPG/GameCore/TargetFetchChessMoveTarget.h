...
#define RPG_GAMECORE_TARGETFETCHCHESSMOVETARGET_METHOD_4_196CAF261AAA51BD_OFFSET UNITYSDK_OFFSET(0x177D2280)
#define RPG_GAMECORE_TARGETFETCHCHESSMOVETARGET_METHOD_4_98951F7E8C17894B_OFFSET UNITYSDK_OFFSET(0x177C8480)
#define RPG_GAMECORE_TARGETFETCHCHESSMOVETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x177C8400)
