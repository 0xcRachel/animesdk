...
#define RPG_GAMECORE_SETUPMODIFIEREXTRAMAXLAYER_METHOD_3_0948C4EF066D6C89_OFFSET UNITYSDK_OFFSET(0x19FF2000)
#define RPG_GAMECORE_SETUPMODIFIEREXTRAMAXLAYER_METHOD_3_9B61A110AFDF3D56_OFFSET UNITYSDK_OFFSET(0x19FF1F80)
#define RPG_GAMECORE_SETUPMODIFIEREXTRAMAXLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x19FF1FD0)
