...
#define RPG_GAMECORE_STOPDITHERCLOSE_METHOD_3_AC67BA2DDBE82E73_OFFSET UNITYSDK_OFFSET(0x17791590)
#define RPG_GAMECORE_STOPDITHERCLOSE_METHOD_3_EA60A0D1B8646DAA_OFFSET UNITYSDK_OFFSET(0x17791610)
#define RPG_GAMECORE_STOPDITHERCLOSE__CTOR_OFFSET UNITYSDK_OFFSET(0x177915E0)
