...
#define RPG_GAMECORE_CREATECURVEPROPGROUPPUZZLE_METHOD_3_A0DC18EB86818222_OFFSET UNITYSDK_OFFSET(0x19B1EA80)
#define RPG_GAMECORE_CREATECURVEPROPGROUPPUZZLE_METHOD_3_DFD0217B2832625C_OFFSET UNITYSDK_OFFSET(0x19B1EB00)
#define RPG_GAMECORE_CREATECURVEPROPGROUPPUZZLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19B1EAD0)
