...
#define RPG_GAMECORE_CREATECURVEPROPGROUPPUZZLE_METHOD_3_A0DC18EB86818222_OFFSET UNITYSDK_OFFSET(0x17150040)
#define RPG_GAMECORE_CREATECURVEPROPGROUPPUZZLE_METHOD_3_DFD0217B2832625C_OFFSET UNITYSDK_OFFSET(0x171500C0)
#define RPG_GAMECORE_CREATECURVEPROPGROUPPUZZLE__CTOR_OFFSET UNITYSDK_OFFSET(0x17150090)
