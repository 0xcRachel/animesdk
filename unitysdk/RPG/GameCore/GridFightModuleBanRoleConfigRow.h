...
#define RPG_GAMECORE_GRIDFIGHTMODULEBANROLECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B34D20)
#define RPG_GAMECORE_GRIDFIGHTMODULEBANROLECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B34E40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModuleBanRoleConfigRow_TypeDefinitionIndex = 12246;
