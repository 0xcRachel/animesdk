...
#define RPG_GAMECORE_AICOMPOSESELECTOR_METHOD_3_13E768942A8B1625_OFFSET UNITYSDK_OFFSET(0x1676EBC0)
#define RPG_GAMECORE_AICOMPOSESELECTOR_METHOD_3_C6ECFC54CB4EA422_OFFSET UNITYSDK_OFFSET(0x1676EB80)
#define RPG_GAMECORE_AICOMPOSESELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1676EBB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIComposeSelector_TypeDefinitionIndex = 14170;
