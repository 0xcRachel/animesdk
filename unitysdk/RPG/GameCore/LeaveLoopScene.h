...
#define RPG_GAMECORE_LEAVELOOPSCENE_METHOD_3_4BC304D2E1815C80_OFFSET UNITYSDK_OFFSET(0x16B9D4D0)
#define RPG_GAMECORE_LEAVELOOPSCENE_METHOD_3_738797A5F58EB634_OFFSET UNITYSDK_OFFSET(0x16B9D3C0)
#define RPG_GAMECORE_LEAVELOOPSCENE__CTOR_OFFSET UNITYSDK_OFFSET(0x16B9D4A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LeaveLoopScene_TypeDefinitionIndex = 18209;
