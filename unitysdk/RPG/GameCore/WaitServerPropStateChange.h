...
#define RPG_GAMECORE_WAITSERVERPROPSTATECHANGE_METHOD_3_C06AE5E12ED00814_OFFSET UNITYSDK_OFFSET(0x1A6541F0)
#define RPG_GAMECORE_WAITSERVERPROPSTATECHANGE_METHOD_3_ECCCEAEC04AAA89B_OFFSET UNITYSDK_OFFSET(0x1A654260)
#define RPG_GAMECORE_WAITSERVERPROPSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A654230)
