...
#define RPG_GAMECORE_WAITSERVERPROPSTATECHANGE_METHOD_3_C06AE5E12ED00814_OFFSET UNITYSDK_OFFSET(0x1715C980)
#define RPG_GAMECORE_WAITSERVERPROPSTATECHANGE_METHOD_3_ECCCEAEC04AAA89B_OFFSET UNITYSDK_OFFSET(0x1715C9F0)
#define RPG_GAMECORE_WAITSERVERPROPSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1715C9C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitServerPropStateChange_TypeDefinitionIndex = 19007;
