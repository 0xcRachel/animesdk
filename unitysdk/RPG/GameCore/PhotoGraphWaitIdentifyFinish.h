...
#define RPG_GAMECORE_PHOTOGRAPHWAITIDENTIFYFINISH_METHOD_3_3A148666410E3256_OFFSET UNITYSDK_OFFSET(0x16D3A1D0)
#define RPG_GAMECORE_PHOTOGRAPHWAITIDENTIFYFINISH_METHOD_3_3F10581D785A4A33_OFFSET UNITYSDK_OFFSET(0x16D3A150)
#define RPG_GAMECORE_PHOTOGRAPHWAITIDENTIFYFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x16D3A1A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphWaitIdentifyFinish_TypeDefinitionIndex = 19301;
