...
#define RPG_GAMECORE_PHOTOGRAPHWAITIDENTIFYFINISH_METHOD_3_3A148666410E3256_OFFSET UNITYSDK_OFFSET(0x174C2020)
#define RPG_GAMECORE_PHOTOGRAPHWAITIDENTIFYFINISH_METHOD_3_3F10581D785A4A33_OFFSET UNITYSDK_OFFSET(0x174C1FA0)
#define RPG_GAMECORE_PHOTOGRAPHWAITIDENTIFYFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x174C1FF0)
