...
#define RPG_GAMECORE_BYCOMPAREFSVWITHGP_METHOD_4_418347DE1A47B068_OFFSET UNITYSDK_OFFSET(0x1701C4F0)
#define RPG_GAMECORE_BYCOMPAREFSVWITHGP_METHOD_4_434BC6E1D0C79FEE_OFFSET UNITYSDK_OFFSET(0x1701C410)
#define RPG_GAMECORE_BYCOMPAREFSVWITHGP__CTOR_OFFSET UNITYSDK_OFFSET(0x1701C490)
