...
#define RPG_GAMECORE_BYCOMPAREFSVWITHGP_METHOD_4_418347DE1A47B068_OFFSET UNITYSDK_OFFSET(0x1690B6C0)
#define RPG_GAMECORE_BYCOMPAREFSVWITHGP_METHOD_4_434BC6E1D0C79FEE_OFFSET UNITYSDK_OFFSET(0x1690B5E0)
#define RPG_GAMECORE_BYCOMPAREFSVWITHGP__CTOR_OFFSET UNITYSDK_OFFSET(0x1690B660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareFSVwithGP_TypeDefinitionIndex = 18219;
