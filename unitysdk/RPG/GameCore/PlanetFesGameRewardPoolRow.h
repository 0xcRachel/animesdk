...
#define RPG_GAMECORE_PLANETFESGAMEREWARDPOOLROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19D4CBA0)
#define RPG_GAMECORE_PLANETFESGAMEREWARDPOOLROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19D4CD50)
