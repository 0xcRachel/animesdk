...
#define RPG_GAMECORE_BYCOMPAREALERTVALUE_METHOD_4_DC937188A25C69AA_OFFSET UNITYSDK_OFFSET(0x16905840)
#define RPG_GAMECORE_BYCOMPAREALERTVALUE_METHOD_4_FE3E1B0F91D61ED6_OFFSET UNITYSDK_OFFSET(0x16905910)
#define RPG_GAMECORE_BYCOMPAREALERTVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x169058C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareAlertValue_TypeDefinitionIndex = 18576;
