...
#define RPG_GAMECORE_DAMAGEBYATTACKPROPERTY_METHOD_3_26CD3EED7D0FB26D_OFFSET UNITYSDK_OFFSET(0x1715B680)
#define RPG_GAMECORE_DAMAGEBYATTACKPROPERTY_METHOD_3_8A32FD65A5CB3972_OFFSET UNITYSDK_OFFSET(0x1715B550)
#define RPG_GAMECORE_DAMAGEBYATTACKPROPERTY_SHAREBYCOPY_OFFSET UNITYSDK_OFFSET(0x1715C1C0)
#define RPG_GAMECORE_DAMAGEBYATTACKPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1715B600)
