...
#define RPG_GAMECORE_CHIMERADUELBUFFCASTERSELECTORCONFIG_METHOD_3_31048B86FB2E6111_OFFSET UNITYSDK_OFFSET(0x196B2460)
#define RPG_GAMECORE_CHIMERADUELBUFFCASTERSELECTORCONFIG_METHOD_3_339B613F449DED3C_OFFSET UNITYSDK_OFFSET(0x196B23C0)
#define RPG_GAMECORE_CHIMERADUELBUFFCASTERSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x196B2450)
