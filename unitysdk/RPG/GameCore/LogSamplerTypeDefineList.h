...
#define RPG_GAMECORE_LOGSAMPLERTYPEDEFINELIST_METHOD_2_78727830B1D1A950_OFFSET UNITYSDK_OFFSET(0x17382510)
#define RPG_GAMECORE_LOGSAMPLERTYPEDEFINELIST__CTOR_OFFSET UNITYSDK_OFFSET(0x17382610)
