...
#define RPG_GAMECORE_ADVNPCCHASE_METHOD_3_7C5EA4D0B6671437_OFFSET UNITYSDK_OFFSET(0x1683AEF0)
#define RPG_GAMECORE_ADVNPCCHASE_METHOD_3_F858BCF12B5500D1_OFFSET UNITYSDK_OFFSET(0x1683AF70)
#define RPG_GAMECORE_ADVNPCCHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1683AF40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNPCChase_TypeDefinitionIndex = 17734;
