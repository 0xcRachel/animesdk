...
#define RPG_GAMECORE_PROPWORMCOMPASSSETITEMVISIBLE_METHOD_3_9041D684094AC502_OFFSET UNITYSDK_OFFSET(0x16DBB1A0)
#define RPG_GAMECORE_PROPWORMCOMPASSSETITEMVISIBLE_METHOD_3_B7DE62B233F1AEFF_OFFSET UNITYSDK_OFFSET(0x16DBB2F0)
#define RPG_GAMECORE_PROPWORMCOMPASSSETITEMVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16DBB260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropWormCompassSetItemVisible_TypeDefinitionIndex = 19813;
