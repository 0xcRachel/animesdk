...
#define RPG_GAMECORE_PROPWORMCOMPASSSETITEMVISIBLE_METHOD_3_9041D684094AC502_OFFSET UNITYSDK_OFFSET(0x175871C0)
#define RPG_GAMECORE_PROPWORMCOMPASSSETITEMVISIBLE_METHOD_3_B7DE62B233F1AEFF_OFFSET UNITYSDK_OFFSET(0x17587310)
#define RPG_GAMECORE_PROPWORMCOMPASSSETITEMVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x17587280)
