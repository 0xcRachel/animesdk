...
#define RPG_GAMECORE_REMOVESHIELD_METHOD_3_C433C03D0519ADA7_OFFSET UNITYSDK_OFFSET(0x190293E0)
#define RPG_GAMECORE_REMOVESHIELD_METHOD_3_EC78E1BACBBB3383_OFFSET UNITYSDK_OFFSET(0x19029360)
#define RPG_GAMECORE_REMOVESHIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x190293B0)
