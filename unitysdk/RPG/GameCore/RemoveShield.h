...
#define RPG_GAMECORE_REMOVESHIELD_METHOD_3_C433C03D0519ADA7_OFFSET UNITYSDK_OFFSET(0x16DE0CA0)
#define RPG_GAMECORE_REMOVESHIELD_METHOD_3_EC78E1BACBBB3383_OFFSET UNITYSDK_OFFSET(0x16DE0C20)
#define RPG_GAMECORE_REMOVESHIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x16DE0C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveShield_TypeDefinitionIndex = 21282;
