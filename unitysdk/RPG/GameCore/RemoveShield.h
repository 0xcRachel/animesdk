...
#define RPG_GAMECORE_REMOVESHIELD_METHOD_3_C433C03D0519ADA7_OFFSET UNITYSDK_OFFSET(0x175ADE10)
#define RPG_GAMECORE_REMOVESHIELD_METHOD_3_EC78E1BACBBB3383_OFFSET UNITYSDK_OFFSET(0x175ADD90)
#define RPG_GAMECORE_REMOVESHIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x175ADDE0)
