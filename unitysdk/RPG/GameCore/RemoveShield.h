...
#define RPG_GAMECORE_REMOVESHIELD_METHOD_3_C433C03D0519ADA7_OFFSET UNITYSDK_OFFSET(0x1A2E8C20)
#define RPG_GAMECORE_REMOVESHIELD_METHOD_3_EC78E1BACBBB3383_OFFSET UNITYSDK_OFFSET(0x1A2E8BA0)
#define RPG_GAMECORE_REMOVESHIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2E8BF0)
