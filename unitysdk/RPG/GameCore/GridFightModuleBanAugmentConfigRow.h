...
#define RPG_GAMECORE_GRIDFIGHTMODULEBANAUGMENTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A1A85D0)
#define RPG_GAMECORE_GRIDFIGHTMODULEBANAUGMENTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1A86F0)
