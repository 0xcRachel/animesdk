...
#define RPG_GAMECORE_MUNICIPALCHATACTIONEMOJI_METHOD_3_AEE6F8FE456CFD56_OFFSET UNITYSDK_OFFSET(0x1746F5A0)
#define RPG_GAMECORE_MUNICIPALCHATACTIONEMOJI_METHOD_3_FC8B32ECE1E5F318_OFFSET UNITYSDK_OFFSET(0x17470110)
#define RPG_GAMECORE_MUNICIPALCHATACTIONEMOJI__CTOR_OFFSET UNITYSDK_OFFSET(0x1746F580)
