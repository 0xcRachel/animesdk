...
#define RPG_GAMECORE_MUNICIPALCHATACTIONEMOJI_METHOD_3_AEE6F8FE456CFD56_OFFSET UNITYSDK_OFFSET(0x16CE8CB0)
#define RPG_GAMECORE_MUNICIPALCHATACTIONEMOJI_METHOD_3_FC8B32ECE1E5F318_OFFSET UNITYSDK_OFFSET(0x16CE9820)
#define RPG_GAMECORE_MUNICIPALCHATACTIONEMOJI__CTOR_OFFSET UNITYSDK_OFFSET(0x16CE8C90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MunicipalChatActionEmoji_TypeDefinitionIndex = 15238;
