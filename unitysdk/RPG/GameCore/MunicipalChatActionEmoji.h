...
#define RPG_GAMECORE_MUNICIPALCHATACTIONEMOJI_METHOD_3_109139A4EDA7C9E0_OFFSET UNITYSDK_OFFSET(0x190EF1E0)
#define RPG_GAMECORE_MUNICIPALCHATACTIONEMOJI_METHOD_3_82BC65BD5711027A_OFFSET UNITYSDK_OFFSET(0x190EFD60)
#define RPG_GAMECORE_MUNICIPALCHATACTIONEMOJI__CTOR_OFFSET UNITYSDK_OFFSET(0x190EF1C0)
