...
#define RPG_GAMECORE_LOCKVERSUSBAR_METHOD_3_4383D0040E087E29_OFFSET UNITYSDK_OFFSET(0x16BDD740)
#define RPG_GAMECORE_LOCKVERSUSBAR_METHOD_3_B313798818AC2870_OFFSET UNITYSDK_OFFSET(0x16BDD7C0)
#define RPG_GAMECORE_LOCKVERSUSBAR__CTOR_OFFSET UNITYSDK_OFFSET(0x16BDD790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockVersusBar_TypeDefinitionIndex = 20823;
