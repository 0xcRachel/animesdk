...
#define RPG_GAMECORE_SETIMMEDIATEACTION_METHOD_3_4151398365890025_OFFSET UNITYSDK_OFFSET(0x16F30E30)
#define RPG_GAMECORE_SETIMMEDIATEACTION_METHOD_3_D856E43DA79D43B4_OFFSET UNITYSDK_OFFSET(0x16F30DB0)
#define RPG_GAMECORE_SETIMMEDIATEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16F30E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetImmediateAction_TypeDefinitionIndex = 20343;
