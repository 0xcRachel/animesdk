...
#define RPG_GAMECORE_SKIPBILLBOARDMODELVISIBLECHECK_METHOD_3_BE34713A3E64B56F_OFFSET UNITYSDK_OFFSET(0x16F6EB10)
#define RPG_GAMECORE_SKIPBILLBOARDMODELVISIBLECHECK_METHOD_3_CEFBEA75E5C1E4E8_OFFSET UNITYSDK_OFFSET(0x16F6E9C0)
#define RPG_GAMECORE_SKIPBILLBOARDMODELVISIBLECHECK__CTOR_OFFSET UNITYSDK_OFFSET(0x16F6EA80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SkipBillboardModelVisibleCheck_TypeDefinitionIndex = 18242;
