...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACEMAGICUNITAUTOCOMPOSERANDOMCONFIG_METHOD_3_05C43C0511AD7255_OFFSET UNITYSDK_OFFSET(0x17640B10)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACEMAGICUNITAUTOCOMPOSERANDOMCONFIG_METHOD_3_1CC6C70D5EF5757C_OFFSET UNITYSDK_OFFSET(0x1764D490)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACEMAGICUNITAUTOCOMPOSERANDOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17640AC0)
