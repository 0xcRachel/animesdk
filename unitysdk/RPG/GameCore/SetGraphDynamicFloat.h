...
#define RPG_GAMECORE_SETGRAPHDYNAMICFLOAT_METHOD_3_64E3530435C22FAA_OFFSET UNITYSDK_OFFSET(0x199B6AD0)
#define RPG_GAMECORE_SETGRAPHDYNAMICFLOAT_METHOD_3_D2C851B4AAAF2E58_OFFSET UNITYSDK_OFFSET(0x199B6B50)
#define RPG_GAMECORE_SETGRAPHDYNAMICFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x199B6B20)
