...
#define RPG_GAMECORE_DEFINEDYNAMICVALUE_METHOD_3_34BE8C2EDB6D677C_OFFSET UNITYSDK_OFFSET(0x169E9FB0)
#define RPG_GAMECORE_DEFINEDYNAMICVALUE_METHOD_3_A70544D91D0A6910_OFFSET UNITYSDK_OFFSET(0x169EA0D0)
#define RPG_GAMECORE_DEFINEDYNAMICVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x169EA050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DefineDynamicValue_TypeDefinitionIndex = 20546;
