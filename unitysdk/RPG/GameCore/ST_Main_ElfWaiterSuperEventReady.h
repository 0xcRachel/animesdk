...
#define RPG_GAMECORE_ST_MAIN_ELFWAITERSUPEREVENTREADY_METHOD_4_34F1B2ABD5B29E7E_OFFSET UNITYSDK_OFFSET(0x18EA1C20)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERSUPEREVENTREADY_METHOD_4_9948245CCBC5E5A1_OFFSET UNITYSDK_OFFSET(0x18E99B40)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERSUPEREVENTREADY__CTOR_OFFSET UNITYSDK_OFFSET(0x18E99AF0)
