...
#define RPG_GAMECORE_SWORDTRAININGCHECKCANENTERGAME_METHOD_3_052BEF72EEFDA436_OFFSET UNITYSDK_OFFSET(0x16FBBD60)
#define RPG_GAMECORE_SWORDTRAININGCHECKCANENTERGAME_METHOD_3_2D0DB15337367AAA_OFFSET UNITYSDK_OFFSET(0x16FBBCE0)
#define RPG_GAMECORE_SWORDTRAININGCHECKCANENTERGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x16FBBD30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwordTrainingCheckCanEnterGame_TypeDefinitionIndex = 18802;
