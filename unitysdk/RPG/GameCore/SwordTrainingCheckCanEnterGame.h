...
#define RPG_GAMECORE_SWORDTRAININGCHECKCANENTERGAME_METHOD_3_052BEF72EEFDA436_OFFSET UNITYSDK_OFFSET(0x177B01C0)
#define RPG_GAMECORE_SWORDTRAININGCHECKCANENTERGAME_METHOD_3_2D0DB15337367AAA_OFFSET UNITYSDK_OFFSET(0x177B0140)
#define RPG_GAMECORE_SWORDTRAININGCHECKCANENTERGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x177B0190)
