...
#define RPG_GAMECORE_ADDDYNAMICENTITYPARAM_METHOD_3_149836B19B5DF3C0_OFFSET UNITYSDK_OFFSET(0x167B92C0)
#define RPG_GAMECORE_ADDDYNAMICENTITYPARAM_METHOD_3_86345638A5063A8F_OFFSET UNITYSDK_OFFSET(0x167B9240)
#define RPG_GAMECORE_ADDDYNAMICENTITYPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x167B9290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddDynamicEntityParam_TypeDefinitionIndex = 20306;
