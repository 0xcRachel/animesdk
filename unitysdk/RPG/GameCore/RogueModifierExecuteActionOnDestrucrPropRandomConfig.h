...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONDESTRUCRPROPRANDOMCONFIG_METHOD_3_42586542FD522BA6_OFFSET UNITYSDK_OFFSET(0x19982760)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONDESTRUCRPROPRANDOMCONFIG_METHOD_3_95C91190C04AF4CF_OFFSET UNITYSDK_OFFSET(0x1998A0B0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONDESTRUCRPROPRANDOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19982710)
