...
#define RPG_GAMECORE_PINBALLPUZZLEENABLECONTROLMODE_METHOD_3_0AF29308CE27F19B_OFFSET UNITYSDK_OFFSET(0x16D3A8E0)
#define RPG_GAMECORE_PINBALLPUZZLEENABLECONTROLMODE_METHOD_3_56ACA4D59591EF8F_OFFSET UNITYSDK_OFFSET(0x16D3A860)
#define RPG_GAMECORE_PINBALLPUZZLEENABLECONTROLMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x16D3A8B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PinballPuzzleEnableControlMode_TypeDefinitionIndex = 19654;
