...
#define RPG_GAMECORE_PINBALLPUZZLEENABLECONTROLMODE_METHOD_3_0AF29308CE27F19B_OFFSET UNITYSDK_OFFSET(0x174C2730)
#define RPG_GAMECORE_PINBALLPUZZLEENABLECONTROLMODE_METHOD_3_56ACA4D59591EF8F_OFFSET UNITYSDK_OFFSET(0x174C26B0)
#define RPG_GAMECORE_PINBALLPUZZLEENABLECONTROLMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x174C2700)
