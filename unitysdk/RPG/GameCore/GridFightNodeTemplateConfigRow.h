...
#define RPG_GAMECORE_GRIDFIGHTNODETEMPLATECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A1A8CC0)
#define RPG_GAMECORE_GRIDFIGHTNODETEMPLATECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1A8F00)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::GridFightNodeType NodeType; // 0x1C
