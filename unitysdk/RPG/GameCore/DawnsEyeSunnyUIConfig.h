...
#define RPG_GAMECORE_DAWNSEYESUNNYUICONFIG_METHOD_3_0825DC494E24FD9E_OFFSET UNITYSDK_OFFSET(0x1715FE40)
#define RPG_GAMECORE_DAWNSEYESUNNYUICONFIG_METHOD_3_D8AADD6180ECE283_OFFSET UNITYSDK_OFFSET(0x1715FDE0)
#define RPG_GAMECORE_DAWNSEYESUNNYUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1715FE30)
