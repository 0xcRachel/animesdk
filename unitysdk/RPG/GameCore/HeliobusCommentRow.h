...
#define RPG_GAMECORE_HELIOBUSCOMMENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18A6DAA0)
#define RPG_GAMECORE_HELIOBUSCOMMENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18A6E260)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean IsPlayerComment; // 0x1C
		::RPG::GameCore::HeliobusTendencyType Tendency; // 0x20
		::System::UInt32 ReplyIncomeReward; // 0x24
