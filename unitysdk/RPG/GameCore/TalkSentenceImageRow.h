...
#define RPG_GAMECORE_TALKSENTENCEIMAGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19873850)
#define RPG_GAMECORE_TALKSENTENCEIMAGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19874280)
