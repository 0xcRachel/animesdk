...
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMFLOATV2_METHOD_4_10E2416C2EE85552_OFFSET UNITYSDK_OFFSET(0x1690C190)
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMFLOATV2_METHOD_4_93187DA7BA964475_OFFSET UNITYSDK_OFFSET(0x1690C0B0)
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMFLOATV2__CTOR_OFFSET UNITYSDK_OFFSET(0x1690C130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareFloorCustomFloatV2_TypeDefinitionIndex = 18499;
