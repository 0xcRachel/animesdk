...
#define RPG_GAMECORE_ADVENTUREMODIFYTEAMPLAYERHP_METHOD_3_A93BB2FB01F49E2A_OFFSET UNITYSDK_OFFSET(0x1685C900)
#define RPG_GAMECORE_ADVENTUREMODIFYTEAMPLAYERHP_METHOD_3_DE7BF09658ADB6AA_OFFSET UNITYSDK_OFFSET(0x1685C9A0)
#define RPG_GAMECORE_ADVENTUREMODIFYTEAMPLAYERHP__CTOR_OFFSET UNITYSDK_OFFSET(0x1685C960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureModifyTeamPlayerHP_TypeDefinitionIndex = 17944;
