...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_ISATTACKER_METHOD_4_B519913715840E90_OFFSET UNITYSDK_OFFSET(0x1A094930)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_ISATTACKER_METHOD_4_F617AECF70825622_OFFSET UNITYSDK_OFFSET(0x1A092AC0)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_ISATTACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A092A70)
