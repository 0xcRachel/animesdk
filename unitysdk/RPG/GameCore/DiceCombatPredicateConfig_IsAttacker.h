...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_ISATTACKER_METHOD_4_32015C2B300523BE_OFFSET UNITYSDK_OFFSET(0x19599C50)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_ISATTACKER_METHOD_4_AC0DBC0E841D84B0_OFFSET UNITYSDK_OFFSET(0x19597DE0)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_ISATTACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x19597D90)
