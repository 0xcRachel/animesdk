...
#define RPG_GAMECORE_BYNPCSTATUS_METHOD_4_977051FB2530E9BB_OFFSET UNITYSDK_OFFSET(0x16939A30)
#define RPG_GAMECORE_BYNPCSTATUS_METHOD_4_A2031675BF4F6A77_OFFSET UNITYSDK_OFFSET(0x16939B00)
#define RPG_GAMECORE_BYNPCSTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x16939AB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByNPCStatus_TypeDefinitionIndex = 17794;
