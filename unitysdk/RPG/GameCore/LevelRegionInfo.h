...
#define RPG_GAMECORE_LEVELREGIONINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16BBC5F0)
#define RPG_GAMECORE_LEVELREGIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16BBC780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelRegionInfo_TypeDefinitionIndex = 15697;
