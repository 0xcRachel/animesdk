...
#define RPG_GAMECORE_MENUSTATECONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16C7E040)
#define RPG_GAMECORE_MENUSTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16C7E240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MenuStateConfig_TypeDefinitionIndex = 14742;
