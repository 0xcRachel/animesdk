...
#define RPG_GAMECORE_ADVFILTERNEARBYMONSTERS_METHOD_3_00CA38B22DA54640_OFFSET UNITYSDK_OFFSET(0x16835660)
#define RPG_GAMECORE_ADVFILTERNEARBYMONSTERS_METHOD_3_6CAA3F5049DE1E39_OFFSET UNITYSDK_OFFSET(0x168356E0)
#define RPG_GAMECORE_ADVFILTERNEARBYMONSTERS__CTOR_OFFSET UNITYSDK_OFFSET(0x168356B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvFilterNearbyMonsters_TypeDefinitionIndex = 19389;
