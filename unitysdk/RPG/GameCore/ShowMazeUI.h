...
#define RPG_GAMECORE_SHOWMAZEUI_METHOD_3_0BB1B8472DAC29B2_OFFSET UNITYSDK_OFFSET(0x17714400)
#define RPG_GAMECORE_SHOWMAZEUI_METHOD_3_34D4CEACBFC8C05B_OFFSET UNITYSDK_OFFSET(0x17714380)
#define RPG_GAMECORE_SHOWMAZEUI__CTOR_OFFSET UNITYSDK_OFFSET(0x177143D0)
