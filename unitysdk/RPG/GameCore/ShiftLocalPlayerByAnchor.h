...
#define RPG_GAMECORE_SHIFTLOCALPLAYERBYANCHOR_METHOD_3_3331416DF5C4EDBB_OFFSET UNITYSDK_OFFSET(0x16F4E7D0)
#define RPG_GAMECORE_SHIFTLOCALPLAYERBYANCHOR_METHOD_3_74B49DC8D6FCD00A_OFFSET UNITYSDK_OFFSET(0x16F4E750)
#define RPG_GAMECORE_SHIFTLOCALPLAYERBYANCHOR__CTOR_OFFSET UNITYSDK_OFFSET(0x16F4E7A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShiftLocalPlayerByAnchor_TypeDefinitionIndex = 18986;
