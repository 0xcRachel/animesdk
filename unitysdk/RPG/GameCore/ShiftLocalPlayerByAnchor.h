...
#define RPG_GAMECORE_SHIFTLOCALPLAYERBYANCHOR_METHOD_3_3331416DF5C4EDBB_OFFSET UNITYSDK_OFFSET(0x1939C710)
#define RPG_GAMECORE_SHIFTLOCALPLAYERBYANCHOR_METHOD_3_74B49DC8D6FCD00A_OFFSET UNITYSDK_OFFSET(0x1939C690)
#define RPG_GAMECORE_SHIFTLOCALPLAYERBYANCHOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1939C6E0)
