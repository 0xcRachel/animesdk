...
#define RPG_GAMECORE_STARTSTAGEBGM_METHOD_3_04BBDCD73A351ABB_OFFSET UNITYSDK_OFFSET(0x16F96990)
#define RPG_GAMECORE_STARTSTAGEBGM_METHOD_3_FBB230053C574B9D_OFFSET UNITYSDK_OFFSET(0x16F96A10)
#define RPG_GAMECORE_STARTSTAGEBGM__CTOR_OFFSET UNITYSDK_OFFSET(0x16F969E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartStageBGM_TypeDefinitionIndex = 21082;
