...
#define RPG_GAMECORE_VIDEOCAPTION_METHOD_2_9A0198C2ADB8ADF6_OFFSET UNITYSDK_OFFSET(0x17147BB0)
#define RPG_GAMECORE_VIDEOCAPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x17147E30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VideoCaption_TypeDefinitionIndex = 15323;
