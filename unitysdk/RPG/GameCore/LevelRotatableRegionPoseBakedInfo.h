...
#define RPG_GAMECORE_LEVELROTATABLEREGIONPOSEBAKEDINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16BBD1E0)
#define RPG_GAMECORE_LEVELROTATABLEREGIONPOSEBAKEDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16BBD310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelRotatableRegionPoseBakedInfo_TypeDefinitionIndex = 15459;
