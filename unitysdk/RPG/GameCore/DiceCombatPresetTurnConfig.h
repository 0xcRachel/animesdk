...
#define RPG_GAMECORE_DICECOMBATPRESETTURNCONFIG_METHOD_2_E3266FDACE82C323_OFFSET UNITYSDK_OFFSET(0x1717BE50)
#define RPG_GAMECORE_DICECOMBATPRESETTURNCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1717BF30)
