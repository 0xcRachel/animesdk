...
#define RPG_GAMECORE_BASELEVELTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA34B440)
#define RPG_GAMECORE_BASELEVELTASK_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0xA34B430)
#define RPG_GAMECORE_BASELEVELTASK_ONSKIP_OFFSET UNITYSDK_OFFSET(0xA34B480)
#define RPG_GAMECORE_BASELEVELTASK_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xA34B4D0)
#define RPG_GAMECORE_BASELEVELTASK_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xA34B520)
#define RPG_GAMECORE_BASELEVELTASK_TICK_OFFSET UNITYSDK_OFFSET(0xA34B570)
#define RPG_GAMECORE_BASELEVELTASK__CTOR_OFFSET UNITYSDK_OFFSET(0xA34B420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseLevelTask_TypeDefinitionIndex = 45658;
