...
#define RPG_GAMECORE_GAMEENTITY___C__DISPLAYCLASS58_0__CTOR_OFFSET UNITYSDK_OFFSET(0xFE4A8D0)
#define RPG_GAMECORE_GAMEENTITY___C__DISPLAYCLASS58_0__DEATHRATTLE_B__0_OFFSET UNITYSDK_OFFSET(0xFE4C440)
