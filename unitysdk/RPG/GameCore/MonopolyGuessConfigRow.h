...
#define RPG_GAMECORE_MONOPOLYGUESSCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16CC9730)
#define RPG_GAMECORE_MONOPOLYGUESSCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16CC9880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyGuessConfigRow_TypeDefinitionIndex = 10993;
