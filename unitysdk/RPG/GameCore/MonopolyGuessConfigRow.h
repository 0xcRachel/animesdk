...
#define RPG_GAMECORE_MONOPOLYGUESSCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x174500B0)
#define RPG_GAMECORE_MONOPOLYGUESSCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17450200)
