...
#define RPG_GAMECORE_LEVELMONSTERSPAWNCONFIG_METHOD_3_113ABBB9CD7BFBC4_OFFSET UNITYSDK_OFFSET(0x16BAD280)
#define RPG_GAMECORE_LEVELMONSTERSPAWNCONFIG_METHOD_3_36102E97BFB94F5F_OFFSET UNITYSDK_OFFSET(0x16BA5400)
#define RPG_GAMECORE_LEVELMONSTERSPAWNCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16BA53F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelMonsterSpawnConfig_TypeDefinitionIndex = 15564;
