...
#define RPG_GAMECORE_ALLEYMAPEFFECTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1687B570)
#define RPG_GAMECORE_ALLEYMAPEFFECTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1687BCF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AlleyMapEffectRow_TypeDefinitionIndex = 11428;

	class AlleyMapEffectRow : public ::System::Object
	{
	public:
		::System::Single Param2; // 0x10
		::System::Single Param3; // 0x14
		::RPG::GameCore::BuffType BuffOrDebuff; // 0x18
