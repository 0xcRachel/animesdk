...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYREROLLBUFFCOSTCONFIG_METHOD_3_A64240B97F013E62_OFFSET UNITYSDK_OFFSET(0x16E99A50)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYREROLLBUFFCOSTCONFIG_METHOD_3_F553E7DFA4FEA46B_OFFSET UNITYSDK_OFFSET(0x16EA07C0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYREROLLBUFFCOSTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E99A00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyReRollBuffCostConfig_TypeDefinitionIndex = 16139;
