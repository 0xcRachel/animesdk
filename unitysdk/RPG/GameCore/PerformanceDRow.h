...
#define RPG_GAMECORE_PERFORMANCEDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18F09300)
#define RPG_GAMECORE_PERFORMANCEDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18F09B80)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::PerformanceChangePlayerType ChangePlayerType; // 0x2C
