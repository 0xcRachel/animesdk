...
#define RPG_GAMECORE_TRAVELBROCHUREDIARYGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1710ECC0)
#define RPG_GAMECORE_TRAVELBROCHUREDIARYGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1710EF10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TravelBrochureDiaryGroupRow_TypeDefinitionIndex = 13996;
