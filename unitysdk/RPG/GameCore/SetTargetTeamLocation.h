...
#define RPG_GAMECORE_SETTARGETTEAMLOCATION_METHOD_3_6EE614B4E40DB3FE_OFFSET UNITYSDK_OFFSET(0x16F41A30)
#define RPG_GAMECORE_SETTARGETTEAMLOCATION_METHOD_3_7C273689D536121C_OFFSET UNITYSDK_OFFSET(0x16F419B0)
#define RPG_GAMECORE_SETTARGETTEAMLOCATION__CTOR_OFFSET UNITYSDK_OFFSET(0x16F41A00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTargetTeamLocation_TypeDefinitionIndex = 20563;
