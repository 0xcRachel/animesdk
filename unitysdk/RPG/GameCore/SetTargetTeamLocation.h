...
#define RPG_GAMECORE_SETTARGETTEAMLOCATION_METHOD_3_6EE614B4E40DB3FE_OFFSET UNITYSDK_OFFSET(0x1A79FF10)
#define RPG_GAMECORE_SETTARGETTEAMLOCATION_METHOD_3_7C273689D536121C_OFFSET UNITYSDK_OFFSET(0x1A79FE90)
#define RPG_GAMECORE_SETTARGETTEAMLOCATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A79FEE0)
