...
#define RPG_GAMECORE_ROGUEADVROOMCANDYCRASHPROPEVENT_METHOD_3_1DF835CD75F8B5C1_OFFSET UNITYSDK_OFFSET(0x19238240)
#define RPG_GAMECORE_ROGUEADVROOMCANDYCRASHPROPEVENT_METHOD_3_8F3D8E7353489532_OFFSET UNITYSDK_OFFSET(0x192381C0)
#define RPG_GAMECORE_ROGUEADVROOMCANDYCRASHPROPEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19238210)
