...
#define RPG_GAMECORE_GRIDFIGHTCAMPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17268680)
#define RPG_GAMECORE_GRIDFIGHTCAMPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17268AD0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* ShowPicPath; // 0x18
		...
		::System::UInt32 IfRandomEnabled; // 0x38
