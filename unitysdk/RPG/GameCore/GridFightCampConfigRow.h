...
#define RPG_GAMECORE_GRIDFIGHTCAMPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AC7E2B0)
#define RPG_GAMECORE_GRIDFIGHTCAMPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC7E6F0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 InitialRandomCode; // 0x48
