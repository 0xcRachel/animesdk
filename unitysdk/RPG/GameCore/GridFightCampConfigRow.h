...
#define RPG_GAMECORE_GRIDFIGHTCAMPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19568170)
#define RPG_GAMECORE_GRIDFIGHTCAMPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x195685C0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 IfRandomEnabled; // 0x34
		::System::UInt32 SeasonID; // 0x38
		::System::UInt32 BossBattleArea; // 0x3C
