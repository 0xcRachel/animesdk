...
#define RPG_GAMECORE_WAITTIMELINE_METHOD_3_444713DCF914282A_OFFSET UNITYSDK_OFFSET(0x1715E8A0)
#define RPG_GAMECORE_WAITTIMELINE_METHOD_3_7C1C6BBBAFE3051C_OFFSET UNITYSDK_OFFSET(0x1715E930)
#define RPG_GAMECORE_WAITTIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1715E900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitTimeline_TypeDefinitionIndex = 20146;
