...
#define RPG_GAMECORE_MAZESKILLROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16C7BB90)
#define RPG_GAMECORE_MAZESKILLROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16C7C3F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazeSkillRow_TypeDefinitionIndex = 11415;
	...
	public:
		...
		::System::UInt32 MazeSkilltype; // 0x28
