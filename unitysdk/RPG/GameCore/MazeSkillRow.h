...
#define RPG_GAMECORE_MAZESKILLROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x173E1480)
#define RPG_GAMECORE_MAZESKILLROW__CTOR_OFFSET UNITYSDK_OFFSET(0x173E1CE0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 MPCost; // 0x18
		::System::UInt32 MazeSkilltype; // 0x1C
		::System::UInt32 Priority; // 0x20
		::RPG::Client::TextID MazeSkillDesc; // 0x28
		::System::UInt32 MazeSkillId; // 0x38
		::System::UInt32 RelatedAvatarSkill; // 0x3C
