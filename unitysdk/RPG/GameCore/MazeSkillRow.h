...
#define RPG_GAMECORE_MAZESKILLROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x190928C0)
#define RPG_GAMECORE_MAZESKILLROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19093120)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 MazeSkillId; // 0x34
		::System::UInt32 RelatedAvatarSkill; // 0x38
