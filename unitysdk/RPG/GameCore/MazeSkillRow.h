...
#define RPG_GAMECORE_MAZESKILLROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A6278F0)
#define RPG_GAMECORE_MAZESKILLROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A628120)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 MazeSkillId; // 0x18
