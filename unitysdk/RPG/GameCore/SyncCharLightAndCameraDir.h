...
#define RPG_GAMECORE_SYNCCHARLIGHTANDCAMERADIR_METHOD_3_5296C003FA497B9B_OFFSET UNITYSDK_OFFSET(0x1986C300)
#define RPG_GAMECORE_SYNCCHARLIGHTANDCAMERADIR_METHOD_3_E2E3C2BA929095F2_OFFSET UNITYSDK_OFFSET(0x1986C380)
#define RPG_GAMECORE_SYNCCHARLIGHTANDCAMERADIR__CTOR_OFFSET UNITYSDK_OFFSET(0x1986C350)
