...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIRONESIDEEQUIPMENTTARGETSELECTORCONFIG_METHOD_3_8AE2CA9A67564347_OFFSET UNITYSDK_OFFSET(0x1A1217D0)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIRONESIDEEQUIPMENTTARGETSELECTORCONFIG_METHOD_3_A3647279316AA5B3_OFFSET UNITYSDK_OFFSET(0x1A1216C0)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIRONESIDEEQUIPMENTTARGETSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1217C0)
