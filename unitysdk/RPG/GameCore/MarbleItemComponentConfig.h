...
#define RPG_GAMECORE_MARBLEITEMCOMPONENTCONFIG_METHOD_3_2E4A7DB54D4A08EA_OFFSET UNITYSDK_OFFSET(0x16C3F5D0)
#define RPG_GAMECORE_MARBLEITEMCOMPONENTCONFIG_METHOD_3_963BE80151BEF9A7_OFFSET UNITYSDK_OFFSET(0x16C3F660)
#define RPG_GAMECORE_MARBLEITEMCOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16C3F640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleItemComponentConfig_TypeDefinitionIndex = 16945;
