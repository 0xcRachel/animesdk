...
#define RPG_GAMECORE_MARBLEITEMCOMPONENTCONFIG_METHOD_3_2E4A7DB54D4A08EA_OFFSET UNITYSDK_OFFSET(0x18FEE720)
#define RPG_GAMECORE_MARBLEITEMCOMPONENTCONFIG_METHOD_3_963BE80151BEF9A7_OFFSET UNITYSDK_OFFSET(0x18FEE7B0)
#define RPG_GAMECORE_MARBLEITEMCOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18FEE790)
