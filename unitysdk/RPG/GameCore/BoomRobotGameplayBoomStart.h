...
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYBOOMSTART_METHOD_3_95B7E39B63788349_OFFSET UNITYSDK_OFFSET(0x17003530)
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYBOOMSTART_METHOD_3_FCE773B6BD0251D5_OFFSET UNITYSDK_OFFSET(0x17003420)
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYBOOMSTART__CTOR_OFFSET UNITYSDK_OFFSET(0x17003500)
