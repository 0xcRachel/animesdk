...
#define RPG_GAMECORE_ADVBYCOMPARECHARACTERID_METHOD_4_195F3D57885D6273_OFFSET UNITYSDK_OFFSET(0x167C2D60)
#define RPG_GAMECORE_ADVBYCOMPARECHARACTERID_METHOD_4_2140CF8E59527506_OFFSET UNITYSDK_OFFSET(0x167C2EC0)
#define RPG_GAMECORE_ADVBYCOMPARECHARACTERID__CTOR_OFFSET UNITYSDK_OFFSET(0x167C2E20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByCompareCharacterID_TypeDefinitionIndex = 18380;
