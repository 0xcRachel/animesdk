...
#define RPG_GAMECORE_ADVBYCOMPARECHARACTERID_METHOD_4_195F3D57885D6273_OFFSET UNITYSDK_OFFSET(0x19556920)
#define RPG_GAMECORE_ADVBYCOMPARECHARACTERID_METHOD_4_2140CF8E59527506_OFFSET UNITYSDK_OFFSET(0x19556A80)
#define RPG_GAMECORE_ADVBYCOMPARECHARACTERID_METHOD_4_2EBFAD70693A6C50_OFFSET UNITYSDK_OFFSET(0x19556D20)
#define RPG_GAMECORE_ADVBYCOMPARECHARACTERID_METHOD_4_6E44AFD8A7185A2B_OFFSET UNITYSDK_OFFSET(0x19556C60)
#define RPG_GAMECORE_ADVBYCOMPARECHARACTERID__CTOR_OFFSET UNITYSDK_OFFSET(0x195569E0)
