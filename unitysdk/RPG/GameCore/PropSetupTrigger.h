...
#define RPG_GAMECORE_PROPSETUPTRIGGER_METHOD_3_61F3686B46B57398_OFFSET UNITYSDK_OFFSET(0x16DB4650)
#define RPG_GAMECORE_PROPSETUPTRIGGER_METHOD_3_DE6D2D8B1BB289DA_OFFSET UNITYSDK_OFFSET(0x16DB4780)
#define RPG_GAMECORE_PROPSETUPTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x16DB4700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropSetupTrigger_TypeDefinitionIndex = 18123;
