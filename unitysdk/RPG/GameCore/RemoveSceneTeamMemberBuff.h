...
#define RPG_GAMECORE_REMOVESCENETEAMMEMBERBUFF_METHOD_3_1C08E2BCB1433939_OFFSET UNITYSDK_OFFSET(0x1A2E8930)
#define RPG_GAMECORE_REMOVESCENETEAMMEMBERBUFF_METHOD_3_42E05C6FB2BB9B49_OFFSET UNITYSDK_OFFSET(0x1A2E89C0)
#define RPG_GAMECORE_REMOVESCENETEAMMEMBERBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2E8990)
