...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDMAZEBUFFAFTERDRESSCONFIG_METHOD_3_1D9C54DEFFC386B1_OFFSET UNITYSDK_OFFSET(0x19575360)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDMAZEBUFFAFTERDRESSCONFIG_METHOD_3_309723814F369B48_OFFSET UNITYSDK_OFFSET(0x19575430)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDMAZEBUFFAFTERDRESSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x195753E0)
