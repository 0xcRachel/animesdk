...
#define RPG_GAMECORE_ADVADDEXTRABATTLEMONSTER_METHOD_3_1B6540409EC3F195_OFFSET UNITYSDK_OFFSET(0x167C1600)
#define RPG_GAMECORE_ADVADDEXTRABATTLEMONSTER_METHOD_3_7101D4F8FBA82C64_OFFSET UNITYSDK_OFFSET(0x167C1680)
#define RPG_GAMECORE_ADVADDEXTRABATTLEMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x167C1650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvAddExtraBattleMonster_TypeDefinitionIndex = 19452;
