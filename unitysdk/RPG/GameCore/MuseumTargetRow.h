...
#define RPG_GAMECORE_MUSEUMTARGETROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17479EC0)
#define RPG_GAMECORE_MUSEUMTARGETROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1747A5F0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 TypeParameter; // 0x20
