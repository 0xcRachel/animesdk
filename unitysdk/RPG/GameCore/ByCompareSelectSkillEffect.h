...
#define RPG_GAMECORE_BYCOMPARESELECTSKILLEFFECT_METHOD_4_5EC265C2023AEE4F_OFFSET UNITYSDK_OFFSET(0x1702AB50)
#define RPG_GAMECORE_BYCOMPARESELECTSKILLEFFECT_METHOD_4_77FE2ADB05E43A31_OFFSET UNITYSDK_OFFSET(0x1702AC20)
#define RPG_GAMECORE_BYCOMPARESELECTSKILLEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1702ABD0)
