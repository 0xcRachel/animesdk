...
#define RPG_GAMECORE_HELIOBUSCHALLENGEGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B61300)
#define RPG_GAMECORE_HELIOBUSCHALLENGEGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B61900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HeliobusChallengeGroupRow_TypeDefinitionIndex = 12527;
