...
#define RPG_GAMECORE_ROGUEBUFFTYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x175FB230)
#define RPG_GAMECORE_ROGUEBUFFTYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x175FBA60)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID RogueBuffTypeTextmapID; // 0x40
