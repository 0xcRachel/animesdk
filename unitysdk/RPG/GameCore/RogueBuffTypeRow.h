...
#define RPG_GAMECORE_ROGUEBUFFTYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x192433C0)
#define RPG_GAMECORE_ROGUEBUFFTYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19243BF0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID HintDesc; // 0x58
