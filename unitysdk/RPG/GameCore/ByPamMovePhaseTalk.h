...
#define RPG_GAMECORE_BYPAMMOVEPHASETALK_METHOD_4_67B27AD8B91878A2_OFFSET UNITYSDK_OFFSET(0x1693A650)
#define RPG_GAMECORE_BYPAMMOVEPHASETALK_METHOD_4_A94004502D50BE48_OFFSET UNITYSDK_OFFSET(0x1693A580)
#define RPG_GAMECORE_BYPAMMOVEPHASETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1693A600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByPamMovePhaseTalk_TypeDefinitionIndex = 17768;
