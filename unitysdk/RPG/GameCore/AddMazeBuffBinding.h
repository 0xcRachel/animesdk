...
#define RPG_GAMECORE_ADDMAZEBUFFBINDING_METHOD_3_9A08BF41C72548D6_OFFSET UNITYSDK_OFFSET(0x167BBC30)
#define RPG_GAMECORE_ADDMAZEBUFFBINDING_METHOD_3_FB0EE2191E28C077_OFFSET UNITYSDK_OFFSET(0x167BBCB0)
#define RPG_GAMECORE_ADDMAZEBUFFBINDING__CTOR_OFFSET UNITYSDK_OFFSET(0x167BBC80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddMazeBuffBinding_TypeDefinitionIndex = 21086;
