...
#define RPG_GAMECORE_HIPPLENINCIDENTRANDOMSTEPCONFIG_METHOD_3_2B75FDE152604AFB_OFFSET UNITYSDK_OFFSET(0x16B74DF0)
#define RPG_GAMECORE_HIPPLENINCIDENTRANDOMSTEPCONFIG_METHOD_3_7E126CC6880B74F9_OFFSET UNITYSDK_OFFSET(0x16B74E50)
#define RPG_GAMECORE_HIPPLENINCIDENTRANDOMSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16B74E40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenIncidentRandomStepConfig_TypeDefinitionIndex = 15136;
