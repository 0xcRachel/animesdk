...
#define RPG_GAMECORE_PROGRESSBARTYPECONFIG_METHOD_2_6A64A33F24836CCB_OFFSET UNITYSDK_OFFSET(0x1A2D4490)
#define RPG_GAMECORE_PROGRESSBARTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2D4560)
