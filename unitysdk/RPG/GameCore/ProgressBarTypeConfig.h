...
#define RPG_GAMECORE_PROGRESSBARTYPECONFIG_METHOD_2_6BFB2FC4070AB802_OFFSET UNITYSDK_OFFSET(0x16DA0ED0)
#define RPG_GAMECORE_PROGRESSBARTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16DA0F80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ProgressBarTypeConfig_TypeDefinitionIndex = 20377;
