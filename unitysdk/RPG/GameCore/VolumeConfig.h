...
#define RPG_GAMECORE_VOLUMECONFIG_METHOD_2_A01AC9BE5A788AE2_OFFSET UNITYSDK_OFFSET(0x1714BC40)
#define RPG_GAMECORE_VOLUMECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1714BD80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VolumeConfig_TypeDefinitionIndex = 17149;
