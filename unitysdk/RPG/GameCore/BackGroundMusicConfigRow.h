...
#define RPG_GAMECORE_BACKGROUNDMUSICCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x182252E0)
#define RPG_GAMECORE_BACKGROUNDMUSICCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18225AA0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID MusicName; // 0x18
