...
#define RPG_GAMECORE_ROGUENOUSTALENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16EB14F0)
#define RPG_GAMECORE_ROGUENOUSTALENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16EB1DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueNousTalentRow_TypeDefinitionIndex = 13583;
	...
	public:
		...
		::Il2CppArray<::RPG::GameCore::ItemConfig*>* Cost; // 0x30
