...
#define RPG_GAMECORE_MESSAGECONTACTSCONDITIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16C80370)
#define RPG_GAMECORE_MESSAGECONTACTSCONDITIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16C804B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MessageContactsConditionRow_TypeDefinitionIndex = 13141;
