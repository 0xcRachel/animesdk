...
#define RPG_GAMECORE_GRIDFIGHTORBTYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B35E40)
#define RPG_GAMECORE_GRIDFIGHTORBTYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B35FC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightOrbTypeRow_TypeDefinitionIndex = 12198;
