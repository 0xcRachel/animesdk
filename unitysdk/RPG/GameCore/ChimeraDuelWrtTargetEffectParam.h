...
#define RPG_GAMECORE_CHIMERADUELWRTTARGETEFFECTPARAM_METHOD_3_8885CECE45D09DAD_OFFSET UNITYSDK_OFFSET(0x170BCB10)
#define RPG_GAMECORE_CHIMERADUELWRTTARGETEFFECTPARAM_METHOD_3_C2E81330861459A5_OFFSET UNITYSDK_OFFSET(0x170BCB70)
#define RPG_GAMECORE_CHIMERADUELWRTTARGETEFFECTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x170BCB60)
