...
#define RPG_GAMECORE_CHIMERADUELWRTTARGETEFFECTPARAM_METHOD_3_4DABD3277357C900_OFFSET UNITYSDK_OFFSET(0x1A51C420)
#define RPG_GAMECORE_CHIMERADUELWRTTARGETEFFECTPARAM_METHOD_3_ADEA472A1F487C90_OFFSET UNITYSDK_OFFSET(0x1A51C480)
#define RPG_GAMECORE_CHIMERADUELWRTTARGETEFFECTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A51C470)
