...
#define RPG_GAMECORE_UNLOCKCAMERA_METHOD_3_194CFD073DF8FF28_OFFSET UNITYSDK_OFFSET(0x1713BA30)
#define RPG_GAMECORE_UNLOCKCAMERA_METHOD_3_8910B86451F83CDC_OFFSET UNITYSDK_OFFSET(0x1713B920)
#define RPG_GAMECORE_UNLOCKCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x1713BA00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UnLockCamera_TypeDefinitionIndex = 17923;
