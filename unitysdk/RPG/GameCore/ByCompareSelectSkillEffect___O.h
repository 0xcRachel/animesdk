...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_9EB2CB86795DEEF1_DelegateParseJson_1<::RPG::GameCore::SkillEffect>**)Il2CppClass::FromTypeDefinitionIndex(ByCompareSelectSkillEffect___O_TypeDefinitionIndex)->GetStaticField(0x8D20);
		}
	};
}
