...
#define RPG_GAMECORE_PIXAIREQUIPPRICEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19D41AE0)
#define RPG_GAMECORE_PIXAIREQUIPPRICEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19D41C90)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::RPG::GameCore::PixAirSlotType SlotType; // 0x10
		::System::UInt32 Level; // 0x14
		::System::UInt32 SellPrice; // 0x18
		::System::UInt32 BuyPrice; // 0x1C
