...
#define RPG_GAMECORE_SWITCHCASE_METHOD_3_295E26A54619163F_OFFSET UNITYSDK_OFFSET(0x16FB2130)
#define RPG_GAMECORE_SWITCHCASE_METHOD_3_DD06B7E62F2BF0A4_OFFSET UNITYSDK_OFFSET(0x16FB21B0)
#define RPG_GAMECORE_SWITCHCASE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FB2180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchCase_TypeDefinitionIndex = 21480;
