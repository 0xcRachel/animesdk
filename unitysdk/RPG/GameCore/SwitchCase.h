...
#define RPG_GAMECORE_SWITCHCASE_METHOD_3_D53807AF0057DC05_OFFSET UNITYSDK_OFFSET(0x1985B0C0)
#define RPG_GAMECORE_SWITCHCASE_METHOD_3_D863706CAC774AD6_OFFSET UNITYSDK_OFFSET(0x1985B140)
#define RPG_GAMECORE_SWITCHCASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1985B110)
