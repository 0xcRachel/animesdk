...
#define RPG_GAMECORE_AETHERDIVIDETRIGGERATTACKSIMPLIFIED_METHOD_3_D91FB4518FB3A140_OFFSET UNITYSDK_OFFSET(0x18BC5E20)
#define RPG_GAMECORE_AETHERDIVIDETRIGGERATTACKSIMPLIFIED_METHOD_3_E6DC7E90C49EC7F9_OFFSET UNITYSDK_OFFSET(0x18BC5DA0)
#define RPG_GAMECORE_AETHERDIVIDETRIGGERATTACKSIMPLIFIED__CTOR_OFFSET UNITYSDK_OFFSET(0x18BC5DF0)
