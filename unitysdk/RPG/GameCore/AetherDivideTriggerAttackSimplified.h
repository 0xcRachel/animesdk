...
#define RPG_GAMECORE_AETHERDIVIDETRIGGERATTACKSIMPLIFIED_METHOD_3_D91FB4518FB3A140_OFFSET UNITYSDK_OFFSET(0x16871F60)
#define RPG_GAMECORE_AETHERDIVIDETRIGGERATTACKSIMPLIFIED_METHOD_3_E6DC7E90C49EC7F9_OFFSET UNITYSDK_OFFSET(0x16871EE0)
#define RPG_GAMECORE_AETHERDIVIDETRIGGERATTACKSIMPLIFIED__CTOR_OFFSET UNITYSDK_OFFSET(0x16871F30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AetherDivideTriggerAttackSimplified_TypeDefinitionIndex = 21753;
