...
#define RPG_GAMECORE_SWITCHHANDRESETTRANSFORM_METHOD_3_37EF99D40B5B2AF2_OFFSET UNITYSDK_OFFSET(0x16FB5570)
#define RPG_GAMECORE_SWITCHHANDRESETTRANSFORM_METHOD_3_9548BA0246A89723_OFFSET UNITYSDK_OFFSET(0x16FB55F0)
#define RPG_GAMECORE_SWITCHHANDRESETTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x16FB55C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchHandResetTransform_TypeDefinitionIndex = 18766;
