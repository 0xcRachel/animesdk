...
#define RPG_GAMECORE_MISSIONRESCONFIGLIST_METHOD_2_B45F12D7A5717E54_OFFSET UNITYSDK_OFFSET(0x16CAFEB0)
#define RPG_GAMECORE_MISSIONRESCONFIGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x16CAFFF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MissionResConfigList_TypeDefinitionIndex = 17038;
