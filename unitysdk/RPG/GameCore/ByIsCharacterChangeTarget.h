...
#define RPG_GAMECORE_BYISCHARACTERCHANGETARGET_METHOD_4_70711479CA1A60A5_OFFSET UNITYSDK_OFFSET(0x1703ED90)
#define RPG_GAMECORE_BYISCHARACTERCHANGETARGET_METHOD_4_BB10006205F57ED9_OFFSET UNITYSDK_OFFSET(0x1703EE70)
#define RPG_GAMECORE_BYISCHARACTERCHANGETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1703EE10)
