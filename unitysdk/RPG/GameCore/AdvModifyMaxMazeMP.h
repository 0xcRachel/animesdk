...
#define RPG_GAMECORE_ADVMODIFYMAXMAZEMP_METHOD_3_58125755B265973B_OFFSET UNITYSDK_OFFSET(0x19BE5B00)
#define RPG_GAMECORE_ADVMODIFYMAXMAZEMP_METHOD_3_F4FBEBCC4B349CF3_OFFSET UNITYSDK_OFFSET(0x19BE5C20)
#define RPG_GAMECORE_ADVMODIFYMAXMAZEMP__CTOR_OFFSET UNITYSDK_OFFSET(0x19BE5BA0)
