...
#define RPG_GAMECORE_ADVMODIFYMAXMAZEMP_METHOD_3_58125755B265973B_OFFSET UNITYSDK_OFFSET(0x1683A8A0)
#define RPG_GAMECORE_ADVMODIFYMAXMAZEMP_METHOD_3_F4FBEBCC4B349CF3_OFFSET UNITYSDK_OFFSET(0x1683A9C0)
#define RPG_GAMECORE_ADVMODIFYMAXMAZEMP__CTOR_OFFSET UNITYSDK_OFFSET(0x1683A940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvModifyMaxMazeMP_TypeDefinitionIndex = 19463;
