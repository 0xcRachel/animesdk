...
#define RPG_GAMECORE_BATTLECOMBOCONFIG_METHOD_2_1D062C20384514FA_OFFSET UNITYSDK_OFFSET(0x1765D0A0)
#define RPG_GAMECORE_BATTLECOMBOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1765D560)
