...
#define RPG_GAMECORE_TARGETSORTMONSTERRANK_METHOD_3_50B2CA8244C7A84D_OFFSET UNITYSDK_OFFSET(0x16FF1E00)
#define RPG_GAMECORE_TARGETSORTMONSTERRANK_METHOD_3_618D6C731AACAABC_OFFSET UNITYSDK_OFFSET(0x16FF2C30)
#define RPG_GAMECORE_TARGETSORTMONSTERRANK__CTOR_OFFSET UNITYSDK_OFFSET(0x16FF1DE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSortMonsterRank_TypeDefinitionIndex = 21700;
