...
#define RPG_GAMECORE_TARGETSORTMONSTERRANK_METHOD_3_50B2CA8244C7A84D_OFFSET UNITYSDK_OFFSET(0x177E7020)
#define RPG_GAMECORE_TARGETSORTMONSTERRANK_METHOD_3_618D6C731AACAABC_OFFSET UNITYSDK_OFFSET(0x177E7E70)
#define RPG_GAMECORE_TARGETSORTMONSTERRANK__CTOR_OFFSET UNITYSDK_OFFSET(0x177E7000)
