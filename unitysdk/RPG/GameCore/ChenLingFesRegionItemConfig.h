...
#define RPG_GAMECORE_CHENLINGFESREGIONITEMCONFIG_METHOD_2_010010416D285032_OFFSET UNITYSDK_OFFSET(0x1A4FF4E0)
#define RPG_GAMECORE_CHENLINGFESREGIONITEMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4FF630)
