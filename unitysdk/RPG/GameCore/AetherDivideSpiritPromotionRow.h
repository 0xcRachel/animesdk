...
#define RPG_GAMECORE_AETHERDIVIDESPIRITPROMOTIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18ABCA60)
#define RPG_GAMECORE_AETHERDIVIDESPIRITPROMOTIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18ABD4B0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::FixPoint CriticalChance; // 0x20
		::RPG::GameCore::FixPoint BaseAggro; // 0x28
		::RPG::GameCore::FixPoint CriticalDamage; // 0x30
		::System::UInt32 Exp; // 0x38
		::System::UInt32 Promotion; // 0x3C
		::RPG::GameCore::FixPoint AttackBase; // 0x40
		::System::UInt32 Slot; // 0x48
		::System::UInt32 RewardID; // 0x4C
		::System::UInt32 AvatarID; // 0x50
		::RPG::GameCore::FixPoint SpeedBase; // 0x58
		::RPG::GameCore::FixPoint DefenceBase; // 0x60
