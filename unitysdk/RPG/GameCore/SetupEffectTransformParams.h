...
#define RPG_GAMECORE_SETUPEFFECTTRANSFORMPARAMS_METHOD_3_72C251D1CAD24F9B_OFFSET UNITYSDK_OFFSET(0x19396C10)
#define RPG_GAMECORE_SETUPEFFECTTRANSFORMPARAMS_METHOD_3_9E0A20077A3B86BB_OFFSET UNITYSDK_OFFSET(0x19396C90)
#define RPG_GAMECORE_SETUPEFFECTTRANSFORMPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x19396C60)
