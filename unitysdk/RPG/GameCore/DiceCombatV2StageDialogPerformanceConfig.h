...
#define RPG_GAMECORE_DICECOMBATV2STAGEDIALOGPERFORMANCECONFIG_METHOD_2_D62CAE80E5F0D669_OFFSET UNITYSDK_OFFSET(0x1A0A1330)
#define RPG_GAMECORE_DICECOMBATV2STAGEDIALOGPERFORMANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0A1420)
