...
#define RPG_GAMECORE_ADVCHASEBAILUSETDOOR_METHOD_3_1979E7E1251A15D3_OFFSET UNITYSDK_OFFSET(0x168305A0)
#define RPG_GAMECORE_ADVCHASEBAILUSETDOOR_METHOD_3_2F085F441B4B7A18_OFFSET UNITYSDK_OFFSET(0x16830620)
#define RPG_GAMECORE_ADVCHASEBAILUSETDOOR__CTOR_OFFSET UNITYSDK_OFFSET(0x168305F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvChaseBailuSetDoor_TypeDefinitionIndex = 19881;
