...
#define RPG_GAMECORE_TRFLEVELCOMPONENTCONFIG_METHOD_3_7DD02624E46F5658_OFFSET UNITYSDK_OFFSET(0x16FC6E10)
#define RPG_GAMECORE_TRFLEVELCOMPONENTCONFIG_METHOD_3_9BB024A06E55263D_OFFSET UNITYSDK_OFFSET(0x16FC6EC0)
#define RPG_GAMECORE_TRFLEVELCOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16FC6E90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TRFLevelComponentConfig_TypeDefinitionIndex = 16936;
