...
#define RPG_GAMECORE_SETEFFECTPROGRESS_METHOD_3_0C2D611C08AF3533_OFFSET UNITYSDK_OFFSET(0x199B0CE0)
#define RPG_GAMECORE_SETEFFECTPROGRESS_METHOD_3_64AED65B8EEBE741_OFFSET UNITYSDK_OFFSET(0x199B0D60)
#define RPG_GAMECORE_SETEFFECTPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x199B0D30)
