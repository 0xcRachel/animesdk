...
#define RPG_GAMECORE_SETEFFECTPROGRESS_METHOD_3_0C2D611C08AF3533_OFFSET UNITYSDK_OFFSET(0x176DE510)
#define RPG_GAMECORE_SETEFFECTPROGRESS_METHOD_3_64AED65B8EEBE741_OFFSET UNITYSDK_OFFSET(0x176DE590)
#define RPG_GAMECORE_SETEFFECTPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x176DE560)
