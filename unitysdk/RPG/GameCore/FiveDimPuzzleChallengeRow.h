...
#define RPG_GAMECORE_FIVEDIMPUZZLECHALLENGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16AD0090)
#define RPG_GAMECORE_FIVEDIMPUZZLECHALLENGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16AD0750)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPuzzleChallengeRow_TypeDefinitionIndex = 12831;
	...
	public:
		...
		::System::UInt32 PuzzleID; // 0x44
		::System::Int16 ProgressLimit; // 0x48
		::RPG::Client::TextID ActiveNameText; // 0x50
		::RPG::Client::TextID DescText; // 0x60
		::System::UInt32 InstanceID; // 0x70
		::System::UInt32 GroupID; // 0x74
