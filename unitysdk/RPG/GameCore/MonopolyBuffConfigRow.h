...
#define RPG_GAMECORE_MONOPOLYBUFFCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19087C20)
#define RPG_GAMECORE_MONOPOLYBUFFCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19087F70)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean IsPermanent; // 0x30
		::System::UInt32 Rank; // 0x34
		::RPG::Client::TextID BuffName; // 0x38
		::System::UInt32 BuffID; // 0x48
