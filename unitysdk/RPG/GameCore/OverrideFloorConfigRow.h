...
#define RPG_GAMECORE_OVERRIDEFLOORCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18EF60E0)
#define RPG_GAMECORE_OVERRIDEFLOORCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18EF6270)
