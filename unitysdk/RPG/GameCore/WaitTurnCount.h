...
#define RPG_GAMECORE_WAITTURNCOUNT_METHOD_3_84B56CCD64415B0A_OFFSET UNITYSDK_OFFSET(0x1715F490)
#define RPG_GAMECORE_WAITTURNCOUNT_METHOD_3_CED716E9171354F2_OFFSET UNITYSDK_OFFSET(0x1715F370)
#define RPG_GAMECORE_WAITTURNCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1715F410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitTurnCount_TypeDefinitionIndex = 21079;
