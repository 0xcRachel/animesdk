...
#define RPG_GAMECORE_BYISENTITYACTIONSTATE_METHOD_4_6F9ADF696BEE7F9F_OFFSET UNITYSDK_OFFSET(0x17041A80)
#define RPG_GAMECORE_BYISENTITYACTIONSTATE_METHOD_4_E599C808F1EF0FC1_OFFSET UNITYSDK_OFFSET(0x170419B0)
#define RPG_GAMECORE_BYISENTITYACTIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17041A30)
