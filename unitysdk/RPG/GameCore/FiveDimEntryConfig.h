...
#define RPG_GAMECORE_FIVEDIMENTRYCONFIG_METHOD_3_7C82697C0859388C_OFFSET UNITYSDK_OFFSET(0x16ABBF00)
#define RPG_GAMECORE_FIVEDIMENTRYCONFIG_METHOD_3_9EC689523426F43D_OFFSET UNITYSDK_OFFSET(0x16ABBF70)
#define RPG_GAMECORE_FIVEDIMENTRYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16ABBF50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimEntryConfig_TypeDefinitionIndex = 16636;
