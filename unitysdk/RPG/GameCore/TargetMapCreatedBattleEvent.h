...
#define RPG_GAMECORE_TARGETMAPCREATEDBATTLEEVENT_METHOD_3_89B37CFD8F3B084F_OFFSET UNITYSDK_OFFSET(0x16FE20B0)
#define RPG_GAMECORE_TARGETMAPCREATEDBATTLEEVENT_METHOD_3_BFCB717AF3AAC8C2_OFFSET UNITYSDK_OFFSET(0x16FE1FF0)
#define RPG_GAMECORE_TARGETMAPCREATEDBATTLEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE2090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapCreatedBattleEvent_TypeDefinitionIndex = 21646;
