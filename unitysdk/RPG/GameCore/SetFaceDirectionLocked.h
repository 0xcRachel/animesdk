...
#define RPG_GAMECORE_SETFACEDIRECTIONLOCKED_METHOD_3_642697B89BD9593B_OFFSET UNITYSDK_OFFSET(0x199B3D50)
#define RPG_GAMECORE_SETFACEDIRECTIONLOCKED_METHOD_3_65565061BF5D6C0C_OFFSET UNITYSDK_OFFSET(0x199B3DD0)
#define RPG_GAMECORE_SETFACEDIRECTIONLOCKED__CTOR_OFFSET UNITYSDK_OFFSET(0x199B3DA0)
