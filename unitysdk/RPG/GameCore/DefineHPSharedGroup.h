...
#define RPG_GAMECORE_DEFINEHPSHAREDGROUP_METHOD_3_08E35FE2E4008812_OFFSET UNITYSDK_OFFSET(0x169EA2C0)
#define RPG_GAMECORE_DEFINEHPSHAREDGROUP_METHOD_3_2A4ACF4D434BB00C_OFFSET UNITYSDK_OFFSET(0x169EA340)
#define RPG_GAMECORE_DEFINEHPSHAREDGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x169EA310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DefineHPSharedGroup_TypeDefinitionIndex = 20474;
