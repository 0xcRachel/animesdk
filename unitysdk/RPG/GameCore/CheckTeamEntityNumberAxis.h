...
#define RPG_GAMECORE_CHECKTEAMENTITYNUMBERAXIS_METHOD_3_3DFD163CC6FBB79F_OFFSET UNITYSDK_OFFSET(0x1708B050)
#define RPG_GAMECORE_CHECKTEAMENTITYNUMBERAXIS_METHOD_3_83D04FBD2A952056_OFFSET UNITYSDK_OFFSET(0x1708B0A0)
#define RPG_GAMECORE_CHECKTEAMENTITYNUMBERAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x1708B090)
