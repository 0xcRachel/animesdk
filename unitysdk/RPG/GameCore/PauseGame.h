...
#define RPG_GAMECORE_PAUSEGAME_METHOD_3_EBD2FF225EAB2B3B_OFFSET UNITYSDK_OFFSET(0x174A2B10)
#define RPG_GAMECORE_PAUSEGAME_METHOD_3_F287DEE5C07943CA_OFFSET UNITYSDK_OFFSET(0x174A2A90)
#define RPG_GAMECORE_PAUSEGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x174A2AE0)
