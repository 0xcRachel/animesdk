...
#define RPG_GAMECORE_RESHAEASTEREGGSTATELISTENER_METHOD_3_C6BDD5895A2AC880_OFFSET UNITYSDK_OFFSET(0x19AABD20)
#define RPG_GAMECORE_RESHAEASTEREGGSTATELISTENER_METHOD_3_DEE1D2EB25944CB7_OFFSET UNITYSDK_OFFSET(0x19AABE70)
#define RPG_GAMECORE_RESHAEASTEREGGSTATELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x19AABDE0)
