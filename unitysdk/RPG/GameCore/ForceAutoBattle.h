...
#define RPG_GAMECORE_FORCEAUTOBATTLE_METHOD_3_7E5FBF7AE067F79F_OFFSET UNITYSDK_OFFSET(0x16ADED70)
#define RPG_GAMECORE_FORCEAUTOBATTLE_METHOD_3_98E74177EFD8BC60_OFFSET UNITYSDK_OFFSET(0x16ADEDF0)
#define RPG_GAMECORE_FORCEAUTOBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16ADEDC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ForceAutoBattle_TypeDefinitionIndex = 20949;
