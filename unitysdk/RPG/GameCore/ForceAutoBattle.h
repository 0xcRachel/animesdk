...
#define RPG_GAMECORE_FORCEAUTOBATTLE_METHOD_3_40F2D69AE16A2E5A_OFFSET UNITYSDK_OFFSET(0x1A3B0D50)
#define RPG_GAMECORE_FORCEAUTOBATTLE_METHOD_3_E13F7BDAEAE3DDE5_OFFSET UNITYSDK_OFFSET(0x1A3B0CD0)
#define RPG_GAMECORE_FORCEAUTOBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3B0D20)
