...
#define RPG_GAMECORE_BYISTARGETABLETOACTION_METHOD_4_B190FD30111E5B01_OFFSET UNITYSDK_OFFSET(0x169367C0)
#define RPG_GAMECORE_BYISTARGETABLETOACTION_METHOD_4_CFD227DB0A8F2C77_OFFSET UNITYSDK_OFFSET(0x169366F0)
#define RPG_GAMECORE_BYISTARGETABLETOACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16936770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsTargetAbleToAction_TypeDefinitionIndex = 20692;
