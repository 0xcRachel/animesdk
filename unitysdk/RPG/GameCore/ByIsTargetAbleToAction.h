...
#define RPG_GAMECORE_BYISTARGETABLETOACTION_METHOD_4_B190FD30111E5B01_OFFSET UNITYSDK_OFFSET(0x17048010)
#define RPG_GAMECORE_BYISTARGETABLETOACTION_METHOD_4_CFD227DB0A8F2C77_OFFSET UNITYSDK_OFFSET(0x17047F40)
#define RPG_GAMECORE_BYISTARGETABLETOACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x17047FC0)
