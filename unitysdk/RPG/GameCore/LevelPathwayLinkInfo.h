...
#define RPG_GAMECORE_LEVELPATHWAYLINKINFO_METHOD_2_C2E95358F282F669_OFFSET UNITYSDK_OFFSET(0x16BB5970)
#define RPG_GAMECORE_LEVELPATHWAYLINKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16BB5A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPathwayLinkInfo_TypeDefinitionIndex = 15568;
