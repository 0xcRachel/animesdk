...
#define RPG_GAMECORE_TOASTMANAGERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x170F8B70)
#define RPG_GAMECORE_TOASTMANAGERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x170F9170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ToastManagerRow_TypeDefinitionIndex = 13913;
