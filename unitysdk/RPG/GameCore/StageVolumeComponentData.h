...
#define RPG_GAMECORE_STAGEVOLUMECOMPONENTDATA_METHOD_2_044687400A577648_OFFSET UNITYSDK_OFFSET(0x19341D60)
#define RPG_GAMECORE_STAGEVOLUMECOMPONENTDATA_METHOD_2_3E0553BA6D3E680F_OFFSET UNITYSDK_OFFSET(0x19341770)
#define RPG_GAMECORE_STAGEVOLUMECOMPONENTDATA_METHOD_2_66428440DA99740A_OFFSET UNITYSDK_OFFSET(0x19341B20)
#define RPG_GAMECORE_STAGEVOLUMECOMPONENTDATA_METHOD_2_F3AEEDCAC183F672_OFFSET UNITYSDK_OFFSET(0x19342150)
#define RPG_GAMECORE_STAGEVOLUMECOMPONENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19341B10)
