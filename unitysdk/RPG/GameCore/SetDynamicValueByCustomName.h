...
#define RPG_GAMECORE_SETDYNAMICVALUEBYCUSTOMNAME_METHOD_3_69ACC753346F8C64_OFFSET UNITYSDK_OFFSET(0x16F23230)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCUSTOMNAME_METHOD_3_E0CFEF4D4D40A1DB_OFFSET UNITYSDK_OFFSET(0x16F231C0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCUSTOMNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x16F23200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByCustomName_TypeDefinitionIndex = 19443;
