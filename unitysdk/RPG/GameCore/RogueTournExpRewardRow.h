...
#define RPG_GAMECORE_ROGUETOURNEXPREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16EC5BF0)
#define RPG_GAMECORE_ROGUETOURNEXPREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16EC5D70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournExpRewardRow_TypeDefinitionIndex = 13628;
