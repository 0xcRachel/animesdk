...
#define RPG_GAMECORE_ADVNPCTRACKEDSEARCH_METHOD_3_F5C303B4C58A9890_OFFSET UNITYSDK_OFFSET(0x18C53FC0)
#define RPG_GAMECORE_ADVNPCTRACKEDSEARCH_METHOD_3_FD007F0F30449849_OFFSET UNITYSDK_OFFSET(0x18C53F40)
#define RPG_GAMECORE_ADVNPCTRACKEDSEARCH__CTOR_OFFSET UNITYSDK_OFFSET(0x18C53F90)
