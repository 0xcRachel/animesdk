...
#define RPG_GAMECORE_MONSTERLODINFO_METHOD_2_1D433E9AF2243E34_OFFSET UNITYSDK_OFFSET(0x16CDEFF0)
#define RPG_GAMECORE_MONSTERLODINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16CDF110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonsterLodInfo_TypeDefinitionIndex = 17086;
