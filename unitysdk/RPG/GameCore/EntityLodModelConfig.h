...
#define RPG_GAMECORE_ENTITYLODMODELCONFIG_METHOD_2_07AC4E1F00513E5D_OFFSET UNITYSDK_OFFSET(0x16A72970)
#define RPG_GAMECORE_ENTITYLODMODELCONFIG_METHOD_2_8B6B88BB55BEE3B0_OFFSET UNITYSDK_OFFSET(0x16A72CC0)
#define RPG_GAMECORE_ENTITYLODMODELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16A72C90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EntityLodModelConfig_TypeDefinitionIndex = 17236;
