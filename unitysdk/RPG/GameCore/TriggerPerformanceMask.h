...
#define RPG_GAMECORE_TRIGGERPERFORMANCEMASK_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17124EE0)
#define RPG_GAMECORE_TRIGGERPERFORMANCEMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x17125220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerPerformanceMask_TypeDefinitionIndex = 18067;
