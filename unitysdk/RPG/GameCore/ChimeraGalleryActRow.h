...
#define RPG_GAMECORE_CHIMERAGALLERYACTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1699B650)
#define RPG_GAMECORE_CHIMERAGALLERYACTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1699B840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraGalleryActRow_TypeDefinitionIndex = 11835;
