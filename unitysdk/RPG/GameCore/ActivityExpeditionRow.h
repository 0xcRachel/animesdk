...
#define RPG_GAMECORE_ACTIVITYEXPEDITIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18875530)
#define RPG_GAMECORE_ACTIVITYEXPEDITIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x188767F0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::ActivityExpeditionRank ExpeditionRank; // 0x18
		::System::UInt32 AvatarNumMax; // 0x1C
		::System::UInt32 Duration; // 0x20
		::System::UInt32 Grade2ExtraRewardID; // 0x24
		...
		::RPG::Client::TextID AssignDesc; // 0x48
		::System::UInt32 ExpeditionTag; // 0x58
		::System::UInt32 Grade3ExtraRewardID; // 0x5C
		::RPG::Client::TextID AssignerName; // 0x60
