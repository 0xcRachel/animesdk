...
#define RPG_GAMECORE_ACTIVITYEXPEDITIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16EC6460)
#define RPG_GAMECORE_ACTIVITYEXPEDITIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16EC7720)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 Grade1ExtraRewardID; // 0x28
		::System::UInt32 RewardID; // 0x2C
		::System::UInt32 Grade2ExtraRewardID; // 0x30
		::System::UInt32 ExpeditionTag; // 0x34
		::RPG::Client::TextID AssignDesc; // 0x38
		::System::UInt32 Duration; // 0x48
		::System::UInt32 Grade3ExtraRewardID; // 0x4C
		::System::UInt32 AvatarNumMin; // 0x50
		::System::UInt32 AvatarNumMax; // 0x54
		::System::UInt32 ExpeditionID; // 0x58
		::RPG::GameCore::ActivityExpeditionRank ExpeditionRank; // 0x5C
