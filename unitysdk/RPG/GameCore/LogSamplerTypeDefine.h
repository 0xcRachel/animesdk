...
#define RPG_GAMECORE_LOGSAMPLERTYPEDEFINE_METHOD_2_928424D475F660BA_OFFSET UNITYSDK_OFFSET(0x18FCC2D0)
#define RPG_GAMECORE_LOGSAMPLERTYPEDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0x18FCC4D0)
