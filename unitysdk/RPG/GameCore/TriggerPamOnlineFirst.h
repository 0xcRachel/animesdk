...
#define RPG_GAMECORE_TRIGGERPAMONLINEFIRST_METHOD_3_2B54955ABC203EEE_OFFSET UNITYSDK_OFFSET(0x17124130)
#define RPG_GAMECORE_TRIGGERPAMONLINEFIRST_METHOD_3_A4E34F5CB7B62E22_OFFSET UNITYSDK_OFFSET(0x17124020)
#define RPG_GAMECORE_TRIGGERPAMONLINEFIRST__CTOR_OFFSET UNITYSDK_OFFSET(0x17124100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerPamOnlineFirst_TypeDefinitionIndex = 17783;
