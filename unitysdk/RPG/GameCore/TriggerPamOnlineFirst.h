...
#define RPG_GAMECORE_TRIGGERPAMONLINEFIRST_METHOD_3_2B54955ABC203EEE_OFFSET UNITYSDK_OFFSET(0x1911C270)
#define RPG_GAMECORE_TRIGGERPAMONLINEFIRST_METHOD_3_A4E34F5CB7B62E22_OFFSET UNITYSDK_OFFSET(0x1911C160)
#define RPG_GAMECORE_TRIGGERPAMONLINEFIRST__CTOR_OFFSET UNITYSDK_OFFSET(0x1911C240)
