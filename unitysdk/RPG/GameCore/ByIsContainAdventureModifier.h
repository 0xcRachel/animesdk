...
#define RPG_GAMECORE_BYISCONTAINADVENTUREMODIFIER_METHOD_4_35B2372ACE0BFE56_OFFSET UNITYSDK_OFFSET(0x1692E030)
#define RPG_GAMECORE_BYISCONTAINADVENTUREMODIFIER_METHOD_4_D9E9FE15D8B5E0D6_OFFSET UNITYSDK_OFFSET(0x1692DF60)
#define RPG_GAMECORE_BYISCONTAINADVENTUREMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1692DFE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsContainAdventureModifier_TypeDefinitionIndex = 18588;
