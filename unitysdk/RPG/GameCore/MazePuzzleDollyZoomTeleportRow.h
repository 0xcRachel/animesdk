...
#define RPG_GAMECORE_MAZEPUZZLEDOLLYZOOMTELEPORTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16C75420)
#define RPG_GAMECORE_MAZEPUZZLEDOLLYZOOMTELEPORTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16C757E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazePuzzleDollyZoomTeleportRow_TypeDefinitionIndex = 12809;
