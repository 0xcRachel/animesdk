...
#define RPG_GAMECORE_MAZEPUZZLEDOLLYZOOMTELEPORTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1908BF90)
#define RPG_GAMECORE_MAZEPUZZLEDOLLYZOOMTELEPORTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1908C350)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 InstanceIDB; // 0x40
