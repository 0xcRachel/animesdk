...
#define RPG_GAMECORE_MAZEPUZZLEDOLLYZOOMTELEPORTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x173DACE0)
#define RPG_GAMECORE_MAZEPUZZLEDOLLYZOOMTELEPORTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x173DB0A0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 OverridePosB; // 0x2C
		::System::UInt32 InstanceIDB; // 0x30
		::System::UInt32 InstanceIDA; // 0x34
		::System::UInt32 FloorID; // 0x38
		::System::UInt32 OverrideTargetPosA; // 0x3C
