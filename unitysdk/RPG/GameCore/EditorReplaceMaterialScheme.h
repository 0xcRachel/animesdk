...
#define RPG_GAMECORE_EDITORREPLACEMATERIALSCHEME_METHOD_2_05D769201B0A9329_OFFSET UNITYSDK_OFFSET(0x19148E10)
#define RPG_GAMECORE_EDITORREPLACEMATERIALSCHEME__CTOR_OFFSET UNITYSDK_OFFSET(0x19148FA0)
