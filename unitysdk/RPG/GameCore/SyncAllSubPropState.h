...
#define RPG_GAMECORE_SYNCALLSUBPROPSTATE_METHOD_3_4FD7A01B25BF1B31_OFFSET UNITYSDK_OFFSET(0x16FC30E0)
#define RPG_GAMECORE_SYNCALLSUBPROPSTATE_METHOD_3_9F04B73A42B39FE1_OFFSET UNITYSDK_OFFSET(0x16FC3170)
#define RPG_GAMECORE_SYNCALLSUBPROPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FC3140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SyncAllSubPropState_TypeDefinitionIndex = 19777;
