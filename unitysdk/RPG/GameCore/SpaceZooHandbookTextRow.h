...
#define RPG_GAMECORE_SPACEZOOHANDBOOKTEXTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16F73B20)
#define RPG_GAMECORE_SPACEZOOHANDBOOKTEXTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16F74190)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SpaceZooHandbookTextRow_TypeDefinitionIndex = 11242;
