...
#define RPG_GAMECORE_ROGUENOUSDIFFICULTYLEVELROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A50D600)
#define RPG_GAMECORE_ROGUENOUSDIFFICULTYLEVELROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A50DD40)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::RogueNousDifficultyType DifficultyType; // 0x20
		::System::UInt32 Tag; // 0x24
