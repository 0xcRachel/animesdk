...
#define RPG_GAMECORE_TARGETFETCHMAZEBUFFTARGETS_METHOD_4_8F65B389A8CB6D02_OFFSET UNITYSDK_OFFSET(0x16FD7E50)
#define RPG_GAMECORE_TARGETFETCHMAZEBUFFTARGETS_METHOD_4_CF4F72CA467439B0_OFFSET UNITYSDK_OFFSET(0x16FDDF30)
#define RPG_GAMECORE_TARGETFETCHMAZEBUFFTARGETS__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD7E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchMazeBuffTargets_TypeDefinitionIndex = 21649;
