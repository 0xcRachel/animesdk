...
#define RPG_GAMECORE_KILLNPCMONSTERINSERVER_METHOD_3_0D47B74A18A95FAC_OFFSET UNITYSDK_OFFSET(0x16B9D180)
#define RPG_GAMECORE_KILLNPCMONSTERINSERVER_METHOD_3_F9693CA833D692AC_OFFSET UNITYSDK_OFFSET(0x16B9D0F0)
#define RPG_GAMECORE_KILLNPCMONSTERINSERVER__CTOR_OFFSET UNITYSDK_OFFSET(0x16B9D150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int KillNPCMonsterInServer_TypeDefinitionIndex = 18089;
