...
#define RPG_GAMECORE_BYCOMPARESPECIALSPRATIO_METHOD_4_0AD23D08ABDAF911_OFFSET UNITYSDK_OFFSET(0x1691B280)
#define RPG_GAMECORE_BYCOMPARESPECIALSPRATIO_METHOD_4_1AF099FFF0498863_OFFSET UNITYSDK_OFFSET(0x1691B1B0)
#define RPG_GAMECORE_BYCOMPARESPECIALSPRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x1691B230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareSpecialSPRatio_TypeDefinitionIndex = 20653;
