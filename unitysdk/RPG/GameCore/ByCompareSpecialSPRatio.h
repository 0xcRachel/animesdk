...
#define RPG_GAMECORE_BYCOMPARESPECIALSPRATIO_METHOD_4_0AD23D08ABDAF911_OFFSET UNITYSDK_OFFSET(0x18FF1C60)
#define RPG_GAMECORE_BYCOMPARESPECIALSPRATIO_METHOD_4_1AF099FFF0498863_OFFSET UNITYSDK_OFFSET(0x18FF1B90)
#define RPG_GAMECORE_BYCOMPARESPECIALSPRATIO_METHOD_4_261CC8249E45543C_OFFSET UNITYSDK_OFFSET(0x18FF1F10)
#define RPG_GAMECORE_BYCOMPARESPECIALSPRATIO_METHOD_4_CDBFCB8B911A00E7_OFFSET UNITYSDK_OFFSET(0x18FF1E90)
#define RPG_GAMECORE_BYCOMPARESPECIALSPRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x18FF1C10)
