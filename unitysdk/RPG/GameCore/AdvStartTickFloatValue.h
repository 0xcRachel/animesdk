...
#define RPG_GAMECORE_ADVSTARTTICKFLOATVALUE_METHOD_3_2D1EB5FB598704A8_OFFSET UNITYSDK_OFFSET(0x1684BA80)
#define RPG_GAMECORE_ADVSTARTTICKFLOATVALUE_METHOD_3_9C23BA6C6A283F71_OFFSET UNITYSDK_OFFSET(0x1684BA00)
#define RPG_GAMECORE_ADVSTARTTICKFLOATVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1684BA50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvStartTickFloatValue_TypeDefinitionIndex = 18829;
