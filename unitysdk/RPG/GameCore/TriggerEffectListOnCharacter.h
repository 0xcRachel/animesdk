...
#define RPG_GAMECORE_TRIGGEREFFECTLISTONCHARACTER_METHOD_3_9A571E746DC07165_OFFSET UNITYSDK_OFFSET(0x1711E700)
#define RPG_GAMECORE_TRIGGEREFFECTLISTONCHARACTER_METHOD_3_B3BDEF99C7D3ED29_OFFSET UNITYSDK_OFFSET(0x1711E680)
#define RPG_GAMECORE_TRIGGEREFFECTLISTONCHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1711E6D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerEffectListOnCharacter_TypeDefinitionIndex = 19554;
