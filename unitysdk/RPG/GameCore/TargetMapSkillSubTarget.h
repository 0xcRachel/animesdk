...
#define RPG_GAMECORE_TARGETMAPSKILLSUBTARGET_METHOD_3_B53C203ABFEE55A8_OFFSET UNITYSDK_OFFSET(0x16FE33E0)
#define RPG_GAMECORE_TARGETMAPSKILLSUBTARGET_METHOD_3_D7F09573111D055D_OFFSET UNITYSDK_OFFSET(0x16FE34A0)
#define RPG_GAMECORE_TARGETMAPSKILLSUBTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE3480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapSkillSubTarget_TypeDefinitionIndex = 21736;
