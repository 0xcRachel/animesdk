...
#define RPG_GAMECORE_ROGUEPARAMSAVEDVALUECONFIG_METHOD_6_45FE769AE0D0C159_OFFSET UNITYSDK_OFFSET(0x1981CE00)
#define RPG_GAMECORE_ROGUEPARAMSAVEDVALUECONFIG_METHOD_6_C321777059D5777F_OFFSET UNITYSDK_OFFSET(0x1981CB50)
#define RPG_GAMECORE_ROGUEPARAMSAVEDVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1981CCD0)
