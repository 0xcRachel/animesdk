...
#define RPG_GAMECORE_GRIDFIGHTTRAITGAMEREFCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1729CE10)
#define RPG_GAMECORE_GRIDFIGHTTRAITGAMEREFCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1729D000)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 PenaltyScore; // 0x18
