...
#define RPG_GAMECORE_GRIDFIGHTTRAITGAMEREFCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B4E710)
#define RPG_GAMECORE_GRIDFIGHTTRAITGAMEREFCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B4E900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightTraitGameRefConfigRow_TypeDefinitionIndex = 12464;

	class GridFightTraitGameRefConfigRow : public ::System::Object
	{
	public:
		::System::UInt32 Season; // 0x10
		::System::UInt32 BasicScore; // 0x14
