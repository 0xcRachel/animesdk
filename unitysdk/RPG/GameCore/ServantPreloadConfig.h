...
#define RPG_GAMECORE_SERVANTPRELOADCONFIG_METHOD_3_8E0CA76276B3918C_OFFSET UNITYSDK_OFFSET(0x176B7C80)
#define RPG_GAMECORE_SERVANTPRELOADCONFIG_METHOD_3_AAFDFB12992C1B1F_OFFSET UNITYSDK_OFFSET(0x176B7C40)
#define RPG_GAMECORE_SERVANTPRELOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176B7C70)
