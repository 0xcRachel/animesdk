...
#define RPG_GAMECORE_SERVANTPRELOADCONFIG_METHOD_3_1C35F7284B8E6633_OFFSET UNITYSDK_OFFSET(0x1A1DFAD0)
#define RPG_GAMECORE_SERVANTPRELOADCONFIG_METHOD_3_FEAA68D8B5DA4430_OFFSET UNITYSDK_OFFSET(0x1A1DFB10)
#define RPG_GAMECORE_SERVANTPRELOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1DFB00)
