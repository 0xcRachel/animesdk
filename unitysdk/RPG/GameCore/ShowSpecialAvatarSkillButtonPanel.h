...
#define RPG_GAMECORE_SHOWSPECIALAVATARSKILLBUTTONPANEL_METHOD_3_4DF958C277D9827B_OFFSET UNITYSDK_OFFSET(0x16F63300)
#define RPG_GAMECORE_SHOWSPECIALAVATARSKILLBUTTONPANEL_METHOD_3_B01942101E16DF25_OFFSET UNITYSDK_OFFSET(0x16F63230)
#define RPG_GAMECORE_SHOWSPECIALAVATARSKILLBUTTONPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0x16F632B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowSpecialAvatarSkillButtonPanel_TypeDefinitionIndex = 20836;
