...
#define RPG_GAMECORE_LOADLEVELGROUP_METHOD_3_02B342015DCC8D5B_OFFSET UNITYSDK_OFFSET(0x16BD4990)
#define RPG_GAMECORE_LOADLEVELGROUP_METHOD_3_AAE98440668B0FF2_OFFSET UNITYSDK_OFFSET(0x16BD4910)
#define RPG_GAMECORE_LOADLEVELGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x16BD4960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoadLevelGroup_TypeDefinitionIndex = 19724;
