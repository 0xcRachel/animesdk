...
#define RPG_GAMECORE_FLOORCUSTOMFLOATCONFIG_METHOD_3_0A0F444FEAC5D6B8_OFFSET UNITYSDK_OFFSET(0x1A3ADFD0)
#define RPG_GAMECORE_FLOORCUSTOMFLOATCONFIG_METHOD_3_44EA7C921DD05EE7_OFFSET UNITYSDK_OFFSET(0x1A3ADF90)
#define RPG_GAMECORE_FLOORCUSTOMFLOATCONFIG_METHOD_3_4E5A3A43FA0B1B4B_OFFSET UNITYSDK_OFFSET(0x1A3AE100)
#define RPG_GAMECORE_FLOORCUSTOMFLOATCONFIG_METHOD_3_643D1015B1A24648_OFFSET UNITYSDK_OFFSET(0x1A3AE130)
#define RPG_GAMECORE_FLOORCUSTOMFLOATCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3ADFC0)
