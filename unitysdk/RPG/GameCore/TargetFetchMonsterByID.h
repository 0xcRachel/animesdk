...
#define RPG_GAMECORE_TARGETFETCHMONSTERBYID_METHOD_4_5770113543797A6B_OFFSET UNITYSDK_OFFSET(0x177CAE30)
#define RPG_GAMECORE_TARGETFETCHMONSTERBYID_METHOD_4_A160624307D82978_OFFSET UNITYSDK_OFFSET(0x177D3A40)
#define RPG_GAMECORE_TARGETFETCHMONSTERBYID__CTOR_OFFSET UNITYSDK_OFFSET(0x177CADE0)
