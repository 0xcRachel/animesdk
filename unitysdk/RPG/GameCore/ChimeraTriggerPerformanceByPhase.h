...
#define RPG_GAMECORE_CHIMERATRIGGERPERFORMANCEBYPHASE_METHOD_3_38C43E4F24F5EC03_OFFSET UNITYSDK_OFFSET(0x170C0BC0)
#define RPG_GAMECORE_CHIMERATRIGGERPERFORMANCEBYPHASE_METHOD_3_DB580490AE9AF272_OFFSET UNITYSDK_OFFSET(0x170C0C40)
#define RPG_GAMECORE_CHIMERATRIGGERPERFORMANCEBYPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x170C0C10)
