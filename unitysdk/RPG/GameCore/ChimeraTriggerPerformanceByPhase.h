...
#define RPG_GAMECORE_CHIMERATRIGGERPERFORMANCEBYPHASE_METHOD_3_38C43E4F24F5EC03_OFFSET UNITYSDK_OFFSET(0x1699EA70)
#define RPG_GAMECORE_CHIMERATRIGGERPERFORMANCEBYPHASE_METHOD_3_DB580490AE9AF272_OFFSET UNITYSDK_OFFSET(0x1699EAF0)
#define RPG_GAMECORE_CHIMERATRIGGERPERFORMANCEBYPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1699EAC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraTriggerPerformanceByPhase_TypeDefinitionIndex = 19364;
