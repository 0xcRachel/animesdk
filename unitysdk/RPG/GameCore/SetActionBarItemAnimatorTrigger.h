...
#define RPG_GAMECORE_SETACTIONBARITEMANIMATORTRIGGER_METHOD_3_26F40ACAE0E5E5E2_OFFSET UNITYSDK_OFFSET(0x176B8740)
#define RPG_GAMECORE_SETACTIONBARITEMANIMATORTRIGGER_METHOD_3_D8F2233D3B5E73F1_OFFSET UNITYSDK_OFFSET(0x176B87C0)
#define RPG_GAMECORE_SETACTIONBARITEMANIMATORTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x176B8790)
