...
#define RPG_GAMECORE_SETACTIONBARITEMANIMATORTRIGGER_METHOD_3_26F40ACAE0E5E5E2_OFFSET UNITYSDK_OFFSET(0x16F032B0)
#define RPG_GAMECORE_SETACTIONBARITEMANIMATORTRIGGER_METHOD_3_D8F2233D3B5E73F1_OFFSET UNITYSDK_OFFSET(0x16F03330)
#define RPG_GAMECORE_SETACTIONBARITEMANIMATORTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x16F03300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetActionBarItemAnimatorTrigger_TypeDefinitionIndex = 20841;
