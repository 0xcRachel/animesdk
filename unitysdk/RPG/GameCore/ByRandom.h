...
#define RPG_GAMECORE_BYRANDOM_METHOD_4_77CFDBACF938C128_OFFSET UNITYSDK_OFFSET(0x1704DA80)
#define RPG_GAMECORE_BYRANDOM_METHOD_4_C9B15B236C759968_OFFSET UNITYSDK_OFFSET(0x1704DB40)
#define RPG_GAMECORE_BYRANDOM__CTOR_OFFSET UNITYSDK_OFFSET(0x1704DAF0)
