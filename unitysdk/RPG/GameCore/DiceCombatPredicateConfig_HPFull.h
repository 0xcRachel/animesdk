...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_HPFULL_METHOD_4_2D1D988684420400_OFFSET UNITYSDK_OFFSET(0x195997C0)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_HPFULL_METHOD_4_524798FA21E548DA_OFFSET UNITYSDK_OFFSET(0x19596C50)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_HPFULL__CTOR_OFFSET UNITYSDK_OFFSET(0x19596C00)
