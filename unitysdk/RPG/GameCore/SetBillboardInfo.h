...
#define RPG_GAMECORE_SETBILLBOARDINFO_METHOD_3_0ED56062465A52B2_OFFSET UNITYSDK_OFFSET(0x16F0A4B0)
#define RPG_GAMECORE_SETBILLBOARDINFO_METHOD_3_48E858C916DF1D05_OFFSET UNITYSDK_OFFSET(0x16F0A2F0)
#define RPG_GAMECORE_SETBILLBOARDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16F0A480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBillboardInfo_TypeDefinitionIndex = 18239;
