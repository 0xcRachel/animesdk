...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERPLAYERLEVELUPCONFIG_METHOD_3_340BC7B61A042B5B_OFFSET UNITYSDK_OFFSET(0x16B2DD60)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERPLAYERLEVELUPCONFIG_METHOD_3_79B6404903D78CC2_OFFSET UNITYSDK_OFFSET(0x16B32770)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERPLAYERLEVELUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16B2DD10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterPlayerLevelUpConfig_TypeDefinitionIndex = 17371;
