...
#define RPG_GAMECORE_FIVEDIMBASEEVENTACTION_METHOD_2_A0E412DF95BA9607_OFFSET UNITYSDK_OFFSET(0x16AADB70)
#define RPG_GAMECORE_FIVEDIMBASEEVENTACTION_METHOD_2_C966ACC22D198A0E_OFFSET UNITYSDK_OFFSET(0x16AADCF0)
#define RPG_GAMECORE_FIVEDIMBASEEVENTACTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x16AADD50)
#define RPG_GAMECORE_FIVEDIMBASEEVENTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16AAA8F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimBaseEventAction_TypeDefinitionIndex = 16733;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Func_2<::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::FiveDimBaseEventAction*>*>**)Il2CppClass::FromTypeDefinitionIndex(FiveDimBaseEventAction_TypeDefinitionIndex)->GetStaticField(0x2A570);
		}
