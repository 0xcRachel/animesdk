...
#define RPG_GAMECORE_MAKECHARACTERHUDVISIBLE_METHOD_3_5DCCFC9B6A20DC8C_OFFSET UNITYSDK_OFFSET(0x1738BFE0)
#define RPG_GAMECORE_MAKECHARACTERHUDVISIBLE_METHOD_3_7637FFAA3CB52109_OFFSET UNITYSDK_OFFSET(0x1738C060)
#define RPG_GAMECORE_MAKECHARACTERHUDVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1738C030)
