...
#define RPG_GAMECORE_FOURROTATEVOXELSETENTITYENABLEACTION_METHOD_3_32FC3BA7A1F9B1A2_OFFSET UNITYSDK_OFFSET(0x1A3B8B00)
#define RPG_GAMECORE_FOURROTATEVOXELSETENTITYENABLEACTION_METHOD_3_B96D81A5A663C26E_OFFSET UNITYSDK_OFFSET(0x1A3B8C30)
#define RPG_GAMECORE_FOURROTATEVOXELSETENTITYENABLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3B8C10)
