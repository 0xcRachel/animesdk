...
#define RPG_GAMECORE_TRYREQUESTENTERREGION_METHOD_3_A325C1008CE911CF_OFFSET UNITYSDK_OFFSET(0x17129800)
#define RPG_GAMECORE_TRYREQUESTENTERREGION_METHOD_3_AAC5373C73794E50_OFFSET UNITYSDK_OFFSET(0x17129960)
#define RPG_GAMECORE_TRYREQUESTENTERREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x17129840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TryRequestEnterRegion_TypeDefinitionIndex = 18559;
