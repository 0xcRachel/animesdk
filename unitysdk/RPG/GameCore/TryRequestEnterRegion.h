...
#define RPG_GAMECORE_TRYREQUESTENTERREGION_METHOD_3_A325C1008CE911CF_OFFSET UNITYSDK_OFFSET(0x19121960)
#define RPG_GAMECORE_TRYREQUESTENTERREGION_METHOD_3_AAC5373C73794E50_OFFSET UNITYSDK_OFFSET(0x19121AC0)
#define RPG_GAMECORE_TRYREQUESTENTERREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x191219A0)
