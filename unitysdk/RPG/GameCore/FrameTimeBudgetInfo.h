...
#define RPG_GAMECORE_FRAMETIMEBUDGETINFO_METHOD_3_1B2F5A22944F090D_OFFSET UNITYSDK_OFFSET(0x16AE7350)
#define RPG_GAMECORE_FRAMETIMEBUDGETINFO_METHOD_3_BA967BAEBEBB1CB1_OFFSET UNITYSDK_OFFSET(0x16AE73E0)
#define RPG_GAMECORE_FRAMETIMEBUDGETINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16AE73B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FrameTimeBudgetInfo_TypeDefinitionIndex = 14820;
