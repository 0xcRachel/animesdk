...
#define RPG_GAMECORE_WAITENTITYSERVEREVENT_METHOD_3_6E4E4EA1CD2B3AAC_OFFSET UNITYSDK_OFFSET(0x19529D60)
#define RPG_GAMECORE_WAITENTITYSERVEREVENT_METHOD_3_7ADC3817CF8CFAE3_OFFSET UNITYSDK_OFFSET(0x19529CF0)
#define RPG_GAMECORE_WAITENTITYSERVEREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19529D30)
