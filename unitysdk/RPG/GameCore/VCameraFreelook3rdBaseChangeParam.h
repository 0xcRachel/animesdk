...
#define RPG_GAMECORE_VCAMERAFREELOOK3RDBASECHANGEPARAM_METHOD_2_89F28CB296EF73D6_OFFSET UNITYSDK_OFFSET(0x171455F0)
#define RPG_GAMECORE_VCAMERAFREELOOK3RDBASECHANGEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x171458F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VCameraFreelook3rdBaseChangeParam_TypeDefinitionIndex = 14768;
