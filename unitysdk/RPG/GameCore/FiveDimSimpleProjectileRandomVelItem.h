...
#define RPG_GAMECORE_FIVEDIMSIMPLEPROJECTILERANDOMVELITEM_METHOD_2_9B06471BFEA8F271_OFFSET UNITYSDK_OFFSET(0x1A3A4140)
#define RPG_GAMECORE_FIVEDIMSIMPLEPROJECTILERANDOMVELITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3A4250)
