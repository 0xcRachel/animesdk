...
#define RPG_GAMECORE_SETPROPABILITYTRIGGERENABLE_METHOD_3_AF8CE5AA5ACC7133_OFFSET UNITYSDK_OFFSET(0x199C2570)
#define RPG_GAMECORE_SETPROPABILITYTRIGGERENABLE_METHOD_3_B2E918AF9042BFE3_OFFSET UNITYSDK_OFFSET(0x199C2600)
#define RPG_GAMECORE_SETPROPABILITYTRIGGERENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x199C25D0)
