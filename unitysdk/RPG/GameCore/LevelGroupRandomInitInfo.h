...
#define RPG_GAMECORE_LEVELGROUPRANDOMINITINFO_METHOD_2_C4B4B5C01EA509A8_OFFSET UNITYSDK_OFFSET(0x18A2F2D0)
#define RPG_GAMECORE_LEVELGROUPRANDOMINITINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18A2F3A0)
