...
#define RPG_GAMECORE_LEVELGROUPRANDOMINITINFO_METHOD_2_C4B4B5C01EA509A8_OFFSET UNITYSDK_OFFSET(0x1734DBC0)
#define RPG_GAMECORE_LEVELGROUPRANDOMINITINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1734E6F0)
