...
#define RPG_GAMECORE_SHOWMENU_METHOD_3_77A4461E0BBAF89D_OFFSET UNITYSDK_OFFSET(0x16F5EFA0)
#define RPG_GAMECORE_SHOWMENU_METHOD_3_BAE7CE9298B9FB0C_OFFSET UNITYSDK_OFFSET(0x16F5F020)
#define RPG_GAMECORE_SHOWMENU__CTOR_OFFSET UNITYSDK_OFFSET(0x16F5EFF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowMenu_TypeDefinitionIndex = 18910;
