...
#define RPG_GAMECORE_SHOWSWIPEGUIDE_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x16F63940)
#define RPG_GAMECORE_SHOWSWIPEGUIDE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16F638A0)
#define RPG_GAMECORE_SHOWSWIPEGUIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F63900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowSwipeGuide_TypeDefinitionIndex = 21820;
