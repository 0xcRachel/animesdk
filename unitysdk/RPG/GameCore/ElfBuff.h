...
#define RPG_GAMECORE_ELFBUFF_METHOD_2_66B9AF3938784A97_OFFSET UNITYSDK_OFFSET(0x16A5E880)
#define RPG_GAMECORE_ELFBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x16A5EB30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfBuff_TypeDefinitionIndex = 16585;
