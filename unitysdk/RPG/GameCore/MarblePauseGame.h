...
#define RPG_GAMECORE_MARBLEPAUSEGAME_METHOD_3_BF47008A0EACEC9C_OFFSET UNITYSDK_OFFSET(0x19C3C350)
#define RPG_GAMECORE_MARBLEPAUSEGAME_METHOD_3_C28FDF29C3FAEF2D_OFFSET UNITYSDK_OFFSET(0x19C3C3A0)
#define RPG_GAMECORE_MARBLEPAUSEGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x199798D0)
