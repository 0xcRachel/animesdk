...
#define RPG_GAMECORE_UNIVERSALHOTFIXTASKC_METHOD_4_5F014F05327EAC77_OFFSET UNITYSDK_OFFSET(0x1713EC60)
#define RPG_GAMECORE_UNIVERSALHOTFIXTASKC_METHOD_4_962EFA6CE9315676_OFFSET UNITYSDK_OFFSET(0x1713ECE0)
#define RPG_GAMECORE_UNIVERSALHOTFIXTASKC__CTOR_OFFSET UNITYSDK_OFFSET(0x1713ECB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UniversalHotFixTaskC_TypeDefinitionIndex = 21030;
