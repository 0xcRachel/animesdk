...
#define RPG_GAMECORE_UNIVERSALHOTFIXTASKC_METHOD_4_5F014F05327EAC77_OFFSET UNITYSDK_OFFSET(0x178FAFE0)
#define RPG_GAMECORE_UNIVERSALHOTFIXTASKC_METHOD_4_962EFA6CE9315676_OFFSET UNITYSDK_OFFSET(0x178FAC70)
#define RPG_GAMECORE_UNIVERSALHOTFIXTASKC__CTOR_OFFSET UNITYSDK_OFFSET(0x178FAC40)
