...
#define RPG_GAMECORE_BGCURVEWITHDETECTPROJECTILEDATA_METHOD_3_24A4CEF664331574_OFFSET UNITYSDK_OFFSET(0x1764EF60)
#define RPG_GAMECORE_BGCURVEWITHDETECTPROJECTILEDATA_METHOD_3_623907DCD0CE9BCB_OFFSET UNITYSDK_OFFSET(0x1764EE40)
#define RPG_GAMECORE_BGCURVEWITHDETECTPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1764EEE0)
