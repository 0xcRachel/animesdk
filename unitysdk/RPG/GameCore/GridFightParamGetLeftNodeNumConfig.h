...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETLEFTNODENUMCONFIG_METHOD_6_9E99C6891DC38068_OFFSET UNITYSDK_OFFSET(0x172857B0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETLEFTNODENUMCONFIG_METHOD_6_F48435C241017AAE_OFFSET UNITYSDK_OFFSET(0x17285A60)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETLEFTNODENUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17285930)
