...
#define RPG_GAMECORE_ELFHEADWAITERTALKCONFIGITEM_METHOD_2_C7784405F8495958_OFFSET UNITYSDK_OFFSET(0x16A60D20)
#define RPG_GAMECORE_ELFHEADWAITERTALKCONFIGITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x16A60E70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfHeadWaiterTalkConfigItem_TypeDefinitionIndex = 16565;
