...
#define RPG_GAMECORE_FIVEDIMMUTEUIINPUTACTION_METHOD_3_9F1BB6EFC21DA9E2_OFFSET UNITYSDK_OFFSET(0x16ACA8E0)
#define RPG_GAMECORE_FIVEDIMMUTEUIINPUTACTION_METHOD_3_BEB95AD9924F5FB6_OFFSET UNITYSDK_OFFSET(0x16ACA7D0)
#define RPG_GAMECORE_FIVEDIMMUTEUIINPUTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16ACA8C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMuteUIInputAction_TypeDefinitionIndex = 16833;
