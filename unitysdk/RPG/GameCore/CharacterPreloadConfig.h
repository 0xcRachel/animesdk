...
#define RPG_GAMECORE_CHARACTERPRELOADCONFIG_METHOD_3_B2E8A12BEC2C251D_OFFSET UNITYSDK_OFFSET(0x16973A60)
#define RPG_GAMECORE_CHARACTERPRELOADCONFIG_METHOD_3_B64FDCDFCAACC286_OFFSET UNITYSDK_OFFSET(0x16973AA0)
#define RPG_GAMECORE_CHARACTERPRELOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16973A90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterPreloadConfig_TypeDefinitionIndex = 14705;
