...
#define RPG_GAMECORE_CHARACTERPRELOADCONFIG_METHOD_3_B2E8A12BEC2C251D_OFFSET UNITYSDK_OFFSET(0x170850E0)
#define RPG_GAMECORE_CHARACTERPRELOADCONFIG_METHOD_3_B64FDCDFCAACC286_OFFSET UNITYSDK_OFFSET(0x17085120)
#define RPG_GAMECORE_CHARACTERPRELOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17085110)
