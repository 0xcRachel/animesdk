...
#define RPG_GAMECORE_BYISROOTHITCALLBACK_METHOD_4_237726AA6455864A_OFFSET UNITYSDK_OFFSET(0x17046930)
#define RPG_GAMECORE_BYISROOTHITCALLBACK_METHOD_4_F4D37F4B18AAC7A0_OFFSET UNITYSDK_OFFSET(0x17046860)
#define RPG_GAMECORE_BYISROOTHITCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x170468E0)
