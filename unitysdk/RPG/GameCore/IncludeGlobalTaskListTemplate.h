...
#define RPG_GAMECORE_INCLUDEGLOBALTASKLISTTEMPLATE_METHOD_3_1D47ADF2D6E6A54D_OFFSET UNITYSDK_OFFSET(0x16B7F230)
#define RPG_GAMECORE_INCLUDEGLOBALTASKLISTTEMPLATE_METHOD_3_D6D9D89729B6928A_OFFSET UNITYSDK_OFFSET(0x16B7F2B0)
#define RPG_GAMECORE_INCLUDEGLOBALTASKLISTTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16B7F280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IncludeGlobalTaskListTemplate_TypeDefinitionIndex = 21546;
