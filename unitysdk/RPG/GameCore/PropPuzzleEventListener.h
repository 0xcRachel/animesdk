...
#define RPG_GAMECORE_PROPPUZZLEEVENTLISTENER_METHOD_3_A46B32C989A0968D_OFFSET UNITYSDK_OFFSET(0x16DAFE80)
#define RPG_GAMECORE_PROPPUZZLEEVENTLISTENER_METHOD_3_F687D4DB5BA8C136_OFFSET UNITYSDK_OFFSET(0x16DAFDE0)
#define RPG_GAMECORE_PROPPUZZLEEVENTLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x16DAFE40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropPuzzleEventListener_TypeDefinitionIndex = 19219;
