...
#define RPG_GAMECORE_BYPRESHOWSTANCEBREAK_METHOD_4_A9192C8777FB9B6C_OFFSET UNITYSDK_OFFSET(0x1693BD10)
#define RPG_GAMECORE_BYPRESHOWSTANCEBREAK_METHOD_4_D25B0E286E212A0C_OFFSET UNITYSDK_OFFSET(0x1693BDE0)
#define RPG_GAMECORE_BYPRESHOWSTANCEBREAK__CTOR_OFFSET UNITYSDK_OFFSET(0x1693BD90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByPreShowStanceBreak_TypeDefinitionIndex = 21209;
