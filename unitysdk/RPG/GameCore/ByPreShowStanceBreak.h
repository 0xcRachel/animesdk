...
#define RPG_GAMECORE_BYPRESHOWSTANCEBREAK_METHOD_4_A9192C8777FB9B6C_OFFSET UNITYSDK_OFFSET(0x1704D560)
#define RPG_GAMECORE_BYPRESHOWSTANCEBREAK_METHOD_4_D25B0E286E212A0C_OFFSET UNITYSDK_OFFSET(0x1704D630)
#define RPG_GAMECORE_BYPRESHOWSTANCEBREAK__CTOR_OFFSET UNITYSDK_OFFSET(0x1704D5E0)
