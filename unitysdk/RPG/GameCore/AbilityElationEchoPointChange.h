...
#define RPG_GAMECORE_ABILITYELATIONECHOPOINTCHANGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA7D8B00)
#define RPG_GAMECORE_ABILITYELATIONECHOPOINTCHANGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA7D8AB0)
#define RPG_GAMECORE_ABILITYELATIONECHOPOINTCHANGE_GET_CHANGEPARAMS_OFFSET UNITYSDK_OFFSET(0xA7D8B90)
#define RPG_GAMECORE_ABILITYELATIONECHOPOINTCHANGE_GET_CHANGEVALUE_OFFSET UNITYSDK_OFFSET(0xA7D8B70)
#define RPG_GAMECORE_ABILITYELATIONECHOPOINTCHANGE_GET_ORIGINMODIFYVALUE_OFFSET UNITYSDK_OFFSET(0xA7D8B50)
#define RPG_GAMECORE_ABILITYELATIONECHOPOINTCHANGE_INIT_OFFSET UNITYSDK_OFFSET(0xA7D89E0)
#define RPG_GAMECORE_ABILITYELATIONECHOPOINTCHANGE_SET_CHANGEPARAMS_OFFSET UNITYSDK_OFFSET(0xA7D8BB0)
#define RPG_GAMECORE_ABILITYELATIONECHOPOINTCHANGE_SET_CHANGEVALUE_OFFSET UNITYSDK_OFFSET(0xA7D8B80)
#define RPG_GAMECORE_ABILITYELATIONECHOPOINTCHANGE_SET_ORIGINMODIFYVALUE_OFFSET UNITYSDK_OFFSET(0xA7D8B60)
#define RPG_GAMECORE_ABILITYELATIONECHOPOINTCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0xA7D8BC0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::FixPoint _OriginModifyValue_k__BackingField; // 0x158
