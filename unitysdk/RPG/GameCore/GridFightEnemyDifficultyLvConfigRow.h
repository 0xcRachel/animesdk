...
#define RPG_GAMECORE_GRIDFIGHTENEMYDIFFICULTYLVCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AC83C90)
#define RPG_GAMECORE_GRIDFIGHTENEMYDIFFICULTYLVCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC84040)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::UInt32 EnemyDifficultyLevel; // 0x10
