...
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMFLOAT_METHOD_4_22D3954C35A47829_OFFSET UNITYSDK_OFFSET(0x18FD0C90)
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMFLOAT_METHOD_4_2CA4D93D0E56D12E_OFFSET UNITYSDK_OFFSET(0x18FD0A00)
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMFLOAT_METHOD_4_6F059005F6B0F8D8_OFFSET UNITYSDK_OFFSET(0x18FD0C10)
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMFLOAT_METHOD_4_DF71023972817F51_OFFSET UNITYSDK_OFFSET(0x18FD0920)
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x18FD09A0)
