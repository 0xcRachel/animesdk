...
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMFLOAT_METHOD_4_2CA4D93D0E56D12E_OFFSET UNITYSDK_OFFSET(0x1690BEA0)
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMFLOAT_METHOD_4_DF71023972817F51_OFFSET UNITYSDK_OFFSET(0x1690BDC0)
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1690BE40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareFloorCustomFloat_TypeDefinitionIndex = 18492;
