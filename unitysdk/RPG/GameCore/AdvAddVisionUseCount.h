...
#define RPG_GAMECORE_ADVADDVISIONUSECOUNT_METHOD_3_8621A750F817086E_OFFSET UNITYSDK_OFFSET(0x167C19F0)
#define RPG_GAMECORE_ADVADDVISIONUSECOUNT_METHOD_3_C3E87BD3F13F8AC1_OFFSET UNITYSDK_OFFSET(0x167C1960)
#define RPG_GAMECORE_ADVADDVISIONUSECOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x167C19C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvAddVisionUseCount_TypeDefinitionIndex = 18879;
