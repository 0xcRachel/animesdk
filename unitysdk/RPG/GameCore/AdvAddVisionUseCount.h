...
#define RPG_GAMECORE_ADVADDVISIONUSECOUNT_METHOD_3_0EE09F7FBA8974F9_OFFSET UNITYSDK_OFFSET(0x18DB9C60)
#define RPG_GAMECORE_ADVADDVISIONUSECOUNT_METHOD_3_9A216B599667E998_OFFSET UNITYSDK_OFFSET(0x18DB9BD0)
#define RPG_GAMECORE_ADVADDVISIONUSECOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x18DB9C30)
