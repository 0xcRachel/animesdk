...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBUFFNUMPARAM_METHOD_4_6C633578394B33C5_OFFSET UNITYSDK_OFFSET(0x1A1FDAA0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBUFFNUMPARAM_METHOD_4_6EC86CA88B115FF5_OFFSET UNITYSDK_OFFSET(0x1A1FDA10)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBUFFNUMPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1FDA70)
