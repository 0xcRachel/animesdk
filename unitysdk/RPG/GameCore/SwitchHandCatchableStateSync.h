...
#define RPG_GAMECORE_SWITCHHANDCATCHABLESTATESYNC_METHOD_3_59182387F5AE454D_OFFSET UNITYSDK_OFFSET(0x16FB4430)
#define RPG_GAMECORE_SWITCHHANDCATCHABLESTATESYNC_METHOD_3_F140AE5A7F71F2EB_OFFSET UNITYSDK_OFFSET(0x16FB44B0)
#define RPG_GAMECORE_SWITCHHANDCATCHABLESTATESYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x16FB4480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchHandCatchableStateSync_TypeDefinitionIndex = 18768;
