...
#define RPG_GAMECORE_ST_SIDE_ENABLEDIALOGUE_METHOD_4_42DE47E3563D55C4_OFFSET UNITYSDK_OFFSET(0x16EF7BA0)
#define RPG_GAMECORE_ST_SIDE_ENABLEDIALOGUE_METHOD_4_A8AC9FFC61C5F58E_OFFSET UNITYSDK_OFFSET(0x16EE77E0)
#define RPG_GAMECORE_ST_SIDE_ENABLEDIALOGUE__CTOR_OFFSET UNITYSDK_OFFSET(0x16EE7790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_EnableDialogue_TypeDefinitionIndex = 17911;
