...
#define RPG_GAMECORE_TEXTDYNAMICPARAMBASE_METHOD_2_11983C0DBACCDDAF_OFFSET UNITYSDK_OFFSET(0x194808B0)
#define RPG_GAMECORE_TEXTDYNAMICPARAMBASE_METHOD_2_7C3F7BBE76C0E431_OFFSET UNITYSDK_OFFSET(0x194805B0)
#define RPG_GAMECORE_TEXTDYNAMICPARAMBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x194808A0)
