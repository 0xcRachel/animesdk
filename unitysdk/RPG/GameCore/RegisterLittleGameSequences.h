...
#define RPG_GAMECORE_REGISTERLITTLEGAMESEQUENCES_METHOD_3_45A0595DB0B2A9B4_OFFSET UNITYSDK_OFFSET(0x16DD1410)
#define RPG_GAMECORE_REGISTERLITTLEGAMESEQUENCES_METHOD_3_D110A9F652F005E5_OFFSET UNITYSDK_OFFSET(0x16DD1390)
#define RPG_GAMECORE_REGISTERLITTLEGAMESEQUENCES__CTOR_OFFSET UNITYSDK_OFFSET(0x16DD13E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RegisterLittleGameSequences_TypeDefinitionIndex = 19109;
