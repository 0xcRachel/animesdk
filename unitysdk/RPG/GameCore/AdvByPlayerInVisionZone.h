...
#define RPG_GAMECORE_ADVBYPLAYERINVISIONZONE_METHOD_4_47A43F393F7ED89B_OFFSET UNITYSDK_OFFSET(0x1955C160)
#define RPG_GAMECORE_ADVBYPLAYERINVISIONZONE_METHOD_4_70DD4C1A4C0E3B65_OFFSET UNITYSDK_OFFSET(0x1955C230)
#define RPG_GAMECORE_ADVBYPLAYERINVISIONZONE_METHOD_4_CE9CA3712BC1FD65_OFFSET UNITYSDK_OFFSET(0x1955C470)
#define RPG_GAMECORE_ADVBYPLAYERINVISIONZONE_METHOD_4_E15A2D0D26992B61_OFFSET UNITYSDK_OFFSET(0x1955C3F0)
#define RPG_GAMECORE_ADVBYPLAYERINVISIONZONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1955C1E0)
