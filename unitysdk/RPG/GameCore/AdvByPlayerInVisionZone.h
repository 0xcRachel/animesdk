...
#define RPG_GAMECORE_ADVBYPLAYERINVISIONZONE_METHOD_4_47A43F393F7ED89B_OFFSET UNITYSDK_OFFSET(0x1682EBA0)
#define RPG_GAMECORE_ADVBYPLAYERINVISIONZONE_METHOD_4_70DD4C1A4C0E3B65_OFFSET UNITYSDK_OFFSET(0x1682EC70)
#define RPG_GAMECORE_ADVBYPLAYERINVISIONZONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1682EC20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByPlayerInVisionZone_TypeDefinitionIndex = 17775;
