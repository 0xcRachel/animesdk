...
#define RPG_GAMECORE_ADVCHARACTERSTEERTOINPUTDIR_METHOD_3_1F605BCABA65CBFE_OFFSET UNITYSDK_OFFSET(0x18DBEB10)
#define RPG_GAMECORE_ADVCHARACTERSTEERTOINPUTDIR_METHOD_3_5D861ADE43A37ABD_OFFSET UNITYSDK_OFFSET(0x18DBEB90)
#define RPG_GAMECORE_ADVCHARACTERSTEERTOINPUTDIR__CTOR_OFFSET UNITYSDK_OFFSET(0x18DBEB60)
