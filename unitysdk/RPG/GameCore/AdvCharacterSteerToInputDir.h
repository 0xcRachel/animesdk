...
#define RPG_GAMECORE_ADVCHARACTERSTEERTOINPUTDIR_METHOD_3_1F605BCABA65CBFE_OFFSET UNITYSDK_OFFSET(0x1682FDC0)
#define RPG_GAMECORE_ADVCHARACTERSTEERTOINPUTDIR_METHOD_3_5D861ADE43A37ABD_OFFSET UNITYSDK_OFFSET(0x1682FE40)
#define RPG_GAMECORE_ADVCHARACTERSTEERTOINPUTDIR__CTOR_OFFSET UNITYSDK_OFFSET(0x1682FE10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvCharacterSteerToInputDir_TypeDefinitionIndex = 18004;
