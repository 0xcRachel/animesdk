...
#define RPG_GAMECORE_ADVNPCPETSEARCH_METHOD_3_362164B95CEA7F3B_OFFSET UNITYSDK_OFFSET(0x1683FF90)
#define RPG_GAMECORE_ADVNPCPETSEARCH_METHOD_3_89CB789BC8459EF6_OFFSET UNITYSDK_OFFSET(0x1683FEF0)
#define RPG_GAMECORE_ADVNPCPETSEARCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1683FF50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNpcPetSearch_TypeDefinitionIndex = 17745;
