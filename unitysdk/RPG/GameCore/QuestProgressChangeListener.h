...
#define RPG_GAMECORE_QUESTPROGRESSCHANGELISTENER_METHOD_3_CC31604B3114D401_OFFSET UNITYSDK_OFFSET(0x1758BAC0)
#define RPG_GAMECORE_QUESTPROGRESSCHANGELISTENER_METHOD_3_DDD8B67C8961A878_OFFSET UNITYSDK_OFFSET(0x1758BB40)
#define RPG_GAMECORE_QUESTPROGRESSCHANGELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1758BB10)
