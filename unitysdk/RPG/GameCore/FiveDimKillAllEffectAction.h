...
#define RPG_GAMECORE_FIVEDIMKILLALLEFFECTACTION_METHOD_3_1155A87AA86CE355_OFFSET UNITYSDK_OFFSET(0x171FCC20)
#define RPG_GAMECORE_FIVEDIMKILLALLEFFECTACTION_METHOD_3_85742BE2CE758E41_OFFSET UNITYSDK_OFFSET(0x1720C3A0)
#define RPG_GAMECORE_FIVEDIMKILLALLEFFECTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x171FCC00)
