...
#define RPG_GAMECORE_FIVEDIMKILLALLEFFECTACTION_METHOD_3_1155A87AA86CE355_OFFSET UNITYSDK_OFFSET(0x16AC34F0)
#define RPG_GAMECORE_FIVEDIMKILLALLEFFECTACTION_METHOD_3_85742BE2CE758E41_OFFSET UNITYSDK_OFFSET(0x16AC33C0)
#define RPG_GAMECORE_FIVEDIMKILLALLEFFECTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16AC34D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimKillAllEffectAction_TypeDefinitionIndex = 16809;
