...
#define RPG_GAMECORE_TARGETFETCHLASTKILLTARGET_METHOD_4_68AC57714A38FDF3_OFFSET UNITYSDK_OFFSET(0x199DA800)
#define RPG_GAMECORE_TARGETFETCHLASTKILLTARGET_METHOD_4_B4568B8EA59C1FE5_OFFSET UNITYSDK_OFFSET(0x199E1740)
#define RPG_GAMECORE_TARGETFETCHLASTKILLTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x199DA7B0)
