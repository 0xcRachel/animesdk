...
#define RPG_GAMECORE_TARGETFETCHLASTKILLTARGET_METHOD_4_68AC57714A38FDF3_OFFSET UNITYSDK_OFFSET(0x16FD7570)
#define RPG_GAMECORE_TARGETFETCHLASTKILLTARGET_METHOD_4_B4568B8EA59C1FE5_OFFSET UNITYSDK_OFFSET(0x16FDD950)
#define RPG_GAMECORE_TARGETFETCHLASTKILLTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD7520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchLastKillTarget_TypeDefinitionIndex = 21716;
