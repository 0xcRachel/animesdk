...
#define RPG_GAMECORE_BYCOMPAREUNUSEDINSERTABILITYCOUNT_METHOD_4_10EE79D0FD7575C8_OFFSET UNITYSDK_OFFSET(0x1691F590)
#define RPG_GAMECORE_BYCOMPAREUNUSEDINSERTABILITYCOUNT_METHOD_4_82F44DB474616D00_OFFSET UNITYSDK_OFFSET(0x1691F660)
#define RPG_GAMECORE_BYCOMPAREUNUSEDINSERTABILITYCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1691F610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareUnusedInsertAbilityCount_TypeDefinitionIndex = 20707;
