...
#define RPG_GAMECORE_EVOLVETALKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA40BDE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EvolveTalkConfig_TypeDefinitionIndex = 46264;
