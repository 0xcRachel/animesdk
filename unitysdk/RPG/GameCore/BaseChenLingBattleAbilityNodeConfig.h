...
#define RPG_GAMECORE_BASECHENLINGBATTLEABILITYNODECONFIG_METHOD_2_01722AB5C1B1D7F0_OFFSET UNITYSDK_OFFSET(0x17651D50)
#define RPG_GAMECORE_BASECHENLINGBATTLEABILITYNODECONFIG_METHOD_2_B02D10049B0F6C90_OFFSET UNITYSDK_OFFSET(0x17652600)
#define RPG_GAMECORE_BASECHENLINGBATTLEABILITYNODECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17652660)
