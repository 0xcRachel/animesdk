...
#define RPG_GAMECORE_TIMELINEENTITYSTATECHANGECALLBACK_METHOD_2_3C8A5CF93A79E3D7_OFFSET UNITYSDK_OFFSET(0x170F72A0)
#define RPG_GAMECORE_TIMELINEENTITYSTATECHANGECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x170F7410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimelineEntityStateChangeCallback_TypeDefinitionIndex = 18427;
