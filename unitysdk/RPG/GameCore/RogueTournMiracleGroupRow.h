...
#define RPG_GAMECORE_ROGUETOURNMIRACLEGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16ECC310)
#define RPG_GAMECORE_ROGUETOURNMIRACLEGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16ECC3D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournMiracleGroupRow_TypeDefinitionIndex = 13667;
