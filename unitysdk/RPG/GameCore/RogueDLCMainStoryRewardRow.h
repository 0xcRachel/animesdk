...
#define RPG_GAMECORE_ROGUEDLCMAINSTORYREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19260AF0)
#define RPG_GAMECORE_ROGUEDLCMAINSTORYREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19261590)
