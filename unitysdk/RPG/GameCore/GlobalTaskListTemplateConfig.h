...
#define RPG_GAMECORE_GLOBALTASKLISTTEMPLATECONFIG_METHOD_2_2DD6F3E68EF7D6C7_OFFSET UNITYSDK_OFFSET(0x16B119F0)
#define RPG_GAMECORE_GLOBALTASKLISTTEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16B11AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GlobalTaskListTemplateConfig_TypeDefinitionIndex = 16364;
