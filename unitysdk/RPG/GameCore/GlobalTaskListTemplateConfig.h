...
#define RPG_GAMECORE_GLOBALTASKLISTTEMPLATECONFIG_METHOD_2_2DD6F3E68EF7D6C7_OFFSET UNITYSDK_OFFSET(0x1955D0B0)
#define RPG_GAMECORE_GLOBALTASKLISTTEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1955D1B0)
