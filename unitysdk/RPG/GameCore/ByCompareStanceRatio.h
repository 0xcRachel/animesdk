...
#define RPG_GAMECORE_BYCOMPARESTANCERATIO_METHOD_4_4D3A850E0EBE9A57_OFFSET UNITYSDK_OFFSET(0x1691C020)
#define RPG_GAMECORE_BYCOMPARESTANCERATIO_METHOD_4_756D64010A051C35_OFFSET UNITYSDK_OFFSET(0x1691C0F0)
#define RPG_GAMECORE_BYCOMPARESTANCERATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x1691C0A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareStanceRatio_TypeDefinitionIndex = 20654;
