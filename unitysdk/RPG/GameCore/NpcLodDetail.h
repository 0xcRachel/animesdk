...
#define RPG_GAMECORE_NPCLODDETAIL_METHOD_3_5170ABD7599572F7_OFFSET UNITYSDK_OFFSET(0x16D045A0)
#define RPG_GAMECORE_NPCLODDETAIL_METHOD_3_A081879910A33027_OFFSET UNITYSDK_OFFSET(0x16D04550)
#define RPG_GAMECORE_NPCLODDETAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x16D04590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NpcLodDetail_TypeDefinitionIndex = 17088;
