...
#define RPG_GAMECORE_EVOLVEBUILDSTAGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A3F4580)
#define RPG_GAMECORE_EVOLVEBUILDSTAGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3F6650)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* InitialWeapon; // 0x60
		::RPG::Client::TextID BuffTextFormat; // 0x68
		::System::UInt32 UnlockQuest; // 0x78
		::System::UInt32 TeamBonusMazeBuffID; // 0x7C
		::RPG::Client::TextID Desc; // 0x80
		::System::Int32 Difficulty; // 0x90
		::RPG::GameCore::EvolveBuildSeason Season; // 0x94
		::System::UInt32 StageMergedID; // 0x98
		::System::Boolean WeaponSelectable; // 0x9C
		::RPG::Client::TextID Name; // 0xA0
		::System::UInt32 IntroID; // 0xB0
		::RPG::Client::TextID DevilDesc; // 0xB8
