...
#define RPG_GAMECORE_TARGETTAKE_METHOD_3_B8832C23CD13191E_OFFSET UNITYSDK_OFFSET(0x171351B0)
#define RPG_GAMECORE_TARGETTAKE_METHOD_3_EA417FCA038D72B4_OFFSET UNITYSDK_OFFSET(0x17135DE0)
#define RPG_GAMECORE_TARGETTAKE__CTOR_OFFSET UNITYSDK_OFFSET(0x17135190)
