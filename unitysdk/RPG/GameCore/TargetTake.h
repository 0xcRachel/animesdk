...
#define RPG_GAMECORE_TARGETTAKE_METHOD_3_B8832C23CD13191E_OFFSET UNITYSDK_OFFSET(0x16FF2180)
#define RPG_GAMECORE_TARGETTAKE_METHOD_3_EA417FCA038D72B4_OFFSET UNITYSDK_OFFSET(0x16FF2CF0)
#define RPG_GAMECORE_TARGETTAKE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FF2160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetTake_TypeDefinitionIndex = 21616;
