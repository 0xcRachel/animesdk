...
#define RPG_GAMECORE_BYISINSERTACTION_METHOD_4_1B9E9A6ED6F3EC94_OFFSET UNITYSDK_OFFSET(0x169337C0)
#define RPG_GAMECORE_BYISINSERTACTION_METHOD_4_E67CE8DCAE851584_OFFSET UNITYSDK_OFFSET(0x169336F0)
#define RPG_GAMECORE_BYISINSERTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16933770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsInsertAction_TypeDefinitionIndex = 20202;
