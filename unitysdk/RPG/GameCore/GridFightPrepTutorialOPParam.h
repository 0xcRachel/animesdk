...
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALOPPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1871D320)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::RPG::GameCore::GridFightPrepTutorialTopHintParam* TopHintParam; // 0x10
		::RPG::GameCore::GridFightPrepTutorialSetGoldNumParam* SetGoldNumParam; // 0x18
		::RPG::GameCore::GridFightPrepTutorialPopupPanelVisibleParam* PopupPanelVisibleParam; // 0x20
