...
#define RPG_GAMECORE_REDDOTCONFIG_METHOD_2_6957707CEC9E832D_OFFSET UNITYSDK_OFFSET(0x1759C3E0)
#define RPG_GAMECORE_REDDOTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1759C550)
