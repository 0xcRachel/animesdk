...
#define RPG_GAMECORE_BYCOMPARECHARACTERNUMBER_METHOD_4_30E9B6BB2733D2E6_OFFSET UNITYSDK_OFFSET(0x16907D60)
#define RPG_GAMECORE_BYCOMPARECHARACTERNUMBER_METHOD_4_38CE48CB31224984_OFFSET UNITYSDK_OFFSET(0x16907C80)
#define RPG_GAMECORE_BYCOMPARECHARACTERNUMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x16907D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareCharacterNumber_TypeDefinitionIndex = 20660;
