...
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALOP_METHOD_3_3467D788080562B9_OFFSET UNITYSDK_OFFSET(0x16B41530)
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALOP_METHOD_3_B5D1B10894A84B0D_OFFSET UNITYSDK_OFFSET(0x16B415B0)
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALOP__CTOR_OFFSET UNITYSDK_OFFSET(0x16B41580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightPrepTutorialOP_TypeDefinitionIndex = 17726;
