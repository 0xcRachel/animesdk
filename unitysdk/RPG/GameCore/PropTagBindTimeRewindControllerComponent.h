...
#define RPG_GAMECORE_PROPTAGBINDTIMEREWINDCONTROLLERCOMPONENT_METHOD_3_17842D26D5142366_OFFSET UNITYSDK_OFFSET(0x17584BD0)
#define RPG_GAMECORE_PROPTAGBINDTIMEREWINDCONTROLLERCOMPONENT_METHOD_3_6FA78EA814811477_OFFSET UNITYSDK_OFFSET(0x17584C20)
#define RPG_GAMECORE_PROPTAGBINDTIMEREWINDCONTROLLERCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x17584C10)
