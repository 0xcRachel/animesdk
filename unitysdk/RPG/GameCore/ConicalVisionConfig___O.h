...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::EntityTag>**)Il2CppClass::FromTypeDefinitionIndex(ConicalVisionConfig___O_TypeDefinitionIndex)->GetStaticField(0x2BE40);
		}
	};
}
