...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCE_METHOD_2_C9DE6815EF87F921_OFFSET UNITYSDK_OFFSET(0x169BD2F0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCE_METHOD_2_F986F3B63223080A_OFFSET UNITYSDK_OFFSET(0x169BA840)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCE__CCTOR_OFFSET UNITYSDK_OFFSET(0x169BD350)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x169BA9C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISource_TypeDefinitionIndex = 14099;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Func_2<::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::ComplexSkillAISource*>*>**)Il2CppClass::FromTypeDefinitionIndex(ComplexSkillAISource_TypeDefinitionIndex)->GetStaticField(0x29780);
		}
