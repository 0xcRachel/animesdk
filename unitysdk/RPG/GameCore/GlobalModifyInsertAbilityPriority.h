...
#define RPG_GAMECORE_GLOBALMODIFYINSERTABILITYPRIORITY_METHOD_3_5D68C384ACDB2B19_OFFSET UNITYSDK_OFFSET(0x16B10F90)
#define RPG_GAMECORE_GLOBALMODIFYINSERTABILITYPRIORITY_METHOD_3_B9F9E929A0771D37_OFFSET UNITYSDK_OFFSET(0x16B11010)
#define RPG_GAMECORE_GLOBALMODIFYINSERTABILITYPRIORITY__CTOR_OFFSET UNITYSDK_OFFSET(0x16B10FE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GlobalModifyInsertAbilityPriority_TypeDefinitionIndex = 20302;
