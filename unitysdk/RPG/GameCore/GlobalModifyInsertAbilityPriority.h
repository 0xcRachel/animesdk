...
#define RPG_GAMECORE_GLOBALMODIFYINSERTABILITYPRIORITY_METHOD_3_5D68C384ACDB2B19_OFFSET UNITYSDK_OFFSET(0x1725CE10)
#define RPG_GAMECORE_GLOBALMODIFYINSERTABILITYPRIORITY_METHOD_3_B9F9E929A0771D37_OFFSET UNITYSDK_OFFSET(0x1725CE90)
#define RPG_GAMECORE_GLOBALMODIFYINSERTABILITYPRIORITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1725CE60)
