...
#define RPG_GAMECORE_FINISHACTIONCONFIG_METHOD_2_22670B67281000AB_OFFSET UNITYSDK_OFFSET(0x18D1B010)
#define RPG_GAMECORE_FINISHACTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D1B1A0)
