...
#define RPG_GAMECORE_ST_SIDE_ATTACHAISTATUS_METHOD_4_561B7EBCBC0C9E1E_OFFSET UNITYSDK_OFFSET(0x1A170170)
#define RPG_GAMECORE_ST_SIDE_ATTACHAISTATUS_METHOD_4_C14AB33BDE12ED14_OFFSET UNITYSDK_OFFSET(0x1A182510)
#define RPG_GAMECORE_ST_SIDE_ATTACHAISTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A170120)
