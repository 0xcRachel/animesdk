...
#define RPG_GAMECORE_CHANGECHARACTERCONFIGPARAMCLIENTONLY_METHOD_4_63FDA03847DD5B14_OFFSET UNITYSDK_OFFSET(0x17075910)
#define RPG_GAMECORE_CHANGECHARACTERCONFIGPARAMCLIENTONLY_METHOD_4_73A51CC14A070A8D_OFFSET UNITYSDK_OFFSET(0x17075460)
#define RPG_GAMECORE_CHANGECHARACTERCONFIGPARAMCLIENTONLY__CTOR_OFFSET UNITYSDK_OFFSET(0x170753C0)
