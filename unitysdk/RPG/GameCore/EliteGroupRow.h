...
#define RPG_GAMECORE_ELITEGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x171A78A0)
#define RPG_GAMECORE_ELITEGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x171A8090)
