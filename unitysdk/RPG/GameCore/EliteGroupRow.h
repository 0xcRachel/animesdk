...
#define RPG_GAMECORE_ELITEGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16A650B0)
#define RPG_GAMECORE_ELITEGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16A658A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EliteGroupRow_TypeDefinitionIndex = 12909;
