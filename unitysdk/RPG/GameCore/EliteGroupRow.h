...
#define RPG_GAMECORE_ELITEGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19153F10)
#define RPG_GAMECORE_ELITEGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19154700)
