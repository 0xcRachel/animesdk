...
#define RPG_GAMECORE_ADVSETCONFINEFEATUREPARAM_METHOD_3_D94041FFD446F4F5_OFFSET UNITYSDK_OFFSET(0x18C5A7D0)
#define RPG_GAMECORE_ADVSETCONFINEFEATUREPARAM_METHOD_3_F7A2F31455B41CE3_OFFSET UNITYSDK_OFFSET(0x18C5A850)
#define RPG_GAMECORE_ADVSETCONFINEFEATUREPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x18C5A820)
