...
#define RPG_GAMECORE_BYCONTAINSREDSTANCE_METHOD_4_3B5639C642EB37EF_OFFSET UNITYSDK_OFFSET(0x169214D0)
#define RPG_GAMECORE_BYCONTAINSREDSTANCE_METHOD_4_CA48AD5BFC6BFFF9_OFFSET UNITYSDK_OFFSET(0x169215A0)
#define RPG_GAMECORE_BYCONTAINSREDSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x16921550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByContainsRedStance_TypeDefinitionIndex = 20265;
