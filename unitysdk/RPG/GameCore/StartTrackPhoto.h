...
#define RPG_GAMECORE_STARTTRACKPHOTO_METHOD_3_4FA7809B47358C4A_OFFSET UNITYSDK_OFFSET(0x16F972D0)
#define RPG_GAMECORE_STARTTRACKPHOTO_METHOD_3_F90E537199E2F672_OFFSET UNITYSDK_OFFSET(0x16F97350)
#define RPG_GAMECORE_STARTTRACKPHOTO__CTOR_OFFSET UNITYSDK_OFFSET(0x16F97320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartTrackPhoto_TypeDefinitionIndex = 19284;
