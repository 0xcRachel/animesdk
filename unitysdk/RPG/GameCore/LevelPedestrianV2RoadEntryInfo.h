...
#define RPG_GAMECORE_LEVELPEDESTRIANV2ROADENTRYINFO_METHOD_2_662403E26E324806_OFFSET UNITYSDK_OFFSET(0x16BB67D0)
#define RPG_GAMECORE_LEVELPEDESTRIANV2ROADENTRYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16BB9C40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPedestrianV2RoadEntryInfo_TypeDefinitionIndex = 15606;
