...
#define RPG_GAMECORE_PUPPYSEARCHPROPDATA_METHOD_2_91678DA9CCF20B26_OFFSET UNITYSDK_OFFSET(0x16DBCAE0)
#define RPG_GAMECORE_PUPPYSEARCHPROPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16DBCBE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PuppySearchPropData_TypeDefinitionIndex = 15881;
