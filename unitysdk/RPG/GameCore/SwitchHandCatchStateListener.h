...
#define RPG_GAMECORE_SWITCHHANDCATCHSTATELISTENER_METHOD_3_9E829A2D5918927C_OFFSET UNITYSDK_OFFSET(0x16FB4220)
#define RPG_GAMECORE_SWITCHHANDCATCHSTATELISTENER_METHOD_3_FC37EE12B42B086C_OFFSET UNITYSDK_OFFSET(0x16FB42A0)
#define RPG_GAMECORE_SWITCHHANDCATCHSTATELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x16FB4270)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchHandCatchStateListener_TypeDefinitionIndex = 18775;
