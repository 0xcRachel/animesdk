...
#define RPG_GAMECORE_AVATARRANKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16FBE6B0)
#define RPG_GAMECORE_AVATARRANKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16FBEFA0)
