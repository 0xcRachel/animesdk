...
#define RPG_GAMECORE_FIVEDIMSTAGEVIEWCONFIG_METHOD_4_B07B6CB33250D2C4_OFFSET UNITYSDK_OFFSET(0x1A3A5FD0)
#define RPG_GAMECORE_FIVEDIMSTAGEVIEWCONFIG_METHOD_4_DF6BF463C1DCF9B9_OFFSET UNITYSDK_OFFSET(0x1A3A5F60)
#define RPG_GAMECORE_FIVEDIMSTAGEVIEWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3A5FB0)
