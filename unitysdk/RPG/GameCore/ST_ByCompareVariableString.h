...
#define RPG_GAMECORE_ST_BYCOMPAREVARIABLESTRING_METHOD_4_4451AD2F76E73CD4_OFFSET UNITYSDK_OFFSET(0x176A6210)
#define RPG_GAMECORE_ST_BYCOMPAREVARIABLESTRING_METHOD_4_B65510496ECC4C40_OFFSET UNITYSDK_OFFSET(0x176A6140)
#define RPG_GAMECORE_ST_BYCOMPAREVARIABLESTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x176A61C0)
