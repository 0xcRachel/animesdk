...
#define RPG_GAMECORE_SETMONSTERVIEWPHASE_METHOD_3_1E701FAEFBCCA000_OFFSET UNITYSDK_OFFSET(0x176ECFB0)
#define RPG_GAMECORE_SETMONSTERVIEWPHASE_METHOD_3_77D02E6125E1D74B_OFFSET UNITYSDK_OFFSET(0x176ECEE0)
#define RPG_GAMECORE_SETMONSTERVIEWPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x176ECF60)
