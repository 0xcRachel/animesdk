...
#define RPG_GAMECORE_CEBATTLEPRESETCONFIG_METHOD_2_CB2463969EB53484_OFFSET UNITYSDK_OFFSET(0x16942290)
#define RPG_GAMECORE_CEBATTLEPRESETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16942610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CEBattlePresetConfig_TypeDefinitionIndex = 16276;
