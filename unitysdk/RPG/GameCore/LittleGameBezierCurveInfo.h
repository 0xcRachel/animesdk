...
#define RPG_GAMECORE_LITTLEGAMEBEZIERCURVEINFO_METHOD_3_0B5A6A046CE77CA9_OFFSET UNITYSDK_OFFSET(0x16BC5260)
#define RPG_GAMECORE_LITTLEGAMEBEZIERCURVEINFO_METHOD_3_8B071BD4E0283A69_OFFSET UNITYSDK_OFFSET(0x16BC53E0)
#define RPG_GAMECORE_LITTLEGAMEBEZIERCURVEINFO_METHOD_3_D978819B0A4871A0_OFFSET UNITYSDK_OFFSET(0x16BC53D0)
#define RPG_GAMECORE_LITTLEGAMEBEZIERCURVEINFO_METHOD_3_F76D7505EE61B432_OFFSET UNITYSDK_OFFSET(0x16BC52A0)
#define RPG_GAMECORE_LITTLEGAMEBEZIERCURVEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16BC5290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameBezierCurveInfo_TypeDefinitionIndex = 16898;
