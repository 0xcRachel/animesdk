...
#define RPG_GAMECORE_ST_CHESS_BYHASLOCKTARGET_METHOD_4_0AE146482DA4C523_OFFSET UNITYSDK_OFFSET(0x16EF1B40)
#define RPG_GAMECORE_ST_CHESS_BYHASLOCKTARGET_METHOD_4_AAFF1623CB143EA9_OFFSET UNITYSDK_OFFSET(0x16EF1C10)
#define RPG_GAMECORE_ST_CHESS_BYHASLOCKTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x16EF1BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Chess_ByHasLockTarget_TypeDefinitionIndex = 21441;
