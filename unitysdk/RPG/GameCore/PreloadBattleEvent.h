...
#define RPG_GAMECORE_PRELOADBATTLEEVENT_METHOD_3_9022B7CF65F1F8FA_OFFSET UNITYSDK_OFFSET(0x175255A0)
#define RPG_GAMECORE_PRELOADBATTLEEVENT_METHOD_3_F154C3690F4AFF83_OFFSET UNITYSDK_OFFSET(0x17525620)
#define RPG_GAMECORE_PRELOADBATTLEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x175255F0)
