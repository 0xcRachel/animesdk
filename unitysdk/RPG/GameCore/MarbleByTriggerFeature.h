...
#define RPG_GAMECORE_MARBLEBYTRIGGERFEATURE_METHOD_4_1D3B534BF39584C8_OFFSET UNITYSDK_OFFSET(0x173A08A0)
#define RPG_GAMECORE_MARBLEBYTRIGGERFEATURE_METHOD_4_4012E7618A15738D_OFFSET UNITYSDK_OFFSET(0x173A0980)
#define RPG_GAMECORE_MARBLEBYTRIGGERFEATURE__CTOR_OFFSET UNITYSDK_OFFSET(0x173A0930)
