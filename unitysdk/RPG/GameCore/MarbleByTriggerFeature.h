...
#define RPG_GAMECORE_MARBLEBYTRIGGERFEATURE_METHOD_4_5576D8B107C1464B_OFFSET UNITYSDK_OFFSET(0x19C34D10)
#define RPG_GAMECORE_MARBLEBYTRIGGERFEATURE_METHOD_4_BC90040FB31B422E_OFFSET UNITYSDK_OFFSET(0x19C34C30)
#define RPG_GAMECORE_MARBLEBYTRIGGERFEATURE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C34CC0)
