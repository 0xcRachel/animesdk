...
#define RPG_GAMECORE_MARBLEBYTRIGGERFEATURE_METHOD_4_1D3B534BF39584C8_OFFSET UNITYSDK_OFFSET(0x16C3BA30)
#define RPG_GAMECORE_MARBLEBYTRIGGERFEATURE_METHOD_4_4012E7618A15738D_OFFSET UNITYSDK_OFFSET(0x16C3BB10)
#define RPG_GAMECORE_MARBLEBYTRIGGERFEATURE__CTOR_OFFSET UNITYSDK_OFFSET(0x16C3BAC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleByTriggerFeature_TypeDefinitionIndex = 15198;
