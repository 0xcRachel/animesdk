...
#define RPG_GAMECORE_CHENLINGBATTLEPREDICATE_INSTAGE_METHOD_3_6BA8927567762926_OFFSET UNITYSDK_OFFSET(0x196A1DB0)
#define RPG_GAMECORE_CHENLINGBATTLEPREDICATE_INSTAGE_METHOD_3_AE478FE5C856D6AA_OFFSET UNITYSDK_OFFSET(0x196A1E80)
#define RPG_GAMECORE_CHENLINGBATTLEPREDICATE_INSTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x196A1E70)
