...
#define RPG_GAMECORE_GRIDFIGHTSTAGEROUTECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B4BEE0)
#define RPG_GAMECORE_GRIDFIGHTSTAGEROUTECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B4C7B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightStageRouteConfigRow_TypeDefinitionIndex = 12377;
	...
	public:
		...
		::System::UInt32 NodeTemplateID; // 0x3C
		::RPG::GameCore::GridFightNodeType NodeType; // 0x40
		::System::UInt32 BasicGoldRewardNum; // 0x44
