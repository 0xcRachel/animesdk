...
#define RPG_GAMECORE_TARGETFETCHLASTSEARCHENTITY_METHOD_4_EB28150427823982_OFFSET UNITYSDK_OFFSET(0x199E1820)
#define RPG_GAMECORE_TARGETFETCHLASTSEARCHENTITY_METHOD_4_EF51959009FCDFE6_OFFSET UNITYSDK_OFFSET(0x199DA920)
#define RPG_GAMECORE_TARGETFETCHLASTSEARCHENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x199DA8D0)
