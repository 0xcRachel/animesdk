...
#define RPG_GAMECORE_LOOPWAITHEARTDIALSCRIPTSTEPCHANGE_METHOD_3_A2D2CECEB1A92FA5_OFFSET UNITYSDK_OFFSET(0x18FCF320)
#define RPG_GAMECORE_LOOPWAITHEARTDIALSCRIPTSTEPCHANGE_METHOD_3_FCF9030C7CB7DF55_OFFSET UNITYSDK_OFFSET(0x18FCF290)
#define RPG_GAMECORE_LOOPWAITHEARTDIALSCRIPTSTEPCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18FCF2F0)
