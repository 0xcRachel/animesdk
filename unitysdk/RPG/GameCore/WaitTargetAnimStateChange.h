...
#define RPG_GAMECORE_WAITTARGETANIMSTATECHANGE_METHOD_4_C981C5C4B2F184A9_OFFSET UNITYSDK_OFFSET(0x1715E390)
#define RPG_GAMECORE_WAITTARGETANIMSTATECHANGE_METHOD_4_E3B9800126EF48F8_OFFSET UNITYSDK_OFFSET(0x1715E2B0)
#define RPG_GAMECORE_WAITTARGETANIMSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1715E330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitTargetAnimStateChange_TypeDefinitionIndex = 19954;
