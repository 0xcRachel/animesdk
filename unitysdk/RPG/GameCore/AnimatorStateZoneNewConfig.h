...
#define RPG_GAMECORE_ANIMATORSTATEZONENEWCONFIG_METHOD_2_2E8DA8F62A1DAC3C_OFFSET UNITYSDK_OFFSET(0x1688A9F0)
#define RPG_GAMECORE_ANIMATORSTATEZONENEWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1688AAC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AnimatorStateZoneNewConfig_TypeDefinitionIndex = 14695;
