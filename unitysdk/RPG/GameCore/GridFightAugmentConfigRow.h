...
#define RPG_GAMECORE_GRIDFIGHTAUGMENTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x195660B0)
#define RPG_GAMECORE_GRIDFIGHTAUGMENTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x195666D0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 CategoryID; // 0x88
		::RPG::GameCore::GridFightAugmentQuality Quality; // 0x8C
