...
#define RPG_GAMECORE_ADVLOGISTICSROBOTDOOROPEN_METHOD_3_12C6D2083989409E_OFFSET UNITYSDK_OFFSET(0x18C4CF50)
#define RPG_GAMECORE_ADVLOGISTICSROBOTDOOROPEN_METHOD_3_DAD21E4DD774FC6F_OFFSET UNITYSDK_OFFSET(0x18C4CED0)
#define RPG_GAMECORE_ADVLOGISTICSROBOTDOOROPEN__CTOR_OFFSET UNITYSDK_OFFSET(0x18C4CF20)
