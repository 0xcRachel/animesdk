...
#define RPG_GAMECORE_ADVLOGISTICSROBOTDOOROPEN_METHOD_3_12C6D2083989409E_OFFSET UNITYSDK_OFFSET(0x19BE4D70)
#define RPG_GAMECORE_ADVLOGISTICSROBOTDOOROPEN_METHOD_3_DAD21E4DD774FC6F_OFFSET UNITYSDK_OFFSET(0x19BE4CF0)
#define RPG_GAMECORE_ADVLOGISTICSROBOTDOOROPEN__CTOR_OFFSET UNITYSDK_OFFSET(0x19BE4D40)
