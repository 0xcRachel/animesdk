...
#define RPG_GAMECORE_DRINKMAKERCONTROLLER_METHOD_3_5D3BBE2FDF6F00C3_OFFSET UNITYSDK_OFFSET(0x1A0A7940)
#define RPG_GAMECORE_DRINKMAKERCONTROLLER_METHOD_3_6E3091430C46CF05_OFFSET UNITYSDK_OFFSET(0x1A0A78C0)
#define RPG_GAMECORE_DRINKMAKERCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0A7910)
