...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::ReadParamPosition>**)Il2CppClass::FromTypeDefinitionIndex(SkillParamMapping___O_TypeDefinitionIndex)->GetStaticField(0x11A50);
		}
	};
}
