...
#define RPG_GAMECORE_AVATARINTENSITYEFFECT_METHOD_3_8F92C683468AD394_OFFSET UNITYSDK_OFFSET(0x17633370)
#define RPG_GAMECORE_AVATARINTENSITYEFFECT_METHOD_3_A0BC7ACABF026AA5_OFFSET UNITYSDK_OFFSET(0x176333F0)
#define RPG_GAMECORE_AVATARINTENSITYEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x176333C0)
