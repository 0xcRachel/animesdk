...
#define RPG_GAMECORE_CLEARDIALOGCAMERA_METHOD_3_B1B1A69AD8AFC38D_OFFSET UNITYSDK_OFFSET(0x170C6000)
#define RPG_GAMECORE_CLEARDIALOGCAMERA_METHOD_3_FB859E49CA8AF519_OFFSET UNITYSDK_OFFSET(0x170C5EF0)
#define RPG_GAMECORE_CLEARDIALOGCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x170C5FD0)
