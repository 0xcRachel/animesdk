...
#define RPG_GAMECORE_HIPPLENGAMEAREALISTENER_METHOD_3_54998919F21D4FB2_OFFSET UNITYSDK_OFFSET(0x19AC6EA0)
#define RPG_GAMECORE_HIPPLENGAMEAREALISTENER_METHOD_3_D7A3D3B0F4AC09DE_OFFSET UNITYSDK_OFFSET(0x19AC6E20)
#define RPG_GAMECORE_HIPPLENGAMEAREALISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x19AC6E70)
