...
#define RPG_GAMECORE_HIPPLENGAMEAREALISTENER_METHOD_3_202CCA5AF2120810_OFFSET UNITYSDK_OFFSET(0x172C0D30)
#define RPG_GAMECORE_HIPPLENGAMEAREALISTENER_METHOD_3_CEB2B37753C29380_OFFSET UNITYSDK_OFFSET(0x172C0DB0)
#define RPG_GAMECORE_HIPPLENGAMEAREALISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x172C0D80)
