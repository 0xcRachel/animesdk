...
#define RPG_GAMECORE_HIPPLENGAMEAREALISTENER_METHOD_3_202CCA5AF2120810_OFFSET UNITYSDK_OFFSET(0x16B72470)
#define RPG_GAMECORE_HIPPLENGAMEAREALISTENER_METHOD_3_CEB2B37753C29380_OFFSET UNITYSDK_OFFSET(0x16B724F0)
#define RPG_GAMECORE_HIPPLENGAMEAREALISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x16B724C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenGameAreaListener_TypeDefinitionIndex = 19077;
