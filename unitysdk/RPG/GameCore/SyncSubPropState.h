...
#define RPG_GAMECORE_SYNCSUBPROPSTATE_METHOD_3_CC1A88A29A8CBAB4_OFFSET UNITYSDK_OFFSET(0x1986C8B0)
#define RPG_GAMECORE_SYNCSUBPROPSTATE_METHOD_3_DFDF0F8DF6354E74_OFFSET UNITYSDK_OFFSET(0x1986C940)
#define RPG_GAMECORE_SYNCSUBPROPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1986C910)
