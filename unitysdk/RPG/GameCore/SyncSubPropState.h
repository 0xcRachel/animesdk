...
#define RPG_GAMECORE_SYNCSUBPROPSTATE_METHOD_3_CC1A88A29A8CBAB4_OFFSET UNITYSDK_OFFSET(0x199C74D0)
#define RPG_GAMECORE_SYNCSUBPROPSTATE_METHOD_3_DFDF0F8DF6354E74_OFFSET UNITYSDK_OFFSET(0x199C7560)
#define RPG_GAMECORE_SYNCSUBPROPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x199C7530)
