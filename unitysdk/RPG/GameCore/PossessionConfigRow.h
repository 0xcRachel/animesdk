...
#define RPG_GAMECORE_POSSESSIONCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16D79F90)
#define RPG_GAMECORE_POSSESSIONCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16D7A250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PossessionConfigRow_TypeDefinitionIndex = 13207;
