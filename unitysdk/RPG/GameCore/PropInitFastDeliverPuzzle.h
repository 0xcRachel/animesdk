...
#define RPG_GAMECORE_PROPINITFASTDELIVERPUZZLE_METHOD_3_7E910852102E1953_OFFSET UNITYSDK_OFFSET(0x191C6A10)
#define RPG_GAMECORE_PROPINITFASTDELIVERPUZZLE_METHOD_3_DD3B6F2342F06C28_OFFSET UNITYSDK_OFFSET(0x191C6BF0)
#define RPG_GAMECORE_PROPINITFASTDELIVERPUZZLE__CTOR_OFFSET UNITYSDK_OFFSET(0x191C6B10)
