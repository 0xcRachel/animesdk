...
#define RPG_GAMECORE_AVATARDEMOMODULECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1762C6A0)
#define RPG_GAMECORE_AVATARDEMOMODULECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1762C840)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 AvatarDemoStageID; // 0x14
