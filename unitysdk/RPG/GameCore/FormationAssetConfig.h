...
#define RPG_GAMECORE_FORMATIONASSETCONFIG_METHOD_2_D8B6426AF745DFAF_OFFSET UNITYSDK_OFFSET(0x1722C140)
#define RPG_GAMECORE_FORMATIONASSETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1722C210)
