...
#define RPG_GAMECORE_BINDTIMEREWINDPARENT_METHOD_3_C240A95616C7D13E_OFFSET UNITYSDK_OFFSET(0x168EAB20)
#define RPG_GAMECORE_BINDTIMEREWINDPARENT_METHOD_3_C45A9A8750BF7468_OFFSET UNITYSDK_OFFSET(0x168EABA0)
#define RPG_GAMECORE_BINDTIMEREWINDPARENT__CTOR_OFFSET UNITYSDK_OFFSET(0x168EAB70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BindTimeRewindParent_TypeDefinitionIndex = 18447;
