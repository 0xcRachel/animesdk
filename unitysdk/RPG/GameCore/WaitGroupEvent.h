...
#define RPG_GAMECORE_WAITGROUPEVENT_METHOD_4_88885C73CE8EC5EA_OFFSET UNITYSDK_OFFSET(0x1790FBE0)
#define RPG_GAMECORE_WAITGROUPEVENT_METHOD_4_DA2CE388B41568E0_OFFSET UNITYSDK_OFFSET(0x1790FB00)
#define RPG_GAMECORE_WAITGROUPEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1790FB80)
