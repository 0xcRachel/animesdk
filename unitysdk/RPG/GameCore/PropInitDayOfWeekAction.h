...
#define RPG_GAMECORE_PROPINITDAYOFWEEKACTION_METHOD_3_75BFDD339841D5A7_OFFSET UNITYSDK_OFFSET(0x191C6500)
#define RPG_GAMECORE_PROPINITDAYOFWEEKACTION_METHOD_3_C8C20455C9B428D6_OFFSET UNITYSDK_OFFSET(0x191C6580)
#define RPG_GAMECORE_PROPINITDAYOFWEEKACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x191C6550)
