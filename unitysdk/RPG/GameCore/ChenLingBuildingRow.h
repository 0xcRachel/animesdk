...
#define RPG_GAMECORE_CHENLINGBUILDINGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A157BA0)
#define RPG_GAMECORE_CHENLINGBUILDINGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A157E60)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 InitialMaxLevel; // 0x44
