...
#define RPG_GAMECORE_AVATAREFFECTSPRELOADITEM_METHOD_2_0E960A2EE066170F_OFFSET UNITYSDK_OFFSET(0x181FF560)
#define RPG_GAMECORE_AVATAREFFECTSPRELOADITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x181FF6A0)
