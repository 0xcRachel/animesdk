...
#define RPG_GAMECORE_ROGUETOURNCOCOONCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17675AF0)
#define RPG_GAMECORE_ROGUETOURNCOCOONCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17676040)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 NpcMonsterID; // 0x48
