...
#define RPG_GAMECORE_ROGUETOURNCOCOONCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x193FEC10)
#define RPG_GAMECORE_ROGUETOURNCOCOONCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x193FF100)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::Il2CppArray<::Class_1_A88C3AAF0DD46F4C_7*>* DisplayMonsterMap; // 0x10
		::Il2CppArray<::System::UInt32>* DropList; // 0x18
		::Il2CppArray<::RPG::GameCore::AttackDamageType>* RecommendDamageTypes; // 0x20
