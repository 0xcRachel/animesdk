...
#define RPG_GAMECORE_ADVENTUREEXTRAMPCOST_METHOD_3_37075FB98627E0DB_OFFSET UNITYSDK_OFFSET(0x19C0A4A0)
#define RPG_GAMECORE_ADVENTUREEXTRAMPCOST_METHOD_3_6A7B67DEE3A1C974_OFFSET UNITYSDK_OFFSET(0x19C0A520)
#define RPG_GAMECORE_ADVENTUREEXTRAMPCOST__CTOR_OFFSET UNITYSDK_OFFSET(0x19C0A4F0)
