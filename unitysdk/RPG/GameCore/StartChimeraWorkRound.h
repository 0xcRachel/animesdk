...
#define RPG_GAMECORE_STARTCHIMERAWORKROUND_METHOD_3_4ED8441665218448_OFFSET UNITYSDK_OFFSET(0x16F94900)
#define RPG_GAMECORE_STARTCHIMERAWORKROUND_METHOD_3_9401EE6F1DAD0751_OFFSET UNITYSDK_OFFSET(0x16F94880)
#define RPG_GAMECORE_STARTCHIMERAWORKROUND__CTOR_OFFSET UNITYSDK_OFFSET(0x16F948D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartChimeraWorkRound_TypeDefinitionIndex = 19372;
