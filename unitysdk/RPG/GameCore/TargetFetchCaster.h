...
#define RPG_GAMECORE_TARGETFETCHCASTER_METHOD_4_1E259FB9F063C03C_OFFSET UNITYSDK_OFFSET(0x177C7E00)
#define RPG_GAMECORE_TARGETFETCHCASTER_METHOD_4_D02B762BEB93DB3E_OFFSET UNITYSDK_OFFSET(0x177D1F60)
#define RPG_GAMECORE_TARGETFETCHCASTER__CTOR_OFFSET UNITYSDK_OFFSET(0x177C7DB0)
