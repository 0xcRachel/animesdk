...
#define RPG_GAMECORE_TARGETFETCHCASTER_METHOD_4_1E259FB9F063C03C_OFFSET UNITYSDK_OFFSET(0x16FD5160)
#define RPG_GAMECORE_TARGETFETCHCASTER_METHOD_4_D02B762BEB93DB3E_OFFSET UNITYSDK_OFFSET(0x16FDC610)
#define RPG_GAMECORE_TARGETFETCHCASTER__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD5110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchCaster_TypeDefinitionIndex = 21622;
