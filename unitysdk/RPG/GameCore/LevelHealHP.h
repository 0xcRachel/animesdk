...
#define RPG_GAMECORE_LEVELHEALHP_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x19206FA0)
#define RPG_GAMECORE_LEVELHEALHP_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x19206F50)
#define RPG_GAMECORE_LEVELHEALHP__CTOR_OFFSET UNITYSDK_OFFSET(0x19206EF0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::FixPoint HealPercentage; // 0x28
		::RPG::GameCore::FixPoint PreHP; // 0x30
		::RPG::GameCore::FixPoint ActualHealValue; // 0x38
		::RPG::GameCore::FixPoint HealValue; // 0x40
		::System::UInt32 TargetID; // 0x48
		::RPG::GameCore::FixPoint PostHP; // 0x50
