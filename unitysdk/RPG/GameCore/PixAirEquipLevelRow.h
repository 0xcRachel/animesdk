...
#define RPG_GAMECORE_PIXAIREQUIPLEVELROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19D41560)
#define RPG_GAMECORE_PIXAIREQUIPLEVELROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19D41AD0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::FixPoint HastePower; // 0x20
		::System::UInt32 EquipID; // 0x28
		::System::UInt32 EquipLevel; // 0x2C
		::RPG::GameCore::FixPoint JamPower; // 0x30
		::RPG::GameCore::FixPoint BurnPower; // 0x38
		::RPG::GameCore::FixPoint MultiPower; // 0x40
