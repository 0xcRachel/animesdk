...
#define RPG_GAMECORE_SWITCHPHOTOGRAPHMODE_METHOD_3_455A2DFBD33CD5BE_OFFSET UNITYSDK_OFFSET(0x16FB7E40)
#define RPG_GAMECORE_SWITCHPHOTOGRAPHMODE_METHOD_3_A8B144FCC885626C_OFFSET UNITYSDK_OFFSET(0x16FB7DA0)
#define RPG_GAMECORE_SWITCHPHOTOGRAPHMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FB7E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchPhotoGraphMode_TypeDefinitionIndex = 18302;
