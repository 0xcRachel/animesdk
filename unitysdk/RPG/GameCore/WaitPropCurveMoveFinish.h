...
#define RPG_GAMECORE_WAITPROPCURVEMOVEFINISH_METHOD_3_9FAE3F0E0A34EA44_OFFSET UNITYSDK_OFFSET(0x17158F30)
#define RPG_GAMECORE_WAITPROPCURVEMOVEFINISH_METHOD_3_AD2CC6DA09E725A0_OFFSET UNITYSDK_OFFSET(0x17159000)
#define RPG_GAMECORE_WAITPROPCURVEMOVEFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x17158FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitPropCurveMoveFinish_TypeDefinitionIndex = 18820;
