...
#define RPG_GAMECORE_CHIMERADUELREPLACESAVEDENTITIESNODE_METHOD_3_08ED987880D80073_OFFSET UNITYSDK_OFFSET(0x194C6E10)
#define RPG_GAMECORE_CHIMERADUELREPLACESAVEDENTITIESNODE_METHOD_3_4B8F1DD33775FA94_OFFSET UNITYSDK_OFFSET(0x194C6D30)
#define RPG_GAMECORE_CHIMERADUELREPLACESAVEDENTITIESNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x194C6DC0)
