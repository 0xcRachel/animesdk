...
#define RPG_GAMECORE_CHENLINGDECKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x196A64F0)
#define RPG_GAMECORE_CHENLINGDECKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x196A6A60)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* ShowCardList; // 0x28
		::System::String* DeckIconPath; // 0x30
		::Il2CppArray<::System::UInt32>* InitialEffectList; // 0x38
		...
		::System::UInt32 GuideGroupID; // 0x74
