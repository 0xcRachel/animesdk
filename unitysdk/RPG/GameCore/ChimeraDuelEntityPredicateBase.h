...
#define RPG_GAMECORE_CHIMERADUELENTITYPREDICATEBASE_METHOD_2_BBBCA82BCC0BD503_OFFSET UNITYSDK_OFFSET(0x1698DC50)
#define RPG_GAMECORE_CHIMERADUELENTITYPREDICATEBASE_METHOD_2_D50AF52EA84BC575_OFFSET UNITYSDK_OFFSET(0x16988230)
#define RPG_GAMECORE_CHIMERADUELENTITYPREDICATEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1698D480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEntityPredicateBase_TypeDefinitionIndex = 14359;
