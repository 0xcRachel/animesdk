...
#define RPG_GAMECORE_BYSWITCHMASCOTCANSHOOTTARGET_METHOD_4_901F70760B847E95_OFFSET UNITYSDK_OFFSET(0x1693E1D0)
#define RPG_GAMECORE_BYSWITCHMASCOTCANSHOOTTARGET_METHOD_4_DE19627887B8FDBF_OFFSET UNITYSDK_OFFSET(0x1693E100)
#define RPG_GAMECORE_BYSWITCHMASCOTCANSHOOTTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1693E180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BySwitchMascotCanShootTarget_TypeDefinitionIndex = 17940;
