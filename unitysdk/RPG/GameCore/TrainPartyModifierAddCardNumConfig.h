...
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDCARDNUMCONFIG_METHOD_3_4D00E349036BAA05_OFFSET UNITYSDK_OFFSET(0x178C0E50)
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDCARDNUMCONFIG_METHOD_3_EA56E03050773389_OFFSET UNITYSDK_OFFSET(0x178C0EA0)
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDCARDNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x178C0E90)
