...
#define RPG_GAMECORE_SWITCHCHALLENGETURNLIMITTYPE_METHOD_3_3795D78A936A4932_OFFSET UNITYSDK_OFFSET(0x177A78A0)
#define RPG_GAMECORE_SWITCHCHALLENGETURNLIMITTYPE_METHOD_3_FCFDA9135545C80D_OFFSET UNITYSDK_OFFSET(0x177A7920)
#define RPG_GAMECORE_SWITCHCHALLENGETURNLIMITTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x177A78F0)
