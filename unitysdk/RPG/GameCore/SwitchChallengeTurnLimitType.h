...
#define RPG_GAMECORE_SWITCHCHALLENGETURNLIMITTYPE_METHOD_3_3795D78A936A4932_OFFSET UNITYSDK_OFFSET(0x16FB30C0)
#define RPG_GAMECORE_SWITCHCHALLENGETURNLIMITTYPE_METHOD_3_FCFDA9135545C80D_OFFSET UNITYSDK_OFFSET(0x16FB3140)
#define RPG_GAMECORE_SWITCHCHALLENGETURNLIMITTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FB3110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchChallengeTurnLimitType_TypeDefinitionIndex = 21120;
