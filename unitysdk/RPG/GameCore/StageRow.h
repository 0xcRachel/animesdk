...
#define RPG_GAMECORE_STAGEROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x18607800)
#define RPG_GAMECORE_STAGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18607F90)
#define RPG_GAMECORE_STAGEROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x1860E200)
#define RPG_GAMECORE_STAGEROW_GETCHALLENGESTORYTYPE_OFFSET UNITYSDK_OFFSET(0x1860E880)
#define RPG_GAMECORE_STAGEROW_GET_PROCESSEDSUBLEVELGRAPHLIST_OFFSET UNITYSDK_OFFSET(0x1860E8B0)
#define RPG_GAMECORE_STAGEROW_GET_PROCESSEDTEMPLATEVARIABLES_OFFSET UNITYSDK_OFFSET(0x1860EC20)
#define RPG_GAMECORE_STAGEROW_PARSETEMPLATEVARIABLE_OFFSET UNITYSDK_OFFSET(0x1860EDA0)
#define RPG_GAMECORE_STAGEROW_RESET_OFFSET UNITYSDK_OFFSET(0x1860E260)
#define RPG_GAMECORE_STAGEROW_TRYGETSTAGECONFIGSTRING_OFFSET UNITYSDK_OFFSET(0x1860E2C0)
#define RPG_GAMECORE_STAGEROW_TRYGETSTAGECONFIGUINTARRAY_OFFSET UNITYSDK_OFFSET(0x1860E5E0)
#define RPG_GAMECORE_STAGEROW_TRYGETSTAGECONFIGUINT_OFFSET UNITYSDK_OFFSET(0x1860E3D0)
#define RPG_GAMECORE_STAGEROW__CCTOR_OFFSET UNITYSDK_OFFSET(0x1860EF50)
#define RPG_GAMECORE_STAGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1860E2B0)
#define RPG_GAMECORE_STAGEROW__TRYADDSTR_OFFSET UNITYSDK_OFFSET(0x1860EBF0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::System::Text::RegularExpressions::Regex**)Il2CppClass::FromTypeDefinitionIndex(StageRow_TypeDefinitionIndex)->GetStaticField(0x3CF30);
		}
		static ::System::Text::RegularExpressions::Regex** StaticGet_s_RegexInteger()
		{
			return (::System::Text::RegularExpressions::Regex**)Il2CppClass::FromTypeDefinitionIndex(StageRow_TypeDefinitionIndex)->GetStaticField(0x3CF38);
		}
		::Il2CppArray<::System::String*>* LevelWinCondition; // 0x10
		::System::Collections::Generic::Dictionary_2<::System::String*, ::Il2CppArray<::System::String*>*>* _ProcessedCustomStringList; // 0x18
		::System::String* LevelGraphPath; // 0x20
		::System::Collections::Generic::Dictionary_2<::System::String*, ::Il2CppArray<::System::String*>*>* _ProcessedSubLevelGraphList; // 0x28
		...
		::Il2CppArray<::System::String*>* LevelLoseCondition; // 0x40
		::Il2CppArray<::System::String*>* StageAbilityConfig; // 0x48
		::Il2CppArray<::System::UInt32>* TrialAvatarList; // 0x50
		::Il2CppArray<::RPG::GameCore::StageMonsterWave*>* MonsterList; // 0x58
		::Il2CppArray<::Class_1_D6A07C122FCF6261*>* SubLevelGraphs; // 0x60
		::System::Single MonsterWarningRatio; // 0x68
		::System::UInt32 HardLevelGroup; // 0x6C
		::System::UInt32 StageID; // 0x70
		::System::UInt32 EliteGroup; // 0x74
		::System::Boolean ForbidViewMode; // 0x78
		::System::Boolean ResetBattleSpeed; // 0x79
		::System::UInt32 BattleScoringGroup; // 0x7C
		::RPG::GameCore::StageType StageType; // 0x80
		::RPG::Client::TextID StageName; // 0x88
		::System::Boolean ForbidExitBattle; // 0x98
		::System::Boolean ForbidAutoBattle; // 0x99
		::System::Boolean Release; // 0x9A
		::System::UInt32 Level; // 0x9C
