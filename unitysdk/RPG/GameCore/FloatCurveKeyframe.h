...
#define RPG_GAMECORE_FLOATCURVEKEYFRAME_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A3ACAD0)
#define RPG_GAMECORE_FLOATCURVEKEYFRAME_METHOD_2_B10C0CBE85DBEC26_OFFSET UNITYSDK_OFFSET(0x1A3AD1B0)
#define RPG_GAMECORE_FLOATCURVEKEYFRAME_METHOD_2_EC794351DF892425_OFFSET UNITYSDK_OFFSET(0x1A3AD210)
#define RPG_GAMECORE_FLOATCURVEKEYFRAME_METHOD_2_F3EEE9A84E9975A1_OFFSET UNITYSDK_OFFSET(0x1A3ACEE0)
#define RPG_GAMECORE_FLOATCURVEKEYFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3AD1A0)
