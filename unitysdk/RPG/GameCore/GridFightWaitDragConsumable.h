...
#define RPG_GAMECORE_GRIDFIGHTWAITDRAGCONSUMABLE_METHOD_3_AE0D6320120CA57B_OFFSET UNITYSDK_OFFSET(0x1729EDC0)
#define RPG_GAMECORE_GRIDFIGHTWAITDRAGCONSUMABLE_METHOD_3_DAB03EB361ACDF14_OFFSET UNITYSDK_OFFSET(0x1729EE40)
#define RPG_GAMECORE_GRIDFIGHTWAITDRAGCONSUMABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1729EE10)
