...
#define RPG_GAMECORE_BASELINEAVATARPRELOADCONFIG_METHOD_2_10A26512E6F95D83_OFFSET UNITYSDK_OFFSET(0x168CE7D0)
#define RPG_GAMECORE_BASELINEAVATARPRELOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x168CE990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaselineAvatarPreloadConfig_TypeDefinitionIndex = 14712;
