...
#define RPG_GAMECORE_TASKCONFIG_GET_ISCLIENTONLY_OFFSET UNITYSDK_OFFSET(0x16FF7B50)
#define RPG_GAMECORE_TASKCONFIG_METHOD_2_1ED259C7ABF370D3_OFFSET UNITYSDK_OFFSET(0x16FF7900)
#define RPG_GAMECORE_TASKCONFIG_METHOD_2_577BAC1DE9DE59A7_OFFSET UNITYSDK_OFFSET(0x16FF7A80)
#define RPG_GAMECORE_TASKCONFIG_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x16FF7B40)
#define RPG_GAMECORE_TASKCONFIG__CCTOR_OFFSET UNITYSDK_OFFSET(0x16FF7BD0)
#define RPG_GAMECORE_TASKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE3FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TaskConfig_TypeDefinitionIndex = 21450;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Func_2<::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::TaskConfig*>*>**)Il2CppClass::FromTypeDefinitionIndex(TaskConfig_TypeDefinitionIndex)->GetStaticField(0x164E0);
		}
