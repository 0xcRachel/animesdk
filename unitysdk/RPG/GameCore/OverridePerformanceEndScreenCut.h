...
#define RPG_GAMECORE_OVERRIDEPERFORMANCEENDSCREENCUT_METHOD_3_74528B0A9F81DE82_OFFSET UNITYSDK_OFFSET(0x16D118D0)
#define RPG_GAMECORE_OVERRIDEPERFORMANCEENDSCREENCUT_METHOD_3_832E75E2D8D45FEB_OFFSET UNITYSDK_OFFSET(0x16D11950)
#define RPG_GAMECORE_OVERRIDEPERFORMANCEENDSCREENCUT__CTOR_OFFSET UNITYSDK_OFFSET(0x16D11920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OverridePerformanceEndScreenCut_TypeDefinitionIndex = 19559;
