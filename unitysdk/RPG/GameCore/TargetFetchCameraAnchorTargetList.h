...
#define RPG_GAMECORE_TARGETFETCHCAMERAANCHORTARGETLIST_METHOD_4_0DBE86CB96046373_OFFSET UNITYSDK_OFFSET(0x16FDC550)
#define RPG_GAMECORE_TARGETFETCHCAMERAANCHORTARGETLIST_METHOD_4_5968BAE8F1678565_OFFSET UNITYSDK_OFFSET(0x16FD4FF0)
#define RPG_GAMECORE_TARGETFETCHCAMERAANCHORTARGETLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD4FA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchCameraAnchorTargetList_TypeDefinitionIndex = 21740;
