...
#define RPG_GAMECORE_SETCUSTOMLOCATIONCONFIG_METHOD_3_A0DA3E521BE6366D_OFFSET UNITYSDK_OFFSET(0x16F101D0)
#define RPG_GAMECORE_SETCUSTOMLOCATIONCONFIG_METHOD_3_EC02F1024DA2ACBC_OFFSET UNITYSDK_OFFSET(0x16F10150)
#define RPG_GAMECORE_SETCUSTOMLOCATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F101A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCustomLocationConfig_TypeDefinitionIndex = 20134;
