...
#define RPG_GAMECORE_SETCUSTOMLOCATIONCONFIG_METHOD_3_A0DA3E521BE6366D_OFFSET UNITYSDK_OFFSET(0x176C5660)
#define RPG_GAMECORE_SETCUSTOMLOCATIONCONFIG_METHOD_3_EC02F1024DA2ACBC_OFFSET UNITYSDK_OFFSET(0x176C55E0)
#define RPG_GAMECORE_SETCUSTOMLOCATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176C5630)
