...
#define RPG_GAMECORE_MARBLEAIDEGRADE_METHOD_3_2D3F2D5B9AEC3ED0_OFFSET UNITYSDK_OFFSET(0x19C2F4D0)
#define RPG_GAMECORE_MARBLEAIDEGRADE_METHOD_3_AEDED0533F5E0577_OFFSET UNITYSDK_OFFSET(0x19C2F610)
#define RPG_GAMECORE_MARBLEAIDEGRADE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C2F5C0)
