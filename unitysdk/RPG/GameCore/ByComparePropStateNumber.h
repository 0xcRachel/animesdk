...
#define RPG_GAMECORE_BYCOMPAREPROPSTATENUMBER_METHOD_4_06428BDB1398B2D7_OFFSET UNITYSDK_OFFSET(0x18FE9280)
#define RPG_GAMECORE_BYCOMPAREPROPSTATENUMBER_METHOD_4_4E8786AE623E8062_OFFSET UNITYSDK_OFFSET(0x18FE9200)
#define RPG_GAMECORE_BYCOMPAREPROPSTATENUMBER_METHOD_4_B6FA904C75C28D76_OFFSET UNITYSDK_OFFSET(0x18FE8E70)
#define RPG_GAMECORE_BYCOMPAREPROPSTATENUMBER_METHOD_4_C18CC9D627BC6B6D_OFFSET UNITYSDK_OFFSET(0x18FE8F40)
#define RPG_GAMECORE_BYCOMPAREPROPSTATENUMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x18FE8EF0)
