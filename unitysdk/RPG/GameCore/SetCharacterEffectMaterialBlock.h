...
#define RPG_GAMECORE_SETCHARACTEREFFECTMATERIALBLOCK_METHOD_3_0DD6DFB7BBF3C0C4_OFFSET UNITYSDK_OFFSET(0x16F0C500)
#define RPG_GAMECORE_SETCHARACTEREFFECTMATERIALBLOCK_METHOD_3_18935231A33196D3_OFFSET UNITYSDK_OFFSET(0x16F0C480)
#define RPG_GAMECORE_SETCHARACTEREFFECTMATERIALBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x16F0C4D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCharacterEffectMaterialBlock_TypeDefinitionIndex = 20856;
