...
#define RPG_GAMECORE_RTTARGETMAPSKILLABORTSOURCE_METHOD_3_73A4C0EDB78FB43D_OFFSET UNITYSDK_OFFSET(0x1A160B40)
#define RPG_GAMECORE_RTTARGETMAPSKILLABORTSOURCE_METHOD_3_8C2CB18A93EC2A7D_OFFSET UNITYSDK_OFFSET(0x1A1609A0)
#define RPG_GAMECORE_RTTARGETMAPSKILLABORTSOURCE_METHOD_3_B478714DE88136CB_OFFSET UNITYSDK_OFFSET(0x1A160A80)
#define RPG_GAMECORE_RTTARGETMAPSKILLABORTSOURCE_METHOD_3_D52D4F15E4284E4D_OFFSET UNITYSDK_OFFSET(0x1A160AE0)
#define RPG_GAMECORE_RTTARGETMAPSKILLABORTSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A160A60)
