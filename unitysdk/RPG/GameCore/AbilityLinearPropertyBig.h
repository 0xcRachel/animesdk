...
#define RPG_GAMECORE_ABILITYLINEARPROPERTYBIG_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x878850)
#define RPG_GAMECORE_ABILITYLINEARPROPERTYBIG__CTOR_OFFSET UNITYSDK_OFFSET(0x878820)
