...
#define RPG_GAMECORE_DYNAMICVECTOR3_METHOD_2_891D7AC424EDA562_OFFSET UNITYSDK_OFFSET(0x1719C2F0)
#define RPG_GAMECORE_DYNAMICVECTOR3__CTOR_OFFSET UNITYSDK_OFFSET(0x1719C4E0)
