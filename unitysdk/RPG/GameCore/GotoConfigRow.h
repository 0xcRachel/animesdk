...
#define RPG_GAMECORE_GOTOCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19CAE080)
#define RPG_GAMECORE_GOTOCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19CAE720)
