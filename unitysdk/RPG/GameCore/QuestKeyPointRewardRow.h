...
#define RPG_GAMECORE_QUESTKEYPOINTREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16DBF640)
#define RPG_GAMECORE_QUESTKEYPOINTREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16DBF7F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int QuestKeyPointRewardRow_TypeDefinitionIndex = 13196;
