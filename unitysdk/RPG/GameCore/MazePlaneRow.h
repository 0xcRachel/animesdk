...
#define RPG_GAMECORE_MAZEPLANEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16C72AB0)
#define RPG_GAMECORE_MAZEPLANEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16C73220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazePlaneRow_TypeDefinitionIndex = 12763;
	...
	public:
		...
		::System::UInt32 SubType; // 0x1C
		::System::UInt32 MazePoolType; // 0x20
		::RPG::GameCore::PlaneType PlaneType; // 0x24
