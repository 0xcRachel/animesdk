...
#define RPG_GAMECORE_ST_BYAIHANGUP_METHOD_4_93BCF57104C1002F_OFFSET UNITYSDK_OFFSET(0x16EEDD60)
#define RPG_GAMECORE_ST_BYAIHANGUP_METHOD_4_F1546C9832841F45_OFFSET UNITYSDK_OFFSET(0x16EEDE30)
#define RPG_GAMECORE_ST_BYAIHANGUP__CTOR_OFFSET UNITYSDK_OFFSET(0x16EEDDE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByAIHangUp_TypeDefinitionIndex = 17836;
