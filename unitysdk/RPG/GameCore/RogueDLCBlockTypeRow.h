...
#define RPG_GAMECORE_ROGUEDLCBLOCKTYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16E6E250)
#define RPG_GAMECORE_ROGUEDLCBLOCKTYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16E6E980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDLCBlockTypeRow_TypeDefinitionIndex = 13434;

	class RogueDLCBlockTypeRow : public ::System::Object
	{
	public:
		::System::String* BlockTypeIcon; // 0x10
