...
#define RPG_GAMECORE_ROGUEDLCBLOCKTYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19257CE0)
#define RPG_GAMECORE_ROGUEDLCBLOCKTYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19258410)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 BlockIntroID; // 0x38
		::System::UInt32 BlockTypeID; // 0x3C
