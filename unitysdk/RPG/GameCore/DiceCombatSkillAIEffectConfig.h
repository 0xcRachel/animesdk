...
#define RPG_GAMECORE_DICECOMBATSKILLAIEFFECTCONFIG_METHOD_2_0A7C339D22642404_OFFSET UNITYSDK_OFFSET(0x1959A7F0)
#define RPG_GAMECORE_DICECOMBATSKILLAIEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1959A8F0)
