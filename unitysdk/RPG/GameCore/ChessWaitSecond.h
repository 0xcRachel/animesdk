...
#define RPG_GAMECORE_CHESSWAITSECOND_METHOD_3_1941E1673291D565_OFFSET UNITYSDK_OFFSET(0x16981AC0)
#define RPG_GAMECORE_CHESSWAITSECOND_METHOD_3_D6BA95A2CB3B730C_OFFSET UNITYSDK_OFFSET(0x16981BE0)
#define RPG_GAMECORE_CHESSWAITSECOND__CTOR_OFFSET UNITYSDK_OFFSET(0x16981B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChessWaitSecond_TypeDefinitionIndex = 21424;
