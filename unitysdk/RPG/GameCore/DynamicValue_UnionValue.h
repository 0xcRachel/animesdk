...
#define RPG_GAMECORE_DYNAMICVALUE_UNIONVALUE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1719BA90)
...
namespace RPG::GameCore
{
	...
	struct alignas(4) DynamicValue_UnionValue
	{
		...
		{
			return (::RPG::GameCore::DynamicValue_UnionValue*)Il2CppClass::FromTypeDefinitionIndex(DynamicValue_UnionValue_TypeDefinitionIndex)->GetStaticField(0xD7B0);
		}
