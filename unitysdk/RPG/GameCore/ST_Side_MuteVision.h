...
#define RPG_GAMECORE_ST_SIDE_MUTEVISION_METHOD_4_73C6CE936AC572B6_OFFSET UNITYSDK_OFFSET(0x16EEA4B0)
#define RPG_GAMECORE_ST_SIDE_MUTEVISION_METHOD_4_7DEDA5E1F28728FC_OFFSET UNITYSDK_OFFSET(0x16EF87C0)
#define RPG_GAMECORE_ST_SIDE_MUTEVISION__CTOR_OFFSET UNITYSDK_OFFSET(0x16EEA460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_MuteVision_TypeDefinitionIndex = 17887;
