...
#define RPG_GAMECORE_SWITCHMASCOTTRIGGERUISHOOTEFFECT_METHOD_3_09C3BEDCF8A8DD14_OFFSET UNITYSDK_OFFSET(0x19860570)
#define RPG_GAMECORE_SWITCHMASCOTTRIGGERUISHOOTEFFECT_METHOD_3_B4FC283DE36AAA28_OFFSET UNITYSDK_OFFSET(0x19860460)
#define RPG_GAMECORE_SWITCHMASCOTTRIGGERUISHOOTEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x19860540)
