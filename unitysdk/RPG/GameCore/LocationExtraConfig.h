...
#define RPG_GAMECORE_LOCATIONEXTRACONFIG_METHOD_2_02101ABD10986598_OFFSET UNITYSDK_OFFSET(0x1737DC60)
#define RPG_GAMECORE_LOCATIONEXTRACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1737DDE0)
