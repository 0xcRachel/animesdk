...
#define RPG_GAMECORE_LOCATIONEXTRACONFIG_METHOD_2_2BD72B376B7006C1_OFFSET UNITYSDK_OFFSET(0x19C11F90)
#define RPG_GAMECORE_LOCATIONEXTRACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19C120E0)
