...
#define RPG_GAMECORE_LOCATIONEXTRACONFIG_METHOD_2_2BD72B376B7006C1_OFFSET UNITYSDK_OFFSET(0x18FC7C60)
#define RPG_GAMECORE_LOCATIONEXTRACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18FC7DB0)
