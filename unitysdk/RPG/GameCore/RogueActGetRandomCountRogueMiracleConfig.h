...
#define RPG_GAMECORE_ROGUEACTGETRANDOMCOUNTROGUEMIRACLECONFIG_METHOD_6_90570A2DBCC0C59B_OFFSET UNITYSDK_OFFSET(0x1A028530)
#define RPG_GAMECORE_ROGUEACTGETRANDOMCOUNTROGUEMIRACLECONFIG_METHOD_6_C4223000928C5BAE_OFFSET UNITYSDK_OFFSET(0x1A028310)
#define RPG_GAMECORE_ROGUEACTGETRANDOMCOUNTROGUEMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A028450)
