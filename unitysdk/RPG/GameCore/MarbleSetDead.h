...
#define RPG_GAMECORE_MARBLESETDEAD_METHOD_3_2E76081FB96DA1BA_OFFSET UNITYSDK_OFFSET(0x16C48EC0)
#define RPG_GAMECORE_MARBLESETDEAD_METHOD_3_B395FF5B78AC85B5_OFFSET UNITYSDK_OFFSET(0x16C49000)
#define RPG_GAMECORE_MARBLESETDEAD__CTOR_OFFSET UNITYSDK_OFFSET(0x16C48FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleSetDead_TypeDefinitionIndex = 15171;
