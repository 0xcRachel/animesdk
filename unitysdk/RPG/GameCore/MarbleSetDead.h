...
#define RPG_GAMECORE_MARBLESETDEAD_METHOD_3_2E76081FB96DA1BA_OFFSET UNITYSDK_OFFSET(0x1997F1C0)
#define RPG_GAMECORE_MARBLESETDEAD_METHOD_3_B395FF5B78AC85B5_OFFSET UNITYSDK_OFFSET(0x1997F300)
#define RPG_GAMECORE_MARBLESETDEAD__CTOR_OFFSET UNITYSDK_OFFSET(0x1997F2B0)
