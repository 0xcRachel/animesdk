...
#define RPG_GAMECORE_TREASUREDUNGEONGRIDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19A36650)
#define RPG_GAMECORE_TREASUREDUNGEONGRIDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19A36B60)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 ReplaceGridID; // 0x38
		::System::UInt32 OpenBuff; // 0x3C
		::System::UInt32 GridSubType; // 0x40
