...
#define RPG_GAMECORE_FINISHHITSTATEIMMEDIATELY_METHOD_3_19765CAD45C06517_OFFSET UNITYSDK_OFFSET(0x171EBD10)
#define RPG_GAMECORE_FINISHHITSTATEIMMEDIATELY_METHOD_3_361E3664C06DE166_OFFSET UNITYSDK_OFFSET(0x171EBC90)
#define RPG_GAMECORE_FINISHHITSTATEIMMEDIATELY__CTOR_OFFSET UNITYSDK_OFFSET(0x171EBCE0)
