...
#define RPG_GAMECORE_FINISHHITSTATEIMMEDIATELY_METHOD_3_19765CAD45C06517_OFFSET UNITYSDK_OFFSET(0x16AA6890)
#define RPG_GAMECORE_FINISHHITSTATEIMMEDIATELY_METHOD_3_361E3664C06DE166_OFFSET UNITYSDK_OFFSET(0x16AA6810)
#define RPG_GAMECORE_FINISHHITSTATEIMMEDIATELY__CTOR_OFFSET UNITYSDK_OFFSET(0x16AA6860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FinishHitStateImmediately_TypeDefinitionIndex = 21126;
