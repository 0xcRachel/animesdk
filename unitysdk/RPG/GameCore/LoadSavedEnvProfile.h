...
#define RPG_GAMECORE_LOADSAVEDENVPROFILE_METHOD_3_4364B61B3A88B2FC_OFFSET UNITYSDK_OFFSET(0x16BD4D40)
#define RPG_GAMECORE_LOADSAVEDENVPROFILE_METHOD_3_78176027C15C82C8_OFFSET UNITYSDK_OFFSET(0x16BD4E50)
#define RPG_GAMECORE_LOADSAVEDENVPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x16BD4E20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoadSavedEnvProfile_TypeDefinitionIndex = 18556;
