...
#define RPG_GAMECORE_LOADSAVEDENVPROFILE_METHOD_3_4364B61B3A88B2FC_OFFSET UNITYSDK_OFFSET(0x18FC27F0)
#define RPG_GAMECORE_LOADSAVEDENVPROFILE_METHOD_3_78176027C15C82C8_OFFSET UNITYSDK_OFFSET(0x18FC2900)
#define RPG_GAMECORE_LOADSAVEDENVPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x18FC28D0)
