...
#define RPG_GAMECORE_MOVETEAM_METHOD_3_2D95233F60A64029_OFFSET UNITYSDK_OFFSET(0x1746C020)
#define RPG_GAMECORE_MOVETEAM_METHOD_3_723D197141B8C5CF_OFFSET UNITYSDK_OFFSET(0x1746C0A0)
#define RPG_GAMECORE_MOVETEAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1746C070)
