...
#define RPG_GAMECORE_RA_BYALERTLEVEL_METHOD_4_2324D9EC737CACBB_OFFSET UNITYSDK_OFFSET(0x16DC0BC0)
#define RPG_GAMECORE_RA_BYALERTLEVEL_METHOD_4_75447B606F521C5D_OFFSET UNITYSDK_OFFSET(0x16D9B270)
#define RPG_GAMECORE_RA_BYALERTLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x16D9B220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RA_ByAlertLevel_TypeDefinitionIndex = 17804;
