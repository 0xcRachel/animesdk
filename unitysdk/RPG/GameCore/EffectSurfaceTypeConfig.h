...
#define RPG_GAMECORE_EFFECTSURFACETYPECONFIG_METHOD_2_2DC8F9AE448FFDB2_OFFSET UNITYSDK_OFFSET(0x16A5BC00)
#define RPG_GAMECORE_EFFECTSURFACETYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16A5BCD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EffectSurfaceTypeConfig_TypeDefinitionIndex = 14842;
