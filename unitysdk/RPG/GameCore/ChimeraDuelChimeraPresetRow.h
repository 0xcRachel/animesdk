...
#define RPG_GAMECORE_CHIMERADUELCHIMERAPRESETROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A50C590)
#define RPG_GAMECORE_CHIMERADUELCHIMERAPRESETROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A50C820)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Int32 DeltaAttack; // 0x20
		::System::UInt32 EquipmentID; // 0x24
