...
#define RPG_GAMECORE_CHIMERADUELCHIMERAPRESETROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1698A9B0)
#define RPG_GAMECORE_CHIMERADUELCHIMERAPRESETROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1698AC40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelChimeraPresetRow_TypeDefinitionIndex = 10347;
	...
	public:
		...
		::System::UInt32 SpecialParam; // 0x20
