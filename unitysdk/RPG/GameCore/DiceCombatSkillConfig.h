...
#define RPG_GAMECORE_DICECOMBATSKILLCONFIG_METHOD_2_3A8F7CFD8C7D9139_OFFSET UNITYSDK_OFFSET(0x1717C050)
#define RPG_GAMECORE_DICECOMBATSKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1717C240)
