...
#define RPG_GAMECORE_FIVEDIMACTIONRANDOMBUBBLETALKINFOGROUP_METHOD_2_F43B4387B350F7D6_OFFSET UNITYSDK_OFFSET(0x16AAA530)
#define RPG_GAMECORE_FIVEDIMACTIONRANDOMBUBBLETALKINFOGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x16AAA680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimActionRandomBubbleTalkInfoGroup_TypeDefinitionIndex = 16837;
