...
#define RPG_GAMECORE_ADVENTUREBYISNPCCONTROLLED_METHOD_4_39890152845F6D57_OFFSET UNITYSDK_OFFSET(0x19C018C0)
#define RPG_GAMECORE_ADVENTUREBYISNPCCONTROLLED_METHOD_4_8CCF678D7B87E726_OFFSET UNITYSDK_OFFSET(0x19C01C20)
#define RPG_GAMECORE_ADVENTUREBYISNPCCONTROLLED_METHOD_4_BFA0A6F0E5AA38FF_OFFSET UNITYSDK_OFFSET(0x19C01BA0)
#define RPG_GAMECORE_ADVENTUREBYISNPCCONTROLLED_METHOD_4_E5AE9D4CDB9F93F3_OFFSET UNITYSDK_OFFSET(0x19C01990)
#define RPG_GAMECORE_ADVENTUREBYISNPCCONTROLLED__CTOR_OFFSET UNITYSDK_OFFSET(0x19C01940)
