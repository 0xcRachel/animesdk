...
#define RPG_GAMECORE_MODIFIERCUSTOMEVENTCONFIG_METHOD_2_9A4F31EE8FFD93CC_OFFSET UNITYSDK_OFFSET(0x1743BCC0)
#define RPG_GAMECORE_MODIFIERCUSTOMEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1743BEB0)
