...
#define RPG_GAMECORE_FIVEDIMSPIKECONFIG_METHOD_3_A6AA8B55D3B0AAAA_OFFSET UNITYSDK_OFFSET(0x16AD5B80)
#define RPG_GAMECORE_FIVEDIMSPIKECONFIG_METHOD_3_F2723B93DC5C2D72_OFFSET UNITYSDK_OFFSET(0x16AD5B10)
#define RPG_GAMECORE_FIVEDIMSPIKECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16AD5B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSpikeConfig_TypeDefinitionIndex = 16683;
