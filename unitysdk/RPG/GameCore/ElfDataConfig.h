...
#define RPG_GAMECORE_ELFDATACONFIG_METHOD_3_937B6BCD668E260A_OFFSET UNITYSDK_OFFSET(0x16A5F3F0)
#define RPG_GAMECORE_ELFDATACONFIG_METHOD_3_B5D8A73788BD8BF1_OFFSET UNITYSDK_OFFSET(0x16A5F2D0)
#define RPG_GAMECORE_ELFDATACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16A5F3D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfDataConfig_TypeDefinitionIndex = 16580;
