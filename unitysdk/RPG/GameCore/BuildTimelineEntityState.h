...
#define RPG_GAMECORE_BUILDTIMELINEENTITYSTATE_METHOD_3_2F71B2B277E96AF3_OFFSET UNITYSDK_OFFSET(0x168FC520)
#define RPG_GAMECORE_BUILDTIMELINEENTITYSTATE_METHOD_3_4C50DE6F2E42FA17_OFFSET UNITYSDK_OFFSET(0x168FC5A0)
#define RPG_GAMECORE_BUILDTIMELINEENTITYSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x168FC570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BuildTimelineEntityState_TypeDefinitionIndex = 18431;
