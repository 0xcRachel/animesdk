...
#define RPG_GAMECORE_INITACTIVITYTELEVISIONBUFFINFO_METHOD_3_88B8A4C07C8BD7F7_OFFSET UNITYSDK_OFFSET(0x16B80D00)
#define RPG_GAMECORE_INITACTIVITYTELEVISIONBUFFINFO_METHOD_3_ECC229761E172FFF_OFFSET UNITYSDK_OFFSET(0x16B80C80)
#define RPG_GAMECORE_INITACTIVITYTELEVISIONBUFFINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16B80CD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InitActivityTelevisionBuffInfo_TypeDefinitionIndex = 20918;
