...
#define RPG_GAMECORE_BYINVISION_METHOD_4_6656D0A4635241BA_OFFSET UNITYSDK_OFFSET(0x1703CD30)
#define RPG_GAMECORE_BYINVISION_METHOD_4_7A55C768483C4A74_OFFSET UNITYSDK_OFFSET(0x1703CC50)
#define RPG_GAMECORE_BYINVISION__CTOR_OFFSET UNITYSDK_OFFSET(0x1703CCD0)
