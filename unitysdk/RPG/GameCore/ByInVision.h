...
#define RPG_GAMECORE_BYINVISION_METHOD_4_3C2E6E907B48A17E_OFFSET UNITYSDK_OFFSET(0x19D9A790)
#define RPG_GAMECORE_BYINVISION_METHOD_4_6656D0A4635241BA_OFFSET UNITYSDK_OFFSET(0x19D9A590)
#define RPG_GAMECORE_BYINVISION_METHOD_4_7A55C768483C4A74_OFFSET UNITYSDK_OFFSET(0x19D9A4B0)
#define RPG_GAMECORE_BYINVISION_METHOD_4_D204CA5A6A7A3C57_OFFSET UNITYSDK_OFFSET(0x19D9A710)
#define RPG_GAMECORE_BYINVISION__CTOR_OFFSET UNITYSDK_OFFSET(0x19D9A530)
