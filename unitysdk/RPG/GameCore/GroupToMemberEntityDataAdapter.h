...
#define RPG_GAMECORE_GROUPTOMEMBERENTITYDATAADAPTER_METHOD_3_C684DAC13DAC644A_OFFSET UNITYSDK_OFFSET(0x1A1C8790)
#define RPG_GAMECORE_GROUPTOMEMBERENTITYDATAADAPTER_METHOD_3_DCB5BA2F0EBA6D39_OFFSET UNITYSDK_OFFSET(0x1A1C8810)
#define RPG_GAMECORE_GROUPTOMEMBERENTITYDATAADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1C87E0)
