...
#define RPG_GAMECORE_GROUPTOMEMBERENTITYDATAADAPTER_METHOD_3_C684DAC13DAC644A_OFFSET UNITYSDK_OFFSET(0x18A5B250)
#define RPG_GAMECORE_GROUPTOMEMBERENTITYDATAADAPTER_METHOD_3_DCB5BA2F0EBA6D39_OFFSET UNITYSDK_OFFSET(0x18A5B2D0)
#define RPG_GAMECORE_GROUPTOMEMBERENTITYDATAADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18A5B2A0)
