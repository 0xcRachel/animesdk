...
#define RPG_GAMECORE_STARTWINDOWSTAGE_METHOD_3_4DD5662413556F0E_OFFSET UNITYSDK_OFFSET(0x1778B360)
#define RPG_GAMECORE_STARTWINDOWSTAGE_METHOD_3_DC37F054231FCD18_OFFSET UNITYSDK_OFFSET(0x1778B3E0)
#define RPG_GAMECORE_STARTWINDOWSTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1778B3B0)
