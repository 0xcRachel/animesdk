...
#define RPG_GAMECORE_BYCOMPARETARGET_METHOD_4_46A5B7F5E62E1A3C_OFFSET UNITYSDK_OFFSET(0x18FF7280)
#define RPG_GAMECORE_BYCOMPARETARGET_METHOD_4_6D16825289398698_OFFSET UNITYSDK_OFFSET(0x18FF71A0)
#define RPG_GAMECORE_BYCOMPARETARGET_METHOD_4_7CC5F56C31F14DFD_OFFSET UNITYSDK_OFFSET(0x18FF7490)
#define RPG_GAMECORE_BYCOMPARETARGET_METHOD_4_9B22EEB1518492FA_OFFSET UNITYSDK_OFFSET(0x18FF7510)
#define RPG_GAMECORE_BYCOMPARETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x18FF7220)
