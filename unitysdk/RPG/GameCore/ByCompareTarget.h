...
#define RPG_GAMECORE_BYCOMPARETARGET_METHOD_4_46A5B7F5E62E1A3C_OFFSET UNITYSDK_OFFSET(0x19AD50A0)
#define RPG_GAMECORE_BYCOMPARETARGET_METHOD_4_6D16825289398698_OFFSET UNITYSDK_OFFSET(0x19AD4FC0)
#define RPG_GAMECORE_BYCOMPARETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD5040)
