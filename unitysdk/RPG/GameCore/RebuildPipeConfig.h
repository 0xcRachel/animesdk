...
#define RPG_GAMECORE_REBUILDPIPECONFIG_METHOD_3_4A927ECEDF044FF0_OFFSET UNITYSDK_OFFSET(0x19AAE370)
#define RPG_GAMECORE_REBUILDPIPECONFIG_METHOD_3_F7363F569DE7B579_OFFSET UNITYSDK_OFFSET(0x19AAE3E0)
#define RPG_GAMECORE_REBUILDPIPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AAE3C0)
