...
#define RPG_GAMECORE_RESETTEAMENTITYFACEDIR_METHOD_3_B94EF0BED4427DA8_OFFSET UNITYSDK_OFFSET(0x16DE6AE0)
#define RPG_GAMECORE_RESETTEAMENTITYFACEDIR_METHOD_3_D81E7799E1483601_OFFSET UNITYSDK_OFFSET(0x16DE6B60)
#define RPG_GAMECORE_RESETTEAMENTITYFACEDIR__CTOR_OFFSET UNITYSDK_OFFSET(0x16DE6B30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetTeamEntityFaceDir_TypeDefinitionIndex = 21123;
