...
#define RPG_GAMECORE_NPCPOSSESSIONEFFECTCONFIG_METHOD_2_5E86C230C28F66C0_OFFSET UNITYSDK_OFFSET(0x1748CBE0)
#define RPG_GAMECORE_NPCPOSSESSIONEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1748CD30)
