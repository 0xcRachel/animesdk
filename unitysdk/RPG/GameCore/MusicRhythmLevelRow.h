...
#define RPG_GAMECORE_MUSICRHYTHMLEVELROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16CF6060)
#define RPG_GAMECORE_MUSICRHYTHMLEVELROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16CF6840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MusicRhythmLevelRow_TypeDefinitionIndex = 12986;
	...
	public:
		...
		::System::UInt32 LevelSecCount; // 0x28
		::System::UInt32 ID; // 0x2C
		::System::UInt32 Group; // 0x30
		::System::UInt32 EnterType; // 0x34
		::System::UInt32 Difficulty; // 0x38
		::System::UInt32 FeverComboCount; // 0x3C
