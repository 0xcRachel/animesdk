...
#define RPG_GAMECORE_MUSICRHYTHMLEVELROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x190FBF40)
#define RPG_GAMECORE_MUSICRHYTHMLEVELROW__CTOR_OFFSET UNITYSDK_OFFSET(0x190FC6F0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 Group; // 0x2C
		::System::UInt32 ID; // 0x30
		::System::UInt32 FeverComboCount; // 0x34
		::System::UInt32 EnterTypeParam; // 0x38
		::System::UInt32 LevelSecCount; // 0x3C
