...
#define RPG_GAMECORE_CHALLENGEPEAKGROUPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x170722D0)
#define RPG_GAMECORE_CHALLENGEPEAKGROUPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17072780)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::String* BossUI3DPrefabPath; // 0x10
		::System::String* ThemeIconPicPath; // 0x18
		::System::String* HandBookPanelBannerPath; // 0x20
		::System::String* BossUI3DAnimatorPath; // 0x28
		::Il2CppArray<::System::String*>* RankIconPathList; // 0x30
		::System::String* ThemePosterTabPicPath; // 0x38
		::Il2CppArray<::System::UInt32>* PreLevelIDList; // 0x40
		::RPG::Client::TextID Title; // 0x48
		::System::UInt32 ID; // 0x58
		::System::UInt32 BossLevelID; // 0x5C
		::System::UInt32 ActivityModule; // 0x60
