...
#define RPG_GAMECORE_CHALLENGEPEAKGROUPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18D4CEE0)
#define RPG_GAMECORE_CHALLENGEPEAKGROUPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18D4D390)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* HandBookPanelBannerPath; // 0x38
