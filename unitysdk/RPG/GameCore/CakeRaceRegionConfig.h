...
#define RPG_GAMECORE_CAKERACEREGIONCONFIG_METHOD_3_A69316D3C2E4FBA8_OFFSET UNITYSDK_OFFSET(0x16952040)
#define RPG_GAMECORE_CAKERACEREGIONCONFIG_METHOD_3_ED91A9EFF797BA3E_OFFSET UNITYSDK_OFFSET(0x169520D0)
#define RPG_GAMECORE_CAKERACEREGIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x169520B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceRegionConfig_TypeDefinitionIndex = 16551;
