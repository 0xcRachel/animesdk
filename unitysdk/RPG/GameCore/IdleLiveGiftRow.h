...
#define RPG_GAMECORE_IDLELIVEGIFTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18A8B350)
#define RPG_GAMECORE_IDLELIVEGIFTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18A8B810)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 DonateValue; // 0x34
		::System::UInt32 SenderID; // 0x38
		::System::UInt32 RarityType; // 0x3C
		::System::UInt32 FinalActChapterIndex; // 0x40
		::System::Single ProtectTime; // 0x44
		::System::UInt32 SourceID; // 0x48
		::System::Single FlySpeed; // 0x4C
		::System::UInt32 Count; // 0x50
		::System::UInt32 ID; // 0x54
		::System::UInt32 TriggerID; // 0x58
