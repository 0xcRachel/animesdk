...
#define RPG_GAMECORE_PROPTRYGETNIUDANREWARD_METHOD_3_A57ED3CE4C2DF419_OFFSET UNITYSDK_OFFSET(0x16DBA370)
#define RPG_GAMECORE_PROPTRYGETNIUDANREWARD_METHOD_3_F8A99638823AB037_OFFSET UNITYSDK_OFFSET(0x16DBA3F0)
#define RPG_GAMECORE_PROPTRYGETNIUDANREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x16DBA3C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropTryGetNiudanReward_TypeDefinitionIndex = 19613;
