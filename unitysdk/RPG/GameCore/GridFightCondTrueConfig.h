...
#define RPG_GAMECORE_GRIDFIGHTCONDTRUECONFIG_METHOD_6_537F70CEC5857840_OFFSET UNITYSDK_OFFSET(0x19569880)
#define RPG_GAMECORE_GRIDFIGHTCONDTRUECONFIG_METHOD_6_D6BFD2CEB5114344_OFFSET UNITYSDK_OFFSET(0x195696C0)
#define RPG_GAMECORE_GRIDFIGHTCONDTRUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x195697C0)
