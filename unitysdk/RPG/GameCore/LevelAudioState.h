...
#define RPG_GAMECORE_LEVELAUDIOSTATE_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x16B9FE10)
#define RPG_GAMECORE_LEVELAUDIOSTATE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B9FD90)
#define RPG_GAMECORE_LEVELAUDIOSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16B9FDE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelAudioState_TypeDefinitionIndex = 21504;
