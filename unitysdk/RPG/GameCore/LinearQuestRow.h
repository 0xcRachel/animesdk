...
#define RPG_GAMECORE_LINEARQUESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16BC2300)
#define RPG_GAMECORE_LINEARQUESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16BC2960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LinearQuestRow_TypeDefinitionIndex = 13224;
