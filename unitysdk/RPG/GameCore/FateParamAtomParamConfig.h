...
#define RPG_GAMECORE_FATEPARAMATOMPARAMCONFIG_METHOD_6_660F7C0DFA079411_OFFSET UNITYSDK_OFFSET(0x171DD9D0)
#define RPG_GAMECORE_FATEPARAMATOMPARAMCONFIG_METHOD_6_C42A31EF1D6FCC25_OFFSET UNITYSDK_OFFSET(0x171DDB90)
#define RPG_GAMECORE_FATEPARAMATOMPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171DDAD0)
