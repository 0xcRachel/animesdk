...
#define RPG_GAMECORE_ROGUEMAGICAREAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1996B680)
#define RPG_GAMECORE_ROGUEMAGICAREAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1996BFF0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::RogueMagicAreaGroupID AreaGroupID; // 0x48
