...
#define RPG_GAMECORE_ROGUEMAGICAREAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19EC0A50)
#define RPG_GAMECORE_ROGUEMAGICAREAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19EC13C0)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::Il2CppArray<::Class_1_73507DF29F8561CD*>* CustomStageDisplayParams; // 0x10
