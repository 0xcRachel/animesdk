...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::MultipleDropTypeConfig>**)Il2CppClass::FromTypeDefinitionIndex(ActivityFarmMultipleDropRow___O_TypeDefinitionIndex)->GetStaticField(0x140A0);
		}
	};
}
