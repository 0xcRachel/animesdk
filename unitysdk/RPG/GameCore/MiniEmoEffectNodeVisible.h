...
#define RPG_GAMECORE_MINIEMOEFFECTNODEVISIBLE_METHOD_2_4F9B7BCDA47869E6_OFFSET UNITYSDK_OFFSET(0x1906C7F0)
#define RPG_GAMECORE_MINIEMOEFFECTNODEVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1906C920)
