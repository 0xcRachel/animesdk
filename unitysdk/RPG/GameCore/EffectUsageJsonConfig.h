...
#define RPG_GAMECORE_EFFECTUSAGEJSONCONFIG_METHOD_2_6FE3F2A951EA6161_OFFSET UNITYSDK_OFFSET(0x1914ABE0)
#define RPG_GAMECORE_EFFECTUSAGEJSONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1914ACE0)
