...
#define RPG_GAMECORE_CAKERACEACTIONTOILETTRANSFER_METHOD_3_27424DEFF4A80787_OFFSET UNITYSDK_OFFSET(0x16949CB0)
#define RPG_GAMECORE_CAKERACEACTIONTOILETTRANSFER_METHOD_3_3E5860E7847E9929_OFFSET UNITYSDK_OFFSET(0x16948940)
#define RPG_GAMECORE_CAKERACEACTIONTOILETTRANSFER__CTOR_OFFSET UNITYSDK_OFFSET(0x16948920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionToiletTransfer_TypeDefinitionIndex = 16467;
