...
#define RPG_GAMECORE_CAKERACEACTIONTOILETTRANSFER_METHOD_3_27424DEFF4A80787_OFFSET UNITYSDK_OFFSET(0x1705B460)
#define RPG_GAMECORE_CAKERACEACTIONTOILETTRANSFER_METHOD_3_3E5860E7847E9929_OFFSET UNITYSDK_OFFSET(0x1705A0F0)
#define RPG_GAMECORE_CAKERACEACTIONTOILETTRANSFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1705A0D0)
