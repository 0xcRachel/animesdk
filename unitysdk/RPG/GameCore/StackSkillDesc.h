...
#define RPG_GAMECORE_STACKSKILLDESC_METHOD_3_E001CC4C5B83652D_OFFSET UNITYSDK_OFFSET(0x16F82DB0)
#define RPG_GAMECORE_STACKSKILLDESC_METHOD_3_EFFA8692BDCE2294_OFFSET UNITYSDK_OFFSET(0x16F82D30)
#define RPG_GAMECORE_STACKSKILLDESC__CTOR_OFFSET UNITYSDK_OFFSET(0x16F82D80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StackSkillDesc_TypeDefinitionIndex = 20805;
