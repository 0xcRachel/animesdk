...
#define RPG_GAMECORE_STACKSKILLDESC_METHOD_3_E001CC4C5B83652D_OFFSET UNITYSDK_OFFSET(0x186039B0)
#define RPG_GAMECORE_STACKSKILLDESC_METHOD_3_EFFA8692BDCE2294_OFFSET UNITYSDK_OFFSET(0x18603930)
#define RPG_GAMECORE_STACKSKILLDESC__CTOR_OFFSET UNITYSDK_OFFSET(0x18603980)
