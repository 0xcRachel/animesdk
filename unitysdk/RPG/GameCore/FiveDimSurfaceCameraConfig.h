...
#define RPG_GAMECORE_FIVEDIMSURFACECAMERACONFIG_METHOD_4_45E4D3DADB73B00C_OFFSET UNITYSDK_OFFSET(0x17223790)
#define RPG_GAMECORE_FIVEDIMSURFACECAMERACONFIG_METHOD_4_8B8E4347B4FEAF0A_OFFSET UNITYSDK_OFFSET(0x172236E0)
#define RPG_GAMECORE_FIVEDIMSURFACECAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17223750)
