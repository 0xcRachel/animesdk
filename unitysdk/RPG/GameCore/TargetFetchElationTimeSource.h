...
#define RPG_GAMECORE_TARGETFETCHELATIONTIMESOURCE_METHOD_4_8CFD2E091BF9E868_OFFSET UNITYSDK_OFFSET(0x177C9600)
#define RPG_GAMECORE_TARGETFETCHELATIONTIMESOURCE_METHOD_4_BD3B874BCD522DFA_OFFSET UNITYSDK_OFFSET(0x177D2C20)
#define RPG_GAMECORE_TARGETFETCHELATIONTIMESOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x177C95B0)
