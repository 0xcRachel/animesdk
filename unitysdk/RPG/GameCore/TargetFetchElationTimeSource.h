...
#define RPG_GAMECORE_TARGETFETCHELATIONTIMESOURCE_METHOD_4_8CFD2E091BF9E868_OFFSET UNITYSDK_OFFSET(0x16FD6940)
#define RPG_GAMECORE_TARGETFETCHELATIONTIMESOURCE_METHOD_4_BD3B874BCD522DFA_OFFSET UNITYSDK_OFFSET(0x16FDD2B0)
#define RPG_GAMECORE_TARGETFETCHELATIONTIMESOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD68F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchElationTimeSource_TypeDefinitionIndex = 21656;
