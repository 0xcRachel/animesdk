...
#define RPG_GAMECORE_MODIFYSWITCHHANDCONTROLPARAM_METHOD_3_B07CD41B72737B2D_OFFSET UNITYSDK_OFFSET(0x16CC2CB0)
#define RPG_GAMECORE_MODIFYSWITCHHANDCONTROLPARAM_METHOD_3_FC314BB4F30400B8_OFFSET UNITYSDK_OFFSET(0x16CC2D30)
#define RPG_GAMECORE_MODIFYSWITCHHANDCONTROLPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x16CC2D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifySwitchHandControlParam_TypeDefinitionIndex = 18769;
