...
#define RPG_GAMECORE_CONFIGMUNICIPAL_METHOD_2_388711155D06859D_OFFSET UNITYSDK_OFFSET(0x18F9FC10)
#define RPG_GAMECORE_CONFIGMUNICIPAL__CTOR_OFFSET UNITYSDK_OFFSET(0x18F9FE40)
