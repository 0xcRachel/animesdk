...
#define RPG_GAMECORE_CHENLINGFESITEMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A4FD450)
#define RPG_GAMECORE_CHENLINGFESITEMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4FD9D0)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::String* BaseProbability; // 0x10
		::System::String* ViewJsonPath; // 0x18
		::Il2CppArray<::System::UInt32>* TagList; // 0x20
		::System::String* BaseCoinNum; // 0x28
		::System::String* BaseMaxEffectTriggerNum; // 0x30
		::Il2CppArray<::System::Int32>* ParamList; // 0x38
		::System::String* IconPath; // 0x40
		::Il2CppArray<::System::UInt32>* EffectItemTypeList; // 0x48
		::System::String* LogicJsonPath; // 0x50
		::System::String* BaseLoopInterval; // 0x58
		::RPG::Client::TextID ItemDesc; // 0x60
		::RPG::Client::TextID ItemName; // 0x70
		::RPG::GameCore::ChenLingFesItemRare Rare; // 0x80
		::System::UInt32 ID; // 0x84
		::System::UInt32 MaxPutDownNum; // 0x88
