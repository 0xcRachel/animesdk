...
#define RPG_GAMECORE_SETDYNAMICVALUEBYELATIONTIMESKILLCOUNT_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1A1FB700)
#define RPG_GAMECORE_SETDYNAMICVALUEBYELATIONTIMESKILLCOUNT_METHOD_4_AB7B466C90B9FA2C_OFFSET UNITYSDK_OFFSET(0x1A1FB680)
#define RPG_GAMECORE_SETDYNAMICVALUEBYELATIONTIMESKILLCOUNT_METHOD_4_FC256F2E9E0A7CA9_OFFSET UNITYSDK_OFFSET(0x1A1F3CF0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYELATIONTIMESKILLCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1F3CA0)
