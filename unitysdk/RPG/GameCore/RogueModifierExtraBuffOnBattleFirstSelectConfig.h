...
#define RPG_GAMECORE_ROGUEMODIFIEREXTRABUFFONBATTLEFIRSTSELECTCONFIG_METHOD_3_5487DB754D5C25C0_OFFSET UNITYSDK_OFFSET(0x16E97D70)
#define RPG_GAMECORE_ROGUEMODIFIEREXTRABUFFONBATTLEFIRSTSELECTCONFIG_METHOD_3_6EA09C541C228929_OFFSET UNITYSDK_OFFSET(0x16E9F6A0)
#define RPG_GAMECORE_ROGUEMODIFIEREXTRABUFFONBATTLEFIRSTSELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E97D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExtraBuffOnBattleFirstSelectConfig_TypeDefinitionIndex = 16155;
