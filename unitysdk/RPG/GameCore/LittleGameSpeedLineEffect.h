...
#define RPG_GAMECORE_LITTLEGAMESPEEDLINEEFFECT_METHOD_3_3812DFAF47358662_OFFSET UNITYSDK_OFFSET(0x17374FD0)
#define RPG_GAMECORE_LITTLEGAMESPEEDLINEEFFECT_METHOD_3_EAF5D0BAFFBD5171_OFFSET UNITYSDK_OFFSET(0x173750D0)
#define RPG_GAMECORE_LITTLEGAMESPEEDLINEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x17375060)
