...
#define RPG_GAMECORE_ROGUECOMMONDIALOGUEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16E60190)
#define RPG_GAMECORE_ROGUECOMMONDIALOGUEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16E602C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueCommonDialogueRow_TypeDefinitionIndex = 13348;
