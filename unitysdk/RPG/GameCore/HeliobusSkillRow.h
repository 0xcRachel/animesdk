...
#define RPG_GAMECORE_HELIOBUSSKILLROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B6BC60)
#define RPG_GAMECORE_HELIOBUSSKILLROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B6C3E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HeliobusSkillRow_TypeDefinitionIndex = 12521;
	...
	public:
		...
		::System::UInt32 HeliobusSkillID; // 0x28
		::System::UInt32 UnlockToastMissionID; // 0x2C
		::System::UInt32 UnlockMissionID; // 0x30
		::RPG::GameCore::SkillEffect SkillEffect; // 0x34
