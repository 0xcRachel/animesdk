...
#define RPG_GAMECORE_VCAMERACONFIGLIST_METHOD_2_6BFD12A4FF85E4C7_OFFSET UNITYSDK_OFFSET(0x19A6FBA0)
#define RPG_GAMECORE_VCAMERACONFIGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x19A6FC80)
