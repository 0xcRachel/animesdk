...
#define RPG_GAMECORE_MODIFYACTIVITYELATIONPOWER_METHOD_3_306CAEE0EA376786_OFFSET UNITYSDK_OFFSET(0x1907AEC0)
#define RPG_GAMECORE_MODIFYACTIVITYELATIONPOWER_METHOD_3_34ACC63A1AE3D2B7_OFFSET UNITYSDK_OFFSET(0x1907AF40)
#define RPG_GAMECORE_MODIFYACTIVITYELATIONPOWER__CTOR_OFFSET UNITYSDK_OFFSET(0x1907AF10)
