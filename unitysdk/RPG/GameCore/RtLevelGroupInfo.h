...
#define RPG_GAMECORE_RTLEVELGROUPINFO_METHOD_3_DAC9391AEF50EEB0_OFFSET UNITYSDK_OFFSET(0x1768A2C0)
#define RPG_GAMECORE_RTLEVELGROUPINFO_METHOD_3_FD1363442F0E8864_OFFSET UNITYSDK_OFFSET(0x1768A330)
#define RPG_GAMECORE_RTLEVELGROUPINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1768A310)
