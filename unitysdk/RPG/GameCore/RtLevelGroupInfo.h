...
#define RPG_GAMECORE_RTLEVELGROUPINFO_METHOD_3_DAC9391AEF50EEB0_OFFSET UNITYSDK_OFFSET(0x16ED5C30)
#define RPG_GAMECORE_RTLEVELGROUPINFO_METHOD_3_FD1363442F0E8864_OFFSET UNITYSDK_OFFSET(0x16ED5CA0)
#define RPG_GAMECORE_RTLEVELGROUPINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16ED5C80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtLevelGroupInfo_TypeDefinitionIndex = 15648;
