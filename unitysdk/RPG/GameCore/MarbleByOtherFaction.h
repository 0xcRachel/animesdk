...
#define RPG_GAMECORE_MARBLEBYOTHERFACTION_METHOD_4_40ABEF8EAA245044_OFFSET UNITYSDK_OFFSET(0x16C3B1C0)
#define RPG_GAMECORE_MARBLEBYOTHERFACTION_METHOD_4_AF80E9A315138B99_OFFSET UNITYSDK_OFFSET(0x16C3B2A0)
#define RPG_GAMECORE_MARBLEBYOTHERFACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16C3B250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleByOtherFaction_TypeDefinitionIndex = 15195;
