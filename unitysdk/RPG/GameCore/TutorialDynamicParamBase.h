...
#define RPG_GAMECORE_TUTORIALDYNAMICPARAMBASE_METHOD_2_1AC451DA05700D01_OFFSET UNITYSDK_OFFSET(0x171307D0)
#define RPG_GAMECORE_TUTORIALDYNAMICPARAMBASE_METHOD_2_67796FD922CE6D74_OFFSET UNITYSDK_OFFSET(0x17130960)
#define RPG_GAMECORE_TUTORIALDYNAMICPARAMBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x171309C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialDynamicParamBase_TypeDefinitionIndex = 21801;
