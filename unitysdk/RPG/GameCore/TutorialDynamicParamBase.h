...
#define RPG_GAMECORE_TUTORIALDYNAMICPARAMBASE_METHOD_2_67796FD922CE6D74_OFFSET UNITYSDK_OFFSET(0x19128BE0)
#define RPG_GAMECORE_TUTORIALDYNAMICPARAMBASE_METHOD_2_CB22982B16077881_OFFSET UNITYSDK_OFFSET(0x191289C0)
#define RPG_GAMECORE_TUTORIALDYNAMICPARAMBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19128C40)
