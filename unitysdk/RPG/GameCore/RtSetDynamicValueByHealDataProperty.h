...
#define RPG_GAMECORE_RTSETDYNAMICVALUEBYHEALDATAPROPERTY_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1A158900)
#define RPG_GAMECORE_RTSETDYNAMICVALUEBYHEALDATAPROPERTY_METHOD_4_1373348A5D9DF5DE_OFFSET UNITYSDK_OFFSET(0x1A158710)
#define RPG_GAMECORE_RTSETDYNAMICVALUEBYHEALDATAPROPERTY_METHOD_4_8C910B8CF8171062_OFFSET UNITYSDK_OFFSET(0x1A158640)
#define RPG_GAMECORE_RTSETDYNAMICVALUEBYHEALDATAPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1586C0)
