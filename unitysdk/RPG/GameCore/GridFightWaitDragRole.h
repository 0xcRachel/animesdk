...
#define RPG_GAMECORE_GRIDFIGHTWAITDRAGROLE_METHOD_3_74BE9A38E0C4489A_OFFSET UNITYSDK_OFFSET(0x16B50B00)
#define RPG_GAMECORE_GRIDFIGHTWAITDRAGROLE_METHOD_3_A3CB618E08EE56AB_OFFSET UNITYSDK_OFFSET(0x16B50A80)
#define RPG_GAMECORE_GRIDFIGHTWAITDRAGROLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16B50AD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightWaitDragRole_TypeDefinitionIndex = 17713;
