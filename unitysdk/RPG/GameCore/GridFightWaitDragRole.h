...
#define RPG_GAMECORE_GRIDFIGHTWAITDRAGROLE_METHOD_3_74BE9A38E0C4489A_OFFSET UNITYSDK_OFFSET(0x1A1C5B10)
#define RPG_GAMECORE_GRIDFIGHTWAITDRAGROLE_METHOD_3_A3CB618E08EE56AB_OFFSET UNITYSDK_OFFSET(0x1A1C5A90)
#define RPG_GAMECORE_GRIDFIGHTWAITDRAGROLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1C5AE0)
