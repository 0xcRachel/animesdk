...
#define RPG_GAMECORE_BYISINELATIONTIME_METHOD_4_721BF12B1EA14222_OFFSET UNITYSDK_OFFSET(0x16932C60)
#define RPG_GAMECORE_BYISINELATIONTIME_METHOD_4_B3A97AA292D987C8_OFFSET UNITYSDK_OFFSET(0x16932B90)
#define RPG_GAMECORE_BYISINELATIONTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x16932C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsInElationTime_TypeDefinitionIndex = 20249;
