...
#define RPG_GAMECORE_CAKERACEBANDRAGCAMERA_METHOD_3_648FFB50C087B5DC_OFFSET UNITYSDK_OFFSET(0x1705BB30)
#define RPG_GAMECORE_CAKERACEBANDRAGCAMERA_METHOD_3_AF5EBA9394855D6D_OFFSET UNITYSDK_OFFSET(0x1705BBB0)
#define RPG_GAMECORE_CAKERACEBANDRAGCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x1705BB80)
