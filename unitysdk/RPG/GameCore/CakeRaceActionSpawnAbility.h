...
#define RPG_GAMECORE_CAKERACEACTIONSPAWNABILITY_METHOD_3_7E870B39A2CAC5DB_OFFSET UNITYSDK_OFFSET(0x19A7C0F0)
#define RPG_GAMECORE_CAKERACEACTIONSPAWNABILITY_METHOD_3_BB6A735C1D1F1484_OFFSET UNITYSDK_OFFSET(0x19A7D440)
#define RPG_GAMECORE_CAKERACEACTIONSPAWNABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x19A7C0D0)
