...
#define RPG_GAMECORE_CAKERACEACTIONSPAWNABILITY_METHOD_3_7E870B39A2CAC5DB_OFFSET UNITYSDK_OFFSET(0x169485B0)
#define RPG_GAMECORE_CAKERACEACTIONSPAWNABILITY_METHOD_3_BB6A735C1D1F1484_OFFSET UNITYSDK_OFFSET(0x16949900)
#define RPG_GAMECORE_CAKERACEACTIONSPAWNABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x16948590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionSpawnAbility_TypeDefinitionIndex = 16483;
