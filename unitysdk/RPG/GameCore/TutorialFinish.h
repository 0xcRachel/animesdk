...
#define RPG_GAMECORE_TUTORIALFINISH_METHOD_3_98E426301EBE3040_OFFSET UNITYSDK_OFFSET(0x19128C50)
#define RPG_GAMECORE_TUTORIALFINISH_METHOD_3_BF72193C4C640A49_OFFSET UNITYSDK_OFFSET(0x19128CD0)
#define RPG_GAMECORE_TUTORIALFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x19128CA0)
