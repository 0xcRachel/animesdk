...
#define RPG_GAMECORE_UNIFIEDBATTLEAREACONFIG_METHOD_2_E95D8DB6DE19A912_OFFSET UNITYSDK_OFFSET(0x1713BD50)
#define RPG_GAMECORE_UNIFIEDBATTLEAREACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1713C100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UnifiedBattleAreaConfig_TypeDefinitionIndex = 15726;
