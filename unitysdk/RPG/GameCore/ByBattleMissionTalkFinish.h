...
#define RPG_GAMECORE_BYBATTLEMISSIONTALKFINISH_METHOD_4_26B844E6F6CB7485_OFFSET UNITYSDK_OFFSET(0x168FF070)
#define RPG_GAMECORE_BYBATTLEMISSIONTALKFINISH_METHOD_4_EAB380450B53ED6F_OFFSET UNITYSDK_OFFSET(0x168FEFA0)
#define RPG_GAMECORE_BYBATTLEMISSIONTALKFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x168FF020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByBattleMissionTalkFinish_TypeDefinitionIndex = 21524;
