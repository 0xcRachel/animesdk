...
#define RPG_GAMECORE_BYRANKACTIVATEDFROMLINEUP_METHOD_4_7A0BB6489ABF64BC_OFFSET UNITYSDK_OFFSET(0x19A6FA90)
#define RPG_GAMECORE_BYRANKACTIVATEDFROMLINEUP_METHOD_4_7E5EF800C23538CA_OFFSET UNITYSDK_OFFSET(0x19A6FB60)
#define RPG_GAMECORE_BYRANKACTIVATEDFROMLINEUP__CTOR_OFFSET UNITYSDK_OFFSET(0x19A6FB10)
