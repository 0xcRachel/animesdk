...
#define RPG_GAMECORE_ADVENABLETRIGGER_METHOD_3_7895DA176D765DBF_OFFSET UNITYSDK_OFFSET(0x16833560)
#define RPG_GAMECORE_ADVENABLETRIGGER_METHOD_3_8960230821DCA829_OFFSET UNITYSDK_OFFSET(0x168335E0)
#define RPG_GAMECORE_ADVENABLETRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x168335B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvEnableTrigger_TypeDefinitionIndex = 18324;
