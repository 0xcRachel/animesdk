...
#define RPG_GAMECORE_COMPLEXSKILLAIFACTORGROUP_METHOD_2_79348BA9B6A1295A_OFFSET UNITYSDK_OFFSET(0x1A325C90)
#define RPG_GAMECORE_COMPLEXSKILLAIFACTORGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A325E30)
