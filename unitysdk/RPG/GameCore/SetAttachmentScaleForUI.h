...
#define RPG_GAMECORE_SETATTACHMENTSCALEFORUI_METHOD_4_4EE550CD4733CB00_OFFSET UNITYSDK_OFFSET(0x1A1E34F0)
#define RPG_GAMECORE_SETATTACHMENTSCALEFORUI_METHOD_4_8F9B9BCA783AA1D1_OFFSET UNITYSDK_OFFSET(0x1A1E3270)
#define RPG_GAMECORE_SETATTACHMENTSCALEFORUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1E3230)
