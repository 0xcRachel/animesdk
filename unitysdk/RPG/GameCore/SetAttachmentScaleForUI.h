...
#define RPG_GAMECORE_SETATTACHMENTSCALEFORUI_METHOD_4_7B196E426C96604E_OFFSET UNITYSDK_OFFSET(0x16F05F90)
#define RPG_GAMECORE_SETATTACHMENTSCALEFORUI_METHOD_4_E3577C54F5FE36A8_OFFSET UNITYSDK_OFFSET(0x16F06200)
#define RPG_GAMECORE_SETATTACHMENTSCALEFORUI__CTOR_OFFSET UNITYSDK_OFFSET(0x16F05F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAttachmentScaleForUI_TypeDefinitionIndex = 20035;
