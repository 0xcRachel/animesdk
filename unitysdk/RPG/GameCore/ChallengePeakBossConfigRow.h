...
#define RPG_GAMECORE_CHALLENGEPEAKBOSSCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x169604B0)
#define RPG_GAMECORE_CHALLENGEPEAKBOSSCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x169607A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChallengePeakBossConfigRow_TypeDefinitionIndex = 11764;

	class ChallengePeakBossConfigRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* HardTagList; // 0x10
		::Il2CppArray<::System::UInt32>* HardEventIDList; // 0x18
		::Il2CppArray<::System::UInt32>* BuffList; // 0x20
		::RPG::Client::TextID HardTitle; // 0x28
		::System::UInt32 ColorMedalTarget; // 0x38
		::System::UInt32 ID; // 0x3C
		::System::UInt32 HardTarget; // 0x40
