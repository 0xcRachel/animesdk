...
#define RPG_GAMECORE_SHOWDAMAGETEXT_METHOD_3_4E6208DFEB83981B_OFFSET UNITYSDK_OFFSET(0x16F570E0)
#define RPG_GAMECORE_SHOWDAMAGETEXT_METHOD_3_C4EA692CD5193770_OFFSET UNITYSDK_OFFSET(0x16F57060)
#define RPG_GAMECORE_SHOWDAMAGETEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F570B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowDamageText_TypeDefinitionIndex = 21238;
