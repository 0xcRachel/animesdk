...
#define RPG_GAMECORE_SHOWDAMAGETEXT_METHOD_3_4E6208DFEB83981B_OFFSET UNITYSDK_OFFSET(0x1770C600)
#define RPG_GAMECORE_SHOWDAMAGETEXT_METHOD_3_C4EA692CD5193770_OFFSET UNITYSDK_OFFSET(0x1770C580)
#define RPG_GAMECORE_SHOWDAMAGETEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1770C5D0)
