...
#define RPG_GAMECORE_ANIMATORCLIPZONENEWCONFIG_METHOD_2_B2C2A5A52A83D28E_OFFSET UNITYSDK_OFFSET(0x1688A3B0)
#define RPG_GAMECORE_ANIMATORCLIPZONENEWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1688A4B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AnimatorClipZoneNewConfig_TypeDefinitionIndex = 14697;
