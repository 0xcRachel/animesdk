...
#define RPG_GAMECORE_CHANGECHARACTERSOMATOTYPE_METHOD_3_4C360DE58383F0E7_OFFSET UNITYSDK_OFFSET(0x16964960)
#define RPG_GAMECORE_CHANGECHARACTERSOMATOTYPE_METHOD_3_9278CD33DC2848E8_OFFSET UNITYSDK_OFFSET(0x16964A30)
#define RPG_GAMECORE_CHANGECHARACTERSOMATOTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x169649E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeCharacterSomatoType_TypeDefinitionIndex = 21368;
