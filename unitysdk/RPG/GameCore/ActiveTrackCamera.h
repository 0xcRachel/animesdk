...
#define RPG_GAMECORE_ACTIVETRACKCAMERA_METHOD_3_44B2CEC4131D2F60_OFFSET UNITYSDK_OFFSET(0x1677FA00)
#define RPG_GAMECORE_ACTIVETRACKCAMERA_METHOD_3_67F85D1A67E1EB13_OFFSET UNITYSDK_OFFSET(0x1677F940)
#define RPG_GAMECORE_ACTIVETRACKCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x1677F9B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActiveTrackCamera_TypeDefinitionIndex = 18636;
