...
#define RPG_GAMECORE_WAITBATTLEOPERATION_METHOD_3_06F02828ADC4069C_OFFSET UNITYSDK_OFFSET(0x1714DC80)
#define RPG_GAMECORE_WAITBATTLEOPERATION_METHOD_3_4BFF9FC9D497DC99_OFFSET UNITYSDK_OFFSET(0x1714DD10)
#define RPG_GAMECORE_WAITBATTLEOPERATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1714DCE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitBattleOperation_TypeDefinitionIndex = 21854;
