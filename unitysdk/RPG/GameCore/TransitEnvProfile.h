...
#define RPG_GAMECORE_TRANSITENVPROFILE_METHOD_3_4942AB81878A4872_OFFSET UNITYSDK_OFFSET(0x178C7B90)
#define RPG_GAMECORE_TRANSITENVPROFILE_METHOD_3_D13E4BFDB0947502_OFFSET UNITYSDK_OFFSET(0x178C7DF0)
#define RPG_GAMECORE_TRANSITENVPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x178C7DC0)
