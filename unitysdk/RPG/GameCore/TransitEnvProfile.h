...
#define RPG_GAMECORE_TRANSITENVPROFILE_METHOD_3_4942AB81878A4872_OFFSET UNITYSDK_OFFSET(0x1710BB90)
#define RPG_GAMECORE_TRANSITENVPROFILE_METHOD_3_D13E4BFDB0947502_OFFSET UNITYSDK_OFFSET(0x1710BDF0)
#define RPG_GAMECORE_TRANSITENVPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x1710BDC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TransitEnvProfile_TypeDefinitionIndex = 18554;
