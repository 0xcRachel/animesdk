...
#define RPG_GAMECORE_POINTNAVPATHLENGTHEVALUATOR_METHOD_4_420771743CBF304A_OFFSET UNITYSDK_OFFSET(0x19367010)
#define RPG_GAMECORE_POINTNAVPATHLENGTHEVALUATOR_METHOD_4_D224151EEEFCD9A5_OFFSET UNITYSDK_OFFSET(0x19367BD0)
#define RPG_GAMECORE_POINTNAVPATHLENGTHEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19367000)
