...
#define RPG_GAMECORE_GRIDFIGHTTRAITOLDLAYERCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B4EEA0)
#define RPG_GAMECORE_GRIDFIGHTTRAITOLDLAYERCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B4F290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightTraitOldLayerConfigRow_TypeDefinitionIndex = 12470;
	...
	public:
		...
		::RPG::Client::TextID PropertyDesc; // 0x28
		::System::UInt32 TraitID; // 0x38
		::System::UInt32 Layer; // 0x3C
		::System::UInt32 ExistSeason; // 0x40
