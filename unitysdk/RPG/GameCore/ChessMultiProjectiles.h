...
#define RPG_GAMECORE_CHESSMULTIPROJECTILES_METHOD_3_356915788D4A7FEA_OFFSET UNITYSDK_OFFSET(0x1697F700)
#define RPG_GAMECORE_CHESSMULTIPROJECTILES_METHOD_3_9845761BD0D01F54_OFFSET UNITYSDK_OFFSET(0x1697F680)
#define RPG_GAMECORE_CHESSMULTIPROJECTILES__CTOR_OFFSET UNITYSDK_OFFSET(0x1697F6D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChessMultiProjectiles_TypeDefinitionIndex = 21430;
