...
#define RPG_GAMECORE_SETLASTKILLFINISH_METHOD_3_5C60BB6944611378_OFFSET UNITYSDK_OFFSET(0x199B97C0)
#define RPG_GAMECORE_SETLASTKILLFINISH_METHOD_3_CAD40592DB7CEBEC_OFFSET UNITYSDK_OFFSET(0x199B96B0)
#define RPG_GAMECORE_SETLASTKILLFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x199B9790)
