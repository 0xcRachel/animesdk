...
#define RPG_GAMECORE_SETLASTKILLFINISH_METHOD_3_5C60BB6944611378_OFFSET UNITYSDK_OFFSET(0x16F31B00)
#define RPG_GAMECORE_SETLASTKILLFINISH_METHOD_3_CAD40592DB7CEBEC_OFFSET UNITYSDK_OFFSET(0x16F319F0)
#define RPG_GAMECORE_SETLASTKILLFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x16F31AD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetLastKillFinish_TypeDefinitionIndex = 21080;
