...
#define RPG_GAMECORE_AETHERDIVIDESPIRITSKILLROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16870640)
#define RPG_GAMECORE_AETHERDIVIDESPIRITSKILLROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16871510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AetherDivideSpiritSkillRow_TypeDefinitionIndex = 10234;
	...
	public:
		...
		::RPG::GameCore::FixPoint SPBase; // 0x48
		...
		::RPG::GameCore::AetherSpiritType PropertyType; // 0x7C
