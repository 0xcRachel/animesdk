...
#define RPG_GAMECORE_QTECATCHGHOSTREWIND_METHOD_3_576E08067ED778DE_OFFSET UNITYSDK_OFFSET(0x16DBDB00)
#define RPG_GAMECORE_QTECATCHGHOSTREWIND_METHOD_3_69DF8C042D29ACD3_OFFSET UNITYSDK_OFFSET(0x16DBDA80)
#define RPG_GAMECORE_QTECATCHGHOSTREWIND__CTOR_OFFSET UNITYSDK_OFFSET(0x16DBDAD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int QteCatchGhostRewind_TypeDefinitionIndex = 19696;
