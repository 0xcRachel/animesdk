...
#define RPG_GAMECORE_VCAMERABLENDCONFIG_METHOD_3_6051098174EA81C8_OFFSET UNITYSDK_OFFSET(0x171414A0)
#define RPG_GAMECORE_VCAMERABLENDCONFIG_METHOD_3_7C59C9A4E8F7B161_OFFSET UNITYSDK_OFFSET(0x17141420)
#define RPG_GAMECORE_VCAMERABLENDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17141470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VCameraBlendConfig_TypeDefinitionIndex = 18048;
