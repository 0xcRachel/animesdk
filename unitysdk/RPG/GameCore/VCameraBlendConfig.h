...
#define RPG_GAMECORE_VCAMERABLENDCONFIG_METHOD_3_6051098174EA81C8_OFFSET UNITYSDK_OFFSET(0x19515100)
#define RPG_GAMECORE_VCAMERABLENDCONFIG_METHOD_3_7C59C9A4E8F7B161_OFFSET UNITYSDK_OFFSET(0x19515080)
#define RPG_GAMECORE_VCAMERABLENDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x195150D0)
