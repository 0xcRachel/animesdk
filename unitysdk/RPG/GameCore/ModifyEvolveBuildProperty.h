...
#define RPG_GAMECORE_MODIFYEVOLVEBUILDPROPERTY_METHOD_3_1C464D090863587F_OFFSET UNITYSDK_OFFSET(0x174450D0)
#define RPG_GAMECORE_MODIFYEVOLVEBUILDPROPERTY_METHOD_3_AE271607FE018280_OFFSET UNITYSDK_OFFSET(0x17445160)
#define RPG_GAMECORE_MODIFYEVOLVEBUILDPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x17445130)
