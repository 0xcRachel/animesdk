...
#define RPG_GAMECORE_FIVEDIMSETPROPSPAWNERENABLEACTION_METHOD_3_E4CE10F3EB0FC9C3_OFFSET UNITYSDK_OFFSET(0x16AD4230)
#define RPG_GAMECORE_FIVEDIMSETPROPSPAWNERENABLEACTION_METHOD_3_E6E33D5697A24F2F_OFFSET UNITYSDK_OFFSET(0x16AD4100)
#define RPG_GAMECORE_FIVEDIMSETPROPSPAWNERENABLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16AD4210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetPropSpawnerEnableAction_TypeDefinitionIndex = 16759;
