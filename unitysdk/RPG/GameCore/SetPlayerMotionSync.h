...
#define RPG_GAMECORE_SETPLAYERMOTIONSYNC_METHOD_3_13A66FCB5052FBBF_OFFSET UNITYSDK_OFFSET(0x176EF8A0)
#define RPG_GAMECORE_SETPLAYERMOTIONSYNC_METHOD_3_C3C2AB6B7407C3EE_OFFSET UNITYSDK_OFFSET(0x176EF920)
#define RPG_GAMECORE_SETPLAYERMOTIONSYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x176EF8F0)
