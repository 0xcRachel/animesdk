...
#define RPG_GAMECORE_TARGETSORTBYDEATHORDER_METHOD_3_40854B8CE02E2A76_OFFSET UNITYSDK_OFFSET(0x171354B0)
#define RPG_GAMECORE_TARGETSORTBYDEATHORDER_METHOD_3_F993ADA5A7248719_OFFSET UNITYSDK_OFFSET(0x17133540)
#define RPG_GAMECORE_TARGETSORTBYDEATHORDER__CTOR_OFFSET UNITYSDK_OFFSET(0x17133520)
