...
#define RPG_GAMECORE_TARGETSORTBYDEATHORDER_METHOD_3_40854B8CE02E2A76_OFFSET UNITYSDK_OFFSET(0x16FF2480)
#define RPG_GAMECORE_TARGETSORTBYDEATHORDER_METHOD_3_F993ADA5A7248719_OFFSET UNITYSDK_OFFSET(0x16FF0840)
#define RPG_GAMECORE_TARGETSORTBYDEATHORDER__CTOR_OFFSET UNITYSDK_OFFSET(0x16FF0820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSortByDeathOrder_TypeDefinitionIndex = 21698;
