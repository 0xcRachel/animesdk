...
#define RPG_GAMECORE_PROPUNLOADHITBOX_METHOD_3_344D148D94EC9FFA_OFFSET UNITYSDK_OFFSET(0x16DBA5B0)
#define RPG_GAMECORE_PROPUNLOADHITBOX_METHOD_3_B717E66BFA4D2983_OFFSET UNITYSDK_OFFSET(0x16DBA530)
#define RPG_GAMECORE_PROPUNLOADHITBOX__CTOR_OFFSET UNITYSDK_OFFSET(0x16DBA580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropUnloadHitBox_TypeDefinitionIndex = 19669;
