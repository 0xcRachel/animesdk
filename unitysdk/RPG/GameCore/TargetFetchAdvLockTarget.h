...
#define RPG_GAMECORE_TARGETFETCHADVLOCKTARGET_METHOD_4_3FDCF70080D9C1D3_OFFSET UNITYSDK_OFFSET(0x16FD1E80)
#define RPG_GAMECORE_TARGETFETCHADVLOCKTARGET_METHOD_4_C5DB0049B1146EC5_OFFSET UNITYSDK_OFFSET(0x16FDAAD0)
#define RPG_GAMECORE_TARGETFETCHADVLOCKTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD1E30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAdvLockTarget_TypeDefinitionIndex = 21631;
