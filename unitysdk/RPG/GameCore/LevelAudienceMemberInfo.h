...
#define RPG_GAMECORE_LEVELAUDIENCEMEMBERINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B9F710)
#define RPG_GAMECORE_LEVELAUDIENCEMEMBERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16B9FC10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelAudienceMemberInfo_TypeDefinitionIndex = 15631;
