...
#define RPG_GAMECORE_RESOLUTIONADAPTIONCONFIGLIST_METHOD_2_821C742B91CB6BA6_OFFSET UNITYSDK_OFFSET(0x1A2F0010)
#define RPG_GAMECORE_RESOLUTIONADAPTIONCONFIGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2F00F0)
