...
#define RPG_GAMECORE_SETALLROGUEPROPSTATE_METHOD_3_DDCA240129EAA9B4_OFFSET UNITYSDK_OFFSET(0x1A1E2450)
#define RPG_GAMECORE_SETALLROGUEPROPSTATE_METHOD_3_F18EAAEC85933D74_OFFSET UNITYSDK_OFFSET(0x1A1E24E0)
#define RPG_GAMECORE_SETALLROGUEPROPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1E24B0)
