...
#define RPG_GAMECORE_CHANGEGROUPSTATE_METHOD_3_59CD469E94EF4843_OFFSET UNITYSDK_OFFSET(0x170774B0)
#define RPG_GAMECORE_CHANGEGROUPSTATE_METHOD_3_EC340CE77CFCDAB3_OFFSET UNITYSDK_OFFSET(0x17077540)
#define RPG_GAMECORE_CHANGEGROUPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17077510)
