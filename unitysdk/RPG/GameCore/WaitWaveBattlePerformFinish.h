...
#define RPG_GAMECORE_WAITWAVEBATTLEPERFORMFINISH_METHOD_3_331B102A591E26E7_OFFSET UNITYSDK_OFFSET(0x1791CD90)
#define RPG_GAMECORE_WAITWAVEBATTLEPERFORMFINISH_METHOD_3_3500EF62E1CBB153_OFFSET UNITYSDK_OFFSET(0x1791CC80)
#define RPG_GAMECORE_WAITWAVEBATTLEPERFORMFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1791CD60)
