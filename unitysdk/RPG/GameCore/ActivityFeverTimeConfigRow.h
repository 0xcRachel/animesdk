...
#define RPG_GAMECORE_ACTIVITYFEVERTIMECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x198A3B70)
#define RPG_GAMECORE_ACTIVITYFEVERTIMECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x198A48C0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* WaveMonsterList_1; // 0x30
		...
		::RPG::Client::TextID LevelDes1; // 0x68
		::System::UInt32 ActivityModuleID; // 0x78
		::System::UInt32 EventID; // 0x7C
		::RPG::Client::TextID StageName; // 0x80
		::System::UInt32 ExtraEffectID; // 0x90
		::System::UInt32 FeverTimeID; // 0x94
		::RPG::Client::TextID LevelDes2; // 0x98
		::RPG::Client::TextID LevelSPDes; // 0xA8
