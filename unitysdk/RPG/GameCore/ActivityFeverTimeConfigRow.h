...
#define RPG_GAMECORE_ACTIVITYFEVERTIMECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x167921C0)
#define RPG_GAMECORE_ACTIVITYFEVERTIMECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16792F80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityFeverTimeConfigRow_TypeDefinitionIndex = 10716;

	class ActivityFeverTimeConfigRow : public ::System::Object
	{
	public:
		::Il2CppArray<::RPG::GameCore::AttackDamageType>* RecommadNature; // 0x10
		::Il2CppArray<::System::UInt32>* WaveMonsterList_1; // 0x18
		::Il2CppArray<::System::UInt32>* MonsterList; // 0x20
		::Il2CppArray<::System::UInt32>* P2AvailableBuffList; // 0x28
		::Il2CppArray<::System::UInt32>* WaveMonsterList_3; // 0x30
		::System::String* ImagePath; // 0x38
		::Il2CppArray<::System::UInt32>* P1AvailableBuffList; // 0x40
		::Il2CppArray<::System::UInt32>* WaveMonsterList_2; // 0x48
		::Il2CppArray<::System::UInt32>* SpecialAvatarList; // 0x50
		::Il2CppArray<::System::UInt32>* P3MazeBuffID; // 0x58
		::RPG::Client::TextID StageName; // 0x60
		::System::UInt32 ActivityModuleID; // 0x70
		::System::UInt32 TutorialGuideGroupID; // 0x74
		::RPG::Client::TextID LevelDes2; // 0x78
		::System::UInt32 EventID; // 0x88
		::System::UInt32 UnlockID; // 0x8C
		::RPG::Client::TextID LevelDes1; // 0x90
		::System::UInt32 UIEnterBattleAreaID; // 0xA0
		::System::UInt32 QuestGroupID; // 0xA4
		::System::UInt32 ExtraEffectID; // 0xA8
		::System::UInt32 FeverTimeID; // 0xAC
		::RPG::Client::TextID LevelSPDes; // 0xB0
