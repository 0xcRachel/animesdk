...
#define RPG_GAMECORE_TELEPORTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x170ED1D0)
#define RPG_GAMECORE_TELEPORTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x170ED850)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TeleportConfigRow_TypeDefinitionIndex = 11406;
