...
#define RPG_GAMECORE_TARGETFETCHSUMMONMONSTERS_METHOD_4_CAC4DDCF92FE006A_OFFSET UNITYSDK_OFFSET(0x199E2CB0)
#define RPG_GAMECORE_TARGETFETCHSUMMONMONSTERS_METHOD_4_FE0028A85C2F1498_OFFSET UNITYSDK_OFFSET(0x199DD0D0)
#define RPG_GAMECORE_TARGETFETCHSUMMONMONSTERS__CTOR_OFFSET UNITYSDK_OFFSET(0x199DD080)
