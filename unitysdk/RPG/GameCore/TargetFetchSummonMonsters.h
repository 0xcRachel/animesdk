...
#define RPG_GAMECORE_TARGETFETCHSUMMONMONSTERS_METHOD_4_CAC4DDCF92FE006A_OFFSET UNITYSDK_OFFSET(0x177D4880)
#define RPG_GAMECORE_TARGETFETCHSUMMONMONSTERS_METHOD_4_FE0028A85C2F1498_OFFSET UNITYSDK_OFFSET(0x177CCB10)
#define RPG_GAMECORE_TARGETFETCHSUMMONMONSTERS__CTOR_OFFSET UNITYSDK_OFFSET(0x177CCAC0)
