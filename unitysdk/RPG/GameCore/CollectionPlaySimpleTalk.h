...
#define RPG_GAMECORE_COLLECTIONPLAYSIMPLETALK_METHOD_3_4114C02E6E463901_OFFSET UNITYSDK_OFFSET(0x17133B70)
#define RPG_GAMECORE_COLLECTIONPLAYSIMPLETALK_METHOD_3_84BAABDA5EF018C0_OFFSET UNITYSDK_OFFSET(0x17133AF0)
#define RPG_GAMECORE_COLLECTIONPLAYSIMPLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x17133B40)
