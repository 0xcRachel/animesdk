...
#define RPG_GAMECORE_WAITFORTURNEND_METHOD_3_228E1220FB636187_OFFSET UNITYSDK_OFFSET(0x1952BA00)
#define RPG_GAMECORE_WAITFORTURNEND_METHOD_3_30BA599FC4C8ECB6_OFFSET UNITYSDK_OFFSET(0x1952BA80)
#define RPG_GAMECORE_WAITFORTURNEND__CTOR_OFFSET UNITYSDK_OFFSET(0x1952BA50)
