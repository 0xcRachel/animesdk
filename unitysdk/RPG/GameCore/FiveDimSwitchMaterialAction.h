...
#define RPG_GAMECORE_FIVEDIMSWITCHMATERIALACTION_METHOD_3_B6DF56A91BA61439_OFFSET UNITYSDK_OFFSET(0x16AD8550)
#define RPG_GAMECORE_FIVEDIMSWITCHMATERIALACTION_METHOD_3_C508B12D60470FB3_OFFSET UNITYSDK_OFFSET(0x16AD8430)
#define RPG_GAMECORE_FIVEDIMSWITCHMATERIALACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16AD8530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSwitchMaterialAction_TypeDefinitionIndex = 16827;
