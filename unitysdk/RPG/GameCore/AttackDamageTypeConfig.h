...
#define RPG_GAMECORE_ATTACKDAMAGETYPECONFIG_METHOD_2_42A043373CD9509C_OFFSET UNITYSDK_OFFSET(0x18BE8C50)
#define RPG_GAMECORE_ATTACKDAMAGETYPECONFIG_METHOD_2_70AD061FE2E32537_OFFSET UNITYSDK_OFFSET(0x18BE8530)
#define RPG_GAMECORE_ATTACKDAMAGETYPECONFIG_METHOD_2_D72A8BA1AB8D977A_OFFSET UNITYSDK_OFFSET(0x18BE8EC0)
#define RPG_GAMECORE_ATTACKDAMAGETYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18BE8C40)
