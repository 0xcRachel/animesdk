...
#define RPG_GAMECORE_WOLFBROGUNENABLEBULLETTIME_METHOD_3_1A423A188092E256_OFFSET UNITYSDK_OFFSET(0x17163730)
#define RPG_GAMECORE_WOLFBROGUNENABLEBULLETTIME_METHOD_3_4ED3DB97D3C3A3CF_OFFSET UNITYSDK_OFFSET(0x171636B0)
#define RPG_GAMECORE_WOLFBROGUNENABLEBULLETTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x17163700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroGunEnableBulletTime_TypeDefinitionIndex = 19225;
