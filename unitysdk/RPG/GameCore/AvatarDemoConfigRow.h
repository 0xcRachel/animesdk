...
#define RPG_GAMECORE_AVATARDEMOCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17629A40)
#define RPG_GAMECORE_AVATARDEMOCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1762A620)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 RandomSeed; // 0x40
		::System::UInt32 RaidID; // 0x44
		::System::UInt32 GuideGroupID; // 0x48
		::System::UInt32 MapEntranceID; // 0x4C
		::System::UInt32 MazeGroupID1; // 0x50
		::System::UInt32 ScoringGroupID; // 0x54
		::RPG::GameCore::AvatarDemoStageType StageType; // 0x58
		::System::UInt32 RewardID; // 0x5C
		::RPG::Client::TextID AvatarDemoGuide; // 0x60
		::System::UInt32 AvatarID; // 0x70
		::System::UInt32 StageID; // 0x74
		::System::Boolean EnableSwitchAvatar; // 0x78
		::System::Boolean EnableMazeSkillEffect; // 0x79
		::System::Boolean NormalWaveNotShowDetail; // 0x7A
