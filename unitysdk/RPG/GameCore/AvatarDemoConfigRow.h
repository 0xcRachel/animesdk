...
#define RPG_GAMECORE_AVATARDEMOCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16FAC530)
#define RPG_GAMECORE_AVATARDEMOCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16FAD120)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID AvatarDemoTitle; // 0x40
		::System::UInt32 RewardID; // 0x50
		::System::UInt32 RaidID; // 0x54
		::RPG::Client::TextID AvatarDemoGuide; // 0x58
		::System::Boolean EnableMazeSkillEffect; // 0x68
		::System::Boolean NormalWaveNotShowDetail; // 0x69
		::System::Boolean EnableSwitchAvatar; // 0x6A
		::System::UInt32 RandomSeed; // 0x6C
		::System::UInt32 MapEntranceID; // 0x70
		::System::UInt32 MazeGroupID1; // 0x74
		::System::UInt32 AvatarID; // 0x78
		::System::UInt32 ScoringGroupID; // 0x7C
		::System::UInt32 StageID; // 0x80
		::RPG::GameCore::AvatarDemoStageType StageType; // 0x84
		::System::UInt32 GuideGroupID; // 0x88
