...
#define RPG_GAMECORE_ACTIVITYBANNERCOMPANYMISSIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16EB82D0)
#define RPG_GAMECORE_ACTIVITYBANNERCOMPANYMISSIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16EB8BF0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* MainImagePath; // 0x18
