...
#define RPG_GAMECORE_GMACCOUNTRELICCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16AEE250)
#define RPG_GAMECORE_GMACCOUNTRELICCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16AEE440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GMAccountRelicConfigRow_TypeDefinitionIndex = 12115;
