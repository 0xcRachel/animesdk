...
#define RPG_GAMECORE_STAGEHARMONYSIGNALDEMODULATORMONOSERIALIZATION_METHOD_2_01BAD194C541D1AE_OFFSET UNITYSDK_OFFSET(0x16F86D30)
#define RPG_GAMECORE_STAGEHARMONYSIGNALDEMODULATORMONOSERIALIZATION__CTOR_OFFSET UNITYSDK_OFFSET(0x16F86E50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StageHarmonySignalDemodulatorMonoSerialization_TypeDefinitionIndex = 17211;
