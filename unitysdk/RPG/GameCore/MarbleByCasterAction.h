...
#define RPG_GAMECORE_MARBLEBYCASTERACTION_METHOD_4_18DA571AC573BEA8_OFFSET UNITYSDK_OFFSET(0x16C38330)
#define RPG_GAMECORE_MARBLEBYCASTERACTION_METHOD_4_7A32226133655B22_OFFSET UNITYSDK_OFFSET(0x16C38410)
#define RPG_GAMECORE_MARBLEBYCASTERACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16C383C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleByCasterAction_TypeDefinitionIndex = 15192;
