...
#define RPG_GAMECORE_REMOVEBATTLEEVENTDATA_METHOD_3_194C2DE62E201E11_OFFSET UNITYSDK_OFFSET(0x16DDDE90)
#define RPG_GAMECORE_REMOVEBATTLEEVENTDATA_METHOD_3_7354645D84528921_OFFSET UNITYSDK_OFFSET(0x16DDDE00)
#define RPG_GAMECORE_REMOVEBATTLEEVENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16DDDE60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveBattleEventData_TypeDefinitionIndex = 19316;
