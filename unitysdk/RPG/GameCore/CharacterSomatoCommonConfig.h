...
#define RPG_GAMECORE_CHARACTERSOMATOCOMMONCONFIG_METHOD_2_D75A76959AFBB71D_OFFSET UNITYSDK_OFFSET(0x16975E10)
#define RPG_GAMECORE_CHARACTERSOMATOCOMMONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16975EE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterSomatoCommonConfig_TypeDefinitionIndex = 14907;
