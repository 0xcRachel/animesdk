...
#define RPG_GAMECORE_BATTLEBGMCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x168CFDC0)
#define RPG_GAMECORE_BATTLEBGMCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x168CFF10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleBGMConfigRow_TypeDefinitionIndex = 11639;
