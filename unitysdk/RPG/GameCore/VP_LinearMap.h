...
#define RPG_GAMECORE_VP_LINEARMAP_METHOD_3_A17455C7FF04B0CE_OFFSET UNITYSDK_OFFSET(0x1951DFB0)
#define RPG_GAMECORE_VP_LINEARMAP_METHOD_3_D574404E1FA8677D_OFFSET UNITYSDK_OFFSET(0x1951DFF0)
#define RPG_GAMECORE_VP_LINEARMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1951DFE0)
