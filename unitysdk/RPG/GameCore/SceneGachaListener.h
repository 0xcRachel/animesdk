...
#define RPG_GAMECORE_SCENEGACHALISTENER_METHOD_3_9873749414EE17E7_OFFSET UNITYSDK_OFFSET(0x16EFA790)
#define RPG_GAMECORE_SCENEGACHALISTENER_METHOD_3_CAA4EE924E1D9B09_OFFSET UNITYSDK_OFFSET(0x16EFA710)
#define RPG_GAMECORE_SCENEGACHALISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x16EFA760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SceneGachaListener_TypeDefinitionIndex = 18119;
