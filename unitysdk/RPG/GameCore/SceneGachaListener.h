...
#define RPG_GAMECORE_SCENEGACHALISTENER_METHOD_3_803A3D132E89AEEB_OFFSET UNITYSDK_OFFSET(0x1A1D79A0)
#define RPG_GAMECORE_SCENEGACHALISTENER_METHOD_3_C5FD2DCEB6EDD545_OFFSET UNITYSDK_OFFSET(0x1A1D7A20)
#define RPG_GAMECORE_SCENEGACHALISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1D79F0)
