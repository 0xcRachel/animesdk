...
#define RPG_GAMECORE_TAROTBOOKREVEALEDCHARACTERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17138D00)
#define RPG_GAMECORE_TAROTBOOKREVEALEDCHARACTERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17138F30)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID MainCatalogTitle; // 0x20
