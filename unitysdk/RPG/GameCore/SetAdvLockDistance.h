...
#define RPG_GAMECORE_SETADVLOCKDISTANCE_METHOD_3_A04465E31E945A13_OFFSET UNITYSDK_OFFSET(0x16F04C70)
#define RPG_GAMECORE_SETADVLOCKDISTANCE_METHOD_3_C37009FF65B60202_OFFSET UNITYSDK_OFFSET(0x16F04CF0)
#define RPG_GAMECORE_SETADVLOCKDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F04CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAdvLockDistance_TypeDefinitionIndex = 17921;
