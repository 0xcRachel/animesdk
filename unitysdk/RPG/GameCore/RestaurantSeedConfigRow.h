...
#define RPG_GAMECORE_RESTAURANTSEEDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A01BEC0)
#define RPG_GAMECORE_RESTAURANTSEEDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A01C280)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 ProductCount; // 0x28
