...
#define RPG_GAMECORE_RESTAURANTSEEDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16DF10E0)
#define RPG_GAMECORE_RESTAURANTSEEDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16DF14A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RestaurantSeedConfigRow_TypeDefinitionIndex = 10561;

	class RestaurantSeedConfigRow : public ::System::Object
	{
	public:
		::Il2CppArray<::Class_1_A88C3AAF0DD46F4C_2*>* SpecialProductList; // 0x10
		::System::String* BigCropsModelPath; // 0x18
		::System::String* CropsModelPath; // 0x20
		::System::UInt32 GrowTime; // 0x28
		::System::UInt32 ProductID; // 0x2C
		::System::UInt32 ProductCount; // 0x30
		::System::UInt32 SortID; // 0x34
		::System::UInt32 ItemID; // 0x38
		::RPG::Client::TextID Name; // 0x40
		::System::UInt32 Price; // 0x50
		::System::UInt32 SeedID; // 0x54
