...
#define RPG_GAMECORE_GRIDFIGHTFRONTSPECIALSPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B25D70)
#define RPG_GAMECORE_GRIDFIGHTFRONTSPECIALSPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B25F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightFrontSpecialSPConfigRow_TypeDefinitionIndex = 12311;
