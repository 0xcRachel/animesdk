...
#define RPG_GAMECORE_GRIDFIGHTFRONTSPECIALSPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19573070)
#define RPG_GAMECORE_GRIDFIGHTFRONTSPECIALSPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19573260)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 InitialSpecialSP; // 0x20
