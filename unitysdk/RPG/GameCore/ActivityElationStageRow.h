...
#define RPG_GAMECORE_ACTIVITYELATIONSTAGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16EBEB60)
#define RPG_GAMECORE_ACTIVITYELATIONSTAGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16EBF2A0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID LevelDes_In_Down; // 0x78
		::System::UInt32 EventID; // 0x88
		::System::UInt32 PerfectWave; // 0x8C
