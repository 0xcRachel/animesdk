...
#define RPG_GAMECORE_GRIDFIGHTACTIONADDNPCCONFIG_METHOD_6_986FC6FEDF25770F_OFFSET UNITYSDK_OFFSET(0x19561F20)
#define RPG_GAMECORE_GRIDFIGHTACTIONADDNPCCONFIG_METHOD_6_E6B9743F0A0E220C_OFFSET UNITYSDK_OFFSET(0x19562090)
#define RPG_GAMECORE_GRIDFIGHTACTIONADDNPCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19561FF0)
