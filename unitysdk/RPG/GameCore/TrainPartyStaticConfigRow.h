...
#define RPG_GAMECORE_TRAINPARTYSTATICCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17108950)
#define RPG_GAMECORE_TRAINPARTYSTATICCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17108BB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyStaticConfigRow_TypeDefinitionIndex = 13959;
	...
	public:
		...
		::RPG::GameCore::TrainPartyStaticType Type; // 0x20
