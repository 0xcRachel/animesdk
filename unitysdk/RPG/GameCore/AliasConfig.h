...
#define RPG_GAMECORE_ALIASCONFIG_METHOD_2_D1F05DE0A2C03A67_OFFSET UNITYSDK_OFFSET(0x18AC2AA0)
#define RPG_GAMECORE_ALIASCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18AC2BA0)
