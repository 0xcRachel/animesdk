...
#define RPG_GAMECORE_SHOWENVBUFFDIALOG_METHOD_3_14794C09B2AB4673_OFFSET UNITYSDK_OFFSET(0x1770DA80)
#define RPG_GAMECORE_SHOWENVBUFFDIALOG_METHOD_3_7997A23D7DE1D38A_OFFSET UNITYSDK_OFFSET(0x1770DB00)
#define RPG_GAMECORE_SHOWENVBUFFDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1770DAD0)
