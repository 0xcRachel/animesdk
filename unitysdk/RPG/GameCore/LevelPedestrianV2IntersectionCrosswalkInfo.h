...
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONCROSSWALKINFO_METHOD_3_4BED10CC6465C143_OFFSET UNITYSDK_OFFSET(0x1735BB90)
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONCROSSWALKINFO_METHOD_3_7C8D0223DCDFDCD5_OFFSET UNITYSDK_OFFSET(0x1735BBD0)
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONCROSSWALKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1735BBC0)
