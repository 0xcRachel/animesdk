...
#define RPG_GAMECORE_TARGETSORTBYFORMATION_METHOD_3_AAB2AC6C26436D04_OFFSET UNITYSDK_OFFSET(0x16FF2610)
#define RPG_GAMECORE_TARGETSORTBYFORMATION_METHOD_3_F9DA5BC4E261A0D0_OFFSET UNITYSDK_OFFSET(0x16FF0C10)
#define RPG_GAMECORE_TARGETSORTBYFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x16FF0BF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSortByFormation_TypeDefinitionIndex = 21697;
