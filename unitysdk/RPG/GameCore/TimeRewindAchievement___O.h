...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::TimeRewindObjectType>**)Il2CppClass::FromTypeDefinitionIndex(TimeRewindAchievement___O_TypeDefinitionIndex)->GetStaticField(0xD0C0);
		}
	};
}
