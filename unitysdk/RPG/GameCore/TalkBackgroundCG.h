...
#define RPG_GAMECORE_TALKBACKGROUNDCG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16FC8010)
#define RPG_GAMECORE_TALKBACKGROUNDCG__CTOR_OFFSET UNITYSDK_OFFSET(0x16FC8310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TalkBackgroundCG_TypeDefinitionIndex = 21871;
