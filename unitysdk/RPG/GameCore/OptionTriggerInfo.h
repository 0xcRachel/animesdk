...
#define RPG_GAMECORE_OPTIONTRIGGERINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16D0E270)
#define RPG_GAMECORE_OPTIONTRIGGERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16D0E440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OptionTriggerInfo_TypeDefinitionIndex = 19226;
