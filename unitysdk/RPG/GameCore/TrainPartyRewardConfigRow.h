...
#define RPG_GAMECORE_TRAINPARTYREWARDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17107930)
#define RPG_GAMECORE_TRAINPARTYREWARDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17107B30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyRewardConfigRow_TypeDefinitionIndex = 13967;
