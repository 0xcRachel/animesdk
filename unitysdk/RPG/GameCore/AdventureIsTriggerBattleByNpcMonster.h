...
#define RPG_GAMECORE_ADVENTUREISTRIGGERBATTLEBYNPCMONSTER_METHOD_4_73AC9E6E21F4A41B_OFFSET UNITYSDK_OFFSET(0x1685AF90)
#define RPG_GAMECORE_ADVENTUREISTRIGGERBATTLEBYNPCMONSTER_METHOD_4_EB80B1E91AF07061_OFFSET UNITYSDK_OFFSET(0x1685AEC0)
#define RPG_GAMECORE_ADVENTUREISTRIGGERBATTLEBYNPCMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1685AF40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureIsTriggerBattleByNpcMonster_TypeDefinitionIndex = 19305;
