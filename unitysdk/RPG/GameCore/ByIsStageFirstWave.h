...
#define RPG_GAMECORE_BYISSTAGEFIRSTWAVE_METHOD_4_3DFE2EDEA89E4F8C_OFFSET UNITYSDK_OFFSET(0x19DB12D0)
#define RPG_GAMECORE_BYISSTAGEFIRSTWAVE_METHOD_4_609E1AB46B18B65B_OFFSET UNITYSDK_OFFSET(0x19DB1190)
#define RPG_GAMECORE_BYISSTAGEFIRSTWAVE_METHOD_4_7A6B85AE021BAEA1_OFFSET UNITYSDK_OFFSET(0x19DB10C0)
#define RPG_GAMECORE_BYISSTAGEFIRSTWAVE_METHOD_4_BEC41FD3D2768064_OFFSET UNITYSDK_OFFSET(0x19DB1350)
#define RPG_GAMECORE_BYISSTAGEFIRSTWAVE__CTOR_OFFSET UNITYSDK_OFFSET(0x19DB1140)
