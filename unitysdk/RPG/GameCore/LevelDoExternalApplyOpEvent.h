...
#define RPG_GAMECORE_LEVELDOEXTERNALAPPLYOPEVENT_CLEAR_OFFSET UNITYSDK_OFFSET(0xA4A2770)
#define RPG_GAMECORE_LEVELDOEXTERNALAPPLYOPEVENT_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA4A2810)
#define RPG_GAMECORE_LEVELDOEXTERNALAPPLYOPEVENT_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA4A27C0)
#define RPG_GAMECORE_LEVELDOEXTERNALAPPLYOPEVENT_INIT_OFFSET UNITYSDK_OFFSET(0xA4A26F0)
#define RPG_GAMECORE_LEVELDOEXTERNALAPPLYOPEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xA4A2860)
#define RPG_GAMECORE_LEVELDOEXTERNALAPPLYOPEVENT___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0xA4A2870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelDoExternalApplyOpEvent_TypeDefinitionIndex = 44644;
