...
#define RPG_GAMECORE_MONOPOLYCREATEWORLD_METHOD_3_3A96485D0BCD8692_OFFSET UNITYSDK_OFFSET(0x1744BE50)
#define RPG_GAMECORE_MONOPOLYCREATEWORLD_METHOD_3_BB0AAAF0283EA64B_OFFSET UNITYSDK_OFFSET(0x1744BED0)
#define RPG_GAMECORE_MONOPOLYCREATEWORLD__CTOR_OFFSET UNITYSDK_OFFSET(0x1744BEA0)
