...
#define RPG_GAMECORE_CHESTGROUPPROPERTYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16981F80)
#define RPG_GAMECORE_CHESTGROUPPROPERTYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x169821F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChestGroupPropertyRow_TypeDefinitionIndex = 13112;
