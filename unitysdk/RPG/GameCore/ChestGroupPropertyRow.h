...
#define RPG_GAMECORE_CHESTGROUPPROPERTYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A504190)
#define RPG_GAMECORE_CHESTGROUPPROPERTYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5043D0)
