...
#define RPG_GAMECORE_CHESTGROUPPROPERTYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x196ABEB0)
#define RPG_GAMECORE_CHESTGROUPPROPERTYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x196AC0F0)
