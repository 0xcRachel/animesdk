...
#define RPG_GAMECORE_FIVEDIMDESTRUCTIBLEPROPCONFIG_METHOD_3_D596F24D78A575E6_OFFSET UNITYSDK_OFFSET(0x16AB98C0)
#define RPG_GAMECORE_FIVEDIMDESTRUCTIBLEPROPCONFIG_METHOD_3_DD7B845D8293EC84_OFFSET UNITYSDK_OFFSET(0x16AB9850)
#define RPG_GAMECORE_FIVEDIMDESTRUCTIBLEPROPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16AB98A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimDestructiblePropConfig_TypeDefinitionIndex = 16645;
