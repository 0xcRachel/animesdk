...
#define RPG_GAMECORE_BYCOMPAREROGUEDICEROTATEIMMEDIATELY_METHOD_4_9ECF044381B5A51D_OFFSET UNITYSDK_OFFSET(0x17029150)
#define RPG_GAMECORE_BYCOMPAREROGUEDICEROTATEIMMEDIATELY_METHOD_4_D1C6D581165370B7_OFFSET UNITYSDK_OFFSET(0x17029220)
#define RPG_GAMECORE_BYCOMPAREROGUEDICEROTATEIMMEDIATELY__CTOR_OFFSET UNITYSDK_OFFSET(0x170291D0)
