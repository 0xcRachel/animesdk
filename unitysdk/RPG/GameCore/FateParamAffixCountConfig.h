...
#define RPG_GAMECORE_FATEPARAMAFFIXCOUNTCONFIG_METHOD_6_926E8308865DD088_OFFSET UNITYSDK_OFFSET(0x194783C0)
#define RPG_GAMECORE_FATEPARAMAFFIXCOUNTCONFIG_METHOD_6_B9205244356EF82C_OFFSET UNITYSDK_OFFSET(0x19478580)
#define RPG_GAMECORE_FATEPARAMAFFIXCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x194784C0)
