...
#define RPG_GAMECORE_WAITSUBMISSION_METHOD_3_840B34AA3CD9D479_OFFSET UNITYSDK_OFFSET(0x1A6553C0)
#define RPG_GAMECORE_WAITSUBMISSION_METHOD_3_D76774227DF66EF0_OFFSET UNITYSDK_OFFSET(0x1A655340)
#define RPG_GAMECORE_WAITSUBMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A655390)
