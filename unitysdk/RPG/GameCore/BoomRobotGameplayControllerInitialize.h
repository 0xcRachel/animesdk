...
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYCONTROLLERINITIALIZE_METHOD_3_94A0B25051E74901_OFFSET UNITYSDK_OFFSET(0x187C1E70)
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYCONTROLLERINITIALIZE_METHOD_3_E2EAC38A6877A52F_OFFSET UNITYSDK_OFFSET(0x187C1EF0)
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYCONTROLLERINITIALIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x187C1EC0)
