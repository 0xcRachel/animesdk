...
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYCONTROLLERINITIALIZE_METHOD_3_94A0B25051E74901_OFFSET UNITYSDK_OFFSET(0x168F2780)
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYCONTROLLERINITIALIZE_METHOD_3_E2EAC38A6877A52F_OFFSET UNITYSDK_OFFSET(0x168F2800)
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYCONTROLLERINITIALIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x168F27D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BoomRobotGameplayControllerInitialize_TypeDefinitionIndex = 18962;
