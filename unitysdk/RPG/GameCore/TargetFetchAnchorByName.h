...
#define RPG_GAMECORE_TARGETFETCHANCHORBYNAME_METHOD_4_C59A4AFFDBEB1256_OFFSET UNITYSDK_OFFSET(0x16FD4360)
#define RPG_GAMECORE_TARGETFETCHANCHORBYNAME_METHOD_4_E6F4BCF8C8188721_OFFSET UNITYSDK_OFFSET(0x16FDBD70)
#define RPG_GAMECORE_TARGETFETCHANCHORBYNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD4310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAnchorByName_TypeDefinitionIndex = 21587;
