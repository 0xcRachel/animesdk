...
#define RPG_GAMECORE_TARGETFETCHANCHORBYNAME_METHOD_4_C59A4AFFDBEB1256_OFFSET UNITYSDK_OFFSET(0x177C7020)
#define RPG_GAMECORE_TARGETFETCHANCHORBYNAME_METHOD_4_E6F4BCF8C8188721_OFFSET UNITYSDK_OFFSET(0x177D16E0)
#define RPG_GAMECORE_TARGETFETCHANCHORBYNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x177C6FD0)
