...
#define RPG_GAMECORE_GRIDFIGHTROLEBACKRANKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19B85060)
#define RPG_GAMECORE_GRIDFIGHTROLEBACKRANKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19B85580)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::StringHash Trigger; // 0x70
