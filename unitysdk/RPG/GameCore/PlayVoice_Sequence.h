...
#define RPG_GAMECORE_PLAYVOICE_SEQUENCE_METHOD_3_1F1AEA60DFC07823_OFFSET UNITYSDK_OFFSET(0x174DCBF0)
#define RPG_GAMECORE_PLAYVOICE_SEQUENCE_METHOD_3_33D485DED46FCD94_OFFSET UNITYSDK_OFFSET(0x174DCC80)
#define RPG_GAMECORE_PLAYVOICE_SEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x174DCC50)
