...
#define RPG_GAMECORE_PLAYVOICE_SEQUENCE_METHOD_3_5FBBAB980BA3A22B_OFFSET UNITYSDK_OFFSET(0x19D5A100)
#define RPG_GAMECORE_PLAYVOICE_SEQUENCE_METHOD_3_B26883606CAD4A6A_OFFSET UNITYSDK_OFFSET(0x19D5A070)
#define RPG_GAMECORE_PLAYVOICE_SEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x19D5A0D0)
