...
#define RPG_GAMECORE_WAITLASTKILLFINISH_METHOD_3_2A15689696DD1B3D_OFFSET UNITYSDK_OFFSET(0x17910DF0)
#define RPG_GAMECORE_WAITLASTKILLFINISH_METHOD_3_B03D446BEE8A6E49_OFFSET UNITYSDK_OFFSET(0x17910CE0)
#define RPG_GAMECORE_WAITLASTKILLFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x17910DC0)
