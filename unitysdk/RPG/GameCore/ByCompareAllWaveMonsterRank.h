...
#define RPG_GAMECORE_BYCOMPAREALLWAVEMONSTERRANK_METHOD_4_1B3968ED24967866_OFFSET UNITYSDK_OFFSET(0x16905EC0)
#define RPG_GAMECORE_BYCOMPAREALLWAVEMONSTERRANK_METHOD_4_91F6A5F562F9BD92_OFFSET UNITYSDK_OFFSET(0x16905F90)
#define RPG_GAMECORE_BYCOMPAREALLWAVEMONSTERRANK__CTOR_OFFSET UNITYSDK_OFFSET(0x16905F40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareAllWaveMonsterRank_TypeDefinitionIndex = 20695;
