...
#define RPG_GAMECORE_SETLEVEL_METHOD_3_895507202C200CBE_OFFSET UNITYSDK_OFFSET(0x199B9B90)
#define RPG_GAMECORE_SETLEVEL_METHOD_3_E777FEB59BD32382_OFFSET UNITYSDK_OFFSET(0x199B9C60)
#define RPG_GAMECORE_SETLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x199B9C10)
