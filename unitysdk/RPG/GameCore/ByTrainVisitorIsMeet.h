...
#define RPG_GAMECORE_BYTRAINVISITORISMEET_METHOD_4_84CBAA5A2A140879_OFFSET UNITYSDK_OFFSET(0x17052B50)
#define RPG_GAMECORE_BYTRAINVISITORISMEET_METHOD_4_C159910D9C7847B2_OFFSET UNITYSDK_OFFSET(0x17052CF0)
#define RPG_GAMECORE_BYTRAINVISITORISMEET__CTOR_OFFSET UNITYSDK_OFFSET(0x17052C30)
