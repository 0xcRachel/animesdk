...
#define RPG_GAMECORE_SETADVACHIEVEMENT_METHOD_3_51AC3CD5979E84DB_OFFSET UNITYSDK_OFFSET(0x16F03FD0)
#define RPG_GAMECORE_SETADVACHIEVEMENT_METHOD_3_8F37A776CD80AB80_OFFSET UNITYSDK_OFFSET(0x16F04050)
#define RPG_GAMECORE_SETADVACHIEVEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F04020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAdvAchievement_TypeDefinitionIndex = 18352;
