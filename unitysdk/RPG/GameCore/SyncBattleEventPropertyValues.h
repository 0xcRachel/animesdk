...
#define RPG_GAMECORE_SYNCBATTLEEVENTPROPERTYVALUES_METHOD_3_46D25371642EB622_OFFSET UNITYSDK_OFFSET(0x1986C1F0)
#define RPG_GAMECORE_SYNCBATTLEEVENTPROPERTYVALUES_METHOD_3_C12CE956DFBAA54B_OFFSET UNITYSDK_OFFSET(0x1986C170)
#define RPG_GAMECORE_SYNCBATTLEEVENTPROPERTYVALUES__CTOR_OFFSET UNITYSDK_OFFSET(0x1986C1C0)
