...
#define RPG_GAMECORE_SWORDTRAININGCHECKIFGAMESTARTED_METHOD_3_1130DD05AC7E493E_OFFSET UNITYSDK_OFFSET(0x19864B00)
#define RPG_GAMECORE_SWORDTRAININGCHECKIFGAMESTARTED_METHOD_3_4B16ADCB006C5592_OFFSET UNITYSDK_OFFSET(0x19864B80)
#define RPG_GAMECORE_SWORDTRAININGCHECKIFGAMESTARTED__CTOR_OFFSET UNITYSDK_OFFSET(0x19864B50)
