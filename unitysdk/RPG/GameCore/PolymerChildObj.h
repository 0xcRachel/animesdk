...
#define RPG_GAMECORE_POLYMERCHILDOBJ_METHOD_3_218C3E658CA1BD77_OFFSET UNITYSDK_OFFSET(0x16D78DA0)
#define RPG_GAMECORE_POLYMERCHILDOBJ_METHOD_3_2C1FACA4F64BF1C1_OFFSET UNITYSDK_OFFSET(0x16D78D60)
#define RPG_GAMECORE_POLYMERCHILDOBJ__CTOR_OFFSET UNITYSDK_OFFSET(0x16D78D90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PolymerChildObj_TypeDefinitionIndex = 17109;
