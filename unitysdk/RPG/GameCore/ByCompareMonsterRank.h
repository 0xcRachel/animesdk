...
#define RPG_GAMECORE_BYCOMPAREMONSTERRANK_METHOD_4_BA509E69529046CA_OFFSET UNITYSDK_OFFSET(0x169130E0)
#define RPG_GAMECORE_BYCOMPAREMONSTERRANK_METHOD_4_C9091CDE88048324_OFFSET UNITYSDK_OFFSET(0x169131C0)
#define RPG_GAMECORE_BYCOMPAREMONSTERRANK__CTOR_OFFSET UNITYSDK_OFFSET(0x16913160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareMonsterRank_TypeDefinitionIndex = 20693;
