...
#define RPG_GAMECORE_FORMATIONZOFFSETLIST_METHOD_2_6621590A3DBA0595_OFFSET UNITYSDK_OFFSET(0x192003C0)
#define RPG_GAMECORE_FORMATIONZOFFSETLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x192004C0)
