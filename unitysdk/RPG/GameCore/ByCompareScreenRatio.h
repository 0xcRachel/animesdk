...
#define RPG_GAMECORE_BYCOMPARESCREENRATIO_METHOD_4_9BEF9B85DD88872B_OFFSET UNITYSDK_OFFSET(0x1702A980)
#define RPG_GAMECORE_BYCOMPARESCREENRATIO_METHOD_4_C71C2B3D6551204F_OFFSET UNITYSDK_OFFSET(0x1702A8A0)
#define RPG_GAMECORE_BYCOMPARESCREENRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x1702A920)
