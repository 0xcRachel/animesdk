...
#define RPG_GAMECORE_MOVETEAMROOTPOSBYTARGETDISTANCE_METHOD_3_3F35EEB83E42320D_OFFSET UNITYSDK_OFFSET(0x16CE5AA0)
#define RPG_GAMECORE_MOVETEAMROOTPOSBYTARGETDISTANCE_METHOD_3_79CE1D2F7C66B332_OFFSET UNITYSDK_OFFSET(0x16CE5A20)
#define RPG_GAMECORE_MOVETEAMROOTPOSBYTARGETDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x16CE5A70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MoveTeamRootPosByTargetDistance_TypeDefinitionIndex = 20268;
