...
#define RPG_GAMECORE_ANIMPARAMRANGEENTRY_METHOD_2_910B3835D294ADF5_OFFSET UNITYSDK_OFFSET(0x16888420)
#define RPG_GAMECORE_ANIMPARAMRANGEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x16888570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AnimParamRangeEntry_TypeDefinitionIndex = 14654;
