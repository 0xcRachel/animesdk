...
#define RPG_GAMECORE_ST_MAIN_PATROL_METHOD_4_0365E8762EB6E05B_OFFSET UNITYSDK_OFFSET(0x16EF7220)
#define RPG_GAMECORE_ST_MAIN_PATROL_METHOD_4_B5FE9918C03B7B73_OFFSET UNITYSDK_OFFSET(0x16EE4800)
#define RPG_GAMECORE_ST_MAIN_PATROL__CTOR_OFFSET UNITYSDK_OFFSET(0x16EE47A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_Patrol_TypeDefinitionIndex = 17866;
