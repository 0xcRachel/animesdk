...
#define RPG_GAMECORE_TARGETSELECTOR_METHOD_4_38016205646F6A8A_OFFSET UNITYSDK_OFFSET(0x177CDF90)
#define RPG_GAMECORE_TARGETSELECTOR_METHOD_4_EFC128BD1419043E_OFFSET UNITYSDK_OFFSET(0x177D9120)
#define RPG_GAMECORE_TARGETSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x177CDF40)
