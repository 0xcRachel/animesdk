...
#define RPG_GAMECORE_IDLELIVEEQUIPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18A89D40)
#define RPG_GAMECORE_IDLELIVEEQUIPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18A89F00)
