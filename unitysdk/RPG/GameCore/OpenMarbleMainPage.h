...
#define RPG_GAMECORE_OPENMARBLEMAINPAGE_METHOD_3_4545FD690CA16F0A_OFFSET UNITYSDK_OFFSET(0x16D0A070)
#define RPG_GAMECORE_OPENMARBLEMAINPAGE_METHOD_3_58ABAFBC8D103296_OFFSET UNITYSDK_OFFSET(0x16D0A0F0)
#define RPG_GAMECORE_OPENMARBLEMAINPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16D0A0C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OpenMarbleMainPage_TypeDefinitionIndex = 19049;
