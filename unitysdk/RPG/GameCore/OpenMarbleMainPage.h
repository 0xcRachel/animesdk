...
#define RPG_GAMECORE_OPENMARBLEMAINPAGE_METHOD_3_4545FD690CA16F0A_OFFSET UNITYSDK_OFFSET(0x18EEFAD0)
#define RPG_GAMECORE_OPENMARBLEMAINPAGE_METHOD_3_58ABAFBC8D103296_OFFSET UNITYSDK_OFFSET(0x18EEFB50)
#define RPG_GAMECORE_OPENMARBLEMAINPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18EEFB20)
