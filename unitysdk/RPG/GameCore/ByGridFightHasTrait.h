...
#define RPG_GAMECORE_BYGRIDFIGHTHASTRAIT_METHOD_4_35D60AA6B27A7C79_OFFSET UNITYSDK_OFFSET(0x19ADDC60)
#define RPG_GAMECORE_BYGRIDFIGHTHASTRAIT_METHOD_4_946F750F9C3A0BCF_OFFSET UNITYSDK_OFFSET(0x19ADDD40)
#define RPG_GAMECORE_BYGRIDFIGHTHASTRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x19ADDCE0)
