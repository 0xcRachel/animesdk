...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROGUEDIALOGUEAEONOPTIONCONFIG_METHOD_3_6D27B6F65AF83A50_OFFSET UNITYSDK_OFFSET(0x16E979F0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROGUEDIALOGUEAEONOPTIONCONFIG_METHOD_3_D72EC87F92E0ACF9_OFFSET UNITYSDK_OFFSET(0x16E9F4A0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROGUEDIALOGUEAEONOPTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E979A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnRogueDialogueAeonOptionConfig_TypeDefinitionIndex = 16125;
