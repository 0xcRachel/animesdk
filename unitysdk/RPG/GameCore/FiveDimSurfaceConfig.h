...
#define RPG_GAMECORE_FIVEDIMSURFACECONFIG_METHOD_3_47AD5215A6516E28_OFFSET UNITYSDK_OFFSET(0x1A3A8730)
#define RPG_GAMECORE_FIVEDIMSURFACECONFIG_METHOD_3_9FA2E9538F4D1AC9_OFFSET UNITYSDK_OFFSET(0x1A3A86C0)
#define RPG_GAMECORE_FIVEDIMSURFACECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3A8710)
