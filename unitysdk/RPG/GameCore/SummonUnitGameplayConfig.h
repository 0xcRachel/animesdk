...
#define RPG_GAMECORE_SUMMONUNITGAMEPLAYCONFIG_METHOD_2_524973B3A2395B86_OFFSET UNITYSDK_OFFSET(0x19858D90)
#define RPG_GAMECORE_SUMMONUNITGAMEPLAYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x198590D0)
