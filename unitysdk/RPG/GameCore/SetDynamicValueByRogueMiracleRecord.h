...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEMIRACLERECORD_METHOD_3_103BC976D4913737_OFFSET UNITYSDK_OFFSET(0x16F25EE0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEMIRACLERECORD_METHOD_3_BE0FAD54E1714510_OFFSET UNITYSDK_OFFSET(0x16F25F50)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEMIRACLERECORD__CTOR_OFFSET UNITYSDK_OFFSET(0x16F25F20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueMiracleRecord_TypeDefinitionIndex = 19419;
