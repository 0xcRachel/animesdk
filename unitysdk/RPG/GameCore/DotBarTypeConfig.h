...
#define RPG_GAMECORE_DOTBARTYPECONFIG_METHOD_2_4D13CE409907E3CF_OFFSET UNITYSDK_OFFSET(0x1A0A3E70)
#define RPG_GAMECORE_DOTBARTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0A3F80)
