...
#define RPG_GAMECORE_CAKERACEISLOCKINGTARGETPREDICATECONFIG_METHOD_3_4089FBFBD0EB76FD_OFFSET UNITYSDK_OFFSET(0x1694FE30)
#define RPG_GAMECORE_CAKERACEISLOCKINGTARGETPREDICATECONFIG_METHOD_3_ED3F8D49DF52D131_OFFSET UNITYSDK_OFFSET(0x1694FF40)
#define RPG_GAMECORE_CAKERACEISLOCKINGTARGETPREDICATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1694FF30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceIsLockingTargetPredicateConfig_TypeDefinitionIndex = 16504;
