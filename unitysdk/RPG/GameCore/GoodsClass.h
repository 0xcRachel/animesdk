...
#define RPG_GAMECORE_GOODSCLASS_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B12810)
#define RPG_GAMECORE_GOODSCLASS__CTOR_OFFSET UNITYSDK_OFFSET(0x16B12900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GoodsClass_TypeDefinitionIndex = 11446;
