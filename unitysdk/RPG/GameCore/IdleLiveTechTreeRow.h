...
#define RPG_GAMECORE_IDLELIVETECHTREEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19ADC8D0)
#define RPG_GAMECORE_IDLELIVETECHTREEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19ADCFC0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::ILBattleAvatarTag TechPowerTagLimit; // 0x30
		::RPG::GameCore::IdleLiveAvatarPropertyType PropertyType; // 0x34
		::RPG::GameCore::IdleLiveAvatarPropertyTargetType PropertyTarget; // 0x38
		::System::UInt32 Cost; // 0x3C
		::RPG::GameCore::FixPoint TechAddPower; // 0x40
		::System::UInt32 ID; // 0x48
		::System::Boolean IsMainPoint; // 0x4C
		::System::Boolean IsBase; // 0x4D
		::RPG::Client::TextID Desc; // 0x50
		::System::Double PropertyParam; // 0x60
		::RPG::Client::TextID Name; // 0x68
		::RPG::GameCore::FixPoint TechPowerFactor; // 0x78
		::RPG::GameCore::IdleLiveTechTreeEffectType Type; // 0x80
