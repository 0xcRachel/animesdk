...
#define RPG_GAMECORE_SHADERTESTPRELOADITEM_METHOD_2_FEF873999D24BE9D_OFFSET UNITYSDK_OFFSET(0x19FF3250)
#define RPG_GAMECORE_SHADERTESTPRELOADITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x19FF3340)
