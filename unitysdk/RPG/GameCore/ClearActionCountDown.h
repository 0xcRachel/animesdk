...
#define RPG_GAMECORE_CLEARACTIONCOUNTDOWN_METHOD_3_24B80B2593869A41_OFFSET UNITYSDK_OFFSET(0x170C5A90)
#define RPG_GAMECORE_CLEARACTIONCOUNTDOWN_METHOD_3_ED4FD0769637654D_OFFSET UNITYSDK_OFFSET(0x170C5980)
#define RPG_GAMECORE_CLEARACTIONCOUNTDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x170C5A60)
