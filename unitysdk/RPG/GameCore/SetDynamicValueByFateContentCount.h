...
#define RPG_GAMECORE_SETDYNAMICVALUEBYFATECONTENTCOUNT_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x16F23590)
#define RPG_GAMECORE_SETDYNAMICVALUEBYFATECONTENTCOUNT_METHOD_4_848A49664F383297_OFFSET UNITYSDK_OFFSET(0x16F23510)
#define RPG_GAMECORE_SETDYNAMICVALUEBYFATECONTENTCOUNT_METHOD_4_9AC6292222A1BFBF_OFFSET UNITYSDK_OFFSET(0x16F19F60)
#define RPG_GAMECORE_SETDYNAMICVALUEBYFATECONTENTCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F19F10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByFateContentCount_TypeDefinitionIndex = 20970;
