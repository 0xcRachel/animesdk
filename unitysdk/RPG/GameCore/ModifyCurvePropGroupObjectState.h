...
#define RPG_GAMECORE_MODIFYCURVEPROPGROUPOBJECTSTATE_METHOD_3_7316629718E9B424_OFFSET UNITYSDK_OFFSET(0x1907CB90)
#define RPG_GAMECORE_MODIFYCURVEPROPGROUPOBJECTSTATE_METHOD_3_78CF5A1320174147_OFFSET UNITYSDK_OFFSET(0x1907CC10)
#define RPG_GAMECORE_MODIFYCURVEPROPGROUPOBJECTSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1907CBE0)
