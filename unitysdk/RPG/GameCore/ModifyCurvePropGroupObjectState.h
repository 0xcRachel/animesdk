...
#define RPG_GAMECORE_MODIFYCURVEPROPGROUPOBJECTSTATE_METHOD_3_7316629718E9B424_OFFSET UNITYSDK_OFFSET(0x16CB9200)
#define RPG_GAMECORE_MODIFYCURVEPROPGROUPOBJECTSTATE_METHOD_3_78CF5A1320174147_OFFSET UNITYSDK_OFFSET(0x16CB9280)
#define RPG_GAMECORE_MODIFYCURVEPROPGROUPOBJECTSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16CB9250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyCurvePropGroupObjectState_TypeDefinitionIndex = 19911;
