...
#define RPG_GAMECORE_FLOATINGSPIRITBLOCK_METHOD_2_896FD22F6545C277_OFFSET UNITYSDK_OFFSET(0x1A3AD640)
#define RPG_GAMECORE_FLOATINGSPIRITBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3AD740)
