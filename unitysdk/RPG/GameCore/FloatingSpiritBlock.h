...
#define RPG_GAMECORE_FLOATINGSPIRITBLOCK_METHOD_2_76F73BA0F24720AC_OFFSET UNITYSDK_OFFSET(0x172281B0)
#define RPG_GAMECORE_FLOATINGSPIRITBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x172282D0)
