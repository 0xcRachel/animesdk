...
#define RPG_GAMECORE_FIVEDIMACHIEVEMENTCONFIG_METHOD_2_D90A883AA977B17E_OFFSET UNITYSDK_OFFSET(0x16AA9FC0)
#define RPG_GAMECORE_FIVEDIMACHIEVEMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16AAA1E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimAchievementConfig_TypeDefinitionIndex = 15021;
