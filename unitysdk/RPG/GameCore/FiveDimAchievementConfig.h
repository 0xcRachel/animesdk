...
#define RPG_GAMECORE_FIVEDIMACHIEVEMENTCONFIG_METHOD_2_8737E4B41739B309_OFFSET UNITYSDK_OFFSET(0x18D1F8E0)
#define RPG_GAMECORE_FIVEDIMACHIEVEMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D1FB40)
