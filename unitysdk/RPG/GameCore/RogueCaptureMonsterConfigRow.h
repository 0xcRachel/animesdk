...
#define RPG_GAMECORE_ROGUECAPTUREMONSTERCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19245500)
#define RPG_GAMECORE_ROGUECAPTUREMONSTERCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19245BB0)
