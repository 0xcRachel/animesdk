...
#define RPG_GAMECORE_ROGUECAPTUREMONSTERCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16E1FE70)
#define RPG_GAMECORE_ROGUECAPTUREMONSTERCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16E20520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueCaptureMonsterConfigRow_TypeDefinitionIndex = 13321;
