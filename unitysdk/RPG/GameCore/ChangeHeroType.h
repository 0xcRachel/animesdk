...
#define RPG_GAMECORE_CHANGEHEROTYPE_METHOD_3_CAFA0220AFB5DD7F_OFFSET UNITYSDK_OFFSET(0x170778E0)
#define RPG_GAMECORE_CHANGEHEROTYPE_METHOD_3_E7599A312C4D46CF_OFFSET UNITYSDK_OFFSET(0x17077970)
#define RPG_GAMECORE_CHANGEHEROTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x17077940)
