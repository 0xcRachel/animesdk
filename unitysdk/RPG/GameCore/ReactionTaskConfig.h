...
#define RPG_GAMECORE_REACTIONTASKCONFIG_METHOD_3_B6305489B169F566_OFFSET UNITYSDK_OFFSET(0x16DCAF60)
#define RPG_GAMECORE_REACTIONTASKCONFIG_METHOD_3_C525E618F88C7463_OFFSET UNITYSDK_OFFSET(0x16DCB1F0)
#define RPG_GAMECORE_REACTIONTASKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16DCB2B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ReactionTaskConfig_TypeDefinitionIndex = 17798;
