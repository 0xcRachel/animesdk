...
#define RPG_GAMECORE_SETDAWNSEYEWEATHERUI_METHOD_3_0744C6A968A6CF90_OFFSET UNITYSDK_OFFSET(0x176C5FA0)
#define RPG_GAMECORE_SETDAWNSEYEWEATHERUI_METHOD_3_0E824203D360CF49_OFFSET UNITYSDK_OFFSET(0x176C5F20)
#define RPG_GAMECORE_SETDAWNSEYEWEATHERUI__CTOR_OFFSET UNITYSDK_OFFSET(0x176C5F70)
