...
#define RPG_GAMECORE_BYTARGETHITBOXACTIVE_METHOD_4_74B5D4CD2F4CA65A_OFFSET UNITYSDK_OFFSET(0x17050430)
#define RPG_GAMECORE_BYTARGETHITBOXACTIVE_METHOD_4_D941DADAEAFDB1A4_OFFSET UNITYSDK_OFFSET(0x17050500)
#define RPG_GAMECORE_BYTARGETHITBOXACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x170504B0)
