...
#define RPG_GAMECORE_SETAUDIENCEGROUPVISIBLE_METHOD_3_27ADC2AFAD5AEF8D_OFFSET UNITYSDK_OFFSET(0x16F06980)
#define RPG_GAMECORE_SETAUDIENCEGROUPVISIBLE_METHOD_3_532EBAF907C00B2C_OFFSET UNITYSDK_OFFSET(0x16F06900)
#define RPG_GAMECORE_SETAUDIENCEGROUPVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F06950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAudienceGroupVisible_TypeDefinitionIndex = 19522;
