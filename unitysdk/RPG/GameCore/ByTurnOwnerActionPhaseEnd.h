...
#define RPG_GAMECORE_BYTURNOWNERACTIONPHASEEND_METHOD_4_9A3FC2E59406BF62_OFFSET UNITYSDK_OFFSET(0x16941620)
#define RPG_GAMECORE_BYTURNOWNERACTIONPHASEEND_METHOD_4_B97FC72BF527FB78_OFFSET UNITYSDK_OFFSET(0x169416F0)
#define RPG_GAMECORE_BYTURNOWNERACTIONPHASEEND__CTOR_OFFSET UNITYSDK_OFFSET(0x169416A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByTurnOwnerActionPhaseEnd_TypeDefinitionIndex = 21155;
