...
#define RPG_GAMECORE_LOOPWAITSERVERFLOORSAVEDVALUECHANGE_METHOD_3_CB559999FB3D3832_OFFSET UNITYSDK_OFFSET(0x18FCF630)
#define RPG_GAMECORE_LOOPWAITSERVERFLOORSAVEDVALUECHANGE_METHOD_3_F602185761CD823D_OFFSET UNITYSDK_OFFSET(0x18FCF6A0)
#define RPG_GAMECORE_LOOPWAITSERVERFLOORSAVEDVALUECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18FCF670)
