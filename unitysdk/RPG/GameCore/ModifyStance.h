...
#define RPG_GAMECORE_MODIFYSTANCE_METHOD_3_B55F62BFAB8B47DB_OFFSET UNITYSDK_OFFSET(0x196B1080)
#define RPG_GAMECORE_MODIFYSTANCE_METHOD_3_DDF4F8DED306C15E_OFFSET UNITYSDK_OFFSET(0x196B1120)
#define RPG_GAMECORE_MODIFYSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x196B10E0)
