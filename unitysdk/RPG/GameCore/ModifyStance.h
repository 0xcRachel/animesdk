...
#define RPG_GAMECORE_MODIFYSTANCE_METHOD_3_B55F62BFAB8B47DB_OFFSET UNITYSDK_OFFSET(0x19086110)
#define RPG_GAMECORE_MODIFYSTANCE_METHOD_3_DDF4F8DED306C15E_OFFSET UNITYSDK_OFFSET(0x190861B0)
#define RPG_GAMECORE_MODIFYSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x19086170)
