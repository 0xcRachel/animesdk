...
#define RPG_GAMECORE_ADVPLAYERREMOVEATTACHMENT_METHOD_3_0C29FF75D3E0CFB2_OFFSET UNITYSDK_OFFSET(0x16842D90)
#define RPG_GAMECORE_ADVPLAYERREMOVEATTACHMENT_METHOD_3_AF6814BA5128241B_OFFSET UNITYSDK_OFFSET(0x16842E10)
#define RPG_GAMECORE_ADVPLAYERREMOVEATTACHMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x16842DE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvPlayerRemoveAttachment_TypeDefinitionIndex = 18857;
