...
#define RPG_GAMECORE_ADVPLAYERREMOVEATTACHMENT_METHOD_3_0C29FF75D3E0CFB2_OFFSET UNITYSDK_OFFSET(0x19BEDE80)
#define RPG_GAMECORE_ADVPLAYERREMOVEATTACHMENT_METHOD_3_AF6814BA5128241B_OFFSET UNITYSDK_OFFSET(0x19BEDF00)
#define RPG_GAMECORE_ADVPLAYERREMOVEATTACHMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19BEDED0)
