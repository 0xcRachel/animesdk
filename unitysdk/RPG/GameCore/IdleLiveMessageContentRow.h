...
#define RPG_GAMECORE_IDLELIVEMESSAGECONTENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19AD80A0)
#define RPG_GAMECORE_IDLELIVEMESSAGECONTENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD8300)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::IdleLiveMessageContentType ContentType; // 0x28
