...
#define RPG_GAMECORE_FIVEDIMEVENTRECEIVERCONFIG_METHOD_3_563623CBB152C1FB_OFFSET UNITYSDK_OFFSET(0x199ECCC0)
#define RPG_GAMECORE_FIVEDIMEVENTRECEIVERCONFIG_METHOD_3_A8668E666C88E992_OFFSET UNITYSDK_OFFSET(0x199ECC20)
#define RPG_GAMECORE_FIVEDIMEVENTRECEIVERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x199ECC80)
