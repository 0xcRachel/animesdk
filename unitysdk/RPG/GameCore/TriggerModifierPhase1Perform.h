...
#define RPG_GAMECORE_TRIGGERMODIFIERPHASE1PERFORM_METHOD_3_C93145C385367C07_OFFSET UNITYSDK_OFFSET(0x1911B3F0)
#define RPG_GAMECORE_TRIGGERMODIFIERPHASE1PERFORM_METHOD_3_D988AEED1409A973_OFFSET UNITYSDK_OFFSET(0x1911B2E0)
#define RPG_GAMECORE_TRIGGERMODIFIERPHASE1PERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1911B3C0)
