...
#define RPG_GAMECORE_BYHASEXTRAAVATARBASETYPE_METHOD_4_0402A01A5990E0C9_OFFSET UNITYSDK_OFFSET(0x16926B50)
#define RPG_GAMECORE_BYHASEXTRAAVATARBASETYPE_METHOD_4_5E51C6DCB9658FBF_OFFSET UNITYSDK_OFFSET(0x16926A80)
#define RPG_GAMECORE_BYHASEXTRAAVATARBASETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x16926B00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHasExtraAvatarBaseType_TypeDefinitionIndex = 20201;
