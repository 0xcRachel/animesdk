...
#define RPG_GAMECORE_TRAVELSHIPHIDEDOCKMAPICON_METHOD_3_A7A3C3CE06C04423_OFFSET UNITYSDK_OFFSET(0x19107670)
#define RPG_GAMECORE_TRAVELSHIPHIDEDOCKMAPICON_METHOD_3_DA32565E933C2E5F_OFFSET UNITYSDK_OFFSET(0x191077C0)
#define RPG_GAMECORE_TRAVELSHIPHIDEDOCKMAPICON__CTOR_OFFSET UNITYSDK_OFFSET(0x19107730)
