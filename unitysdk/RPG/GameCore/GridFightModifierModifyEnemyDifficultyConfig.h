...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERMODIFYENEMYDIFFICULTYCONFIG_METHOD_3_806AEC8F15FC2A83_OFFSET UNITYSDK_OFFSET(0x16B2F6C0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERMODIFYENEMYDIFFICULTYCONFIG_METHOD_3_8B1D66E967632ECA_OFFSET UNITYSDK_OFFSET(0x16B33640)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERMODIFYENEMYDIFFICULTYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16B2F670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierModifyEnemyDifficultyConfig_TypeDefinitionIndex = 17416;
