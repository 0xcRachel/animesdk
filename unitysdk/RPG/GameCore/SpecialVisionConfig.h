...
#define RPG_GAMECORE_SPECIALVISIONCONFIG_METHOD_2_623ECE89A0E2435B_OFFSET UNITYSDK_OFFSET(0x186002D0)
#define RPG_GAMECORE_SPECIALVISIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18600640)
