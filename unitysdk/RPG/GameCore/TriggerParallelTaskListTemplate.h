...
#define RPG_GAMECORE_TRIGGERPARALLELTASKLISTTEMPLATE_METHOD_3_2EABDAB0E1913D1A_OFFSET UNITYSDK_OFFSET(0x171243A0)
#define RPG_GAMECORE_TRIGGERPARALLELTASKLISTTEMPLATE_METHOD_3_4C479BC0E1858B08_OFFSET UNITYSDK_OFFSET(0x17124420)
#define RPG_GAMECORE_TRIGGERPARALLELTASKLISTTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x171243F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerParallelTaskListTemplate_TypeDefinitionIndex = 20989;
	...
	public:
		...
		static ::System::Void Method_3_4C479BC0E1858B08(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::TriggerParallelTaskListTemplate* a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::TriggerParallelTaskListTemplate*))((::PBYTE)hIl2Cpp + RPG_GAMECORE_TRIGGERPARALLELTASKLISTTEMPLATE_METHOD_3_4C479BC0E1858B08_OFFSET))(a1, a2);
		}
	};
}
