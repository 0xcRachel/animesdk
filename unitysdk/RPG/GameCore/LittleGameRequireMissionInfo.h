...
#define RPG_GAMECORE_LITTLEGAMEREQUIREMISSIONINFO_METHOD_2_73267DE8F06E4DD5_OFFSET UNITYSDK_OFFSET(0x16BD1240)
#define RPG_GAMECORE_LITTLEGAMEREQUIREMISSIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16BD1300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameRequireMissionInfo_TypeDefinitionIndex = 15644;
