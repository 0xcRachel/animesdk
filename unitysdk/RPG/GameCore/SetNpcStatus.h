...
#define RPG_GAMECORE_SETNPCSTATUS_METHOD_3_1E64331B1103CD6D_OFFSET UNITYSDK_OFFSET(0x199C1120)
#define RPG_GAMECORE_SETNPCSTATUS_METHOD_3_48E9B685014A6A8D_OFFSET UNITYSDK_OFFSET(0x199C1270)
#define RPG_GAMECORE_SETNPCSTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x199C11E0)
