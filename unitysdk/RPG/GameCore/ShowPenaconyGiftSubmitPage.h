...
#define RPG_GAMECORE_SHOWPENACONYGIFTSUBMITPAGE_METHOD_3_4D855E2DBC2FC379_OFFSET UNITYSDK_OFFSET(0x16F5FB30)
#define RPG_GAMECORE_SHOWPENACONYGIFTSUBMITPAGE_METHOD_3_A0E19DA5FD4C5DF0_OFFSET UNITYSDK_OFFSET(0x16F5FAB0)
#define RPG_GAMECORE_SHOWPENACONYGIFTSUBMITPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F5FB00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowPenaconyGiftSubmitPage_TypeDefinitionIndex = 19023;
