...
#define RPG_GAMECORE_CHANGECHARACTERCONFIGPARAM_METHOD_3_350AD3A2F462FDE6_OFFSET UNITYSDK_OFFSET(0x169634A0)
#define RPG_GAMECORE_CHANGECHARACTERCONFIGPARAM_METHOD_3_8C2BA787E6095AED_OFFSET UNITYSDK_OFFSET(0x169637C0)
#define RPG_GAMECORE_CHANGECHARACTERCONFIGPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x16963720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeCharacterConfigParam_TypeDefinitionIndex = 21369;
