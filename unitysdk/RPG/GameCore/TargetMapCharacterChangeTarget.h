...
#define RPG_GAMECORE_TARGETMAPCHARACTERCHANGETARGET_METHOD_3_4F8DBCA2B7A32F72_OFFSET UNITYSDK_OFFSET(0x16FE1E00)
#define RPG_GAMECORE_TARGETMAPCHARACTERCHANGETARGET_METHOD_3_70DB6BB9CD96D0FE_OFFSET UNITYSDK_OFFSET(0x16FE1F30)
#define RPG_GAMECORE_TARGETMAPCHARACTERCHANGETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE1F10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapCharacterChangeTarget_TypeDefinitionIndex = 21692;
