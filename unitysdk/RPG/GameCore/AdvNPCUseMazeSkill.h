...
#define RPG_GAMECORE_ADVNPCUSEMAZESKILL_METHOD_3_50849937266838AC_OFFSET UNITYSDK_OFFSET(0x18C4FEC0)
#define RPG_GAMECORE_ADVNPCUSEMAZESKILL_METHOD_3_BEC542455A55012F_OFFSET UNITYSDK_OFFSET(0x18C4FF50)
#define RPG_GAMECORE_ADVNPCUSEMAZESKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x18C4FF20)
