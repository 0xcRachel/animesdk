...
#define RPG_GAMECORE_WOLFBROGUNFIRE_METHOD_3_8FE6202D3AE7ECEB_OFFSET UNITYSDK_OFFSET(0x17163930)
#define RPG_GAMECORE_WOLFBROGUNFIRE_METHOD_3_943E6E1DA73103DF_OFFSET UNITYSDK_OFFSET(0x171638B0)
#define RPG_GAMECORE_WOLFBROGUNFIRE__CTOR_OFFSET UNITYSDK_OFFSET(0x17163900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroGunFire_TypeDefinitionIndex = 17938;
