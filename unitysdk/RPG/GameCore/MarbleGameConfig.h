...
#define RPG_GAMECORE_MARBLEGAMECONFIG_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x16C3D840)
#define RPG_GAMECORE_MARBLEGAMECONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16C3D800)
#define RPG_GAMECORE_MARBLEGAMECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16C3D830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleGameConfig_TypeDefinitionIndex = 16956;
