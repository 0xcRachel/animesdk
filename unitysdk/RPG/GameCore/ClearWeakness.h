...
#define RPG_GAMECORE_CLEARWEAKNESS_METHOD_3_137B14CF766028DF_OFFSET UNITYSDK_OFFSET(0x170C8120)
#define RPG_GAMECORE_CLEARWEAKNESS_METHOD_3_19CFF11432B9D1EC_OFFSET UNITYSDK_OFFSET(0x170C81A0)
#define RPG_GAMECORE_CLEARWEAKNESS__CTOR_OFFSET UNITYSDK_OFFSET(0x170C8170)
