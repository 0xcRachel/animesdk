...
#define RPG_GAMECORE_CLEARWEAKNESS_METHOD_3_137B14CF766028DF_OFFSET UNITYSDK_OFFSET(0x169A5FA0)
#define RPG_GAMECORE_CLEARWEAKNESS_METHOD_3_19CFF11432B9D1EC_OFFSET UNITYSDK_OFFSET(0x169A6020)
#define RPG_GAMECORE_CLEARWEAKNESS__CTOR_OFFSET UNITYSDK_OFFSET(0x169A5FF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearWeakness_TypeDefinitionIndex = 20740;
