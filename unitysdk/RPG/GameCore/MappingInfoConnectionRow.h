...
#define RPG_GAMECORE_MAPPINGINFOCONNECTIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19C2CE80)
#define RPG_GAMECORE_MAPPINGINFOCONNECTIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19C2D530)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 SourceMappingInfoID; // 0x18
