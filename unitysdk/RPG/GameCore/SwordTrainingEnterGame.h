...
#define RPG_GAMECORE_SWORDTRAININGENTERGAME_METHOD_3_B703B7DE70656140_OFFSET UNITYSDK_OFFSET(0x177B0F10)
#define RPG_GAMECORE_SWORDTRAININGENTERGAME_METHOD_3_DD91AAEA9E0B3B49_OFFSET UNITYSDK_OFFSET(0x177B0F90)
#define RPG_GAMECORE_SWORDTRAININGENTERGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x177B0F60)
