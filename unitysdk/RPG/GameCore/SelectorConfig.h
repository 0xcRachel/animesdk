...
#define RPG_GAMECORE_SELECTORCONFIG_METHOD_4_856104C95804CF38_OFFSET UNITYSDK_OFFSET(0x16EFE390)
#define RPG_GAMECORE_SELECTORCONFIG_METHOD_4_CBCB80CA4B218B91_OFFSET UNITYSDK_OFFSET(0x16EFE310)
#define RPG_GAMECORE_SELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16EFE360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SelectorConfig_TypeDefinitionIndex = 21497;
