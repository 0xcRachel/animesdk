...
#define RPG_GAMECORE_SETWAYPOINTIGNORELOCK_METHOD_3_1CBA36527B0FDC60_OFFSET UNITYSDK_OFFSET(0x176FB3B0)
#define RPG_GAMECORE_SETWAYPOINTIGNORELOCK_METHOD_3_F9E3119BED095319_OFFSET UNITYSDK_OFFSET(0x176FB330)
#define RPG_GAMECORE_SETWAYPOINTIGNORELOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x176FB380)
