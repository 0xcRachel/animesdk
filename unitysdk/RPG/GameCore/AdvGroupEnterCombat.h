...
#define RPG_GAMECORE_ADVGROUPENTERCOMBAT_METHOD_3_B77887AE21F691A2_OFFSET UNITYSDK_OFFSET(0x16837E50)
#define RPG_GAMECORE_ADVGROUPENTERCOMBAT_METHOD_3_C590CCD336BA8855_OFFSET UNITYSDK_OFFSET(0x16837DD0)
#define RPG_GAMECORE_ADVGROUPENTERCOMBAT__CTOR_OFFSET UNITYSDK_OFFSET(0x16837E20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvGroupEnterCombat_TypeDefinitionIndex = 18348;
