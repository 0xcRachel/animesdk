...
#define RPG_GAMECORE_ADVGROUPENTERCOMBAT_METHOD_3_B77887AE21F691A2_OFFSET UNITYSDK_OFFSET(0x19BE2D10)
#define RPG_GAMECORE_ADVGROUPENTERCOMBAT_METHOD_3_C590CCD336BA8855_OFFSET UNITYSDK_OFFSET(0x19BE2C90)
#define RPG_GAMECORE_ADVGROUPENTERCOMBAT__CTOR_OFFSET UNITYSDK_OFFSET(0x19BE2CE0)
