...
#define RPG_GAMECORE_ST_CHESS_BYINALERTRANGE_METHOD_4_9B619CD56B52898C_OFFSET UNITYSDK_OFFSET(0x16EF2030)
#define RPG_GAMECORE_ST_CHESS_BYINALERTRANGE_METHOD_4_9B70E089A1214D42_OFFSET UNITYSDK_OFFSET(0x16EF1F60)
#define RPG_GAMECORE_ST_CHESS_BYINALERTRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16EF1FE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Chess_ByInAlertRange_TypeDefinitionIndex = 21444;
