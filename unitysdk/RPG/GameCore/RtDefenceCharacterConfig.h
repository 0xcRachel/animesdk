...
#define RPG_GAMECORE_RTDEFENCECHARACTERCONFIG_METHOD_3_BA54F12459647E2A_OFFSET UNITYSDK_OFFSET(0x1941FFA0)
#define RPG_GAMECORE_RTDEFENCECHARACTERCONFIG_METHOD_3_ED848673FF77E4A1_OFFSET UNITYSDK_OFFSET(0x194230C0)
#define RPG_GAMECORE_RTDEFENCECHARACTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1941FF20)
