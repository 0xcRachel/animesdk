...
#define RPG_GAMECORE_BYCOMPARELASTKILLSKILL_METHOD_4_DF54E6B9675723C5_OFFSET UNITYSDK_OFFSET(0x17021840)
#define RPG_GAMECORE_BYCOMPARELASTKILLSKILL_METHOD_4_ED79BF2CDBC5A39B_OFFSET UNITYSDK_OFFSET(0x17021910)
#define RPG_GAMECORE_BYCOMPARELASTKILLSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x170218C0)
