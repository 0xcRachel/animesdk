...
#define RPG_GAMECORE_ADVENTITYFACETO_METHOD_3_204FF613057FA30A_OFFSET UNITYSDK_OFFSET(0x16833C50)
#define RPG_GAMECORE_ADVENTITYFACETO_METHOD_3_FD7CC3790F63D229_OFFSET UNITYSDK_OFFSET(0x16833D10)
#define RPG_GAMECORE_ADVENTITYFACETO__CTOR_OFFSET UNITYSDK_OFFSET(0x16833CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvEntityFaceTo_TypeDefinitionIndex = 18331;
