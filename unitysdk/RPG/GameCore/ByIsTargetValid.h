...
#define RPG_GAMECORE_BYISTARGETVALID_METHOD_4_2635CD2D74F81B0C_OFFSET UNITYSDK_OFFSET(0x16936E60)
#define RPG_GAMECORE_BYISTARGETVALID_METHOD_4_69E3722AB084A21C_OFFSET UNITYSDK_OFFSET(0x16936F30)
#define RPG_GAMECORE_BYISTARGETVALID__CTOR_OFFSET UNITYSDK_OFFSET(0x16936EE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsTargetValid_TypeDefinitionIndex = 21517;
