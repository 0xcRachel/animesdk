...
#define RPG_GAMECORE_SWORDTRAININGMOODROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18D930D0)
#define RPG_GAMECORE_SWORDTRAININGMOODROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18D93440)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 MoodLevel; // 0x30
		::System::UInt32 MinimumValue; // 0x34
		::RPG::GameCore::SwordTrainingMoodState MoodStatus; // 0x38
