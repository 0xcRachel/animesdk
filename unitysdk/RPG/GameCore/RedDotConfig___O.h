...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::RedDotGroupType>**)Il2CppClass::FromTypeDefinitionIndex(RedDotConfig___O_TypeDefinitionIndex)->GetStaticField(0x28960);
		}
	};
}
