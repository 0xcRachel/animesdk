...
#define RPG_GAMECORE_CREATEBATTLEEVENTENTITYFROMSTAGE_METHOD_4_2415148AB41B1D18_OFFSET UNITYSDK_OFFSET(0x169D2310)
#define RPG_GAMECORE_CREATEBATTLEEVENTENTITYFROMSTAGE_METHOD_4_457DA418B6F4F3A4_OFFSET UNITYSDK_OFFSET(0x169D2EA0)
#define RPG_GAMECORE_CREATEBATTLEEVENTENTITYFROMSTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x169D22E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateBattleEventEntityFromStage_TypeDefinitionIndex = 21094;
