...
#define RPG_GAMECORE_CHESSMODIFIERCONFIG_METHOD_3_045BD88E09A05831_OFFSET UNITYSDK_OFFSET(0x1697EE50)
#define RPG_GAMECORE_CHESSMODIFIERCONFIG_METHOD_3_36116D87D4418C57_OFFSET UNITYSDK_OFFSET(0x1697F4B0)
#define RPG_GAMECORE_CHESSMODIFIERCONFIG_METHOD_3_3DD898CD2622B7BA_OFFSET UNITYSDK_OFFSET(0x1697F600)
#define RPG_GAMECORE_CHESSMODIFIERCONFIG_METHOD_3_4ECCD020C8C3D79C_OFFSET UNITYSDK_OFFSET(0x1697F3B0)
#define RPG_GAMECORE_CHESSMODIFIERCONFIG_METHOD_3_7A78596E00A8053D_OFFSET UNITYSDK_OFFSET(0x1697F550)
#define RPG_GAMECORE_CHESSMODIFIERCONFIG_METHOD_3_BD63F9E21B3BA588_OFFSET UNITYSDK_OFFSET(0x1697EEE0)
#define RPG_GAMECORE_CHESSMODIFIERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1697EEC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChessModifierConfig_TypeDefinitionIndex = 15912;
	...
	public:
		...
		::System::Boolean Method_3_4ECCD020C8C3D79C(::RPG::GameCore::ChessModifierBehaviorFlag a1)
		{
			return ((::System::Boolean(*)(::PVOID, ::RPG::GameCore::ChessModifierBehaviorFlag))((::PBYTE)hIl2Cpp + RPG_GAMECORE_CHESSMODIFIERCONFIG_METHOD_3_4ECCD020C8C3D79C_OFFSET))(this, a1);
		}
