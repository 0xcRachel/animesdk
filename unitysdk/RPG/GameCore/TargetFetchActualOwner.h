...
#define RPG_GAMECORE_TARGETFETCHACTUALOWNER_METHOD_3_2E1D81AA84DF008F_OFFSET UNITYSDK_OFFSET(0x16FDA530)
#define RPG_GAMECORE_TARGETFETCHACTUALOWNER_METHOD_3_ACB94AD031885676_OFFSET UNITYSDK_OFFSET(0x16FDA5F0)
#define RPG_GAMECORE_TARGETFETCHACTUALOWNER__CTOR_OFFSET UNITYSDK_OFFSET(0x16FDA5D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchActualOwner_TypeDefinitionIndex = 21680;
