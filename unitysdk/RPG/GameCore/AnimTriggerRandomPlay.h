...
#define RPG_GAMECORE_ANIMTRIGGERRANDOMPLAY_METHOD_3_19C96B0FD48843F2_OFFSET UNITYSDK_OFFSET(0x18AD7480)
#define RPG_GAMECORE_ANIMTRIGGERRANDOMPLAY_METHOD_3_976247451ABAB8A5_OFFSET UNITYSDK_OFFSET(0x18AD7400)
#define RPG_GAMECORE_ANIMTRIGGERRANDOMPLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x18AD7450)
