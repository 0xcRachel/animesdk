...
#define RPG_GAMECORE_BYCHECKDARKTEAMDESTROY_METHOD_4_77889DDB469C151E_OFFSET UNITYSDK_OFFSET(0x169013A0)
#define RPG_GAMECORE_BYCHECKDARKTEAMDESTROY_METHOD_4_8D391E2E464F2820_OFFSET UNITYSDK_OFFSET(0x16901470)
#define RPG_GAMECORE_BYCHECKDARKTEAMDESTROY__CTOR_OFFSET UNITYSDK_OFFSET(0x16901420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckDarkTeamDestroy_TypeDefinitionIndex = 21111;
