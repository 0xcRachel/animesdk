...
#define RPG_GAMECORE_FOLLOWWITHDETECTPROJECTILEDATA_METHOD_3_87CC10C176177385_OFFSET UNITYSDK_OFFSET(0x16ADE090)
#define RPG_GAMECORE_FOLLOWWITHDETECTPROJECTILEDATA_METHOD_3_F0371D2C01DF7559_OFFSET UNITYSDK_OFFSET(0x16ADE100)
#define RPG_GAMECORE_FOLLOWWITHDETECTPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16ADE0E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FollowWithDetectProjectileData_TypeDefinitionIndex = 14241;
