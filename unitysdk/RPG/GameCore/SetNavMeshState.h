...
#define RPG_GAMECORE_SETNAVMESHSTATE_METHOD_3_3258037F0DBBC9CB_OFFSET UNITYSDK_OFFSET(0x199C09B0)
#define RPG_GAMECORE_SETNAVMESHSTATE_METHOD_3_7B920410862438EF_OFFSET UNITYSDK_OFFSET(0x199C0A30)
#define RPG_GAMECORE_SETNAVMESHSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x199C0A00)
