...
#define RPG_GAMECORE_VE_PREDICATE_METHOD_3_0808C5146CEB55DA_OFFSET UNITYSDK_OFFSET(0x1951ABB0)
#define RPG_GAMECORE_VE_PREDICATE_METHOD_3_589FA871C09BD997_OFFSET UNITYSDK_OFFSET(0x1951ABF0)
#define RPG_GAMECORE_VE_PREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1951ABE0)
