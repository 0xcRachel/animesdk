...
#define RPG_GAMECORE_MUSICRHYTHMSONGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x190FCEE0)
#define RPG_GAMECORE_MUSICRHYTHMSONGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x190FD4B0)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::Il2CppArray<::System::Int32>* GridNumList; // 0x10
		...
		::System::Int32 PresetStartGrid; // 0x68
