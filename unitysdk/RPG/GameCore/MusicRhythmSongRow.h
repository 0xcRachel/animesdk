...
#define RPG_GAMECORE_MUSICRHYTHMSONGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18644420)
#define RPG_GAMECORE_MUSICRHYTHMSONGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18644A10)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* MixingWaveMatPath; // 0x18
		...
		::System::Int32 PresetStartGrid; // 0x4C
		::RPG::Client::TextID SongName; // 0x50
		::System::UInt32 UnlockType; // 0x60
		::System::UInt32 UnlockTypeParam; // 0x64
		::System::Int32 PresetEndGrid; // 0x68
		::System::UInt32 SoundEffectUnlockSubMission; // 0x6C
		::System::UInt32 GridTransitionTime; // 0x70
		::System::UInt32 LimitSubMission; // 0x74
		::System::UInt32 GridNum; // 0x78
