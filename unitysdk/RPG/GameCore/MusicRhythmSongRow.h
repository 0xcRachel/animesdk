...
#define RPG_GAMECORE_MUSICRHYTHMSONGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16CF7030)
#define RPG_GAMECORE_MUSICRHYTHMSONGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16CF7620)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MusicRhythmSongRow_TypeDefinitionIndex = 12992;

	class MusicRhythmSongRow : public ::System::Object
	{
	public:
		::System::String* BGMStageState; // 0x10
		::System::String* BGMMenuState; // 0x18
		::Il2CppArray<::System::UInt32>* SoundEffectIDList; // 0x20
		::Il2CppArray<::System::UInt32>* TrackIDList; // 0x28
		::Il2CppArray<::System::UInt32>* PresetIDList; // 0x30
		::System::String* MixingWaveMatPath; // 0x38
		::Il2CppArray<::System::Int32>* GridNumList; // 0x40
		::System::Int32 PresetStartGrid; // 0x48
		::System::UInt32 LimitSubMission; // 0x4C
		::RPG::Client::TextID SongName; // 0x50
		::System::Int32 PresetEndGrid; // 0x60
		::System::UInt32 UnlockTypeParam; // 0x64
		::System::UInt32 GridNum; // 0x68
		::System::UInt32 GridTransitionTime; // 0x6C
		::System::UInt32 UnlockType; // 0x70
		::System::UInt32 ID; // 0x74
		::System::UInt32 SoundEffectUnlockSubMission; // 0x78
