...
#define RPG_GAMECORE_PERFORMANCECAPTURENPC_METHOD_2_9877D25189163954_OFFSET UNITYSDK_OFFSET(0x18F08110)
#define RPG_GAMECORE_PERFORMANCECAPTURENPC__CTOR_OFFSET UNITYSDK_OFFSET(0x18F082F0)
