...
#define RPG_GAMECORE_SETMUSICRHYTHMCAMERA_METHOD_3_38F54F1A339797BD_OFFSET UNITYSDK_OFFSET(0x16F382D0)
#define RPG_GAMECORE_SETMUSICRHYTHMCAMERA_METHOD_3_DD6A9962528EF4DB_OFFSET UNITYSDK_OFFSET(0x16F38250)
#define RPG_GAMECORE_SETMUSICRHYTHMCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x16F382A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMusicRhythmCamera_TypeDefinitionIndex = 19709;
