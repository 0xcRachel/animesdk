...
#define RPG_GAMECORE_CHALLENGEPEAKREWARDORROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16961040)
#define RPG_GAMECORE_CHALLENGEPEAKREWARDORROW__CTOR_OFFSET UNITYSDK_OFFSET(0x169611B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChallengePeakRewardORRow_TypeDefinitionIndex = 11769;
