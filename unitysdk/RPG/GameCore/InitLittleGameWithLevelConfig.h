...
#define RPG_GAMECORE_INITLITTLEGAMEWITHLEVELCONFIG_METHOD_3_67991288636D2BFA_OFFSET UNITYSDK_OFFSET(0x16B82270)
#define RPG_GAMECORE_INITLITTLEGAMEWITHLEVELCONFIG_METHOD_3_FC60A0992DC10937_OFFSET UNITYSDK_OFFSET(0x16B82120)
#define RPG_GAMECORE_INITLITTLEGAMEWITHLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16B821E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InitLittleGameWithLevelConfig_TypeDefinitionIndex = 18795;
