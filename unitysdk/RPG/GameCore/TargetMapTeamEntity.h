...
#define RPG_GAMECORE_TARGETMAPTEAMENTITY_METHOD_3_8A8E39DE2173D4F3_OFFSET UNITYSDK_OFFSET(0x16FE3BC0)
#define RPG_GAMECORE_TARGETMAPTEAMENTITY_METHOD_3_C1AAD4CD4025279E_OFFSET UNITYSDK_OFFSET(0x16FE3B00)
#define RPG_GAMECORE_TARGETMAPTEAMENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE3BA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapTeamEntity_TypeDefinitionIndex = 21659;
