...
#define RPG_GAMECORE_SETTIMEREWINDENTITYDISABLECONTROL_METHOD_3_627D71E3FF8E17D8_OFFSET UNITYSDK_OFFSET(0x1A7A1F60)
#define RPG_GAMECORE_SETTIMEREWINDENTITYDISABLECONTROL_METHOD_3_B0F3C7F5C56B3DDA_OFFSET UNITYSDK_OFFSET(0x1A7A1FE0)
#define RPG_GAMECORE_SETTIMEREWINDENTITYDISABLECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7A1FB0)
