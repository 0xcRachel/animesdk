...
#define RPG_GAMECORE_TARGETFETCHCHESSBASE_METHOD_4_28650EA1C4A75E70_OFFSET UNITYSDK_OFFSET(0x16FDC6D0)
#define RPG_GAMECORE_TARGETFETCHCHESSBASE_METHOD_4_C3DA8274581E94CE_OFFSET UNITYSDK_OFFSET(0x16FD5360)
#define RPG_GAMECORE_TARGETFETCHCHESSBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD52E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchChessBase_TypeDefinitionIndex = 21606;
