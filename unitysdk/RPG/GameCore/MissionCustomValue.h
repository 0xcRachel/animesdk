...
#define RPG_GAMECORE_MISSIONCUSTOMVALUE_METHOD_2_A0FEA106DC66755E_OFFSET UNITYSDK_OFFSET(0x16CADB70)
#define RPG_GAMECORE_MISSIONCUSTOMVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x16CADE30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MissionCustomValue_TypeDefinitionIndex = 16997;
