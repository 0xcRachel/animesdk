...
#define RPG_GAMECORE_ACTIVITYFEVERTIMEUNDERLINEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16795750)
#define RPG_GAMECORE_ACTIVITYFEVERTIMEUNDERLINEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16795D10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityFeverTimeUnderlineRow_TypeDefinitionIndex = 10723;
