...
#define RPG_GAMECORE_ST_BYDISTANCETOENCHANTTARGET_METHOD_4_09D04241A173B5F4_OFFSET UNITYSDK_OFFSET(0x176A6990)
#define RPG_GAMECORE_ST_BYDISTANCETOENCHANTTARGET_METHOD_4_267176B2C57D7B50_OFFSET UNITYSDK_OFFSET(0x176A6A60)
#define RPG_GAMECORE_ST_BYDISTANCETOENCHANTTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x176A6A10)
