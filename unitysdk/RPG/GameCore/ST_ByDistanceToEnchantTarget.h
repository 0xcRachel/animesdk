...
#define RPG_GAMECORE_ST_BYDISTANCETOENCHANTTARGET_METHOD_4_09D04241A173B5F4_OFFSET UNITYSDK_OFFSET(0x16EEF020)
#define RPG_GAMECORE_ST_BYDISTANCETOENCHANTTARGET_METHOD_4_267176B2C57D7B50_OFFSET UNITYSDK_OFFSET(0x16EEF0F0)
#define RPG_GAMECORE_ST_BYDISTANCETOENCHANTTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x16EEF0A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByDistanceToEnchantTarget_TypeDefinitionIndex = 17839;
