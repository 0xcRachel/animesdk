...
#define RPG_GAMECORE_LEVELPEDESTRIANV2INFO_METHOD_4_B98BD0EC298056F8_OFFSET UNITYSDK_OFFSET(0x16BB36B0)
#define RPG_GAMECORE_LEVELPEDESTRIANV2INFO_METHOD_4_C91298D634D534B5_OFFSET UNITYSDK_OFFSET(0x16BB6930)
#define RPG_GAMECORE_LEVELPEDESTRIANV2INFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16BB36A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPedestrianV2Info_TypeDefinitionIndex = 15628;
