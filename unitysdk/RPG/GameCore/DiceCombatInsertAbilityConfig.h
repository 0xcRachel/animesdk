...
#define RPG_GAMECORE_DICECOMBATINSERTABILITYCONFIG_METHOD_2_02980C4FDB7278B0_OFFSET UNITYSDK_OFFSET(0x19592150)
#define RPG_GAMECORE_DICECOMBATINSERTABILITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x195923A0)
