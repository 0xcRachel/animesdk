...
#define RPG_GAMECORE_ACTIONGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1885D740)
#define RPG_GAMECORE_ACTIONGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1885DF50)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* GermanyKeyMouseImagePath; // 0x20
		::System::String* XboxImagePath; // 0x28
		::System::String* PsImagePath; // 0x30
		::System::String* ActionGroupName; // 0x38
		::System::String* FranceKeyMouseImagePath; // 0x40
		::System::String* KeyMouseImagePath; // 0x48
		::Il2CppArray<::System::String*>* ActionListForAnd; // 0x50
