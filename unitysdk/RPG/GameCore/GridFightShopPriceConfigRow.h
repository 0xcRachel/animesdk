...
#define RPG_GAMECORE_GRIDFIGHTSHOPPRICECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17297160)
#define RPG_GAMECORE_GRIDFIGHTSHOPPRICECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17297440)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::UInt32 SellGoldStar3; // 0x10
		...
		::System::UInt32 SellGoldStar2; // 0x2C
