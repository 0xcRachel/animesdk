...
#define RPG_GAMECORE_VE_RTBATTLEGRIDORDER_METHOD_3_667F0CD27C914E5F_OFFSET UNITYSDK_OFFSET(0x1951BBA0)
#define RPG_GAMECORE_VE_RTBATTLEGRIDORDER_METHOD_3_C6367DEAC0E72D04_OFFSET UNITYSDK_OFFSET(0x1951BB60)
#define RPG_GAMECORE_VE_RTBATTLEGRIDORDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1951BB90)
