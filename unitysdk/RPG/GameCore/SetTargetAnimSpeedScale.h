...
#define RPG_GAMECORE_SETTARGETANIMSPEEDSCALE_METHOD_3_7F594083C0BA46DA_OFFSET UNITYSDK_OFFSET(0x16F3FD50)
#define RPG_GAMECORE_SETTARGETANIMSPEEDSCALE_METHOD_3_C24602D2718DBFA9_OFFSET UNITYSDK_OFFSET(0x16F3FDD0)
#define RPG_GAMECORE_SETTARGETANIMSPEEDSCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F3FDA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTargetAnimSpeedScale_TypeDefinitionIndex = 20535;
