...
#define RPG_GAMECORE_ADVENTURECONTROLTIMELINEENTITYEVENT_CLEAR_OFFSET UNITYSDK_OFFSET(0xA3112F0)
#define RPG_GAMECORE_ADVENTURECONTROLTIMELINEENTITYEVENT_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA311390)
#define RPG_GAMECORE_ADVENTURECONTROLTIMELINEENTITYEVENT_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA311340)
#define RPG_GAMECORE_ADVENTURECONTROLTIMELINEENTITYEVENT_INIT_OFFSET UNITYSDK_OFFSET(0xA311280)
#define RPG_GAMECORE_ADVENTURECONTROLTIMELINEENTITYEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xA3113E0)
#define RPG_GAMECORE_ADVENTURECONTROLTIMELINEENTITYEVENT___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0xA3113F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureControlTimelineEntityEvent_TypeDefinitionIndex = 44485;
