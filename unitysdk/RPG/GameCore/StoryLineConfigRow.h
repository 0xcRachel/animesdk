...
#define RPG_GAMECORE_STORYLINECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18D75070)
#define RPG_GAMECORE_STORYLINECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18D75300)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::String* ShowCondition; // 0x10
		::System::String* PerformanceStoryAvatar; // 0x18
		::RPG::GameCore::ConditionParam* BeginCondition; // 0x20
		::RPG::GameCore::ConditionParam* EndCondition; // 0x28
		::System::UInt32 InitGroupID; // 0x30
