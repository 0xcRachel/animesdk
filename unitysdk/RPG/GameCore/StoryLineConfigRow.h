...
#define RPG_GAMECORE_STORYLINECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17794300)
#define RPG_GAMECORE_STORYLINECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17794590)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 StoryLineID; // 0x30
