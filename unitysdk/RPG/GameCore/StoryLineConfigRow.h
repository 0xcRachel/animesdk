...
#define RPG_GAMECORE_STORYLINECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16FA0790)
#define RPG_GAMECORE_STORYLINECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16FA0A20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StoryLineConfigRow_TypeDefinitionIndex = 13803;

	class StoryLineConfigRow : public ::System::Object
	{
	public:
		::RPG::GameCore::ConditionParam* BeginCondition; // 0x10
		::RPG::GameCore::ConditionParam* EndCondition; // 0x18
		...
		::System::UInt32 InitAnchorID; // 0x3C
		::System::UInt32 EarlyAccessContentID; // 0x40
