...
#define RPG_GAMECORE_DICECOMBATV2SINGLEDIALOGPERFORMANCETRIGGERCONDITION_METHOD_2_0948BEEF78D5D811_OFFSET UNITYSDK_OFFSET(0x195A7EB0)
#define RPG_GAMECORE_DICECOMBATV2SINGLEDIALOGPERFORMANCETRIGGERCONDITION_METHOD_2_EE996B6F5A6A973A_OFFSET UNITYSDK_OFFSET(0x195A7A20)
#define RPG_GAMECORE_DICECOMBATV2SINGLEDIALOGPERFORMANCETRIGGERCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x195A7EA0)
