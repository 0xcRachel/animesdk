...
#define RPG_GAMECORE_TIMEREWINDSETSPECULARMAT_METHOD_3_1578C07DD4CC866E_OFFSET UNITYSDK_OFFSET(0x170F6DC0)
#define RPG_GAMECORE_TIMEREWINDSETSPECULARMAT_METHOD_3_C19CA4B012FF8815_OFFSET UNITYSDK_OFFSET(0x170F6E40)
#define RPG_GAMECORE_TIMEREWINDSETSPECULARMAT__CTOR_OFFSET UNITYSDK_OFFSET(0x170F6E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRewindSetSpecularMat_TypeDefinitionIndex = 18439;
