...
#define RPG_GAMECORE_TIMEREWINDSETSPECULARMAT_METHOD_3_1578C07DD4CC866E_OFFSET UNITYSDK_OFFSET(0x178B4840)
#define RPG_GAMECORE_TIMEREWINDSETSPECULARMAT_METHOD_3_C19CA4B012FF8815_OFFSET UNITYSDK_OFFSET(0x1789E1B0)
#define RPG_GAMECORE_TIMEREWINDSETSPECULARMAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1789E180)
