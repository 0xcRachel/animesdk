...
#define RPG_GAMECORE_ST_BYSKILLINCD_METHOD_4_72E2390255B5DB26_OFFSET UNITYSDK_OFFSET(0x176A8D70)
#define RPG_GAMECORE_ST_BYSKILLINCD_METHOD_4_CCB822FFB0D7EE78_OFFSET UNITYSDK_OFFSET(0x176A8CA0)
#define RPG_GAMECORE_ST_BYSKILLINCD__CTOR_OFFSET UNITYSDK_OFFSET(0x176A8D20)
