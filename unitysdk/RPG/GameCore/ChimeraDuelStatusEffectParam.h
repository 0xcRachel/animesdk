...
#define RPG_GAMECORE_CHIMERADUELSTATUSEFFECTPARAM_METHOD_3_08DA8F697E7FE503_OFFSET UNITYSDK_OFFSET(0x16998AF0)
#define RPG_GAMECORE_CHIMERADUELSTATUSEFFECTPARAM_METHOD_3_50F2EAF228CF1273_OFFSET UNITYSDK_OFFSET(0x16998B50)
#define RPG_GAMECORE_CHIMERADUELSTATUSEFFECTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x16998B40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelStatusEffectParam_TypeDefinitionIndex = 14454;
