...
#define RPG_GAMECORE_STAGEHARMONYSIGNALDYNAMICPATTERNMONOSERIALIZATION_METHOD_2_F35845005F9A325E_OFFSET UNITYSDK_OFFSET(0x1777C260)
#define RPG_GAMECORE_STAGEHARMONYSIGNALDYNAMICPATTERNMONOSERIALIZATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1777C3B0)
