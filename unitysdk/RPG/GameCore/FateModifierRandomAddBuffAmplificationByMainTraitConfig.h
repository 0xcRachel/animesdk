...
#define RPG_GAMECORE_FATEMODIFIERRANDOMADDBUFFAMPLIFICATIONBYMAINTRAITCONFIG_METHOD_3_209B1B1BFFB7539D_OFFSET UNITYSDK_OFFSET(0x171DC600)
#define RPG_GAMECORE_FATEMODIFIERRANDOMADDBUFFAMPLIFICATIONBYMAINTRAITCONFIG_METHOD_3_AFC3501543DEB324_OFFSET UNITYSDK_OFFSET(0x171DD400)
#define RPG_GAMECORE_FATEMODIFIERRANDOMADDBUFFAMPLIFICATIONBYMAINTRAITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171DC5B0)
