...
#define RPG_GAMECORE_CHARACTEROUTFITPENDANTCONFIG_METHOD_2_32B901CC29B464B0_OFFSET UNITYSDK_OFFSET(0x16972A10)
#define RPG_GAMECORE_CHARACTEROUTFITPENDANTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16972AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterOutfitPendantConfig_TypeDefinitionIndex = 15787;
