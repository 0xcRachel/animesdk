...
#define RPG_GAMECORE_WAITTIMELINEFINISH_METHOD_3_CD3F42F356C96246_OFFSET UNITYSDK_OFFSET(0x1791B030)
#define RPG_GAMECORE_WAITTIMELINEFINISH_METHOD_3_ED1D00621172FAAF_OFFSET UNITYSDK_OFFSET(0x1791AFB0)
#define RPG_GAMECORE_WAITTIMELINEFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1791B000)
