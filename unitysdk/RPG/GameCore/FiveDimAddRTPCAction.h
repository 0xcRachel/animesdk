...
#define RPG_GAMECORE_FIVEDIMADDRTPCACTION_METHOD_3_09FEFB752C4B848A_OFFSET UNITYSDK_OFFSET(0x16AAB250)
#define RPG_GAMECORE_FIVEDIMADDRTPCACTION_METHOD_3_7FFDFF9F0918AA57_OFFSET UNITYSDK_OFFSET(0x16AAB1E0)
#define RPG_GAMECORE_FIVEDIMADDRTPCACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16AAB230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimAddRTPCAction_TypeDefinitionIndex = 16787;
