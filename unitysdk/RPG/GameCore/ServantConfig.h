...
#define RPG_GAMECORE_SERVANTCONFIG_METHOD_3_302838C57322931A_OFFSET UNITYSDK_OFFSET(0x16EFE9F0)
#define RPG_GAMECORE_SERVANTCONFIG_METHOD_3_B889F2F56102372C_OFFSET UNITYSDK_OFFSET(0x16EFEBC0)
#define RPG_GAMECORE_SERVANTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16EFEB90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ServantConfig_TypeDefinitionIndex = 14885;
