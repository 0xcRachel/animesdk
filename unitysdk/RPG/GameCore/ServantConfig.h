...
#define RPG_GAMECORE_SERVANTCONFIG_METHOD_3_302838C57322931A_OFFSET UNITYSDK_OFFSET(0x176B3E80)
#define RPG_GAMECORE_SERVANTCONFIG_METHOD_3_B889F2F56102372C_OFFSET UNITYSDK_OFFSET(0x176B4050)
#define RPG_GAMECORE_SERVANTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176B4020)
