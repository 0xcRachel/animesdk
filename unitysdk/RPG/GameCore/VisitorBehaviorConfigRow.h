...
#define RPG_GAMECORE_VISITORBEHAVIORCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19A7FB50)
#define RPG_GAMECORE_VISITORBEHAVIORCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19A7FEA0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 DefaultIdleFreeStyleMotionID; // 0x34
