...
#define RPG_GAMECORE_RESETCHARACTERCUSTOMTEAMFORMATION_METHOD_3_094DFF8477650635_OFFSET UNITYSDK_OFFSET(0x16DE5650)
#define RPG_GAMECORE_RESETCHARACTERCUSTOMTEAMFORMATION_METHOD_3_5B5C2486BBFC2169_OFFSET UNITYSDK_OFFSET(0x16DE56D0)
#define RPG_GAMECORE_RESETCHARACTERCUSTOMTEAMFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x16DE56A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetCharacterCustomTeamFormation_TypeDefinitionIndex = 20280;
