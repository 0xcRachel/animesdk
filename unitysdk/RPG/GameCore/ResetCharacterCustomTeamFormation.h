...
#define RPG_GAMECORE_RESETCHARACTERCUSTOMTEAMFORMATION_METHOD_3_094DFF8477650635_OFFSET UNITYSDK_OFFSET(0x175B27E0)
#define RPG_GAMECORE_RESETCHARACTERCUSTOMTEAMFORMATION_METHOD_3_5B5C2486BBFC2169_OFFSET UNITYSDK_OFFSET(0x175B2860)
#define RPG_GAMECORE_RESETCHARACTERCUSTOMTEAMFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x175B2830)
