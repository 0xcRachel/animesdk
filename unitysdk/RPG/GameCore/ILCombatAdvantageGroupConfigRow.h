...
#define RPG_GAMECORE_ILCOMBATADVANTAGEGROUPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19AD21E0)
#define RPG_GAMECORE_ILCOMBATADVANTAGEGROUPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD2430)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::UInt32 CombatAdvantageGroup; // 0x10
