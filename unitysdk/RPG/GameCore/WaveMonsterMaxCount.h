...
#define RPG_GAMECORE_WAVEMONSTERMAXCOUNT_METHOD_3_1BC18D5B53A0FCCB_OFFSET UNITYSDK_OFFSET(0x17161260)
#define RPG_GAMECORE_WAVEMONSTERMAXCOUNT_METHOD_3_2F1449CEDDC82F30_OFFSET UNITYSDK_OFFSET(0x171612E0)
#define RPG_GAMECORE_WAVEMONSTERMAXCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x171612B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaveMonsterMaxCount_TypeDefinitionIndex = 21065;
