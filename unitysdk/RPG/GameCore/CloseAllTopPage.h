...
#define RPG_GAMECORE_CLOSEALLTOPPAGE_METHOD_3_B1257A545029C8B6_OFFSET UNITYSDK_OFFSET(0x169B5CD0)
#define RPG_GAMECORE_CLOSEALLTOPPAGE_METHOD_3_DB69542202AF55EA_OFFSET UNITYSDK_OFFSET(0x169B5BC0)
#define RPG_GAMECORE_CLOSEALLTOPPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x169B5CA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CloseAllTopPage_TypeDefinitionIndex = 18413;
