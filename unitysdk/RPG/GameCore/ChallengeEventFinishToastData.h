...
#define RPG_GAMECORE_CHALLENGEEVENTFINISHTOASTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA366210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChallengeEventFinishToastData_TypeDefinitionIndex = 42127;
