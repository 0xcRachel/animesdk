...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::PPEffectFilterType>**)Il2CppClass::FromTypeDefinitionIndex(FilterSystemConflictTypes___O_TypeDefinitionIndex)->GetStaticField(0x20770);
		}
	};
}
