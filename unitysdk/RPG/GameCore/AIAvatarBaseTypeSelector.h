...
#define RPG_GAMECORE_AIAVATARBASETYPESELECTOR_METHOD_3_36A0D4F96CD446B5_OFFSET UNITYSDK_OFFSET(0x1676E4A0)
#define RPG_GAMECORE_AIAVATARBASETYPESELECTOR_METHOD_3_85C7E9BB84E2078C_OFFSET UNITYSDK_OFFSET(0x1676E4F0)
#define RPG_GAMECORE_AIAVATARBASETYPESELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1676E4E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIAvatarBaseTypeSelector_TypeDefinitionIndex = 14178;
