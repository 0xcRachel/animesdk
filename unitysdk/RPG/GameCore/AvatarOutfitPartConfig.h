...
#define RPG_GAMECORE_AVATAROUTFITPARTCONFIG_METHOD_2_875EF3FB08E71C90_OFFSET UNITYSDK_OFFSET(0x16FB66A0)
#define RPG_GAMECORE_AVATAROUTFITPARTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16FB67B0)
