...
#define RPG_GAMECORE_WAITPLAYERSKILLABORT_METHOD_3_037EE14AD098D848_OFFSET UNITYSDK_OFFSET(0x171586C0)
#define RPG_GAMECORE_WAITPLAYERSKILLABORT_METHOD_3_6610393933A30511_OFFSET UNITYSDK_OFFSET(0x17158640)
#define RPG_GAMECORE_WAITPLAYERSKILLABORT__CTOR_OFFSET UNITYSDK_OFFSET(0x17158690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitPlayerSkillAbort_TypeDefinitionIndex = 18721;
