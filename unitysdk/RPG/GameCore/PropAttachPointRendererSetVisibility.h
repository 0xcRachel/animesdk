...
#define RPG_GAMECORE_PROPATTACHPOINTRENDERERSETVISIBILITY_METHOD_3_5AAFEFBCAF9C2EF9_OFFSET UNITYSDK_OFFSET(0x16DA3260)
#define RPG_GAMECORE_PROPATTACHPOINTRENDERERSETVISIBILITY_METHOD_3_C6D1FA0308AFBC93_OFFSET UNITYSDK_OFFSET(0x16DA3110)
#define RPG_GAMECORE_PROPATTACHPOINTRENDERERSETVISIBILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x16DA31D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropAttachPointRendererSetVisibility_TypeDefinitionIndex = 18176;
