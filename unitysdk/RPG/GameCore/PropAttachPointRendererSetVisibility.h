...
#define RPG_GAMECORE_PROPATTACHPOINTRENDERERSETVISIBILITY_METHOD_3_5AAFEFBCAF9C2EF9_OFFSET UNITYSDK_OFFSET(0x1752A3B0)
#define RPG_GAMECORE_PROPATTACHPOINTRENDERERSETVISIBILITY_METHOD_3_C6D1FA0308AFBC93_OFFSET UNITYSDK_OFFSET(0x1752A260)
#define RPG_GAMECORE_PROPATTACHPOINTRENDERERSETVISIBILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1752A320)
