...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::SkillEffect>**)Il2CppClass::FromTypeDefinitionIndex(ByCurrentSkillEffect___O_TypeDefinitionIndex)->GetStaticField(0x116F0);
		}
	};
}
