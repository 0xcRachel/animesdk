...
#define RPG_GAMECORE_STARTTUTORIALGRAPH_METHOD_3_95B483C229A1777E_OFFSET UNITYSDK_OFFSET(0x16F97640)
#define RPG_GAMECORE_STARTTUTORIALGRAPH_METHOD_3_D216B5657C867488_OFFSET UNITYSDK_OFFSET(0x16F976C0)
#define RPG_GAMECORE_STARTTUTORIALGRAPH__CTOR_OFFSET UNITYSDK_OFFSET(0x16F97690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartTutorialGraph_TypeDefinitionIndex = 21085;
