...
#define RPG_GAMECORE_BYCONTAINMONSTERONWAVE_METHOD_4_113350CF45DAE883_OFFSET UNITYSDK_OFFSET(0x169208B0)
#define RPG_GAMECORE_BYCONTAINMONSTERONWAVE_METHOD_4_ACF123DCC9B82027_OFFSET UNITYSDK_OFFSET(0x169207E0)
#define RPG_GAMECORE_BYCONTAINMONSTERONWAVE__CTOR_OFFSET UNITYSDK_OFFSET(0x16920860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByContainMonsterOnWave_TypeDefinitionIndex = 20208;
