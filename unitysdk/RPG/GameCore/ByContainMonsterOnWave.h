...
#define RPG_GAMECORE_BYCONTAINMONSTERONWAVE_METHOD_4_113350CF45DAE883_OFFSET UNITYSDK_OFFSET(0x17031C50)
#define RPG_GAMECORE_BYCONTAINMONSTERONWAVE_METHOD_4_ACF123DCC9B82027_OFFSET UNITYSDK_OFFSET(0x17031B80)
#define RPG_GAMECORE_BYCONTAINMONSTERONWAVE__CTOR_OFFSET UNITYSDK_OFFSET(0x17031C00)
