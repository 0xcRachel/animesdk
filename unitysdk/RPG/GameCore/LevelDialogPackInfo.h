...
#define RPG_GAMECORE_LEVELDIALOGPACKINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16BA2AA0)
#define RPG_GAMECORE_LEVELDIALOGPACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16BA2BB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelDialogPackInfo_TypeDefinitionIndex = 15552;
