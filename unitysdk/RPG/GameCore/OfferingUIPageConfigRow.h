...
#define RPG_GAMECORE_OFFERINGUIPAGECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19D04120)
#define RPG_GAMECORE_OFFERINGUIPAGECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19D04600)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::RPG::Client::TextID SubmitBtnName; // 0x10
		::RPG::Client::TextID MaxTip; // 0x20
		::RPG::Client::TextID LongTailDesc; // 0x30
