...
#define RPG_GAMECORE_FINISHWAYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x171ED3F0)
#define RPG_GAMECORE_FINISHWAYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x171EE430)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::QuestFinishType FinishType; // 0x28
		::System::UInt32 Progress; // 0x2C
		::System::UInt32 ParamInt2; // 0x30
		::RPG::GameCore::QuestParaType ParamType; // 0x34
		::System::UInt32 ParamInt3; // 0x38
		::System::Boolean IsBackTrack; // 0x3C
		::System::UInt32 ParamInt1; // 0x40
		::System::UInt32 MazePlaneID; // 0x44
