...
#define RPG_GAMECORE_DAMAGETEXTTEAMPOOLCONFIG_METHOD_2_68F117186625E969_OFFSET UNITYSDK_OFFSET(0x169E1E60)
#define RPG_GAMECORE_DAMAGETEXTTEAMPOOLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x169E2070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DamageTextTeamPoolConfig_TypeDefinitionIndex = 15434;
