...
#define RPG_GAMECORE_SWORDTRAININGSKILLROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x177B49A0)
#define RPG_GAMECORE_SWORDTRAININGSKILLROW__CTOR_OFFSET UNITYSDK_OFFSET(0x177B4F90)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::ItemConfig* Cost; // 0x30
		::System::UInt32 SkillTypeID; // 0x38
		::System::UInt32 SkillRank; // 0x3C
		::System::UInt32 MazeBuffID; // 0x40
		::System::UInt32 Condition; // 0x44
		::System::UInt32 SkillID; // 0x48
		::System::UInt32 SkillPower; // 0x4C
		::RPG::Client::TextID SkillName; // 0x50
		::RPG::Client::TextID SkillTag; // 0x60
		::RPG::Client::TextID SkillDesc; // 0x70
		::System::UInt32 SkillStatusLevel; // 0x80
