...
#define RPG_GAMECORE_MARBLEBYVALUEREACH_METHOD_4_434A3092842E57FF_OFFSET UNITYSDK_OFFSET(0x16C3BD10)
#define RPG_GAMECORE_MARBLEBYVALUEREACH_METHOD_4_57F3FFD2ECF9972E_OFFSET UNITYSDK_OFFSET(0x16C3BDF0)
#define RPG_GAMECORE_MARBLEBYVALUEREACH__CTOR_OFFSET UNITYSDK_OFFSET(0x16C3BDA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleByValueReach_TypeDefinitionIndex = 15201;
