...
#define RPG_GAMECORE_MARBLEBYVALUEREACH_METHOD_4_A50795E859BAC65B_OFFSET UNITYSDK_OFFSET(0x19C34F10)
#define RPG_GAMECORE_MARBLEBYVALUEREACH_METHOD_4_E448FB0DE221C1F5_OFFSET UNITYSDK_OFFSET(0x19C34FF0)
#define RPG_GAMECORE_MARBLEBYVALUEREACH__CTOR_OFFSET UNITYSDK_OFFSET(0x19C34FA0)
