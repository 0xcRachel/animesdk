...
#define RPG_GAMECORE_CHESSTRIGGERANIMSTATE_METHOD_3_5E0711AD217FB085_OFFSET UNITYSDK_OFFSET(0x16980DE0)
#define RPG_GAMECORE_CHESSTRIGGERANIMSTATE_METHOD_3_C3D0F1C9186A4EE7_OFFSET UNITYSDK_OFFSET(0x16980D00)
#define RPG_GAMECORE_CHESSTRIGGERANIMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16980D40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChessTriggerAnimState_TypeDefinitionIndex = 21423;
