...
#define RPG_GAMECORE_MAINMISSIONSCHEDULEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18FD40E0)
#define RPG_GAMECORE_MAINMISSIONSCHEDULEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18FD4760)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean HideRemainTime; // 0x18
		::System::Boolean IsNotDelete; // 0x19
