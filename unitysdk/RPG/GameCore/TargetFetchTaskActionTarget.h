...
#define RPG_GAMECORE_TARGETFETCHTASKACTIONTARGET_METHOD_4_0975F12C965F123C_OFFSET UNITYSDK_OFFSET(0x177D49B0)
#define RPG_GAMECORE_TARGETFETCHTASKACTIONTARGET_METHOD_4_BB7BC79E918F2D3E_OFFSET UNITYSDK_OFFSET(0x177CCEA0)
#define RPG_GAMECORE_TARGETFETCHTASKACTIONTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x177CCE50)
