...
#define RPG_GAMECORE_ROGUEMAGICPOWERCONFIG_METHOD_2_1202B961702931B8_OFFSET UNITYSDK_OFFSET(0x1996EEF0)
#define RPG_GAMECORE_ROGUEMAGICPOWERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1996F130)
