...
#define RPG_GAMECORE_ADVENTURESKILLCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16861100)
#define RPG_GAMECORE_ADVENTURESKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x168614A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureSkillConfig_TypeDefinitionIndex = 15810;
