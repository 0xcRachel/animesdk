...
#define RPG_GAMECORE_ROGUEDIALOGUEEVENTOPTIONCONFIG_METHOD_2_A141BF27AD0680E7_OFFSET UNITYSDK_OFFSET(0x16E7A970)
#define RPG_GAMECORE_ROGUEDIALOGUEEVENTOPTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E7ACB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDialogueEventOptionConfig_TypeDefinitionIndex = 16093;
