...
#define RPG_GAMECORE_STREAMINGFORCEHLODVOLUMEDATA_METHOD_4_825C561560251423_OFFSET UNITYSDK_OFFSET(0x16FA2490)
#define RPG_GAMECORE_STREAMINGFORCEHLODVOLUMEDATA_METHOD_4_9F594A72A83781F0_OFFSET UNITYSDK_OFFSET(0x16F8E4B0)
#define RPG_GAMECORE_STREAMINGFORCEHLODVOLUMEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16F8E4A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StreamingForceHLODVolumeData_TypeDefinitionIndex = 17132;
