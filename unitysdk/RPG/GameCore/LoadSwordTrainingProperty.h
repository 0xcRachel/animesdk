...
#define RPG_GAMECORE_LOADSWORDTRAININGPROPERTY_METHOD_3_1791C2BAFD862ECD_OFFSET UNITYSDK_OFFSET(0x18FC29C0)
#define RPG_GAMECORE_LOADSWORDTRAININGPROPERTY_METHOD_3_4EF9FD69FAD563C1_OFFSET UNITYSDK_OFFSET(0x18FC2AD0)
#define RPG_GAMECORE_LOADSWORDTRAININGPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x18FC2AA0)
