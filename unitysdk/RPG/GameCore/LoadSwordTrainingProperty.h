...
#define RPG_GAMECORE_LOADSWORDTRAININGPROPERTY_METHOD_3_1791C2BAFD862ECD_OFFSET UNITYSDK_OFFSET(0x16BD4F10)
#define RPG_GAMECORE_LOADSWORDTRAININGPROPERTY_METHOD_3_4EF9FD69FAD563C1_OFFSET UNITYSDK_OFFSET(0x16BD5020)
#define RPG_GAMECORE_LOADSWORDTRAININGPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x16BD4FF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoadSwordTrainingProperty_TypeDefinitionIndex = 20232;
