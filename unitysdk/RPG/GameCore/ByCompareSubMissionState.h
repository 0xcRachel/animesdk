...
#define RPG_GAMECORE_BYCOMPARESUBMISSIONSTATE_METHOD_4_1ED1B0FE2A40338C_OFFSET UNITYSDK_OFFSET(0x1702DC70)
#define RPG_GAMECORE_BYCOMPARESUBMISSIONSTATE_METHOD_4_2942F15B5EBE8628_OFFSET UNITYSDK_OFFSET(0x1702DBA0)
#define RPG_GAMECORE_BYCOMPARESUBMISSIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1702DC20)
