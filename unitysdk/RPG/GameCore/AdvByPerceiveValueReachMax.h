...
#define RPG_GAMECORE_ADVBYPERCEIVEVALUEREACHMAX_METHOD_4_352F8353921C832B_OFFSET UNITYSDK_OFFSET(0x1955BC30)
#define RPG_GAMECORE_ADVBYPERCEIVEVALUEREACHMAX_METHOD_4_3D1B43F3789D57DF_OFFSET UNITYSDK_OFFSET(0x1955BBB0)
#define RPG_GAMECORE_ADVBYPERCEIVEVALUEREACHMAX_METHOD_4_B9F197A604D8E4CE_OFFSET UNITYSDK_OFFSET(0x1955B9A0)
#define RPG_GAMECORE_ADVBYPERCEIVEVALUEREACHMAX_METHOD_4_D84731B050BC72A4_OFFSET UNITYSDK_OFFSET(0x1955BA70)
#define RPG_GAMECORE_ADVBYPERCEIVEVALUEREACHMAX__CTOR_OFFSET UNITYSDK_OFFSET(0x1955BA20)
