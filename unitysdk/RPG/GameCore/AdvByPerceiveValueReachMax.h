...
#define RPG_GAMECORE_ADVBYPERCEIVEVALUEREACHMAX_METHOD_4_B9F197A604D8E4CE_OFFSET UNITYSDK_OFFSET(0x167C5260)
#define RPG_GAMECORE_ADVBYPERCEIVEVALUEREACHMAX_METHOD_4_D84731B050BC72A4_OFFSET UNITYSDK_OFFSET(0x167C5330)
#define RPG_GAMECORE_ADVBYPERCEIVEVALUEREACHMAX__CTOR_OFFSET UNITYSDK_OFFSET(0x167C52E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByPerceiveValueReachMax_TypeDefinitionIndex = 17777;
