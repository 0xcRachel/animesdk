...
#define RPG_GAMECORE_TURNBASEDMODIFIERUICONFIG_METHOD_2_E6754E924862C07A_OFFSET UNITYSDK_OFFSET(0x1712BF50)
#define RPG_GAMECORE_TURNBASEDMODIFIERUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1712C780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TurnBasedModifierUIConfig_TypeDefinitionIndex = 16371;
