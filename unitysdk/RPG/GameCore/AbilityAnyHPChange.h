...
#define RPG_GAMECORE_ABILITYANYHPCHANGE_GETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0xA297C10)
#define RPG_GAMECORE_ABILITYANYHPCHANGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA297B70)
#define RPG_GAMECORE_ABILITYANYHPCHANGE_GETNEGATIVEHPCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0xA297C60)
#define RPG_GAMECORE_ABILITYANYHPCHANGE_GETORIGINMODIFYVALUE_OFFSET UNITYSDK_OFFSET(0xA297BC0)
#define RPG_GAMECORE_ABILITYANYHPCHANGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA297B20)
#define RPG_GAMECORE_ABILITYANYHPCHANGE_GET_CHANGEPARAMS_OFFSET UNITYSDK_OFFSET(0xA297CB0)
#define RPG_GAMECORE_ABILITYANYHPCHANGE_GET_MODIFYSOURCEENTITY_OFFSET UNITYSDK_OFFSET(0xA297CF0)
#define RPG_GAMECORE_ABILITYANYHPCHANGE_GET_USEBIGCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0xA297CE0)
#define RPG_GAMECORE_ABILITYANYHPCHANGE_INIT_OFFSET UNITYSDK_OFFSET(0xA297A50)
#define RPG_GAMECORE_ABILITYANYHPCHANGE_SET_CHANGEPARAMS_OFFSET UNITYSDK_OFFSET(0xA297CD0)
#define RPG_GAMECORE_ABILITYANYHPCHANGE_SET_MODIFYSOURCEENTITY_OFFSET UNITYSDK_OFFSET(0xA297D00)
#define RPG_GAMECORE_ABILITYANYHPCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0xA297D10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AbilityAnyHPChange_TypeDefinitionIndex = 44408;

	class AbilityAnyHPChange : public ::Class_1_9988289E7F8AA214
	{
	public:
		::Struct_2_5909FD7779934CCA _ChangeParams_k__BackingField; // 0x18
		::RPG::GameCore::GameEntity* _ModifySourceEntity_k__BackingField; // 0x148
		...
		::RPG::GameCore::FixPoint _OriginModifyValue; // 0x168
