...
#define RPG_GAMECORE_SETUPMAPROTATIONCHARGER_METHOD_3_384217892B2B944A_OFFSET UNITYSDK_OFFSET(0x16F496D0)
#define RPG_GAMECORE_SETUPMAPROTATIONCHARGER_METHOD_3_94F6BA095FDB2551_OFFSET UNITYSDK_OFFSET(0x16F49750)
#define RPG_GAMECORE_SETUPMAPROTATIONCHARGER__CTOR_OFFSET UNITYSDK_OFFSET(0x16F49720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetupMapRotationCharger_TypeDefinitionIndex = 19958;
