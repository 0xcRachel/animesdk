...
#define RPG_GAMECORE_FIVEDIMINTERACTEMITTERCONFIG_METHOD_3_ABCC8DEFAB2AFCF2_OFFSET UNITYSDK_OFFSET(0x1720B900)
#define RPG_GAMECORE_FIVEDIMINTERACTEMITTERCONFIG_METHOD_3_DF539A0ABF2224D0_OFFSET UNITYSDK_OFFSET(0x1720B890)
#define RPG_GAMECORE_FIVEDIMINTERACTEMITTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1720B8E0)
