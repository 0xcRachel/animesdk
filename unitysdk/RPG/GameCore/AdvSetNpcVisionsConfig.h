...
#define RPG_GAMECORE_ADVSETNPCVISIONSCONFIG_METHOD_3_8A07A59B8B3EAABE_OFFSET UNITYSDK_OFFSET(0x19BF4310)
#define RPG_GAMECORE_ADVSETNPCVISIONSCONFIG_METHOD_3_F8B7911C5DDE4CFA_OFFSET UNITYSDK_OFFSET(0x19BF4290)
#define RPG_GAMECORE_ADVSETNPCVISIONSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BF42E0)
