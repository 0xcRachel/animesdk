...
#define RPG_GAMECORE_ADVSETNPCVISIONSCONFIG_METHOD_3_78B86363FD76C534_OFFSET UNITYSDK_OFFSET(0x16848FF0)
#define RPG_GAMECORE_ADVSETNPCVISIONSCONFIG_METHOD_3_8D1F41B409F17CC4_OFFSET UNITYSDK_OFFSET(0x16849070)
#define RPG_GAMECORE_ADVSETNPCVISIONSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16849040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetNpcVisionsConfig_TypeDefinitionIndex = 17753;
