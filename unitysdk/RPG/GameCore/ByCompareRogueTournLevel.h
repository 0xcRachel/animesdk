...
#define RPG_GAMECORE_BYCOMPAREROGUETOURNLEVEL_METHOD_4_0B41E09874335DF3_OFFSET UNITYSDK_OFFSET(0x18FEBEC0)
#define RPG_GAMECORE_BYCOMPAREROGUETOURNLEVEL_METHOD_4_7D3B1E207CEEE0AA_OFFSET UNITYSDK_OFFSET(0x18FEBF90)
#define RPG_GAMECORE_BYCOMPAREROGUETOURNLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x18FEBF40)
