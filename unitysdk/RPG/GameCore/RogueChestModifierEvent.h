...
#define RPG_GAMECORE_ROGUECHESTMODIFIEREVENT_METHOD_2_345CA33702013629_OFFSET UNITYSDK_OFFSET(0x192461F0)
#define RPG_GAMECORE_ROGUECHESTMODIFIEREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19246480)
