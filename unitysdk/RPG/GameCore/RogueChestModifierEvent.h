...
#define RPG_GAMECORE_ROGUECHESTMODIFIEREVENT_METHOD_2_345CA33702013629_OFFSET UNITYSDK_OFFSET(0x16E20AC0)
#define RPG_GAMECORE_ROGUECHESTMODIFIEREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x16E20D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueChestModifierEvent_TypeDefinitionIndex = 16087;
