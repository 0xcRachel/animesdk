...
#define RPG_GAMECORE_TRAINPARTYCARDEFFECTCONFIG_METHOD_2_4968D65E0325ED76_OFFSET UNITYSDK_OFFSET(0x17102190)
#define RPG_GAMECORE_TRAINPARTYCARDEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17102290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyCardEffectConfig_TypeDefinitionIndex = 16220;
