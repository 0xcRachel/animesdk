...
#define RPG_GAMECORE_SETFIVEDIMIGNORECOLLISIONTARGET_METHOD_3_17147E63935AFABB_OFFSET UNITYSDK_OFFSET(0x16F2C830)
#define RPG_GAMECORE_SETFIVEDIMIGNORECOLLISIONTARGET_METHOD_3_4F9BB3B39E2BB528_OFFSET UNITYSDK_OFFSET(0x16F2C7B0)
#define RPG_GAMECORE_SETFIVEDIMIGNORECOLLISIONTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x16F2C800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFiveDimIgnoreCollisionTarget_TypeDefinitionIndex = 19056;
