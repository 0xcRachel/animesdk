...
#define RPG_GAMECORE_ADVENTURESETATTACKTARGETWITHOUTBATTLE_METHOD_3_6F420CA0942F9CAE_OFFSET UNITYSDK_OFFSET(0x18C74C50)
#define RPG_GAMECORE_ADVENTURESETATTACKTARGETWITHOUTBATTLE_METHOD_3_B40491D83480E3DF_OFFSET UNITYSDK_OFFSET(0x18C74CD0)
#define RPG_GAMECORE_ADVENTURESETATTACKTARGETWITHOUTBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C74CA0)
