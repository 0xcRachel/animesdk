...
#define RPG_GAMECORE_FIVEDIMANIMATORSTATELISTENERCONFIG_METHOD_3_A167659DAB2888AE_OFFSET UNITYSDK_OFFSET(0x16AAB5C0)
#define RPG_GAMECORE_FIVEDIMANIMATORSTATELISTENERCONFIG_METHOD_3_F445F653D695AC0D_OFFSET UNITYSDK_OFFSET(0x16AAB630)
#define RPG_GAMECORE_FIVEDIMANIMATORSTATELISTENERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16AAB610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimAnimatorStateListenerConfig_TypeDefinitionIndex = 16730;
