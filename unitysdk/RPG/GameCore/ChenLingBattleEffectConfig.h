...
#define RPG_GAMECORE_CHENLINGBATTLEEFFECTCONFIG_METHOD_2_69C4CAE422465EF3_OFFSET UNITYSDK_OFFSET(0x1969BD00)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1969EB30)
