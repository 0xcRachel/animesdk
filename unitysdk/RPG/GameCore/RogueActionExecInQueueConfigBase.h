...
#define RPG_GAMECORE_ROGUEACTIONEXECINQUEUECONFIGBASE_METHOD_6_B45B661BC6CD68FF_OFFSET UNITYSDK_OFFSET(0x1A9C8980)
#define RPG_GAMECORE_ROGUEACTIONEXECINQUEUECONFIGBASE_METHOD_6_BE89E5CB00455A2A_OFFSET UNITYSDK_OFFSET(0x1A9C74C0)
#define RPG_GAMECORE_ROGUEACTIONEXECINQUEUECONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9C73E0)
