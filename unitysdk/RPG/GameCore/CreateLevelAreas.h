...
#define RPG_GAMECORE_CREATELEVELAREAS_METHOD_3_EC5E4F917F0BE291_OFFSET UNITYSDK_OFFSET(0x17150740)
#define RPG_GAMECORE_CREATELEVELAREAS_METHOD_3_FE83C95243BA8048_OFFSET UNITYSDK_OFFSET(0x171506C0)
#define RPG_GAMECORE_CREATELEVELAREAS__CTOR_OFFSET UNITYSDK_OFFSET(0x17150710)
