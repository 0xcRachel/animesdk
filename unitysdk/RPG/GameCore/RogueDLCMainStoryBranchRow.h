...
#define RPG_GAMECORE_ROGUEDLCMAINSTORYBRANCHROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16E75460)
#define RPG_GAMECORE_ROGUEDLCMAINSTORYBRANCHROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16E755D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDLCMainStoryBranchRow_TypeDefinitionIndex = 13447;
