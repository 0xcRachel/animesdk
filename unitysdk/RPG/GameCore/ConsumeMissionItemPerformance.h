...
#define RPG_GAMECORE_CONSUMEMISSIONITEMPERFORMANCE_METHOD_3_10E2BE5BBA1C301F_OFFSET UNITYSDK_OFFSET(0x169CBFB0)
#define RPG_GAMECORE_CONSUMEMISSIONITEMPERFORMANCE_METHOD_3_9F74E7D99C106BDD_OFFSET UNITYSDK_OFFSET(0x169CBF30)
#define RPG_GAMECORE_CONSUMEMISSIONITEMPERFORMANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x169CBF80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConsumeMissionItemPerformance_TypeDefinitionIndex = 18227;
