...
#define RPG_GAMECORE_LEVELTRIGGERINFO_METHOD_2_E3A1B396FF2353A2_OFFSET UNITYSDK_OFFSET(0x18A325F0)
#define RPG_GAMECORE_LEVELTRIGGERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18A435A0)
