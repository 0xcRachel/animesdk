...
#define RPG_GAMECORE_PLAYERROOMSUBAREACONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19365C80)
#define RPG_GAMECORE_PLAYERROOMSUBAREACONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19365E80)
