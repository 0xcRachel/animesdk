...
#define RPG_GAMECORE_TREASUREDUNGEONGROUPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19A36B70)
#define RPG_GAMECORE_TREASUREDUNGEONGROUPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19A37090)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 DEFMazeBuffID; // 0x38
		::System::UInt32 HpConversionRate2; // 0x3C
		::System::UInt32 DEFExchangeRatio; // 0x40
		::System::UInt32 ATKMazeBuffID; // 0x44
		::System::UInt32 MaxDEF; // 0x48
		::System::UInt32 GroupID; // 0x4C
		::RPG::Client::TextID Name; // 0x50
		::System::UInt32 MaxATK; // 0x60
		::System::UInt32 ActivityModuleID; // 0x64
		::System::UInt32 ATKExchangeRatio; // 0x68
		::System::UInt32 HpConversionRate; // 0x6C
