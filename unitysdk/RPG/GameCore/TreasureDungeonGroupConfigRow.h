...
#define RPG_GAMECORE_TREASUREDUNGEONGROUPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x178CFFE0)
#define RPG_GAMECORE_TREASUREDUNGEONGROUPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x178D0500)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 DEFMazeBuffID; // 0x2C
		::System::UInt32 DEFExchangeRatio; // 0x30
		::System::UInt32 HpConversionRate; // 0x34
		::RPG::Client::TextID Name; // 0x38
		::RPG::Client::TextID ATKExchangeName; // 0x48
		::System::UInt32 ATKExchangeRatio; // 0x58
		::System::UInt32 MaxATK; // 0x5C
		::System::UInt32 MaxDEF; // 0x60
		::System::UInt32 ActivityModuleID; // 0x64
		::System::UInt32 ATKMazeBuffID; // 0x68
