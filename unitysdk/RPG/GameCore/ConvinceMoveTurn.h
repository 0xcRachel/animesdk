...
#define RPG_GAMECORE_CONVINCEMOVETURN_METHOD_3_9A972AE33E6794EF_OFFSET UNITYSDK_OFFSET(0x1714BBF0)
#define RPG_GAMECORE_CONVINCEMOVETURN_METHOD_3_C834424611D0DA4E_OFFSET UNITYSDK_OFFSET(0x1714BB70)
#define RPG_GAMECORE_CONVINCEMOVETURN__CTOR_OFFSET UNITYSDK_OFFSET(0x1714BBC0)
