...
#define RPG_GAMECORE_BYPAMANCHORCONTINOUS_METHOD_4_2B1C9D3AD35BE951_OFFSET UNITYSDK_OFFSET(0x19DB9E70)
#define RPG_GAMECORE_BYPAMANCHORCONTINOUS_METHOD_4_B0A23C6EC4FC15F4_OFFSET UNITYSDK_OFFSET(0x19DBA100)
#define RPG_GAMECORE_BYPAMANCHORCONTINOUS_METHOD_4_B61411D24DA6E94B_OFFSET UNITYSDK_OFFSET(0x19DB9F40)
#define RPG_GAMECORE_BYPAMANCHORCONTINOUS_METHOD_4_B89C7DD843AED29C_OFFSET UNITYSDK_OFFSET(0x19DBA080)
#define RPG_GAMECORE_BYPAMANCHORCONTINOUS__CTOR_OFFSET UNITYSDK_OFFSET(0x19DB9EF0)
