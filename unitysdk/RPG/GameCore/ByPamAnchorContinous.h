...
#define RPG_GAMECORE_BYPAMANCHORCONTINOUS_METHOD_4_2B1C9D3AD35BE951_OFFSET UNITYSDK_OFFSET(0x1704B9B0)
#define RPG_GAMECORE_BYPAMANCHORCONTINOUS_METHOD_4_B61411D24DA6E94B_OFFSET UNITYSDK_OFFSET(0x1704BA80)
#define RPG_GAMECORE_BYPAMANCHORCONTINOUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1704BA30)
