...
#define RPG_GAMECORE_LOCKUISKILLOPERATION_METHOD_3_612AF95655B871DD_OFFSET UNITYSDK_OFFSET(0x18FCAF10)
#define RPG_GAMECORE_LOCKUISKILLOPERATION_METHOD_3_E7CC9913C40B98AF_OFFSET UNITYSDK_OFFSET(0x18FCAE90)
#define RPG_GAMECORE_LOCKUISKILLOPERATION__CTOR_OFFSET UNITYSDK_OFFSET(0x18FCAEE0)
