...
#define RPG_GAMECORE_LOCKUISKILLOPERATION_METHOD_3_612AF95655B871DD_OFFSET UNITYSDK_OFFSET(0x16BDD460)
#define RPG_GAMECORE_LOCKUISKILLOPERATION_METHOD_3_E7CC9913C40B98AF_OFFSET UNITYSDK_OFFSET(0x16BDD3E0)
#define RPG_GAMECORE_LOCKUISKILLOPERATION__CTOR_OFFSET UNITYSDK_OFFSET(0x16BDD430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockUISkillOperation_TypeDefinitionIndex = 21294;
