...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::ModifyCalcOpType>**)Il2CppClass::FromTypeDefinitionIndex(GridFightRankSkillModifyConfigRow___O_TypeDefinitionIndex)->GetStaticField(0x34F90);
		}
	};
}
