...
#define RPG_GAMECORE_TARGETMAPSKILLACTUALATTACKER_METHOD_3_619A10B54563F4CF_OFFSET UNITYSDK_OFFSET(0x16FE3070)
#define RPG_GAMECORE_TARGETMAPSKILLACTUALATTACKER_METHOD_3_97B20532A9D3B542_OFFSET UNITYSDK_OFFSET(0x16FE2FB0)
#define RPG_GAMECORE_TARGETMAPSKILLACTUALATTACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE3050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapSkillActualAttacker_TypeDefinitionIndex = 21665;
