...
#define RPG_GAMECORE_EVOLVEGEARTYPECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16A861D0)
#define RPG_GAMECORE_EVOLVEGEARTYPECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16A869C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EvolveGearTypeConfigRow_TypeDefinitionIndex = 10600;
	...
	public:
		...
		::System::String* TypeImgColor; // 0x30
