...
#define RPG_GAMECORE_SETADVEFFECTTOANCHOR_METHOD_3_5217C84EA27847E4_OFFSET UNITYSDK_OFFSET(0x192EAF80)
#define RPG_GAMECORE_SETADVEFFECTTOANCHOR_METHOD_3_7151B77C6732CA73_OFFSET UNITYSDK_OFFSET(0x192EAF00)
#define RPG_GAMECORE_SETADVEFFECTTOANCHOR__CTOR_OFFSET UNITYSDK_OFFSET(0x192EAF50)
