...
#define RPG_GAMECORE_BYISSPLITDAMAGE_METHOD_4_38F7785594035B34_OFFSET UNITYSDK_OFFSET(0x16935BF0)
#define RPG_GAMECORE_BYISSPLITDAMAGE_METHOD_4_D0F453910F8CA67A_OFFSET UNITYSDK_OFFSET(0x16935CC0)
#define RPG_GAMECORE_BYISSPLITDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16935C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsSplitDamage_TypeDefinitionIndex = 20666;
