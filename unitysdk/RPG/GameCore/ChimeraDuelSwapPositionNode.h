...
#define RPG_GAMECORE_CHIMERADUELSWAPPOSITIONNODE_METHOD_3_1F4E42CB5E5B1B1E_OFFSET UNITYSDK_OFFSET(0x194C9000)
#define RPG_GAMECORE_CHIMERADUELSWAPPOSITIONNODE_METHOD_3_B658D4E04E2A7F2D_OFFSET UNITYSDK_OFFSET(0x194C90E0)
#define RPG_GAMECORE_CHIMERADUELSWAPPOSITIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x194C9090)
