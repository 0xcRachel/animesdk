...
#define RPG_GAMECORE_CHIMERADUELEFFECTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1698C750)
#define RPG_GAMECORE_CHIMERADUELEFFECTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1698CA30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEffectRow_TypeDefinitionIndex = 10332;

	class ChimeraDuelEffectRow : public ::System::Object
	{
	public:
		::RPG::GameCore::ChimeraDuelServerEffectType EffectType; // 0x10
