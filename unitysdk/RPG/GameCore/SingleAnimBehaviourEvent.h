...
#define RPG_GAMECORE_SINGLEANIMBEHAVIOUREVENT_METHOD_2_AD66AD3B7A3EE045_OFFSET UNITYSDK_OFFSET(0x16F69350)
#define RPG_GAMECORE_SINGLEANIMBEHAVIOUREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F69470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SingleAnimBehaviourEvent_TypeDefinitionIndex = 14657;
