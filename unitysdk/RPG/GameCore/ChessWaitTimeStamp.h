...
#define RPG_GAMECORE_CHESSWAITTIMESTAMP_METHOD_3_D2C6D7F987DEE92F_OFFSET UNITYSDK_OFFSET(0x16981D20)
#define RPG_GAMECORE_CHESSWAITTIMESTAMP_METHOD_3_E6894C793E3D5802_OFFSET UNITYSDK_OFFSET(0x16981E40)
#define RPG_GAMECORE_CHESSWAITTIMESTAMP__CTOR_OFFSET UNITYSDK_OFFSET(0x16981DC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChessWaitTimeStamp_TypeDefinitionIndex = 21425;
