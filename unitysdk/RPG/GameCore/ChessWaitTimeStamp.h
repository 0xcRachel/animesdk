...
#define RPG_GAMECORE_CHESSWAITTIMESTAMP_METHOD_3_D2C6D7F987DEE92F_OFFSET UNITYSDK_OFFSET(0x170A4110)
#define RPG_GAMECORE_CHESSWAITTIMESTAMP_METHOD_3_E6894C793E3D5802_OFFSET UNITYSDK_OFFSET(0x170A4230)
#define RPG_GAMECORE_CHESSWAITTIMESTAMP__CTOR_OFFSET UNITYSDK_OFFSET(0x170A41B0)
