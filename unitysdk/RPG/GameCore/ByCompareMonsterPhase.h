...
#define RPG_GAMECORE_BYCOMPAREMONSTERPHASE_METHOD_4_358A9082585CCE79_OFFSET UNITYSDK_OFFSET(0x16912D90)
#define RPG_GAMECORE_BYCOMPAREMONSTERPHASE_METHOD_4_8302E96295AE8DDF_OFFSET UNITYSDK_OFFSET(0x16912EB0)
#define RPG_GAMECORE_BYCOMPAREMONSTERPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x16912E30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareMonsterPhase_TypeDefinitionIndex = 20206;
