...
#define RPG_GAMECORE_CHIMERADUELSUMVALUEGETTER_METHOD_3_2460DA1872717B8E_OFFSET UNITYSDK_OFFSET(0x170BAE90)
#define RPG_GAMECORE_CHIMERADUELSUMVALUEGETTER_METHOD_3_C19DC776C3D751C6_OFFSET UNITYSDK_OFFSET(0x170BAEF0)
#define RPG_GAMECORE_CHIMERADUELSUMVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x170BAEE0)
