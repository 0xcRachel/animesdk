...
#define RPG_GAMECORE_CHIMERADUELSUMVALUEGETTER_METHOD_3_2460DA1872717B8E_OFFSET UNITYSDK_OFFSET(0x16998F80)
#define RPG_GAMECORE_CHIMERADUELSUMVALUEGETTER_METHOD_3_C19DC776C3D751C6_OFFSET UNITYSDK_OFFSET(0x16998FE0)
#define RPG_GAMECORE_CHIMERADUELSUMVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x16998FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelSumValueGetter_TypeDefinitionIndex = 14434;
