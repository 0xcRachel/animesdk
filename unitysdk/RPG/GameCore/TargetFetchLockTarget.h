...
#define RPG_GAMECORE_TARGETFETCHLOCKTARGET_METHOD_3_CBD3DA7263F30DAD_OFFSET UNITYSDK_OFFSET(0x16FDDE10)
#define RPG_GAMECORE_TARGETFETCHLOCKTARGET_METHOD_3_E4A868C7EE90FDF8_OFFSET UNITYSDK_OFFSET(0x16FDDD50)
#define RPG_GAMECORE_TARGETFETCHLOCKTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x16FDDDF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchLockTarget_TypeDefinitionIndex = 21678;
