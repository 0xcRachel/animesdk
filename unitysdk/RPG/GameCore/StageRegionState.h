...
#define RPG_GAMECORE_STAGEREGIONSTATE_METHOD_2_34063431D233EDCE_OFFSET UNITYSDK_OFFSET(0x16F8BA00)
#define RPG_GAMECORE_STAGEREGIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F8BAE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StageRegionState_TypeDefinitionIndex = 17199;
