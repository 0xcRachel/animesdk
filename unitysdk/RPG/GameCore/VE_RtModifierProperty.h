...
#define RPG_GAMECORE_VE_RTMODIFIERPROPERTY_METHOD_3_5FAB3772DB403941_OFFSET UNITYSDK_OFFSET(0x1951CC80)
#define RPG_GAMECORE_VE_RTMODIFIERPROPERTY_METHOD_3_747086FD16A110BE_OFFSET UNITYSDK_OFFSET(0x1951CD20)
#define RPG_GAMECORE_VE_RTMODIFIERPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1951CCE0)
