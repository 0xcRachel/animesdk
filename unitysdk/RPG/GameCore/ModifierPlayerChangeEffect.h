...
#define RPG_GAMECORE_MODIFIERPLAYERCHANGEEFFECT_METHOD_3_65F446DB51D703AF_OFFSET UNITYSDK_OFFSET(0x1743CAB0)
#define RPG_GAMECORE_MODIFIERPLAYERCHANGEEFFECT_METHOD_3_F159647A5247B37D_OFFSET UNITYSDK_OFFSET(0x1743CB30)
#define RPG_GAMECORE_MODIFIERPLAYERCHANGEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1743CB00)
