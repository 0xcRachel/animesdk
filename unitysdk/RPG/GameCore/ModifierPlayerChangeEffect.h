...
#define RPG_GAMECORE_MODIFIERPLAYERCHANGEEFFECT_METHOD_3_0756FD568647D385_OFFSET UNITYSDK_OFFSET(0x196A4A30)
#define RPG_GAMECORE_MODIFIERPLAYERCHANGEEFFECT_METHOD_3_4919FBEF5362B0CA_OFFSET UNITYSDK_OFFSET(0x196A4AB0)
#define RPG_GAMECORE_MODIFIERPLAYERCHANGEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x196A4A80)
