...
#define RPG_GAMECORE_SETPHAINONCHARGEPOINT_METHOD_3_D23EB9774B07F170_OFFSET UNITYSDK_OFFSET(0x16F3A080)
#define RPG_GAMECORE_SETPHAINONCHARGEPOINT_METHOD_3_DFB3350920B77EC0_OFFSET UNITYSDK_OFFSET(0x16F3A000)
#define RPG_GAMECORE_SETPHAINONCHARGEPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F3A050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetPhainonChargePoint_TypeDefinitionIndex = 20837;
