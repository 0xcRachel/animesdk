...
#define RPG_GAMECORE_TARGETMAPSKILLTARGET_METHOD_3_1C7DD83CF5861EDC_OFFSET UNITYSDK_OFFSET(0x16FE3610)
#define RPG_GAMECORE_TARGETMAPSKILLTARGET_METHOD_3_D968C77241804C90_OFFSET UNITYSDK_OFFSET(0x16FE3500)
#define RPG_GAMECORE_TARGETMAPSKILLTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE35F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapSkillTarget_TypeDefinitionIndex = 21735;
