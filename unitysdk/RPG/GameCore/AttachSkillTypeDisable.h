...
#define RPG_GAMECORE_ATTACHSKILLTYPEDISABLE_METHOD_3_096F0AA49E94B76A_OFFSET UNITYSDK_OFFSET(0x168918E0)
#define RPG_GAMECORE_ATTACHSKILLTYPEDISABLE_METHOD_3_AEF2DC8178207CEF_OFFSET UNITYSDK_OFFSET(0x16891960)
#define RPG_GAMECORE_ATTACHSKILLTYPEDISABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16891930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AttachSkillTypeDisable_TypeDefinitionIndex = 21286;
