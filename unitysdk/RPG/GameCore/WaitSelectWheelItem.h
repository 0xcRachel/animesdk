...
#define RPG_GAMECORE_WAITSELECTWHEELITEM_METHOD_3_0EA01971DF9E0B60_OFFSET UNITYSDK_OFFSET(0x1715C480)
#define RPG_GAMECORE_WAITSELECTWHEELITEM_METHOD_3_E10B459EB601228B_OFFSET UNITYSDK_OFFSET(0x1715C500)
#define RPG_GAMECORE_WAITSELECTWHEELITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1715C4D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitSelectWheelItem_TypeDefinitionIndex = 21758;
