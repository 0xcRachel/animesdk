...
#define RPG_GAMECORE_SETBPSORTTYPE_METHOD_3_C637EA2B98BAF4B1_OFFSET UNITYSDK_OFFSET(0x176BCDC0)
#define RPG_GAMECORE_SETBPSORTTYPE_METHOD_3_D520E46724985372_OFFSET UNITYSDK_OFFSET(0x176BCD40)
#define RPG_GAMECORE_SETBPSORTTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x176BCD90)
