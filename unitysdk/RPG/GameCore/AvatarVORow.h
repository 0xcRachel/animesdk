...
#define RPG_GAMECORE_AVATARVOROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18222690)
#define RPG_GAMECORE_AVATARVOROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18222E10)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 ActionBegin; // 0x18
