...
#define RPG_GAMECORE_AVATARVOROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16FD2F90)
#define RPG_GAMECORE_AVATARVOROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD3710)
