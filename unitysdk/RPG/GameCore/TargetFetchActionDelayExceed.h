...
#define RPG_GAMECORE_TARGETFETCHACTIONDELAYEXCEED_METHOD_4_1E9DFBC8FCE1D1C5_OFFSET UNITYSDK_OFFSET(0x199D5220)
#define RPG_GAMECORE_TARGETFETCHACTIONDELAYEXCEED_METHOD_4_989FF27FCCA724D3_OFFSET UNITYSDK_OFFSET(0x199DE9D0)
#define RPG_GAMECORE_TARGETFETCHACTIONDELAYEXCEED__CTOR_OFFSET UNITYSDK_OFFSET(0x199D51D0)
