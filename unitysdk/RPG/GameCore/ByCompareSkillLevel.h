...
#define RPG_GAMECORE_BYCOMPARESKILLLEVEL_METHOD_4_274C396221783239_OFFSET UNITYSDK_OFFSET(0x19AD19B0)
#define RPG_GAMECORE_BYCOMPARESKILLLEVEL_METHOD_4_ADB6F07CC92DF2DD_OFFSET UNITYSDK_OFFSET(0x19AD1AD0)
#define RPG_GAMECORE_BYCOMPARESKILLLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD1A50)
