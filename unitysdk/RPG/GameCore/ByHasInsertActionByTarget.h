...
#define RPG_GAMECORE_BYHASINSERTACTIONBYTARGET_METHOD_4_55243860A8251F75_OFFSET UNITYSDK_OFFSET(0x16926EE0)
#define RPG_GAMECORE_BYHASINSERTACTIONBYTARGET_METHOD_4_847C13705A240B12_OFFSET UNITYSDK_OFFSET(0x16927000)
#define RPG_GAMECORE_BYHASINSERTACTIONBYTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x16926F80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHasInsertActionByTarget_TypeDefinitionIndex = 20207;
