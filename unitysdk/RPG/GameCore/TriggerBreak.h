...
#define RPG_GAMECORE_TRIGGERBREAK_METHOD_3_2A174A0DEDEBF1B1_OFFSET UNITYSDK_OFFSET(0x17118770)
#define RPG_GAMECORE_TRIGGERBREAK_METHOD_3_C5210B5A7832D7DD_OFFSET UNITYSDK_OFFSET(0x171186E0)
#define RPG_GAMECORE_TRIGGERBREAK__CTOR_OFFSET UNITYSDK_OFFSET(0x17118740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerBreak_TypeDefinitionIndex = 20355;
