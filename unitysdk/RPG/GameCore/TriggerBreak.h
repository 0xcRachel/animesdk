...
#define RPG_GAMECORE_TRIGGERBREAK_METHOD_3_2A174A0DEDEBF1B1_OFFSET UNITYSDK_OFFSET(0x19A3B270)
#define RPG_GAMECORE_TRIGGERBREAK_METHOD_3_C5210B5A7832D7DD_OFFSET UNITYSDK_OFFSET(0x19A3B1E0)
#define RPG_GAMECORE_TRIGGERBREAK__CTOR_OFFSET UNITYSDK_OFFSET(0x19A3B240)
