...
#define RPG_GAMECORE_SETFLOORCUSTOMFLOAT_METHOD_3_939F97F1592F9EFB_OFFSET UNITYSDK_OFFSET(0x16F2DB10)
#define RPG_GAMECORE_SETFLOORCUSTOMFLOAT_METHOD_3_D7FDC0C14521E232_OFFSET UNITYSDK_OFFSET(0x16F2DB90)
#define RPG_GAMECORE_SETFLOORCUSTOMFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F2DB60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFloorCustomFloat_TypeDefinitionIndex = 18489;
