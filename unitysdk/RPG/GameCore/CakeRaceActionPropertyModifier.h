...
#define RPG_GAMECORE_CAKERACEACTIONPROPERTYMODIFIER_METHOD_3_1F8F9C41C3D4E2EB_OFFSET UNITYSDK_OFFSET(0x1705AEC0)
#define RPG_GAMECORE_CAKERACEACTIONPROPERTYMODIFIER_METHOD_3_78F4C3B6089F9118_OFFSET UNITYSDK_OFFSET(0x17059730)
#define RPG_GAMECORE_CAKERACEACTIONPROPERTYMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x17059710)
