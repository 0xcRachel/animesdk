...
#define RPG_GAMECORE_ADVPASSBYVALUECLIENTSERVER_METHOD_3_0B35E6AF6010E561_OFFSET UNITYSDK_OFFSET(0x18C55010)
#define RPG_GAMECORE_ADVPASSBYVALUECLIENTSERVER_METHOD_3_EE1AFB0521C055F3_OFFSET UNITYSDK_OFFSET(0x18C54F90)
#define RPG_GAMECORE_ADVPASSBYVALUECLIENTSERVER__CTOR_OFFSET UNITYSDK_OFFSET(0x18C54FE0)
