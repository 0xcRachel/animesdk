...
#define RPG_GAMECORE_MAPROTATIONMONSTEREFFECTCONFIG_METHOD_3_51717C95712572EE_OFFSET UNITYSDK_OFFSET(0x19C28C30)
#define RPG_GAMECORE_MAPROTATIONMONSTEREFFECTCONFIG_METHOD_3_C3C9F529B0051BB3_OFFSET UNITYSDK_OFFSET(0x19C29720)
#define RPG_GAMECORE_MAPROTATIONMONSTEREFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19C28C20)
