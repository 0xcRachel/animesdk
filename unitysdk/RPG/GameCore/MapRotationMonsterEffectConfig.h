...
#define RPG_GAMECORE_MAPROTATIONMONSTEREFFECTCONFIG_METHOD_3_40639F56AC724200_OFFSET UNITYSDK_OFFSET(0x16C2F730)
#define RPG_GAMECORE_MAPROTATIONMONSTEREFFECTCONFIG_METHOD_3_DB14B751812311E5_OFFSET UNITYSDK_OFFSET(0x16C30290)
#define RPG_GAMECORE_MAPROTATIONMONSTEREFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16C2F720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MapRotationMonsterEffectConfig_TypeDefinitionIndex = 15338;
