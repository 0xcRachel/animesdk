...
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONCHENLINGTRIBEDROPPOINTINFO_METHOD_2_EC8589995696CC46_OFFSET UNITYSDK_OFFSET(0x16BB76C0)
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONCHENLINGTRIBEDROPPOINTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16BB7810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPedestrianV2IntersectionChenLingTribeDropPointInfo_TypeDefinitionIndex = 15623;
