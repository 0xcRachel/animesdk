...
#define RPG_GAMECORE_SHADERTESTPRELOADCONFIG_METHOD_2_DDDB4B2D77142F3B_OFFSET UNITYSDK_OFFSET(0x177005D0)
#define RPG_GAMECORE_SHADERTESTPRELOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x177007B0)
