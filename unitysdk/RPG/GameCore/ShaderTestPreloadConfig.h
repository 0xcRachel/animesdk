...
#define RPG_GAMECORE_SHADERTESTPRELOADCONFIG_METHOD_2_DDDB4B2D77142F3B_OFFSET UNITYSDK_OFFSET(0x16F4B120)
#define RPG_GAMECORE_SHADERTESTPRELOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F4B300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShaderTestPreloadConfig_TypeDefinitionIndex = 14714;
