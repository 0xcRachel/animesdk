...
#define RPG_GAMECORE_TICKLODCONFIG_METHOD_3_4539F88016B3E011_OFFSET UNITYSDK_OFFSET(0x170F2040)
#define RPG_GAMECORE_TICKLODCONFIG_METHOD_3_9C200645AE464E44_OFFSET UNITYSDK_OFFSET(0x170F2080)
#define RPG_GAMECORE_TICKLODCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x170F2070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TickLodConfig_TypeDefinitionIndex = 17224;
