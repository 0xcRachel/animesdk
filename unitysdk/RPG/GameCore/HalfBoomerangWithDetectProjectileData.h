...
#define RPG_GAMECORE_HALFBOOMERANGWITHDETECTPROJECTILEDATA_METHOD_3_06A393563B5D0867_OFFSET UNITYSDK_OFFSET(0x16B599B0)
#define RPG_GAMECORE_HALFBOOMERANGWITHDETECTPROJECTILEDATA_METHOD_3_3A29A4FC1EA95037_OFFSET UNITYSDK_OFFSET(0x16B59A20)
#define RPG_GAMECORE_HALFBOOMERANGWITHDETECTPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16B59A00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HalfBoomerangWithDetectProjectileData_TypeDefinitionIndex = 14242;
