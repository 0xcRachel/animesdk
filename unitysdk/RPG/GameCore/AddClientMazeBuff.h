...
#define RPG_GAMECORE_ADDCLIENTMAZEBUFF_METHOD_4_5F13EE78D95072C9_OFFSET UNITYSDK_OFFSET(0x167B8E10)
#define RPG_GAMECORE_ADDCLIENTMAZEBUFF_METHOD_4_C54A77845BD73C9C_OFFSET UNITYSDK_OFFSET(0x167B8E90)
#define RPG_GAMECORE_ADDCLIENTMAZEBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x167B8E60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddClientMazeBuff_TypeDefinitionIndex = 19393;
