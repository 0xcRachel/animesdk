...
#define RPG_GAMECORE_ENTERGAMEFLOW_METHOD_3_A306605762AA5A6A_OFFSET UNITYSDK_OFFSET(0x19D7A880)
#define RPG_GAMECORE_ENTERGAMEFLOW_METHOD_3_D47FCF29810D6ADB_OFFSET UNITYSDK_OFFSET(0x19D7A900)
#define RPG_GAMECORE_ENTERGAMEFLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x19D7A8D0)
