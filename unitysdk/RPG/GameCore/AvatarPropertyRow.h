...
#define RPG_GAMECORE_AVATARPROPERTYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x168AE620)
#define RPG_GAMECORE_AVATARPROPERTYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x168B0130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarPropertyRow_TypeDefinitionIndex = 11562;
	...
	public:
		...
		::RPG::Client::TextID PropertyNameSkillTree; // 0x20
		::RPG::Client::TextID PropertyName; // 0x30
		::System::UInt32 SubRelicFilter; // 0x40
		::System::Boolean IsDisplay; // 0x44
		::System::Boolean isBattleDisplay; // 0x45
		::RPG::GameCore::AvatarPropertyType PropertyType; // 0x48
		::RPG::Client::TextID PropertyNameRelic; // 0x50
		::System::UInt32 PropertyClassify; // 0x60
