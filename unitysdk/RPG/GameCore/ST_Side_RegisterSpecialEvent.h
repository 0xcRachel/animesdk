...
#define RPG_GAMECORE_ST_SIDE_REGISTERSPECIALEVENT_METHOD_4_98103278129BB67E_OFFSET UNITYSDK_OFFSET(0x192DDDA0)
#define RPG_GAMECORE_ST_SIDE_REGISTERSPECIALEVENT_METHOD_4_D7442EF998285D53_OFFSET UNITYSDK_OFFSET(0x192DDE70)
#define RPG_GAMECORE_ST_SIDE_REGISTERSPECIALEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x192DDE20)
