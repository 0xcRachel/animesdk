...
#define RPG_GAMECORE_ST_SIDE_REGISTERSPECIALEVENT_METHOD_4_98103278129BB67E_OFFSET UNITYSDK_OFFSET(0x16EF8C00)
#define RPG_GAMECORE_ST_SIDE_REGISTERSPECIALEVENT_METHOD_4_D7442EF998285D53_OFFSET UNITYSDK_OFFSET(0x16EEB900)
#define RPG_GAMECORE_ST_SIDE_REGISTERSPECIALEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x16EEB8B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_RegisterSpecialEvent_TypeDefinitionIndex = 17899;
