...
#define RPG_GAMECORE_BOXINGCLUBPERFORMANCECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x168F9580)
#define RPG_GAMECORE_BOXINGCLUBPERFORMANCECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x168F9800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BoxingClubPerformanceConfigRow_TypeDefinitionIndex = 11726;
