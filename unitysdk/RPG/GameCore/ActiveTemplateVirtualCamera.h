...
#define RPG_GAMECORE_ACTIVETEMPLATEVIRTUALCAMERA_METHOD_3_C62A4034CFA70520_OFFSET UNITYSDK_OFFSET(0x1988FDE0)
#define RPG_GAMECORE_ACTIVETEMPLATEVIRTUALCAMERA_METHOD_3_D472540401E2D54E_OFFSET UNITYSDK_OFFSET(0x1988FE60)
#define RPG_GAMECORE_ACTIVETEMPLATEVIRTUALCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x1988FE30)
