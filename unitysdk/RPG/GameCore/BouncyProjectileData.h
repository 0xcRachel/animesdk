...
#define RPG_GAMECORE_BOUNCYPROJECTILEDATA_METHOD_3_2F466F8F3D1E0EDB_OFFSET UNITYSDK_OFFSET(0x168F3BA0)
#define RPG_GAMECORE_BOUNCYPROJECTILEDATA_METHOD_3_FA29FCF719090AB3_OFFSET UNITYSDK_OFFSET(0x168F3B30)
#define RPG_GAMECORE_BOUNCYPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x168F3B80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BouncyProjectileData_TypeDefinitionIndex = 14238;
