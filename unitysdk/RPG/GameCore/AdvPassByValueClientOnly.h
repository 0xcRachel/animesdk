...
#define RPG_GAMECORE_ADVPASSBYVALUECLIENTONLY_METHOD_3_2F3071B895341F70_OFFSET UNITYSDK_OFFSET(0x16841850)
#define RPG_GAMECORE_ADVPASSBYVALUECLIENTONLY_METHOD_3_754F55046253A528_OFFSET UNITYSDK_OFFSET(0x168418D0)
#define RPG_GAMECORE_ADVPASSBYVALUECLIENTONLY__CTOR_OFFSET UNITYSDK_OFFSET(0x168418A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvPassByValueClientOnly_TypeDefinitionIndex = 18312;
