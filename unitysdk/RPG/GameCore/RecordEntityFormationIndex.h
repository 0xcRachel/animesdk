...
#define RPG_GAMECORE_RECORDENTITYFORMATIONINDEX_METHOD_3_0048AFB8930ED401_OFFSET UNITYSDK_OFFSET(0x16DCDBA0)
#define RPG_GAMECORE_RECORDENTITYFORMATIONINDEX_METHOD_3_E17928DD86091BA8_OFFSET UNITYSDK_OFFSET(0x16DCDB20)
#define RPG_GAMECORE_RECORDENTITYFORMATIONINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x16DCDB70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RecordEntityFormationIndex_TypeDefinitionIndex = 21391;
