...
#define RPG_GAMECORE_RECORDENTITYFORMATIONINDEX_METHOD_3_0048AFB8930ED401_OFFSET UNITYSDK_OFFSET(0x1759AD10)
#define RPG_GAMECORE_RECORDENTITYFORMATIONINDEX_METHOD_3_E17928DD86091BA8_OFFSET UNITYSDK_OFFSET(0x1759AC90)
#define RPG_GAMECORE_RECORDENTITYFORMATIONINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1759ACE0)
