...
#define RPG_GAMECORE_ACHIEVEMENTDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x188588A0)
#define RPG_GAMECORE_ACHIEVEMENTDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18858FF0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID AchievementDesc; // 0x30
		::RPG::Client::TextID HideAchievementDesc; // 0x40
		::RPG::Client::TextID AchievementTitle; // 0x50
		::RPG::Client::TextID RecordText; // 0x60
		::RPG::Client::TextID AchievementDescPS; // 0x70
		::System::UInt32 QuestID; // 0x80
		::System::UInt32 Advance; // 0x84
		::RPG::Client::TextID AchievementTitlePS; // 0x88
		::RPG::GameCore::ShowType ShowType; // 0x98
		::RPG::GameCore::RecordType RecordType; // 0x9C
		::System::UInt32 AchievementID; // 0xA0
		::System::UInt32 SeriesID; // 0xA4
		::System::UInt32 ShowParamInt1; // 0xA8
