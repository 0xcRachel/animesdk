...
#define RPG_GAMECORE_ACHIEVEMENTDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16EA9CE0)
#define RPG_GAMECORE_ACHIEVEMENTDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16EAA430)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID AchievementDescPS; // 0x28
		::RPG::Client::TextID HideAchievementDesc; // 0x38
		::RPG::Client::TextID RecordText; // 0x48
		::RPG::Client::TextID AchievementTitle; // 0x58
		::System::UInt32 Advance; // 0x68
		::RPG::GameCore::RecordType RecordType; // 0x6C
		::System::UInt32 AchievementID; // 0x70
		::System::UInt32 SeriesID; // 0x74
		::System::UInt32 LinearQuestID; // 0x78
		::System::UInt32 ShowParamInt1; // 0x7C
		::RPG::GameCore::ShowType ShowType; // 0x80
		::RPG::Client::TextID AchievementDesc; // 0x88
		::RPG::Client::TextID AchievementTitlePS; // 0x98
