...
#define RPG_GAMECORE_CHIMERADUELENTITIESINTERSECTIONSELECTORCONFIG_METHOD_3_1B4E3A63F788679C_OFFSET UNITYSDK_OFFSET(0x1698D020)
#define RPG_GAMECORE_CHIMERADUELENTITIESINTERSECTIONSELECTORCONFIG_METHOD_3_7784055A96AF916C_OFFSET UNITYSDK_OFFSET(0x1698D080)
#define RPG_GAMECORE_CHIMERADUELENTITIESINTERSECTIONSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1698D070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEntitiesIntersectionSelectorConfig_TypeDefinitionIndex = 14357;
