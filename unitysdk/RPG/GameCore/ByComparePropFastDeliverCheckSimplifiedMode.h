...
#define RPG_GAMECORE_BYCOMPAREPROPFASTDELIVERCHECKSIMPLIFIEDMODE_METHOD_4_19E469E08181BF26_OFFSET UNITYSDK_OFFSET(0x169160D0)
#define RPG_GAMECORE_BYCOMPAREPROPFASTDELIVERCHECKSIMPLIFIEDMODE_METHOD_4_7B6AD898142B176C_OFFSET UNITYSDK_OFFSET(0x16916000)
#define RPG_GAMECORE_BYCOMPAREPROPFASTDELIVERCHECKSIMPLIFIEDMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x16916080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByComparePropFastDeliverCheckSimplifiedMode_TypeDefinitionIndex = 19798;
