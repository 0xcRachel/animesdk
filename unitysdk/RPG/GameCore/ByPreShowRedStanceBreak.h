...
#define RPG_GAMECORE_BYPRESHOWREDSTANCEBREAK_METHOD_4_3E96508C9E938521_OFFSET UNITYSDK_OFFSET(0x1693BB50)
#define RPG_GAMECORE_BYPRESHOWREDSTANCEBREAK_METHOD_4_8D2F77338456F54D_OFFSET UNITYSDK_OFFSET(0x1693BA80)
#define RPG_GAMECORE_BYPRESHOWREDSTANCEBREAK__CTOR_OFFSET UNITYSDK_OFFSET(0x1693BB00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByPreShowRedStanceBreak_TypeDefinitionIndex = 21210;
