...
#define RPG_GAMECORE_TRAINPARTYTAGCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17109470)
#define RPG_GAMECORE_TRAINPARTYTAGCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x171095F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyTagConfigRow_TypeDefinitionIndex = 13965;
