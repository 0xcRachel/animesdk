...
#define RPG_GAMECORE_TRAINPARTYTAGCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x178C5450)
#define RPG_GAMECORE_TRAINPARTYTAGCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x178C55D0)
