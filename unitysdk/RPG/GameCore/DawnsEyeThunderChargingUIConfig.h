...
#define RPG_GAMECORE_DAWNSEYETHUNDERCHARGINGUICONFIG_METHOD_3_77522EFB768F2347_OFFSET UNITYSDK_OFFSET(0x169E40F0)
#define RPG_GAMECORE_DAWNSEYETHUNDERCHARGINGUICONFIG_METHOD_3_CA9167AC61961E8D_OFFSET UNITYSDK_OFFSET(0x169E41F0)
#define RPG_GAMECORE_DAWNSEYETHUNDERCHARGINGUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x169E41E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DawnsEyeThunderChargingUIConfig_TypeDefinitionIndex = 20443;
