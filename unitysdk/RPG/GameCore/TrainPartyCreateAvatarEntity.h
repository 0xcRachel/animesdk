...
#define RPG_GAMECORE_TRAINPARTYCREATEAVATARENTITY_METHOD_3_3AF55DC6707AEA4E_OFFSET UNITYSDK_OFFSET(0x194949C0)
#define RPG_GAMECORE_TRAINPARTYCREATEAVATARENTITY_METHOD_3_DCC8BC18A2E3EA28_OFFSET UNITYSDK_OFFSET(0x19494900)
#define RPG_GAMECORE_TRAINPARTYCREATEAVATARENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x19494970)
