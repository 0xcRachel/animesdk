...
#define RPG_GAMECORE_PREDICATETASKLISTWITHFAIL_METHOD_3_072AD0E25B0A6EB2_OFFSET UNITYSDK_OFFSET(0x1A2D0650)
#define RPG_GAMECORE_PREDICATETASKLISTWITHFAIL_METHOD_3_7A28C3E53CFDB510_OFFSET UNITYSDK_OFFSET(0x1A2D05D0)
#define RPG_GAMECORE_PREDICATETASKLISTWITHFAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2D0620)
