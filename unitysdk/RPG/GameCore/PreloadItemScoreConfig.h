...
#define RPG_GAMECORE_PRELOADITEMSCORECONFIG_METHOD_2_23FD47AA81CBD8B4_OFFSET UNITYSDK_OFFSET(0x17525DA0)
#define RPG_GAMECORE_PRELOADITEMSCORECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17525E70)
