...
#define RPG_GAMECORE_PRELOADITEMSCORECONFIG_METHOD_2_23FD47AA81CBD8B4_OFFSET UNITYSDK_OFFSET(0x16D9EC90)
#define RPG_GAMECORE_PRELOADITEMSCORECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16D9ED60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PreloadItemScoreConfig_TypeDefinitionIndex = 14731;
