...
#define RPG_GAMECORE_SUBSTAGEMETADATA_METHOD_2_1EF1AD321708FF9A_OFFSET UNITYSDK_OFFSET(0x198547D0)
#define RPG_GAMECORE_SUBSTAGEMETADATA_METHOD_2_4D7C7DA54803810F_OFFSET UNITYSDK_OFFSET(0x19854690)
#define RPG_GAMECORE_SUBSTAGEMETADATA__CTOR_OFFSET UNITYSDK_OFFSET(0x198547C0)
