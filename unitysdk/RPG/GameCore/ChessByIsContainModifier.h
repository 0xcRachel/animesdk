...
#define RPG_GAMECORE_CHESSBYISCONTAINMODIFIER_METHOD_4_0885DFC0BA0AA6A4_OFFSET UNITYSDK_OFFSET(0x1709F880)
#define RPG_GAMECORE_CHESSBYISCONTAINMODIFIER_METHOD_4_B4BECCF81EC8AE94_OFFSET UNITYSDK_OFFSET(0x1709F7B0)
#define RPG_GAMECORE_CHESSBYISCONTAINMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1709F830)
