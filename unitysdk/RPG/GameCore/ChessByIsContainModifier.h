...
#define RPG_GAMECORE_CHESSBYISCONTAINMODIFIER_METHOD_4_0885DFC0BA0AA6A4_OFFSET UNITYSDK_OFFSET(0x1697D3F0)
#define RPG_GAMECORE_CHESSBYISCONTAINMODIFIER_METHOD_4_B4BECCF81EC8AE94_OFFSET UNITYSDK_OFFSET(0x1697D320)
#define RPG_GAMECORE_CHESSBYISCONTAINMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1697D3A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChessByIsContainModifier_TypeDefinitionIndex = 21437;
