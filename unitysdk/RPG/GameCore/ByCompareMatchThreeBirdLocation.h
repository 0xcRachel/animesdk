...
#define RPG_GAMECORE_BYCOMPAREMATCHTHREEBIRDLOCATION_METHOD_4_50A89E2182EADD97_OFFSET UNITYSDK_OFFSET(0x16911880)
#define RPG_GAMECORE_BYCOMPAREMATCHTHREEBIRDLOCATION_METHOD_4_94599E0E08FF9385_OFFSET UNITYSDK_OFFSET(0x169117B0)
#define RPG_GAMECORE_BYCOMPAREMATCHTHREEBIRDLOCATION__CTOR_OFFSET UNITYSDK_OFFSET(0x16911830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareMatchThreeBirdLocation_TypeDefinitionIndex = 18791;
