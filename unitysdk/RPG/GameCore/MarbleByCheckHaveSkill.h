...
#define RPG_GAMECORE_MARBLEBYCHECKHAVESKILL_METHOD_4_009A7D9655C93644_OFFSET UNITYSDK_OFFSET(0x16C386B0)
#define RPG_GAMECORE_MARBLEBYCHECKHAVESKILL_METHOD_4_CB8C3CEC19B63116_OFFSET UNITYSDK_OFFSET(0x16C385D0)
#define RPG_GAMECORE_MARBLEBYCHECKHAVESKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x16C38660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleByCheckHaveSkill_TypeDefinitionIndex = 15205;
