...
#define RPG_GAMECORE_TUTORIALGUIDETEXTADAPTCONFIG_METHOD_2_40B705F7DA2C1C7D_OFFSET UNITYSDK_OFFSET(0x1912D6D0)
#define RPG_GAMECORE_TUTORIALGUIDETEXTADAPTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1912D9A0)
