...
#define RPG_GAMECORE_TARGETFETCHMAINMONSTER_METHOD_4_38110B36D68DB2C3_OFFSET UNITYSDK_OFFSET(0x199E1C10)
#define RPG_GAMECORE_TARGETFETCHMAINMONSTER_METHOD_4_658492D16D4E0975_OFFSET UNITYSDK_OFFSET(0x199DAF40)
#define RPG_GAMECORE_TARGETFETCHMAINMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x199DAEF0)
