...
#define RPG_GAMECORE_TAROTBOOKCHARACTERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1ACE6DB0)
#define RPG_GAMECORE_TAROTBOOKCHARACTERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACE72F0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID SubCatalogTitle; // 0x60
		::RPG::Client::TextID MainCatalogTitle; // 0x70
