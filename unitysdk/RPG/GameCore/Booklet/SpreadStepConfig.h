...
#define RPG_GAMECORE_BOOKLET_SPREADSTEPCONFIG_METHOD_2_F4472489FE641A3A_OFFSET UNITYSDK_OFFSET(0x168F0B30)
#define RPG_GAMECORE_BOOKLET_SPREADSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x168F1BF0)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int SpreadStepConfig_TypeDefinitionIndex = 22241;
