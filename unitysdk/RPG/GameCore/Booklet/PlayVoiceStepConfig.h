...
#define RPG_GAMECORE_BOOKLET_PLAYVOICESTEPCONFIG_METHOD_3_6F5F08CEA0B05D1B_OFFSET UNITYSDK_OFFSET(0x168F0DF0)
#define RPG_GAMECORE_BOOKLET_PLAYVOICESTEPCONFIG_METHOD_3_9D080F12030B1451_OFFSET UNITYSDK_OFFSET(0x168F0D90)
#define RPG_GAMECORE_BOOKLET_PLAYVOICESTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x168F0DE0)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int PlayVoiceStepConfig_TypeDefinitionIndex = 22251;
