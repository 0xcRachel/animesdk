...
#define RPG_GAMECORE_BOOKLET_PARALLELSTEPCONFIG_METHOD_3_8C2E079E2F03D321_OFFSET UNITYSDK_OFFSET(0x168F0C40)
#define RPG_GAMECORE_BOOKLET_PARALLELSTEPCONFIG_METHOD_3_A8163298E0BF48A9_OFFSET UNITYSDK_OFFSET(0x168F0CA0)
#define RPG_GAMECORE_BOOKLET_PARALLELSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x168F0C90)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int ParallelStepConfig_TypeDefinitionIndex = 22244;
