...
#define RPG_GAMECORE_BOOKLET_BOOKCONFIG_METHOD_2_D6D9F72E63B07C8A_OFFSET UNITYSDK_OFFSET(0x16FFF730)
#define RPG_GAMECORE_BOOKLET_BOOKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16FFF8F0)
