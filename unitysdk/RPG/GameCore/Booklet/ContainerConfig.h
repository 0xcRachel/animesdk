...
#define RPG_GAMECORE_BOOKLET_CONTAINERCONFIG_METHOD_3_18530C2DD9F0FDCF_OFFSET UNITYSDK_OFFSET(0x168EF340)
#define RPG_GAMECORE_BOOKLET_CONTAINERCONFIG_METHOD_3_2F1687E91A235D31_OFFSET UNITYSDK_OFFSET(0x168EEEA0)
#define RPG_GAMECORE_BOOKLET_CONTAINERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x168EF670)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int ContainerConfig_TypeDefinitionIndex = 22236;
