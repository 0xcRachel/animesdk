...
#define RPG_GAMECORE_BOOKLET_CATALOGPAGEELEMENTCONFIG_METHOD_3_AC96D8C3E03F14AC_OFFSET UNITYSDK_OFFSET(0x16FFF900)
#define RPG_GAMECORE_BOOKLET_CATALOGPAGEELEMENTCONFIG_METHOD_3_AEDA88A8E7CE2D52_OFFSET UNITYSDK_OFFSET(0x16FFF960)
#define RPG_GAMECORE_BOOKLET_CATALOGPAGEELEMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16FFF950)
