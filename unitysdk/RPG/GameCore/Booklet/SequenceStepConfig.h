...
#define RPG_GAMECORE_BOOKLET_SEQUENCESTEPCONFIG_METHOD_3_22A4882222332A63_OFFSET UNITYSDK_OFFSET(0x168F1230)
#define RPG_GAMECORE_BOOKLET_SEQUENCESTEPCONFIG_METHOD_3_5DFFEA4F047BE253_OFFSET UNITYSDK_OFFSET(0x168F1290)
#define RPG_GAMECORE_BOOKLET_SEQUENCESTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x168F1280)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int SequenceStepConfig_TypeDefinitionIndex = 22243;
