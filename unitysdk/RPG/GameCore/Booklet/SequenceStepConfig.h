...
#define RPG_GAMECORE_BOOKLET_SEQUENCESTEPCONFIG_METHOD_3_22A4882222332A63_OFFSET UNITYSDK_OFFSET(0x187C0920)
#define RPG_GAMECORE_BOOKLET_SEQUENCESTEPCONFIG_METHOD_3_5DFFEA4F047BE253_OFFSET UNITYSDK_OFFSET(0x187C0980)
#define RPG_GAMECORE_BOOKLET_SEQUENCESTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x187C0970)
