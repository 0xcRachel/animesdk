...
#define RPG_GAMECORE_ADDFINISHMISSIONDATA_CONSUMEITEM_METHOD_3_0F47F964318FB135_OFFSET UNITYSDK_OFFSET(0x18DB1A00)
#define RPG_GAMECORE_ADDFINISHMISSIONDATA_CONSUMEITEM_METHOD_3_EBD30C7C61E90F00_OFFSET UNITYSDK_OFFSET(0x18DB1A80)
#define RPG_GAMECORE_ADDFINISHMISSIONDATA_CONSUMEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x18DB1A50)
