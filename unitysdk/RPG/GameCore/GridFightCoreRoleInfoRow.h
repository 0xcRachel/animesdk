...
#define RPG_GAMECORE_GRIDFIGHTCOREROLEINFOROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B1E0B0)
#define RPG_GAMECORE_GRIDFIGHTCOREROLEINFOROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B1E2B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightCoreRoleInfoRow_TypeDefinitionIndex = 12453;
