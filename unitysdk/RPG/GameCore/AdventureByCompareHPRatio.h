...
#define RPG_GAMECORE_ADVENTUREBYCOMPAREHPRATIO_METHOD_4_8FCD9F464F17ACD0_OFFSET UNITYSDK_OFFSET(0x19BFD5F0)
#define RPG_GAMECORE_ADVENTUREBYCOMPAREHPRATIO_METHOD_4_A0D9337066444AEA_OFFSET UNITYSDK_OFFSET(0x19BFD220)
#define RPG_GAMECORE_ADVENTUREBYCOMPAREHPRATIO_METHOD_4_CF52A1AE8CF59AAB_OFFSET UNITYSDK_OFFSET(0x19BFD550)
#define RPG_GAMECORE_ADVENTUREBYCOMPAREHPRATIO_METHOD_4_D4C96B5DC56AE286_OFFSET UNITYSDK_OFFSET(0x19BFD340)
#define RPG_GAMECORE_ADVENTUREBYCOMPAREHPRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x19BFD2C0)
