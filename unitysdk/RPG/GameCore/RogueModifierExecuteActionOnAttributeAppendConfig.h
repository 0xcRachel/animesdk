...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONATTRIBUTEAPPENDCONFIG_METHOD_3_73C8842C588EAC16_OFFSET UNITYSDK_OFFSET(0x17643C10)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONATTRIBUTEAPPENDCONFIG_METHOD_3_EDE96BF414EB44FF_OFFSET UNITYSDK_OFFSET(0x17643B40)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONATTRIBUTEAPPENDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17643BC0)
