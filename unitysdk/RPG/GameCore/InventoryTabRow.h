...
#define RPG_GAMECORE_INVENTORYTABROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18E48450)
#define RPG_GAMECORE_INVENTORYTABROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18E48CF0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 DisplayCapacityLimit; // 0x30
		::System::UInt32 TabSortWeight; // 0x34
		::System::Boolean NotDisplayPileLimit; // 0x38
