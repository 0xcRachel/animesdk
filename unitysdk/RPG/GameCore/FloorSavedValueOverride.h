...
#define RPG_GAMECORE_FLOORSAVEDVALUEOVERRIDE_METHOD_2_E13950717E34196E_OFFSET UNITYSDK_OFFSET(0x1A3AF4C0)
#define RPG_GAMECORE_FLOORSAVEDVALUEOVERRIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3AF610)
