...
#define RPG_GAMECORE_PROPCURVEMOVERECOVER_METHOD_3_9A9C1F9A217748FB_OFFSET UNITYSDK_OFFSET(0x16DA51C0)
#define RPG_GAMECORE_PROPCURVEMOVERECOVER_METHOD_3_F266E870893F7CD1_OFFSET UNITYSDK_OFFSET(0x16DA5290)
#define RPG_GAMECORE_PROPCURVEMOVERECOVER__CTOR_OFFSET UNITYSDK_OFFSET(0x16DA5240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropCurveMoveRecover_TypeDefinitionIndex = 18816;
