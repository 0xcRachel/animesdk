...
#define RPG_GAMECORE_PROPCURVEMOVERECOVER_METHOD_3_9A9C1F9A217748FB_OFFSET UNITYSDK_OFFSET(0x1A2D8650)
#define RPG_GAMECORE_PROPCURVEMOVERECOVER_METHOD_3_F266E870893F7CD1_OFFSET UNITYSDK_OFFSET(0x1A2D8720)
#define RPG_GAMECORE_PROPCURVEMOVERECOVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2D86D0)
