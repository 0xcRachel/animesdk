...
#define RPG_GAMECORE_SETDYNAMICVALUEBYACTIVITYELATION_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x176D46F0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYACTIVITYELATION_METHOD_4_BC195C6FBC4D22CE_OFFSET UNITYSDK_OFFSET(0x176D4670)
#define RPG_GAMECORE_SETDYNAMICVALUEBYACTIVITYELATION_METHOD_4_F272D784FB962E23_OFFSET UNITYSDK_OFFSET(0x176CAF60)
#define RPG_GAMECORE_SETDYNAMICVALUEBYACTIVITYELATION__CTOR_OFFSET UNITYSDK_OFFSET(0x176CAF10)
