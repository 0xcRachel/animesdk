...
#define RPG_GAMECORE_CAKERACEACTIONICESLIDE_METHOD_3_BF932007E39A5703_OFFSET UNITYSDK_OFFSET(0x16947B00)
#define RPG_GAMECORE_CAKERACEACTIONICESLIDE_METHOD_3_F253D1662838D5B5_OFFSET UNITYSDK_OFFSET(0x16949570)
#define RPG_GAMECORE_CAKERACEACTIONICESLIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x16947AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionIceSlide_TypeDefinitionIndex = 16475;
