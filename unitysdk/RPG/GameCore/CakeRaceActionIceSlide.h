...
#define RPG_GAMECORE_CAKERACEACTIONICESLIDE_METHOD_3_BF932007E39A5703_OFFSET UNITYSDK_OFFSET(0x170592B0)
#define RPG_GAMECORE_CAKERACEACTIONICESLIDE_METHOD_3_F253D1662838D5B5_OFFSET UNITYSDK_OFFSET(0x1705AD20)
#define RPG_GAMECORE_CAKERACEACTIONICESLIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x17059290)
