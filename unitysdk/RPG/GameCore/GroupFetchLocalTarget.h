...
#define RPG_GAMECORE_GROUPFETCHLOCALTARGET_METHOD_4_1E2052D63AB8A012_OFFSET UNITYSDK_OFFSET(0x16B51B20)
#define RPG_GAMECORE_GROUPFETCHLOCALTARGET_METHOD_4_2E55DDAD0AC699DE_OFFSET UNITYSDK_OFFSET(0x16B51BE0)
#define RPG_GAMECORE_GROUPFETCHLOCALTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x16B51B90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GroupFetchLocalTarget_TypeDefinitionIndex = 18932;
