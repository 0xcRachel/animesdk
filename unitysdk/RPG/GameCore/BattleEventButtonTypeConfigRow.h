...
#define RPG_GAMECORE_BATTLEEVENTBUTTONTYPECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x168D4E20)
#define RPG_GAMECORE_BATTLEEVENTBUTTONTYPECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x168D5000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleEventButtonTypeConfigRow_TypeDefinitionIndex = 11674;
