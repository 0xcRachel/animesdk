...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDROLEDELAYGRANTCONFIG_METHOD_3_176A38F7CB41B6AD_OFFSET UNITYSDK_OFFSET(0x19575C20)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDROLEDELAYGRANTCONFIG_METHOD_3_7B8E94E9DF2C3EA4_OFFSET UNITYSDK_OFFSET(0x19575CF0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDROLEDELAYGRANTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19575CA0)
