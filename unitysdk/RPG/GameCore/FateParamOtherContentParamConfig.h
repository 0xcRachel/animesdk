...
#define RPG_GAMECORE_FATEPARAMOTHERCONTENTPARAMCONFIG_METHOD_6_116CA118880BCD53_OFFSET UNITYSDK_OFFSET(0x1947A3A0)
#define RPG_GAMECORE_FATEPARAMOTHERCONTENTPARAMCONFIG_METHOD_6_55C352718E35DFAF_OFFSET UNITYSDK_OFFSET(0x1947A560)
#define RPG_GAMECORE_FATEPARAMOTHERCONTENTPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1947A4A0)
