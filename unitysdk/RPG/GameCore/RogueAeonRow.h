...
#define RPG_GAMECORE_ROGUEAEONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x175F2D50)
#define RPG_GAMECORE_ROGUEAEONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x175F49D0)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::UInt32 BattleEventBuffGroup; // 0x10
		::System::UInt32 ArrivedTalkDialogueGroupID; // 0x14
		...
		::System::UInt32 RogueVersion; // 0x48
