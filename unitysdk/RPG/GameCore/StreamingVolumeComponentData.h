...
#define RPG_GAMECORE_STREAMINGVOLUMECOMPONENTDATA_METHOD_3_575A94908D88E6E1_OFFSET UNITYSDK_OFFSET(0x16F8E930)
#define RPG_GAMECORE_STREAMINGVOLUMECOMPONENTDATA_METHOD_3_F6C3BB9787EE5DBF_OFFSET UNITYSDK_OFFSET(0x16FA2E20)
#define RPG_GAMECORE_STREAMINGVOLUMECOMPONENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16F8E920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StreamingVolumeComponentData_TypeDefinitionIndex = 17129;
