...
#define RPG_GAMECORE_PLAYERFORCEWALK_METHOD_3_1DC07F62FD89F39F_OFFSET UNITYSDK_OFFSET(0x16D68740)
#define RPG_GAMECORE_PLAYERFORCEWALK_METHOD_3_CF4BE6E321C04B6E_OFFSET UNITYSDK_OFFSET(0x16D686C0)
#define RPG_GAMECORE_PLAYERFORCEWALK__CTOR_OFFSET UNITYSDK_OFFSET(0x16D68710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayerForceWalk_TypeDefinitionIndex = 17762;
