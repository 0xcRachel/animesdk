...
#define RPG_GAMECORE_AIVARIABLEFLOAT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x18856F20)
#define RPG_GAMECORE_AIVARIABLEFLOAT_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x18856E70)
#define RPG_GAMECORE_AIVARIABLEFLOAT_EQUALS_OFFSET UNITYSDK_OFFSET(0x18856DA0)
#define RPG_GAMECORE_AIVARIABLEFLOAT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x18857060)
#define RPG_GAMECORE_AIVARIABLEFLOAT_METHOD_3_2742D7137C9CCDB6_OFFSET UNITYSDK_OFFSET(0x18856090)
#define RPG_GAMECORE_AIVARIABLEFLOAT_METHOD_3_36FA82E9CA56D7A1_OFFSET UNITYSDK_OFFSET(0x18856D70)
#define RPG_GAMECORE_AIVARIABLEFLOAT_METHOD_3_F51FEF81E82409C8_1_OFFSET UNITYSDK_OFFSET(0x18857170)
#define RPG_GAMECORE_AIVARIABLEFLOAT_METHOD_3_F51FEF81E82409C8_OFFSET UNITYSDK_OFFSET(0x18857130)
#define RPG_GAMECORE_AIVARIABLEFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x18856080)
