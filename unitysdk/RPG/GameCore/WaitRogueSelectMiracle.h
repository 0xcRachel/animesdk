...
#define RPG_GAMECORE_WAITROGUESELECTMIRACLE_METHOD_3_577888128C9BDBD3_OFFSET UNITYSDK_OFFSET(0x19534510)
#define RPG_GAMECORE_WAITROGUESELECTMIRACLE_METHOD_3_D157F91051DB9083_OFFSET UNITYSDK_OFFSET(0x195345A0)
#define RPG_GAMECORE_WAITROGUESELECTMIRACLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19534570)
