...
#define RPG_GAMECORE_SETADVEFFECTFORCEFIELD_METHOD_3_AFDDAC5BDAE4169D_OFFSET UNITYSDK_OFFSET(0x192EACA0)
#define RPG_GAMECORE_SETADVEFFECTFORCEFIELD_METHOD_3_C7A7ECF5F8192DE8_OFFSET UNITYSDK_OFFSET(0x192EAD20)
#define RPG_GAMECORE_SETADVEFFECTFORCEFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x192EACF0)
