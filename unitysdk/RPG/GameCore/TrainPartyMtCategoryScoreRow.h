...
#define RPG_GAMECORE_TRAINPARTYMTCATEGORYSCOREROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17105E50)
#define RPG_GAMECORE_TRAINPARTYMTCATEGORYSCOREROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17105FC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyMtCategoryScoreRow_TypeDefinitionIndex = 13971;
