...
#define RPG_GAMECORE_ST_MAIN_ELFWAITERCLEANTABLE_METHOD_4_01ACD4687668A843_OFFSET UNITYSDK_OFFSET(0x176AB7B0)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERCLEANTABLE_METHOD_4_1D97BAE459611154_OFFSET UNITYSDK_OFFSET(0x176987A0)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERCLEANTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x17698750)
