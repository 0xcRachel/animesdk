...
#define RPG_GAMECORE_ST_MAIN_ELFWAITERCLEANTABLE_METHOD_4_01ACD4687668A843_OFFSET UNITYSDK_OFFSET(0x16EF5830)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERCLEANTABLE_METHOD_4_1D97BAE459611154_OFFSET UNITYSDK_OFFSET(0x16EF59A0)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERCLEANTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16EF5950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfWaiterCleanTable_TypeDefinitionIndex = 19173;
