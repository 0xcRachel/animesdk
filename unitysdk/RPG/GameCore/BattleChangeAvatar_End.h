...
#define RPG_GAMECORE_BATTLECHANGEAVATAR_END_METHOD_3_BECEB47B6BA86EDE_OFFSET UNITYSDK_OFFSET(0x168D0400)
#define RPG_GAMECORE_BATTLECHANGEAVATAR_END_METHOD_3_F08AC525B4A9BED2_OFFSET UNITYSDK_OFFSET(0x168D02F0)
#define RPG_GAMECORE_BATTLECHANGEAVATAR_END__CTOR_OFFSET UNITYSDK_OFFSET(0x168D03D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleChangeAvatar_End_TypeDefinitionIndex = 20425;
