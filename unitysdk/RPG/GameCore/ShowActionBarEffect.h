...
#define RPG_GAMECORE_SHOWACTIONBAREFFECT_METHOD_3_4633478A2DA84DE7_OFFSET UNITYSDK_OFFSET(0x16F52680)
#define RPG_GAMECORE_SHOWACTIONBAREFFECT_METHOD_3_6ED99107844B5957_OFFSET UNITYSDK_OFFSET(0x16F52580)
#define RPG_GAMECORE_SHOWACTIONBAREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F52610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowActionBarEffect_TypeDefinitionIndex = 20602;
