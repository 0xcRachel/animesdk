...
#define RPG_GAMECORE_BYCOMPAREITEMNUM_METHOD_4_71100AC1BB1B7480_OFFSET UNITYSDK_OFFSET(0x1690FFE0)
#define RPG_GAMECORE_BYCOMPAREITEMNUM_METHOD_4_8C33D2099279797E_OFFSET UNITYSDK_OFFSET(0x169100B0)
#define RPG_GAMECORE_BYCOMPAREITEMNUM__CTOR_OFFSET UNITYSDK_OFFSET(0x16910060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareItemNum_TypeDefinitionIndex = 18871;
