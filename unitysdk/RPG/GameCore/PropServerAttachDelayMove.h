...
#define RPG_GAMECORE_PROPSERVERATTACHDELAYMOVE_METHOD_3_21F22EA09030F2F8_OFFSET UNITYSDK_OFFSET(0x17538C70)
#define RPG_GAMECORE_PROPSERVERATTACHDELAYMOVE_METHOD_3_35FF9EADC298B8F8_OFFSET UNITYSDK_OFFSET(0x17538BE0)
#define RPG_GAMECORE_PROPSERVERATTACHDELAYMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x17538C40)
