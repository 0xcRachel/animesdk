...
#define RPG_GAMECORE_MAZEPUZZLEORIGAMIFDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16C77DC0)
#define RPG_GAMECORE_MAZEPUZZLEORIGAMIFDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16C78070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazePuzzleOrigamiFDRow_TypeDefinitionIndex = 12800;
	...
	public:
		...
		::System::UInt32 MainPropID; // 0x2C
		::System::UInt32 FDContainerID; // 0x30
