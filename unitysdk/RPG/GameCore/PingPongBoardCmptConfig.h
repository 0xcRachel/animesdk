...
#define RPG_GAMECORE_PINGPONGBOARDCMPTCONFIG_METHOD_3_034118288AA1CABA_OFFSET UNITYSDK_OFFSET(0x174C30D0)
#define RPG_GAMECORE_PINGPONGBOARDCMPTCONFIG_METHOD_3_12F93CBA7BBF3C28_OFFSET UNITYSDK_OFFSET(0x174C2FF0)
#define RPG_GAMECORE_PINGPONGBOARDCMPTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x174C30B0)
