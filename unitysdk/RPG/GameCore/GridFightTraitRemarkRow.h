...
#define RPG_GAMECORE_GRIDFIGHTTRAITREMARKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19B91390)
#define RPG_GAMECORE_GRIDFIGHTTRAITREMARKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19B917E0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 TextOrder; // 0x34
		::RPG::Client::TextID TraitRemark; // 0x38
		::RPG::GameCore::GridFightTraitRemarkActiveEffect Format; // 0x48
		::RPG::GameCore::GridFightTraitRemarkActiveType ConditionType; // 0x4C
