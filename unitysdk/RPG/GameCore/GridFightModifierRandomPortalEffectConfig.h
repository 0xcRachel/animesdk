...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERRANDOMPORTALEFFECTCONFIG_METHOD_3_A17317E8C60F3703_OFFSET UNITYSDK_OFFSET(0x16B33940)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERRANDOMPORTALEFFECTCONFIG_METHOD_3_E755CB7746FDFE3A_OFFSET UNITYSDK_OFFSET(0x16B2FC00)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERRANDOMPORTALEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16B2FBB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierRandomPortalEffectConfig_TypeDefinitionIndex = 17447;
