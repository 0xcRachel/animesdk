...
#define RPG_GAMECORE_CHIMERATEAMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x170C0690)
#define RPG_GAMECORE_CHIMERATEAMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x170C0900)
