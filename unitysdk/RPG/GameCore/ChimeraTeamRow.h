...
#define RPG_GAMECORE_CHIMERATEAMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1699E540)
#define RPG_GAMECORE_CHIMERATEAMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1699E7B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraTeamRow_TypeDefinitionIndex = 11812;
