...
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONMECHAWAREHOUSEINFO_METHOD_3_61348C7677D16331_OFFSET UNITYSDK_OFFSET(0x1735D230)
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONMECHAWAREHOUSEINFO_METHOD_3_CE5DD60A688C1087_OFFSET UNITYSDK_OFFSET(0x1735C8B0)
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONMECHAWAREHOUSEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1735C8A0)
