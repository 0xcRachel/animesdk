...
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONMECHAWAREHOUSEINFO_METHOD_3_61348C7677D16331_OFFSET UNITYSDK_OFFSET(0x16BB96F0)
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONMECHAWAREHOUSEINFO_METHOD_3_CE5DD60A688C1087_OFFSET UNITYSDK_OFFSET(0x16BB8D70)
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONMECHAWAREHOUSEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16BB8D60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPedestrianV2IntersectionMechaWarehouseInfo_TypeDefinitionIndex = 15616;
