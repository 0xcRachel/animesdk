...
#define RPG_GAMECORE_WAITPARALLELTIMESTAMP_METHOD_3_424D5C1D53963308_OFFSET UNITYSDK_OFFSET(0x19530490)
#define RPG_GAMECORE_WAITPARALLELTIMESTAMP_METHOD_3_CBB797929CF0F66F_OFFSET UNITYSDK_OFFSET(0x195305B0)
#define RPG_GAMECORE_WAITPARALLELTIMESTAMP__CTOR_OFFSET UNITYSDK_OFFSET(0x19530530)
