...
#define RPG_GAMECORE_VE_RTBATTLEPROPERTYRATIO_METHOD_3_A19FFDA0EFF203EE_OFFSET UNITYSDK_OFFSET(0x1951C110)
#define RPG_GAMECORE_VE_RTBATTLEPROPERTYRATIO_METHOD_3_BFFD84354B968897_OFFSET UNITYSDK_OFFSET(0x1951C0D0)
#define RPG_GAMECORE_VE_RTBATTLEPROPERTYRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x1951C100)
