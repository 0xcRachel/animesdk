...
#define RPG_GAMECORE_SIMULATELINEUPCONFIG_METHOD_2_FF24423F7227C39E_OFFSET UNITYSDK_OFFSET(0x1771E7A0)
#define RPG_GAMECORE_SIMULATELINEUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1771E8A0)
