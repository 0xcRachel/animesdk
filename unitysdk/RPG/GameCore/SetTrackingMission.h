...
#define RPG_GAMECORE_SETTRACKINGMISSION_METHOD_3_12C442B859D2299D_OFFSET UNITYSDK_OFFSET(0x16F44510)
#define RPG_GAMECORE_SETTRACKINGMISSION_METHOD_3_9C36E1AF811DFAFC_OFFSET UNITYSDK_OFFSET(0x16F44490)
#define RPG_GAMECORE_SETTRACKINGMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x16F444E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTrackingMission_TypeDefinitionIndex = 18563;
