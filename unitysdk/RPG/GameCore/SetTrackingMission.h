...
#define RPG_GAMECORE_SETTRACKINGMISSION_METHOD_3_12C442B859D2299D_OFFSET UNITYSDK_OFFSET(0x1A7A29F0)
#define RPG_GAMECORE_SETTRACKINGMISSION_METHOD_3_9C36E1AF811DFAFC_OFFSET UNITYSDK_OFFSET(0x1A7A2970)
#define RPG_GAMECORE_SETTRACKINGMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7A29C0)
