...
#define RPG_GAMECORE_PROPMOVETOV2TARGETBASE_METHOD_2_C5B85B3E3B45A948_OFFSET UNITYSDK_OFFSET(0x16DAF110)
#define RPG_GAMECORE_PROPMOVETOV2TARGETBASE_METHOD_2_EA56471AEE5A0F19_OFFSET UNITYSDK_OFFSET(0x16DAEE60)
#define RPG_GAMECORE_PROPMOVETOV2TARGETBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x16DAF100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropMoveToV2TargetBase_TypeDefinitionIndex = 18118;
