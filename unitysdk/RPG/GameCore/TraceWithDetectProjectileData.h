...
#define RPG_GAMECORE_TRACEWITHDETECTPROJECTILEDATA_METHOD_3_3D8A77030D68BEBE_OFFSET UNITYSDK_OFFSET(0x1948C780)
#define RPG_GAMECORE_TRACEWITHDETECTPROJECTILEDATA_METHOD_3_6A1F709BBE7A8581_OFFSET UNITYSDK_OFFSET(0x1948C8A0)
#define RPG_GAMECORE_TRACEWITHDETECTPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1948C820)
