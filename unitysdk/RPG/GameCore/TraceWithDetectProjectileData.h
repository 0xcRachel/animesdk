...
#define RPG_GAMECORE_TRACEWITHDETECTPROJECTILEDATA_METHOD_3_3D8A77030D68BEBE_OFFSET UNITYSDK_OFFSET(0x178B6F00)
#define RPG_GAMECORE_TRACEWITHDETECTPROJECTILEDATA_METHOD_3_6A1F709BBE7A8581_OFFSET UNITYSDK_OFFSET(0x178B7020)
#define RPG_GAMECORE_TRACEWITHDETECTPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x178B6FA0)
