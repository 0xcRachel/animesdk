...
#define RPG_GAMECORE_TRACEWITHDETECTPROJECTILEDATA_METHOD_3_3D8A77030D68BEBE_OFFSET UNITYSDK_OFFSET(0x170FB7C0)
#define RPG_GAMECORE_TRACEWITHDETECTPROJECTILEDATA_METHOD_3_6A1F709BBE7A8581_OFFSET UNITYSDK_OFFSET(0x170FB8E0)
#define RPG_GAMECORE_TRACEWITHDETECTPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x170FB860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TraceWithDetectProjectileData_TypeDefinitionIndex = 14245;
