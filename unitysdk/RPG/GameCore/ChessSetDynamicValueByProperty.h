...
#define RPG_GAMECORE_CHESSSETDYNAMICVALUEBYPROPERTY_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x170A2400)
#define RPG_GAMECORE_CHESSSETDYNAMICVALUEBYPROPERTY_METHOD_4_6B1284213D92F329_OFFSET UNITYSDK_OFFSET(0x170A21E0)
#define RPG_GAMECORE_CHESSSETDYNAMICVALUEBYPROPERTY_METHOD_4_9428259889EDDF11_OFFSET UNITYSDK_OFFSET(0x170A2110)
#define RPG_GAMECORE_CHESSSETDYNAMICVALUEBYPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x170A2190)
