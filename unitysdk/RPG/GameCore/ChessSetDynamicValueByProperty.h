...
#define RPG_GAMECORE_CHESSSETDYNAMICVALUEBYPROPERTY_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x16980010)
#define RPG_GAMECORE_CHESSSETDYNAMICVALUEBYPROPERTY_METHOD_4_6B1284213D92F329_OFFSET UNITYSDK_OFFSET(0x1697FDF0)
#define RPG_GAMECORE_CHESSSETDYNAMICVALUEBYPROPERTY_METHOD_4_9428259889EDDF11_OFFSET UNITYSDK_OFFSET(0x1697FD20)
#define RPG_GAMECORE_CHESSSETDYNAMICVALUEBYPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1697FDA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChessSetDynamicValueByProperty_TypeDefinitionIndex = 21427;
