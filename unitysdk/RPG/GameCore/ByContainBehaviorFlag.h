...
#define RPG_GAMECORE_BYCONTAINBEHAVIORFLAG_METHOD_4_4C8D32059C9B7C27_OFFSET UNITYSDK_OFFSET(0x19AD7D10)
#define RPG_GAMECORE_BYCONTAINBEHAVIORFLAG_METHOD_4_5F448CBA177F31DA_OFFSET UNITYSDK_OFFSET(0x19AD7C30)
#define RPG_GAMECORE_BYCONTAINBEHAVIORFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD7CB0)
