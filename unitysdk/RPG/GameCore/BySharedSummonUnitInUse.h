...
#define RPG_GAMECORE_BYSHAREDSUMMONUNITINUSE_METHOD_4_4D522038EE66A25D_OFFSET UNITYSDK_OFFSET(0x1693D290)
#define RPG_GAMECORE_BYSHAREDSUMMONUNITINUSE_METHOD_4_E55F76F93549C733_OFFSET UNITYSDK_OFFSET(0x1693D360)
#define RPG_GAMECORE_BYSHAREDSUMMONUNITINUSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1693D310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BySharedSummonUnitInUse_TypeDefinitionIndex = 18942;
