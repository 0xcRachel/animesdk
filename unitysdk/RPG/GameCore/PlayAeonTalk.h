...
#define RPG_GAMECORE_PLAYAEONTALK_METHOD_4_308B48D2B9215BD5_OFFSET UNITYSDK_OFFSET(0x16D4CF40)
#define RPG_GAMECORE_PLAYAEONTALK_METHOD_4_398DBB32D27E48FC_OFFSET UNITYSDK_OFFSET(0x16D4CEC0)
#define RPG_GAMECORE_PLAYAEONTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x16D4CF10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayAeonTalk_TypeDefinitionIndex = 18893;
