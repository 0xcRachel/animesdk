...
#define RPG_GAMECORE_ADVENTUREAICONFIG_METHOD_2_968AADC1358A4732_OFFSET UNITYSDK_OFFSET(0x16F5D4C0)
#define RPG_GAMECORE_ADVENTUREAICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F5DC10)
