...
#define RPG_GAMECORE_ADVENTUREAICONFIG_METHOD_2_968AADC1358A4732_OFFSET UNITYSDK_OFFSET(0x1684FBF0)
#define RPG_GAMECORE_ADVENTUREAICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16850340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureAIConfig_TypeDefinitionIndex = 15732;
