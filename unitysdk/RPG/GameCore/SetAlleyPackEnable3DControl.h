...
#define RPG_GAMECORE_SETALLEYPACKENABLE3DCONTROL_METHOD_3_9C998B9765FA8AA3_OFFSET UNITYSDK_OFFSET(0x16F052A0)
#define RPG_GAMECORE_SETALLEYPACKENABLE3DCONTROL_METHOD_3_DF585F09B042749A_OFFSET UNITYSDK_OFFSET(0x16F05220)
#define RPG_GAMECORE_SETALLEYPACKENABLE3DCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x16F05270)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAlleyPackEnable3DControl_TypeDefinitionIndex = 21842;
