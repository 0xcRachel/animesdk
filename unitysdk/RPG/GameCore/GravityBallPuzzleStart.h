...
#define RPG_GAMECORE_GRAVITYBALLPUZZLESTART_METHOD_3_21F2AD781525EBDA_OFFSET UNITYSDK_OFFSET(0x19560F80)
#define RPG_GAMECORE_GRAVITYBALLPUZZLESTART_METHOD_3_45930929D7A53C26_OFFSET UNITYSDK_OFFSET(0x19561090)
#define RPG_GAMECORE_GRAVITYBALLPUZZLESTART__CTOR_OFFSET UNITYSDK_OFFSET(0x19561060)
