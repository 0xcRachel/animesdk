...
#define RPG_GAMECORE_CHIMERAPERIODICRANDOMTALK_METHOD_3_575AC62B04A05021_OFFSET UNITYSDK_OFFSET(0x1699BC00)
#define RPG_GAMECORE_CHIMERAPERIODICRANDOMTALK_METHOD_3_78783645F584EAC9_OFFSET UNITYSDK_OFFSET(0x1699BC70)
#define RPG_GAMECORE_CHIMERAPERIODICRANDOMTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1699BC60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraPeriodicRandomTalk_TypeDefinitionIndex = 14294;
