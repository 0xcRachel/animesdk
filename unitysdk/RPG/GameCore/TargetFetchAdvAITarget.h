...
#define RPG_GAMECORE_TARGETFETCHADVAITARGET_METHOD_4_2FF3F5180B061BCC_OFFSET UNITYSDK_OFFSET(0x16FD14F0)
#define RPG_GAMECORE_TARGETFETCHADVAITARGET_METHOD_4_EDD1718D71B64B8E_OFFSET UNITYSDK_OFFSET(0x16FDA650)
#define RPG_GAMECORE_TARGETFETCHADVAITARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD14A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAdvAITarget_TypeDefinitionIndex = 21632;
