...
#define RPG_GAMECORE_AISLAVECONFIG_METHOD_2_999D75FFA63B561E_OFFSET UNITYSDK_OFFSET(0x16771BE0)
#define RPG_GAMECORE_AISLAVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16771D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AISlaveConfig_TypeDefinitionIndex = 15547;
