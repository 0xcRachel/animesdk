...
#define RPG_GAMECORE_BYCHECKISLIMBOREVIVABLE_METHOD_4_5DE0B9709C7EA61F_OFFSET UNITYSDK_OFFSET(0x16901E90)
#define RPG_GAMECORE_BYCHECKISLIMBOREVIVABLE_METHOD_4_DB97F421CBDA4575_OFFSET UNITYSDK_OFFSET(0x16901F60)
#define RPG_GAMECORE_BYCHECKISLIMBOREVIVABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16901F10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckIsLimboRevivable_TypeDefinitionIndex = 20691;
