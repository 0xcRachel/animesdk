...
#define RPG_GAMECORE_MODIFYENTITYBOOSTPOINT_METHOD_3_53FC66E92D791B32_OFFSET UNITYSDK_OFFSET(0x16CBE430)
#define RPG_GAMECORE_MODIFYENTITYBOOSTPOINT_METHOD_3_861B006073E793B5_OFFSET UNITYSDK_OFFSET(0x16CBE3B0)
#define RPG_GAMECORE_MODIFYENTITYBOOSTPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x16CBE400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyEntityBoostPoint_TypeDefinitionIndex = 20240;
