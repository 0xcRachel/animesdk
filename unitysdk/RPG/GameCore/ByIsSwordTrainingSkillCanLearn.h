...
#define RPG_GAMECORE_BYISSWORDTRAININGSKILLCANLEARN_METHOD_4_4D180175C9DC4EA7_OFFSET UNITYSDK_OFFSET(0x19DB19C0)
#define RPG_GAMECORE_BYISSWORDTRAININGSKILLCANLEARN_METHOD_4_7EBDD0C76BF628B8_OFFSET UNITYSDK_OFFSET(0x19DB1C80)
#define RPG_GAMECORE_BYISSWORDTRAININGSKILLCANLEARN_METHOD_4_F4FBC387EC486E30_OFFSET UNITYSDK_OFFSET(0x19DB1C00)
#define RPG_GAMECORE_BYISSWORDTRAININGSKILLCANLEARN_METHOD_4_F98B182E430A7E75_OFFSET UNITYSDK_OFFSET(0x19DB1A90)
#define RPG_GAMECORE_BYISSWORDTRAININGSKILLCANLEARN__CTOR_OFFSET UNITYSDK_OFFSET(0x19DB1A40)
