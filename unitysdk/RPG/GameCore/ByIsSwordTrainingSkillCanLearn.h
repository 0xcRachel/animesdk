...
#define RPG_GAMECORE_BYISSWORDTRAININGSKILLCANLEARN_METHOD_4_4D180175C9DC4EA7_OFFSET UNITYSDK_OFFSET(0x169364B0)
#define RPG_GAMECORE_BYISSWORDTRAININGSKILLCANLEARN_METHOD_4_F98B182E430A7E75_OFFSET UNITYSDK_OFFSET(0x16936580)
#define RPG_GAMECORE_BYISSWORDTRAININGSKILLCANLEARN__CTOR_OFFSET UNITYSDK_OFFSET(0x16936530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsSwordTrainingSkillCanLearn_TypeDefinitionIndex = 21847;
