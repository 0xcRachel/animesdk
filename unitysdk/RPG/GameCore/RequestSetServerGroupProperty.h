...
#define RPG_GAMECORE_REQUESTSETSERVERGROUPPROPERTY_METHOD_3_8CDE6AFECBE3211A_OFFSET UNITYSDK_OFFSET(0x1902C3C0)
#define RPG_GAMECORE_REQUESTSETSERVERGROUPPROPERTY_METHOD_3_E5C4DBC489C330E1_OFFSET UNITYSDK_OFFSET(0x1902C340)
#define RPG_GAMECORE_REQUESTSETSERVERGROUPPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1902C390)
