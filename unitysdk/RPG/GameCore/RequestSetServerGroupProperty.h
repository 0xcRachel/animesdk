...
#define RPG_GAMECORE_REQUESTSETSERVERGROUPPROPERTY_METHOD_3_8CDE6AFECBE3211A_OFFSET UNITYSDK_OFFSET(0x175B0E30)
#define RPG_GAMECORE_REQUESTSETSERVERGROUPPROPERTY_METHOD_3_E5C4DBC489C330E1_OFFSET UNITYSDK_OFFSET(0x175B0DB0)
#define RPG_GAMECORE_REQUESTSETSERVERGROUPPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x175B0E00)
