...
#define RPG_GAMECORE_SHOWMISSIONINFO_METHOD_3_197CFE3A026AD1D0_OFFSET UNITYSDK_OFFSET(0x17714900)
#define RPG_GAMECORE_SHOWMISSIONINFO_METHOD_3_78A05FB8431E3059_OFFSET UNITYSDK_OFFSET(0x17714980)
#define RPG_GAMECORE_SHOWMISSIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x17714950)
