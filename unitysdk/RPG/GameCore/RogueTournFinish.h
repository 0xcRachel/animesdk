...
#define RPG_GAMECORE_ROGUETOURNFINISH_METHOD_3_02A9EB52E264B5FE_OFFSET UNITYSDK_OFFSET(0x19831030)
#define RPG_GAMECORE_ROGUETOURNFINISH_METHOD_3_E15C3C3BCC711472_OFFSET UNITYSDK_OFFSET(0x19830F20)
#define RPG_GAMECORE_ROGUETOURNFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x19831000)
