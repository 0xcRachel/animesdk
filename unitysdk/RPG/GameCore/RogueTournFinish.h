...
#define RPG_GAMECORE_ROGUETOURNFINISH_METHOD_3_02A9EB52E264B5FE_OFFSET UNITYSDK_OFFSET(0x16EC6020)
#define RPG_GAMECORE_ROGUETOURNFINISH_METHOD_3_E15C3C3BCC711472_OFFSET UNITYSDK_OFFSET(0x16EC5F10)
#define RPG_GAMECORE_ROGUETOURNFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x16EC5FF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournFinish_TypeDefinitionIndex = 19751;
