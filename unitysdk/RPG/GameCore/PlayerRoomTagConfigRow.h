...
#define RPG_GAMECORE_PLAYERROOMTAGCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19365E90)
#define RPG_GAMECORE_PLAYERROOMTAGCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19366010)
