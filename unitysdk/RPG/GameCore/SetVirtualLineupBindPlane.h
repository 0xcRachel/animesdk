...
#define RPG_GAMECORE_SETVIRTUALLINEUPBINDPLANE_METHOD_3_3B05C5E09AB7FA00_OFFSET UNITYSDK_OFFSET(0x176FB290)
#define RPG_GAMECORE_SETVIRTUALLINEUPBINDPLANE_METHOD_3_D3D9D3509851AC60_OFFSET UNITYSDK_OFFSET(0x176FB320)
#define RPG_GAMECORE_SETVIRTUALLINEUPBINDPLANE__CTOR_OFFSET UNITYSDK_OFFSET(0x176FB2F0)
