...
#define RPG_GAMECORE_SETVIRTUALLINEUPBINDPLANE_METHOD_3_3B05C5E09AB7FA00_OFFSET UNITYSDK_OFFSET(0x1A7A41A0)
#define RPG_GAMECORE_SETVIRTUALLINEUPBINDPLANE_METHOD_3_D3D9D3509851AC60_OFFSET UNITYSDK_OFFSET(0x1A7A4230)
#define RPG_GAMECORE_SETVIRTUALLINEUPBINDPLANE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7A4200)
