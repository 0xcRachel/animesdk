...
#define RPG_GAMECORE_SWORDTRAININGATTACKDATA_METHOD_3_02589044B8050211_OFFSET UNITYSDK_OFFSET(0x177AEDA0)
#define RPG_GAMECORE_SWORDTRAININGATTACKDATA_METHOD_3_4335EF26734328AD_OFFSET UNITYSDK_OFFSET(0x177AED50)
#define RPG_GAMECORE_SWORDTRAININGATTACKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x177AED90)
