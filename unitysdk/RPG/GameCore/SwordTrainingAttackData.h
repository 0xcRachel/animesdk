...
#define RPG_GAMECORE_SWORDTRAININGATTACKDATA_METHOD_3_02589044B8050211_OFFSET UNITYSDK_OFFSET(0x16FBA940)
#define RPG_GAMECORE_SWORDTRAININGATTACKDATA_METHOD_3_4335EF26734328AD_OFFSET UNITYSDK_OFFSET(0x16FBA8F0)
#define RPG_GAMECORE_SWORDTRAININGATTACKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16FBA930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwordTrainingAttackData_TypeDefinitionIndex = 20231;
