...
#define RPG_GAMECORE_CHARACTERCHANGEPHASE_METHOD_3_0102EAE67CF4F9C0_OFFSET UNITYSDK_OFFSET(0x1707B530)
#define RPG_GAMECORE_CHARACTERCHANGEPHASE_METHOD_3_1D026C7D4233DD36_OFFSET UNITYSDK_OFFSET(0x1707B4B0)
#define RPG_GAMECORE_CHARACTERCHANGEPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1707B500)
