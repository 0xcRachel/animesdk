...
#define RPG_GAMECORE_ROGUEMODIFIERAUTOBUYMIRACLECONFIG_METHOD_3_2BCB5C670EF41D47_OFFSET UNITYSDK_OFFSET(0x17631700)
#define RPG_GAMECORE_ROGUEMODIFIERAUTOBUYMIRACLECONFIG_METHOD_3_9014B969C424F1DE_OFFSET UNITYSDK_OFFSET(0x176317D0)
#define RPG_GAMECORE_ROGUEMODIFIERAUTOBUYMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17631780)
