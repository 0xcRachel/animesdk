...
#define RPG_GAMECORE_ADVENDISOMETRIC_METHOD_3_8FE5649592E2167C_OFFSET UNITYSDK_OFFSET(0x16833940)
#define RPG_GAMECORE_ADVENDISOMETRIC_METHOD_3_902AE7AF0D5FA7B0_OFFSET UNITYSDK_OFFSET(0x16833830)
#define RPG_GAMECORE_ADVENDISOMETRIC__CTOR_OFFSET UNITYSDK_OFFSET(0x16833910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvEndIsometric_TypeDefinitionIndex = 19859;
