...
#define RPG_GAMECORE_GACHASHOWTOASTDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19C8BBF0)
#define RPG_GAMECORE_GACHASHOWTOASTDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19C8C350)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Single LoopUIOpenTime; // 0x1C
		...
		::System::Single LoopBGMOpenTime; // 0x3C
