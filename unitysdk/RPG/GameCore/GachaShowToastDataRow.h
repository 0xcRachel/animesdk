...
#define RPG_GAMECORE_GACHASHOWTOASTDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1723D5B0)
#define RPG_GAMECORE_GACHASHOWTOASTDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1723DCF0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 ShowVideoID; // 0x1C
		::System::UInt32 LoopVideoID; // 0x20
