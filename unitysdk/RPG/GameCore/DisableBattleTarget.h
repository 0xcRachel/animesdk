...
#define RPG_GAMECORE_DISABLEBATTLETARGET_METHOD_3_9496C0B28B0D5E62_OFFSET UNITYSDK_OFFSET(0x195A8C10)
#define RPG_GAMECORE_DISABLEBATTLETARGET_METHOD_3_D6A6DA0560FA8C4E_OFFSET UNITYSDK_OFFSET(0x195A8C90)
#define RPG_GAMECORE_DISABLEBATTLETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x195A8C60)
