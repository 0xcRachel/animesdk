...
#define RPG_GAMECORE_TRIGGERENTITYEVENT_METHOD_3_219BE872DA3B94A6_OFFSET UNITYSDK_OFFSET(0x1711F350)
#define RPG_GAMECORE_TRIGGERENTITYEVENT_METHOD_3_71FDD92D94D8B471_OFFSET UNITYSDK_OFFSET(0x1711F3D0)
#define RPG_GAMECORE_TRIGGERENTITYEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1711F3A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerEntityEvent_TypeDefinitionIndex = 18520;
