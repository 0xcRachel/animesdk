...
#define RPG_GAMECORE_MODIFYCHARACTERFACEMATERIAL_METHOD_3_CA0DC2CC25EF50DC_OFFSET UNITYSDK_OFFSET(0x16CB88B0)
#define RPG_GAMECORE_MODIFYCHARACTERFACEMATERIAL_METHOD_3_F7FA7C37F154B721_OFFSET UNITYSDK_OFFSET(0x16CB8820)
#define RPG_GAMECORE_MODIFYCHARACTERFACEMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x16CB8880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyCharacterFaceMaterial_TypeDefinitionIndex = 20075;
