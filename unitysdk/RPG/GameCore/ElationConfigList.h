...
#define RPG_GAMECORE_ELATIONCONFIGLIST_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16A5CCC0)
#define RPG_GAMECORE_ELATIONCONFIGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x16A5CDC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElationConfigList_TypeDefinitionIndex = 14901;
