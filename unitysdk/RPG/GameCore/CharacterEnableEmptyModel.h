...
#define RPG_GAMECORE_CHARACTERENABLEEMPTYMODEL_METHOD_3_851B5FFC9C08DE6F_OFFSET UNITYSDK_OFFSET(0x1707FBC0)
#define RPG_GAMECORE_CHARACTERENABLEEMPTYMODEL_METHOD_3_EB641690619602D0_OFFSET UNITYSDK_OFFSET(0x1707FC90)
#define RPG_GAMECORE_CHARACTERENABLEEMPTYMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1707FC40)
