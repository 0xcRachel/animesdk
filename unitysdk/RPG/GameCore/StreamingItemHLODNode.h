...
#define RPG_GAMECORE_STREAMINGITEMHLODNODE_METHOD_2_B8181376C3841D78_OFFSET UNITYSDK_OFFSET(0x18D772B0)
#define RPG_GAMECORE_STREAMINGITEMHLODNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x18D776E0)
