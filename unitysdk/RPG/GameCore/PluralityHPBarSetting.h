...
#define RPG_GAMECORE_PLURALITYHPBARSETTING_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A772830)
#define RPG_GAMECORE_PLURALITYHPBARSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A772AE0)
