...
#define RPG_GAMECORE_PHASESKILLINFOMAPPINGLIST_METHOD_2_D500A9B496107AEA_OFFSET UNITYSDK_OFFSET(0x16D305D0)
#define RPG_GAMECORE_PHASESKILLINFOMAPPINGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x16D30690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhaseSkillInfoMappingList_TypeDefinitionIndex = 14891;
