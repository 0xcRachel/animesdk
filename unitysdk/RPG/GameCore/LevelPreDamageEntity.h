...
#define RPG_GAMECORE_LEVELPREDAMAGEENTITY_CLEAR_OFFSET UNITYSDK_OFFSET(0xA4AB2B0)
#define RPG_GAMECORE_LEVELPREDAMAGEENTITY_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA4AB360)
#define RPG_GAMECORE_LEVELPREDAMAGEENTITY_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA4AB310)
#define RPG_GAMECORE_LEVELPREDAMAGEENTITY_GET_ABILITYID_OFFSET UNITYSDK_OFFSET(0xA4AB410)
#define RPG_GAMECORE_LEVELPREDAMAGEENTITY_GET_ATTACKDATAREF_OFFSET UNITYSDK_OFFSET(0xA4AB3D0)
#define RPG_GAMECORE_LEVELPREDAMAGEENTITY_GET_ATTACKERENTITYREF_OFFSET UNITYSDK_OFFSET(0xA4AB450)
#define RPG_GAMECORE_LEVELPREDAMAGEENTITY_GET_ATTACKERID_OFFSET UNITYSDK_OFFSET(0xA4AB430)
#define RPG_GAMECORE_LEVELPREDAMAGEENTITY_GET_CUSTOMNAME_OFFSET UNITYSDK_OFFSET(0xA4AB3F0)
#define RPG_GAMECORE_LEVELPREDAMAGEENTITY_GET_DAMAGEDATAREF_OFFSET UNITYSDK_OFFSET(0xA4AB3B0)
#define RPG_GAMECORE_LEVELPREDAMAGEENTITY_GET_DEFENDERENTITYREF_OFFSET UNITYSDK_OFFSET(0xA4AB490)
#define RPG_GAMECORE_LEVELPREDAMAGEENTITY_GET_DEFENDERID_OFFSET UNITYSDK_OFFSET(0xA4AB470)
#define RPG_GAMECORE_LEVELPREDAMAGEENTITY_GET_HPDAMAGEMULTIPLIER_OFFSET UNITYSDK_OFFSET(0xA4AB4D0)
#define RPG_GAMECORE_LEVELPREDAMAGEENTITY_GET_HPDAMAGE_OFFSET UNITYSDK_OFFSET(0xA4AB4B0)
#define RPG_GAMECORE_LEVELPREDAMAGEENTITY_GET_STANCEDAMAGE_OFFSET UNITYSDK_OFFSET(0xA4AB4F0)
#define RPG_GAMECORE_LEVELPREDAMAGEENTITY_GET_STANCEELEMENTRATIO_OFFSET UNITYSDK_OFFSET(0xA4AB510)
#define RPG_GAMECORE_LEVELPREDAMAGEENTITY_INIT_OFFSET UNITYSDK_OFFSET(0xA4AB000)
#define RPG_GAMECORE_LEVELPREDAMAGEENTITY_SET_ABILITYID_OFFSET UNITYSDK_OFFSET(0xA4AB420)
#define RPG_GAMECORE_LEVELPREDAMAGEENTITY_SET_ATTACKDATAREF_OFFSET UNITYSDK_OFFSET(0xA4AB3E0)
#define RPG_GAMECORE_LEVELPREDAMAGEENTITY_SET_ATTACKERENTITYREF_OFFSET UNITYSDK_OFFSET(0xA4AB460)
#define RPG_GAMECORE_LEVELPREDAMAGEENTITY_SET_ATTACKERID_OFFSET UNITYSDK_OFFSET(0xA4AB440)
#define RPG_GAMECORE_LEVELPREDAMAGEENTITY_SET_CUSTOMNAME_OFFSET UNITYSDK_OFFSET(0xA4AB400)
#define RPG_GAMECORE_LEVELPREDAMAGEENTITY_SET_DAMAGEDATAREF_OFFSET UNITYSDK_OFFSET(0xA4AB3C0)
#define RPG_GAMECORE_LEVELPREDAMAGEENTITY_SET_DEFENDERENTITYREF_OFFSET UNITYSDK_OFFSET(0xA4AB4A0)
#define RPG_GAMECORE_LEVELPREDAMAGEENTITY_SET_DEFENDERID_OFFSET UNITYSDK_OFFSET(0xA4AB480)
#define RPG_GAMECORE_LEVELPREDAMAGEENTITY_SET_HPDAMAGEMULTIPLIER_OFFSET UNITYSDK_OFFSET(0xA4AB4E0)
#define RPG_GAMECORE_LEVELPREDAMAGEENTITY_SET_HPDAMAGE_OFFSET UNITYSDK_OFFSET(0xA4AB4C0)
#define RPG_GAMECORE_LEVELPREDAMAGEENTITY_SET_STANCEDAMAGE_OFFSET UNITYSDK_OFFSET(0xA4AB500)
#define RPG_GAMECORE_LEVELPREDAMAGEENTITY_SET_STANCEELEMENTRATIO_OFFSET UNITYSDK_OFFSET(0xA4AB520)
#define RPG_GAMECORE_LEVELPREDAMAGEENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0xA4AB530)
#define RPG_GAMECORE_LEVELPREDAMAGEENTITY___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0xA4AB540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPreDamageEntity_TypeDefinitionIndex = 44573;
	...
	public:
		...
		::RPG::GameCore::AttackData* _AttackDataRef_k__BackingField; // 0x30
		...
		::System::UInt32 _DefenderID_k__BackingField; // 0x58
		::System::UInt32 _AttackerID_k__BackingField; // 0x5C
		::RPG::GameCore::FixPoint _HPDamageMultiplier_k__BackingField; // 0x60
		::RPG::GameCore::FixPoint _StanceElementRatio_k__BackingField; // 0x68
		...
		::RPG::GameCore::LevelPreDamageEntity* Init(::Class_1_843DD6330B22E422* pDamageData, ::RPG::GameCore::AttackData* pAttackData, ::System::String* sAbilityID, ::RPG::GameCore::GameEntity* pAttacker, ::RPG::GameCore::GameEntity* pDefender, ::RPG::GameCore::FixPoint fHPDamage, ::RPG::GameCore::FixPoint fHPDamageMultiplier, ::RPG::GameCore::FixPoint fStanceElementRatio, ::RPG::GameCore::FixPoint fStanceDamage, ::System::String* customName)
		{
			return ((::RPG::GameCore::LevelPreDamageEntity*(*)(::PVOID, ::Class_1_843DD6330B22E422*, ::RPG::GameCore::AttackData*, ::System::String*, ::RPG::GameCore::GameEntity*, ::RPG::GameCore::GameEntity*, ::RPG::GameCore::FixPoint, ::RPG::GameCore::FixPoint, ::RPG::GameCore::FixPoint, ::RPG::GameCore::FixPoint, ::System::String*))((::PBYTE)hIl2Cpp + RPG_GAMECORE_LEVELPREDAMAGEENTITY_INIT_OFFSET))(this, pDamageData, pAttackData, sAbilityID, pAttacker, pDefender, fHPDamage, fHPDamageMultiplier, fStanceElementRatio, fStanceDamage, customName);
		}
		...
		::System::Void set_DamageDataRef(::Class_1_843DD6330B22E422* value)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_843DD6330B22E422*))((::PBYTE)hIl2Cpp + RPG_GAMECORE_LEVELPREDAMAGEENTITY_SET_DAMAGEDATAREF_OFFSET))(this, value);
		}
