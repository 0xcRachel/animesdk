...
#define RPG_GAMECORE_ELFFARMGAMEPLAYINIT_METHOD_3_303C7927CFAD6B6C_OFFSET UNITYSDK_OFFSET(0x1914F400)
#define RPG_GAMECORE_ELFFARMGAMEPLAYINIT_METHOD_3_D53C0252AE924560_OFFSET UNITYSDK_OFFSET(0x1914F2F0)
#define RPG_GAMECORE_ELFFARMGAMEPLAYINIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1914F3D0)
