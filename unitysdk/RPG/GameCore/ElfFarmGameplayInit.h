...
#define RPG_GAMECORE_ELFFARMGAMEPLAYINIT_METHOD_3_303C7927CFAD6B6C_OFFSET UNITYSDK_OFFSET(0x19D6B3D0)
#define RPG_GAMECORE_ELFFARMGAMEPLAYINIT_METHOD_3_D53C0252AE924560_OFFSET UNITYSDK_OFFSET(0x19D6B2C0)
#define RPG_GAMECORE_ELFFARMGAMEPLAYINIT__CTOR_OFFSET UNITYSDK_OFFSET(0x19D6B3A0)
