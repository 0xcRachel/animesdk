...
#define RPG_GAMECORE_CHIMERADUELTALKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16999A00)
#define RPG_GAMECORE_CHIMERADUELTALKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16999C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelTalkRow_TypeDefinitionIndex = 10359;

	class ChimeraDuelTalkRow : public ::System::Object
	{
	public:
		::RPG::Client::TextID ChimeraDuelTalkText; // 0x10
		::RPG::GameCore::ChimeraDuelTalkType Type; // 0x20
