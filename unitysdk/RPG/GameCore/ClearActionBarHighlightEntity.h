...
#define RPG_GAMECORE_CLEARACTIONBARHIGHLIGHTENTITY_METHOD_3_ADDB0D0726F41EB5_OFFSET UNITYSDK_OFFSET(0x170C5870)
#define RPG_GAMECORE_CLEARACTIONBARHIGHLIGHTENTITY_METHOD_3_C79C01BEDB139444_OFFSET UNITYSDK_OFFSET(0x170C57F0)
#define RPG_GAMECORE_CLEARACTIONBARHIGHLIGHTENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x170C5840)
