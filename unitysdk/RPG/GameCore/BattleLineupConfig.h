...
#define RPG_GAMECORE_BATTLELINEUPCONFIG_METHOD_2_CE3B5EDCD21307FE_OFFSET UNITYSDK_OFFSET(0x168DC810)
#define RPG_GAMECORE_BATTLELINEUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x168DCA50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleLineupConfig_TypeDefinitionIndex = 16266;
