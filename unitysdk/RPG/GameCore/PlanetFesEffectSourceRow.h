...
#define RPG_GAMECORE_PLANETFESEFFECTSOURCEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16D46440)
#define RPG_GAMECORE_PLANETFESEFFECTSOURCEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16D46630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlanetFesEffectSourceRow_TypeDefinitionIndex = 11059;
