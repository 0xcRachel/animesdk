...
#define RPG_GAMECORE_TUTORIALSETMONOPOLYTOASTPAUSESTATE_METHOD_3_375FD8AFE62136E3_OFFSET UNITYSDK_OFFSET(0x17137830)
#define RPG_GAMECORE_TUTORIALSETMONOPOLYTOASTPAUSESTATE_METHOD_3_8EEA12F24660C0DA_OFFSET UNITYSDK_OFFSET(0x171377B0)
#define RPG_GAMECORE_TUTORIALSETMONOPOLYTOASTPAUSESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17137800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialSetMonopolyToastPauseState_TypeDefinitionIndex = 21844;
