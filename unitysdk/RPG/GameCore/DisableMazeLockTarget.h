...
#define RPG_GAMECORE_DISABLEMAZELOCKTARGET_METHOD_3_A8F197A596744DDB_OFFSET UNITYSDK_OFFSET(0x1A0A2180)
#define RPG_GAMECORE_DISABLEMAZELOCKTARGET_METHOD_3_C5F557868227D07F_OFFSET UNITYSDK_OFFSET(0x1A0A2200)
#define RPG_GAMECORE_DISABLEMAZELOCKTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0A21D0)
