...
#define RPG_GAMECORE_PREAVATARLEVELINGTEMPLATEDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A774250)
#define RPG_GAMECORE_PREAVATARLEVELINGTEMPLATEDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A774640)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::UInt32 BossMaterialAmount; // 0x10
		::System::UInt32 TracksDestinyAmount; // 0x14
		::System::UInt32 ExpAmount; // 0x18
		::System::UInt32 WorldMaterialSmallAmount; // 0x1C
		::System::UInt32 SkillMaterialLargeAmount; // 0x20
		::System::UInt32 SkillMaterialSmallAmount; // 0x24
		...
		::System::UInt32 SkillMaterialMediumAmount; // 0x3C
