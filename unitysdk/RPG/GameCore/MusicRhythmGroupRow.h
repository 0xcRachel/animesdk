...
#define RPG_GAMECORE_MUSICRHYTHMGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x190FABC0)
#define RPG_GAMECORE_MUSICRHYTHMGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x190FB740)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::System::Single>* InputTimeList; // 0x18
