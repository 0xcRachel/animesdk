...
#define RPG_GAMECORE_GRIDFIGHTROLEBACKENDRANKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A1B8860)
#define RPG_GAMECORE_GRIDFIGHTROLEBACKENDRANKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1B8ED0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::System::String*>* RankAbility; // 0x38
		::Il2CppArray<::System::UInt32>* ExtraEffectIDList; // 0x40
		::Il2CppArray<::RPG::GameCore::AvatarPropertyValue*>* AllMemberGeneralPropertyList; // 0x48
		::RPG::Client::TextID Name; // 0x50
		::RPG::GameCore::FixPoint ModifyEnergyBar; // 0x60
