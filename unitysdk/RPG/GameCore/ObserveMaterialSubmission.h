...
#define RPG_GAMECORE_OBSERVEMATERIALSUBMISSION_METHOD_3_0952501E522A47D1_OFFSET UNITYSDK_OFFSET(0x1748DA80)
#define RPG_GAMECORE_OBSERVEMATERIALSUBMISSION_METHOD_3_C514CD9E1480042E_OFFSET UNITYSDK_OFFSET(0x1748DA00)
#define RPG_GAMECORE_OBSERVEMATERIALSUBMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1748DA50)
