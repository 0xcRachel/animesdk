...
#define RPG_GAMECORE_SETPROPINTERACTBTNSWITCH_METHOD_3_2128FD4285021B4B_OFFSET UNITYSDK_OFFSET(0x199C2B60)
#define RPG_GAMECORE_SETPROPINTERACTBTNSWITCH_METHOD_3_7DC99BC079961EE2_OFFSET UNITYSDK_OFFSET(0x199C2AE0)
#define RPG_GAMECORE_SETPROPINTERACTBTNSWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x199C2B30)
