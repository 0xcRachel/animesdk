...
#define RPG_GAMECORE_LEVELGROUPRANDOMINITCONTROL_METHOD_2_9E0CC66326787510_OFFSET UNITYSDK_OFFSET(0x18A2F0A0)
#define RPG_GAMECORE_LEVELGROUPRANDOMINITCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x18A2F2C0)
