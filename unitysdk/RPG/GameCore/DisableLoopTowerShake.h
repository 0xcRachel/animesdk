...
#define RPG_GAMECORE_DISABLELOOPTOWERSHAKE_METHOD_3_7295B2E47476DDD0_OFFSET UNITYSDK_OFFSET(0x1A0A1FC0)
#define RPG_GAMECORE_DISABLELOOPTOWERSHAKE_METHOD_3_7BB980DBED906B89_OFFSET UNITYSDK_OFFSET(0x1A0A2040)
#define RPG_GAMECORE_DISABLELOOPTOWERSHAKE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0A2010)
