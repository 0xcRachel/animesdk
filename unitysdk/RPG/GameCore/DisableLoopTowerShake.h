...
#define RPG_GAMECORE_DISABLELOOPTOWERSHAKE_METHOD_3_7295B2E47476DDD0_OFFSET UNITYSDK_OFFSET(0x16A44290)
#define RPG_GAMECORE_DISABLELOOPTOWERSHAKE_METHOD_3_7BB980DBED906B89_OFFSET UNITYSDK_OFFSET(0x16A44310)
#define RPG_GAMECORE_DISABLELOOPTOWERSHAKE__CTOR_OFFSET UNITYSDK_OFFSET(0x16A442E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DisableLoopTowerShake_TypeDefinitionIndex = 20552;
