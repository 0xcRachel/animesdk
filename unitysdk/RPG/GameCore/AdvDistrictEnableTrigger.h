...
#define RPG_GAMECORE_ADVDISTRICTENABLETRIGGER_METHOD_3_0B2789046BD20C83_OFFSET UNITYSDK_OFFSET(0x16831CD0)
#define RPG_GAMECORE_ADVDISTRICTENABLETRIGGER_METHOD_3_B7A340D71081FC2C_OFFSET UNITYSDK_OFFSET(0x16831B20)
#define RPG_GAMECORE_ADVDISTRICTENABLETRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x16831C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvDistrictEnableTrigger_TypeDefinitionIndex = 18970;
