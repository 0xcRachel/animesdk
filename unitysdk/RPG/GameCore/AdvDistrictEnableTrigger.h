...
#define RPG_GAMECORE_ADVDISTRICTENABLETRIGGER_METHOD_3_0B2789046BD20C83_OFFSET UNITYSDK_OFFSET(0x18DC0A20)
#define RPG_GAMECORE_ADVDISTRICTENABLETRIGGER_METHOD_3_B7A340D71081FC2C_OFFSET UNITYSDK_OFFSET(0x18DC0870)
#define RPG_GAMECORE_ADVDISTRICTENABLETRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x18DC0960)
