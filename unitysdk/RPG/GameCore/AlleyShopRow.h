...
#define RPG_GAMECORE_ALLEYSHOPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16880C30)
#define RPG_GAMECORE_ALLEYSHOPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x168812B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AlleyShopRow_TypeDefinitionIndex = 11423;
