...
#define RPG_GAMECORE_JSONENUMCONFIG_METHOD_2_9976CA213120D4FE_OFFSET UNITYSDK_OFFSET(0x16B9ADA0)
#define RPG_GAMECORE_JSONENUMCONFIG_METHOD_2_B6EBCDA4CA6601FB_OFFSET UNITYSDK_OFFSET(0x16B9ACC0)
#define RPG_GAMECORE_JSONENUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16B9AD90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int JsonEnumConfig_TypeDefinitionIndex = 15409;
