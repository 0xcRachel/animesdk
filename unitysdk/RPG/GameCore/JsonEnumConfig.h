...
#define RPG_GAMECORE_JSONENUMCONFIG_METHOD_2_9976CA213120D4FE_OFFSET UNITYSDK_OFFSET(0x188A8040)
#define RPG_GAMECORE_JSONENUMCONFIG_METHOD_2_B6EBCDA4CA6601FB_OFFSET UNITYSDK_OFFSET(0x188A7F60)
#define RPG_GAMECORE_JSONENUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188A8030)
