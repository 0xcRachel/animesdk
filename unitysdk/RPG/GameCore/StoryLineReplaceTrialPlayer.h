...
#define RPG_GAMECORE_STORYLINEREPLACETRIALPLAYER_METHOD_3_202679E5F7870EB9_OFFSET UNITYSDK_OFFSET(0x16FA0D90)
#define RPG_GAMECORE_STORYLINEREPLACETRIALPLAYER_METHOD_3_E5E55548F560F8A9_OFFSET UNITYSDK_OFFSET(0x16FA0D00)
#define RPG_GAMECORE_STORYLINEREPLACETRIALPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x16FA0D60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StoryLineReplaceTrialPlayer_TypeDefinitionIndex = 19312;
