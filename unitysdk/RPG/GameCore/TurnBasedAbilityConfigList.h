...
#define RPG_GAMECORE_TURNBASEDABILITYCONFIGLIST_METHOD_2_41D4756FDE70FD55_OFFSET UNITYSDK_OFFSET(0x19122C40)
#define RPG_GAMECORE_TURNBASEDABILITYCONFIGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x19122F30)
