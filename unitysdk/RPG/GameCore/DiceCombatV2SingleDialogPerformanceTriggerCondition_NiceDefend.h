...
#define RPG_GAMECORE_DICECOMBATV2SINGLEDIALOGPERFORMANCETRIGGERCONDITION_NICEDEFEND_METHOD_3_A908C534FE7E2613_OFFSET UNITYSDK_OFFSET(0x1A0A1240)
#define RPG_GAMECORE_DICECOMBATV2SINGLEDIALOGPERFORMANCETRIGGERCONDITION_NICEDEFEND_METHOD_3_C2EE12075EA4446F_OFFSET UNITYSDK_OFFSET(0x1A0A0EC0)
#define RPG_GAMECORE_DICECOMBATV2SINGLEDIALOGPERFORMANCETRIGGERCONDITION_NICEDEFEND__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0A0EB0)
