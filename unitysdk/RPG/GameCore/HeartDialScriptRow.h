...
#define RPG_GAMECORE_HEARTDIALSCRIPTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x172AD9F0)
#define RPG_GAMECORE_HEARTDIALSCRIPTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x172ADE20)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 ScriptID; // 0x28
		::RPG::GameCore::HeartDialEmoType DefaultEmoType; // 0x2C
		::System::UInt32 ControlDialogueID; // 0x30
		::System::UInt32 LockDialogueID; // 0x34
		::System::UInt32 RaidID; // 0x38
