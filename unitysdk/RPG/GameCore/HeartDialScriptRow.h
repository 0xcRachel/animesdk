...
#define RPG_GAMECORE_HEARTDIALSCRIPTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18A67700)
#define RPG_GAMECORE_HEARTDIALSCRIPTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18A67B30)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 MissingDialogueID; // 0x34
		::System::UInt32 LockDialogueID; // 0x38
		::System::UInt32 ControlDialogueID; // 0x3C
