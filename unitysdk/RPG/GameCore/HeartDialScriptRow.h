...
#define RPG_GAMECORE_HEARTDIALSCRIPTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A1D4870)
#define RPG_GAMECORE_HEARTDIALSCRIPTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1D4C00)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 FullDialogueID; // 0x44
