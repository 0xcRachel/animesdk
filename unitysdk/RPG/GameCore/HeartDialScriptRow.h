...
#define RPG_GAMECORE_HEARTDIALSCRIPTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B5F330)
#define RPG_GAMECORE_HEARTDIALSCRIPTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B5F760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HeartDialScriptRow_TypeDefinitionIndex = 12481;
	...
	public:
		...
		::System::UInt32 MissingDialogueID; // 0x2C
		::System::UInt32 UnLockDialogueID; // 0x30
		::System::UInt32 ScriptID; // 0x34
		::System::UInt32 FullDialogueID; // 0x38
		::System::UInt32 RaidID; // 0x3C
		::System::UInt32 LockDialogueID; // 0x40
		::RPG::GameCore::HeartDialEmoType DefaultEmoType; // 0x44
