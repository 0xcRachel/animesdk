...
#define RPG_GAMECORE_ROGUEARCADECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16E17880)
#define RPG_GAMECORE_ROGUEARCADECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16E17A30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueArcadeConfigRow_TypeDefinitionIndex = 13327;
