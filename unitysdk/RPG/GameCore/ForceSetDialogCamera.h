...
#define RPG_GAMECORE_FORCESETDIALOGCAMERA_METHOD_3_794C130D10C15C99_OFFSET UNITYSDK_OFFSET(0x191FDDF0)
#define RPG_GAMECORE_FORCESETDIALOGCAMERA_METHOD_3_9C2337C39EC7E5E0_OFFSET UNITYSDK_OFFSET(0x191FDE70)
#define RPG_GAMECORE_FORCESETDIALOGCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x191FDE40)
