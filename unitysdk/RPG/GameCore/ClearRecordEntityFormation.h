...
#define RPG_GAMECORE_CLEARRECORDENTITYFORMATION_METHOD_3_5AAA2A9C4BB85C04_OFFSET UNITYSDK_OFFSET(0x1A30F4D0)
#define RPG_GAMECORE_CLEARRECORDENTITYFORMATION_METHOD_3_F61AFA2B464C0135_OFFSET UNITYSDK_OFFSET(0x1A30F450)
#define RPG_GAMECORE_CLEARRECORDENTITYFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A30F4A0)
