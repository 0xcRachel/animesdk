...
#define RPG_GAMECORE_ACTIONTRIGGERACTIONWITHCONDITIONCONFIG_METHOD_4_55830174BA5E80BC_OFFSET UNITYSDK_OFFSET(0x1988DCE0)
#define RPG_GAMECORE_ACTIONTRIGGERACTIONWITHCONDITIONCONFIG_METHOD_4_B7A5B6BEA7B0CE5C_OFFSET UNITYSDK_OFFSET(0x1988DDC0)
#define RPG_GAMECORE_ACTIONTRIGGERACTIONWITHCONDITIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1988DD70)
