...
#define RPG_GAMECORE_GROUPINITMEMBERENTITYPROPSTATE_METHOD_3_7A4D24A3E51708DF_OFFSET UNITYSDK_OFFSET(0x1A1C7580)
#define RPG_GAMECORE_GROUPINITMEMBERENTITYPROPSTATE_METHOD_3_EFBC9EBD04853BE1_OFFSET UNITYSDK_OFFSET(0x1A1C7500)
#define RPG_GAMECORE_GROUPINITMEMBERENTITYPROPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1C7550)
