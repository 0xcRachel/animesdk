...
#define RPG_GAMECORE_HALFBOOMERANGPROJECTILEDATA_METHOD_3_28EFDCFEDE9F7CE6_OFFSET UNITYSDK_OFFSET(0x172A7580)
#define RPG_GAMECORE_HALFBOOMERANGPROJECTILEDATA_METHOD_3_D64C167A4B585F96_OFFSET UNITYSDK_OFFSET(0x172A75F0)
#define RPG_GAMECORE_HALFBOOMERANGPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x172A75D0)
