...
#define RPG_GAMECORE_HALFBOOMERANGPROJECTILEDATA_METHOD_3_28EFDCFEDE9F7CE6_OFFSET UNITYSDK_OFFSET(0x16B58EA0)
#define RPG_GAMECORE_HALFBOOMERANGPROJECTILEDATA_METHOD_3_D64C167A4B585F96_OFFSET UNITYSDK_OFFSET(0x16B58F10)
#define RPG_GAMECORE_HALFBOOMERANGPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16B58EF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HalfBoomerangProjectileData_TypeDefinitionIndex = 14235;
