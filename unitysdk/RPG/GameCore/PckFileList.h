...
#define RPG_GAMECORE_PCKFILELIST_METHOD_2_8FFFB367162E3E69_OFFSET UNITYSDK_OFFSET(0x16D1BFD0)
#define RPG_GAMECORE_PCKFILELIST__CTOR_OFFSET UNITYSDK_OFFSET(0x16D1C0D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PckFileList_TypeDefinitionIndex = 14754;
