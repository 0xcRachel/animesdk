...
#define RPG_GAMECORE_SHOWTUTORIALBLOCKMASK_METHOD_3_55ADE0AD0526495F_OFFSET UNITYSDK_OFFSET(0x16F64800)
#define RPG_GAMECORE_SHOWTUTORIALBLOCKMASK_METHOD_3_992FC7772A15E344_OFFSET UNITYSDK_OFFSET(0x16F64890)
#define RPG_GAMECORE_SHOWTUTORIALBLOCKMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x16F64860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowTutorialBlockMask_TypeDefinitionIndex = 21823;
