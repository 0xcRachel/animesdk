...
#define RPG_GAMECORE_STAGEHARMONYTRAFFICLIGHTMONOSERIALIZATION_METHOD_2_3D0A5585FC21E325_OFFSET UNITYSDK_OFFSET(0x16F87120)
#define RPG_GAMECORE_STAGEHARMONYTRAFFICLIGHTMONOSERIALIZATION__CTOR_OFFSET UNITYSDK_OFFSET(0x16F87240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StageHarmonyTrafficLightMonoSerialization_TypeDefinitionIndex = 17210;
