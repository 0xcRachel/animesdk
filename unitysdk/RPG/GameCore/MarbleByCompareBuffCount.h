...
#define RPG_GAMECORE_MARBLEBYCOMPAREBUFFCOUNT_METHOD_4_18092CD8BD7D0D28_OFFSET UNITYSDK_OFFSET(0x1739DDA0)
#define RPG_GAMECORE_MARBLEBYCOMPAREBUFFCOUNT_METHOD_4_ECEB6B69DEBDE5EA_OFFSET UNITYSDK_OFFSET(0x1739DE80)
#define RPG_GAMECORE_MARBLEBYCOMPAREBUFFCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1739DE30)
