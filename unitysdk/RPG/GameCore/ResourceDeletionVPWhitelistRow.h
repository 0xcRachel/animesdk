...
#define RPG_GAMECORE_RESOURCEDELETIONVPWHITELISTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16DE84C0)
#define RPG_GAMECORE_RESOURCEDELETIONVPWHITELISTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16DE85F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResourceDeletionVPWhitelistRow_TypeDefinitionIndex = 13306;
