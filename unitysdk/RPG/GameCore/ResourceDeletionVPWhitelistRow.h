...
#define RPG_GAMECORE_RESOURCEDELETIONVPWHITELISTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x175B5650)
#define RPG_GAMECORE_RESOURCEDELETIONVPWHITELISTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x175B5780)
