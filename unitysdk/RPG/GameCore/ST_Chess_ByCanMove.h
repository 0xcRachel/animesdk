...
#define RPG_GAMECORE_ST_CHESS_BYCANMOVE_METHOD_4_4D5B13B218CB351C_OFFSET UNITYSDK_OFFSET(0x16EF1650)
#define RPG_GAMECORE_ST_CHESS_BYCANMOVE_METHOD_4_B20BEABD76F27D56_OFFSET UNITYSDK_OFFSET(0x16EF1580)
#define RPG_GAMECORE_ST_CHESS_BYCANMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x16EF1600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Chess_ByCanMove_TypeDefinitionIndex = 21440;
