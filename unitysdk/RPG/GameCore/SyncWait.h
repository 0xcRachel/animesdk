...
#define RPG_GAMECORE_SYNCWAIT_METHOD_3_0E6A27BDB61D3998_OFFSET UNITYSDK_OFFSET(0x1986C9D0)
#define RPG_GAMECORE_SYNCWAIT_METHOD_3_975D5E4811DC7471_OFFSET UNITYSDK_OFFSET(0x1986C950)
#define RPG_GAMECORE_SYNCWAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1986C9A0)
