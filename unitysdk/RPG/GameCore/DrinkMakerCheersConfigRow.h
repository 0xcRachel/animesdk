...
#define RPG_GAMECORE_DRINKMAKERCHEERSCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16A47F60)
#define RPG_GAMECORE_DRINKMAKERCHEERSCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16A48500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DrinkMakerCheersConfigRow_TypeDefinitionIndex = 11976;
	...
	public:
		...
		::RPG::Client::TextID OriginalName; // 0x40
		::RPG::Client::TextID AvatarRequestText; // 0x50
		::RPG::Client::TextID Contraindications; // 0x60
		::System::UInt32 DrinkNameTextJoinID; // 0x70
		::RPG::Client::TextID TagName; // 0x78
		::RPG::GameCore::DrinkMakerRequestMode Mode; // 0x88
