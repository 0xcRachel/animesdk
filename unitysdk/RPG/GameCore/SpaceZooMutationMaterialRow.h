...
#define RPG_GAMECORE_SPACEZOOMUTATIONMATERIALROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16F74CE0)
#define RPG_GAMECORE_SPACEZOOMUTATIONMATERIALROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16F753D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SpaceZooMutationMaterialRow_TypeDefinitionIndex = 11222;

	class SpaceZooMutationMaterialRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* ChangeFeatureList; // 0x10
