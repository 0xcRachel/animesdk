...
#define RPG_GAMECORE_UNLOCKTARGETHP_METHOD_3_22C91DB2516703F3_OFFSET UNITYSDK_OFFSET(0x1713F9B0)
#define RPG_GAMECORE_UNLOCKTARGETHP_METHOD_3_F4DFD397728D9327_OFFSET UNITYSDK_OFFSET(0x1713F930)
#define RPG_GAMECORE_UNLOCKTARGETHP__CTOR_OFFSET UNITYSDK_OFFSET(0x1713F980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UnlockTargetHP_TypeDefinitionIndex = 21301;
