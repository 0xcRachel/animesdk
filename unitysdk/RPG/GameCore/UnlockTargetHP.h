...
#define RPG_GAMECORE_UNLOCKTARGETHP_METHOD_3_22C91DB2516703F3_OFFSET UNITYSDK_OFFSET(0x178FBBB0)
#define RPG_GAMECORE_UNLOCKTARGETHP_METHOD_3_F4DFD397728D9327_OFFSET UNITYSDK_OFFSET(0x178FBB30)
#define RPG_GAMECORE_UNLOCKTARGETHP__CTOR_OFFSET UNITYSDK_OFFSET(0x178FBB80)
