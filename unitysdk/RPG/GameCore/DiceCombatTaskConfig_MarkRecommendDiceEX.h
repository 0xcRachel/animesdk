...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MARKRECOMMENDDICEEX_METHOD_3_BD515427C5DE297E_OFFSET UNITYSDK_OFFSET(0x1A09EF70)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MARKRECOMMENDDICEEX_METHOD_3_DC4E4C8219B8C893_OFFSET UNITYSDK_OFFSET(0x1A099640)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MARKRECOMMENDDICEEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0995F0)
