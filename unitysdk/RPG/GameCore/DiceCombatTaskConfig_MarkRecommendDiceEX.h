...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MARKRECOMMENDDICEEX_METHOD_3_B9C8F9A92F3DAE35_OFFSET UNITYSDK_OFFSET(0x195A6220)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MARKRECOMMENDDICEEX_METHOD_3_E0B6A2FC5DBD141E_OFFSET UNITYSDK_OFFSET(0x195A1340)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MARKRECOMMENDDICEEX__CTOR_OFFSET UNITYSDK_OFFSET(0x195A12F0)
