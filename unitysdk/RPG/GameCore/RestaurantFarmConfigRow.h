...
#define RPG_GAMECORE_RESTAURANTFARMCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A2F41C0)
#define RPG_GAMECORE_RESTAURANTFARMCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2F4440)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::RestaurantFarmType Type; // 0x24
		::System::UInt32 FarmID; // 0x28
