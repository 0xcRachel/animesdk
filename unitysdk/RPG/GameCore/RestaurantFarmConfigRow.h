...
#define RPG_GAMECORE_RESTAURANTFARMCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19034BC0)
#define RPG_GAMECORE_RESTAURANTFARMCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19034E50)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::RestaurantFarmType Type; // 0x3C
