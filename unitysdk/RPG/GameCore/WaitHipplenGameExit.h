...
#define RPG_GAMECORE_WAITHIPPLENGAMEEXIT_METHOD_3_0AD3FAF81BC699B8_OFFSET UNITYSDK_OFFSET(0x1952DA80)
#define RPG_GAMECORE_WAITHIPPLENGAMEEXIT_METHOD_3_C07D9255E29A9BE4_OFFSET UNITYSDK_OFFSET(0x1952DB90)
#define RPG_GAMECORE_WAITHIPPLENGAMEEXIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1952DB60)
