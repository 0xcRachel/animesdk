...
#define RPG_GAMECORE_SWITCHHANDLAYITEM_METHOD_3_27B623279493809A_OFFSET UNITYSDK_OFFSET(0x1985DE10)
#define RPG_GAMECORE_SWITCHHANDLAYITEM_METHOD_3_B46724EE08669C0C_OFFSET UNITYSDK_OFFSET(0x1985DE90)
#define RPG_GAMECORE_SWITCHHANDLAYITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1985DE60)
