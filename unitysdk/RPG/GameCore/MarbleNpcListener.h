...
#define RPG_GAMECORE_MARBLENPCLISTENER_METHOD_3_1E7E0F2FF1479E0B_OFFSET UNITYSDK_OFFSET(0x16C42A80)
#define RPG_GAMECORE_MARBLENPCLISTENER_METHOD_3_F1D60CDB0FF45867_OFFSET UNITYSDK_OFFSET(0x16C42B00)
#define RPG_GAMECORE_MARBLENPCLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x16C42AD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleNpcListener_TypeDefinitionIndex = 19692;
