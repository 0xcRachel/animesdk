...
#define RPG_GAMECORE_MAZEPUZZLESWITCHMASCOTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x173DF1F0)
#define RPG_GAMECORE_MAZEPUZZLESWITCHMASCOTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x173DF600)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::Class_1_A88C3AAF0DD46F4C_10*>* CoinPropID; // 0x48
