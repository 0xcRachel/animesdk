...
#define RPG_GAMECORE_MAZEPUZZLESWITCHMASCOTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x190904A0)
#define RPG_GAMECORE_MAZEPUZZLESWITCHMASCOTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x190908B0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::Class_1_ADE34076259CCCF7_2*>* Section3LoadEntityList; // 0x18
