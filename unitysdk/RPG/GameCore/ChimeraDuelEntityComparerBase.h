...
#define RPG_GAMECORE_CHIMERADUELENTITYCOMPARERBASE_METHOD_3_2F2752BFA6007FBF_OFFSET UNITYSDK_OFFSET(0x170AEF30)
#define RPG_GAMECORE_CHIMERADUELENTITYCOMPARERBASE_METHOD_3_E078793C714C45E9_OFFSET UNITYSDK_OFFSET(0x170AF230)
#define RPG_GAMECORE_CHIMERADUELENTITYCOMPARERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x170AF2F0)
