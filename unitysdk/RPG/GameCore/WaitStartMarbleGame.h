...
#define RPG_GAMECORE_WAITSTARTMARBLEGAME_METHOD_3_3525050CA83ED32F_OFFSET UNITYSDK_OFFSET(0x1715D710)
#define RPG_GAMECORE_WAITSTARTMARBLEGAME_METHOD_3_526BC2826A6E863E_OFFSET UNITYSDK_OFFSET(0x1715D690)
#define RPG_GAMECORE_WAITSTARTMARBLEGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1715D6E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitStartMarbleGame_TypeDefinitionIndex = 19690;
