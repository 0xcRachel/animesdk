...
#define RPG_GAMECORE_WAITSTARTMARBLEGAME_METHOD_3_3525050CA83ED32F_OFFSET UNITYSDK_OFFSET(0x17919C30)
#define RPG_GAMECORE_WAITSTARTMARBLEGAME_METHOD_3_526BC2826A6E863E_OFFSET UNITYSDK_OFFSET(0x17919BB0)
#define RPG_GAMECORE_WAITSTARTMARBLEGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x17919C00)
