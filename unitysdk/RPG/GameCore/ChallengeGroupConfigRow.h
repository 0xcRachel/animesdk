...
#define RPG_GAMECORE_CHALLENGEGROUPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19E8E090)
#define RPG_GAMECORE_CHALLENGEGROUPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19E8E9E0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 PreMissionID; // 0x48
		::System::UInt32 MazeBuffID; // 0x4C
		::System::UInt32 RewardLineGroupID; // 0x50
		::System::UInt32 MappingInfoID; // 0x54
		::RPG::GameCore::ChallengeGroupType ChallengeGroupType; // 0x58
		::System::UInt32 ScheduleDataID; // 0x5C
		::System::UInt32 MapEntranceID; // 0x60
		::System::UInt32 TierceID; // 0x64
