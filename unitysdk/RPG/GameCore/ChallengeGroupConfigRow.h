...
#define RPG_GAMECORE_CHALLENGEGROUPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18D49220)
#define RPG_GAMECORE_CHALLENGEGROUPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18D49B50)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::ChallengeGroupType ChallengeGroupType; // 0x5C
