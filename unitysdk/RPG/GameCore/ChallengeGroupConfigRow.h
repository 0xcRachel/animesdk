...
#define RPG_GAMECORE_CHALLENGEGROUPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1695CE10)
#define RPG_GAMECORE_CHALLENGEGROUPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1695D7B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChallengeGroupConfigRow_TypeDefinitionIndex = 11748;
	...
	public:
		...
		::System::UInt32 GlobalScheduleID; // 0x38
		::System::UInt32 WorldID; // 0x3C
		::RPG::Client::TextID GroupName; // 0x40
		::RPG::GameCore::ChallengeGroupType ChallengeGroupType; // 0x50
		::System::UInt32 PreMissionID; // 0x54
		::System::UInt32 ScheduleDataID; // 0x58
		::System::UInt32 GroupID; // 0x5C
		::System::UInt32 MapEntranceID; // 0x60
		::System::UInt32 RewardLineGroupID; // 0x64
