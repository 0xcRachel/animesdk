...
#define RPG_GAMECORE_ADDMISSIONMENUITEM_METHOD_3_6EBA08D46D0F51D2_OFFSET UNITYSDK_OFFSET(0x167BC900)
#define RPG_GAMECORE_ADDMISSIONMENUITEM_METHOD_3_D6691F3D56C5DFED_OFFSET UNITYSDK_OFFSET(0x167BC870)
#define RPG_GAMECORE_ADDMISSIONMENUITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x167BC8D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddMissionMenuItem_TypeDefinitionIndex = 18909;
