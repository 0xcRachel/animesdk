...
#define RPG_GAMECORE_ADDMISSIONMENUITEM_METHOD_3_6EBA08D46D0F51D2_OFFSET UNITYSDK_OFFSET(0x18DB4B70)
#define RPG_GAMECORE_ADDMISSIONMENUITEM_METHOD_3_D6691F3D56C5DFED_OFFSET UNITYSDK_OFFSET(0x18DB4AE0)
#define RPG_GAMECORE_ADDMISSIONMENUITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x18DB4B40)
