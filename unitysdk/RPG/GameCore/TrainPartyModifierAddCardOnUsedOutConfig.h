...
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDCARDONUSEDOUTCONFIG_METHOD_3_6F57B9A142B6C581_OFFSET UNITYSDK_OFFSET(0x17104EE0)
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDCARDONUSEDOUTCONFIG_METHOD_3_BA3030EB43A742E5_OFFSET UNITYSDK_OFFSET(0x17104F30)
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDCARDONUSEDOUTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17104F20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierAddCardOnUsedOutConfig_TypeDefinitionIndex = 16252;
