...
#define RPG_GAMECORE_SETCOMPONENTASSETLOADSTATEWITHANIMSTATE_METHOD_3_2CCAEB995ABB0AFB_OFFSET UNITYSDK_OFFSET(0x176C4C90)
#define RPG_GAMECORE_SETCOMPONENTASSETLOADSTATEWITHANIMSTATE_METHOD_3_8F734A944FEB00A7_OFFSET UNITYSDK_OFFSET(0x176C4D60)
#define RPG_GAMECORE_SETCOMPONENTASSETLOADSTATEWITHANIMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x176C4D10)
