...
#define RPG_GAMECORE_BASEADVENTURECAMERALOOKAT_METHOD_3_788438D614F85474_OFFSET UNITYSDK_OFFSET(0x168C8E80)
#define RPG_GAMECORE_BASEADVENTURECAMERALOOKAT_METHOD_3_B61871BC8193DACB_OFFSET UNITYSDK_OFFSET(0x168C8C90)
#define RPG_GAMECORE_BASEADVENTURECAMERALOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x168C8E40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseAdventureCameraLookAt_TypeDefinitionIndex = 21416;
