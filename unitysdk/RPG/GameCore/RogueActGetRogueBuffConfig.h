...
#define RPG_GAMECORE_ROGUEACTGETROGUEBUFFCONFIG_METHOD_6_C781D89B0997505A_OFFSET UNITYSDK_OFFSET(0x1A9A4470)
#define RPG_GAMECORE_ROGUEACTGETROGUEBUFFCONFIG_METHOD_6_FCD3053D93366AFF_OFFSET UNITYSDK_OFFSET(0x1A9A4690)
#define RPG_GAMECORE_ROGUEACTGETROGUEBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9A45B0)
