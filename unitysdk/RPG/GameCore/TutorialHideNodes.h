...
#define RPG_GAMECORE_TUTORIALHIDENODES_METHOD_3_089EAAFD819404A4_OFFSET UNITYSDK_OFFSET(0x1912DAD0)
#define RPG_GAMECORE_TUTORIALHIDENODES_METHOD_3_46DA45E098894395_OFFSET UNITYSDK_OFFSET(0x1912DB50)
#define RPG_GAMECORE_TUTORIALHIDENODES__CTOR_OFFSET UNITYSDK_OFFSET(0x1912DB20)
