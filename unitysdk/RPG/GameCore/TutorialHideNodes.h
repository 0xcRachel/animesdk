...
#define RPG_GAMECORE_TUTORIALHIDENODES_METHOD_3_089EAAFD819404A4_OFFSET UNITYSDK_OFFSET(0x17135650)
#define RPG_GAMECORE_TUTORIALHIDENODES_METHOD_3_46DA45E098894395_OFFSET UNITYSDK_OFFSET(0x171356D0)
#define RPG_GAMECORE_TUTORIALHIDENODES__CTOR_OFFSET UNITYSDK_OFFSET(0x171356A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialHideNodes_TypeDefinitionIndex = 21856;
