...
#define RPG_GAMECORE_ROGUEACTGETROGUEMIRACLEEXCONFIG_METHOD_6_7D6DA958BDEEABD4_OFFSET UNITYSDK_OFFSET(0x1A9A5A40)
#define RPG_GAMECORE_ROGUEACTGETROGUEMIRACLEEXCONFIG_METHOD_6_B8F7251FCA69EFB9_OFFSET UNITYSDK_OFFSET(0x1A9A5820)
#define RPG_GAMECORE_ROGUEACTGETROGUEMIRACLEEXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9A5960)
