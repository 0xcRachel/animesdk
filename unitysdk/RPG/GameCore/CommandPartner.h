...
#define RPG_GAMECORE_COMMANDPARTNER_METHOD_3_3BAB360B61A771DF_OFFSET UNITYSDK_OFFSET(0x169B8A20)
#define RPG_GAMECORE_COMMANDPARTNER_METHOD_3_C70F11EC73D4C6EB_OFFSET UNITYSDK_OFFSET(0x169B8AA0)
#define RPG_GAMECORE_COMMANDPARTNER__CTOR_OFFSET UNITYSDK_OFFSET(0x169B8A70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CommandPartner_TypeDefinitionIndex = 20335;
