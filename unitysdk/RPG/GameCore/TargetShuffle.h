...
#define RPG_GAMECORE_TARGETSHUFFLE_METHOD_3_1D5CF062A0A7A4C9_OFFSET UNITYSDK_OFFSET(0x171352E0)
#define RPG_GAMECORE_TARGETSHUFFLE_METHOD_3_5398DF62FE539598_OFFSET UNITYSDK_OFFSET(0x17132E50)
#define RPG_GAMECORE_TARGETSHUFFLE__CTOR_OFFSET UNITYSDK_OFFSET(0x17132E30)
