...
#define RPG_GAMECORE_BYISTURNACTIONENTITY_METHOD_4_18BE1406EF5D374D_OFFSET UNITYSDK_OFFSET(0x16938270)
#define RPG_GAMECORE_BYISTURNACTIONENTITY_METHOD_4_ED99CE0F686B6DAB_OFFSET UNITYSDK_OFFSET(0x169381A0)
#define RPG_GAMECORE_BYISTURNACTIONENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x16938220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsTurnActionEntity_TypeDefinitionIndex = 20184;
