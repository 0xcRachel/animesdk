...
#define RPG_GAMECORE_TEXTJOINCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19480C10)
#define RPG_GAMECORE_TEXTJOINCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19480E20)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 DefaultItem; // 0x1C
