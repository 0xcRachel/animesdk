...
#define RPG_GAMECORE_PROPDESTRUCT_METHOD_3_17B0A56EAB7FD5B1_OFFSET UNITYSDK_OFFSET(0x191C1A50)
#define RPG_GAMECORE_PROPDESTRUCT_METHOD_3_B78BC2DC70B922EE_OFFSET UNITYSDK_OFFSET(0x191C1730)
#define RPG_GAMECORE_PROPDESTRUCT__CTOR_OFFSET UNITYSDK_OFFSET(0x191C19C0)
