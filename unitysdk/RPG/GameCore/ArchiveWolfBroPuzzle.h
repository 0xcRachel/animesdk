...
#define RPG_GAMECORE_ARCHIVEWOLFBROPUZZLE_METHOD_3_0CA63096CBFE809C_OFFSET UNITYSDK_OFFSET(0x1688BB90)
#define RPG_GAMECORE_ARCHIVEWOLFBROPUZZLE_METHOD_3_0FEF0F36814C832D_OFFSET UNITYSDK_OFFSET(0x1688BC10)
#define RPG_GAMECORE_ARCHIVEWOLFBROPUZZLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1688BBE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ArchiveWolfBroPuzzle_TypeDefinitionIndex = 19642;
