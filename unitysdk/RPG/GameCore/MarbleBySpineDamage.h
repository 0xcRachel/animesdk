...
#define RPG_GAMECORE_MARBLEBYSPINEDAMAGE_METHOD_4_BC0877A8EB614198_OFFSET UNITYSDK_OFFSET(0x18FEA7C0)
#define RPG_GAMECORE_MARBLEBYSPINEDAMAGE_METHOD_4_E22DE148A3A54E92_OFFSET UNITYSDK_OFFSET(0x18FEA8A0)
#define RPG_GAMECORE_MARBLEBYSPINEDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18FEA850)
