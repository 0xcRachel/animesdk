...
#define RPG_GAMECORE_MARBLEBYSPINEDAMAGE_METHOD_4_BC0877A8EB614198_OFFSET UNITYSDK_OFFSET(0x16C3B4F0)
#define RPG_GAMECORE_MARBLEBYSPINEDAMAGE_METHOD_4_E22DE148A3A54E92_OFFSET UNITYSDK_OFFSET(0x16C3B5D0)
#define RPG_GAMECORE_MARBLEBYSPINEDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16C3B580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleBySpineDamage_TypeDefinitionIndex = 15209;
