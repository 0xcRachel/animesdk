...
#define RPG_GAMECORE_SETDYNAMICVALUEBYRANDOM_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x16F254F0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYRANDOM_METHOD_4_90F561B106F30766_OFFSET UNITYSDK_OFFSET(0x16F25470)
#define RPG_GAMECORE_SETDYNAMICVALUEBYRANDOM_METHOD_4_C2DB25C86BAFAF87_OFFSET UNITYSDK_OFFSET(0x16F1E6D0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYRANDOM__CTOR_OFFSET UNITYSDK_OFFSET(0x16F1E680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRandom_TypeDefinitionIndex = 21547;
