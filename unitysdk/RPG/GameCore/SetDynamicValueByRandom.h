...
#define RPG_GAMECORE_SETDYNAMICVALUEBYRANDOM_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x199A9B80)
#define RPG_GAMECORE_SETDYNAMICVALUEBYRANDOM_METHOD_4_90F561B106F30766_OFFSET UNITYSDK_OFFSET(0x199A9820)
#define RPG_GAMECORE_SETDYNAMICVALUEBYRANDOM_METHOD_4_C2DB25C86BAFAF87_OFFSET UNITYSDK_OFFSET(0x199A98F0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYRANDOM__CTOR_OFFSET UNITYSDK_OFFSET(0x199A98A0)
