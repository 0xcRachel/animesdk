...
#define RPG_GAMECORE_ADVENTURESTACKPROPERTY_METHOD_3_64CDBC4F3CE6D4AC_OFFSET UNITYSDK_OFFSET(0x16861830)
#define RPG_GAMECORE_ADVENTURESTACKPROPERTY_METHOD_3_F444F0C9609E5CB1_OFFSET UNITYSDK_OFFSET(0x168617B0)
#define RPG_GAMECORE_ADVENTURESTACKPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x16861800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureStackProperty_TypeDefinitionIndex = 19402;
