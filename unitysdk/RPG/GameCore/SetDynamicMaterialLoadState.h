...
#define RPG_GAMECORE_SETDYNAMICMATERIALLOADSTATE_METHOD_3_140CDA269C42BC97_OFFSET UNITYSDK_OFFSET(0x1A1EEB60)
#define RPG_GAMECORE_SETDYNAMICMATERIALLOADSTATE_METHOD_3_679245ABD34F656A_OFFSET UNITYSDK_OFFSET(0x1A1EEA90)
#define RPG_GAMECORE_SETDYNAMICMATERIALLOADSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1EEB10)
