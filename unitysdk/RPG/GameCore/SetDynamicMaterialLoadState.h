...
#define RPG_GAMECORE_SETDYNAMICMATERIALLOADSTATE_METHOD_3_140CDA269C42BC97_OFFSET UNITYSDK_OFFSET(0x16F11DA0)
#define RPG_GAMECORE_SETDYNAMICMATERIALLOADSTATE_METHOD_3_679245ABD34F656A_OFFSET UNITYSDK_OFFSET(0x16F11CD0)
#define RPG_GAMECORE_SETDYNAMICMATERIALLOADSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F11D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicMaterialLoadState_TypeDefinitionIndex = 20455;
