...
#define RPG_GAMECORE_TARGETINDEX_METHOD_3_177DEFCF796591B3_OFFSET UNITYSDK_OFFSET(0x16FE0B20)
#define RPG_GAMECORE_TARGETINDEX_METHOD_3_5769A84CA2F290BA_OFFSET UNITYSDK_OFFSET(0x16FE0AB0)
#define RPG_GAMECORE_TARGETINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE0B00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetIndex_TypeDefinitionIndex = 21618;
