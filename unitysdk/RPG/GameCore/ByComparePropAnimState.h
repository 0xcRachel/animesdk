...
#define RPG_GAMECORE_BYCOMPAREPROPANIMSTATE_METHOD_4_2DAC096B4DD86DF5_OFFSET UNITYSDK_OFFSET(0x17026FD0)
#define RPG_GAMECORE_BYCOMPAREPROPANIMSTATE_METHOD_4_C94FF5F5C7AFDBBE_OFFSET UNITYSDK_OFFSET(0x17026E30)
#define RPG_GAMECORE_BYCOMPAREPROPANIMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17026F10)
