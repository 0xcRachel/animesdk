...
#define RPG_GAMECORE_TARGETFETCHENEMYINALERTRANGE_METHOD_4_B165FF4FBD73FB49_OFFSET UNITYSDK_OFFSET(0x16FDD390)
#define RPG_GAMECORE_TARGETFETCHENEMYINALERTRANGE_METHOD_4_C147F1CBEFDDE4CF_OFFSET UNITYSDK_OFFSET(0x16FD6B40)
#define RPG_GAMECORE_TARGETFETCHENEMYINALERTRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD6AC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchEnemyInAlertRange_TypeDefinitionIndex = 21608;
