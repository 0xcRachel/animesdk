...
#define RPG_GAMECORE_TARGETFETCHENEMYINALERTRANGE_METHOD_4_B165FF4FBD73FB49_OFFSET UNITYSDK_OFFSET(0x177D2D00)
#define RPG_GAMECORE_TARGETFETCHENEMYINALERTRANGE_METHOD_4_C147F1CBEFDDE4CF_OFFSET UNITYSDK_OFFSET(0x177C9800)
#define RPG_GAMECORE_TARGETFETCHENEMYINALERTRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x177C9780)
