...
#define RPG_GAMECORE_MARBLESEALLEVELCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18C1E3A0)
#define RPG_GAMECORE_MARBLESEALLEVELCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18C1E690)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 UnlockSkillID; // 0x18
		::System::UInt32 Level; // 0x1C
		::System::UInt32 ID; // 0x20
		::RPG::Client::TextID LevelUpDesc; // 0x28
		::RPG::Client::TextID LevelUpTitle; // 0x38
