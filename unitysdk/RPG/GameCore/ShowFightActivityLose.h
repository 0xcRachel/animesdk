...
#define RPG_GAMECORE_SHOWFIGHTACTIVITYLOSE_METHOD_3_035EE27F3E5A91C6_OFFSET UNITYSDK_OFFSET(0x16F596A0)
#define RPG_GAMECORE_SHOWFIGHTACTIVITYLOSE_METHOD_3_7F49AA775ED827FA_OFFSET UNITYSDK_OFFSET(0x16F59590)
#define RPG_GAMECORE_SHOWFIGHTACTIVITYLOSE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F59670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowFightActivityLose_TypeDefinitionIndex = 21131;
