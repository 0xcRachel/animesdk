...
#define RPG_GAMECORE_ACHIEVEMENTLEVELROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19885BD0)
#define RPG_GAMECORE_ACHIEVEMENTLEVELROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19886240)
