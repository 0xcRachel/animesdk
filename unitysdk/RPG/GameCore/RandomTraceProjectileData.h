...
#define RPG_GAMECORE_RANDOMTRACEPROJECTILEDATA_METHOD_3_24CD7DCCA59375AB_OFFSET UNITYSDK_OFFSET(0x16DC8B40)
#define RPG_GAMECORE_RANDOMTRACEPROJECTILEDATA_METHOD_3_B1B872F7DE4CEE53_OFFSET UNITYSDK_OFFSET(0x16DC8BB0)
#define RPG_GAMECORE_RANDOMTRACEPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16DC8B90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RandomTraceProjectileData_TypeDefinitionIndex = 14239;
