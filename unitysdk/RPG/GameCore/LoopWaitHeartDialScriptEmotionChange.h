...
#define RPG_GAMECORE_LOOPWAITHEARTDIALSCRIPTEMOTIONCHANGE_METHOD_3_2C6081F99449DE82_OFFSET UNITYSDK_OFFSET(0x16C204D0)
#define RPG_GAMECORE_LOOPWAITHEARTDIALSCRIPTEMOTIONCHANGE_METHOD_3_88A653BC4551A0C2_OFFSET UNITYSDK_OFFSET(0x16C20440)
#define RPG_GAMECORE_LOOPWAITHEARTDIALSCRIPTEMOTIONCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16C204A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitHeartDialScriptEmotionChange_TypeDefinitionIndex = 18994;
