...
#define RPG_GAMECORE_CHESSWAITANIMEVENT_METHOD_3_5311F2B9DDC18903_OFFSET UNITYSDK_OFFSET(0x170A3D20)
#define RPG_GAMECORE_CHESSWAITANIMEVENT_METHOD_3_D04720DB7860FF7A_OFFSET UNITYSDK_OFFSET(0x170A3DA0)
#define RPG_GAMECORE_CHESSWAITANIMEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x170A3D70)
