...
#define RPG_GAMECORE_CHESSWAITANIMEVENT_METHOD_3_5311F2B9DDC18903_OFFSET UNITYSDK_OFFSET(0x16981930)
#define RPG_GAMECORE_CHESSWAITANIMEVENT_METHOD_3_D04720DB7860FF7A_OFFSET UNITYSDK_OFFSET(0x169819B0)
#define RPG_GAMECORE_CHESSWAITANIMEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x16981980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChessWaitAnimEvent_TypeDefinitionIndex = 21426;
