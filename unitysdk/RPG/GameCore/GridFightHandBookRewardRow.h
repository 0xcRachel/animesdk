...
#define RPG_GAMECORE_GRIDFIGHTHANDBOOKREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B268A0)
#define RPG_GAMECORE_GRIDFIGHTHANDBOOKREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B26A00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightHandBookRewardRow_TypeDefinitionIndex = 12341;
