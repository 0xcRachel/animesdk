...
#define RPG_GAMECORE_RELICBASETYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16DD2E00)
#define RPG_GAMECORE_RELICBASETYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16DD3510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RelicBaseTypeRow_TypeDefinitionIndex = 13291;
