...
#define RPG_GAMECORE_ORBITMOVERANGE_METHOD_2_731DF61DB81F7654_OFFSET UNITYSDK_OFFSET(0x16D0F500)
#define RPG_GAMECORE_ORBITMOVERANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16D0F740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OrbitMoveRange_TypeDefinitionIndex = 20514;
