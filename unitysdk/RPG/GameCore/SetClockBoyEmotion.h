...
#define RPG_GAMECORE_SETCLOCKBOYEMOTION_METHOD_3_25F626A2D66BB02B_OFFSET UNITYSDK_OFFSET(0x16F0EA80)
#define RPG_GAMECORE_SETCLOCKBOYEMOTION_METHOD_3_9E12C3FB0BE884DA_OFFSET UNITYSDK_OFFSET(0x16F0EB00)
#define RPG_GAMECORE_SETCLOCKBOYEMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16F0EAD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetClockBoyEmotion_TypeDefinitionIndex = 19536;
