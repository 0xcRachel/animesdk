...
#define RPG_GAMECORE_CHIMERADUELSUMMONNODE_METHOD_3_1730EC81CD985747_OFFSET UNITYSDK_OFFSET(0x194C8E00)
#define RPG_GAMECORE_CHIMERADUELSUMMONNODE_METHOD_3_52F3CC04C7305341_OFFSET UNITYSDK_OFFSET(0x194C8C30)
#define RPG_GAMECORE_CHIMERADUELSUMMONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x194C8DA0)
