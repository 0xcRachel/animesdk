...
#define RPG_GAMECORE_MARBLEADDSCORE_METHOD_3_0D3B8D012F7B2574_OFFSET UNITYSDK_OFFSET(0x18FE6060)
#define RPG_GAMECORE_MARBLEADDSCORE_METHOD_3_6B69F31B7D9CE4D2_OFFSET UNITYSDK_OFFSET(0x18FE6140)
#define RPG_GAMECORE_MARBLEADDSCORE__CTOR_OFFSET UNITYSDK_OFFSET(0x18FE60F0)
