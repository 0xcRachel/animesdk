...
#define RPG_GAMECORE_UNLOCKTARGETSHIELD_METHOD_3_B38A20E846EF7FC8_OFFSET UNITYSDK_OFFSET(0x1713FB10)
#define RPG_GAMECORE_UNLOCKTARGETSHIELD_METHOD_3_C875B5A4D5E7C9CA_OFFSET UNITYSDK_OFFSET(0x1713FB90)
#define RPG_GAMECORE_UNLOCKTARGETSHIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x1713FB60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UnlockTargetShield_TypeDefinitionIndex = 21303;
