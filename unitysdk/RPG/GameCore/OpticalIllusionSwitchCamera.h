...
#define RPG_GAMECORE_OPTICALILLUSIONSWITCHCAMERA_METHOD_3_0C717D1873635530_OFFSET UNITYSDK_OFFSET(0x16D0D9F0)
#define RPG_GAMECORE_OPTICALILLUSIONSWITCHCAMERA_METHOD_3_338AF0F3B50C3AAD_OFFSET UNITYSDK_OFFSET(0x16D0D8A0)
#define RPG_GAMECORE_OPTICALILLUSIONSWITCHCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x16D0D960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OpticalIllusionSwitchCamera_TypeDefinitionIndex = 19876;
