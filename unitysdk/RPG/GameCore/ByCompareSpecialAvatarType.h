...
#define RPG_GAMECORE_BYCOMPARESPECIALAVATARTYPE_METHOD_4_4859B7814DC3AC38_OFFSET UNITYSDK_OFFSET(0x1702C1C0)
#define RPG_GAMECORE_BYCOMPARESPECIALAVATARTYPE_METHOD_4_810BE6FA90AF7850_OFFSET UNITYSDK_OFFSET(0x1702C290)
#define RPG_GAMECORE_BYCOMPARESPECIALAVATARTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1702C240)
