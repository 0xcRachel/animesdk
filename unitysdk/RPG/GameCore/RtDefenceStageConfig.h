...
#define RPG_GAMECORE_RTDEFENCESTAGECONFIG_METHOD_2_4474ECBCD203394A_OFFSET UNITYSDK_OFFSET(0x18E800C0)
#define RPG_GAMECORE_RTDEFENCESTAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18E80540)
