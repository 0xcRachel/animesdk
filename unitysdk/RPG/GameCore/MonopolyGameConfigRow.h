...
#define RPG_GAMECORE_MONOPOLYGAMECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1744EA80)
#define RPG_GAMECORE_MONOPOLYGAMECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1744EE60)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 RaiseCurveID; // 0x48
		::System::UInt32 GameID; // 0x4C
