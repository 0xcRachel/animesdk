...
{
	inline static constexpr unsigned int OpenUIPageTaskBase_1_TypeDefinitionIndex = 45916;

	template <typename TConfig>
	class OpenUIPageTaskBase_1 : public ::Class_1_5F51D4049EA87B7B
	{
	public:
		::Class_3_BCCE950C2E8DF1F0* _OnCancel; // 0x0
		::Class_3_BCCE950C2E8DF1F0* _OnUIEnter; // 0x0
