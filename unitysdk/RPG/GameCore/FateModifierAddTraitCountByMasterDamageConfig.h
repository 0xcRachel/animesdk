...
#define RPG_GAMECORE_FATEMODIFIERADDTRAITCOUNTBYMASTERDAMAGECONFIG_METHOD_3_137BB10490127512_OFFSET UNITYSDK_OFFSET(0x19474B30)
#define RPG_GAMECORE_FATEMODIFIERADDTRAITCOUNTBYMASTERDAMAGECONFIG_METHOD_3_1DC8496AA8F7C69B_OFFSET UNITYSDK_OFFSET(0x19474A60)
#define RPG_GAMECORE_FATEMODIFIERADDTRAITCOUNTBYMASTERDAMAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19474AE0)
