...
#define RPG_GAMECORE_GRIDFIGHTSHOWBATTLEEVENTHINT_METHOD_3_09205D896EB156EB_OFFSET UNITYSDK_OFFSET(0x16B48D50)
#define RPG_GAMECORE_GRIDFIGHTSHOWBATTLEEVENTHINT_METHOD_3_ED47131FF80E09EC_OFFSET UNITYSDK_OFFSET(0x16B48DD0)
#define RPG_GAMECORE_GRIDFIGHTSHOWBATTLEEVENTHINT__CTOR_OFFSET UNITYSDK_OFFSET(0x16B48DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightShowBattleEventHint_TypeDefinitionIndex = 20901;
