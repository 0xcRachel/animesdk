...
#define RPG_GAMECORE_FIVEDIMENTERDASHPREPARESTATEACTION_METHOD_3_36EF6A85E206F204_OFFSET UNITYSDK_OFFSET(0x171FBB20)
#define RPG_GAMECORE_FIVEDIMENTERDASHPREPARESTATEACTION_METHOD_3_72F4CFDDC773D75D_OFFSET UNITYSDK_OFFSET(0x17205090)
#define RPG_GAMECORE_FIVEDIMENTERDASHPREPARESTATEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x171FBB00)
