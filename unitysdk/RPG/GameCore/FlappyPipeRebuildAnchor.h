...
#define RPG_GAMECORE_FLAPPYPIPEREBUILDANCHOR_METHOD_3_22F1C11E62F975C1_OFFSET UNITYSDK_OFFSET(0x17226E60)
#define RPG_GAMECORE_FLAPPYPIPEREBUILDANCHOR_METHOD_3_EB89866F65AA40CD_OFFSET UNITYSDK_OFFSET(0x17226D30)
#define RPG_GAMECORE_FLAPPYPIPEREBUILDANCHOR__CTOR_OFFSET UNITYSDK_OFFSET(0x17226E40)
