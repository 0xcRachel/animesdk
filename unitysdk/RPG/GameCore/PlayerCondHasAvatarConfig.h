...
#define RPG_GAMECORE_PLAYERCONDHASAVATARCONFIG_METHOD_5_0F963D96DE8EB599_OFFSET UNITYSDK_OFFSET(0x19355980)
#define RPG_GAMECORE_PLAYERCONDHASAVATARCONFIG_METHOD_5_1469F88C2084826D_OFFSET UNITYSDK_OFFSET(0x19354C70)
#define RPG_GAMECORE_PLAYERCONDHASAVATARCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19354BB0)
