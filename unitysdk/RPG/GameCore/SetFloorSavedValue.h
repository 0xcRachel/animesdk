...
#define RPG_GAMECORE_SETFLOORSAVEDVALUE_METHOD_3_5438514AFF0ED806_OFFSET UNITYSDK_OFFSET(0x199B60C0)
#define RPG_GAMECORE_SETFLOORSAVEDVALUE_METHOD_3_CC49FB8F677CDD21_OFFSET UNITYSDK_OFFSET(0x199B6130)
#define RPG_GAMECORE_SETFLOORSAVEDVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x199B6100)
