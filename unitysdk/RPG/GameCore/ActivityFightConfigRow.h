...
#define RPG_GAMECORE_ACTIVITYFIGHTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16796680)
#define RPG_GAMECORE_ACTIVITYFIGHTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16796EA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityFightConfigRow_TypeDefinitionIndex = 10728;

	class ActivityFightConfigRow : public ::System::Object
	{
	public:
		::System::UInt32 FightEventID; // 0x10
		::System::UInt32 RewardWave2; // 0x14
