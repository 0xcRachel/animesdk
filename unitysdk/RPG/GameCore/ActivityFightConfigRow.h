...
#define RPG_GAMECORE_ACTIVITYFIGHTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x198A7D50)
#define RPG_GAMECORE_ACTIVITYFIGHTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x198A8580)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::LevelDifficulty DifficultyLevel; // 0x18
		::System::UInt32 RewardQuest; // 0x1C
		::System::UInt32 RewardWave2; // 0x20
		::System::UInt32 RewardID; // 0x24
		::System::UInt32 RoundsLimit; // 0x28
		::System::UInt32 RewardWave; // 0x2C
		::System::UInt32 FightEventID; // 0x30
