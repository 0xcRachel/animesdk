...
#define RPG_GAMECORE_MARBLEBYEXTRAROUND_METHOD_4_29E6C94AF86B2192_OFFSET UNITYSDK_OFFSET(0x16C3A500)
#define RPG_GAMECORE_MARBLEBYEXTRAROUND_METHOD_4_610DB39EF786CA98_OFFSET UNITYSDK_OFFSET(0x16C3A420)
#define RPG_GAMECORE_MARBLEBYEXTRAROUND__CTOR_OFFSET UNITYSDK_OFFSET(0x16C3A4B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleByExtraRound_TypeDefinitionIndex = 15208;
