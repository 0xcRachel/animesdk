...
#define RPG_GAMECORE_REMOVEMINIEMOEFFECT_METHOD_3_5236D6B96D867145_OFFSET UNITYSDK_OFFSET(0x16DE0060)
#define RPG_GAMECORE_REMOVEMINIEMOEFFECT_METHOD_3_81103B3332A73D40_OFFSET UNITYSDK_OFFSET(0x16DDFF90)
#define RPG_GAMECORE_REMOVEMINIEMOEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x16DE0010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveMiniEmoEffect_TypeDefinitionIndex = 19505;
