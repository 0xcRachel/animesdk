...
#define RPG_GAMECORE_CHIMERADUELREORDERCHIMERANODE_METHOD_3_35143B3CEB6472A3_OFFSET UNITYSDK_OFFSET(0x194C6850)
#define RPG_GAMECORE_CHIMERADUELREORDERCHIMERANODE_METHOD_3_659E048475A24F0C_OFFSET UNITYSDK_OFFSET(0x194C6710)
#define RPG_GAMECORE_CHIMERADUELREORDERCHIMERANODE__CTOR_OFFSET UNITYSDK_OFFSET(0x194C6800)
