...
#define RPG_GAMECORE_BYCOMPAREMUSICRHYTHMSONGID_METHOD_4_4A8E18261784EB02_OFFSET UNITYSDK_OFFSET(0x18FE1E90)
#define RPG_GAMECORE_BYCOMPAREMUSICRHYTHMSONGID_METHOD_4_6FC5CEB322AAAA7F_OFFSET UNITYSDK_OFFSET(0x18FE1CA0)
#define RPG_GAMECORE_BYCOMPAREMUSICRHYTHMSONGID_METHOD_4_7EB7BADC0CAA415E_OFFSET UNITYSDK_OFFSET(0x18FE1E10)
#define RPG_GAMECORE_BYCOMPAREMUSICRHYTHMSONGID_METHOD_4_B2A281183527795D_OFFSET UNITYSDK_OFFSET(0x18FE1BD0)
#define RPG_GAMECORE_BYCOMPAREMUSICRHYTHMSONGID__CTOR_OFFSET UNITYSDK_OFFSET(0x18FE1C50)
