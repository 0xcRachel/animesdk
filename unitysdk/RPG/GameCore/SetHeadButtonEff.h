...
#define RPG_GAMECORE_SETHEADBUTTONEFF_METHOD_3_3FC2025C12863CA8_OFFSET UNITYSDK_OFFSET(0x16F30150)
#define RPG_GAMECORE_SETHEADBUTTONEFF_METHOD_3_92FC4603BC3C9554_OFFSET UNITYSDK_OFFSET(0x16F30080)
#define RPG_GAMECORE_SETHEADBUTTONEFF__CTOR_OFFSET UNITYSDK_OFFSET(0x16F30100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetHeadButtonEff_TypeDefinitionIndex = 20388;
