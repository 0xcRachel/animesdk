...
#define RPG_GAMECORE_ACTIONCOUNTDOWNPREVIEW_METHOD_3_6524D7D3ABE9A225_OFFSET UNITYSDK_OFFSET(0x16778D00)
#define RPG_GAMECORE_ACTIONCOUNTDOWNPREVIEW_METHOD_3_7A6AA11A9D2740E6_OFFSET UNITYSDK_OFFSET(0x16778C80)
#define RPG_GAMECORE_ACTIONCOUNTDOWNPREVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x16778CD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActionCountDownPreview_TypeDefinitionIndex = 21384;
