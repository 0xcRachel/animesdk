...
#define RPG_GAMECORE_ACTIONCOUNTDOWNPREVIEW_METHOD_3_6524D7D3ABE9A225_OFFSET UNITYSDK_OFFSET(0x198888C0)
#define RPG_GAMECORE_ACTIONCOUNTDOWNPREVIEW_METHOD_3_7A6AA11A9D2740E6_OFFSET UNITYSDK_OFFSET(0x19888840)
#define RPG_GAMECORE_ACTIONCOUNTDOWNPREVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x19888890)
