...
#define RPG_GAMECORE_BYDRINKMAKERCHEERSSTORYLASTMAKEDDRINKISPOSITIVE_METHOD_4_D973F3B160988C88_OFFSET UNITYSDK_OFFSET(0x16924150)
#define RPG_GAMECORE_BYDRINKMAKERCHEERSSTORYLASTMAKEDDRINKISPOSITIVE_METHOD_4_E81942FA86F181E2_OFFSET UNITYSDK_OFFSET(0x16924220)
#define RPG_GAMECORE_BYDRINKMAKERCHEERSSTORYLASTMAKEDDRINKISPOSITIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x169241D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByDrinkMakerCheersStoryLastMakedDrinkIsPositive_TypeDefinitionIndex = 19357;
