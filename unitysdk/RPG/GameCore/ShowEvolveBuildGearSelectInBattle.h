...
#define RPG_GAMECORE_SHOWEVOLVEBUILDGEARSELECTINBATTLE_METHOD_3_58CF6F557FA05C95_OFFSET UNITYSDK_OFFSET(0x1A000880)
#define RPG_GAMECORE_SHOWEVOLVEBUILDGEARSELECTINBATTLE_METHOD_3_9A23D3757FFC3D7B_OFFSET UNITYSDK_OFFSET(0x1A000800)
#define RPG_GAMECORE_SHOWEVOLVEBUILDGEARSELECTINBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A000850)
