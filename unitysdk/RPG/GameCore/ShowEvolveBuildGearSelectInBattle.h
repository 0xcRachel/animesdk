...
#define RPG_GAMECORE_SHOWEVOLVEBUILDGEARSELECTINBATTLE_METHOD_3_3097F67FF7FCF859_OFFSET UNITYSDK_OFFSET(0x1770DF70)
#define RPG_GAMECORE_SHOWEVOLVEBUILDGEARSELECTINBATTLE_METHOD_3_3E587C535A578BF7_OFFSET UNITYSDK_OFFSET(0x1770DFF0)
#define RPG_GAMECORE_SHOWEVOLVEBUILDGEARSELECTINBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1770DFC0)
