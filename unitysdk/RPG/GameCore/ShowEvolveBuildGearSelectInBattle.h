...
#define RPG_GAMECORE_SHOWEVOLVEBUILDGEARSELECTINBATTLE_METHOD_3_3097F67FF7FCF859_OFFSET UNITYSDK_OFFSET(0x16F58A20)
#define RPG_GAMECORE_SHOWEVOLVEBUILDGEARSELECTINBATTLE_METHOD_3_3E587C535A578BF7_OFFSET UNITYSDK_OFFSET(0x16F58AA0)
#define RPG_GAMECORE_SHOWEVOLVEBUILDGEARSELECTINBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F58A70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowEvolveBuildGearSelectInBattle_TypeDefinitionIndex = 20154;
