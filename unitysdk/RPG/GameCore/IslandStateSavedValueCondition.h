...
#define RPG_GAMECORE_ISLANDSTATESAVEDVALUECONDITION_METHOD_2_062FF7EBE42549AF_OFFSET UNITYSDK_OFFSET(0x16B87830)
#define RPG_GAMECORE_ISLANDSTATESAVEDVALUECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x16B879D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IslandStateSavedValueCondition_TypeDefinitionIndex = 17141;
