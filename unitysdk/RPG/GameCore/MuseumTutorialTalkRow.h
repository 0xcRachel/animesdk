...
#define RPG_GAMECORE_MUSEUMTUTORIALTALKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16CF3D90)
#define RPG_GAMECORE_MUSEUMTUTORIALTALKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16CF3E90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MuseumTutorialTalkRow_TypeDefinitionIndex = 12981;
