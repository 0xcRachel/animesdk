...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::VoicePlayType>**)Il2CppClass::FromTypeDefinitionIndex(PerformanceAudioEventConfig___O_TypeDefinitionIndex)->GetStaticField(0x38E80);
		}
	};
}
