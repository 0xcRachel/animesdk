...
#define RPG_GAMECORE_WAITSUBMISSIONSTATECHANGE_METHOD_4_113D8121111FE529_OFFSET UNITYSDK_OFFSET(0x1715DC50)
#define RPG_GAMECORE_WAITSUBMISSIONSTATECHANGE_METHOD_4_79E550A93A6019F8_OFFSET UNITYSDK_OFFSET(0x1715DD30)
#define RPG_GAMECORE_WAITSUBMISSIONSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1715DCD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitSubMissionStateChange_TypeDefinitionIndex = 18525;
