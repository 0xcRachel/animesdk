...
#define RPG_GAMECORE_BOXINGCLUBCHALLENGECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x187C5AC0)
#define RPG_GAMECORE_BOXINGCLUBCHALLENGECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x187C6570)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 SpecialAvatarActivityModule; // 0x38
		::System::UInt32 FirstPassRewardID; // 0x3C
		::RPG::Client::TextID Name; // 0x40
		::System::UInt32 PreChallengeID; // 0x50
		::RPG::GameCore::BoxingClubActivityType Type; // 0x54
		::System::UInt32 PerfectTurn; // 0x58
