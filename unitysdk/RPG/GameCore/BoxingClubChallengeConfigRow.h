...
#define RPG_GAMECORE_BOXINGCLUBCHALLENGECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17007020)
#define RPG_GAMECORE_BOXINGCLUBCHALLENGECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17007AD0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 PerfectTurn; // 0x3C
		::System::UInt32 ActivityModuleID; // 0x40
		::System::UInt32 PreChallengeID; // 0x44
		::System::UInt32 ChallengeTurnLimit; // 0x48
		::RPG::GameCore::BoxingClubActivityType Type; // 0x4C
		::RPG::Client::TextID Name; // 0x50
		::System::Boolean IsSpecialChallenge; // 0x60
		::System::UInt32 SpecialAvatarActivityModule; // 0x64
		::System::UInt32 FirstPassRewardID; // 0x68
