...
#define RPG_GAMECORE_CAKERACEACTIONSPAWNAOEONCURSECTIONROWS_METHOD_3_CFBBF0E5D06805FD_OFFSET UNITYSDK_OFFSET(0x19A7C1E0)
#define RPG_GAMECORE_CAKERACEACTIONSPAWNAOEONCURSECTIONROWS_METHOD_3_F27966EF4AE4A2C2_OFFSET UNITYSDK_OFFSET(0x19A7D520)
#define RPG_GAMECORE_CAKERACEACTIONSPAWNAOEONCURSECTIONROWS__CTOR_OFFSET UNITYSDK_OFFSET(0x19A7C1C0)
