...
#define RPG_GAMECORE_SETTRACEORIGAMIFLAG_METHOD_3_4D550F98A6CF6B8C_OFFSET UNITYSDK_OFFSET(0x16F44100)
#define RPG_GAMECORE_SETTRACEORIGAMIFLAG_METHOD_3_939B4861772FF118_OFFSET UNITYSDK_OFFSET(0x16F44210)
#define RPG_GAMECORE_SETTRACEORIGAMIFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F441E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTraceOrigamiFlag_TypeDefinitionIndex = 19508;
