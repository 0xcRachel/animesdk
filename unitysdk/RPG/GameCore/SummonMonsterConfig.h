...
#define RPG_GAMECORE_SUMMONMONSTERCONFIG_METHOD_2_85AB3E37885635D0_OFFSET UNITYSDK_OFFSET(0x19855900)
#define RPG_GAMECORE_SUMMONMONSTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x198559C0)
