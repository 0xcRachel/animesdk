...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_9EB2CB86795DEEF1_DelegateParseJson_1<::RPG::GameCore::AIStatus>**)Il2CppClass::FromTypeDefinitionIndex(RA_ByAIStatus___O_TypeDefinitionIndex)->GetStaticField(0x3A3C0);
		}
	};
}
