...
#define RPG_GAMECORE_REMOVEROGUENPCINOTHERGROUP_METHOD_3_4C0017D8827AB24C_OFFSET UNITYSDK_OFFSET(0x190290E0)
#define RPG_GAMECORE_REMOVEROGUENPCINOTHERGROUP_METHOD_3_E44211447E09DECC_OFFSET UNITYSDK_OFFSET(0x19029050)
#define RPG_GAMECORE_REMOVEROGUENPCINOTHERGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x190290B0)
