...
#define RPG_GAMECORE_FIVEDIMSPAWNARROWACTION_METHOD_3_6DFF692D8777714A_OFFSET UNITYSDK_OFFSET(0x1A3A4E40)
#define RPG_GAMECORE_FIVEDIMSPAWNARROWACTION_METHOD_3_AA30613C2FEF2F3B_OFFSET UNITYSDK_OFFSET(0x1A3A4EB0)
#define RPG_GAMECORE_FIVEDIMSPAWNARROWACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3A4E90)
