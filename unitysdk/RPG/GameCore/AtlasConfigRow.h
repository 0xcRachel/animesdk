...
#define RPG_GAMECORE_ATLASCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x168902F0)
#define RPG_GAMECORE_ATLASCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16890470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AtlasConfigRow_TypeDefinitionIndex = 11495;
