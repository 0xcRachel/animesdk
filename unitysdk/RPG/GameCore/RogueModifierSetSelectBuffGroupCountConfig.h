...
#define RPG_GAMECORE_ROGUEMODIFIERSETSELECTBUFFGROUPCOUNTCONFIG_METHOD_3_2866AD7D95FCEBD7_OFFSET UNITYSDK_OFFSET(0x17641910)
#define RPG_GAMECORE_ROGUEMODIFIERSETSELECTBUFFGROUPCOUNTCONFIG_METHOD_3_C3D3F9AB4313A6DE_OFFSET UNITYSDK_OFFSET(0x1764DD30)
#define RPG_GAMECORE_ROGUEMODIFIERSETSELECTBUFFGROUPCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176418C0)
