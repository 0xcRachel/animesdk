...
#define RPG_GAMECORE_FOURROTATEVOXELLEVELUICONFIG_METHOD_2_93CADE53B9442E9D_OFFSET UNITYSDK_OFFSET(0x16AE52E0)
#define RPG_GAMECORE_FOURROTATEVOXELLEVELUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16AE6020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxelLevelUIConfig_TypeDefinitionIndex = 15090;
