...
#define RPG_GAMECORE_STACKCUSTOMUNSELECTABLE_METHOD_3_42C6E6F7FD7DF644_OFFSET UNITYSDK_OFFSET(0x16F81850)
#define RPG_GAMECORE_STACKCUSTOMUNSELECTABLE_METHOD_3_4D835971E4BBCC53_OFFSET UNITYSDK_OFFSET(0x16F817C0)
#define RPG_GAMECORE_STACKCUSTOMUNSELECTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F81820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StackCustomUnselectable_TypeDefinitionIndex = 21406;
