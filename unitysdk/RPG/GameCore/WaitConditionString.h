...
#define RPG_GAMECORE_WAITCONDITIONSTRING_METHOD_3_89EAEA962FBAD69E_OFFSET UNITYSDK_OFFSET(0x195275C0)
#define RPG_GAMECORE_WAITCONDITIONSTRING_METHOD_3_EF88A1D09BD35B1E_OFFSET UNITYSDK_OFFSET(0x19527780)
#define RPG_GAMECORE_WAITCONDITIONSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x19527750)
