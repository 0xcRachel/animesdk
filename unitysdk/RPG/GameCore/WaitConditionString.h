...
#define RPG_GAMECORE_WAITCONDITIONSTRING_METHOD_3_89EAEA962FBAD69E_OFFSET UNITYSDK_OFFSET(0x1714E3A0)
#define RPG_GAMECORE_WAITCONDITIONSTRING_METHOD_3_EF88A1D09BD35B1E_OFFSET UNITYSDK_OFFSET(0x1714E560)
#define RPG_GAMECORE_WAITCONDITIONSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1714E530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitConditionString_TypeDefinitionIndex = 18231;
