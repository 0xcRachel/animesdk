...
#define RPG_GAMECORE_TRIGGERSTANCECOUNTDOWN_METHOD_3_041D4D513B190AE6_OFFSET UNITYSDK_OFFSET(0x171276C0)
#define RPG_GAMECORE_TRIGGERSTANCECOUNTDOWN_METHOD_3_EED7840A49DB6C25_OFFSET UNITYSDK_OFFSET(0x17127750)
#define RPG_GAMECORE_TRIGGERSTANCECOUNTDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x17127720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerStanceCountDown_TypeDefinitionIndex = 20356;
