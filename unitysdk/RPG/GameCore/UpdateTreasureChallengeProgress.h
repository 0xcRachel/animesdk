...
#define RPG_GAMECORE_UPDATETREASURECHALLENGEPROGRESS_METHOD_3_0DB01052B866BAD8_OFFSET UNITYSDK_OFFSET(0x19513BF0)
#define RPG_GAMECORE_UPDATETREASURECHALLENGEPROGRESS_METHOD_3_FBB29ECEC90C3D80_OFFSET UNITYSDK_OFFSET(0x19513C70)
#define RPG_GAMECORE_UPDATETREASURECHALLENGEPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x19513C40)
