...
#define RPG_GAMECORE_FUNCTIONHUDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16AED460)
#define RPG_GAMECORE_FUNCTIONHUDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16AED710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FunctionHudConfigRow_TypeDefinitionIndex = 12078;
