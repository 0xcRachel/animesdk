...
#define RPG_GAMECORE_LEVELOBJECTINFO_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x16BB2CF0)
#define RPG_GAMECORE_LEVELOBJECTINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16BB2370)
#define RPG_GAMECORE_LEVELOBJECTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16BB2CE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelObjectInfo_TypeDefinitionIndex = 15556;
