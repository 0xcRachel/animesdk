...
#define RPG_GAMECORE_COMMONSKILL_METHOD_2_B7610CFABEEF3452_OFFSET UNITYSDK_OFFSET(0x171358C0)
#define RPG_GAMECORE_COMMONSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x171359F0)
