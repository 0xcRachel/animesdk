...
#define RPG_GAMECORE_ADVSETUPCUSTOMTASKTRIGGER_METHOD_3_08AD533224B1CD59_OFFSET UNITYSDK_OFFSET(0x18C5DE70)
#define RPG_GAMECORE_ADVSETUPCUSTOMTASKTRIGGER_METHOD_3_C2E3732AD3286C97_OFFSET UNITYSDK_OFFSET(0x18C5DEF0)
#define RPG_GAMECORE_ADVSETUPCUSTOMTASKTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x18C5DEC0)
