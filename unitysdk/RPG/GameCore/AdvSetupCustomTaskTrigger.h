...
#define RPG_GAMECORE_ADVSETUPCUSTOMTASKTRIGGER_METHOD_3_628C568DFD6E75E1_OFFSET UNITYSDK_OFFSET(0x19BF5A50)
#define RPG_GAMECORE_ADVSETUPCUSTOMTASKTRIGGER_METHOD_3_A8FD16AD33D4A51C_OFFSET UNITYSDK_OFFSET(0x19BF5AD0)
#define RPG_GAMECORE_ADVSETUPCUSTOMTASKTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x19BF5AA0)
