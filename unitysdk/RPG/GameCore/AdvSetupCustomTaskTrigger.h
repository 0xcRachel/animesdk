...
#define RPG_GAMECORE_ADVSETUPCUSTOMTASKTRIGGER_METHOD_3_08AD533224B1CD59_OFFSET UNITYSDK_OFFSET(0x1684A7C0)
#define RPG_GAMECORE_ADVSETUPCUSTOMTASKTRIGGER_METHOD_3_C2E3732AD3286C97_OFFSET UNITYSDK_OFFSET(0x1684A840)
#define RPG_GAMECORE_ADVSETUPCUSTOMTASKTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1684A810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetupCustomTaskTrigger_TypeDefinitionIndex = 18320;
