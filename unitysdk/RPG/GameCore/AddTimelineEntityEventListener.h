...
#define RPG_GAMECORE_ADDTIMELINEENTITYEVENTLISTENER_METHOD_3_13CA3526F700C1C2_OFFSET UNITYSDK_OFFSET(0x167BFE90)
#define RPG_GAMECORE_ADDTIMELINEENTITYEVENTLISTENER_METHOD_3_30D3145A18E263D7_OFFSET UNITYSDK_OFFSET(0x167BFF10)
#define RPG_GAMECORE_ADDTIMELINEENTITYEVENTLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x167BFEE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddTimelineEntityEventListener_TypeDefinitionIndex = 18428;
