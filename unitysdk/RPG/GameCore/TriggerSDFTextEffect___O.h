...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_9EB2CB86795DEEF1_DelegateParseJson_1<::RPG::GameCore::MonoEffectFlag>**)Il2CppClass::FromTypeDefinitionIndex(TriggerSDFTextEffect___O_TypeDefinitionIndex)->GetStaticField(0x7460);
		}
	};
}
