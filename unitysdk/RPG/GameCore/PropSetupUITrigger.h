...
#define RPG_GAMECORE_PROPSETUPUITRIGGER_METHOD_3_77D0AB6BD96A31EF_OFFSET UNITYSDK_OFFSET(0x16DB59C0)
#define RPG_GAMECORE_PROPSETUPUITRIGGER_METHOD_3_895B3E23A8ABBD65_OFFSET UNITYSDK_OFFSET(0x16DB5810)
#define RPG_GAMECORE_PROPSETUPUITRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x16DB5900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropSetupUITrigger_TypeDefinitionIndex = 18158;
