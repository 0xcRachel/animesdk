...
#define RPG_GAMECORE_STATETREESUBTREECONFIG_METHOD_3_EA95AEB40848E6BE_OFFSET UNITYSDK_OFFSET(0x16F98440)
#define RPG_GAMECORE_STATETREESUBTREECONFIG_METHOD_3_F1C930C75F6F573B_OFFSET UNITYSDK_OFFSET(0x16F98770)
#define RPG_GAMECORE_STATETREESUBTREECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F98430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StateTreeSubTreeConfig_TypeDefinitionIndex = 14081;
