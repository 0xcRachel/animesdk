...
#define RPG_GAMECORE_CHARACTERPHASEOVERRIDECONFIG_METHOD_2_FDD0CA0ECFBE05A6_OFFSET UNITYSDK_OFFSET(0x170849C0)
#define RPG_GAMECORE_CHARACTERPHASEOVERRIDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17084BF0)
