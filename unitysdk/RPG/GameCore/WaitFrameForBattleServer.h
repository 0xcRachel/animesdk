...
#define RPG_GAMECORE_WAITFRAMEFORBATTLESERVER_METHOD_3_BCF9AB2A0F1C68B4_OFFSET UNITYSDK_OFFSET(0x1952C320)
#define RPG_GAMECORE_WAITFRAMEFORBATTLESERVER_METHOD_3_FC955290DEDC8135_OFFSET UNITYSDK_OFFSET(0x1952C290)
#define RPG_GAMECORE_WAITFRAMEFORBATTLESERVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1952C2F0)
