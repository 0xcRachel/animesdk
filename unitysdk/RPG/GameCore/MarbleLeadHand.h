...
#define RPG_GAMECORE_MARBLELEADHAND_METHOD_3_09CFB28EFAFF1FE3_OFFSET UNITYSDK_OFFSET(0x18FEED80)
#define RPG_GAMECORE_MARBLELEADHAND_METHOD_3_C6CBB5E0BAB59A85_OFFSET UNITYSDK_OFFSET(0x18FEEF40)
#define RPG_GAMECORE_MARBLELEADHAND__CTOR_OFFSET UNITYSDK_OFFSET(0x18FEEEF0)
