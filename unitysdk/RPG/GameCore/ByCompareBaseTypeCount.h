...
#define RPG_GAMECORE_BYCOMPAREBASETYPECOUNT_METHOD_4_F6B2E257D0EBDEEA_OFFSET UNITYSDK_OFFSET(0x17017640)
#define RPG_GAMECORE_BYCOMPAREBASETYPECOUNT_METHOD_4_F7669BE828D95386_OFFSET UNITYSDK_OFFSET(0x17017720)
#define RPG_GAMECORE_BYCOMPAREBASETYPECOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x170176C0)
