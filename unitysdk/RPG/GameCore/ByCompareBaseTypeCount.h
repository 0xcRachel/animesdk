...
#define RPG_GAMECORE_BYCOMPAREBASETYPECOUNT_METHOD_4_F6B2E257D0EBDEEA_OFFSET UNITYSDK_OFFSET(0x16906810)
#define RPG_GAMECORE_BYCOMPAREBASETYPECOUNT_METHOD_4_F7669BE828D95386_OFFSET UNITYSDK_OFFSET(0x169068F0)
#define RPG_GAMECORE_BYCOMPAREBASETYPECOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x16906890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareBaseTypeCount_TypeDefinitionIndex = 21265;
