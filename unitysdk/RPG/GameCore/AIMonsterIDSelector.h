...
#define RPG_GAMECORE_AIMONSTERIDSELECTOR_METHOD_3_C6EC776F7EB711CE_OFFSET UNITYSDK_OFFSET(0x16770EF0)
#define RPG_GAMECORE_AIMONSTERIDSELECTOR_METHOD_3_FAEC61F59F5AC87D_OFFSET UNITYSDK_OFFSET(0x16770F30)
#define RPG_GAMECORE_AIMONSTERIDSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x16770F20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIMonsterIDSelector_TypeDefinitionIndex = 14180;
