...
#define RPG_GAMECORE_ADVENTITYSETEXTANIMLAYERENABLE_METHOD_3_2F96ABD23DC40FFD_OFFSET UNITYSDK_OFFSET(0x16834D90)
#define RPG_GAMECORE_ADVENTITYSETEXTANIMLAYERENABLE_METHOD_3_735A29E1BF90BB53_OFFSET UNITYSDK_OFFSET(0x16834D10)
#define RPG_GAMECORE_ADVENTITYSETEXTANIMLAYERENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16834D60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvEntitySetExtAnimLayerEnable_TypeDefinitionIndex = 18858;
