...
#define RPG_GAMECORE_PROPCURVESETSTARTPOINT_METHOD_3_00394310626B1888_OFFSET UNITYSDK_OFFSET(0x16DA6A20)
#define RPG_GAMECORE_PROPCURVESETSTARTPOINT_METHOD_3_926E220588F59CA2_OFFSET UNITYSDK_OFFSET(0x16DA6920)
#define RPG_GAMECORE_PROPCURVESETSTARTPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x16DA69B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropCurveSetStartPoint_TypeDefinitionIndex = 18805;
