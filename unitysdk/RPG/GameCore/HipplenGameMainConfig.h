...
#define RPG_GAMECORE_HIPPLENGAMEMAINCONFIG_METHOD_2_6BE199BAACB19B1C_OFFSET UNITYSDK_OFFSET(0x172C11D0)
#define RPG_GAMECORE_HIPPLENGAMEMAINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x172C1990)
