...
#define RPG_GAMECORE_HIPPLENGAMEMAINCONFIG_METHOD_2_6BE199BAACB19B1C_OFFSET UNITYSDK_OFFSET(0x16B72910)
#define RPG_GAMECORE_HIPPLENGAMEMAINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16B730D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenGameMainConfig_TypeDefinitionIndex = 15111;
