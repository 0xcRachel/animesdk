...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::CakeRaceCellType>**)Il2CppClass::FromTypeDefinitionIndex(CakeRaceSparkleInitConfig___O_TypeDefinitionIndex)->GetStaticField(0x13150);
		}
	};
}
