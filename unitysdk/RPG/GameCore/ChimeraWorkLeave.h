...
#define RPG_GAMECORE_CHIMERAWORKLEAVE_METHOD_3_500279D05C50F12E_OFFSET UNITYSDK_OFFSET(0x170C1AB0)
#define RPG_GAMECORE_CHIMERAWORKLEAVE_METHOD_3_6312AFD77B05E852_OFFSET UNITYSDK_OFFSET(0x170C1B10)
#define RPG_GAMECORE_CHIMERAWORKLEAVE__CTOR_OFFSET UNITYSDK_OFFSET(0x170C1B00)
