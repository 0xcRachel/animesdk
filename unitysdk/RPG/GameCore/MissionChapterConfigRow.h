...
#define RPG_GAMECORE_MISSIONCHAPTERCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17433A50)
#define RPG_GAMECORE_MISSIONCHAPTERCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17434250)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* ChapterIconPath; // 0x28
		::System::String* StageName; // 0x30
		::Il2CppArray<::System::UInt32>* LinkChapterList; // 0x38
		::System::UInt32 ChapterDisplayPriority; // 0x40
