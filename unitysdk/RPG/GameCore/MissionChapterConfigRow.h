...
#define RPG_GAMECORE_MISSIONCHAPTERCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1969A750)
#define RPG_GAMECORE_MISSIONCHAPTERCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1969AF50)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* ChapterFigureIconPath; // 0x30
		...
		::RPG::GameCore::MissionChapterType ChapterType; // 0x50
