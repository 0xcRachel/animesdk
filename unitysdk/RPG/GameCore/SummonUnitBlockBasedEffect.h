...
#define RPG_GAMECORE_SUMMONUNITBLOCKBASEDEFFECT_METHOD_2_7B1D27BA2538DDF5_OFFSET UNITYSDK_OFFSET(0x16FADA30)
#define RPG_GAMECORE_SUMMONUNITBLOCKBASEDEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x16FADD80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SummonUnitBlockBasedEffect_TypeDefinitionIndex = 15901;
