...
#define RPG_GAMECORE_CAKERACECHECKANDSAVETARGETSPREDICATECONFIG_METHOD_3_765222DF2DC6A623_OFFSET UNITYSDK_OFFSET(0x1705EC80)
#define RPG_GAMECORE_CAKERACECHECKANDSAVETARGETSPREDICATECONFIG_METHOD_3_7EFC688FAB9BB97B_OFFSET UNITYSDK_OFFSET(0x1705BDC0)
#define RPG_GAMECORE_CAKERACECHECKANDSAVETARGETSPREDICATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1705BDB0)
