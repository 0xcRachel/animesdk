...
#define RPG_GAMECORE_PROPCURVEMOVEMODIFYSPEED_METHOD_3_1B058AC875EAB4C6_OFFSET UNITYSDK_OFFSET(0x1752B9B0)
#define RPG_GAMECORE_PROPCURVEMOVEMODIFYSPEED_METHOD_3_6B7B78099502B3FA_OFFSET UNITYSDK_OFFSET(0x1752BA80)
#define RPG_GAMECORE_PROPCURVEMOVEMODIFYSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x1752BA30)
