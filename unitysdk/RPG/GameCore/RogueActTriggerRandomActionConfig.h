...
#define RPG_GAMECORE_ROGUEACTTRIGGERRANDOMACTIONCONFIG_METHOD_6_A8F42528B73E2780_OFFSET UNITYSDK_OFFSET(0x1A03C390)
#define RPG_GAMECORE_ROGUEACTTRIGGERRANDOMACTIONCONFIG_METHOD_6_AA4437C85AD419DD_OFFSET UNITYSDK_OFFSET(0x1A03C5B0)
#define RPG_GAMECORE_ROGUEACTTRIGGERRANDOMACTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A03C4D0)
