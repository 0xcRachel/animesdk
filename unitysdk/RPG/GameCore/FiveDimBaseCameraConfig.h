...
#define RPG_GAMECORE_FIVEDIMBASECAMERACONFIG_METHOD_3_2D514F79D5F42B7D_OFFSET UNITYSDK_OFFSET(0x16AAD260)
#define RPG_GAMECORE_FIVEDIMBASECAMERACONFIG_METHOD_3_ED9C06CF4EA81F79_OFFSET UNITYSDK_OFFSET(0x16AAD640)
#define RPG_GAMECORE_FIVEDIMBASECAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16AAD600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimBaseCameraConfig_TypeDefinitionIndex = 16713;
