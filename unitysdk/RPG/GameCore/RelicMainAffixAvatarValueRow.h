...
#define RPG_GAMECORE_RELICMAINAFFIXAVATARVALUEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x190208C0)
#define RPG_GAMECORE_RELICMAINAFFIXAVATARVALUEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19020CA0)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::Single CriticalChance; // 0x10
		::System::Single CriticalDamage; // 0x14
		::System::Single BreakDamage; // 0x18
		::System::Single Speed; // 0x1C
		::System::Single SPRatio; // 0x20
		::System::Single Attack; // 0x24
		::System::Single StatusProbability; // 0x28
		::System::Single Defence; // 0x2C
		::System::UInt32 AvatarID; // 0x30
		::System::Single HP; // 0x34
		::System::Single HealRatio; // 0x38
		::System::Single DamageAddedRatio; // 0x3C
