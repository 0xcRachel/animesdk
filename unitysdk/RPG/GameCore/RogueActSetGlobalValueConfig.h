...
#define RPG_GAMECORE_ROGUEACTSETGLOBALVALUECONFIG_METHOD_6_9445E8248516A660_OFFSET UNITYSDK_OFFSET(0x1A9B5D10)
#define RPG_GAMECORE_ROGUEACTSETGLOBALVALUECONFIG_METHOD_6_E45C655423A5226D_OFFSET UNITYSDK_OFFSET(0x1A9B5AF0)
#define RPG_GAMECORE_ROGUEACTSETGLOBALVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9B5C30)
