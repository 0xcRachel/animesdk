...
#define RPG_GAMECORE_OVERRIDEENDTRANSFERCOLOR_METHOD_3_1B42CECC9A280F1A_OFFSET UNITYSDK_OFFSET(0x19D0C610)
#define RPG_GAMECORE_OVERRIDEENDTRANSFERCOLOR_METHOD_3_D883FB5A4FE02523_OFFSET UNITYSDK_OFFSET(0x19D0C6A0)
#define RPG_GAMECORE_OVERRIDEENDTRANSFERCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19D0C670)
