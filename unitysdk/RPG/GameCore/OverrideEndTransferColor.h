...
#define RPG_GAMECORE_OVERRIDEENDTRANSFERCOLOR_METHOD_3_1B42CECC9A280F1A_OFFSET UNITYSDK_OFFSET(0x16D0FEA0)
#define RPG_GAMECORE_OVERRIDEENDTRANSFERCOLOR_METHOD_3_D883FB5A4FE02523_OFFSET UNITYSDK_OFFSET(0x16D0FF30)
#define RPG_GAMECORE_OVERRIDEENDTRANSFERCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x16D0FF00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OverrideEndTransferColor_TypeDefinitionIndex = 19561;
