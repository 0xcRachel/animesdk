...
#define RPG_GAMECORE_RESTAURANTDAILYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A2F2C00)
#define RPG_GAMECORE_RESTAURANTDAILYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2F3150)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID Tips; // 0x30
		::System::UInt32 BeginMainPageMission; // 0x40
		::System::UInt32 LockRestaurantMission; // 0x44
		::System::UInt32 FestivalID; // 0x48
		::System::UInt32 OrderTableID; // 0x4C
		::System::UInt32 ProgressID; // 0x50
		::System::UInt32 DayID; // 0x54
		::System::UInt32 LockNextDayMission; // 0x58
		::System::UInt32 RandomEventNumber; // 0x5C
		::System::Boolean IsLoop; // 0x60
