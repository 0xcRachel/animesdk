...
#define RPG_GAMECORE_ROGUETOURNEXPSCOREROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19830D90)
#define RPG_GAMECORE_ROGUETOURNEXPSCOREROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19830F10)
