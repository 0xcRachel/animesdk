...
#define RPG_GAMECORE_BYLOCALWIN_METHOD_4_A953868FB7B40733_OFFSET UNITYSDK_OFFSET(0x1704ABB0)
#define RPG_GAMECORE_BYLOCALWIN_METHOD_4_BDF9891C50790BB9_OFFSET UNITYSDK_OFFSET(0x1704AC80)
#define RPG_GAMECORE_BYLOCALWIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1704AC30)
