...
#define RPG_GAMECORE_POLYMEROBJ_METHOD_3_3A61DDF89E5C170B_OFFSET UNITYSDK_OFFSET(0x16D79550)
#define RPG_GAMECORE_POLYMEROBJ_METHOD_3_B245B8C845ED5E41_OFFSET UNITYSDK_OFFSET(0x16D79590)
#define RPG_GAMECORE_POLYMEROBJ__CTOR_OFFSET UNITYSDK_OFFSET(0x16D79580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PolymerObj_TypeDefinitionIndex = 17107;
