...
#define RPG_GAMECORE_MAZEPUZZLESWITCHHANDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16C79510)
#define RPG_GAMECORE_MAZEPUZZLESWITCHHANDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16C79990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazePuzzleSwitchHandRow_TypeDefinitionIndex = 12812;
	...
	public:
		...
		::Il2CppArray<::Class_1_A88C3AAF0DD46F4C_9*>* CoinPropID; // 0x30
		...
		::System::Boolean BanRocketPunch; // 0x4C
		::System::Boolean BanJoyStick; // 0x4D
		::System::Boolean IsRaid; // 0x4E
