...
#define RPG_GAMECORE_MAZEPUZZLESWITCHHANDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A625210)
#define RPG_GAMECORE_MAZEPUZZLESWITCHHANDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A625670)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::Class_1_A88C3AAF0DD46F4C_10*>* CoinPropID; // 0x18
		...
		::System::Boolean IsRaid; // 0x44
		::System::Boolean BanRocketPunch; // 0x45
		::System::Boolean BanJoyStick; // 0x46
