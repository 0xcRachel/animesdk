...
#define RPG_GAMECORE_ABILITYSKILLPERFORMFINISH_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA2A43E0)
#define RPG_GAMECORE_ABILITYSKILLPERFORMFINISH_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA2A43A0)
#define RPG_GAMECORE_ABILITYSKILLPERFORMFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0xA2A4390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AbilitySkillPerformFinish_TypeDefinitionIndex = 44422;
