...
#define RPG_GAMECORE_SETMUSEUMPROJECTORSTATE_METHOD_3_361FD9F4B46FD620_OFFSET UNITYSDK_OFFSET(0x199BFCE0)
#define RPG_GAMECORE_SETMUSEUMPROJECTORSTATE_METHOD_3_DCD786DC07DEC433_OFFSET UNITYSDK_OFFSET(0x199BFD70)
#define RPG_GAMECORE_SETMUSEUMPROJECTORSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x199BFD40)
