...
#define RPG_GAMECORE_SETMUSEUMPROJECTORSTATE_METHOD_3_361FD9F4B46FD620_OFFSET UNITYSDK_OFFSET(0x16F38020)
#define RPG_GAMECORE_SETMUSEUMPROJECTORSTATE_METHOD_3_DCD786DC07DEC433_OFFSET UNITYSDK_OFFSET(0x16F380B0)
#define RPG_GAMECORE_SETMUSEUMPROJECTORSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F38080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMuseumProjectorState_TypeDefinitionIndex = 19845;
