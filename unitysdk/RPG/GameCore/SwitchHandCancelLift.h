...
#define RPG_GAMECORE_SWITCHHANDCANCELLIFT_METHOD_3_3A8BF88266B135C1_OFFSET UNITYSDK_OFFSET(0x16FB3E70)
#define RPG_GAMECORE_SWITCHHANDCANCELLIFT_METHOD_3_C66D751A40A88AD5_OFFSET UNITYSDK_OFFSET(0x16FB3F80)
#define RPG_GAMECORE_SWITCHHANDCANCELLIFT__CTOR_OFFSET UNITYSDK_OFFSET(0x16FB3F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchHandCancelLift_TypeDefinitionIndex = 18772;
