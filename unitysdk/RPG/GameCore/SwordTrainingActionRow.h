...
#define RPG_GAMECORE_SWORDTRAININGACTIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19863080)
#define RPG_GAMECORE_SWORDTRAININGACTIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x198634F0)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::Il2CppArray<::RPG::GameCore::SwordTrainingStatusConfig*>* DisplayEffectHintList; // 0x10
		::System::String* ActionImage; // 0x18
		::Il2CppArray<::System::UInt32>* EffectIDList; // 0x20
		::System::String* ActionIcon; // 0x28
		::Il2CppArray<::System::String*>* ActionPerformPrefab; // 0x30
		::System::String* ActionPlanImage; // 0x38
		::RPG::Client::TextID ActionName; // 0x40
		::System::UInt32 ActionLevel; // 0x50
		::RPG::GameCore::SwordTrainingActionType ActionType; // 0x54
