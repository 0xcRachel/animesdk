...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEBUFFGROUPCONFIG_METHOD_3_1CFD036C0136D889_OFFSET UNITYSDK_OFFSET(0x1764C720)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEBUFFGROUPCONFIG_METHOD_3_9D1DEDBC74D07CB0_OFFSET UNITYSDK_OFFSET(0x1764C650)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEBUFFGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1764C6D0)
