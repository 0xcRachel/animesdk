...
#define RPG_GAMECORE_ADVENTUREMONSTERTRIGGERMOVE_METHOD_3_BF22CD411F1CBBC4_OFFSET UNITYSDK_OFFSET(0x19C0D3A0)
#define RPG_GAMECORE_ADVENTUREMONSTERTRIGGERMOVE_METHOD_3_DB9C9141FDC9BD88_OFFSET UNITYSDK_OFFSET(0x19C0D420)
#define RPG_GAMECORE_ADVENTUREMONSTERTRIGGERMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C0D3F0)
