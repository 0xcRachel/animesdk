...
#define RPG_GAMECORE_FATEBATTLESHOWRIDERUI_METHOD_3_20FB45312980566F_OFFSET UNITYSDK_OFFSET(0x16A93F80)
#define RPG_GAMECORE_FATEBATTLESHOWRIDERUI_METHOD_3_E4AF285C2EE313FE_OFFSET UNITYSDK_OFFSET(0x16A93F00)
#define RPG_GAMECORE_FATEBATTLESHOWRIDERUI__CTOR_OFFSET UNITYSDK_OFFSET(0x16A93F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateBattleShowRiderUI_TypeDefinitionIndex = 20975;
