...
#define RPG_GAMECORE_DEPLOYPUZZLECHANGELINEEMISSION_METHOD_3_4B6AFA27590B624E_OFFSET UNITYSDK_OFFSET(0x169EB060)
#define RPG_GAMECORE_DEPLOYPUZZLECHANGELINEEMISSION_METHOD_3_BD4D9294E10E0706_OFFSET UNITYSDK_OFFSET(0x169EB1B0)
#define RPG_GAMECORE_DEPLOYPUZZLECHANGELINEEMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x169EB120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DeployPuzzleChangeLineEmission_TypeDefinitionIndex = 18139;
