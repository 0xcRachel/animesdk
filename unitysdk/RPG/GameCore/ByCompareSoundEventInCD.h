...
#define RPG_GAMECORE_BYCOMPARESOUNDEVENTINCD_METHOD_4_0F07B4036AAFD799_OFFSET UNITYSDK_OFFSET(0x1702BF70)
#define RPG_GAMECORE_BYCOMPARESOUNDEVENTINCD_METHOD_4_CE79C2851D3ADDD7_OFFSET UNITYSDK_OFFSET(0x1702C040)
#define RPG_GAMECORE_BYCOMPARESOUNDEVENTINCD__CTOR_OFFSET UNITYSDK_OFFSET(0x1702BFF0)
