...
#define RPG_GAMECORE_BYCOMPARESOUNDEVENTINCD_METHOD_4_0F07B4036AAFD799_OFFSET UNITYSDK_OFFSET(0x18FF10A0)
#define RPG_GAMECORE_BYCOMPARESOUNDEVENTINCD_METHOD_4_CE79C2851D3ADDD7_OFFSET UNITYSDK_OFFSET(0x18FF1170)
#define RPG_GAMECORE_BYCOMPARESOUNDEVENTINCD_METHOD_4_F6521D3FE0D0ACB5_OFFSET UNITYSDK_OFFSET(0x18FF1370)
#define RPG_GAMECORE_BYCOMPARESOUNDEVENTINCD_METHOD_4_FFBA5991C2165AAC_OFFSET UNITYSDK_OFFSET(0x18FF12F0)
#define RPG_GAMECORE_BYCOMPARESOUNDEVENTINCD__CTOR_OFFSET UNITYSDK_OFFSET(0x18FF1120)
