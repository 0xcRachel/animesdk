...
#define RPG_GAMECORE_CHIMERAPHASEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x194CC0E0)
#define RPG_GAMECORE_CHIMERAPHASEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x194CC340)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::ChimeraPhaseTargetType TargetType; // 0x20
