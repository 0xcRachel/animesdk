...
#define RPG_GAMECORE_SETENTITYTALKENABLE_METHOD_3_69B4FF9771DB715C_OFFSET UNITYSDK_OFFSET(0x199B3150)
#define RPG_GAMECORE_SETENTITYTALKENABLE_METHOD_3_DA8116FD96000EEA_OFFSET UNITYSDK_OFFSET(0x199B30D0)
#define RPG_GAMECORE_SETENTITYTALKENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x199B3120)
