...
#define RPG_GAMECORE_MARBLENPCCONFIG_METHOD_2_D84400464A92AF26_OFFSET UNITYSDK_OFFSET(0x16C3ED70)
#define RPG_GAMECORE_MARBLENPCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16C42A70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleNpcConfig_TypeDefinitionIndex = 16959;
