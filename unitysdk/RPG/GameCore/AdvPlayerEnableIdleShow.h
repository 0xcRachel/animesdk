...
#define RPG_GAMECORE_ADVPLAYERENABLEIDLESHOW_METHOD_3_E84EBAEC91BAA186_OFFSET UNITYSDK_OFFSET(0x19BED550)
#define RPG_GAMECORE_ADVPLAYERENABLEIDLESHOW_METHOD_3_EC8ED245C2670CB7_OFFSET UNITYSDK_OFFSET(0x19BED5D0)
#define RPG_GAMECORE_ADVPLAYERENABLEIDLESHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x19BED5A0)
