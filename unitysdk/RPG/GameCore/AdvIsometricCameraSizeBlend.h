...
#define RPG_GAMECORE_ADVISOMETRICCAMERASIZEBLEND_METHOD_3_3ACF5845AFAD8B31_OFFSET UNITYSDK_OFFSET(0x19BE3A20)
#define RPG_GAMECORE_ADVISOMETRICCAMERASIZEBLEND_METHOD_3_EF7AB418B42AAC5D_OFFSET UNITYSDK_OFFSET(0x19BE39A0)
#define RPG_GAMECORE_ADVISOMETRICCAMERASIZEBLEND__CTOR_OFFSET UNITYSDK_OFFSET(0x19BE39F0)
