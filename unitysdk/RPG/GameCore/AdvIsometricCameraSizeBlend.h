...
#define RPG_GAMECORE_ADVISOMETRICCAMERASIZEBLEND_METHOD_3_3ACF5845AFAD8B31_OFFSET UNITYSDK_OFFSET(0x168387C0)
#define RPG_GAMECORE_ADVISOMETRICCAMERASIZEBLEND_METHOD_3_EF7AB418B42AAC5D_OFFSET UNITYSDK_OFFSET(0x16838740)
#define RPG_GAMECORE_ADVISOMETRICCAMERASIZEBLEND__CTOR_OFFSET UNITYSDK_OFFSET(0x16838790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvIsometricCameraSizeBlend_TypeDefinitionIndex = 19866;
