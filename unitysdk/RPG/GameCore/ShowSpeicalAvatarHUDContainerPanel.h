...
#define RPG_GAMECORE_SHOWSPEICALAVATARHUDCONTAINERPANEL_METHOD_3_2AC11EB9775459B2_OFFSET UNITYSDK_OFFSET(0x16F63480)
#define RPG_GAMECORE_SHOWSPEICALAVATARHUDCONTAINERPANEL_METHOD_3_5EF0B357727ECBBC_OFFSET UNITYSDK_OFFSET(0x16F63550)
#define RPG_GAMECORE_SHOWSPEICALAVATARHUDCONTAINERPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0x16F63500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowSpeicalAvatarHUDContainerPanel_TypeDefinitionIndex = 20835;
