...
#define RPG_GAMECORE_ADDWEAKBYTEAMATTACKTYPE_METHOD_3_27C449969874A098_OFFSET UNITYSDK_OFFSET(0x167C0520)
#define RPG_GAMECORE_ADDWEAKBYTEAMATTACKTYPE_METHOD_3_933C0B4CBE7B502B_OFFSET UNITYSDK_OFFSET(0x167C05A0)
#define RPG_GAMECORE_ADDWEAKBYTEAMATTACKTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x167C0570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddWeakByTeamAttackType_TypeDefinitionIndex = 21245;
