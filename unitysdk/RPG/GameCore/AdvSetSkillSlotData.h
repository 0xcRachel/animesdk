...
#define RPG_GAMECORE_ADVSETSKILLSLOTDATA_METHOD_3_5C9A2E60612CC682_OFFSET UNITYSDK_OFFSET(0x16849620)
#define RPG_GAMECORE_ADVSETSKILLSLOTDATA_METHOD_3_B6EA4DCEE4C9C329_OFFSET UNITYSDK_OFFSET(0x16849550)
#define RPG_GAMECORE_ADVSETSKILLSLOTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x168495D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetSkillSlotData_TypeDefinitionIndex = 17968;
