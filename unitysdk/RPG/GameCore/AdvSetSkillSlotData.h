...
#define RPG_GAMECORE_ADVSETSKILLSLOTDATA_METHOD_3_5C9A2E60612CC682_OFFSET UNITYSDK_OFFSET(0x19BF48C0)
#define RPG_GAMECORE_ADVSETSKILLSLOTDATA_METHOD_3_B6EA4DCEE4C9C329_OFFSET UNITYSDK_OFFSET(0x19BF47F0)
#define RPG_GAMECORE_ADVSETSKILLSLOTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19BF4870)
