...
#define RPG_GAMECORE_CALCELEVATORLOOPTIME_METHOD_3_2E0EDE77FC88A78E_OFFSET UNITYSDK_OFFSET(0x17065760)
#define RPG_GAMECORE_CALCELEVATORLOOPTIME_METHOD_3_B5C8DD6BE8C89537_OFFSET UNITYSDK_OFFSET(0x170657E0)
#define RPG_GAMECORE_CALCELEVATORLOOPTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x170657B0)
