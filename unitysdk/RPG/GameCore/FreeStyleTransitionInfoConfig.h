...
#define RPG_GAMECORE_FREESTYLETRANSITIONINFOCONFIG_METHOD_2_6F97D1A80E0FED1A_OFFSET UNITYSDK_OFFSET(0x16AE9BF0)
#define RPG_GAMECORE_FREESTYLETRANSITIONINFOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16AE9CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FreeStyleTransitionInfoConfig_TypeDefinitionIndex = 14672;
