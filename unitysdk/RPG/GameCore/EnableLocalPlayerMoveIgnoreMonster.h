...
#define RPG_GAMECORE_ENABLELOCALPLAYERMOVEIGNOREMONSTER_METHOD_3_4A5CC60684E4F871_OFFSET UNITYSDK_OFFSET(0x16A6A890)
#define RPG_GAMECORE_ENABLELOCALPLAYERMOVEIGNOREMONSTER_METHOD_3_C1698F7C2925BD98_OFFSET UNITYSDK_OFFSET(0x16A6A910)
#define RPG_GAMECORE_ENABLELOCALPLAYERMOVEIGNOREMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x16A6A8E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableLocalPlayerMoveIgnoreMonster_TypeDefinitionIndex = 17957;
