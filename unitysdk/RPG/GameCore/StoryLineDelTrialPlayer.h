...
#define RPG_GAMECORE_STORYLINEDELTRIALPLAYER_METHOD_3_76C9E15816939AB6_OFFSET UNITYSDK_OFFSET(0x16FA0AD0)
#define RPG_GAMECORE_STORYLINEDELTRIALPLAYER_METHOD_3_8AD7516548FB60B6_OFFSET UNITYSDK_OFFSET(0x16FA0B60)
#define RPG_GAMECORE_STORYLINEDELTRIALPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x16FA0B30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StoryLineDelTrialPlayer_TypeDefinitionIndex = 19310;
