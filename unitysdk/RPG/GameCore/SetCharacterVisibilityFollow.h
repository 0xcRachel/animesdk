...
#define RPG_GAMECORE_SETCHARACTERVISIBILITYFOLLOW_METHOD_3_342111117C916ACE_OFFSET UNITYSDK_OFFSET(0x176C3660)
#define RPG_GAMECORE_SETCHARACTERVISIBILITYFOLLOW_METHOD_3_6F7D0F5DA1CDA221_OFFSET UNITYSDK_OFFSET(0x176C35D0)
#define RPG_GAMECORE_SETCHARACTERVISIBILITYFOLLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x176C3630)
