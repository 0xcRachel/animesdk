...
#define RPG_GAMECORE_PASTERCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19D17F20)
#define RPG_GAMECORE_PASTERCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19D19660)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::TravelBrochurePasterType Type; // 0x34
		::RPG::Client::TextID PasterUnlockDesc; // 0x38
		::System::UInt32 ID; // 0x48
		::System::UInt32 IncreaseCompletion; // 0x4C
