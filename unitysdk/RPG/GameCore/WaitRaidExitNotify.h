...
#define RPG_GAMECORE_WAITRAIDEXITNOTIFY_METHOD_3_A13D9750107246FB_OFFSET UNITYSDK_OFFSET(0x1715A4E0)
#define RPG_GAMECORE_WAITRAIDEXITNOTIFY_METHOD_3_F8DC904A8602E752_OFFSET UNITYSDK_OFFSET(0x1715A560)
#define RPG_GAMECORE_WAITRAIDEXITNOTIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x1715A530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRaidExitNotify_TypeDefinitionIndex = 18715;
