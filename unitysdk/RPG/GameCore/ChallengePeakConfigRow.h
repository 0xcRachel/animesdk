...
#define RPG_GAMECORE_CHALLENGEPEAKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x169607B0)
#define RPG_GAMECORE_CHALLENGEPEAKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16960B70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChallengePeakConfigRow_TypeDefinitionIndex = 11761;
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* HPProgressValueList; // 0x28
