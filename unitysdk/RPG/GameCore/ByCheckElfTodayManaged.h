...
#define RPG_GAMECORE_BYCHECKELFTODAYMANAGED_METHOD_4_029B191E460DDF1B_OFFSET UNITYSDK_OFFSET(0x17012440)
#define RPG_GAMECORE_BYCHECKELFTODAYMANAGED_METHOD_4_A2456C257C18B771_OFFSET UNITYSDK_OFFSET(0x17012510)
#define RPG_GAMECORE_BYCHECKELFTODAYMANAGED__CTOR_OFFSET UNITYSDK_OFFSET(0x170124C0)
