...
#define RPG_GAMECORE_ADVCREATEGROUPENTITY_METHOD_3_21569FF52B85BCFD_OFFSET UNITYSDK_OFFSET(0x18DBFBC0)
#define RPG_GAMECORE_ADVCREATEGROUPENTITY_METHOD_3_D06B849C1EE95076_OFFSET UNITYSDK_OFFSET(0x18DBFB40)
#define RPG_GAMECORE_ADVCREATEGROUPENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x18DBFB90)
