...
#define RPG_GAMECORE_ADVCREATEGROUPENTITY_METHOD_3_21569FF52B85BCFD_OFFSET UNITYSDK_OFFSET(0x16830E70)
#define RPG_GAMECORE_ADVCREATEGROUPENTITY_METHOD_3_D06B849C1EE95076_OFFSET UNITYSDK_OFFSET(0x16830DF0)
#define RPG_GAMECORE_ADVCREATEGROUPENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x16830E40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvCreateGroupEntity_TypeDefinitionIndex = 18052;
