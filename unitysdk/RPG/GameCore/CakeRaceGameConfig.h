...
#define RPG_GAMECORE_CAKERACEGAMECONFIG_METHOD_3_9779DE1442E7C5FF_OFFSET UNITYSDK_OFFSET(0x17060140)
#define RPG_GAMECORE_CAKERACEGAMECONFIG_METHOD_3_CDB0BDD0E23F7E49_OFFSET UNITYSDK_OFFSET(0x17060100)
#define RPG_GAMECORE_CAKERACEGAMECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17060130)
