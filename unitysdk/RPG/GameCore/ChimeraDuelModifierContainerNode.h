...
#define RPG_GAMECORE_CHIMERADUELMODIFIERCONTAINERNODE_METHOD_3_9A82C3F36EFB80D7_OFFSET UNITYSDK_OFFSET(0x16993430)
#define RPG_GAMECORE_CHIMERADUELMODIFIERCONTAINERNODE_METHOD_3_A954EC6E42428FFC_OFFSET UNITYSDK_OFFSET(0x16993350)
#define RPG_GAMECORE_CHIMERADUELMODIFIERCONTAINERNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x169933E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelModifierContainerNode_TypeDefinitionIndex = 14461;
