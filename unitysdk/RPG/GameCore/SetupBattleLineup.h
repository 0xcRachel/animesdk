...
#define RPG_GAMECORE_SETUPBATTLELINEUP_METHOD_3_463C37D77A0B962F_OFFSET UNITYSDK_OFFSET(0x176FDF80)
#define RPG_GAMECORE_SETUPBATTLELINEUP_METHOD_3_AA00D950ACFB8031_OFFSET UNITYSDK_OFFSET(0x176FE000)
#define RPG_GAMECORE_SETUPBATTLELINEUP__CTOR_OFFSET UNITYSDK_OFFSET(0x176FDFD0)
