...
#define RPG_GAMECORE_BYDISTANCE_METHOD_4_BDB64190ABC520A0_OFFSET UNITYSDK_OFFSET(0x16923B30)
#define RPG_GAMECORE_BYDISTANCE_METHOD_4_E839AE69916489E1_OFFSET UNITYSDK_OFFSET(0x16923C10)
#define RPG_GAMECORE_BYDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x16923BB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByDistance_TypeDefinitionIndex = 18573;
