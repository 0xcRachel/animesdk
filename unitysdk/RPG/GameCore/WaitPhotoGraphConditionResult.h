...
#define RPG_GAMECORE_WAITPHOTOGRAPHCONDITIONRESULT_METHOD_3_3D8843B7B631BE8D_OFFSET UNITYSDK_OFFSET(0x1B31DF20)
#define RPG_GAMECORE_WAITPHOTOGRAPHCONDITIONRESULT_METHOD_3_C22C9927811BE18C_OFFSET UNITYSDK_OFFSET(0x1B31DFA0)
#define RPG_GAMECORE_WAITPHOTOGRAPHCONDITIONRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B31DF70)
