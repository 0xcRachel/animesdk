...
#define RPG_GAMECORE_WAITPHOTOGRAPHCONDITIONRESULT_METHOD_3_54B31D0D58910DB2_OFFSET UNITYSDK_OFFSET(0x17913E70)
#define RPG_GAMECORE_WAITPHOTOGRAPHCONDITIONRESULT_METHOD_3_D454D3C37A792B8B_OFFSET UNITYSDK_OFFSET(0x17913DF0)
#define RPG_GAMECORE_WAITPHOTOGRAPHCONDITIONRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x17913E40)
