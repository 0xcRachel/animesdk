...
#define RPG_GAMECORE_WAITPHOTOGRAPHCONDITIONRESULT_METHOD_3_54B31D0D58910DB2_OFFSET UNITYSDK_OFFSET(0x17157A00)
#define RPG_GAMECORE_WAITPHOTOGRAPHCONDITIONRESULT_METHOD_3_D454D3C37A792B8B_OFFSET UNITYSDK_OFFSET(0x17157980)
#define RPG_GAMECORE_WAITPHOTOGRAPHCONDITIONRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x171579D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitPhotoGraphConditionResult_TypeDefinitionIndex = 19267;
