...
#define RPG_GAMECORE_CLONEWEAKNESS_METHOD_3_28C2AB5D8383C46E_OFFSET UNITYSDK_OFFSET(0x169B59A0)
#define RPG_GAMECORE_CLONEWEAKNESS_METHOD_3_2CE8E951597DE431_OFFSET UNITYSDK_OFFSET(0x169B5910)
#define RPG_GAMECORE_CLONEWEAKNESS__CTOR_OFFSET UNITYSDK_OFFSET(0x169B5970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CloneWeakness_TypeDefinitionIndex = 20743;
