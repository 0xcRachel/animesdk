...
#define RPG_GAMECORE_SWORDTRAININGCHECKSTORYLINEFINISHED_METHOD_3_DAC19FFF97974E9A_OFFSET UNITYSDK_OFFSET(0x16FBC100)
#define RPG_GAMECORE_SWORDTRAININGCHECKSTORYLINEFINISHED_METHOD_3_DF0EA5D6AFA30773_OFFSET UNITYSDK_OFFSET(0x16FBC180)
#define RPG_GAMECORE_SWORDTRAININGCHECKSTORYLINEFINISHED__CTOR_OFFSET UNITYSDK_OFFSET(0x16FBC150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwordTrainingCheckStoryLineFinished_TypeDefinitionIndex = 18097;
