...
#define RPG_GAMECORE_CAKERACEWAITDRAGPROP_METHOD_3_24AB9ACAB5C2C241_OFFSET UNITYSDK_OFFSET(0x16953690)
#define RPG_GAMECORE_CAKERACEWAITDRAGPROP_METHOD_3_CD2FB5707335E510_OFFSET UNITYSDK_OFFSET(0x16953710)
#define RPG_GAMECORE_CAKERACEWAITDRAGPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x169536E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceWaitDragProp_TypeDefinitionIndex = 21779;
