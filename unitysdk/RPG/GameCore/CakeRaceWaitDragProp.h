...
#define RPG_GAMECORE_CAKERACEWAITDRAGPROP_METHOD_3_24AB9ACAB5C2C241_OFFSET UNITYSDK_OFFSET(0x17064E40)
#define RPG_GAMECORE_CAKERACEWAITDRAGPROP_METHOD_3_CD2FB5707335E510_OFFSET UNITYSDK_OFFSET(0x17064EC0)
#define RPG_GAMECORE_CAKERACEWAITDRAGPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x17064E90)
