...
#define RPG_GAMECORE_CHENLINGBATTLEBUFFTYPEEXTRACONFIG_METHOD_2_80EB83DBE0C73CCC_OFFSET UNITYSDK_OFFSET(0x17090A20)
#define RPG_GAMECORE_CHENLINGBATTLEBUFFTYPEEXTRACONFIG_METHOD_2_C3329CBD1B7B2FB3_OFFSET UNITYSDK_OFFSET(0x170908C0)
#define RPG_GAMECORE_CHENLINGBATTLEBUFFTYPEEXTRACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17090A10)
