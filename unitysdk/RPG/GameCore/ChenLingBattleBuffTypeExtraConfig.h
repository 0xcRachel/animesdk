...
#define RPG_GAMECORE_CHENLINGBATTLEBUFFTYPEEXTRACONFIG_METHOD_2_80EB83DBE0C73CCC_OFFSET UNITYSDK_OFFSET(0x1969DCA0)
#define RPG_GAMECORE_CHENLINGBATTLEBUFFTYPEEXTRACONFIG_METHOD_2_C3329CBD1B7B2FB3_OFFSET UNITYSDK_OFFSET(0x1969DB40)
#define RPG_GAMECORE_CHENLINGBATTLEBUFFTYPEEXTRACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1969DC90)
