...
#define RPG_GAMECORE_REMOVEENTITYFROMTEAMFORMATION_METHOD_3_1E23DD5CC4F89643_OFFSET UNITYSDK_OFFSET(0x1A2E71D0)
#define RPG_GAMECORE_REMOVEENTITYFROMTEAMFORMATION_METHOD_3_3240488C275C5FE7_OFFSET UNITYSDK_OFFSET(0x1A2E7250)
#define RPG_GAMECORE_REMOVEENTITYFROMTEAMFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2E7220)
