...
#define RPG_GAMECORE_FIVEDIMCONDITIONNONEOF_METHOD_3_1F05A0ADA36BD421_OFFSET UNITYSDK_OFFSET(0x16AB7270)
#define RPG_GAMECORE_FIVEDIMCONDITIONNONEOF_METHOD_3_ABAE59FE0153CDE2_OFFSET UNITYSDK_OFFSET(0x16AB72B0)
#define RPG_GAMECORE_FIVEDIMCONDITIONNONEOF__CTOR_OFFSET UNITYSDK_OFFSET(0x16AB72A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimConditionNoneOf_TypeDefinitionIndex = 16849;
