...
#define RPG_GAMECORE_ROGUETOURNBUILDREFAVATARROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16EC0BD0)
#define RPG_GAMECORE_ROGUETOURNBUILDREFAVATARROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16EC1190)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournBuildRefAvatarRow_TypeDefinitionIndex = 13647;
