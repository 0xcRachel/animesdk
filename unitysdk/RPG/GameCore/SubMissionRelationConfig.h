...
#define RPG_GAMECORE_SUBMISSIONRELATIONCONFIG_METHOD_2_9ECCD2A67933344F_OFFSET UNITYSDK_OFFSET(0x16FAA3A0)
#define RPG_GAMECORE_SUBMISSIONRELATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16FAA4C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SubMissionRelationConfig_TypeDefinitionIndex = 17031;
