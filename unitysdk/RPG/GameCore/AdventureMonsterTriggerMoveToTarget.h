...
#define RPG_GAMECORE_ADVENTUREMONSTERTRIGGERMOVETOTARGET_METHOD_3_16151E6F8F395145_OFFSET UNITYSDK_OFFSET(0x1685D470)
#define RPG_GAMECORE_ADVENTUREMONSTERTRIGGERMOVETOTARGET_METHOD_3_AB4771B3D5306720_OFFSET UNITYSDK_OFFSET(0x1685D4F0)
#define RPG_GAMECORE_ADVENTUREMONSTERTRIGGERMOVETOTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1685D4C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureMonsterTriggerMoveToTarget_TypeDefinitionIndex = 17956;
