...
#define RPG_GAMECORE_RESETALLPUZZLESTATESCLIENTONLY_METHOD_3_850DC69B150A6049_OFFSET UNITYSDK_OFFSET(0x16DE49F0)
#define RPG_GAMECORE_RESETALLPUZZLESTATESCLIENTONLY_METHOD_3_C95BEBC12C0330C0_OFFSET UNITYSDK_OFFSET(0x16DE4A70)
#define RPG_GAMECORE_RESETALLPUZZLESTATESCLIENTONLY__CTOR_OFFSET UNITYSDK_OFFSET(0x16DE4A40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetAllPuzzleStatesClientOnly_TypeDefinitionIndex = 18981;
