...
#define RPG_GAMECORE_RESETALLPUZZLESTATESCLIENTONLY_METHOD_3_850DC69B150A6049_OFFSET UNITYSDK_OFFSET(0x1902D110)
#define RPG_GAMECORE_RESETALLPUZZLESTATESCLIENTONLY_METHOD_3_C95BEBC12C0330C0_OFFSET UNITYSDK_OFFSET(0x1902D190)
#define RPG_GAMECORE_RESETALLPUZZLESTATESCLIENTONLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1902D160)
