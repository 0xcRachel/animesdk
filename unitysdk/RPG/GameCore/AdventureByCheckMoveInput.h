...
#define RPG_GAMECORE_ADVENTUREBYCHECKMOVEINPUT_METHOD_4_0D1B265559100449_OFFSET UNITYSDK_OFFSET(0x19BFCF10)
#define RPG_GAMECORE_ADVENTUREBYCHECKMOVEINPUT_METHOD_4_2759A13DC9C2D40A_OFFSET UNITYSDK_OFFSET(0x19BFD050)
#define RPG_GAMECORE_ADVENTUREBYCHECKMOVEINPUT_METHOD_4_3C5F0F0A1D565443_OFFSET UNITYSDK_OFFSET(0x19BFCE40)
#define RPG_GAMECORE_ADVENTUREBYCHECKMOVEINPUT_METHOD_4_584B6980652A0FA2_OFFSET UNITYSDK_OFFSET(0x19BFD0D0)
#define RPG_GAMECORE_ADVENTUREBYCHECKMOVEINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x19BFCEC0)
