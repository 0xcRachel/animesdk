...
#define RPG_GAMECORE_CHIMERADUELHYSILENSEFFECTNODE_METHOD_3_7B9F6BCB7C5F741D_OFFSET UNITYSDK_OFFSET(0x196B9F10)
#define RPG_GAMECORE_CHIMERADUELHYSILENSEFFECTNODE_METHOD_3_859B6E3751A3B82D_OFFSET UNITYSDK_OFFSET(0x196B9FF0)
#define RPG_GAMECORE_CHIMERADUELHYSILENSEFFECTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x196B9FA0)
