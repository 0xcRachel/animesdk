...
#define RPG_GAMECORE_CHIMERADUELHYSILENSEFFECTNODE_METHOD_3_7B9F6BCB7C5F741D_OFFSET UNITYSDK_OFFSET(0x169908A0)
#define RPG_GAMECORE_CHIMERADUELHYSILENSEFFECTNODE_METHOD_3_859B6E3751A3B82D_OFFSET UNITYSDK_OFFSET(0x16990980)
#define RPG_GAMECORE_CHIMERADUELHYSILENSEFFECTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x16990930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelHysilensEffectNode_TypeDefinitionIndex = 14423;
