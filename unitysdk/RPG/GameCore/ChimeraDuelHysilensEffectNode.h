...
#define RPG_GAMECORE_CHIMERADUELHYSILENSEFFECTNODE_METHOD_3_7B9F6BCB7C5F741D_OFFSET UNITYSDK_OFFSET(0x170B2410)
#define RPG_GAMECORE_CHIMERADUELHYSILENSEFFECTNODE_METHOD_3_859B6E3751A3B82D_OFFSET UNITYSDK_OFFSET(0x170B24F0)
#define RPG_GAMECORE_CHIMERADUELHYSILENSEFFECTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x170B24A0)
