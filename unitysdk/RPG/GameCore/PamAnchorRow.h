...
#define RPG_GAMECORE_PAMANCHORROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16D14650)
#define RPG_GAMECORE_PAMANCHORROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16D14850)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PamAnchorRow_TypeDefinitionIndex = 13033;
