...
#define RPG_GAMECORE_ST_ELFBYISWAITERSTATE_METHOD_4_290D408CD374DBDE_OFFSET UNITYSDK_OFFSET(0x1A17FBD0)
#define RPG_GAMECORE_ST_ELFBYISWAITERSTATE_METHOD_4_7079C2EC98FFE86E_OFFSET UNITYSDK_OFFSET(0x1A17F950)
#define RPG_GAMECORE_ST_ELFBYISWAITERSTATE_METHOD_4_AC31AB97B13CFC67_OFFSET UNITYSDK_OFFSET(0x1A17FC50)
#define RPG_GAMECORE_ST_ELFBYISWAITERSTATE_METHOD_4_D24C3C4AB5A0C4D8_OFFSET UNITYSDK_OFFSET(0x1A17FA20)
#define RPG_GAMECORE_ST_ELFBYISWAITERSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A17F9D0)
