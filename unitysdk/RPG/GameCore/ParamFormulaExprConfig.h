...
#define RPG_GAMECORE_PARAMFORMULAEXPRCONFIG_METHOD_4_3DB220714181345C_OFFSET UNITYSDK_OFFSET(0x18EFD9E0)
#define RPG_GAMECORE_PARAMFORMULAEXPRCONFIG_METHOD_4_6E8FF222DD99DA37_OFFSET UNITYSDK_OFFSET(0x18EFDB20)
#define RPG_GAMECORE_PARAMFORMULAEXPRCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18EFDAA0)
