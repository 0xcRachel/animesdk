...
#define RPG_GAMECORE_BYISCONTAINMODIFIER_METHOD_4_C34A6335241E6990_OFFSET UNITYSDK_OFFSET(0x1692E1F0)
#define RPG_GAMECORE_BYISCONTAINMODIFIER_METHOD_4_E35774B88C3C05C8_OFFSET UNITYSDK_OFFSET(0x1692E2C0)
#define RPG_GAMECORE_BYISCONTAINMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1692E270)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsContainModifier_TypeDefinitionIndex = 20639;
