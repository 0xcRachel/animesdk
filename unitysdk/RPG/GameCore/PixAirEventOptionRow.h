...
#define RPG_GAMECORE_PIXAIREVENTOPTIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19D41E40)
#define RPG_GAMECORE_PIXAIREVENTOPTIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19D420F0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID OptionEffectDesc; // 0x20
		::RPG::Client::TextID OptionDescribe; // 0x30
