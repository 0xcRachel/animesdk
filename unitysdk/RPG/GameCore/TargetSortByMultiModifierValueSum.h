...
#define RPG_GAMECORE_TARGETSORTBYMULTIMODIFIERVALUESUM_METHOD_3_1D916C1BAC442397_OFFSET UNITYSDK_OFFSET(0x171343A0)
#define RPG_GAMECORE_TARGETSORTBYMULTIMODIFIERVALUESUM_METHOD_3_5177D4C27D495544_OFFSET UNITYSDK_OFFSET(0x17135AE0)
#define RPG_GAMECORE_TARGETSORTBYMULTIMODIFIERVALUESUM__CTOR_OFFSET UNITYSDK_OFFSET(0x17134380)
