...
#define RPG_GAMECORE_SIMPLETALKLISTCONFIG_METHOD_3_B64C74A655E34688_OFFSET UNITYSDK_OFFSET(0x1771DF30)
#define RPG_GAMECORE_SIMPLETALKLISTCONFIG_METHOD_3_C91FC9402021A12C_OFFSET UNITYSDK_OFFSET(0x1771DB20)
#define RPG_GAMECORE_SIMPLETALKLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1771DF00)
