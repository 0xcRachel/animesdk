...
#define RPG_GAMECORE_BYISINCHARMACTION_METHOD_4_2D21B70280E6EC08_OFFSET UNITYSDK_OFFSET(0x169324D0)
#define RPG_GAMECORE_BYISINCHARMACTION_METHOD_4_943EE193EF2CCDF2_OFFSET UNITYSDK_OFFSET(0x16932400)
#define RPG_GAMECORE_BYISINCHARMACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16932480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsInCharmAction_TypeDefinitionIndex = 21167;
