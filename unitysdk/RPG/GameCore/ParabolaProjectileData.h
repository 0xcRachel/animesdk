...
#define RPG_GAMECORE_PARABOLAPROJECTILEDATA_METHOD_3_5462F205E5EBE9E9_OFFSET UNITYSDK_OFFSET(0x16D00DC0)
#define RPG_GAMECORE_PARABOLAPROJECTILEDATA_METHOD_3_A728605FF0D9FC15_OFFSET UNITYSDK_OFFSET(0x16D155C0)
#define RPG_GAMECORE_PARABOLAPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16D00DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ParabolaProjectileData_TypeDefinitionIndex = 14243;
