...
#define RPG_GAMECORE_SETTARGETENTITYFADEWITHANIM_METHOD_3_633C624641099C6D_OFFSET UNITYSDK_OFFSET(0x176F69E0)
#define RPG_GAMECORE_SETTARGETENTITYFADEWITHANIM_METHOD_3_C0F83E57D8FBB8F8_OFFSET UNITYSDK_OFFSET(0x176F6A60)
#define RPG_GAMECORE_SETTARGETENTITYFADEWITHANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x176F6A30)
