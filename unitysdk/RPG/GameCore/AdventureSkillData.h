...
#define RPG_GAMECORE_ADVENTURESKILLDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA322C60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureSkillData_TypeDefinitionIndex = 44687;
