...
#define RPG_GAMECORE_FIVEDIMSIMPLEPROJECTILEMOVECONFIG_METHOD_3_30B6E98AAA4B1F1B_OFFSET UNITYSDK_OFFSET(0x191F19A0)
#define RPG_GAMECORE_FIVEDIMSIMPLEPROJECTILEMOVECONFIG_METHOD_3_4B9A4CB9CDEEB455_OFFSET UNITYSDK_OFFSET(0x191EA780)
#define RPG_GAMECORE_FIVEDIMSIMPLEPROJECTILEMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x191EA760)
