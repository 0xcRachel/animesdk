...
#define RPG_GAMECORE_FIVEDIMSIMPLEPROJECTILEMOVECONFIG_METHOD_3_9B032BB5C63F7211_OFFSET UNITYSDK_OFFSET(0x1A39CC30)
#define RPG_GAMECORE_FIVEDIMSIMPLEPROJECTILEMOVECONFIG_METHOD_3_BD62489BAA4630F4_OFFSET UNITYSDK_OFFSET(0x1A3A40D0)
#define RPG_GAMECORE_FIVEDIMSIMPLEPROJECTILEMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A39CC10)
