...
#define RPG_GAMECORE_DRINKMAKERDAYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16A4AB30)
#define RPG_GAMECORE_DRINKMAKERDAYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16A4B140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DrinkMakerDayRow_TypeDefinitionIndex = 11953;
