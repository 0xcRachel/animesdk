...
#define RPG_GAMECORE_FIVEDIMSETPLAYERTOMUSICFALLACTION_METHOD_3_0ABD65B6F496CADD_OFFSET UNITYSDK_OFFSET(0x1A3A2B80)
#define RPG_GAMECORE_FIVEDIMSETPLAYERTOMUSICFALLACTION_METHOD_3_3199361A58A884E9_OFFSET UNITYSDK_OFFSET(0x1A3A2A70)
#define RPG_GAMECORE_FIVEDIMSETPLAYERTOMUSICFALLACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3A2B60)
