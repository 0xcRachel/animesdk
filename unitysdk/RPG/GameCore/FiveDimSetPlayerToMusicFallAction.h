...
#define RPG_GAMECORE_FIVEDIMSETPLAYERTOMUSICFALLACTION_METHOD_3_6EAFFD47A1CFCEAD_OFFSET UNITYSDK_OFFSET(0x16AD3FE0)
#define RPG_GAMECORE_FIVEDIMSETPLAYERTOMUSICFALLACTION_METHOD_3_FF7F12B290030894_OFFSET UNITYSDK_OFFSET(0x16AD40A0)
#define RPG_GAMECORE_FIVEDIMSETPLAYERTOMUSICFALLACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16AD4080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetPlayerToMusicFallAction_TypeDefinitionIndex = 16823;
