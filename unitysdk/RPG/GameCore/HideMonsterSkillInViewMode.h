...
#define RPG_GAMECORE_HIDEMONSTERSKILLINVIEWMODE_METHOD_3_4A7F28E96BA1AC16_OFFSET UNITYSDK_OFFSET(0x19AC4EF0)
#define RPG_GAMECORE_HIDEMONSTERSKILLINVIEWMODE_METHOD_3_AF40FAAC350034FA_OFFSET UNITYSDK_OFFSET(0x19AC4E10)
#define RPG_GAMECORE_HIDEMONSTERSKILLINVIEWMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x19AC4E90)
