...
#define RPG_GAMECORE_GRIDFIGHTSTAGENODEDISPLAYCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A1BFE50)
#define RPG_GAMECORE_GRIDFIGHTSTAGENODEDISPLAYCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1C0140)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID NodeDesc; // 0x28
