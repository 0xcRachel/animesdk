...
#define RPG_GAMECORE_SETNPCMONSTERSVISIBLE_METHOD_3_26B77EF6B80A680D_OFFSET UNITYSDK_OFFSET(0x176EDCD0)
#define RPG_GAMECORE_SETNPCMONSTERSVISIBLE_METHOD_3_69852CACFFE2E2FD_OFFSET UNITYSDK_OFFSET(0x176EDD60)
#define RPG_GAMECORE_SETNPCMONSTERSVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x176EDD30)
