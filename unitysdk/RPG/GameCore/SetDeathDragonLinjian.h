...
#define RPG_GAMECORE_SETDEATHDRAGONLINJIAN_METHOD_3_72AFD09EE3D819BD_OFFSET UNITYSDK_OFFSET(0x176C60A0)
#define RPG_GAMECORE_SETDEATHDRAGONLINJIAN_METHOD_3_912E10BFC86D4376_OFFSET UNITYSDK_OFFSET(0x176C6120)
#define RPG_GAMECORE_SETDEATHDRAGONLINJIAN__CTOR_OFFSET UNITYSDK_OFFSET(0x176C60F0)
