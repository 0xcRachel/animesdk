...
#define RPG_GAMECORE_SETDEATHDRAGONLINJIAN_METHOD_3_72AFD09EE3D819BD_OFFSET UNITYSDK_OFFSET(0x16F10C10)
#define RPG_GAMECORE_SETDEATHDRAGONLINJIAN_METHOD_3_912E10BFC86D4376_OFFSET UNITYSDK_OFFSET(0x16F10C90)
#define RPG_GAMECORE_SETDEATHDRAGONLINJIAN__CTOR_OFFSET UNITYSDK_OFFSET(0x16F10C60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDeathDragonLinjian_TypeDefinitionIndex = 20506;
