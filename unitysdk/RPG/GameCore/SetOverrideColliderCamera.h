...
#define RPG_GAMECORE_SETOVERRIDECOLLIDERCAMERA_METHOD_3_45F4D090EE628019_OFFSET UNITYSDK_OFFSET(0x199C1820)
#define RPG_GAMECORE_SETOVERRIDECOLLIDERCAMERA_METHOD_3_981C138AE75FC365_OFFSET UNITYSDK_OFFSET(0x199C17A0)
#define RPG_GAMECORE_SETOVERRIDECOLLIDERCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x199C17F0)
