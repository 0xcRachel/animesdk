...
#define RPG_GAMECORE_SETOVERRIDECOLLIDERCAMERA_METHOD_3_45F4D090EE628019_OFFSET UNITYSDK_OFFSET(0x16F39B60)
#define RPG_GAMECORE_SETOVERRIDECOLLIDERCAMERA_METHOD_3_981C138AE75FC365_OFFSET UNITYSDK_OFFSET(0x16F39AE0)
#define RPG_GAMECORE_SETOVERRIDECOLLIDERCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x16F39B30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetOverrideColliderCamera_TypeDefinitionIndex = 20053;
