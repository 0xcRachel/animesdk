...
#define RPG_GAMECORE_PLANETFESEVENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19D4BD60)
#define RPG_GAMECORE_PLANETFESEVENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19D4BFE0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 InitialAppearCD; // 0x18
