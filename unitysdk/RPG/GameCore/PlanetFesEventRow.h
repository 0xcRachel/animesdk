...
#define RPG_GAMECORE_PLANETFESEVENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16D46800)
#define RPG_GAMECORE_PLANETFESEVENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16D46A90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlanetFesEventRow_TypeDefinitionIndex = 11094;

	class PlanetFesEventRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* UnlockIDList; // 0x10
		::RPG::GameCore::PlanetFesEventType ID; // 0x18
		::System::UInt32 StayInterval; // 0x1C
		::System::UInt32 InitialAppearCD; // 0x20
		::System::UInt32 FailRecurCD; // 0x24
		::System::UInt32 RecurCD; // 0x28
		::System::UInt32 ReenterAppearCD; // 0x2C
