...
#define RPG_GAMECORE_INITERAFLIPPERREGION_METHOD_3_1B2E1B16386B3E5B_OFFSET UNITYSDK_OFFSET(0x1888EA80)
#define RPG_GAMECORE_INITERAFLIPPERREGION_METHOD_3_3E11595DBB3014FD_OFFSET UNITYSDK_OFFSET(0x1888EA00)
#define RPG_GAMECORE_INITERAFLIPPERREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x1888EA50)
