...
#define RPG_GAMECORE_MARBLELAUNCHAICONFIG_METHOD_2_3D2FC51262288A18_OFFSET UNITYSDK_OFFSET(0x16C3F9C0)
#define RPG_GAMECORE_MARBLELAUNCHAICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16C3FC20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleLaunchAIConfig_TypeDefinitionIndex = 15225;
