...
#define RPG_GAMECORE_OPENTREASURECHALLENGE_METHOD_3_48D31592A1E45A8C_OFFSET UNITYSDK_OFFSET(0x16D0B5A0)
#define RPG_GAMECORE_OPENTREASURECHALLENGE_METHOD_3_E8D9A96185334CFD_OFFSET UNITYSDK_OFFSET(0x16D0B620)
#define RPG_GAMECORE_OPENTREASURECHALLENGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16D0B5F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OpenTreasureChallenge_TypeDefinitionIndex = 18250;
