...
#define RPG_GAMECORE_OPENTREASURECHALLENGE_METHOD_3_48D31592A1E45A8C_OFFSET UNITYSDK_OFFSET(0x18EF1000)
#define RPG_GAMECORE_OPENTREASURECHALLENGE_METHOD_3_E8D9A96185334CFD_OFFSET UNITYSDK_OFFSET(0x18EF1080)
#define RPG_GAMECORE_OPENTREASURECHALLENGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18EF1050)
