...
#define RPG_GAMECORE_BYCOMPARESTRINGVALUE_METHOD_4_55E432B5BF15EB34_OFFSET UNITYSDK_OFFSET(0x1691C5C0)
#define RPG_GAMECORE_BYCOMPARESTRINGVALUE_METHOD_4_6FFE7B90C24B7836_OFFSET UNITYSDK_OFFSET(0x1691C690)
#define RPG_GAMECORE_BYCOMPARESTRINGVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1691C640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareStringValue_TypeDefinitionIndex = 20642;
