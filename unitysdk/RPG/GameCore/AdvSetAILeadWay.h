...
#define RPG_GAMECORE_ADVSETAILEADWAY_METHOD_3_244FE280F840976B_OFFSET UNITYSDK_OFFSET(0x16845F30)
#define RPG_GAMECORE_ADVSETAILEADWAY_METHOD_3_EA32733C8FCC2B31_OFFSET UNITYSDK_OFFSET(0x16846010)
#define RPG_GAMECORE_ADVSETAILEADWAY__CTOR_OFFSET UNITYSDK_OFFSET(0x16845FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetAILeadWay_TypeDefinitionIndex = 19848;
