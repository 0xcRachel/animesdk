...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::TrainPartyStatType>**)Il2CppClass::FromTypeDefinitionIndex(TrainPartyActionAddStatByStepConfig___O_TypeDefinitionIndex)->GetStaticField(0xD690);
		}
	};
}
