...
#define RPG_GAMECORE_RTTARGETMAPSKILLCASTPOS_METHOD_3_2A01848665E3CBF1_OFFSET UNITYSDK_OFFSET(0x1A160CF0)
#define RPG_GAMECORE_RTTARGETMAPSKILLCASTPOS_METHOD_3_4DACBECCAF552C01_OFFSET UNITYSDK_OFFSET(0x1A160C90)
#define RPG_GAMECORE_RTTARGETMAPSKILLCASTPOS_METHOD_3_8F6E66689235D067_OFFSET UNITYSDK_OFFSET(0x1A160C30)
#define RPG_GAMECORE_RTTARGETMAPSKILLCASTPOS_METHOD_3_D86298FC3F931F09_OFFSET UNITYSDK_OFFSET(0x1A160B50)
#define RPG_GAMECORE_RTTARGETMAPSKILLCASTPOS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A160C10)
