...
#define RPG_GAMECORE_FIVEDIMMUSICEVENTINFO_METHOD_2_F26BB78BDB83EDAE_OFFSET UNITYSDK_OFFSET(0x16ACA1E0)
#define RPG_GAMECORE_FIVEDIMMUSICEVENTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16ACA300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMusicEventInfo_TypeDefinitionIndex = 16866;
