...
#define RPG_GAMECORE_SHOWFUNCUNLOCKHINTDIALOG_METHOD_3_273F6D7E08EAD58F_OFFSET UNITYSDK_OFFSET(0x193A8C60)
#define RPG_GAMECORE_SHOWFUNCUNLOCKHINTDIALOG_METHOD_3_849C10DADCD26CD1_OFFSET UNITYSDK_OFFSET(0x193A8BE0)
#define RPG_GAMECORE_SHOWFUNCUNLOCKHINTDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x193A8C30)
