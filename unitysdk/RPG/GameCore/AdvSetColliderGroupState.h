...
#define RPG_GAMECORE_ADVSETCOLLIDERGROUPSTATE_METHOD_3_70FFE2C36537E9CD_OFFSET UNITYSDK_OFFSET(0x18C5A3F0)
#define RPG_GAMECORE_ADVSETCOLLIDERGROUPSTATE_METHOD_3_A329B87B6F1A1411_OFFSET UNITYSDK_OFFSET(0x18C5A370)
#define RPG_GAMECORE_ADVSETCOLLIDERGROUPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C5A3C0)
