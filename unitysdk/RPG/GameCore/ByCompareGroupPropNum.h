...
#define RPG_GAMECORE_BYCOMPAREGROUPPROPNUM_METHOD_4_73D77DE063DE2A05_OFFSET UNITYSDK_OFFSET(0x1701EE80)
#define RPG_GAMECORE_BYCOMPAREGROUPPROPNUM_METHOD_4_98E352EE577B9DFC_OFFSET UNITYSDK_OFFSET(0x1701EF50)
#define RPG_GAMECORE_BYCOMPAREGROUPPROPNUM__CTOR_OFFSET UNITYSDK_OFFSET(0x1701EF00)
