...
#define RPG_GAMECORE_MONSTERTEAMAPPEAR_METHOD_3_3089BA7EF910CDE9_OFFSET UNITYSDK_OFFSET(0x16CE2760)
#define RPG_GAMECORE_MONSTERTEAMAPPEAR_METHOD_3_5CB0C45CEF095730_OFFSET UNITYSDK_OFFSET(0x16CE27E0)
#define RPG_GAMECORE_MONSTERTEAMAPPEAR__CTOR_OFFSET UNITYSDK_OFFSET(0x16CE27B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonsterTeamAppear_TypeDefinitionIndex = 21064;
