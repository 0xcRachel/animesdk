...
#define RPG_GAMECORE_HELIOBUSCHALLENGESTAGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19AB9790)
#define RPG_GAMECORE_HELIOBUSCHALLENGESTAGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19AB9D00)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 HeliobusChallengeHard; // 0x34
