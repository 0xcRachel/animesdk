...
#define RPG_GAMECORE_LISTENTARGETUSESKILL_METHOD_3_41E06D28B56B42F2_OFFSET UNITYSDK_OFFSET(0x16BC4850)
#define RPG_GAMECORE_LISTENTARGETUSESKILL_METHOD_3_4F412DBA8CD64911_OFFSET UNITYSDK_OFFSET(0x16BC47D0)
#define RPG_GAMECORE_LISTENTARGETUSESKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x16BC4820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ListenTargetUseSkill_TypeDefinitionIndex = 19383;
