...
#define RPG_GAMECORE_TARGETFETCHTURNACTIONENTITY_METHOD_4_B95471B175C55B48_OFFSET UNITYSDK_OFFSET(0x16FDFCC0)
#define RPG_GAMECORE_TARGETFETCHTURNACTIONENTITY_METHOD_4_C28B2D6E951406DA_OFFSET UNITYSDK_OFFSET(0x16FDFDD0)
#define RPG_GAMECORE_TARGETFETCHTURNACTIONENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x16FDFD80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchTurnActionEntity_TypeDefinitionIndex = 21710;
