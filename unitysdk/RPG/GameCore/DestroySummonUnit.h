...
#define RPG_GAMECORE_DESTROYSUMMONUNIT_METHOD_3_222141FED5B7D360_OFFSET UNITYSDK_OFFSET(0x17169290)
#define RPG_GAMECORE_DESTROYSUMMONUNIT_METHOD_3_B0092562FAECF859_OFFSET UNITYSDK_OFFSET(0x17169310)
#define RPG_GAMECORE_DESTROYSUMMONUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x171692E0)
