...
#define RPG_GAMECORE_DESTROYSUMMONUNIT_METHOD_3_3F284C2C2133A36A_OFFSET UNITYSDK_OFFSET(0x19585930)
#define RPG_GAMECORE_DESTROYSUMMONUNIT_METHOD_3_DDE39ACCC4274351_OFFSET UNITYSDK_OFFSET(0x195859B0)
#define RPG_GAMECORE_DESTROYSUMMONUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x19585980)
