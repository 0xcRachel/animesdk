...
#define RPG_GAMECORE_DESTROYSUMMONUNIT_METHOD_3_222141FED5B7D360_OFFSET UNITYSDK_OFFSET(0x169ED2A0)
#define RPG_GAMECORE_DESTROYSUMMONUNIT_METHOD_3_B0092562FAECF859_OFFSET UNITYSDK_OFFSET(0x169ED320)
#define RPG_GAMECORE_DESTROYSUMMONUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x169ED2F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DestroySummonUnit_TypeDefinitionIndex = 18133;
