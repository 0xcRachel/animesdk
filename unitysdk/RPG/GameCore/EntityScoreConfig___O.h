...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::EntityScoreType>**)Il2CppClass::FromTypeDefinitionIndex(EntityScoreConfig___O_TypeDefinitionIndex)->GetStaticField(0x390F0);
		}
	};
}
