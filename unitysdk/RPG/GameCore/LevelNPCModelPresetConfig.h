...
#define RPG_GAMECORE_LEVELNPCMODELPRESETCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16BAF220)
#define RPG_GAMECORE_LEVELNPCMODELPRESETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16BAFA10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelNPCModelPresetConfig_TypeDefinitionIndex = 15590;
