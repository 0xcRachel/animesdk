...
#define RPG_GAMECORE_DEVICESETTINGGROUP_METHOD_2_82DD6C1D2E693301_OFFSET UNITYSDK_OFFSET(0x169F0310)
#define RPG_GAMECORE_DEVICESETTINGGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x169F0550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DeviceSettingGroup_TypeDefinitionIndex = 14822;
