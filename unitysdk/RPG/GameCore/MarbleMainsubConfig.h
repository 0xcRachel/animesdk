...
#define RPG_GAMECORE_MARBLEMAINSUBCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16C3EEF0)
#define RPG_GAMECORE_MARBLEMAINSUBCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16C400F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleMainsubConfig_TypeDefinitionIndex = 16957;
