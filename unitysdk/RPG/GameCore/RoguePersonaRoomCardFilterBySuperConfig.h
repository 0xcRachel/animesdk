...
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYSUPERCONFIG_METHOD_3_1B5F6E4F93CD6AF2_OFFSET UNITYSDK_OFFSET(0x1766C200)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYSUPERCONFIG_METHOD_3_35E1F7A603BCF516_OFFSET UNITYSDK_OFFSET(0x1766C4D0)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYSUPERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1766C1F0)
