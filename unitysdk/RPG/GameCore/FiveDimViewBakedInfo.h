...
#define RPG_GAMECORE_FIVEDIMVIEWBAKEDINFO_METHOD_2_3301C081C377F1DC_OFFSET UNITYSDK_OFFSET(0x191F7FF0)
#define RPG_GAMECORE_FIVEDIMVIEWBAKEDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x191F82D0)
