...
#define RPG_GAMECORE_RESTAURANTOPTIONEFFECTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16DED510)
#define RPG_GAMECORE_RESTAURANTOPTIONEFFECTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16DED800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RestaurantOptionEffectConfigRow_TypeDefinitionIndex = 10574;

	class RestaurantOptionEffectConfigRow : public ::System::Object
	{
	public:
		::System::UInt32 Param; // 0x10
		::System::UInt32 EventRewardID; // 0x14
