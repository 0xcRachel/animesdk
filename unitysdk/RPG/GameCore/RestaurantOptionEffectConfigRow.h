...
#define RPG_GAMECORE_RESTAURANTOPTIONEFFECTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x175BA6A0)
#define RPG_GAMECORE_RESTAURANTOPTIONEFFECTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x175BA990)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 EventRewardID; // 0x1C
		::RPG::Client::TextID OptionText; // 0x20
		::RPG::Client::TextID ResultText; // 0x30
		::RPG::GameCore::RestaurantSelectionType Type; // 0x40
