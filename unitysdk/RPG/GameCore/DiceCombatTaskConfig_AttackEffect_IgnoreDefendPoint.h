...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKEFFECT_IGNOREDEFENDPOINT_METHOD_3_801384CF7852BC53_OFFSET UNITYSDK_OFFSET(0x171847D0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKEFFECT_IGNOREDEFENDPOINT_METHOD_3_F4D2952B3E22E36B_OFFSET UNITYSDK_OFFSET(0x17180120)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKEFFECT_IGNOREDEFENDPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x171800D0)
