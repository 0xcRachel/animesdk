...
#define RPG_GAMECORE_ELFDECORATORCONFIG_METHOD_3_0796C7F8F5EA2B1D_OFFSET UNITYSDK_OFFSET(0x16A5F5A0)
#define RPG_GAMECORE_ELFDECORATORCONFIG_METHOD_3_A921478E76A52486_OFFSET UNITYSDK_OFFSET(0x16A5F480)
#define RPG_GAMECORE_ELFDECORATORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16A5F580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfDecoratorConfig_TypeDefinitionIndex = 16582;
