...
#define RPG_GAMECORE_ELFDECORATORCONFIG_METHOD_3_0796C7F8F5EA2B1D_OFFSET UNITYSDK_OFFSET(0x171A1D90)
#define RPG_GAMECORE_ELFDECORATORCONFIG_METHOD_3_A921478E76A52486_OFFSET UNITYSDK_OFFSET(0x171A1C70)
#define RPG_GAMECORE_ELFDECORATORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171A1D70)
