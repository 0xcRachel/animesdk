...
#define RPG_GAMECORE_FREESTYLECONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA417150)
#define RPG_GAMECORE_FREESTYLECONTROLLER_GET_INFO_OFFSET UNITYSDK_OFFSET(0xA416D40)
#define RPG_GAMECORE_FREESTYLECONTROLLER_GET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0xA416D50)
#define RPG_GAMECORE_FREESTYLECONTROLLER_METHOD_1_1779A83FFA83BA8F_OFFSET UNITYSDK_OFFSET(0xA416F00)
#define RPG_GAMECORE_FREESTYLECONTROLLER_METHOD_1_2685B6183E614529_1_OFFSET UNITYSDK_OFFSET(0xA416E10)
#define RPG_GAMECORE_FREESTYLECONTROLLER_METHOD_1_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0xA416DB0)
#define RPG_GAMECORE_FREESTYLECONTROLLER_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0xA4170C0)
#define RPG_GAMECORE_FREESTYLECONTROLLER_METHOD_1_4120FFA8338789EF_OFFSET UNITYSDK_OFFSET(0xA416F90)
#define RPG_GAMECORE_FREESTYLECONTROLLER_METHOD_1_53C2CF710DB7E6D5_OFFSET UNITYSDK_OFFSET(0xA416E70)
#define RPG_GAMECORE_FREESTYLECONTROLLER_METHOD_1_6D0DBA549ECE8225_OFFSET UNITYSDK_OFFSET(0xA417050)
#define RPG_GAMECORE_FREESTYLECONTROLLER_METHOD_1_7EFDB9F1D6E62586_OFFSET UNITYSDK_OFFSET(0xA415690)
#define RPG_GAMECORE_FREESTYLECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA416D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FreeStyleController_TypeDefinitionIndex = 45062;
