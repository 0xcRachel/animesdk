...
#define RPG_GAMECORE_ROGUETOURNROOMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16ECE090)
#define RPG_GAMECORE_ROGUETOURNROOMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16ECE240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournRoomRow_TypeDefinitionIndex = 13616;
