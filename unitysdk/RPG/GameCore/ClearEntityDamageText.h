...
#define RPG_GAMECORE_CLEARENTITYDAMAGETEXT_METHOD_3_146577BE06A515F2_OFFSET UNITYSDK_OFFSET(0x169A4210)
#define RPG_GAMECORE_CLEARENTITYDAMAGETEXT_METHOD_3_1541E3B02F9A9FD0_OFFSET UNITYSDK_OFFSET(0x169A4190)
#define RPG_GAMECORE_CLEARENTITYDAMAGETEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x169A41E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearEntityDamageText_TypeDefinitionIndex = 20876;
