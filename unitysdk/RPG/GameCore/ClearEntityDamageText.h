...
#define RPG_GAMECORE_CLEARENTITYDAMAGETEXT_METHOD_3_100AACAB89A99C19_OFFSET UNITYSDK_OFFSET(0x170C62E0)
#define RPG_GAMECORE_CLEARENTITYDAMAGETEXT_METHOD_3_93C867813B48A7A6_OFFSET UNITYSDK_OFFSET(0x170C6360)
#define RPG_GAMECORE_CLEARENTITYDAMAGETEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x170C6330)
