...
#define RPG_GAMECORE_BYISFIRSTCHALLENGEBATTLE_METHOD_4_A793FAE4B9E74F89_OFFSET UNITYSDK_OFFSET(0x17042840)
#define RPG_GAMECORE_BYISFIRSTCHALLENGEBATTLE_METHOD_4_D5067D9BA9721973_OFFSET UNITYSDK_OFFSET(0x17042910)
#define RPG_GAMECORE_BYISFIRSTCHALLENGEBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x170428C0)
