...
#define RPG_GAMECORE_BYISFIRSTCHALLENGEBATTLE_METHOD_4_A6049B4650A43ADC_OFFSET UNITYSDK_OFFSET(0x19DA6C00)
#define RPG_GAMECORE_BYISFIRSTCHALLENGEBATTLE_METHOD_4_A793FAE4B9E74F89_OFFSET UNITYSDK_OFFSET(0x19DA6970)
#define RPG_GAMECORE_BYISFIRSTCHALLENGEBATTLE_METHOD_4_BD6FAE8D54B3E1E4_OFFSET UNITYSDK_OFFSET(0x19DA6B80)
#define RPG_GAMECORE_BYISFIRSTCHALLENGEBATTLE_METHOD_4_D5067D9BA9721973_OFFSET UNITYSDK_OFFSET(0x19DA6A40)
#define RPG_GAMECORE_BYISFIRSTCHALLENGEBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19DA69F0)
