...
#define RPG_GAMECORE_AVATARDATACOMPONENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA87B750)
#define RPG_GAMECORE_AVATARDATACOMPONENT_GETAETHERDIVIDEPASSIVESKILLLIST_OFFSET UNITYSDK_OFFSET(0xA87D540)
#define RPG_GAMECORE_AVATARDATACOMPONENT_GETBATTLEEQUIPMENTDATA_OFFSET UNITYSDK_OFFSET(0xA879540)
#define RPG_GAMECORE_AVATARDATACOMPONENT_GETBATTLERELICMODULE_OFFSET UNITYSDK_OFFSET(0xA87B3D0)
#define RPG_GAMECORE_AVATARDATACOMPONENT_GETCHARACTERNAME_OFFSET UNITYSDK_OFFSET(0xA87B930)
#define RPG_GAMECORE_AVATARDATACOMPONENT_GETEQUIPMENT_OFFSET UNITYSDK_OFFSET(0xA87E310)
#define RPG_GAMECORE_AVATARDATACOMPONENT_GETRANKCONFIGROWBYTRIGGERKEY_OFFSET UNITYSDK_OFFSET(0xA87D750)
#define RPG_GAMECORE_AVATARDATACOMPONENT_GETREALEQUIPMENTSKILLNAME_OFFSET UNITYSDK_OFFSET(0xA87D3B0)
#define RPG_GAMECORE_AVATARDATACOMPONENT_GETREALEQUIPMENTSKILLPARAMS_OFFSET UNITYSDK_OFFSET(0xA87D900)
#define RPG_GAMECORE_AVATARDATACOMPONENT_GETSKILLTREEROWBYTRIGGERKEY_OFFSET UNITYSDK_OFFSET(0xA87D5A0)
#define RPG_GAMECORE_AVATARDATACOMPONENT_GET_AETHERDIVIDESPIRITLINEUPTYPE_OFFSET UNITYSDK_OFFSET(0xA87EE10)
#define RPG_GAMECORE_AVATARDATACOMPONENT_GET_AVATARROWDATA_OFFSET UNITYSDK_OFFSET(0xA87EA80)
#define RPG_GAMECORE_AVATARDATACOMPONENT_GET_CREATEPARAMS_OFFSET UNITYSDK_OFFSET(0xA87EB80)
#define RPG_GAMECORE_AVATARDATACOMPONENT_GET_DISABLEULTRABTNBYSHOWAVATARPANEL_OFFSET UNITYSDK_OFFSET(0xA87F0D0)
#define RPG_GAMECORE_AVATARDATACOMPONENT_GET_ENERGYBARSTATE_OFFSET UNITYSDK_OFFSET(0xA87F080)
#define RPG_GAMECORE_AVATARDATACOMPONENT_GET_ENHANCEDID_OFFSET UNITYSDK_OFFSET(0xA87EA40)
#define RPG_GAMECORE_AVATARDATACOMPONENT_GET_GRIDFIGHTROWWRAP_OFFSET UNITYSDK_OFFSET(0xA87EA90)
#define RPG_GAMECORE_AVATARDATACOMPONENT_GET_HASLIFE_OFFSET UNITYSDK_OFFSET(0xA87EA70)
#define RPG_GAMECORE_AVATARDATACOMPONENT_GET_ISAETHERDIVIDETRIAL_OFFSET UNITYSDK_OFFSET(0xA87EE70)
#define RPG_GAMECORE_AVATARDATACOMPONENT_GET_ISAETHERDIVIDE_OFFSET UNITYSDK_OFFSET(0xA87ED10)
#define RPG_GAMECORE_AVATARDATACOMPONENT_GET_ISASSISTANTAVATAR_OFFSET UNITYSDK_OFFSET(0xA87ECE0)
#define RPG_GAMECORE_AVATARDATACOMPONENT_GET_ISFAKEAVATAR_OFFSET UNITYSDK_OFFSET(0xA87EC80)
#define RPG_GAMECORE_AVATARDATACOMPONENT_GET_ISSPECIALAVATAR_OFFSET UNITYSDK_OFFSET(0xA87EB90)
#define RPG_GAMECORE_AVATARDATACOMPONENT_GET_ISTRIALPLAYER_OFFSET UNITYSDK_OFFSET(0xA87EBC0)
#define RPG_GAMECORE_AVATARDATACOMPONENT_GET_SERVANTINHERITANCEMANAGER_OFFSET UNITYSDK_OFFSET(0xA87F0E0)
#define RPG_GAMECORE_AVATARDATACOMPONENT_GET_SHOWAVATARPANEL_OFFSET UNITYSDK_OFFSET(0xA87F0B0)
#define RPG_GAMECORE_AVATARDATACOMPONENT_GET_SPECIALAVATARTYPE_OFFSET UNITYSDK_OFFSET(0xA87EC20)
#define RPG_GAMECORE_AVATARDATACOMPONENT_GET_SUMMONERENERGYBARSTATE_OFFSET UNITYSDK_OFFSET(0xA87F090)
#define RPG_GAMECORE_AVATARDATACOMPONENT_GET_TOTALPOWER_OFFSET UNITYSDK_OFFSET(0xA87EF30)
#define RPG_GAMECORE_AVATARDATACOMPONENT_GET_ULTRASKILLCONFIG_OFFSET UNITYSDK_OFFSET(0xA87EF90)
#define RPG_GAMECORE_AVATARDATACOMPONENT_GET_ULTRASKILLTYPE_OFFSET UNITYSDK_OFFSET(0xA87EFF0)
#define RPG_GAMECORE_AVATARDATACOMPONENT_GET_WORLDLEVEL_OFFSET UNITYSDK_OFFSET(0xA87EED0)
#define RPG_GAMECORE_AVATARDATACOMPONENT_INITBATTLECHARACTERDATA_OFFSET UNITYSDK_OFFSET(0xA8767E0)
#define RPG_GAMECORE_AVATARDATACOMPONENT_ONABILITYCHARACTERINITIALIZED_OFFSET UNITYSDK_OFFSET(0xA877400)
#define RPG_GAMECORE_AVATARDATACOMPONENT_RESETAVATARPROPERTY_OFFSET UNITYSDK_OFFSET(0xA877E00)
#define RPG_GAMECORE_AVATARDATACOMPONENT_SETSHOWAVATARPANEL_OFFSET UNITYSDK_OFFSET(0xA87E730)
#define RPG_GAMECORE_AVATARDATACOMPONENT_SETUPINITIALABILITY_OFFSET UNITYSDK_OFFSET(0xA87BD40)
#define RPG_GAMECORE_AVATARDATACOMPONENT_SET_DISABLEULTRABTNBYSHOWAVATARPANEL_OFFSET UNITYSDK_OFFSET(0xA87F0C0)
#define RPG_GAMECORE_AVATARDATACOMPONENT_SET_ROWDATA_OFFSET UNITYSDK_OFFSET(0xA87EAF0)
#define RPG_GAMECORE_AVATARDATACOMPONENT_SET_SERVANTINHERITANCEMANAGER_OFFSET UNITYSDK_OFFSET(0xA87F0F0)
#define RPG_GAMECORE_AVATARDATACOMPONENT_SET_SHOWAVATARPANEL_OFFSET UNITYSDK_OFFSET(0xA87F0A0)
#define RPG_GAMECORE_AVATARDATACOMPONENT_UPDATEENERGYBARSTATE_1_OFFSET UNITYSDK_OFFSET(0xA87DEC0)
#define RPG_GAMECORE_AVATARDATACOMPONENT_UPDATEENERGYBARSTATE_OFFSET UNITYSDK_OFFSET(0xA87DC90)
#define RPG_GAMECORE_AVATARDATACOMPONENT_UPDATESUMMONERENERGYBARSTATE_1_OFFSET UNITYSDK_OFFSET(0xA87E240)
#define RPG_GAMECORE_AVATARDATACOMPONENT_UPDATESUMMONERENERGYBARSTATE_OFFSET UNITYSDK_OFFSET(0xA87E020)
#define RPG_GAMECORE_AVATARDATACOMPONENT__CCTOR_OFFSET UNITYSDK_OFFSET(0xA87F100)
#define RPG_GAMECORE_AVATARDATACOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0xA876670)
#define RPG_GAMECORE_AVATARDATACOMPONENT__FILLDYNAMICVALUES_OFFSET UNITYSDK_OFFSET(0xA879290)
#define RPG_GAMECORE_AVATARDATACOMPONENT__GETEQUIPMENT_G___GETEQUIPMENTFROMAVATARDATA_33_0_OFFSET UNITYSDK_OFFSET(0xA87E720)
#define RPG_GAMECORE_AVATARDATACOMPONENT__GETEQUIPMENT_G___GETEQUIPMENTFROMLINEUPDATA_33_1_OFFSET UNITYSDK_OFFSET(0xA87E600)
#define RPG_GAMECORE_AVATARDATACOMPONENT__INITEVENT_OFFSET UNITYSDK_OFFSET(0xA879010)
#define RPG_GAMECORE_AVATARDATACOMPONENT__ONENTITYREVIVE_OFFSET UNITYSDK_OFFSET(0xA87DB20)
#define RPG_GAMECORE_AVATARDATACOMPONENT__ONINITOWNERREF_OFFSET UNITYSDK_OFFSET(0xA876700)
#define RPG_GAMECORE_AVATARDATACOMPONENT__ONPREABILITYADD_OFFSET UNITYSDK_OFFSET(0xA87DA90)
#define RPG_GAMECORE_AVATARDATACOMPONENT__RESETSKILLTREEANDRELATEDPROPERTY_OFFSET UNITYSDK_OFFSET(0xA87B430)
#define RPG_GAMECORE_AVATARDATACOMPONENT__SETUPAETHERDIVIDEPASSIVEABILITY_OFFSET UNITYSDK_OFFSET(0xA87CBE0)
#define RPG_GAMECORE_AVATARDATACOMPONENT__SETUPEQUIPMENTABILITY_OFFSET UNITYSDK_OFFSET(0xA87C690)
#define RPG_GAMECORE_AVATARDATACOMPONENT__SETUPEQUIPMENTADDEDPROPERTY_OFFSET UNITYSDK_OFFSET(0xA87B1C0)
#define RPG_GAMECORE_AVATARDATACOMPONENT__SETUPOVERRIDEPROPERTY_OFFSET UNITYSDK_OFFSET(0xA8790C0)
#define RPG_GAMECORE_AVATARDATACOMPONENT__SETUPRANKCONFIGABILITY_OFFSET UNITYSDK_OFFSET(0xA87BFF0)
#define RPG_GAMECORE_AVATARDATACOMPONENT__SETUPRELICABILITY_OFFSET UNITYSDK_OFFSET(0xA87C8B0)
#define RPG_GAMECORE_AVATARDATACOMPONENT__SETUPSKILLTREEABILITY_OFFSET UNITYSDK_OFFSET(0xA87BDB0)
#define RPG_GAMECORE_AVATARDATACOMPONENT__SETUPTRIALPLAYERABILITY_OFFSET UNITYSDK_OFFSET(0xA87CA90)
#define RPG_GAMECORE_AVATARDATACOMPONENT__UNINITEVENT_OFFSET UNITYSDK_OFFSET(0xA87B830)
#define RPG_GAMECORE_AVATARDATACOMPONENT___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA87F330)
#define RPG_GAMECORE_AVATARDATACOMPONENT___IFIXBASEPROXY_GETCHARACTERNAME_OFFSET UNITYSDK_OFFSET(0xA87F380)
#define RPG_GAMECORE_AVATARDATACOMPONENT___IFIXBASEPROXY_INITBATTLECHARACTERDATA_OFFSET UNITYSDK_OFFSET(0xA87F1F0)
#define RPG_GAMECORE_AVATARDATACOMPONENT___IFIXBASEPROXY_ONABILITYCHARACTERINITIALIZED_OFFSET UNITYSDK_OFFSET(0xA87F290)
#define RPG_GAMECORE_AVATARDATACOMPONENT___IFIXBASEPROXY_SET_ROWDATA_OFFSET UNITYSDK_OFFSET(0xA87F390)
#define RPG_GAMECORE_AVATARDATACOMPONENT___IFIXBASEPROXY__ONINITOWNERREF_OFFSET UNITYSDK_OFFSET(0xA87F190)
...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Il2CppArray<::RPG::GameCore::AbilityProperty>**)Il2CppClass::FromTypeDefinitionIndex(AvatarDataComponent_TypeDefinitionIndex)->GetStaticField(0x460E0);
		}
		::RPG::GameCore::AvatarRowData* _AvatarRowData; // 0x110
		::RPG::GameCore::AvatarEnergyBarState* _EnergyBarState; // 0x118
		::Class_1_709C4C5FB0270D6D* _ServantInheritanceManager_k__BackingField; // 0x120
