...
#define RPG_GAMECORE_ADVDISABLEPLAYERLOCKTARGET_METHOD_3_1429C3FF32348E7A_OFFSET UNITYSDK_OFFSET(0x16831A10)
#define RPG_GAMECORE_ADVDISABLEPLAYERLOCKTARGET_METHOD_3_96F495DD97951803_OFFSET UNITYSDK_OFFSET(0x16831990)
#define RPG_GAMECORE_ADVDISABLEPLAYERLOCKTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x168319E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvDisablePlayerLockTarget_TypeDefinitionIndex = 18349;
