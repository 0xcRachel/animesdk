...
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYLEVELMAXCONFIG_METHOD_3_CE18CFE180B9EE21_OFFSET UNITYSDK_OFFSET(0x1766C3D0)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYLEVELMAXCONFIG_METHOD_3_F38CF28ACD109F85_OFFSET UNITYSDK_OFFSET(0x1766C180)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYLEVELMAXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1766C170)
