...
#define RPG_GAMECORE_RESETADVENTURECHARACTERCOLLIDER_METHOD_3_79898F93F3CDD53F_OFFSET UNITYSDK_OFFSET(0x16DE4820)
#define RPG_GAMECORE_RESETADVENTURECHARACTERCOLLIDER_METHOD_3_CD936FD75534C993_OFFSET UNITYSDK_OFFSET(0x16DE4930)
#define RPG_GAMECORE_RESETADVENTURECHARACTERCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x16DE4900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetAdventureCharacterCollider_TypeDefinitionIndex = 20069;
