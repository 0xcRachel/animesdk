...
#define RPG_GAMECORE_RESETADVENTURECHARACTERCOLLIDER_METHOD_3_79898F93F3CDD53F_OFFSET UNITYSDK_OFFSET(0x175B19B0)
#define RPG_GAMECORE_RESETADVENTURECHARACTERCOLLIDER_METHOD_3_CD936FD75534C993_OFFSET UNITYSDK_OFFSET(0x175B1AC0)
#define RPG_GAMECORE_RESETADVENTURECHARACTERCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x175B1A90)
