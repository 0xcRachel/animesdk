...
#define RPG_GAMECORE_FIVEDIMSIMPLEHITBOXCONFIG_METHOD_3_7A3175C93FB13C73_OFFSET UNITYSDK_OFFSET(0x1A3A3E00)
#define RPG_GAMECORE_FIVEDIMSIMPLEHITBOXCONFIG_METHOD_3_8E7C4DE58F775994_OFFSET UNITYSDK_OFFSET(0x1A3A3E70)
#define RPG_GAMECORE_FIVEDIMSIMPLEHITBOXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3A3E50)
