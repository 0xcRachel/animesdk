...
#define RPG_GAMECORE_SHOWARCHERPROJECTIONSELECTINBATTLE_METHOD_3_A04EE639F9EFD732_OFFSET UNITYSDK_OFFSET(0x17708740)
#define RPG_GAMECORE_SHOWARCHERPROJECTIONSELECTINBATTLE_METHOD_3_F22454B377229371_OFFSET UNITYSDK_OFFSET(0x177087C0)
#define RPG_GAMECORE_SHOWARCHERPROJECTIONSELECTINBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x17708790)
