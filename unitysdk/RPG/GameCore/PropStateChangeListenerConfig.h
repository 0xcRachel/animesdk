...
#define RPG_GAMECORE_PROPSTATECHANGELISTENERCONFIG_METHOD_3_47AEF3101111810B_OFFSET UNITYSDK_OFFSET(0x16DB7370)
#define RPG_GAMECORE_PROPSTATECHANGELISTENERCONFIG_METHOD_3_D41613BCE9AC3605_OFFSET UNITYSDK_OFFSET(0x16DB7220)
#define RPG_GAMECORE_PROPSTATECHANGELISTENERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16DB72E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropStateChangeListenerConfig_TypeDefinitionIndex = 18177;
