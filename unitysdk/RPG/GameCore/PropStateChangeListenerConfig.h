...
#define RPG_GAMECORE_PROPSTATECHANGELISTENERCONFIG_METHOD_3_47AEF3101111810B_OFFSET UNITYSDK_OFFSET(0x17583350)
#define RPG_GAMECORE_PROPSTATECHANGELISTENERCONFIG_METHOD_3_D41613BCE9AC3605_OFFSET UNITYSDK_OFFSET(0x17583200)
#define RPG_GAMECORE_PROPSTATECHANGELISTENERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175832C0)
