...
#define RPG_GAMECORE_PLAYOPTIONTALK_METHOD_3_A2AF3F66BE742CDD_OFFSET UNITYSDK_OFFSET(0x16D50A90)
#define RPG_GAMECORE_PLAYOPTIONTALK_METHOD_3_ABC843CFA50EFCDC_OFFSET UNITYSDK_OFFSET(0x16D50B10)
#define RPG_GAMECORE_PLAYOPTIONTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x16D50AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayOptionTalk_TypeDefinitionIndex = 18656;
