...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_HASDICEPAIR_METHOD_4_D1B9825CB2CC9110_OFFSET UNITYSDK_OFFSET(0x1717B4D0)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_HASDICEPAIR_METHOD_4_E3FC1BD266E78D76_OFFSET UNITYSDK_OFFSET(0x17179430)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_HASDICEPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x17179390)
