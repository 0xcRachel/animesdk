...
#define RPG_GAMECORE_ROGUEMONSTERELITEDROPITEMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16EA2E60)
#define RPG_GAMECORE_ROGUEMONSTERELITEDROPITEMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16EA2F80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMonsterEliteDropItemRow_TypeDefinitionIndex = 13346;
