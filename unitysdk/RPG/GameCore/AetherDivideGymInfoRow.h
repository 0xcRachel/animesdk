...
#define RPG_GAMECORE_AETHERDIVIDEGYMINFOROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18BBDD60)
#define RPG_GAMECORE_AETHERDIVIDEGYMINFOROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18BBE750)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 SpiritQuest; // 0x6C
		::System::UInt32 ActivityModuleID; // 0x70
		::System::UInt32 EntranceID; // 0x74
		::System::UInt32 ID; // 0x78
		::System::UInt32 TrainerQuest; // 0x7C
		::System::UInt32 BadgeUnlockID; // 0x80
