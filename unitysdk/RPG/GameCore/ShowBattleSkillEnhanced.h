...
#define RPG_GAMECORE_SHOWBATTLESKILLENHANCED_METHOD_3_79F21717C46CAB7A_OFFSET UNITYSDK_OFFSET(0x19FFCE60)
#define RPG_GAMECORE_SHOWBATTLESKILLENHANCED_METHOD_3_AA9B7CF92C3EE14D_OFFSET UNITYSDK_OFFSET(0x19FFCDD0)
#define RPG_GAMECORE_SHOWBATTLESKILLENHANCED__CTOR_OFFSET UNITYSDK_OFFSET(0x19FFCE30)
