...
#define RPG_GAMECORE_SHOWBATTLESKILLENHANCED_METHOD_3_79F21717C46CAB7A_OFFSET UNITYSDK_OFFSET(0x193A3400)
#define RPG_GAMECORE_SHOWBATTLESKILLENHANCED_METHOD_3_AA9B7CF92C3EE14D_OFFSET UNITYSDK_OFFSET(0x193A3370)
#define RPG_GAMECORE_SHOWBATTLESKILLENHANCED__CTOR_OFFSET UNITYSDK_OFFSET(0x193A33D0)
