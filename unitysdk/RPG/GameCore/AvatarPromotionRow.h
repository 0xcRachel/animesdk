...
#define RPG_GAMECORE_AVATARPROMOTIONROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x17635550)
#define RPG_GAMECORE_AVATARPROMOTIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17636310)
#define RPG_GAMECORE_AVATARPROMOTIONROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x176387D0)
#define RPG_GAMECORE_AVATARPROMOTIONROW_RESET_OFFSET UNITYSDK_OFFSET(0x17638830)
#define RPG_GAMECORE_AVATARPROMOTIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17638890)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::FixPoint AttackAdd; // 0x18
		...
		::RPG::GameCore::FixPoint HPBase; // 0x48
		...
		::System::UInt32 PlayerLevelRequire; // 0x7C
		::RPG::GameCore::FixPoint RankDefenceBase; // 0x80
		::RPG::GameCore::FixPoint RankSpeedBase; // 0x88
		::RPG::GameCore::FixPoint RankAttackAdd; // 0x90
		::RPG::GameCore::FixPoint RankAttackBase; // 0x98
		::RPG::GameCore::FixPoint HPAdd; // 0xA0
		::RPG::GameCore::FixPoint RankDefenceAdd; // 0xA8
		::RPG::GameCore::FixPoint RankCriticalDamage; // 0xB0
		::RPG::GameCore::FixPoint AttackBase; // 0xB8
		::RPG::GameCore::FixPoint DefenceBase; // 0xC0
		::RPG::GameCore::FixPoint SpeedAdd; // 0xC8
		::RPG::GameCore::FixPoint CriticalChance; // 0xD0
