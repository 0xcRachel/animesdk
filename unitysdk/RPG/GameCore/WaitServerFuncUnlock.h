...
#define RPG_GAMECORE_WAITSERVERFUNCUNLOCK_METHOD_3_866137965C7CDD57_OFFSET UNITYSDK_OFFSET(0x19535D90)
#define RPG_GAMECORE_WAITSERVERFUNCUNLOCK_METHOD_3_F758297F7FC3C867_OFFSET UNITYSDK_OFFSET(0x19535D00)
#define RPG_GAMECORE_WAITSERVERFUNCUNLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x19535D60)
