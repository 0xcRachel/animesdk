...
#define RPG_GAMECORE_PROPINITFARMELEMENT_METHOD_3_E9677AFA6BA8302E_OFFSET UNITYSDK_OFFSET(0x16DAC2B0)
#define RPG_GAMECORE_PROPINITFARMELEMENT_METHOD_3_F5814C40A04A2D6F_OFFSET UNITYSDK_OFFSET(0x16DAC330)
#define RPG_GAMECORE_PROPINITFARMELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x16DAC300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropInitFarmElement_TypeDefinitionIndex = 19743;
