...
#define RPG_GAMECORE_PROPINITFARMELEMENT_METHOD_3_E9677AFA6BA8302E_OFFSET UNITYSDK_OFFSET(0x191C66B0)
#define RPG_GAMECORE_PROPINITFARMELEMENT_METHOD_3_F5814C40A04A2D6F_OFFSET UNITYSDK_OFFSET(0x191C6730)
#define RPG_GAMECORE_PROPINITFARMELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x191C6700)
