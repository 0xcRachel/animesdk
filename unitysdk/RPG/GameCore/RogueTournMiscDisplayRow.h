...
#define RPG_GAMECORE_ROGUETOURNMISCDISPLAYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16ECCCC0)
#define RPG_GAMECORE_ROGUETOURNMISCDISPLAYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16ECD270)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournMiscDisplayRow_TypeDefinitionIndex = 13639;
