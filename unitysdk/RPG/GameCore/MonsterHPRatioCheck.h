...
#define RPG_GAMECORE_MONSTERHPRATIOCHECK_METHOD_3_1C5887BCDD6DB7F1_OFFSET UNITYSDK_OFFSET(0x16CDED40)
#define RPG_GAMECORE_MONSTERHPRATIOCHECK_METHOD_3_6A5A6F4A82F529E2_OFFSET UNITYSDK_OFFSET(0x16CDECC0)
#define RPG_GAMECORE_MONSTERHPRATIOCHECK__CTOR_OFFSET UNITYSDK_OFFSET(0x16CDED10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonsterHPRatioCheck_TypeDefinitionIndex = 20616;
