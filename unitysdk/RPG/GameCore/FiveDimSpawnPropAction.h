...
#define RPG_GAMECORE_FIVEDIMSPAWNPROPACTION_METHOD_3_738FC8A942BE22B1_OFFSET UNITYSDK_OFFSET(0x1A3A5200)
#define RPG_GAMECORE_FIVEDIMSPAWNPROPACTION_METHOD_3_B8DCC95A55C89EF0_OFFSET UNITYSDK_OFFSET(0x1A3A52C0)
#define RPG_GAMECORE_FIVEDIMSPAWNPROPACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3A52A0)
