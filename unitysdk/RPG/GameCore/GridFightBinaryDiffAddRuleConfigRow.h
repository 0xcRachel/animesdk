...
#define RPG_GAMECORE_GRIDFIGHTBINARYDIFFADDRULECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19567CD0)
#define RPG_GAMECORE_GRIDFIGHTBINARYDIFFADDRULECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19567E40)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::UInt32 EnemyDifficultyAddValue; // 0x10
