...
#define RPG_GAMECORE_MODIFIERBINDEFFECTCONFIG_METHOD_2_87D13AC2FFF5576F_OFFSET UNITYSDK_OFFSET(0x16CB48D0)
#define RPG_GAMECORE_MODIFIERBINDEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16CB4A10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifierBindEffectConfig_TypeDefinitionIndex = 14843;
