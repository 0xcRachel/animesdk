...
#define RPG_GAMECORE_ADVBYENTITIESEXIST_METHOD_4_017AB40905B3BEB2_OFFSET UNITYSDK_OFFSET(0x167C3E30)
#define RPG_GAMECORE_ADVBYENTITIESEXIST_METHOD_4_C4ECCD55934F7F79_OFFSET UNITYSDK_OFFSET(0x167C3C90)
#define RPG_GAMECORE_ADVBYENTITIESEXIST__CTOR_OFFSET UNITYSDK_OFFSET(0x167C3D70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByEntitiesExist_TypeDefinitionIndex = 18996;
