...
#define RPG_GAMECORE_CHIMERADUELCHIMERAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x196B44B0)
#define RPG_GAMECORE_CHIMERADUELCHIMERAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x196B49F0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::ChimeraHornsPartType ModelHorn; // 0x30
		::RPG::GameCore::ChimeraTailPartType ModelTail; // 0x34
		::RPG::Client::TextID ChimeraName; // 0x38
		::RPG::GameCore::ChimeraEyeDetailType ModelEye; // 0x48
		::System::Int32 BaseAttack; // 0x4C
		::System::Int32 BaseHp; // 0x50
		::System::UInt32 Price; // 0x54
		::System::UInt32 ChimeraID; // 0x58
		::RPG::GameCore::ChimeraMaterialType ModelBody; // 0x5C
		::RPG::GameCore::ChimeraWingsPartType ModelWing; // 0x60
