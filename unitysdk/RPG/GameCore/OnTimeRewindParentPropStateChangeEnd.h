...
#define RPG_GAMECORE_ONTIMEREWINDPARENTPROPSTATECHANGEEND_METHOD_3_37E4C4BA8EBF3CF8_OFFSET UNITYSDK_OFFSET(0x18EEEB50)
#define RPG_GAMECORE_ONTIMEREWINDPARENTPROPSTATECHANGEEND_METHOD_3_C22EDB407C658AA7_OFFSET UNITYSDK_OFFSET(0x18EEEAD0)
#define RPG_GAMECORE_ONTIMEREWINDPARENTPROPSTATECHANGEEND__CTOR_OFFSET UNITYSDK_OFFSET(0x18EEEB20)
