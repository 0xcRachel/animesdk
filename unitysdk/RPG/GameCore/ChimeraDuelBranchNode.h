...
#define RPG_GAMECORE_CHIMERADUELBRANCHNODE_METHOD_3_7AC7C3E7B4F9F9CB_OFFSET UNITYSDK_OFFSET(0x169886B0)
#define RPG_GAMECORE_CHIMERADUELBRANCHNODE_METHOD_3_AFA98E7A364AA02F_OFFSET UNITYSDK_OFFSET(0x169885D0)
#define RPG_GAMECORE_CHIMERADUELBRANCHNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x16988660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelBranchNode_TypeDefinitionIndex = 14421;
