...
#define RPG_GAMECORE_BYCOMPAREPROPSTATE_METHOD_4_9A7A73FE5CBBC904_OFFSET UNITYSDK_OFFSET(0x17027CD0)
#define RPG_GAMECORE_BYCOMPAREPROPSTATE_METHOD_4_CF9C2590852AA014_OFFSET UNITYSDK_OFFSET(0x17027DA0)
#define RPG_GAMECORE_BYCOMPAREPROPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17027D50)
