...
#define RPG_GAMECORE_BYCOMPAREPROPSTATE_METHOD_4_9A7A73FE5CBBC904_OFFSET UNITYSDK_OFFSET(0x16916B40)
#define RPG_GAMECORE_BYCOMPAREPROPSTATE_METHOD_4_CF9C2590852AA014_OFFSET UNITYSDK_OFFSET(0x16916C10)
#define RPG_GAMECORE_BYCOMPAREPROPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16916BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByComparePropState_TypeDefinitionIndex = 18087;
