...
#define RPG_GAMECORE_PROPRELOADPUZZLE_METHOD_3_0D96D846EE06921F_OFFSET UNITYSDK_OFFSET(0x16DB0980)
#define RPG_GAMECORE_PROPRELOADPUZZLE_METHOD_3_3CF63CB5C734CAAB_OFFSET UNITYSDK_OFFSET(0x16DB0870)
#define RPG_GAMECORE_PROPRELOADPUZZLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16DB0950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropReloadPuzzle_TypeDefinitionIndex = 18142;
