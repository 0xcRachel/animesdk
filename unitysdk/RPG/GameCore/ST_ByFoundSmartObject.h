...
#define RPG_GAMECORE_ST_BYFOUNDSMARTOBJECT_METHOD_4_30846F98C39F0090_OFFSET UNITYSDK_OFFSET(0x16EEFD80)
#define RPG_GAMECORE_ST_BYFOUNDSMARTOBJECT_METHOD_4_3AC28F1AC2D3DCEA_OFFSET UNITYSDK_OFFSET(0x16EEFCB0)
#define RPG_GAMECORE_ST_BYFOUNDSMARTOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x16EEFD30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByFoundSmartObject_TypeDefinitionIndex = 17851;
