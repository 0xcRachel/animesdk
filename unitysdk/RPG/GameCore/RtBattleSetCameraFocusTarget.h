...
#define RPG_GAMECORE_RTBATTLESETCAMERAFOCUSTARGET_METHOD_3_A50D6F4715ACBC4E_OFFSET UNITYSDK_OFFSET(0x19417A90)
#define RPG_GAMECORE_RTBATTLESETCAMERAFOCUSTARGET_METHOD_3_DE2048DA5DBD8F84_OFFSET UNITYSDK_OFFSET(0x194179C0)
#define RPG_GAMECORE_RTBATTLESETCAMERAFOCUSTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x19417A40)
