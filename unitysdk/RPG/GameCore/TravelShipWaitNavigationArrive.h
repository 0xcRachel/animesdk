...
#define RPG_GAMECORE_TRAVELSHIPWAITNAVIGATIONARRIVE_METHOD_3_2B342535E0AE1417_OFFSET UNITYSDK_OFFSET(0x171103A0)
#define RPG_GAMECORE_TRAVELSHIPWAITNAVIGATIONARRIVE_METHOD_3_A688AD229480E996_OFFSET UNITYSDK_OFFSET(0x17110420)
#define RPG_GAMECORE_TRAVELSHIPWAITNAVIGATIONARRIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x171103F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TravelShipWaitNavigationArrive_TypeDefinitionIndex = 18788;
