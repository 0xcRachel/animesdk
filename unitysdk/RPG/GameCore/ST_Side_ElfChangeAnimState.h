...
#define RPG_GAMECORE_ST_SIDE_ELFCHANGEANIMSTATE_METHOD_4_619117BBE6B7F6B8_OFFSET UNITYSDK_OFFSET(0x1769EA50)
#define RPG_GAMECORE_ST_SIDE_ELFCHANGEANIMSTATE_METHOD_4_7F104796C36C2204_OFFSET UNITYSDK_OFFSET(0x176ACD90)
#define RPG_GAMECORE_ST_SIDE_ELFCHANGEANIMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1769EA00)
