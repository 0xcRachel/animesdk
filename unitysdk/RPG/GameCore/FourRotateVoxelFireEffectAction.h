...
#define RPG_GAMECORE_FOURROTATEVOXELFIREEFFECTACTION_METHOD_4_22822F2C65719189_OFFSET UNITYSDK_OFFSET(0x1722FBD0)
#define RPG_GAMECORE_FOURROTATEVOXELFIREEFFECTACTION_METHOD_4_954FCAEAF09ABED5_OFFSET UNITYSDK_OFFSET(0x1722FB60)
#define RPG_GAMECORE_FOURROTATEVOXELFIREEFFECTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1722FBB0)
