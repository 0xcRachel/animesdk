...
#define RPG_GAMECORE_SETULTRASKILLASSETPRELOAD_METHOD_3_5654CD8CB3F1A609_OFFSET UNITYSDK_OFFSET(0x176FA0B0)
#define RPG_GAMECORE_SETULTRASKILLASSETPRELOAD_METHOD_3_EBCDDAE1154636BF_OFFSET UNITYSDK_OFFSET(0x176F9FD0)
#define RPG_GAMECORE_SETULTRASKILLASSETPRELOAD__CTOR_OFFSET UNITYSDK_OFFSET(0x176FA010)
