...
#define RPG_GAMECORE_SETULTRASKILLASSETPRELOAD_METHOD_3_5654CD8CB3F1A609_OFFSET UNITYSDK_OFFSET(0x16F44AE0)
#define RPG_GAMECORE_SETULTRASKILLASSETPRELOAD_METHOD_3_EBCDDAE1154636BF_OFFSET UNITYSDK_OFFSET(0x16F44A00)
#define RPG_GAMECORE_SETULTRASKILLASSETPRELOAD__CTOR_OFFSET UNITYSDK_OFFSET(0x16F44A40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetUltraSkillAssetPreload_TypeDefinitionIndex = 20452;
