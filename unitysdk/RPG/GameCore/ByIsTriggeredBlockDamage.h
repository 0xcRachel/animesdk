...
#define RPG_GAMECORE_BYISTRIGGEREDBLOCKDAMAGE_METHOD_4_AFD752447508E54E_OFFSET UNITYSDK_OFFSET(0x16938020)
#define RPG_GAMECORE_BYISTRIGGEREDBLOCKDAMAGE_METHOD_4_D5C5F42C1060E520_OFFSET UNITYSDK_OFFSET(0x16937F50)
#define RPG_GAMECORE_BYISTRIGGEREDBLOCKDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16937FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsTriggeredBlockDamage_TypeDefinitionIndex = 21396;
