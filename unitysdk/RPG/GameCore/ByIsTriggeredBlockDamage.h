...
#define RPG_GAMECORE_BYISTRIGGEREDBLOCKDAMAGE_METHOD_4_97D510403B1EC822_OFFSET UNITYSDK_OFFSET(0x19DB5A50)
#define RPG_GAMECORE_BYISTRIGGEREDBLOCKDAMAGE_METHOD_4_AFD752447508E54E_OFFSET UNITYSDK_OFFSET(0x19DB5850)
#define RPG_GAMECORE_BYISTRIGGEREDBLOCKDAMAGE_METHOD_4_C098A60C2B503603_OFFSET UNITYSDK_OFFSET(0x19DB59D0)
#define RPG_GAMECORE_BYISTRIGGEREDBLOCKDAMAGE_METHOD_4_D5C5F42C1060E520_OFFSET UNITYSDK_OFFSET(0x19DB5780)
#define RPG_GAMECORE_BYISTRIGGEREDBLOCKDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19DB5800)
