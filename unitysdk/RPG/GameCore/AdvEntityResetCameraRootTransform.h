...
#define RPG_GAMECORE_ADVENTITYRESETCAMERAROOTTRANSFORM_METHOD_3_38A0CBDDD5A6600C_OFFSET UNITYSDK_OFFSET(0x168349A0)
#define RPG_GAMECORE_ADVENTITYRESETCAMERAROOTTRANSFORM_METHOD_3_F55D436948A75D9D_OFFSET UNITYSDK_OFFSET(0x16834920)
#define RPG_GAMECORE_ADVENTITYRESETCAMERAROOTTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x16834970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvEntityResetCameraRootTransform_TypeDefinitionIndex = 18849;
