...
#define RPG_GAMECORE_TRIGGERMODIFIERCUSTOMEVENT_METHOD_3_92BB07320FEDF53F_OFFSET UNITYSDK_OFFSET(0x1911AAF0)
#define RPG_GAMECORE_TRIGGERMODIFIERCUSTOMEVENT_METHOD_3_BB21DF926805CCB7_OFFSET UNITYSDK_OFFSET(0x1911AC10)
#define RPG_GAMECORE_TRIGGERMODIFIERCUSTOMEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1911AB90)
