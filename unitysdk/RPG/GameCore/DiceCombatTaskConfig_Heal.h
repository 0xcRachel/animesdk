...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_HEAL_METHOD_3_52D9612A5B56A95D_OFFSET UNITYSDK_OFFSET(0x195A04D0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_HEAL_METHOD_3_606A11C807EBCF9F_OFFSET UNITYSDK_OFFSET(0x195A5B80)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_HEAL__CTOR_OFFSET UNITYSDK_OFFSET(0x195A0480)
