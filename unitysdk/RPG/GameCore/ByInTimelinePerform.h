...
#define RPG_GAMECORE_BYINTIMELINEPERFORM_METHOD_4_30D96221BE09F8C6_OFFSET UNITYSDK_OFFSET(0x1692ADB0)
#define RPG_GAMECORE_BYINTIMELINEPERFORM_METHOD_4_FE43C45240E2DD98_OFFSET UNITYSDK_OFFSET(0x1692ACD0)
#define RPG_GAMECORE_BYINTIMELINEPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1692AD50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByInTimelinePerform_TypeDefinitionIndex = 20985;
