...
#define RPG_GAMECORE_ADVENTUREFIREPROJECTILE_METHOD_4_64ED24246515B748_OFFSET UNITYSDK_OFFSET(0x19C0A6E0)
#define RPG_GAMECORE_ADVENTUREFIREPROJECTILE_METHOD_4_AC3BA3CCD5835982_OFFSET UNITYSDK_OFFSET(0x19C0A660)
#define RPG_GAMECORE_ADVENTUREFIREPROJECTILE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C0A6B0)
