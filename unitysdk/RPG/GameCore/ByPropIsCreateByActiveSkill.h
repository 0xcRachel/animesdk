...
#define RPG_GAMECORE_BYPROPISCREATEBYACTIVESKILL_METHOD_4_9DF974EAE7378AAD_OFFSET UNITYSDK_OFFSET(0x1704D870)
#define RPG_GAMECORE_BYPROPISCREATEBYACTIVESKILL_METHOD_4_CC32DC2BBFA39D07_OFFSET UNITYSDK_OFFSET(0x1704D940)
#define RPG_GAMECORE_BYPROPISCREATEBYACTIVESKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1704D8F0)
