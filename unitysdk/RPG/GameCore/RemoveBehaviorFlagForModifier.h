...
#define RPG_GAMECORE_REMOVEBEHAVIORFLAGFORMODIFIER_METHOD_3_B0D519095451861E_OFFSET UNITYSDK_OFFSET(0x19026660)
#define RPG_GAMECORE_REMOVEBEHAVIORFLAGFORMODIFIER_METHOD_3_D8203BD38BDA8361_OFFSET UNITYSDK_OFFSET(0x190265E0)
#define RPG_GAMECORE_REMOVEBEHAVIORFLAGFORMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x19026630)
