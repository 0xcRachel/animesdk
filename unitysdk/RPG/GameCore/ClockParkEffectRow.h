...
#define RPG_GAMECORE_CLOCKPARKEFFECTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x194DB5F0)
#define RPG_GAMECORE_CLOCKPARKEFFECTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x194DBA00)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::ClockParkEffectType EffectType; // 0x38
