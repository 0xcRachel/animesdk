...
#define RPG_GAMECORE_VOICEATLASROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19A7FEB0)
#define RPG_GAMECORE_VOICEATLASROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19A80340)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID Voice_M; // 0x20
		::System::UInt32 ReplaceID; // 0x30
		::System::UInt32 AvatarID; // 0x34
		::System::Boolean IsBattleVoice; // 0x38
		::System::UInt32 AudioID; // 0x3C
		::RPG::Client::TextID VoiceTitle; // 0x40
