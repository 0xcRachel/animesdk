...
#define RPG_GAMECORE_TARGETMAPALLOFFTEAMMEMBER_METHOD_3_26421B0B83F1A6CA_OFFSET UNITYSDK_OFFSET(0x1AC5A6E0)
#define RPG_GAMECORE_TARGETMAPALLOFFTEAMMEMBER_METHOD_3_65EC2B46BC1EC63A_OFFSET UNITYSDK_OFFSET(0x1AC5A820)
#define RPG_GAMECORE_TARGETMAPALLOFFTEAMMEMBER_METHOD_3_8BB250EA873004F8_OFFSET UNITYSDK_OFFSET(0x1AC5A7C0)
#define RPG_GAMECORE_TARGETMAPALLOFFTEAMMEMBER_METHOD_3_FE2E24B2B7ADF2BA_OFFSET UNITYSDK_OFFSET(0x1AC5A880)
#define RPG_GAMECORE_TARGETMAPALLOFFTEAMMEMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC5A7A0)
