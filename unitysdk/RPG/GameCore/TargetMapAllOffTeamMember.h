...
#define RPG_GAMECORE_TARGETMAPALLOFFTEAMMEMBER_METHOD_3_26421B0B83F1A6CA_OFFSET UNITYSDK_OFFSET(0x16FE1270)
#define RPG_GAMECORE_TARGETMAPALLOFFTEAMMEMBER_METHOD_3_8BB250EA873004F8_OFFSET UNITYSDK_OFFSET(0x16FE1350)
#define RPG_GAMECORE_TARGETMAPALLOFFTEAMMEMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE1330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapAllOffTeamMember_TypeDefinitionIndex = 21663;
