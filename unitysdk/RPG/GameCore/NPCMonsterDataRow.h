...
#define RPG_GAMECORE_NPCMONSTERDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16CFA640)
#define RPG_GAMECORE_NPCMONSTERDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16CFAE20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NPCMonsterDataRow_TypeDefinitionIndex = 13010;
	...
	public:
		...
		::System::UInt32 PrototypeID; // 0x30
		::System::UInt32 MappingInfoID; // 0x34
		::System::Boolean IsMazeLink; // 0x38
		::RPG::GameCore::MonsterRank Rank; // 0x3C
