...
#define RPG_GAMECORE_NPCMONSTERDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19100360)
#define RPG_GAMECORE_NPCMONSTERDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19100BA0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean IsMazeLink; // 0x48
