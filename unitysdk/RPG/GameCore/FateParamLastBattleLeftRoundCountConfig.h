...
#define RPG_GAMECORE_FATEPARAMLASTBATTLELEFTROUNDCOUNTCONFIG_METHOD_6_0E08964ED7BCFBFD_OFFSET UNITYSDK_OFFSET(0x1A40DCB0)
#define RPG_GAMECORE_FATEPARAMLASTBATTLELEFTROUNDCOUNTCONFIG_METHOD_6_61F6C6D24ACD1AE9_OFFSET UNITYSDK_OFFSET(0x1A40DAF0)
#define RPG_GAMECORE_FATEPARAMLASTBATTLELEFTROUNDCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A40DBF0)
