...
#define RPG_GAMECORE_BATTLEQTEUICONFIG_METHOD_2_B7E1BF105869A688_OFFSET UNITYSDK_OFFSET(0x168E3990)
#define RPG_GAMECORE_BATTLEQTEUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x168E3C40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleQTEUIConfig_TypeDefinitionIndex = 21019;
