...
#define RPG_GAMECORE_VE_RTDISTANCE_METHOD_3_8B44AB0B7FC48229_OFFSET UNITYSDK_OFFSET(0x1951C8C0)
#define RPG_GAMECORE_VE_RTDISTANCE_METHOD_3_A804455029B78B04_OFFSET UNITYSDK_OFFSET(0x1951C880)
#define RPG_GAMECORE_VE_RTDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1951C8B0)
