...
#define RPG_GAMECORE_REMOVECHALLENGEBOSSINFOPANELSTATE_METHOD_3_5A880B76904ED407_OFFSET UNITYSDK_OFFSET(0x16DDE3A0)
#define RPG_GAMECORE_REMOVECHALLENGEBOSSINFOPANELSTATE_METHOD_3_C03E9ABDB833DFC6_OFFSET UNITYSDK_OFFSET(0x16DDE320)
#define RPG_GAMECORE_REMOVECHALLENGEBOSSINFOPANELSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16DDE370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveChallengeBossInfoPanelState_TypeDefinitionIndex = 20884;
