...
#define RPG_GAMECORE_HARDLEVELGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18A63650)
#define RPG_GAMECORE_HARDLEVELGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18A63FE0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::FixPoint StatusResistance; // 0x18
		...
		::RPG::GameCore::FixPoint AttackRatio; // 0x40
		::System::UInt32 HardLevelGroup; // 0x48
