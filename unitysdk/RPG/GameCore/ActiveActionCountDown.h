...
#define RPG_GAMECORE_ACTIVEACTIONCOUNTDOWN_METHOD_3_4655BE6618E5D798_OFFSET UNITYSDK_OFFSET(0x1677DBE0)
#define RPG_GAMECORE_ACTIVEACTIONCOUNTDOWN_METHOD_3_9BA2FDFD5AB4FBF1_OFFSET UNITYSDK_OFFSET(0x1677DC60)
#define RPG_GAMECORE_ACTIVEACTIONCOUNTDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x1677DC30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActiveActionCountDown_TypeDefinitionIndex = 21380;
