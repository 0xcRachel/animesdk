...
#define RPG_GAMECORE_PLANETFESAVATARROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19D48860)
#define RPG_GAMECORE_PLANETFESAVATARROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19D48E40)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* MidIcon; // 0x30
		::System::String* AnimConfig; // 0x38
