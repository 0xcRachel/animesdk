...
#define RPG_GAMECORE_BASECHIMERADUELSAVEENTITYSELECTIONCONFIG_METHOD_2_C486126AFC9A2677_OFFSET UNITYSDK_OFFSET(0x176569C0)
#define RPG_GAMECORE_BASECHIMERADUELSAVEENTITYSELECTIONCONFIG_METHOD_2_F76E5798A1C5AD31_OFFSET UNITYSDK_OFFSET(0x17656B50)
#define RPG_GAMECORE_BASECHIMERADUELSAVEENTITYSELECTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17656BB0)
