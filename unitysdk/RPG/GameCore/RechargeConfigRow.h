...
#define RPG_GAMECORE_RECHARGECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16DCBEE0)
#define RPG_GAMECORE_RECHARGECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16DCC310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RechargeConfigRow_TypeDefinitionIndex = 13263;
	...
	public:
		...
		::RPG::Client::TextID FirstRechangeConfirm; // 0x28
		::System::UInt32 FirstCharge; // 0x38
		::System::UInt32 NormalCharge; // 0x3C
		::RPG::Client::TextID NormalRechargeConfirm; // 0x40
		::RPG::Client::TextID GiftName; // 0x50
		::System::UInt32 GiftType; // 0x60
		::System::UInt32 ListOrder; // 0x64
