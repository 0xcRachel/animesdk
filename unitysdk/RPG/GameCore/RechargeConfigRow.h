...
#define RPG_GAMECORE_RECHARGECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19AAEF10)
#define RPG_GAMECORE_RECHARGECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19AAF340)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 NormalCharge; // 0x4C
		::System::UInt32 ListOrder; // 0x50
		::System::UInt32 GiftType; // 0x54
