...
#define RPG_GAMECORE_MARBLEBYCOMPAREVALUE_METHOD_4_7377D7A3666B3500_OFFSET UNITYSDK_OFFSET(0x19C32D50)
#define RPG_GAMECORE_MARBLEBYCOMPAREVALUE_METHOD_4_F3BFE4753C700857_OFFSET UNITYSDK_OFFSET(0x19C32C70)
#define RPG_GAMECORE_MARBLEBYCOMPAREVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C32D00)
