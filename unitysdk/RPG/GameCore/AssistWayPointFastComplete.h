...
#define RPG_GAMECORE_ASSISTWAYPOINTFASTCOMPLETE_METHOD_2_EA1AC2098441EF1B_OFFSET UNITYSDK_OFFSET(0x16F9D370)
#define RPG_GAMECORE_ASSISTWAYPOINTFASTCOMPLETE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F9D560)
