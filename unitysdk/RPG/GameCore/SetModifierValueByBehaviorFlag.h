...
#define RPG_GAMECORE_SETMODIFIERVALUEBYBEHAVIORFLAG_METHOD_3_81B0391FEC875005_OFFSET UNITYSDK_OFFSET(0x16F359C0)
#define RPG_GAMECORE_SETMODIFIERVALUEBYBEHAVIORFLAG_METHOD_3_909069C9F4498428_OFFSET UNITYSDK_OFFSET(0x16F35AE0)
#define RPG_GAMECORE_SETMODIFIERVALUEBYBEHAVIORFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F35A60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetModifierValueByBehaviorFlag_TypeDefinitionIndex = 20745;
