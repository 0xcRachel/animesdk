...
#define RPG_GAMECORE_TARGETFETCHTURNOWNERENTITY_METHOD_4_0BE8677640A44229_OFFSET UNITYSDK_OFFSET(0x16FDFF40)
#define RPG_GAMECORE_TARGETFETCHTURNOWNERENTITY_METHOD_4_F4D2547EB0CDB087_OFFSET UNITYSDK_OFFSET(0x16FDFE30)
#define RPG_GAMECORE_TARGETFETCHTURNOWNERENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x16FDFEF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchTurnOwnerEntity_TypeDefinitionIndex = 21711;
