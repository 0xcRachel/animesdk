...
#define RPG_GAMECORE_TARGETFETCHTURNOWNERENTITY_METHOD_4_0BE8677640A44229_OFFSET UNITYSDK_OFFSET(0x199DDD10)
#define RPG_GAMECORE_TARGETFETCHTURNOWNERENTITY_METHOD_4_F4D2547EB0CDB087_OFFSET UNITYSDK_OFFSET(0x199E3230)
#define RPG_GAMECORE_TARGETFETCHTURNOWNERENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x199DDCC0)
