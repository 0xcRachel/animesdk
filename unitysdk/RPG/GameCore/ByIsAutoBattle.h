...
#define RPG_GAMECORE_BYISAUTOBATTLE_METHOD_4_8FB50BF0E4150ED7_OFFSET UNITYSDK_OFFSET(0x1703DB40)
#define RPG_GAMECORE_BYISAUTOBATTLE_METHOD_4_EA61B0446AF79499_OFFSET UNITYSDK_OFFSET(0x1703DC20)
#define RPG_GAMECORE_BYISAUTOBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1703DBC0)
