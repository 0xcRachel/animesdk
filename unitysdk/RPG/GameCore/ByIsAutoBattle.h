...
#define RPG_GAMECORE_BYISAUTOBATTLE_METHOD_4_8E725B961A09D94E_OFFSET UNITYSDK_OFFSET(0x1692C770)
#define RPG_GAMECORE_BYISAUTOBATTLE_METHOD_4_EF98E74910E89850_OFFSET UNITYSDK_OFFSET(0x1692C850)
#define RPG_GAMECORE_BYISAUTOBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1692C7F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsAutoBattle_TypeDefinitionIndex = 20205;
