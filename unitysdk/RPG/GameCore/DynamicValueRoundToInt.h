...
#define RPG_GAMECORE_DYNAMICVALUEROUNDTOINT_METHOD_3_3005453B53689E1E_OFFSET UNITYSDK_OFFSET(0x16A59640)
#define RPG_GAMECORE_DYNAMICVALUEROUNDTOINT_METHOD_3_F8109180F15459EF_OFFSET UNITYSDK_OFFSET(0x16A595C0)
#define RPG_GAMECORE_DYNAMICVALUEROUNDTOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x16A59610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DynamicValueRoundToInt_TypeDefinitionIndex = 20611;
