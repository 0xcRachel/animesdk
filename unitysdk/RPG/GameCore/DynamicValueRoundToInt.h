...
#define RPG_GAMECORE_DYNAMICVALUEROUNDTOINT_METHOD_3_3005453B53689E1E_OFFSET UNITYSDK_OFFSET(0x1719C1E0)
#define RPG_GAMECORE_DYNAMICVALUEROUNDTOINT_METHOD_3_F8109180F15459EF_OFFSET UNITYSDK_OFFSET(0x1719C160)
#define RPG_GAMECORE_DYNAMICVALUEROUNDTOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1719C1B0)
