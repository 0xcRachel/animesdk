...
#define RPG_GAMECORE_WAITFIXEDDELTASECOND_METHOD_3_255B3173F77312BA_OFFSET UNITYSDK_OFFSET(0x171513C0)
#define RPG_GAMECORE_WAITFIXEDDELTASECOND_METHOD_3_9A6E68BCE3C7D18E_OFFSET UNITYSDK_OFFSET(0x171512B0)
#define RPG_GAMECORE_WAITFIXEDDELTASECOND__CTOR_OFFSET UNITYSDK_OFFSET(0x17151390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitFixedDeltaSecond_TypeDefinitionIndex = 21499;
