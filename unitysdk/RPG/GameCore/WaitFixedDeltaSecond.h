...
#define RPG_GAMECORE_WAITFIXEDDELTASECOND_METHOD_3_255B3173F77312BA_OFFSET UNITYSDK_OFFSET(0x1952A8E0)
#define RPG_GAMECORE_WAITFIXEDDELTASECOND_METHOD_3_9A6E68BCE3C7D18E_OFFSET UNITYSDK_OFFSET(0x1952A7D0)
#define RPG_GAMECORE_WAITFIXEDDELTASECOND__CTOR_OFFSET UNITYSDK_OFFSET(0x1952A8B0)
