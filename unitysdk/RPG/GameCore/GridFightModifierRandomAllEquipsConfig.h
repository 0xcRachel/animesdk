...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERRANDOMALLEQUIPSCONFIG_METHOD_3_03CB29F0F8B3575A_OFFSET UNITYSDK_OFFSET(0x1727FE40)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERRANDOMALLEQUIPSCONFIG_METHOD_3_41074B0A1A749513_OFFSET UNITYSDK_OFFSET(0x1727CBE0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERRANDOMALLEQUIPSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1727CB90)
