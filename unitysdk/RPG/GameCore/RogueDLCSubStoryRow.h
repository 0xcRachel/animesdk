...
#define RPG_GAMECORE_ROGUEDLCSUBSTORYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16E79080)
#define RPG_GAMECORE_ROGUEDLCSUBSTORYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16E79310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDLCSubStoryRow_TypeDefinitionIndex = 13453;
