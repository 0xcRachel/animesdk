...
#define RPG_GAMECORE_MODIFIERBEHAVIORFLAGEVENTCONFIG_METHOD_2_5A1C4E27B918630F_OFFSET UNITYSDK_OFFSET(0x190774A0)
#define RPG_GAMECORE_MODIFIERBEHAVIORFLAGEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x190775D0)
