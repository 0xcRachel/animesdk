...
#define RPG_GAMECORE_STARTBATTLEQTE_METHOD_3_36F0EBD9EEA947F5_OFFSET UNITYSDK_OFFSET(0x186156E0)
#define RPG_GAMECORE_STARTBATTLEQTE_METHOD_3_4967394980B0C4C4_OFFSET UNITYSDK_OFFSET(0x18615760)
#define RPG_GAMECORE_STARTBATTLEQTE__CTOR_OFFSET UNITYSDK_OFFSET(0x18615730)
