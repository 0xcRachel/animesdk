...
#define RPG_GAMECORE_ST_BYHASTARGET_METHOD_4_796052435CBDF007_OFFSET UNITYSDK_OFFSET(0x176A81C0)
#define RPG_GAMECORE_ST_BYHASTARGET_METHOD_4_8709E3D1FEDC160D_OFFSET UNITYSDK_OFFSET(0x176A8290)
#define RPG_GAMECORE_ST_BYHASTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x176A8240)
