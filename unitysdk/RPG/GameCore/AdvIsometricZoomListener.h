...
#define RPG_GAMECORE_ADVISOMETRICZOOMLISTENER_METHOD_3_339114C33656AB14_OFFSET UNITYSDK_OFFSET(0x16839350)
#define RPG_GAMECORE_ADVISOMETRICZOOMLISTENER_METHOD_3_6153D53656EDEB84_OFFSET UNITYSDK_OFFSET(0x168392D0)
#define RPG_GAMECORE_ADVISOMETRICZOOMLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x16839320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvIsometricZoomListener_TypeDefinitionIndex = 19863;
