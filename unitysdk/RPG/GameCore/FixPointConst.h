...
#define RPG_GAMECORE_FIXPOINTCONST_METHOD_2_06FF525A02689558_OFFSET UNITYSDK_OFFSET(0x191F8C60)
#define RPG_GAMECORE_FIXPOINTCONST__CTOR_OFFSET UNITYSDK_OFFSET(0x191F8DA0)
