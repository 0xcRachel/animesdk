...
#define RPG_GAMECORE_CHARACTERFOLLOWANIMSTATE_METHOD_3_2149400B6E9319C1_OFFSET UNITYSDK_OFFSET(0x1696F320)
#define RPG_GAMECORE_CHARACTERFOLLOWANIMSTATE_METHOD_3_6E86EF8079227C5A_OFFSET UNITYSDK_OFFSET(0x1696F3B0)
#define RPG_GAMECORE_CHARACTERFOLLOWANIMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1696F380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterFollowAnimState_TypeDefinitionIndex = 20080;
