...
#define RPG_GAMECORE_CHIMERADUELEFFECTCONFIGCONTAINER_METHOD_2_EA0ED511FABCB32A_OFFSET UNITYSDK_OFFSET(0x1698C640)
#define RPG_GAMECORE_CHIMERADUELEFFECTCONFIGCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1698C740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEffectConfigContainer_TypeDefinitionIndex = 14452;
