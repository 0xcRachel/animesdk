...
#define RPG_GAMECORE_SETLOCALPLAYERDITHERALPHA_METHOD_3_2559A1CB8765FAE0_OFFSET UNITYSDK_OFFSET(0x16F32C20)
#define RPG_GAMECORE_SETLOCALPLAYERDITHERALPHA_METHOD_3_86961E754085BCD6_OFFSET UNITYSDK_OFFSET(0x16F32BA0)
#define RPG_GAMECORE_SETLOCALPLAYERDITHERALPHA__CTOR_OFFSET UNITYSDK_OFFSET(0x16F32BF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetLocalPlayerDitherAlpha_TypeDefinitionIndex = 18295;
