...
#define RPG_GAMECORE_FORCEKILL_METHOD_3_65C4CA872D920D08_OFFSET UNITYSDK_OFFSET(0x16ADF310)
#define RPG_GAMECORE_FORCEKILL_METHOD_3_91F7456C7AD92702_OFFSET UNITYSDK_OFFSET(0x16ADF3B0)
#define RPG_GAMECORE_FORCEKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x16ADF370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ForceKill_TypeDefinitionIndex = 20315;
