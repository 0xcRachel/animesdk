...
#define RPG_GAMECORE_ITEMCOMEFROMLIMITROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18896A80)
#define RPG_GAMECORE_ITEMCOMEFROMLIMITROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18897760)
