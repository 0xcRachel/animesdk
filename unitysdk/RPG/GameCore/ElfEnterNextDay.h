...
#define RPG_GAMECORE_ELFENTERNEXTDAY_METHOD_3_88DA98DBFB01D335_OFFSET UNITYSDK_OFFSET(0x171A2430)
#define RPG_GAMECORE_ELFENTERNEXTDAY_METHOD_3_9DFEFBBA653AB8A1_OFFSET UNITYSDK_OFFSET(0x171A2320)
#define RPG_GAMECORE_ELFENTERNEXTDAY__CTOR_OFFSET UNITYSDK_OFFSET(0x171A2400)
