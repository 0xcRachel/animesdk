...
#define RPG_GAMECORE_ELFENTERNEXTDAY_METHOD_3_88DA98DBFB01D335_OFFSET UNITYSDK_OFFSET(0x16A5FC40)
#define RPG_GAMECORE_ELFENTERNEXTDAY_METHOD_3_9DFEFBBA653AB8A1_OFFSET UNITYSDK_OFFSET(0x16A5FB30)
#define RPG_GAMECORE_ELFENTERNEXTDAY__CTOR_OFFSET UNITYSDK_OFFSET(0x16A5FC10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfEnterNextDay_TypeDefinitionIndex = 19374;
