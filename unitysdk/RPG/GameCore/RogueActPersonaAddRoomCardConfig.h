...
#define RPG_GAMECORE_ROGUEACTPERSONAADDROOMCARDCONFIG_METHOD_6_BB2BD05D9EFFB57F_OFFSET UNITYSDK_OFFSET(0x1A9A6E00)
#define RPG_GAMECORE_ROGUEACTPERSONAADDROOMCARDCONFIG_METHOD_6_C55A500CD877A6AA_OFFSET UNITYSDK_OFFSET(0x1A9A7020)
#define RPG_GAMECORE_ROGUEACTPERSONAADDROOMCARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9A6F40)
