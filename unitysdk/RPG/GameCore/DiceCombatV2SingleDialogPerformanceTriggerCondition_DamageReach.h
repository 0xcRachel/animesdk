...
#define RPG_GAMECORE_DICECOMBATV2SINGLEDIALOGPERFORMANCETRIGGERCONDITION_DAMAGEREACH_METHOD_3_589D0B89518192D4_OFFSET UNITYSDK_OFFSET(0x1A0A1150)
#define RPG_GAMECORE_DICECOMBATV2SINGLEDIALOGPERFORMANCETRIGGERCONDITION_DAMAGEREACH_METHOD_3_C5A8B46F2D4CBC88_OFFSET UNITYSDK_OFFSET(0x1A0A0E00)
#define RPG_GAMECORE_DICECOMBATV2SINGLEDIALOGPERFORMANCETRIGGERCONDITION_DAMAGEREACH__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0A0DF0)
