...
#define RPG_GAMECORE_WAITUIANIM_METHOD_3_63AE727AE2E7D2F5_OFFSET UNITYSDK_OFFSET(0x1715FB00)
#define RPG_GAMECORE_WAITUIANIM_METHOD_3_9BB17C72C949B374_OFFSET UNITYSDK_OFFSET(0x1715FA70)
#define RPG_GAMECORE_WAITUIANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x1715FAD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitUIAnim_TypeDefinitionIndex = 21832;
