...
#define RPG_GAMECORE_WAITUIANIM_METHOD_3_63AE727AE2E7D2F5_OFFSET UNITYSDK_OFFSET(0x1791C020)
#define RPG_GAMECORE_WAITUIANIM_METHOD_3_9BB17C72C949B374_OFFSET UNITYSDK_OFFSET(0x1791BF90)
#define RPG_GAMECORE_WAITUIANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x1791BFF0)
