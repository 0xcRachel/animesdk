...
#define RPG_GAMECORE_REMOVEBPFEATURE_METHOD_3_64E9329FA7DA5E9B_OFFSET UNITYSDK_OFFSET(0x16DDE190)
#define RPG_GAMECORE_REMOVEBPFEATURE_METHOD_3_F5363556402178F2_OFFSET UNITYSDK_OFFSET(0x16DDE210)
#define RPG_GAMECORE_REMOVEBPFEATURE__CTOR_OFFSET UNITYSDK_OFFSET(0x16DDE1E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveBpFeature_TypeDefinitionIndex = 20890;
