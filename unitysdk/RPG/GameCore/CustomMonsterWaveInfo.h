...
#define RPG_GAMECORE_CUSTOMMONSTERWAVEINFO_METHOD_3_38C4923D84540706_OFFSET UNITYSDK_OFFSET(0x18FB3BE0)
#define RPG_GAMECORE_CUSTOMMONSTERWAVEINFO_METHOD_3_F60A0C1D9490FE0D_OFFSET UNITYSDK_OFFSET(0x18FB3B60)
#define RPG_GAMECORE_CUSTOMMONSTERWAVEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18FB3BB0)
