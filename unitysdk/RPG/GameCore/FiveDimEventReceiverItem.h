...
#define RPG_GAMECORE_FIVEDIMEVENTRECEIVERITEM_METHOD_2_604FBA5F0637FD12_OFFSET UNITYSDK_OFFSET(0x16ABC420)
#define RPG_GAMECORE_FIVEDIMEVENTRECEIVERITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x16ABC580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimEventReceiverItem_TypeDefinitionIndex = 16724;
