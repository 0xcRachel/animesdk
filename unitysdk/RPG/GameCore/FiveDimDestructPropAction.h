...
#define RPG_GAMECORE_FIVEDIMDESTRUCTPROPACTION_METHOD_3_B1678C0D06541207_OFFSET UNITYSDK_OFFSET(0x18D2AB50)
#define RPG_GAMECORE_FIVEDIMDESTRUCTPROPACTION_METHOD_3_CE3258685E5B5BCA_OFFSET UNITYSDK_OFFSET(0x18D336C0)
#define RPG_GAMECORE_FIVEDIMDESTRUCTPROPACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18D2AB30)
