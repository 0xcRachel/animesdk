...
#define RPG_GAMECORE_FIVEDIMDESTRUCTPROPACTION_METHOD_3_B1678C0D06541207_OFFSET UNITYSDK_OFFSET(0x171FB430)
#define RPG_GAMECORE_FIVEDIMDESTRUCTPROPACTION_METHOD_3_CE3258685E5B5BCA_OFFSET UNITYSDK_OFFSET(0x172033D0)
#define RPG_GAMECORE_FIVEDIMDESTRUCTPROPACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x171FB410)
