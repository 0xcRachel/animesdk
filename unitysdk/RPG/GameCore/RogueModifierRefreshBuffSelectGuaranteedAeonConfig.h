...
#define RPG_GAMECORE_ROGUEMODIFIERREFRESHBUFFSELECTGUARANTEEDAEONCONFIG_METHOD_3_6B87E95E17621B96_OFFSET UNITYSDK_OFFSET(0x1764C1F0)
#define RPG_GAMECORE_ROGUEMODIFIERREFRESHBUFFSELECTGUARANTEEDAEONCONFIG_METHOD_3_85C7463ED3870ACF_OFFSET UNITYSDK_OFFSET(0x1764C2C0)
#define RPG_GAMECORE_ROGUEMODIFIERREFRESHBUFFSELECTGUARANTEEDAEONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1764C270)
