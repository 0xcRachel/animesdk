...
#define RPG_GAMECORE_FORCEGLESDEVICES_METHOD_2_725E1EB405474EE6_OFFSET UNITYSDK_OFFSET(0x16ADF190)
#define RPG_GAMECORE_FORCEGLESDEVICES__CTOR_OFFSET UNITYSDK_OFFSET(0x16ADF300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ForceGlesDevices_TypeDefinitionIndex = 16394;
