...
#define RPG_GAMECORE_WAITDYNAMICSKILLBUTTONINPUT_METHOD_3_47676393FB122213_OFFSET UNITYSDK_OFFSET(0x1714FC20)
#define RPG_GAMECORE_WAITDYNAMICSKILLBUTTONINPUT_METHOD_3_4F2AC23CF543E2BB_OFFSET UNITYSDK_OFFSET(0x1714FB00)
#define RPG_GAMECORE_WAITDYNAMICSKILLBUTTONINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1714FBA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitDynamicSkillButtonInput_TypeDefinitionIndex = 20498;
