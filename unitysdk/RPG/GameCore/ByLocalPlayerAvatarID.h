...
#define RPG_GAMECORE_BYLOCALPLAYERAVATARID_METHOD_4_D4D462E98413987F_OFFSET UNITYSDK_OFFSET(0x16938DB0)
#define RPG_GAMECORE_BYLOCALPLAYERAVATARID_METHOD_4_DBD854D42A0F45A1_OFFSET UNITYSDK_OFFSET(0x16938CE0)
#define RPG_GAMECORE_BYLOCALPLAYERAVATARID__CTOR_OFFSET UNITYSDK_OFFSET(0x16938D60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByLocalPlayerAvatarID_TypeDefinitionIndex = 18376;
