...
#define RPG_GAMECORE_ROGUEMAPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B330CC0)
#define RPG_GAMECORE_ROGUEMAPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3319E0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Single MonsterWarningRatio; // 0x24
