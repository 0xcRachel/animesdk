...
#define RPG_GAMECORE_FORCEMAKECHARACTERACTIONABLE_METHOD_3_6166C3265151D626_OFFSET UNITYSDK_OFFSET(0x16ADF7A0)
#define RPG_GAMECORE_FORCEMAKECHARACTERACTIONABLE_METHOD_3_C4F7591E8F1659F0_OFFSET UNITYSDK_OFFSET(0x16ADF820)
#define RPG_GAMECORE_FORCEMAKECHARACTERACTIONABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16ADF7F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ForceMakeCharacterActionable_TypeDefinitionIndex = 20966;
