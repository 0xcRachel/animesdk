...
#define RPG_GAMECORE_IDLELIVEMESSAGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18A8BF90)
#define RPG_GAMECORE_IDLELIVEMESSAGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18A8C180)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::UInt32 StartContentID; // 0x10
