...
#define RPG_GAMECORE_FIVEDIMCREATEPHANTOMPLAYERACTION_METHOD_3_3B5368739D0C4483_OFFSET UNITYSDK_OFFSET(0x16AB7F70)
#define RPG_GAMECORE_FIVEDIMCREATEPHANTOMPLAYERACTION_METHOD_3_A3E99A16AB256A74_OFFSET UNITYSDK_OFFSET(0x16AB7FE0)
#define RPG_GAMECORE_FIVEDIMCREATEPHANTOMPLAYERACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16AB7FC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimCreatePhantomPlayerAction_TypeDefinitionIndex = 16754;
