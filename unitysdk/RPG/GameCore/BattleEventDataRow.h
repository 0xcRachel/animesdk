...
#define RPG_GAMECORE_BATTLEEVENTDATAROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x168D6FA0)
#define RPG_GAMECORE_BATTLEEVENTDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x168D7250)
#define RPG_GAMECORE_BATTLEEVENTDATAROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x168D6F20)
#define RPG_GAMECORE_BATTLEEVENTDATAROW_RESET_OFFSET UNITYSDK_OFFSET(0x168D6F80)
#define RPG_GAMECORE_BATTLEEVENTDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x168D7530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleEventDataRow_TypeDefinitionIndex = 11667;

	class BattleEventDataRow : public ::System::Object
	{
	public:
		::System::String* BEActionBarPrefab; // 0x10
