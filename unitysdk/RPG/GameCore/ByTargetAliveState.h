...
#define RPG_GAMECORE_BYTARGETALIVESTATE_METHOD_4_39029E29FC2F1230_OFFSET UNITYSDK_OFFSET(0x1693E310)
#define RPG_GAMECORE_BYTARGETALIVESTATE_METHOD_4_9D2BB8B676902328_OFFSET UNITYSDK_OFFSET(0x1693E3E0)
#define RPG_GAMECORE_BYTARGETALIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1693E390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByTargetAliveState_TypeDefinitionIndex = 21114;
