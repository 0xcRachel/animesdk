...
#define RPG_GAMECORE_TAROTBOOKCONDITIONPARAM_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16FF43D0)
#define RPG_GAMECORE_TAROTBOOKCONDITIONPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x16FF44E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TarotBookConditionParam_TypeDefinitionIndex = 13859;
