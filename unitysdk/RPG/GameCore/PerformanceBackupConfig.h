...
#define RPG_GAMECORE_PERFORMANCEBACKUPCONFIG_METHOD_2_774E6EC19B37663B_OFFSET UNITYSDK_OFFSET(0x16D1E6C0)
#define RPG_GAMECORE_PERFORMANCEBACKUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16D1E900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceBackupConfig_TypeDefinitionIndex = 17044;
