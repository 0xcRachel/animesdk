...
#define RPG_GAMECORE_CREATETEAMFORMATIONSNAPSHOT_METHOD_3_59C5688F42F30A5E_OFFSET UNITYSDK_OFFSET(0x169D7940)
#define RPG_GAMECORE_CREATETEAMFORMATIONSNAPSHOT_METHOD_3_89BDFFDC46474BD4_OFFSET UNITYSDK_OFFSET(0x169D78A0)
#define RPG_GAMECORE_CREATETEAMFORMATIONSNAPSHOT__CTOR_OFFSET UNITYSDK_OFFSET(0x169D7900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateTeamFormationSnapshot_TypeDefinitionIndex = 20129;
