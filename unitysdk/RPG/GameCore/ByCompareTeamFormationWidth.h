...
#define RPG_GAMECORE_BYCOMPARETEAMFORMATIONWIDTH_METHOD_4_B15F8CD3B4DA7016_OFFSET UNITYSDK_OFFSET(0x1702FBD0)
#define RPG_GAMECORE_BYCOMPARETEAMFORMATIONWIDTH_METHOD_4_CA1BA682114DDE90_OFFSET UNITYSDK_OFFSET(0x1702FCA0)
#define RPG_GAMECORE_BYCOMPARETEAMFORMATIONWIDTH__CTOR_OFFSET UNITYSDK_OFFSET(0x1702FC50)
