...
#define RPG_GAMECORE_ADDPAMMENUITEM_METHOD_3_B4910DBB7C0BA808_OFFSET UNITYSDK_OFFSET(0x19550710)
#define RPG_GAMECORE_ADDPAMMENUITEM_METHOD_3_D2D9751BEBDA023C_OFFSET UNITYSDK_OFFSET(0x19550600)
#define RPG_GAMECORE_ADDPAMMENUITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x195506E0)
