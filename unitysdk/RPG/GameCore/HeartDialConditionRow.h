...
#define RPG_GAMECORE_HEARTDIALCONDITIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x172ABD80)
#define RPG_GAMECORE_HEARTDIALCONDITIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x172ABF70)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::RPG::GameCore::HeartDialFinishType FinishType; // 0x10
		::System::UInt32 ParamUint1; // 0x14
		::System::UInt32 ParamUint3; // 0x18
