...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::AvatarSkillTreePointTriggerKey>**)Il2CppClass::FromTypeDefinitionIndex(BattleExtraSkillTreeAdditionPair___O_TypeDefinitionIndex)->GetStaticField(0x1DE30);
		}
	};
}
