...
#define RPG_GAMECORE_GRIDFIGHTDIVISIONSTAGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B1F7C0)
#define RPG_GAMECORE_GRIDFIGHTDIVISIONSTAGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B202A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightDivisionStageRow_TypeDefinitionIndex = 12373;

	class GridFightDivisionStageRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::String*>* UniqueEnvironmentDescList; // 0x10
		...
		::System::UInt32 OCScoreRule; // 0x3C
		::System::UInt32 WeeklyScoreModify; // 0x40
		::System::UInt32 EnemyDifficultyLevel; // 0x44
		...
		::System::UInt32 ExpModify; // 0x68
		::System::UInt32 SeasonID; // 0x6C
		::RPG::GameCore::FixPoint LevelBaseAttackMultiRatio; // 0x70
		::System::UInt32 DivisionID; // 0x78
		::System::UInt32 EnemyHardLevel; // 0x7C
