...
#define RPG_GAMECORE_GRIDFIGHTDIVISIONSTAGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1956C0F0)
#define RPG_GAMECORE_GRIDFIGHTDIVISIONSTAGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1956CBD0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 OCScoreRule; // 0x48
		::System::UInt32 ExpModify; // 0x4C
		::System::UInt32 DivisionID; // 0x50
		::System::UInt32 EnemyHardLevel; // 0x54
		::System::UInt32 EnemyDifficultyLevel; // 0x58
		::System::UInt32 SeasonID; // 0x5C
		::RPG::Client::TextID EnvironmentDesc; // 0x60
		::System::UInt32 BinaryNodeDiffAddRule; // 0x70
		::System::UInt32 ScoreRule; // 0x74
