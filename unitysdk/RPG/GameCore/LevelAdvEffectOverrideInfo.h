...
#define RPG_GAMECORE_LEVELADVEFFECTOVERRIDEINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B9E3E0)
#define RPG_GAMECORE_LEVELADVEFFECTOVERRIDEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16B9E960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelAdvEffectOverrideInfo_TypeDefinitionIndex = 15545;
