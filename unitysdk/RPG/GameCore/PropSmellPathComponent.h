...
#define RPG_GAMECORE_PROPSMELLPATHCOMPONENT_METHOD_3_0E7E4212B9409D4C_OFFSET UNITYSDK_OFFSET(0x16DB6150)
#define RPG_GAMECORE_PROPSMELLPATHCOMPONENT_METHOD_3_402056D799F58458_OFFSET UNITYSDK_OFFSET(0x16DB60B0)
#define RPG_GAMECORE_PROPSMELLPATHCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x16DB6120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropSmellPathComponent_TypeDefinitionIndex = 15868;
	...
	public:
		...
		static ::System::Void Method_3_402056D799F58458(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::PropSmellPathComponent*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::PropSmellPathComponent*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_PROPSMELLPATHCOMPONENT_METHOD_3_402056D799F58458_OFFSET))(a1, a2);
		}
