...
#define RPG_GAMECORE_BYISBODYPARTCLIENTONLY_METHOD_5_6FCCA23DB96CDE5E_OFFSET UNITYSDK_OFFSET(0x1692D290)
#define RPG_GAMECORE_BYISBODYPARTCLIENTONLY_METHOD_5_DF3C78F986992AF0_OFFSET UNITYSDK_OFFSET(0x1692D410)
#define RPG_GAMECORE_BYISBODYPARTCLIENTONLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1692D240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsBodyPartClientOnly_TypeDefinitionIndex = 20993;
