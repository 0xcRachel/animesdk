...
#define RPG_GAMECORE_BYISBODYPARTCLIENTONLY_METHOD_5_6FCCA23DB96CDE5E_OFFSET UNITYSDK_OFFSET(0x19AE53C0)
#define RPG_GAMECORE_BYISBODYPARTCLIENTONLY_METHOD_5_DF3C78F986992AF0_OFFSET UNITYSDK_OFFSET(0x19AE5540)
#define RPG_GAMECORE_BYISBODYPARTCLIENTONLY__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE5370)
