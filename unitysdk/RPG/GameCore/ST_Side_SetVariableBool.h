...
#define RPG_GAMECORE_ST_SIDE_SETVARIABLEBOOL_METHOD_4_B56FFABBD669899F_OFFSET UNITYSDK_OFFSET(0x16EEC5B0)
#define RPG_GAMECORE_ST_SIDE_SETVARIABLEBOOL_METHOD_4_FAC58DBEB569CC1E_OFFSET UNITYSDK_OFFSET(0x16EF8FA0)
#define RPG_GAMECORE_ST_SIDE_SETVARIABLEBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x16EEC560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_SetVariableBool_TypeDefinitionIndex = 17873;
