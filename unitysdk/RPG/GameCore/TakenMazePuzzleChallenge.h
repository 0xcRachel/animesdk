...
#define RPG_GAMECORE_TAKENMAZEPUZZLECHALLENGE_METHOD_3_15D1EA72CAAA9698_OFFSET UNITYSDK_OFFSET(0x16FC7B90)
#define RPG_GAMECORE_TAKENMAZEPUZZLECHALLENGE_METHOD_3_FF7655CB66D322A3_OFFSET UNITYSDK_OFFSET(0x16FC7A50)
#define RPG_GAMECORE_TAKENMAZEPUZZLECHALLENGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FC7B00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TakenMazePuzzleChallenge_TypeDefinitionIndex = 19657;
