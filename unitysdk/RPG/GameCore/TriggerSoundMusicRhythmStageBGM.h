...
#define RPG_GAMECORE_TRIGGERSOUNDMUSICRHYTHMSTAGEBGM_METHOD_4_0C9C628A192E0188_OFFSET UNITYSDK_OFFSET(0x1911F7D0)
#define RPG_GAMECORE_TRIGGERSOUNDMUSICRHYTHMSTAGEBGM_METHOD_4_AF0C7BC5A54ACBA4_OFFSET UNITYSDK_OFFSET(0x1911EFA0)
#define RPG_GAMECORE_TRIGGERSOUNDMUSICRHYTHMSTAGEBGM__CTOR_OFFSET UNITYSDK_OFFSET(0x1911EF70)
