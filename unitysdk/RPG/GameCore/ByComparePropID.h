...
#define RPG_GAMECORE_BYCOMPAREPROPID_METHOD_4_AD4111DD0FB5AADC_OFFSET UNITYSDK_OFFSET(0x17027800)
#define RPG_GAMECORE_BYCOMPAREPROPID_METHOD_4_ADBB29BD68DC9778_OFFSET UNITYSDK_OFFSET(0x17027730)
#define RPG_GAMECORE_BYCOMPAREPROPID__CTOR_OFFSET UNITYSDK_OFFSET(0x170277B0)
