...
#define RPG_GAMECORE_CHIMERADUELBUFFIDENTIFIERVALUEGETTER_METHOD_3_405DCDC48FE21512_OFFSET UNITYSDK_OFFSET(0x169893F0)
#define RPG_GAMECORE_CHIMERADUELBUFFIDENTIFIERVALUEGETTER_METHOD_3_497085B1B77348A6_OFFSET UNITYSDK_OFFSET(0x16989310)
#define RPG_GAMECORE_CHIMERADUELBUFFIDENTIFIERVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x169893E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelBuffIdentifierValueGetter_TypeDefinitionIndex = 14444;
