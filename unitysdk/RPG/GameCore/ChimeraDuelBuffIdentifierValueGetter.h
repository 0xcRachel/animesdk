...
#define RPG_GAMECORE_CHIMERADUELBUFFIDENTIFIERVALUEGETTER_METHOD_3_405DCDC48FE21512_OFFSET UNITYSDK_OFFSET(0x196B2C50)
#define RPG_GAMECORE_CHIMERADUELBUFFIDENTIFIERVALUEGETTER_METHOD_3_497085B1B77348A6_OFFSET UNITYSDK_OFFSET(0x196B2B70)
#define RPG_GAMECORE_CHIMERADUELBUFFIDENTIFIERVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x196B2C40)
