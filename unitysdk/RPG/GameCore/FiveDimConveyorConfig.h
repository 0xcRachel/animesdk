...
#define RPG_GAMECORE_FIVEDIMCONVEYORCONFIG_METHOD_3_36F92CFB895C9187_OFFSET UNITYSDK_OFFSET(0x16AB77C0)
#define RPG_GAMECORE_FIVEDIMCONVEYORCONFIG_METHOD_3_42A09DD4111C5B32_OFFSET UNITYSDK_OFFSET(0x16AB7750)
#define RPG_GAMECORE_FIVEDIMCONVEYORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16AB77A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimConveyorConfig_TypeDefinitionIndex = 16687;
