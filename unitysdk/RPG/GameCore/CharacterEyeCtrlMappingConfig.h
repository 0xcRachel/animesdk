...
#define RPG_GAMECORE_CHARACTEREYECTRLMAPPINGCONFIG_METHOD_2_560EFF3130BB177D_OFFSET UNITYSDK_OFFSET(0x170804C0)
#define RPG_GAMECORE_CHARACTEREYECTRLMAPPINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17080590)
