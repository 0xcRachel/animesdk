...
#define RPG_GAMECORE_STREAMINGSCENESCALEDATA_METHOD_2_5CCF310502397610_OFFSET UNITYSDK_OFFSET(0x16FA2B30)
#define RPG_GAMECORE_STREAMINGSCENESCALEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16FA2BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StreamingSceneScaleData_TypeDefinitionIndex = 17147;
