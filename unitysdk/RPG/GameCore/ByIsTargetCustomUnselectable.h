...
#define RPG_GAMECORE_BYISTARGETCUSTOMUNSELECTABLE_METHOD_4_34DA52CF4C605E12_OFFSET UNITYSDK_OFFSET(0x16936940)
#define RPG_GAMECORE_BYISTARGETCUSTOMUNSELECTABLE_METHOD_4_E4A60E91BAABD74A_OFFSET UNITYSDK_OFFSET(0x16936A10)
#define RPG_GAMECORE_BYISTARGETCUSTOMUNSELECTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x169369C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsTargetCustomUnselectable_TypeDefinitionIndex = 21197;
