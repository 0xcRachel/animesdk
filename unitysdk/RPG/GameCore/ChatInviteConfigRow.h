...
#define RPG_GAMECORE_CHATINVITECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18D63BF0)
#define RPG_GAMECORE_CHATINVITECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18D64160)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Single ExpireTime; // 0x1C
		::RPG::Client::TextID InviteContent; // 0x20
		::RPG::Client::TextID InviteGo; // 0x30
		::RPG::Client::TextID SendDesc; // 0x40
		::System::Single NoticeTime; // 0x50
		::RPG::GameCore::ChatNoticeType ChatNoticeType; // 0x54
		::RPG::Client::TextID InviteInvalid; // 0x58
		::RPG::Client::TextID InviteTitle; // 0x68
		::RPG::Client::TextID NoticeDesc; // 0x78
