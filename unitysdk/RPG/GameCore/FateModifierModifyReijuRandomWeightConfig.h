...
#define RPG_GAMECORE_FATEMODIFIERMODIFYREIJURANDOMWEIGHTCONFIG_METHOD_3_6D5DD02446DBE7C9_OFFSET UNITYSDK_OFFSET(0x16A98B60)
#define RPG_GAMECORE_FATEMODIFIERMODIFYREIJURANDOMWEIGHTCONFIG_METHOD_3_D89EF8E87C427060_OFFSET UNITYSDK_OFFSET(0x16A97CA0)
#define RPG_GAMECORE_FATEMODIFIERMODIFYREIJURANDOMWEIGHTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16A97C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierModifyReijuRandomWeightConfig_TypeDefinitionIndex = 17301;
