...
#define RPG_GAMECORE_FATEMODIFIERMODIFYREIJURANDOMWEIGHTCONFIG_METHOD_3_6D5DD02446DBE7C9_OFFSET UNITYSDK_OFFSET(0x19477EC0)
#define RPG_GAMECORE_FATEMODIFIERMODIFYREIJURANDOMWEIGHTCONFIG_METHOD_3_D89EF8E87C427060_OFFSET UNITYSDK_OFFSET(0x19477000)
#define RPG_GAMECORE_FATEMODIFIERMODIFYREIJURANDOMWEIGHTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19476FB0)
