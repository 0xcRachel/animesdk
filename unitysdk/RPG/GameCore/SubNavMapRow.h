...
#define RPG_GAMECORE_SUBNAVMAPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19853B90)
#define RPG_GAMECORE_SUBNAVMAPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19854420)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::UInt32 NavMapSubTabID; // 0x10
