...
#define RPG_GAMECORE_HOYOTAGNODEINFO_METHOD_2_3A2D6C34ACDF1A73_OFFSET UNITYSDK_OFFSET(0x172C86D0)
#define RPG_GAMECORE_HOYOTAGNODEINFO_METHOD_2_501E7A3E999BA1E8_OFFSET UNITYSDK_OFFSET(0x172C7660)
#define RPG_GAMECORE_HOYOTAGNODEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x172C88B0)
