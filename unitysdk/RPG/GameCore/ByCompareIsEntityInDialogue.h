...
#define RPG_GAMECORE_BYCOMPAREISENTITYINDIALOGUE_METHOD_4_89EFB39455EF7E96_OFFSET UNITYSDK_OFFSET(0x18FD8D80)
#define RPG_GAMECORE_BYCOMPAREISENTITYINDIALOGUE_METHOD_4_A8A2823953CD53DB_OFFSET UNITYSDK_OFFSET(0x18FD8F00)
#define RPG_GAMECORE_BYCOMPAREISENTITYINDIALOGUE_METHOD_4_B522C25022764568_OFFSET UNITYSDK_OFFSET(0x18FD8CB0)
#define RPG_GAMECORE_BYCOMPAREISENTITYINDIALOGUE_METHOD_4_E4764EA925126D3A_OFFSET UNITYSDK_OFFSET(0x18FD8F80)
#define RPG_GAMECORE_BYCOMPAREISENTITYINDIALOGUE__CTOR_OFFSET UNITYSDK_OFFSET(0x18FD8D30)
