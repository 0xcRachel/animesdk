...
#define RPG_GAMECORE_CITYSHOPREWARDLISTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x169A2DE0)
#define RPG_GAMECORE_CITYSHOPREWARDLISTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x169A34C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CityShopRewardListRow_TypeDefinitionIndex = 11839;
