...
#define RPG_GAMECORE_ADVENTUREMODIFYMAZEMP_METHOD_3_3F3E8F94B17E7A8C_OFFSET UNITYSDK_OFFSET(0x1685C690)
#define RPG_GAMECORE_ADVENTUREMODIFYMAZEMP_METHOD_3_57A992A38412BF09_OFFSET UNITYSDK_OFFSET(0x1685C710)
#define RPG_GAMECORE_ADVENTUREMODIFYMAZEMP__CTOR_OFFSET UNITYSDK_OFFSET(0x1685C6E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureModifyMazeMP_TypeDefinitionIndex = 19391;
