...
#define RPG_GAMECORE_COCOONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x169B7060)
#define RPG_GAMECORE_COCOONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x169B7AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CocoonRow_TypeDefinitionIndex = 11387;
	...
	public:
		...
		::System::Boolean AutoObtainDamageType; // 0x60
