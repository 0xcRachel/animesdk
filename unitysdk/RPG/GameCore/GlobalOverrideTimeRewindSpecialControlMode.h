...
#define RPG_GAMECORE_GLOBALOVERRIDETIMEREWINDSPECIALCONTROLMODE_METHOD_3_6A44B392DF5EB2A1_OFFSET UNITYSDK_OFFSET(0x1955C830)
#define RPG_GAMECORE_GLOBALOVERRIDETIMEREWINDSPECIALCONTROLMODE_METHOD_3_91906046E2D45B08_OFFSET UNITYSDK_OFFSET(0x1955C8B0)
#define RPG_GAMECORE_GLOBALOVERRIDETIMEREWINDSPECIALCONTROLMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1955C880)
