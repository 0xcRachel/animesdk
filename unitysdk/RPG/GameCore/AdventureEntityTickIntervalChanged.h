...
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA84D1B0)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA84D200)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_GET_ENTITYID_OFFSET UNITYSDK_OFFSET(0xA84D240)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_GET_TICKINTERVALNEW_OFFSET UNITYSDK_OFFSET(0xA84D280)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_GET_TICKINTERVALOLD_OFFSET UNITYSDK_OFFSET(0xA84D260)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_INIT_OFFSET UNITYSDK_OFFSET(0xA84D150)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_SET_ENTITYID_OFFSET UNITYSDK_OFFSET(0xA84D250)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_SET_TICKINTERVALNEW_OFFSET UNITYSDK_OFFSET(0xA84D290)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_SET_TICKINTERVALOLD_OFFSET UNITYSDK_OFFSET(0xA84D270)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED__CTOR_OFFSET UNITYSDK_OFFSET(0xA84D2A0)
