...
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xC769630)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xC769680)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_GET_ENTITYID_OFFSET UNITYSDK_OFFSET(0xC7696C0)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_GET_TICKINTERVALNEW_OFFSET UNITYSDK_OFFSET(0xC769700)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_GET_TICKINTERVALOLD_OFFSET UNITYSDK_OFFSET(0xC7696E0)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_INIT_OFFSET UNITYSDK_OFFSET(0xC7695D0)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_SET_ENTITYID_OFFSET UNITYSDK_OFFSET(0xC7696D0)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_SET_TICKINTERVALNEW_OFFSET UNITYSDK_OFFSET(0xC769710)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_SET_TICKINTERVALOLD_OFFSET UNITYSDK_OFFSET(0xC7696F0)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED__CTOR_OFFSET UNITYSDK_OFFSET(0xC769720)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 _TickIntervalOld_k__BackingField; // 0x20
