...
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA3116C0)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA311710)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_GET_ENTITYID_OFFSET UNITYSDK_OFFSET(0xA311750)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_GET_TICKINTERVALNEW_OFFSET UNITYSDK_OFFSET(0xA311790)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_GET_TICKINTERVALOLD_OFFSET UNITYSDK_OFFSET(0xA311770)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_INIT_OFFSET UNITYSDK_OFFSET(0xA311660)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_SET_ENTITYID_OFFSET UNITYSDK_OFFSET(0xA311760)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_SET_TICKINTERVALNEW_OFFSET UNITYSDK_OFFSET(0xA3117A0)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_SET_TICKINTERVALOLD_OFFSET UNITYSDK_OFFSET(0xA311780)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED__CTOR_OFFSET UNITYSDK_OFFSET(0xA3117B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureEntityTickIntervalChanged_TypeDefinitionIndex = 44452;
