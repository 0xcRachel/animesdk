...
#define RPG_GAMECORE_CLOCKPARKSTORYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x169B3260)
#define RPG_GAMECORE_CLOCKPARKSTORYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x169B39A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClockParkStoryRow_TypeDefinitionIndex = 10387;
