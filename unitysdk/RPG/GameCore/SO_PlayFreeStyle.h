...
#define RPG_GAMECORE_SO_PLAYFREESTYLE_METHOD_4_4C0C5EFD176EE252_OFFSET UNITYSDK_OFFSET(0x16EDCF80)
#define RPG_GAMECORE_SO_PLAYFREESTYLE_METHOD_4_97B5A011780B349E_OFFSET UNITYSDK_OFFSET(0x16EDC360)
#define RPG_GAMECORE_SO_PLAYFREESTYLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16EDC320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SO_PlayFreeStyle_TypeDefinitionIndex = 17818;
