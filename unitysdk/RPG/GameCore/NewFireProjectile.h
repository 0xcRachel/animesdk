...
#define RPG_GAMECORE_NEWFIREPROJECTILE_METHOD_4_276C2C77A253A714_OFFSET UNITYSDK_OFFSET(0x1864CF70)
#define RPG_GAMECORE_NEWFIREPROJECTILE_METHOD_4_B8F11FA84BE31C58_OFFSET UNITYSDK_OFFSET(0x1864D010)
#define RPG_GAMECORE_NEWFIREPROJECTILE__CTOR_OFFSET UNITYSDK_OFFSET(0x1864CFD0)
