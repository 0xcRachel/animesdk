...
#define RPG_GAMECORE_IDLELIVEGACHAAVATARSTARROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18A8AA50)
#define RPG_GAMECORE_IDLELIVEGACHAAVATARSTARROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18A8ABD0)
