...
#define RPG_GAMECORE_DICECOMBATPRESETTURNACTORCONFIG_METHOD_2_D8D6AA9B6B1AD953_OFFSET UNITYSDK_OFFSET(0x1717BBD0)
#define RPG_GAMECORE_DICECOMBATPRESETTURNACTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1717BD30)
