...
#define RPG_GAMECORE_SUBMISSIONIDLISTFORSKIPMCVVERIFY_METHOD_2_256808872E4EDEFA_OFFSET UNITYSDK_OFFSET(0x16FA8BE0)
#define RPG_GAMECORE_SUBMISSIONIDLISTFORSKIPMCVVERIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x16FA8CA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SubMissionIDListForSkipMCVVerify_TypeDefinitionIndex = 17035;
