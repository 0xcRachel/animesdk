...
#define RPG_GAMECORE_NPCMONSTERTRACKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18648480)
#define RPG_GAMECORE_NPCMONSTERTRACKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18648640)
