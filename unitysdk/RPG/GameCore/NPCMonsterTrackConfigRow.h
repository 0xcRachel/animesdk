...
#define RPG_GAMECORE_NPCMONSTERTRACKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x174818B0)
#define RPG_GAMECORE_NPCMONSTERTRACKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17481A70)
