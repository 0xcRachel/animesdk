...
#define RPG_GAMECORE_NPCMONSTERTRACKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16CFB0D0)
#define RPG_GAMECORE_NPCMONSTERTRACKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16CFB290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NPCMonsterTrackConfigRow_TypeDefinitionIndex = 13012;
