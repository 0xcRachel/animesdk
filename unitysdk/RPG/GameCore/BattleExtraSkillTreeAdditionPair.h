...
#define RPG_GAMECORE_BATTLEEXTRASKILLTREEADDITIONPAIR_METHOD_3_BC36FFCBF1884962_OFFSET UNITYSDK_OFFSET(0x187AA9E0)
#define RPG_GAMECORE_BATTLEEXTRASKILLTREEADDITIONPAIR_METHOD_3_F202795BBDAB96C8_OFFSET UNITYSDK_OFFSET(0x187AAC30)
#define RPG_GAMECORE_BATTLEEXTRASKILLTREEADDITIONPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x187AA9D0)
