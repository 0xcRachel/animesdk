...
#define RPG_GAMECORE_NOTIFYVERSUSBARQUESTCHANGE_METHOD_3_672D320D8F1FB10D_OFFSET UNITYSDK_OFFSET(0x18EE95E0)
#define RPG_GAMECORE_NOTIFYVERSUSBARQUESTCHANGE_METHOD_3_A741C8DBEFD7E7FA_OFFSET UNITYSDK_OFFSET(0x18EE9660)
#define RPG_GAMECORE_NOTIFYVERSUSBARQUESTCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18EE9630)
