...
#define RPG_GAMECORE_BYCOMPARESTAGEID_METHOD_4_3947FBDA61BDB682_OFFSET UNITYSDK_OFFSET(0x1702C830)
#define RPG_GAMECORE_BYCOMPARESTAGEID_METHOD_4_DB250444F20A9FBE_OFFSET UNITYSDK_OFFSET(0x1702C760)
#define RPG_GAMECORE_BYCOMPARESTAGEID__CTOR_OFFSET UNITYSDK_OFFSET(0x1702C7E0)
