...
#define RPG_GAMECORE_RESETREDSTANCE_METHOD_3_19E21C8491ADCDCD_OFFSET UNITYSDK_OFFSET(0x175B34A0)
#define RPG_GAMECORE_RESETREDSTANCE_METHOD_3_3A0351ED28D494BA_OFFSET UNITYSDK_OFFSET(0x175B3530)
#define RPG_GAMECORE_RESETREDSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x175B3500)
