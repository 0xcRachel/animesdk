...
#define RPG_GAMECORE_ADVHIDEMAZEBTN_METHOD_3_2BD129A5BA042A9A_OFFSET UNITYSDK_OFFSET(0x16838370)
#define RPG_GAMECORE_ADVHIDEMAZEBTN_METHOD_3_6B6473CDF47A4A0C_OFFSET UNITYSDK_OFFSET(0x168383F0)
#define RPG_GAMECORE_ADVHIDEMAZEBTN__CTOR_OFFSET UNITYSDK_OFFSET(0x168383C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvHideMazeBtn_TypeDefinitionIndex = 21556;
