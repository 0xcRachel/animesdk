...
#define RPG_GAMECORE_ADVCLIENTCHANGEPROPSTATE_METHOD_3_48D0A86CADC3FE31_OFFSET UNITYSDK_OFFSET(0x16830820)
#define RPG_GAMECORE_ADVCLIENTCHANGEPROPSTATE_METHOD_3_59BA1BE9BD6269CF_OFFSET UNITYSDK_OFFSET(0x16830970)
#define RPG_GAMECORE_ADVCLIENTCHANGEPROPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x168308E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvClientChangePropState_TypeDefinitionIndex = 18236;
