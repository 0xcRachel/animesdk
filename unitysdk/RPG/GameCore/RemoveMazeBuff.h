...
#define RPG_GAMECORE_REMOVEMAZEBUFF_METHOD_3_285DF138332F6821_OFFSET UNITYSDK_OFFSET(0x19028580)
#define RPG_GAMECORE_REMOVEMAZEBUFF_METHOD_3_EEA5E53A6F1FB400_OFFSET UNITYSDK_OFFSET(0x19028500)
#define RPG_GAMECORE_REMOVEMAZEBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x19028550)
