...
#define RPG_GAMECORE_TRIGGERMARBLEAFTERSTREAMINGACTION_METHOD_3_1B1D8D2331478BD2_OFFSET UNITYSDK_OFFSET(0x19119CB0)
#define RPG_GAMECORE_TRIGGERMARBLEAFTERSTREAMINGACTION_METHOD_3_E9617C78E8463BDE_OFFSET UNITYSDK_OFFSET(0x19119DC0)
#define RPG_GAMECORE_TRIGGERMARBLEAFTERSTREAMINGACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19119D90)
