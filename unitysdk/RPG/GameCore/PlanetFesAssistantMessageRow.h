...
#define RPG_GAMECORE_PLANETFESASSISTANTMESSAGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18B29A40)
#define RPG_GAMECORE_PLANETFESASSISTANTMESSAGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18B29DC0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 UnlockPlanetFesLevel; // 0x20
