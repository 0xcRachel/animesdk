...
#define RPG_GAMECORE_PLANETFESASSISTANTMESSAGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19D46840)
#define RPG_GAMECORE_PLANETFESASSISTANTMESSAGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19D46BC0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 Delay; // 0x28
		::System::UInt32 ID; // 0x2C
		::System::UInt32 Priority; // 0x30
		::System::Boolean IsUseGLobalCD; // 0x34
		::RPG::GameCore::PlanetFesAssistantMessageType AssistantMessageType; // 0x38
		::System::UInt32 UnlockPlanetFesLevel; // 0x3C
		::System::UInt32 Interval; // 0x40
