...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_INITCONSUMNHPUNLIMITEDROLL_METHOD_3_68A5FAE4BA36052A_OFFSET UNITYSDK_OFFSET(0x195A5C10)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_INITCONSUMNHPUNLIMITEDROLL_METHOD_3_F365269EB204F283_OFFSET UNITYSDK_OFFSET(0x195A07B0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_INITCONSUMNHPUNLIMITEDROLL__CTOR_OFFSET UNITYSDK_OFFSET(0x195A0710)
