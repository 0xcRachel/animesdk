...
#define RPG_GAMECORE_PCKPATCHCONFIG_METHOD_2_F71FDC9F3E12D2A9_OFFSET UNITYSDK_OFFSET(0x174A3F70)
#define RPG_GAMECORE_PCKPATCHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x174A4080)
