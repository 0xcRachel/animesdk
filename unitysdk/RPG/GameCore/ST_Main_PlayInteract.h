...
#define RPG_GAMECORE_ST_MAIN_PLAYINTERACT_METHOD_4_A3474BC459BCCFDA_OFFSET UNITYSDK_OFFSET(0x1A16E080)
#define RPG_GAMECORE_ST_MAIN_PLAYINTERACT_METHOD_4_D7868C88FE1C1BA8_OFFSET UNITYSDK_OFFSET(0x1A181E70)
#define RPG_GAMECORE_ST_MAIN_PLAYINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A16E030)
