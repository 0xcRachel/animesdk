...
#define RPG_GAMECORE_ST_SIDE_ELFINTERACTCURRENTSLOT_METHOD_4_40C0748E509073EC_OFFSET UNITYSDK_OFFSET(0x176ACE10)
#define RPG_GAMECORE_ST_SIDE_ELFINTERACTCURRENTSLOT_METHOD_4_6B711B79EE3DF280_OFFSET UNITYSDK_OFFSET(0x1769ECD0)
#define RPG_GAMECORE_ST_SIDE_ELFINTERACTCURRENTSLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1769EC70)
