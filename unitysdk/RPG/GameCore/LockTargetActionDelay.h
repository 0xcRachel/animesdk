...
#define RPG_GAMECORE_LOCKTARGETACTIONDELAY_METHOD_3_CBAE2A0A7344887D_OFFSET UNITYSDK_OFFSET(0x17380660)
#define RPG_GAMECORE_LOCKTARGETACTIONDELAY_METHOD_3_FDE3B6932F299A41_OFFSET UNITYSDK_OFFSET(0x173805E0)
#define RPG_GAMECORE_LOCKTARGETACTIONDELAY__CTOR_OFFSET UNITYSDK_OFFSET(0x17380630)
