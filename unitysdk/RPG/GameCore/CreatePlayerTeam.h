...
#define RPG_GAMECORE_CREATEPLAYERTEAM_METHOD_3_C7673EF3709D7554_OFFSET UNITYSDK_OFFSET(0x169D5840)
#define RPG_GAMECORE_CREATEPLAYERTEAM_METHOD_3_FC346D1139145CF1_OFFSET UNITYSDK_OFFSET(0x169D58D0)
#define RPG_GAMECORE_CREATEPLAYERTEAM__CTOR_OFFSET UNITYSDK_OFFSET(0x169D58A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreatePlayerTeam_TypeDefinitionIndex = 21062;
