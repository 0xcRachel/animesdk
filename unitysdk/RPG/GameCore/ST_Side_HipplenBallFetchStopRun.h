...
#define RPG_GAMECORE_ST_SIDE_HIPPLENBALLFETCHSTOPRUN_METHOD_4_53A29DF43CAFF863_OFFSET UNITYSDK_OFFSET(0x16EF7EE0)
#define RPG_GAMECORE_ST_SIDE_HIPPLENBALLFETCHSTOPRUN_METHOD_4_A28897986FFC44E9_OFFSET UNITYSDK_OFFSET(0x16EE8130)
#define RPG_GAMECORE_ST_SIDE_HIPPLENBALLFETCHSTOPRUN__CTOR_OFFSET UNITYSDK_OFFSET(0x16EE80E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_HipplenBallFetchStopRun_TypeDefinitionIndex = 19087;
