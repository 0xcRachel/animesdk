...
#define RPG_GAMECORE_EVOLVEBUILDSTAGEPERIODROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16A82BF0)
#define RPG_GAMECORE_EVOLVEBUILDSTAGEPERIODROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16A835A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EvolveBuildStagePeriodRow_TypeDefinitionIndex = 10608;
	...
	public:
		...
		::Il2CppArray<::System::Single>* EmotionList; // 0x18
