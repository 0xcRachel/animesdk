...
#define RPG_GAMECORE_EVOLVEBUILDSTAGEPERIODROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A3F5CA0)
#define RPG_GAMECORE_EVOLVEBUILDSTAGEPERIODROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3F6640)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::EvolvePeriodType PeriodRank; // 0x34
