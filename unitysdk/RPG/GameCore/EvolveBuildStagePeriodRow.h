...
#define RPG_GAMECORE_EVOLVEBUILDSTAGEPERIODROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x194605D0)
#define RPG_GAMECORE_EVOLVEBUILDSTAGEPERIODROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19460F80)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::Class_1_73B429E1E9F270F4*>* WeaknessList; // 0x28
		::System::UInt32 StageID; // 0x30
		::System::UInt32 StageScore; // 0x34
		::System::UInt32 PeriodScore; // 0x38
		::System::UInt32 WaveCount; // 0x3C
		::RPG::GameCore::FixPoint DeadLinePosition; // 0x40
		::System::UInt32 Weight; // 0x48
		::RPG::GameCore::EvolvePeriodType PeriodRank; // 0x4C
		::System::UInt32 BattleArea; // 0x50
		::System::UInt32 EventID; // 0x54
		::System::UInt32 StagePeriodID; // 0x58
