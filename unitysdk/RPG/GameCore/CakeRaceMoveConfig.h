...
#define RPG_GAMECORE_CAKERACEMOVECONFIG_METHOD_2_122FA0AB612CB667_OFFSET UNITYSDK_OFFSET(0x16950400)
#define RPG_GAMECORE_CAKERACEMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16950560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceMoveConfig_TypeDefinitionIndex = 16536;
