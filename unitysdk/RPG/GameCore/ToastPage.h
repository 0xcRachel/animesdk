...
#define RPG_GAMECORE_TOASTPAGE_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x170F9200)
#define RPG_GAMECORE_TOASTPAGE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x170F9180)
#define RPG_GAMECORE_TOASTPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x170F91D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ToastPage_TypeDefinitionIndex = 18073;
