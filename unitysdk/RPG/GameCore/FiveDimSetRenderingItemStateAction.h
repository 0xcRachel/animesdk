...
#define RPG_GAMECORE_FIVEDIMSETRENDERINGITEMSTATEACTION_METHOD_3_449B007783556A73_OFFSET UNITYSDK_OFFSET(0x16AD45F0)
#define RPG_GAMECORE_FIVEDIMSETRENDERINGITEMSTATEACTION_METHOD_3_8999D03DFD421236_OFFSET UNITYSDK_OFFSET(0x16AD4660)
#define RPG_GAMECORE_FIVEDIMSETRENDERINGITEMSTATEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16AD4640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetRenderingItemStateAction_TypeDefinitionIndex = 16778;
