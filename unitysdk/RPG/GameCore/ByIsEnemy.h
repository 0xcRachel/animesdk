...
#define RPG_GAMECORE_BYISENEMY_METHOD_4_2F44EDAB81B8D623_OFFSET UNITYSDK_OFFSET(0x170417F0)
#define RPG_GAMECORE_BYISENEMY_METHOD_4_31334FF7A03ED5C7_OFFSET UNITYSDK_OFFSET(0x17041720)
#define RPG_GAMECORE_BYISENEMY__CTOR_OFFSET UNITYSDK_OFFSET(0x170417A0)
