...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::ELevelPerformanceType>**)Il2CppClass::FromTypeDefinitionIndex(SummonUnitGroupConfig___O_TypeDefinitionIndex)->GetStaticField(0x149F0);
		}
	};
}
