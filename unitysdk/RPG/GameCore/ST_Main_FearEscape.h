...
#define RPG_GAMECORE_ST_MAIN_FEARESCAPE_METHOD_4_1876D1A219E0DFF6_OFFSET UNITYSDK_OFFSET(0x16EF6A40)
#define RPG_GAMECORE_ST_MAIN_FEARESCAPE_METHOD_4_D18533BAE0D73C99_OFFSET UNITYSDK_OFFSET(0x16EE2040)
#define RPG_GAMECORE_ST_MAIN_FEARESCAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x16EE1FF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_FearEscape_TypeDefinitionIndex = 17908;
