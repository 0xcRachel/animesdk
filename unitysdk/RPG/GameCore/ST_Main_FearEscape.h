...
#define RPG_GAMECORE_ST_MAIN_FEARESCAPE_METHOD_4_1876D1A219E0DFF6_OFFSET UNITYSDK_OFFSET(0x176ABDB0)
#define RPG_GAMECORE_ST_MAIN_FEARESCAPE_METHOD_4_D18533BAE0D73C99_OFFSET UNITYSDK_OFFSET(0x17699970)
#define RPG_GAMECORE_ST_MAIN_FEARESCAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x17699920)
