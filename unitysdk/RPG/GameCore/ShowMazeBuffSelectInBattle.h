...
#define RPG_GAMECORE_SHOWMAZEBUFFSELECTINBATTLE_METHOD_3_14EF2A792A17C071_OFFSET UNITYSDK_OFFSET(0x16F5E9A0)
#define RPG_GAMECORE_SHOWMAZEBUFFSELECTINBATTLE_METHOD_3_49D1A714799B9F2F_OFFSET UNITYSDK_OFFSET(0x16F5EA20)
#define RPG_GAMECORE_SHOWMAZEBUFFSELECTINBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F5E9F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowMazeBuffSelectInBattle_TypeDefinitionIndex = 20153;
