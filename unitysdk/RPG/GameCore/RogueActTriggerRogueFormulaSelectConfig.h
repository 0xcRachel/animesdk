...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEFORMULASELECTCONFIG_METHOD_6_AD64875BE70E0141_OFFSET UNITYSDK_OFFSET(0x1A9B8B10)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEFORMULASELECTCONFIG_METHOD_6_FB12A411A4A8FDBC_OFFSET UNITYSDK_OFFSET(0x1A9B8D30)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEFORMULASELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9B8C50)
