...
#define RPG_GAMECORE_ADVCREATEENTITYASYNC_METHOD_3_DA114CF636ECF23D_OFFSET UNITYSDK_OFFSET(0x1955EAB0)
#define RPG_GAMECORE_ADVCREATEENTITYASYNC_METHOD_3_DDC353F5B3E829B3_OFFSET UNITYSDK_OFFSET(0x1955EA30)
#define RPG_GAMECORE_ADVCREATEENTITYASYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1955EA80)
