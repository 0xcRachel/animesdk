...
#define RPG_GAMECORE_HEARTDIALTRACECONSUMEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B5F770)
#define RPG_GAMECORE_HEARTDIALTRACECONSUMEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B5FA30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HeartDialTraceConsumeRow_TypeDefinitionIndex = 12496;

	class HeartDialTraceConsumeRow : public ::System::Object
	{
	public:
		::Il2CppArray<::RPG::GameCore::ItemConfig*>* MaterialCost; // 0x10
		::RPG::GameCore::HeartDialEmoType HeartDialEmotion; // 0x18
		::System::Int32 MiniMapID; // 0x1C
		::RPG::GameCore::HeartDialStepType HeartDialStep; // 0x20
		::System::UInt32 HeartDialTraceID; // 0x24
