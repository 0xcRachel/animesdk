...
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCBASECONFIG_METHOD_2_418BB5EC1EAAB603_OFFSET UNITYSDK_OFFSET(0x16ED3050)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCBASECONFIG_METHOD_2_876E697A9F997D3A_OFFSET UNITYSDK_OFFSET(0x16ED3320)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCBASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16ED3310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWorkbenchFuncBaseConfig_TypeDefinitionIndex = 16187;
