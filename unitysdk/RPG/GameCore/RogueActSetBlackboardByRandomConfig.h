...
#define RPG_GAMECORE_ROGUEACTSETBLACKBOARDBYRANDOMCONFIG_METHOD_6_309FEFB74E1EA5A3_OFFSET UNITYSDK_OFFSET(0x1A9B5AE0)
#define RPG_GAMECORE_ROGUEACTSETBLACKBOARDBYRANDOMCONFIG_METHOD_6_C572FA0F488FCE96_OFFSET UNITYSDK_OFFSET(0x1A9B58C0)
#define RPG_GAMECORE_ROGUEACTSETBLACKBOARDBYRANDOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9B5A00)
