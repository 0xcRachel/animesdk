...
#define RPG_GAMECORE_CHENLINGFESABILITYCONFIG_METHOD_2_DA01811C41AD3276_OFFSET UNITYSDK_OFFSET(0x1A4FB550)
#define RPG_GAMECORE_CHENLINGFESABILITYCONFIG_METHOD_2_F3A2E299997BDB96_OFFSET UNITYSDK_OFFSET(0x1A4FB7D0)
#define RPG_GAMECORE_CHENLINGFESABILITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4FB7C0)
