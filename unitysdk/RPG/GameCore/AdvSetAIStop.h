...
#define RPG_GAMECORE_ADVSETAISTOP_METHOD_3_7A56A9F13D08FDF4_OFFSET UNITYSDK_OFFSET(0x18C5A170)
#define RPG_GAMECORE_ADVSETAISTOP_METHOD_3_BD2BB6D8721CBC17_OFFSET UNITYSDK_OFFSET(0x18C5A1F0)
#define RPG_GAMECORE_ADVSETAISTOP__CTOR_OFFSET UNITYSDK_OFFSET(0x18C5A1C0)
