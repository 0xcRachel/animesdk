...
#define RPG_GAMECORE_BYHASINSERTABILITYPENDING_METHOD_4_606916E40CB3357A_OFFSET UNITYSDK_OFFSET(0x16926CD0)
#define RPG_GAMECORE_BYHASINSERTABILITYPENDING_METHOD_4_9CEB163A7F796DA0_OFFSET UNITYSDK_OFFSET(0x16926DA0)
#define RPG_GAMECORE_BYHASINSERTABILITYPENDING__CTOR_OFFSET UNITYSDK_OFFSET(0x16926D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHasInsertAbilityPending_TypeDefinitionIndex = 21203;
