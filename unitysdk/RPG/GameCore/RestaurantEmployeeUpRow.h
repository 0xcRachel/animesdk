...
#define RPG_GAMECORE_RESTAURANTEMPLOYEEUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16DEBCF0)
#define RPG_GAMECORE_RESTAURANTEMPLOYEEUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16DEBEA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RestaurantEmployeeUpRow_TypeDefinitionIndex = 10532;
