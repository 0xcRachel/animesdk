...
#define RPG_GAMECORE_ACTIVITYDICECOMBATAVATARROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19895EE0)
#define RPG_GAMECORE_ACTIVITYDICECOMBATAVATARROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19896640)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* FinalAttackVoice; // 0x40
		::System::String* ShopIcon; // 0x48
		::System::String* ImgPathUI3D; // 0x50
		::Il2CppArray<::System::UInt32>* RecommendDiceIDList; // 0x58
		::System::String* ImgPathHeadIcon; // 0x60
		::Il2CppArray<::System::UInt32>* DiceCountPerRare; // 0x68
		::System::String* AttackEffectEnemyPath; // 0x70
		::System::String* AttackAnimation; // 0x78
		::System::UInt32 DefendDiceNumber; // 0x80
		::System::Boolean IsCollection; // 0x84
