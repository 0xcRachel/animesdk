...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDUNLOCKEDROLESCONFIG_METHOD_3_9DED47A4CD87A6E1_OFFSET UNITYSDK_OFFSET(0x19576230)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDUNLOCKEDROLESCONFIG_METHOD_3_F68C002FCE2A9F08_OFFSET UNITYSDK_OFFSET(0x19576160)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDUNLOCKEDROLESCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x195761E0)
