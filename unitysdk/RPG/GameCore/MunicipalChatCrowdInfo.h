...
#define RPG_GAMECORE_MUNICIPALCHATCROWDINFO_METHOD_2_6632583CE1B6EB6E_OFFSET UNITYSDK_OFFSET(0x186370C0)
#define RPG_GAMECORE_MUNICIPALCHATCROWDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x186371D0)
