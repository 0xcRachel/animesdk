...
#define RPG_GAMECORE_MODIFYDAMAGEDISPLAYDATA_METHOD_3_01F104D8A4E53611_OFFSET UNITYSDK_OFFSET(0x16CBDCB0)
#define RPG_GAMECORE_MODIFYDAMAGEDISPLAYDATA_METHOD_3_6BF42959DAD931F6_OFFSET UNITYSDK_OFFSET(0x16CBDC10)
#define RPG_GAMECORE_MODIFYDAMAGEDISPLAYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16CBDC70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyDamageDisplayData_TypeDefinitionIndex = 20744;
