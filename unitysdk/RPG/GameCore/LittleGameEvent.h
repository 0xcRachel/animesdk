...
#define RPG_GAMECORE_LITTLEGAMEEVENT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x16BCE110)
#define RPG_GAMECORE_LITTLEGAMEEVENT_EQUALS_OFFSET UNITYSDK_OFFSET(0x16BCE0C0)
#define RPG_GAMECORE_LITTLEGAMEEVENT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x16BCE1D0)
#define RPG_GAMECORE_LITTLEGAMEEVENT_METHOD_2_11FBAD25CE3FF00E_OFFSET UNITYSDK_OFFSET(0x16BCDF60)
#define RPG_GAMECORE_LITTLEGAMEEVENT_METHOD_2_DA9AFBAF121A7C2C_1_OFFSET UNITYSDK_OFFSET(0x16BCE250)
#define RPG_GAMECORE_LITTLEGAMEEVENT_METHOD_2_DA9AFBAF121A7C2C_OFFSET UNITYSDK_OFFSET(0x16BCE210)
#define RPG_GAMECORE_LITTLEGAMEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x16BCE0B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameEvent_TypeDefinitionIndex = 16916;
