...
#define RPG_GAMECORE_LITTLEGAMEEVENT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17371B90)
#define RPG_GAMECORE_LITTLEGAMEEVENT_EQUALS_OFFSET UNITYSDK_OFFSET(0x17371B40)
#define RPG_GAMECORE_LITTLEGAMEEVENT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17371C50)
#define RPG_GAMECORE_LITTLEGAMEEVENT_METHOD_2_11FBAD25CE3FF00E_OFFSET UNITYSDK_OFFSET(0x173719E0)
#define RPG_GAMECORE_LITTLEGAMEEVENT_METHOD_2_DA9AFBAF121A7C2C_1_OFFSET UNITYSDK_OFFSET(0x17371CC0)
#define RPG_GAMECORE_LITTLEGAMEEVENT_METHOD_2_DA9AFBAF121A7C2C_OFFSET UNITYSDK_OFFSET(0x17371C80)
#define RPG_GAMECORE_LITTLEGAMEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x17371B30)
