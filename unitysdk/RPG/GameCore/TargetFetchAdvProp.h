...
#define RPG_GAMECORE_TARGETFETCHADVPROP_METHOD_4_721AAE13ED3F52F8_OFFSET UNITYSDK_OFFSET(0x1AC4C8A0)
#define RPG_GAMECORE_TARGETFETCHADVPROP_METHOD_4_8337BFE36DA4BF3C_OFFSET UNITYSDK_OFFSET(0x1AC3EA90)
#define RPG_GAMECORE_TARGETFETCHADVPROP_METHOD_4_E0B218F844E3062A_OFFSET UNITYSDK_OFFSET(0x1AC524E0)
#define RPG_GAMECORE_TARGETFETCHADVPROP_METHOD_4_E1A5DDCD0C55A180_OFFSET UNITYSDK_OFFSET(0x1AC52550)
#define RPG_GAMECORE_TARGETFETCHADVPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC3EA40)
...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(TargetFetchAdvProp_TypeDefinitionIndex)->GetStaticField(0x9950);
		}
