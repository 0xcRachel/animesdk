...
#define RPG_GAMECORE_CHARACTERSKINCONFIG_METHOD_2_094DB9A1735FFFE0_OFFSET UNITYSDK_OFFSET(0x17087290)
#define RPG_GAMECORE_CHARACTERSKINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17087360)
