...
#define RPG_GAMECORE_MATCHTHREEEMOJIROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16C5EE00)
#define RPG_GAMECORE_MATCHTHREEEMOJIROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16C5EFA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MatchThreeEmojiRow_TypeDefinitionIndex = 10894;
