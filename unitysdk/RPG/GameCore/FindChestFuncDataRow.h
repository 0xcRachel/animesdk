...
#define RPG_GAMECORE_FINDCHESTFUNCDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x171EABE0)
#define RPG_GAMECORE_FINDCHESTFUNCDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x171EB520)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 SpecialMappinginfo; // 0x38
