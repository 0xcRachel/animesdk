...
#define RPG_GAMECORE_FINDCHESTFUNCDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A419CC0)
#define RPG_GAMECORE_FINDCHESTFUNCDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A41A580)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::RPG::GameCore::ChestType>* ChestTypeList; // 0x28
		::System::UInt32 MappingInfoID; // 0x30
		::System::UInt32 FindRange; // 0x34
