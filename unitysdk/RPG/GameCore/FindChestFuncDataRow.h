...
#define RPG_GAMECORE_FINDCHESTFUNCDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16AA57A0)
#define RPG_GAMECORE_FINDCHESTFUNCDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16AA60A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FindChestFuncDataRow_TypeDefinitionIndex = 12064;

	class FindChestFuncDataRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* TriggerParamList; // 0x10
		::Il2CppArray<::RPG::GameCore::ChestType>* ChestTypeList; // 0x18
		::Il2CppArray<::System::UInt32>* WorldIDList; // 0x20
		::Il2CppArray<::RPG::GameCore::GameModeType>* GameModeList; // 0x28
		::System::UInt32 MapIconID; // 0x30
		::System::UInt32 FindNum; // 0x34
		::RPG::GameCore::FindChestTriggerType TriggerType; // 0x38
		::System::UInt32 FindRange; // 0x3C
		::System::UInt32 SpecialMappinginfo; // 0x40
		::System::UInt32 MappingInfoID; // 0x44
		::System::UInt32 FuncID; // 0x48
