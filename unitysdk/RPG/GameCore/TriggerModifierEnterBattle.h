...
#define RPG_GAMECORE_TRIGGERMODIFIERENTERBATTLE_METHOD_3_40EC1D732529C5AC_OFFSET UNITYSDK_OFFSET(0x178DEE20)
#define RPG_GAMECORE_TRIGGERMODIFIERENTERBATTLE_METHOD_3_EEE94AF87AEB983D_OFFSET UNITYSDK_OFFSET(0x178DEEA0)
#define RPG_GAMECORE_TRIGGERMODIFIERENTERBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x178DEE70)
