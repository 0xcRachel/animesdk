...
#define RPG_GAMECORE_UNDEFINEDYNAMICSTRING_METHOD_3_5DBC4BA19B252986_OFFSET UNITYSDK_OFFSET(0x19133C70)
#define RPG_GAMECORE_UNDEFINEDYNAMICSTRING_METHOD_3_E8FC944572D25A17_OFFSET UNITYSDK_OFFSET(0x19133BF0)
#define RPG_GAMECORE_UNDEFINEDYNAMICSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x19133C40)
