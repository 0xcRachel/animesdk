...
#define RPG_GAMECORE_UNDEFINEDYNAMICSTRING_METHOD_3_5DBC4BA19B252986_OFFSET UNITYSDK_OFFSET(0x1713B810)
#define RPG_GAMECORE_UNDEFINEDYNAMICSTRING_METHOD_3_E8FC944572D25A17_OFFSET UNITYSDK_OFFSET(0x1713B790)
#define RPG_GAMECORE_UNDEFINEDYNAMICSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1713B7E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UnDefineDynamicString_TypeDefinitionIndex = 21536;
