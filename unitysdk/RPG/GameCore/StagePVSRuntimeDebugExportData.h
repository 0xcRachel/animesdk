...
#define RPG_GAMECORE_STAGEPVSRUNTIMEDEBUGEXPORTDATA_METHOD_2_9F9E741FC686412D_OFFSET UNITYSDK_OFFSET(0x16F89F20)
#define RPG_GAMECORE_STAGEPVSRUNTIMEDEBUGEXPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16F8A000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StagePVSRuntimeDebugExportData_TypeDefinitionIndex = 17179;
