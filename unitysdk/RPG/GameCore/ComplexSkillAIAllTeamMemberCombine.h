...
#define RPG_GAMECORE_COMPLEXSKILLAIALLTEAMMEMBERCOMBINE_METHOD_3_8038CA6E8FAC01A9_OFFSET UNITYSDK_OFFSET(0x169BAB60)
#define RPG_GAMECORE_COMPLEXSKILLAIALLTEAMMEMBERCOMBINE_METHOD_3_F63E7DDC6362BC08_OFFSET UNITYSDK_OFFSET(0x169BABD0)
#define RPG_GAMECORE_COMPLEXSKILLAIALLTEAMMEMBERCOMBINE__CTOR_OFFSET UNITYSDK_OFFSET(0x169BABB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIAllTeamMemberCombine_TypeDefinitionIndex = 14123;
