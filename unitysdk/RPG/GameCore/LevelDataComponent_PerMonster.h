...
#define RPG_GAMECORE_LEVELDATACOMPONENT_PERMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0xA98DAF0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::LevelDataComponent_PerMonster_State SummonState; // 0x14
