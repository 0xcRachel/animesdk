...
#define RPG_GAMECORE_LEVELDATACOMPONENT_PERMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0xA49CAF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelDataComponent_PerMonster_TypeDefinitionIndex = 45349;
