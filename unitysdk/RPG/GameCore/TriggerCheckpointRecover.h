...
#define RPG_GAMECORE_TRIGGERCHECKPOINTRECOVER_METHOD_3_81A2C82E3FF7A4FD_OFFSET UNITYSDK_OFFSET(0x17118C80)
#define RPG_GAMECORE_TRIGGERCHECKPOINTRECOVER_METHOD_3_E19C345F5CA8B28C_OFFSET UNITYSDK_OFFSET(0x17118C00)
#define RPG_GAMECORE_TRIGGERCHECKPOINTRECOVER__CTOR_OFFSET UNITYSDK_OFFSET(0x17118C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerCheckpointRecover_TypeDefinitionIndex = 18234;
