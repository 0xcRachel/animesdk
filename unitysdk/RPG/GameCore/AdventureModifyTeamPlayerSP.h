...
#define RPG_GAMECORE_ADVENTUREMODIFYTEAMPLAYERSP_METHOD_3_01D56E4FDA8882A6_OFFSET UNITYSDK_OFFSET(0x1685CD00)
#define RPG_GAMECORE_ADVENTUREMODIFYTEAMPLAYERSP_METHOD_3_4B7084AA398A4D00_OFFSET UNITYSDK_OFFSET(0x1685CD90)
#define RPG_GAMECORE_ADVENTUREMODIFYTEAMPLAYERSP__CTOR_OFFSET UNITYSDK_OFFSET(0x1685CD60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureModifyTeamPlayerSP_TypeDefinitionIndex = 17945;
