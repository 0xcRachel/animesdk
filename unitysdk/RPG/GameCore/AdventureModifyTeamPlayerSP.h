...
#define RPG_GAMECORE_ADVENTUREMODIFYTEAMPLAYERSP_METHOD_3_01D56E4FDA8882A6_OFFSET UNITYSDK_OFFSET(0x18C70C00)
#define RPG_GAMECORE_ADVENTUREMODIFYTEAMPLAYERSP_METHOD_3_4B7084AA398A4D00_OFFSET UNITYSDK_OFFSET(0x18C70C90)
#define RPG_GAMECORE_ADVENTUREMODIFYTEAMPLAYERSP__CTOR_OFFSET UNITYSDK_OFFSET(0x18C70C60)
