...
#define RPG_GAMECORE_LEAVERAID_METHOD_3_80B023C55B789638_OFFSET UNITYSDK_OFFSET(0x188AAA40)
#define RPG_GAMECORE_LEAVERAID_METHOD_3_F68A15C082FE5DAC_OFFSET UNITYSDK_OFFSET(0x188AA930)
#define RPG_GAMECORE_LEAVERAID__CTOR_OFFSET UNITYSDK_OFFSET(0x188AAA10)
