...
#define RPG_GAMECORE_TRAINPARTYCARDSPECIALSHOWCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19493A10)
#define RPG_GAMECORE_TRAINPARTYCARDSPECIALSHOWCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19493CF0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID OverWriteTips; // 0x20
		::System::UInt32 PreShowGridNum; // 0x30
