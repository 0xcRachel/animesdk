...
#define RPG_GAMECORE_ST_SIDE_FIRESTIMULUS_METHOD_4_5D669E80881B7CAD_OFFSET UNITYSDK_OFFSET(0x192DA0A0)
#define RPG_GAMECORE_ST_SIDE_FIRESTIMULUS_METHOD_4_A34EEC92A7BBDFCA_OFFSET UNITYSDK_OFFSET(0x192D9FD0)
#define RPG_GAMECORE_ST_SIDE_FIRESTIMULUS__CTOR_OFFSET UNITYSDK_OFFSET(0x192DA050)
