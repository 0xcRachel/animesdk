...
#define RPG_GAMECORE_ST_SIDE_FIRESTIMULUS_METHOD_4_5D669E80881B7CAD_OFFSET UNITYSDK_OFFSET(0x16EE7C10)
#define RPG_GAMECORE_ST_SIDE_FIRESTIMULUS_METHOD_4_A34EEC92A7BBDFCA_OFFSET UNITYSDK_OFFSET(0x16EF7D40)
#define RPG_GAMECORE_ST_SIDE_FIRESTIMULUS__CTOR_OFFSET UNITYSDK_OFFSET(0x16EE7BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_FireStimulus_TypeDefinitionIndex = 17909;
