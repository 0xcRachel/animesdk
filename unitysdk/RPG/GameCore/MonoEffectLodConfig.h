...
#define RPG_GAMECORE_MONOEFFECTLODCONFIG_METHOD_2_530496350C1F94D0_OFFSET UNITYSDK_OFFSET(0x19087320)
#define RPG_GAMECORE_MONOEFFECTLODCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19087430)
