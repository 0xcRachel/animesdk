...
#define RPG_GAMECORE_FIVEDIMTRAINENERGYGEAR_METHOD_2_E6126DFFB01380BA_OFFSET UNITYSDK_OFFSET(0x16AD8CD0)
#define RPG_GAMECORE_FIVEDIMTRAINENERGYGEAR__CTOR_OFFSET UNITYSDK_OFFSET(0x16AD8E50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimTrainEnergyGear_TypeDefinitionIndex = 19151;
