...
#define RPG_GAMECORE_FIVEDIMTRAINENERGYGEAR_METHOD_2_35B00151930399CE_OFFSET UNITYSDK_OFFSET(0x172247D0)
#define RPG_GAMECORE_FIVEDIMTRAINENERGYGEAR__CTOR_OFFSET UNITYSDK_OFFSET(0x17224930)
