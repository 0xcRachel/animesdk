...
#define RPG_GAMECORE_TARGETFETCHPROPFARMELEMENT_METHOD_4_6DDCAC794C8DEC47_OFFSET UNITYSDK_OFFSET(0x1AC44B30)
#define RPG_GAMECORE_TARGETFETCHPROPFARMELEMENT_METHOD_4_85D3CC3AE5A62EE9_OFFSET UNITYSDK_OFFSET(0x1AC57700)
#define RPG_GAMECORE_TARGETFETCHPROPFARMELEMENT_METHOD_4_921AEF3DBA42C697_OFFSET UNITYSDK_OFFSET(0x1AC577C0)
#define RPG_GAMECORE_TARGETFETCHPROPFARMELEMENT_METHOD_4_C700C7E6E2C50AA7_OFFSET UNITYSDK_OFFSET(0x1AC4FDE0)
#define RPG_GAMECORE_TARGETFETCHPROPFARMELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC44AE0)
