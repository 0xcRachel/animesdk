...
#define RPG_GAMECORE_TARGETFETCHPROPFARMELEMENT_METHOD_4_6DDCAC794C8DEC47_OFFSET UNITYSDK_OFFSET(0x16FD9710)
#define RPG_GAMECORE_TARGETFETCHPROPFARMELEMENT_METHOD_4_85D3CC3AE5A62EE9_OFFSET UNITYSDK_OFFSET(0x16FDEB80)
#define RPG_GAMECORE_TARGETFETCHPROPFARMELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD96C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchPropFarmElement_TypeDefinitionIndex = 21638;
