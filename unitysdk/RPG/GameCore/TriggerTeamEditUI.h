...
#define RPG_GAMECORE_TRIGGERTEAMEDITUI_METHOD_3_8EBD310A5D007514_OFFSET UNITYSDK_OFFSET(0x17127920)
#define RPG_GAMECORE_TRIGGERTEAMEDITUI_METHOD_3_C09E1CA193542060_OFFSET UNITYSDK_OFFSET(0x17127A30)
#define RPG_GAMECORE_TRIGGERTEAMEDITUI__CTOR_OFFSET UNITYSDK_OFFSET(0x17127A00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerTeamEditUI_TypeDefinitionIndex = 18192;
