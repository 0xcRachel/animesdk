...
#define RPG_GAMECORE_TRIGGERTEAMEDITUI_METHOD_3_8EBD310A5D007514_OFFSET UNITYSDK_OFFSET(0x1911FA80)
#define RPG_GAMECORE_TRIGGERTEAMEDITUI_METHOD_3_C09E1CA193542060_OFFSET UNITYSDK_OFFSET(0x1911FB90)
#define RPG_GAMECORE_TRIGGERTEAMEDITUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1911FB60)
