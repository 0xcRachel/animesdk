...
#define RPG_GAMECORE_RELEASEENVPROFILEFORSTORY_METHOD_3_4240564C8455DD72_OFFSET UNITYSDK_OFFSET(0x16DD2290)
#define RPG_GAMECORE_RELEASEENVPROFILEFORSTORY_METHOD_3_CF5AD398A5D10406_OFFSET UNITYSDK_OFFSET(0x16DD2180)
#define RPG_GAMECORE_RELEASEENVPROFILEFORSTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x16DD2260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ReleaseEnvProfileForStory_TypeDefinitionIndex = 19544;
