...
#define RPG_GAMECORE_RELEASEENVPROFILEFORSTORY_METHOD_3_4240564C8455DD72_OFFSET UNITYSDK_OFFSET(0x1759F400)
#define RPG_GAMECORE_RELEASEENVPROFILEFORSTORY_METHOD_3_CF5AD398A5D10406_OFFSET UNITYSDK_OFFSET(0x1759F2F0)
#define RPG_GAMECORE_RELEASEENVPROFILEFORSTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x1759F3D0)
