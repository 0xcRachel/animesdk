...
#define RPG_GAMECORE_FIVEDIMMOVEBAKEDCONFIG_METHOD_3_1D6E7A1F43E0C87F_OFFSET UNITYSDK_OFFSET(0x17210420)
#define RPG_GAMECORE_FIVEDIMMOVEBAKEDCONFIG_METHOD_3_DFF52552B2F4C49A_OFFSET UNITYSDK_OFFSET(0x17210460)
#define RPG_GAMECORE_FIVEDIMMOVEBAKEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17210450)
