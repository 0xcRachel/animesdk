...
#define RPG_GAMECORE_BYDIEANIMFINISHED_METHOD_4_3191370E60E5DC44_OFFSET UNITYSDK_OFFSET(0x16923880)
#define RPG_GAMECORE_BYDIEANIMFINISHED_METHOD_4_F8477A5EBA8DB554_OFFSET UNITYSDK_OFFSET(0x16923960)
#define RPG_GAMECORE_BYDIEANIMFINISHED__CTOR_OFFSET UNITYSDK_OFFSET(0x16923900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByDieAnimFinished_TypeDefinitionIndex = 20984;
