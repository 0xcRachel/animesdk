...
#define RPG_GAMECORE_GRIDFIGHTCRAFTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B1E2C0)
#define RPG_GAMECORE_GRIDFIGHTCRAFTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B1E470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightCraftConfigRow_TypeDefinitionIndex = 12226;

	class GridFightCraftConfigRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* CostEquipList; // 0x10
		::System::UInt32 CraftEquipID; // 0x18
