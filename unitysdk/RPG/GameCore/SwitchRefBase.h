...
#define RPG_GAMECORE_SWITCHREFBASE_METHOD_2_38696A2313BF856F_OFFSET UNITYSDK_OFFSET(0x19862560)
#define RPG_GAMECORE_SWITCHREFBASE_METHOD_2_5904CD377781D222_OFFSET UNITYSDK_OFFSET(0x198613C0)
#define RPG_GAMECORE_SWITCHREFBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x198625C0)
