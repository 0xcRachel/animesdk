...
#define RPG_GAMECORE_SHOWHINTEFFECT_METHOD_3_3E78CC0100E78024_OFFSET UNITYSDK_OFFSET(0x16F5DFD0)
#define RPG_GAMECORE_SHOWHINTEFFECT_METHOD_3_60CE1FFB04ECEFC9_OFFSET UNITYSDK_OFFSET(0x16F5DF50)
#define RPG_GAMECORE_SHOWHINTEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F5DFA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowHintEffect_TypeDefinitionIndex = 18353;
