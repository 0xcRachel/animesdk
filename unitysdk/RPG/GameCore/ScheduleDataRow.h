...
#define RPG_GAMECORE_SCHEDULEDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16EFAC30)
#define RPG_GAMECORE_SCHEDULEDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16EFAD80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ScheduleDataRow_TypeDefinitionIndex = 13712;
