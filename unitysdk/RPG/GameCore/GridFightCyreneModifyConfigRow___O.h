...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::ModifyCalcOpType>**)Il2CppClass::FromTypeDefinitionIndex(GridFightCyreneModifyConfigRow___O_TypeDefinitionIndex)->GetStaticField(0x45C90);
		}
	};
}
