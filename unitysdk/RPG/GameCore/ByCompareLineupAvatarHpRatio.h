...
#define RPG_GAMECORE_BYCOMPARELINEUPAVATARHPRATIO_METHOD_4_AEB756966A409C43_OFFSET UNITYSDK_OFFSET(0x19AC8310)
#define RPG_GAMECORE_BYCOMPARELINEUPAVATARHPRATIO_METHOD_4_F73344DDC5E03EB5_OFFSET UNITYSDK_OFFSET(0x19AC8230)
#define RPG_GAMECORE_BYCOMPARELINEUPAVATARHPRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x19AC82B0)
