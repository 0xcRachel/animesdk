...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCERETARGET_METHOD_3_D75DB2ED5030EDF5_OFFSET UNITYSDK_OFFSET(0x1713C3C0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCERETARGET_METHOD_3_FD541A8F3F7D1424_OFFSET UNITYSDK_OFFSET(0x1713D8B0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCERETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1713C3A0)
