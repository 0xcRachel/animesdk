...
#define RPG_GAMECORE_PROPPREDICATEWITHENTITY_METHOD_4_63C942FC0A67226C_OFFSET UNITYSDK_OFFSET(0x16D9A940)
#define RPG_GAMECORE_PROPPREDICATEWITHENTITY_METHOD_4_E9E6315FF8E6FE74_OFFSET UNITYSDK_OFFSET(0x16DAF8A0)
#define RPG_GAMECORE_PROPPREDICATEWITHENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x16D9A880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropPredicateWithEntity_TypeDefinitionIndex = 19666;
