...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKDAMAGE_METHOD_3_6B63F2AEB0090AFF_OFFSET UNITYSDK_OFFSET(0x1717FA30)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKDAMAGE_METHOD_3_B16AA230074706F9_OFFSET UNITYSDK_OFFSET(0x171843D0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1717F9E0)
