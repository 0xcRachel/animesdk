...
#define RPG_GAMECORE_ADVBYHASMOVESINCELASTTELEPORT_METHOD_4_471BDE745F62F8B6_OFFSET UNITYSDK_OFFSET(0x18DBCB90)
#define RPG_GAMECORE_ADVBYHASMOVESINCELASTTELEPORT_METHOD_4_6E12FEA48378C488_OFFSET UNITYSDK_OFFSET(0x18DBCAC0)
#define RPG_GAMECORE_ADVBYHASMOVESINCELASTTELEPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x18DBCB40)
