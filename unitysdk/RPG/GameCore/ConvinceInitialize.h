...
#define RPG_GAMECORE_CONVINCEINITIALIZE_METHOD_3_04E492E1A894BE44_OFFSET UNITYSDK_OFFSET(0x169CEFA0)
#define RPG_GAMECORE_CONVINCEINITIALIZE_METHOD_3_67245169F4C63460_OFFSET UNITYSDK_OFFSET(0x169CF0A0)
#define RPG_GAMECORE_CONVINCEINITIALIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x169CF030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConvinceInitialize_TypeDefinitionIndex = 19472;
