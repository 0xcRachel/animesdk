...
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_SEQ_METHOD_3_5D5F5F957096167B_OFFSET UNITYSDK_OFFSET(0x16A354C0)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_SEQ_METHOD_3_FE3E876D4047745A_OFFSET UNITYSDK_OFFSET(0x16A35D50)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_SEQ__CTOR_OFFSET UNITYSDK_OFFSET(0x16A354B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatDiceSelectorConfig_Seq_TypeDefinitionIndex = 14570;
