...
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_SEQ_METHOD_3_5D5F5F957096167B_OFFSET UNITYSDK_OFFSET(0x17174250)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_SEQ_METHOD_3_FE3E876D4047745A_OFFSET UNITYSDK_OFFSET(0x17174C00)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_SEQ__CTOR_OFFSET UNITYSDK_OFFSET(0x17174240)
