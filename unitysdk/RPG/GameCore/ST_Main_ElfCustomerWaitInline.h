...
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERWAITINLINE_METHOD_4_A1AF32191CE601D5_OFFSET UNITYSDK_OFFSET(0x176974F0)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERWAITINLINE_METHOD_4_CBE6029EECA5462A_OFFSET UNITYSDK_OFFSET(0x176AAF50)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERWAITINLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x176974A0)
