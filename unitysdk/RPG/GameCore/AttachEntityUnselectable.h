...
#define RPG_GAMECORE_ATTACHENTITYUNSELECTABLE_METHOD_3_62FEA316AD55118E_OFFSET UNITYSDK_OFFSET(0x18ADFBF0)
#define RPG_GAMECORE_ATTACHENTITYUNSELECTABLE_METHOD_3_EDEB6BCDC10052BA_OFFSET UNITYSDK_OFFSET(0x18ADFD00)
#define RPG_GAMECORE_ATTACHENTITYUNSELECTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18ADFCD0)
