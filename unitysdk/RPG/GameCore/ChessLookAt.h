...
#define RPG_GAMECORE_CHESSLOOKAT_METHOD_3_1DEFC4A5A575159B_OFFSET UNITYSDK_OFFSET(0x1697E670)
#define RPG_GAMECORE_CHESSLOOKAT_METHOD_3_2E56DB8AFFE25204_OFFSET UNITYSDK_OFFSET(0x1697E740)
#define RPG_GAMECORE_CHESSLOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1697E6F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChessLookAt_TypeDefinitionIndex = 21422;
