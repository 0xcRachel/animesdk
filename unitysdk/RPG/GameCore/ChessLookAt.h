...
#define RPG_GAMECORE_CHESSLOOKAT_METHOD_3_1DEFC4A5A575159B_OFFSET UNITYSDK_OFFSET(0x170A0B00)
#define RPG_GAMECORE_CHESSLOOKAT_METHOD_3_2E56DB8AFFE25204_OFFSET UNITYSDK_OFFSET(0x170A0BD0)
#define RPG_GAMECORE_CHESSLOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x170A0B80)
