...
#define RPG_GAMECORE_REVERSEPROPSTATE_METHOD_3_273F385D726C72D7_OFFSET UNITYSDK_OFFSET(0x175C1E00)
#define RPG_GAMECORE_REVERSEPROPSTATE_METHOD_3_98362A4695B35DE7_OFFSET UNITYSDK_OFFSET(0x175C1D70)
#define RPG_GAMECORE_REVERSEPROPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x175C1DD0)
