...
#define RPG_GAMECORE_LINEUPPATROLFINDSOLDIERMESSAGE_EMPTY_OFFSET UNITYSDK_OFFSET(0xA4B7DE0)
#define RPG_GAMECORE_LINEUPPATROLFINDSOLDIERMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xA4B7E20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LineupPatrolFindSoldierMessage_TypeDefinitionIndex = 41399;
