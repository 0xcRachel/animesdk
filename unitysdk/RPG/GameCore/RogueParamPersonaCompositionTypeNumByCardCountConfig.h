...
#define RPG_GAMECORE_ROGUEPARAMPERSONACOMPOSITIONTYPENUMBYCARDCOUNTCONFIG_METHOD_6_A2B5E8EEFDA54AD1_OFFSET UNITYSDK_OFFSET(0x17660320)
#define RPG_GAMECORE_ROGUEPARAMPERSONACOMPOSITIONTYPENUMBYCARDCOUNTCONFIG_METHOD_6_AEDEDD1635BEB627_OFFSET UNITYSDK_OFFSET(0x17660070)
#define RPG_GAMECORE_ROGUEPARAMPERSONACOMPOSITIONTYPENUMBYCARDCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176601F0)
