...
#define RPG_GAMECORE_OPENTRAINPARTYENTRANCEPAGE_METHOD_3_1042149A3E6F776C_OFFSET UNITYSDK_OFFSET(0x16D0B4E0)
#define RPG_GAMECORE_OPENTRAINPARTYENTRANCEPAGE_METHOD_3_B5419DC51D545160_OFFSET UNITYSDK_OFFSET(0x16D0B3D0)
#define RPG_GAMECORE_OPENTRAINPARTYENTRANCEPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16D0B4B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OpenTrainPartyEntrancePage_TypeDefinitionIndex = 20013;
