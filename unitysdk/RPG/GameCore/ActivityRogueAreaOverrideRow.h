...
#define RPG_GAMECORE_ACTIVITYROGUEAREAOVERRIDEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18DA9360)
#define RPG_GAMECORE_ACTIVITYROGUEAREAOVERRIDEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18DA9570)
