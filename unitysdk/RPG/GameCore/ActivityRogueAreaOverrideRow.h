...
#define RPG_GAMECORE_ACTIVITYROGUEAREAOVERRIDEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x167B1F10)
#define RPG_GAMECORE_ACTIVITYROGUEAREAOVERRIDEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x167B2120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityRogueAreaOverrideRow_TypeDefinitionIndex = 11196;
