...
#define RPG_GAMECORE_AVATARSKINSPECIALACTIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x168C3470)
#define RPG_GAMECORE_AVATARSKINSPECIALACTIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x168C3630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarSkinSpecialActionRow_TypeDefinitionIndex = 11531;
