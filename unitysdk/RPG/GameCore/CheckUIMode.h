...
#define RPG_GAMECORE_CHECKUIMODE_METHOD_3_3120E1E0755B3F31_OFFSET UNITYSDK_OFFSET(0x16979E80)
#define RPG_GAMECORE_CHECKUIMODE_METHOD_3_7F2F9A1FA4AD3D8E_OFFSET UNITYSDK_OFFSET(0x16979E00)
#define RPG_GAMECORE_CHECKUIMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x16979E50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CheckUIMode_TypeDefinitionIndex = 21840;
