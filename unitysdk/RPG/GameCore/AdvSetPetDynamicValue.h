...
#define RPG_GAMECORE_ADVSETPETDYNAMICVALUE_METHOD_3_3ABE7252D9116C99_OFFSET UNITYSDK_OFFSET(0x16849200)
#define RPG_GAMECORE_ADVSETPETDYNAMICVALUE_METHOD_3_5D9597096717F5E0_OFFSET UNITYSDK_OFFSET(0x16849280)
#define RPG_GAMECORE_ADVSETPETDYNAMICVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x16849250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetPetDynamicValue_TypeDefinitionIndex = 18748;
