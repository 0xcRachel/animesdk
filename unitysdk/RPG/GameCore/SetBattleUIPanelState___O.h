...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::BattleUIPanelType>**)Il2CppClass::FromTypeDefinitionIndex(SetBattleUIPanelState___O_TypeDefinitionIndex)->GetStaticField(0xBD20);
		}
	};
}
