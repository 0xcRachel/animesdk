...
#define RPG_GAMECORE_BYCOMPARESKILLUSAGELIMIT_METHOD_4_3116770F311CD2EC_OFFSET UNITYSDK_OFFSET(0x18FF0510)
#define RPG_GAMECORE_BYCOMPARESKILLUSAGELIMIT_METHOD_4_550F0B2918A6D1D2_OFFSET UNITYSDK_OFFSET(0x18FF0170)
#define RPG_GAMECORE_BYCOMPARESKILLUSAGELIMIT_METHOD_4_DEFB2FA637674097_OFFSET UNITYSDK_OFFSET(0x18FF0450)
#define RPG_GAMECORE_BYCOMPARESKILLUSAGELIMIT_METHOD_4_F593CF1124B31343_OFFSET UNITYSDK_OFFSET(0x18FF0010)
#define RPG_GAMECORE_BYCOMPARESKILLUSAGELIMIT__CTOR_OFFSET UNITYSDK_OFFSET(0x18FF00D0)
