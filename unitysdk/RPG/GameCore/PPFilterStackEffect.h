...
#define RPG_GAMECORE_PPFILTERSTACKEFFECT_METHOD_3_9B64F0A001D1D53A_OFFSET UNITYSDK_OFFSET(0x18EF8A80)
#define RPG_GAMECORE_PPFILTERSTACKEFFECT_METHOD_3_CDFBB553691295FA_OFFSET UNITYSDK_OFFSET(0x18EF89B0)
#define RPG_GAMECORE_PPFILTERSTACKEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x18EF8A30)
