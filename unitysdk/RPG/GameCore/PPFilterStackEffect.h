...
#define RPG_GAMECORE_PPFILTERSTACKEFFECT_METHOD_3_9B64F0A001D1D53A_OFFSET UNITYSDK_OFFSET(0x17499740)
#define RPG_GAMECORE_PPFILTERSTACKEFFECT_METHOD_3_CDFBB553691295FA_OFFSET UNITYSDK_OFFSET(0x17499670)
#define RPG_GAMECORE_PPFILTERSTACKEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x174996F0)
