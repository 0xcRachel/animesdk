...
#define RPG_GAMECORE_BYCHECKMECHANISMBARPHASE_METHOD_4_5D6071B6D7420D39_OFFSET UNITYSDK_OFFSET(0x169027B0)
#define RPG_GAMECORE_BYCHECKMECHANISMBARPHASE_METHOD_4_E06D468CB2D9C61F_OFFSET UNITYSDK_OFFSET(0x169026E0)
#define RPG_GAMECORE_BYCHECKMECHANISMBARPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x16902760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckMechanismBarPhase_TypeDefinitionIndex = 18307;
