...
#define RPG_GAMECORE_BYCHECKMECHANISMBARPHASE_METHOD_4_2F2E72E86913A32D_OFFSET UNITYSDK_OFFSET(0x195FA6D0)
#define RPG_GAMECORE_BYCHECKMECHANISMBARPHASE_METHOD_4_5D6071B6D7420D39_OFFSET UNITYSDK_OFFSET(0x195FA4A0)
#define RPG_GAMECORE_BYCHECKMECHANISMBARPHASE_METHOD_4_72E8150CBAF48F49_OFFSET UNITYSDK_OFFSET(0x195FA650)
#define RPG_GAMECORE_BYCHECKMECHANISMBARPHASE_METHOD_4_E06D468CB2D9C61F_OFFSET UNITYSDK_OFFSET(0x195FA3D0)
#define RPG_GAMECORE_BYCHECKMECHANISMBARPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x195FA450)
