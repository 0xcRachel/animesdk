...
#define RPG_GAMECORE_TRACEHEARTDIALNPC_METHOD_3_8A9C487207F5FAEC_OFFSET UNITYSDK_OFFSET(0x1948C200)
#define RPG_GAMECORE_TRACEHEARTDIALNPC_METHOD_3_9630BFAE6A3C553B_OFFSET UNITYSDK_OFFSET(0x1948C280)
#define RPG_GAMECORE_TRACEHEARTDIALNPC__CTOR_OFFSET UNITYSDK_OFFSET(0x1948C250)
