...
#define RPG_GAMECORE_TRACEHEARTDIALNPC_METHOD_3_8A9C487207F5FAEC_OFFSET UNITYSDK_OFFSET(0x178B6E60)
#define RPG_GAMECORE_TRACEHEARTDIALNPC_METHOD_3_9630BFAE6A3C553B_OFFSET UNITYSDK_OFFSET(0x178A0490)
#define RPG_GAMECORE_TRACEHEARTDIALNPC__CTOR_OFFSET UNITYSDK_OFFSET(0x178A0460)
