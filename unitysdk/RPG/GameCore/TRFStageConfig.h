...
#define RPG_GAMECORE_TRFSTAGECONFIG_METHOD_2_DC38EBA036521C1F_OFFSET UNITYSDK_OFFSET(0x16FC7050)
#define RPG_GAMECORE_TRFSTAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16FC7190)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TRFStageConfig_TypeDefinitionIndex = 16935;
