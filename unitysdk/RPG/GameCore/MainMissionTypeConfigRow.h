...
#define RPG_GAMECORE_MAINMISSIONTYPECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1738B130)
#define RPG_GAMECORE_MAINMISSIONTYPECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1738BAA0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* TypeColor; // 0x30
		::System::UInt32 WaypointIconType; // 0x38
		::RPG::GameCore::MainMissionType Type; // 0x3C
		::System::UInt32 IconMapToTake; // 0x40
		::System::Boolean IsShowRedDot; // 0x44
		::System::Boolean IsDelete; // 0x45
		::RPG::Client::TextID TypeName; // 0x48
		::System::UInt32 IconMapOptional; // 0x58
		::System::UInt32 IconMapStarted; // 0x5C
