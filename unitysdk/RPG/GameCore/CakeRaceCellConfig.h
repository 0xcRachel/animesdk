...
#define RPG_GAMECORE_CAKERACECELLCONFIG_METHOD_2_6DFCAE526C6A7F2A_OFFSET UNITYSDK_OFFSET(0x1705E970)
#define RPG_GAMECORE_CAKERACECELLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1705EC70)
