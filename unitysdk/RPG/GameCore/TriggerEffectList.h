...
#define RPG_GAMECORE_TRIGGEREFFECTLIST_METHOD_3_1F5179B55B236E33_OFFSET UNITYSDK_OFFSET(0x1711E140)
#define RPG_GAMECORE_TRIGGEREFFECTLIST_METHOD_3_ABDC0589660D8BCB_OFFSET UNITYSDK_OFFSET(0x1711E300)
#define RPG_GAMECORE_TRIGGEREFFECTLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1711E2D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerEffectList_TypeDefinitionIndex = 18045;
