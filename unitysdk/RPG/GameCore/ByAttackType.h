...
#define RPG_GAMECORE_BYATTACKTYPE_METHOD_4_344FF3DD27B137BD_OFFSET UNITYSDK_OFFSET(0x195F2060)
#define RPG_GAMECORE_BYATTACKTYPE_METHOD_4_9878A107922B50BA_OFFSET UNITYSDK_OFFSET(0x195F2100)
#define RPG_GAMECORE_BYATTACKTYPE_METHOD_4_BBDCB21837290D52_OFFSET UNITYSDK_OFFSET(0x195F1D70)
#define RPG_GAMECORE_BYATTACKTYPE_METHOD_4_FB6181DFE4F159C1_OFFSET UNITYSDK_OFFSET(0x195F1E90)
#define RPG_GAMECORE_BYATTACKTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x195F1E10)
