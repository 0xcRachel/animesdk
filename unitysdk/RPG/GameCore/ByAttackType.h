...
#define RPG_GAMECORE_BYATTACKTYPE_METHOD_4_BBDCB21837290D52_OFFSET UNITYSDK_OFFSET(0x168FE710)
#define RPG_GAMECORE_BYATTACKTYPE_METHOD_4_FB6181DFE4F159C1_OFFSET UNITYSDK_OFFSET(0x168FE830)
#define RPG_GAMECORE_BYATTACKTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x168FE7B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByAttackType_TypeDefinitionIndex = 21180;
