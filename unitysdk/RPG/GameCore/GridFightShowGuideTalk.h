...
#define RPG_GAMECORE_GRIDFIGHTSHOWGUIDETALK_METHOD_3_94BF918AC025CEB4_OFFSET UNITYSDK_OFFSET(0x17297C40)
#define RPG_GAMECORE_GRIDFIGHTSHOWGUIDETALK_METHOD_3_FDB9E6D07E118B25_OFFSET UNITYSDK_OFFSET(0x17297CC0)
#define RPG_GAMECORE_GRIDFIGHTSHOWGUIDETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x17297C90)
