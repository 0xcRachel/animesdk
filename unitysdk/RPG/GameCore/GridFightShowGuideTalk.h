...
#define RPG_GAMECORE_GRIDFIGHTSHOWGUIDETALK_METHOD_3_94BF918AC025CEB4_OFFSET UNITYSDK_OFFSET(0x16B49540)
#define RPG_GAMECORE_GRIDFIGHTSHOWGUIDETALK_METHOD_3_FDB9E6D07E118B25_OFFSET UNITYSDK_OFFSET(0x16B495C0)
#define RPG_GAMECORE_GRIDFIGHTSHOWGUIDETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x16B49590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightShowGuideTalk_TypeDefinitionIndex = 17727;
