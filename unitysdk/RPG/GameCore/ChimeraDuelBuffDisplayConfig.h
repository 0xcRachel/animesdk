...
#define RPG_GAMECORE_CHIMERADUELBUFFDISPLAYCONFIG_METHOD_2_E00313D7CA8F819A_OFFSET UNITYSDK_OFFSET(0x16988F70)
#define RPG_GAMECORE_CHIMERADUELBUFFDISPLAYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x169891B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelBuffDisplayConfig_TypeDefinitionIndex = 14448;
