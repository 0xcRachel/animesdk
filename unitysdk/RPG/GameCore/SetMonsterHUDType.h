...
#define RPG_GAMECORE_SETMONSTERHUDTYPE_METHOD_3_413959577DD5D5AB_OFFSET UNITYSDK_OFFSET(0x16F36840)
#define RPG_GAMECORE_SETMONSTERHUDTYPE_METHOD_3_AB4C3F23F74160D8_OFFSET UNITYSDK_OFFSET(0x16F368C0)
#define RPG_GAMECORE_SETMONSTERHUDTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F36890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMonsterHUDType_TypeDefinitionIndex = 20412;
