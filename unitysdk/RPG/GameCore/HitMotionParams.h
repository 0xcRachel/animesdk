...
#define RPG_GAMECORE_HITMOTIONPARAMS_METHOD_2_608F85D17A394CFB_OFFSET UNITYSDK_OFFSET(0x16B77620)
#define RPG_GAMECORE_HITMOTIONPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x16B77850)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HitMotionParams_TypeDefinitionIndex = 20227;
