...
#define RPG_GAMECORE_CLEARTUTORIALGUIDE_METHOD_3_3D427BFBCDCD1FA3_OFFSET UNITYSDK_OFFSET(0x169A5E60)
#define RPG_GAMECORE_CLEARTUTORIALGUIDE_METHOD_3_80014F6E1815099A_OFFSET UNITYSDK_OFFSET(0x169A5DE0)
#define RPG_GAMECORE_CLEARTUTORIALGUIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x169A5E30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearTutorialGuide_TypeDefinitionIndex = 21828;
