...
#define RPG_GAMECORE_CLEARTUTORIALGUIDE_METHOD_3_3D427BFBCDCD1FA3_OFFSET UNITYSDK_OFFSET(0x194D5AC0)
#define RPG_GAMECORE_CLEARTUTORIALGUIDE_METHOD_3_80014F6E1815099A_OFFSET UNITYSDK_OFFSET(0x194D5A40)
#define RPG_GAMECORE_CLEARTUTORIALGUIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x194D5A90)
