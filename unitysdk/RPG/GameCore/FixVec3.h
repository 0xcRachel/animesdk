...
#define RPG_GAMECORE_FIXVEC3_ANGLEBETWEEN_OFFSET UNITYSDK_OFFSET(0x17238F70)
#define RPG_GAMECORE_FIXVEC3_ANGLE_OFFSET UNITYSDK_OFFSET(0x172367C0)
#define RPG_GAMECORE_FIXVEC3_CLAMPMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x17237B10)
#define RPG_GAMECORE_FIXVEC3_CROSS_OFFSET UNITYSDK_OFFSET(0x172348C0)
#define RPG_GAMECORE_FIXVEC3_DISTANCE_OFFSET UNITYSDK_OFFSET(0x17237910)
#define RPG_GAMECORE_FIXVEC3_DOT_OFFSET UNITYSDK_OFFSET(0x17235C10)
#define RPG_GAMECORE_FIXVEC3_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x201C190)
#define RPG_GAMECORE_FIXVEC3_EQUALS_OFFSET UNITYSDK_OFFSET(0x201C150)
#define RPG_GAMECORE_FIXVEC3_EXCLUDE_OFFSET UNITYSDK_OFFSET(0x172390E0)
#define RPG_GAMECORE_FIXVEC3_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x201C110)
#define RPG_GAMECORE_FIXVEC3_GET_BACK_OFFSET UNITYSDK_OFFSET(0x172385C0)
#define RPG_GAMECORE_FIXVEC3_GET_DOWN_OFFSET UNITYSDK_OFFSET(0x17238600)
#define RPG_GAMECORE_FIXVEC3_GET_FORWARD_OFFSET UNITYSDK_OFFSET(0x172385A0)
#define RPG_GAMECORE_FIXVEC3_GET_FWD_OFFSET UNITYSDK_OFFSET(0x17238F50)
#define RPG_GAMECORE_FIXVEC3_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x201BD30)
#define RPG_GAMECORE_FIXVEC3_GET_LEFT_OFFSET UNITYSDK_OFFSET(0x17238620)
#define RPG_GAMECORE_FIXVEC3_GET_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x201C300)
#define RPG_GAMECORE_FIXVEC3_GET_NORMALIZED_OFFSET UNITYSDK_OFFSET(0x201C260)
#define RPG_GAMECORE_FIXVEC3_GET_ONE_OFFSET UNITYSDK_OFFSET(0x17238580)
#define RPG_GAMECORE_FIXVEC3_GET_RIGHT_OFFSET UNITYSDK_OFFSET(0x17238640)
#define RPG_GAMECORE_FIXVEC3_GET_SQRMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x201C480)
#define RPG_GAMECORE_FIXVEC3_GET_UP_OFFSET UNITYSDK_OFFSET(0x172385E0)
#define RPG_GAMECORE_FIXVEC3_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x17238560)
#define RPG_GAMECORE_FIXVEC3_LERPUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x172336E0)
#define RPG_GAMECORE_FIXVEC3_LERP_OFFSET UNITYSDK_OFFSET(0x17233260)
#define RPG_GAMECORE_FIXVEC3_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x17237EE0)
#define RPG_GAMECORE_FIXVEC3_MAX_OFFSET UNITYSDK_OFFSET(0x17238520)
#define RPG_GAMECORE_FIXVEC3_MIN_OFFSET UNITYSDK_OFFSET(0x172384E0)
#define RPG_GAMECORE_FIXVEC3_MOVETOWARDS_OFFSET UNITYSDK_OFFSET(0x17233B00)
#define RPG_GAMECORE_FIXVEC3_NORMALIZE_1_OFFSET UNITYSDK_OFFSET(0x201C1C0)
#define RPG_GAMECORE_FIXVEC3_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x172358B0)
#define RPG_GAMECORE_FIXVEC3_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x17238660)
#define RPG_GAMECORE_FIXVEC3_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x17238DE0)
#define RPG_GAMECORE_FIXVEC3_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x17238E40)
#define RPG_GAMECORE_FIXVEC3_OP_EXPLICIT_1_OFFSET UNITYSDK_OFFSET(0x17239650)
#define RPG_GAMECORE_FIXVEC3_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x172395D0)
#define RPG_GAMECORE_FIXVEC3_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x17239610)
#define RPG_GAMECORE_FIXVEC3_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x17239590)
#define RPG_GAMECORE_FIXVEC3_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x17238E70)
#define RPG_GAMECORE_FIXVEC3_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x17238B00)
#define RPG_GAMECORE_FIXVEC3_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x17238820)
#define RPG_GAMECORE_FIXVEC3_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x17238720)
#define RPG_GAMECORE_FIXVEC3_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x172387C0)
#define RPG_GAMECORE_FIXVEC3_PROJECTONPLANE_OFFSET UNITYSDK_OFFSET(0x17236310)
#define RPG_GAMECORE_FIXVEC3_PROJECT_OFFSET UNITYSDK_OFFSET(0x17235F20)
#define RPG_GAMECORE_FIXVEC3_REFLECT_OFFSET UNITYSDK_OFFSET(0x17235090)
#define RPG_GAMECORE_FIXVEC3_SCALE_1_OFFSET UNITYSDK_OFFSET(0x201BE60)
#define RPG_GAMECORE_FIXVEC3_SCALE_OFFSET UNITYSDK_OFFSET(0x17234340)
#define RPG_GAMECORE_FIXVEC3_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x201BDB0)
#define RPG_GAMECORE_FIXVEC3_SET_OFFSET UNITYSDK_OFFSET(0x294A0)
#define RPG_GAMECORE_FIXVEC3_SIGNEDANGLE_OFFSET UNITYSDK_OFFSET(0x17236BD0)
#define RPG_GAMECORE_FIXVEC3_SQRMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x172381E0)
#define RPG_GAMECORE_FIXVEC3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x201C490)
#define RPG_GAMECORE_FIXVEC3__CCTOR_OFFSET UNITYSDK_OFFSET(0x17239690)
#define RPG_GAMECORE_FIXVEC3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x201BE40)
#define RPG_GAMECORE_FIXVEC3__CTOR_OFFSET UNITYSDK_OFFSET(0x294A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FixVec3_TypeDefinitionIndex = 8830;

	struct alignas(8) FixVec3
	{
		static ::RPG::GameCore::FixVec3* StaticGet_leftVector()
		{
			return (::RPG::GameCore::FixVec3*)Il2CppClass::FromTypeDefinitionIndex(FixVec3_TypeDefinitionIndex)->GetStaticField(0x6260);
		}
		static ::RPG::GameCore::FixPoint* StaticGet_EpsilonNormalSqrt()
		{
			return (::RPG::GameCore::FixPoint*)Il2CppClass::FromTypeDefinitionIndex(FixVec3_TypeDefinitionIndex)->GetStaticField(0x6278);
		}
		static ::RPG::GameCore::FixVec3* StaticGet_zeroVector()
		{
			return (::RPG::GameCore::FixVec3*)Il2CppClass::FromTypeDefinitionIndex(FixVec3_TypeDefinitionIndex)->GetStaticField(0x6280);
		}
		static ::RPG::GameCore::FixVec3* StaticGet_oneVector()
		{
			return (::RPG::GameCore::FixVec3*)Il2CppClass::FromTypeDefinitionIndex(FixVec3_TypeDefinitionIndex)->GetStaticField(0x6298);
		}
		static ::RPG::GameCore::FixVec3* StaticGet_downVector()
		{
			return (::RPG::GameCore::FixVec3*)Il2CppClass::FromTypeDefinitionIndex(FixVec3_TypeDefinitionIndex)->GetStaticField(0x62B0);
		}
		static ::RPG::GameCore::FixVec3* StaticGet_backVector()
		{
			return (::RPG::GameCore::FixVec3*)Il2CppClass::FromTypeDefinitionIndex(FixVec3_TypeDefinitionIndex)->GetStaticField(0x62C8);
		}
		static ::RPG::GameCore::FixVec3* StaticGet_upVector()
		{
			return (::RPG::GameCore::FixVec3*)Il2CppClass::FromTypeDefinitionIndex(FixVec3_TypeDefinitionIndex)->GetStaticField(0x62E0);
		}
		static ::RPG::GameCore::FixVec3* StaticGet_forwardVector()
		{
			return (::RPG::GameCore::FixVec3*)Il2CppClass::FromTypeDefinitionIndex(FixVec3_TypeDefinitionIndex)->GetStaticField(0x62F8);
		}
		static ::RPG::GameCore::FixVec3* StaticGet_rightVector()
		{
			return (::RPG::GameCore::FixVec3*)Il2CppClass::FromTypeDefinitionIndex(FixVec3_TypeDefinitionIndex)->GetStaticField(0x6310);
		}
