...
#define RPG_GAMECORE_BYHAVEABILITYTARGET_METHOD_4_95ED2DCA5EFC5D49_OFFSET UNITYSDK_OFFSET(0x16929050)
#define RPG_GAMECORE_BYHAVEABILITYTARGET_METHOD_4_C531167F2342AD43_OFFSET UNITYSDK_OFFSET(0x16928F80)
#define RPG_GAMECORE_BYHAVEABILITYTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x16929000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHaveAbilityTarget_TypeDefinitionIndex = 18017;
