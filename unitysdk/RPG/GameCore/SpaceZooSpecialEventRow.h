...
#define RPG_GAMECORE_SPACEZOOSPECIALEVENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x185F9030)
#define RPG_GAMECORE_SPACEZOOSPECIALEVENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x185F9290)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::UInt32 SpecialCatID; // 0x10
		::RPG::GameCore::SpaceZooSpicalEventState EventState; // 0x14
		::RPG::GameCore::SpaceZooMaskType ProgenitorIsMask; // 0x18
