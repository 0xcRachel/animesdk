...
#define RPG_GAMECORE_ROGUEMAGICGAMBLEGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16E86EC0)
#define RPG_GAMECORE_ROGUEMAGICGAMBLEGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16E87090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMagicGambleGroupRow_TypeDefinitionIndex = 13543;
