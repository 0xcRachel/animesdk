...
#define RPG_GAMECORE_ADVLERPGATHEREDSPEEDTOZERO_METHOD_3_73D9BACFE1F9D9AA_OFFSET UNITYSDK_OFFSET(0x16839560)
#define RPG_GAMECORE_ADVLERPGATHEREDSPEEDTOZERO_METHOD_3_9F1BD3D5C875F8FD_OFFSET UNITYSDK_OFFSET(0x168394E0)
#define RPG_GAMECORE_ADVLERPGATHEREDSPEEDTOZERO__CTOR_OFFSET UNITYSDK_OFFSET(0x16839530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvLerpGatheredSpeedToZero_TypeDefinitionIndex = 18803;
