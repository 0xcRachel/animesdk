...
#define RPG_GAMECORE_RELICCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1901C710)
#define RPG_GAMECORE_RELICCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1901D870)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::RelicType Type; // 0x18
