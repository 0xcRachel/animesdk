...
#define RPG_GAMECORE_RELICCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A2DB790)
#define RPG_GAMECORE_RELICCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2DC8E0)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::UInt32 MainAffixGroup; // 0x10
		::System::UInt32 ID; // 0x14
		::System::UInt32 CoinCost; // 0x18
		::RPG::GameCore::CombatPowerRelicRarityType Rarity; // 0x1C
		::System::UInt32 ExpProvide; // 0x20
		::RPG::GameCore::RelicType Type; // 0x24
