...
#define RPG_GAMECORE_RELICCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16DD4050)
#define RPG_GAMECORE_RELICCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16DD51B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RelicConfigRow_TypeDefinitionIndex = 13278;

	class RelicConfigRow : public ::System::Object
	{
	public:
		::System::UInt32 SetID; // 0x10
		::System::UInt32 ExpType; // 0x14
		::System::UInt32 ExpProvide; // 0x18
		::RPG::GameCore::RelicMode Mode; // 0x1C
		::RPG::GameCore::RelicType Type; // 0x20
		::System::UInt32 MainAffixGroup; // 0x24
		::System::UInt32 SubAffixGroup; // 0x28
		::System::UInt32 ID; // 0x2C
		::System::UInt32 CoinCost; // 0x30
		::System::UInt32 MaxLevel; // 0x34
		::RPG::GameCore::CombatPowerRelicRarityType Rarity; // 0x38
