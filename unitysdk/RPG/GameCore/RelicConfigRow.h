...
#define RPG_GAMECORE_RELICCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x175A11C0)
#define RPG_GAMECORE_RELICCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x175A2320)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 ExpType; // 0x24
		::RPG::GameCore::RelicType Type; // 0x28
