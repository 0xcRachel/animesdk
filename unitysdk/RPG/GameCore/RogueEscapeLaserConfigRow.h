...
#define RPG_GAMECORE_ROGUEESCAPELASERCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16E7D950)
#define RPG_GAMECORE_ROGUEESCAPELASERCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16E7E090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueEscapeLaserConfigRow_TypeDefinitionIndex = 13325;
	...
	public:
		...
		::System::UInt32 ScoreperWave; // 0x20
