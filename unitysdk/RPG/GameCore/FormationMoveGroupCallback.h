...
#define RPG_GAMECORE_FORMATIONMOVEGROUPCALLBACK_METHOD_3_18AF65CB4D789D0A_OFFSET UNITYSDK_OFFSET(0x1722CC10)
#define RPG_GAMECORE_FORMATIONMOVEGROUPCALLBACK_METHOD_3_EE8D7F91F3BF65A3_OFFSET UNITYSDK_OFFSET(0x1722CC90)
#define RPG_GAMECORE_FORMATIONMOVEGROUPCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1722CC60)
