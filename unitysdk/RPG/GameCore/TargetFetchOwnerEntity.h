...
#define RPG_GAMECORE_TARGETFETCHOWNERENTITY_METHOD_4_853F5B059CAEF954_OFFSET UNITYSDK_OFFSET(0x199E2300)
#define RPG_GAMECORE_TARGETFETCHOWNERENTITY_METHOD_4_95FE3DE17BFEE216_OFFSET UNITYSDK_OFFSET(0x199DBD20)
#define RPG_GAMECORE_TARGETFETCHOWNERENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x199DBCD0)
