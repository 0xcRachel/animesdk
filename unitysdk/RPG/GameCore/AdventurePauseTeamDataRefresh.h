...
#define RPG_GAMECORE_ADVENTUREPAUSETEAMDATAREFRESH_METHOD_3_41A700F1FAD9C77C_OFFSET UNITYSDK_OFFSET(0x1685D930)
#define RPG_GAMECORE_ADVENTUREPAUSETEAMDATAREFRESH_METHOD_3_535C94F4924AE60D_OFFSET UNITYSDK_OFFSET(0x1685D8A0)
#define RPG_GAMECORE_ADVENTUREPAUSETEAMDATAREFRESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1685D900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventurePauseTeamDataRefresh_TypeDefinitionIndex = 18180;
