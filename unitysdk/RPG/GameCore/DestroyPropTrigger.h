...
#define RPG_GAMECORE_DESTROYPROPTRIGGER_METHOD_3_AF52E6EEB6CAF9B6_OFFSET UNITYSDK_OFFSET(0x169ED0E0)
#define RPG_GAMECORE_DESTROYPROPTRIGGER_METHOD_3_B021FF24319142E4_OFFSET UNITYSDK_OFFSET(0x169ECF90)
#define RPG_GAMECORE_DESTROYPROPTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x169ED050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DestroyPropTrigger_TypeDefinitionIndex = 19216;
