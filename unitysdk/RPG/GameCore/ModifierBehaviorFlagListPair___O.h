...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::ModifierBehaviorFlag>**)Il2CppClass::FromTypeDefinitionIndex(ModifierBehaviorFlagListPair___O_TypeDefinitionIndex)->GetStaticField(0x46F70);
		}
	};
}
