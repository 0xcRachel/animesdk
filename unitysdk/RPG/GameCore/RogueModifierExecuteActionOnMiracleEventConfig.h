...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONMIRACLEEVENTCONFIG_METHOD_3_D6A94533DCA74590_OFFSET UNITYSDK_OFFSET(0x1998A930)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONMIRACLEEVENTCONFIG_METHOD_3_F6A0223F73AAFEE9_OFFSET UNITYSDK_OFFSET(0x19983640)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONMIRACLEEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x199835F0)
