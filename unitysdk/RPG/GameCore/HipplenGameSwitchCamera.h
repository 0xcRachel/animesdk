...
#define RPG_GAMECORE_HIPPLENGAMESWITCHCAMERA_METHOD_3_50F3D35B0ED03FC8_OFFSET UNITYSDK_OFFSET(0x172C19A0)
#define RPG_GAMECORE_HIPPLENGAMESWITCHCAMERA_METHOD_3_B042469FB748F930_OFFSET UNITYSDK_OFFSET(0x172C1A20)
#define RPG_GAMECORE_HIPPLENGAMESWITCHCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x172C19F0)
