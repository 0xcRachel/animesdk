...
#define RPG_GAMECORE_BYTURNOWNERHASACTIONINTURN_METHOD_4_2440CBBC74B1629E_OFFSET UNITYSDK_OFFSET(0x17053150)
#define RPG_GAMECORE_BYTURNOWNERHASACTIONINTURN_METHOD_4_8F70003B96B7B194_OFFSET UNITYSDK_OFFSET(0x17053080)
#define RPG_GAMECORE_BYTURNOWNERHASACTIONINTURN__CTOR_OFFSET UNITYSDK_OFFSET(0x17053100)
