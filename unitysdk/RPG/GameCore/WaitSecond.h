...
#define RPG_GAMECORE_WAITSECOND_METHOD_3_1A3F428C4F33F876_OFFSET UNITYSDK_OFFSET(0x1715C0F0)
#define RPG_GAMECORE_WAITSECOND_METHOD_3_B5AEF315722E4F96_OFFSET UNITYSDK_OFFSET(0x1715C230)
#define RPG_GAMECORE_WAITSECOND__CTOR_OFFSET UNITYSDK_OFFSET(0x1715C1A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitSecond_TypeDefinitionIndex = 21498;
