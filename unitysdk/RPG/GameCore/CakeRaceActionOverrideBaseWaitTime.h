...
#define RPG_GAMECORE_CAKERACEACTIONOVERRIDEBASEWAITTIME_METHOD_3_690B58B131793C45_OFFSET UNITYSDK_OFFSET(0x16947DD0)
#define RPG_GAMECORE_CAKERACEACTIONOVERRIDEBASEWAITTIME_METHOD_3_F23E432A1DE224A3_OFFSET UNITYSDK_OFFSET(0x169496A0)
#define RPG_GAMECORE_CAKERACEACTIONOVERRIDEBASEWAITTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x16947DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionOverrideBaseWaitTime_TypeDefinitionIndex = 16466;
