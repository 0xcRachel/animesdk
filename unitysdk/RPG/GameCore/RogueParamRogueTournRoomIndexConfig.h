...
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNROOMINDEXCONFIG_METHOD_6_5D89C8C044CFB806_OFFSET UNITYSDK_OFFSET(0x1981C310)
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNROOMINDEXCONFIG_METHOD_6_8C637B93E4E61590_OFFSET UNITYSDK_OFFSET(0x1981C5C0)
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNROOMINDEXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1981C490)
