...
#define RPG_GAMECORE_MODIFIERREATTACHEFFECT_METHOD_3_128BE72D99351558_OFFSET UNITYSDK_OFFSET(0x16CB6390)
#define RPG_GAMECORE_MODIFIERREATTACHEFFECT_METHOD_3_D8BFFCBD0AC59557_OFFSET UNITYSDK_OFFSET(0x16CB6310)
#define RPG_GAMECORE_MODIFIERREATTACHEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x16CB6360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifierReattachEffect_TypeDefinitionIndex = 19382;
