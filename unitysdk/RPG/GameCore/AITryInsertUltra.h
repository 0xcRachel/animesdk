...
#define RPG_GAMECORE_AITRYINSERTULTRA_METHOD_3_2A92F54FEFA198A7_OFFSET UNITYSDK_OFFSET(0x16772220)
#define RPG_GAMECORE_AITRYINSERTULTRA_METHOD_3_7D951C722113EBD6_OFFSET UNITYSDK_OFFSET(0x167722A0)
#define RPG_GAMECORE_AITRYINSERTULTRA__CTOR_OFFSET UNITYSDK_OFFSET(0x16772270)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AITryInsertUltra_TypeDefinitionIndex = 20487;
