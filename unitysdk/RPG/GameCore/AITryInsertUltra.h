...
#define RPG_GAMECORE_AITRYINSERTULTRA_METHOD_3_2A92F54FEFA198A7_OFFSET UNITYSDK_OFFSET(0x19881750)
#define RPG_GAMECORE_AITRYINSERTULTRA_METHOD_3_7D951C722113EBD6_OFFSET UNITYSDK_OFFSET(0x198817D0)
#define RPG_GAMECORE_AITRYINSERTULTRA__CTOR_OFFSET UNITYSDK_OFFSET(0x198817A0)
