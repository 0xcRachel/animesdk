...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKEFFECT_CUTINANIMATION_METHOD_3_00FFE251A8C16448_OFFSET UNITYSDK_OFFSET(0x1717FD70)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKEFFECT_CUTINANIMATION_METHOD_3_B25E929237883723_OFFSET UNITYSDK_OFFSET(0x171845F0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKEFFECT_CUTINANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1717FD20)
