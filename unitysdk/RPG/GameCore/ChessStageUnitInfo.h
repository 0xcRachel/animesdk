...
#define RPG_GAMECORE_CHESSSTAGEUNITINFO_METHOD_2_4D0745202E2FC733_OFFSET UNITYSDK_OFFSET(0x16980830)
#define RPG_GAMECORE_CHESSSTAGEUNITINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16980A30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChessStageUnitInfo_TypeDefinitionIndex = 15918;
