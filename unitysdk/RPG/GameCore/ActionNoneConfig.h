...
#define RPG_GAMECORE_ACTIONNONECONFIG_METHOD_4_572F81432C5B49D0_OFFSET UNITYSDK_OFFSET(0x1885E100)
#define RPG_GAMECORE_ACTIONNONECONFIG_METHOD_4_EA682DFB392A3C5E_OFFSET UNITYSDK_OFFSET(0x1885DF60)
#define RPG_GAMECORE_ACTIONNONECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1885E0B0)
