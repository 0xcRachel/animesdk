...
#define RPG_GAMECORE_BYCOMPAREFIRSTPERFORMANCE_METHOD_4_870928E515CF609C_OFFSET UNITYSDK_OFFSET(0x1701C9B0)
#define RPG_GAMECORE_BYCOMPAREFIRSTPERFORMANCE_METHOD_4_BDC165359FE99D16_OFFSET UNITYSDK_OFFSET(0x1701CA80)
#define RPG_GAMECORE_BYCOMPAREFIRSTPERFORMANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1701CA30)
