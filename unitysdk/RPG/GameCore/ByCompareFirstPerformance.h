...
#define RPG_GAMECORE_BYCOMPAREFIRSTPERFORMANCE_METHOD_4_870928E515CF609C_OFFSET UNITYSDK_OFFSET(0x1690BB80)
#define RPG_GAMECORE_BYCOMPAREFIRSTPERFORMANCE_METHOD_4_BDC165359FE99D16_OFFSET UNITYSDK_OFFSET(0x1690BC50)
#define RPG_GAMECORE_BYCOMPAREFIRSTPERFORMANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1690BC00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareFirstPerformance_TypeDefinitionIndex = 18874;
