...
#define RPG_GAMECORE_CHESSADDMODIFIER_METHOD_3_15FA34ED2E8EACE2_OFFSET UNITYSDK_OFFSET(0x1697C510)
#define RPG_GAMECORE_CHESSADDMODIFIER_METHOD_3_8F87D8B0ED801314_OFFSET UNITYSDK_OFFSET(0x1697C590)
#define RPG_GAMECORE_CHESSADDMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1697C560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChessAddModifier_TypeDefinitionIndex = 21435;
