...
#define RPG_GAMECORE_MESSAGEITEMROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x173E9E10)
#define RPG_GAMECORE_MESSAGEITEMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x173EA190)
#define RPG_GAMECORE_MESSAGEITEMROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x173EC250)
#define RPG_GAMECORE_MESSAGEITEMROW_GET_CANBESENT_OFFSET UNITYSDK_OFFSET(0x173EC300)
#define RPG_GAMECORE_MESSAGEITEMROW_GET_ISEND_OFFSET UNITYSDK_OFFSET(0x173EC2E0)
#define RPG_GAMECORE_MESSAGEITEMROW_RESET_OFFSET UNITYSDK_OFFSET(0x173EC2B0)
#define RPG_GAMECORE_MESSAGEITEMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x173EC2D0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::MessageItemType ItemType; // 0x34
		::RPG::GameCore::SenderType Sender; // 0x38
		::System::UInt32 ItemContentID; // 0x3C
		::RPG::Client::TextID MainText; // 0x40
