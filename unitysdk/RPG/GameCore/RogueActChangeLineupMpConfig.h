...
#define RPG_GAMECORE_ROGUEACTCHANGELINEUPMPCONFIG_METHOD_6_57462E8BF079DE8B_OFFSET UNITYSDK_OFFSET(0x175C6BC0)
#define RPG_GAMECORE_ROGUEACTCHANGELINEUPMPCONFIG_METHOD_6_FA2528940E39AE4E_OFFSET UNITYSDK_OFFSET(0x175C6DE0)
#define RPG_GAMECORE_ROGUEACTCHANGELINEUPMPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175C6D00)
