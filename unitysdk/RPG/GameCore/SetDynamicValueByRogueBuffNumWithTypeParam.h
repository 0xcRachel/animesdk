...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBUFFNUMWITHTYPEPARAM_METHOD_4_163FDF42D85A16E5_OFFSET UNITYSDK_OFFSET(0x16F258C0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBUFFNUMWITHTYPEPARAM_METHOD_4_D6CD2CFC87DB4AF5_OFFSET UNITYSDK_OFFSET(0x16F25950)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBUFFNUMWITHTYPEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x16F25920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueBuffNumWithTypeParam_TypeDefinitionIndex = 19417;
