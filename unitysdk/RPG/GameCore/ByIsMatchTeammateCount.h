...
#define RPG_GAMECORE_BYISMATCHTEAMMATECOUNT_METHOD_4_0A416682482BA8AD_OFFSET UNITYSDK_OFFSET(0x16933B90)
#define RPG_GAMECORE_BYISMATCHTEAMMATECOUNT_METHOD_4_79E5827FA67471D9_OFFSET UNITYSDK_OFFSET(0x16933AB0)
#define RPG_GAMECORE_BYISMATCHTEAMMATECOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x16933B30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsMatchTeammateCount_TypeDefinitionIndex = 20689;
