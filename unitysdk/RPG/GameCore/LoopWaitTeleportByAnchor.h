...
#define RPG_GAMECORE_LOOPWAITTELEPORTBYANCHOR_METHOD_3_7FACCE162639D4A3_OFFSET UNITYSDK_OFFSET(0x19C19C90)
#define RPG_GAMECORE_LOOPWAITTELEPORTBYANCHOR_METHOD_3_AA94DF6590F4F1F3_OFFSET UNITYSDK_OFFSET(0x19C19C00)
#define RPG_GAMECORE_LOOPWAITTELEPORTBYANCHOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19C19C60)
