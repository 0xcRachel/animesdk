...
#define RPG_GAMECORE_LOOPWAITTELEPORTBYANCHOR_METHOD_3_7FACCE162639D4A3_OFFSET UNITYSDK_OFFSET(0x16C20D90)
#define RPG_GAMECORE_LOOPWAITTELEPORTBYANCHOR_METHOD_3_AA94DF6590F4F1F3_OFFSET UNITYSDK_OFFSET(0x16C20D00)
#define RPG_GAMECORE_LOOPWAITTELEPORTBYANCHOR__CTOR_OFFSET UNITYSDK_OFFSET(0x16C20D60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitTeleportByAnchor_TypeDefinitionIndex = 18357;
