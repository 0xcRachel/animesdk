...
#define RPG_GAMECORE_ADVBYFASTDELIVERHASMULTIROUTE_METHOD_4_017B86666B0C9004_OFFSET UNITYSDK_OFFSET(0x1955A000)
#define RPG_GAMECORE_ADVBYFASTDELIVERHASMULTIROUTE_METHOD_4_6ABE7A0A2DA410E2_OFFSET UNITYSDK_OFFSET(0x19559CE0)
#define RPG_GAMECORE_ADVBYFASTDELIVERHASMULTIROUTE_METHOD_4_A8C413E596B49ED3_OFFSET UNITYSDK_OFFSET(0x1955A0E0)
#define RPG_GAMECORE_ADVBYFASTDELIVERHASMULTIROUTE_METHOD_4_DDA19FFE55B8F539_OFFSET UNITYSDK_OFFSET(0x19559E80)
#define RPG_GAMECORE_ADVBYFASTDELIVERHASMULTIROUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x19559DC0)
