...
#define RPG_GAMECORE_SETLOCALWINFLAG_METHOD_3_1C5B1D6DE6B6E526_OFFSET UNITYSDK_OFFSET(0x1A7913A0)
#define RPG_GAMECORE_SETLOCALWINFLAG_METHOD_3_F8BAC1BC243794DA_OFFSET UNITYSDK_OFFSET(0x1A791290)
#define RPG_GAMECORE_SETLOCALWINFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A791370)
