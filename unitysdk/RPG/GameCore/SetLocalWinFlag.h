...
#define RPG_GAMECORE_SETLOCALWINFLAG_METHOD_3_1C5B1D6DE6B6E526_OFFSET UNITYSDK_OFFSET(0x16F32E90)
#define RPG_GAMECORE_SETLOCALWINFLAG_METHOD_3_F8BAC1BC243794DA_OFFSET UNITYSDK_OFFSET(0x16F32D80)
#define RPG_GAMECORE_SETLOCALWINFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F32E60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetLocalWinFlag_TypeDefinitionIndex = 21073;
