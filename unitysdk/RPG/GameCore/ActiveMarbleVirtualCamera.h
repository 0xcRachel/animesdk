...
#define RPG_GAMECORE_ACTIVEMARBLEVIRTUALCAMERA_METHOD_4_D7DDA170B7F90816_OFFSET UNITYSDK_OFFSET(0x1988EEA0)
#define RPG_GAMECORE_ACTIVEMARBLEVIRTUALCAMERA_METHOD_4_EF3DE278BF422031_OFFSET UNITYSDK_OFFSET(0x1988EDE0)
#define RPG_GAMECORE_ACTIVEMARBLEVIRTUALCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x1988EE50)
