...
#define RPG_GAMECORE_TRIGGERSKIPDEADHANDLER_METHOD_3_146D805F58D71A08_OFFSET UNITYSDK_OFFSET(0x17126770)
#define RPG_GAMECORE_TRIGGERSKIPDEADHANDLER_METHOD_3_32B5E7BFC8A5743C_OFFSET UNITYSDK_OFFSET(0x17126660)
#define RPG_GAMECORE_TRIGGERSKIPDEADHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17126740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerSkipDeadHandler_TypeDefinitionIndex = 20142;
