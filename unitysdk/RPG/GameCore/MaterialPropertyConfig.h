...
#define RPG_GAMECORE_MATERIALPROPERTYCONFIG_METHOD_2_8679A6A675998319_OFFSET UNITYSDK_OFFSET(0x1999C980)
#define RPG_GAMECORE_MATERIALPROPERTYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1999CB70)
