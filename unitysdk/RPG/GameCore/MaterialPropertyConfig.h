...
#define RPG_GAMECORE_MATERIALPROPERTYCONFIG_METHOD_2_8BB0DDAB1B8A86D0_OFFSET UNITYSDK_OFFSET(0x18C3F8D0)
#define RPG_GAMECORE_MATERIALPROPERTYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18C3FAE0)
