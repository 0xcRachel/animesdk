...
#define RPG_GAMECORE_CACHECHARACTERATLASFACEEMOTION_METHOD_3_2EA263A1776109D1_OFFSET UNITYSDK_OFFSET(0x16943BD0)
#define RPG_GAMECORE_CACHECHARACTERATLASFACEEMOTION_METHOD_3_357A7AFD47614978_OFFSET UNITYSDK_OFFSET(0x16943C50)
#define RPG_GAMECORE_CACHECHARACTERATLASFACEEMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16943C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CacheCharacterAtlasFaceEmotion_TypeDefinitionIndex = 18420;
