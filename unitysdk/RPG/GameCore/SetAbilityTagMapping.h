...
#define RPG_GAMECORE_SETABILITYTAGMAPPING_METHOD_3_476C7E6C2BE4AF44_OFFSET UNITYSDK_OFFSET(0x1A1E0350)
#define RPG_GAMECORE_SETABILITYTAGMAPPING_METHOD_3_A27F0B3DEF9A31A1_OFFSET UNITYSDK_OFFSET(0x1A1E03D0)
#define RPG_GAMECORE_SETABILITYTAGMAPPING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1E03A0)
