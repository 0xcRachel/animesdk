...
#define RPG_GAMECORE_CREATETRIALPLAYER_METHOD_3_37157B4A27469102_OFFSET UNITYSDK_OFFSET(0x18FB1EF0)
#define RPG_GAMECORE_CREATETRIALPLAYER_METHOD_3_4341A4D5C6C1145D_OFFSET UNITYSDK_OFFSET(0x18FB1E80)
#define RPG_GAMECORE_CREATETRIALPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x18FB1EC0)
