...
#define RPG_GAMECORE_CREATETRIALPLAYER_METHOD_3_37157B4A27469102_OFFSET UNITYSDK_OFFSET(0x169D7B30)
#define RPG_GAMECORE_CREATETRIALPLAYER_METHOD_3_935B4D0CD84E5342_OFFSET UNITYSDK_OFFSET(0x169D7AA0)
#define RPG_GAMECORE_CREATETRIALPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x169D7B00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateTrialPlayer_TypeDefinitionIndex = 19237;
