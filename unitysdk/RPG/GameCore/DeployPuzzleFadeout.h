...
#define RPG_GAMECORE_DEPLOYPUZZLEFADEOUT_METHOD_3_66893F6EC5C64B59_OFFSET UNITYSDK_OFFSET(0x171677C0)
#define RPG_GAMECORE_DEPLOYPUZZLEFADEOUT_METHOD_3_AEB0835A8A24BA11_OFFSET UNITYSDK_OFFSET(0x17167670)
#define RPG_GAMECORE_DEPLOYPUZZLEFADEOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x17167730)
