...
#define RPG_GAMECORE_DEVICERELATEDGAMEOBJECTPOOLCONFIG_METHOD_3_1DE617CE8B142C12_OFFSET UNITYSDK_OFFSET(0x19587A00)
#define RPG_GAMECORE_DEVICERELATEDGAMEOBJECTPOOLCONFIG_METHOD_3_E93DF3D109B71934_OFFSET UNITYSDK_OFFSET(0x19588030)
#define RPG_GAMECORE_DEVICERELATEDGAMEOBJECTPOOLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x195879F0)
