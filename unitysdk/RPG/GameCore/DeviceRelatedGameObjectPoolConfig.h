...
#define RPG_GAMECORE_DEVICERELATEDGAMEOBJECTPOOLCONFIG_METHOD_3_1DE617CE8B142C12_OFFSET UNITYSDK_OFFSET(0x1716B280)
#define RPG_GAMECORE_DEVICERELATEDGAMEOBJECTPOOLCONFIG_METHOD_3_E93DF3D109B71934_OFFSET UNITYSDK_OFFSET(0x1716B8B0)
#define RPG_GAMECORE_DEVICERELATEDGAMEOBJECTPOOLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1716B270)
