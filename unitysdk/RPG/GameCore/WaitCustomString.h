...
#define RPG_GAMECORE_WAITCUSTOMSTRING_GET_ISCLIENTONLY_OFFSET UNITYSDK_OFFSET(0x1790B0A0)
#define RPG_GAMECORE_WAITCUSTOMSTRING_METHOD_3_77D53170EB7BF1DA_OFFSET UNITYSDK_OFFSET(0x1790AA20)
#define RPG_GAMECORE_WAITCUSTOMSTRING_METHOD_3_CA89EF70B6C7BF4C_OFFSET UNITYSDK_OFFSET(0x1790AC30)
#define RPG_GAMECORE_WAITCUSTOMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x178F4080)
