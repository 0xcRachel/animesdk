...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_ISPVE_METHOD_4_4AC2A4303CEB3BBF_OFFSET UNITYSDK_OFFSET(0x195985A0)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_ISPVE_METHOD_4_CEA2378995498ACC_OFFSET UNITYSDK_OFFSET(0x19599E90)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_ISPVE__CTOR_OFFSET UNITYSDK_OFFSET(0x19598550)
