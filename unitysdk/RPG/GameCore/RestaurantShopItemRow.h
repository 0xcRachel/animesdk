...
#define RPG_GAMECORE_RESTAURANTSHOPITEMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16DF1730)
#define RPG_GAMECORE_RESTAURANTSHOPITEMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16DF1B40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RestaurantShopItemRow_TypeDefinitionIndex = 10540;
	...
	public:
		...
		::System::UInt32 BuyPrice; // 0x2C
		::System::UInt32 ShopItemID; // 0x30
		::System::Boolean IsDiscount; // 0x34
		::System::UInt32 LimitCount; // 0x38
