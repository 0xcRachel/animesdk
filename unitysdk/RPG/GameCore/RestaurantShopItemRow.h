...
#define RPG_GAMECORE_RESTAURANTSHOPITEMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A2F9020)
#define RPG_GAMECORE_RESTAURANTSHOPITEMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2F9420)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::RestaurantShopItemRefreshType RefreshType; // 0x28
		::System::UInt32 RefreshParam; // 0x2C
		::System::UInt32 LimitCount; // 0x30
		::System::UInt32 BuyPrice; // 0x34
		::System::UInt32 AddLimitDay; // 0x38
		::System::UInt32 ShopItemID; // 0x3C
		::System::UInt32 AddLimitParam; // 0x40
		::System::UInt32 ProductID; // 0x44
