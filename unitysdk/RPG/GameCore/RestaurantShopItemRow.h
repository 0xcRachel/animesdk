...
#define RPG_GAMECORE_RESTAURANTSHOPITEMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x175BE8C0)
#define RPG_GAMECORE_RESTAURANTSHOPITEMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x175BECD0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::RestaurantShopItemRefreshType RefreshType; // 0x24
		...
		::System::UInt32 RefreshParam; // 0x44
