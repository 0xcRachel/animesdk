...
#define RPG_GAMECORE_RESTAURANTSHOPITEMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A01C510)
#define RPG_GAMECORE_RESTAURANTSHOPITEMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A01C920)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 RefreshParam; // 0x24
