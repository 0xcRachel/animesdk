...
#define RPG_GAMECORE_SERIALBELLSNOTECONFIG_METHOD_2_DFBCE4974F4703F8_OFFSET UNITYSDK_OFFSET(0x16EFE840)
#define RPG_GAMECORE_SERIALBELLSNOTECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16EFE9E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SerialBellsNoteConfig_TypeDefinitionIndex = 14740;
