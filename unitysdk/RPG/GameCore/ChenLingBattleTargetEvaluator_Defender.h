...
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_DEFENDER_METHOD_3_65EA1D82E3D2BC40_OFFSET UNITYSDK_OFFSET(0x196A3410)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_DEFENDER_METHOD_3_F5DB4736ADEF4705_OFFSET UNITYSDK_OFFSET(0x196A3370)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_DEFENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x196A3400)
