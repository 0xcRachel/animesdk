...
#define RPG_GAMECORE_PLANETFESAVATAREVENTOPTIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19D46FC0)
#define RPG_GAMECORE_PLANETFESAVATAREVENTOPTIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19D472A0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 RewardPoolID; // 0x30
		::System::UInt32 EventOptionID; // 0x34
