...
#define RPG_GAMECORE_STAGEBASECONFIG_GET_ACTIVEBLOCKNODECONFIGLIST_OFFSET UNITYSDK_OFFSET(0x18605EC0)
#define RPG_GAMECORE_STAGEBASECONFIG_GET_ENABLENORMDISTANCELODTEMPLATE_OFFSET UNITYSDK_OFFSET(0x18605EF0)
#define RPG_GAMECORE_STAGEBASECONFIG_GET_PVSENABLEREGIONFILTER_OFFSET UNITYSDK_OFFSET(0x18605F30)
#define RPG_GAMECORE_STAGEBASECONFIG_METHOD_2_0B3142A33AF5ED4C_OFFSET UNITYSDK_OFFSET(0x18605D40)
#define RPG_GAMECORE_STAGEBASECONFIG_METHOD_2_3A7480C8F521D402_OFFSET UNITYSDK_OFFSET(0x18605E30)
#define RPG_GAMECORE_STAGEBASECONFIG_METHOD_2_67F0C80DCDDCCF30_OFFSET UNITYSDK_OFFSET(0x18604CC0)
#define RPG_GAMECORE_STAGEBASECONFIG_METHOD_2_703DDFE3F88F0872_OFFSET UNITYSDK_OFFSET(0x18604B90)
#define RPG_GAMECORE_STAGEBASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18604CB0)
