...
#define RPG_GAMECORE_DISABLEROGUETITANBLESS_METHOD_3_467ADD47683D3CF8_OFFSET UNITYSDK_OFFSET(0x1A0A25D0)
#define RPG_GAMECORE_DISABLEROGUETITANBLESS_METHOD_3_E6B810BACE9EB6B1_OFFSET UNITYSDK_OFFSET(0x1A0A2550)
#define RPG_GAMECORE_DISABLEROGUETITANBLESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0A25A0)
