...
#define RPG_GAMECORE_MARBLEBYIMMUNEATTACKBACK_METHOD_4_088605AECACF8DF6_OFFSET UNITYSDK_OFFSET(0x19C33BE0)
#define RPG_GAMECORE_MARBLEBYIMMUNEATTACKBACK_METHOD_4_7B4B82F0B3EBAFC3_OFFSET UNITYSDK_OFFSET(0x19C33CC0)
#define RPG_GAMECORE_MARBLEBYIMMUNEATTACKBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19C33C70)
