...
#define RPG_GAMECORE_MARBLEBYIMMUNEATTACKBACK_METHOD_4_0861999BD2C0D2A5_OFFSET UNITYSDK_OFFSET(0x18FE9D50)
#define RPG_GAMECORE_MARBLEBYIMMUNEATTACKBACK_METHOD_4_51000A96990515A0_OFFSET UNITYSDK_OFFSET(0x18FE9C70)
#define RPG_GAMECORE_MARBLEBYIMMUNEATTACKBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18FE9D00)
