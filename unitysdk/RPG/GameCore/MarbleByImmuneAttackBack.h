...
#define RPG_GAMECORE_MARBLEBYIMMUNEATTACKBACK_METHOD_4_0861999BD2C0D2A5_OFFSET UNITYSDK_OFFSET(0x16C3AA80)
#define RPG_GAMECORE_MARBLEBYIMMUNEATTACKBACK_METHOD_4_51000A96990515A0_OFFSET UNITYSDK_OFFSET(0x16C3A9A0)
#define RPG_GAMECORE_MARBLEBYIMMUNEATTACKBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x16C3AA30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleByImmuneAttackBack_TypeDefinitionIndex = 15211;
