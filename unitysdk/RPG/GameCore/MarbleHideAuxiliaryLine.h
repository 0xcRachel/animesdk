...
#define RPG_GAMECORE_MARBLEHIDEAUXILIARYLINE_METHOD_3_3A8B5A0FE26BDD95_OFFSET UNITYSDK_OFFSET(0x18FEE500)
#define RPG_GAMECORE_MARBLEHIDEAUXILIARYLINE_METHOD_3_C44F45ED8E37831A_OFFSET UNITYSDK_OFFSET(0x18FEE3C0)
#define RPG_GAMECORE_MARBLEHIDEAUXILIARYLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x18FEE4B0)
