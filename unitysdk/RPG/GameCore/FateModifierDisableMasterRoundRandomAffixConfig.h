...
#define RPG_GAMECORE_FATEMODIFIERDISABLEMASTERROUNDRANDOMAFFIXCONFIG_METHOD_3_2338F6773D59ECC9_OFFSET UNITYSDK_OFFSET(0x171DBAA0)
#define RPG_GAMECORE_FATEMODIFIERDISABLEMASTERROUNDRANDOMAFFIXCONFIG_METHOD_3_500B8D76AD4673F0_OFFSET UNITYSDK_OFFSET(0x171DCD30)
#define RPG_GAMECORE_FATEMODIFIERDISABLEMASTERROUNDRANDOMAFFIXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171DBA50)
