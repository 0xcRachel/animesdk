...
#define RPG_GAMECORE_ST_MAIN_WAIT_METHOD_4_3D6D04A91877EF16_OFFSET UNITYSDK_OFFSET(0x16EF76D0)
#define RPG_GAMECORE_ST_MAIN_WAIT_METHOD_4_7D51BC927B83FADC_OFFSET UNITYSDK_OFFSET(0x16EE60B0)
#define RPG_GAMECORE_ST_MAIN_WAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x16EE6060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_Wait_TypeDefinitionIndex = 17860;
