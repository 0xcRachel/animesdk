...
#define RPG_GAMECORE_BYCOMPAREBATTLEEVENTID_METHOD_4_AD944FED6D309CBB_OFFSET UNITYSDK_OFFSET(0x17017990)
#define RPG_GAMECORE_BYCOMPAREBATTLEEVENTID_METHOD_4_F352A6951BDE819E_OFFSET UNITYSDK_OFFSET(0x17017AF0)
#define RPG_GAMECORE_BYCOMPAREBATTLEEVENTID__CTOR_OFFSET UNITYSDK_OFFSET(0x17017A50)
