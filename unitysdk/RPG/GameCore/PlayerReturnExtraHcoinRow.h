...
#define RPG_GAMECORE_PLAYERRETURNEXTRAHCOINROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x193627A0)
#define RPG_GAMECORE_PLAYERRETURNEXTRAHCOINROW__CTOR_OFFSET UNITYSDK_OFFSET(0x193629E0)
