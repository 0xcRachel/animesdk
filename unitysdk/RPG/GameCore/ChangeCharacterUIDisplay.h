...
#define RPG_GAMECORE_CHANGECHARACTERUIDISPLAY_METHOD_3_251DAE82D56C2162_OFFSET UNITYSDK_OFFSET(0x16964BA0)
#define RPG_GAMECORE_CHANGECHARACTERUIDISPLAY_METHOD_3_3706CA4FCA14049C_OFFSET UNITYSDK_OFFSET(0x16964DF0)
#define RPG_GAMECORE_CHANGECHARACTERUIDISPLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x16964DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeCharacterUIDisplay_TypeDefinitionIndex = 21364;
