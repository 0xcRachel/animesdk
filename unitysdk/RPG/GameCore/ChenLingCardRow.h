...
#define RPG_GAMECORE_CHENLINGCARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A158260)
#define RPG_GAMECORE_CHENLINGCARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1585D0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean IsSpecialCard; // 0x30
		::RPG::GameCore::ChenLingCardType Type; // 0x34
		::System::UInt32 ShopCost; // 0x38
