...
#define RPG_GAMECORE_LOCKMAINSTREAMSOURCETOPLAYERTELEPORTPOS_METHOD_3_ABF72AF229E35ED1_OFFSET UNITYSDK_OFFSET(0x16BDBC70)
#define RPG_GAMECORE_LOCKMAINSTREAMSOURCETOPLAYERTELEPORTPOS_METHOD_3_F3F21784D03E7E25_OFFSET UNITYSDK_OFFSET(0x16BDBD80)
#define RPG_GAMECORE_LOCKMAINSTREAMSOURCETOPLAYERTELEPORTPOS__CTOR_OFFSET UNITYSDK_OFFSET(0x16BDBD50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockMainStreamSourceToPlayerTeleportPos_TypeDefinitionIndex = 18280;
