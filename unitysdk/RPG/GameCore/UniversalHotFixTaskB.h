...
#define RPG_GAMECORE_UNIVERSALHOTFIXTASKB_METHOD_4_1D8198B00FEE39C8_OFFSET UNITYSDK_OFFSET(0x1713EA90)
#define RPG_GAMECORE_UNIVERSALHOTFIXTASKB_METHOD_4_DAE54065822F0511_OFFSET UNITYSDK_OFFSET(0x1713EB10)
#define RPG_GAMECORE_UNIVERSALHOTFIXTASKB__CTOR_OFFSET UNITYSDK_OFFSET(0x1713EAE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UniversalHotFixTaskB_TypeDefinitionIndex = 21029;
