...
#define RPG_GAMECORE_UNIVERSALHOTFIXTASKB_METHOD_4_1D8198B00FEE39C8_OFFSET UNITYSDK_OFFSET(0x178FAF90)
#define RPG_GAMECORE_UNIVERSALHOTFIXTASKB_METHOD_4_DAE54065822F0511_OFFSET UNITYSDK_OFFSET(0x178FAAF0)
#define RPG_GAMECORE_UNIVERSALHOTFIXTASKB__CTOR_OFFSET UNITYSDK_OFFSET(0x178FAAC0)
