...
#define RPG_GAMECORE_NOTIFYROUGEGOALFINISH_METHOD_3_152725694FFD150C_OFFSET UNITYSDK_OFFSET(0x19108CF0)
#define RPG_GAMECORE_NOTIFYROUGEGOALFINISH_METHOD_3_C51CC0E6743E99DD_OFFSET UNITYSDK_OFFSET(0x19108C70)
#define RPG_GAMECORE_NOTIFYROUGEGOALFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x19108CC0)
