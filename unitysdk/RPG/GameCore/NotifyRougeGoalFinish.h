...
#define RPG_GAMECORE_NOTIFYROUGEGOALFINISH_METHOD_3_152725694FFD150C_OFFSET UNITYSDK_OFFSET(0x16D03A00)
#define RPG_GAMECORE_NOTIFYROUGEGOALFINISH_METHOD_3_C51CC0E6743E99DD_OFFSET UNITYSDK_OFFSET(0x16D03980)
#define RPG_GAMECORE_NOTIFYROUGEGOALFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x16D039D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NotifyRougeGoalFinish_TypeDefinitionIndex = 21354;
