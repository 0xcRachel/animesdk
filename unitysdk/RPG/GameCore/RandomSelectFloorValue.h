...
#define RPG_GAMECORE_RANDOMSELECTFLOORVALUE_METHOD_3_1CACD0FC53D3EA34_OFFSET UNITYSDK_OFFSET(0x16DC7970)
#define RPG_GAMECORE_RANDOMSELECTFLOORVALUE_METHOD_3_DFBFA383242A104F_OFFSET UNITYSDK_OFFSET(0x16DC78F0)
#define RPG_GAMECORE_RANDOMSELECTFLOORVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x16DC7940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RandomSelectFloorValue_TypeDefinitionIndex = 18987;
