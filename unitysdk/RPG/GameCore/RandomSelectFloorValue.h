...
#define RPG_GAMECORE_RANDOMSELECTFLOORVALUE_METHOD_3_1CACD0FC53D3EA34_OFFSET UNITYSDK_OFFSET(0x1900DD60)
#define RPG_GAMECORE_RANDOMSELECTFLOORVALUE_METHOD_3_DFBFA383242A104F_OFFSET UNITYSDK_OFFSET(0x1900DCE0)
#define RPG_GAMECORE_RANDOMSELECTFLOORVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1900DD30)
