...
#define RPG_GAMECORE_RANDOMSELECTFLOORVALUE_METHOD_3_47E30C8DD8D22725_OFFSET UNITYSDK_OFFSET(0x19AA9D20)
#define RPG_GAMECORE_RANDOMSELECTFLOORVALUE_METHOD_3_DEA3B58070BAAD86_OFFSET UNITYSDK_OFFSET(0x19AA9DA0)
#define RPG_GAMECORE_RANDOMSELECTFLOORVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x19AA9D70)
