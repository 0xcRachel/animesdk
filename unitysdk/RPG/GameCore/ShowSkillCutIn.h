...
#define RPG_GAMECORE_SHOWSKILLCUTIN_METHOD_3_60847421BF38722E_OFFSET UNITYSDK_OFFSET(0x193B0C10)
#define RPG_GAMECORE_SHOWSKILLCUTIN_METHOD_3_EB89798D293D6F73_OFFSET UNITYSDK_OFFSET(0x193B0B90)
#define RPG_GAMECORE_SHOWSKILLCUTIN__CTOR_OFFSET UNITYSDK_OFFSET(0x193B0BE0)
