...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERADDAUGMENTCONFIG_METHOD_3_2C5CBBEA1B4FABC5_OFFSET UNITYSDK_OFFSET(0x1957CA10)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERADDAUGMENTCONFIG_METHOD_3_2E76316A8153102C_OFFSET UNITYSDK_OFFSET(0x195801C0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERADDAUGMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1957C9C0)
