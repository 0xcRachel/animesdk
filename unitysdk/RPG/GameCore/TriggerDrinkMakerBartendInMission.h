...
#define RPG_GAMECORE_TRIGGERDRINKMAKERBARTENDINMISSION_METHOD_3_A4FAEED92FFCA9D3_OFFSET UNITYSDK_OFFSET(0x191124B0)
#define RPG_GAMECORE_TRIGGERDRINKMAKERBARTENDINMISSION_METHOD_3_FC3E9988464253EA_OFFSET UNITYSDK_OFFSET(0x19112530)
#define RPG_GAMECORE_TRIGGERDRINKMAKERBARTENDINMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x19112500)
