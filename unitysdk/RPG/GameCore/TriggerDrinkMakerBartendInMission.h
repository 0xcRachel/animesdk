...
#define RPG_GAMECORE_TRIGGERDRINKMAKERBARTENDINMISSION_METHOD_3_A4FAEED92FFCA9D3_OFFSET UNITYSDK_OFFSET(0x1711A3B0)
#define RPG_GAMECORE_TRIGGERDRINKMAKERBARTENDINMISSION_METHOD_3_FC3E9988464253EA_OFFSET UNITYSDK_OFFSET(0x1711A430)
#define RPG_GAMECORE_TRIGGERDRINKMAKERBARTENDINMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1711A400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerDrinkMakerBartendInMission_TypeDefinitionIndex = 19355;
