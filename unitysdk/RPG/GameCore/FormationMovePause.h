...
#define RPG_GAMECORE_FORMATIONMOVEPAUSE_METHOD_3_AE0D716F4247B1C9_OFFSET UNITYSDK_OFFSET(0x1A3B3770)
#define RPG_GAMECORE_FORMATIONMOVEPAUSE_METHOD_3_EA82191DE4C24C40_OFFSET UNITYSDK_OFFSET(0x1A3B37F0)
#define RPG_GAMECORE_FORMATIONMOVEPAUSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3B37C0)
