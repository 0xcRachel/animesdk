...
#define RPG_GAMECORE_ROGUETOURNHANDBOOKEVENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x194056E0)
#define RPG_GAMECORE_ROGUETOURNHANDBOOKEVENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x194059F0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 UnlockDisplayID; // 0x34
