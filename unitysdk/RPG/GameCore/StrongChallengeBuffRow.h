...
#define RPG_GAMECORE_STRONGCHALLENGEBUFFROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16FA3890)
#define RPG_GAMECORE_STRONGCHALLENGEBUFFROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16FA3980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StrongChallengeBuffRow_TypeDefinitionIndex = 11259;
