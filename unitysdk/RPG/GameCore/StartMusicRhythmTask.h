...
#define RPG_GAMECORE_STARTMUSICRHYTHMTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAA49B80)
#define RPG_GAMECORE_STARTMUSICRHYTHMTASK_ONPUZZLEEVENT_OFFSET UNITYSDK_OFFSET(0xAA4A5A0)
#define RPG_GAMECORE_STARTMUSICRHYTHMTASK_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xAA49700)
#define RPG_GAMECORE_STARTMUSICRHYTHMTASK_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xAA49B30)
#define RPG_GAMECORE_STARTMUSICRHYTHMTASK_SHOWMAINPAGE_OFFSET UNITYSDK_OFFSET(0xAA4A250)
#define RPG_GAMECORE_STARTMUSICRHYTHMTASK_TICK_OFFSET UNITYSDK_OFFSET(0xAA49D10)
#define RPG_GAMECORE_STARTMUSICRHYTHMTASK__CTOR_OFFSET UNITYSDK_OFFSET(0xAA49590)
#define RPG_GAMECORE_STARTMUSICRHYTHMTASK__ONCHOOSELEVELPAGEEXIT_OFFSET UNITYSDK_OFFSET(0xAA49A50)
#define RPG_GAMECORE_STARTMUSICRHYTHMTASK__ONMAINPAGEENTER_OFFSET UNITYSDK_OFFSET(0xAA4A730)
#define RPG_GAMECORE_STARTMUSICRHYTHMTASK__ONMUSICREADYPAGECLOSE_OFFSET UNITYSDK_OFFSET(0xAA4A6D0)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::RPG::GameCore::TaskContext* _Context; // 0x18
		::RPG::Client::LuaUIController* _MainPage; // 0x20
		::Class_3_5775A4FEC79026BC* _OnShowUi; // 0x28
		::Class_3_5775A4FEC79026BC* _FormalFlow; // 0x30
		::RPG::GameCore::StartMusicRhythm* _Config; // 0x38
		::Class_3_5775A4FEC79026BC* _TutorialFlow; // 0x40
		::RPG::Client::MusicRhythmBoard* _MusicBoard; // 0x48
