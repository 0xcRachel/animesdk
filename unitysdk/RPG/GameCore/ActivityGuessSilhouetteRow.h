...
#define RPG_GAMECORE_ACTIVITYGUESSSILHOUETTEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1952BE30)
#define RPG_GAMECORE_ACTIVITYGUESSSILHOUETTEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1952C390)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* Aim02; // 0x18
		::System::String* Tab; // 0x20
		...
		::System::String* KeyIconPath; // 0x50
