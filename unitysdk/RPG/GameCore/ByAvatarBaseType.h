...
#define RPG_GAMECORE_BYAVATARBASETYPE_METHOD_4_D013E7ABFD926BDF_OFFSET UNITYSDK_OFFSET(0x168FEA40)
#define RPG_GAMECORE_BYAVATARBASETYPE_METHOD_4_F62EBC277D2B9FEE_OFFSET UNITYSDK_OFFSET(0x168FEB20)
#define RPG_GAMECORE_BYAVATARBASETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x168FEAC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByAvatarBaseType_TypeDefinitionIndex = 20199;
