...
#define RPG_GAMECORE_MARBLEADDSKILL_METHOD_3_05591B011D32BA82_OFFSET UNITYSDK_OFFSET(0x16C371C0)
#define RPG_GAMECORE_MARBLEADDSKILL_METHOD_3_DFB39F021567D056_OFFSET UNITYSDK_OFFSET(0x16C370E0)
#define RPG_GAMECORE_MARBLEADDSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x16C37170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleAddSkill_TypeDefinitionIndex = 15180;
