...
#define RPG_GAMECORE_BOOKSERIESWORLDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x168EE410)
#define RPG_GAMECORE_BOOKSERIESWORLDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x168EE600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BookSeriesWorldConfigRow_TypeDefinitionIndex = 11704;
