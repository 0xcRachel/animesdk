...
#define RPG_GAMECORE_ROGUECONDITEMCOUNTCONFIG_METHOD_6_095363C684CFACF0_OFFSET UNITYSDK_OFFSET(0x19248600)
#define RPG_GAMECORE_ROGUECONDITEMCOUNTCONFIG_METHOD_6_3BAD16FDAD655BC6_OFFSET UNITYSDK_OFFSET(0x192488B0)
#define RPG_GAMECORE_ROGUECONDITEMCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19248780)
