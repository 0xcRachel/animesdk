...
#define RPG_GAMECORE_BYHASSTANCEWEAKPREVIEW_METHOD_4_4003166403879B72_OFFSET UNITYSDK_OFFSET(0x16928780)
#define RPG_GAMECORE_BYHASSTANCEWEAKPREVIEW_METHOD_4_D66EC403087BE0B5_OFFSET UNITYSDK_OFFSET(0x169286A0)
#define RPG_GAMECORE_BYHASSTANCEWEAKPREVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x16928720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHasStanceWeakPreview_TypeDefinitionIndex = 20196;
