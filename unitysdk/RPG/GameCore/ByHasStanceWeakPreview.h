...
#define RPG_GAMECORE_BYHASSTANCEWEAKPREVIEW_METHOD_4_4003166403879B72_OFFSET UNITYSDK_OFFSET(0x17039B20)
#define RPG_GAMECORE_BYHASSTANCEWEAKPREVIEW_METHOD_4_D66EC403087BE0B5_OFFSET UNITYSDK_OFFSET(0x17039A40)
#define RPG_GAMECORE_BYHASSTANCEWEAKPREVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x17039AC0)
