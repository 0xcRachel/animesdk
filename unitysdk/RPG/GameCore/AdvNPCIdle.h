...
#define RPG_GAMECORE_ADVNPCIDLE_METHOD_3_A22FB378161500D1_OFFSET UNITYSDK_OFFSET(0x18C4EBD0)
#define RPG_GAMECORE_ADVNPCIDLE_METHOD_3_D1B3CF7E29F5019D_OFFSET UNITYSDK_OFFSET(0x18C4EAC0)
#define RPG_GAMECORE_ADVNPCIDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C4EBA0)
