...
#define RPG_GAMECORE_AETHERDIVIDETRAINERLEVELROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18BC5A80)
#define RPG_GAMECORE_AETHERDIVIDETRAINERLEVELROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18BC5D00)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 RareMonsterNumID; // 0x34
