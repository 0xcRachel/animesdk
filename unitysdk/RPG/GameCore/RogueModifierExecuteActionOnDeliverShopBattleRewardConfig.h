...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONDELIVERSHOPBATTLEREWARDCONFIG_METHOD_3_4CE8E75077B3279A_OFFSET UNITYSDK_OFFSET(0x16E96B10)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONDELIVERSHOPBATTLEREWARDCONFIG_METHOD_3_5F6023A246D727E3_OFFSET UNITYSDK_OFFSET(0x16E9EC20)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONDELIVERSHOPBATTLEREWARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E96AC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnDeliverShopBattleRewardConfig_TypeDefinitionIndex = 15965;
