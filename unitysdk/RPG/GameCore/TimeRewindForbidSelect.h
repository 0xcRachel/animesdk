...
#define RPG_GAMECORE_TIMEREWINDFORBIDSELECT_METHOD_3_96EA2A0BCBF5B8C7_OFFSET UNITYSDK_OFFSET(0x1789D5F0)
#define RPG_GAMECORE_TIMEREWINDFORBIDSELECT_METHOD_3_E8279BB9CF15B87E_OFFSET UNITYSDK_OFFSET(0x178B3D30)
#define RPG_GAMECORE_TIMEREWINDFORBIDSELECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1789D5C0)
