...
#define RPG_GAMECORE_ST_SIDE_LOOKATTARGET_METHOD_4_5094B626D7FBAEEA_OFFSET UNITYSDK_OFFSET(0x176AD910)
#define RPG_GAMECORE_ST_SIDE_LOOKATTARGET_METHOD_4_8504F445FBD37095_OFFSET UNITYSDK_OFFSET(0x176A1A70)
#define RPG_GAMECORE_ST_SIDE_LOOKATTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x176A1A20)
