...
#define RPG_GAMECORE_ST_SIDE_LOOKATTARGET_METHOD_4_5094B626D7FBAEEA_OFFSET UNITYSDK_OFFSET(0x16EF8580)
#define RPG_GAMECORE_ST_SIDE_LOOKATTARGET_METHOD_4_8504F445FBD37095_OFFSET UNITYSDK_OFFSET(0x16EEA100)
#define RPG_GAMECORE_ST_SIDE_LOOKATTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x16EEA0B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_LookAtTarget_TypeDefinitionIndex = 17877;
