...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERUNLOCKROLECONFIG_METHOD_3_1F47EA3CA3DE4BFB_OFFSET UNITYSDK_OFFSET(0x1A1A8090)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERUNLOCKROLECONFIG_METHOD_3_B1119BFE93F5FE72_OFFSET UNITYSDK_OFFSET(0x1A1A8160)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERUNLOCKROLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1A8110)
