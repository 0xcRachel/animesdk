...
#define RPG_GAMECORE_SETDYNAMICVALUEBYHPRATIO_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x16F24140)
#define RPG_GAMECORE_SETDYNAMICVALUEBYHPRATIO_METHOD_4_606922BBB8C6C33D_OFFSET UNITYSDK_OFFSET(0x16F23F50)
#define RPG_GAMECORE_SETDYNAMICVALUEBYHPRATIO_METHOD_4_8A095C1359E986C9_OFFSET UNITYSDK_OFFSET(0x16F1B3F0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYHPRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x16F1B3A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByHPRatio_TypeDefinitionIndex = 20754;
