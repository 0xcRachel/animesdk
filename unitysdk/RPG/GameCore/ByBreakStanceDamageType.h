...
#define RPG_GAMECORE_BYBREAKSTANCEDAMAGETYPE_METHOD_4_B39AF4EDFE23280D_OFFSET UNITYSDK_OFFSET(0x168FF280)
#define RPG_GAMECORE_BYBREAKSTANCEDAMAGETYPE_METHOD_4_C920B0F6F11B0221_OFFSET UNITYSDK_OFFSET(0x168FF1B0)
#define RPG_GAMECORE_BYBREAKSTANCEDAMAGETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x168FF230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByBreakStanceDamageType_TypeDefinitionIndex = 21190;
