...
#define RPG_GAMECORE_FIVEDIMARROWMOVECONFIG_METHOD_3_C863CCBFA08CAF12_OFFSET UNITYSDK_OFFSET(0x16AABB10)
#define RPG_GAMECORE_FIVEDIMARROWMOVECONFIG_METHOD_3_F440F39542D393B3_OFFSET UNITYSDK_OFFSET(0x16AABAC0)
#define RPG_GAMECORE_FIVEDIMARROWMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16AABB00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimArrowMoveConfig_TypeDefinitionIndex = 15039;
