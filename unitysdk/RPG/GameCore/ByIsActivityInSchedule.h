...
#define RPG_GAMECORE_BYISACTIVITYINSCHEDULE_METHOD_4_B5873BCBBC977E26_OFFSET UNITYSDK_OFFSET(0x1692BD50)
#define RPG_GAMECORE_BYISACTIVITYINSCHEDULE_METHOD_4_F6D63E59267DFFA4_OFFSET UNITYSDK_OFFSET(0x1692BE20)
#define RPG_GAMECORE_BYISACTIVITYINSCHEDULE__CTOR_OFFSET UNITYSDK_OFFSET(0x1692BDD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsActivityInSchedule_TypeDefinitionIndex = 18761;
