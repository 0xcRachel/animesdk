...
#define RPG_GAMECORE_CAKERACEWAITVOTEEND_METHOD_3_E7E91CD387C767DA_OFFSET UNITYSDK_OFFSET(0x16953EF0)
#define RPG_GAMECORE_CAKERACEWAITVOTEEND_METHOD_3_EB37DDE45E8A512E_OFFSET UNITYSDK_OFFSET(0x16953DE0)
#define RPG_GAMECORE_CAKERACEWAITVOTEEND__CTOR_OFFSET UNITYSDK_OFFSET(0x16953EC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceWaitVoteEnd_TypeDefinitionIndex = 21782;
