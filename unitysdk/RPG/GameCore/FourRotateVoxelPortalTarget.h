...
#define RPG_GAMECORE_FOURROTATEVOXELPORTALTARGET_METHOD_2_BC8642D9925B0F08_OFFSET UNITYSDK_OFFSET(0x1A3B86D0)
#define RPG_GAMECORE_FOURROTATEVOXELPORTALTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3B8770)
