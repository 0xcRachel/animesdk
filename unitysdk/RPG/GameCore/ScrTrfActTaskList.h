...
#define RPG_GAMECORE_SCRTRFACTTASKLIST_METHOD_3_011E0242151CCCBD_OFFSET UNITYSDK_OFFSET(0x176B1970)
#define RPG_GAMECORE_SCRTRFACTTASKLIST_METHOD_3_A8741B4E3138128E_OFFSET UNITYSDK_OFFSET(0x176B19B0)
#define RPG_GAMECORE_SCRTRFACTTASKLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x176B19A0)
