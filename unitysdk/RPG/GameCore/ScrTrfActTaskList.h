...
#define RPG_GAMECORE_SCRTRFACTTASKLIST_METHOD_3_011E0242151CCCBD_OFFSET UNITYSDK_OFFSET(0x16EFC4C0)
#define RPG_GAMECORE_SCRTRFACTTASKLIST_METHOD_3_A8741B4E3138128E_OFFSET UNITYSDK_OFFSET(0x16EFC500)
#define RPG_GAMECORE_SCRTRFACTTASKLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x16EFC4F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ScrTrfActTaskList_TypeDefinitionIndex = 18666;
