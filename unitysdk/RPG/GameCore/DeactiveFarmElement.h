...
#define RPG_GAMECORE_DEACTIVEFARMELEMENT_METHOD_3_7706044986DEBDB0_OFFSET UNITYSDK_OFFSET(0x19B2ED90)
#define RPG_GAMECORE_DEACTIVEFARMELEMENT_METHOD_3_F26E4C9C1C088BE9_OFFSET UNITYSDK_OFFSET(0x19B2EE10)
#define RPG_GAMECORE_DEACTIVEFARMELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19B2EDE0)
