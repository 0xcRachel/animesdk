...
#define RPG_GAMECORE_DEACTIVEFARMELEMENT_METHOD_3_7706044986DEBDB0_OFFSET UNITYSDK_OFFSET(0x169E48F0)
#define RPG_GAMECORE_DEACTIVEFARMELEMENT_METHOD_3_F26E4C9C1C088BE9_OFFSET UNITYSDK_OFFSET(0x169E4970)
#define RPG_GAMECORE_DEACTIVEFARMELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x169E4940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DeactiveFarmElement_TypeDefinitionIndex = 19740;
