...
#define RPG_GAMECORE_ADVENTURESKILLSLOTDATA_GET_SKILLINDEX_OFFSET UNITYSDK_OFFSET(0xA321C00)
#define RPG_GAMECORE_ADVENTURESKILLSLOTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA322C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureSkillSlotData_TypeDefinitionIndex = 44688;
