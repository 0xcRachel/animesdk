...
#define RPG_GAMECORE_TRIGGERENTERSAFEUI_METHOD_3_6598FE21E0756C17_OFFSET UNITYSDK_OFFSET(0x1711F030)
#define RPG_GAMECORE_TRIGGERENTERSAFEUI_METHOD_3_8240D7D95B22E866_OFFSET UNITYSDK_OFFSET(0x1711EFB0)
#define RPG_GAMECORE_TRIGGERENTERSAFEUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1711F000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerEnterSafeUI_TypeDefinitionIndex = 19733;
