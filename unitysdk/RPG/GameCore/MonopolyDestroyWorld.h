...
#define RPG_GAMECORE_MONOPOLYDESTROYWORLD_METHOD_3_1965D702B5318CE4_OFFSET UNITYSDK_OFFSET(0x1744BFD0)
#define RPG_GAMECORE_MONOPOLYDESTROYWORLD_METHOD_3_3E92E766875B9030_OFFSET UNITYSDK_OFFSET(0x1744C0E0)
#define RPG_GAMECORE_MONOPOLYDESTROYWORLD__CTOR_OFFSET UNITYSDK_OFFSET(0x1744C0B0)
