...
#define RPG_GAMECORE_PERFORMANCESKIPCROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x16D2AC20)
#define RPG_GAMECORE_PERFORMANCESKIPCROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16D2ADF0)
#define RPG_GAMECORE_PERFORMANCESKIPCROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x16D2ABA0)
#define RPG_GAMECORE_PERFORMANCESKIPCROW_RESET_OFFSET UNITYSDK_OFFSET(0x16D2AC00)
#define RPG_GAMECORE_PERFORMANCESKIPCROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16D2AFE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceSkipCRow_TypeDefinitionIndex = 13093;
