...
#define RPG_GAMECORE_FIVEDIMDESTROYMASCOTFAKEPLAYERACTION_METHOD_3_42C27024D1032D88_OFFSET UNITYSDK_OFFSET(0x199E9C80)
#define RPG_GAMECORE_FIVEDIMDESTROYMASCOTFAKEPLAYERACTION_METHOD_3_EE1D3889BF68EFBD_OFFSET UNITYSDK_OFFSET(0x199DEB50)
#define RPG_GAMECORE_FIVEDIMDESTROYMASCOTFAKEPLAYERACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x199DEB30)
