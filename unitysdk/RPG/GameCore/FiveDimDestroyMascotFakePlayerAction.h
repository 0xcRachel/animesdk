...
#define RPG_GAMECORE_FIVEDIMDESTROYMASCOTFAKEPLAYERACTION_METHOD_3_42C27024D1032D88_OFFSET UNITYSDK_OFFSET(0x16AB9480)
#define RPG_GAMECORE_FIVEDIMDESTROYMASCOTFAKEPLAYERACTION_METHOD_3_EE1D3889BF68EFBD_OFFSET UNITYSDK_OFFSET(0x16AB9540)
#define RPG_GAMECORE_FIVEDIMDESTROYMASCOTFAKEPLAYERACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16AB9520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimDestroyMascotFakePlayerAction_TypeDefinitionIndex = 16765;
