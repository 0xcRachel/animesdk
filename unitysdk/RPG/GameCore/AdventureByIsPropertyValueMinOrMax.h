...
#define RPG_GAMECORE_ADVENTUREBYISPROPERTYVALUEMINORMAX_METHOD_4_6A331EDF297F9DDE_OFFSET UNITYSDK_OFFSET(0x18C682C0)
#define RPG_GAMECORE_ADVENTUREBYISPROPERTYVALUEMINORMAX_METHOD_4_7C225C23CDB335F8_OFFSET UNITYSDK_OFFSET(0x18C683E0)
#define RPG_GAMECORE_ADVENTUREBYISPROPERTYVALUEMINORMAX__CTOR_OFFSET UNITYSDK_OFFSET(0x18C68360)
