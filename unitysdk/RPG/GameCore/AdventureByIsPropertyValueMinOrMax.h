...
#define RPG_GAMECORE_ADVENTUREBYISPROPERTYVALUEMINORMAX_METHOD_4_6A331EDF297F9DDE_OFFSET UNITYSDK_OFFSET(0x16854720)
#define RPG_GAMECORE_ADVENTUREBYISPROPERTYVALUEMINORMAX_METHOD_4_7C225C23CDB335F8_OFFSET UNITYSDK_OFFSET(0x16854840)
#define RPG_GAMECORE_ADVENTUREBYISPROPERTYVALUEMINORMAX__CTOR_OFFSET UNITYSDK_OFFSET(0x168547C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureByIsPropertyValueMinOrMax_TypeDefinitionIndex = 18013;
