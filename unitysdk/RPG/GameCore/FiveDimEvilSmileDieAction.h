...
#define RPG_GAMECORE_FIVEDIMEVILSMILEDIEACTION_METHOD_3_365B0954266A1D37_OFFSET UNITYSDK_OFFSET(0x199ED2B0)
#define RPG_GAMECORE_FIVEDIMEVILSMILEDIEACTION_METHOD_3_8585A33CA65CF3AE_OFFSET UNITYSDK_OFFSET(0x199DFEA0)
#define RPG_GAMECORE_FIVEDIMEVILSMILEDIEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x199DFE80)
