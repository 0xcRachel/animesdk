...
#define RPG_GAMECORE_MANIKINSERVANTPOSITIONSCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16C28D40)
#define RPG_GAMECORE_MANIKINSERVANTPOSITIONSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16C28F90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ManikinServantPositionsConfig_TypeDefinitionIndex = 15780;
