...
#define RPG_GAMECORE_ASSISTWAYPOINTLITTLEGAMECONDITION_METHOD_2_F943FA07782D44CC_OFFSET UNITYSDK_OFFSET(0x1688FB60)
#define RPG_GAMECORE_ASSISTWAYPOINTLITTLEGAMECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1688FC50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AssistWayPointLittleGameCondition_TypeDefinitionIndex = 17015;
