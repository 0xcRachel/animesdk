...
#define RPG_GAMECORE_CHIMERADUELPRESETTEAMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16995390)
#define RPG_GAMECORE_CHIMERADUELPRESETTEAMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16995520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelPresetTeamRow_TypeDefinitionIndex = 10345;
