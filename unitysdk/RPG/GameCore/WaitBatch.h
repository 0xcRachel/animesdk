...
#define RPG_GAMECORE_WAITBATCH_METHOD_3_87827B7CE3C57166_OFFSET UNITYSDK_OFFSET(0x1714D670)
#define RPG_GAMECORE_WAITBATCH_METHOD_3_DB9C3454B47C362D_OFFSET UNITYSDK_OFFSET(0x1714D6F0)
#define RPG_GAMECORE_WAITBATCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1714D6C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitBatch_TypeDefinitionIndex = 21471;
