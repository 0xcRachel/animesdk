...
#define RPG_GAMECORE_WAITBATCH_METHOD_3_87827B7CE3C57166_OFFSET UNITYSDK_OFFSET(0x179097B0)
#define RPG_GAMECORE_WAITBATCH_METHOD_3_DB9C3454B47C362D_OFFSET UNITYSDK_OFFSET(0x17909830)
#define RPG_GAMECORE_WAITBATCH__CTOR_OFFSET UNITYSDK_OFFSET(0x17909800)
