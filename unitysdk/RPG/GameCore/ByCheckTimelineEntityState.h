...
#define RPG_GAMECORE_BYCHECKTIMELINEENTITYSTATE_METHOD_4_2915B6D09CB1D176_OFFSET UNITYSDK_OFFSET(0x195FEAD0)
#define RPG_GAMECORE_BYCHECKTIMELINEENTITYSTATE_METHOD_4_D560BD013C61893F_OFFSET UNITYSDK_OFFSET(0x195FECF0)
#define RPG_GAMECORE_BYCHECKTIMELINEENTITYSTATE_METHOD_4_E59C07E3B62C9818_OFFSET UNITYSDK_OFFSET(0x195FEC70)
#define RPG_GAMECORE_BYCHECKTIMELINEENTITYSTATE_METHOD_4_FA2F1F8F8F8FE276_OFFSET UNITYSDK_OFFSET(0x195FEA00)
#define RPG_GAMECORE_BYCHECKTIMELINEENTITYSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x195FEA80)
