...
#define RPG_GAMECORE_REMOVEAIRLINE_METHOD_3_33A3C5E8C0C9FF87_OFFSET UNITYSDK_OFFSET(0x175AAAC0)
#define RPG_GAMECORE_REMOVEAIRLINE_METHOD_3_912AB873C054EE29_OFFSET UNITYSDK_OFFSET(0x175AAA40)
#define RPG_GAMECORE_REMOVEAIRLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x175AAA90)
