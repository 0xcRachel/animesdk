...
#define RPG_GAMECORE_BYISUIPAGEOPEN_METHOD_4_0DA78A0525669028_OFFSET UNITYSDK_OFFSET(0x16938950)
#define RPG_GAMECORE_BYISUIPAGEOPEN_METHOD_4_CE1271FCC7E96386_OFFSET UNITYSDK_OFFSET(0x16938880)
#define RPG_GAMECORE_BYISUIPAGEOPEN__CTOR_OFFSET UNITYSDK_OFFSET(0x16938900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsUIPageOpen_TypeDefinitionIndex = 19898;
