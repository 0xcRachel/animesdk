...
#define RPG_GAMECORE_CONSUMEACTIONCOUNTDOWN_METHOD_3_14587A81DF4441F6_OFFSET UNITYSDK_OFFSET(0x169CBA80)
#define RPG_GAMECORE_CONSUMEACTIONCOUNTDOWN_METHOD_3_96139679F9AA34C8_OFFSET UNITYSDK_OFFSET(0x169CB960)
#define RPG_GAMECORE_CONSUMEACTIONCOUNTDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x169CBA00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConsumeActionCountDown_TypeDefinitionIndex = 21381;
