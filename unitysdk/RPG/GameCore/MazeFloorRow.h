...
#define RPG_GAMECORE_MAZEFLOORROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x199A5350)
#define RPG_GAMECORE_MAZEFLOORROW__CTOR_OFFSET UNITYSDK_OFFSET(0x199A5DA0)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::Il2CppArray<::RPG::Client::TextID>* MapLayerNameList; // 0x10
		...
		::System::String* BGMWorldState; // 0x38
		::System::String* CombatBGMHigh; // 0x40
		::Il2CppArray<::System::String*>* EnterAudioEvent; // 0x48
		::Il2CppArray<::System::String*>* FloorTag; // 0x50
		::Il2CppArray<::System::String*>* ExitAudioEvent; // 0x58
		::System::String* FloorBGMNormalStateName; // 0x60
		::System::String* FloorName; // 0x68
		::System::String* MunicipalConfigPath; // 0x70
		::System::String* CombatBGMLow; // 0x78
