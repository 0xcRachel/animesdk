...
#define RPG_GAMECORE_PROPSETUPOPTIONSTRIGGER_METHOD_3_9B809C0656BB438D_OFFSET UNITYSDK_OFFSET(0x16DB3DC0)
#define RPG_GAMECORE_PROPSETUPOPTIONSTRIGGER_METHOD_3_A368E1FED7E71A57_OFFSET UNITYSDK_OFFSET(0x16DB3F10)
#define RPG_GAMECORE_PROPSETUPOPTIONSTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x16DB3E80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropSetupOptionsTrigger_TypeDefinitionIndex = 19227;
