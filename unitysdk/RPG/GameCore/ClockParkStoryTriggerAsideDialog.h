...
#define RPG_GAMECORE_CLOCKPARKSTORYTRIGGERASIDEDIALOG_METHOD_3_CFAEE72EB100DED9_OFFSET UNITYSDK_OFFSET(0x1712F480)
#define RPG_GAMECORE_CLOCKPARKSTORYTRIGGERASIDEDIALOG_METHOD_3_E07008660ECC0B40_OFFSET UNITYSDK_OFFSET(0x1712F500)
#define RPG_GAMECORE_CLOCKPARKSTORYTRIGGERASIDEDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1712F4D0)
