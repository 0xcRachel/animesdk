...
#define RPG_GAMECORE_REFRESHALLTUTORIALNODE_METHOD_3_2ED74DD05038CA6B_OFFSET UNITYSDK_OFFSET(0x1759CCF0)
#define RPG_GAMECORE_REFRESHALLTUTORIALNODE_METHOD_3_DC86820D1181BBDF_OFFSET UNITYSDK_OFFSET(0x1759CE00)
#define RPG_GAMECORE_REFRESHALLTUTORIALNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1759CDD0)
