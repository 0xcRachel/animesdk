...
#define RPG_GAMECORE_SHOWBOSSHPVALUE_METHOD_3_A42E522639A48D17_OFFSET UNITYSDK_OFFSET(0x16F56550)
#define RPG_GAMECORE_SHOWBOSSHPVALUE_METHOD_3_C0D62BDDB4520966_OFFSET UNITYSDK_OFFSET(0x16F564D0)
#define RPG_GAMECORE_SHOWBOSSHPVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F56520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowBossHPValue_TypeDefinitionIndex = 20590;
