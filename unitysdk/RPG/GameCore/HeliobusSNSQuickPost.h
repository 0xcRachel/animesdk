...
#define RPG_GAMECORE_HELIOBUSSNSQUICKPOST_METHOD_3_290C438F86DD79AC_OFFSET UNITYSDK_OFFSET(0x16B6B100)
#define RPG_GAMECORE_HELIOBUSSNSQUICKPOST_METHOD_3_E4CCEDE781054E7C_OFFSET UNITYSDK_OFFSET(0x16B6B180)
#define RPG_GAMECORE_HELIOBUSSNSQUICKPOST__CTOR_OFFSET UNITYSDK_OFFSET(0x16B6B150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HeliobusSNSQuickPost_TypeDefinitionIndex = 18228;
