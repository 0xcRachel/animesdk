...
#define RPG_GAMECORE_TOGGLESPECIALSKILLMARK_METHOD_3_17DFEE9F00AC66BE_OFFSET UNITYSDK_OFFSET(0x170FA1F0)
#define RPG_GAMECORE_TOGGLESPECIALSKILLMARK_METHOD_3_4ECAFB252043D17D_OFFSET UNITYSDK_OFFSET(0x170FA170)
#define RPG_GAMECORE_TOGGLESPECIALSKILLMARK__CTOR_OFFSET UNITYSDK_OFFSET(0x170FA1C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ToggleSpecialSkillMark_TypeDefinitionIndex = 21372;
