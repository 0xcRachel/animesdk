...
#define RPG_GAMECORE_SETDYNAMICVALUEBYADSORPTION_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x192FF670)
#define RPG_GAMECORE_SETDYNAMICVALUEBYADSORPTION_METHOD_4_165FBC07AF037848_OFFSET UNITYSDK_OFFSET(0x192FF5F0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYADSORPTION_METHOD_4_34BCA9AB9320606C_OFFSET UNITYSDK_OFFSET(0x192FCB00)
#define RPG_GAMECORE_SETDYNAMICVALUEBYADSORPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x192FCAB0)
