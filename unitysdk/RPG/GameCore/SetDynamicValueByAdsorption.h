...
#define RPG_GAMECORE_SETDYNAMICVALUEBYADSORPTION_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1A1FA850)
#define RPG_GAMECORE_SETDYNAMICVALUEBYADSORPTION_METHOD_4_4F2CC875B65721CB_OFFSET UNITYSDK_OFFSET(0x1A1FA7D0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYADSORPTION_METHOD_4_FEB84096FF7BE1A3_OFFSET UNITYSDK_OFFSET(0x1A1F07A0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYADSORPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1F0750)
