...
#define RPG_GAMECORE_STARTBATTLESCORINGABILITY_METHOD_3_8327C47FE48D0D90_OFFSET UNITYSDK_OFFSET(0x16F946B0)
#define RPG_GAMECORE_STARTBATTLESCORINGABILITY_METHOD_3_C63CD54A9892DFDC_OFFSET UNITYSDK_OFFSET(0x16F947C0)
#define RPG_GAMECORE_STARTBATTLESCORINGABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x16F94790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartBattleScoringAbility_TypeDefinitionIndex = 21090;
