...
#define RPG_GAMECORE_HOYOGROUPSTREAMINGBLACKLISTITEM_METHOD_2_7CA2615DEE69DD8C_OFFSET UNITYSDK_OFFSET(0x16B77B30)
#define RPG_GAMECORE_HOYOGROUPSTREAMINGBLACKLISTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x16B77C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HoYoGroupStreamingBlackListItem_TypeDefinitionIndex = 15656;
