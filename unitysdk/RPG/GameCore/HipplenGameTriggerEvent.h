...
#define RPG_GAMECORE_HIPPLENGAMETRIGGEREVENT_METHOD_3_08A1D262F1233F7A_OFFSET UNITYSDK_OFFSET(0x172C1D20)
#define RPG_GAMECORE_HIPPLENGAMETRIGGEREVENT_METHOD_3_8B6CA4415683C903_OFFSET UNITYSDK_OFFSET(0x172C1CA0)
#define RPG_GAMECORE_HIPPLENGAMETRIGGEREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x172C1CF0)
