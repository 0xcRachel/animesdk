...
#define RPG_GAMECORE_DRINKMAKERCHEERSCOMMENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16A47CF0)
#define RPG_GAMECORE_DRINKMAKERCHEERSCOMMENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16A47F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DrinkMakerCheersCommentRow_TypeDefinitionIndex = 11984;
	...
	public:
		...
		::RPG::Client::TextID Comment; // 0x20
