...
#define RPG_GAMECORE_BYISINCHARACTERIDGROUP_METHOD_4_8D921F136B18F253_OFFSET UNITYSDK_OFFSET(0x16932170)
#define RPG_GAMECORE_BYISINCHARACTERIDGROUP_METHOD_4_F15D30BEF0753F17_OFFSET UNITYSDK_OFFSET(0x16932240)
#define RPG_GAMECORE_BYISINCHARACTERIDGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x169321F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsInCharacterIDGroup_TypeDefinitionIndex = 21037;
