...
#define RPG_GAMECORE_SHOWGUIDEHINTWITHTEXT_METHOD_3_23EF75B7FE80CADA_OFFSET UNITYSDK_OFFSET(0x16F5BC50)
#define RPG_GAMECORE_SHOWGUIDEHINTWITHTEXT_METHOD_3_7E48DDECFB1CB741_OFFSET UNITYSDK_OFFSET(0x16F5BCF0)
#define RPG_GAMECORE_SHOWGUIDEHINTWITHTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F5BCB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowGuideHintWithText_TypeDefinitionIndex = 21805;
