...
#define RPG_GAMECORE_CHIMERADUELCONDITIONCONFIG_METHOD_2_6A2C2D5DDA37ABF7_OFFSET UNITYSDK_OFFSET(0x196B4F30)
#define RPG_GAMECORE_CHIMERADUELCONDITIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x196B5030)
