...
#define RPG_GAMECORE_FIVEDIMTRAMPOLINECONFIG_METHOD_3_420B248E8F3C789A_OFFSET UNITYSDK_OFFSET(0x17224C90)
#define RPG_GAMECORE_FIVEDIMTRAMPOLINECONFIG_METHOD_3_72704E4310E0CF38_OFFSET UNITYSDK_OFFSET(0x1720FA80)
#define RPG_GAMECORE_FIVEDIMTRAMPOLINECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17224C70)
