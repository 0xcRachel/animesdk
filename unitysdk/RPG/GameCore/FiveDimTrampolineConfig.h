...
#define RPG_GAMECORE_FIVEDIMTRAMPOLINECONFIG_METHOD_3_420B248E8F3C789A_OFFSET UNITYSDK_OFFSET(0x16AD8FD0)
#define RPG_GAMECORE_FIVEDIMTRAMPOLINECONFIG_METHOD_3_72704E4310E0CF38_OFFSET UNITYSDK_OFFSET(0x16ABA810)
#define RPG_GAMECORE_FIVEDIMTRAMPOLINECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16AD8FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimTrampolineConfig_TypeDefinitionIndex = 16642;
