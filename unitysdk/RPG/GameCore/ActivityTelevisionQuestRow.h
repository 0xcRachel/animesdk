...
#define RPG_GAMECORE_ACTIVITYTELEVISIONQUESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x167B6130)
#define RPG_GAMECORE_ACTIVITYTELEVISIONQUESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x167B67C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityTelevisionQuestRow_TypeDefinitionIndex = 11333;
