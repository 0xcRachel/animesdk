...
#define RPG_GAMECORE_ELFWAVEORDER_METHOD_2_3516F600CFD2FDC1_OFFSET UNITYSDK_OFFSET(0x16A646F0)
#define RPG_GAMECORE_ELFWAVEORDER__CTOR_OFFSET UNITYSDK_OFFSET(0x16A647D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfWaveOrder_TypeDefinitionIndex = 16597;
