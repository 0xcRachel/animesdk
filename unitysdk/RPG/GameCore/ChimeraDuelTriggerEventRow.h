...
#define RPG_GAMECORE_CHIMERADUELTRIGGEREVENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16999C30)
#define RPG_GAMECORE_CHIMERADUELTRIGGEREVENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16999DE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelTriggerEventRow_TypeDefinitionIndex = 10356;
