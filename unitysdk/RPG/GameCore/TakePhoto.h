...
#define RPG_GAMECORE_TAKEPHOTO_METHOD_3_036C4F56FFFB19FE_OFFSET UNITYSDK_OFFSET(0x199CAFE0)
#define RPG_GAMECORE_TAKEPHOTO_METHOD_3_E21EA03FEA077872_OFFSET UNITYSDK_OFFSET(0x199CAED0)
#define RPG_GAMECORE_TAKEPHOTO__CTOR_OFFSET UNITYSDK_OFFSET(0x199CAFB0)
