...
#define RPG_GAMECORE_TAKEPHOTO_METHOD_3_036C4F56FFFB19FE_OFFSET UNITYSDK_OFFSET(0x198702A0)
#define RPG_GAMECORE_TAKEPHOTO_METHOD_3_E21EA03FEA077872_OFFSET UNITYSDK_OFFSET(0x19870190)
#define RPG_GAMECORE_TAKEPHOTO__CTOR_OFFSET UNITYSDK_OFFSET(0x19870270)
