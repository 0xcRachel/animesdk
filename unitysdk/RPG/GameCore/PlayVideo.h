...
#define RPG_GAMECORE_PLAYVIDEO_METHOD_3_1BDF90B2EDB7B6F8_OFFSET UNITYSDK_OFFSET(0x18B3CF30)
#define RPG_GAMECORE_PLAYVIDEO_METHOD_3_A05594646C89B722_OFFSET UNITYSDK_OFFSET(0x18B3CE90)
#define RPG_GAMECORE_PLAYVIDEO__CTOR_OFFSET UNITYSDK_OFFSET(0x18B3CEF0)
