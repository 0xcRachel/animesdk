...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::PamActionType>**)Il2CppClass::FromTypeDefinitionIndex(PamPlaceInfoRow___O_TypeDefinitionIndex)->GetStaticField(0x374A0);
		}
	};
}
