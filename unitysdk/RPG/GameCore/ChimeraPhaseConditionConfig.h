...
#define RPG_GAMECORE_CHIMERAPHASECONDITIONCONFIG_METHOD_2_D83170B07782E3C6_OFFSET UNITYSDK_OFFSET(0x1699BFE0)
#define RPG_GAMECORE_CHIMERAPHASECONDITIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1699C0E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraPhaseConditionConfig_TypeDefinitionIndex = 14328;
