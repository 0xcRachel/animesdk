...
#define RPG_GAMECORE_PLAYORIGAMITRACETALK_METHOD_3_6DD1C4C46E121274_OFFSET UNITYSDK_OFFSET(0x16D50F70)
#define RPG_GAMECORE_PLAYORIGAMITRACETALK_METHOD_3_AC3213DE03C86F03_OFFSET UNITYSDK_OFFSET(0x16D50FF0)
#define RPG_GAMECORE_PLAYORIGAMITRACETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x16D50FC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayOrigamiTraceTalk_TypeDefinitionIndex = 19511;
