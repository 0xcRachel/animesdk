...
#define RPG_GAMECORE_ROGUEADVENTUREROOMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16E12AA0)
#define RPG_GAMECORE_ROGUEADVENTUREROOMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16E12C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAdventureRoomRow_TypeDefinitionIndex = 13365;
