...
#define RPG_GAMECORE_ROGUEADVENTUREROOMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x175F0CD0)
#define RPG_GAMECORE_ROGUEADVENTUREROOMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x175F0E40)
