...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::AvatarPropertyType>**)Il2CppClass::FromTypeDefinitionIndex(AvatarPropertyOverrideRow___O_TypeDefinitionIndex)->GetStaticField(0xCC60);
		}
	};
}
