...
#define RPG_GAMECORE_PLAYERPARAMFULLHPAVATARCOUNTCONFIG_METHOD_5_979C82B1B615A5C6_OFFSET UNITYSDK_OFFSET(0x1A768250)
#define RPG_GAMECORE_PLAYERPARAMFULLHPAVATARCOUNTCONFIG_METHOD_5_98805422CF4FB45A_OFFSET UNITYSDK_OFFSET(0x1A768090)
#define RPG_GAMECORE_PLAYERPARAMFULLHPAVATARCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A768190)
