...
#define RPG_GAMECORE_ENABLENPCMONSTERAI_METHOD_3_325A992D91EDD1DD_OFFSET UNITYSDK_OFFSET(0x16A6AAE0)
#define RPG_GAMECORE_ENABLENPCMONSTERAI_METHOD_3_ABD8CFB81786013F_OFFSET UNITYSDK_OFFSET(0x16A6AA50)
#define RPG_GAMECORE_ENABLENPCMONSTERAI__CTOR_OFFSET UNITYSDK_OFFSET(0x16A6AAB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableNPCMonsterAI_TypeDefinitionIndex = 18199;
