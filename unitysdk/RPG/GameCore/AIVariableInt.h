...
#define RPG_GAMECORE_AIVARIABLEINT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x16EA8700)
#define RPG_GAMECORE_AIVARIABLEINT_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x16EA8670)
#define RPG_GAMECORE_AIVARIABLEINT_EQUALS_OFFSET UNITYSDK_OFFSET(0x16EA8620)
#define RPG_GAMECORE_AIVARIABLEINT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x16EA87C0)
#define RPG_GAMECORE_AIVARIABLEINT_METHOD_3_4A36F66A17625501_1_OFFSET UNITYSDK_OFFSET(0x16EA88B0)
#define RPG_GAMECORE_AIVARIABLEINT_METHOD_3_4A36F66A17625501_OFFSET UNITYSDK_OFFSET(0x16EA8870)
#define RPG_GAMECORE_AIVARIABLEINT_METHOD_3_8CA41CC098D6F426_OFFSET UNITYSDK_OFFSET(0x16EA7640)
#define RPG_GAMECORE_AIVARIABLEINT_METHOD_3_9A3D7F22E23EA6A3_OFFSET UNITYSDK_OFFSET(0x16EA85F0)
#define RPG_GAMECORE_AIVARIABLEINT__CTOR_OFFSET UNITYSDK_OFFSET(0x16EA7630)
