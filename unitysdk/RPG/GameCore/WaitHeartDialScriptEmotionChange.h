...
#define RPG_GAMECORE_WAITHEARTDIALSCRIPTEMOTIONCHANGE_METHOD_3_4E920D93B193E534_OFFSET UNITYSDK_OFFSET(0x17154250)
#define RPG_GAMECORE_WAITHEARTDIALSCRIPTEMOTIONCHANGE_METHOD_3_6256947F0D3C78F4_OFFSET UNITYSDK_OFFSET(0x171542E0)
#define RPG_GAMECORE_WAITHEARTDIALSCRIPTEMOTIONCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x171542B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitHeartDialScriptEmotionChange_TypeDefinitionIndex = 18992;
