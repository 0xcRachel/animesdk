...
#define RPG_GAMECORE_ROGUEACTCHANGEROGUEMIRACLETOROGUEMIRACLECONFIG_METHOD_6_B531DAABC539CB30_OFFSET UNITYSDK_OFFSET(0x1A302460)
#define RPG_GAMECORE_ROGUEACTCHANGEROGUEMIRACLETOROGUEMIRACLECONFIG_METHOD_6_D87CCD3E99B0C64D_OFFSET UNITYSDK_OFFSET(0x1A302680)
#define RPG_GAMECORE_ROGUEACTCHANGEROGUEMIRACLETOROGUEMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3025A0)
