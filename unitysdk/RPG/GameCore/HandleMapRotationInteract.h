...
#define RPG_GAMECORE_HANDLEMAPROTATIONINTERACT_METHOD_3_1564A95E1A89D723_OFFSET UNITYSDK_OFFSET(0x16B5A510)
#define RPG_GAMECORE_HANDLEMAPROTATIONINTERACT_METHOD_3_17CE552B4A8A2B25_OFFSET UNITYSDK_OFFSET(0x16B5A590)
#define RPG_GAMECORE_HANDLEMAPROTATIONINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x16B5A560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HandleMapRotationInteract_TypeDefinitionIndex = 19959;
