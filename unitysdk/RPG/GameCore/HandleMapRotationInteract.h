...
#define RPG_GAMECORE_HANDLEMAPROTATIONINTERACT_METHOD_3_1564A95E1A89D723_OFFSET UNITYSDK_OFFSET(0x172A8BF0)
#define RPG_GAMECORE_HANDLEMAPROTATIONINTERACT_METHOD_3_17CE552B4A8A2B25_OFFSET UNITYSDK_OFFSET(0x172A8C70)
#define RPG_GAMECORE_HANDLEMAPROTATIONINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x172A8C40)
