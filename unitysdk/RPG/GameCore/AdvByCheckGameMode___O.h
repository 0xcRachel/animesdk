...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_9EB2CB86795DEEF1_DelegateParseJson_1<::RPG::GameCore::GameModeType>**)Il2CppClass::FromTypeDefinitionIndex(AdvByCheckGameMode___O_TypeDefinitionIndex)->GetStaticField(0x67D60);
		}
	};
}
