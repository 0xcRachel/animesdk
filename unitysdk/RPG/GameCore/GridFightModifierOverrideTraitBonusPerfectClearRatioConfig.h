...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEROVERRIDETRAITBONUSPERFECTCLEARRATIOCONFIG_METHOD_3_ADCF87A91C2E2E00_OFFSET UNITYSDK_OFFSET(0x16B2F960)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEROVERRIDETRAITBONUSPERFECTCLEARRATIOCONFIG_METHOD_3_BC10D9D4669B9669_OFFSET UNITYSDK_OFFSET(0x16B337C0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEROVERRIDETRAITBONUSPERFECTCLEARRATIOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16B2F910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierOverrideTraitBonusPerfectClearRatioConfig_TypeDefinitionIndex = 17453;
