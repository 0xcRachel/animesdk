...
#define RPG_GAMECORE_ADDGLOBALDYNAMICOFFSETIGNOREENTITY_METHOD_3_4C8DF3AB0EF33FE7_OFFSET UNITYSDK_OFFSET(0x18DB2DF0)
#define RPG_GAMECORE_ADDGLOBALDYNAMICOFFSETIGNOREENTITY_METHOD_3_DC625F6680ADA24E_OFFSET UNITYSDK_OFFSET(0x18DB2E70)
#define RPG_GAMECORE_ADDGLOBALDYNAMICOFFSETIGNOREENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x18DB2E40)
