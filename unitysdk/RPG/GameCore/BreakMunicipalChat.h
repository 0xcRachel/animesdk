...
#define RPG_GAMECORE_BREAKMUNICIPALCHAT_METHOD_3_184DF2C147AC1120_OFFSET UNITYSDK_OFFSET(0x1700C860)
#define RPG_GAMECORE_BREAKMUNICIPALCHAT_METHOD_3_E03E0D0FBEFA82B1_OFFSET UNITYSDK_OFFSET(0x1700C7E0)
#define RPG_GAMECORE_BREAKMUNICIPALCHAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1700C830)
