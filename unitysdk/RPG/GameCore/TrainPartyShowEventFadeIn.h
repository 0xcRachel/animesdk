...
#define RPG_GAMECORE_TRAINPARTYSHOWEVENTFADEIN_METHOD_3_7B98257C7AC6FC29_OFFSET UNITYSDK_OFFSET(0x17107D10)
#define RPG_GAMECORE_TRAINPARTYSHOWEVENTFADEIN_METHOD_3_94F56E17D97AD626_OFFSET UNITYSDK_OFFSET(0x17107D90)
#define RPG_GAMECORE_TRAINPARTYSHOWEVENTFADEIN__CTOR_OFFSET UNITYSDK_OFFSET(0x17107D60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyShowEventFadeIn_TypeDefinitionIndex = 20028;
