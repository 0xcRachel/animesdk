...
#define RPG_GAMECORE_PAUSEMUSICVISUALEFFECT_METHOD_3_14E44F1002B830BE_OFFSET UNITYSDK_OFFSET(0x16D1B030)
#define RPG_GAMECORE_PAUSEMUSICVISUALEFFECT_METHOD_3_5455548857FFD59E_OFFSET UNITYSDK_OFFSET(0x16D1B180)
#define RPG_GAMECORE_PAUSEMUSICVISUALEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x16D1B0F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PauseMusicVisualEffect_TypeDefinitionIndex = 19968;
