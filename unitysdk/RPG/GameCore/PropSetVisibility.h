...
#define RPG_GAMECORE_PROPSETVISIBILITY_METHOD_3_7982506B62293525_OFFSET UNITYSDK_OFFSET(0x16DB2EA0)
#define RPG_GAMECORE_PROPSETVISIBILITY_METHOD_3_8B4AB4C7C40E0BEF_OFFSET UNITYSDK_OFFSET(0x16DB2D50)
#define RPG_GAMECORE_PROPSETVISIBILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x16DB2E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropSetVisibility_TypeDefinitionIndex = 18175;
