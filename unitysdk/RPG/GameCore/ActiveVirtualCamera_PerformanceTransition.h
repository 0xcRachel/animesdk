...
#define RPG_GAMECORE_ACTIVEVIRTUALCAMERA_PERFORMANCETRANSITION_METHOD_3_2B8DAD87E37E1F9B_OFFSET UNITYSDK_OFFSET(0x16780FC0)
#define RPG_GAMECORE_ACTIVEVIRTUALCAMERA_PERFORMANCETRANSITION_METHOD_3_844132D0780C62B7_OFFSET UNITYSDK_OFFSET(0x167815D0)
#define RPG_GAMECORE_ACTIVEVIRTUALCAMERA_PERFORMANCETRANSITION_METHOD_3_CB29BCDA95B08A8C_OFFSET UNITYSDK_OFFSET(0x16780F50)
#define RPG_GAMECORE_ACTIVEVIRTUALCAMERA_PERFORMANCETRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x16780F00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActiveVirtualCamera_PerformanceTransition_TypeDefinitionIndex = 19501;
