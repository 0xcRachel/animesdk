...
#define RPG_GAMECORE_BYCOMPAREALIVEENEMYNUMBER_METHOD_4_3FA2165BE2FC0B58_OFFSET UNITYSDK_OFFSET(0x16905BC0)
#define RPG_GAMECORE_BYCOMPAREALIVEENEMYNUMBER_METHOD_4_6BE9488387CCC58A_OFFSET UNITYSDK_OFFSET(0x16905C90)
#define RPG_GAMECORE_BYCOMPAREALIVEENEMYNUMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x16905C40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareAliveEnemyNumber_TypeDefinitionIndex = 20643;
