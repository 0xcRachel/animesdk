...
#define RPG_GAMECORE_BYCOMPAREALIVEENEMYNUMBER_METHOD_4_3FA2165BE2FC0B58_OFFSET UNITYSDK_OFFSET(0x19ABCE80)
#define RPG_GAMECORE_BYCOMPAREALIVEENEMYNUMBER_METHOD_4_6BE9488387CCC58A_OFFSET UNITYSDK_OFFSET(0x19ABCF50)
#define RPG_GAMECORE_BYCOMPAREALIVEENEMYNUMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x19ABCF00)
