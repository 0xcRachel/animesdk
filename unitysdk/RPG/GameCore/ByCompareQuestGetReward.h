...
#define RPG_GAMECORE_BYCOMPAREQUESTGETREWARD_METHOD_4_409378A17EE349AA_OFFSET UNITYSDK_OFFSET(0x16917450)
#define RPG_GAMECORE_BYCOMPAREQUESTGETREWARD_METHOD_4_98BB74D6EF2F8478_OFFSET UNITYSDK_OFFSET(0x16917520)
#define RPG_GAMECORE_BYCOMPAREQUESTGETREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x169174D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareQuestGetReward_TypeDefinitionIndex = 19527;
