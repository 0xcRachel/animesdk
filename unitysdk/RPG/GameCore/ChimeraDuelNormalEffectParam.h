...
#define RPG_GAMECORE_CHIMERADUELNORMALEFFECTPARAM_METHOD_3_1489FFA34F0562A0_OFFSET UNITYSDK_OFFSET(0x170B5770)
#define RPG_GAMECORE_CHIMERADUELNORMALEFFECTPARAM_METHOD_3_80EC19AA4C0131B0_OFFSET UNITYSDK_OFFSET(0x170B57D0)
#define RPG_GAMECORE_CHIMERADUELNORMALEFFECTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x170B57C0)
