...
#define RPG_GAMECORE_CHIMERADUELNORMALEFFECTPARAM_METHOD_3_1489FFA34F0562A0_OFFSET UNITYSDK_OFFSET(0x16993A20)
#define RPG_GAMECORE_CHIMERADUELNORMALEFFECTPARAM_METHOD_3_80EC19AA4C0131B0_OFFSET UNITYSDK_OFFSET(0x16993A80)
#define RPG_GAMECORE_CHIMERADUELNORMALEFFECTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x16993A70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelNormalEffectParam_TypeDefinitionIndex = 14455;
