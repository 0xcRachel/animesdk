...
#define RPG_GAMECORE_FIVEDIMSETPLAYERSKILLMOVEACTION_METHOD_3_46EB146A57643508_OFFSET UNITYSDK_OFFSET(0x1A3A27C0)
#define RPG_GAMECORE_FIVEDIMSETPLAYERSKILLMOVEACTION_METHOD_3_65337BCAC7328F3C_OFFSET UNITYSDK_OFFSET(0x1A3A2690)
#define RPG_GAMECORE_FIVEDIMSETPLAYERSKILLMOVEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3A27A0)
