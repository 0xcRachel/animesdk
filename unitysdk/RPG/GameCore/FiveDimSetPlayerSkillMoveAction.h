...
#define RPG_GAMECORE_FIVEDIMSETPLAYERSKILLMOVEACTION_METHOD_3_46EB146A57643508_OFFSET UNITYSDK_OFFSET(0x16AD3D30)
#define RPG_GAMECORE_FIVEDIMSETPLAYERSKILLMOVEACTION_METHOD_3_65337BCAC7328F3C_OFFSET UNITYSDK_OFFSET(0x16AD3C00)
#define RPG_GAMECORE_FIVEDIMSETPLAYERSKILLMOVEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16AD3D10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetPlayerSkillMoveAction_TypeDefinitionIndex = 16822;
