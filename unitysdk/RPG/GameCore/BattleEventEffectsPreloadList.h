...
#define RPG_GAMECORE_BATTLEEVENTEFFECTSPRELOADLIST_METHOD_3_1280AF0908DD47FD_OFFSET UNITYSDK_OFFSET(0x16FE8260)
#define RPG_GAMECORE_BATTLEEVENTEFFECTSPRELOADLIST_METHOD_3_AA859EE251C98AC8_OFFSET UNITYSDK_OFFSET(0x16FE8220)
#define RPG_GAMECORE_BATTLEEVENTEFFECTSPRELOADLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE8250)
