...
#define RPG_GAMECORE_DEVICERELATEDAVATARASSETPRELOADCONFIG_METHOD_3_4DDD68D2A31FD705_OFFSET UNITYSDK_OFFSET(0x19586C20)
#define RPG_GAMECORE_DEVICERELATEDAVATARASSETPRELOADCONFIG_METHOD_3_874B1EF7036DF083_OFFSET UNITYSDK_OFFSET(0x19586C80)
#define RPG_GAMECORE_DEVICERELATEDAVATARASSETPRELOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19586C70)
