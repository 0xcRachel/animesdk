...
#define RPG_GAMECORE_ADVBYROLLSHOPRESULT_METHOD_4_090ED2386C9E9A51_OFFSET UNITYSDK_OFFSET(0x1955CA20)
#define RPG_GAMECORE_ADVBYROLLSHOPRESULT_METHOD_4_5FC216021C221283_OFFSET UNITYSDK_OFFSET(0x1955C6D0)
#define RPG_GAMECORE_ADVBYROLLSHOPRESULT_METHOD_4_9D89A1907B04791F_OFFSET UNITYSDK_OFFSET(0x1955C7A0)
#define RPG_GAMECORE_ADVBYROLLSHOPRESULT_METHOD_4_E52EC084839301E2_OFFSET UNITYSDK_OFFSET(0x1955C9A0)
#define RPG_GAMECORE_ADVBYROLLSHOPRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1955C750)
