...
#define RPG_GAMECORE_ADVBYROLLSHOPRESULT_METHOD_4_5FC216021C221283_OFFSET UNITYSDK_OFFSET(0x18DBDB90)
#define RPG_GAMECORE_ADVBYROLLSHOPRESULT_METHOD_4_9D89A1907B04791F_OFFSET UNITYSDK_OFFSET(0x18DBDC60)
#define RPG_GAMECORE_ADVBYROLLSHOPRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x18DBDC10)
