...
#define RPG_GAMECORE_OPENRAID_METHOD_3_166BD1B92EED31B4_OFFSET UNITYSDK_OFFSET(0x16D0A4D0)
#define RPG_GAMECORE_OPENRAID_METHOD_3_FE8C92DF8C8FB525_OFFSET UNITYSDK_OFFSET(0x16D0A550)
#define RPG_GAMECORE_OPENRAID__CTOR_OFFSET UNITYSDK_OFFSET(0x16D0A520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OpenRaid_TypeDefinitionIndex = 19249;
