...
#define RPG_GAMECORE_OPENRAID_METHOD_3_166BD1B92EED31B4_OFFSET UNITYSDK_OFFSET(0x17490D90)
#define RPG_GAMECORE_OPENRAID_METHOD_3_FE8C92DF8C8FB525_OFFSET UNITYSDK_OFFSET(0x17490E10)
#define RPG_GAMECORE_OPENRAID__CTOR_OFFSET UNITYSDK_OFFSET(0x17490DE0)
