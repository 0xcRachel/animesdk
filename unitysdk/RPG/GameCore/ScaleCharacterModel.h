...
#define RPG_GAMECORE_SCALECHARACTERMODEL_METHOD_3_1955D8FE7A261719_OFFSET UNITYSDK_OFFSET(0x16EF9D20)
#define RPG_GAMECORE_SCALECHARACTERMODEL_METHOD_3_94AA597E068738FA_OFFSET UNITYSDK_OFFSET(0x16EF9C40)
#define RPG_GAMECORE_SCALECHARACTERMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x16EF9CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ScaleCharacterModel_TypeDefinitionIndex = 20367;
