...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::CharacterMotionFlag>**)Il2CppClass::FromTypeDefinitionIndex(AdvNPCPatrol___O_TypeDefinitionIndex)->GetStaticField(0x8360);
		}
	};
}
