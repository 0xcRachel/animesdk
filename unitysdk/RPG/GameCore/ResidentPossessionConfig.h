...
#define RPG_GAMECORE_RESIDENTPOSSESSIONCONFIG_METHOD_2_77CB37C830722391_OFFSET UNITYSDK_OFFSET(0x1A2EF800)
#define RPG_GAMECORE_RESIDENTPOSSESSIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2EF990)
