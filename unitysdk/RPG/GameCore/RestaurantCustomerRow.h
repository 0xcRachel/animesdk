...
#define RPG_GAMECORE_RESTAURANTCUSTOMERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A2F2880)
#define RPG_GAMECORE_RESTAURANTCUSTOMERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2F2BF0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::RestaurantCustomerType Type; // 0x44
