...
#define RPG_GAMECORE_RESTAURANTCUSTOMERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x190331E0)
#define RPG_GAMECORE_RESTAURANTCUSTOMERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19033550)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 CustomerID; // 0x44
		::RPG::GameCore::RestaurantCustomerType Type; // 0x48
