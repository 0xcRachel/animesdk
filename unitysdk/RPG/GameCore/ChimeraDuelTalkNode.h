...
#define RPG_GAMECORE_CHIMERADUELTALKNODE_METHOD_3_12EDFA6FDC1A917F_OFFSET UNITYSDK_OFFSET(0x194C91D0)
#define RPG_GAMECORE_CHIMERADUELTALKNODE_METHOD_3_D03E6B265D9017B1_OFFSET UNITYSDK_OFFSET(0x194C92D0)
#define RPG_GAMECORE_CHIMERADUELTALKNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x194C9270)
