...
#define RPG_GAMECORE_CHIMERADUELTALKNODE_METHOD_3_12EDFA6FDC1A917F_OFFSET UNITYSDK_OFFSET(0x169997B0)
#define RPG_GAMECORE_CHIMERADUELTALKNODE_METHOD_3_D03E6B265D9017B1_OFFSET UNITYSDK_OFFSET(0x169998B0)
#define RPG_GAMECORE_CHIMERADUELTALKNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x16999850)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelTalkNode_TypeDefinitionIndex = 14414;
