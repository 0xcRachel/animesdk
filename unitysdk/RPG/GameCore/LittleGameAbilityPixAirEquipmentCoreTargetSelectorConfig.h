...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREQUIPMENTCORETARGETSELECTORCONFIG_METHOD_3_3CBB5C5B998B5D9B_OFFSET UNITYSDK_OFFSET(0x1A120B50)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREQUIPMENTCORETARGETSELECTORCONFIG_METHOD_3_C95ADABF6E742F0F_OFFSET UNITYSDK_OFFSET(0x1A120C60)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREQUIPMENTCORETARGETSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A120C50)
