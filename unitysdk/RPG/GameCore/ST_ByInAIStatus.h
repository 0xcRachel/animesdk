...
#define RPG_GAMECORE_ST_BYINAISTATUS_METHOD_4_879CC8C5E7F577A6_OFFSET UNITYSDK_OFFSET(0x16EF0B30)
#define RPG_GAMECORE_ST_BYINAISTATUS_METHOD_4_E172B2C343178AF8_OFFSET UNITYSDK_OFFSET(0x16EF0A60)
#define RPG_GAMECORE_ST_BYINAISTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x16EF0AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByInAIStatus_TypeDefinitionIndex = 17848;
