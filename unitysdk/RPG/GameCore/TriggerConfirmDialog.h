...
#define RPG_GAMECORE_TRIGGERCONFIRMDIALOG_METHOD_3_55A3946D286CAD7F_OFFSET UNITYSDK_OFFSET(0x17119020)
#define RPG_GAMECORE_TRIGGERCONFIRMDIALOG_METHOD_3_A128247BC5B1628F_OFFSET UNITYSDK_OFFSET(0x171190A0)
#define RPG_GAMECORE_TRIGGERCONFIRMDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x17119070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerConfirmDialog_TypeDefinitionIndex = 19208;
