...
#define RPG_GAMECORE_ADVSETHOYOGROUPNPCANIMSPEEDRATIO_METHOD_3_4F827CBB7611E609_OFFSET UNITYSDK_OFFSET(0x16847ED0)
#define RPG_GAMECORE_ADVSETHOYOGROUPNPCANIMSPEEDRATIO_METHOD_3_9D34A904EE945122_OFFSET UNITYSDK_OFFSET(0x16847E50)
#define RPG_GAMECORE_ADVSETHOYOGROUPNPCANIMSPEEDRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x16847EA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetHoyoGroupNpcAnimSpeedRatio_TypeDefinitionIndex = 18834;
