...
#define RPG_GAMECORE_CUTSCENESFXCONFIG_METHOD_2_F6D2761B470AC1B4_OFFSET UNITYSDK_OFFSET(0x18FB4A60)
#define RPG_GAMECORE_CUTSCENESFXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18FB4B60)
