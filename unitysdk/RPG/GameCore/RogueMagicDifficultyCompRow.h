...
#define RPG_GAMECORE_ROGUEMAGICDIFFICULTYCOMPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16E86750)
#define RPG_GAMECORE_ROGUEMAGICDIFFICULTYCOMPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16E86990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMagicDifficultyCompRow_TypeDefinitionIndex = 13519;

	class RogueMagicDifficultyCompRow : public ::System::Object
	{
	public:
		::Il2CppArray<::RPG::GameCore::FixPoint>* ParamList; // 0x10
		::System::UInt32 DifficultyCompID; // 0x18
