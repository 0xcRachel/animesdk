...
#define RPG_GAMECORE_ASSISTWAYPOINTCONDITION_METHOD_2_3E3F0CAE554016C5_OFFSET UNITYSDK_OFFSET(0x18BE26F0)
#define RPG_GAMECORE_ASSISTWAYPOINTCONDITION_METHOD_2_94EAB48016E76E75_OFFSET UNITYSDK_OFFSET(0x18BE3C30)
#define RPG_GAMECORE_ASSISTWAYPOINTCONDITION_METHOD_2_A08C4CA112427212_OFFSET UNITYSDK_OFFSET(0x18BE4010)
#define RPG_GAMECORE_ASSISTWAYPOINTCONDITION_METHOD_2_FC1B6B2B93097560_OFFSET UNITYSDK_OFFSET(0x18BE2A50)
#define RPG_GAMECORE_ASSISTWAYPOINTCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x18BE2A40)
