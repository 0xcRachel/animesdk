...
#define RPG_GAMECORE_BYHASSPARETEAMFORMATION_METHOD_4_284602E848201C34_OFFSET UNITYSDK_OFFSET(0x17039440)
#define RPG_GAMECORE_BYHASSPARETEAMFORMATION_METHOD_4_FCB989898B621DC4_OFFSET UNITYSDK_OFFSET(0x17039510)
#define RPG_GAMECORE_BYHASSPARETEAMFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x170394C0)
