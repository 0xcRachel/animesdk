...
#define RPG_GAMECORE_TARGETFETCHAIDATTACKER_METHOD_4_5064AA45E7DA9AA7_OFFSET UNITYSDK_OFFSET(0x177D0F90)
#define RPG_GAMECORE_TARGETFETCHAIDATTACKER_METHOD_4_F29601CF457A7449_OFFSET UNITYSDK_OFFSET(0x177C6360)
#define RPG_GAMECORE_TARGETFETCHAIDATTACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x177C6310)
