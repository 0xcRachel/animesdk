...
#define RPG_GAMECORE_NUMBARTYPECONFIG_METHOD_2_6D2242AA2333D3CF_OFFSET UNITYSDK_OFFSET(0x16D06E50)
#define RPG_GAMECORE_NUMBARTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16D06FC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NumBarTypeConfig_TypeDefinitionIndex = 20378;
