...
#define RPG_GAMECORE_SETMISSIONAUDIOSTATE_METHOD_3_178D291519872096_OFFSET UNITYSDK_OFFSET(0x16F342F0)
#define RPG_GAMECORE_SETMISSIONAUDIOSTATE_METHOD_3_2A623ED5ADA240B7_OFFSET UNITYSDK_OFFSET(0x16F34370)
#define RPG_GAMECORE_SETMISSIONAUDIOSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F34340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMissionAudioState_TypeDefinitionIndex = 19323;
