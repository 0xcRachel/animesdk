...
#define RPG_GAMECORE_SETMISSIONAUDIOSTATE_METHOD_3_178D291519872096_OFFSET UNITYSDK_OFFSET(0x199BBFB0)
#define RPG_GAMECORE_SETMISSIONAUDIOSTATE_METHOD_3_2A623ED5ADA240B7_OFFSET UNITYSDK_OFFSET(0x199BC030)
#define RPG_GAMECORE_SETMISSIONAUDIOSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x199BC000)
