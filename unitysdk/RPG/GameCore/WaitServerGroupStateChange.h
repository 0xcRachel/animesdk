...
#define RPG_GAMECORE_WAITSERVERGROUPSTATECHANGE_METHOD_3_A40EF486C07A2DB5_OFFSET UNITYSDK_OFFSET(0x1715C970)
#define RPG_GAMECORE_WAITSERVERGROUPSTATECHANGE_METHOD_3_E1B18BDDCB0E12A5_OFFSET UNITYSDK_OFFSET(0x1715C8E0)
#define RPG_GAMECORE_WAITSERVERGROUPSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1715C940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitServerGroupStateChange_TypeDefinitionIndex = 18954;
