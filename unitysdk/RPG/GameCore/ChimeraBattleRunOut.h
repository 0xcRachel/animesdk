...
#define RPG_GAMECORE_CHIMERABATTLERUNOUT_METHOD_3_DBAB9427723AB440_OFFSET UNITYSDK_OFFSET(0x16986900)
#define RPG_GAMECORE_CHIMERABATTLERUNOUT_METHOD_3_E1AE68D0C15291AE_OFFSET UNITYSDK_OFFSET(0x16984F80)
#define RPG_GAMECORE_CHIMERABATTLERUNOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x16984F70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattleRunOut_TypeDefinitionIndex = 14320;
