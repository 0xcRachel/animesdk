...
#define RPG_GAMECORE_MARBLESEALROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1997E310)
#define RPG_GAMECORE_MARBLESEALROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1997EC50)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* EnemyIconPath; // 0x30
		...
		::System::UInt32 UnlockBuySubMissionID; // 0xA0
		::System::UInt32 UnlockShowSubMissionID; // 0xA4
		::System::UInt32 ActivityID; // 0xA8
		::System::UInt32 ActionPriority; // 0xAC
		::RPG::GameCore::MultiPlayerGameMode GameMode; // 0xB0
		::System::Int32 Hp; // 0xB4
