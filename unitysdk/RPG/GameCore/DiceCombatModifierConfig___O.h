...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::DiceCombatModifierFlag>**)Il2CppClass::FromTypeDefinitionIndex(DiceCombatModifierConfig___O_TypeDefinitionIndex)->GetStaticField(0x1B1A0);
		}
	};
}
