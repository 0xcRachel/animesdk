...
#define RPG_GAMECORE_ROGUEACTREVIVEAVATARCONFIG_METHOD_6_2DF97855D0404C31_OFFSET UNITYSDK_OFFSET(0x1A9B5690)
#define RPG_GAMECORE_ROGUEACTREVIVEAVATARCONFIG_METHOD_6_FC77173B9CE8F0AC_OFFSET UNITYSDK_OFFSET(0x1A9B58B0)
#define RPG_GAMECORE_ROGUEACTREVIVEAVATARCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9B57D0)
