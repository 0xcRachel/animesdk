...
#define RPG_GAMECORE_WAITROTATABLEREGIONLOADFINISH_METHOD_3_8FA614DFAA768343_OFFSET UNITYSDK_OFFSET(0x19535460)
#define RPG_GAMECORE_WAITROTATABLEREGIONLOADFINISH_METHOD_3_91BB4142570908AF_OFFSET UNITYSDK_OFFSET(0x19535350)
#define RPG_GAMECORE_WAITROTATABLEREGIONLOADFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x19535430)
