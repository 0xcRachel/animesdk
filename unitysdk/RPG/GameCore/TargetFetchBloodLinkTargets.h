...
#define RPG_GAMECORE_TARGETFETCHBLOODLINKTARGETS_METHOD_4_2268F759788FF74B_OFFSET UNITYSDK_OFFSET(0x16FD4B60)
#define RPG_GAMECORE_TARGETFETCHBLOODLINKTARGETS_METHOD_4_239A10FDAAAA42B4_OFFSET UNITYSDK_OFFSET(0x16FDC130)
#define RPG_GAMECORE_TARGETFETCHBLOODLINKTARGETS__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD4B10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchBloodLinkTargets_TypeDefinitionIndex = 21650;
