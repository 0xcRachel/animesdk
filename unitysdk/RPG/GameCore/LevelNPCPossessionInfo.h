...
#define RPG_GAMECORE_LEVELNPCPOSSESSIONINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16BA21A0)
#define RPG_GAMECORE_LEVELNPCPOSSESSIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16BB0170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelNPCPossessionInfo_TypeDefinitionIndex = 15592;
