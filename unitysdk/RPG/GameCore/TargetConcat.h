...
#define RPG_GAMECORE_TARGETCONCAT_METHOD_4_4C0D9FF96DA62EA7_OFFSET UNITYSDK_OFFSET(0x16FCD540)
#define RPG_GAMECORE_TARGETCONCAT_METHOD_4_C8151DD4FBD16C23_OFFSET UNITYSDK_OFFSET(0x16FCD480)
#define RPG_GAMECORE_TARGETCONCAT__CTOR_OFFSET UNITYSDK_OFFSET(0x16FCD4F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetConcat_TypeDefinitionIndex = 21609;
