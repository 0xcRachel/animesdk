...
#define RPG_GAMECORE_ROGUETOURNLAYERROOMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1767F870)
#define RPG_GAMECORE_ROGUETOURNLAYERROOMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1767FAC0)
