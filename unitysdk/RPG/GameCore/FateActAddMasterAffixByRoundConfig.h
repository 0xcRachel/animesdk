...
#define RPG_GAMECORE_FATEACTADDMASTERAFFIXBYROUNDCONFIG_METHOD_6_5E7290C5F59FE890_OFFSET UNITYSDK_OFFSET(0x1946FB00)
#define RPG_GAMECORE_FATEACTADDMASTERAFFIXBYROUNDCONFIG_METHOD_6_C43400FC4FFED0CB_OFFSET UNITYSDK_OFFSET(0x1946F990)
#define RPG_GAMECORE_FATEACTADDMASTERAFFIXBYROUNDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1946FA60)
