...
#define RPG_GAMECORE_LEVELDIALOGINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16BA2730)
#define RPG_GAMECORE_LEVELDIALOGINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16BA28F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelDialogInfo_TypeDefinitionIndex = 15553;
