...
#define RPG_GAMECORE_ST_ELFBYISTAKEOUTSTATE_METHOD_4_5988BAF5157DD7AF_OFFSET UNITYSDK_OFFSET(0x16EF2D30)
#define RPG_GAMECORE_ST_ELFBYISTAKEOUTSTATE_METHOD_4_7AF2C8EF441224C1_OFFSET UNITYSDK_OFFSET(0x16EF2C60)
#define RPG_GAMECORE_ST_ELFBYISTAKEOUTSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16EF2CE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ElfByIsTakeOutState_TypeDefinitionIndex = 19197;
