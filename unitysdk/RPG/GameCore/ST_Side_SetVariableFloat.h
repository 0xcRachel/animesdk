...
#define RPG_GAMECORE_ST_SIDE_SETVARIABLEFLOAT_METHOD_4_8BCECC042922D9FD_OFFSET UNITYSDK_OFFSET(0x16EEC950)
#define RPG_GAMECORE_ST_SIDE_SETVARIABLEFLOAT_METHOD_4_BEE4A87945D4C5F5_OFFSET UNITYSDK_OFFSET(0x16EF9020)
#define RPG_GAMECORE_ST_SIDE_SETVARIABLEFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x16EEC900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_SetVariableFloat_TypeDefinitionIndex = 17874;
