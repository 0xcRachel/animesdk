...
#define RPG_GAMECORE_OFFLINECULLINGCONFIG_METHOD_2_0E7CF5ABF813FE71_OFFSET UNITYSDK_OFFSET(0x18EEDAF0)
#define RPG_GAMECORE_OFFLINECULLINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18EEDCB0)
