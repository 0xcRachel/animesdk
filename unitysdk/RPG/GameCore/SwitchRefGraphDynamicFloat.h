...
#define RPG_GAMECORE_SWITCHREFGRAPHDYNAMICFLOAT_METHOD_3_118781D4FFA0469B_OFFSET UNITYSDK_OFFSET(0x16FB9C30)
#define RPG_GAMECORE_SWITCHREFGRAPHDYNAMICFLOAT_METHOD_3_79E9909A2ED46BCC_OFFSET UNITYSDK_OFFSET(0x16FB93A0)
#define RPG_GAMECORE_SWITCHREFGRAPHDYNAMICFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x16FB9390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchRefGraphDynamicFloat_TypeDefinitionIndex = 15822;
