...
#define RPG_GAMECORE_BLOCKCAMERADITHERUPDATE_METHOD_3_C3B0DC248D54DD8D_OFFSET UNITYSDK_OFFSET(0x168EB0D0)
#define RPG_GAMECORE_BLOCKCAMERADITHERUPDATE_METHOD_3_CE5A69633C5DF8FC_OFFSET UNITYSDK_OFFSET(0x168EB050)
#define RPG_GAMECORE_BLOCKCAMERADITHERUPDATE__CTOR_OFFSET UNITYSDK_OFFSET(0x168EB0A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BlockCameraDitherUpdate_TypeDefinitionIndex = 20414;
