...
#define RPG_GAMECORE_ADVWAITTICKVALUEFINISH_METHOD_3_3D56ABD552E8F24C_OFFSET UNITYSDK_OFFSET(0x1684D3E0)
#define RPG_GAMECORE_ADVWAITTICKVALUEFINISH_METHOD_3_A8C99AC848142328_OFFSET UNITYSDK_OFFSET(0x1684D4B0)
#define RPG_GAMECORE_ADVWAITTICKVALUEFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1684D460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvWaitTickValueFinish_TypeDefinitionIndex = 18833;
