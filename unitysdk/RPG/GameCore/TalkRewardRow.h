...
#define RPG_GAMECORE_TALKREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x177BD0C0)
#define RPG_GAMECORE_TALKREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x177BD3D0)
