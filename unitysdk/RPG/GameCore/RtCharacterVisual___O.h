...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::RtBehaviorFlag>**)Il2CppClass::FromTypeDefinitionIndex(RtCharacterVisual___O_TypeDefinitionIndex)->GetStaticField(0x35060);
		}
	};
}
