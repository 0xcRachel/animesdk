...
#define RPG_GAMECORE_RESTAURANTFACILITYUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16DEC540)
#define RPG_GAMECORE_RESTAURANTFACILITYUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16DEC710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RestaurantFacilityUpRow_TypeDefinitionIndex = 10523;
