...
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBASECONFIG_METHOD_2_8C9B53B7AC888692_OFFSET UNITYSDK_OFFSET(0x1766C230)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBASECONFIG_METHOD_2_96E7EC1DC56DD81B_OFFSET UNITYSDK_OFFSET(0x1766BDE0)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1766C240)
