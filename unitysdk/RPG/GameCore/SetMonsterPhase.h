...
#define RPG_GAMECORE_SETMONSTERPHASE_METHOD_3_852C90B8B5F0CCE0_OFFSET UNITYSDK_OFFSET(0x16F370C0)
#define RPG_GAMECORE_SETMONSTERPHASE_METHOD_3_B750F9A61D439704_OFFSET UNITYSDK_OFFSET(0x16F371A0)
#define RPG_GAMECORE_SETMONSTERPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F37140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMonsterPhase_TypeDefinitionIndex = 20369;
