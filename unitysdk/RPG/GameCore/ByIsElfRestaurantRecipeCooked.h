...
#define RPG_GAMECORE_BYISELFRESTAURANTRECIPECOOKED_METHOD_4_4A618C00DAF7D062_OFFSET UNITYSDK_OFFSET(0x19DA3A00)
#define RPG_GAMECORE_BYISELFRESTAURANTRECIPECOOKED_METHOD_4_898ADF642BBBC8BB_OFFSET UNITYSDK_OFFSET(0x19DA3CC0)
#define RPG_GAMECORE_BYISELFRESTAURANTRECIPECOOKED_METHOD_4_8CA52B3C7F57DB80_OFFSET UNITYSDK_OFFSET(0x19DA3AD0)
#define RPG_GAMECORE_BYISELFRESTAURANTRECIPECOOKED_METHOD_4_AF4AA26D9F12EDD3_OFFSET UNITYSDK_OFFSET(0x19DA3C40)
#define RPG_GAMECORE_BYISELFRESTAURANTRECIPECOOKED__CTOR_OFFSET UNITYSDK_OFFSET(0x19DA3A80)
