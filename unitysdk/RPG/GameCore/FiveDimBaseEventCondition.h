...
#define RPG_GAMECORE_FIVEDIMBASEEVENTCONDITION_METHOD_2_07E47907727C537A_OFFSET UNITYSDK_OFFSET(0x171F2DA0)
#define RPG_GAMECORE_FIVEDIMBASEEVENTCONDITION_METHOD_2_6129AC8DC6E421E5_OFFSET UNITYSDK_OFFSET(0x171FF140)
#define RPG_GAMECORE_FIVEDIMBASEEVENTCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x171FF1A0)
