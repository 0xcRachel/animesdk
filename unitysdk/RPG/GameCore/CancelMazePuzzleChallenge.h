...
#define RPG_GAMECORE_CANCELMAZEPUZZLECHALLENGE_METHOD_3_1B5CF87C0670873C_OFFSET UNITYSDK_OFFSET(0x170672F0)
#define RPG_GAMECORE_CANCELMAZEPUZZLECHALLENGE_METHOD_3_B321AF77242CFFCD_OFFSET UNITYSDK_OFFSET(0x17067270)
#define RPG_GAMECORE_CANCELMAZEPUZZLECHALLENGE__CTOR_OFFSET UNITYSDK_OFFSET(0x170672C0)
