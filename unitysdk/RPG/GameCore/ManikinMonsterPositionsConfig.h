...
#define RPG_GAMECORE_MANIKINMONSTERPOSITIONSCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16C28910)
#define RPG_GAMECORE_MANIKINMONSTERPOSITIONSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16C28BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ManikinMonsterPositionsConfig_TypeDefinitionIndex = 15781;
