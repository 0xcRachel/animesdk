...
#define RPG_GAMECORE_ELFFEVERSKILLCONFIG_METHOD_2_9A1B97F6C79B9A89_OFFSET UNITYSDK_OFFSET(0x16A60660)
#define RPG_GAMECORE_ELFFEVERSKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16A60760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfFeverSkillConfig_TypeDefinitionIndex = 16560;
