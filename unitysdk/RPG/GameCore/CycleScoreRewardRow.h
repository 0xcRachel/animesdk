...
#define RPG_GAMECORE_CYCLESCOREREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18FB6790)
#define RPG_GAMECORE_CYCLESCOREREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18FB68D0)
