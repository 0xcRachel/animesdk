...
#define RPG_GAMECORE_ROGUEACTGETSCOINBYCHESSMAINSTORYCONFIG_METHOD_6_0DC0514603D38FC3_OFFSET UNITYSDK_OFFSET(0x1A9A5C70)
#define RPG_GAMECORE_ROGUEACTGETSCOINBYCHESSMAINSTORYCONFIG_METHOD_6_1AD180D494C5E9B6_OFFSET UNITYSDK_OFFSET(0x1A9A5A50)
#define RPG_GAMECORE_ROGUEACTGETSCOINBYCHESSMAINSTORYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9A5B90)
