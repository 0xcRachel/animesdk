...
#define RPG_GAMECORE_MATCHTHREEV2CHALLENGERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18C3D4F0)
#define RPG_GAMECORE_MATCHTHREEV2CHALLENGERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18C3D800)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 ChallengerID; // 0x34
