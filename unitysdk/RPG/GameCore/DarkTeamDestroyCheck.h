...
#define RPG_GAMECORE_DARKTEAMDESTROYCHECK_METHOD_3_A66550BA1906AF1D_OFFSET UNITYSDK_OFFSET(0x169E3670)
#define RPG_GAMECORE_DARKTEAMDESTROYCHECK_METHOD_3_F3D28E6B4734178C_OFFSET UNITYSDK_OFFSET(0x169E35F0)
#define RPG_GAMECORE_DARKTEAMDESTROYCHECK__CTOR_OFFSET UNITYSDK_OFFSET(0x169E3640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DarkTeamDestroyCheck_TypeDefinitionIndex = 21071;
