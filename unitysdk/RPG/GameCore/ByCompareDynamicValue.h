...
#define RPG_GAMECORE_BYCOMPAREDYNAMICVALUE_METHOD_4_42814A2C0F34758A_OFFSET UNITYSDK_OFFSET(0x1690A570)
#define RPG_GAMECORE_BYCOMPAREDYNAMICVALUE_METHOD_4_7B10385DA81789E0_OFFSET UNITYSDK_OFFSET(0x1690A450)
#define RPG_GAMECORE_BYCOMPAREDYNAMICVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1690A4F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareDynamicValue_TypeDefinitionIndex = 21514;
