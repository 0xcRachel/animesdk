...
#define RPG_GAMECORE_AUDIOSETRTPCVALUE_METHOD_3_1B308CF71E714FC2_OFFSET UNITYSDK_OFFSET(0x168982D0)
#define RPG_GAMECORE_AUDIOSETRTPCVALUE_METHOD_3_71C01BBD2555D375_OFFSET UNITYSDK_OFFSET(0x16898250)
#define RPG_GAMECORE_AUDIOSETRTPCVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x168982A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AudioSetRTPCValue_TypeDefinitionIndex = 18404;
