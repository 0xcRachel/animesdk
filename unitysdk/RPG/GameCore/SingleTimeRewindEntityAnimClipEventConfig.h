...
#define RPG_GAMECORE_SINGLETIMEREWINDENTITYANIMCLIPEVENTCONFIG_METHOD_3_7C57C0CCCCBB0669_OFFSET UNITYSDK_OFFSET(0x16F69F50)
#define RPG_GAMECORE_SINGLETIMEREWINDENTITYANIMCLIPEVENTCONFIG_METHOD_3_E2025E265CFFA78A_OFFSET UNITYSDK_OFFSET(0x16F69EF0)
#define RPG_GAMECORE_SINGLETIMEREWINDENTITYANIMCLIPEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F69F40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SingleTimeRewindEntityAnimClipEventConfig_TypeDefinitionIndex = 14953;
