...
#define RPG_GAMECORE_SETADVEFFECTBGCURVE_METHOD_3_0DEE85CFF2A6FE66_OFFSET UNITYSDK_OFFSET(0x1A1E1760)
#define RPG_GAMECORE_SETADVEFFECTBGCURVE_METHOD_3_C5AD9082C7A27939_OFFSET UNITYSDK_OFFSET(0x1A1E16E0)
#define RPG_GAMECORE_SETADVEFFECTBGCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1E1730)
