...
#define RPG_GAMECORE_ST_MAIN_PREDICATE_BEHAVIOUR_METHOD_4_0E3EAE14EF4D21AA_OFFSET UNITYSDK_OFFSET(0x176AC7A0)
#define RPG_GAMECORE_ST_MAIN_PREDICATE_BEHAVIOUR_METHOD_4_1A5F8C744C6E05EE_OFFSET UNITYSDK_OFFSET(0x1769CEC0)
#define RPG_GAMECORE_ST_MAIN_PREDICATE_BEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1769CE70)
