...
#define RPG_GAMECORE_DECALPUZZLECLEAR_METHOD_3_E1A360DAFB0BD97C_OFFSET UNITYSDK_OFFSET(0x17164140)
#define RPG_GAMECORE_DECALPUZZLECLEAR_METHOD_3_F358F4DD927CF80D_OFFSET UNITYSDK_OFFSET(0x171640C0)
#define RPG_GAMECORE_DECALPUZZLECLEAR__CTOR_OFFSET UNITYSDK_OFFSET(0x17164110)
