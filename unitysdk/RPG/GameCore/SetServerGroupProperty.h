...
#define RPG_GAMECORE_SETSERVERGROUPPROPERTY_METHOD_3_3E784620D32219B7_OFFSET UNITYSDK_OFFSET(0x1938A340)
#define RPG_GAMECORE_SETSERVERGROUPPROPERTY_METHOD_3_EC4C29FEE0022790_OFFSET UNITYSDK_OFFSET(0x1938A3B0)
#define RPG_GAMECORE_SETSERVERGROUPPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1938A380)
