...
#define RPG_GAMECORE_ATTACHGLOBALSHIELD_METHOD_3_105D61E7ACBDF7CE_OFFSET UNITYSDK_OFFSET(0x16890DF0)
#define RPG_GAMECORE_ATTACHGLOBALSHIELD_METHOD_3_156E1D0FB9C6ABF5_OFFSET UNITYSDK_OFFSET(0x16890E70)
#define RPG_GAMECORE_ATTACHGLOBALSHIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x16890E40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AttachGlobalShield_TypeDefinitionIndex = 21283;
