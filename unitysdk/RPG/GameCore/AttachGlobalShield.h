...
#define RPG_GAMECORE_ATTACHGLOBALSHIELD_METHOD_3_739D0C3ACF4291CE_OFFSET UNITYSDK_OFFSET(0x18BE7C30)
#define RPG_GAMECORE_ATTACHGLOBALSHIELD_METHOD_3_EFD9BDB897A91457_OFFSET UNITYSDK_OFFSET(0x18BE7BB0)
#define RPG_GAMECORE_ATTACHGLOBALSHIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x18BE7C00)
