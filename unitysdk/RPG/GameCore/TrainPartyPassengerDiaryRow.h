...
#define RPG_GAMECORE_TRAINPARTYPASSENGERDIARYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17106630)
#define RPG_GAMECORE_TRAINPARTYPASSENGERDIARYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17106790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyPassengerDiaryRow_TypeDefinitionIndex = 13939;
