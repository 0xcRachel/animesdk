...
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_OVERRIDE_INTERACT_LIKE_TYPE_METHOD_4_8F4C41883345D386_OFFSET UNITYSDK_OFFSET(0x1A182F40)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_OVERRIDE_INTERACT_LIKE_TYPE_METHOD_4_B3480FF1D721225E_OFFSET UNITYSDK_OFFSET(0x1A172C80)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_OVERRIDE_INTERACT_LIKE_TYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A172C20)
