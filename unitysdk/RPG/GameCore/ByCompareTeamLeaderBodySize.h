...
#define RPG_GAMECORE_BYCOMPARETEAMLEADERBODYSIZE_METHOD_4_3A5B2F9C4760CC2D_OFFSET UNITYSDK_OFFSET(0x19AD63C0)
#define RPG_GAMECORE_BYCOMPARETEAMLEADERBODYSIZE_METHOD_4_948AF340B74934C3_OFFSET UNITYSDK_OFFSET(0x19AD6490)
#define RPG_GAMECORE_BYCOMPARETEAMLEADERBODYSIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD6440)
