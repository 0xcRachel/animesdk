...
#define RPG_GAMECORE_STARTSUMMONUNITGAMEPLAY_METHOD_3_874DB083122D72F8_OFFSET UNITYSDK_OFFSET(0x16F96EB0)
#define RPG_GAMECORE_STARTSUMMONUNITGAMEPLAY_METHOD_3_B5C7C73DED37B1CB_OFFSET UNITYSDK_OFFSET(0x16F96F30)
#define RPG_GAMECORE_STARTSUMMONUNITGAMEPLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x16F96F00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartSummonUnitGameplay_TypeDefinitionIndex = 18938;
