...
#define RPG_GAMECORE_STARTSUMMONUNITGAMEPLAY_METHOD_3_0A26D52F4A52EDFD_OFFSET UNITYSDK_OFFSET(0x1934A870)
#define RPG_GAMECORE_STARTSUMMONUNITGAMEPLAY_METHOD_3_B40DD527B0A543B4_OFFSET UNITYSDK_OFFSET(0x1934A8F0)
#define RPG_GAMECORE_STARTSUMMONUNITGAMEPLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1934A8C0)
