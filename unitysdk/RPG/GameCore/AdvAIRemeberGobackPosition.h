...
#define RPG_GAMECORE_ADVAIREMEBERGOBACKPOSITION_METHOD_3_5D0BC922786868EB_OFFSET UNITYSDK_OFFSET(0x18DB9380)
#define RPG_GAMECORE_ADVAIREMEBERGOBACKPOSITION_METHOD_3_A367BBE3CABD57FD_OFFSET UNITYSDK_OFFSET(0x18DB94D0)
#define RPG_GAMECORE_ADVAIREMEBERGOBACKPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x18DB9440)
