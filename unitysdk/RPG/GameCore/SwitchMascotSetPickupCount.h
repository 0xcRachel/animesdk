...
#define RPG_GAMECORE_SWITCHMASCOTSETPICKUPCOUNT_METHOD_3_F34F23710F3C41BE_OFFSET UNITYSDK_OFFSET(0x18D8CB50)
#define RPG_GAMECORE_SWITCHMASCOTSETPICKUPCOUNT_METHOD_3_FF66718892DE888F_OFFSET UNITYSDK_OFFSET(0x18D8CAD0)
#define RPG_GAMECORE_SWITCHMASCOTSETPICKUPCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x18D8CB20)
