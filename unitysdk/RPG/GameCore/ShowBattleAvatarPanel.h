...
#define RPG_GAMECORE_SHOWBATTLEAVATARPANEL_METHOD_3_1BF2D66CEDED86E7_OFFSET UNITYSDK_OFFSET(0x16F53DE0)
#define RPG_GAMECORE_SHOWBATTLEAVATARPANEL_METHOD_3_ED69D0A7DB9C1B28_OFFSET UNITYSDK_OFFSET(0x16F53E60)
#define RPG_GAMECORE_SHOWBATTLEAVATARPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0x16F53E30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowBattleAvatarPanel_TypeDefinitionIndex = 20465;
