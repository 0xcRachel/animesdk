...
#define RPG_GAMECORE_CHIMERADUELROUNDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x169974E0)
#define RPG_GAMECORE_CHIMERADUELROUNDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x169977A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelRoundRow_TypeDefinitionIndex = 10340;
