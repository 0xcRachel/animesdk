...
#define RPG_GAMECORE_BYCOMPARERESISTCHANCE_METHOD_4_10362B32B0B241C8_OFFSET UNITYSDK_OFFSET(0x16917C80)
#define RPG_GAMECORE_BYCOMPARERESISTCHANCE_METHOD_4_8A8EA314FF4CDD93_OFFSET UNITYSDK_OFFSET(0x16917BB0)
#define RPG_GAMECORE_BYCOMPARERESISTCHANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x16917C30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareResistChance_TypeDefinitionIndex = 21162;
