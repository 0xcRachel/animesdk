...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTBOOSTJAMCONFIG_METHOD_3_CF7FAA60D4FFAE62_OFFSET UNITYSDK_OFFSET(0x1A11FB60)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTBOOSTJAMCONFIG_METHOD_3_EF1D4E4AA5316436_OFFSET UNITYSDK_OFFSET(0x1A11FA90)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTBOOSTJAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A11FB50)
