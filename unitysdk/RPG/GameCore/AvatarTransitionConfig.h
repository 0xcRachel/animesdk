...
#define RPG_GAMECORE_AVATARTRANSITIONCONFIG_METHOD_2_CA8B843C8FAB49E5_OFFSET UNITYSDK_OFFSET(0x16FD20C0)
#define RPG_GAMECORE_AVATARTRANSITIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD21C0)
