...
#define RPG_GAMECORE_STAGELODMAPCONFIG_METHOD_2_DA10B7CFBEE9C221_OFFSET UNITYSDK_OFFSET(0x1933D1F0)
#define RPG_GAMECORE_STAGELODMAPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1933D330)
