...
#define RPG_GAMECORE_REQUESTMISSIONCUSTOMVALUE_METHOD_3_0312C9BE1D1B8AB2_OFFSET UNITYSDK_OFFSET(0x1A2EB930)
#define RPG_GAMECORE_REQUESTMISSIONCUSTOMVALUE_METHOD_3_095288287618B1D4_OFFSET UNITYSDK_OFFSET(0x1A2EB810)
#define RPG_GAMECORE_REQUESTMISSIONCUSTOMVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2EB8B0)
