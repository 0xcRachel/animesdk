...
#define RPG_GAMECORE_CHIMERATALKCONDITION_METHOD_2_A27D255D892C69D6_OFFSET UNITYSDK_OFFSET(0x1699CE70)
#define RPG_GAMECORE_CHIMERATALKCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1699CFD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraTalkCondition_TypeDefinitionIndex = 14293;
