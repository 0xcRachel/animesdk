...
#define RPG_GAMECORE_BYCHIMERADUELISMASTERSELECTED_METHOD_4_1B0A5ACC20D35A7A_OFFSET UNITYSDK_OFFSET(0x195FFDC0)
#define RPG_GAMECORE_BYCHIMERADUELISMASTERSELECTED_METHOD_4_DD6DF32DC627F547_OFFSET UNITYSDK_OFFSET(0x195FFBD0)
#define RPG_GAMECORE_BYCHIMERADUELISMASTERSELECTED_METHOD_4_DE1F85B3568C50C5_OFFSET UNITYSDK_OFFSET(0x195FFB00)
#define RPG_GAMECORE_BYCHIMERADUELISMASTERSELECTED_METHOD_4_E0F2845D944BD076_OFFSET UNITYSDK_OFFSET(0x195FFD40)
#define RPG_GAMECORE_BYCHIMERADUELISMASTERSELECTED__CTOR_OFFSET UNITYSDK_OFFSET(0x195FFB80)
