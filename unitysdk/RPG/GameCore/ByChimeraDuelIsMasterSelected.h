...
#define RPG_GAMECORE_BYCHIMERADUELISMASTERSELECTED_METHOD_4_DD6DF32DC627F547_OFFSET UNITYSDK_OFFSET(0x169050A0)
#define RPG_GAMECORE_BYCHIMERADUELISMASTERSELECTED_METHOD_4_DE1F85B3568C50C5_OFFSET UNITYSDK_OFFSET(0x16904FD0)
#define RPG_GAMECORE_BYCHIMERADUELISMASTERSELECTED__CTOR_OFFSET UNITYSDK_OFFSET(0x16905050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByChimeraDuelIsMasterSelected_TypeDefinitionIndex = 21787;
