...
#define RPG_GAMECORE_SPECIALCHESTFINDDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16F7BFF0)
#define RPG_GAMECORE_SPECIALCHESTFINDDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16F7C310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SpecialChestFindDataRow_TypeDefinitionIndex = 12068;

	class SpecialChestFindDataRow : public ::System::Object
	{
	public:
		::System::Boolean IsUseSpecialMappinginfo; // 0x10
		::System::UInt32 LittleGameEntityID; // 0x14
		::RPG::GameCore::FindChestReplaceType ReplaceType; // 0x18
		::System::UInt32 InstanceID; // 0x1C
		::System::UInt32 ReplaceGroupID; // 0x20
