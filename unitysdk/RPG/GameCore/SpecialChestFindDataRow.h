...
#define RPG_GAMECORE_SPECIALCHESTFINDDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1932D940)
#define RPG_GAMECORE_SPECIALCHESTFINDDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1932DC60)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::RPG::GameCore::FindChestReplaceType ReplaceType; // 0x10
		::System::UInt32 LittleGameEntityID; // 0x14
		::System::Boolean IsUseSpecialMappinginfo; // 0x18
		::System::UInt32 FloorID; // 0x1C
		::System::UInt32 ReplaceLittleGameEntityID; // 0x20
		::System::UInt32 ReplaceGroupID; // 0x24
		::System::UInt32 ReplaceInstanceID; // 0x28
