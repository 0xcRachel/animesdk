...
#define RPG_GAMECORE_RECHARGEBENEFITDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16DCBCF0)
#define RPG_GAMECORE_RECHARGEBENEFITDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16DCBED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RechargeBenefitDataRow_TypeDefinitionIndex = 13269;
