...
#define RPG_GAMECORE_ELFRESTAURANTPAUSEGAME_METHOD_3_41ADBB6A08AAFE55_OFFSET UNITYSDK_OFFSET(0x171A5370)
#define RPG_GAMECORE_ELFRESTAURANTPAUSEGAME_METHOD_3_CCB271A451746324_OFFSET UNITYSDK_OFFSET(0x171A53F0)
#define RPG_GAMECORE_ELFRESTAURANTPAUSEGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x171A53C0)
