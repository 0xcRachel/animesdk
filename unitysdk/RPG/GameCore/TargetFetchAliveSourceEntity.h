...
#define RPG_GAMECORE_TARGETFETCHALIVESOURCEENTITY_METHOD_3_C668D31E242F9EB8_OFFSET UNITYSDK_OFFSET(0x16FDB9A0)
#define RPG_GAMECORE_TARGETFETCHALIVESOURCEENTITY_METHOD_3_FF6AEC36767BC469_OFFSET UNITYSDK_OFFSET(0x16FDB8E0)
#define RPG_GAMECORE_TARGETFETCHALIVESOURCEENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x16FDB980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAliveSourceEntity_TypeDefinitionIndex = 21681;
