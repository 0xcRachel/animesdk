...
#define RPG_GAMECORE_RECORDUSEAVATARGLOBALBUFF_METHOD_3_BD305AE5EC3351D3_OFFSET UNITYSDK_OFFSET(0x1759C110)
#define RPG_GAMECORE_RECORDUSEAVATARGLOBALBUFF_METHOD_3_F3C7C87B2DC1B1DA_OFFSET UNITYSDK_OFFSET(0x1759C090)
#define RPG_GAMECORE_RECORDUSEAVATARGLOBALBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x1759C0E0)
