...
#define RPG_GAMECORE_AVATARSERVANTPROPERTYOVERRIDEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x168B4D10)
#define RPG_GAMECORE_AVATARSERVANTPROPERTYOVERRIDEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x168B5540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarServantPropertyOverrideRow_TypeDefinitionIndex = 11624;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::RPG::GameCore::AttackType, ::System::String*>* SkillPointIconSourceTriggerKey; // 0x20
