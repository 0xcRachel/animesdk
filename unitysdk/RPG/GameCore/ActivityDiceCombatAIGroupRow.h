...
#define RPG_GAMECORE_ACTIVITYDICECOMBATAIGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19895720)
#define RPG_GAMECORE_ACTIVITYDICECOMBATAIGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19895B20)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Single SelectWrongRate; // 0x4C
		::System::UInt32 RerollMaxDefend; // 0x50
		::System::Single ColorfulDiceWeight; // 0x54
		::System::Single Quantile; // 0x58
		::System::Boolean CanUseTactics; // 0x5C
		::System::Single SpecialRuleWeight; // 0x60
