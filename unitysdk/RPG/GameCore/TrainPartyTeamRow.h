...
#define RPG_GAMECORE_TRAINPARTYTEAMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x178C55E0)
#define RPG_GAMECORE_TRAINPARTYTEAMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x178C5870)
