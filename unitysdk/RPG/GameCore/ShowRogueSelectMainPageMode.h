...
#define RPG_GAMECORE_SHOWROGUESELECTMAINPAGEMODE_METHOD_3_16BF84DC4CED9638_OFFSET UNITYSDK_OFFSET(0x16F612C0)
#define RPG_GAMECORE_SHOWROGUESELECTMAINPAGEMODE_METHOD_3_E57D57BAF04B621B_OFFSET UNITYSDK_OFFSET(0x16F61350)
#define RPG_GAMECORE_SHOWROGUESELECTMAINPAGEMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F61320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowRogueSelectMainPageMode_TypeDefinitionIndex = 21786;
