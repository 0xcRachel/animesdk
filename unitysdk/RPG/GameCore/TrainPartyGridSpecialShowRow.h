...
#define RPG_GAMECORE_TRAINPARTYGRIDSPECIALSHOWROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17104920)
#define RPG_GAMECORE_TRAINPARTYGRIDSPECIALSHOWROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17104A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyGridSpecialShowRow_TypeDefinitionIndex = 13924;
