...
#define RPG_GAMECORE_PERFORMANCEENDBLACKTEXT_METHOD_3_81C67B34E654630B_OFFSET UNITYSDK_OFFSET(0x174AB9B0)
#define RPG_GAMECORE_PERFORMANCEENDBLACKTEXT_METHOD_3_9F07040753EF1DFA_OFFSET UNITYSDK_OFFSET(0x174ABA30)
#define RPG_GAMECORE_PERFORMANCEENDBLACKTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x174ABA00)
