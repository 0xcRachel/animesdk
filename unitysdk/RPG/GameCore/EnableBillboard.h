...
#define RPG_GAMECORE_ENABLEBILLBOARD_METHOD_3_749016EB8896BE68_OFFSET UNITYSDK_OFFSET(0x16A68E30)
#define RPG_GAMECORE_ENABLEBILLBOARD_METHOD_3_8F5B428A5B05BFC5_OFFSET UNITYSDK_OFFSET(0x16A68CE0)
#define RPG_GAMECORE_ENABLEBILLBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x16A68DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableBillboard_TypeDefinitionIndex = 18241;
