...
#define RPG_GAMECORE_ACTIVITYSTARFIGHTGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x167B2130)
#define RPG_GAMECORE_ACTIVITYSTARFIGHTGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x167B2640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityStarFightGroupRow_TypeDefinitionIndex = 11248;
	...
	public:
		...
		::System::UInt32 PerfectQuest; // 0x38
		::System::UInt32 PerfectWave; // 0x3C
		::RPG::GameCore::StarFightSeason Season; // 0x40
		::RPG::Client::TextID GroupTitle; // 0x48
