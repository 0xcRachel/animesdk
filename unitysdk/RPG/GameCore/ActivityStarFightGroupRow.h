...
#define RPG_GAMECORE_ACTIVITYSTARFIGHTGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16F28B80)
#define RPG_GAMECORE_ACTIVITYSTARFIGHTGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16F29090)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 PerfectWave; // 0x50
