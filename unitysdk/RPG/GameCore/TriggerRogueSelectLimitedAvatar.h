...
#define RPG_GAMECORE_TRIGGERROGUESELECTLIMITEDAVATAR_METHOD_3_182F9E025CE46305_OFFSET UNITYSDK_OFFSET(0x171261A0)
#define RPG_GAMECORE_TRIGGERROGUESELECTLIMITEDAVATAR_METHOD_3_FC9B094E5F1937ED_OFFSET UNITYSDK_OFFSET(0x17126120)
#define RPG_GAMECORE_TRIGGERROGUESELECTLIMITEDAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x17126170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerRogueSelectLimitedAvatar_TypeDefinitionIndex = 19924;
