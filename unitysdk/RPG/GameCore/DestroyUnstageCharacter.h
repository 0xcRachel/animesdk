...
#define RPG_GAMECORE_DESTROYUNSTAGECHARACTER_METHOD_3_45DCFEE5EB1347B6_OFFSET UNITYSDK_OFFSET(0x169ED550)
#define RPG_GAMECORE_DESTROYUNSTAGECHARACTER_METHOD_3_C243B4182E4038EC_OFFSET UNITYSDK_OFFSET(0x169ED4D0)
#define RPG_GAMECORE_DESTROYUNSTAGECHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x169ED520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DestroyUnstageCharacter_TypeDefinitionIndex = 20394;
