...
#define RPG_GAMECORE_DESTROYUNSTAGECHARACTER_METHOD_3_45DCFEE5EB1347B6_OFFSET UNITYSDK_OFFSET(0x19585CF0)
#define RPG_GAMECORE_DESTROYUNSTAGECHARACTER_METHOD_3_C243B4182E4038EC_OFFSET UNITYSDK_OFFSET(0x19585C70)
#define RPG_GAMECORE_DESTROYUNSTAGECHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19585CC0)
