...
#define RPG_GAMECORE_DISPLAYITEMCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16A45370)
#define RPG_GAMECORE_DISPLAYITEMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16A45460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DisplayItemConfig_TypeDefinitionIndex = 10222;
