...
#define RPG_GAMECORE_BYCOMPARECUSTOMSTRING_METHOD_4_1F12AABEE37CC8D6_OFFSET UNITYSDK_OFFSET(0x1701ABD0)
#define RPG_GAMECORE_BYCOMPARECUSTOMSTRING_METHOD_4_211C2282FC9A9CFB_OFFSET UNITYSDK_OFFSET(0x1701AB00)
#define RPG_GAMECORE_BYCOMPARECUSTOMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1701AB80)
