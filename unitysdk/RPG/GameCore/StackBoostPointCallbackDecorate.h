...
#define RPG_GAMECORE_STACKBOOSTPOINTCALLBACKDECORATE_METHOD_3_CE0373ED0B8A6FED_OFFSET UNITYSDK_OFFSET(0x19332690)
#define RPG_GAMECORE_STACKBOOSTPOINTCALLBACKDECORATE_METHOD_3_D95A4DA784187914_OFFSET UNITYSDK_OFFSET(0x19332720)
#define RPG_GAMECORE_STACKBOOSTPOINTCALLBACKDECORATE__CTOR_OFFSET UNITYSDK_OFFSET(0x193326F0)
