...
#define RPG_GAMECORE_TARGETFETCHPUZZLEENTITY_METHOD_4_5AC2412134CF577E_OFFSET UNITYSDK_OFFSET(0x16FDECB0)
#define RPG_GAMECORE_TARGETFETCHPUZZLEENTITY_METHOD_4_7316D8AFB06EC79A_OFFSET UNITYSDK_OFFSET(0x16FDEC40)
#define RPG_GAMECORE_TARGETFETCHPUZZLEENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x16FDED50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchPuzzleEntity_TypeDefinitionIndex = 21601;
