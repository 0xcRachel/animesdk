...
#define RPG_GAMECORE_BATTLEPASSLEVELREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x195CFD40)
#define RPG_GAMECORE_BATTLEPASSLEVELREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x195D0D20)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 PremiumFixedReward2; // 0x1C
