...
#define RPG_GAMECORE_BATTLEPASSLEVELREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x168DEBB0)
#define RPG_GAMECORE_BATTLEPASSLEVELREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x168DFAE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattlePassLevelRewardRow_TypeDefinitionIndex = 11682;
	...
	public:
		...
		::System::Boolean SpeicalPoint; // 0x24
