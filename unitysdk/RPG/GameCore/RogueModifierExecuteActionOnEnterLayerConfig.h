...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERLAYERCONFIG_METHOD_3_0A128726977BB05F_OFFSET UNITYSDK_OFFSET(0x16E96F70)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERLAYERCONFIG_METHOD_3_7DB880A8D0EE2BE6_OFFSET UNITYSDK_OFFSET(0x16E9EEA0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERLAYERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E96F20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnEnterLayerConfig_TypeDefinitionIndex = 15961;
