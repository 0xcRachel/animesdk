...
#define RPG_GAMECORE_REFRESHWEAKNESSUI_METHOD_3_329CFA51C5BE3741_OFFSET UNITYSDK_OFFSET(0x19AB4C60)
#define RPG_GAMECORE_REFRESHWEAKNESSUI_METHOD_3_65056DCE3EDCEBA8_OFFSET UNITYSDK_OFFSET(0x19AB4CE0)
#define RPG_GAMECORE_REFRESHWEAKNESSUI__CTOR_OFFSET UNITYSDK_OFFSET(0x19AB4CB0)
