...
#define RPG_GAMECORE_SETMONSTERHPTOTALSEG_METHOD_3_8B459EC1EC5A0CDF_OFFSET UNITYSDK_OFFSET(0x16F365F0)
#define RPG_GAMECORE_SETMONSTERHPTOTALSEG_METHOD_3_BA2C3602F97BFBDF_OFFSET UNITYSDK_OFFSET(0x16F366C0)
#define RPG_GAMECORE_SETMONSTERHPTOTALSEG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F36670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMonsterHPTotalSeg_TypeDefinitionIndex = 20819;
