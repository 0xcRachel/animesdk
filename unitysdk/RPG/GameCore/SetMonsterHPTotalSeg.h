...
#define RPG_GAMECORE_SETMONSTERHPTOTALSEG_METHOD_3_8B459EC1EC5A0CDF_OFFSET UNITYSDK_OFFSET(0x176EBB10)
#define RPG_GAMECORE_SETMONSTERHPTOTALSEG_METHOD_3_BA2C3602F97BFBDF_OFFSET UNITYSDK_OFFSET(0x176EBBE0)
#define RPG_GAMECORE_SETMONSTERHPTOTALSEG__CTOR_OFFSET UNITYSDK_OFFSET(0x176EBB90)
