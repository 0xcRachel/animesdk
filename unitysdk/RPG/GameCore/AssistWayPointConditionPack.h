...
#define RPG_GAMECORE_ASSISTWAYPOINTCONDITIONPACK_METHOD_2_45EFD0503A2B61F2_OFFSET UNITYSDK_OFFSET(0x18ADE790)
#define RPG_GAMECORE_ASSISTWAYPOINTCONDITIONPACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18ADE8C0)
