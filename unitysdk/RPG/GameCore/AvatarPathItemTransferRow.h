...
#define RPG_GAMECORE_AVATARPATHITEMTRANSFERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18206270)
#define RPG_GAMECORE_AVATARPATHITEMTRANSFERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x182064E0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID DialogTitle; // 0x28
