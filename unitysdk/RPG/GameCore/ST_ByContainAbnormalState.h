...
#define RPG_GAMECORE_ST_BYCONTAINABNORMALSTATE_METHOD_4_5D76A6D908D8CEFE_OFFSET UNITYSDK_OFFSET(0x1A179A00)
#define RPG_GAMECORE_ST_BYCONTAINABNORMALSTATE_METHOD_4_9D31DC0DE1588100_OFFSET UNITYSDK_OFFSET(0x1A179AD0)
#define RPG_GAMECORE_ST_BYCONTAINABNORMALSTATE_METHOD_4_B3E00A57D2A703F9_OFFSET UNITYSDK_OFFSET(0x1A179CE0)
#define RPG_GAMECORE_ST_BYCONTAINABNORMALSTATE_METHOD_4_CD82A4A1A9E208FD_OFFSET UNITYSDK_OFFSET(0x1A179C60)
#define RPG_GAMECORE_ST_BYCONTAINABNORMALSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A179A80)
