...
#define RPG_GAMECORE_ST_BYCONTAINABNORMALSTATE_METHOD_4_5D76A6D908D8CEFE_OFFSET UNITYSDK_OFFSET(0x16EEEAA0)
#define RPG_GAMECORE_ST_BYCONTAINABNORMALSTATE_METHOD_4_9D31DC0DE1588100_OFFSET UNITYSDK_OFFSET(0x16EEEB70)
#define RPG_GAMECORE_ST_BYCONTAINABNORMALSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16EEEB20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByContainAbnormalState_TypeDefinitionIndex = 17846;
