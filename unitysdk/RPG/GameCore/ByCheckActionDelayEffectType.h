...
#define RPG_GAMECORE_BYCHECKACTIONDELAYEFFECTTYPE_METHOD_4_41AA97F98A3C6C44_OFFSET UNITYSDK_OFFSET(0x17010C60)
#define RPG_GAMECORE_BYCHECKACTIONDELAYEFFECTTYPE_METHOD_4_C78F913653A8849A_OFFSET UNITYSDK_OFFSET(0x17010D30)
#define RPG_GAMECORE_BYCHECKACTIONDELAYEFFECTTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x17010CE0)
