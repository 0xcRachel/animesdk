...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TACTICSEFFECT_ALIGNDEFEND_METHOD_3_00ED5A157E531B4E_OFFSET UNITYSDK_OFFSET(0x195A6C80)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TACTICSEFFECT_ALIGNDEFEND_METHOD_3_CC9FAE086139B1F9_OFFSET UNITYSDK_OFFSET(0x195A2F30)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TACTICSEFFECT_ALIGNDEFEND__CTOR_OFFSET UNITYSDK_OFFSET(0x195A2EE0)
