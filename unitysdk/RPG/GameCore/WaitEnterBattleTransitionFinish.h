...
#define RPG_GAMECORE_WAITENTERBATTLETRANSITIONFINISH_METHOD_3_3C8C89B291DDF463_OFFSET UNITYSDK_OFFSET(0x1790BFD0)
#define RPG_GAMECORE_WAITENTERBATTLETRANSITIONFINISH_METHOD_3_E249445DB8B08D32_OFFSET UNITYSDK_OFFSET(0x1790C050)
#define RPG_GAMECORE_WAITENTERBATTLETRANSITIONFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1790C020)
