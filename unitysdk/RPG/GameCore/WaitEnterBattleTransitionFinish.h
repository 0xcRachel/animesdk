...
#define RPG_GAMECORE_WAITENTERBATTLETRANSITIONFINISH_METHOD_3_3C8C89B291DDF463_OFFSET UNITYSDK_OFFSET(0x1714FEC0)
#define RPG_GAMECORE_WAITENTERBATTLETRANSITIONFINISH_METHOD_3_E249445DB8B08D32_OFFSET UNITYSDK_OFFSET(0x1714FF40)
#define RPG_GAMECORE_WAITENTERBATTLETRANSITIONFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1714FF10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitEnterBattleTransitionFinish_TypeDefinitionIndex = 20998;
