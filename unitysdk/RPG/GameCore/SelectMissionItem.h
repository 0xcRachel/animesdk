...
#define RPG_GAMECORE_SELECTMISSIONITEM_METHOD_3_3FA54D6C9248C1C2_OFFSET UNITYSDK_OFFSET(0x16EFD750)
#define RPG_GAMECORE_SELECTMISSIONITEM_METHOD_3_5CAE2C9FB42A63D7_OFFSET UNITYSDK_OFFSET(0x16EFD8B0)
#define RPG_GAMECORE_SELECTMISSIONITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x16EFD810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SelectMissionItem_TypeDefinitionIndex = 18226;
