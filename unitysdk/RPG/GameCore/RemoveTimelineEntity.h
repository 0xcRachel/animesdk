...
#define RPG_GAMECORE_REMOVETIMELINEENTITY_METHOD_3_0DFE8F94387A0838_OFFSET UNITYSDK_OFFSET(0x19029970)
#define RPG_GAMECORE_REMOVETIMELINEENTITY_METHOD_3_DCBC6272DBD7D41B_OFFSET UNITYSDK_OFFSET(0x190299F0)
#define RPG_GAMECORE_REMOVETIMELINEENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x190299C0)
