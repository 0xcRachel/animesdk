...
#define RPG_GAMECORE_SKILLPARAMMAPPING_METHOD_2_21CC4DB7E1DBD914_OFFSET UNITYSDK_OFFSET(0x17723370)
#define RPG_GAMECORE_SKILLPARAMMAPPING__CTOR_OFFSET UNITYSDK_OFFSET(0x177235A0)
