...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLOSTCOINANDGAINMORECONFIG_METHOD_3_8A11D65C6C7E69A3_OFFSET UNITYSDK_OFFSET(0x1727FA40)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLOSTCOINANDGAINMORECONFIG_METHOD_3_DDE44044370A775A_OFFSET UNITYSDK_OFFSET(0x1727C4E0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLOSTCOINANDGAINMORECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1727C490)
