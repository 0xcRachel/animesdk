...
#define RPG_GAMECORE_ACTIVITYEQUIPMENTREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16789640)
#define RPG_GAMECORE_ACTIVITYEQUIPMENTREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16789860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityEquipmentRewardRow_TypeDefinitionIndex = 10580;
