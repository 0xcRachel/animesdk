...
#define RPG_GAMECORE_PROPSETUPTWOSTATEUITRIGGER_METHOD_3_5148000FB8338B68_OFFSET UNITYSDK_OFFSET(0x16DB5090)
#define RPG_GAMECORE_PROPSETUPTWOSTATEUITRIGGER_METHOD_3_531DA6F1DE7733A6_OFFSET UNITYSDK_OFFSET(0x16DB4EB0)
#define RPG_GAMECORE_PROPSETUPTWOSTATEUITRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x16DB4FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropSetupTwoStateUITrigger_TypeDefinitionIndex = 19869;
