...
#define RPG_GAMECORE_PIXAIREFFECTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19D3FAE0)
#define RPG_GAMECORE_PIXAIREFFECTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19D3FD10)
