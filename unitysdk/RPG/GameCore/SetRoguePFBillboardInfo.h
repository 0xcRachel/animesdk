...
#define RPG_GAMECORE_SETROGUEPFBILLBOARDINFO_METHOD_4_14CC4756E6BCFB7D_OFFSET UNITYSDK_OFFSET(0x16F3BD80)
#define RPG_GAMECORE_SETROGUEPFBILLBOARDINFO_METHOD_4_519EC204A3994E7A_OFFSET UNITYSDK_OFFSET(0x16F3BD00)
#define RPG_GAMECORE_SETROGUEPFBILLBOARDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16F3BD50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetRoguePFBillboardInfo_TypeDefinitionIndex = 19736;
