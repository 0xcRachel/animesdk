...
#define RPG_GAMECORE_ADVNPCSEARCHPROP_METHOD_3_6CA52367EF33A472_OFFSET UNITYSDK_OFFSET(0x18C53E80)
#define RPG_GAMECORE_ADVNPCSEARCHPROP_METHOD_3_F9BFA0B410AECB06_OFFSET UNITYSDK_OFFSET(0x18C53D70)
#define RPG_GAMECORE_ADVNPCSEARCHPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x18C53E50)
