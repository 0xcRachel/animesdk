...
#define RPG_GAMECORE_ADVNPCSEARCHPROP_METHOD_3_6CA52367EF33A472_OFFSET UNITYSDK_OFFSET(0x16840A40)
#define RPG_GAMECORE_ADVNPCSEARCHPROP_METHOD_3_F9BFA0B410AECB06_OFFSET UNITYSDK_OFFSET(0x16840930)
#define RPG_GAMECORE_ADVNPCSEARCHPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x16840A10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNpcSearchProp_TypeDefinitionIndex = 17751;
