...
#define RPG_GAMECORE_REMOVEMODIFIERBYBEHAVIORFLAG_METHOD_3_0974556B08999E79_OFFSET UNITYSDK_OFFSET(0x16DE0500)
#define RPG_GAMECORE_REMOVEMODIFIERBYBEHAVIORFLAG_METHOD_3_E4C9DC360258772A_OFFSET UNITYSDK_OFFSET(0x16DE0580)
#define RPG_GAMECORE_REMOVEMODIFIERBYBEHAVIORFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x16DE0550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveModifierByBehaviorFlag_TypeDefinitionIndex = 20747;
