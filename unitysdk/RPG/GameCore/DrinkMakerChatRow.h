...
#define RPG_GAMECORE_DRINKMAKERCHATROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16A47500)
#define RPG_GAMECORE_DRINKMAKERCHATROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16A47B10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DrinkMakerChatRow_TypeDefinitionIndex = 11957;
	...
	public:
		...
		::System::UInt32 SuccessNextChatID; // 0x18
