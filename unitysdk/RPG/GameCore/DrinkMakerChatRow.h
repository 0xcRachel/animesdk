...
#define RPG_GAMECORE_DRINKMAKERCHATROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19136030)
#define RPG_GAMECORE_DRINKMAKERCHATROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19136640)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 FailNextChatID; // 0x1C
