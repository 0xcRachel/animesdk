...
#define RPG_GAMECORE_PLANETFESLEVELROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18B32380)
#define RPG_GAMECORE_PLANETFESLEVELROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18B32B20)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::PlanetFesBigInt* GrantGold; // 0x20
