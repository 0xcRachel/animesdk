...
#define RPG_GAMECORE_PARALLELCOMPLETECONFIG_METHOD_4_041A8831D8870D80_OFFSET UNITYSDK_OFFSET(0x1749C250)
#define RPG_GAMECORE_PARALLELCOMPLETECONFIG_METHOD_4_D9FB642352B45979_OFFSET UNITYSDK_OFFSET(0x1749C2D0)
#define RPG_GAMECORE_PARALLELCOMPLETECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1749C2A0)
