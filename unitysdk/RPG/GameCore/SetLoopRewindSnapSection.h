...
#define RPG_GAMECORE_SETLOOPREWINDSNAPSECTION_METHOD_3_1343E13F2CDCE893_OFFSET UNITYSDK_OFFSET(0x199BAE30)
#define RPG_GAMECORE_SETLOOPREWINDSNAPSECTION_METHOD_3_4CCDFACD013453B4_OFFSET UNITYSDK_OFFSET(0x199BAEB0)
#define RPG_GAMECORE_SETLOOPREWINDSNAPSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x199BAE80)
