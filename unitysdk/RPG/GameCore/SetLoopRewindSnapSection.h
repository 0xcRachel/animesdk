...
#define RPG_GAMECORE_SETLOOPREWINDSNAPSECTION_METHOD_3_1343E13F2CDCE893_OFFSET UNITYSDK_OFFSET(0x16F33170)
#define RPG_GAMECORE_SETLOOPREWINDSNAPSECTION_METHOD_3_4CCDFACD013453B4_OFFSET UNITYSDK_OFFSET(0x16F331F0)
#define RPG_GAMECORE_SETLOOPREWINDSNAPSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16F331C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetLoopRewindSnapSection_TypeDefinitionIndex = 18433;
