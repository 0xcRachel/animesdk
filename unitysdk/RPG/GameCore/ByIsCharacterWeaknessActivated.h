...
#define RPG_GAMECORE_BYISCHARACTERWEAKNESSACTIVATED_METHOD_4_048394E921D34B5B_OFFSET UNITYSDK_OFFSET(0x1692DC40)
#define RPG_GAMECORE_BYISCHARACTERWEAKNESSACTIVATED_METHOD_4_2FD0FAC46F173997_OFFSET UNITYSDK_OFFSET(0x1692DD10)
#define RPG_GAMECORE_BYISCHARACTERWEAKNESSACTIVATED__CTOR_OFFSET UNITYSDK_OFFSET(0x1692DCC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsCharacterWeaknessActivated_TypeDefinitionIndex = 21214;
