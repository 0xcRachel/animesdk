...
#define RPG_GAMECORE_SETBATTLEUIPANELOFFSET_METHOD_3_9C241240AFC344FB_OFFSET UNITYSDK_OFFSET(0x16F09B20)
#define RPG_GAMECORE_SETBATTLEUIPANELOFFSET_METHOD_3_EE1C0BC2687B901F_OFFSET UNITYSDK_OFFSET(0x16F09BA0)
#define RPG_GAMECORE_SETBATTLEUIPANELOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x16F09B70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBattleUIPanelOffset_TypeDefinitionIndex = 20923;
