...
#define RPG_GAMECORE_PINGPONGLEVELADDPOINTCMPTCONFIG_METHOD_3_1B40E9C07B35D0EC_OFFSET UNITYSDK_OFFSET(0x174C5ED0)
#define RPG_GAMECORE_PINGPONGLEVELADDPOINTCMPTCONFIG_METHOD_3_849B360734902BFD_OFFSET UNITYSDK_OFFSET(0x174C5E20)
#define RPG_GAMECORE_PINGPONGLEVELADDPOINTCMPTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x174C5EA0)
