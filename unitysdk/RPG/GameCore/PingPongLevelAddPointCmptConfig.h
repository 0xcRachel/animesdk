...
#define RPG_GAMECORE_PINGPONGLEVELADDPOINTCMPTCONFIG_METHOD_3_1B40E9C07B35D0EC_OFFSET UNITYSDK_OFFSET(0x16D3E080)
#define RPG_GAMECORE_PINGPONGLEVELADDPOINTCMPTCONFIG_METHOD_3_849B360734902BFD_OFFSET UNITYSDK_OFFSET(0x16D3DFD0)
#define RPG_GAMECORE_PINGPONGLEVELADDPOINTCMPTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16D3E050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongLevelAddPointCmptConfig_TypeDefinitionIndex = 16970;
