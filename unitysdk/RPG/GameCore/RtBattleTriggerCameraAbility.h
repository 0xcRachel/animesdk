...
#define RPG_GAMECORE_RTBATTLETRIGGERCAMERAABILITY_METHOD_3_504DFF4CE4471434_OFFSET UNITYSDK_OFFSET(0x19419030)
#define RPG_GAMECORE_RTBATTLETRIGGERCAMERAABILITY_METHOD_3_A1BE10D6A54D9C11_OFFSET UNITYSDK_OFFSET(0x19419100)
#define RPG_GAMECORE_RTBATTLETRIGGERCAMERAABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x194190B0)
