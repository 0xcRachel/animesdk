...
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASETALK_METHOD_3_9375824386727BFA_OFFSET UNITYSDK_OFFSET(0x1911BD00)
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASETALK_METHOD_3_E8E58EAB46C095CE_OFFSET UNITYSDK_OFFSET(0x1911BBF0)
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1911BCD0)
