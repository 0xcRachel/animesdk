...
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASETALK_METHOD_3_9375824386727BFA_OFFSET UNITYSDK_OFFSET(0x19A4AFD0)
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASETALK_METHOD_3_E8E58EAB46C095CE_OFFSET UNITYSDK_OFFSET(0x19A4AEC0)
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x19A4AFA0)
