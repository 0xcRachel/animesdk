...
#define RPG_GAMECORE_ROGUEACTGETROGUEBUFFWITHBUFFTYPECONFIG_METHOD_6_C21EFC21292E4537_OFFSET UNITYSDK_OFFSET(0x1A029260)
#define RPG_GAMECORE_ROGUEACTGETROGUEBUFFWITHBUFFTYPECONFIG_METHOD_6_D0D74110C6A8BA42_OFFSET UNITYSDK_OFFSET(0x1A029480)
#define RPG_GAMECORE_ROGUEACTGETROGUEBUFFWITHBUFFTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0293A0)
