...
#define RPG_GAMECORE_ST_MAIN_STANDBY_METHOD_4_17B8C05B134CE9E7_OFFSET UNITYSDK_OFFSET(0x16EF74B0)
#define RPG_GAMECORE_ST_MAIN_STANDBY_METHOD_4_AA5DD8C57035D86A_OFFSET UNITYSDK_OFFSET(0x16EE5820)
#define RPG_GAMECORE_ST_MAIN_STANDBY__CTOR_OFFSET UNITYSDK_OFFSET(0x16EE57D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_StandBy_TypeDefinitionIndex = 17859;
