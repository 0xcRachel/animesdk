...
#define RPG_GAMECORE_UNLOCKPLAYERCONTROL_METHOD_3_68BD2096583EA79C_OFFSET UNITYSDK_OFFSET(0x178F7D70)
#define RPG_GAMECORE_UNLOCKPLAYERCONTROL_METHOD_3_995A8D825D1F7B2D_OFFSET UNITYSDK_OFFSET(0x178F7CF0)
#define RPG_GAMECORE_UNLOCKPLAYERCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x178F7D40)
