...
#define RPG_GAMECORE_SINGLETIMEREWINDENTITYANIMEVENTBASECONFIG_METHOD_2_115212FCB58435B4_OFFSET UNITYSDK_OFFSET(0x16F6A250)
#define RPG_GAMECORE_SINGLETIMEREWINDENTITYANIMEVENTBASECONFIG_METHOD_2_65BF1AD30BF00CFA_OFFSET UNITYSDK_OFFSET(0x16F6A400)
#define RPG_GAMECORE_SINGLETIMEREWINDENTITYANIMEVENTBASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F6A240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SingleTimeRewindEntityAnimEventBaseConfig_TypeDefinitionIndex = 14954;
