...
#define RPG_GAMECORE_PLAYMISSIONTALK_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x16D4ED70)
#define RPG_GAMECORE_PLAYMISSIONTALK_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16D4ECF0)
#define RPG_GAMECORE_PLAYMISSIONTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x16D4ED40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayMissionTalk_TypeDefinitionIndex = 21520;
