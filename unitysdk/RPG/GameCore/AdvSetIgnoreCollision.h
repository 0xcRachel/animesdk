...
#define RPG_GAMECORE_ADVSETIGNORECOLLISION_METHOD_3_01683D60DDD8F8B1_OFFSET UNITYSDK_OFFSET(0x16848100)
#define RPG_GAMECORE_ADVSETIGNORECOLLISION_METHOD_3_90B5814827F5BCDD_OFFSET UNITYSDK_OFFSET(0x16848080)
#define RPG_GAMECORE_ADVSETIGNORECOLLISION__CTOR_OFFSET UNITYSDK_OFFSET(0x168480D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetIgnoreCollision_TypeDefinitionIndex = 18316;
