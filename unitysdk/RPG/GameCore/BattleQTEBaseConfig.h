...
#define RPG_GAMECORE_BATTLEQTEBASECONFIG_METHOD_2_454B3E92A821C610_OFFSET UNITYSDK_OFFSET(0x187B1FE0)
#define RPG_GAMECORE_BATTLEQTEBASECONFIG_METHOD_2_6A4FB82806DB8594_OFFSET UNITYSDK_OFFSET(0x187B2990)
#define RPG_GAMECORE_BATTLEQTEBASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x187B2BD0)
