...
#define RPG_GAMECORE_TRAINPARTYPASSENGERCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19A29210)
#define RPG_GAMECORE_TRAINPARTYPASSENGERCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19A29610)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 DiaryOrder; // 0x50
		::System::UInt32 PassengerID; // 0x54
		::System::UInt32 PassengerQuest; // 0x58
		::RPG::Client::TextID UnlcokDesc; // 0x60
