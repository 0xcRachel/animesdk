...
#define RPG_GAMECORE_TRAINPARTYPASSENGERCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19497A30)
#define RPG_GAMECORE_TRAINPARTYPASSENGERCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19497E30)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* AvatarRoundIconPath; // 0x20
		::System::String* MiniIconPath; // 0x28
		::System::String* IconPath; // 0x30
		::System::String* AvatarRoundIconBgPath; // 0x38
		::RPG::Client::TextID UnlcokDesc; // 0x40
		::System::UInt32 PassengerID; // 0x50
		::System::UInt32 PassengerQuest; // 0x54
