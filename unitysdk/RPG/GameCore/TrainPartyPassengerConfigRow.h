...
#define RPG_GAMECORE_TRAINPARTYPASSENGERCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x178C2200)
#define RPG_GAMECORE_TRAINPARTYPASSENGERCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x178C2600)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 DiaryOrder; // 0x58
		::System::UInt32 PassengerID; // 0x5C
