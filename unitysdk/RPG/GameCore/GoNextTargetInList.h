...
#define RPG_GAMECORE_GONEXTTARGETINLIST_METHOD_3_22C22C4CD6B107FA_OFFSET UNITYSDK_OFFSET(0x16B12750)
#define RPG_GAMECORE_GONEXTTARGETINLIST_METHOD_3_783238B496FF21CE_OFFSET UNITYSDK_OFFSET(0x16B12640)
#define RPG_GAMECORE_GONEXTTARGETINLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x16B12720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GoNextTargetInList_TypeDefinitionIndex = 20115;
