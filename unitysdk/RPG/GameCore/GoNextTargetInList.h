...
#define RPG_GAMECORE_GONEXTTARGETINLIST_METHOD_3_22C22C4CD6B107FA_OFFSET UNITYSDK_OFFSET(0x1955DE10)
#define RPG_GAMECORE_GONEXTTARGETINLIST_METHOD_3_783238B496FF21CE_OFFSET UNITYSDK_OFFSET(0x1955DD00)
#define RPG_GAMECORE_GONEXTTARGETINLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1955DDE0)
