...
#define RPG_GAMECORE_BYLOCALPLAYERISFAKEAVATAR_METHOD_4_72D1198EC2C9203A_OFFSET UNITYSDK_OFFSET(0x19A6BFB0)
#define RPG_GAMECORE_BYLOCALPLAYERISFAKEAVATAR_METHOD_4_D27BC0D2787C9510_OFFSET UNITYSDK_OFFSET(0x19A6BEE0)
#define RPG_GAMECORE_BYLOCALPLAYERISFAKEAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x19A6BF60)
