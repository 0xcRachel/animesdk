...
#define RPG_GAMECORE_ADVNPCMONSTERSETUPTRIGGER_METHOD_3_17508F992E0679C8_OFFSET UNITYSDK_OFFSET(0x1683F410)
#define RPG_GAMECORE_ADVNPCMONSTERSETUPTRIGGER_METHOD_3_9C75C43FC7629CEE_OFFSET UNITYSDK_OFFSET(0x1683F380)
#define RPG_GAMECORE_ADVNPCMONSTERSETUPTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1683F3E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNpcMonsterSetupTrigger_TypeDefinitionIndex = 19868;
