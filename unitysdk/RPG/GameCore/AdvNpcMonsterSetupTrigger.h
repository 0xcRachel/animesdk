...
#define RPG_GAMECORE_ADVNPCMONSTERSETUPTRIGGER_METHOD_3_17508F992E0679C8_OFFSET UNITYSDK_OFFSET(0x18C52850)
#define RPG_GAMECORE_ADVNPCMONSTERSETUPTRIGGER_METHOD_3_9C75C43FC7629CEE_OFFSET UNITYSDK_OFFSET(0x18C527C0)
#define RPG_GAMECORE_ADVNPCMONSTERSETUPTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x18C52820)
