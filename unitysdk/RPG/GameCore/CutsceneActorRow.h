...
#define RPG_GAMECORE_CUTSCENEACTORROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x169DA950)
#define RPG_GAMECORE_CUTSCENEACTORROW__CTOR_OFFSET UNITYSDK_OFFSET(0x169DAB10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CutsceneActorRow_TypeDefinitionIndex = 11880;
