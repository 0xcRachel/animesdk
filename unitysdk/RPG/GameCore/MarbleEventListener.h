...
#define RPG_GAMECORE_MARBLEEVENTLISTENER_METHOD_3_5F25FA9C230F8774_OFFSET UNITYSDK_OFFSET(0x16C3D180)
#define RPG_GAMECORE_MARBLEEVENTLISTENER_METHOD_3_CD497E838E3127DB_OFFSET UNITYSDK_OFFSET(0x16C3D200)
#define RPG_GAMECORE_MARBLEEVENTLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x16C3D1D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleEventListener_TypeDefinitionIndex = 19691;
