...
#define RPG_GAMECORE_MANUALTRIGGERANIMEVENT_METHOD_3_3E8888F579D1FF43_OFFSET UNITYSDK_OFFSET(0x16C28FA0)
#define RPG_GAMECORE_MANUALTRIGGERANIMEVENT_METHOD_3_7DE3FCF333B06897_OFFSET UNITYSDK_OFFSET(0x16C29130)
#define RPG_GAMECORE_MANUALTRIGGERANIMEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x16C28FE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ManualTriggerAnimEvent_TypeDefinitionIndex = 20528;
