...
#define RPG_GAMECORE_HELIOBUSPOSTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19ABC630)
#define RPG_GAMECORE_HELIOBUSPOSTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19ABDF30)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 HeliobusPostID; // 0x30
		::System::UInt32 PostTypeParameter; // 0x34
		::RPG::GameCore::HeliobusPostType PostType; // 0x38
		::System::UInt32 ReplyIncomeReward; // 0x3C
		::System::UInt32 PostImgID; // 0x40
		::RPG::Client::TextID PostFansPreview; // 0x48
		::System::Boolean IsClosePanel; // 0x58
		::System::UInt32 PostIncomeReward; // 0x5C
		::System::UInt32 PostUnlockPhase; // 0x60
		::System::UInt32 HeliobusUserID; // 0x64
