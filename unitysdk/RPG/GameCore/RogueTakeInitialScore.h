...
#define RPG_GAMECORE_ROGUETAKEINITIALSCORE_METHOD_3_311FD5654CD0276C_OFFSET UNITYSDK_OFFSET(0x16EBA350)
#define RPG_GAMECORE_ROGUETAKEINITIALSCORE_METHOD_3_C2AC8B3BB5B44EF8_OFFSET UNITYSDK_OFFSET(0x16EBA460)
#define RPG_GAMECORE_ROGUETAKEINITIALSCORE__CTOR_OFFSET UNITYSDK_OFFSET(0x16EBA430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTakeInitialScore_TypeDefinitionIndex = 19944;
