...
#define RPG_GAMECORE_ROGUETAKEINITIALSCORE_METHOD_3_311FD5654CD0276C_OFFSET UNITYSDK_OFFSET(0x1766F1D0)
#define RPG_GAMECORE_ROGUETAKEINITIALSCORE_METHOD_3_C2AC8B3BB5B44EF8_OFFSET UNITYSDK_OFFSET(0x1766F2E0)
#define RPG_GAMECORE_ROGUETAKEINITIALSCORE__CTOR_OFFSET UNITYSDK_OFFSET(0x1766F2B0)
