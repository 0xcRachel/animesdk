...
#define RPG_GAMECORE_MESSAGEITEMRAIDENTRANCEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16C85D40)
#define RPG_GAMECORE_MESSAGEITEMRAIDENTRANCEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16C86910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MessageItemRaidEntranceRow_TypeDefinitionIndex = 13143;
