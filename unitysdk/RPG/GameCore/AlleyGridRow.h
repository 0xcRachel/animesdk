...
#define RPG_GAMECORE_ALLEYGRIDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16F87E90)
#define RPG_GAMECORE_ALLEYGRIDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16F88690)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID GridTitle; // 0x40
