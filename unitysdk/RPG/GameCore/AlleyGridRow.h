...
#define RPG_GAMECORE_ALLEYGRIDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18BCDEA0)
#define RPG_GAMECORE_ALLEYGRIDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18BCE6C0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::GridTypeEnum GridType; // 0x34
		::System::UInt32 RelatedMainMission; // 0x38
