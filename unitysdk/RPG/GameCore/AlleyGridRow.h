...
#define RPG_GAMECORE_ALLEYGRIDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18AC8BA0)
#define RPG_GAMECORE_ALLEYGRIDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18AC93A0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 RelatedMainMission; // 0x3C
