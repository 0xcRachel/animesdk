...
#define RPG_GAMECORE_ADVENTUREBYISINROTATION_METHOD_4_091BD5AD5615AFF5_OFFSET UNITYSDK_OFFSET(0x16853DE0)
#define RPG_GAMECORE_ADVENTUREBYISINROTATION_METHOD_4_E1DCBC1EC452DDEE_OFFSET UNITYSDK_OFFSET(0x16853D00)
#define RPG_GAMECORE_ADVENTUREBYISINROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x16853D80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureByIsInRotation_TypeDefinitionIndex = 18585;
