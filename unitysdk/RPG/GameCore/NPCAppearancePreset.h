...
#define RPG_GAMECORE_NPCAPPEARANCEPRESET_METHOD_2_399D005045C6C2FC_OFFSET UNITYSDK_OFFSET(0x18645D10)
#define RPG_GAMECORE_NPCAPPEARANCEPRESET__CTOR_OFFSET UNITYSDK_OFFSET(0x18645EE0)
