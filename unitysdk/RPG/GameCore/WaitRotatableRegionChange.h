...
#define RPG_GAMECORE_WAITROTATABLEREGIONCHANGE_METHOD_4_6932E791DA7837A2_OFFSET UNITYSDK_OFFSET(0x1715BB20)
#define RPG_GAMECORE_WAITROTATABLEREGIONCHANGE_METHOD_4_73A7329C7CC44F19_OFFSET UNITYSDK_OFFSET(0x1715BA40)
#define RPG_GAMECORE_WAITROTATABLEREGIONCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1715BAC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRotatableRegionChange_TypeDefinitionIndex = 19026;
