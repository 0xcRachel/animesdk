...
#define RPG_GAMECORE_PLAYSERIALBELLS_METHOD_3_87FC6DE03DFF73EF_OFFSET UNITYSDK_OFFSET(0x18B3BB30)
#define RPG_GAMECORE_PLAYSERIALBELLS_METHOD_3_B9DBB579ED6A2A20_OFFSET UNITYSDK_OFFSET(0x18B3BBC0)
#define RPG_GAMECORE_PLAYSERIALBELLS__CTOR_OFFSET UNITYSDK_OFFSET(0x18B3BB90)
