...
#define RPG_GAMECORE_AETHERDIVIDECHALLENGERANKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18BBBF90)
#define RPG_GAMECORE_AETHERDIVIDECHALLENGERANKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18BBC700)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean IsHard; // 0x20
		::System::UInt32 ChallengeRank; // 0x24
		::RPG::Client::TextID UnlockText; // 0x28
		::System::UInt32 TrainerLevel; // 0x38
		::System::UInt32 PreRank; // 0x3C
