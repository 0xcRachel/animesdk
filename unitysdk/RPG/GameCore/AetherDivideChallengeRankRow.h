...
#define RPG_GAMECORE_AETHERDIVIDECHALLENGERANKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18C7A810)
#define RPG_GAMECORE_AETHERDIVIDECHALLENGERANKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18C7AFA0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean IsHard; // 0x18
		::System::UInt32 PreRank; // 0x1C
		::System::UInt32 FunctionUnlockID; // 0x20
		::System::UInt32 TrainerLevel; // 0x24
