...
#define RPG_GAMECORE_BYENTITYTIMESCALEZERO_METHOD_4_0B6131B44729635F_OFFSET UNITYSDK_OFFSET(0x16924D40)
#define RPG_GAMECORE_BYENTITYTIMESCALEZERO_METHOD_4_310E0C75F8458A81_OFFSET UNITYSDK_OFFSET(0x16924C70)
#define RPG_GAMECORE_BYENTITYTIMESCALEZERO__CTOR_OFFSET UNITYSDK_OFFSET(0x16924CF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByEntityTimeScaleZero_TypeDefinitionIndex = 18378;
