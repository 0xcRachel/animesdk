...
#define RPG_GAMECORE_CHIMERADUELWAITSECONDSNODE_METHOD_3_D407FBB18DD7391E_OFFSET UNITYSDK_OFFSET(0x1699A880)
#define RPG_GAMECORE_CHIMERADUELWAITSECONDSNODE_METHOD_3_F048FEE914F18090_OFFSET UNITYSDK_OFFSET(0x1699AA20)
#define RPG_GAMECORE_CHIMERADUELWAITSECONDSNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1699A9D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelWaitSecondsNode_TypeDefinitionIndex = 14400;
