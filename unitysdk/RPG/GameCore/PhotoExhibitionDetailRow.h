...
#define RPG_GAMECORE_PHOTOEXHIBITIONDETAILROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18B1A570)
#define RPG_GAMECORE_PHOTOEXHIBITIONDETAILROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18B1AB60)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID RuikeReply; // 0x78
