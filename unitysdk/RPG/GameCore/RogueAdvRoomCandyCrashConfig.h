...
#define RPG_GAMECORE_ROGUEADVROOMCANDYCRASHCONFIG_METHOD_2_641186A55198F303_OFFSET UNITYSDK_OFFSET(0x1A9C90C0)
#define RPG_GAMECORE_ROGUEADVROOMCANDYCRASHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9C91C0)
