...
#define RPG_GAMECORE_ROGUEADVROOMCANDYCRASHCONFIG_METHOD_2_C319CE300B7DEB39_OFFSET UNITYSDK_OFFSET(0x16E115B0)
#define RPG_GAMECORE_ROGUEADVROOMCANDYCRASHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E116C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAdvRoomCandyCrashConfig_TypeDefinitionIndex = 16068;
