...
#define RPG_GAMECORE_FETCHADVNPCDATA_METHOD_2_9850D7BFB02D5F74_OFFSET UNITYSDK_OFFSET(0x16A9D5E0)
#define RPG_GAMECORE_FETCHADVNPCDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16A9D700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FetchAdvNPCData_TypeDefinitionIndex = 21576;
