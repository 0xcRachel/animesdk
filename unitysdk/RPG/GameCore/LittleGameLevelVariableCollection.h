...
#define RPG_GAMECORE_LITTLEGAMELEVELVARIABLECOLLECTION_METHOD_2_75FAFA42E7BC465E_OFFSET UNITYSDK_OFFSET(0x16BCED10)
#define RPG_GAMECORE_LITTLEGAMELEVELVARIABLECOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16BD02B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameLevelVariableCollection_TypeDefinitionIndex = 16934;
