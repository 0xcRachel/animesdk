...
#define RPG_GAMECORE_LITTLEGAMEWAYPOINTGRAPHCONFIG_METHOD_3_B4BB9CCC6928EBF6_OFFSET UNITYSDK_OFFSET(0x16BD1FF0)
#define RPG_GAMECORE_LITTLEGAMEWAYPOINTGRAPHCONFIG_METHOD_3_F1A3FE1C616F18B9_OFFSET UNITYSDK_OFFSET(0x16BCC410)
#define RPG_GAMECORE_LITTLEGAMEWAYPOINTGRAPHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16BCC3E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameWayPointGraphConfig_TypeDefinitionIndex = 16913;
