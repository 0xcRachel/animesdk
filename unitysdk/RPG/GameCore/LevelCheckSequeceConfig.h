...
#define RPG_GAMECORE_LEVELCHECKSEQUECECONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16BA1260)
#define RPG_GAMECORE_LEVELCHECKSEQUECECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16BA1360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelCheckSequeceConfig_TypeDefinitionIndex = 16422;
