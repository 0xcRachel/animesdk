...
#define RPG_GAMECORE_ST_SIDE_TRIGGEREFFECT_METHOD_4_34D42A6F7507E798_OFFSET UNITYSDK_OFFSET(0x16EF9220)
#define RPG_GAMECORE_ST_SIDE_TRIGGEREFFECT_METHOD_4_61D5EB787223950F_OFFSET UNITYSDK_OFFSET(0x16EED400)
#define RPG_GAMECORE_ST_SIDE_TRIGGEREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x16EED390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_TriggerEffect_TypeDefinitionIndex = 17914;
