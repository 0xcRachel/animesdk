...
#define RPG_GAMECORE_CONVINCEWAITALLTURNFINISH_METHOD_3_21E4615BE2EFBAA8_OFFSET UNITYSDK_OFFSET(0x18FAAA70)
#define RPG_GAMECORE_CONVINCEWAITALLTURNFINISH_METHOD_3_76ABF7FAF82DED94_OFFSET UNITYSDK_OFFSET(0x18FAAB80)
#define RPG_GAMECORE_CONVINCEWAITALLTURNFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x18FAAB50)
