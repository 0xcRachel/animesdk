...
#define RPG_GAMECORE_CONVINCEWAITALLTURNFINISH_METHOD_3_21E4615BE2EFBAA8_OFFSET UNITYSDK_OFFSET(0x1714C7C0)
#define RPG_GAMECORE_CONVINCEWAITALLTURNFINISH_METHOD_3_76ABF7FAF82DED94_OFFSET UNITYSDK_OFFSET(0x1714C8D0)
#define RPG_GAMECORE_CONVINCEWAITALLTURNFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1714C8A0)
