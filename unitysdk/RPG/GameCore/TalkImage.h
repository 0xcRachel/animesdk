...
#define RPG_GAMECORE_TALKIMAGE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16FC8850)
#define RPG_GAMECORE_TALKIMAGE_PATHINVALID_OFFSET UNITYSDK_OFFSET(0x16FC8C10)
#define RPG_GAMECORE_TALKIMAGE_SHAREBYCOPY_OFFSET UNITYSDK_OFFSET(0x16FC8B70)
#define RPG_GAMECORE_TALKIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FC8B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TalkImage_TypeDefinitionIndex = 21869;
