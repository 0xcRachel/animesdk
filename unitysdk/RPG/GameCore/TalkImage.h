...
#define RPG_GAMECORE_TALKIMAGE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x177BCCC0)
#define RPG_GAMECORE_TALKIMAGE_PATHINVALID_OFFSET UNITYSDK_OFFSET(0x177BD080)
#define RPG_GAMECORE_TALKIMAGE_SHAREBYCOPY_OFFSET UNITYSDK_OFFSET(0x177BCFE0)
#define RPG_GAMECORE_TALKIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x177BCFD0)
