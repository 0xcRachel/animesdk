...
#define RPG_GAMECORE_HIDEMODIFIEREFFECT_METHOD_3_42EFA32977E5E624_OFFSET UNITYSDK_OFFSET(0x16B70170)
#define RPG_GAMECORE_HIDEMODIFIEREFFECT_METHOD_3_A9DD9D6D0E821409_OFFSET UNITYSDK_OFFSET(0x16B701F0)
#define RPG_GAMECORE_HIDEMODIFIEREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x16B701C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HideModifierEffect_TypeDefinitionIndex = 21316;
