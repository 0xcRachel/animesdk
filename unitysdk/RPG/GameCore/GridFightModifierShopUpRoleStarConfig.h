...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLESTARCONFIG_METHOD_3_7AE0EECA587A9033_OFFSET UNITYSDK_OFFSET(0x16B311E0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLESTARCONFIG_METHOD_3_90B2B82B8E60E07A_OFFSET UNITYSDK_OFFSET(0x16B345C0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLESTARCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16B31190)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierShopUpRoleStarConfig_TypeDefinitionIndex = 17359;
