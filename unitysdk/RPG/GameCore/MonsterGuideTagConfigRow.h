...
#define RPG_GAMECORE_MONSTERGUIDETAGCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16CDE940)
#define RPG_GAMECORE_MONSTERGUIDETAGCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16CDECB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonsterGuideTagConfigRow_TypeDefinitionIndex = 12924;
	...
	public:
		...
		::RPG::Client::TextID TagBriefDescription; // 0x30
		::RPG::Client::TextID TagDetailDescription; // 0x40
