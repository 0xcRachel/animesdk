...
#define RPG_GAMECORE_CONVINCEMOVEPREVTURN_METHOD_3_A2C75C7E600F4790_OFFSET UNITYSDK_OFFSET(0x1714BA30)
#define RPG_GAMECORE_CONVINCEMOVEPREVTURN_METHOD_3_AA04D7D8CAC94749_OFFSET UNITYSDK_OFFSET(0x1714B9B0)
#define RPG_GAMECORE_CONVINCEMOVEPREVTURN__CTOR_OFFSET UNITYSDK_OFFSET(0x1714BA00)
