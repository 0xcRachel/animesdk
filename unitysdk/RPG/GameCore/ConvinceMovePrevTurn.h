...
#define RPG_GAMECORE_CONVINCEMOVEPREVTURN_METHOD_3_A2C75C7E600F4790_OFFSET UNITYSDK_OFFSET(0x169CFA80)
#define RPG_GAMECORE_CONVINCEMOVEPREVTURN_METHOD_3_AA04D7D8CAC94749_OFFSET UNITYSDK_OFFSET(0x169CFA00)
#define RPG_GAMECORE_CONVINCEMOVEPREVTURN__CTOR_OFFSET UNITYSDK_OFFSET(0x169CFA50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConvinceMovePrevTurn_TypeDefinitionIndex = 19481;
