...
#define RPG_GAMECORE_RTSUBMODIFIERDATA_METHOD_2_7A3B629FF5E5C700_OFFSET UNITYSDK_OFFSET(0x18E8A3B0)
#define RPG_GAMECORE_RTSUBMODIFIERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18E8A5D0)
