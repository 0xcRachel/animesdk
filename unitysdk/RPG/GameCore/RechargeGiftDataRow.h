...
#define RPG_GAMECORE_RECHARGEGIFTDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19014990)
#define RPG_GAMECORE_RECHARGEGIFTDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19014B90)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::UInt32 McoinFree; // 0x10
		::System::UInt32 RewardsPay; // 0x14
		::System::UInt32 GiftID; // 0x18
		::System::UInt32 RewardsFree; // 0x1C
		::System::UInt32 Days; // 0x20
