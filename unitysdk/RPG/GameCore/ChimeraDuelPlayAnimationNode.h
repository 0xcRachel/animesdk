...
#define RPG_GAMECORE_CHIMERADUELPLAYANIMATIONNODE_METHOD_3_2782CAFB9302087C_OFFSET UNITYSDK_OFFSET(0x170B6690)
#define RPG_GAMECORE_CHIMERADUELPLAYANIMATIONNODE_METHOD_3_B19A607B64C22A9D_OFFSET UNITYSDK_OFFSET(0x170B65B0)
#define RPG_GAMECORE_CHIMERADUELPLAYANIMATIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x170B6640)
