...
#define RPG_GAMECORE_CHIMERADUELPLAYANIMATIONNODE_METHOD_3_2782CAFB9302087C_OFFSET UNITYSDK_OFFSET(0x194C3D80)
#define RPG_GAMECORE_CHIMERADUELPLAYANIMATIONNODE_METHOD_3_B19A607B64C22A9D_OFFSET UNITYSDK_OFFSET(0x194C3CA0)
#define RPG_GAMECORE_CHIMERADUELPLAYANIMATIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x194C3D30)
