...
#define RPG_GAMECORE_CHIMERADUELPLAYANIMATIONNODE_METHOD_3_2782CAFB9302087C_OFFSET UNITYSDK_OFFSET(0x16994940)
#define RPG_GAMECORE_CHIMERADUELPLAYANIMATIONNODE_METHOD_3_B19A607B64C22A9D_OFFSET UNITYSDK_OFFSET(0x16994860)
#define RPG_GAMECORE_CHIMERADUELPLAYANIMATIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x169948F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelPlayAnimationNode_TypeDefinitionIndex = 14388;
