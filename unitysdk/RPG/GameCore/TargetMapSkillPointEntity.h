...
#define RPG_GAMECORE_TARGETMAPSKILLPOINTENTITY_METHOD_3_1884732C7C743BEC_OFFSET UNITYSDK_OFFSET(0x16FE31F0)
#define RPG_GAMECORE_TARGETMAPSKILLPOINTENTITY_METHOD_3_AA112902E5586378_OFFSET UNITYSDK_OFFSET(0x16FE3320)
#define RPG_GAMECORE_TARGETMAPSKILLPOINTENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE3300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapSkillPointEntity_TypeDefinitionIndex = 21664;
