...
#define RPG_GAMECORE_ALLEYACTIVITYQUESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16874740)
#define RPG_GAMECORE_ALLEYACTIVITYQUESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16874940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AlleyActivityQuestRow_TypeDefinitionIndex = 11460;

	class AlleyActivityQuestRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* QuestList; // 0x10
		::System::UInt32 SubTab; // 0x18
