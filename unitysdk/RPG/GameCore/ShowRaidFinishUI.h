...
#define RPG_GAMECORE_SHOWRAIDFINISHUI_METHOD_3_979CB63E733A28A9_OFFSET UNITYSDK_OFFSET(0x16F608F0)
#define RPG_GAMECORE_SHOWRAIDFINISHUI_METHOD_3_AFB78C2AF410F0A0_OFFSET UNITYSDK_OFFSET(0x16F60970)
#define RPG_GAMECORE_SHOWRAIDFINISHUI__CTOR_OFFSET UNITYSDK_OFFSET(0x16F60940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowRaidFinishUI_TypeDefinitionIndex = 19251;
