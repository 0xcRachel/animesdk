...
#define RPG_GAMECORE_CHECKSKILLDEPENDENCYAXIS_METHOD_3_4D2BC474D012BC49_OFFSET UNITYSDK_OFFSET(0x169792D0)
#define RPG_GAMECORE_CHECKSKILLDEPENDENCYAXIS_METHOD_3_5280C96B4DD5AA08_OFFSET UNITYSDK_OFFSET(0x16979310)
#define RPG_GAMECORE_CHECKSKILLDEPENDENCYAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x16979300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CheckSkillDependencyAxis_TypeDefinitionIndex = 14089;
