...
#define RPG_GAMECORE_BYMAINMISSIONFINISH_METHOD_4_724AEBA713197D9D_OFFSET UNITYSDK_OFFSET(0x16939640)
#define RPG_GAMECORE_BYMAINMISSIONFINISH_METHOD_4_73E29FBDB861606F_OFFSET UNITYSDK_OFFSET(0x16939570)
#define RPG_GAMECORE_BYMAINMISSIONFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x169395F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByMainMissionFinish_TypeDefinitionIndex = 18256;
