...
#define RPG_GAMECORE_ROGUEMAGICDIFFICULTYDROPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16E869A0)
#define RPG_GAMECORE_ROGUEMAGICDIFFICULTYDROPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16E86B10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMagicDifficultyDropRow_TypeDefinitionIndex = 13505;
