...
#define RPG_GAMECORE_ROGUECURSECHESTPROPINTERACT_METHOD_3_070B94C36DB37C6E_OFFSET UNITYSDK_OFFSET(0x176038C0)
#define RPG_GAMECORE_ROGUECURSECHESTPROPINTERACT_METHOD_3_0B31D2B743AD9C31_OFFSET UNITYSDK_OFFSET(0x17603840)
#define RPG_GAMECORE_ROGUECURSECHESTPROPINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x17603890)
