...
#define RPG_GAMECORE_CONVINCESPLITLINE_METHOD_3_19DDA9977D547F3B_OFFSET UNITYSDK_OFFSET(0x1714C520)
#define RPG_GAMECORE_CONVINCESPLITLINE_METHOD_3_912035860BAD02D2_OFFSET UNITYSDK_OFFSET(0x1714C4A0)
#define RPG_GAMECORE_CONVINCESPLITLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1714C4F0)
