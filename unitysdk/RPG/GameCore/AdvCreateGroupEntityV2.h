...
#define RPG_GAMECORE_ADVCREATEGROUPENTITYV2_METHOD_3_360ED04ABD9DE24A_OFFSET UNITYSDK_OFFSET(0x168310A0)
#define RPG_GAMECORE_ADVCREATEGROUPENTITYV2_METHOD_3_9B3B57FAF5B70D31_OFFSET UNITYSDK_OFFSET(0x16831120)
#define RPG_GAMECORE_ADVCREATEGROUPENTITYV2__CTOR_OFFSET UNITYSDK_OFFSET(0x168310F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvCreateGroupEntityV2_TypeDefinitionIndex = 18053;
