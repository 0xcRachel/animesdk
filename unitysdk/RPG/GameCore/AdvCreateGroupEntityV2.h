...
#define RPG_GAMECORE_ADVCREATEGROUPENTITYV2_METHOD_3_B5DB48C66F17C04B_OFFSET UNITYSDK_OFFSET(0x1955EEE0)
#define RPG_GAMECORE_ADVCREATEGROUPENTITYV2_METHOD_3_E32A7CEC7A047B8A_OFFSET UNITYSDK_OFFSET(0x1955EF60)
#define RPG_GAMECORE_ADVCREATEGROUPENTITYV2__CTOR_OFFSET UNITYSDK_OFFSET(0x1955EF30)
