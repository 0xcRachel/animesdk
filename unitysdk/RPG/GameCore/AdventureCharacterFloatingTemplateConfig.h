...
#define RPG_GAMECORE_ADVENTURECHARACTERFLOATINGTEMPLATECONFIG_METHOD_2_FF72FC8650BC7384_OFFSET UNITYSDK_OFFSET(0x19C09E70)
#define RPG_GAMECORE_ADVENTURECHARACTERFLOATINGTEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19C09F50)
