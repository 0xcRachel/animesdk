...
#define RPG_GAMECORE_PROPPUZZLEEVENTSENDER_METHOD_3_4D25964ACACE3775_OFFSET UNITYSDK_OFFSET(0x16DB0370)
#define RPG_GAMECORE_PROPPUZZLEEVENTSENDER_METHOD_3_B56A0DD98AE22F26_OFFSET UNITYSDK_OFFSET(0x16DB02F0)
#define RPG_GAMECORE_PROPPUZZLEEVENTSENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x16DB0340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropPuzzleEventSender_TypeDefinitionIndex = 19218;
