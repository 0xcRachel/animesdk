...
#define RPG_GAMECORE_PROPPUZZLEEVENTSENDER_METHOD_3_4D25964ACACE3775_OFFSET UNITYSDK_OFFSET(0x175370C0)
#define RPG_GAMECORE_PROPPUZZLEEVENTSENDER_METHOD_3_B56A0DD98AE22F26_OFFSET UNITYSDK_OFFSET(0x17537040)
#define RPG_GAMECORE_PROPPUZZLEEVENTSENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x17537090)
