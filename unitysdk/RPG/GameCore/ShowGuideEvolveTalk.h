...
#define RPG_GAMECORE_SHOWGUIDEEVOLVETALK_METHOD_3_08A49B504AFD4FCD_OFFSET UNITYSDK_OFFSET(0x17710C20)
#define RPG_GAMECORE_SHOWGUIDEEVOLVETALK_METHOD_3_E4DDE1146AF0759A_OFFSET UNITYSDK_OFFSET(0x17710CA0)
#define RPG_GAMECORE_SHOWGUIDEEVOLVETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x17710C70)
