...
#define RPG_GAMECORE_SHOWGUIDEEVOLVETALK_METHOD_3_08A49B504AFD4FCD_OFFSET UNITYSDK_OFFSET(0x16F5B6B0)
#define RPG_GAMECORE_SHOWGUIDEEVOLVETALK_METHOD_3_E4DDE1146AF0759A_OFFSET UNITYSDK_OFFSET(0x16F5B730)
#define RPG_GAMECORE_SHOWGUIDEEVOLVETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x16F5B700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowGuideEvolveTalk_TypeDefinitionIndex = 21807;
