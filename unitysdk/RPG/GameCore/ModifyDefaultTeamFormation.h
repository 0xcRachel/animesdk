...
#define RPG_GAMECORE_MODIFYDEFAULTTEAMFORMATION_METHOD_3_1E595BA546AC205E_OFFSET UNITYSDK_OFFSET(0x16CBDEE0)
#define RPG_GAMECORE_MODIFYDEFAULTTEAMFORMATION_METHOD_3_6DFBC248FB01A0F5_OFFSET UNITYSDK_OFFSET(0x16CBE060)
#define RPG_GAMECORE_MODIFYDEFAULTTEAMFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x16CBDFB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyDefaultTeamFormation_TypeDefinitionIndex = 20132;
