...
#define RPG_GAMECORE_MODIFYDEFAULTTEAMFORMATION_METHOD_3_290B0C8EAA125B1E_OFFSET UNITYSDK_OFFSET(0x196ACAD0)
#define RPG_GAMECORE_MODIFYDEFAULTTEAMFORMATION_METHOD_3_9227538EE359B3B1_OFFSET UNITYSDK_OFFSET(0x196AC950)
#define RPG_GAMECORE_MODIFYDEFAULTTEAMFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x196ACA20)
