...
#define RPG_GAMECORE_BYCOMPAREPHONEMESSAGEITEM_METHOD_4_05857B824FE917C0_OFFSET UNITYSDK_OFFSET(0x16915450)
#define RPG_GAMECORE_BYCOMPAREPHONEMESSAGEITEM_METHOD_4_825698B02ABFDF4A_OFFSET UNITYSDK_OFFSET(0x16915520)
#define RPG_GAMECORE_BYCOMPAREPHONEMESSAGEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x169154D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByComparePhoneMessageItem_TypeDefinitionIndex = 18513;
