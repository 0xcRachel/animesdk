...
#define RPG_GAMECORE_SETCHARLIGHTTOENTITYDIR_METHOD_3_3CF43F9A08D31714_OFFSET UNITYSDK_OFFSET(0x176C0D40)
#define RPG_GAMECORE_SETCHARLIGHTTOENTITYDIR_METHOD_3_8890CDB15035954B_OFFSET UNITYSDK_OFFSET(0x176C0E90)
#define RPG_GAMECORE_SETCHARLIGHTTOENTITYDIR__CTOR_OFFSET UNITYSDK_OFFSET(0x176C0E00)
