...
#define RPG_GAMECORE_SETCHARLIGHTTOENTITYDIR_METHOD_3_3CF43F9A08D31714_OFFSET UNITYSDK_OFFSET(0x16F0B8B0)
#define RPG_GAMECORE_SETCHARLIGHTTOENTITYDIR_METHOD_3_8890CDB15035954B_OFFSET UNITYSDK_OFFSET(0x16F0BA00)
#define RPG_GAMECORE_SETCHARLIGHTTOENTITYDIR__CTOR_OFFSET UNITYSDK_OFFSET(0x16F0B970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCharLightToEntityDir_TypeDefinitionIndex = 19515;
