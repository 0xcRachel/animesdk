...
#define RPG_GAMECORE_RESETMISSIONWAYPOINT_METHOD_3_7916377EE16BDFAD_OFFSET UNITYSDK_OFFSET(0x175B31A0)
#define RPG_GAMECORE_RESETMISSIONWAYPOINT_METHOD_3_A16AEA80EB49B2AC_OFFSET UNITYSDK_OFFSET(0x175B3220)
#define RPG_GAMECORE_RESETMISSIONWAYPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x175B31F0)
