...
#define RPG_GAMECORE_NPCAPPEARANCEPRESETLIST_METHOD_2_0973B1A72A63E36E_OFFSET UNITYSDK_OFFSET(0x1747F320)
#define RPG_GAMECORE_NPCAPPEARANCEPRESETLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1747F3F0)
