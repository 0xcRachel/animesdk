...
#define RPG_GAMECORE_SHOWALLEYMAINENTRANCEPAGE_METHOD_3_0BC5D5DC144CE6B5_OFFSET UNITYSDK_OFFSET(0x17708370)
#define RPG_GAMECORE_SHOWALLEYMAINENTRANCEPAGE_METHOD_3_ED689718DD457AB3_OFFSET UNITYSDK_OFFSET(0x177083F0)
#define RPG_GAMECORE_SHOWALLEYMAINENTRANCEPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x177083C0)
