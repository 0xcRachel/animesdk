...
#define RPG_GAMECORE_SHOWALLEYMAINENTRANCEPAGE_METHOD_3_0BC5D5DC144CE6B5_OFFSET UNITYSDK_OFFSET(0x16F52EF0)
#define RPG_GAMECORE_SHOWALLEYMAINENTRANCEPAGE_METHOD_3_ED689718DD457AB3_OFFSET UNITYSDK_OFFSET(0x16F52F70)
#define RPG_GAMECORE_SHOWALLEYMAINENTRANCEPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F52F40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowAlleyMainEntrancePage_TypeDefinitionIndex = 18917;
