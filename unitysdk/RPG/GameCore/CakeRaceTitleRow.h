...
#define RPG_GAMECORE_CAKERACETITLEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17063DB0)
#define RPG_GAMECORE_CAKERACETITLEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x170641A0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID TitleName; // 0x38
		::System::UInt32 Priority; // 0x48
		::RPG::GameCore::CakeRaceTitleExtremType ExtremType; // 0x4C
