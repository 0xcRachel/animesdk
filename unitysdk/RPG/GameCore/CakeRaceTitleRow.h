...
#define RPG_GAMECORE_CAKERACETITLEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18D3E350)
#define RPG_GAMECORE_CAKERACETITLEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18D3E740)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::CakeRaceTitleConditionType ConditionType; // 0x20
		::RPG::GameCore::CakeRaceTitleExtremType ExtremType; // 0x24
