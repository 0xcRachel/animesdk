...
#define RPG_GAMECORE_ADVENTUREPHASECACHE_GETENTITYLODLOADINGDATA_OFFSET UNITYSDK_OFFSET(0xA31B850)
#define RPG_GAMECORE_ADVENTUREPHASECACHE_GETMESHLODPATH_OFFSET UNITYSDK_OFFSET(0xA31BA50)
#define RPG_GAMECORE_ADVENTUREPHASECACHE_RELEASEONSWITCHMAP_OFFSET UNITYSDK_OFFSET(0xA31B770)
#define RPG_GAMECORE_ADVENTUREPHASECACHE__CCTOR_OFFSET UNITYSDK_OFFSET(0xA31BC80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventurePhaseCache_TypeDefinitionIndex = 41245;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Collections::Generic::KeyValuePair_2<::System::String*, ::System::Int32>, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(AdventurePhaseCache_TypeDefinitionIndex)->GetStaticField(0x3E2B0);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::RPG::GameCore::EntityLodLoadingData*>**)Il2CppClass::FromTypeDefinitionIndex(AdventurePhaseCache_TypeDefinitionIndex)->GetStaticField(0x3E2B8);
		}
