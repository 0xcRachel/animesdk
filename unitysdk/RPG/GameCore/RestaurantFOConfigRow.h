...
#define RPG_GAMECORE_RESTAURANTFOCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16DEC1B0)
#define RPG_GAMECORE_RESTAURANTFOCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16DEC320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RestaurantFOConfigRow_TypeDefinitionIndex = 10546;
