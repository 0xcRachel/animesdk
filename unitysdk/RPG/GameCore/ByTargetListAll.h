...
#define RPG_GAMECORE_BYTARGETLISTALL_METHOD_4_0DF9EE681003664F_OFFSET UNITYSDK_OFFSET(0x1693F940)
#define RPG_GAMECORE_BYTARGETLISTALL_METHOD_4_257B07483E2414CB_OFFSET UNITYSDK_OFFSET(0x1693F870)
#define RPG_GAMECORE_BYTARGETLISTALL__CTOR_OFFSET UNITYSDK_OFFSET(0x1693F8F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByTargetListAll_TypeDefinitionIndex = 21512;
