...
#define RPG_GAMECORE_USESKILL_METHOD_3_4474EFFF13F2A180_OFFSET UNITYSDK_OFFSET(0x195145B0)
#define RPG_GAMECORE_USESKILL_METHOD_3_D5E6F956B67D054F_OFFSET UNITYSDK_OFFSET(0x19514530)
#define RPG_GAMECORE_USESKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x19514580)
