...
#define RPG_GAMECORE_LEVELCROWDMEMBERINFO_METHOD_2_C9D494A27B67B1C3_OFFSET UNITYSDK_OFFSET(0x16BA1B30)
#define RPG_GAMECORE_LEVELCROWDMEMBERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16BA1FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelCrowdMemberInfo_TypeDefinitionIndex = 15593;
