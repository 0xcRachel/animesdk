...
#define RPG_GAMECORE_WAITPROPCURVEMOVEPAUSED_METHOD_3_444F9FF57BAFF811_OFFSET UNITYSDK_OFFSET(0x19532700)
#define RPG_GAMECORE_WAITPROPCURVEMOVEPAUSED_METHOD_3_E8A947B543BDC4EA_OFFSET UNITYSDK_OFFSET(0x195327D0)
#define RPG_GAMECORE_WAITPROPCURVEMOVEPAUSED__CTOR_OFFSET UNITYSDK_OFFSET(0x19532780)
