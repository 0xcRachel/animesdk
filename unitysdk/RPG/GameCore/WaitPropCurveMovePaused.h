...
#define RPG_GAMECORE_WAITPROPCURVEMOVEPAUSED_METHOD_3_444F9FF57BAFF811_OFFSET UNITYSDK_OFFSET(0x17915640)
#define RPG_GAMECORE_WAITPROPCURVEMOVEPAUSED_METHOD_3_E8A947B543BDC4EA_OFFSET UNITYSDK_OFFSET(0x17915710)
#define RPG_GAMECORE_WAITPROPCURVEMOVEPAUSED__CTOR_OFFSET UNITYSDK_OFFSET(0x179156C0)
