...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_9EB2CB86795DEEF1_DelegateParseJson_1<::RPG::GameCore::AvatarBaseType>**)Il2CppClass::FromTypeDefinitionIndex(ByAvatarBaseType___O_TypeDefinitionIndex)->GetStaticField(0x6F70);
		}
	};
}
