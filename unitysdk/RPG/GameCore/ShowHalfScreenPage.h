...
#define RPG_GAMECORE_SHOWHALFSCREENPAGE_METHOD_3_9D873A6C7F077391_OFFSET UNITYSDK_OFFSET(0x16F5D880)
#define RPG_GAMECORE_SHOWHALFSCREENPAGE_METHOD_3_D429D2104786A550_OFFSET UNITYSDK_OFFSET(0x16F5D800)
#define RPG_GAMECORE_SHOWHALFSCREENPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F5D850)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowHalfScreenPage_TypeDefinitionIndex = 18247;
