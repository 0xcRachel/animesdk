...
#define RPG_GAMECORE_TRACKNPCCONST_METHOD_2_405BD143B5D62E47_OFFSET UNITYSDK_OFFSET(0x170FC9E0)
#define RPG_GAMECORE_TRACKNPCCONST__CTOR_OFFSET UNITYSDK_OFFSET(0x170FCAB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrackNpcConst_TypeDefinitionIndex = 14646;
