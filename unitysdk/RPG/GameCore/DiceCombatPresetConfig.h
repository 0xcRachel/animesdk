...
#define RPG_GAMECORE_DICECOMBATPRESETCONFIG_METHOD_2_9FCA4AE9874C77AF_OFFSET UNITYSDK_OFFSET(0x1959A0D0)
#define RPG_GAMECORE_DICECOMBATPRESETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1959A1D0)
