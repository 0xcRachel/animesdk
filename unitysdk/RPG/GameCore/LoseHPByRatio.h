...
#define RPG_GAMECORE_LOSEHPBYRATIO_METHOD_3_4CA05222F25EE503_OFFSET UNITYSDK_OFFSET(0x16C214C0)
#define RPG_GAMECORE_LOSEHPBYRATIO_METHOD_3_FDF7C82583C3A810_OFFSET UNITYSDK_OFFSET(0x16C21380)
#define RPG_GAMECORE_LOSEHPBYRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x16C21430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoseHPByRatio_TypeDefinitionIndex = 20337;
