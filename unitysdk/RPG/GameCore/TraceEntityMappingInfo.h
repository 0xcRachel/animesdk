...
#define RPG_GAMECORE_TRACEENTITYMAPPINGINFO_METHOD_3_680A24B0C7982357_OFFSET UNITYSDK_OFFSET(0x1948C070)
#define RPG_GAMECORE_TRACEENTITYMAPPINGINFO_METHOD_3_E96D1775893488C6_OFFSET UNITYSDK_OFFSET(0x1948C0F0)
#define RPG_GAMECORE_TRACEENTITYMAPPINGINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1948C0C0)
