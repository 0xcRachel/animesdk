...
#define RPG_GAMECORE_TRACEENTITYMAPPINGINFO_METHOD_3_680A24B0C7982357_OFFSET UNITYSDK_OFFSET(0x170FB0B0)
#define RPG_GAMECORE_TRACEENTITYMAPPINGINFO_METHOD_3_E96D1775893488C6_OFFSET UNITYSDK_OFFSET(0x170FB130)
#define RPG_GAMECORE_TRACEENTITYMAPPINGINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x170FB100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TraceEntityMappingInfo_TypeDefinitionIndex = 18482;
