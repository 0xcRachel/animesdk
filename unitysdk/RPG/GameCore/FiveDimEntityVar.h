...
#define RPG_GAMECORE_FIVEDIMENTITYVAR_METHOD_2_128774387667156B_OFFSET UNITYSDK_OFFSET(0x199EBA00)
#define RPG_GAMECORE_FIVEDIMENTITYVAR_METHOD_2_35BAD89675FB426E_OFFSET UNITYSDK_OFFSET(0x199EC3B0)
#define RPG_GAMECORE_FIVEDIMENTITYVAR__CTOR_OFFSET UNITYSDK_OFFSET(0x199EC6C0)
