...
#define RPG_GAMECORE_CAKERACECATIDLISTSELECTORCONFIG_METHOD_3_8BEF3CA76438DBCE_OFFSET UNITYSDK_OFFSET(0x1694A820)
#define RPG_GAMECORE_CAKERACECATIDLISTSELECTORCONFIG_METHOD_3_DBBB3D635C7AFBFD_OFFSET UNITYSDK_OFFSET(0x1694BF90)
#define RPG_GAMECORE_CAKERACECATIDLISTSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1694A810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceCatIdListSelectorConfig_TypeDefinitionIndex = 16520;
