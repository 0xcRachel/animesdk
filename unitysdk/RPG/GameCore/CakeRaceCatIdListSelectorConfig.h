...
#define RPG_GAMECORE_CAKERACECATIDLISTSELECTORCONFIG_METHOD_3_8BEF3CA76438DBCE_OFFSET UNITYSDK_OFFSET(0x1705C7A0)
#define RPG_GAMECORE_CAKERACECATIDLISTSELECTORCONFIG_METHOD_3_DBBB3D635C7AFBFD_OFFSET UNITYSDK_OFFSET(0x1705DFF0)
#define RPG_GAMECORE_CAKERACECATIDLISTSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1705C790)
