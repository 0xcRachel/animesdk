...
#define RPG_GAMECORE_CAKERACECATIDLISTSELECTORCONFIG_METHOD_3_356A2F8BA195DE18_OFFSET UNITYSDK_OFFSET(0x19E7E3B0)
#define RPG_GAMECORE_CAKERACECATIDLISTSELECTORCONFIG_METHOD_3_D16C95BCD7EA4BCB_OFFSET UNITYSDK_OFFSET(0x19E7C9C0)
#define RPG_GAMECORE_CAKERACECATIDLISTSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19E7C9B0)
