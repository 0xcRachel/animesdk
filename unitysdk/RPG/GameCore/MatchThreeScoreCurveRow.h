...
#define RPG_GAMECORE_MATCHTHREESCORECURVEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16C64950)
#define RPG_GAMECORE_MATCHTHREESCORECURVEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16C65110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MatchThreeScoreCurveRow_TypeDefinitionIndex = 10884;

	class MatchThreeScoreCurveRow : public ::System::Object
	{
	public:
		::System::UInt32 PlayerStep; // 0x10
		::System::UInt32 CurveID; // 0x14
		::System::UInt32 AddHigh; // 0x18
		::System::UInt32 HPDecrease; // 0x1C
		::System::UInt32 DelayTime; // 0x20
