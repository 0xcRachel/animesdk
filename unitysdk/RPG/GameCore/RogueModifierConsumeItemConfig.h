...
#define RPG_GAMECORE_ROGUEMODIFIERCONSUMEITEMCONFIG_METHOD_3_8DF8911DF129C881_OFFSET UNITYSDK_OFFSET(0x16E9DCD0)
#define RPG_GAMECORE_ROGUEMODIFIERCONSUMEITEMCONFIG_METHOD_3_D70198B6885A7B28_OFFSET UNITYSDK_OFFSET(0x16E9DC00)
#define RPG_GAMECORE_ROGUEMODIFIERCONSUMEITEMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E9DC80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierConsumeItemConfig_TypeDefinitionIndex = 16156;
