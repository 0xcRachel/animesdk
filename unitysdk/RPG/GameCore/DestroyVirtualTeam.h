...
#define RPG_GAMECORE_DESTROYVIRTUALTEAM_METHOD_3_4967865323846857_OFFSET UNITYSDK_OFFSET(0x19585E50)
#define RPG_GAMECORE_DESTROYVIRTUALTEAM_METHOD_3_D68BEA3301726547_OFFSET UNITYSDK_OFFSET(0x19585EE0)
#define RPG_GAMECORE_DESTROYVIRTUALTEAM__CTOR_OFFSET UNITYSDK_OFFSET(0x19585EB0)
