...
#define RPG_GAMECORE_DESTROYVIRTUALTEAM_METHOD_3_4967865323846857_OFFSET UNITYSDK_OFFSET(0x171696A0)
#define RPG_GAMECORE_DESTROYVIRTUALTEAM_METHOD_3_D68BEA3301726547_OFFSET UNITYSDK_OFFSET(0x17169730)
#define RPG_GAMECORE_DESTROYVIRTUALTEAM__CTOR_OFFSET UNITYSDK_OFFSET(0x17169700)
