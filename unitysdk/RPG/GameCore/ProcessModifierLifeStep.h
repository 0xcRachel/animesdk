...
#define RPG_GAMECORE_PROCESSMODIFIERLIFESTEP_METHOD_3_CE0C45CEF9D53DCE_OFFSET UNITYSDK_OFFSET(0x1A2D3E70)
#define RPG_GAMECORE_PROCESSMODIFIERLIFESTEP_METHOD_3_E9CF12DB9E7C261F_OFFSET UNITYSDK_OFFSET(0x1A2D3DF0)
#define RPG_GAMECORE_PROCESSMODIFIERLIFESTEP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2D3E40)
