...
#define RPG_GAMECORE_PHOTOGRAPHSHOTRESULTCONDITION_METHOD_2_D87A4E44315D1918_OFFSET UNITYSDK_OFFSET(0x174C11A0)
#define RPG_GAMECORE_PHOTOGRAPHSHOTRESULTCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x174C13F0)
