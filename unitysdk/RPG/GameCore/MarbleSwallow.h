...
#define RPG_GAMECORE_MARBLESWALLOW_METHOD_3_1BF91A4F778FF7F9_OFFSET UNITYSDK_OFFSET(0x18C20A80)
#define RPG_GAMECORE_MARBLESWALLOW_METHOD_3_937066DA8C4C9CE2_OFFSET UNITYSDK_OFFSET(0x18C20B60)
#define RPG_GAMECORE_MARBLESWALLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x18C20B10)
