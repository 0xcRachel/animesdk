...
#define RPG_GAMECORE_CYCLEQUESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x169DB5C0)
#define RPG_GAMECORE_CYCLEQUESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x169DC350)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CycleQuestRow_TypeDefinitionIndex = 13226;
	...
	public:
		...
		::System::UInt32 Cycledays; // 0x20
		::System::UInt32 CycleID; // 0x24
		::System::UInt32 MinLevel; // 0x28
