...
#define RPG_GAMECORE_BYCOMPAREHP_METHOD_4_315FEC21E4E22B4C_OFFSET UNITYSDK_OFFSET(0x1690E490)
#define RPG_GAMECORE_BYCOMPAREHP_METHOD_4_FFA654C1BDA11D82_OFFSET UNITYSDK_OFFSET(0x1690E3C0)
#define RPG_GAMECORE_BYCOMPAREHP__CTOR_OFFSET UNITYSDK_OFFSET(0x1690E440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareHP_TypeDefinitionIndex = 20650;
