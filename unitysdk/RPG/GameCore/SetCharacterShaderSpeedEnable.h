...
#define RPG_GAMECORE_SETCHARACTERSHADERSPEEDENABLE_METHOD_3_D5A02BBF1E8728DC_OFFSET UNITYSDK_OFFSET(0x176C2DC0)
#define RPG_GAMECORE_SETCHARACTERSHADERSPEEDENABLE_METHOD_3_E6D49E67FDC8DD6A_OFFSET UNITYSDK_OFFSET(0x176C2D40)
#define RPG_GAMECORE_SETCHARACTERSHADERSPEEDENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x176C2D90)
