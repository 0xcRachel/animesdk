...
#define RPG_GAMECORE_CLOCKPARKCHAPTERCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x169A9FC0)
#define RPG_GAMECORE_CLOCKPARKCHAPTERCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x169AA870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClockParkChapterConfigRow_TypeDefinitionIndex = 10374;
	...
	public:
		...
		::RPG::GameCore::ClockParkChapterType ChapterType; // 0x38
		::System::UInt32 RewardProgress; // 0x3C
		::RPG::Client::TextID ChapterTitle; // 0x40
		::System::UInt32 ChapterAutoUnlock; // 0x50
