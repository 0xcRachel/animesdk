...
#define RPG_GAMECORE_ADDTIMEREWINDBTNCD_METHOD_3_3A85B19702FD669D_OFFSET UNITYSDK_OFFSET(0x167BFB60)
#define RPG_GAMECORE_ADDTIMEREWINDBTNCD_METHOD_3_6C3C078BC674FBBB_OFFSET UNITYSDK_OFFSET(0x167BFAE0)
#define RPG_GAMECORE_ADDTIMEREWINDBTNCD__CTOR_OFFSET UNITYSDK_OFFSET(0x167BFB30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddTimeRewindBtnCD_TypeDefinitionIndex = 18480;
