...
#define RPG_GAMECORE_ADDTIMEREWINDBTNCD_METHOD_3_3A85B19702FD669D_OFFSET UNITYSDK_OFFSET(0x18DB7DD0)
#define RPG_GAMECORE_ADDTIMEREWINDBTNCD_METHOD_3_6C3C078BC674FBBB_OFFSET UNITYSDK_OFFSET(0x18DB7D50)
#define RPG_GAMECORE_ADDTIMEREWINDBTNCD__CTOR_OFFSET UNITYSDK_OFFSET(0x18DB7DA0)
