...
#define RPG_GAMECORE_MAZEPUZZLEORIGAMICOLONYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1908E6C0)
#define RPG_GAMECORE_MAZEPUZZLEORIGAMICOLONYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1908E8E0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 MirrorFloorID; // 0x20
