...
#define RPG_GAMECORE_GRIDFIGHTRANKSKILLMODIFYCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B42E60)
#define RPG_GAMECORE_GRIDFIGHTRANKSKILLMODIFYCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B430E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightRankSkillModifyConfigRow_TypeDefinitionIndex = 12277;
