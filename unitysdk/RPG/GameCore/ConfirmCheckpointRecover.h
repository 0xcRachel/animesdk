...
#define RPG_GAMECORE_CONFIRMCHECKPOINTRECOVER_METHOD_3_301468328E22D0DD_OFFSET UNITYSDK_OFFSET(0x169C5F80)
#define RPG_GAMECORE_CONFIRMCHECKPOINTRECOVER_METHOD_3_D469DF410E1C764C_OFFSET UNITYSDK_OFFSET(0x169C6000)
#define RPG_GAMECORE_CONFIRMCHECKPOINTRECOVER__CTOR_OFFSET UNITYSDK_OFFSET(0x169C5FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConfirmCheckpointRecover_TypeDefinitionIndex = 19235;
