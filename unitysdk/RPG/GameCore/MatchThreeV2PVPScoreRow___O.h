...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::MultiPlayerGameMode>**)Il2CppClass::FromTypeDefinitionIndex(MatchThreeV2PVPScoreRow___O_TypeDefinitionIndex)->GetStaticField(0x455A0);
		}
	};
}
