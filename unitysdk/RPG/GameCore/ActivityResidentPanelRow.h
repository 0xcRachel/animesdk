...
#define RPG_GAMECORE_ACTIVITYRESIDENTPANELROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19542280)
#define RPG_GAMECORE_ACTIVITYRESIDENTPANELROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19542710)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::FixPoint ExpectTime; // 0x50
