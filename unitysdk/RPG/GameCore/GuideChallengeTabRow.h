...
#define RPG_GAMECORE_GUIDECHALLENGETABROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18A5C690)
#define RPG_GAMECORE_GUIDECHALLENGETABROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18A5D040)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::GuideChallengeType GuideType; // 0x3C
