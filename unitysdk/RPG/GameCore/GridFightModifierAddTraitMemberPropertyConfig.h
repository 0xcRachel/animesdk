...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDTRAITMEMBERPROPERTYCONFIG_METHOD_3_4F219E302CA35450_OFFSET UNITYSDK_OFFSET(0x16B28790)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDTRAITMEMBERPROPERTYCONFIG_METHOD_3_B928AFB9648BC6F9_OFFSET UNITYSDK_OFFSET(0x16B286C0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDTRAITMEMBERPROPERTYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16B28740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddTraitMemberPropertyConfig_TypeDefinitionIndex = 17467;
