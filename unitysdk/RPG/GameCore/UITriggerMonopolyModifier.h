...
#define RPG_GAMECORE_UITRIGGERMONOPOLYMODIFIER_METHOD_3_672CED75576CFD85_OFFSET UNITYSDK_OFFSET(0x178F7750)
#define RPG_GAMECORE_UITRIGGERMONOPOLYMODIFIER_METHOD_3_CF2561C7C8AC1E31_OFFSET UNITYSDK_OFFSET(0x178F7640)
#define RPG_GAMECORE_UITRIGGERMONOPOLYMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x178F7720)
