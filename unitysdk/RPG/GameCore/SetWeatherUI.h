...
#define RPG_GAMECORE_SETWEATHERUI_METHOD_3_621AC65B8FB2852B_OFFSET UNITYSDK_OFFSET(0x19394120)
#define RPG_GAMECORE_SETWEATHERUI_METHOD_3_938A4FFA2B5465F2_OFFSET UNITYSDK_OFFSET(0x193941A0)
#define RPG_GAMECORE_SETWEATHERUI__CTOR_OFFSET UNITYSDK_OFFSET(0x19394170)
