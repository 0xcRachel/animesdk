...
#define RPG_GAMECORE_SETWEATHERUI_METHOD_3_621AC65B8FB2852B_OFFSET UNITYSDK_OFFSET(0x16F46200)
#define RPG_GAMECORE_SETWEATHERUI_METHOD_3_938A4FFA2B5465F2_OFFSET UNITYSDK_OFFSET(0x16F46280)
#define RPG_GAMECORE_SETWEATHERUI__CTOR_OFFSET UNITYSDK_OFFSET(0x16F46250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetWeatherUI_TypeDefinitionIndex = 20434;
