...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ADDMODIFIER_METHOD_3_5A01598E34DD80FF_OFFSET UNITYSDK_OFFSET(0x1959ED50)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ADDMODIFIER_METHOD_3_7A72BF8A3700476E_OFFSET UNITYSDK_OFFSET(0x195A5060)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ADDMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1959EC70)
