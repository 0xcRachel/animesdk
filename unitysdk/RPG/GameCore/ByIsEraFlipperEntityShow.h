...
#define RPG_GAMECORE_BYISERAFLIPPERENTITYSHOW_METHOD_4_0E47B3B5314C6E30_OFFSET UNITYSDK_OFFSET(0x169308D0)
#define RPG_GAMECORE_BYISERAFLIPPERENTITYSHOW_METHOD_4_E7D5633B03849D0A_OFFSET UNITYSDK_OFFSET(0x16930800)
#define RPG_GAMECORE_BYISERAFLIPPERENTITYSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x16930880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsEraFlipperEntityShow_TypeDefinitionIndex = 19990;
