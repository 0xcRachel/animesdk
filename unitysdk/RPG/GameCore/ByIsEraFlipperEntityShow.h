...
#define RPG_GAMECORE_BYISERAFLIPPERENTITYSHOW_METHOD_4_0E47B3B5314C6E30_OFFSET UNITYSDK_OFFSET(0x17041CD0)
#define RPG_GAMECORE_BYISERAFLIPPERENTITYSHOW_METHOD_4_E7D5633B03849D0A_OFFSET UNITYSDK_OFFSET(0x17041C00)
#define RPG_GAMECORE_BYISERAFLIPPERENTITYSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x17041C80)
