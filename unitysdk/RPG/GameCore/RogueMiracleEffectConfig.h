...
#define RPG_GAMECORE_ROGUEMIRACLEEFFECTCONFIG_METHOD_2_D0A74B218E6CE8D6_OFFSET UNITYSDK_OFFSET(0x16E8EC10)
#define RPG_GAMECORE_ROGUEMIRACLEEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E8EC50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMiracleEffectConfig_TypeDefinitionIndex = 16107;
