...
#define RPG_GAMECORE_ADVENTURECAMERALOOKATTEMPLATE_METHOD_3_0BEB03EF22EEC647_OFFSET UNITYSDK_OFFSET(0x16857420)
#define RPG_GAMECORE_ADVENTURECAMERALOOKATTEMPLATE_METHOD_3_36C9E2B85247B0DC_OFFSET UNITYSDK_OFFSET(0x168573A0)
#define RPG_GAMECORE_ADVENTURECAMERALOOKATTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x168573F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureCameraLookAtTemplate_TypeDefinitionIndex = 19786;
