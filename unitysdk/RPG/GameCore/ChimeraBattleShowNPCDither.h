...
#define RPG_GAMECORE_CHIMERABATTLESHOWNPCDITHER_METHOD_3_5F0096CD591C1E03_OFFSET UNITYSDK_OFFSET(0x170A8BC0)
#define RPG_GAMECORE_CHIMERABATTLESHOWNPCDITHER_METHOD_3_710E99850A513409_OFFSET UNITYSDK_OFFSET(0x170A7A20)
#define RPG_GAMECORE_CHIMERABATTLESHOWNPCDITHER__CTOR_OFFSET UNITYSDK_OFFSET(0x170A7A10)
