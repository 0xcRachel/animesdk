...
#define RPG_GAMECORE_STAGEINFINITEGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16F87250)
#define RPG_GAMECORE_STAGEINFINITEGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16F87370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StageInfiniteGroupRow_TypeDefinitionIndex = 13781;
