...
#define RPG_GAMECORE_SETCURRENTTURNACTIONENTITY_METHOD_3_0B6BDA2DC7B96C6D_OFFSET UNITYSDK_OFFSET(0x192F64F0)
#define RPG_GAMECORE_SETCURRENTTURNACTIONENTITY_METHOD_3_4E2DEB0A15BCC167_OFFSET UNITYSDK_OFFSET(0x192F6420)
#define RPG_GAMECORE_SETCURRENTTURNACTIONENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x192F64A0)
