...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_METHOD_3_86BC569D0D91B2E4_OFFSET UNITYSDK_OFFSET(0x1717AB40)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_METHOD_3_CD34B14E5F611AC9_OFFSET UNITYSDK_OFFSET(0x17176070)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1717ACA0)
