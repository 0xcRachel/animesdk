...
#define RPG_GAMECORE_WAVEMONSTERPERFORM_METHOD_3_324CB5C3A101F54D_OFFSET UNITYSDK_OFFSET(0x1791D9E0)
#define RPG_GAMECORE_WAVEMONSTERPERFORM_METHOD_3_B6855378A61782EB_OFFSET UNITYSDK_OFFSET(0x1791DA60)
#define RPG_GAMECORE_WAVEMONSTERPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1791DA30)
