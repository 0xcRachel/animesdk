...
#define RPG_GAMECORE_ADVENTUREMONSTERESCAPE_METHOD_3_7B2AAAD3405DB4BD_OFFSET UNITYSDK_OFFSET(0x19C0D320)
#define RPG_GAMECORE_ADVENTUREMONSTERESCAPE_METHOD_3_CCAFF0B6DDAC0262_OFFSET UNITYSDK_OFFSET(0x19C0D390)
#define RPG_GAMECORE_ADVENTUREMONSTERESCAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C0D360)
