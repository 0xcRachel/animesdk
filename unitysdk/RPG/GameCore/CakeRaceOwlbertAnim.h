...
#define RPG_GAMECORE_CAKERACEOWLBERTANIM_METHOD_2_9A548E8E2B7F1672_OFFSET UNITYSDK_OFFSET(0x16950F00)
#define RPG_GAMECORE_CAKERACEOWLBERTANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x169510F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceOwlbertAnim_TypeDefinitionIndex = 16494;
