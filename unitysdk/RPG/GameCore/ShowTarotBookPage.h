...
#define RPG_GAMECORE_SHOWTAROTBOOKPAGE_METHOD_3_8B56382252B76D47_OFFSET UNITYSDK_OFFSET(0x16F643F0)
#define RPG_GAMECORE_SHOWTAROTBOOKPAGE_METHOD_3_DD85DD0C99BEA7FE_OFFSET UNITYSDK_OFFSET(0x16F64470)
#define RPG_GAMECORE_SHOWTAROTBOOKPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F64440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowTarotBookPage_TypeDefinitionIndex = 20009;
