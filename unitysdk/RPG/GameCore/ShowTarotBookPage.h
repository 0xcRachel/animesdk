...
#define RPG_GAMECORE_SHOWTAROTBOOKPAGE_METHOD_3_8B56382252B76D47_OFFSET UNITYSDK_OFFSET(0x1A00BCE0)
#define RPG_GAMECORE_SHOWTAROTBOOKPAGE_METHOD_3_DD85DD0C99BEA7FE_OFFSET UNITYSDK_OFFSET(0x1A00BD60)
#define RPG_GAMECORE_SHOWTAROTBOOKPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A00BD30)
