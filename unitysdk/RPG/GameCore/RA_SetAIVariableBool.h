...
#define RPG_GAMECORE_RA_SETAIVARIABLEBOOL_METHOD_4_6D23C85EE214B863_OFFSET UNITYSDK_OFFSET(0x19AA2D60)
#define RPG_GAMECORE_RA_SETAIVARIABLEBOOL_METHOD_4_95A8CC5FD29C0417_OFFSET UNITYSDK_OFFSET(0x19AA2CE0)
#define RPG_GAMECORE_RA_SETAIVARIABLEBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x19AA2D30)
