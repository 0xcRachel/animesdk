...
#define RPG_GAMECORE_TRANSITENVPROFILEFORSTORY_METHOD_4_2A4B6EABA30841EC_OFFSET UNITYSDK_OFFSET(0x1949D570)
#define RPG_GAMECORE_TRANSITENVPROFILEFORSTORY_METHOD_4_59A2E11592810C1D_OFFSET UNITYSDK_OFFSET(0x1949D3E0)
#define RPG_GAMECORE_TRANSITENVPROFILEFORSTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x1949D3B0)
