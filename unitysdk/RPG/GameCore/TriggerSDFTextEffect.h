...
#define RPG_GAMECORE_TRIGGERSDFTEXTEFFECT_METHOD_4_9421631F6D1AAFE9_OFFSET UNITYSDK_OFFSET(0x1711CE10)
#define RPG_GAMECORE_TRIGGERSDFTEXTEFFECT_METHOD_4_AC06E073EA27CF75_OFFSET UNITYSDK_OFFSET(0x171265D0)
#define RPG_GAMECORE_TRIGGERSDFTEXTEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1711CDA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerSDFTextEffect_TypeDefinitionIndex = 21320;
