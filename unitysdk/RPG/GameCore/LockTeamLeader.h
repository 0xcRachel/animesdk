...
#define RPG_GAMECORE_LOCKTEAMLEADER_METHOD_3_0BCBE7970C1E9D18_OFFSET UNITYSDK_OFFSET(0x18FCAC30)
#define RPG_GAMECORE_LOCKTEAMLEADER_METHOD_3_11C9DEFD8B582618_OFFSET UNITYSDK_OFFSET(0x18FCACC0)
#define RPG_GAMECORE_LOCKTEAMLEADER__CTOR_OFFSET UNITYSDK_OFFSET(0x18FCAC90)
