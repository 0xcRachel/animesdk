...
#define RPG_GAMECORE_LINEUPCHARACTER_DEEPCOPY_OFFSET UNITYSDK_OFFSET(0xA4B5A60)
#define RPG_GAMECORE_LINEUPCHARACTER_GETAVATARROWWRAPPEREXTRAPARAM_OFFSET UNITYSDK_OFFSET(0xA4B5F10)
#define RPG_GAMECORE_LINEUPCHARACTER_GET_AVATARDERIVETYPE_OFFSET UNITYSDK_OFFSET(0xA4B5EC0)
#define RPG_GAMECORE_LINEUPCHARACTER_GET_CHARACTERSPRATIO_OFFSET UNITYSDK_OFFSET(0xA4B5E70)
#define RPG_GAMECORE_LINEUPCHARACTER_RESET_OFFSET UNITYSDK_OFFSET(0xA4B5A10)
#define RPG_GAMECORE_LINEUPCHARACTER_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA4B5FE0)
#define RPG_GAMECORE_LINEUPCHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0xA4B59A0)
#define RPG_GAMECORE_LINEUPCHARACTER___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA4B6300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LineUpCharacter_TypeDefinitionIndex = 44103;
	...
	public:
		...
		::Class_1_5045AA363287E230* BattleRelicItemModule; // 0x30
		...
		::Enum_3_0A3761FE34514D6C_13 SpiritLineupType; // 0x60
		::System::UInt32 CharacterRowIndex; // 0x64
		::Enum_3_A35B38E5F9115A76 CharacterAvatarType; // 0x68
		::System::UInt32 CharacterID; // 0x6C
		::System::UInt32 EnhancedID; // 0x70
		::System::UInt32 CharacterRank; // 0x74
		::System::UInt32 Index; // 0x78
		::System::UInt32 CharacterLevel; // 0x7C
		::System::UInt32 TotalPower; // 0x80
		::System::UInt32 CharacterPromotion; // 0x84
		::System::UInt32 AssistUid; // 0x88
