...
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKISSELF_METHOD_4_32FD39228BBA3C3B_OFFSET UNITYSDK_OFFSET(0x195FB660)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKISSELF_METHOD_4_51ECDF36565BDCEF_OFFSET UNITYSDK_OFFSET(0x195FB5E0)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKISSELF_METHOD_4_64219F948BEBB8D4_OFFSET UNITYSDK_OFFSET(0x195FB4A0)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKISSELF_METHOD_4_BAC24EEB85E007BE_OFFSET UNITYSDK_OFFSET(0x195FB3D0)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKISSELF__CTOR_OFFSET UNITYSDK_OFFSET(0x195FB450)
