...
#define RPG_GAMECORE_BYHASSTANCEWEAK_METHOD_4_943EB40A231B8865_OFFSET UNITYSDK_OFFSET(0x19AE0590)
#define RPG_GAMECORE_BYHASSTANCEWEAK_METHOD_4_D6ECF76B9FF4C967_OFFSET UNITYSDK_OFFSET(0x19AE0470)
#define RPG_GAMECORE_BYHASSTANCEWEAK__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE0510)
