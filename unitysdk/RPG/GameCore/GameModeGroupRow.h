...
#define RPG_GAMECORE_GAMEMODEGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B094C0)
#define RPG_GAMECORE_GAMEMODEGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B09650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GameModeGroupRow_TypeDefinitionIndex = 11699;
