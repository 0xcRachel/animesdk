...
#define RPG_GAMECORE_BYISINERAFLIPPERSPOTAREA_METHOD_4_B170A4B700C233DB_OFFSET UNITYSDK_OFFSET(0x16932DA0)
#define RPG_GAMECORE_BYISINERAFLIPPERSPOTAREA_METHOD_4_B79555B827DA387D_OFFSET UNITYSDK_OFFSET(0x16932E70)
#define RPG_GAMECORE_BYISINERAFLIPPERSPOTAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x16932E20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsInEraFlipperSpotArea_TypeDefinitionIndex = 19989;
