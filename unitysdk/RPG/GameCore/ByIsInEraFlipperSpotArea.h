...
#define RPG_GAMECORE_BYISINERAFLIPPERSPOTAREA_METHOD_4_09B1D821A9DAD3F3_OFFSET UNITYSDK_OFFSET(0x19DAA1E0)
#define RPG_GAMECORE_BYISINERAFLIPPERSPOTAREA_METHOD_4_2C1B34C7D6FFB3D2_OFFSET UNITYSDK_OFFSET(0x19DAA160)
#define RPG_GAMECORE_BYISINERAFLIPPERSPOTAREA_METHOD_4_B170A4B700C233DB_OFFSET UNITYSDK_OFFSET(0x19DA9F10)
#define RPG_GAMECORE_BYISINERAFLIPPERSPOTAREA_METHOD_4_B79555B827DA387D_OFFSET UNITYSDK_OFFSET(0x19DA9FE0)
#define RPG_GAMECORE_BYISINERAFLIPPERSPOTAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x19DA9F90)
