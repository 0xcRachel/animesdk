...
#define RPG_GAMECORE_ELFTRIGGERSHOWUI_METHOD_3_957CF080C32C8412_OFFSET UNITYSDK_OFFSET(0x19153140)
#define RPG_GAMECORE_ELFTRIGGERSHOWUI_METHOD_3_9871D9225D0BE6A3_OFFSET UNITYSDK_OFFSET(0x191531C0)
#define RPG_GAMECORE_ELFTRIGGERSHOWUI__CTOR_OFFSET UNITYSDK_OFFSET(0x19153190)
