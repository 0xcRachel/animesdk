...
#define RPG_GAMECORE_ELFTRIGGERSHOWUI_METHOD_3_957CF080C32C8412_OFFSET UNITYSDK_OFFSET(0x16A642E0)
#define RPG_GAMECORE_ELFTRIGGERSHOWUI_METHOD_3_9871D9225D0BE6A3_OFFSET UNITYSDK_OFFSET(0x16A64360)
#define RPG_GAMECORE_ELFTRIGGERSHOWUI__CTOR_OFFSET UNITYSDK_OFFSET(0x16A64330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfTriggerShowUI_TypeDefinitionIndex = 19379;
