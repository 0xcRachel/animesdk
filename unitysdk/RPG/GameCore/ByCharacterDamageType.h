...
#define RPG_GAMECORE_BYCHARACTERDAMAGETYPE_METHOD_4_1F53F44815CFC985_OFFSET UNITYSDK_OFFSET(0x168FF770)
#define RPG_GAMECORE_BYCHARACTERDAMAGETYPE_METHOD_4_DD0601D876C2DDD9_OFFSET UNITYSDK_OFFSET(0x168FF6A0)
#define RPG_GAMECORE_BYCHARACTERDAMAGETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x168FF720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCharacterDamageType_TypeDefinitionIndex = 18016;
