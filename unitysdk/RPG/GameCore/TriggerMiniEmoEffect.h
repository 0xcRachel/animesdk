...
#define RPG_GAMECORE_TRIGGERMINIEMOEFFECT_METHOD_3_85EC573208EA891E_OFFSET UNITYSDK_OFFSET(0x17122420)
#define RPG_GAMECORE_TRIGGERMINIEMOEFFECT_METHOD_3_AD776BA9EB4B1D2A_OFFSET UNITYSDK_OFFSET(0x171224F0)
#define RPG_GAMECORE_TRIGGERMINIEMOEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x171224A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerMiniEmoEffect_TypeDefinitionIndex = 19504;
