...
#define RPG_GAMECORE_SETPROPINTERACTTRIGGERSTATE_METHOD_3_90E0905E510AA7DB_OFFSET UNITYSDK_OFFSET(0x1A799440)
#define RPG_GAMECORE_SETPROPINTERACTTRIGGERSTATE_METHOD_3_D715CA6CAF98FB04_OFFSET UNITYSDK_OFFSET(0x1A7994C0)
#define RPG_GAMECORE_SETPROPINTERACTTRIGGERSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A799490)
