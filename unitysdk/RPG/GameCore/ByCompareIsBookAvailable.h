...
#define RPG_GAMECORE_BYCOMPAREISBOOKAVAILABLE_METHOD_4_1060F59C14E6C929_OFFSET UNITYSDK_OFFSET(0x18FD8990)
#define RPG_GAMECORE_BYCOMPAREISBOOKAVAILABLE_METHOD_4_8A4977F50563D68D_OFFSET UNITYSDK_OFFSET(0x18FD8A10)
#define RPG_GAMECORE_BYCOMPAREISBOOKAVAILABLE_METHOD_4_A93E3B04E85C3E99_OFFSET UNITYSDK_OFFSET(0x18FD87E0)
#define RPG_GAMECORE_BYCOMPAREISBOOKAVAILABLE_METHOD_4_D6AFE0802CB586FF_OFFSET UNITYSDK_OFFSET(0x18FD8710)
#define RPG_GAMECORE_BYCOMPAREISBOOKAVAILABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18FD8790)
