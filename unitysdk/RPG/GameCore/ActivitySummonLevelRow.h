...
#define RPG_GAMECORE_ACTIVITYSUMMONLEVELROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x167B4180)
#define RPG_GAMECORE_ACTIVITYSUMMONLEVELROW__CTOR_OFFSET UNITYSDK_OFFSET(0x167B4520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivitySummonLevelRow_TypeDefinitionIndex = 11266;
