...
#define RPG_GAMECORE_PRELOADMAP_METHOD_3_1D2970ED930FF42F_OFFSET UNITYSDK_OFFSET(0x1A2D17E0)
#define RPG_GAMECORE_PRELOADMAP_METHOD_3_8B4762048E06EEA6_OFFSET UNITYSDK_OFFSET(0x1A2D1860)
#define RPG_GAMECORE_PRELOADMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2D1830)
