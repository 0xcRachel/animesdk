...
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMROOMCARDCASTRESETCONFIG_METHOD_7_08C0FE952500FC52_OFFSET UNITYSDK_OFFSET(0x1A032560)
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMROOMCARDCASTRESETCONFIG_METHOD_7_D3C4DBF2A577C8B7_OFFSET UNITYSDK_OFFSET(0x1A032040)
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMROOMCARDCASTRESETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A031F60)
