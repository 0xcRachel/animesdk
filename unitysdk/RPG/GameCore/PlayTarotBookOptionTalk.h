...
#define RPG_GAMECORE_PLAYTAROTBOOKOPTIONTALK_METHOD_3_1ADF9FFEB2397BFA_OFFSET UNITYSDK_OFFSET(0x16D53A80)
#define RPG_GAMECORE_PLAYTAROTBOOKOPTIONTALK_METHOD_3_9DAA71DD179A0583_OFFSET UNITYSDK_OFFSET(0x16D53A00)
#define RPG_GAMECORE_PLAYTAROTBOOKOPTIONTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x16D53A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayTarotBookOptionTalk_TypeDefinitionIndex = 18922;
