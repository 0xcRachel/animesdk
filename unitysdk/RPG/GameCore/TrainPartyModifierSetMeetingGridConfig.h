...
#define RPG_GAMECORE_TRAINPARTYMODIFIERSETMEETINGGRIDCONFIG_METHOD_3_4705E89DEA220CB3_OFFSET UNITYSDK_OFFSET(0x178C16E0)
#define RPG_GAMECORE_TRAINPARTYMODIFIERSETMEETINGGRIDCONFIG_METHOD_3_FD67C3582A28A5EF_OFFSET UNITYSDK_OFFSET(0x178C1A40)
#define RPG_GAMECORE_TRAINPARTYMODIFIERSETMEETINGGRIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x178C16D0)
