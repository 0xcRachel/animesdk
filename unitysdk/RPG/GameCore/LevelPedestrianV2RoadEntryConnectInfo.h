...
#define RPG_GAMECORE_LEVELPEDESTRIANV2ROADENTRYCONNECTINFO_METHOD_2_F65715759ED90F2B_OFFSET UNITYSDK_OFFSET(0x16BB9B70)
#define RPG_GAMECORE_LEVELPEDESTRIANV2ROADENTRYCONNECTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16BB9C30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPedestrianV2RoadEntryConnectInfo_TypeDefinitionIndex = 15608;
