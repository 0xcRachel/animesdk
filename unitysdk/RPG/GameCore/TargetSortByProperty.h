...
#define RPG_GAMECORE_TARGETSORTBYPROPERTY_METHOD_3_1EC32C2A5300E557_OFFSET UNITYSDK_OFFSET(0x16FF1860)
#define RPG_GAMECORE_TARGETSORTBYPROPERTY_METHOD_3_950FF984DE5B23B3_OFFSET UNITYSDK_OFFSET(0x16FF2B20)
#define RPG_GAMECORE_TARGETSORTBYPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x16FF1840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSortByProperty_TypeDefinitionIndex = 21695;
