...
#define RPG_GAMECORE_SWITCHMASCOTRESETSECTION_METHOD_3_21AC624F591F3BC9_OFFSET UNITYSDK_OFFSET(0x16FB70D0)
#define RPG_GAMECORE_SWITCHMASCOTRESETSECTION_METHOD_3_EAA8342E83D699AA_OFFSET UNITYSDK_OFFSET(0x16FB7150)
#define RPG_GAMECORE_SWITCHMASCOTRESETSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16FB7120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchMascotResetSection_TypeDefinitionIndex = 19649;
