...
#define RPG_GAMECORE_ACTIVITYSUMMONREWARDTABROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16F2AF80)
#define RPG_GAMECORE_ACTIVITYSUMMONREWARDTABROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16F2B1D0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID OriginalQuestName; // 0x18
