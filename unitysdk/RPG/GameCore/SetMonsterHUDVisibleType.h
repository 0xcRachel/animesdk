...
#define RPG_GAMECORE_SETMONSTERHUDVISIBLETYPE_METHOD_3_BDDEA7FAD7E9D30C_OFFSET UNITYSDK_OFFSET(0x176EBF30)
#define RPG_GAMECORE_SETMONSTERHUDVISIBLETYPE_METHOD_3_DE5EB9C9342219C7_OFFSET UNITYSDK_OFFSET(0x176EBFB0)
#define RPG_GAMECORE_SETMONSTERHUDVISIBLETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x176EBF80)
