...
#define RPG_GAMECORE_CREATEPLAYERCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x169D5570)
#define RPG_GAMECORE_CREATEPLAYERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x169D56B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreatePlayerConfig_TypeDefinitionIndex = 21889;
