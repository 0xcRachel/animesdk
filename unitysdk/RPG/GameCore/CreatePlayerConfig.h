...
#define RPG_GAMECORE_CREATEPLAYERCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18FAF950)
#define RPG_GAMECORE_CREATEPLAYERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18FAFA90)
