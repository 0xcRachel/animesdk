...
#define RPG_GAMECORE_CREATEPLAYERCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17151580)
#define RPG_GAMECORE_CREATEPLAYERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171516C0)
