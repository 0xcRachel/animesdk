...
#define RPG_GAMECORE_ROGUESHOWSELECTMAINPAGE_METHOD_3_01A6659C1084AC3A_OFFSET UNITYSDK_OFFSET(0x16EBA060)
#define RPG_GAMECORE_ROGUESHOWSELECTMAINPAGE_METHOD_3_76B99CE4FCD96B0E_OFFSET UNITYSDK_OFFSET(0x16EB9F50)
#define RPG_GAMECORE_ROGUESHOWSELECTMAINPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16EBA030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueShowSelectMainPage_TypeDefinitionIndex = 18607;
