...
#define RPG_GAMECORE_ROGUESHOWSELECTMAINPAGE_METHOD_3_01A6659C1084AC3A_OFFSET UNITYSDK_OFFSET(0x1766EEE0)
#define RPG_GAMECORE_ROGUESHOWSELECTMAINPAGE_METHOD_3_76B99CE4FCD96B0E_OFFSET UNITYSDK_OFFSET(0x1766EDD0)
#define RPG_GAMECORE_ROGUESHOWSELECTMAINPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1766EEB0)
