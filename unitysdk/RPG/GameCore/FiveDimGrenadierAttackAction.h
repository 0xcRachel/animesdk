...
#define RPG_GAMECORE_FIVEDIMGRENADIERATTACKACTION_METHOD_3_3CFF1935919D4915_OFFSET UNITYSDK_OFFSET(0x171FC910)
#define RPG_GAMECORE_FIVEDIMGRENADIERATTACKACTION_METHOD_3_98D97814C5DCA030_OFFSET UNITYSDK_OFFSET(0x1720A0C0)
#define RPG_GAMECORE_FIVEDIMGRENADIERATTACKACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x171FC8F0)
