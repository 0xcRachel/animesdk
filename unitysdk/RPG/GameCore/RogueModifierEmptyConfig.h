...
#define RPG_GAMECORE_ROGUEMODIFIEREMPTYCONFIG_METHOD_3_003DFC71FB5199B4_OFFSET UNITYSDK_OFFSET(0x16E9DF80)
#define RPG_GAMECORE_ROGUEMODIFIEREMPTYCONFIG_METHOD_3_5BE4BF30B68717AD_OFFSET UNITYSDK_OFFSET(0x16E9E050)
#define RPG_GAMECORE_ROGUEMODIFIEREMPTYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E9E000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierEmptyConfig_TypeDefinitionIndex = 15959;
