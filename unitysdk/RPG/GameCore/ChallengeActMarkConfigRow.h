...
#define RPG_GAMECORE_CHALLENGEACTMARKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16957F10)
#define RPG_GAMECORE_CHALLENGEACTMARKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16958040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChallengeActMarkConfigRow_TypeDefinitionIndex = 11740;
