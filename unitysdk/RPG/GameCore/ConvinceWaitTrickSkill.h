...
#define RPG_GAMECORE_CONVINCEWAITTRICKSKILL_METHOD_3_2031568F2A557D30_OFFSET UNITYSDK_OFFSET(0x1714C990)
#define RPG_GAMECORE_CONVINCEWAITTRICKSKILL_METHOD_3_F505DAFDB4639523_OFFSET UNITYSDK_OFFSET(0x1714CA10)
#define RPG_GAMECORE_CONVINCEWAITTRICKSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1714C9E0)
