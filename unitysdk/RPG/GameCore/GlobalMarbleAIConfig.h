...
#define RPG_GAMECORE_GLOBALMARBLEAICONFIG_METHOD_2_24AAF11F1284A612_OFFSET UNITYSDK_OFFSET(0x16B109A0)
#define RPG_GAMECORE_GLOBALMARBLEAICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16B10B00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GlobalMarbleAIConfig_TypeDefinitionIndex = 15226;
