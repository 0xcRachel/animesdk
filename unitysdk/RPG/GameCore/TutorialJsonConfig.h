...
#define RPG_GAMECORE_TUTORIALJSONCONFIG_METHOD_2_3C180D895DE1BC75_OFFSET UNITYSDK_OFFSET(0x17135800)
#define RPG_GAMECORE_TUTORIALJSONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17135C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialJsonConfig_TypeDefinitionIndex = 21880;
