...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONFIRSTENTERSUPERROOMEVERYLAYERCONFIG_METHOD_3_25C62FDA153DFAEA_OFFSET UNITYSDK_OFFSET(0x19983020)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONFIRSTENTERSUPERROOMEVERYLAYERCONFIG_METHOD_3_F24EFF468066A733_OFFSET UNITYSDK_OFFSET(0x1998A5B0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONFIRSTENTERSUPERROOMEVERYLAYERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19982FD0)
