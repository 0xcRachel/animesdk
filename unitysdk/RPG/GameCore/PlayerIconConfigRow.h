...
#define RPG_GAMECORE_PLAYERICONCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16D693B0)
#define RPG_GAMECORE_PLAYERICONCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16D69A40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayerIconConfigRow_TypeDefinitionIndex = 13160;
