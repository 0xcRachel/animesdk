...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEROVERRIDETRAITEFFECTPARAMCONFIG_METHOD_3_608ECB725C1052F9_OFFSET UNITYSDK_OFFSET(0x16B33840)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEROVERRIDETRAITEFFECTPARAMCONFIG_METHOD_3_F687B9E92427E050_OFFSET UNITYSDK_OFFSET(0x16B2FA40)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEROVERRIDETRAITEFFECTPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16B2F9F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierOverrideTraitEffectParamConfig_TypeDefinitionIndex = 17455;
