...
#define RPG_GAMECORE_DEVICERELATEDFLOAT_METHOD_3_2C3526E9F541837B_OFFSET UNITYSDK_OFFSET(0x169EF820)
#define RPG_GAMECORE_DEVICERELATEDFLOAT_METHOD_3_374C89B013C1C901_OFFSET UNITYSDK_OFFSET(0x169EEEB0)
#define RPG_GAMECORE_DEVICERELATEDFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x169EEEA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DeviceRelatedFloat_TypeDefinitionIndex = 14824;
