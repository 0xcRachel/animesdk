...
#define RPG_GAMECORE_ROGUETOURNMODIFYROOMPOOLCONFIG_METHOD_2_552ED27CA50BB1E7_OFFSET UNITYSDK_OFFSET(0x16ECD280)
#define RPG_GAMECORE_ROGUETOURNMODIFYROOMPOOLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16ECD2C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournModifyRoomPoolConfig_TypeDefinitionIndex = 16182;
