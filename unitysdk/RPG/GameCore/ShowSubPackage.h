...
#define RPG_GAMECORE_SHOWSUBPACKAGE_METHOD_3_5795FDAE3D7D6A60_OFFSET UNITYSDK_OFFSET(0x193B1AF0)
#define RPG_GAMECORE_SHOWSUBPACKAGE_METHOD_3_B29674835E98906C_OFFSET UNITYSDK_OFFSET(0x193B1C00)
#define RPG_GAMECORE_SHOWSUBPACKAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x193B1BD0)
