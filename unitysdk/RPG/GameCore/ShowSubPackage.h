...
#define RPG_GAMECORE_SHOWSUBPACKAGE_METHOD_3_5795FDAE3D7D6A60_OFFSET UNITYSDK_OFFSET(0x1A00AFC0)
#define RPG_GAMECORE_SHOWSUBPACKAGE_METHOD_3_B29674835E98906C_OFFSET UNITYSDK_OFFSET(0x1A00B0D0)
#define RPG_GAMECORE_SHOWSUBPACKAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A00B0A0)
