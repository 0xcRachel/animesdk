...
#define RPG_GAMECORE_ADVNPCRESETEYETRANSFORMS_METHOD_3_1BC9914B570A3433_OFFSET UNITYSDK_OFFSET(0x16840440)
#define RPG_GAMECORE_ADVNPCRESETEYETRANSFORMS_METHOD_3_C823DCC58EB852D7_OFFSET UNITYSDK_OFFSET(0x168404C0)
#define RPG_GAMECORE_ADVNPCRESETEYETRANSFORMS__CTOR_OFFSET UNITYSDK_OFFSET(0x16840490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNpcResetEyeTransforms_TypeDefinitionIndex = 20084;
