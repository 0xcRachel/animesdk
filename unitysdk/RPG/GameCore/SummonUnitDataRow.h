...
#define RPG_GAMECORE_SUMMONUNITDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19858970)
#define RPG_GAMECORE_SUMMONUNITDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19858D80)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean IsClient; // 0x1C
		::System::Boolean IsTeamSummon; // 0x1D
		::System::Boolean DestroyOnEnterBattle; // 0x1E
		::System::Boolean RemoveMazeBuffOnDestroy; // 0x1F
