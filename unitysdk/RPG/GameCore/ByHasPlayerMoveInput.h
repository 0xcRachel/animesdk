...
#define RPG_GAMECORE_BYHASPLAYERMOVEINPUT_METHOD_4_2428D18D8B2FC900_OFFSET UNITYSDK_OFFSET(0x16927600)
#define RPG_GAMECORE_BYHASPLAYERMOVEINPUT_METHOD_4_BEC3E6BB528B93AA_OFFSET UNITYSDK_OFFSET(0x169276D0)
#define RPG_GAMECORE_BYHASPLAYERMOVEINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x16927680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHasPlayerMoveInput_TypeDefinitionIndex = 18020;
