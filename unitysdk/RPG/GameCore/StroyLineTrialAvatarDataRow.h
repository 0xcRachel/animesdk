...
#define RPG_GAMECORE_STROYLINETRIALAVATARDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16FA5E00)
#define RPG_GAMECORE_STROYLINETRIALAVATARDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16FA6020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StroyLineTrialAvatarDataRow_TypeDefinitionIndex = 13805;
