...
#define RPG_GAMECORE_CHIMERADUELDITHEROUTNODE_METHOD_3_389E618667772EE9_OFFSET UNITYSDK_OFFSET(0x1698C0D0)
#define RPG_GAMECORE_CHIMERADUELDITHEROUTNODE_METHOD_3_5176900F3A360A33_OFFSET UNITYSDK_OFFSET(0x1698C1B0)
#define RPG_GAMECORE_CHIMERADUELDITHEROUTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1698C160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelDitherOutNode_TypeDefinitionIndex = 14401;
