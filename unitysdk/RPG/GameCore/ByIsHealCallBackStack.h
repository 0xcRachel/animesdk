...
#define RPG_GAMECORE_BYISHEALCALLBACKSTACK_METHOD_4_BBB14A4284876633_OFFSET UNITYSDK_OFFSET(0x16931B80)
#define RPG_GAMECORE_BYISHEALCALLBACKSTACK_METHOD_4_CC0EFD25330A3B49_OFFSET UNITYSDK_OFFSET(0x16931AB0)
#define RPG_GAMECORE_BYISHEALCALLBACKSTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x16931B30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsHealCallBackStack_TypeDefinitionIndex = 21170;
