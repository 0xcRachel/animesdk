...
#define RPG_GAMECORE_TUTORIALSAVE_METHOD_3_8B934656C01E0507_OFFSET UNITYSDK_OFFSET(0x171374F0)
#define RPG_GAMECORE_TUTORIALSAVE_METHOD_3_F149D59DE80310C6_OFFSET UNITYSDK_OFFSET(0x17137470)
#define RPG_GAMECORE_TUTORIALSAVE__CTOR_OFFSET UNITYSDK_OFFSET(0x171374C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialSave_TypeDefinitionIndex = 21839;
