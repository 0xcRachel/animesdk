...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPREPLACEROLECONFIG_METHOD_3_672E31C794868D2D_OFFSET UNITYSDK_OFFSET(0x1A1A7530)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPREPLACEROLECONFIG_METHOD_3_CB528DB9A8711524_OFFSET UNITYSDK_OFFSET(0x1A1A7600)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPREPLACEROLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1A75B0)
