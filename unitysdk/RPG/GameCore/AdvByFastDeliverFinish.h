...
#define RPG_GAMECORE_ADVBYFASTDELIVERFINISH_METHOD_4_1EFD778BA0CA204C_OFFSET UNITYSDK_OFFSET(0x167C43E0)
#define RPG_GAMECORE_ADVBYFASTDELIVERFINISH_METHOD_4_808BFB30847D36BB_OFFSET UNITYSDK_OFFSET(0x167C4240)
#define RPG_GAMECORE_ADVBYFASTDELIVERFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x167C4320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByFastDeliverFinish_TypeDefinitionIndex = 19806;
