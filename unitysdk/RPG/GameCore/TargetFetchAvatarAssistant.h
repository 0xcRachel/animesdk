...
#define RPG_GAMECORE_TARGETFETCHAVATARASSISTANT_METHOD_4_310AEEFCB3CF1031_OFFSET UNITYSDK_OFFSET(0x199E0290)
#define RPG_GAMECORE_TARGETFETCHAVATARASSISTANT_METHOD_4_86B195EFDBF8B54F_OFFSET UNITYSDK_OFFSET(0x199D8370)
#define RPG_GAMECORE_TARGETFETCHAVATARASSISTANT__CTOR_OFFSET UNITYSDK_OFFSET(0x199D8320)
