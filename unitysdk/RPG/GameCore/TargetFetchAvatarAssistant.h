...
#define RPG_GAMECORE_TARGETFETCHAVATARASSISTANT_METHOD_4_310AEEFCB3CF1031_OFFSET UNITYSDK_OFFSET(0x177D17D0)
#define RPG_GAMECORE_TARGETFETCHAVATARASSISTANT_METHOD_4_86B195EFDBF8B54F_OFFSET UNITYSDK_OFFSET(0x177C71B0)
#define RPG_GAMECORE_TARGETFETCHAVATARASSISTANT__CTOR_OFFSET UNITYSDK_OFFSET(0x177C7160)
