...
#define RPG_GAMECORE_SETUPACTIONDELAYLINK_METHOD_3_41470E85B2C97C30_OFFSET UNITYSDK_OFFSET(0x16F48670)
#define RPG_GAMECORE_SETUPACTIONDELAYLINK_METHOD_3_47E0FE9C4640EF3F_OFFSET UNITYSDK_OFFSET(0x16F485F0)
#define RPG_GAMECORE_SETUPACTIONDELAYLINK__CTOR_OFFSET UNITYSDK_OFFSET(0x16F48640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetupActionDelayLink_TypeDefinitionIndex = 20952;
