...
#define RPG_GAMECORE_MISSIONVERSIONCONSTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16CB29B0)
#define RPG_GAMECORE_MISSIONVERSIONCONSTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16CB2F40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MissionVersionConstRow_TypeDefinitionIndex = 12887;
