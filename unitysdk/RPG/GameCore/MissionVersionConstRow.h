...
#define RPG_GAMECORE_MISSIONVERSIONCONSTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17439440)
#define RPG_GAMECORE_MISSIONVERSIONCONSTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x174399D0)
