...
#define RPG_GAMECORE_ST_BYONHIT_METHOD_4_5917E1D0D70BF614_OFFSET UNITYSDK_OFFSET(0x16EF1120)
#define RPG_GAMECORE_ST_BYONHIT_METHOD_4_EDE8AD51B505A71E_OFFSET UNITYSDK_OFFSET(0x16EF11F0)
#define RPG_GAMECORE_ST_BYONHIT__CTOR_OFFSET UNITYSDK_OFFSET(0x16EF11A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByOnHit_TypeDefinitionIndex = 17850;
