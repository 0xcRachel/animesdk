...
#define RPG_GAMECORE_CHENLINGEFFECTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A4FA820)
#define RPG_GAMECORE_CHENLINGEFFECTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4FAAB0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::ChenLingEffectType EffectType; // 0x1C
