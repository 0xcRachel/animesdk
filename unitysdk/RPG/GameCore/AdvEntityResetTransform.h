...
#define RPG_GAMECORE_ADVENTITYRESETTRANSFORM_METHOD_3_76976F8DC428D25C_OFFSET UNITYSDK_OFFSET(0x16834B30)
#define RPG_GAMECORE_ADVENTITYRESETTRANSFORM_METHOD_3_D207189FDB92A915_OFFSET UNITYSDK_OFFSET(0x16834AB0)
#define RPG_GAMECORE_ADVENTITYRESETTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x16834B00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvEntityResetTransform_TypeDefinitionIndex = 18336;
