...
#define RPG_GAMECORE_FIVEDIMCREATEMASCOTFAKEPLAYERACTION_METHOD_3_DFCF1393B81B3F91_OFFSET UNITYSDK_OFFSET(0x16AB7C30)
#define RPG_GAMECORE_FIVEDIMCREATEMASCOTFAKEPLAYERACTION_METHOD_3_F393BB5F3EC5694E_OFFSET UNITYSDK_OFFSET(0x16AB7BC0)
#define RPG_GAMECORE_FIVEDIMCREATEMASCOTFAKEPLAYERACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16AB7C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimCreateMascotFakePlayerAction_TypeDefinitionIndex = 16764;
