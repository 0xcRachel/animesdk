...
#define RPG_GAMECORE_GRIDFIGHTTUTORIALSTAGENODECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A1C4FF0)
#define RPG_GAMECORE_GRIDFIGHTTUTORIALSTAGENODECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1C5230)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 UnlockTutorialTask; // 0x28
