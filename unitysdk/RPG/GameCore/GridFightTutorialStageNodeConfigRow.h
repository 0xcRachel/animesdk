...
#define RPG_GAMECORE_GRIDFIGHTTUTORIALSTAGENODECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B4FF90)
#define RPG_GAMECORE_GRIDFIGHTTUTORIALSTAGENODECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B50220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightTutorialStageNodeConfigRow_TypeDefinitionIndex = 12411;
