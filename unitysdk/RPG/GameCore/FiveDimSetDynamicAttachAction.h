...
#define RPG_GAMECORE_FIVEDIMSETDYNAMICATTACHACTION_METHOD_3_04B76EDE182844F0_OFFSET UNITYSDK_OFFSET(0x1A3A17C0)
#define RPG_GAMECORE_FIVEDIMSETDYNAMICATTACHACTION_METHOD_3_C51C20E0A026D7FF_OFFSET UNITYSDK_OFFSET(0x1A3A1750)
#define RPG_GAMECORE_FIVEDIMSETDYNAMICATTACHACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3A17A0)
