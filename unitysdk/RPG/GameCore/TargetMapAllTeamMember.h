...
#define RPG_GAMECORE_TARGETMAPALLTEAMMEMBER_METHOD_3_B7229ADE2018A2FC_OFFSET UNITYSDK_OFFSET(0x16FE13B0)
#define RPG_GAMECORE_TARGETMAPALLTEAMMEMBER_METHOD_3_EBD544EAA6EC72C8_OFFSET UNITYSDK_OFFSET(0x16FE14C0)
#define RPG_GAMECORE_TARGETMAPALLTEAMMEMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE14A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapAllTeamMember_TypeDefinitionIndex = 21661;
