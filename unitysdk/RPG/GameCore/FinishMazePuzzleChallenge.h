...
#define RPG_GAMECORE_FINISHMAZEPUZZLECHALLENGE_METHOD_3_05D17D2E7A6ECCAF_OFFSET UNITYSDK_OFFSET(0x171EC060)
#define RPG_GAMECORE_FINISHMAZEPUZZLECHALLENGE_METHOD_3_AF71DF3D05EB4E3E_OFFSET UNITYSDK_OFFSET(0x171EBFE0)
#define RPG_GAMECORE_FINISHMAZEPUZZLECHALLENGE__CTOR_OFFSET UNITYSDK_OFFSET(0x171EC030)
