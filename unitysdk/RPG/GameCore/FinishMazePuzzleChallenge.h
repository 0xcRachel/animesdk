...
#define RPG_GAMECORE_FINISHMAZEPUZZLECHALLENGE_METHOD_3_05D17D2E7A6ECCAF_OFFSET UNITYSDK_OFFSET(0x16AA6BE0)
#define RPG_GAMECORE_FINISHMAZEPUZZLECHALLENGE_METHOD_3_AF71DF3D05EB4E3E_OFFSET UNITYSDK_OFFSET(0x16AA6B60)
#define RPG_GAMECORE_FINISHMAZEPUZZLECHALLENGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16AA6BB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FinishMazePuzzleChallenge_TypeDefinitionIndex = 19658;
