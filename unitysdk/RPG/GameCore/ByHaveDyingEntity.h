...
#define RPG_GAMECORE_BYHAVEDYINGENTITY_METHOD_4_B3D3175C9CCDA94F_OFFSET UNITYSDK_OFFSET(0x16929270)
#define RPG_GAMECORE_BYHAVEDYINGENTITY_METHOD_4_CB54303CCAEE57CB_OFFSET UNITYSDK_OFFSET(0x16929190)
#define RPG_GAMECORE_BYHAVEDYINGENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x16929210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHaveDyingEntity_TypeDefinitionIndex = 20721;
