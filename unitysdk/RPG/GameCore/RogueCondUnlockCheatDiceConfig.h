...
#define RPG_GAMECORE_ROGUECONDUNLOCKCHEATDICECONFIG_METHOD_6_8D344480ECB54AD0_OFFSET UNITYSDK_OFFSET(0x1924A9B0)
#define RPG_GAMECORE_ROGUECONDUNLOCKCHEATDICECONFIG_METHOD_6_E86E18EBF073ED46_OFFSET UNITYSDK_OFFSET(0x1924A700)
#define RPG_GAMECORE_ROGUECONDUNLOCKCHEATDICECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1924A880)
