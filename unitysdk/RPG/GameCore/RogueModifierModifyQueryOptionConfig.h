...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYQUERYOPTIONCONFIG_METHOD_3_818D50A79351F116_OFFSET UNITYSDK_OFFSET(0x16EA0740)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYQUERYOPTIONCONFIG_METHOD_3_9BCCAD884F76E04F_OFFSET UNITYSDK_OFFSET(0x16E99970)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYQUERYOPTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E99920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyQueryOptionConfig_TypeDefinitionIndex = 16135;
