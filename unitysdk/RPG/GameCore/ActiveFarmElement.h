...
#define RPG_GAMECORE_ACTIVEFARMELEMENT_METHOD_3_A434C74DF6096151_OFFSET UNITYSDK_OFFSET(0x16EB3DB0)
#define RPG_GAMECORE_ACTIVEFARMELEMENT_METHOD_3_EC2FB3E09C6480A5_OFFSET UNITYSDK_OFFSET(0x16EB3EC0)
#define RPG_GAMECORE_ACTIVEFARMELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x16EB3E90)
