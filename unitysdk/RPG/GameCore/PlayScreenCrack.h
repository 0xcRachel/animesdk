...
#define RPG_GAMECORE_PLAYSCREENCRACK_METHOD_3_2AB4F70FF7F07C33_OFFSET UNITYSDK_OFFSET(0x16D525C0)
#define RPG_GAMECORE_PLAYSCREENCRACK_METHOD_3_61778FE47C979954_OFFSET UNITYSDK_OFFSET(0x16D52640)
#define RPG_GAMECORE_PLAYSCREENCRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x16D52610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayScreenCrack_TypeDefinitionIndex = 18694;
