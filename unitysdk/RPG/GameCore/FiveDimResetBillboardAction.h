...
#define RPG_GAMECORE_FIVEDIMRESETBILLBOARDACTION_METHOD_3_A5E2B26F327E8FA3_OFFSET UNITYSDK_OFFSET(0x16AD1670)
#define RPG_GAMECORE_FIVEDIMRESETBILLBOARDACTION_METHOD_3_E9973F2BE0F02CD7_OFFSET UNITYSDK_OFFSET(0x16AD1580)
#define RPG_GAMECORE_FIVEDIMRESETBILLBOARDACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16AD1650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimResetBillboardAction_TypeDefinitionIndex = 16840;
