...
#define RPG_GAMECORE_SHOWPROPSCENEOBJCLICKHINT_METHOD_3_29981694393996A5_OFFSET UNITYSDK_OFFSET(0x193AE830)
#define RPG_GAMECORE_SHOWPROPSCENEOBJCLICKHINT_METHOD_3_454FD8351BE14AED_OFFSET UNITYSDK_OFFSET(0x193AE6E0)
#define RPG_GAMECORE_SHOWPROPSCENEOBJCLICKHINT__CTOR_OFFSET UNITYSDK_OFFSET(0x193AE7A0)
