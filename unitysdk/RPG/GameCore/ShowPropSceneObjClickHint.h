...
#define RPG_GAMECORE_SHOWPROPSCENEOBJCLICKHINT_METHOD_3_29981694393996A5_OFFSET UNITYSDK_OFFSET(0x16F603F0)
#define RPG_GAMECORE_SHOWPROPSCENEOBJCLICKHINT_METHOD_3_454FD8351BE14AED_OFFSET UNITYSDK_OFFSET(0x16F602A0)
#define RPG_GAMECORE_SHOWPROPSCENEOBJCLICKHINT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F60360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowPropSceneObjClickHint_TypeDefinitionIndex = 19895;
