...
#define RPG_GAMECORE_SHOWPROPSCENEOBJCLICKHINT_METHOD_3_29981694393996A5_OFFSET UNITYSDK_OFFSET(0x17715990)
#define RPG_GAMECORE_SHOWPROPSCENEOBJCLICKHINT_METHOD_3_454FD8351BE14AED_OFFSET UNITYSDK_OFFSET(0x17715840)
#define RPG_GAMECORE_SHOWPROPSCENEOBJCLICKHINT__CTOR_OFFSET UNITYSDK_OFFSET(0x17715900)
