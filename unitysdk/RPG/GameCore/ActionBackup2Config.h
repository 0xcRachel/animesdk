...
#define RPG_GAMECORE_ACTIONBACKUP2CONFIG_METHOD_4_467ACD5E2938ABD6_OFFSET UNITYSDK_OFFSET(0x1885B3F0)
#define RPG_GAMECORE_ACTIONBACKUP2CONFIG_METHOD_4_F93BB412376A1DBF_OFFSET UNITYSDK_OFFSET(0x1885B320)
#define RPG_GAMECORE_ACTIONBACKUP2CONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1885B3A0)
