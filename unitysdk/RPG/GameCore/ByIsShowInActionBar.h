...
#define RPG_GAMECORE_BYISSHOWINACTIONBAR_METHOD_4_50F96F0ED040E34C_OFFSET UNITYSDK_OFFSET(0x16935790)
#define RPG_GAMECORE_BYISSHOWINACTIONBAR_METHOD_4_E8E65D981FABC70E_OFFSET UNITYSDK_OFFSET(0x169356C0)
#define RPG_GAMECORE_BYISSHOWINACTIONBAR__CTOR_OFFSET UNITYSDK_OFFSET(0x16935740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsShowInActionBar_TypeDefinitionIndex = 21846;
