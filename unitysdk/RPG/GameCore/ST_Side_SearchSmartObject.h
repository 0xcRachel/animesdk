...
#define RPG_GAMECORE_ST_SIDE_SEARCHSMARTOBJECT_METHOD_4_95730021841446A7_OFFSET UNITYSDK_OFFSET(0x192DE6A0)
#define RPG_GAMECORE_ST_SIDE_SEARCHSMARTOBJECT_METHOD_4_AF5216FD351C88AD_OFFSET UNITYSDK_OFFSET(0x192DE780)
#define RPG_GAMECORE_ST_SIDE_SEARCHSMARTOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x192DE720)
