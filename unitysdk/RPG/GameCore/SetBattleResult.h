...
#define RPG_GAMECORE_SETBATTLERESULT_METHOD_3_048D361267F9A0D5_OFFSET UNITYSDK_OFFSET(0x16F08CA0)
#define RPG_GAMECORE_SETBATTLERESULT_METHOD_3_0ADF68180578B1E4_OFFSET UNITYSDK_OFFSET(0x16F08C20)
#define RPG_GAMECORE_SETBATTLERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F08C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBattleResult_TypeDefinitionIndex = 21076;
