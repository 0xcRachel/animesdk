...
#define RPG_GAMECORE_STORYCHARACTERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16FA00D0)
#define RPG_GAMECORE_STORYCHARACTERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16FA06E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StoryCharacterRow_TypeDefinitionIndex = 13799;
