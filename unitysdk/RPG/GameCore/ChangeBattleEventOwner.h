...
#define RPG_GAMECORE_CHANGEBATTLEEVENTOWNER_METHOD_3_4F04724771C5CE71_OFFSET UNITYSDK_OFFSET(0x169630E0)
#define RPG_GAMECORE_CHANGEBATTLEEVENTOWNER_METHOD_3_5FDF0E278A9CB5DA_OFFSET UNITYSDK_OFFSET(0x16963060)
#define RPG_GAMECORE_CHANGEBATTLEEVENTOWNER__CTOR_OFFSET UNITYSDK_OFFSET(0x169630B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeBattleEventOwner_TypeDefinitionIndex = 20632;
