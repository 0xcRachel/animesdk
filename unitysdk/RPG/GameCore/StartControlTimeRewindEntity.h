...
#define RPG_GAMECORE_STARTCONTROLTIMEREWINDENTITY_METHOD_3_BA2C253F875455E6_OFFSET UNITYSDK_OFFSET(0x16F94A80)
#define RPG_GAMECORE_STARTCONTROLTIMEREWINDENTITY_METHOD_3_F95DEC57BCB7621C_OFFSET UNITYSDK_OFFSET(0x16F94A00)
#define RPG_GAMECORE_STARTCONTROLTIMEREWINDENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x16F94A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartControlTimeRewindEntity_TypeDefinitionIndex = 18434;
