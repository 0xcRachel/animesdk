...
#define RPG_GAMECORE_ROGUENOUSENDGAMEREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16EAB1F0)
#define RPG_GAMECORE_ROGUENOUSENDGAMEREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16EAB8B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueNousEndGameRewardRow_TypeDefinitionIndex = 13581;
