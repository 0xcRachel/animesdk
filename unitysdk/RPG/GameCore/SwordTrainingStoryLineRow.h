...
#define RPG_GAMECORE_SWORDTRAININGSTORYLINEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16FC2360)
#define RPG_GAMECORE_SWORDTRAININGSTORYLINEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16FC28D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwordTrainingStoryLineRow_TypeDefinitionIndex = 11316;

	class SwordTrainingStoryLineRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* TurnIDList; // 0x10
		::Il2CppArray<::System::UInt32>* EndingStoryIDList; // 0x18
		::System::String* EndingOptionKey; // 0x20
		::Il2CppArray<::System::UInt32>* AvatarIDList; // 0x28
		::System::String* StartTalkImage; // 0x30
		::System::String* StoryLineImage; // 0x38
		::RPG::Client::TextID StoryLineDesc; // 0x40
		::System::UInt32 TalkSentenceID; // 0x50
		::System::UInt32 UnlockID; // 0x54
		::System::UInt32 StoryLine; // 0x58
		::System::UInt32 StartTalkSentenceID; // 0x5C
		::System::UInt32 RewardID; // 0x60
		::RPG::Client::TextID StoryHardDesc; // 0x68
