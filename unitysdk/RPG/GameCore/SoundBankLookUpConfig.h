...
#define RPG_GAMECORE_SOUNDBANKLOOKUPCONFIG_METHOD_2_DBA7D4A6D49C74E4_OFFSET UNITYSDK_OFFSET(0x17725500)
#define RPG_GAMECORE_SOUNDBANKLOOKUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17725600)
