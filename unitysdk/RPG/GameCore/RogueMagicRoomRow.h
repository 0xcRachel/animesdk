...
#define RPG_GAMECORE_ROGUEMAGICROOMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16E87FC0)
#define RPG_GAMECORE_ROGUEMAGICROOMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16E88100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMagicRoomRow_TypeDefinitionIndex = 13513;
