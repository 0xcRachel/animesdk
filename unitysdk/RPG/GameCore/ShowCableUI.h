...
#define RPG_GAMECORE_SHOWCABLEUI_METHOD_3_89D644A420A840EF_OFFSET UNITYSDK_OFFSET(0x1770BDB0)
#define RPG_GAMECORE_SHOWCABLEUI_METHOD_3_C1CAF85E82BC851E_OFFSET UNITYSDK_OFFSET(0x1770BE30)
#define RPG_GAMECORE_SHOWCABLEUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1770BE00)
