...
#define RPG_GAMECORE_LEVELCHESSABILITYPROPERTYCHANGEEVENT_CLEAR_OFFSET UNITYSDK_OFFSET(0xA98B160)
#define RPG_GAMECORE_LEVELCHESSABILITYPROPERTYCHANGEEVENT_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA98B220)
#define RPG_GAMECORE_LEVELCHESSABILITYPROPERTYCHANGEEVENT_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA98B1D0)
#define RPG_GAMECORE_LEVELCHESSABILITYPROPERTYCHANGEEVENT_GET_CHANGEPARAM_OFFSET UNITYSDK_OFFSET(0xA98B2E0)
#define RPG_GAMECORE_LEVELCHESSABILITYPROPERTYCHANGEEVENT_GET_CHANGEVALUE_OFFSET UNITYSDK_OFFSET(0xA98B2B0)
#define RPG_GAMECORE_LEVELCHESSABILITYPROPERTYCHANGEEVENT_GET_ORIGINMODIFYVALUE_OFFSET UNITYSDK_OFFSET(0xA98B290)
#define RPG_GAMECORE_LEVELCHESSABILITYPROPERTYCHANGEEVENT_GET_PROPERTY_OFFSET UNITYSDK_OFFSET(0xA98B270)
#define RPG_GAMECORE_LEVELCHESSABILITYPROPERTYCHANGEEVENT_GET_TARGETENTITYRUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA98B2D0)
#define RPG_GAMECORE_LEVELCHESSABILITYPROPERTYCHANGEEVENT_INIT_OFFSET UNITYSDK_OFFSET(0xA98B0D0)
#define RPG_GAMECORE_LEVELCHESSABILITYPROPERTYCHANGEEVENT_SET_CHANGEPARAM_OFFSET UNITYSDK_OFFSET(0xA98B2F0)
#define RPG_GAMECORE_LEVELCHESSABILITYPROPERTYCHANGEEVENT_SET_CHANGEVALUE_OFFSET UNITYSDK_OFFSET(0xA98B2C0)
#define RPG_GAMECORE_LEVELCHESSABILITYPROPERTYCHANGEEVENT_SET_ORIGINMODIFYVALUE_OFFSET UNITYSDK_OFFSET(0xA98B2A0)
#define RPG_GAMECORE_LEVELCHESSABILITYPROPERTYCHANGEEVENT_SET_PROPERTY_OFFSET UNITYSDK_OFFSET(0xA98B280)
#define RPG_GAMECORE_LEVELCHESSABILITYPROPERTYCHANGEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xA98B300)
#define RPG_GAMECORE_LEVELCHESSABILITYPROPERTYCHANGEEVENT___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0xA98B310)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::FixPoint _ChangeValue_k__BackingField; // 0x20
		::RPG::GameCore::ChessAbilityProperty _Property_k__BackingField; // 0x28
		::System::UInt32 _EntityRuntimeID; // 0x2C
