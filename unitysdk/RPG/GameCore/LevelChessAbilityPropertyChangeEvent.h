...
#define RPG_GAMECORE_LEVELCHESSABILITYPROPERTYCHANGEEVENT_CLEAR_OFFSET UNITYSDK_OFFSET(0xA49A110)
#define RPG_GAMECORE_LEVELCHESSABILITYPROPERTYCHANGEEVENT_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA49A1D0)
#define RPG_GAMECORE_LEVELCHESSABILITYPROPERTYCHANGEEVENT_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA49A180)
#define RPG_GAMECORE_LEVELCHESSABILITYPROPERTYCHANGEEVENT_GET_CHANGEPARAM_OFFSET UNITYSDK_OFFSET(0xA49A290)
#define RPG_GAMECORE_LEVELCHESSABILITYPROPERTYCHANGEEVENT_GET_CHANGEVALUE_OFFSET UNITYSDK_OFFSET(0xA49A260)
#define RPG_GAMECORE_LEVELCHESSABILITYPROPERTYCHANGEEVENT_GET_ORIGINMODIFYVALUE_OFFSET UNITYSDK_OFFSET(0xA49A240)
#define RPG_GAMECORE_LEVELCHESSABILITYPROPERTYCHANGEEVENT_GET_PROPERTY_OFFSET UNITYSDK_OFFSET(0xA49A220)
#define RPG_GAMECORE_LEVELCHESSABILITYPROPERTYCHANGEEVENT_GET_TARGETENTITYRUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA49A280)
#define RPG_GAMECORE_LEVELCHESSABILITYPROPERTYCHANGEEVENT_INIT_OFFSET UNITYSDK_OFFSET(0xA49A080)
#define RPG_GAMECORE_LEVELCHESSABILITYPROPERTYCHANGEEVENT_SET_CHANGEPARAM_OFFSET UNITYSDK_OFFSET(0xA49A2A0)
#define RPG_GAMECORE_LEVELCHESSABILITYPROPERTYCHANGEEVENT_SET_CHANGEVALUE_OFFSET UNITYSDK_OFFSET(0xA49A270)
#define RPG_GAMECORE_LEVELCHESSABILITYPROPERTYCHANGEEVENT_SET_ORIGINMODIFYVALUE_OFFSET UNITYSDK_OFFSET(0xA49A250)
#define RPG_GAMECORE_LEVELCHESSABILITYPROPERTYCHANGEEVENT_SET_PROPERTY_OFFSET UNITYSDK_OFFSET(0xA49A230)
#define RPG_GAMECORE_LEVELCHESSABILITYPROPERTYCHANGEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xA49A2B0)
#define RPG_GAMECORE_LEVELCHESSABILITYPROPERTYCHANGEEVENT___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0xA49A2C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelChessAbilityPropertyChangeEvent_TypeDefinitionIndex = 44190;
	...
	public:
		...
		::RPG::GameCore::ChessAbilityProperty _Property_k__BackingField; // 0x20
		::System::UInt32 _EntityRuntimeID; // 0x24
		::RPG::GameCore::FixPoint _ChangeValue_k__BackingField; // 0x28
		::RPG::GameCore::FixPoint _OriginModifyValue_k__BackingField; // 0x30
