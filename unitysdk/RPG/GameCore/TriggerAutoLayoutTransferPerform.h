...
#define RPG_GAMECORE_TRIGGERAUTOLAYOUTTRANSFERPERFORM_METHOD_3_8DC045631A921799_OFFSET UNITYSDK_OFFSET(0x171179E0)
#define RPG_GAMECORE_TRIGGERAUTOLAYOUTTRANSFERPERFORM_METHOD_3_C66B14ABFC3E31E5_OFFSET UNITYSDK_OFFSET(0x17117960)
#define RPG_GAMECORE_TRIGGERAUTOLAYOUTTRANSFERPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x171179B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerAutoLayoutTransferPerform_TypeDefinitionIndex = 20801;
