...
#define RPG_GAMECORE_SETBATTLEUIPANELSTATE_METHOD_3_0C26432518CD7DA3_OFFSET UNITYSDK_OFFSET(0x16F09D00)
#define RPG_GAMECORE_SETBATTLEUIPANELSTATE_METHOD_3_4309EF5932473441_OFFSET UNITYSDK_OFFSET(0x16F09D80)
#define RPG_GAMECORE_SETBATTLEUIPANELSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F09D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBattleUIPanelState_TypeDefinitionIndex = 20462;
