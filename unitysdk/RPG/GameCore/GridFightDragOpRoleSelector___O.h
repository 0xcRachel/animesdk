...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::GridFightRegion>**)Il2CppClass::FromTypeDefinitionIndex(GridFightDragOpRoleSelector___O_TypeDefinitionIndex)->GetStaticField(0x290F0);
		}
	};
}
