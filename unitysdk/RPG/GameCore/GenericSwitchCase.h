...
#define RPG_GAMECORE_GENERICSWITCHCASE_METHOD_3_951C26F30F462CFD_OFFSET UNITYSDK_OFFSET(0x1955B0F0)
#define RPG_GAMECORE_GENERICSWITCHCASE_METHOD_3_F032630D26A58FEA_OFFSET UNITYSDK_OFFSET(0x1955B070)
#define RPG_GAMECORE_GENERICSWITCHCASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1955B0C0)
