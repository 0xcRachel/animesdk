...
#define RPG_GAMECORE_FIGHTFESTPHASEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x171E7590)
#define RPG_GAMECORE_FIGHTFESTPHASEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x171E7F20)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* LukaAnimTrigger; // 0x20
		::Il2CppArray<::System::UInt32>* PhaseTutorialParams; // 0x28
		::System::String* MiniIconPath1; // 0x30
		::System::String* Board3DTexture; // 0x38
		::RPG::Client::TextID TargetTips; // 0x40
		::System::UInt32 SortWeight; // 0x50
		::RPG::GameCore::FightFestPhaseType PhaseType; // 0x54
		::System::UInt32 UnlockSubMissionID; // 0x58
		::System::UInt32 PhaseID; // 0x5C
		::RPG::Client::TextID BoardTitle; // 0x60
