...
#define RPG_GAMECORE_FIGHTFESTPHASEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A416830)
#define RPG_GAMECORE_FIGHTFESTPHASEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4171E0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* LukaAnimTrigger; // 0x28
