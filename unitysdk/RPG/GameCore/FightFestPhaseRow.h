...
#define RPG_GAMECORE_FIGHTFESTPHASEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18D16D80)
#define RPG_GAMECORE_FIGHTFESTPHASEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18D17710)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* MiniIconPath1; // 0x18
		...
		::RPG::GameCore::FightFestPhaseType PhaseType; // 0x64
