...
#define RPG_GAMECORE_ST_CHESS_BYDISTANCETOTARGET_METHOD_4_9EB16729F58746DE_OFFSET UNITYSDK_OFFSET(0x16EF1860)
#define RPG_GAMECORE_ST_CHESS_BYDISTANCETOTARGET_METHOD_4_BBC1299154D70B2A_OFFSET UNITYSDK_OFFSET(0x16EF1790)
#define RPG_GAMECORE_ST_CHESS_BYDISTANCETOTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x16EF1810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Chess_ByDistanceToTarget_TypeDefinitionIndex = 21445;
