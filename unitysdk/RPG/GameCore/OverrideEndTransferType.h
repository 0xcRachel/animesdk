...
#define RPG_GAMECORE_OVERRIDEENDTRANSFERTYPE_METHOD_3_5AC1963ADCEB0998_OFFSET UNITYSDK_OFFSET(0x174969E0)
#define RPG_GAMECORE_OVERRIDEENDTRANSFERTYPE_METHOD_3_E3B4CCC538AA4471_OFFSET UNITYSDK_OFFSET(0x17496950)
#define RPG_GAMECORE_OVERRIDEENDTRANSFERTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x174969B0)
