...
#define RPG_GAMECORE_OVERRIDEENDTRANSFERTYPE_METHOD_3_5AC1963ADCEB0998_OFFSET UNITYSDK_OFFSET(0x16D100E0)
#define RPG_GAMECORE_OVERRIDEENDTRANSFERTYPE_METHOD_3_E3B4CCC538AA4471_OFFSET UNITYSDK_OFFSET(0x16D10050)
#define RPG_GAMECORE_OVERRIDEENDTRANSFERTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x16D100B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OverrideEndTransferType_TypeDefinitionIndex = 19562;
