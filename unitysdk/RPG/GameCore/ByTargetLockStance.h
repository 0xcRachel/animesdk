...
#define RPG_GAMECORE_BYTARGETLOCKSTANCE_METHOD_4_3EE46A03CDF5D8BB_OFFSET UNITYSDK_OFFSET(0x17051C30)
#define RPG_GAMECORE_BYTARGETLOCKSTANCE_METHOD_4_D1C297B7355CB37F_OFFSET UNITYSDK_OFFSET(0x17051D00)
#define RPG_GAMECORE_BYTARGETLOCKSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x17051CB0)
