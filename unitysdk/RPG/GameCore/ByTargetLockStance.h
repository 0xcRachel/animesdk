...
#define RPG_GAMECORE_BYTARGETLOCKSTANCE_METHOD_4_3EE46A03CDF5D8BB_OFFSET UNITYSDK_OFFSET(0x169403E0)
#define RPG_GAMECORE_BYTARGETLOCKSTANCE_METHOD_4_D1C297B7355CB37F_OFFSET UNITYSDK_OFFSET(0x169404B0)
#define RPG_GAMECORE_BYTARGETLOCKSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x16940460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByTargetLockStance_TypeDefinitionIndex = 21305;
