...
#define RPG_GAMECORE_SETIGNORETIMEREWINDLOCKRANGELIMIT_METHOD_3_35B2D4F2AA4728F1_OFFSET UNITYSDK_OFFSET(0x199B8870)
#define RPG_GAMECORE_SETIGNORETIMEREWINDLOCKRANGELIMIT_METHOD_3_D719A85E8FE5392D_OFFSET UNITYSDK_OFFSET(0x199B88F0)
#define RPG_GAMECORE_SETIGNORETIMEREWINDLOCKRANGELIMIT__CTOR_OFFSET UNITYSDK_OFFSET(0x199B88C0)
