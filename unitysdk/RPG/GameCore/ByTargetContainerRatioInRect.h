...
#define RPG_GAMECORE_BYTARGETCONTAINERRATIOINRECT_METHOD_4_32207F2AC0855714_OFFSET UNITYSDK_OFFSET(0x1693E6D0)
#define RPG_GAMECORE_BYTARGETCONTAINERRATIOINRECT_METHOD_4_66B36311B089860F_OFFSET UNITYSDK_OFFSET(0x1693E5B0)
#define RPG_GAMECORE_BYTARGETCONTAINERRATIOINRECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1693E650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByTargetContainerRatioInRect_TypeDefinitionIndex = 19290;
