...
#define RPG_GAMECORE_BYCHECKFIGHTFINISH_METHOD_4_1E5DB1E69EE66563_OFFSET UNITYSDK_OFFSET(0x169018F0)
#define RPG_GAMECORE_BYCHECKFIGHTFINISH_METHOD_4_EF0056CE4BF148B9_OFFSET UNITYSDK_OFFSET(0x16901820)
#define RPG_GAMECORE_BYCHECKFIGHTFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x169018A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckFightFinish_TypeDefinitionIndex = 21113;
