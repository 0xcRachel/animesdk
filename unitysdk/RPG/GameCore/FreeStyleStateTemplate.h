...
#define RPG_GAMECORE_FREESTYLESTATETEMPLATE_METHOD_2_B17A555C76331CAA_OFFSET UNITYSDK_OFFSET(0x16AE96D0)
#define RPG_GAMECORE_FREESTYLESTATETEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16AE9A30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FreeStyleStateTemplate_TypeDefinitionIndex = 14678;
