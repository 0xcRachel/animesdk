...
#define RPG_GAMECORE_CHALLENGEACTIVITYCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18D43FC0)
#define RPG_GAMECORE_CHALLENGEACTIVITYCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18D441C0)
