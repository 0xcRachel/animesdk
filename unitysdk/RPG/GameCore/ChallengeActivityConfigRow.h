...
#define RPG_GAMECORE_CHALLENGEACTIVITYCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16958050)
#define RPG_GAMECORE_CHALLENGEACTIVITYCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16958250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChallengeActivityConfigRow_TypeDefinitionIndex = 11734;
