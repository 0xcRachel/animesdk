...
#define RPG_GAMECORE_CHALLENGEACTIVITYCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17069800)
#define RPG_GAMECORE_CHALLENGEACTIVITYCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17069A00)
