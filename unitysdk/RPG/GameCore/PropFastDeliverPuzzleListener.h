...
#define RPG_GAMECORE_PROPFASTDELIVERPUZZLELISTENER_METHOD_3_5FC9989F26B920C6_OFFSET UNITYSDK_OFFSET(0x191C5B60)
#define RPG_GAMECORE_PROPFASTDELIVERPUZZLELISTENER_METHOD_3_732E49F1C267C9A2_OFFSET UNITYSDK_OFFSET(0x191C5A10)
#define RPG_GAMECORE_PROPFASTDELIVERPUZZLELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x191C5AD0)
