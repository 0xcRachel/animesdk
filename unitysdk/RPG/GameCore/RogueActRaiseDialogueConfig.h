...
#define RPG_GAMECORE_ROGUEACTRAISEDIALOGUECONFIG_METHOD_6_7F324A441E26C3B7_OFFSET UNITYSDK_OFFSET(0x1A9B2440)
#define RPG_GAMECORE_ROGUEACTRAISEDIALOGUECONFIG_METHOD_6_8DEA8F33BBA138C2_OFFSET UNITYSDK_OFFSET(0x1A9B2660)
#define RPG_GAMECORE_ROGUEACTRAISEDIALOGUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9B2580)
