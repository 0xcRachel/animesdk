...
#define RPG_GAMECORE_BYPAMACTIONPHASETALK_METHOD_4_0071C0E6C399AFB1_OFFSET UNITYSDK_OFFSET(0x19DB9A90)
#define RPG_GAMECORE_BYPAMACTIONPHASETALK_METHOD_4_A929381BFF99FAAB_OFFSET UNITYSDK_OFFSET(0x19DB9B60)
#define RPG_GAMECORE_BYPAMACTIONPHASETALK_METHOD_4_C4BB22B957F00C7C_OFFSET UNITYSDK_OFFSET(0x19DB9CA0)
#define RPG_GAMECORE_BYPAMACTIONPHASETALK_METHOD_4_E4A05637E3C04354_OFFSET UNITYSDK_OFFSET(0x19DB9D20)
#define RPG_GAMECORE_BYPAMACTIONPHASETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x19DB9B10)
