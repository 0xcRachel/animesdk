...
#define RPG_GAMECORE_BYPAMACTIONPHASETALK_METHOD_4_0071C0E6C399AFB1_OFFSET UNITYSDK_OFFSET(0x16939F50)
#define RPG_GAMECORE_BYPAMACTIONPHASETALK_METHOD_4_A929381BFF99FAAB_OFFSET UNITYSDK_OFFSET(0x1693A020)
#define RPG_GAMECORE_BYPAMACTIONPHASETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x16939FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByPamActionPhaseTalk_TypeDefinitionIndex = 17769;
