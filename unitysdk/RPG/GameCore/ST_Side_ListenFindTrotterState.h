...
#define RPG_GAMECORE_ST_SIDE_LISTENFINDTROTTERSTATE_METHOD_4_5E2DE80A0AB6546D_OFFSET UNITYSDK_OFFSET(0x16EE9DD0)
#define RPG_GAMECORE_ST_SIDE_LISTENFINDTROTTERSTATE_METHOD_4_9970E3BE71C44C01_OFFSET UNITYSDK_OFFSET(0x16EF8500)
#define RPG_GAMECORE_ST_SIDE_LISTENFINDTROTTERSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16EE9D70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_ListenFindTrotterState_TypeDefinitionIndex = 17903;
