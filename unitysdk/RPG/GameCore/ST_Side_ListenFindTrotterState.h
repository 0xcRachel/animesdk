...
#define RPG_GAMECORE_ST_SIDE_LISTENFINDTROTTERSTATE_METHOD_4_5E2DE80A0AB6546D_OFFSET UNITYSDK_OFFSET(0x176A1740)
#define RPG_GAMECORE_ST_SIDE_LISTENFINDTROTTERSTATE_METHOD_4_9970E3BE71C44C01_OFFSET UNITYSDK_OFFSET(0x176AD890)
#define RPG_GAMECORE_ST_SIDE_LISTENFINDTROTTERSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x176A16E0)
