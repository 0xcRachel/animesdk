...
#define RPG_GAMECORE_SKILLABILITYCONFIG_METHOD_2_2D6E1F92B1FBF606_OFFSET UNITYSDK_OFFSET(0x16F6AA00)
#define RPG_GAMECORE_SKILLABILITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F6AB20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SkillAbilityConfig_TypeDefinitionIndex = 14222;
