...
#define RPG_GAMECORE_LEVELLOCKFEATURE_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x16BAB6B0)
#define RPG_GAMECORE_LEVELLOCKFEATURE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16BAB630)
#define RPG_GAMECORE_LEVELLOCKFEATURE__CTOR_OFFSET UNITYSDK_OFFSET(0x16BAB680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelLockFeature_TypeDefinitionIndex = 21070;
