...
#define RPG_GAMECORE_ELFENTRANCENPCSET_METHOD_2_90C9C759AAA9B77F_OFFSET UNITYSDK_OFFSET(0x16A5FF60)
#define RPG_GAMECORE_ELFENTRANCENPCSET__CTOR_OFFSET UNITYSDK_OFFSET(0x16A60060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfEntranceNPCSet_TypeDefinitionIndex = 14602;
