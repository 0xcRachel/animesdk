...
#define RPG_GAMECORE_ELFENTRANCENPCSET_METHOD_2_90C9C759AAA9B77F_OFFSET UNITYSDK_OFFSET(0x1914EDC0)
#define RPG_GAMECORE_ELFENTRANCENPCSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1914EEC0)
