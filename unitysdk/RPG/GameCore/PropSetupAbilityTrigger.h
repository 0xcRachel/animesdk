...
#define RPG_GAMECORE_PROPSETUPABILITYTRIGGER_METHOD_3_8E68CDABF75DB68C_OFFSET UNITYSDK_OFFSET(0x16DB3070)
#define RPG_GAMECORE_PROPSETUPABILITYTRIGGER_METHOD_3_EBB97B243F75F059_OFFSET UNITYSDK_OFFSET(0x16DB3190)
#define RPG_GAMECORE_PROPSETUPABILITYTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x16DB3110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropSetupAbilityTrigger_TypeDefinitionIndex = 18125;
