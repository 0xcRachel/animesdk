...
#define RPG_GAMECORE_NUMBERCASECONTAINER_METHOD_3_748F142DC5C73C17_OFFSET UNITYSDK_OFFSET(0x18EECA30)
#define RPG_GAMECORE_NUMBERCASECONTAINER_METHOD_3_AC84ADEF1784E364_OFFSET UNITYSDK_OFFSET(0x18EECA70)
#define RPG_GAMECORE_NUMBERCASECONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x18EECA60)
