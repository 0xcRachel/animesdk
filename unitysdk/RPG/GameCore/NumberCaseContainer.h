...
#define RPG_GAMECORE_NUMBERCASECONTAINER_METHOD_3_748F142DC5C73C17_OFFSET UNITYSDK_OFFSET(0x16D06FD0)
#define RPG_GAMECORE_NUMBERCASECONTAINER_METHOD_3_AC84ADEF1784E364_OFFSET UNITYSDK_OFFSET(0x16D07010)
#define RPG_GAMECORE_NUMBERCASECONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x16D07000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NumberCaseContainer_TypeDefinitionIndex = 15835;
