...
#define RPG_GAMECORE_CHESSSTAGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x170A2860)
#define RPG_GAMECORE_CHESSSTAGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x170A2960)
