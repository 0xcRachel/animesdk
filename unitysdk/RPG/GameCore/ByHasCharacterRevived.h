...
#define RPG_GAMECORE_BYHASCHARACTERREVIVED_METHOD_4_0439CF1F0074E6DD_OFFSET UNITYSDK_OFFSET(0x16926830)
#define RPG_GAMECORE_BYHASCHARACTERREVIVED_METHOD_4_9C4725DF47580BB3_OFFSET UNITYSDK_OFFSET(0x16926900)
#define RPG_GAMECORE_BYHASCHARACTERREVIVED__CTOR_OFFSET UNITYSDK_OFFSET(0x169268B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHasCharacterRevived_TypeDefinitionIndex = 20714;
