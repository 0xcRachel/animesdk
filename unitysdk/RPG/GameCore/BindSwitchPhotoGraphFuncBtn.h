...
#define RPG_GAMECORE_BINDSWITCHPHOTOGRAPHFUNCBTN_METHOD_3_4AF01CF27AB539C5_OFFSET UNITYSDK_OFFSET(0x187B9260)
#define RPG_GAMECORE_BINDSWITCHPHOTOGRAPHFUNCBTN_METHOD_3_6939BA66C270A04E_OFFSET UNITYSDK_OFFSET(0x187B9320)
#define RPG_GAMECORE_BINDSWITCHPHOTOGRAPHFUNCBTN__CTOR_OFFSET UNITYSDK_OFFSET(0x187B92D0)
