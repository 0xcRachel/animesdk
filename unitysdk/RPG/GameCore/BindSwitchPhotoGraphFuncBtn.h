...
#define RPG_GAMECORE_BINDSWITCHPHOTOGRAPHFUNCBTN_METHOD_3_034DCED400B9F2A1_OFFSET UNITYSDK_OFFSET(0x195DB080)
#define RPG_GAMECORE_BINDSWITCHPHOTOGRAPHFUNCBTN_METHOD_3_0B55F517E5C1B3FC_OFFSET UNITYSDK_OFFSET(0x195DAFC0)
#define RPG_GAMECORE_BINDSWITCHPHOTOGRAPHFUNCBTN__CTOR_OFFSET UNITYSDK_OFFSET(0x195DB030)
