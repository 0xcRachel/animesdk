...
#define RPG_GAMECORE_BINDSWITCHPHOTOGRAPHFUNCBTN_METHOD_3_6939BA66C270A04E_OFFSET UNITYSDK_OFFSET(0x16FFAD10)
#define RPG_GAMECORE_BINDSWITCHPHOTOGRAPHFUNCBTN_METHOD_3_8CDD1D2E0208797E_OFFSET UNITYSDK_OFFSET(0x16FFAC50)
#define RPG_GAMECORE_BINDSWITCHPHOTOGRAPHFUNCBTN__CTOR_OFFSET UNITYSDK_OFFSET(0x16FFACC0)
