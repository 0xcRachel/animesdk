...
#define RPG_GAMECORE_FIVEDIMCONDITIONALLOF_METHOD_3_B2F74180553A92EE_OFFSET UNITYSDK_OFFSET(0x16AB7010)
#define RPG_GAMECORE_FIVEDIMCONDITIONALLOF_METHOD_3_D16F57798A6BC795_OFFSET UNITYSDK_OFFSET(0x16AB7050)
#define RPG_GAMECORE_FIVEDIMCONDITIONALLOF__CTOR_OFFSET UNITYSDK_OFFSET(0x16AB7040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimConditionAllOf_TypeDefinitionIndex = 16848;
