...
#define RPG_GAMECORE_BYCHECKMODIFIERDEATHSOURCE_METHOD_4_1FEE0E915F6A398D_OFFSET UNITYSDK_OFFSET(0x195FCC30)
#define RPG_GAMECORE_BYCHECKMODIFIERDEATHSOURCE_METHOD_4_646B201E5DDC111C_OFFSET UNITYSDK_OFFSET(0x195FCBB0)
#define RPG_GAMECORE_BYCHECKMODIFIERDEATHSOURCE_METHOD_4_B31C504FCF3370DE_OFFSET UNITYSDK_OFFSET(0x195FCA00)
#define RPG_GAMECORE_BYCHECKMODIFIERDEATHSOURCE_METHOD_4_EC5D0F97D38DC4E0_OFFSET UNITYSDK_OFFSET(0x195FC930)
#define RPG_GAMECORE_BYCHECKMODIFIERDEATHSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x195FC9B0)
