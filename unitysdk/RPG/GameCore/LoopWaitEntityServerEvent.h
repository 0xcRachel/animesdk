...
#define RPG_GAMECORE_LOOPWAITENTITYSERVEREVENT_METHOD_3_31FEC89E38633222_OFFSET UNITYSDK_OFFSET(0x19C19330)
#define RPG_GAMECORE_LOOPWAITENTITYSERVEREVENT_METHOD_3_F85355FD62381C7D_OFFSET UNITYSDK_OFFSET(0x19C192C0)
#define RPG_GAMECORE_LOOPWAITENTITYSERVEREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C19300)
