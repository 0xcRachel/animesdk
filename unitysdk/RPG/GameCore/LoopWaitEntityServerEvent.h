...
#define RPG_GAMECORE_LOOPWAITENTITYSERVEREVENT_METHOD_3_31FEC89E38633222_OFFSET UNITYSDK_OFFSET(0x16C20430)
#define RPG_GAMECORE_LOOPWAITENTITYSERVEREVENT_METHOD_3_F85355FD62381C7D_OFFSET UNITYSDK_OFFSET(0x16C203C0)
#define RPG_GAMECORE_LOOPWAITENTITYSERVEREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x16C20400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitEntityServerEvent_TypeDefinitionIndex = 19775;
