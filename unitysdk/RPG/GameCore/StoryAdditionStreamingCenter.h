...
#define RPG_GAMECORE_STORYADDITIONSTREAMINGCENTER_METHOD_2_6E6C4476C8B986B6_OFFSET UNITYSDK_OFFSET(0x16F9F3E0)
#define RPG_GAMECORE_STORYADDITIONSTREAMINGCENTER__CTOR_OFFSET UNITYSDK_OFFSET(0x16F9F530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StoryAdditionStreamingCenter_TypeDefinitionIndex = 19016;
