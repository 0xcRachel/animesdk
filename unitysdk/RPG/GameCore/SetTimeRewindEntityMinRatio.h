...
#define RPG_GAMECORE_SETTIMEREWINDENTITYMINRATIO_METHOD_3_0D01B4FB9A2EE992_OFFSET UNITYSDK_OFFSET(0x1A7A21E0)
#define RPG_GAMECORE_SETTIMEREWINDENTITYMINRATIO_METHOD_3_2D66E72539C1E1C5_OFFSET UNITYSDK_OFFSET(0x1A7A2160)
#define RPG_GAMECORE_SETTIMEREWINDENTITYMINRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7A21B0)
