...
#define RPG_GAMECORE_SETTIMEREWINDENTITYMINRATIO_METHOD_3_0D01B4FB9A2EE992_OFFSET UNITYSDK_OFFSET(0x16F43D00)
#define RPG_GAMECORE_SETTIMEREWINDENTITYMINRATIO_METHOD_3_2D66E72539C1E1C5_OFFSET UNITYSDK_OFFSET(0x16F43C80)
#define RPG_GAMECORE_SETTIMEREWINDENTITYMINRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x16F43CD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTimeRewindEntityMinRatio_TypeDefinitionIndex = 18478;
