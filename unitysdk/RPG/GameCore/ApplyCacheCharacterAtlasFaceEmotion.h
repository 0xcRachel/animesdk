...
#define RPG_GAMECORE_APPLYCACHECHARACTERATLASFACEEMOTION_METHOD_3_8DE496EE864E5680_OFFSET UNITYSDK_OFFSET(0x1688B520)
#define RPG_GAMECORE_APPLYCACHECHARACTERATLASFACEEMOTION_METHOD_3_A0EE8AF16917A539_OFFSET UNITYSDK_OFFSET(0x1688B4A0)
#define RPG_GAMECORE_APPLYCACHECHARACTERATLASFACEEMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1688B4F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ApplyCacheCharacterAtlasFaceEmotion_TypeDefinitionIndex = 18421;
