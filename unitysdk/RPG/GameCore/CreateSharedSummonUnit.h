...
#define RPG_GAMECORE_CREATESHAREDSUMMONUNIT_METHOD_3_2A874A3828E22EB5_OFFSET UNITYSDK_OFFSET(0x169D6970)
#define RPG_GAMECORE_CREATESHAREDSUMMONUNIT_METHOD_3_EFFCE7EFF563BAED_OFFSET UNITYSDK_OFFSET(0x169D6B80)
#define RPG_GAMECORE_CREATESHAREDSUMMONUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x169D69B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateSharedSummonUnit_TypeDefinitionIndex = 18937;
