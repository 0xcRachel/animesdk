...
#define RPG_GAMECORE_SHADERPROPERTYOVERRIDEMONOSERIALIZATION_METHOD_2_2C7879A5473A3CDC_OFFSET UNITYSDK_OFFSET(0x16F4AB30)
#define RPG_GAMECORE_SHADERPROPERTYOVERRIDEMONOSERIALIZATION__CTOR_OFFSET UNITYSDK_OFFSET(0x16F4AC50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShaderPropertyOverrideMonoSerialization_TypeDefinitionIndex = 17216;
