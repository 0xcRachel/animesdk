...
#define RPG_GAMECORE_SETAVATARBASETYPE_METHOD_3_12674314453660FE_OFFSET UNITYSDK_OFFSET(0x192ED610)
#define RPG_GAMECORE_SETAVATARBASETYPE_METHOD_3_F11C75DCB2C4E981_OFFSET UNITYSDK_OFFSET(0x192ED580)
#define RPG_GAMECORE_SETAVATARBASETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x192ED5E0)
