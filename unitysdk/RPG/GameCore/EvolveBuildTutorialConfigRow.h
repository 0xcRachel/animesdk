...
#define RPG_GAMECORE_EVOLVEBUILDTUTORIALCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16A85030)
#define RPG_GAMECORE_EVOLVEBUILDTUTORIALCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16A85730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EvolveBuildTutorialConfigRow_TypeDefinitionIndex = 10621;
