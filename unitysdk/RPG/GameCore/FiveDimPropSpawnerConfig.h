...
#define RPG_GAMECORE_FIVEDIMPROPSPAWNERCONFIG_METHOD_3_4E6023DAF33388C1_OFFSET UNITYSDK_OFFSET(0x17219C90)
#define RPG_GAMECORE_FIVEDIMPROPSPAWNERCONFIG_METHOD_3_9AA320A21C18C300_OFFSET UNITYSDK_OFFSET(0x17219C00)
#define RPG_GAMECORE_FIVEDIMPROPSPAWNERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17219C60)
