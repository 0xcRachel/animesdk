...
#define RPG_GAMECORE_FIVEDIMPROPSPAWNERCONFIG_METHOD_3_4E6023DAF33388C1_OFFSET UNITYSDK_OFFSET(0x16ACF710)
#define RPG_GAMECORE_FIVEDIMPROPSPAWNERCONFIG_METHOD_3_9AA320A21C18C300_OFFSET UNITYSDK_OFFSET(0x16ACF680)
#define RPG_GAMECORE_FIVEDIMPROPSPAWNERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16ACF6E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPropSpawnerConfig_TypeDefinitionIndex = 16682;
