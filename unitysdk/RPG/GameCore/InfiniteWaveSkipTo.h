...
#define RPG_GAMECORE_INFINITEWAVESKIPTO_METHOD_3_7877202168B91357_OFFSET UNITYSDK_OFFSET(0x1888DD80)
#define RPG_GAMECORE_INFINITEWAVESKIPTO_METHOD_3_E223FC2559A6F1FE_OFFSET UNITYSDK_OFFSET(0x1888DE00)
#define RPG_GAMECORE_INFINITEWAVESKIPTO__CTOR_OFFSET UNITYSDK_OFFSET(0x1888DDD0)
