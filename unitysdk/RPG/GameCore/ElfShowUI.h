...
#define RPG_GAMECORE_ELFSHOWUI_METHOD_3_2CB5E327299DD450_OFFSET UNITYSDK_OFFSET(0x16A62F30)
#define RPG_GAMECORE_ELFSHOWUI_METHOD_3_4E3C7DF97C5F1F09_OFFSET UNITYSDK_OFFSET(0x16A62EB0)
#define RPG_GAMECORE_ELFSHOWUI__CTOR_OFFSET UNITYSDK_OFFSET(0x16A62F00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfShowUI_TypeDefinitionIndex = 19378;
