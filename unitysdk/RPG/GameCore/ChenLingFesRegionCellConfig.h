...
#define RPG_GAMECORE_CHENLINGFESREGIONCELLCONFIG_METHOD_2_3ADE8769375F93D8_OFFSET UNITYSDK_OFFSET(0x1A4FEFB0)
#define RPG_GAMECORE_CHENLINGFESREGIONCELLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4FF1B0)
