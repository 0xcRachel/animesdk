...
#define RPG_GAMECORE_SETFLIPPERLIGHTDEVICEFOLLOWPLAYER_METHOD_3_5E462D16A56F0FB5_OFFSET UNITYSDK_OFFSET(0x16F2C9F0)
#define RPG_GAMECORE_SETFLIPPERLIGHTDEVICEFOLLOWPLAYER_METHOD_3_C7000447E11CA5FB_OFFSET UNITYSDK_OFFSET(0x16F2CAD0)
#define RPG_GAMECORE_SETFLIPPERLIGHTDEVICEFOLLOWPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x16F2CA70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFlipperLightDeviceFollowPlayer_TypeDefinitionIndex = 19998;
