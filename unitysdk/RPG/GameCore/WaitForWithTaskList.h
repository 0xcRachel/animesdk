...
#define RPG_GAMECORE_WAITFORWITHTASKLIST_METHOD_3_B5EB0EE7547A56D7_OFFSET UNITYSDK_OFFSET(0x1952BEE0)
#define RPG_GAMECORE_WAITFORWITHTASKLIST_METHOD_3_E747C0AE5FB70033_OFFSET UNITYSDK_OFFSET(0x1952BE60)
#define RPG_GAMECORE_WAITFORWITHTASKLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1952BEB0)
