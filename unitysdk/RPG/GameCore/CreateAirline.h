...
#define RPG_GAMECORE_CREATEAIRLINE_METHOD_3_08D854CABE061C47_OFFSET UNITYSDK_OFFSET(0x169D0FF0)
#define RPG_GAMECORE_CREATEAIRLINE_METHOD_3_C1F058E717DF4A69_OFFSET UNITYSDK_OFFSET(0x169D0F70)
#define RPG_GAMECORE_CREATEAIRLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x169D0FC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateAirline_TypeDefinitionIndex = 19517;
