...
#define RPG_GAMECORE_CREATEAIRLINE_METHOD_3_08D854CABE061C47_OFFSET UNITYSDK_OFFSET(0x1714CFA0)
#define RPG_GAMECORE_CREATEAIRLINE_METHOD_3_C1F058E717DF4A69_OFFSET UNITYSDK_OFFSET(0x1714CF20)
#define RPG_GAMECORE_CREATEAIRLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1714CF70)
