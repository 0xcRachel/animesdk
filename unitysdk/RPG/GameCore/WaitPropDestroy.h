...
#define RPG_GAMECORE_WAITPROPDESTROY_METHOD_3_2C5DF8873AFE9173_OFFSET UNITYSDK_OFFSET(0x19532AA0)
#define RPG_GAMECORE_WAITPROPDESTROY_METHOD_3_34294A95452621C4_OFFSET UNITYSDK_OFFSET(0x19532950)
#define RPG_GAMECORE_WAITPROPDESTROY__CTOR_OFFSET UNITYSDK_OFFSET(0x19532A10)
