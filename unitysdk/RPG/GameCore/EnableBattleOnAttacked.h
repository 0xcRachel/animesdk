...
#define RPG_GAMECORE_ENABLEBATTLEONATTACKED_METHOD_3_6A8FAC608280E3C3_OFFSET UNITYSDK_OFFSET(0x16A68AE0)
#define RPG_GAMECORE_ENABLEBATTLEONATTACKED_METHOD_3_903C911D85F51C67_OFFSET UNITYSDK_OFFSET(0x16A68B60)
#define RPG_GAMECORE_ENABLEBATTLEONATTACKED__CTOR_OFFSET UNITYSDK_OFFSET(0x16A68B30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableBattleOnAttacked_TypeDefinitionIndex = 19401;
