...
#define RPG_GAMECORE_CHENLINGPOLICYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1709C370)
#define RPG_GAMECORE_CHENLINGPOLICYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1709C790)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::ChenLingIconType IconType; // 0x5C
