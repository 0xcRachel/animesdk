...
#define RPG_GAMECORE_BYGAMEENTITYNOTCREATED_METHOD_4_B5108C4456E817FB_OFFSET UNITYSDK_OFFSET(0x170366B0)
#define RPG_GAMECORE_BYGAMEENTITYNOTCREATED_METHOD_4_B6217744C594489D_OFFSET UNITYSDK_OFFSET(0x17036780)
#define RPG_GAMECORE_BYGAMEENTITYNOTCREATED__CTOR_OFFSET UNITYSDK_OFFSET(0x17036730)
