...
#define RPG_GAMECORE_CHIMERADUELPLAYEYEANIMATIONNODE_METHOD_3_151CD5631151A84E_OFFSET UNITYSDK_OFFSET(0x16994B70)
#define RPG_GAMECORE_CHIMERADUELPLAYEYEANIMATIONNODE_METHOD_3_4E4C2F9B7DB47A0D_OFFSET UNITYSDK_OFFSET(0x16994A90)
#define RPG_GAMECORE_CHIMERADUELPLAYEYEANIMATIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x16994B20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelPlayEyeAnimationNode_TypeDefinitionIndex = 14389;
