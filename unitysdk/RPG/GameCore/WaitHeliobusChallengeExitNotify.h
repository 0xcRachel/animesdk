...
#define RPG_GAMECORE_WAITHELIOBUSCHALLENGEEXITNOTIFY_METHOD_3_15A90519F8F6BAF1_OFFSET UNITYSDK_OFFSET(0x17154390)
#define RPG_GAMECORE_WAITHELIOBUSCHALLENGEEXITNOTIFY_METHOD_3_47A7AE27430F6F68_OFFSET UNITYSDK_OFFSET(0x17154410)
#define RPG_GAMECORE_WAITHELIOBUSCHALLENGEEXITNOTIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x171543E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitHeliobusChallengeExitNotify_TypeDefinitionIndex = 19352;
