...
#define RPG_GAMECORE_ROGUEFORMULACONDITIONCONFIGBASE_METHOD_6_79F6C218CBBA130F_OFFSET UNITYSDK_OFFSET(0x1761E730)
#define RPG_GAMECORE_ROGUEFORMULACONDITIONCONFIGBASE_METHOD_6_A46B7B8686D2C4E6_OFFSET UNITYSDK_OFFSET(0x1761ED10)
#define RPG_GAMECORE_ROGUEFORMULACONDITIONCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1761EC50)
