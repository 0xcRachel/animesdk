...
#define RPG_GAMECORE_REMOVESELFMODIFIER_METHOD_3_28C656195331A15C_OFFSET UNITYSDK_OFFSET(0x175ADCD0)
#define RPG_GAMECORE_REMOVESELFMODIFIER_METHOD_3_E5B1454E9F2BCF10_OFFSET UNITYSDK_OFFSET(0x175ADBC0)
#define RPG_GAMECORE_REMOVESELFMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x175ADCA0)
