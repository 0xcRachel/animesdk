...
#define RPG_GAMECORE_SETAVATARGLOBALBUFFSTATE_METHOD_3_80EEA91EA1AC25F7_OFFSET UNITYSDK_OFFSET(0x192EDD80)
#define RPG_GAMECORE_SETAVATARGLOBALBUFFSTATE_METHOD_3_8438FE30B97B73AF_OFFSET UNITYSDK_OFFSET(0x192EDC60)
#define RPG_GAMECORE_SETAVATARGLOBALBUFFSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x192EDD00)
