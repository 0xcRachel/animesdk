...
#define RPG_GAMECORE_FIXPOINTLINQEXT_AVERAGEFP_1_OFFSET UNITYSDK_OFFSET(0x179EA5D0)
#define RPG_GAMECORE_FIXPOINTLINQEXT_AVERAGEFP_OFFSET UNITYSDK_OFFSET(0x179EA110)
#define RPG_GAMECORE_FIXPOINTLINQEXT_SUMFP_1_OFFSET UNITYSDK_OFFSET(0x179E9D70)
#define RPG_GAMECORE_FIXPOINTLINQEXT_SUMFP_OFFSET UNITYSDK_OFFSET(0x179E9A00)
