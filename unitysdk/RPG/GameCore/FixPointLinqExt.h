...
#define RPG_GAMECORE_FIXPOINTLINQEXT_AVERAGEFP_1_OFFSET UNITYSDK_OFFSET(0x1722EAA0)
#define RPG_GAMECORE_FIXPOINTLINQEXT_AVERAGEFP_OFFSET UNITYSDK_OFFSET(0x1722E5E0)
#define RPG_GAMECORE_FIXPOINTLINQEXT_SUMFP_1_OFFSET UNITYSDK_OFFSET(0x1722E240)
#define RPG_GAMECORE_FIXPOINTLINQEXT_SUMFP_OFFSET UNITYSDK_OFFSET(0x1722DED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FixPointLinqExt_TypeDefinitionIndex = 8828;
