...
#define RPG_GAMECORE_SETMODIFIERVALUE_METHOD_3_05EC4C4921479655_OFFSET UNITYSDK_OFFSET(0x176EACB0)
#define RPG_GAMECORE_SETMODIFIERVALUE_METHOD_3_A58B952626E1F0F7_OFFSET UNITYSDK_OFFSET(0x176EABC0)
#define RPG_GAMECORE_SETMODIFIERVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x176EAC00)
