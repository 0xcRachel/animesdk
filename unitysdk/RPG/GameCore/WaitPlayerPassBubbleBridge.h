...
#define RPG_GAMECORE_WAITPLAYERPASSBUBBLEBRIDGE_METHOD_4_4382FB9462241000_OFFSET UNITYSDK_OFFSET(0x17158380)
#define RPG_GAMECORE_WAITPLAYERPASSBUBBLEBRIDGE_METHOD_4_CD6C014C622438B8_OFFSET UNITYSDK_OFFSET(0x17158460)
#define RPG_GAMECORE_WAITPLAYERPASSBUBBLEBRIDGE__CTOR_OFFSET UNITYSDK_OFFSET(0x17158400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitPlayerPassBubbleBridge_TypeDefinitionIndex = 19963;
