...
#define RPG_GAMECORE_TARGETFETCHADVLOCALPLAYER_METHOD_4_DCE672916A3BF661_OFFSET UNITYSDK_OFFSET(0x16FD1C10)
#define RPG_GAMECORE_TARGETFETCHADVLOCALPLAYER_METHOD_4_E36A00312068E38B_OFFSET UNITYSDK_OFFSET(0x16FDAA50)
#define RPG_GAMECORE_TARGETFETCHADVLOCALPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD1BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAdvLocalPlayer_TypeDefinitionIndex = 21566;
