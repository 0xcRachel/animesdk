...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::EntityTag>**)Il2CppClass::FromTypeDefinitionIndex(AdventureCharacterConfig___O_TypeDefinitionIndex)->GetStaticField(0x8F30);
		}
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::AdventureModifierBehaviorFlag>**)Il2CppClass::FromTypeDefinitionIndex(AdventureCharacterConfig___O_TypeDefinitionIndex)->GetStaticField(0x8F38);
		}
	};
}
