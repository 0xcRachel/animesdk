...
#define RPG_GAMECORE_LOADINGSTRATAGECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16BD7660)
#define RPG_GAMECORE_LOADINGSTRATAGECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16BD7900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoadingStratageConfigRow_TypeDefinitionIndex = 12713;
