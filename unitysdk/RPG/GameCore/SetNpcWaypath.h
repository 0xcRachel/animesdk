...
#define RPG_GAMECORE_SETNPCWAYPATH_METHOD_3_CE6FAE50E9ADDBFF_OFFSET UNITYSDK_OFFSET(0x199C1410)
#define RPG_GAMECORE_SETNPCWAYPATH_METHOD_3_DC214FE941B4EF13_OFFSET UNITYSDK_OFFSET(0x199C1560)
#define RPG_GAMECORE_SETNPCWAYPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x199C14D0)
