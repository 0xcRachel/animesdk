...
#define RPG_GAMECORE_SETNPCWAYPATH_METHOD_3_CE6FAE50E9ADDBFF_OFFSET UNITYSDK_OFFSET(0x1A797BB0)
#define RPG_GAMECORE_SETNPCWAYPATH_METHOD_3_DC214FE941B4EF13_OFFSET UNITYSDK_OFFSET(0x1A797D00)
#define RPG_GAMECORE_SETNPCWAYPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1A797C70)
