...
#define RPG_GAMECORE_ST_BYHASPATROLPATH_METHOD_4_4EF75EE25923E29B_OFFSET UNITYSDK_OFFSET(0x176A7FB0)
#define RPG_GAMECORE_ST_BYHASPATROLPATH_METHOD_4_EEA1B1E98F2EBAF1_OFFSET UNITYSDK_OFFSET(0x176A8080)
#define RPG_GAMECORE_ST_BYHASPATROLPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x176A8030)
