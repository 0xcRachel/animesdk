...
#define RPG_GAMECORE_BLINKTOPOSITION_METHOD_3_49F56242224536BA_OFFSET UNITYSDK_OFFSET(0x168EAEF0)
#define RPG_GAMECORE_BLINKTOPOSITION_METHOD_3_6DD9BBC870C213E1_OFFSET UNITYSDK_OFFSET(0x168EAE20)
#define RPG_GAMECORE_BLINKTOPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x168EAEA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BlinkToPosition_TypeDefinitionIndex = 20809;
