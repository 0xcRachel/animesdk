...
#define RPG_GAMECORE_PLAYERAPPLYINMAPTELEPORT_METHOD_3_1A765214F38C830A_OFFSET UNITYSDK_OFFSET(0x174EAAC0)
#define RPG_GAMECORE_PLAYERAPPLYINMAPTELEPORT_METHOD_3_F625B4DC032ED99E_OFFSET UNITYSDK_OFFSET(0x174EA9B0)
#define RPG_GAMECORE_PLAYERAPPLYINMAPTELEPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x174EAA90)
