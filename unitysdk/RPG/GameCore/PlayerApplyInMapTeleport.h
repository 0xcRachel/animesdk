...
#define RPG_GAMECORE_PLAYERAPPLYINMAPTELEPORT_METHOD_3_1A765214F38C830A_OFFSET UNITYSDK_OFFSET(0x16D642D0)
#define RPG_GAMECORE_PLAYERAPPLYINMAPTELEPORT_METHOD_3_F625B4DC032ED99E_OFFSET UNITYSDK_OFFSET(0x16D641C0)
#define RPG_GAMECORE_PLAYERAPPLYINMAPTELEPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x16D642A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayerApplyInMapTeleport_TypeDefinitionIndex = 18283;
