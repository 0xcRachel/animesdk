...
#define RPG_GAMECORE_PROPFASTDELIVERSWITCHTARGET_METHOD_3_6D2A1C4441C783F8_OFFSET UNITYSDK_OFFSET(0x16DABE00)
#define RPG_GAMECORE_PROPFASTDELIVERSWITCHTARGET_METHOD_3_F498F952F7FCA69A_OFFSET UNITYSDK_OFFSET(0x16DABF40)
#define RPG_GAMECORE_PROPFASTDELIVERSWITCHTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x16DABEB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropFastDeliverSwitchTarget_TypeDefinitionIndex = 19808;
