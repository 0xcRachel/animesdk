...
#define RPG_GAMECORE_UINOTIFYMONOPOLYEVENTSTART_METHOD_3_007D93F619EDE6F9_OFFSET UNITYSDK_OFFSET(0x19131170)
#define RPG_GAMECORE_UINOTIFYMONOPOLYEVENTSTART_METHOD_3_DFADBF672E579C6D_OFFSET UNITYSDK_OFFSET(0x19131280)
#define RPG_GAMECORE_UINOTIFYMONOPOLYEVENTSTART__CTOR_OFFSET UNITYSDK_OFFSET(0x19131250)
