...
#define RPG_GAMECORE_WAVEMONSTER_METHOD_3_9ECB7B60956F1A5F_OFFSET UNITYSDK_OFFSET(0x17160E70)
#define RPG_GAMECORE_WAVEMONSTER_METHOD_3_A404C235E773EB30_OFFSET UNITYSDK_OFFSET(0x17160D40)
#define RPG_GAMECORE_WAVEMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x17160DF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaveMonster_TypeDefinitionIndex = 21067;
