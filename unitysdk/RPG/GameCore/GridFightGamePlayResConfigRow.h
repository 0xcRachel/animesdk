...
#define RPG_GAMECORE_GRIDFIGHTGAMEPLAYRESCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B26110)
#define RPG_GAMECORE_GRIDFIGHTGAMEPLAYRESCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B262D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightGamePlayResConfigRow_TypeDefinitionIndex = 12232;
