...
#define RPG_GAMECORE_FOURROTATEVOXELANIMALATTACHBILLBOARDCONFIG_METHOD_3_44E258685273316C_OFFSET UNITYSDK_OFFSET(0x16AE2FC0)
#define RPG_GAMECORE_FOURROTATEVOXELANIMALATTACHBILLBOARDCONFIG_METHOD_3_795170A1E9531471_OFFSET UNITYSDK_OFFSET(0x16AE2F50)
#define RPG_GAMECORE_FOURROTATEVOXELANIMALATTACHBILLBOARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16AE2FA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxelAnimalAttachBillboardConfig_TypeDefinitionIndex = 15109;
