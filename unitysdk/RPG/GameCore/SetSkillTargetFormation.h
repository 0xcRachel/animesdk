...
#define RPG_GAMECORE_SETSKILLTARGETFORMATION_METHOD_3_613B037FE6B31A8A_OFFSET UNITYSDK_OFFSET(0x16F3CEF0)
#define RPG_GAMECORE_SETSKILLTARGETFORMATION_METHOD_3_99C9F1B17F962EE0_OFFSET UNITYSDK_OFFSET(0x16F3CE20)
#define RPG_GAMECORE_SETSKILLTARGETFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x16F3CEA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetSkillTargetFormation_TypeDefinitionIndex = 20137;
