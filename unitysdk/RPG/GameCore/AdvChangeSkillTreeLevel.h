...
#define RPG_GAMECORE_ADVCHANGESKILLTREELEVEL_METHOD_3_0E6B8BCC6D64CFFC_OFFSET UNITYSDK_OFFSET(0x1955D290)
#define RPG_GAMECORE_ADVCHANGESKILLTREELEVEL_METHOD_3_B1B3B1B66E39E3E3_OFFSET UNITYSDK_OFFSET(0x1955D300)
#define RPG_GAMECORE_ADVCHANGESKILLTREELEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1955D2D0)
