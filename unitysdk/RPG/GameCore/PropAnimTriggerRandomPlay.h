...
#define RPG_GAMECORE_PROPANIMTRIGGERRANDOMPLAY_METHOD_3_996AC7CCE23F15E8_OFFSET UNITYSDK_OFFSET(0x16DA2C00)
#define RPG_GAMECORE_PROPANIMTRIGGERRANDOMPLAY_METHOD_3_EB3462AAE55C026D_OFFSET UNITYSDK_OFFSET(0x16DA2AB0)
#define RPG_GAMECORE_PROPANIMTRIGGERRANDOMPLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x16DA2B70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropAnimTriggerRandomPlay_TypeDefinitionIndex = 19899;
