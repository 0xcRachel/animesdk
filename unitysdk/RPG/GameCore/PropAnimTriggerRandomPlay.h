...
#define RPG_GAMECORE_PROPANIMTRIGGERRANDOMPLAY_METHOD_3_996AC7CCE23F15E8_OFFSET UNITYSDK_OFFSET(0x17529D50)
#define RPG_GAMECORE_PROPANIMTRIGGERRANDOMPLAY_METHOD_3_EB3462AAE55C026D_OFFSET UNITYSDK_OFFSET(0x17529C00)
#define RPG_GAMECORE_PROPANIMTRIGGERRANDOMPLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x17529CC0)
