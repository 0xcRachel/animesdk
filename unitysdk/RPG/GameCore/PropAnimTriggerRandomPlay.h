...
#define RPG_GAMECORE_PROPANIMTRIGGERRANDOMPLAY_METHOD_3_996AC7CCE23F15E8_OFFSET UNITYSDK_OFFSET(0x191BCD80)
#define RPG_GAMECORE_PROPANIMTRIGGERRANDOMPLAY_METHOD_3_EB3462AAE55C026D_OFFSET UNITYSDK_OFFSET(0x191BCC30)
#define RPG_GAMECORE_PROPANIMTRIGGERRANDOMPLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x191BCCF0)
