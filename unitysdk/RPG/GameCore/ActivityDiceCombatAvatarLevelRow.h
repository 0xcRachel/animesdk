...
#define RPG_GAMECORE_ACTIVITYDICECOMBATAVATARLEVELROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18869D90)
#define RPG_GAMECORE_ACTIVITYDICECOMBATAVATARLEVELROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1886A130)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::String* Dice2FramePath; // 0x10
		::System::String* SideUI3DMatPath; // 0x18
		...
		::System::String* Dice4FramePath; // 0x40
		::System::String* Dice1FramePathUI3D; // 0x48
		::System::String* Dice4FramePathUI3D; // 0x50
		::System::String* Dice2FramePathUI3D; // 0x58
