...
#define RPG_GAMECORE_BASELITTLEGAMEABILITYEFFECTCONFIG_METHOD_2_4C82FBED36025703_OFFSET UNITYSDK_OFFSET(0x17657D80)
#define RPG_GAMECORE_BASELITTLEGAMEABILITYEFFECTCONFIG_METHOD_2_CB1CEE99748FF125_OFFSET UNITYSDK_OFFSET(0x17657320)
#define RPG_GAMECORE_BASELITTLEGAMEABILITYEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17657DE0)
