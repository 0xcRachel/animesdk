...
#define RPG_GAMECORE_CREATEBATTLEEVENTFROMGRIDFIGHTBACKEND_METHOD_4_1064A55224404902_OFFSET UNITYSDK_OFFSET(0x169D2F00)
#define RPG_GAMECORE_CREATEBATTLEEVENTFROMGRIDFIGHTBACKEND_METHOD_4_72086B7FCC7551F4_OFFSET UNITYSDK_OFFSET(0x169D2880)
#define RPG_GAMECORE_CREATEBATTLEEVENTFROMGRIDFIGHTBACKEND__CTOR_OFFSET UNITYSDK_OFFSET(0x169D2840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateBattleEventFromGridFightBackend_TypeDefinitionIndex = 21096;
