...
#define RPG_GAMECORE_FATEPARAMBATTLESERIESWINCOUNTCONFIG_METHOD_6_75CF3E7DA5D5A763_OFFSET UNITYSDK_OFFSET(0x19478920)
#define RPG_GAMECORE_FATEPARAMBATTLESERIESWINCOUNTCONFIG_METHOD_6_E4F9EB737152113F_OFFSET UNITYSDK_OFFSET(0x19478760)
#define RPG_GAMECORE_FATEPARAMBATTLESERIESWINCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19478860)
