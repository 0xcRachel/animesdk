...
#define RPG_GAMECORE_SETDYNAMICVALUEBYITEMNUMPARAM_METHOD_4_853D82E25B33941F_OFFSET UNITYSDK_OFFSET(0x16F245B0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYITEMNUMPARAM_METHOD_4_FB15AC8F7BFF8C8F_OFFSET UNITYSDK_OFFSET(0x16F24520)
#define RPG_GAMECORE_SETDYNAMICVALUEBYITEMNUMPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x16F24580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByItemNumParam_TypeDefinitionIndex = 19408;
