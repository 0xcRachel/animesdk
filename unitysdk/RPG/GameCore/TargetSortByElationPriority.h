...
#define RPG_GAMECORE_TARGETSORTBYELATIONPRIORITY_METHOD_3_7091B1B126BF7451_OFFSET UNITYSDK_OFFSET(0x17135640)
#define RPG_GAMECORE_TARGETSORTBYELATIONPRIORITY_METHOD_3_7769C90CF6BFB3F8_OFFSET UNITYSDK_OFFSET(0x17133860)
#define RPG_GAMECORE_TARGETSORTBYELATIONPRIORITY__CTOR_OFFSET UNITYSDK_OFFSET(0x17133840)
