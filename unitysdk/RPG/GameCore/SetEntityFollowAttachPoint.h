...
#define RPG_GAMECORE_SETENTITYFOLLOWATTACHPOINT_METHOD_3_BEAADE656044253A_OFFSET UNITYSDK_OFFSET(0x199B2260)
#define RPG_GAMECORE_SETENTITYFOLLOWATTACHPOINT_METHOD_3_EF1D1D8404074EF0_OFFSET UNITYSDK_OFFSET(0x199B21D0)
#define RPG_GAMECORE_SETENTITYFOLLOWATTACHPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x199B2230)
