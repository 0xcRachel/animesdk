...
#define RPG_GAMECORE_AVATARLINKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x168A8820)
#define RPG_GAMECORE_AVATARLINKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x168A8940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarLinkRow_TypeDefinitionIndex = 11613;
