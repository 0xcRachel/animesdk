...
#define RPG_GAMECORE_SELECTAISKILLTARGET_METHOD_3_CD2CF031EB10658F_OFFSET UNITYSDK_OFFSET(0x16EFD5B0)
#define RPG_GAMECORE_SELECTAISKILLTARGET_METHOD_3_D21981C8B8A58042_OFFSET UNITYSDK_OFFSET(0x16EFD530)
#define RPG_GAMECORE_SELECTAISKILLTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x16EFD580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SelectAISkillTarget_TypeDefinitionIndex = 20088;
