...
#define RPG_GAMECORE_MODIFYADDMODIFIERBINDVALUE_METHOD_3_06CD0F273186D37A_OFFSET UNITYSDK_OFFSET(0x16CB7780)
#define RPG_GAMECORE_MODIFYADDMODIFIERBINDVALUE_METHOD_3_5DBB022CEBFBEF6E_OFFSET UNITYSDK_OFFSET(0x16CB7800)
#define RPG_GAMECORE_MODIFYADDMODIFIERBINDVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x16CB77D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyAddModifierBindValue_TypeDefinitionIndex = 21400;
