...
#define RPG_GAMECORE_ST_MAIN_FOLLOWTARGET_METHOD_4_6473A1BF3F103276_OFFSET UNITYSDK_OFFSET(0x16EE2260)
#define RPG_GAMECORE_ST_MAIN_FOLLOWTARGET_METHOD_4_86B246024D6F40AF_OFFSET UNITYSDK_OFFSET(0x16EF6B60)
#define RPG_GAMECORE_ST_MAIN_FOLLOWTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x16EE21C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_FollowTarget_TypeDefinitionIndex = 17895;
