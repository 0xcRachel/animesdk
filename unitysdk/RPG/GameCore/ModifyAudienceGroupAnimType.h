...
#define RPG_GAMECORE_MODIFYAUDIENCEGROUPANIMTYPE_METHOD_3_D4B6DC0477BD9835_OFFSET UNITYSDK_OFFSET(0x196A6FF0)
#define RPG_GAMECORE_MODIFYAUDIENCEGROUPANIMTYPE_METHOD_3_E86078588929FD64_OFFSET UNITYSDK_OFFSET(0x196A6F70)
#define RPG_GAMECORE_MODIFYAUDIENCEGROUPANIMTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x196A6FC0)
