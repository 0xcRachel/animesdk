...
#define RPG_GAMECORE_WOLFBROPICKUPBULLET_METHOD_3_8584C94687BA448E_OFFSET UNITYSDK_OFFSET(0x1A65BE90)
#define RPG_GAMECORE_WOLFBROPICKUPBULLET_METHOD_3_C4455067C5B7DCC2_OFFSET UNITYSDK_OFFSET(0x1A65BD80)
#define RPG_GAMECORE_WOLFBROPICKUPBULLET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A65BE60)
