...
#define RPG_GAMECORE_ROGUEDLCAEONTALENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1760A0E0)
#define RPG_GAMECORE_ROGUEDLCAEONTALENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1760A940)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 UnlockAeonDimensionPoint; // 0x40
		::System::UInt32 AeonDimensionID; // 0x44
