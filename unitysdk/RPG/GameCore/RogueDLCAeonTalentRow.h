...
#define RPG_GAMECORE_ROGUEDLCAEONTALENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19254670)
#define RPG_GAMECORE_ROGUEDLCAEONTALENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19254E90)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean IsImportant; // 0x2C
