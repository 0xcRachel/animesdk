...
#define RPG_GAMECORE_ROGUEDLCAEONTALENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16E6ABA0)
#define RPG_GAMECORE_ROGUEDLCAEONTALENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16E6B400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDLCAeonTalentRow_TypeDefinitionIndex = 13401;
