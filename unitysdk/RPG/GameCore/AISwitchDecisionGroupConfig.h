...
#define RPG_GAMECORE_AISWITCHDECISIONGROUPCONFIG_METHOD_4_A1490A35DCAFE8EA_OFFSET UNITYSDK_OFFSET(0x16772020)
#define RPG_GAMECORE_AISWITCHDECISIONGROUPCONFIG_METHOD_4_D1F5B122C5EE6849_OFFSET UNITYSDK_OFFSET(0x1676FA60)
#define RPG_GAMECORE_AISWITCHDECISIONGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1676FA50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AISwitchDecisionGroupConfig_TypeDefinitionIndex = 14067;
