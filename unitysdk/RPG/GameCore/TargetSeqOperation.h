...
#define RPG_GAMECORE_TARGETSEQOPERATION_METHOD_2_117856C3404BBC11_OFFSET UNITYSDK_OFFSET(0x16FE4820)
#define RPG_GAMECORE_TARGETSEQOPERATION_METHOD_2_9C4C5D2174678974_OFFSET UNITYSDK_OFFSET(0x16FE49A0)
#define RPG_GAMECORE_TARGETSEQOPERATION__CCTOR_OFFSET UNITYSDK_OFFSET(0x16FE4A00)
#define RPG_GAMECORE_TARGETSEQOPERATION__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE0540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSeqOperation_TypeDefinitionIndex = 21454;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Func_2<::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::TargetSeqOperation*>*>**)Il2CppClass::FromTypeDefinitionIndex(TargetSeqOperation_TypeDefinitionIndex)->GetStaticField(0x15D60);
		}
