...
#define RPG_GAMECORE_TARGETSEQOPERATION_METHOD_2_117856C3404BBC11_OFFSET UNITYSDK_OFFSET(0x177D91B0)
#define RPG_GAMECORE_TARGETSEQOPERATION_METHOD_2_9C4C5D2174678974_OFFSET UNITYSDK_OFFSET(0x177D9330)
#define RPG_GAMECORE_TARGETSEQOPERATION__CCTOR_OFFSET UNITYSDK_OFFSET(0x177D9390)
#define RPG_GAMECORE_TARGETSEQOPERATION__CTOR_OFFSET UNITYSDK_OFFSET(0x177CEA20)
...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Func_2<::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::TargetSeqOperation*>*>**)Il2CppClass::FromTypeDefinitionIndex(TargetSeqOperation_TypeDefinitionIndex)->GetStaticField(0x167A0);
		}
