...
#define RPG_GAMECORE_ROGUETOURNTITANTALENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1940B540)
#define RPG_GAMECORE_ROGUETOURNTITANTALENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1940B9C0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 PreID; // 0x34
		::RPG::Client::TextID TalentTitle; // 0x38
