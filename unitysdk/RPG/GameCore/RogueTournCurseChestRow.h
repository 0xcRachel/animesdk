...
#define RPG_GAMECORE_ROGUETOURNCURSECHESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19401330)
#define RPG_GAMECORE_ROGUETOURNCURSECHESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19401C70)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::FixPoint ParamValue4; // 0x28
		::System::UInt32 ChestID; // 0x30
		...
		::System::UInt32 SubTitleDisplayID; // 0x4C
