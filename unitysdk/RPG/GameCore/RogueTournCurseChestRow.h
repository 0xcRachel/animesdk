...
#define RPG_GAMECORE_ROGUETOURNCURSECHESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16EC44E0)
#define RPG_GAMECORE_ROGUETOURNCURSECHESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16EC4E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournCurseChestRow_TypeDefinitionIndex = 13690;
	...
	public:
		...
		::RPG::GameCore::RogueTournCurseChestType Type; // 0x20
		::System::UInt32 SubDescDisplayID; // 0x24
		::RPG::GameCore::FixPoint ParamValue3; // 0x28
		::RPG::GameCore::FixPoint ParamValue4; // 0x30
		::System::UInt32 ChestID; // 0x38
		::System::UInt32 SubTitleDisplayID; // 0x3C
		::System::UInt32 MainTitleDisplayID; // 0x40
		::System::UInt32 MainDescDisplayID; // 0x44
