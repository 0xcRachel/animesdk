...
#define RPG_GAMECORE_ROGUETOURNCURSECHESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x176783A0)
#define RPG_GAMECORE_ROGUETOURNCURSECHESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17678CC0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::FixPoint ParamValue3; // 0x20
		::RPG::GameCore::FixPoint ParamValue1; // 0x28
		::RPG::GameCore::FixPoint ParamValue2; // 0x30
		::System::UInt32 SubDescDisplayID; // 0x38
		::System::UInt32 MainTitleDisplayID; // 0x3C
		::System::UInt32 ChestID; // 0x40
		::System::UInt32 MainDescDisplayID; // 0x44
		::System::UInt32 SubTitleDisplayID; // 0x48
