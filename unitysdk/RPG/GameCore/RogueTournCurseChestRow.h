...
#define RPG_GAMECORE_ROGUETOURNCURSECHESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1982F4F0)
#define RPG_GAMECORE_ROGUETOURNCURSECHESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1982FE10)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 MainDescDisplayID; // 0x18
		::System::UInt32 MainTitleDisplayID; // 0x1C
		::RPG::GameCore::FixPoint ParamValue4; // 0x20
		::RPG::GameCore::FixPoint ParamValue1; // 0x28
		::System::UInt32 SubTitleDisplayID; // 0x30
		::RPG::GameCore::RogueTournCurseChestType Type; // 0x34
		::RPG::GameCore::FixPoint ParamValue2; // 0x38
