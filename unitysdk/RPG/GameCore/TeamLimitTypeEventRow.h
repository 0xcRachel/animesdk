...
#define RPG_GAMECORE_TEAMLIMITTYPEEVENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x170EBF90)
#define RPG_GAMECORE_TEAMLIMITTYPEEVENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x170EC1B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TeamLimitTypeEventRow_TypeDefinitionIndex = 13886;
