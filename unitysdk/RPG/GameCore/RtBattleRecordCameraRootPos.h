...
#define RPG_GAMECORE_RTBATTLERECORDCAMERAROOTPOS_METHOD_3_A655450F3BCD76C1_OFFSET UNITYSDK_OFFSET(0x19417760)
#define RPG_GAMECORE_RTBATTLERECORDCAMERAROOTPOS_METHOD_3_B14D4A871359181A_OFFSET UNITYSDK_OFFSET(0x19417840)
#define RPG_GAMECORE_RTBATTLERECORDCAMERAROOTPOS__CTOR_OFFSET UNITYSDK_OFFSET(0x194177E0)
