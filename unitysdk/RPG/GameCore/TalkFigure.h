...
#define RPG_GAMECORE_TALKFIGURE_METHOD_3_30A0D11E6A19258B_OFFSET UNITYSDK_OFFSET(0x16FC8670)
#define RPG_GAMECORE_TALKFIGURE_METHOD_3_BE14FAAD6545BAC6_OFFSET UNITYSDK_OFFSET(0x16FC85D0)
#define RPG_GAMECORE_TALKFIGURE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FC8630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TalkFigure_TypeDefinitionIndex = 19568;
