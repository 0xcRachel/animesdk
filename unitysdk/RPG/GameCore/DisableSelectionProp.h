...
#define RPG_GAMECORE_DISABLESELECTIONPROP_METHOD_3_015B6A38CC85D217_OFFSET UNITYSDK_OFFSET(0x1A0A2740)
#define RPG_GAMECORE_DISABLESELECTIONPROP_METHOD_3_7769F819DE2D2659_OFFSET UNITYSDK_OFFSET(0x1A0A2890)
#define RPG_GAMECORE_DISABLESELECTIONPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0A2800)
