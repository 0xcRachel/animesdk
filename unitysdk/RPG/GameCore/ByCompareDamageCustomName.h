...
#define RPG_GAMECORE_BYCOMPAREDAMAGECUSTOMNAME_METHOD_4_0080AFBAC3676109_OFFSET UNITYSDK_OFFSET(0x1701ADF0)
#define RPG_GAMECORE_BYCOMPAREDAMAGECUSTOMNAME_METHOD_4_0115E19352855FC7_OFFSET UNITYSDK_OFFSET(0x1701AEC0)
#define RPG_GAMECORE_BYCOMPAREDAMAGECUSTOMNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1701AE70)
