...
#define RPG_GAMECORE_BYCOMPAREDAMAGECUSTOMNAME_METHOD_4_0080AFBAC3676109_OFFSET UNITYSDK_OFFSET(0x16909FC0)
#define RPG_GAMECORE_BYCOMPAREDAMAGECUSTOMNAME_METHOD_4_0115E19352855FC7_OFFSET UNITYSDK_OFFSET(0x1690A090)
#define RPG_GAMECORE_BYCOMPAREDAMAGECUSTOMNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1690A040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareDamageCustomName_TypeDefinitionIndex = 21248;
