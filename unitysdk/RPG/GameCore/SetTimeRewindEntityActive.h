...
#define RPG_GAMECORE_SETTIMEREWINDENTITYACTIVE_METHOD_3_1975C5DAE9BE3B75_OFFSET UNITYSDK_OFFSET(0x19391600)
#define RPG_GAMECORE_SETTIMEREWINDENTITYACTIVE_METHOD_3_CBE79FEED89D21B9_OFFSET UNITYSDK_OFFSET(0x19391580)
#define RPG_GAMECORE_SETTIMEREWINDENTITYACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x193915D0)
