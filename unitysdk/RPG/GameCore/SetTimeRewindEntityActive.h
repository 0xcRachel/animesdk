...
#define RPG_GAMECORE_SETTIMEREWINDENTITYACTIVE_METHOD_3_1975C5DAE9BE3B75_OFFSET UNITYSDK_OFFSET(0x16F436E0)
#define RPG_GAMECORE_SETTIMEREWINDENTITYACTIVE_METHOD_3_CBE79FEED89D21B9_OFFSET UNITYSDK_OFFSET(0x16F43660)
#define RPG_GAMECORE_SETTIMEREWINDENTITYACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F436B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTimeRewindEntityActive_TypeDefinitionIndex = 18477;
