...
#define RPG_GAMECORE_SETTIMEREWINDENTITYACTIVE_METHOD_3_1975C5DAE9BE3B75_OFFSET UNITYSDK_OFFSET(0x1A7A1BC0)
#define RPG_GAMECORE_SETTIMEREWINDENTITYACTIVE_METHOD_3_CBE79FEED89D21B9_OFFSET UNITYSDK_OFFSET(0x1A7A1B40)
#define RPG_GAMECORE_SETTIMEREWINDENTITYACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7A1B90)
