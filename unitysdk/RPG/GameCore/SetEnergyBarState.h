...
#define RPG_GAMECORE_SETENERGYBARSTATE_METHOD_3_2FFF4AA972C84BB1_OFFSET UNITYSDK_OFFSET(0x16F296E0)
#define RPG_GAMECORE_SETENERGYBARSTATE_METHOD_3_69FFF948B6EA4CA2_OFFSET UNITYSDK_OFFSET(0x16F29540)
#define RPG_GAMECORE_SETENERGYBARSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F29580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetEnergyBarState_TypeDefinitionIndex = 20381;
