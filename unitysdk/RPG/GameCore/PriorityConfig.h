...
#define RPG_GAMECORE_PRIORITYCONFIG_METHOD_2_011FAD9D6E19C54C_OFFSET UNITYSDK_OFFSET(0x17526A00)
#define RPG_GAMECORE_PRIORITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17526AD0)
