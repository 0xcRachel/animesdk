...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERDIFFERENTROLEMERGECONFIG_METHOD_3_04A054B02D9A3B20_OFFSET UNITYSDK_OFFSET(0x1957FFC0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERDIFFERENTROLEMERGECONFIG_METHOD_3_345BEDAF99AD96F9_OFFSET UNITYSDK_OFFSET(0x1957C690)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERDIFFERENTROLEMERGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1957C640)
