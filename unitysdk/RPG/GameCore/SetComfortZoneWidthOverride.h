...
#define RPG_GAMECORE_SETCOMFORTZONEWIDTHOVERRIDE_METHOD_3_4DE95D16849431B2_OFFSET UNITYSDK_OFFSET(0x176C4540)
#define RPG_GAMECORE_SETCOMFORTZONEWIDTHOVERRIDE_METHOD_3_795C312DE5F97499_OFFSET UNITYSDK_OFFSET(0x176C44C0)
#define RPG_GAMECORE_SETCOMFORTZONEWIDTHOVERRIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x176C4510)
