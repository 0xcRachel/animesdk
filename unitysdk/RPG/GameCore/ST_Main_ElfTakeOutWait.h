...
#define RPG_GAMECORE_ST_MAIN_ELFTAKEOUTWAIT_METHOD_4_011B2438C6A538B3_OFFSET UNITYSDK_OFFSET(0x17698110)
#define RPG_GAMECORE_ST_MAIN_ELFTAKEOUTWAIT_METHOD_4_180A7231BA83051C_OFFSET UNITYSDK_OFFSET(0x176AB450)
#define RPG_GAMECORE_ST_MAIN_ELFTAKEOUTWAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x176980C0)
