...
#define RPG_GAMECORE_ST_MAIN_ELFTAKEOUTWAIT_METHOD_4_011B2438C6A538B3_OFFSET UNITYSDK_OFFSET(0x1A169700)
#define RPG_GAMECORE_ST_MAIN_ELFTAKEOUTWAIT_METHOD_4_180A7231BA83051C_OFFSET UNITYSDK_OFFSET(0x1A180C10)
#define RPG_GAMECORE_ST_MAIN_ELFTAKEOUTWAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1696B0)
