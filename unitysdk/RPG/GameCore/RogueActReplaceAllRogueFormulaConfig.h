...
#define RPG_GAMECORE_ROGUEACTREPLACEALLROGUEFORMULACONFIG_METHOD_6_37073C64623A3C22_OFFSET UNITYSDK_OFFSET(0x1A9B4740)
#define RPG_GAMECORE_ROGUEACTREPLACEALLROGUEFORMULACONFIG_METHOD_6_5E9F3B7D68F5EDC7_OFFSET UNITYSDK_OFFSET(0x1A9B4960)
#define RPG_GAMECORE_ROGUEACTREPLACEALLROGUEFORMULACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9B4880)
