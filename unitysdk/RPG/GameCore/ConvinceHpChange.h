...
#define RPG_GAMECORE_CONVINCEHPCHANGE_METHOD_3_41403969C121FA1C_OFFSET UNITYSDK_OFFSET(0x169CEDF0)
#define RPG_GAMECORE_CONVINCEHPCHANGE_METHOD_3_E67577D54C177CBD_OFFSET UNITYSDK_OFFSET(0x169CEE70)
#define RPG_GAMECORE_CONVINCEHPCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x169CEE40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConvinceHpChange_TypeDefinitionIndex = 19476;
