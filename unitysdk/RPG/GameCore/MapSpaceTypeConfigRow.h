...
#define RPG_GAMECORE_MAPSPACETYPECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16C327D0)
#define RPG_GAMECORE_MAPSPACETYPECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16C32E30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MapSpaceTypeConfigRow_TypeDefinitionIndex = 12727;
