...
#define RPG_GAMECORE_MARBLEMATCHINFOCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18C17500)
#define RPG_GAMECORE_MARBLEMATCHINFOCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18C17E90)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 PlayerID; // 0x28
		::System::UInt32 Round; // 0x2C
		::System::UInt32 AIRank; // 0x30
		::System::UInt32 CustomID; // 0x34
		::RPG::GameCore::MarblePhaseType PhaseID; // 0x38
		::System::UInt32 FirstType; // 0x3C
		::System::UInt32 Reward; // 0x40
		::System::UInt32 CanGoMatchSubMission; // 0x44
