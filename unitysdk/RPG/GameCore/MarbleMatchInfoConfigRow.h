...
#define RPG_GAMECORE_MARBLEMATCHINFOCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19C39F30)
#define RPG_GAMECORE_MARBLEMATCHINFOCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19C3A890)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 AIRank; // 0x28
		::System::UInt32 FirstType; // 0x2C
		::System::UInt32 ID; // 0x30
		::System::UInt32 PerformanceID; // 0x34
		::System::UInt32 CustomID; // 0x38
		::System::UInt32 LevelID; // 0x3C
		::System::UInt32 CanGoMatchSubMission; // 0x40
		::System::UInt32 Round; // 0x44
		::System::UInt32 PlayerID; // 0x48
