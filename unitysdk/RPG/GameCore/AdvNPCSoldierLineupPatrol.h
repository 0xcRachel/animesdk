...
#define RPG_GAMECORE_ADVNPCSOLDIERLINEUPPATROL_METHOD_3_3B9398D5AB6CBD28_OFFSET UNITYSDK_OFFSET(0x19BE7A90)
#define RPG_GAMECORE_ADVNPCSOLDIERLINEUPPATROL_METHOD_3_905B2F74C0AAF014_OFFSET UNITYSDK_OFFSET(0x19BE7BA0)
#define RPG_GAMECORE_ADVNPCSOLDIERLINEUPPATROL__CTOR_OFFSET UNITYSDK_OFFSET(0x19BE7B70)
