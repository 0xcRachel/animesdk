...
#define RPG_GAMECORE_WAITUINODEOPEN_METHOD_3_0A5C1425CC565074_OFFSET UNITYSDK_OFFSET(0x1791C560)
#define RPG_GAMECORE_WAITUINODEOPEN_METHOD_3_19CDAE212FA62D56_OFFSET UNITYSDK_OFFSET(0x1791C5E0)
#define RPG_GAMECORE_WAITUINODEOPEN__CTOR_OFFSET UNITYSDK_OFFSET(0x1791C5B0)
