...
#define RPG_GAMECORE_BYISCURRENTSKILLALLOWMULTITARGET_METHOD_4_191C2F1F7FBAA480_OFFSET UNITYSDK_OFFSET(0x19DA1B40)
#define RPG_GAMECORE_BYISCURRENTSKILLALLOWMULTITARGET_METHOD_4_8853CDAC096C4B7D_OFFSET UNITYSDK_OFFSET(0x19DA1CE0)
#define RPG_GAMECORE_BYISCURRENTSKILLALLOWMULTITARGET_METHOD_4_D8B0C9C596D22B49_OFFSET UNITYSDK_OFFSET(0x19DA1D60)
#define RPG_GAMECORE_BYISCURRENTSKILLALLOWMULTITARGET_METHOD_4_D960F9EAA73AF27E_OFFSET UNITYSDK_OFFSET(0x19DA1A70)
#define RPG_GAMECORE_BYISCURRENTSKILLALLOWMULTITARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x19DA1AF0)
