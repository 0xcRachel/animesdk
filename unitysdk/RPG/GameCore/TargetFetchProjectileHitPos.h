...
#define RPG_GAMECORE_TARGETFETCHPROJECTILEHITPOS_METHOD_4_8E33552671733EC8_OFFSET UNITYSDK_OFFSET(0x16FDEAC0)
#define RPG_GAMECORE_TARGETFETCHPROJECTILEHITPOS_METHOD_4_976A10E390C1EA5A_OFFSET UNITYSDK_OFFSET(0x16FD95A0)
#define RPG_GAMECORE_TARGETFETCHPROJECTILEHITPOS__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD9550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchProjectileHitPos_TypeDefinitionIndex = 21636;
