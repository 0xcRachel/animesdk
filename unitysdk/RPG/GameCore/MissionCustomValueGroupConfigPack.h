...
#define RPG_GAMECORE_MISSIONCUSTOMVALUEGROUPCONFIGPACK_METHOD_2_3EDC2E3ED5F89DBB_OFFSET UNITYSDK_OFFSET(0x1969C1D0)
#define RPG_GAMECORE_MISSIONCUSTOMVALUEGROUPCONFIGPACK_METHOD_2_C2C0AD4B578EB3BF_OFFSET UNITYSDK_OFFSET(0x1969C2A0)
#define RPG_GAMECORE_MISSIONCUSTOMVALUEGROUPCONFIGPACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1969C290)
