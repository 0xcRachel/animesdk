...
#define RPG_GAMECORE_SETTEXTJOINVALUE_METHOD_3_BE4C70C796BD237F_OFFSET UNITYSDK_OFFSET(0x19391150)
#define RPG_GAMECORE_SETTEXTJOINVALUE_METHOD_3_D35CB075C8E7E801_OFFSET UNITYSDK_OFFSET(0x193911D0)
#define RPG_GAMECORE_SETTEXTJOINVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x193911A0)
