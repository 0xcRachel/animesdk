...
#define RPG_GAMECORE_CREATEFMCHANNELRECEIVER_METHOD_3_3858AA5677DAA1C8_OFFSET UNITYSDK_OFFSET(0x18FAE7B0)
#define RPG_GAMECORE_CREATEFMCHANNELRECEIVER_METHOD_3_9AEA0244DAE4CE91_OFFSET UNITYSDK_OFFSET(0x18FAE730)
#define RPG_GAMECORE_CREATEFMCHANNELRECEIVER__CTOR_OFFSET UNITYSDK_OFFSET(0x18FAE780)
