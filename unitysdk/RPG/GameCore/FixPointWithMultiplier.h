...
#define RPG_GAMECORE_FIXPOINTWITHMULTIPLIER_COMPARETO_OFFSET UNITYSDK_OFFSET(0x20F1C30)
#define RPG_GAMECORE_FIXPOINTWITHMULTIPLIER_COMPRESS_1_OFFSET UNITYSDK_OFFSET(0x179EB1A0)
#define RPG_GAMECORE_FIXPOINTWITHMULTIPLIER_COMPRESS_OFFSET UNITYSDK_OFFSET(0x20F1D60)
#define RPG_GAMECORE_FIXPOINTWITHMULTIPLIER_GET_COMPRESSEDVALUE_OFFSET UNITYSDK_OFFSET(0x20F1D20)
#define RPG_GAMECORE_FIXPOINTWITHMULTIPLIER_GET_ISOVERFLOW_OFFSET UNITYSDK_OFFSET(0x20F1B00)
#define RPG_GAMECORE_FIXPOINTWITHMULTIPLIER_GET_SIGN_OFFSET UNITYSDK_OFFSET(0x20F1BF0)
#define RPG_GAMECORE_FIXPOINTWITHMULTIPLIER_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x179EAFE0)
#define RPG_GAMECORE_FIXPOINTWITHMULTIPLIER_OP_GREATERTHANOREQUAL_OFFSET UNITYSDK_OFFSET(0x179EAD10)
#define RPG_GAMECORE_FIXPOINTWITHMULTIPLIER_OP_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x179EAB40)
#define RPG_GAMECORE_FIXPOINTWITHMULTIPLIER_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x179EAB20)
#define RPG_GAMECORE_FIXPOINTWITHMULTIPLIER_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x179EB0B0)
#define RPG_GAMECORE_FIXPOINTWITHMULTIPLIER_OP_LESSTHANOREQUAL_OFFSET UNITYSDK_OFFSET(0x179EAEF0)
#define RPG_GAMECORE_FIXPOINTWITHMULTIPLIER_OP_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x179EAE00)
#define RPG_GAMECORE_FIXPOINTWITHMULTIPLIER_TOBIGFIXPOINT_OFFSET UNITYSDK_OFFSET(0x20F1D70)
#define RPG_GAMECORE_FIXPOINTWITHMULTIPLIER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x72D30)
#define RPG_GAMECORE_FIXPOINTWITHMULTIPLIER__CTOR_OFFSET UNITYSDK_OFFSET(0x20F1C20)
#define RPG_GAMECORE_FIXPOINTWITHMULTIPLIER__SINGOFFIXPOINT_OFFSET UNITYSDK_OFFSET(0x179EAAF0)
