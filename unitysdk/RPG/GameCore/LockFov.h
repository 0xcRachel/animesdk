...
#define RPG_GAMECORE_LOCKFOV_METHOD_3_708738909936C110_OFFSET UNITYSDK_OFFSET(0x19C136A0)
#define RPG_GAMECORE_LOCKFOV_METHOD_3_77C4B3EB03F0C0C9_OFFSET UNITYSDK_OFFSET(0x19C13620)
#define RPG_GAMECORE_LOCKFOV__CTOR_OFFSET UNITYSDK_OFFSET(0x19C13670)
