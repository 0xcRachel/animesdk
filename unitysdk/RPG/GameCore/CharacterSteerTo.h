...
#define RPG_GAMECORE_CHARACTERSTEERTO_METHOD_3_0E31B757DD6200F1_OFFSET UNITYSDK_OFFSET(0x16975F80)
#define RPG_GAMECORE_CHARACTERSTEERTO_METHOD_3_D0E703C6B254C72E_OFFSET UNITYSDK_OFFSET(0x16975EF0)
#define RPG_GAMECORE_CHARACTERSTEERTO__CTOR_OFFSET UNITYSDK_OFFSET(0x16975F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterSteerTo_TypeDefinitionIndex = 18674;
