...
#define RPG_GAMECORE_CHARACTERSTEERTO_METHOD_3_0E31B757DD6200F1_OFFSET UNITYSDK_OFFSET(0x1A147970)
#define RPG_GAMECORE_CHARACTERSTEERTO_METHOD_3_D0E703C6B254C72E_OFFSET UNITYSDK_OFFSET(0x1A1478E0)
#define RPG_GAMECORE_CHARACTERSTEERTO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A147940)
