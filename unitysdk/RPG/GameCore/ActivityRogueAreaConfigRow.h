...
#define RPG_GAMECORE_ACTIVITYROGUEAREACONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18DA8940)
#define RPG_GAMECORE_ACTIVITYROGUEAREACONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18DA9350)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* FigurePath2; // 0x18
		...
		::RPG::Client::TextID GamePlay_2; // 0x70
		::RPG::Client::TextID GamePlay_1; // 0x80
		::RPG::Client::TextID Endless_GamePlay; // 0x90
		::System::UInt32 ActivityModuleID; // 0xA0
		::System::UInt32 AreaID; // 0xA4
		::RPG::Client::TextID Describe; // 0xA8
		::System::UInt32 EventID; // 0xB8
		::System::UInt32 FloorID; // 0xBC
		::System::UInt32 DisplayMapID; // 0xC0
		::RPG::Client::TextID GamePlay_3; // 0xC8
		::System::UInt32 StageID; // 0xD8
		::System::UInt32 PlaneID; // 0xDC
		::System::UInt32 BattleAreaID; // 0xE0
		::System::UInt32 BattleAreaGroupID; // 0xE4
