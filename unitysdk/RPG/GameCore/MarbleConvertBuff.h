...
#define RPG_GAMECORE_MARBLECONVERTBUFF_METHOD_3_6119D693D1F853EA_OFFSET UNITYSDK_OFFSET(0x16C3C350)
#define RPG_GAMECORE_MARBLECONVERTBUFF_METHOD_3_E275F49EEBB31610_OFFSET UNITYSDK_OFFSET(0x16C3C270)
#define RPG_GAMECORE_MARBLECONVERTBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x16C3C300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleConvertBuff_TypeDefinitionIndex = 15161;
