...
#define RPG_GAMECORE_MUSICRHYTHMPHASEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16CF6B50)
#define RPG_GAMECORE_MUSICRHYTHMPHASEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16CF6DD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MusicRhythmPhaseRow_TypeDefinitionIndex = 12990;
	...
	public:
		...
		::System::UInt32 FinishMissionID; // 0x30
