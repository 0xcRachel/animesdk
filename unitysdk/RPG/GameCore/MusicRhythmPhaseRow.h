...
#define RPG_GAMECORE_MUSICRHYTHMPHASEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1747D370)
#define RPG_GAMECORE_MUSICRHYTHMPHASEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1747D5F0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 Phase; // 0x20
		::System::UInt32 SongID; // 0x24
		::System::UInt32 FinishMissionID; // 0x28
