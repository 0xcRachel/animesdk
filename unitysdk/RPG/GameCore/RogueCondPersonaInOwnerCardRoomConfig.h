...
#define RPG_GAMECORE_ROGUECONDPERSONAINOWNERCARDROOMCONFIG_METHOD_6_A3248E8F23B887FF_OFFSET UNITYSDK_OFFSET(0x19249670)
#define RPG_GAMECORE_ROGUECONDPERSONAINOWNERCARDROOMCONFIG_METHOD_6_E6EBCC91E6E4C6B9_OFFSET UNITYSDK_OFFSET(0x192493C0)
#define RPG_GAMECORE_ROGUECONDPERSONAINOWNERCARDROOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19249540)
