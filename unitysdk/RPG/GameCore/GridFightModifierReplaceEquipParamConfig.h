...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACEEQUIPPARAMCONFIG_METHOD_3_5332420CD254EFA0_OFFSET UNITYSDK_OFFSET(0x16B33B40)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACEEQUIPPARAMCONFIG_METHOD_3_82EDDB0C3E684B79_OFFSET UNITYSDK_OFFSET(0x16B2FF80)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACEEQUIPPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16B2FF30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierReplaceEquipParamConfig_TypeDefinitionIndex = 17389;
