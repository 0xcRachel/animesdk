...
#define RPG_GAMECORE_ADVENTUREBYNPCMONSTERPURPOSETYPE_METHOD_4_28048AB518F2CC5E_OFFSET UNITYSDK_OFFSET(0x16855680)
#define RPG_GAMECORE_ADVENTUREBYNPCMONSTERPURPOSETYPE_METHOD_4_E0913CDA9CD9579E_OFFSET UNITYSDK_OFFSET(0x168555B0)
#define RPG_GAMECORE_ADVENTUREBYNPCMONSTERPURPOSETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x16855630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureByNPCMonsterPurposeType_TypeDefinitionIndex = 17990;
