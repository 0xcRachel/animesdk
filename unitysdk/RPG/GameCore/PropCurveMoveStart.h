...
#define RPG_GAMECORE_PROPCURVEMOVESTART_METHOD_3_42DD3519273842F4_OFFSET UNITYSDK_OFFSET(0x16DA5540)
#define RPG_GAMECORE_PROPCURVEMOVESTART_METHOD_3_A1320943A61CB818_OFFSET UNITYSDK_OFFSET(0x16DA53A0)
#define RPG_GAMECORE_PROPCURVEMOVESTART__CTOR_OFFSET UNITYSDK_OFFSET(0x16DA53E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropCurveMoveStart_TypeDefinitionIndex = 18813;
