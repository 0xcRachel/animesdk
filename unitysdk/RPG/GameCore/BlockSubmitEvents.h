...
#define RPG_GAMECORE_BLOCKSUBMITEVENTS_METHOD_3_5DFE9CC7FDA56DA3_OFFSET UNITYSDK_OFFSET(0x168ECD60)
#define RPG_GAMECORE_BLOCKSUBMITEVENTS_METHOD_3_F81D693FEF74729A_OFFSET UNITYSDK_OFFSET(0x168ECDE0)
#define RPG_GAMECORE_BLOCKSUBMITEVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x168ECDB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BlockSubmitEvents_TypeDefinitionIndex = 21759;
