...
#define RPG_GAMECORE_BLOCKSUBMITEVENTS_METHOD_3_5DFE9CC7FDA56DA3_OFFSET UNITYSDK_OFFSET(0x16FFDB90)
#define RPG_GAMECORE_BLOCKSUBMITEVENTS_METHOD_3_F81D693FEF74729A_OFFSET UNITYSDK_OFFSET(0x16FFDC10)
#define RPG_GAMECORE_BLOCKSUBMITEVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x16FFDBE0)
