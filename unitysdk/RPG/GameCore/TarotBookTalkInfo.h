...
#define RPG_GAMECORE_TAROTBOOKTALKINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16FF64F0)
#define RPG_GAMECORE_TAROTBOOKTALKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16FF65B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TarotBookTalkInfo_TypeDefinitionIndex = 18921;
