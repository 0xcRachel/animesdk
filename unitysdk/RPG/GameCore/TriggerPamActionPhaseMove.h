...
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASEMOVE_METHOD_3_4DAF2A95A077F091_OFFSET UNITYSDK_OFFSET(0x17123710)
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASEMOVE_METHOD_3_9A6566183D8D61E5_OFFSET UNITYSDK_OFFSET(0x17123820)
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASEMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x171237F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerPamActionPhaseMove_TypeDefinitionIndex = 17787;
