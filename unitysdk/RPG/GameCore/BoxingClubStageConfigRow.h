...
#define RPG_GAMECORE_BOXINGCLUBSTAGECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x195EAED0)
#define RPG_GAMECORE_BOXINGCLUBSTAGECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x195EB700)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID BubbleTalkEnemy; // 0x30
