...
#define RPG_GAMECORE_LINEARPROJECTILEDATA_METHOD_3_6967E7B6B072D0A7_OFFSET UNITYSDK_OFFSET(0x16BC0DB0)
#define RPG_GAMECORE_LINEARPROJECTILEDATA_METHOD_3_FA596D0C7F873DEC_OFFSET UNITYSDK_OFFSET(0x16BC0ED0)
#define RPG_GAMECORE_LINEARPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16BC0E50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LinearProjectileData_TypeDefinitionIndex = 14236;
