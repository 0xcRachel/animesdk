...
#define RPG_GAMECORE_TRIGGERANIMSTATEWITHMOVE_METHOD_3_57B6CF32F17C97A6_OFFSET UNITYSDK_OFFSET(0x17117010)
#define RPG_GAMECORE_TRIGGERANIMSTATEWITHMOVE_METHOD_3_E8E42C7968867E18_OFFSET UNITYSDK_OFFSET(0x171172A0)
#define RPG_GAMECORE_TRIGGERANIMSTATEWITHMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x17117170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerAnimStateWithMove_TypeDefinitionIndex = 20112;
