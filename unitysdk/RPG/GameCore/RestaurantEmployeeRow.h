...
#define RPG_GAMECORE_RESTAURANTEMPLOYEEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A2F32B0)
#define RPG_GAMECORE_RESTAURANTEMPLOYEEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2F37C0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 BehaviorID; // 0x6C
		::System::UInt32 EmployeeID; // 0x70
		::System::UInt32 NPCID; // 0x74
