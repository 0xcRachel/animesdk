...
#define RPG_GAMECORE_RESTAURANTEMPLOYEEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x175B8950)
#define RPG_GAMECORE_RESTAURANTEMPLOYEEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x175B8E70)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 ConfigID; // 0x50
		::System::UInt32 NPCID; // 0x54
		::System::UInt32 GroupID; // 0x58
		::RPG::Client::TextID Detail; // 0x60
		::System::Boolean IsShow; // 0x70
		::System::UInt32 BehaviorID; // 0x74
