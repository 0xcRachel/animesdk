...
#define RPG_GAMECORE_TUTORIALCLICKBTN_METHOD_3_D1BADCDE0D187F51_OFFSET UNITYSDK_OFFSET(0x191276A0)
#define RPG_GAMECORE_TUTORIALCLICKBTN_METHOD_3_D892F439DD18BEF8_OFFSET UNITYSDK_OFFSET(0x19127720)
#define RPG_GAMECORE_TUTORIALCLICKBTN__CTOR_OFFSET UNITYSDK_OFFSET(0x191276F0)
