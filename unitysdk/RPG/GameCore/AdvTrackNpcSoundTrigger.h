...
#define RPG_GAMECORE_ADVTRACKNPCSOUNDTRIGGER_METHOD_3_10CA7E69E90AF326_OFFSET UNITYSDK_OFFSET(0x1684C1A0)
#define RPG_GAMECORE_ADVTRACKNPCSOUNDTRIGGER_METHOD_3_A484DB9C10E848F0_OFFSET UNITYSDK_OFFSET(0x1684C220)
#define RPG_GAMECORE_ADVTRACKNPCSOUNDTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1684C1F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvTrackNpcSoundTrigger_TypeDefinitionIndex = 19838;
