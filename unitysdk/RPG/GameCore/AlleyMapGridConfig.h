...
#define RPG_GAMECORE_ALLEYMAPGRIDCONFIG_METHOD_2_360BA3F10FDB9491_OFFSET UNITYSDK_OFFSET(0x18ACB350)
#define RPG_GAMECORE_ALLEYMAPGRIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18ACB6C0)
