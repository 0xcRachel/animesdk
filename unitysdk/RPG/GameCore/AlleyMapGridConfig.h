...
#define RPG_GAMECORE_ALLEYMAPGRIDCONFIG_METHOD_2_360BA3F10FDB9491_OFFSET UNITYSDK_OFFSET(0x1687CBB0)
#define RPG_GAMECORE_ALLEYMAPGRIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1687CF20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AlleyMapGridConfig_TypeDefinitionIndex = 14255;
