...
#define RPG_GAMECORE_ACTIVITYHIPPLENINTERACTPROPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16F116B0)
#define RPG_GAMECORE_ACTIVITYHIPPLENINTERACTPROPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16F119C0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 UnlockCycleID; // 0x30
		::RPG::GameCore::HipplenInteractLikeType LikeType; // 0x34
