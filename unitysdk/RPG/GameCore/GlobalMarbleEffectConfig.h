...
#define RPG_GAMECORE_GLOBALMARBLEEFFECTCONFIG_METHOD_2_268699C4022635F2_OFFSET UNITYSDK_OFFSET(0x1955C2B0)
#define RPG_GAMECORE_GLOBALMARBLEEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1955C3C0)
