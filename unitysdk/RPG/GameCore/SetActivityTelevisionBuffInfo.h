...
#define RPG_GAMECORE_SETACTIVITYTELEVISIONBUFFINFO_METHOD_3_6E99B8A12CD5A5D6_OFFSET UNITYSDK_OFFSET(0x16F03D00)
#define RPG_GAMECORE_SETACTIVITYTELEVISIONBUFFINFO_METHOD_3_CF05392FA4E06924_OFFSET UNITYSDK_OFFSET(0x16F03E20)
#define RPG_GAMECORE_SETACTIVITYTELEVISIONBUFFINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16F03DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetActivityTelevisionBuffInfo_TypeDefinitionIndex = 20919;
