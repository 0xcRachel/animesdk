...
#define RPG_GAMECORE_SETACTIVITYTELEVISIONBUFFINFO_METHOD_3_6E99B8A12CD5A5D6_OFFSET UNITYSDK_OFFSET(0x176B9190)
#define RPG_GAMECORE_SETACTIVITYTELEVISIONBUFFINFO_METHOD_3_CF05392FA4E06924_OFFSET UNITYSDK_OFFSET(0x176B92B0)
#define RPG_GAMECORE_SETACTIVITYTELEVISIONBUFFINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x176B9230)
