...
#define RPG_GAMECORE_ST_SIDE_OVERRIDEVISION_METHOD_4_071E93ED4315636F_OFFSET UNITYSDK_OFFSET(0x16EEAB90)
#define RPG_GAMECORE_ST_SIDE_OVERRIDEVISION_METHOD_4_44F18418FE0E4C82_OFFSET UNITYSDK_OFFSET(0x16EF8940)
#define RPG_GAMECORE_ST_SIDE_OVERRIDEVISION__CTOR_OFFSET UNITYSDK_OFFSET(0x16EEAB40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_OverrideVision_TypeDefinitionIndex = 17869;
