...
#define RPG_GAMECORE_PARALLELSELECTORCONFIG_METHOD_4_91450F8694A694BE_OFFSET UNITYSDK_OFFSET(0x1749C930)
#define RPG_GAMECORE_PARALLELSELECTORCONFIG_METHOD_4_E7A4AD78092A132F_OFFSET UNITYSDK_OFFSET(0x1749C9B0)
#define RPG_GAMECORE_PARALLELSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1749C980)
