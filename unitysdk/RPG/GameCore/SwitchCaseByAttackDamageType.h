...
#define RPG_GAMECORE_SWITCHCASEBYATTACKDAMAGETYPE_METHOD_3_04D35085989E1FF2_OFFSET UNITYSDK_OFFSET(0x177A6C00)
#define RPG_GAMECORE_SWITCHCASEBYATTACKDAMAGETYPE_METHOD_3_6618BEA37F7D5825_OFFSET UNITYSDK_OFFSET(0x177A6B80)
#define RPG_GAMECORE_SWITCHCASEBYATTACKDAMAGETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x177A6BD0)
