...
#define RPG_GAMECORE_SWITCHCASEBYATTACKDAMAGETYPE_METHOD_3_0CE1D305328A9FF8_OFFSET UNITYSDK_OFFSET(0x1985B3B0)
#define RPG_GAMECORE_SWITCHCASEBYATTACKDAMAGETYPE_METHOD_3_C6B9D866A9F2CADF_OFFSET UNITYSDK_OFFSET(0x1985B330)
#define RPG_GAMECORE_SWITCHCASEBYATTACKDAMAGETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1985B380)
