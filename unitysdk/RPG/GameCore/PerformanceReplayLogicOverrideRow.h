...
#define RPG_GAMECORE_PERFORMANCEREPLAYLOGICOVERRIDEROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x16D28D20)
#define RPG_GAMECORE_PERFORMANCEREPLAYLOGICOVERRIDEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16D29350)
#define RPG_GAMECORE_PERFORMANCEREPLAYLOGICOVERRIDEROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x16D28C90)
#define RPG_GAMECORE_PERFORMANCEREPLAYLOGICOVERRIDEROW_RESET_OFFSET UNITYSDK_OFFSET(0x16D28CF0)
#define RPG_GAMECORE_PERFORMANCEREPLAYLOGICOVERRIDEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16D299C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceReplayLogicOverrideRow_TypeDefinitionIndex = 13068;

	class PerformanceReplayLogicOverrideRow : public ::System::Object
	{
	public:
		::System::String* PatchLevelGraph; // 0x10
		...
		::Il2CppArray<::Class_1_927AEEA01B635CB6_1*>* OverridePropState; // 0x30
		::System::UInt32 IsOverrideBranchFlag; // 0x38
		::System::UInt32 PerformanceID; // 0x3C
		::System::UInt32 IsOverridePropStateFlag; // 0x40
		::RPG::GameCore::ELevelPerformanceType PerformanceType; // 0x44
		::System::UInt32 IsOverrideMissionAudioStateFlag; // 0x48
		::System::UInt32 IsOverrideDeactiveGroupFlag; // 0x4C
		::System::UInt32 IsOverrideMissionLGDisableFlag; // 0x50
		::System::Int32 OverrideEndBlackType; // 0x54
		::System::UInt32 IsOverridePerformancePriorityFlag; // 0x58
		...
		::System::UInt32 IsOverrideActiveGroupFlag; // 0x6C
