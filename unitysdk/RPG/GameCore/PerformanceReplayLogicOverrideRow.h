...
#define RPG_GAMECORE_PERFORMANCEREPLAYLOGICOVERRIDEROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x18F10E90)
#define RPG_GAMECORE_PERFORMANCEREPLAYLOGICOVERRIDEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18F114C0)
#define RPG_GAMECORE_PERFORMANCEREPLAYLOGICOVERRIDEROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x18F10E00)
#define RPG_GAMECORE_PERFORMANCEREPLAYLOGICOVERRIDEROW_RESET_OFFSET UNITYSDK_OFFSET(0x18F10E60)
#define RPG_GAMECORE_PERFORMANCEREPLAYLOGICOVERRIDEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18F11B30)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Int32 OverrideEndBlackType; // 0x3C
		...
		::System::UInt32 OverrideMissionLGDisable; // 0x4C
		::RPG::GameCore::ELevelPerformanceType PerformanceType; // 0x50
		::System::UInt32 OverrideIntent; // 0x54
		::System::UInt32 PerformanceID; // 0x58
		::System::Int32 OverridePerformancePriority; // 0x5C
		::System::UInt32 IsOverrideMissionAudioStateFlag; // 0x60
		::System::UInt32 OverrideIsBranch; // 0x64
		::System::UInt32 IsOverridePerformancePriorityFlag; // 0x68
