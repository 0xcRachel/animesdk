...
#define RPG_GAMECORE_PERFORMANCEREPLAYLOGICOVERRIDEROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x19D28370)
#define RPG_GAMECORE_PERFORMANCEREPLAYLOGICOVERRIDEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19D28990)
#define RPG_GAMECORE_PERFORMANCEREPLAYLOGICOVERRIDEROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x19D282E0)
#define RPG_GAMECORE_PERFORMANCEREPLAYLOGICOVERRIDEROW_RESET_OFFSET UNITYSDK_OFFSET(0x19D28340)
#define RPG_GAMECORE_PERFORMANCEREPLAYLOGICOVERRIDEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19D28FF0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 OverrideIsBranch; // 0x38
		::System::UInt32 IsOverrideBranchFlag; // 0x3C
		::System::UInt32 IsOverridePerformancePriorityFlag; // 0x40
		::System::UInt32 IsOverrideActiveGroupFlag; // 0x44
		::System::Int32 OverridePerformancePriority; // 0x48
		::RPG::GameCore::ELevelPerformanceType PerformanceType; // 0x4C
		::System::UInt32 IsOverrideDeactiveGroupFlag; // 0x50
		...
		::System::UInt32 IsOverridePropStateFlag; // 0x70
