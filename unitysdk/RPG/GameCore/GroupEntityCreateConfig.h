...
#define RPG_GAMECORE_GROUPENTITYCREATECONFIG_METHOD_2_DBFCB6AC43B7DCA2_OFFSET UNITYSDK_OFFSET(0x16B51340)
#define RPG_GAMECORE_GROUPENTITYCREATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16B516C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GroupEntityCreateConfig_TypeDefinitionIndex = 19001;
