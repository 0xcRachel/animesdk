...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::BattleOperationType>**)Il2CppClass::FromTypeDefinitionIndex(ShowGuideHintWithText___O_TypeDefinitionIndex)->GetStaticField(0x115A0);
		}
	};
}
