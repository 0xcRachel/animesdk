...
#define RPG_GAMECORE_AVATARBASETYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x181F8940)
#define RPG_GAMECORE_AVATARBASETYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x181F9200)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* BaseTypeIconSmall; // 0x50
