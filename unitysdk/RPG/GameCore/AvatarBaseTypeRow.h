...
#define RPG_GAMECORE_AVATARBASETYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17627E30)
#define RPG_GAMECORE_AVATARBASETYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17628710)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* LightConeCardBackImagePath; // 0x28
		::System::String* BaseTypeIconSmall; // 0x30
		::System::String* BaseTypeIconPathTalk; // 0x38
		::System::String* EquipmentLightMatPath; // 0x40
		::System::String* Equipment3DTgaPath; // 0x48
