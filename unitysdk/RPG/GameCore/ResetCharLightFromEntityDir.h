...
#define RPG_GAMECORE_RESETCHARLIGHTFROMENTITYDIR_METHOD_3_4C67A3CACB17324A_OFFSET UNITYSDK_OFFSET(0x1902DCB0)
#define RPG_GAMECORE_RESETCHARLIGHTFROMENTITYDIR_METHOD_3_F066337EB592BEDE_OFFSET UNITYSDK_OFFSET(0x1902DBA0)
#define RPG_GAMECORE_RESETCHARLIGHTFROMENTITYDIR__CTOR_OFFSET UNITYSDK_OFFSET(0x1902DC80)
