...
#define RPG_GAMECORE_SETVERSUSBAR_METHOD_3_6395EFD1FF31AAE5_OFFSET UNITYSDK_OFFSET(0x1A7A3C30)
#define RPG_GAMECORE_SETVERSUSBAR_METHOD_3_6B61804D4EF0B13E_OFFSET UNITYSDK_OFFSET(0x1A7A3BB0)
#define RPG_GAMECORE_SETVERSUSBAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7A3C00)
