...
#define RPG_GAMECORE_SETVERSUSBAR_METHOD_3_6395EFD1FF31AAE5_OFFSET UNITYSDK_OFFSET(0x16F45750)
#define RPG_GAMECORE_SETVERSUSBAR_METHOD_3_6B61804D4EF0B13E_OFFSET UNITYSDK_OFFSET(0x16F456D0)
#define RPG_GAMECORE_SETVERSUSBAR__CTOR_OFFSET UNITYSDK_OFFSET(0x16F45720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetVersusBar_TypeDefinitionIndex = 20820;
