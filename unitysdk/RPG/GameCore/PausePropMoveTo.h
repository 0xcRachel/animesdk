...
#define RPG_GAMECORE_PAUSEPROPMOVETO_METHOD_3_1620541E8C05B24D_OFFSET UNITYSDK_OFFSET(0x16D1B470)
#define RPG_GAMECORE_PAUSEPROPMOVETO_METHOD_3_B4C44B3A74AA9CDE_OFFSET UNITYSDK_OFFSET(0x16D1B320)
#define RPG_GAMECORE_PAUSEPROPMOVETO__CTOR_OFFSET UNITYSDK_OFFSET(0x16D1B3E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PausePropMoveTo_TypeDefinitionIndex = 19606;
