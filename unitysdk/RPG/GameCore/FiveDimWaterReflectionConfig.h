...
#define RPG_GAMECORE_FIVEDIMWATERREFLECTIONCONFIG_METHOD_3_2465DD4A2F20163C_OFFSET UNITYSDK_OFFSET(0x16ADA560)
#define RPG_GAMECORE_FIVEDIMWATERREFLECTIONCONFIG_METHOD_3_EFC3604F7A5CE73B_OFFSET UNITYSDK_OFFSET(0x16ADA4F0)
#define RPG_GAMECORE_FIVEDIMWATERREFLECTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16ADA540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimWaterReflectionConfig_TypeDefinitionIndex = 16692;
