...
#define RPG_GAMECORE_MODIFYSP_METHOD_3_0D77EEA27686BDFE_OFFSET UNITYSDK_OFFSET(0x16CC0350)
#define RPG_GAMECORE_MODIFYSP_METHOD_3_B37C2DE6482AA758_OFFSET UNITYSDK_OFFSET(0x16CC03F0)
#define RPG_GAMECORE_MODIFYSP__CTOR_OFFSET UNITYSDK_OFFSET(0x16CC03B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifySP_TypeDefinitionIndex = 21242;
