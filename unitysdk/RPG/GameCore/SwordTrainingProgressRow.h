...
#define RPG_GAMECORE_SWORDTRAININGPROGRESSROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19868420)
#define RPG_GAMECORE_SWORDTRAININGPROGRESSROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19868860)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 PartnerAbilitySelectNum; // 0x1C
		::RPG::Client::TextID SectionHint; // 0x20
		::RPG::GameCore::SwordTrainingTurnType TurnType; // 0x30
		::System::UInt32 ExamID; // 0x34
		::System::UInt32 PartnerAbilityGroupID; // 0x38
		::System::UInt32 RecommendPower; // 0x3C
