...
#define RPG_GAMECORE_TRAINPARTYPERFORMANCECONFIG_METHOD_2_EECFEEE9D5AEFB4C_OFFSET UNITYSDK_OFFSET(0x178C3190)
#define RPG_GAMECORE_TRAINPARTYPERFORMANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x178C33F0)
