...
#define RPG_GAMECORE_COLLECTDATACONDITIONS_METHOD_3_215A9C5B539377B3_OFFSET UNITYSDK_OFFSET(0x17133340)
#define RPG_GAMECORE_COLLECTDATACONDITIONS_METHOD_3_909991EEB7C7239B_OFFSET UNITYSDK_OFFSET(0x171332C0)
#define RPG_GAMECORE_COLLECTDATACONDITIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x17133310)
