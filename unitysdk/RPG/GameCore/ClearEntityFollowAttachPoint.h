...
#define RPG_GAMECORE_CLEARENTITYFOLLOWATTACHPOINT_METHOD_3_033B856A9E43499F_OFFSET UNITYSDK_OFFSET(0x170C6700)
#define RPG_GAMECORE_CLEARENTITYFOLLOWATTACHPOINT_METHOD_3_E778B85DF99C614E_OFFSET UNITYSDK_OFFSET(0x170C6780)
#define RPG_GAMECORE_CLEARENTITYFOLLOWATTACHPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x170C6750)
