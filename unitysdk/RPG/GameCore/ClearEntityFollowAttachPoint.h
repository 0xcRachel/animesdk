...
#define RPG_GAMECORE_CLEARENTITYFOLLOWATTACHPOINT_METHOD_3_033B856A9E43499F_OFFSET UNITYSDK_OFFSET(0x169A4580)
#define RPG_GAMECORE_CLEARENTITYFOLLOWATTACHPOINT_METHOD_3_E778B85DF99C614E_OFFSET UNITYSDK_OFFSET(0x169A4600)
#define RPG_GAMECORE_CLEARENTITYFOLLOWATTACHPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x169A45D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearEntityFollowAttachPoint_TypeDefinitionIndex = 21328;
