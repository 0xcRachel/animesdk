...
#define RPG_GAMECORE_SETMUSICVISUALRENDERENABLE_METHOD_3_7D67D31B9877EFF2_OFFSET UNITYSDK_OFFSET(0x199C0270)
#define RPG_GAMECORE_SETMUSICVISUALRENDERENABLE_METHOD_3_89F414942BA99392_OFFSET UNITYSDK_OFFSET(0x199C0120)
#define RPG_GAMECORE_SETMUSICVISUALRENDERENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x199C01E0)
