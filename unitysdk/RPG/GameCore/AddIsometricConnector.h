...
#define RPG_GAMECORE_ADDISOMETRICCONNECTOR_METHOD_3_13EE773768E6A67D_OFFSET UNITYSDK_OFFSET(0x167BB610)
#define RPG_GAMECORE_ADDISOMETRICCONNECTOR_METHOD_3_CD9284761691B76B_OFFSET UNITYSDK_OFFSET(0x167BB4C0)
#define RPG_GAMECORE_ADDISOMETRICCONNECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x167BB580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddIsometricConnector_TypeDefinitionIndex = 19857;
