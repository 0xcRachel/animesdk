...
#define RPG_GAMECORE_BYCONTAINOPINSKILL_METHOD_4_34E628933CC684D6_OFFSET UNITYSDK_OFFSET(0x16920AA0)
#define RPG_GAMECORE_BYCONTAINOPINSKILL_METHOD_4_A95EBD651CDF9238_OFFSET UNITYSDK_OFFSET(0x16920B70)
#define RPG_GAMECORE_BYCONTAINOPINSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x16920B20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByContainOpInSkill_TypeDefinitionIndex = 20210;
