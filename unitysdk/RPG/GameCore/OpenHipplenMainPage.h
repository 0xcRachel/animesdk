...
#define RPG_GAMECORE_OPENHIPPLENMAINPAGE_METHOD_3_674735837FB98D43_OFFSET UNITYSDK_OFFSET(0x17490870)
#define RPG_GAMECORE_OPENHIPPLENMAINPAGE_METHOD_3_695C61E62C4C12AF_OFFSET UNITYSDK_OFFSET(0x17490760)
#define RPG_GAMECORE_OPENHIPPLENMAINPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x17490840)
