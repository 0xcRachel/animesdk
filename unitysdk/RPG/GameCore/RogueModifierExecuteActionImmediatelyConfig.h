...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONIMMEDIATELYCONFIG_METHOD_3_9B4011CF9F5EC64B_OFFSET UNITYSDK_OFFSET(0x16E965D0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONIMMEDIATELYCONFIG_METHOD_3_C0D539F8786134F2_OFFSET UNITYSDK_OFFSET(0x16E9E920)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONIMMEDIATELYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E96580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionImmediatelyConfig_TypeDefinitionIndex = 16118;
