...
#define RPG_GAMECORE_STACKSCEPTERPROPERTY_METHOD_3_F822ABC902C6EC96_OFFSET UNITYSDK_OFFSET(0x19333D20)
#define RPG_GAMECORE_STACKSCEPTERPROPERTY_METHOD_3_FA44F7FDBBF3841D_OFFSET UNITYSDK_OFFSET(0x19333DA0)
#define RPG_GAMECORE_STACKSCEPTERPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x19333D70)
