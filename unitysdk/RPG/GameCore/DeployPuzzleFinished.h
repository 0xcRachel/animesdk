...
#define RPG_GAMECORE_DEPLOYPUZZLEFINISHED_METHOD_3_0D0F76003D3EF667_OFFSET UNITYSDK_OFFSET(0x169EBB20)
#define RPG_GAMECORE_DEPLOYPUZZLEFINISHED_METHOD_3_7990282402B8ED61_OFFSET UNITYSDK_OFFSET(0x169EB9D0)
#define RPG_GAMECORE_DEPLOYPUZZLEFINISHED__CTOR_OFFSET UNITYSDK_OFFSET(0x169EBA90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DeployPuzzleFinished_TypeDefinitionIndex = 18136;
