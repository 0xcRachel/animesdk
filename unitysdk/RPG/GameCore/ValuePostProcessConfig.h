...
#define RPG_GAMECORE_VALUEPOSTPROCESSCONFIG_METHOD_2_0ACC4AC96C3EFE2D_OFFSET UNITYSDK_OFFSET(0x1951F610)
#define RPG_GAMECORE_VALUEPOSTPROCESSCONFIG_METHOD_2_BC56F9321F1A2BDF_OFFSET UNITYSDK_OFFSET(0x1951EE00)
#define RPG_GAMECORE_VALUEPOSTPROCESSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1951D920)
