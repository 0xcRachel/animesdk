...
#define RPG_GAMECORE_MUSEUMMISSIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16CEF2E0)
#define RPG_GAMECORE_MUSEUMMISSIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16CEF470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MuseumMissionRow_TypeDefinitionIndex = 12968;
