...
#define RPG_GAMECORE_ILBATTLEAVATARSKILLCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19AD08B0)
#define RPG_GAMECORE_ILBATTLEAVATARSKILLCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD0E00)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::AttackType AttackType; // 0x30
