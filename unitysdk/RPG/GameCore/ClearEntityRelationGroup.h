...
#define RPG_GAMECORE_CLEARENTITYRELATIONGROUP_METHOD_3_4092FAE14C9D1641_OFFSET UNITYSDK_OFFSET(0x170C6890)
#define RPG_GAMECORE_CLEARENTITYRELATIONGROUP_METHOD_3_804FDE90A7A254F2_OFFSET UNITYSDK_OFFSET(0x170C6910)
#define RPG_GAMECORE_CLEARENTITYRELATIONGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x170C68E0)
