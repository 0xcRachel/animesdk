...
#define RPG_GAMECORE_SMELLPATHEDGE_METHOD_2_E6DA00F7CCF0F720_OFFSET UNITYSDK_OFFSET(0x16F6EE50)
#define RPG_GAMECORE_SMELLPATHEDGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F6F020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SmellPathEdge_TypeDefinitionIndex = 15869;
