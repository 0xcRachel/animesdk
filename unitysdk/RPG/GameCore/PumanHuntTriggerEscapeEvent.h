...
#define RPG_GAMECORE_PUMANHUNTTRIGGERESCAPEEVENT_METHOD_3_F03DC8D259D9A2FE_OFFSET UNITYSDK_OFFSET(0x17588190)
#define RPG_GAMECORE_PUMANHUNTTRIGGERESCAPEEVENT_METHOD_3_F98420EACE63A7EA_OFFSET UNITYSDK_OFFSET(0x175882A0)
#define RPG_GAMECORE_PUMANHUNTTRIGGERESCAPEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x17588270)
