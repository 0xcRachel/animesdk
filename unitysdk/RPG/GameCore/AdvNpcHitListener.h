...
#define RPG_GAMECORE_ADVNPCHITLISTENER_METHOD_3_C627DB71950689F7_OFFSET UNITYSDK_OFFSET(0x18C52640)
#define RPG_GAMECORE_ADVNPCHITLISTENER_METHOD_3_E2AFDE4A6E615640_OFFSET UNITYSDK_OFFSET(0x18C524F0)
#define RPG_GAMECORE_ADVNPCHITLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x18C525B0)
