...
#define RPG_GAMECORE_SETDYNAMICVALUEBYCOPYINGBATCHITEM_METHOD_2_23962C9CB970A44B_OFFSET UNITYSDK_OFFSET(0x1A1FB280)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCOPYINGBATCHITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1FB3B0)
