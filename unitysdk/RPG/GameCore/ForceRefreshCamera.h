...
#define RPG_GAMECORE_FORCEREFRESHCAMERA_METHOD_3_6B3017EF27EE23DE_OFFSET UNITYSDK_OFFSET(0x1A3B1E30)
#define RPG_GAMECORE_FORCEREFRESHCAMERA_METHOD_3_9CEC289970EF73D2_OFFSET UNITYSDK_OFFSET(0x1A3B1D20)
#define RPG_GAMECORE_FORCEREFRESHCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3B1E00)
