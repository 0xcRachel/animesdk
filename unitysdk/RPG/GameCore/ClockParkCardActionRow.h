...
#define RPG_GAMECORE_CLOCKPARKCARDACTIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A311F30)
#define RPG_GAMECORE_CLOCKPARKCARDACTIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A312300)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* ImgPath2; // 0x38
		::System::String* ForeImgPath; // 0x40
		::Il2CppArray<::System::UInt32>* DiceList; // 0x48
