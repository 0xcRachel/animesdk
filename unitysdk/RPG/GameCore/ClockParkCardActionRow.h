...
#define RPG_GAMECORE_CLOCKPARKCARDACTIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x169A7E10)
#define RPG_GAMECORE_CLOCKPARKCARDACTIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x169A8200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClockParkCardActionRow_TypeDefinitionIndex = 10385;

	class ClockParkCardActionRow : public ::System::Object
	{
	public:
		::System::String* ImgPath1; // 0x10
		::Il2CppArray<::System::UInt32>* SuccessEffectList; // 0x18
		::System::String* ImgPath2; // 0x20
