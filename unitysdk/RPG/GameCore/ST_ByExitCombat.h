...
#define RPG_GAMECORE_ST_BYEXITCOMBAT_METHOD_4_CD55CC68E3732C78_OFFSET UNITYSDK_OFFSET(0x176A7200)
#define RPG_GAMECORE_ST_BYEXITCOMBAT_METHOD_4_DFF5C3047D9FAC52_OFFSET UNITYSDK_OFFSET(0x176A72D0)
#define RPG_GAMECORE_ST_BYEXITCOMBAT__CTOR_OFFSET UNITYSDK_OFFSET(0x176A7280)
