...
#define RPG_GAMECORE_HELIOBUSCHALLENGEPHASEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19AB7250)
#define RPG_GAMECORE_HELIOBUSCHALLENGEPHASEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19AB79C0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 MapEntranceID; // 0x24
