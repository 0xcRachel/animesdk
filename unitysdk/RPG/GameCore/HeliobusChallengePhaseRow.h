...
#define RPG_GAMECORE_HELIOBUSCHALLENGEPHASEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18A6A5D0)
#define RPG_GAMECORE_HELIOBUSCHALLENGEPHASEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18A6AD20)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID ChallengePhaseName; // 0x30
