...
#define RPG_GAMECORE_CHARACTERLODCONFIG_METHOD_2_46EA512D7D45436B_OFFSET UNITYSDK_OFFSET(0x17081C50)
#define RPG_GAMECORE_CHARACTERLODCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17081E00)
