...
#define RPG_GAMECORE_CLEARTRIGGER_METHOD_3_12C05A93804B67A9_OFFSET UNITYSDK_OFFSET(0x169A5CB0)
#define RPG_GAMECORE_CLEARTRIGGER_METHOD_3_973D118C31940970_OFFSET UNITYSDK_OFFSET(0x169A5C30)
#define RPG_GAMECORE_CLEARTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x169A5C80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearTrigger_TypeDefinitionIndex = 17781;
