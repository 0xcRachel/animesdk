...
#define RPG_GAMECORE_CLEARTRIGGER_METHOD_3_12C05A93804B67A9_OFFSET UNITYSDK_OFFSET(0x170C7E30)
#define RPG_GAMECORE_CLEARTRIGGER_METHOD_3_973D118C31940970_OFFSET UNITYSDK_OFFSET(0x170C7DB0)
#define RPG_GAMECORE_CLEARTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x170C7E00)
