...
#define RPG_GAMECORE_CLEARALLEFFECT_METHOD_3_80BDFA9A9A954E86_OFFSET UNITYSDK_OFFSET(0x169A3A00)
#define RPG_GAMECORE_CLEARALLEFFECT_METHOD_3_F3A37D4E791A27F2_OFFSET UNITYSDK_OFFSET(0x169A3B10)
#define RPG_GAMECORE_CLEARALLEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x169A3AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearAllEffect_TypeDefinitionIndex = 18038;
