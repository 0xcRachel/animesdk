...
#define RPG_GAMECORE_UNIVERSALHOTFIXPREDICATEA_METHOD_5_4EEB52F53202998D_OFFSET UNITYSDK_OFFSET(0x1713DD70)
#define RPG_GAMECORE_UNIVERSALHOTFIXPREDICATEA_METHOD_5_98AAC565E88CD82A_OFFSET UNITYSDK_OFFSET(0x1713DCA0)
#define RPG_GAMECORE_UNIVERSALHOTFIXPREDICATEA__CTOR_OFFSET UNITYSDK_OFFSET(0x1713DD20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UniversalHotFixPredicateA_TypeDefinitionIndex = 21031;
