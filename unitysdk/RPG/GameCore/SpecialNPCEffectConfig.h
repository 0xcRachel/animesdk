...
#define RPG_GAMECORE_SPECIALNPCEFFECTCONFIG_METHOD_3_8A5BAC48951E68E8_OFFSET UNITYSDK_OFFSET(0x16F7E400)
#define RPG_GAMECORE_SPECIALNPCEFFECTCONFIG_METHOD_3_F543E08A2401D12D_OFFSET UNITYSDK_OFFSET(0x16F7E3C0)
#define RPG_GAMECORE_SPECIALNPCEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F7E3F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SpecialNPCEffectConfig_TypeDefinitionIndex = 15340;
