...
#define RPG_GAMECORE_TEAMMATEATTACKFORMATIONCONFIG_METHOD_2_44E60777AA9E8DAD_OFFSET UNITYSDK_OFFSET(0x1947DA50)
#define RPG_GAMECORE_TEAMMATEATTACKFORMATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1947DBF0)
