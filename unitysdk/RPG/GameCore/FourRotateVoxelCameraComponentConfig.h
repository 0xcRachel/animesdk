...
#define RPG_GAMECORE_FOURROTATEVOXELCAMERACOMPONENTCONFIG_METHOD_3_07762468080494A5_OFFSET UNITYSDK_OFFSET(0x1722EDC0)
#define RPG_GAMECORE_FOURROTATEVOXELCAMERACOMPONENTCONFIG_METHOD_3_9E7BCF224A18D834_OFFSET UNITYSDK_OFFSET(0x1722ED50)
#define RPG_GAMECORE_FOURROTATEVOXELCAMERACOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1722EDA0)
