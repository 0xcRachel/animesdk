...
#define RPG_GAMECORE_LEVELBASECURVEPOINTINFO_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x16BA05B0)
#define RPG_GAMECORE_LEVELBASECURVEPOINTINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16BA0340)
#define RPG_GAMECORE_LEVELBASECURVEPOINTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16BA05A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelBaseCurvePointInfo_TypeDefinitionIndex = 15679;
