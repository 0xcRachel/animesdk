...
#define RPG_GAMECORE_ACTIVITYRAIDCOLLECTIONGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1953C100)
#define RPG_GAMECORE_ACTIVITYRAIDCOLLECTIONGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1953CDB0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 UnlockGroupID; // 0x30
		::System::Boolean RaidCollectionGroupNextEnable; // 0x34
