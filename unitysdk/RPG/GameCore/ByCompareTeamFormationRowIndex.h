...
#define RPG_GAMECORE_BYCOMPARETEAMFORMATIONROWINDEX_METHOD_4_28DDF6F09803A9BA_OFFSET UNITYSDK_OFFSET(0x18FF9240)
#define RPG_GAMECORE_BYCOMPARETEAMFORMATIONROWINDEX_METHOD_4_8A70500B1D5CABEB_OFFSET UNITYSDK_OFFSET(0x18FF9620)
#define RPG_GAMECORE_BYCOMPARETEAMFORMATIONROWINDEX_METHOD_4_978C418616085B34_OFFSET UNITYSDK_OFFSET(0x18FF9310)
#define RPG_GAMECORE_BYCOMPARETEAMFORMATIONROWINDEX_METHOD_4_C7D66C1E12B28494_OFFSET UNITYSDK_OFFSET(0x18FF95A0)
#define RPG_GAMECORE_BYCOMPARETEAMFORMATIONROWINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x18FF92C0)
