...
#define RPG_GAMECORE_PSTROPHYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16D139A0)
#define RPG_GAMECORE_PSTROPHYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16D13BB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PSTrophyRow_TypeDefinitionIndex = 11862;

	class PSTrophyRow : public ::System::Object
	{
	public:
		::System::UInt32 AchievementID; // 0x10
		::RPG::Client::TextID AchievementDesc; // 0x18
