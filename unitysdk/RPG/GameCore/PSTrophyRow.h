...
#define RPG_GAMECORE_PSTROPHYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19D104C0)
#define RPG_GAMECORE_PSTROPHYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19D106D0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID AchievementDesc; // 0x20
