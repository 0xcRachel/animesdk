...
#define RPG_GAMECORE_TRIGGERFIGHTFESTLINEUPINMISSION_METHOD_3_339AA2E9FC9F59D0_OFFSET UNITYSDK_OFFSET(0x171200C0)
#define RPG_GAMECORE_TRIGGERFIGHTFESTLINEUPINMISSION_METHOD_3_508170CCB2BA7247_OFFSET UNITYSDK_OFFSET(0x17120040)
#define RPG_GAMECORE_TRIGGERFIGHTFESTLINEUPINMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x17120090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerFightFestLineupInMission_TypeDefinitionIndex = 19361;
