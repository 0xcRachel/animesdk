...
#define RPG_GAMECORE_BYRANDOMCHANCECLIENTONLY_METHOD_4_0F80AE7351D8B765_OFFSET UNITYSDK_OFFSET(0x1693C680)
#define RPG_GAMECORE_BYRANDOMCHANCECLIENTONLY_METHOD_4_A770B67B8371DEEB_OFFSET UNITYSDK_OFFSET(0x1693C5B0)
#define RPG_GAMECORE_BYRANDOMCHANCECLIENTONLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1693C630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByRandomChanceClientOnly_TypeDefinitionIndex = 20646;
