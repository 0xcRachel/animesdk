...
#define RPG_GAMECORE_BYSKIPNEXTTELEPORTEFFECT_METHOD_4_3ABAA03C04190E30_OFFSET UNITYSDK_OFFSET(0x1693DBA0)
#define RPG_GAMECORE_BYSKIPNEXTTELEPORTEFFECT_METHOD_4_676730271EAEFEDA_OFFSET UNITYSDK_OFFSET(0x1693DC70)
#define RPG_GAMECORE_BYSKIPNEXTTELEPORTEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1693DC20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BySkipNextTeleportEffect_TypeDefinitionIndex = 18374;
