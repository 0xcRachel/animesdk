...
#define RPG_GAMECORE_DISTRICTSETUPGEOMETRYTRIGGER_METHOD_3_80E7581C65B3E43B_OFFSET UNITYSDK_OFFSET(0x19134750)
#define RPG_GAMECORE_DISTRICTSETUPGEOMETRYTRIGGER_METHOD_3_D1708A962600ACEA_OFFSET UNITYSDK_OFFSET(0x191347D0)
#define RPG_GAMECORE_DISTRICTSETUPGEOMETRYTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x191347A0)
