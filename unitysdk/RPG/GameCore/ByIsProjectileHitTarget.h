...
#define RPG_GAMECORE_BYISPROJECTILEHITTARGET_METHOD_4_59977953AECFA14E_OFFSET UNITYSDK_OFFSET(0x17045750)
#define RPG_GAMECORE_BYISPROJECTILEHITTARGET_METHOD_4_7F861B3B4A27A120_OFFSET UNITYSDK_OFFSET(0x17045680)
#define RPG_GAMECORE_BYISPROJECTILEHITTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x17045700)
