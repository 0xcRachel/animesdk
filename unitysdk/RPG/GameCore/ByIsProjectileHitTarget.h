...
#define RPG_GAMECORE_BYISPROJECTILEHITTARGET_METHOD_4_59977953AECFA14E_OFFSET UNITYSDK_OFFSET(0x19DAC840)
#define RPG_GAMECORE_BYISPROJECTILEHITTARGET_METHOD_4_7F861B3B4A27A120_OFFSET UNITYSDK_OFFSET(0x19DAC770)
#define RPG_GAMECORE_BYISPROJECTILEHITTARGET_METHOD_4_B6311516F263BC22_OFFSET UNITYSDK_OFFSET(0x19DACA40)
#define RPG_GAMECORE_BYISPROJECTILEHITTARGET_METHOD_4_DEF4AAE2E2952A03_OFFSET UNITYSDK_OFFSET(0x19DAC9C0)
#define RPG_GAMECORE_BYISPROJECTILEHITTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x19DAC7F0)
