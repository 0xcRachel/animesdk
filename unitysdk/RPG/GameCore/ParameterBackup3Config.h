...
#define RPG_GAMECORE_PARAMETERBACKUP3CONFIG_METHOD_4_2DCB0C1582DA87CC_OFFSET UNITYSDK_OFFSET(0x18EFE8E0)
#define RPG_GAMECORE_PARAMETERBACKUP3CONFIG_METHOD_4_E5C5FAFDC07DCC26_OFFSET UNITYSDK_OFFSET(0x18EFEA10)
#define RPG_GAMECORE_PARAMETERBACKUP3CONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18EFE990)
