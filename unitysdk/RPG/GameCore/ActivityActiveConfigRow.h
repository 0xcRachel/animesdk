...
#define RPG_GAMECORE_ACTIVITYACTIVECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x198921C0)
#define RPG_GAMECORE_ACTIVITYACTIVECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19892440)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 ActiveItemID; // 0x2C
