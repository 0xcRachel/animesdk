...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::SkillLayoutKey>**)Il2CppClass::FromTypeDefinitionIndex(StackCrazyAIBehavior___O_TypeDefinitionIndex)->GetStaticField(0x11E40);
		}
	};
}
