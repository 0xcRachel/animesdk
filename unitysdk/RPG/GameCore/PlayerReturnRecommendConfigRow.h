...
#define RPG_GAMECORE_PLAYERRETURNRECOMMENDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A771220)
#define RPG_GAMECORE_PLAYERRETURNRECOMMENDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A771560)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::PlayerReturnRecommendType Type; // 0x38
		::System::UInt32 RecommendID; // 0x3C
		::System::UInt32 GotoID; // 0x40
