...
#define RPG_GAMECORE_TARGETFETCHABILITYGROUP_METHOD_4_53302C24C51CF703_OFFSET UNITYSDK_OFFSET(0x177CE360)
#define RPG_GAMECORE_TARGETFETCHABILITYGROUP_METHOD_4_85F0DD8309BB75B5_OFFSET UNITYSDK_OFFSET(0x177CE250)
#define RPG_GAMECORE_TARGETFETCHABILITYGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x177CE310)
