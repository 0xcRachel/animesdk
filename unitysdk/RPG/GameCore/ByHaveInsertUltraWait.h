...
#define RPG_GAMECORE_BYHAVEINSERTULTRAWAIT_METHOD_4_1C6C9469F4EFF6B9_OFFSET UNITYSDK_OFFSET(0x19AE1880)
#define RPG_GAMECORE_BYHAVEINSERTULTRAWAIT_METHOD_4_82EAAF9CE54C4EF7_OFFSET UNITYSDK_OFFSET(0x19AE1960)
#define RPG_GAMECORE_BYHAVEINSERTULTRAWAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE1900)
