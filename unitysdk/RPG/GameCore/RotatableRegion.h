...
#define RPG_GAMECORE_ROTATABLEREGION_METHOD_2_8258EEA12D6A29D0_OFFSET UNITYSDK_OFFSET(0x176886A0)
#define RPG_GAMECORE_ROTATABLEREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x17688BA0)
