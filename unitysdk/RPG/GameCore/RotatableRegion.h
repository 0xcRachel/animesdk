...
#define RPG_GAMECORE_ROTATABLEREGION_METHOD_2_8258EEA12D6A29D0_OFFSET UNITYSDK_OFFSET(0x16ED4010)
#define RPG_GAMECORE_ROTATABLEREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x16ED4510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RotatableRegion_TypeDefinitionIndex = 15334;
