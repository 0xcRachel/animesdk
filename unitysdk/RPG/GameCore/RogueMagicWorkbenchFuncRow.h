...
#define RPG_GAMECORE_ROGUEMAGICWORKBENCHFUNCROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19EC6F60)
#define RPG_GAMECORE_ROGUEMAGICWORKBENCHFUNCROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19EC7210)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID FuncDesc; // 0x20
