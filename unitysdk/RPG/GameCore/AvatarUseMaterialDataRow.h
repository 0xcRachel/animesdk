...
#define RPG_GAMECORE_AVATARUSEMATERIALDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x168C47C0)
#define RPG_GAMECORE_AVATARUSEMATERIALDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x168C4A80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarUseMaterialDataRow_TypeDefinitionIndex = 11587;

	class AvatarUseMaterialDataRow : public ::System::Object
	{
	public:
		::System::UInt32 SkillMaterialSmall; // 0x10
		::System::UInt32 PromotionMaterial; // 0x14
		::System::UInt32 SkillMaterialLarge; // 0x18
