...
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYCONSUMECOINCONFIG_METHOD_3_921DDD899213E36D_OFFSET UNITYSDK_OFFSET(0x16E9CA70)
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYCONSUMECOINCONFIG_METHOD_3_F91B7F8A5604C974_OFFSET UNITYSDK_OFFSET(0x16EA2390)
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYCONSUMECOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E9CA20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierSetCountByConsumeCoinConfig_TypeDefinitionIndex = 15985;
