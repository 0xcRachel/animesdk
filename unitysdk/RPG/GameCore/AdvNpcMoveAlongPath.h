...
#define RPG_GAMECORE_ADVNPCMOVEALONGPATH_METHOD_3_E1B3756C6FEF557F_OFFSET UNITYSDK_OFFSET(0x18C52C90)
#define RPG_GAMECORE_ADVNPCMOVEALONGPATH_METHOD_3_ED7227A7FDA245BF_OFFSET UNITYSDK_OFFSET(0x18C52C00)
#define RPG_GAMECORE_ADVNPCMOVEALONGPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x18C52C60)
