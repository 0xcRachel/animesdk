...
#define RPG_GAMECORE_ADVNPCMOVEALONGPATH_METHOD_3_E1B3756C6FEF557F_OFFSET UNITYSDK_OFFSET(0x1683F850)
#define RPG_GAMECORE_ADVNPCMOVEALONGPATH_METHOD_3_ED7227A7FDA245BF_OFFSET UNITYSDK_OFFSET(0x1683F7C0)
#define RPG_GAMECORE_ADVNPCMOVEALONGPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1683F820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNpcMoveAlongPath_TypeDefinitionIndex = 18101;
