...
#define RPG_GAMECORE_SERVERPREFSCONFIG_METHOD_2_9ED0344226182869_OFFSET UNITYSDK_OFFSET(0x1A1DFF70)
#define RPG_GAMECORE_SERVERPREFSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1E0050)
