...
#define RPG_GAMECORE_SERVERPREFSCONFIG_METHOD_2_51BB0A34274766EF_OFFSET UNITYSDK_OFFSET(0x16F02C40)
#define RPG_GAMECORE_SERVERPREFSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F02D80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ServerPrefsConfig_TypeDefinitionIndex = 21906;
