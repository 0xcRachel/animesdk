...
#define RPG_GAMECORE_SETENTITYARTROTATION_METHOD_3_680B84D556DACC77_OFFSET UNITYSDK_OFFSET(0x16F29E80)
#define RPG_GAMECORE_SETENTITYARTROTATION_METHOD_3_C86C3BF8514071D5_OFFSET UNITYSDK_OFFSET(0x16F2A020)
#define RPG_GAMECORE_SETENTITYARTROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x16F29EC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetEntityArtRotation_TypeDefinitionIndex = 21465;
