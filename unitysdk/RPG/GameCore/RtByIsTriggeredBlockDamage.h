...
#define RPG_GAMECORE_RTBYISTRIGGEREDBLOCKDAMAGE_METHOD_4_175FB0B1D6C5BBB8_OFFSET UNITYSDK_OFFSET(0x1941E9F0)
#define RPG_GAMECORE_RTBYISTRIGGEREDBLOCKDAMAGE_METHOD_4_1B0C78932702C627_OFFSET UNITYSDK_OFFSET(0x1941E830)
#define RPG_GAMECORE_RTBYISTRIGGEREDBLOCKDAMAGE_METHOD_4_D6628B31A81CF8CD_OFFSET UNITYSDK_OFFSET(0x1941E760)
#define RPG_GAMECORE_RTBYISTRIGGEREDBLOCKDAMAGE_METHOD_4_DB76ACB4179E9670_OFFSET UNITYSDK_OFFSET(0x1941E970)
#define RPG_GAMECORE_RTBYISTRIGGEREDBLOCKDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1941E7E0)
