...
#define RPG_GAMECORE_ACTIVITYMOVIESTARTBUFFCONFIG_METHOD_2_17BAC2727871254B_OFFSET UNITYSDK_OFFSET(0x1679EA80)
#define RPG_GAMECORE_ACTIVITYMOVIESTARTBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1679EBF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityMovieStartBuffConfig_TypeDefinitionIndex = 15840;
