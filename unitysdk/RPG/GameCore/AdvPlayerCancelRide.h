...
#define RPG_GAMECORE_ADVPLAYERCANCELRIDE_METHOD_3_872F4BC88B503F6B_OFFSET UNITYSDK_OFFSET(0x16842270)
#define RPG_GAMECORE_ADVPLAYERCANCELRIDE_METHOD_3_F011DA45BECA2B42_OFFSET UNITYSDK_OFFSET(0x168422F0)
#define RPG_GAMECORE_ADVPLAYERCANCELRIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x168422C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvPlayerCancelRide_TypeDefinitionIndex = 18840;
