...
#define RPG_GAMECORE_ENABLEADVENTITYDITHERWITHPLAYER_METHOD_3_303DF4E3E7CCF69C_OFFSET UNITYSDK_OFFSET(0x16A68500)
#define RPG_GAMECORE_ENABLEADVENTITYDITHERWITHPLAYER_METHOD_3_4334A333FB9984AA_OFFSET UNITYSDK_OFFSET(0x16A68480)
#define RPG_GAMECORE_ENABLEADVENTITYDITHERWITHPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x16A684D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableAdvEntityDitherWithPlayer_TypeDefinitionIndex = 18358;
