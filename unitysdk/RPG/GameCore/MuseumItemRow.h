...
#define RPG_GAMECORE_MUSEUMITEMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x174753D0)
#define RPG_GAMECORE_MUSEUMITEMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17475970)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 DisplayOrder; // 0x28
		::System::UInt32 AreaID; // 0x2C
		::System::UInt32 ItemID; // 0x30
		::System::UInt32 RenewPoint; // 0x34
		::System::UInt32 StatsA; // 0x38
		::System::Boolean HideGetHint; // 0x3C
		::System::Boolean IsInitial; // 0x3D
		::System::UInt32 ScenePropID; // 0x40
		::System::UInt32 CollectedReward; // 0x44
		::RPG::Client::TextID EvidenceInfoTextID; // 0x48
		::System::UInt32 SceneGroupID; // 0x58
		::System::UInt32 UnlockPhase; // 0x5C
