...
#define RPG_GAMECORE_MUSEUMITEMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1863BF60)
#define RPG_GAMECORE_MUSEUMITEMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1863C500)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean HideGetHint; // 0x18
		::System::Boolean IsInitial; // 0x19
		::System::UInt32 CollectedReward; // 0x1C
		::System::UInt32 StatsB; // 0x20
		::System::UInt32 UnlockPhase; // 0x24
		::RPG::Client::TextID MuseumItemDesc; // 0x28
		::RPG::Client::TextID EvidenceInfoTextID; // 0x38
		::System::UInt32 DisplayOrder; // 0x48
		::System::UInt32 AreaID; // 0x4C
		::System::UInt32 SceneGroupID; // 0x50
		::System::UInt32 ScenePropID; // 0x54
		::System::UInt32 StatsA; // 0x58
