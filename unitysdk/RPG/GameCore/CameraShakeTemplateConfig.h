...
#define RPG_GAMECORE_CAMERASHAKETEMPLATECONFIG_METHOD_2_5BCD8A29929F2A67_OFFSET UNITYSDK_OFFSET(0x169553A0)
#define RPG_GAMECORE_CAMERASHAKETEMPLATECONFIG_METHOD_2_80A29442A2186008_OFFSET UNITYSDK_OFFSET(0x16955480)
#define RPG_GAMECORE_CAMERASHAKETEMPLATECONFIG_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x16955780)
#define RPG_GAMECORE_CAMERASHAKETEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16955470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CameraShakeTemplateConfig_TypeDefinitionIndex = 14797;
