...
#define RPG_GAMECORE_SETFUNCBTN_METHOD_3_32D955E55BAF1E0C_OFFSET UNITYSDK_OFFSET(0x199B64C0)
#define RPG_GAMECORE_SETFUNCBTN_METHOD_3_8035AA36AD215ABD_OFFSET UNITYSDK_OFFSET(0x199B6540)
#define RPG_GAMECORE_SETFUNCBTN__CTOR_OFFSET UNITYSDK_OFFSET(0x199B6510)
