...
#define RPG_GAMECORE_MISSIONDISABLEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16CAE4E0)
#define RPG_GAMECORE_MISSIONDISABLEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16CAE730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MissionDisableRow_TypeDefinitionIndex = 12883;
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* RecycleItemList; // 0x20
