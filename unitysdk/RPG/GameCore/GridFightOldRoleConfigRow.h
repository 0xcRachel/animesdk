...
#define RPG_GAMECORE_GRIDFIGHTOLDROLECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A1A92B0)
#define RPG_GAMECORE_GRIDFIGHTOLDROLECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1A9660)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 SpecialAvatarID; // 0x3C
