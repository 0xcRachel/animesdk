...
#define RPG_GAMECORE_FORMATIONMOVEADDGROUP_METHOD_3_03F6981A3A36A5E8_OFFSET UNITYSDK_OFFSET(0x1A3B2CE0)
#define RPG_GAMECORE_FORMATIONMOVEADDGROUP_METHOD_3_3FB73780301277BD_OFFSET UNITYSDK_OFFSET(0x1A3B2D60)
#define RPG_GAMECORE_FORMATIONMOVEADDGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3B2D30)
