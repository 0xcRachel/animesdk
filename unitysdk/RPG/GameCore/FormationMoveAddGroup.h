...
#define RPG_GAMECORE_FORMATIONMOVEADDGROUP_METHOD_3_03F6981A3A36A5E8_OFFSET UNITYSDK_OFFSET(0x16AE0DB0)
#define RPG_GAMECORE_FORMATIONMOVEADDGROUP_METHOD_3_3FB73780301277BD_OFFSET UNITYSDK_OFFSET(0x16AE0E30)
#define RPG_GAMECORE_FORMATIONMOVEADDGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x16AE0E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FormationMoveAddGroup_TypeDefinitionIndex = 19031;
