...
#define RPG_GAMECORE_ADVENTUREFIREPROJECTILEBASE_METHOD_3_4C8F1FDCFAD18A7E_OFFSET UNITYSDK_OFFSET(0x19C0ABC0)
#define RPG_GAMECORE_ADVENTUREFIREPROJECTILEBASE_METHOD_3_8A9BFB9AE6B2DE3A_OFFSET UNITYSDK_OFFSET(0x19C0A9A0)
#define RPG_GAMECORE_ADVENTUREFIREPROJECTILEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C0A970)
