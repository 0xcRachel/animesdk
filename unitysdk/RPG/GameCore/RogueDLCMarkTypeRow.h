...
#define RPG_GAMECORE_ROGUEDLCMARKTYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16E785B0)
#define RPG_GAMECORE_ROGUEDLCMARKTYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16E78C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDLCMarkTypeRow_TypeDefinitionIndex = 13439;
