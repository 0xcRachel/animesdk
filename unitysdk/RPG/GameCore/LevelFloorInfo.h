...
#define RPG_GAMECORE_LEVELFLOORINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16BA6400)
#define RPG_GAMECORE_LEVELFLOORINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16BA6C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelFloorInfo_TypeDefinitionIndex = 15661;
