...
#define RPG_GAMECORE_ROGUEDLCAEONDICESURFACEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19EA3C00)
#define RPG_GAMECORE_ROGUEDLCAEONDICESURFACEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19EA4540)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::Il2CppArray<::System::UInt32>* Dice3DSurfaceList; // 0x10
		...
		::System::UInt32 DiceActiveStage; // 0x5C
		::System::UInt32 Rarity; // 0x60
		::System::UInt32 AeonSurfaceDiceID; // 0x64
