...
#define RPG_GAMECORE_SHOWULTRASKILLALTERNATIVE_METHOD_3_1E8DBE193337542F_OFFSET UNITYSDK_OFFSET(0x1771BB40)
#define RPG_GAMECORE_SHOWULTRASKILLALTERNATIVE_METHOD_3_C82E2027BEB3D5BE_OFFSET UNITYSDK_OFFSET(0x1771BAC0)
#define RPG_GAMECORE_SHOWULTRASKILLALTERNATIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1771BB10)
