...
#define RPG_GAMECORE_SHOWULTRASKILLALTERNATIVE_METHOD_3_1E8DBE193337542F_OFFSET UNITYSDK_OFFSET(0x16F665C0)
#define RPG_GAMECORE_SHOWULTRASKILLALTERNATIVE_METHOD_3_C82E2027BEB3D5BE_OFFSET UNITYSDK_OFFSET(0x16F66540)
#define RPG_GAMECORE_SHOWULTRASKILLALTERNATIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F66590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowUltraSkillAlternative_TypeDefinitionIndex = 20572;
