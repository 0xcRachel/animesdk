...
#define RPG_GAMECORE_LITTLEGAMEPARENTCONFIG_METHOD_3_39DBF5AD5804DBB5_OFFSET UNITYSDK_OFFSET(0x173742C0)
#define RPG_GAMECORE_LITTLEGAMEPARENTCONFIG_METHOD_3_99DF50D858C26FD1_OFFSET UNITYSDK_OFFSET(0x1736F3D0)
#define RPG_GAMECORE_LITTLEGAMEPARENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1736F3B0)
