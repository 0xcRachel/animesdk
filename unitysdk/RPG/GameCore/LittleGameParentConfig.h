...
#define RPG_GAMECORE_LITTLEGAMEPARENTCONFIG_METHOD_3_39DBF5AD5804DBB5_OFFSET UNITYSDK_OFFSET(0x16BD0850)
#define RPG_GAMECORE_LITTLEGAMEPARENTCONFIG_METHOD_3_99DF50D858C26FD1_OFFSET UNITYSDK_OFFSET(0x16BCB950)
#define RPG_GAMECORE_LITTLEGAMEPARENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16BCB930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameParentConfig_TypeDefinitionIndex = 16893;
