...
#define RPG_GAMECORE_HIPPLENGAMEATMOSPHERECONFIG_METHOD_2_11E56DBDAF9DB277_OFFSET UNITYSDK_OFFSET(0x172C0B90)
#define RPG_GAMECORE_HIPPLENGAMEATMOSPHERECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x172C0F40)
