...
#define RPG_GAMECORE_HIPPLENGAMEATMOSPHERECONFIG_METHOD_2_11E56DBDAF9DB277_OFFSET UNITYSDK_OFFSET(0x16B722D0)
#define RPG_GAMECORE_HIPPLENGAMEATMOSPHERECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16B72680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenGameAtmosphereConfig_TypeDefinitionIndex = 15112;
