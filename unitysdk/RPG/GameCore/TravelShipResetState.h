...
#define RPG_GAMECORE_TRAVELSHIPRESETSTATE_METHOD_3_1A6F4C6FAAC2A2AD_OFFSET UNITYSDK_OFFSET(0x19108300)
#define RPG_GAMECORE_TRAVELSHIPRESETSTATE_METHOD_3_302EE82858B35AD4_OFFSET UNITYSDK_OFFSET(0x19108270)
#define RPG_GAMECORE_TRAVELSHIPRESETSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x191082D0)
