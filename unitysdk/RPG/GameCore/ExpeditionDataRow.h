...
#define RPG_GAMECORE_EXPEDITIONDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16A88E60)
#define RPG_GAMECORE_EXPEDITIONDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16A89370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ExpeditionDataRow_TypeDefinitionIndex = 12030;
	...
	public:
		...
		::System::UInt32 AvatarNumMin; // 0x5C
