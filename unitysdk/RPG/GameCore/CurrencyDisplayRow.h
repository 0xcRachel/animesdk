...
#define RPG_GAMECORE_CURRENCYDISPLAYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x169D84B0)
#define RPG_GAMECORE_CURRENCYDISPLAYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x169D8A40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CurrencyDisplayRow_TypeDefinitionIndex = 13300;
