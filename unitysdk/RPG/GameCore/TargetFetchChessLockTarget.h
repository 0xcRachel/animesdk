...
#define RPG_GAMECORE_TARGETFETCHCHESSLOCKTARGET_METHOD_4_9196935B20BE003B_OFFSET UNITYSDK_OFFSET(0x177D2150)
#define RPG_GAMECORE_TARGETFETCHCHESSLOCKTARGET_METHOD_4_D65170BFAF49B79D_OFFSET UNITYSDK_OFFSET(0x177C8240)
#define RPG_GAMECORE_TARGETFETCHCHESSLOCKTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x177C81C0)
