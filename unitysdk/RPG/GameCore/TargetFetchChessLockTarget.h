...
#define RPG_GAMECORE_TARGETFETCHCHESSLOCKTARGET_METHOD_4_9196935B20BE003B_OFFSET UNITYSDK_OFFSET(0x16FDC800)
#define RPG_GAMECORE_TARGETFETCHCHESSLOCKTARGET_METHOD_4_D65170BFAF49B79D_OFFSET UNITYSDK_OFFSET(0x16FD55A0)
#define RPG_GAMECORE_TARGETFETCHCHESSLOCKTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD5520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchChessLockTarget_TypeDefinitionIndex = 21603;
