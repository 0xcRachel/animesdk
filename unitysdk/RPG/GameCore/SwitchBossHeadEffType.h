...
#define RPG_GAMECORE_SWITCHBOSSHEADEFFTYPE_METHOD_3_38376206338F1FAE_OFFSET UNITYSDK_OFFSET(0x16FB1AF0)
#define RPG_GAMECORE_SWITCHBOSSHEADEFFTYPE_METHOD_3_8B15F2BC5EFC430D_OFFSET UNITYSDK_OFFSET(0x16FB1B70)
#define RPG_GAMECORE_SWITCHBOSSHEADEFFTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FB1B40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchBossHeadEffType_TypeDefinitionIndex = 20880;
