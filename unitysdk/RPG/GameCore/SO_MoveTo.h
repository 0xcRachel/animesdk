...
#define RPG_GAMECORE_SO_MOVETO_METHOD_4_DF7E136865B9FAD6_OFFSET UNITYSDK_OFFSET(0x16EDC030)
#define RPG_GAMECORE_SO_MOVETO_METHOD_4_E479E51F9D0612B3_OFFSET UNITYSDK_OFFSET(0x16EDCF30)
#define RPG_GAMECORE_SO_MOVETO__CTOR_OFFSET UNITYSDK_OFFSET(0x16EDC000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SO_MoveTo_TypeDefinitionIndex = 17816;
