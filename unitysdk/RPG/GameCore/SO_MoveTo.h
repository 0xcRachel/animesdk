...
#define RPG_GAMECORE_SO_MOVETO_METHOD_4_E479E51F9D0612B3_OFFSET UNITYSDK_OFFSET(0x176916B0)
#define RPG_GAMECORE_SO_MOVETO_METHOD_4_FA907C27DBFD8845_OFFSET UNITYSDK_OFFSET(0x17690780)
#define RPG_GAMECORE_SO_MOVETO__CTOR_OFFSET UNITYSDK_OFFSET(0x17690750)
