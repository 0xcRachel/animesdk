...
#define RPG_GAMECORE_HIPPLENINCIDENTOPTIONCONFIG_METHOD_2_B9D536A79D8CFEAD_OFFSET UNITYSDK_OFFSET(0x16B748A0)
#define RPG_GAMECORE_HIPPLENINCIDENTOPTIONCONFIG_METHOD_2_F7261BDD3C680651_OFFSET UNITYSDK_OFFSET(0x16B745C0)
#define RPG_GAMECORE_HIPPLENINCIDENTOPTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16B74000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenIncidentOptionConfig_TypeDefinitionIndex = 15138;
