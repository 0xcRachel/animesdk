...
#define RPG_GAMECORE_HIPPLENINCIDENTOPTIONCONFIG_METHOD_2_B9D536A79D8CFEAD_OFFSET UNITYSDK_OFFSET(0x172C3160)
#define RPG_GAMECORE_HIPPLENINCIDENTOPTIONCONFIG_METHOD_2_F7261BDD3C680651_OFFSET UNITYSDK_OFFSET(0x172C2E80)
#define RPG_GAMECORE_HIPPLENINCIDENTOPTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x172C28C0)
