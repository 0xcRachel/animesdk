...
#define RPG_GAMECORE_GLOBALSHOWBILLBOARD_METHOD_3_48D2A9D9888C9BF7_OFFSET UNITYSDK_OFFSET(0x1725D5D0)
#define RPG_GAMECORE_GLOBALSHOWBILLBOARD_METHOD_3_6276077FDAC2A346_OFFSET UNITYSDK_OFFSET(0x1725D550)
#define RPG_GAMECORE_GLOBALSHOWBILLBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1725D5A0)
