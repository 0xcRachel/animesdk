...
#define RPG_GAMECORE_MARBLEPREDICATECONFIG_METHOD_3_03B3E2F3E296DE5B_OFFSET UNITYSDK_OFFSET(0x18C1AC60)
#define RPG_GAMECORE_MARBLEPREDICATECONFIG_METHOD_3_301930FD20218805_OFFSET UNITYSDK_OFFSET(0x18C1BC90)
#define RPG_GAMECORE_MARBLEPREDICATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18C1BE50)
