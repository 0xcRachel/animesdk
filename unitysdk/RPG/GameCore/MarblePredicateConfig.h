...
#define RPG_GAMECORE_MARBLEPREDICATECONFIG_METHOD_3_03B3E2F3E296DE5B_OFFSET UNITYSDK_OFFSET(0x16C44640)
#define RPG_GAMECORE_MARBLEPREDICATECONFIG_METHOD_3_301930FD20218805_OFFSET UNITYSDK_OFFSET(0x16C456D0)
#define RPG_GAMECORE_MARBLEPREDICATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16C382E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarblePredicateConfig_TypeDefinitionIndex = 15156;
