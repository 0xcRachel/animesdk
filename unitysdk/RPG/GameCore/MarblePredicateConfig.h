...
#define RPG_GAMECORE_MARBLEPREDICATECONFIG_METHOD_3_03B3E2F3E296DE5B_OFFSET UNITYSDK_OFFSET(0x1997A7C0)
#define RPG_GAMECORE_MARBLEPREDICATECONFIG_METHOD_3_5CFB9B8919BCF2A7_OFFSET UNITYSDK_OFFSET(0x1997B7F0)
#define RPG_GAMECORE_MARBLEPREDICATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1997B9B0)
