...
#define RPG_GAMECORE_SWITCHMASCOTBULLETTRIGGERATTACK_METHOD_3_DECDB6E877CF8687_OFFSET UNITYSDK_OFFSET(0x16FB6080)
#define RPG_GAMECORE_SWITCHMASCOTBULLETTRIGGERATTACK_METHOD_3_EA7527C0FF8F5032_OFFSET UNITYSDK_OFFSET(0x16FB5F80)
#define RPG_GAMECORE_SWITCHMASCOTBULLETTRIGGERATTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x16FB6010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchMascotBulletTriggerAttack_TypeDefinitionIndex = 17939;
