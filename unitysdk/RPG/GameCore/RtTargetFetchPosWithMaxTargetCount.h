...
#define RPG_GAMECORE_RTTARGETFETCHPOSWITHMAXTARGETCOUNT_METHOD_4_015E1DBE5FB13EF2_OFFSET UNITYSDK_OFFSET(0x1A15CAE0)
#define RPG_GAMECORE_RTTARGETFETCHPOSWITHMAXTARGETCOUNT_METHOD_4_56072958798F734A_OFFSET UNITYSDK_OFFSET(0x1A15CA10)
#define RPG_GAMECORE_RTTARGETFETCHPOSWITHMAXTARGETCOUNT_METHOD_4_BFBA0B9AC5A4CBB3_OFFSET UNITYSDK_OFFSET(0x1A15C6D0)
#define RPG_GAMECORE_RTTARGETFETCHPOSWITHMAXTARGETCOUNT_METHOD_4_C52A111A708900B1_OFFSET UNITYSDK_OFFSET(0x1A15C840)
#define RPG_GAMECORE_RTTARGETFETCHPOSWITHMAXTARGETCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A15C7A0)
