...
#define RPG_GAMECORE_SETFLOORCUSTOMBOOL_METHOD_3_B6C414C0FA66B6B4_OFFSET UNITYSDK_OFFSET(0x1A78BA70)
#define RPG_GAMECORE_SETFLOORCUSTOMBOOL_METHOD_3_DEED5FC6CA5C68FD_OFFSET UNITYSDK_OFFSET(0x1A78B9F0)
#define RPG_GAMECORE_SETFLOORCUSTOMBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A78BA40)
