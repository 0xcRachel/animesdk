...
#define RPG_GAMECORE_TARGETSEQUENCE_METHOD_4_1B6AB92A0F4AEE12_OFFSET UNITYSDK_OFFSET(0x17135270)
#define RPG_GAMECORE_TARGETSEQUENCE_METHOD_4_21B947C3EC1B2476_OFFSET UNITYSDK_OFFSET(0x17132CE0)
#define RPG_GAMECORE_TARGETSEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x17132C90)
