...
#define RPG_GAMECORE_PROJECTILETEMPLATEDATA_METHOD_2_993287E990B17A01_OFFSET UNITYSDK_OFFSET(0x1A2D5F90)
#define RPG_GAMECORE_PROJECTILETEMPLATEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2D6100)
