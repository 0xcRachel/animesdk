...
#define RPG_GAMECORE_ROGUENOUSAEONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AE3EF10)
#define RPG_GAMECORE_ROGUENOUSAEONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE3F730)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 BattleEventBuffGroup; // 0x20
