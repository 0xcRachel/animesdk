...
#define RPG_GAMECORE_MARBLESETTECHACTIVE_METHOD_3_89E7214945186E46_OFFSET UNITYSDK_OFFSET(0x16C49850)
#define RPG_GAMECORE_MARBLESETTECHACTIVE_METHOD_3_D2E80BA6EE7A08E8_OFFSET UNITYSDK_OFFSET(0x16C49690)
#define RPG_GAMECORE_MARBLESETTECHACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x16C49800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleSetTechActive_TypeDefinitionIndex = 15167;
