...
#define RPG_GAMECORE_FLOATCURVE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A3AC8F0)
#define RPG_GAMECORE_FLOATCURVE_GET_CACHEDANIMCURVE_OFFSET UNITYSDK_OFFSET(0x1A3ACCD0)
#define RPG_GAMECORE_FLOATCURVE_METHOD_2_0739E5F4AFDDD8B0_OFFSET UNITYSDK_OFFSET(0x1A3AAB70)
#define RPG_GAMECORE_FLOATCURVE_METHOD_2_28633EAD2621903E_OFFSET UNITYSDK_OFFSET(0x1A3ACD20)
#define RPG_GAMECORE_FLOATCURVE_METHOD_2_6115B8FF6F2F3006_OFFSET UNITYSDK_OFFSET(0x1A3AD1D0)
#define RPG_GAMECORE_FLOATCURVE_METHOD_2_65C44E317041EBAA_OFFSET UNITYSDK_OFFSET(0x1A3ACD60)
#define RPG_GAMECORE_FLOATCURVE_METHOD_2_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x1A3AD190)
#define RPG_GAMECORE_FLOATCURVE_METHOD_2_8A6035CCBA726F8F_OFFSET UNITYSDK_OFFSET(0x1A3ACC70)
#define RPG_GAMECORE_FLOATCURVE_METHOD_2_B7AEDE66D3D00F7D_OFFSET UNITYSDK_OFFSET(0x1A3ACF00)
#define RPG_GAMECORE_FLOATCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3AC8E0)
