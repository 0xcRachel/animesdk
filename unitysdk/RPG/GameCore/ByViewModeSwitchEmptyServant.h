...
#define RPG_GAMECORE_BYVIEWMODESWITCHEMPTYSERVANT_METHOD_4_7325FC452131FD85_OFFSET UNITYSDK_OFFSET(0x19A74BC0)
#define RPG_GAMECORE_BYVIEWMODESWITCHEMPTYSERVANT_METHOD_4_900B5B20E4D94A5B_OFFSET UNITYSDK_OFFSET(0x19A74C90)
#define RPG_GAMECORE_BYVIEWMODESWITCHEMPTYSERVANT__CTOR_OFFSET UNITYSDK_OFFSET(0x19A74C40)
