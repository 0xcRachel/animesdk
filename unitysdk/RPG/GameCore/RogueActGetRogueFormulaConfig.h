...
#define RPG_GAMECORE_ROGUEACTGETROGUEFORMULACONFIG_METHOD_6_3D22BBB66A15B50C_OFFSET UNITYSDK_OFFSET(0x1A9A4AF0)
#define RPG_GAMECORE_ROGUEACTGETROGUEFORMULACONFIG_METHOD_6_D0AA81CFDA708491_OFFSET UNITYSDK_OFFSET(0x1A9A48D0)
#define RPG_GAMECORE_ROGUEACTGETROGUEFORMULACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9A4A10)
