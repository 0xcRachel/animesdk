...
#define RPG_GAMECORE_ELFPROGRESSUPGRADE_METHOD_3_3B86E4AD0BE2B1E1_OFFSET UNITYSDK_OFFSET(0x19150C10)
#define RPG_GAMECORE_ELFPROGRESSUPGRADE_METHOD_3_D049FD46B7EBCDED_OFFSET UNITYSDK_OFFSET(0x19150B00)
#define RPG_GAMECORE_ELFPROGRESSUPGRADE__CTOR_OFFSET UNITYSDK_OFFSET(0x19150BE0)
