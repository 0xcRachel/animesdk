...
#define RPG_GAMECORE_TARGETFETCHINSTIGATOR_METHOD_4_C169270D61F3623A_OFFSET UNITYSDK_OFFSET(0x177D3100)
#define RPG_GAMECORE_TARGETFETCHINSTIGATOR_METHOD_4_D1214B9F5310D3A8_OFFSET UNITYSDK_OFFSET(0x177C9F10)
#define RPG_GAMECORE_TARGETFETCHINSTIGATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x177C9EC0)
