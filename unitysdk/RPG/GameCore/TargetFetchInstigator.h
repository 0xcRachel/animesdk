...
#define RPG_GAMECORE_TARGETFETCHINSTIGATOR_METHOD_4_C169270D61F3623A_OFFSET UNITYSDK_OFFSET(0x16FDD790)
#define RPG_GAMECORE_TARGETFETCHINSTIGATOR_METHOD_4_D1214B9F5310D3A8_OFFSET UNITYSDK_OFFSET(0x16FD7250)
#define RPG_GAMECORE_TARGETFETCHINSTIGATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD7200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchInstigator_TypeDefinitionIndex = 21641;
