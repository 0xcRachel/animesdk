...
#define RPG_GAMECORE_ADVSETTARGETALERTVALUE_METHOD_3_5AA79FFDD7850D0C_OFFSET UNITYSDK_OFFSET(0x18C5D070)
#define RPG_GAMECORE_ADVSETTARGETALERTVALUE_METHOD_3_E1D533264CD8D52E_OFFSET UNITYSDK_OFFSET(0x18C5D1C0)
#define RPG_GAMECORE_ADVSETTARGETALERTVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C5D130)
