...
#define RPG_GAMECORE_WAITGETMUSEUMEXHIBIT_METHOD_3_0C056349F876838B_OFFSET UNITYSDK_OFFSET(0x17153100)
#define RPG_GAMECORE_WAITGETMUSEUMEXHIBIT_METHOD_3_ED66DD5196F6BE27_OFFSET UNITYSDK_OFFSET(0x17153250)
#define RPG_GAMECORE_WAITGETMUSEUMEXHIBIT__CTOR_OFFSET UNITYSDK_OFFSET(0x171531C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitGetMuseumExhibit_TypeDefinitionIndex = 19846;
