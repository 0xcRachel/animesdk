...
#define RPG_GAMECORE_STOPSUMMONUNITGAMEPLAY_METHOD_3_328C5361A86B543E_OFFSET UNITYSDK_OFFSET(0x16F9EF30)
#define RPG_GAMECORE_STOPSUMMONUNITGAMEPLAY_METHOD_3_88EBF1531CEED2AF_OFFSET UNITYSDK_OFFSET(0x16F9EFB0)
#define RPG_GAMECORE_STOPSUMMONUNITGAMEPLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x16F9EF80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StopSummonUnitGameplay_TypeDefinitionIndex = 18939;
