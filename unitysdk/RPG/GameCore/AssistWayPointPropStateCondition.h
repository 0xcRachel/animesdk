...
#define RPG_GAMECORE_ASSISTWAYPOINTPROPSTATECONDITION_METHOD_3_18ADC697CA3F92EB_OFFSET UNITYSDK_OFFSET(0x1688FEC0)
#define RPG_GAMECORE_ASSISTWAYPOINTPROPSTATECONDITION_METHOD_3_30496A545DFDD1DE_OFFSET UNITYSDK_OFFSET(0x1688EFF0)
#define RPG_GAMECORE_ASSISTWAYPOINTPROPSTATECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1688EFE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AssistWayPointPropStateCondition_TypeDefinitionIndex = 17005;
