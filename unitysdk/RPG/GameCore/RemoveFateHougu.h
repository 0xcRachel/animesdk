...
#define RPG_GAMECORE_REMOVEFATEHOUGU_METHOD_3_48C4AAFA75698B14_OFFSET UNITYSDK_OFFSET(0x16DDF410)
#define RPG_GAMECORE_REMOVEFATEHOUGU_METHOD_3_97E876498DF6DD56_OFFSET UNITYSDK_OFFSET(0x16DDF530)
#define RPG_GAMECORE_REMOVEFATEHOUGU__CTOR_OFFSET UNITYSDK_OFFSET(0x16DDF4B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveFateHougu_TypeDefinitionIndex = 20971;
