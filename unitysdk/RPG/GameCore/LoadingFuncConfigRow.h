...
#define RPG_GAMECORE_LOADINGFUNCCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16BD63E0)
#define RPG_GAMECORE_LOADINGFUNCCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16BD6650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoadingFuncConfigRow_TypeDefinitionIndex = 12701;
	...
	public:
		...
		::RPG::GameCore::LoadingFuncType LoadingFuncType; // 0x20
