...
#define RPG_GAMECORE_FIGHTFESTCOACHSKILLROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16A9F550)
#define RPG_GAMECORE_FIGHTFESTCOACHSKILLROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16A9FD70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FightFestCoachSkillRow_TypeDefinitionIndex = 12057;
	...
	public:
		...
		::System::UInt32 CoachItemID; // 0x34
		::RPG::Client::TextID CoachSkillName; // 0x38
		::RPG::Client::TextID CoachSkillExtraDesc; // 0x48
