...
#define RPG_GAMECORE_SETENTITYFORCEVISIBLE_METHOD_3_E73A19A77FEB1BD6_OFFSET UNITYSDK_OFFSET(0x16F2ABD0)
#define RPG_GAMECORE_SETENTITYFORCEVISIBLE_METHOD_3_FBEB0ED19959FE0C_OFFSET UNITYSDK_OFFSET(0x16F2AB50)
#define RPG_GAMECORE_SETENTITYFORCEVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F2ABA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetEntityForceVisible_TypeDefinitionIndex = 18392;
