...
#define RPG_GAMECORE_SPECIALRESTARTBATTLEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16F7F550)
#define RPG_GAMECORE_SPECIALRESTARTBATTLEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16F7F6C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SpecialRestartBattleRow_TypeDefinitionIndex = 13787;
