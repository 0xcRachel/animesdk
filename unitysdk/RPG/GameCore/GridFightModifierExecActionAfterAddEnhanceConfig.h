...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERADDENHANCECONFIG_METHOD_3_28ADE70705BB48BC_OFFSET UNITYSDK_OFFSET(0x1957CAF0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERADDENHANCECONFIG_METHOD_3_9894EC1A00DB0FC5_OFFSET UNITYSDK_OFFSET(0x19580240)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERADDENHANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1957CAA0)
