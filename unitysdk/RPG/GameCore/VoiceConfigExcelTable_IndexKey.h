...
#define RPG_GAMECORE_VOICECONFIGEXCELTABLE_INDEXKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x29260)
#define RPG_GAMECORE_VOICECONFIGEXCELTABLE_INDEXKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x59D0)
#define RPG_GAMECORE_VOICECONFIGEXCELTABLE_INDEXKEY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x2019600)
#define RPG_GAMECORE_VOICECONFIGEXCELTABLE_INDEXKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x29250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VoiceConfigExcelTable_IndexKey_TypeDefinitionIndex = 14052;
