...
#define RPG_GAMECORE_TEAMLEADERRUNNING_METHOD_3_043C0ED3FDDCB3C1_OFFSET UNITYSDK_OFFSET(0x1789BF40)
#define RPG_GAMECORE_TEAMLEADERRUNNING_METHOD_3_87329BE787B6885A_OFFSET UNITYSDK_OFFSET(0x178AA2D0)
#define RPG_GAMECORE_TEAMLEADERRUNNING__CTOR_OFFSET UNITYSDK_OFFSET(0x1789BF10)
