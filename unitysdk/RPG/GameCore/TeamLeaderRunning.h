...
#define RPG_GAMECORE_TEAMLEADERRUNNING_METHOD_3_043C0ED3FDDCB3C1_OFFSET UNITYSDK_OFFSET(0x170EAD10)
#define RPG_GAMECORE_TEAMLEADERRUNNING_METHOD_3_87329BE787B6885A_OFFSET UNITYSDK_OFFSET(0x170EAC90)
#define RPG_GAMECORE_TEAMLEADERRUNNING__CTOR_OFFSET UNITYSDK_OFFSET(0x170EACE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TeamLeaderRunning_TypeDefinitionIndex = 18751;
