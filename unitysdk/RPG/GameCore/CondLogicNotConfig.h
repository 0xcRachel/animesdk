...
#define RPG_GAMECORE_CONDLOGICNOTCONFIG_METHOD_4_480FDCAFD45CFA83_OFFSET UNITYSDK_OFFSET(0x18F9D0B0)
#define RPG_GAMECORE_CONDLOGICNOTCONFIG_METHOD_4_C1EF9C2E91CBECCE_OFFSET UNITYSDK_OFFSET(0x18F9CF70)
#define RPG_GAMECORE_CONDLOGICNOTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18F9D030)
