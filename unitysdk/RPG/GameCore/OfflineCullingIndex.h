...
#define RPG_GAMECORE_OFFLINECULLINGINDEX_METHOD_2_538B1F6B67BE399B_OFFSET UNITYSDK_OFFSET(0x1748ED20)
#define RPG_GAMECORE_OFFLINECULLINGINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1748F180)
