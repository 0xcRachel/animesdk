...
#define RPG_GAMECORE_OFFLINECULLINGINDEX_METHOD_2_538B1F6B67BE399B_OFFSET UNITYSDK_OFFSET(0x16D08460)
#define RPG_GAMECORE_OFFLINECULLINGINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x16D088C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OfflineCullingIndex_TypeDefinitionIndex = 17175;
