...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::RtBattleCharacterCameraTag>**)Il2CppClass::FromTypeDefinitionIndex(RtBattleCharacterCameraConfig___O_TypeDefinitionIndex)->GetStaticField(0x34C40);
		}
	};
}
