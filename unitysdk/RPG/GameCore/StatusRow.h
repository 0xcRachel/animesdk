...
#define RPG_GAMECORE_STATUSROW_CONTAINSTAG_OFFSET UNITYSDK_OFFSET(0x16F9CAB0)
#define RPG_GAMECORE_STATUSROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x16F9A4A0)
#define RPG_GAMECORE_STATUSROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16F9A970)
#define RPG_GAMECORE_STATUSROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x16F9CA10)
#define RPG_GAMECORE_STATUSROW_RESET_OFFSET UNITYSDK_OFFSET(0x16F9CA70)
#define RPG_GAMECORE_STATUSROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16F9CAA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StatusRow_TypeDefinitionIndex = 13795;

	class StatusRow : public ::System::Object
	{
	public:
		::Il2CppArray<::RPG::GameCore::EnumStatusTag>* TagList; // 0x10
		::System::String* StatusIconPathHighSize; // 0x18
		...
		::RPG::GameCore::EnumStatusType StatusType; // 0x40
		::RPG::Client::TextID StatusEffect; // 0x48
