...
#define RPG_GAMECORE_SETCHARACTERFORMATION_METHOD_3_0C2FECA127A92F59_OFFSET UNITYSDK_OFFSET(0x16F0CA50)
#define RPG_GAMECORE_SETCHARACTERFORMATION_METHOD_3_FED157FC32A60A3A_OFFSET UNITYSDK_OFFSET(0x16F0C910)
#define RPG_GAMECORE_SETCHARACTERFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x16F0C9C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCharacterFormation_TypeDefinitionIndex = 20276;
