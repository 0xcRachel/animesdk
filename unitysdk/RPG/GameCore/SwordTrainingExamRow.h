...
#define RPG_GAMECORE_SWORDTRAININGEXAMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x198661F0)
#define RPG_GAMECORE_SWORDTRAININGEXAMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19866660)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 FailPerformID; // 0x50
