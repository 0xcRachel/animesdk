...
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONINFO_METHOD_2_4E33AA8EB7CFF56A_OFFSET UNITYSDK_OFFSET(0x1735C2B0)
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONINFO_METHOD_2_6D549C05EA2497F8_OFFSET UNITYSDK_OFFSET(0x1735C600)
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1735AEF0)
