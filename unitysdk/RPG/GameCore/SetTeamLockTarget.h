...
#define RPG_GAMECORE_SETTEAMLOCKTARGET_METHOD_3_287B754919770E7D_OFFSET UNITYSDK_OFFSET(0x1A7A0F00)
#define RPG_GAMECORE_SETTEAMLOCKTARGET_METHOD_3_E140920797034C41_OFFSET UNITYSDK_OFFSET(0x1A7A0E80)
#define RPG_GAMECORE_SETTEAMLOCKTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7A0ED0)
