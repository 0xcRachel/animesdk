...
#define RPG_GAMECORE_SETBATTLETARGETDIALOGOFFSET_METHOD_3_A68EEBCBE2E2597B_OFFSET UNITYSDK_OFFSET(0x1A1E6590)
#define RPG_GAMECORE_SETBATTLETARGETDIALOGOFFSET_METHOD_3_FE2DE4C65872F9D2_OFFSET UNITYSDK_OFFSET(0x1A1E6610)
#define RPG_GAMECORE_SETBATTLETARGETDIALOGOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1E65E0)
