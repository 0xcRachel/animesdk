...
#define RPG_GAMECORE_ROGUECONDTOURNROOMTYPECONFIG_METHOD_6_4C4D496939216E17_OFFSET UNITYSDK_OFFSET(0x176010E0)
#define RPG_GAMECORE_ROGUECONDTOURNROOMTYPECONFIG_METHOD_6_94C87626C8E2A8BB_OFFSET UNITYSDK_OFFSET(0x17600F20)
#define RPG_GAMECORE_ROGUECONDTOURNROOMTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17601020)
