...
#define RPG_GAMECORE_FLOORCUSTOMDATACONFIG_METHOD_2_892DC0BA527FD00F_OFFSET UNITYSDK_OFFSET(0x1A3ADDC0)
#define RPG_GAMECORE_FLOORCUSTOMDATACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3ADF80)
