...
#define RPG_GAMECORE_ADVNPCPATROL_METHOD_3_02EE9E976B64A2FA_OFFSET UNITYSDK_OFFSET(0x1683BB40)
#define RPG_GAMECORE_ADVNPCPATROL_METHOD_3_BA314B0541647ED2_OFFSET UNITYSDK_OFFSET(0x1683BBD0)
#define RPG_GAMECORE_ADVNPCPATROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1683BBA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNPCPatrol_TypeDefinitionIndex = 17732;
