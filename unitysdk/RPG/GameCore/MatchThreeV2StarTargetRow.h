...
#define RPG_GAMECORE_MATCHTHREEV2STARTARGETROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16C67A90)
#define RPG_GAMECORE_MATCHTHREEV2STARTARGETROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16C67CD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MatchThreeV2StarTargetRow_TypeDefinitionIndex = 10918;
