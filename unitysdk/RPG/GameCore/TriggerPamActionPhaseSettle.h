...
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASESETTLE_METHOD_3_0B0AACFD3204AE8B_OFFSET UNITYSDK_OFFSET(0x1911BA20)
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASESETTLE_METHOD_3_39E21FE64A37CDFF_OFFSET UNITYSDK_OFFSET(0x1911BB30)
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASESETTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1911BB00)
