...
#define RPG_GAMECORE_ACTIONSETBLACKBOARDVALUECONFIG_METHOD_4_667D9F51418CC109_OFFSET UNITYSDK_OFFSET(0x1988C220)
#define RPG_GAMECORE_ACTIONSETBLACKBOARDVALUECONFIG_METHOD_4_9D33E9B4FD69A996_OFFSET UNITYSDK_OFFSET(0x1988BFD0)
#define RPG_GAMECORE_ACTIONSETBLACKBOARDVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1988C130)
