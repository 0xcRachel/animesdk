...
#define RPG_GAMECORE_SETBATTLECONDITIONPROGRESS_METHOD_3_1FA5437C87D12A6F_OFFSET UNITYSDK_OFFSET(0x1A1E5330)
#define RPG_GAMECORE_SETBATTLECONDITIONPROGRESS_METHOD_3_9386764161BEC05E_OFFSET UNITYSDK_OFFSET(0x1A1E52A0)
#define RPG_GAMECORE_SETBATTLECONDITIONPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1E5300)
