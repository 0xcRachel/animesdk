...
#define RPG_GAMECORE_BYCOMPAREGROUPSTATE_METHOD_4_8B9CCD7A6DF2067C_OFFSET UNITYSDK_OFFSET(0x18FD58F0)
#define RPG_GAMECORE_BYCOMPAREGROUPSTATE_METHOD_4_C93AAE7418A6A698_OFFSET UNITYSDK_OFFSET(0x18FD5810)
#define RPG_GAMECORE_BYCOMPAREGROUPSTATE_METHOD_4_D5D3F36C45379070_OFFSET UNITYSDK_OFFSET(0x18FD5B30)
#define RPG_GAMECORE_BYCOMPAREGROUPSTATE_METHOD_4_F2523DB02C3430ED_OFFSET UNITYSDK_OFFSET(0x18FD5AB0)
#define RPG_GAMECORE_BYCOMPAREGROUPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18FD5890)
