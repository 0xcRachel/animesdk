...
#define RPG_GAMECORE_BYCOMPARESPRATIO_METHOD_4_6C537CDD615403F4_OFFSET UNITYSDK_OFFSET(0x16918DB0)
#define RPG_GAMECORE_BYCOMPARESPRATIO_METHOD_4_F375440F2DC42FF6_OFFSET UNITYSDK_OFFSET(0x16918E80)
#define RPG_GAMECORE_BYCOMPARESPRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x16918E30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareSPRatio_TypeDefinitionIndex = 20652;
