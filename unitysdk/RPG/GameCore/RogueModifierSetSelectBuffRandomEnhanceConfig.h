...
#define RPG_GAMECORE_ROGUEMODIFIERSETSELECTBUFFRANDOMENHANCECONFIG_METHOD_3_6C0EB268EAAD27B7_OFFSET UNITYSDK_OFFSET(0x16EA2960)
#define RPG_GAMECORE_ROGUEMODIFIERSETSELECTBUFFRANDOMENHANCECONFIG_METHOD_3_E55187651EE3568E_OFFSET UNITYSDK_OFFSET(0x16E9D410)
#define RPG_GAMECORE_ROGUEMODIFIERSETSELECTBUFFRANDOMENHANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E9D3C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierSetSelectBuffRandomEnhanceConfig_TypeDefinitionIndex = 16149;
