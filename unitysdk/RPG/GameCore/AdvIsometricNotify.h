...
#define RPG_GAMECORE_ADVISOMETRICNOTIFY_METHOD_3_1D9AF81D2B2FBE6C_OFFSET UNITYSDK_OFFSET(0x19BE3D60)
#define RPG_GAMECORE_ADVISOMETRICNOTIFY_METHOD_3_DCE0DBD4AFF1D888_OFFSET UNITYSDK_OFFSET(0x19BE3B80)
#define RPG_GAMECORE_ADVISOMETRICNOTIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x19BE3C80)
