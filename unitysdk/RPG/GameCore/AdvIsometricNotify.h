...
#define RPG_GAMECORE_ADVISOMETRICNOTIFY_METHOD_3_1D9AF81D2B2FBE6C_OFFSET UNITYSDK_OFFSET(0x16838B00)
#define RPG_GAMECORE_ADVISOMETRICNOTIFY_METHOD_3_DCE0DBD4AFF1D888_OFFSET UNITYSDK_OFFSET(0x16838920)
#define RPG_GAMECORE_ADVISOMETRICNOTIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x16838A20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvIsometricNotify_TypeDefinitionIndex = 19862;
