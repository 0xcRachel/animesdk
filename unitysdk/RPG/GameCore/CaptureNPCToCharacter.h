...
#define RPG_GAMECORE_CAPTURENPCTOCHARACTER_METHOD_3_13F05A60B4C1F423_OFFSET UNITYSDK_OFFSET(0x17067C30)
#define RPG_GAMECORE_CAPTURENPCTOCHARACTER_METHOD_3_2D1FAAED58BA46D3_OFFSET UNITYSDK_OFFSET(0x17067CB0)
#define RPG_GAMECORE_CAPTURENPCTOCHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x17067C80)
