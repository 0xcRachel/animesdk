...
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMSTRINGV2_METHOD_4_60E3FCF181DE4806_OFFSET UNITYSDK_OFFSET(0x1690C6B0)
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMSTRINGV2_METHOD_4_87309496852D89B4_OFFSET UNITYSDK_OFFSET(0x1690C790)
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMSTRINGV2__CTOR_OFFSET UNITYSDK_OFFSET(0x1690C730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareFloorCustomStringV2_TypeDefinitionIndex = 18500;
