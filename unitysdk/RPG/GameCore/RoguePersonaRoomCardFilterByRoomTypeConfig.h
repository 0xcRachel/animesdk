...
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYROOMTYPECONFIG_METHOD_3_998E9B1FB95D8E0A_OFFSET UNITYSDK_OFFSET(0x1766C1E0)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYROOMTYPECONFIG_METHOD_3_B3148174849D1BCE_OFFSET UNITYSDK_OFFSET(0x1766C490)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYROOMTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1766C1D0)
