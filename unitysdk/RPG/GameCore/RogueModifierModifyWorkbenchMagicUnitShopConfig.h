...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHMAGICUNITSHOPCONFIG_METHOD_3_7F8CCEE644E20153_OFFSET UNITYSDK_OFFSET(0x1764AF90)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHMAGICUNITSHOPCONFIG_METHOD_3_F1E7671503A2C88A_OFFSET UNITYSDK_OFFSET(0x1764B060)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHMAGICUNITSHOPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1764B010)
