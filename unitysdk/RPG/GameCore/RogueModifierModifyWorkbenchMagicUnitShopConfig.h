...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHMAGICUNITSHOPCONFIG_METHOD_3_7F8CCEE644E20153_OFFSET UNITYSDK_OFFSET(0x16EA12C0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHMAGICUNITSHOPCONFIG_METHOD_3_F1E7671503A2C88A_OFFSET UNITYSDK_OFFSET(0x16E9AD90)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHMAGICUNITSHOPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E9AD40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyWorkbenchMagicUnitShopConfig_TypeDefinitionIndex = 16063;
