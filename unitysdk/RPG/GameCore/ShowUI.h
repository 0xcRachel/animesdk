...
#define RPG_GAMECORE_SHOWUI_METHOD_3_6A99478263A527EA_OFFSET UNITYSDK_OFFSET(0x16F65D00)
#define RPG_GAMECORE_SHOWUI_METHOD_3_7B0ED04179FD33C0_OFFSET UNITYSDK_OFFSET(0x16F65C80)
#define RPG_GAMECORE_SHOWUI__CTOR_OFFSET UNITYSDK_OFFSET(0x16F65CD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowUI_TypeDefinitionIndex = 21555;
