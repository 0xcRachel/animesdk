...
#define RPG_GAMECORE_RESETACTIONDELAY_METHOD_3_0E77CF49700CCEA8_OFFSET UNITYSDK_OFFSET(0x16DE4620)
#define RPG_GAMECORE_RESETACTIONDELAY_METHOD_3_9DED3DFE360A0D2A_OFFSET UNITYSDK_OFFSET(0x16DE46A0)
#define RPG_GAMECORE_RESETACTIONDELAY__CTOR_OFFSET UNITYSDK_OFFSET(0x16DE4670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetActionDelay_TypeDefinitionIndex = 20965;
