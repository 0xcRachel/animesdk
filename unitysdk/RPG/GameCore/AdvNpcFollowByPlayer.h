...
#define RPG_GAMECORE_ADVNPCFOLLOWBYPLAYER_METHOD_3_D17314141ABB6AA2_OFFSET UNITYSDK_OFFSET(0x1683DC40)
#define RPG_GAMECORE_ADVNPCFOLLOWBYPLAYER_METHOD_3_F7965E6CE18B421D_OFFSET UNITYSDK_OFFSET(0x1683DCE0)
#define RPG_GAMECORE_ADVNPCFOLLOWBYPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1683DCA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNpcFollowByPlayer_TypeDefinitionIndex = 17744;
