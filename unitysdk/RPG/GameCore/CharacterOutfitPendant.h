...
#define RPG_GAMECORE_CHARACTEROUTFITPENDANT_METHOD_2_0605CCA380D7C6F9_OFFSET UNITYSDK_OFFSET(0x16972810)
#define RPG_GAMECORE_CHARACTEROUTFITPENDANT__CTOR_OFFSET UNITYSDK_OFFSET(0x16972A00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterOutfitPendant_TypeDefinitionIndex = 15786;
