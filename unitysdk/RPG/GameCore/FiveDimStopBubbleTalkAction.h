...
#define RPG_GAMECORE_FIVEDIMSTOPBUBBLETALKACTION_METHOD_3_74B97D3336460AC3_OFFSET UNITYSDK_OFFSET(0x191F49B0)
#define RPG_GAMECORE_FIVEDIMSTOPBUBBLETALKACTION_METHOD_3_897FB4F89661C262_OFFSET UNITYSDK_OFFSET(0x191F4A70)
#define RPG_GAMECORE_FIVEDIMSTOPBUBBLETALKACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x191F4A50)
