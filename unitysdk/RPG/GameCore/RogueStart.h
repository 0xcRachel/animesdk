...
#define RPG_GAMECORE_ROGUESTART_METHOD_3_BF883BE0C5DD94DC_OFFSET UNITYSDK_OFFSET(0x16EBA120)
#define RPG_GAMECORE_ROGUESTART_METHOD_3_CE6523B372114ECD_OFFSET UNITYSDK_OFFSET(0x16EBA1A0)
#define RPG_GAMECORE_ROGUESTART__CTOR_OFFSET UNITYSDK_OFFSET(0x16EBA170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueStart_TypeDefinitionIndex = 19923;
