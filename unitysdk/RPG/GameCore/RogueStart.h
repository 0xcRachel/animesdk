...
#define RPG_GAMECORE_ROGUESTART_METHOD_3_BF883BE0C5DD94DC_OFFSET UNITYSDK_OFFSET(0x1766EFA0)
#define RPG_GAMECORE_ROGUESTART_METHOD_3_CE6523B372114ECD_OFFSET UNITYSDK_OFFSET(0x1766F020)
#define RPG_GAMECORE_ROGUESTART__CTOR_OFFSET UNITYSDK_OFFSET(0x1766EFF0)
