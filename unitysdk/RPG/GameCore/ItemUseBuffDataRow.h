...
#define RPG_GAMECORE_ITEMUSEBUFFDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B97410)
#define RPG_GAMECORE_ITEMUSEBUFFDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B97F70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ItemUseBuffDataRow_TypeDefinitionIndex = 12614;
	...
	public:
		...
		::Il2CppArray<::RPG::GameCore::FixPoint>* MazeBuffParam2; // 0x28
		::System::UInt32 ConsumeType; // 0x30
		::RPG::GameCore::ItemFoodTargetType UseTargetType; // 0x34
		::System::UInt32 UseMultipleMax; // 0x38
		::System::UInt32 MazeBuffID2; // 0x3C
		::System::Single PreviewHPRecoveryValue; // 0x40
		::System::Boolean IsCheckHP; // 0x44
		::System::Boolean IsShowItemDesc; // 0x45
		::System::Boolean IsShowUseMultipleSlider; // 0x46
		::System::Single PreviewPowerPercent; // 0x48
		::System::UInt32 ActivityCount; // 0x4C
		::System::Single PreviewSkillPoint; // 0x50
