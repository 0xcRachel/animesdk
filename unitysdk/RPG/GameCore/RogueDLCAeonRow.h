...
#define RPG_GAMECORE_ROGUEDLCAEONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x192530C0)
#define RPG_GAMECORE_ROGUEDLCAEONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19253D70)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::String* EntrancePrefabPath; // 0x10
		...
		::RPG::Client::TextID EffectDesc2; // 0x50
		::RPG::Client::TextID EffectDesc1; // 0x60
		::RPG::GameCore::ModifierEffectType EffectType1; // 0x70
		::System::UInt32 RogueAeonDisplayID; // 0x74
		::System::UInt32 Sort; // 0x78
		::System::UInt32 UnlockID; // 0x7C
		::RPG::Client::TextID PlayShortDesc; // 0x80
		::System::UInt32 RogueBuffType; // 0x90
		::System::UInt32 AeonID; // 0x94
		::RPG::GameCore::ModifierEffectType EffectType2; // 0x98
		::System::UInt32 BattleEventEnhanceBuffGroup; // 0x9C
		::System::UInt32 BattleEventBuffGroup; // 0xA0
