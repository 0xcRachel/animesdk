...
#define RPG_GAMECORE_MARBLEBYCOMPARESKILLROUND_METHOD_4_2291BE262C307FE7_OFFSET UNITYSDK_OFFSET(0x18FE8980)
#define RPG_GAMECORE_MARBLEBYCOMPARESKILLROUND_METHOD_4_C734367F8BBD0A31_OFFSET UNITYSDK_OFFSET(0x18FE8A60)
#define RPG_GAMECORE_MARBLEBYCOMPARESKILLROUND__CTOR_OFFSET UNITYSDK_OFFSET(0x18FE8A10)
