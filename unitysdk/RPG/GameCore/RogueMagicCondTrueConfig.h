...
#define RPG_GAMECORE_ROGUEMAGICCONDTRUECONFIG_METHOD_7_7BBEC5C8FD0532D2_OFFSET UNITYSDK_OFFSET(0x1996CC30)
#define RPG_GAMECORE_ROGUEMAGICCONDTRUECONFIG_METHOD_7_7C301402A1EA8B7C_OFFSET UNITYSDK_OFFSET(0x1996CEE0)
#define RPG_GAMECORE_ROGUEMAGICCONDTRUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1996CDB0)
