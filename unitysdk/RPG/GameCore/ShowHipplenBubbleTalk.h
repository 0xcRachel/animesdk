...
#define RPG_GAMECORE_SHOWHIPPLENBUBBLETALK_METHOD_3_BBADCB6F8B8BACC4_OFFSET UNITYSDK_OFFSET(0x177138F0)
#define RPG_GAMECORE_SHOWHIPPLENBUBBLETALK_METHOD_3_EBBAA119287BA65E_OFFSET UNITYSDK_OFFSET(0x17713860)
#define RPG_GAMECORE_SHOWHIPPLENBUBBLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x177138C0)
