...
#define RPG_GAMECORE_ADVOVERRIDECAMERAMODULECONFIG_METHOD_3_589733C0044C1DC0_OFFSET UNITYSDK_OFFSET(0x18C54500)
#define RPG_GAMECORE_ADVOVERRIDECAMERAMODULECONFIG_METHOD_3_FA7920B91F921C55_OFFSET UNITYSDK_OFFSET(0x18C54480)
#define RPG_GAMECORE_ADVOVERRIDECAMERAMODULECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18C544D0)
