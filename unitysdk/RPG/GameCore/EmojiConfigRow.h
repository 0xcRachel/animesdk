...
#define RPG_GAMECORE_EMOJICONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16A66150)
#define RPG_GAMECORE_EMOJICONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16A67480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EmojiConfigRow_TypeDefinitionIndex = 12000;

	class EmojiConfigRow : public ::System::Object
	{
	public:
		::System::String* EmojiPath; // 0x10
		::System::UInt32 GenderLink; // 0x18
		::System::UInt32 SameGroupOrder; // 0x1C
		::RPG::GameCore::EmojiGenderEnum Gender; // 0x20
		::System::UInt32 EmojiID; // 0x24
