...
#define RPG_GAMECORE_EMOJICONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19154FB0)
#define RPG_GAMECORE_EMOJICONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19156320)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean IsTrainMembers; // 0x1C
		::System::UInt32 EmojiGroupID; // 0x20
		::System::UInt32 GenderLink; // 0x24
		::RPG::GameCore::EmojiGenderEnum Gender; // 0x28
