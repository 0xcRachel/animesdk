...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURCAMPIDCONFIG_METHOD_6_858F58C4D19FB967_OFFSET UNITYSDK_OFFSET(0x1A1AA0A0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURCAMPIDCONFIG_METHOD_6_BF1200E99E67E0B1_OFFSET UNITYSDK_OFFSET(0x1A1A9DF0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURCAMPIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1A9F70)
