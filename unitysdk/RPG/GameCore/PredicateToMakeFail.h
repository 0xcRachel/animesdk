...
#define RPG_GAMECORE_PREDICATETOMAKEFAIL_METHOD_3_4753A87FD3BE224C_OFFSET UNITYSDK_OFFSET(0x1A2D0840)
#define RPG_GAMECORE_PREDICATETOMAKEFAIL_METHOD_3_F6C2D01ED273045A_OFFSET UNITYSDK_OFFSET(0x1A2D07C0)
#define RPG_GAMECORE_PREDICATETOMAKEFAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2D0810)
