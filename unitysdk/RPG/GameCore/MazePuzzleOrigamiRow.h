...
#define RPG_GAMECORE_MAZEPUZZLEORIGAMIROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1908EB80)
#define RPG_GAMECORE_MAZEPUZZLEORIGAMIROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1908EF90)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 MirrorGroupID; // 0x1C
		::System::UInt32 GroupID; // 0x20
		::System::UInt32 ColonyID; // 0x24
		::RPG::GameCore::PropState TargetSubPropState; // 0x28
		::System::UInt32 MirrorMainPropID; // 0x2C
		::System::UInt32 NpcInstanceID; // 0x30
		::System::UInt32 SubPropID; // 0x34
		::System::UInt32 NpcGroupID; // 0x38
		::System::UInt32 MainPropID; // 0x3C
		::RPG::GameCore::PropState CreateNpcPropState; // 0x40
