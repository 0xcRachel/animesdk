...
#define RPG_GAMECORE_TRIGGERMAZEMINIMAPUI_METHOD_3_A9F1C8E8A4AF1357_OFFSET UNITYSDK_OFFSET(0x1911A420)
#define RPG_GAMECORE_TRIGGERMAZEMINIMAPUI_METHOD_3_AB067C7BFC61E143_OFFSET UNITYSDK_OFFSET(0x1911A310)
#define RPG_GAMECORE_TRIGGERMAZEMINIMAPUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1911A3F0)
