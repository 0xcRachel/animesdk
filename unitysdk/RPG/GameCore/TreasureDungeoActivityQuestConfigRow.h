...
#define RPG_GAMECORE_TREASUREDUNGEOACTIVITYQUESTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17110E90)
#define RPG_GAMECORE_TREASUREDUNGEOACTIVITYQUESTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17111550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TreasureDungeoActivityQuestConfigRow_TypeDefinitionIndex = 11368;
