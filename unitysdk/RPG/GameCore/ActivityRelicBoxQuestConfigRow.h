...
#define RPG_GAMECORE_ACTIVITYRELICBOXQUESTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18DA7250)
#define RPG_GAMECORE_ACTIVITYRELICBOXQUESTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18DA73F0)
