...
#define RPG_GAMECORE_ACTIVITYFEVERTIMEQUESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16793880)
#define RPG_GAMECORE_ACTIVITYFEVERTIMEQUESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16793EC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityFeverTimeQuestRow_TypeDefinitionIndex = 10719;
