...
#define RPG_GAMECORE_DICECOMBATV2SINGLEDIALOGPERFORMANCETRIGGERCONDITION_BOSSCHANGEPHASE_METHOD_3_5A6DB1817D0A4B20_OFFSET UNITYSDK_OFFSET(0x1A0A0D40)
#define RPG_GAMECORE_DICECOMBATV2SINGLEDIALOGPERFORMANCETRIGGERCONDITION_BOSSCHANGEPHASE_METHOD_3_61B7F5FD6B22396C_OFFSET UNITYSDK_OFFSET(0x1A0A1060)
#define RPG_GAMECORE_DICECOMBATV2SINGLEDIALOGPERFORMANCETRIGGERCONDITION_BOSSCHANGEPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0A0D30)
