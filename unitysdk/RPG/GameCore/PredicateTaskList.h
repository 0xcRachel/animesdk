...
#define RPG_GAMECORE_PREDICATETASKLIST_METHOD_3_8A8481413F886A70_OFFSET UNITYSDK_OFFSET(0x1A2D0130)
#define RPG_GAMECORE_PREDICATETASKLIST_METHOD_3_A0726820766CD54D_OFFSET UNITYSDK_OFFSET(0x1A2D0580)
#define RPG_GAMECORE_PREDICATETASKLIST_METHOD_3_EA6739731D6A904C_OFFSET UNITYSDK_OFFSET(0x1A2D01B0)
#define RPG_GAMECORE_PREDICATETASKLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2D0180)
