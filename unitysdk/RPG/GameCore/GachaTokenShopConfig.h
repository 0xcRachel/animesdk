...
#define RPG_GAMECORE_GACHATOKENSHOPCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16AF2490)
#define RPG_GAMECORE_GACHATOKENSHOPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16AF2580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GachaTokenShopConfig_TypeDefinitionIndex = 12123;
