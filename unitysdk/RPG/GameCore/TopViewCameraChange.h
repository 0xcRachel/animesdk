...
#define RPG_GAMECORE_TOPVIEWCAMERACHANGE_METHOD_3_133684657F9274D4_OFFSET UNITYSDK_OFFSET(0x170FAC30)
#define RPG_GAMECORE_TOPVIEWCAMERACHANGE_METHOD_3_37388A7F73471162_OFFSET UNITYSDK_OFFSET(0x170FAB90)
#define RPG_GAMECORE_TOPVIEWCAMERACHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x170FABF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TopViewCameraChange_TypeDefinitionIndex = 21439;
