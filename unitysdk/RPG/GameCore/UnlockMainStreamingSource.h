...
#define RPG_GAMECORE_UNLOCKMAINSTREAMINGSOURCE_METHOD_3_481CBBA5183EB411_OFFSET UNITYSDK_OFFSET(0x178FB8A0)
#define RPG_GAMECORE_UNLOCKMAINSTREAMINGSOURCE_METHOD_3_BEB953562151DCDD_OFFSET UNITYSDK_OFFSET(0x178FB790)
#define RPG_GAMECORE_UNLOCKMAINSTREAMINGSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x178FB870)
