...
#define RPG_GAMECORE_UNLOCKMAINSTREAMINGSOURCE_METHOD_3_481CBBA5183EB411_OFFSET UNITYSDK_OFFSET(0x19513300)
#define RPG_GAMECORE_UNLOCKMAINSTREAMINGSOURCE_METHOD_3_BEB953562151DCDD_OFFSET UNITYSDK_OFFSET(0x195131F0)
#define RPG_GAMECORE_UNLOCKMAINSTREAMINGSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x195132D0)
