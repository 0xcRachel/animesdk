...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYQUERYFACTORCONFIG_METHOD_3_592D491E14DCD0C9_OFFSET UNITYSDK_OFFSET(0x16E99890)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYQUERYFACTORCONFIG_METHOD_3_85FFE01D84C957F0_OFFSET UNITYSDK_OFFSET(0x16EA06C0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYQUERYFACTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E99840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyQueryFactorConfig_TypeDefinitionIndex = 16137;
