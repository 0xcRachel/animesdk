...
#define RPG_GAMECORE_RTBATTLETARGETCAMERAFOCUSTARGET_METHOD_4_2211AD7C90AB7C6C_OFFSET UNITYSDK_OFFSET(0x18E77C30)
#define RPG_GAMECORE_RTBATTLETARGETCAMERAFOCUSTARGET_METHOD_4_2D2FDDF86B9B9FAE_OFFSET UNITYSDK_OFFSET(0x18E77B00)
#define RPG_GAMECORE_RTBATTLETARGETCAMERAFOCUSTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x18E77BE0)
