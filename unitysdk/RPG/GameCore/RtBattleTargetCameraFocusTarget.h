...
#define RPG_GAMECORE_RTBATTLETARGETCAMERAFOCUSTARGET_METHOD_4_2211AD7C90AB7C6C_OFFSET UNITYSDK_OFFSET(0x19418B70)
#define RPG_GAMECORE_RTBATTLETARGETCAMERAFOCUSTARGET_METHOD_4_2D2FDDF86B9B9FAE_OFFSET UNITYSDK_OFFSET(0x19418A40)
#define RPG_GAMECORE_RTBATTLETARGETCAMERAFOCUSTARGET_METHOD_4_468255E3864077C5_OFFSET UNITYSDK_OFFSET(0x19418BD0)
#define RPG_GAMECORE_RTBATTLETARGETCAMERAFOCUSTARGET_METHOD_4_D69B50D08B20B0BC_OFFSET UNITYSDK_OFFSET(0x19418C50)
#define RPG_GAMECORE_RTBATTLETARGETCAMERAFOCUSTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x19418B20)
