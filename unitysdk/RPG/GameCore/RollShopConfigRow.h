...
#define RPG_GAMECORE_ROLLSHOPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19410420)
#define RPG_GAMECORE_ROLLSHOPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19410840)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 CostItemNum; // 0x1C
		::RPG::Client::TextID ShopName; // 0x20
		::System::UInt32 T3GroupID; // 0x30
		::System::UInt32 SecretGroupID; // 0x34
		::System::UInt32 CostItemID; // 0x38
		::System::UInt32 RollShopID; // 0x3C
		::RPG::GameCore::RollShopType RollShopType; // 0x40
		::System::Int32 IntroduceID; // 0x44
		::System::UInt32 T2GroupID; // 0x48
		::System::UInt32 T1GroupID; // 0x4C
