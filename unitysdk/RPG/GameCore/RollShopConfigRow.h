...
#define RPG_GAMECORE_ROLLSHOPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1983ED80)
#define RPG_GAMECORE_ROLLSHOPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1983F1B0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 T1GroupID; // 0x2C
		::System::UInt32 CostItemNum; // 0x30
		::System::UInt32 T2GroupID; // 0x34
		::System::UInt32 T3GroupID; // 0x38
		::System::Int32 IntroduceID; // 0x3C
		::System::UInt32 T4GroupID; // 0x40
		::System::UInt32 RollShopID; // 0x44
