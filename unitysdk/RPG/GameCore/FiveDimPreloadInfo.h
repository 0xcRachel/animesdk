...
#define RPG_GAMECORE_FIVEDIMPRELOADINFO_METHOD_2_7B27258F9759C2D5_OFFSET UNITYSDK_OFFSET(0x17217E00)
#define RPG_GAMECORE_FIVEDIMPRELOADINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x17217F40)
