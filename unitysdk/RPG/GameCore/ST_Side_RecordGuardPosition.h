...
#define RPG_GAMECORE_ST_SIDE_RECORDGUARDPOSITION_METHOD_4_55FACA78510074A7_OFFSET UNITYSDK_OFFSET(0x192DDCE0)
#define RPG_GAMECORE_ST_SIDE_RECORDGUARDPOSITION_METHOD_4_C781F9A157C524F8_OFFSET UNITYSDK_OFFSET(0x192DDB70)
#define RPG_GAMECORE_ST_SIDE_RECORDGUARDPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x192DDC90)
