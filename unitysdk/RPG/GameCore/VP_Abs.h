...
#define RPG_GAMECORE_VP_ABS_METHOD_3_4C424A12BB0190C1_OFFSET UNITYSDK_OFFSET(0x1951D8C0)
#define RPG_GAMECORE_VP_ABS_METHOD_3_E8F401B3C9B986AC_OFFSET UNITYSDK_OFFSET(0x1951D840)
#define RPG_GAMECORE_VP_ABS__CTOR_OFFSET UNITYSDK_OFFSET(0x1951D8B0)
