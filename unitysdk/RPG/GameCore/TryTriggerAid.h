...
#define RPG_GAMECORE_TRYTRIGGERAID_METHOD_3_0B10079365CE8FCD_OFFSET UNITYSDK_OFFSET(0x1712A380)
#define RPG_GAMECORE_TRYTRIGGERAID_METHOD_3_1682F96EAB3AF4F4_OFFSET UNITYSDK_OFFSET(0x1712A400)
#define RPG_GAMECORE_TRYTRIGGERAID__CTOR_OFFSET UNITYSDK_OFFSET(0x1712A3D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TryTriggerAid_TypeDefinitionIndex = 21326;
