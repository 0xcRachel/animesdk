...
#define RPG_GAMECORE_MAPPINGINFOENTRANCECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16C349F0)
#define RPG_GAMECORE_MAPPINGINFOENTRANCECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16C34F30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MappingInfoEntranceConfigRow_TypeDefinitionIndex = 11408;
