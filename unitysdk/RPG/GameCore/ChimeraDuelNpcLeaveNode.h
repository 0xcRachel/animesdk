...
#define RPG_GAMECORE_CHIMERADUELNPCLEAVENODE_METHOD_3_35DBC84190ABE729_OFFSET UNITYSDK_OFFSET(0x194C3820)
#define RPG_GAMECORE_CHIMERADUELNPCLEAVENODE_METHOD_3_F4545A477B83DE07_OFFSET UNITYSDK_OFFSET(0x194C3740)
#define RPG_GAMECORE_CHIMERADUELNPCLEAVENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x194C37D0)
