...
#define RPG_GAMECORE_GRIDFIGHTBASICBONUSCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B1B6D0)
#define RPG_GAMECORE_GRIDFIGHTBASICBONUSCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B1B8E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightBasicBonusConfigRow_TypeDefinitionIndex = 12194;
