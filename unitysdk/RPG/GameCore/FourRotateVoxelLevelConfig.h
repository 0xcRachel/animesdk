...
#define RPG_GAMECORE_FOURROTATEVOXELLEVELCONFIG_METHOD_2_8FB4D1F3A0781C71_OFFSET UNITYSDK_OFFSET(0x172303D0)
#define RPG_GAMECORE_FOURROTATEVOXELLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17230E20)
