...
#define RPG_GAMECORE_FOURROTATEVOXELLEVELCONFIG_METHOD_2_8FB4D1F3A0781C71_OFFSET UNITYSDK_OFFSET(0x16AE4DF0)
#define RPG_GAMECORE_FOURROTATEVOXELLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16AE5840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxelLevelConfig_TypeDefinitionIndex = 15086;
