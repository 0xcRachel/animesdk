...
#define RPG_GAMECORE_FATEACTREMOVEMASTERAFFIXBYRARITYCONFIG_METHOD_6_13375462211A3FB1_OFFSET UNITYSDK_OFFSET(0x19470E90)
#define RPG_GAMECORE_FATEACTREMOVEMASTERAFFIXBYRARITYCONFIG_METHOD_6_DBCBA06C2100A41A_OFFSET UNITYSDK_OFFSET(0x19471000)
#define RPG_GAMECORE_FATEACTREMOVEMASTERAFFIXBYRARITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19470F60)
