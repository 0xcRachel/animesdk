...
#define RPG_GAMECORE_MINIEMOEFFECTOVERRIDE_METHOD_2_5301E3BF8600DCBE_OFFSET UNITYSDK_OFFSET(0x16CA9150)
#define RPG_GAMECORE_MINIEMOEFFECTOVERRIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x16CA9620)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MiniEmoEffectOverride_TypeDefinitionIndex = 19503;
