...
#define RPG_GAMECORE_BYCURRENTSKILLTARGETTYPE_METHOD_4_58F7ED50A6F5D029_OFFSET UNITYSDK_OFFSET(0x17033B80)
#define RPG_GAMECORE_BYCURRENTSKILLTARGETTYPE_METHOD_4_C3D92E64A73FB331_OFFSET UNITYSDK_OFFSET(0x17033C50)
#define RPG_GAMECORE_BYCURRENTSKILLTARGETTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x17033C00)
