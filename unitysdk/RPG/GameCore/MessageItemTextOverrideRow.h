...
#define RPG_GAMECORE_MESSAGEITEMTEXTOVERRIDEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16C869E0)
#define RPG_GAMECORE_MESSAGEITEMTEXTOVERRIDEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16C86B80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MessageItemTextOverrideRow_TypeDefinitionIndex = 13147;
