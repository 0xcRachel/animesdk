...
#define RPG_GAMECORE_PLAYPENACONYENDMOSTSIMPLETALK_METHOD_3_09F201307237FC54_OFFSET UNITYSDK_OFFSET(0x16D51DF0)
#define RPG_GAMECORE_PLAYPENACONYENDMOSTSIMPLETALK_METHOD_3_5448CFCAC689CE17_OFFSET UNITYSDK_OFFSET(0x16D51D70)
#define RPG_GAMECORE_PLAYPENACONYENDMOSTSIMPLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x16D51DC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayPenaconyEndmostSimpleTalk_TypeDefinitionIndex = 19465;
