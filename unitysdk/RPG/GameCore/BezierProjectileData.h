...
#define RPG_GAMECORE_BEZIERPROJECTILEDATA_METHOD_3_5E2BDD7186B2CFD3_OFFSET UNITYSDK_OFFSET(0x168E80C0)
#define RPG_GAMECORE_BEZIERPROJECTILEDATA_METHOD_3_D07B4CB153A5D6B2_OFFSET UNITYSDK_OFFSET(0x168E8110)
#define RPG_GAMECORE_BEZIERPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x168E8100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BezierProjectileData_TypeDefinitionIndex = 14244;
