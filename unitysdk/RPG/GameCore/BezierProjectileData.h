...
#define RPG_GAMECORE_BEZIERPROJECTILEDATA_METHOD_3_5E2BDD7186B2CFD3_OFFSET UNITYSDK_OFFSET(0x16FF8F20)
#define RPG_GAMECORE_BEZIERPROJECTILEDATA_METHOD_3_D07B4CB153A5D6B2_OFFSET UNITYSDK_OFFSET(0x16FF8F70)
#define RPG_GAMECORE_BEZIERPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16FF8F60)
