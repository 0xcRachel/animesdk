...
#define RPG_GAMECORE_AVATARPATHCHANGECONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x168A8C80)
#define RPG_GAMECORE_AVATARPATHCHANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x168A8F20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarPathChangeConfig_TypeDefinitionIndex = 21887;
