...
#define RPG_GAMECORE_ACTIVITYFINDTROTTERCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x198A9760)
#define RPG_GAMECORE_ACTIVITYFINDTROTTERCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x198A9CA0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 StartSubMissionID; // 0x20
		::System::UInt32 FinishSubMissionID; // 0x24
		...
		::RPG::Client::TextID Result02; // 0x58
		::System::UInt32 ActivityID; // 0x68
		::System::UInt32 RewardQuestID; // 0x6C
