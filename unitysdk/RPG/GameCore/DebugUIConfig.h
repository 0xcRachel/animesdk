...
#define RPG_GAMECORE_DEBUGUICONFIG_METHOD_2_3F9CA5EFCEA9DE8D_OFFSET UNITYSDK_OFFSET(0x169E5EE0)
#define RPG_GAMECORE_DEBUGUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x169E60E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DebugUIConfig_TypeDefinitionIndex = 14813;
