...
#define RPG_GAMECORE_ROGUECONDWITHDIFFICULTYCOMPCONFIG_METHOD_6_217C86008C138F18_OFFSET UNITYSDK_OFFSET(0x1924A9C0)
#define RPG_GAMECORE_ROGUECONDWITHDIFFICULTYCOMPCONFIG_METHOD_6_8EC7435823D5C29E_OFFSET UNITYSDK_OFFSET(0x1924AC70)
#define RPG_GAMECORE_ROGUECONDWITHDIFFICULTYCOMPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1924AB40)
