...
#define RPG_GAMECORE_STARTMARBLEPVECHALLENGEMATCH_METHOD_3_4112E1487E6220B8_OFFSET UNITYSDK_OFFSET(0x16F955C0)
#define RPG_GAMECORE_STARTMARBLEPVECHALLENGEMATCH_METHOD_3_82914627142BE141_OFFSET UNITYSDK_OFFSET(0x16F95640)
#define RPG_GAMECORE_STARTMARBLEPVECHALLENGEMATCH__CTOR_OFFSET UNITYSDK_OFFSET(0x16F95610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartMarblePVEChallengeMatch_TypeDefinitionIndex = 19048;
