...
#define RPG_GAMECORE_SETSUMMONERENERGYBARSTATE_METHOD_3_018161101C05D0B8_OFFSET UNITYSDK_OFFSET(0x16F3F480)
#define RPG_GAMECORE_SETSUMMONERENERGYBARSTATE_METHOD_3_1FFFE78EF1780D47_OFFSET UNITYSDK_OFFSET(0x16F3F360)
#define RPG_GAMECORE_SETSUMMONERENERGYBARSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F3F3A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetSummonerEnergyBarState_TypeDefinitionIndex = 20375;
