...
#define RPG_GAMECORE_SETADVENTUREDYNAMICVALUE_METHOD_3_47FFA5EA5A3446ED_OFFSET UNITYSDK_OFFSET(0x192EB5C0)
#define RPG_GAMECORE_SETADVENTUREDYNAMICVALUE_METHOD_3_CF1DEA531996F262_OFFSET UNITYSDK_OFFSET(0x192EB550)
#define RPG_GAMECORE_SETADVENTUREDYNAMICVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x192EB590)
