...
#define RPG_GAMECORE_FOURROTATEVOXELCHESTHINTCONFIG_METHOD_3_8D4E6578CA54099A_OFFSET UNITYSDK_OFFSET(0x16AE3830)
#define RPG_GAMECORE_FOURROTATEVOXELCHESTHINTCONFIG_METHOD_3_AE691D0393D3BF8C_OFFSET UNITYSDK_OFFSET(0x16AE38C0)
#define RPG_GAMECORE_FOURROTATEVOXELCHESTHINTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16AE38A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxelChestHintConfig_TypeDefinitionIndex = 15110;
	...
	public:
		...
		static ::System::Void Method_3_8D4E6578CA54099A(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::FourRotateVoxelChestHintConfig*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::FourRotateVoxelChestHintConfig*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_FOURROTATEVOXELCHESTHINTCONFIG_METHOD_3_8D4E6578CA54099A_OFFSET))(a1, a2);
		}
