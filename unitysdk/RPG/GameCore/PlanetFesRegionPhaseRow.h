...
#define RPG_GAMECORE_PLANETFESREGIONPHASEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18B34700)
#define RPG_GAMECORE_PLANETFESREGIONPHASEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18B34A80)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 ProgressValue; // 0x2C
