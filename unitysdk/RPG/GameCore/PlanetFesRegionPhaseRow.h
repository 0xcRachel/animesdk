...
#define RPG_GAMECORE_PLANETFESREGIONPHASEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19D510D0)
#define RPG_GAMECORE_PLANETFESREGIONPHASEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19D51450)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 ProgressValue; // 0x24
