...
#define RPG_GAMECORE_STOPSERIALBELLS_METHOD_3_07CFE74849AB282D_OFFSET UNITYSDK_OFFSET(0x16F9EB60)
#define RPG_GAMECORE_STOPSERIALBELLS_METHOD_3_89C0CBDC9EBF8AB9_OFFSET UNITYSDK_OFFSET(0x16F9EA50)
#define RPG_GAMECORE_STOPSERIALBELLS__CTOR_OFFSET UNITYSDK_OFFSET(0x16F9EB30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StopSerialBells_TypeDefinitionIndex = 18338;
