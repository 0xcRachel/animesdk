...
#define RPG_GAMECORE_ADVBYCHECKWINDOWPERMCODES_METHOD_4_370DCC57ECA7694A_OFFSET UNITYSDK_OFFSET(0x167C2A40)
#define RPG_GAMECORE_ADVBYCHECKWINDOWPERMCODES_METHOD_4_CEB3F36967968EA1_OFFSET UNITYSDK_OFFSET(0x167C2B10)
#define RPG_GAMECORE_ADVBYCHECKWINDOWPERMCODES__CTOR_OFFSET UNITYSDK_OFFSET(0x167C2AC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByCheckWindowPermCodes_TypeDefinitionIndex = 19065;
