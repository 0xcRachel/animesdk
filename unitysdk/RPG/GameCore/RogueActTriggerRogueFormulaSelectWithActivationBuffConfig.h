...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEFORMULASELECTWITHACTIVATIONBUFFCONFIG_METHOD_6_065DE09249BA9635_OFFSET UNITYSDK_OFFSET(0x1A9B8F60)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEFORMULASELECTWITHACTIVATIONBUFFCONFIG_METHOD_6_AEADB06C81058FF8_OFFSET UNITYSDK_OFFSET(0x1A9B8D40)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEFORMULASELECTWITHACTIVATIONBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9B8E80)
