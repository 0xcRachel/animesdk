...
#define RPG_GAMECORE_REPLACETRIALPLAYER_METHOD_3_061C173784733352_OFFSET UNITYSDK_OFFSET(0x1902ABF0)
#define RPG_GAMECORE_REPLACETRIALPLAYER_METHOD_3_589A86E848583AD2_OFFSET UNITYSDK_OFFSET(0x1902AC80)
#define RPG_GAMECORE_REPLACETRIALPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1902AC50)
