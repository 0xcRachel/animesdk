...
#define RPG_GAMECORE_MANIKINPETCONFIG_METHOD_2_A355C17B5CAA7D1D_OFFSET UNITYSDK_OFFSET(0x18FD7980)
#define RPG_GAMECORE_MANIKINPETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18FD7C50)
