...
#define RPG_GAMECORE_TAROTBOOKREADREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16FF5AF0)
#define RPG_GAMECORE_TAROTBOOKREADREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16FF5C30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TarotBookReadRewardRow_TypeDefinitionIndex = 13856;
