...
#define RPG_GAMECORE_MUTEENTITYSOUND_METHOD_3_6467977E62ECABC7_OFFSET UNITYSDK_OFFSET(0x16CF8410)
#define RPG_GAMECORE_MUTEENTITYSOUND_METHOD_3_C2E1DB7E860E92A3_OFFSET UNITYSDK_OFFSET(0x16CF8390)
#define RPG_GAMECORE_MUTEENTITYSOUND__CTOR_OFFSET UNITYSDK_OFFSET(0x16CF83E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MuteEntitySound_TypeDefinitionIndex = 19844;
