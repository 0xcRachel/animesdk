...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::EntranceShowType>**)Il2CppClass::FromTypeDefinitionIndex(FuncUnlockConfigRow___O_TypeDefinitionIndex)->GetStaticField(0x441C0);
		}
	};
}
