...
#define RPG_GAMECORE_COMPONENTCONFIG_METHOD_2_A8EBF78230E22F38_OFFSET UNITYSDK_OFFSET(0x18F9C1D0)
#define RPG_GAMECORE_COMPONENTCONFIG_METHOD_2_F366EDE048C147AD_OFFSET UNITYSDK_OFFSET(0x18F9BD40)
#define RPG_GAMECORE_COMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18F9C1C0)
