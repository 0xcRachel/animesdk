...
#define RPG_GAMECORE_COMPONENTCONFIG_METHOD_2_A8EBF78230E22F38_OFFSET UNITYSDK_OFFSET(0x169C27A0)
#define RPG_GAMECORE_COMPONENTCONFIG_METHOD_2_F366EDE048C147AD_OFFSET UNITYSDK_OFFSET(0x169C2320)
#define RPG_GAMECORE_COMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x169B8A10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComponentConfig_TypeDefinitionIndex = 14910;
