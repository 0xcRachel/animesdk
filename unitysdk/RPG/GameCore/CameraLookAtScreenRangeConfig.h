...
#define RPG_GAMECORE_CAMERALOOKATSCREENRANGECONFIG_METHOD_2_023088A00DFD821B_OFFSET UNITYSDK_OFFSET(0x16955220)
#define RPG_GAMECORE_CAMERALOOKATSCREENRANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16955390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CameraLookAtScreenRangeConfig_TypeDefinitionIndex = 18287;
