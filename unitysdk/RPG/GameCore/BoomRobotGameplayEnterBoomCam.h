...
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYENTERBOOMCAM_METHOD_3_0CE6A0E1BC8282B2_OFFSET UNITYSDK_OFFSET(0x187C2380)
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYENTERBOOMCAM_METHOD_3_B024B62639C9D71B_OFFSET UNITYSDK_OFFSET(0x187C2400)
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYENTERBOOMCAM__CTOR_OFFSET UNITYSDK_OFFSET(0x187C23D0)
