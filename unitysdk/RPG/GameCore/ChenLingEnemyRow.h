...
#define RPG_GAMECORE_CHENLINGENEMYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17099BF0)
#define RPG_GAMECORE_CHENLINGENEMYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1709A0F0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::FixPoint CrtRatio; // 0x28
		::RPG::GameCore::FixPoint HpRatio; // 0x30
		::System::UInt32 ID; // 0x38
		::System::UInt32 GridIndex; // 0x3C
		::System::UInt32 Level; // 0x40
		::RPG::GameCore::FixPoint AtkRatio; // 0x48
		::System::UInt32 SoldierID; // 0x50
		::System::Boolean IsPromotion; // 0x54
