...
#define RPG_GAMECORE_CHENLINGENEMYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A4FB050)
#define RPG_GAMECORE_CHENLINGENEMYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4FB540)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::FixPoint AtkSpdRatio; // 0x48
