...
#define RPG_GAMECORE_PHOTOGRAPHAVATARCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16D34DB0)
#define RPG_GAMECORE_PHOTOGRAPHAVATARCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16D34F00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphAvatarConfigRow_TypeDefinitionIndex = 13153;
