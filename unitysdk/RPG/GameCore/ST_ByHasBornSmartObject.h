...
#define RPG_GAMECORE_ST_BYHASBORNSMARTOBJECT_METHOD_4_85DD6ED0892EFD76_OFFSET UNITYSDK_OFFSET(0x1A17D0C0)
#define RPG_GAMECORE_ST_BYHASBORNSMARTOBJECT_METHOD_4_90E233486B204D5F_OFFSET UNITYSDK_OFFSET(0x1A17CE30)
#define RPG_GAMECORE_ST_BYHASBORNSMARTOBJECT_METHOD_4_CA8C2F819098DAAE_OFFSET UNITYSDK_OFFSET(0x1A17D040)
#define RPG_GAMECORE_ST_BYHASBORNSMARTOBJECT_METHOD_4_F04A42BC3CAF86B5_OFFSET UNITYSDK_OFFSET(0x1A17CF00)
#define RPG_GAMECORE_ST_BYHASBORNSMARTOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A17CEB0)
