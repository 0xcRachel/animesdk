...
#define RPG_GAMECORE_ST_BYHASBORNSMARTOBJECT_METHOD_4_90E233486B204D5F_OFFSET UNITYSDK_OFFSET(0x16EF0430)
#define RPG_GAMECORE_ST_BYHASBORNSMARTOBJECT_METHOD_4_F04A42BC3CAF86B5_OFFSET UNITYSDK_OFFSET(0x16EF0500)
#define RPG_GAMECORE_ST_BYHASBORNSMARTOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x16EF04B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByHasBornSmartObject_TypeDefinitionIndex = 17841;
