...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_9EB2CB86795DEEF1_DelegateParseJson_1<::RPG::GameCore::SkillType>**)Il2CppClass::FromTypeDefinitionIndex(ByIsInsertAction___O_TypeDefinitionIndex)->GetStaticField(0xA960);
		}
	};
}
