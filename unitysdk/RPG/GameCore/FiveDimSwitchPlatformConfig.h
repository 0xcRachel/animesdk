...
#define RPG_GAMECORE_FIVEDIMSWITCHPLATFORMCONFIG_METHOD_3_28688FF7CAFE7655_OFFSET UNITYSDK_OFFSET(0x16AD8680)
#define RPG_GAMECORE_FIVEDIMSWITCHPLATFORMCONFIG_METHOD_3_2DD881798A95F04D_OFFSET UNITYSDK_OFFSET(0x16AD8610)
#define RPG_GAMECORE_FIVEDIMSWITCHPLATFORMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16AD8660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSwitchPlatformConfig_TypeDefinitionIndex = 16657;
