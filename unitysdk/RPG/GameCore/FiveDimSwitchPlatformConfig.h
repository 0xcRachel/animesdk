...
#define RPG_GAMECORE_FIVEDIMSWITCHPLATFORMCONFIG_METHOD_3_5A4AA0A18EE8F32B_OFFSET UNITYSDK_OFFSET(0x1A3A8C20)
#define RPG_GAMECORE_FIVEDIMSWITCHPLATFORMCONFIG_METHOD_3_FB917A4ED3313D74_OFFSET UNITYSDK_OFFSET(0x1A3A8BB0)
#define RPG_GAMECORE_FIVEDIMSWITCHPLATFORMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3A8C00)
