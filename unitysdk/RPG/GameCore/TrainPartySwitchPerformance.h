...
#define RPG_GAMECORE_TRAINPARTYSWITCHPERFORMANCE_METHOD_3_36F0372891913F38_OFFSET UNITYSDK_OFFSET(0x178C5270)
#define RPG_GAMECORE_TRAINPARTYSWITCHPERFORMANCE_METHOD_3_FCF9119EFE01C0BA_OFFSET UNITYSDK_OFFSET(0x178C52F0)
#define RPG_GAMECORE_TRAINPARTYSWITCHPERFORMANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x178C52C0)
