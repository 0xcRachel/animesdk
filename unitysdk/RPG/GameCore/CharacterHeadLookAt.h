...
#define RPG_GAMECORE_CHARACTERHEADLOOKAT_METHOD_3_4C6DBD36A1A6B8D2_OFFSET UNITYSDK_OFFSET(0x1696FA70)
#define RPG_GAMECORE_CHARACTERHEADLOOKAT_METHOD_3_7DA8D231D3282CC8_OFFSET UNITYSDK_OFFSET(0x1696F9D0)
#define RPG_GAMECORE_CHARACTERHEADLOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1696FA30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterHeadLookAt_TypeDefinitionIndex = 18670;
