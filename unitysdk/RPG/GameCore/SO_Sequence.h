...
#define RPG_GAMECORE_SO_SEQUENCE_METHOD_5_2F7A41C2AB439412_OFFSET UNITYSDK_OFFSET(0x16EDAA40)
#define RPG_GAMECORE_SO_SEQUENCE_METHOD_5_A4D3722C3F62A7E2_OFFSET UNITYSDK_OFFSET(0x16EDD080)
#define RPG_GAMECORE_SO_SEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x16EDAA10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SO_Sequence_TypeDefinitionIndex = 17813;
