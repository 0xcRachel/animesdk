...
#define RPG_GAMECORE_SETEFFECTANIMATORPARAMETER_METHOD_3_09511807A5DE0381_OFFSET UNITYSDK_OFFSET(0x176DD570)
#define RPG_GAMECORE_SETEFFECTANIMATORPARAMETER_METHOD_3_BEABCCAB6C676C92_OFFSET UNITYSDK_OFFSET(0x176DD720)
#define RPG_GAMECORE_SETEFFECTANIMATORPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x176DD660)
