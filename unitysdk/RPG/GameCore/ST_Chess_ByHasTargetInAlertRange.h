...
#define RPG_GAMECORE_ST_CHESS_BYHASTARGETINALERTRANGE_METHOD_4_0F17730DDFA22E68_OFFSET UNITYSDK_OFFSET(0x16EF1D50)
#define RPG_GAMECORE_ST_CHESS_BYHASTARGETINALERTRANGE_METHOD_4_B1BE89CDFE20C042_OFFSET UNITYSDK_OFFSET(0x16EF1E20)
#define RPG_GAMECORE_ST_CHESS_BYHASTARGETINALERTRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16EF1DD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Chess_ByHasTargetInAlertRange_TypeDefinitionIndex = 21442;
