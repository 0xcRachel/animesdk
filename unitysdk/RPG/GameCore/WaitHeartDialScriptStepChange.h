...
#define RPG_GAMECORE_WAITHEARTDIALSCRIPTSTEPCHANGE_METHOD_3_73853BDDDD835DA3_OFFSET UNITYSDK_OFFSET(0x17154380)
#define RPG_GAMECORE_WAITHEARTDIALSCRIPTSTEPCHANGE_METHOD_3_9E6D4D2D483E7AF3_OFFSET UNITYSDK_OFFSET(0x171542F0)
#define RPG_GAMECORE_WAITHEARTDIALSCRIPTSTEPCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x17154350)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitHeartDialScriptStepChange_TypeDefinitionIndex = 18993;
