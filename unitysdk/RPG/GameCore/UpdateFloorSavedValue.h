...
#define RPG_GAMECORE_UPDATEFLOORSAVEDVALUE_METHOD_3_1A787CBD54186202_OFFSET UNITYSDK_OFFSET(0x19A6A530)
#define RPG_GAMECORE_UPDATEFLOORSAVEDVALUE_METHOD_3_76BE4E8005202442_OFFSET UNITYSDK_OFFSET(0x19A6A4A0)
#define RPG_GAMECORE_UPDATEFLOORSAVEDVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x19A6A500)
