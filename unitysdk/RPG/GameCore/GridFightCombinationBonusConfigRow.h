...
#define RPG_GAMECORE_GRIDFIGHTCOMBINATIONBONUSCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x195685D0)
#define RPG_GAMECORE_GRIDFIGHTCOMBINATIONBONUSCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19568770)
