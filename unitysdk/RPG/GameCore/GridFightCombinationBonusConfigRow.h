...
#define RPG_GAMECORE_GRIDFIGHTCOMBINATIONBONUSCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B1C3F0)
#define RPG_GAMECORE_GRIDFIGHTCOMBINATIONBONUSCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B1C590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightCombinationBonusConfigRow_TypeDefinitionIndex = 12192;
