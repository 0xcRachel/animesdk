...
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYBOOMEND_METHOD_3_25E0B33CBC08F10C_OFFSET UNITYSDK_OFFSET(0x187C1900)
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYBOOMEND_METHOD_3_6C26EC058C697698_OFFSET UNITYSDK_OFFSET(0x187C1A10)
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYBOOMEND__CTOR_OFFSET UNITYSDK_OFFSET(0x187C19E0)
