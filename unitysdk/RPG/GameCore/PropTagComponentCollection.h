...
#define RPG_GAMECORE_PROPTAGCOMPONENTCOLLECTION_METHOD_2_3ADCD16ADFB993C6_OFFSET UNITYSDK_OFFSET(0x16DA4BE0)
#define RPG_GAMECORE_PROPTAGCOMPONENTCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16DB9D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropTagComponentCollection_TypeDefinitionIndex = 15872;
