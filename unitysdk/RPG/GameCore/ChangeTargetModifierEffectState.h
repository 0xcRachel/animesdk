...
#define RPG_GAMECORE_CHANGETARGETMODIFIEREFFECTSTATE_METHOD_3_5A978C4B9A5F455B_OFFSET UNITYSDK_OFFSET(0x169674D0)
#define RPG_GAMECORE_CHANGETARGETMODIFIEREFFECTSTATE_METHOD_3_E3477340100A4016_OFFSET UNITYSDK_OFFSET(0x16967450)
#define RPG_GAMECORE_CHANGETARGETMODIFIEREFFECTSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x169674A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeTargetModifierEffectState_TypeDefinitionIndex = 20101;
