...
#define RPG_GAMECORE_CHANGETARGETMODIFIEREFFECTSTATE_METHOD_3_5A978C4B9A5F455B_OFFSET UNITYSDK_OFFSET(0x17078C80)
#define RPG_GAMECORE_CHANGETARGETMODIFIEREFFECTSTATE_METHOD_3_E3477340100A4016_OFFSET UNITYSDK_OFFSET(0x17078C00)
#define RPG_GAMECORE_CHANGETARGETMODIFIEREFFECTSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17078C50)
