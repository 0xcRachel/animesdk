...
#define RPG_GAMECORE_SETUPPAMAIDIALOGUE_METHOD_3_14421D5CABE283AA_OFFSET UNITYSDK_OFFSET(0x16F45070)
#define RPG_GAMECORE_SETUPPAMAIDIALOGUE_METHOD_3_F815646CCA6822BE_OFFSET UNITYSDK_OFFSET(0x16F44F60)
#define RPG_GAMECORE_SETUPPAMAIDIALOGUE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F45040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetUpPamAIDialogue_TypeDefinitionIndex = 18886;
