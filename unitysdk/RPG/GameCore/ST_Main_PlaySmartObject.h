...
#define RPG_GAMECORE_ST_MAIN_PLAYSMARTOBJECT_METHOD_4_8F1EF31CD6C33B83_OFFSET UNITYSDK_OFFSET(0x16EE5290)
#define RPG_GAMECORE_ST_MAIN_PLAYSMARTOBJECT_METHOD_4_B21087AA77116508_OFFSET UNITYSDK_OFFSET(0x16EF73B0)
#define RPG_GAMECORE_ST_MAIN_PLAYSMARTOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x16EE5240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_PlaySmartObject_TypeDefinitionIndex = 17882;
