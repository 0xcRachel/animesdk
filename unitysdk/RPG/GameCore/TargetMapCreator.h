...
#define RPG_GAMECORE_TARGETMAPCREATOR_METHOD_3_6963DF70E8A01A78_OFFSET UNITYSDK_OFFSET(0x16FE2110)
#define RPG_GAMECORE_TARGETMAPCREATOR_METHOD_3_F60E08B86302AAA4_OFFSET UNITYSDK_OFFSET(0x16FE2240)
#define RPG_GAMECORE_TARGETMAPCREATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE2220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapCreator_TypeDefinitionIndex = 21667;
