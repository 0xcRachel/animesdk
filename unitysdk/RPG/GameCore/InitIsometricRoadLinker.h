...
#define RPG_GAMECORE_INITISOMETRICROADLINKER_METHOD_3_3E11F4F908D0BA72_OFFSET UNITYSDK_OFFSET(0x16B81C40)
#define RPG_GAMECORE_INITISOMETRICROADLINKER_METHOD_3_A677D672CBC6CFCB_OFFSET UNITYSDK_OFFSET(0x16B81D90)
#define RPG_GAMECORE_INITISOMETRICROADLINKER__CTOR_OFFSET UNITYSDK_OFFSET(0x16B81D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InitIsometricRoadLinker_TypeDefinitionIndex = 19854;
