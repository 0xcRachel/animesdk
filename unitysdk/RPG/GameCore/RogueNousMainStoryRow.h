...
#define RPG_GAMECORE_ROGUENOUSMAINSTORYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16EAC160)
#define RPG_GAMECORE_ROGUENOUSMAINSTORYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16EAC970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueNousMainStoryRow_TypeDefinitionIndex = 13569;
