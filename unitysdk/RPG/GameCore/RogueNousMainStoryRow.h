...
#define RPG_GAMECORE_ROGUENOUSMAINSTORYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x176576C0)
#define RPG_GAMECORE_ROGUENOUSMAINSTORYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17657E90)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 UnlockConditionDisplay; // 0x30
