...
#define RPG_GAMECORE_ADVENTUREPLAYVO_METHOD_3_136F2CFA50D25C17_OFFSET UNITYSDK_OFFSET(0x1685DAC0)
#define RPG_GAMECORE_ADVENTUREPLAYVO_METHOD_3_301706B1CB7FD866_OFFSET UNITYSDK_OFFSET(0x1685DA40)
#define RPG_GAMECORE_ADVENTUREPLAYVO__CTOR_OFFSET UNITYSDK_OFFSET(0x1685DA90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventurePlayVO_TypeDefinitionIndex = 18550;
