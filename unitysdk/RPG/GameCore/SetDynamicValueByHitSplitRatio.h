...
#define RPG_GAMECORE_SETDYNAMICVALUEBYHITSPLITRATIO_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1A1FC730)
#define RPG_GAMECORE_SETDYNAMICVALUEBYHITSPLITRATIO_METHOD_4_340DBF20D2D5A684_OFFSET UNITYSDK_OFFSET(0x1A1F6670)
#define RPG_GAMECORE_SETDYNAMICVALUEBYHITSPLITRATIO_METHOD_4_C708FC3B18EDAB1B_OFFSET UNITYSDK_OFFSET(0x1A1FC6B0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYHITSPLITRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1F6620)
