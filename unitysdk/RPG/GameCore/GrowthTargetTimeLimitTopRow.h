...
#define RPG_GAMECORE_GROWTHTARGETTIMELIMITTOPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x172A1DB0)
#define RPG_GAMECORE_GROWTHTARGETTIMELIMITTOPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x172A1ED0)
