...
#define RPG_GAMECORE_GROWTHTARGETTIMELIMITTOPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B536B0)
#define RPG_GAMECORE_GROWTHTARGETTIMELIMITTOPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B537D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GrowthTargetTimeLimitTopRow_TypeDefinitionIndex = 12142;
