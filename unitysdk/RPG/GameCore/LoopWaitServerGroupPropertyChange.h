...
#define RPG_GAMECORE_LOOPWAITSERVERGROUPPROPERTYCHANGE_METHOD_3_67604A541838EFF1_OFFSET UNITYSDK_OFFSET(0x16C20990)
#define RPG_GAMECORE_LOOPWAITSERVERGROUPPROPERTYCHANGE_METHOD_3_8B0B849A61AA5001_OFFSET UNITYSDK_OFFSET(0x16C20900)
#define RPG_GAMECORE_LOOPWAITSERVERGROUPPROPERTYCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16C20960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitServerGroupPropertyChange_TypeDefinitionIndex = 18957;
