...
#define RPG_GAMECORE_SHOWBATTLEUIINTIMELINE_METHOD_3_6F36E9C1E8336BCA_OFFSET UNITYSDK_OFFSET(0x16F55760)
#define RPG_GAMECORE_SHOWBATTLEUIINTIMELINE_METHOD_3_9CE461F452198E8B_OFFSET UNITYSDK_OFFSET(0x16F556E0)
#define RPG_GAMECORE_SHOWBATTLEUIINTIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F55730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowBattleUIInTimeline_TypeDefinitionIndex = 20574;
