...
#define RPG_GAMECORE_BATTLERAIDTARGETCHANGEPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0xA35DDB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleRaidTargetChangeParams_TypeDefinitionIndex = 46191;
