...
#define RPG_GAMECORE_BYCHECKBLOODLINKDEAD_METHOD_4_63C4D12E597B5410_OFFSET UNITYSDK_OFFSET(0x16900640)
#define RPG_GAMECORE_BYCHECKBLOODLINKDEAD_METHOD_4_6E02F0B058B0306A_OFFSET UNITYSDK_OFFSET(0x16900570)
#define RPG_GAMECORE_BYCHECKBLOODLINKDEAD__CTOR_OFFSET UNITYSDK_OFFSET(0x169005F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckBloodLinkDead_TypeDefinitionIndex = 20690;
