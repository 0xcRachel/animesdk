...
#define RPG_GAMECORE_MATCHTHREEVSTALKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16C680D0)
#define RPG_GAMECORE_MATCHTHREEVSTALKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16C682E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MatchThreeVsTalkRow_TypeDefinitionIndex = 10892;

	class MatchThreeVsTalkRow : public ::System::Object
	{
	public:
		::RPG::Client::TextID MyTalk; // 0x10
