...
#define RPG_GAMECORE_SHOWDELETEMISSIONDIALOG_METHOD_3_9CD7BD7A03A88CF2_OFFSET UNITYSDK_OFFSET(0x1770C820)
#define RPG_GAMECORE_SHOWDELETEMISSIONDIALOG_METHOD_3_D1ACDE9F4DA5C3CD_OFFSET UNITYSDK_OFFSET(0x1770C7A0)
#define RPG_GAMECORE_SHOWDELETEMISSIONDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1770C7F0)
