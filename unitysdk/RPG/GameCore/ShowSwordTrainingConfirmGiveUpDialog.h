...
#define RPG_GAMECORE_SHOWSWORDTRAININGCONFIRMGIVEUPDIALOG_METHOD_3_1EF96201D1856C0B_OFFSET UNITYSDK_OFFSET(0x16F63C40)
#define RPG_GAMECORE_SHOWSWORDTRAININGCONFIRMGIVEUPDIALOG_METHOD_3_4DD0D4EAE9B88B7F_OFFSET UNITYSDK_OFFSET(0x16F63D50)
#define RPG_GAMECORE_SHOWSWORDTRAININGCONFIRMGIVEUPDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F63D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowSwordTrainingConfirmGiveUpDialog_TypeDefinitionIndex = 18655;
