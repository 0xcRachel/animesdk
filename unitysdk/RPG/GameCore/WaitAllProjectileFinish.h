...
#define RPG_GAMECORE_WAITALLPROJECTILEFINISH_METHOD_3_5DEE8A5C0BD1D577_OFFSET UNITYSDK_OFFSET(0x1714C4A0)
#define RPG_GAMECORE_WAITALLPROJECTILEFINISH_METHOD_3_EEDE14E8B23CF263_OFFSET UNITYSDK_OFFSET(0x1714C390)
#define RPG_GAMECORE_WAITALLPROJECTILEFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1714C470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitAllProjectileFinish_TypeDefinitionIndex = 21220;
