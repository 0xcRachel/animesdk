...
#define RPG_GAMECORE_CLOSETIMEREWINDRECREATEWORLDPAGE_METHOD_3_3F70C7915DED8AC9_OFFSET UNITYSDK_OFFSET(0x1A31FF00)
#define RPG_GAMECORE_CLOSETIMEREWINDRECREATEWORLDPAGE_METHOD_3_B948EBBC064037BD_OFFSET UNITYSDK_OFFSET(0x1A320010)
#define RPG_GAMECORE_CLOSETIMEREWINDRECREATEWORLDPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A31FFE0)
