...
#define RPG_GAMECORE_CLOSETIMEREWINDRECREATEWORLDPAGE_METHOD_3_3F70C7915DED8AC9_OFFSET UNITYSDK_OFFSET(0x169B6570)
#define RPG_GAMECORE_CLOSETIMEREWINDRECREATEWORLDPAGE_METHOD_3_B948EBBC064037BD_OFFSET UNITYSDK_OFFSET(0x169B6680)
#define RPG_GAMECORE_CLOSETIMEREWINDRECREATEWORLDPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x169B6650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CloseTimeRewindRecreateWorldPage_TypeDefinitionIndex = 18462;
