...
#define RPG_GAMECORE_MISSIONRESCONFIG_METHOD_2_D78FA622F4325B8E_OFFSET UNITYSDK_OFFSET(0x16CAFD10)
#define RPG_GAMECORE_MISSIONRESCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16CAFEA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MissionResConfig_TypeDefinitionIndex = 17036;
