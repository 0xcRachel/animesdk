...
#define RPG_GAMECORE_FORBIDBATTLECONDITIONONSTART_METHOD_3_052DD92380D71B57_OFFSET UNITYSDK_OFFSET(0x16ADECB0)
#define RPG_GAMECORE_FORBIDBATTLECONDITIONONSTART_METHOD_3_06428CB6D889E943_OFFSET UNITYSDK_OFFSET(0x16ADEBA0)
#define RPG_GAMECORE_FORBIDBATTLECONDITIONONSTART__CTOR_OFFSET UNITYSDK_OFFSET(0x16ADEC80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ForbidBattleConditionOnStart_TypeDefinitionIndex = 21023;
