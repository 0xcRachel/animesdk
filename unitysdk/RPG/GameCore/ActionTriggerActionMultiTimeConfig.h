...
#define RPG_GAMECORE_ACTIONTRIGGERACTIONMULTITIMECONFIG_METHOD_4_0997F8B176ED00BE_OFFSET UNITYSDK_OFFSET(0x16EB2A80)
#define RPG_GAMECORE_ACTIONTRIGGERACTIONMULTITIMECONFIG_METHOD_4_D66C6130E0653A01_OFFSET UNITYSDK_OFFSET(0x16EB2D00)
#define RPG_GAMECORE_ACTIONTRIGGERACTIONMULTITIMECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16EB2BF0)
