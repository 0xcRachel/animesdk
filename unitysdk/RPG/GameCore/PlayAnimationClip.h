...
#define RPG_GAMECORE_PLAYANIMATIONCLIP_METHOD_3_30210606B87C53CC_OFFSET UNITYSDK_OFFSET(0x16D4D940)
#define RPG_GAMECORE_PLAYANIMATIONCLIP_METHOD_3_49EA3C5581A120DA_OFFSET UNITYSDK_OFFSET(0x16D4D8C0)
#define RPG_GAMECORE_PLAYANIMATIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x16D4D910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayAnimationClip_TypeDefinitionIndex = 18050;
