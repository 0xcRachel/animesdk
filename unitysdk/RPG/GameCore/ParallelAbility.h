...
#define RPG_GAMECORE_PARALLELABILITY_METHOD_2_F66BDF046C282114_OFFSET UNITYSDK_OFFSET(0x18EFBFB0)
#define RPG_GAMECORE_PARALLELABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x18EFC300)
