...
#define RPG_GAMECORE_FIVEDIMGECKOMOVECONFIG_METHOD_3_4ED652FEDD849A5A_OFFSET UNITYSDK_OFFSET(0x199F1B50)
#define RPG_GAMECORE_FIVEDIMGECKOMOVECONFIG_METHOD_3_82058E21A7901B8B_OFFSET UNITYSDK_OFFSET(0x199F1BB0)
#define RPG_GAMECORE_FIVEDIMGECKOMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x199F1B90)
