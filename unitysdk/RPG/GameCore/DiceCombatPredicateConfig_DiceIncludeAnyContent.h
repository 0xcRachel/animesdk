...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_DICEINCLUDEANYCONTENT_METHOD_4_67F511A8CD77C1BF_OFFSET UNITYSDK_OFFSET(0x19599610)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_DICEINCLUDEANYCONTENT_METHOD_4_B5DF58F115306E12_OFFSET UNITYSDK_OFFSET(0x19596500)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_DICEINCLUDEANYCONTENT__CTOR_OFFSET UNITYSDK_OFFSET(0x195964B0)
