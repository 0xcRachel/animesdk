...
#define RPG_GAMECORE_CHALLENGESTORYTHEMECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17073E40)
#define RPG_GAMECORE_CHALLENGESTORYTHEMECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x170740A0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* ThemeSubColor1; // 0x20
		::System::String* ThemeBgPrefabPath; // 0x28
