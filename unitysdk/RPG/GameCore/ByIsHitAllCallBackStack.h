...
#define RPG_GAMECORE_BYISHITALLCALLBACKSTACK_METHOD_4_0DE4EE3F277B4BAB_OFFSET UNITYSDK_OFFSET(0x19DA79C0)
#define RPG_GAMECORE_BYISHITALLCALLBACKSTACK_METHOD_4_A1BEE485FBBE7801_OFFSET UNITYSDK_OFFSET(0x19DA7A90)
#define RPG_GAMECORE_BYISHITALLCALLBACKSTACK_METHOD_4_DBEF398311E0ED7A_OFFSET UNITYSDK_OFFSET(0x19DA7C50)
#define RPG_GAMECORE_BYISHITALLCALLBACKSTACK_METHOD_4_FEFB09D281EBD862_OFFSET UNITYSDK_OFFSET(0x19DA7BD0)
#define RPG_GAMECORE_BYISHITALLCALLBACKSTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19DA7A40)
