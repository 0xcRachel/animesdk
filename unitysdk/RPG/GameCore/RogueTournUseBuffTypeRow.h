...
#define RPG_GAMECORE_ROGUETOURNUSEBUFFTYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16ECFE90)
#define RPG_GAMECORE_ROGUETOURNUSEBUFFTYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16ECFFC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournUseBuffTypeRow_TypeDefinitionIndex = 13665;
