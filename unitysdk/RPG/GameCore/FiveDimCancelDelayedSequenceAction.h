...
#define RPG_GAMECORE_FIVEDIMCANCELDELAYEDSEQUENCEACTION_METHOD_3_30DB676C09113872_OFFSET UNITYSDK_OFFSET(0x16AB5A30)
#define RPG_GAMECORE_FIVEDIMCANCELDELAYEDSEQUENCEACTION_METHOD_3_522916831F04D9FE_OFFSET UNITYSDK_OFFSET(0x16AB5B30)
#define RPG_GAMECORE_FIVEDIMCANCELDELAYEDSEQUENCEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16AB5B10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimCancelDelayedSequenceAction_TypeDefinitionIndex = 16780;
