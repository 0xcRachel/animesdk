...
#define RPG_GAMECORE_ROGUENOUSDICESURFACEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A50C2C0)
#define RPG_GAMECORE_ROGUENOUSDICESURFACEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A50CCD0)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::Il2CppArray<::System::UInt32>* BranchLimitaion; // 0x10
		...
		::System::UInt32 DiceActiveStage; // 0x44
		::RPG::Client::TextID SurfaceName; // 0x48
		::RPG::Client::TextID SurfaceDesc; // 0x58
		::System::UInt32 Sort; // 0x68
		::System::UInt32 ItemID; // 0x6C
		::System::UInt32 UnlockDisplayID; // 0x70
		::System::UInt32 SurfaceID; // 0x74
