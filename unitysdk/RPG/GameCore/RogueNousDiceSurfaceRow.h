...
#define RPG_GAMECORE_ROGUENOUSDICESURFACEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AE41FE0)
#define RPG_GAMECORE_ROGUENOUSDICESURFACEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE429B0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::RPG::GameCore::RogueNousSurfaceTag>* TagList; // 0x18
