...
#define RPG_GAMECORE_ROGUETOURNTITANBLESSROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16ECE5D0)
#define RPG_GAMECORE_ROGUETOURNTITANBLESSROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16ECE900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournTitanBlessRow_TypeDefinitionIndex = 13695;
	...
	public:
		...
		::System::UInt32 TitanBlessLevel; // 0x20
		...
		::System::UInt32 SpeedUpRatio; // 0x34
