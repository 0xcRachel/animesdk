...
#define RPG_GAMECORE_ROGUETOURNTITANBLESSROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1940B220)
#define RPG_GAMECORE_ROGUETOURNTITANBLESSROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1940B530)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 SpeedUpRatio; // 0x30
