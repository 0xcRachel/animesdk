...
#define RPG_GAMECORE_MODIFIERVALUEBINDDATA_METHOD_2_7394BA234853589D_OFFSET UNITYSDK_OFFSET(0x16CB6E00)
#define RPG_GAMECORE_MODIFIERVALUEBINDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16CB6F70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifierValueBindData_TypeDefinitionIndex = 16356;
