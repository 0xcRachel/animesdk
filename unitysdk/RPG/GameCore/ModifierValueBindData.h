...
#define RPG_GAMECORE_MODIFIERVALUEBINDDATA_METHOD_2_7394BA234853589D_OFFSET UNITYSDK_OFFSET(0x196A5800)
#define RPG_GAMECORE_MODIFIERVALUEBINDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x196A5970)
