...
#define RPG_GAMECORE_BYISSUBTARGETOFHPSHAREDGROUP_METHOD_4_50E51B83B687E0A1_OFFSET UNITYSDK_OFFSET(0x19DB1570)
#define RPG_GAMECORE_BYISSUBTARGETOFHPSHAREDGROUP_METHOD_4_B761AC2587B5C5FE_OFFSET UNITYSDK_OFFSET(0x19DB16F0)
#define RPG_GAMECORE_BYISSUBTARGETOFHPSHAREDGROUP_METHOD_4_E9372FDE8BB9F017_OFFSET UNITYSDK_OFFSET(0x19DB14A0)
#define RPG_GAMECORE_BYISSUBTARGETOFHPSHAREDGROUP_METHOD_4_FAAA1F250DADD8EB_OFFSET UNITYSDK_OFFSET(0x19DB1770)
#define RPG_GAMECORE_BYISSUBTARGETOFHPSHAREDGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x19DB1520)
