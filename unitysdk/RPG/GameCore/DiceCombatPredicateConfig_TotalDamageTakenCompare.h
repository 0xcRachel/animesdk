...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_TOTALDAMAGETAKENCOMPARE_METHOD_4_A907AF9C2A7BE06B_OFFSET UNITYSDK_OFFSET(0x1A094D20)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_TOTALDAMAGETAKENCOMPARE_METHOD_4_BAFAFE0E4B5AE26E_OFFSET UNITYSDK_OFFSET(0x1A0938C0)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_TOTALDAMAGETAKENCOMPARE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A093870)
