...
#define RPG_GAMECORE_ROGUETOURNADVENTUREROOMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19828B90)
#define RPG_GAMECORE_ROGUETOURNADVENTUREROOMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19828D00)
