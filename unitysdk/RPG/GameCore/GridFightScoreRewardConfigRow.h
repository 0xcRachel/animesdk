...
#define RPG_GAMECORE_GRIDFIGHTSCOREREWARDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B470E0)
#define RPG_GAMECORE_GRIDFIGHTSCOREREWARDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B47290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightScoreRewardConfigRow_TypeDefinitionIndex = 12203;
