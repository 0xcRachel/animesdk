...
#define RPG_GAMECORE_MAZEPUZZLEWOLFBROROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x173DF610)
#define RPG_GAMECORE_MAZEPUZZLEWOLFBROROW__CTOR_OFFSET UNITYSDK_OFFSET(0x173DF8C0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 WolfBroID; // 0x20
		::System::UInt32 StartState; // 0x24
		::System::UInt32 FloorID; // 0x28
		::System::UInt32 CloseState; // 0x2C
		::System::UInt32 ControlGroupID; // 0x30
