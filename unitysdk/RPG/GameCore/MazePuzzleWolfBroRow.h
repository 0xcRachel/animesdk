...
#define RPG_GAMECORE_MAZEPUZZLEWOLFBROROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16C79DC0)
#define RPG_GAMECORE_MAZEPUZZLEWOLFBROROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16C7A070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazePuzzleWolfBroRow_TypeDefinitionIndex = 12802;
