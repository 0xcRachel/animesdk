...
#define RPG_GAMECORE_WAITPROPANIMSTATE_METHOD_3_80465FCE267AFBA7_OFFSET UNITYSDK_OFFSET(0x171588D0)
#define RPG_GAMECORE_WAITPROPANIMSTATE_METHOD_3_C2F768EDFE0A2FA5_OFFSET UNITYSDK_OFFSET(0x17158950)
#define RPG_GAMECORE_WAITPROPANIMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17158920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitPropAnimState_TypeDefinitionIndex = 18484;
