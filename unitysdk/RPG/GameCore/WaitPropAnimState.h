...
#define RPG_GAMECORE_WAITPROPANIMSTATE_METHOD_3_80465FCE267AFBA7_OFFSET UNITYSDK_OFFSET(0x19531E30)
#define RPG_GAMECORE_WAITPROPANIMSTATE_METHOD_3_C2F768EDFE0A2FA5_OFFSET UNITYSDK_OFFSET(0x19531EB0)
#define RPG_GAMECORE_WAITPROPANIMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19531E80)
