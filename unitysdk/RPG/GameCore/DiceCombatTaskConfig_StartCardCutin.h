...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_STARTCARDCUTIN_METHOD_3_D7E4988344A2CD62_OFFSET UNITYSDK_OFFSET(0x1A09AD10)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_STARTCARDCUTIN_METHOD_3_EB76D2B71AFC2E59_OFFSET UNITYSDK_OFFSET(0x1A09F760)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_STARTCARDCUTIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1A09ACC0)
