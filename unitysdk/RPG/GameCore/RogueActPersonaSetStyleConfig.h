...
#define RPG_GAMECORE_ROGUEACTPERSONASETSTYLECONFIG_METHOD_6_41D263727864849D_OFFSET UNITYSDK_OFFSET(0x1A9B1B70)
#define RPG_GAMECORE_ROGUEACTPERSONASETSTYLECONFIG_METHOD_6_936F4144CB4F1640_OFFSET UNITYSDK_OFFSET(0x1A9B1950)
#define RPG_GAMECORE_ROGUEACTPERSONASETSTYLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9B1A90)
