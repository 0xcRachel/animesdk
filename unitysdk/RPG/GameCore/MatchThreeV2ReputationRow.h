...
#define RPG_GAMECORE_MATCHTHREEV2REPUTATIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18C3E9D0)
#define RPG_GAMECORE_MATCHTHREEV2REPUTATIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18C3ED70)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID LevelUpDesc; // 0x30
