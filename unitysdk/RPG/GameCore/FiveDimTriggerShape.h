...
#define RPG_GAMECORE_FIVEDIMTRIGGERSHAPE_METHOD_3_0DF9C32F54D75735_OFFSET UNITYSDK_OFFSET(0x16AD99F0)
#define RPG_GAMECORE_FIVEDIMTRIGGERSHAPE_METHOD_3_22C96C8C929895F9_OFFSET UNITYSDK_OFFSET(0x16AB6470)
#define RPG_GAMECORE_FIVEDIMTRIGGERSHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x16AD99D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimTriggerShape_TypeDefinitionIndex = 16631;
