...
#define RPG_GAMECORE_FIVEDIMTRIGGERSHAPE_METHOD_3_0DF9C32F54D75735_OFFSET UNITYSDK_OFFSET(0x1A3AA6C0)
#define RPG_GAMECORE_FIVEDIMTRIGGERSHAPE_METHOD_3_22C96C8C929895F9_OFFSET UNITYSDK_OFFSET(0x1A39B150)
#define RPG_GAMECORE_FIVEDIMTRIGGERSHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3AA6A0)
