...
#define RPG_GAMECORE_STAGEMONSTERWAVE_FROMARRAY_OFFSET UNITYSDK_OFFSET(0x16F882C0)
#define RPG_GAMECORE_STAGEMONSTERWAVE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16F88040)
#define RPG_GAMECORE_STAGEMONSTERWAVE_TOLIST_OFFSET UNITYSDK_OFFSET(0x16F88380)
#define RPG_GAMECORE_STAGEMONSTERWAVE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F88260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StageMonsterWave_TypeDefinitionIndex = 13764;
