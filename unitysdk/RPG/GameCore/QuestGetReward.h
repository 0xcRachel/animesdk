...
#define RPG_GAMECORE_QUESTGETREWARD_METHOD_3_737C45B40060A617_OFFSET UNITYSDK_OFFSET(0x1758B7D0)
#define RPG_GAMECORE_QUESTGETREWARD_METHOD_3_90241F6B7B0E2266_OFFSET UNITYSDK_OFFSET(0x1758B750)
#define RPG_GAMECORE_QUESTGETREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1758B7A0)
