...
#define RPG_GAMECORE_ST_MAIN_PLAYFREESTYLE_METHOD_4_3654DF1D0F8F706B_OFFSET UNITYSDK_OFFSET(0x176AC610)
#define RPG_GAMECORE_ST_MAIN_PLAYFREESTYLE_METHOD_4_FC376FD8A71B0431_OFFSET UNITYSDK_OFFSET(0x1769C440)
#define RPG_GAMECORE_ST_MAIN_PLAYFREESTYLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1769C3D0)
