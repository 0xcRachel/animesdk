...
#define RPG_GAMECORE_BYSTATUSCOUNT_METHOD_4_945A0C20BF0D6408_OFFSET UNITYSDK_OFFSET(0x1693DDB0)
#define RPG_GAMECORE_BYSTATUSCOUNT_METHOD_4_DE032D9922A48C70_OFFSET UNITYSDK_OFFSET(0x1693DE90)
#define RPG_GAMECORE_BYSTATUSCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1693DE30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByStatusCount_TypeDefinitionIndex = 20198;
