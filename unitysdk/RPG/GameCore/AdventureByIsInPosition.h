...
#define RPG_GAMECORE_ADVENTUREBYISINPOSITION_METHOD_4_553A6054008BBE46_OFFSET UNITYSDK_OFFSET(0x19BFFB20)
#define RPG_GAMECORE_ADVENTUREBYISINPOSITION_METHOD_4_7AA1500C0DD48E68_OFFSET UNITYSDK_OFFSET(0x19BFFEA0)
#define RPG_GAMECORE_ADVENTUREBYISINPOSITION_METHOD_4_9919864F73C98AF0_OFFSET UNITYSDK_OFFSET(0x19BFFF20)
#define RPG_GAMECORE_ADVENTUREBYISINPOSITION_METHOD_4_F6B97091CCEADA81_OFFSET UNITYSDK_OFFSET(0x19BFFA40)
#define RPG_GAMECORE_ADVENTUREBYISINPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x19BFFAC0)
