...
#define RPG_GAMECORE_LEVELPROPTIMEREWINDPARAMETER_METHOD_3_BFBD4B00EAEE8C86_OFFSET UNITYSDK_OFFSET(0x18A41AD0)
#define RPG_GAMECORE_LEVELPROPTIMEREWINDPARAMETER_METHOD_3_C843853EA20F1D7B_OFFSET UNITYSDK_OFFSET(0x18A414C0)
#define RPG_GAMECORE_LEVELPROPTIMEREWINDPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x18A414B0)
