...
#define RPG_GAMECORE_FIVEDIMFIREEFFECTACTION_METHOD_3_4C93557B2F8E15D1_OFFSET UNITYSDK_OFFSET(0x16ABCAD0)
#define RPG_GAMECORE_FIVEDIMFIREEFFECTACTION_METHOD_3_58254C7A042E779B_OFFSET UNITYSDK_OFFSET(0x16ABCC90)
#define RPG_GAMECORE_FIVEDIMFIREEFFECTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16ABCC70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimFireEffectAction_TypeDefinitionIndex = 16805;
