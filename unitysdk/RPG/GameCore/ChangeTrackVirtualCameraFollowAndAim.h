...
#define RPG_GAMECORE_CHANGETRACKVIRTUALCAMERAFOLLOWANDAIM_METHOD_3_6EDE58E399C859A8_OFFSET UNITYSDK_OFFSET(0x169677D0)
#define RPG_GAMECORE_CHANGETRACKVIRTUALCAMERAFOLLOWANDAIM_METHOD_3_EC95CAC945449637_OFFSET UNITYSDK_OFFSET(0x16967750)
#define RPG_GAMECORE_CHANGETRACKVIRTUALCAMERAFOLLOWANDAIM__CTOR_OFFSET UNITYSDK_OFFSET(0x169677A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeTrackVirtualCameraFollowAndAim_TypeDefinitionIndex = 19334;
