...
#define RPG_GAMECORE_FATEPARAMOCCUPIEDBUFFSLOTNUMCONFIG_METHOD_6_E38F1C61E66B2614_OFFSET UNITYSDK_OFFSET(0x1947A1D0)
#define RPG_GAMECORE_FATEPARAMOCCUPIEDBUFFSLOTNUMCONFIG_METHOD_6_F1DBACCD8AB3C590_OFFSET UNITYSDK_OFFSET(0x1947A390)
#define RPG_GAMECORE_FATEPARAMOCCUPIEDBUFFSLOTNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1947A2D0)
