...
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONCONNECTAREAINFO_METHOD_2_4581396B9B4F9FCE_OFFSET UNITYSDK_OFFSET(0x1A10FD10)
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONCONNECTAREAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A10FE30)
