...
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONCONNECTAREAINFO_METHOD_2_4581396B9B4F9FCE_OFFSET UNITYSDK_OFFSET(0x16BB7F20)
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONCONNECTAREAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16BB8040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPedestrianV2IntersectionConnectAreaInfo_TypeDefinitionIndex = 15611;
