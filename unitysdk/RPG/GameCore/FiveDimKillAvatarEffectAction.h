...
#define RPG_GAMECORE_FIVEDIMKILLAVATAREFFECTACTION_METHOD_3_030DED4C7EFFBB83_OFFSET UNITYSDK_OFFSET(0x1720C4B0)
#define RPG_GAMECORE_FIVEDIMKILLAVATAREFFECTACTION_METHOD_3_CEA6649083563C97_OFFSET UNITYSDK_OFFSET(0x171FCDB0)
#define RPG_GAMECORE_FIVEDIMKILLAVATAREFFECTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x171FCD90)
