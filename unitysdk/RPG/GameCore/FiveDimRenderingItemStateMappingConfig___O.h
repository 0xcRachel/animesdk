...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::FDRIStateMaskEnum>**)Il2CppClass::FromTypeDefinitionIndex(FiveDimRenderingItemStateMappingConfig___O_TypeDefinitionIndex)->GetStaticField(0x40A20);
		}
	};
}
