...
#define RPG_GAMECORE_SPACEZOOSPECIALCATROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16F77B70)
#define RPG_GAMECORE_SPACEZOOSPECIALCATROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16F784B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SpaceZooSpecialCatRow_TypeDefinitionIndex = 11224;
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* MatchedChannelFeature; // 0x20
		...
		::System::UInt32 PhotoSubmissionID; // 0x4C
		::System::UInt32 SpecialCatID; // 0x50
		::System::UInt32 ResearchPointSSR; // 0x54
