...
#define RPG_GAMECORE_BATTLEPERFORMCONFIG_METHOD_2_C7103370C3C5342B_OFFSET UNITYSDK_OFFSET(0x168E1220)
#define RPG_GAMECORE_BATTLEPERFORMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x168E1360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattlePerformConfig_TypeDefinitionIndex = 16279;
