...
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKISINFECTED_METHOD_4_A9E99BC1C3D2D031_OFFSET UNITYSDK_OFFSET(0x195FB280)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKISINFECTED_METHOD_4_ABCB8164844A5B08_OFFSET UNITYSDK_OFFSET(0x195FAFF0)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKISINFECTED_METHOD_4_BA70D0ADAAA35062_OFFSET UNITYSDK_OFFSET(0x195FB0C0)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKISINFECTED_METHOD_4_DB75015A0C418B3D_OFFSET UNITYSDK_OFFSET(0x195FB200)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKISINFECTED__CTOR_OFFSET UNITYSDK_OFFSET(0x195FB070)
