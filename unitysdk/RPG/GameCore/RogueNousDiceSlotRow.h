...
#define RPG_GAMECORE_ROGUENOUSDICESLOTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x176538F0)
#define RPG_GAMECORE_ROGUENOUSDICESLOTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17653BA0)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::RPG::Client::TextID UpgradedSlotName; // 0x10
		::System::UInt32 SlotUnlockID; // 0x20
		::System::UInt32 ExtraMaxRarity; // 0x24
		::RPG::Client::TextID SlotName; // 0x28
		::System::UInt32 SlotID; // 0x38
		::System::UInt32 MaxRarity; // 0x3C
