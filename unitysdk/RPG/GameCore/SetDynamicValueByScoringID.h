...
#define RPG_GAMECORE_SETDYNAMICVALUEBYSCORINGID_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1A781A70)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSCORINGID_METHOD_4_1CAAED88B50660F7_OFFSET UNITYSDK_OFFSET(0x1A7818A0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSCORINGID_METHOD_4_1FF5429ACCD5AEAF_OFFSET UNITYSDK_OFFSET(0x1A7817D0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSCORINGID__CTOR_OFFSET UNITYSDK_OFFSET(0x1A781850)
