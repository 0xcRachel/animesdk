...
#define RPG_GAMECORE_MATCHTHREEDRAGTUTORIAL_METHOD_3_48814FEB1C1D5764_OFFSET UNITYSDK_OFFSET(0x18C35F80)
#define RPG_GAMECORE_MATCHTHREEDRAGTUTORIAL_METHOD_3_9CF3AD81804B8CF5_OFFSET UNITYSDK_OFFSET(0x18C36000)
#define RPG_GAMECORE_MATCHTHREEDRAGTUTORIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x18C35FD0)
