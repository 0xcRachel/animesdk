...
#define RPG_GAMECORE_BYCURRENTROGUEHASMIRACLE_METHOD_4_9993237B4DDF2141_OFFSET UNITYSDK_OFFSET(0x16921CB0)
#define RPG_GAMECORE_BYCURRENTROGUEHASMIRACLE_METHOD_4_BFB9B70198F60B43_OFFSET UNITYSDK_OFFSET(0x16921D80)
#define RPG_GAMECORE_BYCURRENTROGUEHASMIRACLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16921D30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCurrentRogueHasMiracle_TypeDefinitionIndex = 18852;
