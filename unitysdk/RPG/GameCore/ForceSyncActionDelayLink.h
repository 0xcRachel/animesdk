...
#define RPG_GAMECORE_FORCESYNCACTIONDELAYLINK_METHOD_3_1D80F065011EF6C7_OFFSET UNITYSDK_OFFSET(0x16AE02F0)
#define RPG_GAMECORE_FORCESYNCACTIONDELAYLINK_METHOD_3_F6DBF6FDA5913293_OFFSET UNITYSDK_OFFSET(0x16AE0370)
#define RPG_GAMECORE_FORCESYNCACTIONDELAYLINK__CTOR_OFFSET UNITYSDK_OFFSET(0x16AE0340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ForceSyncActionDelayLink_TypeDefinitionIndex = 20954;
