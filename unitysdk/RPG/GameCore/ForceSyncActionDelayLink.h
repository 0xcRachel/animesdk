...
#define RPG_GAMECORE_FORCESYNCACTIONDELAYLINK_METHOD_3_1D80F065011EF6C7_OFFSET UNITYSDK_OFFSET(0x1A3B2240)
#define RPG_GAMECORE_FORCESYNCACTIONDELAYLINK_METHOD_3_F6DBF6FDA5913293_OFFSET UNITYSDK_OFFSET(0x1A3B22C0)
#define RPG_GAMECORE_FORCESYNCACTIONDELAYLINK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3B2290)
