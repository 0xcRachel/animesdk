...
#define RPG_GAMECORE_LITTLEGAMEENTITYPRESET_METHOD_2_E8FF085532984C61_OFFSET UNITYSDK_OFFSET(0x18A53A00)
#define RPG_GAMECORE_LITTLEGAMEENTITYPRESET__CTOR_OFFSET UNITYSDK_OFFSET(0x18A53C40)
