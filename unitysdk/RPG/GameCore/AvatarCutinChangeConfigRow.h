...
#define RPG_GAMECORE_AVATARCUTINCHANGECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1689DEC0)
#define RPG_GAMECORE_AVATARCUTINCHANGECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1689E050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarCutinChangeConfigRow_TypeDefinitionIndex = 11545;
