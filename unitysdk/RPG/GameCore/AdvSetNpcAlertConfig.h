...
#define RPG_GAMECORE_ADVSETNPCALERTCONFIG_METHOD_3_105A136F9C4B35AC_OFFSET UNITYSDK_OFFSET(0x18C5C010)
#define RPG_GAMECORE_ADVSETNPCALERTCONFIG_METHOD_3_BE9D76154476F829_OFFSET UNITYSDK_OFFSET(0x18C5C160)
#define RPG_GAMECORE_ADVSETNPCALERTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18C5C0D0)
