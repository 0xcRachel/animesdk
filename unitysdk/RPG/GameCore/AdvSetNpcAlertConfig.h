...
#define RPG_GAMECORE_ADVSETNPCALERTCONFIG_METHOD_3_105A136F9C4B35AC_OFFSET UNITYSDK_OFFSET(0x19BF3C10)
#define RPG_GAMECORE_ADVSETNPCALERTCONFIG_METHOD_3_BE9D76154476F829_OFFSET UNITYSDK_OFFSET(0x19BF3D60)
#define RPG_GAMECORE_ADVSETNPCALERTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BF3CD0)
