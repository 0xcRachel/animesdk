...
#define RPG_GAMECORE_RETRYSWORDTRAININGFINALBATTLE_METHOD_3_8EED0A48DCE980B3_OFFSET UNITYSDK_OFFSET(0x16DF4850)
#define RPG_GAMECORE_RETRYSWORDTRAININGFINALBATTLE_METHOD_3_A24B61531FE7326A_OFFSET UNITYSDK_OFFSET(0x16DF47D0)
#define RPG_GAMECORE_RETRYSWORDTRAININGFINALBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16DF4820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RetrySwordTrainingFinalBattle_TypeDefinitionIndex = 18100;
