...
#define RPG_GAMECORE_TRAVELSHIPPOWERSPRINT_METHOD_3_009CE9131FFEE4C7_OFFSET UNITYSDK_OFFSET(0x17110010)
#define RPG_GAMECORE_TRAVELSHIPPOWERSPRINT_METHOD_3_421E8F23A1484350_OFFSET UNITYSDK_OFFSET(0x1710FF90)
#define RPG_GAMECORE_TRAVELSHIPPOWERSPRINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1710FFE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TravelShipPowerSprint_TypeDefinitionIndex = 18780;
