...
#define RPG_GAMECORE_PROPDESTRUCTRESET_METHOD_3_4CB1FB3D6F016DCE_OFFSET UNITYSDK_OFFSET(0x1752E9B0)
#define RPG_GAMECORE_PROPDESTRUCTRESET_METHOD_3_5C87F157B85E8958_OFFSET UNITYSDK_OFFSET(0x1752EB00)
#define RPG_GAMECORE_PROPDESTRUCTRESET__CTOR_OFFSET UNITYSDK_OFFSET(0x1752EA70)
