...
#define RPG_GAMECORE_SHOWTUTORIALUIMASK_METHOD_3_A9CC483D68BAB43E_OFFSET UNITYSDK_OFFSET(0x16F65890)
#define RPG_GAMECORE_SHOWTUTORIALUIMASK_METHOD_3_B7749A00808F7EFC_OFFSET UNITYSDK_OFFSET(0x16F65920)
#define RPG_GAMECORE_SHOWTUTORIALUIMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x16F658F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowTutorialUIMask_TypeDefinitionIndex = 21821;
