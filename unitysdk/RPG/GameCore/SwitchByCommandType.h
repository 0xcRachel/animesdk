...
#define RPG_GAMECORE_SWITCHBYCOMMANDTYPE_METHOD_3_296DC11BD55C494E_OFFSET UNITYSDK_OFFSET(0x16FB1F60)
#define RPG_GAMECORE_SWITCHBYCOMMANDTYPE_METHOD_3_6CF510B3332BDE0A_OFFSET UNITYSDK_OFFSET(0x16FB1E80)
#define RPG_GAMECORE_SWITCHBYCOMMANDTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FB1F00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchByCommandType_TypeDefinitionIndex = 21360;
