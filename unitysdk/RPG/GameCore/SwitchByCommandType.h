...
#define RPG_GAMECORE_SWITCHBYCOMMANDTYPE_METHOD_3_296DC11BD55C494E_OFFSET UNITYSDK_OFFSET(0x1985ACB0)
#define RPG_GAMECORE_SWITCHBYCOMMANDTYPE_METHOD_3_6CF510B3332BDE0A_OFFSET UNITYSDK_OFFSET(0x1985ABD0)
#define RPG_GAMECORE_SWITCHBYCOMMANDTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1985AC50)
