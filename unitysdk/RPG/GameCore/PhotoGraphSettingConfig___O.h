...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::GameCore::PhotoGraphFuncBtnType>**)Il2CppClass::FromTypeDefinitionIndex(PhotoGraphSettingConfig___O_TypeDefinitionIndex)->GetStaticField(0x43600);
		}
	};
}
