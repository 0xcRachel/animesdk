...
#define RPG_GAMECORE_GRIDFIGHTSHOWTRAITEFFECT_METHOD_3_3345C242E6A216E4_OFFSET UNITYSDK_OFFSET(0x16B49D70)
#define RPG_GAMECORE_GRIDFIGHTSHOWTRAITEFFECT_METHOD_3_D2D961EADF232050_OFFSET UNITYSDK_OFFSET(0x16B49CF0)
#define RPG_GAMECORE_GRIDFIGHTSHOWTRAITEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x16B49D40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightShowTraitEffect_TypeDefinitionIndex = 20909;
