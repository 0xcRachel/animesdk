...
#define RPG_GAMECORE_ELFBUFFCONFIG_METHOD_2_BF55DB325F9D2759_OFFSET UNITYSDK_OFFSET(0x1914D9A0)
#define RPG_GAMECORE_ELFBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1914DAB0)
