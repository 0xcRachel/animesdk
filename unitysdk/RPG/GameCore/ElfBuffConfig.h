...
#define RPG_GAMECORE_ELFBUFFCONFIG_METHOD_2_BF55DB325F9D2759_OFFSET UNITYSDK_OFFSET(0x171A1330)
#define RPG_GAMECORE_ELFBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171A1440)
