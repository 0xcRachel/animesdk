...
#define RPG_GAMECORE_ENTITYERAFLIPPERSHOWLISTENER_METHOD_3_85699B1EEFF1989E_OFFSET UNITYSDK_OFFSET(0x16A71120)
#define RPG_GAMECORE_ENTITYERAFLIPPERSHOWLISTENER_METHOD_3_C0D0D27D00E551AF_OFFSET UNITYSDK_OFFSET(0x16A711A0)
#define RPG_GAMECORE_ENTITYERAFLIPPERSHOWLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x16A71170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EntityEraFlipperShowListener_TypeDefinitionIndex = 20006;
