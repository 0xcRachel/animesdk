...
#define RPG_GAMECORE_RELEASETARGETUNIQUENAME_METHOD_3_DAE2183EFD7871BB_OFFSET UNITYSDK_OFFSET(0x1A2D9C10)
#define RPG_GAMECORE_RELEASETARGETUNIQUENAME_METHOD_3_F929DC2AEC6E6412_OFFSET UNITYSDK_OFFSET(0x1A2D9C90)
#define RPG_GAMECORE_RELEASETARGETUNIQUENAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2D9C60)
