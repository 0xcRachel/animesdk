...
#define RPG_GAMECORE_RELEASETARGETUNIQUENAME_METHOD_3_DAE2183EFD7871BB_OFFSET UNITYSDK_OFFSET(0x1901AA10)
#define RPG_GAMECORE_RELEASETARGETUNIQUENAME_METHOD_3_F929DC2AEC6E6412_OFFSET UNITYSDK_OFFSET(0x1901AA90)
#define RPG_GAMECORE_RELEASETARGETUNIQUENAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1901AA60)
