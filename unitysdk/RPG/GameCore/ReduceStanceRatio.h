...
#define RPG_GAMECORE_REDUCESTANCERATIO_METHOD_3_329734278FBD467C_OFFSET UNITYSDK_OFFSET(0x16DCF9B0)
#define RPG_GAMECORE_REDUCESTANCERATIO_METHOD_3_99FC259B954987C1_OFFSET UNITYSDK_OFFSET(0x16DCF920)
#define RPG_GAMECORE_REDUCESTANCERATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x16DCF980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ReduceStanceRatio_TypeDefinitionIndex = 21244;
