...
#define RPG_GAMECORE_REDUCESTANCERATIO_METHOD_3_329734278FBD467C_OFFSET UNITYSDK_OFFSET(0x1759CB20)
#define RPG_GAMECORE_REDUCESTANCERATIO_METHOD_3_99FC259B954987C1_OFFSET UNITYSDK_OFFSET(0x1759CA90)
#define RPG_GAMECORE_REDUCESTANCERATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x1759CAF0)
