...
#define RPG_GAMECORE_RANDOMSELECTOR_METHOD_3_11973BAFAB059F5D_OFFSET UNITYSDK_OFFSET(0x16DC85F0)
#define RPG_GAMECORE_RANDOMSELECTOR_METHOD_3_F3F8445B08D3E2C4_OFFSET UNITYSDK_OFFSET(0x16DC8570)
#define RPG_GAMECORE_RANDOMSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x16DC85C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RandomSelector_TypeDefinitionIndex = 21490;
