...
#define RPG_GAMECORE_PHOTOGRAPHEMOTIONCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x174BDF60)
#define RPG_GAMECORE_PHOTOGRAPHEMOTIONCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x174BE880)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Single ExShyIntensity; // 0x40
		::System::Single ExCheekIntensity; // 0x44
		::System::Single BrowWeight; // 0x48
		::System::Single MouthWeight; // 0x4C
