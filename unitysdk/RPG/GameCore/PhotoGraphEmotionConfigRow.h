...
#define RPG_GAMECORE_PHOTOGRAPHEMOTIONCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16D36000)
#define RPG_GAMECORE_PHOTOGRAPHEMOTIONCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16D36920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphEmotionConfigRow_TypeDefinitionIndex = 13151;

	class PhotoGraphEmotionConfigRow : public ::System::Object
	{
	public:
		::System::String* MouthClipName; // 0x10
		::System::String* EyeClipName; // 0x18
		::System::String* EmotionClipPath; // 0x20
		::System::String* EmotionIconPath; // 0x28
		::System::String* BrowClipName; // 0x30
		::RPG::Client::TextID EmotionName; // 0x38
		::System::Single ExShadowIntensity; // 0x48
		::System::Single ExCheekIntensity; // 0x4C
		::System::UInt32 EmotionID; // 0x50
		::System::Single ExShyIntensity; // 0x54
		::System::Single EyeWeight; // 0x58
		::System::Single MouthWeight; // 0x5C
		::System::Single BrowWeight; // 0x60
