...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERENABLEFUNCTIONCONFIG_METHOD_3_3C1568F8D378B2E1_OFFSET UNITYSDK_OFFSET(0x16B31D40)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERENABLEFUNCTIONCONFIG_METHOD_3_94B42183D41BAB08_OFFSET UNITYSDK_OFFSET(0x16B31C70)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERENABLEFUNCTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16B31CF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierEnableFunctionConfig_TypeDefinitionIndex = 17402;
