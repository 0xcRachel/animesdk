...
#define RPG_GAMECORE_SETFLOORCUSTOMSTRING_METHOD_3_0B7DFC4FD24F8ADA_OFFSET UNITYSDK_OFFSET(0x16F2DFF0)
#define RPG_GAMECORE_SETFLOORCUSTOMSTRING_METHOD_3_4B096023EAB64A43_OFFSET UNITYSDK_OFFSET(0x16F2E070)
#define RPG_GAMECORE_SETFLOORCUSTOMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x16F2E040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFloorCustomString_TypeDefinitionIndex = 18491;
