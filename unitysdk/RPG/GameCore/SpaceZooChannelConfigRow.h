...
#define RPG_GAMECORE_SPACEZOOCHANNELCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16F71990)
#define RPG_GAMECORE_SPACEZOOCHANNELCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16F72000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SpaceZooChannelConfigRow_TypeDefinitionIndex = 11218;
	...
	public:
		...
		::System::UInt32 DefaultFeatureID; // 0x24
