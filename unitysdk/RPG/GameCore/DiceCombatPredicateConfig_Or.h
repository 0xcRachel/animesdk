...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_OR_METHOD_4_081A8DE03790FA94_OFFSET UNITYSDK_OFFSET(0x1A094C90)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_OR_METHOD_4_A14C715D0891E021_OFFSET UNITYSDK_OFFSET(0x1A0936D0)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_OR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A093680)
