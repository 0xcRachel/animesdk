...
#define RPG_GAMECORE_VIDEOCAPTIONCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17147E40)
#define RPG_GAMECORE_VIDEOCAPTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17147F10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VideoCaptionConfig_TypeDefinitionIndex = 15324;
