...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_9EB2CB86795DEEF1_DelegateParseJson_1<::RPG::GameCore::AttackDamageType>**)Il2CppClass::FromTypeDefinitionIndex(ByIsDamageType___O_TypeDefinitionIndex)->GetStaticField(0xA6D0);
		}
	};
}
