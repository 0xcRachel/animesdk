...
#define RPG_GAMECORE_ADVENTURECAMERALOOKATSIMPLE_METHOD_3_0C1DB8355CB0B338_OFFSET UNITYSDK_OFFSET(0x16856C00)
#define RPG_GAMECORE_ADVENTURECAMERALOOKATSIMPLE_METHOD_3_14C1AF16396BD9B4_OFFSET UNITYSDK_OFFSET(0x16856B70)
#define RPG_GAMECORE_ADVENTURECAMERALOOKATSIMPLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16856BD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureCameraLookAtSimple_TypeDefinitionIndex = 18288;
