...
#define RPG_GAMECORE_ADVENTURECAMERALOOKATSIMPLE_METHOD_3_0C1DB8355CB0B338_OFFSET UNITYSDK_OFFSET(0x18C6A7A0)
#define RPG_GAMECORE_ADVENTURECAMERALOOKATSIMPLE_METHOD_3_14C1AF16396BD9B4_OFFSET UNITYSDK_OFFSET(0x18C6A710)
#define RPG_GAMECORE_ADVENTURECAMERALOOKATSIMPLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C6A770)
