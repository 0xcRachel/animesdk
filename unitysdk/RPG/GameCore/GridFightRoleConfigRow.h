...
#define RPG_GAMECORE_GRIDFIGHTROLECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B442D0)
#define RPG_GAMECORE_GRIDFIGHTROLECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B44890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightRoleConfigRow_TypeDefinitionIndex = 12260;

	class GridFightRoleConfigRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* TraitList; // 0x10
		::Il2CppArray<::System::UInt32>* SeasonIDList; // 0x18
		...
		::RPG::GameCore::GridFightRoleSkillTag HealOrShieldDisplay; // 0x48
		::System::Boolean IsInPool; // 0x4C
		...
		::RPG::GameCore::GridFightPreset FrontBackType; // 0x64
