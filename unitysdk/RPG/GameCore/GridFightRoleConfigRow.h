...
#define RPG_GAMECORE_GRIDFIGHTROLECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19B85DD0)
#define RPG_GAMECORE_GRIDFIGHTROLECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19B86390)
