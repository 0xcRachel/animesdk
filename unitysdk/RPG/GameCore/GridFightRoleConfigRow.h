...
#define RPG_GAMECORE_GRIDFIGHTROLECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x172929D0)
#define RPG_GAMECORE_GRIDFIGHTROLECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17292F90)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::GridFightPreset FrontBackType; // 0x50
		::System::UInt32 ID; // 0x54
		::System::Boolean IsInPool; // 0x58
		::RPG::GameCore::GridFightRoleSkillTag HealOrShieldDisplay; // 0x5C
