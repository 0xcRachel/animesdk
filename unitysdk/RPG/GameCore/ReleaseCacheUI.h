...
#define RPG_GAMECORE_RELEASECACHEUI_METHOD_3_0620D24DC89C5991_OFFSET UNITYSDK_OFFSET(0x1A2D9480)
#define RPG_GAMECORE_RELEASECACHEUI_METHOD_3_AF7F0737FE10A838_OFFSET UNITYSDK_OFFSET(0x1A2D9400)
#define RPG_GAMECORE_RELEASECACHEUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2D9450)
