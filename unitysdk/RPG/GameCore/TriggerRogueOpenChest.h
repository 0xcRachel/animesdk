...
#define RPG_GAMECORE_TRIGGERROGUEOPENCHEST_METHOD_3_5182DE07056CC624_OFFSET UNITYSDK_OFFSET(0x17125F90)
#define RPG_GAMECORE_TRIGGERROGUEOPENCHEST_METHOD_3_8FBE78EA1C620515_OFFSET UNITYSDK_OFFSET(0x17126010)
#define RPG_GAMECORE_TRIGGERROGUEOPENCHEST__CTOR_OFFSET UNITYSDK_OFFSET(0x17125FE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerRogueOpenChest_TypeDefinitionIndex = 19921;
