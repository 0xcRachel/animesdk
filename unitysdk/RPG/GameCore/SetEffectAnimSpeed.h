...
#define RPG_GAMECORE_SETEFFECTANIMSPEED_METHOD_3_2A46242B0C8A8F15_OFFSET UNITYSDK_OFFSET(0x199AFB60)
#define RPG_GAMECORE_SETEFFECTANIMSPEED_METHOD_3_30B69F64DEA1AA49_OFFSET UNITYSDK_OFFSET(0x199AFBE0)
#define RPG_GAMECORE_SETEFFECTANIMSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x199AFBB0)
