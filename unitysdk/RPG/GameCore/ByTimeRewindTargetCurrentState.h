...
#define RPG_GAMECORE_BYTIMEREWINDTARGETCURRENTSTATE_METHOD_4_259673E560D87CE1_OFFSET UNITYSDK_OFFSET(0x17052700)
#define RPG_GAMECORE_BYTIMEREWINDTARGETCURRENTSTATE_METHOD_4_B72B7CE29FB8A4AD_OFFSET UNITYSDK_OFFSET(0x17052630)
#define RPG_GAMECORE_BYTIMEREWINDTARGETCURRENTSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x170526B0)
