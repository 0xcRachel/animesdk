...
#define RPG_GAMECORE_MATCHTHREELEVELROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x199950E0)
#define RPG_GAMECORE_MATCHTHREELEVELROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19995D10)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID LevelDescription; // 0x28
		::System::UInt32 LevelID; // 0x38
		::System::UInt32 RewardID; // 0x3C
		::System::UInt32 Mode; // 0x40
		::System::UInt32 GoMissionCondition; // 0x44
		::RPG::Client::TextID LevelName; // 0x48
		::System::UInt32 PlayerBirdID; // 0x58
		::System::UInt32 HPmax; // 0x5C
		::RPG::Client::TextID MissionDescription; // 0x60
		::RPG::Client::TextID VictoryDesc; // 0x70
		::System::UInt32 OpponentBirdID; // 0x80
		::System::UInt32 LevelMission; // 0x84
		::System::UInt32 OpponentID; // 0x88
		::System::UInt32 TurnStep; // 0x8C
		::System::UInt32 UnlockID; // 0x90
		::System::UInt32 PlayerID; // 0x94
		::RPG::Client::TextID LoseDesc; // 0x98
