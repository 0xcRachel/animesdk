...
#define RPG_GAMECORE_MATCHTHREELEVELROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x173C6290)
#define RPG_GAMECORE_MATCHTHREELEVELROW__CTOR_OFFSET UNITYSDK_OFFSET(0x173C6EC0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 Mode; // 0x84
		::RPG::Client::TextID MissionDescription; // 0x88
		::RPG::Client::TextID VictoryDesc; // 0x98
