...
#define RPG_GAMECORE_ROGUEADVENTUREESCAPELAYSERCONFIG_METHOD_3_6CE1927FA819F5BC_OFFSET UNITYSDK_OFFSET(0x16E123D0)
#define RPG_GAMECORE_ROGUEADVENTUREESCAPELAYSERCONFIG_METHOD_3_B40029D695B915C0_OFFSET UNITYSDK_OFFSET(0x16E12460)
#define RPG_GAMECORE_ROGUEADVENTUREESCAPELAYSERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E123C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAdventureEscapeLayserConfig_TypeDefinitionIndex = 16073;
