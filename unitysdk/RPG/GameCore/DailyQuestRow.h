...
#define RPG_GAMECORE_DAILYQUESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18FB91B0)
#define RPG_GAMECORE_DAILYQUESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18FB93E0)
