...
#define RPG_GAMECORE_REDMODESTANCEBARSETTING_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16DCF5C0)
#define RPG_GAMECORE_REDMODESTANCEBARSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x16DCF6D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RedModeStanceBarSetting_TypeDefinitionIndex = 15441;
