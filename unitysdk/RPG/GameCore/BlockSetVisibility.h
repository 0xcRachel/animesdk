...
#define RPG_GAMECORE_BLOCKSETVISIBILITY_METHOD_3_673829067CE3753C_OFFSET UNITYSDK_OFFSET(0x195DDA20)
#define RPG_GAMECORE_BLOCKSETVISIBILITY_METHOD_3_FEA1B29A3578EAFD_OFFSET UNITYSDK_OFFSET(0x195DD9A0)
#define RPG_GAMECORE_BLOCKSETVISIBILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x195DD9F0)
