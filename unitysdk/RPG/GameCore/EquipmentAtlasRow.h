...
#define RPG_GAMECORE_EQUIPMENTATLASROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16A75410)
#define RPG_GAMECORE_EQUIPMENTATLASROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16A75530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EquipmentAtlasRow_TypeDefinitionIndex = 12021;
