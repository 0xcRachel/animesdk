...
#define RPG_GAMECORE_ADDGRIDFIGHTTARGETEQUIP_METHOD_3_6BECA9AFE0F9C18C_OFFSET UNITYSDK_OFFSET(0x1954DC40)
#define RPG_GAMECORE_ADDGRIDFIGHTTARGETEQUIP_METHOD_3_EE829B4A30965EED_OFFSET UNITYSDK_OFFSET(0x1954DCC0)
#define RPG_GAMECORE_ADDGRIDFIGHTTARGETEQUIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1954DC90)
