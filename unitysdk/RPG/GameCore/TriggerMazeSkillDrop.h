...
#define RPG_GAMECORE_TRIGGERMAZESKILLDROP_METHOD_3_A8FF22884C4E9AE5_OFFSET UNITYSDK_OFFSET(0x171223A0)
#define RPG_GAMECORE_TRIGGERMAZESKILLDROP_METHOD_3_E408C7E05ECBF60A_OFFSET UNITYSDK_OFFSET(0x17122410)
#define RPG_GAMECORE_TRIGGERMAZESKILLDROP__CTOR_OFFSET UNITYSDK_OFFSET(0x171223E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerMazeSkillDrop_TypeDefinitionIndex = 19396;
