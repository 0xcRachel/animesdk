...
#define RPG_GAMECORE_TRIGGERMAZESKILLDROP_METHOD_3_A8FF22884C4E9AE5_OFFSET UNITYSDK_OFFSET(0x1911A4E0)
#define RPG_GAMECORE_TRIGGERMAZESKILLDROP_METHOD_3_E408C7E05ECBF60A_OFFSET UNITYSDK_OFFSET(0x1911A550)
#define RPG_GAMECORE_TRIGGERMAZESKILLDROP__CTOR_OFFSET UNITYSDK_OFFSET(0x1911A520)
