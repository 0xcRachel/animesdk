...
#define RPG_GAMECORE_SETREPORTCUSTOMVALUE_METHOD_3_13C3F03F8F06AC9C_OFFSET UNITYSDK_OFFSET(0x19389730)
#define RPG_GAMECORE_SETREPORTCUSTOMVALUE_METHOD_3_DE7A57B1D9F20BFD_OFFSET UNITYSDK_OFFSET(0x193897C0)
#define RPG_GAMECORE_SETREPORTCUSTOMVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x19389790)
