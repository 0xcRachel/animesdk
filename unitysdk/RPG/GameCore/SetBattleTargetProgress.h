...
#define RPG_GAMECORE_SETBATTLETARGETPROGRESS_METHOD_3_6CF5C621BBB87E1A_OFFSET UNITYSDK_OFFSET(0x16F09890)
#define RPG_GAMECORE_SETBATTLETARGETPROGRESS_METHOD_3_9EA66BE71A253483_OFFSET UNITYSDK_OFFSET(0x16F09920)
#define RPG_GAMECORE_SETBATTLETARGETPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x16F098F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBattleTargetProgress_TypeDefinitionIndex = 20846;
