...
#define RPG_GAMECORE_TARGETFETCHAIDDEFENDER_METHOD_4_484EBBE6EEB848FB_OFFSET UNITYSDK_OFFSET(0x16FDB6E0)
#define RPG_GAMECORE_TARGETFETCHAIDDEFENDER_METHOD_4_74792FF03F7E792D_OFFSET UNITYSDK_OFFSET(0x16FD37F0)
#define RPG_GAMECORE_TARGETFETCHAIDDEFENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD37A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAidDefender_TypeDefinitionIndex = 21720;
