...
#define RPG_GAMECORE_TARGETFETCHAIDDEFENDER_METHOD_4_484EBBE6EEB848FB_OFFSET UNITYSDK_OFFSET(0x199DFC20)
#define RPG_GAMECORE_TARGETFETCHAIDDEFENDER_METHOD_4_74792FF03F7E792D_OFFSET UNITYSDK_OFFSET(0x199D7670)
#define RPG_GAMECORE_TARGETFETCHAIDDEFENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x199D7620)
