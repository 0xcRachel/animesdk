...
#define RPG_GAMECORE_WAITSIMPLETALKFINISH_METHOD_3_61135BAD6E3BB0D5_OFFSET UNITYSDK_OFFSET(0x1715CDC0)
#define RPG_GAMECORE_WAITSIMPLETALKFINISH_METHOD_3_D531DF1594445BC1_OFFSET UNITYSDK_OFFSET(0x1715CCB0)
#define RPG_GAMECORE_WAITSIMPLETALKFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1715CD90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitSimpleTalkFinish_TypeDefinitionIndex = 18649;
