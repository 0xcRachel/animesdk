...
#define RPG_GAMECORE_WAITDIALOGUEFINISH_METHOD_3_73446C8259859243_OFFSET UNITYSDK_OFFSET(0x1790B570)
#define RPG_GAMECORE_WAITDIALOGUEFINISH_METHOD_3_8CF24C15668A67BA_OFFSET UNITYSDK_OFFSET(0x1790B5F0)
#define RPG_GAMECORE_WAITDIALOGUEFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1790B5C0)
