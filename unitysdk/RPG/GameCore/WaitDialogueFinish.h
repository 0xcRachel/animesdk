...
#define RPG_GAMECORE_WAITDIALOGUEFINISH_METHOD_3_73446C8259859243_OFFSET UNITYSDK_OFFSET(0x1714F460)
#define RPG_GAMECORE_WAITDIALOGUEFINISH_METHOD_3_8CF24C15668A67BA_OFFSET UNITYSDK_OFFSET(0x1714F4E0)
#define RPG_GAMECORE_WAITDIALOGUEFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1714F4B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitDialogueFinish_TypeDefinitionIndex = 18650;
