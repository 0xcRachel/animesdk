...
#define RPG_GAMECORE_SWITCHHANDLIFTTOANCHOR_METHOD_3_10AB6AE4EE6B1B3A_OFFSET UNITYSDK_OFFSET(0x177A98E0)
#define RPG_GAMECORE_SWITCHHANDLIFTTOANCHOR_METHOD_3_18586900149606B8_OFFSET UNITYSDK_OFFSET(0x177A9860)
#define RPG_GAMECORE_SWITCHHANDLIFTTOANCHOR__CTOR_OFFSET UNITYSDK_OFFSET(0x177A98B0)
