...
#define RPG_GAMECORE_BYISINANIMZONE_METHOD_4_B695D30DB5B3DCC9_OFFSET UNITYSDK_OFFSET(0x16931FA0)
#define RPG_GAMECORE_BYISINANIMZONE_METHOD_4_B9DB4CDBE408E815_OFFSET UNITYSDK_OFFSET(0x16931ED0)
#define RPG_GAMECORE_BYISINANIMZONE__CTOR_OFFSET UNITYSDK_OFFSET(0x16931F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsInAnimZone_TypeDefinitionIndex = 18007;
