...
#define RPG_GAMECORE_ALLEYTRANSPORTFOCUSCAMERA_METHOD_3_97BF6FCA13CBADE8_OFFSET UNITYSDK_OFFSET(0x168836B0)
#define RPG_GAMECORE_ALLEYTRANSPORTFOCUSCAMERA_METHOD_3_EA9E89FE3BD7CAB1_OFFSET UNITYSDK_OFFSET(0x16883730)
#define RPG_GAMECORE_ALLEYTRANSPORTFOCUSCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x16883700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AlleyTransportFocusCamera_TypeDefinitionIndex = 21769;
