...
#define RPG_GAMECORE_CHENLINGBATTLEBULLETCONFIG_METHOD_2_23511808BF34820F_OFFSET UNITYSDK_OFFSET(0x1708E700)
#define RPG_GAMECORE_CHENLINGBATTLEBULLETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17090C50)
