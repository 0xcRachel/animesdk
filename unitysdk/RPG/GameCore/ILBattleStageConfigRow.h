...
#define RPG_GAMECORE_ILBATTLESTAGECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18A85A60)
#define RPG_GAMECORE_ILBATTLESTAGECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18A85DB0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt64 CombatValue; // 0x20
		::System::UInt64 RecommendIdleCrystal; // 0x28
		::System::UInt32 Level; // 0x30
		::System::UInt16 RecommendDungeonFloor; // 0x34
		::System::UInt32 HardLevelGroup; // 0x38
		::System::UInt32 CombatAdvantageGroup; // 0x3C
		::System::UInt32 EliteGroup; // 0x40
