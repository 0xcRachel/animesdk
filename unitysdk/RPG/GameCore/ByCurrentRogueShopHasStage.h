...
#define RPG_GAMECORE_BYCURRENTROGUESHOPHASSTAGE_METHOD_4_25B1A6241A3EF879_OFFSET UNITYSDK_OFFSET(0x19001910)
#define RPG_GAMECORE_BYCURRENTROGUESHOPHASSTAGE_METHOD_4_4991F5D28341B772_OFFSET UNITYSDK_OFFSET(0x19001AD0)
#define RPG_GAMECORE_BYCURRENTROGUESHOPHASSTAGE_METHOD_4_AC72F8BC8AF137F3_OFFSET UNITYSDK_OFFSET(0x19001840)
#define RPG_GAMECORE_BYCURRENTROGUESHOPHASSTAGE_METHOD_4_CC11C006FCDC6E5A_OFFSET UNITYSDK_OFFSET(0x19001A50)
#define RPG_GAMECORE_BYCURRENTROGUESHOPHASSTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x190018C0)
