...
#define RPG_GAMECORE_TUTORIALCLOSE_METHOD_3_50AD60D58F0954C9_OFFSET UNITYSDK_OFFSET(0x19A58B10)
#define RPG_GAMECORE_TUTORIALCLOSE_METHOD_3_CA858500375C01BD_OFFSET UNITYSDK_OFFSET(0x19A58C20)
#define RPG_GAMECORE_TUTORIALCLOSE__CTOR_OFFSET UNITYSDK_OFFSET(0x19A58BF0)
