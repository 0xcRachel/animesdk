...
#define RPG_GAMECORE_AUTOUSEULTRASKILL_METHOD_3_9BE50230E4633A03_OFFSET UNITYSDK_OFFSET(0x16899CF0)
#define RPG_GAMECORE_AUTOUSEULTRASKILL_METHOD_3_D986FA203FC88B32_OFFSET UNITYSDK_OFFSET(0x16899D80)
#define RPG_GAMECORE_AUTOUSEULTRASKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x16899D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AutoUseUltraSkill_TypeDefinitionIndex = 21141;
