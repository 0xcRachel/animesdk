...
#define RPG_GAMECORE_CHARACTERCONFIG_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1696A3D0)
#define RPG_GAMECORE_CHARACTERCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1696A010)
#define RPG_GAMECORE_CHARACTERCONFIG_GETATTACHPOINTEFFECTADAPTIONCONFIG_OFFSET UNITYSDK_OFFSET(0x1696DDB0)
#define RPG_GAMECORE_CHARACTERCONFIG_GETEFFECTADAPTIONCONFIG_OFFSET UNITYSDK_OFFSET(0x1696DC40)
#define RPG_GAMECORE_CHARACTERCONFIG_GETEFFECTATTACHPOINTREDIRECT_OFFSET UNITYSDK_OFFSET(0x1696DF00)
#define RPG_GAMECORE_CHARACTERCONFIG_GETSKILLCONFIGBYTRIGGERKEY_OFFSET UNITYSDK_OFFSET(0x1696DAD0)
#define RPG_GAMECORE_CHARACTERCONFIG_GETSKILLINDEXBYTRIGGERKEY_OFFSET UNITYSDK_OFFSET(0x1696D9D0)
#define RPG_GAMECORE_CHARACTERCONFIG_SAFEGETSKILLCONFIG_OFFSET UNITYSDK_OFFSET(0x1696DBF0)
#define RPG_GAMECORE_CHARACTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1696A2D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterConfig_TypeDefinitionIndex = 14873;
	...
	public:
		...
		::RPG::GameCore::SkillConfig* GetSkillConfigByTriggerKey(::System::String* sTriggerKey)
		{
			return ((::RPG::GameCore::SkillConfig*(*)(::PVOID, ::System::String*))((::PBYTE)hIl2Cpp + RPG_GAMECORE_CHARACTERCONFIG_GETSKILLCONFIGBYTRIGGERKEY_OFFSET))(this, sTriggerKey);
		}

		::RPG::GameCore::SkillConfig* SafeGetSkillConfig(::System::Int32 nIndex)
		{
			return ((::RPG::GameCore::SkillConfig*(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + RPG_GAMECORE_CHARACTERCONFIG_SAFEGETSKILLCONFIG_OFFSET))(this, nIndex);
		}
