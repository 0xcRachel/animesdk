...
#define RPG_GAMECORE_ITEMSTROYLINEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B969C0)
#define RPG_GAMECORE_ITEMSTROYLINEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B96AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ItemStroyLineRow_TypeDefinitionIndex = 12632;
