...
#define RPG_GAMECORE_TRIGGERANIMATORLAYEREMOTION_METHOD_3_402AD514CD5729E0_OFFSET UNITYSDK_OFFSET(0x17117700)
#define RPG_GAMECORE_TRIGGERANIMATORLAYEREMOTION_METHOD_3_5B6DDBEE8AA406B3_OFFSET UNITYSDK_OFFSET(0x17117790)
#define RPG_GAMECORE_TRIGGERANIMATORLAYEREMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x17117760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerAnimatorLayerEmotion_TypeDefinitionIndex = 18388;
