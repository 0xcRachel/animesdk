...
#define RPG_GAMECORE_EFFECTCONFIG_METHOD_2_ABA54A11C20ABE02_OFFSET UNITYSDK_OFFSET(0x16A5A290)
#define RPG_GAMECORE_EFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16A5A690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EffectConfig_TypeDefinitionIndex = 18044;
