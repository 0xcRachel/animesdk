...
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYUNIQUEIDCONFIG_METHOD_3_882627E56C5C6DBB_OFFSET UNITYSDK_OFFSET(0x1766C510)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYUNIQUEIDCONFIG_METHOD_3_ED0068833E37673F_OFFSET UNITYSDK_OFFSET(0x1766C220)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYUNIQUEIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1766C210)
