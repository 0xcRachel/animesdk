...
#define RPG_GAMECORE_ADVPLAYERFORCEUSEDEFAULTOUTFIT_METHOD_3_5F02A21CE6628D7A_OFFSET UNITYSDK_OFFSET(0x18C55D40)
#define RPG_GAMECORE_ADVPLAYERFORCEUSEDEFAULTOUTFIT_METHOD_3_610B9B8E3CBD2003_OFFSET UNITYSDK_OFFSET(0x18C55C70)
#define RPG_GAMECORE_ADVPLAYERFORCEUSEDEFAULTOUTFIT__CTOR_OFFSET UNITYSDK_OFFSET(0x18C55CF0)
