...
#define RPG_GAMECORE_ACTIVITYHIPPLENINTERACTINFOROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1679A7C0)
#define RPG_GAMECORE_ACTIVITYHIPPLENINTERACTINFOROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1679AB00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityHipplenInteractInfoRow_TypeDefinitionIndex = 10786;
	...
	public:
		...
		::System::String* JsonConfigPath; // 0x28
		::RPG::Client::TextID InAreaHint; // 0x30
		::RPG::GameCore::HipplenInteractType Type; // 0x40
