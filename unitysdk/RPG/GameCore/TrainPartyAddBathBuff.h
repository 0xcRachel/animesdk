...
#define RPG_GAMECORE_TRAINPARTYADDBATHBUFF_METHOD_3_33752FA822E5249A_OFFSET UNITYSDK_OFFSET(0x171006F0)
#define RPG_GAMECORE_TRAINPARTYADDBATHBUFF_METHOD_3_F0B65C35D89D3AA3_OFFSET UNITYSDK_OFFSET(0x17100770)
#define RPG_GAMECORE_TRAINPARTYADDBATHBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x17100740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyAddBathBuff_TypeDefinitionIndex = 20017;
