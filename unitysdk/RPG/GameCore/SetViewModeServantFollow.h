...
#define RPG_GAMECORE_SETVIEWMODESERVANTFOLLOW_METHOD_3_57BE84F2664C4748_OFFSET UNITYSDK_OFFSET(0x16F45BB0)
#define RPG_GAMECORE_SETVIEWMODESERVANTFOLLOW_METHOD_3_73C74515DA5976E1_OFFSET UNITYSDK_OFFSET(0x16F45B30)
#define RPG_GAMECORE_SETVIEWMODESERVANTFOLLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x16F45B80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetViewModeServantFollow_TypeDefinitionIndex = 20564;
