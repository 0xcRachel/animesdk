...
#define RPG_GAMECORE_SETVIEWMODESERVANTFOLLOW_METHOD_3_57BE84F2664C4748_OFFSET UNITYSDK_OFFSET(0x1A7A4090)
#define RPG_GAMECORE_SETVIEWMODESERVANTFOLLOW_METHOD_3_73C74515DA5976E1_OFFSET UNITYSDK_OFFSET(0x1A7A4010)
#define RPG_GAMECORE_SETVIEWMODESERVANTFOLLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7A4060)
