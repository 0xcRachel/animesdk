...
#define RPG_GAMECORE_TARGETFETCHALLUNSELECTABLE_METHOD_4_0AC30D39FA8FD377_OFFSET UNITYSDK_OFFSET(0x16FD3FD0)
#define RPG_GAMECORE_TARGETFETCHALLUNSELECTABLE_METHOD_4_6872DF14EF880888_OFFSET UNITYSDK_OFFSET(0x16FDBBD0)
#define RPG_GAMECORE_TARGETFETCHALLUNSELECTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD3F80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAllUnselectable_TypeDefinitionIndex = 21651;
