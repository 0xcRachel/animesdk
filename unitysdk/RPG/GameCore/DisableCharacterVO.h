...
#define RPG_GAMECORE_DISABLECHARACTERVO_METHOD_3_8B9B6C260A9BFA4B_OFFSET UNITYSDK_OFFSET(0x1A0A1B80)
#define RPG_GAMECORE_DISABLECHARACTERVO_METHOD_3_A7BD271D5EE0CBC2_OFFSET UNITYSDK_OFFSET(0x1A0A1B00)
#define RPG_GAMECORE_DISABLECHARACTERVO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0A1B50)
