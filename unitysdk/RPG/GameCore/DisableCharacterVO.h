...
#define RPG_GAMECORE_DISABLECHARACTERVO_METHOD_3_8B9B6C260A9BFA4B_OFFSET UNITYSDK_OFFSET(0x16A43E10)
#define RPG_GAMECORE_DISABLECHARACTERVO_METHOD_3_A7BD271D5EE0CBC2_OFFSET UNITYSDK_OFFSET(0x16A43D90)
#define RPG_GAMECORE_DISABLECHARACTERVO__CTOR_OFFSET UNITYSDK_OFFSET(0x16A43DE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DisableCharacterVO_TypeDefinitionIndex = 20550;
