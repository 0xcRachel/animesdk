...
#define RPG_GAMECORE_CHIMERADUELNPCFIREEFFECTNODE_METHOD_3_797014C79AA3D703_OFFSET UNITYSDK_OFFSET(0x170B5EF0)
#define RPG_GAMECORE_CHIMERADUELNPCFIREEFFECTNODE_METHOD_3_8E91CB792C443B16_OFFSET UNITYSDK_OFFSET(0x170B5DF0)
#define RPG_GAMECORE_CHIMERADUELNPCFIREEFFECTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x170B5E90)
