...
#define RPG_GAMECORE_LEVELTURNACTIONPHASEEND_GETACTIONONEMORE_OFFSET UNITYSDK_OFFSET(0xA4ACAF0)
#define RPG_GAMECORE_LEVELTURNACTIONPHASEEND_GETACTIVEENTITY_OFFSET UNITYSDK_OFFSET(0xA4ACA70)
#define RPG_GAMECORE_LEVELTURNACTIONPHASEEND_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA4ACA20)
#define RPG_GAMECORE_LEVELTURNACTIONPHASEEND_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA4AC9D0)
#define RPG_GAMECORE_LEVELTURNACTIONPHASEEND_GETTURNCOUNTER_OFFSET UNITYSDK_OFFSET(0xA4ACAB0)
#define RPG_GAMECORE_LEVELTURNACTIONPHASEEND__CTOR_OFFSET UNITYSDK_OFFSET(0xA4AC9C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelTurnActionPhaseEnd_TypeDefinitionIndex = 44543;
