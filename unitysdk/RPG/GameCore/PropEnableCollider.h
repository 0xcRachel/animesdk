...
#define RPG_GAMECORE_PROPENABLECOLLIDER_METHOD_3_62EE0BC2FDA6E25B_OFFSET UNITYSDK_OFFSET(0x16DA84D0)
#define RPG_GAMECORE_PROPENABLECOLLIDER_METHOD_3_C9A9C25FA702FC17_OFFSET UNITYSDK_OFFSET(0x16DA8630)
#define RPG_GAMECORE_PROPENABLECOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x16DA8590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropEnableCollider_TypeDefinitionIndex = 18174;
