...
#define RPG_GAMECORE_GRIDFIGHTPORTALREMARKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B41230)
#define RPG_GAMECORE_GRIDFIGHTPORTALREMARKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B413B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightPortalRemarkConfigRow_TypeDefinitionIndex = 12403;
