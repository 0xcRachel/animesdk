...
#define RPG_GAMECORE_PROPLODTEMPLATE_METHOD_3_B53728052B2DD9B5_OFFSET UNITYSDK_OFFSET(0x16DADAC0)
#define RPG_GAMECORE_PROPLODTEMPLATE_METHOD_3_EB1B991853129278_OFFSET UNITYSDK_OFFSET(0x16DADA80)
#define RPG_GAMECORE_PROPLODTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16DADAB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropLodTemplate_TypeDefinitionIndex = 17093;
