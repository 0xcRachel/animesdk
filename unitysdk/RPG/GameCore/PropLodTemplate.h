...
#define RPG_GAMECORE_PROPLODTEMPLATE_METHOD_3_B53728052B2DD9B5_OFFSET UNITYSDK_OFFSET(0x175347B0)
#define RPG_GAMECORE_PROPLODTEMPLATE_METHOD_3_EB1B991853129278_OFFSET UNITYSDK_OFFSET(0x17534770)
#define RPG_GAMECORE_PROPLODTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x175347A0)
