...
#define RPG_GAMECORE_GRIDFIGHTPLAYERLEVELCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A1B5690)
#define RPG_GAMECORE_GRIDFIGHTPLAYERLEVELCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1B5990)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 Rarity1Weight; // 0x28
