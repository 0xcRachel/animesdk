...
#define RPG_GAMECORE_MATCHTHREEV2PVPRANKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18C3E0F0)
#define RPG_GAMECORE_MATCHTHREEV2PVPRANKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18C3E440)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 MaxScore; // 0x40
		::System::UInt32 Rank; // 0x44
