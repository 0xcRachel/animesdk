...
#define RPG_GAMECORE_BYDRINKMAKERCHEERSSTORYDRINKHASMADE_METHOD_4_6D3C4CD02A62E861_OFFSET UNITYSDK_OFFSET(0x19ADBA70)
#define RPG_GAMECORE_BYDRINKMAKERCHEERSSTORYDRINKHASMADE_METHOD_4_DB49DA9C510C753F_OFFSET UNITYSDK_OFFSET(0x19ADBB40)
#define RPG_GAMECORE_BYDRINKMAKERCHEERSSTORYDRINKHASMADE__CTOR_OFFSET UNITYSDK_OFFSET(0x19ADBAF0)
