...
#define RPG_GAMECORE_SWITCHCASEBYDYNAMICVALUE_METHOD_3_8FC90175993C3AA1_OFFSET UNITYSDK_OFFSET(0x1985B600)
#define RPG_GAMECORE_SWITCHCASEBYDYNAMICVALUE_METHOD_3_FB6DB7541C44CF99_OFFSET UNITYSDK_OFFSET(0x1985B560)
#define RPG_GAMECORE_SWITCHCASEBYDYNAMICVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1985B5C0)
