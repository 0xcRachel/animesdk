...
#define RPG_GAMECORE_SWITCHCASEBYDYNAMICVALUE_METHOD_3_321F7518A773B81E_OFFSET UNITYSDK_OFFSET(0x177A6E50)
#define RPG_GAMECORE_SWITCHCASEBYDYNAMICVALUE_METHOD_3_713B8CEE03D928A8_OFFSET UNITYSDK_OFFSET(0x177A6DB0)
#define RPG_GAMECORE_SWITCHCASEBYDYNAMICVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x177A6E10)
