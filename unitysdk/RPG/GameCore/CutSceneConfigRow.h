...
#define RPG_GAMECORE_CUTSCENECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19B24A20)
#define RPG_GAMECORE_CUTSCENECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19B24E40)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* CutSceneName; // 0x18
		::System::String* CaptionPath; // 0x20
		::System::String* CutScenePath; // 0x28
		::Il2CppArray<::System::String*>* HideBlockList; // 0x30
		::System::String* CutSceneBGMStateName; // 0x38
		::System::String* CutSceneSFXJsonPath; // 0x40
		::System::UInt32 MazeFloorID; // 0x48
		::System::UInt32 VoiceID; // 0x4C
		::System::UInt32 MazePlaneID; // 0x50
		::System::UInt32 SFXID; // 0x54
		::System::Boolean IsPlayerInvolved; // 0x58
