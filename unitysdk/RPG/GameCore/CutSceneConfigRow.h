...
#define RPG_GAMECORE_CUTSCENECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18FB4630)
#define RPG_GAMECORE_CUTSCENECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18FB4A50)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* CutSceneSFXJsonPath; // 0x30
