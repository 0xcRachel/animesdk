...
#define RPG_GAMECORE_ADVTRACKNPCTRIGGER_METHOD_3_1FF59433170975D3_OFFSET UNITYSDK_OFFSET(0x1684C400)
#define RPG_GAMECORE_ADVTRACKNPCTRIGGER_METHOD_3_51239E1B29ED6E0A_OFFSET UNITYSDK_OFFSET(0x1684C380)
#define RPG_GAMECORE_ADVTRACKNPCTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1684C3D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvTrackNpcTrigger_TypeDefinitionIndex = 19839;
