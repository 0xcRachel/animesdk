...
#define RPG_GAMECORE_ADVAINAVIGATETO_METHOD_3_492B26D54933E4FA_OFFSET UNITYSDK_OFFSET(0x167C0CF0)
#define RPG_GAMECORE_ADVAINAVIGATETO_METHOD_3_824DBF1ED57B2245_OFFSET UNITYSDK_OFFSET(0x167C0D70)
#define RPG_GAMECORE_ADVAINAVIGATETO__CTOR_OFFSET UNITYSDK_OFFSET(0x167C0D40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvAINavigateTo_TypeDefinitionIndex = 17760;
