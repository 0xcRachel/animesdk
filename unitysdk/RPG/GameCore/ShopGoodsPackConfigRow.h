...
#define RPG_GAMECORE_SHOPGOODSPACKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19FF90D0)
#define RPG_GAMECORE_SHOPGOODSPACKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19FF9250)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::UInt32 ComboGoodsID1; // 0x10
