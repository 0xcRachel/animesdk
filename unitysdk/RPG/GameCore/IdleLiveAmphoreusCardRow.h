...
#define RPG_GAMECORE_IDLELIVEAMPHOREUSCARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19AD2CB0)
#define RPG_GAMECORE_IDLELIVEAMPHOREUSCARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD30B0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 TriggerChapter; // 0x4C
