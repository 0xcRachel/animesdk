...
#define RPG_GAMECORE_ALLEYBASEGRIDITEMDATA_METHOD_2_624105AE8EA76FA2_OFFSET UNITYSDK_OFFSET(0x16874950)
#define RPG_GAMECORE_ALLEYBASEGRIDITEMDATA_METHOD_2_F48D35FAF57FD14F_OFFSET UNITYSDK_OFFSET(0x16874C60)
#define RPG_GAMECORE_ALLEYBASEGRIDITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16874C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AlleyBaseGridItemData_TypeDefinitionIndex = 14248;
