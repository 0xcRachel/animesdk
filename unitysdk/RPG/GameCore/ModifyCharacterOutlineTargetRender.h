...
#define RPG_GAMECORE_MODIFYCHARACTEROUTLINETARGETRENDER_METHOD_3_4669A712B8A0C8F0_OFFSET UNITYSDK_OFFSET(0x1907C4A0)
#define RPG_GAMECORE_MODIFYCHARACTEROUTLINETARGETRENDER_METHOD_3_8CF042BB9F9138EF_OFFSET UNITYSDK_OFFSET(0x1907C420)
#define RPG_GAMECORE_MODIFYCHARACTEROUTLINETARGETRENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1907C470)
