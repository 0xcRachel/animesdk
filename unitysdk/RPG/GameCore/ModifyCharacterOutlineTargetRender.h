...
#define RPG_GAMECORE_MODIFYCHARACTEROUTLINETARGETRENDER_METHOD_3_4669A712B8A0C8F0_OFFSET UNITYSDK_OFFSET(0x16CB8B10)
#define RPG_GAMECORE_MODIFYCHARACTEROUTLINETARGETRENDER_METHOD_3_8CF042BB9F9138EF_OFFSET UNITYSDK_OFFSET(0x16CB8A90)
#define RPG_GAMECORE_MODIFYCHARACTEROUTLINETARGETRENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x16CB8AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyCharacterOutlineTargetRender_TypeDefinitionIndex = 20451;
