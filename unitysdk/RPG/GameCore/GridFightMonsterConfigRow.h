...
#define RPG_GAMECORE_GRIDFIGHTMONSTERCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16B34E50)
#define RPG_GAMECORE_GRIDFIGHTMONSTERCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16B35070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightMonsterConfigRow_TypeDefinitionIndex = 12393;

	class GridFightMonsterConfigRow : public ::System::Object
	{
	public:
		::System::UInt32 Star1EliteGroup3; // 0x10
		...
		::System::UInt32 Star3EliteGroup3; // 0x24
