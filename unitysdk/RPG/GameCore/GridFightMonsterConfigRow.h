...
#define RPG_GAMECORE_GRIDFIGHTMONSTERCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17281970)
#define RPG_GAMECORE_GRIDFIGHTMONSTERCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17281B90)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::UInt32 MonsterTier; // 0x10
		::System::UInt32 Star1EliteGroup3; // 0x14
		::System::UInt32 Star4EliteGroup3; // 0x18
