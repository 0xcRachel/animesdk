...
#define RPG_GAMECORE_GRIDFIGHTMONSTERCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A1A8960)
#define RPG_GAMECORE_GRIDFIGHTMONSTERCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1A8B80)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 MonsterTier; // 0x1C
