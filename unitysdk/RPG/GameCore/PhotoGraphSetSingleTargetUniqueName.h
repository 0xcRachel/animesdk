...
#define RPG_GAMECORE_PHOTOGRAPHSETSINGLETARGETUNIQUENAME_METHOD_3_02650869D9FACF30_OFFSET UNITYSDK_OFFSET(0x16D36BE0)
#define RPG_GAMECORE_PHOTOGRAPHSETSINGLETARGETUNIQUENAME_METHOD_3_4924C21275E5CE7C_OFFSET UNITYSDK_OFFSET(0x16D38800)
#define RPG_GAMECORE_PHOTOGRAPHSETSINGLETARGETUNIQUENAME__CTOR_OFFSET UNITYSDK_OFFSET(0x16D36BD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphSetSingleTargetUniqueName_TypeDefinitionIndex = 19263;
