...
#define RPG_GAMECORE_REMOVEENTITYFROMRELATIONGROUP_METHOD_3_7A284CCBA7087CE7_OFFSET UNITYSDK_OFFSET(0x1A2E6FB0)
#define RPG_GAMECORE_REMOVEENTITYFROMRELATIONGROUP_METHOD_3_7EF3FCFD5748B318_OFFSET UNITYSDK_OFFSET(0x1A2E7030)
#define RPG_GAMECORE_REMOVEENTITYFROMRELATIONGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2E7000)
