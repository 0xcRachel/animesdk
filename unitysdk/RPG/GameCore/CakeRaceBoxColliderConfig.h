...
#define RPG_GAMECORE_CAKERACEBOXCOLLIDERCONFIG_METHOD_3_2B2A142A9BB55F66_OFFSET UNITYSDK_OFFSET(0x19A7FA50)
#define RPG_GAMECORE_CAKERACEBOXCOLLIDERCONFIG_METHOD_3_D86CAD8FAD12A99A_OFFSET UNITYSDK_OFFSET(0x19A7F9C0)
#define RPG_GAMECORE_CAKERACEBOXCOLLIDERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19A7FA30)
