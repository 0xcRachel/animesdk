...
#define RPG_GAMECORE_ADVSETMINIMAPALERTVISIONSTATE_METHOD_3_52B45BE3A3531C68_OFFSET UNITYSDK_OFFSET(0x18C5BD40)
#define RPG_GAMECORE_ADVSETMINIMAPALERTVISIONSTATE_METHOD_3_B8941B45AD77DFEF_OFFSET UNITYSDK_OFFSET(0x18C5BE90)
#define RPG_GAMECORE_ADVSETMINIMAPALERTVISIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C5BE00)
