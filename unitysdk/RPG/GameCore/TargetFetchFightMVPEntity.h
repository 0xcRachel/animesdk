...
#define RPG_GAMECORE_TARGETFETCHFIGHTMVPENTITY_METHOD_4_930D0B5E7803B3B6_OFFSET UNITYSDK_OFFSET(0x177D3040)
#define RPG_GAMECORE_TARGETFETCHFIGHTMVPENTITY_METHOD_4_BDBA263FDA0B1674_OFFSET UNITYSDK_OFFSET(0x177C9D80)
#define RPG_GAMECORE_TARGETFETCHFIGHTMVPENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x177C9D30)
