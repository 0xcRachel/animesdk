...
#define RPG_GAMECORE_TARGETFETCHFIGHTMVPENTITY_METHOD_4_547B6833E0352D14_OFFSET UNITYSDK_OFFSET(0x1AC55C50)
#define RPG_GAMECORE_TARGETFETCHFIGHTMVPENTITY_METHOD_4_930D0B5E7803B3B6_OFFSET UNITYSDK_OFFSET(0x1AC55B90)
#define RPG_GAMECORE_TARGETFETCHFIGHTMVPENTITY_METHOD_4_BDBA263FDA0B1674_OFFSET UNITYSDK_OFFSET(0x1AC424F0)
#define RPG_GAMECORE_TARGETFETCHFIGHTMVPENTITY_METHOD_4_F5A9A207FC8052D4_OFFSET UNITYSDK_OFFSET(0x1AC4E840)
#define RPG_GAMECORE_TARGETFETCHFIGHTMVPENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC424A0)
