...
#define RPG_GAMECORE_ADVSPECIALVISIONPROTECT_METHOD_3_8D67088AF2BB7A34_OFFSET UNITYSDK_OFFSET(0x18C5EB20)
#define RPG_GAMECORE_ADVSPECIALVISIONPROTECT_METHOD_3_F6615DD0B0A736A5_OFFSET UNITYSDK_OFFSET(0x18C5EBA0)
#define RPG_GAMECORE_ADVSPECIALVISIONPROTECT__CTOR_OFFSET UNITYSDK_OFFSET(0x18C5EB70)
