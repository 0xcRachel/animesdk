...
#define RPG_GAMECORE_CITYSHOPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x194D19A0)
#define RPG_GAMECORE_CITYSHOPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x194D20D0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 RewardListGroupID; // 0x28
		::System::UInt32 ShopID; // 0x2C
