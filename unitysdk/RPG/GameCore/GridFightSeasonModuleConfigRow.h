...
#define RPG_GAMECORE_GRIDFIGHTSEASONMODULECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19B89360)
#define RPG_GAMECORE_GRIDFIGHTSEASONMODULECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19B895A0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 MaxRewardExp; // 0x18
		::System::UInt32 ActivityQuestConfigID; // 0x1C
