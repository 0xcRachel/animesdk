...
#define RPG_GAMECORE_PROPSETHP_METHOD_3_A58FAB121CB1344B_OFFSET UNITYSDK_OFFSET(0x17539580)
#define RPG_GAMECORE_PROPSETHP_METHOD_3_C8E1A0CAAC334FEF_OFFSET UNITYSDK_OFFSET(0x17539440)
#define RPG_GAMECORE_PROPSETHP__CTOR_OFFSET UNITYSDK_OFFSET(0x175394F0)
