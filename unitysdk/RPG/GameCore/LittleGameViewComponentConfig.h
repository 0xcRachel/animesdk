...
#define RPG_GAMECORE_LITTLEGAMEVIEWCOMPONENTCONFIG_METHOD_3_272CEDFB04ED3720_OFFSET UNITYSDK_OFFSET(0x173758C0)
#define RPG_GAMECORE_LITTLEGAMEVIEWCOMPONENTCONFIG_METHOD_3_295A0DD05A6799C6_OFFSET UNITYSDK_OFFSET(0x1736FCD0)
#define RPG_GAMECORE_LITTLEGAMEVIEWCOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1736FCB0)
