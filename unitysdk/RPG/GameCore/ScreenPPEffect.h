...
#define RPG_GAMECORE_SCREENPPEFFECT_METHOD_3_DA45E579125F8D42_OFFSET UNITYSDK_OFFSET(0x1A1D97F0)
#define RPG_GAMECORE_SCREENPPEFFECT_METHOD_3_EDE72BB3FD2A7779_OFFSET UNITYSDK_OFFSET(0x1A1D9870)
#define RPG_GAMECORE_SCREENPPEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1D9840)
