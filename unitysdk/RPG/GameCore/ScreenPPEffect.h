...
#define RPG_GAMECORE_SCREENPPEFFECT_METHOD_3_DA45E579125F8D42_OFFSET UNITYSDK_OFFSET(0x16EFC5C0)
#define RPG_GAMECORE_SCREENPPEFFECT_METHOD_3_EDE72BB3FD2A7779_OFFSET UNITYSDK_OFFSET(0x16EFC640)
#define RPG_GAMECORE_SCREENPPEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x16EFC610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ScreenPPEffect_TypeDefinitionIndex = 21474;
