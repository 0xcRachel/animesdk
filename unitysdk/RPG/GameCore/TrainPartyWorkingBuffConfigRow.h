...
#define RPG_GAMECORE_TRAINPARTYWORKINGBUFFCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17109880)
#define RPG_GAMECORE_TRAINPARTYWORKINGBUFFCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17109AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyWorkingBuffConfigRow_TypeDefinitionIndex = 13941;
