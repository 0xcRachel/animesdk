...
#define RPG_GAMECORE_TRAINPARTYWORKINGBUFFCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x178C5880)
#define RPG_GAMECORE_TRAINPARTYWORKINGBUFFCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x178C5AE0)
