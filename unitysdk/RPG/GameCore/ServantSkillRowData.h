...
#define RPG_GAMECORE_SERVANTSKILLROWDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14B53E70)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_ATTACKDAMAGETYPEOVERRIDE_OFFSET UNITYSDK_OFFSET(0x14B54950)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_ATTACKTYPE_OFFSET UNITYSDK_OFFSET(0x14B549A0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_BPADD_OFFSET UNITYSDK_OFFSET(0x14B54580)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_BPNEED_OFFSET UNITYSDK_OFFSET(0x14B54440)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x14B53F60)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_COOLDOWN_OFFSET UNITYSDK_OFFSET(0x14B54080)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_DELAYRATIO_OFFSET UNITYSDK_OFFSET(0x14B546C0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_EXTRAEFFECTIDLIST_OFFSET UNITYSDK_OFFSET(0x14B55020)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_HIDEINUI_OFFSET UNITYSDK_OFFSET(0x14B54F50)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_INITCOOLDOWN_OFFSET UNITYSDK_OFFSET(0x14B54020)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x14B54A30)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_MAXLEVEL_OFFSET UNITYSDK_OFFSET(0x14B54A60)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_PARAMLIST_OFFSET UNITYSDK_OFFSET(0x14B54800)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_PREADDMODIFIERLIST_OFFSET UNITYSDK_OFFSET(0x14B54A90)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_PRECALEQUALSPLITTARGET_OFFSET UNITYSDK_OFFSET(0x14B54AA0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_RATEDRANKID_OFFSET UNITYSDK_OFFSET(0x14B55080)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_RATEDSKILLTREEID_OFFSET UNITYSDK_OFFSET(0x14B55060)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0x14B53EB0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SHOWDAMAGELIST_OFFSET UNITYSDK_OFFSET(0x14B55230)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SHOWHEALLIST_OFFSET UNITYSDK_OFFSET(0x14B55240)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SHOWSTANCELIST_OFFSET UNITYSDK_OFFSET(0x14B55210)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SIMPLEEXTRAEFFECTIDLIST_OFFSET UNITYSDK_OFFSET(0x14B55040)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SIMPLEPARAMLIST_OFFSET UNITYSDK_OFFSET(0x14B54870)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SIMPLESKILLDESC_OFFSET UNITYSDK_OFFSET(0x14B54EA0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SKILLCOMBOVALUEDELTA_OFFSET UNITYSDK_OFFSET(0x14B54A00)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SKILLDESC_OFFSET UNITYSDK_OFFSET(0x14B54DF0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SKILLEFFECT_OFFSET UNITYSDK_OFFSET(0x14B549D0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SKILLICON_OFFSET UNITYSDK_OFFSET(0x14B54D10)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SKILLID_OFFSET UNITYSDK_OFFSET(0x14B53F70)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SKILLNAME_OFFSET UNITYSDK_OFFSET(0x14B54B00)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SKILLNEED_OFFSET UNITYSDK_OFFSET(0x14B54FC0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SKILLTAG_OFFSET UNITYSDK_OFFSET(0x14B54BB0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SKILLTRIGGERKEY_OFFSET UNITYSDK_OFFSET(0x14B53FA0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SKILLTYPEDESC_OFFSET UNITYSDK_OFFSET(0x14B54C60)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SPADD_OFFSET UNITYSDK_OFFSET(0x14B540E0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SPBASE_OFFSET UNITYSDK_OFFSET(0x14B54220)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SPMULTIPLERATIO_OFFSET UNITYSDK_OFFSET(0x14B543D0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SPNEED_OFFSET UNITYSDK_OFFSET(0x14B54290)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_STANCEDAMAGEDISPLAY_OFFSET UNITYSDK_OFFSET(0x14B54FF0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_STANCEDAMAGETYPE_OFFSET UNITYSDK_OFFSET(0x14B548E0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_ULTRASKILLICON_OFFSET UNITYSDK_OFFSET(0x14B54D80)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_OVERRIDEDATA_OFFSET UNITYSDK_OFFSET(0x14B550A0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_SET_ROW_OFFSET UNITYSDK_OFFSET(0x14B53F10)
#define RPG_GAMECORE_SERVANTSKILLROWDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x14B53D90)
...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::RPG::GameCore::AvatarServantSkillRow**)Il2CppClass::FromTypeDefinitionIndex(ServantSkillRowData_TypeDefinitionIndex)->GetStaticField(0x684B0);
		}
		::Struct_2_5CDBC06B233F2791 _DefaultOverrideData; // 0x10
		::RPG::GameCore::AvatarServantSkillRow* _Row; // 0x108
