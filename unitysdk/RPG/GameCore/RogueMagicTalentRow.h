...
#define RPG_GAMECORE_ROGUEMAGICTALENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19971570)
#define RPG_GAMECORE_ROGUEMAGICTALENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19971850)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 NameDisplayID; // 0x28
