...
#define RPG_GAMECORE_WAITROGUEADVENTUREROOMSTOP_METHOD_3_32186C84FEDFAF33_OFFSET UNITYSDK_OFFSET(0x17916E20)
#define RPG_GAMECORE_WAITROGUEADVENTUREROOMSTOP_METHOD_3_35749F8A3455FDE3_OFFSET UNITYSDK_OFFSET(0x17916EB0)
#define RPG_GAMECORE_WAITROGUEADVENTUREROOMSTOP__CTOR_OFFSET UNITYSDK_OFFSET(0x17916E80)
