...
#define RPG_GAMECORE_WAITWOLFBROPUZZLESTARTUP_METHOD_3_1E60118EDB88E0EE_OFFSET UNITYSDK_OFFSET(0x17160930)
#define RPG_GAMECORE_WAITWOLFBROPUZZLESTARTUP_METHOD_3_FFFDD2D9CB6F36ED_OFFSET UNITYSDK_OFFSET(0x171609C0)
#define RPG_GAMECORE_WAITWOLFBROPUZZLESTARTUP__CTOR_OFFSET UNITYSDK_OFFSET(0x17160990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitWolfBroPuzzleStartup_TypeDefinitionIndex = 19641;
