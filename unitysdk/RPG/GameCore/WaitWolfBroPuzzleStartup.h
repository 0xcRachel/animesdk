...
#define RPG_GAMECORE_WAITWOLFBROPUZZLESTARTUP_METHOD_3_1E60118EDB88E0EE_OFFSET UNITYSDK_OFFSET(0x1791CE50)
#define RPG_GAMECORE_WAITWOLFBROPUZZLESTARTUP_METHOD_3_FFFDD2D9CB6F36ED_OFFSET UNITYSDK_OFFSET(0x1791CEE0)
#define RPG_GAMECORE_WAITWOLFBROPUZZLESTARTUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1791CEB0)
