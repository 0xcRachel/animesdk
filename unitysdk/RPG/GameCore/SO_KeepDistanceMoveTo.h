...
#define RPG_GAMECORE_SO_KEEPDISTANCEMOVETO_METHOD_4_6781C6220E925787_OFFSET UNITYSDK_OFFSET(0x16EDBCC0)
#define RPG_GAMECORE_SO_KEEPDISTANCEMOVETO_METHOD_4_CE108CCD9C25A940_OFFSET UNITYSDK_OFFSET(0x16EDCED0)
#define RPG_GAMECORE_SO_KEEPDISTANCEMOVETO__CTOR_OFFSET UNITYSDK_OFFSET(0x16EDBC80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SO_KeepDistanceMoveTo_TypeDefinitionIndex = 17822;
