...
#define RPG_GAMECORE_LOCKCURRENTTELEPORTACTION_METHOD_3_1B997A84F0FF4996_OFFSET UNITYSDK_OFFSET(0x1737EED0)
#define RPG_GAMECORE_LOCKCURRENTTELEPORTACTION_METHOD_3_21815537AB8BF9A7_OFFSET UNITYSDK_OFFSET(0x1737EE50)
#define RPG_GAMECORE_LOCKCURRENTTELEPORTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1737EEA0)
