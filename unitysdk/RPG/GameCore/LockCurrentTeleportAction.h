...
#define RPG_GAMECORE_LOCKCURRENTTELEPORTACTION_METHOD_3_1B997A84F0FF4996_OFFSET UNITYSDK_OFFSET(0x16BDB3F0)
#define RPG_GAMECORE_LOCKCURRENTTELEPORTACTION_METHOD_3_21815537AB8BF9A7_OFFSET UNITYSDK_OFFSET(0x16BDB370)
#define RPG_GAMECORE_LOCKCURRENTTELEPORTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16BDB3C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockCurrentTeleportAction_TypeDefinitionIndex = 19303;
