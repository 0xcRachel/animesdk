...
#define RPG_GAMECORE_ABILITYBEFOREESCAPE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x12AFB310)
#define RPG_GAMECORE_ABILITYBEFOREESCAPE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x12AFB2D0)
#define RPG_GAMECORE_ABILITYBEFOREESCAPE_INIT_OFFSET UNITYSDK_OFFSET(0x12AFB280)
#define RPG_GAMECORE_ABILITYBEFOREESCAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x12AFB360)
