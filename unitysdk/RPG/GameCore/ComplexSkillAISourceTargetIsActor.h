...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCETARGETISACTOR_METHOD_3_BBC073679720DF48_OFFSET UNITYSDK_OFFSET(0x1713DA10)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCETARGETISACTOR_METHOD_3_C4F72F24B66F8ADA_OFFSET UNITYSDK_OFFSET(0x1713C860)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCETARGETISACTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1713C840)
