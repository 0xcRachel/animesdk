...
#define RPG_GAMECORE_MUSEUMITEMSKILLCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16CEF0D0)
#define RPG_GAMECORE_MUSEUMITEMSKILLCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16CEF2D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MuseumItemSkillConfigRow_TypeDefinitionIndex = 12955;
