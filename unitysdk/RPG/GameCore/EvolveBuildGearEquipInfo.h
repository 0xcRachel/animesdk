...
#define RPG_GAMECORE_EVOLVEBUILDGEAREQUIPINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xA3F1CB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EvolveBuildGearEquipInfo_TypeDefinitionIndex = 43864;
