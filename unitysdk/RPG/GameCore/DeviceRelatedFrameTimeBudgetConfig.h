...
#define RPG_GAMECORE_DEVICERELATEDFRAMETIMEBUDGETCONFIG_METHOD_3_175FBCDD72584A7A_OFFSET UNITYSDK_OFFSET(0x169EF090)
#define RPG_GAMECORE_DEVICERELATEDFRAMETIMEBUDGETCONFIG_METHOD_3_FD929D5D14DB5C1C_OFFSET UNITYSDK_OFFSET(0x169EF870)
#define RPG_GAMECORE_DEVICERELATEDFRAMETIMEBUDGETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x169EF080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DeviceRelatedFrameTimeBudgetConfig_TypeDefinitionIndex = 14833;
