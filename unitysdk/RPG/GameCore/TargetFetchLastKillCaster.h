...
#define RPG_GAMECORE_TARGETFETCHLASTKILLCASTER_METHOD_4_34D1730DF36A13B4_OFFSET UNITYSDK_OFFSET(0x16FD73E0)
#define RPG_GAMECORE_TARGETFETCHLASTKILLCASTER_METHOD_4_65FD4FD173A774F6_OFFSET UNITYSDK_OFFSET(0x16FDD870)
#define RPG_GAMECORE_TARGETFETCHLASTKILLCASTER__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD7390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchLastKillCaster_TypeDefinitionIndex = 21715;
