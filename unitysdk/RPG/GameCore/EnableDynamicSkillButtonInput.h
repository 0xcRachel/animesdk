...
#define RPG_GAMECORE_ENABLEDYNAMICSKILLBUTTONINPUT_METHOD_3_5CB52ADF54DE67BB_OFFSET UNITYSDK_OFFSET(0x16A69270)
#define RPG_GAMECORE_ENABLEDYNAMICSKILLBUTTONINPUT_METHOD_3_E8835CCEB6CB032C_OFFSET UNITYSDK_OFFSET(0x16A691F0)
#define RPG_GAMECORE_ENABLEDYNAMICSKILLBUTTONINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x16A69240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableDynamicSkillButtonInput_TypeDefinitionIndex = 20493;
