...
#define RPG_GAMECORE_MUNICIPALQUALITYSETTING_METHOD_2_1AD312E3323F776D_OFFSET UNITYSDK_OFFSET(0x16CEA200)
#define RPG_GAMECORE_MUNICIPALQUALITYSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x16CEA470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MunicipalQualitySetting_TypeDefinitionIndex = 15230;
