...
#define RPG_GAMECORE_ADVDESTROYENTITYASYNC_METHOD_3_C43FDD1E76D9C8E4_OFFSET UNITYSDK_OFFSET(0x16831350)
#define RPG_GAMECORE_ADVDESTROYENTITYASYNC_METHOD_3_DB0901F4A07E8615_OFFSET UNITYSDK_OFFSET(0x168313D0)
#define RPG_GAMECORE_ADVDESTROYENTITYASYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x168313A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvDestroyEntityAsync_TypeDefinitionIndex = 19004;
