...
#define RPG_GAMECORE_ADVDESTROYENTITYASYNC_METHOD_3_1431FB431909C517_OFFSET UNITYSDK_OFFSET(0x1955F210)
#define RPG_GAMECORE_ADVDESTROYENTITYASYNC_METHOD_3_F0537447880C508E_OFFSET UNITYSDK_OFFSET(0x1955F190)
#define RPG_GAMECORE_ADVDESTROYENTITYASYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1955F1E0)
