...
#define RPG_GAMECORE_GRIDFIGHTCONDRANDOMCONFIG_METHOD_6_4EDE78F3DC1D302B_OFFSET UNITYSDK_OFFSET(0x17269830)
#define RPG_GAMECORE_GRIDFIGHTCONDRANDOMCONFIG_METHOD_6_D292240FE3682587_OFFSET UNITYSDK_OFFSET(0x172699F0)
#define RPG_GAMECORE_GRIDFIGHTCONDRANDOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17269930)
