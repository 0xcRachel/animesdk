...
#define RPG_GAMECORE_RTUNSTACKINVISIBLE_METHOD_3_DF4059D1CAA071A1_OFFSET UNITYSDK_OFFSET(0x1A161630)
#define RPG_GAMECORE_RTUNSTACKINVISIBLE_METHOD_3_E9D715067DAFE8AD_OFFSET UNITYSDK_OFFSET(0x1A161520)
#define RPG_GAMECORE_RTUNSTACKINVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A161600)
