...
#define RPG_GAMECORE_STAGECAPTUREALIASLOOKUP_METHOD_2_43E4EECF562C8920_OFFSET UNITYSDK_OFFSET(0x17778B00)
#define RPG_GAMECORE_STAGECAPTUREALIASLOOKUP__CTOR_OFFSET UNITYSDK_OFFSET(0x17778BD0)
