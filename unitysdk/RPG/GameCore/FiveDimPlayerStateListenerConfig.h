...
#define RPG_GAMECORE_FIVEDIMPLAYERSTATELISTENERCONFIG_METHOD_3_A79DEDA27655D41A_OFFSET UNITYSDK_OFFSET(0x16ACD1A0)
#define RPG_GAMECORE_FIVEDIMPLAYERSTATELISTENERCONFIG_METHOD_3_BDFC6AB78B2657E9_OFFSET UNITYSDK_OFFSET(0x16ACD130)
#define RPG_GAMECORE_FIVEDIMPLAYERSTATELISTENERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16ACD180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPlayerStateListenerConfig_TypeDefinitionIndex = 16699;
