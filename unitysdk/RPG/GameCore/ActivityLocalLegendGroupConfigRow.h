...
#define RPG_GAMECORE_ACTIVITYLOCALLEGENDGROUPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1952F8D0)
#define RPG_GAMECORE_ACTIVITYLOCALLEGENDGROUPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1952FD30)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID StageMechanism; // 0x28
		::RPG::Client::TextID StageMechanismTitle; // 0x38
		::RPG::Client::TextID TeamBuildTip; // 0x48
