...
#define RPG_GAMECORE_MODIFYTEAMBOOSTPOINTMAX_METHOD_3_757363779A7C055D_OFFSET UNITYSDK_OFFSET(0x16CC32F0)
#define RPG_GAMECORE_MODIFYTEAMBOOSTPOINTMAX_METHOD_3_D7A5208707A12C7C_OFFSET UNITYSDK_OFFSET(0x16CC3260)
#define RPG_GAMECORE_MODIFYTEAMBOOSTPOINTMAX__CTOR_OFFSET UNITYSDK_OFFSET(0x16CC32C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyTeamBoostPointMax_TypeDefinitionIndex = 20242;
