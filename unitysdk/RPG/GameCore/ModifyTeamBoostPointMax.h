...
#define RPG_GAMECORE_MODIFYTEAMBOOSTPOINTMAX_METHOD_3_757363779A7C055D_OFFSET UNITYSDK_OFFSET(0x196B1C60)
#define RPG_GAMECORE_MODIFYTEAMBOOSTPOINTMAX_METHOD_3_D7A5208707A12C7C_OFFSET UNITYSDK_OFFSET(0x196B1BD0)
#define RPG_GAMECORE_MODIFYTEAMBOOSTPOINTMAX__CTOR_OFFSET UNITYSDK_OFFSET(0x196B1C30)
