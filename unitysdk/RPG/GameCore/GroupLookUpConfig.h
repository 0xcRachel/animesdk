...
#define RPG_GAMECORE_GROUPLOOKUPCONFIG_METHOD_2_C847BFE93B0A2B72_OFFSET UNITYSDK_OFFSET(0x18A5A7B0)
#define RPG_GAMECORE_GROUPLOOKUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18A5A910)
