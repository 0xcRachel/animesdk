...
#define RPG_GAMECORE_GRIDFIGHTSEASONITEMCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17295E30)
#define RPG_GAMECORE_GRIDFIGHTSEASONITEMCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17295F50)
