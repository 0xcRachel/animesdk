...
#define RPG_GAMECORE_MAZEPUZZLECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16C74D60)
#define RPG_GAMECORE_MAZEPUZZLECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16C75410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazePuzzleConfigRow_TypeDefinitionIndex = 13220;
