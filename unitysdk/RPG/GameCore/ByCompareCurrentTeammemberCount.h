...
#define RPG_GAMECORE_BYCOMPARECURRENTTEAMMEMBERCOUNT_METHOD_4_7CD3BF9E8802CFA3_OFFSET UNITYSDK_OFFSET(0x18FCB2F0)
#define RPG_GAMECORE_BYCOMPARECURRENTTEAMMEMBERCOUNT_METHOD_4_9DEC9B4EC62EF529_OFFSET UNITYSDK_OFFSET(0x18FCB530)
#define RPG_GAMECORE_BYCOMPARECURRENTTEAMMEMBERCOUNT_METHOD_4_E0F4D6F85200C20B_OFFSET UNITYSDK_OFFSET(0x18FCB220)
#define RPG_GAMECORE_BYCOMPARECURRENTTEAMMEMBERCOUNT_METHOD_4_EA1E9608873B75D8_OFFSET UNITYSDK_OFFSET(0x18FCB4B0)
#define RPG_GAMECORE_BYCOMPARECURRENTTEAMMEMBERCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x18FCB2A0)
