...
#define RPG_GAMECORE_ATLASUNLOCKTEXTMAPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16F9DEC0)
#define RPG_GAMECORE_ATLASUNLOCKTEXTMAPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16F9E040)
