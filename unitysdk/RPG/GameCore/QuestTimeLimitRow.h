...
#define RPG_GAMECORE_QUESTTIMELIMITROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x191DA700)
#define RPG_GAMECORE_QUESTTIMELIMITROW__CTOR_OFFSET UNITYSDK_OFFSET(0x191DAEF0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID GuideDesc; // 0x28
