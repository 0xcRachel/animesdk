...
#define RPG_GAMECORE_SETGRAPHDYNAMICSTRING_METHOD_3_125FEC9B23C594E7_OFFSET UNITYSDK_OFFSET(0x16F2F0C0)
#define RPG_GAMECORE_SETGRAPHDYNAMICSTRING_METHOD_3_E3D6E6D611742928_OFFSET UNITYSDK_OFFSET(0x16F2F140)
#define RPG_GAMECORE_SETGRAPHDYNAMICSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x16F2F110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetGraphDynamicString_TypeDefinitionIndex = 18510;
