...
#define RPG_GAMECORE_BYISEXCLUDEINMULTICHARACTERFORMATION_METHOD_4_823671EDF5FC5D89_OFFSET UNITYSDK_OFFSET(0x16930C20)
#define RPG_GAMECORE_BYISEXCLUDEINMULTICHARACTERFORMATION_METHOD_4_82CBA3C6851A5C47_OFFSET UNITYSDK_OFFSET(0x16930CF0)
#define RPG_GAMECORE_BYISEXCLUDEINMULTICHARACTERFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x16930CA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsExcludeInMultiCharacterFormation_TypeDefinitionIndex = 20278;
