...
#define RPG_GAMECORE_CHESSWAITALLPROJECTILEFINISH_METHOD_3_19E179B97B3F2A9F_OFFSET UNITYSDK_OFFSET(0x170A3C60)
#define RPG_GAMECORE_CHESSWAITALLPROJECTILEFINISH_METHOD_3_4940DE28546D632B_OFFSET UNITYSDK_OFFSET(0x170A3B50)
#define RPG_GAMECORE_CHESSWAITALLPROJECTILEFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x170A3C30)
