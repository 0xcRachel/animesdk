...
#define RPG_GAMECORE_CHESSWAITALLPROJECTILEFINISH_METHOD_3_19E179B97B3F2A9F_OFFSET UNITYSDK_OFFSET(0x16981870)
#define RPG_GAMECORE_CHESSWAITALLPROJECTILEFINISH_METHOD_3_4940DE28546D632B_OFFSET UNITYSDK_OFFSET(0x16981760)
#define RPG_GAMECORE_CHESSWAITALLPROJECTILEFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x16981840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChessWaitAllProjectileFinish_TypeDefinitionIndex = 21431;
