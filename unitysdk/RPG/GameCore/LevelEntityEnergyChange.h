...
#define RPG_GAMECORE_LEVELENTITYENERGYCHANGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA4A36B0)
#define RPG_GAMECORE_LEVELENTITYENERGYCHANGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA4A3660)
#define RPG_GAMECORE_LEVELENTITYENERGYCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0xA4A3700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelEntityEnergyChange_TypeDefinitionIndex = 44654;
