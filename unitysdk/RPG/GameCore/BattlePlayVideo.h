...
#define RPG_GAMECORE_BATTLEPLAYVIDEO_METHOD_3_487D95CFE253E73E_OFFSET UNITYSDK_OFFSET(0x168E21F0)
#define RPG_GAMECORE_BATTLEPLAYVIDEO_METHOD_3_ABD4ACD0D79C73EC_OFFSET UNITYSDK_OFFSET(0x168E2140)
#define RPG_GAMECORE_BATTLEPLAYVIDEO__CTOR_OFFSET UNITYSDK_OFFSET(0x168E21B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattlePlayVideo_TypeDefinitionIndex = 21047;
