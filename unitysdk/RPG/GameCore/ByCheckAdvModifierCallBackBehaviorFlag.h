...
#define RPG_GAMECORE_BYCHECKADVMODIFIERCALLBACKBEHAVIORFLAG_METHOD_4_2FC8B21A5EFE6CBB_OFFSET UNITYSDK_OFFSET(0x195F5F60)
#define RPG_GAMECORE_BYCHECKADVMODIFIERCALLBACKBEHAVIORFLAG_METHOD_4_6302EB46F2784E76_OFFSET UNITYSDK_OFFSET(0x195F5DE0)
#define RPG_GAMECORE_BYCHECKADVMODIFIERCALLBACKBEHAVIORFLAG_METHOD_4_B02F0FB4173A8616_OFFSET UNITYSDK_OFFSET(0x195F5FE0)
#define RPG_GAMECORE_BYCHECKADVMODIFIERCALLBACKBEHAVIORFLAG_METHOD_4_E4BE073F0CDE4148_OFFSET UNITYSDK_OFFSET(0x195F5D10)
#define RPG_GAMECORE_BYCHECKADVMODIFIERCALLBACKBEHAVIORFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x195F5D90)
