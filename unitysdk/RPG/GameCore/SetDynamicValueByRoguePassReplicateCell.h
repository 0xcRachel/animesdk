...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEPASSREPLICATECELL_METHOD_3_6D9556A346B38DEE_OFFSET UNITYSDK_OFFSET(0x16F262B0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEPASSREPLICATECELL_METHOD_3_871606442B4C8419_OFFSET UNITYSDK_OFFSET(0x16F26240)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEPASSREPLICATECELL__CTOR_OFFSET UNITYSDK_OFFSET(0x16F26280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRoguePassReplicateCell_TypeDefinitionIndex = 19426;
