...
#define RPG_GAMECORE_HIDEEFFECTAUTOLAYOUT_METHOD_3_864141A7762A4045_OFFSET UNITYSDK_OFFSET(0x16B6ECE0)
#define RPG_GAMECORE_HIDEEFFECTAUTOLAYOUT_METHOD_3_E5DB7C9101835450_OFFSET UNITYSDK_OFFSET(0x16B6EC60)
#define RPG_GAMECORE_HIDEEFFECTAUTOLAYOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x16B6ECB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HideEffectAutoLayout_TypeDefinitionIndex = 20087;
