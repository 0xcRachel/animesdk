...
#define RPG_GAMECORE_LOOPWAITROLLSHOPDOGACHA_METHOD_3_BACD8976E7A6F946_OFFSET UNITYSDK_OFFSET(0x17385510)
#define RPG_GAMECORE_LOOPWAITROLLSHOPDOGACHA_METHOD_3_D4CB801DCBC4AB06_OFFSET UNITYSDK_OFFSET(0x17385480)
#define RPG_GAMECORE_LOOPWAITROLLSHOPDOGACHA__CTOR_OFFSET UNITYSDK_OFFSET(0x173854E0)
