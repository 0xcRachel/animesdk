...
#define RPG_GAMECORE_ADVFORCENPCGOBACK_METHOD_3_DB4844A03491DE0F_OFFSET UNITYSDK_OFFSET(0x16836820)
#define RPG_GAMECORE_ADVFORCENPCGOBACK_METHOD_3_E027A13F72D7EBD0_OFFSET UNITYSDK_OFFSET(0x168368A0)
#define RPG_GAMECORE_ADVFORCENPCGOBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x16836870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvForceNpcGoBack_TypeDefinitionIndex = 19604;
