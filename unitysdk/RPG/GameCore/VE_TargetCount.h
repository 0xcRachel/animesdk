...
#define RPG_GAMECORE_VE_TARGETCOUNT_METHOD_3_9AE6A4DABBDAD9CB_OFFSET UNITYSDK_OFFSET(0x1951D460)
#define RPG_GAMECORE_VE_TARGETCOUNT_METHOD_3_EC51F05EF27A0F82_OFFSET UNITYSDK_OFFSET(0x1951D4A0)
#define RPG_GAMECORE_VE_TARGETCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1951D490)
