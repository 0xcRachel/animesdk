...
#define RPG_GAMECORE_ADVENTUREFORBIDATTACKTRIGGERBATTLE_METHOD_3_62779342027A1413_OFFSET UNITYSDK_OFFSET(0x1685AA80)
#define RPG_GAMECORE_ADVENTUREFORBIDATTACKTRIGGERBATTLE_METHOD_3_8AF42581274B2FCA_OFFSET UNITYSDK_OFFSET(0x1685AB00)
#define RPG_GAMECORE_ADVENTUREFORBIDATTACKTRIGGERBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1685AAD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureForbidAttackTriggerBattle_TypeDefinitionIndex = 19304;
