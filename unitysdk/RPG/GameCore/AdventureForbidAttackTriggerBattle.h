...
#define RPG_GAMECORE_ADVENTUREFORBIDATTACKTRIGGERBATTLE_METHOD_3_62779342027A1413_OFFSET UNITYSDK_OFFSET(0x19C0AE30)
#define RPG_GAMECORE_ADVENTUREFORBIDATTACKTRIGGERBATTLE_METHOD_3_8AF42581274B2FCA_OFFSET UNITYSDK_OFFSET(0x19C0AEB0)
#define RPG_GAMECORE_ADVENTUREFORBIDATTACKTRIGGERBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C0AE80)
