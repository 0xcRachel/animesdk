...
#define RPG_GAMECORE_BYHASBILLBOARD_METHOD_4_68D35877E89AFD95_OFFSET UNITYSDK_OFFSET(0x16926590)
#define RPG_GAMECORE_BYHASBILLBOARD_METHOD_4_84B40662F38CC2D2_OFFSET UNITYSDK_OFFSET(0x169266B0)
#define RPG_GAMECORE_BYHASBILLBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x16926630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHasBillboard_TypeDefinitionIndex = 20079;
