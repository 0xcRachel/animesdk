...
#define RPG_GAMECORE_SETDYNAMICVALUEBYRAIDTARGETPROGRESS_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x16F25460)
#define RPG_GAMECORE_SETDYNAMICVALUEBYRAIDTARGETPROGRESS_METHOD_4_6BF546781508933C_OFFSET UNITYSDK_OFFSET(0x16F1E400)
#define RPG_GAMECORE_SETDYNAMICVALUEBYRAIDTARGETPROGRESS_METHOD_4_926610D4B813FF98_OFFSET UNITYSDK_OFFSET(0x16F253E0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYRAIDTARGETPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x16F1E3B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRaidTargetProgress_TypeDefinitionIndex = 21351;
