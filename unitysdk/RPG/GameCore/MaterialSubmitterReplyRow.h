...
#define RPG_GAMECORE_MATERIALSUBMITTERREPLYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16C68D90)
#define RPG_GAMECORE_MATERIALSUBMITTERREPLYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16C694D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MaterialSubmitterReplyRow_TypeDefinitionIndex = 10935;
