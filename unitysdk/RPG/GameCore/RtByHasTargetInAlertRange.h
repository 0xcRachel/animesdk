...
#define RPG_GAMECORE_RTBYHASTARGETINALERTRANGE_METHOD_4_A9CAAF7D5E939E68_OFFSET UNITYSDK_OFFSET(0x1941CBF0)
#define RPG_GAMECORE_RTBYHASTARGETINALERTRANGE_METHOD_4_B3A6C3174BEDE4C6_OFFSET UNITYSDK_OFFSET(0x1941CB20)
#define RPG_GAMECORE_RTBYHASTARGETINALERTRANGE_METHOD_4_C9E87C3D16625018_OFFSET UNITYSDK_OFFSET(0x1941CDF0)
#define RPG_GAMECORE_RTBYHASTARGETINALERTRANGE_METHOD_4_D4A96B83C3BC9575_OFFSET UNITYSDK_OFFSET(0x1941CD70)
#define RPG_GAMECORE_RTBYHASTARGETINALERTRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1941CBA0)
