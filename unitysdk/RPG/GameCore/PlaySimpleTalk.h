...
#define RPG_GAMECORE_PLAYSIMPLETALK_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x16D53460)
#define RPG_GAMECORE_PLAYSIMPLETALK_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16D533C0)
#define RPG_GAMECORE_PLAYSIMPLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x16D53420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlaySimpleTalk_TypeDefinitionIndex = 18648;
