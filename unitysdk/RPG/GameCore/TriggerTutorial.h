...
#define RPG_GAMECORE_TRIGGERTUTORIAL_METHOD_3_533361552E679453_OFFSET UNITYSDK_OFFSET(0x17127CC0)
#define RPG_GAMECORE_TRIGGERTUTORIAL_METHOD_3_E2B4F3DC28433C69_OFFSET UNITYSDK_OFFSET(0x17127D50)
#define RPG_GAMECORE_TRIGGERTUTORIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x17127D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerTutorial_TypeDefinitionIndex = 21852;
