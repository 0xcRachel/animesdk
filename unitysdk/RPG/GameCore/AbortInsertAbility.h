...
#define RPG_GAMECORE_ABORTINSERTABILITY_METHOD_3_51D2CEF4BEC7FE99_OFFSET UNITYSDK_OFFSET(0x188582F0)
#define RPG_GAMECORE_ABORTINSERTABILITY_METHOD_3_FEAFAFB3463B1D55_OFFSET UNITYSDK_OFFSET(0x18858370)
#define RPG_GAMECORE_ABORTINSERTABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x18858340)
