...
#define RPG_GAMECORE_WAITENTITYMUSICCUE_METHOD_3_2B4F9404A8F4069C_OFFSET UNITYSDK_OFFSET(0x171508A0)
#define RPG_GAMECORE_WAITENTITYMUSICCUE_METHOD_3_D0D3F013B6D64E4D_OFFSET UNITYSDK_OFFSET(0x17150920)
#define RPG_GAMECORE_WAITENTITYMUSICCUE__CTOR_OFFSET UNITYSDK_OFFSET(0x171508F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitEntityMusicCue_TypeDefinitionIndex = 18410;
