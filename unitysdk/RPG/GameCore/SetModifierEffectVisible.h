...
#define RPG_GAMECORE_SETMODIFIEREFFECTVISIBLE_METHOD_3_6C20CB97CD84EBA5_OFFSET UNITYSDK_OFFSET(0x16F35300)
#define RPG_GAMECORE_SETMODIFIEREFFECTVISIBLE_METHOD_3_8F8E0CF694B8024C_OFFSET UNITYSDK_OFFSET(0x16F35280)
#define RPG_GAMECORE_SETMODIFIEREFFECTVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F352D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetModifierEffectVisible_TypeDefinitionIndex = 21317;
