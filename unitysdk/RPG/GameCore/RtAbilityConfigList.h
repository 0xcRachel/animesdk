...
#define RPG_GAMECORE_RTABILITYCONFIGLIST_METHOD_2_52F16213835172D9_OFFSET UNITYSDK_OFFSET(0x19840740)
#define RPG_GAMECORE_RTABILITYCONFIGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x198408F0)
