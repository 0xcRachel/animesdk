...
#define RPG_GAMECORE_TUTORIALLOCKCONTROL_METHOD_3_53D7290A3C2BBFD0_OFFSET UNITYSDK_OFFSET(0x178F1E70)
#define RPG_GAMECORE_TUTORIALLOCKCONTROL_METHOD_3_755DC3DC8EED0A89_OFFSET UNITYSDK_OFFSET(0x178F1DF0)
#define RPG_GAMECORE_TUTORIALLOCKCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x178F1E40)
