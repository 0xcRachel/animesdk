...
#define RPG_GAMECORE_TUTORIALLOCKCONTROL_METHOD_3_53D7290A3C2BBFD0_OFFSET UNITYSDK_OFFSET(0x17135CA0)
#define RPG_GAMECORE_TUTORIALLOCKCONTROL_METHOD_3_755DC3DC8EED0A89_OFFSET UNITYSDK_OFFSET(0x17135C20)
#define RPG_GAMECORE_TUTORIALLOCKCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x17135C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialLockControl_TypeDefinitionIndex = 21755;
