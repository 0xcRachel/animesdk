...
#define RPG_GAMECORE_TARGETMAPADJOINENTITY_METHOD_3_6293A8663FBD49AF_OFFSET UNITYSDK_OFFSET(0x16FE0FC0)
#define RPG_GAMECORE_TARGETMAPADJOINENTITY_METHOD_3_DCCAF6D535829D72_OFFSET UNITYSDK_OFFSET(0x16FE1050)
#define RPG_GAMECORE_TARGETMAPADJOINENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE1020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapAdjoinEntity_TypeDefinitionIndex = 21727;
