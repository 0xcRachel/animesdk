...
#define RPG_GAMECORE_WAITGRAPHDYNAMICVALUECHANGE_METHOD_4_1839A79FFB1125EC_OFFSET UNITYSDK_OFFSET(0x1952C9D0)
#define RPG_GAMECORE_WAITGRAPHDYNAMICVALUECHANGE_METHOD_4_B704497C12159B08_OFFSET UNITYSDK_OFFSET(0x1952C8F0)
#define RPG_GAMECORE_WAITGRAPHDYNAMICVALUECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1952C970)
