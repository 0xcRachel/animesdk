...
#define RPG_GAMECORE_RTREMOVESTAGEABILITYBYNAME_METHOD_3_6C493AE19846876F_OFFSET UNITYSDK_OFFSET(0x1942B250)
#define RPG_GAMECORE_RTREMOVESTAGEABILITYBYNAME_METHOD_3_A43DEE9BFA5ACB9E_OFFSET UNITYSDK_OFFSET(0x1942B2D0)
#define RPG_GAMECORE_RTREMOVESTAGEABILITYBYNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1942B2A0)
