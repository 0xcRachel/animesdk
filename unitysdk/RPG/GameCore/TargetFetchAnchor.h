...
#define RPG_GAMECORE_TARGETFETCHANCHOR_METHOD_4_57F7E1633B2877D8_OFFSET UNITYSDK_OFFSET(0x16FD4150)
#define RPG_GAMECORE_TARGETFETCHANCHOR_METHOD_4_72FA6306366E2C96_OFFSET UNITYSDK_OFFSET(0x16FDBCE0)
#define RPG_GAMECORE_TARGETFETCHANCHOR__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD4100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAnchor_TypeDefinitionIndex = 21586;
