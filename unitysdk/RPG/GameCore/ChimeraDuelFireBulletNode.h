...
#define RPG_GAMECORE_CHIMERADUELFIREBULLETNODE_METHOD_3_6EC67B900F7DE6E8_OFFSET UNITYSDK_OFFSET(0x1698EA50)
#define RPG_GAMECORE_CHIMERADUELFIREBULLETNODE_METHOD_3_D586C46E09F31C62_OFFSET UNITYSDK_OFFSET(0x1698EB70)
#define RPG_GAMECORE_CHIMERADUELFIREBULLETNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1698EB00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelFireBulletNode_TypeDefinitionIndex = 14407;
