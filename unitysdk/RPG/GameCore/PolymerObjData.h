...
#define RPG_GAMECORE_POLYMEROBJDATA_METHOD_2_47FB19154B7D3799_OFFSET UNITYSDK_OFFSET(0x19368D20)
#define RPG_GAMECORE_POLYMEROBJDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19368F00)
