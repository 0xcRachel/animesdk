...
#define RPG_GAMECORE_BATTLEAREAUNIFIEDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x168CF850)
#define RPG_GAMECORE_BATTLEAREAUNIFIEDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x168CF910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleAreaUnifiedConfigRow_TypeDefinitionIndex = 11645;
