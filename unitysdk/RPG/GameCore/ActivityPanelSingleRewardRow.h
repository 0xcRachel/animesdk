...
#define RPG_GAMECORE_ACTIVITYPANELSINGLEREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x167A22E0)
#define RPG_GAMECORE_ACTIVITYPANELSINGLEREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x167A2490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityPanelSingleRewardRow_TypeDefinitionIndex = 10432;
