...
#define RPG_GAMECORE_FIVEDIMRISTATEEMISSIONACTION_METHOD_3_0DEB56EA691156C1_OFFSET UNITYSDK_OFFSET(0x1721AD60)
#define RPG_GAMECORE_FIVEDIMRISTATEEMISSIONACTION_METHOD_3_A68665766385157C_OFFSET UNITYSDK_OFFSET(0x1721ADD0)
#define RPG_GAMECORE_FIVEDIMRISTATEEMISSIONACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1721ADB0)
