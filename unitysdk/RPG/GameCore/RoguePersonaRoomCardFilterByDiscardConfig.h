...
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYDISCARDCONFIG_METHOD_3_1329A361D3758237_OFFSET UNITYSDK_OFFSET(0x1766C350)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYDISCARDCONFIG_METHOD_3_8D9DC27334CE6F9B_OFFSET UNITYSDK_OFFSET(0x1766C140)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYDISCARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1766C130)
