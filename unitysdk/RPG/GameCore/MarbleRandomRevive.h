...
#define RPG_GAMECORE_MARBLERANDOMREVIVE_METHOD_3_6C4779B4E04084B2_OFFSET UNITYSDK_OFFSET(0x16C46020)
#define RPG_GAMECORE_MARBLERANDOMREVIVE_METHOD_3_FA03C283E326F1BD_OFFSET UNITYSDK_OFFSET(0x16C45F40)
#define RPG_GAMECORE_MARBLERANDOMREVIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x16C45FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleRandomRevive_TypeDefinitionIndex = 15175;
