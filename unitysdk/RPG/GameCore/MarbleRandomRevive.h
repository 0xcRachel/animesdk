...
#define RPG_GAMECORE_MARBLERANDOMREVIVE_METHOD_3_6C4779B4E04084B2_OFFSET UNITYSDK_OFFSET(0x18C1C630)
#define RPG_GAMECORE_MARBLERANDOMREVIVE_METHOD_3_FA03C283E326F1BD_OFFSET UNITYSDK_OFFSET(0x18C1C550)
#define RPG_GAMECORE_MARBLERANDOMREVIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C1C5E0)
