...
#define RPG_GAMECORE_SETDYNAMICVALUEBYBPCHANGE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x176D49C0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBPCHANGE_METHOD_4_2A0817B24B225BC0_OFFSET UNITYSDK_OFFSET(0x176D4940)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBPCHANGE_METHOD_4_6E8F7838827AEBEC_OFFSET UNITYSDK_OFFSET(0x176CBD30)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBPCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x176CBCE0)
