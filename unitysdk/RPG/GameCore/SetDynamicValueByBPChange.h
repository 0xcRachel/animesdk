...
#define RPG_GAMECORE_SETDYNAMICVALUEBYBPCHANGE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x16F22820)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBPCHANGE_METHOD_4_2A0817B24B225BC0_OFFSET UNITYSDK_OFFSET(0x16F227A0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBPCHANGE_METHOD_4_6E8F7838827AEBEC_OFFSET UNITYSDK_OFFSET(0x16F16B10)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBPCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F16AC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByBPChange_TypeDefinitionIndex = 20762;
