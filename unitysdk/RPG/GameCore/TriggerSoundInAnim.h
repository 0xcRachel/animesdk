...
#define RPG_GAMECORE_TRIGGERSOUNDINANIM_METHOD_3_7E84322EF5ABD222_OFFSET UNITYSDK_OFFSET(0x171273B0)
#define RPG_GAMECORE_TRIGGERSOUNDINANIM_METHOD_3_E59908B870ED60D9_OFFSET UNITYSDK_OFFSET(0x17127440)
#define RPG_GAMECORE_TRIGGERSOUNDINANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x17127410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerSoundInAnim_TypeDefinitionIndex = 20037;
