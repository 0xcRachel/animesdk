...
#define RPG_GAMECORE_FATEMODIFIERSHOPMODIFYBUFFCOUNTPRICECONFIG_METHOD_3_2A7AB932F38DFCA5_OFFSET UNITYSDK_OFFSET(0x16A98100)
#define RPG_GAMECORE_FATEMODIFIERSHOPMODIFYBUFFCOUNTPRICECONFIG_METHOD_3_88B22795B96D308C_OFFSET UNITYSDK_OFFSET(0x16A98DE0)
#define RPG_GAMECORE_FATEMODIFIERSHOPMODIFYBUFFCOUNTPRICECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16A980B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierShopModifyBuffCountPriceConfig_TypeDefinitionIndex = 17285;
