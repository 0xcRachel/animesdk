...
#define RPG_GAMECORE_ADVENTURETRIGGERFASTRUN_METHOD_3_67F9AC3BB36E754D_OFFSET UNITYSDK_OFFSET(0x168630D0)
#define RPG_GAMECORE_ADVENTURETRIGGERFASTRUN_METHOD_3_EE177D8ABA369561_OFFSET UNITYSDK_OFFSET(0x16863150)
#define RPG_GAMECORE_ADVENTURETRIGGERFASTRUN__CTOR_OFFSET UNITYSDK_OFFSET(0x16863120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureTriggerFastRun_TypeDefinitionIndex = 17951;
