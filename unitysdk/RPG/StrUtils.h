...
#define RPG_STRUTILS_CHARATINDEXTOCACHEDSTRING_OFFSET UNITYSDK_OFFSET(0x172C0F30)
#define RPG_STRUTILS_CONCATWITHSEPARATOR_OFFSET UNITYSDK_OFFSET(0x172C0760)
#define RPG_STRUTILS_CONCAT_1_OFFSET UNITYSDK_OFFSET(0x172C0580)
#define RPG_STRUTILS_CONCAT_2_OFFSET UNITYSDK_OFFSET(0x172C05E0)
#define RPG_STRUTILS_CONCAT_3_OFFSET UNITYSDK_OFFSET(0x172C0650)
#define RPG_STRUTILS_CONCAT_4_OFFSET UNITYSDK_OFFSET(0x172C06D0)
#define RPG_STRUTILS_CONCAT_5_OFFSET UNITYSDK_OFFSET(0x172C0810)
#define RPG_STRUTILS_CONCAT_6_OFFSET UNITYSDK_OFFSET(0x172C0870)
#define RPG_STRUTILS_CONCAT_7_OFFSET UNITYSDK_OFFSET(0x172C08E0)
#define RPG_STRUTILS_CONCAT_8_OFFSET UNITYSDK_OFFSET(0x172C0960)
#define RPG_STRUTILS_CONCAT_9_OFFSET UNITYSDK_OFFSET(0x172C0A00)
#define RPG_STRUTILS_CONCAT_OFFSET UNITYSDK_OFFSET(0x172C0530)
#define RPG_STRUTILS_CONTAINS_OFFSET UNITYSDK_OFFSET(0x172C1160)
#define RPG_STRUTILS_ENDSWITHOPT_OFFSET UNITYSDK_OFFSET(0x172C1480)
#define RPG_STRUTILS_FORMATBYPROVIDER_OFFSET UNITYSDK_OFFSET(0x172C02F0)
#define RPG_STRUTILS_FORMAT_1_OFFSET UNITYSDK_OFFSET(0x172C0380)
#define RPG_STRUTILS_FORMAT_2_OFFSET UNITYSDK_OFFSET(0x172C03F0)
#define RPG_STRUTILS_FORMAT_3_OFFSET UNITYSDK_OFFSET(0x172C0470)
#define RPG_STRUTILS_FORMAT_OFFSET UNITYSDK_OFFSET(0x172C0280)
#define RPG_STRUTILS_GETBUILDER_OFFSET UNITYSDK_OFFSET(0x172C00D0)
#define RPG_STRUTILS_GETSTABLEHASH_OFFSET UNITYSDK_OFFSET(0x172C1990)
#define RPG_STRUTILS_INTERNSTRING_OFFSET UNITYSDK_OFFSET(0x172C0F10)
#define RPG_STRUTILS_INTERN_OFFSET UNITYSDK_OFFSET(0x172C0F00)
#define RPG_STRUTILS_STARTSWITHOPT_OFFSET UNITYSDK_OFFSET(0x172C11A0)
#define RPG_STRUTILS_SUBSTRINGAFTERLAST_OFFSET UNITYSDK_OFFSET(0x172C1A60)
#define RPG_STRUTILS_SUBSTRINGLAST_OFFSET UNITYSDK_OFFSET(0x172C1AB0)
#define RPG_STRUTILS_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x172C0B20)
#define RPG_STRUTILS_TOSTRING_2_OFFSET UNITYSDK_OFFSET(0x172C0BA0)
#define RPG_STRUTILS_TOSTRING_3_OFFSET UNITYSDK_OFFSET(0x172C0C20)
#define RPG_STRUTILS_TOSTRING_4_OFFSET UNITYSDK_OFFSET(0x172C0CA0)
#define RPG_STRUTILS_TOSTRING_5_OFFSET UNITYSDK_OFFSET(0x172C0D00)
#define RPG_STRUTILS_TOSTRING_6_OFFSET UNITYSDK_OFFSET(0x172C0D60)
#define RPG_STRUTILS_TOSTRING_7_OFFSET UNITYSDK_OFFSET(0x172C0DC0)
#define RPG_STRUTILS_TOSTRING_8_OFFSET UNITYSDK_OFFSET(0x172C0E20)
#define RPG_STRUTILS_TOSTRING_9_OFFSET UNITYSDK_OFFSET(0x172C0E90)
#define RPG_STRUTILS_TOSTRING_OFFSET UNITYSDK_OFFSET(0x172C0AA0)
#define RPG_STRUTILS_TRYGETSTRINGFROMSTABLEHASH_OFFSET UNITYSDK_OFFSET(0x172C1A50)
#define RPG_STRUTILS_WILDCARDMATCH_OFFSET UNITYSDK_OFFSET(0x172C1700)
#define RPG_STRUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x172C1C40)

namespace RPG
{
	inline static constexpr unsigned int StrUtils_TypeDefinitionIndex = 8586;
	...
	public:
		...
		{
			return (::System::Text::StringBuilder**)Il2CppClass::FromTypeDefinitionIndex(StrUtils_TypeDefinitionIndex)->GetStaticField(0x630);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::Char, ::System::String*>** StaticGet__CharToStrDict()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Char, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(StrUtils_TypeDefinitionIndex)->GetStaticField(0x638);
		}
		static ::System::Int32* StaticGet_msMainThreadId()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(StrUtils_TypeDefinitionIndex)->GetStaticField(0x480);
		}
		...
		static ::System::String* FormatByProvider(::System::String* format, ::System::Single arg0, ::System::IFormatProvider* provider)
		{
			return ((::System::String*(*)(::System::String*, ::System::Single, ::System::IFormatProvider*))((::PBYTE)hIl2Cpp + RPG_STRUTILS_FORMATBYPROVIDER_OFFSET))(format, arg0, provider);
		}
