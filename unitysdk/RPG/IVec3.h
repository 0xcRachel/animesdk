...
#define RPG_IVEC3_EQUALS_OFFSET UNITYSDK_OFFSET(0x2256B10)
#define RPG_IVEC3_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2256AF0)
#define RPG_IVEC3_GET_BACK_OFFSET UNITYSDK_OFFSET(0x15DC8220)
#define RPG_IVEC3_GET_DOWN_OFFSET UNITYSDK_OFFSET(0x15DC8260)
#define RPG_IVEC3_GET_FORWARD_OFFSET UNITYSDK_OFFSET(0x15DC8200)
#define RPG_IVEC3_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x22569D0)
#define RPG_IVEC3_GET_LEFT_OFFSET UNITYSDK_OFFSET(0x15DC8280)
#define RPG_IVEC3_GET_ONE_OFFSET UNITYSDK_OFFSET(0x15DC81E0)
#define RPG_IVEC3_GET_RIGHT_OFFSET UNITYSDK_OFFSET(0x15DC82A0)
#define RPG_IVEC3_GET_UP_OFFSET UNITYSDK_OFFSET(0x15DC8240)
#define RPG_IVEC3_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x15DC81C0)
#define RPG_IVEC3_METHOD_2_20C4C7E23BB528BC_OFFSET UNITYSDK_OFFSET(0x2256B50)
#define RPG_IVEC3_METHOD_2_3AF7C73D7E1DAB11_1_OFFSET UNITYSDK_OFFSET(0x15DC8300)
#define RPG_IVEC3_METHOD_2_3AF7C73D7E1DAB11_OFFSET UNITYSDK_OFFSET(0x15DC8190)
#define RPG_IVEC3_METHOD_2_6EB8CFA46BD6F6EA_OFFSET UNITYSDK_OFFSET(0x1BB8790)
#define RPG_IVEC3_METHOD_2_7D12E28C4CB15D9C_OFFSET UNITYSDK_OFFSET(0x15DC83C0)
#define RPG_IVEC3_METHOD_2_C68DD56EA29E5F53_OFFSET UNITYSDK_OFFSET(0x15DC83A0)
#define RPG_IVEC3_METHOD_2_D466FBA41248FC85_1_OFFSET UNITYSDK_OFFSET(0x15DC8150)
#define RPG_IVEC3_METHOD_2_D466FBA41248FC85_2_OFFSET UNITYSDK_OFFSET(0x15DC82C0)
#define RPG_IVEC3_METHOD_2_D466FBA41248FC85_3_OFFSET UNITYSDK_OFFSET(0x15DC82E0)
#define RPG_IVEC3_METHOD_2_D466FBA41248FC85_OFFSET UNITYSDK_OFFSET(0x15DC8110)
#define RPG_IVEC3_METHOD_2_E16EA785DA81BE97_1_OFFSET UNITYSDK_OFFSET(0x15DC8350)
#define RPG_IVEC3_METHOD_2_E16EA785DA81BE97_2_OFFSET UNITYSDK_OFFSET(0x15DC8370)
#define RPG_IVEC3_METHOD_2_E16EA785DA81BE97_OFFSET UNITYSDK_OFFSET(0x15DC8320)
#define RPG_IVEC3_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x2256A50)
#define RPG_IVEC3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x2256B40)
#define RPG_IVEC3__CCTOR_OFFSET UNITYSDK_OFFSET(0x15DC8570)
#define RPG_IVEC3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x2256AE0)
#define RPG_IVEC3__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB8790)
...
namespace RPG
{
	...
	struct alignas(4) IVec3
	{
		...
		{
			return (::RPG::IVec3*)Il2CppClass::FromTypeDefinitionIndex(IVec3_TypeDefinitionIndex)->GetStaticField(0x6C20);
		}
		static ::RPG::IVec3* StaticGet_oneVector()
		{
			return (::RPG::IVec3*)Il2CppClass::FromTypeDefinitionIndex(IVec3_TypeDefinitionIndex)->GetStaticField(0x6C2C);
		}
		static ::RPG::IVec3* StaticGet_backVector()
		{
			return (::RPG::IVec3*)Il2CppClass::FromTypeDefinitionIndex(IVec3_TypeDefinitionIndex)->GetStaticField(0x6C38);
		}
		static ::RPG::IVec3* StaticGet_zeroVector()
		{
			return (::RPG::IVec3*)Il2CppClass::FromTypeDefinitionIndex(IVec3_TypeDefinitionIndex)->GetStaticField(0x6C44);
		}
		static ::RPG::IVec3* StaticGet_upVector()
		{
			return (::RPG::IVec3*)Il2CppClass::FromTypeDefinitionIndex(IVec3_TypeDefinitionIndex)->GetStaticField(0x6C50);
		}
		static ::RPG::IVec3* StaticGet_leftVector()
		{
			return (::RPG::IVec3*)Il2CppClass::FromTypeDefinitionIndex(IVec3_TypeDefinitionIndex)->GetStaticField(0x6C5C);
		}
		static ::RPG::IVec3* StaticGet_downVector()
		{
			return (::RPG::IVec3*)Il2CppClass::FromTypeDefinitionIndex(IVec3_TypeDefinitionIndex)->GetStaticField(0x6C68);
		}
		static ::RPG::IVec3* StaticGet_forwardVector()
		{
			return (::RPG::IVec3*)Il2CppClass::FromTypeDefinitionIndex(IVec3_TypeDefinitionIndex)->GetStaticField(0x6C74);
		}
		::System::Int32 x; // 0x10
		::System::Int32 y; // 0x14
		::System::Int32 z; // 0x18
