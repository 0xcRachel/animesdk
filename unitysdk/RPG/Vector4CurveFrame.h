...
#define RPG_VECTOR4CURVEFRAME_COMPARETO_OFFSET UNITYSDK_OFFSET(0x20293D0)
#define RPG_VECTOR4CURVEFRAME_GETTIME_OFFSET UNITYSDK_OFFSET(0xCC50)
#define RPG_VECTOR4CURVEFRAME_GETVALUE_OFFSET UNITYSDK_OFFSET(0x15AEA00)
#define RPG_VECTOR4CURVEFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x2029430)

namespace RPG
{
	inline static constexpr unsigned int Vector4CurveFrame_TypeDefinitionIndex = 8527;
