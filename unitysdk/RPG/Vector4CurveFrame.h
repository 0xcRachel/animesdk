...
#define RPG_VECTOR4CURVEFRAME_COMPARETO_OFFSET UNITYSDK_OFFSET(0x23BD6E0)
#define RPG_VECTOR4CURVEFRAME_GETTIME_OFFSET UNITYSDK_OFFSET(0x608BC0)
#define RPG_VECTOR4CURVEFRAME_GETVALUE_OFFSET UNITYSDK_OFFSET(0x2237840)
#define RPG_VECTOR4CURVEFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x23BD740)
