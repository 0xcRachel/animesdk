...
#define RPG_MVECTOR2_ANGLE_OFFSET UNITYSDK_OFFSET(0x172BE270)
#define RPG_MVECTOR2_CLAMPMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x172BE5E0)
#define RPG_MVECTOR2_DISTANCE_OFFSET UNITYSDK_OFFSET(0x172BE5A0)
#define RPG_MVECTOR2_DOT_OFFSET UNITYSDK_OFFSET(0x1727E400)
#define RPG_MVECTOR2_EQUALS_OFFSET UNITYSDK_OFFSET(0x2028CA0)
#define RPG_MVECTOR2_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2028C60)
#define RPG_MVECTOR2_GET_DOWN_OFFSET UNITYSDK_OFFSET(0x172BEA70)
#define RPG_MVECTOR2_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x20288E0)
#define RPG_MVECTOR2_GET_LEFT_OFFSET UNITYSDK_OFFSET(0x172BEA80)
#define RPG_MVECTOR2_GET_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x2028D20)
#define RPG_MVECTOR2_GET_NEGATIVEINFINITY_OFFSET UNITYSDK_OFFSET(0x172BEAB0)
#define RPG_MVECTOR2_GET_NORMALIZED_OFFSET UNITYSDK_OFFSET(0x2028A80)
#define RPG_MVECTOR2_GET_ONE_OFFSET UNITYSDK_OFFSET(0x172BEA50)
#define RPG_MVECTOR2_GET_POSITIVEINFINITY_OFFSET UNITYSDK_OFFSET(0x172BEAA0)
#define RPG_MVECTOR2_GET_RIGHT_OFFSET UNITYSDK_OFFSET(0x172BEA90)
#define RPG_MVECTOR2_GET_SQRMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x2028D50)
#define RPG_MVECTOR2_GET_UP_OFFSET UNITYSDK_OFFSET(0x172BEA60)
#define RPG_MVECTOR2_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x172BEA40)
#define RPG_MVECTOR2_LERPUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x172BDE60)
#define RPG_MVECTOR2_LERP_OFFSET UNITYSDK_OFFSET(0x172BDE00)
#define RPG_MVECTOR2_MAX_OFFSET UNITYSDK_OFFSET(0x172BE710)
#define RPG_MVECTOR2_MIN_OFFSET UNITYSDK_OFFSET(0x172BE6E0)
#define RPG_MVECTOR2_MOVETOWARDS_OFFSET UNITYSDK_OFFSET(0x172BDEA0)
#define RPG_MVECTOR2_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x2028A10)
#define RPG_MVECTOR2_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1727E690)
#define RPG_MVECTOR2_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x172BDF80)
#define RPG_MVECTOR2_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x172BE9C0)
#define RPG_MVECTOR2_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1728BB60)
#define RPG_MVECTOR2_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x172824E0)
#define RPG_MVECTOR2_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x172BEA00)
#define RPG_MVECTOR2_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1727E660)
#define RPG_MVECTOR2_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x172A33F0)
#define RPG_MVECTOR2_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1727E2C0)
#define RPG_MVECTOR2_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x172BE9A0)
#define RPG_MVECTOR2_REFLECT_OFFSET UNITYSDK_OFFSET(0x172BE210)
#define RPG_MVECTOR2_SCALE_1_OFFSET UNITYSDK_OFFSET(0x20289F0)
#define RPG_MVECTOR2_SCALE_OFFSET UNITYSDK_OFFSET(0x172BDFB0)
#define RPG_MVECTOR2_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x2028960)
#define RPG_MVECTOR2_SET_OFFSET UNITYSDK_OFFSET(0x29910)
#define RPG_MVECTOR2_SIGNEDANGLE_OFFSET UNITYSDK_OFFSET(0x172BE3F0)
#define RPG_MVECTOR2_SMOOTHDAMP_OFFSET UNITYSDK_OFFSET(0x172BE740)
#define RPG_MVECTOR2_SQRMAGNITUDE_1_OFFSET UNITYSDK_OFFSET(0x2028D50)
#define RPG_MVECTOR2_SQRMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x172BE6B0)
#define RPG_MVECTOR2_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x2028BB0)
#define RPG_MVECTOR2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x2028B00)
#define RPG_MVECTOR2__CCTOR_OFFSET UNITYSDK_OFFSET(0x172BEAC0)
#define RPG_MVECTOR2__CTOR_OFFSET UNITYSDK_OFFSET(0x29910)

namespace RPG
{
	inline static constexpr unsigned int MVector2_TypeDefinitionIndex = 8577;

	struct alignas(4) MVector2
	{
		static ::RPG::MVector2* StaticGet_upVector()
		{
			return (::RPG::MVector2*)Il2CppClass::FromTypeDefinitionIndex(MVector2_TypeDefinitionIndex)->GetStaticField(0x2F20);
		}
		static ::RPG::MVector2* StaticGet_zeroVector()
		{
			return (::RPG::MVector2*)Il2CppClass::FromTypeDefinitionIndex(MVector2_TypeDefinitionIndex)->GetStaticField(0x2F28);
		}
		static ::RPG::MVector2* StaticGet_negativeInfinityVector()
		{
			return (::RPG::MVector2*)Il2CppClass::FromTypeDefinitionIndex(MVector2_TypeDefinitionIndex)->GetStaticField(0x2F30);
		}
		static ::RPG::MVector2* StaticGet_downVector()
		{
			return (::RPG::MVector2*)Il2CppClass::FromTypeDefinitionIndex(MVector2_TypeDefinitionIndex)->GetStaticField(0x2F38);
		}
		static ::RPG::MVector2* StaticGet_positiveInfinityVector()
		{
			return (::RPG::MVector2*)Il2CppClass::FromTypeDefinitionIndex(MVector2_TypeDefinitionIndex)->GetStaticField(0x2F40);
		}
		static ::RPG::MVector2* StaticGet_rightVector()
		{
			return (::RPG::MVector2*)Il2CppClass::FromTypeDefinitionIndex(MVector2_TypeDefinitionIndex)->GetStaticField(0x2F48);
		}
		static ::RPG::MVector2* StaticGet_leftVector()
		{
			return (::RPG::MVector2*)Il2CppClass::FromTypeDefinitionIndex(MVector2_TypeDefinitionIndex)->GetStaticField(0x2F50);
		}
		static ::RPG::MVector2* StaticGet_oneVector()
		{
			return (::RPG::MVector2*)Il2CppClass::FromTypeDefinitionIndex(MVector2_TypeDefinitionIndex)->GetStaticField(0x2F58);
		}
