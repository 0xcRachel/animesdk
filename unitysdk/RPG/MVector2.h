...
#define RPG_MVECTOR2_ANGLE_OFFSET UNITYSDK_OFFSET(0x12EAE570)
#define RPG_MVECTOR2_CLAMPMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x12EAE8F0)
#define RPG_MVECTOR2_DISTANCE_OFFSET UNITYSDK_OFFSET(0x12EAE8B0)
#define RPG_MVECTOR2_DOT_OFFSET UNITYSDK_OFFSET(0x12EAE540)
#define RPG_MVECTOR2_EQUALS_OFFSET UNITYSDK_OFFSET(0x3741600)
#define RPG_MVECTOR2_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x37415C0)
#define RPG_MVECTOR2_GET_DOWN_OFFSET UNITYSDK_OFFSET(0x1B4E0DF0)
#define RPG_MVECTOR2_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x3741240)
#define RPG_MVECTOR2_GET_LEFT_OFFSET UNITYSDK_OFFSET(0x1B4E0E00)
#define RPG_MVECTOR2_GET_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x3741680)
#define RPG_MVECTOR2_GET_NEGATIVEINFINITY_OFFSET UNITYSDK_OFFSET(0x1B4E0E30)
#define RPG_MVECTOR2_GET_NORMALIZED_OFFSET UNITYSDK_OFFSET(0x37413E0)
#define RPG_MVECTOR2_GET_ONE_OFFSET UNITYSDK_OFFSET(0x1B4E0DD0)
#define RPG_MVECTOR2_GET_POSITIVEINFINITY_OFFSET UNITYSDK_OFFSET(0x1B4E0E20)
#define RPG_MVECTOR2_GET_RIGHT_OFFSET UNITYSDK_OFFSET(0x1B4E0E10)
#define RPG_MVECTOR2_GET_SQRMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x37416B0)
#define RPG_MVECTOR2_GET_UP_OFFSET UNITYSDK_OFFSET(0x1B4E0DE0)
#define RPG_MVECTOR2_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x1B4E0DC0)
#define RPG_MVECTOR2_LERPUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x12EAE160)
#define RPG_MVECTOR2_LERP_OFFSET UNITYSDK_OFFSET(0x12EAE0F0)
#define RPG_MVECTOR2_MAX_OFFSET UNITYSDK_OFFSET(0x12EAEA20)
#define RPG_MVECTOR2_MIN_OFFSET UNITYSDK_OFFSET(0x12EAE9F0)
#define RPG_MVECTOR2_MOVETOWARDS_OFFSET UNITYSDK_OFFSET(0x12EAE1A0)
#define RPG_MVECTOR2_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x3741370)
#define RPG_MVECTOR2_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x12E7DA80)
#define RPG_MVECTOR2_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x12E836B0)
#define RPG_MVECTOR2_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x12EAECB0)
#define RPG_MVECTOR2_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1B4E0D90)
#define RPG_MVECTOR2_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B4E0D80)
#define RPG_MVECTOR2_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x12EAECF0)
#define RPG_MVECTOR2_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x12E7DA50)
#define RPG_MVECTOR2_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x12E7FCD0)
#define RPG_MVECTOR2_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x12E7CE10)
#define RPG_MVECTOR2_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x12E978A0)
#define RPG_MVECTOR2_REFLECT_OFFSET UNITYSDK_OFFSET(0x12EAE4E0)
#define RPG_MVECTOR2_SCALE_1_OFFSET UNITYSDK_OFFSET(0x3741350)
#define RPG_MVECTOR2_SCALE_OFFSET UNITYSDK_OFFSET(0x12EAE280)
#define RPG_MVECTOR2_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x37412C0)
#define RPG_MVECTOR2_SET_OFFSET UNITYSDK_OFFSET(0x6C3BE0)
#define RPG_MVECTOR2_SIGNEDANGLE_OFFSET UNITYSDK_OFFSET(0x12EAE6F0)
#define RPG_MVECTOR2_SMOOTHDAMP_OFFSET UNITYSDK_OFFSET(0x12EAEA50)
#define RPG_MVECTOR2_SQRMAGNITUDE_1_OFFSET UNITYSDK_OFFSET(0x37416B0)
#define RPG_MVECTOR2_SQRMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x12EAE9C0)
#define RPG_MVECTOR2_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x3741510)
#define RPG_MVECTOR2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3741460)
#define RPG_MVECTOR2__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B4E0E40)
#define RPG_MVECTOR2__CTOR_OFFSET UNITYSDK_OFFSET(0x6C3BE0)
