...
#define RPG_EDITOR_ENVIRONMENTSYSTEMV2EDITOR_ENVEDITORPROPERTYLIST__CTOR_OFFSET UNITYSDK_OFFSET(0xA294A10)

namespace RPG::Editor::EnvironmentSystemV2Editor
{
	inline static constexpr unsigned int EnvEditorPropertyList_TypeDefinitionIndex = 41059;
