...
#define RPG_EDITOR_SKILLLINEASSETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA2967C0)

namespace RPG::Editor
{
	inline static constexpr unsigned int SkillLineAssetConfig_TypeDefinitionIndex = 41019;
