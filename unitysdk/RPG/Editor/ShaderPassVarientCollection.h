...
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xB1A6D60)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_27EC8924F4F29B89_OFFSET UNITYSDK_OFFSET(0xB1A6E40)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_305D7772FC4F3138_OFFSET UNITYSDK_OFFSET(0xB1A8200)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_4314164ED1025523_OFFSET UNITYSDK_OFFSET(0xB1A7910)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_6F9F6E3C25D55AFD_OFFSET UNITYSDK_OFFSET(0xB1A7D10)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_79F616D5C3C27F8A_OFFSET UNITYSDK_OFFSET(0xB1A7170)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_B2C0ADBFEA309440_OFFSET UNITYSDK_OFFSET(0xB1A7550)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_B732DC7FA82BA621_OFFSET UNITYSDK_OFFSET(0xB1A76F0)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_BD395A260D7ECC62_OFFSET UNITYSDK_OFFSET(0xB1A72F0)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_DAE70E7E8EA7A53C_OFFSET UNITYSDK_OFFSET(0xB1A7B90)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0xB1A8590)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xB1A6CE0)
...
namespace RPG::Editor
{
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(ShaderPassVarientCollection_TypeDefinitionIndex)->GetStaticField(0x5E3F0);
		}
		static ::RPG::Editor::ShaderPassVarientCollection** StaticGet__Asset()
		{
			return (::RPG::Editor::ShaderPassVarientCollection**)Il2CppClass::FromTypeDefinitionIndex(ShaderPassVarientCollection_TypeDefinitionIndex)->GetStaticField(0x5E3F8);
		}
		static ::Il2CppArray<::System::String*>** StaticGet__NoRuntimePassName()
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ShaderPassVarientCollection_TypeDefinitionIndex)->GetStaticField(0x5E400);
		}
