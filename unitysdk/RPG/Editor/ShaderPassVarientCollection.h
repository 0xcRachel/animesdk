...
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xA294BB0)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_27EC8924F4F29B89_OFFSET UNITYSDK_OFFSET(0xA294C90)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_305D7772FC4F3138_OFFSET UNITYSDK_OFFSET(0xA296050)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_4314164ED1025523_OFFSET UNITYSDK_OFFSET(0xA295760)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_6F9F6E3C25D55AFD_OFFSET UNITYSDK_OFFSET(0xA295B60)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_79F616D5C3C27F8A_OFFSET UNITYSDK_OFFSET(0xA294FC0)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_B2C0ADBFEA309440_OFFSET UNITYSDK_OFFSET(0xA2953A0)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_B732DC7FA82BA621_OFFSET UNITYSDK_OFFSET(0xA295540)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_BD395A260D7ECC62_OFFSET UNITYSDK_OFFSET(0xA295140)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_DAE70E7E8EA7A53C_OFFSET UNITYSDK_OFFSET(0xA2959E0)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0xA2963E0)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xA294B30)

namespace RPG::Editor
{
	inline static constexpr unsigned int ShaderPassVarientCollection_TypeDefinitionIndex = 40990;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(ShaderPassVarientCollection_TypeDefinitionIndex)->GetStaticField(0x38D70);
		}
		static ::RPG::Editor::ShaderPassVarientCollection** StaticGet__Asset()
		{
			return (::RPG::Editor::ShaderPassVarientCollection**)Il2CppClass::FromTypeDefinitionIndex(ShaderPassVarientCollection_TypeDefinitionIndex)->GetStaticField(0x38D78);
		}
		static ::Il2CppArray<::System::String*>** StaticGet__NoRuntimePassName()
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ShaderPassVarientCollection_TypeDefinitionIndex)->GetStaticField(0x38D80);
		}
