...
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xA7CF690)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_27EC8924F4F29B89_OFFSET UNITYSDK_OFFSET(0xA7CF770)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_305D7772FC4F3138_OFFSET UNITYSDK_OFFSET(0xA7D0B30)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_4314164ED1025523_OFFSET UNITYSDK_OFFSET(0xA7D0240)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_6F9F6E3C25D55AFD_OFFSET UNITYSDK_OFFSET(0xA7D0640)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_79F616D5C3C27F8A_OFFSET UNITYSDK_OFFSET(0xA7CFAA0)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_B2C0ADBFEA309440_OFFSET UNITYSDK_OFFSET(0xA7CFE80)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_B732DC7FA82BA621_OFFSET UNITYSDK_OFFSET(0xA7D0020)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_BD395A260D7ECC62_OFFSET UNITYSDK_OFFSET(0xA7CFC20)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_DAE70E7E8EA7A53C_OFFSET UNITYSDK_OFFSET(0xA7D04C0)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0xA7D0EC0)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xA7CF5F0)
...
namespace RPG::Editor
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ShaderPassVarientCollection_TypeDefinitionIndex)->GetStaticField(0x3E270);
		}
		static ::RPG::Editor::ShaderPassVarientCollection** StaticGet__Asset()
		{
			return (::RPG::Editor::ShaderPassVarientCollection**)Il2CppClass::FromTypeDefinitionIndex(ShaderPassVarientCollection_TypeDefinitionIndex)->GetStaticField(0x3E278);
		}
		static ::System::String** StaticGet__AssetPath()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(ShaderPassVarientCollection_TypeDefinitionIndex)->GetStaticField(0x3E280);
		}
