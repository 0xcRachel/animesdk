...
#define RPG_EDITOR_BGCURVEPCG_MULTSUBMESH_METHOD_2_0E5F9F723F3FD31F_OFFSET UNITYSDK_OFFSET(0xA7CCD60)
#define RPG_EDITOR_BGCURVEPCG_MULTSUBMESH_METHOD_2_2B9D478141E0F891_OFFSET UNITYSDK_OFFSET(0xA7CCC50)
#define RPG_EDITOR_BGCURVEPCG_MULTSUBMESH_METHOD_2_630EDA686801A28F_OFFSET UNITYSDK_OFFSET(0xA7CBB50)
#define RPG_EDITOR_BGCURVEPCG_MULTSUBMESH_METHOD_2_6F03F79E54DE121E_OFFSET UNITYSDK_OFFSET(0xA7CBD60)
#define RPG_EDITOR_BGCURVEPCG_MULTSUBMESH_METHOD_2_B917C58B4E14AC1B_OFFSET UNITYSDK_OFFSET(0xA7CC1D0)
#define RPG_EDITOR_BGCURVEPCG_MULTSUBMESH_METHOD_2_BF9BB9E2BBF3B6F4_OFFSET UNITYSDK_OFFSET(0xA7CBCF0)
#define RPG_EDITOR_BGCURVEPCG_MULTSUBMESH_METHOD_2_C20A8E714F76AB3E_OFFSET UNITYSDK_OFFSET(0xA7CCD10)
#define RPG_EDITOR_BGCURVEPCG_MULTSUBMESH_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA7CCCD0)
#define RPG_EDITOR_BGCURVEPCG_MULTSUBMESH_METHOD_2_F0F8DE036FE283F6_OFFSET UNITYSDK_OFFSET(0xA7CC160)
#define RPG_EDITOR_BGCURVEPCG_MULTSUBMESH__CTOR_OFFSET UNITYSDK_OFFSET(0xA7CCE70)
