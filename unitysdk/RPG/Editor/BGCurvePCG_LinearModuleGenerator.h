...
#define RPG_EDITOR_BGCURVEPCG_LINEARMODULEGENERATOR_METHOD_2_13F0FEDB1C58AAEC_OFFSET UNITYSDK_OFFSET(0xB1A2E70)
#define RPG_EDITOR_BGCURVEPCG_LINEARMODULEGENERATOR_METHOD_2_19E6130E11DE9B10_OFFSET UNITYSDK_OFFSET(0xB19F630)
#define RPG_EDITOR_BGCURVEPCG_LINEARMODULEGENERATOR_METHOD_2_3D2B77EBCAE390AB_OFFSET UNITYSDK_OFFSET(0xB1A0CA0)
#define RPG_EDITOR_BGCURVEPCG_LINEARMODULEGENERATOR_METHOD_2_5D235433A0288AF8_OFFSET UNITYSDK_OFFSET(0xB19FC90)
#define RPG_EDITOR_BGCURVEPCG_LINEARMODULEGENERATOR_METHOD_2_796376D4C7B57B85_OFFSET UNITYSDK_OFFSET(0xB1A2910)
#define RPG_EDITOR_BGCURVEPCG_LINEARMODULEGENERATOR_METHOD_2_87C2079BDA6B4F34_OFFSET UNITYSDK_OFFSET(0xB19F710)
#define RPG_EDITOR_BGCURVEPCG_LINEARMODULEGENERATOR_METHOD_2_8EE45C9ADEDB0506_OFFSET UNITYSDK_OFFSET(0xB1A2740)
#define RPG_EDITOR_BGCURVEPCG_LINEARMODULEGENERATOR_METHOD_2_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xB1A26D0)
#define RPG_EDITOR_BGCURVEPCG_LINEARMODULEGENERATOR_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB1A1390)
#define RPG_EDITOR_BGCURVEPCG_LINEARMODULEGENERATOR_METHOD_2_DC4DC6EABAAA4D92_OFFSET UNITYSDK_OFFSET(0xB19F860)
#define RPG_EDITOR_BGCURVEPCG_LINEARMODULEGENERATOR_METHOD_2_EF2E74CEEC4FEFA5_OFFSET UNITYSDK_OFFSET(0xB19F550)
#define RPG_EDITOR_BGCURVEPCG_LINEARMODULEGENERATOR_METHOD_2_F496458A8038CA66_OFFSET UNITYSDK_OFFSET(0xB1A2F10)
#define RPG_EDITOR_BGCURVEPCG_LINEARMODULEGENERATOR_METHOD_2_F9A381FFDBA756DD_OFFSET UNITYSDK_OFFSET(0xB1A1D10)
#define RPG_EDITOR_BGCURVEPCG_LINEARMODULEGENERATOR_METHOD_2_FAA9DC03DCA4FFB1_OFFSET UNITYSDK_OFFSET(0xB1A13D0)
#define RPG_EDITOR_BGCURVEPCG_LINEARMODULEGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xB1A2F90)
