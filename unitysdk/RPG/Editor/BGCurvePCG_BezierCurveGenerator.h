...
#define RPG_EDITOR_BGCURVEPCG_BEZIERCURVEGENERATOR_METHOD_2_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xA289280)
#define RPG_EDITOR_BGCURVEPCG_BEZIERCURVEGENERATOR_METHOD_2_1FF9A11EFEF8FFB3_OFFSET UNITYSDK_OFFSET(0xA289630)
#define RPG_EDITOR_BGCURVEPCG_BEZIERCURVEGENERATOR_METHOD_2_3C56C1AF247AC1EC_OFFSET UNITYSDK_OFFSET(0xA289DD0)
#define RPG_EDITOR_BGCURVEPCG_BEZIERCURVEGENERATOR_METHOD_2_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0xA28AA50)
#define RPG_EDITOR_BGCURVEPCG_BEZIERCURVEGENERATOR_METHOD_2_8894E534FED3129C_OFFSET UNITYSDK_OFFSET(0xA2895D0)
#define RPG_EDITOR_BGCURVEPCG_BEZIERCURVEGENERATOR_METHOD_2_96F7A194C92D21E8_OFFSET UNITYSDK_OFFSET(0xA2893B0)
#define RPG_EDITOR_BGCURVEPCG_BEZIERCURVEGENERATOR_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA289540)
#define RPG_EDITOR_BGCURVEPCG_BEZIERCURVEGENERATOR_METHOD_2_E631B63295647DB5_OFFSET UNITYSDK_OFFSET(0xA2894F0)
#define RPG_EDITOR_BGCURVEPCG_BEZIERCURVEGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xA28AB20)

namespace RPG::Editor
{
	inline static constexpr unsigned int BGCurvePCG_BezierCurveGenerator_TypeDefinitionIndex = 41000;
