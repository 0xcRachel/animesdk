...
#define RPG_EDITOR_SKILLPOINTSIMCONFIG_GET_CONTENTTITLE_OFFSET UNITYSDK_OFFSET(0xA297330)
#define RPG_EDITOR_SKILLPOINTSIMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA2972C0)

namespace RPG::Editor
{
	inline static constexpr unsigned int SkillPointSimConfig_TypeDefinitionIndex = 41026;
