...
#define RPG_UINAVIGATION_UINAVIGATIONAREACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA5D26A0)

namespace RPG::UINavigation
{
	inline static constexpr unsigned int UINavigationAreaConfig_TypeDefinitionIndex = 40780;
