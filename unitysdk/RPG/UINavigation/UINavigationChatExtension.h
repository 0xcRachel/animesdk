...
#define RPG_UINAVIGATION_UINAVIGATIONCHATEXTENSION_GETFIRSTSELECTABLE_OFFSET UNITYSDK_OFFSET(0x17B5A640)
#define RPG_UINAVIGATION_UINAVIGATIONCHATEXTENSION_METHOD_6_2BF2BE327F577697_OFFSET UNITYSDK_OFFSET(0x17B5A840)
#define RPG_UINAVIGATION_UINAVIGATIONCHATEXTENSION_METHOD_6_53A27BD4FBBC063A_OFFSET UNITYSDK_OFFSET(0x17B5A990)
#define RPG_UINAVIGATION_UINAVIGATIONCHATEXTENSION_METHOD_6_5CE279A17BFB4762_OFFSET UNITYSDK_OFFSET(0x17B59E10)
#define RPG_UINAVIGATION_UINAVIGATIONCHATEXTENSION_METHOD_6_6E37671A3C35FC0E_OFFSET UNITYSDK_OFFSET(0x17B5B390)
#define RPG_UINAVIGATION_UINAVIGATIONCHATEXTENSION_METHOD_6_AD0064E4659DB694_OFFSET UNITYSDK_OFFSET(0x17B5AE10)
#define RPG_UINAVIGATION_UINAVIGATIONCHATEXTENSION_METHOD_6_DFB2B1C709BA3C20_OFFSET UNITYSDK_OFFSET(0x17B5BB80)
#define RPG_UINAVIGATION_UINAVIGATIONCHATEXTENSION_METHOD_6_E23C97CEA99B7CE1_OFFSET UNITYSDK_OFFSET(0x17B59EC0)
#define RPG_UINAVIGATION_UINAVIGATIONCHATEXTENSION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x17B5A4C0)
#define RPG_UINAVIGATION_UINAVIGATIONCHATEXTENSION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17B5A1A0)
#define RPG_UINAVIGATION_UINAVIGATIONCHATEXTENSION_POSTONCHILDSELECTED_OFFSET UNITYSDK_OFFSET(0x17B5B230)
#define RPG_UINAVIGATION_UINAVIGATIONCHATEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x17B5BD30)
#define RPG_UINAVIGATION_UINAVIGATIONCHATEXTENSION___IFIXBASEPROXY_GETFIRSTSELECTABLE_OFFSET UNITYSDK_OFFSET(0x17B5BDF0)
#define RPG_UINAVIGATION_UINAVIGATIONCHATEXTENSION___IFIXBASEPROXY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x17B5BDA0)
#define RPG_UINAVIGATION_UINAVIGATIONCHATEXTENSION___IFIXBASEPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17B5BD50)
#define RPG_UINAVIGATION_UINAVIGATIONCHATEXTENSION___IFIXBASEPROXY_POSTONCHILDSELECTED_OFFSET UNITYSDK_OFFSET(0x17B5BE80)
