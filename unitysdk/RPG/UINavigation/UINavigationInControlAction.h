...
#define RPG_UINAVIGATION_UINAVIGATIONINCONTROLACTION_ADDNAVIGATIONZONE_OFFSET UNITYSDK_OFFSET(0xA5D4580)
#define RPG_UINAVIGATION_UINAVIGATIONINCONTROLACTION_AWAKE_OFFSET UNITYSDK_OFFSET(0xA5D4C70)
#define RPG_UINAVIGATION_UINAVIGATIONINCONTROLACTION_BELONGTONAVIGATIONZONE_OFFSET UNITYSDK_OFFSET(0xA5D46D0)
#define RPG_UINAVIGATION_UINAVIGATIONINCONTROLACTION_GETACTIONHINTNAME_OFFSET UNITYSDK_OFFSET(0xA5D52D0)
#define RPG_UINAVIGATION_UINAVIGATIONINCONTROLACTION_GET_NAVIGATIONZONE_OFFSET UNITYSDK_OFFSET(0xA5D4260)
#define RPG_UINAVIGATION_UINAVIGATIONINCONTROLACTION_GET_NAVIGATION_OFFSET UNITYSDK_OFFSET(0xA5D4410)
#define RPG_UINAVIGATION_UINAVIGATIONINCONTROLACTION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA5D4E20)
#define RPG_UINAVIGATION_UINAVIGATIONINCONTROLACTION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA5D5090)
#define RPG_UINAVIGATION_UINAVIGATIONINCONTROLACTION_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA5D4FD0)
#define RPG_UINAVIGATION_UINAVIGATIONINCONTROLACTION_ONINCONTROLACTIONSTATUSCHANGE_OFFSET UNITYSDK_OFFSET(0xA5D5280)
#define RPG_UINAVIGATION_UINAVIGATIONINCONTROLACTION_ONNAVIGATIONPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0xA5D4A30)
#define RPG_UINAVIGATION_UINAVIGATIONINCONTROLACTION_ONTRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0xA5D5220)
#define RPG_UINAVIGATION_UINAVIGATIONINCONTROLACTION_REFRESHINCONTROLHINT_OFFSET UNITYSDK_OFFSET(0xA5D4800)
#define RPG_UINAVIGATION_UINAVIGATIONINCONTROLACTION_RESETNAVIGATIONZONE_OFFSET UNITYSDK_OFFSET(0xA5D45F0)
#define RPG_UINAVIGATION_UINAVIGATIONINCONTROLACTION_SETACTIONHINTNAME_OFFSET UNITYSDK_OFFSET(0xA5D4780)
#define RPG_UINAVIGATION_UINAVIGATIONINCONTROLACTION_SETCONTROLLEDBYBUTTON_OFFSET UNITYSDK_OFFSET(0xA5D2AE0)
#define RPG_UINAVIGATION_UINAVIGATIONINCONTROLACTION_SETNAVIGATIONZONE_OFFSET UNITYSDK_OFFSET(0xA5D4480)
#define RPG_UINAVIGATION_UINAVIGATIONINCONTROLACTION_SHOULDSHOWINCONTROLACTIONHINT_OFFSET UNITYSDK_OFFSET(0xA5D5320)
#define RPG_UINAVIGATION_UINAVIGATIONINCONTROLACTION_UPDATEINCONTROLACTIONSTATUS_OFFSET UNITYSDK_OFFSET(0xA5D4670)
#define RPG_UINAVIGATION_UINAVIGATIONINCONTROLACTION__ADDTONAVIGATION_OFFSET UNITYSDK_OFFSET(0xA5D4CC0)
#define RPG_UINAVIGATION_UINAVIGATIONINCONTROLACTION__CCTOR_OFFSET UNITYSDK_OFFSET(0xA5D59D0)
#define RPG_UINAVIGATION_UINAVIGATIONINCONTROLACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xA5D5980)
#define RPG_UINAVIGATION_UINAVIGATIONINCONTROLACTION__FINDVALIDSPECIFIEDZONE_OFFSET UNITYSDK_OFFSET(0xA5D5360)
#define RPG_UINAVIGATION_UINAVIGATIONINCONTROLACTION__INITINCONTROLACTIONSTATUS_OFFSET UNITYSDK_OFFSET(0xA5D4A80)
#define RPG_UINAVIGATION_UINAVIGATIONINCONTROLACTION__ISZONEATTOP_OFFSET UNITYSDK_OFFSET(0xA5D5620)
#define RPG_UINAVIGATION_UINAVIGATIONINCONTROLACTION__MARKZONESHOULDREBUILDINCONTROLACTIONS_OFFSET UNITYSDK_OFFSET(0xA5D4B30)
#define RPG_UINAVIGATION_UINAVIGATIONINCONTROLACTION__MARKZONESHOULDUPDATEINCONTROLHINTS_OFFSET UNITYSDK_OFFSET(0xA5D4850)
#define RPG_UINAVIGATION_UINAVIGATIONINCONTROLACTION__REMOVEFROMNAVIGATION_OFFSET UNITYSDK_OFFSET(0xA5D4E70)

namespace RPG::UINavigation
{
	inline static constexpr unsigned int UINavigationInControlAction_TypeDefinitionIndex = 40782;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::RPG::UINavigation::UINavigationInControlAction*>**)Il2CppClass::FromTypeDefinitionIndex(UINavigationInControlAction_TypeDefinitionIndex)->GetStaticField(0x464E0);
		}
		...
		::System::Void _InitInControlActionStatus()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_UINAVIGATION_UINAVIGATIONINCONTROLACTION__INITINCONTROLACTIONSTATUS_OFFSET))(this);
		}

		::System::Boolean _IsZoneAtTop()
		{
			return ((::System::Boolean(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_UINAVIGATION_UINAVIGATIONINCONTROLACTION__ISZONEATTOP_OFFSET))(this);
		}
	};
}
