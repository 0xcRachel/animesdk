...
#define RPG_HASHUTILS_THREADFILESTREAM_READ_OFFSET UNITYSDK_OFFSET(0x172BA4A0)
#define RPG_HASHUTILS_THREADFILESTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x172B9240)

namespace RPG
{
	inline static constexpr unsigned int HashUtils_ThreadFileStream_TypeDefinitionIndex = 8560;
