...
#define RPG_CUSTOMRP_PREVIEWPPFS_METHOD_5_0E3D8071A5930FA8_1_OFFSET UNITYSDK_OFFSET(0xA285D60)
#define RPG_CUSTOMRP_PREVIEWPPFS_METHOD_5_0E3D8071A5930FA8_OFFSET UNITYSDK_OFFSET(0xA283940)
#define RPG_CUSTOMRP_PREVIEWPPFS_METHOD_5_81A66FB988DFA6AA_OFFSET UNITYSDK_OFFSET(0xA284870)
#define RPG_CUSTOMRP_PREVIEWPPFS_METHOD_5_A2172401030892FD_OFFSET UNITYSDK_OFFSET(0xA287D50)
#define RPG_CUSTOMRP_PREVIEWPPFS_METHOD_5_AE80CBC984AADFD5_1_OFFSET UNITYSDK_OFFSET(0xA287770)
#define RPG_CUSTOMRP_PREVIEWPPFS_METHOD_5_AE80CBC984AADFD5_OFFSET UNITYSDK_OFFSET(0xA285290)
#define RPG_CUSTOMRP_PREVIEWPPFS_METHOD_5_B29205EE7F7B640C_OFFSET UNITYSDK_OFFSET(0xA284CD0)
#define RPG_CUSTOMRP_PREVIEWPPFS_METHOD_5_C83B2479936B63C3_OFFSET UNITYSDK_OFFSET(0xA285930)
#define RPG_CUSTOMRP_PREVIEWPPFS_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA2886A0)
#define RPG_CUSTOMRP_PREVIEWPPFS_START_OFFSET UNITYSDK_OFFSET(0xA2837A0)
#define RPG_CUSTOMRP_PREVIEWPPFS_UPDATE_OFFSET UNITYSDK_OFFSET(0xA283820)
#define RPG_CUSTOMRP_PREVIEWPPFS__CTOR_OFFSET UNITYSDK_OFFSET(0xA289270)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int previewPPFS_TypeDefinitionIndex = 40852;
