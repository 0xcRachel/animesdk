...
#define RPG_CUSTOMRP_PREVIEWPPFS_METHOD_5_0E3D8071A5930FA8_1_OFFSET UNITYSDK_OFFSET(0xA7C0860)
#define RPG_CUSTOMRP_PREVIEWPPFS_METHOD_5_0E3D8071A5930FA8_OFFSET UNITYSDK_OFFSET(0xA7BE440)
#define RPG_CUSTOMRP_PREVIEWPPFS_METHOD_5_81A66FB988DFA6AA_OFFSET UNITYSDK_OFFSET(0xA7BF370)
#define RPG_CUSTOMRP_PREVIEWPPFS_METHOD_5_A2172401030892FD_OFFSET UNITYSDK_OFFSET(0xA7C2850)
#define RPG_CUSTOMRP_PREVIEWPPFS_METHOD_5_AE80CBC984AADFD5_1_OFFSET UNITYSDK_OFFSET(0xA7C2270)
#define RPG_CUSTOMRP_PREVIEWPPFS_METHOD_5_AE80CBC984AADFD5_OFFSET UNITYSDK_OFFSET(0xA7BFD90)
#define RPG_CUSTOMRP_PREVIEWPPFS_METHOD_5_B29205EE7F7B640C_OFFSET UNITYSDK_OFFSET(0xA7BF7D0)
#define RPG_CUSTOMRP_PREVIEWPPFS_METHOD_5_C83B2479936B63C3_OFFSET UNITYSDK_OFFSET(0xA7C0430)
#define RPG_CUSTOMRP_PREVIEWPPFS_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA7C31A0)
#define RPG_CUSTOMRP_PREVIEWPPFS_START_OFFSET UNITYSDK_OFFSET(0xA7BE2A0)
#define RPG_CUSTOMRP_PREVIEWPPFS_UPDATE_OFFSET UNITYSDK_OFFSET(0xA7BE320)
#define RPG_CUSTOMRP_PREVIEWPPFS__CTOR_OFFSET UNITYSDK_OFFSET(0xA7C3D70)
