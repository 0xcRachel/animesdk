...
#define RPG_CUSTOMRP_PARAMTABLE_CONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x163AA810)
#define RPG_CUSTOMRP_PARAMTABLE_CONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x163AA850)
#define RPG_CUSTOMRP_PARAMTABLE_CONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x163AA920)
#define RPG_CUSTOMRP_PARAMTABLE_CONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x163AA9F0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int ParamTable_Converter_TypeDefinitionIndex = 28653;
