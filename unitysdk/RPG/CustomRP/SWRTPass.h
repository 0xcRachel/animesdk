...
#define RPG_CUSTOMRP_SWRTPASS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15AA0900)
#define RPG_CUSTOMRP_SWRTPASS_INNEREXCUTE_OFFSET UNITYSDK_OFFSET(0x15A9F080)
#define RPG_CUSTOMRP_SWRTPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x15A9F030)
...
namespace RPG::CustomRP
{
	...
	{
	public:
		::UnityEngine::ComputeBuffer* _Positions; // 0x10
		::UnityEngine::ComputeBuffer* _BVHNodes8; // 0x18
		::UnityEngine::ComputeBuffer* _TriangleIndex8; // 0x20
		::UnityEngine::RenderTexture* _AtlasNormal; // 0x28
		::UnityEngine::ComputeBuffer* _UVs; // 0x30
		::UnityEngine::ComputeBuffer* _Tangents; // 0x38
		::UnityEngine::ComputeBuffer* _RendererIndex8; // 0x40
		::UnityEngine::Material* _BlitMaterial; // 0x48
		::SWRT::SWRT* _CurSWRT; // 0x50
		::UnityEngine::ComputeBuffer* _LocalToWorlds; // 0x58
		::UnityEngine::ComputeBuffer* _Materials; // 0x60
		::UnityEngine::RenderTexture* _AtlasAlbedo; // 0x68
		::UnityEngine::ComputeBuffer* _Indices; // 0x70
		::UnityEngine::ComputeBuffer* _BlasIndex; // 0x78
		::UnityEngine::ComputeBuffer* _Triangle8; // 0x80
		::UnityEngine::ComputeBuffer* _WorldToLocals; // 0x88
		::UnityEngine::ComputeBuffer* _BlasOffsets8; // 0x90
