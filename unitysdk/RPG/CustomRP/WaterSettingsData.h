...
#define RPG_CUSTOMRP_WATERSETTINGSDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x163E45B0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int WaterSettingsData_TypeDefinitionIndex = 28586;
