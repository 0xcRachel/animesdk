...
#define RPG_CUSTOMRP_CAPTURESCENE_CAPTUREAMBIENTTEX_OFFSET UNITYSDK_OFFSET(0x16A923D0)
#define RPG_CUSTOMRP_CAPTURESCENE_CAPTUREPROBEOUTPUT_OFFSET UNITYSDK_OFFSET(0x16A92320)
#define RPG_CUSTOMRP_CAPTURESCENE_CAPTURESCENEOUTPUT_OFFSET UNITYSDK_OFFSET(0x16A922D0)
#define RPG_CUSTOMRP_CAPTURESCENE_CAPTURE_OFFSET UNITYSDK_OFFSET(0x16A917F0)
#define RPG_CUSTOMRP_CAPTURESCENE_QACAPTUREALL_OFFSET UNITYSDK_OFFSET(0x16A92430)
#define RPG_CUSTOMRP_CAPTURESCENE__CAPTURECOROUTINE_OFFSET UNITYSDK_OFFSET(0x16A92380)
#define RPG_CUSTOMRP_CAPTURESCENE__CAPTURESCENEOUTPUTCOROUTINE_OFFSET UNITYSDK_OFFSET(0x16A92270)
#define RPG_CUSTOMRP_CAPTURESCENE__CBSCENE_OFFSET UNITYSDK_OFFSET(0x16A91B10)
#define RPG_CUSTOMRP_CAPTURESCENE__CTOR_OFFSET UNITYSDK_OFFSET(0x16A924F0)
#define RPG_CUSTOMRP_CAPTURESCENE__DUMPPARAMS_OFFSET UNITYSDK_OFFSET(0x16A919A0)
#define RPG_CUSTOMRP_CAPTURESCENE__QACAPTUREALL_OFFSET UNITYSDK_OFFSET(0x16A92480)
