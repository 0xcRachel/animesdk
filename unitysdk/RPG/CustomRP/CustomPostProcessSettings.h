...
#define RPG_CUSTOMRP_CUSTOMPOSTPROCESSSETTINGS_RESET_OFFSET UNITYSDK_OFFSET(0x16394600)
#define RPG_CUSTOMRP_CUSTOMPOSTPROCESSSETTINGS_SETUP_OFFSET UNITYSDK_OFFSET(0x16394430)
#define RPG_CUSTOMRP_CUSTOMPOSTPROCESSSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x16394420)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int CustomPostProcessSettings_TypeDefinitionIndex = 28506;

	class CustomPostProcessSettings : public ::System::Object
	{
	public:
		::RPG::CustomRP::RPGRadialBlur* directionBlur; // 0x10
		::RPG::CustomRP::RPGBloom* bloom; // 0x18
		::RPG::CustomRP::RPGColorGrading* colorGrading; // 0x20
		::RPG::CustomRP::RPGAdditionalColorGrading* additionalColorGrading; // 0x28
		::RPG::CustomRP::RPGGaussianBlur* gaussianBlur; // 0x30
		...
		::RPG::CustomRP::RPGTonemapping* toneMapping; // 0x50
		::RPG::CustomRP::RPGBlink* blink; // 0x58
		::RPG::CustomRP::RPGVignette* vignette; // 0x60
		::RPG::CustomRP::RPGSkillRadialBlur* skillRadialBlur; // 0x68
		::RPG::CustomRP::RPGLensGlitch2* ppLensGlitch2; // 0x70
		::RPG::CustomRP::RPGMotionBlur* motionBlur; // 0x78
		::RPG::CustomRP::RPGRadialBlur* radialBlur; // 0x80
		::RPG::CustomRP::RPGSpeedLine* speedLine; // 0x88
		::RPG::CustomRP::RPGPPPattern* ppPattern; // 0x90
		::RPG::CustomRP::RPGFXAA* fxaa; // 0x98
		::RPG::CustomRP::RPGPolaroid* polaroid; // 0xA0
		::RPG::CustomRP::RPGChromaticAberration* chromaticAberration; // 0xA8
		::RPG::CustomRP::RPGTemporalAntialiasing* taa; // 0xB0
		::UnityEngine::RenderTextureDescriptor sharedDesc; // 0xB8
		::System::Int32 cameraPixelHeight; // 0xEC
		::System::Single cameraNear; // 0xF0
		::System::Single cameraAspect; // 0xF4
		::RPG::CustomRP::GameCameraType cameraType; // 0xF8
		::System::Boolean targetTextureIsNull; // 0xFC
		::System::Boolean isUI3DCameraEnable; // 0xFD
		::UnityEngine::Vector3 cameraForward; // 0x100
		::System::Single cameraFar; // 0x10C
		::System::Single cameraRenderScale; // 0x110
		::System::Int32 cameraPixelWidth; // 0x114
		::System::Boolean finalRenderToTexture; // 0x118
		::System::Boolean isPostProcessEnable; // 0x119
		::System::Boolean isTAAEnable; // 0x11A
		::System::Single cameraFov; // 0x11C
