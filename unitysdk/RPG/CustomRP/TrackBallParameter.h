...
#define RPG_CUSTOMRP_TRACKBALLPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x163B3CC0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int TrackBallParameter_TypeDefinitionIndex = 28526;
