...
#define RPG_CUSTOMRP_RPGSKILLRADIALBLURRENDERER_INNEREXECUTE_OFFSET UNITYSDK_OFFSET(0x163CDB40)
#define RPG_CUSTOMRP_RPGSKILLRADIALBLURRENDERER_UPDATE_OFFSET UNITYSDK_OFFSET(0x163CDA10)
#define RPG_CUSTOMRP_RPGSKILLRADIALBLURRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x163CD910)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int RPGSkillRadialBlurRenderer_TypeDefinitionIndex = 28573;
