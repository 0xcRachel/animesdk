...
#define RPG_CUSTOMRP_CAPTURESCENE___CAPTURESCENEOUTPUTCOROUTINE_D__13_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x163851B0)
#define RPG_CUSTOMRP_CAPTURESCENE___CAPTURESCENEOUTPUTCOROUTINE_D__13_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x16385430)
#define RPG_CUSTOMRP_CAPTURESCENE___CAPTURESCENEOUTPUTCOROUTINE_D__13_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x16385490)
#define RPG_CUSTOMRP_CAPTURESCENE___CAPTURESCENEOUTPUTCOROUTINE_D__13_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x16385440)
#define RPG_CUSTOMRP_CAPTURESCENE___CAPTURESCENEOUTPUTCOROUTINE_D__13_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x163851A0)
#define RPG_CUSTOMRP_CAPTURESCENE___CAPTURESCENEOUTPUTCOROUTINE_D__13__CTOR_OFFSET UNITYSDK_OFFSET(0x16383210)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int CaptureScene___CaptureSceneOutputCoroutine_d__13_TypeDefinitionIndex = 28348;
	...
	public:
		...
		::UnityEngine::RenderTexture* _tex_5__2; // 0x28
