...
#define RPG_CUSTOMRP_MOTIONBLURMETHODPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x163A7850)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int MotionBlurMethodParameter_TypeDefinitionIndex = 28561;
