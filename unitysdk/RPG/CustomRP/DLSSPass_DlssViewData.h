...
#define RPG_CUSTOMRP_DLSSPASS_DLSSVIEWDATA_CANFITINPUT_OFFSET UNITYSDK_OFFSET(0x20183C0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int DLSSPass_DlssViewData_TypeDefinitionIndex = 28305;
