...
#define RPG_CUSTOMRP_REFLECTIONRENDERDATA_RESET_OFFSET UNITYSDK_OFFSET(0x2019160)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int ReflectionRenderData_TypeDefinitionIndex = 28312;
