...
#define RPG_CUSTOMRP_DEBUGWIREFRAMEPASS___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x16AAC5D0)
#define RPG_CUSTOMRP_DEBUGWIREFRAMEPASS___C__CTOR_OFFSET UNITYSDK_OFFSET(0x16AAC610)
#define RPG_CUSTOMRP_DEBUGWIREFRAMEPASS___C__INNEREXECUTE_B__5_0_OFFSET UNITYSDK_OFFSET(0x16AAC620)
...
namespace RPG::CustomRP
{
	...
	public:
		...
		{
			return (::System::Func_2<::UnityEngine::Collider*, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(DebugWireframePass___c_TypeDefinitionIndex)->GetStaticField(0x2B360);
		}
		static ::RPG::CustomRP::DebugWireframePass___c** StaticGet___9()
		{
			return (::RPG::CustomRP::DebugWireframePass___c**)Il2CppClass::FromTypeDefinitionIndex(DebugWireframePass___c_TypeDefinitionIndex)->GetStaticField(0x2B368);
		}
