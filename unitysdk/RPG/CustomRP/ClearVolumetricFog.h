...
#define RPG_CUSTOMRP_CLEARVOLUMETRICFOG_START_OFFSET UNITYSDK_OFFSET(0x157143B0)
#define RPG_CUSTOMRP_CLEARVOLUMETRICFOG_UPDATE_OFFSET UNITYSDK_OFFSET(0x15714460)
#define RPG_CUSTOMRP_CLEARVOLUMETRICFOG__CTOR_OFFSET UNITYSDK_OFFSET(0x157149B0)
#define RPG_CUSTOMRP_CLEARVOLUMETRICFOG__DOCLEAR_OFFSET UNITYSDK_OFFSET(0x15714890)
#define RPG_CUSTOMRP_CLEARVOLUMETRICFOG__RECOVER_OFFSET UNITYSDK_OFFSET(0x15714790)
