...
#define RPG_CUSTOMRP_REFLECTIONSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x163D8F50)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int ReflectionSetting_TypeDefinitionIndex = 28583;
