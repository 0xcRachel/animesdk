...
#define RPG_CUSTOMRP_DEBUGSHADERVIPMATERIALLISTREQMSGCREATOR_ONMSG_OFFSET UNITYSDK_OFFSET(0x157EDC00)
#define RPG_CUSTOMRP_DEBUGSHADERVIPMATERIALLISTREQMSGCREATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x157EE650)
#define RPG_CUSTOMRP_DEBUGSHADERVIPMATERIALLISTREQMSGCREATOR__FINDTYPE_OFFSET UNITYSDK_OFFSET(0x157EE1F0)
#define RPG_CUSTOMRP_DEBUGSHADERVIPMATERIALLISTREQMSGCREATOR__GETSHADERTESTCASEINSTANCE_OFFSET UNITYSDK_OFFSET(0x157EE360)
#define RPG_CUSTOMRP_DEBUGSHADERVIPMATERIALLISTREQMSGCREATOR__GETSHADERTESTINITIALIZED_OFFSET UNITYSDK_OFFSET(0x157EE490)
