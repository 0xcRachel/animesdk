...
#define RPG_CUSTOMRP_RPGDEPTHOFFIELDRENDERER_COMPUTEFOCALLENGTHFROMFOV_OFFSET UNITYSDK_OFFSET(0x1580EC80)
#define RPG_CUSTOMRP_RPGDEPTHOFFIELDRENDERER_COMPUTEINFINITYCOCRADIUS_OFFSET UNITYSDK_OFFSET(0x15808B50)
#define RPG_CUSTOMRP_RPGDEPTHOFFIELDRENDERER_COMPUTEVIEWMAXBACKGROUNDCOCRADIUS_OFFSET UNITYSDK_OFFSET(0x15808DD0)
#define RPG_CUSTOMRP_RPGDEPTHOFFIELDRENDERER_COMPUTEVIEWMINFOREGROUNDCOCRADIUS_OFFSET UNITYSDK_OFFSET(0x15808D00)
#define RPG_CUSTOMRP_RPGDEPTHOFFIELDRENDERER_DEPTHTORESCOCRADIUS_OFFSET UNITYSDK_OFFSET(0x1580EBD0)
#define RPG_CUSTOMRP_RPGDEPTHOFFIELDRENDERER_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x15808400)
#define RPG_CUSTOMRP_RPGDEPTHOFFIELDRENDERER_GETDOFCOLORANDCOCFORMAT_OFFSET UNITYSDK_OFFSET(0x15808DF0)
#define RPG_CUSTOMRP_RPGDEPTHOFFIELDRENDERER_GET_GLOBALDOFQUALITY_OFFSET UNITYSDK_OFFSET(0x1580B2E0)
#define RPG_CUSTOMRP_RPGDEPTHOFFIELDRENDERER_INNEREXECUTE_OFFSET UNITYSDK_OFFSET(0x158084E0)
#define RPG_CUSTOMRP_RPGDEPTHOFFIELDRENDERER_SETCOCPARAMS_OFFSET UNITYSDK_OFFSET(0x15808E60)
#define RPG_CUSTOMRP_RPGDEPTHOFFIELDRENDERER_SETUPDOFBOKEHCIRCLELOW_OFFSET UNITYSDK_OFFSET(0x1580B3B0)
#define RPG_CUSTOMRP_RPGDEPTHOFFIELDRENDERER_SETUPDOFBOKEHCIRCLE_OFFSET UNITYSDK_OFFSET(0x1580C920)
#define RPG_CUSTOMRP_RPGDEPTHOFFIELDRENDERER_SETUPDOFBOKEHPOLYGON_OFFSET UNITYSDK_OFFSET(0x1580A620)
#define RPG_CUSTOMRP_RPGDEPTHOFFIELDRENDERER_SETUPDOFDEFAULT_OFFSET UNITYSDK_OFFSET(0x158091E0)
#define RPG_CUSTOMRP_RPGDEPTHOFFIELDRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x15807DA0)
...
namespace RPG::CustomRP
{
	...
	public:
		...
		::RPG::CustomRP::RTIDHandle _DOFBokehTex0; // 0x98
		::RPG::CustomRP::RTIDHandle _DOFBokehCoC; // 0xD0
		::RPG::CustomRP::RTIDHandle _HalfResCocTex; // 0x108
		::RPG::CustomRP::RTIDHandle _OutputBgdColorTex; // 0x140
		::System::Single InfinityBackgroundCocRadius; // 0x178
		::System::Single MinForegroundCocRadius; // 0x17C
		::RPG::CustomRP::RTIDHandle _DOFBokehTex1; // 0x180
		::System::Single FocusDistance; // 0x1B8
		::System::Single MaxDepthBlurRadius; // 0x1BC
		::RPG::CustomRP::RTIDHandle _ForegroundCocTex1; // 0x1C0
		::RPG::CustomRP::RTIDHandle _DOFLowQualityColorTex; // 0x1F8
		::RPG::CustomRP::RTIDHandle _OutputFgdColorTex; // 0x230
		::RPG::CustomRP::RTIDHandle _HalfResColorTex; // 0x268
		::RPG::CustomRP::RTIDHandle _ColorCoCBuffer; // 0x2A0
		::RPG::CustomRP::RTIDHandle _OutputFgdOpacityTex; // 0x2D8
		::RPG::CustomRP::RTIDHandle _OutputColorImmediateTex; // 0x310
		::RPG::CustomRP::RTIDHandle _BackgroundCocTex1; // 0x348
		::RPG::CustomRP::RTIDHandle _ForegroundCocTex0; // 0x380
		::RPG::CustomRP::RTIDHandle _BackgroundCocTex0; // 0x3B8
		::RPG::CustomRP::RTIDHandle _COCTile; // 0x3F0
