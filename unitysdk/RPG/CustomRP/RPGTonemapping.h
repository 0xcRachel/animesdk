...
#define RPG_CUSTOMRP_RPGTONEMAPPING__CTOR_OFFSET UNITYSDK_OFFSET(0x163CF5B0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int RPGTonemapping_TypeDefinitionIndex = 28580;
