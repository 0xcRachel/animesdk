...
#define RPG_CUSTOMRP_RTIDHANDLE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x2246D20)
#define RPG_CUSTOMRP_RTIDHANDLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x2246CE0)
#define RPG_CUSTOMRP_RTIDHANDLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x608A20)
#define RPG_CUSTOMRP_RTIDHANDLE_INIT_OFFSET UNITYSDK_OFFSET(0x2246C40)
#define RPG_CUSTOMRP_RTIDHANDLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x15A990C0)
#define RPG_CUSTOMRP_RTIDHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x2246C40)
...
namespace RPG::CustomRP
{
	...
	struct alignas(8) RTIDHandle
	{
		...
		{
			return (::RPG::CustomRP::RTIDHandle*)Il2CppClass::FromTypeDefinitionIndex(RTIDHandle_TypeDefinitionIndex)->GetStaticField(0x10760);
		}
