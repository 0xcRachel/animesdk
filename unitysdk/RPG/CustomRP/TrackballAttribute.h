...
#define RPG_CUSTOMRP_TRACKBALLATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B3C37C0)
#define RPG_CUSTOMRP_TRACKBALLATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3C37A0)
...
namespace RPG::CustomRP
{
	...
	public:
		...
		::RPG::CustomRP::TrackballAttribute_Mode mode; // 0x20
