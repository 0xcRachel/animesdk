...
#define RPG_CUSTOMRP_RPGFINALCOMPOSE_CACHELUTPARAMS_OFFSET UNITYSDK_OFFSET(0x15815350)
#define RPG_CUSTOMRP_RPGFINALCOMPOSE_DUMPTONEMAPPINGDATA_OFFSET UNITYSDK_OFFSET(0x1580FBA0)
#define RPG_CUSTOMRP_RPGFINALCOMPOSE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1580FA20)
#define RPG_CUSTOMRP_RPGFINALCOMPOSE_GET_CURRENTHDRHEADROOM_OFFSET UNITYSDK_OFFSET(0x15815320)
#define RPG_CUSTOMRP_RPGFINALCOMPOSE_INNEREXECUTE_OFFSET UNITYSDK_OFFSET(0x15810820)
#define RPG_CUSTOMRP_RPGFINALCOMPOSE_ISADDITIONALCOLORGRADINGENABLED_OFFSET UNITYSDK_OFFSET(0x15810090)
#define RPG_CUSTOMRP_RPGFINALCOMPOSE_ISLUTDIRTY_OFFSET UNITYSDK_OFFSET(0x158149B0)
#define RPG_CUSTOMRP_RPGFINALCOMPOSE_ISRARELYUSEDEFFECTSENABLED_OFFSET UNITYSDK_OFFSET(0x15810130)
#define RPG_CUSTOMRP_RPGFINALCOMPOSE_RELEASE_OFFSET UNITYSDK_OFFSET(0x1580FB10)
#define RPG_CUSTOMRP_RPGFINALCOMPOSE_SETUPFINALOUTPUT_OFFSET UNITYSDK_OFFSET(0x1580FB00)
#define RPG_CUSTOMRP_RPGFINALCOMPOSE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1580FA10)
#define RPG_CUSTOMRP_RPGFINALCOMPOSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1580F9A0)
#define RPG_CUSTOMRP_RPGFINALCOMPOSE__GENERATELUTIFNEEDED_OFFSET UNITYSDK_OFFSET(0x15813120)
#define RPG_CUSTOMRP_RPGFINALCOMPOSE__GENERATELUT_OFFSET UNITYSDK_OFFSET(0x15815870)
#define RPG_CUSTOMRP_RPGFINALCOMPOSE__ISCOLORGRADINGBAKELUT_OFFSET UNITYSDK_OFFSET(0x15811B80)
#define RPG_CUSTOMRP_RPGFINALCOMPOSE__SETUPADDITIONALCOLORGRADING_OFFSET UNITYSDK_OFFSET(0x15810260)
#define RPG_CUSTOMRP_RPGFINALCOMPOSE__SETUPBLINK_OFFSET UNITYSDK_OFFSET(0x15812B10)
#define RPG_CUSTOMRP_RPGFINALCOMPOSE__SETUPCHROMATICABERRATION_OFFSET UNITYSDK_OFFSET(0x15813370)
#define RPG_CUSTOMRP_RPGFINALCOMPOSE__SETUPCOLORGRADING_OFFSET UNITYSDK_OFFSET(0x15811BC0)
#define RPG_CUSTOMRP_RPGFINALCOMPOSE__SETUPFXAA_OFFSET UNITYSDK_OFFSET(0x158147D0)
#define RPG_CUSTOMRP_RPGFINALCOMPOSE__SETUPLENSDISTORTION_OFFSET UNITYSDK_OFFSET(0x15813F30)
#define RPG_CUSTOMRP_RPGFINALCOMPOSE__SETUPPOLAROID_OFFSET UNITYSDK_OFFSET(0x15812730)
#define RPG_CUSTOMRP_RPGFINALCOMPOSE__SETUPSPEEDLINE_OFFSET UNITYSDK_OFFSET(0x15813650)
#define RPG_CUSTOMRP_RPGFINALCOMPOSE__SETUPTONEMAPPING_OFFSET UNITYSDK_OFFSET(0x15815E30)
#define RPG_CUSTOMRP_RPGFINALCOMPOSE__SETUPVIGNETTE_OFFSET UNITYSDK_OFFSET(0x158134C0)
#define RPG_CUSTOMRP_RPGFINALCOMPOSE__UBERBLIT_OFFSET UNITYSDK_OFFSET(0x15814300)
...
namespace RPG::CustomRP
{
	...
	public:
		...
		::UnityEngine::RenderTexture* _CachedLutRT; // 0x48
		...
		::UnityEngine::Vector4 _CachedColorSaturationMidtone; // 0x68
		::System::Boolean _CachedDebugHDROutputIntermediate; // 0x78
		::System::Boolean _CachedHDRActive; // 0x79
		::System::Single _CachedGamma; // 0x7C
		::UnityEngine::Vector4 _CachedColorContrastGlobal; // 0x80
		::UnityEngine::Vector4 _CachedColorGainShadow; // 0x90
		::UnityEngine::Vector4 _CachedColorGainGlobal; // 0xA0
		::UnityEngine::Vector4 _CachedColorContrastShadow; // 0xB0
		::System::Single _CachedColorCorrectionShadowMax; // 0xC0
		::System::Single _CachedToeLength; // 0xC4
		::System::Single _CachedShoulderAngle; // 0xC8
		::System::Single _CachedLevelShadowTone; // 0xCC
		::UnityEngine::Color _CachedLevelColor; // 0xD0
		::UnityEngine::Vector4 _CachedColorSaturationHighlight; // 0xE0
		::System::Single _CachedToeStrength; // 0xF0
		::UnityEngine::Vector4 _CachedColorContrastHighlight; // 0xF4
		::System::Single _CachedHDRHeadroom; // 0x104
		::UnityEngine::Vector4 _LutParam; // 0x108
		::UnityEngine::Vector4 _CachedColorSaturationGlobal; // 0x118
		::UnityEngine::Vector4 _CachedColorSaturationShadow; // 0x128
		::System::Single _CachedColorCorrectionHighlightMin; // 0x138
		::System::Int32 _GenerateFrameCount; // 0x13C
		::System::Single _CachedShoulderLength; // 0x140
		::UnityEngine::Vector4 _CachedColorGainHighlight; // 0x144
		::System::Single _CachedLevelHighTone; // 0x154
		::System::Int32 _OutputRT; // 0x158
		::UnityEngine::Vector4 _CachedColorContrastMidtone; // 0x15C
		::System::Single _CachedExpandGamut; // 0x16C
		::System::Boolean _CachedColorGradingEnable; // 0x170
		::System::Boolean _CachedTonemappingEnable; // 0x171
		::System::Boolean _CachedDebugEnableGamutClipping; // 0x172
		::System::Boolean _CachedForceDisableToneMapping; // 0x173
		::System::Single _CachedShoulderStrength; // 0x174
		::UnityEngine::Vector4 _CachedColorGainMidtone; // 0x178
