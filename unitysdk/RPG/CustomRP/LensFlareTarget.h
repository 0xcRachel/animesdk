...
#define RPG_CUSTOMRP_LENSFLARETARGET_COMPARETO_OFFSET UNITYSDK_OFFSET(0x16AB26E0)
#define RPG_CUSTOMRP_LENSFLARETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x16AB2730)
