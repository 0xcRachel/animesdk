...
#define RPG_CUSTOMRP_DEBUGSHADERVIPMATERIALLISTRSPMSG_ENSURECAPACITY_OFFSET UNITYSDK_OFFSET(0x157EE5F0)
#define RPG_CUSTOMRP_DEBUGSHADERVIPMATERIALLISTRSPMSG_GETMESSAGETYPE_OFFSET UNITYSDK_OFFSET(0x157EE690)
#define RPG_CUSTOMRP_DEBUGSHADERVIPMATERIALLISTRSPMSG_READ_OFFSET UNITYSDK_OFFSET(0x157EE7C0)
#define RPG_CUSTOMRP_DEBUGSHADERVIPMATERIALLISTRSPMSG_RESET_OFFSET UNITYSDK_OFFSET(0x157EE8E0)
#define RPG_CUSTOMRP_DEBUGSHADERVIPMATERIALLISTRSPMSG_WRITE_OFFSET UNITYSDK_OFFSET(0x157EE6D0)
#define RPG_CUSTOMRP_DEBUGSHADERVIPMATERIALLISTRSPMSG__CTOR_OFFSET UNITYSDK_OFFSET(0x157EE980)
