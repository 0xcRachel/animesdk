...
#define RPG_CUSTOMRP_MATERIALLIBRARY_CLEANUP_OFFSET UNITYSDK_OFFSET(0x163A6AB0)
#define RPG_CUSTOMRP_MATERIALLIBRARY_LOAD_OFFSET UNITYSDK_OFFSET(0x163A69F0)
#define RPG_CUSTOMRP_MATERIALLIBRARY__CTOR_OFFSET UNITYSDK_OFFSET(0x163A68E0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int MaterialLibrary_TypeDefinitionIndex = 28505;
	...
	public:
		...
		::UnityEngine::Material* fxaa; // 0x28
		::UnityEngine::Material* PPLensGlitch; // 0x30
		::UnityEngine::Material* smaa; // 0x38
		::UnityEngine::Material* lut2DBaker; // 0x40
		::UnityEngine::Material* motionBlur; // 0x48
