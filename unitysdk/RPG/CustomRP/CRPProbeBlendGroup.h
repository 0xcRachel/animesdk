...
#define RPG_CUSTOMRP_CRPPROBEBLENDGROUP_GETPROBE_OFFSET UNITYSDK_OFFSET(0x1525DEC0)
#define RPG_CUSTOMRP_CRPPROBEBLENDGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1525E120)
#define RPG_CUSTOMRP_CRPPROBEBLENDGROUP__GETPROBECOUNT_OFFSET UNITYSDK_OFFSET(0x1525DF60)
