...
#define RPG_CUSTOMRP_CRPPROBEBLENDGROUP_GETPROBE_OFFSET UNITYSDK_OFFSET(0x16379450)
#define RPG_CUSTOMRP_CRPPROBEBLENDGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x16379650)
#define RPG_CUSTOMRP_CRPPROBEBLENDGROUP__GETPROBECOUNT_OFFSET UNITYSDK_OFFSET(0x163794F0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int CRPProbeBlendGroup_TypeDefinitionIndex = 28431;
