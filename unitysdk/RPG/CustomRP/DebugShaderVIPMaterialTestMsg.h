...
#define RPG_CUSTOMRP_DEBUGSHADERVIPMATERIALTESTMSG_GETMESSAGETYPE_OFFSET UNITYSDK_OFFSET(0x157EE990)
#define RPG_CUSTOMRP_DEBUGSHADERVIPMATERIALTESTMSG_READ_OFFSET UNITYSDK_OFFSET(0x157EEA80)
#define RPG_CUSTOMRP_DEBUGSHADERVIPMATERIALTESTMSG_RESET_OFFSET UNITYSDK_OFFSET(0x157EEB00)
#define RPG_CUSTOMRP_DEBUGSHADERVIPMATERIALTESTMSG_WRITE_OFFSET UNITYSDK_OFFSET(0x157EE9D0)
#define RPG_CUSTOMRP_DEBUGSHADERVIPMATERIALTESTMSG__CTOR_OFFSET UNITYSDK_OFFSET(0x157EEB20)
...
namespace RPG::CustomRP
{
	...
	public:
		...
		::System::String* materialName; // 0x18
