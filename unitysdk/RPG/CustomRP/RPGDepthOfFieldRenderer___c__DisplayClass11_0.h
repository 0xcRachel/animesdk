...
#define RPG_CUSTOMRP_RPGDEPTHOFFIELDRENDERER___C__DISPLAYCLASS11_0__CTOR_OFFSET UNITYSDK_OFFSET(0x163BBC30)
#define RPG_CUSTOMRP_RPGDEPTHOFFIELDRENDERER___C__DISPLAYCLASS11_0__SETUPDOFBOKEHPOLYGON_B__0_OFFSET UNITYSDK_OFFSET(0x163BBEA0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int RPGDepthOfFieldRenderer___c__DisplayClass11_0_TypeDefinitionIndex = 28539;

	class RPGDepthOfFieldRenderer___c__DisplayClass11_0 : public ::System::Object
	{
	public:
		::RPG::CustomRP::RPGDepthOfField* settings; // 0x10
		::System::Single textureTapCount; // 0x18
