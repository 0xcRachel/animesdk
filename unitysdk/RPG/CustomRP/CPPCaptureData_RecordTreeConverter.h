...
#define RPG_CUSTOMRP_CPPCAPTUREDATA_RECORDTREECONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x16365830)
#define RPG_CUSTOMRP_CPPCAPTUREDATA_RECORDTREECONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x16365870)
#define RPG_CUSTOMRP_CPPCAPTUREDATA_RECORDTREECONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x163658E0)
#define RPG_CUSTOMRP_CPPCAPTUREDATA_RECORDTREECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x16365C40)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int CPPCaptureData_RecordTreeConverter_TypeDefinitionIndex = 28367;
