...
#define RPG_CUSTOMRP_CUSTOMPOSTPROCESSPASS2_CLEANUP_OFFSET UNITYSDK_OFFSET(0x1636B440)
#define RPG_CUSTOMRP_CUSTOMPOSTPROCESSPASS2_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x16373F60)
#define RPG_CUSTOMRP_CUSTOMPOSTPROCESSPASS2_INNEREXECUTE_OFFSET UNITYSDK_OFFSET(0x16373520)
#define RPG_CUSTOMRP_CUSTOMPOSTPROCESSPASS2_ONCHANGEENV_OFFSET UNITYSDK_OFFSET(0x1636BDC0)
#define RPG_CUSTOMRP_CUSTOMPOSTPROCESSPASS2_UPDATE_OFFSET UNITYSDK_OFFSET(0x163733C0)
#define RPG_CUSTOMRP_CUSTOMPOSTPROCESSPASS2__CTOR_OFFSET UNITYSDK_OFFSET(0x16366DD0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int CustomPostProcessPass2_TypeDefinitionIndex = 28510;

	class CustomPostProcessPass2 : public ::System::Object
	{
	public:
		// static const ::System::String* _Tag; // 0x0
		::UnityEngine::MaterialPropertyBlock* _UberProperty; // 0x10
		::RPG::CustomRP::RPGLensFlareRenderer* _LensFlareRenderer; // 0x18
		::System::Collections::Generic::List_1<::RPG::CustomRP::CRPPostprocessSubPass2*>* _PassListC; // 0x20
		::System::Collections::Generic::List_1<::RPG::CustomRP::CRPPostprocessSubPass2*>* _PassListA; // 0x28
		::RPG::CustomRP::RPGPPPatternRenderer* _PPPatternRender; // 0x30
		::RPG::CustomRP::RPGRadialBlurRenderer* _RadialBlurRenderer; // 0x38
		::RPG::CustomRP::RPGGaussianBlurRenderer* _GaussianBlurRenderer; // 0x40
		::RPG::CustomRP::MaterialLibrary* _MaterialLib; // 0x48
		::RPG::CustomRP::CustomPostProcessSettings* _Settings; // 0x50
		::RPG::CustomRP::RPGFinalCompose* _FinalCompose; // 0x58
		::RPG::CustomRP::RPGLensGlitch2Renderer* _PPLensGlitch2Renderer; // 0x60
		::RPG::CustomRP::RPGSkillRadialBlurRenderer* _SkillRadialBlurRenderer; // 0x68
		::System::Collections::Generic::List_1<::RPG::CustomRP::CRPPostprocessSubPass2*>* _PassListB; // 0x70
		::RPG::CustomRP::RPGLensGlitchRenderer* _PPLensGlitchRenderer; // 0x78
		::UnityEngine::Rendering::VolumeStack* _StackRef; // 0x80
		::RPG::CustomRP::MotionBlurRenderer* _MotionBlurRenderer; // 0x88
		::RPG::CustomRP::RPGBloomRenderer* _BloomRenderer; // 0x90
