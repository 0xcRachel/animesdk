...
#define RPG_CUSTOMRP_SHADOWSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x163E1270)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int ShadowSettings_TypeDefinitionIndex = 28316;
