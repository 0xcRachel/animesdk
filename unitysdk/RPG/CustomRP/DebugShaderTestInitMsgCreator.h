...
#define RPG_CUSTOMRP_DEBUGSHADERTESTINITMSGCREATOR_ONMSG_OFFSET UNITYSDK_OFFSET(0x157ED410)
#define RPG_CUSTOMRP_DEBUGSHADERTESTINITMSGCREATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x157EDB00)
#define RPG_CUSTOMRP_DEBUGSHADERTESTINITMSGCREATOR__FINDTYPE_OFFSET UNITYSDK_OFFSET(0x157ED990)
#define RPG_CUSTOMRP_DEBUGSHADERTESTINITMSGCREATOR__GETSHADERTESTCASEINSTANCE_OFFSET UNITYSDK_OFFSET(0x157ED770)
#define RPG_CUSTOMRP_DEBUGSHADERTESTINITMSGCREATOR__INVOKEINSTANCEMETHOD_OFFSET UNITYSDK_OFFSET(0x157ED8A0)
