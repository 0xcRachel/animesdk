...
#define RPG_MRECT_EQUALS_OFFSET UNITYSDK_OFFSET(0x20FEB30)
#define RPG_MRECT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x20FEAB0)
#define RPG_MRECT_GET_BOTTOM_OFFSET UNITYSDK_OFFSET(0x20FECA0)
#define RPG_MRECT_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x20FE690)
#define RPG_MRECT_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0xCCB0)
#define RPG_MRECT_GET_LEFT_OFFSET UNITYSDK_OFFSET(0xCC50)
#define RPG_MRECT_GET_MAX_OFFSET UNITYSDK_OFFSET(0x20FE700)
#define RPG_MRECT_GET_MIN_OFFSET UNITYSDK_OFFSET(0x5580)
#define RPG_MRECT_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x5580)
#define RPG_MRECT_GET_RIGHT_OFFSET UNITYSDK_OFFSET(0x20D0F40)
...
#define RPG_MRECT_GET_XMAX_OFFSET UNITYSDK_OFFSET(0x20FE790)
#define RPG_MRECT_GET_XMIN_OFFSET UNITYSDK_OFFSET(0xCC50)
#define RPG_MRECT_GET_X_OFFSET UNITYSDK_OFFSET(0xCC50)
#define RPG_MRECT_GET_YMAX_OFFSET UNITYSDK_OFFSET(0x20FE7B0)
#define RPG_MRECT_GET_YMIN_OFFSET UNITYSDK_OFFSET(0xCC70)
#define RPG_MRECT_GET_Y_OFFSET UNITYSDK_OFFSET(0xCC70)
#define RPG_MRECT_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x17A78FE0)
#define RPG_MRECT_METHOD_2_049CD1907283FB4E_OFFSET UNITYSDK_OFFSET(0x17A793B0)
#define RPG_MRECT_METHOD_2_1B9EA960A9DB41B1_OFFSET UNITYSDK_OFFSET(0x17A78FF0)
#define RPG_MRECT_METHOD_2_263BE4375B628391_OFFSET UNITYSDK_OFFSET(0x20FEC90)
#define RPG_MRECT_METHOD_2_4022C2F79758BB77_OFFSET UNITYSDK_OFFSET(0x20FE810)
#define RPG_MRECT_METHOD_2_5B0203A4BE86EC04_OFFSET UNITYSDK_OFFSET(0x20FE7D0)
#define RPG_MRECT_METHOD_2_722BF5E0036337D0_1_OFFSET UNITYSDK_OFFSET(0x17A79680)
#define RPG_MRECT_METHOD_2_722BF5E0036337D0_OFFSET UNITYSDK_OFFSET(0x17A79640)
#define RPG_MRECT_METHOD_2_8264E922558C7063_OFFSET UNITYSDK_OFFSET(0x20FE850)
#define RPG_MRECT_METHOD_2_90D402E1D634495E_OFFSET UNITYSDK_OFFSET(0x17A795A0)
#define RPG_MRECT_METHOD_2_9D50E61CF9674A13_OFFSET UNITYSDK_OFFSET(0x17A79510)
#define RPG_MRECT_METHOD_2_A574C24F2647CF85_OFFSET UNITYSDK_OFFSET(0x20FE910)
#define RPG_MRECT_METHOD_2_CFB00F7EDF0A1A72_OFFSET UNITYSDK_OFFSET(0x20FE960)
#define RPG_MRECT_METHOD_2_D375F1894550A459_OFFSET UNITYSDK_OFFSET(0x24C40)
#define RPG_MRECT_SET_CENTER_OFFSET UNITYSDK_OFFSET(0x20FE6C0)
#define RPG_MRECT_SET_HEIGHT_OFFSET UNITYSDK_OFFSET(0xCCC0)
#define RPG_MRECT_SET_MAX_OFFSET UNITYSDK_OFFSET(0x20FE730)
#define RPG_MRECT_SET_MIN_OFFSET UNITYSDK_OFFSET(0x20FE6E0)
...
#define RPG_MRECT_SET_XMAX_OFFSET UNITYSDK_OFFSET(0x20FE7A0)
#define RPG_MRECT_SET_XMIN_OFFSET UNITYSDK_OFFSET(0x20FE750)
#define RPG_MRECT_SET_X_OFFSET UNITYSDK_OFFSET(0xCC60)
#define RPG_MRECT_SET_YMAX_OFFSET UNITYSDK_OFFSET(0x20FE7C0)
#define RPG_MRECT_SET_YMIN_OFFSET UNITYSDK_OFFSET(0x20FE770)
#define RPG_MRECT_SET_Y_OFFSET UNITYSDK_OFFSET(0xCC80)
#define RPG_MRECT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x20FEC80)
#define RPG_MRECT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x20FE670)
#define RPG_MRECT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1534670)
