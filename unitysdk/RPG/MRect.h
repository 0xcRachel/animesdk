...
#define RPG_MRECT_EQUALS_OFFSET UNITYSDK_OFFSET(0x37410B0)
#define RPG_MRECT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3741030)
#define RPG_MRECT_GET_BOTTOM_OFFSET UNITYSDK_OFFSET(0x3741230)
#define RPG_MRECT_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x3740BF0)
#define RPG_MRECT_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0xFD35D0)
#define RPG_MRECT_GET_LEFT_OFFSET UNITYSDK_OFFSET(0x72BD60)
#define RPG_MRECT_GET_MAX_OFFSET UNITYSDK_OFFSET(0x3740C60)
#define RPG_MRECT_GET_MIN_OFFSET UNITYSDK_OFFSET(0x66AF90)
#define RPG_MRECT_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x66AF90)
#define RPG_MRECT_GET_RIGHT_OFFSET UNITYSDK_OFFSET(0x3741220)
#define RPG_MRECT_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x66B7B0)
#define RPG_MRECT_GET_TOP_OFFSET UNITYSDK_OFFSET(0x72BD70)
#define RPG_MRECT_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0xFD2FD0)
#define RPG_MRECT_GET_XMAX_OFFSET UNITYSDK_OFFSET(0x3740D10)
#define RPG_MRECT_GET_XMIN_OFFSET UNITYSDK_OFFSET(0x72BD60)
#define RPG_MRECT_GET_X_OFFSET UNITYSDK_OFFSET(0x72BD60)
#define RPG_MRECT_GET_YMAX_OFFSET UNITYSDK_OFFSET(0x3740D30)
#define RPG_MRECT_GET_YMIN_OFFSET UNITYSDK_OFFSET(0x72BD70)
#define RPG_MRECT_GET_Y_OFFSET UNITYSDK_OFFSET(0x72BD70)
#define RPG_MRECT_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x12EAD270)
#define RPG_MRECT_METHOD_2_049CD1907283FB4E_OFFSET UNITYSDK_OFFSET(0x12EAD620)
#define RPG_MRECT_METHOD_2_1B9EA960A9DB41B1_OFFSET UNITYSDK_OFFSET(0x12EAD280)
#define RPG_MRECT_METHOD_2_4022C2F79758BB77_OFFSET UNITYSDK_OFFSET(0x3740D90)
#define RPG_MRECT_METHOD_2_5B0203A4BE86EC04_OFFSET UNITYSDK_OFFSET(0x3740D50)
#define RPG_MRECT_METHOD_2_722BF5E0036337D0_1_OFFSET UNITYSDK_OFFSET(0x12EAD8F0)
#define RPG_MRECT_METHOD_2_722BF5E0036337D0_OFFSET UNITYSDK_OFFSET(0x12EAD8B0)
#define RPG_MRECT_METHOD_2_8264E922558C7063_OFFSET UNITYSDK_OFFSET(0x3740DD0)
#define RPG_MRECT_METHOD_2_90D402E1D634495E_OFFSET UNITYSDK_OFFSET(0x12EAD810)
#define RPG_MRECT_METHOD_2_9D50E61CF9674A13_OFFSET UNITYSDK_OFFSET(0x12EAD780)
#define RPG_MRECT_METHOD_2_A574C24F2647CF85_OFFSET UNITYSDK_OFFSET(0x3740E90)
#define RPG_MRECT_METHOD_2_C8AF816F85BE923A_OFFSET UNITYSDK_OFFSET(0x3741210)
#define RPG_MRECT_METHOD_2_CFB00F7EDF0A1A72_OFFSET UNITYSDK_OFFSET(0x3740EE0)
#define RPG_MRECT_METHOD_2_D375F1894550A459_OFFSET UNITYSDK_OFFSET(0x3740880)
#define RPG_MRECT_SET_CENTER_OFFSET UNITYSDK_OFFSET(0x3740C20)
#define RPG_MRECT_SET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x3740CC0)
#define RPG_MRECT_SET_MAX_OFFSET UNITYSDK_OFFSET(0x3740C90)
#define RPG_MRECT_SET_MIN_OFFSET UNITYSDK_OFFSET(0x3740C40)
#define RPG_MRECT_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x66AF20)
#define RPG_MRECT_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x8BE040)
#define RPG_MRECT_SET_WIDTH_OFFSET UNITYSDK_OFFSET(0x3740CB0)
#define RPG_MRECT_SET_XMAX_OFFSET UNITYSDK_OFFSET(0x3740D20)
#define RPG_MRECT_SET_XMIN_OFFSET UNITYSDK_OFFSET(0x3740CD0)
#define RPG_MRECT_SET_X_OFFSET UNITYSDK_OFFSET(0x366BF30)
#define RPG_MRECT_SET_YMAX_OFFSET UNITYSDK_OFFSET(0x3740D40)
#define RPG_MRECT_SET_YMIN_OFFSET UNITYSDK_OFFSET(0x3740CF0)
#define RPG_MRECT_SET_Y_OFFSET UNITYSDK_OFFSET(0x3740BE0)
#define RPG_MRECT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3741200)
#define RPG_MRECT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3740BC0)
#define RPG_MRECT__CTOR_2_OFFSET UNITYSDK_OFFSET(0xB1EAF0)
#define RPG_MRECT__CTOR_OFFSET UNITYSDK_OFFSET(0x3740880)
