...
#define RPG_MRECT_EQUALS_OFFSET UNITYSDK_OFFSET(0x2257670)
#define RPG_MRECT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x22575F0)
#define RPG_MRECT_GET_BOTTOM_OFFSET UNITYSDK_OFFSET(0x22577F0)
#define RPG_MRECT_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x22571C0)
#define RPG_MRECT_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x879EE0)
#define RPG_MRECT_GET_LEFT_OFFSET UNITYSDK_OFFSET(0x608BC0)
#define RPG_MRECT_GET_MAX_OFFSET UNITYSDK_OFFSET(0x2257230)
#define RPG_MRECT_GET_MIN_OFFSET UNITYSDK_OFFSET(0x5078B0)
#define RPG_MRECT_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x5078B0)
#define RPG_MRECT_GET_RIGHT_OFFSET UNITYSDK_OFFSET(0x22577E0)
#define RPG_MRECT_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x608BA0)
#define RPG_MRECT_GET_TOP_OFFSET UNITYSDK_OFFSET(0x608BD0)
#define RPG_MRECT_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0x8798B0)
#define RPG_MRECT_GET_XMAX_OFFSET UNITYSDK_OFFSET(0x22572D0)
#define RPG_MRECT_GET_XMIN_OFFSET UNITYSDK_OFFSET(0x608BC0)
#define RPG_MRECT_GET_X_OFFSET UNITYSDK_OFFSET(0x608BC0)
#define RPG_MRECT_GET_YMAX_OFFSET UNITYSDK_OFFSET(0x22572F0)
#define RPG_MRECT_GET_YMIN_OFFSET UNITYSDK_OFFSET(0x608BD0)
#define RPG_MRECT_GET_Y_OFFSET UNITYSDK_OFFSET(0x608BD0)
#define RPG_MRECT_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x15DCAE80)
#define RPG_MRECT_METHOD_2_049CD1907283FB4E_OFFSET UNITYSDK_OFFSET(0x15DCB250)
#define RPG_MRECT_METHOD_2_1B9EA960A9DB41B1_OFFSET UNITYSDK_OFFSET(0x15DCAE90)
#define RPG_MRECT_METHOD_2_263BE4375B628391_OFFSET UNITYSDK_OFFSET(0x22577D0)
#define RPG_MRECT_METHOD_2_4022C2F79758BB77_OFFSET UNITYSDK_OFFSET(0x2257350)
#define RPG_MRECT_METHOD_2_5B0203A4BE86EC04_OFFSET UNITYSDK_OFFSET(0x2257310)
#define RPG_MRECT_METHOD_2_722BF5E0036337D0_1_OFFSET UNITYSDK_OFFSET(0x15DCB520)
#define RPG_MRECT_METHOD_2_722BF5E0036337D0_OFFSET UNITYSDK_OFFSET(0x15DCB4E0)
#define RPG_MRECT_METHOD_2_8264E922558C7063_OFFSET UNITYSDK_OFFSET(0x2257390)
#define RPG_MRECT_METHOD_2_90D402E1D634495E_OFFSET UNITYSDK_OFFSET(0x15DCB440)
#define RPG_MRECT_METHOD_2_9D50E61CF9674A13_OFFSET UNITYSDK_OFFSET(0x15DCB3B0)
#define RPG_MRECT_METHOD_2_A574C24F2647CF85_OFFSET UNITYSDK_OFFSET(0x2257450)
#define RPG_MRECT_METHOD_2_CFB00F7EDF0A1A72_OFFSET UNITYSDK_OFFSET(0x22574A0)
#define RPG_MRECT_METHOD_2_D375F1894550A459_OFFSET UNITYSDK_OFFSET(0x1FEFEB0)
#define RPG_MRECT_SET_CENTER_OFFSET UNITYSDK_OFFSET(0x22571F0)
#define RPG_MRECT_SET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x1DBC1D0)
#define RPG_MRECT_SET_MAX_OFFSET UNITYSDK_OFFSET(0x2257260)
#define RPG_MRECT_SET_MIN_OFFSET UNITYSDK_OFFSET(0x2257210)
#define RPG_MRECT_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x6163B0)
#define RPG_MRECT_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x6163C0)
#define RPG_MRECT_SET_WIDTH_OFFSET UNITYSDK_OFFSET(0x2257280)
#define RPG_MRECT_SET_XMAX_OFFSET UNITYSDK_OFFSET(0x22572E0)
#define RPG_MRECT_SET_XMIN_OFFSET UNITYSDK_OFFSET(0x2257290)
#define RPG_MRECT_SET_X_OFFSET UNITYSDK_OFFSET(0x65A390)
#define RPG_MRECT_SET_YMAX_OFFSET UNITYSDK_OFFSET(0x2257300)
#define RPG_MRECT_SET_YMIN_OFFSET UNITYSDK_OFFSET(0x22572B0)
#define RPG_MRECT_SET_Y_OFFSET UNITYSDK_OFFSET(0x22571B0)
#define RPG_MRECT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x22577C0)
#define RPG_MRECT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x2257190)
#define RPG_MRECT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x63F9C0)
#define RPG_MRECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1FEFEB0)
