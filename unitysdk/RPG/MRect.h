...
#define RPG_MRECT_EQUALS_OFFSET UNITYSDK_OFFSET(0x2028760)
#define RPG_MRECT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x20286E0)
#define RPG_MRECT_GET_BOTTOM_OFFSET UNITYSDK_OFFSET(0x20288D0)
#define RPG_MRECT_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x20282C0)
#define RPG_MRECT_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0xCCB0)
#define RPG_MRECT_GET_LEFT_OFFSET UNITYSDK_OFFSET(0xCC50)
#define RPG_MRECT_GET_MAX_OFFSET UNITYSDK_OFFSET(0x2028330)
#define RPG_MRECT_GET_MIN_OFFSET UNITYSDK_OFFSET(0x5580)
#define RPG_MRECT_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x5580)
#define RPG_MRECT_GET_RIGHT_OFFSET UNITYSDK_OFFSET(0x1FFB540)
...
#define RPG_MRECT_GET_XMAX_OFFSET UNITYSDK_OFFSET(0x20283C0)
#define RPG_MRECT_GET_XMIN_OFFSET UNITYSDK_OFFSET(0xCC50)
#define RPG_MRECT_GET_X_OFFSET UNITYSDK_OFFSET(0xCC50)
#define RPG_MRECT_GET_YMAX_OFFSET UNITYSDK_OFFSET(0x20283E0)
#define RPG_MRECT_GET_YMIN_OFFSET UNITYSDK_OFFSET(0xCC70)
#define RPG_MRECT_GET_Y_OFFSET UNITYSDK_OFFSET(0xCC70)
#define RPG_MRECT_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x172BCE20)
#define RPG_MRECT_METHOD_2_049CD1907283FB4E_OFFSET UNITYSDK_OFFSET(0x172BD1F0)
#define RPG_MRECT_METHOD_2_1B9EA960A9DB41B1_OFFSET UNITYSDK_OFFSET(0x172BCE30)
#define RPG_MRECT_METHOD_2_263BE4375B628391_OFFSET UNITYSDK_OFFSET(0x20288C0)
#define RPG_MRECT_METHOD_2_4022C2F79758BB77_OFFSET UNITYSDK_OFFSET(0x2028440)
#define RPG_MRECT_METHOD_2_5B0203A4BE86EC04_OFFSET UNITYSDK_OFFSET(0x2028400)
#define RPG_MRECT_METHOD_2_722BF5E0036337D0_1_OFFSET UNITYSDK_OFFSET(0x172BD4C0)
#define RPG_MRECT_METHOD_2_722BF5E0036337D0_OFFSET UNITYSDK_OFFSET(0x172BD480)
#define RPG_MRECT_METHOD_2_8264E922558C7063_OFFSET UNITYSDK_OFFSET(0x2028480)
#define RPG_MRECT_METHOD_2_90D402E1D634495E_OFFSET UNITYSDK_OFFSET(0x172BD3E0)
#define RPG_MRECT_METHOD_2_9D50E61CF9674A13_OFFSET UNITYSDK_OFFSET(0x172BD350)
#define RPG_MRECT_METHOD_2_A574C24F2647CF85_OFFSET UNITYSDK_OFFSET(0x2028540)
#define RPG_MRECT_METHOD_2_CFB00F7EDF0A1A72_OFFSET UNITYSDK_OFFSET(0x2028590)
#define RPG_MRECT_METHOD_2_D375F1894550A459_OFFSET UNITYSDK_OFFSET(0x24C90)
#define RPG_MRECT_SET_CENTER_OFFSET UNITYSDK_OFFSET(0x20282F0)
#define RPG_MRECT_SET_HEIGHT_OFFSET UNITYSDK_OFFSET(0xCCC0)
#define RPG_MRECT_SET_MAX_OFFSET UNITYSDK_OFFSET(0x2028360)
#define RPG_MRECT_SET_MIN_OFFSET UNITYSDK_OFFSET(0x2028310)
...
#define RPG_MRECT_SET_XMAX_OFFSET UNITYSDK_OFFSET(0x20283D0)
#define RPG_MRECT_SET_XMIN_OFFSET UNITYSDK_OFFSET(0x2028380)
#define RPG_MRECT_SET_X_OFFSET UNITYSDK_OFFSET(0xCC60)
#define RPG_MRECT_SET_YMAX_OFFSET UNITYSDK_OFFSET(0x20283F0)
#define RPG_MRECT_SET_YMIN_OFFSET UNITYSDK_OFFSET(0x20283A0)
#define RPG_MRECT_SET_Y_OFFSET UNITYSDK_OFFSET(0xCC80)
#define RPG_MRECT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x20288B0)
#define RPG_MRECT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x20282A0)
#define RPG_MRECT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x14A6D00)
#define RPG_MRECT__CTOR_OFFSET UNITYSDK_OFFSET(0x24C90)

namespace RPG
{
	inline static constexpr unsigned int MRect_TypeDefinitionIndex = 8576;
