...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPMAPS_INIT_OFFSET UNITYSDK_OFFSET(0x97E3850)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPMAPS_UNINIT_OFFSET UNITYSDK_OFFSET(0x97E38F0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPMAPS_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x97E3990)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPMAPS__CTOR_OFFSET UNITYSDK_OFFSET(0x97E3D50)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPMAPS___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x97E3D70)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPMAPS___IFIXBASEPROXY_UNINIT_OFFSET UNITYSDK_OFFSET(0x97E3D80)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropMaps_TypeDefinitionIndex = 55682;
