...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPMAPS_INIT_OFFSET UNITYSDK_OFFSET(0x9CC5280)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPMAPS_UNINIT_OFFSET UNITYSDK_OFFSET(0x9CC5320)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPMAPS_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x9CC53C0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPMAPS__CTOR_OFFSET UNITYSDK_OFFSET(0x9CC5780)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPMAPS___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x9CC57A0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPMAPS___IFIXBASEPROXY_UNINIT_OFFSET UNITYSDK_OFFSET(0x9CC57B0)
