...
#define RPG_CLIENT_CRPVOLUMETRICFOGSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x8E14F40)

namespace RPG::Client
{
	inline static constexpr unsigned int CRPVolumetricFogSettings_TypeDefinitionIndex = 53881;
