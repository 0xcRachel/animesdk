...
#define RPG_CLIENT_UIPOLYGON_VERTEXATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0xD4AA0)

namespace RPG::Client
{
	inline static constexpr unsigned int UIPolygon_VertexAttribute_TypeDefinitionIndex = 57956;
