...
#define RPG_CLIENT_UIQUAD_VERTEXATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x22459F0)

namespace RPG::Client
{
	inline static constexpr unsigned int UIQuad_VertexAttribute_TypeDefinitionIndex = 66981;
