...
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_GET_IFINSTANCENEEDREFRESH_OFFSET UNITYSDK_OFFSET(0x8FFD020)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_GET_IFUSESIMULATE_OFFSET UNITYSDK_OFFSET(0x8FFCF90)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0x8FFCFE0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_LATETICK_OFFSET UNITYSDK_OFFSET(0x9000240)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_0076C796B2045359_OFFSET UNITYSDK_OFFSET(0x8FFD150)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_00BC1D03A9F4D997_OFFSET UNITYSDK_OFFSET(0x9003D30)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_0F2138E056F9294A_OFFSET UNITYSDK_OFFSET(0x9000150)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_14F193ED8E6A3459_OFFSET UNITYSDK_OFFSET(0x9003B00)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x8FFD2E0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_18982EFD3B740683_OFFSET UNITYSDK_OFFSET(0x8FFD820)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_19578FF14D5CC81B_OFFSET UNITYSDK_OFFSET(0x9003870)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x9000110)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_401F06ADB0C71DD8_OFFSET UNITYSDK_OFFSET(0x9000B40)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x9000050)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0x90000B0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x8FFFE90)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_4857357D5C1BFCE8_OFFSET UNITYSDK_OFFSET(0x8FFD920)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0x90045C0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_5790A55946AA509D_2_OFFSET UNITYSDK_OFFSET(0x9004620)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_5790A55946AA509D_3_OFFSET UNITYSDK_OFFSET(0x9004680)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_5790A55946AA509D_4_OFFSET UNITYSDK_OFFSET(0x90046E0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_5790A55946AA509D_5_OFFSET UNITYSDK_OFFSET(0x9004740)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_5790A55946AA509D_6_OFFSET UNITYSDK_OFFSET(0x9004810)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x9004560)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_81FEFD1B22CE37A2_OFFSET UNITYSDK_OFFSET(0x9002550)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_A2729CBF245B8253_OFFSET UNITYSDK_OFFSET(0x9003690)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_B1EA412ACAE87C15_OFFSET UNITYSDK_OFFSET(0x8FFD3D0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_B5431FFED5A8CE32_OFFSET UNITYSDK_OFFSET(0x9002F60)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_D7852DE078ACC1F1_OFFSET UNITYSDK_OFFSET(0x8FFFEF0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_DBA8CB09BF007EAD_OFFSET UNITYSDK_OFFSET(0x9003CA0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_E322D311AC7C7EE8_OFFSET UNITYSDK_OFFSET(0x9004360)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_F0E307B84478A272_OFFSET UNITYSDK_OFFSET(0x90047A0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_F49136C3D3312CEA_OFFSET UNITYSDK_OFFSET(0x9003710)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_F4DD08A31BA3F883_OFFSET UNITYSDK_OFFSET(0x8FFD040)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_SET_IFINSTANCENEEDREFRESH_OFFSET UNITYSDK_OFFSET(0x8FFD030)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x9004530)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x9004520)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR___IFIXBASEPROXY_LATETICK_OFFSET UNITYSDK_OFFSET(0x9004870)

namespace RPG::Client
{
	inline static constexpr unsigned int DialogEmitterBehavior_TypeDefinitionIndex = 56488;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DialogEmitterBehavior_TypeDefinitionIndex)->GetStaticField(0xFBB0);
		}
		static ::System::Int32* StaticGet__MainTexID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DialogEmitterBehavior_TypeDefinitionIndex)->GetStaticField(0xFBB4);
		}
		...
		::System::Collections::Generic::List_1<::RPG::Client::DialogEmitterBehavior_Struct_2_7B5711D3A8C81549>* _SimulateAgents; // 0x38
		::System::Single _Timer; // 0x40
		::System::Int32 _CurrentIndex; // 0x44
		::System::Single _CurrentInterval; // 0x48
		::Il2CppArray<::System::Single>* _HorizionDistanceBuffer; // 0x50
		::System::Int32 _StaticEmojiCounter; // 0x58
		::System::Int32 _TextCounter; // 0x5C
		::System::Int32 _BackboardCounter; // 0x60
		::UnityEngine::MaterialPropertyBlock* _StaticEmojiMPB; // 0x68
		::UnityEngine::MaterialPropertyBlock* _TextMPB; // 0x70
		::UnityEngine::MaterialPropertyBlock* _BackboardMPB; // 0x78
		::Il2CppArray<::UnityEngine::Matrix4x4>* _StaticEmojiMatrixList; // 0x80
		::Il2CppArray<::UnityEngine::Matrix4x4>* _TextMatrixList; // 0x88
		::Il2CppArray<::UnityEngine::Matrix4x4>* _BackboardMatrixList; // 0x90
		::Il2CppArray<::UnityEngine::Vector4>* _StaticEmojiCustomDatas; // 0x98
		::Il2CppArray<::UnityEngine::Vector4>* _TextCustomDatas; // 0xA0
		::Il2CppArray<::UnityEngine::Vector4>* _BackboardCustomDatas; // 0xA8
		::TMPro::TMP_FontAsset* _FontAsset; // 0xB0
		::System::Boolean _IfInstanceNeedRefresh_k__BackingField; // 0xB8
		::UnityEngine::Bounds _PatternBounds; // 0xBC
