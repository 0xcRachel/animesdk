...
#define RPG_CLIENT_GRIDFIGHTBONUSCONSUMABLEITEMDATA_CREATEFROMSERVER_OFFSET UNITYSDK_OFFSET(0x932FEA0)
#define RPG_CLIENT_GRIDFIGHTBONUSCONSUMABLEITEMDATA_GET_CONSUMABLECONFIG_OFFSET UNITYSDK_OFFSET(0x93301E0)
#define RPG_CLIENT_GRIDFIGHTBONUSCONSUMABLEITEMDATA_GET_ITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x93301A0)
#define RPG_CLIENT_GRIDFIGHTBONUSCONSUMABLEITEMDATA_GET_ITEMID_OFFSET UNITYSDK_OFFSET(0x9330180)
#define RPG_CLIENT_GRIDFIGHTBONUSCONSUMABLEITEMDATA_GET_ITEMPREVIOUSCOUNT_OFFSET UNITYSDK_OFFSET(0x93301C0)
#define RPG_CLIENT_GRIDFIGHTBONUSCONSUMABLEITEMDATA_GET_ORDER_OFFSET UNITYSDK_OFFSET(0x9330160)
#define RPG_CLIENT_GRIDFIGHTBONUSCONSUMABLEITEMDATA_SETORDER_OFFSET UNITYSDK_OFFSET(0x93300C0)
#define RPG_CLIENT_GRIDFIGHTBONUSCONSUMABLEITEMDATA_SETPREVIOUSCOUNT_OFFSET UNITYSDK_OFFSET(0x9330110)
#define RPG_CLIENT_GRIDFIGHTBONUSCONSUMABLEITEMDATA_SET_CONSUMABLECONFIG_OFFSET UNITYSDK_OFFSET(0x93301F0)
#define RPG_CLIENT_GRIDFIGHTBONUSCONSUMABLEITEMDATA_SET_ITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x93301B0)
#define RPG_CLIENT_GRIDFIGHTBONUSCONSUMABLEITEMDATA_SET_ITEMID_OFFSET UNITYSDK_OFFSET(0x9330190)
#define RPG_CLIENT_GRIDFIGHTBONUSCONSUMABLEITEMDATA_SET_ITEMPREVIOUSCOUNT_OFFSET UNITYSDK_OFFSET(0x93301D0)
#define RPG_CLIENT_GRIDFIGHTBONUSCONSUMABLEITEMDATA_SET_ORDER_OFFSET UNITYSDK_OFFSET(0x9330170)
#define RPG_CLIENT_GRIDFIGHTBONUSCONSUMABLEITEMDATA_SYNC_OFFSET UNITYSDK_OFFSET(0x9330060)
#define RPG_CLIENT_GRIDFIGHTBONUSCONSUMABLEITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x932FFF0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightBonusConsumableItemData_TypeDefinitionIndex = 51189;
	...
	public:
		...
		static ::RPG::Client::GridFightBonusConsumableItemData* CreateFromServer(::Class_1_120319518E6F6581_40* consumable)
		{
			return ((::RPG::Client::GridFightBonusConsumableItemData*(*)(::Class_1_120319518E6F6581_40*))((::PBYTE)hIl2Cpp + RPG_CLIENT_GRIDFIGHTBONUSCONSUMABLEITEMDATA_CREATEFROMSERVER_OFFSET))(consumable);
		}

		::System::Void Sync(::Class_1_120319518E6F6581_40* consumable)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_120319518E6F6581_40*))((::PBYTE)hIl2Cpp + RPG_CLIENT_GRIDFIGHTBONUSCONSUMABLEITEMDATA_SYNC_OFFSET))(this, consumable);
		}
