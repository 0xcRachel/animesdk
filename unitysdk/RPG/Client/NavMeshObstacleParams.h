...
#define RPG_CLIENT_NAVMESHOBSTACLEPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x999FB90)

namespace RPG::Client
{
	inline static constexpr unsigned int NavMeshObstacleParams_TypeDefinitionIndex = 54498;
