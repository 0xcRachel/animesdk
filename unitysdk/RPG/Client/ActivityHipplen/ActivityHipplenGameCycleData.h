...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_CHECKTRAITISINCURTRAITLIST_OFFSET UNITYSDK_OFFSET(0x8F26410)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8F25BA0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GETSORTEDTRAITLIST_OFFSET UNITYSDK_OFFSET(0x8F26260)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GET_CYCLEGAMETIMES_OFFSET UNITYSDK_OFFSET(0x8F26610)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GET_HIPPLENBODYSIZE_OFFSET UNITYSDK_OFFSET(0x8F26660)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GET_PHASENAME_OFFSET UNITYSDK_OFFSET(0x8F26630)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GET_PHASEROW_OFFSET UNITYSDK_OFFSET(0x8F26590)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GET_PHASETRIALTARGETTEXT_OFFSET UNITYSDK_OFFSET(0x8F26680)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GET_PHASETYPE_OFFSET UNITYSDK_OFFSET(0x8F26570)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GET_SPEEDRATIOMULTIPLIER_OFFSET UNITYSDK_OFFSET(0x8F266B0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GET_STATUSDATA_OFFSET UNITYSDK_OFFSET(0x8F265B0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GET_TOTALACTIONPOINTS_OFFSET UNITYSDK_OFFSET(0x8F26710)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GET_TRAILLEFTDAYS_OFFSET UNITYSDK_OFFSET(0x8F265F0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GET_TRAITLIST_OFFSET UNITYSDK_OFFSET(0x8F265D0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_INIT_OFFSET UNITYSDK_OFFSET(0x8F25A80)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_REFRESHDATABYSETTLERSP_OFFSET UNITYSDK_OFFSET(0x8F261A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_REFRESHDATA_OFFSET UNITYSDK_OFFSET(0x8F25C60)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_SET_CYCLEGAMETIMES_OFFSET UNITYSDK_OFFSET(0x8F26620)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_SET_PHASEROW_OFFSET UNITYSDK_OFFSET(0x8F265A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_SET_PHASETYPE_OFFSET UNITYSDK_OFFSET(0x8F26580)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_SET_STATUSDATA_OFFSET UNITYSDK_OFFSET(0x8F265C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_SET_TRAILLEFTDAYS_OFFSET UNITYSDK_OFFSET(0x8F26600)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_SET_TRAITLIST_OFFSET UNITYSDK_OFFSET(0x8F265E0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8F26730)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenGameCycleData_TypeDefinitionIndex = 61651;
