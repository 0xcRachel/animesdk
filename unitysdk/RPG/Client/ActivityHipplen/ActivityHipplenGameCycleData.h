...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_CHECKTRAITISINCURTRAITLIST_OFFSET UNITYSDK_OFFSET(0x171EC7F0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x171EBF80)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GETSORTEDTRAITLIST_OFFSET UNITYSDK_OFFSET(0x171EC640)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GET_CYCLEGAMETIMES_OFFSET UNITYSDK_OFFSET(0x171EC9F0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GET_HIPPLENBODYSIZE_OFFSET UNITYSDK_OFFSET(0x171ECA40)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GET_PHASENAME_OFFSET UNITYSDK_OFFSET(0x171ECA10)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GET_PHASEROW_OFFSET UNITYSDK_OFFSET(0x171EC970)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GET_PHASETRIALTARGETTEXT_OFFSET UNITYSDK_OFFSET(0x171ECA60)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GET_PHASETYPE_OFFSET UNITYSDK_OFFSET(0x171EC950)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GET_SPEEDRATIOMULTIPLIER_OFFSET UNITYSDK_OFFSET(0x171ECA90)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GET_STATUSDATA_OFFSET UNITYSDK_OFFSET(0x171EC990)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GET_TOTALACTIONPOINTS_OFFSET UNITYSDK_OFFSET(0x171ECAF0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GET_TRAILLEFTDAYS_OFFSET UNITYSDK_OFFSET(0x171EC9D0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GET_TRAITLIST_OFFSET UNITYSDK_OFFSET(0x171EC9B0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_INIT_OFFSET UNITYSDK_OFFSET(0x171EBE60)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_REFRESHDATABYSETTLERSP_OFFSET UNITYSDK_OFFSET(0x171EC580)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_REFRESHDATA_OFFSET UNITYSDK_OFFSET(0x171EC040)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_SET_CYCLEGAMETIMES_OFFSET UNITYSDK_OFFSET(0x171ECA00)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_SET_PHASEROW_OFFSET UNITYSDK_OFFSET(0x171EC980)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_SET_PHASETYPE_OFFSET UNITYSDK_OFFSET(0x171EC960)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_SET_STATUSDATA_OFFSET UNITYSDK_OFFSET(0x171EC9A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_SET_TRAILLEFTDAYS_OFFSET UNITYSDK_OFFSET(0x171EC9E0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_SET_TRAITLIST_OFFSET UNITYSDK_OFFSET(0x171EC9C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x171ECB10)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenGameCycleData_TypeDefinitionIndex = 69561;
