...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_CHECKTRAITISINCURTRAITLIST_OFFSET UNITYSDK_OFFSET(0x8B25300)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8B24A90)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GETSORTEDTRAITLIST_OFFSET UNITYSDK_OFFSET(0x8B25150)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GET_CYCLEGAMETIMES_OFFSET UNITYSDK_OFFSET(0x8B25500)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GET_HIPPLENBODYSIZE_OFFSET UNITYSDK_OFFSET(0x8B25550)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GET_PHASENAME_OFFSET UNITYSDK_OFFSET(0x8B25520)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GET_PHASEROW_OFFSET UNITYSDK_OFFSET(0x8B25480)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GET_PHASETRIALTARGETTEXT_OFFSET UNITYSDK_OFFSET(0x8B25570)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GET_PHASETYPE_OFFSET UNITYSDK_OFFSET(0x8B25460)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GET_SPEEDRATIOMULTIPLIER_OFFSET UNITYSDK_OFFSET(0x8B255A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GET_STATUSDATA_OFFSET UNITYSDK_OFFSET(0x8B254A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GET_TOTALACTIONPOINTS_OFFSET UNITYSDK_OFFSET(0x8B25600)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GET_TRAILLEFTDAYS_OFFSET UNITYSDK_OFFSET(0x8B254E0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_GET_TRAITLIST_OFFSET UNITYSDK_OFFSET(0x8B254C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_INIT_OFFSET UNITYSDK_OFFSET(0x8B24970)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_REFRESHDATABYSETTLERSP_OFFSET UNITYSDK_OFFSET(0x8B25090)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_REFRESHDATA_OFFSET UNITYSDK_OFFSET(0x8B24B50)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_SET_CYCLEGAMETIMES_OFFSET UNITYSDK_OFFSET(0x8B25510)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_SET_PHASEROW_OFFSET UNITYSDK_OFFSET(0x8B25490)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_SET_PHASETYPE_OFFSET UNITYSDK_OFFSET(0x8B25470)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_SET_STATUSDATA_OFFSET UNITYSDK_OFFSET(0x8B254B0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_SET_TRAILLEFTDAYS_OFFSET UNITYSDK_OFFSET(0x8B254F0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA_SET_TRAITLIST_OFFSET UNITYSDK_OFFSET(0x8B254D0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMECYCLEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8B25620)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenGameCycleData_TypeDefinitionIndex = 59895;
