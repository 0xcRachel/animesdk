...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_CANRESTART_OFFSET UNITYSDK_OFFSET(0x8F31360)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8F30BD0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_DOREPORT_OFFSET UNITYSDK_OFFSET(0x8F31310)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_ENABLEAUTOMODESWITCH_OFFSET UNITYSDK_OFFSET(0x8F31690)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_ENABLEAUTOMODE_OFFSET UNITYSDK_OFFSET(0x8F314D0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_GET_ISAUTOMODE_OFFSET UNITYSDK_OFFSET(0x8F329E0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_GET_ROOTANCHORNAME_OFFSET UNITYSDK_OFFSET(0x8F32A00)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_INIT_OFFSET UNITYSDK_OFFSET(0x8F30A30)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_LOADCHARACTER_OFFSET UNITYSDK_OFFSET(0x8F31730)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_ONUISCREENSIZECHANGED_OFFSET UNITYSDK_OFFSET(0x8F31D90)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_PAUSE_OFFSET UNITYSDK_OFFSET(0x8F31210)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_RESTART_OFFSET UNITYSDK_OFFSET(0x8F31290)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_RESUME_OFFSET UNITYSDK_OFFSET(0x8F31250)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_SETTLEGAME_OFFSET UNITYSDK_OFFSET(0x8F313A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_SET_ISAUTOMODE_OFFSET UNITYSDK_OFFSET(0x8F329F0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_START_OFFSET UNITYSDK_OFFSET(0x8F309E0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_TICK_OFFSET UNITYSDK_OFFSET(0x8F305D0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_TRYLOADATMOSPHERE_OFFSET UNITYSDK_OFFSET(0x8F31A70)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_TRYUNLOADATMOSPHERE_OFFSET UNITYSDK_OFFSET(0x8F31D40)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__CREATECHARACTER_OFFSET UNITYSDK_OFFSET(0x8F31790)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__CREATENPC_OFFSET UNITYSDK_OFFSET(0x8F322D0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__CREATESTATICPREFAB_OFFSET UNITYSDK_OFFSET(0x8F32510)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x8F30590)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__DESTORYALLENTITY_OFFSET UNITYSDK_OFFSET(0x8F30F30)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__DOSETAUTOMODE_OFFSET UNITYSDK_OFFSET(0x8F31590)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__ENDCURRENTLG_OFFSET UNITYSDK_OFFSET(0x8F31130)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__EXECUTETASKLIST_OFFSET UNITYSDK_OFFSET(0x8F32190)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__FIREAUTOMODEEVENT_OFFSET UNITYSDK_OFFSET(0x8F315F0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__GETGRADETYPE_OFFSET UNITYSDK_OFFSET(0x8F32040)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__GETLOCALPLAYERNPCID_OFFSET UNITYSDK_OFFSET(0x8F32710)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__LOADATMOSPHERE_OFFSET UNITYSDK_OFFSET(0x8F31AC0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__ONAUTOMODECHANGED_OFFSET UNITYSDK_OFFSET(0x8F32080)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x8F31FC0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__ONINIT_OFFSET UNITYSDK_OFFSET(0x8F31F20)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__ONSETTLE_OFFSET UNITYSDK_OFFSET(0x8F32000)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__ONSTART_OFFSET UNITYSDK_OFFSET(0x8F31EE0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__ONTICK_OFFSET UNITYSDK_OFFSET(0x8F31F60)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__SENDSETTLEPACKET_OFFSET UNITYSDK_OFFSET(0x8F30710)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__SETATMOSPHERECONFIG_OFFSET UNITYSDK_OFFSET(0x8F31E80)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__SETENTITYDITHER_OFFSET UNITYSDK_OFFSET(0x8F32880)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__STARTLG_OFFSET UNITYSDK_OFFSET(0x8F320C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__UNLOADATMOSPHERE_OFFSET UNITYSDK_OFFSET(0x8F30CD0)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenMiniGameBase_TypeDefinitionIndex = 61730;
	...
	public:
		...
		::Class_1_7E0DCA9D208905FE* _BabyHipplenRef; // 0x28
		::UnityEngine::Transform* _Root; // 0x30
		::RPG::Client::ActivityHipplen::ActivityHipplenMiniGameManager* _Manager; // 0x38
		::RPG::GameCore::HipplenGameAtmosphereConfig* _AtmosphereConfig; // 0x40
		::System::Action* _OnTaskFinished; // 0x48
		...
		::System::Boolean _IsAutoMode_k__BackingField; // 0x68
		::System::Boolean _IsAtmosphereLoaded; // 0x69
		::System::Boolean _IsAutoModeSwitchEnabled; // 0x6A
		::System::Boolean _IsLGStarted; // 0x6B
