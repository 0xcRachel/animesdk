...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_CANRESTART_OFFSET UNITYSDK_OFFSET(0x8B301E0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8B2FA50)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_DOREPORT_OFFSET UNITYSDK_OFFSET(0x8B30190)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_ENABLEAUTOMODESWITCH_OFFSET UNITYSDK_OFFSET(0x8B304A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_ENABLEAUTOMODE_OFFSET UNITYSDK_OFFSET(0x8B302E0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_GET_ISAUTOMODE_OFFSET UNITYSDK_OFFSET(0x8B31740)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_GET_ROOTANCHORNAME_OFFSET UNITYSDK_OFFSET(0x8B31760)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_INIT_OFFSET UNITYSDK_OFFSET(0x8B2F8B0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_LOADCHARACTER_OFFSET UNITYSDK_OFFSET(0x8B30540)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_ONUISCREENSIZECHANGED_OFFSET UNITYSDK_OFFSET(0x8B30BA0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_PAUSE_OFFSET UNITYSDK_OFFSET(0x8B30090)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_RESTART_OFFSET UNITYSDK_OFFSET(0x8B30110)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_RESUME_OFFSET UNITYSDK_OFFSET(0x8B300D0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_SETTLEGAME_OFFSET UNITYSDK_OFFSET(0x8B30220)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_SET_ISAUTOMODE_OFFSET UNITYSDK_OFFSET(0x8B31750)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_START_OFFSET UNITYSDK_OFFSET(0x8B2F860)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_TICK_OFFSET UNITYSDK_OFFSET(0x8B2F450)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_TRYLOADATMOSPHERE_OFFSET UNITYSDK_OFFSET(0x8B30880)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_TRYUNLOADATMOSPHERE_OFFSET UNITYSDK_OFFSET(0x8B30B50)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__CREATECHARACTER_OFFSET UNITYSDK_OFFSET(0x8B305A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__CREATENPC_OFFSET UNITYSDK_OFFSET(0x8B31030)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__CREATESTATICPREFAB_OFFSET UNITYSDK_OFFSET(0x8B31270)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x8B2F410)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__DESTORYALLENTITY_OFFSET UNITYSDK_OFFSET(0x8B2FDB0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__DOSETAUTOMODE_OFFSET UNITYSDK_OFFSET(0x8B303A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__ENDCURRENTLG_OFFSET UNITYSDK_OFFSET(0x8B2FFB0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__EXECUTETASKLIST_OFFSET UNITYSDK_OFFSET(0x8B30EF0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__FIREAUTOMODEEVENT_OFFSET UNITYSDK_OFFSET(0x8B30400)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__GETGRADETYPE_OFFSET UNITYSDK_OFFSET(0x8B30DA0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__GETLOCALPLAYERNPCID_OFFSET UNITYSDK_OFFSET(0x8B31470)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__LOADATMOSPHERE_OFFSET UNITYSDK_OFFSET(0x8B308D0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__ONAUTOMODECHANGED_OFFSET UNITYSDK_OFFSET(0x8B30DE0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x8B30D20)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__ONINIT_OFFSET UNITYSDK_OFFSET(0x8B30C80)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__ONSETTLE_OFFSET UNITYSDK_OFFSET(0x8B30D60)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__ONSTART_OFFSET UNITYSDK_OFFSET(0x8B30C40)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__ONTICK_OFFSET UNITYSDK_OFFSET(0x8B30CC0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__SENDSETTLEPACKET_OFFSET UNITYSDK_OFFSET(0x8B2F590)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__SETATMOSPHERECONFIG_OFFSET UNITYSDK_OFFSET(0x8B30BE0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__SETENTITYDITHER_OFFSET UNITYSDK_OFFSET(0x8B315E0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__STARTLG_OFFSET UNITYSDK_OFFSET(0x8B30E20)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__UNLOADATMOSPHERE_OFFSET UNITYSDK_OFFSET(0x8B2FB50)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenMiniGameBase_TypeDefinitionIndex = 59974;

	class ActivityHipplenMiniGameBase : public ::System::Object
	{
	public:
		::RPG::GameCore::HipplenGameAtmosphereConfig* _AtmosphereConfig; // 0x10
		::System::String* _RootAnchorName_k__BackingField; // 0x18
		::Class_1_69FF5DE516C87A66* _TaskExecuter; // 0x20
		::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* _EntityList; // 0x28
		::RPG::Client::ActivityHipplen::ActivityHipplenMiniGameManager* _Manager; // 0x30
		::Class_1_C8BA815B6612F0EA* _BabyHipplenRef; // 0x38
		::System::Action* _OnTaskFinished; // 0x40
		::UnityEngine::Transform* _Root; // 0x48
		::RPG::Client::ActivityHipplen::ActivityHipplenGameConfig _Config; // 0x50
		::RPG::GameCore::HipplenGameGradeType _SettleGradeType; // 0x60
		::System::Boolean _IsLGStarted; // 0x64
		::System::Boolean _IsAutoMode_k__BackingField; // 0x65
		::System::Boolean _IsAtmosphereLoaded; // 0x66
