...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENENDINGDATA_GET_DESCTEXTID_OFFSET UNITYSDK_OFFSET(0x186AF100)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENENDINGDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0x186AF090)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENENDINGDATA_GET_IMAGEPATH_OFFSET UNITYSDK_OFFSET(0x186AF160)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENENDINGDATA_GET_ISREWARDTAKEN_OFFSET UNITYSDK_OFFSET(0x186AF0C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENENDINGDATA_GET_NAMETEXTID_OFFSET UNITYSDK_OFFSET(0x186AF0D0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENENDINGDATA_GET_REWARDID_OFFSET UNITYSDK_OFFSET(0x186AF180)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENENDINGDATA_GET_UNLOCKDESCTEXTID_OFFSET UNITYSDK_OFFSET(0x186AF130)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENENDINGDATA_GET_UNLOCKED_OFFSET UNITYSDK_OFFSET(0x186AF0B0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENENDINGDATA_MARKSEEN_OFFSET UNITYSDK_OFFSET(0x186AEF20)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENENDINGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x186AA3D0)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenEndingData_TypeDefinitionIndex = 70371;
