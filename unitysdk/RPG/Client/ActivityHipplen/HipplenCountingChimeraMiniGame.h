...
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_CANRESTART_OFFSET UNITYSDK_OFFSET(0x8F3F250)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_DOREPORT_OFFSET UNITYSDK_OFFSET(0x8F3F1C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_GETQUIZCHIMERATRANSFORM_OFFSET UNITYSDK_OFFSET(0x8F3EC00)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_GET_HIPPLENGUESSANSWERINDEX_OFFSET UNITYSDK_OFFSET(0x8F428D0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_GET_ISSHOWHINT_OFFSET UNITYSDK_OFFSET(0x8F428F0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_GET_OPTIONS_OFFSET UNITYSDK_OFFSET(0x8F42890)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_GET_PERFORMANCETOTALTIME_OFFSET UNITYSDK_OFFSET(0x8F428B0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_GET_ROOTANCHORNAME_OFFSET UNITYSDK_OFFSET(0x8F42900)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_REGISTERCHIMERAGOTOWORKCALLBACK_OFFSET UNITYSDK_OFFSET(0x8F3EBB0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_REGISTERFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0x8F3EB60)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_REGISTERPERFORMANCETIMECHANGEDCALLBACK_OFFSET UNITYSDK_OFFSET(0x8F3EB10)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_REGISTERSHOWOPTIONSCALLBACK_OFFSET UNITYSDK_OFFSET(0x8F3EAC0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_RESTART_OFFSET UNITYSDK_OFFSET(0x8F3EC70)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_SELECTANSWER_OFFSET UNITYSDK_OFFSET(0x8F3E850)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_SET_HIPPLENGUESSANSWERINDEX_OFFSET UNITYSDK_OFFSET(0x8F428E0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_SET_OPTIONS_OFFSET UNITYSDK_OFFSET(0x8F428A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_SET_PERFORMANCETOTALTIME_OFFSET UNITYSDK_OFFSET(0x8F428C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__CHECKISCHIMERAGOTOWORK_OFFSET UNITYSDK_OFFSET(0x8F409F0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__CREATECHIMERAENTITY_OFFSET UNITYSDK_OFFSET(0x8F42230)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__CREATEOPTIONS_OFFSET UNITYSDK_OFFSET(0x8F41CB0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__CREATEQUIZCHIMERA_OFFSET UNITYSDK_OFFSET(0x8F3F930)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x8F3E730)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__GETANSWERINDEX_OFFSET UNITYSDK_OFFSET(0x8F42810)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__GETCHIMERAENTITY_OFFSET UNITYSDK_OFFSET(0x8F3FEB0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__GETGRADETYPE_OFFSET UNITYSDK_OFFSET(0x8F421E0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__INITTRACKS_OFFSET UNITYSDK_OFFSET(0x8F413A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__ONCHIMERAPERFORMANCEFINISHED_OFFSET UNITYSDK_OFFSET(0x8F419B0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x8F41280)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__ONFAIL_OFFSET UNITYSDK_OFFSET(0x8F3E9E0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__ONINIT_OFFSET UNITYSDK_OFFSET(0x8F3F380)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__ONSTART_OFFSET UNITYSDK_OFFSET(0x8F3F060)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__ONSUCC_OFFSET UNITYSDK_OFFSET(0x8F3E900)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__ONTICK_OFFSET UNITYSDK_OFFSET(0x8F40610)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__RECYCLECHIMERA_OFFSET UNITYSDK_OFFSET(0x8F3EE30)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__REFRESHHIPPLENGUESSANSWER_OFFSET UNITYSDK_OFFSET(0x8F423E0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__SELECTCHIMERAID_OFFSET UNITYSDK_OFFSET(0x8F41900)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__SETLOOKATCHIMERA_OFFSET UNITYSDK_OFFSET(0x8F3FAB0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__SHOWOPTIONS_OFFSET UNITYSDK_OFFSET(0x8F41AA0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__STARTCHIMERAPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x8F3F2A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__TICKCHIMERAENITY_OFFSET UNITYSDK_OFFSET(0x8F3FB80)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__TRYSHOWNEXTCHIMERAPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x8F40C10)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__UNLOADCHARACTERS_OFFSET UNITYSDK_OFFSET(0x8F42020)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME___IFIXBASEPROXY_CANRESTART_OFFSET UNITYSDK_OFFSET(0x8F42B00)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME___IFIXBASEPROXY_DOREPORT_OFFSET UNITYSDK_OFFSET(0x8F42A90)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME___IFIXBASEPROXY_RESTART_OFFSET UNITYSDK_OFFSET(0x8F42A80)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME___IFIXBASEPROXY__GETGRADETYPE_OFFSET UNITYSDK_OFFSET(0x8F42D00)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME___IFIXBASEPROXY__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x8F42CA0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME___IFIXBASEPROXY__ONINIT_OFFSET UNITYSDK_OFFSET(0x8F42BD0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME___IFIXBASEPROXY__ONSTART_OFFSET UNITYSDK_OFFSET(0x8F42B70)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME___IFIXBASEPROXY__ONTICK_OFFSET UNITYSDK_OFFSET(0x8F42C30)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME___ONFAIL_B__25_0_OFFSET UNITYSDK_OFFSET(0x8F42A10)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME___ONINIT_B__14_0_OFFSET UNITYSDK_OFFSET(0x8F42940)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME___ONSUCC_B__24_0_OFFSET UNITYSDK_OFFSET(0x8F429A0)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int HipplenCountingChimeraMiniGame_TypeDefinitionIndex = 61733;
	...
	public:
		...
		::System::Collections::Generic::Queue_1<::RPG::GameCore::GameEntity*>* _ChimeraPool; // 0x78
		...
		::System::Collections::Generic::List_1<::RPG::Client::ActivityHipplen::HipplenCountingChimeraMiniGame_PlayingTrackAsset*>* _PlayingTrackAssets; // 0x98
		::System::Action* _OnChimeraGotoWork; // 0xA0
		::UnityEngine::Timeline::TimelineAsset* _TimelineAsset; // 0xA8
		::RPG::GameCore::GameEntity* _LookAtChimera; // 0xB0
		::System::Action* _FinishAction; // 0xB8
		::System::Action_1<::System::Int32>* _OnFinish; // 0xC0
		::RPG::GameCore::GameEntity* _QuizChimera; // 0xC8
		::RPG::GameCore::HipplenCountingChimeraMiniGameConfig* _ConfigRef; // 0xD0
		::Il2CppArray<::System::Int32>* _Options_k__BackingField; // 0xD8
		::System::Int32 _WorstAnswer; // 0xE0
		::System::Int32 _HipplenGuessAnswerIndex_k__BackingField; // 0xE4
		::System::Int32 _ApproximatelyAnswer; // 0xE8
		::System::Boolean _IsCharacterLoaded; // 0xEC
		::System::Single _CountDown; // 0xF0
		::RPG::Client::ActivityHipplen::HipplenCountingChimeraMiniGame_InnerState _State; // 0xF4
		::System::Single _PerformanceRemainTime; // 0xF8
		::System::Single _PerformanceTotalTime_k__BackingField; // 0xFC
		::System::Int32 _CurWaveIndex; // 0x100
		...
		::System::Int32 _CorrectAnswer; // 0x110
		::System::Int32 _CorrectAnswerIndex; // 0x114
