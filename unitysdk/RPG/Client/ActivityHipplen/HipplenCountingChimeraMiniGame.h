...
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_CANRESTART_OFFSET UNITYSDK_OFFSET(0x16927EB0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_DOREPORT_OFFSET UNITYSDK_OFFSET(0x16927E20)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_GETQUIZCHIMERATRANSFORM_OFFSET UNITYSDK_OFFSET(0x16927870)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_GET_HIPPLENGUESSANSWERINDEX_OFFSET UNITYSDK_OFFSET(0x1692B520)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_GET_ISSHOWHINT_OFFSET UNITYSDK_OFFSET(0x1692B540)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_GET_OPTIONS_OFFSET UNITYSDK_OFFSET(0x1692B4E0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_GET_PERFORMANCETOTALTIME_OFFSET UNITYSDK_OFFSET(0x1692B500)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_GET_ROOTANCHORNAME_OFFSET UNITYSDK_OFFSET(0x1692B550)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_REGISTERCHIMERAGOTOWORKCALLBACK_OFFSET UNITYSDK_OFFSET(0x16927820)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_REGISTERFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0x169277D0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_REGISTERPERFORMANCETIMECHANGEDCALLBACK_OFFSET UNITYSDK_OFFSET(0x16927780)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_REGISTERSHOWOPTIONSCALLBACK_OFFSET UNITYSDK_OFFSET(0x16927730)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_RESTART_OFFSET UNITYSDK_OFFSET(0x169278D0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_SELECTANSWER_OFFSET UNITYSDK_OFFSET(0x169274C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_SET_HIPPLENGUESSANSWERINDEX_OFFSET UNITYSDK_OFFSET(0x1692B530)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_SET_OPTIONS_OFFSET UNITYSDK_OFFSET(0x1692B4F0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_SET_PERFORMANCETOTALTIME_OFFSET UNITYSDK_OFFSET(0x1692B510)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__CHECKISCHIMERAGOTOWORK_OFFSET UNITYSDK_OFFSET(0x16929640)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__CREATECHIMERAENTITY_OFFSET UNITYSDK_OFFSET(0x1692AE80)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__CREATEOPTIONS_OFFSET UNITYSDK_OFFSET(0x1692A900)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__CREATEQUIZCHIMERA_OFFSET UNITYSDK_OFFSET(0x16928580)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1691C5D0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__GETANSWERINDEX_OFFSET UNITYSDK_OFFSET(0x1692B460)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__GETCHIMERAENTITY_OFFSET UNITYSDK_OFFSET(0x16928B00)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__GETGRADETYPE_OFFSET UNITYSDK_OFFSET(0x1692AE30)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__INITTRACKS_OFFSET UNITYSDK_OFFSET(0x16929FF0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__ONCHIMERAPERFORMANCEFINISHED_OFFSET UNITYSDK_OFFSET(0x1692A600)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x16929ED0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__ONFAIL_OFFSET UNITYSDK_OFFSET(0x16927650)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__ONINIT_OFFSET UNITYSDK_OFFSET(0x16927FE0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__ONSTART_OFFSET UNITYSDK_OFFSET(0x16927CC0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__ONSUCC_OFFSET UNITYSDK_OFFSET(0x16927570)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__ONTICK_OFFSET UNITYSDK_OFFSET(0x16929260)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__RECYCLECHIMERA_OFFSET UNITYSDK_OFFSET(0x16927A90)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__REFRESHHIPPLENGUESSANSWER_OFFSET UNITYSDK_OFFSET(0x1692B030)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__SELECTCHIMERAID_OFFSET UNITYSDK_OFFSET(0x1692A550)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__SETLOOKATCHIMERA_OFFSET UNITYSDK_OFFSET(0x16928700)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__SHOWOPTIONS_OFFSET UNITYSDK_OFFSET(0x1692A6F0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__STARTCHIMERAPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x16927F00)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__TICKCHIMERAENITY_OFFSET UNITYSDK_OFFSET(0x169287D0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__TRYSHOWNEXTCHIMERAPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x16929860)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME__UNLOADCHARACTERS_OFFSET UNITYSDK_OFFSET(0x1692AC70)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME___IFIXBASEPROXY_CANRESTART_OFFSET UNITYSDK_OFFSET(0x1692B730)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME___IFIXBASEPROXY_DOREPORT_OFFSET UNITYSDK_OFFSET(0x1692B6E0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME___IFIXBASEPROXY_RESTART_OFFSET UNITYSDK_OFFSET(0x1692B6D0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME___IFIXBASEPROXY__GETGRADETYPE_OFFSET UNITYSDK_OFFSET(0x1692B890)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME___IFIXBASEPROXY__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x1692B850)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME___IFIXBASEPROXY__ONINIT_OFFSET UNITYSDK_OFFSET(0x1692B7B0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME___IFIXBASEPROXY__ONSTART_OFFSET UNITYSDK_OFFSET(0x1692B770)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME___IFIXBASEPROXY__ONTICK_OFFSET UNITYSDK_OFFSET(0x1692B7F0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME___ONFAIL_B__25_0_OFFSET UNITYSDK_OFFSET(0x1692B660)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME___ONINIT_B__14_0_OFFSET UNITYSDK_OFFSET(0x1692B590)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME___ONSUCC_B__24_0_OFFSET UNITYSDK_OFFSET(0x1692B5F0)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int HipplenCountingChimeraMiniGame_TypeDefinitionIndex = 69643;

	class HipplenCountingChimeraMiniGame : public ::RPG::Client::ActivityHipplen::ActivityHipplenMiniGameBase
	{
	public:
		::RPG::GameCore::GameEntity* _LookAtChimera; // 0x70
		::RPG::GameCore::GameEntity* _QuizChimera; // 0x78
		::System::Action_1<::System::Single>* _OnPerformanceTimeChanged; // 0x80
		::RPG::GameCore::HipplenCountingChimeraMiniGameConfig* _ConfigRef; // 0x88
		...
		::System::Action_1<::System::Int32>* _OnFinish; // 0xA0
		::System::Collections::Generic::Queue_1<::RPG::GameCore::GameEntity*>* _ChimeraPool; // 0xA8
		...
		::Il2CppArray<::System::Int32>* _Options_k__BackingField; // 0xC0
		...
		::System::Boolean _IsCharacterLoaded; // 0xF4
		::System::Single _PlayTime; // 0xF8
		::RPG::Client::ActivityHipplen::HipplenCountingChimeraMiniGame_HipplenGuessAnswerType _GuessAnswerType; // 0xFC
		::System::Int32 _CorrectAnswer; // 0x100
		::RPG::Client::ActivityHipplen::HipplenCountingChimeraMiniGame_InnerState _State; // 0x104
		::System::Int32 _CurWaveIndex; // 0x108
