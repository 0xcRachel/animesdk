...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEMANAGER_ADD__ONEVENT_OFFSET UNITYSDK_OFFSET(0x1691CB60)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEMANAGER_DESTROY_OFFSET UNITYSDK_OFFSET(0x1691BEE0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEMANAGER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1691C860)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEMANAGER_FIREEVENT_OFFSET UNITYSDK_OFFSET(0x1691A8C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEMANAGER_GETGAME_OFFSET UNITYSDK_OFFSET(0x1691C910)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEMANAGER_GET_CANRESTARTGAME_OFFSET UNITYSDK_OFFSET(0x1691CF50)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEMANAGER_GET_CANSTARTGAME_OFFSET UNITYSDK_OFFSET(0x1691D130)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEMANAGER_GET_ISINTRIAL_OFFSET UNITYSDK_OFFSET(0x1691D140)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEMANAGER_GET_MAINCTRL_OFFSET UNITYSDK_OFFSET(0x1691D110)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEMANAGER_GET_OFFSET UNITYSDK_OFFSET(0x1691BDC0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0x1691BF70)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEMANAGER_LOADCHARACTER_OFFSET UNITYSDK_OFFSET(0x1691D030)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEMANAGER_MARKCANSTART_OFFSET UNITYSDK_OFFSET(0x1691CD10)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEMANAGER_NOTIFYGAMEGRADECHANGED_OFFSET UNITYSDK_OFFSET(0x1691CCB0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEMANAGER_ONGAMEFINISHED_OFFSET UNITYSDK_OFFSET(0x16919F50)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEMANAGER_ONUISCREENSIZECHANGED_OFFSET UNITYSDK_OFFSET(0x1691D0B0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEMANAGER_PAUSE_OFFSET UNITYSDK_OFFSET(0x1691CD60)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEMANAGER_REGISTEREVENTLISTENER_OFFSET UNITYSDK_OFFSET(0x1691CAD0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEMANAGER_REGISTERGAMEFINISHEDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1691C9F0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEMANAGER_REGISTERGAMEGRADECHANGEDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1691CA60)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEMANAGER_REMOVE__ONEVENT_OFFSET UNITYSDK_OFFSET(0x1691CC50)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEMANAGER_REPORT_OFFSET UNITYSDK_OFFSET(0x1691CFC0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEMANAGER_RESTART_OFFSET UNITYSDK_OFFSET(0x1691CE20)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEMANAGER_RESUME_OFFSET UNITYSDK_OFFSET(0x1691CDC0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEMANAGER_SET_ISINTRIAL_OFFSET UNITYSDK_OFFSET(0x1691D150)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEMANAGER_SET_MAINCTRL_OFFSET UNITYSDK_OFFSET(0x1691D120)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEMANAGER_STARTGAME_OFFSET UNITYSDK_OFFSET(0x1691C950)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEMANAGER_TICK_OFFSET UNITYSDK_OFFSET(0x1691BE50)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEMANAGER_UNREGISTEREVENTLISTENER_OFFSET UNITYSDK_OFFSET(0x1691CBC0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1691BE40)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenMiniGameManager_TypeDefinitionIndex = 69641;
	...
	public:
		...
		::System::Action_1<::RPG::GameCore::HipplenGameGradeType>* _OnGameFinished; // 0x38
		::System::Action_1<::Class_2_CFE01593AA29BD1C_Class_1_22046C69D06B0F53*>* _OnEvent; // 0x40
