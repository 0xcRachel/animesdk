...
#define RPG_CLIENT_ONPRELOADOPERATIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x9A06160)
#define RPG_CLIENT_ONPRELOADOPERATIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x9A06190)
#define RPG_CLIENT_ONPRELOADOPERATIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x9A05A20)
#define RPG_CLIENT_ONPRELOADOPERATIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x9A05A00)

namespace RPG::Client
{
	inline static constexpr unsigned int OnPreloadOperationDelegate_TypeDefinitionIndex = 46951;
