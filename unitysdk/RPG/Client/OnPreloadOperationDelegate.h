...
#define RPG_CLIENT_ONPRELOADOPERATIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x143F1DA0)
#define RPG_CLIENT_ONPRELOADOPERATIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x143F1DD0)
#define RPG_CLIENT_ONPRELOADOPERATIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x143F1850)
#define RPG_CLIENT_ONPRELOADOPERATIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x143F1830)
