...
#define RPG_CLIENT_LITTLEGAMESHARE_LITTLEGAMESTTASKCONFIG_METHOD_4_4D1CDCD9589F74A7_OFFSET UNITYSDK_OFFSET(0x19246300)
#define RPG_CLIENT_LITTLEGAMESHARE_LITTLEGAMESTTASKCONFIG_METHOD_4_CB890B25D5D40713_OFFSET UNITYSDK_OFFSET(0x19245790)
#define RPG_CLIENT_LITTLEGAMESHARE_LITTLEGAMESTTASKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x192463C0)
