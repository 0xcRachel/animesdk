...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEUSEFOODITEMDECISION_METHOD_5_51E1C5EDAE61404D_OFFSET UNITYSDK_OFFSET(0x1676A2F0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEUSEFOODITEMDECISION_METHOD_5_A818A74B86007B7A_OFFSET UNITYSDK_OFFSET(0x16768490)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEUSEFOODITEMDECISION__CTOR_OFFSET UNITYSDK_OFFSET(0x16768440)
