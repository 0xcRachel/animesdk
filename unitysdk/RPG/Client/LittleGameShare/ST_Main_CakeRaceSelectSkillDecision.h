...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACESELECTSKILLDECISION_METHOD_5_69E6DD3D0007EC9E_OFFSET UNITYSDK_OFFSET(0x19877560)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACESELECTSKILLDECISION_METHOD_5_9E82239B816267C0_OFFSET UNITYSDK_OFFSET(0x198773C0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACESELECTSKILLDECISION__CTOR_OFFSET UNITYSDK_OFFSET(0x19877510)
