...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_DIE_METHOD_2_9B39F7D7C1FF70D6_OFFSET UNITYSDK_OFFSET(0xA266350)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_DIE_METHOD_2_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0xA2663C0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_DIE__CTOR_OFFSET UNITYSDK_OFFSET(0xA2663B0)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayTargetActionConfig_Die_TypeDefinitionIndex = 54549;
	...
	public:
		...
		{
			return ((::Class_1_482F3423DE650EAD*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_DIE_METHOD_2_9B39F7D7C1FF70D6_OFFSET))(this);
		}
