...
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONLIVESTREAMSTAGEDATA_GET_BEGINTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x16D60210)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONLIVESTREAMSTAGEDATA_GET_PREVSTAGEBEGINTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x16D601F0)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONLIVESTREAMSTAGEDATA_GET_REVIEWTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x16D60230)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONLIVESTREAMSTAGEDATA_GET_STAGESTATE_OFFSET UNITYSDK_OFFSET(0x16D600D0)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONLIVESTREAMSTAGEDATA_SET_BEGINTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x16D60220)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONLIVESTREAMSTAGEDATA_SET_PREVSTAGEBEGINTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x16D60200)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONLIVESTREAMSTAGEDATA_SET_REVIEWTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x16D60240)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONLIVESTREAMSTAGEDATA_UPDATETIMEINFO_OFFSET UNITYSDK_OFFSET(0x16D60070)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONLIVESTREAMSTAGEDATA__CALCULATECURSTATE_OFFSET UNITYSDK_OFFSET(0x16D600E0)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONLIVESTREAMSTAGEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16D60060)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 _ReviewTimeStamp_k__BackingField; // 0x20
