...
#define RPG_CLIENT_PROPSELECTIONSTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9D1F9D0)

namespace RPG::Client
{
	inline static constexpr unsigned int PropSelectionStateConfig_TypeDefinitionIndex = 47715;
