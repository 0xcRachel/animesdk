...
#define RPG_CLIENT_EFFECTAUDIOITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9093980)

namespace RPG::Client
{
	inline static constexpr unsigned int EffectAudioItem_TypeDefinitionIndex = 55739;
