...
#define RPG_CLIENT_MATCUSTOMDICTIONAY_FINALIZE_OFFSET UNITYSDK_OFFSET(0x9648790)
#define RPG_CLIENT_MATCUSTOMDICTIONAY_METHOD_1_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x96486F0)
#define RPG_CLIENT_MATCUSTOMDICTIONAY_METHOD_1_4DB5506DCD053FB2_OFFSET UNITYSDK_OFFSET(0x9648610)
#define RPG_CLIENT_MATCUSTOMDICTIONAY_METHOD_1_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x96486A0)
#define RPG_CLIENT_MATCUSTOMDICTIONAY__CTOR_OFFSET UNITYSDK_OFFSET(0x96485B0)

namespace RPG::Client
{
	inline static constexpr unsigned int MatCustomDictionay_TypeDefinitionIndex = 56377;
