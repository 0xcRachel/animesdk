...
#define RPG_CLIENT_CRPLENSFLAREPLUGIN_METHOD_5_755870B55A8B3AFF_OFFSET UNITYSDK_OFFSET(0x15FB9120)
#define RPG_CLIENT_CRPLENSFLAREPLUGIN_METHOD_5_AAFC2E07366CF380_OFFSET UNITYSDK_OFFSET(0x15FB8D70)
#define RPG_CLIENT_CRPLENSFLAREPLUGIN_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x15FB8470)
#define RPG_CLIENT_CRPLENSFLAREPLUGIN_ONENABLE_OFFSET UNITYSDK_OFFSET(0x15FB9550)
#define RPG_CLIENT_CRPLENSFLAREPLUGIN_UPDATELENSFLARE_OFFSET UNITYSDK_OFFSET(0x15FB9510)
#define RPG_CLIENT_CRPLENSFLAREPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x15FB9680)
