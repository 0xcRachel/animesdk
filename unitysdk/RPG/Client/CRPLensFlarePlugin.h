...
#define RPG_CLIENT_CRPLENSFLAREPLUGIN_METHOD_5_98060E4D16CBDFE4_OFFSET UNITYSDK_OFFSET(0x8E145D0)
#define RPG_CLIENT_CRPLENSFLAREPLUGIN_METHOD_5_AAFC2E07366CF380_OFFSET UNITYSDK_OFFSET(0x8E14210)
#define RPG_CLIENT_CRPLENSFLAREPLUGIN_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x8E13910)
#define RPG_CLIENT_CRPLENSFLAREPLUGIN_ONENABLE_OFFSET UNITYSDK_OFFSET(0x8E149E0)
#define RPG_CLIENT_CRPLENSFLAREPLUGIN_UPDATELENSFLARE_OFFSET UNITYSDK_OFFSET(0x8E149A0)
#define RPG_CLIENT_CRPLENSFLAREPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x8E14B10)

namespace RPG::Client
{
	inline static constexpr unsigned int CRPLensFlarePlugin_TypeDefinitionIndex = 55861;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_CRPLENSFLAREPLUGIN_METHOD_5_98060E4D16CBDFE4_OFFSET))(this);
		}
