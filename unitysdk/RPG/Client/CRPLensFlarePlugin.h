...
#define RPG_CLIENT_CRPLENSFLAREPLUGIN_METHOD_5_755870B55A8B3AFF_OFFSET UNITYSDK_OFFSET(0x921E380)
#define RPG_CLIENT_CRPLENSFLAREPLUGIN_METHOD_5_AAFC2E07366CF380_OFFSET UNITYSDK_OFFSET(0x921DFD0)
#define RPG_CLIENT_CRPLENSFLAREPLUGIN_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x921D6D0)
#define RPG_CLIENT_CRPLENSFLAREPLUGIN_ONENABLE_OFFSET UNITYSDK_OFFSET(0x921E7B0)
#define RPG_CLIENT_CRPLENSFLAREPLUGIN_UPDATELENSFLARE_OFFSET UNITYSDK_OFFSET(0x921E770)
#define RPG_CLIENT_CRPLENSFLAREPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x921E8E0)
