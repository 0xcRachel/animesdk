...
#define RPG_CLIENT_NAVMAP_ICONCOLLECTOR3DERAFLIP_INIT_OFFSET UNITYSDK_OFFSET(0x9E02870)
#define RPG_CLIENT_NAVMAP_ICONCOLLECTOR3DERAFLIP__COLLECTMAPPINGINFO3DICON_OFFSET UNITYSDK_OFFSET(0x9E162D0)
#define RPG_CLIENT_NAVMAP_ICONCOLLECTOR3DERAFLIP__COLLECTTELEPORT3DICON_OFFSET UNITYSDK_OFFSET(0x9E16900)
#define RPG_CLIENT_NAVMAP_ICONCOLLECTOR3DERAFLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x9E02810)
#define RPG_CLIENT_NAVMAP_ICONCOLLECTOR3DERAFLIP___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x9E16D60)
#define RPG_CLIENT_NAVMAP_ICONCOLLECTOR3DERAFLIP___IFIXBASEPROXY__COLLECTMAPPINGINFO3DICON_OFFSET UNITYSDK_OFFSET(0x9E16D70)

namespace RPG::Client::NavMap
{
	inline static constexpr unsigned int IconCollector3DEraFlip_TypeDefinitionIndex = 61256;
