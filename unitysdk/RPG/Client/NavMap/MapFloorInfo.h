...
#define RPG_CLIENT_NAVMAP_MAPFLOORINFO_GET_CONTENTID_OFFSET UNITYSDK_OFFSET(0x9988630)
#define RPG_CLIENT_NAVMAP_MAPFLOORINFO_GET_FLOORID_OFFSET UNITYSDK_OFFSET(0x9988650)
#define RPG_CLIENT_NAVMAP_MAPFLOORINFO_GET_STORYLINEID_OFFSET UNITYSDK_OFFSET(0x9988610)
#define RPG_CLIENT_NAVMAP_MAPFLOORINFO_SET_CONTENTID_OFFSET UNITYSDK_OFFSET(0x9988640)
#define RPG_CLIENT_NAVMAP_MAPFLOORINFO_SET_FLOORID_OFFSET UNITYSDK_OFFSET(0x9988660)
#define RPG_CLIENT_NAVMAP_MAPFLOORINFO_SET_STORYLINEID_OFFSET UNITYSDK_OFFSET(0x9988620)
#define RPG_CLIENT_NAVMAP_MAPFLOORINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x99859C0)

namespace RPG::Client::NavMap
{
	inline static constexpr unsigned int MapFloorInfo_TypeDefinitionIndex = 59538;
