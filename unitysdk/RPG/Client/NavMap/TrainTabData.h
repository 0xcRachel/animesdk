...
#define RPG_CLIENT_NAVMAP_TRAINTABDATA_GETDEFAULTSUBTABANDLAYER_OFFSET UNITYSDK_OFFSET(0x999BD40)
#define RPG_CLIENT_NAVMAP_TRAINTABDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x999BCF0)
#define RPG_CLIENT_NAVMAP_TRAINTABDATA___IFIXBASEPROXY_GETDEFAULTSUBTABANDLAYER_OFFSET UNITYSDK_OFFSET(0x999C0F0)

namespace RPG::Client::NavMap
{
	inline static constexpr unsigned int TrainTabData_TypeDefinitionIndex = 59512;
