...
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_CREATE_OFFSET UNITYSDK_OFFSET(0x9929A00)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x992CA70)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_EQUALS_OFFSET UNITYSDK_OFFSET(0x992C920)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_GETWAYPOINTCONNECTINFO_OFFSET UNITYSDK_OFFSET(0x992C770)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_GET_CARTOGRAPHERIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x992C610)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_GET_CONTENTID_OFFSET UNITYSDK_OFFSET(0x992C5B0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_GET_CREATETIMESTAMP_OFFSET UNITYSDK_OFFSET(0x992C740)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_GET_ENTITYID_OFFSET UNITYSDK_OFFSET(0x992C5F0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_GET_FLOORID_OFFSET UNITYSDK_OFFSET(0x992C5D0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_GET_ISAUTOCANCELTRACK_OFFSET UNITYSDK_OFFSET(0x992C760)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_GET_ISINCURRENTSCENE_OFFSET UNITYSDK_OFFSET(0x992C670)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_GET_ISSHOWINCURRENTSCENE_OFFSET UNITYSDK_OFFSET(0x992C6C0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_GET_MAPICONCOLOR_OFFSET UNITYSDK_OFFSET(0x992C650)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_GET_MAPICONTYPE_OFFSET UNITYSDK_OFFSET(0x992C630)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_GET_MAPPOSITION_OFFSET UNITYSDK_OFFSET(0x992C710)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_GET_STORYLINEID_OFFSET UNITYSDK_OFFSET(0x992C590)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_SET_CARTOGRAPHERIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x992C620)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_SET_CONTENTID_OFFSET UNITYSDK_OFFSET(0x992C5C0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_SET_CREATETIMESTAMP_OFFSET UNITYSDK_OFFSET(0x992C750)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_SET_ENTITYID_OFFSET UNITYSDK_OFFSET(0x992C600)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_SET_FLOORID_OFFSET UNITYSDK_OFFSET(0x992C5E0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_SET_MAPICONCOLOR_OFFSET UNITYSDK_OFFSET(0x992C660)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_SET_MAPICONTYPE_OFFSET UNITYSDK_OFFSET(0x992C640)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_SET_MAPPOSITION_OFFSET UNITYSDK_OFFSET(0x992C730)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_SET_STORYLINEID_OFFSET UNITYSDK_OFFSET(0x992C5A0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT__CTOR_OFFSET UNITYSDK_OFFSET(0x992C470)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT__INITCARTOGRAPHERIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x992C480)

namespace RPG::Client::NavMap::FiveDim
{
	inline static constexpr unsigned int FiveDimIconTrackSnapshot_TypeDefinitionIndex = 59640;
	...
	public:
		...
		::System::UInt32 _ContainerInstanceID; // 0x38
		...
		::System::UInt32 _ContainerGroupID; // 0x58
