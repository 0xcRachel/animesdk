...
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_CREATE_OFFSET UNITYSDK_OFFSET(0x159273D0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1592A840)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_EQUALS_OFFSET UNITYSDK_OFFSET(0x1592A6F0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_GETWAYPOINTCONNECTINFO_OFFSET UNITYSDK_OFFSET(0x1592A410)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_GET_CARTOGRAPHERIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1592A280)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_GET_CONTENTID_OFFSET UNITYSDK_OFFSET(0x1592A220)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_GET_CREATETIMESTAMP_OFFSET UNITYSDK_OFFSET(0x1592A3E0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_GET_ENTITYID_OFFSET UNITYSDK_OFFSET(0x1592A260)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_GET_FLOORID_OFFSET UNITYSDK_OFFSET(0x1592A240)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_GET_ISAUTOCANCELTRACK_OFFSET UNITYSDK_OFFSET(0x1592A400)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_GET_ISINCURRENTSCENE_OFFSET UNITYSDK_OFFSET(0x1592A2E0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_GET_ISSHOWINCURRENTSCENE_OFFSET UNITYSDK_OFFSET(0x1592A3A0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_GET_MAPICONCOLOR_OFFSET UNITYSDK_OFFSET(0x1592A2C0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_GET_MAPICONTYPE_OFFSET UNITYSDK_OFFSET(0x1592A2A0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_GET_MAPPOSITION_OFFSET UNITYSDK_OFFSET(0x1592A3B0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_GET_STORYLINEID_OFFSET UNITYSDK_OFFSET(0x1592A200)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_SET_CARTOGRAPHERIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1592A290)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_SET_CONTENTID_OFFSET UNITYSDK_OFFSET(0x1592A230)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_SET_CREATETIMESTAMP_OFFSET UNITYSDK_OFFSET(0x1592A3F0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_SET_ENTITYID_OFFSET UNITYSDK_OFFSET(0x1592A270)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_SET_FLOORID_OFFSET UNITYSDK_OFFSET(0x1592A250)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_SET_MAPICONCOLOR_OFFSET UNITYSDK_OFFSET(0x1592A2D0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_SET_MAPICONTYPE_OFFSET UNITYSDK_OFFSET(0x1592A2B0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_SET_MAPPOSITION_OFFSET UNITYSDK_OFFSET(0x1592A3D0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT_SET_STORYLINEID_OFFSET UNITYSDK_OFFSET(0x1592A210)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1592A0C0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_FIVEDIMICONTRACKSNAPSHOT__INITCARTOGRAPHERIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1592A0D0)

namespace RPG::Client::NavMap::FiveDim
{
	inline static constexpr unsigned int FiveDimIconTrackSnapshot_TypeDefinitionIndex = 68902;
	...
	public:
		...
		::System::UInt64 _CreateTimeStamp_k__BackingField; // 0x38
		...
		::System::UInt32 _ContainerInstanceID; // 0x58
		::System::UInt32 _SubMapID; // 0x5C
