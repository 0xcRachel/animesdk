...
#define RPG_CLIENT_NAVMAP_FIVEDIM_SURFACECONNECTICON_SURFACECONNECTTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x166984D0)

namespace RPG::Client::NavMap::FiveDim
{
	inline static constexpr unsigned int SurfaceConnectIcon_SurfaceConnectTarget_TypeDefinitionIndex = 69723;

	class SurfaceConnectIcon_SurfaceConnectTarget : public ::System::Object
	{
	public:
		::System::UInt32 ContainerGroupID; // 0x10
		::System::UInt32 SurfaceID; // 0x14
		::System::UInt32 EntityID; // 0x18
		::System::UInt32 ContainerInstanceID; // 0x1C
