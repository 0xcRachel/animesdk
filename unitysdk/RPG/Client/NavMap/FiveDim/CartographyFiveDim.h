...
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9E07170)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GETCHESTICONS_OFFSET UNITYSDK_OFFSET(0x9E08290)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GETFACEPLAYERIN_OFFSET UNITYSDK_OFFSET(0x9E09300)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GETFACE_1_OFFSET UNITYSDK_OFFSET(0x9E09940)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GETFACE_OFFSET UNITYSDK_OFFSET(0x9E096E0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GETICONS_OFFSET UNITYSDK_OFFSET(0x9E07F60)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GETLEVELINSTANCE_OFFSET UNITYSDK_OFFSET(0x9E08DC0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GETMISSIONICONS_OFFSET UNITYSDK_OFFSET(0x9E084E0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GETSURFACEPLAYERIN_OFFSET UNITYSDK_OFFSET(0x9E09380)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_ALLFACES_OFFSET UNITYSDK_OFFSET(0x9E08180)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_CARTOGRAPHER_OFFSET UNITYSDK_OFFSET(0x9E0A6B0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_CONTENTID_OFFSET UNITYSDK_OFFSET(0x9E08820)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_CURFACE_OFFSET UNITYSDK_OFFSET(0x9E09360)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_DIFFICULTYLEVEL_OFFSET UNITYSDK_OFFSET(0x9E09F30)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_ENTRYID_OFFSET UNITYSDK_OFFSET(0x9E0A260)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_EXPLORATIONPROGRESS_OFFSET UNITYSDK_OFFSET(0x9E09A60)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_FLOORID_OFFSET UNITYSDK_OFFSET(0x9E08680)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_ISEXPLORATIONCOMPLETED_OFFSET UNITYSDK_OFFSET(0x9E099D0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_ISPLAYERHERE_OFFSET UNITYSDK_OFFSET(0x9E092E0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_LEVELINSTANCES_OFFSET UNITYSDK_OFFSET(0x9E0A770)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_MAPAREALIST_OFFSET UNITYSDK_OFFSET(0x9E0A6A0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_MAPDATA_OFFSET UNITYSDK_OFFSET(0x9E0A010)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_NAVMAPCONFIG_OFFSET UNITYSDK_OFFSET(0x9E0A690)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_PLANEID_OFFSET UNITYSDK_OFFSET(0x9E0A1B0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_STORYLINEID_OFFSET UNITYSDK_OFFSET(0x9E08730)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_SUBMAPID_OFFSET UNITYSDK_OFFSET(0x9E09810)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_SYNCEDWITHSERVER_OFFSET UNITYSDK_OFFSET(0x9E09FF0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_VERSEPARAM_OFFSET UNITYSDK_OFFSET(0x9E0A310)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_ONMAPDATADIRTY_OFFSET UNITYSDK_OFFSET(0x9E0A6D0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_REPORTOPENEDDIALOG_OFFSET UNITYSDK_OFFSET(0x9E09830)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_RESETDEFAULTFACE_OFFSET UNITYSDK_OFFSET(0x9E09200)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_RPG_CLIENT_NAVMAP_ICARTOGRAPHY_GET_MAPDATA_OFFSET UNITYSDK_OFFSET(0x9E0A6C0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_SETCURFACE_OFFSET UNITYSDK_OFFSET(0x9E09530)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_SET_CURFACE_OFFSET UNITYSDK_OFFSET(0x9E09370)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_UPDATEDATA_OFFSET UNITYSDK_OFFSET(0x9E0A710)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM__COLLECTMISSIONICON_OFFSET UNITYSDK_OFFSET(0x9E078C0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM__COLLECTTRACKINGMISSIONICON_OFFSET UNITYSDK_OFFSET(0x9E08910)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM__CTOR_OFFSET UNITYSDK_OFFSET(0x9E06EC0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM__GETFACEBYID_OFFSET UNITYSDK_OFFSET(0x9E09120)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM__INITCURFACE_OFFSET UNITYSDK_OFFSET(0x9E07D70)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM__INITEXPLORATIONPROGRESS_OFFSET UNITYSDK_OFFSET(0x9E06FA0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM__INITFACEINDEX_OFFSET UNITYSDK_OFFSET(0x9E077A0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM__INITLEVELINSTANCES_OFFSET UNITYSDK_OFFSET(0x9E072D0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM__INITMAP_OFFSET UNITYSDK_OFFSET(0x9E06F30)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM__REFRESHEXPLORATIONPROGRESS_OFFSET UNITYSDK_OFFSET(0x9E07E00)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM__TRYADDMISSIONGUIDEICON_OFFSET UNITYSDK_OFFSET(0x9E079F0)

namespace RPG::Client::NavMap::FiveDim
{
	inline static constexpr unsigned int CartographyFiveDim_TypeDefinitionIndex = 61372;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_954*>* _ExplorationProgressList; // 0x28
