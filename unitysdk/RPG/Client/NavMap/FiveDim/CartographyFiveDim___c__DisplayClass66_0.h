...
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM___C__DISPLAYCLASS66_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15926390)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM___C__DISPLAYCLASS66_0__GETLEVELINSTANCE_B__0_OFFSET UNITYSDK_OFFSET(0x159264D0)

namespace RPG::Client::NavMap::FiveDim
{
	inline static constexpr unsigned int CartographyFiveDim___c__DisplayClass66_0_TypeDefinitionIndex = 68881;
