...
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_GET_ARTBOUNDFULL_OFFSET UNITYSDK_OFFSET(0x185AEDB0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_GET_ARTBOUND_OFFSET UNITYSDK_OFFSET(0x185AF510)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_GET__OWNER_OFFSET UNITYSDK_OFFSET(0x185AFD10)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_13D8773148BD1DCD_OFFSET UNITYSDK_OFFSET(0x185B25D0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_3C56C1AF247AC1EC_OFFSET UNITYSDK_OFFSET(0x185AFD50)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x185AFDA0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x185AFA40)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_48EE6F8CA58AC368_OFFSET UNITYSDK_OFFSET(0x185AFF50)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_5587AE4B03E68C58_OFFSET UNITYSDK_OFFSET(0x185B2460)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0x185B2A80)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_5790A55946AA509D_2_OFFSET UNITYSDK_OFFSET(0x185B2AE0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_5790A55946AA509D_3_OFFSET UNITYSDK_OFFSET(0x185B2B40)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_5790A55946AA509D_4_OFFSET UNITYSDK_OFFSET(0x185B2BA0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_5790A55946AA509D_5_OFFSET UNITYSDK_OFFSET(0x185B2C00)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x185B2A20)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_62167C28EC14CC63_OFFSET UNITYSDK_OFFSET(0x185AFAB0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_6A8EC1C1458586F1_1_OFFSET UNITYSDK_OFFSET(0x185B18E0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_6A8EC1C1458586F1_OFFSET UNITYSDK_OFFSET(0x185B1140)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_9F8F6511E8EF1235_OFFSET UNITYSDK_OFFSET(0x185B02F0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_A9A50625EA2594BB_OFFSET UNITYSDK_OFFSET(0x185B04D0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_B1936CE4DA97AA45_1_OFFSET UNITYSDK_OFFSET(0x185B2380)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x185B23F0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_B1EA412ACAE87C15_OFFSET UNITYSDK_OFFSET(0x185B2080)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x185AFE70)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x185AFEB0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_CA373AA1C7054598_3_OFFSET UNITYSDK_OFFSET(0x185B2340)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_CA373AA1C7054598_4_OFFSET UNITYSDK_OFFSET(0x185B2900)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x185AFE30)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0x185AFEF0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x185B29C0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x185B2950)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x185B2C60)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(TransformPatrolAnimBehavior_TypeDefinitionIndex)->GetStaticField(0xF750);
		}
		static ::System::Int32* StaticGet__SpeedRatioAnimatorHash()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(TransformPatrolAnimBehavior_TypeDefinitionIndex)->GetStaticField(0xF754);
		}
		static ::System::Int32* StaticGet__StayAnimatorHash()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(TransformPatrolAnimBehavior_TypeDefinitionIndex)->GetStaticField(0xF758);
		}
