...
#define RPG_CLIENT_GRIDFIGHTGAMEREF___C__DISPLAYCLASS80_0__APPLYREF_B__0_OFFSET UNITYSDK_OFFSET(0x1752BBA0)
#define RPG_CLIENT_GRIDFIGHTGAMEREF___C__DISPLAYCLASS80_0__APPLYREF_B__1_OFFSET UNITYSDK_OFFSET(0x1752BC80)
#define RPG_CLIENT_GRIDFIGHTGAMEREF___C__DISPLAYCLASS80_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1752BB90)
