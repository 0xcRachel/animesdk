...
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTEFFECTDISPLAYDATAITEM_CREATE_OFFSET UNITYSDK_OFFSET(0xA5195E0)
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTEFFECTDISPLAYDATAITEM_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xA519580)
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTEFFECTDISPLAYDATAITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0xA5195A0)
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTEFFECTDISPLAYDATAITEM_GET_VALUE_OFFSET UNITYSDK_OFFSET(0xA5195C0)
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTEFFECTDISPLAYDATAITEM_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xA519590)
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTEFFECTDISPLAYDATAITEM_SET_NAME_OFFSET UNITYSDK_OFFSET(0xA5195B0)
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTEFFECTDISPLAYDATAITEM_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xA5195D0)
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTEFFECTDISPLAYDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xA519680)

namespace RPG::Client::SwordTraining
{
	inline static constexpr unsigned int SwordTrainingRandomEventEffectDisplayDataItem_TypeDefinitionIndex = 61592;
