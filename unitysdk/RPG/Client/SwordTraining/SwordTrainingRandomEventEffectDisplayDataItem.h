...
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTEFFECTDISPLAYDATAITEM_CREATE_OFFSET UNITYSDK_OFFSET(0x16FE4DD0)
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTEFFECTDISPLAYDATAITEM_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x16FE4D70)
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTEFFECTDISPLAYDATAITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0x16FE4D90)
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTEFFECTDISPLAYDATAITEM_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x16FE4DB0)
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTEFFECTDISPLAYDATAITEM_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x16FE4D80)
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTEFFECTDISPLAYDATAITEM_SET_NAME_OFFSET UNITYSDK_OFFSET(0x16FE4DA0)
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTEFFECTDISPLAYDATAITEM_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x16FE4DC0)
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTEFFECTDISPLAYDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE4E70)

namespace RPG::Client::SwordTraining
{
	inline static constexpr unsigned int SwordTrainingRandomEventEffectDisplayDataItem_TypeDefinitionIndex = 69104;
