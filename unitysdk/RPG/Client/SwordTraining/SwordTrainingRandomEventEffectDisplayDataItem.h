...
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTEFFECTDISPLAYDATAITEM_CREATE_OFFSET UNITYSDK_OFFSET(0x9FF6CB0)
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTEFFECTDISPLAYDATAITEM_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x9FF6C50)
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTEFFECTDISPLAYDATAITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0x9FF6C70)
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTEFFECTDISPLAYDATAITEM_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x9FF6C90)
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTEFFECTDISPLAYDATAITEM_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x9FF6C60)
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTEFFECTDISPLAYDATAITEM_SET_NAME_OFFSET UNITYSDK_OFFSET(0x9FF6C80)
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTEFFECTDISPLAYDATAITEM_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x9FF6CA0)
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTEFFECTDISPLAYDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9FF6D50)

namespace RPG::Client::SwordTraining
{
	inline static constexpr unsigned int SwordTrainingRandomEventEffectDisplayDataItem_TypeDefinitionIndex = 59836;
