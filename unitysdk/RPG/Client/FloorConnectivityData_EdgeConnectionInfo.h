...
#define RPG_CLIENT_FLOORCONNECTIVITYDATA_EDGECONNECTIONINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x929A1C0)
#define RPG_CLIENT_FLOORCONNECTIVITYDATA_EDGECONNECTIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x929A1B0)
#define RPG_CLIENT_FLOORCONNECTIVITYDATA_EDGECONNECTIONINFO___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x929A2A0)

namespace RPG::Client
{
	inline static constexpr unsigned int FloorConnectivityData_EdgeConnectionInfo_TypeDefinitionIndex = 51012;

	class FloorConnectivityData_EdgeConnectionInfo : public ::System::Object
	{
	public:
		::System::Boolean IsRegionDirectConnect; // 0x10
