...
#define RPG_CLIENT_STATENORMALIZEDTIME_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0x9FC3450)
#define RPG_CLIENT_STATENORMALIZEDTIME_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9FC3330)
#define RPG_CLIENT_STATENORMALIZEDTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x9FC3500)
#define RPG_CLIENT_STATENORMALIZEDTIME___IFIXBASEPROXY_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0x9FC3520)
#define RPG_CLIENT_STATENORMALIZEDTIME___IFIXBASEPROXY_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9FC3510)

namespace RPG::Client
{
	inline static constexpr unsigned int StateNormalizedTime_TypeDefinitionIndex = 54668;
