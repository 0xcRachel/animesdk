...
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_CREATEDATA_OFFSET UNITYSDK_OFFSET(0x172E0050)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_GET_COSTITEM_OFFSET UNITYSDK_OFFSET(0x172E1440)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0x172E14A0)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x172E1400)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_GET_HASSTORY_OFFSET UNITYSDK_OFFSET(0x172E1550)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x172E1480)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0x172E13C0)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_GET_ISENABLED_OFFSET UNITYSDK_OFFSET(0x172E1630)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x172E13E0)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x172E1460)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_GET_PREID_OFFSET UNITYSDK_OFFSET(0x172E1420)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x172E1610)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_GET_STORYJSONPATH_OFFSET UNITYSDK_OFFSET(0x172E15D0)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_GET_STORYTITLE_OFFSET UNITYSDK_OFFSET(0x172E15B0)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_GET_UNLOCKHINT_OFFSET UNITYSDK_OFFSET(0x172E15F0)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_SET_COSTITEM_OFFSET UNITYSDK_OFFSET(0x172E1450)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_SET_GROUPID_OFFSET UNITYSDK_OFFSET(0x172E1410)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x172E1490)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0x172E13D0)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x172E13F0)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_SET_NAME_OFFSET UNITYSDK_OFFSET(0x172E1470)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_SET_PREID_OFFSET UNITYSDK_OFFSET(0x172E1430)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_SET_STATUS_OFFSET UNITYSDK_OFFSET(0x172E1620)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_SET_STORYJSONPATH_OFFSET UNITYSDK_OFFSET(0x172E15E0)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_SET_STORYTITLE_OFFSET UNITYSDK_OFFSET(0x172E15C0)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_SET_UNLOCKHINT_OFFSET UNITYSDK_OFFSET(0x172E1600)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_SYNC_OFFSET UNITYSDK_OFFSET(0x172E0B10)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x172E1340)
...
namespace RPG::Client
{
	...
	public:
		...
		::RPG::Client::TextID _StoryTitle_k__BackingField; // 0x48
		::System::UInt32 _PreID_k__BackingField; // 0x58
