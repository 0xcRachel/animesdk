...
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_CREATEDATA_OFFSET UNITYSDK_OFFSET(0xA3D5EB0)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_GET_COSTITEM_OFFSET UNITYSDK_OFFSET(0xA3D7280)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0xA3D72E0)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0xA3D7240)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_GET_HASSTORY_OFFSET UNITYSDK_OFFSET(0xA3D7390)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xA3D72C0)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xA3D7200)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_GET_ISENABLED_OFFSET UNITYSDK_OFFSET(0xA3D7470)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xA3D7220)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xA3D72A0)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_GET_PREID_OFFSET UNITYSDK_OFFSET(0xA3D7260)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_GET_STATUS_OFFSET UNITYSDK_OFFSET(0xA3D7450)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_GET_STORYJSONPATH_OFFSET UNITYSDK_OFFSET(0xA3D7410)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_GET_STORYTITLE_OFFSET UNITYSDK_OFFSET(0xA3D73F0)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_GET_UNLOCKHINT_OFFSET UNITYSDK_OFFSET(0xA3D7430)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_SET_COSTITEM_OFFSET UNITYSDK_OFFSET(0xA3D7290)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_SET_GROUPID_OFFSET UNITYSDK_OFFSET(0xA3D7250)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xA3D72D0)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0xA3D7210)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0xA3D7230)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_SET_NAME_OFFSET UNITYSDK_OFFSET(0xA3D72B0)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_SET_PREID_OFFSET UNITYSDK_OFFSET(0xA3D7270)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_SET_STATUS_OFFSET UNITYSDK_OFFSET(0xA3D7460)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_SET_STORYJSONPATH_OFFSET UNITYSDK_OFFSET(0xA3D7420)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_SET_STORYTITLE_OFFSET UNITYSDK_OFFSET(0xA3D7400)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_SET_UNLOCKHINT_OFFSET UNITYSDK_OFFSET(0xA3D7440)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA_SYNC_OFFSET UNITYSDK_OFFSET(0xA3D6950)
#define RPG_CLIENT_ROGUETOURNPERSONATALENTNODEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA3D7180)
...
namespace RPG::Client
{
	...
	public:
		...
		::Enum_3_0A3761FE34514D6C_64 _Status_k__BackingField; // 0x40
