...
#define RPG_CLIENT_ONLINEPLAYROOMMODULE_PENDINGVISITUIDINFO_GET_ENTERTIME_OFFSET UNITYSDK_OFFSET(0x143FA700)
#define RPG_CLIENT_ONLINEPLAYROOMMODULE_PENDINGVISITUIDINFO_GET_PLAYERINFO_OFFSET UNITYSDK_OFFSET(0x143FA720)
#define RPG_CLIENT_ONLINEPLAYROOMMODULE_PENDINGVISITUIDINFO_GET_UID_OFFSET UNITYSDK_OFFSET(0x143FA6E0)
#define RPG_CLIENT_ONLINEPLAYROOMMODULE_PENDINGVISITUIDINFO_SET_ENTERTIME_OFFSET UNITYSDK_OFFSET(0x143FA710)
#define RPG_CLIENT_ONLINEPLAYROOMMODULE_PENDINGVISITUIDINFO_SET_PLAYERINFO_OFFSET UNITYSDK_OFFSET(0x143FA730)
#define RPG_CLIENT_ONLINEPLAYROOMMODULE_PENDINGVISITUIDINFO_SET_UID_OFFSET UNITYSDK_OFFSET(0x143FA6F0)
#define RPG_CLIENT_ONLINEPLAYROOMMODULE_PENDINGVISITUIDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x143F9340)
