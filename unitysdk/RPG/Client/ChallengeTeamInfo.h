...
#define RPG_CLIENT_CHALLENGETEAMINFO_GETAVATARBYAVATARID_OFFSET UNITYSDK_OFFSET(0x15DD34C0)
#define RPG_CLIENT_CHALLENGETEAMINFO_GETAVATARDATALIST_OFFSET UNITYSDK_OFFSET(0x15DD3660)
#define RPG_CLIENT_CHALLENGETEAMINFO_SYNC_OFFSET UNITYSDK_OFFSET(0x15DD3130)
#define RPG_CLIENT_CHALLENGETEAMINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x15DD30F0)
