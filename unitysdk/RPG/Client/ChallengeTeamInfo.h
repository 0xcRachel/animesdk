...
#define RPG_CLIENT_CHALLENGETEAMINFO_GETAVATARBYAVATARID_OFFSET UNITYSDK_OFFSET(0x93044C0)
#define RPG_CLIENT_CHALLENGETEAMINFO_GETAVATARDATALIST_OFFSET UNITYSDK_OFFSET(0x9304660)
#define RPG_CLIENT_CHALLENGETEAMINFO_SYNC_OFFSET UNITYSDK_OFFSET(0x9304080)
#define RPG_CLIENT_CHALLENGETEAMINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x9304040)
