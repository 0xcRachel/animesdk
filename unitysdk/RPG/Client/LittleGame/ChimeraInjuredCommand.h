...
#define RPG_CLIENT_LITTLEGAME_CHIMERAINJUREDCOMMAND_EXECUTE_OFFSET UNITYSDK_OFFSET(0x17E2FCC0)
#define RPG_CLIENT_LITTLEGAME_CHIMERAINJUREDCOMMAND__CTOR_OFFSET UNITYSDK_OFFSET(0x17E2FD20)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int ChimeraInjuredCommand_TypeDefinitionIndex = 71204;
