...
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELDEADCURVE_METHOD_6_0414B7E68ABA5085_OFFSET UNITYSDK_OFFSET(0x95543B0)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELDEADCURVE_METHOD_6_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x9554170)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELDEADCURVE_METHOD_6_459C79521BFE514E_OFFSET UNITYSDK_OFFSET(0x95541D0)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELDEADCURVE_METHOD_6_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x95540E0)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELDEADCURVE_METHOD_6_D3129FE8DF635B48_OFFSET UNITYSDK_OFFSET(0x9554390)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELDEADCURVE_METHOD_6_F7300E87EC49A206_OFFSET UNITYSDK_OFFSET(0x95543A0)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELDEADCURVE_STARTCURVE_OFFSET UNITYSDK_OFFSET(0x9553FE0)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELDEADCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x9554370)

namespace RPG::Client::LittleGame::FourRotateVoxel
{
	inline static constexpr unsigned int FourRotateVoxelDeadCurve_TypeDefinitionIndex = 60557;
	...
	public:
		...
		::System::Void StartCurve(::Class_1_867B6CE75953535A_1* a1, ::Class_3_44EDAE37250FA2DB* a2, ::Class_1_8385F95FFA7FAA1C* a3, ::UnityEngine::Vector3 a4, ::UnityEngine::Vector3 a5, ::System::Action* a6)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_867B6CE75953535A_1*, ::Class_3_44EDAE37250FA2DB*, ::Class_1_8385F95FFA7FAA1C*, ::UnityEngine::Vector3, ::UnityEngine::Vector3, ::System::Action*))((::PBYTE)hIl2Cpp + RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELDEADCURVE_STARTCURVE_OFFSET))(this, a1, a2, a3, a4, a5, a6);
		}
