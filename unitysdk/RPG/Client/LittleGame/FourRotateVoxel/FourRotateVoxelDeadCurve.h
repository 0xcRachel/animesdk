...
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELDEADCURVE_METHOD_6_0414B7E68ABA5085_OFFSET UNITYSDK_OFFSET(0x9A2D960)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELDEADCURVE_METHOD_6_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x9A2D720)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELDEADCURVE_METHOD_6_459C79521BFE514E_OFFSET UNITYSDK_OFFSET(0x9A2D780)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELDEADCURVE_METHOD_6_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x9A2D690)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELDEADCURVE_METHOD_6_D3129FE8DF635B48_OFFSET UNITYSDK_OFFSET(0x9A2D940)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELDEADCURVE_METHOD_6_F7300E87EC49A206_OFFSET UNITYSDK_OFFSET(0x9A2D950)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELDEADCURVE_STARTCURVE_OFFSET UNITYSDK_OFFSET(0x9A2D590)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELDEADCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x9A2D920)

namespace RPG::Client::LittleGame::FourRotateVoxel
{
	inline static constexpr unsigned int FourRotateVoxelDeadCurve_TypeDefinitionIndex = 62535;
