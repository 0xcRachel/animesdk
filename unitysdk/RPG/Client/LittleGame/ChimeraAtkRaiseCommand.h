...
#define RPG_CLIENT_LITTLEGAME_CHIMERAATKRAISECOMMAND_EXECUTE_OFFSET UNITYSDK_OFFSET(0x9516990)
#define RPG_CLIENT_LITTLEGAME_CHIMERAATKRAISECOMMAND__CTOR_OFFSET UNITYSDK_OFFSET(0x95169F0)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int ChimeraAtkRaiseCommand_TypeDefinitionIndex = 60413;
