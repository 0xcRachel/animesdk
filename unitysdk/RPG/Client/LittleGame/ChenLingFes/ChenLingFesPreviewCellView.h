...
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESPREVIEWCELLVIEW_INITPEFORMCELL_OFFSET UNITYSDK_OFFSET(0x17E23FE0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESPREVIEWCELLVIEW_METHOD_7_648D33A557BC2E77_OFFSET UNITYSDK_OFFSET(0x17E24430)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESPREVIEWCELLVIEW_METHOD_7_84E99AA4DE826971_OFFSET UNITYSDK_OFFSET(0x17E24210)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESPREVIEWCELLVIEW_SETPEFORMCELLAVAILABLE_OFFSET UNITYSDK_OFFSET(0x17E24340)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESPREVIEWCELLVIEW__CCTOR_OFFSET UNITYSDK_OFFSET(0x17E24560)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESPREVIEWCELLVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x17E24540)

namespace RPG::Client::LittleGame::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesPreviewCellView_TypeDefinitionIndex = 72309;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ChenLingFesPreviewCellView_TypeDefinitionIndex)->GetStaticField(0xCB30);
		}
		static ::System::Int32* StaticGet_MainTextureId()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ChenLingFesPreviewCellView_TypeDefinitionIndex)->GetStaticField(0xCB34);
		}
