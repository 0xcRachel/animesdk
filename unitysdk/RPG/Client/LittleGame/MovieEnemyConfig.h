...
#define RPG_CLIENT_LITTLEGAME_MOVIEENEMYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x161572E0)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int MovieEnemyConfig_TypeDefinitionIndex = 31874;
