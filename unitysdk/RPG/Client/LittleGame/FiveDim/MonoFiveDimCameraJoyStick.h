...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK_AWAKE_OFFSET UNITYSDK_OFFSET(0x9A276F0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK_GET__CENTERPOS_OFFSET UNITYSDK_OFFSET(0x9A282C0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK_GET__MAXRADIUS_OFFSET UNITYSDK_OFFSET(0x9A283C0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9A27800)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x9A277A0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK_ONDRAG_OFFSET UNITYSDK_OFFSET(0x9A27660)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x9A27510)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x9A27590)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK_SPAWNED_OFFSET UNITYSDK_OFFSET(0x9A276B0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK__CTOR_OFFSET UNITYSDK_OFFSET(0x9A28590)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK__ENDJOYCAMERAOBSERVE_OFFSET UNITYSDK_OFFSET(0x9A275E0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK__GETMOVEDIR_OFFSET UNITYSDK_OFFSET(0x9A27CE0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK__INITVIEW_OFFSET UNITYSDK_OFFSET(0x9A27DE0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK__INIT_OFFSET UNITYSDK_OFFSET(0x9A27750)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK__SETNODEPOSBYSCREENPOS_OFFSET UNITYSDK_OFFSET(0x9A27890)

namespace RPG::Client::LittleGame::FiveDim
{
	inline static constexpr unsigned int MonoFiveDimCameraJoyStick_TypeDefinitionIndex = 62897;
