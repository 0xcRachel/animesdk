...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK_AWAKE_OFFSET UNITYSDK_OFFSET(0x15908250)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK_GET__CENTERPOS_OFFSET UNITYSDK_OFFSET(0x15908E20)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK_GET__MAXRADIUS_OFFSET UNITYSDK_OFFSET(0x15908F20)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x15908360)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x15908300)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK_ONDRAG_OFFSET UNITYSDK_OFFSET(0x159081C0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x15908070)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x159080F0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK_SPAWNED_OFFSET UNITYSDK_OFFSET(0x15908210)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK__CTOR_OFFSET UNITYSDK_OFFSET(0x159090F0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK__ENDJOYCAMERAOBSERVE_OFFSET UNITYSDK_OFFSET(0x15908140)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK__GETMOVEDIR_OFFSET UNITYSDK_OFFSET(0x15908840)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK__INITVIEW_OFFSET UNITYSDK_OFFSET(0x15908940)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK__INIT_OFFSET UNITYSDK_OFFSET(0x159082B0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK__SETNODEPOSBYSCREENPOS_OFFSET UNITYSDK_OFFSET(0x159083F0)

namespace RPG::Client::LittleGame::FiveDim
{
	inline static constexpr unsigned int MonoFiveDimCameraJoyStick_TypeDefinitionIndex = 70937;
