...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMGARBAGEBINVIEW_GETVIEWBOUND_OFFSET UNITYSDK_OFFSET(0x9A0F310)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMGARBAGEBINVIEW_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x9A0EC00)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMGARBAGEBINVIEW_METHOD_8_47EFDF992485ECD9_OFFSET UNITYSDK_OFFSET(0x9A0EE10)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMGARBAGEBINVIEW_METHOD_8_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0x9A0F450)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMGARBAGEBINVIEW_RELEASE_OFFSET UNITYSDK_OFFSET(0x9A0F0D0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMGARBAGEBINVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x9A0F580)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMGARBAGEBINVIEW___IFIXBASEPROXY_GETVIEWBOUND_OFFSET UNITYSDK_OFFSET(0x9A0F5E0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMGARBAGEBINVIEW___IFIXBASEPROXY_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x9A0F5C0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMGARBAGEBINVIEW___IFIXBASEPROXY_RELEASE_OFFSET UNITYSDK_OFFSET(0x9A0F5D0)

namespace RPG::Client::LittleGame::FiveDim
{
	inline static constexpr unsigned int FiveDimGarbageBinView_TypeDefinitionIndex = 62846;
