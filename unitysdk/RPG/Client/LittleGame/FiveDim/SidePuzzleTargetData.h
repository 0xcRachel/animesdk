...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_SIDEPUZZLETARGETDATA_CLEARDIRTY_OFFSET UNITYSDK_OFFSET(0x9A2BCB0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_SIDEPUZZLETARGETDATA_CREATE_1_OFFSET UNITYSDK_OFFSET(0x9A2BBE0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_SIDEPUZZLETARGETDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x9A2BB00)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_SIDEPUZZLETARGETDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0x9A2BF50)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_SIDEPUZZLETARGETDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x9A2BF80)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_SIDEPUZZLETARGETDATA_GET_NEEDSHOWPANEL_OFFSET UNITYSDK_OFFSET(0x9A2BFF0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_SIDEPUZZLETARGETDATA_GET_PROGRESSLIMIT_OFFSET UNITYSDK_OFFSET(0x9A2BFD0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_SIDEPUZZLETARGETDATA_GET_PROGRESS_OFFSET UNITYSDK_OFFSET(0x9A2BFB0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_SIDEPUZZLETARGETDATA_GET_PUZZLEID_OFFSET UNITYSDK_OFFSET(0x9A2BF30)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_SIDEPUZZLETARGETDATA_ISTRACKINGTARGET_OFFSET UNITYSDK_OFFSET(0x9A2BE70)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_SIDEPUZZLETARGETDATA_REFRESHPROGRESS_OFFSET UNITYSDK_OFFSET(0x9A2BCF0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_SIDEPUZZLETARGETDATA_SETPROGRESS_OFFSET UNITYSDK_OFFSET(0x9A2BC60)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_SIDEPUZZLETARGETDATA_SET_PROGRESS_OFFSET UNITYSDK_OFFSET(0x9A2BFC0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_SIDEPUZZLETARGETDATA_SET_PUZZLEID_OFFSET UNITYSDK_OFFSET(0x9A2BF40)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_SIDEPUZZLETARGETDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9A2BC50)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_SIDEPUZZLETARGETDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9A2BBA0)

namespace RPG::Client::LittleGame::FiveDim
{
	inline static constexpr unsigned int SidePuzzleTargetData_TypeDefinitionIndex = 62904;
