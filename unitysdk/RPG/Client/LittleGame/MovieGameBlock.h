...
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEBLOCK_GETCENTERPOSITION_OFFSET UNITYSDK_OFFSET(0x16532960)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEBLOCK_ONHIT_OFFSET UNITYSDK_OFFSET(0x165327F0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x16532A00)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEBLOCK___IFIXBASEPROXY_GETCENTERPOSITION_OFFSET UNITYSDK_OFFSET(0x16532BA0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEBLOCK___IFIXBASEPROXY_ONHIT_OFFSET UNITYSDK_OFFSET(0x16532A20)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int MovieGameBlock_TypeDefinitionIndex = 70360;
