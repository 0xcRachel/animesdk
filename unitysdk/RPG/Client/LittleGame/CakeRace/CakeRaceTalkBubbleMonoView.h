...
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACETALKBUBBLEMONOVIEW_AWAKE_OFFSET UNITYSDK_OFFSET(0x9997DE0)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACETALKBUBBLEMONOVIEW_FADEIN_OFFSET UNITYSDK_OFFSET(0x9997D70)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACETALKBUBBLEMONOVIEW_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9997E90)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACETALKBUBBLEMONOVIEW_SETTALKTEXTID_OFFSET UNITYSDK_OFFSET(0x9997D00)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACETALKBUBBLEMONOVIEW_SETTALKTEXT_OFFSET UNITYSDK_OFFSET(0x9997C50)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACETALKBUBBLEMONOVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0x9997F70)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACETALKBUBBLEMONOVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x9998160)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACETALKBUBBLEMONOVIEW__TRYCOMPLETEFADEOUT_OFFSET UNITYSDK_OFFSET(0x9997F10)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACETALKBUBBLEMONOVIEW__TRYFADEOUT_OFFSET UNITYSDK_OFFSET(0x9997FF0)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACETALKBUBBLEMONOVIEW___TRYFADEOUT_B__13_0_OFFSET UNITYSDK_OFFSET(0x9998170)

namespace RPG::Client::LittleGame::CakeRace
{
	inline static constexpr unsigned int CakeRaceTalkBubbleMonoView_TypeDefinitionIndex = 63616;
