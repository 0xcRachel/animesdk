...
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACETALKBUBBLEMONOVIEW_AWAKE_OFFSET UNITYSDK_OFFSET(0x9515570)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACETALKBUBBLEMONOVIEW_FADEIN_OFFSET UNITYSDK_OFFSET(0x9515500)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACETALKBUBBLEMONOVIEW_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9515620)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACETALKBUBBLEMONOVIEW_SETTALKTEXTID_OFFSET UNITYSDK_OFFSET(0x9515490)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACETALKBUBBLEMONOVIEW_SETTALKTEXT_OFFSET UNITYSDK_OFFSET(0x95153E0)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACETALKBUBBLEMONOVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0x9515700)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACETALKBUBBLEMONOVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x95158F0)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACETALKBUBBLEMONOVIEW__TRYCOMPLETEFADEOUT_OFFSET UNITYSDK_OFFSET(0x95156A0)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACETALKBUBBLEMONOVIEW__TRYFADEOUT_OFFSET UNITYSDK_OFFSET(0x9515780)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACETALKBUBBLEMONOVIEW___TRYFADEOUT_B__13_0_OFFSET UNITYSDK_OFFSET(0x9515900)

namespace RPG::Client::LittleGame::CakeRace
{
	inline static constexpr unsigned int CakeRaceTalkBubbleMonoView_TypeDefinitionIndex = 61429;
