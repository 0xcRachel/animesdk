...
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACETRAPMONOVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x15847110)

namespace RPG::Client::LittleGame::CakeRace
{
	inline static constexpr unsigned int CakeRaceTrapMonoView_TypeDefinitionIndex = 71657;
