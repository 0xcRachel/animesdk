...
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMESTATISTICCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x16157320)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int MovieGameStatisticComponent_TypeDefinitionIndex = 31936;
