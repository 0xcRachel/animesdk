...
#define RPG_CLIENT_LITTLEGAME_MATCH3ENERGYVIEWSTATEBUFFER_EXECUTESEQUENCE_OFFSET UNITYSDK_OFFSET(0x1652BF90)
#define RPG_CLIENT_LITTLEGAME_MATCH3ENERGYVIEWSTATEBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1652C080)
#define RPG_CLIENT_LITTLEGAME_MATCH3ENERGYVIEWSTATEBUFFER__ONSEQUENCEFINISH_OFFSET UNITYSDK_OFFSET(0x1652C030)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int Match3EnergyViewStateBuffer_TypeDefinitionIndex = 70328;

	class Match3EnergyViewStateBuffer : public ::System::Object
	{
	public:
		::System::Action* OnFinishIncrease; // 0x10
		::Class_0_16E4307DCC419505_341* CommandSequence; // 0x18
		::Class_0_16E4307DCC419505_341* IncreaseCommand; // 0x20
		::System::Func_2<::System::UInt32, ::Class_0_16E4307DCC419505_341*>* GenIncreaseCommand; // 0x28
