...
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPROP_GETCENTERPOSITION_OFFSET UNITYSDK_OFFSET(0x9A40940)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPROP_INITIALIZEVIEW_OFFSET UNITYSDK_OFFSET(0x9A450A0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPROP_ONHIT_OFFSET UNITYSDK_OFFSET(0x9A40730)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPROP_REGISTERLISTENERS_OFFSET UNITYSDK_OFFSET(0x9A45290)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPROP_RELEASEVIEW_OFFSET UNITYSDK_OFFSET(0x9A451A0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPROP_SAFESETACTIVE_OFFSET UNITYSDK_OFFSET(0x9A45240)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPROP_SETLOCALROTATION_OFFSET UNITYSDK_OFFSET(0x9A45380)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPROP_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x9A452F0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x9A40710)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPROP___IFIXBASEPROXY_GETCENTERPOSITION_OFFSET UNITYSDK_OFFSET(0x9A45400)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPROP___IFIXBASEPROXY_SAFESETACTIVE_OFFSET UNITYSDK_OFFSET(0x9A454D0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPROP___IFIXBASEPROXY_SETLOCALROTATION_OFFSET UNITYSDK_OFFSET(0x9A455A0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPROP___IFIXBASEPROXY_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x9A454E0)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int MovieGameProp_TypeDefinitionIndex = 62373;
