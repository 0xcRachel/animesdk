...
{
	inline static constexpr unsigned int SimpleViewService_1_AssetAsyncLoadHandle_TypeDefinitionIndex = 60315;
	...
	public:
		...
		::Class_0_16E4307DCC419505_76* _PostLoadInterface; // 0x0
