...
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRBACKGROUNDVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x188809B0)

namespace RPG::Client::LittleGame::PixAir
{
	inline static constexpr unsigned int PixAirBackgroundView_TypeDefinitionIndex = 71843;
