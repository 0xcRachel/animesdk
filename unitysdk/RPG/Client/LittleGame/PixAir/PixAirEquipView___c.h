...
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIREQUIPVIEW___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x188856E0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIREQUIPVIEW___C__CTOR_OFFSET UNITYSDK_OFFSET(0x18885720)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIREQUIPVIEW___C___FIREEFFECT_B__10_0_OFFSET UNITYSDK_OFFSET(0x18885730)

namespace RPG::Client::LittleGame::PixAir
{
	inline static constexpr unsigned int PixAirEquipView___c_TypeDefinitionIndex = 71845;
	...
	public:
		...
		{
			return (::System::Action_2<::RPG::Client::MonoEffect*, ::RPG::Client::TriggerEffectCallbackParams>**)Il2CppClass::FromTypeDefinitionIndex(PixAirEquipView___c_TypeDefinitionIndex)->GetStaticField(0x47620);
		}
		static ::RPG::Client::LittleGame::PixAir::PixAirEquipView___c** StaticGet___9()
		{
			return (::RPG::Client::LittleGame::PixAir::PixAirEquipView___c**)Il2CppClass::FromTypeDefinitionIndex(PixAirEquipView___c_TypeDefinitionIndex)->GetStaticField(0x47628);
		}
