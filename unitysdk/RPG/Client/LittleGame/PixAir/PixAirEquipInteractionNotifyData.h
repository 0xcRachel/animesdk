...
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIREQUIPINTERACTIONNOTIFYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x188848A0)

namespace RPG::Client::LittleGame::PixAir
{
	inline static constexpr unsigned int PixAirEquipInteractionNotifyData_TypeDefinitionIndex = 71813;
	...
	public:
		...
		::System::Int32 ToEquipRuntimeUniqueID; // 0x18
