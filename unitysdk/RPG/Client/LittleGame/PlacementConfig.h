...
#define RPG_CLIENT_LITTLEGAME_PLACEMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x161572F0)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int PlacementConfig_TypeDefinitionIndex = 31873;
