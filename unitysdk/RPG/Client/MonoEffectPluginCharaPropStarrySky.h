...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPSTARRYSKY_INIT_OFFSET UNITYSDK_OFFSET(0x97EC030)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPSTARRYSKY_UNINIT_OFFSET UNITYSDK_OFFSET(0x97ED160)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPSTARRYSKY_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x97EC0D0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPSTARRYSKY__CTOR_OFFSET UNITYSDK_OFFSET(0x97ED270)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPSTARRYSKY___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x97ED290)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropStarrySky_TypeDefinitionIndex = 55692;
