...
#define RPG_CLIENT_EVOLVEBUILDUTILS___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0x91AA4D0)
#define RPG_CLIENT_EVOLVEBUILDUTILS___C__DISPLAYCLASS2_0__SORTWEAPONLIST_B__0_OFFSET UNITYSDK_OFFSET(0x91ACFD0)

namespace RPG::Client
{
	inline static constexpr unsigned int EvolveBuildUtils___c__DisplayClass2_0_TypeDefinitionIndex = 50728;
