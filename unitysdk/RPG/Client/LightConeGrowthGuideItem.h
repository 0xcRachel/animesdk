...
#define RPG_CLIENT_LIGHTCONEGROWTHGUIDEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x95057A0)

namespace RPG::Client
{
	inline static constexpr unsigned int LightConeGrowthGuideItem_TypeDefinitionIndex = 52090;
