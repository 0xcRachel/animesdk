...
#define RPG_CLIENT_ENTITYTIMELINECONTROLTRACKINFO_METHOD_1_6B72D4EE8C6E907F_OFFSET UNITYSDK_OFFSET(0x9165860)
#define RPG_CLIENT_ENTITYTIMELINECONTROLTRACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x9165A00)

namespace RPG::Client
{
	inline static constexpr unsigned int EntityTimelineControlTrackInfo_TypeDefinitionIndex = 50682;
