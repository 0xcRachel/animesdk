...
#define RPG_CLIENT_MATERIALSWITCHMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x96E4CF0)

namespace RPG::Client
{
	inline static constexpr unsigned int MaterialSwitchMonoPlugin_TypeDefinitionIndex = 56355;
