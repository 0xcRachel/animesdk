...
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0x8FB7570)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_0076C796B2045359_OFFSET UNITYSDK_OFFSET(0x8FB5780)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_0A1EBDC04FF09910_OFFSET UNITYSDK_OFFSET(0x8FBA520)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_0FD0EC313FAAB75A_OFFSET UNITYSDK_OFFSET(0x8FB7C30)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x8FB7E80)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_1F3793A40D6D0F7F_OFFSET UNITYSDK_OFFSET(0x8FB6480)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_22AFCF77865E9802_OFFSET UNITYSDK_OFFSET(0x8FBAB60)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x8FB7E40)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x8FB7D80)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0x8FB7DE0)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x8FB7BD0)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0x8FBAD10)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_5790A55946AA509D_2_OFFSET UNITYSDK_OFFSET(0x8FBAD70)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_5790A55946AA509D_3_OFFSET UNITYSDK_OFFSET(0x8FBADD0)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_5790A55946AA509D_4_OFFSET UNITYSDK_OFFSET(0x8FBAE30)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_5790A55946AA509D_5_OFFSET UNITYSDK_OFFSET(0x8FBAE90)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_5790A55946AA509D_6_OFFSET UNITYSDK_OFFSET(0x8FBAF60)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x8FBACB0)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_6D93101E4CE10A96_OFFSET UNITYSDK_OFFSET(0x8FB56D0)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_825CC99DD653DEE0_OFFSET UNITYSDK_OFFSET(0x8FB5910)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_8F7825DAFFB9B517_OFFSET UNITYSDK_OFFSET(0x8FB8700)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_A21BBA85D4EF7B41_OFFSET UNITYSDK_OFFSET(0x8FB88B0)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_AF7DB9C9316245A8_OFFSET UNITYSDK_OFFSET(0x8FBA2F0)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_B1EA412ACAE87C15_OFFSET UNITYSDK_OFFSET(0x8FB61A0)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_DBA8CB09BF007EAD_OFFSET UNITYSDK_OFFSET(0x8FBA490)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_F0E307B84478A272_OFFSET UNITYSDK_OFFSET(0x8FBAEF0)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_F63FE1AA9633F811_OFFSET UNITYSDK_OFFSET(0x8FB8D30)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0x8FB7F60)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x8FBAC90)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x8FBAC70)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x8FBAFC0)

namespace RPG::Client
{
	inline static constexpr unsigned int ComicDialogEmitterBehavior_TypeDefinitionIndex = 56480;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ComicDialogEmitterBehavior_TypeDefinitionIndex)->GetStaticField(0xF7A0);
		}
		...
		::System::Collections::Generic::List_1<::RPG::Client::ComicDialogEmitterBehavior_Struct_2_F7C243F317D8E44A_2>* _SimulateAgents; // 0x38
		::System::Int32 _CurrentIndex; // 0x40
		::System::Single _Timer; // 0x44
		::System::Int32 _StaticEmojiCounter; // 0x48
		::System::Int32 _TextCounter; // 0x4C
		::System::Int32 _BackboardCounter; // 0x50
		::UnityEngine::MaterialPropertyBlock* _TextMPB; // 0x58
		::UnityEngine::MaterialPropertyBlock* _BackboardMPB; // 0x60
		::Il2CppArray<::UnityEngine::Matrix4x4>* _TextMatrixList; // 0x68
		::Il2CppArray<::UnityEngine::Matrix4x4>* _BackboardMatrixList; // 0x70
		::Il2CppArray<::UnityEngine::Vector4>* _TextCustomDatas; // 0x78
		::Il2CppArray<::UnityEngine::Vector4>* _BackboardCustomDatas; // 0x80
		::Il2CppArray<::System::Boolean>* _DialogDisplayBuffer; // 0x88
		::UnityEngine::Vector3 _CameraPos; // 0x90
		::TMPro::TMP_FontAsset* _FontAsset; // 0xA0
		::System::Boolean _IfPreviewAudio; // 0xA8
		::UnityEngine::Vector3 _PlayerPos; // 0xAC
		::UnityEngine::Bounds _PatternBounds; // 0xB8
