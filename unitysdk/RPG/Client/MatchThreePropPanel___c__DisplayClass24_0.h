...
#define RPG_CLIENT_MATCHTHREEPROPPANEL___C__DISPLAYCLASS24_0__CTOR_OFFSET UNITYSDK_OFFSET(0x96741F0)
#define RPG_CLIENT_MATCHTHREEPROPPANEL___C__DISPLAYCLASS24_0__SETUPVIEW_B__2_OFFSET UNITYSDK_OFFSET(0x9674400)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreePropPanel___c__DisplayClass24_0_TypeDefinitionIndex = 52456;
