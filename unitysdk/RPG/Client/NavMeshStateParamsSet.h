...
#define RPG_CLIENT_NAVMESHSTATEPARAMSSET__CTOR_OFFSET UNITYSDK_OFFSET(0x99A0C90)

namespace RPG::Client
{
	inline static constexpr unsigned int NavMeshStateParamsSet_TypeDefinitionIndex = 54500;
