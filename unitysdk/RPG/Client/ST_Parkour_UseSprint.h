...
#define RPG_CLIENT_ST_PARKOUR_USESPRINT_METHOD_4_A1E03D6FBE224B76_OFFSET UNITYSDK_OFFSET(0x16EA1E80)
#define RPG_CLIENT_ST_PARKOUR_USESPRINT_METHOD_4_D0C6D4B0CB443A76_OFFSET UNITYSDK_OFFSET(0x16EA1F50)
#define RPG_CLIENT_ST_PARKOUR_USESPRINT__CTOR_OFFSET UNITYSDK_OFFSET(0x16EA1F00)
