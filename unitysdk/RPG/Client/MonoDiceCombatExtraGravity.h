...
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY_AWAKE_OFFSET UNITYSDK_OFFSET(0x9795A60)
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x9795CA0)
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY_METHOD_5_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x9796250)
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY_METHOD_5_CA20A96113B135EC_OFFSET UNITYSDK_OFFSET(0x97963B0)
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY_METHOD_5_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0x9796690)
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x9796680)
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x97962D0)
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY_START_OFFSET UNITYSDK_OFFSET(0x9795B80)
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY__CTOR_OFFSET UNITYSDK_OFFSET(0x97966A0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoDiceCombatExtraGravity_TypeDefinitionIndex = 50479;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::String*))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY_METHOD_5_CA20A96113B135EC_OFFSET))(this, a1);
		}
