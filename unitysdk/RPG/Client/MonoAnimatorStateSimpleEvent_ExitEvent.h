...
#define RPG_CLIENT_MONOANIMATORSTATESIMPLEEVENT_EXITEVENT_METHOD_2_183DCE814B2CC19A_OFFSET UNITYSDK_OFFSET(0x152BB9E0)
#define RPG_CLIENT_MONOANIMATORSTATESIMPLEEVENT_EXITEVENT_METHOD_2_23F4864AF47CFD90_OFFSET UNITYSDK_OFFSET(0x152BB8D0)
#define RPG_CLIENT_MONOANIMATORSTATESIMPLEEVENT_EXITEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x152BBAE0)
