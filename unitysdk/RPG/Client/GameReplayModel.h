...
#define RPG_CLIENT_GAMEREPLAYMODEL_METHOD_1_09628151A51CB453_OFFSET UNITYSDK_OFFSET(0x92FDED0)
#define RPG_CLIENT_GAMEREPLAYMODEL_METHOD_1_2000EF9DF943AC87_OFFSET UNITYSDK_OFFSET(0x92FE010)
#define RPG_CLIENT_GAMEREPLAYMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x92FE190)

namespace RPG::Client
{
	inline static constexpr unsigned int GameReplayModel_TypeDefinitionIndex = 48346;
