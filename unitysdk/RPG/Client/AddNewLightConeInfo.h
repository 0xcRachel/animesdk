...
#define RPG_CLIENT_ADDNEWLIGHTCONEINFO_CREATEADDNEWLIGHTCONEINFO_OFFSET UNITYSDK_OFFSET(0x8BDCF20)
#define RPG_CLIENT_ADDNEWLIGHTCONEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x8BDD270)

namespace RPG::Client
{
	inline static constexpr unsigned int AddNewLightConeInfo_TypeDefinitionIndex = 52205;
