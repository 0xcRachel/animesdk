...
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_CREATE_OFFSET UNITYSDK_OFFSET(0x9693860)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_GET_EFFECTDESC_OFFSET UNITYSDK_OFFSET(0x96943F0)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_GET_EXTRAEFFECTIDS_OFFSET UNITYSDK_OFFSET(0x9694500)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_GET_IDFORSORT_OFFSET UNITYSDK_OFFSET(0x9694270)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0x9694280)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_GET_RARITY_OFFSET UNITYSDK_OFFSET(0x9694350)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_GET_REIJUAFFIXID_OFFSET UNITYSDK_OFFSET(0x9694250)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_GET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0x9694260)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0x9694030)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_SYNC_OFFSET UNITYSDK_OFFSET(0x9693DA0)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9694020)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM__GETTEXTPARAMLIST_OFFSET UNITYSDK_OFFSET(0x9694090)
