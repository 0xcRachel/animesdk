...
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_CREATE_OFFSET UNITYSDK_OFFSET(0x91E5360)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_GET_EFFECTDESC_OFFSET UNITYSDK_OFFSET(0x921E460)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_GET_EXTRAEFFECTIDS_OFFSET UNITYSDK_OFFSET(0x921E5D0)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_GET_IDFORSORT_OFFSET UNITYSDK_OFFSET(0x921E280)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0x921E290)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_GET_RARITY_OFFSET UNITYSDK_OFFSET(0x921E3C0)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_GET_REIJUAFFIXID_OFFSET UNITYSDK_OFFSET(0x91E5C80)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_GET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0x921E270)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0x921E360)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_SYNC_OFFSET UNITYSDK_OFFSET(0x91E58A0)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x91E5B20)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM__GETTEXTPARAMLIST_OFFSET UNITYSDK_OFFSET(0x91E5B30)

namespace RPG::Client
{
	inline static constexpr unsigned int FateGameMasterReijuAffixInfoItem_TypeDefinitionIndex = 50877;
