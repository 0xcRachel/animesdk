...
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_CREATE_OFFSET UNITYSDK_OFFSET(0x1790C940)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_GET_EFFECTDESC_OFFSET UNITYSDK_OFFSET(0x1790D4D0)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_GET_EXTRAEFFECTIDS_OFFSET UNITYSDK_OFFSET(0x1790D5E0)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_GET_IDFORSORT_OFFSET UNITYSDK_OFFSET(0x1790D350)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1790D360)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_GET_RARITY_OFFSET UNITYSDK_OFFSET(0x1790D430)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_GET_REIJUAFFIXID_OFFSET UNITYSDK_OFFSET(0x1790D330)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_GET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0x1790D340)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0x1790D110)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_SYNC_OFFSET UNITYSDK_OFFSET(0x1790CE80)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1790D100)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM__GETTEXTPARAMLIST_OFFSET UNITYSDK_OFFSET(0x1790D170)
