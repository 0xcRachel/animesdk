...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_GET_BOSSSCORE_OFFSET UNITYSDK_OFFSET(0xA267790)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_INIT_OFFSET UNITYSDK_OFFSET(0xA266EB0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_ISBOOMABLE_OFFSET UNITYSDK_OFFSET(0xA2671F0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_ISHITTABLE_OFFSET UNITYSDK_OFFSET(0xA267140)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_KILL_OFFSET UNITYSDK_OFFSET(0xA266DC0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0xA266E50)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_3DFE7A801EF34CFC_OFFSET UNITYSDK_OFFSET(0xA267890)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_41CF9B9431532A25_OFFSET UNITYSDK_OFFSET(0xA267670)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_56A28EFF6A9CC5BA_1_OFFSET UNITYSDK_OFFSET(0xA267A20)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_56A28EFF6A9CC5BA_OFFSET UNITYSDK_OFFSET(0xA2679D0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_69225B22C8D30B3E_OFFSET UNITYSDK_OFFSET(0xA267A70)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_775B6D644F07B554_OFFSET UNITYSDK_OFFSET(0xA2678A0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_A86A455D6AB5B836_1_OFFSET UNITYSDK_OFFSET(0xA267620)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_A86A455D6AB5B836_OFFSET UNITYSDK_OFFSET(0xA2675D0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_AD23FDCC7576BB32_OFFSET UNITYSDK_OFFSET(0xA266F50)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0xA267030)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_F0BD65B017F2AC0B_OFFSET UNITYSDK_OFFSET(0xA267A80)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_ONHIT_OFFSET UNITYSDK_OFFSET(0xA267280)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_SET_BOSSSCORE_OFFSET UNITYSDK_OFFSET(0xA2677A0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS__CTOR_OFFSET UNITYSDK_OFFSET(0xA2677B0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0xA267880)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS___IFIXBASEPROXY_ISBOOMABLE_OFFSET UNITYSDK_OFFSET(0xA267920)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS___IFIXBASEPROXY_ISHITTABLE_OFFSET UNITYSDK_OFFSET(0xA2678B0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS___IFIXBASEPROXY_ONHIT_OFFSET UNITYSDK_OFFSET(0xA267990)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayTarget_Boss_TypeDefinitionIndex = 54561;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_B09E78EE7EE4F8FA_OFFSET))(this);
		}
		...
		::System::Void Method_6_41CF9B9431532A25()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_41CF9B9431532A25_OFFSET))(this);
		}
		...
		::System::Void Method_6_3DFE7A801EF34CFC(::System::Single P0)
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_3DFE7A801EF34CFC_OFFSET))(this, P0);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_F0BD65B017F2AC0B_OFFSET))(this);
		}
	};
}
