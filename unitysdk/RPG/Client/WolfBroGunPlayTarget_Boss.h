...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_GET_BOSSSCORE_OFFSET UNITYSDK_OFFSET(0x11E5CBD0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_INIT_OFFSET UNITYSDK_OFFSET(0x11E5C2C0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_ISBOOMABLE_OFFSET UNITYSDK_OFFSET(0x11E5C630)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_ISHITTABLE_OFFSET UNITYSDK_OFFSET(0x11E5C580)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_KILL_OFFSET UNITYSDK_OFFSET(0x11E5C1D0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0x11E5C260)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_56A28EFF6A9CC5BA_1_OFFSET UNITYSDK_OFFSET(0x11E5CEC0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_56A28EFF6A9CC5BA_OFFSET UNITYSDK_OFFSET(0x11E5CE70)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_69225B22C8D30B3E_OFFSET UNITYSDK_OFFSET(0x11E5CF10)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_775B6D644F07B554_1_OFFSET UNITYSDK_OFFSET(0x11E5CF20)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_775B6D644F07B554_OFFSET UNITYSDK_OFFSET(0x11E5CD40)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_A86A455D6AB5B836_1_OFFSET UNITYSDK_OFFSET(0x11E5CA30)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_A86A455D6AB5B836_OFFSET UNITYSDK_OFFSET(0x11E5C9E0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_AD23FDCC7576BB32_OFFSET UNITYSDK_OFFSET(0x11E5C360)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_B961D33AD47A2113_OFFSET UNITYSDK_OFFSET(0x11E5CA80)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_BEC0C6D1D2906F45_OFFSET UNITYSDK_OFFSET(0x11E5CD30)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0x11E5C440)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_ONHIT_OFFSET UNITYSDK_OFFSET(0x11E5C6C0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_SET_BOSSSCORE_OFFSET UNITYSDK_OFFSET(0x11E5CBE0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS__CTOR_OFFSET UNITYSDK_OFFSET(0x11E5CBF0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x11E5CD20)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS___IFIXBASEPROXY_ISBOOMABLE_OFFSET UNITYSDK_OFFSET(0x11E5CDC0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS___IFIXBASEPROXY_ISHITTABLE_OFFSET UNITYSDK_OFFSET(0x11E5CD50)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS___IFIXBASEPROXY_ONHIT_OFFSET UNITYSDK_OFFSET(0x11E5CE30)
