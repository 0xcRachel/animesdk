...
#define RPG_CLIENT_TREASURECHALLENGESETTLEMENT_CREATESETTLEMENT_OFFSET UNITYSDK_OFFSET(0x16840450)
#define RPG_CLIENT_TREASURECHALLENGESETTLEMENT_GET_EXTENSIONDATA_OFFSET UNITYSDK_OFFSET(0x16840920)
#define RPG_CLIENT_TREASURECHALLENGESETTLEMENT_SET_EXTENSIONDATA_OFFSET UNITYSDK_OFFSET(0x16840930)
#define RPG_CLIENT_TREASURECHALLENGESETTLEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x16840710)
#define RPG_CLIENT_TREASURECHALLENGESETTLEMENT__TRYCREATEEXTENSIONDATA_OFFSET UNITYSDK_OFFSET(0x168407F0)
...
namespace RPG::Client
{
	...
	public:
		...
		static ::RPG::Client::TreasureChallengeSettlement* CreateSettlement(::Class_1_BB4B99DE4C2501EC_10* ntf)
		{
			return ((::RPG::Client::TreasureChallengeSettlement*(*)(::Class_1_BB4B99DE4C2501EC_10*))((::PBYTE)hIl2Cpp + RPG_CLIENT_TREASURECHALLENGESETTLEMENT_CREATESETTLEMENT_OFFSET))(ntf);
		}

		::System::Void _TryCreateExtensionData(::Class_1_BB4B99DE4C2501EC_10* ntf)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_BB4B99DE4C2501EC_10*))((::PBYTE)hIl2Cpp + RPG_CLIENT_TREASURECHALLENGESETTLEMENT__TRYCREATEEXTENSIONDATA_OFFSET))(this, ntf);
		}
