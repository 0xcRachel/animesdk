...
#define RPG_CLIENT_RECHARGESHOPSTATIC_COLLECTANDSORTITEMS_OFFSET UNITYSDK_OFFSET(0xA294DA0)
#define RPG_CLIENT_RECHARGESHOPSTATIC_GET_PRODUCTGIFTTYPEOFDISCOUNTEDDOZENPASSESGIFT_OFFSET UNITYSDK_OFFSET(0xA298B00)
#define RPG_CLIENT_RECHARGESHOPSTATIC_GET_PRODUCTGIFTTYPEOFDISCOUNTEDOUTFITGIFT_OFFSET UNITYSDK_OFFSET(0xA298B40)
#define RPG_CLIENT_RECHARGESHOPSTATIC_GET_PRODUCTGIFTTYPEOFDISCOUNTEDPACKEDGIFT_OFFSET UNITYSDK_OFFSET(0xA298AC0)
#define RPG_CLIENT_RECHARGESHOPSTATIC_GET_PRODUCTGIFTTYPEOFDISCOUNTEDSINGLEGIFT_OFFSET UNITYSDK_OFFSET(0xA298A80)
#define RPG_CLIENT_RECHARGESHOPSTATIC_GET_UINTGIFTTYPEOFDISCOUNTEDDOZENPASSESGIFT_OFFSET UNITYSDK_OFFSET(0xA298B10)
#define RPG_CLIENT_RECHARGESHOPSTATIC_GET_UINTGIFTTYPEOFDISCOUNTEDOUTFITGIFT_OFFSET UNITYSDK_OFFSET(0xA298B50)
#define RPG_CLIENT_RECHARGESHOPSTATIC_GET_UINTGIFTTYPEOFDISCOUNTEDPACKEDGIFT_OFFSET UNITYSDK_OFFSET(0xA298AD0)
#define RPG_CLIENT_RECHARGESHOPSTATIC_GET_UINTGIFTTYPEOFDISCOUNTEDSINGLEGIFT_OFFSET UNITYSDK_OFFSET(0xA298A90)
#define RPG_CLIENT_RECHARGESHOPSTATIC_ISGIFTBANNED_OFFSET UNITYSDK_OFFSET(0xA293EF0)
#define RPG_CLIENT_RECHARGESHOPSTATIC_TRYGETPRODUCTGIFTTYPE_OFFSET UNITYSDK_OFFSET(0xA296F10)
#define RPG_CLIENT_RECHARGESHOPSTATIC__CCTOR_OFFSET UNITYSDK_OFFSET(0xA298B80)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Enum_3_7CED31C413C530F0>**)Il2CppClass::FromTypeDefinitionIndex(RechargeShopStatic_TypeDefinitionIndex)->GetStaticField(0x14330);
		}
