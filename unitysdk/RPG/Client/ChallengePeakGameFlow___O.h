...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Func_2<::RPG::Client::BaseGameFlow*, ::RPG::Client::BaseGameFlowContext*>**)Il2CppClass::FromTypeDefinitionIndex(ChallengePeakGameFlow___O_TypeDefinitionIndex)->GetStaticField(0x67510);
		}
	};
}
