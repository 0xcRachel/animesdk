...
#define RPG_CLIENT_MONOEFFECTPLUGINBGCURVE_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0x97C2D60)
#define RPG_CLIENT_MONOEFFECTPLUGINBGCURVE_METHOD_6_B040ACE7C5CABF47_OFFSET UNITYSDK_OFFSET(0x97C2E70)
#define RPG_CLIENT_MONOEFFECTPLUGINBGCURVE_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0x97C2D10)
#define RPG_CLIENT_MONOEFFECTPLUGINBGCURVE_SETUP_1_OFFSET UNITYSDK_OFFSET(0x97C39A0)
#define RPG_CLIENT_MONOEFFECTPLUGINBGCURVE_SETUP_2_OFFSET UNITYSDK_OFFSET(0x97C3BF0)
#define RPG_CLIENT_MONOEFFECTPLUGINBGCURVE_SETUP_OFFSET UNITYSDK_OFFSET(0x97C2DA0)
#define RPG_CLIENT_MONOEFFECTPLUGINBGCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x97C3DB0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginBGCurve_TypeDefinitionIndex = 55743;
	...
	public:
		...
		::System::Void Method_6_B040ACE7C5CABF47(::System::Collections::Generic::IEnumerable_1<::RPG::GameCore::LevelCurvePointInfo*>* a1)
		{
			return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::IEnumerable_1<::RPG::GameCore::LevelCurvePointInfo*>*))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOEFFECTPLUGINBGCURVE_METHOD_6_B040ACE7C5CABF47_OFFSET))(this, a1);
		}
	};
}
