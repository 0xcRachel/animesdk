...
#define RPG_CLIENT_FIVEDIMMODULE___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x16BBCE00)
#define RPG_CLIENT_FIVEDIMMODULE___C__CTOR_OFFSET UNITYSDK_OFFSET(0x15939F40)
#define RPG_CLIENT_FIVEDIMMODULE___C__ONENTERGAME_B__162_0_OFFSET UNITYSDK_OFFSET(0x15939F50)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::RPG::Client::FiveDimModule___c**)Il2CppClass::FromTypeDefinitionIndex(FiveDimModule___c_TypeDefinitionIndex)->GetStaticField(0x1B7A0);
		}
		static ::System::Action** StaticGet___9__162_0()
		{
			return (::System::Action**)Il2CppClass::FromTypeDefinitionIndex(FiveDimModule___c_TypeDefinitionIndex)->GetStaticField(0x1B7A8);
		}
