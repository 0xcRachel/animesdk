...
#define RPG_CLIENT_TAROTBOOKCATALOGLUAPANELPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x16992500)

namespace RPG::Client
{
	inline static constexpr unsigned int TarotBookCatalogLuaPanelParam_TypeDefinitionIndex = 66766;

	class TarotBookCatalogLuaPanelParam : public ::RPG::Client::BookletLuaPanelParam
	{
	public:
		::System::Int32 EndIndex; // 0x30
		::System::Int32 BeginIndex; // 0x34
