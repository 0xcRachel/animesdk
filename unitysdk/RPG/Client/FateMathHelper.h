...
#define RPG_CLIENT_FATEMATHHELPER_FIXPOINT2PERCENTAGEINT_OFFSET UNITYSDK_OFFSET(0x922CEC0)

namespace RPG::Client
{
	inline static constexpr unsigned int FateMathHelper_TypeDefinitionIndex = 50807;
