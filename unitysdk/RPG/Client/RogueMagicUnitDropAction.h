...
#define RPG_CLIENT_ROGUEMAGICUNITDROPACTION_GETROGUEACTIONID_OFFSET UNITYSDK_OFFSET(0x9E1DEB0)
#define RPG_CLIENT_ROGUEMAGICUNITDROPACTION_GETUIPATH_OFFSET UNITYSDK_OFFSET(0x9E1DF40)
#define RPG_CLIENT_ROGUEMAGICUNITDROPACTION_GET_HINTID_OFFSET UNITYSDK_OFFSET(0x9E1DB00)
#define RPG_CLIENT_ROGUEMAGICUNITDROPACTION_GET_ROGUEACTIONID_OFFSET UNITYSDK_OFFSET(0x9E1DAC0)
#define RPG_CLIENT_ROGUEMAGICUNITDROPACTION_GET_SELECTUNITS_OFFSET UNITYSDK_OFFSET(0x9E1DAE0)
#define RPG_CLIENT_ROGUEMAGICUNITDROPACTION_SET_HINTID_OFFSET UNITYSDK_OFFSET(0x9E1DB10)
#define RPG_CLIENT_ROGUEMAGICUNITDROPACTION_SET_ROGUEACTIONID_OFFSET UNITYSDK_OFFSET(0x9E1DAD0)
#define RPG_CLIENT_ROGUEMAGICUNITDROPACTION_SET_SELECTUNITS_OFFSET UNITYSDK_OFFSET(0x9E1DAF0)
#define RPG_CLIENT_ROGUEMAGICUNITDROPACTION_TRIGGERACTION_OFFSET UNITYSDK_OFFSET(0x9E1DEF0)
#define RPG_CLIENT_ROGUEMAGICUNITDROPACTION__CONSTRUCT_OFFSET UNITYSDK_OFFSET(0x9E1DB30)
#define RPG_CLIENT_ROGUEMAGICUNITDROPACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x9E1DB20)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueMagicUnitDropAction_TypeDefinitionIndex = 53370;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::UInt32, ::Class_1_5FEFAED860528596_81*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ROGUEMAGICUNITDROPACTION__CTOR_OFFSET))(this, actionID, proto);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_5FEFAED860528596_81*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ROGUEMAGICUNITDROPACTION__CONSTRUCT_OFFSET))(this, proto);
		}
	};
}
