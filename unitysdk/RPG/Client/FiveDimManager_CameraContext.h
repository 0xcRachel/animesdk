...
#define RPG_CLIENT_FIVEDIMMANAGER_CAMERACONTEXT_CLEAR_OFFSET UNITYSDK_OFFSET(0x16BB2810)
#define RPG_CLIENT_FIVEDIMMANAGER_CAMERACONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x16BB2860)
...
namespace RPG::Client
{
	...
	public:
		...
		::RPG::GameCore::FiveDimVCameraBlendConfig* InBlend; // 0x18
