...
#define RPG_CLIENT_FIVEDIMMANAGER_CAMERACONTEXT_CLEAR_OFFSET UNITYSDK_OFFSET(0x92830F0)
#define RPG_CLIENT_FIVEDIMMANAGER_CAMERACONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9283140)

namespace RPG::Client
{
	inline static constexpr unsigned int FiveDimManager_CameraContext_TypeDefinitionIndex = 47944;
