...
#define RPG_CLIENT_BOUNDSCOPYTOOLMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x8DFF400)

namespace RPG::Client
{
	inline static constexpr unsigned int BoundsCopyToolMonoPlugin_TypeDefinitionIndex = 56593;
