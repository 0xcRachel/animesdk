...
#define RPG_CLIENT_AUDIENCELAYOUTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x8CA62C0)

namespace RPG::Client
{
	inline static constexpr unsigned int AudienceLayoutConfig_TypeDefinitionIndex = 54945;
