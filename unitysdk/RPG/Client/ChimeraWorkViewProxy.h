...
#define RPG_CLIENT_CHIMERAWORKVIEWPROXY_POSTEVENT_OFFSET UNITYSDK_OFFSET(0x8F47850)
#define RPG_CLIENT_CHIMERAWORKVIEWPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x8F47C20)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraWorkViewProxy_TypeDefinitionIndex = 54511;
