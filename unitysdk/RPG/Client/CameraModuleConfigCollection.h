...
#define RPG_CLIENT_CAMERAMODULECONFIGCOLLECTION_METHOD_3_44A52BAABCFE5A85_OFFSET UNITYSDK_OFFSET(0x18FBA340)
#define RPG_CLIENT_CAMERAMODULECONFIGCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18FBA440)
