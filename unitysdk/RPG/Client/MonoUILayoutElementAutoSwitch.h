...
#define RPG_CLIENT_MONOUILAYOUTELEMENTAUTOSWITCH_AWAKE_OFFSET UNITYSDK_OFFSET(0x9876D30)
#define RPG_CLIENT_MONOUILAYOUTELEMENTAUTOSWITCH_METHOD_6_E68E5CBD27DBE1A9_OFFSET UNITYSDK_OFFSET(0x9876DB0)
#define RPG_CLIENT_MONOUILAYOUTELEMENTAUTOSWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x9876F30)
#define RPG_CLIENT_MONOUILAYOUTELEMENTAUTOSWITCH___IFIXBASEPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0x9876FD0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoUILayoutElementAutoSwitch_TypeDefinitionIndex = 57885;
