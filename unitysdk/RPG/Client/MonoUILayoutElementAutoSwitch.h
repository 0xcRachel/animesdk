...
#define RPG_CLIENT_MONOUILAYOUTELEMENTAUTOSWITCH_AWAKE_OFFSET UNITYSDK_OFFSET(0x9D59340)
#define RPG_CLIENT_MONOUILAYOUTELEMENTAUTOSWITCH_METHOD_6_E68E5CBD27DBE1A9_OFFSET UNITYSDK_OFFSET(0x9D593C0)
#define RPG_CLIENT_MONOUILAYOUTELEMENTAUTOSWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x9D59540)
#define RPG_CLIENT_MONOUILAYOUTELEMENTAUTOSWITCH___IFIXBASEPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0x9D595E0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoUILayoutElementAutoSwitch_TypeDefinitionIndex = 59513;
