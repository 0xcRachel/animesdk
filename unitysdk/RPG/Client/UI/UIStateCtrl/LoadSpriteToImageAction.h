...
#define RPG_CLIENT_UI_UISTATECTRL_LOADSPRITETOIMAGEACTION_METHOD_3_7E9C4D81D04C3024_OFFSET UNITYSDK_OFFSET(0xA657FC0)
#define RPG_CLIENT_UI_UISTATECTRL_LOADSPRITETOIMAGEACTION_METHOD_3_7EDE9E9E9F847110_OFFSET UNITYSDK_OFFSET(0xA6582E0)
#define RPG_CLIENT_UI_UISTATECTRL_LOADSPRITETOIMAGEACTION_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA658550)
#define RPG_CLIENT_UI_UISTATECTRL_LOADSPRITETOIMAGEACTION_METHOD_3_E068A59BAB9D06D1_OFFSET UNITYSDK_OFFSET(0xA658110)
#define RPG_CLIENT_UI_UISTATECTRL_LOADSPRITETOIMAGEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xA658490)

namespace RPG::Client::UI::UIStateCtrl
{
	inline static constexpr unsigned int LoadSpriteToImageAction_TypeDefinitionIndex = 60719;
