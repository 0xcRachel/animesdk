...
#define RPG_CLIENT_UI_UISTATECTRL_ASYNCACTION_GET_CURRENTCOSTTIME_OFFSET UNITYSDK_OFFSET(0x138DB7D0)
#define RPG_CLIENT_UI_UISTATECTRL_ASYNCACTION_METHOD_2_16480B1867AF51ED_OFFSET UNITYSDK_OFFSET(0x138DB370)
#define RPG_CLIENT_UI_UISTATECTRL_ASYNCACTION_METHOD_2_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x138DB790)
#define RPG_CLIENT_UI_UISTATECTRL_ASYNCACTION_METHOD_2_39590AB2089F9F4D_OFFSET UNITYSDK_OFFSET(0x138DB530)
#define RPG_CLIENT_UI_UISTATECTRL_ASYNCACTION_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x138DB450)
#define RPG_CLIENT_UI_UISTATECTRL_ASYNCACTION_METHOD_2_45CCDE687DEEF3B6_OFFSET UNITYSDK_OFFSET(0x138DB670)
#define RPG_CLIENT_UI_UISTATECTRL_ASYNCACTION_METHOD_2_9906DCA5239E8E32_OFFSET UNITYSDK_OFFSET(0x138DB810)
#define RPG_CLIENT_UI_UISTATECTRL_ASYNCACTION_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x138DB610)
#define RPG_CLIENT_UI_UISTATECTRL_ASYNCACTION_SET_CURRENTCOSTTIME_OFFSET UNITYSDK_OFFSET(0x138DB7E0)
#define RPG_CLIENT_UI_UISTATECTRL_ASYNCACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x138DB7F0)

namespace RPG::Client::UI::UIStateCtrl
{
	inline static constexpr unsigned int AsyncAction_TypeDefinitionIndex = 68173;
