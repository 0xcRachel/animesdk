...
#define RPG_CLIENT_UI_UISTATECTRL_STATEDATA_GET_OWNERUISTATECTRL_OFFSET UNITYSDK_OFFSET(0x138DE950)
#define RPG_CLIENT_UI_UISTATECTRL_STATEDATA_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x138DE4C0)
#define RPG_CLIENT_UI_UISTATECTRL_STATEDATA_METHOD_1_30615810974CEB89_OFFSET UNITYSDK_OFFSET(0x138DE890)
#define RPG_CLIENT_UI_UISTATECTRL_STATEDATA_METHOD_1_57CD51AAF699439D_OFFSET UNITYSDK_OFFSET(0x138DDFE0)
#define RPG_CLIENT_UI_UISTATECTRL_STATEDATA_METHOD_1_867AF37B6C9E4C74_OFFSET UNITYSDK_OFFSET(0x138DE520)
#define RPG_CLIENT_UI_UISTATECTRL_STATEDATA_METHOD_1_A66B981E1EA3E23D_OFFSET UNITYSDK_OFFSET(0x138DE770)
#define RPG_CLIENT_UI_UISTATECTRL_STATEDATA_METHOD_1_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0x138DE6A0)
#define RPG_CLIENT_UI_UISTATECTRL_STATEDATA_SET_OWNERUISTATECTRL_OFFSET UNITYSDK_OFFSET(0x138DE960)
#define RPG_CLIENT_UI_UISTATECTRL_STATEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x138DE970)

namespace RPG::Client::UI::UIStateCtrl
{
	inline static constexpr unsigned int StateData_TypeDefinitionIndex = 68178;
