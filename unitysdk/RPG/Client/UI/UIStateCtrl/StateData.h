...
#define RPG_CLIENT_UI_UISTATECTRL_STATEDATA_GET_OWNERUISTATECTRL_OFFSET UNITYSDK_OFFSET(0xA6597C0)
#define RPG_CLIENT_UI_UISTATECTRL_STATEDATA_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xA659330)
#define RPG_CLIENT_UI_UISTATECTRL_STATEDATA_METHOD_1_30615810974CEB89_OFFSET UNITYSDK_OFFSET(0xA659700)
#define RPG_CLIENT_UI_UISTATECTRL_STATEDATA_METHOD_1_57CD51AAF699439D_OFFSET UNITYSDK_OFFSET(0xA658E50)
#define RPG_CLIENT_UI_UISTATECTRL_STATEDATA_METHOD_1_867AF37B6C9E4C74_OFFSET UNITYSDK_OFFSET(0xA659390)
#define RPG_CLIENT_UI_UISTATECTRL_STATEDATA_METHOD_1_A66B981E1EA3E23D_OFFSET UNITYSDK_OFFSET(0xA6595E0)
#define RPG_CLIENT_UI_UISTATECTRL_STATEDATA_METHOD_1_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0xA659510)
#define RPG_CLIENT_UI_UISTATECTRL_STATEDATA_SET_OWNERUISTATECTRL_OFFSET UNITYSDK_OFFSET(0xA6597D0)
#define RPG_CLIENT_UI_UISTATECTRL_STATEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA6597E0)

namespace RPG::Client::UI::UIStateCtrl
{
	inline static constexpr unsigned int StateData_TypeDefinitionIndex = 60733;
