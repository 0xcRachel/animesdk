...
#define RPG_CLIENT_AVATARMODULE_ADDAVATARSKINDATACACHE_OFFSET UNITYSDK_OFFSET(0x15E2FFD0)
#define RPG_CLIENT_AVATARMODULE_ADDTRIALPLAYER_OFFSET UNITYSDK_OFFSET(0x15E34530)
#define RPG_CLIENT_AVATARMODULE_BUILDCHALLENGEUPGRADEDAVATARRELIC_OFFSET UNITYSDK_OFFSET(0x15E2E1A0)
#define RPG_CLIENT_AVATARMODULE_BUILDSKILLTREESANDSKILLS_OFFSET UNITYSDK_OFFSET(0x15E32F20)
#define RPG_CLIENT_AVATARMODULE_BUILDUPGRADEDAVATARRELIC_OFFSET UNITYSDK_OFFSET(0x15E31BB0)
#define RPG_CLIENT_AVATARMODULE_CHANGEMULTIPATHAVATARTYPE_OFFSET UNITYSDK_OFFSET(0x15E33CB0)
#define RPG_CLIENT_AVATARMODULE_CHECKPLAYERHASAVATAR_OFFSET UNITYSDK_OFFSET(0x15E352B0)
#define RPG_CLIENT_AVATARMODULE_CLEARENHANCEREDDOT_OFFSET UNITYSDK_OFFSET(0x15E2EF00)
#define RPG_CLIENT_AVATARMODULE_CREATEPLAYERAVATARCLONEBYREALID_OFFSET UNITYSDK_OFFSET(0x15E2F830)
#define RPG_CLIENT_AVATARMODULE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15E35740)
#define RPG_CLIENT_AVATARMODULE_FORMATDISPLAYDATABYTYPE_OFFSET UNITYSDK_OFFSET(0x15E34740)
#define RPG_CLIENT_AVATARMODULE_GETASSISTAVATAR_OFFSET UNITYSDK_OFFSET(0x15E33E40)
#define RPG_CLIENT_AVATARMODULE_GETAVATARDATALIST_OFFSET UNITYSDK_OFFSET(0x15E34290)
#define RPG_CLIENT_AVATARMODULE_GETAVATAR_1_OFFSET UNITYSDK_OFFSET(0x15E33B70)
#define RPG_CLIENT_AVATARMODULE_GETAVATAR_OFFSET UNITYSDK_OFFSET(0x15E2E7E0)
#define RPG_CLIENT_AVATARMODULE_GETCHALLENGEUPGRADEDEQUIPMENT_OFFSET UNITYSDK_OFFSET(0x15E2E100)
#define RPG_CLIENT_AVATARMODULE_GETCOMMONUPGRADEAVATAR_OFFSET UNITYSDK_OFFSET(0x15E30240)
#define RPG_CLIENT_AVATARMODULE_GETCURRENTRANK_OFFSET UNITYSDK_OFFSET(0x15E354C0)
#define RPG_CLIENT_AVATARMODULE_GETDEFAULTUPGRADEAVATARSET2ID_OFFSET UNITYSDK_OFFSET(0x15E32B40)
#define RPG_CLIENT_AVATARMODULE_GETDEFAULTUPGRADEAVATARSET4ID_OFFSET UNITYSDK_OFFSET(0x15E32710)
#define RPG_CLIENT_AVATARMODULE_GETMAXPOWERAVATAR_OFFSET UNITYSDK_OFFSET(0x15E34CA0)
#define RPG_CLIENT_AVATARMODULE_GETMAXRANK_OFFSET UNITYSDK_OFFSET(0x15E353D0)
#define RPG_CLIENT_AVATARMODULE_GETMULTIPATHAVATAR_OFFSET UNITYSDK_OFFSET(0x15E30B30)
#define RPG_CLIENT_AVATARMODULE_GETMULTIPATHPLAYERAVATAR_OFFSET UNITYSDK_OFFSET(0x15E2F5B0)
#define RPG_CLIENT_AVATARMODULE_GETRANKITEMID_OFFSET UNITYSDK_OFFSET(0x15E35220)
#define RPG_CLIENT_AVATARMODULE_GETRECOMMENDRELICAVATARPROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0x15E328F0)
#define RPG_CLIENT_AVATARMODULE_GETTRIALAVATAR_OFFSET UNITYSDK_OFFSET(0x15E341D0)
#define RPG_CLIENT_AVATARMODULE_GETUPGRADEAVAILABLEAVATAR_OFFSET UNITYSDK_OFFSET(0x15E30790)
#define RPG_CLIENT_AVATARMODULE_GETUPGRADEAVATARSUBRELICROW_OFFSET UNITYSDK_OFFSET(0x15E32A70)
#define RPG_CLIENT_AVATARMODULE_GETUPGRADEDAVATARLEVEL_OFFSET UNITYSDK_OFFSET(0x15E313B0)
#define RPG_CLIENT_AVATARMODULE_GETUPGRADEDAVATARPROMOTION_OFFSET UNITYSDK_OFFSET(0x15E314C0)
#define RPG_CLIENT_AVATARMODULE_GETUPGRADEDEQUIPMENT_OFFSET UNITYSDK_OFFSET(0x15E315D0)
#define RPG_CLIENT_AVATARMODULE_GETUPGRADEDRANK_OFFSET UNITYSDK_OFFSET(0x15E33420)
#define RPG_CLIENT_AVATARMODULE_GETUPGRADERELICID_OFFSET UNITYSDK_OFFSET(0x15E32810)
#define RPG_CLIENT_AVATARMODULE_GET_ALLAVATARSKINS_OFFSET UNITYSDK_OFFSET(0x15E30220)
#define RPG_CLIENT_AVATARMODULE_GET_ALLAVATARS_OFFSET UNITYSDK_OFFSET(0x15E38A20)
#define RPG_CLIENT_AVATARMODULE_GET_ALLMULTIPATHAVATARS_OFFSET UNITYSDK_OFFSET(0x15E38A60)
#define RPG_CLIENT_AVATARMODULE_GET_ALLSPECIALAVATARS_OFFSET UNITYSDK_OFFSET(0x15E38A40)
#define RPG_CLIENT_AVATARMODULE_GET_ENHANCEREDDOTAVATARIDS_OFFSET UNITYSDK_OFFSET(0x15E2EB70)
#define RPG_CLIENT_AVATARMODULE_GET_ENHANCEREDDOTTRIALSTAGEIDS_OFFSET UNITYSDK_OFFSET(0x15E2EF70)
#define RPG_CLIENT_AVATARMODULE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x15E33530)
#define RPG_CLIENT_AVATARMODULE_GET_ISSHOWENHANCECHANGESIMPLEDESC_OFFSET UNITYSDK_OFFSET(0x15E2F4F0)
#define RPG_CLIENT_AVATARMODULE_GET_LASTSEENENHANCESEASON_OFFSET UNITYSDK_OFFSET(0x15E2E910)
#define RPG_CLIENT_AVATARMODULE_GET_MAXENHANCEDSEASON_OFFSET UNITYSDK_OFFSET(0x15E2EA30)
#define RPG_CLIENT_AVATARMODULE_GET_PLAYEROUTFIT_OFFSET UNITYSDK_OFFSET(0x15E38A80)
#define RPG_CLIENT_AVATARMODULE_GET_PREFSSHOWSIMPLIFIEDSKILLDESC_OFFSET UNITYSDK_OFFSET(0x15E34AF0)
#define RPG_CLIENT_AVATARMODULE_ISNEEDUPGRADEAVATARBYID_OFFSET UNITYSDK_OFFSET(0x15E30920)
#define RPG_CLIENT_AVATARMODULE_ISNEEDUPGRADEAVATARLEVEL_OFFSET UNITYSDK_OFFSET(0x15E30CB0)
#define RPG_CLIENT_AVATARMODULE_ISNEEDUPGRADEAVATAR_OFFSET UNITYSDK_OFFSET(0x15E30BF0)
#define RPG_CLIENT_AVATARMODULE_ISNEEDUPGRADEEQUIPMENT_OFFSET UNITYSDK_OFFSET(0x15E30DC0)
#define RPG_CLIENT_AVATARMODULE_ISNEEDUPGRADERANK_OFFSET UNITYSDK_OFFSET(0x15E311F0)
#define RPG_CLIENT_AVATARMODULE_ISNEEDUPGRADERELICSET2_OFFSET UNITYSDK_OFFSET(0x15E31A50)
#define RPG_CLIENT_AVATARMODULE_ISNEEDUPGRADERELICSET4_OFFSET UNITYSDK_OFFSET(0x15E318A0)
#define RPG_CLIENT_AVATARMODULE_ISNEEDUPGRADERELIC_OFFSET UNITYSDK_OFFSET(0x15E30EE0)
#define RPG_CLIENT_AVATARMODULE_ISNEEDUPGRADESKILLPOINT_OFFSET UNITYSDK_OFFSET(0x15E32C40)
#define RPG_CLIENT_AVATARMODULE_ISNEEDUPGRADESKILLTREE_OFFSET UNITYSDK_OFFSET(0x15E30F40)
#define RPG_CLIENT_AVATARMODULE_ISOWNSKIN_OFFSET UNITYSDK_OFFSET(0x15E2FDB0)
#define RPG_CLIENT_AVATARMODULE_ISSKINNEW_OFFSET UNITYSDK_OFFSET(0x15E2FE20)
#define RPG_CLIENT_AVATARMODULE_NEEDSHOWUPGRADEINLINEUP_OFFSET UNITYSDK_OFFSET(0x15E30730)
#define RPG_CLIENT_AVATARMODULE_REFRESHENHANCEREDDOT_OFFSET UNITYSDK_OFFSET(0x15E2EB90)
#define RPG_CLIENT_AVATARMODULE_REFRESHENHANCETRIALSTAGEREDDOT_OFFSET UNITYSDK_OFFSET(0x15E2EF80)
#define RPG_CLIENT_AVATARMODULE_REMOVEENHANCEREDDOT_OFFSET UNITYSDK_OFFSET(0x15E2EE50)
#define RPG_CLIENT_AVATARMODULE_REVERTPREFSSHOWSIMPLIFIEDSKILLDESC_OFFSET UNITYSDK_OFFSET(0x15E34B40)
#define RPG_CLIENT_AVATARMODULE_SETTEMPADVENTUREAVATARS_OFFSET UNITYSDK_OFFSET(0x15E33EF0)
#define RPG_CLIENT_AVATARMODULE_SET_ALLAVATARSKINS_OFFSET UNITYSDK_OFFSET(0x15E30230)
#define RPG_CLIENT_AVATARMODULE_SET_ALLAVATARS_OFFSET UNITYSDK_OFFSET(0x15E38A30)
#define RPG_CLIENT_AVATARMODULE_SET_ALLMULTIPATHAVATARS_OFFSET UNITYSDK_OFFSET(0x15E38A70)
#define RPG_CLIENT_AVATARMODULE_SET_ALLSPECIALAVATARS_OFFSET UNITYSDK_OFFSET(0x15E38A50)
#define RPG_CLIENT_AVATARMODULE_SET_ENHANCEREDDOTAVATARIDS_OFFSET UNITYSDK_OFFSET(0x15E2EB80)
#define RPG_CLIENT_AVATARMODULE_SET_ISSHOWENHANCECHANGESIMPLEDESC_OFFSET UNITYSDK_OFFSET(0x15E2F550)
#define RPG_CLIENT_AVATARMODULE_SET_LASTSEENENHANCESEASON_OFFSET UNITYSDK_OFFSET(0x15E2E9A0)
#define RPG_CLIENT_AVATARMODULE_SWITCHTEAMASSOCIATIONSHOWSTATE_OFFSET UNITYSDK_OFFSET(0x15E35600)
#define RPG_CLIENT_AVATARMODULE_TRYGETAVATARSKINDATACACHE_OFFSET UNITYSDK_OFFSET(0x15E2FF50)
#define RPG_CLIENT_AVATARMODULE_TRYGETTRIALAVATARSBYIDS_OFFSET UNITYSDK_OFFSET(0x15E34F90)
#define RPG_CLIENT_AVATARMODULE_UPDATEAVATAREQUIP_OFFSET UNITYSDK_OFFSET(0x15E34E90)
#define RPG_CLIENT_AVATARMODULE_UPDATERELICSET_OFFSET UNITYSDK_OFFSET(0x15E34F00)
#define RPG_CLIENT_AVATARMODULE_UPDATESKINNEW_OFFSET UNITYSDK_OFFSET(0x15E2FEB0)
#define RPG_CLIENT_AVATARMODULE__ADDNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0x15E35C30)
#define RPG_CLIENT_AVATARMODULE__ADDPACKETHANDLERS_OFFSET UNITYSDK_OFFSET(0x15E35800)
#define RPG_CLIENT_AVATARMODULE__CREATEPLAYERAVATARBYREALID_OFFSET UNITYSDK_OFFSET(0x15E2F740)
#define RPG_CLIENT_AVATARMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x15E33580)
#define RPG_CLIENT_AVATARMODULE__DISPOSEUPGRADEAVATAR_OFFSET UNITYSDK_OFFSET(0x15E30690)
#define RPG_CLIENT_AVATARMODULE__HASPATHSERVERDATA_OFFSET UNITYSDK_OFFSET(0x15E2F880)
#define RPG_CLIENT_AVATARMODULE__HASROLESERVERDATA_OFFSET UNITYSDK_OFFSET(0x15E38770)
#define RPG_CLIENT_AVATARMODULE__NOTIFYADDNEWAVATARINFO_OFFSET UNITYSDK_OFFSET(0x15E37C50)
#define RPG_CLIENT_AVATARMODULE__ONAVATARSYNCDATA_OFFSET UNITYSDK_OFFSET(0x15E386B0)
#define RPG_CLIENT_AVATARMODULE__ONCMDADDAVATARSCNOTIFY_OFFSET UNITYSDK_OFFSET(0x15E379B0)
#define RPG_CLIENT_AVATARMODULE__ONCMDAVATAREXPUPSCRSP_OFFSET UNITYSDK_OFFSET(0x15E37E20)
#define RPG_CLIENT_AVATARMODULE__ONCMDAVATARSPECIALSKILLTREEUNLOCKSCNOTIFY_OFFSET UNITYSDK_OFFSET(0x15E383B0)
#define RPG_CLIENT_AVATARMODULE__ONCMDDRESSAVATARSCRSP_OFFSET UNITYSDK_OFFSET(0x15E38150)
#define RPG_CLIENT_AVATARMODULE__ONCMDDRESSAVATARSKINSCRSP_OFFSET UNITYSDK_OFFSET(0x15E30050)
#define RPG_CLIENT_AVATARMODULE__ONCMDDRESSRELICAVATARSCRSP_OFFSET UNITYSDK_OFFSET(0x15E38270)
#define RPG_CLIENT_AVATARMODULE__ONCMDGETAVATARDATASCRSP_OFFSET UNITYSDK_OFFSET(0x15E36010)
#define RPG_CLIENT_AVATARMODULE__ONCMDPLAYERSYNCSCNOTIFY_OFFSET UNITYSDK_OFFSET(0x15E37780)
#define RPG_CLIENT_AVATARMODULE__ONCMDPROMOTEAVATARSCRSP_OFFSET UNITYSDK_OFFSET(0x15E38010)
#define RPG_CLIENT_AVATARMODULE__ONCMDRANKUPAVATARSCRSP_OFFSET UNITYSDK_OFFSET(0x15E38210)
#define RPG_CLIENT_AVATARMODULE__ONCMDSETAVATARENHANCEDIDSCRSP_OFFSET UNITYSDK_OFFSET(0x15E2E730)
#define RPG_CLIENT_AVATARMODULE__ONCMDSETPLAYEROUTFITSCRSP_OFFSET UNITYSDK_OFFSET(0x15E38440)
#define RPG_CLIENT_AVATARMODULE__ONCMDTAKEOFFAVATARSKINSCRSP_OFFSET UNITYSDK_OFFSET(0x15E300E0)
#define RPG_CLIENT_AVATARMODULE__ONCMDTAKEOFFEQUIPMENTSCRSP_OFFSET UNITYSDK_OFFSET(0x15E381B0)
#define RPG_CLIENT_AVATARMODULE__ONCMDTAKEOFFRELICSCRSP_OFFSET UNITYSDK_OFFSET(0x15E382D0)
#define RPG_CLIENT_AVATARMODULE__ONCMDTAKEPROMOTIONREWARDSCRSP_OFFSET UNITYSDK_OFFSET(0x15E38330)
#define RPG_CLIENT_AVATARMODULE__ONCMDUNLOCKAVATARSKINSCNOTIFY_OFFSET UNITYSDK_OFFSET(0x15E30170)
#define RPG_CLIENT_AVATARMODULE__ONCMDUNLOCKSKILLTREESCRSP_OFFSET UNITYSDK_OFFSET(0x15E38070)
#define RPG_CLIENT_AVATARMODULE__ONMARKAVATARSCRSP_OFFSET UNITYSDK_OFFSET(0x15E37D90)
#define RPG_CLIENT_AVATARMODULE__ONWORLDLEVELUP_OFFSET UNITYSDK_OFFSET(0x15E384E0)
#define RPG_CLIENT_AVATARMODULE__REFRESHUPGRADEAVATAR_OFFSET UNITYSDK_OFFSET(0x15E304E0)
#define RPG_CLIENT_AVATARMODULE__SENDAVATARSYNCDATA_OFFSET UNITYSDK_OFFSET(0x15E38710)
#define RPG_CLIENT_AVATARMODULE__SETPLAYEROUTFIT_OFFSET UNITYSDK_OFFSET(0x15E38830)
#define RPG_CLIENT_AVATARMODULE__SYNCALLAVATARS_OFFSET UNITYSDK_OFFSET(0x15E36CA0)
#define RPG_CLIENT_AVATARMODULE__SYNCAVATAR_OFFSET UNITYSDK_OFFSET(0x15E2F910)
#define RPG_CLIENT_AVATARMODULE__SYNCFORMALMULTIPATHAVATARS_OFFSET UNITYSDK_OFFSET(0x15E2FB70)
#define RPG_CLIENT_AVATARMODULE__SYNCMULTIPATHAVATARS_OFFSET UNITYSDK_OFFSET(0x15E37210)
#define RPG_CLIENT_AVATARMODULE__UPDATEAVATARPATHSERVERDATACACHE_OFFSET UNITYSDK_OFFSET(0x15E36930)
#define RPG_CLIENT_AVATARMODULE__UPDATEAVATARROLESERVERDATACACHE_OFFSET UNITYSDK_OFFSET(0x15E365C0)
#define RPG_CLIENT_AVATARMODULE__UPDATENEWAVATARREDDOT_OFFSET UNITYSDK_OFFSET(0x15E37BE0)
#define RPG_CLIENT_AVATARMODULE___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15E38A90)
#define RPG_CLIENT_AVATARMODULE___IFIXBASEPROXY__ADDNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0x15E38B00)
#define RPG_CLIENT_AVATARMODULE___IFIXBASEPROXY__ADDPACKETHANDLERS_OFFSET UNITYSDK_OFFSET(0x15E38AA0)
...
namespace RPG::Client
{
	...
	{
	public:
		::Class_1_15951C7ACBFF8B93* _PlayerOutfitServerAgent; // 0x10
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::AvatarData*>* _AllUpgradedAvatars; // 0x18
		::System::Collections::Generic::List_1<::System::UInt32>* _EnhanceRedDotAvatarIDs_k__BackingField; // 0x20
		::RPG::GameCore::GameEntity* AvatarUI3DPageShowingAvatar; // 0x28
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::AvatarData*>* _AllAvatars_k__BackingField; // 0x30
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::AvatarData*>* _AllSpecialAvatars_k__BackingField; // 0x38
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_BB4B99DE4C2501EC_3*>* _AvatarRoleServerDataCache; // 0x40
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::UInt32>* _AvatarRankItemIDs; // 0x48
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::AvatarData*>* _AllMultiPathAvatars_k__BackingField; // 0x50
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Boolean>* _AllAvatarSkins_k__BackingField; // 0x58
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::AvatarData*>* _AllNoSyncPlayerMultiPathAvatars; // 0x60
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_F3CA30716D4FAF92_3*>* _AvatarPathServerDataCache; // 0x68
		::RPG::Client::AvatarOutfit* _PlayerOutfit_k__BackingField; // 0x70
		::RPG::Client::LRUCache_2<::Struct_2_137AB23E3A00ECA1, ::RPG::Client::IAvatarSkinData*>* _AvatarSkinDataCache; // 0x78
		...
		::System::Void _SyncFormalMultiPathAvatars(::Google::Protobuf::Collections::RepeatedField_1<::Class_1_BB4B99DE4C2501EC_3*>* avatarBaseDataList, ::Google::Protobuf::Collections::RepeatedField_1<::Class_1_F3CA30716D4FAF92_3*>* avatarUniqueDataList)
		{
			return ((::System::Void(*)(::PVOID, ::Google::Protobuf::Collections::RepeatedField_1<::Class_1_BB4B99DE4C2501EC_3*>*, ::Google::Protobuf::Collections::RepeatedField_1<::Class_1_F3CA30716D4FAF92_3*>*))((::PBYTE)hIl2Cpp + RPG_CLIENT_AVATARMODULE__SYNCFORMALMULTIPATHAVATARS_OFFSET))(this, avatarBaseDataList, avatarUniqueDataList);
		}
		...
		::System::Void _SyncAllAvatars(::Google::Protobuf::Collections::RepeatedField_1<::Class_1_BB4B99DE4C2501EC_3*>* avatarBaseDataList, ::Google::Protobuf::Collections::RepeatedField_1<::Class_1_F3CA30716D4FAF92_3*>* avatarUniqueDataList)
		{
			return ((::System::Void(*)(::PVOID, ::Google::Protobuf::Collections::RepeatedField_1<::Class_1_BB4B99DE4C2501EC_3*>*, ::Google::Protobuf::Collections::RepeatedField_1<::Class_1_F3CA30716D4FAF92_3*>*))((::PBYTE)hIl2Cpp + RPG_CLIENT_AVATARMODULE__SYNCALLAVATARS_OFFSET))(this, avatarBaseDataList, avatarUniqueDataList);
		}
		...
		::System::Void _SyncMultiPathAvatars(::Google::Protobuf::Collections::RepeatedField_1<::Class_1_BB4B99DE4C2501EC_3*>* avatarBaseDataList, ::Google::Protobuf::Collections::RepeatedField_1<::Class_1_F3CA30716D4FAF92_3*>* avatarUniqueDataList)
		{
			return ((::System::Void(*)(::PVOID, ::Google::Protobuf::Collections::RepeatedField_1<::Class_1_BB4B99DE4C2501EC_3*>*, ::Google::Protobuf::Collections::RepeatedField_1<::Class_1_F3CA30716D4FAF92_3*>*))((::PBYTE)hIl2Cpp + RPG_CLIENT_AVATARMODULE__SYNCMULTIPATHAVATARS_OFFSET))(this, avatarBaseDataList, avatarUniqueDataList);
		}
		...
		::System::Void _UpdateAvatarPathServerDataCache(::System::Collections::Generic::IEnumerable_1<::Class_1_F3CA30716D4FAF92_3*>* avatarUniqueDataList)
		{
			return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::IEnumerable_1<::Class_1_F3CA30716D4FAF92_3*>*))((::PBYTE)hIl2Cpp + RPG_CLIENT_AVATARMODULE__UPDATEAVATARPATHSERVERDATACACHE_OFFSET))(this, avatarUniqueDataList);
		}
