...
#define RPG_CLIENT_AVATARMODULE_ADDAVATARSKINDATACACHE_OFFSET UNITYSDK_OFFSET(0x9150CD0)
#define RPG_CLIENT_AVATARMODULE_ADDTRIALPLAYER_OFFSET UNITYSDK_OFFSET(0x9154A60)
#define RPG_CLIENT_AVATARMODULE_BUILDCHALLENGEUPGRADEDAVATARRELIC_OFFSET UNITYSDK_OFFSET(0x914EF40)
#define RPG_CLIENT_AVATARMODULE_BUILDSKILLTREESANDSKILLS_OFFSET UNITYSDK_OFFSET(0x9153510)
#define RPG_CLIENT_AVATARMODULE_BUILDUPGRADEDAVATARRELIC_OFFSET UNITYSDK_OFFSET(0x91528A0)
#define RPG_CLIENT_AVATARMODULE_CHANGEMULTIPATHAVATARTYPE_OFFSET UNITYSDK_OFFSET(0x9154270)
#define RPG_CLIENT_AVATARMODULE_CHECKPLAYERHASAVATAR_OFFSET UNITYSDK_OFFSET(0x91554C0)
#define RPG_CLIENT_AVATARMODULE_CLEARENHANCEREDDOT_OFFSET UNITYSDK_OFFSET(0x914FC40)
#define RPG_CLIENT_AVATARMODULE_CREATEPLAYERAVATARCLONEBYREALID_OFFSET UNITYSDK_OFFSET(0x9150560)
#define RPG_CLIENT_AVATARMODULE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x91558A0)
#define RPG_CLIENT_AVATARMODULE_FORMATDISPLAYDATABYTYPE_OFFSET UNITYSDK_OFFSET(0x913BFC0)
#define RPG_CLIENT_AVATARMODULE_GETASSISTAVATAR_OFFSET UNITYSDK_OFFSET(0x9154400)
#define RPG_CLIENT_AVATARMODULE_GETAVATARDATALIST_OFFSET UNITYSDK_OFFSET(0x91547C0)
#define RPG_CLIENT_AVATARMODULE_GETAVATAR_1_OFFSET UNITYSDK_OFFSET(0x9154170)
#define RPG_CLIENT_AVATARMODULE_GETAVATAR_OFFSET UNITYSDK_OFFSET(0x912A1F0)
#define RPG_CLIENT_AVATARMODULE_GETCHALLENGEUPGRADEDEQUIPMENT_OFFSET UNITYSDK_OFFSET(0x914EEB0)
#define RPG_CLIENT_AVATARMODULE_GETCOMMONUPGRADEAVATAR_OFFSET UNITYSDK_OFFSET(0x9150F40)
#define RPG_CLIENT_AVATARMODULE_GETCURRENTRANK_OFFSET UNITYSDK_OFFSET(0x9155660)
#define RPG_CLIENT_AVATARMODULE_GETDEFAULTUPGRADEAVATARSET2ID_OFFSET UNITYSDK_OFFSET(0x9124570)
#define RPG_CLIENT_AVATARMODULE_GETDEFAULTUPGRADEAVATARSET4ID_OFFSET UNITYSDK_OFFSET(0x9124140)
#define RPG_CLIENT_AVATARMODULE_GETMAXPOWERAVATAR_OFFSET UNITYSDK_OFFSET(0x9154CC0)
#define RPG_CLIENT_AVATARMODULE_GETMAXRANK_OFFSET UNITYSDK_OFFSET(0x91555B0)
#define RPG_CLIENT_AVATARMODULE_GETMULTIPATHAVATAR_OFFSET UNITYSDK_OFFSET(0x9151840)
#define RPG_CLIENT_AVATARMODULE_GETMULTIPATHPLAYERAVATAR_OFFSET UNITYSDK_OFFSET(0x91502E0)
#define RPG_CLIENT_AVATARMODULE_GETRANKITEMID_OFFSET UNITYSDK_OFFSET(0x9155430)
#define RPG_CLIENT_AVATARMODULE_GETRECOMMENDRELICAVATARPROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0x9124320)
#define RPG_CLIENT_AVATARMODULE_GETTRIALAVATAR_OFFSET UNITYSDK_OFFSET(0x9154700)
#define RPG_CLIENT_AVATARMODULE_GETUPGRADEAVAILABLEAVATAR_OFFSET UNITYSDK_OFFSET(0x9151490)
#define RPG_CLIENT_AVATARMODULE_GETUPGRADEAVATARSUBRELICROW_OFFSET UNITYSDK_OFFSET(0x91244A0)
#define RPG_CLIENT_AVATARMODULE_GETUPGRADEDAVATARLEVEL_OFFSET UNITYSDK_OFFSET(0x91520B0)
#define RPG_CLIENT_AVATARMODULE_GETUPGRADEDAVATARPROMOTION_OFFSET UNITYSDK_OFFSET(0x91521B0)
#define RPG_CLIENT_AVATARMODULE_GETUPGRADEDEQUIPMENT_OFFSET UNITYSDK_OFFSET(0x91522C0)
#define RPG_CLIENT_AVATARMODULE_GETUPGRADEDRANK_OFFSET UNITYSDK_OFFSET(0x9153A00)
#define RPG_CLIENT_AVATARMODULE_GETUPGRADERELICID_OFFSET UNITYSDK_OFFSET(0x9124240)
#define RPG_CLIENT_AVATARMODULE_GET_ALLAVATARSKINS_OFFSET UNITYSDK_OFFSET(0x9150F20)
#define RPG_CLIENT_AVATARMODULE_GET_ALLAVATARS_OFFSET UNITYSDK_OFFSET(0x91591A0)
#define RPG_CLIENT_AVATARMODULE_GET_ALLMULTIPATHAVATARS_OFFSET UNITYSDK_OFFSET(0x91591E0)
#define RPG_CLIENT_AVATARMODULE_GET_ALLSPECIALAVATARS_OFFSET UNITYSDK_OFFSET(0x91591C0)
#define RPG_CLIENT_AVATARMODULE_GET_ENHANCEREDDOTAVATARIDS_OFFSET UNITYSDK_OFFSET(0x914F860)
#define RPG_CLIENT_AVATARMODULE_GET_ENHANCEREDDOTTRIALSTAGEIDS_OFFSET UNITYSDK_OFFSET(0x914FCB0)
#define RPG_CLIENT_AVATARMODULE_GET_GROWTHTARGETAVATARID_OFFSET UNITYSDK_OFFSET(0x9159200)
#define RPG_CLIENT_AVATARMODULE_GET_GROWTHTARGETINCLUDEALLSKILLTREE_OFFSET UNITYSDK_OFFSET(0x9159220)
#define RPG_CLIENT_AVATARMODULE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x9153B10)
#define RPG_CLIENT_AVATARMODULE_GET_ISSHOWENHANCECHANGESIMPLEDESC_OFFSET UNITYSDK_OFFSET(0x9150220)
#define RPG_CLIENT_AVATARMODULE_GET_LASTSEENENHANCESEASON_OFFSET UNITYSDK_OFFSET(0x914F580)
#define RPG_CLIENT_AVATARMODULE_GET_MAXENHANCEDSEASON_OFFSET UNITYSDK_OFFSET(0x914F6F0)
#define RPG_CLIENT_AVATARMODULE_GET_PLAYEROUTFIT_OFFSET UNITYSDK_OFFSET(0x91592A0)
#define RPG_CLIENT_AVATARMODULE_GET_PREFSSHOWSIMPLIFIEDSKILLDESC_OFFSET UNITYSDK_OFFSET(0x9154C70)
#define RPG_CLIENT_AVATARMODULE_ISNEEDUPGRADEAVATARBYID_OFFSET UNITYSDK_OFFSET(0x9151620)
#define RPG_CLIENT_AVATARMODULE_ISNEEDUPGRADEAVATARLEVEL_OFFSET UNITYSDK_OFFSET(0x91519C0)
#define RPG_CLIENT_AVATARMODULE_ISNEEDUPGRADEAVATAR_OFFSET UNITYSDK_OFFSET(0x9151900)
#define RPG_CLIENT_AVATARMODULE_ISNEEDUPGRADEEQUIPMENT_OFFSET UNITYSDK_OFFSET(0x9151AC0)
#define RPG_CLIENT_AVATARMODULE_ISNEEDUPGRADERANK_OFFSET UNITYSDK_OFFSET(0x9151EF0)
#define RPG_CLIENT_AVATARMODULE_ISNEEDUPGRADERELICSET2_OFFSET UNITYSDK_OFFSET(0x9152740)
#define RPG_CLIENT_AVATARMODULE_ISNEEDUPGRADERELICSET4_OFFSET UNITYSDK_OFFSET(0x9152590)
#define RPG_CLIENT_AVATARMODULE_ISNEEDUPGRADERELIC_OFFSET UNITYSDK_OFFSET(0x9151BE0)
#define RPG_CLIENT_AVATARMODULE_ISNEEDUPGRADESKILLPOINT_OFFSET UNITYSDK_OFFSET(0x9153400)
#define RPG_CLIENT_AVATARMODULE_ISNEEDUPGRADESKILLTREE_OFFSET UNITYSDK_OFFSET(0x9151C40)
#define RPG_CLIENT_AVATARMODULE_ISOWNSKIN_OFFSET UNITYSDK_OFFSET(0x9150AB0)
#define RPG_CLIENT_AVATARMODULE_ISSKINNEW_OFFSET UNITYSDK_OFFSET(0x9150B20)
#define RPG_CLIENT_AVATARMODULE_NEEDSHOWUPGRADEINLINEUP_OFFSET UNITYSDK_OFFSET(0x9151430)
#define RPG_CLIENT_AVATARMODULE_REFRESHENHANCEREDDOT_OFFSET UNITYSDK_OFFSET(0x914F880)
#define RPG_CLIENT_AVATARMODULE_REFRESHENHANCETRIALSTAGEREDDOT_OFFSET UNITYSDK_OFFSET(0x914FCC0)
#define RPG_CLIENT_AVATARMODULE_REMOVEENHANCEREDDOT_OFFSET UNITYSDK_OFFSET(0x914FB90)
#define RPG_CLIENT_AVATARMODULE_REVERTPREFSSHOWSIMPLIFIEDSKILLDESC_OFFSET UNITYSDK_OFFSET(0x9120DD0)
#define RPG_CLIENT_AVATARMODULE_SETGROWTHTARGET_OFFSET UNITYSDK_OFFSET(0x9155250)
#define RPG_CLIENT_AVATARMODULE_SETTEMPADVENTUREAVATARS_OFFSET UNITYSDK_OFFSET(0x91544B0)
#define RPG_CLIENT_AVATARMODULE_SET_ALLAVATARSKINS_OFFSET UNITYSDK_OFFSET(0x9150F30)
#define RPG_CLIENT_AVATARMODULE_SET_ALLAVATARS_OFFSET UNITYSDK_OFFSET(0x91591B0)
#define RPG_CLIENT_AVATARMODULE_SET_ALLMULTIPATHAVATARS_OFFSET UNITYSDK_OFFSET(0x91591F0)
#define RPG_CLIENT_AVATARMODULE_SET_ALLSPECIALAVATARS_OFFSET UNITYSDK_OFFSET(0x91591D0)
#define RPG_CLIENT_AVATARMODULE_SET_ENHANCEREDDOTAVATARIDS_OFFSET UNITYSDK_OFFSET(0x914F870)
#define RPG_CLIENT_AVATARMODULE_SET_GROWTHTARGETAVATARID_OFFSET UNITYSDK_OFFSET(0x9159210)
#define RPG_CLIENT_AVATARMODULE_SET_ISSHOWENHANCECHANGESIMPLEDESC_OFFSET UNITYSDK_OFFSET(0x9150280)
#define RPG_CLIENT_AVATARMODULE_SET_LASTSEENENHANCESEASON_OFFSET UNITYSDK_OFFSET(0x914F630)
#define RPG_CLIENT_AVATARMODULE_SWITCHTEAMASSOCIATIONSHOWSTATE_OFFSET UNITYSDK_OFFSET(0x9155760)
#define RPG_CLIENT_AVATARMODULE_TRYGETAVATARSKINDATACACHE_OFFSET UNITYSDK_OFFSET(0x9150C50)
#define RPG_CLIENT_AVATARMODULE_TRYGETTRIALAVATARSBYIDS_OFFSET UNITYSDK_OFFSET(0x9154FC0)
#define RPG_CLIENT_AVATARMODULE_UPDATEAVATAREQUIP_OFFSET UNITYSDK_OFFSET(0x9154EB0)
#define RPG_CLIENT_AVATARMODULE_UPDATERELICSET_OFFSET UNITYSDK_OFFSET(0x9154F20)
#define RPG_CLIENT_AVATARMODULE_UPDATESKINNEW_OFFSET UNITYSDK_OFFSET(0x9150BB0)
#define RPG_CLIENT_AVATARMODULE__ADDNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0x9155E00)
#define RPG_CLIENT_AVATARMODULE__ADDPACKETHANDLERS_OFFSET UNITYSDK_OFFSET(0x9155960)
#define RPG_CLIENT_AVATARMODULE__CREATEPLAYERAVATARBYREALID_OFFSET UNITYSDK_OFFSET(0x9150470)
#define RPG_CLIENT_AVATARMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x9153B70)
#define RPG_CLIENT_AVATARMODULE__DISPOSEUPGRADEAVATAR_OFFSET UNITYSDK_OFFSET(0x9151390)
#define RPG_CLIENT_AVATARMODULE__HASPATHSERVERDATA_OFFSET UNITYSDK_OFFSET(0x91505B0)
#define RPG_CLIENT_AVATARMODULE__HASROLESERVERDATA_OFFSET UNITYSDK_OFFSET(0x9158EF0)
#define RPG_CLIENT_AVATARMODULE__NOTIFYADDNEWAVATARINFO_OFFSET UNITYSDK_OFFSET(0x9157BD0)
#define RPG_CLIENT_AVATARMODULE__ONAVATARSYNCDATA_OFFSET UNITYSDK_OFFSET(0x9158E30)
#define RPG_CLIENT_AVATARMODULE__ONCMDADDAVATARSCNOTIFY_OFFSET UNITYSDK_OFFSET(0x9157970)
#define RPG_CLIENT_AVATARMODULE__ONCMDAVATAREXPUPSCRSP_OFFSET UNITYSDK_OFFSET(0x91585B0)
#define RPG_CLIENT_AVATARMODULE__ONCMDAVATARSPECIALSKILLTREEUNLOCKSCNOTIFY_OFFSET UNITYSDK_OFFSET(0x9158B30)
#define RPG_CLIENT_AVATARMODULE__ONCMDDRESSAVATARSCRSP_OFFSET UNITYSDK_OFFSET(0x91588D0)
#define RPG_CLIENT_AVATARMODULE__ONCMDDRESSAVATARSKINSCRSP_OFFSET UNITYSDK_OFFSET(0x9150D50)
#define RPG_CLIENT_AVATARMODULE__ONCMDDRESSRELICAVATARSCRSP_OFFSET UNITYSDK_OFFSET(0x91589F0)
#define RPG_CLIENT_AVATARMODULE__ONCMDGETAVATARDATASCRSP_OFFSET UNITYSDK_OFFSET(0x9155F20)
#define RPG_CLIENT_AVATARMODULE__ONCMDPLAYERSYNCSCNOTIFY_OFFSET UNITYSDK_OFFSET(0x9157740)
#define RPG_CLIENT_AVATARMODULE__ONCMDPROMOTEAVATARSCRSP_OFFSET UNITYSDK_OFFSET(0x91587A0)
#define RPG_CLIENT_AVATARMODULE__ONCMDRANKUPAVATARSCRSP_OFFSET UNITYSDK_OFFSET(0x9158990)
#define RPG_CLIENT_AVATARMODULE__ONCMDSETAVATARENHANCEDIDSCRSP_OFFSET UNITYSDK_OFFSET(0x914F4D0)
#define RPG_CLIENT_AVATARMODULE__ONCMDSETPLAYEROUTFITSCRSP_OFFSET UNITYSDK_OFFSET(0x9158BC0)
#define RPG_CLIENT_AVATARMODULE__ONCMDTAKEOFFAVATARSKINSCRSP_OFFSET UNITYSDK_OFFSET(0x9150DE0)
#define RPG_CLIENT_AVATARMODULE__ONCMDTAKEOFFEQUIPMENTSCRSP_OFFSET UNITYSDK_OFFSET(0x9158930)
#define RPG_CLIENT_AVATARMODULE__ONCMDTAKEOFFRELICSCRSP_OFFSET UNITYSDK_OFFSET(0x9158A50)
#define RPG_CLIENT_AVATARMODULE__ONCMDTAKEPROMOTIONREWARDSCRSP_OFFSET UNITYSDK_OFFSET(0x9158AB0)
#define RPG_CLIENT_AVATARMODULE__ONCMDUNLOCKAVATARSKINSCNOTIFY_OFFSET UNITYSDK_OFFSET(0x9150E70)
#define RPG_CLIENT_AVATARMODULE__ONCMDUNLOCKSKILLTREESCRSP_OFFSET UNITYSDK_OFFSET(0x9158800)
#define RPG_CLIENT_AVATARMODULE__ONGROWTHTARGETAVATARCHANGEDSCNOTIFY_OFFSET UNITYSDK_OFFSET(0x9158310)
#define RPG_CLIENT_AVATARMODULE__ONMARKAVATARSCRSP_OFFSET UNITYSDK_OFFSET(0x9157D10)
#define RPG_CLIENT_AVATARMODULE__ONSETGROWTHTARGETAVATARSCRSP_OFFSET UNITYSDK_OFFSET(0x9157DA0)
#define RPG_CLIENT_AVATARMODULE__ONWORLDLEVELUP_OFFSET UNITYSDK_OFFSET(0x9158C60)
#define RPG_CLIENT_AVATARMODULE__REFRESHUPGRADEAVATAR_OFFSET UNITYSDK_OFFSET(0x91511E0)
#define RPG_CLIENT_AVATARMODULE__SENDAVATARSYNCDATA_OFFSET UNITYSDK_OFFSET(0x9158E90)
#define RPG_CLIENT_AVATARMODULE__SETPLAYEROUTFIT_OFFSET UNITYSDK_OFFSET(0x9158FB0)
#define RPG_CLIENT_AVATARMODULE__SYNCALLAVATARS_OFFSET UNITYSDK_OFFSET(0x9156C60)
#define RPG_CLIENT_AVATARMODULE__SYNCAVATAR_OFFSET UNITYSDK_OFFSET(0x9150640)
#define RPG_CLIENT_AVATARMODULE__SYNCFORMALMULTIPATHAVATARS_OFFSET UNITYSDK_OFFSET(0x9150870)
#define RPG_CLIENT_AVATARMODULE__SYNCMULTIPATHAVATARS_OFFSET UNITYSDK_OFFSET(0x91571D0)
#define RPG_CLIENT_AVATARMODULE__UPDATEAVATARPATHSERVERDATACACHE_OFFSET UNITYSDK_OFFSET(0x91568F0)
#define RPG_CLIENT_AVATARMODULE__UPDATEAVATARROLESERVERDATACACHE_OFFSET UNITYSDK_OFFSET(0x9156580)
#define RPG_CLIENT_AVATARMODULE__UPDATENEWAVATARREDDOT_OFFSET UNITYSDK_OFFSET(0x9157B60)
#define RPG_CLIENT_AVATARMODULE___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x91592B0)
#define RPG_CLIENT_AVATARMODULE___IFIXBASEPROXY__ADDNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0x9159320)
#define RPG_CLIENT_AVATARMODULE___IFIXBASEPROXY__ADDPACKETHANDLERS_OFFSET UNITYSDK_OFFSET(0x91592C0)
...
namespace RPG::Client
{
	...
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::AvatarData*>* _AllMultiPathAvatars_k__BackingField; // 0x10
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_F3CA30716D4FAF92_4*>* _AvatarPathServerDataCache; // 0x18
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_BB4B99DE4C2501EC_3*>* _AvatarRoleServerDataCache; // 0x20
		::RPG::Client::LRUCache_2<::Struct_2_137AB23E3A00ECA1, ::RPG::Client::IAvatarSkinData*>* _AvatarSkinDataCache; // 0x28
		::System::Collections::Generic::List_1<::System::UInt32>* _EnhanceRedDotTrialStageIDs_k__BackingField; // 0x30
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::AvatarData*>* _AllAvatars_k__BackingField; // 0x38
		::RPG::GameCore::GameEntity* AvatarUI3DPageShowingAvatar; // 0x40
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::UInt32>* _AvatarRankItemIDs; // 0x48
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::AvatarData*>* _AllNoSyncPlayerMultiPathAvatars; // 0x50
		::System::Collections::Generic::List_1<::Enum_3_84F790F6B4BFF34E_1>* _GrowthTargetFuncTypeList; // 0x58
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Boolean>* _AllAvatarSkins_k__BackingField; // 0x60
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::AvatarData*>* _AllUpgradedAvatars; // 0x68
		::RPG::Client::AvatarOutfit* _PlayerOutfit_k__BackingField; // 0x70
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::AvatarData*>* _AllSpecialAvatars_k__BackingField; // 0x78
		::Class_1_15951C7ACBFF8B93* _PlayerOutfitServerAgent; // 0x80
		::System::Collections::Generic::List_1<::System::UInt32>* _EnhanceRedDotAvatarIDs_k__BackingField; // 0x88
