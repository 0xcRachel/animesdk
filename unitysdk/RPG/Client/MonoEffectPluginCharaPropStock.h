...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPSTOCK_INIT_OFFSET UNITYSDK_OFFSET(0x165F8820)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPSTOCK_UNINIT_OFFSET UNITYSDK_OFFSET(0x165F9190)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPSTOCK_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x165F88C0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPSTOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x165F92A0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPSTOCK___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x165F92D0)
