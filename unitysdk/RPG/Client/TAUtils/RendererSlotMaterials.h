...
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x180A7DD0)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALS_EQUALS_OFFSET UNITYSDK_OFFSET(0x180A7D00)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x180A7F50)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALS_METHOD_1_7223CD34BEFCBF48_OFFSET UNITYSDK_OFFSET(0x180A7AA0)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALS_METHOD_1_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0x180A7C90)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALS__CTOR_OFFSET UNITYSDK_OFFSET(0x180A7FD0)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALS___IFIXBASEPROXY_EQUALS_OFFSET UNITYSDK_OFFSET(0x180A8070)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALS___IFIXBASEPROXY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x180A8080)

namespace RPG::Client::TAUtils
{
	inline static constexpr unsigned int RendererSlotMaterials_TypeDefinitionIndex = 68742;
