...
#define RPG_CLIENT_DICECOMBATBIGAVATARCARDDISPLAYER_CREATE_OFFSET UNITYSDK_OFFSET(0x1704CBE0)
#define RPG_CLIENT_DICECOMBATBIGAVATARCARDDISPLAYER_FOCUSONSPECIALDICEICON_OFFSET UNITYSDK_OFFSET(0x1704F790)
#define RPG_CLIENT_DICECOMBATBIGAVATARCARDDISPLAYER_ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x1704FF20)
#define RPG_CLIENT_DICECOMBATBIGAVATARCARDDISPLAYER_REMOVECOLOR_OFFSET UNITYSDK_OFFSET(0x1704FAC0)
#define RPG_CLIENT_DICECOMBATBIGAVATARCARDDISPLAYER_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x1704E250)
#define RPG_CLIENT_DICECOMBATBIGAVATARCARDDISPLAYER__ASYNCLOADSPRITETO_OFFSET UNITYSDK_OFFSET(0x17050260)
#define RPG_CLIENT_DICECOMBATBIGAVATARCARDDISPLAYER__BIND_OFFSET UNITYSDK_OFFSET(0x1704CCA0)
#define RPG_CLIENT_DICECOMBATBIGAVATARCARDDISPLAYER__CCTOR_OFFSET UNITYSDK_OFFSET(0x17050690)
#define RPG_CLIENT_DICECOMBATBIGAVATARCARDDISPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1704CC90)
#define RPG_CLIENT_DICECOMBATBIGAVATARCARDDISPLAYER__ONREMOVECOLORMATTWEENTICK_OFFSET UNITYSDK_OFFSET(0x170504C0)
#define RPG_CLIENT_DICECOMBATBIGAVATARCARDDISPLAYER__SETUPAVAILABLEDICEVIEW_OFFSET UNITYSDK_OFFSET(0x1704F1A0)
#define RPG_CLIENT_DICECOMBATBIGAVATARCARDDISPLAYER__SETUPLEVELVIEW_OFFSET UNITYSDK_OFFSET(0x1704E8B0)
#define RPG_CLIENT_DICECOMBATBIGAVATARCARDDISPLAYER__SETUPREMOVECOLORMAT_OFFSET UNITYSDK_OFFSET(0x1704FB10)
#define RPG_CLIENT_DICECOMBATBIGAVATARCARDDISPLAYER__SETUPSTARVIEW_OFFSET UNITYSDK_OFFSET(0x1704EEF0)
#define RPG_CLIENT_DICECOMBATBIGAVATARCARDDISPLAYER__STARTREMOVECOLOR_OFFSET UNITYSDK_OFFSET(0x1704FDA0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(DiceCombatBigAvatarCardDisplayer_TypeDefinitionIndex)->GetStaticField(0x68EE0);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::String*>** StaticGet__LEVEL_STYLE_MAP()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(DiceCombatBigAvatarCardDisplayer_TypeDefinitionIndex)->GetStaticField(0x68EE8);
		}
		static ::System::UInt32* StaticGet__DICE_MAX_RARE()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(DiceCombatBigAvatarCardDisplayer_TypeDefinitionIndex)->GetStaticField(0x112B0);
		}
		static ::System::UInt32* StaticGet__CARD_MAX_RARE()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(DiceCombatBigAvatarCardDisplayer_TypeDefinitionIndex)->GetStaticField(0x112B4);
		}
		...
		::UnityEngine::Transform* _NodeLevel2; // 0x28
		::UnityEngine::UI::ScrollRect* _ScrollViewSkillDesc; // 0x30
		::UnityEngine::Transform* _RemoveColorMatWhiteListRoot; // 0x38
		::RPG::Client::LocalizedText* _TxtSkillDesc; // 0x40
		::UnityEngine::Transform* _NodeDiceValueItemContent; // 0x48
		::UnityEngine::UI::Image* _ImgHighLevelAvatarBg; // 0x50
		::UnityEngine::UI::Image* _ImgAvatarLevel2; // 0x58
		::UnityEngine::Material* _InstRemoveColorMat; // 0x60
		::System::Collections::Generic::List_1<::UnityEngine::Object*>* _LoadedResources; // 0x68
		::UnityEngine::UI::Image* _ImgAvatarLevel3; // 0x70
		::UnityEngine::Transform* _NodeLevel1; // 0x78
		::Il2CppArray<::UnityEngine::Transform*>* _NodeLevels; // 0x80
		::RPG::Client::LocalizedText* _TxtAvatarName; // 0x88
		::UnityEngine::UI::Image* _ImgAvatarLevelFrame3; // 0x90
		::RPG::Client::DiceCombat::IDiceCombatAvatarInfo* _AvatarInfo; // 0x98
		::Il2CppArray<::UnityEngine::UI::Image*>* _ImgLevelFrames; // 0xA0
		::UnityEngine::UI::Image* _ImgAvatarLevelFrame2; // 0xA8
		::UnityEngine::UI::Image* _ImgAvatarLevel1; // 0xB0
		::RPG::Client::MonoUIColorSwitcher* _ColorSwitcher; // 0xB8
		::Il2CppArray<::UnityEngine::Transform*>* _NodeStars; // 0xC0
		::RPG::Client::LocalizedText* _TxtDef; // 0xC8
		::RPG::Client::LocalizedText* _TxtAtk; // 0xD0
		::UnityEngine::UI::Image* _ImgAvatarLevelFrame1; // 0xD8
		::UnityEngine::Transform* _Root; // 0xE0
		::RPG::Client::LocalizedText* _TxtHp; // 0xE8
		::UnityEngine::Transform* _NodeLevel3; // 0xF0
		::RPG::Client::UIValueChangeAnimation* _ValueChanger; // 0xF8
		::System::Collections::Generic::List_1<::RPG::Client::DiceCombatDiceRarityIconDisplayer*>* _RareIconPanelList; // 0x100
