...
#define RPG_CLIENT_PROPEFFECT_METHOD_7_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0xEE0FCB0)
#define RPG_CLIENT_PROPEFFECT_METHOD_7_25DEA5C65A602671_OFFSET UNITYSDK_OFFSET(0xEE0F3A0)
#define RPG_CLIENT_PROPEFFECT_METHOD_7_82E992240300FB30_OFFSET UNITYSDK_OFFSET(0xEE0FB70)
#define RPG_CLIENT_PROPEFFECT_METHOD_7_8F059A365E90744C_OFFSET UNITYSDK_OFFSET(0xEE0FA80)
#define RPG_CLIENT_PROPEFFECT_METHOD_7_D0EAB95EE152A65F_OFFSET UNITYSDK_OFFSET(0xEE0F800)
#define RPG_CLIENT_PROPEFFECT_ONENABLE_OFFSET UNITYSDK_OFFSET(0xEE0FBC0)
#define RPG_CLIENT_PROPEFFECT_RESET_OFFSET UNITYSDK_OFFSET(0xEE0FB20)
#define RPG_CLIENT_PROPEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xEE0FC70)
#define RPG_CLIENT_PROPEFFECT___IFIXBASEPROXY_RESET_OFFSET UNITYSDK_OFFSET(0xEE0FCA0)
