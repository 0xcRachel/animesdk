...
#define RPG_CLIENT_PROPEFFECT_METHOD_7_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0x9D19AE0)
#define RPG_CLIENT_PROPEFFECT_METHOD_7_25DEA5C65A602671_OFFSET UNITYSDK_OFFSET(0x9D191D0)
#define RPG_CLIENT_PROPEFFECT_METHOD_7_82E992240300FB30_OFFSET UNITYSDK_OFFSET(0x9D199A0)
#define RPG_CLIENT_PROPEFFECT_METHOD_7_8F059A365E90744C_OFFSET UNITYSDK_OFFSET(0x9D198B0)
#define RPG_CLIENT_PROPEFFECT_METHOD_7_D0EAB95EE152A65F_OFFSET UNITYSDK_OFFSET(0x9D19630)
#define RPG_CLIENT_PROPEFFECT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9D199F0)
#define RPG_CLIENT_PROPEFFECT_RESET_OFFSET UNITYSDK_OFFSET(0x9D19950)
#define RPG_CLIENT_PROPEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x9D19AA0)
#define RPG_CLIENT_PROPEFFECT___IFIXBASEPROXY_RESET_OFFSET UNITYSDK_OFFSET(0x9D19AD0)

namespace RPG::Client
{
	inline static constexpr unsigned int PropEffect_TypeDefinitionIndex = 56336;
