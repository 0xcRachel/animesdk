...
#define RPG_CLIENT_TIMELINEITEMSINGLEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA0C23D0)

namespace RPG::Client
{
	inline static constexpr unsigned int TimelineItemSingleData_TypeDefinitionIndex = 48227;
