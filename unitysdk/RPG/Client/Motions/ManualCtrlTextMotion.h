...
#define RPG_CLIENT_MOTIONS_MANUALCTRLTEXTMOTION_METHOD_7_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x9D94FE0)
#define RPG_CLIENT_MOTIONS_MANUALCTRLTEXTMOTION_METHOD_7_D8F6D70D1D015823_OFFSET UNITYSDK_OFFSET(0x9D950E0)
#define RPG_CLIENT_MOTIONS_MANUALCTRLTEXTMOTION_METHOD_7_E2B51C21E92F614C_OFFSET UNITYSDK_OFFSET(0x9D94500)
#define RPG_CLIENT_MOTIONS_MANUALCTRLTEXTMOTION_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x9D94360)
#define RPG_CLIENT_MOTIONS_MANUALCTRLTEXTMOTION_UPDATE_OFFSET UNITYSDK_OFFSET(0x9D94EE0)
#define RPG_CLIENT_MOTIONS_MANUALCTRLTEXTMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x9D957A0)

namespace RPG::Client::Motions
{
	inline static constexpr unsigned int ManualCtrlTextMotion_TypeDefinitionIndex = 60261;
