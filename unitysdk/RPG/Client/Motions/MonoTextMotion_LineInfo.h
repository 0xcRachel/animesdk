...
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION_LINEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x169AF010)

namespace RPG::Client::Motions
{
	inline static constexpr unsigned int MonoTextMotion_LineInfo_TypeDefinitionIndex = 68640;

	class MonoTextMotion_LineInfo : public ::System::Object
	{
	public:
		::System::Int32 StartVisibleCharIndex; // 0x10
		::System::Int32 EndVisibleCharIndex; // 0x14
