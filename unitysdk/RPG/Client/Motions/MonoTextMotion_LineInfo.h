...
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION_LINEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1371BAB0)

namespace RPG::Client::Motions
{
	inline static constexpr unsigned int MonoTextMotion_LineInfo_TypeDefinitionIndex = 67682;
