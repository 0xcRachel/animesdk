...
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x183A38F0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GETEDITMODEUNDERLINEIDS_OFFSET UNITYSDK_OFFSET(0x183A3F00)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GETENTERMODEUNDERLINEIDS_OFFSET UNITYSDK_OFFSET(0x183A4180)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_BESTCOMPLEVELRECORD_OFFSET UNITYSDK_OFFSET(0x183A54A0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_BESTLEVELPASSRECORD_OFFSET UNITYSDK_OFFSET(0x183A5480)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_BRANCHCORELARGEPREFAB_OFFSET UNITYSDK_OFFSET(0x183A4E10)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_BRANCHCORESMALLPREFAB_OFFSET UNITYSDK_OFFSET(0x183A4EC0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_BRANCHICONPATH_OFFSET UNITYSDK_OFFSET(0x183A4F70)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_BRANCHID_OFFSET UNITYSDK_OFFSET(0x183A4470)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_BRANCHNAME_OFFSET UNITYSDK_OFFSET(0x183A4C50)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_BRIEFINTRO_OFFSET UNITYSDK_OFFSET(0x183A4D30)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_DESCPARAMVALUE1_OFFSET UNITYSDK_OFFSET(0x183A4810)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_DESCPARAMVALUE2_OFFSET UNITYSDK_OFFSET(0x183A4990)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_DESCPARAMVALUE3_OFFSET UNITYSDK_OFFSET(0x183A4B10)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_DICEICONPATH_OFFSET UNITYSDK_OFFSET(0x183A5020)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_EFFECTDESCPARAM1_OFFSET UNITYSDK_OFFSET(0x183A4730)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_EFFECTDESCPARAM2_OFFSET UNITYSDK_OFFSET(0x183A48B0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_EFFECTDESCPARAM3_OFFSET UNITYSDK_OFFSET(0x183A4A30)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_EFFECTDESC_OFFSET UNITYSDK_OFFSET(0x183A4490)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_EFFECTEXTRADESC_OFFSET UNITYSDK_OFFSET(0x183A4040)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_GENRETAGVALUE_OFFSET UNITYSDK_OFFSET(0x183A4BB0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_ISANYLEVELPASSED_OFFSET UNITYSDK_OFFSET(0x183A54C0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_ISFIRSTTIMEUNLOCK_OFFSET UNITYSDK_OFFSET(0x183A5320)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_ISHARDESTLEVELPASSED_OFFSET UNITYSDK_OFFSET(0x183A54D0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_PASSIVEEFFECTDESC_OFFSET UNITYSDK_OFFSET(0x183A4570)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_PASSIVEEFFECTEXTRADESC_OFFSET UNITYSDK_OFFSET(0x183A40E0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_PASSIVEEXTRADESC_OFFSET UNITYSDK_OFFSET(0x183A42C0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_RECOMMENDHASHSET_OFFSET UNITYSDK_OFFSET(0x183A5340)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_SLOTLIST_OFFSET UNITYSDK_OFFSET(0x183A51F0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_STARTINGEFFECTDESCTOAST_OFFSET UNITYSDK_OFFSET(0x183A4650)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_UNLOCKCONDITIONDESC_OFFSET UNITYSDK_OFFSET(0x183A50D0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0x183A4370)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_INIT_OFFSET UNITYSDK_OFFSET(0x183A3350)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_REFRESHFIRSTTIMEUNLOCKSTATUS_OFFSET UNITYSDK_OFFSET(0x183A3E20)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_SET_BESTCOMPLEVELRECORD_OFFSET UNITYSDK_OFFSET(0x183A54B0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_SET_BESTLEVELPASSRECORD_OFFSET UNITYSDK_OFFSET(0x183A5490)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_SET_BRANCHID_OFFSET UNITYSDK_OFFSET(0x183A4480)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_SET_ISFIRSTTIMEUNLOCK_OFFSET UNITYSDK_OFFSET(0x183A5330)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_SYNCSLOT_OFFSET UNITYSDK_OFFSET(0x183A3990)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x183A3340)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM__INITSLOTS_OFFSET UNITYSDK_OFFSET(0x183A33A0)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 _BranchID_k__BackingField; // 0x20
		::System::UInt32 _BestCompLevelRecord_k__BackingField; // 0x24
		::System::UInt32 _BestLevelPassRecord_k__BackingField; // 0x28
