...
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKDATA___C__DISPLAYCLASS42_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9360070)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKDATA___C__DISPLAYCLASS42_0___TRYASSIGNBASICEQUIP_B__0_OFFSET UNITYSDK_OFFSET(0x93609C0)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKDATA___C__DISPLAYCLASS42_0___TRYASSIGNBASICEQUIP_G___NOTAVAILABLE_2_OFFSET UNITYSDK_OFFSET(0x9360A40)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightEquipTrackData___c__DisplayClass42_0_TypeDefinitionIndex = 51929;
