...
#define RPG_CLIENT_GACHAGROUPDATAEXT_ISSINGLEPOOLGACHAGROUP_OFFSET UNITYSDK_OFFSET(0x92E8410)

namespace RPG::Client
{
	inline static constexpr unsigned int GachaGroupDataExt_TypeDefinitionIndex = 51090;
