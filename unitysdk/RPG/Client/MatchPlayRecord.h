...
#define RPG_CLIENT_MATCHPLAYRECORD_GET_ACTIVITYID_OFFSET UNITYSDK_OFFSET(0x9B2E750)
#define RPG_CLIENT_MATCHPLAYRECORD_GET_DATACASE_OFFSET UNITYSDK_OFFSET(0x9B2E7B0)
#define RPG_CLIENT_MATCHPLAYRECORD_GET_MARBLECOMMONDATA_OFFSET UNITYSDK_OFFSET(0x9B2E790)
#define RPG_CLIENT_MATCHPLAYRECORD_GET_MATCHTHREECOMMONDATA_OFFSET UNITYSDK_OFFSET(0x9B2E770)
#define RPG_CLIENT_MATCHPLAYRECORD_GET_PLAYTYPE_OFFSET UNITYSDK_OFFSET(0x9B2E730)
#define RPG_CLIENT_MATCHPLAYRECORD_SET_ACTIVITYID_OFFSET UNITYSDK_OFFSET(0x9B2E760)
#define RPG_CLIENT_MATCHPLAYRECORD_SET_DATACASE_OFFSET UNITYSDK_OFFSET(0x9B2E7C0)
#define RPG_CLIENT_MATCHPLAYRECORD_SET_MARBLECOMMONDATA_OFFSET UNITYSDK_OFFSET(0x9B2E7A0)
#define RPG_CLIENT_MATCHPLAYRECORD_SET_MATCHTHREECOMMONDATA_OFFSET UNITYSDK_OFFSET(0x9B2E780)
#define RPG_CLIENT_MATCHPLAYRECORD_SET_PLAYTYPE_OFFSET UNITYSDK_OFFSET(0x9B2E740)
#define RPG_CLIENT_MATCHPLAYRECORD_SYNC_OFFSET UNITYSDK_OFFSET(0x9B2E7D0)
#define RPG_CLIENT_MATCHPLAYRECORD__CTOR_OFFSET UNITYSDK_OFFSET(0x9B2E880)
...
namespace RPG::Client
{
	...
	public:
		...
		::Class_1_BB3B9C6F3C34D789_Enum_3_060898AA908AAA4E_10 _DataCase_k__BackingField; // 0x20
