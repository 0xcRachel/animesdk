...
#define RPG_CLIENT_STREAMINGNOTIFYMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x9FD7C10)

namespace RPG::Client
{
	inline static constexpr unsigned int StreamingNotifyMonoPlugin_TypeDefinitionIndex = 56468;
