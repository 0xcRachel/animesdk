...
#define RPG_CLIENT_AUDIENCEMOODMAPCONFIG_METHOD_3_4204875C2FA6F503_OFFSET UNITYSDK_OFFSET(0x8CA6380)
#define RPG_CLIENT_AUDIENCEMOODMAPCONFIG_METHOD_3_7BAE42DF43893E29_OFFSET UNITYSDK_OFFSET(0x8CA62D0)
#define RPG_CLIENT_AUDIENCEMOODMAPCONFIG_METHOD_3_EA0BA3E4AF50C583_OFFSET UNITYSDK_OFFSET(0x8CA6470)
#define RPG_CLIENT_AUDIENCEMOODMAPCONFIG_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x8CA6700)
#define RPG_CLIENT_AUDIENCEMOODMAPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x8CA67B0)

namespace RPG::Client
{
	inline static constexpr unsigned int AudienceMoodMapConfig_TypeDefinitionIndex = 54951;
