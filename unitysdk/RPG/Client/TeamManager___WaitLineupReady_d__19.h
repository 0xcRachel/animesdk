...
#define RPG_CLIENT_TEAMMANAGER___WAITLINEUPREADY_D__19_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x141EBE50)
#define RPG_CLIENT_TEAMMANAGER___WAITLINEUPREADY_D__19_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_WORK_IASYNCWORKSTEPRESULT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x141EBF20)
#define RPG_CLIENT_TEAMMANAGER___WAITLINEUPREADY_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x141EBF80)
#define RPG_CLIENT_TEAMMANAGER___WAITLINEUPREADY_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x141EBF30)
#define RPG_CLIENT_TEAMMANAGER___WAITLINEUPREADY_D__19_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x141EBE40)
#define RPG_CLIENT_TEAMMANAGER___WAITLINEUPREADY_D__19__CTOR_OFFSET UNITYSDK_OFFSET(0x141E1990)
