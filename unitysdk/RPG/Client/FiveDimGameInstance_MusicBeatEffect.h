...
#define RPG_CLIENT_FIVEDIMGAMEINSTANCE_MUSICBEATEFFECT_DISABLEVISUALRENDERER_OFFSET UNITYSDK_OFFSET(0x96F2740)
#define RPG_CLIENT_FIVEDIMGAMEINSTANCE_MUSICBEATEFFECT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x96F2310)
#define RPG_CLIENT_FIVEDIMGAMEINSTANCE_MUSICBEATEFFECT_ENABLEVISUALRENDERER_OFFSET UNITYSDK_OFFSET(0x96F2700)
#define RPG_CLIENT_FIVEDIMGAMEINSTANCE_MUSICBEATEFFECT_ONCHANGEMUSICINDEX_OFFSET UNITYSDK_OFFSET(0x96F2800)
#define RPG_CLIENT_FIVEDIMGAMEINSTANCE_MUSICBEATEFFECT_PAUSEVISUALEFFECT_OFFSET UNITYSDK_OFFSET(0x96F2780)
#define RPG_CLIENT_FIVEDIMGAMEINSTANCE_MUSICBEATEFFECT_PLAYVISUALEFFECT_OFFSET UNITYSDK_OFFSET(0x96F27C0)
#define RPG_CLIENT_FIVEDIMGAMEINSTANCE_MUSICBEATEFFECT_TICKMUSICCUE_OFFSET UNITYSDK_OFFSET(0x96F26B0)
#define RPG_CLIENT_FIVEDIMGAMEINSTANCE_MUSICBEATEFFECT_TICKPERBAR_OFFSET UNITYSDK_OFFSET(0x96F25F0)
#define RPG_CLIENT_FIVEDIMGAMEINSTANCE_MUSICBEATEFFECT_TICKPERBEAT_OFFSET UNITYSDK_OFFSET(0x96F23F0)
#define RPG_CLIENT_FIVEDIMGAMEINSTANCE_MUSICBEATEFFECT_TICKPERGRID_OFFSET UNITYSDK_OFFSET(0x96F2650)
#define RPG_CLIENT_FIVEDIMGAMEINSTANCE_MUSICBEATEFFECT_TICK_OFFSET UNITYSDK_OFFSET(0x96F2390)
#define RPG_CLIENT_FIVEDIMGAMEINSTANCE_MUSICBEATEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x96F22B0)
...
namespace RPG::Client
{
	...
	{
	public:
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_221*>* MusicBeatHandles; // 0x10
