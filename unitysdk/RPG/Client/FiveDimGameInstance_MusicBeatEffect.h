...
#define RPG_CLIENT_FIVEDIMGAMEINSTANCE_MUSICBEATEFFECT_DISABLEVISUALRENDERER_OFFSET UNITYSDK_OFFSET(0x11322A10)
#define RPG_CLIENT_FIVEDIMGAMEINSTANCE_MUSICBEATEFFECT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x113225E0)
#define RPG_CLIENT_FIVEDIMGAMEINSTANCE_MUSICBEATEFFECT_ENABLEVISUALRENDERER_OFFSET UNITYSDK_OFFSET(0x113229D0)
#define RPG_CLIENT_FIVEDIMGAMEINSTANCE_MUSICBEATEFFECT_ONCHANGEMUSICINDEX_OFFSET UNITYSDK_OFFSET(0x11322AD0)
#define RPG_CLIENT_FIVEDIMGAMEINSTANCE_MUSICBEATEFFECT_PAUSEVISUALEFFECT_OFFSET UNITYSDK_OFFSET(0x11322A50)
#define RPG_CLIENT_FIVEDIMGAMEINSTANCE_MUSICBEATEFFECT_PLAYVISUALEFFECT_OFFSET UNITYSDK_OFFSET(0x11322A90)
#define RPG_CLIENT_FIVEDIMGAMEINSTANCE_MUSICBEATEFFECT_TICKMUSICCUE_OFFSET UNITYSDK_OFFSET(0x11322980)
#define RPG_CLIENT_FIVEDIMGAMEINSTANCE_MUSICBEATEFFECT_TICKPERBAR_OFFSET UNITYSDK_OFFSET(0x113228C0)
#define RPG_CLIENT_FIVEDIMGAMEINSTANCE_MUSICBEATEFFECT_TICKPERBEAT_OFFSET UNITYSDK_OFFSET(0x113226C0)
#define RPG_CLIENT_FIVEDIMGAMEINSTANCE_MUSICBEATEFFECT_TICKPERGRID_OFFSET UNITYSDK_OFFSET(0x11322920)
#define RPG_CLIENT_FIVEDIMGAMEINSTANCE_MUSICBEATEFFECT_TICK_OFFSET UNITYSDK_OFFSET(0x11322660)
#define RPG_CLIENT_FIVEDIMGAMEINSTANCE_MUSICBEATEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x11322580)
