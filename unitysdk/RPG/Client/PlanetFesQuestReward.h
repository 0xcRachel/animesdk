...
#define RPG_CLIENT_PLANETFESQUESTREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x9AEF360)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesQuestReward_TypeDefinitionIndex = 53079;
