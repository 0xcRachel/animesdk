...
#define RPG_CLIENT_CAMERANAMEDDYNAMICOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x8E5EA30)

namespace RPG::Client
{
	inline static constexpr unsigned int CameraNamedDynamicOffset_TypeDefinitionIndex = 55446;
