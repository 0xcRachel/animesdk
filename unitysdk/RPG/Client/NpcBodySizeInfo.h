...
#define RPG_CLIENT_NPCBODYSIZEINFO_METHOD_1_A76089E51BD60DE9_OFFSET UNITYSDK_OFFSET(0x99FCFC0)
#define RPG_CLIENT_NPCBODYSIZEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x99FD160)

namespace RPG::Client
{
	inline static constexpr unsigned int NpcBodySizeInfo_TypeDefinitionIndex = 47568;
