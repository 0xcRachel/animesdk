...
#define RPG_CLIENT_CAMERABAKINGMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x8E53CA0)

namespace RPG::Client
{
	inline static constexpr unsigned int CameraBakingMonoPlugin_TypeDefinitionIndex = 56595;
