...
#define RPG_CLIENT_BYCANPLANETFESSKILLLEVELUP_METHOD_4_8FB9966913FBE426_OFFSET UNITYSDK_OFFSET(0x1A0E82D0)
#define RPG_CLIENT_BYCANPLANETFESSKILLLEVELUP_METHOD_4_F1400520A6A53C6C_OFFSET UNITYSDK_OFFSET(0x1A0E8200)
#define RPG_CLIENT_BYCANPLANETFESSKILLLEVELUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0E8280)
