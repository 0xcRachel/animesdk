...
#define RPG_CLIENT_BYCANPLANETFESSKILLLEVELUP_METHOD_4_38CAD2232F5B39FD_OFFSET UNITYSDK_OFFSET(0x19240790)
#define RPG_CLIENT_BYCANPLANETFESSKILLLEVELUP_METHOD_4_6CB4056184BEB819_OFFSET UNITYSDK_OFFSET(0x19240710)
#define RPG_CLIENT_BYCANPLANETFESSKILLLEVELUP_METHOD_4_8FB9966913FBE426_OFFSET UNITYSDK_OFFSET(0x192405D0)
#define RPG_CLIENT_BYCANPLANETFESSKILLLEVELUP_METHOD_4_F1400520A6A53C6C_OFFSET UNITYSDK_OFFSET(0x19240500)
#define RPG_CLIENT_BYCANPLANETFESSKILLLEVELUP__CTOR_OFFSET UNITYSDK_OFFSET(0x19240580)
