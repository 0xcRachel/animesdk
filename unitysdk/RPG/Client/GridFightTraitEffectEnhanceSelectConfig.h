...
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTENHANCESELECTCONFIG_CREATE_OFFSET UNITYSDK_OFFSET(0x98DFF10)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTENHANCESELECTCONFIG_GET_COST_OFFSET UNITYSDK_OFFSET(0x98E00E0)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTENHANCESELECTCONFIG_GET_DESC_OFFSET UNITYSDK_OFFSET(0x98E0100)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTENHANCESELECTCONFIG_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x98E0160)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTENHANCESELECTCONFIG_GET_ID_OFFSET UNITYSDK_OFFSET(0x98E00A0)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTENHANCESELECTCONFIG_GET_NAME_OFFSET UNITYSDK_OFFSET(0x98E0120)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTENHANCESELECTCONFIG_GET_SIMPLEDESC_OFFSET UNITYSDK_OFFSET(0x98E0140)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTENHANCESELECTCONFIG_GET_TRAITEFFECTID_OFFSET UNITYSDK_OFFSET(0x98E00C0)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTENHANCESELECTCONFIG_SET_COST_OFFSET UNITYSDK_OFFSET(0x98E00F0)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTENHANCESELECTCONFIG_SET_DESC_OFFSET UNITYSDK_OFFSET(0x98E0110)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTENHANCESELECTCONFIG_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x98E0170)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTENHANCESELECTCONFIG_SET_ID_OFFSET UNITYSDK_OFFSET(0x98E00B0)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTENHANCESELECTCONFIG_SET_NAME_OFFSET UNITYSDK_OFFSET(0x98E0130)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTENHANCESELECTCONFIG_SET_SIMPLEDESC_OFFSET UNITYSDK_OFFSET(0x98E0150)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTENHANCESELECTCONFIG_SET_TRAITEFFECTID_OFFSET UNITYSDK_OFFSET(0x98E00D0)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTENHANCESELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x98E0090)
