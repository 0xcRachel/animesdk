...
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEPREPAREVIEWMODEL_GET_BTNSHOWEQUIPASSEMBLE_OFFSET UNITYSDK_OFFSET(0x1994AE30)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEPREPAREVIEWMODEL_SET_BTNSHOWEQUIPASSEMBLE_OFFSET UNITYSDK_OFFSET(0x1994AE40)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEPREPAREVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1994AC10)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEPREPAREVIEWMODEL___CTOR_B__0_0_OFFSET UNITYSDK_OFFSET(0x1994AE50)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirGamePrepareViewModel_TypeDefinitionIndex = 73579;

	class PixAirGamePrepareViewModel : public ::Sofa::BaseViewModel
	{
	public:
		::RPG::Client::PixAir::PixAirPrepareContentViewModel* ContentViewModel; // 0x20
		::Class_1_17365F5FA0311FC9* _GameFlowService; // 0x28
		::RPG::Client::PixAir::PixAirGameProgressViewModel* ProgressViewModel; // 0x30
		::RPG::Client::PixAir::PixAirBattleEquipsViewModel* BattleEquipsViewModel; // 0x38
		::Class_1_D031E8F06825AB4F* _EquipService; // 0x40
		::Class_1_774B79B08DDA9E9C* _WindowService; // 0x48
		::Class_1_2FDE33CCAE591AA8* _BtnShowEquipAssemble_k__BackingField; // 0x50
