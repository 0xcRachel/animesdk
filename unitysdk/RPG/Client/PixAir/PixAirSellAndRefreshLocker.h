...
#define RPG_CLIENT_PIXAIR_PIXAIRSELLANDREFRESHLOCKER_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0x18D00BE0)
#define RPG_CLIENT_PIXAIR_PIXAIRSELLANDREFRESHLOCKER__CTOR_OFFSET UNITYSDK_OFFSET(0x18D00A20)
#define RPG_CLIENT_PIXAIR_PIXAIRSELLANDREFRESHLOCKER__LOADCONFIG_OFFSET UNITYSDK_OFFSET(0x18D00A30)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirSellAndRefreshLocker_TypeDefinitionIndex = 73669;

	class PixAirSellAndRefreshLocker : public ::System::Object
	{
	public:
		::RPG::Client::PixAir::PixAirGameSession* _Session; // 0x10
		::System::UInt32 _UnlockNodeID; // 0x18
