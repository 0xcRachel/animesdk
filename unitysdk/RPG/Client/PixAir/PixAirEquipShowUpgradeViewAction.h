...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOWUPGRADEVIEWACTION_FINISH_OFFSET UNITYSDK_OFFSET(0x199449B0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOWUPGRADEVIEWACTION_GET_NODECASE_OFFSET UNITYSDK_OFFSET(0x19944A30)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOWUPGRADEVIEWACTION_START_OFFSET UNITYSDK_OFFSET(0x19944770)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOWUPGRADEVIEWACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19944750)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOWUPGRADEVIEWACTION__ONDIALOGEXIT_OFFSET UNITYSDK_OFFSET(0x19944910)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOWUPGRADEVIEWACTION___IFIXBASEPROXY_FINISH_OFFSET UNITYSDK_OFFSET(0x19944AA0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOWUPGRADEVIEWACTION___IFIXBASEPROXY_START_OFFSET UNITYSDK_OFFSET(0x19944A40)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipShowUpgradeViewAction_TypeDefinitionIndex = 73609;
