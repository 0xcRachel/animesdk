...
#define RPG_CLIENT_PIXAIR_PIXAIRENTERBATTLELOADINGWINDOWS_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19936030)
#define RPG_CLIENT_PIXAIR_PIXAIRENTERBATTLELOADINGWINDOWS__CTOR_OFFSET UNITYSDK_OFFSET(0x19935870)
#define RPG_CLIENT_PIXAIR_PIXAIRENTERBATTLELOADINGWINDOWS__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19935D80)
#define RPG_CLIENT_PIXAIR_PIXAIRENTERBATTLELOADINGWINDOWS__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x19935910)
#define RPG_CLIENT_PIXAIR_PIXAIRENTERBATTLELOADINGWINDOWS__ONTICK_OFFSET UNITYSDK_OFFSET(0x199360A0)
#define RPG_CLIENT_PIXAIR_PIXAIRENTERBATTLELOADINGWINDOWS___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19936230)
#define RPG_CLIENT_PIXAIR_PIXAIRENTERBATTLELOADINGWINDOWS___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x199361D0)
#define RPG_CLIENT_PIXAIR_PIXAIRENTERBATTLELOADINGWINDOWS___IFIXBASEPROXY__ONTICK_OFFSET UNITYSDK_OFFSET(0x19936290)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEnterBattleLoadingWindows_TypeDefinitionIndex = 73562;

	class PixAirEnterBattleLoadingWindows : public ::Sofa::BaseSofaWindow
	{
	public:
		::UnityEngine::UI::Text* _PlayerName; // 0x40
		::UnityEngine::UI::Image* _PlayerIconImage; // 0x48
		::UnityEngine::UI::Text* _EnemyTalkContent; // 0x50
		::UnityEngine::UI::Text* _EnemyName; // 0x58
