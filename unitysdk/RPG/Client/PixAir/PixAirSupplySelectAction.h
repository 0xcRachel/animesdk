...
#define RPG_CLIENT_PIXAIR_PIXAIRSUPPLYSELECTACTION_FINISHSUPPLYSTAGE_OFFSET UNITYSDK_OFFSET(0x18D030A0)
#define RPG_CLIENT_PIXAIR_PIXAIRSUPPLYSELECTACTION_FINISH_OFFSET UNITYSDK_OFFSET(0x18D02E20)
#define RPG_CLIENT_PIXAIR_PIXAIRSUPPLYSELECTACTION_GETCONTENTKEY_OFFSET UNITYSDK_OFFSET(0x18D032B0)
#define RPG_CLIENT_PIXAIR_PIXAIRSUPPLYSELECTACTION_GET_DISPLAYEQUIPITEM_OFFSET UNITYSDK_OFFSET(0x18D03320)
#define RPG_CLIENT_PIXAIR_PIXAIRSUPPLYSELECTACTION_GET_NODECASE_OFFSET UNITYSDK_OFFSET(0x18D03330)
#define RPG_CLIENT_PIXAIR_PIXAIRSUPPLYSELECTACTION_START_OFFSET UNITYSDK_OFFSET(0x18D02DC0)
#define RPG_CLIENT_PIXAIR_PIXAIRSUPPLYSELECTACTION_TAKEREWARD_OFFSET UNITYSDK_OFFSET(0x18D02E90)
#define RPG_CLIENT_PIXAIR_PIXAIRSUPPLYSELECTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18D02D80)
#define RPG_CLIENT_PIXAIR_PIXAIRSUPPLYSELECTACTION___IFIXBASEPROXY_FINISH_OFFSET UNITYSDK_OFFSET(0x18D033A0)
#define RPG_CLIENT_PIXAIR_PIXAIRSUPPLYSELECTACTION___IFIXBASEPROXY_GETCONTENTKEY_OFFSET UNITYSDK_OFFSET(0x18D03410)
#define RPG_CLIENT_PIXAIR_PIXAIRSUPPLYSELECTACTION___IFIXBASEPROXY_START_OFFSET UNITYSDK_OFFSET(0x18D03340)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirSupplySelectAction_TypeDefinitionIndex = 73620;
