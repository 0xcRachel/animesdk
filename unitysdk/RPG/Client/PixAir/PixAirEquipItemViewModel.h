...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_BAGSLOTINDEX_OFFSET UNITYSDK_OFFSET(0x1992FBE0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_BATTLESLOTINDEX_OFFSET UNITYSDK_OFFSET(0x19932BD0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_BURNPOWER_OFFSET UNITYSDK_OFFSET(0x19942860)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_CDPROGRESS_OFFSET UNITYSDK_OFFSET(0x199428B0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_DAMAGEPOWER_OFFSET UNITYSDK_OFFSET(0x199427C0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_ISLARGESLOT_OFFSET UNITYSDK_OFFSET(0x199427B0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x19942420)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_POS_OFFSET UNITYSDK_OFFSET(0x19942790)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_SHIELDPOWER_OFFSET UNITYSDK_OFFSET(0x19942810)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1992F910)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipItemViewModel_TypeDefinitionIndex = 73578;

	class PixAirEquipItemViewModel : public ::Sofa::BaseViewModel
	{
	public:
		// static const ::System::UInt32 PreSlotSize = 0xB; // 0x0
		::RPG::Client::PixAir::Legacy::PixAirEquipDisplayData* EquipDisplayData; // 0x20
		::Class_1_9E825E3D3A62B6E0* _EquipItem; // 0x28
		::Class_1_CC76D1702CC17C09_8* _EquipProperty; // 0x30
		::Class_0_16E4307DCC419505_1207* _EquipPropertyGetter; // 0x38
