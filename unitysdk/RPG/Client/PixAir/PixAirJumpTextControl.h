...
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18CECFB0)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x18CED5F0)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL__GETDISPLAYTEXT_OFFSET UNITYSDK_OFFSET(0x18CED250)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL__GETSIZESTATENAME_OFFSET UNITYSDK_OFFSET(0x18CED4F0)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL__GETTYPESTATENAME_OFFSET UNITYSDK_OFFSET(0x18CED3F0)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL__ONANIMATIONEND_OFFSET UNITYSDK_OFFSET(0x18CECF40)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18CECE40)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x18CECA50)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL__PLAYUISTATE_OFFSET UNITYSDK_OFFSET(0x18CED1A0)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL__REFRESHDISPLAY_OFFSET UNITYSDK_OFFSET(0x18CECE90)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL__REGISTERANIMATIONEVENT_OFFSET UNITYSDK_OFFSET(0x18CECD60)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL__SETALLTEXTVALUES_OFFSET UNITYSDK_OFFSET(0x18CED020)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18CED680)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x18CED620)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirJumpTextControl_TypeDefinitionIndex = 73568;
