...
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEPROGRESSVIEWMODEL_GET_NODEVIEWMODELS_OFFSET UNITYSDK_OFFSET(0x1994C1A0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEPROGRESSVIEWMODEL_SET_NODEVIEWMODELS_OFFSET UNITYSDK_OFFSET(0x1994C1B0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEPROGRESSVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1994AD20)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirGameProgressViewModel_TypeDefinitionIndex = 73581;

	class PixAirGameProgressViewModel : public ::Sofa::BaseViewModel
	{
	public:
		::Class_1_774B79B08DDA9E9C* _WindowService; // 0x20
		...
		::System::UInt32 CurAreaID; // 0x38
		::System::UInt32 CurNodeID; // 0x3C
