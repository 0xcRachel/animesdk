...
#define RPG_CLIENT_PIXAIR_PIXAIRLEVELPROGRESSVIEW_LINEPROGRESSUPDATEVIEWER_FORCETOEND_OFFSET UNITYSDK_OFFSET(0x18CEE6E0)
#define RPG_CLIENT_PIXAIR_PIXAIRLEVELPROGRESSVIEW_LINEPROGRESSUPDATEVIEWER_UPDATE_OFFSET UNITYSDK_OFFSET(0x18CEE590)
#define RPG_CLIENT_PIXAIR_PIXAIRLEVELPROGRESSVIEW_LINEPROGRESSUPDATEVIEWER__CTOR_OFFSET UNITYSDK_OFFSET(0x18CEE500)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirLevelProgressView_LineProgressUpdateViewer_TypeDefinitionIndex = 73712;
