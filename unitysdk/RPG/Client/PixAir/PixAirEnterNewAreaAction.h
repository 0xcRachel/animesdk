...
#define RPG_CLIENT_PIXAIR_PIXAIRENTERNEWAREAACTION_RECORDCHANGE_OFFSET UNITYSDK_OFFSET(0x199373C0)
#define RPG_CLIENT_PIXAIR_PIXAIRENTERNEWAREAACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19937C10)
#define RPG_CLIENT_PIXAIR_PIXAIRENTERNEWAREAACTION__RECORDBASICCHANGE_OFFSET UNITYSDK_OFFSET(0x19937870)
#define RPG_CLIENT_PIXAIR_PIXAIRENTERNEWAREAACTION__RECORDSLOTNUMCHANGE_OFFSET UNITYSDK_OFFSET(0x19937BB0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEnterNewAreaAction_TypeDefinitionIndex = 73601;

	class PixAirEnterNewAreaAction : public ::System::Object
	{
	public:
		::System::Int32 _TempMaxHp; // 0x10
		::System::Int32 _TempCoin; // 0x14
		::System::Int32 AddMaxHp; // 0x18
		::System::Int32 AddSlotNum; // 0x1C
