...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x1993EE70)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL_GET_CLOSECOMMAND_OFFSET UNITYSDK_OFFSET(0x1993F310)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL_GET_COOLDOWN_OFFSET UNITYSDK_OFFSET(0x1993E8D0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1993F260)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL_GET_ISPLAYEREQUIPPED_OFFSET UNITYSDK_OFFSET(0x199348D0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1993E810)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL_GET_SKILLDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1993E870)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL_GET_STARLEVEL_OFFSET UNITYSDK_OFFSET(0x1993F2C0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL_GET_TAGS_OFFSET UNITYSDK_OFFSET(0x1993EAB0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL_SET_CLOSECOMMAND_OFFSET UNITYSDK_OFFSET(0x1993F320)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1993EF30)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL__INIT_OFFSET UNITYSDK_OFFSET(0x1993EF50)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL__ONCLOSE_OFFSET UNITYSDK_OFFSET(0x1993F1D0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL__ONGHOSTPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1993F0E0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipInfoViewModel_TypeDefinitionIndex = 73587;
