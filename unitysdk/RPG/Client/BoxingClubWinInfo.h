...
#define RPG_CLIENT_BOXINGCLUBWININFO__CTOR_OFFSET UNITYSDK_OFFSET(0x8E03DF0)

namespace RPG::Client
{
	inline static constexpr unsigned int BoxingClubWinInfo_TypeDefinitionIndex = 49974;
