...
#define RPG_CLIENT_PLANETFESINCOMECHANGEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x9AD2FE0)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesIncomeChangeEvent_TypeDefinitionIndex = 53074;
