...
#define RPG_CLIENT_SAMFLIPCONTROLLER_COMPARETO_OFFSET UNITYSDK_OFFSET(0xA422000)
#define RPG_CLIENT_SAMFLIPCONTROLLER_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xA421D80)
#define RPG_CLIENT_SAMFLIPCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA421B00)
#define RPG_CLIENT_SAMFLIPCONTROLLER_METHOD_5_0D262735D01CAB97_OFFSET UNITYSDK_OFFSET(0xA421D90)
#define RPG_CLIENT_SAMFLIPCONTROLLER_PROCESS_OFFSET UNITYSDK_OFFSET(0xA421BA0)
#define RPG_CLIENT_SAMFLIPCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA4220E0)
