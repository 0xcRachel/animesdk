...
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_AVATARDATA_OFFSET UNITYSDK_OFFSET(0x171D3780)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_BATTLEEVENTSKILLDESCSIMPLE_OFFSET UNITYSDK_OFFSET(0x171D38E0)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_BATTLEEVENTSKILLDESC_OFFSET UNITYSDK_OFFSET(0x171D38B0)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_BATTLEEVENTSKILLPARAMLIST_OFFSET UNITYSDK_OFFSET(0x171D3910)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_ENERGYCOLLECTIONDESCSIMPLE_OFFSET UNITYSDK_OFFSET(0x171D3860)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_ENERGYCOLLECTIONDESC_OFFSET UNITYSDK_OFFSET(0x171D3830)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_ENERGYCOLLECTIONPARAMLIST_OFFSET UNITYSDK_OFFSET(0x171D3890)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_GIFTIMAGEPATH_OFFSET UNITYSDK_OFFSET(0x171D3810)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_GIFTNAME_OFFSET UNITYSDK_OFFSET(0x171D37E0)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0x171D37A0)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_MODIFIEDSKILLDESCSIMPLE_OFFSET UNITYSDK_OFFSET(0x171D3960)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_MODIFIEDSKILLDESC_OFFSET UNITYSDK_OFFSET(0x171D3930)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_MODIFIEDSKILLPARAMLIST_OFFSET UNITYSDK_OFFSET(0x171D3990)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_SPECIALAVATARID_OFFSET UNITYSDK_OFFSET(0x171D37C0)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_TAG_OFFSET UNITYSDK_OFFSET(0x171D39B0)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_SET_AVATARDATA_OFFSET UNITYSDK_OFFSET(0x171D3790)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x171D39E0)
