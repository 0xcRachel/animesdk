...
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKUTILS___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9361160)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKUTILS___C__DISPLAYCLASS5_0__ISROLEEQUIPPEDWITH_B__0_OFFSET UNITYSDK_OFFSET(0x9361C90)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKUTILS___C__DISPLAYCLASS5_0__ISROLEEQUIPPEDWITH_B__1_OFFSET UNITYSDK_OFFSET(0x9361CD0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightEquipTrackUtils___c__DisplayClass5_0_TypeDefinitionIndex = 51939;
