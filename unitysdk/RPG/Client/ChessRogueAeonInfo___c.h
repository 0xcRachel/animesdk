...
#define RPG_CLIENT_CHESSROGUEAEONINFO___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x17B3A750)
#define RPG_CLIENT_CHESSROGUEAEONINFO___C__CTOR_OFFSET UNITYSDK_OFFSET(0x17B3A790)
#define RPG_CLIENT_CHESSROGUEAEONINFO___C__GETCHESSROGUEAEONSORTEDDATA_B__7_0_OFFSET UNITYSDK_OFFSET(0x17B3A7A0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Func_2<::RPG::Client::ChessRogueAeonDataItem*, ::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(ChessRogueAeonInfo___c_TypeDefinitionIndex)->GetStaticField(0x5F230);
		}
		static ::RPG::Client::ChessRogueAeonInfo___c** StaticGet___9()
		{
			return (::RPG::Client::ChessRogueAeonInfo___c**)Il2CppClass::FromTypeDefinitionIndex(ChessRogueAeonInfo___c_TypeDefinitionIndex)->GetStaticField(0x5F238);
		}
