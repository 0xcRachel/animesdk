...
#define RPG_CLIENT_A4SKYDOMEEFFECTCONTROLMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x8ACD5C0)
#define RPG_CLIENT_A4SKYDOMEEFFECTCONTROLMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x8ACD610)
#define RPG_CLIENT_A4SKYDOMEEFFECTCONTROLMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x8ACD620)

namespace RPG::Client
{
	inline static constexpr unsigned int A4SkyDomeEffectControlMonoPlugin_TypeDefinitionIndex = 56479;
