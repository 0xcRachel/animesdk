...
#define RPG_CLIENT_PROPINSTANCEMATFLOATCONFIG_METHOD_2_1ECFB1C19B577E7A_OFFSET UNITYSDK_OFFSET(0x171441B0)
#define RPG_CLIENT_PROPINSTANCEMATFLOATCONFIG_METHOD_2_2313F2256728F710_OFFSET UNITYSDK_OFFSET(0x17144130)
#define RPG_CLIENT_PROPINSTANCEMATFLOATCONFIG_METHOD_2_7033EFB970A18315_OFFSET UNITYSDK_OFFSET(0x17144010)
#define RPG_CLIENT_PROPINSTANCEMATFLOATCONFIG_METHOD_2_8DF68C4BE895E6C3_OFFSET UNITYSDK_OFFSET(0x17143640)
#define RPG_CLIENT_PROPINSTANCEMATFLOATCONFIG_METHOD_2_90D369AA14AFEE1C_OFFSET UNITYSDK_OFFSET(0x17144090)
#define RPG_CLIENT_PROPINSTANCEMATFLOATCONFIG_METHOD_2_BF5FC31AA577C76F_OFFSET UNITYSDK_OFFSET(0x171442A0)
#define RPG_CLIENT_PROPINSTANCEMATFLOATCONFIG_METHOD_2_F1E2CFDA70BD4DCE_OFFSET UNITYSDK_OFFSET(0x17144250)
#define RPG_CLIENT_PROPINSTANCEMATFLOATCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17144240)
