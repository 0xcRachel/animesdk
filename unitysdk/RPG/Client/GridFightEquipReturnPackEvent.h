...
#define RPG_CLIENT_GRIDFIGHTEQUIPRETURNPACKEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x9354D70)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightEquipReturnPackEvent_TypeDefinitionIndex = 51577;
