...
#define RPG_CLIENT_MONOHANDKILLTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x9830830)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoHandKillTrigger_TypeDefinitionIndex = 54616;
