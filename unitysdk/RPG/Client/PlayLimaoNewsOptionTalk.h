...
#define RPG_CLIENT_PLAYLIMAONEWSOPTIONTALK_METHOD_3_570329A0FC2B4A05_OFFSET UNITYSDK_OFFSET(0x1884EEA0)
#define RPG_CLIENT_PLAYLIMAONEWSOPTIONTALK_METHOD_3_936C50083A1FD7D4_OFFSET UNITYSDK_OFFSET(0x1884EF20)
#define RPG_CLIENT_PLAYLIMAONEWSOPTIONTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1884EEF0)
