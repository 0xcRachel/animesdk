...
#define RPG_CLIENT_ST_PARKOUR_BYCOMPARERANK_METHOD_4_1FDE4693B0DDE6D9_OFFSET UNITYSDK_OFFSET(0x1676CA90)
#define RPG_CLIENT_ST_PARKOUR_BYCOMPARERANK_METHOD_4_911084033AD37B3F_OFFSET UNITYSDK_OFFSET(0x1676CB60)
#define RPG_CLIENT_ST_PARKOUR_BYCOMPARERANK__CTOR_OFFSET UNITYSDK_OFFSET(0x1676CB10)
