...
#define RPG_CLIENT_MODELUI3DMODECONSTRAINT_AWAKE_OFFSET UNITYSDK_OFFSET(0x152B23D0)
#define RPG_CLIENT_MODELUI3DMODECONSTRAINT_INIT_OFFSET UNITYSDK_OFFSET(0x152B2B30)
#define RPG_CLIENT_MODELUI3DMODECONSTRAINT_LOGICUPDATE_OFFSET UNITYSDK_OFFSET(0x152B2E30)
#define RPG_CLIENT_MODELUI3DMODECONSTRAINT_METHOD_5_ECA33935490AF2E4_OFFSET UNITYSDK_OFFSET(0x152B26B0)
#define RPG_CLIENT_MODELUI3DMODECONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0x152B3350)
