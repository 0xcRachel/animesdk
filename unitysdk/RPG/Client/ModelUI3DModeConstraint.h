...
#define RPG_CLIENT_MODELUI3DMODECONSTRAINT_AWAKE_OFFSET UNITYSDK_OFFSET(0x12A24BA0)
#define RPG_CLIENT_MODELUI3DMODECONSTRAINT_INIT_OFFSET UNITYSDK_OFFSET(0x12A25260)
#define RPG_CLIENT_MODELUI3DMODECONSTRAINT_LOGICUPDATE_OFFSET UNITYSDK_OFFSET(0x12A25570)
#define RPG_CLIENT_MODELUI3DMODECONSTRAINT_METHOD_5_EE7339DA6ECF5F6D_OFFSET UNITYSDK_OFFSET(0x12A24E60)
#define RPG_CLIENT_MODELUI3DMODECONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0x12A25AC0)
