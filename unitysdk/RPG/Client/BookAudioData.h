...
#define RPG_CLIENT_BOOKAUDIODATA_GET_AUDIOEVENT_OFFSET UNITYSDK_OFFSET(0x8DF7BE0)
#define RPG_CLIENT_BOOKAUDIODATA_GET_HASAUDIO_OFFSET UNITYSDK_OFFSET(0x8DF7BD0)
#define RPG_CLIENT_BOOKAUDIODATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8DF7780)

namespace RPG::Client
{
	inline static constexpr unsigned int BookAudioData_TypeDefinitionIndex = 52856;
