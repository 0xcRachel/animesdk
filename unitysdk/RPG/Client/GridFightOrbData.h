...
#define RPG_CLIENT_GRIDFIGHTORBDATA_CLEARCOUNT_OFFSET UNITYSDK_OFFSET(0x19776900)
#define RPG_CLIENT_GRIDFIGHTORBDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x19776750)
#define RPG_CLIENT_GRIDFIGHTORBDATA_GET_BONUSID_OFFSET UNITYSDK_OFFSET(0x19776A00)
#define RPG_CLIENT_GRIDFIGHTORBDATA_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x19776990)
#define RPG_CLIENT_GRIDFIGHTORBDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x19776AE0)
#define RPG_CLIENT_GRIDFIGHTORBDATA_GET_ORBID_OFFSET UNITYSDK_OFFSET(0x197769A0)
#define RPG_CLIENT_GRIDFIGHTORBDATA_GET_ORBNAME_OFFSET UNITYSDK_OFFSET(0x19776A60)
#define RPG_CLIENT_GRIDFIGHTORBDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x19775B80)
#define RPG_CLIENT_GRIDFIGHTORBDATA_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x19776890)
#define RPG_CLIENT_GRIDFIGHTORBDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19776870)
