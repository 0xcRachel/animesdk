...
#define RPG_CLIENT_IKHITREACTIONSPINE__CTOR_OFFSET UNITYSDK_OFFSET(0x94C0780)

namespace RPG::Client
{
	inline static constexpr unsigned int IKHitReactionSpine_TypeDefinitionIndex = 54328;
