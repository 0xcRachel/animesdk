...
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8FEBA40)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_GET_ENTITYREF_OFFSET UNITYSDK_OFFSET(0x8FEB380)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_GET_FROMPOINT_OFFSET UNITYSDK_OFFSET(0x8FEB430)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_GET_GRAPH_OFFSET UNITYSDK_OFFSET(0x8FEB340)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_GET_ISARRIVED_OFFSET UNITYSDK_OFFSET(0x8FEB400)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_GET_ISBLOCKED_OFFSET UNITYSDK_OFFSET(0x8FEB390)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_GET_ISMOVING_OFFSET UNITYSDK_OFFSET(0x8FEB3F0)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_GET_ISTRANSITION_OFFSET UNITYSDK_OFFSET(0x8FE71D0)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_GET_LOCSTATUS_OFFSET UNITYSDK_OFFSET(0x8FEB460)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_GET_MANAGER_OFFSET UNITYSDK_OFFSET(0x8FEB320)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_GET_MOVABLEOBJECT_OFFSET UNITYSDK_OFFSET(0x8FEB360)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_GET_MOVEDIRECTION_OFFSET UNITYSDK_OFFSET(0x8FEB450)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_GET_PERCENT_OFFSET UNITYSDK_OFFSET(0x8FEB420)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_GET_SPEED_OFFSET UNITYSDK_OFFSET(0x8FEB410)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_GET_TOPOINT_OFFSET UNITYSDK_OFFSET(0x8FEB440)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_0F59EC33A00E0D87_OFFSET UNITYSDK_OFFSET(0x8FE9EF0)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_0FD0EC313FAAB75A_OFFSET UNITYSDK_OFFSET(0x8FE8450)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_1749C9009A08FDA0_OFFSET UNITYSDK_OFFSET(0x8FE6EB0)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_1E1FFD875CA8014A_OFFSET UNITYSDK_OFFSET(0x8FE9310)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_5587AE4B03E68C58_OFFSET UNITYSDK_OFFSET(0x8FE8ED0)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_59AFC7A1199E1551_OFFSET UNITYSDK_OFFSET(0x8FE8A40)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_5E1F1C56DAD337FB_OFFSET UNITYSDK_OFFSET(0x8FEBE10)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_7AEA4B2B25797605_OFFSET UNITYSDK_OFFSET(0x8FE6DF0)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_8BD28CA07EC47CDB_OFFSET UNITYSDK_OFFSET(0x8FEBC90)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_8DFD97677BBDF0B1_OFFSET UNITYSDK_OFFSET(0x8FE7900)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_8FAD57395F26ACC4_OFFSET UNITYSDK_OFFSET(0x8FEB0C0)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_9133398E73B9D974_OFFSET UNITYSDK_OFFSET(0x8FE9000)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_946BB4FEA1D1E31E_OFFSET UNITYSDK_OFFSET(0x8FE7860)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_AFFC2EC55FECB4CD_OFFSET UNITYSDK_OFFSET(0x8FEA6D0)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_C3DEB36A8C3E2BA5_OFFSET UNITYSDK_OFFSET(0x8FE8F50)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_C733F4B13025CACB_OFFSET UNITYSDK_OFFSET(0x8FE8820)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_CCBE8E3D38E773EF_OFFSET UNITYSDK_OFFSET(0x8FE8D50)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_D56DAA96379ECAB9_OFFSET UNITYSDK_OFFSET(0x8FE9410)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_DC4ED6DB5B93D711_OFFSET UNITYSDK_OFFSET(0x8FE72B0)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_DE3F7DF9E0B52E1C_OFFSET UNITYSDK_OFFSET(0x8FEB160)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_FB0C35914DD39E44_OFFSET UNITYSDK_OFFSET(0x8FE9720)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_SET_GRAPH_OFFSET UNITYSDK_OFFSET(0x8FEB350)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_SET_MANAGER_OFFSET UNITYSDK_OFFSET(0x8FEB330)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_SET_MOVABLEOBJECT_OFFSET UNITYSDK_OFFSET(0x8FEB370)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8FEB610)

namespace RPG::Client
{
	inline static constexpr unsigned int CurveMovementHandler_TypeDefinitionIndex = 54405;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_5587AE4B03E68C58_OFFSET))(this);
		}
