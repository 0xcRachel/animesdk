...
#define RPG_CLIENT_ASSISTDATA_CLONE_OFFSET UNITYSDK_OFFSET(0x90EB150)
#define RPG_CLIENT_ASSISTDATA_CREATE_1_OFFSET UNITYSDK_OFFSET(0x90EB0E0)
#define RPG_CLIENT_ASSISTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x90EAF40)
#define RPG_CLIENT_ASSISTDATA_GET_AVATARDATA_OFFSET UNITYSDK_OFFSET(0x90EAE90)
#define RPG_CLIENT_ASSISTDATA_GET_AVATAR_OFFSET UNITYSDK_OFFSET(0x90EAF20)
#define RPG_CLIENT_ASSISTDATA_SET_AVATARDATA_OFFSET UNITYSDK_OFFSET(0x90EAED0)
#define RPG_CLIENT_ASSISTDATA_SET_AVATAR_OFFSET UNITYSDK_OFFSET(0x90EAF30)
#define RPG_CLIENT_ASSISTDATA_SYNCDATA_OFFSET UNITYSDK_OFFSET(0x90EAFC0)
#define RPG_CLIENT_ASSISTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x90EAFB0)
