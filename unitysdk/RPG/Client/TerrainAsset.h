...
#define RPG_CLIENT_TERRAINASSET_ADDBYKEYWORDS_OFFSET UNITYSDK_OFFSET(0xA06D8D0)
#define RPG_CLIENT_TERRAINASSET_AWAKE_OFFSET UNITYSDK_OFFSET(0xA06C920)
#define RPG_CLIENT_TERRAINASSET_GETPREFABNAME_OFFSET UNITYSDK_OFFSET(0xA06D840)
#define RPG_CLIENT_TERRAINASSET_LOAD_OFFSET UNITYSDK_OFFSET(0xA06C970)
#define RPG_CLIENT_TERRAINASSET_METHOD_5_2BEB3887295B939A_OFFSET UNITYSDK_OFFSET(0xA06CDB0)
#define RPG_CLIENT_TERRAINASSET_METHOD_5_7F29568EA964E563_OFFSET UNITYSDK_OFFSET(0xA06CF70)
#define RPG_CLIENT_TERRAINASSET_SETBLOCKPROPERTY_OFFSET UNITYSDK_OFFSET(0xA06D890)
#define RPG_CLIENT_TERRAINASSET_START_OFFSET UNITYSDK_OFFSET(0xA06CD60)
#define RPG_CLIENT_TERRAINASSET__CCTOR_OFFSET UNITYSDK_OFFSET(0xA06DBF0)
#define RPG_CLIENT_TERRAINASSET__CTOR_OFFSET UNITYSDK_OFFSET(0xA06DB40)

namespace RPG::Client
{
	inline static constexpr unsigned int TerrainAsset_TypeDefinitionIndex = 54720;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(TerrainAsset_TypeDefinitionIndex)->GetStaticField(0x83F0);
		}
