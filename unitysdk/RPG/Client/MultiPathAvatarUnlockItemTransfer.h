...
#define RPG_CLIENT_MULTIPATHAVATARUNLOCKITEMTRANSFER_GET_TRANSFERDESC_OFFSET UNITYSDK_OFFSET(0x169C6980)
#define RPG_CLIENT_MULTIPATHAVATARUNLOCKITEMTRANSFER_GET_TRANSFERTITLE_OFFSET UNITYSDK_OFFSET(0x169C6950)
#define RPG_CLIENT_MULTIPATHAVATARUNLOCKITEMTRANSFER__CTOR_OFFSET UNITYSDK_OFFSET(0x169C6890)
