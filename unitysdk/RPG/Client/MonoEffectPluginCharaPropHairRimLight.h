...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPHAIRRIMLIGHT_INIT_OFFSET UNITYSDK_OFFSET(0x97E26D0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPHAIRRIMLIGHT_UNINIT_OFFSET UNITYSDK_OFFSET(0x97E2F70)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPHAIRRIMLIGHT_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x97E2770)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPHAIRRIMLIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x97E3010)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPHAIRRIMLIGHT___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x97E3030)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPHAIRRIMLIGHT___IFIXBASEPROXY_UNINIT_OFFSET UNITYSDK_OFFSET(0x97E3040)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropHairRimLight_TypeDefinitionIndex = 55675;
