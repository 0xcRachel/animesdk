...
#define RPG_CLIENT_GRIDFIGHTUPGRADEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x174434F0)
...
namespace RPG::Client
{
	...
	{
	public:
		::RPG::Client::GridFightRole* UpgradedRole; // 0x10
		::RPG::Client::GridFightRole* SecondRemovedRole; // 0x18
		::RPG::Client::GridFightRole* FirstRemovedRole; // 0x20
