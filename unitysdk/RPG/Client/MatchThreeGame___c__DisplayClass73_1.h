...
#define RPG_CLIENT_MATCHTHREEGAME___C__DISPLAYCLASS73_1__CTOR_OFFSET UNITYSDK_OFFSET(0x9661A80)
#define RPG_CLIENT_MATCHTHREEGAME___C__DISPLAYCLASS73_1___UPDATEPLAYER_B__1_OFFSET UNITYSDK_OFFSET(0x96652D0)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeGame___c__DisplayClass73_1_TypeDefinitionIndex = 52434;

	class MatchThreeGame___c__DisplayClass73_1 : public ::System::Object
	{
	public:
		::Class_1_FA4F4A67B1C04320_280* itemInfo; // 0x10
