...
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0x18930E80)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_FRONTBACKTYPE_OFFSET UNITYSDK_OFFSET(0x18930E60)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_HEADICONPATH_OFFSET UNITYSDK_OFFSET(0x189310B0)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_ID_OFFSET UNITYSDK_OFFSET(0x18930E20)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_ISEXPERT_OFFSET UNITYSDK_OFFSET(0x18930EA0)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_MINIROUNDICONPATH_OFFSET UNITYSDK_OFFSET(0x18931220)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_NAMETEXTID_OFFSET UNITYSDK_OFFSET(0x18931520)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_RARITY_OFFSET UNITYSDK_OFFSET(0x18930E40)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_ROUNDICONPATH_OFFSET UNITYSDK_OFFSET(0x189313A0)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_SHOPICONPATH_OFFSET UNITYSDK_OFFSET(0x18930ED0)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_TRAITIDS_OFFSET UNITYSDK_OFFSET(0x18930EB0)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18930DD0)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG__GETEXPIREDHEADICONPATH_OFFSET UNITYSDK_OFFSET(0x189310C0)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG__GETEXPIREDNAMETEXTID_OFFSET UNITYSDK_OFFSET(0x18931590)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG__GETEXPIREDSHOPICONPATH_OFFSET UNITYSDK_OFFSET(0x18930EE0)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG__GETMINIROUNDICONPATH_OFFSET UNITYSDK_OFFSET(0x18931230)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG__GETROUNDICONPATH_OFFSET UNITYSDK_OFFSET(0x189313B0)
