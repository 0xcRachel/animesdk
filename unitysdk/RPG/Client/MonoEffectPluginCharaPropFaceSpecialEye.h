...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACESPECIALEYE_INIT_OFFSET UNITYSDK_OFFSET(0x9CC3820)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACESPECIALEYE_UNINIT_OFFSET UNITYSDK_OFFSET(0x9CC3FB0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACESPECIALEYE_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x9CC38C0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACESPECIALEYE__CTOR_OFFSET UNITYSDK_OFFSET(0x9CC4050)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACESPECIALEYE___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x9CC4090)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACESPECIALEYE___IFIXBASEPROXY_UNINIT_OFFSET UNITYSDK_OFFSET(0x9CC40A0)
