...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACESPECIALEYE_INIT_OFFSET UNITYSDK_OFFSET(0x97E1DE0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACESPECIALEYE_UNINIT_OFFSET UNITYSDK_OFFSET(0x97E2570)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACESPECIALEYE_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x97E1E80)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACESPECIALEYE__CTOR_OFFSET UNITYSDK_OFFSET(0x97E2610)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACESPECIALEYE___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x97E2650)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACESPECIALEYE___IFIXBASEPROXY_UNINIT_OFFSET UNITYSDK_OFFSET(0x97E2660)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropFaceSpecialEye_TypeDefinitionIndex = 55674;
