...
#define RPG_CLIENT_MONOEFFECTPLUGINTRANSFORM_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x980AFA0)
#define RPG_CLIENT_MONOEFFECTPLUGINTRANSFORM_METHOD_5_00DEF5A164D9A9D5_OFFSET UNITYSDK_OFFSET(0x980B230)
#define RPG_CLIENT_MONOEFFECTPLUGINTRANSFORM_METHOD_5_DAEB67F34AF80609_OFFSET UNITYSDK_OFFSET(0x980B000)
#define RPG_CLIENT_MONOEFFECTPLUGINTRANSFORM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x980B800)
#define RPG_CLIENT_MONOEFFECTPLUGINTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x980B8A0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginTransform_TypeDefinitionIndex = 55823;
