...
#define RPG_CLIENT_MONOEFFECTPLUGINTRANSFORM_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x11672FB0)
#define RPG_CLIENT_MONOEFFECTPLUGINTRANSFORM_METHOD_5_00DEF5A164D9A9D5_OFFSET UNITYSDK_OFFSET(0x11673240)
#define RPG_CLIENT_MONOEFFECTPLUGINTRANSFORM_METHOD_5_DAEB67F34AF80609_OFFSET UNITYSDK_OFFSET(0x11673010)
#define RPG_CLIENT_MONOEFFECTPLUGINTRANSFORM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x11673810)
#define RPG_CLIENT_MONOEFFECTPLUGINTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x116738B0)
