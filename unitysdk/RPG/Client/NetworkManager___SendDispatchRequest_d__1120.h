...
#define RPG_CLIENT_NETWORKMANAGER___SENDDISPATCHREQUEST_D__1120_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x9E93BE0)
#define RPG_CLIENT_NETWORKMANAGER___SENDDISPATCHREQUEST_D__1120_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x9E94130)
#define RPG_CLIENT_NETWORKMANAGER___SENDDISPATCHREQUEST_D__1120_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x9E94190)
#define RPG_CLIENT_NETWORKMANAGER___SENDDISPATCHREQUEST_D__1120_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x9E94140)
#define RPG_CLIENT_NETWORKMANAGER___SENDDISPATCHREQUEST_D__1120_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9E93B80)
#define RPG_CLIENT_NETWORKMANAGER___SENDDISPATCHREQUEST_D__1120__CTOR_OFFSET UNITYSDK_OFFSET(0x9E885F0)
#define RPG_CLIENT_NETWORKMANAGER___SENDDISPATCHREQUEST_D__1120___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x9E93BC0)
...
namespace RPG::Client
{
	...
	public:
		...
		::Class_1_D6D8D891CDDE5DED* _dispatchResult_5__2; // 0x18
		::RPG::Client::NetworkManager* __4__this; // 0x20
		::System::Action_1<::Class_1_D6D8D891CDDE5DED*>* callback; // 0x28
		::System::Object* __2__current; // 0x30
		::System::String* dispatchUrl; // 0x38
