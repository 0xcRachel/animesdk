...
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_BEGINDESTRUCTION_OFFSET UNITYSDK_OFFSET(0x9791D80)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_CANDESTRUCT_OFFSET UNITYSDK_OFFSET(0x9792A50)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_CHANGEOBJECTREFTOPATHREF_OFFSET UNITYSDK_OFFSET(0x9790490)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x97917D0)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_DISCONNECTEDOBJECTREF_OFFSET UNITYSDK_OFFSET(0x9790620)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x9790ED0)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_INITDESTRUCT_OFFSET UNITYSDK_OFFSET(0x9792390)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_ISBEGINDESTRUCTION_OFFSET UNITYSDK_OFFSET(0x9791D30)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_METHOD_6_5835DC16FC46989B_OFFSET UNITYSDK_OFFSET(0x9792AC0)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_METHOD_6_66CC9828DB1F478F_OFFSET UNITYSDK_OFFSET(0x9790A00)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_METHOD_6_8CB9BDF340E2FC64_OFFSET UNITYSDK_OFFSET(0x9790780)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_METHOD_6_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x9790970)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_METHOD_6_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x9792530)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_METHOD_6_E876C8B6D3B840A6_OFFSET UNITYSDK_OFFSET(0x9790F30)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_METHOD_6_EF17FAB3022DE07B_OFFSET UNITYSDK_OFFSET(0x9792670)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_METHOD_6_FCB175EE4400634C_OFFSET UNITYSDK_OFFSET(0x9792DB0)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_REFRESHOBJECTREFBYPATHREF_OFFSET UNITYSDK_OFFSET(0x97904E0)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_RESETDESTRUCTION_OFFSET UNITYSDK_OFFSET(0x97918B0)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0x9791770)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_UPDATE_OFFSET UNITYSDK_OFFSET(0x9790680)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x9793290)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT___IFIXBASEPROXY_CHANGEOBJECTREFTOPATHREF_OFFSET UNITYSDK_OFFSET(0x9793320)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT___IFIXBASEPROXY_DISCONNECTEDOBJECTREF_OFFSET UNITYSDK_OFFSET(0x97933F0)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT___IFIXBASEPROXY_REFRESHOBJECTREFBYPATHREF_OFFSET UNITYSDK_OFFSET(0x9793390)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoDestructibleObject_TypeDefinitionIndex = 54440;
