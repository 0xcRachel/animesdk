...
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_BEGINDESTRUCTION_OFFSET UNITYSDK_OFFSET(0x9C37C80)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_CANDESTRUCT_OFFSET UNITYSDK_OFFSET(0x9C38950)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_CHANGEOBJECTREFTOPATHREF_OFFSET UNITYSDK_OFFSET(0x9C36390)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x9C376D0)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_DISCONNECTEDOBJECTREF_OFFSET UNITYSDK_OFFSET(0x9C36520)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x9C36DD0)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_INITDESTRUCT_OFFSET UNITYSDK_OFFSET(0x9C38290)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_ISBEGINDESTRUCTION_OFFSET UNITYSDK_OFFSET(0x9C37C30)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_METHOD_6_5835DC16FC46989B_OFFSET UNITYSDK_OFFSET(0x9C389C0)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_METHOD_6_66CC9828DB1F478F_OFFSET UNITYSDK_OFFSET(0x9C36900)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_METHOD_6_8CB9BDF340E2FC64_OFFSET UNITYSDK_OFFSET(0x9C36680)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_METHOD_6_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x9C36870)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_METHOD_6_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x9C38430)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_METHOD_6_E876C8B6D3B840A6_OFFSET UNITYSDK_OFFSET(0x9C36E30)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_METHOD_6_EF17FAB3022DE07B_OFFSET UNITYSDK_OFFSET(0x9C38570)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_METHOD_6_FCB175EE4400634C_OFFSET UNITYSDK_OFFSET(0x9C38CB0)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_REFRESHOBJECTREFBYPATHREF_OFFSET UNITYSDK_OFFSET(0x9C363E0)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_RESETDESTRUCTION_OFFSET UNITYSDK_OFFSET(0x9C377B0)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0x9C37670)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_UPDATE_OFFSET UNITYSDK_OFFSET(0x9C36580)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x9C39190)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT___IFIXBASEPROXY_CHANGEOBJECTREFTOPATHREF_OFFSET UNITYSDK_OFFSET(0x9C39220)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT___IFIXBASEPROXY_DISCONNECTEDOBJECTREF_OFFSET UNITYSDK_OFFSET(0x9C392F0)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT___IFIXBASEPROXY_REFRESHOBJECTREFBYPATHREF_OFFSET UNITYSDK_OFFSET(0x9C39290)
