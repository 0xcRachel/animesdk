...
#define RPG_CLIENT_PERMUSICPARAMETERSPECTRUM__CTOR_OFFSET UNITYSDK_OFFSET(0x9A5C220)

namespace RPG::Client
{
	inline static constexpr unsigned int PerMusicParameterSpectrum_TypeDefinitionIndex = 56452;
