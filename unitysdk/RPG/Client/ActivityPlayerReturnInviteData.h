...
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8FA52D0)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_GET_BOUNDINVITATIONCODE_OFFSET UNITYSDK_OFFSET(0x8FA5490)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_GET_INVITATIONCODE_OFFSET UNITYSDK_OFFSET(0x8FA5410)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_GET_INVITEDPLAYERCOUNTMAX_OFFSET UNITYSDK_OFFSET(0x8FA5450)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_GET_INVITEDPLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0x8FA5430)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_GET_ISINVITATIONCODEBOUND_OFFSET UNITYSDK_OFFSET(0x8FA5470)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_INIT_OFFSET UNITYSDK_OFFSET(0x8FA5210)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_SET_BOUNDINVITATIONCODE_OFFSET UNITYSDK_OFFSET(0x8FA54A0)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_SET_INVITATIONCODE_OFFSET UNITYSDK_OFFSET(0x8FA5420)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_SET_INVITEDPLAYERCOUNTMAX_OFFSET UNITYSDK_OFFSET(0x8FA5460)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_SET_INVITEDPLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0x8FA5440)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_SET_ISINVITATIONCODEBOUND_OFFSET UNITYSDK_OFFSET(0x8FA5480)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_SYNCINVITEEDATA_OFFSET UNITYSDK_OFFSET(0x8FA53B0)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_SYNCINVITERDATA_OFFSET UNITYSDK_OFFSET(0x8FA5340)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA__CLEARDATA_OFFSET UNITYSDK_OFFSET(0x8FA5280)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8FA54B0)
