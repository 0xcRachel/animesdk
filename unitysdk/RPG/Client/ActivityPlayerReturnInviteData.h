...
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8BA3E30)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_GET_BOUNDINVITATIONCODE_OFFSET UNITYSDK_OFFSET(0x8BA3FE0)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_GET_INVITATIONCODE_OFFSET UNITYSDK_OFFSET(0x8BA3F60)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_GET_INVITEDPLAYERCOUNTMAX_OFFSET UNITYSDK_OFFSET(0x8BA3FA0)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_GET_INVITEDPLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0x8BA3F80)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_GET_ISINVITATIONCODEBOUND_OFFSET UNITYSDK_OFFSET(0x8BA3FC0)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_INIT_OFFSET UNITYSDK_OFFSET(0x8BA3D70)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_SET_BOUNDINVITATIONCODE_OFFSET UNITYSDK_OFFSET(0x8BA3FF0)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_SET_INVITATIONCODE_OFFSET UNITYSDK_OFFSET(0x8BA3F70)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_SET_INVITEDPLAYERCOUNTMAX_OFFSET UNITYSDK_OFFSET(0x8BA3FB0)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_SET_INVITEDPLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0x8BA3F90)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_SET_ISINVITATIONCODEBOUND_OFFSET UNITYSDK_OFFSET(0x8BA3FD0)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_SYNCINVITEEDATA_OFFSET UNITYSDK_OFFSET(0x8BA3F00)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_SYNCINVITERDATA_OFFSET UNITYSDK_OFFSET(0x8BA3EA0)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA__CLEARDATA_OFFSET UNITYSDK_OFFSET(0x8BA3DE0)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8BA4000)

namespace RPG::Client
{
	inline static constexpr unsigned int ActivityPlayerReturnInviteData_TypeDefinitionIndex = 49086;
	...
	public:
		...
		::System::UInt32 _InvitedPlayerCountMax_k__BackingField; // 0x20
		::System::UInt32 _InvitedPlayerCount_k__BackingField; // 0x24
