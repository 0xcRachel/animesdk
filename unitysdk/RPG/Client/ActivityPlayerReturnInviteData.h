...
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1707C280)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_GET_BOUNDINVITATIONCODE_OFFSET UNITYSDK_OFFSET(0x1707C430)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_GET_INVITATIONCODE_OFFSET UNITYSDK_OFFSET(0x1707C3B0)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_GET_INVITEDPLAYERCOUNTMAX_OFFSET UNITYSDK_OFFSET(0x1707C3F0)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_GET_INVITEDPLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0x1707C3D0)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_GET_ISINVITATIONCODEBOUND_OFFSET UNITYSDK_OFFSET(0x1707C410)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_INIT_OFFSET UNITYSDK_OFFSET(0x1707C1B0)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_SET_BOUNDINVITATIONCODE_OFFSET UNITYSDK_OFFSET(0x1707C440)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_SET_INVITATIONCODE_OFFSET UNITYSDK_OFFSET(0x1707C3C0)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_SET_INVITEDPLAYERCOUNTMAX_OFFSET UNITYSDK_OFFSET(0x1707C400)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_SET_INVITEDPLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0x1707C3E0)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_SET_ISINVITATIONCODEBOUND_OFFSET UNITYSDK_OFFSET(0x1707C420)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_SYNCINVITEEDATA_OFFSET UNITYSDK_OFFSET(0x1707C350)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_SYNCINVITERDATA_OFFSET UNITYSDK_OFFSET(0x1707C2F0)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA__CLEARDATA_OFFSET UNITYSDK_OFFSET(0x1707C220)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1707C450)
