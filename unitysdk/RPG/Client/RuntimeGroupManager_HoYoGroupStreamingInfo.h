...
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO_CLEAR_OFFSET UNITYSDK_OFFSET(0xA418680)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0xA4187C0)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO_GET_MANAGER_OFFSET UNITYSDK_OFFSET(0xA4187E0)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO_GET_ONLOADCALLBACK_OFFSET UNITYSDK_OFFSET(0xA418800)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO_GET_ONUNLOADCALLBACK_OFFSET UNITYSDK_OFFSET(0xA418810)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO_GET_STREAMINGDATA_OFFSET UNITYSDK_OFFSET(0xA4187A0)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO_INIT_OFFSET UNITYSDK_OFFSET(0xA40B5D0)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO_SETSTREAMINGDATA_OFFSET UNITYSDK_OFFSET(0xA40B690)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO_SET_GROUPID_OFFSET UNITYSDK_OFFSET(0xA4187D0)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO_SET_MANAGER_OFFSET UNITYSDK_OFFSET(0xA4187F0)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO_SET_STREAMINGDATA_OFFSET UNITYSDK_OFFSET(0xA4187B0)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xA418620)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO__ONSTREAMINGUNLOADED_OFFSET UNITYSDK_OFFSET(0xA418740)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO__ONSTREAMLOADED_OFFSET UNITYSDK_OFFSET(0xA4186E0)
