...
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO_CLEAR_OFFSET UNITYSDK_OFFSET(0x15BC3130)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x15BC3260)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO_GET_MANAGER_OFFSET UNITYSDK_OFFSET(0x15BC3280)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO_GET_ONLOADCALLBACK_OFFSET UNITYSDK_OFFSET(0x15BC32A0)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO_GET_ONUNLOADCALLBACK_OFFSET UNITYSDK_OFFSET(0x15BC32B0)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO_GET_STREAMINGDATA_OFFSET UNITYSDK_OFFSET(0x15BC3240)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO_INIT_OFFSET UNITYSDK_OFFSET(0x15BB5E10)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO_SETSTREAMINGDATA_OFFSET UNITYSDK_OFFSET(0x15BB5ED0)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO_SET_GROUPID_OFFSET UNITYSDK_OFFSET(0x15BC3270)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO_SET_MANAGER_OFFSET UNITYSDK_OFFSET(0x15BC3290)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO_SET_STREAMINGDATA_OFFSET UNITYSDK_OFFSET(0x15BC3250)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x15BC30D0)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO__ONSTREAMINGUNLOADED_OFFSET UNITYSDK_OFFSET(0x15BC31E0)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO__ONSTREAMLOADED_OFFSET UNITYSDK_OFFSET(0x15BC3180)
