...
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO_CLEAR_OFFSET UNITYSDK_OFFSET(0x9F4CE90)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x9F4CFD0)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO_GET_MANAGER_OFFSET UNITYSDK_OFFSET(0x9F4CFF0)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO_GET_ONLOADCALLBACK_OFFSET UNITYSDK_OFFSET(0x9F4D010)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO_GET_ONUNLOADCALLBACK_OFFSET UNITYSDK_OFFSET(0x9F4D020)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO_GET_STREAMINGDATA_OFFSET UNITYSDK_OFFSET(0x9F4CFB0)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO_INIT_OFFSET UNITYSDK_OFFSET(0x9F3FDB0)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO_SETSTREAMINGDATA_OFFSET UNITYSDK_OFFSET(0x9F3FE70)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO_SET_GROUPID_OFFSET UNITYSDK_OFFSET(0x9F4CFE0)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO_SET_MANAGER_OFFSET UNITYSDK_OFFSET(0x9F4D000)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO_SET_STREAMINGDATA_OFFSET UNITYSDK_OFFSET(0x9F4CFC0)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x9F4CE30)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO__ONSTREAMINGUNLOADED_OFFSET UNITYSDK_OFFSET(0x9F4CF50)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_HOYOGROUPSTREAMINGINFO__ONSTREAMLOADED_OFFSET UNITYSDK_OFFSET(0x9F4CEF0)

namespace RPG::Client
{
	inline static constexpr unsigned int RuntimeGroupManager_HoYoGroupStreamingInfo_TypeDefinitionIndex = 49268;
