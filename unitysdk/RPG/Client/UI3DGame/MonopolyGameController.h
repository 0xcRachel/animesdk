...
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_ADDCELLEVENTTRIGGERIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0xA662E10)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_ADDCELLEVENTTRIGGER_OFFSET UNITYSDK_OFFSET(0xA664810)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_ADDVISUALEFFECTTOPATH_OFFSET UNITYSDK_OFFSET(0xA665DE0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_ADDVISUALEFFECT_OFFSET UNITYSDK_OFFSET(0xA665560)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_CHANGEASSETLEVEL_OFFSET UNITYSDK_OFFSET(0xA665040)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_CREATEBARRIER_OFFSET UNITYSDK_OFFSET(0xA666880)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_CREATECLICKITEM_OFFSET UNITYSDK_OFFSET(0xA6669F0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_DELETEBARRIER_OFFSET UNITYSDK_OFFSET(0xA6667C0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_DESTROYCLICKITEM_OFFSET UNITYSDK_OFFSET(0xA666B50)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_DESTROYENTITY_OFFSET UNITYSDK_OFFSET(0xA6618C0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_DISPOSELEVELGRAPH_OFFSET UNITYSDK_OFFSET(0xA665500)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA663330)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_GETCURCELLCONFIG_OFFSET UNITYSDK_OFFSET(0xA664D40)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_GETCURMAP_OFFSET UNITYSDK_OFFSET(0xA664280)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_GETCURWORLD_OFFSET UNITYSDK_OFFSET(0xA661880)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_GETMAPCONFIG_OFFSET UNITYSDK_OFFSET(0xA664E70)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_GETMAPDICT_OFFSET UNITYSDK_OFFSET(0xA664EC0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_GETPLAYERENTITY_OFFSET UNITYSDK_OFFSET(0xA666590)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_GETREMAINSTEP_OFFSET UNITYSDK_OFFSET(0xA664F20)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_INITGAMECONTEXT_OFFSET UNITYSDK_OFFSET(0xA6601E0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_ISSWITCHINGWORLD_OFFSET UNITYSDK_OFFSET(0xA6653F0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_LOADWORLDBG_OFFSET UNITYSDK_OFFSET(0xA661FD0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_LOADWORLD_OFFSET UNITYSDK_OFFSET(0xA661970)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_MOVEBYPATH_OFFSET UNITYSDK_OFFSET(0xA664500)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_ONUIENTERTRIGGER_OFFSET UNITYSDK_OFFSET(0xA663530)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_OVERRIDESTARTCELLID_OFFSET UNITYSDK_OFFSET(0xA664350)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_PLAYCLICKITEMFINALANIM_OFFSET UNITYSDK_OFFSET(0xA666BE0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_PLAYSPINEANIM_OFFSET UNITYSDK_OFFSET(0xA6665F0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_RECOVERINFOAFTERSWITCHMAP_OFFSET UNITYSDK_OFFSET(0xA662270)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_RECOVERSTATE_OFFSET UNITYSDK_OFFSET(0xA662020)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_REFRESHACTIVESTATE_OFFSET UNITYSDK_OFFSET(0xA6654A0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_SETGAMEPAUSE_OFFSET UNITYSDK_OFFSET(0xA663890)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_SETPLAYERANIMATION_OFFSET UNITYSDK_OFFSET(0xA6643A0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_TELEPORTTOCELL_OFFSET UNITYSDK_OFFSET(0xA6646F0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_TRIGGERCLICKABLEFINALANIM_OFFSET UNITYSDK_OFFSET(0xA664AA0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_UNLOADWORLD_OFFSET UNITYSDK_OFFSET(0xA661600)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_UPDATEBARRIERS_OFFSET UNITYSDK_OFFSET(0xA664BE0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__CREATEENTITYS_OFFSET UNITYSDK_OFFSET(0xA6632A0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__CREATEGAMEINPUT_OFFSET UNITYSDK_OFFSET(0xA663B80)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__CREATEMAP_OFFSET UNITYSDK_OFFSET(0xA664180)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__CREATEMONOPOLYGAMECONFIG_OFFSET UNITYSDK_OFFSET(0xA663C30)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__CREATEMONOPOLYGAMESTATE_OFFSET UNITYSDK_OFFSET(0xA663D00)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__CREATEPLAYER_OFFSET UNITYSDK_OFFSET(0xA663E00)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__CREATESERVICES_OFFSET UNITYSDK_OFFSET(0xA6630A0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__CREATESYSTEMS_OFFSET UNITYSDK_OFFSET(0xA663200)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA65FDC0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__FETCHVISUALEFFECTENTITY_OFFSET UNITYSDK_OFFSET(0xA665920)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__GETASSETICONPATH_OFFSET UNITYSDK_OFFSET(0xA665340)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__GETCURCELL_OFFSET UNITYSDK_OFFSET(0xA6620E0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__GETNEXTMAP_OFFSET UNITYSDK_OFFSET(0xA661BA0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__GETOWNEDENTITY_OFFSET UNITYSDK_OFFSET(0xA663A20)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__GETTARGETMAP_OFFSET UNITYSDK_OFFSET(0xA661CF0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__LOADWORLD_OFFSET UNITYSDK_OFFSET(0xA661DE0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__MOVEPLAYER_OFFSET UNITYSDK_OFFSET(0xA662510)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__RECOVERTRIGGERONSWITCHMAP_OFFSET UNITYSDK_OFFSET(0xA662450)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__RECOVERTRIGGER_OFFSET UNITYSDK_OFFSET(0xA662A10)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA666C60)

namespace RPG::Client::UI3DGame
{
	inline static constexpr unsigned int MonopolyGameController_TypeDefinitionIndex = 61822;
	...
	public:
		...
		::RPG::Client::LittleGame::MonopolyGameState _PrevState; // 0x4C
