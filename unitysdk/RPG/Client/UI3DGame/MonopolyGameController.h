...
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_ADDCELLEVENTTRIGGERIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0x138E9C70)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_ADDCELLEVENTTRIGGER_OFFSET UNITYSDK_OFFSET(0x138EB670)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_ADDVISUALEFFECTTOPATH_OFFSET UNITYSDK_OFFSET(0x138ECC50)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_ADDVISUALEFFECT_OFFSET UNITYSDK_OFFSET(0x138EC3C0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_CHANGEASSETLEVEL_OFFSET UNITYSDK_OFFSET(0x138EBE80)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_CREATEBARRIER_OFFSET UNITYSDK_OFFSET(0x138ED6F0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_CREATECLICKITEM_OFFSET UNITYSDK_OFFSET(0x138ED860)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_DELETEBARRIER_OFFSET UNITYSDK_OFFSET(0x138ED630)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_DESTROYCLICKITEM_OFFSET UNITYSDK_OFFSET(0x138ED9C0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_DESTROYENTITY_OFFSET UNITYSDK_OFFSET(0x138E86F0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_DISPOSELEVELGRAPH_OFFSET UNITYSDK_OFFSET(0x138EC350)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x138EA190)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_GETCURCELLCONFIG_OFFSET UNITYSDK_OFFSET(0x138EBBA0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_GETCURMAP_OFFSET UNITYSDK_OFFSET(0x138EB0E0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_GETCURWORLD_OFFSET UNITYSDK_OFFSET(0x138E86B0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_GETMAPCONFIG_OFFSET UNITYSDK_OFFSET(0x138EBCD0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_GETMAPDICT_OFFSET UNITYSDK_OFFSET(0x138EBD20)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_GETPLAYERENTITY_OFFSET UNITYSDK_OFFSET(0x138ED400)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_GETREMAINSTEP_OFFSET UNITYSDK_OFFSET(0x138EBD80)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_INITGAMECONTEXT_OFFSET UNITYSDK_OFFSET(0x138E7010)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_ISSWITCHINGWORLD_OFFSET UNITYSDK_OFFSET(0x138EC230)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_LOADWORLDBG_OFFSET UNITYSDK_OFFSET(0x138E8E00)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_LOADWORLD_OFFSET UNITYSDK_OFFSET(0x138E87A0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_MOVEBYPATH_OFFSET UNITYSDK_OFFSET(0x138EB360)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_ONUIENTERTRIGGER_OFFSET UNITYSDK_OFFSET(0x138EA390)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_OVERRIDESTARTCELLID_OFFSET UNITYSDK_OFFSET(0x138EB1B0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_PLAYCLICKITEMFINALANIM_OFFSET UNITYSDK_OFFSET(0x138EDA50)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_PLAYSPINEANIM_OFFSET UNITYSDK_OFFSET(0x138ED460)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_RECOVERINFOAFTERSWITCHMAP_OFFSET UNITYSDK_OFFSET(0x138E90A0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_RECOVERSTATE_OFFSET UNITYSDK_OFFSET(0x138E8E50)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_REFRESHACTIVESTATE_OFFSET UNITYSDK_OFFSET(0x138EC2F0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_SETGAMEPAUSE_OFFSET UNITYSDK_OFFSET(0x138EA6F0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_SETPLAYERANIMATION_OFFSET UNITYSDK_OFFSET(0x138EB200)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_TELEPORTTOCELL_OFFSET UNITYSDK_OFFSET(0x138EB550)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_TRIGGERCLICKABLEFINALANIM_OFFSET UNITYSDK_OFFSET(0x138EB900)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_UNLOADWORLD_OFFSET UNITYSDK_OFFSET(0x138E8430)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER_UPDATEBARRIERS_OFFSET UNITYSDK_OFFSET(0x138EBA40)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__CREATEENTITYS_OFFSET UNITYSDK_OFFSET(0x138EA100)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__CREATEGAMEINPUT_OFFSET UNITYSDK_OFFSET(0x138EA9F0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__CREATEMAP_OFFSET UNITYSDK_OFFSET(0x138EAFE0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__CREATEMONOPOLYGAMECONFIG_OFFSET UNITYSDK_OFFSET(0x138EAAA0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__CREATEMONOPOLYGAMESTATE_OFFSET UNITYSDK_OFFSET(0x138EAB60)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__CREATEPLAYER_OFFSET UNITYSDK_OFFSET(0x138EAC60)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__CREATESERVICES_OFFSET UNITYSDK_OFFSET(0x138E9F00)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__CREATESYSTEMS_OFFSET UNITYSDK_OFFSET(0x138EA060)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x138E6BF0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__FETCHVISUALEFFECTENTITY_OFFSET UNITYSDK_OFFSET(0x138EC780)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__GETASSETICONPATH_OFFSET UNITYSDK_OFFSET(0x138EC180)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__GETCURCELL_OFFSET UNITYSDK_OFFSET(0x138E8F10)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__GETNEXTMAP_OFFSET UNITYSDK_OFFSET(0x138E89D0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__GETOWNEDENTITY_OFFSET UNITYSDK_OFFSET(0x138EA880)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__GETTARGETMAP_OFFSET UNITYSDK_OFFSET(0x138E8B20)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__LOADWORLD_OFFSET UNITYSDK_OFFSET(0x138E8C10)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__MOVEPLAYER_OFFSET UNITYSDK_OFFSET(0x138E9350)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__RECOVERTRIGGERONSWITCHMAP_OFFSET UNITYSDK_OFFSET(0x138E9290)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER__RECOVERTRIGGER_OFFSET UNITYSDK_OFFSET(0x138E9870)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGAMECONTROLLER___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x138EDAD0)

namespace RPG::Client::UI3DGame
{
	inline static constexpr unsigned int MonopolyGameController_TypeDefinitionIndex = 69732;
	...
	public:
		...
		::Class_2_40B4F44059E8FC53* _Services; // 0x30
		::Class_2_9850514C0F89B91A* _WorldBgEntity; // 0x38
		::Class_1_867B6CE75953535A* _Contexts; // 0x40
		...
		::System::UInt32 _MonopolyStartCellID; // 0x54
