...
#define RPG_CLIENT_MONOEFFECTPLUGINFRAMECAPTURE_AWAKEPLUGIN_OFFSET UNITYSDK_OFFSET(0x15A48C30)
#define RPG_CLIENT_MONOEFFECTPLUGINFRAMECAPTURE_DESTROYPLUGIN_OFFSET UNITYSDK_OFFSET(0x15A48D10)
#define RPG_CLIENT_MONOEFFECTPLUGINFRAMECAPTURE_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0x15A48B20)
#define RPG_CLIENT_MONOEFFECTPLUGINFRAMECAPTURE_GET_BEHAVIOR_OFFSET UNITYSDK_OFFSET(0x15A48DD0)
#define RPG_CLIENT_MONOEFFECTPLUGINFRAMECAPTURE_IGNOREINEDITOR_OFFSET UNITYSDK_OFFSET(0x15A48A50)
#define RPG_CLIENT_MONOEFFECTPLUGINFRAMECAPTURE_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0x15A48A90)
#define RPG_CLIENT_MONOEFFECTPLUGINFRAMECAPTURE_TICK_OFFSET UNITYSDK_OFFSET(0x15A48BB0)
#define RPG_CLIENT_MONOEFFECTPLUGINFRAMECAPTURE__CTOR_OFFSET UNITYSDK_OFFSET(0x15A48DE0)
#define RPG_CLIENT_MONOEFFECTPLUGINFRAMECAPTURE___IFIXBASEPROXY_AWAKEPLUGIN_OFFSET UNITYSDK_OFFSET(0x15A48E90)
#define RPG_CLIENT_MONOEFFECTPLUGINFRAMECAPTURE___IFIXBASEPROXY_DESTROYPLUGIN_OFFSET UNITYSDK_OFFSET(0x15A48ED0)
#define RPG_CLIENT_MONOEFFECTPLUGINFRAMECAPTURE___IFIXBASEPROXY_IGNOREINEDITOR_OFFSET UNITYSDK_OFFSET(0x15A48DF0)
#define RPG_CLIENT_MONOEFFECTPLUGINFRAMECAPTURE___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x15A48E30)
