...
#define RPG_CLIENT_AETHERDIVIDETRAINERDATA___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x10AD9490)
#define RPG_CLIENT_AETHERDIVIDETRAINERDATA___C__CTOR_OFFSET UNITYSDK_OFFSET(0x10AD94D0)
#define RPG_CLIENT_AETHERDIVIDETRAINERDATA___C__GETSORTEDQUESTDATALIST_B__7_0_OFFSET UNITYSDK_OFFSET(0x10AD94E0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Func_2<::RPG::Client::QuestData*, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(AetherDivideTrainerData___c_TypeDefinitionIndex)->GetStaticField(0x56160);
		}
		static ::RPG::Client::AetherDivideTrainerData___c** StaticGet___9()
		{
			return (::RPG::Client::AetherDivideTrainerData___c**)Il2CppClass::FromTypeDefinitionIndex(AetherDivideTrainerData___c_TypeDefinitionIndex)->GetStaticField(0x56168);
		}
