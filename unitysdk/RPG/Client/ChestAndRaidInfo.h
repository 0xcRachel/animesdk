...
#define RPG_CLIENT_CHESTANDRAIDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18A61050)
...
namespace RPG::Client
{
	...
	{
	public:
		::RPG::GameCore::MapPregressShowType ShowType; // 0x10
		::System::UInt32 ExistNum; // 0x14
		::System::UInt32 ExistNumCurWorldLevel; // 0x18
