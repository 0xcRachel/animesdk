...
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GETDEBUGINFO_OFFSET UNITYSDK_OFFSET(0xA3903C0)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xA3904B0)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GET_MARKTYPE_OFFSET UNITYSDK_OFFSET(0xA390450)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xA390480)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GET_ROOMID_OFFSET UNITYSDK_OFFSET(0xA390410)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GET_ROOMINDEX_OFFSET UNITYSDK_OFFSET(0xA390420)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GET_ROOMTYPE_OFFSET UNITYSDK_OFFSET(0xA390430)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GET_STATUS_OFFSET UNITYSDK_OFFSET(0xA390470)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GET_TOASTICONPATH_OFFSET UNITYSDK_OFFSET(0xA3904D0)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_SYNC_OFFSET UNITYSDK_OFFSET(0xA390240)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA38FF40)
