...
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GETDEBUGINFO_OFFSET UNITYSDK_OFFSET(0x17DF4C70)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x17DF4D60)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GET_MARKTYPE_OFFSET UNITYSDK_OFFSET(0x17DF4D00)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x17DF4D30)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GET_ROOMID_OFFSET UNITYSDK_OFFSET(0x17DF4CC0)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GET_ROOMINDEX_OFFSET UNITYSDK_OFFSET(0x17DF4CD0)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GET_ROOMTYPE_OFFSET UNITYSDK_OFFSET(0x17DF4CE0)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x17DF4D20)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GET_TOASTICONPATH_OFFSET UNITYSDK_OFFSET(0x17DF4D80)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_SYNC_OFFSET UNITYSDK_OFFSET(0x17DF4AF0)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17DF4800)
