...
#define RPG_CLIENT_GACHATIMELINECONTROLLER_METHOD_5_2DF312D8F1F2AEB0_OFFSET UNITYSDK_OFFSET(0x92F1940)
#define RPG_CLIENT_GACHATIMELINECONTROLLER_METHOD_5_370754945A4AA2A7_OFFSET UNITYSDK_OFFSET(0x92F29A0)
#define RPG_CLIENT_GACHATIMELINECONTROLLER_METHOD_5_496FEE6B21ED2447_OFFSET UNITYSDK_OFFSET(0x92F21D0)
#define RPG_CLIENT_GACHATIMELINECONTROLLER_METHOD_5_4F6F1F5E9E636C20_OFFSET UNITYSDK_OFFSET(0x92F2460)
#define RPG_CLIENT_GACHATIMELINECONTROLLER_METHOD_5_60451B2DE9D371C9_OFFSET UNITYSDK_OFFSET(0x92F22C0)
#define RPG_CLIENT_GACHATIMELINECONTROLLER_METHOD_5_76AA266C33AD557E_OFFSET UNITYSDK_OFFSET(0x92F1BA0)
#define RPG_CLIENT_GACHATIMELINECONTROLLER_METHOD_5_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0x92F2C40)
#define RPG_CLIENT_GACHATIMELINECONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x92F2BA0)
#define RPG_CLIENT_GACHATIMELINECONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x92F1180)
#define RPG_CLIENT_GACHATIMELINECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x92F2CE0)

namespace RPG::Client
{
	inline static constexpr unsigned int GachaTimelineController_TypeDefinitionIndex = 58044;
