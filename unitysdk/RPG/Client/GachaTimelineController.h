...
#define RPG_CLIENT_GACHATIMELINECONTROLLER_METHOD_5_2DF312D8F1F2AEB0_OFFSET UNITYSDK_OFFSET(0x9766710)
#define RPG_CLIENT_GACHATIMELINECONTROLLER_METHOD_5_370754945A4AA2A7_OFFSET UNITYSDK_OFFSET(0x9767770)
#define RPG_CLIENT_GACHATIMELINECONTROLLER_METHOD_5_496FEE6B21ED2447_OFFSET UNITYSDK_OFFSET(0x9766FA0)
#define RPG_CLIENT_GACHATIMELINECONTROLLER_METHOD_5_4F6F1F5E9E636C20_OFFSET UNITYSDK_OFFSET(0x9767230)
#define RPG_CLIENT_GACHATIMELINECONTROLLER_METHOD_5_60451B2DE9D371C9_OFFSET UNITYSDK_OFFSET(0x9767090)
#define RPG_CLIENT_GACHATIMELINECONTROLLER_METHOD_5_76AA266C33AD557E_OFFSET UNITYSDK_OFFSET(0x9766970)
#define RPG_CLIENT_GACHATIMELINECONTROLLER_METHOD_5_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0x9767A10)
#define RPG_CLIENT_GACHATIMELINECONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x9767970)
#define RPG_CLIENT_GACHATIMELINECONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x9765F50)
#define RPG_CLIENT_GACHATIMELINECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9767A70)

namespace RPG::Client
{
	inline static constexpr unsigned int GachaTimelineController_TypeDefinitionIndex = 59671;
