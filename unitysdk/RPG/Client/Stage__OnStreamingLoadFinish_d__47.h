...
#define RPG_CLIENT_STAGE__ONSTREAMINGLOADFINISH_D__47_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x16C3BD30)
#define RPG_CLIENT_STAGE__ONSTREAMINGLOADFINISH_D__47_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_WORK_IASYNCWORKSTEPRESULT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x16C3BDB0)
#define RPG_CLIENT_STAGE__ONSTREAMINGLOADFINISH_D__47_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x16C3BE10)
#define RPG_CLIENT_STAGE__ONSTREAMINGLOADFINISH_D__47_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x16C3BDC0)
#define RPG_CLIENT_STAGE__ONSTREAMINGLOADFINISH_D__47_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16C3BD20)
#define RPG_CLIENT_STAGE__ONSTREAMINGLOADFINISH_D__47__CTOR_OFFSET UNITYSDK_OFFSET(0x16C38D70)
