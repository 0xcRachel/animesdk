...
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16C65620)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_EQUALS_OFFSET UNITYSDK_OFFSET(0x16C65670)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GETDIALOGATTACHPOINT_OFFSET UNITYSDK_OFFSET(0x16C65900)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GETENTITYRUNTIMEID_OFFSET UNITYSDK_OFFSET(0x16C656F0)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GETTIPSATTACHTRANSFORM_OFFSET UNITYSDK_OFFSET(0x16C65770)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_BORNNUMBER_OFFSET UNITYSDK_OFFSET(0x16C664B0)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_CURRENTWAVE_OFFSET UNITYSDK_OFFSET(0x16C66C30)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_CUSTOMERID_OFFSET UNITYSDK_OFFSET(0x16C668F0)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_CUSTOMERWAITTIME_OFFSET UNITYSDK_OFFSET(0x16C65D90)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_EMOJIPATH_OFFSET UNITYSDK_OFFSET(0x16C66010)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_EMOJITYPE_OFFSET UNITYSDK_OFFSET(0x16C660A0)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_EMPLOYEEID_OFFSET UNITYSDK_OFFSET(0x16C669C0)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_ENTITY_OFFSET UNITYSDK_OFFSET(0x16C66D10)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_LIFETIME_OFFSET UNITYSDK_OFFSET(0x16C663D0)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_ORDERRECIPEIDLIST_OFFSET UNITYSDK_OFFSET(0x16C65E70)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_PAYPRICE_OFFSET UNITYSDK_OFFSET(0x16C65BF0)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_PREORDERRECIPEIDLIST_OFFSET UNITYSDK_OFFSET(0x16C65F40)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_SELECTEVENTCONFIG_OFFSET UNITYSDK_OFFSET(0x16C66700)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_SPECIALBUBBLETEXT_OFFSET UNITYSDK_OFFSET(0x16C662C0)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_SPECIALCUSTOMERID_OFFSET UNITYSDK_OFFSET(0x16C66820)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_TALKTEXT_OFFSET UNITYSDK_OFFSET(0x16C66170)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_THUMBCOUNT_OFFSET UNITYSDK_OFFSET(0x16C65CC0)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_WAVEORDERCNT_OFFSET UNITYSDK_OFFSET(0x16C66A90)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_WAVEWAITTIME_OFFSET UNITYSDK_OFFSET(0x16C66590)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_ISCHEFBUSY_OFFSET UNITYSDK_OFFSET(0x16C65B20)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_ISWAITERBUSY_OFFSET UNITYSDK_OFFSET(0x16C65A90)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x16C65610)
