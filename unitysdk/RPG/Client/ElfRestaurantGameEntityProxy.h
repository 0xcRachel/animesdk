...
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x95DB140)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_EQUALS_OFFSET UNITYSDK_OFFSET(0x95DB190)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GETDIALOGATTACHPOINT_OFFSET UNITYSDK_OFFSET(0x95DB4A0)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GETENTITYRUNTIMEID_OFFSET UNITYSDK_OFFSET(0x95DB210)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GETTIPSATTACHTRANSFORM_OFFSET UNITYSDK_OFFSET(0x95DB290)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_BORNNUMBER_OFFSET UNITYSDK_OFFSET(0x95DC100)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_CURRENTWAVE_OFFSET UNITYSDK_OFFSET(0x95DC910)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_CUSTOMERID_OFFSET UNITYSDK_OFFSET(0x95DC5C0)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_CUSTOMERWAITTIME_OFFSET UNITYSDK_OFFSET(0x95DB9D0)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_EMOJIPATH_OFFSET UNITYSDK_OFFSET(0x95DBC50)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_EMOJITYPE_OFFSET UNITYSDK_OFFSET(0x95DBCE0)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_EMPLOYEEID_OFFSET UNITYSDK_OFFSET(0x95DC690)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_ENTITY_OFFSET UNITYSDK_OFFSET(0x95DC9F0)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_LIFETIME_OFFSET UNITYSDK_OFFSET(0x95DC020)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_ORDERRECIPEIDLIST_OFFSET UNITYSDK_OFFSET(0x95DBAB0)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_PAYPRICE_OFFSET UNITYSDK_OFFSET(0x95DB810)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_PREORDERRECIPEIDLIST_OFFSET UNITYSDK_OFFSET(0x95DBB80)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_SELECTEVENTCONFIG_OFFSET UNITYSDK_OFFSET(0x95DC3B0)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_SPECIALBUBBLETEXT_OFFSET UNITYSDK_OFFSET(0x95DBF10)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_SPECIALCUSTOMERID_OFFSET UNITYSDK_OFFSET(0x95DC4E0)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_TALKTEXT_OFFSET UNITYSDK_OFFSET(0x95DBDC0)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_THUMBCOUNT_OFFSET UNITYSDK_OFFSET(0x95DB8F0)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_WAVEORDERCNT_OFFSET UNITYSDK_OFFSET(0x95DC770)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_WAVEWAITTIME_OFFSET UNITYSDK_OFFSET(0x95DC1E0)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_ISCHEFBUSY_OFFSET UNITYSDK_OFFSET(0x95DB740)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_ISWAITERBUSY_OFFSET UNITYSDK_OFFSET(0x95DB6B0)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x95DB130)
