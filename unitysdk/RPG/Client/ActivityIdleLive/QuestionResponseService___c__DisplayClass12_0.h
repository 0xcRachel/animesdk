...
#define RPG_CLIENT_ACTIVITYIDLELIVE_QUESTIONRESPONSESERVICE___C__DISPLAYCLASS12_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1730ED50)
#define RPG_CLIENT_ACTIVITYIDLELIVE_QUESTIONRESPONSESERVICE___C__DISPLAYCLASS12_0___TRIGGERGIFT_B__0_OFFSET UNITYSDK_OFFSET(0x1730F2C0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int QuestionResponseService___c__DisplayClass12_0_TypeDefinitionIndex = 69416;
