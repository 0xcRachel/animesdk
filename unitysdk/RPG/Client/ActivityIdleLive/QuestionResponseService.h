...
#define RPG_CLIENT_ACTIVITYIDLELIVE_QUESTIONRESPONSESERVICE_DEBUGDIRECTRESPONSE_OFFSET UNITYSDK_OFFSET(0x1730F1D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_QUESTIONRESPONSESERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1730E150)
#define RPG_CLIENT_ACTIVITYIDLELIVE_QUESTIONRESPONSESERVICE_RESPONSEONTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1730E1E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_QUESTIONRESPONSESERVICE_STARTRESPONSE_OFFSET UNITYSDK_OFFSET(0x1730E390)
#define RPG_CLIENT_ACTIVITYIDLELIVE_QUESTIONRESPONSESERVICE__BUILDRESPONSECOMMAND_OFFSET UNITYSDK_OFFSET(0x1730ECC0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_QUESTIONRESPONSESERVICE__BUILDSHOWMESSAGEPAGE_OFFSET UNITYSDK_OFFSET(0x1730F060)
#define RPG_CLIENT_ACTIVITYIDLELIVE_QUESTIONRESPONSESERVICE__BUILDSHOWRECOMMENDTEAM_OFFSET UNITYSDK_OFFSET(0x1730EE70)
#define RPG_CLIENT_ACTIVITYIDLELIVE_QUESTIONRESPONSESERVICE__BUILDSHOWSPEQUIPINVENTORY_OFFSET UNITYSDK_OFFSET(0x1730ED60)
#define RPG_CLIENT_ACTIVITYIDLELIVE_QUESTIONRESPONSESERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1730DF60)
#define RPG_CLIENT_ACTIVITYIDLELIVE_QUESTIONRESPONSESERVICE__ONFINISHQUESTIONRSP_OFFSET UNITYSDK_OFFSET(0x1730DFE0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_QUESTIONRESPONSESERVICE__ONRESPONSECOMPLETE_OFFSET UNITYSDK_OFFSET(0x1730E630)
#define RPG_CLIENT_ACTIVITYIDLELIVE_QUESTIONRESPONSESERVICE__REQUESTRESPONSEONTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1730E2D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_QUESTIONRESPONSESERVICE__REQUESTRESPONSE_OFFSET UNITYSDK_OFFSET(0x1730E440)
#define RPG_CLIENT_ACTIVITYIDLELIVE_QUESTIONRESPONSESERVICE__SETSPECIALCHATIDS_OFFSET UNITYSDK_OFFSET(0x1730E9B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_QUESTIONRESPONSESERVICE__TRIGGERGIFT_OFFSET UNITYSDK_OFFSET(0x1730E7C0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_QUESTIONRESPONSESERVICE__TRIGGERSPINE_OFFSET UNITYSDK_OFFSET(0x1730E750)
#define RPG_CLIENT_ACTIVITYIDLELIVE_QUESTIONRESPONSESERVICE___REQUESTRESPONSE_B__14_0_OFFSET UNITYSDK_OFFSET(0x1730F220)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int QuestionResponseService_TypeDefinitionIndex = 69415;

	class QuestionResponseService : public ::System::Object
	{
	public:
		::RPG::Client::Promises::Promise* _RspGotPromise; // 0x10
		::System::UInt32 _QuestionId; // 0x18
