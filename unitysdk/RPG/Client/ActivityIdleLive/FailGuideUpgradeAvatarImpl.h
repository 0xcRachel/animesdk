...
#define RPG_CLIENT_ACTIVITYIDLELIVE_FAILGUIDEUPGRADEAVATARIMPL_GETFAILHINTTEXT_OFFSET UNITYSDK_OFFSET(0x18548740)
#define RPG_CLIENT_ACTIVITYIDLELIVE_FAILGUIDEUPGRADEAVATARIMPL_HASTRIGGERACTION_OFFSET UNITYSDK_OFFSET(0x18548DB0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_FAILGUIDEUPGRADEAVATARIMPL_ONTRIGGER_OFFSET UNITYSDK_OFFSET(0x18548DF0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_FAILGUIDEUPGRADEAVATARIMPL_SHOULDTRIGGER_OFFSET UNITYSDK_OFFSET(0x185487F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_FAILGUIDEUPGRADEAVATARIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x18548E70)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int FailGuideUpgradeAvatarImpl_TypeDefinitionIndex = 70259;
