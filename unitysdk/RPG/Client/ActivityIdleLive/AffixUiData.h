...
#define RPG_CLIENT_ACTIVITYIDLELIVE_AFFIXUIDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17335C70)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int AffixUiData_TypeDefinitionIndex = 69470;
