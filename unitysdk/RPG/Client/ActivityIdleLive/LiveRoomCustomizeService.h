...
#define RPG_CLIENT_ACTIVITYIDLELIVE_LIVEROOMCUSTOMIZESERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1730C670)
#define RPG_CLIENT_ACTIVITYIDLELIVE_LIVEROOMCUSTOMIZESERVICE_REQUESTUPDATEICON_OFFSET UNITYSDK_OFFSET(0x1730C2B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_LIVEROOMCUSTOMIZESERVICE_REQUESTUPDATETITLE_OFFSET UNITYSDK_OFFSET(0x1730C490)
#define RPG_CLIENT_ACTIVITYIDLELIVE_LIVEROOMCUSTOMIZESERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1730C0F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_LIVEROOMCUSTOMIZESERVICE__ONUPDATECUSTOMINFOSCRSP_OFFSET UNITYSDK_OFFSET(0x1730C150)
#define RPG_CLIENT_ACTIVITYIDLELIVE_LIVEROOMCUSTOMIZESERVICE__REQUESTUPDATEICON_B__4_0_OFFSET UNITYSDK_OFFSET(0x1730C7F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_LIVEROOMCUSTOMIZESERVICE__REQUESTUPDATETITLE_B__5_0_OFFSET UNITYSDK_OFFSET(0x1730C890)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int LiveRoomCustomizeService_TypeDefinitionIndex = 69414;
