...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMU_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x173081B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMU_ONCREATE_OFFSET UNITYSDK_OFFSET(0x173080F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMU_SETTEXT_OFFSET UNITYSDK_OFFSET(0x17308270)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMU_TOSTRING_OFFSET UNITYSDK_OFFSET(0x173082E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMU__CTOR_OFFSET UNITYSDK_OFFSET(0x17308360)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMU___IFIXBASEPROXY_ONCREATE_OFFSET UNITYSDK_OFFSET(0x17308390)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMU___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x173083A0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveTextDanmu_TypeDefinitionIndex = 69248;
