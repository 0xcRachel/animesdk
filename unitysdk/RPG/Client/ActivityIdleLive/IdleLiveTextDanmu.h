...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMU_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x18649E30)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMU_ONCREATE_OFFSET UNITYSDK_OFFSET(0x18649D80)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMU_SETTEXT_OFFSET UNITYSDK_OFFSET(0x18649EF0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMU_TOSTRING_OFFSET UNITYSDK_OFFSET(0x18649F60)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMU__CTOR_OFFSET UNITYSDK_OFFSET(0x18649FE0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMU___IFIXBASEPROXY_ONCREATE_OFFSET UNITYSDK_OFFSET(0x1864A010)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMU___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1864A020)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveTextDanmu_TypeDefinitionIndex = 70060;
