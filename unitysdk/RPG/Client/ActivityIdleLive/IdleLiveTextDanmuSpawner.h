...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMUSPAWNER_AWAKE_OFFSET UNITYSDK_OFFSET(0x17308790)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMUSPAWNER_HIDEDANMU_OFFSET UNITYSDK_OFFSET(0x173086D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMUSPAWNER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x17308D10)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMUSPAWNER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17309290)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMUSPAWNER_PAUSEDANMU_OFFSET UNITYSDK_OFFSET(0x17308630)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMUSPAWNER_RESUMEDANMU_OFFSET UNITYSDK_OFFSET(0x17308680)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMUSPAWNER_SETCHATSERVICE_OFFSET UNITYSDK_OFFSET(0x173083B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMUSPAWNER_SETIMGDANMUSERVICE_OFFSET UNITYSDK_OFFSET(0x173085D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMUSPAWNER_SHOWDANMU_OFFSET UNITYSDK_OFFSET(0x17308730)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMUSPAWNER_UPDATEPHASE_OFFSET UNITYSDK_OFFSET(0x17308410)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMUSPAWNER_UPDATE_OFFSET UNITYSDK_OFFSET(0x17308A00)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMUSPAWNER__CLEANENDEDDANMUS_OFFSET UNITYSDK_OFFSET(0x17309060)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMUSPAWNER__CTOR_OFFSET UNITYSDK_OFFSET(0x1730A580)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMUSPAWNER__GETLINEOCCUPANTS_OFFSET UNITYSDK_OFFSET(0x173094C0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMUSPAWNER__GETLINEWORLDYS_OFFSET UNITYSDK_OFFSET(0x173098B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMUSPAWNER__GETSTARWORLDY_OFFSET UNITYSDK_OFFSET(0x17309570)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMUSPAWNER__GETUID_OFFSET UNITYSDK_OFFSET(0x1730A530)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMUSPAWNER__HASEMPTYLINETOPLAY_OFFSET UNITYSDK_OFFSET(0x173093A0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMUSPAWNER__INITIALIZEIMAGELINES_OFFSET UNITYSDK_OFFSET(0x17309B60)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMUSPAWNER__INITIALIZETEXTLINES_OFFSET UNITYSDK_OFFSET(0x17309960)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMUSPAWNER__ISPAUSEDBYTIMESCALELOCK_OFFSET UNITYSDK_OFFSET(0x17309300)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMUSPAWNER__ISPAUSED_OFFSET UNITYSDK_OFFSET(0x17308C50)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMUSPAWNER__SPAWNDANMU_OFFSET UNITYSDK_OFFSET(0x1730A2B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMUSPAWNER__STARSHOWDANMU_OFFSET UNITYSDK_OFFSET(0x1730A100)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMUSPAWNER__TRYFETCHDANMUTOSHOW_OFFSET UNITYSDK_OFFSET(0x17309000)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMUSPAWNER__TRYFETCHNEWIMAGEDANMU_OFFSET UNITYSDK_OFFSET(0x17309F20)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMUSPAWNER__TRYFETCHNEWTEXTDANMU_OFFSET UNITYSDK_OFFSET(0x1730A010)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMUSPAWNER__TRYSHOWPENDINGIMAGEDANMU_OFFSET UNITYSDK_OFFSET(0x17309D80)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMUSPAWNER__TRYSHOWPENDINGTEXTDANMU_OFFSET UNITYSDK_OFFSET(0x17309E50)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMUSPAWNER__UPDATELINEOCCUPANTS_OFFSET UNITYSDK_OFFSET(0x17308E90)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveTextDanmuSpawner_TypeDefinitionIndex = 69249;
