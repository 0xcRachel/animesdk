...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETECHTREE_CREATE_OFFSET UNITYSDK_OFFSET(0x1733F6D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETECHTREE_GETFIRSTREACHNODE_OFFSET UNITYSDK_OFFSET(0x1734E030)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETECHTREE_GETFIRSTREACHROWINDEX_OFFSET UNITYSDK_OFFSET(0x1734E6A0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETECHTREE_GET_ROWS_OFFSET UNITYSDK_OFFSET(0x1734E950)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETECHTREE_HASANYIDLELIVETECHTREECANACTIVATE_OFFSET UNITYSDK_OFFSET(0x17341120)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETECHTREE_ISALLNODEACTIVATED_OFFSET UNITYSDK_OFFSET(0x1734E820)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETECHTREE_SET_ROWS_OFFSET UNITYSDK_OFFSET(0x1734E960)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETECHTREE__CTOR_OFFSET UNITYSDK_OFFSET(0x1734DED0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETECHTREE__DETERMINEROWTYPE_OFFSET UNITYSDK_OFFSET(0x1734DF50)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveBaseTechTree_TypeDefinitionIndex = 69457;
