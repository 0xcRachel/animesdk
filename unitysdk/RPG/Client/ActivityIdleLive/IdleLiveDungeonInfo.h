...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_BACKTOMAIN_OFFSET UNITYSDK_OFFSET(0x1735DC10)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_DOSTARTDUNGEON_OFFSET UNITYSDK_OFFSET(0x17360310)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_ENDBATTLE_OFFSET UNITYSDK_OFFSET(0x1735DE80)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_EXITDUNGEON_OFFSET UNITYSDK_OFFSET(0x1735E180)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_GETASSISTREWARD_OFFSET UNITYSDK_OFFSET(0x1735E4D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_GETAVATAREQUIPPEDSPEQUIPINFO_OFFSET UNITYSDK_OFFSET(0x1735EA80)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_GETCURRENTDUNGEONDATA_OFFSET UNITYSDK_OFFSET(0x1735E5E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_GETDUNGEONDATA_OFFSET UNITYSDK_OFFSET(0x1735DDA0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_GETSPEQUIPINVENTORYDISPLAYDATA_OFFSET UNITYSDK_OFFSET(0x1735E9B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_GET_DUNGEONDATAS_OFFSET UNITYSDK_OFFSET(0x17360860)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_GET_GAMEPLAYCONTEXT_OFFSET UNITYSDK_OFFSET(0x17360880)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_GET_HASREWARD_OFFSET UNITYSDK_OFFSET(0x17360850)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_GET_RANKINFO_OFFSET UNITYSDK_OFFSET(0x173608C0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_GET_SPEQUIPSLOTINFO_OFFSET UNITYSDK_OFFSET(0x173608E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_GET_TEAMINFO_OFFSET UNITYSDK_OFFSET(0x173608A0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_GET_TOTALPROGRESS_OFFSET UNITYSDK_OFFSET(0x1733CB80)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_HANDLEEARLYFINISHDUNGEON_OFFSET UNITYSDK_OFFSET(0x1735E460)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_INIT_OFFSET UNITYSDK_OFFSET(0x1735C140)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_REBUILDDUNGEON_OFFSET UNITYSDK_OFFSET(0x1735D420)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_REBUILDSPEQUIPSLOTINFO_OFFSET UNITYSDK_OFFSET(0x1735D4A0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_REFRESHFRIENDDUNGEONINFOWITHPROMISE_OFFSET UNITYSDK_OFFSET(0x1733CF40)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_REFRESHSELFTOTALPROGRESS_OFFSET UNITYSDK_OFFSET(0x1735E630)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_RESETALLDUNGEONFRIENDSOLTDATAS_OFFSET UNITYSDK_OFFSET(0x1735E860)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_SET_DUNGEONDATAS_OFFSET UNITYSDK_OFFSET(0x17360870)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_SET_GAMEPLAYCONTEXT_OFFSET UNITYSDK_OFFSET(0x17360890)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_SET_RANKINFO_OFFSET UNITYSDK_OFFSET(0x173608D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_SET_SPEQUIPSLOTINFO_OFFSET UNITYSDK_OFFSET(0x173608F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_SET_TEAMINFO_OFFSET UNITYSDK_OFFSET(0x173608B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_STARTDUNGEON_OFFSET UNITYSDK_OFFSET(0x1735C7B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x1735FAC0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_UPDATE_2_OFFSET UNITYSDK_OFFSET(0x1735FE80)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_UPDATE_3_OFFSET UNITYSDK_OFFSET(0x1735FEE0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_UPDATE_4_OFFSET UNITYSDK_OFFSET(0x17360560)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_UPDATE_5_OFFSET UNITYSDK_OFFSET(0x173606E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_UPDATE_OFFSET UNITYSDK_OFFSET(0x1735EEF0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x17360900)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO__INITASSITIDLIST_OFFSET UNITYSDK_OFFSET(0x1735CCC0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO__INITGAMEPLAYCONTEXT_OFFSET UNITYSDK_OFFSET(0x17360210)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO__INITSPSLOTS_OFFSET UNITYSDK_OFFSET(0x1735C420)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO__ISLOADING_OFFSET UNITYSDK_OFFSET(0x1735CBF0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO__ONSETPLURALITYHPNUM_OFFSET UNITYSDK_OFFSET(0x17360770)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO__TRYSYNCSPEQUIPTOPREFS_OFFSET UNITYSDK_OFFSET(0x1735CE80)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveDungeonInfo_TypeDefinitionIndex = 69268;
	...
	public:
		...
		::RPG::Client::ActivityIdleLive::IdleLiveDungeonTeamInfo* _TeamInfo_k__BackingField; // 0x28
		::RPG::Client::Promises::Promise* _FriendDungeonInfoPromise; // 0x30
		::System::Collections::Generic::List_1<::RPG::Client::ActivityIdleLive::IdleLiveDungeonData*>* _DungeonDatas_k__BackingField; // 0x38
		...
		::System::Void Update_3(::Class_1_36E3880E987172D7_6* rsp)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_36E3880E987172D7_6*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO_UPDATE_3_OFFSET))(this, rsp);
		}
		...
		::System::Void _InitGamePlayContext(::Class_1_36E3880E987172D7_6* rsp)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_36E3880E987172D7_6*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONINFO__INITGAMEPLAYCONTEXT_OFFSET))(this, rsp);
		}
