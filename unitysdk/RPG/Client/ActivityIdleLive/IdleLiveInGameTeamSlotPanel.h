...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL_AWAKE_OFFSET UNITYSDK_OFFSET(0x16C68CD0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL_GETCANMANUALUSESKILL_OFFSET UNITYSDK_OFFSET(0x16C6AE70)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL_INSERTSKILL_OFFSET UNITYSDK_OFFSET(0x16C6B1B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x16C6A4E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL_ONCLICK_OFFSET UNITYSDK_OFFSET(0x16C6AF60)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x16C68F60)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL_REFRESHLEVEL_OFFSET UNITYSDK_OFFSET(0x16C69950)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL_SETINTERACTIVE_OFFSET UNITYSDK_OFFSET(0x16C6AEB0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL_SETUPEMPTY_OFFSET UNITYSDK_OFFSET(0x16C6AD10)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL_SETUPLOCKED_OFFSET UNITYSDK_OFFSET(0x16C6AE10)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL_SETUPOCCUPIEDAVATAR_OFFSET UNITYSDK_OFFSET(0x16C691D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL_TRYGETEVENTMGR_OFFSET UNITYSDK_OFFSET(0x16C69C40)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL_UPDATE_OFFSET UNITYSDK_OFFSET(0x16C6A400)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL__BINDENTITY_OFFSET UNITYSDK_OFFSET(0x16C69E50)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL__CLEARSKILL_OFFSET UNITYSDK_OFFSET(0x16C690C0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0x16C6B360)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL__ENSURENODEINITIALIZED_OFFSET UNITYSDK_OFFSET(0x16C68D20)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL__FINDAVATARTOINIT_OFFSET UNITYSDK_OFFSET(0x16C695D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL__INITBINDHPCHANGEREFRESHHP_OFFSET UNITYSDK_OFFSET(0x16C69FD0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL__INITCTRLSKILL_OFFSET UNITYSDK_OFFSET(0x16C69EC0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL__ISAUTO_OFFSET UNITYSDK_OFFSET(0x16C6B050)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL__ISEMPTY_OFFSET UNITYSDK_OFFSET(0x16C69BF0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL__ONCHARACTERCREATED_OFFSET UNITYSDK_OFFSET(0x16C69D60)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL__PLAYSKILLCDENDHINTEFFECT_OFFSET UNITYSDK_OFFSET(0x16C6A9D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL__PLAYSKILLRESET_OFFSET UNITYSDK_OFFSET(0x16C6ABC0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL__PLAYSTATEWITHDEADCHECK_OFFSET UNITYSDK_OFFSET(0x16C69120)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL__REFRESHHPVIEW_OFFSET UNITYSDK_OFFSET(0x16C6A540)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL__REFRESHLEVEL_B__39_0_OFFSET UNITYSDK_OFFSET(0x16C6B370)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL__REFRESHONHPCHANGED_OFFSET UNITYSDK_OFFSET(0x16C6AC30)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL__REFRESHONMAXHPCHANGED_OFFSET UNITYSDK_OFFSET(0x16C6ACA0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL__REGISTEREVENTHANDLERS_OFFSET UNITYSDK_OFFSET(0x16C69880)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL__REMOVEEVENTHANDLERS_OFFSET UNITYSDK_OFFSET(0x16C69000)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL__UPDATECDVIEW_OFFSET UNITYSDK_OFFSET(0x16C6A480)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL__UPDATESKILLCD_OFFSET UNITYSDK_OFFSET(0x16C6A890)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMETEAMSLOTPANEL__UPDATESKILLSTATE_OFFSET UNITYSDK_OFFSET(0x16C6A7A0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveInGameTeamSlotPanel_TypeDefinitionIndex = 69243;
