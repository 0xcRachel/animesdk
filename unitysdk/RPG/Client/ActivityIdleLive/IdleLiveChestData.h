...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECHESTDATA_CANRANKUP_OFFSET UNITYSDK_OFFSET(0x17352B00)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECHESTDATA_GETBATCHOPENSIZE_OFFSET UNITYSDK_OFFSET(0x173527D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECHESTDATA_GETEXPRATIO_OFFSET UNITYSDK_OFFSET(0x17352A60)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECHESTDATA_GETRANKUPLEVELRATIO_OFFSET UNITYSDK_OFFSET(0x17352AB0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECHESTDATA_GET_AUTODECOMPOSERARITY_OFFSET UNITYSDK_OFFSET(0x173522F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECHESTDATA_GET_EQUIPPROBABILITIES_OFFSET UNITYSDK_OFFSET(0x17352370)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECHESTDATA_GET_EXPLIMIT_OFFSET UNITYSDK_OFFSET(0x17352360)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECHESTDATA_GET_EXP_OFFSET UNITYSDK_OFFSET(0x173522B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECHESTDATA_GET_ISAUTOOPEN_OFFSET UNITYSDK_OFFSET(0x173522D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECHESTDATA_GET_LEVELTORANKUP_OFFSET UNITYSDK_OFFSET(0x17352310)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECHESTDATA_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x17352290)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECHESTDATA_GET_MAXAUTODISCARDABLEEQUIPRARITY_OFFSET UNITYSDK_OFFSET(0x17352340)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECHESTDATA_GET_MAXRANK_OFFSET UNITYSDK_OFFSET(0x17352320)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECHESTDATA_GET_RANK_OFFSET UNITYSDK_OFFSET(0x17352270)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECHESTDATA_INIT_OFFSET UNITYSDK_OFFSET(0x17352380)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECHESTDATA_ISAUTOCHESTOPENUNLOCKED_OFFSET UNITYSDK_OFFSET(0x17352540)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECHESTDATA_SET_AUTODECOMPOSERARITY_OFFSET UNITYSDK_OFFSET(0x17352300)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECHESTDATA_SET_EXP_OFFSET UNITYSDK_OFFSET(0x173522C0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECHESTDATA_SET_ISAUTOOPEN_OFFSET UNITYSDK_OFFSET(0x173522E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECHESTDATA_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x173522A0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECHESTDATA_SET_MAXAUTODISCARDABLEEQUIPRARITY_OFFSET UNITYSDK_OFFSET(0x17352350)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECHESTDATA_SET_MAXRANK_OFFSET UNITYSDK_OFFSET(0x17352330)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECHESTDATA_SET_RANK_OFFSET UNITYSDK_OFFSET(0x17352280)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECHESTDATA_UPDATEAUTOSETTING_OFFSET UNITYSDK_OFFSET(0x173524E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECHESTDATA_UPDATEMAXPOSSIBLERARITY_OFFSET UNITYSDK_OFFSET(0x17352B50)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECHESTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17352C20)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECHESTDATA__UPDATEEXPLIMIT_OFFSET UNITYSDK_OFFSET(0x17352BA0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveChestData_TypeDefinitionIndex = 69227;
	...
	public:
		...
		::System::Boolean _IsAutoOpen_k__BackingField; // 0x18
		::System::Boolean _IsInited; // 0x19
		::System::UInt32 _AutoDecomposeRarity_k__BackingField; // 0x1C
		::System::UInt32 _ExpLimit; // 0x20
		::System::UInt32 _Level_k__BackingField; // 0x24
		::System::UInt32 _MaxAutoDiscardableEquipRarity_k__BackingField; // 0x28
