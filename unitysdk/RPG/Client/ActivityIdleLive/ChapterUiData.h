...
#define RPG_CLIENT_ACTIVITYIDLELIVE_CHAPTERUIDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x17339340)
#define RPG_CLIENT_ACTIVITYIDLELIVE_CHAPTERUIDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17339520)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int ChapterUiData_TypeDefinitionIndex = 69474;
	...
	public:
		...
		::System::UInt32 StarNum; // 0x30
		::System::Boolean IsHardMode; // 0x34
		::System::Boolean IsFinished; // 0x35
		::System::Boolean IsUnlocked; // 0x36
		::System::UInt32 ChapterId; // 0x38
		::RPG::Client::TextID Name; // 0x40
		::System::UInt32 CurProgress; // 0x50
		::System::UInt32 MaxProgress; // 0x54
