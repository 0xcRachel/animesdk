...
#define RPG_CLIENT_MATCHTHREEPLAYROLECUTINCMD_CREATE_OFFSET UNITYSDK_OFFSET(0x9B56700)
#define RPG_CLIENT_MATCHTHREEPLAYROLECUTINCMD_ONCLEAR_OFFSET UNITYSDK_OFFSET(0x9B568A0)
#define RPG_CLIENT_MATCHTHREEPLAYROLECUTINCMD_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x9B56780)
#define RPG_CLIENT_MATCHTHREEPLAYROLECUTINCMD__CTOR_OFFSET UNITYSDK_OFFSET(0x9B569A0)
#define RPG_CLIENT_MATCHTHREEPLAYROLECUTINCMD__ONCUTINCOMPLETED_OFFSET UNITYSDK_OFFSET(0x9B56850)
#define RPG_CLIENT_MATCHTHREEPLAYROLECUTINCMD___IFIXBASEPROXY_ONCLEAR_OFFSET UNITYSDK_OFFSET(0x9B56A10)
#define RPG_CLIENT_MATCHTHREEPLAYROLECUTINCMD___IFIXBASEPROXY_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x9B569B0)
