...
#define RPG_CLIENT_GRIDFIGHTEQUIPCHANGEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x180511F0)
...
namespace RPG::Client
{
	...
	public:
		...
		::RPG::Client::GridFightPlacementType PlacementType; // 0x18
		::System::UInt32 PlacementIndex; // 0x1C
