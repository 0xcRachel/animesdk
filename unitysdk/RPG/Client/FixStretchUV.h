...
#define RPG_CLIENT_FIXSTRETCHUV_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x15942D90)
#define RPG_CLIENT_FIXSTRETCHUV__CTOR_OFFSET UNITYSDK_OFFSET(0x15942DE0)
#define RPG_CLIENT_FIXSTRETCHUV___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x15942EB0)
