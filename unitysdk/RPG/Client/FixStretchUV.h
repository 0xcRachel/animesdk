...
#define RPG_CLIENT_FIXSTRETCHUV_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x9294F00)
#define RPG_CLIENT_FIXSTRETCHUV__CTOR_OFFSET UNITYSDK_OFFSET(0x9294F50)
#define RPG_CLIENT_FIXSTRETCHUV___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x9295020)

namespace RPG::Client
{
	inline static constexpr unsigned int FixStretchUV_TypeDefinitionIndex = 56241;
