...
#define RPG_CLIENT_INCONTROLICONPATHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x94D1080)

namespace RPG::Client
{
	inline static constexpr unsigned int InControlIconPathConfig_TypeDefinitionIndex = 48656;
