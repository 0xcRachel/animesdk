...
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_CREATEBYADVPLAYERID_OFFSET UNITYSDK_OFFSET(0x15880BF0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_CREATE_1_OFFSET UNITYSDK_OFFSET(0x15880B90)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x15880AE0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_ACTIONAVATARHEADICONPATH_OFFSET UNITYSDK_OFFSET(0x15881520)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_ADVDEFAULTAVATARHEADICONPATH_OFFSET UNITYSDK_OFFSET(0x15881F20)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_ADVENTUREPLAYERROW_OFFSET UNITYSDK_OFFSET(0x15880F60)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_ADVPLAYERPREFABPATH_OFFSET UNITYSDK_OFFSET(0x15881EB0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AUDIOEVENTTAG_OFFSET UNITYSDK_OFFSET(0x15882430)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARCUTINBGIMGPATH_OFFSET UNITYSDK_OFFSET(0x15881AC0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARCUTINFRONTIMGPATH_OFFSET UNITYSDK_OFFSET(0x15881BB0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARCUTINIMGPATH_OFFSET UNITYSDK_OFFSET(0x158819D0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARCUTININTROTEXT_OFFSET UNITYSDK_OFFSET(0x15881D90)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARDROPOFFSET_OFFSET UNITYSDK_OFFSET(0x15881CA0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0x15880D90)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARMINIICONPATH_OFFSET UNITYSDK_OFFSET(0x15881430)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARNAME_OFFSET UNITYSDK_OFFSET(0x15882310)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARROWWRAP_OFFSET UNITYSDK_OFFSET(0x15880D50)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARSELFSHOWOFFSET_OFFSET UNITYSDK_OFFSET(0x158821E0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARSIDEICONPATH_OFFSET UNITYSDK_OFFSET(0x15881340)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARSKINNAME_OFFSET UNITYSDK_OFFSET(0x15881060)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_CHARACTERSKINOVERRIDECONFIGPATH_OFFSET UNITYSDK_OFFSET(0x15882420)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_DEFAULTAVATARHEADICONPATH_OFFSET UNITYSDK_OFFSET(0x15881250)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_DEFAULTAVATARMODELPATH_OFFSET UNITYSDK_OFFSET(0x15881160)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_DRESSEDSKINID_OFFSET UNITYSDK_OFFSET(0x15882080)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_DRESSICONPATH_OFFSET UNITYSDK_OFFSET(0x15882440)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_ENHANCEDID_OFFSET UNITYSDK_OFFSET(0x15880E70)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_FREESTYLECHARACTERID_OFFSET UNITYSDK_OFFSET(0x15881EA0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_MANIKINJSONPATH_OFFSET UNITYSDK_OFFSET(0x15881F90)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_OVERRIDEADVPLAYERID_OFFSET UNITYSDK_OFFSET(0x15880D70)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_PLAYERCARDID_OFFSET UNITYSDK_OFFSET(0x15881E90)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_SIDEAVATARHEADICONPATH_OFFSET UNITYSDK_OFFSET(0x158817F0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_SKINDESC_OFFSET UNITYSDK_OFFSET(0x158822D0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_SKINITEMAVATARICONPATH_OFFSET UNITYSDK_OFFSET(0x15882090)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_SKINTYPE_OFFSET UNITYSDK_OFFSET(0x15882410)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_UIAVATARMODELPATH_OFFSET UNITYSDK_OFFSET(0x15881700)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_ULTRASKILLCUTINPREFABPATH_OFFSET UNITYSDK_OFFSET(0x15881610)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_WAITINGAVATARHEADICONPATH_OFFSET UNITYSDK_OFFSET(0x158818E0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_MAPTOSKINRES_OFFSET UNITYSDK_OFFSET(0x15882450)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_SET_AVATARROWWRAP_OFFSET UNITYSDK_OFFSET(0x15880D60)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_SET_OVERRIDEADVPLAYERID_OFFSET UNITYSDK_OFFSET(0x15880D80)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x15880B80)
