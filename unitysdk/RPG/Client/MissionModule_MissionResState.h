...
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_DELETEFINISHEDMISSIONRES_OFFSET UNITYSDK_OFFSET(0x9753860)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_GETDELETESIZE_OFFSET UNITYSDK_OFFSET(0x97537A0)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_GETDOWNLOADSIZE_OFFSET UNITYSDK_OFFSET(0x9753800)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_GETFINISHEDMISSIONIDS_OFFSET UNITYSDK_OFFSET(0x9753410)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_ISAUTOCLEARMISSIONRES_OFFSET UNITYSDK_OFFSET(0x9753240)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_ISFUNCTIONENABLED_OFFSET UNITYSDK_OFFSET(0x9753040)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_ISSHOWCLEARMISSIONRESREDDOT_OFFSET UNITYSDK_OFFSET(0x97534F0)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_LOCKINFINISHEDMISSIONIDS_OFFSET UNITYSDK_OFFSET(0x9753450)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_MARKCLEARMISSIONRESSHOWN_OFFSET UNITYSDK_OFFSET(0x9753530)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_ONMAINMISSIONFINISHED_OFFSET UNITYSDK_OFFSET(0x9751FE0)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_RESTOREMISSIONRES_OFFSET UNITYSDK_OFFSET(0x9753610)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_SETAUTOCLEARMISSIONRES_OFFSET UNITYSDK_OFFSET(0x97539F0)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_TRYAUTOSAVEFINISHEDMISSIONTOLOCAL_OFFSET UNITYSDK_OFFSET(0x9753310)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_UPDATESTATEBYFINISHEDMISSION_OFFSET UNITYSDK_OFFSET(0x973D2A0)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE__CHECKMISSIONRESSIZE_OFFSET UNITYSDK_OFFSET(0x97530E0)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x974A010)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE__RECOMMENDDELETESIZE_OFFSET UNITYSDK_OFFSET(0x9753CE0)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE__RESETFINISHEDMISSIONTOLOCAL_OFFSET UNITYSDK_OFFSET(0x9753C80)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE__SAVEFINISHEDMISSIONTOLOCAL_OFFSET UNITYSDK_OFFSET(0x97533B0)

namespace RPG::Client
{
	inline static constexpr unsigned int MissionModule_MissionResState_TypeDefinitionIndex = 52628;
