...
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_DELETEFINISHEDMISSIONRES_OFFSET UNITYSDK_OFFSET(0x15294380)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_GETDELETESIZE_OFFSET UNITYSDK_OFFSET(0x152942C0)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_GETDOWNLOADSIZE_OFFSET UNITYSDK_OFFSET(0x15294320)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_GETFINISHEDMISSIONIDS_OFFSET UNITYSDK_OFFSET(0x15293F30)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_ISAUTOCLEARMISSIONRES_OFFSET UNITYSDK_OFFSET(0x15293D60)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_ISFUNCTIONENABLED_OFFSET UNITYSDK_OFFSET(0x15293780)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_ISSHOWCLEARMISSIONRESREDDOT_OFFSET UNITYSDK_OFFSET(0x15294010)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_LOCKINFINISHEDMISSIONIDS_OFFSET UNITYSDK_OFFSET(0x15293F70)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_MARKCLEARMISSIONRESSHOWN_OFFSET UNITYSDK_OFFSET(0x15294050)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_ONMAINMISSIONFINISHED_OFFSET UNITYSDK_OFFSET(0x152923C0)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_RESTOREMISSIONRES_OFFSET UNITYSDK_OFFSET(0x15294130)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_SETAUTOCLEARMISSIONRES_OFFSET UNITYSDK_OFFSET(0x15294510)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_TRYAUTOSAVEFINISHEDMISSIONTOLOCAL_OFFSET UNITYSDK_OFFSET(0x15293E30)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_UPDATESTATEBYFINISHEDMISSION_OFFSET UNITYSDK_OFFSET(0x15293820)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE__CHECKMISSIONRESSIZE_OFFSET UNITYSDK_OFFSET(0x15293C00)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1528A1D0)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE__RECOMMENDDELETESIZE_OFFSET UNITYSDK_OFFSET(0x15294800)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE__RESETFINISHEDMISSIONTOLOCAL_OFFSET UNITYSDK_OFFSET(0x152947A0)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE__SAVEFINISHEDMISSIONTOLOCAL_OFFSET UNITYSDK_OFFSET(0x15293ED0)
