...
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_DELETEFINISHEDMISSIONRES_OFFSET UNITYSDK_OFFSET(0x9BF8E40)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_GETDELETESIZE_OFFSET UNITYSDK_OFFSET(0x9BF8D80)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_GETDOWNLOADSIZE_OFFSET UNITYSDK_OFFSET(0x9BF8DE0)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_GETFINISHEDMISSIONIDS_OFFSET UNITYSDK_OFFSET(0x9BF89F0)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_ISAUTOCLEARMISSIONRES_OFFSET UNITYSDK_OFFSET(0x9BF8820)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_ISFUNCTIONENABLED_OFFSET UNITYSDK_OFFSET(0x9BF8620)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_ISSHOWCLEARMISSIONRESREDDOT_OFFSET UNITYSDK_OFFSET(0x9BF8AD0)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_LOCKINFINISHEDMISSIONIDS_OFFSET UNITYSDK_OFFSET(0x9BF8A30)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_MARKCLEARMISSIONRESSHOWN_OFFSET UNITYSDK_OFFSET(0x9BF8B10)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_ONMAINMISSIONFINISHED_OFFSET UNITYSDK_OFFSET(0x9BF75D0)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_RESTOREMISSIONRES_OFFSET UNITYSDK_OFFSET(0x9BF8BF0)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_SETAUTOCLEARMISSIONRES_OFFSET UNITYSDK_OFFSET(0x9BF8FD0)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_TRYAUTOSAVEFINISHEDMISSIONTOLOCAL_OFFSET UNITYSDK_OFFSET(0x9BF88F0)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE_UPDATESTATEBYFINISHEDMISSION_OFFSET UNITYSDK_OFFSET(0x9BE29C0)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE__CHECKMISSIONRESSIZE_OFFSET UNITYSDK_OFFSET(0x9BF86C0)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x9BEF610)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE__RECOMMENDDELETESIZE_OFFSET UNITYSDK_OFFSET(0x9BF92C0)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE__RESETFINISHEDMISSIONTOLOCAL_OFFSET UNITYSDK_OFFSET(0x9BF9260)
#define RPG_CLIENT_MISSIONMODULE_MISSIONRESSTATE__SAVEFINISHEDMISSIONTOLOCAL_OFFSET UNITYSDK_OFFSET(0x9BF8990)
