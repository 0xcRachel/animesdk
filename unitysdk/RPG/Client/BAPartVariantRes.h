...
class Class_1_9B8D6DA11DB1F3D3;
...
#define RPG_CLIENT_BAPARTVARIANTRES_METHOD_1_1041E4ED3107B921_OFFSET UNITYSDK_OFFSET(0x8D639D0)
#define RPG_CLIENT_BAPARTVARIANTRES_METHOD_1_18D9238B9C310BFF_OFFSET UNITYSDK_OFFSET(0x8D63A60)
#define RPG_CLIENT_BAPARTVARIANTRES_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x8D62FD0)
#define RPG_CLIENT_BAPARTVARIANTRES_METHOD_1_3C8D3D5994F57353_OFFSET UNITYSDK_OFFSET(0x8D62F10)
#define RPG_CLIENT_BAPARTVARIANTRES_METHOD_1_426F10C86F2F4793_OFFSET UNITYSDK_OFFSET(0x8D63070)
#define RPG_CLIENT_BAPARTVARIANTRES_METHOD_1_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x8D64130)
#define RPG_CLIENT_BAPARTVARIANTRES_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x8D640C0)
#define RPG_CLIENT_BAPARTVARIANTRES_METHOD_1_9E0AE5CCF5240C75_OFFSET UNITYSDK_OFFSET(0x8D63950)
#define RPG_CLIENT_BAPARTVARIANTRES_METHOD_1_ADF4AD3331B4D7AD_OFFSET UNITYSDK_OFFSET(0x8D63020)
#define RPG_CLIENT_BAPARTVARIANTRES_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x8D63BB0)
#define RPG_CLIENT_BAPARTVARIANTRES_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x8D62F80)
#define RPG_CLIENT_BAPARTVARIANTRES_METHOD_1_CC3053D4FB0528C3_OFFSET UNITYSDK_OFFSET(0x8D63C40)
#define RPG_CLIENT_BAPARTVARIANTRES_RESET_OFFSET UNITYSDK_OFFSET(0x8D62E00)
#define RPG_CLIENT_BAPARTVARIANTRES__CCTOR_OFFSET UNITYSDK_OFFSET(0x8D64200)
#define RPG_CLIENT_BAPARTVARIANTRES__CTOR_OFFSET UNITYSDK_OFFSET(0x8D641A0)

namespace RPG::Client
{
	inline static constexpr unsigned int BAPartVariantRes_TypeDefinitionIndex = 55257;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(BAPartVariantRes_TypeDefinitionIndex)->GetStaticField(0xC860);
		}
		static ::System::Int32* StaticGet__DitherAlpha()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(BAPartVariantRes_TypeDefinitionIndex)->GetStaticField(0xC864);
		}
		static ::System::Int32* StaticGet__UsingDitherAlpha()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(BAPartVariantRes_TypeDefinitionIndex)->GetStaticField(0xC868);
		}
		::UnityEngine::Rendering::BatchAnimationInstance* instance; // 0x10
		::Class_3_6C54BE5953054E2B* loadCb; // 0x18
		::Il2CppArray<::Class_1_9B8D6DA11DB1F3D3*>* resLods; // 0x20
