...
#define RPG_CLIENT_MATCHTHREEFLYEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x9B421F0)
#define RPG_CLIENT_MATCHTHREEFLYEFFECT_FLYFROMPOS_OFFSET UNITYSDK_OFFSET(0x9B41FB0)
#define RPG_CLIENT_MATCHTHREEFLYEFFECT_FLY_OFFSET UNITYSDK_OFFSET(0x9B41D00)
#define RPG_CLIENT_MATCHTHREEFLYEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0x9B42230)
#define RPG_CLIENT_MATCHTHREEFLYEFFECT_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x9B42110)
#define RPG_CLIENT_MATCHTHREEFLYEFFECT_SETSIZE_OFFSET UNITYSDK_OFFSET(0x9B42090)
#define RPG_CLIENT_MATCHTHREEFLYEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0x9B421B0)
#define RPG_CLIENT_MATCHTHREEFLYEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x9B423A0)
#define RPG_CLIENT_MATCHTHREEFLYEFFECT__FLY_OFFSET UNITYSDK_OFFSET(0x9B41DF0)
