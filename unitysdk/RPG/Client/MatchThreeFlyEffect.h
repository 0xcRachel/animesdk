...
#define RPG_CLIENT_MATCHTHREEFLYEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x965C080)
#define RPG_CLIENT_MATCHTHREEFLYEFFECT_FLYFROMPOS_OFFSET UNITYSDK_OFFSET(0x965BE40)
#define RPG_CLIENT_MATCHTHREEFLYEFFECT_FLY_OFFSET UNITYSDK_OFFSET(0x965BB90)
#define RPG_CLIENT_MATCHTHREEFLYEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0x965C0C0)
#define RPG_CLIENT_MATCHTHREEFLYEFFECT_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x965BFA0)
#define RPG_CLIENT_MATCHTHREEFLYEFFECT_SETSIZE_OFFSET UNITYSDK_OFFSET(0x965BF20)
#define RPG_CLIENT_MATCHTHREEFLYEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0x965C040)
#define RPG_CLIENT_MATCHTHREEFLYEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x965C230)
#define RPG_CLIENT_MATCHTHREEFLYEFFECT__FLY_OFFSET UNITYSDK_OFFSET(0x965BC80)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeFlyEffect_TypeDefinitionIndex = 52420;
