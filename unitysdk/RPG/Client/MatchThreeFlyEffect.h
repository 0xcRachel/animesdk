...
#define RPG_CLIENT_MATCHTHREEFLYEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x16F77F70)
#define RPG_CLIENT_MATCHTHREEFLYEFFECT_FLYFROMPOS_OFFSET UNITYSDK_OFFSET(0x16F77D30)
#define RPG_CLIENT_MATCHTHREEFLYEFFECT_FLY_OFFSET UNITYSDK_OFFSET(0x16F77A80)
#define RPG_CLIENT_MATCHTHREEFLYEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0x16F77FB0)
#define RPG_CLIENT_MATCHTHREEFLYEFFECT_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x16F77E90)
#define RPG_CLIENT_MATCHTHREEFLYEFFECT_SETSIZE_OFFSET UNITYSDK_OFFSET(0x16F77E10)
#define RPG_CLIENT_MATCHTHREEFLYEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0x16F77F30)
#define RPG_CLIENT_MATCHTHREEFLYEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F78120)
#define RPG_CLIENT_MATCHTHREEFLYEFFECT__FLY_OFFSET UNITYSDK_OFFSET(0x16F77B70)
