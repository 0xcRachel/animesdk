...
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_CANINTERACTWHENPAUSE_OFFSET UNITYSDK_OFFSET(0xA5C53C0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_CANTRIGGERPAUSE_OFFSET UNITYSDK_OFFSET(0xA5C5400)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_CHECKCANINTERACT_OFFSET UNITYSDK_OFFSET(0xA5C4C70)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_CHECKCOLLIDERHITTARGETVALID_OFFSET UNITYSDK_OFFSET(0xA5C51B0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_CHECKCOLLIDERNEEDHITDETECT_OFFSET UNITYSDK_OFFSET(0xA5C5160)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA5C5D30)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_ENTERCONTROLMODE_OFFSET UNITYSDK_OFFSET(0xA5C4510)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_EXITCONTROLMODE_OFFSET UNITYSDK_OFFSET(0xA5C3CB0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_GETTARGETDURATION_OFFSET UNITYSDK_OFFSET(0xA5C4F20)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_GETTARGETRATIO_OFFSET UNITYSDK_OFFSET(0xA5C4FA0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_GETTIMEREWINDSTATE_OFFSET UNITYSDK_OFFSET(0xA5C4CE0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_GETTIMEREWINDVIEWOVERRIDE_OFFSET UNITYSDK_OFFSET(0xA5C4DE0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_GETTRACKNODECOUNT_OFFSET UNITYSDK_OFFSET(0xA5C5020)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_GETTRACKNODEPERCENTAGE_OFFSET UNITYSDK_OFFSET(0xA5C50B0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_GET_AUTOTRIGGERFINISHEVENT_OFFSET UNITYSDK_OFFSET(0xA5C5E40)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_GET_BINDTYPE_OFFSET UNITYSDK_OFFSET(0xA5C5E60)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_GET_ISINCONTROL_OFFSET UNITYSDK_OFFSET(0xA5C5DE0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_GET_ISINMOTION_OFFSET UNITYSDK_OFFSET(0xA5C49F0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_GET_ISPAUSE_OFFSET UNITYSDK_OFFSET(0xA5C5D80)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_GET_ISTARGETVALID_OFFSET UNITYSDK_OFFSET(0xA5C5E80)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_GET_LOCKRAYCASTCHECKIGNOREINNERTARGET_OFFSET UNITYSDK_OFFSET(0xA5C5E50)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_GET_PAUSEBYCONDITION_OFFSET UNITYSDK_OFFSET(0xA5C5E70)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_GET_TIMEREWINDSTATE_OFFSET UNITYSDK_OFFSET(0xA5C4D80)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_GET__ISINCONTROL_OFFSET UNITYSDK_OFFSET(0xA5C4780)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_GET__ISINMOTION_OFFSET UNITYSDK_OFFSET(0xA5C4C10)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_INIT_OFFSET UNITYSDK_OFFSET(0xA5C3550)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_ISACTIVETARGET_OFFSET UNITYSDK_OFFSET(0xA5C4ED0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_MANUALSNAPLOOPREWINDRATIO_OFFSET UNITYSDK_OFFSET(0xA5C47E0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_ONFINISHREBUILD_OFFSET UNITYSDK_OFFSET(0xA5C4AD0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_PAUSE_OFFSET UNITYSDK_OFFSET(0xA5C5200)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_PRELOADEFFECT_OFFSET UNITYSDK_OFFSET(0xA5C3760)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_RELEASEPRELOADEFFECT_OFFSET UNITYSDK_OFFSET(0xA5C37C0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_RESUMEPAUSE_OFFSET UNITYSDK_OFFSET(0xA5C52F0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_REVERTTRANSITIONIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0xA5C4B20)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_SETSPECULARMATFADETIME_OFFSET UNITYSDK_OFFSET(0xA5C4E40)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_SETSTATEBYSTATEHASH_OFFSET UNITYSDK_OFFSET(0xA5C3930)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_STARTREBUILD_OFFSET UNITYSDK_OFFSET(0xA5C4A50)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_TICK_OFFSET UNITYSDK_OFFSET(0xA5C35A0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_TRIGGERMOTIONPAUSEACTION_OFFSET UNITYSDK_OFFSET(0xA5C3870)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_TRIGGERRESUMEMOTIONPAUSEACTION_OFFSET UNITYSDK_OFFSET(0xA5C38D0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_TRYREWINDONCE_OFFSET UNITYSDK_OFFSET(0xA5C4480)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0xA5C5EA0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET__SETTIMEREWINDSTATE_OFFSET UNITYSDK_OFFSET(0xA5C43E0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET__TICKMOTIONSTATE_OFFSET UNITYSDK_OFFSET(0xA5C5970)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET__TICKNOMOTIONSTATE_OFFSET UNITYSDK_OFFSET(0xA5C55E0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET__TICKTARGETRATIO_OFFSET UNITYSDK_OFFSET(0xA5C3610)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET__TRYEXITMOTIONWITHSTABLESTATE_OFFSET UNITYSDK_OFFSET(0xA5C40A0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET__TRYEXITMOTION_OFFSET UNITYSDK_OFFSET(0xA5C5450)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET__TRYSTARTMOTION_OFFSET UNITYSDK_OFFSET(0xA5C4050)
