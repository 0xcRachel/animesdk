...
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_CANINTERACTWHENPAUSE_OFFSET UNITYSDK_OFFSET(0xA0A1320)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_CANTRIGGERPAUSE_OFFSET UNITYSDK_OFFSET(0xA0A1360)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_CHECKCANINTERACT_OFFSET UNITYSDK_OFFSET(0xA0A0BC0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_CHECKCOLLIDERHITTARGETVALID_OFFSET UNITYSDK_OFFSET(0xA0A1110)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_CHECKCOLLIDERNEEDHITDETECT_OFFSET UNITYSDK_OFFSET(0xA0A10C0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA0A1C90)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_ENTERCONTROLMODE_OFFSET UNITYSDK_OFFSET(0xA0A0460)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_EXITCONTROLMODE_OFFSET UNITYSDK_OFFSET(0xA09FC00)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_GETTARGETDURATION_OFFSET UNITYSDK_OFFSET(0xA0A0E80)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_GETTARGETRATIO_OFFSET UNITYSDK_OFFSET(0xA0A0F00)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_GETTIMEREWINDSTATE_OFFSET UNITYSDK_OFFSET(0xA0A0C30)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_GETTIMEREWINDVIEWOVERRIDE_OFFSET UNITYSDK_OFFSET(0xA0A0D30)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_GETTRACKNODECOUNT_OFFSET UNITYSDK_OFFSET(0xA0A0F80)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_GETTRACKNODEPERCENTAGE_OFFSET UNITYSDK_OFFSET(0xA0A1010)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_GET_AUTOTRIGGERFINISHEVENT_OFFSET UNITYSDK_OFFSET(0xA0A1DA0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_GET_BINDTYPE_OFFSET UNITYSDK_OFFSET(0xA0A1DC0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_GET_ISINCONTROL_OFFSET UNITYSDK_OFFSET(0xA0A1D40)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_GET_ISINMOTION_OFFSET UNITYSDK_OFFSET(0xA0A0940)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_GET_ISPAUSE_OFFSET UNITYSDK_OFFSET(0xA0A1CE0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_GET_ISTARGETVALID_OFFSET UNITYSDK_OFFSET(0xA0A1DE0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_GET_LOCKRAYCASTCHECKIGNOREINNERTARGET_OFFSET UNITYSDK_OFFSET(0xA0A1DB0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_GET_PAUSEBYCONDITION_OFFSET UNITYSDK_OFFSET(0xA0A1DD0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_GET_TIMEREWINDSTATE_OFFSET UNITYSDK_OFFSET(0xA0A0CD0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_GET__ISINCONTROL_OFFSET UNITYSDK_OFFSET(0xA0A06D0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_GET__ISINMOTION_OFFSET UNITYSDK_OFFSET(0xA0A0B60)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_INIT_OFFSET UNITYSDK_OFFSET(0xA09F490)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_ISACTIVETARGET_OFFSET UNITYSDK_OFFSET(0xA0A0E30)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_MANUALSNAPLOOPREWINDRATIO_OFFSET UNITYSDK_OFFSET(0xA0A0730)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_ONFINISHREBUILD_OFFSET UNITYSDK_OFFSET(0xA0A0A20)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_PAUSE_OFFSET UNITYSDK_OFFSET(0xA0A1160)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_PRELOADEFFECT_OFFSET UNITYSDK_OFFSET(0xA09F6B0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_RELEASEPRELOADEFFECT_OFFSET UNITYSDK_OFFSET(0xA09F710)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_RESUMEPAUSE_OFFSET UNITYSDK_OFFSET(0xA0A1250)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_REVERTTRANSITIONIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0xA0A0A70)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_SETSPECULARMATFADETIME_OFFSET UNITYSDK_OFFSET(0xA0A0D90)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_SETSTATEBYSTATEHASH_OFFSET UNITYSDK_OFFSET(0xA09F880)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_STARTREBUILD_OFFSET UNITYSDK_OFFSET(0xA0A09A0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_TICK_OFFSET UNITYSDK_OFFSET(0xA09F4E0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_TRIGGERMOTIONPAUSEACTION_OFFSET UNITYSDK_OFFSET(0xA09F7C0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_TRIGGERRESUMEMOTIONPAUSEACTION_OFFSET UNITYSDK_OFFSET(0xA09F820)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET_TRYREWINDONCE_OFFSET UNITYSDK_OFFSET(0xA0A03D0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0xA0A1E00)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET__SETTIMEREWINDSTATE_OFFSET UNITYSDK_OFFSET(0xA0A0330)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET__TICKMOTIONSTATE_OFFSET UNITYSDK_OFFSET(0xA0A18D0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET__TICKNOMOTIONSTATE_OFFSET UNITYSDK_OFFSET(0xA0A1540)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET__TICKTARGETRATIO_OFFSET UNITYSDK_OFFSET(0xA09F550)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET__TRYEXITMOTIONWITHSTABLESTATE_OFFSET UNITYSDK_OFFSET(0xA09FFF0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET__TRYEXITMOTION_OFFSET UNITYSDK_OFFSET(0xA0A13B0)
#define RPG_CLIENT_TIMEREWINDSINGLETARGET__TRYSTARTMOTION_OFFSET UNITYSDK_OFFSET(0xA09FFA0)

namespace RPG::Client
{
	inline static constexpr unsigned int TimeRewindSingleTarget_TypeDefinitionIndex = 48192;
