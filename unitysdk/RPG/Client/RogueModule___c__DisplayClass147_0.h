...
class Class_1_FA4F4A67B1C04320_703;
namespace RPG::Client { class RogueAreaData; }

#define RPG_CLIENT_ROGUEMODULE___C__DISPLAYCLASS147_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9E2EBA0)
#define RPG_CLIENT_ROGUEMODULE___C__DISPLAYCLASS147_0___ONCMDSYNCROGUEAREAUNLOCKSCNOTIFY_B__0_OFFSET UNITYSDK_OFFSET(0x9E33080)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueModule___c__DisplayClass147_0_TypeDefinitionIndex = 53609;

	class RogueModule___c__DisplayClass147_0 : public ::System::Object
	{
	public:
		::Class_1_FA4F4A67B1C04320_703* rsp; // 0x10
