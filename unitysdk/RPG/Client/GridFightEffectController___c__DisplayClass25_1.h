...
#define RPG_CLIENT_GRIDFIGHTEFFECTCONTROLLER___C__DISPLAYCLASS25_1__CTOR_OFFSET UNITYSDK_OFFSET(0x9345BC0)
#define RPG_CLIENT_GRIDFIGHTEFFECTCONTROLLER___C__DISPLAYCLASS25_1__PLAYUPGRADEEFFECT_B__1_OFFSET UNITYSDK_OFFSET(0x9347180)
#define RPG_CLIENT_GRIDFIGHTEFFECTCONTROLLER___C__DISPLAYCLASS25_1__PLAYUPGRADEEFFECT_B__2_OFFSET UNITYSDK_OFFSET(0x93471F0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightEffectController___c__DisplayClass25_1_TypeDefinitionIndex = 51250;
