...
#define RPG_CLIENT_CHIMERAWORKSETTLEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8F435D0)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraWorkSettleData_TypeDefinitionIndex = 50388;
