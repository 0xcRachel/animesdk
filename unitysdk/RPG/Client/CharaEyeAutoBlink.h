...
#define RPG_CLIENT_CHARAEYEAUTOBLINK_AWAKE_OFFSET UNITYSDK_OFFSET(0x8EA2660)
#define RPG_CLIENT_CHARAEYEAUTOBLINK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x8EA2370)
#define RPG_CLIENT_CHARAEYEAUTOBLINK_METHOD_5_52CA0F45BC3414DC_OFFSET UNITYSDK_OFFSET(0x8EA27B0)
#define RPG_CLIENT_CHARAEYEAUTOBLINK_UPDATE_OFFSET UNITYSDK_OFFSET(0x8EA28B0)
#define RPG_CLIENT_CHARAEYEAUTOBLINK__CTOR_OFFSET UNITYSDK_OFFSET(0x8EA2A50)

namespace RPG::Client
{
	inline static constexpr unsigned int CharaEyeAutoBlink_TypeDefinitionIndex = 54250;
	...
	public:
		...
		::Class_0_16E4307DCC419505_705* Field_5_7; // 0x48
