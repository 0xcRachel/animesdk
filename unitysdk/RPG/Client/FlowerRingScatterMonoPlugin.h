...
#define RPG_CLIENT_FLOWERRINGSCATTERMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x929F0F0)

namespace RPG::Client
{
	inline static constexpr unsigned int FlowerRingScatterMonoPlugin_TypeDefinitionIndex = 56248;
