...
#define RPG_CLIENT_CURVEOBJECTLOADTRIGGER_METHOD_1_B1476C314B32BFD8_OFFSET UNITYSDK_OFFSET(0x15C0F950)
#define RPG_CLIENT_CURVEOBJECTLOADTRIGGER_METHOD_1_B24D6784786E080C_OFFSET UNITYSDK_OFFSET(0x15C0FA90)
#define RPG_CLIENT_CURVEOBJECTLOADTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x15C0FB80)
