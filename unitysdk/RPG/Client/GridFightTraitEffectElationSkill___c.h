...
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTELATIONSKILL___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x17432180)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTELATIONSKILL___C__CTOR_OFFSET UNITYSDK_OFFSET(0x174321C0)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTELATIONSKILL___C___GETCONFIGS_B__1_0_OFFSET UNITYSDK_OFFSET(0x174321D0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Func_2<::System::UInt32, ::RPG::Client::GridFightElationSkillConfig*>**)Il2CppClass::FromTypeDefinitionIndex(GridFightTraitEffectElationSkill___c_TypeDefinitionIndex)->GetStaticField(0x35410);
		}
		static ::RPG::Client::GridFightTraitEffectElationSkill___c** StaticGet___9()
		{
			return (::RPG::Client::GridFightTraitEffectElationSkill___c**)Il2CppClass::FromTypeDefinitionIndex(GridFightTraitEffectElationSkill___c_TypeDefinitionIndex)->GetStaticField(0x35418);
		}
