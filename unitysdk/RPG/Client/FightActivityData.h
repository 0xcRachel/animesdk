...
#define RPG_CLIENT_FIGHTACTIVITYDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x92474C0)
#define RPG_CLIENT_FIGHTACTIVITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x92474B0)
#define RPG_CLIENT_FIGHTACTIVITYDATA___IFIXBASEPROXY_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x9247B20)

namespace RPG::Client
{
	inline static constexpr unsigned int FightActivityData_TypeDefinitionIndex = 48857;
