...
#define RPG_CLIENT_CHIMERAVIEWPROXY___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x93E6050)
#define RPG_CLIENT_CHIMERAVIEWPROXY___C__CTOR_OFFSET UNITYSDK_OFFSET(0x93E6090)
#define RPG_CLIENT_CHIMERAVIEWPROXY___C__POSTEVENT_B__4_0_OFFSET UNITYSDK_OFFSET(0x93E60A0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Action**)Il2CppClass::FromTypeDefinitionIndex(ChimeraViewProxy___c_TypeDefinitionIndex)->GetStaticField(0x46D50);
		}
		static ::RPG::Client::ChimeraViewProxy___c** StaticGet___9()
		{
			return (::RPG::Client::ChimeraViewProxy___c**)Il2CppClass::FromTypeDefinitionIndex(ChimeraViewProxy___c_TypeDefinitionIndex)->GetStaticField(0x46D58);
		}
