...
#define RPG_CLIENT_CHALLENGEPEAKNORMALFRIENDLINEUPRECOMMENDATION_CLEAR_OFFSET UNITYSDK_OFFSET(0x15FB1C30)
#define RPG_CLIENT_CHALLENGEPEAKNORMALFRIENDLINEUPRECOMMENDATION_CREATE_OFFSET UNITYSDK_OFFSET(0x15FAC290)
#define RPG_CLIENT_CHALLENGEPEAKNORMALFRIENDLINEUPRECOMMENDATION_GETCOUNTOFSTARS_OFFSET UNITYSDK_OFFSET(0x15FB2220)
#define RPG_CLIENT_CHALLENGEPEAKNORMALFRIENDLINEUPRECOMMENDATION_GETLINEUPAVATARIDS_OFFSET UNITYSDK_OFFSET(0x15FB1E80)
#define RPG_CLIENT_CHALLENGEPEAKNORMALFRIENDLINEUPRECOMMENDATION_GETLINEUPAVATARLEVELS_OFFSET UNITYSDK_OFFSET(0x15FB2290)
#define RPG_CLIENT_CHALLENGEPEAKNORMALFRIENDLINEUPRECOMMENDATION_GETLINEUPAVATARSKINIDS_OFFSET UNITYSDK_OFFSET(0x15FB23A0)
#define RPG_CLIENT_CHALLENGEPEAKNORMALFRIENDLINEUPRECOMMENDATION_GETLINEUPDETAILINFO_OFFSET UNITYSDK_OFFSET(0x15FB24B0)
#define RPG_CLIENT_CHALLENGEPEAKNORMALFRIENDLINEUPRECOMMENDATION_GETLINEUPPLAYERBRIEFDISPLAYDATA_OFFSET UNITYSDK_OFFSET(0x15FB1CA0)
#define RPG_CLIENT_CHALLENGEPEAKNORMALFRIENDLINEUPRECOMMENDATION_GETMONSTERICONPATH_OFFSET UNITYSDK_OFFSET(0x15FB20B0)
#define RPG_CLIENT_CHALLENGEPEAKNORMALFRIENDLINEUPRECOMMENDATION_GETTITLE_OFFSET UNITYSDK_OFFSET(0x15FB2170)
#define RPG_CLIENT_CHALLENGEPEAKNORMALFRIENDLINEUPRECOMMENDATION_GET_CANREFRESH_OFFSET UNITYSDK_OFFSET(0x15FB19D0)
#define RPG_CLIENT_CHALLENGEPEAKNORMALFRIENDLINEUPRECOMMENDATION_GET_COUNTOFLINEUPS_OFFSET UNITYSDK_OFFSET(0x15FB1920)
#define RPG_CLIENT_CHALLENGEPEAKNORMALFRIENDLINEUPRECOMMENDATION_GET_FRIENDRECOMMENDTYPE_OFFSET UNITYSDK_OFFSET(0x15FB1910)
#define RPG_CLIENT_CHALLENGEPEAKNORMALFRIENDLINEUPRECOMMENDATION_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x15FB18D0)
#define RPG_CLIENT_CHALLENGEPEAKNORMALFRIENDLINEUPRECOMMENDATION_GET_ISDATAREADY_OFFSET UNITYSDK_OFFSET(0x15FB1980)
#define RPG_CLIENT_CHALLENGEPEAKNORMALFRIENDLINEUPRECOMMENDATION_GET_MAXTEAMCOUNT_OFFSET UNITYSDK_OFFSET(0x15FB1970)
#define RPG_CLIENT_CHALLENGEPEAKNORMALFRIENDLINEUPRECOMMENDATION_GET_RECOMMENDTYPE_OFFSET UNITYSDK_OFFSET(0x15FB1900)
#define RPG_CLIENT_CHALLENGEPEAKNORMALFRIENDLINEUPRECOMMENDATION_REFRESH_OFFSET UNITYSDK_OFFSET(0x15FB1AB0)
#define RPG_CLIENT_CHALLENGEPEAKNORMALFRIENDLINEUPRECOMMENDATION_REPORTACTION_OFFSET UNITYSDK_OFFSET(0x15FB26C0)
#define RPG_CLIENT_CHALLENGEPEAKNORMALFRIENDLINEUPRECOMMENDATION_SET_CANREFRESH_OFFSET UNITYSDK_OFFSET(0x15FB19E0)
#define RPG_CLIENT_CHALLENGEPEAKNORMALFRIENDLINEUPRECOMMENDATION__CTOR_OFFSET UNITYSDK_OFFSET(0x15FB19F0)
#define RPG_CLIENT_CHALLENGEPEAKNORMALFRIENDLINEUPRECOMMENDATION__GETFRIENDRECOMMENDLINEUPDETAILSCRSP_OFFSET UNITYSDK_OFFSET(0x15FB29F0)
#define RPG_CLIENT_CHALLENGEPEAKNORMALFRIENDLINEUPRECOMMENDATION__GETLINEUPINFO_OFFSET UNITYSDK_OFFSET(0x15FB2F30)
#define RPG_CLIENT_CHALLENGEPEAKNORMALFRIENDLINEUPRECOMMENDATION__GETRECOMMENDINFO_OFFSET UNITYSDK_OFFSET(0x15FB1DE0)
#define RPG_CLIENT_CHALLENGEPEAKNORMALFRIENDLINEUPRECOMMENDATION__GETTEAMINFO_OFFSET UNITYSDK_OFFSET(0x15FB1F90)
#define RPG_CLIENT_CHALLENGEPEAKNORMALFRIENDLINEUPRECOMMENDATION__ONGETFRIENDRECOMMENDLINEUPSCRSP_OFFSET UNITYSDK_OFFSET(0x15FB2780)
...
namespace RPG::Client
{
	...
	public:
		...
		::Class_1_496DDD2F6FDC28F1* _GetRecommendInfo(::System::Int32 index)
		{
			return ((::Class_1_496DDD2F6FDC28F1*(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + RPG_CLIENT_CHALLENGEPEAKNORMALFRIENDLINEUPRECOMMENDATION__GETRECOMMENDINFO_OFFSET))(this, index);
		}
