...
#define RPG_CLIENT_GRIDFIGHTPENDINGSTAGEROUNDBEGINACTION_HANDLE_OFFSET UNITYSDK_OFFSET(0x93CBBC0)
#define RPG_CLIENT_GRIDFIGHTPENDINGSTAGEROUNDBEGINACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x93CBBB0)
#define RPG_CLIENT_GRIDFIGHTPENDINGSTAGEROUNDBEGINACTION___IFIXBASEPROXY_HANDLE_OFFSET UNITYSDK_OFFSET(0x93CBCB0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightPendingStageRoundBeginAction_TypeDefinitionIndex = 51375;
