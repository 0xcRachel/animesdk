...
#define RPG_CLIENT_AIRSHIPEMITTER_AWAKE_OFFSET UNITYSDK_OFFSET(0x16E479B0)
#define RPG_CLIENT_AIRSHIPEMITTER_CHANNELNAME_OFFSET UNITYSDK_OFFSET(0x16E47E10)
#define RPG_CLIENT_AIRSHIPEMITTER_CREATEMANAGER_OFFSET UNITYSDK_OFFSET(0x16E464C0)
#define RPG_CLIENT_AIRSHIPEMITTER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16E47240)
#define RPG_CLIENT_AIRSHIPEMITTER_GET_CURRENTEMITINTERVAL_OFFSET UNITYSDK_OFFSET(0x16E47DD0)
#define RPG_CLIENT_AIRSHIPEMITTER_GET_CURRENTMAXALIVECOUNT_OFFSET UNITYSDK_OFFSET(0x16E47DB0)
#define RPG_CLIENT_AIRSHIPEMITTER_GET_OWNERFMSYSTEM_OFFSET UNITYSDK_OFFSET(0x16E47DF0)
#define RPG_CLIENT_AIRSHIPEMITTER_GET_WAITEMITTIMER_OFFSET UNITYSDK_OFFSET(0x16E46550)
#define RPG_CLIENT_AIRSHIPEMITTER_ISREADYTOEMIT_OFFSET UNITYSDK_OFFSET(0x16E465A0)
#define RPG_CLIENT_AIRSHIPEMITTER_METHOD_5_1FFBCA2671193585_OFFSET UNITYSDK_OFFSET(0x16E469C0)
#define RPG_CLIENT_AIRSHIPEMITTER_METHOD_5_2F0F99A12DB93F30_OFFSET UNITYSDK_OFFSET(0x16E47B80)
#define RPG_CLIENT_AIRSHIPEMITTER_METHOD_5_3B258437A86233AC_OFFSET UNITYSDK_OFFSET(0x16E47CA0)
#define RPG_CLIENT_AIRSHIPEMITTER_METHOD_5_4E7FADC1B404C65B_OFFSET UNITYSDK_OFFSET(0x16E46970)
#define RPG_CLIENT_AIRSHIPEMITTER_METHOD_5_A3979D70DA6179B4_OFFSET UNITYSDK_OFFSET(0x16E477B0)
#define RPG_CLIENT_AIRSHIPEMITTER_METHOD_5_DDE597491913B761_OFFSET UNITYSDK_OFFSET(0x16E471A0)
#define RPG_CLIENT_AIRSHIPEMITTER_METHOD_5_E67FA6A042436B76_OFFSET UNITYSDK_OFFSET(0x16E47290)
#define RPG_CLIENT_AIRSHIPEMITTER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x16E47C10)
#define RPG_CLIENT_AIRSHIPEMITTER_ONSAMPLE_OFFSET UNITYSDK_OFFSET(0x16E47E90)
#define RPG_CLIENT_AIRSHIPEMITTER_READYTOEMIT_OFFSET UNITYSDK_OFFSET(0x16E46610)
#define RPG_CLIENT_AIRSHIPEMITTER_RESETTIMER_OFFSET UNITYSDK_OFFSET(0x16E468C0)
#define RPG_CLIENT_AIRSHIPEMITTER_RESET_OFFSET UNITYSDK_OFFSET(0x16E47D00)
#define RPG_CLIENT_AIRSHIPEMITTER_SAMPLEDELAY_OFFSET UNITYSDK_OFFSET(0x16E47E50)
#define RPG_CLIENT_AIRSHIPEMITTER_SET_CURRENTEMITINTERVAL_OFFSET UNITYSDK_OFFSET(0x16E47DE0)
#define RPG_CLIENT_AIRSHIPEMITTER_SET_CURRENTMAXALIVECOUNT_OFFSET UNITYSDK_OFFSET(0x16E47DC0)
#define RPG_CLIENT_AIRSHIPEMITTER_SET_OWNERFMSYSTEM_OFFSET UNITYSDK_OFFSET(0x16E47E00)
#define RPG_CLIENT_AIRSHIPEMITTER_SHOULDEMITBYSIGNAL_OFFSET UNITYSDK_OFFSET(0x16E47730)
#define RPG_CLIENT_AIRSHIPEMITTER_TICK_OFFSET UNITYSDK_OFFSET(0x16E476A0)
#define RPG_CLIENT_AIRSHIPEMITTER_TRYDESTROY_OFFSET UNITYSDK_OFFSET(0x16E46FC0)
#define RPG_CLIENT_AIRSHIPEMITTER_TRYEMIT_OFFSET UNITYSDK_OFFSET(0x16E46660)
#define RPG_CLIENT_AIRSHIPEMITTER_UPDATELEVELINFO_OFFSET UNITYSDK_OFFSET(0x16E47A90)
#define RPG_CLIENT_AIRSHIPEMITTER__CTOR_OFFSET UNITYSDK_OFFSET(0x16E47F30)
