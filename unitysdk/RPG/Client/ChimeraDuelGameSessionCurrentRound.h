...
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCURRENTROUND_CREATEFAKE_OFFSET UNITYSDK_OFFSET(0x177B7440)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCURRENTROUND_CREATE_OFFSET UNITYSDK_OFFSET(0x177B7180)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCURRENTROUND_DISPOSE_OFFSET UNITYSDK_OFFSET(0x177B7720)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCURRENTROUND_GET_ROUNDDATA_OFFSET UNITYSDK_OFFSET(0x177BC6B0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCURRENTROUND_GET_ROUNDID_OFFSET UNITYSDK_OFFSET(0x177BC670)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCURRENTROUND_GET_ROUNDINDEX_OFFSET UNITYSDK_OFFSET(0x177BC690)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCURRENTROUND_SET_ROUNDID_OFFSET UNITYSDK_OFFSET(0x177BC680)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCURRENTROUND_SET_ROUNDINDEX_OFFSET UNITYSDK_OFFSET(0x177BC6A0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCURRENTROUND_UPDATE_OFFSET UNITYSDK_OFFSET(0x177B7D50)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCURRENTROUND__CTOR_OFFSET UNITYSDK_OFFSET(0x177BC7C0)
