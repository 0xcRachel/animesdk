...
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCURRENTROUND_CREATEFAKE_OFFSET UNITYSDK_OFFSET(0x93A7220)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCURRENTROUND_CREATE_OFFSET UNITYSDK_OFFSET(0x93A6F60)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCURRENTROUND_DISPOSE_OFFSET UNITYSDK_OFFSET(0x93A7500)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCURRENTROUND_GET_ROUNDDATA_OFFSET UNITYSDK_OFFSET(0x93ACB00)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCURRENTROUND_GET_ROUNDID_OFFSET UNITYSDK_OFFSET(0x93ACAC0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCURRENTROUND_GET_ROUNDINDEX_OFFSET UNITYSDK_OFFSET(0x93ACAE0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCURRENTROUND_SET_ROUNDID_OFFSET UNITYSDK_OFFSET(0x93ACAD0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCURRENTROUND_SET_ROUNDINDEX_OFFSET UNITYSDK_OFFSET(0x93ACAF0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCURRENTROUND_UPDATE_OFFSET UNITYSDK_OFFSET(0x93A7B30)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCURRENTROUND__CTOR_OFFSET UNITYSDK_OFFSET(0x93ACC10)
