...
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCURRENTROUND_CREATEFAKE_OFFSET UNITYSDK_OFFSET(0x8F04E70)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCURRENTROUND_CREATE_OFFSET UNITYSDK_OFFSET(0x8F04230)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCURRENTROUND_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8F05990)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCURRENTROUND_GET_ROUNDDATA_OFFSET UNITYSDK_OFFSET(0x8F0B8F0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCURRENTROUND_GET_ROUNDID_OFFSET UNITYSDK_OFFSET(0x8F0B8B0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCURRENTROUND_GET_ROUNDINDEX_OFFSET UNITYSDK_OFFSET(0x8F0B8D0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCURRENTROUND_SET_ROUNDID_OFFSET UNITYSDK_OFFSET(0x8F0B8C0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCURRENTROUND_SET_ROUNDINDEX_OFFSET UNITYSDK_OFFSET(0x8F0B8E0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCURRENTROUND_UPDATE_OFFSET UNITYSDK_OFFSET(0x8F05FC0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCURRENTROUND__CTOR_OFFSET UNITYSDK_OFFSET(0x8F0BA00)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraDuelGameSessionCurrentRound_TypeDefinitionIndex = 50253;
