...
#define RPG_CLIENT_BATTLEULTRASKILLCUTINDATA_CREATEFROMAVATARID_OFFSET UNITYSDK_OFFSET(0x1472EAD0)
#define RPG_CLIENT_BATTLEULTRASKILLCUTINDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1472EA40)
#define RPG_CLIENT_BATTLEULTRASKILLCUTINDATA_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0x1472EBE0)
#define RPG_CLIENT_BATTLEULTRASKILLCUTINDATA_GET_PREFABPATH_OFFSET UNITYSDK_OFFSET(0x1472EBC0)
#define RPG_CLIENT_BATTLEULTRASKILLCUTINDATA_GET_SKILLNAME_OFFSET UNITYSDK_OFFSET(0x1472EC00)
#define RPG_CLIENT_BATTLEULTRASKILLCUTINDATA_SET_AVATARID_OFFSET UNITYSDK_OFFSET(0x1472EBF0)
#define RPG_CLIENT_BATTLEULTRASKILLCUTINDATA_SET_PREFABPATH_OFFSET UNITYSDK_OFFSET(0x1472EBD0)
#define RPG_CLIENT_BATTLEULTRASKILLCUTINDATA_SET_SKILLNAME_OFFSET UNITYSDK_OFFSET(0x1472EC10)
#define RPG_CLIENT_BATTLEULTRASKILLCUTINDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1472EAC0)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleUltraSkillCutInData_TypeDefinitionIndex = 66298;
