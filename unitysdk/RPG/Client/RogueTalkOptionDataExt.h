...
#define RPG_CLIENT_ROGUETALKOPTIONDATAEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x17DD54B0)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Int32 EffectNousValueChangeDelta; // 0x2C
		::System::Single DescRatioParam; // 0x30
		::System::Int32 DescParam2; // 0x34
		::System::UInt32 RogueOptionID; // 0x38
		::System::Int32 DescIntParam; // 0x3C
		::System::Int32 DescParam3; // 0x40
		::System::Int32 DescCostParam; // 0x44
		::System::Boolean HasEffectNousValueChange; // 0x48
		::System::UInt32 DisplayID; // 0x4C
		::System::Int32 DescParam4; // 0x50
