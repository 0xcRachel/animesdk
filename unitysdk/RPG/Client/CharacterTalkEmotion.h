...
#define RPG_CLIENT_CHARACTERTALKEMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x8EB6740)

namespace RPG::Client
{
	inline static constexpr unsigned int CharacterTalkEmotion_TypeDefinitionIndex = 56677;
