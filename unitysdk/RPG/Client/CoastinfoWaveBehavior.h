...
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0x940D750)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR_METHOD_3_0591D209F721C9B9_OFFSET UNITYSDK_OFFSET(0x940D860)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR_METHOD_3_0C88AB06D46E777A_OFFSET UNITYSDK_OFFSET(0x940DA40)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR_METHOD_3_19844080C13BA28F_OFFSET UNITYSDK_OFFSET(0x940D330)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR_METHOD_3_1DA5C35D6019ACFB_OFFSET UNITYSDK_OFFSET(0x940B4E0)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR_METHOD_3_25DD7463C131509A_OFFSET UNITYSDK_OFFSET(0x940CBA0)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR_METHOD_3_292851C8CABF98E9_OFFSET UNITYSDK_OFFSET(0x940B5C0)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR_METHOD_3_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x940DD50)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR_METHOD_3_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x940ED00)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x940EB70)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0x940EBE0)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR_METHOD_3_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0x940EC40)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR_METHOD_3_4343F372F34C05BF_4_OFFSET UNITYSDK_OFFSET(0x940ECA0)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR_METHOD_3_4343F372F34C05BF_5_OFFSET UNITYSDK_OFFSET(0x940ED40)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x940EB10)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR_METHOD_3_459C79521BFE514E_OFFSET UNITYSDK_OFFSET(0x940EE00)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR_METHOD_3_50777E1B00315547_OFFSET UNITYSDK_OFFSET(0x940DEA0)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR_METHOD_3_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0x940F110)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR_METHOD_3_5790A55946AA509D_2_OFFSET UNITYSDK_OFFSET(0x940F170)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR_METHOD_3_5790A55946AA509D_3_OFFSET UNITYSDK_OFFSET(0x940F1D0)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR_METHOD_3_5790A55946AA509D_4_OFFSET UNITYSDK_OFFSET(0x940F230)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR_METHOD_3_5790A55946AA509D_5_OFFSET UNITYSDK_OFFSET(0x940F2A0)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR_METHOD_3_5790A55946AA509D_6_OFFSET UNITYSDK_OFFSET(0x940F380)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR_METHOD_3_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x940F0B0)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR_METHOD_3_60E1F7F58CCF739F_OFFSET UNITYSDK_OFFSET(0x940BE80)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR_METHOD_3_7807D95AEFFB3EED_OFFSET UNITYSDK_OFFSET(0x940E590)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR_METHOD_3_7DA3FDF704693A06_OFFSET UNITYSDK_OFFSET(0x940C050)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR_METHOD_3_8CA9B687AA7C466A_OFFSET UNITYSDK_OFFSET(0x940AD50)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x940EA80)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR_METHOD_3_BE5A0083341D8F96_OFFSET UNITYSDK_OFFSET(0x940E880)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR_METHOD_3_E55199F4E71DB1AE_OFFSET UNITYSDK_OFFSET(0x940BE00)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR_METHOD_3_ED34DCC6F6541B09_OFFSET UNITYSDK_OFFSET(0x940D7C0)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR_METHOD_3_F0E307B84478A272_OFFSET UNITYSDK_OFFSET(0x940F310)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0x940EDA0)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x940EFA0)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR__COMPUTENEARFARFROMBOUNDS_G__EXTENTALONGDIR_2_0_OFFSET UNITYSDK_OFFSET(0x940F070)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x940EF70)
#define RPG_CLIENT_COASTINFOWAVEBEHAVIOR___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x940F3E0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CoastinfoWaveBehavior_TypeDefinitionIndex)->GetStaticField(0x128B0);
		}
		static ::System::Int32* StaticGet_ID_TM_WrapMode()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CoastinfoWaveBehavior_TypeDefinitionIndex)->GetStaticField(0x128B4);
		}
		static ::System::Int32* StaticGet_ID_RefAxisN_WS()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CoastinfoWaveBehavior_TypeDefinitionIndex)->GetStaticField(0x128B8);
		}
		static ::System::Int32* StaticGet_ID_RefUV00_10()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CoastinfoWaveBehavior_TypeDefinitionIndex)->GetStaticField(0x128BC);
		}
		static ::System::Int32* StaticGet_ID_RefAxisT_WS()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CoastinfoWaveBehavior_TypeDefinitionIndex)->GetStaticField(0x128C0);
		}
		static ::System::Int32* StaticGet_ID_RefUV01_11()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CoastinfoWaveBehavior_TypeDefinitionIndex)->GetStaticField(0x128C4);
		}
		static ::System::Int32* StaticGet_ID_RefOriginWS()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CoastinfoWaveBehavior_TypeDefinitionIndex)->GetStaticField(0x128C8);
		}
		static ::System::Int32* StaticGet_ID_TM_Switch()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CoastinfoWaveBehavior_TypeDefinitionIndex)->GetStaticField(0x128CC);
		}
