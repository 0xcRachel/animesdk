...
#define RPG_CLIENT_CYCLESCORESERVICE_CHECKRANKREWARDCANBEDESTROY_OFFSET UNITYSDK_OFFSET(0x141DE5D0)
#define RPG_CLIENT_CYCLESCORESERVICE_DESTROYREWARD_OFFSET UNITYSDK_OFFSET(0x141DE9C0)
#define RPG_CLIENT_CYCLESCORESERVICE_GETALLREWARD_OFFSET UNITYSDK_OFFSET(0x141DE7F0)
#define RPG_CLIENT_CYCLESCORESERVICE_GETREWARDBYSCORERANK_OFFSET UNITYSDK_OFFSET(0x141DE8B0)
#define RPG_CLIENT_CYCLESCORESERVICE_GET__CANDESTROYREWARDITEMID_OFFSET UNITYSDK_OFFSET(0x141DEA80)
#define RPG_CLIENT_CYCLESCORESERVICE_ISCYCLESCORESEEN_OFFSET UNITYSDK_OFFSET(0x141DEC40)
#define RPG_CLIENT_CYCLESCORESERVICE_ISSHOWNEWREDDOT_OFFSET UNITYSDK_OFFSET(0x141DEBF0)
#define RPG_CLIENT_CYCLESCORESERVICE_MARKCYCLESCORESEEN_OFFSET UNITYSDK_OFFSET(0x141DED70)
#define RPG_CLIENT_CYCLESCORESERVICE_MARKGRIDFIGHTCYCLESCORESEEN_OFFSET UNITYSDK_OFFSET(0x141DF230)
#define RPG_CLIENT_CYCLESCORESERVICE_MARKROGUECYCLESCORESEEN_OFFSET UNITYSDK_OFFSET(0x141DEFF0)
#define RPG_CLIENT_CYCLESCORESERVICE_SHOULDSHOWGRIDFIGHTCYCLESCORE_OFFSET UNITYSDK_OFFSET(0x141DF0C0)
#define RPG_CLIENT_CYCLESCORESERVICE_SHOULDSHOWROGUECYCLESCORE_OFFSET UNITYSDK_OFFSET(0x141DEEF0)
#define RPG_CLIENT_CYCLESCORESERVICE_START_OFFSET UNITYSDK_OFFSET(0x141DE680)
#define RPG_CLIENT_CYCLESCORESERVICE_STOP_OFFSET UNITYSDK_OFFSET(0x141DE7A0)
#define RPG_CLIENT_CYCLESCORESERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x141DF7A0)
#define RPG_CLIENT_CYCLESCORESERVICE__ONCYCLESCOREREWARDDESTROYEXCEEDREWARDSCRSP_OFFSET UNITYSDK_OFFSET(0x141DF5A0)
#define RPG_CLIENT_CYCLESCORESERVICE__ONCYCLESCOREREWARDRSP_OFFSET UNITYSDK_OFFSET(0x141DF390)
#define RPG_CLIENT_CYCLESCORESERVICE__ONCYCLESCOREREWARDTAKEREWARDSCRSP_OFFSET UNITYSDK_OFFSET(0x141DF460)
#define RPG_CLIENT_CYCLESCORESERVICE__ONCYCLESCOREREWARDUPDATEINFOSCNOTIFY_OFFSET UNITYSDK_OFFSET(0x141DF6B0)
