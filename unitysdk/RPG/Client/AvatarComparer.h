...
#define RPG_CLIENT_AVATARCOMPARER__ACCEPTIMPL_OFFSET UNITYSDK_OFFSET(0x15997490)
#define RPG_CLIENT_AVATARCOMPARER__COMPAREIMPL_OFFSET UNITYSDK_OFFSET(0x15997840)
#define RPG_CLIENT_AVATARCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x15997430)
#define RPG_CLIENT_AVATARCOMPARER___IFIXBASEPROXY__ACCEPTIMPL_OFFSET UNITYSDK_OFFSET(0x15997AD0)
