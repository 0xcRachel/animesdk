...
#define RPG_CLIENT_COMPONENTASSETLOADER__COLLECTALLREFASSETPATH_D__15_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x8FC3A80)
#define RPG_CLIENT_COMPONENTASSETLOADER__COLLECTALLREFASSETPATH_D__15_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_STRING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x8FC3C00)
#define RPG_CLIENT_COMPONENTASSETLOADER__COLLECTALLREFASSETPATH_D__15_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x8FC3C60)
#define RPG_CLIENT_COMPONENTASSETLOADER__COLLECTALLREFASSETPATH_D__15_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x8FC3C10)
#define RPG_CLIENT_COMPONENTASSETLOADER__COLLECTALLREFASSETPATH_D__15_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8FC3A70)
#define RPG_CLIENT_COMPONENTASSETLOADER__COLLECTALLREFASSETPATH_D__15__CTOR_OFFSET UNITYSDK_OFFSET(0x8FC37F0)

namespace RPG::Client
{
	inline static constexpr unsigned int ComponentAssetLoader__CollectAllRefAssetPath_d__15_TypeDefinitionIndex = 54277;
