...
#define RPG_CLIENT_GRIDFIGHTORBMANAGER___C__DISPLAYCLASS35_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1977AE60)
#define RPG_CLIENT_GRIDFIGHTORBMANAGER___C__DISPLAYCLASS35_0__REMOVESPHERE_B__0_OFFSET UNITYSDK_OFFSET(0x1977BB40)
#define RPG_CLIENT_GRIDFIGHTORBMANAGER___C__DISPLAYCLASS35_0__REMOVESPHERE_B__1_OFFSET UNITYSDK_OFFSET(0x1977BBF0)
