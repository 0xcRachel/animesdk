...
#define RPG_CLIENT_UIMAP3DCONTAINERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA1DA660)

namespace RPG::Client
{
	inline static constexpr unsigned int UIMap3DContainerConfig_TypeDefinitionIndex = 54850;
