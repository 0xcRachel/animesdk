...
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTANIMSPEED_METHOD_2_8A4821B6962F6B25_OFFSET UNITYSDK_OFFSET(0x990CA00)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTANIMSPEED_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x990CC60)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTANIMSPEED_METHOD_2_9F9ED25754A7CAB9_OFFSET UNITYSDK_OFFSET(0x990CE90)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTANIMSPEED_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x990CF30)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTANIMSPEED_METHOD_2_E530905EC9C5B4AD_OFFSET UNITYSDK_OFFSET(0x990C9B0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTANIMSPEED_METHOD_2_EF9FF539AE18C3F9_OFFSET UNITYSDK_OFFSET(0x990CCC0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTANIMSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x990CDD0)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicVisualization_BeatEffectElementAnimSpeed_TypeDefinitionIndex = 56438;
