...
#define RPG_CLIENT_MAPMISSIONDATA_GET_AREADATA_OFFSET UNITYSDK_OFFSET(0x9B0DBF0)
#define RPG_CLIENT_MAPMISSIONDATA_GET_AREAID_OFFSET UNITYSDK_OFFSET(0x9B0DB20)
#define RPG_CLIENT_MAPMISSIONDATA_GET_CONTENTID_OFFSET UNITYSDK_OFFSET(0x9B0DBB0)
#define RPG_CLIENT_MAPMISSIONDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0x9B0D670)
#define RPG_CLIENT_MAPMISSIONDATA_GET_DIMENSIONID_OFFSET UNITYSDK_OFFSET(0x9B0DB80)
#define RPG_CLIENT_MAPMISSIONDATA_GET_ENTRANCEID_OFFSET UNITYSDK_OFFSET(0x9B0D440)
#define RPG_CLIENT_MAPMISSIONDATA_GET_FLOORID_OFFSET UNITYSDK_OFFSET(0x9B0DBD0)
#define RPG_CLIENT_MAPMISSIONDATA_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x9B0DAF0)
#define RPG_CLIENT_MAPMISSIONDATA_GET_IDENTIFICATIONID_OFFSET UNITYSDK_OFFSET(0x9B0D450)
#define RPG_CLIENT_MAPMISSIONDATA_GET_INSTANCEID_OFFSET UNITYSDK_OFFSET(0x9B0DB00)
#define RPG_CLIENT_MAPMISSIONDATA_GET_ISCONNECTID_OFFSET UNITYSDK_OFFSET(0x9B0DBC0)
#define RPG_CLIENT_MAPMISSIONDATA_GET_ISTRACKING_OFFSET UNITYSDK_OFFSET(0x9B0DA90)
#define RPG_CLIENT_MAPMISSIONDATA_GET_MAPAREATYPE_OFFSET UNITYSDK_OFFSET(0x9B0DB40)
#define RPG_CLIENT_MAPMISSIONDATA_GET_MAPICONCOLOR_OFFSET UNITYSDK_OFFSET(0x9B0D480)
#define RPG_CLIENT_MAPMISSIONDATA_GET_MAPICONTYPE_OFFSET UNITYSDK_OFFSET(0x9B0D960)
#define RPG_CLIENT_MAPMISSIONDATA_GET_MAPLAYER_OFFSET UNITYSDK_OFFSET(0x9B0D460)
#define RPG_CLIENT_MAPMISSIONDATA_GET_MAPPINGINFOID_OFFSET UNITYSDK_OFFSET(0x9B0DB10)
#define RPG_CLIENT_MAPMISSIONDATA_GET_MAPPINGINFOROW_OFFSET UNITYSDK_OFFSET(0x9B0D470)
#define RPG_CLIENT_MAPMISSIONDATA_GET_MAPPOSITION_OFFSET UNITYSDK_OFFSET(0x9B0DA20)
#define RPG_CLIENT_MAPMISSIONDATA_GET_MAPRAWPOSITION_OFFSET UNITYSDK_OFFSET(0x9B0DA40)
#define RPG_CLIENT_MAPMISSIONDATA_GET_MAPROTATION_OFFSET UNITYSDK_OFFSET(0x9B0DA60)
#define RPG_CLIENT_MAPMISSIONDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x9B0D490)
#define RPG_CLIENT_MAPMISSIONDATA_GET_NEARESTTELEPORTMAPPINGINFOID_OFFSET UNITYSDK_OFFSET(0x9B0DB90)
#define RPG_CLIENT_MAPMISSIONDATA_GET_POSITIONINAREAMAP_OFFSET UNITYSDK_OFFSET(0x9B0DB50)
#define RPG_CLIENT_MAPMISSIONDATA_GET_REGIONID_OFFSET UNITYSDK_OFFSET(0x9B0DB30)
#define RPG_CLIENT_MAPMISSIONDATA_GET_SECTIONID_OFFSET UNITYSDK_OFFSET(0x9B0DB70)
#define RPG_CLIENT_MAPMISSIONDATA_GET_STORYLINEID_OFFSET UNITYSDK_OFFSET(0x9B0DBA0)
#define RPG_CLIENT_MAPMISSIONDATA_GET_SUBMAPID_OFFSET UNITYSDK_OFFSET(0x9B0DB60)
#define RPG_CLIENT_MAPMISSIONDATA_GET_SUBMISSIONDATA_OFFSET UNITYSDK_OFFSET(0x9B0DA80)
#define RPG_CLIENT_MAPMISSIONDATA_INITMAPMISSIONDATA_OFFSET UNITYSDK_OFFSET(0x9B0CFC0)
#define RPG_CLIENT_MAPMISSIONDATA_SET_FLOORID_OFFSET UNITYSDK_OFFSET(0x9B0DBE0)
#define RPG_CLIENT_MAPMISSIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9B0CEC0)
#define RPG_CLIENT_MAPMISSIONDATA__UPDATEMAPICONAREADATA_OFFSET UNITYSDK_OFFSET(0x9B0D2B0)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 _MappingInfoID; // 0x2C
		::System::Int32 _SectionID; // 0x30
		::System::UInt32 _SubMapID; // 0x34
		::UnityEngine::Vector3 _MapRotation; // 0x38
		::System::UInt32 _StoryLineID; // 0x44
		::System::UInt32 _NearestTeleportMappingInfoID; // 0x48
		::System::UInt32 _DimensionID; // 0x4C
		::UnityEngine::Color _MapIconColor; // 0x50
		::System::Int32 _MapLayer; // 0x60
		::UnityEngine::Vector3 _MapPosition; // 0x64
		::System::UInt32 _RegionID; // 0x70
		::System::UInt32 _InstanceId; // 0x74
		::System::UInt32 _FloorID_k__BackingField; // 0x78
		::UnityEngine::Vector2 _PositionInAreaMap; // 0x7C
		::System::UInt32 _EntranceID; // 0x84
		::System::Boolean _IsConnect; // 0x88
		::System::UInt32 _MapIconType; // 0x8C
		::RPG::GameCore::MinimapAreaType _MapAreaType; // 0x90
		::System::UInt32 _ContentID; // 0x94
