...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEEXPRESSION_INIT_OFFSET UNITYSDK_OFFSET(0x165EAA50)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEEXPRESSION_UNINIT_OFFSET UNITYSDK_OFFSET(0x165EB250)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEEXPRESSION_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x165EAAF0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x165EB2F0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEEXPRESSION___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x165EB330)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEEXPRESSION___IFIXBASEPROXY_UNINIT_OFFSET UNITYSDK_OFFSET(0x165EB340)
