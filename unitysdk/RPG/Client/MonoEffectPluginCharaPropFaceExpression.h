...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEEXPRESSION_INIT_OFFSET UNITYSDK_OFFSET(0x97E0710)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEEXPRESSION_UNINIT_OFFSET UNITYSDK_OFFSET(0x97E0F10)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEEXPRESSION_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x97E07B0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x97E0FB0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEEXPRESSION___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x97E0FF0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEEXPRESSION___IFIXBASEPROXY_UNINIT_OFFSET UNITYSDK_OFFSET(0x97E1000)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropFaceExpression_TypeDefinitionIndex = 55671;
