...
#define RPG_CLIENT_AVATARMODULE___C__DISPLAYCLASS27_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15E2FDA0)
#define RPG_CLIENT_AVATARMODULE___C__DISPLAYCLASS27_0___SYNCFORMALMULTIPATHAVATARS_B__0_OFFSET UNITYSDK_OFFSET(0x15E38C40)
#define RPG_CLIENT_AVATARMODULE___C__DISPLAYCLASS27_0___SYNCFORMALMULTIPATHAVATARS_B__1_OFFSET UNITYSDK_OFFSET(0x15E38C60)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Boolean __SyncFormalMultiPathAvatars_b__1(::Class_1_F3CA30716D4FAF92_3* data)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_F3CA30716D4FAF92_3*))((::PBYTE)hIl2Cpp + RPG_CLIENT_AVATARMODULE___C__DISPLAYCLASS27_0___SYNCFORMALMULTIPATHAVATARS_B__1_OFFSET))(this, data);
		}
	};
}
