...
#define RPG_CLIENT_AVATARUI3DDISABLEIDLESHOWREASONBOOL_ISNEEDDISABLE_OFFSET UNITYSDK_OFFSET(0x8D5F430)
#define RPG_CLIENT_AVATARUI3DDISABLEIDLESHOWREASONBOOL_SETDISABLE_OFFSET UNITYSDK_OFFSET(0x8D5F480)
#define RPG_CLIENT_AVATARUI3DDISABLEIDLESHOWREASONBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x8D5F420)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarUI3DDisableIdleShowReasonBool_TypeDefinitionIndex = 49648;
