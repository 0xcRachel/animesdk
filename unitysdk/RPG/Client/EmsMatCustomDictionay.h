...
#define RPG_CLIENT_EMSMATCUSTOMDICTIONAY_FINALIZE_OFFSET UNITYSDK_OFFSET(0x15AE1E20)
#define RPG_CLIENT_EMSMATCUSTOMDICTIONAY_METHOD_1_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x15AE1D80)
#define RPG_CLIENT_EMSMATCUSTOMDICTIONAY_METHOD_1_4DB5506DCD053FB2_OFFSET UNITYSDK_OFFSET(0x15AE1CA0)
#define RPG_CLIENT_EMSMATCUSTOMDICTIONAY_METHOD_1_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x15AE1D30)
#define RPG_CLIENT_EMSMATCUSTOMDICTIONAY__CTOR_OFFSET UNITYSDK_OFFSET(0x15AE1C40)
