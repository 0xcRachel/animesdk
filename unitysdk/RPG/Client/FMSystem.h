...
#define RPG_CLIENT_FMSYSTEM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9666500)
#define RPG_CLIENT_FMSYSTEM_GET_ISPAUSE_OFFSET UNITYSDK_OFFSET(0x9666F90)
#define RPG_CLIENT_FMSYSTEM_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x9665DF0)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_2439B52C953E2E46_OFFSET UNITYSDK_OFFSET(0x96651B0)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_261814E9E5018383_1_OFFSET UNITYSDK_OFFSET(0x9664DA0)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_261814E9E5018383_OFFSET UNITYSDK_OFFSET(0x9664990)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_2767989B1782DE75_OFFSET UNITYSDK_OFFSET(0x9666D80)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_422BC3370982FBE0_OFFSET UNITYSDK_OFFSET(0x96669B0)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_44932B303F1165E9_OFFSET UNITYSDK_OFFSET(0x9665510)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_7EDBC63FC2BC53F4_1_OFFSET UNITYSDK_OFFSET(0x9664F80)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_7EDBC63FC2BC53F4_OFFSET UNITYSDK_OFFSET(0x9664B70)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_838396E16A1F8A0F_1_OFFSET UNITYSDK_OFFSET(0x9662DB0)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_838396E16A1F8A0F_OFFSET UNITYSDK_OFFSET(0x9663960)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_87D695987E98317C_1_OFFSET UNITYSDK_OFFSET(0x9663E10)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_87D695987E98317C_2_OFFSET UNITYSDK_OFFSET(0x96659C0)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_87D695987E98317C_OFFSET UNITYSDK_OFFSET(0x96656A0)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_88E99A17C817F5C9_OFFSET UNITYSDK_OFFSET(0x9665E90)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_ADE9B05D0E6295A7_1_OFFSET UNITYSDK_OFFSET(0x96650C0)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_ADE9B05D0E6295A7_OFFSET UNITYSDK_OFFSET(0x9664CB0)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_BD22CF6620FEF6E4_OFFSET UNITYSDK_OFFSET(0x9666770)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_BEF2D00B46C3636D_OFFSET UNITYSDK_OFFSET(0x9663A30)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x9665E10)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x9665E50)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x9665DB0)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_FCAE7D0A63C8DDC3_OFFSET UNITYSDK_OFFSET(0x9662F40)
#define RPG_CLIENT_FMSYSTEM_SET_ISPAUSE_OFFSET UNITYSDK_OFFSET(0x9666FA0)
#define RPG_CLIENT_FMSYSTEM_SET_ISVALID_OFFSET UNITYSDK_OFFSET(0x9665E00)
#define RPG_CLIENT_FMSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9666FB0)
