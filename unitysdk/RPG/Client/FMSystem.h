...
#define RPG_CLIENT_FMSYSTEM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18259400)
#define RPG_CLIENT_FMSYSTEM_GET_ISPAUSE_OFFSET UNITYSDK_OFFSET(0x18259E60)
#define RPG_CLIENT_FMSYSTEM_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x18258D60)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_1F130271093617A5_OFFSET UNITYSDK_OFFSET(0x182580B0)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_27C2887D49F6F6B3_OFFSET UNITYSDK_OFFSET(0x18258970)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_30BE3523CF9B739E_1_OFFSET UNITYSDK_OFFSET(0x18258000)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_30BE3523CF9B739E_OFFSET UNITYSDK_OFFSET(0x18257CC0)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_400F35719779E796_OFFSET UNITYSDK_OFFSET(0x18259C10)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_518C6F1B8C5A6FFD_1_OFFSET UNITYSDK_OFFSET(0x18257F10)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_518C6F1B8C5A6FFD_OFFSET UNITYSDK_OFFSET(0x18257BD0)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_5466C2B94F8B36FC_OFFSET UNITYSDK_OFFSET(0x18259830)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_838396E16A1F8A0F_1_OFFSET UNITYSDK_OFFSET(0x18255EA0)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_838396E16A1F8A0F_OFFSET UNITYSDK_OFFSET(0x18256A80)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_87D695987E98317C_1_OFFSET UNITYSDK_OFFSET(0x18256F00)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_87D695987E98317C_OFFSET UNITYSDK_OFFSET(0x18258580)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_89F155ADF08BB250_OFFSET UNITYSDK_OFFSET(0x182583E0)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_A4E70CB481BCC07A_OFFSET UNITYSDK_OFFSET(0x18256030)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_B815CC8D577760D2_OFFSET UNITYSDK_OFFSET(0x18258E00)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_BD22CF6620FEF6E4_OFFSET UNITYSDK_OFFSET(0x18256B60)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x18258D80)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x18258DC0)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x18258D20)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_D3B8CF0C6A611E3A_1_OFFSET UNITYSDK_OFFSET(0x18257D70)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_D3B8CF0C6A611E3A_OFFSET UNITYSDK_OFFSET(0x18257A30)
#define RPG_CLIENT_FMSYSTEM_METHOD_1_E1C787AF75EB04DB_OFFSET UNITYSDK_OFFSET(0x18259630)
#define RPG_CLIENT_FMSYSTEM_SET_ISPAUSE_OFFSET UNITYSDK_OFFSET(0x18259E70)
#define RPG_CLIENT_FMSYSTEM_SET_ISVALID_OFFSET UNITYSDK_OFFSET(0x18258D70)
#define RPG_CLIENT_FMSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x18259E80)
