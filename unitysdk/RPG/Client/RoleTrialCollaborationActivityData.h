...
#define RPG_CLIENT_ROLETRIALCOLLABORATIONACTIVITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9F34070)

namespace RPG::Client
{
	inline static constexpr unsigned int RoleTrialCollaborationActivityData_TypeDefinitionIndex = 48888;
