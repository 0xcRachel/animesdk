...
#define RPG_CLIENT_ACHIEVEMENTUTILS_DOESENTITYCONTAINSMODIFIER_OFFSET UNITYSDK_OFFSET(0x8ADBA30)

namespace RPG::Client
{
	inline static constexpr unsigned int AchievementUtils_TypeDefinitionIndex = 48673;
