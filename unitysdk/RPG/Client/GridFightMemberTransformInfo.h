...
#define RPG_CLIENT_GRIDFIGHTMEMBERTRANSFORMINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x93A5D10)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightMemberTransformInfo_TypeDefinitionIndex = 51522;
