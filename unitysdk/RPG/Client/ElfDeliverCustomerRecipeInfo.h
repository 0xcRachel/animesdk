...
#define RPG_CLIENT_ELFDELIVERCUSTOMERRECIPEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x90FBE00)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfDeliverCustomerRecipeInfo_TypeDefinitionIndex = 50653;
