...
#define RPG_CLIENT_TIMEREWINDPATHRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0xA09CA80)

namespace RPG::Client
{
	inline static constexpr unsigned int TimeRewindPathRuntime_TypeDefinitionIndex = 50677;
