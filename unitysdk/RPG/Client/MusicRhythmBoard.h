...
#define RPG_CLIENT_MUSICRHYTHMBOARD_ADDTUTORIALFAILTIMES_OFFSET UNITYSDK_OFFSET(0x15F1F0E0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15F1CDF0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x15F1E4E0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_GETENTITY_OFFSET UNITYSDK_OFFSET(0x15F1ECC0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_GETPOINT_OFFSET UNITYSDK_OFFSET(0x15F1E5A0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_GET_GROUPROW_OFFSET UNITYSDK_OFFSET(0x15F1F1F0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_GET_ISDISPOSED_OFFSET UNITYSDK_OFFSET(0x15F1F130)
#define RPG_CLIENT_MUSICRHYTHMBOARD_GET_LEVELID_OFFSET UNITYSDK_OFFSET(0x15F1F150)
#define RPG_CLIENT_MUSICRHYTHMBOARD_GET_LEVELROW_OFFSET UNITYSDK_OFFSET(0x15F1F170)
#define RPG_CLIENT_MUSICRHYTHMBOARD_GET_SKIPTUTORIAL_OFFSET UNITYSDK_OFFSET(0x15F1F290)
#define RPG_CLIENT_MUSICRHYTHMBOARD_GET_TUTORIALFAILTIMES_OFFSET UNITYSDK_OFFSET(0x15F1F270)
#define RPG_CLIENT_MUSICRHYTHMBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0x15F1B450)
#define RPG_CLIENT_MUSICRHYTHMBOARD_ISTIMELINEFINISH_OFFSET UNITYSDK_OFFSET(0x15F1D580)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_0565C92E9C2B314B_OFFSET UNITYSDK_OFFSET(0x15F1E3C0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_2566AD459572DFC3_OFFSET UNITYSDK_OFFSET(0x15F1BAF0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_6AF8CC03883E6064_OFFSET UNITYSDK_OFFSET(0x15F1DAB0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_802D2A6E195347E8_OFFSET UNITYSDK_OFFSET(0x15F1CBD0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x15F1BA00)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_96BDC4B57CCFE000_1_OFFSET UNITYSDK_OFFSET(0x15F1DA00)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_96BDC4B57CCFE000_2_OFFSET UNITYSDK_OFFSET(0x15F1DC10)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_96BDC4B57CCFE000_3_OFFSET UNITYSDK_OFFSET(0x15F1DD30)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_96BDC4B57CCFE000_4_OFFSET UNITYSDK_OFFSET(0x15F1DE30)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_96BDC4B57CCFE000_5_OFFSET UNITYSDK_OFFSET(0x15F1E030)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_96BDC4B57CCFE000_6_OFFSET UNITYSDK_OFFSET(0x15F1E230)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_96BDC4B57CCFE000_7_OFFSET UNITYSDK_OFFSET(0x15F1E310)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_96BDC4B57CCFE000_OFFSET UNITYSDK_OFFSET(0x15F1D770)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_9871B2ED609502A4_1_OFFSET UNITYSDK_OFFSET(0x15F1DEE0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_9871B2ED609502A4_OFFSET UNITYSDK_OFFSET(0x15F1D880)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_D2666B2B900DD38A_OFFSET UNITYSDK_OFFSET(0x15F1E6E0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_EE33E0531969166F_OFFSET UNITYSDK_OFFSET(0x15F1E0E0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_PLAYTIMELINE_OFFSET UNITYSDK_OFFSET(0x15F1C930)
#define RPG_CLIENT_MUSICRHYTHMBOARD_RESETANIMATORS_OFFSET UNITYSDK_OFFSET(0x15F1EDB0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_SETADJUSTMODE_OFFSET UNITYSDK_OFFSET(0x15F1CC70)
#define RPG_CLIENT_MUSICRHYTHMBOARD_SET_GROUPROW_OFFSET UNITYSDK_OFFSET(0x15F1F230)
#define RPG_CLIENT_MUSICRHYTHMBOARD_SET_ISDISPOSED_OFFSET UNITYSDK_OFFSET(0x15F1F140)
#define RPG_CLIENT_MUSICRHYTHMBOARD_SET_LEVELID_OFFSET UNITYSDK_OFFSET(0x15F1F160)
#define RPG_CLIENT_MUSICRHYTHMBOARD_SET_LEVELROW_OFFSET UNITYSDK_OFFSET(0x15F1F1B0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_SET_SKIPTUTORIAL_OFFSET UNITYSDK_OFFSET(0x15F1F2A0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_SET_TUTORIALFAILTIMES_OFFSET UNITYSDK_OFFSET(0x15F1F280)
#define RPG_CLIENT_MUSICRHYTHMBOARD_SHOWPLAYERHINT_OFFSET UNITYSDK_OFFSET(0x15F1D5E0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_STARTMUSICRHYTHM_OFFSET UNITYSDK_OFFSET(0x15F1C7D0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_UPDATE_OFFSET UNITYSDK_OFFSET(0x15F1E480)
#define RPG_CLIENT_MUSICRHYTHMBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x15F1F2B0)
#define RPG_CLIENT_MUSICRHYTHMBOARD___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15F1F3E0)
#define RPG_CLIENT_MUSICRHYTHMBOARD___IFIXBASEPROXY_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0x15F1F3D0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::RPG::GameCore::MusicRhythmLevelRow**)Il2CppClass::FromTypeDefinitionIndex(MusicRhythmBoard_TypeDefinitionIndex)->GetStaticField(0x4080);
		}
		static ::RPG::GameCore::MusicRhythmGameConfig** StaticGet_MusicRhythmConfig()
		{
			return (::RPG::GameCore::MusicRhythmGameConfig**)Il2CppClass::FromTypeDefinitionIndex(MusicRhythmBoard_TypeDefinitionIndex)->GetStaticField(0x4088);
		}
		static ::RPG::GameCore::MusicRhythmGroupRow** StaticGet__GroupRow_k__BackingField()
		{
			return (::RPG::GameCore::MusicRhythmGroupRow**)Il2CppClass::FromTypeDefinitionIndex(MusicRhythmBoard_TypeDefinitionIndex)->GetStaticField(0x4090);
		}
