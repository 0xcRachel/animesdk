...
#define RPG_CLIENT_ENVWINDTRIGGERMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x916B2F0)

namespace RPG::Client
{
	inline static constexpr unsigned int EnvWindTriggerMonoPlugin_TypeDefinitionIndex = 56625;
