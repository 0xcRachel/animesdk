...
#define RPG_CLIENT_PLANETFESEVENTDATABASE_CANREFRESHAPPEAR_OFFSET UNITYSDK_OFFSET(0x174FCC90)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_CANREFRESHDISAPPEAR_OFFSET UNITYSDK_OFFSET(0x174FD000)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_CLEAR_OFFSET UNITYSDK_OFFSET(0x174F75C0)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x174FC9E0)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_GET_APPEARCD_OFFSET UNITYSDK_OFFSET(0x174F8B20)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_GET_CUREVENTTYPE_OFFSET UNITYSDK_OFFSET(0x174FD5B0)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_GET_DISAPPEARAPPEARCD_OFFSET UNITYSDK_OFFSET(0x174F8BB0)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_GET_FAILREAPPEARCD_OFFSET UNITYSDK_OFFSET(0x174FD730)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_GET_FINISHEDCOUNT_OFFSET UNITYSDK_OFFSET(0x174FD5D0)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_GET_FIRSTUNLOCKAPPEARCD_OFFSET UNITYSDK_OFFSET(0x174FD6D0)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_GET_HISTORYDATA_OFFSET UNITYSDK_OFFSET(0x174FD790)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_GET_INITAPPEARCD_OFFSET UNITYSDK_OFFSET(0x174FD6F0)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_GET_ISDATAVALID_OFFSET UNITYSDK_OFFSET(0x174FD590)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_GET_ISEVENTFIRSTTIME_OFFSET UNITYSDK_OFFSET(0x174FD690)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_GET_ISEXIST_OFFSET UNITYSDK_OFFSET(0x174FD610)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_GET_ISFINISHEDALLCOUNT_OFFSET UNITYSDK_OFFSET(0x174F89A0)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_GET_ISJUSTENTERACTIVITY_OFFSET UNITYSDK_OFFSET(0x174FD650)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_GET_ISRECENTAPPEARFINISHEVENT_OFFSET UNITYSDK_OFFSET(0x174FD630)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_GET_LASTSTATUSCHANGETIME_OFFSET UNITYSDK_OFFSET(0x174FD670)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_GET_MISSCOUNT_OFFSET UNITYSDK_OFFSET(0x174FD6B0)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_GET_REENTERAPPEARCD_OFFSET UNITYSDK_OFFSET(0x174FD750)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_GET_STAYINTERVAL_OFFSET UNITYSDK_OFFSET(0x174FD770)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_GET_SUCCESSREAPPEARCD_OFFSET UNITYSDK_OFFSET(0x174FD710)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_GET_TOTALCOUNT_OFFSET UNITYSDK_OFFSET(0x174FD5F0)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_GET__CURBUSINESSDAYDATA_OFFSET UNITYSDK_OFFSET(0x174FCF70)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_ISBONUSEVENT_OFFSET UNITYSDK_OFFSET(0x174FA980)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_ISINPROGRESS_OFFSET UNITYSDK_OFFSET(0x174FCC50)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0x174F88E0)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_LOADCDCONFIG_OFFSET UNITYSDK_OFFSET(0x174F89B0)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_REFRESHISFIRSTTIME_OFFSET UNITYSDK_OFFSET(0x174FD2E0)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_SETTOTALCOUNT_OFFSET UNITYSDK_OFFSET(0x174F7BD0)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_SET_CUREVENTTYPE_OFFSET UNITYSDK_OFFSET(0x174FD5C0)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_SET_FAILREAPPEARCD_OFFSET UNITYSDK_OFFSET(0x174FD740)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_SET_FINISHEDCOUNT_OFFSET UNITYSDK_OFFSET(0x174FD5E0)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_SET_FIRSTUNLOCKAPPEARCD_OFFSET UNITYSDK_OFFSET(0x174FD6E0)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_SET_INITAPPEARCD_OFFSET UNITYSDK_OFFSET(0x174FD700)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_SET_ISDATAVALID_OFFSET UNITYSDK_OFFSET(0x174FD5A0)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_SET_ISEVENTFIRSTTIME_OFFSET UNITYSDK_OFFSET(0x174FD6A0)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_SET_ISEXIST_OFFSET UNITYSDK_OFFSET(0x174FD620)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_SET_ISJUSTENTERACTIVITY_OFFSET UNITYSDK_OFFSET(0x174FD660)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_SET_ISRECENTAPPEARFINISHEVENT_OFFSET UNITYSDK_OFFSET(0x174FD640)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_SET_LASTSTATUSCHANGETIME_OFFSET UNITYSDK_OFFSET(0x174FD680)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_SET_MISSCOUNT_OFFSET UNITYSDK_OFFSET(0x174FD6C0)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_SET_REENTERAPPEARCD_OFFSET UNITYSDK_OFFSET(0x174FD760)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_SET_STAYINTERVAL_OFFSET UNITYSDK_OFFSET(0x174FD780)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_SET_SUCCESSREAPPEARCD_OFFSET UNITYSDK_OFFSET(0x174FD720)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_SET_TOTALCOUNT_OFFSET UNITYSDK_OFFSET(0x174FD600)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_SYNCHISTORY_OFFSET UNITYSDK_OFFSET(0x174F6F50)
#define RPG_CLIENT_PLANETFESEVENTDATABASE_SYNC_OFFSET UNITYSDK_OFFSET(0x174F8080)
#define RPG_CLIENT_PLANETFESEVENTDATABASE__CLEARDETAIL_OFFSET UNITYSDK_OFFSET(0x174FCB80)
#define RPG_CLIENT_PLANETFESEVENTDATABASE__CTOR_OFFSET UNITYSDK_OFFSET(0x174F61E0)
#define RPG_CLIENT_PLANETFESEVENTDATABASE__DISPOSEDETAIL_OFFSET UNITYSDK_OFFSET(0x174FCBC0)
#define RPG_CLIENT_PLANETFESEVENTDATABASE__ISMISSEVENT_OFFSET UNITYSDK_OFFSET(0x174FC910)
#define RPG_CLIENT_PLANETFESEVENTDATABASE__ONEVENTFINISHCOUNTUPDATE_OFFSET UNITYSDK_OFFSET(0x174FCC00)
#define RPG_CLIENT_PLANETFESEVENTDATABASE__SYNCDETAIL_OFFSET UNITYSDK_OFFSET(0x174FCB30)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Boolean _IsRecentAppearFinishEvent_k__BackingField; // 0x20
		::System::Boolean _IsJustEnterActivity_k__BackingField; // 0x21
		::System::Boolean _IsEventFirstTime_k__BackingField; // 0x22
		::System::Boolean _IsExist_k__BackingField; // 0x23
		::System::Boolean _IsDataValid_k__BackingField; // 0x24
		::System::Int64 _FirstUnlockAppearCD_k__BackingField; // 0x28
		::System::Int64 _LastStatusChangeTime_k__BackingField; // 0x30
		...
		::RPG::GameCore::PlanetFesEventType _CurEventType_k__BackingField; // 0x58
