...
#define RPG_CLIENT_ATTACHMAPPINGITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x8C9BB60)

namespace RPG::Client
{
	inline static constexpr unsigned int AttachMappingItem_TypeDefinitionIndex = 54743;
