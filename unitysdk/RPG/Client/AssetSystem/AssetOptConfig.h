...
#define RPG_CLIENT_ASSETSYSTEM_ASSETOPTCONFIG_LOGINFO_OFFSET UNITYSDK_OFFSET(0x16BA6A30)
#define RPG_CLIENT_ASSETSYSTEM_ASSETOPTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16BA6A10)
...
namespace RPG::Client::AssetSystem
{
	...
	public:
		...
		::System::Boolean EnableLimitFrameUnload; // 0x11
		::System::Boolean EnableAssetRef; // 0x12
		::System::Boolean EnableHighBundleOptThreadPriority; // 0x13
		::System::Int32 BgJobQueueMaximumActiveThreadCount; // 0x14
		::System::Int32 CustomUpdatePreloadTimeMs; // 0x18
		::System::Boolean EnableLoadAssetOneTime; // 0x1C
		::System::Boolean IsEnableLimitMaxAsyncLoadCount; // 0x1D
		::System::Boolean EnablePrecache; // 0x1E
