...
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_GETLEVELBYUNIQUEID_OFFSET UNITYSDK_OFFSET(0xA3D1DB0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_GETROGUEACTIONID_OFFSET UNITYSDK_OFFSET(0xA3D1E40)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_GET_CURUSEDREROLLCNT_OFFSET UNITYSDK_OFFSET(0xA3D11F0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_GET_FORCESELECTROOMCARDUNIQUEIDLIST_OFFSET UNITYSDK_OFFSET(0xA3D1290)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_GET_FREEGOODSMAXPROGRESS_OFFSET UNITYSDK_OFFSET(0xA3D1310)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_GET_FREEGOODSPROGRESS_OFFSET UNITYSDK_OFFSET(0xA3D12F0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_GET_ISINSTANTKILLACTIVE_OFFSET UNITYSDK_OFFSET(0xA3D12D0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_GET_ISPRESET_OFFSET UNITYSDK_OFFSET(0xA3D1230)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_GET_ISQINGQUEKONG_OFFSET UNITYSDK_OFFSET(0xA3D1250)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_GET_ISREROLLFORBID_OFFSET UNITYSDK_OFFSET(0xA3D1270)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_GET_MAXREROLLCNT_OFFSET UNITYSDK_OFFSET(0xA3D1210)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_GET_QINGQUESUPERCARDUNIQUEIDLIST_OFFSET UNITYSDK_OFFSET(0xA3D12B0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_GET_ROGUEACTIONID_OFFSET UNITYSDK_OFFSET(0xA3D11B0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_GET_ROOMCARDLIST_OFFSET UNITYSDK_OFFSET(0xA3D11D0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_REFRESHONROLLRSP_OFFSET UNITYSDK_OFFSET(0xA3D1D50)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_SET_CURUSEDREROLLCNT_OFFSET UNITYSDK_OFFSET(0xA3D1200)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_SET_FORCESELECTROOMCARDUNIQUEIDLIST_OFFSET UNITYSDK_OFFSET(0xA3D12A0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_SET_FREEGOODSMAXPROGRESS_OFFSET UNITYSDK_OFFSET(0xA3D1320)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_SET_FREEGOODSPROGRESS_OFFSET UNITYSDK_OFFSET(0xA3D1300)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_SET_ISINSTANTKILLACTIVE_OFFSET UNITYSDK_OFFSET(0xA3D12E0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_SET_ISPRESET_OFFSET UNITYSDK_OFFSET(0xA3D1240)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_SET_ISQINGQUEKONG_OFFSET UNITYSDK_OFFSET(0xA3D1260)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_SET_ISREROLLFORBID_OFFSET UNITYSDK_OFFSET(0xA3D1280)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_SET_MAXREROLLCNT_OFFSET UNITYSDK_OFFSET(0xA3D1220)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_SET_QINGQUESUPERCARDUNIQUEIDLIST_OFFSET UNITYSDK_OFFSET(0xA3D12C0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_SET_ROGUEACTIONID_OFFSET UNITYSDK_OFFSET(0xA3D11C0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_SET_ROOMCARDLIST_OFFSET UNITYSDK_OFFSET(0xA3D11E0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_TRIGGERACTION_OFFSET UNITYSDK_OFFSET(0xA3D1E80)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION__CHECKFREEGOODSEFFECT_OFFSET UNITYSDK_OFFSET(0xA3D21F0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION__CHECKINSTANTKILLEFFECT_OFFSET UNITYSDK_OFFSET(0xA3D2060)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION__CHECKSTYLEEFFECT_OFFSET UNITYSDK_OFFSET(0xA3D2000)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION__CONSTRUCT_OFFSET UNITYSDK_OFFSET(0xA3D14C0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xA3D1330)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION__REFRESHPILEBELONG_OFFSET UNITYSDK_OFFSET(0xA3D1ED0)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Boolean _IsQingQueKong_k__BackingField; // 0x38
		::System::Boolean _IsPreset_k__BackingField; // 0x39
		::System::Boolean _IsRerollForbid_k__BackingField; // 0x3A
		::System::Boolean _IsInstantKillActive_k__BackingField; // 0x3B
