...
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_GETLEVELBYUNIQUEID_OFFSET UNITYSDK_OFFSET(0x172DBF80)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_GETROGUEACTIONID_OFFSET UNITYSDK_OFFSET(0x172DC010)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_GET_CURUSEDREROLLCNT_OFFSET UNITYSDK_OFFSET(0x172DB3E0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_GET_FORCESELECTROOMCARDUNIQUEIDLIST_OFFSET UNITYSDK_OFFSET(0x172DB480)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_GET_FREEGOODSMAXPROGRESS_OFFSET UNITYSDK_OFFSET(0x172DB500)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_GET_FREEGOODSPROGRESS_OFFSET UNITYSDK_OFFSET(0x172DB4E0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_GET_ISINSTANTKILLACTIVE_OFFSET UNITYSDK_OFFSET(0x172DB4C0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_GET_ISPRESET_OFFSET UNITYSDK_OFFSET(0x172DB420)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_GET_ISQINGQUEKONG_OFFSET UNITYSDK_OFFSET(0x172DB440)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_GET_ISREROLLFORBID_OFFSET UNITYSDK_OFFSET(0x172DB460)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_GET_MAXREROLLCNT_OFFSET UNITYSDK_OFFSET(0x172DB400)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_GET_QINGQUESUPERCARDUNIQUEIDLIST_OFFSET UNITYSDK_OFFSET(0x172DB4A0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_GET_ROGUEACTIONID_OFFSET UNITYSDK_OFFSET(0x172DB3A0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_GET_ROOMCARDLIST_OFFSET UNITYSDK_OFFSET(0x172DB3C0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_REFRESHONROLLRSP_OFFSET UNITYSDK_OFFSET(0x172DBF20)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_SET_CURUSEDREROLLCNT_OFFSET UNITYSDK_OFFSET(0x172DB3F0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_SET_FORCESELECTROOMCARDUNIQUEIDLIST_OFFSET UNITYSDK_OFFSET(0x172DB490)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_SET_FREEGOODSMAXPROGRESS_OFFSET UNITYSDK_OFFSET(0x172DB510)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_SET_FREEGOODSPROGRESS_OFFSET UNITYSDK_OFFSET(0x172DB4F0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_SET_ISINSTANTKILLACTIVE_OFFSET UNITYSDK_OFFSET(0x172DB4D0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_SET_ISPRESET_OFFSET UNITYSDK_OFFSET(0x172DB430)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_SET_ISQINGQUEKONG_OFFSET UNITYSDK_OFFSET(0x172DB450)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_SET_ISREROLLFORBID_OFFSET UNITYSDK_OFFSET(0x172DB470)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_SET_MAXREROLLCNT_OFFSET UNITYSDK_OFFSET(0x172DB410)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_SET_QINGQUESUPERCARDUNIQUEIDLIST_OFFSET UNITYSDK_OFFSET(0x172DB4B0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_SET_ROGUEACTIONID_OFFSET UNITYSDK_OFFSET(0x172DB3B0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_SET_ROOMCARDLIST_OFFSET UNITYSDK_OFFSET(0x172DB3D0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION_TRIGGERACTION_OFFSET UNITYSDK_OFFSET(0x172DC050)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION__CHECKFREEGOODSEFFECT_OFFSET UNITYSDK_OFFSET(0x172DC3C0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION__CHECKINSTANTKILLEFFECT_OFFSET UNITYSDK_OFFSET(0x172DC230)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION__CHECKSTYLEEFFECT_OFFSET UNITYSDK_OFFSET(0x172DC1D0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION__CONSTRUCT_OFFSET UNITYSDK_OFFSET(0x172DB690)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x172DB520)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDSELECTACTION__REFRESHPILEBELONG_OFFSET UNITYSDK_OFFSET(0x172DC0A0)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Boolean _IsRerollForbid_k__BackingField; // 0x48
		::System::Boolean _IsInstantKillActive_k__BackingField; // 0x49
		::System::Boolean _IsQingQueKong_k__BackingField; // 0x4A
		::System::Boolean _IsPreset_k__BackingField; // 0x4B
		::System::UInt32 _RogueActionID_k__BackingField; // 0x4C
