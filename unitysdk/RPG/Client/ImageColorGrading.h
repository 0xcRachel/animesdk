...
#define RPG_CLIENT_IMAGECOLORGRADING_GETMATERIALFORRENDERING_OFFSET UNITYSDK_OFFSET(0x94C1B30)
#define RPG_CLIENT_IMAGECOLORGRADING_GET_IMAGE_OFFSET UNITYSDK_OFFSET(0x94C1A80)
#define RPG_CLIENT_IMAGECOLORGRADING_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x94C2380)
#define RPG_CLIENT_IMAGECOLORGRADING_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x94C23E0)
#define RPG_CLIENT_IMAGECOLORGRADING_UPDATE_OFFSET UNITYSDK_OFFSET(0x94C2120)
#define RPG_CLIENT_IMAGECOLORGRADING__CTOR_OFFSET UNITYSDK_OFFSET(0x94C2430)
#define RPG_CLIENT_IMAGECOLORGRADING___IFIXBASEPROXY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x94C24B0)
#define RPG_CLIENT_IMAGECOLORGRADING___IFIXBASEPROXY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x94C24C0)

namespace RPG::Client
{
	inline static constexpr unsigned int ImageColorGrading_TypeDefinitionIndex = 57822;
