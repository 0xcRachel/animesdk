...
#define RPG_CLIENT_IMAGECOLORGRADING_GETMATERIALFORRENDERING_OFFSET UNITYSDK_OFFSET(0x165E17D0)
#define RPG_CLIENT_IMAGECOLORGRADING_GET_IMAGE_OFFSET UNITYSDK_OFFSET(0x165E1720)
#define RPG_CLIENT_IMAGECOLORGRADING_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x165E2010)
#define RPG_CLIENT_IMAGECOLORGRADING_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x165E2070)
#define RPG_CLIENT_IMAGECOLORGRADING_UPDATE_OFFSET UNITYSDK_OFFSET(0x165E1DB0)
#define RPG_CLIENT_IMAGECOLORGRADING__CTOR_OFFSET UNITYSDK_OFFSET(0x165E20C0)
#define RPG_CLIENT_IMAGECOLORGRADING___IFIXBASEPROXY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x165E2140)
#define RPG_CLIENT_IMAGECOLORGRADING___IFIXBASEPROXY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x165E2150)

namespace RPG::Client
{
	inline static constexpr unsigned int ImageColorGrading_TypeDefinitionIndex = 67785;
