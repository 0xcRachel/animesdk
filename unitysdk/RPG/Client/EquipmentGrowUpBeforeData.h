...
#define RPG_CLIENT_EQUIPMENTGROWUPBEFOREDATA_COPYTO_OFFSET UNITYSDK_OFFSET(0x1686C640)
#define RPG_CLIENT_EQUIPMENTGROWUPBEFOREDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1686C6C0)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 MaxLevelBefore; // 0x24
