...
#define RPG_CLIENT_SWITCHHANDUTILS_GETHANDMAPICONTYPE_OFFSET UNITYSDK_OFFSET(0x9FEDBB0)
#define RPG_CLIENT_SWITCHHANDUTILS_ISSHOWMAPSELFICON_OFFSET UNITYSDK_OFFSET(0x9FED980)
#define RPG_CLIENT_SWITCHHANDUTILS_ISSWITCHHANDBANROCKETPUNCH_OFFSET UNITYSDK_OFFSET(0x9FED880)

namespace RPG::Client
{
	inline static constexpr unsigned int SwitchHandUtils_TypeDefinitionIndex = 53953;
