...
#define RPG_CLIENT_TRAINMODULE___C__DISPLAYCLASS40_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA0CEAB0)
#define RPG_CLIENT_TRAINMODULE___C__DISPLAYCLASS40_0___ADDTRAINVISITOR_B__0_OFFSET UNITYSDK_OFFSET(0xA0CF6B0)
#define RPG_CLIENT_TRAINMODULE___C__DISPLAYCLASS40_0___ADDTRAINVISITOR_B__1_OFFSET UNITYSDK_OFFSET(0xA0CF6E0)

namespace RPG::Client
{
	inline static constexpr unsigned int TrainModule___c__DisplayClass40_0_TypeDefinitionIndex = 54085;
