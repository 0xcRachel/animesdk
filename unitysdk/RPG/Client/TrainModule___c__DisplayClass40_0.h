...
#define RPG_CLIENT_TRAINMODULE___C__DISPLAYCLASS40_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA5F4B40)
#define RPG_CLIENT_TRAINMODULE___C__DISPLAYCLASS40_0___ADDTRAINVISITOR_B__0_OFFSET UNITYSDK_OFFSET(0xA5F5760)
#define RPG_CLIENT_TRAINMODULE___C__DISPLAYCLASS40_0___ADDTRAINVISITOR_B__1_OFFSET UNITYSDK_OFFSET(0xA5F5790)
