...
#define RPG_CLIENT_EFFECT_MATERIALPROPERTYSETTER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x90C2FC0)
#define RPG_CLIENT_EFFECT_MATERIALPROPERTYSETTER_METHOD_5_00DEF5A164D9A9D5_OFFSET UNITYSDK_OFFSET(0x90C3030)
#define RPG_CLIENT_EFFECT_MATERIALPROPERTYSETTER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x90C2F10)
#define RPG_CLIENT_EFFECT_MATERIALPROPERTYSETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x90C3B90)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_MaterialPropertySetter_TypeDefinitionIndex = 56167;
