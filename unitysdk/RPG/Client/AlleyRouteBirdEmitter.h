...
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_BINDCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x8C76350)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_EMIT_OFFSET UNITYSDK_OFFSET(0x8C76B50)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_GET_BGCCMATH_OFFSET UNITYSDK_OFFSET(0x8C76240)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_0DEBA9294EADE4AB_OFFSET UNITYSDK_OFFSET(0x8C76DF0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_3ABD0165571B5EF8_1_OFFSET UNITYSDK_OFFSET(0x8C765D0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_3ABD0165571B5EF8_2_OFFSET UNITYSDK_OFFSET(0x8C77080)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_3ABD0165571B5EF8_OFFSET UNITYSDK_OFFSET(0x8C76880)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_660474B0F8C5FECE_OFFSET UNITYSDK_OFFSET(0x8C769B0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_6B72D4EE8C6E907F_OFFSET UNITYSDK_OFFSET(0x8C766B0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_93569AEF92075BB5_OFFSET UNITYSDK_OFFSET(0x8C76F10)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_B67699D6DDA99366_OFFSET UNITYSDK_OFFSET(0x8C77160)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_BA35AAB815742E34_OFFSET UNITYSDK_OFFSET(0x8C773E0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x8C76840)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x8C76960)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_SETBIRDCOLOR_OFFSET UNITYSDK_OFFSET(0x8C76300)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_SETBIRDCONFIG_OFFSET UNITYSDK_OFFSET(0x8C762B0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_SETBIRDPOOL_OFFSET UNITYSDK_OFFSET(0x8C76260)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_SET_BGCCMATH_OFFSET UNITYSDK_OFFSET(0x8C76250)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_STOP_OFFSET UNITYSDK_OFFSET(0x8C76C30)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_UPDATE_OFFSET UNITYSDK_OFFSET(0x8C76490)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER__CTOR_OFFSET UNITYSDK_OFFSET(0x8C77480)

namespace RPG::Client
{
	inline static constexpr unsigned int AlleyRouteBirdEmitter_TypeDefinitionIndex = 49467;
	...
	public:
		...
		::Class_0_16E4307DCC419505_523* Field_5_4; // 0x30
		...
		::Class_0_16E4307DCC419505_525* Field_5_10; // 0x58
		...
		::System::Void SetBirdConfig(::Class_0_16E4307DCC419505_523* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_523*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ALLEYROUTEBIRDEMITTER_SETBIRDCONFIG_OFFSET))(this, a1);
		}
