...
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_BINDCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x90C7540)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_EMIT_OFFSET UNITYSDK_OFFSET(0x90C7D40)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_GET_BGCCMATH_OFFSET UNITYSDK_OFFSET(0x90C7430)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_0DEBA9294EADE4AB_OFFSET UNITYSDK_OFFSET(0x90C7FE0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_3ABD0165571B5EF8_1_OFFSET UNITYSDK_OFFSET(0x90C77C0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_3ABD0165571B5EF8_2_OFFSET UNITYSDK_OFFSET(0x90C8270)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_3ABD0165571B5EF8_OFFSET UNITYSDK_OFFSET(0x90C7A70)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_660474B0F8C5FECE_OFFSET UNITYSDK_OFFSET(0x90C7BA0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_6B72D4EE8C6E907F_OFFSET UNITYSDK_OFFSET(0x90C78A0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_93569AEF92075BB5_OFFSET UNITYSDK_OFFSET(0x90C8100)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_B67699D6DDA99366_OFFSET UNITYSDK_OFFSET(0x90C8350)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_BA35AAB815742E34_OFFSET UNITYSDK_OFFSET(0x90C85D0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x90C7A30)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x90C7B50)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_SETBIRDCOLOR_OFFSET UNITYSDK_OFFSET(0x90C74F0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_SETBIRDCONFIG_OFFSET UNITYSDK_OFFSET(0x90C74A0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_SETBIRDPOOL_OFFSET UNITYSDK_OFFSET(0x90C7450)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_SET_BGCCMATH_OFFSET UNITYSDK_OFFSET(0x90C7440)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_STOP_OFFSET UNITYSDK_OFFSET(0x90C7E20)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_UPDATE_OFFSET UNITYSDK_OFFSET(0x90C7680)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER__CTOR_OFFSET UNITYSDK_OFFSET(0x90C8670)
