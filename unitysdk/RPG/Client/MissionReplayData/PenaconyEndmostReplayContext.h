...
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT_AUTOSHOW_OFFSET UNITYSDK_OFFSET(0x15296C70)
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT_CREATE_OFFSET UNITYSDK_OFFSET(0x152969B0)
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT_GETCHAPTERID_OFFSET UNITYSDK_OFFSET(0x15296AD0)
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT_GETMISSIONID_OFFSET UNITYSDK_OFFSET(0x15296B50)
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT_GETRECORDPAGEID_OFFSET UNITYSDK_OFFSET(0x15296F30)
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT_GET_CURINDEX_OFFSET UNITYSDK_OFFSET(0x15297040)
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT_GET_REPLAYDATA_OFFSET UNITYSDK_OFFSET(0x15297060)
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT_SETPENACONYENDMOSTCHRONICLECONTEXT_OFFSET UNITYSDK_OFFSET(0x15296EE0)
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT_SETREPLAYDATA_OFFSET UNITYSDK_OFFSET(0x15296C20)
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT_SET_CURINDEX_OFFSET UNITYSDK_OFFSET(0x15297050)
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT_SET_REPLAYDATA_OFFSET UNITYSDK_OFFSET(0x15297070)
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x15296AC0)

namespace RPG::Client::MissionReplayData
{
	inline static constexpr unsigned int PenaconyEndmostReplayContext_TypeDefinitionIndex = 68920;
