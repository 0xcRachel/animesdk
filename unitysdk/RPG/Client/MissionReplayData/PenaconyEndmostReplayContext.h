...
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT_AUTOSHOW_OFFSET UNITYSDK_OFFSET(0x9BFB070)
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT_CREATE_OFFSET UNITYSDK_OFFSET(0x9BFADB0)
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT_GETCHAPTERID_OFFSET UNITYSDK_OFFSET(0x9BFAED0)
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT_GETMISSIONID_OFFSET UNITYSDK_OFFSET(0x9BFAF50)
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT_GETRECORDPAGEID_OFFSET UNITYSDK_OFFSET(0x9BFB330)
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT_GET_CURINDEX_OFFSET UNITYSDK_OFFSET(0x9BFB440)
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT_GET_REPLAYDATA_OFFSET UNITYSDK_OFFSET(0x9BFB460)
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT_SETPENACONYENDMOSTCHRONICLECONTEXT_OFFSET UNITYSDK_OFFSET(0x9BFB2E0)
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT_SETREPLAYDATA_OFFSET UNITYSDK_OFFSET(0x9BFB020)
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT_SET_CURINDEX_OFFSET UNITYSDK_OFFSET(0x9BFB450)
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT_SET_REPLAYDATA_OFFSET UNITYSDK_OFFSET(0x9BFB470)
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9BFAEC0)

namespace RPG::Client::MissionReplayData
{
	inline static constexpr unsigned int PenaconyEndmostReplayContext_TypeDefinitionIndex = 61414;
