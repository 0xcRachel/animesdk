...
#define RPG_CLIENT_MONOUIANCHOREDMOVEANIMATION_GET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0x9D575F0)
#define RPG_CLIENT_MONOUIANCHOREDMOVEANIMATION_GET_PROGRESS_OFFSET UNITYSDK_OFFSET(0x9D572E0)
#define RPG_CLIENT_MONOUIANCHOREDMOVEANIMATION_PLAYATCURPOS_OFFSET UNITYSDK_OFFSET(0x9D57530)
#define RPG_CLIENT_MONOUIANCHOREDMOVEANIMATION_PLAY_OFFSET UNITYSDK_OFFSET(0x9D573F0)
#define RPG_CLIENT_MONOUIANCHOREDMOVEANIMATION_UPDATE_OFFSET UNITYSDK_OFFSET(0x9D56FA0)
#define RPG_CLIENT_MONOUIANCHOREDMOVEANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x9D57600)
#define RPG_CLIENT_MONOUIANCHOREDMOVEANIMATION__GETCURVEVALUE_OFFSET UNITYSDK_OFFSET(0x9D57340)
#define RPG_CLIENT_MONOUIANCHOREDMOVEANIMATION__PLAY_OFFSET UNITYSDK_OFFSET(0x9D574D0)
#define RPG_CLIENT_MONOUIANCHOREDMOVEANIMATION__STOP_OFFSET UNITYSDK_OFFSET(0x9D57270)
