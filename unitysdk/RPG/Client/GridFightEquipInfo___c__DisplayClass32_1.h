...
#define RPG_CLIENT_GRIDFIGHTEQUIPINFO___C__DISPLAYCLASS32_1__CTOR_OFFSET UNITYSDK_OFFSET(0x9353690)
#define RPG_CLIENT_GRIDFIGHTEQUIPINFO___C__DISPLAYCLASS32_1__GETEQUIPRECOMMENDROLEIDLIST_B__1_OFFSET UNITYSDK_OFFSET(0x9353A50)
#define RPG_CLIENT_GRIDFIGHTEQUIPINFO___C__DISPLAYCLASS32_1__GETEQUIPRECOMMENDROLEIDLIST_B__2_OFFSET UNITYSDK_OFFSET(0x9353AA0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightEquipInfo___c__DisplayClass32_1_TypeDefinitionIndex = 51619;
