...
#define RPG_CLIENT_TEXTICONS_CLASS_1_DE8146FD159B95CF_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xA070930)
#define RPG_CLIENT_TEXTICONS_CLASS_1_DE8146FD159B95CF__CTOR_OFFSET UNITYSDK_OFFSET(0xA0744D0)

namespace RPG::Client
{
	inline static constexpr unsigned int TextIcons_Class_1_DE8146FD159B95CF_TypeDefinitionIndex = 57941;

	class TextIcons_Class_1_DE8146FD159B95CF : public ::System::Object
	{
	public:
		::UnityEngine::Texture* Field_1_2; // 0x10
		::UnityEngine::CanvasRenderer* Field_1_0; // 0x18
