...
#define RPG_CLIENT_MATCHTHREEBOARD___C__DISPLAYCLASS40_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9653D20)
#define RPG_CLIENT_MATCHTHREEBOARD___C__DISPLAYCLASS40_0__DOPLAYPOWERCOUNTER_B__0_OFFSET UNITYSDK_OFFSET(0x96592B0)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeBoard___c__DisplayClass40_0_TypeDefinitionIndex = 52404;
