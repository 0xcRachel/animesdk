...
#define RPG_CLIENT_PARSEURLCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x9F1D2A0)
#define RPG_CLIENT_PARSEURLCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x9F1D2D0)
#define RPG_CLIENT_PARSEURLCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x9F1CD50)
#define RPG_CLIENT_PARSEURLCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x9F1CD30)
