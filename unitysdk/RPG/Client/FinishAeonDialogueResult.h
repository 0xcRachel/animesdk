...
#define RPG_CLIENT_FINISHAEONDIALOGUERESULT_CREATE_OFFSET UNITYSDK_OFFSET(0x9263EC0)
#define RPG_CLIENT_FINISHAEONDIALOGUERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x9263F70)

namespace RPG::Client
{
	inline static constexpr unsigned int FinishAeonDialogueResult_TypeDefinitionIndex = 53624;
