...
#define RPG_CLIENT_ROGUESEASONFINISHINFO_QUITROGUEMAP_OFFSET UNITYSDK_OFFSET(0xA368F90)
#define RPG_CLIENT_ROGUESEASONFINISHINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xA3533F0)
...
namespace RPG::Client
{
	...
	public:
		...
		::Class_1_14E02E1F6D70E487_2* _LineupInfo; // 0x18
