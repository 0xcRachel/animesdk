...
#define RPG_CLIENT_AIRLINECARWAY_AWAKE_OFFSET UNITYSDK_OFFSET(0x16E370E0)
#define RPG_CLIENT_AIRLINECARWAY__CTOR_OFFSET UNITYSDK_OFFSET(0x16E37410)
#define RPG_CLIENT_AIRLINECARWAY___IFIXBASEPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0x16E37470)
