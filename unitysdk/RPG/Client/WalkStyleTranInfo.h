...
#define RPG_CLIENT_WALKSTYLETRANINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xA255D50)

namespace RPG::Client
{
	inline static constexpr unsigned int WalkStyleTranInfo_TypeDefinitionIndex = 54686;
