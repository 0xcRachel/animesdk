...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_ROGUEBOSS_ISHITTABLE_OFFSET UNITYSDK_OFFSET(0x11E5F480)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_ROGUEBOSS_SLEEP_OFFSET UNITYSDK_OFFSET(0x11E5F7E0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_ROGUEBOSS_TICK_OFFSET UNITYSDK_OFFSET(0x11E5F4E0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_ROGUEBOSS_WAKEUP_OFFSET UNITYSDK_OFFSET(0x11E5F6C0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_ROGUEBOSS__CTOR_OFFSET UNITYSDK_OFFSET(0x11E5FAB0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_ROGUEBOSS___IFIXBASEPROXY_ISHITTABLE_OFFSET UNITYSDK_OFFSET(0x11E5FAC0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_ROGUEBOSS___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x11E5FAD0)
