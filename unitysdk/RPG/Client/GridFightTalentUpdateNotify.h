...
#define RPG_CLIENT_GRIDFIGHTTALENTUPDATENOTIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x9406000)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightTalentUpdateNotify_TypeDefinitionIndex = 51862;
