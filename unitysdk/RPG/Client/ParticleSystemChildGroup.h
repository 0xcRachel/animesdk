...
#define RPG_CLIENT_PARTICLESYSTEMCHILDGROUP_METHOD_5_71912DBB0D113575_OFFSET UNITYSDK_OFFSET(0x9A51270)
#define RPG_CLIENT_PARTICLESYSTEMCHILDGROUP_METHOD_5_E876C8B6D3B840A6_OFFSET UNITYSDK_OFFSET(0x9A50E60)
#define RPG_CLIENT_PARTICLESYSTEMCHILDGROUP_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9A51300)
#define RPG_CLIENT_PARTICLESYSTEMCHILDGROUP_ONPARENTGROUPALPHACHANGE_OFFSET UNITYSDK_OFFSET(0x9A50A70)
#define RPG_CLIENT_PARTICLESYSTEMCHILDGROUP_START_OFFSET UNITYSDK_OFFSET(0x9A50E10)
#define RPG_CLIENT_PARTICLESYSTEMCHILDGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x9A515D0)

namespace RPG::Client
{
	inline static constexpr unsigned int ParticleSystemChildGroup_TypeDefinitionIndex = 54811;
