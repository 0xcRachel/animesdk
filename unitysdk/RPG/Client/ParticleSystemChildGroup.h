...
#define RPG_CLIENT_PARTICLESYSTEMCHILDGROUP_METHOD_5_83BE0299944D0F77_OFFSET UNITYSDK_OFFSET(0x18C72C50)
#define RPG_CLIENT_PARTICLESYSTEMCHILDGROUP_METHOD_5_E876C8B6D3B840A6_OFFSET UNITYSDK_OFFSET(0x18C727B0)
#define RPG_CLIENT_PARTICLESYSTEMCHILDGROUP_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18C72CE0)
#define RPG_CLIENT_PARTICLESYSTEMCHILDGROUP_ONPARENTGROUPALPHACHANGE_OFFSET UNITYSDK_OFFSET(0x18C72370)
#define RPG_CLIENT_PARTICLESYSTEMCHILDGROUP_START_OFFSET UNITYSDK_OFFSET(0x18C72760)
#define RPG_CLIENT_PARTICLESYSTEMCHILDGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x18C73010)
