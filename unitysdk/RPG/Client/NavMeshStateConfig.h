...
#define RPG_CLIENT_NAVMESHSTATECONFIG_AWAKE_OFFSET UNITYSDK_OFFSET(0x1262C360)
#define RPG_CLIENT_NAVMESHSTATECONFIG_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1262BFB0)
#define RPG_CLIENT_NAVMESHSTATECONFIG_ENABLENAVMESHCONFIG_OFFSET UNITYSDK_OFFSET(0x1262CF00)
#define RPG_CLIENT_NAVMESHSTATECONFIG_METHOD_5_1F47CAD86E555F5A_OFFSET UNITYSDK_OFFSET(0x1262C000)
#define RPG_CLIENT_NAVMESHSTATECONFIG_METHOD_5_868C75966CA63116_OFFSET UNITYSDK_OFFSET(0x1262CCA0)
#define RPG_CLIENT_NAVMESHSTATECONFIG_REMOVENAVMESHCONFIG_OFFSET UNITYSDK_OFFSET(0x1262CEB0)
#define RPG_CLIENT_NAVMESHSTATECONFIG_SETNAVMESHCONFIG_OFFSET UNITYSDK_OFFSET(0x1262C430)
#define RPG_CLIENT_NAVMESHSTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1262CFF0)
