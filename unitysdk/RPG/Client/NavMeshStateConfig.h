...
#define RPG_CLIENT_NAVMESHSTATECONFIG_AWAKE_OFFSET UNITYSDK_OFFSET(0x15607670)
#define RPG_CLIENT_NAVMESHSTATECONFIG_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15607350)
#define RPG_CLIENT_NAVMESHSTATECONFIG_ENABLENAVMESHCONFIG_OFFSET UNITYSDK_OFFSET(0x15608260)
#define RPG_CLIENT_NAVMESHSTATECONFIG_METHOD_5_7E64705CB9FB1B5D_OFFSET UNITYSDK_OFFSET(0x15608050)
#define RPG_CLIENT_NAVMESHSTATECONFIG_METHOD_5_F74441856239DF08_OFFSET UNITYSDK_OFFSET(0x156073A0)
#define RPG_CLIENT_NAVMESHSTATECONFIG_REMOVENAVMESHCONFIG_OFFSET UNITYSDK_OFFSET(0x15608210)
#define RPG_CLIENT_NAVMESHSTATECONFIG_SETNAVMESHCONFIG_OFFSET UNITYSDK_OFFSET(0x15607740)
#define RPG_CLIENT_NAVMESHSTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x15608350)
