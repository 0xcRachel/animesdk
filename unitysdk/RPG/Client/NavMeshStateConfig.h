...
#define RPG_CLIENT_NAVMESHSTATECONFIG_AWAKE_OFFSET UNITYSDK_OFFSET(0x9E3CE60)
#define RPG_CLIENT_NAVMESHSTATECONFIG_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9E3CAB0)
#define RPG_CLIENT_NAVMESHSTATECONFIG_ENABLENAVMESHCONFIG_OFFSET UNITYSDK_OFFSET(0x9E3DA00)
#define RPG_CLIENT_NAVMESHSTATECONFIG_METHOD_5_1F47CAD86E555F5A_OFFSET UNITYSDK_OFFSET(0x9E3CB00)
#define RPG_CLIENT_NAVMESHSTATECONFIG_METHOD_5_868C75966CA63116_OFFSET UNITYSDK_OFFSET(0x9E3D7A0)
#define RPG_CLIENT_NAVMESHSTATECONFIG_REMOVENAVMESHCONFIG_OFFSET UNITYSDK_OFFSET(0x9E3D9B0)
#define RPG_CLIENT_NAVMESHSTATECONFIG_SETNAVMESHCONFIG_OFFSET UNITYSDK_OFFSET(0x9E3CF30)
#define RPG_CLIENT_NAVMESHSTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9E3DAF0)
