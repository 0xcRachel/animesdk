...
#define RPG_CLIENT_NAVMESHSTATECONFIG_AWAKE_OFFSET UNITYSDK_OFFSET(0x999FF60)
#define RPG_CLIENT_NAVMESHSTATECONFIG_DISPOSE_OFFSET UNITYSDK_OFFSET(0x999FBB0)
#define RPG_CLIENT_NAVMESHSTATECONFIG_ENABLENAVMESHCONFIG_OFFSET UNITYSDK_OFFSET(0x99A0B00)
#define RPG_CLIENT_NAVMESHSTATECONFIG_METHOD_5_1F47CAD86E555F5A_OFFSET UNITYSDK_OFFSET(0x999FC00)
#define RPG_CLIENT_NAVMESHSTATECONFIG_METHOD_5_868C75966CA63116_OFFSET UNITYSDK_OFFSET(0x99A08A0)
#define RPG_CLIENT_NAVMESHSTATECONFIG_REMOVENAVMESHCONFIG_OFFSET UNITYSDK_OFFSET(0x99A0AB0)
#define RPG_CLIENT_NAVMESHSTATECONFIG_SETNAVMESHCONFIG_OFFSET UNITYSDK_OFFSET(0x99A0030)
#define RPG_CLIENT_NAVMESHSTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x99A0BF0)

namespace RPG::Client
{
	inline static constexpr unsigned int NavMeshStateConfig_TypeDefinitionIndex = 54501;
