...
#define RPG_CLIENT_PLANETFESAVATARSTOPMOVE_METHOD_3_6035F9FC37D8AFB8_OFFSET UNITYSDK_OFFSET(0x1676B4C0)
#define RPG_CLIENT_PLANETFESAVATARSTOPMOVE_METHOD_3_A6A075FD2AF56C11_OFFSET UNITYSDK_OFFSET(0x1676B440)
#define RPG_CLIENT_PLANETFESAVATARSTOPMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1676B490)
