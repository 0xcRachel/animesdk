...
#define RPG_CLIENT_IPEDESTRIANMEMBEREXTERNALCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x94C07A0)

namespace RPG::Client
{
	inline static constexpr unsigned int IPedestrianMemberExternalConfig_TypeDefinitionIndex = 55040;
