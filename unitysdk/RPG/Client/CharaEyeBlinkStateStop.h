...
#define RPG_CLIENT_CHARAEYEBLINKSTATESTOP_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x8EA3170)
#define RPG_CLIENT_CHARAEYEBLINKSTATESTOP_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x8EA3200)
#define RPG_CLIENT_CHARAEYEBLINKSTATESTOP_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x8EA31C0)
#define RPG_CLIENT_CHARAEYEBLINKSTATESTOP_TICK_OFFSET UNITYSDK_OFFSET(0x8EA3240)
#define RPG_CLIENT_CHARAEYEBLINKSTATESTOP__CTOR_OFFSET UNITYSDK_OFFSET(0x8EA32A0)

namespace RPG::Client
{
	inline static constexpr unsigned int CharaEyeBlinkStateStop_TypeDefinitionIndex = 54252;
