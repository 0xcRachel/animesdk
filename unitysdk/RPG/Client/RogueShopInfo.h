...
#define RPG_CLIENT_ROGUESHOPINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9E46600)
#define RPG_CLIENT_ROGUESHOPINFO_GET_BUFFSHOP_OFFSET UNITYSDK_OFFSET(0x9E467A0)
#define RPG_CLIENT_ROGUESHOPINFO_GET_FORMULASHOP_OFFSET UNITYSDK_OFFSET(0x9E467C0)
#define RPG_CLIENT_ROGUESHOPINFO_GET_MIRACLESHOP_OFFSET UNITYSDK_OFFSET(0x9E46780)
#define RPG_CLIENT_ROGUESHOPINFO_SET_BUFFSHOP_OFFSET UNITYSDK_OFFSET(0x9E467B0)
#define RPG_CLIENT_ROGUESHOPINFO_SET_FORMULASHOP_OFFSET UNITYSDK_OFFSET(0x9E467D0)
#define RPG_CLIENT_ROGUESHOPINFO_SET_MIRACLESHOP_OFFSET UNITYSDK_OFFSET(0x9E46790)
#define RPG_CLIENT_ROGUESHOPINFO_SYNCBUFFSHOPCONFIG_OFFSET UNITYSDK_OFFSET(0x9E464C0)
#define RPG_CLIENT_ROGUESHOPINFO_SYNCBUFFSHOPITEM_OFFSET UNITYSDK_OFFSET(0x9E46460)
#define RPG_CLIENT_ROGUESHOPINFO_SYNCFORMULASHOPCONFIG_OFFSET UNITYSDK_OFFSET(0x9E46590)
#define RPG_CLIENT_ROGUESHOPINFO_SYNCFORMULASHOPITEM_OFFSET UNITYSDK_OFFSET(0x9E46530)
#define RPG_CLIENT_ROGUESHOPINFO_SYNCMIRACLE_OFFSET UNITYSDK_OFFSET(0x9E463D0)
#define RPG_CLIENT_ROGUESHOPINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x9E467E0)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueShopInfo_TypeDefinitionIndex = 53507;
	...
	public:
		...
		::System::Void SyncMiracle(::Class_1_E7C4009BCC22497A_73* info)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_E7C4009BCC22497A_73*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ROGUESHOPINFO_SYNCMIRACLE_OFFSET))(this, info);
		}

		::System::Void SyncBuffShopItem(::Class_1_E7C4009BCC22497A_74* info)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_E7C4009BCC22497A_74*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ROGUESHOPINFO_SYNCBUFFSHOPITEM_OFFSET))(this, info);
		}
		...
		::System::Void SyncFormulaShopItem(::Class_1_E7C4009BCC22497A_75* info)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_E7C4009BCC22497A_75*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ROGUESHOPINFO_SYNCFORMULASHOPITEM_OFFSET))(this, info);
		}
