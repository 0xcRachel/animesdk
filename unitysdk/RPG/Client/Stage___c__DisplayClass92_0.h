...
#define RPG_CLIENT_STAGE___C__DISPLAYCLASS92_0__CTOR_OFFSET UNITYSDK_OFFSET(0x17C29A10)
#define RPG_CLIENT_STAGE___C__DISPLAYCLASS92_0__RUNTIMEADDSTREAMINGITEM_B__0_OFFSET UNITYSDK_OFFSET(0x17C2A850)
#define RPG_CLIENT_STAGE___C__DISPLAYCLASS92_0__RUNTIMEADDSTREAMINGITEM_B__1_OFFSET UNITYSDK_OFFSET(0x17C2A8C0)
#define RPG_CLIENT_STAGE___C__DISPLAYCLASS92_0__RUNTIMEADDSTREAMINGITEM_B__2_OFFSET UNITYSDK_OFFSET(0x17C2A930)
