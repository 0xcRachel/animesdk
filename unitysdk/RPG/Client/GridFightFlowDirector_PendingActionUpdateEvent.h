...
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_PENDINGACTIONUPDATEEVENT_GET_HASFORBIDMONSTERREVEAL_OFFSET UNITYSDK_OFFSET(0x9824E30)
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_PENDINGACTIONUPDATEEVENT_GET_HASINITIALSUPPLYBONUS_OFFSET UNITYSDK_OFFSET(0x9825160)
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_PENDINGACTIONUPDATEEVENT_GET_HASPORTALBUFFSELECTION_OFFSET UNITYSDK_OFFSET(0x9824D50)
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_PENDINGACTIONUPDATEEVENT_GET_NEEDSHOWSTAGEHINT_OFFSET UNITYSDK_OFFSET(0x9824F80)
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_PENDINGACTIONUPDATEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x9826B80)
