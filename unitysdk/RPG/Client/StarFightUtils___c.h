...
#define RPG_CLIENT_STARFIGHTUTILS___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xA4E2A60)
#define RPG_CLIENT_STARFIGHTUTILS___C__CTOR_OFFSET UNITYSDK_OFFSET(0xA4E2AA0)
#define RPG_CLIENT_STARFIGHTUTILS___C__GETMONSTERDATALIST_B__0_0_OFFSET UNITYSDK_OFFSET(0xA4E2AB0)
#define RPG_CLIENT_STARFIGHTUTILS___C__GETMONSTERDATALIST_B__0_1_OFFSET UNITYSDK_OFFSET(0xA4E2AD0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Comparison_1<::RPG::Client::MonsterData*>**)Il2CppClass::FromTypeDefinitionIndex(StarFightUtils___c_TypeDefinitionIndex)->GetStaticField(0x2B4E0);
		}
		static ::RPG::Client::StarFightUtils___c** StaticGet___9()
		{
			return (::RPG::Client::StarFightUtils___c**)Il2CppClass::FromTypeDefinitionIndex(StarFightUtils___c_TypeDefinitionIndex)->GetStaticField(0x2B4E8);
		}
		static ::System::Func_2<::RPG::Client::MonsterData*, ::System::UInt32>** StaticGet___9__0_0()
		{
			return (::System::Func_2<::RPG::Client::MonsterData*, ::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(StarFightUtils___c_TypeDefinitionIndex)->GetStaticField(0x2B4F0);
		}
