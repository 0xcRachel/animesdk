...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPEMISSION_INIT_OFFSET UNITYSDK_OFFSET(0x165E8ED0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPEMISSION_UNINIT_OFFSET UNITYSDK_OFFSET(0x165E91D0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPEMISSION_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x165E8F70)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPEMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x165E9270)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPEMISSION___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x165E9290)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPEMISSION___IFIXBASEPROXY_UNINIT_OFFSET UNITYSDK_OFFSET(0x165E92A0)
