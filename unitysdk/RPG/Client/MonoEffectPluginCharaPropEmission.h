...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPEMISSION_INIT_OFFSET UNITYSDK_OFFSET(0x15A29440)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPEMISSION_UNINIT_OFFSET UNITYSDK_OFFSET(0x15A29750)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPEMISSION_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x15A294E0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPEMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x15A297F0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPEMISSION___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x15A29810)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPEMISSION___IFIXBASEPROXY_UNINIT_OFFSET UNITYSDK_OFFSET(0x15A29820)
