...
#define RPG_CLIENT_BATCHANIMATIONLODSIZECONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x8D7E280)
#define RPG_CLIENT_BATCHANIMATIONLODSIZECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8D7E3B0)

namespace RPG::Client
{
	inline static constexpr unsigned int BatchAnimationLodSizeController_TypeDefinitionIndex = 55250;
