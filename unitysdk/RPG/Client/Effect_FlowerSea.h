...
#define RPG_CLIENT_EFFECT_FLOWERSEA_AWAKE_OFFSET UNITYSDK_OFFSET(0x9556F30)
#define RPG_CLIENT_EFFECT_FLOWERSEA_LATETICK_OFFSET UNITYSDK_OFFSET(0x9558160)
#define RPG_CLIENT_EFFECT_FLOWERSEA_METHOD_5_81FEFD1B22CE37A2_OFFSET UNITYSDK_OFFSET(0x95581C0)
#define RPG_CLIENT_EFFECT_FLOWERSEA_METHOD_5_B29205EE7F7B640C_OFFSET UNITYSDK_OFFSET(0x9556F80)
#define RPG_CLIENT_EFFECT_FLOWERSEA_METHOD_5_F29D7A7F508EABE1_OFFSET UNITYSDK_OFFSET(0x9558D80)
#define RPG_CLIENT_EFFECT_FLOWERSEA_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x95580D0)
#define RPG_CLIENT_EFFECT_FLOWERSEA_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9557F70)
#define RPG_CLIENT_EFFECT_FLOWERSEA__CTOR_OFFSET UNITYSDK_OFFSET(0x9558F50)
