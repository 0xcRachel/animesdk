...
#define RPG_CLIENT_EFFECT_FLOWERSEA_AWAKE_OFFSET UNITYSDK_OFFSET(0x90A99B0)
#define RPG_CLIENT_EFFECT_FLOWERSEA_LATETICK_OFFSET UNITYSDK_OFFSET(0x90AABC0)
#define RPG_CLIENT_EFFECT_FLOWERSEA_METHOD_5_81FEFD1B22CE37A2_OFFSET UNITYSDK_OFFSET(0x90AAC20)
#define RPG_CLIENT_EFFECT_FLOWERSEA_METHOD_5_AE80CBC984AADFD5_OFFSET UNITYSDK_OFFSET(0x90A9A00)
#define RPG_CLIENT_EFFECT_FLOWERSEA_METHOD_5_D78B51BFDA4B8B32_OFFSET UNITYSDK_OFFSET(0x90AB7C0)
#define RPG_CLIENT_EFFECT_FLOWERSEA_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x90AAB30)
#define RPG_CLIENT_EFFECT_FLOWERSEA_ONENABLE_OFFSET UNITYSDK_OFFSET(0x90AA9D0)
#define RPG_CLIENT_EFFECT_FLOWERSEA__CTOR_OFFSET UNITYSDK_OFFSET(0x90AB930)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_FlowerSea_TypeDefinitionIndex = 56141;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_EFFECT_FLOWERSEA_METHOD_5_AE80CBC984AADFD5_OFFSET))(this);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_EFFECT_FLOWERSEA_METHOD_5_D78B51BFDA4B8B32_OFFSET))(this);
		}
	};
}
