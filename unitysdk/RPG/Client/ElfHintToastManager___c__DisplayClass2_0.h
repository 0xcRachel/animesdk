...
#define RPG_CLIENT_ELFHINTTOASTMANAGER___C__DISPLAYCLASS2_0__CHECKFARMHINTS_B__0_OFFSET UNITYSDK_OFFSET(0x16C51A00)
#define RPG_CLIENT_ELFHINTTOASTMANAGER___C__DISPLAYCLASS2_0__CHECKFARMHINTS_B__1_OFFSET UNITYSDK_OFFSET(0x16C51BA0)
#define RPG_CLIENT_ELFHINTTOASTMANAGER___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16C51830)
