...
#define RPG_CLIENT_CHIMERADUELMASTERRECOMMENDATIONDATA_CONTAINS_OFFSET UNITYSDK_OFFSET(0x8F16630)
#define RPG_CLIENT_CHIMERADUELMASTERRECOMMENDATIONDATA_EXPORTDISPLAYDATA_OFFSET UNITYSDK_OFFSET(0x8F16700)
#define RPG_CLIENT_CHIMERADUELMASTERRECOMMENDATIONDATA_GET_SLOTCOUNT_OFFSET UNITYSDK_OFFSET(0x8F16540)
#define RPG_CLIENT_CHIMERADUELMASTERRECOMMENDATIONDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x8F164E0)
#define RPG_CLIENT_CHIMERADUELMASTERRECOMMENDATIONDATA_SYSTEM_ICOMPARABLE_RPG_CLIENT_CHIMERADUELMASTERRECOMMENDATIONDATA__COMPARETO_OFFSET UNITYSDK_OFFSET(0x8F16600)
#define RPG_CLIENT_CHIMERADUELMASTERRECOMMENDATIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8F165F0)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraDuelMasterRecommendationData_TypeDefinitionIndex = 50310;
