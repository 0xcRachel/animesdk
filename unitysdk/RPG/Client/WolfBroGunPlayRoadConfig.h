...
#define RPG_CLIENT_WOLFBROGUNPLAYROADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA261510)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayRoadConfig_TypeDefinitionIndex = 54587;
