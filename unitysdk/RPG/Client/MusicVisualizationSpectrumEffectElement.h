...
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_00A968F776BCC204_OFFSET UNITYSDK_OFFSET(0x9909080)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_224BCAB043AC8B27_OFFSET UNITYSDK_OFFSET(0x99095C0)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_25EC451C0EA68F53_1_OFFSET UNITYSDK_OFFSET(0x99086C0)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_25EC451C0EA68F53_OFFSET UNITYSDK_OFFSET(0x99084F0)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x9909470)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_314BF8EF46C5FD93_OFFSET UNITYSDK_OFFSET(0x990A190)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_3200429A74A84938_OFFSET UNITYSDK_OFFSET(0x990A3A0)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x9908BC0)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_52CA0F45BC3414DC_OFFSET UNITYSDK_OFFSET(0x9908970)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_558C6AE12602A241_OFFSET UNITYSDK_OFFSET(0x9908490)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_71D239EC67769A2B_OFFSET UNITYSDK_OFFSET(0x990A2B0)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_73627CF2C5000039_OFFSET UNITYSDK_OFFSET(0x9909740)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_8594010D6A57C9BB_OFFSET UNITYSDK_OFFSET(0x9908890)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_89ECADC0D3C7C373_OFFSET UNITYSDK_OFFSET(0x9909FC0)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_B7F8E0B4AF22DEA3_1_OFFSET UNITYSDK_OFFSET(0x9908F40)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_B7F8E0B4AF22DEA3_OFFSET UNITYSDK_OFFSET(0x9908C40)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_C8D6B29192F288ED_OFFSET UNITYSDK_OFFSET(0x99080D0)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x9908440)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x9908D80)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_CA373AA1C7054598_3_OFFSET UNITYSDK_OFFSET(0x9909F40)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_CA373AA1C7054598_4_OFFSET UNITYSDK_OFFSET(0x9909F80)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x9908400)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_CEE72EAC18ECC163_1_OFFSET UNITYSDK_OFFSET(0x9909560)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_CEE72EAC18ECC163_OFFSET UNITYSDK_OFFSET(0x9909500)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_D737CD2779D51A4E_OFFSET UNITYSDK_OFFSET(0x9908DD0)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_EA6181D1E7BCBCB3_OFFSET UNITYSDK_OFFSET(0x99098C0)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x990A710)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicVisualizationSpectrumEffectElement_TypeDefinitionIndex = 56456;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_D737CD2779D51A4E_OFFSET))(this);
		}
		...
		::System::Span_1<::System::Single> Method_1_73627CF2C5000039(::Il2CppArray<::System::Single>* a1, ::UnityEngine::Vector2 a2)
		{
			return ((::System::Span_1<::System::Single>(*)(::PVOID, ::Il2CppArray<::System::Single>*, ::UnityEngine::Vector2))((::PBYTE)hIl2Cpp + RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_73627CF2C5000039_OFFSET))(this, a1, a2);
		}
