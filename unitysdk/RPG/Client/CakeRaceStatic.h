...
#define RPG_CLIENT_CAKERACESTATIC_GETACTIVITYREWARDID_OFFSET UNITYSDK_OFFSET(0x15E1A370)
#define RPG_CLIENT_CAKERACESTATIC_GETCURLOANPERFORMENCEID_OFFSET UNITYSDK_OFFSET(0x15E1AD30)
#define RPG_CLIENT_CAKERACESTATIC_GETSCORERANKRATIO_OFFSET UNITYSDK_OFFSET(0x15E1AED0)
#define RPG_CLIENT_CAKERACESTATIC_GET_ACTIVITYID_OFFSET UNITYSDK_OFFSET(0x15E1A360)
#define RPG_CLIENT_CAKERACESTATIC_GET_BETRATIOSHOWSPECIAL_OFFSET UNITYSDK_OFFSET(0x15E1AC10)
#define RPG_CLIENT_CAKERACESTATIC_GET_CAMERACHANGEFOLLOWTIME_OFFSET UNITYSDK_OFFSET(0x15E1A7C0)
#define RPG_CLIENT_CAKERACESTATIC_GET_CHAMPIONCAMERACHANGETIME_OFFSET UNITYSDK_OFFSET(0x15E1AB00)
#define RPG_CLIENT_CAKERACESTATIC_GET_CHAMPIONCAMERASHOWTIME_OFFSET UNITYSDK_OFFSET(0x15E1A9F0)
#define RPG_CLIENT_CAKERACESTATIC_GET_COINITEMICON128SIZEPATH_OFFSET UNITYSDK_OFFSET(0x15E1A100)
#define RPG_CLIENT_CAKERACESTATIC_GET_COINITEMICONPATH_OFFSET UNITYSDK_OFFSET(0x15E1A050)
#define RPG_CLIENT_CAKERACESTATIC_GET_COINITEMID_OFFSET UNITYSDK_OFFSET(0x15E14CC0)
#define RPG_CLIENT_CAKERACESTATIC_GET_COINITEMLIMIT_OFFSET UNITYSDK_OFFSET(0x15E1A440)
#define RPG_CLIENT_CAKERACESTATIC_GET_ENTRANCEID_OFFSET UNITYSDK_OFFSET(0x15E1A740)
#define RPG_CLIENT_CAKERACESTATIC_GET_ENTRANCEMAPINFOID_OFFSET UNITYSDK_OFFSET(0x15E1A660)
#define RPG_CLIENT_CAKERACESTATIC_GET_HIGHWINRATETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x15E0A160)
#define RPG_CLIENT_CAKERACESTATIC_GET_LOWWINRATETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x15E0A2D0)
#define RPG_CLIENT_CAKERACESTATIC_GET_SCOREITEMICONPATH_OFFSET UNITYSDK_OFFSET(0x15E1A1B0)
#define RPG_CLIENT_CAKERACESTATIC_GET_SCOREITEMID_OFFSET UNITYSDK_OFFSET(0x15E16760)
#define RPG_CLIENT_CAKERACESTATIC_GET_SCOREITEMLIMIT_OFFSET UNITYSDK_OFFSET(0x15E1A550)
#define RPG_CLIENT_CAKERACESTATIC_GET_SHOWSECTIONENDTOASTTIME_OFFSET UNITYSDK_OFFSET(0x15E1A8E0)
#define RPG_CLIENT_CAKERACESTATIC_GET_SPECIALBETRATIO_OFFSET UNITYSDK_OFFSET(0x15E1A260)
