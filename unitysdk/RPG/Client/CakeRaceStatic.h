...
#define RPG_CLIENT_CAKERACESTATIC_GETACTIVITYREWARDID_OFFSET UNITYSDK_OFFSET(0x18FAC0D0)
#define RPG_CLIENT_CAKERACESTATIC_GETCURLOANPERFORMENCEID_OFFSET UNITYSDK_OFFSET(0x18FACD60)
#define RPG_CLIENT_CAKERACESTATIC_GETSCORERANKRATIO_OFFSET UNITYSDK_OFFSET(0x18FACEF0)
#define RPG_CLIENT_CAKERACESTATIC_GET_ACTIVITYID_OFFSET UNITYSDK_OFFSET(0x18FAC0C0)
#define RPG_CLIENT_CAKERACESTATIC_GET_BETRATIOSHOWSPECIAL_OFFSET UNITYSDK_OFFSET(0x18FAC980)
#define RPG_CLIENT_CAKERACESTATIC_GET_CAMERACHANGEFOLLOWTIME_OFFSET UNITYSDK_OFFSET(0x18FAC530)
#define RPG_CLIENT_CAKERACESTATIC_GET_CHAMPIONCAMERACHANGETIME_OFFSET UNITYSDK_OFFSET(0x18FAC870)
#define RPG_CLIENT_CAKERACESTATIC_GET_CHAMPIONCAMERASHOWTIME_OFFSET UNITYSDK_OFFSET(0x18FAC760)
#define RPG_CLIENT_CAKERACESTATIC_GET_COINITEMICON128SIZEPATH_OFFSET UNITYSDK_OFFSET(0x18FABE60)
#define RPG_CLIENT_CAKERACESTATIC_GET_COINITEMICONPATH_OFFSET UNITYSDK_OFFSET(0x18FABDB0)
#define RPG_CLIENT_CAKERACESTATIC_GET_COINITEMID_OFFSET UNITYSDK_OFFSET(0x18FA6710)
#define RPG_CLIENT_CAKERACESTATIC_GET_COINITEMLIMIT_OFFSET UNITYSDK_OFFSET(0x18FAC1A0)
#define RPG_CLIENT_CAKERACESTATIC_GET_ENTRANCEID_OFFSET UNITYSDK_OFFSET(0x18FAC4B0)
#define RPG_CLIENT_CAKERACESTATIC_GET_ENTRANCEMAPINFOID_OFFSET UNITYSDK_OFFSET(0x18FAC3C0)
#define RPG_CLIENT_CAKERACESTATIC_GET_HIGHWINRATETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x18FACAA0)
#define RPG_CLIENT_CAKERACESTATIC_GET_LOWWINRATETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x18FACC00)
#define RPG_CLIENT_CAKERACESTATIC_GET_SCOREITEMICONPATH_OFFSET UNITYSDK_OFFSET(0x18FABF10)
#define RPG_CLIENT_CAKERACESTATIC_GET_SCOREITEMID_OFFSET UNITYSDK_OFFSET(0x18FA8270)
#define RPG_CLIENT_CAKERACESTATIC_GET_SCOREITEMLIMIT_OFFSET UNITYSDK_OFFSET(0x18FAC2B0)
#define RPG_CLIENT_CAKERACESTATIC_GET_SHOWSECTIONENDTOASTTIME_OFFSET UNITYSDK_OFFSET(0x18FAC650)
#define RPG_CLIENT_CAKERACESTATIC_GET_SPECIALBETRATIO_OFFSET UNITYSDK_OFFSET(0x18FABFC0)
