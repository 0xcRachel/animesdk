...
#define RPG_CLIENT_EFFECT_PETALINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x90D4E70)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_PetalInstance_TypeDefinitionIndex = 56186;
