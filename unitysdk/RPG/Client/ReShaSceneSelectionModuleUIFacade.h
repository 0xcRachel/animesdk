...
#define RPG_CLIENT_RESHASCENESELECTIONMODULEUIFACADE_GETCURROUTEEASTEREGGCONDITIONMATCHEDCOUNT_OFFSET UNITYSDK_OFFSET(0x1600FC20)
#define RPG_CLIENT_RESHASCENESELECTIONMODULEUIFACADE_GETROUTEDISPLAYROWS_OFFSET UNITYSDK_OFFSET(0x1600FA70)
#define RPG_CLIENT_RESHASCENESELECTIONMODULEUIFACADE_GET_CURROUTEDISPLAYID_OFFSET UNITYSDK_OFFSET(0x1600FD70)
#define RPG_CLIENT_RESHASCENESELECTIONMODULEUIFACADE_GET_ISCURROUTESELECTED_OFFSET UNITYSDK_OFFSET(0x1600FE30)
#define RPG_CLIENT_RESHASCENESELECTIONMODULEUIFACADE_GET_PLANETDISPLAYID_OFFSET UNITYSDK_OFFSET(0x1600FDD0)
#define RPG_CLIENT_RESHASCENESELECTIONMODULEUIFACADE_GET_REACTPROP_OFFSET UNITYSDK_OFFSET(0x1600FE90)
#define RPG_CLIENT_RESHASCENESELECTIONMODULEUIFACADE_TRYCREATECURMODULEFACADE_OFFSET UNITYSDK_OFFSET(0x1600F8D0)
#define RPG_CLIENT_RESHASCENESELECTIONMODULEUIFACADE__CTOR_OFFSET UNITYSDK_OFFSET(0x1600F8C0)
