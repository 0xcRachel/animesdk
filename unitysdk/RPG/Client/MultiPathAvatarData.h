...
#define RPG_CLIENT_MULTIPATHAVATARDATA_CANCHANGETOSPECIFICAVATARPATH_OFFSET UNITYSDK_OFFSET(0x9DB1980)
#define RPG_CLIENT_MULTIPATHAVATARDATA_DELETEOTHERGENDERAVATARPATHDATA_OFFSET UNITYSDK_OFFSET(0x9DB07F0)
#define RPG_CLIENT_MULTIPATHAVATARDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9DB04B0)
#define RPG_CLIENT_MULTIPATHAVATARDATA_GETALLAVAILABLEMULTIPATHAVATARTYPE_OFFSET UNITYSDK_OFFSET(0x9DB1460)
#define RPG_CLIENT_MULTIPATHAVATARDATA_GETALLAVATARPATHDATA_OFFSET UNITYSDK_OFFSET(0x9DB0C50)
#define RPG_CLIENT_MULTIPATHAVATARDATA_GETALLMULTIPATHAVATARTYPE_OFFSET UNITYSDK_OFFSET(0x9DB0FD0)
#define RPG_CLIENT_MULTIPATHAVATARDATA_GETAVATARPATHDATA_OFFSET UNITYSDK_OFFSET(0x9DB0B90)
#define RPG_CLIENT_MULTIPATHAVATARDATA_GETAVATARPATHROW_OFFSET UNITYSDK_OFFSET(0x9DB18C0)
#define RPG_CLIENT_MULTIPATHAVATARDATA_GETCURRENTMULTIPATHAVATARTYPE_OFFSET UNITYSDK_OFFSET(0x9DB0B50)
#define RPG_CLIENT_MULTIPATHAVATARDATA_GETEARLYUNLOCKMULTIPATHAVATARTYPES_OFFSET UNITYSDK_OFFSET(0x9DB15C0)
#define RPG_CLIENT_MULTIPATHAVATARDATA_GET_BASEAVATARID_OFFSET UNITYSDK_OFFSET(0x9DB1AF0)
#define RPG_CLIENT_MULTIPATHAVATARDATA_HASMULTIAVATARPATH_OFFSET UNITYSDK_OFFSET(0x9DB1A60)
#define RPG_CLIENT_MULTIPATHAVATARDATA_SETCURRENTMULTIPATHAVATARTYPE_OFFSET UNITYSDK_OFFSET(0x9DB0AB0)
#define RPG_CLIENT_MULTIPATHAVATARDATA_SYNC_OFFSET UNITYSDK_OFFSET(0x9DB05C0)
#define RPG_CLIENT_MULTIPATHAVATARDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9DB0250)
#define RPG_CLIENT_MULTIPATHAVATARDATA__UPDATEALLAVATARPATHDATA_OFFSET UNITYSDK_OFFSET(0x9DB0CB0)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::Enum_3_DFCB42601400F441, ::RPG::Client::AvatarPathData*>* _AvatarPathDataDict; // 0x10
		::System::Collections::Generic::List_1<::Enum_3_DFCB42601400F441>* _AllMultiPathAvatarTypes; // 0x18
		...
		::System::Collections::Generic::List_1<::RPG::Client::AvatarPathData*>* _AllAvatarPathDatas; // 0x30
