...
#define RPG_CLIENT_MULTIPATHAVATARDATA_CANCHANGETOSPECIFICAVATARPATH_OFFSET UNITYSDK_OFFSET(0x13734B50)
#define RPG_CLIENT_MULTIPATHAVATARDATA_DELETEOTHERGENDERAVATARPATHDATA_OFFSET UNITYSDK_OFFSET(0x13733CF0)
#define RPG_CLIENT_MULTIPATHAVATARDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13733690)
#define RPG_CLIENT_MULTIPATHAVATARDATA_GETALLAVAILABLEMULTIPATHAVATARTYPE_OFFSET UNITYSDK_OFFSET(0x13734630)
#define RPG_CLIENT_MULTIPATHAVATARDATA_GETALLAVATARPATHDATA_OFFSET UNITYSDK_OFFSET(0x13734250)
#define RPG_CLIENT_MULTIPATHAVATARDATA_GETALLMULTIPATHAVATARTYPE_OFFSET UNITYSDK_OFFSET(0x137342B0)
#define RPG_CLIENT_MULTIPATHAVATARDATA_GETAVATARPATHDATA_OFFSET UNITYSDK_OFFSET(0x13734190)
#define RPG_CLIENT_MULTIPATHAVATARDATA_GETAVATARPATHROW_OFFSET UNITYSDK_OFFSET(0x13734A90)
#define RPG_CLIENT_MULTIPATHAVATARDATA_GETCURRENTMULTIPATHAVATARTYPE_OFFSET UNITYSDK_OFFSET(0x13734150)
#define RPG_CLIENT_MULTIPATHAVATARDATA_GETEARLYUNLOCKMULTIPATHAVATARTYPES_OFFSET UNITYSDK_OFFSET(0x13734790)
#define RPG_CLIENT_MULTIPATHAVATARDATA_GET_BASEAVATARID_OFFSET UNITYSDK_OFFSET(0x13734CC0)
#define RPG_CLIENT_MULTIPATHAVATARDATA_HASMULTIAVATARPATH_OFFSET UNITYSDK_OFFSET(0x13734C30)
#define RPG_CLIENT_MULTIPATHAVATARDATA_SETCURRENTMULTIPATHAVATARTYPE_OFFSET UNITYSDK_OFFSET(0x137340C0)
#define RPG_CLIENT_MULTIPATHAVATARDATA_SYNC_OFFSET UNITYSDK_OFFSET(0x137337A0)
#define RPG_CLIENT_MULTIPATHAVATARDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x13733430)
#define RPG_CLIENT_MULTIPATHAVATARDATA__UPDATEALLAVATARPATHDATA_OFFSET UNITYSDK_OFFSET(0x137339D0)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Collections::Generic::List_1<::Enum_3_DFCB42601400F441>* _AllMultiPathAvatarTypes; // 0x28
		::System::Collections::Generic::Dictionary_2<::Enum_3_DFCB42601400F441, ::RPG::Client::AvatarPathRowWrapper*>* _AvatarPathRowDict; // 0x30
		::Enum_3_DFCB42601400F441 _CurrentAvatarType; // 0x38
		::System::UInt32 _BaseAvatarID; // 0x3C
		...
		::System::Void Sync(::Class_1_BB4B99DE4C2501EC_3* baseData, ::System::Span_1<::Class_1_F3CA30716D4FAF92_3*> uniqueDataSpan)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_BB4B99DE4C2501EC_3*, ::System::Span_1<::Class_1_F3CA30716D4FAF92_3*>))((::PBYTE)hIl2Cpp + RPG_CLIENT_MULTIPATHAVATARDATA_SYNC_OFFSET))(this, baseData, uniqueDataSpan);
		}
