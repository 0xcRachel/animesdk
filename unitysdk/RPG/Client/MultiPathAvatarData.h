...
#define RPG_CLIENT_MULTIPATHAVATARDATA_CANCHANGETOSPECIFICAVATARPATH_OFFSET UNITYSDK_OFFSET(0x98CF770)
#define RPG_CLIENT_MULTIPATHAVATARDATA_DELETEOTHERGENDERAVATARPATHDATA_OFFSET UNITYSDK_OFFSET(0x98CE950)
#define RPG_CLIENT_MULTIPATHAVATARDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x98CE320)
#define RPG_CLIENT_MULTIPATHAVATARDATA_GETALLAVAILABLEMULTIPATHAVATARTYPE_OFFSET UNITYSDK_OFFSET(0x98CF250)
#define RPG_CLIENT_MULTIPATHAVATARDATA_GETALLAVATARPATHDATA_OFFSET UNITYSDK_OFFSET(0x98CEED0)
#define RPG_CLIENT_MULTIPATHAVATARDATA_GETALLMULTIPATHAVATARTYPE_OFFSET UNITYSDK_OFFSET(0x98CEF30)
#define RPG_CLIENT_MULTIPATHAVATARDATA_GETAVATARPATHDATA_OFFSET UNITYSDK_OFFSET(0x98CEE10)
#define RPG_CLIENT_MULTIPATHAVATARDATA_GETAVATARPATHROW_OFFSET UNITYSDK_OFFSET(0x98CF6B0)
#define RPG_CLIENT_MULTIPATHAVATARDATA_GETCURRENTMULTIPATHAVATARTYPE_OFFSET UNITYSDK_OFFSET(0x98CEDD0)
#define RPG_CLIENT_MULTIPATHAVATARDATA_GETEARLYUNLOCKMULTIPATHAVATARTYPES_OFFSET UNITYSDK_OFFSET(0x98CF3B0)
#define RPG_CLIENT_MULTIPATHAVATARDATA_GET_BASEAVATARID_OFFSET UNITYSDK_OFFSET(0x98CF8E0)
#define RPG_CLIENT_MULTIPATHAVATARDATA_HASMULTIAVATARPATH_OFFSET UNITYSDK_OFFSET(0x98CF850)
#define RPG_CLIENT_MULTIPATHAVATARDATA_SETCURRENTMULTIPATHAVATARTYPE_OFFSET UNITYSDK_OFFSET(0x98CED20)
#define RPG_CLIENT_MULTIPATHAVATARDATA_SYNC_OFFSET UNITYSDK_OFFSET(0x98CE430)
#define RPG_CLIENT_MULTIPATHAVATARDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x98CE0C0)
#define RPG_CLIENT_MULTIPATHAVATARDATA__UPDATEALLAVATARPATHDATA_OFFSET UNITYSDK_OFFSET(0x98CE660)

namespace RPG::Client
{
	inline static constexpr unsigned int MultiPathAvatarData_TypeDefinitionIndex = 52781;

	class MultiPathAvatarData : public ::System::Object
	{
	public:
		// static const ::System::UInt32 HERO_BASE_AVATAR_ID = 0x1F41; // 0x0
		::System::Collections::Generic::List_1<::RPG::Client::AvatarPathData*>* _AllAvatarPathDatas; // 0x10
		::System::Collections::Generic::Dictionary_2<::Enum_3_DFCB42601400F441, ::RPG::Client::AvatarPathData*>* _AvatarPathDataDict; // 0x18
		::System::Collections::Generic::Dictionary_2<::Enum_3_DFCB42601400F441, ::RPG::Client::AvatarPathRowWrapper*>* _AvatarPathRowDict; // 0x20
		::System::Collections::Generic::List_1<::Enum_3_DFCB42601400F441>* _AllEarlyUnlockMultiPathAvatarTypes; // 0x28
		...
		::System::Void Sync(::Class_1_BB4B99DE4C2501EC_3* baseData, ::System::Span_1<::Class_1_F3CA30716D4FAF92_2*> uniqueDataSpan)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_BB4B99DE4C2501EC_3*, ::System::Span_1<::Class_1_F3CA30716D4FAF92_2*>))((::PBYTE)hIl2Cpp + RPG_CLIENT_MULTIPATHAVATARDATA_SYNC_OFFSET))(this, baseData, uniqueDataSpan);
		}
