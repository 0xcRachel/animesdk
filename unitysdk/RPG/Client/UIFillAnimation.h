...
#define RPG_CLIENT_UIFILLANIMATION_GET_CURFILLAMOUNT_OFFSET UNITYSDK_OFFSET(0x12F12570)
#define RPG_CLIENT_UIFILLANIMATION_GET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0x12F12560)
#define RPG_CLIENT_UIFILLANIMATION_PLAY_1_OFFSET UNITYSDK_OFFSET(0x12F12430)
#define RPG_CLIENT_UIFILLANIMATION_PLAY_OFFSET UNITYSDK_OFFSET(0x12F123D0)
#define RPG_CLIENT_UIFILLANIMATION_START_OFFSET UNITYSDK_OFFSET(0x12F12040)
#define RPG_CLIENT_UIFILLANIMATION_STOP_OFFSET UNITYSDK_OFFSET(0x12F124D0)
#define RPG_CLIENT_UIFILLANIMATION_UPDATE_OFFSET UNITYSDK_OFFSET(0x12F12170)
#define RPG_CLIENT_UIFILLANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x12F12580)
#define RPG_CLIENT_UIFILLANIMATION__SETUPCMPTVALUE_OFFSET UNITYSDK_OFFSET(0x12F12350)
