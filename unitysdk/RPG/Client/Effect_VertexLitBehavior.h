...
#define RPG_CLIENT_EFFECT_VERTEXLITBEHAVIOR_GET__OWNER_OFFSET UNITYSDK_OFFSET(0x15F4D510)
#define RPG_CLIENT_EFFECT_VERTEXLITBEHAVIOR_LATETICK_OFFSET UNITYSDK_OFFSET(0x15F4BB70)
#define RPG_CLIENT_EFFECT_VERTEXLITBEHAVIOR_METHOD_3_2B9D478141E0F891_OFFSET UNITYSDK_OFFSET(0x15F4B7C0)
#define RPG_CLIENT_EFFECT_VERTEXLITBEHAVIOR_METHOD_3_40EBA7013E4CCDDF_1_OFFSET UNITYSDK_OFFSET(0x15F4D4C0)
#define RPG_CLIENT_EFFECT_VERTEXLITBEHAVIOR_METHOD_3_40EBA7013E4CCDDF_OFFSET UNITYSDK_OFFSET(0x15F4AEC0)
#define RPG_CLIENT_EFFECT_VERTEXLITBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x15F4BA50)
#define RPG_CLIENT_EFFECT_VERTEXLITBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0x15F4BAB0)
#define RPG_CLIENT_EFFECT_VERTEXLITBEHAVIOR_METHOD_3_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0x15F4BB10)
#define RPG_CLIENT_EFFECT_VERTEXLITBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x15F4AE60)
#define RPG_CLIENT_EFFECT_VERTEXLITBEHAVIOR_METHOD_3_489E0B827662C211_1_OFFSET UNITYSDK_OFFSET(0x15F4BBD0)
#define RPG_CLIENT_EFFECT_VERTEXLITBEHAVIOR_METHOD_3_489E0B827662C211_OFFSET UNITYSDK_OFFSET(0x15F4AF10)
#define RPG_CLIENT_EFFECT_VERTEXLITBEHAVIOR_METHOD_3_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0x15F4D620)
#define RPG_CLIENT_EFFECT_VERTEXLITBEHAVIOR_METHOD_3_5790A55946AA509D_2_OFFSET UNITYSDK_OFFSET(0x15F4D680)
#define RPG_CLIENT_EFFECT_VERTEXLITBEHAVIOR_METHOD_3_5790A55946AA509D_3_OFFSET UNITYSDK_OFFSET(0x15F4D6E0)
#define RPG_CLIENT_EFFECT_VERTEXLITBEHAVIOR_METHOD_3_5790A55946AA509D_4_OFFSET UNITYSDK_OFFSET(0x15F4D740)
#define RPG_CLIENT_EFFECT_VERTEXLITBEHAVIOR_METHOD_3_5790A55946AA509D_5_OFFSET UNITYSDK_OFFSET(0x15F4D7B0)
#define RPG_CLIENT_EFFECT_VERTEXLITBEHAVIOR_METHOD_3_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x15F4D5C0)
#define RPG_CLIENT_EFFECT_VERTEXLITBEHAVIOR_METHOD_3_7A150941533E8F96_OFFSET UNITYSDK_OFFSET(0x15F4B770)
#define RPG_CLIENT_EFFECT_VERTEXLITBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x15F4D560)
#define RPG_CLIENT_EFFECT_VERTEXLITBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x15F4D550)
#define RPG_CLIENT_EFFECT_VERTEXLITBEHAVIOR___IFIXBASEPROXY_LATETICK_OFFSET UNITYSDK_OFFSET(0x15F4D820)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Effect_VertexLitBehavior_TypeDefinitionIndex)->GetStaticField(0x16E0);
		}
		static ::System::Int32* StaticGet__SceneLightColorColorShaderProperty()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Effect_VertexLitBehavior_TypeDefinitionIndex)->GetStaticField(0x16E4);
		}
		static ::System::Int32* StaticGet__PointLightPosRangesShaderProperty()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Effect_VertexLitBehavior_TypeDefinitionIndex)->GetStaticField(0x16E8);
		}
		static ::System::Int32* StaticGet__PointLightColorsShaderProperty()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Effect_VertexLitBehavior_TypeDefinitionIndex)->GetStaticField(0x16EC);
		}
