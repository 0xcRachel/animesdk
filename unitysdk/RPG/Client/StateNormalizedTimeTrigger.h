...
#define RPG_CLIENT_STATENORMALIZEDTIMETRIGGER_AWAKE_OFFSET UNITYSDK_OFFSET(0x9FC3530)
#define RPG_CLIENT_STATENORMALIZEDTIMETRIGGER_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x9FC35A0)
#define RPG_CLIENT_STATENORMALIZEDTIMETRIGGER_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9FC3620)
#define RPG_CLIENT_STATENORMALIZEDTIMETRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x9FC3700)
#define RPG_CLIENT_STATENORMALIZEDTIMETRIGGER___IFIXBASEPROXY_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x9FC3710)
#define RPG_CLIENT_STATENORMALIZEDTIMETRIGGER___IFIXBASEPROXY_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9FC3720)

namespace RPG::Client
{
	inline static constexpr unsigned int StateNormalizedTimeTrigger_TypeDefinitionIndex = 54669;
