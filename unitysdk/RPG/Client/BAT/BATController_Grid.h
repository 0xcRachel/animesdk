...
#define RPG_CLIENT_BAT_BATCONTROLLER_GRID_GET_MODE_OFFSET UNITYSDK_OFFSET(0x9170320)
#define RPG_CLIENT_BAT_BATCONTROLLER_GRID_GET__GRIDCOUNT_OFFSET UNITYSDK_OFFSET(0x91703A0)
#define RPG_CLIENT_BAT_BATCONTROLLER_GRID_METHOD_2_A2172401030892FD_OFFSET UNITYSDK_OFFSET(0x91705F0)
#define RPG_CLIENT_BAT_BATCONTROLLER_GRID_METHOD_2_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x9170F00)
#define RPG_CLIENT_BAT_BATCONTROLLER_GRID_METHOD_2_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x9170F40)
#define RPG_CLIENT_BAT_BATCONTROLLER_GRID_METHOD_2_CA373AA1C7054598_3_OFFSET UNITYSDK_OFFSET(0x9170F80)
#define RPG_CLIENT_BAT_BATCONTROLLER_GRID_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x9170DB0)
#define RPG_CLIENT_BAT_BATCONTROLLER_GRID_METHOD_2_F4C8B018D655630D_OFFSET UNITYSDK_OFFSET(0x91703F0)
#define RPG_CLIENT_BAT_BATCONTROLLER_GRID__CTOR_OFFSET UNITYSDK_OFFSET(0x9170E00)
#define RPG_CLIENT_BAT_BATCONTROLLER_GRID___IFIXBASEPROXY_GET_MODE_OFFSET UNITYSDK_OFFSET(0x9170EF0)

namespace RPG::Client::BAT
{
	inline static constexpr unsigned int BATController_Grid_TypeDefinitionIndex = 60382;
