...
#define RPG_CLIENT_TILTCOMMONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA082C60)

namespace RPG::Client
{
	inline static constexpr unsigned int TiltCommonConfig_TypeDefinitionIndex = 47584;
