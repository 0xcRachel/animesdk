...
#define RPG_CLIENT_AVATARTEAMEDITLACKEQUIPTOASTERVIEWMODEL___C__DISPLAYCLASS7_0__CTOR_OFFSET UNITYSDK_OFFSET(0x179F6770)
#define RPG_CLIENT_AVATARTEAMEDITLACKEQUIPTOASTERVIEWMODEL___C__DISPLAYCLASS7_0__REFRESHANDTRYTOAST_B__0_OFFSET UNITYSDK_OFFSET(0x179F6780)
#define RPG_CLIENT_AVATARTEAMEDITLACKEQUIPTOASTERVIEWMODEL___C__DISPLAYCLASS7_0__REFRESHANDTRYTOAST_B__1_OFFSET UNITYSDK_OFFSET(0x179F67E0)
...
namespace RPG::Client
{
	...
	{
	public:
		::RPG::Client::AvatarTeamEditLackEquipToasterViewModel* __4__this; // 0x10
		::System::Collections::Generic::HashSet_1<::RPG::AvatarSystem::IAvatar*>* newAvatars; // 0x18
