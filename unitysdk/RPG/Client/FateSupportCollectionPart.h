...
#define RPG_CLIENT_FATESUPPORTCOLLECTIONPART_GETGAMEPLAYACTIVITYPANELDATA_OFFSET UNITYSDK_OFFSET(0x178FE280)
#define RPG_CLIENT_FATESUPPORTCOLLECTIONPART_GET_COLLECTIONACTIVITYID_OFFSET UNITYSDK_OFFSET(0x17927600)
#define RPG_CLIENT_FATESUPPORTCOLLECTIONPART_GET_GAMEPLAYACTIVITYID_OFFSET UNITYSDK_OFFSET(0x179275F0)
#define RPG_CLIENT_FATESUPPORTCOLLECTIONPART_GET_MISSIONCHRONICLEMAINPATHID_OFFSET UNITYSDK_OFFSET(0x179277D0)
#define RPG_CLIENT_FATESUPPORTCOLLECTIONPART_GET_MISSIONCONTENTID_OFFSET UNITYSDK_OFFSET(0x17927610)
#define RPG_CLIENT_FATESUPPORTCOLLECTIONPART_GET__GACHAREWARDQUESTID_OFFSET UNITYSDK_OFFSET(0x179276C0)
#define RPG_CLIENT_FATESUPPORTCOLLECTIONPART_HASGACHAREWARD_OFFSET UNITYSDK_OFFSET(0x178FE430)
#define RPG_CLIENT_FATESUPPORTCOLLECTIONPART_ISMAINMISSIONFINISHED_OFFSET UNITYSDK_OFFSET(0x179279A0)
#define RPG_CLIENT_FATESUPPORTCOLLECTIONPART_ONLOGINFINISH_OFFSET UNITYSDK_OFFSET(0x179278B0)
#define RPG_CLIENT_FATESUPPORTCOLLECTIONPART__CTOR_OFFSET UNITYSDK_OFFSET(0x17927A90)
