...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPOVERRIDELIGHT_INIT_OFFSET UNITYSDK_OFFSET(0x97E57C0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPOVERRIDELIGHT_UNINIT_OFFSET UNITYSDK_OFFSET(0x97E5820)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPOVERRIDELIGHT_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x97E5870)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPOVERRIDELIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x97E5940)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPOVERRIDELIGHT___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x97E59A0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPOVERRIDELIGHT___IFIXBASEPROXY_UNINIT_OFFSET UNITYSDK_OFFSET(0x97E59B0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropOverrideLight_TypeDefinitionIndex = 55685;
