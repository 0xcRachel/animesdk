...
#define RPG_CLIENT_EFFECT_FALLINGANIMATOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13FF27B0)
#define RPG_CLIENT_EFFECT_FALLINGANIMATOR_INIT_OFFSET UNITYSDK_OFFSET(0x13FF1DC0)
#define RPG_CLIENT_EFFECT_FALLINGANIMATOR_METHOD_5_356114EF3CF36D59_OFFSET UNITYSDK_OFFSET(0x13FF38D0)
#define RPG_CLIENT_EFFECT_FALLINGANIMATOR_METHOD_5_4CD934F1AB922E45_OFFSET UNITYSDK_OFFSET(0x13FF3010)
#define RPG_CLIENT_EFFECT_FALLINGANIMATOR_METHOD_5_77FD543600E00498_1_OFFSET UNITYSDK_OFFSET(0x13FF2420)
#define RPG_CLIENT_EFFECT_FALLINGANIMATOR_METHOD_5_77FD543600E00498_2_OFFSET UNITYSDK_OFFSET(0x13FF2670)
#define RPG_CLIENT_EFFECT_FALLINGANIMATOR_METHOD_5_77FD543600E00498_OFFSET UNITYSDK_OFFSET(0x13FF2380)
#define RPG_CLIENT_EFFECT_FALLINGANIMATOR_METHOD_5_FA7F07669215B524_OFFSET UNITYSDK_OFFSET(0x13FF25E0)
#define RPG_CLIENT_EFFECT_FALLINGANIMATOR_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x13FF2760)
#define RPG_CLIENT_EFFECT_FALLINGANIMATOR_ONENABLE_OFFSET UNITYSDK_OFFSET(0x13FF2710)
#define RPG_CLIENT_EFFECT_FALLINGANIMATOR_REGENERATE_OFFSET UNITYSDK_OFFSET(0x13FF1D70)
#define RPG_CLIENT_EFFECT_FALLINGANIMATOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x13FF28B0)
#define RPG_CLIENT_EFFECT_FALLINGANIMATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x13FF3AC0)
