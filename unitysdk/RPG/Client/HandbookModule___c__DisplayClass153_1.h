...
#define RPG_CLIENT_HANDBOOKMODULE___C__DISPLAYCLASS153_1__CTOR_OFFSET UNITYSDK_OFFSET(0x949AFF0)
#define RPG_CLIENT_HANDBOOKMODULE___C__DISPLAYCLASS153_1__GOTOTOGUIDEROGUETOURNENTRANCE_B__1_OFFSET UNITYSDK_OFFSET(0x949B000)

namespace RPG::Client
{
	inline static constexpr unsigned int HandbookModule___c__DisplayClass153_1_TypeDefinitionIndex = 52163;
