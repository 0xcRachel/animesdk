...
#define RPG_CLIENT_UIUTILS___C__DISPLAYCLASS67_0__CREATEBLOCKER_B__0_OFFSET UNITYSDK_OFFSET(0x14BA4E60)
#define RPG_CLIENT_UIUTILS___C__DISPLAYCLASS67_0__CTOR_OFFSET UNITYSDK_OFFSET(0x14BA4AB0)

namespace RPG::Client
{
	inline static constexpr unsigned int UIUtils___c__DisplayClass67_0_TypeDefinitionIndex = 68349;
