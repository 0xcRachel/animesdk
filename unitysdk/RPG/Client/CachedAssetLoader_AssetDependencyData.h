...
#define RPG_CLIENT_CACHEDASSETLOADER_ASSETDEPENDENCYDATA_CLEAR_OFFSET UNITYSDK_OFFSET(0x15FC1AB0)
#define RPG_CLIENT_CACHEDASSETLOADER_ASSETDEPENDENCYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x15FC1B10)
...
namespace RPG::Client
{
	...
	public:
		...
		::RPG::Client::CachedAssetLogicType OwnerLogicType; // 0x20
