...
#define RPG_CLIENT_CACHEDASSETLOADER_ASSETDEPENDENCYDATA_CLEAR_OFFSET UNITYSDK_OFFSET(0x182E5B50)
#define RPG_CLIENT_CACHEDASSETLOADER_ASSETDEPENDENCYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x182E5BA0)
...
namespace RPG::Client
{
	...
	public:
		...
		::RPG::Client::CachedAssetLogicType OwnerLogicType; // 0x14
