...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Func_1<::RPG::GameCore::FixEnumerator_2<::RPG::GameCore::CommonIndexKey, ::RPG::GameCore::ItemComefromRow*>>**)Il2CppClass::FromTypeDefinitionIndex(InventoryModule___O_TypeDefinitionIndex)->GetStaticField(0x3C0D0);
		}
	};
}
