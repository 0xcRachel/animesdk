...
#define RPG_CLIENT_RAIDBATTLESCORINGRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x9D5F2F0)

namespace RPG::Client
{
	inline static constexpr unsigned int RaidBattleScoringResult_TypeDefinitionIndex = 53186;
