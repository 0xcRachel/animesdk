...
#define RPG_CLIENT_MATCHTHREEV2CHANGEPROPCONTAINERVISIBLE_METHOD_3_0CE87EFF075956C4_OFFSET UNITYSDK_OFFSET(0x1676AD50)
#define RPG_CLIENT_MATCHTHREEV2CHANGEPROPCONTAINERVISIBLE_METHOD_3_F3278A475339E135_OFFSET UNITYSDK_OFFSET(0x1676ADD0)
#define RPG_CLIENT_MATCHTHREEV2CHANGEPROPCONTAINERVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1676ADA0)
