...
#define RPG_CLIENT_ATTACHPOINTOVERRIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x8C9E180)

namespace RPG::Client
{
	inline static constexpr unsigned int AttachPointOverride_TypeDefinitionIndex = 54239;
