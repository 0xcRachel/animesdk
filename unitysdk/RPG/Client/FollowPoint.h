...
#define RPG_CLIENT_FOLLOWPOINT_GET_ISFOLLOWDYNAMIC_OFFSET UNITYSDK_OFFSET(0x929FAB0)
#define RPG_CLIENT_FOLLOWPOINT_GET_ISPOINTDYNAMIC_OFFSET UNITYSDK_OFFSET(0x929F9E0)
#define RPG_CLIENT_FOLLOWPOINT_METHOD_1_18D9238B9C310BFF_OFFSET UNITYSDK_OFFSET(0x929F410)
#define RPG_CLIENT_FOLLOWPOINT_METHOD_1_25DEA5C65A602671_OFFSET UNITYSDK_OFFSET(0x929F2B0)
#define RPG_CLIENT_FOLLOWPOINT_METHOD_1_B768DA94E3FD91D9_OFFSET UNITYSDK_OFFSET(0x929F530)
#define RPG_CLIENT_FOLLOWPOINT_METHOD_1_D83D54151A7C7525_OFFSET UNITYSDK_OFFSET(0x929F1A0)
#define RPG_CLIENT_FOLLOWPOINT_METHOD_1_FC26FA0DD9B4AAF4_OFFSET UNITYSDK_OFFSET(0x929F930)
#define RPG_CLIENT_FOLLOWPOINT_SET_ISFOLLOWDYNAMIC_OFFSET UNITYSDK_OFFSET(0x929FB10)
#define RPG_CLIENT_FOLLOWPOINT_SET_ISPOINTDYNAMIC_OFFSET UNITYSDK_OFFSET(0x929FA40)
#define RPG_CLIENT_FOLLOWPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x929FB80)

namespace RPG::Client
{
	inline static constexpr unsigned int FollowPoint_TypeDefinitionIndex = 54299;
