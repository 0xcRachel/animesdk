...
#define RPG_CLIENT_CHECKITEMFINISHQUEST_FILLNOTIFYTYPESTO_OFFSET UNITYSDK_OFFSET(0x8EC36F0)
#define RPG_CLIENT_CHECKITEMFINISHQUEST_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8EC3830)
#define RPG_CLIENT_CHECKITEMFINISHQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x8EC36D0)
#define RPG_CLIENT_CHECKITEMFINISHQUEST__DOCHECKIMPL_OFFSET UNITYSDK_OFFSET(0x8EC3780)
#define RPG_CLIENT_CHECKITEMFINISHQUEST___IFIXBASEPROXY_FILLNOTIFYTYPESTO_OFFSET UNITYSDK_OFFSET(0x8EC38E0)
#define RPG_CLIENT_CHECKITEMFINISHQUEST___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8EC39C0)
#define RPG_CLIENT_CHECKITEMFINISHQUEST___IFIXBASEPROXY__DOCHECKIMPL_OFFSET UNITYSDK_OFFSET(0x8EC3950)

namespace RPG::Client
{
	inline static constexpr unsigned int CheckItemFinishQuest_TypeDefinitionIndex = 47416;
