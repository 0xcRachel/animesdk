...
#define RPG_CLIENT_AUILINECTRL_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x159A5A10)
#define RPG_CLIENT_AUILINECTRL_FRESHLINE_OFFSET UNITYSDK_OFFSET(0x159A57D0)
#define RPG_CLIENT_AUILINECTRL_GET_ANIMOD_OFFSET UNITYSDK_OFFSET(0x159A5720)
#define RPG_CLIENT_AUILINECTRL_GET_CURRENTLEVEL_OFFSET UNITYSDK_OFFSET(0x159A56B0)
#define RPG_CLIENT_AUILINECTRL_GET_LINERCOLOR_OFFSET UNITYSDK_OFFSET(0x159A5490)
#define RPG_CLIENT_AUILINECTRL_METHOD_5_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x159A5C60)
#define RPG_CLIENT_AUILINECTRL_METHOD_5_35942D7A8A374AB0_OFFSET UNITYSDK_OFFSET(0x159A5A60)
#define RPG_CLIENT_AUILINECTRL_SET_ANIMOD_OFFSET UNITYSDK_OFFSET(0x159A5730)
#define RPG_CLIENT_AUILINECTRL_SET_CURRENTLEVEL_OFFSET UNITYSDK_OFFSET(0x159A56C0)
#define RPG_CLIENT_AUILINECTRL_SET_LINERCOLOR_OFFSET UNITYSDK_OFFSET(0x159A54A0)
#define RPG_CLIENT_AUILINECTRL_START_OFFSET UNITYSDK_OFFSET(0x159A5780)
#define RPG_CLIENT_AUILINECTRL__CTOR_OFFSET UNITYSDK_OFFSET(0x159A5DD0)

namespace RPG::Client
{
	inline static constexpr unsigned int AUiLineCtrl_TypeDefinitionIndex = 66796;
