...
#define RPG_CLIENT_OVERRIDELIGHTMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x9A25680)

namespace RPG::Client
{
	inline static constexpr unsigned int OverrideLightMonoPlugin_TypeDefinitionIndex = 55975;
