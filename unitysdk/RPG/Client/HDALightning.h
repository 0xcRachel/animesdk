...
#define RPG_CLIENT_HDALIGHTNING_AWAKE_OFFSET UNITYSDK_OFFSET(0x947AB30)
#define RPG_CLIENT_HDALIGHTNING_LATETICK_OFFSET UNITYSDK_OFFSET(0x947AD30)
#define RPG_CLIENT_HDALIGHTNING_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x947ACA0)
#define RPG_CLIENT_HDALIGHTNING_ONENABLE_OFFSET UNITYSDK_OFFSET(0x947AC10)
#define RPG_CLIENT_HDALIGHTNING__CTOR_OFFSET UNITYSDK_OFFSET(0x947AF80)

namespace RPG::Client
{
	inline static constexpr unsigned int HDALightning_TypeDefinitionIndex = 56249;
