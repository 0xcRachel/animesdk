...
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x183A5F00)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_BRANCHLIMITATIONS_OFFSET UNITYSDK_OFFSET(0x183A6F60)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_DESCPARAM_OFFSET UNITYSDK_OFFSET(0x183A87D0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_DICEACTIVESTAGE_OFFSET UNITYSDK_OFFSET(0x183A89B0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_EXTRADESC_OFFSET UNITYSDK_OFFSET(0x183A8AF0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_ICON_OFFSET UNITYSDK_OFFSET(0x183A8030)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_ISFIRSTTIMEUNLOCK_OFFSET UNITYSDK_OFFSET(0x183A8D50)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0x183A85F0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_ITEMID_OFFSET UNITYSDK_OFFSET(0x183A7340)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_RARITY_OFFSET UNITYSDK_OFFSET(0x183A8870)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_SLOTLIST_OFFSET UNITYSDK_OFFSET(0x183A8910)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_SORT_OFFSET UNITYSDK_OFFSET(0x183A8A50)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_SURFACEDESC_OFFSET UNITYSDK_OFFSET(0x183A86F0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_SURFACEID_OFFSET UNITYSDK_OFFSET(0x183A85D0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_SURFACENAME_OFFSET UNITYSDK_OFFSET(0x183A8610)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_TAGLIST_OFFSET UNITYSDK_OFFSET(0x183A8B90)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_UNLOCKCONDITION_OFFSET UNITYSDK_OFFSET(0x183A8C30)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0x183A8570)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_SET_ISFIRSTTIMEUNLOCK_OFFSET UNITYSDK_OFFSET(0x183A8D60)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_SET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0x183A8600)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_SET_SURFACEID_OFFSET UNITYSDK_OFFSET(0x183A85E0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_SYNCUNLOCKEDSTATUS_OFFSET UNITYSDK_OFFSET(0x183A65C0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_UPDATENEWSTATUS_OFFSET UNITYSDK_OFFSET(0x183A8490)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x183A7330)
