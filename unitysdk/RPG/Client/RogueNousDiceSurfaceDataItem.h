...
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9E36E10)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_BRANCHLIMITATIONS_OFFSET UNITYSDK_OFFSET(0x9E37E60)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_DESCPARAM_OFFSET UNITYSDK_OFFSET(0x9E39580)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_DICEACTIVESTAGE_OFFSET UNITYSDK_OFFSET(0x9E39760)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_EXTRADESC_OFFSET UNITYSDK_OFFSET(0x9E398A0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_ICON_OFFSET UNITYSDK_OFFSET(0x9E38E20)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_ISFIRSTTIMEUNLOCK_OFFSET UNITYSDK_OFFSET(0x9E39B00)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0x9E393C0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_ITEMID_OFFSET UNITYSDK_OFFSET(0x9E380C0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_RARITY_OFFSET UNITYSDK_OFFSET(0x9E39620)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_SLOTLIST_OFFSET UNITYSDK_OFFSET(0x9E396C0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_SORT_OFFSET UNITYSDK_OFFSET(0x9E39800)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_SURFACEDESC_OFFSET UNITYSDK_OFFSET(0x9E394B0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_SURFACEID_OFFSET UNITYSDK_OFFSET(0x9E393A0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_SURFACENAME_OFFSET UNITYSDK_OFFSET(0x9E393E0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_TAGLIST_OFFSET UNITYSDK_OFFSET(0x9E39940)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_UNLOCKCONDITION_OFFSET UNITYSDK_OFFSET(0x9E399E0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0x9E39340)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_SET_ISFIRSTTIMEUNLOCK_OFFSET UNITYSDK_OFFSET(0x9E39B10)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_SET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0x9E393D0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_SET_SURFACEID_OFFSET UNITYSDK_OFFSET(0x9E393B0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_SYNCUNLOCKEDSTATUS_OFFSET UNITYSDK_OFFSET(0x9E37570)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_UPDATENEWSTATUS_OFFSET UNITYSDK_OFFSET(0x9E39260)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9E380B0)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueNousDiceSurfaceDataItem_TypeDefinitionIndex = 53333;
