...
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA359280)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_BRANCHLIMITATIONS_OFFSET UNITYSDK_OFFSET(0xA35A2D0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_DESCPARAM_OFFSET UNITYSDK_OFFSET(0xA35BA30)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_DICEACTIVESTAGE_OFFSET UNITYSDK_OFFSET(0xA35BC10)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_EXTRADESC_OFFSET UNITYSDK_OFFSET(0xA35BD50)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_ICON_OFFSET UNITYSDK_OFFSET(0xA35B2D0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_ISFIRSTTIMEUNLOCK_OFFSET UNITYSDK_OFFSET(0xA35BFB0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xA35B870)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_ITEMID_OFFSET UNITYSDK_OFFSET(0xA35A550)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_RARITY_OFFSET UNITYSDK_OFFSET(0xA35BAD0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_SLOTLIST_OFFSET UNITYSDK_OFFSET(0xA35BB70)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_SORT_OFFSET UNITYSDK_OFFSET(0xA35BCB0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_SURFACEDESC_OFFSET UNITYSDK_OFFSET(0xA35B960)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_SURFACEID_OFFSET UNITYSDK_OFFSET(0xA35B850)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_SURFACENAME_OFFSET UNITYSDK_OFFSET(0xA35B890)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_TAGLIST_OFFSET UNITYSDK_OFFSET(0xA35BDF0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_UNLOCKCONDITION_OFFSET UNITYSDK_OFFSET(0xA35BE90)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0xA35B7F0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_SET_ISFIRSTTIMEUNLOCK_OFFSET UNITYSDK_OFFSET(0xA35BFC0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_SET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xA35B880)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_SET_SURFACEID_OFFSET UNITYSDK_OFFSET(0xA35B860)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_SYNCUNLOCKEDSTATUS_OFFSET UNITYSDK_OFFSET(0xA3599E0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_UPDATENEWSTATUS_OFFSET UNITYSDK_OFFSET(0xA35B710)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xA35A540)
