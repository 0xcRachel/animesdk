...
#define RPG_CLIENT_PLANETFESALLLANDINCOMEWITHFESLEVELBUFF_COMBINE_OFFSET UNITYSDK_OFFSET(0x9AB5380)
#define RPG_CLIENT_PLANETFESALLLANDINCOMEWITHFESLEVELBUFF_GETCOMBINEKEY_OFFSET UNITYSDK_OFFSET(0x9AB54C0)
#define RPG_CLIENT_PLANETFESALLLANDINCOMEWITHFESLEVELBUFF_GET_PERCENTINCREASE_OFFSET UNITYSDK_OFFSET(0x9AB51C0)
#define RPG_CLIENT_PLANETFESALLLANDINCOMEWITHFESLEVELBUFF_ISEFFECTIVEONAVATAR_OFFSET UNITYSDK_OFFSET(0x9AB52F0)
#define RPG_CLIENT_PLANETFESALLLANDINCOMEWITHFESLEVELBUFF_ISTRIGGERED_OFFSET UNITYSDK_OFFSET(0x9AB5340)
#define RPG_CLIENT_PLANETFESALLLANDINCOMEWITHFESLEVELBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x9AB5520)
#define RPG_CLIENT_PLANETFESALLLANDINCOMEWITHFESLEVELBUFF__ONINITPARAM_OFFSET UNITYSDK_OFFSET(0x9AB5280)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesAllLandIncomeWithFesLevelBuff_TypeDefinitionIndex = 52994;
	...
	public:
		...
		{
			return ((::Class_0_16E4307DCC419505_639*(*)(::PVOID, ::RPG::Client::IPlanetFesBuff*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PLANETFESALLLANDINCOMEWITHFESLEVELBUFF_COMBINE_OFFSET))(this, other);
		}
