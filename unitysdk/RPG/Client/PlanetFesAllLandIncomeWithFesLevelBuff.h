...
#define RPG_CLIENT_PLANETFESALLLANDINCOMEWITHFESLEVELBUFF_COMBINE_OFFSET UNITYSDK_OFFSET(0xF6E65C0)
#define RPG_CLIENT_PLANETFESALLLANDINCOMEWITHFESLEVELBUFF_GETCOMBINEKEY_OFFSET UNITYSDK_OFFSET(0xF6E6700)
#define RPG_CLIENT_PLANETFESALLLANDINCOMEWITHFESLEVELBUFF_GET_PERCENTINCREASE_OFFSET UNITYSDK_OFFSET(0xF6E6400)
#define RPG_CLIENT_PLANETFESALLLANDINCOMEWITHFESLEVELBUFF_ISEFFECTIVEONAVATAR_OFFSET UNITYSDK_OFFSET(0xF6E6530)
#define RPG_CLIENT_PLANETFESALLLANDINCOMEWITHFESLEVELBUFF_ISTRIGGERED_OFFSET UNITYSDK_OFFSET(0xF6E6580)
#define RPG_CLIENT_PLANETFESALLLANDINCOMEWITHFESLEVELBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0xF6E6760)
#define RPG_CLIENT_PLANETFESALLLANDINCOMEWITHFESLEVELBUFF__ONINITPARAM_OFFSET UNITYSDK_OFFSET(0xF6E64C0)
