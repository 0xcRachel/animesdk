...
#define RPG_CLIENT_GRIDFIGHTGAMESESSION___C__DISPLAYCLASS40_0__COMPAREWITHCURTEAM_B__4_OFFSET UNITYSDK_OFFSET(0x9850DA0)
#define RPG_CLIENT_GRIDFIGHTGAMESESSION___C__DISPLAYCLASS40_0__COMPAREWITHCURTEAM_B__5_OFFSET UNITYSDK_OFFSET(0x9850DC0)
#define RPG_CLIENT_GRIDFIGHTGAMESESSION___C__DISPLAYCLASS40_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9850D90)
