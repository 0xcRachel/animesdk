...
#define RPG_CLIENT_GRIDFIGHTGAMESESSION___C__DISPLAYCLASS40_0__COMPAREWITHCURTEAM_B__4_OFFSET UNITYSDK_OFFSET(0x93948D0)
#define RPG_CLIENT_GRIDFIGHTGAMESESSION___C__DISPLAYCLASS40_0__COMPAREWITHCURTEAM_B__5_OFFSET UNITYSDK_OFFSET(0x93948F0)
#define RPG_CLIENT_GRIDFIGHTGAMESESSION___C__DISPLAYCLASS40_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9393A90)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightGameSession___c__DisplayClass40_0_TypeDefinitionIndex = 51530;
