...
#define RPG_CLIENT_COMPONENTASSETLOADER_CLASS_1_859AA148F8A71EF2_METHOD_1_A9824D5ECA42BAF4_OFFSET UNITYSDK_OFFSET(0x941F7C0)
#define RPG_CLIENT_COMPONENTASSETLOADER_CLASS_1_859AA148F8A71EF2_METHOD_1_FD15B3DA4E61B9D2_OFFSET UNITYSDK_OFFSET(0x941FD50)
#define RPG_CLIENT_COMPONENTASSETLOADER_CLASS_1_859AA148F8A71EF2__CCTOR_OFFSET UNITYSDK_OFFSET(0x941FE10)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::Il2CppArray<::RPG::Client::ComponentAssetLoader_Class_1_A733C3439371489B*>**)Il2CppClass::FromTypeDefinitionIndex(ComponentAssetLoader_Class_1_859AA148F8A71EF2_TypeDefinitionIndex)->GetStaticField(0x47BE0);
		}
