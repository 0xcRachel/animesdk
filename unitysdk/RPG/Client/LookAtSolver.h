...
#define RPG_CLIENT_LOOKATSOLVER_CLEAR_OFFSET UNITYSDK_OFFSET(0x9A6D6C0)
#define RPG_CLIENT_LOOKATSOLVER_GET_HEADIKROTATION_OFFSET UNITYSDK_OFFSET(0x9A766A0)
#define RPG_CLIENT_LOOKATSOLVER_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x9A6E790)
#define RPG_CLIENT_LOOKATSOLVER_GET_LOOKATTARGET_OFFSET UNITYSDK_OFFSET(0x9A766C0)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_52EADDA79E9EC21B_OFFSET UNITYSDK_OFFSET(0x9A758C0)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_6409EF8034A68A6B_OFFSET UNITYSDK_OFFSET(0x9A71EA0)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_6B72D4EE8C6E907F_OFFSET UNITYSDK_OFFSET(0x9A756C0)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_88BF69F2F98093D5_OFFSET UNITYSDK_OFFSET(0x9A74230)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_8CE0803574BB66D7_OFFSET UNITYSDK_OFFSET(0x9A76B50)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_9F100D0D149E9A73_OFFSET UNITYSDK_OFFSET(0x9A70C90)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_A116C8ED96BD8D99_OFFSET UNITYSDK_OFFSET(0x9A76120)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_B45333C63548FF10_OFFSET UNITYSDK_OFFSET(0x9A73E80)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_EC6B9B01A2C923AD_OFFSET UNITYSDK_OFFSET(0x9A76700)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_F27A64F8FEB174E3_OFFSET UNITYSDK_OFFSET(0x9A75D70)
#define RPG_CLIENT_LOOKATSOLVER_SET_LOOKATTARGET_OFFSET UNITYSDK_OFFSET(0x9A766E0)
#define RPG_CLIENT_LOOKATSOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x9A75110)
