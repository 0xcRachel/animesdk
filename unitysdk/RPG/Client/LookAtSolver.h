...
#define RPG_CLIENT_LOOKATSOLVER_CLEAR_OFFSET UNITYSDK_OFFSET(0x9592A30)
#define RPG_CLIENT_LOOKATSOLVER_GET_HEADIKROTATION_OFFSET UNITYSDK_OFFSET(0x959BDF0)
#define RPG_CLIENT_LOOKATSOLVER_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x9593B00)
#define RPG_CLIENT_LOOKATSOLVER_GET_LOOKATTARGET_OFFSET UNITYSDK_OFFSET(0x959BE10)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_52EADDA79E9EC21B_OFFSET UNITYSDK_OFFSET(0x959B010)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_6409EF8034A68A6B_OFFSET UNITYSDK_OFFSET(0x9597610)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_6B72D4EE8C6E907F_OFFSET UNITYSDK_OFFSET(0x959AE10)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_88BF69F2F98093D5_OFFSET UNITYSDK_OFFSET(0x95999A0)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_8CE0803574BB66D7_OFFSET UNITYSDK_OFFSET(0x959C2A0)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_9F100D0D149E9A73_OFFSET UNITYSDK_OFFSET(0x95961B0)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_A116C8ED96BD8D99_OFFSET UNITYSDK_OFFSET(0x959B870)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_B45333C63548FF10_OFFSET UNITYSDK_OFFSET(0x95995F0)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_EC6B9B01A2C923AD_OFFSET UNITYSDK_OFFSET(0x959BE50)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_F27A64F8FEB174E3_OFFSET UNITYSDK_OFFSET(0x959B4C0)
#define RPG_CLIENT_LOOKATSOLVER_SET_LOOKATTARGET_OFFSET UNITYSDK_OFFSET(0x959BE30)
#define RPG_CLIENT_LOOKATSOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x959A880)

namespace RPG::Client
{
	inline static constexpr unsigned int LookAtSolver_TypeDefinitionIndex = 54342;
