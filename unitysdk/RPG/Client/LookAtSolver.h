...
#define RPG_CLIENT_LOOKATSOLVER_CLEAR_OFFSET UNITYSDK_OFFSET(0x16942DA0)
#define RPG_CLIENT_LOOKATSOLVER_GET_HEADIKROTATION_OFFSET UNITYSDK_OFFSET(0x1694C150)
#define RPG_CLIENT_LOOKATSOLVER_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x16943E50)
#define RPG_CLIENT_LOOKATSOLVER_GET_LOOKATTARGET_OFFSET UNITYSDK_OFFSET(0x1694C170)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_6409EF8034A68A6B_OFFSET UNITYSDK_OFFSET(0x16947960)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_6B72D4EE8C6E907F_OFFSET UNITYSDK_OFFSET(0x1694B170)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_88BF69F2F98093D5_OFFSET UNITYSDK_OFFSET(0x16949CF0)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_8CE0803574BB66D7_OFFSET UNITYSDK_OFFSET(0x1694C600)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_9F100D0D149E9A73_OFFSET UNITYSDK_OFFSET(0x16946500)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_A116C8ED96BD8D99_OFFSET UNITYSDK_OFFSET(0x1694BBD0)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_B45333C63548FF10_OFFSET UNITYSDK_OFFSET(0x16949940)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_EC6B9B01A2C923AD_OFFSET UNITYSDK_OFFSET(0x1694C1B0)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_EF613104545B8E04_OFFSET UNITYSDK_OFFSET(0x1694B370)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_F27A64F8FEB174E3_OFFSET UNITYSDK_OFFSET(0x1694B840)
#define RPG_CLIENT_LOOKATSOLVER_SET_LOOKATTARGET_OFFSET UNITYSDK_OFFSET(0x1694C190)
#define RPG_CLIENT_LOOKATSOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1694ABD0)
