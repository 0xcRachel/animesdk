...
#define RPG_CLIENT_ASYNCCHECKITEMBASE___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0x8C9B940)
#define RPG_CLIENT_ASYNCCHECKITEMBASE___C__DISPLAYCLASS9_0__DOCHECKWITHPROMISE_B__0_OFFSET UNITYSDK_OFFSET(0x8C9BAE0)

namespace RPG::Client
{
	inline static constexpr unsigned int AsyncCheckItemBase___c__DisplayClass9_0_TypeDefinitionIndex = 47405;
