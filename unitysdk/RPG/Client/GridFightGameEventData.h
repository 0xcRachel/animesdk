...
class Class_1_6298C7F911B6B6EE;
...
#define RPG_CLIENT_GRIDFIGHTGAMEEVENTDATA_DISPATCH_OFFSET UNITYSDK_OFFSET(0x936EE20)
#define RPG_CLIENT_GRIDFIGHTGAMEEVENTDATA_GETCOLLECTOR_OFFSET UNITYSDK_OFFSET(0x936EE80)
#define RPG_CLIENT_GRIDFIGHTGAMEEVENTDATA_REGISTERCOLLECTOR_OFFSET UNITYSDK_OFFSET(0x936EF70)
#define RPG_CLIENT_GRIDFIGHTGAMEEVENTDATA_RESET_OFFSET UNITYSDK_OFFSET(0x936EBA0)
#define RPG_CLIENT_GRIDFIGHTGAMEEVENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x936E880)
#define RPG_CLIENT_GRIDFIGHTGAMEEVENTDATA__INITDATACHANGECOLLECTOR_OFFSET UNITYSDK_OFFSET(0x936EA30)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightGameEventData_TypeDefinitionIndex = 51317;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::System::String*, ::Class_0_16E4307DCC419505_595*>* _CollectorsLUT; // 0x10
		::RPG::Client::GridFightProjectionChangeCollector* ProjData; // 0x18
		::RPG::Client::GridFightAugmentChangeCollector* AugmentData; // 0x20
		::RPG::Client::GridFightTrackChangeCollector* TrackData; // 0x28
		::RPG::Client::GridFightTraitChangeCollector* TraitData; // 0x30
		::RPG::Client::GridFightPlayerChangeCollector* PlayerData; // 0x38
		::RPG::Client::GridFightStageChangeCollector* StageData; // 0x40
		::RPG::Client::GridFightForgeChangeCollector* ForgeData; // 0x48
		::RPG::Client::GridFightOrbChangeCollector* OrbData; // 0x50
		::RPG::Client::GridFightNPCChangeCollector* NPCData; // 0x58
		::RPG::Client::GridFightEquipChangeCollector* EquipData; // 0x60
		::RPG::Client::GridFightRoleChangeCollector* RoleData; // 0x68
		::RPG::Client::GridFightConsumableChangeCollector* ConsumableData; // 0x70
		::Class_1_6298C7F911B6B6EE* ShopData; // 0x78
		...
		::Class_0_16E4307DCC419505_595* GetCollector(::System::String* dataType)
		{
			return ((::Class_0_16E4307DCC419505_595*(*)(::PVOID, ::System::String*))((::PBYTE)hIl2Cpp + RPG_CLIENT_GRIDFIGHTGAMEEVENTDATA_GETCOLLECTOR_OFFSET))(this, dataType);
		}

		::System::Void RegisterCollector(::System::String* dataType, ::Class_0_16E4307DCC419505_595* collector)
		{
			return ((::System::Void(*)(::PVOID, ::System::String*, ::Class_0_16E4307DCC419505_595*))((::PBYTE)hIl2Cpp + RPG_CLIENT_GRIDFIGHTGAMEEVENTDATA_REGISTERCOLLECTOR_OFFSET))(this, dataType, collector);
		}
