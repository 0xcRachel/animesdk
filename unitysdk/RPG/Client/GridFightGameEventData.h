...
#define RPG_CLIENT_GRIDFIGHTGAMEEVENTDATA_DISPATCH_OFFSET UNITYSDK_OFFSET(0x982C8C0)
#define RPG_CLIENT_GRIDFIGHTGAMEEVENTDATA_GETCOLLECTOR_OFFSET UNITYSDK_OFFSET(0x982C920)
#define RPG_CLIENT_GRIDFIGHTGAMEEVENTDATA_REGISTERCOLLECTOR_OFFSET UNITYSDK_OFFSET(0x982CA10)
#define RPG_CLIENT_GRIDFIGHTGAMEEVENTDATA_RESET_OFFSET UNITYSDK_OFFSET(0x982C640)
#define RPG_CLIENT_GRIDFIGHTGAMEEVENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x982C230)
#define RPG_CLIENT_GRIDFIGHTGAMEEVENTDATA__INITDATACHANGECOLLECTOR_OFFSET UNITYSDK_OFFSET(0x982C4D0)
...
namespace RPG::Client
{
	...
	public:
		...
		::RPG::Client::GridFightRoleChangeCollector* RoleData; // 0x10
		::RPG::Client::GridFightShopChangeCollector* ShopData; // 0x18
		::RPG::Client::GridFightNPCChangeCollector* NPCData; // 0x20
		::RPG::Client::GridFightEquipChangeCollector* EquipData; // 0x28
		::RPG::Client::GridFightProjectionChangeCollector* ProjData; // 0x30
		::RPG::Client::GridFightForgeChangeCollector* ForgeData; // 0x38
		::RPG::Client::GridFightPlayerChangeCollector* PlayerData; // 0x40
		::RPG::Client::GridFightStageChangeCollector* StageData; // 0x48
		::RPG::Client::GridFightConsumableChangeCollector* ConsumableData; // 0x50
		::RPG::Client::GridFightTraitChangeCollector* TraitData; // 0x58
		::System::Collections::Generic::Dictionary_2<::System::String*, ::Class_0_16E4307DCC419505_626*>* _CollectorsLUT; // 0x60
		::RPG::Client::GridFightOrbChangeCollector* OrbData; // 0x68
		::RPG::Client::GridFightTrackChangeCollector* TrackData; // 0x70
