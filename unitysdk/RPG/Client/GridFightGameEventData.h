...
#define RPG_CLIENT_GRIDFIGHTGAMEEVENTDATA_DISPATCH_OFFSET UNITYSDK_OFFSET(0x174D8F80)
#define RPG_CLIENT_GRIDFIGHTGAMEEVENTDATA_GETCOLLECTOR_OFFSET UNITYSDK_OFFSET(0x174D8FE0)
#define RPG_CLIENT_GRIDFIGHTGAMEEVENTDATA_REGISTERCOLLECTOR_OFFSET UNITYSDK_OFFSET(0x174D90D0)
#define RPG_CLIENT_GRIDFIGHTGAMEEVENTDATA_RESET_OFFSET UNITYSDK_OFFSET(0x174D8D00)
#define RPG_CLIENT_GRIDFIGHTGAMEEVENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x174D88F0)
#define RPG_CLIENT_GRIDFIGHTGAMEEVENTDATA__INITDATACHANGECOLLECTOR_OFFSET UNITYSDK_OFFSET(0x174D8B90)
...
namespace RPG::Client
{
	...
	public:
		...
		::RPG::Client::GridFightNPCChangeCollector* NPCData; // 0x10
		::RPG::Client::GridFightAugmentChangeCollector* AugmentData; // 0x18
		::RPG::Client::GridFightShopChangeCollector* ShopData; // 0x20
		::RPG::Client::GridFightStageChangeCollector* StageData; // 0x28
		::RPG::Client::GridFightProjectionChangeCollector* ProjData; // 0x30
		::RPG::Client::GridFightForgeChangeCollector* ForgeData; // 0x38
		::RPG::Client::GridFightTrackChangeCollector* TrackData; // 0x40
		::RPG::Client::GridFightOrbChangeCollector* OrbData; // 0x48
		::System::Collections::Generic::Dictionary_2<::System::String*, ::Class_0_16E4307DCC419505_717*>* _CollectorsLUT; // 0x50
		...
		::RPG::Client::GridFightPlayerChangeCollector* PlayerData; // 0x70
