...
#define RPG_CLIENT_GRIDFIGHTGAMEEVENTDATA_DISPATCH_OFFSET UNITYSDK_OFFSET(0x18D228B0)
#define RPG_CLIENT_GRIDFIGHTGAMEEVENTDATA_GETCOLLECTOR_OFFSET UNITYSDK_OFFSET(0x18D22910)
#define RPG_CLIENT_GRIDFIGHTGAMEEVENTDATA_REGISTERCOLLECTOR_OFFSET UNITYSDK_OFFSET(0x18D229F0)
#define RPG_CLIENT_GRIDFIGHTGAMEEVENTDATA_RESET_OFFSET UNITYSDK_OFFSET(0x18D22630)
#define RPG_CLIENT_GRIDFIGHTGAMEEVENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18D22220)
#define RPG_CLIENT_GRIDFIGHTGAMEEVENTDATA__INITDATACHANGECOLLECTOR_OFFSET UNITYSDK_OFFSET(0x18D224C0)
...
namespace RPG::Client
{
	...
	public:
		...
		::RPG::Client::GridFightForgeChangeCollector* ForgeData; // 0x20
		::RPG::Client::GridFightStageChangeCollector* StageData; // 0x28
		::RPG::Client::GridFightAugmentChangeCollector* AugmentData; // 0x30
		::RPG::Client::GridFightTrackChangeCollector* TrackData; // 0x38
		::RPG::Client::GridFightShopChangeCollector* ShopData; // 0x40
		::RPG::Client::GridFightConsumableChangeCollector* ConsumableData; // 0x48
		::RPG::Client::GridFightPlayerChangeCollector* PlayerData; // 0x50
		::System::Collections::Generic::Dictionary_2<::System::String*, ::Class_0_16E4307DCC419505_768*>* _CollectorsLUT; // 0x58
		...
		::RPG::Client::GridFightProjectionChangeCollector* ProjData; // 0x78
