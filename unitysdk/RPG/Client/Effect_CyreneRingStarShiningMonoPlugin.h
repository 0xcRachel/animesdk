...
#define RPG_CLIENT_EFFECT_CYRENERINGSTARSHININGMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x90A3B90)
#define RPG_CLIENT_EFFECT_CYRENERINGSTARSHININGMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x90A3BE0)
#define RPG_CLIENT_EFFECT_CYRENERINGSTARSHININGMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x90A3C60)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_CyreneRingStarShiningMonoPlugin_TypeDefinitionIndex = 56111;
