...
#define RPG_CLIENT_PPEFFECTMANAGER___C__DISPLAYCLASS19_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9A280C0)
#define RPG_CLIENT_PPEFFECTMANAGER___C__DISPLAYCLASS19_0__REFRESHAVATARINTENSITY_B__0_OFFSET UNITYSDK_OFFSET(0x9A2C520)

namespace RPG::Client
{
	inline static constexpr unsigned int PPEffectManager___c__DisplayClass19_0_TypeDefinitionIndex = 55492;
