...
#define RPG_CLIENT_EMOEYECTRL_AWAKE_OFFSET UNITYSDK_OFFSET(0x96052F0)
#define RPG_CLIENT_EMOEYECTRL_DOUPDATE_OFFSET UNITYSDK_OFFSET(0x9605890)
#define RPG_CLIENT_EMOEYECTRL_EYELOOKAT_1_OFFSET UNITYSDK_OFFSET(0x9604E80)
#define RPG_CLIENT_EMOEYECTRL_EYELOOKAT_OFFSET UNITYSDK_OFFSET(0x9604C60)
#define RPG_CLIENT_EMOEYECTRL_GET_ENABLEEYELOOKAT_OFFSET UNITYSDK_OFFSET(0x9604B60)
#define RPG_CLIENT_EMOEYECTRL_HASDATA_OFFSET UNITYSDK_OFFSET(0x9604B70)
#define RPG_CLIENT_EMOEYECTRL_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9606A70)
#define RPG_CLIENT_EMOEYECTRL_METHOD_5_0C9DFA95C6F28D26_OFFSET UNITYSDK_OFFSET(0x9608470)
#define RPG_CLIENT_EMOEYECTRL_METHOD_5_8B5519E0E1747D4E_OFFSET UNITYSDK_OFFSET(0x9608EB0)
#define RPG_CLIENT_EMOEYECTRL_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x9604D10)
#define RPG_CLIENT_EMOEYECTRL_METHOD_5_9F70F7100A78F9A0_OFFSET UNITYSDK_OFFSET(0x9607970)
#define RPG_CLIENT_EMOEYECTRL_METHOD_5_B54AB57637A113AA_OFFSET UNITYSDK_OFFSET(0x9608610)
#define RPG_CLIENT_EMOEYECTRL_METHOD_5_BF653AC3FD8A315F_OFFSET UNITYSDK_OFFSET(0x96058F0)
#define RPG_CLIENT_EMOEYECTRL_METHOD_5_CEE772DE95055C01_OFFSET UNITYSDK_OFFSET(0x9606B10)
#define RPG_CLIENT_EMOEYECTRL_SCALEADD_OFFSET UNITYSDK_OFFSET(0x9608550)
#define RPG_CLIENT_EMOEYECTRL_SETBLINKWEIGHT_OFFSET UNITYSDK_OFFSET(0x9608F30)
#define RPG_CLIENT_EMOEYECTRL_SETBLINK_OFFSET UNITYSDK_OFFSET(0x96088F0)
#define RPG_CLIENT_EMOEYECTRL_SETDATA_OFFSET UNITYSDK_OFFSET(0x9604BC0)
#define RPG_CLIENT_EMOEYECTRL_SETEYELOOKATWEIGHT_OFFSET UNITYSDK_OFFSET(0x9604FF0)
#define RPG_CLIENT_EMOEYECTRL_SETSHAKEDATA_OFFSET UNITYSDK_OFFSET(0x9604C10)
#define RPG_CLIENT_EMOEYECTRL_SETUPEYELOOKATCURVEBLEND_OFFSET UNITYSDK_OFFSET(0x9605060)
#define RPG_CLIENT_EMOEYECTRL_STOPEYELOOKAT_OFFSET UNITYSDK_OFFSET(0x9604F40)
#define RPG_CLIENT_EMOEYECTRL__CTOR_OFFSET UNITYSDK_OFFSET(0x9608F90)
