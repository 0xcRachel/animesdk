...
#define RPG_CLIENT_EMOEYECTRL_AWAKE_OFFSET UNITYSDK_OFFSET(0x91581F0)
#define RPG_CLIENT_EMOEYECTRL_DOUPDATE_OFFSET UNITYSDK_OFFSET(0x9158790)
#define RPG_CLIENT_EMOEYECTRL_EYELOOKAT_1_OFFSET UNITYSDK_OFFSET(0x9157D80)
#define RPG_CLIENT_EMOEYECTRL_EYELOOKAT_OFFSET UNITYSDK_OFFSET(0x9157B60)
#define RPG_CLIENT_EMOEYECTRL_GET_ENABLEEYELOOKAT_OFFSET UNITYSDK_OFFSET(0x9157A60)
#define RPG_CLIENT_EMOEYECTRL_HASDATA_OFFSET UNITYSDK_OFFSET(0x9157A70)
#define RPG_CLIENT_EMOEYECTRL_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9159970)
#define RPG_CLIENT_EMOEYECTRL_METHOD_5_0C9DFA95C6F28D26_OFFSET UNITYSDK_OFFSET(0x915B370)
#define RPG_CLIENT_EMOEYECTRL_METHOD_5_8B5519E0E1747D4E_OFFSET UNITYSDK_OFFSET(0x915BDB0)
#define RPG_CLIENT_EMOEYECTRL_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x9157C10)
#define RPG_CLIENT_EMOEYECTRL_METHOD_5_9F70F7100A78F9A0_OFFSET UNITYSDK_OFFSET(0x915A870)
#define RPG_CLIENT_EMOEYECTRL_METHOD_5_B54AB57637A113AA_OFFSET UNITYSDK_OFFSET(0x915B510)
#define RPG_CLIENT_EMOEYECTRL_METHOD_5_BF653AC3FD8A315F_OFFSET UNITYSDK_OFFSET(0x91587F0)
#define RPG_CLIENT_EMOEYECTRL_METHOD_5_CEE772DE95055C01_OFFSET UNITYSDK_OFFSET(0x9159A10)
#define RPG_CLIENT_EMOEYECTRL_SCALEADD_OFFSET UNITYSDK_OFFSET(0x915B450)
#define RPG_CLIENT_EMOEYECTRL_SETBLINKWEIGHT_OFFSET UNITYSDK_OFFSET(0x915BE30)
#define RPG_CLIENT_EMOEYECTRL_SETBLINK_OFFSET UNITYSDK_OFFSET(0x915B7F0)
#define RPG_CLIENT_EMOEYECTRL_SETDATA_OFFSET UNITYSDK_OFFSET(0x9157AC0)
#define RPG_CLIENT_EMOEYECTRL_SETEYELOOKATWEIGHT_OFFSET UNITYSDK_OFFSET(0x9157EF0)
#define RPG_CLIENT_EMOEYECTRL_SETSHAKEDATA_OFFSET UNITYSDK_OFFSET(0x9157B10)
#define RPG_CLIENT_EMOEYECTRL_SETUPEYELOOKATCURVEBLEND_OFFSET UNITYSDK_OFFSET(0x9157F60)
#define RPG_CLIENT_EMOEYECTRL_STOPEYELOOKAT_OFFSET UNITYSDK_OFFSET(0x9157E40)
#define RPG_CLIENT_EMOEYECTRL__CTOR_OFFSET UNITYSDK_OFFSET(0x915BE90)

namespace RPG::Client
{
	inline static constexpr unsigned int EmoEyeCtrl_TypeDefinitionIndex = 56680;
