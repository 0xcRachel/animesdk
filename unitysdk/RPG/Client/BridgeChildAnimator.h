...
#define RPG_CLIENT_BRIDGECHILDANIMATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x8E0F7C0)

namespace RPG::Client
{
	inline static constexpr unsigned int BridgeChildAnimator_TypeDefinitionIndex = 55962;
