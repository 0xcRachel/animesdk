...
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_CLEARSERVERSTATE_OFFSET UNITYSDK_OFFSET(0x16FFC4F0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x16FFC480)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_CONDITIONDESC_OFFSET UNITYSDK_OFFSET(0x16FFCD30)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_CONDITIONID_OFFSET UNITYSDK_OFFSET(0x16FFC6D0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_EFFECTDESC_OFFSET UNITYSDK_OFFSET(0x16FFCE00)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_EFFECTIDARR_OFFSET UNITYSDK_OFFSET(0x16FFBED0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_EXAMID_OFFSET UNITYSDK_OFFSET(0x16FFC860)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_ISENDING_OFFSET UNITYSDK_OFFSET(0x16FFD0A0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_ISFINISH_OFFSET UNITYSDK_OFFSET(0x16FFC740)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_ISSTORY_OFFSET UNITYSDK_OFFSET(0x16FFD040)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0x16FFC580)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_MISSIONID_OFFSET UNITYSDK_OFFSET(0x16FFC9A0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_PARTNERID_OFFSET UNITYSDK_OFFSET(0x16FFCFA0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_PERFORMANCEID_OFFSET UNITYSDK_OFFSET(0x16FFC900)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_REPEATPERFORMANCEID_OFFSET UNITYSDK_OFFSET(0x16FFCA40)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_STORYDESC_OFFSET UNITYSDK_OFFSET(0x16FFCC60)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_STORYHINT_OFFSET UNITYSDK_OFFSET(0x16FFCED0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_STORYIMAGE_OFFSET UNITYSDK_OFFSET(0x16FFCAE0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_STORYTITLE_OFFSET UNITYSDK_OFFSET(0x16FFCB90)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_STORYTYPE_OFFSET UNITYSDK_OFFSET(0x16FFC760)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x16FFC800)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_SETSTORYFINISH_OFFSET UNITYSDK_OFFSET(0x16FFC530)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_SET_ISFINISH_OFFSET UNITYSDK_OFFSET(0x16FFC750)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16FFC4E0)
