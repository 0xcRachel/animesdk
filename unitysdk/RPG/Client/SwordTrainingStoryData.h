...
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_CLEARSERVERSTATE_OFFSET UNITYSDK_OFFSET(0x184C1370)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x184C1300)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_CONDITIONDESC_OFFSET UNITYSDK_OFFSET(0x184C1BE0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_CONDITIONID_OFFSET UNITYSDK_OFFSET(0x184C1560)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_EFFECTDESC_OFFSET UNITYSDK_OFFSET(0x184C1CC0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_EFFECTIDARR_OFFSET UNITYSDK_OFFSET(0x184C0D60)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_EXAMID_OFFSET UNITYSDK_OFFSET(0x184C16F0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_ISENDING_OFFSET UNITYSDK_OFFSET(0x184C1F80)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_ISFINISH_OFFSET UNITYSDK_OFFSET(0x184C15D0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_ISSTORY_OFFSET UNITYSDK_OFFSET(0x184C1F20)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0x184C1400)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_MISSIONID_OFFSET UNITYSDK_OFFSET(0x184C1830)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_PARTNERID_OFFSET UNITYSDK_OFFSET(0x184C1E80)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_PERFORMANCEID_OFFSET UNITYSDK_OFFSET(0x184C1790)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_REPEATPERFORMANCEID_OFFSET UNITYSDK_OFFSET(0x184C18D0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_STORYDESC_OFFSET UNITYSDK_OFFSET(0x184C1B00)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_STORYHINT_OFFSET UNITYSDK_OFFSET(0x184C1DA0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_STORYIMAGE_OFFSET UNITYSDK_OFFSET(0x184C1970)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_STORYTITLE_OFFSET UNITYSDK_OFFSET(0x184C1A20)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_STORYTYPE_OFFSET UNITYSDK_OFFSET(0x184C15F0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x184C1690)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_SETSTORYFINISH_OFFSET UNITYSDK_OFFSET(0x184C13B0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_SET_ISFINISH_OFFSET UNITYSDK_OFFSET(0x184C15E0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x184C1360)
