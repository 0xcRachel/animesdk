...
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE_CHOOSEDELIVERER_OFFSET UNITYSDK_OFFSET(0x90D6B40)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE_GET_CANDIDATEDELIVERERS_OFFSET UNITYSDK_OFFSET(0x90D6320)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE_GET_CHOSENCANDIDATEINDEX_OFFSET UNITYSDK_OFFSET(0x90D6340)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE_GET_CHOSENDELIVERER_OFFSET UNITYSDK_OFFSET(0x90D5D30)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE_GET_DELIVERYDATETIME_OFFSET UNITYSDK_OFFSET(0x90D6360)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE_GET_ENDDATETIME_OFFSET UNITYSDK_OFFSET(0x90D6200)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x90D6170)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE_GET_ISDELIVERED_OFFSET UNITYSDK_OFFSET(0x90D60C0)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE_GET_ISREWARDTAKEN_OFFSET UNITYSDK_OFFSET(0x90D6380)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE_GET_REWARDITEMS_OFFSET UNITYSDK_OFFSET(0x90D63A0)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE_GET_SHOULDBEDELIVERED_OFFSET UNITYSDK_OFFSET(0x90D5E50)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE_GET__ISDATAVALID_OFFSET UNITYSDK_OFFSET(0x90D5FC0)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE_GET__ISINSCHEDULE_OFFSET UNITYSDK_OFFSET(0x90D5CD0)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE_INIT_OFFSET UNITYSDK_OFFSET(0x90D63C0)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE_ONLOGINFINISH_OFFSET UNITYSDK_OFFSET(0x90D64D0)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE_REDDOTHASREWARDNOTTAKENYET_OFFSET UNITYSDK_OFFSET(0x90D5DB0)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE_REDDOTISAVATARNOTSELECTEDYET_OFFSET UNITYSDK_OFFSET(0x90D5BE0)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE_REFRESHDATA_OFFSET UNITYSDK_OFFSET(0x90D6A90)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE_SET_CANDIDATEDELIVERERS_OFFSET UNITYSDK_OFFSET(0x90D6330)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE_SET_CHOSENCANDIDATEINDEX_OFFSET UNITYSDK_OFFSET(0x90D6350)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE_SET_DELIVERYDATETIME_OFFSET UNITYSDK_OFFSET(0x90D6370)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE_SET_ISREWARDTAKEN_OFFSET UNITYSDK_OFFSET(0x90D6390)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE_SET_REWARDITEMS_OFFSET UNITYSDK_OFFSET(0x90D63B0)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE_TAKEREWARD_OFFSET UNITYSDK_OFFSET(0x90D6BF0)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE__ADDPACKETHANDLERS_OFFSET UNITYSDK_OFFSET(0x90D5160)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x90D6C80)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE__INITCANDIDATEDELIVERERS_OFFSET UNITYSDK_OFFSET(0x90D6650)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE__INITDELIVERYDATETIME_OFFSET UNITYSDK_OFFSET(0x90D6910)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE__INITREWARDITEMS_OFFSET UNITYSDK_OFFSET(0x90D68A0)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE__ONCHOOSEAVATARSCRSP_OFFSET UNITYSDK_OFFSET(0x90D5800)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE__ONGETDATASCRSP_OFFSET UNITYSDK_OFFSET(0x90D5470)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE__ONMODULEINITREQ_OFFSET UNITYSDK_OFFSET(0x90D6A40)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE__ONTAKEREWARDSCRSP_OFFSET UNITYSDK_OFFSET(0x90D5B30)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE__SENDCHOOSEAVATARCSREQ_OFFSET UNITYSDK_OFFSET(0x90D5620)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE__SENDGETDATACSREQ_OFFSET UNITYSDK_OFFSET(0x90D5240)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE__SENDTAKEREWARDCSREQ_OFFSET UNITYSDK_OFFSET(0x90D5900)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE__SYNCCHOSENCANDIDATE_OFFSET UNITYSDK_OFFSET(0x90D5580)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x90D6DC0)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE___IFIXBASEPROXY_ONLOGINFINISH_OFFSET UNITYSDK_OFFSET(0x90D6E50)
#define RPG_CLIENT_ANNIVERSARYAVATARDELIVERMODULE___IFIXBASEPROXY__ADDPACKETHANDLERS_OFFSET UNITYSDK_OFFSET(0x90D6D60)
