...
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x17077520)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GETCURINPROGRESSDETAILDATA_OFFSET UNITYSDK_OFFSET(0x17077830)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ACTIVITYMODULEID_OFFSET UNITYSDK_OFFSET(0x17077FF0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_COMMENTLIST_OFFSET UNITYSDK_OFFSET(0x17077810)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_DAILY_OFFSET UNITYSDK_OFFSET(0x17078420)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x17077DB0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_GROUPINDEX_OFFSET UNITYSDK_OFFSET(0x17077DD0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_HASREWARDCANTAKE_OFFSET UNITYSDK_OFFSET(0x17078350)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISANYDETAILFINISHED_OFFSET UNITYSDK_OFFSET(0x17078220)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISAVAILABLE_OFFSET UNITYSDK_OFFSET(0x17077220)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x170779D0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISINSCHEDULE_OFFSET UNITYSDK_OFFSET(0x17078010)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISLASTDAYFINISHED_OFFSET UNITYSDK_OFFSET(0x17078210)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISLASTDAY_OFFSET UNITYSDK_OFFSET(0x17076E40)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISPREGROUPFINISH_OFFSET UNITYSDK_OFFSET(0x170780C0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISSEENUNLOCK_OFFSET UNITYSDK_OFFSET(0x17077CA0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x170781F0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_PHOTOID_OFFSET UNITYSDK_OFFSET(0x17076F80)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_QUESTID_OFFSET UNITYSDK_OFFSET(0x17078400)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_SCHEDULEDATA_OFFSET UNITYSDK_OFFSET(0x17077F10)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_TAB_OFFSET UNITYSDK_OFFSET(0x17078450)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_RECORDSEENUNLOCK_OFFSET UNITYSDK_OFFSET(0x17077B10)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_SET_GROUPID_OFFSET UNITYSDK_OFFSET(0x17077DC0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17077770)
