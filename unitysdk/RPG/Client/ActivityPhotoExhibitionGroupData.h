...
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x18819F00)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GETCURINPROGRESSDETAILDATA_OFFSET UNITYSDK_OFFSET(0x1881A260)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ACTIVITYMODULEID_OFFSET UNITYSDK_OFFSET(0x1881AA80)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_COMMENTLIST_OFFSET UNITYSDK_OFFSET(0x1881A240)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_DAILY_OFFSET UNITYSDK_OFFSET(0x1881AEB0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1881A840)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_GROUPINDEX_OFFSET UNITYSDK_OFFSET(0x1881A860)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_HASREWARDCANTAKE_OFFSET UNITYSDK_OFFSET(0x1881ADE0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISANYDETAILFINISHED_OFFSET UNITYSDK_OFFSET(0x1881AC90)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISAVAILABLE_OFFSET UNITYSDK_OFFSET(0x18819C00)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x1881A430)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISINSCHEDULE_OFFSET UNITYSDK_OFFSET(0x1881AAA0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISLASTDAYFINISHED_OFFSET UNITYSDK_OFFSET(0x1881AC80)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISLASTDAY_OFFSET UNITYSDK_OFFSET(0x188197E0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISPREGROUPFINISH_OFFSET UNITYSDK_OFFSET(0x1881AB50)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISSEENUNLOCK_OFFSET UNITYSDK_OFFSET(0x1881A730)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x1881AC60)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_PHOTOID_OFFSET UNITYSDK_OFFSET(0x18819920)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_QUESTID_OFFSET UNITYSDK_OFFSET(0x1881AE90)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_SCHEDULEDATA_OFFSET UNITYSDK_OFFSET(0x1881A9A0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_TAB_OFFSET UNITYSDK_OFFSET(0x1881AEE0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_RECORDSEENUNLOCK_OFFSET UNITYSDK_OFFSET(0x1881A5A0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_SET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1881A850)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1881A1A0)
