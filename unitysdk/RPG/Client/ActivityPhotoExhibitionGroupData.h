...
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x8FA0310)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GETCURINPROGRESSDETAILDATA_OFFSET UNITYSDK_OFFSET(0x8FA0620)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ACTIVITYMODULEID_OFFSET UNITYSDK_OFFSET(0x8FA0DE0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_COMMENTLIST_OFFSET UNITYSDK_OFFSET(0x8FA0600)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_DAILY_OFFSET UNITYSDK_OFFSET(0x8FA1210)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x8FA0BA0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_GROUPINDEX_OFFSET UNITYSDK_OFFSET(0x8FA0BC0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_HASREWARDCANTAKE_OFFSET UNITYSDK_OFFSET(0x8FA1140)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISANYDETAILFINISHED_OFFSET UNITYSDK_OFFSET(0x8FA1010)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISAVAILABLE_OFFSET UNITYSDK_OFFSET(0x8FA0010)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x8FA07C0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISINSCHEDULE_OFFSET UNITYSDK_OFFSET(0x8FA0E00)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISLASTDAYFINISHED_OFFSET UNITYSDK_OFFSET(0x8FA1000)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISLASTDAY_OFFSET UNITYSDK_OFFSET(0x8F9FC30)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISPREGROUPFINISH_OFFSET UNITYSDK_OFFSET(0x8FA0EB0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISSEENUNLOCK_OFFSET UNITYSDK_OFFSET(0x8FA0A90)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x8FA0FE0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_PHOTOID_OFFSET UNITYSDK_OFFSET(0x8F9FD70)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_QUESTID_OFFSET UNITYSDK_OFFSET(0x8FA11F0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_SCHEDULEDATA_OFFSET UNITYSDK_OFFSET(0x8FA0D00)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_TAB_OFFSET UNITYSDK_OFFSET(0x8FA1240)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_RECORDSEENUNLOCK_OFFSET UNITYSDK_OFFSET(0x8FA0900)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_SET_GROUPID_OFFSET UNITYSDK_OFFSET(0x8FA0BB0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8FA0560)
