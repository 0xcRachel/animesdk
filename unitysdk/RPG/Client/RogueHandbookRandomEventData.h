...
#define RPG_CLIENT_ROGUEHANDBOOKRANDOMEVENTDATA_GET_EVENTTYPELIST_OFFSET UNITYSDK_OFFSET(0xA31C1F0)
#define RPG_CLIENT_ROGUEHANDBOOKRANDOMEVENTDATA_GET_HANDBOOKEVENTID_OFFSET UNITYSDK_OFFSET(0xA31B7F0)
#define RPG_CLIENT_ROGUEHANDBOOKRANDOMEVENTDATA_GET_HASUNTAKENREWARD_OFFSET UNITYSDK_OFFSET(0xA31CA60)
#define RPG_CLIENT_ROGUEHANDBOOKRANDOMEVENTDATA_GET_IMAGEID_OFFSET UNITYSDK_OFFSET(0xA31C920)
#define RPG_CLIENT_ROGUEHANDBOOKRANDOMEVENTDATA_GET_IMAGEPATH_OFFSET UNITYSDK_OFFSET(0xA31C9A0)
#define RPG_CLIENT_ROGUEHANDBOOKRANDOMEVENTDATA_GET_ISINSCHEDULE_OFFSET UNITYSDK_OFFSET(0xA31CAA0)
#define RPG_CLIENT_ROGUEHANDBOOKRANDOMEVENTDATA_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xA31CA80)
#define RPG_CLIENT_ROGUEHANDBOOKRANDOMEVENTDATA_GET_ORDER_OFFSET UNITYSDK_OFFSET(0xA31C8B0)
#define RPG_CLIENT_ROGUEHANDBOOKRANDOMEVENTDATA_GET_REWARDID_OFFSET UNITYSDK_OFFSET(0xA31CA40)
#define RPG_CLIENT_ROGUEHANDBOOKRANDOMEVENTDATA_GET_TITLE_OFFSET UNITYSDK_OFFSET(0xA31C8F0)
#define RPG_CLIENT_ROGUEHANDBOOKRANDOMEVENTDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xA31C970)
#define RPG_CLIENT_ROGUEHANDBOOKRANDOMEVENTDATA_GET_UNLOCKHINTDESC_OFFSET UNITYSDK_OFFSET(0xA31CAC0)
#define RPG_CLIENT_ROGUEHANDBOOKRANDOMEVENTDATA_SET_HASUNTAKENREWARD_OFFSET UNITYSDK_OFFSET(0xA31CA70)
#define RPG_CLIENT_ROGUEHANDBOOKRANDOMEVENTDATA_SET_ISINSCHEDULE_OFFSET UNITYSDK_OFFSET(0xA31CAB0)
#define RPG_CLIENT_ROGUEHANDBOOKRANDOMEVENTDATA_SET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xA31CA90)
#define RPG_CLIENT_ROGUEHANDBOOKRANDOMEVENTDATA_UPDATEBYSERVER_OFFSET UNITYSDK_OFFSET(0xA31B430)
#define RPG_CLIENT_ROGUEHANDBOOKRANDOMEVENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA31B7E0)
