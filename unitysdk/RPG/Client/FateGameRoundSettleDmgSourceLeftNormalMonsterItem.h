...
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTNORMALMONSTERITEM_GET_DESC_OFFSET UNITYSDK_OFFSET(0x9698CF0)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTNORMALMONSTERITEM_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x9698890)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTNORMALMONSTERITEM_GET__DMGMAXLIMIT_OFFSET UNITYSDK_OFFSET(0x9698B90)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTNORMALMONSTERITEM_GET__DMGPERLEFTMONSTER_OFFSET UNITYSDK_OFFSET(0x9698A30)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTNORMALMONSTERITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9698880)
