...
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTNORMALMONSTERITEM_GET_DESC_OFFSET UNITYSDK_OFFSET(0x9223AE0)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTNORMALMONSTERITEM_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x9223600)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTNORMALMONSTERITEM_GET__DMGMAXLIMIT_OFFSET UNITYSDK_OFFSET(0x9223980)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTNORMALMONSTERITEM_GET__DMGPERLEFTMONSTER_OFFSET UNITYSDK_OFFSET(0x9223820)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTNORMALMONSTERITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x92235F0)

namespace RPG::Client
{
	inline static constexpr unsigned int FateGameRoundSettleDmgSourceLeftNormalMonsterItem_TypeDefinitionIndex = 50837;
