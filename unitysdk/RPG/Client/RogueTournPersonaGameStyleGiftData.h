...
#define RPG_CLIENT_ROGUETOURNPERSONAGAMESTYLEGIFTDATA_CREATE_1_OFFSET UNITYSDK_OFFSET(0xA3C54F0)
#define RPG_CLIENT_ROGUETOURNPERSONAGAMESTYLEGIFTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xA3C5490)
#define RPG_CLIENT_ROGUETOURNPERSONAGAMESTYLEGIFTDATA_GET_DYNAMICHINT_OFFSET UNITYSDK_OFFSET(0xA3C5710)
#define RPG_CLIENT_ROGUETOURNPERSONAGAMESTYLEGIFTDATA_GET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0xA3C56F0)
#define RPG_CLIENT_ROGUETOURNPERSONAGAMESTYLEGIFTDATA_SET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0xA3C5700)
#define RPG_CLIENT_ROGUETOURNPERSONAGAMESTYLEGIFTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA3C5480)
#define RPG_CLIENT_ROGUETOURNPERSONAGAMESTYLEGIFTDATA__INITFROMROW_OFFSET UNITYSDK_OFFSET(0xA3C5610)
#define RPG_CLIENT_ROGUETOURNPERSONAGAMESTYLEGIFTDATA___IFIXBASEPROXY__INITFROMROW_OFFSET UNITYSDK_OFFSET(0xA3C57D0)
...
namespace RPG::Client
{
	...
	{
	public:
		::Class_1_7BE0B64AF0A0B070_1* _BlackboardContext; // 0x40
		::Class_1_412DDC84C44F8B4B* _DynamicHint; // 0x48
