...
#define RPG_CLIENT_BLENDCURVERANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x8DF6C00)

namespace RPG::Client
{
	inline static constexpr unsigned int BlendCurveRange_TypeDefinitionIndex = 55442;
