...
#define RPG_CLIENT_GRIDFIGHTTRAITCORESELECTBASE_GETCOREROLEUIDS_OFFSET UNITYSDK_OFFSET(0x9420A60)
#define RPG_CLIENT_GRIDFIGHTTRAITCORESELECTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x9420540)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightTraitCoreSelectBase_TypeDefinitionIndex = 51947;
