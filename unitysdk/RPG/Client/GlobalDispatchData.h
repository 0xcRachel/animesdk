...
#define RPG_CLIENT_GLOBALDISPATCHDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9306DC0)

namespace RPG::Client
{
	inline static constexpr unsigned int GlobalDispatchData_TypeDefinitionIndex = 55144;
	...
	public:
		...
		::System::String* ForceUpdateUrl; // 0x20
