...
#define RPG_CLIENT_CATGOD_CATGODBUBBLEDATA_GET_CURRENTCNT_OFFSET UNITYSDK_OFFSET(0x18FBC870)
#define RPG_CLIENT_CATGOD_CATGODBUBBLEDATA_GET_TARGETCNT_OFFSET UNITYSDK_OFFSET(0x18FBC890)
#define RPG_CLIENT_CATGOD_CATGODBUBBLEDATA_SET_CURRENTCNT_OFFSET UNITYSDK_OFFSET(0x18FBC880)
#define RPG_CLIENT_CATGOD_CATGODBUBBLEDATA_SET_TARGETCNT_OFFSET UNITYSDK_OFFSET(0x18FBC8A0)
#define RPG_CLIENT_CATGOD_CATGODBUBBLEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18FBC860)

namespace RPG::Client::CatGod
{
	inline static constexpr unsigned int CatGodBubbleData_TypeDefinitionIndex = 74302;
