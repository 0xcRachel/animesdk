...
#define RPG_CLIENT_BEHAVIORBASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x91EEBC0)
#define RPG_CLIENT_BEHAVIORBASE_METHOD_1_627A43057F5DEAED_OFFSET UNITYSDK_OFFSET(0x91EEC10)
#define RPG_CLIENT_BEHAVIORBASE_METHOD_1_BB7A80635436443C_OFFSET UNITYSDK_OFFSET(0x91EEB70)
#define RPG_CLIENT_BEHAVIORBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x91EECE0)
