...
#define RPG_CLIENT_BEHAVIORBASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8DE4A50)
#define RPG_CLIENT_BEHAVIORBASE_METHOD_1_627A43057F5DEAED_OFFSET UNITYSDK_OFFSET(0x8DE4AA0)
#define RPG_CLIENT_BEHAVIORBASE_METHOD_1_BB7A80635436443C_OFFSET UNITYSDK_OFFSET(0x8DE4A00)
#define RPG_CLIENT_BEHAVIORBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x8DE4B70)

namespace RPG::Client
{
	inline static constexpr unsigned int BehaviorBase_TypeDefinitionIndex = 56036;
