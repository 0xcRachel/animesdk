...
#define RPG_CLIENT_ASSEMNPC_METHOD_1_92D59DB27A2254BC_OFFSET UNITYSDK_OFFSET(0x17E57120)
#define RPG_CLIENT_ASSEMNPC_METHOD_1_9672A1E124B0978D_OFFSET UNITYSDK_OFFSET(0x17E56F50)
#define RPG_CLIENT_ASSEMNPC_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x17E57310)
#define RPG_CLIENT_ASSEMNPC_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x17E572D0)
#define RPG_CLIENT_ASSEMNPC_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17E57200)
#define RPG_CLIENT_ASSEMNPC__CTOR_OFFSET UNITYSDK_OFFSET(0x17E571C0)
#define RPG_CLIENT_ASSEMNPC___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17E57410)
