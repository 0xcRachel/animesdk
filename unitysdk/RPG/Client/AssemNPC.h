...
#define RPG_CLIENT_ASSEMNPC_METHOD_1_92D59DB27A2254BC_OFFSET UNITYSDK_OFFSET(0x8C949C0)
#define RPG_CLIENT_ASSEMNPC_METHOD_1_9672A1E124B0978D_OFFSET UNITYSDK_OFFSET(0x8C947F0)
#define RPG_CLIENT_ASSEMNPC_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x8C94BD0)
#define RPG_CLIENT_ASSEMNPC_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x8C94B90)
#define RPG_CLIENT_ASSEMNPC_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8C94AA0)
#define RPG_CLIENT_ASSEMNPC__CTOR_OFFSET UNITYSDK_OFFSET(0x8C94A60)
#define RPG_CLIENT_ASSEMNPC___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8C94CD0)

namespace RPG::Client
{
	inline static constexpr unsigned int AssemNPC_TypeDefinitionIndex = 47538;
