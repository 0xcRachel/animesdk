...
#define RPG_CLIENT_EFFECT_ANIMSPEED_UPDATE_OFFSET UNITYSDK_OFFSET(0x909CF60)
#define RPG_CLIENT_EFFECT_ANIMSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x909D130)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_AnimSpeed_TypeDefinitionIndex = 56101;
