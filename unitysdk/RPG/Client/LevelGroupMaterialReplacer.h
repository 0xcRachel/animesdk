...
#define RPG_CLIENT_LEVELGROUPMATERIALREPLACER_METHOD_6_8A00650C96DAEFA1_OFFSET UNITYSDK_OFFSET(0x94FF7A0)
#define RPG_CLIENT_LEVELGROUPMATERIALREPLACER_METHOD_6_C596D6C9B0B7B38D_OFFSET UNITYSDK_OFFSET(0x94FFC70)
#define RPG_CLIENT_LEVELGROUPMATERIALREPLACER__CTOR_OFFSET UNITYSDK_OFFSET(0x9500190)
#define RPG_CLIENT_LEVELGROUPMATERIALREPLACER___GETNPCINFO_B__1_0_OFFSET UNITYSDK_OFFSET(0x95001A0)
#define RPG_CLIENT_LEVELGROUPMATERIALREPLACER___GETNPCINFO_B__1_1_OFFSET UNITYSDK_OFFSET(0x95001C0)

namespace RPG::Client
{
	inline static constexpr unsigned int LevelGroupMaterialReplacer_TypeDefinitionIndex = 54836;
