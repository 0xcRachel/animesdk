...
#define RPG_CLIENT_REGIONMANAGERDEBUGMONO__CTOR_OFFSET UNITYSDK_OFFSET(0x9D80EC0)

namespace RPG::Client
{
	inline static constexpr unsigned int RegionManagerDebugMono_TypeDefinitionIndex = 49363;
