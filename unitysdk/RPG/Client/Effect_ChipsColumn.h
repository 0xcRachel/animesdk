...
#define RPG_CLIENT_EFFECT_CHIPSCOLUMN_LATETICK_OFFSET UNITYSDK_OFFSET(0x909E2A0)
#define RPG_CLIENT_EFFECT_CHIPSCOLUMN_METHOD_5_2566AD459572DFC3_OFFSET UNITYSDK_OFFSET(0x909E380)
#define RPG_CLIENT_EFFECT_CHIPSCOLUMN_METHOD_5_F7300E87EC49A206_OFFSET UNITYSDK_OFFSET(0x909E870)
#define RPG_CLIENT_EFFECT_CHIPSCOLUMN_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x909E210)
#define RPG_CLIENT_EFFECT_CHIPSCOLUMN_ONENABLE_OFFSET UNITYSDK_OFFSET(0x909E180)
#define RPG_CLIENT_EFFECT_CHIPSCOLUMN__CTOR_OFFSET UNITYSDK_OFFSET(0x909F0D0)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_ChipsColumn_TypeDefinitionIndex = 56105;
