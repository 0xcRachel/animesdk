...
#define RPG_CLIENT_EFFECT_CHIPSCOLUMN_LATETICK_OFFSET UNITYSDK_OFFSET(0x954AAF0)
#define RPG_CLIENT_EFFECT_CHIPSCOLUMN_METHOD_5_2566AD459572DFC3_OFFSET UNITYSDK_OFFSET(0x954AC10)
#define RPG_CLIENT_EFFECT_CHIPSCOLUMN_METHOD_5_F7300E87EC49A206_OFFSET UNITYSDK_OFFSET(0x954B100)
#define RPG_CLIENT_EFFECT_CHIPSCOLUMN_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x954AA60)
#define RPG_CLIENT_EFFECT_CHIPSCOLUMN_ONENABLE_OFFSET UNITYSDK_OFFSET(0x954A9D0)
#define RPG_CLIENT_EFFECT_CHIPSCOLUMN__CTOR_OFFSET UNITYSDK_OFFSET(0x954B960)
