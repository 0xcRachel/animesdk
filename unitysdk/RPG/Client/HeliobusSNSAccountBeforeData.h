...
#define RPG_CLIENT_HELIOBUSSNSACCOUNTBEFOREDATA_COPYTO_OFFSET UNITYSDK_OFFSET(0x94B5220)
#define RPG_CLIENT_HELIOBUSSNSACCOUNTBEFOREDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x94B5290)

namespace RPG::Client
{
	inline static constexpr unsigned int HeliobusSNSAccountBeforeData_TypeDefinitionIndex = 52201;
	...
	public:
		...
		::System::UInt32 Posts; // 0x24
		::System::UInt32 ActionDay; // 0x28
		::System::UInt32 Fans; // 0x2C
