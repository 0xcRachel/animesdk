...
#define RPG_CLIENT_HELIOBUSSNSACCOUNTBEFOREDATA_COPYTO_OFFSET UNITYSDK_OFFSET(0x165D45E0)
#define RPG_CLIENT_HELIOBUSSNSACCOUNTBEFOREDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x165D4650)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 Posts; // 0x14
		::System::UInt32 Incomes; // 0x18
		::System::UInt32 ActionDay; // 0x1C
		::System::UInt32 Fans; // 0x20
		::System::UInt32 PopPhase; // 0x24
		::System::Boolean IsAllFinish; // 0x28
		::System::UInt32 Likes; // 0x2C
