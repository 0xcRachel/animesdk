...
#define RPG_CLIENT_SHOTANIMMOVEMENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9F71D90)

namespace RPG::Client
{
	inline static constexpr unsigned int ShotAnimMovementData_TypeDefinitionIndex = 55377;
