...
#define RPG_CLIENT_TUTORIALRAYCASTER_GET_EVENTCAMERA_OFFSET UNITYSDK_OFFSET(0xA12CE00)
#define RPG_CLIENT_TUTORIALRAYCASTER_GET_SORTORDERPRIORITY_OFFSET UNITYSDK_OFFSET(0xA12CE30)
#define RPG_CLIENT_TUTORIALRAYCASTER_RAYCAST_OFFSET UNITYSDK_OFFSET(0xA12CE90)
#define RPG_CLIENT_TUTORIALRAYCASTER_SETTARGET_OFFSET UNITYSDK_OFFSET(0xA12CE40)
#define RPG_CLIENT_TUTORIALRAYCASTER__CTOR_OFFSET UNITYSDK_OFFSET(0xA12D070)

namespace RPG::Client
{
	inline static constexpr unsigned int TutorialRaycaster_TypeDefinitionIndex = 54835;
