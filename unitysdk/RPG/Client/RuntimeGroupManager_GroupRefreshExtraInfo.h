...
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_GROUPREFRESHEXTRAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x9F3FD70)

namespace RPG::Client
{
	inline static constexpr unsigned int RuntimeGroupManager_GroupRefreshExtraInfo_TypeDefinitionIndex = 49259;

	class RuntimeGroupManager_GroupRefreshExtraInfo : public ::System::Object
	{
	public:
		::System::Boolean IsAsync; // 0x10
		::RPG::Client::RuntimeGroupManager_CustomPredicatorType PredicatorType; // 0x14
		::RPG::Client::RuntimeGroupManager_GroupRefreshReason Reason; // 0x18
