...
#define RPG_CLIENT_ANIMATIONCLIPMOTIONPARAMS_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3836F80)
#define RPG_CLIENT_ANIMATIONCLIPMOTIONPARAMS___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3836F90)

namespace RPG::Client
{
	inline static constexpr unsigned int AnimationClipMotionParams_TypeDefinitionIndex = 68407;
