...
#define RPG_CLIENT_ANIMATIONCLIPMOTIONPARAMS_TOSTRING_OFFSET UNITYSDK_OFFSET(0x2240800)
#define RPG_CLIENT_ANIMATIONCLIPMOTIONPARAMS___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x2240810)

namespace RPG::Client
{
	inline static constexpr unsigned int AnimationClipMotionParams_TypeDefinitionIndex = 67455;
