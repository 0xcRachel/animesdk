...
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCACHE_GETSHOPAPPLIEDRECOMMENDATION_OFFSET UNITYSDK_OFFSET(0x177BAA00)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCACHE_ISSHOPDUELCONFIRMSKIPCHECKED_OFFSET UNITYSDK_OFFSET(0x177BAE40)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCACHE_ISSHOPITEMSLOTUNLOCKHINTSEEN_OFFSET UNITYSDK_OFFSET(0x177BADE0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCACHE_ISSHOPNEWRARITYSEEN_OFFSET UNITYSDK_OFFSET(0x177BA830)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCACHE_ISSHOPREFRESHUNLOCKHINTSEEN_OFFSET UNITYSDK_OFFSET(0x177BACA0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCACHE_ISSHOPSHOULDSKIPDUELCONFIRM_OFFSET UNITYSDK_OFFSET(0x177BAEE0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCACHE_ONENDROUNDBATTLESTAGE_OFFSET UNITYSDK_OFFSET(0x177B7C30)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCACHE_ONENDROUNDSHOPSTAGE_OFFSET UNITYSDK_OFFSET(0x177B7A70)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCACHE_RESETINMEMORYCACHE_OFFSET UNITYSDK_OFFSET(0x177BA5D0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCACHE_RESETINSESSIONCACHEWITHFORCESAVE_OFFSET UNITYSDK_OFFSET(0x177BA610)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCACHE_RESETPREFCACHE_OFFSET UNITYSDK_OFFSET(0x177BA3B0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCACHE_SETSHOPAPPLIEDRECOMMENDATION_OFFSET UNITYSDK_OFFSET(0x177BA8E0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCACHE_SETSHOPDUELCONFIRMSKIPCHECKED_OFFSET UNITYSDK_OFFSET(0x177BAE90)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCACHE_SETSHOPITEMSLOTUNLOCKHINTSEEN_OFFSET UNITYSDK_OFFSET(0x177BAD50)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCACHE_SETSHOPNEWRARITYSEEN_OFFSET UNITYSDK_OFFSET(0x177BA730)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCACHE_SETSHOPREFRESHUNLOCKHINTSEEN_OFFSET UNITYSDK_OFFSET(0x177BABA0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCACHE_SETSHOPSHOULDSKIPDUELCONFIRM_OFFSET UNITYSDK_OFFSET(0x177BAF30)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x177B7250)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ChimeraDuelGameSessionCache_TypeDefinitionIndex)->GetStaticField(0x10D40);
		}
		static ::System::Boolean* StaticGet__IsShopDuelConfirmSkipChecked()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ChimeraDuelGameSessionCache_TypeDefinitionIndex)->GetStaticField(0x10D41);
		}
