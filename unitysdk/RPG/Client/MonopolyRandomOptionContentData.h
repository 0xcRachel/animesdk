...
#define RPG_CLIENT_MONOPOLYRANDOMOPTIONCONTENTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x176170E0)
#define RPG_CLIENT_MONOPOLYRANDOMOPTIONCONTENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17617180)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 RandomOptionID; // 0x1C
		::System::UInt32 ExtraRollResult; // 0x20
