...
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_0F8F19F95968811E_OFFSET UNITYSDK_OFFSET(0x972E9C0)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_11B44307560B914A_OFFSET UNITYSDK_OFFSET(0x972C200)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_48BB9C73BC77AAA5_OFFSET UNITYSDK_OFFSET(0x972E5D0)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_4E79B4E99E5C3D83_OFFSET UNITYSDK_OFFSET(0x972E1A0)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_7070204E61FA9553_OFFSET UNITYSDK_OFFSET(0x972E7A0)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_71844229BB8A53C3_OFFSET UNITYSDK_OFFSET(0x972D860)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_8D2257AF3F64D853_OFFSET UNITYSDK_OFFSET(0x972A9C0)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_9633F0C7606850F0_OFFSET UNITYSDK_OFFSET(0x972A300)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_ACEEEF175975141F_OFFSET UNITYSDK_OFFSET(0x972C9A0)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_ADE65C435D7ECF4B_OFFSET UNITYSDK_OFFSET(0x972A6E0)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_B10F9C763249D5FB_OFFSET UNITYSDK_OFFSET(0x972A4C0)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_B2270891467A6E08_OFFSET UNITYSDK_OFFSET(0x972DBE0)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_B38B48E6FC310048_OFFSET UNITYSDK_OFFSET(0x972B810)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_B7150905C6969EA6_OFFSET UNITYSDK_OFFSET(0x972C580)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_CA9AD3D703CC4954_OFFSET UNITYSDK_OFFSET(0x972E430)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_CCE12794AD0BC1CF_OFFSET UNITYSDK_OFFSET(0x972EBA0)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_D945CEAD343B5366_OFFSET UNITYSDK_OFFSET(0x972E380)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_E30043CA2241A03B_OFFSET UNITYSDK_OFFSET(0x972A5F0)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN__CTOR_1_OFFSET UNITYSDK_OFFSET(0x972A200)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x972A130)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int FBIKChain_TypeDefinitionIndex = 60885;
