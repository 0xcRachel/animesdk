...
#define RPG_CLIENT_FULLBODY_GROUNDER_CLASS_3_50D343C44D28BEFB_9_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x154DB500)
#define RPG_CLIENT_FULLBODY_GROUNDER_CLASS_3_50D343C44D28BEFB_9_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x154DB530)
#define RPG_CLIENT_FULLBODY_GROUNDER_CLASS_3_50D343C44D28BEFB_9_INVOKE_OFFSET UNITYSDK_OFFSET(0x154DB260)
#define RPG_CLIENT_FULLBODY_GROUNDER_CLASS_3_50D343C44D28BEFB_9__CTOR_OFFSET UNITYSDK_OFFSET(0x154DB240)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int Grounder_Class_3_50D343C44D28BEFB_9_TypeDefinitionIndex = 68338;
