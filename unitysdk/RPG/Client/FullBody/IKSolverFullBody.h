...
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_021031D9935F927E_OFFSET UNITYSDK_OFFSET(0x92D37B0)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_0B7E3489D2C0938B_OFFSET UNITYSDK_OFFSET(0x92D5330)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_16975C26AC475304_OFFSET UNITYSDK_OFFSET(0x92D3A30)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_1947BC35B7A7FCB8_OFFSET UNITYSDK_OFFSET(0x92D4880)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_370B283A2686728C_OFFSET UNITYSDK_OFFSET(0x92D3AE0)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_388538BD99159606_OFFSET UNITYSDK_OFFSET(0x92D35E0)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_40EBA7013E4CCDDF_OFFSET UNITYSDK_OFFSET(0x92D52B0)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_4805283D59625FD9_OFFSET UNITYSDK_OFFSET(0x92D4680)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_5C5F7B9A709C2135_OFFSET UNITYSDK_OFFSET(0x92D4DE0)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_7142D89B39D12AB7_OFFSET UNITYSDK_OFFSET(0x92D3720)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_79638E65BEE6EF1F_OFFSET UNITYSDK_OFFSET(0x92D3E40)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_8E8B1DEC3F78455A_OFFSET UNITYSDK_OFFSET(0x92D4530)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_A59F33F8CA7F3A80_OFFSET UNITYSDK_OFFSET(0x92D4A90)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_BAD42A15E1550F87_OFFSET UNITYSDK_OFFSET(0x92D43A0)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_DAB65F30E4454DBE_OFFSET UNITYSDK_OFFSET(0x92D4110)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_F3A1044BBFF26F51_OFFSET UNITYSDK_OFFSET(0x92D3B90)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY__CTOR_OFFSET UNITYSDK_OFFSET(0x92D54E0)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKSolverFullBody_TypeDefinitionIndex = 59167;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_BAD42A15E1550F87_OFFSET))(this);
		}

		::System::Void Method_2_8E8B1DEC3F78455A()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_8E8B1DEC3F78455A_OFFSET))(this);
		}
