...
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_021031D9935F927E_OFFSET UNITYSDK_OFFSET(0x972F130)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_0B7E3489D2C0938B_OFFSET UNITYSDK_OFFSET(0x974A110)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_16975C26AC475304_OFFSET UNITYSDK_OFFSET(0x973D990)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_1947BC35B7A7FCB8_OFFSET UNITYSDK_OFFSET(0x9749650)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_370B283A2686728C_OFFSET UNITYSDK_OFFSET(0x973CC30)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_388538BD99159606_OFFSET UNITYSDK_OFFSET(0x9748A60)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_40EBA7013E4CCDDF_OFFSET UNITYSDK_OFFSET(0x974A090)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_4805283D59625FD9_OFFSET UNITYSDK_OFFSET(0x9749450)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_543F8938BA868A0C_OFFSET UNITYSDK_OFFSET(0x9749300)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_5C5F7B9A709C2135_OFFSET UNITYSDK_OFFSET(0x9749BB0)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_7142D89B39D12AB7_OFFSET UNITYSDK_OFFSET(0x9748BA0)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_79638E65BEE6EF1F_OFFSET UNITYSDK_OFFSET(0x973C8C0)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_A59F33F8CA7F3A80_OFFSET UNITYSDK_OFFSET(0x9749860)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_B3CBC181390C9CD1_OFFSET UNITYSDK_OFFSET(0x9749170)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_DAB65F30E4454DBE_OFFSET UNITYSDK_OFFSET(0x9748EE0)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_F3A1044BBFF26F51_OFFSET UNITYSDK_OFFSET(0x9748C30)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY__CTOR_OFFSET UNITYSDK_OFFSET(0x974A2C0)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKSolverFullBody_TypeDefinitionIndex = 60919;
