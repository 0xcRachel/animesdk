...
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_021031D9935F927E_OFFSET UNITYSDK_OFFSET(0x15FEA200)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_0507EB8022711947_OFFSET UNITYSDK_OFFSET(0x15FEAAE0)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_0B7E3489D2C0938B_OFFSET UNITYSDK_OFFSET(0x15FEBB20)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_16975C26AC475304_OFFSET UNITYSDK_OFFSET(0x15FEA460)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_26F5E793BB51FC71_OFFSET UNITYSDK_OFFSET(0x15FEA5B0)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_370B283A2686728C_OFFSET UNITYSDK_OFFSET(0x15FEA500)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_388538BD99159606_OFFSET UNITYSDK_OFFSET(0x15FEA070)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_4805283D59625FD9_OFFSET UNITYSDK_OFFSET(0x15FEAFC0)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_7142D89B39D12AB7_OFFSET UNITYSDK_OFFSET(0x15FEA180)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_79638E65BEE6EF1F_OFFSET UNITYSDK_OFFSET(0x15FEA840)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_7C2C2820B36B9508_OFFSET UNITYSDK_OFFSET(0x15FEB190)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_84B92802FDAFF6C8_OFFSET UNITYSDK_OFFSET(0x15FEAE80)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_921C3C3E09D59CD4_OFFSET UNITYSDK_OFFSET(0x15FEAD00)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_9E610EF313D0CC32_OFFSET UNITYSDK_OFFSET(0x15FEB670)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_A59F33F8CA7F3A80_OFFSET UNITYSDK_OFFSET(0x15FEB390)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_D1305BC17A89C222_OFFSET UNITYSDK_OFFSET(0x15FEBAB0)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY__CTOR_OFFSET UNITYSDK_OFFSET(0x15FEBCC0)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKSolverFullBody_TypeDefinitionIndex = 69342;
