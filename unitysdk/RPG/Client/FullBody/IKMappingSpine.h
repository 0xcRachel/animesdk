...
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_03F8818C1383CCD8_OFFSET UNITYSDK_OFFSET(0x154F1080)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_151E25A63D14DDB0_1_OFFSET UNITYSDK_OFFSET(0x154EEE50)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x154EEDB0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x154EFC00)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_2157CED3CDDF8996_OFFSET UNITYSDK_OFFSET(0x154EFC60)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_2F0DC1CA1AADEABC_OFFSET UNITYSDK_OFFSET(0x154F0180)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_3FBE0C585F4EF331_OFFSET UNITYSDK_OFFSET(0x154F0A20)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_6821143A80BCED87_OFFSET UNITYSDK_OFFSET(0x154EED20)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_6B0FB11F996F75D1_OFFSET UNITYSDK_OFFSET(0x154EEF00)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_8F59263A7D1D04F6_OFFSET UNITYSDK_OFFSET(0x154F0890)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_A461AC4695F6A5F0_OFFSET UNITYSDK_OFFSET(0x154F10D0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_BB9DE9323DE5A4F5_OFFSET UNITYSDK_OFFSET(0x154EE840)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_FC1A6F0C23BBD83A_OFFSET UNITYSDK_OFFSET(0x154F06B0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x154EEBB0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE__CTOR_OFFSET UNITYSDK_OFFSET(0x154EEAC0)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKMappingSpine_TypeDefinitionIndex = 68361;
