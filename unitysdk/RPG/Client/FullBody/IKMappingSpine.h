...
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_03F8818C1383CCD8_OFFSET UNITYSDK_OFFSET(0x9746500)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_151E25A63D14DDB0_1_OFFSET UNITYSDK_OFFSET(0x97442A0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x9744200)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x9745080)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_2157CED3CDDF8996_OFFSET UNITYSDK_OFFSET(0x97450E0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_2F0DC1CA1AADEABC_OFFSET UNITYSDK_OFFSET(0x9745600)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_39DB8586C0CDFDE2_OFFSET UNITYSDK_OFFSET(0x9744350)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_3FBE0C585F4EF331_OFFSET UNITYSDK_OFFSET(0x9745EA0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_6821143A80BCED87_OFFSET UNITYSDK_OFFSET(0x9744170)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_8F59263A7D1D04F6_OFFSET UNITYSDK_OFFSET(0x9745D10)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_A461AC4695F6A5F0_OFFSET UNITYSDK_OFFSET(0x9746550)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_BB5227825222DD2C_OFFSET UNITYSDK_OFFSET(0x9743C20)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_FC1A6F0C23BBD83A_OFFSET UNITYSDK_OFFSET(0x9745B30)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9743FE0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE__CTOR_OFFSET UNITYSDK_OFFSET(0x9743ED0)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKMappingSpine_TypeDefinitionIndex = 60912;
