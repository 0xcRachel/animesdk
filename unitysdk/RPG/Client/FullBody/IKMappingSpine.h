...
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_151E25A63D14DDB0_1_OFFSET UNITYSDK_OFFSET(0x1597B560)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x1597B4D0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x1597C1E0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_1C648BC3BB33C550_OFFSET UNITYSDK_OFFSET(0x1597D4C0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_1CBC2A1E5F49E55B_OFFSET UNITYSDK_OFFSET(0x1597B600)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_2157CED3CDDF8996_OFFSET UNITYSDK_OFFSET(0x1597C240)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_2F0DC1CA1AADEABC_OFFSET UNITYSDK_OFFSET(0x1597C6D0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_6821143A80BCED87_OFFSET UNITYSDK_OFFSET(0x1597B440)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_8F59263A7D1D04F6_OFFSET UNITYSDK_OFFSET(0x1597CD20)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_A980FB7965D4A13F_OFFSET UNITYSDK_OFFSET(0x1597D470)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_BB9DE9323DE5A4F5_OFFSET UNITYSDK_OFFSET(0x1597AF70)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_E789DC027CE67008_OFFSET UNITYSDK_OFFSET(0x1597CE90)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_FC1A6F0C23BBD83A_OFFSET UNITYSDK_OFFSET(0x1597CB60)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1597B2D0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1597B1E0)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKMappingSpine_TypeDefinitionIndex = 69335;
