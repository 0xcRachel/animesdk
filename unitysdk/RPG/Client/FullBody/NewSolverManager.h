...
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_DISABLE_OFFSET UNITYSDK_OFFSET(0x15500F60)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x15501730)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x15501800)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_METHOD_5_1808E1CF7A125519_1_OFFSET UNITYSDK_OFFSET(0x155016C0)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_METHOD_5_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x15501220)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x15501110)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_METHOD_5_62B963209E16F919_OFFSET UNITYSDK_OFFSET(0x155012A0)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_METHOD_5_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x15500BB0)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_METHOD_5_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x15500CB0)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x15500C30)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x15501070)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_START_OFFSET UNITYSDK_OFFSET(0x15501190)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_UPDATESOLVEREXTERNAL_OFFSET UNITYSDK_OFFSET(0x155018D0)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x155015F0)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x15500B60)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int NewSolverManager_TypeDefinitionIndex = 68381;
