...
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_DISABLE_OFFSET UNITYSDK_OFFSET(0x9755EF0)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x97566C0)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9756790)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_METHOD_5_1808E1CF7A125519_1_OFFSET UNITYSDK_OFFSET(0x9756650)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_METHOD_5_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x97561B0)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x97560A0)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_METHOD_5_62B963209E16F919_OFFSET UNITYSDK_OFFSET(0x9756230)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_METHOD_5_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x9755B40)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_METHOD_5_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x9755C40)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x9755BC0)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x9756000)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_START_OFFSET UNITYSDK_OFFSET(0x9756120)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_UPDATESOLVEREXTERNAL_OFFSET UNITYSDK_OFFSET(0x9756860)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x9756580)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x9755AF0)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int NewSolverManager_TypeDefinitionIndex = 60932;
