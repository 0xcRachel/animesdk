...
#define RPG_CLIENT_FULLBODY_GROUNDING_CLASS_3_443CA02E4E068003_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x973C540)
#define RPG_CLIENT_FULLBODY_GROUNDING_CLASS_3_443CA02E4E068003_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x973C640)
#define RPG_CLIENT_FULLBODY_GROUNDING_CLASS_3_443CA02E4E068003_INVOKE_OFFSET UNITYSDK_OFFSET(0x9735CE0)
#define RPG_CLIENT_FULLBODY_GROUNDING_CLASS_3_443CA02E4E068003__CTOR_OFFSET UNITYSDK_OFFSET(0x9739020)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int Grounding_Class_3_443CA02E4E068003_TypeDefinitionIndex = 60898;
