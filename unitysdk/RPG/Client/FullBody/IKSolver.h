...
#define RPG_CLIENT_FULLBODY_IKSOLVER_GET_INITIATED_OFFSET UNITYSDK_OFFSET(0x9746C10)
#define RPG_CLIENT_FULLBODY_IKSOLVER_METHOD_1_03E2B9212B4B6EAF_OFFSET UNITYSDK_OFFSET(0x9746BD0)
#define RPG_CLIENT_FULLBODY_IKSOLVER_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x9746C30)
#define RPG_CLIENT_FULLBODY_IKSOLVER_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x97465A0)
#define RPG_CLIENT_FULLBODY_IKSOLVER_METHOD_1_40E490E2772D5D75_OFFSET UNITYSDK_OFFSET(0x9746AA0)
#define RPG_CLIENT_FULLBODY_IKSOLVER_METHOD_1_479759059E440327_OFFSET UNITYSDK_OFFSET(0x9746B50)
#define RPG_CLIENT_FULLBODY_IKSOLVER_METHOD_1_48312DE5F57AE9EE_OFFSET UNITYSDK_OFFSET(0x9746C80)
#define RPG_CLIENT_FULLBODY_IKSOLVER_METHOD_1_8FD0952225841B46_OFFSET UNITYSDK_OFFSET(0x97469B0)
#define RPG_CLIENT_FULLBODY_IKSOLVER_METHOD_1_A33D4C2DBD15AB2A_OFFSET UNITYSDK_OFFSET(0x9746600)
#define RPG_CLIENT_FULLBODY_IKSOLVER_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x9746B00)
#define RPG_CLIENT_FULLBODY_IKSOLVER_METHOD_1_AD86BB23236ADD43_OFFSET UNITYSDK_OFFSET(0x9746DA0)
#define RPG_CLIENT_FULLBODY_IKSOLVER_METHOD_1_FA662896843C137A_OFFSET UNITYSDK_OFFSET(0x9746A40)
#define RPG_CLIENT_FULLBODY_IKSOLVER_SET_INITIATED_OFFSET UNITYSDK_OFFSET(0x9746C20)
#define RPG_CLIENT_FULLBODY_IKSOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x9747370)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKSolver_TypeDefinitionIndex = 60913;
