...
#define RPG_CLIENT_FULLBODY_IKSOLVER_CLASS_3_039EC88CFCC653F3_1_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x9748510)
#define RPG_CLIENT_FULLBODY_IKSOLVER_CLASS_3_039EC88CFCC653F3_1_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x9748560)
#define RPG_CLIENT_FULLBODY_IKSOLVER_CLASS_3_039EC88CFCC653F3_1_INVOKE_OFFSET UNITYSDK_OFFSET(0x9748220)
#define RPG_CLIENT_FULLBODY_IKSOLVER_CLASS_3_039EC88CFCC653F3_1__CTOR_OFFSET UNITYSDK_OFFSET(0x9748200)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKSolver_Class_3_039EC88CFCC653F3_1_TypeDefinitionIndex = 60918;
