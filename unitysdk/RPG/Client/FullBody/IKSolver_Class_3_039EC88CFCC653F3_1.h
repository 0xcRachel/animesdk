...
#define RPG_CLIENT_FULLBODY_IKSOLVER_CLASS_3_039EC88CFCC653F3_1_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x92D30D0)
#define RPG_CLIENT_FULLBODY_IKSOLVER_CLASS_3_039EC88CFCC653F3_1_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x92D3120)
#define RPG_CLIENT_FULLBODY_IKSOLVER_CLASS_3_039EC88CFCC653F3_1_INVOKE_OFFSET UNITYSDK_OFFSET(0x92D2CB0)
#define RPG_CLIENT_FULLBODY_IKSOLVER_CLASS_3_039EC88CFCC653F3_1__CTOR_OFFSET UNITYSDK_OFFSET(0x92D2C90)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKSolver_Class_3_039EC88CFCC653F3_1_TypeDefinitionIndex = 59166;
