...
#define RPG_CLIENT_FULLBODY_IKMAPPINGBONE_METHOD_2_03F8818C1383CCD8_OFFSET UNITYSDK_OFFSET(0x154ED210)
#define RPG_CLIENT_FULLBODY_IKMAPPINGBONE_METHOD_2_1053A0403E1C1BAA_OFFSET UNITYSDK_OFFSET(0x154ECDF0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGBONE_METHOD_2_7744894CEC41BF06_OFFSET UNITYSDK_OFFSET(0x154ECF30)
#define RPG_CLIENT_FULLBODY_IKMAPPINGBONE_METHOD_2_A461AC4695F6A5F0_OFFSET UNITYSDK_OFFSET(0x154ED260)
#define RPG_CLIENT_FULLBODY_IKMAPPINGBONE_METHOD_2_B1936CE4DA97AA45_1_OFFSET UNITYSDK_OFFSET(0x154ED100)
#define RPG_CLIENT_FULLBODY_IKMAPPINGBONE_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x154ECF80)
#define RPG_CLIENT_FULLBODY_IKMAPPINGBONE_METHOD_2_C4FDF5DB46830B8A_OFFSET UNITYSDK_OFFSET(0x154ED1A0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGBONE_METHOD_2_DB89C3F439E2B61F_OFFSET UNITYSDK_OFFSET(0x154ED020)
#define RPG_CLIENT_FULLBODY_IKMAPPINGBONE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x154ECEE0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGBONE__CTOR_OFFSET UNITYSDK_OFFSET(0x154ECE90)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKMappingBone_TypeDefinitionIndex = 68358;
