...
#define RPG_CLIENT_FULLBODY_IKMAPPINGBONE_METHOD_2_03F8818C1383CCD8_OFFSET UNITYSDK_OFFSET(0x9742580)
#define RPG_CLIENT_FULLBODY_IKMAPPINGBONE_METHOD_2_36FA1B7E64E1E8B3_OFFSET UNITYSDK_OFFSET(0x97420D0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGBONE_METHOD_2_7744894CEC41BF06_OFFSET UNITYSDK_OFFSET(0x9742270)
#define RPG_CLIENT_FULLBODY_IKMAPPINGBONE_METHOD_2_A461AC4695F6A5F0_OFFSET UNITYSDK_OFFSET(0x97425D0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGBONE_METHOD_2_ABE5700EAEB5AE29_OFFSET UNITYSDK_OFFSET(0x9742360)
#define RPG_CLIENT_FULLBODY_IKMAPPINGBONE_METHOD_2_B1936CE4DA97AA45_1_OFFSET UNITYSDK_OFFSET(0x9742470)
#define RPG_CLIENT_FULLBODY_IKMAPPINGBONE_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x97422C0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGBONE_METHOD_2_C4FDF5DB46830B8A_OFFSET UNITYSDK_OFFSET(0x9742510)
#define RPG_CLIENT_FULLBODY_IKMAPPINGBONE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9742200)
#define RPG_CLIENT_FULLBODY_IKMAPPINGBONE__CTOR_OFFSET UNITYSDK_OFFSET(0x97421A0)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKMappingBone_TypeDefinitionIndex = 60909;
