...
#define RPG_CLIENT_FULLBODY_IKMAPPINGBONE_METHOD_2_03F8818C1383CCD8_OFFSET UNITYSDK_OFFSET(0x92CCE80)
#define RPG_CLIENT_FULLBODY_IKMAPPINGBONE_METHOD_2_36FA1B7E64E1E8B3_OFFSET UNITYSDK_OFFSET(0x92CC9D0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGBONE_METHOD_2_7744894CEC41BF06_OFFSET UNITYSDK_OFFSET(0x92CCB70)
#define RPG_CLIENT_FULLBODY_IKMAPPINGBONE_METHOD_2_A461AC4695F6A5F0_OFFSET UNITYSDK_OFFSET(0x92CCED0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGBONE_METHOD_2_ABE5700EAEB5AE29_OFFSET UNITYSDK_OFFSET(0x92CCC60)
#define RPG_CLIENT_FULLBODY_IKMAPPINGBONE_METHOD_2_B1936CE4DA97AA45_1_OFFSET UNITYSDK_OFFSET(0x92CCD70)
#define RPG_CLIENT_FULLBODY_IKMAPPINGBONE_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x92CCBC0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGBONE_METHOD_2_C4FDF5DB46830B8A_OFFSET UNITYSDK_OFFSET(0x92CCE10)
#define RPG_CLIENT_FULLBODY_IKMAPPINGBONE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x92CCB00)
#define RPG_CLIENT_FULLBODY_IKMAPPINGBONE__CTOR_OFFSET UNITYSDK_OFFSET(0x92CCAA0)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKMappingBone_TypeDefinitionIndex = 59157;
