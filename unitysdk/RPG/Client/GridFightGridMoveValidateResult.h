...
#define RPG_CLIENT_GRIDFIGHTGRIDMOVEVALIDATERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x939B630)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightGridMoveValidateResult_TypeDefinitionIndex = 51521;
