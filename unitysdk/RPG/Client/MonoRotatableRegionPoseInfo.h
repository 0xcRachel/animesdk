...
#define RPG_CLIENT_MONOROTATABLEREGIONPOSEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x985D350)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoRotatableRegionPoseInfo_TypeDefinitionIndex = 54846;
