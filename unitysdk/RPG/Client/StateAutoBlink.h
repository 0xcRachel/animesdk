...
#define RPG_CLIENT_STATEAUTOBLINK_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x9FC0130)
#define RPG_CLIENT_STATEAUTOBLINK_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0x9FC03C0)
#define RPG_CLIENT_STATEAUTOBLINK_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9FC0210)
#define RPG_CLIENT_STATEAUTOBLINK__CTOR_OFFSET UNITYSDK_OFFSET(0x9FC0470)
#define RPG_CLIENT_STATEAUTOBLINK___IFIXBASEPROXY_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x9FC0490)
#define RPG_CLIENT_STATEAUTOBLINK___IFIXBASEPROXY_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0x9FC04B0)
#define RPG_CLIENT_STATEAUTOBLINK___IFIXBASEPROXY_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9FC04A0)

namespace RPG::Client
{
	inline static constexpr unsigned int StateAutoBlink_TypeDefinitionIndex = 54660;
