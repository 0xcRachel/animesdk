...
#define RPG_CLIENT_MONOREMAINTIMERTEXT_AWAKE_OFFSET UNITYSDK_OFFSET(0x9D3C200)
#define RPG_CLIENT_MONOREMAINTIMERTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9D3C7B0)
#define RPG_CLIENT_MONOREMAINTIMERTEXT__LOADPALETTE_OFFSET UNITYSDK_OFFSET(0x9D3C350)
#define RPG_CLIENT_MONOREMAINTIMERTEXT__ONREMAINTIMEEXPIRED_OFFSET UNITYSDK_OFFSET(0x9D3C740)
#define RPG_CLIENT_MONOREMAINTIMERTEXT__ONREMAINTIMEUPDATED_OFFSET UNITYSDK_OFFSET(0x9D3C490)
#define RPG_CLIENT_MONOREMAINTIMERTEXT__SETREMAINTIMETEXT_OFFSET UNITYSDK_OFFSET(0x9D3C4F0)
#define RPG_CLIENT_MONOREMAINTIMERTEXT__TRYINITPALETTE_OFFSET UNITYSDK_OFFSET(0x9D3C2F0)
#define RPG_CLIENT_MONOREMAINTIMERTEXT___IFIXBASEPROXY__ONREMAINTIMEEXPIRED_OFFSET UNITYSDK_OFFSET(0x9D3C840)
#define RPG_CLIENT_MONOREMAINTIMERTEXT___IFIXBASEPROXY__ONREMAINTIMEUPDATED_OFFSET UNITYSDK_OFFSET(0x9D3C7F0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoRemainTimerText_TypeDefinitionIndex = 59499;
