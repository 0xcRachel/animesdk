...
#define RPG_CLIENT_MONOREMAINTIMERTEXT_AWAKE_OFFSET UNITYSDK_OFFSET(0x17AED5B0)
#define RPG_CLIENT_MONOREMAINTIMERTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x17AEDAE0)
#define RPG_CLIENT_MONOREMAINTIMERTEXT__LOADPALETTE_OFFSET UNITYSDK_OFFSET(0x17AED700)
#define RPG_CLIENT_MONOREMAINTIMERTEXT__ONREMAINTIMEEXPIRED_OFFSET UNITYSDK_OFFSET(0x17AEDA70)
#define RPG_CLIENT_MONOREMAINTIMERTEXT__ONREMAINTIMEUPDATED_OFFSET UNITYSDK_OFFSET(0x17AED870)
#define RPG_CLIENT_MONOREMAINTIMERTEXT__SETREMAINTIMETEXT_OFFSET UNITYSDK_OFFSET(0x17AED8D0)
#define RPG_CLIENT_MONOREMAINTIMERTEXT__TRYINITPALETTE_OFFSET UNITYSDK_OFFSET(0x17AED6A0)
#define RPG_CLIENT_MONOREMAINTIMERTEXT___IFIXBASEPROXY__ONREMAINTIMEEXPIRED_OFFSET UNITYSDK_OFFSET(0x17AEDB70)
#define RPG_CLIENT_MONOREMAINTIMERTEXT___IFIXBASEPROXY__ONREMAINTIMEUPDATED_OFFSET UNITYSDK_OFFSET(0x17AEDB20)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoRemainTimerText_TypeDefinitionIndex = 67834;
