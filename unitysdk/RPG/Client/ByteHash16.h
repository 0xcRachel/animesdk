...
#define RPG_CLIENT_BYTEHASH16_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x23BD880)
#define RPG_CLIENT_BYTEHASH16_EQUALS_OFFSET UNITYSDK_OFFSET(0x23BD800)
#define RPG_CLIENT_BYTEHASH16_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x23BD890)
#define RPG_CLIENT_BYTEHASH16_METHOD_2_16CE6C53D61BC7E4_OFFSET UNITYSDK_OFFSET(0x1A6DE290)
#define RPG_CLIENT_BYTEHASH16_METHOD_2_47481B30F0B839BD_OFFSET UNITYSDK_OFFSET(0x1A6DE310)
#define RPG_CLIENT_BYTEHASH16_METHOD_2_7DC101B0AF1C5A10_OFFSET UNITYSDK_OFFSET(0x23BD770)
#define RPG_CLIENT_BYTEHASH16_METHOD_2_AC64FAF78AE39F81_OFFSET UNITYSDK_OFFSET(0x23BD760)
#define RPG_CLIENT_BYTEHASH16_METHOD_2_AD926EDA52F5878B_OFFSET UNITYSDK_OFFSET(0x23BD7F0)
#define RPG_CLIENT_BYTEHASH16_TOSTRING_OFFSET UNITYSDK_OFFSET(0x23BD7E0)
#define RPG_CLIENT_BYTEHASH16__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A6DE390)
#define RPG_CLIENT_BYTEHASH16__CTOR_1_OFFSET UNITYSDK_OFFSET(0x23BD750)
#define RPG_CLIENT_BYTEHASH16__CTOR_OFFSET UNITYSDK_OFFSET(0x608870)
#define RPG_CLIENT_BYTEHASH16___IFIXBASEPROXY_EQUALS_OFFSET UNITYSDK_OFFSET(0x23BD950)
#define RPG_CLIENT_BYTEHASH16___IFIXBASEPROXY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x23BD990)
#define RPG_CLIENT_BYTEHASH16___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x23BD8F0)
