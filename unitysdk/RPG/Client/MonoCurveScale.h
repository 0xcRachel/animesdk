...
#define RPG_CLIENT_MONOCURVESCALE_GENERATEREVERSECURVE_OFFSET UNITYSDK_OFFSET(0x978B5D0)
#define RPG_CLIENT_MONOCURVESCALE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x978B440)
#define RPG_CLIENT_MONOCURVESCALE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x978B550)
#define RPG_CLIENT_MONOCURVESCALE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x978B3B0)
#define RPG_CLIENT_MONOCURVESCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x978B960)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoCurveScale_TypeDefinitionIndex = 56603;
