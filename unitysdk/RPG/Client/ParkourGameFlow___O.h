...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Func_2<::RPG::Client::BaseGameFlow*, ::RPG::Client::BaseGameFlowContext*>**)Il2CppClass::FromTypeDefinitionIndex(ParkourGameFlow___O_TypeDefinitionIndex)->GetStaticField(0x1F20);
		}
	};
}
