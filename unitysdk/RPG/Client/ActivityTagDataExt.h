...
#define RPG_CLIENT_ACTIVITYTAGDATAEXT_CONTAINSTAG_OFFSET UNITYSDK_OFFSET(0x8BD1DD0)

namespace RPG::Client
{
	inline static constexpr unsigned int ActivityTagDataExt_TypeDefinitionIndex = 48930;
