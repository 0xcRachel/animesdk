...
#define RPG_CLIENT_FEATUREDATA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x15109BC0)
#define RPG_CLIENT_FEATUREDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x15109C00)
#define RPG_CLIENT_FEATUREDATA___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x15109C10)
