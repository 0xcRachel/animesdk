...
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCK_APPLY_1_OFFSET UNITYSDK_OFFSET(0x9419160)
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCK_APPLY_2_OFFSET UNITYSDK_OFFSET(0x94192F0)
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCK_APPLY_OFFSET UNITYSDK_OFFSET(0x9419010)
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCK_AWAKE_OFFSET UNITYSDK_OFFSET(0x9419570)
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9419A00)
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCK_LATETICK_OFFSET UNITYSDK_OFFSET(0x9419E90)
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCK_METHOD_5_07BB45288DFF8852_OFFSET UNITYSDK_OFFSET(0x9419760)
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCK_METHOD_5_DB67EEFB041425EC_OFFSET UNITYSDK_OFFSET(0x941A2E0)
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCK_METHOD_5_DDFCBBB54CA12CE0_OFFSET UNITYSDK_OFFSET(0x9419A50)
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCK_METHOD_5_EAA98911AD2C0AE4_OFFSET UNITYSDK_OFFSET(0x941A030)
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x941A9C0)
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCK_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x941A930)
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCK_ONENABLE_OFFSET UNITYSDK_OFFSET(0x941A8A0)
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCK_RESET_OFFSET UNITYSDK_OFFSET(0x9419710)
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCK_RETRIVEORIGINDATA_OFFSET UNITYSDK_OFFSET(0x9418EE0)
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCK__CCTOR_OFFSET UNITYSDK_OFFSET(0x941AA70)
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x941AA60)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::RPG::Client::RPGProfilerMarker**)Il2CppClass::FromTypeDefinitionIndex(CommonEffectMaterialBlock_TypeDefinitionIndex)->GetStaticField(0x47B00);
		}
