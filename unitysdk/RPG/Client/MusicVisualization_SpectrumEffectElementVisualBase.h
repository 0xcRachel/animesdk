...
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTVISUALBASE_METHOD_1_1B839C6E2E9774D0_1_OFFSET UNITYSDK_OFFSET(0x9908800)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTVISUALBASE_METHOD_1_1B839C6E2E9774D0_OFFSET UNITYSDK_OFFSET(0x9908630)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTVISUALBASE_METHOD_1_818C8938061AC0D4_OFFSET UNITYSDK_OFFSET(0x9913470)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTVISUALBASE_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x9913430)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTVISUALBASE_METHOD_1_D76778020DDB2FEC_OFFSET UNITYSDK_OFFSET(0x99081F0)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTVISUALBASE_METHOD_1_E9A575D18A0748D9_OFFSET UNITYSDK_OFFSET(0x9909410)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTVISUALBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x99136D0)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicVisualization_SpectrumEffectElementVisualBase_TypeDefinitionIndex = 56457;
