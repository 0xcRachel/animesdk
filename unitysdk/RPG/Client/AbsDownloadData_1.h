...
{
	inline static constexpr unsigned int AbsDownloadData_1_TypeDefinitionIndex = 47012;
	...
	public:
		...
		::RPG::Client::DelayList_1<::Class_0_16E4307DCC419505_42*>* _BlockItems_k__BackingField; // 0x0
