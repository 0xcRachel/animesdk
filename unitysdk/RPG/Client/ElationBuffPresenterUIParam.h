...
#define RPG_CLIENT_ELATIONBUFFPRESENTERUIPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x90F1190)

namespace RPG::Client
{
	inline static constexpr unsigned int ElationBuffPresenterUIParam_TypeDefinitionIndex = 56735;

	class ElationBuffPresenterUIParam : public ::System::Object
	{
	public:
		::RPG::Client::NodeListViewPanel_1<::Class_2_F76E966DD50AB39A*>* ElationBuffList; // 0x10
