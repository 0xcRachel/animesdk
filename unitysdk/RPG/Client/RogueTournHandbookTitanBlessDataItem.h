...
#define RPG_CLIENT_ROGUETOURNHANDBOOKTITANBLESSDATAITEM_CREATE_OFFSET UNITYSDK_OFFSET(0xA3A4D80)
#define RPG_CLIENT_ROGUETOURNHANDBOOKTITANBLESSDATAITEM_GET_DESC_OFFSET UNITYSDK_OFFSET(0xA3A5000)
#define RPG_CLIENT_ROGUETOURNHANDBOOKTITANBLESSDATAITEM_GET_EXTRAEFFECTIDS_OFFSET UNITYSDK_OFFSET(0xA3A5020)
#define RPG_CLIENT_ROGUETOURNHANDBOOKTITANBLESSDATAITEM_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xA3A4FE0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKTITANBLESSDATAITEM_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xA3A50E0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKTITANBLESSDATAITEM_GET_LOCKEDDESC_OFFSET UNITYSDK_OFFSET(0xA3A5040)
#define RPG_CLIENT_ROGUETOURNHANDBOOKTITANBLESSDATAITEM_GET_NAMEWITHAVATAR_OFFSET UNITYSDK_OFFSET(0xA3A4FC0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKTITANBLESSDATAITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0xA3A4F30)
#define RPG_CLIENT_ROGUETOURNHANDBOOKTITANBLESSDATAITEM_GET_TITANBLESSID_OFFSET UNITYSDK_OFFSET(0xA3A4EB0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKTITANBLESSDATAITEM_GET_TITANBLESSLEVEL_OFFSET UNITYSDK_OFFSET(0xA3A4EF0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKTITANBLESSDATAITEM_GET_TITANCATEGORY_OFFSET UNITYSDK_OFFSET(0xA3A4F10)
#define RPG_CLIENT_ROGUETOURNHANDBOOKTITANBLESSDATAITEM_GET_TITANTYPE_OFFSET UNITYSDK_OFFSET(0xA3A4ED0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKTITANBLESSDATAITEM_SET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xA3A50F0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKTITANBLESSDATAITEM_SYNCUNLOCKED_OFFSET UNITYSDK_OFFSET(0xA3A4E60)
#define RPG_CLIENT_ROGUETOURNHANDBOOKTITANBLESSDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xA3A4D70)
