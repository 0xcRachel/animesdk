...
#define RPG_CLIENT_POSCONSTRAINTBONES__CTOR_OFFSET UNITYSDK_OFFSET(0x9B2E910)

namespace RPG::Client
{
	inline static constexpr unsigned int PosConstraintBones_TypeDefinitionIndex = 55936;
