...
#define RPG_CLIENT_CURVEEDGEPOINTTRIGGERSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x8FE6DE0)

namespace RPG::Client
{
	inline static constexpr unsigned int CurveEdgePointTriggerSetting_TypeDefinitionIndex = 54417;
