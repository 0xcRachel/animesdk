...
#define RPG_CLIENT_PARTIALFLIPDEVICECOMPONENT___C__DISPLAYCLASS42_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9A504C0)
#define RPG_CLIENT_PARTIALFLIPDEVICECOMPONENT___C__DISPLAYCLASS42_0___ONREFRESHSTATE_B__0_OFFSET UNITYSDK_OFFSET(0x9A50A10)
#define RPG_CLIENT_PARTIALFLIPDEVICECOMPONENT___C__DISPLAYCLASS42_0___ONREFRESHSTATE_B__1_OFFSET UNITYSDK_OFFSET(0x9A50A40)

namespace RPG::Client
{
	inline static constexpr unsigned int PartialFlipDeviceComponent___c__DisplayClass42_0_TypeDefinitionIndex = 58435;
