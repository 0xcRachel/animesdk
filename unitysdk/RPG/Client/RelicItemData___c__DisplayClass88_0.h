...
#define RPG_CLIENT_RELICITEMDATA___C__DISPLAYCLASS88_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9D91130)
#define RPG_CLIENT_RELICITEMDATA___C__DISPLAYCLASS88_0___SORTREFORGESUBAFFIXES_B__0_OFFSET UNITYSDK_OFFSET(0x9D911D0)

namespace RPG::Client
{
	inline static constexpr unsigned int RelicItemData___c__DisplayClass88_0_TypeDefinitionIndex = 53262;
