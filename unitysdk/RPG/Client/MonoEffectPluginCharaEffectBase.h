...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_COMPAREPRIORITY_OFFSET UNITYSDK_OFFSET(0x97C5680)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_COPYORIGINMATERIALCHARACTERCOMMONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x97C5740)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_DESTROYPLUGIN_OFFSET UNITYSDK_OFFSET(0x97C9610)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0x97C6A90)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0x97C9650)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_GETINSTANCEMATERIALS_OFFSET UNITYSDK_OFFSET(0x97C4DD0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_GETRENDERINSTANCEDMATERIALMAP_OFFSET UNITYSDK_OFFSET(0x97C5020)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_GETTARGETRENDERERLIST_OFFSET UNITYSDK_OFFSET(0x97C4FD0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_GET_ISAPPLY_OFFSET UNITYSDK_OFFSET(0x97CA340)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_GET_ISEDITORMODE_OFFSET UNITYSDK_OFFSET(0x97C6A70)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_GET_ISSUBPLUGIN_OFFSET UNITYSDK_OFFSET(0x97CE740)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_GET_ISTARGETPARTMONSTER_OFFSET UNITYSDK_OFFSET(0x97CE720)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_GET_PARENTPLUGIN_OFFSET UNITYSDK_OFFSET(0x97CE760)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_GET__ISAPPLY_OFFSET UNITYSDK_OFFSET(0x97CE780)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_GET__ISRESET_OFFSET UNITYSDK_OFFSET(0x97CE7A0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_IGNOREINEDITOR_OFFSET UNITYSDK_OFFSET(0x97C6A30)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_ISCONFLICT_OFFSET UNITYSDK_OFFSET(0x97C5150)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_ISTARGETGROUPLEADER_OFFSET UNITYSDK_OFFSET(0x97C5070)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_0AC350B64D89A1AE_1_OFFSET UNITYSDK_OFFSET(0x97C9810)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_0AC350B64D89A1AE_2_OFFSET UNITYSDK_OFFSET(0x97C93C0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_0AC350B64D89A1AE_OFFSET UNITYSDK_OFFSET(0x97C89F0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_0E549C9E38D0E257_OFFSET UNITYSDK_OFFSET(0x97C59D0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_0F219594B5F172AE_OFFSET UNITYSDK_OFFSET(0x97CBF80)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x97CE5C0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_1FE2B10286A019B7_OFFSET UNITYSDK_OFFSET(0x97C94C0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_20139550C8206D50_OFFSET UNITYSDK_OFFSET(0x97C7280)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_2A5F76182A02F976_OFFSET UNITYSDK_OFFSET(0x97C9AF0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_2BC55A66CB2B0118_OFFSET UNITYSDK_OFFSET(0x97CC710)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_33E2FA8E6403B93D_OFFSET UNITYSDK_OFFSET(0x97C8DA0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_3AC067C2C6518EDA_OFFSET UNITYSDK_OFFSET(0x97CD290)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_3CEE9D93D2EBC326_OFFSET UNITYSDK_OFFSET(0x97CCE30)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_3EBE3F136A41CCD9_OFFSET UNITYSDK_OFFSET(0x97C5D00)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_41F5D9C0F0A306F5_OFFSET UNITYSDK_OFFSET(0x97CC390)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_4529D5FBB820A524_OFFSET UNITYSDK_OFFSET(0x97C68B0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_508D4DD02D3DB74E_OFFSET UNITYSDK_OFFSET(0x97CBA70)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_591CEBEAFC47406B_OFFSET UNITYSDK_OFFSET(0x97C7970)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_5E72916301E347E2_OFFSET UNITYSDK_OFFSET(0x97C5EA0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_6AE9C0C7D4D137B0_OFFSET UNITYSDK_OFFSET(0x97C6000)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_712E1FA01E5693FE_OFFSET UNITYSDK_OFFSET(0x97CA030)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_714674645EE1CBCA_OFFSET UNITYSDK_OFFSET(0x97CB6E0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_74FE0F242303E029_OFFSET UNITYSDK_OFFSET(0x97CCF30)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_81FEFD1B22CE37A2_OFFSET UNITYSDK_OFFSET(0x97C74B0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_8B1FA4185C7C0938_1_OFFSET UNITYSDK_OFFSET(0x97C4CB0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_8B1FA4185C7C0938_OFFSET UNITYSDK_OFFSET(0x97C4B90)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_9079FE2639801498_1_OFFSET UNITYSDK_OFFSET(0x97CE440)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_9079FE2639801498_OFFSET UNITYSDK_OFFSET(0x97CE1D0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_946586516B7DFBDB_OFFSET UNITYSDK_OFFSET(0x97CA4E0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_9C08DA5C1FAA2B3E_OFFSET UNITYSDK_OFFSET(0x97CD4E0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_9FA0F2F97B19BDFF_OFFSET UNITYSDK_OFFSET(0x97CD3D0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_A44A18C9451109E4_OFFSET UNITYSDK_OFFSET(0x97CBD80)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_A80796DA5203C46C_OFFSET UNITYSDK_OFFSET(0x97CCEA0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_B2B7B6D6D6477556_OFFSET UNITYSDK_OFFSET(0x97CA360)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_C081D0F1BA12AC56_OFFSET UNITYSDK_OFFSET(0x97C9910)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_C5DCE2A551C0E81B_OFFSET UNITYSDK_OFFSET(0x97CBB50)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_C6C47C9FFA92653C_1_OFFSET UNITYSDK_OFFSET(0x97C8CC0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_C6C47C9FFA92653C_OFFSET UNITYSDK_OFFSET(0x97CE640)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_D0FA121921ED01A5_OFFSET UNITYSDK_OFFSET(0x97C99F0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_D155D4917B3D2C6A_OFFSET UNITYSDK_OFFSET(0x97CC5A0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_DAB3177560EA0C5C_OFFSET UNITYSDK_OFFSET(0x97CAC70)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_E26C99C52BC1E654_OFFSET UNITYSDK_OFFSET(0x97CB7C0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_E844C30991F3F8DC_OFFSET UNITYSDK_OFFSET(0x97CA3D0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_EA1C78EF39610042_OFFSET UNITYSDK_OFFSET(0x97C9C80)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_F0BD65B017F2AC0B_OFFSET UNITYSDK_OFFSET(0x97C7140)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_F1FEBBADC39F3EAB_OFFSET UNITYSDK_OFFSET(0x97CCA40)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_F5447CD65612575D_OFFSET UNITYSDK_OFFSET(0x97C8AF0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_F94757253A563A02_1_OFFSET UNITYSDK_OFFSET(0x97CD9D0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_F94757253A563A02_OFFSET UNITYSDK_OFFSET(0x97CD640)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_REMOVESUBPLUGIN_OFFSET UNITYSDK_OFFSET(0x97C5C20)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0x97C6270)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_SETCHARAEFFECTENABLE_OFFSET UNITYSDK_OFFSET(0x97A5EF0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_SETOTHEREFFECTTARGET_OFFSET UNITYSDK_OFFSET(0x97C5DA0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_SETSUBPLUGIN_OFFSET UNITYSDK_OFFSET(0x97C5BD0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_SET_ISSUBPLUGIN_OFFSET UNITYSDK_OFFSET(0x97CE750)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_SET_ISTARGETPARTMONSTER_OFFSET UNITYSDK_OFFSET(0x97CE730)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_SET_PARENTPLUGIN_OFFSET UNITYSDK_OFFSET(0x97CE770)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_SET__ISAPPLY_OFFSET UNITYSDK_OFFSET(0x97CE790)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_SET__ISRESET_OFFSET UNITYSDK_OFFSET(0x97CE7B0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_TRYCREATESUBPLUGIN_OFFSET UNITYSDK_OFFSET(0x97B8130)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x97CE7C0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE___IFIXBASEPROXY_DESTROYPLUGIN_OFFSET UNITYSDK_OFFSET(0x97CE990)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE___IFIXBASEPROXY_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0x97CE9D0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE___IFIXBASEPROXY_IGNOREINEDITOR_OFFSET UNITYSDK_OFFSET(0x97CE950)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaEffectBase_TypeDefinitionIndex = 55650;
	...
	public:
		...
		::System::Void Method_6_4529D5FBB820A524(::RPG::Client::MonoEffect* a1)
		{
			return ((::System::Void(*)(::PVOID, ::RPG::Client::MonoEffect*))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_4529D5FBB820A524_OFFSET))(this, a1);
		}
