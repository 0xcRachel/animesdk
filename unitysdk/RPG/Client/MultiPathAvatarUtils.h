...
#define RPG_CLIENT_MULTIPATHAVATARUTILS_CANCHANGETOSPECIFICAVATARPATH_OFFSET UNITYSDK_OFFSET(0x13738E20)
#define RPG_CLIENT_MULTIPATHAVATARUTILS_CHANGEHEROIDTOANOTHERGENDER_OFFSET UNITYSDK_OFFSET(0x137389D0)
#define RPG_CLIENT_MULTIPATHAVATARUTILS_CHANGEHEROIDTOCURRENTGENDER_OFFSET UNITYSDK_OFFSET(0x13738C20)
#define RPG_CLIENT_MULTIPATHAVATARUTILS_CONVERTBASEIDTOREAL_OFFSET UNITYSDK_OFFSET(0x137383F0)
#define RPG_CLIENT_MULTIPATHAVATARUTILS_CONVERTREALIDTOBASE_OFFSET UNITYSDK_OFFSET(0x137382E0)
#define RPG_CLIENT_MULTIPATHAVATARUTILS_CONVERTTOPLAYERGENDERAVATARID_OFFSET UNITYSDK_OFFSET(0x137387A0)
#define RPG_CLIENT_MULTIPATHAVATARUTILS_GETAVATARGENDERTYPE_OFFSET UNITYSDK_OFFSET(0x13733FB0)
#define RPG_CLIENT_MULTIPATHAVATARUTILS_GETCURRENTHEROREALID_OFFSET UNITYSDK_OFFSET(0x13738740)
#define RPG_CLIENT_MULTIPATHAVATARUTILS_GETMALEHEROID_OFFSET UNITYSDK_OFFSET(0x13738B60)
#define RPG_CLIENT_MULTIPATHAVATARUTILS_INITEXCELDATACACHE_OFFSET UNITYSDK_OFFSET(0x137381F0)
#define RPG_CLIENT_MULTIPATHAVATARUTILS_ISHEROID_OFFSET UNITYSDK_OFFSET(0x137345A0)
#define RPG_CLIENT_MULTIPATHAVATARUTILS_ISMULTIPATHAVATAR_OFFSET UNITYSDK_OFFSET(0x137384C0)
#define RPG_CLIENT_MULTIPATHAVATARUTILS_ISSHOWAVATARPATHCHANGEBTN_OFFSET UNITYSDK_OFFSET(0x137385D0)
#define RPG_CLIENT_MULTIPATHAVATARUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x13738F00)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::MultiPathAvatarUtils_MultiPathAvatarCache>**)Il2CppClass::FromTypeDefinitionIndex(MultiPathAvatarUtils_TypeDefinitionIndex)->GetStaticField(0x5F5A0);
		}
