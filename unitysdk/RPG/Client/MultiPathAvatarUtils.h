...
#define RPG_CLIENT_MULTIPATHAVATARUTILS_CANCHANGETOSPECIFICAVATARPATH_OFFSET UNITYSDK_OFFSET(0x98D3350)
#define RPG_CLIENT_MULTIPATHAVATARUTILS_CHANGEHEROIDTOANOTHERGENDER_OFFSET UNITYSDK_OFFSET(0x98D2FA0)
#define RPG_CLIENT_MULTIPATHAVATARUTILS_CHANGEHEROIDTOCURRENTGENDER_OFFSET UNITYSDK_OFFSET(0x98D31B0)
#define RPG_CLIENT_MULTIPATHAVATARUTILS_CONVERTBASEIDTOREAL_OFFSET UNITYSDK_OFFSET(0x98D2A70)
#define RPG_CLIENT_MULTIPATHAVATARUTILS_CONVERTREALIDTOBASE_OFFSET UNITYSDK_OFFSET(0x98D15A0)
#define RPG_CLIENT_MULTIPATHAVATARUTILS_CONVERTTOPLAYERGENDERAVATARID_OFFSET UNITYSDK_OFFSET(0x98D2DA0)
#define RPG_CLIENT_MULTIPATHAVATARUTILS_GETAVATARGENDERTYPE_OFFSET UNITYSDK_OFFSET(0x98CEC10)
#define RPG_CLIENT_MULTIPATHAVATARUTILS_GETCURRENTHEROREALID_OFFSET UNITYSDK_OFFSET(0x98D2D40)
#define RPG_CLIENT_MULTIPATHAVATARUTILS_GETMALEHEROID_OFFSET UNITYSDK_OFFSET(0x98D30F0)
#define RPG_CLIENT_MULTIPATHAVATARUTILS_INITEXCELDATACACHE_OFFSET UNITYSDK_OFFSET(0x98D2980)
#define RPG_CLIENT_MULTIPATHAVATARUTILS_ISHEROID_OFFSET UNITYSDK_OFFSET(0x98CF1F0)
#define RPG_CLIENT_MULTIPATHAVATARUTILS_ISMULTIPATHAVATAR_OFFSET UNITYSDK_OFFSET(0x98D2B40)
#define RPG_CLIENT_MULTIPATHAVATARUTILS_ISSHOWAVATARPATHCHANGEBTN_OFFSET UNITYSDK_OFFSET(0x98D2C50)
#define RPG_CLIENT_MULTIPATHAVATARUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x98D3430)

namespace RPG::Client
{
	inline static constexpr unsigned int MultiPathAvatarUtils_TypeDefinitionIndex = 52788;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::MultiPathAvatarUtils_MultiPathAvatarCache>**)Il2CppClass::FromTypeDefinitionIndex(MultiPathAvatarUtils_TypeDefinitionIndex)->GetStaticField(0x41BF0);
		}
