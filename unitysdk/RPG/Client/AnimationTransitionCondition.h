...
#define RPG_CLIENT_ANIMATIONTRANSITIONCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x8C7F500)

namespace RPG::Client
{
	inline static constexpr unsigned int AnimationTransitionCondition_TypeDefinitionIndex = 54667;
