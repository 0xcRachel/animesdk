...
#define RPG_CLIENT_RPGPROFILERMARKERWITHSTRINGDATA_BEGIN_OFFSET UNITYSDK_OFFSET(0x17AD7800)
#define RPG_CLIENT_RPGPROFILERMARKERWITHSTRINGDATA_END_OFFSET UNITYSDK_OFFSET(0x17AD7880)
#define RPG_CLIENT_RPGPROFILERMARKERWITHSTRINGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17AD7730)

namespace RPG::Client
{
	inline static constexpr unsigned int RPGProfilerMarkerWithStringData_TypeDefinitionIndex = 26896;
