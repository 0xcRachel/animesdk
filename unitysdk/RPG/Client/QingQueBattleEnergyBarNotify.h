...
#define RPG_CLIENT_QINGQUEBATTLEENERGYBARNOTIFY__CTOR_OFFSET UNITYSDK_OFFSET(0xA24A5C0)

namespace RPG::Client
{
	inline static constexpr unsigned int QingQueBattleEnergyBarNotify_TypeDefinitionIndex = 58825;
