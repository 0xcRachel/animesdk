...
#define RPG_CLIENT_CHALLENGEDATA_CHALLENGEOPENRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0xCB340)

namespace RPG::Client
{
	inline static constexpr unsigned int ChallengeData_ChallengeOpenResult_TypeDefinitionIndex = 50058;
