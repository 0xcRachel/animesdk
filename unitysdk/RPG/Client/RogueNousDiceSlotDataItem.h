...
#define RPG_CLIENT_ROGUENOUSDICESLOTDATAITEM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16357A80)
#define RPG_CLIENT_ROGUENOUSDICESLOTDATAITEM_GET_CUREQUIPPEDSURFACE_OFFSET UNITYSDK_OFFSET(0x16357CD0)
#define RPG_CLIENT_ROGUENOUSDICESLOTDATAITEM_GET_DEFAULTBUILDSURFACEID_OFFSET UNITYSDK_OFFSET(0x163581E0)
#define RPG_CLIENT_ROGUENOUSDICESLOTDATAITEM_GET_EXTRARARITYUNLOCKED_OFFSET UNITYSDK_OFFSET(0x16358570)
#define RPG_CLIENT_ROGUENOUSDICESLOTDATAITEM_GET_ISAUTOUNLOCKED_OFFSET UNITYSDK_OFFSET(0x163584D0)
#define RPG_CLIENT_ROGUENOUSDICESLOTDATAITEM_GET_ISLOCKED_OFFSET UNITYSDK_OFFSET(0x16357CB0)
#define RPG_CLIENT_ROGUENOUSDICESLOTDATAITEM_GET_MAXRARITY_OFFSET UNITYSDK_OFFSET(0x16357BA0)
#define RPG_CLIENT_ROGUENOUSDICESLOTDATAITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0x16358330)
#define RPG_CLIENT_ROGUENOUSDICESLOTDATAITEM_GET_SLOTID_OFFSET UNITYSDK_OFFSET(0x16357B80)
#define RPG_CLIENT_ROGUENOUSDICESLOTDATAITEM_GET_SUGGESTIVEBUILDSURFACEID_OFFSET UNITYSDK_OFFSET(0x163581F0)
#define RPG_CLIENT_ROGUENOUSDICESLOTDATAITEM_GET_SURFACEICONPATH_OFFSET UNITYSDK_OFFSET(0x163580E0)
#define RPG_CLIENT_ROGUENOUSDICESLOTDATAITEM_GET_UNLOCKMETHODDESC_OFFSET UNITYSDK_OFFSET(0x16358210)
#define RPG_CLIENT_ROGUENOUSDICESLOTDATAITEM_GET_UPGRADEDNAME_OFFSET UNITYSDK_OFFSET(0x16358400)
#define RPG_CLIENT_ROGUENOUSDICESLOTDATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0x16357B20)
#define RPG_CLIENT_ROGUENOUSDICESLOTDATAITEM_SETCUSTOMBUILDSURFACEID_OFFSET UNITYSDK_OFFSET(0x16357AD0)
#define RPG_CLIENT_ROGUENOUSDICESLOTDATAITEM_SETDEFAULTBUILDSURFACEID_OFFSET UNITYSDK_OFFSET(0x163547C0)
#define RPG_CLIENT_ROGUENOUSDICESLOTDATAITEM_SETSUGGESTIVEBUILDSURFACEID_OFFSET UNITYSDK_OFFSET(0x16354810)
#define RPG_CLIENT_ROGUENOUSDICESLOTDATAITEM_SET_ISLOCKED_OFFSET UNITYSDK_OFFSET(0x16357CC0)
#define RPG_CLIENT_ROGUENOUSDICESLOTDATAITEM_SET_SLOTID_OFFSET UNITYSDK_OFFSET(0x16357B90)
#define RPG_CLIENT_ROGUENOUSDICESLOTDATAITEM_SET_SUGGESTIVEBUILDSURFACEID_OFFSET UNITYSDK_OFFSET(0x16358200)
#define RPG_CLIENT_ROGUENOUSDICESLOTDATAITEM_SYNC_OFFSET UNITYSDK_OFFSET(0x16354130)
#define RPG_CLIENT_ROGUENOUSDICESLOTDATAITEM_UNLOCKEXTRARARITY_OFFSET UNITYSDK_OFFSET(0x16354190)
#define RPG_CLIENT_ROGUENOUSDICESLOTDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x16354750)
...
namespace RPG::Client
{
	...
	{
	public:
		::System::UInt32 _SuggestiveBuildSurfaceID_k__BackingField; // 0x10
		::System::UInt32 _CustomBuildSurfaceID; // 0x14
		::System::UInt32 _DefaultBuildSurfaceID; // 0x18
		::System::Boolean _IsLocked_k__BackingField; // 0x1C
		::System::Boolean _ExtraRarityUnlocked; // 0x1D
