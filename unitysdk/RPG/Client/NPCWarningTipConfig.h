...
#define RPG_CLIENT_NPCWARNINGTIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x991CC40)

namespace RPG::Client
{
	inline static constexpr unsigned int NPCWarningTipConfig_TypeDefinitionIndex = 54900;
