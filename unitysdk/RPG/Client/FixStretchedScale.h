...
#define RPG_CLIENT_FIXSTRETCHEDSCALE_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x9296290)
#define RPG_CLIENT_FIXSTRETCHEDSCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x92962E0)
#define RPG_CLIENT_FIXSTRETCHEDSCALE___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x9296300)

namespace RPG::Client
{
	inline static constexpr unsigned int FixStretchedScale_TypeDefinitionIndex = 56243;
