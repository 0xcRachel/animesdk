...
#define RPG_CLIENT_COMPOSEITEMCOST_CLEAR_OFFSET UNITYSDK_OFFSET(0x8FC7AE0)
#define RPG_CLIENT_COMPOSEITEMCOST__CTOR_OFFSET UNITYSDK_OFFSET(0x8FC7B60)

namespace RPG::Client
{
	inline static constexpr unsigned int ComposeItemCost_TypeDefinitionIndex = 52261;
