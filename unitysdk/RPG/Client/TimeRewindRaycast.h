...
#define RPG_CLIENT_TIMEREWINDRAYCAST__CTOR_OFFSET UNITYSDK_OFFSET(0xA09F440)

namespace RPG::Client
{
	inline static constexpr unsigned int TimeRewindRaycast_TypeDefinitionIndex = 48220;
