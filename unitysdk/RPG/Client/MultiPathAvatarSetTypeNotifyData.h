...
#define RPG_CLIENT_MULTIPATHAVATARSETTYPENOTIFYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x98CEDC0)

namespace RPG::Client
{
	inline static constexpr unsigned int MultiPathAvatarSetTypeNotifyData_TypeDefinitionIndex = 52787;
