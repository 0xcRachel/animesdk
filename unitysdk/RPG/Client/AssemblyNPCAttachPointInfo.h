...
#define RPG_CLIENT_ASSEMBLYNPCATTACHPOINTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x8C96C10)

namespace RPG::Client
{
	inline static constexpr unsigned int AssemblyNPCAttachPointInfo_TypeDefinitionIndex = 47570;
