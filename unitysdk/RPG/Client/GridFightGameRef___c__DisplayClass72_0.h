...
#define RPG_CLIENT_GRIDFIGHTGAMEREF___C__DISPLAYCLASS72_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9375F10)
#define RPG_CLIENT_GRIDFIGHTGAMEREF___C__DISPLAYCLASS72_0__UNLIKE_B__0_OFFSET UNITYSDK_OFFSET(0x9378A20)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightGameRef___c__DisplayClass72_0_TypeDefinitionIndex = 51397;
