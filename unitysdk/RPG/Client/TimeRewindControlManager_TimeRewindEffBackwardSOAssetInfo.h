...
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER_TIMEREWINDEFFBACKWARDSOASSETINFO_ADDREF_OFFSET UNITYSDK_OFFSET(0xA08A300)
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER_TIMEREWINDEFFBACKWARDSOASSETINFO_CLEAR_OFFSET UNITYSDK_OFFSET(0xA08D600)
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER_TIMEREWINDEFFBACKWARDSOASSETINFO_GET_REFCOUNT_OFFSET UNITYSDK_OFFSET(0xA094820)
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER_TIMEREWINDEFFBACKWARDSOASSETINFO_INIT_OFFSET UNITYSDK_OFFSET(0xA08A340)
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER_TIMEREWINDEFFBACKWARDSOASSETINFO_REMOVEREF_OFFSET UNITYSDK_OFFSET(0xA08A630)
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER_TIMEREWINDEFFBACKWARDSOASSETINFO_SET_REFCOUNT_OFFSET UNITYSDK_OFFSET(0xA094830)
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER_TIMEREWINDEFFBACKWARDSOASSETINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xA094840)

namespace RPG::Client
{
	inline static constexpr unsigned int TimeRewindControlManager_TimeRewindEffBackwardSOAssetInfo_TypeDefinitionIndex = 48198;
