...
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER_TIMEREWINDEFFBACKWARDSOASSETINFO_ADDREF_OFFSET UNITYSDK_OFFSET(0x10576EF0)
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER_TIMEREWINDEFFBACKWARDSOASSETINFO_CLEAR_OFFSET UNITYSDK_OFFSET(0x1057A1F0)
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER_TIMEREWINDEFFBACKWARDSOASSETINFO_GET_REFCOUNT_OFFSET UNITYSDK_OFFSET(0x10581310)
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER_TIMEREWINDEFFBACKWARDSOASSETINFO_INIT_OFFSET UNITYSDK_OFFSET(0x10576F30)
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER_TIMEREWINDEFFBACKWARDSOASSETINFO_REMOVEREF_OFFSET UNITYSDK_OFFSET(0x10577210)
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER_TIMEREWINDEFFBACKWARDSOASSETINFO_SET_REFCOUNT_OFFSET UNITYSDK_OFFSET(0x10581320)
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER_TIMEREWINDEFFBACKWARDSOASSETINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x10581330)
