...
#define RPG_CLIENT_ROGUETOASTMIRACLEBROKENPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x9E4D200)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueToastMiracleBrokenParam_TypeDefinitionIndex = 53387;
