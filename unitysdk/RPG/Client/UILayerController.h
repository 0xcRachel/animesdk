...
#define RPG_CLIENT_UILAYERCONTROLLER_GET_BASELAYER_OFFSET UNITYSDK_OFFSET(0xA6A1840)
#define RPG_CLIENT_UILAYERCONTROLLER_METHOD_5_64501B5CB67A94C3_OFFSET UNITYSDK_OFFSET(0xA6A1570)
#define RPG_CLIENT_UILAYERCONTROLLER_METHOD_5_D7BDEB5B8A3A7B6E_OFFSET UNITYSDK_OFFSET(0xA6A1790)
#define RPG_CLIENT_UILAYERCONTROLLER_METHOD_5_D97779B750ED0BB2_OFFSET UNITYSDK_OFFSET(0xA6A16C0)
#define RPG_CLIENT_UILAYERCONTROLLER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0xA6A1670)
#define RPG_CLIENT_UILAYERCONTROLLER_SET_BASELAYER_OFFSET UNITYSDK_OFFSET(0xA6A1850)
#define RPG_CLIENT_UILAYERCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0xA6A1520)
#define RPG_CLIENT_UILAYERCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA6A18A0)

namespace RPG::Client
{
	inline static constexpr unsigned int UILayerController_TypeDefinitionIndex = 59884;
