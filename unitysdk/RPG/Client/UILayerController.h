...
#define RPG_CLIENT_UILAYERCONTROLLER_GET_BASELAYER_OFFSET UNITYSDK_OFFSET(0xA1BD210)
#define RPG_CLIENT_UILAYERCONTROLLER_METHOD_5_64501B5CB67A94C3_OFFSET UNITYSDK_OFFSET(0xA1BCF40)
#define RPG_CLIENT_UILAYERCONTROLLER_METHOD_5_D7BDEB5B8A3A7B6E_OFFSET UNITYSDK_OFFSET(0xA1BD160)
#define RPG_CLIENT_UILAYERCONTROLLER_METHOD_5_D97779B750ED0BB2_OFFSET UNITYSDK_OFFSET(0xA1BD090)
#define RPG_CLIENT_UILAYERCONTROLLER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0xA1BD040)
#define RPG_CLIENT_UILAYERCONTROLLER_SET_BASELAYER_OFFSET UNITYSDK_OFFSET(0xA1BD220)
#define RPG_CLIENT_UILAYERCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0xA1BCEF0)
#define RPG_CLIENT_UILAYERCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA1BD270)

namespace RPG::Client
{
	inline static constexpr unsigned int UILayerController_TypeDefinitionIndex = 58234;
