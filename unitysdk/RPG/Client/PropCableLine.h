...
#define RPG_CLIENT_PROPCABLELINE_INIT_OFFSET UNITYSDK_OFFSET(0xA238F20)
#define RPG_CLIENT_PROPCABLELINE_METHOD_5_3CAD92CFB876DBF6_OFFSET UNITYSDK_OFFSET(0xA239490)
#define RPG_CLIENT_PROPCABLELINE_METHOD_5_3CCA0B8A31B650A8_OFFSET UNITYSDK_OFFSET(0xA239FA0)
#define RPG_CLIENT_PROPCABLELINE_METHOD_5_4E80C32BD992E8BD_OFFSET UNITYSDK_OFFSET(0xA23A420)
#define RPG_CLIENT_PROPCABLELINE_METHOD_5_96BDC4B57CCFE000_OFFSET UNITYSDK_OFFSET(0xA23A510)
#define RPG_CLIENT_PROPCABLELINE_METHOD_5_F1372164966A6952_OFFSET UNITYSDK_OFFSET(0xA23A5B0)
#define RPG_CLIENT_PROPCABLELINE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA23A4C0)
#define RPG_CLIENT_PROPCABLELINE_ONSPAWNCABLELINE_OFFSET UNITYSDK_OFFSET(0xA239560)
#define RPG_CLIENT_PROPCABLELINE_REGISTERGROUPEVENT_OFFSET UNITYSDK_OFFSET(0xA239960)
#define RPG_CLIENT_PROPCABLELINE_SETGROUPCONTEXT_OFFSET UNITYSDK_OFFSET(0xA2397F0)
#define RPG_CLIENT_PROPCABLELINE_SETVISIBLE_OFFSET UNITYSDK_OFFSET(0xA239130)
#define RPG_CLIENT_PROPCABLELINE_UNINIT_OFFSET UNITYSDK_OFFSET(0xA239250)
#define RPG_CLIENT_PROPCABLELINE_UPDATE_OFFSET UNITYSDK_OFFSET(0xA239A40)
#define RPG_CLIENT_PROPCABLELINE__CCTOR_OFFSET UNITYSDK_OFFSET(0xA23A680)
#define RPG_CLIENT_PROPCABLELINE__CTOR_OFFSET UNITYSDK_OFFSET(0xA23A660)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(PropCableLine_TypeDefinitionIndex)->GetStaticField(0xD330);
		}
		static ::System::String** StaticGet_Field_5_23()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(PropCableLine_TypeDefinitionIndex)->GetStaticField(0xD338);
		}
