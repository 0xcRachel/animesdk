...
#define RPG_CLIENT_SILVERWOLFIMGPATH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9F782D0)
#define RPG_CLIENT_SILVERWOLFIMGPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x9F78D90)

namespace RPG::Client
{
	inline static constexpr unsigned int SilverWolfImgPath_TypeDefinitionIndex = 53905;
