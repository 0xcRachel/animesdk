...
#define RPG_CLIENT_GRIDFIGHTORBMANAGER___C__ADDPRESENT_B__32_1_OFFSET UNITYSDK_OFFSET(0x9882190)
#define RPG_CLIENT_GRIDFIGHTORBMANAGER___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x9882140)
#define RPG_CLIENT_GRIDFIGHTORBMANAGER___C__CTOR_OFFSET UNITYSDK_OFFSET(0x9882180)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Func_2<::Class_1_F4BC0015EEAF0CC2*, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(GridFightOrbManager___c_TypeDefinitionIndex)->GetStaticField(0x280B0);
		}
		static ::RPG::Client::GridFightOrbManager___c** StaticGet___9()
		{
			return (::RPG::Client::GridFightOrbManager___c**)Il2CppClass::FromTypeDefinitionIndex(GridFightOrbManager___c_TypeDefinitionIndex)->GetStaticField(0x280B8);
		}
