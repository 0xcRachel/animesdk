...
#define RPG_CLIENT_PIVOTBASEDFRACTUREMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x9AAC020)
#define RPG_CLIENT_PIVOTBASEDFRACTUREMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x9AAC070)
#define RPG_CLIENT_PIVOTBASEDFRACTUREMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x9AAC0A0)

namespace RPG::Client
{
	inline static constexpr unsigned int PivotBasedFractureMonoPlugin_TypeDefinitionIndex = 56327;
