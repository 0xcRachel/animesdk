...
#define RPG_CLIENT_TAROTBOOKMAINCATALOGELEMENT_INITVIEW_OFFSET UNITYSDK_OFFSET(0xA55BA60)
#define RPG_CLIENT_TAROTBOOKMAINCATALOGELEMENT_METHOD_7_A611F143A0941284_OFFSET UNITYSDK_OFFSET(0xA55BB10)
#define RPG_CLIENT_TAROTBOOKMAINCATALOGELEMENT__BEFOREDESTROY_OFFSET UNITYSDK_OFFSET(0xA55C6D0)
#define RPG_CLIENT_TAROTBOOKMAINCATALOGELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0xA55C840)
#define RPG_CLIENT_TAROTBOOKMAINCATALOGELEMENT___IFIXBASEPROXY_INITVIEW_OFFSET UNITYSDK_OFFSET(0xA55C890)
#define RPG_CLIENT_TAROTBOOKMAINCATALOGELEMENT___IFIXBASEPROXY__BEFOREDESTROY_OFFSET UNITYSDK_OFFSET(0xA55C940)

namespace RPG::Client
{
	inline static constexpr unsigned int TarotBookMainCatalogElement_TypeDefinitionIndex = 59370;
