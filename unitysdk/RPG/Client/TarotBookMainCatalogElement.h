...
#define RPG_CLIENT_TAROTBOOKMAINCATALOGELEMENT_INITVIEW_OFFSET UNITYSDK_OFFSET(0xA039F90)
#define RPG_CLIENT_TAROTBOOKMAINCATALOGELEMENT_METHOD_7_A611F143A0941284_OFFSET UNITYSDK_OFFSET(0xA03A040)
#define RPG_CLIENT_TAROTBOOKMAINCATALOGELEMENT__BEFOREDESTROY_OFFSET UNITYSDK_OFFSET(0xA03AC00)
#define RPG_CLIENT_TAROTBOOKMAINCATALOGELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0xA03AD70)
#define RPG_CLIENT_TAROTBOOKMAINCATALOGELEMENT___IFIXBASEPROXY_INITVIEW_OFFSET UNITYSDK_OFFSET(0xA03ADC0)
#define RPG_CLIENT_TAROTBOOKMAINCATALOGELEMENT___IFIXBASEPROXY__BEFOREDESTROY_OFFSET UNITYSDK_OFFSET(0xA03AE70)

namespace RPG::Client
{
	inline static constexpr unsigned int TarotBookMainCatalogElement_TypeDefinitionIndex = 57750;
