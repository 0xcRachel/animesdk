...
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_0270A57DC85825A7_OFFSET UNITYSDK_OFFSET(0xA26EAB0)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_0645CE6982F1F5B0_OFFSET UNITYSDK_OFFSET(0xA26F640)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_0DD7CF48A53D3E55_OFFSET UNITYSDK_OFFSET(0xA26E920)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_704CE2B0D4D2E676_OFFSET UNITYSDK_OFFSET(0xA26EF30)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_8CA88D55ECEFAD59_OFFSET UNITYSDK_OFFSET(0xA26DD40)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_9B97A7966B23A4A7_OFFSET UNITYSDK_OFFSET(0xA26E470)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_9BFADF4EA44C45E9_OFFSET UNITYSDK_OFFSET(0xA26E740)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA26F5F0)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_D45DEFEECF0CCC79_OFFSET UNITYSDK_OFFSET(0xA26F690)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_D80BBC359D875059_OFFSET UNITYSDK_OFFSET(0xA26E860)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_TESTTARGET_OFFSET UNITYSDK_OFFSET(0xA26DF70)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_TICK_OFFSET UNITYSDK_OFFSET(0xA26DEE0)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE__CTOR_OFFSET UNITYSDK_OFFSET(0xA26F590)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0xA26F630)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunTargetProjectile_TypeDefinitionIndex = 54604;
	...
	public:
		...
		::System::Boolean Method_6_9BFADF4EA44C45E9(::UnityEngine::Collider* a1)
		{
			return ((::System::Boolean(*)(::PVOID, ::UnityEngine::Collider*))((::PBYTE)hIl2Cpp + RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_9BFADF4EA44C45E9_OFFSET))(this, a1);
		}

		::System::Void Method_6_D80BBC359D875059(::UnityEngine::Collider* a1, ::UnityEngine::Vector3 a2)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Collider*, ::UnityEngine::Vector3))((::PBYTE)hIl2Cpp + RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_D80BBC359D875059_OFFSET))(this, a1, a2);
		}

		::System::Void Method_6_0DD7CF48A53D3E55(::RPG::Client::MonoWolfBroCustomData* a1, ::UnityEngine::Vector3 a2)
		{
			return ((::System::Void(*)(::PVOID, ::RPG::Client::MonoWolfBroCustomData*, ::UnityEngine::Vector3))((::PBYTE)hIl2Cpp + RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_0DD7CF48A53D3E55_OFFSET))(this, a1, a2);
		}
