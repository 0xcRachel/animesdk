...
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_0270A57DC85825A7_OFFSET UNITYSDK_OFFSET(0x12AD1350)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_227F3D625371821C_OFFSET UNITYSDK_OFFSET(0x12AD1F10)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_290BD11329CA8210_OFFSET UNITYSDK_OFFSET(0x12AD1170)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_704CE2B0D4D2E676_OFFSET UNITYSDK_OFFSET(0x12AD17B0)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_7D3AFE2824353718_OFFSET UNITYSDK_OFFSET(0x12AD1EC0)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_88E5D000ABA33B13_OFFSET UNITYSDK_OFFSET(0x12AD1250)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_8CA88D55ECEFAD59_OFFSET UNITYSDK_OFFSET(0x12AD0630)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_9B97A7966B23A4A7_OFFSET UNITYSDK_OFFSET(0x12AD0D60)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_A1AF98B26C7CFE0A_OFFSET UNITYSDK_OFFSET(0x12AD1030)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x12AD1E70)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_TESTTARGET_OFFSET UNITYSDK_OFFSET(0x12AD0860)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_TICK_OFFSET UNITYSDK_OFFSET(0x12AD07D0)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE__CTOR_OFFSET UNITYSDK_OFFSET(0x12AD1E00)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x12AD1EB0)
