...
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_0270A57DC85825A7_OFFSET UNITYSDK_OFFSET(0xA7A94A0)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_0645CE6982F1F5B0_OFFSET UNITYSDK_OFFSET(0xA7AA040)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_290BD11329CA8210_OFFSET UNITYSDK_OFFSET(0xA7A92C0)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_704CE2B0D4D2E676_OFFSET UNITYSDK_OFFSET(0xA7A9920)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_88E5D000ABA33B13_OFFSET UNITYSDK_OFFSET(0xA7A93A0)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_8CA88D55ECEFAD59_OFFSET UNITYSDK_OFFSET(0xA7A8780)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_9B97A7966B23A4A7_OFFSET UNITYSDK_OFFSET(0xA7A8EB0)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_A1AF98B26C7CFE0A_OFFSET UNITYSDK_OFFSET(0xA7A9180)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA7A9FF0)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_D45DEFEECF0CCC79_OFFSET UNITYSDK_OFFSET(0xA7AA090)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_TESTTARGET_OFFSET UNITYSDK_OFFSET(0xA7A89B0)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_TICK_OFFSET UNITYSDK_OFFSET(0xA7A8920)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE__CTOR_OFFSET UNITYSDK_OFFSET(0xA7A9F80)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0xA7AA030)
