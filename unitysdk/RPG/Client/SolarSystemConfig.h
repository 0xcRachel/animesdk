...
#define RPG_CLIENT_SOLARSYSTEMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9F8D1C0)

namespace RPG::Client
{
	inline static constexpr unsigned int SolarSystemConfig_TypeDefinitionIndex = 55508;
