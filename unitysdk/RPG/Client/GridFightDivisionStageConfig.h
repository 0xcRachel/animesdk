...
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GETCONFIG_OFFSET UNITYSDK_OFFSET(0x1803F550)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_AFFIXCOUNT_OFFSET UNITYSDK_OFFSET(0x18042360)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_DIVISIONCONFIG_OFFSET UNITYSDK_OFFSET(0x18041BF0)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_DIVISIONID_OFFSET UNITYSDK_OFFSET(0x180423A0)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_ENEMYHARDLEVEL_OFFSET UNITYSDK_OFFSET(0x18042380)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_ENVIRONMENTBUFFLIST_OFFSET UNITYSDK_OFFSET(0x18042300)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_ENVIRONMENTDESCLIST_OFFSET UNITYSDK_OFFSET(0x18042340)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_EXISTINGPROMOTION_OFFSET UNITYSDK_OFFSET(0x180422E0)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_EXPMODIFY_OFFSET UNITYSDK_OFFSET(0x180424D0)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_EXP_OFFSET UNITYSDK_OFFSET(0x18042250)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_ID_OFFSET UNITYSDK_OFFSET(0x18042230)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_ISPROMOTION_OFFSET UNITYSDK_OFFSET(0x180423B0)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_ISTHEORETICALYCLOSETOPROMOTION_OFFSET UNITYSDK_OFFSET(0x180422D0)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_OCSCORERULE_OFFSET UNITYSDK_OFFSET(0x18042490)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_OVERCHARGEEXP_OFFSET UNITYSDK_OFFSET(0x180422B0)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_OVERCHARGEWEEKLYSCORE_OFFSET UNITYSDK_OFFSET(0x18042290)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_PREVDIVISIONID_OFFSET UNITYSDK_OFFSET(0x18042410)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_PROMOTIONLEVELTITLE_OFFSET UNITYSDK_OFFSET(0x180422F0)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_SCORERULE_OFFSET UNITYSDK_OFFSET(0x18042470)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_UNIQUEENVIRONMENTDESCLIST_OFFSET UNITYSDK_OFFSET(0x18042320)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_WEEKLYSCORE_OFFSET UNITYSDK_OFFSET(0x18042270)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_WEEKSCOREMODIFY_OFFSET UNITYSDK_OFFSET(0x180424B0)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_SET_AFFIXCOUNT_OFFSET UNITYSDK_OFFSET(0x18042370)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_SET_ENEMYHARDLEVEL_OFFSET UNITYSDK_OFFSET(0x18042390)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_SET_ENVIRONMENTBUFFLIST_OFFSET UNITYSDK_OFFSET(0x18042310)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_SET_ENVIRONMENTDESCLIST_OFFSET UNITYSDK_OFFSET(0x18042350)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_SET_EXPMODIFY_OFFSET UNITYSDK_OFFSET(0x180424E0)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_SET_EXP_OFFSET UNITYSDK_OFFSET(0x18042260)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_SET_ID_OFFSET UNITYSDK_OFFSET(0x18042240)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_SET_OCSCORERULE_OFFSET UNITYSDK_OFFSET(0x180424A0)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_SET_OVERCHARGEEXP_OFFSET UNITYSDK_OFFSET(0x180422C0)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_SET_OVERCHARGEWEEKLYSCORE_OFFSET UNITYSDK_OFFSET(0x180422A0)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_SET_SCORERULE_OFFSET UNITYSDK_OFFSET(0x18042480)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_SET_UNIQUEENVIRONMENTDESCLIST_OFFSET UNITYSDK_OFFSET(0x18042330)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_SET_WEEKLYSCORE_OFFSET UNITYSDK_OFFSET(0x18042280)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_SET_WEEKSCOREMODIFY_OFFSET UNITYSDK_OFFSET(0x180424C0)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18041150)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG__EXISTINGPROMOTION_OFFSET UNITYSDK_OFFSET(0x18041C80)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG__GETPROMOTIONLEVELTITLE_OFFSET UNITYSDK_OFFSET(0x18041F00)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG__INITAFFIXCOUNT_OFFSET UNITYSDK_OFFSET(0x180417D0)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG__INITEXPANDSCORE_OFFSET UNITYSDK_OFFSET(0x180413C0)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG__ISTHEORETICALYCLOSETOPROMOTION_OFFSET UNITYSDK_OFFSET(0x18041930)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG___INITEXPANDSCORE_B__3_0_OFFSET UNITYSDK_OFFSET(0x180424F0)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG___INITEXPANDSCORE_B__3_1_OFFSET UNITYSDK_OFFSET(0x18042510)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Func_2<::System::UInt32, ::RPG::Client::GridFightDivisionStageConfig*>**)Il2CppClass::FromTypeDefinitionIndex(GridFightDivisionStageConfig_TypeDefinitionIndex)->GetStaticField(0x1F790);
		}
		...
		::System::UInt32 _OverChargeExp_k__BackingField; // 0x30
		...
		::System::UInt32 _ExpModify_k__BackingField; // 0x40
		::System::UInt32 _OCScoreRule_k__BackingField; // 0x44
		::System::UInt32 _AffixCount_k__BackingField; // 0x48
