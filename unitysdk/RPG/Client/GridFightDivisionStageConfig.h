...
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GETCONFIG_OFFSET UNITYSDK_OFFSET(0x933E760)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_AFFIXCOUNT_OFFSET UNITYSDK_OFFSET(0x9341430)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_DIVISIONCONFIG_OFFSET UNITYSDK_OFFSET(0x9340D40)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_DIVISIONID_OFFSET UNITYSDK_OFFSET(0x9341470)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_ENEMYHARDLEVEL_OFFSET UNITYSDK_OFFSET(0x9341450)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_ENVIRONMENTBUFFLIST_OFFSET UNITYSDK_OFFSET(0x93413D0)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_ENVIRONMENTDESCLIST_OFFSET UNITYSDK_OFFSET(0x9341410)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_EXISTINGPROMOTION_OFFSET UNITYSDK_OFFSET(0x93413B0)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_EXPMODIFY_OFFSET UNITYSDK_OFFSET(0x93415A0)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_EXP_OFFSET UNITYSDK_OFFSET(0x9341320)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_ID_OFFSET UNITYSDK_OFFSET(0x9341300)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_ISPROMOTION_OFFSET UNITYSDK_OFFSET(0x9341480)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_ISTHEORETICALYCLOSETOPROMOTION_OFFSET UNITYSDK_OFFSET(0x93413A0)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_OCSCORERULE_OFFSET UNITYSDK_OFFSET(0x9341560)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_OVERCHARGEEXP_OFFSET UNITYSDK_OFFSET(0x9341380)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_OVERCHARGEWEEKLYSCORE_OFFSET UNITYSDK_OFFSET(0x9341360)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_PREVDIVISIONID_OFFSET UNITYSDK_OFFSET(0x93414E0)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_PROMOTIONLEVELTITLE_OFFSET UNITYSDK_OFFSET(0x93413C0)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_SCORERULE_OFFSET UNITYSDK_OFFSET(0x9341540)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_UNIQUEENVIRONMENTDESCLIST_OFFSET UNITYSDK_OFFSET(0x93413F0)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_WEEKLYSCORE_OFFSET UNITYSDK_OFFSET(0x9341340)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_GET_WEEKSCOREMODIFY_OFFSET UNITYSDK_OFFSET(0x9341580)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_SET_AFFIXCOUNT_OFFSET UNITYSDK_OFFSET(0x9341440)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_SET_ENEMYHARDLEVEL_OFFSET UNITYSDK_OFFSET(0x9341460)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_SET_ENVIRONMENTBUFFLIST_OFFSET UNITYSDK_OFFSET(0x93413E0)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_SET_ENVIRONMENTDESCLIST_OFFSET UNITYSDK_OFFSET(0x9341420)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_SET_EXPMODIFY_OFFSET UNITYSDK_OFFSET(0x93415B0)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_SET_EXP_OFFSET UNITYSDK_OFFSET(0x9341330)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_SET_ID_OFFSET UNITYSDK_OFFSET(0x9341310)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_SET_OCSCORERULE_OFFSET UNITYSDK_OFFSET(0x9341570)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_SET_OVERCHARGEEXP_OFFSET UNITYSDK_OFFSET(0x9341390)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_SET_OVERCHARGEWEEKLYSCORE_OFFSET UNITYSDK_OFFSET(0x9341370)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_SET_SCORERULE_OFFSET UNITYSDK_OFFSET(0x9341550)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_SET_UNIQUEENVIRONMENTDESCLIST_OFFSET UNITYSDK_OFFSET(0x9341400)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_SET_WEEKLYSCORE_OFFSET UNITYSDK_OFFSET(0x9341350)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG_SET_WEEKSCOREMODIFY_OFFSET UNITYSDK_OFFSET(0x9341590)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x93402D0)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG__EXISTINGPROMOTION_OFFSET UNITYSDK_OFFSET(0x9340DD0)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG__GETPROMOTIONLEVELTITLE_OFFSET UNITYSDK_OFFSET(0x9341010)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG__INITAFFIXCOUNT_OFFSET UNITYSDK_OFFSET(0x9340950)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG__INITEXPANDSCORE_OFFSET UNITYSDK_OFFSET(0x9340540)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG__ISTHEORETICALYCLOSETOPROMOTION_OFFSET UNITYSDK_OFFSET(0x9340AB0)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG___INITEXPANDSCORE_B__3_0_OFFSET UNITYSDK_OFFSET(0x93415C0)
#define RPG_CLIENT_GRIDFIGHTDIVISIONSTAGECONFIG___INITEXPANDSCORE_B__3_1_OFFSET UNITYSDK_OFFSET(0x93415E0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightDivisionStageConfig_TypeDefinitionIndex = 51300;
	...
	public:
		...
		{
			return (::System::Func_2<::System::UInt32, ::RPG::Client::GridFightDivisionStageConfig*>**)Il2CppClass::FromTypeDefinitionIndex(GridFightDivisionStageConfig_TypeDefinitionIndex)->GetStaticField(0x44190);
		}
		...
		::System::UInt32 _AffixCount_k__BackingField; // 0x28
		::System::UInt32 _ID_k__BackingField; // 0x2C
		::System::UInt32 _Exp_k__BackingField; // 0x30
		::System::UInt32 _OverChargeExp_k__BackingField; // 0x34
		...
		::System::UInt32 _WeeklyScore_k__BackingField; // 0x44
		::System::UInt32 _OverChargeWeeklyScore_k__BackingField; // 0x48
