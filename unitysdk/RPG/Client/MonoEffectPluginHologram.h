...
#define RPG_CLIENT_MONOEFFECTPLUGINHOLOGRAM_METHOD_8_29352E75304CF2A0_OFFSET UNITYSDK_OFFSET(0x97FD2D0)
#define RPG_CLIENT_MONOEFFECTPLUGINHOLOGRAM_METHOD_8_749948B663FCCCEF_OFFSET UNITYSDK_OFFSET(0x97FD5B0)
#define RPG_CLIENT_MONOEFFECTPLUGINHOLOGRAM__CTOR_OFFSET UNITYSDK_OFFSET(0x97FD590)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginHologram_TypeDefinitionIndex = 55718;
