...
#define RPG_CLIENT_PROPERTYOVERRIDEVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x9D1FAB0)

namespace RPG::Client
{
	inline static constexpr unsigned int PropertyOverrideValue_TypeDefinitionIndex = 56586;
