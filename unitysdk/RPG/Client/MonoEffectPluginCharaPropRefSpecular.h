...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPREFSPECULAR_GETBASECHARACTERFILTER_OFFSET UNITYSDK_OFFSET(0x97E67B0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPREFSPECULAR_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x97E6820)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPREFSPECULAR__CTOR_OFFSET UNITYSDK_OFFSET(0x97E6B70)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPREFSPECULAR___IFIXBASEPROXY_GETBASECHARACTERFILTER_OFFSET UNITYSDK_OFFSET(0x97E6B90)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropRefSpecular_TypeDefinitionIndex = 55687;
