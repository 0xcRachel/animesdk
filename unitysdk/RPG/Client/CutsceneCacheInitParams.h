...
#define RPG_CLIENT_CUTSCENECACHEINITPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x8FF3650)

namespace RPG::Client
{
	inline static constexpr unsigned int CutsceneCacheInitParams_TypeDefinitionIndex = 47231;
