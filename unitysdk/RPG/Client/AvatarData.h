...
#define RPG_CLIENT_AVATARDATA_APPLYAVATARDATA_OFFSET UNITYSDK_OFFSET(0x911A500)
#define RPG_CLIENT_AVATARDATA_APPLYEQUIPMENT_OFFSET UNITYSDK_OFFSET(0x9119FB0)
#define RPG_CLIENT_AVATARDATA_APPLYRELICSET_OFFSET UNITYSDK_OFFSET(0x911A310)
#define RPG_CLIENT_AVATARDATA_APPLYSKILLTREE_OFFSET UNITYSDK_OFFSET(0x911A1A0)
#define RPG_CLIENT_AVATARDATA_CHANGEMULTIPATHAVATARTYPE_OFFSET UNITYSDK_OFFSET(0x911CEE0)
#define RPG_CLIENT_AVATARDATA_CLEARLEVELUPBEFORDATA_OFFSET UNITYSDK_OFFSET(0x911D120)
#define RPG_CLIENT_AVATARDATA_CLEARPROMOTIONBEFOREDATA_OFFSET UNITYSDK_OFFSET(0x911D170)
#define RPG_CLIENT_AVATARDATA_COPYBUILDDATA_OFFSET UNITYSDK_OFFSET(0x9119D70)
#define RPG_CLIENT_AVATARDATA_CREATEAETHERDIVIDESPIRIT_OFFSET UNITYSDK_OFFSET(0x911BE00)
#define RPG_CLIENT_AVATARDATA_CREATEASSISTAVATAR_OFFSET UNITYSDK_OFFSET(0x90EB1E0)
#define RPG_CLIENT_AVATARDATA_CREATEBYADVENTUREPLAYERID_OFFSET UNITYSDK_OFFSET(0x9119680)
#define RPG_CLIENT_AVATARDATA_CREATEBYREALID_OFFSET UNITYSDK_OFFSET(0x91191B0)
#define RPG_CLIENT_AVATARDATA_CREATECHALLENGEUPGRADEDAVATAR_OFFSET UNITYSDK_OFFSET(0x911B310)
#define RPG_CLIENT_AVATARDATA_CREATEDISPLAYAVATAR_1_OFFSET UNITYSDK_OFFSET(0x91198C0)
#define RPG_CLIENT_AVATARDATA_CREATEDISPLAYAVATAR_OFFSET UNITYSDK_OFFSET(0x911BB40)
#define RPG_CLIENT_AVATARDATA_CREATEGACHADATABYREALID_OFFSET UNITYSDK_OFFSET(0x9119490)
#define RPG_CLIENT_AVATARDATA_CREATEMAXENHANCEDGACHADATA_OFFSET UNITYSDK_OFFSET(0x9116460)
#define RPG_CLIENT_AVATARDATA_CREATEMULTIPATHAVATARBYREALID_OFFSET UNITYSDK_OFFSET(0x9119320)
#define RPG_CLIENT_AVATARDATA_CREATESPEICALAVATAR_OFFSET UNITYSDK_OFFSET(0x911A5E0)
#define RPG_CLIENT_AVATARDATA_CREATEUPGRADEDAVATAR_OFFSET UNITYSDK_OFFSET(0x911ADA0)
#define RPG_CLIENT_AVATARDATA_CREATE_1_OFFSET UNITYSDK_OFFSET(0x9119040)
#define RPG_CLIENT_AVATARDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x9118E80)
#define RPG_CLIENT_AVATARDATA_GETALLPROPERTYVALUEWITHVIRTUALRELICSET_OFFSET UNITYSDK_OFFSET(0x911E110)
#define RPG_CLIENT_AVATARDATA_GETAVATARCOMBATPOWERVALUE_OFFSET UNITYSDK_OFFSET(0x911F800)
#define RPG_CLIENT_AVATARDATA_GETCHARACTERSKILLDATA_1_OFFSET UNITYSDK_OFFSET(0x911D9D0)
#define RPG_CLIENT_AVATARDATA_GETCHARACTERSKILLDATA_OFFSET UNITYSDK_OFFSET(0x911D960)
#define RPG_CLIENT_AVATARDATA_GETCURRENTEXPPERCENT_OFFSET UNITYSDK_OFFSET(0x911E740)
#define RPG_CLIENT_AVATARDATA_GETCURRENTLVMAXEXP_OFFSET UNITYSDK_OFFSET(0x911E9F0)
#define RPG_CLIENT_AVATARDATA_GETCURRENTMAXLV_OFFSET UNITYSDK_OFFSET(0x911EC30)
#define RPG_CLIENT_AVATARDATA_GETDISPLAYFORMATADDVALUE_OFFSET UNITYSDK_OFFSET(0x911DE60)
#define RPG_CLIENT_AVATARDATA_GETDISPLAYFORMATPROPERTYBASEVALUE_OFFSET UNITYSDK_OFFSET(0x911DDC0)
#define RPG_CLIENT_AVATARDATA_GETDISPLAYFORMATPROPERTYBYTYPE_OFFSET UNITYSDK_OFFSET(0x911E6A0)
#define RPG_CLIENT_AVATARDATA_GETDISPLAYSKILLDATALIST_OFFSET UNITYSDK_OFFSET(0x911D1C0)
#define RPG_CLIENT_AVATARDATA_GETEQUIPMENT_OFFSET UNITYSDK_OFFSET(0x911F390)
#define RPG_CLIENT_AVATARDATA_GETEXTRAADDITION_OFFSET UNITYSDK_OFFSET(0x911DF90)
#define RPG_CLIENT_AVATARDATA_GETFIRSTSKINTYPE_OFFSET UNITYSDK_OFFSET(0x9117CD0)
#define RPG_CLIENT_AVATARDATA_GETHPMAX_OFFSET UNITYSDK_OFFSET(0x911E4A0)
#define RPG_CLIENT_AVATARDATA_GETLVMAXEXP_OFFSET UNITYSDK_OFFSET(0x911EB10)
#define RPG_CLIENT_AVATARDATA_GETMAXLV_OFFSET UNITYSDK_OFFSET(0x911EDC0)
#define RPG_CLIENT_AVATARDATA_GETMODIFIEDADVENTURECHARACTERCONFIG_OFFSET UNITYSDK_OFFSET(0x9120F30)
#define RPG_CLIENT_AVATARDATA_GETNEEDEXPTOLV_OFFSET UNITYSDK_OFFSET(0x911E870)
#define RPG_CLIENT_AVATARDATA_GETNEWLEVELBYADDEXP_OFFSET UNITYSDK_OFFSET(0x911F010)
#define RPG_CLIENT_AVATARDATA_GETNORMALSKINIDS_OFFSET UNITYSDK_OFFSET(0x9117EB0)
#define RPG_CLIENT_AVATARDATA_GETPROPERTYBYTYPE_OFFSET UNITYSDK_OFFSET(0x911E610)
#define RPG_CLIENT_AVATARDATA_GETPROPERTYUIDATA_OFFSET UNITYSDK_OFFSET(0x911DBF0)
#define RPG_CLIENT_AVATARDATA_GETRANKAFTEREXTRAADDITION_OFFSET UNITYSDK_OFFSET(0x911E050)
#define RPG_CLIENT_AVATARDATA_GETRELICLIST_OFFSET UNITYSDK_OFFSET(0x911F440)
#define RPG_CLIENT_AVATARDATA_GETSKINIDS_OFFSET UNITYSDK_OFFSET(0x9117F00)
#define RPG_CLIENT_AVATARDATA_GETSPMAX_OFFSET UNITYSDK_OFFSET(0x911E520)
#define RPG_CLIENT_AVATARDATA_GETSTELLARSKINIDS_OFFSET UNITYSDK_OFFSET(0x91180A0)
#define RPG_CLIENT_AVATARDATA_GET_ADVENTUREJSONCONFIGPATH_OFFSET UNITYSDK_OFFSET(0x91211F0)
#define RPG_CLIENT_AVATARDATA_GET_ADVENTUREPLAYERID_OFFSET UNITYSDK_OFFSET(0x9120030)
#define RPG_CLIENT_AVATARDATA_GET_AVATARJSONPATH_OFFSET UNITYSDK_OFFSET(0x9121390)
#define RPG_CLIENT_AVATARDATA_GET_AVATARNAME_OFFSET UNITYSDK_OFFSET(0x911CDC0)
#define RPG_CLIENT_AVATARDATA_GET_AVATARPROPERTYDATA_OFFSET UNITYSDK_OFFSET(0x9121AC0)
#define RPG_CLIENT_AVATARDATA_GET_AVATARROWDATA_OFFSET UNITYSDK_OFFSET(0x9121B30)
#define RPG_CLIENT_AVATARDATA_GET_AVATARTYPE_OFFSET UNITYSDK_OFFSET(0x911FD50)
#define RPG_CLIENT_AVATARDATA_GET_BASEID_OFFSET UNITYSDK_OFFSET(0x9117A50)
#define RPG_CLIENT_AVATARDATA_GET_CAMPID_OFFSET UNITYSDK_OFFSET(0x91219A0)
#define RPG_CLIENT_AVATARDATA_GET_CAMPROW_OFFSET UNITYSDK_OFFSET(0x9121930)
#define RPG_CLIENT_AVATARDATA_GET_COMBATPOWERDATA_OFFSET UNITYSDK_OFFSET(0x9121AE0)
#define RPG_CLIENT_AVATARDATA_GET_CURRENTEXP_OFFSET UNITYSDK_OFFSET(0x9121730)
#define RPG_CLIENT_AVATARDATA_GET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0x911FD70)
#define RPG_CLIENT_AVATARDATA_GET_DEFAULTAVATARMODELPATH_OFFSET UNITYSDK_OFFSET(0x9121570)
#define RPG_CLIENT_AVATARDATA_GET_ENHANCEDID_OFFSET UNITYSDK_OFFSET(0x9117AE0)
#define RPG_CLIENT_AVATARDATA_GET_EQUIPMENTMODIFIER_OFFSET UNITYSDK_OFFSET(0x9121D40)
#define RPG_CLIENT_AVATARDATA_GET_EQUIPMENTUID_OFFSET UNITYSDK_OFFSET(0x91216F0)
#define RPG_CLIENT_AVATARDATA_GET_GROWUPBEFOREDATA_OFFSET UNITYSDK_OFFSET(0x9121A60)
#define RPG_CLIENT_AVATARDATA_GET_HASEQUIPMENT_OFFSET UNITYSDK_OFFSET(0x9121BA0)
#define RPG_CLIENT_AVATARDATA_GET_HASSERVANT_OFFSET UNITYSDK_OFFSET(0x9121B20)
#define RPG_CLIENT_AVATARDATA_GET_HASSKIN_OFFSET UNITYSDK_OFFSET(0x9117BD0)
#define RPG_CLIENT_AVATARDATA_GET_HASTAKENPROMOTIONREWARDLIST_OFFSET UNITYSDK_OFFSET(0x9121C60)
#define RPG_CLIENT_AVATARDATA_GET_HEROGENDER_OFFSET UNITYSDK_OFFSET(0x911FCC0)
#define RPG_CLIENT_AVATARDATA_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x9117720)
#define RPG_CLIENT_AVATARDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0x911BCF0)
#define RPG_CLIENT_AVATARDATA_GET_ISAETHERDIVIDE_OFFSET UNITYSDK_OFFSET(0x9121640)
#define RPG_CLIENT_AVATARDATA_GET_ISASSISTAVATAR_OFFSET UNITYSDK_OFFSET(0x9121620)
#define RPG_CLIENT_AVATARDATA_GET_ISCUSTOMNAME_OFFSET UNITYSDK_OFFSET(0x9120020)
#define RPG_CLIENT_AVATARDATA_GET_ISDISPLAYONLY_OFFSET UNITYSDK_OFFSET(0x9121670)
#define RPG_CLIENT_AVATARDATA_GET_ISFIXEDPATHAVATAR_OFFSET UNITYSDK_OFFSET(0x9121630)
#define RPG_CLIENT_AVATARDATA_GET_ISFORMALAVATAR_OFFSET UNITYSDK_OFFSET(0x9121650)
#define RPG_CLIENT_AVATARDATA_GET_ISHERO_OFFSET UNITYSDK_OFFSET(0x911FBC0)
#define RPG_CLIENT_AVATARDATA_GET_ISMARKED_OFFSET UNITYSDK_OFFSET(0x9121C80)
#define RPG_CLIENT_AVATARDATA_GET_ISNEW_OFFSET UNITYSDK_OFFSET(0x9121C40)
#define RPG_CLIENT_AVATARDATA_GET_ISPLOTTRIALPLAYER_OFFSET UNITYSDK_OFFSET(0x9120180)
#define RPG_CLIENT_AVATARDATA_GET_ISSHOWSKILLPLOTTRIALPLAYER_OFFSET UNITYSDK_OFFSET(0x91201E0)
#define RPG_CLIENT_AVATARDATA_GET_ISTRIALPLAYER_OFFSET UNITYSDK_OFFSET(0x911CD60)
#define RPG_CLIENT_AVATARDATA_GET_ISUPGRADEAVAILABLETYPE_OFFSET UNITYSDK_OFFSET(0x9121660)
#define RPG_CLIENT_AVATARDATA_GET_LEVELUPEDBEFOREDATA_OFFSET UNITYSDK_OFFSET(0x9121A80)
#define RPG_CLIENT_AVATARDATA_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x9121690)
#define RPG_CLIENT_AVATARDATA_GET_MAXPROMOTION_OFFSET UNITYSDK_OFFSET(0x9121840)
#define RPG_CLIENT_AVATARDATA_GET_MAXRANK_OFFSET UNITYSDK_OFFSET(0x9121750)
#define RPG_CLIENT_AVATARDATA_GET_MULTIPATHAVATARTYPE_OFFSET UNITYSDK_OFFSET(0x911FD40)
#define RPG_CLIENT_AVATARDATA_GET_OUTFIT_OFFSET UNITYSDK_OFFSET(0x9121D90)
#define RPG_CLIENT_AVATARDATA_GET_PREFSSHOWSIMPLIFIEDSKILLDESC_OFFSET UNITYSDK_OFFSET(0x9120280)
#define RPG_CLIENT_AVATARDATA_GET_PROFESSIONTYPENAME_OFFSET UNITYSDK_OFFSET(0x911FF50)
#define RPG_CLIENT_AVATARDATA_GET_PROFESSIONTYPE_OFFSET UNITYSDK_OFFSET(0x911FE60)
#define RPG_CLIENT_AVATARDATA_GET_PROMOTEDBEFOREDATA_OFFSET UNITYSDK_OFFSET(0x9121AA0)
#define RPG_CLIENT_AVATARDATA_GET_PROMOTION_OFFSET UNITYSDK_OFFSET(0x91216B0)
#define RPG_CLIENT_AVATARDATA_GET_RANK_OFFSET UNITYSDK_OFFSET(0x91216D0)
#define RPG_CLIENT_AVATARDATA_GET_REALID_OFFSET UNITYSDK_OFFSET(0x9117920)
#define RPG_CLIENT_AVATARDATA_GET_RELICSDATA_OFFSET UNITYSDK_OFFSET(0x9121710)
#define RPG_CLIENT_AVATARDATA_GET_RELICSUITMODIFIER_OFFSET UNITYSDK_OFFSET(0x9121D60)
#define RPG_CLIENT_AVATARDATA_GET_ROLETYPE_OFFSET UNITYSDK_OFFSET(0x911FB60)
#define RPG_CLIENT_AVATARDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0x911FB20)
#define RPG_CLIENT_AVATARDATA_GET_SERVANTDATA_OFFSET UNITYSDK_OFFSET(0x9121B00)
#define RPG_CLIENT_AVATARDATA_GET_SKILLTREEMODIFIER_OFFSET UNITYSDK_OFFSET(0x9121D50)
#define RPG_CLIENT_AVATARDATA_GET_SKINDATA_OFFSET UNITYSDK_OFFSET(0x9121D20)
#define RPG_CLIENT_AVATARDATA_GET_SPECIALAVATARID_OFFSET UNITYSDK_OFFSET(0x9117A00)
#define RPG_CLIENT_AVATARDATA_GET_SPECIALROW_OFFSET UNITYSDK_OFFSET(0x911FB40)
#define RPG_CLIENT_AVATARDATA_GET_SPECIFIEDGENDERTYPE_OFFSET UNITYSDK_OFFSET(0x9121D70)
#define RPG_CLIENT_AVATARDATA_GET_TRIALPLAYERID_OFFSET UNITYSDK_OFFSET(0x9120130)
#define RPG_CLIENT_AVATARDATA_GET_ULTRASKILLCONFIG_OFFSET UNITYSDK_OFFSET(0x9121CA0)
#define RPG_CLIENT_AVATARDATA_GET_ULTRASKILLTYPE_OFFSET UNITYSDK_OFFSET(0x9121CC0)
#define RPG_CLIENT_AVATARDATA_GET__PROFESSIONTYPEROW_OFFSET UNITYSDK_OFFSET(0x9121DB0)
#define RPG_CLIENT_AVATARDATA_ISCURHERO_OFFSET UNITYSDK_OFFSET(0x911BBA0)
#define RPG_CLIENT_AVATARDATA_ISHEROID_OFFSET UNITYSDK_OFFSET(0x91131C0)
#define RPG_CLIENT_AVATARDATA_ISMAXPROMOTION_OFFSET UNITYSDK_OFFSET(0x911EFB0)
#define RPG_CLIENT_AVATARDATA_ISPROMOTIONMAXLEVEL_OFFSET UNITYSDK_OFFSET(0x911EF50)
#define RPG_CLIENT_AVATARDATA_ISPROMOTIONREWARDRECEIVED_OFFSET UNITYSDK_OFFSET(0x911F920)
#define RPG_CLIENT_AVATARDATA_ISSAMEGENDER_OFFSET UNITYSDK_OFFSET(0x911BD80)
#define RPG_CLIENT_AVATARDATA_ISSERVANTSKILLID_OFFSET UNITYSDK_OFFSET(0x911DB70)
#define RPG_CLIENT_AVATARDATA_REFRESHCHALLENGEUPGRADEDAVATAR_OFFSET UNITYSDK_OFFSET(0x911B520)
#define RPG_CLIENT_AVATARDATA_REFRESHUPGRADEDAVATAR_OFFSET UNITYSDK_OFFSET(0x911AF20)
#define RPG_CLIENT_AVATARDATA_RESETEXTRAPROPERTYADDITION_OFFSET UNITYSDK_OFFSET(0x911F330)
#define RPG_CLIENT_AVATARDATA_REVERTPREFSSHOWSIMPLIFIEDSKILLDESC_OFFSET UNITYSDK_OFFSET(0x9120D80)
#define RPG_CLIENT_AVATARDATA_SETAVATARLEVEL_OFFSET UNITYSDK_OFFSET(0x911CD10)
#define RPG_CLIENT_AVATARDATA_SETAVATARSKIN_OFFSET UNITYSDK_OFFSET(0x9118400)
#define RPG_CLIENT_AVATARDATA_SETEXTRAPROPERTYADDITION_OFFSET UNITYSDK_OFFSET(0x911F240)
#define RPG_CLIENT_AVATARDATA_SETGACHAINITIALDATA_OFFSET UNITYSDK_OFFSET(0x91195F0)
#define RPG_CLIENT_AVATARDATA_SETGACHAULTIMATEDATA_OFFSET UNITYSDK_OFFSET(0x911F6D0)
#define RPG_CLIENT_AVATARDATA_SETINITIALDATA_OFFSET UNITYSDK_OFFSET(0x911F4A0)
#define RPG_CLIENT_AVATARDATA_SETMULTIPATHDRESSEDSKINID_OFFSET UNITYSDK_OFFSET(0x91180F0)
#define RPG_CLIENT_AVATARDATA_SETRANK_OFFSET UNITYSDK_OFFSET(0x911D0D0)
#define RPG_CLIENT_AVATARDATA_SETULTIMATEDATA_OFFSET UNITYSDK_OFFSET(0x911F510)
#define RPG_CLIENT_AVATARDATA_SET_AVATARPROPERTYDATA_OFFSET UNITYSDK_OFFSET(0x9121AD0)
#define RPG_CLIENT_AVATARDATA_SET_AVATARTYPE_OFFSET UNITYSDK_OFFSET(0x911FD60)
#define RPG_CLIENT_AVATARDATA_SET_COMBATPOWERDATA_OFFSET UNITYSDK_OFFSET(0x9121AF0)
#define RPG_CLIENT_AVATARDATA_SET_CURRENTEXP_OFFSET UNITYSDK_OFFSET(0x9121740)
#define RPG_CLIENT_AVATARDATA_SET_EQUIPMENTUID_OFFSET UNITYSDK_OFFSET(0x9121700)
#define RPG_CLIENT_AVATARDATA_SET_GROWUPBEFOREDATA_OFFSET UNITYSDK_OFFSET(0x9121A70)
#define RPG_CLIENT_AVATARDATA_SET_HASTAKENPROMOTIONREWARDLIST_OFFSET UNITYSDK_OFFSET(0x9121C70)
#define RPG_CLIENT_AVATARDATA_SET_ISDISPLAYONLY_OFFSET UNITYSDK_OFFSET(0x9121680)
#define RPG_CLIENT_AVATARDATA_SET_ISMARKED_OFFSET UNITYSDK_OFFSET(0x9121C90)
#define RPG_CLIENT_AVATARDATA_SET_ISNEW_OFFSET UNITYSDK_OFFSET(0x9121C50)
#define RPG_CLIENT_AVATARDATA_SET_LEVELUPEDBEFOREDATA_OFFSET UNITYSDK_OFFSET(0x9121A90)
#define RPG_CLIENT_AVATARDATA_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x91216A0)
#define RPG_CLIENT_AVATARDATA_SET_OUTFIT_OFFSET UNITYSDK_OFFSET(0x9121DA0)
#define RPG_CLIENT_AVATARDATA_SET_PROMOTEDBEFOREDATA_OFFSET UNITYSDK_OFFSET(0x9121AB0)
#define RPG_CLIENT_AVATARDATA_SET_PROMOTION_OFFSET UNITYSDK_OFFSET(0x91216C0)
#define RPG_CLIENT_AVATARDATA_SET_RANK_OFFSET UNITYSDK_OFFSET(0x91216E0)
#define RPG_CLIENT_AVATARDATA_SET_RELICSDATA_OFFSET UNITYSDK_OFFSET(0x9121720)
#define RPG_CLIENT_AVATARDATA_SET_ROW_OFFSET UNITYSDK_OFFSET(0x911FB30)
#define RPG_CLIENT_AVATARDATA_SET_SERVANTDATA_OFFSET UNITYSDK_OFFSET(0x9121B10)
#define RPG_CLIENT_AVATARDATA_SET_SKINDATA_OFFSET UNITYSDK_OFFSET(0x9121D30)
#define RPG_CLIENT_AVATARDATA_SET_SPECIALROW_OFFSET UNITYSDK_OFFSET(0x911FB50)
#define RPG_CLIENT_AVATARDATA_SET_SPECIFIEDGENDERTYPE_OFFSET UNITYSDK_OFFSET(0x9121D80)
#define RPG_CLIENT_AVATARDATA_SET_ULTRASKILLCONFIG_OFFSET UNITYSDK_OFFSET(0x9121CB0)
#define RPG_CLIENT_AVATARDATA_SWITCHENHANCEDID_OFFSET UNITYSDK_OFFSET(0x911CA80)
#define RPG_CLIENT_AVATARDATA_SYNCAVATARDATA_OFFSET UNITYSDK_OFFSET(0x911BFC0)
#define RPG_CLIENT_AVATARDATA_SYNCAVATARPATHDATAWITHOUTEQUIPMENTANDRELIC_OFFSET UNITYSDK_OFFSET(0x911B9E0)
#define RPG_CLIENT_AVATARDATA_SYNCAVATARPATHDATA_OFFSET UNITYSDK_OFFSET(0x911C860)
#define RPG_CLIENT_AVATARDATA__ADDSKIN_OFFSET UNITYSDK_OFFSET(0x91189E0)
#define RPG_CLIENT_AVATARDATA__BUILDSKILLTREESANDSKILLS_OFFSET UNITYSDK_OFFSET(0x911AD40)
#define RPG_CLIENT_AVATARDATA__BUILDSPECIALAVATAREQUIPMENT_OFFSET UNITYSDK_OFFSET(0x911A930)
#define RPG_CLIENT_AVATARDATA__BUILDSPECIALAVATARRELIC_OFFSET UNITYSDK_OFFSET(0x911AA50)
#define RPG_CLIENT_AVATARDATA__CHECKHASSKIN_OFFSET UNITYSDK_OFFSET(0x9117D40)
#define RPG_CLIENT_AVATARDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9118BD0)
#define RPG_CLIENT_AVATARDATA__ENSUREHASINITIALIZED_OFFSET UNITYSDK_OFFSET(0x9117C70)
#define RPG_CLIENT_AVATARDATA__INITSKINS_OFFSET UNITYSDK_OFFSET(0x9118520)
#define RPG_CLIENT_AVATARDATA__RECORDDATA_OFFSET UNITYSDK_OFFSET(0x911F980)
#define RPG_CLIENT_AVATARDATA__REFRESHBEFOREDATA_OFFSET UNITYSDK_OFFSET(0x911C550)
#define RPG_CLIENT_AVATARDATA__REFRESHSERVANTDATA_OFFSET UNITYSDK_OFFSET(0x911C730)
#define RPG_CLIENT_AVATARDATA__SWITCHRELICSETDATA_OFFSET UNITYSDK_OFFSET(0x911E440)
...
namespace RPG::Client
{
	...
	{
	public:
		::Class_1_BBF620797152C03F* _EquipmentModifier_k__BackingField; // 0x10
		::RPG::Client::AvatarGrowUpBeforeData* _GrowUpBeforeData_k__BackingField; // 0x18
		::RPG::Client::AvatarOutfit* _Outfit_k__BackingField; // 0x20
		::RPG::GameCore::IAvatarCommonRowWrap* _Row_k__BackingField; // 0x28
		::System::String* _AvatarCustomName; // 0x30
		::Class_1_03C16F0BFAD3A648* _AvatarPropertyData_k__BackingField; // 0x38
		::System::Collections::Generic::Dictionary_2<::RPG::GameCore::BattleExtraPropertyAddition, ::RPG::GameCore::FixPoint>* _ExtraPropertyAddition; // 0x40
		::RPG::Client::CombatPowerData* _CombatPowerData_k__BackingField; // 0x48
		::RPG::Client::AvatarGrowUpBeforeData* _PromotedBeforeData_k__BackingField; // 0x50
		::RPG::GameCore::SpecialAvatarRow* _SpecialRow_k__BackingField; // 0x58
		::RPG::Client::AvatarGrowUpBeforeData* _LevelUpedBeforeData_k__BackingField; // 0x60
		::Class_1_19A9A4869232D3A4* _RelicSuitModifier_k__BackingField; // 0x68
		::System::Collections::Generic::List_1<::System::UInt32>* _HasTakenPromotionRewardList_k__BackingField; // 0x70
		::RPG::Client::AvatarSkillTreeData* SkillTreeData; // 0x78
		::Class_1_9B9B872136BC0EE3* _ServantData_k__BackingField; // 0x80
		::RPG::Client::EquipmentItemData* _TrialEquipment; // 0x88
		::RPG::GameCore::AvatarRowData* _AvatarRowData; // 0x90
		::RPG::Client::TwoKeyDictionary_3<::System::UInt32, ::System::UInt32, ::RPG::GameCore::AvatarSkillRowData*>* _SkillDataMap; // 0x98
		::RPG::GameCore::AvatarUltraSkillConfigRow* _UltraSkillConfig_k__BackingField; // 0xA0
		::Class_1_BBF620797152C03F_1* _SkillTreeModifier_k__BackingField; // 0xA8
		...
		::RPG::Client::RelicSuitData* _RelicsData_k__BackingField; // 0xB8
		::RPG::Client::IAvatarSkinData* _SkinData_k__BackingField; // 0xC0
		::System::UInt32 _Rank_k__BackingField; // 0xC8
		::System::UInt32 _EquipmentUID_k__BackingField; // 0xCC
		::RPG::GameCore::GenderType _SpecifiedGenderType_k__BackingField; // 0xD0
		::System::Boolean _IsNew_k__BackingField; // 0xD4
		::System::Boolean _IsMarked_k__BackingField; // 0xD5
		::System::Boolean _IsDisplayOnly_k__BackingField; // 0xD6
		::System::UInt32 _AdventurePlayerIDOverwrite; // 0xD8
		::System::UInt32 _Level_k__BackingField; // 0xDC
		::System::UInt32 _CurrentExp_k__BackingField; // 0xE0
		::Enum_3_A35B38E5F9115A76 _AvatarType_k__BackingField; // 0xE4
		::System::UInt64 FirstMetTimeStamp; // 0xE8
		::System::UInt32 _Promotion_k__BackingField; // 0xF0
