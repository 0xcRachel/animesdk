...
#define RPG_CLIENT_AVATARDATA_APPLYAVATARDATA_OFFSET UNITYSDK_OFFSET(0x15877220)
#define RPG_CLIENT_AVATARDATA_APPLYEQUIPMENT_OFFSET UNITYSDK_OFFSET(0x15876CD0)
#define RPG_CLIENT_AVATARDATA_APPLYRELICSET_OFFSET UNITYSDK_OFFSET(0x15877030)
#define RPG_CLIENT_AVATARDATA_APPLYSKILLTREE_OFFSET UNITYSDK_OFFSET(0x15876EC0)
#define RPG_CLIENT_AVATARDATA_CHANGEMULTIPATHAVATARTYPE_OFFSET UNITYSDK_OFFSET(0x15879E50)
#define RPG_CLIENT_AVATARDATA_CLEARLEVELUPBEFORDATA_OFFSET UNITYSDK_OFFSET(0x1587A0A0)
#define RPG_CLIENT_AVATARDATA_CLEARPROMOTIONBEFOREDATA_OFFSET UNITYSDK_OFFSET(0x1587A0F0)
#define RPG_CLIENT_AVATARDATA_COPYBUILDDATA_OFFSET UNITYSDK_OFFSET(0x15876AA0)
#define RPG_CLIENT_AVATARDATA_CREATEAETHERDIVIDESPIRIT_OFFSET UNITYSDK_OFFSET(0x15878D60)
#define RPG_CLIENT_AVATARDATA_CREATEASSISTAVATAR_OFFSET UNITYSDK_OFFSET(0x15876550)
#define RPG_CLIENT_AVATARDATA_CREATEBYADVENTUREPLAYERID_OFFSET UNITYSDK_OFFSET(0x15876320)
#define RPG_CLIENT_AVATARDATA_CREATEBYREALID_OFFSET UNITYSDK_OFFSET(0x15875E50)
#define RPG_CLIENT_AVATARDATA_CREATECHALLENGEUPGRADEDAVATAR_OFFSET UNITYSDK_OFFSET(0x15878020)
#define RPG_CLIENT_AVATARDATA_CREATEDISPLAYAVATAR_1_OFFSET UNITYSDK_OFFSET(0x158765F0)
#define RPG_CLIENT_AVATARDATA_CREATEDISPLAYAVATAR_2_OFFSET UNITYSDK_OFFSET(0x158788B0)
#define RPG_CLIENT_AVATARDATA_CREATEDISPLAYAVATAR_OFFSET UNITYSDK_OFFSET(0x15878850)
#define RPG_CLIENT_AVATARDATA_CREATEGACHADATABYREALID_OFFSET UNITYSDK_OFFSET(0x15876130)
#define RPG_CLIENT_AVATARDATA_CREATEMAXENHANCEDGACHADATA_OFFSET UNITYSDK_OFFSET(0x15872E20)
#define RPG_CLIENT_AVATARDATA_CREATEMULTIPATHAVATARBYREALID_OFFSET UNITYSDK_OFFSET(0x15875FC0)
#define RPG_CLIENT_AVATARDATA_CREATESPEICALAVATAR_OFFSET UNITYSDK_OFFSET(0x15877300)
#define RPG_CLIENT_AVATARDATA_CREATEUPGRADEDAVATAR_OFFSET UNITYSDK_OFFSET(0x15877AC0)
#define RPG_CLIENT_AVATARDATA_CREATE_1_OFFSET UNITYSDK_OFFSET(0x15875CE0)
#define RPG_CLIENT_AVATARDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x15875B20)
#define RPG_CLIENT_AVATARDATA_GETALLPROPERTYVALUEWITHVIRTUALRELICSET_OFFSET UNITYSDK_OFFSET(0x1587B0E0)
#define RPG_CLIENT_AVATARDATA_GETAVATARCOMBATPOWERVALUE_OFFSET UNITYSDK_OFFSET(0x1587C8A0)
#define RPG_CLIENT_AVATARDATA_GETCHARACTERSKILLDATA_1_OFFSET UNITYSDK_OFFSET(0x1587A9A0)
#define RPG_CLIENT_AVATARDATA_GETCHARACTERSKILLDATA_OFFSET UNITYSDK_OFFSET(0x1587A930)
#define RPG_CLIENT_AVATARDATA_GETCURRENTEXPPERCENT_OFFSET UNITYSDK_OFFSET(0x1587B6F0)
#define RPG_CLIENT_AVATARDATA_GETCURRENTLVMAXEXP_OFFSET UNITYSDK_OFFSET(0x1587B9A0)
#define RPG_CLIENT_AVATARDATA_GETCURRENTMAXLV_OFFSET UNITYSDK_OFFSET(0x1587BBE0)
#define RPG_CLIENT_AVATARDATA_GETDISPLAYFORMATADDVALUE_OFFSET UNITYSDK_OFFSET(0x1587AE30)
#define RPG_CLIENT_AVATARDATA_GETDISPLAYFORMATPROPERTYBASEVALUE_OFFSET UNITYSDK_OFFSET(0x1587AD90)
#define RPG_CLIENT_AVATARDATA_GETDISPLAYFORMATPROPERTYBYTYPE_OFFSET UNITYSDK_OFFSET(0x1587B650)
#define RPG_CLIENT_AVATARDATA_GETDISPLAYSKILLDATALIST_OFFSET UNITYSDK_OFFSET(0x1587A140)
#define RPG_CLIENT_AVATARDATA_GETEQUIPMENT_OFFSET UNITYSDK_OFFSET(0x1587C430)
#define RPG_CLIENT_AVATARDATA_GETEXTRAADDITION_OFFSET UNITYSDK_OFFSET(0x1587AF60)
#define RPG_CLIENT_AVATARDATA_GETFIRSTSKINTYPE_OFFSET UNITYSDK_OFFSET(0x15874690)
#define RPG_CLIENT_AVATARDATA_GETHPMAX_OFFSET UNITYSDK_OFFSET(0x1587B450)
#define RPG_CLIENT_AVATARDATA_GETLVMAXEXP_OFFSET UNITYSDK_OFFSET(0x1587BAC0)
#define RPG_CLIENT_AVATARDATA_GETMAXLV_OFFSET UNITYSDK_OFFSET(0x1587BD70)
#define RPG_CLIENT_AVATARDATA_GETMODIFIEDADVENTURECHARACTERCONFIG_OFFSET UNITYSDK_OFFSET(0x1587D590)
#define RPG_CLIENT_AVATARDATA_GETNEEDEXPTOLV_OFFSET UNITYSDK_OFFSET(0x1587B820)
#define RPG_CLIENT_AVATARDATA_GETNEWLEVELBYADDEXP_OFFSET UNITYSDK_OFFSET(0x1587C0B0)
#define RPG_CLIENT_AVATARDATA_GETNORMALSKINIDS_OFFSET UNITYSDK_OFFSET(0x15874830)
#define RPG_CLIENT_AVATARDATA_GETPROPERTYBYTYPE_OFFSET UNITYSDK_OFFSET(0x1587B5C0)
#define RPG_CLIENT_AVATARDATA_GETPROPERTYUIDATA_OFFSET UNITYSDK_OFFSET(0x1587ABC0)
#define RPG_CLIENT_AVATARDATA_GETRANKAFTEREXTRAADDITION_OFFSET UNITYSDK_OFFSET(0x1587B020)
#define RPG_CLIENT_AVATARDATA_GETRELICLIST_OFFSET UNITYSDK_OFFSET(0x1587C4E0)
#define RPG_CLIENT_AVATARDATA_GETSKINIDS_OFFSET UNITYSDK_OFFSET(0x15874880)
#define RPG_CLIENT_AVATARDATA_GETSPMAX_OFFSET UNITYSDK_OFFSET(0x1587B4D0)
#define RPG_CLIENT_AVATARDATA_GETSTELLARSKINIDS_OFFSET UNITYSDK_OFFSET(0x158749F0)
#define RPG_CLIENT_AVATARDATA_GET_ADVENTUREJSONCONFIGPATH_OFFSET UNITYSDK_OFFSET(0x1587D840)
#define RPG_CLIENT_AVATARDATA_GET_ADVENTUREPLAYERID_OFFSET UNITYSDK_OFFSET(0x1587D260)
#define RPG_CLIENT_AVATARDATA_GET_AVATARJSONPATH_OFFSET UNITYSDK_OFFSET(0x1587D9E0)
#define RPG_CLIENT_AVATARDATA_GET_AVATARNAME_OFFSET UNITYSDK_OFFSET(0x15879D30)
#define RPG_CLIENT_AVATARDATA_GET_AVATARPROPERTYDATA_OFFSET UNITYSDK_OFFSET(0x1587E0E0)
#define RPG_CLIENT_AVATARDATA_GET_AVATARROWDATA_OFFSET UNITYSDK_OFFSET(0x1587E140)
#define RPG_CLIENT_AVATARDATA_GET_AVATARTYPE_OFFSET UNITYSDK_OFFSET(0x1587CF10)
#define RPG_CLIENT_AVATARDATA_GET_BASEID_OFFSET UNITYSDK_OFFSET(0x15874420)
#define RPG_CLIENT_AVATARDATA_GET_CAMPID_OFFSET UNITYSDK_OFFSET(0x1587DF10)
#define RPG_CLIENT_AVATARDATA_GET_CAMPROW_OFFSET UNITYSDK_OFFSET(0x1587DEA0)
#define RPG_CLIENT_AVATARDATA_GET_COMBATPOWERDATA_OFFSET UNITYSDK_OFFSET(0x1587E100)
#define RPG_CLIENT_AVATARDATA_GET_CURRENTEXP_OFFSET UNITYSDK_OFFSET(0x1587DD90)
#define RPG_CLIENT_AVATARDATA_GET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0x1587CF30)
#define RPG_CLIENT_AVATARDATA_GET_DEFAULTAVATARMODELPATH_OFFSET UNITYSDK_OFFSET(0x1587DBD0)
#define RPG_CLIENT_AVATARDATA_GET_ENHANCEDID_OFFSET UNITYSDK_OFFSET(0x158744B0)
#define RPG_CLIENT_AVATARDATA_GET_EQUIPMENTMODIFIER_OFFSET UNITYSDK_OFFSET(0x1587E350)
#define RPG_CLIENT_AVATARDATA_GET_EQUIPMENTUID_OFFSET UNITYSDK_OFFSET(0x1587DD50)
#define RPG_CLIENT_AVATARDATA_GET_GROWUPBEFOREDATA_OFFSET UNITYSDK_OFFSET(0x1587E080)
#define RPG_CLIENT_AVATARDATA_GET_HASEQUIPMENT_OFFSET UNITYSDK_OFFSET(0x1587E1B0)
#define RPG_CLIENT_AVATARDATA_GET_HASSERVANT_OFFSET UNITYSDK_OFFSET(0x1587ABB0)
#define RPG_CLIENT_AVATARDATA_GET_HASSKIN_OFFSET UNITYSDK_OFFSET(0x158745A0)
#define RPG_CLIENT_AVATARDATA_GET_HASTAKENPROMOTIONREWARDLIST_OFFSET UNITYSDK_OFFSET(0x1587E270)
#define RPG_CLIENT_AVATARDATA_GET_HEROGENDER_OFFSET UNITYSDK_OFFSET(0x1587CE80)
#define RPG_CLIENT_AVATARDATA_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x158740E0)
#define RPG_CLIENT_AVATARDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0x15878C50)
#define RPG_CLIENT_AVATARDATA_GET_ISAETHERDIVIDE_OFFSET UNITYSDK_OFFSET(0x1587DCA0)
#define RPG_CLIENT_AVATARDATA_GET_ISASSISTAVATAR_OFFSET UNITYSDK_OFFSET(0x1587DC80)
#define RPG_CLIENT_AVATARDATA_GET_ISCUSTOMNAME_OFFSET UNITYSDK_OFFSET(0x1587D250)
#define RPG_CLIENT_AVATARDATA_GET_ISDISPLAYONLY_OFFSET UNITYSDK_OFFSET(0x1587DCD0)
#define RPG_CLIENT_AVATARDATA_GET_ISFIXEDPATHAVATAR_OFFSET UNITYSDK_OFFSET(0x1587DC90)
#define RPG_CLIENT_AVATARDATA_GET_ISFORMALAVATAR_OFFSET UNITYSDK_OFFSET(0x1587DCB0)
#define RPG_CLIENT_AVATARDATA_GET_ISHERO_OFFSET UNITYSDK_OFFSET(0x1587CD30)
#define RPG_CLIENT_AVATARDATA_GET_ISMARKED_OFFSET UNITYSDK_OFFSET(0x1587E290)
#define RPG_CLIENT_AVATARDATA_GET_ISNEW_OFFSET UNITYSDK_OFFSET(0x1587E250)
#define RPG_CLIENT_AVATARDATA_GET_ISPLOTTRIALPLAYER_OFFSET UNITYSDK_OFFSET(0x1587D3C0)
#define RPG_CLIENT_AVATARDATA_GET_ISSHOWSKILLPLOTTRIALPLAYER_OFFSET UNITYSDK_OFFSET(0x1587D420)
#define RPG_CLIENT_AVATARDATA_GET_ISTRIALPLAYER_OFFSET UNITYSDK_OFFSET(0x15879CD0)
#define RPG_CLIENT_AVATARDATA_GET_ISUPGRADEAVAILABLETYPE_OFFSET UNITYSDK_OFFSET(0x1587DCC0)
#define RPG_CLIENT_AVATARDATA_GET_LEVELUPEDBEFOREDATA_OFFSET UNITYSDK_OFFSET(0x1587E0A0)
#define RPG_CLIENT_AVATARDATA_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1587DCF0)
#define RPG_CLIENT_AVATARDATA_GET_MAXPROMOTION_OFFSET UNITYSDK_OFFSET(0x1587BF00)
#define RPG_CLIENT_AVATARDATA_GET_MAXRANK_OFFSET UNITYSDK_OFFSET(0x1587DDB0)
#define RPG_CLIENT_AVATARDATA_GET_MULTIPATHAVATARTYPE_OFFSET UNITYSDK_OFFSET(0x1587CF00)
#define RPG_CLIENT_AVATARDATA_GET_OUTFIT_OFFSET UNITYSDK_OFFSET(0x1587E3A0)
#define RPG_CLIENT_AVATARDATA_GET_PREFSSHOWSIMPLIFIEDSKILLDESC_OFFSET UNITYSDK_OFFSET(0x1587D4C0)
#define RPG_CLIENT_AVATARDATA_GET_PROFESSIONTYPENAME_OFFSET UNITYSDK_OFFSET(0x1587D110)
#define RPG_CLIENT_AVATARDATA_GET_PROFESSIONTYPE_OFFSET UNITYSDK_OFFSET(0x1587D020)
#define RPG_CLIENT_AVATARDATA_GET_PROMOTEDBEFOREDATA_OFFSET UNITYSDK_OFFSET(0x1587E0C0)
#define RPG_CLIENT_AVATARDATA_GET_PROMOTION_OFFSET UNITYSDK_OFFSET(0x1587DD10)
#define RPG_CLIENT_AVATARDATA_GET_RANK_OFFSET UNITYSDK_OFFSET(0x1587DD30)
#define RPG_CLIENT_AVATARDATA_GET_REALID_OFFSET UNITYSDK_OFFSET(0x158742E0)
#define RPG_CLIENT_AVATARDATA_GET_RELICSDATA_OFFSET UNITYSDK_OFFSET(0x1587DD70)
#define RPG_CLIENT_AVATARDATA_GET_RELICSUITMODIFIER_OFFSET UNITYSDK_OFFSET(0x1587E370)
#define RPG_CLIENT_AVATARDATA_GET_ROLETYPE_OFFSET UNITYSDK_OFFSET(0x1587CCA0)
#define RPG_CLIENT_AVATARDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0x1587CC60)
#define RPG_CLIENT_AVATARDATA_GET_SERVANTDATA_OFFSET UNITYSDK_OFFSET(0x1587E120)
#define RPG_CLIENT_AVATARDATA_GET_SKILLTREEMODIFIER_OFFSET UNITYSDK_OFFSET(0x1587E360)
#define RPG_CLIENT_AVATARDATA_GET_SKINDATA_OFFSET UNITYSDK_OFFSET(0x1587E330)
#define RPG_CLIENT_AVATARDATA_GET_SPECIALAVATARID_OFFSET UNITYSDK_OFFSET(0x158743C0)
#define RPG_CLIENT_AVATARDATA_GET_SPECIALROW_OFFSET UNITYSDK_OFFSET(0x1587CC80)
#define RPG_CLIENT_AVATARDATA_GET_SPECIFIEDGENDERTYPE_OFFSET UNITYSDK_OFFSET(0x1587E380)
#define RPG_CLIENT_AVATARDATA_GET_TRIALPLAYERID_OFFSET UNITYSDK_OFFSET(0x1587D360)
#define RPG_CLIENT_AVATARDATA_GET_ULTRASKILLCONFIG_OFFSET UNITYSDK_OFFSET(0x1587E2B0)
#define RPG_CLIENT_AVATARDATA_GET_ULTRASKILLTYPE_OFFSET UNITYSDK_OFFSET(0x1587E2D0)
#define RPG_CLIENT_AVATARDATA_GET__PROFESSIONTYPEROW_OFFSET UNITYSDK_OFFSET(0x1587D1E0)
#define RPG_CLIENT_AVATARDATA_ISCURHERO_OFFSET UNITYSDK_OFFSET(0x15878B00)
#define RPG_CLIENT_AVATARDATA_ISHEROID_OFFSET UNITYSDK_OFFSET(0x1586F950)
#define RPG_CLIENT_AVATARDATA_ISMAXPROMOTION_OFFSET UNITYSDK_OFFSET(0x1587C050)
#define RPG_CLIENT_AVATARDATA_ISPROMOTIONMAXLEVEL_OFFSET UNITYSDK_OFFSET(0x1587BFF0)
#define RPG_CLIENT_AVATARDATA_ISPROMOTIONREWARDRECEIVED_OFFSET UNITYSDK_OFFSET(0x1587C9C0)
#define RPG_CLIENT_AVATARDATA_ISSAMEGENDER_OFFSET UNITYSDK_OFFSET(0x15878CE0)
#define RPG_CLIENT_AVATARDATA_ISSERVANTSKILLID_OFFSET UNITYSDK_OFFSET(0x1587AB30)
#define RPG_CLIENT_AVATARDATA_REFRESHCHALLENGEUPGRADEDAVATAR_OFFSET UNITYSDK_OFFSET(0x15878230)
#define RPG_CLIENT_AVATARDATA_REFRESHUPGRADEDAVATAR_OFFSET UNITYSDK_OFFSET(0x15877C40)
#define RPG_CLIENT_AVATARDATA_RESETEXTRAPROPERTYADDITION_OFFSET UNITYSDK_OFFSET(0x1587C3D0)
#define RPG_CLIENT_AVATARDATA_REVERTPREFSSHOWSIMPLIFIEDSKILLDESC_OFFSET UNITYSDK_OFFSET(0x1587D540)
#define RPG_CLIENT_AVATARDATA_SETAVATARLEVEL_OFFSET UNITYSDK_OFFSET(0x15879C80)
#define RPG_CLIENT_AVATARDATA_SETAVATARSKIN_OFFSET UNITYSDK_OFFSET(0x15874D50)
#define RPG_CLIENT_AVATARDATA_SETEXTRAPROPERTYADDITION_OFFSET UNITYSDK_OFFSET(0x1587C2E0)
#define RPG_CLIENT_AVATARDATA_SETGACHAINITIALDATA_OFFSET UNITYSDK_OFFSET(0x15876290)
#define RPG_CLIENT_AVATARDATA_SETGACHAULTIMATEDATA_OFFSET UNITYSDK_OFFSET(0x1587C770)
#define RPG_CLIENT_AVATARDATA_SETINITIALDATA_OFFSET UNITYSDK_OFFSET(0x1587C530)
#define RPG_CLIENT_AVATARDATA_SETMULTIPATHDRESSEDSKINID_OFFSET UNITYSDK_OFFSET(0x15874A40)
#define RPG_CLIENT_AVATARDATA_SETRANK_OFFSET UNITYSDK_OFFSET(0x1587A050)
#define RPG_CLIENT_AVATARDATA_SETULTIMATEDATA_OFFSET UNITYSDK_OFFSET(0x1587C5B0)
#define RPG_CLIENT_AVATARDATA_SET_AVATARPROPERTYDATA_OFFSET UNITYSDK_OFFSET(0x1587E0F0)
#define RPG_CLIENT_AVATARDATA_SET_AVATARTYPE_OFFSET UNITYSDK_OFFSET(0x1587CF20)
#define RPG_CLIENT_AVATARDATA_SET_COMBATPOWERDATA_OFFSET UNITYSDK_OFFSET(0x1587E110)
#define RPG_CLIENT_AVATARDATA_SET_CURRENTEXP_OFFSET UNITYSDK_OFFSET(0x1587DDA0)
#define RPG_CLIENT_AVATARDATA_SET_EQUIPMENTUID_OFFSET UNITYSDK_OFFSET(0x1587DD60)
#define RPG_CLIENT_AVATARDATA_SET_GROWUPBEFOREDATA_OFFSET UNITYSDK_OFFSET(0x1587E090)
#define RPG_CLIENT_AVATARDATA_SET_HASTAKENPROMOTIONREWARDLIST_OFFSET UNITYSDK_OFFSET(0x1587E280)
#define RPG_CLIENT_AVATARDATA_SET_ISDISPLAYONLY_OFFSET UNITYSDK_OFFSET(0x1587DCE0)
#define RPG_CLIENT_AVATARDATA_SET_ISMARKED_OFFSET UNITYSDK_OFFSET(0x1587E2A0)
#define RPG_CLIENT_AVATARDATA_SET_ISNEW_OFFSET UNITYSDK_OFFSET(0x1587E260)
#define RPG_CLIENT_AVATARDATA_SET_LEVELUPEDBEFOREDATA_OFFSET UNITYSDK_OFFSET(0x1587E0B0)
#define RPG_CLIENT_AVATARDATA_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1587DD00)
#define RPG_CLIENT_AVATARDATA_SET_OUTFIT_OFFSET UNITYSDK_OFFSET(0x1587E3B0)
#define RPG_CLIENT_AVATARDATA_SET_PROMOTEDBEFOREDATA_OFFSET UNITYSDK_OFFSET(0x1587E0D0)
#define RPG_CLIENT_AVATARDATA_SET_PROMOTION_OFFSET UNITYSDK_OFFSET(0x1587DD20)
#define RPG_CLIENT_AVATARDATA_SET_RANK_OFFSET UNITYSDK_OFFSET(0x1587DD40)
#define RPG_CLIENT_AVATARDATA_SET_RELICSDATA_OFFSET UNITYSDK_OFFSET(0x1587DD80)
#define RPG_CLIENT_AVATARDATA_SET_ROW_OFFSET UNITYSDK_OFFSET(0x1587CC70)
#define RPG_CLIENT_AVATARDATA_SET_SERVANTDATA_OFFSET UNITYSDK_OFFSET(0x1587E130)
#define RPG_CLIENT_AVATARDATA_SET_SKINDATA_OFFSET UNITYSDK_OFFSET(0x1587E340)
#define RPG_CLIENT_AVATARDATA_SET_SPECIALROW_OFFSET UNITYSDK_OFFSET(0x1587CC90)
#define RPG_CLIENT_AVATARDATA_SET_SPECIFIEDGENDERTYPE_OFFSET UNITYSDK_OFFSET(0x1587E390)
#define RPG_CLIENT_AVATARDATA_SET_ULTRASKILLCONFIG_OFFSET UNITYSDK_OFFSET(0x1587E2C0)
#define RPG_CLIENT_AVATARDATA_SWITCHENHANCEDID_OFFSET UNITYSDK_OFFSET(0x158799F0)
#define RPG_CLIENT_AVATARDATA_SYNCAVATARDATA_OFFSET UNITYSDK_OFFSET(0x15878F20)
#define RPG_CLIENT_AVATARDATA_SYNCAVATARPATHDATAWITHOUTEQUIPMENTANDRELIC_OFFSET UNITYSDK_OFFSET(0x158786F0)
#define RPG_CLIENT_AVATARDATA_SYNCAVATARPATHDATA_OFFSET UNITYSDK_OFFSET(0x158797D0)
#define RPG_CLIENT_AVATARDATA__ADDSKIN_OFFSET UNITYSDK_OFFSET(0x158756C0)
#define RPG_CLIENT_AVATARDATA__BUILDSKILLTREESANDSKILLS_OFFSET UNITYSDK_OFFSET(0x15877A60)
#define RPG_CLIENT_AVATARDATA__BUILDSPECIALAVATAREQUIPMENT_OFFSET UNITYSDK_OFFSET(0x15877660)
#define RPG_CLIENT_AVATARDATA__BUILDSPECIALAVATARRELIC_OFFSET UNITYSDK_OFFSET(0x15877780)
#define RPG_CLIENT_AVATARDATA__CHECKHASSKIN_OFFSET UNITYSDK_OFFSET(0x15874700)
#define RPG_CLIENT_AVATARDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x15875870)
#define RPG_CLIENT_AVATARDATA__ENSUREHASINITIALIZED_OFFSET UNITYSDK_OFFSET(0x15874640)
#define RPG_CLIENT_AVATARDATA__INITSKINS_OFFSET UNITYSDK_OFFSET(0x15874E70)
#define RPG_CLIENT_AVATARDATA__RECORDDATA_OFFSET UNITYSDK_OFFSET(0x1587CA30)
#define RPG_CLIENT_AVATARDATA__REFRESHBEFOREDATA_OFFSET UNITYSDK_OFFSET(0x158794C0)
#define RPG_CLIENT_AVATARDATA__REFRESHSERVANTDATA_OFFSET UNITYSDK_OFFSET(0x158796B0)
#define RPG_CLIENT_AVATARDATA__SWITCHRELICSETDATA_OFFSET UNITYSDK_OFFSET(0x1587B400)
...
namespace RPG::Client
{
	...
	{
	public:
		::RPG::Client::CombatPowerData* _CombatPowerData_k__BackingField; // 0x10
		::RPG::Client::IAvatarSkinData* _SkinData_k__BackingField; // 0x18
		::System::Collections::Generic::Dictionary_2<::RPG::GameCore::AvatarSkinType, ::System::Collections::Generic::List_1<::System::UInt32>*>* _SkinIDs; // 0x20
		::System::String* _AvatarCustomName; // 0x28
		::RPG::Client::AvatarGrowUpBeforeData* _LevelUpedBeforeData_k__BackingField; // 0x30
		::RPG::GameCore::IAvatarCommonRowWrap* _Row_k__BackingField; // 0x38
		::RPG::Client::AvatarOutfit* _Outfit_k__BackingField; // 0x40
		::Class_1_9B9B872136BC0EE3* _ServantData_k__BackingField; // 0x48
		::RPG::Client::TwoKeyDictionary_3<::System::UInt32, ::System::UInt32, ::RPG::GameCore::AvatarSkillRowData*>* _SkillDataMap; // 0x50
		::Class_1_19A9A4869232D3A4* _RelicSuitModifier_k__BackingField; // 0x58
		::RPG::Client::RelicSuitData* _RelicsData_k__BackingField; // 0x60
		::RPG::Client::AvatarGrowUpBeforeData* _GrowUpBeforeData_k__BackingField; // 0x68
		::RPG::GameCore::SpecialAvatarRow* _SpecialRow_k__BackingField; // 0x70
		::System::Collections::Generic::List_1<::System::UInt32>* _HasTakenPromotionRewardList_k__BackingField; // 0x78
		::RPG::Client::AvatarSkillTreeData* SkillTreeData; // 0x80
		::RPG::Client::EquipmentItemData* _TrialEquipment; // 0x88
		::RPG::GameCore::AvatarUltraSkillConfigRow* _UltraSkillConfig_k__BackingField; // 0x90
		::RPG::Client::AvatarGrowUpBeforeData* _PromotedBeforeData_k__BackingField; // 0x98
		::RPG::GameCore::AvatarRowData* _AvatarRowData; // 0xA0
		::Class_1_BBF620797152C03F* _EquipmentModifier_k__BackingField; // 0xA8
		::Class_1_BBF620797152C03F_1* _SkillTreeModifier_k__BackingField; // 0xB0
		::System::Collections::Generic::Dictionary_2<::RPG::GameCore::BattleExtraPropertyAddition, ::RPG::GameCore::FixPoint>* _ExtraPropertyAddition; // 0xB8
		::Class_1_03C16F0BFAD3A648* _AvatarPropertyData_k__BackingField; // 0xC0
		::RPG::GameCore::GenderType _SpecifiedGenderType_k__BackingField; // 0xC8
		::System::UInt32 _Rank_k__BackingField; // 0xCC
		::System::Boolean _IsMarked_k__BackingField; // 0xD0
		::System::Boolean _IsDisplayOnly_k__BackingField; // 0xD1
		::System::Boolean _IsNew_k__BackingField; // 0xD2
		::System::UInt32 _AdventurePlayerIDOverwrite; // 0xD4
		::System::UInt32 _Promotion_k__BackingField; // 0xD8
		::System::UInt32 _EquipmentUID_k__BackingField; // 0xDC
		::System::UInt32 _Level_k__BackingField; // 0xE0
		::System::UInt32 _CurrentExp_k__BackingField; // 0xE4
		::Enum_3_01618AD0437C8486 _AvatarType_k__BackingField; // 0xE8
		::System::UInt64 FirstMetTimeStamp; // 0xF0
		...
		::System::Void SyncAvatarData(::Class_1_BB4B99DE4C2501EC_3* baseData, ::Class_1_F3CA30716D4FAF92_3* uniqueData)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_BB4B99DE4C2501EC_3*, ::Class_1_F3CA30716D4FAF92_3*))((::PBYTE)hIl2Cpp + RPG_CLIENT_AVATARDATA_SYNCAVATARDATA_OFFSET))(this, baseData, uniqueData);
		}
		...
		::Class_1_BBF620797152C03F* get_EquipmentModifier()
		{
			return ((::Class_1_BBF620797152C03F*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_AVATARDATA_GET_EQUIPMENTMODIFIER_OFFSET))(this);
		}

		::Class_1_BBF620797152C03F_1* get_SkillTreeModifier()
		{
			return ((::Class_1_BBF620797152C03F_1*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_AVATARDATA_GET_SKILLTREEMODIFIER_OFFSET))(this);
		}
