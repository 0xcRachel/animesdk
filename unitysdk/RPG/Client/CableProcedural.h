...
#define RPG_CLIENT_CABLEPROCEDURAL_AWAKE_OFFSET UNITYSDK_OFFSET(0x921ED20)
#define RPG_CLIENT_CABLEPROCEDURAL_LATETICK_OFFSET UNITYSDK_OFFSET(0x921EF10)
#define RPG_CLIENT_CABLEPROCEDURAL_METHOD_5_19B91D58E02869BC_OFFSET UNITYSDK_OFFSET(0x921F360)
#define RPG_CLIENT_CABLEPROCEDURAL_METHOD_5_56BF6518E35FCD15_OFFSET UNITYSDK_OFFSET(0x921FF30)
#define RPG_CLIENT_CABLEPROCEDURAL_METHOD_5_616B5B1FFE25821C_OFFSET UNITYSDK_OFFSET(0x9220180)
#define RPG_CLIENT_CABLEPROCEDURAL_METHOD_5_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x921EE20)
#define RPG_CLIENT_CABLEPROCEDURAL_METHOD_5_D7DC8A0EDD4003E0_OFFSET UNITYSDK_OFFSET(0x921F810)
#define RPG_CLIENT_CABLEPROCEDURAL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x921EDD0)
#define RPG_CLIENT_CABLEPROCEDURAL__CTOR_OFFSET UNITYSDK_OFFSET(0x92203C0)
