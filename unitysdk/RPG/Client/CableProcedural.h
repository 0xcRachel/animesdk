...
#define RPG_CLIENT_CABLEPROCEDURAL_AWAKE_OFFSET UNITYSDK_OFFSET(0x8E14F50)
#define RPG_CLIENT_CABLEPROCEDURAL_LATETICK_OFFSET UNITYSDK_OFFSET(0x8E15140)
#define RPG_CLIENT_CABLEPROCEDURAL_METHOD_5_19B91D58E02869BC_OFFSET UNITYSDK_OFFSET(0x8E15590)
#define RPG_CLIENT_CABLEPROCEDURAL_METHOD_5_56BF6518E35FCD15_OFFSET UNITYSDK_OFFSET(0x8E16160)
#define RPG_CLIENT_CABLEPROCEDURAL_METHOD_5_616B5B1FFE25821C_OFFSET UNITYSDK_OFFSET(0x8E163B0)
#define RPG_CLIENT_CABLEPROCEDURAL_METHOD_5_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x8E15050)
#define RPG_CLIENT_CABLEPROCEDURAL_METHOD_5_D7DC8A0EDD4003E0_OFFSET UNITYSDK_OFFSET(0x8E15A40)
#define RPG_CLIENT_CABLEPROCEDURAL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x8E15000)
#define RPG_CLIENT_CABLEPROCEDURAL__CTOR_OFFSET UNITYSDK_OFFSET(0x8E165F0)

namespace RPG::Client
{
	inline static constexpr unsigned int CableProcedural_TypeDefinitionIndex = 56065;
