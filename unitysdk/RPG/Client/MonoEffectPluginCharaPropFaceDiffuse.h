...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEDIFFUSE_INIT_OFFSET UNITYSDK_OFFSET(0x165E9310)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEDIFFUSE_UNINIT_OFFSET UNITYSDK_OFFSET(0x165EA8A0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEDIFFUSE_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x165E95F0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEDIFFUSE__CTOR_OFFSET UNITYSDK_OFFSET(0x165EA940)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEDIFFUSE___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x165EA9D0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEDIFFUSE___IFIXBASEPROXY_UNINIT_OFFSET UNITYSDK_OFFSET(0x165EA9E0)
