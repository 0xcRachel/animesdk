...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEDIFFUSE_INIT_OFFSET UNITYSDK_OFFSET(0x15A29890)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEDIFFUSE_UNINIT_OFFSET UNITYSDK_OFFSET(0x15A2AEF0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEDIFFUSE_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x15A29C40)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEDIFFUSE__CTOR_OFFSET UNITYSDK_OFFSET(0x15A2AF90)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEDIFFUSE___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x15A2B020)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEDIFFUSE___IFIXBASEPROXY_UNINIT_OFFSET UNITYSDK_OFFSET(0x15A2B030)
