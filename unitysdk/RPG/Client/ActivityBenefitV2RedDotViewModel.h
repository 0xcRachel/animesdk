...
#define RPG_CLIENT_ACTIVITYBENEFITV2REDDOTVIEWMODEL_ADD_ONCHANGED_OFFSET UNITYSDK_OFFSET(0x8B01150)
#define RPG_CLIENT_ACTIVITYBENEFITV2REDDOTVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x8B01100)
#define RPG_CLIENT_ACTIVITYBENEFITV2REDDOTVIEWMODEL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8B01660)
#define RPG_CLIENT_ACTIVITYBENEFITV2REDDOTVIEWMODEL_GET__SEASON_OFFSET UNITYSDK_OFFSET(0x8B01360)
#define RPG_CLIENT_ACTIVITYBENEFITV2REDDOTVIEWMODEL_ISALLREWARDCLAIMED_OFFSET UNITYSDK_OFFSET(0x8B01DC0)
#define RPG_CLIENT_ACTIVITYBENEFITV2REDDOTVIEWMODEL_ISANYREWARDCLAIMABLE_OFFSET UNITYSDK_OFFSET(0x8B00EB0)
#define RPG_CLIENT_ACTIVITYBENEFITV2REDDOTVIEWMODEL_ISINITIALREWARDCLAIMABLE_OFFSET UNITYSDK_OFFSET(0x8B01D60)
#define RPG_CLIENT_ACTIVITYBENEFITV2REDDOTVIEWMODEL_REMOVE_ONCHANGED_OFFSET UNITYSDK_OFFSET(0x8B01440)
#define RPG_CLIENT_ACTIVITYBENEFITV2REDDOTVIEWMODEL_VISITREWARDINGROUNDS_OFFSET UNITYSDK_OFFSET(0x8B01980)
#define RPG_CLIENT_ACTIVITYBENEFITV2REDDOTVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x8B014A0)
#define RPG_CLIENT_ACTIVITYBENEFITV2REDDOTVIEWMODEL__ONCLAIMREWARDFINISHED_OFFSET UNITYSDK_OFFSET(0x8B01910)
#define RPG_CLIENT_ACTIVITYBENEFITV2REDDOTVIEWMODEL__ONDRAWFINISHED_OFFSET UNITYSDK_OFFSET(0x8B018B0)
#define RPG_CLIENT_ACTIVITYBENEFITV2REDDOTVIEWMODEL__ONGETDATAFINISHED_OFFSET UNITYSDK_OFFSET(0x8B01860)

namespace RPG::Client
{
	inline static constexpr unsigned int ActivityBenefitV2RedDotViewModel_TypeDefinitionIndex = 48721;
