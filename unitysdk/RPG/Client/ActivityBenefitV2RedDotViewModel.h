...
#define RPG_CLIENT_ACTIVITYBENEFITV2REDDOTVIEWMODEL_ADD_ONCHANGED_OFFSET UNITYSDK_OFFSET(0x171C8040)
#define RPG_CLIENT_ACTIVITYBENEFITV2REDDOTVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x171C7FF0)
#define RPG_CLIENT_ACTIVITYBENEFITV2REDDOTVIEWMODEL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x171C7840)
#define RPG_CLIENT_ACTIVITYBENEFITV2REDDOTVIEWMODEL_GET__SEASON_OFFSET UNITYSDK_OFFSET(0x171C8250)
#define RPG_CLIENT_ACTIVITYBENEFITV2REDDOTVIEWMODEL_ISALLREWARDCLAIMED_OFFSET UNITYSDK_OFFSET(0x171C7C10)
#define RPG_CLIENT_ACTIVITYBENEFITV2REDDOTVIEWMODEL_ISANYREWARDCLAIMABLE_OFFSET UNITYSDK_OFFSET(0x171C7DA0)
#define RPG_CLIENT_ACTIVITYBENEFITV2REDDOTVIEWMODEL_ISINITIALREWARDCLAIMABLE_OFFSET UNITYSDK_OFFSET(0x171C8A70)
#define RPG_CLIENT_ACTIVITYBENEFITV2REDDOTVIEWMODEL_REMOVE_ONCHANGED_OFFSET UNITYSDK_OFFSET(0x171C8330)
#define RPG_CLIENT_ACTIVITYBENEFITV2REDDOTVIEWMODEL_VISITREWARDINGROUNDS_OFFSET UNITYSDK_OFFSET(0x171C86C0)
#define RPG_CLIENT_ACTIVITYBENEFITV2REDDOTVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x171C8390)
#define RPG_CLIENT_ACTIVITYBENEFITV2REDDOTVIEWMODEL__ONCLAIMREWARDFINISHED_OFFSET UNITYSDK_OFFSET(0x171C8650)
#define RPG_CLIENT_ACTIVITYBENEFITV2REDDOTVIEWMODEL__ONDRAWFINISHED_OFFSET UNITYSDK_OFFSET(0x171C85F0)
#define RPG_CLIENT_ACTIVITYBENEFITV2REDDOTVIEWMODEL__ONGETDATAFINISHED_OFFSET UNITYSDK_OFFSET(0x171C85A0)
