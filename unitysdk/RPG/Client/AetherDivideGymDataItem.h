...
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_CLEARNEWSTATUS_OFFSET UNITYSDK_OFFSET(0x8C30310)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8C2FB10)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GETDISPLAYMONSTERDATAS_OFFSET UNITYSDK_OFFSET(0x8C30610)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GETSCHEDULEDATA_OFFSET UNITYSDK_OFFSET(0x8C30150)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GETSPIRITCOLLECTIONINFO_OFFSET UNITYSDK_OFFSET(0x8C2FCC0)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GETSTARCOUNT_OFFSET UNITYSDK_OFFSET(0x8C30920)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GETTRAINERCHALLENGEINFO_OFFSET UNITYSDK_OFFSET(0x8C2FE20)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_ACTIVITYMODULEID_OFFSET UNITYSDK_OFFSET(0x8C304D0)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_BGPATH_OFFSET UNITYSDK_OFFSET(0x8C31300)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_DESC_OFFSET UNITYSDK_OFFSET(0x8C30ED0)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_ENTRANCEID_OFFSET UNITYSDK_OFFSET(0x8C2EEF0)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_FLOORID_OFFSET UNITYSDK_OFFSET(0x8C31450)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_GYMINFOROW_OFFSET UNITYSDK_OFFSET(0x8C2F930)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x8C311B0)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0x8C30D60)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_RULE_OFFSET UNITYSDK_OFFSET(0x8C31040)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET__BADGEUNLOCKKEY_OFFSET UNITYSDK_OFFSET(0x8C30BE0)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET__FIRSTUNLOCKKEY_OFFSET UNITYSDK_OFFSET(0x8C31520)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_ISALREADYUNLOCKED_OFFSET UNITYSDK_OFFSET(0x8C2FC80)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_ISBADGEALREADYUNLOCKED_OFFSET UNITYSDK_OFFSET(0x8C2FB70)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_ISBADGEUNLOCK_OFFSET UNITYSDK_OFFSET(0x8C30420)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_ISNEW_OFFSET UNITYSDK_OFFSET(0x8C30230)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0x8C2FF80)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_RECORDBADGEUNLOCKEFFECTPLAYED_OFFSET UNITYSDK_OFFSET(0x8C30C30)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_SHOULDPLAYBADGEUNLOCKEFFECT_OFFSET UNITYSDK_OFFSET(0x8C30AA0)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x8C2FB60)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x8C2F9A0)

namespace RPG::Client
{
	inline static constexpr unsigned int AetherDivideGymDataItem_TypeDefinitionIndex = 49394;
