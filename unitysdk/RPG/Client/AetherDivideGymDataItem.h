...
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_CLEARNEWSTATUS_OFFSET UNITYSDK_OFFSET(0x9081760)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9080F80)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GETDISPLAYMONSTERDATAS_OFFSET UNITYSDK_OFFSET(0x9081A60)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GETSCHEDULEDATA_OFFSET UNITYSDK_OFFSET(0x90815A0)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GETSPIRITCOLLECTIONINFO_OFFSET UNITYSDK_OFFSET(0x9081130)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GETSTARCOUNT_OFFSET UNITYSDK_OFFSET(0x9081D80)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GETTRAINERCHALLENGEINFO_OFFSET UNITYSDK_OFFSET(0x9081280)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_ACTIVITYMODULEID_OFFSET UNITYSDK_OFFSET(0x9081920)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_BGPATH_OFFSET UNITYSDK_OFFSET(0x9082760)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_DESC_OFFSET UNITYSDK_OFFSET(0x9082330)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_ENTRANCEID_OFFSET UNITYSDK_OFFSET(0x9080360)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_FLOORID_OFFSET UNITYSDK_OFFSET(0x90828B0)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_GYMINFOROW_OFFSET UNITYSDK_OFFSET(0x9080DA0)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x9082610)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0x90821C0)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_RULE_OFFSET UNITYSDK_OFFSET(0x90824A0)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET__BADGEUNLOCKKEY_OFFSET UNITYSDK_OFFSET(0x9082040)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET__FIRSTUNLOCKKEY_OFFSET UNITYSDK_OFFSET(0x9082980)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_ISALREADYUNLOCKED_OFFSET UNITYSDK_OFFSET(0x90810F0)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_ISBADGEALREADYUNLOCKED_OFFSET UNITYSDK_OFFSET(0x9080FE0)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_ISBADGEUNLOCK_OFFSET UNITYSDK_OFFSET(0x9081870)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_ISNEW_OFFSET UNITYSDK_OFFSET(0x9081680)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0x90813D0)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_RECORDBADGEUNLOCKEFFECTPLAYED_OFFSET UNITYSDK_OFFSET(0x9082090)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_SHOULDPLAYBADGEUNLOCKEFFECT_OFFSET UNITYSDK_OFFSET(0x9081F00)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9080FD0)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9080E10)
