...
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_CLEARNEWSTATUS_OFFSET UNITYSDK_OFFSET(0x167DFA00)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x167DF150)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GETDISPLAYMONSTERDATAS_OFFSET UNITYSDK_OFFSET(0x167DFCF0)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GETSCHEDULEDATA_OFFSET UNITYSDK_OFFSET(0x167DF840)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GETSPIRITCOLLECTIONINFO_OFFSET UNITYSDK_OFFSET(0x167DF380)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GETSTARCOUNT_OFFSET UNITYSDK_OFFSET(0x167E0040)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GETTRAINERCHALLENGEINFO_OFFSET UNITYSDK_OFFSET(0x167DF500)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_ACTIVITYMODULEID_OFFSET UNITYSDK_OFFSET(0x167DFBC0)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_BGPATH_OFFSET UNITYSDK_OFFSET(0x167E0A00)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_DESC_OFFSET UNITYSDK_OFFSET(0x167E05E0)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_ENTRANCEID_OFFSET UNITYSDK_OFFSET(0x167DE420)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_FLOORID_OFFSET UNITYSDK_OFFSET(0x167E0B40)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_GYMINFOROW_OFFSET UNITYSDK_OFFSET(0x167DEFD0)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x167E08C0)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0x167E0470)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_RULE_OFFSET UNITYSDK_OFFSET(0x167E0750)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET__BADGEUNLOCKKEY_OFFSET UNITYSDK_OFFSET(0x167E02F0)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET__FIRSTUNLOCKKEY_OFFSET UNITYSDK_OFFSET(0x167E0C10)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_ISALREADYUNLOCKED_OFFSET UNITYSDK_OFFSET(0x167DF340)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_ISBADGEALREADYUNLOCKED_OFFSET UNITYSDK_OFFSET(0x167DF1B0)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_ISBADGEUNLOCK_OFFSET UNITYSDK_OFFSET(0x167DFB10)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_ISNEW_OFFSET UNITYSDK_OFFSET(0x167DF920)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0x167DF680)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_RECORDBADGEUNLOCKEFFECTPLAYED_OFFSET UNITYSDK_OFFSET(0x167E0340)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_SHOULDPLAYBADGEUNLOCKEFFECT_OFFSET UNITYSDK_OFFSET(0x167E01B0)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x167DF1A0)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x167DF040)
