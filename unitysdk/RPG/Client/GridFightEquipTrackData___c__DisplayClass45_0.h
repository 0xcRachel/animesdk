...
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKDATA___C__DISPLAYCLASS45_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1892E550)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKDATA___C__DISPLAYCLASS45_0___TRYASSIGNBASICEQUIP_B__0_OFFSET UNITYSDK_OFFSET(0x1892F4A0)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKDATA___C__DISPLAYCLASS45_0___TRYASSIGNBASICEQUIP_G___NOTAVAILABLE_2_OFFSET UNITYSDK_OFFSET(0x1892F4B0)
