...
#define RPG_CLIENT_GRIDFIGHTFORGEADDCOINEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x936B9A0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightForgeAddCoinEvent_TypeDefinitionIndex = 51580;
