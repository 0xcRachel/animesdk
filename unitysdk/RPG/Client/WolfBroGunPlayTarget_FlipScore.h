...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_FLIPSCORE_INIT_OFFSET UNITYSDK_OFFSET(0x11E5D790)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_FLIPSCORE_METHOD_6_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0x11E5D800)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_FLIPSCORE_METHOD_6_2461C65E55CF590F_OFFSET UNITYSDK_OFFSET(0x11E5D9B0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_FLIPSCORE__CTOR_OFFSET UNITYSDK_OFFSET(0x11E5D890)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_FLIPSCORE___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x11E5D9A0)
