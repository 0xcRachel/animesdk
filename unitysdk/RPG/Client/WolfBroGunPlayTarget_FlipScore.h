...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_FLIPSCORE_INIT_OFFSET UNITYSDK_OFFSET(0xA268250)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_FLIPSCORE_METHOD_6_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0xA2682C0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_FLIPSCORE_METHOD_6_2461C65E55CF590F_OFFSET UNITYSDK_OFFSET(0xA268400)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_FLIPSCORE__CTOR_OFFSET UNITYSDK_OFFSET(0xA268350)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_FLIPSCORE___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0xA2683F0)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayTarget_FlipScore_TypeDefinitionIndex = 54564;
