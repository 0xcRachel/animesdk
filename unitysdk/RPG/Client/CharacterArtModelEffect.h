...
#define RPG_CLIENT_CHARACTERARTMODELEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x8EA3B30)

namespace RPG::Client
{
	inline static constexpr unsigned int CharacterArtModelEffect_TypeDefinitionIndex = 55944;
