...
#define RPG_CLIENT_EDITORASSETHASH2BUNDLEINDEXITEMWRAP__CTOR_OFFSET UNITYSDK_OFFSET(0x15EA58E0)

namespace RPG::Client
{
	inline static constexpr unsigned int EditorAssetHash2BundleIndexItemWrap_TypeDefinitionIndex = 31140;
