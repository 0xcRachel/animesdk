...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPPARTSSELECTION_INIT_OFFSET UNITYSDK_OFFSET(0x9CC7440)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPPARTSSELECTION_METHOD_6_4CC249C408196EA6_OFFSET UNITYSDK_OFFSET(0x9CC7FF0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPPARTSSELECTION_UNINIT_OFFSET UNITYSDK_OFFSET(0x9CC8090)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPPARTSSELECTION_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x9CC74E0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPPARTSSELECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x9CC8130)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPPARTSSELECTION___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x9CC8150)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPPARTSSELECTION___IFIXBASEPROXY_UNINIT_OFFSET UNITYSDK_OFFSET(0x9CC8160)
