...
#define RPG_CLIENT_AVATARSKILLTREEDATA___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x15E49B50)
#define RPG_CLIENT_AVATARSKILLTREEDATA___C__CTOR_OFFSET UNITYSDK_OFFSET(0x15E49B90)
#define RPG_CLIENT_AVATARSKILLTREEDATA___C__GETRECOMMENDPOINTS_B__16_0_OFFSET UNITYSDK_OFFSET(0x15E49BA0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Comparison_1<::RPG::GameCore::AvatarSkillTreeRow*>**)Il2CppClass::FromTypeDefinitionIndex(AvatarSkillTreeData___c_TypeDefinitionIndex)->GetStaticField(0x5CE90);
		}
		static ::RPG::Client::AvatarSkillTreeData___c** StaticGet___9()
		{
			return (::RPG::Client::AvatarSkillTreeData___c**)Il2CppClass::FromTypeDefinitionIndex(AvatarSkillTreeData___c_TypeDefinitionIndex)->GetStaticField(0x5CE98);
		}
