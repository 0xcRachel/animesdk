...
#define RPG_CLIENT_AVATARSKILLTREEDATA___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x8D5DEF0)
#define RPG_CLIENT_AVATARSKILLTREEDATA___C__CTOR_OFFSET UNITYSDK_OFFSET(0x8D5DF30)
#define RPG_CLIENT_AVATARSKILLTREEDATA___C__GETRECOMMENDPOINTS_B__16_0_OFFSET UNITYSDK_OFFSET(0x8D5DF40)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarSkillTreeData___c_TypeDefinitionIndex = 49641;
	...
	public:
		...
		{
			return (::System::Comparison_1<::RPG::GameCore::AvatarSkillTreeRow*>**)Il2CppClass::FromTypeDefinitionIndex(AvatarSkillTreeData___c_TypeDefinitionIndex)->GetStaticField(0x340E0);
		}
		static ::RPG::Client::AvatarSkillTreeData___c** StaticGet___9()
		{
			return (::RPG::Client::AvatarSkillTreeData___c**)Il2CppClass::FromTypeDefinitionIndex(AvatarSkillTreeData___c_TypeDefinitionIndex)->GetStaticField(0x340E8);
		}
