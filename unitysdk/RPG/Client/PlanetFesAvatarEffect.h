...
#define RPG_CLIENT_PLANETFESAVATAREFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xF6EA970)
#define RPG_CLIENT_PLANETFESAVATAREFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0xF6EA9B0)
#define RPG_CLIENT_PLANETFESAVATAREFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0xF6EAB50)
#define RPG_CLIENT_PLANETFESAVATAREFFECT_SETBASECANVAS_OFFSET UNITYSDK_OFFSET(0xF6EAAD0)
#define RPG_CLIENT_PLANETFESAVATAREFFECT_SETPOSITION_OFFSET UNITYSDK_OFFSET(0xF6EAA40)
#define RPG_CLIENT_PLANETFESAVATAREFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0xF6EA930)
#define RPG_CLIENT_PLANETFESAVATAREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xF6EAC80)
