...
#define RPG_CLIENT_MONOTRIGGERREGION_ENABLECOLLIDER_OFFSET UNITYSDK_OFFSET(0x9D524B0)
#define RPG_CLIENT_MONOTRIGGERREGION_GET_CORRESPONDCOLLIDER_OFFSET UNITYSDK_OFFSET(0x9D52580)
#define RPG_CLIENT_MONOTRIGGERREGION_METHOD_6_D799715F2EF979EA_OFFSET UNITYSDK_OFFSET(0x9D52330)
#define RPG_CLIENT_MONOTRIGGERREGION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x9D522E0)
#define RPG_CLIENT_MONOTRIGGERREGION_ONGUESTCOLLIDERDISABLE_OFFSET UNITYSDK_OFFSET(0x9D52510)
#define RPG_CLIENT_MONOTRIGGERREGION_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x9D52160)
#define RPG_CLIENT_MONOTRIGGERREGION_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x9D52220)
#define RPG_CLIENT_MONOTRIGGERREGION_OVERLAPPOINT_OFFSET UNITYSDK_OFFSET(0x9D51BD0)
#define RPG_CLIENT_MONOTRIGGERREGION_OVERLAP_OFFSET UNITYSDK_OFFSET(0x9D51910)
#define RPG_CLIENT_MONOTRIGGERREGION_SETCOLLIDER_OFFSET UNITYSDK_OFFSET(0x9D52460)
#define RPG_CLIENT_MONOTRIGGERREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x9D52590)
#define RPG_CLIENT_MONOTRIGGERREGION___IFIXBASEPROXY_OVERLAPPOINT_OFFSET UNITYSDK_OFFSET(0x9D52640)
#define RPG_CLIENT_MONOTRIGGERREGION___IFIXBASEPROXY_OVERLAP_OFFSET UNITYSDK_OFFSET(0x9D525D0)
