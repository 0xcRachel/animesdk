...
#define RPG_CLIENT_NETWORKMANAGER___C__DISPLAYCLASS107_1__CTOR_OFFSET UNITYSDK_OFFSET(0x9E92850)
#define RPG_CLIENT_NETWORKMANAGER___C__DISPLAYCLASS107_1__PINGBYUDP_B__1_OFFSET UNITYSDK_OFFSET(0x9E92860)
...
namespace RPG::Client
{
	...
	public:
		...
		::RPG::Client::NetworkManager___c__DisplayClass107_0* CS___8__locals1; // 0x18
