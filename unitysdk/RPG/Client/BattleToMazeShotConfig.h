...
#define RPG_CLIENT_BATTLETOMAZESHOTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x8DDC090)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleToMazeShotConfig_TypeDefinitionIndex = 55450;
