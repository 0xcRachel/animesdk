...
#define RPG_CLIENT_ERAFLIPPERMANAGERDEBUG_METHOD_5_EBBC49A9109F0F2F_OFFSET UNITYSDK_OFFSET(0x9188AC0)
#define RPG_CLIENT_ERAFLIPPERMANAGERDEBUG_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x9188B40)
#define RPG_CLIENT_ERAFLIPPERMANAGERDEBUG__CTOR_OFFSET UNITYSDK_OFFSET(0x9188B50)

namespace RPG::Client
{
	inline static constexpr unsigned int EraFlipperManagerDebug_TypeDefinitionIndex = 47921;
