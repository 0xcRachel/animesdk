...
#define RPG_CLIENT_MONOMASKSLIDERDASH_GETRATIO_OFFSET UNITYSDK_OFFSET(0x17ADBB90)
#define RPG_CLIENT_MONOMASKSLIDERDASH_REFRESHANIM_OFFSET UNITYSDK_OFFSET(0x17ADBC00)
#define RPG_CLIENT_MONOMASKSLIDERDASH_UPDATEVALUE_OFFSET UNITYSDK_OFFSET(0x17ADB820)
#define RPG_CLIENT_MONOMASKSLIDERDASH__CTOR_OFFSET UNITYSDK_OFFSET(0x17ADBCE0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoMaskSliderDash_TypeDefinitionIndex = 67823;
