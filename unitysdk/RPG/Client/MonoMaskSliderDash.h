...
#define RPG_CLIENT_MONOMASKSLIDERDASH_GETRATIO_OFFSET UNITYSDK_OFFSET(0x9847E90)
#define RPG_CLIENT_MONOMASKSLIDERDASH_REFRESHANIM_OFFSET UNITYSDK_OFFSET(0x9847F00)
#define RPG_CLIENT_MONOMASKSLIDERDASH_UPDATEVALUE_OFFSET UNITYSDK_OFFSET(0x9847B20)
#define RPG_CLIENT_MONOMASKSLIDERDASH__CTOR_OFFSET UNITYSDK_OFFSET(0x9847FE0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoMaskSliderDash_TypeDefinitionIndex = 57860;
