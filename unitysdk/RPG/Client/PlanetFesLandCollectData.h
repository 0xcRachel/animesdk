...
#define RPG_CLIENT_PLANETFESLANDCOLLECTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9AD2FF0)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesLandCollectData_TypeDefinitionIndex = 53057;
