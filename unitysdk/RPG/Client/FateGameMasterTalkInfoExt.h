...
#define RPG_CLIENT_FATEGAMEMASTERTALKINFOEXT_GETRANDOMITEMSONOVERVIEWPAGE_OFFSET UNITYSDK_OFFSET(0x921F550)
#define RPG_CLIENT_FATEGAMEMASTERTALKINFOEXT_ISPLAYERINVOLVED_OFFSET UNITYSDK_OFFSET(0x921F090)

namespace RPG::Client
{
	inline static constexpr unsigned int FateGameMasterTalkInfoExt_TypeDefinitionIndex = 50887;
