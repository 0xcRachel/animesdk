...
#define RPG_CLIENT_AVATARSKILLDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8D58F60)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarSkillData_TypeDefinitionIndex = 49638;
