...
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSMESSAGESERVICE_ADDPENDINGMESSAGE_OFFSET UNITYSDK_OFFSET(0x95B7020)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSMESSAGESERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x95B01E0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSMESSAGESERVICE_GETMESSAGESEQUENCE_OFFSET UNITYSDK_OFFSET(0x95B6930)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSMESSAGESERVICE_GETSHOWMAINENTRANCEMESSAGE_OFFSET UNITYSDK_OFFSET(0x95B68D0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSMESSAGESERVICE_HASMAINENTRANCEMESSAGE_OFFSET UNITYSDK_OFFSET(0x95B6750)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSMESSAGESERVICE_REFRESHPENDINGMESSAGES_OFFSET UNITYSDK_OFFSET(0x95B6D20)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSMESSAGESERVICE_REMOVEPENDINGMESSAGE_OFFSET UNITYSDK_OFFSET(0x95B7110)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSMESSAGESERVICE_SENDFINISHMESSAGE_OFFSET UNITYSDK_OFFSET(0x95B7170)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSMESSAGESERVICE__BUILDMESSAGESEQUENCE_OFFSET UNITYSDK_OFFSET(0x95B69F0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSMESSAGESERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x95AFB70)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSMESSAGESERVICE__GETSHOWMAINENTRANCEMESSAGEID_OFFSET UNITYSDK_OFFSET(0x95B67A0)

namespace RPG::Client::MVVM::Service
{
	inline static constexpr unsigned int LimaoNewsMessageService_TypeDefinitionIndex = 59281;
