...
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSMESSAGESERVICE_ADDPENDINGMESSAGE_OFFSET UNITYSDK_OFFSET(0x9A958D0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSMESSAGESERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9A8E820)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSMESSAGESERVICE_GETMESSAGESEQUENCE_OFFSET UNITYSDK_OFFSET(0x9A951E0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSMESSAGESERVICE_GETSHOWMAINENTRANCEMESSAGE_OFFSET UNITYSDK_OFFSET(0x9A95180)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSMESSAGESERVICE_HASMAINENTRANCEMESSAGE_OFFSET UNITYSDK_OFFSET(0x9A95000)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSMESSAGESERVICE_REFRESHPENDINGMESSAGES_OFFSET UNITYSDK_OFFSET(0x9A955D0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSMESSAGESERVICE_REMOVEPENDINGMESSAGE_OFFSET UNITYSDK_OFFSET(0x9A95950)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSMESSAGESERVICE_SENDFINISHMESSAGE_OFFSET UNITYSDK_OFFSET(0x9A959B0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSMESSAGESERVICE__BUILDMESSAGESEQUENCE_OFFSET UNITYSDK_OFFSET(0x9A952A0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSMESSAGESERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x9A8E070)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSMESSAGESERVICE__GETSHOWMAINENTRANCEMESSAGEID_OFFSET UNITYSDK_OFFSET(0x9A95050)

namespace RPG::Client::MVVM::Service
{
	inline static constexpr unsigned int LimaoNewsMessageService_TypeDefinitionIndex = 61034;
