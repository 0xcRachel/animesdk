...
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSOFFICESURVEYSERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16964450)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSOFFICESURVEYSERVICE_GETCUROFFICESURVEYS_OFFSET UNITYSDK_OFFSET(0x1696ED60)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSOFFICESURVEYSERVICE_GETSHOWSURVEYTOTALCOUNT_OFFSET UNITYSDK_OFFSET(0x1696F050)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSOFFICESURVEYSERVICE_GETSURVEYDISPLAYREWARDID_OFFSET UNITYSDK_OFFSET(0x1696F4B0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSOFFICESURVEYSERVICE_GETSURVEYITEMSTATETAGVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1696EDA0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSOFFICESURVEYSERVICE_GETSURVEYITEMSTATETAG_1_OFFSET UNITYSDK_OFFSET(0x1696EE40)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSOFFICESURVEYSERVICE_GETSURVEYITEMSTATETAG_OFFSET UNITYSDK_OFFSET(0x1696F5B0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSOFFICESURVEYSERVICE_GET_RECOMMENDSERVICEID_OFFSET UNITYSDK_OFFSET(0x1696F610)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSOFFICESURVEYSERVICE_GOTOSURVEYMISSIONPAGE_OFFSET UNITYSDK_OFFSET(0x1696F290)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSOFFICESURVEYSERVICE_ISANYSURVEYCANSHOW_OFFSET UNITYSDK_OFFSET(0x1696F000)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSOFFICESURVEYSERVICE_ISFINISHEDALLSURVEY_OFFSET UNITYSDK_OFFSET(0x1696F160)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSOFFICESURVEYSERVICE_ISOFFICESURVEYFINISH_OFFSET UNITYSDK_OFFSET(0x1696EEF0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSOFFICESURVEYSERVICE_ISOFFICESURVEYSHOW_OFFSET UNITYSDK_OFFSET(0x1696EF70)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSOFFICESURVEYSERVICE_ISSURVEYHIDEREWARDAFTERSTART_OFFSET UNITYSDK_OFFSET(0x1696F520)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSOFFICESURVEYSERVICE_REBUILDSURVEYITEMSBYRECOMMENDID_OFFSET UNITYSDK_OFFSET(0x1696D840)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSOFFICESURVEYSERVICE_REFRESHCUROFFICESURVEY_OFFSET UNITYSDK_OFFSET(0x1696D4F0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSOFFICESURVEYSERVICE_SETRECOMMENDSURVEYID_OFFSET UNITYSDK_OFFSET(0x1696DCA0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSOFFICESURVEYSERVICE_SET_RECOMMENDSERVICEID_OFFSET UNITYSDK_OFFSET(0x1696F620)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSOFFICESURVEYSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x16963D10)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSOFFICESURVEYSERVICE__DISPOSECUROFFICESURVEYS_OFFSET UNITYSDK_OFFSET(0x1696EBB0)

namespace RPG::Client::MVVM::Service
{
	inline static constexpr unsigned int LimaoNewsOfficeSurveyService_TypeDefinitionIndex = 68498;
