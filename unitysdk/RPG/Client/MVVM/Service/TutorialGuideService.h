...
#define RPG_CLIENT_MVVM_SERVICE_TUTORIALGUIDESERVICE_CREATEGUIDEGROUPDATA_OFFSET UNITYSDK_OFFSET(0x9AA0BC0)
#define RPG_CLIENT_MVVM_SERVICE_TUTORIALGUIDESERVICE_CREATE_OFFSET UNITYSDK_OFFSET(0x9AA0770)
#define RPG_CLIENT_MVVM_SERVICE_TUTORIALGUIDESERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9AA0860)
#define RPG_CLIENT_MVVM_SERVICE_TUTORIALGUIDESERVICE_GETGUIDECOLLECTION_OFFSET UNITYSDK_OFFSET(0x9AA08E0)
#define RPG_CLIENT_MVVM_SERVICE_TUTORIALGUIDESERVICE_GETGUIDEGROUPDATA_OFFSET UNITYSDK_OFFSET(0x9AA0AD0)
#define RPG_CLIENT_MVVM_SERVICE_TUTORIALGUIDESERVICE_INIT_OFFSET UNITYSDK_OFFSET(0x9AA07C0)
#define RPG_CLIENT_MVVM_SERVICE_TUTORIALGUIDESERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x9AA07B0)

namespace RPG::Client::MVVM::Service
{
	inline static constexpr unsigned int TutorialGuideService_TypeDefinitionIndex = 61053;
