...
#define RPG_CLIENT_MVVM_SERVICE_TUTORIALGUIDESERVICE_CREATEGUIDEGROUPDATA_OFFSET UNITYSDK_OFFSET(0x122DA6D0)
#define RPG_CLIENT_MVVM_SERVICE_TUTORIALGUIDESERVICE_CREATE_OFFSET UNITYSDK_OFFSET(0x16976860)
#define RPG_CLIENT_MVVM_SERVICE_TUTORIALGUIDESERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x122DA370)
#define RPG_CLIENT_MVVM_SERVICE_TUTORIALGUIDESERVICE_GETGUIDECOLLECTION_OFFSET UNITYSDK_OFFSET(0x122DA3F0)
#define RPG_CLIENT_MVVM_SERVICE_TUTORIALGUIDESERVICE_GETGUIDEGROUPDATA_OFFSET UNITYSDK_OFFSET(0x122DA5E0)
#define RPG_CLIENT_MVVM_SERVICE_TUTORIALGUIDESERVICE_INIT_OFFSET UNITYSDK_OFFSET(0x122DA2D0)
#define RPG_CLIENT_MVVM_SERVICE_TUTORIALGUIDESERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x122DA7C0)

namespace RPG::Client::MVVM::Service
{
	inline static constexpr unsigned int TutorialGuideService_TypeDefinitionIndex = 68511;
