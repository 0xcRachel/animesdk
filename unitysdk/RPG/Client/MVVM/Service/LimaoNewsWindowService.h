...
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSWINDOWSERVICE_CREATEINTERVIEWDETAILPAGE_1_OFFSET UNITYSDK_OFFSET(0x9A9ED30)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSWINDOWSERVICE_CREATEINTERVIEWDETAILPAGE_OFFSET UNITYSDK_OFFSET(0x9A9EEB0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSWINDOWSERVICE_CREATEPOSTDETAILWINDOW_OFFSET UNITYSDK_OFFSET(0x9A9F170)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSWINDOWSERVICE_CREATEWEBSITEPAGE_OFFSET UNITYSDK_OFFSET(0x9A9E7E0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSWINDOWSERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9A8E550)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSWINDOWSERVICE_ENTERMAINENTRANCEPAGE_OFFSET UNITYSDK_OFFSET(0x9A9DF20)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSWINDOWSERVICE_SHOWINTERVIEWDETAILPAGE_OFFSET UNITYSDK_OFFSET(0x9A9ECB0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSWINDOWSERVICE_SHOWISSUESUBMITWINDOW_OFFSET UNITYSDK_OFFSET(0x9A9FCA0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSWINDOWSERVICE_SHOWLIMAONEWSISSUEHINTPOPUPMESSAGE_OFFSET UNITYSDK_OFFSET(0x9AA0080)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSWINDOWSERVICE_SHOWLIMAONEWSSPONSORINTRODUCTION_OFFSET UNITYSDK_OFFSET(0x9A9EA60)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSWINDOWSERVICE_SHOWMAINENTRANCEPAGE_OFFSET UNITYSDK_OFFSET(0x9A9E060)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSWINDOWSERVICE_SHOWMAINENTRANCEWEBSITEPAGE_OFFSET UNITYSDK_OFFSET(0x9A9E220)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSWINDOWSERVICE_SHOWPOSTDETAILWINDOWBYPOSTDATA_OFFSET UNITYSDK_OFFSET(0x9A9F100)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSWINDOWSERVICE_SHOWPOSTDETAILWINDOW_OFFSET UNITYSDK_OFFSET(0x9A9F460)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSWINDOWSERVICE_SHOWPOSTFULLSCREENCOMIC_OFFSET UNITYSDK_OFFSET(0x9A9F6D0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSWINDOWSERVICE_SHOWPOSTFULLSCREENVIDEO_OFFSET UNITYSDK_OFFSET(0x9A9F940)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSWINDOWSERVICE_SHOWPOSTSUBMITWINDOW_OFFSET UNITYSDK_OFFSET(0x9A9FE90)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSWINDOWSERVICE_SHOWWEBSITEPAGE_1_OFFSET UNITYSDK_OFFSET(0x9A9E640)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSWINDOWSERVICE_SHOWWEBSITEPAGE_OFFSET UNITYSDK_OFFSET(0x9A9E6B0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSWINDOWSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x9A8DE30)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSWINDOWSERVICE__ENTERMAINENTRANCEPAGE_B__1_0_OFFSET UNITYSDK_OFFSET(0x9AA02F0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSWINDOWSERVICE__ENTERMAINENTRANCEPAGE_B__1_1_OFFSET UNITYSDK_OFFSET(0x9AA0630)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSWINDOWSERVICE__ONTRIGGERENTRANCENEWGUIDE_OFFSET UNITYSDK_OFFSET(0x9AA0270)

namespace RPG::Client::MVVM::Service
{
	inline static constexpr unsigned int LimaoNewsWindowService_TypeDefinitionIndex = 61052;
