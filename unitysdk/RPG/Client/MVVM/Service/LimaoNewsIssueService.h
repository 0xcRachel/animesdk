...
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_ADDSUBMITTEDISSUEID_OFFSET UNITYSDK_OFFSET(0x1696A520)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x169644A0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_GETALLCANSUBMITISSUEDATA_OFFSET UNITYSDK_OFFSET(0x1696AB00)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_GETALLSHOWISSUEDATA_OFFSET UNITYSDK_OFFSET(0x1696A750)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_GETTOPISSUEDATA_OFFSET UNITYSDK_OFFSET(0x1696A960)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_HASCANSUBMITISSUE_OFFSET UNITYSDK_OFFSET(0x1696AEA0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_ISINTERVIEWUPVOTE_OFFSET UNITYSDK_OFFSET(0x1696A4C0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_ISISSUECANSHOW_OFFSET UNITYSDK_OFFSET(0x1696A6C0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_ISISSUECANSUBMIT_OFFSET UNITYSDK_OFFSET(0x1696A5E0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_ISISSUESUBMITTED_OFFSET UNITYSDK_OFFSET(0x1696A580)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_REFRESHCANSUBMITISSUEIDS_OFFSET UNITYSDK_OFFSET(0x1696ACB0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_REFRESHINTERVIEWUPVOTE_OFFSET UNITYSDK_OFFSET(0x1696A440)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_REFRESHSUBMITEDISSUE_OFFSET UNITYSDK_OFFSET(0x16969E00)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x16963D50)

namespace RPG::Client::MVVM::Service
{
	inline static constexpr unsigned int LimaoNewsIssueService_TypeDefinitionIndex = 68490;
