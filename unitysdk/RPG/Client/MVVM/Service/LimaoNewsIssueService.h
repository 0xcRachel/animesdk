...
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_ADDSUBMITTEDISSUEID_OFFSET UNITYSDK_OFFSET(0x9A94620)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9A8E5E0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_GETALLCANSUBMITISSUEDATA_OFFSET UNITYSDK_OFFSET(0x9A94C00)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_GETALLSHOWISSUEDATA_OFFSET UNITYSDK_OFFSET(0x9A94850)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_GETTOPISSUEDATA_OFFSET UNITYSDK_OFFSET(0x9A94A60)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_HASCANSUBMITISSUE_OFFSET UNITYSDK_OFFSET(0x9A94FA0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_ISINTERVIEWUPVOTE_OFFSET UNITYSDK_OFFSET(0x9A945C0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_ISISSUECANSHOW_OFFSET UNITYSDK_OFFSET(0x9A947C0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_ISISSUECANSUBMIT_OFFSET UNITYSDK_OFFSET(0x9A946E0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_ISISSUESUBMITTED_OFFSET UNITYSDK_OFFSET(0x9A94680)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_REFRESHCANSUBMITISSUEIDS_OFFSET UNITYSDK_OFFSET(0x9A94DB0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_REFRESHINTERVIEWUPVOTE_OFFSET UNITYSDK_OFFSET(0x9A94540)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_REFRESHSUBMITEDISSUE_OFFSET UNITYSDK_OFFSET(0x9A93F00)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x9A8DE80)

namespace RPG::Client::MVVM::Service
{
	inline static constexpr unsigned int LimaoNewsIssueService_TypeDefinitionIndex = 61032;
