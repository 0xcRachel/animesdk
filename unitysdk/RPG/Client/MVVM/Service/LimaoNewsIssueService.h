...
class Class_1_3C58D309C7A040F5_25;
namespace Google::Protobuf::Collections { template <typename T> class RepeatedField_1; }
namespace RPG::Client::MVVM::Model { class LimaoNewsIssueData; }
namespace System::Collections::Generic { template <typename T> class HashSet_1; }
namespace System::Collections::Generic { template <typename T> class List_1; }

#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_ADDSUBMITTEDISSUEID_OFFSET UNITYSDK_OFFSET(0x95B5E20)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x95B0090)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_GETALLCANSUBMITISSUEDATA_OFFSET UNITYSDK_OFFSET(0x95B6380)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_GETALLSHOWISSUEDATA_OFFSET UNITYSDK_OFFSET(0x95B6050)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_GETTOPISSUEDATA_OFFSET UNITYSDK_OFFSET(0x95B6210)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_HASCANSUBMITISSUE_OFFSET UNITYSDK_OFFSET(0x95B66F0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_ISINTERVIEWUPVOTE_OFFSET UNITYSDK_OFFSET(0x95B5DC0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_ISISSUECANSHOW_OFFSET UNITYSDK_OFFSET(0x95B5FC0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_ISISSUECANSUBMIT_OFFSET UNITYSDK_OFFSET(0x95B5EE0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_ISISSUESUBMITTED_OFFSET UNITYSDK_OFFSET(0x95B5E80)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_REFRESHCANSUBMITISSUEIDS_OFFSET UNITYSDK_OFFSET(0x95B6500)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_REFRESHINTERVIEWUPVOTE_OFFSET UNITYSDK_OFFSET(0x95B5D40)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_REFRESHSUBMITEDISSUE_OFFSET UNITYSDK_OFFSET(0x95B5700)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x95AF920)

namespace RPG::Client::MVVM::Service
{
	inline static constexpr unsigned int LimaoNewsIssueService_TypeDefinitionIndex = 59279;
	...
	public:
		...
		::System::Void RefreshSubmitedIssue(::Google::Protobuf::Collections::RepeatedField_1<::Class_1_3C58D309C7A040F5_25*>* submittedIssues)
		{
			return ((::System::Void(*)(::PVOID, ::Google::Protobuf::Collections::RepeatedField_1<::Class_1_3C58D309C7A040F5_25*>*))((::PBYTE)hIl2Cpp + RPG_CLIENT_MVVM_SERVICE_LIMAONEWSISSUESERVICE_REFRESHSUBMITEDISSUE_OFFSET))(this, submittedIssues);
		}
