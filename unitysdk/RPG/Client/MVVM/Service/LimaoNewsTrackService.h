...
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE_BEGINTRACKOFFICE_OFFSET UNITYSDK_OFFSET(0x16971D50)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16964660)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE_ENDTRACKOFFICE_OFFSET UNITYSDK_OFFSET(0x169714E0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE_GOTOSURVEYMISSIONTARGET_OFFSET UNITYSDK_OFFSET(0x1696F350)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE_GOTOSURVEYMISSION_OFFSET UNITYSDK_OFFSET(0x16971900)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE_SETLIMAONEWSTRACKSURVEY_OFFSET UNITYSDK_OFFSET(0x169713C0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__ADDBILLBOARDINFO_OFFSET UNITYSDK_OFFSET(0x16972BD0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__CLEARDATA_OFFSET UNITYSDK_OFFSET(0x16972180)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x16963E50)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__DOTRACKOFFICE_OFFSET UNITYSDK_OFFSET(0x169721D0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__GETBILLBOARDCOMPONENT_OFFSET UNITYSDK_OFFSET(0x16972CD0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__GETENTRYIDBYFLOORID_OFFSET UNITYSDK_OFFSET(0x16971C20)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__GETFIRSTTRACKABLEDATA_OFFSET UNITYSDK_OFFSET(0x16972330)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__GETMAPICONINCARTOGRAPHY_OFFSET UNITYSDK_OFFSET(0x16972580)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__GETPREPARESUBMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x16972FC0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__GOTOSURVEYMISSIONTARGET_B__3_0_OFFSET UNITYSDK_OFFSET(0x16973860)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__ISDATAVALID_OFFSET UNITYSDK_OFFSET(0x16971480)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__JUMPTOMISSIONTARGETUIPAGE_OFFSET UNITYSDK_OFFSET(0x169715A0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__ONCLOSEBIGMAP_OFFSET UNITYSDK_OFFSET(0x16973750)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__ONFINISHSUBMISSION_OFFSET UNITYSDK_OFFSET(0x16973180)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__ONREFRESHBILLBORDINFO_OFFSET UNITYSDK_OFFSET(0x16973430)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__ONUPDATEMAPPINGINFOTRACE_OFFSET UNITYSDK_OFFSET(0x169735A0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__OPENMAPPAGE_OFFSET UNITYSDK_OFFSET(0x16972850)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__PREPARESUBMISSION_OFFSET UNITYSDK_OFFSET(0x16971EB0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__REMOVEBILLBOARDINFO_OFFSET UNITYSDK_OFFSET(0x16971F60)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__REMOVEMAPSHOWICON_OFFSET UNITYSDK_OFFSET(0x169720D0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__TRYTRACKNEXTENTITY_OFFSET UNITYSDK_OFFSET(0x16973260)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE___DOTRACKOFFICE_B__10_0_OFFSET UNITYSDK_OFFSET(0x169739E0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE___TRYTRACKNEXTENTITY_B__21_0_OFFSET UNITYSDK_OFFSET(0x16973B60)

namespace RPG::Client::MVVM::Service
{
	inline static constexpr unsigned int LimaoNewsTrackService_TypeDefinitionIndex = 68506;
