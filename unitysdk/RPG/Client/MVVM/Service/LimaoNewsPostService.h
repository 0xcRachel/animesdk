...
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_CLEARNEW_OFFSET UNITYSDK_OFFSET(0x16970230)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_CREATECOMMENTVIEWMODELS_OFFSET UNITYSDK_OFFSET(0x16970990)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16964530)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_GETALLCANSUBMITPOSTS_OFFSET UNITYSDK_OFFSET(0x1696FCC0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_GETALLSHOWPOSTS_OFFSET UNITYSDK_OFFSET(0x1696F810)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_GETNEWPOSTCOUNT_OFFSET UNITYSDK_OFFSET(0x1696FEC0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_GETORCREATEPOSTDATA_OFFSET UNITYSDK_OFFSET(0x1696F6E0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_GETPOSTSTATETAGVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16970710)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_GETTOPCANSUBMITPOSTDATA_OFFSET UNITYSDK_OFFSET(0x1696FB40)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_GOTOPOSTTRACKSURVEYMISSION_OFFSET UNITYSDK_OFFSET(0x16970650)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_HASCANSUBMITPOST_OFFSET UNITYSDK_OFFSET(0x1696FE60)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_ISCANSHOWQUICKPOSTSUBMIT_OFFSET UNITYSDK_OFFSET(0x16971110)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_ISNEWPOST_OFFSET UNITYSDK_OFFSET(0x16970090)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_ISPOSTCANGOTOSURVEY_OFFSET UNITYSDK_OFFSET(0x169704D0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_ISPOSTCANREPLAY_OFFSET UNITYSDK_OFFSET(0x16970360)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_ISPOSTCANSUBMIT_OFFSET UNITYSDK_OFFSET(0x1696F9E0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_ISPOSTLOCALCHANGESTATE_OFFSET UNITYSDK_OFFSET(0x16971230)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_ONCHANGEPOST_OFFSET UNITYSDK_OFFSET(0x1696D270)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_RECORDPOSTLOCALCHANGESTATE_OFFSET UNITYSDK_OFFSET(0x169711B0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_REFRESHCANSUBMITPOSTIDS_OFFSET UNITYSDK_OFFSET(0x1696D300)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_REFRESHPOSTUPVOTE_OFFSET UNITYSDK_OFFSET(0x1696E2F0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_REFRESHSUBMITTEDPOSTS_OFFSET UNITYSDK_OFFSET(0x1696DCF0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_REFRESHSUBMITTEDPOST_OFFSET UNITYSDK_OFFSET(0x1696E100)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_REMOVEPOSTLOCALCHANGESTATE_OFFSET UNITYSDK_OFFSET(0x1696F650)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_SETCOMMENTTONEXTSTATE_OFFSET UNITYSDK_OFFSET(0x16971040)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_TRYGETPOSTDATA_OFFSET UNITYSDK_OFFSET(0x16971340)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x16963DB0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE__GETCOMMENTSTATEROW_OFFSET UNITYSDK_OFFSET(0x16970F50)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE__GETPOSTDATA_OFFSET UNITYSDK_OFFSET(0x16971290)

namespace RPG::Client::MVVM::Service
{
	inline static constexpr unsigned int LimaoNewsPostService_TypeDefinitionIndex = 68500;

	class LimaoNewsPostService : public ::System::Object
	{
	public:
		::RPG::Client::MVVM::Service::LimaoNewsOfficeSurveyService* _SurveyService; // 0x10
		...
		::System::Collections::Generic::List_1<::RPG::Client::MVVM::Model::LimaoNewsPostData*>* _AllPostDatas; // 0x30
		...
		::System::Void RefreshSubmittedPosts(::Google::Protobuf::Collections::RepeatedField_1<::Class_1_EBB10EC01CCC4716_12*>* submittedPostList)
		{
			return ((::System::Void(*)(::PVOID, ::Google::Protobuf::Collections::RepeatedField_1<::Class_1_EBB10EC01CCC4716_12*>*))((::PBYTE)hIl2Cpp + RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_REFRESHSUBMITTEDPOSTS_OFFSET))(this, submittedPostList);
		}

		::System::Void OnChangePost(::Class_1_EBB10EC01CCC4716_12* proto)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_EBB10EC01CCC4716_12*))((::PBYTE)hIl2Cpp + RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_ONCHANGEPOST_OFFSET))(this, proto);
		}

		::System::Void RefreshSubmittedPost(::Class_1_EBB10EC01CCC4716_12* proto)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_EBB10EC01CCC4716_12*))((::PBYTE)hIl2Cpp + RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_REFRESHSUBMITTEDPOST_OFFSET))(this, proto);
		}
