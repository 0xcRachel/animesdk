...
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_CLEARNEW_OFFSET UNITYSDK_OFFSET(0x9A9A240)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_CREATECOMMENTVIEWMODELS_OFFSET UNITYSDK_OFFSET(0x9A9A9A0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9A8E670)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_GETALLCANSUBMITPOSTS_OFFSET UNITYSDK_OFFSET(0x9A99CD0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_GETALLSHOWPOSTS_OFFSET UNITYSDK_OFFSET(0x9A99820)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_GETNEWPOSTCOUNT_OFFSET UNITYSDK_OFFSET(0x9A99ED0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_GETORCREATEPOSTDATA_OFFSET UNITYSDK_OFFSET(0x9A996F0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_GETPOSTSTATETAGVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9A9A720)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_GETTOPCANSUBMITPOSTDATA_OFFSET UNITYSDK_OFFSET(0x9A99B50)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_GOTOPOSTTRACKSURVEYMISSION_OFFSET UNITYSDK_OFFSET(0x9A9A660)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_HASCANSUBMITPOST_OFFSET UNITYSDK_OFFSET(0x9A99E70)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_ISCANSHOWQUICKPOSTSUBMIT_OFFSET UNITYSDK_OFFSET(0x9A9B120)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_ISNEWPOST_OFFSET UNITYSDK_OFFSET(0x9A9A0A0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_ISPOSTCANGOTOSURVEY_OFFSET UNITYSDK_OFFSET(0x9A9A4E0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_ISPOSTCANREPLAY_OFFSET UNITYSDK_OFFSET(0x9A9A370)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_ISPOSTCANSUBMIT_OFFSET UNITYSDK_OFFSET(0x9A999F0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_ISPOSTLOCALCHANGESTATE_OFFSET UNITYSDK_OFFSET(0x9A9B240)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_ONCHANGEPOST_OFFSET UNITYSDK_OFFSET(0x9A97320)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_RECORDPOSTLOCALCHANGESTATE_OFFSET UNITYSDK_OFFSET(0x9A9B1C0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_REFRESHCANSUBMITPOSTIDS_OFFSET UNITYSDK_OFFSET(0x9A973B0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_REFRESHPOSTUPVOTE_OFFSET UNITYSDK_OFFSET(0x9A983A0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_REFRESHSUBMITTEDPOSTS_OFFSET UNITYSDK_OFFSET(0x9A97DA0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_REFRESHSUBMITTEDPOST_OFFSET UNITYSDK_OFFSET(0x9A981B0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_REMOVEPOSTLOCALCHANGESTATE_OFFSET UNITYSDK_OFFSET(0x9A99660)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_SETCOMMENTTONEXTSTATE_OFFSET UNITYSDK_OFFSET(0x9A9B050)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_TRYGETPOSTDATA_OFFSET UNITYSDK_OFFSET(0x9A9B380)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x9A8DEE0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE__GETCOMMENTSTATEROW_OFFSET UNITYSDK_OFFSET(0x9A9AF60)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE__GETPOSTDATA_OFFSET UNITYSDK_OFFSET(0x9A9B2A0)

namespace RPG::Client::MVVM::Service
{
	inline static constexpr unsigned int LimaoNewsPostService_TypeDefinitionIndex = 61042;
