...
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSMAINENTRANCEVIEWMODEL_GET_EVENTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x12301F20)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSMAINENTRANCEVIEWMODEL_GET_ISFIRSTIN_OFFSET UNITYSDK_OFFSET(0x12301EE0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSMAINENTRANCEVIEWMODEL_GET_SCENEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x12301F00)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSMAINENTRANCEVIEWMODEL_SETISFIRSTIN_OFFSET UNITYSDK_OFFSET(0x12301E90)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSMAINENTRANCEVIEWMODEL_SET_EVENTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x12301F30)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSMAINENTRANCEVIEWMODEL_SET_ISFIRSTIN_OFFSET UNITYSDK_OFFSET(0x12301EF0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSMAINENTRANCEVIEWMODEL_SET_SCENEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x12301F10)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSMAINENTRANCEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x12301D90)

namespace RPG::Client::MVVM::ViewModel
{
	inline static constexpr unsigned int LimaoNewsMainEntranceViewModel_TypeDefinitionIndex = 68393;
