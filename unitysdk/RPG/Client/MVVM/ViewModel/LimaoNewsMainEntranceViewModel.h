...
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSMAINENTRANCEVIEWMODEL_GET_EVENTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9ABB230)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSMAINENTRANCEVIEWMODEL_GET_ISFIRSTIN_OFFSET UNITYSDK_OFFSET(0x9ABB1F0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSMAINENTRANCEVIEWMODEL_GET_SCENEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9ABB210)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSMAINENTRANCEVIEWMODEL_SETISFIRSTIN_OFFSET UNITYSDK_OFFSET(0x9ABB1A0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSMAINENTRANCEVIEWMODEL_SET_EVENTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9ABB240)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSMAINENTRANCEVIEWMODEL_SET_ISFIRSTIN_OFFSET UNITYSDK_OFFSET(0x9ABB200)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSMAINENTRANCEVIEWMODEL_SET_SCENEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9ABB220)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSMAINENTRANCEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x9ABB0A0)

namespace RPG::Client::MVVM::ViewModel
{
	inline static constexpr unsigned int LimaoNewsMainEntranceViewModel_TypeDefinitionIndex = 60942;

	class LimaoNewsMainEntranceViewModel : public ::Class_2_3DE15EA7F53A0550
	{
	public:
		::RPG::Client::MVVM::Model::LimaoNewsModule* _Module; // 0x18
		::RPG::Client::MVVM::ViewModel::LimaoNewsMainEntranceEventViewModel* _EventViewModel_k__BackingField; // 0x20
