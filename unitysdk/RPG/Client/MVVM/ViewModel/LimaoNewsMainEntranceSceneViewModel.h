...
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSMAINENTRANCESCENEVIEWMODEL_GETCURPHASEDESKS_OFFSET UNITYSDK_OFFSET(0x95CBDC0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSMAINENTRANCESCENEVIEWMODEL_GETCURPHASEPOINTIDS_OFFSET UNITYSDK_OFFSET(0x95CBE70)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSMAINENTRANCESCENEVIEWMODEL_GETSHOWLIMAODATAS_OFFSET UNITYSDK_OFFSET(0x95CBF20)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSMAINENTRANCESCENEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x95D5090)

namespace RPG::Client::MVVM::ViewModel
{
	inline static constexpr unsigned int LimaoNewsMainEntranceSceneViewModel_TypeDefinitionIndex = 59189;

	class LimaoNewsMainEntranceSceneViewModel : public ::Class_2_3DE15EA7F53A0550
	{
	public:
		::Class_1_895FB63906FAA27E* _EventService; // 0x18
		::Class_1_4780C96744815F8D* _LimaoService; // 0x20
