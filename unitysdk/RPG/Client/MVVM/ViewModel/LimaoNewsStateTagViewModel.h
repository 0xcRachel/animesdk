...
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSSTATETAGVIEWMODEL_GET_STATETAG_OFFSET UNITYSDK_OFFSET(0x95D7740)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSSTATETAGVIEWMODEL_GET_SUBMITREWARDID_OFFSET UNITYSDK_OFFSET(0x95D7750)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSSTATETAGVIEWMODEL_SET_STATETAG_OFFSET UNITYSDK_OFFSET(0x95D7660)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSSTATETAGVIEWMODEL_SET_SUBMITREWARDID_OFFSET UNITYSDK_OFFSET(0x95D76D0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSSTATETAGVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x95D7580)

namespace RPG::Client::MVVM::ViewModel
{
	inline static constexpr unsigned int LimaoNewsStateTagViewModel_TypeDefinitionIndex = 59187;
