...
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSSTATETAGVIEWMODEL_GET_STATETAG_OFFSET UNITYSDK_OFFSET(0x12304010)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSSTATETAGVIEWMODEL_GET_SUBMITREWARDID_OFFSET UNITYSDK_OFFSET(0x12304020)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSSTATETAGVIEWMODEL_SET_STATETAG_OFFSET UNITYSDK_OFFSET(0x12303EF0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSSTATETAGVIEWMODEL_SET_SUBMITREWARDID_OFFSET UNITYSDK_OFFSET(0x12303F80)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSSTATETAGVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x12303DB0)

namespace RPG::Client::MVVM::ViewModel
{
	inline static constexpr unsigned int LimaoNewsStateTagViewModel_TypeDefinitionIndex = 68390;

	class LimaoNewsStateTagViewModel : public ::Class_2_E77EE8BE0A609DD9
	{
	public:
		::RPG::Client::MVVM::Model::LimaoNewsStateTag _StateTag; // 0x20
