...
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSSTATETAGVIEWMODEL_GET_STATETAG_OFFSET UNITYSDK_OFFSET(0x9ABDA30)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSSTATETAGVIEWMODEL_GET_SUBMITREWARDID_OFFSET UNITYSDK_OFFSET(0x9ABDA40)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSSTATETAGVIEWMODEL_SET_STATETAG_OFFSET UNITYSDK_OFFSET(0x9ABD910)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSSTATETAGVIEWMODEL_SET_SUBMITREWARDID_OFFSET UNITYSDK_OFFSET(0x9ABD9A0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSSTATETAGVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x9ABD7D0)

namespace RPG::Client::MVVM::ViewModel
{
	inline static constexpr unsigned int LimaoNewsStateTagViewModel_TypeDefinitionIndex = 60939;
