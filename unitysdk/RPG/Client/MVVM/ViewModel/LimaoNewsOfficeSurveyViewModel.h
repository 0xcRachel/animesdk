...
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_FIXCOMPLETEOFFICESURVEYLIST_OFFSET UNITYSDK_OFFSET(0x95D6380)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_GETFILTERLOCATIONDATAS_OFFSET UNITYSDK_OFFSET(0x95D6060)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_GETFILTERSTATES_OFFSET UNITYSDK_OFFSET(0x95D6240)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_GETFILTERSURVEYTYPEDATAS_OFFSET UNITYSDK_OFFSET(0x95D5ED0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_GETSHOWITEMS_OFFSET UNITYSDK_OFFSET(0x95D5A10)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_GETTOTALSHOWCOUNT_OFFSET UNITYSDK_OFFSET(0x95D5B80)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_GET_RECOMMENDSERVICEID_OFFSET UNITYSDK_OFFSET(0x95D63E0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_ISANYSURVEYCANSHOW_OFFSET UNITYSDK_OFFSET(0x95D5AF0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_ISFINISHEDALLSURVEY_OFFSET UNITYSDK_OFFSET(0x95D5A90)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_REFRESHOFFICESURVEYBYFILTER_OFFSET UNITYSDK_OFFSET(0x95D5E60)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_REFRESHSELECTEDFILTER_OFFSET UNITYSDK_OFFSET(0x95D5BE0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x95D5920)

namespace RPG::Client::MVVM::ViewModel
{
	inline static constexpr unsigned int LimaoNewsOfficeSurveyViewModel_TypeDefinitionIndex = 59194;
