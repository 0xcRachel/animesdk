...
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_FIXCOMPLETEOFFICESURVEYLIST_OFFSET UNITYSDK_OFFSET(0x9ABC250)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_GETFILTERLOCATIONDATAS_OFFSET UNITYSDK_OFFSET(0x9ABBF80)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_GETFILTERSTATES_OFFSET UNITYSDK_OFFSET(0x9ABC110)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_GETFILTERSURVEYTYPEDATAS_OFFSET UNITYSDK_OFFSET(0x9ABBDF0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_GETSHOWITEMS_OFFSET UNITYSDK_OFFSET(0x9ABB930)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_GETTOTALSHOWCOUNT_OFFSET UNITYSDK_OFFSET(0x9ABBAA0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_GET_RECOMMENDSERVICEID_OFFSET UNITYSDK_OFFSET(0x9ABC2B0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_ISANYSURVEYCANSHOW_OFFSET UNITYSDK_OFFSET(0x9ABBA10)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_ISFINISHEDALLSURVEY_OFFSET UNITYSDK_OFFSET(0x9ABB9B0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_REFRESHOFFICESURVEYBYFILTER_OFFSET UNITYSDK_OFFSET(0x9ABBD80)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_REFRESHSELECTEDFILTER_OFFSET UNITYSDK_OFFSET(0x9ABBB00)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x9ABB800)

namespace RPG::Client::MVVM::ViewModel
{
	inline static constexpr unsigned int LimaoNewsOfficeSurveyViewModel_TypeDefinitionIndex = 60946;

	class LimaoNewsOfficeSurveyViewModel : public ::Class_2_3DE15EA7F53A0550
	{
	public:
		::System::Collections::Generic::List_1<::System::UInt32>* _SelectedLocationIDs; // 0x18
		::System::Collections::Generic::List_1<::Enum_3_4608E37A1B3D374A_20>* _SelectedStates; // 0x20
