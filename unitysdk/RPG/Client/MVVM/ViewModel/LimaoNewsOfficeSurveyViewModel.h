...
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_FIXCOMPLETEOFFICESURVEYLIST_OFFSET UNITYSDK_OFFSET(0x12302F50)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_GETFILTERLOCATIONDATAS_OFFSET UNITYSDK_OFFSET(0x12302C80)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_GETFILTERSTATES_OFFSET UNITYSDK_OFFSET(0x12302E10)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_GETFILTERSURVEYTYPEDATAS_OFFSET UNITYSDK_OFFSET(0x12302AF0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_GETSHOWITEMS_OFFSET UNITYSDK_OFFSET(0x12302630)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_GETTOTALSHOWCOUNT_OFFSET UNITYSDK_OFFSET(0x123027A0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_GET_RECOMMENDSERVICEID_OFFSET UNITYSDK_OFFSET(0x12302FB0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_ISANYSURVEYCANSHOW_OFFSET UNITYSDK_OFFSET(0x12302710)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_ISFINISHEDALLSURVEY_OFFSET UNITYSDK_OFFSET(0x123026B0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_REFRESHOFFICESURVEYBYFILTER_OFFSET UNITYSDK_OFFSET(0x12302A80)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_REFRESHSELECTEDFILTER_OFFSET UNITYSDK_OFFSET(0x12302800)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x12302500)

namespace RPG::Client::MVVM::ViewModel
{
	inline static constexpr unsigned int LimaoNewsOfficeSurveyViewModel_TypeDefinitionIndex = 68397;

	class LimaoNewsOfficeSurveyViewModel : public ::Class_2_E77EE8BE0A609DD9
	{
	public:
		::RPG::Client::MVVM::Model::LimaoNewsModule* _Module; // 0x20
		::System::Collections::Generic::List_1<::Enum_3_4608E37A1B3D374A_19>* _SelectedStates; // 0x28
