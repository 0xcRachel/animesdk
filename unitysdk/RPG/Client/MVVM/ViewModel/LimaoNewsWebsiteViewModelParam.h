...
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_CREATEDEFAULTTAB_OFFSET UNITYSDK_OFFSET(0x95D77B0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_CREATEMOVETONEWPOST_OFFSET UNITYSDK_OFFSET(0x95D7930)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_CREATEMOVETOPOST_OFFSET UNITYSDK_OFFSET(0x95D7870)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_CREATESELECTEDISSUE_OFFSET UNITYSDK_OFFSET(0x95D7810)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_CREATETOPPOST_OFFSET UNITYSDK_OFFSET(0x95D78D0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_CREATE_OFFSET UNITYSDK_OFFSET(0x95D7760)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_GET_ISSUEID_OFFSET UNITYSDK_OFFSET(0x95D79B0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_GET_MOVETOPOSTID_OFFSET UNITYSDK_OFFSET(0x95D79F0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_GET_TOPPOSTID_OFFSET UNITYSDK_OFFSET(0x95D79D0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_GET_VIEWTAB_OFFSET UNITYSDK_OFFSET(0x95D7990)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_SET_ISSUEID_OFFSET UNITYSDK_OFFSET(0x95D79C0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_SET_MOVETOPOSTID_OFFSET UNITYSDK_OFFSET(0x95D7A00)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_SET_TOPPOSTID_OFFSET UNITYSDK_OFFSET(0x95D79E0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_SET_VIEWTAB_OFFSET UNITYSDK_OFFSET(0x95D79A0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x95D77A0)

namespace RPG::Client::MVVM::ViewModel
{
	inline static constexpr unsigned int LimaoNewsWebsiteViewModelParam_TypeDefinitionIndex = 59217;
	...
	public:
		...
		::RPG::Client::MVVM::ViewModel::LimaoNewsWebsiteViewTabEnum _ViewTab_k__BackingField; // 0x1C
