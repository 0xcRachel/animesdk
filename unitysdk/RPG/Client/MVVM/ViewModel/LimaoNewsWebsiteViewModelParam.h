...
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_CREATEDEFAULTTAB_OFFSET UNITYSDK_OFFSET(0x123040B0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_CREATEMOVETONEWPOST_OFFSET UNITYSDK_OFFSET(0x123042B0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_CREATEMOVETOPOST_OFFSET UNITYSDK_OFFSET(0x123041B0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_CREATESELECTEDISSUE_OFFSET UNITYSDK_OFFSET(0x12304130)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_CREATETOPPOST_OFFSET UNITYSDK_OFFSET(0x12304230)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_CREATE_OFFSET UNITYSDK_OFFSET(0x12304030)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_GET_ISSUEID_OFFSET UNITYSDK_OFFSET(0x12304350)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_GET_MOVETOPOSTID_OFFSET UNITYSDK_OFFSET(0x12304390)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_GET_TOPPOSTID_OFFSET UNITYSDK_OFFSET(0x12304370)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_GET_VIEWTAB_OFFSET UNITYSDK_OFFSET(0x12304330)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_SET_ISSUEID_OFFSET UNITYSDK_OFFSET(0x12304360)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_SET_MOVETOPOSTID_OFFSET UNITYSDK_OFFSET(0x123043A0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_SET_TOPPOSTID_OFFSET UNITYSDK_OFFSET(0x12304380)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_SET_VIEWTAB_OFFSET UNITYSDK_OFFSET(0x12304340)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x123040A0)

namespace RPG::Client::MVVM::ViewModel
{
	inline static constexpr unsigned int LimaoNewsWebsiteViewModelParam_TypeDefinitionIndex = 68420;

	class LimaoNewsWebsiteViewModelParam : public ::System::Object
	{
	public:
		::RPG::Client::MVVM::ViewModel::LimaoNewsWebsiteViewTabEnum _ViewTab_k__BackingField; // 0x10
		::System::UInt32 _MoveToPostID_k__BackingField; // 0x14
		::System::UInt32 _TopPostID_k__BackingField; // 0x18
