...
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_CREATE_OFFSET UNITYSDK_OFFSET(0x95B07F0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x95B0A80)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_FETCHFIRSTJUMPABLESUBMISSIONDATA_OFFSET UNITYSDK_OFFSET(0x95B1AF0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_GETBIGMAPICON_OFFSET UNITYSDK_OFFSET(0x95B1D60)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_GETLIMAODATA_OFFSET UNITYSDK_OFFSET(0x95B1230)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_GETLOACTIONDATA_OFFSET UNITYSDK_OFFSET(0x95B14B0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_GETSURVEYTYPEDATA_OFFSET UNITYSDK_OFFSET(0x95B12D0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_GET_CURCONTENTDATAS_OFFSET UNITYSDK_OFFSET(0x95B18C0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_GET_CURCONTENTID_OFFSET UNITYSDK_OFFSET(0x95B1750)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_GET_DESC_OFFSET UNITYSDK_OFFSET(0x95B15D0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_GET_DISPLAYREWARDID_OFFSET UNITYSDK_OFFSET(0x95B0C60)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_GET_FINISHCONDITIONIDS_OFFSET UNITYSDK_OFFSET(0x95B10F0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_GET_HIDEREWARDAFTERSTART_OFFSET UNITYSDK_OFFSET(0x95B0D60)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_GET_ISMISSIONTARGET_OFFSET UNITYSDK_OFFSET(0x95B1EA0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_GET_LIMAOID_OFFSET UNITYSDK_OFFSET(0x95B0B30)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_GET_PICTUREPATH_OFFSET UNITYSDK_OFFSET(0x95B0B50)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_GET_SHOWCONDITIONIDS_OFFSET UNITYSDK_OFFSET(0x95B0E70)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_GET_STARTCONDITIONIDS_OFFSET UNITYSDK_OFFSET(0x95B0FB0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_GET_SURVEYID_OFFSET UNITYSDK_OFFSET(0x95B0B10)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_REFRESH_OFFSET UNITYSDK_OFFSET(0x95B0AC0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_SET_LIMAOID_OFFSET UNITYSDK_OFFSET(0x95B0B40)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_SET_SURVEYID_OFFSET UNITYSDK_OFFSET(0x95B0B20)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x95B0870)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM__GETFIRSTJUMPABLESUBMISSIONDATA_OFFSET UNITYSDK_OFFSET(0x95B1F00)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM__GETFIRSTSTARTANDHASWAYPOINTSUBMISSIONDATA_OFFSET UNITYSDK_OFFSET(0x95B1FD0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM__GETSURVEYROW_OFFSET UNITYSDK_OFFSET(0x95B0C00)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM__INITTRACKDATALIST_OFFSET UNITYSDK_OFFSET(0x95B08B0)

namespace RPG::Client::MVVM::Model
{
	inline static constexpr unsigned int LimaoNewsOfficeSurveyItem_TypeDefinitionIndex = 59312;
	...
	public:
		...
		::RPG::Client::MVVM::Model::LimaoNewsOfficeSurveyTypeData* _SurveyTypeData; // 0x20
		::RPG::Client::MVVM::Model::LimaoNewsLocationData* _LocationData; // 0x28
