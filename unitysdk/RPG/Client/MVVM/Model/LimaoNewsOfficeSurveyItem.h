...
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_CREATE_OFFSET UNITYSDK_OFFSET(0x9A8EE30)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9A8F0C0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_FETCHFIRSTJUMPABLESUBMISSIONDATA_OFFSET UNITYSDK_OFFSET(0x9A90210)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_GETBIGMAPICON_OFFSET UNITYSDK_OFFSET(0x9A90480)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_GETLIMAODATA_OFFSET UNITYSDK_OFFSET(0x9A8F870)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_GETLOACTIONDATA_OFFSET UNITYSDK_OFFSET(0x9A8FB40)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_GETSURVEYTYPEDATA_OFFSET UNITYSDK_OFFSET(0x9A8F930)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_GET_CURCONTENTDATAS_OFFSET UNITYSDK_OFFSET(0x9A8FFE0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_GET_CURCONTENTID_OFFSET UNITYSDK_OFFSET(0x9A8FE60)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_GET_DESC_OFFSET UNITYSDK_OFFSET(0x9A8FCE0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_GET_DISPLAYREWARDID_OFFSET UNITYSDK_OFFSET(0x9A8F2A0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_GET_FINISHCONDITIONIDS_OFFSET UNITYSDK_OFFSET(0x9A8F730)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_GET_HIDEREWARDAFTERSTART_OFFSET UNITYSDK_OFFSET(0x9A8F3A0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_GET_ISMISSIONTARGET_OFFSET UNITYSDK_OFFSET(0x9A905C0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_GET_LIMAOID_OFFSET UNITYSDK_OFFSET(0x9A8F170)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_GET_PICTUREPATH_OFFSET UNITYSDK_OFFSET(0x9A8F190)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_GET_SHOWCONDITIONIDS_OFFSET UNITYSDK_OFFSET(0x9A8F4B0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_GET_STARTCONDITIONIDS_OFFSET UNITYSDK_OFFSET(0x9A8F5F0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_GET_SURVEYID_OFFSET UNITYSDK_OFFSET(0x9A8F150)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_REFRESH_OFFSET UNITYSDK_OFFSET(0x9A8F100)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_SET_LIMAOID_OFFSET UNITYSDK_OFFSET(0x9A8F180)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM_SET_SURVEYID_OFFSET UNITYSDK_OFFSET(0x9A8F160)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9A8EEB0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM__GETFIRSTJUMPABLESUBMISSIONDATA_OFFSET UNITYSDK_OFFSET(0x9A90620)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM__GETFIRSTSTARTANDHASWAYPOINTSUBMISSIONDATA_OFFSET UNITYSDK_OFFSET(0x9A906F0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM__GETSURVEYROW_OFFSET UNITYSDK_OFFSET(0x9A8F240)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYITEM__INITTRACKDATALIST_OFFSET UNITYSDK_OFFSET(0x9A8EEF0)

namespace RPG::Client::MVVM::Model
{
	inline static constexpr unsigned int LimaoNewsOfficeSurveyItem_TypeDefinitionIndex = 61065;
	...
	public:
		...
		::RPG::Client::MVVM::Model::LimaoNewsLocationData* _LocationData; // 0x18
