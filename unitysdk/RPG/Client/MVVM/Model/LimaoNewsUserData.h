...
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSUSERDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x9A8D390)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSUSERDATA_GET_ISOFFICIAL_OFFSET UNITYSDK_OFFSET(0x9A92290)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSUSERDATA_GET_ISVAILD_OFFSET UNITYSDK_OFFSET(0x9A91F70)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSUSERDATA_GET_USERICON_OFFSET UNITYSDK_OFFSET(0x9A92030)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSUSERDATA_GET_USERID_OFFSET UNITYSDK_OFFSET(0x9A91F50)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSUSERDATA_GET_USERNAME_OFFSET UNITYSDK_OFFSET(0x9A92140)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSUSERDATA_SET_USERID_OFFSET UNITYSDK_OFFSET(0x9A91F60)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSUSERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9A91F40)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSUSERDATA__GETUSERROW_OFFSET UNITYSDK_OFFSET(0x9A91FD0)

namespace RPG::Client::MVVM::Model
{
	inline static constexpr unsigned int LimaoNewsUserData_TypeDefinitionIndex = 61072;
