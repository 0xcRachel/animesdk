...
#define RPG_CLIENT_MVVM_MODEL_TUTORIALSINGLEGUIDEINFO_GET_DESCTEXT_OFFSET UNITYSDK_OFFSET(0x9A93580)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALSINGLEGUIDEINFO_GET_IMAGEPATH_OFFSET UNITYSDK_OFFSET(0x9A93570)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALSINGLEGUIDEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x9A92770)

namespace RPG::Client::MVVM::Model
{
	inline static constexpr unsigned int TutorialSingleGuideInfo_TypeDefinitionIndex = 61074;
