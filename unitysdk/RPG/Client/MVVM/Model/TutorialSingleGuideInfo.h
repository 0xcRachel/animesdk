...
#define RPG_CLIENT_MVVM_MODEL_TUTORIALSINGLEGUIDEINFO_GET_DESCTEXT_OFFSET UNITYSDK_OFFSET(0x16969430)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALSINGLEGUIDEINFO_GET_IMAGEPATH_OFFSET UNITYSDK_OFFSET(0x16969420)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALSINGLEGUIDEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16968620)

namespace RPG::Client::MVVM::Model
{
	inline static constexpr unsigned int TutorialSingleGuideInfo_TypeDefinitionIndex = 68533;
