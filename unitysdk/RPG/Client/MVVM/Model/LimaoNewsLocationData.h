...
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSLOCATIONDATA_CREATE_1_OFFSET UNITYSDK_OFFSET(0x9A8D490)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSLOCATIONDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x9A8D430)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSLOCATIONDATA_GET_LOCATIONID_OFFSET UNITYSDK_OFFSET(0x9A8D530)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSLOCATIONDATA_GET_LOCATIONNAME_OFFSET UNITYSDK_OFFSET(0x9A8D550)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSLOCATIONDATA_SET_LOCATIONID_OFFSET UNITYSDK_OFFSET(0x9A8D540)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSLOCATIONDATA_SET_LOCATIONNAME_OFFSET UNITYSDK_OFFSET(0x9A8D560)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSLOCATIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9A8D520)

namespace RPG::Client::MVVM::Model
{
	inline static constexpr unsigned int LimaoNewsLocationData_TypeDefinitionIndex = 61059;
