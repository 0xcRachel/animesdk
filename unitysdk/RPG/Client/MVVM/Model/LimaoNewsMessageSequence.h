...
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_CREATEITEMSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16963590)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_CREATEOPTIONSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16963730)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_GETOPTIONMESSAGESEQUENCE_OFFSET UNITYSDK_OFFSET(0x169634F0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_GET_MESSAGEID_OFFSET UNITYSDK_OFFSET(0x16963980)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_GET_MESSAGELIST_OFFSET UNITYSDK_OFFSET(0x16963920)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_GET_OPTIONLIST_OFFSET UNITYSDK_OFFSET(0x16963940)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_GET_OPTIONMESSAGESEQUENCELIST_OFFSET UNITYSDK_OFFSET(0x16963960)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_SETMESSAGEID_OFFSET UNITYSDK_OFFSET(0x169638D0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_SET_MESSAGEID_OFFSET UNITYSDK_OFFSET(0x16963990)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_SET_MESSAGELIST_OFFSET UNITYSDK_OFFSET(0x16963930)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_SET_OPTIONLIST_OFFSET UNITYSDK_OFFSET(0x16963950)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_SET_OPTIONMESSAGESEQUENCELIST_OFFSET UNITYSDK_OFFSET(0x16963970)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x16963450)

namespace RPG::Client::MVVM::Model
{
	inline static constexpr unsigned int LimaoNewsMessageSequence_TypeDefinitionIndex = 68520;

	class LimaoNewsMessageSequence : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::Class_1_36F921FE7B01E8EB*>* _MessageList_k__BackingField; // 0x10
		::System::Collections::Generic::List_1<::Class_1_36F921FE7B01E8EB*>* _OptionList_k__BackingField; // 0x18
		::System::Collections::Generic::List_1<::RPG::Client::MVVM::Model::LimaoNewsMessageSequence*>* _OptionMessageSequenceList_k__BackingField; // 0x20
