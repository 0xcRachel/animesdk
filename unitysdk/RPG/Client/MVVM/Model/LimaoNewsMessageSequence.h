...
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_CREATEITEMSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9A8D6B0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_CREATEOPTIONSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9A8D850)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_GETOPTIONMESSAGESEQUENCE_OFFSET UNITYSDK_OFFSET(0x9A8D610)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_GET_MESSAGEID_OFFSET UNITYSDK_OFFSET(0x9A8DAA0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_GET_MESSAGELIST_OFFSET UNITYSDK_OFFSET(0x9A8DA40)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_GET_OPTIONLIST_OFFSET UNITYSDK_OFFSET(0x9A8DA60)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_GET_OPTIONMESSAGESEQUENCELIST_OFFSET UNITYSDK_OFFSET(0x9A8DA80)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_SETMESSAGEID_OFFSET UNITYSDK_OFFSET(0x9A8D9F0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_SET_MESSAGEID_OFFSET UNITYSDK_OFFSET(0x9A8DAB0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_SET_MESSAGELIST_OFFSET UNITYSDK_OFFSET(0x9A8DA50)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_SET_OPTIONLIST_OFFSET UNITYSDK_OFFSET(0x9A8DA70)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_SET_OPTIONMESSAGESEQUENCELIST_OFFSET UNITYSDK_OFFSET(0x9A8DA90)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x9A8D570)

namespace RPG::Client::MVVM::Model
{
	inline static constexpr unsigned int LimaoNewsMessageSequence_TypeDefinitionIndex = 61061;
