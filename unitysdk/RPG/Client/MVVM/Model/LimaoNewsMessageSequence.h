...
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_CREATEITEMSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x95AF100)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_CREATEOPTIONSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x95AF2A0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_GETOPTIONMESSAGESEQUENCE_OFFSET UNITYSDK_OFFSET(0x95AF060)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_GET_MESSAGEID_OFFSET UNITYSDK_OFFSET(0x95AF4F0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_GET_MESSAGELIST_OFFSET UNITYSDK_OFFSET(0x95AF490)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_GET_OPTIONLIST_OFFSET UNITYSDK_OFFSET(0x95AF4B0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_GET_OPTIONMESSAGESEQUENCELIST_OFFSET UNITYSDK_OFFSET(0x95AF4D0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_SETMESSAGEID_OFFSET UNITYSDK_OFFSET(0x95AF440)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_SET_MESSAGEID_OFFSET UNITYSDK_OFFSET(0x95AF500)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_SET_MESSAGELIST_OFFSET UNITYSDK_OFFSET(0x95AF4A0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_SET_OPTIONLIST_OFFSET UNITYSDK_OFFSET(0x95AF4C0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE_SET_OPTIONMESSAGESEQUENCELIST_OFFSET UNITYSDK_OFFSET(0x95AF4E0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMESSAGESEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x95AEFC0)

namespace RPG::Client::MVVM::Model
{
	inline static constexpr unsigned int LimaoNewsMessageSequence_TypeDefinitionIndex = 59308;
