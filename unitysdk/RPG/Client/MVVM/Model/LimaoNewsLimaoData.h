...
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSLIMAODATA_CREATE_OFFSET UNITYSDK_OFFSET(0x16962ED0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSLIMAODATA_GET_LIMAOID_OFFSET UNITYSDK_OFFSET(0x169632F0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSLIMAODATA_GET_NPCID_OFFSET UNITYSDK_OFFSET(0x16962F60)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSLIMAODATA_GET_USERDATA_OFFSET UNITYSDK_OFFSET(0x169630C0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSLIMAODATA_SET_LIMAOID_OFFSET UNITYSDK_OFFSET(0x16963300)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSLIMAODATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16962F50)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSLIMAODATA__GETLIMAOROW_OFFSET UNITYSDK_OFFSET(0x16963060)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSLIMAODATA__GETUSERDATA_OFFSET UNITYSDK_OFFSET(0x169630D0)

namespace RPG::Client::MVVM::Model
{
	inline static constexpr unsigned int LimaoNewsLimaoData_TypeDefinitionIndex = 68517;
