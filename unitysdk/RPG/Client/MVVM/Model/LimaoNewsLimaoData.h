...
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSLIMAODATA_CREATE_OFFSET UNITYSDK_OFFSET(0x9A8CFF0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSLIMAODATA_GET_LIMAOID_OFFSET UNITYSDK_OFFSET(0x9A8D410)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSLIMAODATA_GET_NPCID_OFFSET UNITYSDK_OFFSET(0x9A8D080)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSLIMAODATA_GET_USERDATA_OFFSET UNITYSDK_OFFSET(0x9A8D1E0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSLIMAODATA_SET_LIMAOID_OFFSET UNITYSDK_OFFSET(0x9A8D420)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSLIMAODATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9A8D070)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSLIMAODATA__GETLIMAOROW_OFFSET UNITYSDK_OFFSET(0x9A8D180)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSLIMAODATA__GETUSERDATA_OFFSET UNITYSDK_OFFSET(0x9A8D1F0)

namespace RPG::Client::MVVM::Model
{
	inline static constexpr unsigned int LimaoNewsLimaoData_TypeDefinitionIndex = 61058;
