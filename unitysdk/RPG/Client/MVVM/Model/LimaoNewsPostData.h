...
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_CREATENEXTSTATEPOST_OFFSET UNITYSDK_OFFSET(0x9A90BE0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x9A90B70)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_CANSUBMITCONDITIONIDS_OFFSET UNITYSDK_OFFSET(0x9A90F60)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_COMICPREFABPATH_OFFSET UNITYSDK_OFFSET(0x9A91440)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_COMMENTIDLIST_OFFSET UNITYSDK_OFFSET(0x9A91D50)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0x9A910B0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_DISPLAYSURVEYTYPEDATA_OFFSET UNITYSDK_OFFSET(0x9A91B70)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_GOTOSURVEYID_OFFSET UNITYSDK_OFFSET(0x9A912F0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_HEADCOUNT_OFFSET UNITYSDK_OFFSET(0x9A91CB0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_ISSUBMITTED_OFFSET UNITYSDK_OFFSET(0x9A90F00)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_ISUPVOTE_OFFSET UNITYSDK_OFFSET(0x9A90F40)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_LOCATIONID_OFFSET UNITYSDK_OFFSET(0x9A91130)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_NEXTSTATEID_OFFSET UNITYSDK_OFFSET(0x9A90CF0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_PICTUREPATH_OFFSET UNITYSDK_OFFSET(0x9A91930)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_POSTID_OFFSET UNITYSDK_OFFSET(0x9A90EA0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_POSTTYPE_OFFSET UNITYSDK_OFFSET(0x9A913D0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_REPLYCOMMENTID_OFFSET UNITYSDK_OFFSET(0x9A91210)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_REPLYFINISHCONDITIONIDLIST_OFFSET UNITYSDK_OFFSET(0x9A91280)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_REWARDID_OFFSET UNITYSDK_OFFSET(0x9A911A0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_STATEID_OFFSET UNITYSDK_OFFSET(0x9A90EE0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_SUBMITTEDSORTID_OFFSET UNITYSDK_OFFSET(0x9A90F20)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_SUBMITTEDUSERID_OFFSET UNITYSDK_OFFSET(0x9A90EC0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_SUBMITTYPE_OFFSET UNITYSDK_OFFSET(0x9A91360)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_TITLE_OFFSET UNITYSDK_OFFSET(0x9A91030)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_USERDATA_OFFSET UNITYSDK_OFFSET(0x9A919E0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_VIDEOID_OFFSET UNITYSDK_OFFSET(0x9A914B0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_NEEDSHOWTAG_OFFSET UNITYSDK_OFFSET(0x9A91E10)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_REFRESHUPVOTE_OFFSET UNITYSDK_OFFSET(0x9A90E50)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_REFRESH_OFFSET UNITYSDK_OFFSET(0x9A90D90)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_SET_ISSUBMITTED_OFFSET UNITYSDK_OFFSET(0x9A90F10)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_SET_ISUPVOTE_OFFSET UNITYSDK_OFFSET(0x9A90F50)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_SET_POSTID_OFFSET UNITYSDK_OFFSET(0x9A90EB0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_SET_STATEID_OFFSET UNITYSDK_OFFSET(0x9A90EF0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_SET_SUBMITTEDSORTID_OFFSET UNITYSDK_OFFSET(0x9A90F30)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_SET_SUBMITTEDUSERID_OFFSET UNITYSDK_OFFSET(0x9A90ED0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9A90BD0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA__GETDISPLAYSURVEYTYPEDATA_OFFSET UNITYSDK_OFFSET(0x9A91B80)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA__GETPOSTROW_OFFSET UNITYSDK_OFFSET(0x9A90FD0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA__GETPOSTSTATEROW_OFFSET UNITYSDK_OFFSET(0x9A91C40)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA__GETUSERDATA_OFFSET UNITYSDK_OFFSET(0x9A919F0)

namespace RPG::Client::MVVM::Model
{
	inline static constexpr unsigned int LimaoNewsPostData_TypeDefinitionIndex = 61069;
