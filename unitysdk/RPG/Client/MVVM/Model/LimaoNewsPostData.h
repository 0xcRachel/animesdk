...
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_CREATENEXTSTATEPOST_OFFSET UNITYSDK_OFFSET(0x16966A90)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x16966A20)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_CANSUBMITCONDITIONIDS_OFFSET UNITYSDK_OFFSET(0x16966E10)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_COMICPREFABPATH_OFFSET UNITYSDK_OFFSET(0x169672F0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_COMMENTIDLIST_OFFSET UNITYSDK_OFFSET(0x16967C00)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0x16966F60)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_DISPLAYSURVEYTYPEDATA_OFFSET UNITYSDK_OFFSET(0x16967A20)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_GOTOSURVEYID_OFFSET UNITYSDK_OFFSET(0x169671A0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_HEADCOUNT_OFFSET UNITYSDK_OFFSET(0x16967B60)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_ISSUBMITTED_OFFSET UNITYSDK_OFFSET(0x16966DB0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_ISUPVOTE_OFFSET UNITYSDK_OFFSET(0x16966DF0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_LOCATIONID_OFFSET UNITYSDK_OFFSET(0x16966FE0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_NEXTSTATEID_OFFSET UNITYSDK_OFFSET(0x16966BA0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_PICTUREPATH_OFFSET UNITYSDK_OFFSET(0x169677E0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_POSTID_OFFSET UNITYSDK_OFFSET(0x16966D50)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_POSTTYPE_OFFSET UNITYSDK_OFFSET(0x16967280)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_REPLYCOMMENTID_OFFSET UNITYSDK_OFFSET(0x169670C0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_REPLYFINISHCONDITIONIDLIST_OFFSET UNITYSDK_OFFSET(0x16967130)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_REWARDID_OFFSET UNITYSDK_OFFSET(0x16967050)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_STATEID_OFFSET UNITYSDK_OFFSET(0x16966D90)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_SUBMITTEDSORTID_OFFSET UNITYSDK_OFFSET(0x16966DD0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_SUBMITTEDUSERID_OFFSET UNITYSDK_OFFSET(0x16966D70)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_SUBMITTYPE_OFFSET UNITYSDK_OFFSET(0x16967210)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_TITLE_OFFSET UNITYSDK_OFFSET(0x16966EE0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_USERDATA_OFFSET UNITYSDK_OFFSET(0x16967890)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_VIDEOID_OFFSET UNITYSDK_OFFSET(0x16967360)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_NEEDSHOWTAG_OFFSET UNITYSDK_OFFSET(0x16967CC0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_REFRESHUPVOTE_OFFSET UNITYSDK_OFFSET(0x16966D00)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_REFRESH_OFFSET UNITYSDK_OFFSET(0x16966C40)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_SET_ISSUBMITTED_OFFSET UNITYSDK_OFFSET(0x16966DC0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_SET_ISUPVOTE_OFFSET UNITYSDK_OFFSET(0x16966E00)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_SET_POSTID_OFFSET UNITYSDK_OFFSET(0x16966D60)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_SET_STATEID_OFFSET UNITYSDK_OFFSET(0x16966DA0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_SET_SUBMITTEDSORTID_OFFSET UNITYSDK_OFFSET(0x16966DE0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_SET_SUBMITTEDUSERID_OFFSET UNITYSDK_OFFSET(0x16966D80)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16966A80)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA__GETDISPLAYSURVEYTYPEDATA_OFFSET UNITYSDK_OFFSET(0x16967A30)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA__GETPOSTROW_OFFSET UNITYSDK_OFFSET(0x16966E80)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA__GETPOSTSTATEROW_OFFSET UNITYSDK_OFFSET(0x16967AF0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA__GETUSERDATA_OFFSET UNITYSDK_OFFSET(0x169678A0)

namespace RPG::Client::MVVM::Model
{
	inline static constexpr unsigned int LimaoNewsPostData_TypeDefinitionIndex = 68528;
	...
	public:
		...
		::System::UInt32 _PostID_k__BackingField; // 0x24
		::System::UInt32 _SubmittedSortID_k__BackingField; // 0x28
