...
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_CREATENEXTSTATEPOST_OFFSET UNITYSDK_OFFSET(0x95B24A0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x95B2430)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_CANSUBMITCONDITIONIDS_OFFSET UNITYSDK_OFFSET(0x95B2820)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_COMICPREFABPATH_OFFSET UNITYSDK_OFFSET(0x95B2D00)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_COMMENTIDLIST_OFFSET UNITYSDK_OFFSET(0x95B35E0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0x95B2970)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_DISPLAYSURVEYTYPEDATA_OFFSET UNITYSDK_OFFSET(0x95B3400)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_GOTOSURVEYID_OFFSET UNITYSDK_OFFSET(0x95B2BB0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_HEADCOUNT_OFFSET UNITYSDK_OFFSET(0x95B3540)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_ISSUBMITTED_OFFSET UNITYSDK_OFFSET(0x95B27C0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_ISUPVOTE_OFFSET UNITYSDK_OFFSET(0x95B2800)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_LOCATIONID_OFFSET UNITYSDK_OFFSET(0x95B29F0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_NEXTSTATEID_OFFSET UNITYSDK_OFFSET(0x95B25B0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_PICTUREPATH_OFFSET UNITYSDK_OFFSET(0x95B31F0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_POSTID_OFFSET UNITYSDK_OFFSET(0x95B2760)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_POSTTYPE_OFFSET UNITYSDK_OFFSET(0x95B2C90)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_REPLYCOMMENTID_OFFSET UNITYSDK_OFFSET(0x95B2AD0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_REPLYFINISHCONDITIONIDLIST_OFFSET UNITYSDK_OFFSET(0x95B2B40)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_REWARDID_OFFSET UNITYSDK_OFFSET(0x95B2A60)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_STATEID_OFFSET UNITYSDK_OFFSET(0x95B27A0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_SUBMITTEDSORTID_OFFSET UNITYSDK_OFFSET(0x95B27E0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_SUBMITTEDUSERID_OFFSET UNITYSDK_OFFSET(0x95B2780)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_SUBMITTYPE_OFFSET UNITYSDK_OFFSET(0x95B2C20)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_TITLE_OFFSET UNITYSDK_OFFSET(0x95B28F0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_USERDATA_OFFSET UNITYSDK_OFFSET(0x95B32A0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_GET_VIDEOID_OFFSET UNITYSDK_OFFSET(0x95B2D70)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_NEEDSHOWTAG_OFFSET UNITYSDK_OFFSET(0x95B36A0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_REFRESHUPVOTE_OFFSET UNITYSDK_OFFSET(0x95B2710)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_REFRESH_OFFSET UNITYSDK_OFFSET(0x95B2650)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_SET_ISSUBMITTED_OFFSET UNITYSDK_OFFSET(0x95B27D0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_SET_ISUPVOTE_OFFSET UNITYSDK_OFFSET(0x95B2810)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_SET_POSTID_OFFSET UNITYSDK_OFFSET(0x95B2770)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_SET_STATEID_OFFSET UNITYSDK_OFFSET(0x95B27B0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_SET_SUBMITTEDSORTID_OFFSET UNITYSDK_OFFSET(0x95B27F0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA_SET_SUBMITTEDUSERID_OFFSET UNITYSDK_OFFSET(0x95B2790)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x95B2490)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA__GETDISPLAYSURVEYTYPEDATA_OFFSET UNITYSDK_OFFSET(0x95B3410)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA__GETPOSTROW_OFFSET UNITYSDK_OFFSET(0x95B2890)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA__GETPOSTSTATEROW_OFFSET UNITYSDK_OFFSET(0x95B34D0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA__GETUSERDATA_OFFSET UNITYSDK_OFFSET(0x95B32B0)

namespace RPG::Client::MVVM::Model
{
	inline static constexpr unsigned int LimaoNewsPostData_TypeDefinitionIndex = 59316;
	...
	public:
		...
		{
			return ((::Class_1_3DBA0458C780107F*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_MVVM_MODEL_LIMAONEWSPOSTDATA__GETPOSTSTATEROW_OFFSET))(this);
		}
