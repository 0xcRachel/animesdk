...
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYTYPEDATA_CREATE_1_OFFSET UNITYSDK_OFFSET(0x95B2250)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYTYPEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x95B13F0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYTYPEDATA_GET_ISNONE_OFFSET UNITYSDK_OFFSET(0x95B2360)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYTYPEDATA_GET_OFFICESURVEYTYPE_OFFSET UNITYSDK_OFFSET(0x95B2300)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYTYPEDATA_GET_SURVEYTYPECOLORSTATE_OFFSET UNITYSDK_OFFSET(0x95B2370)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYTYPEDATA_GET_SURVEYTYPEICON_OFFSET UNITYSDK_OFFSET(0x95B2320)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYTYPEDATA_GET_SURVEYTYPEMASKCOLORSTATE_OFFSET UNITYSDK_OFFSET(0x95B23D0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYTYPEDATA_GET_SURVEYTYPETEXTID_OFFSET UNITYSDK_OFFSET(0x95B2340)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYTYPEDATA_SET_OFFICESURVEYTYPE_OFFSET UNITYSDK_OFFSET(0x95B2310)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYTYPEDATA_SET_SURVEYTYPEICON_OFFSET UNITYSDK_OFFSET(0x95B2330)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYTYPEDATA_SET_SURVEYTYPETEXTID_OFFSET UNITYSDK_OFFSET(0x95B2350)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYTYPEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x95B21E0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYTYPEDATA__INITBYROW_OFFSET UNITYSDK_OFFSET(0x95B21F0)

namespace RPG::Client::MVVM::Model
{
	inline static constexpr unsigned int LimaoNewsOfficeSurveyTypeData_TypeDefinitionIndex = 59314;
	...
	public:
		...
		static ::RPG::Client::MVVM::Model::LimaoNewsOfficeSurveyTypeData* Create_1(::Class_1_9B395D4E6EEE639B* row)
		{
			return ((::RPG::Client::MVVM::Model::LimaoNewsOfficeSurveyTypeData*(*)(::Class_1_9B395D4E6EEE639B*))((::PBYTE)hIl2Cpp + RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYTYPEDATA_CREATE_1_OFFSET))(row);
		}

		::System::Void _InitByRow(::Class_1_9B395D4E6EEE639B* row)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_9B395D4E6EEE639B*))((::PBYTE)hIl2Cpp + RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYTYPEDATA__INITBYROW_OFFSET))(this, row);
		}
