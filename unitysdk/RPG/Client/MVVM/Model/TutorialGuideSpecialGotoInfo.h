...
#define RPG_CLIENT_MVVM_MODEL_TUTORIALGUIDESPECIALGOTOINFO_GET_GOTOID_OFFSET UNITYSDK_OFFSET(0x16968A80)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALGUIDESPECIALGOTOINFO_GET_HINTTEXT_OFFSET UNITYSDK_OFFSET(0x16968A70)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALGUIDESPECIALGOTOINFO_GET_NEEDREDDOT_OFFSET UNITYSDK_OFFSET(0x16968AB0)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALGUIDESPECIALGOTOINFO_GET_REDDOTKEY_OFFSET UNITYSDK_OFFSET(0x16968A90)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALGUIDESPECIALGOTOINFO_GET_REDDOTSUBKEY_OFFSET UNITYSDK_OFFSET(0x16968AA0)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALGUIDESPECIALGOTOINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16968A30)

namespace RPG::Client::MVVM::Model
{
	inline static constexpr unsigned int TutorialGuideSpecialGotoInfo_TypeDefinitionIndex = 68536;
