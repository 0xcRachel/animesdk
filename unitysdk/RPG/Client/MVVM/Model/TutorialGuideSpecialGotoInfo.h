...
#define RPG_CLIENT_MVVM_MODEL_TUTORIALGUIDESPECIALGOTOINFO_GET_GOTOID_OFFSET UNITYSDK_OFFSET(0x95B4420)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALGUIDESPECIALGOTOINFO_GET_HINTTEXT_OFFSET UNITYSDK_OFFSET(0x95B4410)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALGUIDESPECIALGOTOINFO_GET_NEEDREDDOT_OFFSET UNITYSDK_OFFSET(0x95B4450)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALGUIDESPECIALGOTOINFO_GET_REDDOTKEY_OFFSET UNITYSDK_OFFSET(0x95B4430)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALGUIDESPECIALGOTOINFO_GET_REDDOTSUBKEY_OFFSET UNITYSDK_OFFSET(0x95B4440)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALGUIDESPECIALGOTOINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x95B43D0)

namespace RPG::Client::MVVM::Model
{
	inline static constexpr unsigned int TutorialGuideSpecialGotoInfo_TypeDefinitionIndex = 59324;
