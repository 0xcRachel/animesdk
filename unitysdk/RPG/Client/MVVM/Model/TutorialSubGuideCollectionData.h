...
#define RPG_CLIENT_MVVM_MODEL_TUTORIALSUBGUIDECOLLECTIONDATA_CREATEGUIDEGROUPDATA_OFFSET UNITYSDK_OFFSET(0x95B53D0)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALSUBGUIDECOLLECTIONDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x95B4E40)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALSUBGUIDECOLLECTIONDATA_GETCATEGORYIDLISTBYGROUPTYPEID_OFFSET UNITYSDK_OFFSET(0x95B5500)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALSUBGUIDECOLLECTIONDATA_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x95B5240)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALSUBGUIDECOLLECTIONDATA_GETGUIDECATEGORYINFO_OFFSET UNITYSDK_OFFSET(0x95B5460)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALSUBGUIDECOLLECTIONDATA_GETGUIDEGROUPDATABYID_OFFSET UNITYSDK_OFFSET(0x95B5310)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALSUBGUIDECOLLECTIONDATA_GETSPECIALGOTOINFO_OFFSET UNITYSDK_OFFSET(0x95B56A0)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALSUBGUIDECOLLECTIONDATA_GET_GUIDETYPE_OFFSET UNITYSDK_OFFSET(0x95B56F0)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALSUBGUIDECOLLECTIONDATA__CREATEGUIDEGROUPDATA_OFFSET UNITYSDK_OFFSET(0x95B5080)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALSUBGUIDECOLLECTIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x95B4DC0)

namespace RPG::Client::MVVM::Model
{
	inline static constexpr unsigned int TutorialSubGuideCollectionData_TypeDefinitionIndex = 59326;
	...
	public:
		...
		{
			return ((::Enum_3_ED790DAC948A65A9_23(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_MVVM_MODEL_TUTORIALSUBGUIDECOLLECTIONDATA_GET_GUIDETYPE_OFFSET))(this);
		}
	};
}
