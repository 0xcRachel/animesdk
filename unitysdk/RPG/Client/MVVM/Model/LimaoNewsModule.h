...
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16963F40)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_CONDITIONSERVICE_OFFSET UNITYSDK_OFFSET(0x169647D0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_ISSUESERVICE_OFFSET UNITYSDK_OFFSET(0x16964830)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_LIMAOSERVICE_OFFSET UNITYSDK_OFFSET(0x16964870)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_MESSAGESERVICE_OFFSET UNITYSDK_OFFSET(0x169648F0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_NETWORKSERVICE_OFFSET UNITYSDK_OFFSET(0x16964770)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_OFFERINGSERVICE_OFFSET UNITYSDK_OFFSET(0x16964890)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_OFFICEEVENTSERVICE_OFFSET UNITYSDK_OFFSET(0x16964810)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_OFFICESURVEYSERVICE_OFFSET UNITYSDK_OFFSET(0x169647F0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_POSTSERVICE_OFFSET UNITYSDK_OFFSET(0x16964850)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_SPONSORSERVICE_OFFSET UNITYSDK_OFFSET(0x169648D0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_TRACKSERVICE_OFFSET UNITYSDK_OFFSET(0x169648B0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_TUTORIALSERVICE_OFFSET UNITYSDK_OFFSET(0x169647B0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_WINDOWSERVICE_OFFSET UNITYSDK_OFFSET(0x16964790)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_INIT_OFFSET UNITYSDK_OFFSET(0x169639A0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_CONDITIONSERVICE_OFFSET UNITYSDK_OFFSET(0x169647E0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_ISSUESERVICE_OFFSET UNITYSDK_OFFSET(0x16964840)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_LIMAOSERVICE_OFFSET UNITYSDK_OFFSET(0x16964880)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_MESSAGESERVICE_OFFSET UNITYSDK_OFFSET(0x16964900)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_NETWORKSERVICE_OFFSET UNITYSDK_OFFSET(0x16964780)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_OFFERINGSERVICE_OFFSET UNITYSDK_OFFSET(0x169648A0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_OFFICEEVENTSERVICE_OFFSET UNITYSDK_OFFSET(0x16964820)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_OFFICESURVEYSERVICE_OFFSET UNITYSDK_OFFSET(0x16964800)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_POSTSERVICE_OFFSET UNITYSDK_OFFSET(0x16964860)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_SPONSORSERVICE_OFFSET UNITYSDK_OFFSET(0x169648E0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_TRACKSERVICE_OFFSET UNITYSDK_OFFSET(0x169648C0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_TUTORIALSERVICE_OFFSET UNITYSDK_OFFSET(0x169647C0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_WINDOWSERVICE_OFFSET UNITYSDK_OFFSET(0x169647A0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x16964910)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x169649C0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x16964930)

namespace RPG::Client::MVVM::Model
{
	inline static constexpr unsigned int LimaoNewsModule_TypeDefinitionIndex = 68521;

	class LimaoNewsModule : public ::RPG::Client::BaseModule
	{
	public:
		::RPG::Client::MVVM::Service::LimaoNewsIssueService* _IssueService_k__BackingField; // 0x10
		::Class_1_0BE9E9C1D5A3C687* _ConditionService_k__BackingField; // 0x18
		::RPG::Client::MVVM::Service::LimaoNewsOfficeSurveyService* _OfficeSurveyService_k__BackingField; // 0x20
		::RPG::Client::MVVM::Service::LimaoNewsNetworkService* _NetworkService_k__BackingField; // 0x28
		::RPG::Client::MVVM::Service::LimaoNewsMessageService* _MessageService_k__BackingField; // 0x30
		::RPG::Client::MVVM::Service::LimaoNewsOfferingService* _OfferingService_k__BackingField; // 0x38
		::RPG::Client::MVVM::Service::LimaoNewsWindowService* _WindowService_k__BackingField; // 0x40
		::Class_1_03D6D30E62EFB374_1* _SponsorService_k__BackingField; // 0x48
		::RPG::Client::MVVM::Service::LimaoNewsPostService* _PostService_k__BackingField; // 0x50
		::Class_1_4780C96744815F8D* _LimaoService_k__BackingField; // 0x58
		::Class_1_895FB63906FAA27E* _OfficeEventService_k__BackingField; // 0x60
		::RPG::Client::MVVM::Service::LimaoNewsTrackService* _TrackService_k__BackingField; // 0x68
		::RPG::Client::MVVM::Service::LimaoNewsTutorialService* _TutorialService_k__BackingField; // 0x70
