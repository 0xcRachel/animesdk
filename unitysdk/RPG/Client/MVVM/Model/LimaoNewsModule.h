...
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x95AFB80)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_CONDITIONSERVICE_OFFSET UNITYSDK_OFFSET(0x95B02D0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_ISSUESERVICE_OFFSET UNITYSDK_OFFSET(0x95B0330)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_LIMAOSERVICE_OFFSET UNITYSDK_OFFSET(0x95B0370)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_MESSAGESERVICE_OFFSET UNITYSDK_OFFSET(0x95B03F0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_NETWORKSERVICE_OFFSET UNITYSDK_OFFSET(0x95B0270)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_OFFERINGSERVICE_OFFSET UNITYSDK_OFFSET(0x95B0390)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_OFFICEEVENTSERVICE_OFFSET UNITYSDK_OFFSET(0x95B0310)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_OFFICESURVEYSERVICE_OFFSET UNITYSDK_OFFSET(0x95B02F0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_POSTSERVICE_OFFSET UNITYSDK_OFFSET(0x95B0350)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_SPONSORSERVICE_OFFSET UNITYSDK_OFFSET(0x95B03D0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_TRACKSERVICE_OFFSET UNITYSDK_OFFSET(0x95B03B0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_TUTORIALSERVICE_OFFSET UNITYSDK_OFFSET(0x95B02B0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_WINDOWSERVICE_OFFSET UNITYSDK_OFFSET(0x95B0290)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_INIT_OFFSET UNITYSDK_OFFSET(0x95AF510)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_CONDITIONSERVICE_OFFSET UNITYSDK_OFFSET(0x95B02E0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_ISSUESERVICE_OFFSET UNITYSDK_OFFSET(0x95B0340)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_LIMAOSERVICE_OFFSET UNITYSDK_OFFSET(0x95B0380)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_MESSAGESERVICE_OFFSET UNITYSDK_OFFSET(0x95B0400)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_NETWORKSERVICE_OFFSET UNITYSDK_OFFSET(0x95B0280)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_OFFERINGSERVICE_OFFSET UNITYSDK_OFFSET(0x95B03A0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_OFFICEEVENTSERVICE_OFFSET UNITYSDK_OFFSET(0x95B0320)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_OFFICESURVEYSERVICE_OFFSET UNITYSDK_OFFSET(0x95B0300)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_POSTSERVICE_OFFSET UNITYSDK_OFFSET(0x95B0360)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_SPONSORSERVICE_OFFSET UNITYSDK_OFFSET(0x95B03E0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_TRACKSERVICE_OFFSET UNITYSDK_OFFSET(0x95B03C0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_TUTORIALSERVICE_OFFSET UNITYSDK_OFFSET(0x95B02C0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_WINDOWSERVICE_OFFSET UNITYSDK_OFFSET(0x95B02A0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x95B0410)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x95B04C0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x95B0430)

namespace RPG::Client::MVVM::Model
{
	inline static constexpr unsigned int LimaoNewsModule_TypeDefinitionIndex = 59309;

	class LimaoNewsModule : public ::RPG::Client::BaseModule
	{
	public:
		::RPG::Client::MVVM::Service::LimaoNewsOfferingService* _OfferingService_k__BackingField; // 0x10
		::RPG::Client::MVVM::Service::LimaoNewsPostService* _PostService_k__BackingField; // 0x18
		::RPG::Client::MVVM::Service::LimaoNewsOfficeSurveyService* _OfficeSurveyService_k__BackingField; // 0x20
		::RPG::Client::MVVM::Service::LimaoNewsTutorialService* _TutorialService_k__BackingField; // 0x28
		::RPG::Client::MVVM::Service::LimaoNewsIssueService* _IssueService_k__BackingField; // 0x30
		::Class_1_895FB63906FAA27E* _OfficeEventService_k__BackingField; // 0x38
		::Class_1_4780C96744815F8D* _LimaoService_k__BackingField; // 0x40
		::RPG::Client::MVVM::Service::LimaoNewsNetworkService* _NetworkService_k__BackingField; // 0x48
		::Class_1_0BE9E9C1D5A3C687* _ConditionService_k__BackingField; // 0x50
		::RPG::Client::MVVM::Service::LimaoNewsMessageService* _MessageService_k__BackingField; // 0x58
		::RPG::Client::MVVM::Service::LimaoNewsTrackService* _TrackService_k__BackingField; // 0x60
		::Class_1_03D6D30E62EFB374_1* _SponsorService_k__BackingField; // 0x68
