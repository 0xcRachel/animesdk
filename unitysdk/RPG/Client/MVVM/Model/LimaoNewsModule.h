...
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9A8E080)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_CONDITIONSERVICE_OFFSET UNITYSDK_OFFSET(0x9A8E910)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_ISSUESERVICE_OFFSET UNITYSDK_OFFSET(0x9A8E970)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_LIMAOSERVICE_OFFSET UNITYSDK_OFFSET(0x9A8E9B0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_MESSAGESERVICE_OFFSET UNITYSDK_OFFSET(0x9A8EA30)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_NETWORKSERVICE_OFFSET UNITYSDK_OFFSET(0x9A8E8B0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_OFFERINGSERVICE_OFFSET UNITYSDK_OFFSET(0x9A8E9D0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_OFFICEEVENTSERVICE_OFFSET UNITYSDK_OFFSET(0x9A8E950)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_OFFICESURVEYSERVICE_OFFSET UNITYSDK_OFFSET(0x9A8E930)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_POSTSERVICE_OFFSET UNITYSDK_OFFSET(0x9A8E990)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_SPONSORSERVICE_OFFSET UNITYSDK_OFFSET(0x9A8EA10)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_TRACKSERVICE_OFFSET UNITYSDK_OFFSET(0x9A8E9F0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_TUTORIALSERVICE_OFFSET UNITYSDK_OFFSET(0x9A8E8F0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_WINDOWSERVICE_OFFSET UNITYSDK_OFFSET(0x9A8E8D0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_INIT_OFFSET UNITYSDK_OFFSET(0x9A8DAC0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_CONDITIONSERVICE_OFFSET UNITYSDK_OFFSET(0x9A8E920)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_ISSUESERVICE_OFFSET UNITYSDK_OFFSET(0x9A8E980)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_LIMAOSERVICE_OFFSET UNITYSDK_OFFSET(0x9A8E9C0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_MESSAGESERVICE_OFFSET UNITYSDK_OFFSET(0x9A8EA40)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_NETWORKSERVICE_OFFSET UNITYSDK_OFFSET(0x9A8E8C0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_OFFERINGSERVICE_OFFSET UNITYSDK_OFFSET(0x9A8E9E0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_OFFICEEVENTSERVICE_OFFSET UNITYSDK_OFFSET(0x9A8E960)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_OFFICESURVEYSERVICE_OFFSET UNITYSDK_OFFSET(0x9A8E940)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_POSTSERVICE_OFFSET UNITYSDK_OFFSET(0x9A8E9A0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_SPONSORSERVICE_OFFSET UNITYSDK_OFFSET(0x9A8EA20)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_TRACKSERVICE_OFFSET UNITYSDK_OFFSET(0x9A8EA00)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_TUTORIALSERVICE_OFFSET UNITYSDK_OFFSET(0x9A8E900)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_WINDOWSERVICE_OFFSET UNITYSDK_OFFSET(0x9A8E8E0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x9A8EA50)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9A8EB00)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x9A8EA70)

namespace RPG::Client::MVVM::Model
{
	inline static constexpr unsigned int LimaoNewsModule_TypeDefinitionIndex = 61062;
	...
	public:
		...
		::RPG::Client::MVVM::Service::LimaoNewsOfficeSurveyService* _OfficeSurveyService_k__BackingField; // 0x18
		::Class_1_895FB63906FAA27E* _OfficeEventService_k__BackingField; // 0x20
		::RPG::Client::MVVM::Service::LimaoNewsPostService* _PostService_k__BackingField; // 0x28
		::Class_1_03D6D30E62EFB374_1* _SponsorService_k__BackingField; // 0x30
		::RPG::Client::MVVM::Service::LimaoNewsIssueService* _IssueService_k__BackingField; // 0x38
		::Class_1_0BE9E9C1D5A3C687* _ConditionService_k__BackingField; // 0x40
		::RPG::Client::MVVM::Service::LimaoNewsTrackService* _TrackService_k__BackingField; // 0x48
		...
		::RPG::Client::MVVM::Service::LimaoNewsWindowService* _WindowService_k__BackingField; // 0x60
