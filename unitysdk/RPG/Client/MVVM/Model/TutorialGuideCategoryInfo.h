...
#define RPG_CLIENT_MVVM_MODEL_TUTORIALGUIDECATEGORYINFO_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x16968270)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALGUIDECATEGORYINFO_GET_NAMETEXT_OFFSET UNITYSDK_OFFSET(0x16968260)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALGUIDECATEGORYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16968250)

namespace RPG::Client::MVVM::Model
{
	inline static constexpr unsigned int TutorialGuideCategoryInfo_TypeDefinitionIndex = 68534;
