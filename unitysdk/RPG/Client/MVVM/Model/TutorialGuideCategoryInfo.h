...
#define RPG_CLIENT_MVVM_MODEL_TUTORIALGUIDECATEGORYINFO_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x95B3C10)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALGUIDECATEGORYINFO_GET_NAMETEXT_OFFSET UNITYSDK_OFFSET(0x95B3C00)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALGUIDECATEGORYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x95B3BF0)

namespace RPG::Client::MVVM::Model
{
	inline static constexpr unsigned int TutorialGuideCategoryInfo_TypeDefinitionIndex = 59322;
