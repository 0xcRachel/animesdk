...
#define RPG_CLIENT_MVVM_MODEL_TUTORIALGUIDECATEGORYINFO_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x9A923C0)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALGUIDECATEGORYINFO_GET_NAMETEXT_OFFSET UNITYSDK_OFFSET(0x9A923B0)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALGUIDECATEGORYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x9A923A0)

namespace RPG::Client::MVVM::Model
{
	inline static constexpr unsigned int TutorialGuideCategoryInfo_TypeDefinitionIndex = 61075;
