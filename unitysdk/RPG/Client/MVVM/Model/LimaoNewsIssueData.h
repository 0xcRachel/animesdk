...
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSISSUEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x16962810)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSISSUEDATA_GETCOMMENTDATAS_OFFSET UNITYSDK_OFFSET(0x16962AF0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSISSUEDATA_GETINTERVIEWS_OFFSET UNITYSDK_OFFSET(0x169628A0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSISSUEDATA_GETREWARDID_OFFSET UNITYSDK_OFFSET(0x16962CE0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSISSUEDATA_GETREWARDITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x16962D80)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSISSUEDATA_GET_HINTPOPUPSHOWTYPE_OFFSET UNITYSDK_OFFSET(0x16962E30)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSISSUEDATA_GET_ISSUEID_OFFSET UNITYSDK_OFFSET(0x16962E10)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSISSUEDATA_SET_ISSUEID_OFFSET UNITYSDK_OFFSET(0x16962E20)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSISSUEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16962890)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSISSUEDATA__GETISSUEROW_OFFSET UNITYSDK_OFFSET(0x16962A90)

namespace RPG::Client::MVVM::Model
{
	inline static constexpr unsigned int LimaoNewsIssueData_TypeDefinitionIndex = 68516;
