...
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSISSUEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x9A8C930)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSISSUEDATA_GETCOMMENTDATAS_OFFSET UNITYSDK_OFFSET(0x9A8CC10)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSISSUEDATA_GETINTERVIEWS_OFFSET UNITYSDK_OFFSET(0x9A8C9C0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSISSUEDATA_GETREWARDID_OFFSET UNITYSDK_OFFSET(0x9A8CE00)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSISSUEDATA_GETREWARDITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x9A8CEA0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSISSUEDATA_GET_HINTPOPUPSHOWTYPE_OFFSET UNITYSDK_OFFSET(0x9A8CF50)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSISSUEDATA_GET_ISSUEID_OFFSET UNITYSDK_OFFSET(0x9A8CF30)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSISSUEDATA_SET_ISSUEID_OFFSET UNITYSDK_OFFSET(0x9A8CF40)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSISSUEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9A8C9B0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSISSUEDATA__GETISSUEROW_OFFSET UNITYSDK_OFFSET(0x9A8CBB0)

namespace RPG::Client::MVVM::Model
{
	inline static constexpr unsigned int LimaoNewsIssueData_TypeDefinitionIndex = 61057;
