...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSTATETAGCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x122FC440)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSTATETAGCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x122FC310)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSTATETAGCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x122FC0D0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSTATETAGCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x122FC4B0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSTATETAGCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x122FC450)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsStateTagControl_TypeDefinitionIndex = 68435;
