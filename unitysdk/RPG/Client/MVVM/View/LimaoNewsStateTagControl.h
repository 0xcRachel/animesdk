...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSTATETAGCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x9AB56F0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSTATETAGCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AB55C0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSTATETAGCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AB5380)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSTATETAGCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AB5760)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSTATETAGCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AB5700)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsStateTagControl_TypeDefinitionIndex = 60982;
