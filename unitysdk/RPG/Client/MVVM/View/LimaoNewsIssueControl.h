...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUECONTROL_METHOD_6_0CA9B0B924F0CB2A_OFFSET UNITYSDK_OFFSET(0x9AA8470)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUECONTROL_METHOD_6_323F95926A2F616E_OFFSET UNITYSDK_OFFSET(0x9AA8400)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUECONTROL_METHOD_6_32B252CB84490CAB_OFFSET UNITYSDK_OFFSET(0x9AA86C0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUECONTROL_ONLIMAONEWSSUBMITISSUE_OFFSET UNITYSDK_OFFSET(0x9AA8D30)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUECONTROL_REFRESHSUBMITNODE_OFFSET UNITYSDK_OFFSET(0x9AA8C10)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUECONTROL_TRYSHOWSUBMITNODEWITHFADEIN_OFFSET UNITYSDK_OFFSET(0x9AA8960)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x9AA9100)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUECONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AA70E0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUECONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AA6A00)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUECONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AA9170)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUECONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AA9110)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsIssueControl_TypeDefinitionIndex = 61004;
