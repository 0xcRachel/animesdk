...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUECONTROL_METHOD_6_0CA9B0B924F0CB2A_OFFSET UNITYSDK_OFFSET(0x122E5BC0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUECONTROL_METHOD_6_323F95926A2F616E_OFFSET UNITYSDK_OFFSET(0x122E5B50)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUECONTROL_METHOD_6_32B252CB84490CAB_OFFSET UNITYSDK_OFFSET(0x122E5E10)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUECONTROL_ONLIMAONEWSSUBMITISSUE_OFFSET UNITYSDK_OFFSET(0x122E6480)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUECONTROL_REFRESHSUBMITNODE_OFFSET UNITYSDK_OFFSET(0x122E6360)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUECONTROL_TRYSHOWSUBMITNODEWITHFADEIN_OFFSET UNITYSDK_OFFSET(0x122E60B0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x122E6850)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUECONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x122E4830)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUECONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x122E4150)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUECONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x122E68C0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUECONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x122E6860)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsIssueControl_TypeDefinitionIndex = 68457;
