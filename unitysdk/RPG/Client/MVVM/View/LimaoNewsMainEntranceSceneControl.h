...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINENTRANCESCENECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x9AAD1F0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINENTRANCESCENECONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AAC570)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINENTRANCESCENECONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AAC090)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINENTRANCESCENECONTROL__SETUPDESKS_OFFSET UNITYSDK_OFFSET(0x9AAC630)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINENTRANCESCENECONTROL__SETUPNPCS_OFFSET UNITYSDK_OFFSET(0x9AACB40)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINENTRANCESCENECONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AAD260)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINENTRANCESCENECONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AAD200)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsMainEntranceSceneControl_TypeDefinitionIndex = 60985;
