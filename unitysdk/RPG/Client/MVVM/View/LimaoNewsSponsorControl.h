...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSPONSORCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x9AB4A60)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSPONSORCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AB4470)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSPONSORCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AB4130)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSPONSORCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AB4AD0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSPONSORCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AB4A70)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsSponsorControl_TypeDefinitionIndex = 61016;
