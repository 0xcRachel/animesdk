...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSPONSORCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x122FB7B0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSPONSORCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x122FB1C0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSPONSORCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x122FAE80)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSPONSORCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x122FB820)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSPONSORCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x122FB7C0)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsSponsorControl_TypeDefinitionIndex = 68469;
