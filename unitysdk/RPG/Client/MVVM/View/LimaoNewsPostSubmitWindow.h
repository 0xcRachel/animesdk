...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTSUBMITWINDOW_METHOD_2_323F95926A2F616E_OFFSET UNITYSDK_OFFSET(0x9AB1DE0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTSUBMITWINDOW_METHOD_2_DE70BFBC2BB426D0_OFFSET UNITYSDK_OFFSET(0x9AB1E50)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTSUBMITWINDOW__CTOR_OFFSET UNITYSDK_OFFSET(0x9AB12E0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTSUBMITWINDOW__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AB1670)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTSUBMITWINDOW__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AB1380)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTSUBMITWINDOW___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AB2310)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTSUBMITWINDOW___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AB22B0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTSUBMITWINDOW___ONINITIALIZECOMPONENT_B__1_0_OFFSET UNITYSDK_OFFSET(0x9AB2240)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsPostSubmitWindow_TypeDefinitionIndex = 61029;
	...
	public:
		...
		::RPG::Client::MVVM::View::LimaoNewsInteractionControl* Field_2_4; // 0x60
