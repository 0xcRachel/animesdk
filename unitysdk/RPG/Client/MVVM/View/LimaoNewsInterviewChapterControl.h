...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWCHAPTERCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x9AA4020)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWCHAPTERCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AA3ED0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWCHAPTERCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AA3E10)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWCHAPTERCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AA4090)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWCHAPTERCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AA4030)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsInterviewChapterControl_TypeDefinitionIndex = 60990;
