...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWCONTROL_METHOD_6_8DC652D916C182B2_OFFSET UNITYSDK_OFFSET(0x9AA4A20)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x9AA50D0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AA4370)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AA40F0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AA5140)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AA50E0)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsInterviewControl_TypeDefinitionIndex = 61002;
