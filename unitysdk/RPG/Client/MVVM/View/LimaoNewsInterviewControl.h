...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWCONTROL_METHOD_6_8DC652D916C182B2_OFFSET UNITYSDK_OFFSET(0x122DF5D0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x122DFC80)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x122DEF20)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x122DECA0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x122DFCF0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x122DFC90)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsInterviewControl_TypeDefinitionIndex = 68455;
