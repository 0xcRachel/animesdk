...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL_METHOD_6_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0x122DD270)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL_METHOD_6_323F95926A2F616E_OFFSET UNITYSDK_OFFSET(0x122DD200)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL_METHOD_6_394DCF9DA306E923_OFFSET UNITYSDK_OFFSET(0x122DDA00)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL_METHOD_6_3D4F127F6B974E0C_OFFSET UNITYSDK_OFFSET(0x122DD830)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL_REFRESHREDDOTNODE_OFFSET UNITYSDK_OFFSET(0x122DD7E0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL_TRYMOVETONEWPOST_OFFSET UNITYSDK_OFFSET(0x122DD520)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL_TRYMOVETO_OFFSET UNITYSDK_OFFSET(0x122DD3C0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0x122DDFB0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x122DE010)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x122DCFA0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x122DCD80)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x122DE0A0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x122DE040)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL___TRYPLAYPOSTROWANIMATION_B__7_0_OFFSET UNITYSDK_OFFSET(0x122DE020)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsForumControl_TypeDefinitionIndex = 68454;
