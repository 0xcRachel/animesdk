...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL_METHOD_6_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0x9AA28B0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL_METHOD_6_192D2D35A79523B5_OFFSET UNITYSDK_OFFSET(0x9AA3020)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL_METHOD_6_323F95926A2F616E_OFFSET UNITYSDK_OFFSET(0x9AA2840)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL_METHOD_6_3D4F127F6B974E0C_OFFSET UNITYSDK_OFFSET(0x9AA2E50)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL_REFRESHREDDOTNODE_OFFSET UNITYSDK_OFFSET(0x9AA2E00)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL_TRYMOVETONEWPOST_OFFSET UNITYSDK_OFFSET(0x9AA2BC0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL_TRYMOVETO_OFFSET UNITYSDK_OFFSET(0x9AA2A00)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0x9AA3400)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x9AA3460)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AA25E0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AA23C0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AA34F0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AA3490)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL___TRYPLAYPOSTROWANIMATION_B__7_0_OFFSET UNITYSDK_OFFSET(0x9AA3470)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsForumControl_TypeDefinitionIndex = 61001;
