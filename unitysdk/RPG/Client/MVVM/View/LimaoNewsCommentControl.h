...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSCOMMENTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x95C16A0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSCOMMENTCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x95C1570)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSCOMMENTCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x95C1450)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSCOMMENTCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x95C1710)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSCOMMENTCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x95C16B0)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsCommentControl_TypeDefinitionIndex = 59220;
