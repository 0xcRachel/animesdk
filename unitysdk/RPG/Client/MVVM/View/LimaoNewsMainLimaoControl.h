...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL_INITENTITY_OFFSET UNITYSDK_OFFSET(0x122EDCE0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0x122EDF30)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0x122EE2D0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL_PLAYFREESTYLE_OFFSET UNITYSDK_OFFSET(0x122EE520)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL_SETEYEEMOTION_OFFSET UNITYSDK_OFFSET(0x122EDDD0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL_SETLOOKATTARGET_OFFSET UNITYSDK_OFFSET(0x122EDD70)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x122EE6E0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL__GETENTITY_OFFSET UNITYSDK_OFFSET(0x122EE640)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x122EDB60)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x122ED940)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL__PLAYENTITYDITHER_OFFSET UNITYSDK_OFFSET(0x122EE140)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL__PLAYFADEIN_G__ONTIMELINEAPPEARONSTOPPED_3_0_OFFSET UNITYSDK_OFFSET(0x122EE6F0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL__PLAYFADEOUT_G__ONTIMELINEDISAPPEARONSTOPPED_4_0_OFFSET UNITYSDK_OFFSET(0x122EE7B0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x122EE8D0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x122EE870)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsMainLimaoControl_TypeDefinitionIndex = 68439;
