...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL_INITENTITY_OFFSET UNITYSDK_OFFSET(0x9AAD670)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0x9AAD8C0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0x9AADC60)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL_PLAYFREESTYLE_OFFSET UNITYSDK_OFFSET(0x9AADEB0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL_SETEYEEMOTION_OFFSET UNITYSDK_OFFSET(0x9AAD760)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL_SETLOOKATTARGET_OFFSET UNITYSDK_OFFSET(0x9AAD700)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x9AAE070)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL__GETENTITY_OFFSET UNITYSDK_OFFSET(0x9AADFD0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AAD4E0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AAD2C0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL__PLAYENTITYDITHER_OFFSET UNITYSDK_OFFSET(0x9AADAD0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL__PLAYFADEIN_G__ONTIMELINEAPPEARONSTOPPED_3_0_OFFSET UNITYSDK_OFFSET(0x9AAE080)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL__PLAYFADEOUT_G__ONTIMELINEDISAPPEARONSTOPPED_4_0_OFFSET UNITYSDK_OFFSET(0x9AAE140)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AAE260)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AAE200)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsMainLimaoControl_TypeDefinitionIndex = 60986;
