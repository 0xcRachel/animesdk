...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL_INITENTITY_OFFSET UNITYSDK_OFFSET(0x95CC540)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0x95CC7F0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0x95CCBE0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL_PLAYFREESTYLE_OFFSET UNITYSDK_OFFSET(0x95CCE30)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL_SETEYEEMOTION_OFFSET UNITYSDK_OFFSET(0x95CC630)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL_SETLOOKATTARGET_OFFSET UNITYSDK_OFFSET(0x95CC5D0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x95CD020)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL__GETENTITY_OFFSET UNITYSDK_OFFSET(0x95CCFA0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x95CC3F0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x95CC200)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL__PLAYENTITYDITHER_OFFSET UNITYSDK_OFFSET(0x95CC9D0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL__PLAYFADEIN_G__ONTIMELINEAPPEARONSTOPPED_3_0_OFFSET UNITYSDK_OFFSET(0x95CD030)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL__PLAYFADEOUT_G__ONTIMELINEDISAPPEARONSTOPPED_4_0_OFFSET UNITYSDK_OFFSET(0x95CD0E0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x95CD200)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x95CD1A0)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsMainLimaoControl_TypeDefinitionIndex = 59234;
