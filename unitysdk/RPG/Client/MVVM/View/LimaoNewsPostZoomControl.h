...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_INIT_OFFSET UNITYSDK_OFFSET(0x122F79D0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_METHOD_6_073D39C3DB5A9C1F_OFFSET UNITYSDK_OFFSET(0x122F8200)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_METHOD_6_62588A1BBFF521EC_1_OFFSET UNITYSDK_OFFSET(0x122F92F0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_METHOD_6_62588A1BBFF521EC_OFFSET UNITYSDK_OFFSET(0x122F9220)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_METHOD_6_6D93101E4CE10A96_OFFSET UNITYSDK_OFFSET(0x122F8CB0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_METHOD_6_75B2F7652BAFC47F_OFFSET UNITYSDK_OFFSET(0x122F7BD0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_METHOD_6_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x122F7B30)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_METHOD_6_9D967D80C41C7781_OFFSET UNITYSDK_OFFSET(0x122F93B0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_METHOD_6_A77033F2447DC719_OFFSET UNITYSDK_OFFSET(0x122F9160)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_METHOD_6_E1CE0A1C7957700D_OFFSET UNITYSDK_OFFSET(0x122F8010)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_METHOD_6_E3ADA5CA2C064E44_OFFSET UNITYSDK_OFFSET(0x122F7E00)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_METHOD_6_E9A8695D8BBAA196_OFFSET UNITYSDK_OFFSET(0x122F9070)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x122F8870)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x122F8480)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_ONJOYSTICKPRESS_OFFSET UNITYSDK_OFFSET(0x122F7F00)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_ONJOYSTICKRELEASE_OFFSET UNITYSDK_OFFSET(0x122F8140)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_ONJOYSTICKZOOM_OFFSET UNITYSDK_OFFSET(0x122F7E70)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_ONMOUSEWHEELROLL_OFFSET UNITYSDK_OFFSET(0x122F7D70)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0x122F8C60)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x122F9400)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsPostZoomControl_TypeDefinitionIndex = 68479;
