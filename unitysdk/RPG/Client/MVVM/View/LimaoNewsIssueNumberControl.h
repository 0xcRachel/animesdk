...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUENUMBERCONTROL_METHOD_6_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x9AA9B00)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUENUMBERCONTROL_SETNUMBER_OFFSET UNITYSDK_OFFSET(0x9AA8910)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUENUMBERCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x9AA9BB0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUENUMBERCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AA99C0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUENUMBERCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AA97F0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUENUMBERCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AA9C20)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUENUMBERCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AA9BC0)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsIssueNumberControl_TypeDefinitionIndex = 61008;
