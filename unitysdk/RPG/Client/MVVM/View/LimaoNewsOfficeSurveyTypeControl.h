...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSOFFICESURVEYTYPECONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x95CD510)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSOFFICESURVEYTYPECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x95CD560)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSOFFICESURVEYTYPECONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x95CD3B0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSOFFICESURVEYTYPECONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x95CD260)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSOFFICESURVEYTYPECONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x95CD5D0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSOFFICESURVEYTYPECONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x95CD570)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsOfficeSurveyTypeControl_TypeDefinitionIndex = 59228;
