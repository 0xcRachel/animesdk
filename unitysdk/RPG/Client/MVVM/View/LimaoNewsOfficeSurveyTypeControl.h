...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSOFFICESURVEYTYPECONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x122EECF0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSOFFICESURVEYTYPECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x122EED60)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSOFFICESURVEYTYPECONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x122EEAB0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSOFFICESURVEYTYPECONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x122EE930)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSOFFICESURVEYTYPECONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x122EEDD0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSOFFICESURVEYTYPECONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x122EED70)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsOfficeSurveyTypeControl_TypeDefinitionIndex = 68433;
