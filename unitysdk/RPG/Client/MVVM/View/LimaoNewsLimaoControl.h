...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSLIMAOCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x9AAA8E0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSLIMAOCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AAA7C0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSLIMAOCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AAA6A0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSLIMAOCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AAA950)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSLIMAOCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AAA8F0)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsLimaoControl_TypeDefinitionIndex = 60978;
