...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSLIMAOCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x122EAE60)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSLIMAOCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x122EAD40)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSLIMAOCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x122EAC20)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSLIMAOCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x122EAED0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSLIMAOCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x122EAE70)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsLimaoControl_TypeDefinitionIndex = 68431;
