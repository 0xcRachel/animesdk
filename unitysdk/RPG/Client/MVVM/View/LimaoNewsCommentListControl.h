...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSCOMMENTLISTCONTROL_METHOD_6_8BA9E415415F5BBF_OFFSET UNITYSDK_OFFSET(0x122DBDC0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSCOMMENTLISTCONTROL_MOVETOCOMMENT_OFFSET UNITYSDK_OFFSET(0x122DBC80)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSCOMMENTLISTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x122DC060)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSCOMMENTLISTCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x122DBB30)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSCOMMENTLISTCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x122DB9C0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSCOMMENTLISTCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x122DC0D0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSCOMMENTLISTCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x122DC070)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsCommentListControl_TypeDefinitionIndex = 68426;
