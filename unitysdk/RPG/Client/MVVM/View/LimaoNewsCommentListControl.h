...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSCOMMENTLISTCONTROL_METHOD_6_8BA9E415415F5BBF_OFFSET UNITYSDK_OFFSET(0x9AA1400)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSCOMMENTLISTCONTROL_MOVETOCOMMENT_OFFSET UNITYSDK_OFFSET(0x9AA12C0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSCOMMENTLISTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x9AA16A0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSCOMMENTLISTCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AA1170)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSCOMMENTLISTCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AA1000)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSCOMMENTLISTCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AA1710)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSCOMMENTLISTCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AA16B0)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsCommentListControl_TypeDefinitionIndex = 60973;
