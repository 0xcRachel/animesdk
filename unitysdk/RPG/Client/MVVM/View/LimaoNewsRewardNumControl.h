...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSREWARDNUMCONTROL_SETREWARDID_OFFSET UNITYSDK_OFFSET(0x9AB4010)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSREWARDNUMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x9AB4060)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSREWARDNUMCONTROL__GETREWARDCOUNT_OFFSET UNITYSDK_OFFSET(0x9AB3F80)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSREWARDNUMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AB3EF0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSREWARDNUMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AB3E30)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSREWARDNUMCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AB40D0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSREWARDNUMCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AB4070)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsRewardNumControl_TypeDefinitionIndex = 60981;
