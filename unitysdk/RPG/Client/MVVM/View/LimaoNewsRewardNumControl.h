...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSREWARDNUMCONTROL_SETREWARDID_OFFSET UNITYSDK_OFFSET(0x95D1AC0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSREWARDNUMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x95D1B10)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSREWARDNUMCONTROL__GETREWARDCOUNT_OFFSET UNITYSDK_OFFSET(0x95D1A30)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSREWARDNUMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x95D19A0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSREWARDNUMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x95D1900)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSREWARDNUMCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x95D1B80)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSREWARDNUMCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x95D1B20)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsRewardNumControl_TypeDefinitionIndex = 59229;
