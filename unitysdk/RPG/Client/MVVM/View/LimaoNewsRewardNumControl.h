...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSREWARDNUMCONTROL_SETREWARDID_OFFSET UNITYSDK_OFFSET(0x122FAD60)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSREWARDNUMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x122FADB0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSREWARDNUMCONTROL__GETREWARDCOUNT_OFFSET UNITYSDK_OFFSET(0x122FACD0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSREWARDNUMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x122FAC40)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSREWARDNUMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x122FAB80)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSREWARDNUMCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x122FAE20)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSREWARDNUMCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x122FADC0)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsRewardNumControl_TypeDefinitionIndex = 68434;
