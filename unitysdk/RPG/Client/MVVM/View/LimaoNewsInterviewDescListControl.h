...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWDESCLISTCONTROL_METHOD_6_933A237F9F33FB1E_OFFSET UNITYSDK_OFFSET(0x9AA5420)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWDESCLISTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x9AA57C0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWDESCLISTCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AA5310)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWDESCLISTCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AA51F0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWDESCLISTCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AA5830)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWDESCLISTCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AA57D0)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsInterviewDescListControl_TypeDefinitionIndex = 60991;
