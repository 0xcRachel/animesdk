...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWDESCLISTCONTROL_METHOD_6_933A237F9F33FB1E_OFFSET UNITYSDK_OFFSET(0x95C5940)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWDESCLISTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x95C5CE0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWDESCLISTCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x95C5830)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWDESCLISTCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x95C5710)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWDESCLISTCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x95C5D50)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWDESCLISTCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x95C5CF0)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsInterviewDescListControl_TypeDefinitionIndex = 59239;
