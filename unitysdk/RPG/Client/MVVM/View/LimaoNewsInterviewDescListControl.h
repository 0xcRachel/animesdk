...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWDESCLISTCONTROL_METHOD_6_933A237F9F33FB1E_OFFSET UNITYSDK_OFFSET(0x122DFFD0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWDESCLISTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x122E0370)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWDESCLISTCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x122DFEC0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWDESCLISTCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x122DFDA0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWDESCLISTCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x122E03E0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWDESCLISTCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x122E0380)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsInterviewDescListControl_TypeDefinitionIndex = 68444;
