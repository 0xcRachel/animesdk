...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUESUBMITWINDOW_METHOD_2_323F95926A2F616E_OFFSET UNITYSDK_OFFSET(0x122E9B40)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUESUBMITWINDOW_METHOD_2_CFC95121222309BD_OFFSET UNITYSDK_OFFSET(0x122E9C00)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUESUBMITWINDOW_METHOD_2_DE70BFBC2BB426D0_OFFSET UNITYSDK_OFFSET(0x122E9CA0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUESUBMITWINDOW__CTOR_OFFSET UNITYSDK_OFFSET(0x122E8E90)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUESUBMITWINDOW__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x122E9320)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUESUBMITWINDOW__ONEXITFINALSTEP_OFFSET UNITYSDK_OFFSET(0x122E9BB0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUESUBMITWINDOW__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x122E8F30)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUESUBMITWINDOW___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x122EA0F0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUESUBMITWINDOW___IFIXBASEPROXY__ONEXITFINALSTEP_OFFSET UNITYSDK_OFFSET(0x122EA150)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUESUBMITWINDOW___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x122EA090)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsIssueSubmitWindow_TypeDefinitionIndex = 68452;

	class LimaoNewsIssueSubmitWindow : public ::Sofa::BaseSofaWindow
	{
	public:
		::RPG::Client::MonoAnimationTrigger* Field_2_5; // 0x40
		::System::Collections::Generic::List_1<::RPG::Client::MVVM::View::LimaoNewsCommentControl*>* Field_2_3; // 0x48
		::RPG::Client::AnimatorButton* Field_2_2; // 0x50
		::Class_1_029A7EDCBF9933C8* Field_2_1; // 0x58
