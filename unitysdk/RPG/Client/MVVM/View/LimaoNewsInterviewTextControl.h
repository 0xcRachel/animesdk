...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWTEXTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x122E3CD0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWTEXTCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x122E3B80)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWTEXTCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x122E3AC0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWTEXTCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x122E3D40)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWTEXTCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x122E3CE0)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsInterviewTextControl_TypeDefinitionIndex = 68450;
