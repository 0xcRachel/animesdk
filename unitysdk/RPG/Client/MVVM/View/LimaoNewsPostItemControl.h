...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x95CFD70)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTITEMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x95CF650)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x95CF3C0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTITEMCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x95CFDE0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTITEMCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x95CFD80)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsPostItemControl_TypeDefinitionIndex = 59261;
