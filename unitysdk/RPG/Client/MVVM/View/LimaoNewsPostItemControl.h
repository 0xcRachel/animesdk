...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x9AB11C0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTITEMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AB0A30)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AB07A0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTITEMCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AB1230)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTITEMCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AB11D0)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsPostItemControl_TypeDefinitionIndex = 61014;
