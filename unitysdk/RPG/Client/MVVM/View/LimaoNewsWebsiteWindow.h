...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSWEBSITEWINDOW_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AB9A70)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSWEBSITEWINDOW__CTOR_OFFSET UNITYSDK_OFFSET(0x9AB7630)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSWEBSITEWINDOW__EXITVIEW_OFFSET UNITYSDK_OFFSET(0x9AB9D10)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSWEBSITEWINDOW__INITNAVIGATIONTARGET_OFFSET UNITYSDK_OFFSET(0x9AB9890)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSWEBSITEWINDOW__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AB81F0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSWEBSITEWINDOW__ONENTRANCEANIMEND_OFFSET UNITYSDK_OFFSET(0x9AB9AE0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSWEBSITEWINDOW__ONEXITFINALSTEP_OFFSET UNITYSDK_OFFSET(0x9AB9E50)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSWEBSITEWINDOW__ONINCONTROLEXIT_OFFSET UNITYSDK_OFFSET(0x9AB9CC0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSWEBSITEWINDOW__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AB76E0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSWEBSITEWINDOW__ONLIMAONEWSCLOSEWEBSITE_OFFSET UNITYSDK_OFFSET(0x9ABA950)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSWEBSITEWINDOW__ONLIMAONEWSFORUMOPERATION_OFFSET UNITYSDK_OFFSET(0x9ABA160)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSWEBSITEWINDOW__ONLIMAONEWSREFRESHUPVOTE_OFFSET UNITYSDK_OFFSET(0x9ABA700)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSWEBSITEWINDOW__ONLIMAONEWSREPLAYPOST_OFFSET UNITYSDK_OFFSET(0x9ABA110)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSWEBSITEWINDOW__ONLIMAONEWSSUBMITISSUE_OFFSET UNITYSDK_OFFSET(0x9AB9FA0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSWEBSITEWINDOW__ONLIMAONEWSSUBMITPOST_OFFSET UNITYSDK_OFFSET(0x9ABA010)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSWEBSITEWINDOW__ONREFRESHREDDOT_OFFSET UNITYSDK_OFFSET(0x9ABA420)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSWEBSITEWINDOW__REFRESHREDDOTNODE_OFFSET UNITYSDK_OFFSET(0x9ABA470)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSWEBSITEWINDOW__REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x9AB9060)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSWEBSITEWINDOW__SUBSCRIBEMESSAGE_OFFSET UNITYSDK_OFFSET(0x9AB8140)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSWEBSITEWINDOW___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9ABAAB0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSWEBSITEWINDOW___IFIXBASEPROXY__ONENTRANCEANIMEND_OFFSET UNITYSDK_OFFSET(0x9ABAB10)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSWEBSITEWINDOW___IFIXBASEPROXY__ONEXITFINALSTEP_OFFSET UNITYSDK_OFFSET(0x9ABABA0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSWEBSITEWINDOW___IFIXBASEPROXY__ONINCONTROLEXIT_OFFSET UNITYSDK_OFFSET(0x9ABAB90)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSWEBSITEWINDOW___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9ABAA50)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSWEBSITEWINDOW___SUBSCRIBEMESSAGE_B__8_0_OFFSET UNITYSDK_OFFSET(0x9ABA9E0)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsWebsiteWindow_TypeDefinitionIndex = 61022;

	class LimaoNewsWebsiteWindow : public ::Sofa::BaseSofaWindow
	{
	public:
		::UnityEngine::Transform* _NodeBtnIssueTag; // 0x40
		::UnityEngine::Transform* _NodeIssueRedDot; // 0x48
		::RPG::Client::MVVM::View::LimaoNewsIssueControl* _IssueControl; // 0x50
		::RPG::Client::MVVM::View::LimaoNewsSponsorControl* _SponsorControl; // 0x58
		::RPG::Client::UIMeta* _UIMeta; // 0x60
		::RPG::Client::AnimatorButton* _BtnIssue; // 0x68
		::UnityEngine::Transform* _NodeForumRedDotPoint; // 0x70
		::Class_1_0BA5D98E0F73DDB8* _Messenger; // 0x78
		::RPG::Client::AnimatorButton* _BtnForum; // 0x80
		::UnityEngine::Transform* _NodeForumRedDotNew; // 0x88
		::RPG::UINavigation::UINavigationZone* _NavigationZone; // 0x90
		::RPG::Client::MVVM::View::LimaoNewsForumControl* _ForumControl; // 0x98
		::RPG::Client::MonoPrefabSwitcher* _MonoPrefabSwitcher; // 0xA0
		::RPG::Client::AnimatorButton* _BtnClose; // 0xA8
		::UnityEngine::Transform* _NodeBtnForumTag; // 0xB0
		::UnityEngine::Transform* _NodeForumRedDot; // 0xB8
