...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSUBMITLEVELCONTROL_METHOD_6_071850D2764E9D4C_OFFSET UNITYSDK_OFFSET(0x9AB6830)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSUBMITLEVELCONTROL_METHOD_6_323F95926A2F616E_OFFSET UNITYSDK_OFFSET(0x9AB5C80)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSUBMITLEVELCONTROL_METHOD_6_51D4C4EE6EA0D8EF_OFFSET UNITYSDK_OFFSET(0x9AB6640)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSUBMITLEVELCONTROL_METHOD_6_554044C88588C5A0_OFFSET UNITYSDK_OFFSET(0x9AB6470)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSUBMITLEVELCONTROL_METHOD_6_69AB3F506C73DE73_OFFSET UNITYSDK_OFFSET(0x9AB5CF0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSUBMITLEVELCONTROL_METHOD_6_CDA8A3F6E2C03F05_OFFSET UNITYSDK_OFFSET(0x9AB67B0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSUBMITLEVELCONTROL_PLAYLEVELCHANGEANIMATION_OFFSET UNITYSDK_OFFSET(0x9AB1F00)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSUBMITLEVELCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x9AB6C40)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSUBMITLEVELCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AB5FD0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSUBMITLEVELCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AB57C0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSUBMITLEVELCONTROL__PLAYFIRECHANGEANIMATION_OFFSET UNITYSDK_OFFSET(0x9AB5F40)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSUBMITLEVELCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AB6CB0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSUBMITLEVELCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AB6C50)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsSubmitLevelControl_TypeDefinitionIndex = 61020;
