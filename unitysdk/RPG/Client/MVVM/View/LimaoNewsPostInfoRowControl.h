...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTINFOROWCONTROL_METHOD_6_A62231621CE60BD0_OFFSET UNITYSDK_OFFSET(0x9AB02D0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTINFOROWCONTROL_METHOD_6_B2C52ACF9D9B435B_OFFSET UNITYSDK_OFFSET(0x9AB0150)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTINFOROWCONTROL_METHOD_6_F7300E87EC49A206_OFFSET UNITYSDK_OFFSET(0x9AB0530)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTINFOROWCONTROL_PLAYADDANIMATION_OFFSET UNITYSDK_OFFSET(0x9AB0270)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTINFOROWCONTROL_PLAYFADEINANIMATION_OFFSET UNITYSDK_OFFSET(0x9AB0470)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTINFOROWCONTROL_PLAYLIKENUMANIMATION_OFFSET UNITYSDK_OFFSET(0x9AB04D0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTINFOROWCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x9AB05F0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTINFOROWCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AAF0C0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTINFOROWCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AAE7C0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTINFOROWCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AB0660)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTINFOROWCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AB0600)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsPostInfoRowControl_TypeDefinitionIndex = 61011;
