...
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA_GETCANTAKEREWARDSCORELEVELLIST_OFFSET UNITYSDK_OFFSET(0x1744CFD0)
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA_GETNEXTSPECIALREWARDLEVELCONFIG_OFFSET UNITYSDK_OFFSET(0x1744C860)
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA_GETTAKENREWARDSCORELEVELLIST_OFFSET UNITYSDK_OFFSET(0x1744D110)
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA_GET_CUREXPMAXNUM_OFFSET UNITYSDK_OFFSET(0x1744C710)
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA_GET_CUREXPNUM_OFFSET UNITYSDK_OFFSET(0x1744C6F0)
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA_GET_CURLEVEL_OFFSET UNITYSDK_OFFSET(0x1744C790)
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA_GET_ISMAXLEVEL_OFFSET UNITYSDK_OFFSET(0x1744C7B0)
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA_GET_OFFERINGREWARDDATA_OFFSET UNITYSDK_OFFSET(0x1744C6D0)
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA_GET_SEENMAXLEVEL_OFFSET UNITYSDK_OFFSET(0x1744C7E0)
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA_GET_TOTALLEFTEXPNUM_OFFSET UNITYSDK_OFFSET(0x1744C730)
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA_HASREWARDCANTAKEAFTERLEVEL_OFFSET UNITYSDK_OFFSET(0x1744CC60)
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA_HASREWARDCANTAKEBEFORELEVEL_OFFSET UNITYSDK_OFFSET(0x1744CB70)
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA_HASREWARDISNEWAFTERLEVEL_OFFSET UNITYSDK_OFFSET(0x1744CD40)
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA_ISREWARDISNEW_OFFSET UNITYSDK_OFFSET(0x1744CE30)
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA_SETSEENMAXLEVEL_OFFSET UNITYSDK_OFFSET(0x1744CEE0)
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA_SET_OFFERINGREWARDDATA_OFFSET UNITYSDK_OFFSET(0x1744C6E0)
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA_TAKEREWARDBEFORELEVEL_OFFSET UNITYSDK_OFFSET(0x1744C960)
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1744C850)
