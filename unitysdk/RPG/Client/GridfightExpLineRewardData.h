...
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA_GETCANTAKEREWARDSCORELEVELLIST_OFFSET UNITYSDK_OFFSET(0x98F7EB0)
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA_GETNEXTSPECIALREWARDLEVELCONFIG_OFFSET UNITYSDK_OFFSET(0x98F7740)
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA_GETTAKENREWARDSCORELEVELLIST_OFFSET UNITYSDK_OFFSET(0x98F7FF0)
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA_GET_CUREXPMAXNUM_OFFSET UNITYSDK_OFFSET(0x98F75F0)
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA_GET_CUREXPNUM_OFFSET UNITYSDK_OFFSET(0x98F75D0)
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA_GET_CURLEVEL_OFFSET UNITYSDK_OFFSET(0x98F7670)
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA_GET_ISMAXLEVEL_OFFSET UNITYSDK_OFFSET(0x98F7690)
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA_GET_OFFERINGREWARDDATA_OFFSET UNITYSDK_OFFSET(0x98F75B0)
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA_GET_SEENMAXLEVEL_OFFSET UNITYSDK_OFFSET(0x98F76C0)
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA_GET_TOTALLEFTEXPNUM_OFFSET UNITYSDK_OFFSET(0x98F7610)
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA_HASREWARDCANTAKEAFTERLEVEL_OFFSET UNITYSDK_OFFSET(0x98F7B40)
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA_HASREWARDCANTAKEBEFORELEVEL_OFFSET UNITYSDK_OFFSET(0x98F7A50)
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA_HASREWARDISNEWAFTERLEVEL_OFFSET UNITYSDK_OFFSET(0x98F7C20)
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA_ISREWARDISNEW_OFFSET UNITYSDK_OFFSET(0x98F7D10)
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA_SETSEENMAXLEVEL_OFFSET UNITYSDK_OFFSET(0x98F7DC0)
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA_SET_OFFERINGREWARDDATA_OFFSET UNITYSDK_OFFSET(0x98F75C0)
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA_TAKEREWARDBEFORELEVEL_OFFSET UNITYSDK_OFFSET(0x98F7840)
#define RPG_CLIENT_GRIDFIGHTEXPLINEREWARDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x98F7730)
