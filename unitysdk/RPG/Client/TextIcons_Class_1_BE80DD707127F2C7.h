...
#define RPG_CLIENT_TEXTICONS_CLASS_1_BE80DD707127F2C7_BUILD_OFFSET UNITYSDK_OFFSET(0x105624A0)
#define RPG_CLIENT_TEXTICONS_CLASS_1_BE80DD707127F2C7_GETICONASPECTS_OFFSET UNITYSDK_OFFSET(0x10562450)
#define RPG_CLIENT_TEXTICONS_CLASS_1_BE80DD707127F2C7__CTOR_OFFSET UNITYSDK_OFFSET(0x1055C320)

namespace RPG::Client
{
	inline static constexpr unsigned int TextIcons_Class_1_BE80DD707127F2C7_TypeDefinitionIndex = 66962;
