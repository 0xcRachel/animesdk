...
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_AWAKE_OFFSET UNITYSDK_OFFSET(0x9186CD0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_CLEARCAMERADITHERALPHA_OFFSET UNITYSDK_OFFSET(0x91867F0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_CLEARDITHERALPHA_OFFSET UNITYSDK_OFFSET(0x9186700)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x91874B0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GETCURRENTDITHERALPHA_OFFSET UNITYSDK_OFFSET(0x9185B10)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GETDITHERANIMTIME_OFFSET UNITYSDK_OFFSET(0x9185BC0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GETDITHERTRANSITIONINFO_OFFSET UNITYSDK_OFFSET(0x9185CA0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GETOWNERENTITY_OFFSET UNITYSDK_OFFSET(0x9186C30)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GETTARGETDITHERALPHA_OFFSET UNITYSDK_OFFSET(0x9185B60)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GET_DITHERTIMESCALE_OFFSET UNITYSDK_OFFSET(0x9187960)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GET_GORENDERERCACHE_OFFSET UNITYSDK_OFFSET(0x9187950)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GET_ISFORBIDCAMERADITHER_OFFSET UNITYSDK_OFFSET(0x9187980)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_ISDITHERANIMFINISH_OFFSET UNITYSDK_OFFSET(0x9185C40)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_LATETICK_OFFSET UNITYSDK_OFFSET(0x91871C0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_288B0CA3C3E003D9_OFFSET UNITYSDK_OFFSET(0x9186520)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_40F411C01C4CB2C1_OFFSET UNITYSDK_OFFSET(0x9185DF0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x9186660)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_51BBA01F511E6107_OFFSET UNITYSDK_OFFSET(0x9187340)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_56A14AED8987ABED_OFFSET UNITYSDK_OFFSET(0x91876B0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_82E992240300FB30_OFFSET UNITYSDK_OFFSET(0x91868B0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_8B320F9C06FC45D4_OFFSET UNITYSDK_OFFSET(0x9187880)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_ACF73F91E2376FA4_OFFSET UNITYSDK_OFFSET(0x91875E0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_EBAC71FBE1837205_OFFSET UNITYSDK_OFFSET(0x9186ED0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9186D70)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_ONREFRESHMATERIALS_OFFSET UNITYSDK_OFFSET(0x91873E0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_RESET_OFFSET UNITYSDK_OFFSET(0x9186DC0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETDISTANCEDITHERALPHAVALUE_OFFSET UNITYSDK_OFFSET(0x91860D0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETDITHERALPHAVALUEWITHANIMATION_OFFSET UNITYSDK_OFFSET(0x9186200)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETDITHERALPHAVALUE_OFFSET UNITYSDK_OFFSET(0x9186170)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETDITHERTIMESCALE_OFFSET UNITYSDK_OFFSET(0x9186C70)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETELEVATIONDITHERALPHAVALUE_OFFSET UNITYSDK_OFFSET(0x9185D60)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETFINISHCURRENTDITHERTRANSITIONIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0x91865D0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETOWNERENTITY_OFFSET UNITYSDK_OFFSET(0x9186B10)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SET_DITHERTIMESCALE_OFFSET UNITYSDK_OFFSET(0x9187970)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_START_OFFSET UNITYSDK_OFFSET(0x9186D30)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_TICK_OFFSET UNITYSDK_OFFSET(0x9187180)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x9187A00)
