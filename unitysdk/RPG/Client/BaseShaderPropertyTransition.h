...
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_AWAKE_OFFSET UNITYSDK_OFFSET(0xF39BB60)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_CLEARCAMERADITHERALPHA_OFFSET UNITYSDK_OFFSET(0xF39B680)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_CLEARDITHERALPHA_OFFSET UNITYSDK_OFFSET(0xF39B590)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_DISPOSE_OFFSET UNITYSDK_OFFSET(0xF39C330)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GETCURRENTDITHERALPHA_OFFSET UNITYSDK_OFFSET(0xF39A9A0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GETDITHERANIMTIME_OFFSET UNITYSDK_OFFSET(0xF39AA50)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GETDITHERTRANSITIONINFO_OFFSET UNITYSDK_OFFSET(0xF39AB30)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GETOWNERENTITY_OFFSET UNITYSDK_OFFSET(0xF39BAC0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GETTARGETDITHERALPHA_OFFSET UNITYSDK_OFFSET(0xF39A9F0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GET_DITHERTIMESCALE_OFFSET UNITYSDK_OFFSET(0xF39C7E0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GET_GORENDERERCACHE_OFFSET UNITYSDK_OFFSET(0xF39C7D0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GET_ISFORBIDCAMERADITHER_OFFSET UNITYSDK_OFFSET(0xF39C800)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_ISDITHERANIMFINISH_OFFSET UNITYSDK_OFFSET(0xF39AAD0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_LATETICK_OFFSET UNITYSDK_OFFSET(0xF39C040)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_288B0CA3C3E003D9_OFFSET UNITYSDK_OFFSET(0xF39B3B0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_40F411C01C4CB2C1_OFFSET UNITYSDK_OFFSET(0xF39AC80)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xF39B4F0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_51BBA01F511E6107_OFFSET UNITYSDK_OFFSET(0xF39C1C0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_56A14AED8987ABED_OFFSET UNITYSDK_OFFSET(0xF39C530)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_82E992240300FB30_OFFSET UNITYSDK_OFFSET(0xF39B740)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_8B320F9C06FC45D4_OFFSET UNITYSDK_OFFSET(0xF39C700)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_ACF73F91E2376FA4_OFFSET UNITYSDK_OFFSET(0xF39C460)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_EBAC71FBE1837205_OFFSET UNITYSDK_OFFSET(0xF39BD50)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xF39BC00)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_ONREFRESHMATERIALS_OFFSET UNITYSDK_OFFSET(0xF39C260)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_RESET_OFFSET UNITYSDK_OFFSET(0xF39BC50)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETDISTANCEDITHERALPHAVALUE_OFFSET UNITYSDK_OFFSET(0xF39AF60)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETDITHERALPHAVALUEWITHANIMATION_OFFSET UNITYSDK_OFFSET(0xF39B090)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETDITHERALPHAVALUE_OFFSET UNITYSDK_OFFSET(0xF39B000)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETDITHERTIMESCALE_OFFSET UNITYSDK_OFFSET(0xF39BB00)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETELEVATIONDITHERALPHAVALUE_OFFSET UNITYSDK_OFFSET(0xF39ABF0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETFINISHCURRENTDITHERTRANSITIONIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0xF39B460)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETOWNERENTITY_OFFSET UNITYSDK_OFFSET(0xF39B9A0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SET_DITHERTIMESCALE_OFFSET UNITYSDK_OFFSET(0xF39C7F0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_START_OFFSET UNITYSDK_OFFSET(0xF39BBC0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_TICK_OFFSET UNITYSDK_OFFSET(0xF39C000)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0xF39C880)
