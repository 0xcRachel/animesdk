...
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_AWAKE_OFFSET UNITYSDK_OFFSET(0x8D7BCA0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_CLEARCAMERADITHERALPHA_OFFSET UNITYSDK_OFFSET(0x8D7B7C0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_CLEARDITHERALPHA_OFFSET UNITYSDK_OFFSET(0x8D7B6D0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8D7C470)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GETCURRENTDITHERALPHA_OFFSET UNITYSDK_OFFSET(0x8D7AAE0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GETDITHERANIMTIME_OFFSET UNITYSDK_OFFSET(0x8D7AB90)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GETDITHERTRANSITIONINFO_OFFSET UNITYSDK_OFFSET(0x8D7AC70)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GETOWNERENTITY_OFFSET UNITYSDK_OFFSET(0x8D7BC00)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GETTARGETDITHERALPHA_OFFSET UNITYSDK_OFFSET(0x8D7AB30)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GET_DITHERTIMESCALE_OFFSET UNITYSDK_OFFSET(0x8D7C920)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GET_GORENDERERCACHE_OFFSET UNITYSDK_OFFSET(0x8D7C910)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GET_ISFORBIDCAMERADITHER_OFFSET UNITYSDK_OFFSET(0x8D7C940)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_ISDITHERANIMFINISH_OFFSET UNITYSDK_OFFSET(0x8D7AC10)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_LATETICK_OFFSET UNITYSDK_OFFSET(0x8D7C180)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_288B0CA3C3E003D9_OFFSET UNITYSDK_OFFSET(0x8D7B4F0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_40F411C01C4CB2C1_OFFSET UNITYSDK_OFFSET(0x8D7ADC0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x8D7B630)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_51BBA01F511E6107_OFFSET UNITYSDK_OFFSET(0x8D7C300)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_56A14AED8987ABED_OFFSET UNITYSDK_OFFSET(0x8D7C670)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_82E992240300FB30_OFFSET UNITYSDK_OFFSET(0x8D7B880)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_8B320F9C06FC45D4_OFFSET UNITYSDK_OFFSET(0x8D7C840)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_ACF73F91E2376FA4_OFFSET UNITYSDK_OFFSET(0x8D7C5A0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_EBAC71FBE1837205_OFFSET UNITYSDK_OFFSET(0x8D7BE90)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x8D7BD40)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_ONREFRESHMATERIALS_OFFSET UNITYSDK_OFFSET(0x8D7C3A0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_RESET_OFFSET UNITYSDK_OFFSET(0x8D7BD90)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETDISTANCEDITHERALPHAVALUE_OFFSET UNITYSDK_OFFSET(0x8D7B0A0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETDITHERALPHAVALUEWITHANIMATION_OFFSET UNITYSDK_OFFSET(0x8D7B1D0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETDITHERALPHAVALUE_OFFSET UNITYSDK_OFFSET(0x8D7B140)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETDITHERTIMESCALE_OFFSET UNITYSDK_OFFSET(0x8D7BC40)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETELEVATIONDITHERALPHAVALUE_OFFSET UNITYSDK_OFFSET(0x8D7AD30)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETFINISHCURRENTDITHERTRANSITIONIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0x8D7B5A0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETOWNERENTITY_OFFSET UNITYSDK_OFFSET(0x8D7BAE0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SET_DITHERTIMESCALE_OFFSET UNITYSDK_OFFSET(0x8D7C930)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_START_OFFSET UNITYSDK_OFFSET(0x8D7BD00)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_TICK_OFFSET UNITYSDK_OFFSET(0x8D7C140)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x8D7C9C0)

namespace RPG::Client
{
	inline static constexpr unsigned int BaseShaderPropertyTransition_TypeDefinitionIndex = 54689;
