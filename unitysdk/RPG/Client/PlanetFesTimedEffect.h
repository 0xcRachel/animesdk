...
#define RPG_CLIENT_PLANETFESTIMEDEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x17DCBED0)
#define RPG_CLIENT_PLANETFESTIMEDEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0x17DCBF10)
#define RPG_CLIENT_PLANETFESTIMEDEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0x17DCBF60)
#define RPG_CLIENT_PLANETFESTIMEDEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0x17DCBE90)
#define RPG_CLIENT_PLANETFESTIMEDEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x17DCC0D0)
