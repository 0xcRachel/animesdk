...
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_CASTSINGLETARGET_OFFSET UNITYSDK_OFFSET(0x982F860)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_GET_TARGETGROUPID_OFFSET UNITYSDK_OFFSET(0x9830180)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_GET_TARGETINSTANCEID_OFFSET UNITYSDK_OFFSET(0x9830190)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_GET_TARGETTYPE_OFFSET UNITYSDK_OFFSET(0x9830170)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_METHOD_6_00A4B38C951C5BD5_OFFSET UNITYSDK_OFFSET(0x982F0D0)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_METHOD_6_0AB718BEE9EA06D7_OFFSET UNITYSDK_OFFSET(0x982F540)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_METHOD_6_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x982F1A0)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_METHOD_6_5022DB1DC5AA8CB4_OFFSET UNITYSDK_OFFSET(0x982F450)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_METHOD_6_508D4DD02D3DB74E_OFFSET UNITYSDK_OFFSET(0x982F6D0)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_METHOD_6_8422ABC65E83BF12_OFFSET UNITYSDK_OFFSET(0x982F2B0)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_METHOD_6_AB389C69D231955F_OFFSET UNITYSDK_OFFSET(0x982F630)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_METHOD_6_C2B13F505CA2DA54_OFFSET UNITYSDK_OFFSET(0x982FE80)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_METHOD_6_CEA992B6DEFDAF0A_OFFSET UNITYSDK_OFFSET(0x982F200)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_METHOD_6_E30A0CB4AE5808EA_OFFSET UNITYSDK_OFFSET(0x982FD20)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x9830120)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_OVERLAPPOINT_OFFSET UNITYSDK_OFFSET(0x982FC00)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_SETUPGEOMETRYREGION_OFFSET UNITYSDK_OFFSET(0x982F010)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_TICK_OFFSET UNITYSDK_OFFSET(0x982F7A0)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x98301A0)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER___IFIXBASEPROXY_OVERLAPPOINT_OFFSET UNITYSDK_OFFSET(0x98301B0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoGeometryTrigger_TypeDefinitionIndex = 54739;

	class MonoGeometryTrigger : public ::RPG::Client::BaseMonoTriggerRegion
	{
	public:
		::Class_0_16E4307DCC419505_718* Field_6_0; // 0x20
