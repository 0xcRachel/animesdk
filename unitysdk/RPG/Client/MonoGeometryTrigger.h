...
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_CASTSINGLETARGET_OFFSET UNITYSDK_OFFSET(0x11697B50)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_GET_TARGETGROUPID_OFFSET UNITYSDK_OFFSET(0x11698480)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_GET_TARGETINSTANCEID_OFFSET UNITYSDK_OFFSET(0x11698490)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_GET_TARGETTYPE_OFFSET UNITYSDK_OFFSET(0x11698470)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_METHOD_6_00A4B38C951C5BD5_OFFSET UNITYSDK_OFFSET(0x116973C0)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_METHOD_6_0AB718BEE9EA06D7_OFFSET UNITYSDK_OFFSET(0x11697830)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_METHOD_6_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x11697490)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_METHOD_6_5022DB1DC5AA8CB4_OFFSET UNITYSDK_OFFSET(0x11697740)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_METHOD_6_508D4DD02D3DB74E_OFFSET UNITYSDK_OFFSET(0x116979C0)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_METHOD_6_8422ABC65E83BF12_OFFSET UNITYSDK_OFFSET(0x116975A0)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_METHOD_6_AB389C69D231955F_OFFSET UNITYSDK_OFFSET(0x11697920)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_METHOD_6_C2B13F505CA2DA54_OFFSET UNITYSDK_OFFSET(0x11698170)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_METHOD_6_CEA992B6DEFDAF0A_OFFSET UNITYSDK_OFFSET(0x116974F0)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_METHOD_6_E30A0CB4AE5808EA_OFFSET UNITYSDK_OFFSET(0x11698010)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x11698420)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_OVERLAPPOINT_OFFSET UNITYSDK_OFFSET(0x11697EF0)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_SETUPGEOMETRYREGION_OFFSET UNITYSDK_OFFSET(0x11697300)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_TICK_OFFSET UNITYSDK_OFFSET(0x11697A90)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x116984A0)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER___IFIXBASEPROXY_OVERLAPPOINT_OFFSET UNITYSDK_OFFSET(0x116984B0)
