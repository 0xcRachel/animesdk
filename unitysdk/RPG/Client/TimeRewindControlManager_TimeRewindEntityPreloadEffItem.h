...
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER_TIMEREWINDENTITYPRELOADEFFITEM_ADDCNT_OFFSET UNITYSDK_OFFSET(0xA5B8FD0)
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER_TIMEREWINDENTITYPRELOADEFFITEM_CLEAR_OFFSET UNITYSDK_OFFSET(0xA5B8CD0)
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER_TIMEREWINDENTITYPRELOADEFFITEM_FINISHEFFECT_OFFSET UNITYSDK_OFFSET(0xA5B8C40)
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER_TIMEREWINDENTITYPRELOADEFFITEM_FIREEFFECTASYNC_OFFSET UNITYSDK_OFFSET(0xA5B8BB0)
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER_TIMEREWINDENTITYPRELOADEFFITEM_GET_EFFCNT_OFFSET UNITYSDK_OFFSET(0xA5B9160)
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER_TIMEREWINDENTITYPRELOADEFFITEM_GET_EFFPATH_OFFSET UNITYSDK_OFFSET(0xA5B9120)
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER_TIMEREWINDENTITYPRELOADEFFITEM_GET_LOADSTATE_OFFSET UNITYSDK_OFFSET(0xA5B9140)
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER_TIMEREWINDENTITYPRELOADEFFITEM_INITITEM_OFFSET UNITYSDK_OFFSET(0xA5B8D70)
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER_TIMEREWINDENTITYPRELOADEFFITEM_LOAD_OFFSET UNITYSDK_OFFSET(0xA5B8E30)
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER_TIMEREWINDENTITYPRELOADEFFITEM_SET_EFFCNT_OFFSET UNITYSDK_OFFSET(0xA5B9170)
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER_TIMEREWINDENTITYPRELOADEFFITEM_SET_EFFPATH_OFFSET UNITYSDK_OFFSET(0xA5B9130)
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER_TIMEREWINDENTITYPRELOADEFFITEM_SET_LOADSTATE_OFFSET UNITYSDK_OFFSET(0xA5B9150)
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER_TIMEREWINDENTITYPRELOADEFFITEM_UNLOAD_OFFSET UNITYSDK_OFFSET(0xA5B9180)
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER_TIMEREWINDENTITYPRELOADEFFITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xA5B9920)
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER_TIMEREWINDENTITYPRELOADEFFITEM__ONEFFLOADCOMPLETE_OFFSET UNITYSDK_OFFSET(0xA5B93E0)
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER_TIMEREWINDENTITYPRELOADEFFITEM__ONEFFSOLOADED_OFFSET UNITYSDK_OFFSET(0xA5B9890)
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER_TIMEREWINDENTITYPRELOADEFFITEM__ONLOADEND_OFFSET UNITYSDK_OFFSET(0xA5B9820)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(TimeRewindControlManager_TimeRewindEntityPreloadEffItem_TypeDefinitionIndex)->GetStaticField(0x10640);
		}
		...
		::Class_1_DD81253E160EB8B2* _FireEffectHandler; // 0x28
