...
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_GET_AABB_OFFSET UNITYSDK_OFFSET(0x14AB5D10)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_GET_CONTAINWINDTRIGGERSCOUNT_OFFSET UNITYSDK_OFFSET(0x14AB5D60)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_GET_SELECTED_OFFSET UNITYSDK_OFFSET(0x14AB5CF0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_GET_WINDVELOCITY_OFFSET UNITYSDK_OFFSET(0x14AB5D40)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0x14AB7AC0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_146E6E50FAF07D8F_OFFSET UNITYSDK_OFFSET(0x14AB9470)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_2CBE0B79DD36047E_OFFSET UNITYSDK_OFFSET(0x14AB8E60)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_2F2B436D8A949630_OFFSET UNITYSDK_OFFSET(0x14AB9290)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x14ABA330)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x14ABA2C0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_4DA6D4A624E42CAB_OFFSET UNITYSDK_OFFSET(0x14AB91E0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0x14ABA4F0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5790A55946AA509D_2_OFFSET UNITYSDK_OFFSET(0x14ABA550)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5790A55946AA509D_3_OFFSET UNITYSDK_OFFSET(0x14ABA5B0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5790A55946AA509D_4_OFFSET UNITYSDK_OFFSET(0x14ABA610)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5790A55946AA509D_5_OFFSET UNITYSDK_OFFSET(0x14ABA680)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x14ABA490)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5BCE9210F4ACDD0B_1_OFFSET UNITYSDK_OFFSET(0x14AB9A00)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5BCE9210F4ACDD0B_OFFSET UNITYSDK_OFFSET(0x14AB5DD0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5FAD56E9E208220A_OFFSET UNITYSDK_OFFSET(0x14AB9E70)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_6041E775D6263614_OFFSET UNITYSDK_OFFSET(0x14AB9310)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_66CC9828DB1F478F_OFFSET UNITYSDK_OFFSET(0x14ABA190)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_89EF21CA0414B145_OFFSET UNITYSDK_OFFSET(0x14AB8B70)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_921C3C3E09D59CD4_OFFSET UNITYSDK_OFFSET(0x14AB9EF0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_B7CCB99AAB7A4C8B_OFFSET UNITYSDK_OFFSET(0x14ABA250)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_CFE6FB160FFF5938_OFFSET UNITYSDK_OFFSET(0x14AB5D80)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_E824431C22EF9361_OFFSET UNITYSDK_OFFSET(0x14AB9BE0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_E876C8B6D3B840A6_OFFSET UNITYSDK_OFFSET(0x14AB5FD0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_SET_AABB_OFFSET UNITYSDK_OFFSET(0x14AB5D30)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_SET_CONTAINWINDTRIGGERSCOUNT_OFFSET UNITYSDK_OFFSET(0x14AB5D70)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_SET_SELECTED_OFFSET UNITYSDK_OFFSET(0x14AB5D00)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_SET_WINDVELOCITY_OFFSET UNITYSDK_OFFSET(0x14AB5D50)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0x14AB9410)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x14ABA3C0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x14ABA3A0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x14ABA420)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnvWindReceiverBehavior_TypeDefinitionIndex)->GetStaticField(0x4890);
		}
		static ::System::Int32* StaticGet__FlagWaveAmplitudeID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnvWindReceiverBehavior_TypeDefinitionIndex)->GetStaticField(0x4894);
		}
		static ::System::Int32* StaticGet__WindVelocityID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnvWindReceiverBehavior_TypeDefinitionIndex)->GetStaticField(0x4898);
		}
		static ::System::Int32* StaticGet__AABBSizeID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnvWindReceiverBehavior_TypeDefinitionIndex)->GetStaticField(0x489C);
		}
