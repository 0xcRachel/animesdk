...
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_GET_AABB_OFFSET UNITYSDK_OFFSET(0x9612B20)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_GET_CONTAINWINDTRIGGERSCOUNT_OFFSET UNITYSDK_OFFSET(0x9612B70)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_GET_SELECTED_OFFSET UNITYSDK_OFFSET(0x9612B00)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_GET_WINDVELOCITY_OFFSET UNITYSDK_OFFSET(0x9612B50)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0x96148D0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_146E6E50FAF07D8F_OFFSET UNITYSDK_OFFSET(0x9616280)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_2CBE0B79DD36047E_OFFSET UNITYSDK_OFFSET(0x9615C70)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_2F2B436D8A949630_OFFSET UNITYSDK_OFFSET(0x96160A0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x9617140)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x96170D0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_4DA6D4A624E42CAB_OFFSET UNITYSDK_OFFSET(0x9615FF0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0x9617300)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5790A55946AA509D_2_OFFSET UNITYSDK_OFFSET(0x9617360)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5790A55946AA509D_3_OFFSET UNITYSDK_OFFSET(0x96173C0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5790A55946AA509D_4_OFFSET UNITYSDK_OFFSET(0x9617420)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5790A55946AA509D_5_OFFSET UNITYSDK_OFFSET(0x9617490)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x96172A0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5BCE9210F4ACDD0B_1_OFFSET UNITYSDK_OFFSET(0x9616810)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5BCE9210F4ACDD0B_OFFSET UNITYSDK_OFFSET(0x9612BE0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5FAD56E9E208220A_OFFSET UNITYSDK_OFFSET(0x9616C80)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_6041E775D6263614_OFFSET UNITYSDK_OFFSET(0x9616120)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_66CC9828DB1F478F_OFFSET UNITYSDK_OFFSET(0x9616FA0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_89EF21CA0414B145_OFFSET UNITYSDK_OFFSET(0x9615980)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_921C3C3E09D59CD4_OFFSET UNITYSDK_OFFSET(0x9616D00)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_B7CCB99AAB7A4C8B_OFFSET UNITYSDK_OFFSET(0x9617060)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_CFE6FB160FFF5938_OFFSET UNITYSDK_OFFSET(0x9612B90)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_E824431C22EF9361_OFFSET UNITYSDK_OFFSET(0x96169F0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_E876C8B6D3B840A6_OFFSET UNITYSDK_OFFSET(0x9612DE0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_SET_AABB_OFFSET UNITYSDK_OFFSET(0x9612B40)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_SET_CONTAINWINDTRIGGERSCOUNT_OFFSET UNITYSDK_OFFSET(0x9612B80)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_SET_SELECTED_OFFSET UNITYSDK_OFFSET(0x9612B10)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_SET_WINDVELOCITY_OFFSET UNITYSDK_OFFSET(0x9612B60)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0x9616220)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x96171D0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x96171B0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x9617230)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnvWindReceiverBehavior_TypeDefinitionIndex)->GetStaticField(0x12070);
		}
		static ::System::Int32* StaticGet__FlagWaveAmplitudeID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnvWindReceiverBehavior_TypeDefinitionIndex)->GetStaticField(0x12074);
		}
		static ::System::Int32* StaticGet__AABBSizeID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnvWindReceiverBehavior_TypeDefinitionIndex)->GetStaticField(0x12078);
		}
		static ::System::Int32* StaticGet__FlagWaveFrequencyID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnvWindReceiverBehavior_TypeDefinitionIndex)->GetStaticField(0x1207C);
		}
