...
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_GET_AABB_OFFSET UNITYSDK_OFFSET(0x9165A40)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_GET_CONTAINWINDTRIGGERSCOUNT_OFFSET UNITYSDK_OFFSET(0x9165A90)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_GET_SELECTED_OFFSET UNITYSDK_OFFSET(0x9165A20)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_GET_WINDVELOCITY_OFFSET UNITYSDK_OFFSET(0x9165A70)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0x91679A0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_146E6E50FAF07D8F_OFFSET UNITYSDK_OFFSET(0x9169080)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_2CBE0B79DD36047E_OFFSET UNITYSDK_OFFSET(0x9168A70)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_2F2B436D8A949630_OFFSET UNITYSDK_OFFSET(0x9168EA0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x9169F40)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x9169ED0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_489E0B827662C211_OFFSET UNITYSDK_OFFSET(0x9165D00)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_4DA6D4A624E42CAB_OFFSET UNITYSDK_OFFSET(0x9168DF0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0x916A0F0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5790A55946AA509D_2_OFFSET UNITYSDK_OFFSET(0x916A150)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5790A55946AA509D_3_OFFSET UNITYSDK_OFFSET(0x916A1B0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5790A55946AA509D_4_OFFSET UNITYSDK_OFFSET(0x916A210)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5790A55946AA509D_5_OFFSET UNITYSDK_OFFSET(0x916A270)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x916A090)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5BCE9210F4ACDD0B_1_OFFSET UNITYSDK_OFFSET(0x9169610)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5BCE9210F4ACDD0B_OFFSET UNITYSDK_OFFSET(0x9165B00)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5FAD56E9E208220A_OFFSET UNITYSDK_OFFSET(0x9169A80)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_6041E775D6263614_OFFSET UNITYSDK_OFFSET(0x9168F20)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_66CC9828DB1F478F_OFFSET UNITYSDK_OFFSET(0x9169DA0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_89EF21CA0414B145_OFFSET UNITYSDK_OFFSET(0x9168780)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_921C3C3E09D59CD4_OFFSET UNITYSDK_OFFSET(0x9169B00)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_B7CCB99AAB7A4C8B_OFFSET UNITYSDK_OFFSET(0x9169E60)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_BF622B900A7F3625_OFFSET UNITYSDK_OFFSET(0x9165AB0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_E824431C22EF9361_OFFSET UNITYSDK_OFFSET(0x91697F0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_SET_AABB_OFFSET UNITYSDK_OFFSET(0x9165A60)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_SET_CONTAINWINDTRIGGERSCOUNT_OFFSET UNITYSDK_OFFSET(0x9165AA0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_SET_SELECTED_OFFSET UNITYSDK_OFFSET(0x9165A30)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_SET_WINDVELOCITY_OFFSET UNITYSDK_OFFSET(0x9165A80)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0x9169020)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x9169FC0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x9169FB0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x916A020)

namespace RPG::Client
{
	inline static constexpr unsigned int EnvWindReceiverBehavior_TypeDefinitionIndex = 56618;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnvWindReceiverBehavior_TypeDefinitionIndex)->GetStaticField(0x107A0);
		}
		static ::System::Int32* StaticGet__FlagWaveAmplitudeID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnvWindReceiverBehavior_TypeDefinitionIndex)->GetStaticField(0x107A4);
		}
		static ::System::Int32* StaticGet__FlagWaveFrequencyID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnvWindReceiverBehavior_TypeDefinitionIndex)->GetStaticField(0x107A8);
		}
		static ::System::Int32* StaticGet__WindVelocityID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnvWindReceiverBehavior_TypeDefinitionIndex)->GetStaticField(0x107AC);
		}
