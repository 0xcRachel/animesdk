...
#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL_AWAKE_OFFSET UNITYSDK_OFFSET(0x9D5BD60)
#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL_METHOD_5_8C945585B4A8C17B_OFFSET UNITYSDK_OFFSET(0x9D5C010)
#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9D5BF80)
#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9D5BDE0)
#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL_SETFLOORID_OFFSET UNITYSDK_OFFSET(0x9D5BE70)
#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0x9D5BF20)
#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x9D5C070)
