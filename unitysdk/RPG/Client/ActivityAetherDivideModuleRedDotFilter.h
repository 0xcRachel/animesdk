...
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEMODULEREDDOTFILTER_ADDHANDLERS_OFFSET UNITYSDK_OFFSET(0x159B7E40)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEMODULEREDDOTFILTER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x159B7CB0)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEMODULEREDDOTFILTER_GET_AETHERDIVIDELEVELREWARDDATA_OFFSET UNITYSDK_OFFSET(0x159B64F0)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEMODULEREDDOTFILTER_GET_HASNEWCHALLENGE_OFFSET UNITYSDK_OFFSET(0x159B6490)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEMODULEREDDOTFILTER_GET_HASNEWGYM_OFFSET UNITYSDK_OFFSET(0x159B6430)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEMODULEREDDOTFILTER_GET_ISACTIVITYGOTOEVERYDAYACTIVE_OFFSET UNITYSDK_OFFSET(0x159B65D0)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEMODULEREDDOTFILTER_GET__AETHERDIVIDEMODULE_OFFSET UNITYSDK_OFFSET(0x159B7530)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEMODULEREDDOTFILTER_INIT_OFFSET UNITYSDK_OFFSET(0x159B77F0)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEMODULEREDDOTFILTER_UPDATECANTAKEREWARDREDDOT_OFFSET UNITYSDK_OFFSET(0x159B7150)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEMODULEREDDOTFILTER_UPDATEISNEWREDDOT_OFFSET UNITYSDK_OFFSET(0x159B6A20)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEMODULEREDDOTFILTER_UPDATENEWCHALLENGERANK_OFFSET UNITYSDK_OFFSET(0x159B7590)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEMODULEREDDOTFILTER_UPDATENEWGYM_OFFSET UNITYSDK_OFFSET(0x159B7340)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEMODULEREDDOTFILTER_UPDATEQUESTREWARD_OFFSET UNITYSDK_OFFSET(0x159B7790)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEMODULEREDDOTFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x159B8710)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEMODULEREDDOTFILTER__GETACTIVITYPANELDATA_OFFSET UNITYSDK_OFFSET(0x159B6C00)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEMODULEREDDOTFILTER__INITACTIVITYTYPE_OFFSET UNITYSDK_OFFSET(0x159B7900)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEMODULEREDDOTFILTER__ONFINISHMAINMISSION_OFFSET UNITYSDK_OFFSET(0x159B8520)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEMODULEREDDOTFILTER__ONMISSIONSYNC_OFFSET UNITYSDK_OFFSET(0x159B84C0)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEMODULEREDDOTFILTER__ONQUESTUPDATED_OFFSET UNITYSDK_OFFSET(0x159B8660)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEMODULEREDDOTFILTER__ONTERMINALREDDOTREFRESH_OFFSET UNITYSDK_OFFSET(0x159B8600)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEMODULEREDDOTFILTER__ONUPDATEACTIVITYREWARDSEENREDDOT_OFFSET UNITYSDK_OFFSET(0x159B8370)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEMODULEREDDOTFILTER__ONUPDATEALLREDDOT_OFFSET UNITYSDK_OFFSET(0x159B8220)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEMODULEREDDOTFILTER__ONUPDATECANTAKEREWARDREDDOT_OFFSET UNITYSDK_OFFSET(0x159B8320)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEMODULEREDDOTFILTER__ONUPDATEISNEWREDDOT_OFFSET UNITYSDK_OFFSET(0x159B82D0)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEMODULEREDDOTFILTER__RECONSTRUCTTYPEGROUPIDLIST_OFFSET UNITYSDK_OFFSET(0x159B6CB0)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEMODULEREDDOTFILTER__SETUNLOCKMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x159B7B50)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEMODULEREDDOTFILTER___IFIXBASEPROXY_ADDHANDLERS_OFFSET UNITYSDK_OFFSET(0x159B8BA0)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEMODULEREDDOTFILTER___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x159B8B20)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEMODULEREDDOTFILTER___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x159B8AA0)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Collections::Generic::List_1<::System::UInt32>* GetAvatarTypeGroupIdList; // 0x10
		...
		::System::Collections::Generic::List_1<::System::UInt32>* CanTakeRewardActivityAetherDivideDataIdList; // 0x30
		::System::Collections::Generic::List_1<::System::UInt32>* _UnlockMissionIDList; // 0x38
		::System::Collections::Generic::List_1<::System::UInt32>* NewActivityAetherDivideDataIdList; // 0x40
		::System::Collections::Generic::List_1<::System::UInt32>* NewChallengeRankIdList; // 0x48
		::System::Collections::Generic::List_1<::System::UInt32>* RewardTypeCanTakeGroupIdList; // 0x50
		::System::Collections::Generic::List_1<::System::UInt32>* GetAvatarTypeNewGroupIdList; // 0x58
