...
#define RPG_CLIENT_UIDRAGGABLEMANAGER___C__DISPLAYCLASS29_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA1B3410)
#define RPG_CLIENT_UIDRAGGABLEMANAGER___C__DISPLAYCLASS29_0__LUABINDDRAGEXITCALLBACK_B__0_OFFSET UNITYSDK_OFFSET(0xA1B3DA0)

namespace RPG::Client
{
	inline static constexpr unsigned int UIDraggableManager___c__DisplayClass29_0_TypeDefinitionIndex = 54892;
