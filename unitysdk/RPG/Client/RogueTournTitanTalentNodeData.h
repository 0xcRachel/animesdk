...
#define RPG_CLIENT_ROGUETOURNTITANTALENTNODEDATA_GETTITANICONPATH_OFFSET UNITYSDK_OFFSET(0x172F2940)
#define RPG_CLIENT_ROGUETOURNTITANTALENTNODEDATA_GETTITANTITLE_OFFSET UNITYSDK_OFFSET(0x172F28A0)
#define RPG_CLIENT_ROGUETOURNTITANTALENTNODEDATA_GET_CANACTIVE_OFFSET UNITYSDK_OFFSET(0x172F2FF0)
#define RPG_CLIENT_ROGUETOURNTITANTALENTNODEDATA_GET_COSTITEM_OFFSET UNITYSDK_OFFSET(0x172F2E50)
#define RPG_CLIENT_ROGUETOURNTITANTALENTNODEDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0x172F2BD0)
#define RPG_CLIENT_ROGUETOURNTITANTALENTNODEDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x172F2D70)
#define RPG_CLIENT_ROGUETOURNTITANTALENTNODEDATA_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x172F2830)
#define RPG_CLIENT_ROGUETOURNTITANTALENTNODEDATA_GET_PREID_OFFSET UNITYSDK_OFFSET(0x172F2430)
#define RPG_CLIENT_ROGUETOURNTITANTALENTNODEDATA_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x172F2FD0)
#define RPG_CLIENT_ROGUETOURNTITANTALENTNODEDATA_GET_STORYJSONPATH_OFFSET UNITYSDK_OFFSET(0x172F2DE0)
#define RPG_CLIENT_ROGUETOURNTITANTALENTNODEDATA_GET_STORYTITLE_OFFSET UNITYSDK_OFFSET(0x172F2B00)
#define RPG_CLIENT_ROGUETOURNTITANTALENTNODEDATA_GET_TALENTID_OFFSET UNITYSDK_OFFSET(0x172F29C0)
#define RPG_CLIENT_ROGUETOURNTITANTALENTNODEDATA_GET_TITANTYPE_OFFSET UNITYSDK_OFFSET(0x172F1B10)
#define RPG_CLIENT_ROGUETOURNTITANTALENTNODEDATA_GET_TITLE_OFFSET UNITYSDK_OFFSET(0x172F2A30)
#define RPG_CLIENT_ROGUETOURNTITANTALENTNODEDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x172F29D0)
#define RPG_CLIENT_ROGUETOURNTITANTALENTNODEDATA_SET_STATUS_OFFSET UNITYSDK_OFFSET(0x172F2FE0)
#define RPG_CLIENT_ROGUETOURNTITANTALENTNODEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x172F1AE0)
