...
#define RPG_CLIENT_UIADVENTUREMINIMAP_INSTANCEDLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0xA1926E0)

namespace RPG::Client
{
	inline static constexpr unsigned int UIAdventureMinimap_InstancedLayer_TypeDefinitionIndex = 54860;
