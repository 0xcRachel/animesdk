...
{
	inline static constexpr unsigned int BookletElement_1_TypeDefinitionIndex = 57676;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_802*>* _Children; // 0x0
		::RPG::Client::IBookletView* _View_k__BackingField; // 0x0
		::Class_0_16E4307DCC419505_802* _Parent_k__BackingField; // 0x0
	};
}
