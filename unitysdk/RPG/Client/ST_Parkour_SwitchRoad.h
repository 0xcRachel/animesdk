...
#define RPG_CLIENT_ST_PARKOUR_SWITCHROAD_METHOD_4_23D1A0E75276F8FB_OFFSET UNITYSDK_OFFSET(0x188507C0)
#define RPG_CLIENT_ST_PARKOUR_SWITCHROAD_METHOD_4_24E28BE7C123299D_OFFSET UNITYSDK_OFFSET(0x188508A0)
#define RPG_CLIENT_ST_PARKOUR_SWITCHROAD__CTOR_OFFSET UNITYSDK_OFFSET(0x18850840)
