...
#define RPG_CLIENT_MONOEFFECTPLUGINMAHJONGITEM_AWAKEPLUGIN_OFFSET UNITYSDK_OFFSET(0x97FE5B0)
#define RPG_CLIENT_MONOEFFECTPLUGINMAHJONGITEM_DESTROYPLUGIN_OFFSET UNITYSDK_OFFSET(0x97FE660)
#define RPG_CLIENT_MONOEFFECTPLUGINMAHJONGITEM_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0x97FE560)
#define RPG_CLIENT_MONOEFFECTPLUGINMAHJONGITEM_ENABLEPLUGIN_OFFSET UNITYSDK_OFFSET(0x97FE510)
#define RPG_CLIENT_MONOEFFECTPLUGINMAHJONGITEM_GET_BEHAVIOR_OFFSET UNITYSDK_OFFSET(0x97FE7B0)
#define RPG_CLIENT_MONOEFFECTPLUGINMAHJONGITEM_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0x97FE4B0)
#define RPG_CLIENT_MONOEFFECTPLUGINMAHJONGITEM_TICK_OFFSET UNITYSDK_OFFSET(0x97FE710)
#define RPG_CLIENT_MONOEFFECTPLUGINMAHJONGITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x97FE7C0)
#define RPG_CLIENT_MONOEFFECTPLUGINMAHJONGITEM___IFIXBASEPROXY_AWAKEPLUGIN_OFFSET UNITYSDK_OFFSET(0x97FE850)
#define RPG_CLIENT_MONOEFFECTPLUGINMAHJONGITEM___IFIXBASEPROXY_DESTROYPLUGIN_OFFSET UNITYSDK_OFFSET(0x97FE8B0)
#define RPG_CLIENT_MONOEFFECTPLUGINMAHJONGITEM___IFIXBASEPROXY_ENABLEPLUGIN_OFFSET UNITYSDK_OFFSET(0x97FE7F0)
#define RPG_CLIENT_MONOEFFECTPLUGINMAHJONGITEM___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x97FE910)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginMahJongItem_TypeDefinitionIndex = 55779;
