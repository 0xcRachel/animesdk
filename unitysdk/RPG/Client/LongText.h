...
#define RPG_CLIENT_LONGTEXT_APPLYTEXTGENERATOR_OFFSET UNITYSDK_OFFSET(0x958CC10)
#define RPG_CLIENT_LONGTEXT_CULL_OFFSET UNITYSDK_OFFSET(0x958C260)
#define RPG_CLIENT_LONGTEXT_FILLVERTICES_OFFSET UNITYSDK_OFFSET(0x958F3F0)
#define RPG_CLIENT_LONGTEXT_FINDVERTICESRANGE_OFFSET UNITYSDK_OFFSET(0x958F000)
#define RPG_CLIENT_LONGTEXT_FINDVISIBLERANGE_OFFSET UNITYSDK_OFFSET(0x958E9B0)
#define RPG_CLIENT_LONGTEXT_GET_CLIPRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x958C180)
#define RPG_CLIENT_LONGTEXT_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x958C1A0)
#define RPG_CLIENT_LONGTEXT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x958C980)
#define RPG_CLIENT_LONGTEXT_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x958D1D0)
#define RPG_CLIENT_LONGTEXT_ONTEXTCHANGED_OFFSET UNITYSDK_OFFSET(0x958E960)
#define RPG_CLIENT_LONGTEXT_SETCLIPRECT_OFFSET UNITYSDK_OFFSET(0x958C6A0)
#define RPG_CLIENT_LONGTEXT_SETCLIPSOFTNESS_OFFSET UNITYSDK_OFFSET(0x958C810)
#define RPG_CLIENT_LONGTEXT_SETNTHMESH_OFFSET UNITYSDK_OFFSET(0x958F8E0)
#define RPG_CLIENT_LONGTEXT_SET_CLIPRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x958C190)
#define RPG_CLIENT_LONGTEXT_SET_TEXT_OFFSET UNITYSDK_OFFSET(0x958C1B0)
#define RPG_CLIENT_LONGTEXT_UPDATEGEOMETRY_OFFSET UNITYSDK_OFFSET(0x958CE40)
#define RPG_CLIENT_LONGTEXT_UPDATEMATERIAL_OFFSET UNITYSDK_OFFSET(0x958CA50)
#define RPG_CLIENT_LONGTEXT__CCTOR_OFFSET UNITYSDK_OFFSET(0x958FD20)
#define RPG_CLIENT_LONGTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x958FCB0)
#define RPG_CLIENT_LONGTEXT___IFIXBASEPROXY_CULL_OFFSET UNITYSDK_OFFSET(0x958FD80)
#define RPG_CLIENT_LONGTEXT___IFIXBASEPROXY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x958FE70)
#define RPG_CLIENT_LONGTEXT___IFIXBASEPROXY_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x958FF80)
#define RPG_CLIENT_LONGTEXT___IFIXBASEPROXY_ONTEXTCHANGED_OFFSET UNITYSDK_OFFSET(0x958FF70)
#define RPG_CLIENT_LONGTEXT___IFIXBASEPROXY_SETCLIPRECT_OFFSET UNITYSDK_OFFSET(0x958FDA0)
#define RPG_CLIENT_LONGTEXT___IFIXBASEPROXY_SETCLIPSOFTNESS_OFFSET UNITYSDK_OFFSET(0x958FDC0)
#define RPG_CLIENT_LONGTEXT___IFIXBASEPROXY_SET_TEXT_OFFSET UNITYSDK_OFFSET(0x958FD70)
#define RPG_CLIENT_LONGTEXT___IFIXBASEPROXY_UPDATEGEOMETRY_OFFSET UNITYSDK_OFFSET(0x958FF20)
#define RPG_CLIENT_LONGTEXT___IFIXBASEPROXY_UPDATEMATERIAL_OFFSET UNITYSDK_OFFSET(0x958FEE0)

namespace RPG::Client
{
	inline static constexpr unsigned int LongText_TypeDefinitionIndex = 57840;
	...
	public:
		...
		{
			return (::UnityEngine::UI::VertexHelper**)Il2CppClass::FromTypeDefinitionIndex(LongText_TypeDefinitionIndex)->GetStaticField(0x23160);
		}
		static ::Il2CppArray<::UnityEngine::Vector3>** StaticGet_worldCorners()
		{
			return (::Il2CppArray<::UnityEngine::Vector3>**)Il2CppClass::FromTypeDefinitionIndex(LongText_TypeDefinitionIndex)->GetStaticField(0x23168);
		}
