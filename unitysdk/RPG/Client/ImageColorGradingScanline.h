...
#define RPG_CLIENT_IMAGECOLORGRADINGSCANLINE_GETMATERIALFORRENDERING_OFFSET UNITYSDK_OFFSET(0x94C2580)
#define RPG_CLIENT_IMAGECOLORGRADINGSCANLINE_GET_IMAGE_OFFSET UNITYSDK_OFFSET(0x94C24D0)
#define RPG_CLIENT_IMAGECOLORGRADINGSCANLINE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x94C2BF0)
#define RPG_CLIENT_IMAGECOLORGRADINGSCANLINE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x94C2ED0)
#define RPG_CLIENT_IMAGECOLORGRADINGSCANLINE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x94C2F30)
#define RPG_CLIENT_IMAGECOLORGRADINGSCANLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x94C2F80)
#define RPG_CLIENT_IMAGECOLORGRADINGSCANLINE___IFIXBASEPROXY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x94C30F0)
#define RPG_CLIENT_IMAGECOLORGRADINGSCANLINE___IFIXBASEPROXY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x94C3100)

namespace RPG::Client
{
	inline static constexpr unsigned int ImageColorGradingScanline_TypeDefinitionIndex = 56600;
