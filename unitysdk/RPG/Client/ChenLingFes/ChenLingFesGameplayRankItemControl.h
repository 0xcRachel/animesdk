...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL_GET_ISFIRSTSHOW_OFFSET UNITYSDK_OFFSET(0x18B07920)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18B07ED0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL_RESETREFRESHANIMTOEND_OFFSET UNITYSDK_OFFSET(0x18B06A70)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL_SET_ISFIRSTSHOW_OFFSET UNITYSDK_OFFSET(0x18B07930)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x18B086E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__INITVIEW_OFFSET UNITYSDK_OFFSET(0x18B07F50)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__ONANIMCALLBACK_OFFSET UNITYSDK_OFFSET(0x18B08450)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18B07C10)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18B085B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x18B07940)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__ONITEMVIEWMODELPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x18B082C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__REFRESHICONPATH_OFFSET UNITYSDK_OFFSET(0x18B084A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__REFRESHITEM_OFFSET UNITYSDK_OFFSET(0x18B08230)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x18B08030)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18B08770)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL___IFIXBASEPROXY__ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18B087D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x18B08710)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayRankItemControl_TypeDefinitionIndex = 73976;
