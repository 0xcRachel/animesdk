...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_ADD_ONCLEARPENDINGTOASTQUEUE_OFFSET UNITYSDK_OFFSET(0x1884E4F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_ADD_ONTOASTREQUEST_OFFSET UNITYSDK_OFFSET(0x1884E410)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x1883ED20)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_GET_FEVERTOASTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x188530A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_GET_OPENDAYSTARTTOASTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18853080)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_GET_PREPARESTARTTOASTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18853060)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_REGISTERNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0x1884E550)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_REMOVE_ONCLEARPENDINGTOASTQUEUE_OFFSET UNITYSDK_OFFSET(0x1884E490)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_REMOVE_ONTOASTREQUEST_OFFSET UNITYSDK_OFFSET(0x1884E390)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_SET_FEVERTOASTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x188530B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_SET_OPENDAYSTARTTOASTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18853090)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_SET_PREPARESTARTTOASTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18853070)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_UNREGISTERNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0x18851040)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__CANEMITFLYTOAST_OFFSET UNITYSDK_OFFSET(0x18851D40)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x188517C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__EMITUIDIALOGREQUEST_OFFSET UNITYSDK_OFFSET(0x18852740)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__GETFLYTOASTMININTERVAL_OFFSET UNITYSDK_OFFSET(0x188520D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__GETSPECIALSHOWCOINNUM_OFFSET UNITYSDK_OFFSET(0x18851E40)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__INIT_OFFSET UNITYSDK_OFFSET(0x18851870)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__ONDAYEND_OFFSET UNITYSDK_OFFSET(0x18852520)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__ONFEVERUPDATE_OFFSET UNITYSDK_OFFSET(0x18851F60)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__ONHIDEUIDIALOG_OFFSET UNITYSDK_OFFSET(0x18852B70)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__ONSCOREUPDATE_OFFSET UNITYSDK_OFFSET(0x18851A80)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__ONSHOWTOAST_OFFSET UNITYSDK_OFFSET(0x18852170)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__ONSHOWUIDIALOG_OFFSET UNITYSDK_OFFSET(0x188526B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__ONSHOWUITOAST_OFFSET UNITYSDK_OFFSET(0x18852D10)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__ONSWITCHDAY_OFFSET UNITYSDK_OFFSET(0x188524B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__ONUPDATEUIDIALOG_OFFSET UNITYSDK_OFFSET(0x18852980)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__TRYGETDIALOGPREFABPATH_OFFSET UNITYSDK_OFFSET(0x18852A10)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__TRYGETTOASTPREFABPATH_OFFSET UNITYSDK_OFFSET(0x18852FB0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesToastContainerViewModel_TypeDefinitionIndex = 74067;

	class ChenLingFesToastContainerViewModel : public ::Sofa::BaseViewModel
	{
	public:
		::System::Action_1<::RPG::Client::ChenLingFes::ChenLingFesToastRequestViewModel*>* OnToastRequest; // 0x20
		::RPG::Client::ChenLingFes::ChenLingFesGameplayFeverViewModel* _FeverToastViewModel_k__BackingField; // 0x28
		...
		::RPG::Client::ChenLingFes::ChenLingFesGamePhaseToastViewModel* _OpenDayStartToastViewModel_k__BackingField; // 0x48
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Single>* _LastFlyToastTriggerTimeByEntity; // 0x50
