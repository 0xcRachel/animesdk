...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYTARGETITEMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x18B16830)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYTARGETITEMVIEWMODEL__INITSTARVMS_OFFSET UNITYSDK_OFFSET(0x18B16950)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayTargetItemViewModel_TypeDefinitionIndex = 74047;
	...
	public:
		...
		::System::Int32 WeekIndex; // 0x30
		::System::Int32 Star; // 0x34
		::System::Int32 RequiredStarCount; // 0x38
		::System::Boolean IsFinished; // 0x3C
		::System::Boolean IsShowGlobalTarget; // 0x3D
		::System::Boolean IsEndlessModeForBoss; // 0x3E
		::System::Boolean IsCurWeek; // 0x3F
		::System::Boolean IsEndlessMode; // 0x40
		::System::Int32 TargetScore; // 0x44
		::System::Int32 DayCount; // 0x48
