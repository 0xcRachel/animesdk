...
#define RPG_CLIENT_MINIMAPMANAGER_PROPDEFERLOADCALLBACKCLOSURE_CLEAR_OFFSET UNITYSDK_OFFSET(0x1474CA70)
#define RPG_CLIENT_MINIMAPMANAGER_PROPDEFERLOADCALLBACKCLOSURE_EXECUTEFORASSISTWAYPOINTREFRESHEDIMPL_OFFSET UNITYSDK_OFFSET(0x1474C900)
#define RPG_CLIENT_MINIMAPMANAGER_PROPDEFERLOADCALLBACKCLOSURE_EXECUTEFORMISSIONREFRESHEDIMPL_OFFSET UNITYSDK_OFFSET(0x1474C630)
#define RPG_CLIENT_MINIMAPMANAGER_PROPDEFERLOADCALLBACKCLOSURE_GET_EXECUTEFORASSISTWAYPOINTREFRESHED_OFFSET UNITYSDK_OFFSET(0x1474BB40)
#define RPG_CLIENT_MINIMAPMANAGER_PROPDEFERLOADCALLBACKCLOSURE_GET_EXECUTEFORMISSIONREFRESHED_OFFSET UNITYSDK_OFFSET(0x1474BA40)
#define RPG_CLIENT_MINIMAPMANAGER_PROPDEFERLOADCALLBACKCLOSURE_INIT_1_OFFSET UNITYSDK_OFFSET(0x1474BAE0)
#define RPG_CLIENT_MINIMAPMANAGER_PROPDEFERLOADCALLBACKCLOSURE_INIT_OFFSET UNITYSDK_OFFSET(0x1474B930)
#define RPG_CLIENT_MINIMAPMANAGER_PROPDEFERLOADCALLBACKCLOSURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1474CAD0)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Action_1<::RPG::Client::MapProp*>* _executeCallback; // 0x18
		::RPG::Client::SubMissionData* subMission; // 0x20
		::System::Action_1<::RPG::Client::MapProp*>* _execute2Callback; // 0x28
		::System::Boolean bIsTrackingMission; // 0x30
		::System::Single fWayPointShowRangeMax; // 0x34
		::System::UInt32 nIconID; // 0x38
		::System::Single fWayPointShowRangeMin; // 0x3C
		::UnityEngine::Color circleColor; // 0x40
		::System::Single fShowRangeRadius; // 0x50
