...
#define RPG_CLIENT_DIFFICULTYADJUSTMODULE_CANRAIDADJUSTDIFFICULTY_OFFSET UNITYSDK_OFFSET(0x94ADE70)
#define RPG_CLIENT_DIFFICULTYADJUSTMODULE_CANSTAGEEVENTADJUSTDIFFICULTY_OFFSET UNITYSDK_OFFSET(0x94AE010)
#define RPG_CLIENT_DIFFICULTYADJUSTMODULE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x94AE7D0)
#define RPG_CLIENT_DIFFICULTYADJUSTMODULE_GETDIFFICULTYTYPE_OFFSET UNITYSDK_OFFSET(0x94AE1A0)
#define RPG_CLIENT_DIFFICULTYADJUSTMODULE_GETEASYWORLDLEVEL_OFFSET UNITYSDK_OFFSET(0x94AE0E0)
#define RPG_CLIENT_DIFFICULTYADJUSTMODULE_GETRAIDDIFFICULTYTYPE_OFFSET UNITYSDK_OFFSET(0x94ADD00)
#define RPG_CLIENT_DIFFICULTYADJUSTMODULE_GETSTAGEEVENTDIFFICULTYTYPE_OFFSET UNITYSDK_OFFSET(0x94ADD60)
#define RPG_CLIENT_DIFFICULTYADJUSTMODULE_INIT_OFFSET UNITYSDK_OFFSET(0x94AE510)
#define RPG_CLIENT_DIFFICULTYADJUSTMODULE_ISNPCDIFFICULTYADJUSTEASY_OFFSET UNITYSDK_OFFSET(0x94ADAF0)
#define RPG_CLIENT_DIFFICULTYADJUSTMODULE_ISRAIDDIFFICULTYADJUSTEASY_OFFSET UNITYSDK_OFFSET(0x94ADDC0)
#define RPG_CLIENT_DIFFICULTYADJUSTMODULE_ISSTAGEDIFFICULTYADJUSTEASY_OFFSET UNITYSDK_OFFSET(0x94ADF70)
#define RPG_CLIENT_DIFFICULTYADJUSTMODULE_SENDRAIDDIFFICULTYUPDATEDATACSREQ_OFFSET UNITYSDK_OFFSET(0x94AE270)
#define RPG_CLIENT_DIFFICULTYADJUSTMODULE_SENDSTAGEEVENTDIFFICULTYUPDATEDATACSREQ_OFFSET UNITYSDK_OFFSET(0x94AE3C0)
#define RPG_CLIENT_DIFFICULTYADJUSTMODULE__ADDORREFRESHDIFFICULTYADJUSTDATA_OFFSET UNITYSDK_OFFSET(0x94AEEA0)
#define RPG_CLIENT_DIFFICULTYADJUSTMODULE__ADDPACKETHANDLERS_OFFSET UNITYSDK_OFFSET(0x94AE9F0)
#define RPG_CLIENT_DIFFICULTYADJUSTMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x94AF370)
#define RPG_CLIENT_DIFFICULTYADJUSTMODULE__INITCANADJUSTMENTSTAGEEVENTIDS_OFFSET UNITYSDK_OFFSET(0x94AE610)
#define RPG_CLIENT_DIFFICULTYADJUSTMODULE__ONCMDDIFFICULTYADJUSTMENTGETDATASCRSP_OFFSET UNITYSDK_OFFSET(0x94AEB60)
#define RPG_CLIENT_DIFFICULTYADJUSTMODULE__ONCMDDIFFICULTYADJUSTMENTUPDATEDATASCRSP_OFFSET UNITYSDK_OFFSET(0x94AF0C0)
#define RPG_CLIENT_DIFFICULTYADJUSTMODULE__SENDDIFFICULTYADJUSTMENTGETDATACSREQ_OFFSET UNITYSDK_OFFSET(0x94AEAA0)
#define RPG_CLIENT_DIFFICULTYADJUSTMODULE___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x94AF420)
#define RPG_CLIENT_DIFFICULTYADJUSTMODULE___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x94AF390)
#define RPG_CLIENT_DIFFICULTYADJUSTMODULE___IFIXBASEPROXY__ADDPACKETHANDLERS_OFFSET UNITYSDK_OFFSET(0x94AF430)
