...
#define RPG_CLIENT_LOOPSCENE_ADDATTACHMOVEOBJECT_OFFSET UNITYSDK_OFFSET(0x959E2F0)
#define RPG_CLIENT_LOOPSCENE_AWAKE_OFFSET UNITYSDK_OFFSET(0x959E850)
#define RPG_CLIENT_LOOPSCENE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x959E460)
#define RPG_CLIENT_LOOPSCENE_FINDMOVEOBJECT_OFFSET UNITYSDK_OFFSET(0x959E380)
#define RPG_CLIENT_LOOPSCENE_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x959E980)
#define RPG_CLIENT_LOOPSCENE_INIT_OFFSET UNITYSDK_OFFSET(0x959DD60)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x959F060)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_596FD8239C601ED8_OFFSET UNITYSDK_OFFSET(0x959F120)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_9D3B43E6609D6005_OFFSET UNITYSDK_OFFSET(0x959EC80)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x959F0D0)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_B7F8E0B4AF22DEA3_OFFSET UNITYSDK_OFFSET(0x959EAD0)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_D9EF75A2D048B8A1_1_OFFSET UNITYSDK_OFFSET(0x959EA80)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_D9EF75A2D048B8A1_OFFSET UNITYSDK_OFFSET(0x959EA30)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_F79D5EC57FBF426E_OFFSET UNITYSDK_OFFSET(0x959E930)
#define RPG_CLIENT_LOOPSCENE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x959E8C0)
#define RPG_CLIENT_LOOPSCENE_RESETCAMERA_OFFSET UNITYSDK_OFFSET(0x959E180)
#define RPG_CLIENT_LOOPSCENE__CTOR_OFFSET UNITYSDK_OFFSET(0x959F5C0)

namespace RPG::Client
{
	inline static constexpr unsigned int LoopScene_TypeDefinitionIndex = 54700;
