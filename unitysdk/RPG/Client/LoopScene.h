...
#define RPG_CLIENT_LOOPSCENE_ADDATTACHMOVEOBJECT_OFFSET UNITYSDK_OFFSET(0x9A7C710)
#define RPG_CLIENT_LOOPSCENE_AWAKE_OFFSET UNITYSDK_OFFSET(0x9A7CC70)
#define RPG_CLIENT_LOOPSCENE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9A7C880)
#define RPG_CLIENT_LOOPSCENE_FINDMOVEOBJECT_OFFSET UNITYSDK_OFFSET(0x9A7C7A0)
#define RPG_CLIENT_LOOPSCENE_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x9A7CDA0)
#define RPG_CLIENT_LOOPSCENE_INIT_OFFSET UNITYSDK_OFFSET(0x9A7C180)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x9A7D480)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_596FD8239C601ED8_OFFSET UNITYSDK_OFFSET(0x9A7D540)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_9D3B43E6609D6005_OFFSET UNITYSDK_OFFSET(0x9A7D0A0)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x9A7D4F0)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_B7F8E0B4AF22DEA3_OFFSET UNITYSDK_OFFSET(0x9A7CEF0)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_D9EF75A2D048B8A1_1_OFFSET UNITYSDK_OFFSET(0x9A7CEA0)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_D9EF75A2D048B8A1_OFFSET UNITYSDK_OFFSET(0x9A7CE50)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_F79D5EC57FBF426E_OFFSET UNITYSDK_OFFSET(0x9A7CD50)
#define RPG_CLIENT_LOOPSCENE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9A7CCE0)
#define RPG_CLIENT_LOOPSCENE_RESETCAMERA_OFFSET UNITYSDK_OFFSET(0x9A7C5A0)
#define RPG_CLIENT_LOOPSCENE__CTOR_OFFSET UNITYSDK_OFFSET(0x9A7D9E0)
