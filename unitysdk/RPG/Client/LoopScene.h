...
#define RPG_CLIENT_LOOPSCENE_ADDATTACHMOVEOBJECT_OFFSET UNITYSDK_OFFSET(0x16951CC0)
#define RPG_CLIENT_LOOPSCENE_AWAKE_OFFSET UNITYSDK_OFFSET(0x16952220)
#define RPG_CLIENT_LOOPSCENE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16951E30)
#define RPG_CLIENT_LOOPSCENE_FINDMOVEOBJECT_OFFSET UNITYSDK_OFFSET(0x16951D50)
#define RPG_CLIENT_LOOPSCENE_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x16952350)
#define RPG_CLIENT_LOOPSCENE_INIT_OFFSET UNITYSDK_OFFSET(0x16951730)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x16952A30)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_596FD8239C601ED8_OFFSET UNITYSDK_OFFSET(0x16952AF0)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_9D3B43E6609D6005_OFFSET UNITYSDK_OFFSET(0x16952650)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x16952AA0)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_B7F8E0B4AF22DEA3_OFFSET UNITYSDK_OFFSET(0x169524A0)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_D9EF75A2D048B8A1_1_OFFSET UNITYSDK_OFFSET(0x16952450)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_D9EF75A2D048B8A1_OFFSET UNITYSDK_OFFSET(0x16952400)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_F79D5EC57FBF426E_OFFSET UNITYSDK_OFFSET(0x16952300)
#define RPG_CLIENT_LOOPSCENE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x16952290)
#define RPG_CLIENT_LOOPSCENE_RESETCAMERA_OFFSET UNITYSDK_OFFSET(0x16951B50)
#define RPG_CLIENT_LOOPSCENE__CTOR_OFFSET UNITYSDK_OFFSET(0x16952F90)
