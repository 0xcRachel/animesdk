...
#define RPG_CLIENT_MUSEUMGETFUNDNOTIFYPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x98E36E0)

namespace RPG::Client
{
	inline static constexpr unsigned int MuseumGetFundNotifyParam_TypeDefinitionIndex = 52828;
