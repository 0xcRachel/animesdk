...
#define RPG_CLIENT_MONOSLIDERANIM_AWAKE_OFFSET UNITYSDK_OFFSET(0x17AF3680)
#define RPG_CLIENT_MONOSLIDERANIM_SETVALUE_OFFSET UNITYSDK_OFFSET(0x17AF3520)
#define RPG_CLIENT_MONOSLIDERANIM_STARTANIM_OFFSET UNITYSDK_OFFSET(0x17AF3420)
#define RPG_CLIENT_MONOSLIDERANIM_UPDATE_OFFSET UNITYSDK_OFFSET(0x17AF3850)
#define RPG_CLIENT_MONOSLIDERANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x17AF3AF0)
#define RPG_CLIENT_MONOSLIDERANIM__SETFILLAMOUNT_OFFSET UNITYSDK_OFFSET(0x17AF35E0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoSliderAnim_TypeDefinitionIndex = 67840;
