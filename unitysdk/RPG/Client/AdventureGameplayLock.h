...
#define RPG_CLIENT_ADVENTUREGAMEPLAYLOCK_METHOD_3_1251ABBEE9F4DFE8_OFFSET UNITYSDK_OFFSET(0x1923FD00)
#define RPG_CLIENT_ADVENTUREGAMEPLAYLOCK_METHOD_3_39E9E3ED32B3FEF5_OFFSET UNITYSDK_OFFSET(0x1923FB30)
#define RPG_CLIENT_ADVENTUREGAMEPLAYLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x1923FCD0)
