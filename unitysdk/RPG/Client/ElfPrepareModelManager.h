...
#define RPG_CLIENT_ELFPREPAREMODELMANAGER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9114E60)
#define RPG_CLIENT_ELFPREPAREMODELMANAGER_GET__MONOEFFECTMANAGERREF_OFFSET UNITYSDK_OFFSET(0x911B870)
#define RPG_CLIENT_ELFPREPAREMODELMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0x911AF70)
#define RPG_CLIENT_ELFPREPAREMODELMANAGER_REFRESHRECIPEMODELS_OFFSET UNITYSDK_OFFSET(0x911B140)
#define RPG_CLIENT_ELFPREPAREMODELMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x91165C0)
#define RPG_CLIENT_ELFPREPAREMODELMANAGER__GETRECIPEANCHORINFO_OFFSET UNITYSDK_OFFSET(0x911B720)
#define RPG_CLIENT_ELFPREPAREMODELMANAGER__RELEASEALLMODEL_OFFSET UNITYSDK_OFFSET(0x911AFB0)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfPrepareModelManager_TypeDefinitionIndex = 50621;
