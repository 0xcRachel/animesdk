...
#define RPG_CLIENT_CMDLINEQUALITYSETTINGSMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x17B374B0)

namespace RPG::Client
{
	inline static constexpr unsigned int CmdLineQualitySettingsModel_TypeDefinitionIndex = 8871;
