...
#define RPG_CLIENT_CHECKITEMCLOSEQUEST_FILLNOTIFYTYPESTO_OFFSET UNITYSDK_OFFSET(0x8EC2B80)
#define RPG_CLIENT_CHECKITEMCLOSEQUEST_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8EC2CC0)
#define RPG_CLIENT_CHECKITEMCLOSEQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x8EC2B60)
#define RPG_CLIENT_CHECKITEMCLOSEQUEST__DOCHECKIMPL_OFFSET UNITYSDK_OFFSET(0x8EC2C10)
#define RPG_CLIENT_CHECKITEMCLOSEQUEST___IFIXBASEPROXY_FILLNOTIFYTYPESTO_OFFSET UNITYSDK_OFFSET(0x8EC2D70)
#define RPG_CLIENT_CHECKITEMCLOSEQUEST___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8EC2E50)
#define RPG_CLIENT_CHECKITEMCLOSEQUEST___IFIXBASEPROXY__DOCHECKIMPL_OFFSET UNITYSDK_OFFSET(0x8EC2DE0)

namespace RPG::Client
{
	inline static constexpr unsigned int CheckItemCloseQuest_TypeDefinitionIndex = 47411;
