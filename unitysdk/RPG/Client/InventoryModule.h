...
#define RPG_CLIENT_INVENTORYMODULE_CHECKISHEROAVATAREIDOLONITEMTYPE_OFFSET UNITYSDK_OFFSET(0x13392100)
#define RPG_CLIENT_INVENTORYMODULE_CHECKUSEITEM_OFFSET UNITYSDK_OFFSET(0x1338EF00)
#define RPG_CLIENT_INVENTORYMODULE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1338E250)
#define RPG_CLIENT_INVENTORYMODULE_ENABLESETFAVORITE_OFFSET UNITYSDK_OFFSET(0x1338ADA0)
#define RPG_CLIENT_INVENTORYMODULE_FINDALLEQUIPMENTS_OFFSET UNITYSDK_OFFSET(0x1338F7B0)
#define RPG_CLIENT_INVENTORYMODULE_FINDEQUIPMENT_OFFSET UNITYSDK_OFFSET(0x1338F640)
#define RPG_CLIENT_INVENTORYMODULE_FINDTABIDBYITEMID_OFFSET UNITYSDK_OFFSET(0x13390610)
#define RPG_CLIENT_INVENTORYMODULE_GETAETHERSKILLCOREITEMDATABYCONFIGID_OFFSET UNITYSDK_OFFSET(0x13392290)
#define RPG_CLIENT_INVENTORYMODULE_GETCONVERTIBLEITEMDATABYITEMID_OFFSET UNITYSDK_OFFSET(0x13392DC0)
#define RPG_CLIENT_INVENTORYMODULE_GETCONVERTIBLEITEMDATABYITEMSUBTYPE_OFFSET UNITYSDK_OFFSET(0x13392CE0)
#define RPG_CLIENT_INVENTORYMODULE_GETEQUIPMENTDATABYCONFIGID_OFFSET UNITYSDK_OFFSET(0x1338F500)
#define RPG_CLIENT_INVENTORYMODULE_GETEQUIPMENTDATABYUID_OFFSET UNITYSDK_OFFSET(0x1338F990)
#define RPG_CLIENT_INVENTORYMODULE_GETEQUIPMENTMAXRANKANDCOUNTBYCONFIGID_OFFSET UNITYSDK_OFFSET(0x1338F380)
#define RPG_CLIENT_INVENTORYMODULE_GETEQUIPMENTMAXRANKBYCONFIGID_OFFSET UNITYSDK_OFFSET(0x1338F210)
#define RPG_CLIENT_INVENTORYMODULE_GETFOODCOUNTBYCONSUMETYPEID_OFFSET UNITYSDK_OFFSET(0x13389DE0)
#define RPG_CLIENT_INVENTORYMODULE_GETFOODITEMSBYCONSUMETYPE_OFFSET UNITYSDK_OFFSET(0x1338A3D0)
#define RPG_CLIENT_INVENTORYMODULE_GETFOODITEMSBYMAZEBUFFPOOL_OFFSET UNITYSDK_OFFSET(0x13390EC0)
#define RPG_CLIENT_INVENTORYMODULE_GETHCOINCONFIGID_OFFSET UNITYSDK_OFFSET(0x133931E0)
#define RPG_CLIENT_INVENTORYMODULE_GETINVENTORYTABITEMS_OFFSET UNITYSDK_OFFSET(0x133908E0)
#define RPG_CLIENT_INVENTORYMODULE_GETISPILEBYCONFIGID_OFFSET UNITYSDK_OFFSET(0x13392C60)
#define RPG_CLIENT_INVENTORYMODULE_GETISPILEBYITEMMAINTYPE_OFFSET UNITYSDK_OFFSET(0x13393460)
#define RPG_CLIENT_INVENTORYMODULE_GETISPILEBYITEMSUBTYPE_OFFSET UNITYSDK_OFFSET(0x133912A0)
#define RPG_CLIENT_INVENTORYMODULE_GETITEMAUTOCONVERSIONRECORDS_OFFSET UNITYSDK_OFFSET(0x13391A90)
#define RPG_CLIENT_INVENTORYMODULE_GETITEMCOMEFROM_OFFSET UNITYSDK_OFFSET(0x13393820)
#define RPG_CLIENT_INVENTORYMODULE_GETITEMCOUNTAFTERDELETEBYCONFIGID_OFFSET UNITYSDK_OFFSET(0x1338E9D0)
#define RPG_CLIENT_INVENTORYMODULE_GETITEMCOUNTBYCONFIGID_OFFSET UNITYSDK_OFFSET(0x1338E970)
#define RPG_CLIENT_INVENTORYMODULE_GETITEMDATABYCONFIGID_OFFSET UNITYSDK_OFFSET(0x1338ABA0)
#define RPG_CLIENT_INVENTORYMODULE_GETITEMDATABYUID_OFFSET UNITYSDK_OFFSET(0x1338F150)
#define RPG_CLIENT_INVENTORYMODULE_GETITEMRARITYCONFIG_OFFSET UNITYSDK_OFFSET(0x13392FD0)
#define RPG_CLIENT_INVENTORYMODULE_GETITEMROW_OFFSET UNITYSDK_OFFSET(0x13392EA0)
#define RPG_CLIENT_INVENTORYMODULE_GETITEMSBYMAINTYPES_OFFSET UNITYSDK_OFFSET(0x13388D20)
#define RPG_CLIENT_INVENTORYMODULE_GETITEMSBYSUBTYPES_OFFSET UNITYSDK_OFFSET(0x133896F0)
#define RPG_CLIENT_INVENTORYMODULE_GETITEMSBYSUBTYPE_OFFSET UNITYSDK_OFFSET(0x1338FC10)
#define RPG_CLIENT_INVENTORYMODULE_GETITEMSINTYPES_OFFSET UNITYSDK_OFFSET(0x1338FCA0)
#define RPG_CLIENT_INVENTORYMODULE_GETITEMUSEDATAROWBYCONFIGID_OFFSET UNITYSDK_OFFSET(0x133934B0)
#define RPG_CLIENT_INVENTORYMODULE_GETLIGHTCONECOUNT_OFFSET UNITYSDK_OFFSET(0x133900A0)
#define RPG_CLIENT_INVENTORYMODULE_GETLIGHTCONEITEMSMAXNUM_OFFSET UNITYSDK_OFFSET(0x13393260)
#define RPG_CLIENT_INVENTORYMODULE_GETMPITEMS_OFFSET UNITYSDK_OFFSET(0x13389990)
#define RPG_CLIENT_INVENTORYMODULE_GETONETIMESYNCITEMAUTOCONVERSIONRECORD_OFFSET UNITYSDK_OFFSET(0x13391AE0)
#define RPG_CLIENT_INVENTORYMODULE_GETPILEITEMS_OFFSET UNITYSDK_OFFSET(0x13390E30)
#define RPG_CLIENT_INVENTORYMODULE_GETQUICKCONSUMABLEITEMBYCONSUMETYPE_OFFSET UNITYSDK_OFFSET(0x1338AA50)
#define RPG_CLIENT_INVENTORYMODULE_GETQUICKCONSUMABLEITEMIDBYCONSUMETYPE_OFFSET UNITYSDK_OFFSET(0x1338A8D0)
#define RPG_CLIENT_INVENTORYMODULE_GETQUICKCONSUMABLEITEMS_OFFSET UNITYSDK_OFFSET(0x1338A010)
#define RPG_CLIENT_INVENTORYMODULE_GETRELICDATABYUID_OFFSET UNITYSDK_OFFSET(0x1338FAD0)
#define RPG_CLIENT_INVENTORYMODULE_GETRELICITEMSMAXNUM_OFFSET UNITYSDK_OFFSET(0x13393360)
#define RPG_CLIENT_INVENTORYMODULE_GETRESBARCOUNTBYCONFIGID_OFFSET UNITYSDK_OFFSET(0x1338EC00)
#define RPG_CLIENT_INVENTORYMODULE_GETREVIVEITEMS_OFFSET UNITYSDK_OFFSET(0x133894C0)
#define RPG_CLIENT_INVENTORYMODULE_GETREWARDITEMDISPLAYDATA_OFFSET UNITYSDK_OFFSET(0x13393510)
#define RPG_CLIENT_INVENTORYMODULE_GETSORTEDMPITEMS_OFFSET UNITYSDK_OFFSET(0x13389C20)
#define RPG_CLIENT_INVENTORYMODULE_GETSORTTYPENAME_OFFSET UNITYSDK_OFFSET(0x13393090)
#define RPG_CLIENT_INVENTORYMODULE_GETSUPERRARELIGHTCONECOUNT_OFFSET UNITYSDK_OFFSET(0x13390130)
#define RPG_CLIENT_INVENTORYMODULE_GETUNIQUEITEMSCOUNTBYMAINTYPE_OFFSET UNITYSDK_OFFSET(0x13390D10)
#define RPG_CLIENT_INVENTORYMODULE_GETUNIQUEITEMSCOUNT_OFFSET UNITYSDK_OFFSET(0x13390CA0)
#define RPG_CLIENT_INVENTORYMODULE_GETUNIQUEITEMS_OFFSET UNITYSDK_OFFSET(0x13390E80)
#define RPG_CLIENT_INVENTORYMODULE_GET_GOTOLOCATEITEMDATA_OFFSET UNITYSDK_OFFSET(0x1339B790)
#define RPG_CLIENT_INVENTORYMODULE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1339B710)
#define RPG_CLIENT_INVENTORYMODULE_GET_ITEMVISIBALEPREDICATE_OFFSET UNITYSDK_OFFSET(0x1339B770)
#define RPG_CLIENT_INVENTORYMODULE_GET_QUICKCONSUMABLEITEMS_OFFSET UNITYSDK_OFFSET(0x1338BE70)
#define RPG_CLIENT_INVENTORYMODULE_GET__QUICKCONSUMABLEFEATURECLOSED_OFFSET UNITYSDK_OFFSET(0x1338BED0)
#define RPG_CLIENT_INVENTORYMODULE_HASITEMINSUBTYPE_OFFSET UNITYSDK_OFFSET(0x13391130)
#define RPG_CLIENT_INVENTORYMODULE_HASMPITEM_OFFSET UNITYSDK_OFFSET(0x13389750)
#define RPG_CLIENT_INVENTORYMODULE_INIT_OFFSET UNITYSDK_OFFSET(0x1338C710)
#define RPG_CLIENT_INVENTORYMODULE_ISCOMEFROMVALID_OFFSET UNITYSDK_OFFSET(0x13393C50)
#define RPG_CLIENT_INVENTORYMODULE_ISFAVORITEFOODREACHMAX_OFFSET UNITYSDK_OFFSET(0x13389460)
#define RPG_CLIENT_INVENTORYMODULE_ISFAVORITENEW_OFFSET UNITYSDK_OFFSET(0x1338AE50)
#define RPG_CLIENT_INVENTORYMODULE_ISITEMCONVERSIONED_OFFSET UNITYSDK_OFFSET(0x13391C10)
#define RPG_CLIENT_INVENTORYMODULE_ISITEMEXPIRED_OFFSET UNITYSDK_OFFSET(0x13391820)
#define RPG_CLIENT_INVENTORYMODULE_ISITEMIMPORTHINTBYID_OFFSET UNITYSDK_OFFSET(0x133937D0)
#define RPG_CLIENT_INVENTORYMODULE_ISITEMIMPORTHINT_OFFSET UNITYSDK_OFFSET(0x13393700)
#define RPG_CLIENT_INVENTORYMODULE_ISQUICKCONSUMABLETURNSWITCHOPEN_1_OFFSET UNITYSDK_OFFSET(0x1338A6B0)
#define RPG_CLIENT_INVENTORYMODULE_ISQUICKCONSUMABLETURNSWITCHOPEN_OFFSET UNITYSDK_OFFSET(0x1338A600)
#define RPG_CLIENT_INVENTORYMODULE_ISREWARDITEMREACHPILELIMIT_OFFSET UNITYSDK_OFFSET(0x133923E0)
#define RPG_CLIENT_INVENTORYMODULE_LOCKALLEQUIPMENTS_OFFSET UNITYSDK_OFFSET(0x133891E0)
#define RPG_CLIENT_INVENTORYMODULE_ONEXPIREDITEMSSHOWN_OFFSET UNITYSDK_OFFSET(0x133912F0)
#define RPG_CLIENT_INVENTORYMODULE_RECORDEXPIREDITEMS_1_OFFSET UNITYSDK_OFFSET(0x13399650)
#define RPG_CLIENT_INVENTORYMODULE_RECORDEXPIREDITEMS_OFFSET UNITYSDK_OFFSET(0x133992E0)
#define RPG_CLIENT_INVENTORYMODULE_SENDCANCELAUTOCONVERSIONCACHECSREQ_OFFSET UNITYSDK_OFFSET(0x13391B20)
#define RPG_CLIENT_INVENTORYMODULE_SENDPACKETSAFTERLOGINFINISHED_OFFSET UNITYSDK_OFFSET(0x1338E790)
#define RPG_CLIENT_INVENTORYMODULE_SETITEMVISIBLEPREDICATE_OFFSET UNITYSDK_OFFSET(0x13392390)
#define RPG_CLIENT_INVENTORYMODULE_SETTURNFOODSWITCH_1_OFFSET UNITYSDK_OFFSET(0x1338A7A0)
#define RPG_CLIENT_INVENTORYMODULE_SETTURNFOODSWITCH_OFFSET UNITYSDK_OFFSET(0x1338A740)
#define RPG_CLIENT_INVENTORYMODULE_SET_GOTOLOCATEITEMDATA_OFFSET UNITYSDK_OFFSET(0x1339B7A0)
#define RPG_CLIENT_INVENTORYMODULE_SET_ITEMVISIBALEPREDICATE_OFFSET UNITYSDK_OFFSET(0x1339B780)
#define RPG_CLIENT_INVENTORYMODULE_SYNCVIRTUALITEMNUM_OFFSET UNITYSDK_OFFSET(0x13392160)
#define RPG_CLIENT_INVENTORYMODULE_TRYGETEXPIREDDISPLAYITEMS_OFFSET UNITYSDK_OFFSET(0x13391470)
#define RPG_CLIENT_INVENTORYMODULE_TRYGETEXPIREDITEMS_OFFSET UNITYSDK_OFFSET(0x13391500)
#define RPG_CLIENT_INVENTORYMODULE_TRYGETEXPIREDTIMEBYITEMID_OFFSET UNITYSDK_OFFSET(0x13391A10)
#define RPG_CLIENT_INVENTORYMODULE_TRYHANDLEREBATEITEMS_OFFSET UNITYSDK_OFFSET(0x13398CB0)
#define RPG_CLIENT_INVENTORYMODULE_TRYSETEXPIREDTIME_OFFSET UNITYSDK_OFFSET(0x13396DD0)
#define RPG_CLIENT_INVENTORYMODULE_TRYSHOWEXPIREDITEMS_OFFSET UNITYSDK_OFFSET(0x133916D0)
#define RPG_CLIENT_INVENTORYMODULE_TRYSHOWUSEBPITEMHINT_OFFSET UNITYSDK_OFFSET(0x13398EA0)
#define RPG_CLIENT_INVENTORYMODULE_TRYSHOWUSEMONTHCARDITEMHINT_OFFSET UNITYSDK_OFFSET(0x13398D10)
#define RPG_CLIENT_INVENTORYMODULE_UNLOCKALLEQUIPMENTS_OFFSET UNITYSDK_OFFSET(0x13388A80)
#define RPG_CLIENT_INVENTORYMODULE_UNLOCKALLRANKMAXEQUIPMENTS_OFFSET UNITYSDK_OFFSET(0x13388DA0)
#define RPG_CLIENT_INVENTORYMODULE_UPDATEAETHERSKILLCORE_OFFSET UNITYSDK_OFFSET(0x133941D0)
#define RPG_CLIENT_INVENTORYMODULE_UPDATEAETHERSPIRITFRAGMENT_OFFSET UNITYSDK_OFFSET(0x13394C90)
#define RPG_CLIENT_INVENTORYMODULE_USEFOODITEM_OFFSET UNITYSDK_OFFSET(0x1338EF70)
#define RPG_CLIENT_INVENTORYMODULE_USEGIFTPACKITEM_OFFSET UNITYSDK_OFFSET(0x1338F080)
#define RPG_CLIENT_INVENTORYMODULE_USEITEM_OFFSET UNITYSDK_OFFSET(0x1338ED90)
#define RPG_CLIENT_INVENTORYMODULE__ADDITEM_OFFSET UNITYSDK_OFFSET(0x133944A0)
#define RPG_CLIENT_INVENTORYMODULE__ADDNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0x13399A10)
#define RPG_CLIENT_INVENTORYMODULE__ADDPACKETHANDLERS_OFFSET UNITYSDK_OFFSET(0x13399A50)
#define RPG_CLIENT_INVENTORYMODULE__ADDUNIQUEITEMS_OFFSET UNITYSDK_OFFSET(0x13396440)
#define RPG_CLIENT_INVENTORYMODULE__CHECKPLATFORMBOUNDGIFT_OFFSET UNITYSDK_OFFSET(0x13398900)
#define RPG_CLIENT_INVENTORYMODULE__CHECKUSEITEMBP_OFFSET UNITYSDK_OFFSET(0x13398610)
#define RPG_CLIENT_INVENTORYMODULE__CHECKUSEITEM_OFFSET UNITYSDK_OFFSET(0x1338EEB0)
#define RPG_CLIENT_INVENTORYMODULE__CLEAREXCEPTVIRTUALITEMS_OFFSET UNITYSDK_OFFSET(0x13394EE0)
#define RPG_CLIENT_INVENTORYMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x1338BFB0)
#define RPG_CLIENT_INVENTORYMODULE__DEFAULTVISIBLEPREDICATE_OFFSET UNITYSDK_OFFSET(0x133999C0)
#define RPG_CLIENT_INVENTORYMODULE__DELETEEQUIPMENTS_OFFSET UNITYSDK_OFFSET(0x133979F0)
#define RPG_CLIENT_INVENTORYMODULE__DELETERELICS_OFFSET UNITYSDK_OFFSET(0x13398020)
#define RPG_CLIENT_INVENTORYMODULE__GETCURRENTPLATFORMTYPE_OFFSET UNITYSDK_OFFSET(0x13398BC0)
#define RPG_CLIENT_INVENTORYMODULE__INITCONVERTIBLEITEM_OFFSET UNITYSDK_OFFSET(0x1338D980)
#define RPG_CLIENT_INVENTORYMODULE__INITHEROAVATAREIDOLONITEMIDLIST_OFFSET UNITYSDK_OFFSET(0x1338DB00)
#define RPG_CLIENT_INVENTORYMODULE__INITMAINTYPEFILTER_OFFSET UNITYSDK_OFFSET(0x1338D3F0)
#define RPG_CLIENT_INVENTORYMODULE__INITSUBTYPEFILTER_OFFSET UNITYSDK_OFFSET(0x1338CE40)
#define RPG_CLIENT_INVENTORYMODULE__INITVIRTUALITEM_OFFSET UNITYSDK_OFFSET(0x1338C950)
#define RPG_CLIENT_INVENTORYMODULE__ISITEMREACHLIMIT_OFFSET UNITYSDK_OFFSET(0x13392B10)
#define RPG_CLIENT_INVENTORYMODULE__ONCANCELMARKITEMNOTIFY_OFFSET UNITYSDK_OFFSET(0x1338B0E0)
#define RPG_CLIENT_INVENTORYMODULE__ONCMDADDEQUIPMENTSCRSP_OFFSET UNITYSDK_OFFSET(0x1339B580)
#define RPG_CLIENT_INVENTORYMODULE__ONCMDDESTROYITEMSCRSP_OFFSET UNITYSDK_OFFSET(0x1339B440)
#define RPG_CLIENT_INVENTORYMODULE__ONCMDEXPUPEQUIPMENTSCRSP_OFFSET UNITYSDK_OFFSET(0x1339ACC0)
#define RPG_CLIENT_INVENTORYMODULE__ONCMDEXPUPRELICSCRSP_OFFSET UNITYSDK_OFFSET(0x1339AFC0)
#define RPG_CLIENT_INVENTORYMODULE__ONCMDGETBAGSCRSP_OFFSET UNITYSDK_OFFSET(0x13399F20)
#define RPG_CLIENT_INVENTORYMODULE__ONCMDGETRECYLETIMESCRSP_OFFSET UNITYSDK_OFFSET(0x1339A150)
#define RPG_CLIENT_INVENTORYMODULE__ONCMDLOCKEQUIPMENTSCRSP_OFFSET UNITYSDK_OFFSET(0x1339AF70)
#define RPG_CLIENT_INVENTORYMODULE__ONCMDLOCKRELICSCRSP_OFFSET UNITYSDK_OFFSET(0x1339B260)
#define RPG_CLIENT_INVENTORYMODULE__ONCMDPLAYERLOGINSCRSP_OFFSET UNITYSDK_OFFSET(0x1339A0B0)
#define RPG_CLIENT_INVENTORYMODULE__ONCMDPLAYERSYNCSCNOTIFY_OFFSET UNITYSDK_OFFSET(0x1339A4B0)
#define RPG_CLIENT_INVENTORYMODULE__ONCMDPROMOTEEQUIPMENTSCRSP_OFFSET UNITYSDK_OFFSET(0x1339AEB0)
#define RPG_CLIENT_INVENTORYMODULE__ONCMDRANKUPEQUIPMENTSCRSP_OFFSET UNITYSDK_OFFSET(0x1339AF10)
#define RPG_CLIENT_INVENTORYMODULE__ONCMDSELLITEMSCRSP_OFFSET UNITYSDK_OFFSET(0x1339B2B0)
#define RPG_CLIENT_INVENTORYMODULE__ONCMDSETTURNFOODSWITCHSCRSP_OFFSET UNITYSDK_OFFSET(0x1338B690)
#define RPG_CLIENT_INVENTORYMODULE__ONCMDSYNCTURNFOODNOTIFY_OFFSET UNITYSDK_OFFSET(0x1338B6E0)
#define RPG_CLIENT_INVENTORYMODULE__ONCMDUSEITEMSCRSP_OFFSET UNITYSDK_OFFSET(0x1339A7F0)
#define RPG_CLIENT_INVENTORYMODULE__ONDISCARDRELICSCRSP_OFFSET UNITYSDK_OFFSET(0x1339B1B0)
#define RPG_CLIENT_INVENTORYMODULE__ONGENERALVIRTUALITEMDATANOTIFY_OFFSET UNITYSDK_OFFSET(0x1339B640)
#define RPG_CLIENT_INVENTORYMODULE__ONGETMARKITEMLISTSCRSP_OFFSET UNITYSDK_OFFSET(0x1338B270)
#define RPG_CLIENT_INVENTORYMODULE__ONGETPLAYERBOARDDATASCRSP_OFFSET UNITYSDK_OFFSET(0x1339B4D0)
#define RPG_CLIENT_INVENTORYMODULE__ONMARKITEMSCRSP_OFFSET UNITYSDK_OFFSET(0x1338AF00)
#define RPG_CLIENT_INVENTORYMODULE__ONSTAMINAINFOSCNOTIFY_OFFSET UNITYSDK_OFFSET(0x1339A440)
#define RPG_CLIENT_INVENTORYMODULE__PROCESSNEWMATERIALITEM_OFFSET UNITYSDK_OFFSET(0x13396CA0)
#define RPG_CLIENT_INVENTORYMODULE__RECORDITEMAUTOCONVERSION_OFFSET UNITYSDK_OFFSET(0x13391C80)
#define RPG_CLIENT_INVENTORYMODULE__RECORDONETIMESYNCITEMAUTOCONVERSION_OFFSET UNITYSDK_OFFSET(0x13392010)
#define RPG_CLIENT_INVENTORYMODULE__REMOVEITEMBYSUBTYPE_OFFSET UNITYSDK_OFFSET(0x13395590)
#define RPG_CLIENT_INVENTORYMODULE__REMOVEITEM_OFFSET UNITYSDK_OFFSET(0x133948F0)
#define RPG_CLIENT_INVENTORYMODULE__RESETMAINTYPEFILTER_OFFSET UNITYSDK_OFFSET(0x133902C0)
#define RPG_CLIENT_INVENTORYMODULE__RESETSUBTYPEFILTER_OFFSET UNITYSDK_OFFSET(0x13390420)
#define RPG_CLIENT_INVENTORYMODULE__SYNCGENERALVIRTUALITEMS_OFFSET UNITYSDK_OFFSET(0x13398460)
#define RPG_CLIENT_INVENTORYMODULE__SYNCQUICKCONSUMABLEITEM_OFFSET UNITYSDK_OFFSET(0x1338B7B0)
#define RPG_CLIENT_INVENTORYMODULE__SYNCQUICKCONSUMABLETURNSWITCH_OFFSET UNITYSDK_OFFSET(0x1338BAF0)
#define RPG_CLIENT_INVENTORYMODULE__UPDATEBASICMODULE_OFFSET UNITYSDK_OFFSET(0x13395980)
#define RPG_CLIENT_INVENTORYMODULE__UPDATEEQUIPMENTS_OFFSET UNITYSDK_OFFSET(0x13397780)
#define RPG_CLIENT_INVENTORYMODULE__UPDATEHEADICONS_OFFSET UNITYSDK_OFFSET(0x13396250)
#define RPG_CLIENT_INVENTORYMODULE__UPDATEMATERIALS_OFFSET UNITYSDK_OFFSET(0x133969D0)
#define RPG_CLIENT_INVENTORYMODULE__UPDATEPERSONALCARDS_OFFSET UNITYSDK_OFFSET(0x133981F0)
#define RPG_CLIENT_INVENTORYMODULE__UPDATEPETSUMMONITEMS_OFFSET UNITYSDK_OFFSET(0x133967F0)
#define RPG_CLIENT_INVENTORYMODULE__UPDATEPILEITEMWITHCOUNT_OFFSET UNITYSDK_OFFSET(0x13394D30)
#define RPG_CLIENT_INVENTORYMODULE__UPDATEPLATFORMBOUNDGIFTS_OFFSET UNITYSDK_OFFSET(0x13396EE0)
#define RPG_CLIENT_INVENTORYMODULE__UPDATEPLAYERBOARDMODULE_OFFSET UNITYSDK_OFFSET(0x13395A70)
#define RPG_CLIENT_INVENTORYMODULE__UPDATERELICS_OFFSET UNITYSDK_OFFSET(0x13397BC0)
#define RPG_CLIENT_INVENTORYMODULE__UPDATESTAMINAINFO_OFFSET UNITYSDK_OFFSET(0x133959E0)
#define RPG_CLIENT_INVENTORYMODULE__UPDATEVIRTUALITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x13395860)
#define RPG_CLIENT_INVENTORYMODULE__UPDATEVIRTUALITEMS_OFFSET UNITYSDK_OFFSET(0x133957C0)
#define RPG_CLIENT_INVENTORYMODULE__UPDATEWAITDELRESOUCE_OFFSET UNITYSDK_OFFSET(0x13398230)
#define RPG_CLIENT_INVENTORYMODULE___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1339B8D0)
#define RPG_CLIENT_INVENTORYMODULE___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x1339B840)
#define RPG_CLIENT_INVENTORYMODULE___IFIXBASEPROXY__ADDNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0x1339B8E0)
#define RPG_CLIENT_INVENTORYMODULE___IFIXBASEPROXY__ADDPACKETHANDLERS_OFFSET UNITYSDK_OFFSET(0x1339B940)
#define RPG_CLIENT_INVENTORYMODULE___SYNCQUICKCONSUMABLEITEM_B__24_0_OFFSET UNITYSDK_OFFSET(0x1339B7B0)
#define RPG_CLIENT_INVENTORYMODULE___SYNCQUICKCONSUMABLETURNSWITCH_B__25_0_OFFSET UNITYSDK_OFFSET(0x1339B7E0)
...
namespace RPG::Client
{
	...
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::UInt32>* _UniqueItemCountDict; // 0x10
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::ItemData*>* _UniqueItems; // 0x18
		::RPG::GameCore::InventoryTabRow* _ConsumableRow; // 0x20
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::ItemDisplayData*>* _ExpiredItems; // 0x28
		::System::Predicate_1<::System::UInt32>* _ItemVisibalePredicate_k__BackingField; // 0x30
		::System::Collections::Generic::List_1<::System::UInt32>* _HeroAvatarEidolonItemIdList; // 0x38
		...
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::UInt64>* _ExpiredTimes; // 0x50
		::System::Collections::Generic::List_1<::System::UInt32>* _QuickConsumbaleItems; // 0x58
		::RPG::Client::ItemData* _GotoLocateItemData_k__BackingField; // 0x60
		::System::Collections::Generic::List_1<::RPG::Client::ItemData*>* _FoundItemDatasCache; // 0x68
		::System::Collections::Generic::List_1<::System::UInt32>* _FavoriteFoodItems; // 0x70
		::System::Collections::Generic::Dictionary_2<::RPG::GameCore::ItemMainType, ::System::Boolean>* _MainTypeFilter; // 0x78
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::UInt32>* _WaitDelItemCount; // 0x80
		::System::Collections::Generic::HashSet_1<::Enum_3_0A3761FE34514D6C_46>* _QuickConsumableSwitches; // 0x88
		::System::Collections::Generic::List_1<::RPG::Client::ConvertibleItemData*>* _ConvertibleItems; // 0x90
		::System::Collections::Generic::HashSet_1<::RPG::GameCore::ItemSubType>* _PileItemSubTypes; // 0x98
		...
		::System::Void _UpdateVirtualItems(::Class_1_21DCD4640D389503_2* basicInfo)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_21DCD4640D389503_2*))((::PBYTE)hIl2Cpp + RPG_CLIENT_INVENTORYMODULE__UPDATEVIRTUALITEMS_OFFSET))(this, basicInfo);
		}
		...
		::System::Void _UpdatePlayerBoardModule(::Class_1_7E1E05C17C895270* moduleSync)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_7E1E05C17C895270*))((::PBYTE)hIl2Cpp + RPG_CLIENT_INVENTORYMODULE__UPDATEPLAYERBOARDMODULE_OFFSET))(this, moduleSync);
		}
		...
		::System::Void _UpdateEquipments(::System::Collections::Generic::IList_1<::Class_1_EBB10EC01CCC4716_11*>* equipmentList, ::System::Boolean fromLogin)
		{
			return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::IList_1<::Class_1_EBB10EC01CCC4716_11*>*, ::System::Boolean))((::PBYTE)hIl2Cpp + RPG_CLIENT_INVENTORYMODULE__UPDATEEQUIPMENTS_OFFSET))(this, equipmentList, fromLogin);
		}
