...
#define RPG_CLIENT_INVENTORYMODULE_CHECKISHEROAVATAREIDOLONITEMTYPE_OFFSET UNITYSDK_OFFSET(0x99648F0)
#define RPG_CLIENT_INVENTORYMODULE_CHECKUSEITEM_OFFSET UNITYSDK_OFFSET(0x99615B0)
#define RPG_CLIENT_INVENTORYMODULE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9960930)
#define RPG_CLIENT_INVENTORYMODULE_ENABLESETFAVORITE_OFFSET UNITYSDK_OFFSET(0x995D4A0)
#define RPG_CLIENT_INVENTORYMODULE_FINDALLEQUIPMENTS_OFFSET UNITYSDK_OFFSET(0x9961E70)
#define RPG_CLIENT_INVENTORYMODULE_FINDEQUIPMENT_OFFSET UNITYSDK_OFFSET(0x9961D00)
#define RPG_CLIENT_INVENTORYMODULE_FINDTABIDBYITEMID_OFFSET UNITYSDK_OFFSET(0x9962D80)
#define RPG_CLIENT_INVENTORYMODULE_GETAETHERSKILLCOREITEMDATABYCONFIGID_OFFSET UNITYSDK_OFFSET(0x9964A90)
#define RPG_CLIENT_INVENTORYMODULE_GETCONVERTIBLEITEMDATABYITEMID_OFFSET UNITYSDK_OFFSET(0x99655C0)
#define RPG_CLIENT_INVENTORYMODULE_GETCONVERTIBLEITEMDATABYITEMSUBTYPE_OFFSET UNITYSDK_OFFSET(0x99654E0)
#define RPG_CLIENT_INVENTORYMODULE_GETEQUIPMENTDATABYCONFIGID_OFFSET UNITYSDK_OFFSET(0x9961BB0)
#define RPG_CLIENT_INVENTORYMODULE_GETEQUIPMENTDATABYUID_OFFSET UNITYSDK_OFFSET(0x9962050)
#define RPG_CLIENT_INVENTORYMODULE_GETEQUIPMENTMAXRANKANDCOUNTBYCONFIGID_OFFSET UNITYSDK_OFFSET(0x9961A30)
#define RPG_CLIENT_INVENTORYMODULE_GETEQUIPMENTMAXRANKBYCONFIGID_OFFSET UNITYSDK_OFFSET(0x99618C0)
#define RPG_CLIENT_INVENTORYMODULE_GETFOODCOUNTBYCONSUMETYPEID_OFFSET UNITYSDK_OFFSET(0x995C490)
#define RPG_CLIENT_INVENTORYMODULE_GETFOODITEMSBYCONSUMETYPE_OFFSET UNITYSDK_OFFSET(0x995CAB0)
#define RPG_CLIENT_INVENTORYMODULE_GETFOODITEMSBYMAZEBUFFPOOL_OFFSET UNITYSDK_OFFSET(0x9963640)
#define RPG_CLIENT_INVENTORYMODULE_GETHCOINCONFIGID_OFFSET UNITYSDK_OFFSET(0x99659E0)
#define RPG_CLIENT_INVENTORYMODULE_GETINVENTORYTABITEMS_OFFSET UNITYSDK_OFFSET(0x9963040)
#define RPG_CLIENT_INVENTORYMODULE_GETISPILEBYCONFIGID_OFFSET UNITYSDK_OFFSET(0x9965460)
#define RPG_CLIENT_INVENTORYMODULE_GETISPILEBYITEMMAINTYPE_OFFSET UNITYSDK_OFFSET(0x9965C60)
#define RPG_CLIENT_INVENTORYMODULE_GETISPILEBYITEMSUBTYPE_OFFSET UNITYSDK_OFFSET(0x9963A40)
#define RPG_CLIENT_INVENTORYMODULE_GETITEMAUTOCONVERSIONRECORDS_OFFSET UNITYSDK_OFFSET(0x9964240)
#define RPG_CLIENT_INVENTORYMODULE_GETITEMCOMEFROM_OFFSET UNITYSDK_OFFSET(0x9966020)
#define RPG_CLIENT_INVENTORYMODULE_GETITEMCOUNTAFTERDELETEBYCONFIGID_OFFSET UNITYSDK_OFFSET(0x99610A0)
#define RPG_CLIENT_INVENTORYMODULE_GETITEMCOUNTBYCONFIGID_OFFSET UNITYSDK_OFFSET(0x9961040)
#define RPG_CLIENT_INVENTORYMODULE_GETITEMDATABYCONFIGID_OFFSET UNITYSDK_OFFSET(0x995D2A0)
#define RPG_CLIENT_INVENTORYMODULE_GETITEMDATABYUID_OFFSET UNITYSDK_OFFSET(0x9961800)
#define RPG_CLIENT_INVENTORYMODULE_GETITEMRARITYCONFIG_OFFSET UNITYSDK_OFFSET(0x99657D0)
#define RPG_CLIENT_INVENTORYMODULE_GETITEMROW_OFFSET UNITYSDK_OFFSET(0x99656A0)
#define RPG_CLIENT_INVENTORYMODULE_GETITEMSBYMAINTYPES_OFFSET UNITYSDK_OFFSET(0x995B780)
#define RPG_CLIENT_INVENTORYMODULE_GETITEMSBYSUBTYPES_OFFSET UNITYSDK_OFFSET(0x995C1A0)
#define RPG_CLIENT_INVENTORYMODULE_GETITEMSBYSUBTYPE_OFFSET UNITYSDK_OFFSET(0x99622D0)
#define RPG_CLIENT_INVENTORYMODULE_GETITEMSINTYPES_OFFSET UNITYSDK_OFFSET(0x9962380)
#define RPG_CLIENT_INVENTORYMODULE_GETITEMUSEDATAROWBYCONFIGID_OFFSET UNITYSDK_OFFSET(0x9965CB0)
#define RPG_CLIENT_INVENTORYMODULE_GETLIGHTCONECOUNT_OFFSET UNITYSDK_OFFSET(0x99627B0)
#define RPG_CLIENT_INVENTORYMODULE_GETLIGHTCONEITEMSMAXNUM_OFFSET UNITYSDK_OFFSET(0x9965A60)
#define RPG_CLIENT_INVENTORYMODULE_GETMPITEMS_OFFSET UNITYSDK_OFFSET(0x995C200)
#define RPG_CLIENT_INVENTORYMODULE_GETONETIMESYNCITEMAUTOCONVERSIONRECORD_OFFSET UNITYSDK_OFFSET(0x9964290)
#define RPG_CLIENT_INVENTORYMODULE_GETPILEITEMS_OFFSET UNITYSDK_OFFSET(0x99635C0)
#define RPG_CLIENT_INVENTORYMODULE_GETQUICKCONSUMABLEITEMBYCONSUMETYPE_OFFSET UNITYSDK_OFFSET(0x995D150)
#define RPG_CLIENT_INVENTORYMODULE_GETQUICKCONSUMABLEITEMIDBYCONSUMETYPE_OFFSET UNITYSDK_OFFSET(0x995CFD0)
#define RPG_CLIENT_INVENTORYMODULE_GETQUICKCONSUMABLEITEMS_OFFSET UNITYSDK_OFFSET(0x995C6F0)
#define RPG_CLIENT_INVENTORYMODULE_GETRELICDATABYUID_OFFSET UNITYSDK_OFFSET(0x9962190)
#define RPG_CLIENT_INVENTORYMODULE_GETRELICITEMSMAXNUM_OFFSET UNITYSDK_OFFSET(0x9965B60)
#define RPG_CLIENT_INVENTORYMODULE_GETRESBARCOUNTBYCONFIGID_OFFSET UNITYSDK_OFFSET(0x99612C0)
#define RPG_CLIENT_INVENTORYMODULE_GETREVIVEITEMS_OFFSET UNITYSDK_OFFSET(0x995BF50)
#define RPG_CLIENT_INVENTORYMODULE_GETREWARDITEMDISPLAYDATA_OFFSET UNITYSDK_OFFSET(0x9965D10)
#define RPG_CLIENT_INVENTORYMODULE_GETSORTTYPENAME_OFFSET UNITYSDK_OFFSET(0x9965890)
#define RPG_CLIENT_INVENTORYMODULE_GETSUPERRARELIGHTCONECOUNT_OFFSET UNITYSDK_OFFSET(0x9962870)
#define RPG_CLIENT_INVENTORYMODULE_GETUNIQUEITEMSCOUNTBYMAINTYPE_OFFSET UNITYSDK_OFFSET(0x99634A0)
#define RPG_CLIENT_INVENTORYMODULE_GETUNIQUEITEMSCOUNT_OFFSET UNITYSDK_OFFSET(0x9963430)
#define RPG_CLIENT_INVENTORYMODULE_GETUNIQUEITEMS_OFFSET UNITYSDK_OFFSET(0x9963600)
#define RPG_CLIENT_INVENTORYMODULE_GET_GOTOLOCATEITEMDATA_OFFSET UNITYSDK_OFFSET(0x996DF90)
#define RPG_CLIENT_INVENTORYMODULE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x996DF10)
#define RPG_CLIENT_INVENTORYMODULE_GET_ITEMVISIBALEPREDICATE_OFFSET UNITYSDK_OFFSET(0x996DF70)
#define RPG_CLIENT_INVENTORYMODULE_GET_QUICKCONSUMABLEITEMS_OFFSET UNITYSDK_OFFSET(0x995E560)
#define RPG_CLIENT_INVENTORYMODULE_GET__QUICKCONSUMABLEFEATURECLOSED_OFFSET UNITYSDK_OFFSET(0x995E5C0)
#define RPG_CLIENT_INVENTORYMODULE_HASITEMINSUBTYPE_OFFSET UNITYSDK_OFFSET(0x99638D0)
#define RPG_CLIENT_INVENTORYMODULE_INIT_OFFSET UNITYSDK_OFFSET(0x995EE00)
#define RPG_CLIENT_INVENTORYMODULE_ISCOMEFROMVALID_OFFSET UNITYSDK_OFFSET(0x9966450)
#define RPG_CLIENT_INVENTORYMODULE_ISFAVORITEFOODREACHMAX_OFFSET UNITYSDK_OFFSET(0x995BEF0)
#define RPG_CLIENT_INVENTORYMODULE_ISFAVORITENEW_OFFSET UNITYSDK_OFFSET(0x995D550)
#define RPG_CLIENT_INVENTORYMODULE_ISITEMCONVERSIONED_OFFSET UNITYSDK_OFFSET(0x99643C0)
#define RPG_CLIENT_INVENTORYMODULE_ISITEMEXPIRED_OFFSET UNITYSDK_OFFSET(0x9963FD0)
#define RPG_CLIENT_INVENTORYMODULE_ISITEMIMPORTHINTBYID_OFFSET UNITYSDK_OFFSET(0x9965FD0)
#define RPG_CLIENT_INVENTORYMODULE_ISITEMIMPORTHINT_OFFSET UNITYSDK_OFFSET(0x9965F00)
#define RPG_CLIENT_INVENTORYMODULE_ISQUICKCONSUMABLETURNSWITCHOPEN_1_OFFSET UNITYSDK_OFFSET(0x995CDB0)
#define RPG_CLIENT_INVENTORYMODULE_ISQUICKCONSUMABLETURNSWITCHOPEN_OFFSET UNITYSDK_OFFSET(0x995CD10)
#define RPG_CLIENT_INVENTORYMODULE_ISREWARDITEMREACHPILELIMIT_OFFSET UNITYSDK_OFFSET(0x9964BE0)
#define RPG_CLIENT_INVENTORYMODULE_LOCKALLEQUIPMENTS_OFFSET UNITYSDK_OFFSET(0x995BC40)
#define RPG_CLIENT_INVENTORYMODULE_ONEXPIREDITEMSSHOWN_OFFSET UNITYSDK_OFFSET(0x9963A90)
#define RPG_CLIENT_INVENTORYMODULE_RECORDEXPIREDITEMS_1_OFFSET UNITYSDK_OFFSET(0x996BE30)
#define RPG_CLIENT_INVENTORYMODULE_RECORDEXPIREDITEMS_OFFSET UNITYSDK_OFFSET(0x996BAC0)
#define RPG_CLIENT_INVENTORYMODULE_SENDCANCELAUTOCONVERSIONCACHECSREQ_OFFSET UNITYSDK_OFFSET(0x99642D0)
#define RPG_CLIENT_INVENTORYMODULE_SENDPACKETSAFTERLOGINFINISHED_OFFSET UNITYSDK_OFFSET(0x9960E60)
#define RPG_CLIENT_INVENTORYMODULE_SETITEMVISIBLEPREDICATE_OFFSET UNITYSDK_OFFSET(0x9964B90)
#define RPG_CLIENT_INVENTORYMODULE_SETTURNFOODSWITCH_1_OFFSET UNITYSDK_OFFSET(0x995CEA0)
#define RPG_CLIENT_INVENTORYMODULE_SETTURNFOODSWITCH_OFFSET UNITYSDK_OFFSET(0x995CE40)
#define RPG_CLIENT_INVENTORYMODULE_SET_GOTOLOCATEITEMDATA_OFFSET UNITYSDK_OFFSET(0x996DFA0)
#define RPG_CLIENT_INVENTORYMODULE_SET_ITEMVISIBALEPREDICATE_OFFSET UNITYSDK_OFFSET(0x996DF80)
#define RPG_CLIENT_INVENTORYMODULE_SYNCVIRTUALITEMNUM_OFFSET UNITYSDK_OFFSET(0x9964950)
#define RPG_CLIENT_INVENTORYMODULE_TRYGETEXPIREDDISPLAYITEMS_OFFSET UNITYSDK_OFFSET(0x9963C20)
#define RPG_CLIENT_INVENTORYMODULE_TRYGETEXPIREDITEMS_OFFSET UNITYSDK_OFFSET(0x9963CB0)
#define RPG_CLIENT_INVENTORYMODULE_TRYGETEXPIREDTIMEBYITEMID_OFFSET UNITYSDK_OFFSET(0x99641C0)
#define RPG_CLIENT_INVENTORYMODULE_TRYHANDLEREBATEITEMS_OFFSET UNITYSDK_OFFSET(0x996B490)
#define RPG_CLIENT_INVENTORYMODULE_TRYSETEXPIREDTIME_OFFSET UNITYSDK_OFFSET(0x9969610)
#define RPG_CLIENT_INVENTORYMODULE_TRYSHOWEXPIREDITEMS_OFFSET UNITYSDK_OFFSET(0x9963E80)
#define RPG_CLIENT_INVENTORYMODULE_TRYSHOWUSEBPITEMHINT_OFFSET UNITYSDK_OFFSET(0x996B680)
#define RPG_CLIENT_INVENTORYMODULE_TRYSHOWUSEMONTHCARDITEMHINT_OFFSET UNITYSDK_OFFSET(0x996B4F0)
#define RPG_CLIENT_INVENTORYMODULE_UNLOCKALLEQUIPMENTS_OFFSET UNITYSDK_OFFSET(0x995B4C0)
#define RPG_CLIENT_INVENTORYMODULE_UNLOCKALLRANKMAXEQUIPMENTS_OFFSET UNITYSDK_OFFSET(0x995B800)
#define RPG_CLIENT_INVENTORYMODULE_UPDATEAETHERSKILLCORE_OFFSET UNITYSDK_OFFSET(0x99669B0)
#define RPG_CLIENT_INVENTORYMODULE_UPDATEAETHERSPIRITFRAGMENT_OFFSET UNITYSDK_OFFSET(0x9967470)
#define RPG_CLIENT_INVENTORYMODULE_USEFOODITEM_OFFSET UNITYSDK_OFFSET(0x9961620)
#define RPG_CLIENT_INVENTORYMODULE_USEGIFTPACKITEM_OFFSET UNITYSDK_OFFSET(0x9961730)
#define RPG_CLIENT_INVENTORYMODULE_USEITEM_OFFSET UNITYSDK_OFFSET(0x9961440)
#define RPG_CLIENT_INVENTORYMODULE__ADDITEM_OFFSET UNITYSDK_OFFSET(0x9966C80)
#define RPG_CLIENT_INVENTORYMODULE__ADDNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0x996C1F0)
#define RPG_CLIENT_INVENTORYMODULE__ADDPACKETHANDLERS_OFFSET UNITYSDK_OFFSET(0x996C230)
#define RPG_CLIENT_INVENTORYMODULE__ADDUNIQUEITEMS_OFFSET UNITYSDK_OFFSET(0x9968C90)
#define RPG_CLIENT_INVENTORYMODULE__CHECKPLATFORMBOUNDGIFT_OFFSET UNITYSDK_OFFSET(0x996B0F0)
#define RPG_CLIENT_INVENTORYMODULE__CHECKUSEITEMBP_OFFSET UNITYSDK_OFFSET(0x996AE00)
#define RPG_CLIENT_INVENTORYMODULE__CHECKUSEITEM_OFFSET UNITYSDK_OFFSET(0x9961560)
#define RPG_CLIENT_INVENTORYMODULE__CLEAREXCEPTVIRTUALITEMS_OFFSET UNITYSDK_OFFSET(0x99676C0)
#define RPG_CLIENT_INVENTORYMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x995E6A0)
#define RPG_CLIENT_INVENTORYMODULE__DEFAULTVISIBLEPREDICATE_OFFSET UNITYSDK_OFFSET(0x996C1A0)
#define RPG_CLIENT_INVENTORYMODULE__DELETEEQUIPMENTS_OFFSET UNITYSDK_OFFSET(0x996A200)
#define RPG_CLIENT_INVENTORYMODULE__DELETERELICS_OFFSET UNITYSDK_OFFSET(0x996A830)
#define RPG_CLIENT_INVENTORYMODULE__GETCURRENTPLATFORMTYPE_OFFSET UNITYSDK_OFFSET(0x996B3A0)
#define RPG_CLIENT_INVENTORYMODULE__INITCONVERTIBLEITEM_OFFSET UNITYSDK_OFFSET(0x9960070)
#define RPG_CLIENT_INVENTORYMODULE__INITHEROAVATAREIDOLONITEMIDLIST_OFFSET UNITYSDK_OFFSET(0x99601F0)
#define RPG_CLIENT_INVENTORYMODULE__INITMAINTYPEFILTER_OFFSET UNITYSDK_OFFSET(0x995FAE0)
#define RPG_CLIENT_INVENTORYMODULE__INITSUBTYPEFILTER_OFFSET UNITYSDK_OFFSET(0x995F530)
#define RPG_CLIENT_INVENTORYMODULE__INITVIRTUALITEM_OFFSET UNITYSDK_OFFSET(0x995F040)
#define RPG_CLIENT_INVENTORYMODULE__ISITEMREACHLIMIT_OFFSET UNITYSDK_OFFSET(0x9965310)
#define RPG_CLIENT_INVENTORYMODULE__ONCANCELMARKITEMNOTIFY_OFFSET UNITYSDK_OFFSET(0x995D7E0)
#define RPG_CLIENT_INVENTORYMODULE__ONCMDADDEQUIPMENTSCRSP_OFFSET UNITYSDK_OFFSET(0x996DD70)
#define RPG_CLIENT_INVENTORYMODULE__ONCMDDESTROYITEMSCRSP_OFFSET UNITYSDK_OFFSET(0x996DC30)
#define RPG_CLIENT_INVENTORYMODULE__ONCMDEXPUPEQUIPMENTSCRSP_OFFSET UNITYSDK_OFFSET(0x996D4B0)
#define RPG_CLIENT_INVENTORYMODULE__ONCMDEXPUPRELICSCRSP_OFFSET UNITYSDK_OFFSET(0x996D7B0)
#define RPG_CLIENT_INVENTORYMODULE__ONCMDGETBAGSCRSP_OFFSET UNITYSDK_OFFSET(0x996C700)
#define RPG_CLIENT_INVENTORYMODULE__ONCMDGETRECYLETIMESCRSP_OFFSET UNITYSDK_OFFSET(0x996C940)
#define RPG_CLIENT_INVENTORYMODULE__ONCMDLOCKEQUIPMENTSCRSP_OFFSET UNITYSDK_OFFSET(0x996D760)
#define RPG_CLIENT_INVENTORYMODULE__ONCMDLOCKRELICSCRSP_OFFSET UNITYSDK_OFFSET(0x996DA50)
#define RPG_CLIENT_INVENTORYMODULE__ONCMDPLAYERLOGINSCRSP_OFFSET UNITYSDK_OFFSET(0x996C8A0)
#define RPG_CLIENT_INVENTORYMODULE__ONCMDPLAYERSYNCSCNOTIFY_OFFSET UNITYSDK_OFFSET(0x996CCA0)
#define RPG_CLIENT_INVENTORYMODULE__ONCMDPROMOTEEQUIPMENTSCRSP_OFFSET UNITYSDK_OFFSET(0x996D6A0)
#define RPG_CLIENT_INVENTORYMODULE__ONCMDRANKUPEQUIPMENTSCRSP_OFFSET UNITYSDK_OFFSET(0x996D700)
#define RPG_CLIENT_INVENTORYMODULE__ONCMDSELLITEMSCRSP_OFFSET UNITYSDK_OFFSET(0x996DAA0)
#define RPG_CLIENT_INVENTORYMODULE__ONCMDSETTURNFOODSWITCHSCRSP_OFFSET UNITYSDK_OFFSET(0x995DD80)
#define RPG_CLIENT_INVENTORYMODULE__ONCMDSYNCTURNFOODNOTIFY_OFFSET UNITYSDK_OFFSET(0x995DDD0)
#define RPG_CLIENT_INVENTORYMODULE__ONCMDUSEITEMSCRSP_OFFSET UNITYSDK_OFFSET(0x996CFE0)
#define RPG_CLIENT_INVENTORYMODULE__ONDISCARDRELICSCRSP_OFFSET UNITYSDK_OFFSET(0x996D9A0)
#define RPG_CLIENT_INVENTORYMODULE__ONGENERALVIRTUALITEMDATANOTIFY_OFFSET UNITYSDK_OFFSET(0x996DE40)
#define RPG_CLIENT_INVENTORYMODULE__ONGETMARKITEMLISTSCRSP_OFFSET UNITYSDK_OFFSET(0x995D960)
#define RPG_CLIENT_INVENTORYMODULE__ONGETPLAYERBOARDDATASCRSP_OFFSET UNITYSDK_OFFSET(0x996DCC0)
#define RPG_CLIENT_INVENTORYMODULE__ONMARKITEMSCRSP_OFFSET UNITYSDK_OFFSET(0x995D600)
#define RPG_CLIENT_INVENTORYMODULE__ONSTAMINAINFOSCNOTIFY_OFFSET UNITYSDK_OFFSET(0x996CC30)
#define RPG_CLIENT_INVENTORYMODULE__PROCESSNEWMATERIALITEM_OFFSET UNITYSDK_OFFSET(0x99694E0)
#define RPG_CLIENT_INVENTORYMODULE__RECORDITEMAUTOCONVERSION_OFFSET UNITYSDK_OFFSET(0x9964430)
#define RPG_CLIENT_INVENTORYMODULE__RECORDONETIMESYNCITEMAUTOCONVERSION_OFFSET UNITYSDK_OFFSET(0x99647E0)
#define RPG_CLIENT_INVENTORYMODULE__REMOVEITEMBYSUBTYPE_OFFSET UNITYSDK_OFFSET(0x9967D90)
#define RPG_CLIENT_INVENTORYMODULE__REMOVEITEM_OFFSET UNITYSDK_OFFSET(0x99670D0)
#define RPG_CLIENT_INVENTORYMODULE__RESETMAINTYPEFILTER_OFFSET UNITYSDK_OFFSET(0x9962A30)
#define RPG_CLIENT_INVENTORYMODULE__RESETSUBTYPEFILTER_OFFSET UNITYSDK_OFFSET(0x9962B90)
#define RPG_CLIENT_INVENTORYMODULE__SYNCGENERALVIRTUALITEMS_OFFSET UNITYSDK_OFFSET(0x996AC50)
#define RPG_CLIENT_INVENTORYMODULE__SYNCQUICKCONSUMABLEITEM_OFFSET UNITYSDK_OFFSET(0x995DEA0)
#define RPG_CLIENT_INVENTORYMODULE__SYNCQUICKCONSUMABLETURNSWITCH_OFFSET UNITYSDK_OFFSET(0x995E1E0)
#define RPG_CLIENT_INVENTORYMODULE__UPDATEBASICMODULE_OFFSET UNITYSDK_OFFSET(0x9968170)
#define RPG_CLIENT_INVENTORYMODULE__UPDATEEQUIPMENTS_OFFSET UNITYSDK_OFFSET(0x9969F90)
#define RPG_CLIENT_INVENTORYMODULE__UPDATEHEADICONS_OFFSET UNITYSDK_OFFSET(0x9968AA0)
#define RPG_CLIENT_INVENTORYMODULE__UPDATEMATERIALS_OFFSET UNITYSDK_OFFSET(0x9969210)
#define RPG_CLIENT_INVENTORYMODULE__UPDATEPERSONALCARDS_OFFSET UNITYSDK_OFFSET(0x996AA00)
#define RPG_CLIENT_INVENTORYMODULE__UPDATEPETSUMMONITEMS_OFFSET UNITYSDK_OFFSET(0x9969040)
#define RPG_CLIENT_INVENTORYMODULE__UPDATEPILEITEMWITHCOUNT_OFFSET UNITYSDK_OFFSET(0x9967510)
#define RPG_CLIENT_INVENTORYMODULE__UPDATEPLATFORMBOUNDGIFTS_OFFSET UNITYSDK_OFFSET(0x9969720)
#define RPG_CLIENT_INVENTORYMODULE__UPDATEPLAYERBOARDMODULE_OFFSET UNITYSDK_OFFSET(0x9968260)
#define RPG_CLIENT_INVENTORYMODULE__UPDATERELICS_OFFSET UNITYSDK_OFFSET(0x996A3D0)
#define RPG_CLIENT_INVENTORYMODULE__UPDATESTAMINAINFO_OFFSET UNITYSDK_OFFSET(0x99681D0)
#define RPG_CLIENT_INVENTORYMODULE__UPDATEVIRTUALITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x9968060)
#define RPG_CLIENT_INVENTORYMODULE__UPDATEVIRTUALITEMS_OFFSET UNITYSDK_OFFSET(0x9967FC0)
#define RPG_CLIENT_INVENTORYMODULE__UPDATEWAITDELRESOUCE_OFFSET UNITYSDK_OFFSET(0x996AA40)
#define RPG_CLIENT_INVENTORYMODULE___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x996E0D0)
#define RPG_CLIENT_INVENTORYMODULE___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x996E040)
#define RPG_CLIENT_INVENTORYMODULE___IFIXBASEPROXY__ADDNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0x996E0E0)
#define RPG_CLIENT_INVENTORYMODULE___IFIXBASEPROXY__ADDPACKETHANDLERS_OFFSET UNITYSDK_OFFSET(0x996E140)
#define RPG_CLIENT_INVENTORYMODULE___SYNCQUICKCONSUMABLEITEM_B__22_0_OFFSET UNITYSDK_OFFSET(0x996DFB0)
#define RPG_CLIENT_INVENTORYMODULE___SYNCQUICKCONSUMABLETURNSWITCH_B__23_0_OFFSET UNITYSDK_OFFSET(0x996DFE0)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Collections::Generic::HashSet_1<::Enum_3_0A3761FE34514D6C_45>* _QuickConsumableSwitches; // 0x18
		::System::Predicate_1<::System::UInt32>* _ItemVisibalePredicate_k__BackingField; // 0x20
		...
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::UInt32>* _UniqueItemCountDict; // 0x38
		::System::Collections::Generic::HashSet_1<::RPG::GameCore::ItemSubType>* _PileItemSubTypes; // 0x40
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::UInt32>* _WaitDelItemCount; // 0x48
		::System::Collections::Generic::List_1<::System::UInt32>* _HeroAvatarEidolonItemIdList; // 0x50
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::ItemData*>* _PileItems; // 0x58
		::RPG::Client::ItemAutoConversionRecord* _OneTimeSyncItemAutoConversionRecord; // 0x60
		::System::Collections::Generic::List_1<::System::UInt32>* _QuickConsumbaleItems; // 0x68
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::UInt64>* _ExpiredTimes; // 0x70
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::ItemData*>* _UniqueItems; // 0x78
		::System::Collections::Generic::List_1<::RPG::Client::ItemAutoConversionRecord*>* _ItemAutoConversionRecords; // 0x80
		::System::Collections::Generic::List_1<::RPG::Client::ItemData*>* _FoundItemDatasCache; // 0x88
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::ItemDisplayData*>* _ExpiredItems; // 0x90
		::System::Collections::Generic::Dictionary_2<::RPG::GameCore::ItemSubType, ::System::Boolean>* _SubTypeFilter; // 0x98
		::System::Collections::Generic::List_1<::RPG::Client::ConvertibleItemData*>* _ConvertibleItems; // 0xA0
		::System::Collections::Generic::HashSet_1<::RPG::GameCore::ItemSubType>* _UniqueItemSubTypes; // 0xA8
		::System::Collections::Generic::List_1<::System::UInt32>* _EmptyList; // 0xB0
		::RPG::GameCore::InventoryTabRow* _ConsumableRow; // 0xB8
