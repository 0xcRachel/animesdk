...
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTMATBLENDTEX_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x990DB70)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTMATBLENDTEX_METHOD_2_44196695CAF284A8_OFFSET UNITYSDK_OFFSET(0x990DA50)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTMATBLENDTEX_METHOD_2_697CEBDDAD44641A_OFFSET UNITYSDK_OFFSET(0x990DAA0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTMATBLENDTEX_METHOD_2_7CDD8E0732AB7384_OFFSET UNITYSDK_OFFSET(0x990DBF0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTMATBLENDTEX_METHOD_2_9F9ED25754A7CAB9_OFFSET UNITYSDK_OFFSET(0x990ED90)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTMATBLENDTEX__CTOR_OFFSET UNITYSDK_OFFSET(0x990ED30)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicVisualization_BeatEffectElementMatBlendTex_TypeDefinitionIndex = 56443;
