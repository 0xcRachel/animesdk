...
#define RPG_CLIENT_CHARACTERSKILLITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x15DE9A10)

namespace RPG::Client
{
	inline static constexpr unsigned int CharacterSkillItemData_TypeDefinitionIndex = 67024;

	class CharacterSkillItemData : public ::System::Object
	{
	public:
		::UnityEngine::GameObject* SkillItemRootGO; // 0x10
