...
#define RPG_CLIENT_CAMERATWITCH_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x9268E70)
#define RPG_CLIENT_CAMERATWITCH_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9268C50)
#define RPG_CLIENT_CAMERATWITCH_START_OFFSET UNITYSDK_OFFSET(0x9268BC0)
#define RPG_CLIENT_CAMERATWITCH_UPDATE_OFFSET UNITYSDK_OFFSET(0x9268CA0)
#define RPG_CLIENT_CAMERATWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x9268EE0)
