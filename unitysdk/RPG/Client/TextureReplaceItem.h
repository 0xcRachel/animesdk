...
#define RPG_CLIENT_TEXTUREREPLACEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xA082C40)

namespace RPG::Client
{
	inline static constexpr unsigned int TextureReplaceItem_TypeDefinitionIndex = 56367;
