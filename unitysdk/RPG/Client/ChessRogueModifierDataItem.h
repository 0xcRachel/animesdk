...
#define RPG_CLIENT_CHESSROGUEMODIFIERDATAITEM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9382F00)
#define RPG_CLIENT_CHESSROGUEMODIFIERDATAITEM_GETRANDOMRESULTID_OFFSET UNITYSDK_OFFSET(0x9383100)
#define RPG_CLIENT_CHESSROGUEMODIFIERDATAITEM_GETRANDOMRESULTTEXT_OFFSET UNITYSDK_OFFSET(0x9383160)
#define RPG_CLIENT_CHESSROGUEMODIFIERDATAITEM_GETROGUEMODIFIEREFFECTTYPE_OFFSET UNITYSDK_OFFSET(0x93830A0)
#define RPG_CLIENT_CHESSROGUEMODIFIERDATAITEM_GETROGUEMODIFIERSELECTDATA_OFFSET UNITYSDK_OFFSET(0x9382F50)
#define RPG_CLIENT_CHESSROGUEMODIFIERDATAITEM_GET_MODIFIERID_OFFSET UNITYSDK_OFFSET(0x9382EA0)
#define RPG_CLIENT_CHESSROGUEMODIFIERDATAITEM_GET_MODIFIERSOURCETYPE_OFFSET UNITYSDK_OFFSET(0x9383250)
#define RPG_CLIENT_CHESSROGUEMODIFIERDATAITEM_REFRESH_OFFSET UNITYSDK_OFFSET(0x9382E00)
#define RPG_CLIENT_CHESSROGUEMODIFIERDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9382DF0)
