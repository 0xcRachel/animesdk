...
#define RPG_CLIENT_ADVENTUREBUFFDATA_CLONE_OFFSET UNITYSDK_OFFSET(0xC9ED0)
#define RPG_CLIENT_ADVENTUREBUFFDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC9EC0)

namespace RPG::Client
{
	inline static constexpr unsigned int AdventureBuffData_TypeDefinitionIndex = 54037;
