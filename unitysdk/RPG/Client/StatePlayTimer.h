...
#define RPG_CLIENT_STATEPLAYTIMER_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x9FC4370)
#define RPG_CLIENT_STATEPLAYTIMER_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0x9FC4420)
#define RPG_CLIENT_STATEPLAYTIMER_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9FC44D0)
#define RPG_CLIENT_STATEPLAYTIMER__CTOR_OFFSET UNITYSDK_OFFSET(0x9FC4600)
#define RPG_CLIENT_STATEPLAYTIMER___IFIXBASEPROXY_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x9FC4620)
#define RPG_CLIENT_STATEPLAYTIMER___IFIXBASEPROXY_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0x9FC4630)
#define RPG_CLIENT_STATEPLAYTIMER___IFIXBASEPROXY_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9FC4640)

namespace RPG::Client
{
	inline static constexpr unsigned int StatePlayTimer_TypeDefinitionIndex = 54676;
