...
#define RPG_CLIENT_STATEPLAYTIMER_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x16209080)
#define RPG_CLIENT_STATEPLAYTIMER_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0x16209130)
#define RPG_CLIENT_STATEPLAYTIMER_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x162091E0)
#define RPG_CLIENT_STATEPLAYTIMER__CTOR_OFFSET UNITYSDK_OFFSET(0x16209310)
#define RPG_CLIENT_STATEPLAYTIMER___IFIXBASEPROXY_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x16209330)
#define RPG_CLIENT_STATEPLAYTIMER___IFIXBASEPROXY_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0x16209340)
#define RPG_CLIENT_STATEPLAYTIMER___IFIXBASEPROXY_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x16209350)
