...
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA_CREATEBYROW_OFFSET UNITYSDK_OFFSET(0x184EECB0)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA_GET_LOCKEDREASON_OFFSET UNITYSDK_OFFSET(0x184EF3B0)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA_ISHIDEALLREDDOT_OFFSET UNITYSDK_OFFSET(0x184EF370)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA_ISSHOWNEWREDDOT_OFFSET UNITYSDK_OFFSET(0x184EF330)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA_ISSHOWNOPASSNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x184EF2F0)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x184EEDA0)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x184EECA0)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA__ISSHOWHANDBOOKREWARDREDDOT_OFFSET UNITYSDK_OFFSET(0x184EEF50)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA__ISSHOWQUESTREWARDREDDOT_OFFSET UNITYSDK_OFFSET(0x184EEEB0)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA__ISSHOWSTORYARCHIVEREWARDREDDOT_OFFSET UNITYSDK_OFFSET(0x184EF250)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA___IFIXBASEPROXY_GET_LOCKEDREASON_OFFSET UNITYSDK_OFFSET(0x184EF480)
