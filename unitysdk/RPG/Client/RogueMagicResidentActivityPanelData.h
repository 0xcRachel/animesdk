...
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA_CREATEBYROW_OFFSET UNITYSDK_OFFSET(0x172C8AB0)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA_GET_LOCKEDREASON_OFFSET UNITYSDK_OFFSET(0x172C9220)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA_ISHIDEALLREDDOT_OFFSET UNITYSDK_OFFSET(0x172C91E0)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA_ISSHOWNEWREDDOT_OFFSET UNITYSDK_OFFSET(0x172C91A0)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA_ISSHOWNOPASSNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x172C9160)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x172C8BA0)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x172C8AA0)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA__ISSHOWHANDBOOKREWARDREDDOT_OFFSET UNITYSDK_OFFSET(0x172C8D50)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA__ISSHOWQUESTREWARDREDDOT_OFFSET UNITYSDK_OFFSET(0x172C8CB0)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA__ISSHOWSTORYARCHIVEREWARDREDDOT_OFFSET UNITYSDK_OFFSET(0x172C90C0)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA___IFIXBASEPROXY_GET_LOCKEDREASON_OFFSET UNITYSDK_OFFSET(0x172C92F0)
