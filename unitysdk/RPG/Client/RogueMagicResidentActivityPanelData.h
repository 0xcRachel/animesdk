...
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA_CREATEBYROW_OFFSET UNITYSDK_OFFSET(0xA334620)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA_GET_LOCKEDREASON_OFFSET UNITYSDK_OFFSET(0xA334D90)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA_ISHIDEALLREDDOT_OFFSET UNITYSDK_OFFSET(0xA334D50)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA_ISSHOWNEWREDDOT_OFFSET UNITYSDK_OFFSET(0xA334D10)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA_ISSHOWNOPASSNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0xA334CD0)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0xA334710)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA334610)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA__ISSHOWHANDBOOKREWARDREDDOT_OFFSET UNITYSDK_OFFSET(0xA3348C0)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA__ISSHOWQUESTREWARDREDDOT_OFFSET UNITYSDK_OFFSET(0xA334820)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA__ISSHOWSTORYARCHIVEREWARDREDDOT_OFFSET UNITYSDK_OFFSET(0xA334C30)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA___IFIXBASEPROXY_GET_LOCKEDREASON_OFFSET UNITYSDK_OFFSET(0xA334E50)
