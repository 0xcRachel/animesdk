...
#define RPG_CLIENT_EFFECT_INSTANCEARRAYMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x90B3900)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_InstanceArrayMonoPlugin_TypeDefinitionIndex = 56260;
