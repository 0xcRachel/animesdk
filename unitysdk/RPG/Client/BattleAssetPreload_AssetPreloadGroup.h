...
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_ADDASSETS_OFFSET UNITYSDK_OFFSET(0x8D845A0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_ADDASSET_OFFSET UNITYSDK_OFFSET(0x8D844D0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_COLLECTITEMSIZE_OFFSET UNITYSDK_OFFSET(0x8D85A60)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8D81D00)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_GETASSETITEMSCORE_OFFSET UNITYSDK_OFFSET(0x8D83A20)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_GETPRELOADITEM_OFFSET UNITYSDK_OFFSET(0x8D84210)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x8D834A0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_GET_GROUPTYPE_OFFSET UNITYSDK_OFFSET(0x8D83490)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x8D83130)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x8D82FA0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_GET_ISENABLE_OFFSET UNITYSDK_OFFSET(0x8D83120)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_GET_ISLOADINGORLOADED_OFFSET UNITYSDK_OFFSET(0x8D83000)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x8D834B0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_GET_PRELOADMULTIPLIER_OFFSET UNITYSDK_OFFSET(0x8D82F30)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_HASITEMOFFLAG_OFFSET UNITYSDK_OFFSET(0x8D84A60)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x8D83570)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_MAPASSETPATH_OFFSET UNITYSDK_OFFSET(0x8D83B00)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_MARKNOUSEITEM_OFFSET UNITYSDK_OFFSET(0x8D85AA0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_ONPRELOADTAGSTAGECHANGE_OFFSET UNITYSDK_OFFSET(0x8D858E0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_RECOLLECTRESOURCE_OFFSET UNITYSDK_OFFSET(0x8D837A0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_REFRESHAFTERENTERADVENTURE_OFFSET UNITYSDK_OFFSET(0x8D85210)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_REFRESHAFTERENTERBATTLE_OFFSET UNITYSDK_OFFSET(0x8D85480)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_REFRESHBEFOREENTERADVENTURE_OFFSET UNITYSDK_OFFSET(0x8D85160)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_REFRESHBEFOREENTERBATTLE_OFFSET UNITYSDK_OFFSET(0x8D853D0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_REFRESHBEFORELEAVEADVENTURE_OFFSET UNITYSDK_OFFSET(0x8D85340)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_REFRESHBEFORELEAVEBATTLE_OFFSET UNITYSDK_OFFSET(0x8D85590)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_REFRESHBEFORERESTARTBATTLE_OFFSET UNITYSDK_OFFSET(0x8D85530)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_REFRESHBEFORESWITCHMAP_OFFSET UNITYSDK_OFFSET(0x8D85300)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_REFRESHINADVENTURE_OFFSET UNITYSDK_OFFSET(0x8D852C0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_REFRESHPRELOADTYPE_OFFSET UNITYSDK_OFFSET(0x8D85060)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_REGISTERPRELOADITEM_OFFSET UNITYSDK_OFFSET(0x8D83B50)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_RELEASERESOURCE_OFFSET UNITYSDK_OFFSET(0x8D83810)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_REMOVEPRELOADITEMBYFLAG_OFFSET UNITYSDK_OFFSET(0x8D84BA0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_REMOVEPRELOADITEM_1_OFFSET UNITYSDK_OFFSET(0x8D84830)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_REMOVEPRELOADITEM_OFFSET UNITYSDK_OFFSET(0x8D846D0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_SETPRELOADTYPEBIAS_OFFSET UNITYSDK_OFFSET(0x8D831D0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x8D83140)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_SET_PRELOADMULTIPLIER_OFFSET UNITYSDK_OFFSET(0x8D82F40)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8D834C0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_UPDATEPRELOADTYPEBYFLAG_OFFSET UNITYSDK_OFFSET(0x8D84D60)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP_UPDATEPRELOADTYPE_OFFSET UNITYSDK_OFFSET(0x8D84F30)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP__CALREALPRELOADTYPE_OFFSET UNITYSDK_OFFSET(0x8D843E0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP__COLLECTRESOURCEIMPLFORCOLLECTIONMODE_OFFSET UNITYSDK_OFFSET(0x8D856E0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP__COLLECTRESOURCEIMPL_OFFSET UNITYSDK_OFFSET(0x8D856A0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP__CONVERTTOORIGINLOD_OFFSET UNITYSDK_OFFSET(0x8D85C70)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x8D85D20)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP__GENITEMNAME_OFFSET UNITYSDK_OFFSET(0x8D85BF0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP__GETSYNCPRELOADITEM_OFFSET UNITYSDK_OFFSET(0x8D848E0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP__ONACTIVESTATECHANGE_OFFSET UNITYSDK_OFFSET(0x8D858A0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x8D85660)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP__ONINITIALIZE_OFFSET UNITYSDK_OFFSET(0x8D85620)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP__ONPRELOADTYPEBIASCHANGE_OFFSET UNITYSDK_OFFSET(0x8D85760)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP__RELEASERESOURCEIMPL_OFFSET UNITYSDK_OFFSET(0x8D85720)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP__UPDATEPRELOADTYPEIMPL_OFFSET UNITYSDK_OFFSET(0x8D83FF0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ASSETPRELOADGROUP___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8D85E30)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleAssetPreload_AssetPreloadGroup_TypeDefinitionIndex = 47203;

	class BattleAssetPreload_AssetPreloadGroup : public ::System::Object
	{
	public:
		::RPG::Client::BattleAssetPreload_AssetPreloadGroupCreateParam* _CreateParamBase; // 0x10
		...
		::Collections::Pooled::PooledDictionary_2<::System::String*, ::Class_1_2C2DA62D5BBB20B1*>* _PreloadItemDict; // 0x38
		::System::Int32 _PreloadTypeBias; // 0x40
		::System::Boolean _IsActive; // 0x44
