...
#define RPG_CLIENT_GRIDFIGHTROLESHOP_CYRENESHOPSUMMARIZER_ISCONCERNEDWITH_OFFSET UNITYSDK_OFFSET(0x93EB730)
#define RPG_CLIENT_GRIDFIGHTROLESHOP_CYRENESHOPSUMMARIZER_UPDATEAFTER_OFFSET UNITYSDK_OFFSET(0x93EB9F0)
#define RPG_CLIENT_GRIDFIGHTROLESHOP_CYRENESHOPSUMMARIZER_UPDATEBEFORE_OFFSET UNITYSDK_OFFSET(0x93EB780)
#define RPG_CLIENT_GRIDFIGHTROLESHOP_CYRENESHOPSUMMARIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x93EBA50)
#define RPG_CLIENT_GRIDFIGHTROLESHOP_CYRENESHOPSUMMARIZER___IFIXBASEPROXY_ISCONCERNEDWITH_OFFSET UNITYSDK_OFFSET(0x93EBA60)
#define RPG_CLIENT_GRIDFIGHTROLESHOP_CYRENESHOPSUMMARIZER___IFIXBASEPROXY_UPDATEAFTER_OFFSET UNITYSDK_OFFSET(0x93EBB40)
#define RPG_CLIENT_GRIDFIGHTROLESHOP_CYRENESHOPSUMMARIZER___IFIXBASEPROXY_UPDATEBEFORE_OFFSET UNITYSDK_OFFSET(0x93EBAD0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightRoleShop_CyreneShopSUmmarizer_TypeDefinitionIndex = 51831;
