...
#define RPG_CLIENT_ELFSELECTEVENTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1683F150)
#define RPG_CLIENT_ELFSELECTEVENTDATA_GET_BUBBLETYPE_OFFSET UNITYSDK_OFFSET(0x1683F5B0)
#define RPG_CLIENT_ELFSELECTEVENTDATA_GET_CONTACTSID_OFFSET UNITYSDK_OFFSET(0x1683F540)
#define RPG_CLIENT_ELFSELECTEVENTDATA_GET_DESCRIBE_OFFSET UNITYSDK_OFFSET(0x1683F460)
#define RPG_CLIENT_ELFSELECTEVENTDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0x1683F440)
#define RPG_CLIENT_ELFSELECTEVENTDATA_GET_OPEFFECT1_OFFSET UNITYSDK_OFFSET(0x1683F360)
#define RPG_CLIENT_ELFSELECTEVENTDATA_GET_OPEFFECT2_OFFSET UNITYSDK_OFFSET(0x1683F3D0)
#define RPG_CLIENT_ELFSELECTEVENTDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x1683F4E0)
#define RPG_CLIENT_ELFSELECTEVENTDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0x1683F450)
#define RPG_CLIENT_ELFSELECTEVENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1683F350)
