...
#define RPG_CLIENT_UIADVENTUREMINIMAP_ICONCIRCLE_GET_IMAGE_OFFSET UNITYSDK_OFFSET(0xA198A10)
#define RPG_CLIENT_UIADVENTUREMINIMAP_ICONCIRCLE_SETRADIUS_OFFSET UNITYSDK_OFFSET(0xA195190)
#define RPG_CLIENT_UIADVENTUREMINIMAP_ICONCIRCLE_SET_IMAGE_OFFSET UNITYSDK_OFFSET(0xA198A20)
#define RPG_CLIENT_UIADVENTUREMINIMAP_ICONCIRCLE__CTOR_OFFSET UNITYSDK_OFFSET(0xA197300)

namespace RPG::Client
{
	inline static constexpr unsigned int UIAdventureMinimap_IconCircle_TypeDefinitionIndex = 54864;
