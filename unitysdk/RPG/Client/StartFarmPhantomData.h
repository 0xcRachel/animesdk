...
#define RPG_CLIENT_STARTFARMPHANTOMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9FC0120)

namespace RPG::Client
{
	inline static constexpr unsigned int StartFarmPhantomData_TypeDefinitionIndex = 48052;
