...
#define RPG_CLIENT_JIGSAWCOMMONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x94FD5F0)

namespace RPG::Client
{
	inline static constexpr unsigned int JigsawCommonConfig_TypeDefinitionIndex = 47563;
