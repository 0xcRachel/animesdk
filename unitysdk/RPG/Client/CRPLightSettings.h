...
#define RPG_CLIENT_CRPLIGHTSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x8E14DE0)

namespace RPG::Client
{
	inline static constexpr unsigned int CRPLightSettings_TypeDefinitionIndex = 53876;
