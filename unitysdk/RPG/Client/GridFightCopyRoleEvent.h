...
#define RPG_CLIENT_GRIDFIGHTCOPYROLEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x933D330)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightCopyRoleEvent_TypeDefinitionIndex = 51794;
