...
#define RPG_CLIENT_AVATARPATHROWWRAPPER_GET_ALLOWREPEATUNLOCKREWARD_OFFSET UNITYSDK_OFFSET(0x8D094F0)
#define RPG_CLIENT_AVATARPATHROWWRAPPER_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0x8D09310)
#define RPG_CLIENT_AVATARPATHROWWRAPPER_GET_CHANGECONFIGPATH_OFFSET UNITYSDK_OFFSET(0x8D09410)
#define RPG_CLIENT_AVATARPATHROWWRAPPER_GET_DESC_OFFSET UNITYSDK_OFFSET(0x8D09330)
#define RPG_CLIENT_AVATARPATHROWWRAPPER_GET_ISEARLYUNLOCK_OFFSET UNITYSDK_OFFSET(0x8D09480)
#define RPG_CLIENT_AVATARPATHROWWRAPPER_GET_UNLOCKTOAST_OFFSET UNITYSDK_OFFSET(0x8D09560)
#define RPG_CLIENT_AVATARPATHROWWRAPPER_GET__ROW_OFFSET UNITYSDK_OFFSET(0x8D093B0)
#define RPG_CLIENT_AVATARPATHROWWRAPPER_SET_AVATARID_OFFSET UNITYSDK_OFFSET(0x8D09320)
#define RPG_CLIENT_AVATARPATHROWWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x8D08E60)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarPathRowWrapper_TypeDefinitionIndex = 52780;
