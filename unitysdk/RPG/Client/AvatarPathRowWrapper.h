...
#define RPG_CLIENT_AVATARPATHROWWRAPPER_GET_ALLOWREPEATUNLOCKREWARD_OFFSET UNITYSDK_OFFSET(0x915FE70)
#define RPG_CLIENT_AVATARPATHROWWRAPPER_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0x915FC90)
#define RPG_CLIENT_AVATARPATHROWWRAPPER_GET_CHANGECONFIGPATH_OFFSET UNITYSDK_OFFSET(0x915FD90)
#define RPG_CLIENT_AVATARPATHROWWRAPPER_GET_DESC_OFFSET UNITYSDK_OFFSET(0x915FCB0)
#define RPG_CLIENT_AVATARPATHROWWRAPPER_GET_ISEARLYUNLOCK_OFFSET UNITYSDK_OFFSET(0x915FE00)
#define RPG_CLIENT_AVATARPATHROWWRAPPER_GET_UNLOCKTOAST_OFFSET UNITYSDK_OFFSET(0x915FEE0)
#define RPG_CLIENT_AVATARPATHROWWRAPPER_GET__ROW_OFFSET UNITYSDK_OFFSET(0x915FD30)
#define RPG_CLIENT_AVATARPATHROWWRAPPER_SET_AVATARID_OFFSET UNITYSDK_OFFSET(0x915FCA0)
#define RPG_CLIENT_AVATARPATHROWWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x915F7E0)
