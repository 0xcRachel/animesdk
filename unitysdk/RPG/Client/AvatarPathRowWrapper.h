...
#define RPG_CLIENT_AVATARPATHROWWRAPPER_GET_ALLOWREPEATUNLOCKREWARD_OFFSET UNITYSDK_OFFSET(0x15E3FC10)
#define RPG_CLIENT_AVATARPATHROWWRAPPER_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0x15E3FA30)
#define RPG_CLIENT_AVATARPATHROWWRAPPER_GET_CHANGECONFIGPATH_OFFSET UNITYSDK_OFFSET(0x15E3FB30)
#define RPG_CLIENT_AVATARPATHROWWRAPPER_GET_DESC_OFFSET UNITYSDK_OFFSET(0x15E3FA50)
#define RPG_CLIENT_AVATARPATHROWWRAPPER_GET_ISEARLYUNLOCK_OFFSET UNITYSDK_OFFSET(0x15E3FBA0)
#define RPG_CLIENT_AVATARPATHROWWRAPPER_GET_UNLOCKTOAST_OFFSET UNITYSDK_OFFSET(0x15E3FC80)
#define RPG_CLIENT_AVATARPATHROWWRAPPER_GET__ROW_OFFSET UNITYSDK_OFFSET(0x15E3FAD0)
#define RPG_CLIENT_AVATARPATHROWWRAPPER_SET_AVATARID_OFFSET UNITYSDK_OFFSET(0x15E3FA40)
#define RPG_CLIENT_AVATARPATHROWWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x15E3F580)
