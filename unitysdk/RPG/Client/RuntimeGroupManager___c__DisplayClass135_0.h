...
#define RPG_CLIENT_RUNTIMEGROUPMANAGER___C__DISPLAYCLASS135_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9F4BF00)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER___C__DISPLAYCLASS135_0__DESTROYLOCALENTITY_B__0_OFFSET UNITYSDK_OFFSET(0x9F4CD70)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER___C__DISPLAYCLASS135_0__DESTROYLOCALENTITY_B__1_OFFSET UNITYSDK_OFFSET(0x9F4CDA0)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER___C__DISPLAYCLASS135_0__DESTROYLOCALENTITY_B__2_OFFSET UNITYSDK_OFFSET(0x9F4CDD0)

namespace RPG::Client
{
	inline static constexpr unsigned int RuntimeGroupManager___c__DisplayClass135_0_TypeDefinitionIndex = 49273;
