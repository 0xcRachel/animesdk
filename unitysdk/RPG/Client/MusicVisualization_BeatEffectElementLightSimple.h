...
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTLIGHTSIMPLE_METHOD_2_097468641FDED14E_OFFSET UNITYSDK_OFFSET(0x990D370)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTLIGHTSIMPLE_METHOD_2_6D93101E4CE10A96_OFFSET UNITYSDK_OFFSET(0x990CFD0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTLIGHTSIMPLE_METHOD_2_9F9ED25754A7CAB9_OFFSET UNITYSDK_OFFSET(0x990DA00)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTLIGHTSIMPLE_METHOD_2_AA1AB263D4D04DE5_OFFSET UNITYSDK_OFFSET(0x990D410)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTLIGHTSIMPLE_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x990D980)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTLIGHTSIMPLE_METHOD_2_E5204C0EB6EBF361_1_OFFSET UNITYSDK_OFFSET(0x990D6F0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTLIGHTSIMPLE_METHOD_2_E5204C0EB6EBF361_OFFSET UNITYSDK_OFFSET(0x990D490)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTLIGHTSIMPLE__CTOR_OFFSET UNITYSDK_OFFSET(0x990D8E0)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicVisualization_BeatEffectElementLightSimple_TypeDefinitionIndex = 56440;
