...
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL_ADD_ONMAYBEINITIALREWARDCLAIMED_OFFSET UNITYSDK_OFFSET(0x8B02730)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL_CLAIMINITIALREWARD_OFFSET UNITYSDK_OFFSET(0x8B02600)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x8B01F90)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8B02570)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL_GET_INITIALREWARDITEM_OFFSET UNITYSDK_OFFSET(0x8B01ED0)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL_GET_ISINITIALREWARDCLAIMABLE_OFFSET UNITYSDK_OFFSET(0x8B01EF0)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL_GET_ISINITIALREWARDCLAIMED_OFFSET UNITYSDK_OFFSET(0x8B01F10)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL_GET_NORMALREWARDITEM_OFFSET UNITYSDK_OFFSET(0x8B01F30)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL_GET_ROUNDCOUNT_OFFSET UNITYSDK_OFFSET(0x8B01F70)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL_GET_SPECIALREWARDEXTRAITEM_OFFSET UNITYSDK_OFFSET(0x8B01F50)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL_GET__INITIALREWARDQUESTDATA_OFFSET UNITYSDK_OFFSET(0x8B01E30)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL_GET__INITIALREWARDQUESTID_OFFSET UNITYSDK_OFFSET(0x8B01E20)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL_REMOVE_ONMAYBEINITIALREWARDCLAIMED_OFFSET UNITYSDK_OFFSET(0x8B02790)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL_SET_INITIALREWARDITEM_OFFSET UNITYSDK_OFFSET(0x8B01EE0)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL_SET_NORMALREWARDITEM_OFFSET UNITYSDK_OFFSET(0x8B01F40)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL_SET_ROUNDCOUNT_OFFSET UNITYSDK_OFFSET(0x8B01F80)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL_SET_SPECIALREWARDEXTRAITEM_OFFSET UNITYSDK_OFFSET(0x8B01F60)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x8B020E0)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL__ONQUESTGETREWARD_OFFSET UNITYSDK_OFFSET(0x8B02690)

namespace RPG::Client
{
	inline static constexpr unsigned int ActivityBenefitV2RewardOverviewViewModel_TypeDefinitionIndex = 48722;
	...
	public:
		...
		::System::Action_1<::System::Collections::Generic::List_1<::RPG::Client::ItemDisplayData*>*>* OnMaybeInitialRewardClaimed; // 0x28
