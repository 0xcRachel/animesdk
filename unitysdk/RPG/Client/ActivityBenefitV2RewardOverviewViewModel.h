...
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL_ADD_ONMAYBEINITIALREWARDCLAIMED_OFFSET UNITYSDK_OFFSET(0x8F02A70)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL_CLAIMINITIALREWARD_OFFSET UNITYSDK_OFFSET(0x8F02940)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x8F022B0)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8F028B0)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL_GET_INITIALREWARDITEM_OFFSET UNITYSDK_OFFSET(0x8F021F0)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL_GET_ISINITIALREWARDCLAIMABLE_OFFSET UNITYSDK_OFFSET(0x8F02210)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL_GET_ISINITIALREWARDCLAIMED_OFFSET UNITYSDK_OFFSET(0x8F02230)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL_GET_NORMALREWARDITEM_OFFSET UNITYSDK_OFFSET(0x8F02250)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL_GET_ROUNDCOUNT_OFFSET UNITYSDK_OFFSET(0x8F02290)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL_GET_SPECIALREWARDEXTRAITEM_OFFSET UNITYSDK_OFFSET(0x8F02270)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL_GET__INITIALREWARDQUESTDATA_OFFSET UNITYSDK_OFFSET(0x8F02150)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL_GET__INITIALREWARDQUESTID_OFFSET UNITYSDK_OFFSET(0x8F02140)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL_REMOVE_ONMAYBEINITIALREWARDCLAIMED_OFFSET UNITYSDK_OFFSET(0x8F02AD0)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL_SET_INITIALREWARDITEM_OFFSET UNITYSDK_OFFSET(0x8F02200)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL_SET_NORMALREWARDITEM_OFFSET UNITYSDK_OFFSET(0x8F02260)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL_SET_ROUNDCOUNT_OFFSET UNITYSDK_OFFSET(0x8F022A0)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL_SET_SPECIALREWARDEXTRAITEM_OFFSET UNITYSDK_OFFSET(0x8F02280)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x8F02400)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL__ONQUESTGETREWARD_OFFSET UNITYSDK_OFFSET(0x8F029D0)
