...
#define RPG_CLIENT_PLANETFESAVATARMOVETO_METHOD_3_5B19D22B475C30C1_OFFSET UNITYSDK_OFFSET(0x1676B260)
#define RPG_CLIENT_PLANETFESAVATARMOVETO_METHOD_3_C6A7ED31A42B57FD_OFFSET UNITYSDK_OFFSET(0x1676B2E0)
#define RPG_CLIENT_PLANETFESAVATARMOVETO__CTOR_OFFSET UNITYSDK_OFFSET(0x1676B2B0)
