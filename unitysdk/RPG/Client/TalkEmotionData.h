...
#define RPG_CLIENT_TALKEMOTIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA025470)

namespace RPG::Client
{
	inline static constexpr unsigned int TalkEmotionData_TypeDefinitionIndex = 56678;
