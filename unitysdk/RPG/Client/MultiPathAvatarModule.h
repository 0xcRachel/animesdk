...
#define RPG_CLIENT_MULTIPATHAVATARMODULE_CLEARCACHEDTRANSFERITEMBYUNLOCKAVATAR_OFFSET UNITYSDK_OFFSET(0x13737E20)
#define RPG_CLIENT_MULTIPATHAVATARMODULE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13735970)
#define RPG_CLIENT_MULTIPATHAVATARMODULE_GETALLAVATARPATHDATA_OFFSET UNITYSDK_OFFSET(0x13736FD0)
#define RPG_CLIENT_MULTIPATHAVATARMODULE_GETALLMULTIPATHAVATARTYPE_OFFSET UNITYSDK_OFFSET(0x137371F0)
#define RPG_CLIENT_MULTIPATHAVATARMODULE_GETAVATARPATHDATALIST_OFFSET UNITYSDK_OFFSET(0x137373B0)
#define RPG_CLIENT_MULTIPATHAVATARMODULE_GETAVATARPATHDATA_1_OFFSET UNITYSDK_OFFSET(0x137375B0)
#define RPG_CLIENT_MULTIPATHAVATARMODULE_GETAVATARPATHDATA_OFFSET UNITYSDK_OFFSET(0x13737450)
#define RPG_CLIENT_MULTIPATHAVATARMODULE_GETCHANGECONFIG_1_OFFSET UNITYSDK_OFFSET(0x13737980)
#define RPG_CLIENT_MULTIPATHAVATARMODULE_GETCHANGECONFIG_OFFSET UNITYSDK_OFFSET(0x13737710)
#define RPG_CLIENT_MULTIPATHAVATARMODULE_GETMULTIPATHAVATARDATA_OFFSET UNITYSDK_OFFSET(0x13736BE0)
#define RPG_CLIENT_MULTIPATHAVATARMODULE_GETMULTIPATHAVATARTYPE_OFFSET UNITYSDK_OFFSET(0x13736E50)
#define RPG_CLIENT_MULTIPATHAVATARMODULE_GETREQUESTUNLOCKEDMULTIPATHAVATARTYPES_OFFSET UNITYSDK_OFFSET(0x13737C70)
#define RPG_CLIENT_MULTIPATHAVATARMODULE_GETUNLOCKTOAST_1_OFFSET UNITYSDK_OFFSET(0x13737C00)
#define RPG_CLIENT_MULTIPATHAVATARMODULE_GETUNLOCKTOAST_OFFSET UNITYSDK_OFFSET(0x137379D0)
#define RPG_CLIENT_MULTIPATHAVATARMODULE_GET_CACHEDTRANSFERITEM_OFFSET UNITYSDK_OFFSET(0x13737E70)
#define RPG_CLIENT_MULTIPATHAVATARMODULE_GET_HASCACHEDTRANSFERITEMBYUNLOCKAVATAR_OFFSET UNITYSDK_OFFSET(0x13737E10)
#define RPG_CLIENT_MULTIPATHAVATARMODULE_INITSERVERDATA_OFFSET UNITYSDK_OFFSET(0x13735A60)
#define RPG_CLIENT_MULTIPATHAVATARMODULE_INIT_OFFSET UNITYSDK_OFFSET(0x137356B0)
#define RPG_CLIENT_MULTIPATHAVATARMODULE_ISHARMONYBASICTYPEREQUESTUNLOCKED_OFFSET UNITYSDK_OFFSET(0x13737D10)
#define RPG_CLIENT_MULTIPATHAVATARMODULE_ISMULTIPATHAVATARTYPEREQUESTUNLOCKED_OFFSET UNITYSDK_OFFSET(0x13737DA0)
#define RPG_CLIENT_MULTIPATHAVATARMODULE_SENDSETAVATARPATHCSREQ_OFFSET UNITYSDK_OFFSET(0x13734E30)
#define RPG_CLIENT_MULTIPATHAVATARMODULE_SENDSETMULTIPLEAVATARPATHSCSREQ_OFFSET UNITYSDK_OFFSET(0x13734F00)
#define RPG_CLIENT_MULTIPATHAVATARMODULE_SENDUNLOCKAVATARPATHCSREQ_OFFSET UNITYSDK_OFFSET(0x13735220)
#define RPG_CLIENT_MULTIPATHAVATARMODULE_SETCURRENTMULTIPATHAVATARTYPE_OFFSET UNITYSDK_OFFSET(0x13735010)
#define RPG_CLIENT_MULTIPATHAVATARMODULE_SETREQUESTUNLOCKEDMULTIPATHAVATARTYPES_OFFSET UNITYSDK_OFFSET(0x13735330)
#define RPG_CLIENT_MULTIPATHAVATARMODULE_SYNCHEROAVATARPATHDATA_OFFSET UNITYSDK_OFFSET(0x13736D10)
#define RPG_CLIENT_MULTIPATHAVATARMODULE_SYNCSERVERDATA_OFFSET UNITYSDK_OFFSET(0x137361E0)
#define RPG_CLIENT_MULTIPATHAVATARMODULE__ADDPACKETHANDLERS_OFFSET UNITYSDK_OFFSET(0x13734CE0)
#define RPG_CLIENT_MULTIPATHAVATARMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x13737E80)
#define RPG_CLIENT_MULTIPATHAVATARMODULE__INITMULTIPATHAVATARDATA_OFFSET UNITYSDK_OFFSET(0x13735740)
#define RPG_CLIENT_MULTIPATHAVATARMODULE__ONCMDADDMULTIPATHAVATARSCNOTIFY_OFFSET UNITYSDK_OFFSET(0x13735450)
#define RPG_CLIENT_MULTIPATHAVATARMODULE__ONCMDAVATARPATHCHANGEDNOTIFY_OFFSET UNITYSDK_OFFSET(0x137351A0)
#define RPG_CLIENT_MULTIPATHAVATARMODULE__ONCMDSETAVATARPATHSCRSP_OFFSET UNITYSDK_OFFSET(0x13734F90)
#define RPG_CLIENT_MULTIPATHAVATARMODULE__ONCMDSETMULTIPLEAVATARPATHSSCRSP_OFFSET UNITYSDK_OFFSET(0x13735120)
#define RPG_CLIENT_MULTIPATHAVATARMODULE__ONCMDUNLOCKAVATARPATHSCRSP_OFFSET UNITYSDK_OFFSET(0x137352B0)
#define RPG_CLIENT_MULTIPATHAVATARMODULE___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13738000)
#define RPG_CLIENT_MULTIPATHAVATARMODULE___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x13737F70)
#define RPG_CLIENT_MULTIPATHAVATARMODULE___IFIXBASEPROXY__ADDPACKETHANDLERS_OFFSET UNITYSDK_OFFSET(0x13737F10)
...
namespace RPG::Client
{
	...
	public:
		...
		::RPG::Client::MultiPathAvatarUnlockItemTransfer* _CachedTransferItem; // 0x20
		...
		::System::Void InitServerData(::System::Collections::Generic::IReadOnlyDictionary_2<::System::UInt32, ::Class_1_BB4B99DE4C2501EC_3*>* avatarBaseDataDict, ::System::Collections::Generic::IReadOnlyDictionary_2<::System::UInt32, ::Class_1_F3CA30716D4FAF92_3*>* avatarUniqueDataDict, ::System::Collections::Generic::IReadOnlyList_1<::System::UInt32>* reqUnlockedAvatarIdList)
		{
			return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::IReadOnlyDictionary_2<::System::UInt32, ::Class_1_BB4B99DE4C2501EC_3*>*, ::System::Collections::Generic::IReadOnlyDictionary_2<::System::UInt32, ::Class_1_F3CA30716D4FAF92_3*>*, ::System::Collections::Generic::IReadOnlyList_1<::System::UInt32>*))((::PBYTE)hIl2Cpp + RPG_CLIENT_MULTIPATHAVATARMODULE_INITSERVERDATA_OFFSET))(this, avatarBaseDataDict, avatarUniqueDataDict, reqUnlockedAvatarIdList);
		}

		::System::Void SyncServerData(::System::Collections::Generic::IEnumerable_1<::Class_1_F3CA30716D4FAF92_3*>* changeUniqueDataList, ::System::Collections::Generic::IReadOnlyDictionary_2<::System::UInt32, ::Class_1_BB4B99DE4C2501EC_3*>* avatarBaseDataDict, ::System::Collections::Generic::IReadOnlyDictionary_2<::System::UInt32, ::Class_1_F3CA30716D4FAF92_3*>* avatarUniqueDataDict)
		{
			return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::IEnumerable_1<::Class_1_F3CA30716D4FAF92_3*>*, ::System::Collections::Generic::IReadOnlyDictionary_2<::System::UInt32, ::Class_1_BB4B99DE4C2501EC_3*>*, ::System::Collections::Generic::IReadOnlyDictionary_2<::System::UInt32, ::Class_1_F3CA30716D4FAF92_3*>*))((::PBYTE)hIl2Cpp + RPG_CLIENT_MULTIPATHAVATARMODULE_SYNCSERVERDATA_OFFSET))(this, changeUniqueDataList, avatarBaseDataDict, avatarUniqueDataDict);
		}
