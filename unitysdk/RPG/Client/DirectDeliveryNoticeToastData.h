...
#define RPG_CLIENT_DIRECTDELIVERYNOTICETOASTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x90559D0)

namespace RPG::Client
{
	inline static constexpr unsigned int DirectDeliveryNoticeToastData_TypeDefinitionIndex = 50495;
