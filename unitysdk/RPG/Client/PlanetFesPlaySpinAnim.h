...
#define RPG_CLIENT_PLANETFESPLAYSPINANIM_METHOD_3_8C9A31F9B5800A33_OFFSET UNITYSDK_OFFSET(0x1676B7D0)
#define RPG_CLIENT_PLANETFESPLAYSPINANIM_METHOD_3_9492EA95D6901E22_OFFSET UNITYSDK_OFFSET(0x1676B850)
#define RPG_CLIENT_PLANETFESPLAYSPINANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x1676B820)
