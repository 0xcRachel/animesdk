...
#define RPG_CLIENT_PREAVATARGROWTHMATERIALDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x161F7A50)
#define RPG_CLIENT_PREAVATARGROWTHMATERIALDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x161F7B10)
...
namespace RPG::Client
{
	...
	{
	public:
		::System::UInt32 WorldMaterialMedium; // 0x10
		...
		::System::UInt32 AvatarTemplateID; // 0x2C
