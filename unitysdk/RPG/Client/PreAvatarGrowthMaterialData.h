...
#define RPG_CLIENT_PREAVATARGROWTHMATERIALDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x12748E80)
#define RPG_CLIENT_PREAVATARGROWTHMATERIALDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x12748F40)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 PromotionMaterial; // 0x30
		...
		static ::RPG::Client::PreAvatarGrowthMaterialData* Create(::Class_1_21DCD4640D389503_15* rsp)
		{
			return ((::RPG::Client::PreAvatarGrowthMaterialData*(*)(::Class_1_21DCD4640D389503_15*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PREAVATARGROWTHMATERIALDATA_CREATE_OFFSET))(rsp);
		}
	};
}
