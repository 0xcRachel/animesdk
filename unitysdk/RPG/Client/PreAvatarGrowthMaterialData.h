...
#define RPG_CLIENT_PREAVATARGROWTHMATERIALDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xA000160)
#define RPG_CLIENT_PREAVATARGROWTHMATERIALDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA000210)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 AvatarTemplateID; // 0x24
		::System::UInt32 SkillMaterialLarge; // 0x28
		::System::UInt32 WorldMaterialLarge; // 0x2C
		::System::UInt32 BossMaterial; // 0x30
