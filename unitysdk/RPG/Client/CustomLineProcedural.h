...
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_AWAKE_OFFSET UNITYSDK_OFFSET(0x944B210)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_7B411317D337F87A_1_OFFSET UNITYSDK_OFFSET(0x944C970)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_7B411317D337F87A_OFFSET UNITYSDK_OFFSET(0x944C150)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_8336E89DF737C001_OFFSET UNITYSDK_OFFSET(0x944BCB0)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_95288ADC9C10D154_OFFSET UNITYSDK_OFFSET(0x944B4C0)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_B50CA01B5EDC1228_OFFSET UNITYSDK_OFFSET(0x944D420)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_E4F0C07FA0B569BB_OFFSET UNITYSDK_OFFSET(0x944D510)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_F2BB8CA4A5596DD6_OFFSET UNITYSDK_OFFSET(0x944D160)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_REBUILDLINE_OFFSET UNITYSDK_OFFSET(0x944B2E0)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_UPDATEPOINTS_OFFSET UNITYSDK_OFFSET(0x944B370)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL__CTOR_OFFSET UNITYSDK_OFFSET(0x944D880)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Vector3>**)Il2CppClass::FromTypeDefinitionIndex(CustomLineProcedural_TypeDefinitionIndex)->GetStaticField(0x48260);
		}
