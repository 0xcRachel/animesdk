...
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_AWAKE_OFFSET UNITYSDK_OFFSET(0x8FEF970)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_7B411317D337F87A_1_OFFSET UNITYSDK_OFFSET(0x8FF10D0)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_7B411317D337F87A_OFFSET UNITYSDK_OFFSET(0x8FF08B0)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_8336E89DF737C001_OFFSET UNITYSDK_OFFSET(0x8FF0410)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_95288ADC9C10D154_OFFSET UNITYSDK_OFFSET(0x8FEFC20)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_B50CA01B5EDC1228_OFFSET UNITYSDK_OFFSET(0x8FF1B80)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_E4F0C07FA0B569BB_OFFSET UNITYSDK_OFFSET(0x8FF1C70)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_F2BB8CA4A5596DD6_OFFSET UNITYSDK_OFFSET(0x8FF18C0)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_REBUILDLINE_OFFSET UNITYSDK_OFFSET(0x8FEFA40)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_UPDATEPOINTS_OFFSET UNITYSDK_OFFSET(0x8FEFAD0)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL__CTOR_OFFSET UNITYSDK_OFFSET(0x8FF1FE0)

namespace RPG::Client
{
	inline static constexpr unsigned int CustomLineProcedural_TypeDefinitionIndex = 56073;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Vector3>**)Il2CppClass::FromTypeDefinitionIndex(CustomLineProcedural_TypeDefinitionIndex)->GetStaticField(0x43790);
		}
