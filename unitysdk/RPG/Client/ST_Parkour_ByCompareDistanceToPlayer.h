...
#define RPG_CLIENT_ST_PARKOUR_BYCOMPAREDISTANCETOPLAYER_METHOD_4_08408ECF1AD95AD2_OFFSET UNITYSDK_OFFSET(0x1676C0B0)
#define RPG_CLIENT_ST_PARKOUR_BYCOMPAREDISTANCETOPLAYER_METHOD_4_A2A4732A227CA15A_OFFSET UNITYSDK_OFFSET(0x1676BFE0)
#define RPG_CLIENT_ST_PARKOUR_BYCOMPAREDISTANCETOPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1676C060)
