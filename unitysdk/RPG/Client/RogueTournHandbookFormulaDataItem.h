...
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_CREATE_OFFSET UNITYSDK_OFFSET(0x1755BED0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_CATEGORY_OFFSET UNITYSDK_OFFSET(0x1755CAA0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_DESCPARAMS_OFFSET UNITYSDK_OFFSET(0x1755CD30)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_DESC_OFFSET UNITYSDK_OFFSET(0x1755CB20)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_EXTRAEFFECTIDS_OFFSET UNITYSDK_OFFSET(0x1755CD90)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_FORMULADATA_OFFSET UNITYSDK_OFFSET(0x1755CA00)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_FORMULAID_OFFSET UNITYSDK_OFFSET(0x1755BF40)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_ISSUBBUFFTYPEREQUIRED_OFFSET UNITYSDK_OFFSET(0x1755CEB0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0x1755CF40)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_LOCKEDDESC_OFFSET UNITYSDK_OFFSET(0x1755CBC0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_MAINAEONICONPATH_OFFSET UNITYSDK_OFFSET(0x1755C960)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_MAINBUFFCOUNTITEM_OFFSET UNITYSDK_OFFSET(0x1755CE10)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_MAINBUFFTYPE_OFFSET UNITYSDK_OFFSET(0x1755CDB0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1755CA10)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_SUBAEONICONPATH_OFFSET UNITYSDK_OFFSET(0x1755C980)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_SUBBUFFCOUNTITEM_OFFSET UNITYSDK_OFFSET(0x1755CE90)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_SUBBUFFTYPE_OFFSET UNITYSDK_OFFSET(0x1755CE30)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET__DISPLAYROW_OFFSET UNITYSDK_OFFSET(0x1755CFD0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET__LOCKEDDESCDISPLAYROW_OFFSET UNITYSDK_OFFSET(0x1755CCB0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0x1755CF60)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_SET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0x1755CF50)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_SYNCUNLOCKED_OFFSET UNITYSDK_OFFSET(0x1755C9B0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1755C9A0)
