...
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_CREATE_OFFSET UNITYSDK_OFFSET(0x9E76B50)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_CATEGORY_OFFSET UNITYSDK_OFFSET(0x9E775A0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_DESCPARAMS_OFFSET UNITYSDK_OFFSET(0x9E77820)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_DESC_OFFSET UNITYSDK_OFFSET(0x9E77620)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_EXTRAEFFECTIDS_OFFSET UNITYSDK_OFFSET(0x9E77880)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_FORMULADATA_OFFSET UNITYSDK_OFFSET(0x9E774F0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_FORMULAID_OFFSET UNITYSDK_OFFSET(0x9E76BC0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_ISSUBBUFFTYPEREQUIRED_OFFSET UNITYSDK_OFFSET(0x9E779A0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0x9E77A30)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_LOCKEDDESC_OFFSET UNITYSDK_OFFSET(0x9E776B0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_MAINAEONICONPATH_OFFSET UNITYSDK_OFFSET(0x9E77450)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_MAINBUFFCOUNTITEM_OFFSET UNITYSDK_OFFSET(0x9E77900)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_MAINBUFFTYPE_OFFSET UNITYSDK_OFFSET(0x9E778A0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0x9E77500)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_SUBAEONICONPATH_OFFSET UNITYSDK_OFFSET(0x9E77470)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_SUBBUFFCOUNTITEM_OFFSET UNITYSDK_OFFSET(0x9E77980)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_SUBBUFFTYPE_OFFSET UNITYSDK_OFFSET(0x9E77920)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET__DISPLAYROW_OFFSET UNITYSDK_OFFSET(0x9E77AC0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET__LOCKEDDESCDISPLAYROW_OFFSET UNITYSDK_OFFSET(0x9E777A0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0x9E77A50)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_SET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0x9E77A40)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_SYNCUNLOCKED_OFFSET UNITYSDK_OFFSET(0x9E774A0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9E77490)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournHandbookFormulaDataItem_TypeDefinitionIndex = 53755;
