...
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_CREATE_OFFSET UNITYSDK_OFFSET(0xA3A1A00)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_CATEGORY_OFFSET UNITYSDK_OFFSET(0xA3A21F0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_DESCPARAMS_OFFSET UNITYSDK_OFFSET(0xA3A2560)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_DESC_OFFSET UNITYSDK_OFFSET(0xA3A2360)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_EXTRAEFFECTIDS_OFFSET UNITYSDK_OFFSET(0xA3A25C0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_FORMULADATA_OFFSET UNITYSDK_OFFSET(0xA3A2150)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_FORMULAID_OFFSET UNITYSDK_OFFSET(0xA3A1A70)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_ISSUBBUFFTYPEREQUIRED_OFFSET UNITYSDK_OFFSET(0xA3A26E0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xA3A2770)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_LOCKEDDESC_OFFSET UNITYSDK_OFFSET(0xA3A23F0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_MAINAEONICONPATH_OFFSET UNITYSDK_OFFSET(0xA3A20B0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_MAINBUFFCOUNTITEM_OFFSET UNITYSDK_OFFSET(0xA3A2640)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_MAINBUFFTYPE_OFFSET UNITYSDK_OFFSET(0xA3A25E0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0xA3A2160)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_SUBAEONICONPATH_OFFSET UNITYSDK_OFFSET(0xA3A20D0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_SUBBUFFCOUNTITEM_OFFSET UNITYSDK_OFFSET(0xA3A26C0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_SUBBUFFTYPE_OFFSET UNITYSDK_OFFSET(0xA3A2660)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET__DISPLAYROW_OFFSET UNITYSDK_OFFSET(0xA3A2800)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET__LOCKEDDESCDISPLAYROW_OFFSET UNITYSDK_OFFSET(0xA3A24E0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0xA3A2790)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_SET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xA3A2780)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_SYNCUNLOCKED_OFFSET UNITYSDK_OFFSET(0xA3A2100)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xA3A20F0)
