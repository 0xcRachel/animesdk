...
#define RPG_CLIENT_MUSICRHYTHMLEVELINFO_GET_ISFINISH_OFFSET UNITYSDK_OFFSET(0xD04F0)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicRhythmLevelInfo_TypeDefinitionIndex = 49036;
