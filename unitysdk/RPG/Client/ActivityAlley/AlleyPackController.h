...
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_ADDALLEYGOOD_OFFSET UNITYSDK_OFFSET(0x159C2820)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_ADDALLEYPACKSHIP_OFFSET UNITYSDK_OFFSET(0x159C2290)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_ADDUIAREA_OFFSET UNITYSDK_OFFSET(0x159C80F0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_BEGINDRAGTARGET_OFFSET UNITYSDK_OFFSET(0x159C6490)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_CANCELSETTLECURGOOD_OFFSET UNITYSDK_OFFSET(0x159C7A50)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_CLEARDRAGMOUSEPOSOFFSET_OFFSET UNITYSDK_OFFSET(0x159BC780)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_CLEARMATCHANI_OFFSET UNITYSDK_OFFSET(0x171BA1A0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_CLEARSHIP_OFFSET UNITYSDK_OFFSET(0x159C2390)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_CLEARUIAREA_OFFSET UNITYSDK_OFFSET(0x159C8160)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_COMBINEGOOD_OFFSET UNITYSDK_OFFSET(0x159C1590)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x159C76B0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_ENDDRAG_OFFSET UNITYSDK_OFFSET(0x159C5450)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_GETALLEYPLACINGSHIPINFO_OFFSET UNITYSDK_OFFSET(0x159C2CA0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_GETINTERSECTADJUSTYPOS_OFFSET UNITYSDK_OFFSET(0x159C0030)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_GETINTERSECTBOUND_OFFSET UNITYSDK_OFFSET(0x159C46A0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_GET_ALLGOODDATADICT_OFFSET UNITYSDK_OFFSET(0x159C3410)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_GET_CURALLEYPACKCOMPONENT_OFFSET UNITYSDK_OFFSET(0x171B9BC0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_GET_CURGROUPDATA_OFFSET UNITYSDK_OFFSET(0x171B9BE0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_GET_CURJOYSTICKSTATE_OFFSET UNITYSDK_OFFSET(0x159C74B0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_GET_SHIPDATA_OFFSET UNITYSDK_OFFSET(0x159C3400)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x159C74D0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_ISINSELECTGROUP_OFFSET UNITYSDK_OFFSET(0x159C48A0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_LATETICK_OFFSET UNITYSDK_OFFSET(0x159C3F50)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x159C7990)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_REGISTERGOODOPERATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x159C8000)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_REMOVECURGOOD_OFFSET UNITYSDK_OFFSET(0x159C5940)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_REMOVESHIP_OFFSET UNITYSDK_OFFSET(0x159C2740)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_RESETCURSORPOS_OFFSET UNITYSDK_OFFSET(0x159C81D0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_ROTATECURGOOD_OFFSET UNITYSDK_OFFSET(0x159C5A70)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_ROTATESHIP_OFFSET UNITYSDK_OFFSET(0x159C7E20)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_SELECTGOOD_OFFSET UNITYSDK_OFFSET(0x159C6FF0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_SETLAYERRECURSIVE_OFFSET UNITYSDK_OFFSET(0x159C3420)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_SETTLEGOOD_OFFSET UNITYSDK_OFFSET(0x159C2160)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_SET_CURALLEYPACKCOMPONENT_OFFSET UNITYSDK_OFFSET(0x171B9BD0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_SET_CURJOYSTICKSTATE_OFFSET UNITYSDK_OFFSET(0x159C74C0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_SHOWFINISHORDEREFFECT_OFFSET UNITYSDK_OFFSET(0x159C3720)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_SWITCHJOYSTICKSTATE_OFFSET UNITYSDK_OFFSET(0x159C7320)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_SWITCHSELECTTARGET_OFFSET UNITYSDK_OFFSET(0x159C6150)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0x159C3C50)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_TRYAUTOSETTLE_OFFSET UNITYSDK_OFFSET(0x159C7B10)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_TRYENDDRAG_OFFSET UNITYSDK_OFFSET(0x159C7AC0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_TRYSHOWMATCHANI_OFFSET UNITYSDK_OFFSET(0x171B9C50)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_UNSELECTCURGOOD_OFFSET UNITYSDK_OFFSET(0x159C55C0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_UPDATEDRAGMOUSEPOSOFFSET_OFFSET UNITYSDK_OFFSET(0x159BC7E0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x159C7900)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ADDALLEYPACKCMPT_INTERNAL_OFFSET UNITYSDK_OFFSET(0x159C2510)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ADDALLEYPACKGOODDATA_OFFSET UNITYSDK_OFFSET(0x159C2940)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ADJUSTPOSFROMMOUSE_OFFSET UNITYSDK_OFFSET(0x159C2B00)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__CANCELSETTLEGOOD_INTERNAL_OFFSET UNITYSDK_OFFSET(0x171BAF40)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__CHECKGOODCANSETTLE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x171BBE50)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__COMBINEGOOD_INTERNAL_OFFSET UNITYSDK_OFFSET(0x171BB940)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x171BC030)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__DECOMBINEGOOD_INTERNAL_OFFSET UNITYSDK_OFFSET(0x171BBC20)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__DISPOSEALLEYPACKCMPTCONTAINER_OFFSET UNITYSDK_OFFSET(0x159C31F0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__DISPOSEALLEYPACKGRID_OFFSET UNITYSDK_OFFSET(0x159C32E0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__GETCURMOUSEHOVERCMPT_OFFSET UNITYSDK_OFFSET(0x159C62D0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__GETVIRTUALCURSOR_OFFSET UNITYSDK_OFFSET(0x159C73C0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__INITALLEYPACKCMPTCONTAINER_OFFSET UNITYSDK_OFFSET(0x159C2CF0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__INITALLEYPACKGRID_OFFSET UNITYSDK_OFFSET(0x159C2D80)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__INITEFFECTASSET_OFFSET UNITYSDK_OFFSET(0x159C3B10)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__INITINPUTMANAGER_OFFSET UNITYSDK_OFFSET(0x159C70D0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__INITSHIPCOLLISIONCOMPONENT_OFFSET UNITYSDK_OFFSET(0x159C25D0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ISCURCMPTOUTSIDESHIP_OFFSET UNITYSDK_OFFSET(0x159C6880)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ISCURSORINUIAREA_OFFSET UNITYSDK_OFFSET(0x171B9890)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ISCURSORPOINTGOOD_OFFSET UNITYSDK_OFFSET(0x159C7440)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__LOADFINISHORDEREFFECT_OFFSET UNITYSDK_OFFSET(0x159C3970)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ONALLEYPACKENABLE3DCONTROL_OFFSET UNITYSDK_OFFSET(0x159C7260)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ONCONTROLLERPRESSMENUCANCEL_OFFSET UNITYSDK_OFFSET(0x159C5D50)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ONCONTROLLERPRESSMENUCONFIRM_OFFSET UNITYSDK_OFFSET(0x159C51A0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ONCONTROLLERPRESSRT_OFFSET UNITYSDK_OFFSET(0x159C5A10)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ONCONTROLLERREMOVE_OFFSET UNITYSDK_OFFSET(0x159C58E0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__PROCESSDRAG_OFFSET UNITYSDK_OFFSET(0x159C6E00)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__PROCESSENDDRAG_OFFSET UNITYSDK_OFFSET(0x159C6FA0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__PROCESSSELECTITEM_OFFSET UNITYSDK_OFFSET(0x159C6B10)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__REFRESHJOYSTICKFACTOR_OFFSET UNITYSDK_OFFSET(0x159C6A10)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__REGISTERCONTROLLERJOYSTICK_OFFSET UNITYSDK_OFFSET(0x159C4AD0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__RELEASEEFFECTASSET_OFFSET UNITYSDK_OFFSET(0x159C3BC0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__REMOVEALLEYPACKCMPT_INTERNAL_OFFSET UNITYSDK_OFFSET(0x159C2F10)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__REMOVEALLEYPACKGOODDATA_OFFSET UNITYSDK_OFFSET(0x159C33A0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__REMOVEALLGOODS_OFFSET UNITYSDK_OFFSET(0x159C3030)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__REMOVECURSHIP_OFFSET UNITYSDK_OFFSET(0x159C2790)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__REMOVEGOOD_INTERNAL_OFFSET UNITYSDK_OFFSET(0x171BB270)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__REMOVESHIPCOLLISIONCOMPONENT_OFFSET UNITYSDK_OFFSET(0x159C3180)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__RESETCURSORPOS_OFFSET UNITYSDK_OFFSET(0x159C4DA0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__RESETINPUTPOSPARAM_OFFSET UNITYSDK_OFFSET(0x159C71D0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ROTATESHIP_B__111_0_OFFSET UNITYSDK_OFFSET(0x171BC120)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__SELECTGOOD_INTERNAL_OFFSET UNITYSDK_OFFSET(0x171BA5E0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__SETTLEGOOD_INTERNAL_OFFSET UNITYSDK_OFFSET(0x171BA940)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TICKGAMEPADINPUT_OFFSET UNITYSDK_OFFSET(0x159C44F0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TICKINPUT_OFFSET UNITYSDK_OFFSET(0x159C4250)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TICKJOYSTICKMOVECMPT_OFFSET UNITYSDK_OFFSET(0x159C5D90)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TICKMOUSEINPUTPOSCAL_OFFSET UNITYSDK_OFFSET(0x159C3D00)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TICKMOUSEINPUT_OFFSET UNITYSDK_OFFSET(0x159C3CB0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TICKREFRESHCURSORSTATE_OFFSET UNITYSDK_OFFSET(0x159C4540)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRIGGERGOODADDCALLBACK_OFFSET UNITYSDK_OFFSET(0x159C2C40)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRIGGERGOODCANCELSETTLECALLBACK_OFFSET UNITYSDK_OFFSET(0x159C8290)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRIGGERGOODONDRAGENDCALLBACK_OFFSET UNITYSDK_OFFSET(0x159C7D60)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRIGGERGOODONDRAGSTARTCALLBACK_OFFSET UNITYSDK_OFFSET(0x159C6430)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRIGGERGOODREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x159C7DC0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRIGGERGOODSELECTCALLBACK_OFFSET UNITYSDK_OFFSET(0x159C79E0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRIGGERGOODSETTLECALLBACK_OFFSET UNITYSDK_OFFSET(0x159C8220)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRYENDDRAG_OFFSET UNITYSDK_OFFSET(0x159C66B0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRYSELECT_OFFSET UNITYSDK_OFFSET(0x159C5FF0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRYSTARTDRAG_OFFSET UNITYSDK_OFFSET(0x159C5740)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__UNINITINPUTMANAGER_OFFSET UNITYSDK_OFFSET(0x159C7150)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__UNREGISTERCONTROLLERJOYSTICK_OFFSET UNITYSDK_OFFSET(0x159C4FA0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__UNSELECTGOOD_INTERNAL_OFFSET UNITYSDK_OFFSET(0x171BA790)

namespace RPG::Client::ActivityAlley
{
	inline static constexpr unsigned int AlleyPackController_TypeDefinitionIndex = 68184;
