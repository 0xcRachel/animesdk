...
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_ADDALLEYGOOD_OFFSET UNITYSDK_OFFSET(0x8EEEFC0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_ADDALLEYPACKSHIP_OFFSET UNITYSDK_OFFSET(0x8EEE960)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_ADDUIAREA_OFFSET UNITYSDK_OFFSET(0x8EF6910)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_BEGINDRAGTARGET_OFFSET UNITYSDK_OFFSET(0x8EF2F10)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_CANCELSETTLECURGOOD_OFFSET UNITYSDK_OFFSET(0x8EF4A80)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_CLEARDRAGMOUSEPOSOFFSET_OFFSET UNITYSDK_OFFSET(0x8EE7670)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_CLEARMATCHANI_OFFSET UNITYSDK_OFFSET(0x8EEE440)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_CLEARSHIP_OFFSET UNITYSDK_OFFSET(0x8EEEA60)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_CLEARUIAREA_OFFSET UNITYSDK_OFFSET(0x8EF6980)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_COMBINEGOOD_OFFSET UNITYSDK_OFFSET(0x8EED780)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8EF4460)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_ENDDRAG_OFFSET UNITYSDK_OFFSET(0x8EF1ED0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_GETALLEYPLACINGSHIPINFO_OFFSET UNITYSDK_OFFSET(0x8EEF440)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_GETINTERSECTADJUSTYPOS_OFFSET UNITYSDK_OFFSET(0x8EEBBB0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_GETINTERSECTBOUND_OFFSET UNITYSDK_OFFSET(0x8EF10A0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_GET_ALLGOODDATADICT_OFFSET UNITYSDK_OFFSET(0x8EEFC60)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_GET_CURALLEYPACKCOMPONENT_OFFSET UNITYSDK_OFFSET(0x8EF6B10)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_GET_CURGROUPDATA_OFFSET UNITYSDK_OFFSET(0x8EE8860)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_GET_CURJOYSTICKSTATE_OFFSET UNITYSDK_OFFSET(0x8EF4260)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_GET_SHIPDATA_OFFSET UNITYSDK_OFFSET(0x8EEFC50)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x8EF4280)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_ISINSELECTGROUP_OFFSET UNITYSDK_OFFSET(0x8EF12A0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_LATETICK_OFFSET UNITYSDK_OFFSET(0x8EF07A0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x8EF4740)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_REGISTERGOODOPERATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x8EF6820)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_REMOVECURGOOD_OFFSET UNITYSDK_OFFSET(0x8EF23C0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_REMOVESHIP_OFFSET UNITYSDK_OFFSET(0x8EEEEE0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_RESETCURSORPOS_OFFSET UNITYSDK_OFFSET(0x8EF69F0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_ROTATECURGOOD_OFFSET UNITYSDK_OFFSET(0x8EF24F0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_ROTATESHIP_OFFSET UNITYSDK_OFFSET(0x8EF64D0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_SELECTGOOD_OFFSET UNITYSDK_OFFSET(0x8EF3DA0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_SETLAYERRECURSIVE_OFFSET UNITYSDK_OFFSET(0x8EEFC70)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_SETTLEGOOD_OFFSET UNITYSDK_OFFSET(0x8EEE360)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_SET_CURALLEYPACKCOMPONENT_OFFSET UNITYSDK_OFFSET(0x8EF6B20)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_SET_CURJOYSTICKSTATE_OFFSET UNITYSDK_OFFSET(0x8EF4270)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_SHOWFINISHORDEREFFECT_OFFSET UNITYSDK_OFFSET(0x8EEFF70)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_SWITCHJOYSTICKSTATE_OFFSET UNITYSDK_OFFSET(0x8EF40D0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_SWITCHSELECTTARGET_OFFSET UNITYSDK_OFFSET(0x8EF2BD0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0x8EF04A0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_TRYAUTOSETTLE_OFFSET UNITYSDK_OFFSET(0x8EF51C0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_TRYENDDRAG_OFFSET UNITYSDK_OFFSET(0x8EF5170)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_TRYSHOWMATCHANI_OFFSET UNITYSDK_OFFSET(0x8EF4CB0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_UNSELECTCURGOOD_OFFSET UNITYSDK_OFFSET(0x8EF2040)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_UPDATEDRAGMOUSEPOSOFFSET_OFFSET UNITYSDK_OFFSET(0x8EE76D0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x8EF46B0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ADDALLEYPACKCMPT_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8EEEBE0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ADDALLEYPACKGOODDATA_OFFSET UNITYSDK_OFFSET(0x8EEF0E0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ADJUSTPOSFROMMOUSE_OFFSET UNITYSDK_OFFSET(0x8EEF2A0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__CANCELSETTLEGOOD_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8EF4AF0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__CHECKGOODCANSETTLE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8EF1E50)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__COMBINEGOOD_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8EF4790)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8EF70D0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__DECOMBINEGOOD_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8EF5FE0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__DISPOSEALLEYPACKCMPTCONTAINER_OFFSET UNITYSDK_OFFSET(0x8EEFA40)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__DISPOSEALLEYPACKGRID_OFFSET UNITYSDK_OFFSET(0x8EEFB30)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__GETCURMOUSEHOVERCMPT_OFFSET UNITYSDK_OFFSET(0x8EF2D50)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__GETVIRTUALCURSOR_OFFSET UNITYSDK_OFFSET(0x8EF4170)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__INITALLEYPACKCMPTCONTAINER_OFFSET UNITYSDK_OFFSET(0x8EEF490)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__INITALLEYPACKGRID_OFFSET UNITYSDK_OFFSET(0x8EEF520)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__INITEFFECTASSET_OFFSET UNITYSDK_OFFSET(0x8EF0360)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__INITINPUTMANAGER_OFFSET UNITYSDK_OFFSET(0x8EF3E80)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__INITSHIPCOLLISIONCOMPONENT_OFFSET UNITYSDK_OFFSET(0x8EEECA0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ISCURCMPTOUTSIDESHIP_OFFSET UNITYSDK_OFFSET(0x8EF3300)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ISCURSORINUIAREA_OFFSET UNITYSDK_OFFSET(0x8EF3490)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ISCURSORPOINTGOOD_OFFSET UNITYSDK_OFFSET(0x8EF41F0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__LOADFINISHORDEREFFECT_OFFSET UNITYSDK_OFFSET(0x8EF01C0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ONALLEYPACKENABLE3DCONTROL_OFFSET UNITYSDK_OFFSET(0x8EF4010)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ONCONTROLLERPRESSMENUCANCEL_OFFSET UNITYSDK_OFFSET(0x8EF27D0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ONCONTROLLERPRESSMENUCONFIRM_OFFSET UNITYSDK_OFFSET(0x8EF1BA0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ONCONTROLLERPRESSRT_OFFSET UNITYSDK_OFFSET(0x8EF2490)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ONCONTROLLERREMOVE_OFFSET UNITYSDK_OFFSET(0x8EF2360)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__PROCESSDRAG_OFFSET UNITYSDK_OFFSET(0x8EF3BB0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__PROCESSENDDRAG_OFFSET UNITYSDK_OFFSET(0x8EF3D50)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__PROCESSSELECTITEM_OFFSET UNITYSDK_OFFSET(0x8EF38C0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__REFRESHJOYSTICKFACTOR_OFFSET UNITYSDK_OFFSET(0x8EF37C0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__REGISTERCONTROLLERJOYSTICK_OFFSET UNITYSDK_OFFSET(0x8EF14D0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__RELEASEEFFECTASSET_OFFSET UNITYSDK_OFFSET(0x8EF0410)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__REMOVEALLEYPACKCMPT_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8EEF760)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__REMOVEALLEYPACKGOODDATA_OFFSET UNITYSDK_OFFSET(0x8EEFBF0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__REMOVEALLGOODS_OFFSET UNITYSDK_OFFSET(0x8EEF880)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__REMOVECURSHIP_OFFSET UNITYSDK_OFFSET(0x8EEEF30)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__REMOVEGOOD_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8EF5870)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__REMOVESHIPCOLLISIONCOMPONENT_OFFSET UNITYSDK_OFFSET(0x8EEF9D0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__RESETCURSORPOS_OFFSET UNITYSDK_OFFSET(0x8EF17A0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__RESETINPUTPOSPARAM_OFFSET UNITYSDK_OFFSET(0x8EF3F80)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ROTATESHIP_B__111_0_OFFSET UNITYSDK_OFFSET(0x8EF71C0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__SELECTGOOD_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8EF4860)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__SETTLEGOOD_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8EF5D60)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TICKGAMEPADINPUT_OFFSET UNITYSDK_OFFSET(0x8EF0D40)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TICKINPUT_OFFSET UNITYSDK_OFFSET(0x8EF0AA0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TICKJOYSTICKMOVECMPT_OFFSET UNITYSDK_OFFSET(0x8EF2810)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TICKMOUSEINPUTPOSCAL_OFFSET UNITYSDK_OFFSET(0x8EF0550)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TICKMOUSEINPUT_OFFSET UNITYSDK_OFFSET(0x8EF0500)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TICKREFRESHCURSORSTATE_OFFSET UNITYSDK_OFFSET(0x8EF0D90)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRIGGERGOODADDCALLBACK_OFFSET UNITYSDK_OFFSET(0x8EEF3E0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRIGGERGOODCANCELSETTLECALLBACK_OFFSET UNITYSDK_OFFSET(0x8EF6AB0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRIGGERGOODONDRAGENDCALLBACK_OFFSET UNITYSDK_OFFSET(0x8EF5B50)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRIGGERGOODONDRAGSTARTCALLBACK_OFFSET UNITYSDK_OFFSET(0x8EF2EB0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRIGGERGOODREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x8EF6300)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRIGGERGOODSELECTCALLBACK_OFFSET UNITYSDK_OFFSET(0x8EF4A10)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRIGGERGOODSETTLECALLBACK_OFFSET UNITYSDK_OFFSET(0x8EF6A40)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRYENDDRAG_OFFSET UNITYSDK_OFFSET(0x8EF3130)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRYSELECT_OFFSET UNITYSDK_OFFSET(0x8EF2A70)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRYSTARTDRAG_OFFSET UNITYSDK_OFFSET(0x8EF21C0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__UNINITINPUTMANAGER_OFFSET UNITYSDK_OFFSET(0x8EF3F00)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__UNREGISTERCONTROLLERJOYSTICK_OFFSET UNITYSDK_OFFSET(0x8EF19A0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__UNSELECTGOOD_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8EF5BB0)

namespace RPG::Client::ActivityAlley
{
	inline static constexpr unsigned int AlleyPackController_TypeDefinitionIndex = 60735;
