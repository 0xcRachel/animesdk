...
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_ADDALLEYGOOD_OFFSET UNITYSDK_OFFSET(0x8AEE500)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_ADDALLEYPACKSHIP_OFFSET UNITYSDK_OFFSET(0x8AEDEA0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_ADDUIAREA_OFFSET UNITYSDK_OFFSET(0x8AF5E50)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_BEGINDRAGTARGET_OFFSET UNITYSDK_OFFSET(0x8AF2470)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_CANCELSETTLECURGOOD_OFFSET UNITYSDK_OFFSET(0x8AF3FE0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_CLEARDRAGMOUSEPOSOFFSET_OFFSET UNITYSDK_OFFSET(0x8AE6BB0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_CLEARMATCHANI_OFFSET UNITYSDK_OFFSET(0x8AED980)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_CLEARSHIP_OFFSET UNITYSDK_OFFSET(0x8AEDFA0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_CLEARUIAREA_OFFSET UNITYSDK_OFFSET(0x8AF5EC0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_COMBINEGOOD_OFFSET UNITYSDK_OFFSET(0x8AECCD0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8AF39C0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_ENDDRAG_OFFSET UNITYSDK_OFFSET(0x8AF1420)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_GETALLEYPLACINGSHIPINFO_OFFSET UNITYSDK_OFFSET(0x8AEE980)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_GETINTERSECTADJUSTYPOS_OFFSET UNITYSDK_OFFSET(0x8AEB100)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_GETINTERSECTBOUND_OFFSET UNITYSDK_OFFSET(0x8AF05F0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_GET_ALLGOODDATADICT_OFFSET UNITYSDK_OFFSET(0x8AEF1B0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_GET_CURALLEYPACKCOMPONENT_OFFSET UNITYSDK_OFFSET(0x8AF6050)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_GET_CURGROUPDATA_OFFSET UNITYSDK_OFFSET(0x8AE7DB0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_GET_CURJOYSTICKSTATE_OFFSET UNITYSDK_OFFSET(0x8AF37C0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_GET_SHIPDATA_OFFSET UNITYSDK_OFFSET(0x8AEF1A0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x8AF37E0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_ISINSELECTGROUP_OFFSET UNITYSDK_OFFSET(0x8AF07F0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_LATETICK_OFFSET UNITYSDK_OFFSET(0x8AEFCF0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x8AF3CA0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_REGISTERGOODOPERATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x8AF5D60)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_REMOVECURGOOD_OFFSET UNITYSDK_OFFSET(0x8AF1910)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_REMOVESHIP_OFFSET UNITYSDK_OFFSET(0x8AEE420)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_RESETCURSORPOS_OFFSET UNITYSDK_OFFSET(0x8AF5F30)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_ROTATECURGOOD_OFFSET UNITYSDK_OFFSET(0x8AF1A40)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_ROTATESHIP_OFFSET UNITYSDK_OFFSET(0x8AF5A10)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_SELECTGOOD_OFFSET UNITYSDK_OFFSET(0x8AF3300)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_SETLAYERRECURSIVE_OFFSET UNITYSDK_OFFSET(0x8AEF1C0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_SETTLEGOOD_OFFSET UNITYSDK_OFFSET(0x8AED8A0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_SET_CURALLEYPACKCOMPONENT_OFFSET UNITYSDK_OFFSET(0x8AF6060)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_SET_CURJOYSTICKSTATE_OFFSET UNITYSDK_OFFSET(0x8AF37D0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_SHOWFINISHORDEREFFECT_OFFSET UNITYSDK_OFFSET(0x8AEF4C0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_SWITCHJOYSTICKSTATE_OFFSET UNITYSDK_OFFSET(0x8AF3630)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_SWITCHSELECTTARGET_OFFSET UNITYSDK_OFFSET(0x8AF2130)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0x8AEF9F0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_TRYAUTOSETTLE_OFFSET UNITYSDK_OFFSET(0x8AF4720)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_TRYENDDRAG_OFFSET UNITYSDK_OFFSET(0x8AF46D0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_TRYSHOWMATCHANI_OFFSET UNITYSDK_OFFSET(0x8AF4210)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_UNSELECTCURGOOD_OFFSET UNITYSDK_OFFSET(0x8AF1590)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_UPDATEDRAGMOUSEPOSOFFSET_OFFSET UNITYSDK_OFFSET(0x8AE6C10)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x8AF3C10)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ADDALLEYPACKCMPT_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8AEE120)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ADDALLEYPACKGOODDATA_OFFSET UNITYSDK_OFFSET(0x8AEE620)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ADJUSTPOSFROMMOUSE_OFFSET UNITYSDK_OFFSET(0x8AEE7E0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__CANCELSETTLEGOOD_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8AF4050)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__CHECKGOODCANSETTLE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8AF13A0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__COMBINEGOOD_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8AF3CF0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8AF6610)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__DECOMBINEGOOD_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8AF5520)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__DISPOSEALLEYPACKCMPTCONTAINER_OFFSET UNITYSDK_OFFSET(0x8AEEF90)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__DISPOSEALLEYPACKGRID_OFFSET UNITYSDK_OFFSET(0x8AEF080)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__GETCURMOUSEHOVERCMPT_OFFSET UNITYSDK_OFFSET(0x8AF22B0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__GETVIRTUALCURSOR_OFFSET UNITYSDK_OFFSET(0x8AF36D0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__INITALLEYPACKCMPTCONTAINER_OFFSET UNITYSDK_OFFSET(0x8AEE9D0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__INITALLEYPACKGRID_OFFSET UNITYSDK_OFFSET(0x8AEEA60)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__INITEFFECTASSET_OFFSET UNITYSDK_OFFSET(0x8AEF8B0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__INITINPUTMANAGER_OFFSET UNITYSDK_OFFSET(0x8AF33E0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__INITSHIPCOLLISIONCOMPONENT_OFFSET UNITYSDK_OFFSET(0x8AEE1E0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ISCURCMPTOUTSIDESHIP_OFFSET UNITYSDK_OFFSET(0x8AF2860)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ISCURSORINUIAREA_OFFSET UNITYSDK_OFFSET(0x8AF29F0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ISCURSORPOINTGOOD_OFFSET UNITYSDK_OFFSET(0x8AF3750)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__LOADFINISHORDEREFFECT_OFFSET UNITYSDK_OFFSET(0x8AEF710)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ONALLEYPACKENABLE3DCONTROL_OFFSET UNITYSDK_OFFSET(0x8AF3570)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ONCONTROLLERPRESSMENUCANCEL_OFFSET UNITYSDK_OFFSET(0x8AF1D20)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ONCONTROLLERPRESSMENUCONFIRM_OFFSET UNITYSDK_OFFSET(0x8AF10F0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ONCONTROLLERPRESSRT_OFFSET UNITYSDK_OFFSET(0x8AF19E0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ONCONTROLLERREMOVE_OFFSET UNITYSDK_OFFSET(0x8AF18B0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__PROCESSDRAG_OFFSET UNITYSDK_OFFSET(0x8AF3110)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__PROCESSENDDRAG_OFFSET UNITYSDK_OFFSET(0x8AF32B0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__PROCESSSELECTITEM_OFFSET UNITYSDK_OFFSET(0x8AF2E20)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__REFRESHJOYSTICKFACTOR_OFFSET UNITYSDK_OFFSET(0x8AF2D20)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__REGISTERCONTROLLERJOYSTICK_OFFSET UNITYSDK_OFFSET(0x8AF0A20)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__RELEASEEFFECTASSET_OFFSET UNITYSDK_OFFSET(0x8AEF960)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__REMOVEALLEYPACKCMPT_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8AEECA0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__REMOVEALLEYPACKGOODDATA_OFFSET UNITYSDK_OFFSET(0x8AEF140)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__REMOVEALLGOODS_OFFSET UNITYSDK_OFFSET(0x8AEEDD0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__REMOVECURSHIP_OFFSET UNITYSDK_OFFSET(0x8AEE470)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__REMOVEGOOD_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8AF4DC0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__REMOVESHIPCOLLISIONCOMPONENT_OFFSET UNITYSDK_OFFSET(0x8AEEF20)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__RESETCURSORPOS_OFFSET UNITYSDK_OFFSET(0x8AF0CF0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__RESETINPUTPOSPARAM_OFFSET UNITYSDK_OFFSET(0x8AF34E0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ROTATESHIP_B__111_0_OFFSET UNITYSDK_OFFSET(0x8AF6700)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__SELECTGOOD_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8AF3DC0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__SETTLEGOOD_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8AF52A0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TICKGAMEPADINPUT_OFFSET UNITYSDK_OFFSET(0x8AF0290)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TICKINPUT_OFFSET UNITYSDK_OFFSET(0x8AEFFF0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TICKJOYSTICKMOVECMPT_OFFSET UNITYSDK_OFFSET(0x8AF1D60)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TICKMOUSEINPUTPOSCAL_OFFSET UNITYSDK_OFFSET(0x8AEFAA0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TICKMOUSEINPUT_OFFSET UNITYSDK_OFFSET(0x8AEFA50)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TICKREFRESHCURSORSTATE_OFFSET UNITYSDK_OFFSET(0x8AF02E0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRIGGERGOODADDCALLBACK_OFFSET UNITYSDK_OFFSET(0x8AEE920)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRIGGERGOODCANCELSETTLECALLBACK_OFFSET UNITYSDK_OFFSET(0x8AF5FF0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRIGGERGOODONDRAGENDCALLBACK_OFFSET UNITYSDK_OFFSET(0x8AF5090)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRIGGERGOODONDRAGSTARTCALLBACK_OFFSET UNITYSDK_OFFSET(0x8AF2410)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRIGGERGOODREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x8AF5840)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRIGGERGOODSELECTCALLBACK_OFFSET UNITYSDK_OFFSET(0x8AF3F70)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRIGGERGOODSETTLECALLBACK_OFFSET UNITYSDK_OFFSET(0x8AF5F80)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRYENDDRAG_OFFSET UNITYSDK_OFFSET(0x8AF2690)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRYSELECT_OFFSET UNITYSDK_OFFSET(0x8AF1FC0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRYSTARTDRAG_OFFSET UNITYSDK_OFFSET(0x8AF1710)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__UNINITINPUTMANAGER_OFFSET UNITYSDK_OFFSET(0x8AF3460)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__UNREGISTERCONTROLLERJOYSTICK_OFFSET UNITYSDK_OFFSET(0x8AF0EF0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__UNSELECTGOOD_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8AF50F0)

namespace RPG::Client::ActivityAlley
{
	inline static constexpr unsigned int AlleyPackController_TypeDefinitionIndex = 58983;
