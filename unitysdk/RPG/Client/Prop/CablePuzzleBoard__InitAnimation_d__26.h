...
#define RPG_CLIENT_PROP_CABLEPUZZLEBOARD__INITANIMATION_D__26_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xA034C30)
#define RPG_CLIENT_PROP_CABLEPUZZLEBOARD__INITANIMATION_D__26_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xA0356C0)
#define RPG_CLIENT_PROP_CABLEPUZZLEBOARD__INITANIMATION_D__26_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xA035720)
#define RPG_CLIENT_PROP_CABLEPUZZLEBOARD__INITANIMATION_D__26_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xA0356D0)
#define RPG_CLIENT_PROP_CABLEPUZZLEBOARD__INITANIMATION_D__26_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA034C20)
#define RPG_CLIENT_PROP_CABLEPUZZLEBOARD__INITANIMATION_D__26__CTOR_OFFSET UNITYSDK_OFFSET(0xA0336B0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int CablePuzzleBoard__InitAnimation_d__26_TypeDefinitionIndex = 64055;
