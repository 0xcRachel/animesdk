...
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEITEM_BACKUPORIGIN_OFFSET UNITYSDK_OFFSET(0x15B59020)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEITEM_INIT_OFFSET UNITYSDK_OFFSET(0x15B57A90)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEITEM_METHOD_7_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x15B59700)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEITEM_METHOD_7_F5447CD65612575D_OFFSET UNITYSDK_OFFSET(0x15B597D0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEITEM_ONSELECT_OFFSET UNITYSDK_OFFSET(0x15B59A90)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEITEM_RECOVERORIGIN_OFFSET UNITYSDK_OFFSET(0x15B59260)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEITEM_REFRESHDIRECTION_OFFSET UNITYSDK_OFFSET(0x15B58290)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x15B59B80)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEITEM___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x15B59B90)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEITEM___IFIXBASEPROXY_ONSELECT_OFFSET UNITYSDK_OFFSET(0x15B59BF0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PushHexPuzzleItem_TypeDefinitionIndex = 73140;
