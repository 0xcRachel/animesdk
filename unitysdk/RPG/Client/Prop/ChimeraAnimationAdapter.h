...
#define RPG_CLIENT_PROP_CHIMERAANIMATIONADAPTER_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x9B69E10)
#define RPG_CLIENT_PROP_CHIMERAANIMATIONADAPTER_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x9B69E70)
#define RPG_CLIENT_PROP_CHIMERAANIMATIONADAPTER_PLAY_OFFSET UNITYSDK_OFFSET(0x9B69CE0)
#define RPG_CLIENT_PROP_CHIMERAANIMATIONADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x9B69EF0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraAnimationAdapter_TypeDefinitionIndex = 61656;
