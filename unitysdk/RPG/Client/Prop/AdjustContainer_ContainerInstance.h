...
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_09124A4A24353C26_OFFSET UNITYSDK_OFFSET(0x16206C20)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_100C37D9D1141569_OFFSET UNITYSDK_OFFSET(0x16202170)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_2340068C22DFE332_OFFSET UNITYSDK_OFFSET(0x162000F0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_3DB6944F89094FEC_OFFSET UNITYSDK_OFFSET(0x16200FB0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_66CC9828DB1F478F_OFFSET UNITYSDK_OFFSET(0x162066D0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_B45A873CFEB6DEE0_OFFSET UNITYSDK_OFFSET(0x16202B30)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_B75D122F21CFAD25_OFFSET UNITYSDK_OFFSET(0x162018A0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_B93DCFC57470A0D2_OFFSET UNITYSDK_OFFSET(0x16203FF0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_C3E4F3CB916E5633_OFFSET UNITYSDK_OFFSET(0x16200650)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_D4248573D6F716B1_OFFSET UNITYSDK_OFFSET(0x162042B0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_DFB53B789DEB4FB5_OFFSET UNITYSDK_OFFSET(0x16205CA0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_F026F9F94BAA5E1F_1_OFFSET UNITYSDK_OFFSET(0x16204100)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_F026F9F94BAA5E1F_OFFSET UNITYSDK_OFFSET(0x162040A0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x16206CD0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE___REGENERATENOREUSE_B__11_0_OFFSET UNITYSDK_OFFSET(0x16206D80)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE___REGENERATENOREUSE_B__11_1_OFFSET UNITYSDK_OFFSET(0x16206D90)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int AdjustContainer_ContainerInstance_TypeDefinitionIndex = 72714;
