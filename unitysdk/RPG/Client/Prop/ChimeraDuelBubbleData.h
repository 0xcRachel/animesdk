...
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9B77F90)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelBubbleData_TypeDefinitionIndex = 61543;

	class ChimeraDuelBubbleData : public ::System::Object
	{
	public:
		::RPG::Client::ChimeraDuelTalkData* TalkData; // 0x10
		::RPG::GameCore::ChimeraDuelTalkType TalkType; // 0x18
