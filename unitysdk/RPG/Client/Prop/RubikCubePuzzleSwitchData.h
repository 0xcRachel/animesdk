...
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLESWITCHDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9CDAF20)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RubikCubePuzzleSwitchData_TypeDefinitionIndex = 62102;
