...
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEARROW_INIT_OFFSET UNITYSDK_OFFSET(0x9CAA780)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEARROW_REFRESHDIRECTION_OFFSET UNITYSDK_OFFSET(0x9CAA800)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEARROW__CTOR_OFFSET UNITYSDK_OFFSET(0x9CAA9F0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEARROW___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x9CAAA00)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PushHexPuzzleArrow_TypeDefinitionIndex = 61880;
