...
#define RPG_CLIENT_PROP_PADSPUZZLEENDPAD_INITSTATE_OFFSET UNITYSDK_OFFSET(0x15B33ED0)
#define RPG_CLIENT_PROP_PADSPUZZLEENDPAD_METHOD_7_46E030E6F5465A66_OFFSET UNITYSDK_OFFSET(0x15B34D10)
#define RPG_CLIENT_PROP_PADSPUZZLEENDPAD_METHOD_7_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x15B34A60)
#define RPG_CLIENT_PROP_PADSPUZZLEENDPAD_PUZZLEENTER_OFFSET UNITYSDK_OFFSET(0x15B343F0)
#define RPG_CLIENT_PROP_PADSPUZZLEENDPAD_PUZZLERESET_OFFSET UNITYSDK_OFFSET(0x15B348F0)
#define RPG_CLIENT_PROP_PADSPUZZLEENDPAD_PUZZLESUCCEED_OFFSET UNITYSDK_OFFSET(0x15B34740)
#define RPG_CLIENT_PROP_PADSPUZZLEENDPAD__CTOR_OFFSET UNITYSDK_OFFSET(0x15B34C10)
#define RPG_CLIENT_PROP_PADSPUZZLEENDPAD___IFIXBASEPROXY_INITSTATE_OFFSET UNITYSDK_OFFSET(0x15B34C30)
#define RPG_CLIENT_PROP_PADSPUZZLEENDPAD___IFIXBASEPROXY_PUZZLEENTER_OFFSET UNITYSDK_OFFSET(0x15B34C40)
#define RPG_CLIENT_PROP_PADSPUZZLEENDPAD___IFIXBASEPROXY_PUZZLERESET_OFFSET UNITYSDK_OFFSET(0x15B34CB0)
#define RPG_CLIENT_PROP_PADSPUZZLEENDPAD___IFIXBASEPROXY_PUZZLESUCCEED_OFFSET UNITYSDK_OFFSET(0x15B34C50)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PadsPuzzleEndPad_TypeDefinitionIndex = 73263;
