...
#define RPG_CLIENT_PROP_PADSPUZZLEENDPAD_INITSTATE_OFFSET UNITYSDK_OFFSET(0x13A887D0)
#define RPG_CLIENT_PROP_PADSPUZZLEENDPAD_METHOD_7_924C62BE8591D2FD_OFFSET UNITYSDK_OFFSET(0x13A895F0)
#define RPG_CLIENT_PROP_PADSPUZZLEENDPAD_METHOD_7_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x13A89340)
#define RPG_CLIENT_PROP_PADSPUZZLEENDPAD_PUZZLEENTER_OFFSET UNITYSDK_OFFSET(0x13A88CD0)
#define RPG_CLIENT_PROP_PADSPUZZLEENDPAD_PUZZLERESET_OFFSET UNITYSDK_OFFSET(0x13A891D0)
#define RPG_CLIENT_PROP_PADSPUZZLEENDPAD_PUZZLESUCCEED_OFFSET UNITYSDK_OFFSET(0x13A89020)
#define RPG_CLIENT_PROP_PADSPUZZLEENDPAD__CTOR_OFFSET UNITYSDK_OFFSET(0x13A894F0)
#define RPG_CLIENT_PROP_PADSPUZZLEENDPAD___IFIXBASEPROXY_INITSTATE_OFFSET UNITYSDK_OFFSET(0x13A89510)
#define RPG_CLIENT_PROP_PADSPUZZLEENDPAD___IFIXBASEPROXY_PUZZLEENTER_OFFSET UNITYSDK_OFFSET(0x13A89520)
#define RPG_CLIENT_PROP_PADSPUZZLEENDPAD___IFIXBASEPROXY_PUZZLERESET_OFFSET UNITYSDK_OFFSET(0x13A89590)
#define RPG_CLIENT_PROP_PADSPUZZLEENDPAD___IFIXBASEPROXY_PUZZLESUCCEED_OFFSET UNITYSDK_OFFSET(0x13A89530)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PadsPuzzleEndPad_TypeDefinitionIndex = 72241;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_PADSPUZZLEENDPAD_METHOD_7_924C62BE8591D2FD_OFFSET))(this);
		}
	};
}
