...
#define RPG_CLIENT_PROP_CHIMERADUELJUMPTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x15823380)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelJumpText_TypeDefinitionIndex = 71770;
	...
	public:
		...
		::RPG::Client::Prop::ChimeraDuelJumpTextType Type; // 0x20
