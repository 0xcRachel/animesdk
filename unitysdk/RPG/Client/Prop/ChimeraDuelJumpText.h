...
#define RPG_CLIENT_PROP_CHIMERADUELJUMPTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9B82880)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelJumpText_TypeDefinitionIndex = 61537;

	class ChimeraDuelJumpText : public ::System::Object
	{
	public:
		::System::Int32 InitialValue; // 0x10
		::System::Int32 ActualValue; // 0x14
