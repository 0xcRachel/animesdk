...
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING__DOROTATEACTION_D__10_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x133AB780)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING__DOROTATEACTION_D__10_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x133ABFB0)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING__DOROTATEACTION_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x133AC010)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING__DOROTATEACTION_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x133ABFC0)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING__DOROTATEACTION_D__10_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x133AB770)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING__DOROTATEACTION_D__10__CTOR_OFFSET UNITYSDK_OFFSET(0x133AB1B0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int LaserTurnablePuzzleRing__DoRotateAction_d__10_TypeDefinitionIndex = 73190;
	...
	public:
		...
		::System::Single _st_5__6; // 0x20
		::System::Boolean _childRotate_5__5; // 0x24
		::System::Int32 __1__state; // 0x28
		::System::Int32 targetDegree; // 0x2C
