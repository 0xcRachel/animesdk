...
#define RPG_CLIENT_PROP_ADVMONEYMANAGER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9B3D410)
#define RPG_CLIENT_PROP_ADVMONEYMANAGER_GETEFFECTPARAMS_OFFSET UNITYSDK_OFFSET(0x9B3ED50)
#define RPG_CLIENT_PROP_ADVMONEYMANAGER_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x9B3F320)
#define RPG_CLIENT_PROP_ADVMONEYMANAGER_INITMANAGER_OFFSET UNITYSDK_OFFSET(0x9B3CEF0)
#define RPG_CLIENT_PROP_ADVMONEYMANAGER_LOGICTICK_OFFSET UNITYSDK_OFFSET(0x9B3E300)
#define RPG_CLIENT_PROP_ADVMONEYMANAGER_METHOD_5_187B4790D46C8F21_OFFSET UNITYSDK_OFFSET(0x9B3F950)
#define RPG_CLIENT_PROP_ADVMONEYMANAGER_METHOD_5_74FE0F242303E029_OFFSET UNITYSDK_OFFSET(0x9B3F740)
#define RPG_CLIENT_PROP_ADVMONEYMANAGER_METHOD_5_998E02F9D6277E03_OFFSET UNITYSDK_OFFSET(0x9B3EF70)
#define RPG_CLIENT_PROP_ADVMONEYMANAGER_ONCANCELSPAWN_OFFSET UNITYSDK_OFFSET(0x9B3F6C0)
#define RPG_CLIENT_PROP_ADVMONEYMANAGER_ONSPAWNASYNC_OFFSET UNITYSDK_OFFSET(0x9B3F330)
#define RPG_CLIENT_PROP_ADVMONEYMANAGER_SPAWNMONEY_OFFSET UNITYSDK_OFFSET(0x9B3DFF0)
#define RPG_CLIENT_PROP_ADVMONEYMANAGER_USELIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x9B3F700)
#define RPG_CLIENT_PROP_ADVMONEYMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x9B3FBD0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int AdvMoneyManager_TypeDefinitionIndex = 61456;
	...
	public:
		...
		::System::Void Method_5_187B4790D46C8F21(::Class_0_16E4307DCC419505_347* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_347*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_ADVMONEYMANAGER_METHOD_5_187B4790D46C8F21_OFFSET))(this, a1);
		}
