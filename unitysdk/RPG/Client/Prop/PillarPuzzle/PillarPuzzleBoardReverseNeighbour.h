...
#define RPG_CLIENT_PROP_PILLARPUZZLE_PILLARPUZZLEBOARDREVERSENEIGHBOUR_INITPILLARPROPS_OFFSET UNITYSDK_OFFSET(0x15B3BE20)
#define RPG_CLIENT_PROP_PILLARPUZZLE_PILLARPUZZLEBOARDREVERSENEIGHBOUR_METHOD_7_FEB104F83913DCF9_OFFSET UNITYSDK_OFFSET(0x15B3BA10)
#define RPG_CLIENT_PROP_PILLARPUZZLE_PILLARPUZZLEBOARDREVERSENEIGHBOUR_ONPILLARHIT_OFFSET UNITYSDK_OFFSET(0x15B3C120)
#define RPG_CLIENT_PROP_PILLARPUZZLE_PILLARPUZZLEBOARDREVERSENEIGHBOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x15B3C530)
#define RPG_CLIENT_PROP_PILLARPUZZLE_PILLARPUZZLEBOARDREVERSENEIGHBOUR___IFIXBASEPROXY_INITPILLARPROPS_OFFSET UNITYSDK_OFFSET(0x15B3C7B0)

namespace RPG::Client::Prop::PillarPuzzle
{
	inline static constexpr unsigned int PillarPuzzleBoardReverseNeighbour_TypeDefinitionIndex = 73487;
