...
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_PARTSCONFIG_GET_MODELBODY_OFFSET UNITYSDK_OFFSET(0x1581F3F0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_PARTSCONFIG_GET_MODELHORN_OFFSET UNITYSDK_OFFSET(0x1581F410)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_PARTSCONFIG_GET_MODELITEMMATOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1581F470)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_PARTSCONFIG_GET_MODELTAIL_OFFSET UNITYSDK_OFFSET(0x1581F450)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_PARTSCONFIG_GET_MODELWING_OFFSET UNITYSDK_OFFSET(0x1581F430)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_PARTSCONFIG_SET_MODELBODY_OFFSET UNITYSDK_OFFSET(0x1581F400)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_PARTSCONFIG_SET_MODELHORN_OFFSET UNITYSDK_OFFSET(0x1581F420)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_PARTSCONFIG_SET_MODELITEMMATOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1581F480)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_PARTSCONFIG_SET_MODELTAIL_OFFSET UNITYSDK_OFFSET(0x1581F460)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_PARTSCONFIG_SET_MODELWING_OFFSET UNITYSDK_OFFSET(0x1581F440)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_PARTSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1581E990)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelChimeraModelView_PartsConfig_TypeDefinitionIndex = 71824;
