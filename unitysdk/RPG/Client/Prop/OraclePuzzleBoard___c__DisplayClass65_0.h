...
#define RPG_CLIENT_PROP_ORACLEPUZZLEBOARD___C__DISPLAYCLASS65_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA10BCF0)
#define RPG_CLIENT_PROP_ORACLEPUZZLEBOARD___C__DISPLAYCLASS65_0___STARTPUZZLEPANELTRANSITION_B__0_OFFSET UNITYSDK_OFFSET(0xA10CC10)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int OraclePuzzleBoard___c__DisplayClass65_0_TypeDefinitionIndex = 64175;
