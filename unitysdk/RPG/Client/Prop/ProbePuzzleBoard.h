...
#define RPG_CLIENT_PROP_PROBEPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9CA6E60)
#define RPG_CLIENT_PROP_PROBEPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0x9CA6450)
#define RPG_CLIENT_PROP_PROBEPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0x9CA6E10)
#define RPG_CLIENT_PROP_PROBEPUZZLEBOARD_METHOD_6_0A0A3F0F2DFB2D03_OFFSET UNITYSDK_OFFSET(0x9CA8990)
#define RPG_CLIENT_PROP_PROBEPUZZLEBOARD_METHOD_6_1A6BA74B1FDC4CEB_OFFSET UNITYSDK_OFFSET(0x9CA9970)
#define RPG_CLIENT_PROP_PROBEPUZZLEBOARD_METHOD_6_1C1866DEF4DE26A9_OFFSET UNITYSDK_OFFSET(0x9CA9270)
#define RPG_CLIENT_PROP_PROBEPUZZLEBOARD_METHOD_6_2372762F4122DEB8_OFFSET UNITYSDK_OFFSET(0x9CA6AE0)
#define RPG_CLIENT_PROP_PROBEPUZZLEBOARD_METHOD_6_CE017E2A52468EF8_OFFSET UNITYSDK_OFFSET(0x9CA7660)
#define RPG_CLIENT_PROP_PROBEPUZZLEBOARD_RESET_OFFSET UNITYSDK_OFFSET(0x9CA7320)
#define RPG_CLIENT_PROP_PROBEPUZZLEBOARD_SETRESETNUMBER_OFFSET UNITYSDK_OFFSET(0x9CA7270)
#define RPG_CLIENT_PROP_PROBEPUZZLEBOARD_UPDATE_OFFSET UNITYSDK_OFFSET(0x9CA6B60)
#define RPG_CLIENT_PROP_PROBEPUZZLEBOARD__CCTOR_OFFSET UNITYSDK_OFFSET(0x9CA9F10)
#define RPG_CLIENT_PROP_PROBEPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x9CA9DD0)
#define RPG_CLIENT_PROP_PROBEPUZZLEBOARD___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9CAA000)
#define RPG_CLIENT_PROP_PROBEPUZZLEBOARD___IFIXBASEPROXY_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0x9CA9F80)
#define RPG_CLIENT_PROP_PROBEPUZZLEBOARD___IFIXBASEPROXY_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0x9CA9F90)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ProbePuzzleBoard_TypeDefinitionIndex = 62041;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(ProbePuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x42E00);
		}
		static ::UnityEngine::Vector3* StaticGet_Field_6_31()
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(ProbePuzzleBoard_TypeDefinitionIndex)->GetStaticField(0xF740);
		}
		static ::System::Int32* StaticGet_Field_6_29()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ProbePuzzleBoard_TypeDefinitionIndex)->GetStaticField(0xF74C);
		}
		static ::System::Int32* StaticGet_Field_6_30()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ProbePuzzleBoard_TypeDefinitionIndex)->GetStaticField(0xF750);
		}
		static ::UnityEngine::Vector3* StaticGet_Field_6_32()
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(ProbePuzzleBoard_TypeDefinitionIndex)->GetStaticField(0xF754);
		}
