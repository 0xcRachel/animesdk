...
#define RPG_CLIENT_PROP_CHIMERAPREPARATIONSTATECONTROLLERBASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA074780)
#define RPG_CLIENT_PROP_CHIMERAPREPARATIONSTATECONTROLLERBASE_INIT_OFFSET UNITYSDK_OFFSET(0xA0746B0)
#define RPG_CLIENT_PROP_CHIMERAPREPARATIONSTATECONTROLLERBASE_ONENTER_OFFSET UNITYSDK_OFFSET(0xA068000)
#define RPG_CLIENT_PROP_CHIMERAPREPARATIONSTATECONTROLLERBASE_ONEXIT_OFFSET UNITYSDK_OFFSET(0xA068F80)
#define RPG_CLIENT_PROP_CHIMERAPREPARATIONSTATECONTROLLERBASE_ONTICK_OFFSET UNITYSDK_OFFSET(0xA074720)
#define RPG_CLIENT_PROP_CHIMERAPREPARATIONSTATECONTROLLERBASE_SWITCHTO_OFFSET UNITYSDK_OFFSET(0xA068280)
#define RPG_CLIENT_PROP_CHIMERAPREPARATIONSTATECONTROLLERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xA0683B0)
#define RPG_CLIENT_PROP_CHIMERAPREPARATIONSTATECONTROLLERBASE__HANDLEUISCREENSIZECHANGED_OFFSET UNITYSDK_OFFSET(0xA06A5E0)
#define RPG_CLIENT_PROP_CHIMERAPREPARATIONSTATECONTROLLERBASE__INIT_OFFSET UNITYSDK_OFFSET(0xA06BF20)
#define RPG_CLIENT_PROP_CHIMERAPREPARATIONSTATECONTROLLERBASE__ONUISCREENSIZECHANGED_OFFSET UNITYSDK_OFFSET(0xA0747E0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraPreparationStateControllerBase_TypeDefinitionIndex = 63929;
