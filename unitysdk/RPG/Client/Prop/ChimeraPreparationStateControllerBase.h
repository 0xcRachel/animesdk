...
#define RPG_CLIENT_PROP_CHIMERAPREPARATIONSTATECONTROLLERBASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9BA2C80)
#define RPG_CLIENT_PROP_CHIMERAPREPARATIONSTATECONTROLLERBASE_INIT_OFFSET UNITYSDK_OFFSET(0x9BA2BB0)
#define RPG_CLIENT_PROP_CHIMERAPREPARATIONSTATECONTROLLERBASE_ONENTER_OFFSET UNITYSDK_OFFSET(0x9B96640)
#define RPG_CLIENT_PROP_CHIMERAPREPARATIONSTATECONTROLLERBASE_ONEXIT_OFFSET UNITYSDK_OFFSET(0x9B975D0)
#define RPG_CLIENT_PROP_CHIMERAPREPARATIONSTATECONTROLLERBASE_ONTICK_OFFSET UNITYSDK_OFFSET(0x9BA2C20)
#define RPG_CLIENT_PROP_CHIMERAPREPARATIONSTATECONTROLLERBASE_SWITCHTO_OFFSET UNITYSDK_OFFSET(0x9B968C0)
#define RPG_CLIENT_PROP_CHIMERAPREPARATIONSTATECONTROLLERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x9B969F0)
#define RPG_CLIENT_PROP_CHIMERAPREPARATIONSTATECONTROLLERBASE__HANDLEUISCREENSIZECHANGED_OFFSET UNITYSDK_OFFSET(0x9B98C00)
#define RPG_CLIENT_PROP_CHIMERAPREPARATIONSTATECONTROLLERBASE__INIT_OFFSET UNITYSDK_OFFSET(0x9B9A540)
#define RPG_CLIENT_PROP_CHIMERAPREPARATIONSTATECONTROLLERBASE__ONUISCREENSIZECHANGED_OFFSET UNITYSDK_OFFSET(0x9BA2CE0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraPreparationStateControllerBase_TypeDefinitionIndex = 61742;

	class ChimeraPreparationStateControllerBase : public ::UnityEngine::MonoBehaviour
	{
	public:
		::Class_0_16E4307DCC419505_937* _StateMachine; // 0x18
		...
		::System::Void Init(::Class_0_16E4307DCC419505_937* stateMachine, ::Class_1_9C1673530BBC4E15* sharedContext)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_937*, ::Class_1_9C1673530BBC4E15*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_CHIMERAPREPARATIONSTATECONTROLLERBASE_INIT_OFFSET))(this, stateMachine, sharedContext);
		}
