...
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_ANIMROTATEANYANGLE_OFFSET UNITYSDK_OFFSET(0xA0DAC20)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_ANIMROTATE_OFFSET UNITYSDK_OFFSET(0xA0D3D80)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA0D68A0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_GETCENTEROID_OFFSET UNITYSDK_OFFSET(0xA0DB5E0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_GETCOLORMATERIALS_OFFSET UNITYSDK_OFFSET(0xA0D58F0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_GETGROUP_OFFSET UNITYSDK_OFFSET(0xA0DA370)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_GET_ISCOMPLETE_OFFSET UNITYSDK_OFFSET(0xA0D3050)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_INITCUBE_OFFSET UNITYSDK_OFFSET(0xA0D24C0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_INITSECONDORDER_OFFSET UNITYSDK_OFFSET(0xA0D5AF0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_METHOD_6_6D8B8CD47CD59618_OFFSET UNITYSDK_OFFSET(0xA0DBE50)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA0D6860)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_ONROTATEFINISH_OFFSET UNITYSDK_OFFSET(0xA0DBAD0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_ONROTATESTART_OFFSET UNITYSDK_OFFSET(0xA0DBA50)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_REGISTERFRAME_OFFSET UNITYSDK_OFFSET(0xA0D4C40)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_REGISTERROTATEFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0xA0D4590)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_ROTATEX_OFFSET UNITYSDK_OFFSET(0xA0D68E0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_ROTATEY_OFFSET UNITYSDK_OFFSET(0xA0D7CE0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_ROTATEZ_OFFSET UNITYSDK_OFFSET(0xA0D8FF0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_SELECTGROUPTEST_OFFSET UNITYSDK_OFFSET(0xA0DAB70)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_SELECTGROUP_OFFSET UNITYSDK_OFFSET(0xA0D41D0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_SETBLOCKMATERIAL_OFFSET UNITYSDK_OFFSET(0xA0DABD0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_UNREGISTERROTATEFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0xA0D4820)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE__CTOR_OFFSET UNITYSDK_OFFSET(0xA0DBEB0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_ANIMROTATEANYANGLE_OFFSET UNITYSDK_OFFSET(0xA0DC000)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_ANIMROTATE_OFFSET UNITYSDK_OFFSET(0xA0DC080)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA0DBF30)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_GETCENTEROID_OFFSET UNITYSDK_OFFSET(0xA0DC050)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_GET_ISCOMPLETE_OFFSET UNITYSDK_OFFSET(0xA0DC0B0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_INITSECONDORDER_OFFSET UNITYSDK_OFFSET(0xA0DBF20)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_ONROTATEFINISH_OFFSET UNITYSDK_OFFSET(0xA0DC0A0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_ONROTATESTART_OFFSET UNITYSDK_OFFSET(0xA0DC090)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_ROTATEX_OFFSET UNITYSDK_OFFSET(0xA0DBF40)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_ROTATEY_OFFSET UNITYSDK_OFFSET(0xA0DBF50)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_ROTATEZ_OFFSET UNITYSDK_OFFSET(0xA0DBF60)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_SELECTGROUPTEST_OFFSET UNITYSDK_OFFSET(0xA0DBF80)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_SELECTGROUP_OFFSET UNITYSDK_OFFSET(0xA0DBF70)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int LightRubikCubePuzzleCube_TypeDefinitionIndex = 64135;
