...
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_ANIMROTATEANYANGLE_OFFSET UNITYSDK_OFFSET(0x10363180)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_ANIMROTATE_OFFSET UNITYSDK_OFFSET(0x1035C2E0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1035EE00)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_GETCENTEROID_OFFSET UNITYSDK_OFFSET(0x10363B40)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_GETCOLORMATERIALS_OFFSET UNITYSDK_OFFSET(0x1035DE50)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_GETGROUP_OFFSET UNITYSDK_OFFSET(0x103628D0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_GET_ISCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1035B5B0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_INITCUBE_OFFSET UNITYSDK_OFFSET(0x1035AA20)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_INITSECONDORDER_OFFSET UNITYSDK_OFFSET(0x1035E050)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_METHOD_6_6D8B8CD47CD59618_OFFSET UNITYSDK_OFFSET(0x103643B0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1035EDC0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_ONROTATEFINISH_OFFSET UNITYSDK_OFFSET(0x10364030)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_ONROTATESTART_OFFSET UNITYSDK_OFFSET(0x10363FB0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_REGISTERFRAME_OFFSET UNITYSDK_OFFSET(0x1035D1A0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_REGISTERROTATEFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0x1035CAF0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_ROTATEX_OFFSET UNITYSDK_OFFSET(0x1035EE40)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_ROTATEY_OFFSET UNITYSDK_OFFSET(0x10360240)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_ROTATEZ_OFFSET UNITYSDK_OFFSET(0x10361550)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_SELECTGROUPTEST_OFFSET UNITYSDK_OFFSET(0x103630D0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_SELECTGROUP_OFFSET UNITYSDK_OFFSET(0x1035C730)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_SETBLOCKMATERIAL_OFFSET UNITYSDK_OFFSET(0x10363130)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_UNREGISTERROTATEFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0x1035CD80)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE__CTOR_OFFSET UNITYSDK_OFFSET(0x10364410)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_ANIMROTATEANYANGLE_OFFSET UNITYSDK_OFFSET(0x10364560)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_ANIMROTATE_OFFSET UNITYSDK_OFFSET(0x103645E0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10364490)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_GETCENTEROID_OFFSET UNITYSDK_OFFSET(0x103645B0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_GET_ISCOMPLETE_OFFSET UNITYSDK_OFFSET(0x10364610)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_INITSECONDORDER_OFFSET UNITYSDK_OFFSET(0x10364480)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_ONROTATEFINISH_OFFSET UNITYSDK_OFFSET(0x10364600)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_ONROTATESTART_OFFSET UNITYSDK_OFFSET(0x103645F0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_ROTATEX_OFFSET UNITYSDK_OFFSET(0x103644A0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_ROTATEY_OFFSET UNITYSDK_OFFSET(0x103644B0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_ROTATEZ_OFFSET UNITYSDK_OFFSET(0x103644C0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_SELECTGROUPTEST_OFFSET UNITYSDK_OFFSET(0x103644E0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_SELECTGROUP_OFFSET UNITYSDK_OFFSET(0x103644D0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int LightRubikCubePuzzleCube_TypeDefinitionIndex = 72182;
