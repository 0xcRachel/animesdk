...
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_ANIMROTATEANYANGLE_OFFSET UNITYSDK_OFFSET(0x9C4DF40)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_ANIMROTATE_OFFSET UNITYSDK_OFFSET(0x9C470A0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9C49BC0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_GETCENTEROID_OFFSET UNITYSDK_OFFSET(0x9C4E900)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_GETCOLORMATERIALS_OFFSET UNITYSDK_OFFSET(0x9C48C10)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_GETGROUP_OFFSET UNITYSDK_OFFSET(0x9C4D690)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_GET_ISCOMPLETE_OFFSET UNITYSDK_OFFSET(0x9C46390)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_INITCUBE_OFFSET UNITYSDK_OFFSET(0x9C45800)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_INITSECONDORDER_OFFSET UNITYSDK_OFFSET(0x9C48E10)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_METHOD_6_08C9B39C07B526E4_OFFSET UNITYSDK_OFFSET(0x9C4F170)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x9C49B80)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_ONROTATEFINISH_OFFSET UNITYSDK_OFFSET(0x9C4EDF0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_ONROTATESTART_OFFSET UNITYSDK_OFFSET(0x9C4ED70)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_REGISTERFRAME_OFFSET UNITYSDK_OFFSET(0x9C47F60)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_REGISTERROTATEFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0x9C478B0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_ROTATEX_OFFSET UNITYSDK_OFFSET(0x9C49C00)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_ROTATEY_OFFSET UNITYSDK_OFFSET(0x9C4B000)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_ROTATEZ_OFFSET UNITYSDK_OFFSET(0x9C4C310)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_SELECTGROUPTEST_OFFSET UNITYSDK_OFFSET(0x9C4DE90)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_SELECTGROUP_OFFSET UNITYSDK_OFFSET(0x9C474F0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_SETBLOCKMATERIAL_OFFSET UNITYSDK_OFFSET(0x9C4DEF0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_UNREGISTERROTATEFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0x9C47B40)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE__CTOR_OFFSET UNITYSDK_OFFSET(0x9C4F1D0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_ANIMROTATEANYANGLE_OFFSET UNITYSDK_OFFSET(0x9C4F320)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_ANIMROTATE_OFFSET UNITYSDK_OFFSET(0x9C4F3A0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9C4F250)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_GETCENTEROID_OFFSET UNITYSDK_OFFSET(0x9C4F370)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_GET_ISCOMPLETE_OFFSET UNITYSDK_OFFSET(0x9C4F3D0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_INITSECONDORDER_OFFSET UNITYSDK_OFFSET(0x9C4F240)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_ONROTATEFINISH_OFFSET UNITYSDK_OFFSET(0x9C4F3C0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_ONROTATESTART_OFFSET UNITYSDK_OFFSET(0x9C4F3B0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_ROTATEX_OFFSET UNITYSDK_OFFSET(0x9C4F260)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_ROTATEY_OFFSET UNITYSDK_OFFSET(0x9C4F270)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_ROTATEZ_OFFSET UNITYSDK_OFFSET(0x9C4F280)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_SELECTGROUPTEST_OFFSET UNITYSDK_OFFSET(0x9C4F2A0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_SELECTGROUP_OFFSET UNITYSDK_OFFSET(0x9C4F290)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int LightRubikCubePuzzleCube_TypeDefinitionIndex = 61948;
	...
	public:
		...
		::System::Void Method_6_08C9B39C07B526E4()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_METHOD_6_08C9B39C07B526E4_OFFSET))(this);
		}
