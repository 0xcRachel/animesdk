...
#define RPG_CLIENT_PROP_CABLEPUZZLEBOARD__DELAYREFRESH_D__9_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xA0349C0)
#define RPG_CLIENT_PROP_CABLEPUZZLEBOARD__DELAYREFRESH_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xA034BB0)
#define RPG_CLIENT_PROP_CABLEPUZZLEBOARD__DELAYREFRESH_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xA034C10)
#define RPG_CLIENT_PROP_CABLEPUZZLEBOARD__DELAYREFRESH_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xA034BC0)
#define RPG_CLIENT_PROP_CABLEPUZZLEBOARD__DELAYREFRESH_D__9_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA0349B0)
#define RPG_CLIENT_PROP_CABLEPUZZLEBOARD__DELAYREFRESH_D__9__CTOR_OFFSET UNITYSDK_OFFSET(0xA030AD0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int CablePuzzleBoard__DelayRefresh_d__9_TypeDefinitionIndex = 64054;
