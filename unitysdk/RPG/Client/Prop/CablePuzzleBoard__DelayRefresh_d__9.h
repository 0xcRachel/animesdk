...
#define RPG_CLIENT_PROP_CABLEPUZZLEBOARD__DELAYREFRESH_D__9_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x158031F0)
#define RPG_CLIENT_PROP_CABLEPUZZLEBOARD__DELAYREFRESH_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x158033E0)
#define RPG_CLIENT_PROP_CABLEPUZZLEBOARD__DELAYREFRESH_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x15803440)
#define RPG_CLIENT_PROP_CABLEPUZZLEBOARD__DELAYREFRESH_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x158033F0)
#define RPG_CLIENT_PROP_CABLEPUZZLEBOARD__DELAYREFRESH_D__9_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x158031E0)
#define RPG_CLIENT_PROP_CABLEPUZZLEBOARD__DELAYREFRESH_D__9__CTOR_OFFSET UNITYSDK_OFFSET(0x157FF300)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int CablePuzzleBoard__DelayRefresh_d__9_TypeDefinitionIndex = 72101;
