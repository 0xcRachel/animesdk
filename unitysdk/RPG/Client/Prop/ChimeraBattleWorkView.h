...
#define RPG_CLIENT_PROP_CHIMERABATTLEWORKVIEW_PLAYBREAK_OFFSET UNITYSDK_OFFSET(0x158160B0)
#define RPG_CLIENT_PROP_CHIMERABATTLEWORKVIEW_PLAYDITHER_OFFSET UNITYSDK_OFFSET(0x15815F90)
#define RPG_CLIENT_PROP_CHIMERABATTLEWORKVIEW_PLAYOPENBOX_OFFSET UNITYSDK_OFFSET(0x15815FE0)
#define RPG_CLIENT_PROP_CHIMERABATTLEWORKVIEW_SETATTACHPOINTACTIVE_OFFSET UNITYSDK_OFFSET(0x158161B0)
#define RPG_CLIENT_PROP_CHIMERABATTLEWORKVIEW_START_OFFSET UNITYSDK_OFFSET(0x15815EE0)
#define RPG_CLIENT_PROP_CHIMERABATTLEWORKVIEW__CCTOR_OFFSET UNITYSDK_OFFSET(0x158162B0)
#define RPG_CLIENT_PROP_CHIMERABATTLEWORKVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x158162A0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraBattleWorkView_TypeDefinitionIndex = 71942;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ChimeraBattleWorkView_TypeDefinitionIndex)->GetStaticField(0x1B80);
		}
