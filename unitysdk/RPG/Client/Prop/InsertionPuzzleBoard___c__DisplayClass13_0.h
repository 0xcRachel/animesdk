...
#define RPG_CLIENT_PROP_INSERTIONPUZZLEBOARD___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1338C950)
#define RPG_CLIENT_PROP_INSERTIONPUZZLEBOARD___C__DISPLAYCLASS13_0__PLAYERROTATEAROUNDCENTER_B__1_OFFSET UNITYSDK_OFFSET(0x13390C90)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int InsertionPuzzleBoard___c__DisplayClass13_0_TypeDefinitionIndex = 73144;

	class InsertionPuzzleBoard___c__DisplayClass13_0 : public ::System::Object
	{
	public:
		::Class_3_CD04D3296DF4C842_12* __9__1; // 0x10
		::System::Collections::Generic::List_1<::Struct_2_32361ACFB28DADC0>* blockCoords; // 0x18
		::RPG::Client::Prop::InsertionPuzzleBoard* __4__this; // 0x20
