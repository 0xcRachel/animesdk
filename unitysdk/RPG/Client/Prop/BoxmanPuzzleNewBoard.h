...
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_DESTROYINTERACTTARGETENTITY_OFFSET UNITYSDK_OFFSET(0xA02B940)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA02E670)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_INITITEMS_OFFSET UNITYSDK_OFFSET(0xA029E00)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_INITOPTIONS_OFFSET UNITYSDK_OFFSET(0xA02B6D0)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xA029DB0)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_METHOD_8_01509228E3A9577B_OFFSET UNITYSDK_OFFSET(0xA02D110)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_METHOD_8_0946D2F262750751_OFFSET UNITYSDK_OFFSET(0xA02D090)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_METHOD_8_2372762F4122DEB8_OFFSET UNITYSDK_OFFSET(0xA02B8C0)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_METHOD_8_61019C706ABBB921_OFFSET UNITYSDK_OFFSET(0xA02D640)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_METHOD_8_6F826D2C1894C968_OFFSET UNITYSDK_OFFSET(0xA02D7D0)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_METHOD_8_82DA7C9763B3C65E_OFFSET UNITYSDK_OFFSET(0xA02DB90)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_METHOD_8_86EBD5D37B0318E4_OFFSET UNITYSDK_OFFSET(0xA02BB10)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_METHOD_8_9681042564541CD6_1_OFFSET UNITYSDK_OFFSET(0xA02D000)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_METHOD_8_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xA02CF60)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_METHOD_8_9AB55F553C4AC6E8_OFFSET UNITYSDK_OFFSET(0xA02D900)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_METHOD_8_9CA35E5BF1A50E77_OFFSET UNITYSDK_OFFSET(0xA02D710)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_METHOD_8_B8817F4F77EFC234_OFFSET UNITYSDK_OFFSET(0xA02CE00)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_ONINTERACTTARGETFINISH_OFFSET UNITYSDK_OFFSET(0xA02DC50)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_ONITEMMOVEFINISH_OFFSET UNITYSDK_OFFSET(0xA02DC00)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_RECOVERFROMPUZZLESTATE_OFFSET UNITYSDK_OFFSET(0xA02AFF0)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xA02DD80)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_UPDATE_OFFSET UNITYSDK_OFFSET(0xA02BD20)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD__CCTOR_OFFSET UNITYSDK_OFFSET(0xA02EA40)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xA02E930)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA02EB90)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD___IFIXBASEPROXY_INITITEMS_OFFSET UNITYSDK_OFFSET(0xA02EAD0)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD___IFIXBASEPROXY_INITOPTIONS_OFFSET UNITYSDK_OFFSET(0xA02EAF0)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD___IFIXBASEPROXY_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xA02EA80)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD___IFIXBASEPROXY_ONITEMMOVEFINISH_OFFSET UNITYSDK_OFFSET(0xA02EB10)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD___IFIXBASEPROXY_RECOVERFROMPUZZLESTATE_OFFSET UNITYSDK_OFFSET(0xA02EAE0)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD___IFIXBASEPROXY_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xA02EB80)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD___IFIXBASEPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0xA02EB00)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int BoxmanPuzzleNewBoard_TypeDefinitionIndex = 64303;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(BoxmanPuzzleNewBoard_TypeDefinitionIndex)->GetStaticField(0x12130);
		}
