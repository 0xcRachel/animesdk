...
#define RPG_CLIENT_PROP_SIGNITEM_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x9CDBAA0)
#define RPG_CLIENT_PROP_SIGNITEM_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x9CDB9A0)
#define RPG_CLIENT_PROP_SIGNITEM_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x9CDBA60)
#define RPG_CLIENT_PROP_SIGNITEM_METHOD_1_4307B2A4B4A12C1A_1_OFFSET UNITYSDK_OFFSET(0x9CDBC20)
#define RPG_CLIENT_PROP_SIGNITEM_METHOD_1_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x9CDBB00)
#define RPG_CLIENT_PROP_SIGNITEM_METHOD_1_45AA2F5085C2C40D_OFFSET UNITYSDK_OFFSET(0x9CDB8E0)
#define RPG_CLIENT_PROP_SIGNITEM_METHOD_1_8F7C3089F41CC993_OFFSET UNITYSDK_OFFSET(0x9CDB590)
#define RPG_CLIENT_PROP_SIGNITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9CDBD40)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int SignItem_TypeDefinitionIndex = 62125;
