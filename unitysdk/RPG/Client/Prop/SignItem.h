...
#define RPG_CLIENT_PROP_SIGNITEM_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xA1681C0)
#define RPG_CLIENT_PROP_SIGNITEM_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0xA1680C0)
#define RPG_CLIENT_PROP_SIGNITEM_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xA168180)
#define RPG_CLIENT_PROP_SIGNITEM_METHOD_1_4307B2A4B4A12C1A_1_OFFSET UNITYSDK_OFFSET(0xA168340)
#define RPG_CLIENT_PROP_SIGNITEM_METHOD_1_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xA168220)
#define RPG_CLIENT_PROP_SIGNITEM_METHOD_1_8F7C3089F41CC993_OFFSET UNITYSDK_OFFSET(0xA167CB0)
#define RPG_CLIENT_PROP_SIGNITEM_METHOD_1_CD8EB704BDED69B6_OFFSET UNITYSDK_OFFSET(0xA168000)
#define RPG_CLIENT_PROP_SIGNITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xA168460)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int SignItem_TypeDefinitionIndex = 64312;
