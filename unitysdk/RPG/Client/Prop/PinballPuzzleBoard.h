...
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_CANACTIVEPLATE_OFFSET UNITYSDK_OFFSET(0x9C9E450)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_CANPUZZLEUNLOAD_OFFSET UNITYSDK_OFFSET(0x9C9A800)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9C999D0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_ENDPINBALLCONTROLMODE_OFFSET UNITYSDK_OFFSET(0x9CA1870)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_GETPINBALLITEMBYINDEX_OFFSET UNITYSDK_OFFSET(0x9C9BB50)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_GET_CURRENTSELECTPINBALLITEM_OFFSET UNITYSDK_OFFSET(0x9C97A30)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_GET_OWNERTRANS_OFFSET UNITYSDK_OFFSET(0x9CA3050)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_GET_PINBALLITEMS_DEBUG_OFFSET UNITYSDK_OFFSET(0x9CA3060)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_GET_PLATEREMAINCOUNT_OFFSET UNITYSDK_OFFSET(0x9CA3070)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_INITOPTIONS_OFFSET UNITYSDK_OFFSET(0x9C995C0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_INITPINBALL_OFFSET UNITYSDK_OFFSET(0x9C98EE0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0x9C98E50)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0x9C9A840)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_LATEUPDATEPUZZLE_OFFSET UNITYSDK_OFFSET(0x9C9AAA0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_LAUNCH_OFFSET UNITYSDK_OFFSET(0x9CA0180)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_01F8C9B8FEC4A2CF_OFFSET UNITYSDK_OFFSET(0x9CA1FC0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_070546811DD6F16C_OFFSET UNITYSDK_OFFSET(0x9CA23C0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_08C689627757D0F9_OFFSET UNITYSDK_OFFSET(0x9CA20C0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_1676349FAEF4B05E_OFFSET UNITYSDK_OFFSET(0x9CA01D0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_18982EFD3B740683_OFFSET UNITYSDK_OFFSET(0x9C9D7E0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_1AD3CAF2B0982C3F_OFFSET UNITYSDK_OFFSET(0x9C9EF70)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_1CFEF2C87EA4995A_OFFSET UNITYSDK_OFFSET(0x9C9BDD0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_2083A1568CE00304_OFFSET UNITYSDK_OFFSET(0x9CA14C0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_228E3444D290BEE7_OFFSET UNITYSDK_OFFSET(0x9C9FF70)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_280628713361E10F_OFFSET UNITYSDK_OFFSET(0x9C9F370)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_2CBE0B79DD36047E_OFFSET UNITYSDK_OFFSET(0x9CA2730)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_367B9590522079D1_OFFSET UNITYSDK_OFFSET(0x9C9EA10)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_3972738626E6BB6F_OFFSET UNITYSDK_OFFSET(0x9C9B280)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_5152ABC5D08CE614_OFFSET UNITYSDK_OFFSET(0x9C989E0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_529341EF7E8B39BE_OFFSET UNITYSDK_OFFSET(0x9C9E7E0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_540DB5DAE524BF3C_1_OFFSET UNITYSDK_OFFSET(0x9CA2510)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_540DB5DAE524BF3C_2_OFFSET UNITYSDK_OFFSET(0x9CA2A40)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_540DB5DAE524BF3C_OFFSET UNITYSDK_OFFSET(0x9CA24B0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_5FB066975C67F812_OFFSET UNITYSDK_OFFSET(0x9C9CDC0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_66A26E3317E26881_OFFSET UNITYSDK_OFFSET(0x9CA2570)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_6D93101E4CE10A96_OFFSET UNITYSDK_OFFSET(0x9CA0740)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_739DB9F245C7FAD0_OFFSET UNITYSDK_OFFSET(0x9C9A3B0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_74EB46AAC179C832_OFFSET UNITYSDK_OFFSET(0x9C99E90)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_7778ABE51AFDB516_OFFSET UNITYSDK_OFFSET(0x9C9E980)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_78E88B7CB3CC1E2A_OFFSET UNITYSDK_OFFSET(0x9CA0860)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_825CC99DD653DEE0_OFFSET UNITYSDK_OFFSET(0x9C9DA30)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_8AEE3C4E6BD69BAB_OFFSET UNITYSDK_OFFSET(0x9C9B880)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_921C3C3E09D59CD4_OFFSET UNITYSDK_OFFSET(0x9CA27D0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_9547E82748FE6C69_OFFSET UNITYSDK_OFFSET(0x9C9ED30)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x9C9ED80)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_A1ADC999CFACEB89_OFFSET UNITYSDK_OFFSET(0x9C9A730)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_A3CD8010EE7E2C0B_OFFSET UNITYSDK_OFFSET(0x9CA21D0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_B09E78EE7EE4F8FA_1_OFFSET UNITYSDK_OFFSET(0x9C9E550)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0x9C998A0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_B3F1A3A8F66EAE32_OFFSET UNITYSDK_OFFSET(0x9C9AFA0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_BA410EA09457B5C1_OFFSET UNITYSDK_OFFSET(0x9C9AA50)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_BB881F05E41D3A04_OFFSET UNITYSDK_OFFSET(0x9C9D770)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_C2D94B542F8BDBB0_OFFSET UNITYSDK_OFFSET(0x9C9E4A0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_C450A961450309C9_OFFSET UNITYSDK_OFFSET(0x9C9EE00)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_C8F93DC0DF0652A4_1_OFFSET UNITYSDK_OFFSET(0x9CA09C0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_C8F93DC0DF0652A4_OFFSET UNITYSDK_OFFSET(0x9CA0790)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_C9748511121817AE_OFFSET UNITYSDK_OFFSET(0x9C9D0E0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x9C9CD50)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x9C9EF30)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_CB613A5EF970C11B_OFFSET UNITYSDK_OFFSET(0x9C988B0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_D2594BF9DC46F655_OFFSET UNITYSDK_OFFSET(0x9C9F2D0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_D6288EFA98A301E9_OFFSET UNITYSDK_OFFSET(0x9C9C560)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_DF3C54A5ADEABAF1_OFFSET UNITYSDK_OFFSET(0x9C9D190)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_E658B2206C1568CD_OFFSET UNITYSDK_OFFSET(0x9CA0A90)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0x9C9A530)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_F81C848FE9ED44F9_OFFSET UNITYSDK_OFFSET(0x9CA2240)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_FD7514C64FB1B043_OFFSET UNITYSDK_OFFSET(0x9CA1380)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_ONINTERACTSTATION_OFFSET UNITYSDK_OFFSET(0x9C9BBE0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_ONPINBALLITEMINTERACTEND_OFFSET UNITYSDK_OFFSET(0x9C9A9F0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_ONPINBALLITEMINTERACTSTART_OFFSET UNITYSDK_OFFSET(0x9C9E2F0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_ONPLATEACTIVE_OFFSET UNITYSDK_OFFSET(0x9C9E330)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_ONPLATEDEACTIVE_OFFSET UNITYSDK_OFFSET(0x9C9E3C0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_PINBALLCONFIGPOSTOMATRIXPOS_OFFSET UNITYSDK_OFFSET(0x9C9BAF0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_PINBALLDEBUG_SELECTPINBALLITEM_OFFSET UNITYSDK_OFFSET(0x9C982D0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_REPORTINTERACTPLATE_OFFSET UNITYSDK_OFFSET(0x9CA2AA0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0x9C9A880)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_STARTPINBALLCONTROLMODE_OFFSET UNITYSDK_OFFSET(0x9C9C680)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_STARTPLAYERCONTROLMODE_OFFSET UNITYSDK_OFFSET(0x9C9C730)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_SWITCHCURRENTGAMEMODE_OFFSET UNITYSDK_OFFSET(0x9C9BD80)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0x9C9AC30)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x9CA3080)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD___IFIXBASEPROXY_CANPUZZLEUNLOAD_OFFSET UNITYSDK_OFFSET(0x9CA3590)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9CA3580)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD___IFIXBASEPROXY_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0x9CA3570)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD___IFIXBASEPROXY_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0x9CA35D0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD___IFIXBASEPROXY_LATEUPDATEPUZZLE_OFFSET UNITYSDK_OFFSET(0x9CA3680)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD___IFIXBASEPROXY_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0x9CA3640)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD___IFIXBASEPROXY_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0x9CA36E0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PinballPuzzleBoard_TypeDefinitionIndex = 62031;
	...
	public:
		...
		::Class_1_09216AC83FE49B91* Field_6_80; // 0x1F8
		::Class_1_09216AC83FE49B91* Field_6_81; // 0x200
		::Class_1_09216AC83FE49B91* Field_6_82; // 0x208
		::Class_1_09216AC83FE49B91* Field_6_83; // 0x210
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_2CBE0B79DD36047E_OFFSET))(this);
		}

		::System::Void Method_6_BB881F05E41D3A04()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_BB881F05E41D3A04_OFFSET))(this);
		}

		::System::Void Method_6_921C3C3E09D59CD4()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_921C3C3E09D59CD4_OFFSET))(this);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_DF3C54A5ADEABAF1_OFFSET))(this);
		}
		...
		::System::Void Method_6_66A26E3317E26881(::System::Single a1)
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_66A26E3317E26881_OFFSET))(this, a1);
		}
