...
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_CANACTIVEPLATE_OFFSET UNITYSDK_OFFSET(0xA12A9B0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_CANPUZZLEUNLOAD_OFFSET UNITYSDK_OFFSET(0xA126B30)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA125D40)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_ENDPINBALLCONTROLMODE_OFFSET UNITYSDK_OFFSET(0xA12DEB0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_GETPINBALLITEMBYINDEX_OFFSET UNITYSDK_OFFSET(0xA127E50)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_GET_CURRENTSELECTPINBALLITEM_OFFSET UNITYSDK_OFFSET(0xA123DB0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_GET_OWNERTRANS_OFFSET UNITYSDK_OFFSET(0xA12F7B0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_GET_PINBALLITEMS_DEBUG_OFFSET UNITYSDK_OFFSET(0xA12F7C0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_GET_PLATEREMAINCOUNT_OFFSET UNITYSDK_OFFSET(0xA12F7D0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_INITOPTIONS_OFFSET UNITYSDK_OFFSET(0xA125930)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_INITPINBALL_OFFSET UNITYSDK_OFFSET(0xA125230)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xA1251A0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xA126B70)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_LATEUPDATEPUZZLE_OFFSET UNITYSDK_OFFSET(0xA126DD0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_LAUNCH_OFFSET UNITYSDK_OFFSET(0xA12C750)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_01F8C9B8FEC4A2CF_OFFSET UNITYSDK_OFFSET(0xA12E600)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_070546811DD6F16C_OFFSET UNITYSDK_OFFSET(0xA12EA00)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_08C689627757D0F9_OFFSET UNITYSDK_OFFSET(0xA12E700)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_0B7E3489D2C0938B_OFFSET UNITYSDK_OFFSET(0xA12EEF0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_1676349FAEF4B05E_OFFSET UNITYSDK_OFFSET(0xA12C7A0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_18982EFD3B740683_OFFSET UNITYSDK_OFFSET(0xA129BD0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_1AD3CAF2B0982C3F_OFFSET UNITYSDK_OFFSET(0xA12B4D0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_1CFEF2C87EA4995A_OFFSET UNITYSDK_OFFSET(0xA1280E0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_2083A1568CE00304_OFFSET UNITYSDK_OFFSET(0xA12DB00)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_228E3444D290BEE7_OFFSET UNITYSDK_OFFSET(0xA12C540)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_24B05D2E15A5C3C8_OFFSET UNITYSDK_OFFSET(0xA129520)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_280628713361E10F_OFFSET UNITYSDK_OFFSET(0xA12B8D0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_367B9590522079D1_OFFSET UNITYSDK_OFFSET(0xA12AF70)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_3972738626E6BB6F_OFFSET UNITYSDK_OFFSET(0xA127580)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_5152ABC5D08CE614_OFFSET UNITYSDK_OFFSET(0xA124D30)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_529341EF7E8B39BE_OFFSET UNITYSDK_OFFSET(0xA12AD40)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_540DB5DAE524BF3C_1_OFFSET UNITYSDK_OFFSET(0xA12EB50)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_540DB5DAE524BF3C_2_OFFSET UNITYSDK_OFFSET(0xA12F1A0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_540DB5DAE524BF3C_OFFSET UNITYSDK_OFFSET(0xA12EAF0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_5FB066975C67F812_OFFSET UNITYSDK_OFFSET(0xA129140)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_61FA52F6867AECBB_OFFSET UNITYSDK_OFFSET(0xA1272D0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_6D93101E4CE10A96_OFFSET UNITYSDK_OFFSET(0xA12CD80)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_739DB9F245C7FAD0_OFFSET UNITYSDK_OFFSET(0xA1266E0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_74EB46AAC179C832_OFFSET UNITYSDK_OFFSET(0xA1261C0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_7778ABE51AFDB516_OFFSET UNITYSDK_OFFSET(0xA12AEE0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_78E88B7CB3CC1E2A_OFFSET UNITYSDK_OFFSET(0xA12CEA0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_825CC99DD653DEE0_OFFSET UNITYSDK_OFFSET(0xA129E20)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_8AEE3C4E6BD69BAB_OFFSET UNITYSDK_OFFSET(0xA127B80)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_9547E82748FE6C69_OFFSET UNITYSDK_OFFSET(0xA12B290)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xA12B2E0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_96A53A17AC5D0E93_OFFSET UNITYSDK_OFFSET(0xA129B60)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_A1ADC999CFACEB89_OFFSET UNITYSDK_OFFSET(0xA126A60)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_A3CD8010EE7E2C0B_OFFSET UNITYSDK_OFFSET(0xA12E810)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_B09E78EE7EE4F8FA_1_OFFSET UNITYSDK_OFFSET(0xA12AAB0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0xA125C10)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_BA410EA09457B5C1_OFFSET UNITYSDK_OFFSET(0xA126D80)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_C2D94B542F8BDBB0_OFFSET UNITYSDK_OFFSET(0xA12AA00)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_C450A961450309C9_OFFSET UNITYSDK_OFFSET(0xA12B360)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_C8F93DC0DF0652A4_1_OFFSET UNITYSDK_OFFSET(0xA12D000)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_C8F93DC0DF0652A4_OFFSET UNITYSDK_OFFSET(0xA12CDD0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_C9748511121817AE_OFFSET UNITYSDK_OFFSET(0xA129470)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xA1290D0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA12B490)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_CB613A5EF970C11B_OFFSET UNITYSDK_OFFSET(0xA124C00)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_D2594BF9DC46F655_OFFSET UNITYSDK_OFFSET(0xA12B830)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_D6288EFA98A301E9_OFFSET UNITYSDK_OFFSET(0xA1288E0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_E658B2206C1568CD_OFFSET UNITYSDK_OFFSET(0xA12D0D0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_EAD10B3E55E2C4C5_OFFSET UNITYSDK_OFFSET(0xA12EDD0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0xA126860)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_F7E674C1303ACB5B_OFFSET UNITYSDK_OFFSET(0xA12EBB0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_F81C848FE9ED44F9_OFFSET UNITYSDK_OFFSET(0xA12E880)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_FD7514C64FB1B043_OFFSET UNITYSDK_OFFSET(0xA12D9C0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_ONINTERACTSTATION_OFFSET UNITYSDK_OFFSET(0xA127EE0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_ONPINBALLITEMINTERACTEND_OFFSET UNITYSDK_OFFSET(0xA126D20)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_ONPINBALLITEMINTERACTSTART_OFFSET UNITYSDK_OFFSET(0xA12A850)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_ONPLATEACTIVE_OFFSET UNITYSDK_OFFSET(0xA12A890)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_ONPLATEDEACTIVE_OFFSET UNITYSDK_OFFSET(0xA12A920)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_PINBALLCONFIGPOSTOMATRIXPOS_OFFSET UNITYSDK_OFFSET(0xA127DF0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_PINBALLDEBUG_SELECTPINBALLITEM_OFFSET UNITYSDK_OFFSET(0xA124650)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_REPORTINTERACTPLATE_OFFSET UNITYSDK_OFFSET(0xA12F200)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xA126BB0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_STARTPINBALLCONTROLMODE_OFFSET UNITYSDK_OFFSET(0xA1289F0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_STARTPLAYERCONTROLMODE_OFFSET UNITYSDK_OFFSET(0xA128AA0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_SWITCHCURRENTGAMEMODE_OFFSET UNITYSDK_OFFSET(0xA128090)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0xA126F60)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xA12F7E0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD___IFIXBASEPROXY_CANPUZZLEUNLOAD_OFFSET UNITYSDK_OFFSET(0xA12FCF0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA12FCE0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD___IFIXBASEPROXY_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xA12FCD0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD___IFIXBASEPROXY_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xA12FD30)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD___IFIXBASEPROXY_LATEUPDATEPUZZLE_OFFSET UNITYSDK_OFFSET(0xA12FDE0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD___IFIXBASEPROXY_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xA12FDA0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD___IFIXBASEPROXY_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0xA12FE40)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PinballPuzzleBoard_TypeDefinitionIndex = 64218;
