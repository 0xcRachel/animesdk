...
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_CHANGELINERENDEREMISSION_OFFSET UNITYSDK_OFFSET(0xA084370)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_CHANGESTATE_OFFSET UNITYSDK_OFFSET(0xA081590)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA080F80)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GETANSWERBASEPOINTPROPIDLIST_OFFSET UNITYSDK_OFFSET(0xA07F0C0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GETBASEPOINT_OFFSET UNITYSDK_OFFSET(0xA082840)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GETSTONE_OFFSET UNITYSDK_OFFSET(0xA082920)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GET_CURRENTHOLDSTONEPROPID_OFFSET UNITYSDK_OFFSET(0xA084C60)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GET_CURRENTPICKUPBASEPOINTPROPID_OFFSET UNITYSDK_OFFSET(0xA084C80)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GET_ISPLAYERHOLDINGSTONE_OFFSET UNITYSDK_OFFSET(0xA07EE20)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GET_ISPLAYINGSTONEMOVEANIM_OFFSET UNITYSDK_OFFSET(0xA082A10)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GET_PUZZLESOLVED_OFFSET UNITYSDK_OFFSET(0xA084CA0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GIVEBACKHOLDINGSTONE_OFFSET UNITYSDK_OFFSET(0xA0835D0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xA07F3C0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xA081540)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_0F9BA4683D398D7A_OFFSET UNITYSDK_OFFSET(0xA080010)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_292F9610D63D1947_OFFSET UNITYSDK_OFFSET(0xA083760)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_2DD8EB2A8AB21975_OFFSET UNITYSDK_OFFSET(0xA083F20)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_31B86CF031D1C6B2_OFFSET UNITYSDK_OFFSET(0xA084A20)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_37D0382D0C30A2DC_OFFSET UNITYSDK_OFFSET(0xA0850D0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_3CAB3F134E5CEF52_OFFSET UNITYSDK_OFFSET(0xA081750)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_3CCA0B8A31B650A8_OFFSET UNITYSDK_OFFSET(0xA07FD00)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xA084480)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_7206DC8F66A4D2A8_OFFSET UNITYSDK_OFFSET(0xA0822A0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_78DD1D9F31D0769E_OFFSET UNITYSDK_OFFSET(0xA081690)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_8080E22F79F246F0_OFFSET UNITYSDK_OFFSET(0xA080550)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_8608350DFEDEE4FD_OFFSET UNITYSDK_OFFSET(0xA0839D0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_8719F90BD885137A_OFFSET UNITYSDK_OFFSET(0xA084D60)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_889C45DCDD74975A_OFFSET UNITYSDK_OFFSET(0xA081F90)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_8A2905DAFB806E28_OFFSET UNITYSDK_OFFSET(0xA083D40)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0xA0837F0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_A984848EA3E436DA_OFFSET UNITYSDK_OFFSET(0xA081030)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_C1E0405EEC95DC65_OFFSET UNITYSDK_OFFSET(0xA082C40)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_CB8E229BDF290D41_OFFSET UNITYSDK_OFFSET(0xA0802F0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_E21AC6EE08DC160A_OFFSET UNITYSDK_OFFSET(0xA0823F0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_EBBE08F2874773A2_OFFSET UNITYSDK_OFFSET(0xA084C30)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_F63565EA57F495CC_OFFSET UNITYSDK_OFFSET(0xA080C70)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_ONPUZZLEFINISHED_OFFSET UNITYSDK_OFFSET(0xA0831C0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_PICKUPSTONE_OFFSET UNITYSDK_OFFSET(0xA07EA60)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_PLACESTONE_OFFSET UNITYSDK_OFFSET(0xA07E8B0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_PLAYEREFFECTATTACHPOINT_OFFSET UNITYSDK_OFFSET(0xA084CC0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_PLAYSTONEMOVEANIMATION_OFFSET UNITYSDK_OFFSET(0xA082A70)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xA080BA0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_SET_CURRENTHOLDSTONEPROPID_OFFSET UNITYSDK_OFFSET(0xA084C70)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_SET_CURRENTPICKUPBASEPOINTPROPID_OFFSET UNITYSDK_OFFSET(0xA084C90)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_SET_PUZZLESOLVED_OFFSET UNITYSDK_OFFSET(0xA084CB0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xA07FCA0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_SWAPSTONE_OFFSET UNITYSDK_OFFSET(0xA07EC10)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0xA083930)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_TRIGGERHINTLINERENDERSFADEOUT_OFFSET UNITYSDK_OFFSET(0xA084850)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_TRIGGERSTONEFADEOUT_OFFSET UNITYSDK_OFFSET(0xA084590)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_TRIGGERSTONELINERENDERSFADEOUT_OFFSET UNITYSDK_OFFSET(0xA084710)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD__CCTOR_OFFSET UNITYSDK_OFFSET(0xA0854E0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xA085190)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA085610)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___IFIXBASEPROXY_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xA085540)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___IFIXBASEPROXY_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xA085620)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___IFIXBASEPROXY_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xA0855B0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___IFIXBASEPROXY_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xA085550)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___IFIXBASEPROXY_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0xA0856C0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___SWITCHPLAYEREFFECT_B__39_0_OFFSET UNITYSDK_OFFSET(0xA085530)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int DeployPuzzleBoard_TypeDefinitionIndex = 63979;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(DeployPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x478F0);
		}
		static ::System::Int32* StaticGet_Field_6_25()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DeployPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x12930);
		}
