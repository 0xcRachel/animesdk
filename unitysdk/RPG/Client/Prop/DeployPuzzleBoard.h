...
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_CHANGELINERENDEREMISSION_OFFSET UNITYSDK_OFFSET(0x9BB28C0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_CHANGESTATE_OFFSET UNITYSDK_OFFSET(0x9BAFB40)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9BAF530)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GETANSWERBASEPOINTPROPIDLIST_OFFSET UNITYSDK_OFFSET(0x9BAD630)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GETBASEPOINT_OFFSET UNITYSDK_OFFSET(0x9BB0DA0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GETSTONE_OFFSET UNITYSDK_OFFSET(0x9BB0E80)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GET_CURRENTHOLDSTONEPROPID_OFFSET UNITYSDK_OFFSET(0x9BB31B0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GET_CURRENTPICKUPBASEPOINTPROPID_OFFSET UNITYSDK_OFFSET(0x9BB31D0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GET_ISPLAYERHOLDINGSTONE_OFFSET UNITYSDK_OFFSET(0x9BAD390)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GET_ISPLAYINGSTONEMOVEANIM_OFFSET UNITYSDK_OFFSET(0x9BB0F70)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GET_PUZZLESOLVED_OFFSET UNITYSDK_OFFSET(0x9BB31F0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GIVEBACKHOLDINGSTONE_OFFSET UNITYSDK_OFFSET(0x9BB1B20)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0x9BAD960)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0x9BAFAF0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_0F9BA4683D398D7A_OFFSET UNITYSDK_OFFSET(0x9BAE5C0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_292F9610D63D1947_OFFSET UNITYSDK_OFFSET(0x9BB1CB0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_2DD8EB2A8AB21975_OFFSET UNITYSDK_OFFSET(0x9BB2470)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_31B86CF031D1C6B2_OFFSET UNITYSDK_OFFSET(0x9BB2F70)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_37D0382D0C30A2DC_OFFSET UNITYSDK_OFFSET(0x9BB3620)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_3CAB3F134E5CEF52_OFFSET UNITYSDK_OFFSET(0x9BAFD00)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_3CCA0B8A31B650A8_OFFSET UNITYSDK_OFFSET(0x9BAE2B0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x9BB29D0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_66C8A374E0913D6C_OFFSET UNITYSDK_OFFSET(0x9BB0540)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_7206DC8F66A4D2A8_OFFSET UNITYSDK_OFFSET(0x9BB0800)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_78DD1D9F31D0769E_OFFSET UNITYSDK_OFFSET(0x9BAFC40)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_8080E22F79F246F0_OFFSET UNITYSDK_OFFSET(0x9BAEB00)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_8608350DFEDEE4FD_OFFSET UNITYSDK_OFFSET(0x9BB1F20)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_8719F90BD885137A_OFFSET UNITYSDK_OFFSET(0x9BB32B0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_8A2905DAFB806E28_OFFSET UNITYSDK_OFFSET(0x9BB2290)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0x9BB1D40)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_A984848EA3E436DA_OFFSET UNITYSDK_OFFSET(0x9BAF5E0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_C1E0405EEC95DC65_OFFSET UNITYSDK_OFFSET(0x9BB1190)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_CB8E229BDF290D41_OFFSET UNITYSDK_OFFSET(0x9BAE8A0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_E21AC6EE08DC160A_OFFSET UNITYSDK_OFFSET(0x9BB0950)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_EBBE08F2874773A2_OFFSET UNITYSDK_OFFSET(0x9BB3180)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_F63565EA57F495CC_OFFSET UNITYSDK_OFFSET(0x9BAF220)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_ONPUZZLEFINISHED_OFFSET UNITYSDK_OFFSET(0x9BB1710)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_PICKUPSTONE_OFFSET UNITYSDK_OFFSET(0x9BACFD0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_PLACESTONE_OFFSET UNITYSDK_OFFSET(0x9BACE20)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_PLAYEREFFECTATTACHPOINT_OFFSET UNITYSDK_OFFSET(0x9BB3210)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_PLAYSTONEMOVEANIMATION_OFFSET UNITYSDK_OFFSET(0x9BB0FD0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0x9BAF150)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_SET_CURRENTHOLDSTONEPROPID_OFFSET UNITYSDK_OFFSET(0x9BB31C0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_SET_CURRENTPICKUPBASEPOINTPROPID_OFFSET UNITYSDK_OFFSET(0x9BB31E0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_SET_PUZZLESOLVED_OFFSET UNITYSDK_OFFSET(0x9BB3200)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0x9BAE250)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_SWAPSTONE_OFFSET UNITYSDK_OFFSET(0x9BAD180)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0x9BB1E80)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_TRIGGERHINTLINERENDERSFADEOUT_OFFSET UNITYSDK_OFFSET(0x9BB2DA0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_TRIGGERSTONEFADEOUT_OFFSET UNITYSDK_OFFSET(0x9BB2AE0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_TRIGGERSTONELINERENDERSFADEOUT_OFFSET UNITYSDK_OFFSET(0x9BB2C60)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD__CCTOR_OFFSET UNITYSDK_OFFSET(0x9BB3A30)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x9BB36E0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9BB3B60)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___IFIXBASEPROXY_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0x9BB3A90)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___IFIXBASEPROXY_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0x9BB3B70)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___IFIXBASEPROXY_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0x9BB3B00)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___IFIXBASEPROXY_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0x9BB3AA0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___IFIXBASEPROXY_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0x9BB3C10)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___SWITCHPLAYEREFFECT_B__39_0_OFFSET UNITYSDK_OFFSET(0x9BB3A80)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int DeployPuzzleBoard_TypeDefinitionIndex = 61792;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(DeployPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x41770);
		}
		static ::System::Int32* StaticGet_Field_6_25()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DeployPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0xF160);
		}
		...
		::System::Collections::Generic::List_1<::Class_1_8CF94E0F14A91ED3_3*>* Field_6_22; // 0xE8
		...
		::System::Void Method_6_66C8A374E0913D6C(::System::Boolean a1, ::System::Single a2)
		{
			return ((::System::Void(*)(::PVOID, ::System::Boolean, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_66C8A374E0913D6C_OFFSET))(this, a1, a2);
		}
