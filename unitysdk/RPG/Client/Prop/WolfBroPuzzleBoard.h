...
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_ACTIVATEBULLET_OFFSET UNITYSDK_OFFSET(0xA18B1A0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_ARCHIVE_OFFSET UNITYSDK_OFFSET(0xA18CBC0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_BOOMPROPHITTARGETS_OFFSET UNITYSDK_OFFSET(0xA18BBA0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA18BE40)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_ENABLETELEPORTTIMING_OFFSET UNITYSDK_OFFSET(0xA18DC90)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_GET_CACHEDCAMERAAXIS_OFFSET UNITYSDK_OFFSET(0xA191300)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xA192A60)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_GET_ISBULLETACTIVATED_OFFSET UNITYSDK_OFFSET(0xA1912B0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_GET_ISLOCK_OFFSET UNITYSDK_OFFSET(0xA191290)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_GET_ISMINISTATE_OFFSET UNITYSDK_OFFSET(0xA1912A0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_HITTARGETS_OFFSET UNITYSDK_OFFSET(0xA18B840)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xA18A180)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_INTERRUPTEDPLAYERPROJECTILES_OFFSET UNITYSDK_OFFSET(0xA18DB30)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xA18C2D0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_02B490C9189918DC_OFFSET UNITYSDK_OFFSET(0xA18C610)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_07BB45288DFF8852_OFFSET UNITYSDK_OFFSET(0xA18FC50)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_09AB8FC0B8BA1B6E_1_OFFSET UNITYSDK_OFFSET(0xA191050)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_09AB8FC0B8BA1B6E_OFFSET UNITYSDK_OFFSET(0xA190CA0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_0D64F99BAAA7B5C4_1_OFFSET UNITYSDK_OFFSET(0xA1909B0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_0D64F99BAAA7B5C4_OFFSET UNITYSDK_OFFSET(0xA1908B0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_119DF0CE89C21899_OFFSET UNITYSDK_OFFSET(0xA18C3B0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_28BB8707B4CC88A2_OFFSET UNITYSDK_OFFSET(0xA192770)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_2B630A56F9D369CF_OFFSET UNITYSDK_OFFSET(0xA18AB30)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_2FAC9ED1B8FB93BF_OFFSET UNITYSDK_OFFSET(0xA18C4C0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_3059C0D95D3E3E77_OFFSET UNITYSDK_OFFSET(0xA190200)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_3A103EA5D528A631_OFFSET UNITYSDK_OFFSET(0xA18E9B0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_3C111959D3BB5616_OFFSET UNITYSDK_OFFSET(0xA1906C0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0xA18ACD0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_45AA2F5085C2C40D_OFFSET UNITYSDK_OFFSET(0xA18CE80)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_566048917FF28665_OFFSET UNITYSDK_OFFSET(0xA18BC20)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_602BF28DABA35AB5_OFFSET UNITYSDK_OFFSET(0xA1904A0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_609506B9DE731615_OFFSET UNITYSDK_OFFSET(0xA18B710)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_648CCB08284C0A69_OFFSET UNITYSDK_OFFSET(0xA18E350)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_70595BBE3E0E4F2A_OFFSET UNITYSDK_OFFSET(0xA18E110)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_73C583976350BB58_OFFSET UNITYSDK_OFFSET(0xA18F840)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_854CB545243705CE_OFFSET UNITYSDK_OFFSET(0xA18E600)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_9036CFAD14566A8D_OFFSET UNITYSDK_OFFSET(0xA18EB20)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_954DFE111A908774_OFFSET UNITYSDK_OFFSET(0xA18B200)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_9AD47D8DC12F1689_OFFSET UNITYSDK_OFFSET(0xA18CC20)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_9EBD28FD8FFC1A2A_OFFSET UNITYSDK_OFFSET(0xA1911F0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_A7E8B52E9ABB8DB9_OFFSET UNITYSDK_OFFSET(0xA18F7B0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_A984848EA3E436DA_OFFSET UNITYSDK_OFFSET(0xA18AEC0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_B235E757922104A8_OFFSET UNITYSDK_OFFSET(0xA18A820)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_BADDA70ED68283AE_1_OFFSET UNITYSDK_OFFSET(0xA18C130)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_BADDA70ED68283AE_OFFSET UNITYSDK_OFFSET(0xA18E420)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_C75E7A4CF4958719_OFFSET UNITYSDK_OFFSET(0xA18C180)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_C8F03EB4AC0A2737_OFFSET UNITYSDK_OFFSET(0xA18F760)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_D02229B3478BB464_OFFSET UNITYSDK_OFFSET(0xA18B8E0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_D7B51E636B36E189_OFFSET UNITYSDK_OFFSET(0xA18F620)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_D85A69A177ED1ECC_OFFSET UNITYSDK_OFFSET(0xA190810)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_DE1C1F4DF5D06882_1_OFFSET UNITYSDK_OFFSET(0xA18F0D0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_DE1C1F4DF5D06882_2_OFFSET UNITYSDK_OFFSET(0xA18F140)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_DE1C1F4DF5D06882_OFFSET UNITYSDK_OFFSET(0xA18EF50)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_E4FAD5C67AACF046_OFFSET UNITYSDK_OFFSET(0xA191470)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_EC2B405D0723571D_1_OFFSET UNITYSDK_OFFSET(0xA18AC00)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_EC2B405D0723571D_2_OFFSET UNITYSDK_OFFSET(0xA18DA60)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_EC2B405D0723571D_3_OFFSET UNITYSDK_OFFSET(0xA18B350)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_EC2B405D0723571D_OFFSET UNITYSDK_OFFSET(0xA18E8E0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_F0C0A09DEADFA368_OFFSET UNITYSDK_OFFSET(0xA18DE40)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_F1BB718E73080948_OFFSET UNITYSDK_OFFSET(0xA191320)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0xA190DC0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_FB0CC4A7FCE4A5BA_OFFSET UNITYSDK_OFFSET(0xA18F970)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_PICKUPBULLET_OFFSET UNITYSDK_OFFSET(0xA18B4B0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_REPORTMONSTERALERT_OFFSET UNITYSDK_OFFSET(0xA190E50)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_REPORTMONSTERCHASE_OFFSET UNITYSDK_OFFSET(0xA190AA0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_REPORTPUSHHIDE_OFFSET UNITYSDK_OFFSET(0xA192330)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_REPORTPUSHHIT_OFFSET UNITYSDK_OFFSET(0xA1921A0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_REPORTPUSHLOOK_OFFSET UNITYSDK_OFFSET(0xA192010)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_REPORTPUSHPROPHIT_OFFSET UNITYSDK_OFFSET(0xA18E470)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_REPORTPUSHPROP_OFFSET UNITYSDK_OFFSET(0xA191D90)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_REPORTPUSHTV_OFFSET UNITYSDK_OFFSET(0xA1924C0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_RESETACHIEVEMENTCHASE_OFFSET UNITYSDK_OFFSET(0xA18D9E0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xA18AF40)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_RESTOREARCHIVE_OFFSET UNITYSDK_OFFSET(0xA18CDC0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_SET_CACHEDCAMERAAXIS_OFFSET UNITYSDK_OFFSET(0xA191310)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xA192A90)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_SHUTDOWNPUZZLE_OFFSET UNITYSDK_OFFSET(0xA18B040)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xA18A560)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0xA18C320)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_UNWAITRESTOREARCHIVE_OFFSET UNITYSDK_OFFSET(0xA18CB60)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_UNWAITSTARTUP_OFFSET UNITYSDK_OFFSET(0xA18CA70)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_USEBULLET_OFFSET UNITYSDK_OFFSET(0xA18B2F0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_WAITRESTOREARCHIVE_OFFSET UNITYSDK_OFFSET(0xA18CAD0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_WAITSTARTUP_OFFSET UNITYSDK_OFFSET(0xA18C990)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD__CCTOR_OFFSET UNITYSDK_OFFSET(0xA192DD0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xA192AD0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA192F20)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD___IFIXBASEPROXY_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xA192E50)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD___IFIXBASEPROXY_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xA192F30)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD___IFIXBASEPROXY_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xA192EC0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD___IFIXBASEPROXY_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xA192E60)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD___IFIXBASEPROXY_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0xA192FD0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int WolfBroPuzzleBoard_TypeDefinitionIndex = 64139;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(WolfBroPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x51B0);
		}
		static ::System::String** StaticGet_Field_6_27()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(WolfBroPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x51B8);
		}
		static ::System::String** StaticGet_Field_6_32()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(WolfBroPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x51C0);
		}
		static ::System::String** StaticGet_Field_6_31()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(WolfBroPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x51C8);
		}
		static ::System::String** StaticGet_Field_6_33()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(WolfBroPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x51D0);
		}
		static ::System::String** StaticGet_Field_6_28()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(WolfBroPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x51D8);
		}
		static ::RPG::Client::Prop::WolfBroPuzzleBoard** StaticGet__Instance_k__BackingField()
		{
			return (::RPG::Client::Prop::WolfBroPuzzleBoard**)Il2CppClass::FromTypeDefinitionIndex(WolfBroPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x51E0);
		}
		static ::System::String** StaticGet_Field_6_30()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(WolfBroPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x51E8);
		}
		static ::System::UInt32* StaticGet_Field_6_1()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(WolfBroPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x2C30);
		}
