...
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD___C__DISPLAYCLASS124_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA0A02E0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD___C__DISPLAYCLASS124_0__ONPUZZLEFINISH_B__0_OFFSET UNITYSDK_OFFSET(0xA0A02F0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD___C__DISPLAYCLASS124_0__ONPUZZLEFINISH_B__1_OFFSET UNITYSDK_OFFSET(0xA0A0890)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD___C__DISPLAYCLASS124_0__ONPUZZLEFINISH_B__2_OFFSET UNITYSDK_OFFSET(0xA0A0A80)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int FastDeliverPuzzleBoard___c__DisplayClass124_0_TypeDefinitionIndex = 64034;
