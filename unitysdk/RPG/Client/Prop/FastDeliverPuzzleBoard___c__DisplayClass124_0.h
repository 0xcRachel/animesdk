...
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD___C__DISPLAYCLASS124_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9C12DB0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD___C__DISPLAYCLASS124_0__ONPUZZLEFINISH_B__0_OFFSET UNITYSDK_OFFSET(0x9C12DC0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD___C__DISPLAYCLASS124_0__ONPUZZLEFINISH_B__1_OFFSET UNITYSDK_OFFSET(0x9C13360)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD___C__DISPLAYCLASS124_0__ONPUZZLEFINISH_B__2_OFFSET UNITYSDK_OFFSET(0x9C13550)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int FastDeliverPuzzleBoard___c__DisplayClass124_0_TypeDefinitionIndex = 61847;
