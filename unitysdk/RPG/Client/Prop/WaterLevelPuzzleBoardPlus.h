...
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_CANWATERLEVELCHANGE_OFFSET UNITYSDK_OFFSET(0xEDF0240)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_CHANGEWATERLEVEL_OFFSET UNITYSDK_OFFSET(0xEDEFE90)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_DISPOSE_OFFSET UNITYSDK_OFFSET(0xEDF2FB0)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_DUMPSAVEDATA_OFFSET UNITYSDK_OFFSET(0xEDF34C0)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xEDF22E0)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_METHOD_6_54D9F076DD3781B1_OFFSET UNITYSDK_OFFSET(0xEDF2910)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_ONCHANGEWATERLEVELEND_OFFSET UNITYSDK_OFFSET(0xEDEEC00)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xEDF2D10)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0xEDF31E0)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_TRYSAVEDATATOSERVER_OFFSET UNITYSDK_OFFSET(0xEDEE1B0)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS__CTOR_OFFSET UNITYSDK_OFFSET(0xEDF3640)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xEDF37B0)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS___IFIXBASEPROXY_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xEDF3740)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS___IFIXBASEPROXY_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xEDF3750)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS___IFIXBASEPROXY_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0xEDF37C0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int WaterLevelPuzzleBoardPlus_TypeDefinitionIndex = 72417;
