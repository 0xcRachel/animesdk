...
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_CANWATERLEVELCHANGE_OFFSET UNITYSDK_OFFSET(0x12CA39B0)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_CHANGEWATERLEVEL_OFFSET UNITYSDK_OFFSET(0x12CA37F0)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x12CA6690)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_DUMPSAVEDATA_OFFSET UNITYSDK_OFFSET(0x12CA6B70)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0x12CA5B50)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_METHOD_6_1D77A561617C71A4_OFFSET UNITYSDK_OFFSET(0x12CA60E0)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_ONCHANGEWATERLEVELEND_OFFSET UNITYSDK_OFFSET(0x12CA2710)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0x12CA6410)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0x12CA68A0)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_TRYSAVEDATATOSERVER_OFFSET UNITYSDK_OFFSET(0x12CA1C10)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS__CTOR_OFFSET UNITYSDK_OFFSET(0x12CA6CF0)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x12CA6E60)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS___IFIXBASEPROXY_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0x12CA6DF0)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS___IFIXBASEPROXY_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0x12CA6E00)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS___IFIXBASEPROXY_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0x12CA6E70)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int WaterLevelPuzzleBoardPlus_TypeDefinitionIndex = 73439;
