...
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x15B52B30)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_514DADE30A6B3A71_OFFSET UNITYSDK_OFFSET(0x15B514B0)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_729AA4D1DEC0970C_OFFSET UNITYSDK_OFFSET(0x15B51DC0)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_8706B4640D53FE36_OFFSET UNITYSDK_OFFSET(0x15B52B80)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_95AA3C6CB470ECEA_OFFSET UNITYSDK_OFFSET(0x15B51680)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x15B52320)
#define RPG_CLIENT_PROP_PORTERTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x15B52C20)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PorterTarget_TypeDefinitionIndex = 73294;
