...
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_00C5E99C9B0EC08D_OFFSET UNITYSDK_OFFSET(0x13AA4730)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x13AA5CD0)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_514DADE30A6B3A71_OFFSET UNITYSDK_OFFSET(0x13AA4540)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_6E896AACE3F012D5_OFFSET UNITYSDK_OFFSET(0x13AA4EF0)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x13AA54B0)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_ED65AE7582736594_OFFSET UNITYSDK_OFFSET(0x13AA5D20)
#define RPG_CLIENT_PROP_PORTERTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x13AA5DC0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PorterTarget_TypeDefinitionIndex = 72272;
