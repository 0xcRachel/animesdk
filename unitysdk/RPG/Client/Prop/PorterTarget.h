...
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_00C5E99C9B0EC08D_OFFSET UNITYSDK_OFFSET(0xA131460)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xA132A00)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_514DADE30A6B3A71_OFFSET UNITYSDK_OFFSET(0xA131270)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_6E896AACE3F012D5_OFFSET UNITYSDK_OFFSET(0xA131C20)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xA1321E0)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_ED65AE7582736594_OFFSET UNITYSDK_OFFSET(0xA132A50)
#define RPG_CLIENT_PROP_PORTERTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0xA132AF0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PorterTarget_TypeDefinitionIndex = 64225;
