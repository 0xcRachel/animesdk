...
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_DISABLETRIGGER_OFFSET UNITYSDK_OFFSET(0xEDEFA60)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xEDEF510)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_ENABLETRIGGER_OFFSET UNITYSDK_OFFSET(0xEDEF780)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xEDEED30)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_1B167429A8B82AD3_1_OFFSET UNITYSDK_OFFSET(0xEDEF8E0)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_1B167429A8B82AD3_OFFSET UNITYSDK_OFFSET(0xEDEF950)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_28141171CE1C76E0_OFFSET UNITYSDK_OFFSET(0xEDEFDB0)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_36726F9E10ADB55F_OFFSET UNITYSDK_OFFSET(0xEDEFE30)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_7033EFB970A18315_OFFSET UNITYSDK_OFFSET(0xEDEF9C0)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_7646FFE662147970_1_OFFSET UNITYSDK_OFFSET(0xEDF02E0)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_7646FFE662147970_OFFSET UNITYSDK_OFFSET(0xEDF0180)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xEDEF870)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_A1781348F0A89177_1_OFFSET UNITYSDK_OFFSET(0xEDEFD40)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_A1781348F0A89177_OFFSET UNITYSDK_OFFSET(0xEDEFB50)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_FD1A8012013ED9C5_OFFSET UNITYSDK_OFFSET(0xEDEFBC0)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_ONWATERLEVELCHANGEEND_OFFSET UNITYSDK_OFFSET(0xEDEF660)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_REFRESHCURRENTACTIVEINDEX_OFFSET UNITYSDK_OFFSET(0xEDEF090)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0xEDEF590)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xEDF03A0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int WaterLevelController_TypeDefinitionIndex = 72415;
