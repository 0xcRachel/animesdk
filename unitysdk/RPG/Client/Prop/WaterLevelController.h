...
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_DISABLETRIGGER_OFFSET UNITYSDK_OFFSET(0x9CF9B10)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9CF95C0)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_ENABLETRIGGER_OFFSET UNITYSDK_OFFSET(0x9CF9830)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x9CF8DE0)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_1B167429A8B82AD3_1_OFFSET UNITYSDK_OFFSET(0x9CF9990)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_1B167429A8B82AD3_OFFSET UNITYSDK_OFFSET(0x9CF9A00)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_28141171CE1C76E0_OFFSET UNITYSDK_OFFSET(0x9CF9E60)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_36726F9E10ADB55F_OFFSET UNITYSDK_OFFSET(0x9CF9EE0)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_7033EFB970A18315_OFFSET UNITYSDK_OFFSET(0x9CF9A70)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x9CF9920)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_A1781348F0A89177_1_OFFSET UNITYSDK_OFFSET(0x9CF9DF0)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_A1781348F0A89177_OFFSET UNITYSDK_OFFSET(0x9CF9C00)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_BF5E2DCAE0BF038A_1_OFFSET UNITYSDK_OFFSET(0x9CFA410)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_BF5E2DCAE0BF038A_OFFSET UNITYSDK_OFFSET(0x9CFA230)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_FD1A8012013ED9C5_OFFSET UNITYSDK_OFFSET(0x9CF9C70)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_ONWATERLEVELCHANGEEND_OFFSET UNITYSDK_OFFSET(0x9CF9710)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_REFRESHCURRENTACTIVEINDEX_OFFSET UNITYSDK_OFFSET(0x9CF9140)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0x9CF9640)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9CFA550)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int WaterLevelController_TypeDefinitionIndex = 62181;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_BF5E2DCAE0BF038A_OFFSET))(this);
		}

		::System::Void Method_5_BF5E2DCAE0BF038A_1()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_BF5E2DCAE0BF038A_1_OFFSET))(this);
		}
	};
}
