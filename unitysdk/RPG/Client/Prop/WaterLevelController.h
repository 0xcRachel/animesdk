...
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_DISABLETRIGGER_OFFSET UNITYSDK_OFFSET(0xA1863C0)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA185E70)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_ENABLETRIGGER_OFFSET UNITYSDK_OFFSET(0xA1860E0)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xA185690)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_1B167429A8B82AD3_1_OFFSET UNITYSDK_OFFSET(0xA186240)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_1B167429A8B82AD3_OFFSET UNITYSDK_OFFSET(0xA1862B0)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_28141171CE1C76E0_OFFSET UNITYSDK_OFFSET(0xA186710)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_36726F9E10ADB55F_OFFSET UNITYSDK_OFFSET(0xA186790)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_7033EFB970A18315_OFFSET UNITYSDK_OFFSET(0xA186320)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_7646FFE662147970_1_OFFSET UNITYSDK_OFFSET(0xA186C30)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_7646FFE662147970_OFFSET UNITYSDK_OFFSET(0xA186AE0)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xA1861D0)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_A1781348F0A89177_1_OFFSET UNITYSDK_OFFSET(0xA1866A0)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_A1781348F0A89177_OFFSET UNITYSDK_OFFSET(0xA1864B0)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_FD1A8012013ED9C5_OFFSET UNITYSDK_OFFSET(0xA186520)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_ONWATERLEVELCHANGEEND_OFFSET UNITYSDK_OFFSET(0xA185FC0)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_REFRESHCURRENTACTIVEINDEX_OFFSET UNITYSDK_OFFSET(0xA1859F0)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0xA185EF0)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA186CF0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int WaterLevelController_TypeDefinitionIndex = 64368;
