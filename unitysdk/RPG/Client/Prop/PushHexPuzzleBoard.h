...
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_INITITEMSPOSITION_OFFSET UNITYSDK_OFFSET(0x13AAAB50)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_INITITEMS_OFFSET UNITYSDK_OFFSET(0x13AAA460)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_0BE999401C7B391E_OFFSET UNITYSDK_OFFSET(0x13AABA00)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_290A3E8A6F71CEC9_OFFSET UNITYSDK_OFFSET(0x13AAB930)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_55B8349E0B606444_OFFSET UNITYSDK_OFFSET(0x13AABDA0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_56E076CBC69B0772_OFFSET UNITYSDK_OFFSET(0x13AABCA0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_5E0B2F98EE594DCF_OFFSET UNITYSDK_OFFSET(0x13AAB850)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_703AF19EA2713271_OFFSET UNITYSDK_OFFSET(0x13AABC10)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_72279D6ACE251992_OFFSET UNITYSDK_OFFSET(0x13AABAF0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_810DD818C57F797D_OFFSET UNITYSDK_OFFSET(0x13AABF90)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_MOVEITEM_OFFSET UNITYSDK_OFFSET(0x13AABEA0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_RECOVERORIGIN_OFFSET UNITYSDK_OFFSET(0x13AAC180)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_REFRESHITEMDIRECTION_OFFSET UNITYSDK_OFFSET(0x13AAB1F0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_REFRESHITEMSPOSITION_OFFSET UNITYSDK_OFFSET(0x13AAB5A0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_START_OFFSET UNITYSDK_OFFSET(0x13AABF30)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x13AAC380)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PushHexPuzzleBoard_TypeDefinitionIndex = 72115;
