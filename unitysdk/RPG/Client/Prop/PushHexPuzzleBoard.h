...
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_INITITEMSPOSITION_OFFSET UNITYSDK_OFFSET(0xA137870)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_INITITEMS_OFFSET UNITYSDK_OFFSET(0xA137180)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_0BE999401C7B391E_OFFSET UNITYSDK_OFFSET(0xA138720)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_290A3E8A6F71CEC9_OFFSET UNITYSDK_OFFSET(0xA138650)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_55B8349E0B606444_OFFSET UNITYSDK_OFFSET(0xA138AC0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_56E076CBC69B0772_OFFSET UNITYSDK_OFFSET(0xA1389C0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_5E0B2F98EE594DCF_OFFSET UNITYSDK_OFFSET(0xA138570)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_703AF19EA2713271_OFFSET UNITYSDK_OFFSET(0xA138930)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_72279D6ACE251992_OFFSET UNITYSDK_OFFSET(0xA138810)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_810DD818C57F797D_OFFSET UNITYSDK_OFFSET(0xA138CB0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_MOVEITEM_OFFSET UNITYSDK_OFFSET(0xA138BC0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_RECOVERORIGIN_OFFSET UNITYSDK_OFFSET(0xA138EA0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_REFRESHITEMDIRECTION_OFFSET UNITYSDK_OFFSET(0xA137F10)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_REFRESHITEMSPOSITION_OFFSET UNITYSDK_OFFSET(0xA1382C0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_START_OFFSET UNITYSDK_OFFSET(0xA138C50)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xA1390A0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PushHexPuzzleBoard_TypeDefinitionIndex = 64068;
