...
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_INITITEMSPOSITION_OFFSET UNITYSDK_OFFSET(0x9CAB160)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_INITITEMS_OFFSET UNITYSDK_OFFSET(0x9CAAA70)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_0BE999401C7B391E_OFFSET UNITYSDK_OFFSET(0x9CAC010)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_290A3E8A6F71CEC9_OFFSET UNITYSDK_OFFSET(0x9CABF40)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_55B8349E0B606444_OFFSET UNITYSDK_OFFSET(0x9CAC3B0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_56E076CBC69B0772_OFFSET UNITYSDK_OFFSET(0x9CAC2B0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_5E0B2F98EE594DCF_OFFSET UNITYSDK_OFFSET(0x9CABE60)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_703AF19EA2713271_OFFSET UNITYSDK_OFFSET(0x9CAC220)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_72279D6ACE251992_OFFSET UNITYSDK_OFFSET(0x9CAC100)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_810DD818C57F797D_OFFSET UNITYSDK_OFFSET(0x9CAC5A0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_MOVEITEM_OFFSET UNITYSDK_OFFSET(0x9CAC4B0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_RECOVERORIGIN_OFFSET UNITYSDK_OFFSET(0x9CAC790)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_REFRESHITEMDIRECTION_OFFSET UNITYSDK_OFFSET(0x9CAB800)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_REFRESHITEMSPOSITION_OFFSET UNITYSDK_OFFSET(0x9CABBB0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_START_OFFSET UNITYSDK_OFFSET(0x9CAC540)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x9CAC990)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PushHexPuzzleBoard_TypeDefinitionIndex = 61881;
