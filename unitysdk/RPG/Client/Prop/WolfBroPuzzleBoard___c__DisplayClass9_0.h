...
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9CFEFD0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int WolfBroPuzzleBoard___c__DisplayClass9_0_TypeDefinitionIndex = 61957;
