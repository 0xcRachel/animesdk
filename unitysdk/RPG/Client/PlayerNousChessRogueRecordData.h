...
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_GET_ADVANCEDDIFFICULTY_OFFSET UNITYSDK_OFFSET(0x1273EB50)
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_GET_AREAID_OFFSET UNITYSDK_OFFSET(0x1273EB10)
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_GET_DIFFICULTY_OFFSET UNITYSDK_OFFSET(0x1273EBD0)
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_GET_DISPLAYTYPE_OFFSET UNITYSDK_OFFSET(0x1273EB90)
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_GET_DLCID_OFFSET UNITYSDK_OFFSET(0x1273EAF0)
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_GET_HASRECORD_OFFSET UNITYSDK_OFFSET(0x1273EBA0)
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1273EBB0)
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_GET_PRIMARYDIFFICULT_OFFSET UNITYSDK_OFFSET(0x1273EB30)
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_GET_PROCESS_OFFSET UNITYSDK_OFFSET(0x1273EB70)
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_SET_ADVANCEDDIFFICULTY_OFFSET UNITYSDK_OFFSET(0x1273EB60)
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_SET_AREAID_OFFSET UNITYSDK_OFFSET(0x1273EB20)
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_SET_DIFFICULTY_OFFSET UNITYSDK_OFFSET(0x1273EBE0)
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_SET_DLCID_OFFSET UNITYSDK_OFFSET(0x1273EB00)
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1273EBC0)
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_SET_PRIMARYDIFFICULT_OFFSET UNITYSDK_OFFSET(0x1273EB40)
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_SET_PROCESS_OFFSET UNITYSDK_OFFSET(0x1273EB80)
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_SYNC_OFFSET UNITYSDK_OFFSET(0x1273EBF0)
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1273ECF0)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 _Process_k__BackingField; // 0x18
