...
#define RPG_CLIENT_AIRLINEVARIABLESCALEPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x8C48FE0)

namespace RPG::Client
{
	inline static constexpr unsigned int AirlineVariableScalePoint_TypeDefinitionIndex = 47313;
