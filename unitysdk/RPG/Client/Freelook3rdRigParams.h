...
#define RPG_CLIENT_FREELOOK3RDRIGPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x92A48C0)

namespace RPG::Client
{
	inline static constexpr unsigned int Freelook3rdRigParams_TypeDefinitionIndex = 55404;
