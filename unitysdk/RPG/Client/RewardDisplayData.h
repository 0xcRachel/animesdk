...
#define RPG_CLIENT_REWARDDISPLAYDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1771C370)
#define RPG_CLIENT_REWARDDISPLAYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1771C400)
