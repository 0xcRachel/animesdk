...
#define RPG_CLIENT_REWARDDISPLAYDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x9DCE8F0)
#define RPG_CLIENT_REWARDDISPLAYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9DCE980)

namespace RPG::Client
{
	inline static constexpr unsigned int RewardDisplayData_TypeDefinitionIndex = 52239;
