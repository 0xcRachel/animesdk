...
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_0F9F7473284990EE_OFFSET UNITYSDK_OFFSET(0x1620B1F0)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_253939E38255333C_OFFSET UNITYSDK_OFFSET(0x1620B430)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_316207AB65D83105_OFFSET UNITYSDK_OFFSET(0x1620A710)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_3FC863B885E15ED5_OFFSET UNITYSDK_OFFSET(0x1620A120)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_41674EA405344719_OFFSET UNITYSDK_OFFSET(0x1620BCB0)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_5200FCB2A2AED1C2_OFFSET UNITYSDK_OFFSET(0x1620B940)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_66019C9C927A7F81_OFFSET UNITYSDK_OFFSET(0x1620C020)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_7C39B552AC01A40C_OFFSET UNITYSDK_OFFSET(0x1620A7B0)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_8B9FCF9FEE524950_OFFSET UNITYSDK_OFFSET(0x1620B6A0)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_AF2A45B2392898DF_OFFSET UNITYSDK_OFFSET(0x1620BE30)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_BA29415E87DA466B_OFFSET UNITYSDK_OFFSET(0x16209A80)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_BAC72019BD607572_OFFSET UNITYSDK_OFFSET(0x1620AC30)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_BC809936E0F4F009_OFFSET UNITYSDK_OFFSET(0x1620A590)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_D1A394DDCA154DC3_OFFSET UNITYSDK_OFFSET(0x1620A4E0)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_D806DABEADBC80D3_OFFSET UNITYSDK_OFFSET(0x1620A9A0)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_DAB6E73F3199851E_OFFSET UNITYSDK_OFFSET(0x1620AAE0)
#define RPG_CLIENT_STATERUNBLENDTREE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x16209A10)
#define RPG_CLIENT_STATERUNBLENDTREE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x162099B0)
#define RPG_CLIENT_STATERUNBLENDTREE_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x16209D10)
#define RPG_CLIENT_STATERUNBLENDTREE_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0x1620BAA0)
#define RPG_CLIENT_STATERUNBLENDTREE_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1620ADA0)
#define RPG_CLIENT_STATERUNBLENDTREE__CTOR_OFFSET UNITYSDK_OFFSET(0x1620C0C0)
#define RPG_CLIENT_STATERUNBLENDTREE___IFIXBASEPROXY_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x1620C130)
#define RPG_CLIENT_STATERUNBLENDTREE___IFIXBASEPROXY_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0x1620C150)
#define RPG_CLIENT_STATERUNBLENDTREE___IFIXBASEPROXY_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1620C140)
