...
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICRECOMMENDSUBPROPERTYFILTER_FILTER_OFFSET UNITYSDK_OFFSET(0x1602C750)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICRECOMMENDSUBPROPERTYFILTER_GETDESC_OFFSET UNITYSDK_OFFSET(0x1602CE00)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICRECOMMENDSUBPROPERTYFILTER_GETMAXSELECTCOUNT_OFFSET UNITYSDK_OFFSET(0x1602CDC0)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICRECOMMENDSUBPROPERTYFILTER_GET_ISOPENED_OFFSET UNITYSDK_OFFSET(0x1602C6B0)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICRECOMMENDSUBPROPERTYFILTER_GET_MATCHCOUNT_OFFSET UNITYSDK_OFFSET(0x1602C690)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICRECOMMENDSUBPROPERTYFILTER_ISMATCH_OFFSET UNITYSDK_OFFSET(0x1602C7B0)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICRECOMMENDSUBPROPERTYFILTER_SET_ISOPENED_OFFSET UNITYSDK_OFFSET(0x1602C6C0)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICRECOMMENDSUBPROPERTYFILTER_SET_MATCHCOUNT_OFFSET UNITYSDK_OFFSET(0x1602C6A0)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICRECOMMENDSUBPROPERTYFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1602C6D0)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICRECOMMENDSUBPROPERTYFILTER__ISMATCH_OFFSET UNITYSDK_OFFSET(0x1602C9D0)

namespace RPG::Client::RelicIntelligentSellFilter
{
	inline static constexpr unsigned int RelicRecommendSubPropertyFilter_TypeDefinitionIndex = 68715;
