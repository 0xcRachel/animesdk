...
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICRECOMMENDSUBPROPERTYFILTER_FILTER_OFFSET UNITYSDK_OFFSET(0xA2AE230)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICRECOMMENDSUBPROPERTYFILTER_GETDESC_OFFSET UNITYSDK_OFFSET(0xA2AE9A0)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICRECOMMENDSUBPROPERTYFILTER_GETMAXSELECTCOUNT_OFFSET UNITYSDK_OFFSET(0xA2AE960)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICRECOMMENDSUBPROPERTYFILTER_GET_ISOPENED_OFFSET UNITYSDK_OFFSET(0xA2AE190)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICRECOMMENDSUBPROPERTYFILTER_GET_MATCHCOUNT_OFFSET UNITYSDK_OFFSET(0xA2AE170)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICRECOMMENDSUBPROPERTYFILTER_ISMATCH_OFFSET UNITYSDK_OFFSET(0xA2AE290)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICRECOMMENDSUBPROPERTYFILTER_SET_ISOPENED_OFFSET UNITYSDK_OFFSET(0xA2AE1A0)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICRECOMMENDSUBPROPERTYFILTER_SET_MATCHCOUNT_OFFSET UNITYSDK_OFFSET(0xA2AE180)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICRECOMMENDSUBPROPERTYFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0xA2AE1B0)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICRECOMMENDSUBPROPERTYFILTER__ISMATCH_OFFSET UNITYSDK_OFFSET(0xA2AE4B0)

namespace RPG::Client::RelicIntelligentSellFilter
{
	inline static constexpr unsigned int RelicRecommendSubPropertyFilter_TypeDefinitionIndex = 61207;
	...
	public:
		...
		::System::UInt32 _MaxSelectCount; // 0x20
		::System::UInt32 _MatchCount_k__BackingField; // 0x24
		::System::UInt32 FilterCount; // 0x28
