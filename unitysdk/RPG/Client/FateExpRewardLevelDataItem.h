...
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_CREATEBYROW_OFFSET UNITYSDK_OFFSET(0x178FFA80)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_GET_EXPREQUIREDTOTAL_OFFSET UNITYSDK_OFFSET(0x17900D40)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_GET_ISCLAIMEDLIMITEDTIME_OFFSET UNITYSDK_OFFSET(0x17901B80)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_GET_ISCLAIMEDPERMANENT_OFFSET UNITYSDK_OFFSET(0x17901B70)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x17901A90)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_GET_REWARDIDLIMITEDTIME_OFFSET UNITYSDK_OFFSET(0x17901A20)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_GET_REWARDIDPERMANENT_OFFSET UNITYSDK_OFFSET(0x17901B00)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0x17901AA0)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_ISCLAIMABLEIFLEVELREACHED_OFFSET UNITYSDK_OFFSET(0x17901160)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_SYNCLIMITEDTIMECLAIMEDSTATUS_OFFSET UNITYSDK_OFFSET(0x179004B0)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_SYNCPERMANENTCLAIMEDSTATUS_OFFSET UNITYSDK_OFFSET(0x17900460)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x17901A10)
