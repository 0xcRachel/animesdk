...
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_CREATEBYROW_OFFSET UNITYSDK_OFFSET(0x91D9A00)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_GET_EXPREQUIREDTOTAL_OFFSET UNITYSDK_OFFSET(0x91DACC0)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_GET_ISCLAIMEDLIMITEDTIME_OFFSET UNITYSDK_OFFSET(0x91DB8B0)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_GET_ISCLAIMEDPERMANENT_OFFSET UNITYSDK_OFFSET(0x91DB8A0)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x91DB7C0)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_GET_REWARDIDLIMITEDTIME_OFFSET UNITYSDK_OFFSET(0x91DB750)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_GET_REWARDIDPERMANENT_OFFSET UNITYSDK_OFFSET(0x91DB830)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0x91DB7D0)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_ISCLAIMABLEIFLEVELREACHED_OFFSET UNITYSDK_OFFSET(0x91DAF90)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_SYNCLIMITEDTIMECLAIMEDSTATUS_OFFSET UNITYSDK_OFFSET(0x91DA430)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_SYNCPERMANENTCLAIMEDSTATUS_OFFSET UNITYSDK_OFFSET(0x91DA3E0)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x91DB740)

namespace RPG::Client
{
	inline static constexpr unsigned int FateExpRewardLevelDataItem_TypeDefinitionIndex = 50798;
