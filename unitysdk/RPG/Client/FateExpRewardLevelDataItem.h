...
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_CREATEBYROW_OFFSET UNITYSDK_OFFSET(0x96869F0)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_GET_EXPREQUIREDTOTAL_OFFSET UNITYSDK_OFFSET(0x9687CB0)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_GET_ISCLAIMEDLIMITEDTIME_OFFSET UNITYSDK_OFFSET(0x9688AF0)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_GET_ISCLAIMEDPERMANENT_OFFSET UNITYSDK_OFFSET(0x9688AE0)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x9688A00)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_GET_REWARDIDLIMITEDTIME_OFFSET UNITYSDK_OFFSET(0x9688990)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_GET_REWARDIDPERMANENT_OFFSET UNITYSDK_OFFSET(0x9688A70)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0x9688A10)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_ISCLAIMABLEIFLEVELREACHED_OFFSET UNITYSDK_OFFSET(0x96880D0)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_SYNCLIMITEDTIMECLAIMEDSTATUS_OFFSET UNITYSDK_OFFSET(0x9687420)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_SYNCPERMANENTCLAIMEDSTATUS_OFFSET UNITYSDK_OFFSET(0x96873D0)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9688980)
...
namespace RPG::Client
{
	...
	{
	public:
		::System::Boolean _IsClaimedLimitedTime; // 0x10
		::System::Boolean _IsClaimedPermanent; // 0x11
