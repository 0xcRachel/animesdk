...
#define RPG_CLIENT_ANIMATIONCLIPBAKER__CTOR_OFFSET UNITYSDK_OFFSET(0x8C7ED70)

namespace RPG::Client
{
	inline static constexpr unsigned int AnimationClipBaker_TypeDefinitionIndex = 54233;
