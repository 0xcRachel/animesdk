...
#define RPG_CLIENT_AVATARSERVANTEXTENSIONS_GETSERVANTID_OFFSET UNITYSDK_OFFSET(0x8D58F10)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarServantExtensions_TypeDefinitionIndex = 49735;
