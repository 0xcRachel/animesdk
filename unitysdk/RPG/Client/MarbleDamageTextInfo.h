...
#define RPG_CLIENT_MARBLEDAMAGETEXTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x9641400)

namespace RPG::Client
{
	inline static constexpr unsigned int MarbleDamageTextInfo_TypeDefinitionIndex = 52323;
	...
	public:
		...
		::Enum_3_0A3761FE34514D6C_33 DamageType; // 0x28
