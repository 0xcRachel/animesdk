...
#define RPG_CLIENT_AVATARDATA_UPGRADEAVATARDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x9121F90)
#define RPG_CLIENT_AVATARDATA_UPGRADEAVATARDATA_GET_ORIGINAVATAR_OFFSET UNITYSDK_OFFSET(0x9121EE0)
#define RPG_CLIENT_AVATARDATA_UPGRADEAVATARDATA_GET_UPGRADEAVATAR_OFFSET UNITYSDK_OFFSET(0x9121EF0)
#define RPG_CLIENT_AVATARDATA_UPGRADEAVATARDATA_GET_WORLDLEVEL_OFFSET UNITYSDK_OFFSET(0x9124040)
#define RPG_CLIENT_AVATARDATA_UPGRADEAVATARDATA_SETWORLDLEVELSTRATEGY_OFFSET UNITYSDK_OFFSET(0x9122740)
#define RPG_CLIENT_AVATARDATA_UPGRADEAVATARDATA_UPDATE_OFFSET UNITYSDK_OFFSET(0x9122360)
#define RPG_CLIENT_AVATARDATA_UPGRADEAVATARDATA__BUILDSKILLTREESANDSKILLS_OFFSET UNITYSDK_OFFSET(0x9123A90)
#define RPG_CLIENT_AVATARDATA_UPGRADEAVATARDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9121F00)
#define RPG_CLIENT_AVATARDATA_UPGRADEAVATARDATA__GETUPGRADEDAVATARLEVEL_OFFSET UNITYSDK_OFFSET(0x9122B80)
#define RPG_CLIENT_AVATARDATA_UPGRADEAVATARDATA__GETUPGRADEDAVATARPROMOTION_OFFSET UNITYSDK_OFFSET(0x9122C20)
#define RPG_CLIENT_AVATARDATA_UPGRADEAVATARDATA__GETUPGRADEDAVATARRELIC_OFFSET UNITYSDK_OFFSET(0x9122F40)
#define RPG_CLIENT_AVATARDATA_UPGRADEAVATARDATA__GETUPGRADEDEQUIPMENT_OFFSET UNITYSDK_OFFSET(0x9122CD0)
#define RPG_CLIENT_AVATARDATA_UPGRADEAVATARDATA__GETUPGRADEDRANK_OFFSET UNITYSDK_OFFSET(0x9123F50)
#define RPG_CLIENT_AVATARDATA_UPGRADEAVATARDATA__INTERNALUPDATE_OFFSET UNITYSDK_OFFSET(0x91223B0)
...
namespace RPG::Client
{
	...
	{
	public:
		::RPG::Client::AvatarData* _OriginAvatar; // 0x10
		::Class_1_96A52A8F71E6742B* _UpgradeAvatarChecker; // 0x18
		::Class_0_16E4307DCC419505_571* _WorldLevelStrategy; // 0x20
		::RPG::Client::AvatarData* _UpgradeAvatar; // 0x28
