...
#define RPG_CLIENT_LOCALIZEDINPUTFIELD_AWAKE_OFFSET UNITYSDK_OFFSET(0x1519D320)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD_HASSTATE_OFFSET UNITYSDK_OFFSET(0x1519E870)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1519D7F0)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD_ONDESELECT_OFFSET UNITYSDK_OFFSET(0x1519E4B0)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1519D5F0)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD_ONSELECT_OFFSET UNITYSDK_OFFSET(0x1519DFF0)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD_SETCHECKED_OFFSET UNITYSDK_OFFSET(0x1519E370)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD_UPDATELABEL_OFFSET UNITYSDK_OFFSET(0x1519DA60)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD__ANIMATORCHECK_OFFSET UNITYSDK_OFFSET(0x1519E780)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x1519F150)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD__INITNAVIGATIONMODE_OFFSET UNITYSDK_OFFSET(0x1519EC10)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD__ONENDEDIT_OFFSET UNITYSDK_OFFSET(0x1519EA80)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD__ONUIINCONTROLTIPUPDATE_OFFSET UNITYSDK_OFFSET(0x1519ED20)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD__ONVALIDATEINPUT_OFFSET UNITYSDK_OFFSET(0x1519E920)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD__POSTINPUTSOUND_OFFSET UNITYSDK_OFFSET(0x1519EF50)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD___IFIXBASEPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0x1519F1F0)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD___IFIXBASEPROXY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1519F290)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD___IFIXBASEPROXY_ONDESELECT_OFFSET UNITYSDK_OFFSET(0x1519F380)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD___IFIXBASEPROXY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1519F280)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD___IFIXBASEPROXY_ONSELECT_OFFSET UNITYSDK_OFFSET(0x1519F2B0)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD___IFIXBASEPROXY_UPDATELABEL_OFFSET UNITYSDK_OFFSET(0x1519F2A0)

namespace RPG::Client
{
	inline static constexpr unsigned int LocalizedInputField_TypeDefinitionIndex = 67796;
