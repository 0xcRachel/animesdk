...
#define RPG_CLIENT_LOCALIZEDINPUTFIELD_AWAKE_OFFSET UNITYSDK_OFFSET(0x9A58180)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD_HASSTATE_OFFSET UNITYSDK_OFFSET(0x9A59C30)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9A58600)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD_ONDESELECT_OFFSET UNITYSDK_OFFSET(0x9A59870)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9A58440)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD_ONSELECT_OFFSET UNITYSDK_OFFSET(0x9A58E70)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD_SETCHECKED_OFFSET UNITYSDK_OFFSET(0x9A591F0)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD_UPDATELABEL_OFFSET UNITYSDK_OFFSET(0x9A58850)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD__ANIMATORCHECK_OFFSET UNITYSDK_OFFSET(0x9A59B40)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x9A5A480)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD__INITNAVIGATIONMODE_OFFSET UNITYSDK_OFFSET(0x9A59FD0)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD__ONENDEDIT_OFFSET UNITYSDK_OFFSET(0x9A59E40)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD__ONUIINCONTROLTIPUPDATE_OFFSET UNITYSDK_OFFSET(0x9A5A060)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD__ONVALIDATEINPUT_OFFSET UNITYSDK_OFFSET(0x9A59CE0)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD__POSTINPUTSOUND_OFFSET UNITYSDK_OFFSET(0x9A5A290)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD___IFIXBASEPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0x9A5A520)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD___IFIXBASEPROXY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9A5A5C0)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD___IFIXBASEPROXY_ONDESELECT_OFFSET UNITYSDK_OFFSET(0x9A5A6B0)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD___IFIXBASEPROXY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9A5A5B0)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD___IFIXBASEPROXY_ONSELECT_OFFSET UNITYSDK_OFFSET(0x9A5A5E0)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD___IFIXBASEPROXY_UPDATELABEL_OFFSET UNITYSDK_OFFSET(0x9A5A5D0)

namespace RPG::Client
{
	inline static constexpr unsigned int LocalizedInputField_TypeDefinitionIndex = 59461;
