...
#define RPG_CLIENT_EASYFOG_GET_FOGNORMALMAP_OFFSET UNITYSDK_OFFSET(0x160DD1C0)
#define RPG_CLIENT_EASYFOG_GET_OPACITYMAP_OFFSET UNITYSDK_OFFSET(0x160DD170)
#define RPG_CLIENT_EASYFOG__CTOR_OFFSET UNITYSDK_OFFSET(0x160DD210)
