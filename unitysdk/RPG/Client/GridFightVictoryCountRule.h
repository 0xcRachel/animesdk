...
#define RPG_CLIENT_GRIDFIGHTVICTORYCOUNTRULE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x94717B0)
#define RPG_CLIENT_GRIDFIGHTVICTORYCOUNTRULE__CTOR_OFFSET UNITYSDK_OFFSET(0x94717A0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightVictoryCountRule_TypeDefinitionIndex = 51707;
