...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODELPARAM_CREATEDEFAULTTAB_OFFSET UNITYSDK_OFFSET(0x17E02DE0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODELPARAM_CREATEMOVETONEWPOST_OFFSET UNITYSDK_OFFSET(0x17E02FE0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODELPARAM_CREATEMOVETOPOST_OFFSET UNITYSDK_OFFSET(0x17E02EE0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODELPARAM_CREATESELECTEDISSUE_OFFSET UNITYSDK_OFFSET(0x17E02E60)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODELPARAM_CREATETOPPOST_OFFSET UNITYSDK_OFFSET(0x17E02F60)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODELPARAM_CREATE_OFFSET UNITYSDK_OFFSET(0x17E02D60)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODELPARAM_GET_ISSUEID_OFFSET UNITYSDK_OFFSET(0x17E03080)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODELPARAM_GET_MOVETOPOSTID_OFFSET UNITYSDK_OFFSET(0x17E030C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODELPARAM_GET_TOPPOSTID_OFFSET UNITYSDK_OFFSET(0x17E030A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODELPARAM_GET_VIEWTAB_OFFSET UNITYSDK_OFFSET(0x17E03060)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODELPARAM_SET_ISSUEID_OFFSET UNITYSDK_OFFSET(0x17E03090)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODELPARAM_SET_MOVETOPOSTID_OFFSET UNITYSDK_OFFSET(0x17E030D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODELPARAM_SET_TOPPOSTID_OFFSET UNITYSDK_OFFSET(0x17E030B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODELPARAM_SET_VIEWTAB_OFFSET UNITYSDK_OFFSET(0x17E03070)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODELPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x17E02DD0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsWebsiteViewModelParam_TypeDefinitionIndex = 73893;
	...
	public:
		...
		::System::Boolean IsMoveToNewPost; // 0x20
