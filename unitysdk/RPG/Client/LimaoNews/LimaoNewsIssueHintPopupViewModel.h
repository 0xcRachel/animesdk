...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEHINTPOPUPVIEWMODEL_GET_ISSUEDATA_OFFSET UNITYSDK_OFFSET(0x1897C190)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEHINTPOPUPVIEWMODEL_GET_ISSUEID_OFFSET UNITYSDK_OFFSET(0x1897C130)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEHINTPOPUPVIEWMODEL_GET_ONBTNCLOSE_OFFSET UNITYSDK_OFFSET(0x1897C150)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEHINTPOPUPVIEWMODEL_GET_ONBTNFORM_OFFSET UNITYSDK_OFFSET(0x1897C170)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEHINTPOPUPVIEWMODEL_SET_ISSUEDATA_OFFSET UNITYSDK_OFFSET(0x1897C1A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEHINTPOPUPVIEWMODEL_SET_ISSUEID_OFFSET UNITYSDK_OFFSET(0x1897C140)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEHINTPOPUPVIEWMODEL_SET_ONBTNCLOSE_OFFSET UNITYSDK_OFFSET(0x1897C160)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEHINTPOPUPVIEWMODEL_SET_ONBTNFORM_OFFSET UNITYSDK_OFFSET(0x1897C180)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEHINTPOPUPVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1897BFD0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEHINTPOPUPVIEWMODEL___CTOR_B__0_0_OFFSET UNITYSDK_OFFSET(0x1897C1B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEHINTPOPUPVIEWMODEL___CTOR_B__0_1_OFFSET UNITYSDK_OFFSET(0x1897C200)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsIssueHintPopupViewModel_TypeDefinitionIndex = 73871;
	...
	public:
		...
		::Class_1_2FDE33CCAE591AA8* _OnBtnForm_k__BackingField; // 0x40
