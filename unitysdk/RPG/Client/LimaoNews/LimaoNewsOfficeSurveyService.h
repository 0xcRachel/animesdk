...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYSERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x189890F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYSERVICE_GETCUROFFICESURVEYS_OFFSET UNITYSDK_OFFSET(0x1898E3F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYSERVICE_GETSHOWSURVEYTOTALCOUNT_OFFSET UNITYSDK_OFFSET(0x1898E820)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYSERVICE_GETSURVEYDISPLAYREWARDID_OFFSET UNITYSDK_OFFSET(0x1898ED40)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYSERVICE_GETSURVEYITEMSTATETAGVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1898E430)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYSERVICE_GETSURVEYITEMSTATETAG_1_OFFSET UNITYSDK_OFFSET(0x1898E4D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYSERVICE_GETSURVEYITEMSTATETAG_OFFSET UNITYSDK_OFFSET(0x1898EE40)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYSERVICE_GET_RECOMMENDSERVICEID_OFFSET UNITYSDK_OFFSET(0x1898EEA0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYSERVICE_GOTOSURVEYMISSIONPAGE_OFFSET UNITYSDK_OFFSET(0x1898EAF0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYSERVICE_ISANYSURVEYCANSHOW_OFFSET UNITYSDK_OFFSET(0x1898E7D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYSERVICE_ISFINISHEDALLSURVEY_OFFSET UNITYSDK_OFFSET(0x1898E990)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYSERVICE_ISOFFICESURVEYFINISH_OFFSET UNITYSDK_OFFSET(0x1898E6C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYSERVICE_ISOFFICESURVEYSHOW_OFFSET UNITYSDK_OFFSET(0x1898E740)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYSERVICE_ISSURVEYHIDEREWARDAFTERSTART_OFFSET UNITYSDK_OFFSET(0x1898EDB0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYSERVICE_REBUILDSURVEYITEMSBYRECOMMENDID_OFFSET UNITYSDK_OFFSET(0x1898B230)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYSERVICE_REFRESHCUROFFICESURVEY_OFFSET UNITYSDK_OFFSET(0x1898AE80)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYSERVICE_SETRECOMMENDSURVEYID_OFFSET UNITYSDK_OFFSET(0x1898B6B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYSERVICE_SET_RECOMMENDSERVICEID_OFFSET UNITYSDK_OFFSET(0x1898EEB0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x18988A70)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYSERVICE__DISPOSECUROFFICESURVEYS_OFFSET UNITYSDK_OFFSET(0x1898E220)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsOfficeSurveyService_TypeDefinitionIndex = 73787;
