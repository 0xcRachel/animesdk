...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18993EF0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__BINDBOTTOMVIEW_OFFSET UNITYSDK_OFFSET(0x18994F50)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__BINDBTNSVIEW_OFFSET UNITYSDK_OFFSET(0x18995180)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__BINDPOSTBASICVIEW_OFFSET UNITYSDK_OFFSET(0x18993F60)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__BINDRIGHTVIEW_OFFSET UNITYSDK_OFFSET(0x18994BE0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__CLEARREDDOT_OFFSET UNITYSDK_OFFSET(0x18995C00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__CTOR_OFFSET UNITYSDK_OFFSET(0x189929C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__MOVETOCOMMENT_OFFSET UNITYSDK_OFFSET(0x18996930)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18993CA0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__ONEXITFINALSTEP_OFFSET UNITYSDK_OFFSET(0x18995CA0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x18992A70)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__ONLIMAONEWSCLOSEPOSTDETAIL_OFFSET UNITYSDK_OFFSET(0x18996B80)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__ONLIMAONEWSPOSTDETAILOPERATION_OFFSET UNITYSDK_OFFSET(0x189969D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__ONLIMAONEWSPOSTMESSAGE_OFFSET UNITYSDK_OFFSET(0x18995F20)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__ONLIMAONEWSREFRESHUPVOTE_OFFSET UNITYSDK_OFFSET(0x18996D30)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__ONLIMAONEWSREPLAYPOST_OFFSET UNITYSDK_OFFSET(0x189965C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__ONLIMAONEWSSUBMITPOST_OFFSET UNITYSDK_OFFSET(0x18995FC0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__ONNEWCOMMENTITEM_OFFSET UNITYSDK_OFFSET(0x18997620)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__SUBSCRIBEMESSAGE_OFFSET UNITYSDK_OFFSET(0x18993BE0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18997850)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW___IFIXBASEPROXY__ONEXITFINALSTEP_OFFSET UNITYSDK_OFFSET(0x189978B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x189977F0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsPostDetailWindow_TypeDefinitionIndex = 73852;

	class LimaoNewsPostDetailWindow : public ::Sofa::BaseSofaWindow
	{
	public:
		::RPG::Client::LimaoNews::LimaoNewsStateTagControl* _StateTagControl; // 0x40
		::RPG::Client::AnimatorButton* _BtnEmptyClose; // 0x48
		::Class_1_5F4D64A4B97E38F9* _Messenger; // 0x50
		::UnityEngine::Transform* _NodeComic; // 0x58
		::UnityEngine::Transform* _NodeComicMask; // 0x60
		::UnityEngine::RectTransform* _NodeDescContent; // 0x68
		::UnityEngine::Transform* _NodeBannedMask; // 0x70
		::UnityEngine::UI::Image* _UserImage; // 0x78
		::RPG::Client::AnimatorButton* _BtnClose; // 0x80
		::RPG::Client::AnimatorButton* _BtnGo; // 0x88
		::UnityEngine::UI::Text* _BtnGoText; // 0x90
		::UnityEngine::UI::Text* _PostDesc; // 0x98
		::RPG::Client::LimaoNews::LimaoNewsOfficeSurveyTypeControl* _SurveyTypeControl; // 0xA0
		::RPG::Client::StaticListView* _CommentListView; // 0xA8
		::UnityEngine::Transform* _NodeComicLoadRoot; // 0xB0
		::UnityEngine::UI::Text* _UserName; // 0xB8
		::RPG::Client::AnimatorButton* _BtnImage; // 0xC0
		::UnityEngine::UI::Text* _PostTitle; // 0xC8
		::UnityEngine::UI::Image* _PostImage; // 0xD0
		::UnityEngine::Transform* _NodeBottom; // 0xD8
		::RPG::Client::LimaoNews::LimaoNewsLocationControl* _LocationControl; // 0xE0
		::RPG::Client::LimaoNews::LimaoNewsCommentListControl* _CommentListControl; // 0xE8
		::UnityEngine::Transform* _NodeDivider; // 0xF0
		::UnityEngine::UI::ScrollRect* _RightScrollRect; // 0xF8
		::RPG::Client::LimaoNews::LimaoNewsInteractionControl* _InteractionControl; // 0x100
		::UnityEngine::Transform* _NodeImage; // 0x108
		::UnityEngine::Transform* _UserOfficialTag; // 0x110
		::UnityEngine::Transform* _NodeVideoMask; // 0x118
