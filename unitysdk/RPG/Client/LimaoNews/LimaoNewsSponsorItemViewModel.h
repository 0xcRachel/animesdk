...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSPONSORITEMVIEWMODEL_GET_CLICKCOMMAND_OFFSET UNITYSDK_OFFSET(0x189A2140)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSPONSORITEMVIEWMODEL_GET_HINTICONPATH_OFFSET UNITYSDK_OFFSET(0x189A2120)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSPONSORITEMVIEWMODEL_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x189A2110)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSPONSORITEMVIEWMODEL_GET_POSTID_OFFSET UNITYSDK_OFFSET(0x189A2130)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSPONSORITEMVIEWMODEL_SET_HINTICONPATH_OFFSET UNITYSDK_OFFSET(0x189A1FF0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSPONSORITEMVIEWMODEL_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x189A1F60)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSPONSORITEMVIEWMODEL_SET_POSTID_OFFSET UNITYSDK_OFFSET(0x189A2080)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSPONSORITEMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x189A1CF0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSPONSORITEMVIEWMODEL__GOTOPOST_OFFSET UNITYSDK_OFFSET(0x189A2150)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSPONSORITEMVIEWMODEL___CTOR_B__0_0_OFFSET UNITYSDK_OFFSET(0x189A2270)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsSponsorItemViewModel_TypeDefinitionIndex = 73888;

	class LimaoNewsSponsorItemViewModel : public ::Sofa::BaseViewModel
	{
	public:
		::System::String* _IconPath; // 0x20
		::Class_1_2FDE33CCAE591AA8* _ClickCommand; // 0x28
		::System::String* _HintIconPath; // 0x30
