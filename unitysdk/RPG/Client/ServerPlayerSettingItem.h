...
#define RPG_CLIENT_SERVERPLAYERSETTINGITEM_GET_SERVERTYPE_OFFSET UNITYSDK_OFFSET(0x17547490)
#define RPG_CLIENT_SERVERPLAYERSETTINGITEM_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x17547350)
#define RPG_CLIENT_SERVERPLAYERSETTINGITEM_SET_SERVERTYPE_OFFSET UNITYSDK_OFFSET(0x175474A0)
#define RPG_CLIENT_SERVERPLAYERSETTINGITEM_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x17547360)
#define RPG_CLIENT_SERVERPLAYERSETTINGITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x17547340)
#define RPG_CLIENT_SERVERPLAYERSETTINGITEM___IFIXBASEPROXY_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x175474B0)
