...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_INIT_OFFSET UNITYSDK_OFFSET(0xA268E10)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_ISBOOMABLE_OFFSET UNITYSDK_OFFSET(0xA269040)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_ISHITTABLE_OFFSET UNITYSDK_OFFSET(0xA268F90)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_METHOD_6_3DFE7A801EF34CFC_OFFSET UNITYSDK_OFFSET(0xA269550)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_METHOD_6_AD23FDCC7576BB32_OFFSET UNITYSDK_OFFSET(0xA268EB0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_ONHIT_OFFSET UNITYSDK_OFFSET(0xA2690D0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_ONLOSSHP_OFFSET UNITYSDK_OFFSET(0xA269430)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP__CTOR_OFFSET UNITYSDK_OFFSET(0xA269470)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0xA269540)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP___IFIXBASEPROXY_ISBOOMABLE_OFFSET UNITYSDK_OFFSET(0xA2695F0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP___IFIXBASEPROXY_ISHITTABLE_OFFSET UNITYSDK_OFFSET(0xA269560)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP___IFIXBASEPROXY_ONHIT_OFFSET UNITYSDK_OFFSET(0xA269680)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayTarget_HP_TypeDefinitionIndex = 54567;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_METHOD_6_3DFE7A801EF34CFC_OFFSET))(this, P0);
		}
