...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_INIT_OFFSET UNITYSDK_OFFSET(0x11E5E430)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_ISBOOMABLE_OFFSET UNITYSDK_OFFSET(0x11E5E660)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_ISHITTABLE_OFFSET UNITYSDK_OFFSET(0x11E5E5B0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_METHOD_6_AD23FDCC7576BB32_OFFSET UNITYSDK_OFFSET(0x11E5E4D0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_METHOD_6_BEC0C6D1D2906F45_OFFSET UNITYSDK_OFFSET(0x11E5EBB0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_ONHIT_OFFSET UNITYSDK_OFFSET(0x11E5E6F0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_ONLOSSHP_OFFSET UNITYSDK_OFFSET(0x11E5EA30)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP__CTOR_OFFSET UNITYSDK_OFFSET(0x11E5EA70)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x11E5EBA0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP___IFIXBASEPROXY_ISBOOMABLE_OFFSET UNITYSDK_OFFSET(0x11E5EC30)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP___IFIXBASEPROXY_ISHITTABLE_OFFSET UNITYSDK_OFFSET(0x11E5EBC0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP___IFIXBASEPROXY_ONHIT_OFFSET UNITYSDK_OFFSET(0x11E5ECA0)
