...
#define RPG_CLIENT_GRIDFIGHTPENDINGSTAGEBASEACTION_FINISH_OFFSET UNITYSDK_OFFSET(0x177E8FA0)
#define RPG_CLIENT_GRIDFIGHTPENDINGSTAGEBASEACTION_GETACTIONID_OFFSET UNITYSDK_OFFSET(0x177E9050)
#define RPG_CLIENT_GRIDFIGHTPENDINGSTAGEBASEACTION_GETISHANDLED_OFFSET UNITYSDK_OFFSET(0x177E9090)
#define RPG_CLIENT_GRIDFIGHTPENDINGSTAGEBASEACTION_GET_ACTIONID_OFFSET UNITYSDK_OFFSET(0x177E91C0)
#define RPG_CLIENT_GRIDFIGHTPENDINGSTAGEBASEACTION_GET_ISHANDLED_OFFSET UNITYSDK_OFFSET(0x177E91A0)
#define RPG_CLIENT_GRIDFIGHTPENDINGSTAGEBASEACTION_HANDLE_OFFSET UNITYSDK_OFFSET(0x177E9110)
#define RPG_CLIENT_GRIDFIGHTPENDINGSTAGEBASEACTION_REGISTERFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0x177E9000)
#define RPG_CLIENT_GRIDFIGHTPENDINGSTAGEBASEACTION_SET_ACTIONID_OFFSET UNITYSDK_OFFSET(0x177E91D0)
#define RPG_CLIENT_GRIDFIGHTPENDINGSTAGEBASEACTION_SET_ISHANDLED_OFFSET UNITYSDK_OFFSET(0x177E91B0)
#define RPG_CLIENT_GRIDFIGHTPENDINGSTAGEBASEACTION_START_OFFSET UNITYSDK_OFFSET(0x177E90D0)
#define RPG_CLIENT_GRIDFIGHTPENDINGSTAGEBASEACTION_SYNCHANDLERSP_OFFSET UNITYSDK_OFFSET(0x177E9150)
#define RPG_CLIENT_GRIDFIGHTPENDINGSTAGEBASEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x177E8F90)
