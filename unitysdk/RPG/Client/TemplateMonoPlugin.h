...
#define RPG_CLIENT_TEMPLATEMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xA06C900)

namespace RPG::Client
{
	inline static constexpr unsigned int TemplateMonoPlugin_TypeDefinitionIndex = 56408;
