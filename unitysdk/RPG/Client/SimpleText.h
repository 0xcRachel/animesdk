...
#include "unitysdk/RPG/Client/SimpleText_Struct_2_FD8E1D4014EE315F_2.h"
...
#define RPG_CLIENT_SIMPLETEXT_AWAKE_OFFSET UNITYSDK_OFFSET(0x9F7E440)
#define RPG_CLIENT_SIMPLETEXT_FONTTEXTURECHANGED_OFFSET UNITYSDK_OFFSET(0x9F7F100)
#define RPG_CLIENT_SIMPLETEXT_GETSDFSCALE_OFFSET UNITYSDK_OFFSET(0x9F7FEC0)
#define RPG_CLIENT_SIMPLETEXT_GET_DATACOUNT_OFFSET UNITYSDK_OFFSET(0x9F7E170)
#define RPG_CLIENT_SIMPLETEXT_GET_ENABLEGLOW_OFFSET UNITYSDK_OFFSET(0x9F7E240)
#define RPG_CLIENT_SIMPLETEXT_GET_ENABLEOUTLINE1_OFFSET UNITYSDK_OFFSET(0x9F7E190)
#define RPG_CLIENT_SIMPLETEXT_GET_ENABLEOUTLINE_OFFSET UNITYSDK_OFFSET(0x9F7E180)
#define RPG_CLIENT_SIMPLETEXT_GET_ENABLESHADOW_OFFSET UNITYSDK_OFFSET(0x9F7DF80)
#define RPG_CLIENT_SIMPLETEXT_GET_FONTSIZE_OFFSET UNITYSDK_OFFSET(0x9F7DDD0)
#define RPG_CLIENT_SIMPLETEXT_GET_FONT_OFFSET UNITYSDK_OFFSET(0x9F7DBF0)
#define RPG_CLIENT_SIMPLETEXT_GET_GLOWINTENSITY_OFFSET UNITYSDK_OFFSET(0x9F7E1A0)
#define RPG_CLIENT_SIMPLETEXT_GET_GLOWWIDTH_OFFSET UNITYSDK_OFFSET(0x9F7E260)
#define RPG_CLIENT_SIMPLETEXT_GET_KEYFONT_OFFSET UNITYSDK_OFFSET(0x9F7DB90)
#define RPG_CLIENT_SIMPLETEXT_GET_OUTLINE1WIDTH_OFFSET UNITYSDK_OFFSET(0x9F7DEE0)
#define RPG_CLIENT_SIMPLETEXT_GET_OUTLINEWIDTH_OFFSET UNITYSDK_OFFSET(0x9F7DE40)
#define RPG_CLIENT_SIMPLETEXT_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x9F7E360)
#define RPG_CLIENT_SIMPLETEXT_GET_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x9F7E2B0)
#define RPG_CLIENT_SIMPLETEXT_GET_SHADOWOFFSET_OFFSET UNITYSDK_OFFSET(0x9F7DFE0)
#define RPG_CLIENT_SIMPLETEXT_GET_TEXTMAPID_OFFSET UNITYSDK_OFFSET(0x9F7DAD0)
#define RPG_CLIENT_SIMPLETEXT_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x9F7DAE0)
#define RPG_CLIENT_SIMPLETEXT_GET_UV0_OFFSET UNITYSDK_OFFSET(0x9F7E140)
#define RPG_CLIENT_SIMPLETEXT_GET_UV1_OFFSET UNITYSDK_OFFSET(0x9F7E150)
#define RPG_CLIENT_SIMPLETEXT_GET_UVEXTENDS_OFFSET UNITYSDK_OFFSET(0x9F7E160)
#define RPG_CLIENT_SIMPLETEXT_GET_VERTCOLORS_OFFSET UNITYSDK_OFFSET(0x9F7E130)
#define RPG_CLIENT_SIMPLETEXT_GET_VERTICES_OFFSET UNITYSDK_OFFSET(0x9F7E120)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_0CF83E823A2CCABD_OFFSET UNITYSDK_OFFSET(0x9F7EB00)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_1DE6433C25680F9D_OFFSET UNITYSDK_OFFSET(0x9F7E690)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0x9F7E990)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_89C03AF435ED2C78_OFFSET UNITYSDK_OFFSET(0x9F817F0)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_9EB0BC18871AB79D_OFFSET UNITYSDK_OFFSET(0x9F81970)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0x9F7F070)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_ABE8B3657B1F8305_OFFSET UNITYSDK_OFFSET(0x9F80530)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_B29205EE7F7B640C_OFFSET UNITYSDK_OFFSET(0x9F7F2B0)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x9F7EC40)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_D9AAE950C6F28BA6_OFFSET UNITYSDK_OFFSET(0x9F80440)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_FE9CC166D09C957F_OFFSET UNITYSDK_OFFSET(0x9F80190)
#define RPG_CLIENT_SIMPLETEXT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9F7ED60)
#define RPG_CLIENT_SIMPLETEXT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x9F7EBD0)
#define RPG_CLIENT_SIMPLETEXT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9F7E8A0)
#define RPG_CLIENT_SIMPLETEXT_ONLIGHTWEIGHTACTIVATE_OFFSET UNITYSDK_OFFSET(0x9F7EC90)
#define RPG_CLIENT_SIMPLETEXT_ONLIGHTWEIGHTDEACTIVATE_OFFSET UNITYSDK_OFFSET(0x9F7ECE0)
#define RPG_CLIENT_SIMPLETEXT_ONTRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0x9F7EEE0)
#define RPG_CLIENT_SIMPLETEXT_ONUITEXTCHANGEFONTFROMCONDENSETOCOMPLETE_OFFSET UNITYSDK_OFFSET(0x9F7EF90)
#define RPG_CLIENT_SIMPLETEXT_ONUITEXTLANGUAGECHANGE_OFFSET UNITYSDK_OFFSET(0x9F7EF30)
#define RPG_CLIENT_SIMPLETEXT_ONUITEXTSWITCH_OFFSET UNITYSDK_OFFSET(0x9F7EFD0)
#define RPG_CLIENT_SIMPLETEXT_ONUIWORLDFONTCHANGE_OFFSET UNITYSDK_OFFSET(0x9F7F020)
#define RPG_CLIENT_SIMPLETEXT_SETTEXTID_1_OFFSET UNITYSDK_OFFSET(0x9F818F0)
#define RPG_CLIENT_SIMPLETEXT_SETTEXTID_OFFSET UNITYSDK_OFFSET(0x9F81770)
#define RPG_CLIENT_SIMPLETEXT_SET_FONTSIZE_OFFSET UNITYSDK_OFFSET(0x9F7DDE0)
#define RPG_CLIENT_SIMPLETEXT_SET_FONT_OFFSET UNITYSDK_OFFSET(0x9F7DC00)
#define RPG_CLIENT_SIMPLETEXT_SET_GLOWINTENSITY_OFFSET UNITYSDK_OFFSET(0x9F7E1B0)
#define RPG_CLIENT_SIMPLETEXT_SET_OUTLINE1WIDTH_OFFSET UNITYSDK_OFFSET(0x9F7DEF0)
#define RPG_CLIENT_SIMPLETEXT_SET_OUTLINEWIDTH_OFFSET UNITYSDK_OFFSET(0x9F7DE50)
#define RPG_CLIENT_SIMPLETEXT_SET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x9F7E370)
#define RPG_CLIENT_SIMPLETEXT_SET_SHADOWOFFSET_OFFSET UNITYSDK_OFFSET(0x9F7DFF0)
#define RPG_CLIENT_SIMPLETEXT_SET_TEXT_OFFSET UNITYSDK_OFFSET(0x9F7DAF0)
#define RPG_CLIENT_SIMPLETEXT_START_OFFSET UNITYSDK_OFFSET(0x9F7E600)
#define RPG_CLIENT_SIMPLETEXT_UPDATEMESHDATA_OFFSET UNITYSDK_OFFSET(0x9F7FE10)
#define RPG_CLIENT_SIMPLETEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9F819A0)

namespace RPG::Client
{
	inline static constexpr unsigned int SimpleText_TypeDefinitionIndex = 57912;
	...
	public:
		...
		::RPG::Client::TextID Field_5_25; // 0xE0
		::Il2CppArray<::System::Object*>* Field_5_26; // 0xF0
		::UnityEngine::TextGenerationSettings Field_5_27; // 0xF8
		::System::Boolean Field_5_28; // 0x160
		::System::Boolean Field_5_29; // 0x161
		::UnityEngine::Canvas* Field_5_30; // 0x168
		::Il2CppArray<::UnityEngine::Vector3>* Field_5_31; // 0x170
		::Il2CppArray<::UnityEngine::Color32>* Field_5_32; // 0x178
		::Il2CppArray<::UnityEngine::Vector4>* Field_5_33; // 0x180
		::Il2CppArray<::UnityEngine::Vector4>* Field_5_34; // 0x188
		::Il2CppArray<::UnityEngine::Vector4>* Field_5_35; // 0x190
		::System::Int32 Field_5_36; // 0x198
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_SIMPLETEXT_ONTRANSFORMPARENTCHANGED_OFFSET))(this);
		}
		...
		::RPG::Client::SimpleText_Struct_2_FD8E1D4014EE315F_2 GetSDFScale()
		{
			return ((::RPG::Client::SimpleText_Struct_2_FD8E1D4014EE315F_2(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_SIMPLETEXT_GETSDFSCALE_OFFSET))(this);
		}

		::System::Void Method_5_B29205EE7F7B640C()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_SIMPLETEXT_METHOD_5_B29205EE7F7B640C_OFFSET))(this);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_SIMPLETEXT_METHOD_5_51CFFE2AF748ECD7_OFFSET))(this);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_SIMPLETEXT_METHOD_5_1DE6433C25680F9D_OFFSET))(this);
		}

		::System::Void Method_5_89C03AF435ED2C78()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_SIMPLETEXT_METHOD_5_89C03AF435ED2C78_OFFSET))(this);
		}
		...
		::System::Boolean Method_5_0CF83E823A2CCABD()
		{
			return ((::System::Boolean(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_SIMPLETEXT_METHOD_5_0CF83E823A2CCABD_OFFSET))(this);
		}
	};
}
