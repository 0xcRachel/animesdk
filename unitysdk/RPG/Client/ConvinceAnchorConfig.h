...
#define RPG_CLIENT_CONVINCEANCHORCONFIG_METHOD_1_A6ADFA379C021A61_1_OFFSET UNITYSDK_OFFSET(0x8FD6B70)
#define RPG_CLIENT_CONVINCEANCHORCONFIG_METHOD_1_A6ADFA379C021A61_OFFSET UNITYSDK_OFFSET(0x8FD69D0)
#define RPG_CLIENT_CONVINCEANCHORCONFIG_METHOD_1_A9CC58969E11B744_OFFSET UNITYSDK_OFFSET(0x8FD6A30)
#define RPG_CLIENT_CONVINCEANCHORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x8FD6BD0)

namespace RPG::Client
{
	inline static constexpr unsigned int ConvinceAnchorConfig_TypeDefinitionIndex = 48064;
