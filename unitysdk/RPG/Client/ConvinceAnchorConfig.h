...
#define RPG_CLIENT_CONVINCEANCHORCONFIG_METHOD_1_72CA05BE564B70B7_OFFSET UNITYSDK_OFFSET(0x15F2A2C0)
#define RPG_CLIENT_CONVINCEANCHORCONFIG_METHOD_1_A6ADFA379C021A61_1_OFFSET UNITYSDK_OFFSET(0x15F2A3F0)
#define RPG_CLIENT_CONVINCEANCHORCONFIG_METHOD_1_A6ADFA379C021A61_OFFSET UNITYSDK_OFFSET(0x15F2A260)
#define RPG_CLIENT_CONVINCEANCHORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x15F2A450)
