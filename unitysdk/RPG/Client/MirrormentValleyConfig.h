...
#define RPG_CLIENT_MIRRORMENTVALLEYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9718270)

namespace RPG::Client
{
	inline static constexpr unsigned int MirrormentValleyConfig_TypeDefinitionIndex = 47564;
