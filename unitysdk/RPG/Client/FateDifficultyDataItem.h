...
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_GETDIFFTEXTBYLEVEL_OFFSET UNITYSDK_OFFSET(0x9685680)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_GETMAXSCORE_OFFSET UNITYSDK_OFFSET(0x9685880)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_GETMINSCORE_OFFSET UNITYSDK_OFFSET(0x9685C90)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_GETPLAYERTITLEBYLEVEL_OFFSET UNITYSDK_OFFSET(0x96857F0)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_GETSCORERULETEXT_OFFSET UNITYSDK_OFFSET(0x9686040)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_GET_DIFFID_OFFSET UNITYSDK_OFFSET(0x96861B0)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_GET_EFFECTDESC_OFFSET UNITYSDK_OFFSET(0x9686220)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_GET_EFFECTENEMYDESC_OFFSET UNITYSDK_OFFSET(0x9686440)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_GET_FIRSTPASSREWARD_OFFSET UNITYSDK_OFFSET(0x9686660)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_GET_TEXTLEVEL_OFFSET UNITYSDK_OFFSET(0x96861D0)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0x9685C30)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_SET_DIFFID_OFFSET UNITYSDK_OFFSET(0x96861C0)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9685660)
