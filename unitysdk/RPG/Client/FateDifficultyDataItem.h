...
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_GETDIFFTEXTBYLEVEL_OFFSET UNITYSDK_OFFSET(0x178FE6F0)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_GETMAXSCORE_OFFSET UNITYSDK_OFFSET(0x178FE900)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_GETMINSCORE_OFFSET UNITYSDK_OFFSET(0x178FED10)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_GETPLAYERTITLEBYLEVEL_OFFSET UNITYSDK_OFFSET(0x178FE870)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_GETSCORERULETEXT_OFFSET UNITYSDK_OFFSET(0x178FF0C0)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_GET_DIFFID_OFFSET UNITYSDK_OFFSET(0x178FF240)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_GET_EFFECTDESC_OFFSET UNITYSDK_OFFSET(0x178FF2B0)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_GET_EFFECTENEMYDESC_OFFSET UNITYSDK_OFFSET(0x178FF4D0)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_GET_FIRSTPASSREWARD_OFFSET UNITYSDK_OFFSET(0x178FF6F0)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_GET_TEXTLEVEL_OFFSET UNITYSDK_OFFSET(0x178FF260)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0x178FECB0)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_SET_DIFFID_OFFSET UNITYSDK_OFFSET(0x178FF250)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x178FE6D0)
