...
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_GETDIFFTEXTBYLEVEL_OFFSET UNITYSDK_OFFSET(0x91D8690)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_GETMAXSCORE_OFFSET UNITYSDK_OFFSET(0x91D8910)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_GETMINSCORE_OFFSET UNITYSDK_OFFSET(0x91D8D20)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_GETPLAYERTITLEBYLEVEL_OFFSET UNITYSDK_OFFSET(0x91D8880)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_GETSCORERULETEXT_OFFSET UNITYSDK_OFFSET(0x91D90D0)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_GET_DIFFID_OFFSET UNITYSDK_OFFSET(0x91D9220)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_GET_EFFECTDESC_OFFSET UNITYSDK_OFFSET(0x91D9290)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_GET_EFFECTENEMYDESC_OFFSET UNITYSDK_OFFSET(0x91D9480)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_GET_FIRSTPASSREWARD_OFFSET UNITYSDK_OFFSET(0x91D9670)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_GET_TEXTLEVEL_OFFSET UNITYSDK_OFFSET(0x91D9240)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0x91D8CC0)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM_SET_DIFFID_OFFSET UNITYSDK_OFFSET(0x91D9230)
#define RPG_CLIENT_FATEDIFFICULTYDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x91CDD00)

namespace RPG::Client
{
	inline static constexpr unsigned int FateDifficultyDataItem_TypeDefinitionIndex = 50770;
