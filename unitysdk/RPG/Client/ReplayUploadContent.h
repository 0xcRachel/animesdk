...
#define RPG_CLIENT_REPLAYUPLOADCONTENT__CTOR_OFFSET UNITYSDK_OFFSET(0x9DC6120)

namespace RPG::Client
{
	inline static constexpr unsigned int ReplayUploadContent_TypeDefinitionIndex = 48348;
