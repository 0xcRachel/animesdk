...
#define RPG_CLIENT_GRIDFIGHTCYRENEBONUSEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x933D340)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightCyreneBonusEvent_TypeDefinitionIndex = 51828;
