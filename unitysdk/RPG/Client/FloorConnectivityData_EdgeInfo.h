...
#define RPG_CLIENT_FLOORCONNECTIVITYDATA_EDGEINFO_GETFIRSTORDEFAULTCONNECTION_OFFSET UNITYSDK_OFFSET(0x9299880)
#define RPG_CLIENT_FLOORCONNECTIVITYDATA_EDGEINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x929A2E0)
#define RPG_CLIENT_FLOORCONNECTIVITYDATA_EDGEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x9299E90)
#define RPG_CLIENT_FLOORCONNECTIVITYDATA_EDGEINFO___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x929A3E0)

namespace RPG::Client
{
	inline static constexpr unsigned int FloorConnectivityData_EdgeInfo_TypeDefinitionIndex = 51011;
