...
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER___C__DISPLAYCLASS39_0__ASYNCAPPLYTEXTLANGUAGE_B__0_OFFSET UNITYSDK_OFFSET(0x142117F0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER___C__DISPLAYCLASS39_0__ASYNCAPPLYTEXTLANGUAGE_B__1_OFFSET UNITYSDK_OFFSET(0x142119B0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER___C__DISPLAYCLASS39_0__CTOR_OFFSET UNITYSDK_OFFSET(0x14210570)
...
namespace RPG::Client
{
	...
	{
	public:
		::System::String* textLangKey; // 0x10
