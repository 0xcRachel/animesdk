...
#define RPG_CLIENT_MONOCUSTOMROTATEITEM_TICK_OFFSET UNITYSDK_OFFSET(0x978FD20)
#define RPG_CLIENT_MONOCUSTOMROTATEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x978FEA0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoCustomRotateItem_TypeDefinitionIndex = 54613;
