...
#define RPG_CLIENT_PROXYEFFECTPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x9D21540)

namespace RPG::Client
{
	inline static constexpr unsigned int ProxyEffectProp_TypeDefinitionIndex = 47911;
