...
#define RPG_CLIENT_GRIDFIGHTBONUSSRCINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x931DC00)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightBonusSrcInfo_TypeDefinitionIndex = 51158;
