...
#define RPG_CLIENT_RPGQUALITYSETTINGSPRESET__CTOR_OFFSET UNITYSDK_OFFSET(0x9D4C5A0)

namespace RPG::Client
{
	inline static constexpr unsigned int RPGQualitySettingsPreset_TypeDefinitionIndex = 53889;
