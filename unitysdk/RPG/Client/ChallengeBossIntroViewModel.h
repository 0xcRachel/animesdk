...
#define RPG_CLIENT_CHALLENGEBOSSINTROVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x181D2A70)
#define RPG_CLIENT_CHALLENGEBOSSINTROVIEWMODEL_GETSTAGE_OFFSET UNITYSDK_OFFSET(0x181D29F0)
#define RPG_CLIENT_CHALLENGEBOSSINTROVIEWMODEL_GET_CHALLENGEDATA_OFFSET UNITYSDK_OFFSET(0x181D2990)
#define RPG_CLIENT_CHALLENGEBOSSINTROVIEWMODEL_GET_STAGECOUNT_OFFSET UNITYSDK_OFFSET(0x181D29A0)
#define RPG_CLIENT_CHALLENGEBOSSINTROVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x181D2B90)
