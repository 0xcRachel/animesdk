...
#define RPG_CLIENT_CONDITIONCHECKER___C__DISPLAYCLASS17_0__CTOR_OFFSET UNITYSDK_OFFSET(0x8FCBDB0)
#define RPG_CLIENT_CONDITIONCHECKER___C__DISPLAYCLASS17_0__DOCHECKWITHPROMISE_B__0_OFFSET UNITYSDK_OFFSET(0x8FCBE40)

namespace RPG::Client
{
	inline static constexpr unsigned int ConditionChecker___c__DisplayClass17_0_TypeDefinitionIndex = 47435;
