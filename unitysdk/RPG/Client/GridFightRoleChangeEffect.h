...
#define RPG_CLIENT_GRIDFIGHTROLECHANGEEFFECT_METHOD_6_7E0102A7D81125F5_OFFSET UNITYSDK_OFFSET(0x19953530)
#define RPG_CLIENT_GRIDFIGHTROLECHANGEEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0x19953270)
#define RPG_CLIENT_GRIDFIGHTROLECHANGEEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0x19953400)
#define RPG_CLIENT_GRIDFIGHTROLECHANGEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x19953620)
#define RPG_CLIENT_GRIDFIGHTROLECHANGEEFFECT___IFIXBASEPROXY_ONCREATE_OFFSET UNITYSDK_OFFSET(0x19953630)
