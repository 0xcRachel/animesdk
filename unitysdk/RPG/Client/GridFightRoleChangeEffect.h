...
#define RPG_CLIENT_GRIDFIGHTROLECHANGEEFFECT_METHOD_6_B44C98182D03F795_OFFSET UNITYSDK_OFFSET(0x1811C580)
#define RPG_CLIENT_GRIDFIGHTROLECHANGEEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0x1811C260)
#define RPG_CLIENT_GRIDFIGHTROLECHANGEEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0x1811C440)
#define RPG_CLIENT_GRIDFIGHTROLECHANGEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1811C660)
#define RPG_CLIENT_GRIDFIGHTROLECHANGEEFFECT___IFIXBASEPROXY_ONCREATE_OFFSET UNITYSDK_OFFSET(0x1811C670)
