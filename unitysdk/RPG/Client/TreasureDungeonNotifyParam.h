...
#define RPG_CLIENT_TREASUREDUNGEONNOTIFYPARAM_CLEARTUTORIAL_OFFSET UNITYSDK_OFFSET(0x17FD0EA0)
#define RPG_CLIENT_TREASUREDUNGEONNOTIFYPARAM_CLEAR_OFFSET UNITYSDK_OFFSET(0x17FD0D90)
#define RPG_CLIENT_TREASUREDUNGEONNOTIFYPARAM_GET_ISGETCHEST_OFFSET UNITYSDK_OFFSET(0x17FD0F10)
#define RPG_CLIENT_TREASUREDUNGEONNOTIFYPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x17FD0F20)
...
namespace RPG::Client
{
	...
	{
	public:
		::System::Collections::Generic::List_1<::System::UInt32>* EmptyChangedGrids; // 0x10
		::System::Collections::Generic::List_1<::Class_1_1CBA230307F9C289_68*>* RecordData; // 0x18
		...
		::System::Boolean IsGetNewFloorBuff; // 0x42
		::System::Boolean IsFloorBuffReplaced; // 0x43
		::System::UInt32 GotChestGridIndex; // 0x44
		::System::Boolean IsItemUpdated; // 0x48
		::System::Boolean IsExplorePointUpdated; // 0x49
		::System::Boolean IsMapUpdated; // 0x4A
		::System::Boolean IsTeamUpdated; // 0x4B
		::System::Boolean IsGetUltraItem; // 0x4C
		::System::Boolean IsGetNewEnvBuff; // 0x4D
