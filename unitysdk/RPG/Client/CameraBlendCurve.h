...
#define RPG_CLIENT_CAMERABLENDCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x8E53CC0)

namespace RPG::Client
{
	inline static constexpr unsigned int CameraBlendCurve_TypeDefinitionIndex = 55269;
