...
#define RPG_CLIENT_PHOTOGRAPHSHOTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x9A824C0)

namespace RPG::Client
{
	inline static constexpr unsigned int PhotoGraphShotParam_TypeDefinitionIndex = 48300;
