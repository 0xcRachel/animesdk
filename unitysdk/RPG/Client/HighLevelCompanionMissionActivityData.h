...
#define RPG_CLIENT_HIGHLEVELCOMPANIONMISSIONACTIVITYDATA_ISEXTRACONDSATISFY_OFFSET UNITYSDK_OFFSET(0x94B8F80)
#define RPG_CLIENT_HIGHLEVELCOMPANIONMISSIONACTIVITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x94B8F60)
#define RPG_CLIENT_HIGHLEVELCOMPANIONMISSIONACTIVITYDATA___IFIXBASEPROXY_ISEXTRACONDSATISFY_OFFSET UNITYSDK_OFFSET(0x94B9110)

namespace RPG::Client
{
	inline static constexpr unsigned int HighLevelCompanionMissionActivityData_TypeDefinitionIndex = 48865;
