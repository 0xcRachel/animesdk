...
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8FECFE0)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_GET_CURVE_OFFSET UNITYSDK_OFFSET(0x8FEC1F0)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_GET_DISTANCE_OFFSET UNITYSDK_OFFSET(0x8FE7220)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_GET_GRAPH_OFFSET UNITYSDK_OFFSET(0x8FEC1D0)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_GET_MATH_OFFSET UNITYSDK_OFFSET(0x8FEC200)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x8FEC1E0)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_0FDE67E8BCF7203D_OFFSET UNITYSDK_OFFSET(0x8FEAFF0)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_1ED56D19798D11C4_OFFSET UNITYSDK_OFFSET(0x8FEC8A0)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_2C304A99BB635D34_OFFSET UNITYSDK_OFFSET(0x8FECB20)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_3C24F6FFDD40F9E9_OFFSET UNITYSDK_OFFSET(0x8FEC630)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_6D4EED649DB90654_OFFSET UNITYSDK_OFFSET(0x8FE6A50)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_74AA1BF2A29001A3_OFFSET UNITYSDK_OFFSET(0x8FEC770)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_8C82C81F45965A30_OFFSET UNITYSDK_OFFSET(0x8FED020)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_95DEB009F6EC8741_OFFSET UNITYSDK_OFFSET(0x8FEC4F0)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_B7447ED1D1F41826_OFFSET UNITYSDK_OFFSET(0x8FE9E20)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_BEA6D8CD8A871E29_OFFSET UNITYSDK_OFFSET(0x8FEC9F0)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_E467A6121B51953B_OFFSET UNITYSDK_OFFSET(0x8FE6B40)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8FECFA0)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE__CTOR_OFFSET UNITYSDK_OFFSET(0x8FEC210)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8FED550)

namespace RPG::Client
{
	inline static constexpr unsigned int CurveUndirectedEdge_TypeDefinitionIndex = 54429;
