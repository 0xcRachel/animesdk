...
#define RPG_CLIENT_EFFECT_INSTANCEDATAGPUPARTICLES_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x90B3BC0)
#define RPG_CLIENT_EFFECT_INSTANCEDATAGPUPARTICLES__CTOR_OFFSET UNITYSDK_OFFSET(0x90B3C10)
#define RPG_CLIENT_EFFECT_INSTANCEDATAGPUPARTICLES___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x90B3C20)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_InstanceDataGPUParticles_TypeDefinitionIndex = 56270;
