...
#define RPG_CLIENT_ALLEYCONSTVALUE_INIT_OFFSET UNITYSDK_OFFSET(0x153082D0)
#define RPG_CLIENT_ALLEYCONSTVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x153089F0)
