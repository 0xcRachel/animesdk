...
#define RPG_CLIENT_ALLEYCONSTVALUE_INIT_OFFSET UNITYSDK_OFFSET(0x16E49A90)
#define RPG_CLIENT_ALLEYCONSTVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x16E4A200)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 AlleyOrderBasicProfitRatio; // 0x34
		::System::UInt32 TutorialOrderID; // 0x38
		::System::UInt32 TotalOrderNum; // 0x3C
