...
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_STAGEHINTSTATE___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x174CFA80)
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_STAGEHINTSTATE___C__CTOR_OFFSET UNITYSDK_OFFSET(0x174CFAC0)
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_STAGEHINTSTATE___C__ONENTER_B__0_0_OFFSET UNITYSDK_OFFSET(0x174CFAD0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::RPG::Client::GridFightFlowDirector_StageHintState___c**)Il2CppClass::FromTypeDefinitionIndex(GridFightFlowDirector_StageHintState___c_TypeDefinitionIndex)->GetStaticField(0x24B10);
		}
		static ::System::Action** StaticGet___9__0_0()
		{
			return (::System::Action**)Il2CppClass::FromTypeDefinitionIndex(GridFightFlowDirector_StageHintState___c_TypeDefinitionIndex)->GetStaticField(0x24B18);
		}
