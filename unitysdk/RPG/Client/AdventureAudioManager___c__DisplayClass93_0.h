...
#define RPG_CLIENT_ADVENTUREAUDIOMANAGER___C__DISPLAYCLASS93_0__CTOR_OFFSET UNITYSDK_OFFSET(0x8BE71D0)
#define RPG_CLIENT_ADVENTUREAUDIOMANAGER___C__DISPLAYCLASS93_0___ONPLAYERLOCKNEWTARGET_B__0_OFFSET UNITYSDK_OFFSET(0x8BE8680)

namespace RPG::Client
{
	inline static constexpr unsigned int AdventureAudioManager___c__DisplayClass93_0_TypeDefinitionIndex = 47899;
