...
#define RPG_CLIENT_ITEMCOSTCALCULATOR___C__DISPLAYCLASS18_0__CTOR_OFFSET UNITYSDK_OFFSET(0x997ADC0)
#define RPG_CLIENT_ITEMCOSTCALCULATOR___C__DISPLAYCLASS18_0__GETITEMNEEDCOUNT_B__0_OFFSET UNITYSDK_OFFSET(0x997B8F0)
#define RPG_CLIENT_ITEMCOSTCALCULATOR___C__DISPLAYCLASS18_0__GETITEMNEEDCOUNT_B__1_OFFSET UNITYSDK_OFFSET(0x997B8D0)
