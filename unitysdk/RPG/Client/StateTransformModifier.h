...
#define RPG_CLIENT_STATETRANSFORMMODIFIER_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0xA4EA910)
#define RPG_CLIENT_STATETRANSFORMMODIFIER_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA4EAA50)
#define RPG_CLIENT_STATETRANSFORMMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0xA4EAB90)
#define RPG_CLIENT_STATETRANSFORMMODIFIER___IFIXBASEPROXY_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0xA4EABB0)
#define RPG_CLIENT_STATETRANSFORMMODIFIER___IFIXBASEPROXY_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA4EABC0)
