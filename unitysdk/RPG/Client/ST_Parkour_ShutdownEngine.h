...
#define RPG_CLIENT_ST_PARKOUR_SHUTDOWNENGINE_METHOD_4_FB6FA5B354632C38_OFFSET UNITYSDK_OFFSET(0x18850590)
#define RPG_CLIENT_ST_PARKOUR_SHUTDOWNENGINE_METHOD_4_FBB2A37C10765CE7_OFFSET UNITYSDK_OFFSET(0x18850700)
#define RPG_CLIENT_ST_PARKOUR_SHUTDOWNENGINE__CTOR_OFFSET UNITYSDK_OFFSET(0x188506B0)
