...
#define RPG_CLIENT_RESMANAGERCONFIRMDIALOGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x131D6630)

namespace RPG::Client
{
	inline static constexpr unsigned int ResManagerConfirmDialogData_TypeDefinitionIndex = 66997;
	...
	public:
		...
		::RPG::Client::TextID OKBtnLabel; // 0x30
		::RPG::Client::TextID CancelBtnLabel; // 0x40
