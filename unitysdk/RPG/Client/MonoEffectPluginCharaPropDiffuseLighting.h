...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDIFFUSELIGHTING_INIT_OFFSET UNITYSDK_OFFSET(0x97D8700)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDIFFUSELIGHTING_UNINIT_OFFSET UNITYSDK_OFFSET(0x97D89E0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDIFFUSELIGHTING_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x97D87A0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDIFFUSELIGHTING__CTOR_OFFSET UNITYSDK_OFFSET(0x97D8A80)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDIFFUSELIGHTING___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x97D8AA0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDIFFUSELIGHTING___IFIXBASEPROXY_UNINIT_OFFSET UNITYSDK_OFFSET(0x97D8AB0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropDiffuseLighting_TypeDefinitionIndex = 55665;
