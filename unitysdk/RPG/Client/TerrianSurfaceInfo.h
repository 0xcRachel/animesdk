...
#define RPG_CLIENT_TERRIANSURFACEINFO_GET_ENABLESEALEVELALTITUDE_OFFSET UNITYSDK_OFFSET(0x141FD7A0)
#define RPG_CLIENT_TERRIANSURFACEINFO_GET_ISWATERSURFACE_OFFSET UNITYSDK_OFFSET(0x141FD830)
#define RPG_CLIENT_TERRIANSURFACEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x141FD890)
