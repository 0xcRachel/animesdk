...
#define RPG_CLIENT_MONOANIMATORSTATESIMPLEEVENT_TIMEDEVENT_METHOD_2_183DCE814B2CC19A_OFFSET UNITYSDK_OFFSET(0x152BBC10)
#define RPG_CLIENT_MONOANIMATORSTATESIMPLEEVENT_TIMEDEVENT_METHOD_2_44EEB2BE4941EFE3_OFFSET UNITYSDK_OFFSET(0x152BBAF0)
#define RPG_CLIENT_MONOANIMATORSTATESIMPLEEVENT_TIMEDEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x152BBD10)
