...
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17B16EA0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_DISSOLVETO_OFFSET UNITYSDK_OFFSET(0x17B16FA0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_GETCHARWPOS_OFFSET UNITYSDK_OFFSET(0x17B16600)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_GETCURRENTDISSOLVERATE_OFFSET UNITYSDK_OFFSET(0x17B17730)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_LATETICK_OFFSET UNITYSDK_OFFSET(0x17B175B0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_METHOD_6_0CC4BC19C602BCD0_OFFSET UNITYSDK_OFFSET(0x17B169B0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_METHOD_6_3363D89E03193669_OFFSET UNITYSDK_OFFSET(0x17B176D0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_METHOD_6_442C4EFC0D686CFB_1_OFFSET UNITYSDK_OFFSET(0x17B17680)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_METHOD_6_442C4EFC0D686CFB_OFFSET UNITYSDK_OFFSET(0x17B17630)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_METHOD_6_7AEA4B2B25797605_OFFSET UNITYSDK_OFFSET(0x17B16C40)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_METHOD_6_A6CE5DAA2387E1E2_OFFSET UNITYSDK_OFFSET(0x17B16D60)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_METHOD_6_C561FF611C07A44C_OFFSET UNITYSDK_OFFSET(0x17B16B40)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_METHOD_6_D17B49CABC597E3E_OFFSET UNITYSDK_OFFSET(0x17B17110)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17B173E0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_ONREFRESHMATERIALS_OFFSET UNITYSDK_OFFSET(0x17B17500)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_RESET_OFFSET UNITYSDK_OFFSET(0x17B166E0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_SETCHARACTEROUTLINESCALE_OFFSET UNITYSDK_OFFSET(0x17B171A0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_SETCHARHEIGHT_OFFSET UNITYSDK_OFFSET(0x17B16400)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_SETCHARWPOS_OFFSET UNITYSDK_OFFSET(0x17B164A0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_SETSCENECONTRASTENABLE_OFFSET UNITYSDK_OFFSET(0x17B16370)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_SETUPDATECHARWPOSBYSMRBOUNDS_OFFSET UNITYSDK_OFFSET(0x17B16680)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_START_OFFSET UNITYSDK_OFFSET(0x17B172B0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION__CCTOR_OFFSET UNITYSDK_OFFSET(0x17B177D0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x17B17780)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17B17830)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION___IFIXBASEPROXY_LATETICK_OFFSET UNITYSDK_OFFSET(0x17B17850)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION___IFIXBASEPROXY_ONREFRESHMATERIALS_OFFSET UNITYSDK_OFFSET(0x17B17840)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION___IFIXBASEPROXY_RESET_OFFSET UNITYSDK_OFFSET(0x17B17820)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CharacterShaderPropertyTransition_TypeDefinitionIndex)->GetStaticField(0x13880);
		}
		static ::System::Int32* StaticGet_PropertyIDCharaWorldSpaceOffset()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CharacterShaderPropertyTransition_TypeDefinitionIndex)->GetStaticField(0x13884);
		}
		static ::System::Int32* StaticGet_PropertyIDCharHeight()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CharacterShaderPropertyTransition_TypeDefinitionIndex)->GetStaticField(0x13888);
		}
