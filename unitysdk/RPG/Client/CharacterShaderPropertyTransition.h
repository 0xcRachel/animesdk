...
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x93196E0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_DISSOLVETO_OFFSET UNITYSDK_OFFSET(0x93197D0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_GETCHARWPOS_OFFSET UNITYSDK_OFFSET(0x9318E60)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_GETCURRENTDISSOLVERATE_OFFSET UNITYSDK_OFFSET(0x931A020)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_LATETICK_OFFSET UNITYSDK_OFFSET(0x9319EA0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_METHOD_6_3363D89E03193669_OFFSET UNITYSDK_OFFSET(0x9319FC0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_METHOD_6_442C4EFC0D686CFB_1_OFFSET UNITYSDK_OFFSET(0x9319F70)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_METHOD_6_442C4EFC0D686CFB_OFFSET UNITYSDK_OFFSET(0x9319F20)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_METHOD_6_4AADAF19CDCB660E_1_OFFSET UNITYSDK_OFFSET(0x93194B0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_METHOD_6_4AADAF19CDCB660E_OFFSET UNITYSDK_OFFSET(0x93195C0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_METHOD_6_C561FF611C07A44C_OFFSET UNITYSDK_OFFSET(0x93193B0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_METHOD_6_D17B49CABC597E3E_OFFSET UNITYSDK_OFFSET(0x9319900)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_METHOD_6_DDA8A2337932DF10_OFFSET UNITYSDK_OFFSET(0x9319230)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9319C40)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_ONREFRESHMATERIALS_OFFSET UNITYSDK_OFFSET(0x9319D20)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_RESET_OFFSET UNITYSDK_OFFSET(0x9318F40)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_SETCHARACTEROUTLINESCALE_OFFSET UNITYSDK_OFFSET(0x9319990)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_SETCHARHEIGHT_OFFSET UNITYSDK_OFFSET(0x9318C60)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_SETCHARWPOS_OFFSET UNITYSDK_OFFSET(0x9318D00)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_SETSCENECONTRASTENABLE_OFFSET UNITYSDK_OFFSET(0x9318BD0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_SETUPDATECHARWPOSBYSMRBOUNDS_OFFSET UNITYSDK_OFFSET(0x9318EE0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_START_OFFSET UNITYSDK_OFFSET(0x9319B40)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION__CCTOR_OFFSET UNITYSDK_OFFSET(0x931A0C0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x931A070)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x931A120)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION___IFIXBASEPROXY_LATETICK_OFFSET UNITYSDK_OFFSET(0x931A140)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION___IFIXBASEPROXY_ONREFRESHMATERIALS_OFFSET UNITYSDK_OFFSET(0x931A130)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION___IFIXBASEPROXY_RESET_OFFSET UNITYSDK_OFFSET(0x931A110)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CharacterShaderPropertyTransition_TypeDefinitionIndex)->GetStaticField(0xECE0);
		}
		static ::System::Int32* StaticGet_PropertyIDIsMonster()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CharacterShaderPropertyTransition_TypeDefinitionIndex)->GetStaticField(0xECE4);
		}
		static ::System::Int32* StaticGet_PropertyIDCharHeight()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CharacterShaderPropertyTransition_TypeDefinitionIndex)->GetStaticField(0xECE8);
		}
