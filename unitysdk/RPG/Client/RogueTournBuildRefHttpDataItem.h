...
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_CLEAR_OFFSET UNITYSDK_OFFSET(0x9E55C50)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9E55D90)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_APPLIEDCOUNTFORSORT_OFFSET UNITYSDK_OFFSET(0x9E56360)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_AUTHOR_OFFSET UNITYSDK_OFFSET(0x9E56100)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_BUILDREFID_OFFSET UNITYSDK_OFFSET(0x9E55FB0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_ESSENTIALFORMULAS_OFFSET UNITYSDK_OFFSET(0x9E561A0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_ESSENTIALHEXMIRACLES_OFFSET UNITYSDK_OFFSET(0x9E56260)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_FAVORITECOUNTFORSORT_OFFSET UNITYSDK_OFFSET(0x9E56380)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_GAMEMAJORVERSIONFORSORT_OFFSET UNITYSDK_OFFSET(0x9E563E0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_GAMEMINORVERSIONFORSORT_OFFSET UNITYSDK_OFFSET(0x9E56400)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_ISLIKE_OFFSET UNITYSDK_OFFSET(0x9E56320)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_LANGUAGE_OFFSET UNITYSDK_OFFSET(0x9E56120)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_LIKECOUNTFORSORT_OFFSET UNITYSDK_OFFSET(0x9E563A0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_LIKECOUNT_OFFSET UNITYSDK_OFFSET(0x9E56340)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_OPTIONALFORMULAS_OFFSET UNITYSDK_OFFSET(0x9E56200)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_OPTIONALHEXMIRACLES_OFFSET UNITYSDK_OFFSET(0x9E562C0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_TEAMS_OFFSET UNITYSDK_OFFSET(0x9E56140)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_TITLE_OFFSET UNITYSDK_OFFSET(0x9E560E0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_UNIONINDEX_OFFSET UNITYSDK_OFFSET(0x9E55FE0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_WEIGHTFORSORT_OFFSET UNITYSDK_OFFSET(0x9E563C0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SETCONTENT_OFFSET UNITYSDK_OFFSET(0x9E55E00)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_APPLIEDCOUNTFORSORT_OFFSET UNITYSDK_OFFSET(0x9E56370)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_AUTHOR_OFFSET UNITYSDK_OFFSET(0x9E56110)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_BUILDREFID_OFFSET UNITYSDK_OFFSET(0x9E55FD0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_FAVORITECOUNTFORSORT_OFFSET UNITYSDK_OFFSET(0x9E56390)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_GAMEMAJORVERSIONFORSORT_OFFSET UNITYSDK_OFFSET(0x9E563F0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_GAMEMINORVERSIONFORSORT_OFFSET UNITYSDK_OFFSET(0x9E56410)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_ISLIKE_OFFSET UNITYSDK_OFFSET(0x9E56330)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_LANGUAGE_OFFSET UNITYSDK_OFFSET(0x9E56130)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_LIKECOUNTFORSORT_OFFSET UNITYSDK_OFFSET(0x9E563B0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_LIKECOUNT_OFFSET UNITYSDK_OFFSET(0x9E56350)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_TITLE_OFFSET UNITYSDK_OFFSET(0x9E560F0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_WEIGHTFORSORT_OFFSET UNITYSDK_OFFSET(0x9E563D0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SYNCINTERACTDATA_OFFSET UNITYSDK_OFFSET(0x9E55E50)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SYNCISLIKE_OFFSET UNITYSDK_OFFSET(0x9E55EB0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9E55940)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9E55930)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9E56420)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournBuildRefHttpDataItem_TypeDefinitionIndex = 53662;
	...
	public:
		...
		::System::UInt32 _GameMajorVersionForSort_k__BackingField; // 0x68
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_EA34684135EFC9DB*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SETCONTENT_OFFSET))(this, content);
		}
		...
		{
			return ((::System::Collections::Generic::IList_1<::RPG::Client::RogueMiracleData*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_ESSENTIALHEXMIRACLES_OFFSET))(this);
		}

		::System::Collections::Generic::IList_1<::RPG::Client::RogueMiracleData*>* get_OptionalHexMiracles()
		{
			return ((::System::Collections::Generic::IList_1<::RPG::Client::RogueMiracleData*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_OPTIONALHEXMIRACLES_OFFSET))(this);
		}
