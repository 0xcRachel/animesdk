...
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_CLEAR_OFFSET UNITYSDK_OFFSET(0x16EFCA70)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16EFCBC0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_APPLIEDCOUNTFORSORT_OFFSET UNITYSDK_OFFSET(0x16EFD230)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_AUTHOR_OFFSET UNITYSDK_OFFSET(0x16EFCFD0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_BUILDREFID_OFFSET UNITYSDK_OFFSET(0x16EFCDE0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_ESSENTIALFORMULAS_OFFSET UNITYSDK_OFFSET(0x16EFD070)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_ESSENTIALHEXMIRACLES_OFFSET UNITYSDK_OFFSET(0x16EFD130)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_FAVORITECOUNTFORSORT_OFFSET UNITYSDK_OFFSET(0x16EFD250)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_GAMEMAJORVERSIONFORSORT_OFFSET UNITYSDK_OFFSET(0x16EFD2B0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_GAMEMINORVERSIONFORSORT_OFFSET UNITYSDK_OFFSET(0x16EFD2D0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_ISLIKE_OFFSET UNITYSDK_OFFSET(0x16EFD1F0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_LANGUAGE_OFFSET UNITYSDK_OFFSET(0x16EFCFF0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_LIKECOUNTFORSORT_OFFSET UNITYSDK_OFFSET(0x16EFD270)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_LIKECOUNT_OFFSET UNITYSDK_OFFSET(0x16EFD210)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_OPTIONALFORMULAS_OFFSET UNITYSDK_OFFSET(0x16EFD0D0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_OPTIONALHEXMIRACLES_OFFSET UNITYSDK_OFFSET(0x16EFD190)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_TEAMS_OFFSET UNITYSDK_OFFSET(0x16EFD010)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_TITLE_OFFSET UNITYSDK_OFFSET(0x16EFCFB0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_UNIONINDEX_OFFSET UNITYSDK_OFFSET(0x16EFCE10)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_WEIGHTFORSORT_OFFSET UNITYSDK_OFFSET(0x16EFD290)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SETCONTENT_OFFSET UNITYSDK_OFFSET(0x16EFCC30)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_APPLIEDCOUNTFORSORT_OFFSET UNITYSDK_OFFSET(0x16EFD240)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_AUTHOR_OFFSET UNITYSDK_OFFSET(0x16EFCFE0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_BUILDREFID_OFFSET UNITYSDK_OFFSET(0x16EFCE00)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_FAVORITECOUNTFORSORT_OFFSET UNITYSDK_OFFSET(0x16EFD260)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_GAMEMAJORVERSIONFORSORT_OFFSET UNITYSDK_OFFSET(0x16EFD2C0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_GAMEMINORVERSIONFORSORT_OFFSET UNITYSDK_OFFSET(0x16EFD2E0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_ISLIKE_OFFSET UNITYSDK_OFFSET(0x16EFD200)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_LANGUAGE_OFFSET UNITYSDK_OFFSET(0x16EFD000)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_LIKECOUNTFORSORT_OFFSET UNITYSDK_OFFSET(0x16EFD280)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_LIKECOUNT_OFFSET UNITYSDK_OFFSET(0x16EFD220)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_TITLE_OFFSET UNITYSDK_OFFSET(0x16EFCFC0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_WEIGHTFORSORT_OFFSET UNITYSDK_OFFSET(0x16EFD2A0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SYNCINTERACTDATA_OFFSET UNITYSDK_OFFSET(0x16EFCC80)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SYNCISLIKE_OFFSET UNITYSDK_OFFSET(0x16EFCCE0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_TOSTRING_OFFSET UNITYSDK_OFFSET(0x16EFC760)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x16EFC750)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x16EFD2F0)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Boolean _IsLike_k__BackingField; // 0x38
		::RPG::Client::MongoObjectId _BuildRefID_k__BackingField; // 0x3C
		::System::Double _WeightForSort_k__BackingField; // 0x48
		::System::UInt64 _LikeCount_k__BackingField; // 0x50
		::System::UInt64 _FavoriteCountForSort_k__BackingField; // 0x58
		::System::UInt64 _AppliedCountForSort_k__BackingField; // 0x60
		::System::UInt32 _GameMinorVersionForSort_k__BackingField; // 0x68
		::System::UInt32 _GameMajorVersionForSort_k__BackingField; // 0x6C
