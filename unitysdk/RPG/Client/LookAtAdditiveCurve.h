...
#define RPG_CLIENT_LOOKATADDITIVECURVE_CLEAR_OFFSET UNITYSDK_OFFSET(0x9590BD0)
#define RPG_CLIENT_LOOKATADDITIVECURVE_GET_BLEND_OFFSET UNITYSDK_OFFSET(0x9590100)
#define RPG_CLIENT_LOOKATADDITIVECURVE_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x9590240)
#define RPG_CLIENT_LOOKATADDITIVECURVE_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x9590050)
#define RPG_CLIENT_LOOKATADDITIVECURVE_GET_ISBLENDOUT_OFFSET UNITYSDK_OFFSET(0x9590270)
#define RPG_CLIENT_LOOKATADDITIVECURVE_GET_STOPTRACE_OFFSET UNITYSDK_OFFSET(0x9590250)
#define RPG_CLIENT_LOOKATADDITIVECURVE_GET_USESPINENUM_OFFSET UNITYSDK_OFFSET(0x95902F0)
#define RPG_CLIENT_LOOKATADDITIVECURVE_METHOD_1_039A661B725702C7_OFFSET UNITYSDK_OFFSET(0x95903E0)
#define RPG_CLIENT_LOOKATADDITIVECURVE_METHOD_1_4132D1D61E73C31C_OFFSET UNITYSDK_OFFSET(0x9590A20)
#define RPG_CLIENT_LOOKATADDITIVECURVE_METHOD_1_51284674B86D32D0_OFFSET UNITYSDK_OFFSET(0x9590350)
#define RPG_CLIENT_LOOKATADDITIVECURVE_METHOD_1_76779914A04D87DB_OFFSET UNITYSDK_OFFSET(0x9590110)
#define RPG_CLIENT_LOOKATADDITIVECURVE_METHOD_1_8FAD57395F26ACC4_OFFSET UNITYSDK_OFFSET(0x95905D0)
#define RPG_CLIENT_LOOKATADDITIVECURVE_METHOD_1_9E5102607DED4FAE_OFFSET UNITYSDK_OFFSET(0x9590650)
#define RPG_CLIENT_LOOKATADDITIVECURVE_METHOD_1_D0C32DC65A00E8B1_OFFSET UNITYSDK_OFFSET(0x9590D20)
#define RPG_CLIENT_LOOKATADDITIVECURVE_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x95900F0)
#define RPG_CLIENT_LOOKATADDITIVECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x9590310)

namespace RPG::Client
{
	inline static constexpr unsigned int LookAtAdditiveCurve_TypeDefinitionIndex = 54348;
