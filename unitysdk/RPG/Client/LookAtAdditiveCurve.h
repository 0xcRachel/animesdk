...
#define RPG_CLIENT_LOOKATADDITIVECURVE_CLEAR_OFFSET UNITYSDK_OFFSET(0x16940F60)
#define RPG_CLIENT_LOOKATADDITIVECURVE_GET_BLEND_OFFSET UNITYSDK_OFFSET(0x16940490)
#define RPG_CLIENT_LOOKATADDITIVECURVE_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x169405D0)
#define RPG_CLIENT_LOOKATADDITIVECURVE_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x169403E0)
#define RPG_CLIENT_LOOKATADDITIVECURVE_GET_ISBLENDOUT_OFFSET UNITYSDK_OFFSET(0x16940600)
#define RPG_CLIENT_LOOKATADDITIVECURVE_GET_STOPTRACE_OFFSET UNITYSDK_OFFSET(0x169405E0)
#define RPG_CLIENT_LOOKATADDITIVECURVE_GET_USESPINENUM_OFFSET UNITYSDK_OFFSET(0x16940680)
#define RPG_CLIENT_LOOKATADDITIVECURVE_METHOD_1_039A661B725702C7_OFFSET UNITYSDK_OFFSET(0x16940770)
#define RPG_CLIENT_LOOKATADDITIVECURVE_METHOD_1_4132D1D61E73C31C_OFFSET UNITYSDK_OFFSET(0x16940DB0)
#define RPG_CLIENT_LOOKATADDITIVECURVE_METHOD_1_51284674B86D32D0_OFFSET UNITYSDK_OFFSET(0x169406E0)
#define RPG_CLIENT_LOOKATADDITIVECURVE_METHOD_1_76779914A04D87DB_OFFSET UNITYSDK_OFFSET(0x169404A0)
#define RPG_CLIENT_LOOKATADDITIVECURVE_METHOD_1_8FAD57395F26ACC4_OFFSET UNITYSDK_OFFSET(0x16940960)
#define RPG_CLIENT_LOOKATADDITIVECURVE_METHOD_1_9E5102607DED4FAE_OFFSET UNITYSDK_OFFSET(0x169409E0)
#define RPG_CLIENT_LOOKATADDITIVECURVE_METHOD_1_D0C32DC65A00E8B1_OFFSET UNITYSDK_OFFSET(0x169410B0)
#define RPG_CLIENT_LOOKATADDITIVECURVE_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x16940480)
#define RPG_CLIENT_LOOKATADDITIVECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x169406A0)
