...
#define RPG_CLIENT_LOOKATADDITIVECURVE_CLEAR_OFFSET UNITYSDK_OFFSET(0x9A6B840)
#define RPG_CLIENT_LOOKATADDITIVECURVE_GET_BLEND_OFFSET UNITYSDK_OFFSET(0x9A6AD70)
#define RPG_CLIENT_LOOKATADDITIVECURVE_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x9A6AEB0)
#define RPG_CLIENT_LOOKATADDITIVECURVE_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x9A6ACC0)
#define RPG_CLIENT_LOOKATADDITIVECURVE_GET_ISBLENDOUT_OFFSET UNITYSDK_OFFSET(0x9A6AEE0)
#define RPG_CLIENT_LOOKATADDITIVECURVE_GET_STOPTRACE_OFFSET UNITYSDK_OFFSET(0x9A6AEC0)
#define RPG_CLIENT_LOOKATADDITIVECURVE_GET_USESPINENUM_OFFSET UNITYSDK_OFFSET(0x9A6AF60)
#define RPG_CLIENT_LOOKATADDITIVECURVE_METHOD_1_039A661B725702C7_OFFSET UNITYSDK_OFFSET(0x9A6B050)
#define RPG_CLIENT_LOOKATADDITIVECURVE_METHOD_1_4132D1D61E73C31C_OFFSET UNITYSDK_OFFSET(0x9A6B690)
#define RPG_CLIENT_LOOKATADDITIVECURVE_METHOD_1_51284674B86D32D0_OFFSET UNITYSDK_OFFSET(0x9A6AFC0)
#define RPG_CLIENT_LOOKATADDITIVECURVE_METHOD_1_76779914A04D87DB_OFFSET UNITYSDK_OFFSET(0x9A6AD80)
#define RPG_CLIENT_LOOKATADDITIVECURVE_METHOD_1_8FAD57395F26ACC4_OFFSET UNITYSDK_OFFSET(0x9A6B240)
#define RPG_CLIENT_LOOKATADDITIVECURVE_METHOD_1_9E5102607DED4FAE_OFFSET UNITYSDK_OFFSET(0x9A6B2C0)
#define RPG_CLIENT_LOOKATADDITIVECURVE_METHOD_1_D0C32DC65A00E8B1_OFFSET UNITYSDK_OFFSET(0x9A6B990)
#define RPG_CLIENT_LOOKATADDITIVECURVE_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x9A6AD60)
#define RPG_CLIENT_LOOKATADDITIVECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x9A6AF80)
