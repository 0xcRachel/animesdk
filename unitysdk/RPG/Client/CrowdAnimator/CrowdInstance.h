...
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_GETCLIPLENGTH_OFFSET UNITYSDK_OFFSET(0x15BFF710)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_GET_CURRENTPLAYINGCLIPINDEX_OFFSET UNITYSDK_OFFSET(0x15BFF7D0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_GET_CURRENTPLAYINGCLIPLENGTH_OFFSET UNITYSDK_OFFSET(0x15BFF9B0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_GET_CUSTOMDATA_OFFSET UNITYSDK_OFFSET(0x15BFE110)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_GET_INSTANCED_OFFSET UNITYSDK_OFFSET(0x15BFDCC0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_GET_VISIBLESTATE_OFFSET UNITYSDK_OFFSET(0x15BFDBE0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_METHOD_5_03E2B9212B4B6EAF_OFFSET UNITYSDK_OFFSET(0x15BFE390)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_METHOD_5_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x15BFE350)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_METHOD_5_ADF4AD3331B4D7AD_OFFSET UNITYSDK_OFFSET(0x15BFEE20)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x15BFEE70)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_METHOD_5_E9A575D18A0748D9_OFFSET UNITYSDK_OFFSET(0x15BFEDD0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_METHOD_5_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0x15BFE310)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x15BFED80)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0x15BFEEC0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_REGISTER_OFFSET UNITYSDK_OFFSET(0x15BFE3E0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_SET_CUSTOMDATA_OFFSET UNITYSDK_OFFSET(0x15BFE120)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_SET_VISIBLESTATE_OFFSET UNITYSDK_OFFSET(0x15BFDBF0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_UNREGISTER_OFFSET UNITYSDK_OFFSET(0x15BFE810)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x15BFFB60)

namespace RPG::Client::CrowdAnimator
{
	inline static constexpr unsigned int CrowdInstance_TypeDefinitionIndex = 67853;
