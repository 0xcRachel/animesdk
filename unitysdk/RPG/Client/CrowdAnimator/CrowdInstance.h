...
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_GETCLIPLENGTH_OFFSET UNITYSDK_OFFSET(0x94366B0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_GET_CURRENTPLAYINGCLIPINDEX_OFFSET UNITYSDK_OFFSET(0x9436770)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_GET_CURRENTPLAYINGCLIPLENGTH_OFFSET UNITYSDK_OFFSET(0x9436950)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_GET_CUSTOMDATA_OFFSET UNITYSDK_OFFSET(0x94350B0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_GET_INSTANCED_OFFSET UNITYSDK_OFFSET(0x9434C60)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_GET_VISIBLESTATE_OFFSET UNITYSDK_OFFSET(0x9434B80)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_METHOD_5_03E2B9212B4B6EAF_OFFSET UNITYSDK_OFFSET(0x9435330)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_METHOD_5_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x94352F0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_METHOD_5_ADF4AD3331B4D7AD_OFFSET UNITYSDK_OFFSET(0x9435DC0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x9435E10)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_METHOD_5_E9A575D18A0748D9_OFFSET UNITYSDK_OFFSET(0x9435D70)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_METHOD_5_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0x94352B0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9435D20)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0x9435E60)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_REGISTER_OFFSET UNITYSDK_OFFSET(0x9435380)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_SET_CUSTOMDATA_OFFSET UNITYSDK_OFFSET(0x94350C0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_SET_VISIBLESTATE_OFFSET UNITYSDK_OFFSET(0x9434B90)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_UNREGISTER_OFFSET UNITYSDK_OFFSET(0x94357B0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x9436B00)

namespace RPG::Client::CrowdAnimator
{
	inline static constexpr unsigned int CrowdInstance_TypeDefinitionIndex = 60431;
