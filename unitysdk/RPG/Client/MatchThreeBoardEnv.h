...
#define RPG_CLIENT_MATCHTHREEBOARDENV_INIT_OFFSET UNITYSDK_OFFSET(0x964B220)
#define RPG_CLIENT_MATCHTHREEBOARDENV_METHOD_5_19B91D58E02869BC_OFFSET UNITYSDK_OFFSET(0x96597B0)
#define RPG_CLIENT_MATCHTHREEBOARDENV_METHOD_5_380D3A6DB0A496D6_OFFSET UNITYSDK_OFFSET(0x96596B0)
#define RPG_CLIENT_MATCHTHREEBOARDENV_METHOD_5_87ED86A49598E706_OFFSET UNITYSDK_OFFSET(0x9659830)
#define RPG_CLIENT_MATCHTHREEBOARDENV_SETGRIDTAG_OFFSET UNITYSDK_OFFSET(0x96543F0)
#define RPG_CLIENT_MATCHTHREEBOARDENV_SETSIZE_OFFSET UNITYSDK_OFFSET(0x9659530)
#define RPG_CLIENT_MATCHTHREEBOARDENV__CTOR_OFFSET UNITYSDK_OFFSET(0x9659A00)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeBoardEnv_TypeDefinitionIndex = 52412;
