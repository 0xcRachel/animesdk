...
#define RPG_CLIENT_MATCHTHREEBOARDENV_INIT_OFFSET UNITYSDK_OFFSET(0x9B31370)
#define RPG_CLIENT_MATCHTHREEBOARDENV_METHOD_5_19B91D58E02869BC_OFFSET UNITYSDK_OFFSET(0x9B3F920)
#define RPG_CLIENT_MATCHTHREEBOARDENV_METHOD_5_380D3A6DB0A496D6_OFFSET UNITYSDK_OFFSET(0x9B3F820)
#define RPG_CLIENT_MATCHTHREEBOARDENV_METHOD_5_87ED86A49598E706_OFFSET UNITYSDK_OFFSET(0x9B3F9A0)
#define RPG_CLIENT_MATCHTHREEBOARDENV_SETGRIDTAG_OFFSET UNITYSDK_OFFSET(0x9B3A540)
#define RPG_CLIENT_MATCHTHREEBOARDENV_SETSIZE_OFFSET UNITYSDK_OFFSET(0x9B3F6A0)
#define RPG_CLIENT_MATCHTHREEBOARDENV__CTOR_OFFSET UNITYSDK_OFFSET(0x9B3FB70)
