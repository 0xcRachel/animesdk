...
#define RPG_CLIENT_MONODEFERREDDECALMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x9790480)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoDeferredDecalMonoPlugin_TypeDefinitionIndex = 56510;
