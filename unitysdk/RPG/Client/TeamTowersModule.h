...
#define RPG_CLIENT_TEAMTOWERSMODULE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10557600)
#define RPG_CLIENT_TEAMTOWERSMODULE_GET_PVPMGR_OFFSET UNITYSDK_OFFSET(0x10557690)
#define RPG_CLIENT_TEAMTOWERSMODULE_INIT_OFFSET UNITYSDK_OFFSET(0x10557530)
#define RPG_CLIENT_TEAMTOWERSMODULE_SET_PVPMGR_OFFSET UNITYSDK_OFFSET(0x105576A0)
#define RPG_CLIENT_TEAMTOWERSMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x105576B0)
#define RPG_CLIENT_TEAMTOWERSMODULE___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10557760)
#define RPG_CLIENT_TEAMTOWERSMODULE___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x105576D0)
