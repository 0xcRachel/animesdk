...
#define RPG_CLIENT_TEAMTOWERSMODULE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA58F0D0)
#define RPG_CLIENT_TEAMTOWERSMODULE_GET_PVPMGR_OFFSET UNITYSDK_OFFSET(0xA58F160)
#define RPG_CLIENT_TEAMTOWERSMODULE_INIT_OFFSET UNITYSDK_OFFSET(0xA58F000)
#define RPG_CLIENT_TEAMTOWERSMODULE_SET_PVPMGR_OFFSET UNITYSDK_OFFSET(0xA58F170)
#define RPG_CLIENT_TEAMTOWERSMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0xA58F180)
#define RPG_CLIENT_TEAMTOWERSMODULE___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA58F230)
#define RPG_CLIENT_TEAMTOWERSMODULE___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0xA58F1A0)
