...
#define RPG_CLIENT_SIGNALCURVEPOOL_GET_CURRENTSCENEPOOL_OFFSET UNITYSDK_OFFSET(0xA488C20)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_02AA17F528A7083C_OFFSET UNITYSDK_OFFSET(0xA489570)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_19035547B38554A7_OFFSET UNITYSDK_OFFSET(0xA489350)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_2AB12BF7608A20EF_OFFSET UNITYSDK_OFFSET(0xA489630)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_3C3BC7530E3D1C00_OFFSET UNITYSDK_OFFSET(0xA4894A0)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_640514F2FC7A7607_1_OFFSET UNITYSDK_OFFSET(0xA489780)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_640514F2FC7A7607_OFFSET UNITYSDK_OFFSET(0xA4896C0)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_6D93101E4CE10A96_OFFSET UNITYSDK_OFFSET(0xA488CA0)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_8BCB3191E6BEE7CB_OFFSET UNITYSDK_OFFSET(0xA488C40)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_AE4F744DD72146D5_OFFSET UNITYSDK_OFFSET(0xA489A90)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_DF1269DF412ABB91_OFFSET UNITYSDK_OFFSET(0xA489860)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_F978A1D172468895_OFFSET UNITYSDK_OFFSET(0xA488EB0)
#define RPG_CLIENT_SIGNALCURVEPOOL_SET_CURRENTSCENEPOOL_OFFSET UNITYSDK_OFFSET(0xA488C30)
#define RPG_CLIENT_SIGNALCURVEPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0xA489B60)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::RPG::Client::SignalCurvePool**)Il2CppClass::FromTypeDefinitionIndex(SignalCurvePool_TypeDefinitionIndex)->GetStaticField(0x36A10);
		}
		static ::RPG::Client::SignalCurvePool** StaticGet__currentScenePool()
		{
			return (::RPG::Client::SignalCurvePool**)Il2CppClass::FromTypeDefinitionIndex(SignalCurvePool_TypeDefinitionIndex)->GetStaticField(0x36A18);
		}
