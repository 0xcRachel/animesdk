...
#define RPG_CLIENT_SIGNALCURVEPOOL_GET_CURRENTSCENEPOOL_OFFSET UNITYSDK_OFFSET(0x9F73880)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_02AA17F528A7083C_OFFSET UNITYSDK_OFFSET(0x9F741D0)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_19035547B38554A7_OFFSET UNITYSDK_OFFSET(0x9F73FB0)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_2AB12BF7608A20EF_OFFSET UNITYSDK_OFFSET(0x9F74290)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_3C3BC7530E3D1C00_OFFSET UNITYSDK_OFFSET(0x9F74100)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_640514F2FC7A7607_1_OFFSET UNITYSDK_OFFSET(0x9F743E0)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_640514F2FC7A7607_OFFSET UNITYSDK_OFFSET(0x9F74320)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_6D93101E4CE10A96_OFFSET UNITYSDK_OFFSET(0x9F73900)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_8BCB3191E6BEE7CB_OFFSET UNITYSDK_OFFSET(0x9F738A0)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_AE4F744DD72146D5_OFFSET UNITYSDK_OFFSET(0x9F746F0)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_DF1269DF412ABB91_OFFSET UNITYSDK_OFFSET(0x9F744C0)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_F978A1D172468895_OFFSET UNITYSDK_OFFSET(0x9F73B10)
#define RPG_CLIENT_SIGNALCURVEPOOL_SET_CURRENTSCENEPOOL_OFFSET UNITYSDK_OFFSET(0x9F73890)
#define RPG_CLIENT_SIGNALCURVEPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x9F747C0)

namespace RPG::Client
{
	inline static constexpr unsigned int SignalCurvePool_TypeDefinitionIndex = 56539;
	...
	public:
		...
		{
			return (::RPG::Client::SignalCurvePool**)Il2CppClass::FromTypeDefinitionIndex(SignalCurvePool_TypeDefinitionIndex)->GetStaticField(0x15A80);
		}
		static ::RPG::Client::SignalCurvePool** StaticGet__instance()
		{
			return (::RPG::Client::SignalCurvePool**)Il2CppClass::FromTypeDefinitionIndex(SignalCurvePool_TypeDefinitionIndex)->GetStaticField(0x15A88);
		}
