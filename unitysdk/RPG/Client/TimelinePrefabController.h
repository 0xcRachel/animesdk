...
#define RPG_CLIENT_TIMELINEPREFABCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xA5E8430)
#define RPG_CLIENT_TIMELINEPREFABCONTROLLER_GET_BEHAVIOUR_OFFSET UNITYSDK_OFFSET(0xA5E83D0)
#define RPG_CLIENT_TIMELINEPREFABCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA5E8620)
#define RPG_CLIENT_TIMELINEPREFABCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA5E85D0)
#define RPG_CLIENT_TIMELINEPREFABCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA5E8520)
#define RPG_CLIENT_TIMELINEPREFABCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xA5E86B0)
#define RPG_CLIENT_TIMELINEPREFABCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA5E8700)
