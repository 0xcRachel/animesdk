...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_CUSTOMEVENT_METHOD_6_1DEF7ECEE7F7C088_OFFSET UNITYSDK_OFFSET(0x17741400)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_CUSTOMEVENT_METHOD_6_775B6D644F07B554_OFFSET UNITYSDK_OFFSET(0x177413F0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_CUSTOMEVENT_METHOD_6_C5D98F30ADA6FD61_OFFSET UNITYSDK_OFFSET(0x17740FE0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_CUSTOMEVENT_METHOD_6_D9EF75A2D048B8A1_OFFSET UNITYSDK_OFFSET(0x17740E50)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_CUSTOMEVENT_SHOWSCORE_OFFSET UNITYSDK_OFFSET(0x17740BB0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_CUSTOMEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x177412D0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_CUSTOMEVENT___IFIXBASEPROXY_SHOWSCORE_OFFSET UNITYSDK_OFFSET(0x177413E0)
