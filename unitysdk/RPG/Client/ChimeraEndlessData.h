...
#define RPG_CLIENT_CHIMERAENDLESSDATA_CLEARENDLESSATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x93C4360)
#define RPG_CLIENT_CHIMERAENDLESSDATA_GET_CURRENTATK_OFFSET UNITYSDK_OFFSET(0x93C4460)
#define RPG_CLIENT_CHIMERAENDLESSDATA_GET_CURRENTHP_OFFSET UNITYSDK_OFFSET(0x93C43B0)
#define RPG_CLIENT_CHIMERAENDLESSDATA_GET_ISDEAD_OFFSET UNITYSDK_OFFSET(0x93C4510)
#define RPG_CLIENT_CHIMERAENDLESSDATA_SYNCENDLESSATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x93C4280)
#define RPG_CLIENT_CHIMERAENDLESSDATA_UPDATEAFTERBATTLEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x93C41A0)
#define RPG_CLIENT_CHIMERAENDLESSDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x93C4190)
#define RPG_CLIENT_CHIMERAENDLESSDATA___IFIXBASEPROXY_GET_CURRENTATK_OFFSET UNITYSDK_OFFSET(0x93C4580)
#define RPG_CLIENT_CHIMERAENDLESSDATA___IFIXBASEPROXY_GET_CURRENTHP_OFFSET UNITYSDK_OFFSET(0x93C4570)
#define RPG_CLIENT_CHIMERAENDLESSDATA___IFIXBASEPROXY_GET_ISDEAD_OFFSET UNITYSDK_OFFSET(0x93C4590)
