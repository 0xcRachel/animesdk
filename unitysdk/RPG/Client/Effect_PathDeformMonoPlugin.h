...
#define RPG_CLIENT_EFFECT_PATHDEFORMMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x90D4E60)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_PathDeformMonoPlugin_TypeDefinitionIndex = 56185;
