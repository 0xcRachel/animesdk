...
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_CLEARHITDATA_OFFSET UNITYSDK_OFFSET(0x90A5700)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x90A4760)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_METHOD_5_0C83273C8E891A7D_OFFSET UNITYSDK_OFFSET(0x90A5AD0)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_METHOD_5_36340C412653317C_OFFSET UNITYSDK_OFFSET(0x90A5480)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_METHOD_5_3A599F23178B2776_OFFSET UNITYSDK_OFFSET(0x90A4200)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_METHOD_5_4307B2A4B4A12C1A_1_OFFSET UNITYSDK_OFFSET(0x90A4610)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_METHOD_5_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x90A3E30)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_METHOD_5_55510D094E94D536_OFFSET UNITYSDK_OFFSET(0x90A5770)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_METHOD_5_6735D87E90F99030_OFFSET UNITYSDK_OFFSET(0x90A58E0)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_METHOD_5_78DE1569AE48596D_OFFSET UNITYSDK_OFFSET(0x90A5D50)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_METHOD_5_7AE1B3E28F328DA0_OFFSET UNITYSDK_OFFSET(0x90A5BF0)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_METHOD_5_7FBAA229ED524F8E_OFFSET UNITYSDK_OFFSET(0x90A3FD0)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_METHOD_5_8347A1099A618012_OFFSET UNITYSDK_OFFSET(0x90A5FF0)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_METHOD_5_8A76897D6A693475_OFFSET UNITYSDK_OFFSET(0x90A47F0)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_METHOD_5_A984848EA3E436DA_OFFSET UNITYSDK_OFFSET(0x90A48B0)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_METHOD_5_DF9C4DFC36CBDE06_OFFSET UNITYSDK_OFFSET(0x90A5030)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_METHOD_5_EBBEA899F1ECCD98_OFFSET UNITYSDK_OFFSET(0x90A4AB0)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x90A4490)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x90A3F80)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_SETHITPOINT_OFFSET UNITYSDK_OFFSET(0x90A5300)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_START_OFFSET UNITYSDK_OFFSET(0x90A3CB0)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x90A6080)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_DynamicWavesManager_TypeDefinitionIndex = 56112;
