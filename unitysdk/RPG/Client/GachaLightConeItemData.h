...
#define RPG_CLIENT_GACHALIGHTCONEITEMDATA_GET_EQUIPMENTROW_OFFSET UNITYSDK_OFFSET(0x92E9B10)
#define RPG_CLIENT_GACHALIGHTCONEITEMDATA_SETROW_OFFSET UNITYSDK_OFFSET(0x92E9A40)
#define RPG_CLIENT_GACHALIGHTCONEITEMDATA_SET_EQUIPMENTROW_OFFSET UNITYSDK_OFFSET(0x92E9B20)
#define RPG_CLIENT_GACHALIGHTCONEITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x92E99E0)
#define RPG_CLIENT_GACHALIGHTCONEITEMDATA___IFIXBASEPROXY_SETROW_OFFSET UNITYSDK_OFFSET(0x92E9B30)

namespace RPG::Client
{
	inline static constexpr unsigned int GachaLightConeItemData_TypeDefinitionIndex = 51075;
