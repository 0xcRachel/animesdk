...
#define RPG_CLIENT_UIMUSICVISUALIZATION_MUSICMIXINGBEHAVIOR_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0xA1DE970)
#define RPG_CLIENT_UIMUSICVISUALIZATION_MUSICMIXINGBEHAVIOR_GET_MATERIALINSTANCES_OFFSET UNITYSDK_OFFSET(0xA1DF470)
#define RPG_CLIENT_UIMUSICVISUALIZATION_MUSICMIXINGBEHAVIOR_GET_ORIGINMATERIALS_OFFSET UNITYSDK_OFFSET(0xA1DF6A0)
#define RPG_CLIENT_UIMUSICVISUALIZATION_MUSICMIXINGBEHAVIOR_GET__OWNER_OFFSET UNITYSDK_OFFSET(0xA1DF630)
#define RPG_CLIENT_UIMUSICVISUALIZATION_MUSICMIXINGBEHAVIOR_METHOD_3_3A599F23178B2776_OFFSET UNITYSDK_OFFSET(0xA1DE590)
#define RPG_CLIENT_UIMUSICVISUALIZATION_MUSICMIXINGBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xA1DE850)
#define RPG_CLIENT_UIMUSICVISUALIZATION_MUSICMIXINGBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0xA1DE8B0)
#define RPG_CLIENT_UIMUSICVISUALIZATION_MUSICMIXINGBEHAVIOR_METHOD_3_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0xA1DE910)
#define RPG_CLIENT_UIMUSICVISUALIZATION_MUSICMIXINGBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xA1DDE10)
#define RPG_CLIENT_UIMUSICVISUALIZATION_MUSICMIXINGBEHAVIOR_METHOD_3_48441CA44C0D59F4_OFFSET UNITYSDK_OFFSET(0xA1DE9D0)
#define RPG_CLIENT_UIMUSICVISUALIZATION_MUSICMIXINGBEHAVIOR_METHOD_3_494D01CAE2C9CF5C_OFFSET UNITYSDK_OFFSET(0xA1DF1E0)
#define RPG_CLIENT_UIMUSICVISUALIZATION_MUSICMIXINGBEHAVIOR_METHOD_3_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0xA1DFA00)
#define RPG_CLIENT_UIMUSICVISUALIZATION_MUSICMIXINGBEHAVIOR_METHOD_3_5790A55946AA509D_2_OFFSET UNITYSDK_OFFSET(0xA1DFA60)
#define RPG_CLIENT_UIMUSICVISUALIZATION_MUSICMIXINGBEHAVIOR_METHOD_3_5790A55946AA509D_3_OFFSET UNITYSDK_OFFSET(0xA1DFAC0)
#define RPG_CLIENT_UIMUSICVISUALIZATION_MUSICMIXINGBEHAVIOR_METHOD_3_5790A55946AA509D_4_OFFSET UNITYSDK_OFFSET(0xA1DFB20)
#define RPG_CLIENT_UIMUSICVISUALIZATION_MUSICMIXINGBEHAVIOR_METHOD_3_5790A55946AA509D_5_OFFSET UNITYSDK_OFFSET(0xA1DFB80)
#define RPG_CLIENT_UIMUSICVISUALIZATION_MUSICMIXINGBEHAVIOR_METHOD_3_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xA1DF9A0)
#define RPG_CLIENT_UIMUSICVISUALIZATION_MUSICMIXINGBEHAVIOR_METHOD_3_777C630B90A28EF1_OFFSET UNITYSDK_OFFSET(0xA1DDE70)
#define RPG_CLIENT_UIMUSICVISUALIZATION_MUSICMIXINGBEHAVIOR_METHOD_3_B1EA412ACAE87C15_OFFSET UNITYSDK_OFFSET(0xA1DDEC0)
#define RPG_CLIENT_UIMUSICVISUALIZATION_MUSICMIXINGBEHAVIOR_METHOD_3_B2AF81294D9C69C7_OFFSET UNITYSDK_OFFSET(0xA1DE540)
#define RPG_CLIENT_UIMUSICVISUALIZATION_MUSICMIXINGBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0xA1DF910)
#define RPG_CLIENT_UIMUSICVISUALIZATION_MUSICMIXINGBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xA1DF860)
#define RPG_CLIENT_UIMUSICVISUALIZATION_MUSICMIXINGBEHAVIOR___IFIXBASEPROXY_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0xA1DFBE0)

namespace RPG::Client
{
	inline static constexpr unsigned int UIMusicVisualization_MusicMixingBehavior_TypeDefinitionIndex = 56458;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMusicVisualization_MusicMixingBehavior_TypeDefinitionIndex)->GetStaticField(0xC6C0);
		}
		static ::System::Int32* StaticGet__BarWidthShaderProperty()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMusicVisualization_MusicMixingBehavior_TypeDefinitionIndex)->GetStaticField(0xC6C4);
		}
		static ::System::Int32* StaticGet__ChunkEdgeShaderProperty()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMusicVisualization_MusicMixingBehavior_TypeDefinitionIndex)->GetStaticField(0xC6C8);
		}
		static ::System::Int32* StaticGet__UVNoiseTexStShaderProperty()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMusicVisualization_MusicMixingBehavior_TypeDefinitionIndex)->GetStaticField(0xC6CC);
		}
		static ::System::Int32* StaticGet__MusicMixingChannelShaderProperty()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMusicVisualization_MusicMixingBehavior_TypeDefinitionIndex)->GetStaticField(0xC6D0);
		}
