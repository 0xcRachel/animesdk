...
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACK___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9356DD0)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACK___C__DISPLAYCLASS13_0__UPDATEWAITTRACKEQUIPIDS_B__0_OFFSET UNITYSDK_OFFSET(0x93571E0)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACK___C__DISPLAYCLASS13_0__UPDATEWAITTRACKEQUIPIDS_B__1_OFFSET UNITYSDK_OFFSET(0x9357240)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightEquipTrack___c__DisplayClass13_0_TypeDefinitionIndex = 51909;
