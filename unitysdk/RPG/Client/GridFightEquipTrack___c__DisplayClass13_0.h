...
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACK___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9814650)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACK___C__DISPLAYCLASS13_0__UPDATEWAITTRACKEQUIPIDS_B__0_OFFSET UNITYSDK_OFFSET(0x9814A60)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACK___C__DISPLAYCLASS13_0__UPDATEWAITTRACKEQUIPIDS_B__1_OFFSET UNITYSDK_OFFSET(0x9814AE0)
