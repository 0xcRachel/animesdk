...
#define RPG_CLIENT_AVATARPROPERTYUIDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8CE8720)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarPropertyUIData_TypeDefinitionIndex = 49616;
