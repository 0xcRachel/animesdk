...
#define RPG_CLIENT_AUDIENCEPREFABSPECIALTAG_BLINK_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x8CA69A0)
#define RPG_CLIENT_AUDIENCEPREFABSPECIALTAG_BLINK__CTOR_OFFSET UNITYSDK_OFFSET(0x8CA69B0)

namespace RPG::Client
{
	inline static constexpr unsigned int AudiencePrefabSpecialTag_Blink_TypeDefinitionIndex = 54924;
