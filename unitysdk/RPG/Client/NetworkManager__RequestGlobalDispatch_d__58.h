...
#define RPG_CLIENT_NETWORKMANAGER__REQUESTGLOBALDISPATCH_D__58_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x99F16B0)
#define RPG_CLIENT_NETWORKMANAGER__REQUESTGLOBALDISPATCH_D__58_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x99F1D30)
#define RPG_CLIENT_NETWORKMANAGER__REQUESTGLOBALDISPATCH_D__58_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x99F1D90)
#define RPG_CLIENT_NETWORKMANAGER__REQUESTGLOBALDISPATCH_D__58_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x99F1D40)
#define RPG_CLIENT_NETWORKMANAGER__REQUESTGLOBALDISPATCH_D__58_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x99F1640)
#define RPG_CLIENT_NETWORKMANAGER__REQUESTGLOBALDISPATCH_D__58__CTOR_OFFSET UNITYSDK_OFFSET(0x99F1630)
#define RPG_CLIENT_NETWORKMANAGER__REQUESTGLOBALDISPATCH_D__58___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x99F1690)

namespace RPG::Client
{
	inline static constexpr unsigned int NetworkManager__RequestGlobalDispatch_d__58_TypeDefinitionIndex = 55136;
	...
	public:
		...
		::UnityEngine::Networking::UnityWebRequest* _request_5__10; // 0x28
		::System::String* _url_5__9; // 0x30
		::System::String* _errMsg_5__6; // 0x38
		::System::String* _requestUrl_5__4; // 0x40
		::RPG::Client::NetworkManager* __4__this; // 0x48
		::System::Int32 __7__wrap7; // 0x50
		::System::Int32 _tryIndex_5__2; // 0x54
