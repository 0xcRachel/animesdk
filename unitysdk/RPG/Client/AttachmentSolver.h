...
#define RPG_CLIENT_ATTACHMENTSOLVER_METHOD_1_05891E8E87C14559_OFFSET UNITYSDK_OFFSET(0x8C9E790)
#define RPG_CLIENT_ATTACHMENTSOLVER_METHOD_1_10E3199645FD9D0C_OFFSET UNITYSDK_OFFSET(0x8C9E1A0)
#define RPG_CLIENT_ATTACHMENTSOLVER_METHOD_1_2566AD459572DFC3_OFFSET UNITYSDK_OFFSET(0x8C9E400)
#define RPG_CLIENT_ATTACHMENTSOLVER_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x8C9EC90)
#define RPG_CLIENT_ATTACHMENTSOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x8C9ECD0)

namespace RPG::Client
{
	inline static constexpr unsigned int AttachmentSolver_TypeDefinitionIndex = 54314;
