...
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_CANBEUPGRADEDBY_OFFSET UNITYSDK_OFFSET(0x93ABFE0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_CREATEFAKE_OFFSET UNITYSDK_OFFSET(0x93ABA40)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_CREATE_1_OFFSET UNITYSDK_OFFSET(0x93AB720)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_CREATE_OFFSET UNITYSDK_OFFSET(0x93AB5C0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_GETCURRENTATTACK_OFFSET UNITYSDK_OFFSET(0x93AC1F0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_GETCURRENTEXPOFCURRENTLEVEL_OFFSET UNITYSDK_OFFSET(0x93ABF50)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_GETCURRENTHEALTH_OFFSET UNITYSDK_OFFSET(0x93AC460)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_GETCURRENTLEVEL_OFFSET UNITYSDK_OFFSET(0x93ABBD0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_GETMAXEXPOFCURRENTLEVEL_OFFSET UNITYSDK_OFFSET(0x93ABDD0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_GETMAXEXPOFPREVIOUSLEVEL_OFFSET UNITYSDK_OFFSET(0x93ABE90)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_GETSELLPRICE_OFFSET UNITYSDK_OFFSET(0x93AC620)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_GET_CHIMERADATA_OFFSET UNITYSDK_OFFSET(0x93AB400)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_GET_CHIMERAID_OFFSET UNITYSDK_OFFSET(0x93AB3E0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_GET_EQUIPMENT_OFFSET UNITYSDK_OFFSET(0x93AB5A0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_GET_GAINEDEXP_OFFSET UNITYSDK_OFFSET(0x93AB4B0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_GET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0x93AB3D0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_ISMAXLEVEL_OFFSET UNITYSDK_OFFSET(0x93ABD40)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_SET_CHIMERAID_OFFSET UNITYSDK_OFFSET(0x93AB3F0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_SET_EQUIPMENT_OFFSET UNITYSDK_OFFSET(0x93AB5B0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_SYNC_OFFSET UNITYSDK_OFFSET(0x93AC9C0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_TRYGETBATTLESKILLDATA_OFFSET UNITYSDK_OFFSET(0x93AC900)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_TRYGETCOREFLAMECOUNT_OFFSET UNITYSDK_OFFSET(0x93AC6B0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_TRYGETSHOPSKILLDATA_OFFSET UNITYSDK_OFFSET(0x93AC840)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_TRYGETSKILLDATAFORDISPLAY_OFFSET UNITYSDK_OFFSET(0x93AC750)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_WOULDLEVELUPWITHEXP_OFFSET UNITYSDK_OFFSET(0x93AC0D0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x93ABB40)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x93AB6B0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA__GETCOREFLAMECOUNT_OFFSET UNITYSDK_OFFSET(0x93ABB90)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA__GETGAINEDEXPFORDISPLAY_OFFSET UNITYSDK_OFFSET(0x93AB4C0)
