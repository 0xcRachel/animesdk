...
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_CANBEUPGRADEDBY_OFFSET UNITYSDK_OFFSET(0x177BBB90)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_CREATEFAKE_OFFSET UNITYSDK_OFFSET(0x177BB600)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_CREATE_1_OFFSET UNITYSDK_OFFSET(0x177BB2E0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_CREATE_OFFSET UNITYSDK_OFFSET(0x177BB170)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_GETCURRENTATTACK_OFFSET UNITYSDK_OFFSET(0x177BBDA0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_GETCURRENTEXPOFCURRENTLEVEL_OFFSET UNITYSDK_OFFSET(0x177BBB00)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_GETCURRENTHEALTH_OFFSET UNITYSDK_OFFSET(0x177BC010)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_GETCURRENTLEVEL_OFFSET UNITYSDK_OFFSET(0x177BB780)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_GETMAXEXPOFCURRENTLEVEL_OFFSET UNITYSDK_OFFSET(0x177BB980)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_GETMAXEXPOFPREVIOUSLEVEL_OFFSET UNITYSDK_OFFSET(0x177BBA40)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_GETSELLPRICE_OFFSET UNITYSDK_OFFSET(0x177BC1D0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_GET_CHIMERADATA_OFFSET UNITYSDK_OFFSET(0x177BAFB0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_GET_CHIMERAID_OFFSET UNITYSDK_OFFSET(0x177BAF90)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_GET_EQUIPMENT_OFFSET UNITYSDK_OFFSET(0x177BB150)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_GET_GAINEDEXP_OFFSET UNITYSDK_OFFSET(0x177BB060)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_GET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0x177BAF80)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_ISMAXLEVEL_OFFSET UNITYSDK_OFFSET(0x177BB8F0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_SET_CHIMERAID_OFFSET UNITYSDK_OFFSET(0x177BAFA0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_SET_EQUIPMENT_OFFSET UNITYSDK_OFFSET(0x177BB160)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_SYNC_OFFSET UNITYSDK_OFFSET(0x177BC570)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_TRYGETBATTLESKILLDATA_OFFSET UNITYSDK_OFFSET(0x177BC4B0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_TRYGETCOREFLAMECOUNT_OFFSET UNITYSDK_OFFSET(0x177BC260)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_TRYGETSHOPSKILLDATA_OFFSET UNITYSDK_OFFSET(0x177BC3F0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_TRYGETSKILLDATAFORDISPLAY_OFFSET UNITYSDK_OFFSET(0x177BC300)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA_WOULDLEVELUPWITHEXP_OFFSET UNITYSDK_OFFSET(0x177BBC80)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x177BB700)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x177BB270)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA__GETCOREFLAMECOUNT_OFFSET UNITYSDK_OFFSET(0x177BB740)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONCHIMERA__GETGAINEDEXPFORDISPLAY_OFFSET UNITYSDK_OFFSET(0x177BB070)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 _SpecialParam; // 0x24
		::System::Int32 _DeltaHealth; // 0x28
