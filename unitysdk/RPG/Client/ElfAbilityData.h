...
#define RPG_CLIENT_ELFABILITYDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x156DCE50)
#define RPG_CLIENT_ELFABILITYDATA_GET_DETAIL_OFFSET UNITYSDK_OFFSET(0x156DCFD0)
#define RPG_CLIENT_ELFABILITYDATA_GET_DYNAMICVALUES_OFFSET UNITYSDK_OFFSET(0x156DD0D0)
#define RPG_CLIENT_ELFABILITYDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0x156DCEE0)
#define RPG_CLIENT_ELFABILITYDATA_GET_ISORDINARYABILITY_OFFSET UNITYSDK_OFFSET(0x156DD140)
#define RPG_CLIENT_ELFABILITYDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x156DD050)
#define RPG_CLIENT_ELFABILITYDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x156DCF00)
#define RPG_CLIENT_ELFABILITYDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x156DCF70)
#define RPG_CLIENT_ELFABILITYDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0x156DCEF0)
#define RPG_CLIENT_ELFABILITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x156DCED0)
