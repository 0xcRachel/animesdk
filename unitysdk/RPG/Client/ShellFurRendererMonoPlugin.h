...
#define RPG_CLIENT_SHELLFURRENDERERMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x9F71560)

namespace RPG::Client
{
	inline static constexpr unsigned int ShellFurRendererMonoPlugin_TypeDefinitionIndex = 56531;
