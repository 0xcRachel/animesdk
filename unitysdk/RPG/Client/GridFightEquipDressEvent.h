...
#define RPG_CLIENT_GRIDFIGHTEQUIPDRESSEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x934F7C0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightEquipDressEvent_TypeDefinitionIndex = 51575;
