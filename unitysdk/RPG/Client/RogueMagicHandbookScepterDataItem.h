...
#define RPG_CLIENT_ROGUEMAGICHANDBOOKSCEPTERDATAITEM_GET_BIGICONPATH_OFFSET UNITYSDK_OFFSET(0xA32C0E0)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKSCEPTERDATAITEM_GET_DISPLAYDATAITEM_OFFSET UNITYSDK_OFFSET(0xA32C980)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKSCEPTERDATAITEM_GET_FUNCTYPE_OFFSET UNITYSDK_OFFSET(0xA32C8C0)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKSCEPTERDATAITEM_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xA32BFB0)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKSCEPTERDATAITEM_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xA32C990)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKSCEPTERDATAITEM_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xA32BE00)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKSCEPTERDATAITEM_GET_LOCKEDUNITEFFECT_OFFSET UNITYSDK_OFFSET(0xA32C3E0)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKSCEPTERDATAITEM_GET_LOCKEDUNITEXTRAEFFECTS_OFFSET UNITYSDK_OFFSET(0xA32C5F0)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKSCEPTERDATAITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0xA32BE20)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKSCEPTERDATAITEM_GET_SCEPTERID_OFFSET UNITYSDK_OFFSET(0xA32BDE0)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKSCEPTERDATAITEM_GET_STYLETYPE_OFFSET UNITYSDK_OFFSET(0xA32C800)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKSCEPTERDATAITEM_GET_TRIGGERCOND_OFFSET UNITYSDK_OFFSET(0xA32C210)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKSCEPTERDATAITEM_SET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xA32C9A0)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKSCEPTERDATAITEM_SYNCISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xA32A7B0)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKSCEPTERDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xA32A330)
