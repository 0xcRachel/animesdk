...
#define RPG_CLIENT_STORYLINEUTILS_SHOWSWITCHLINEDIALOGONDEMAND_OFFSET UNITYSDK_OFFSET(0x9FD6EF0)

namespace RPG::Client
{
	inline static constexpr unsigned int StoryLineUtils_TypeDefinitionIndex = 53939;
