...
#define RPG_CLIENT_HEADICONUTILS_SORTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xCE380)

namespace RPG::Client
{
	inline static constexpr unsigned int HeadIconUtils_SortInfo_TypeDefinitionIndex = 52182;
