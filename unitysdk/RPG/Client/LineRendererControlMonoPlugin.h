...
#define RPG_CLIENT_LINERENDERERCONTROLMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x950C8B0)
#define RPG_CLIENT_LINERENDERERCONTROLMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x950C900)
#define RPG_CLIENT_LINERENDERERCONTROLMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x950C920)

namespace RPG::Client
{
	inline static constexpr unsigned int LineRendererControlMonoPlugin_TypeDefinitionIndex = 56276;
