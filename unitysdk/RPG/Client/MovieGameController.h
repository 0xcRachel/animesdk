...
#define RPG_CLIENT_MOVIEGAMECONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13723FF0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_GETGAMEMODECOMPONENT_OFFSET UNITYSDK_OFFSET(0x13723530)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_GETGAMEMODEENTITY_OFFSET UNITYSDK_OFFSET(0x137235A0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_GETGAMEMODE_OFFSET UNITYSDK_OFFSET(0x13723180)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_GETOPERATIONCONFIG_OFFSET UNITYSDK_OFFSET(0x13723600)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_GETPLAYERSPANCHORPOSITION_OFFSET UNITYSDK_OFFSET(0x13723230)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_GETSTATISTICS_OFFSET UNITYSDK_OFFSET(0x137234C0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0x13722580)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0x13723A00)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_071850D2764E9D4C_OFFSET UNITYSDK_OFFSET(0x13724490)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_0C490FF1F071E8D4_OFFSET UNITYSDK_OFFSET(0x137254C0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x13722B80)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x13724870)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_6112A1276899AF0F_OFFSET UNITYSDK_OFFSET(0x13723A40)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_617F2795F0D73EAD_OFFSET UNITYSDK_OFFSET(0x13725650)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_77F4CE1192CC157F_OFFSET UNITYSDK_OFFSET(0x13723DD0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_A43D587A89E24E29_OFFSET UNITYSDK_OFFSET(0x137250F0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_AB1A253BFABC50A9_OFFSET UNITYSDK_OFFSET(0x13724F10)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_B710AD145420A84D_1_OFFSET UNITYSDK_OFFSET(0x13724B20)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_B710AD145420A84D_2_OFFSET UNITYSDK_OFFSET(0x13724C60)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_B710AD145420A84D_OFFSET UNITYSDK_OFFSET(0x137249E0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_BBAF4B070327A414_OFFSET UNITYSDK_OFFSET(0x13724DA0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_E7B33E32CA371E57_OFFSET UNITYSDK_OFFSET(0x13726CA0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_E88B764FDB27A464_OFFSET UNITYSDK_OFFSET(0x13725230)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_F79D5EC57FBF426E_OFFSET UNITYSDK_OFFSET(0x13722910)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_ONANYTRIGGERSOUNDEVENT_OFFSET UNITYSDK_OFFSET(0x13726E50)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_ONPLAYERHITSTATE_OFFSET UNITYSDK_OFFSET(0x13726F60)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0x13722CD0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0x13722DC0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0x13723660)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_TRIGGERPUZZLECUSTOMEVENT_OFFSET UNITYSDK_OFFSET(0x13727030)
#define RPG_CLIENT_MOVIEGAMECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x137270F0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13727240)
#define RPG_CLIENT_MOVIEGAMECONTROLLER___IFIXBASEPROXY_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0x13727100)
#define RPG_CLIENT_MOVIEGAMECONTROLLER___IFIXBASEPROXY_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0x13727250)
#define RPG_CLIENT_MOVIEGAMECONTROLLER___IFIXBASEPROXY_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0x13727110)
#define RPG_CLIENT_MOVIEGAMECONTROLLER___IFIXBASEPROXY_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0x13727170)
#define RPG_CLIENT_MOVIEGAMECONTROLLER___IFIXBASEPROXY_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0x137271D0)
