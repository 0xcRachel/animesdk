...
#define RPG_CLIENT_MOVIEGAMECONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x98BEC50)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_GETGAMEMODECOMPONENT_OFFSET UNITYSDK_OFFSET(0x98BE180)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_GETGAMEMODEENTITY_OFFSET UNITYSDK_OFFSET(0x98BE1F0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_GETGAMEMODE_OFFSET UNITYSDK_OFFSET(0x98BDDD0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_GETOPERATIONCONFIG_OFFSET UNITYSDK_OFFSET(0x98BE250)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_GETPLAYERSPANCHORPOSITION_OFFSET UNITYSDK_OFFSET(0x98BDE80)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_GETSTATISTICS_OFFSET UNITYSDK_OFFSET(0x98BE110)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0x98BD190)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0x98BE650)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_071850D2764E9D4C_OFFSET UNITYSDK_OFFSET(0x98BF140)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_0C490FF1F071E8D4_OFFSET UNITYSDK_OFFSET(0x98C0180)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x98BD790)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x98BF520)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_6112A1276899AF0F_OFFSET UNITYSDK_OFFSET(0x98BE690)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_617F2795F0D73EAD_OFFSET UNITYSDK_OFFSET(0x98C0310)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_77F4CE1192CC157F_OFFSET UNITYSDK_OFFSET(0x98BEA30)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_A43D587A89E24E29_OFFSET UNITYSDK_OFFSET(0x98BFDB0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_AB1A253BFABC50A9_OFFSET UNITYSDK_OFFSET(0x98BFBD0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_B710AD145420A84D_1_OFFSET UNITYSDK_OFFSET(0x98BF7D0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_B710AD145420A84D_2_OFFSET UNITYSDK_OFFSET(0x98BF910)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_B710AD145420A84D_OFFSET UNITYSDK_OFFSET(0x98BF690)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_BBAF4B070327A414_OFFSET UNITYSDK_OFFSET(0x98BFA50)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_E7B33E32CA371E57_OFFSET UNITYSDK_OFFSET(0x98C1960)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_E88B764FDB27A464_OFFSET UNITYSDK_OFFSET(0x98BFEF0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_F79D5EC57FBF426E_OFFSET UNITYSDK_OFFSET(0x98BD520)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_ONANYTRIGGERSOUNDEVENT_OFFSET UNITYSDK_OFFSET(0x98C1B10)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_ONPLAYERHITSTATE_OFFSET UNITYSDK_OFFSET(0x98C1C20)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0x98BD8E0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0x98BD9D0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0x98BE2B0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_TRIGGERPUZZLECUSTOMEVENT_OFFSET UNITYSDK_OFFSET(0x98C1CF0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x98C1DB0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x98C1F00)
#define RPG_CLIENT_MOVIEGAMECONTROLLER___IFIXBASEPROXY_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0x98C1DC0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER___IFIXBASEPROXY_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0x98C1F10)
#define RPG_CLIENT_MOVIEGAMECONTROLLER___IFIXBASEPROXY_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0x98C1DD0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER___IFIXBASEPROXY_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0x98C1E30)
#define RPG_CLIENT_MOVIEGAMECONTROLLER___IFIXBASEPROXY_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0x98C1E90)

namespace RPG::Client
{
	inline static constexpr unsigned int MovieGameController_TypeDefinitionIndex = 47843;
