...
#define RPG_CLIENT_BATTLERESULTPROCESS_CONFIGITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x8DD3EB0)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleResultProcess_ConfigItem_TypeDefinitionIndex = 48368;
	...
	public:
		...
		::RPG::Client::BattleResultProcess_RestartOption RestartOption; // 0x20
		::RPG::GameCore::StageType StageType; // 0x24
		::System::Boolean HaveResultPageOnQuit; // 0x28
		::System::Boolean HaveResultPageOnWin; // 0x29
		::System::Boolean HaveResultPageOnLose; // 0x2A
