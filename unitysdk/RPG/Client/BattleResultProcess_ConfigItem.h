...
#define RPG_CLIENT_BATTLERESULTPROCESS_CONFIGITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1471EC20)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Boolean HaveResultPageOnQuit; // 0x24
		::System::Boolean HaveResultPageOnWin; // 0x25
		::System::Boolean HaveResultPageOnLose; // 0x26
