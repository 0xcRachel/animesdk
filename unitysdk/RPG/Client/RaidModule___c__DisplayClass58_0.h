...
#define RPG_CLIENT_RAIDMODULE___C__DISPLAYCLASS58_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9D69F50)
#define RPG_CLIENT_RAIDMODULE___C__DISPLAYCLASS58_0__STARTRAID_B__0_OFFSET UNITYSDK_OFFSET(0x9D6DE80)

namespace RPG::Client
{
	inline static constexpr unsigned int RaidModule___c__DisplayClass58_0_TypeDefinitionIndex = 53189;
	...
	public:
		...
		::System::UInt32 propEntityID; // 0x28
