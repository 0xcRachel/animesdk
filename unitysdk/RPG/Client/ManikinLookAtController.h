...
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1511BA10)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_DISABLELOOKAT_OFFSET UNITYSDK_OFFSET(0x1511DE50)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_DOLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1511DB30)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_ENABLELOOKAT_OFFSET UNITYSDK_OFFSET(0x1511DD90)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_GET_STATICENABLED_OFFSET UNITYSDK_OFFSET(0x1511B920)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_METHOD_5_45F2459C967E3311_OFFSET UNITYSDK_OFFSET(0x1511DA20)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_METHOD_5_5EB6B43A59A0A89B_OFFSET UNITYSDK_OFFSET(0x1511BEE0)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1511BE40)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1511BD40)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_SETOWNER_OFFSET UNITYSDK_OFFSET(0x1511B9C0)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x1511BC80)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1511DF10)
