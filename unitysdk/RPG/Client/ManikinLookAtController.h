...
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x95EE710)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_DISABLELOOKAT_OFFSET UNITYSDK_OFFSET(0x95F0B70)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_DOLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x95F0850)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_ENABLELOOKAT_OFFSET UNITYSDK_OFFSET(0x95F0AB0)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_GET_STATICENABLED_OFFSET UNITYSDK_OFFSET(0x95EE620)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_METHOD_5_45F2459C967E3311_OFFSET UNITYSDK_OFFSET(0x95F0740)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_METHOD_5_5EB6B43A59A0A89B_OFFSET UNITYSDK_OFFSET(0x95EEC00)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x95EEB60)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x95EEA60)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_SETOWNER_OFFSET UNITYSDK_OFFSET(0x95EE6C0)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x95EE9A0)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x95F0C30)

namespace RPG::Client
{
	inline static constexpr unsigned int ManikinLookAtController_TypeDefinitionIndex = 54375;
