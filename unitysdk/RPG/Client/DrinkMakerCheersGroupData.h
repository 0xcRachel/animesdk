...
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_AVATARNAME_OFFSET UNITYSDK_OFFSET(0x18CE4420)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_AVATARREQUESTHEADICONPATH_OFFSET UNITYSDK_OFFSET(0x18CE43D0)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_DAYSTARTTOASTDESC_OFFSET UNITYSDK_OFFSET(0x18CE43A0)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x18CDB010)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_GUESTHEADICON_OFFSET UNITYSDK_OFFSET(0x18CE4470)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_INTRODUCEID_OFFSET UNITYSDK_OFFSET(0x18CE4450)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_ISSHOWINHANDBOOK_OFFSET UNITYSDK_OFFSET(0x18CDB400)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_MADEDRINKCOUNT_OFFSET UNITYSDK_OFFSET(0x18CDB9C0)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_NEGATIVEDRINKDATA_OFFSET UNITYSDK_OFFSET(0x18CDAA30)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_NEXTGROUPID_OFFSET UNITYSDK_OFFSET(0x18CDAFF0)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_POSITIVEDRINKDATA_OFFSET UNITYSDK_OFFSET(0x18CDA960)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_ROLEREQUIREMENT_OFFSET UNITYSDK_OFFSET(0x18CE43F0)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_TOTALDRINKCOUNT_OFFSET UNITYSDK_OFFSET(0x18CDB740)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18CE0470)
