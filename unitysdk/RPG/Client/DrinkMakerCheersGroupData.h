...
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_AVATARNAME_OFFSET UNITYSDK_OFFSET(0x160C0890)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_AVATARREQUESTHEADICONPATH_OFFSET UNITYSDK_OFFSET(0x160C0840)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_DAYSTARTTOASTDESC_OFFSET UNITYSDK_OFFSET(0x160C0810)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x160B7560)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_GUESTHEADICON_OFFSET UNITYSDK_OFFSET(0x160C08E0)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_INTRODUCEID_OFFSET UNITYSDK_OFFSET(0x160C08C0)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_ISSHOWINHANDBOOK_OFFSET UNITYSDK_OFFSET(0x160B78C0)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_MADEDRINKCOUNT_OFFSET UNITYSDK_OFFSET(0x160B7DD0)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_NEGATIVEDRINKDATA_OFFSET UNITYSDK_OFFSET(0x160B6E90)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_NEXTGROUPID_OFFSET UNITYSDK_OFFSET(0x160B7540)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_POSITIVEDRINKDATA_OFFSET UNITYSDK_OFFSET(0x160B6DC0)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_ROLEREQUIREMENT_OFFSET UNITYSDK_OFFSET(0x160C0860)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_TOTALDRINKCOUNT_OFFSET UNITYSDK_OFFSET(0x160B7BC0)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x160BCB20)
