...
#define RPG_CLIENT_ACTIVITYMODULE___C__DISPLAYCLASS23_0__CTOR_OFFSET UNITYSDK_OFFSET(0x17BC16E0)
#define RPG_CLIENT_ACTIVITYMODULE___C__DISPLAYCLASS23_0__GETACTIVITYLOGINDATABYACTIVITYID_B__0_OFFSET UNITYSDK_OFFSET(0x17BD3300)
#define RPG_CLIENT_ACTIVITYMODULE___C__DISPLAYCLASS23_0__GETACTIVITYLOGINDATABYACTIVITYID_B__1_OFFSET UNITYSDK_OFFSET(0x17BD3320)
