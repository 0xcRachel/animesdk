...
#define RPG_CLIENT_PROMISES_PROMISE___C__DISPLAYCLASS56_0__CTOR_OFFSET UNITYSDK_OFFSET(0x17B41760)
#define RPG_CLIENT_PROMISES_PROMISE___C__DISPLAYCLASS56_0__THEN_B__0_OFFSET UNITYSDK_OFFSET(0x17B42CC0)
#define RPG_CLIENT_PROMISES_PROMISE___C__DISPLAYCLASS56_0__THEN_B__1_OFFSET UNITYSDK_OFFSET(0x17B42D00)

namespace RPG::Client::Promises
{
	inline static constexpr unsigned int Promise___c__DisplayClass56_0_TypeDefinitionIndex = 9047;
