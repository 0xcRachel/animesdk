...
#define RPG_CLIENT_PROMISES_PROMISE___C__DISPLAYCLASS55_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1835B150)
#define RPG_CLIENT_PROMISES_PROMISE___C__DISPLAYCLASS55_0__THEN_B__0_OFFSET UNITYSDK_OFFSET(0x1835C220)
#define RPG_CLIENT_PROMISES_PROMISE___C__DISPLAYCLASS55_0__THEN_B__1_OFFSET UNITYSDK_OFFSET(0x1835C410)
#define RPG_CLIENT_PROMISES_PROMISE___C__DISPLAYCLASS55_0__THEN_B__2_OFFSET UNITYSDK_OFFSET(0x1835C3B0)
#define RPG_CLIENT_PROMISES_PROMISE___C__DISPLAYCLASS55_0__THEN_B__3_OFFSET UNITYSDK_OFFSET(0x1835C3D0)
#define RPG_CLIENT_PROMISES_PROMISE___C__DISPLAYCLASS55_0__THEN_B__4_OFFSET UNITYSDK_OFFSET(0x1835C3F0)
...
namespace RPG::Client::Promises
{
	...
	public:
		...
		::RPG::Client::Promises::Promise* resultPromise; // 0x38
