...
#define RPG_CLIENT_PROMISES_EXCEPTIONS_PROMISEEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17B3F3C0)
#define RPG_CLIENT_PROMISES_EXCEPTIONS_PROMISEEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x17B3F420)
#define RPG_CLIENT_PROMISES_EXCEPTIONS_PROMISEEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x17B3F360)

namespace RPG::Client::Promises::Exceptions
{
	inline static constexpr unsigned int PromiseException_TypeDefinitionIndex = 9062;
