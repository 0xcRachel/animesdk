...
#define RPG_CLIENT_PROMISES_PREDICATEWAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x17B3F5C0)

namespace RPG::Client::Promises
{
	inline static constexpr unsigned int PredicateWait_TypeDefinitionIndex = 9030;
	...
	public:
		...
		::System::Single timeStarted; // 0x2C
		::System::Int32 frameStarted; // 0x30
