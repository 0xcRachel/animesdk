...
#define RPG_CLIENT_ROGUETOURNBUILDREFTEAMAVATARMEMBERDATA_CLEAR_OFFSET UNITYSDK_OFFSET(0xA3878B0)
#define RPG_CLIENT_ROGUETOURNBUILDREFTEAMAVATARMEMBERDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA387900)
#define RPG_CLIENT_ROGUETOURNBUILDREFTEAMAVATARMEMBERDATA_GET_AVATAR_OFFSET UNITYSDK_OFFSET(0xA387CE0)
#define RPG_CLIENT_ROGUETOURNBUILDREFTEAMAVATARMEMBERDATA_ISVALIDFORRECOM_OFFSET UNITYSDK_OFFSET(0xA387970)
#define RPG_CLIENT_ROGUETOURNBUILDREFTEAMAVATARMEMBERDATA_SET_AVATAR_OFFSET UNITYSDK_OFFSET(0xA387CF0)
#define RPG_CLIENT_ROGUETOURNBUILDREFTEAMAVATARMEMBERDATA_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA3877B0)
#define RPG_CLIENT_ROGUETOURNBUILDREFTEAMAVATARMEMBERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA3877A0)
#define RPG_CLIENT_ROGUETOURNBUILDREFTEAMAVATARMEMBERDATA__ISAVATARCANTRIAL_OFFSET UNITYSDK_OFFSET(0xA387BF0)
#define RPG_CLIENT_ROGUETOURNBUILDREFTEAMAVATARMEMBERDATA__ISAVATAROBTAINED_OFFSET UNITYSDK_OFFSET(0xA387AE0)
#define RPG_CLIENT_ROGUETOURNBUILDREFTEAMAVATARMEMBERDATA___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA387D00)
