...
#define RPG_CLIENT_PLAYERCHESSROGUERECORDDATA_GET_AREAID_OFFSET UNITYSDK_OFFSET(0x9FEE660)
#define RPG_CLIENT_PLAYERCHESSROGUERECORDDATA_GET_DIFFICULTY_OFFSET UNITYSDK_OFFSET(0x9FEE6E0)
#define RPG_CLIENT_PLAYERCHESSROGUERECORDDATA_GET_DISPLAYTYPE_OFFSET UNITYSDK_OFFSET(0x9FEE6C0)
#define RPG_CLIENT_PLAYERCHESSROGUERECORDDATA_GET_DLCID_OFFSET UNITYSDK_OFFSET(0x9FEE700)
#define RPG_CLIENT_PLAYERCHESSROGUERECORDDATA_GET_HASRECORD_OFFSET UNITYSDK_OFFSET(0x9FEE6D0)
#define RPG_CLIENT_PLAYERCHESSROGUERECORDDATA_GET_MAINSTORYCOUNT_OFFSET UNITYSDK_OFFSET(0x9FEE680)
#define RPG_CLIENT_PLAYERCHESSROGUERECORDDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x9FEE720)
#define RPG_CLIENT_PLAYERCHESSROGUERECORDDATA_GET_REGULARCABINETCNT_OFFSET UNITYSDK_OFFSET(0x9FEE6A0)
#define RPG_CLIENT_PLAYERCHESSROGUERECORDDATA_SET_AREAID_OFFSET UNITYSDK_OFFSET(0x9FEE670)
#define RPG_CLIENT_PLAYERCHESSROGUERECORDDATA_SET_DIFFICULTY_OFFSET UNITYSDK_OFFSET(0x9FEE6F0)
#define RPG_CLIENT_PLAYERCHESSROGUERECORDDATA_SET_DLCID_OFFSET UNITYSDK_OFFSET(0x9FEE710)
#define RPG_CLIENT_PLAYERCHESSROGUERECORDDATA_SET_MAINSTORYCOUNT_OFFSET UNITYSDK_OFFSET(0x9FEE690)
#define RPG_CLIENT_PLAYERCHESSROGUERECORDDATA_SET_NAME_OFFSET UNITYSDK_OFFSET(0x9FEE730)
#define RPG_CLIENT_PLAYERCHESSROGUERECORDDATA_SET_REGULARCABINETCNT_OFFSET UNITYSDK_OFFSET(0x9FEE6B0)
#define RPG_CLIENT_PLAYERCHESSROGUERECORDDATA_SYNC_OFFSET UNITYSDK_OFFSET(0x9FEE740)
#define RPG_CLIENT_PLAYERCHESSROGUERECORDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9FEE830)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 _RegularCabinetCnt_k__BackingField; // 0x2C
