...
#define RPG_CLIENT_PLAYERCHESSROGUERECORDDATA_GET_AREAID_OFFSET UNITYSDK_OFFSET(0x17DE10E0)
#define RPG_CLIENT_PLAYERCHESSROGUERECORDDATA_GET_DIFFICULTY_OFFSET UNITYSDK_OFFSET(0x17DE1160)
#define RPG_CLIENT_PLAYERCHESSROGUERECORDDATA_GET_DISPLAYTYPE_OFFSET UNITYSDK_OFFSET(0x17DE1140)
#define RPG_CLIENT_PLAYERCHESSROGUERECORDDATA_GET_DLCID_OFFSET UNITYSDK_OFFSET(0x17DE1180)
#define RPG_CLIENT_PLAYERCHESSROGUERECORDDATA_GET_HASRECORD_OFFSET UNITYSDK_OFFSET(0x17DE1150)
#define RPG_CLIENT_PLAYERCHESSROGUERECORDDATA_GET_MAINSTORYCOUNT_OFFSET UNITYSDK_OFFSET(0x17DE1100)
#define RPG_CLIENT_PLAYERCHESSROGUERECORDDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x17DE11A0)
#define RPG_CLIENT_PLAYERCHESSROGUERECORDDATA_GET_REGULARCABINETCNT_OFFSET UNITYSDK_OFFSET(0x17DE1120)
#define RPG_CLIENT_PLAYERCHESSROGUERECORDDATA_SET_AREAID_OFFSET UNITYSDK_OFFSET(0x17DE10F0)
#define RPG_CLIENT_PLAYERCHESSROGUERECORDDATA_SET_DIFFICULTY_OFFSET UNITYSDK_OFFSET(0x17DE1170)
#define RPG_CLIENT_PLAYERCHESSROGUERECORDDATA_SET_DLCID_OFFSET UNITYSDK_OFFSET(0x17DE1190)
#define RPG_CLIENT_PLAYERCHESSROGUERECORDDATA_SET_MAINSTORYCOUNT_OFFSET UNITYSDK_OFFSET(0x17DE1110)
#define RPG_CLIENT_PLAYERCHESSROGUERECORDDATA_SET_NAME_OFFSET UNITYSDK_OFFSET(0x17DE11B0)
#define RPG_CLIENT_PLAYERCHESSROGUERECORDDATA_SET_REGULARCABINETCNT_OFFSET UNITYSDK_OFFSET(0x17DE1130)
#define RPG_CLIENT_PLAYERCHESSROGUERECORDDATA_SYNC_OFFSET UNITYSDK_OFFSET(0x17DE11C0)
#define RPG_CLIENT_PLAYERCHESSROGUERECORDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17DE12B0)
