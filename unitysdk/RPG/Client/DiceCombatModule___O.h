...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Comparison_1<::RPG::Client::DiceCombat::DiceCombatShopData*>**)Il2CppClass::FromTypeDefinitionIndex(DiceCombatModule___O_TypeDefinitionIndex)->GetStaticField(0x68F40);
		}
	};
}
