...
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTELITEMONSTERITEM_GET_DESC_OFFSET UNITYSDK_OFFSET(0x92233F0)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTELITEMONSTERITEM_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x9222F10)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTELITEMONSTERITEM_GET__DMGMAXLIMIT_OFFSET UNITYSDK_OFFSET(0x9223290)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTELITEMONSTERITEM_GET__DMGPERLEFTMONSTER_OFFSET UNITYSDK_OFFSET(0x9223130)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTELITEMONSTERITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9222F00)

namespace RPG::Client
{
	inline static constexpr unsigned int FateGameRoundSettleDmgSourceLeftEliteMonsterItem_TypeDefinitionIndex = 50836;
