...
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTELITEMONSTERITEM_GET_DESC_OFFSET UNITYSDK_OFFSET(0x17911820)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTELITEMONSTERITEM_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x179113B0)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTELITEMONSTERITEM_GET__DMGMAXLIMIT_OFFSET UNITYSDK_OFFSET(0x179116C0)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTELITEMONSTERITEM_GET__DMGPERLEFTMONSTER_OFFSET UNITYSDK_OFFSET(0x17911560)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTELITEMONSTERITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x179113A0)
