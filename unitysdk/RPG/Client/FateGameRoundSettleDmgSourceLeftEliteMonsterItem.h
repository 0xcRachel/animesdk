...
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTELITEMONSTERITEM_GET_DESC_OFFSET UNITYSDK_OFFSET(0x9698700)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTELITEMONSTERITEM_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x96982A0)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTELITEMONSTERITEM_GET__DMGMAXLIMIT_OFFSET UNITYSDK_OFFSET(0x96985A0)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTELITEMONSTERITEM_GET__DMGPERLEFTMONSTER_OFFSET UNITYSDK_OFFSET(0x9698440)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTELITEMONSTERITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9698290)
