...
#define RPG_CLIENT_REPLAYGAMEPHASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14D25450)
#define RPG_CLIENT_REPLAYGAMEPHASE_ENTER_OFFSET UNITYSDK_OFFSET(0x14D254C0)
#define RPG_CLIENT_REPLAYGAMEPHASE_GET_ISREPLAYMODE_OFFSET UNITYSDK_OFFSET(0x14D25740)
#define RPG_CLIENT_REPLAYGAMEPHASE_GET_ISREPLAYOPFINISH_OFFSET UNITYSDK_OFFSET(0x14D257E0)
#define RPG_CLIENT_REPLAYGAMEPHASE_GET__REPLAYOPEXECUTANT_OFFSET UNITYSDK_OFFSET(0x14D25780)
#define RPG_CLIENT_REPLAYGAMEPHASE_ONLEVELSNAPSHOTCHECKAHEAD_OFFSET UNITYSDK_OFFSET(0x14D256E0)
#define RPG_CLIENT_REPLAYGAMEPHASE_TICK_OFFSET UNITYSDK_OFFSET(0x14D25590)
#define RPG_CLIENT_REPLAYGAMEPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x14D25380)
#define RPG_CLIENT_REPLAYGAMEPHASE__LEVELTURNENDPROCESS_OFFSET UNITYSDK_OFFSET(0x14D25640)
#define RPG_CLIENT_REPLAYGAMEPHASE___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14D25860)
#define RPG_CLIENT_REPLAYGAMEPHASE___IFIXBASEPROXY_ENTER_OFFSET UNITYSDK_OFFSET(0x14D25870)
#define RPG_CLIENT_REPLAYGAMEPHASE___IFIXBASEPROXY_GET_ISREPLAYMODE_OFFSET UNITYSDK_OFFSET(0x14D25960)
#define RPG_CLIENT_REPLAYGAMEPHASE___IFIXBASEPROXY_GET__REPLAYOPEXECUTANT_OFFSET UNITYSDK_OFFSET(0x14D259C0)
#define RPG_CLIENT_REPLAYGAMEPHASE___IFIXBASEPROXY_ONLEVELSNAPSHOTCHECKAHEAD_OFFSET UNITYSDK_OFFSET(0x14D25900)
#define RPG_CLIENT_REPLAYGAMEPHASE___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x14D25880)
#define RPG_CLIENT_REPLAYGAMEPHASE___IFIXBASEPROXY__LEVELTURNENDPROCESS_OFFSET UNITYSDK_OFFSET(0x14D25890)
