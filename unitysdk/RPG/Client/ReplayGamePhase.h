...
#define RPG_CLIENT_REPLAYGAMEPHASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9DC5B90)
#define RPG_CLIENT_REPLAYGAMEPHASE_ENTER_OFFSET UNITYSDK_OFFSET(0x9DC5C00)
#define RPG_CLIENT_REPLAYGAMEPHASE_GET_ISREPLAYMODE_OFFSET UNITYSDK_OFFSET(0x9DC5E80)
#define RPG_CLIENT_REPLAYGAMEPHASE_GET_ISREPLAYOPFINISH_OFFSET UNITYSDK_OFFSET(0x9DC5F20)
#define RPG_CLIENT_REPLAYGAMEPHASE_GET__REPLAYOPEXECUTANT_OFFSET UNITYSDK_OFFSET(0x9DC5EC0)
#define RPG_CLIENT_REPLAYGAMEPHASE_ONLEVELSNAPSHOTCHECKAHEAD_OFFSET UNITYSDK_OFFSET(0x9DC5E20)
#define RPG_CLIENT_REPLAYGAMEPHASE_TICK_OFFSET UNITYSDK_OFFSET(0x9DC5CD0)
#define RPG_CLIENT_REPLAYGAMEPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x9DC5AD0)
#define RPG_CLIENT_REPLAYGAMEPHASE__LEVELTURNENDPROCESS_OFFSET UNITYSDK_OFFSET(0x9DC5D80)
#define RPG_CLIENT_REPLAYGAMEPHASE___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9DC5FA0)
#define RPG_CLIENT_REPLAYGAMEPHASE___IFIXBASEPROXY_ENTER_OFFSET UNITYSDK_OFFSET(0x9DC5FB0)
#define RPG_CLIENT_REPLAYGAMEPHASE___IFIXBASEPROXY_GET_ISREPLAYMODE_OFFSET UNITYSDK_OFFSET(0x9DC60A0)
#define RPG_CLIENT_REPLAYGAMEPHASE___IFIXBASEPROXY_GET__REPLAYOPEXECUTANT_OFFSET UNITYSDK_OFFSET(0x9DC6110)
#define RPG_CLIENT_REPLAYGAMEPHASE___IFIXBASEPROXY_ONLEVELSNAPSHOTCHECKAHEAD_OFFSET UNITYSDK_OFFSET(0x9DC6040)
#define RPG_CLIENT_REPLAYGAMEPHASE___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x9DC5FC0)
#define RPG_CLIENT_REPLAYGAMEPHASE___IFIXBASEPROXY__LEVELTURNENDPROCESS_OFFSET UNITYSDK_OFFSET(0x9DC5FD0)

namespace RPG::Client
{
	inline static constexpr unsigned int ReplayGamePhase_TypeDefinitionIndex = 48534;
