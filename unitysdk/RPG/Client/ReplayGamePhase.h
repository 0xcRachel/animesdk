...
#define RPG_CLIENT_REPLAYGAMEPHASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x131D6090)
#define RPG_CLIENT_REPLAYGAMEPHASE_ENTER_OFFSET UNITYSDK_OFFSET(0x131D6100)
#define RPG_CLIENT_REPLAYGAMEPHASE_GET_ISREPLAYMODE_OFFSET UNITYSDK_OFFSET(0x131D6380)
#define RPG_CLIENT_REPLAYGAMEPHASE_GET_ISREPLAYOPFINISH_OFFSET UNITYSDK_OFFSET(0x131D6420)
#define RPG_CLIENT_REPLAYGAMEPHASE_GET__REPLAYOPEXECUTANT_OFFSET UNITYSDK_OFFSET(0x131D63C0)
#define RPG_CLIENT_REPLAYGAMEPHASE_ONLEVELSNAPSHOTCHECKAHEAD_OFFSET UNITYSDK_OFFSET(0x131D6320)
#define RPG_CLIENT_REPLAYGAMEPHASE_TICK_OFFSET UNITYSDK_OFFSET(0x131D61D0)
#define RPG_CLIENT_REPLAYGAMEPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x131D5FC0)
#define RPG_CLIENT_REPLAYGAMEPHASE__LEVELTURNENDPROCESS_OFFSET UNITYSDK_OFFSET(0x131D6280)
#define RPG_CLIENT_REPLAYGAMEPHASE___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x131D64A0)
#define RPG_CLIENT_REPLAYGAMEPHASE___IFIXBASEPROXY_ENTER_OFFSET UNITYSDK_OFFSET(0x131D64B0)
#define RPG_CLIENT_REPLAYGAMEPHASE___IFIXBASEPROXY_GET_ISREPLAYMODE_OFFSET UNITYSDK_OFFSET(0x131D65A0)
#define RPG_CLIENT_REPLAYGAMEPHASE___IFIXBASEPROXY_GET__REPLAYOPEXECUTANT_OFFSET UNITYSDK_OFFSET(0x131D6610)
#define RPG_CLIENT_REPLAYGAMEPHASE___IFIXBASEPROXY_ONLEVELSNAPSHOTCHECKAHEAD_OFFSET UNITYSDK_OFFSET(0x131D6540)
#define RPG_CLIENT_REPLAYGAMEPHASE___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x131D64C0)
#define RPG_CLIENT_REPLAYGAMEPHASE___IFIXBASEPROXY__LEVELTURNENDPROCESS_OFFSET UNITYSDK_OFFSET(0x131D64D0)
