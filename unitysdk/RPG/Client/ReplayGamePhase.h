...
#define RPG_CLIENT_REPLAYGAMEPHASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA2E6860)
#define RPG_CLIENT_REPLAYGAMEPHASE_ENTER_OFFSET UNITYSDK_OFFSET(0xA2E68D0)
#define RPG_CLIENT_REPLAYGAMEPHASE_GET_ISREPLAYMODE_OFFSET UNITYSDK_OFFSET(0xA2E6B50)
#define RPG_CLIENT_REPLAYGAMEPHASE_GET_ISREPLAYOPFINISH_OFFSET UNITYSDK_OFFSET(0xA2E6BF0)
#define RPG_CLIENT_REPLAYGAMEPHASE_GET__REPLAYOPEXECUTANT_OFFSET UNITYSDK_OFFSET(0xA2E6B90)
#define RPG_CLIENT_REPLAYGAMEPHASE_ONLEVELSNAPSHOTCHECKAHEAD_OFFSET UNITYSDK_OFFSET(0xA2E6AF0)
#define RPG_CLIENT_REPLAYGAMEPHASE_TICK_OFFSET UNITYSDK_OFFSET(0xA2E69A0)
#define RPG_CLIENT_REPLAYGAMEPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0xA2E6790)
#define RPG_CLIENT_REPLAYGAMEPHASE__LEVELTURNENDPROCESS_OFFSET UNITYSDK_OFFSET(0xA2E6A50)
#define RPG_CLIENT_REPLAYGAMEPHASE___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA2E6C70)
#define RPG_CLIENT_REPLAYGAMEPHASE___IFIXBASEPROXY_ENTER_OFFSET UNITYSDK_OFFSET(0xA2E6C80)
#define RPG_CLIENT_REPLAYGAMEPHASE___IFIXBASEPROXY_GET_ISREPLAYMODE_OFFSET UNITYSDK_OFFSET(0xA2E6D70)
#define RPG_CLIENT_REPLAYGAMEPHASE___IFIXBASEPROXY_GET__REPLAYOPEXECUTANT_OFFSET UNITYSDK_OFFSET(0xA2E6DE0)
#define RPG_CLIENT_REPLAYGAMEPHASE___IFIXBASEPROXY_ONLEVELSNAPSHOTCHECKAHEAD_OFFSET UNITYSDK_OFFSET(0xA2E6D10)
#define RPG_CLIENT_REPLAYGAMEPHASE___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0xA2E6C90)
#define RPG_CLIENT_REPLAYGAMEPHASE___IFIXBASEPROXY__LEVELTURNENDPROCESS_OFFSET UNITYSDK_OFFSET(0xA2E6CA0)
