...
#define RPG_CLIENT_PROPINTERACTMUTEINPUTACTIONPARAM_METHOD_3_AA8D19CD2E4E7E54_OFFSET UNITYSDK_OFFSET(0x1676AC90)
#define RPG_CLIENT_PROPINTERACTMUTEINPUTACTIONPARAM_METHOD_3_FE31181E7D31147F_OFFSET UNITYSDK_OFFSET(0x1676BDB0)
#define RPG_CLIENT_PROPINTERACTMUTEINPUTACTIONPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1676AC80)
