...
#define RPG_CLIENT_MATCHTHREEBOARD___C__DISPLAYCLASS28_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9652030)
#define RPG_CLIENT_MATCHTHREEBOARD___C__DISPLAYCLASS28_0__DOFLYEFFECTFROMSKILLTOPROP_B__0_OFFSET UNITYSDK_OFFSET(0x9658F60)
#define RPG_CLIENT_MATCHTHREEBOARD___C__DISPLAYCLASS28_0__DOFLYEFFECTFROMSKILLTOPROP_B__1_OFFSET UNITYSDK_OFFSET(0x9658F70)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeBoard___c__DisplayClass28_0_TypeDefinitionIndex = 52395;
