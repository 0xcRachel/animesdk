...
#define RPG_CLIENT_MONOUIPANELDISPLAY_ADDPANEL_OFFSET UNITYSDK_OFFSET(0x98772A0)
#define RPG_CLIENT_MONOUIPANELDISPLAY_GETPANELS_OFFSET UNITYSDK_OFFSET(0x9877330)
#define RPG_CLIENT_MONOUIPANELDISPLAY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9877370)
#define RPG_CLIENT_MONOUIPANELDISPLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x98773E0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoUIPanelDisplay_TypeDefinitionIndex = 58225;
