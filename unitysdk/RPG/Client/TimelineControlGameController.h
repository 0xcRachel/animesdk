...
#define RPG_CLIENT_TIMELINECONTROLGAMECONTROLLER_GET_TIMELINELENGTH_OFFSET UNITYSDK_OFFSET(0xA0BFB50)
#define RPG_CLIENT_TIMELINECONTROLGAMECONTROLLER_GET_UPDATESYSTEMS_OFFSET UNITYSDK_OFFSET(0xA0BFA50)
#define RPG_CLIENT_TIMELINECONTROLGAMECONTROLLER_ONACTIONPROTECTTIMEOVER_OFFSET UNITYSDK_OFFSET(0xA0BFB00)
#define RPG_CLIENT_TIMELINECONTROLGAMECONTROLLER_ONACTIONTRIGGERED_OFFSET UNITYSDK_OFFSET(0xA0BFA70)
#define RPG_CLIENT_TIMELINECONTROLGAMECONTROLLER_ONPLAYERFAIL_OFFSET UNITYSDK_OFFSET(0xA0BFC60)
#define RPG_CLIENT_TIMELINECONTROLGAMECONTROLLER_ONPLAYFINISH_OFFSET UNITYSDK_OFFSET(0xA0BFCE0)
#define RPG_CLIENT_TIMELINECONTROLGAMECONTROLLER_ONRESTOREMOVEMENTFAILED_OFFSET UNITYSDK_OFFSET(0xA0BFC00)
#define RPG_CLIENT_TIMELINECONTROLGAMECONTROLLER_ONTIMELINEPOINTCHANGE_OFFSET UNITYSDK_OFFSET(0xA0BFB70)
#define RPG_CLIENT_TIMELINECONTROLGAMECONTROLLER_SET_TIMELINELENGTH_OFFSET UNITYSDK_OFFSET(0xA0BFB60)
#define RPG_CLIENT_TIMELINECONTROLGAMECONTROLLER_SET_UPDATESYSTEMS_OFFSET UNITYSDK_OFFSET(0xA0BFA60)
#define RPG_CLIENT_TIMELINECONTROLGAMECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA0BFD30)

namespace RPG::Client
{
	inline static constexpr unsigned int TimelineControlGameController_TypeDefinitionIndex = 47864;
