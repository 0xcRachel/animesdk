...
#define RPG_CLIENT_TIMELINECONTROLGAMECONTROLLER_GET_TIMELINELENGTH_OFFSET UNITYSDK_OFFSET(0x1515DF80)
#define RPG_CLIENT_TIMELINECONTROLGAMECONTROLLER_GET_UPDATESYSTEMS_OFFSET UNITYSDK_OFFSET(0x1515DE80)
#define RPG_CLIENT_TIMELINECONTROLGAMECONTROLLER_ONACTIONPROTECTTIMEOVER_OFFSET UNITYSDK_OFFSET(0x1515DF30)
#define RPG_CLIENT_TIMELINECONTROLGAMECONTROLLER_ONACTIONTRIGGERED_OFFSET UNITYSDK_OFFSET(0x1515DEA0)
#define RPG_CLIENT_TIMELINECONTROLGAMECONTROLLER_ONPLAYERFAIL_OFFSET UNITYSDK_OFFSET(0x1515E090)
#define RPG_CLIENT_TIMELINECONTROLGAMECONTROLLER_ONPLAYFINISH_OFFSET UNITYSDK_OFFSET(0x1515E110)
#define RPG_CLIENT_TIMELINECONTROLGAMECONTROLLER_ONRESTOREMOVEMENTFAILED_OFFSET UNITYSDK_OFFSET(0x1515E030)
#define RPG_CLIENT_TIMELINECONTROLGAMECONTROLLER_ONTIMELINEPOINTCHANGE_OFFSET UNITYSDK_OFFSET(0x1515DFA0)
#define RPG_CLIENT_TIMELINECONTROLGAMECONTROLLER_SET_TIMELINELENGTH_OFFSET UNITYSDK_OFFSET(0x1515DF90)
#define RPG_CLIENT_TIMELINECONTROLGAMECONTROLLER_SET_UPDATESYSTEMS_OFFSET UNITYSDK_OFFSET(0x1515DE90)
#define RPG_CLIENT_TIMELINECONTROLGAMECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1515E160)
