...
#define RPG_CLIENT_TIMELINECONTROLGAMECONTROLLER_GET_TIMELINELENGTH_OFFSET UNITYSDK_OFFSET(0xA5E5B40)
#define RPG_CLIENT_TIMELINECONTROLGAMECONTROLLER_GET_UPDATESYSTEMS_OFFSET UNITYSDK_OFFSET(0xA5E5A40)
#define RPG_CLIENT_TIMELINECONTROLGAMECONTROLLER_ONACTIONPROTECTTIMEOVER_OFFSET UNITYSDK_OFFSET(0xA5E5AF0)
#define RPG_CLIENT_TIMELINECONTROLGAMECONTROLLER_ONACTIONTRIGGERED_OFFSET UNITYSDK_OFFSET(0xA5E5A60)
#define RPG_CLIENT_TIMELINECONTROLGAMECONTROLLER_ONPLAYERFAIL_OFFSET UNITYSDK_OFFSET(0xA5E5C50)
#define RPG_CLIENT_TIMELINECONTROLGAMECONTROLLER_ONPLAYFINISH_OFFSET UNITYSDK_OFFSET(0xA5E5CD0)
#define RPG_CLIENT_TIMELINECONTROLGAMECONTROLLER_ONRESTOREMOVEMENTFAILED_OFFSET UNITYSDK_OFFSET(0xA5E5BF0)
#define RPG_CLIENT_TIMELINECONTROLGAMECONTROLLER_ONTIMELINEPOINTCHANGE_OFFSET UNITYSDK_OFFSET(0xA5E5B60)
#define RPG_CLIENT_TIMELINECONTROLGAMECONTROLLER_SET_TIMELINELENGTH_OFFSET UNITYSDK_OFFSET(0xA5E5B50)
#define RPG_CLIENT_TIMELINECONTROLGAMECONTROLLER_SET_UPDATESYSTEMS_OFFSET UNITYSDK_OFFSET(0xA5E5A50)
#define RPG_CLIENT_TIMELINECONTROLGAMECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA5E5D20)
