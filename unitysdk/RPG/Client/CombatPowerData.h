...
#define RPG_CLIENT_COMBATPOWERDATA_GETCOMBATPOWERVALUE_OFFSET UNITYSDK_OFFSET(0x8FB5210)
#define RPG_CLIENT_COMBATPOWERDATA_GETTOTALCOMBATPOWERVALUE_OFFSET UNITYSDK_OFFSET(0x8FB5170)
#define RPG_CLIENT_COMBATPOWERDATA_GETTOTALCOMBATPOWERVALUE_SERVER_OFFSET UNITYSDK_OFFSET(0x8FB51C0)
#define RPG_CLIENT_COMBATPOWERDATA_GET__AVATARDATA_OFFSET UNITYSDK_OFFSET(0x8FB53E0)
#define RPG_CLIENT_COMBATPOWERDATA_SETCOMBATPOWER_OFFSET UNITYSDK_OFFSET(0x8FB50E0)
#define RPG_CLIENT_COMBATPOWERDATA_SET__AVATARDATA_OFFSET UNITYSDK_OFFSET(0x8FB53F0)
#define RPG_CLIENT_COMBATPOWERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8FB4F30)

namespace RPG::Client
{
	inline static constexpr unsigned int CombatPowerData_TypeDefinitionIndex = 49650;
