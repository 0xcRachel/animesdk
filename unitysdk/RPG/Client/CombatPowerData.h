...
#define RPG_CLIENT_COMBATPOWERDATA_GETCOMBATPOWERVALUE_OFFSET UNITYSDK_OFFSET(0x9410620)
#define RPG_CLIENT_COMBATPOWERDATA_GETTOTALCOMBATPOWERVALUE_OFFSET UNITYSDK_OFFSET(0x9410580)
#define RPG_CLIENT_COMBATPOWERDATA_GETTOTALCOMBATPOWERVALUE_SERVER_OFFSET UNITYSDK_OFFSET(0x94105D0)
#define RPG_CLIENT_COMBATPOWERDATA_GET__AVATARDATA_OFFSET UNITYSDK_OFFSET(0x94107B0)
#define RPG_CLIENT_COMBATPOWERDATA_SETCOMBATPOWER_OFFSET UNITYSDK_OFFSET(0x94104F0)
#define RPG_CLIENT_COMBATPOWERDATA_SET__AVATARDATA_OFFSET UNITYSDK_OFFSET(0x94107C0)
#define RPG_CLIENT_COMBATPOWERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9410340)
