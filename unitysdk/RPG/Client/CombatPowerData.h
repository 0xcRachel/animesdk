...
#define RPG_CLIENT_COMBATPOWERDATA_GETCOMBATPOWERVALUE_OFFSET UNITYSDK_OFFSET(0x15BD9440)
#define RPG_CLIENT_COMBATPOWERDATA_GETTOTALCOMBATPOWERVALUE_OFFSET UNITYSDK_OFFSET(0x15BD93A0)
#define RPG_CLIENT_COMBATPOWERDATA_GETTOTALCOMBATPOWERVALUE_SERVER_OFFSET UNITYSDK_OFFSET(0x15BD93F0)
#define RPG_CLIENT_COMBATPOWERDATA_GET__AVATARDATA_OFFSET UNITYSDK_OFFSET(0x15BD95D0)
#define RPG_CLIENT_COMBATPOWERDATA_SETCOMBATPOWER_OFFSET UNITYSDK_OFFSET(0x15BD9310)
#define RPG_CLIENT_COMBATPOWERDATA_SET__AVATARDATA_OFFSET UNITYSDK_OFFSET(0x15BD95E0)
#define RPG_CLIENT_COMBATPOWERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x15BD9160)
