...
#define RPG_CLIENT_TEMPLATEMONOBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xA06C8F0)

namespace RPG::Client
{
	inline static constexpr unsigned int TemplateMonoBase_TypeDefinitionIndex = 56407;
