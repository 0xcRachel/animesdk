...
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPBEHAVIOR___ASYNCINITIRICOMBINEDINSTANCES_D__2_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1514D120)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPBEHAVIOR___ASYNCINITIRICOMBINEDINSTANCES_D__2_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_WORK_IASYNCWORKSTEPRESULT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1514E330)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPBEHAVIOR___ASYNCINITIRICOMBINEDINSTANCES_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1514E390)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPBEHAVIOR___ASYNCINITIRICOMBINEDINSTANCES_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1514E340)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPBEHAVIOR___ASYNCINITIRICOMBINEDINSTANCES_D__2_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1514D0D0)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPBEHAVIOR___ASYNCINITIRICOMBINEDINSTANCES_D__2__CTOR_OFFSET UNITYSDK_OFFSET(0x151441C0)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPBEHAVIOR___ASYNCINITIRICOMBINEDINSTANCES_D__2___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1514D100)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPBEHAVIOR___ASYNCINITIRICOMBINEDINSTANCES_D__2___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1514D110)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Collections::Generic::List_1_Enumerator<::Class_1_0BF4BC17BA691114*> __7__wrap13; // 0x60
		::Class_0_16E4307DCC419505_265* __2__current; // 0x78
		::UnityEngine::Mesh* _targetMesh_5__6; // 0x80
		::RPG::Client::TimeSpaceCrisscrossIRIMonoPlugin_TSCInstanceData* _data_5__11; // 0x88
		::RPG::Client::LiteInstancedItem::ItemPrototype* _prototypeNormal_5__8; // 0x90
		::RPG::Client::LiteInstancedItem::ItemPrototype* _prototypeNormalDeformation_5__9; // 0x98
		::RPG::Client::TimeSpaceCrisscrossGroupBehavior* __4__this; // 0xA0
		::Class_1_0BF4BC17BA691114* _tscItemInstance_5__15; // 0xA8
		::System::Boolean _includeDeformation_5__12; // 0xB0
		::System::Int32 workID; // 0xB4
		::System::Int32 _j_5__13; // 0xB8
		::System::Int32 _i_5__10; // 0xBC
		::System::Int32 _batchSize_5__2; // 0xC0
		::System::Int32 _batchCounter_5__3; // 0xC4
		::System::Int32 __1__state; // 0xC8
