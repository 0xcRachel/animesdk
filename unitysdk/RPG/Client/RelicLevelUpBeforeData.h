...
#define RPG_CLIENT_RELICLEVELUPBEFOREDATA_COPYTO_OFFSET UNITYSDK_OFFSET(0x9D901A0)
#define RPG_CLIENT_RELICLEVELUPBEFOREDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9D90050)

namespace RPG::Client
{
	inline static constexpr unsigned int RelicLevelUpBeforeData_TypeDefinitionIndex = 53260;
