...
#define RPG_CLIENT_MATERIALGROUPASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x96D8B80)

namespace RPG::Client
{
	inline static constexpr unsigned int MaterialGroupAsset_TypeDefinitionIndex = 55562;
