...
#define RPG_CLIENT_STAGESETTLEINFO___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x161FFBF0)
#define RPG_CLIENT_STAGESETTLEINFO___C__CTOR_OFFSET UNITYSDK_OFFSET(0x161FFC30)
#define RPG_CLIENT_STAGESETTLEINFO___C___CTOR_B__0_0_OFFSET UNITYSDK_OFFSET(0x161FFC40)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Func_2<::Class_1_23C1B7E6B450FFB8_6*, ::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(StageSettleInfo___c_TypeDefinitionIndex)->GetStaticField(0x3F540);
		}
		static ::RPG::Client::StageSettleInfo___c** StaticGet___9()
		{
			return (::RPG::Client::StageSettleInfo___c**)Il2CppClass::FromTypeDefinitionIndex(StageSettleInfo___c_TypeDefinitionIndex)->GetStaticField(0x3F548);
		}
