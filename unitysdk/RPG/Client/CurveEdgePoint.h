...
#define RPG_CLIENT_CURVEEDGEPOINT_GET_EMPTYPOINT_OFFSET UNITYSDK_OFFSET(0x9442420)
#define RPG_CLIENT_CURVEEDGEPOINT_METHOD_2_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x7C950)
#define RPG_CLIENT_CURVEEDGEPOINT_METHOD_2_9D255C917A1DECA7_OFFSET UNITYSDK_OFFSET(0x7CA20)
#define RPG_CLIENT_CURVEEDGEPOINT_METHOD_2_F5758E0A6FE89A9D_OFFSET UNITYSDK_OFFSET(0x7C9B0)
#define RPG_CLIENT_CURVEEDGEPOINT__CCTOR_OFFSET UNITYSDK_OFFSET(0x9442810)
...
namespace RPG::Client
{
	...
	struct alignas(8) CurveEdgePoint
	{
		...
		{
			return (::RPG::Client::CurveEdgePoint*)Il2CppClass::FromTypeDefinitionIndex(CurveEdgePoint_TypeDefinitionIndex)->GetStaticField(0x48160);
		}
