...
#define RPG_CLIENT_CAMERANORMALCONFIGTEMPLATELIST_METHOD_3_8560D34C440F7DEB_OFFSET UNITYSDK_OFFSET(0x18FB32C0)
#define RPG_CLIENT_CAMERANORMALCONFIGTEMPLATELIST__CTOR_OFFSET UNITYSDK_OFFSET(0x18FBA5D0)
