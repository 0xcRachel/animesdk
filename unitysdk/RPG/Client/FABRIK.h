...
#define RPG_CLIENT_FABRIK_AWAKE_OFFSET UNITYSDK_OFFSET(0x9661270)
#define RPG_CLIENT_FABRIK_GET_ISPROCESSABLE_OFFSET UNITYSDK_OFFSET(0x9660CB0)
#define RPG_CLIENT_FABRIK_GET_WEIGHT_OFFSET UNITYSDK_OFFSET(0x9660D40)
#define RPG_CLIENT_FABRIK_IKRESET_OFFSET UNITYSDK_OFFSET(0x96611E0)
#define RPG_CLIENT_FABRIK_PROCESS_OFFSET UNITYSDK_OFFSET(0x9660F10)
#define RPG_CLIENT_FABRIK_SAFEINIT_OFFSET UNITYSDK_OFFSET(0x9660D90)
#define RPG_CLIENT_FABRIK__CTOR_OFFSET UNITYSDK_OFFSET(0x96612C0)
