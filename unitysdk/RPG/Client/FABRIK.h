...
#define RPG_CLIENT_FABRIK_AWAKE_OFFSET UNITYSDK_OFFSET(0x91B4830)
#define RPG_CLIENT_FABRIK_GET_ISPROCESSABLE_OFFSET UNITYSDK_OFFSET(0x91B4270)
#define RPG_CLIENT_FABRIK_GET_WEIGHT_OFFSET UNITYSDK_OFFSET(0x91B4300)
#define RPG_CLIENT_FABRIK_IKRESET_OFFSET UNITYSDK_OFFSET(0x91B47A0)
#define RPG_CLIENT_FABRIK_PROCESS_OFFSET UNITYSDK_OFFSET(0x91B44D0)
#define RPG_CLIENT_FABRIK_SAFEINIT_OFFSET UNITYSDK_OFFSET(0x91B4350)
#define RPG_CLIENT_FABRIK__CTOR_OFFSET UNITYSDK_OFFSET(0x91B4880)

namespace RPG::Client
{
	inline static constexpr unsigned int FABRIK_TypeDefinitionIndex = 54294;
