...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOOM_METHOD_6_69225B22C8D30B3E_OFFSET UNITYSDK_OFFSET(0xA7A1070)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOOM_METHOD_6_775B6D644F07B554_OFFSET UNITYSDK_OFFSET(0xA7A1060)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOOM_METHOD_6_890F5FC885825F9E_OFFSET UNITYSDK_OFFSET(0xA7A0E60)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOOM_METHOD_6_B961D33AD47A2113_OFFSET UNITYSDK_OFFSET(0xA7A0D10)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOOM__CTOR_OFFSET UNITYSDK_OFFSET(0xA7A0F50)
