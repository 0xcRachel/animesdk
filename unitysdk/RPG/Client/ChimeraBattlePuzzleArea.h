...
#define RPG_CLIENT_CHIMERABATTLEPUZZLEAREA_GET_TEAMMEMBERANCHORS_OFFSET UNITYSDK_OFFSET(0x93975C0)
#define RPG_CLIENT_CHIMERABATTLEPUZZLEAREA_METHOD_5_51BBA01F511E6107_OFFSET UNITYSDK_OFFSET(0x9396C20)
#define RPG_CLIENT_CHIMERABATTLEPUZZLEAREA_START_OFFSET UNITYSDK_OFFSET(0x9396A50)
#define RPG_CLIENT_CHIMERABATTLEPUZZLEAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x9397620)
