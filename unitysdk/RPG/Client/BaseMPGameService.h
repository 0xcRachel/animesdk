...
#define RPG_CLIENT_BASEMPGAMESERVICE_ACCEPTINVITATION_OFFSET UNITYSDK_OFFSET(0x15E65940)
#define RPG_CLIENT_BASEMPGAMESERVICE_CANCELMATCH_OFFSET UNITYSDK_OFFSET(0x15E655E0)
#define RPG_CLIENT_BASEMPGAMESERVICE_CHECKCANENTERMPGAME_OFFSET UNITYSDK_OFFSET(0x15E66380)
#define RPG_CLIENT_BASEMPGAMESERVICE_CHECKRECONNECTTOFIGHT_OFFSET UNITYSDK_OFFSET(0x15E65AB0)
#define RPG_CLIENT_BASEMPGAMESERVICE_CREATELOBBY_OFFSET UNITYSDK_OFFSET(0x15E64C60)
#define RPG_CLIENT_BASEMPGAMESERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15E66120)
#define RPG_CLIENT_BASEMPGAMESERVICE_INVITE_OFFSET UNITYSDK_OFFSET(0x15E658E0)
#define RPG_CLIENT_BASEMPGAMESERVICE_JOINLOBBY_OFFSET UNITYSDK_OFFSET(0x15E650C0)
#define RPG_CLIENT_BASEMPGAMESERVICE_ONCREATEGAME_OFFSET UNITYSDK_OFFSET(0x15E66410)
#define RPG_CLIENT_BASEMPGAMESERVICE_ONFINISHGAME_OFFSET UNITYSDK_OFFSET(0x15E66500)
#define RPG_CLIENT_BASEMPGAMESERVICE_ONGENERALNOTIFY_OFFSET UNITYSDK_OFFSET(0x15E666B0)
#define RPG_CLIENT_BASEMPGAMESERVICE_ONONGENERALRSP_OFFSET UNITYSDK_OFFSET(0x15E66660)
#define RPG_CLIENT_BASEMPGAMESERVICE_ONSERVERCONNECTED_OFFSET UNITYSDK_OFFSET(0x15E665A0)
#define RPG_CLIENT_BASEMPGAMESERVICE_ONSERVERCONNECTFAIL_OFFSET UNITYSDK_OFFSET(0x15E665E0)
#define RPG_CLIENT_BASEMPGAMESERVICE_ONSERVERDISCONNECTED_OFFSET UNITYSDK_OFFSET(0x15E66620)
#define RPG_CLIENT_BASEMPGAMESERVICE_ONSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x15E663C0)
#define RPG_CLIENT_BASEMPGAMESERVICE_REMINDPREPARE_OFFSET UNITYSDK_OFFSET(0x15E65640)
#define RPG_CLIENT_BASEMPGAMESERVICE_STARTMATCH_OFFSET UNITYSDK_OFFSET(0x15E65570)
#define RPG_CLIENT_BASEMPGAMESERVICE_TRYGIVEUP_OFFSET UNITYSDK_OFFSET(0x15E65A60)
#define RPG_CLIENT_BASEMPGAMESERVICE_TRYQUITLOBBY_OFFSET UNITYSDK_OFFSET(0x15E654B0)
#define RPG_CLIENT_BASEMPGAMESERVICE_TRYRECONNECTTOFIGHT_OFFSET UNITYSDK_OFFSET(0x15E65D90)
#define RPG_CLIENT_BASEMPGAMESERVICE_VALIDATEINVITATION_OFFSET UNITYSDK_OFFSET(0x15E66700)
#define RPG_CLIENT_BASEMPGAMESERVICE__CHECKRECONNECTTOFIGHT_B__10_0_OFFSET UNITYSDK_OFFSET(0x15E66830)
#define RPG_CLIENT_BASEMPGAMESERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x15E64BD0)
#define RPG_CLIENT_BASEMPGAMESERVICE__INIT_OFFSET UNITYSDK_OFFSET(0x15E66020)
#define RPG_CLIENT_BASEMPGAMESERVICE__ONMPSESSIONSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x15E66770)
...
namespace RPG::Client
{
	...
	{
	public:
		::Class_2_FD1781FBF85A46E5* _SessionService; // 0x10
		::Class_1_9DB8CECD03D9FBBA* _InviteService; // 0x18
