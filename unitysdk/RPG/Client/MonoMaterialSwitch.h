...
#define RPG_CLIENT_MONOMATERIALSWITCH_ONENABLE_OFFSET UNITYSDK_OFFSET(0x162D4730)
#define RPG_CLIENT_MONOMATERIALSWITCH_RECOVERMATERIAL_OFFSET UNITYSDK_OFFSET(0x162D4860)
#define RPG_CLIENT_MONOMATERIALSWITCH_START_OFFSET UNITYSDK_OFFSET(0x162D45F0)
#define RPG_CLIENT_MONOMATERIALSWITCH_SWITCHMATERIAL_OFFSET UNITYSDK_OFFSET(0x162D4780)
#define RPG_CLIENT_MONOMATERIALSWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x162D49D0)
#define RPG_CLIENT_MONOMATERIALSWITCH__SETMATERIAL_OFFSET UNITYSDK_OFFSET(0x162D4800)
#define RPG_CLIENT_MONOMATERIALSWITCH__TRYCACHEUI_OFFSET UNITYSDK_OFFSET(0x162D48F0)
#define RPG_CLIENT_MONOMATERIALSWITCH__UPDATEMATERIAL_OFFSET UNITYSDK_OFFSET(0x162D4640)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoMaterialSwitch_TypeDefinitionIndex = 66884;
