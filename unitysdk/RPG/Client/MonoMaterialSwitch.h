...
#define RPG_CLIENT_MONOMATERIALSWITCH_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9848940)
#define RPG_CLIENT_MONOMATERIALSWITCH_RECOVERMATERIAL_OFFSET UNITYSDK_OFFSET(0x9848A70)
#define RPG_CLIENT_MONOMATERIALSWITCH_START_OFFSET UNITYSDK_OFFSET(0x9848800)
#define RPG_CLIENT_MONOMATERIALSWITCH_SWITCHMATERIAL_OFFSET UNITYSDK_OFFSET(0x9848990)
#define RPG_CLIENT_MONOMATERIALSWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x9848BE0)
#define RPG_CLIENT_MONOMATERIALSWITCH__SETMATERIAL_OFFSET UNITYSDK_OFFSET(0x9848A10)
#define RPG_CLIENT_MONOMATERIALSWITCH__TRYCACHEUI_OFFSET UNITYSDK_OFFSET(0x9848B00)
#define RPG_CLIENT_MONOMATERIALSWITCH__UPDATEMATERIAL_OFFSET UNITYSDK_OFFSET(0x9848850)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoMaterialSwitch_TypeDefinitionIndex = 57861;
