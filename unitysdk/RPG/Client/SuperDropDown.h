...
#define RPG_CLIENT_SUPERDROPDOWN_ADDITEM_OFFSET UNITYSDK_OFFSET(0x9FE1FD0)
#define RPG_CLIENT_SUPERDROPDOWN_ADDOPTIONS_1_OFFSET UNITYSDK_OFFSET(0x9FE1BE0)
#define RPG_CLIENT_SUPERDROPDOWN_ADDOPTIONS_2_OFFSET UNITYSDK_OFFSET(0x9FE1CD0)
#define RPG_CLIENT_SUPERDROPDOWN_ADDOPTIONS_3_OFFSET UNITYSDK_OFFSET(0x9FE1DD0)
#define RPG_CLIENT_SUPERDROPDOWN_ADDOPTIONS_4_OFFSET UNITYSDK_OFFSET(0x9FE1F00)
#define RPG_CLIENT_SUPERDROPDOWN_ADDOPTIONS_OFFSET UNITYSDK_OFFSET(0x9FE1B30)
#define RPG_CLIENT_SUPERDROPDOWN_AWAKE_OFFSET UNITYSDK_OFFSET(0x9FE0700)
#define RPG_CLIENT_SUPERDROPDOWN_BINDTOGGLECHANGEDFUNCTION_OFFSET UNITYSDK_OFFSET(0x9FE26B0)
#define RPG_CLIENT_SUPERDROPDOWN_CLEAROPTIONS_OFFSET UNITYSDK_OFFSET(0x9FE0E40)
#define RPG_CLIENT_SUPERDROPDOWN_GET_TURNOFFCHECKVALUE_OFFSET UNITYSDK_OFFSET(0x9FE1FB0)
#define RPG_CLIENT_SUPERDROPDOWN_HASSTATE_OFFSET UNITYSDK_OFFSET(0x9FE17C0)
#define RPG_CLIENT_SUPERDROPDOWN_ONDESELECT_OFFSET UNITYSDK_OFFSET(0x9FE1A10)
#define RPG_CLIENT_SUPERDROPDOWN_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9FE08F0)
#define RPG_CLIENT_SUPERDROPDOWN_ONPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0x9FE1150)
#define RPG_CLIENT_SUPERDROPDOWN_ONPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0x9FE1050)
#define RPG_CLIENT_SUPERDROPDOWN_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x9FE0F30)
#define RPG_CLIENT_SUPERDROPDOWN_ONSELECTITEM_OFFSET UNITYSDK_OFFSET(0x9FE12E0)
#define RPG_CLIENT_SUPERDROPDOWN_ONSELECT_OFFSET UNITYSDK_OFFSET(0x9FE1870)
#define RPG_CLIENT_SUPERDROPDOWN_REFRESHSHOWNVALUE_OFFSET UNITYSDK_OFFSET(0x9FE0AB0)
#define RPG_CLIENT_SUPERDROPDOWN_SETCHECKED_OFFSET UNITYSDK_OFFSET(0x9FE15B0)
#define RPG_CLIENT_SUPERDROPDOWN_SETLUABINDINGCALLBACK_OFFSET UNITYSDK_OFFSET(0x9FE2640)
#define RPG_CLIENT_SUPERDROPDOWN_SETOPTIONSCOUNT_OFFSET UNITYSDK_OFFSET(0x9FE2700)
#define RPG_CLIENT_SUPERDROPDOWN_SET_OFFSET UNITYSDK_OFFSET(0x9FE0990)
#define RPG_CLIENT_SUPERDROPDOWN_SET_TURNOFFCHECKVALUE_OFFSET UNITYSDK_OFFSET(0x9FE1FC0)
#define RPG_CLIENT_SUPERDROPDOWN_START_OFFSET UNITYSDK_OFFSET(0x9FE0810)
#define RPG_CLIENT_SUPERDROPDOWN_UPDATE_OFFSET UNITYSDK_OFFSET(0x9FE0530)
#define RPG_CLIENT_SUPERDROPDOWN__ANIMATORCHECK_OFFSET UNITYSDK_OFFSET(0x9FE16D0)
#define RPG_CLIENT_SUPERDROPDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x9FE2860)
#define RPG_CLIENT_SUPERDROPDOWN__INITNAVIGATIONMODE_OFFSET UNITYSDK_OFFSET(0x9FE25B0)
#define RPG_CLIENT_SUPERDROPDOWN__ONUIINCONTROLTIPUPDATE_OFFSET UNITYSDK_OFFSET(0x9FE2440)
#define RPG_CLIENT_SUPERDROPDOWN___IFIXBASEPROXY_ADDITEM_OFFSET UNITYSDK_OFFSET(0x9FE2CC0)
#define RPG_CLIENT_SUPERDROPDOWN___IFIXBASEPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0x9FE28A0)
#define RPG_CLIENT_SUPERDROPDOWN___IFIXBASEPROXY_ONDESELECT_OFFSET UNITYSDK_OFFSET(0x9FE2C10)
#define RPG_CLIENT_SUPERDROPDOWN___IFIXBASEPROXY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9FE2990)
#define RPG_CLIENT_SUPERDROPDOWN___IFIXBASEPROXY_ONPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0x9FE2B40)
#define RPG_CLIENT_SUPERDROPDOWN___IFIXBASEPROXY_ONPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0x9FE2A90)
#define RPG_CLIENT_SUPERDROPDOWN___IFIXBASEPROXY_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x9FE29C0)
#define RPG_CLIENT_SUPERDROPDOWN___IFIXBASEPROXY_ONSELECTITEM_OFFSET UNITYSDK_OFFSET(0x9FE2B50)
#define RPG_CLIENT_SUPERDROPDOWN___IFIXBASEPROXY_ONSELECT_OFFSET UNITYSDK_OFFSET(0x9FE2B60)
#define RPG_CLIENT_SUPERDROPDOWN___IFIXBASEPROXY_SET_OFFSET UNITYSDK_OFFSET(0x9FE29B0)
#define RPG_CLIENT_SUPERDROPDOWN___IFIXBASEPROXY_START_OFFSET UNITYSDK_OFFSET(0x9FE2940)

namespace RPG::Client
{
	inline static constexpr unsigned int SuperDropDown_TypeDefinitionIndex = 57935;
