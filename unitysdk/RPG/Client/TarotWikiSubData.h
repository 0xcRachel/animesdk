...
#define RPG_CLIENT_TAROTWIKISUBDATA_GET_APPLYINGCHANGEID_OFFSET UNITYSDK_OFFSET(0xA56A2C0)
#define RPG_CLIENT_TAROTWIKISUBDATA_GET_DESCTEXTID_OFFSET UNITYSDK_OFFSET(0xA56A2A0)
#define RPG_CLIENT_TAROTWIKISUBDATA_GET_TITLETEXTID_OFFSET UNITYSDK_OFFSET(0xA56A280)
#define RPG_CLIENT_TAROTWIKISUBDATA_ISNEW_OFFSET UNITYSDK_OFFSET(0xA56A540)
#define RPG_CLIENT_TAROTWIKISUBDATA_MARKSEEN_OFFSET UNITYSDK_OFFSET(0xA56A670)
#define RPG_CLIENT_TAROTWIKISUBDATA_SET_APPLYINGCHANGEID_OFFSET UNITYSDK_OFFSET(0xA56A2D0)
#define RPG_CLIENT_TAROTWIKISUBDATA_SET_DESCTEXTID_OFFSET UNITYSDK_OFFSET(0xA56A2B0)
#define RPG_CLIENT_TAROTWIKISUBDATA_SET_TITLETEXTID_OFFSET UNITYSDK_OFFSET(0xA56A290)
#define RPG_CLIENT_TAROTWIKISUBDATA_TRYAPPLYCHANGE_OFFSET UNITYSDK_OFFSET(0xA56A390)
#define RPG_CLIENT_TAROTWIKISUBDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA56A2E0)
