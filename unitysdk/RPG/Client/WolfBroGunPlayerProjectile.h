...
#define RPG_CLIENT_WOLFBROGUNPLAYERPROJECTILE_METHOD_6_290BD11329CA8210_OFFSET UNITYSDK_OFFSET(0xA7A66B0)
#define RPG_CLIENT_WOLFBROGUNPLAYERPROJECTILE_METHOD_6_4336FBACB9794796_OFFSET UNITYSDK_OFFSET(0xA7A6A90)
#define RPG_CLIENT_WOLFBROGUNPLAYERPROJECTILE_METHOD_6_D2CE238054CB70B4_OFFSET UNITYSDK_OFFSET(0xA7A6D30)
#define RPG_CLIENT_WOLFBROGUNPLAYERPROJECTILE_METHOD_6_D45DEFEECF0CCC79_OFFSET UNITYSDK_OFFSET(0xA7A6F50)
#define RPG_CLIENT_WOLFBROGUNPLAYERPROJECTILE__CTOR_OFFSET UNITYSDK_OFFSET(0xA7A6EC0)
