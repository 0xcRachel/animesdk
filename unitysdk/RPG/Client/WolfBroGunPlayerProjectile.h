...
#define RPG_CLIENT_WOLFBROGUNPLAYERPROJECTILE_METHOD_6_290BD11329CA8210_OFFSET UNITYSDK_OFFSET(0xA26BDB0)
#define RPG_CLIENT_WOLFBROGUNPLAYERPROJECTILE_METHOD_6_4336FBACB9794796_OFFSET UNITYSDK_OFFSET(0xA26C130)
#define RPG_CLIENT_WOLFBROGUNPLAYERPROJECTILE_METHOD_6_D2CE238054CB70B4_OFFSET UNITYSDK_OFFSET(0xA26C3D0)
#define RPG_CLIENT_WOLFBROGUNPLAYERPROJECTILE_METHOD_6_D45DEFEECF0CCC79_OFFSET UNITYSDK_OFFSET(0xA26C5D0)
#define RPG_CLIENT_WOLFBROGUNPLAYERPROJECTILE__CTOR_OFFSET UNITYSDK_OFFSET(0xA26C570)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayerProjectile_TypeDefinitionIndex = 54601;
