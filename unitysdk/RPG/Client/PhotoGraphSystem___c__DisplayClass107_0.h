...
#define RPG_CLIENT_PHOTOGRAPHSYSTEM___C__DISPLAYCLASS107_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9A8E9B0)
#define RPG_CLIENT_PHOTOGRAPHSYSTEM___C__DISPLAYCLASS107_0___NOTIFYSHOTNONPOSTPROCESS_B__0_OFFSET UNITYSDK_OFFSET(0x9A931E0)

namespace RPG::Client
{
	inline static constexpr unsigned int PhotoGraphSystem___c__DisplayClass107_0_TypeDefinitionIndex = 48290;

	class PhotoGraphSystem___c__DisplayClass107_0 : public ::System::Object
	{
	public:
		::RPG::Client::PhotoGraphSystem* __4__this; // 0x10
		::Class_0_16E4307DCC419505_492* pEnvSystem; // 0x18
