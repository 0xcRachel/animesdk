...
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_GET_COLLIDERCENTER_OFFSET UNITYSDK_OFFSET(0x9D51320)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ISLOOKAT_OFFSET UNITYSDK_OFFSET(0x9D50E60)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_0AD139A96804E15E_OFFSET UNITYSDK_OFFSET(0x9D515B0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_10CF9247431CA0D8_OFFSET UNITYSDK_OFFSET(0x9D50770)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_292F9610D63D1947_OFFSET UNITYSDK_OFFSET(0x9D51710)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_2B0AE62D097BB2AF_OFFSET UNITYSDK_OFFSET(0x9D51790)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_9B23FC08130ED5FB_OFFSET UNITYSDK_OFFSET(0x9D502F0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_CCD88C0D86A5A786_OFFSET UNITYSDK_OFFSET(0x9D50C70)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x9D50BF0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x9D50150)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9D4FFF0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x9D50520)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ONTRIGGERSTAY_OFFSET UNITYSDK_OFFSET(0x9D509A0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x9D518D0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoTravelShipStation_TypeDefinitionIndex)->GetStaticField(0x11250);
		}
