...
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_GET_COLLIDERCENTER_OFFSET UNITYSDK_OFFSET(0x986ED00)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ISLOOKAT_OFFSET UNITYSDK_OFFSET(0x986E840)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_0AD139A96804E15E_OFFSET UNITYSDK_OFFSET(0x986EF90)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_10CF9247431CA0D8_OFFSET UNITYSDK_OFFSET(0x986E140)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_292F9610D63D1947_OFFSET UNITYSDK_OFFSET(0x986F0F0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_2B0AE62D097BB2AF_OFFSET UNITYSDK_OFFSET(0x986F170)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_9B23FC08130ED5FB_OFFSET UNITYSDK_OFFSET(0x986DCC0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_CCD88C0D86A5A786_OFFSET UNITYSDK_OFFSET(0x986E640)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x986E5C0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x986DB20)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x986D9C0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x986DEF0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ONTRIGGERSTAY_OFFSET UNITYSDK_OFFSET(0x986E370)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x986F2B0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoTravelShipStation_TypeDefinitionIndex = 54624;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoTravelShipStation_TypeDefinitionIndex)->GetStaticField(0xECD0);
		}
