...
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_GET_COLLIDERCENTER_OFFSET UNITYSDK_OFFSET(0x162FA8B0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ISLOOKAT_OFFSET UNITYSDK_OFFSET(0x162FA440)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_0AD139A96804E15E_OFFSET UNITYSDK_OFFSET(0x162FAB40)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_10CF9247431CA0D8_OFFSET UNITYSDK_OFFSET(0x162F9D50)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_292F9610D63D1947_OFFSET UNITYSDK_OFFSET(0x162FACA0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_2B0AE62D097BB2AF_OFFSET UNITYSDK_OFFSET(0x162FAD20)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_9B23FC08130ED5FB_OFFSET UNITYSDK_OFFSET(0x162F98D0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_CCD88C0D86A5A786_OFFSET UNITYSDK_OFFSET(0x162FA250)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x162FA1D0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x162F9730)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x162F95D0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x162F9B00)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ONTRIGGERSTAY_OFFSET UNITYSDK_OFFSET(0x162F9F80)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x162FAE60)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoTravelShipStation_TypeDefinitionIndex)->GetStaticField(0x10150);
		}
