...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSCAMERACONTROLLER_EXAMPLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x141F8FA0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSCAMERACONTROLLER_EXAMPLE__CTOR_OFFSET UNITYSDK_OFFSET(0x141F9200)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersCameraController_Example_TypeDefinitionIndex = 70573;
