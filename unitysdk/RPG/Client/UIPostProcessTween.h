...
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xA1CBD40)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_METHOD_5_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0xA1F7F80)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_METHOD_5_7250DE5FF780E436_OFFSET UNITYSDK_OFFSET(0xA1F5F00)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_METHOD_5_8C704EC832EDEFC8_OFFSET UNITYSDK_OFFSET(0xA1F7AC0)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_METHOD_5_93E6B8A6D29521ED_OFFSET UNITYSDK_OFFSET(0xA1F6510)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_METHOD_5_E41B6A823556FEEA_OFFSET UNITYSDK_OFFSET(0xA1F72B0)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_RESET_OFFSET UNITYSDK_OFFSET(0xA1CBEA0)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_SETDISABLEUIBLURTWEEN_OFFSET UNITYSDK_OFFSET(0xA1F8150)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_SETUIMETA_OFFSET UNITYSDK_OFFSET(0xA1F6150)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_UPDATE_OFFSET UNITYSDK_OFFSET(0xA1F81A0)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN__CTOR_OFFSET UNITYSDK_OFFSET(0xA1F8200)

namespace RPG::Client
{
	inline static constexpr unsigned int UIPostProcessTween_TypeDefinitionIndex = 58252;
	...
	public:
		...
		{
			return (::RPG::Client::UIPostProcessTween**)Il2CppClass::FromTypeDefinitionIndex(UIPostProcessTween_TypeDefinitionIndex)->GetStaticField(0x34210);
		}
