...
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x15967930)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_METHOD_5_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x15969B10)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_METHOD_5_7250DE5FF780E436_OFFSET UNITYSDK_OFFSET(0x15967A90)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_METHOD_5_8C704EC832EDEFC8_OFFSET UNITYSDK_OFFSET(0x15969650)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_METHOD_5_93E6B8A6D29521ED_OFFSET UNITYSDK_OFFSET(0x159680A0)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_METHOD_5_E41B6A823556FEEA_OFFSET UNITYSDK_OFFSET(0x15968E40)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_RESET_OFFSET UNITYSDK_OFFSET(0x15969D30)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_SETDISABLEUIBLURTWEEN_OFFSET UNITYSDK_OFFSET(0x15969CE0)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_SETUIMETA_OFFSET UNITYSDK_OFFSET(0x15967CE0)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_UPDATE_OFFSET UNITYSDK_OFFSET(0x15969F90)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN__CTOR_OFFSET UNITYSDK_OFFSET(0x15969FF0)

namespace RPG::Client
{
	inline static constexpr unsigned int UIPostProcessTween_TypeDefinitionIndex = 67300;
	...
	public:
		...
		{
			return (::RPG::Client::UIPostProcessTween**)Il2CppClass::FromTypeDefinitionIndex(UIPostProcessTween_TypeDefinitionIndex)->GetStaticField(0x5B5A0);
		}
