...
#define RPG_CLIENT_MONOESCALATORITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9822AA0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEscalatorItem_TypeDefinitionIndex = 54450;
