...
#define RPG_CLIENT_RANDOMFALLINGOBJECTMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x9D70F70)
#define RPG_CLIENT_RANDOMFALLINGOBJECTMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x9D70FC0)
#define RPG_CLIENT_RANDOMFALLINGOBJECTMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x9D70FE0)

namespace RPG::Client
{
	inline static constexpr unsigned int RandomFallingObjectMonoPlugin_TypeDefinitionIndex = 56524;
