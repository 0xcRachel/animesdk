...
#define RPG_CLIENT_REQUESTCHANGEMATCHTHREEV2BIRDLOCATION_METHOD_3_CFF7579380403101_OFFSET UNITYSDK_OFFSET(0x1987A4E0)
#define RPG_CLIENT_REQUESTCHANGEMATCHTHREEV2BIRDLOCATION_METHOD_3_F37A589FBB291478_OFFSET UNITYSDK_OFFSET(0x1987A460)
#define RPG_CLIENT_REQUESTCHANGEMATCHTHREEV2BIRDLOCATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1987A4B0)
