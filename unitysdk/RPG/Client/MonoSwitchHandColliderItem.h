...
#define RPG_CLIENT_MONOSWITCHHANDCOLLIDERITEM_AWAKE_OFFSET UNITYSDK_OFFSET(0x9D44A40)
#define RPG_CLIENT_MONOSWITCHHANDCOLLIDERITEM_METHOD_5_C05CECF17E0BB2B1_1_OFFSET UNITYSDK_OFFSET(0x9D45020)
#define RPG_CLIENT_MONOSWITCHHANDCOLLIDERITEM_METHOD_5_C05CECF17E0BB2B1_OFFSET UNITYSDK_OFFSET(0x9D44C00)
#define RPG_CLIENT_MONOSWITCHHANDCOLLIDERITEM_METHOD_5_DF7CEFC0E6C5FD0D_OFFSET UNITYSDK_OFFSET(0x9D44E90)
#define RPG_CLIENT_MONOSWITCHHANDCOLLIDERITEM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x9D44D90)
#define RPG_CLIENT_MONOSWITCHHANDCOLLIDERITEM_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9D44AE0)
#define RPG_CLIENT_MONOSWITCHHANDCOLLIDERITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9D451F0)
