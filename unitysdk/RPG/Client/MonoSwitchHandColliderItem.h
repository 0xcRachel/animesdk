...
#define RPG_CLIENT_MONOSWITCHHANDCOLLIDERITEM_AWAKE_OFFSET UNITYSDK_OFFSET(0x162EE050)
#define RPG_CLIENT_MONOSWITCHHANDCOLLIDERITEM_METHOD_5_C05CECF17E0BB2B1_1_OFFSET UNITYSDK_OFFSET(0x162EE620)
#define RPG_CLIENT_MONOSWITCHHANDCOLLIDERITEM_METHOD_5_C05CECF17E0BB2B1_OFFSET UNITYSDK_OFFSET(0x162EE210)
#define RPG_CLIENT_MONOSWITCHHANDCOLLIDERITEM_METHOD_5_DF7CEFC0E6C5FD0D_OFFSET UNITYSDK_OFFSET(0x162EE490)
#define RPG_CLIENT_MONOSWITCHHANDCOLLIDERITEM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x162EE390)
#define RPG_CLIENT_MONOSWITCHHANDCOLLIDERITEM_ONENABLE_OFFSET UNITYSDK_OFFSET(0x162EE0F0)
#define RPG_CLIENT_MONOSWITCHHANDCOLLIDERITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x162EE7F0)
