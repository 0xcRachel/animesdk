...
#define RPG_CLIENT_MONOSWITCHHANDCOLLIDERITEM_AWAKE_OFFSET UNITYSDK_OFFSET(0x98623D0)
#define RPG_CLIENT_MONOSWITCHHANDCOLLIDERITEM_METHOD_5_C05CECF17E0BB2B1_1_OFFSET UNITYSDK_OFFSET(0x98629B0)
#define RPG_CLIENT_MONOSWITCHHANDCOLLIDERITEM_METHOD_5_C05CECF17E0BB2B1_OFFSET UNITYSDK_OFFSET(0x9862590)
#define RPG_CLIENT_MONOSWITCHHANDCOLLIDERITEM_METHOD_5_DF7CEFC0E6C5FD0D_OFFSET UNITYSDK_OFFSET(0x9862820)
#define RPG_CLIENT_MONOSWITCHHANDCOLLIDERITEM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x9862720)
#define RPG_CLIENT_MONOSWITCHHANDCOLLIDERITEM_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9862470)
#define RPG_CLIENT_MONOSWITCHHANDCOLLIDERITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9862B80)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoSwitchHandColliderItem_TypeDefinitionIndex = 54618;
