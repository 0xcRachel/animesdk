...
#define RPG_CLIENT_MONOEFFECTPLUGINEFFECTSCAN_METHOD_8_2566AD459572DFC3_OFFSET UNITYSDK_OFFSET(0x97F9C10)
#define RPG_CLIENT_MONOEFFECTPLUGINEFFECTSCAN_METHOD_8_D78B51BFDA4B8B32_OFFSET UNITYSDK_OFFSET(0x97FA1E0)
#define RPG_CLIENT_MONOEFFECTPLUGINEFFECTSCAN__CTOR_OFFSET UNITYSDK_OFFSET(0x97FA0A0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginEffectScan_TypeDefinitionIndex = 55715;
