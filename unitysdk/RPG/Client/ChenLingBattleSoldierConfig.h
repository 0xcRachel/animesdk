...
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_ATKSKILLIDLIST_OFFSET UNITYSDK_OFFSET(0x18DDE6C0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_ID_OFFSET UNITYSDK_OFFSET(0x18DDE3B0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_INITIALMAXLEVEL_OFFSET UNITYSDK_OFFSET(0x18DD3830)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_ISRANGEATTACK_OFFSET UNITYSDK_OFFSET(0x18DDE730)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0x18DDE630)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_MODELPATH_OFFSET UNITYSDK_OFFSET(0x18DC3940)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_NAME_OFFSET UNITYSDK_OFFSET(0x18DD4640)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x18DDE430)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_PREPARESIZE_OFFSET UNITYSDK_OFFSET(0x18DDE4B0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_PROMOTIONCONDITIONLIST_OFFSET UNITYSDK_OFFSET(0x18DD4130)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_PROMOTIONSKILLDESC_OFFSET UNITYSDK_OFFSET(0x18DDE5B0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_SCALE_OFFSET UNITYSDK_OFFSET(0x18DDE4A0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_SKILLDESC_OFFSET UNITYSDK_OFFSET(0x18DDE530)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_SKILLIDLIST_OFFSET UNITYSDK_OFFSET(0x18DDE650)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_SMALLICONOUTLINEPATH_OFFSET UNITYSDK_OFFSET(0x18DD35F0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_SMALLICONPATH_OFFSET UNITYSDK_OFFSET(0x18DD3500)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET__ROW_OFFSET UNITYSDK_OFFSET(0x18DDE3D0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_SET_ID_OFFSET UNITYSDK_OFFSET(0x18DDE3C0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_SET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0x18DDE640)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18DDE390)
