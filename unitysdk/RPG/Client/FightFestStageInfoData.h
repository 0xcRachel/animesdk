...
#define RPG_CLIENT_FIGHTFESTSTAGEINFODATA_CREATE_OFFSET UNITYSDK_OFFSET(0x15121EE0)
#define RPG_CLIENT_FIGHTFESTSTAGEINFODATA_GET_CHALLENGENAME_OFFSET UNITYSDK_OFFSET(0x15122110)
#define RPG_CLIENT_FIGHTFESTSTAGEINFODATA_GET_ENVIRONMENTBUFFDES_OFFSET UNITYSDK_OFFSET(0x15122330)
#define RPG_CLIENT_FIGHTFESTSTAGEINFODATA_GET_ENVIRONMENTBUFFID_OFFSET UNITYSDK_OFFSET(0x15122E70)
#define RPG_CLIENT_FIGHTFESTSTAGEINFODATA_GET_ENVIRONMENTBUFFNAME_OFFSET UNITYSDK_OFFSET(0x15122220)
#define RPG_CLIENT_FIGHTFESTSTAGEINFODATA_GET_EVENTID_OFFSET UNITYSDK_OFFSET(0x15122DA0)
#define RPG_CLIENT_FIGHTFESTSTAGEINFODATA_GET_HIGHLIGHTDESC_OFFSET UNITYSDK_OFFSET(0x15122EC0)
#define RPG_CLIENT_FIGHTFESTSTAGEINFODATA_GET_ISLOCKAVATARSKILL_OFFSET UNITYSDK_OFFSET(0x15122DC0)
#define RPG_CLIENT_FIGHTFESTSTAGEINFODATA_GET_PREVIEWMONSTERLIST_OFFSET UNITYSDK_OFFSET(0x15122410)
#define RPG_CLIENT_FIGHTFESTSTAGEINFODATA_GET_RECOMMENDCOACHID_OFFSET UNITYSDK_OFFSET(0x15122F40)
#define RPG_CLIENT_FIGHTFESTSTAGEINFODATA_GET_RECOMMENDNATURE_OFFSET UNITYSDK_OFFSET(0x151224D0)
#define RPG_CLIENT_FIGHTFESTSTAGEINFODATA_GET_SPECIALAVATARLIST_OFFSET UNITYSDK_OFFSET(0x15122590)
#define RPG_CLIENT_FIGHTFESTSTAGEINFODATA_GET_UIENTERBATTLEAREAID_OFFSET UNITYSDK_OFFSET(0x151225F0)
#define RPG_CLIENT_FIGHTFESTSTAGEINFODATA_SET_EVENTID_OFFSET UNITYSDK_OFFSET(0x15122DB0)
#define RPG_CLIENT_FIGHTFESTSTAGEINFODATA__CTOR_OFFSET UNITYSDK_OFFSET(0x15122D90)
