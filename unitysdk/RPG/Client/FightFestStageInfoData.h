...
#define RPG_CLIENT_FIGHTFESTSTAGEINFODATA_CREATE_OFFSET UNITYSDK_OFFSET(0x16B88ED0)
#define RPG_CLIENT_FIGHTFESTSTAGEINFODATA_GET_CHALLENGENAME_OFFSET UNITYSDK_OFFSET(0x16B891A0)
#define RPG_CLIENT_FIGHTFESTSTAGEINFODATA_GET_ENVIRONMENTBUFFDES_OFFSET UNITYSDK_OFFSET(0x16B893C0)
#define RPG_CLIENT_FIGHTFESTSTAGEINFODATA_GET_ENVIRONMENTBUFFID_OFFSET UNITYSDK_OFFSET(0x16B89F80)
#define RPG_CLIENT_FIGHTFESTSTAGEINFODATA_GET_ENVIRONMENTBUFFNAME_OFFSET UNITYSDK_OFFSET(0x16B892B0)
#define RPG_CLIENT_FIGHTFESTSTAGEINFODATA_GET_EVENTID_OFFSET UNITYSDK_OFFSET(0x16B89E20)
#define RPG_CLIENT_FIGHTFESTSTAGEINFODATA_GET_HIGHLIGHTDESC_OFFSET UNITYSDK_OFFSET(0x16B89FD0)
#define RPG_CLIENT_FIGHTFESTSTAGEINFODATA_GET_ISLOCKAVATARSKILL_OFFSET UNITYSDK_OFFSET(0x16B89E40)
#define RPG_CLIENT_FIGHTFESTSTAGEINFODATA_GET_PREVIEWMONSTERLIST_OFFSET UNITYSDK_OFFSET(0x16B894A0)
#define RPG_CLIENT_FIGHTFESTSTAGEINFODATA_GET_RECOMMENDCOACHID_OFFSET UNITYSDK_OFFSET(0x16B8A050)
#define RPG_CLIENT_FIGHTFESTSTAGEINFODATA_GET_RECOMMENDNATURE_OFFSET UNITYSDK_OFFSET(0x16B89560)
#define RPG_CLIENT_FIGHTFESTSTAGEINFODATA_GET_SPECIALAVATARLIST_OFFSET UNITYSDK_OFFSET(0x16B89620)
#define RPG_CLIENT_FIGHTFESTSTAGEINFODATA_GET_UIENTERBATTLEAREAID_OFFSET UNITYSDK_OFFSET(0x16B896E0)
#define RPG_CLIENT_FIGHTFESTSTAGEINFODATA_SET_EVENTID_OFFSET UNITYSDK_OFFSET(0x16B89E30)
#define RPG_CLIENT_FIGHTFESTSTAGEINFODATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16B89E10)
