...
#define RPG_CLIENT_STANDARDGACHAPOOLDATA_HAVETIMELIMIT_OFFSET UNITYSDK_OFFSET(0xA4DE1F0)
#define RPG_CLIENT_STANDARDGACHAPOOLDATA_ISFEATURECLOSED_OFFSET UNITYSDK_OFFSET(0xA4DE130)
#define RPG_CLIENT_STANDARDGACHAPOOLDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA4DE120)
#define RPG_CLIENT_STANDARDGACHAPOOLDATA___IFIXBASEPROXY_HAVETIMELIMIT_OFFSET UNITYSDK_OFFSET(0xA4DE240)
#define RPG_CLIENT_STANDARDGACHAPOOLDATA___IFIXBASEPROXY_ISFEATURECLOSED_OFFSET UNITYSDK_OFFSET(0xA4DE230)
