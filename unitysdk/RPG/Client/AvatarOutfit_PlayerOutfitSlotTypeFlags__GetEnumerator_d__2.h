...
#define RPG_CLIENT_AVATAROUTFIT_PLAYEROUTFITSLOTTYPEFLAGS__GETENUMERATOR_D__2_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x915B020)
#define RPG_CLIENT_AVATAROUTFIT_PLAYEROUTFITSLOTTYPEFLAGS__GETENUMERATOR_D__2_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_GAMECORE_PLAYEROUTFITSLOTTYPE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x915B0C0)
#define RPG_CLIENT_AVATAROUTFIT_PLAYEROUTFITSLOTTYPEFLAGS__GETENUMERATOR_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x915B120)
#define RPG_CLIENT_AVATAROUTFIT_PLAYEROUTFITSLOTTYPEFLAGS__GETENUMERATOR_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x915B0D0)
#define RPG_CLIENT_AVATAROUTFIT_PLAYEROUTFITSLOTTYPEFLAGS__GETENUMERATOR_D__2_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x915B010)
#define RPG_CLIENT_AVATAROUTFIT_PLAYEROUTFITSLOTTYPEFLAGS__GETENUMERATOR_D__2__CTOR_OFFSET UNITYSDK_OFFSET(0x915AA90)
...
namespace RPG::Client
{
	...
	public:
		...
		::RPG::GameCore::PlayerOutfitSlotType __2__current; // 0x20
