...
#define RPG_CLIENT_AVATAROUTFIT_PLAYEROUTFITSLOTTYPEFLAGS__GETENUMERATOR_D__2_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x8D046A0)
#define RPG_CLIENT_AVATAROUTFIT_PLAYEROUTFITSLOTTYPEFLAGS__GETENUMERATOR_D__2_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_GAMECORE_PLAYEROUTFITSLOTTYPE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x8D04750)
#define RPG_CLIENT_AVATAROUTFIT_PLAYEROUTFITSLOTTYPEFLAGS__GETENUMERATOR_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x8D047B0)
#define RPG_CLIENT_AVATAROUTFIT_PLAYEROUTFITSLOTTYPEFLAGS__GETENUMERATOR_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x8D04760)
#define RPG_CLIENT_AVATAROUTFIT_PLAYEROUTFITSLOTTYPEFLAGS__GETENUMERATOR_D__2_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8D04690)
#define RPG_CLIENT_AVATAROUTFIT_PLAYEROUTFITSLOTTYPEFLAGS__GETENUMERATOR_D__2__CTOR_OFFSET UNITYSDK_OFFSET(0x8D04110)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarOutfit_PlayerOutfitSlotTypeFlags__GetEnumerator_d__2_TypeDefinitionIndex = 49681;
	...
	public:
		...
		::RPG::GameCore::PlayerOutfitSlotType __2__current; // 0x24
