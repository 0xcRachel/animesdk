...
#define RPG_CLIENT_MONSTERAVATARPROPERTYUIDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x98AE330)

namespace RPG::Client
{
	inline static constexpr unsigned int MonsterAvatarPropertyUIData_TypeDefinitionIndex = 49395;
