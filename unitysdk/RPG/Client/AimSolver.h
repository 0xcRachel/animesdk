...
#define RPG_CLIENT_AIMSOLVER_GET_AIMERCOUNT_OFFSET UNITYSDK_OFFSET(0x908F740)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_106B26BE164E4FCD_OFFSET UNITYSDK_OFFSET(0x9090E30)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_11923540E96E60E4_OFFSET UNITYSDK_OFFSET(0x9091DA0)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_3F5823D34C4A0A38_OFFSET UNITYSDK_OFFSET(0x90922B0)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_412B37D6127486C3_OFFSET UNITYSDK_OFFSET(0x9091CF0)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_4855D279E0E27DA8_OFFSET UNITYSDK_OFFSET(0x9091FC0)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_4C7D121ED22BD1D1_OFFSET UNITYSDK_OFFSET(0x9091F00)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_64D17174D10FA3CE_OFFSET UNITYSDK_OFFSET(0x90900E0)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_8E968BA443B7271D_OFFSET UNITYSDK_OFFSET(0x9092CC0)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_A17B38030E623502_OFFSET UNITYSDK_OFFSET(0x9091C70)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_B530AE696D19BB54_OFFSET UNITYSDK_OFFSET(0x90919B0)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_BA1BB49741CFDFE1_OFFSET UNITYSDK_OFFSET(0x908F790)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_BBCB217B420D617D_OFFSET UNITYSDK_OFFSET(0x9090A50)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_C50A2293958CA940_OFFSET UNITYSDK_OFFSET(0x9092C40)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_EABBE399EFB12E42_OFFSET UNITYSDK_OFFSET(0x908FD30)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_F7BA13C72A6B3F58_OFFSET UNITYSDK_OFFSET(0x908FDE0)
#define RPG_CLIENT_AIMSOLVER__CCTOR_OFFSET UNITYSDK_OFFSET(0x9092F20)
#define RPG_CLIENT_AIMSOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x9092EC0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Quaternion>**)Il2CppClass::FromTypeDefinitionIndex(AimSolver_TypeDefinitionIndex)->GetStaticField(0x37BC0);
		}
		static ::System::Collections::Generic::List_1<::System::Int32>** StaticGet__BoneIdxAndDepth()
		{
			return (::System::Collections::Generic::List_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(AimSolver_TypeDefinitionIndex)->GetStaticField(0x37BC8);
		}
