...
#define RPG_CLIENT_AIMSOLVER_GET_AIMERCOUNT_OFFSET UNITYSDK_OFFSET(0x10AE0500)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_106B26BE164E4FCD_OFFSET UNITYSDK_OFFSET(0x10AE1BF0)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_11923540E96E60E4_OFFSET UNITYSDK_OFFSET(0x10AE2B90)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_3F5823D34C4A0A38_OFFSET UNITYSDK_OFFSET(0x10AE30A0)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_412B37D6127486C3_OFFSET UNITYSDK_OFFSET(0x10AE2AE0)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_4855D279E0E27DA8_OFFSET UNITYSDK_OFFSET(0x10AE2DB0)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_4C7D121ED22BD1D1_OFFSET UNITYSDK_OFFSET(0x10AE2CF0)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_64D17174D10FA3CE_OFFSET UNITYSDK_OFFSET(0x10AE0EA0)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_8E968BA443B7271D_OFFSET UNITYSDK_OFFSET(0x10AE3AB0)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_A17B38030E623502_OFFSET UNITYSDK_OFFSET(0x10AE2A60)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_B530AE696D19BB54_OFFSET UNITYSDK_OFFSET(0x10AE27A0)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_BA1BB49741CFDFE1_OFFSET UNITYSDK_OFFSET(0x10AE0550)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_BBCB217B420D617D_OFFSET UNITYSDK_OFFSET(0x10AE1810)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_C50A2293958CA940_OFFSET UNITYSDK_OFFSET(0x10AE3A30)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_EABBE399EFB12E42_OFFSET UNITYSDK_OFFSET(0x10AE0AF0)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_F7BA13C72A6B3F58_OFFSET UNITYSDK_OFFSET(0x10AE0BA0)
#define RPG_CLIENT_AIMSOLVER__CCTOR_OFFSET UNITYSDK_OFFSET(0x10AE3D10)
#define RPG_CLIENT_AIMSOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x10AE3CB0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(AimSolver_TypeDefinitionIndex)->GetStaticField(0x56460);
		}
		static ::System::Collections::Generic::List_1<::UnityEngine::Quaternion>** StaticGet__QuaternionCache()
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Quaternion>**)Il2CppClass::FromTypeDefinitionIndex(AimSolver_TypeDefinitionIndex)->GetStaticField(0x56468);
		}
