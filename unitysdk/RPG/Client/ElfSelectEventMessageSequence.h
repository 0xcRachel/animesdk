...
#define RPG_CLIENT_ELFSELECTEVENTMESSAGESEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x91543E0)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfSelectEventMessageSequence_TypeDefinitionIndex = 50583;
