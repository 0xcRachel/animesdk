...
#define RPG_CLIENT_RELICSUITDATA_BUILDITEM_OFFSET UNITYSDK_OFFSET(0x131B73E0)
#define RPG_CLIENT_RELICSUITDATA_BUILDPROPERTYVALUES_OFFSET UNITYSDK_OFFSET(0x131B7740)
#define RPG_CLIENT_RELICSUITDATA_BUILDUPGRADEDITEMS_OFFSET UNITYSDK_OFFSET(0x131B7310)
#define RPG_CLIENT_RELICSUITDATA_CREATEDISPLAYRELICSUIT_OFFSET UNITYSDK_OFFSET(0x131B6B30)
#define RPG_CLIENT_RELICSUITDATA_GETPOSITIONRELIC_1_OFFSET UNITYSDK_OFFSET(0x131B7E60)
#define RPG_CLIENT_RELICSUITDATA_GETPOSITIONRELIC_OFFSET UNITYSDK_OFFSET(0x131B7D30)
#define RPG_CLIENT_RELICSUITDATA_GETRELICCOMBATPOWER_OFFSET UNITYSDK_OFFSET(0x131B8790)
#define RPG_CLIENT_RELICSUITDATA_GETRELICSITEMS_OFFSET UNITYSDK_OFFSET(0x131B7EB0)
#define RPG_CLIENT_RELICSUITDATA_GETVIRTUALDATAREPLACEWITH_OFFSET UNITYSDK_OFFSET(0x131B8030)
#define RPG_CLIENT_RELICSUITDATA_GETVIRTUALDATA_OFFSET UNITYSDK_OFFSET(0x131B8360)
#define RPG_CLIENT_RELICSUITDATA_GET_RELICITEMS_OFFSET UNITYSDK_OFFSET(0x131B8EF0)
#define RPG_CLIENT_RELICSUITDATA_GET_RELICSETADDPROPERTYVALUES_OFFSET UNITYSDK_OFFSET(0x131B8F10)
#define RPG_CLIENT_RELICSUITDATA_GET_RELICSETAFFIXPROPERTYVALUES_OFFSET UNITYSDK_OFFSET(0x131B8F20)
#define RPG_CLIENT_RELICSUITDATA_ISCONTAINPOSITION_OFFSET UNITYSDK_OFFSET(0x131B7610)
#define RPG_CLIENT_RELICSUITDATA_REFRESHRELICITEMS_OFFSET UNITYSDK_OFFSET(0x131B8970)
#define RPG_CLIENT_RELICSUITDATA_REFRESHRELICSETADDPROPERTYVALUES_OFFSET UNITYSDK_OFFSET(0x131B6E50)
#define RPG_CLIENT_RELICSUITDATA_SET_RELICITEMS_OFFSET UNITYSDK_OFFSET(0x131B8F00)
#define RPG_CLIENT_RELICSUITDATA_SYNC_OFFSET UNITYSDK_OFFSET(0x131B7160)
#define RPG_CLIENT_RELICSUITDATA__CALCULATERELICSETSKILLCOUNT_OFFSET UNITYSDK_OFFSET(0x131B8BE0)
#define RPG_CLIENT_RELICSUITDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x131B6D40)
#define RPG_CLIENT_RELICSUITDATA__GETCOMBATPOWERCONSTVALUE_OFFSET UNITYSDK_OFFSET(0x131B8E10)
#define RPG_CLIENT_RELICSUITDATA__TRYADDPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x131B7B60)
#define RPG_CLIENT_RELICSUITDATA__TRYADDRELICPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x131B8AE0)
#define RPG_CLIENT_RELICSUITDATA__TRYADDRELICSETSKILLPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x131B7C30)
#define RPG_CLIENT_RELICSUITDATA__UPDATERELICITEMDATA_OFFSET UNITYSDK_OFFSET(0x131B71C0)
...
namespace RPG::Client
{
	...
	{
	public:
		::System::Collections::Generic::List_1<::RPG::Client::RelicItemData*>* _RelicItems_k__BackingField; // 0x10
