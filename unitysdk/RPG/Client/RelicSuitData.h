...
#define RPG_CLIENT_RELICSUITDATA_BUILDITEM_OFFSET UNITYSDK_OFFSET(0xA2C7D80)
#define RPG_CLIENT_RELICSUITDATA_BUILDPROPERTYVALUES_OFFSET UNITYSDK_OFFSET(0xA2C80E0)
#define RPG_CLIENT_RELICSUITDATA_BUILDUPGRADEDITEMS_OFFSET UNITYSDK_OFFSET(0xA2C7CB0)
#define RPG_CLIENT_RELICSUITDATA_CREATEDISPLAYRELICSUIT_OFFSET UNITYSDK_OFFSET(0xA2C74D0)
#define RPG_CLIENT_RELICSUITDATA_GETPOSITIONRELIC_1_OFFSET UNITYSDK_OFFSET(0xA2C8800)
#define RPG_CLIENT_RELICSUITDATA_GETPOSITIONRELIC_OFFSET UNITYSDK_OFFSET(0xA2C86D0)
#define RPG_CLIENT_RELICSUITDATA_GETRELICCOMBATPOWER_OFFSET UNITYSDK_OFFSET(0xA2C9130)
#define RPG_CLIENT_RELICSUITDATA_GETRELICSITEMS_OFFSET UNITYSDK_OFFSET(0xA2C8850)
#define RPG_CLIENT_RELICSUITDATA_GETVIRTUALDATAREPLACEWITH_OFFSET UNITYSDK_OFFSET(0xA2C89D0)
#define RPG_CLIENT_RELICSUITDATA_GETVIRTUALDATA_OFFSET UNITYSDK_OFFSET(0xA2C8D00)
#define RPG_CLIENT_RELICSUITDATA_GET_RELICITEMS_OFFSET UNITYSDK_OFFSET(0xA2C9890)
#define RPG_CLIENT_RELICSUITDATA_GET_RELICSETADDPROPERTYVALUES_OFFSET UNITYSDK_OFFSET(0xA2C98B0)
#define RPG_CLIENT_RELICSUITDATA_GET_RELICSETAFFIXPROPERTYVALUES_OFFSET UNITYSDK_OFFSET(0xA2C98C0)
#define RPG_CLIENT_RELICSUITDATA_ISCONTAINPOSITION_OFFSET UNITYSDK_OFFSET(0xA2C7FB0)
#define RPG_CLIENT_RELICSUITDATA_REFRESHRELICITEMS_OFFSET UNITYSDK_OFFSET(0xA2C9310)
#define RPG_CLIENT_RELICSUITDATA_REFRESHRELICSETADDPROPERTYVALUES_OFFSET UNITYSDK_OFFSET(0xA2C77F0)
#define RPG_CLIENT_RELICSUITDATA_SET_RELICITEMS_OFFSET UNITYSDK_OFFSET(0xA2C98A0)
#define RPG_CLIENT_RELICSUITDATA_SYNC_OFFSET UNITYSDK_OFFSET(0xA2C7B00)
#define RPG_CLIENT_RELICSUITDATA__CALCULATERELICSETSKILLCOUNT_OFFSET UNITYSDK_OFFSET(0xA2C9580)
#define RPG_CLIENT_RELICSUITDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA2C76E0)
#define RPG_CLIENT_RELICSUITDATA__GETCOMBATPOWERCONSTVALUE_OFFSET UNITYSDK_OFFSET(0xA2C97B0)
#define RPG_CLIENT_RELICSUITDATA__TRYADDPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0xA2C8500)
#define RPG_CLIENT_RELICSUITDATA__TRYADDRELICPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0xA2C9480)
#define RPG_CLIENT_RELICSUITDATA__TRYADDRELICSETSKILLPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0xA2C85D0)
#define RPG_CLIENT_RELICSUITDATA__UPDATERELICITEMDATA_OFFSET UNITYSDK_OFFSET(0xA2C7B60)
