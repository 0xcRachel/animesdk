...
#define RPG_CLIENT_PLANETFESTRADINGCARDEXCHANGEHISTORYITEM_CREATE_OFFSET UNITYSDK_OFFSET(0x9FDA910)
#define RPG_CLIENT_PLANETFESTRADINGCARDEXCHANGEHISTORYITEM_GETRARITY_OFFSET UNITYSDK_OFFSET(0x9FDA9B0)
#define RPG_CLIENT_PLANETFESTRADINGCARDEXCHANGEHISTORYITEM_GET_DATETIME_OFFSET UNITYSDK_OFFSET(0x9FDACE0)
#define RPG_CLIENT_PLANETFESTRADINGCARDEXCHANGEHISTORYITEM_GET_ID_OFFSET UNITYSDK_OFFSET(0x9FDAAC0)
#define RPG_CLIENT_PLANETFESTRADINGCARDEXCHANGEHISTORYITEM_GET_ITEMNAME_OFFSET UNITYSDK_OFFSET(0x9FDADE0)
#define RPG_CLIENT_PLANETFESTRADINGCARDEXCHANGEHISTORYITEM_GET_TIME_OFFSET UNITYSDK_OFFSET(0x9FDABE0)
#define RPG_CLIENT_PLANETFESTRADINGCARDEXCHANGEHISTORYITEM_GET_USERNAME_OFFSET UNITYSDK_OFFSET(0x9FDAAE0)
#define RPG_CLIENT_PLANETFESTRADINGCARDEXCHANGEHISTORYITEM_SET_ID_OFFSET UNITYSDK_OFFSET(0x9FDAAD0)
#define RPG_CLIENT_PLANETFESTRADINGCARDEXCHANGEHISTORYITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9FDA9A0)
