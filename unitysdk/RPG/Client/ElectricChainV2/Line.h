...
#define RPG_CLIENT_ELECTRICCHAINV2_LINE_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x15F56EE0)
#define RPG_CLIENT_ELECTRICCHAINV2_LINE_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x15F587D0)
#define RPG_CLIENT_ELECTRICCHAINV2_LINE_METHOD_1_EDCA216BAAE60E47_OFFSET UNITYSDK_OFFSET(0x15F577F0)
#define RPG_CLIENT_ELECTRICCHAINV2_LINE__CTOR_OFFSET UNITYSDK_OFFSET(0x15F52530)

namespace RPG::Client::ElectricChainV2
{
	inline static constexpr unsigned int Line_TypeDefinitionIndex = 67738;
