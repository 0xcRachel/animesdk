...
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE_GET_LENGTHS_OFFSET UNITYSDK_OFFSET(0x156DBA10)
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE_METHOD_2_0094A08E076C3CCD_OFFSET UNITYSDK_OFFSET(0x156DBEA0)
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE_METHOD_2_653EEB7EF259681D_OFFSET UNITYSDK_OFFSET(0x156DBDD0)
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x156DC060)
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE_METHOD_2_B07554F28042D3EB_OFFSET UNITYSDK_OFFSET(0x156DB750)
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE_SET_LENGTHS_OFFSET UNITYSDK_OFFSET(0x156DBFD0)
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x156DBFE0)

namespace RPG::Client::ElectricChainV2
{
	inline static constexpr unsigned int PolyLine_TypeDefinitionIndex = 68698;
