...
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE_GET_LENGTHS_OFFSET UNITYSDK_OFFSET(0x15F58DF0)
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE_METHOD_2_19F951B38D2C86E3_OFFSET UNITYSDK_OFFSET(0x15F59130)
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE_METHOD_2_49CA198F7882284A_OFFSET UNITYSDK_OFFSET(0x15F58B30)
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x15F59460)
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE_METHOD_2_A66B981E1EA3E23D_OFFSET UNITYSDK_OFFSET(0x15F59260)
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE_SET_LENGTHS_OFFSET UNITYSDK_OFFSET(0x15F593B0)
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x15F593C0)

namespace RPG::Client::ElectricChainV2
{
	inline static constexpr unsigned int PolyLine_TypeDefinitionIndex = 67740;
