...
#define RPG_CLIENT_ELECTRICCHAINV2_CURVE_METHOD_2_124E7DAB85EAFECD_OFFSET UNITYSDK_OFFSET(0x156D56C0)
#define RPG_CLIENT_ELECTRICCHAINV2_CURVE_METHOD_2_C30F51361D1AB438_OFFSET UNITYSDK_OFFSET(0x156D5450)
#define RPG_CLIENT_ELECTRICCHAINV2_CURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x156D5740)

namespace RPG::Client::ElectricChainV2
{
	inline static constexpr unsigned int Curve_TypeDefinitionIndex = 68699;
