...
#define RPG_CLIENT_MONOFOGVOLUME_AWAKE_OFFSET UNITYSDK_OFFSET(0x9D0C840)
#define RPG_CLIENT_MONOFOGVOLUME_GET_LAST_SAVE_PATH_OFFSET UNITYSDK_OFFSET(0x9D0C9E0)
#define RPG_CLIENT_MONOFOGVOLUME_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9D0C8A0)
#define RPG_CLIENT_MONOFOGVOLUME_SAVETOFILE_OFFSET UNITYSDK_OFFSET(0x9D0C970)
#define RPG_CLIENT_MONOFOGVOLUME_SET_LAST_SAVE_PATH_OFFSET UNITYSDK_OFFSET(0x9D0C9F0)
#define RPG_CLIENT_MONOFOGVOLUME_UPDATE_OFFSET UNITYSDK_OFFSET(0x9D0C910)
#define RPG_CLIENT_MONOFOGVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x9D0CA30)
