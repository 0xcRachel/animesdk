...
#define RPG_CLIENT_MONOFOGVOLUME_AWAKE_OFFSET UNITYSDK_OFFSET(0x11692340)
#define RPG_CLIENT_MONOFOGVOLUME_GET_LAST_SAVE_PATH_OFFSET UNITYSDK_OFFSET(0x116924E0)
#define RPG_CLIENT_MONOFOGVOLUME_ONENABLE_OFFSET UNITYSDK_OFFSET(0x116923A0)
#define RPG_CLIENT_MONOFOGVOLUME_SAVETOFILE_OFFSET UNITYSDK_OFFSET(0x11692470)
#define RPG_CLIENT_MONOFOGVOLUME_SET_LAST_SAVE_PATH_OFFSET UNITYSDK_OFFSET(0x116924F0)
#define RPG_CLIENT_MONOFOGVOLUME_UPDATE_OFFSET UNITYSDK_OFFSET(0x11692410)
#define RPG_CLIENT_MONOFOGVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x11692530)
