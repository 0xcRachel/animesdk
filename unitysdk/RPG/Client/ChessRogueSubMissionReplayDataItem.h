...
#define RPG_CLIENT_CHESSROGUESUBMISSIONREPLAYDATAITEM_CREATE_OFFSET UNITYSDK_OFFSET(0x1779EF20)
#define RPG_CLIENT_CHESSROGUESUBMISSIONREPLAYDATAITEM_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1779EDF0)
#define RPG_CLIENT_CHESSROGUESUBMISSIONREPLAYDATAITEM_GET_GROUPNAME_OFFSET UNITYSDK_OFFSET(0x177A0800)
#define RPG_CLIENT_CHESSROGUESUBMISSIONREPLAYDATAITEM_GET_ID_OFFSET UNITYSDK_OFFSET(0x1779EED0)
#define RPG_CLIENT_CHESSROGUESUBMISSIONREPLAYDATAITEM_GET_IMAGEPATH_OFFSET UNITYSDK_OFFSET(0x177A0880)
#define RPG_CLIENT_CHESSROGUESUBMISSIONREPLAYDATAITEM_GET_LEVELGRAPHPATH_OFFSET UNITYSDK_OFFSET(0x177A06C0)
#define RPG_CLIENT_CHESSROGUESUBMISSIONREPLAYDATAITEM_GET_OPTIONJSONPATH_OFFSET UNITYSDK_OFFSET(0x177A0720)
#define RPG_CLIENT_CHESSROGUESUBMISSIONREPLAYDATAITEM_GET_SHOWGROUP_OFFSET UNITYSDK_OFFSET(0x1779E360)
#define RPG_CLIENT_CHESSROGUESUBMISSIONREPLAYDATAITEM_GET_STORYNAME_OFFSET UNITYSDK_OFFSET(0x177A0780)
#define RPG_CLIENT_CHESSROGUESUBMISSIONREPLAYDATAITEM_GET_UNLOCKED_OFFSET UNITYSDK_OFFSET(0x177A08E0)
#define RPG_CLIENT_CHESSROGUESUBMISSIONREPLAYDATAITEM_PLAY_OFFSET UNITYSDK_OFFSET(0x177A0550)
#define RPG_CLIENT_CHESSROGUESUBMISSIONREPLAYDATAITEM_SET_UNLOCKED_OFFSET UNITYSDK_OFFSET(0x177A08F0)
#define RPG_CLIENT_CHESSROGUESUBMISSIONREPLAYDATAITEM_SYNC_OFFSET UNITYSDK_OFFSET(0x1779EE40)
#define RPG_CLIENT_CHESSROGUESUBMISSIONREPLAYDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x177A0540)
