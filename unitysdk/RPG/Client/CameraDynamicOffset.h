...
#define RPG_CLIENT_CAMERADYNAMICOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x8E5CF00)

namespace RPG::Client
{
	inline static constexpr unsigned int CameraDynamicOffset_TypeDefinitionIndex = 55443;
