...
#define RPG_CLIENT_MONOMAPROTATIONVOLUMEV2__CTOR_OFFSET UNITYSDK_OFFSET(0x9846C80)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoMapRotationVolumeV2_TypeDefinitionIndex = 54470;
