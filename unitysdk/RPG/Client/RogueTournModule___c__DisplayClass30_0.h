...
#define RPG_CLIENT_ROGUETOURNMODULE___C__DISPLAYCLASS30_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA3ABA70)
#define RPG_CLIENT_ROGUETOURNMODULE___C__DISPLAYCLASS30_0__SENDGETROGUETOURNBUILDREFSTATICDATAHTTPREQ_B__0_OFFSET UNITYSDK_OFFSET(0xA3BC560)
#define RPG_CLIENT_ROGUETOURNMODULE___C__DISPLAYCLASS30_0__SENDGETROGUETOURNBUILDREFSTATICDATAHTTPREQ_B__1_OFFSET UNITYSDK_OFFSET(0xA3BC590)
#define RPG_CLIENT_ROGUETOURNMODULE___C__DISPLAYCLASS30_0__SENDGETROGUETOURNBUILDREFSTATICDATAHTTPREQ_B__2_OFFSET UNITYSDK_OFFSET(0xA3BC760)
#define RPG_CLIENT_ROGUETOURNMODULE___C__DISPLAYCLASS30_0__SENDGETROGUETOURNBUILDREFSTATICDATAHTTPREQ_B__3_OFFSET UNITYSDK_OFFSET(0xA3BC780)
#define RPG_CLIENT_ROGUETOURNMODULE___C__DISPLAYCLASS30_0__SENDGETROGUETOURNBUILDREFSTATICDATAHTTPREQ_B__4_OFFSET UNITYSDK_OFFSET(0xA3BC6C0)
#define RPG_CLIENT_ROGUETOURNMODULE___C__DISPLAYCLASS30_0__SENDGETROGUETOURNBUILDREFSTATICDATAHTTPREQ_B__5_OFFSET UNITYSDK_OFFSET(0xA3BC6F0)
...
namespace RPG::Client
{
	...
	{
	public:
		::RPG::Client::Promises::Promise_1<::Class_1_2F346BBD0ECB22BB*>* reqPromise; // 0x10
		::System::Action_1<::Class_1_2F346BBD0ECB22BB*>* __9__4; // 0x18
