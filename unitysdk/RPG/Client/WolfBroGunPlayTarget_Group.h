...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_GROUP_ISBOOMABLE_OFFSET UNITYSDK_OFFSET(0xA2686D0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_GROUP_ISHITTABLE_OFFSET UNITYSDK_OFFSET(0xA268690)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_GROUP_METHOD_6_356E5DD361D7C314_OFFSET UNITYSDK_OFFSET(0xA268760)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_GROUP_METHOD_6_37C4724869F9DDDF_OFFSET UNITYSDK_OFFSET(0xA268900)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_GROUP_METHOD_6_56A28EFF6A9CC5BA_OFFSET UNITYSDK_OFFSET(0xA268D30)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_GROUP_METHOD_6_69225B22C8D30B3E_OFFSET UNITYSDK_OFFSET(0xA268E00)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_GROUP_METHOD_6_A86A455D6AB5B836_OFFSET UNITYSDK_OFFSET(0xA268710)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_GROUP_METHOD_6_B560799CAB48EE76_OFFSET UNITYSDK_OFFSET(0xA2689D0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_GROUP_METHOD_6_C7C4DE819CC07C7B_OFFSET UNITYSDK_OFFSET(0xA268DF0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_GROUP_METHOD_6_EF49D266363BFCB2_OFFSET UNITYSDK_OFFSET(0xA268D80)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_GROUP_SETPOSITION_OFFSET UNITYSDK_OFFSET(0xA268450)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_GROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xA268B10)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_GROUP___IFIXBASEPROXY_ISBOOMABLE_OFFSET UNITYSDK_OFFSET(0xA268CC0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_GROUP___IFIXBASEPROXY_ISHITTABLE_OFFSET UNITYSDK_OFFSET(0xA268C50)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_GROUP___IFIXBASEPROXY_SETPOSITION_OFFSET UNITYSDK_OFFSET(0xA268BB0)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayTarget_Group_TypeDefinitionIndex = 54565;
	...
	public:
		...
		::System::Boolean Method_6_EF49D266363BFCB2(::System::Single P0)
		{
			return ((::System::Boolean(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_WOLFBROGUNPLAYTARGET_GROUP_METHOD_6_EF49D266363BFCB2_OFFSET))(this, P0);
		}
