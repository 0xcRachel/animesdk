...
#define RPG_CLIENT_AVATARSKILLTREEDATA_BUILDSKILLLEVELS_OFFSET UNITYSDK_OFFSET(0x9166100)
#define RPG_CLIENT_AVATARSKILLTREEDATA_BUILDSPECIALAVATARSKILLTREE_OFFSET UNITYSDK_OFFSET(0x9165F20)
#define RPG_CLIENT_AVATARSKILLTREEDATA_COPYSKILLLEVELS_OFFSET UNITYSDK_OFFSET(0x9166E70)
#define RPG_CLIENT_AVATARSKILLTREEDATA_GENERATESKILLTREEPOINTDATA_OFFSET UNITYSDK_OFFSET(0x9165D10)
#define RPG_CLIENT_AVATARSKILLTREEDATA_GETRECOMMENDPOINTS_OFFSET UNITYSDK_OFFSET(0x91699D0)
#define RPG_CLIENT_AVATARSKILLTREEDATA_GETSKILLCOMBATPOWER_OFFSET UNITYSDK_OFFSET(0x9165CB0)
#define RPG_CLIENT_AVATARSKILLTREEDATA_GETSKILLPOINTLEVEL_OFFSET UNITYSDK_OFFSET(0x9169700)
#define RPG_CLIENT_AVATARSKILLTREEDATA_GETSKILLTREEPOINTLEVELBYANCHORTYPE_OFFSET UNITYSDK_OFFSET(0x91695D0)
#define RPG_CLIENT_AVATARSKILLTREEDATA_GETSKILLTREEPOINTLEVEL_OFFSET UNITYSDK_OFFSET(0x9169190)
#define RPG_CLIENT_AVATARSKILLTREEDATA_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0x9169E90)
#define RPG_CLIENT_AVATARSKILLTREEDATA_GET_ENHANCEDID_OFFSET UNITYSDK_OFFSET(0x9169EB0)
#define RPG_CLIENT_AVATARSKILLTREEDATA_ISSKILLTREEMAX_OFFSET UNITYSDK_OFFSET(0x9169790)
#define RPG_CLIENT_AVATARSKILLTREEDATA_SETINITIALSKILLS_OFFSET UNITYSDK_OFFSET(0x9167130)
#define RPG_CLIENT_AVATARSKILLTREEDATA_SETINITIALSKILLTREEDATA_OFFSET UNITYSDK_OFFSET(0x9168DE0)
#define RPG_CLIENT_AVATARSKILLTREEDATA_SETULTIMATESKILLS_OFFSET UNITYSDK_OFFSET(0x9168440)
#define RPG_CLIENT_AVATARSKILLTREEDATA_SETULTIMATESKILLTREEDATA_OFFSET UNITYSDK_OFFSET(0x9169220)
#define RPG_CLIENT_AVATARSKILLTREEDATA_SET_AVATARID_OFFSET UNITYSDK_OFFSET(0x9169EA0)
#define RPG_CLIENT_AVATARSKILLTREEDATA_SET_ENHANCEDID_OFFSET UNITYSDK_OFFSET(0x9169EC0)
#define RPG_CLIENT_AVATARSKILLTREEDATA_SWITCHAVATAR_OFFSET UNITYSDK_OFFSET(0x91677F0)
#define RPG_CLIENT_AVATARSKILLTREEDATA_SYNCSKILLTREE_OFFSET UNITYSDK_OFFSET(0x9164FD0)
#define RPG_CLIENT_AVATARSKILLTREEDATA_UPDATESKILLTREELEVELS_OFFSET UNITYSDK_OFFSET(0x9168030)
#define RPG_CLIENT_AVATARSKILLTREEDATA__BUILDANCHORTYPE2POINTID_OFFSET UNITYSDK_OFFSET(0x9167E00)
#define RPG_CLIENT_AVATARSKILLTREEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9169ED0)
#define RPG_CLIENT_AVATARSKILLTREEDATA__GETMAXLEVELLIST_OFFSET UNITYSDK_OFFSET(0x9168BB0)
#define RPG_CLIENT_AVATARSKILLTREEDATA__GETSKILLTREEPOINTSUITLEVEL_OFFSET UNITYSDK_OFFSET(0x9169D60)
#define RPG_CLIENT_AVATARSKILLTREEDATA__OVERRIDESKILLHIDEINUI_OFFSET UNITYSDK_OFFSET(0x91658D0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(AvatarSkillTreeData_TypeDefinitionIndex)->GetStaticField(0x471F0);
		}
		// static const ::System::String* _MAX_LEVEL_KEY; // 0x0
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::UInt32>* SkillTreeLevels; // 0x10
		::System::Collections::Generic::Dictionary_2<::RPG::GameCore::AvatarSkillTreeAnchorType, ::System::UInt32>* _PointIDOfAnchorType; // 0x18
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::UInt32>* SkillLevels; // 0x20
		::RPG::GameCore::AvatarBaseType _BelongAvatarBaseType; // 0x28
		::System::UInt32 _AvatarID_k__BackingField; // 0x2C
		::System::UInt32 _EnhancedID_k__BackingField; // 0x30
