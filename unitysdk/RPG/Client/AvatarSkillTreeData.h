...
#define RPG_CLIENT_AVATARSKILLTREEDATA_BUILDSKILLLEVELS_OFFSET UNITYSDK_OFFSET(0x8D5A0B0)
#define RPG_CLIENT_AVATARSKILLTREEDATA_BUILDSPECIALAVATARSKILLTREE_OFFSET UNITYSDK_OFFSET(0x8D59EC0)
#define RPG_CLIENT_AVATARSKILLTREEDATA_COPYSKILLLEVELS_OFFSET UNITYSDK_OFFSET(0x8D5AE50)
#define RPG_CLIENT_AVATARSKILLTREEDATA_GENERATESKILLTREEPOINTDATA_OFFSET UNITYSDK_OFFSET(0x8D59CB0)
#define RPG_CLIENT_AVATARSKILLTREEDATA_GETRECOMMENDPOINTS_OFFSET UNITYSDK_OFFSET(0x8D5D930)
#define RPG_CLIENT_AVATARSKILLTREEDATA_GETSKILLCOMBATPOWER_OFFSET UNITYSDK_OFFSET(0x8D59C50)
#define RPG_CLIENT_AVATARSKILLTREEDATA_GETSKILLPOINTLEVEL_OFFSET UNITYSDK_OFFSET(0x8D58A30)
#define RPG_CLIENT_AVATARSKILLTREEDATA_GETSKILLTREEPOINTLEVELBYANCHORTYPE_OFFSET UNITYSDK_OFFSET(0x8D5D5C0)
#define RPG_CLIENT_AVATARSKILLTREEDATA_GETSKILLTREEPOINTLEVEL_OFFSET UNITYSDK_OFFSET(0x8D5D180)
#define RPG_CLIENT_AVATARSKILLTREEDATA_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0x8D5DE00)
#define RPG_CLIENT_AVATARSKILLTREEDATA_GET_ENHANCEDID_OFFSET UNITYSDK_OFFSET(0x8D5DE20)
#define RPG_CLIENT_AVATARSKILLTREEDATA_ISSKILLTREEMAX_OFFSET UNITYSDK_OFFSET(0x8D5D6F0)
#define RPG_CLIENT_AVATARSKILLTREEDATA_SETINITIALSKILLS_OFFSET UNITYSDK_OFFSET(0x8D5B110)
#define RPG_CLIENT_AVATARSKILLTREEDATA_SETINITIALSKILLTREEDATA_OFFSET UNITYSDK_OFFSET(0x8D5CDE0)
#define RPG_CLIENT_AVATARSKILLTREEDATA_SETULTIMATESKILLS_OFFSET UNITYSDK_OFFSET(0x8D5C440)
#define RPG_CLIENT_AVATARSKILLTREEDATA_SETULTIMATESKILLTREEDATA_OFFSET UNITYSDK_OFFSET(0x8D5D210)
#define RPG_CLIENT_AVATARSKILLTREEDATA_SET_AVATARID_OFFSET UNITYSDK_OFFSET(0x8D5DE10)
#define RPG_CLIENT_AVATARSKILLTREEDATA_SET_ENHANCEDID_OFFSET UNITYSDK_OFFSET(0x8D5DE30)
#define RPG_CLIENT_AVATARSKILLTREEDATA_SWITCHAVATAR_OFFSET UNITYSDK_OFFSET(0x8D5B7D0)
#define RPG_CLIENT_AVATARSKILLTREEDATA_SYNCSKILLTREE_OFFSET UNITYSDK_OFFSET(0x8D58F70)
#define RPG_CLIENT_AVATARSKILLTREEDATA_UPDATESKILLTREELEVELS_OFFSET UNITYSDK_OFFSET(0x8D5C010)
#define RPG_CLIENT_AVATARSKILLTREEDATA__BUILDANCHORTYPE2POINTID_OFFSET UNITYSDK_OFFSET(0x8D5BDE0)
#define RPG_CLIENT_AVATARSKILLTREEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8D5DE40)
#define RPG_CLIENT_AVATARSKILLTREEDATA__GETMAXLEVELLIST_OFFSET UNITYSDK_OFFSET(0x8D5CBB0)
#define RPG_CLIENT_AVATARSKILLTREEDATA__GETSKILLTREEPOINTSUITLEVEL_OFFSET UNITYSDK_OFFSET(0x8D5DCC0)
#define RPG_CLIENT_AVATARSKILLTREEDATA__OVERRIDESKILLHIDEINUI_OFFSET UNITYSDK_OFFSET(0x8D59870)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarSkillTreeData_TypeDefinitionIndex = 49640;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(AvatarSkillTreeData_TypeDefinitionIndex)->GetStaticField(0x340F0);
		}
		...
		::System::UInt32 _EnhancedID_k__BackingField; // 0x28
		::RPG::GameCore::AvatarBaseType _BelongAvatarBaseType; // 0x2C
