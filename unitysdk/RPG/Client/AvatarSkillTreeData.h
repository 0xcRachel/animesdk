...
#define RPG_CLIENT_AVATARSKILLTREEDATA_BUILDSKILLLEVELS_OFFSET UNITYSDK_OFFSET(0x15E45D20)
#define RPG_CLIENT_AVATARSKILLTREEDATA_BUILDSPECIALAVATARSKILLTREE_OFFSET UNITYSDK_OFFSET(0x15E45B30)
#define RPG_CLIENT_AVATARSKILLTREEDATA_COPYSKILLLEVELS_OFFSET UNITYSDK_OFFSET(0x15E46A90)
#define RPG_CLIENT_AVATARSKILLTREEDATA_GENERATESKILLTREEPOINTDATA_OFFSET UNITYSDK_OFFSET(0x15E45920)
#define RPG_CLIENT_AVATARSKILLTREEDATA_GETRECOMMENDPOINTS_OFFSET UNITYSDK_OFFSET(0x15E49560)
#define RPG_CLIENT_AVATARSKILLTREEDATA_GETSKILLCOMBATPOWER_OFFSET UNITYSDK_OFFSET(0x15E458C0)
#define RPG_CLIENT_AVATARSKILLTREEDATA_GETSKILLPOINTLEVEL_OFFSET UNITYSDK_OFFSET(0x15E49290)
#define RPG_CLIENT_AVATARSKILLTREEDATA_GETSKILLTREEPOINTLEVELBYANCHORTYPE_OFFSET UNITYSDK_OFFSET(0x15E49160)
#define RPG_CLIENT_AVATARSKILLTREEDATA_GETSKILLTREEPOINTLEVEL_OFFSET UNITYSDK_OFFSET(0x15E32E90)
#define RPG_CLIENT_AVATARSKILLTREEDATA_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0x15E49A20)
#define RPG_CLIENT_AVATARSKILLTREEDATA_GET_ENHANCEDID_OFFSET UNITYSDK_OFFSET(0x15E49A40)
#define RPG_CLIENT_AVATARSKILLTREEDATA_ISSKILLTREEMAX_OFFSET UNITYSDK_OFFSET(0x15E49320)
#define RPG_CLIENT_AVATARSKILLTREEDATA_SETINITIALSKILLS_OFFSET UNITYSDK_OFFSET(0x15E46D50)
#define RPG_CLIENT_AVATARSKILLTREEDATA_SETINITIALSKILLTREEDATA_OFFSET UNITYSDK_OFFSET(0x15E48A00)
#define RPG_CLIENT_AVATARSKILLTREEDATA_SETULTIMATESKILLS_OFFSET UNITYSDK_OFFSET(0x15E48060)
#define RPG_CLIENT_AVATARSKILLTREEDATA_SETULTIMATESKILLTREEDATA_OFFSET UNITYSDK_OFFSET(0x15E48DB0)
#define RPG_CLIENT_AVATARSKILLTREEDATA_SET_AVATARID_OFFSET UNITYSDK_OFFSET(0x15E49A30)
#define RPG_CLIENT_AVATARSKILLTREEDATA_SET_ENHANCEDID_OFFSET UNITYSDK_OFFSET(0x15E49A50)
#define RPG_CLIENT_AVATARSKILLTREEDATA_SWITCHAVATAR_OFFSET UNITYSDK_OFFSET(0x15E47410)
#define RPG_CLIENT_AVATARSKILLTREEDATA_SYNCSKILLTREE_OFFSET UNITYSDK_OFFSET(0x15E44BE0)
#define RPG_CLIENT_AVATARSKILLTREEDATA_UPDATESKILLTREELEVELS_OFFSET UNITYSDK_OFFSET(0x15E47C50)
#define RPG_CLIENT_AVATARSKILLTREEDATA__BUILDANCHORTYPE2POINTID_OFFSET UNITYSDK_OFFSET(0x15E47A20)
#define RPG_CLIENT_AVATARSKILLTREEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x15E49A60)
#define RPG_CLIENT_AVATARSKILLTREEDATA__GETMAXLEVELLIST_OFFSET UNITYSDK_OFFSET(0x15E487D0)
#define RPG_CLIENT_AVATARSKILLTREEDATA__GETSKILLTREEPOINTSUITLEVEL_OFFSET UNITYSDK_OFFSET(0x15E498F0)
#define RPG_CLIENT_AVATARSKILLTREEDATA__OVERRIDESKILLHIDEINUI_OFFSET UNITYSDK_OFFSET(0x15E454E0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(AvatarSkillTreeData_TypeDefinitionIndex)->GetStaticField(0x5CED0);
		}
