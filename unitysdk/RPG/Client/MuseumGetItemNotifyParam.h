...
#define RPG_CLIENT_MUSEUMGETITEMNOTIFYPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x98E36F0)

namespace RPG::Client
{
	inline static constexpr unsigned int MuseumGetItemNotifyParam_TypeDefinitionIndex = 52827;
