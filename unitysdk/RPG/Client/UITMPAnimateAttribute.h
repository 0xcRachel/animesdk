...
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_GET_MAT_OFFSET UNITYSDK_OFFSET(0xA209980)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_INIT_OFFSET UNITYSDK_OFFSET(0xA201780)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA209860)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_TMPMATPROPERTIESUPDATE_OFFSET UNITYSDK_OFFSET(0xA2018A0)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_UPDATE_OFFSET UNITYSDK_OFFSET(0xA209930)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0xA209A30)

namespace RPG::Client
{
	inline static constexpr unsigned int UITMPAnimateAttribute_TypeDefinitionIndex = 56345;
