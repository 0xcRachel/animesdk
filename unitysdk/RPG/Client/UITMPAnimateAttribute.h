...
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_GET_MAT_OFFSET UNITYSDK_OFFSET(0xA7437D0)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_INIT_OFFSET UNITYSDK_OFFSET(0xA73B870)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA7436D0)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_TMPMATPROPERTIESUPDATE_OFFSET UNITYSDK_OFFSET(0xA73B960)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_UPDATE_OFFSET UNITYSDK_OFFSET(0xA743780)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0xA743880)
