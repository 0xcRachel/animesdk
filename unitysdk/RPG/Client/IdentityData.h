...
#define RPG_CLIENT_IDENTITYDATA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x94C19F0)
#define RPG_CLIENT_IDENTITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x94C1A30)
#define RPG_CLIENT_IDENTITYDATA___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x94C1A40)

namespace RPG::Client
{
	inline static constexpr unsigned int IdentityData_TypeDefinitionIndex = 47536;
