...
#define RPG_CLIENT_GAMEPLAYLOCKMODULECONFIGLIST_METHOD_2_A83D84C085C4AB80_OFFSET UNITYSDK_OFFSET(0x1A0E9350)
#define RPG_CLIENT_GAMEPLAYLOCKMODULECONFIGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0E9680)
