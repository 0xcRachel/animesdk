...
#define RPG_CLIENT_MONOPOLYGAMEREWARDPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x988C000)

namespace RPG::Client
{
	inline static constexpr unsigned int MonopolyGameRewardParam_TypeDefinitionIndex = 52747;
