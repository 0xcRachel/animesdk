...
#define RPG_CLIENT_QUATERNIONROTATIONCONTROLMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x9D32B20)
#define RPG_CLIENT_QUATERNIONROTATIONCONTROLMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x9D32B70)
#define RPG_CLIENT_QUATERNIONROTATIONCONTROLMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x9D32C10)

namespace RPG::Client
{
	inline static constexpr unsigned int QuaternionRotationControlMonoPlugin_TypeDefinitionIndex = 56388;
