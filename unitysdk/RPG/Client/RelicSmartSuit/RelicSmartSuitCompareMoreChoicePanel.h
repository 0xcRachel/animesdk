...
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREMORECHOICEPANEL_CLEARCACHEDDATA_OFFSET UNITYSDK_OFFSET(0x131B14F0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREMORECHOICEPANEL_CONFIRM_OFFSET UNITYSDK_OFFSET(0x131B1850)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREMORECHOICEPANEL_CREATE_OFFSET UNITYSDK_OFFSET(0x131B1260)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREMORECHOICEPANEL_GETCURPAGERELICINFOS_OFFSET UNITYSDK_OFFSET(0x131B1750)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREMORECHOICEPANEL_GET_ISSHOW_OFFSET UNITYSDK_OFFSET(0x131B1240)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREMORECHOICEPANEL_HIDE_OFFSET UNITYSDK_OFFSET(0x131B1630)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREMORECHOICEPANEL_SET_ISSHOW_OFFSET UNITYSDK_OFFSET(0x131B1250)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREMORECHOICEPANEL_SHOW_OFFSET UNITYSDK_OFFSET(0x131B15F0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREMORECHOICEPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0x131B1390)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREMORECHOICEPANEL__INITSTRATEGY_OFFSET UNITYSDK_OFFSET(0x131B14A0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREMORECHOICEPANEL__INIT_OFFSET UNITYSDK_OFFSET(0x131B1430)

namespace RPG::Client::RelicSmartSuit
{
	inline static constexpr unsigned int RelicSmartSuitCompareMoreChoicePanel_TypeDefinitionIndex = 68666;
	...
	public:
		...
		::Class_0_16E4307DCC419505_1046* _Strategy; // 0x20
