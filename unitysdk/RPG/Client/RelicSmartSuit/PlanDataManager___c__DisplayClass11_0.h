...
#define RPG_CLIENT_RELICSMARTSUIT_PLANDATAMANAGER___C__DISPLAYCLASS11_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9D9C9A0)
#define RPG_CLIENT_RELICSMARTSUIT_PLANDATAMANAGER___C__DISPLAYCLASS11_0__REQUESTRELICSMARTSUITPLANDATAS_B__0_OFFSET UNITYSDK_OFFSET(0x9D9E040)
#define RPG_CLIENT_RELICSMARTSUIT_PLANDATAMANAGER___C__DISPLAYCLASS11_0__REQUESTRELICSMARTSUITPLANDATAS_B__1_OFFSET UNITYSDK_OFFSET(0x9D9E060)
#define RPG_CLIENT_RELICSMARTSUIT_PLANDATAMANAGER___C__DISPLAYCLASS11_0__REQUESTRELICSMARTSUITPLANDATAS_B__2_OFFSET UNITYSDK_OFFSET(0x9D9E080)
#define RPG_CLIENT_RELICSMARTSUIT_PLANDATAMANAGER___C__DISPLAYCLASS11_0__REQUESTRELICSMARTSUITPLANDATAS_B__3_OFFSET UNITYSDK_OFFSET(0x9D9E130)
#define RPG_CLIENT_RELICSMARTSUIT_PLANDATAMANAGER___C__DISPLAYCLASS11_0__REQUESTRELICSMARTSUITPLANDATAS_B__4_OFFSET UNITYSDK_OFFSET(0x9D9E150)

namespace RPG::Client::RelicSmartSuit
{
	inline static constexpr unsigned int PlanDataManager___c__DisplayClass11_0_TypeDefinitionIndex = 59418;
