...
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_CONFIRMSELECTMORECHOICE_OFFSET UNITYSDK_OFFSET(0xA2C4420)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xA2C26C0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_DESTROY_OFFSET UNITYSDK_OFFSET(0xA2C2CC0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_FLIPPAGE_OFFSET UNITYSDK_OFFSET(0xA2C2EC0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_GETFOCUSEDRELICINFO_OFFSET UNITYSDK_OFFSET(0xA2C32B0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_GETRELICRESULTINFOS_OFFSET UNITYSDK_OFFSET(0xA2C3E00)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_GET_CURINDEX_OFFSET UNITYSDK_OFFSET(0xA2C2480)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_GET_CURRELICINFO_OFFSET UNITYSDK_OFFSET(0xA2C25A0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_GET_CURRELICTYPE_OFFSET UNITYSDK_OFFSET(0xA2C24A0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_GET_ISMORECHOICESHOW_OFFSET UNITYSDK_OFFSET(0xA2C2660)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_GET_LASTPAGESELECTEDRELICINFO_OFFSET UNITYSDK_OFFSET(0xA2C2680)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_GET_PININFORECORDER_OFFSET UNITYSDK_OFFSET(0xA2C2380)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_GET_PLANRESULT_OFFSET UNITYSDK_OFFSET(0xA2C23E0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_GET_PREINDEX_OFFSET UNITYSDK_OFFSET(0xA2C2460)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_GET_RELICINFOLIST_OFFSET UNITYSDK_OFFSET(0xA2C2400)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_GET_SELECTEDRELICINFOINMORECHOICE_OFFSET UNITYSDK_OFFSET(0xA2C26A0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_HIDEMORECHOICEPANEL_OFFSET UNITYSDK_OFFSET(0xA2C3C10)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_ISINPLANRESULT_OFFSET UNITYSDK_OFFSET(0xA2C4A60)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_ISPINNED_OFFSET UNITYSDK_OFFSET(0xA2C31E0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_ISSELECTEDRELICPINNED_OFFSET UNITYSDK_OFFSET(0xA2C3D30)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_PINORUNPINRELIC_OFFSET UNITYSDK_OFFSET(0xA2C3340)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_SELECTRELICINMORECHOICE_OFFSET UNITYSDK_OFFSET(0xA2C4260)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_SETPLANRESULT_OFFSET UNITYSDK_OFFSET(0xA2C29E0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_SET_CURINDEX_OFFSET UNITYSDK_OFFSET(0xA2C2490)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_SET_ISMORECHOICESHOW_OFFSET UNITYSDK_OFFSET(0xA2C2670)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_SET_LASTPAGESELECTEDRELICINFO_OFFSET UNITYSDK_OFFSET(0xA2C2690)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_SET_PLANRESULT_OFFSET UNITYSDK_OFFSET(0xA2C23F0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_SET_PREINDEX_OFFSET UNITYSDK_OFFSET(0xA2C2470)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_SET_SELECTEDRELICINFOINMORECHOICE_OFFSET UNITYSDK_OFFSET(0xA2C26B0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_SHOWMORECHOICEPANEL_OFFSET UNITYSDK_OFFSET(0xA2C3BD0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__CLEARCACHEDDATA_OFFSET UNITYSDK_OFFSET(0xA2C2D00)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__CLEARCACHEDRELICRESULTINFOSBYRELICTYPE_OFFSET UNITYSDK_OFFSET(0xA2C2DA0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xA2C2830)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__GETCLONEPINDATA_OFFSET UNITYSDK_OFFSET(0xA2C4490)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__GETORCREATERELICRESULTINFOS_OFFSET UNITYSDK_OFFSET(0xA2C3FB0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__INITDATASOURCE_OFFSET UNITYSDK_OFFSET(0xA2C28F0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__INITPINCHECKER_OFFSET UNITYSDK_OFFSET(0xA2C2C10)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__ISSELECTEDRELICINFOINMORECHOICEVALID_OFFSET UNITYSDK_OFFSET(0xA2C4360)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__NOTIFYHIDEMORECHOICEPANEL_OFFSET UNITYSDK_OFFSET(0xA2C3CE0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__NOTIFYMODIFYPIN_OFFSET UNITYSDK_OFFSET(0xA2C4BC0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__NOTIFYREFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xA2C3190)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__NOTIFYSELECTRELICINMORECHOICE_OFFSET UNITYSDK_OFFSET(0xA2C4310)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__PINSELECTEDRELIC_OFFSET UNITYSDK_OFFSET(0xA2C36F0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__REQUESTMODIFYPINRELIC_OFFSET UNITYSDK_OFFSET(0xA2C4670)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__RESETSELECTEDRELICINFOINMORECHOICE_OFFSET UNITYSDK_OFFSET(0xA2C3140)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__SETFOCUSEDRELICINFO_OFFSET UNITYSDK_OFFSET(0xA2C3B30)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__TRYRESETSELECTEDRELICINFOINMORECHOICE_OFFSET UNITYSDK_OFFSET(0xA2C4130)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__UNPINSELECTEDRELIC_OFFSET UNITYSDK_OFFSET(0xA2C3480)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL___PINSELECTEDRELIC_B__58_0_OFFSET UNITYSDK_OFFSET(0xA2C4C60)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL___UNPINSELECTEDRELIC_B__59_0_OFFSET UNITYSDK_OFFSET(0xA2C4D80)

namespace RPG::Client::RelicSmartSuit
{
	inline static constexpr unsigned int RelicSmartSuitCompareViewModel_TypeDefinitionIndex = 61201;
	...
	public:
		...
		::RPG::Client::RelicSmartSuit::RelicSmartSuitResultRelicInfo* _LastPageSelectedRelicInfo_k__BackingField; // 0x30
		...
		::System::Boolean _IsMoreChoiceShow_k__BackingField; // 0x4C
		::System::Int32 _CurIndex_k__BackingField; // 0x50
