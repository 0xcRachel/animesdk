...
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_CONFIRMSELECTMORECHOICE_OFFSET UNITYSDK_OFFSET(0x9DA37E0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x9DA19D0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_DESTROY_OFFSET UNITYSDK_OFFSET(0x9DA1FD0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_FLIPPAGE_OFFSET UNITYSDK_OFFSET(0x9DA21D0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_GETFOCUSEDRELICINFO_OFFSET UNITYSDK_OFFSET(0x9DA25C0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_GETRELICRESULTINFOS_OFFSET UNITYSDK_OFFSET(0x9DA31C0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_GET_CURINDEX_OFFSET UNITYSDK_OFFSET(0x9DA1790)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_GET_CURRELICINFO_OFFSET UNITYSDK_OFFSET(0x9DA18B0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_GET_CURRELICTYPE_OFFSET UNITYSDK_OFFSET(0x9DA17B0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_GET_ISMORECHOICESHOW_OFFSET UNITYSDK_OFFSET(0x9DA1970)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_GET_LASTPAGESELECTEDRELICINFO_OFFSET UNITYSDK_OFFSET(0x9DA1990)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_GET_PININFORECORDER_OFFSET UNITYSDK_OFFSET(0x9DA1690)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_GET_PLANRESULT_OFFSET UNITYSDK_OFFSET(0x9DA16F0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_GET_PREINDEX_OFFSET UNITYSDK_OFFSET(0x9DA1770)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_GET_RELICINFOLIST_OFFSET UNITYSDK_OFFSET(0x9DA1710)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_GET_SELECTEDRELICINFOINMORECHOICE_OFFSET UNITYSDK_OFFSET(0x9DA19B0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_HIDEMORECHOICEPANEL_OFFSET UNITYSDK_OFFSET(0x9DA2FD0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_ISINPLANRESULT_OFFSET UNITYSDK_OFFSET(0x9DA3EC0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_ISPINNED_OFFSET UNITYSDK_OFFSET(0x9DA24F0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_ISSELECTEDRELICPINNED_OFFSET UNITYSDK_OFFSET(0x9DA30F0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_PINORUNPINRELIC_OFFSET UNITYSDK_OFFSET(0x9DA2650)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_SELECTRELICINMORECHOICE_OFFSET UNITYSDK_OFFSET(0x9DA3620)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_SETPLANRESULT_OFFSET UNITYSDK_OFFSET(0x9DA1CF0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_SET_CURINDEX_OFFSET UNITYSDK_OFFSET(0x9DA17A0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_SET_ISMORECHOICESHOW_OFFSET UNITYSDK_OFFSET(0x9DA1980)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_SET_LASTPAGESELECTEDRELICINFO_OFFSET UNITYSDK_OFFSET(0x9DA19A0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_SET_PLANRESULT_OFFSET UNITYSDK_OFFSET(0x9DA1700)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_SET_PREINDEX_OFFSET UNITYSDK_OFFSET(0x9DA1780)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_SET_SELECTEDRELICINFOINMORECHOICE_OFFSET UNITYSDK_OFFSET(0x9DA19C0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_SHOWMORECHOICEPANEL_OFFSET UNITYSDK_OFFSET(0x9DA2F90)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__CLEARCACHEDDATA_OFFSET UNITYSDK_OFFSET(0x9DA2010)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__CLEARCACHEDRELICRESULTINFOSBYRELICTYPE_OFFSET UNITYSDK_OFFSET(0x9DA20B0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x9DA1B40)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__GETCLONEPINDATA_OFFSET UNITYSDK_OFFSET(0x9DA3850)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__GETORCREATERELICRESULTINFOS_OFFSET UNITYSDK_OFFSET(0x9DA3370)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__INITDATASOURCE_OFFSET UNITYSDK_OFFSET(0x9DA1C00)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__INITPINCHECKER_OFFSET UNITYSDK_OFFSET(0x9DA1F20)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__ISSELECTEDRELICINFOINMORECHOICEVALID_OFFSET UNITYSDK_OFFSET(0x9DA3720)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__NOTIFYHIDEMORECHOICEPANEL_OFFSET UNITYSDK_OFFSET(0x9DA30A0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__NOTIFYMODIFYPIN_OFFSET UNITYSDK_OFFSET(0x9DA4020)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__NOTIFYREFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x9DA24A0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__NOTIFYSELECTRELICINMORECHOICE_OFFSET UNITYSDK_OFFSET(0x9DA36D0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__PINSELECTEDRELIC_OFFSET UNITYSDK_OFFSET(0x9DA2A40)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__REQUESTMODIFYPINRELIC_OFFSET UNITYSDK_OFFSET(0x9DA3A60)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__RESETSELECTEDRELICINFOINMORECHOICE_OFFSET UNITYSDK_OFFSET(0x9DA2450)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__SETFOCUSEDRELICINFO_OFFSET UNITYSDK_OFFSET(0x9DA2EF0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__TRYRESETSELECTEDRELICINFOINMORECHOICE_OFFSET UNITYSDK_OFFSET(0x9DA34F0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__UNPINSELECTEDRELIC_OFFSET UNITYSDK_OFFSET(0x9DA2790)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL___PINSELECTEDRELIC_B__58_0_OFFSET UNITYSDK_OFFSET(0x9DA40C0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL___UNPINSELECTEDRELIC_B__59_0_OFFSET UNITYSDK_OFFSET(0x9DA41E0)

namespace RPG::Client::RelicSmartSuit
{
	inline static constexpr unsigned int RelicSmartSuitCompareViewModel_TypeDefinitionIndex = 59447;

	class RelicSmartSuitCompareViewModel : public ::System::Object
	{
	public:
		::RPG::Client::RelicSmartSuit::RelicSmartSuitResultRelicInfo* _LastPageSelectedRelicInfo_k__BackingField; // 0x10
		::System::Collections::Generic::Dictionary_2<::RPG::GameCore::RelicType, ::System::Collections::Generic::List_1<::RPG::Client::RelicSmartSuit::RelicSmartSuitResultRelicInfo*>*>* _CachedMoreChoiceRelicResultInfos; // 0x18
		::Class_1_045F75CAE3CBF38C* _PinChecker; // 0x20
		...
		::Class_1_81595715048249D2* _DataSource; // 0x38
		::RPG::Client::RelicSmartSuit::RelicSmartSuitResultRelicInfo* _SelectedRelicInfoInMoreChoice_k__BackingField; // 0x40
		::System::Int32 _PreIndex_k__BackingField; // 0x48
		::System::Int32 _CurIndex_k__BackingField; // 0x4C
		...
		static ::RPG::Client::RelicSmartSuit::RelicSmartSuitCompareViewModel* Create(::System::Int32 index, ::RPG::Client::IAvatarInfoProvider* avatarData, ::RPG::Client::RelicSmartSuit::RelicSmartSuitPlanData* planData, ::RPG::Client::RelicSmartSuit::RelicSmartSuitCalculationResultData* planResult)
		{
			return ((::RPG::Client::RelicSmartSuit::RelicSmartSuitCompareViewModel*(*)(::System::Int32, ::RPG::Client::IAvatarInfoProvider*, ::RPG::Client::RelicSmartSuit::RelicSmartSuitPlanData*, ::RPG::Client::RelicSmartSuit::RelicSmartSuitCalculationResultData*))((::PBYTE)hIl2Cpp + RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL_CREATE_OFFSET))(index, avatarData, planData, planResult);
		}

		::System::Void _InitDataSource(::RPG::Client::IAvatarInfoProvider* avatarData, ::RPG::Client::RelicSmartSuit::RelicSmartSuitPlanData* planData)
		{
			return ((::System::Void(*)(::PVOID, ::RPG::Client::IAvatarInfoProvider*, ::RPG::Client::RelicSmartSuit::RelicSmartSuitPlanData*))((::PBYTE)hIl2Cpp + RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREVIEWMODEL__INITDATASOURCE_OFFSET))(this, avatarData, planData);
		}
