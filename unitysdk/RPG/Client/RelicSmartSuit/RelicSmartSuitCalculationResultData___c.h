...
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCALCULATIONRESULTDATA___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xA2C0500)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCALCULATIONRESULTDATA___C__CTOR_OFFSET UNITYSDK_OFFSET(0xA2C0540)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCALCULATIONRESULTDATA___C__GET_RELICINFOLIST_B__32_0_OFFSET UNITYSDK_OFFSET(0xA2C0550)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCALCULATIONRESULTDATA___C__GET_RELICITEMDATAS_B__34_0_OFFSET UNITYSDK_OFFSET(0xA2C0600)

namespace RPG::Client::RelicSmartSuit
{
	inline static constexpr unsigned int RelicSmartSuitCalculationResultData___c_TypeDefinitionIndex = 61176;
	...
	public:
		...
		{
			return (::System::Comparison_1<::RPG::Client::RelicItemData*>**)Il2CppClass::FromTypeDefinitionIndex(RelicSmartSuitCalculationResultData___c_TypeDefinitionIndex)->GetStaticField(0x17420);
		}
		static ::RPG::Client::RelicSmartSuit::RelicSmartSuitCalculationResultData___c** StaticGet___9()
		{
			return (::RPG::Client::RelicSmartSuit::RelicSmartSuitCalculationResultData___c**)Il2CppClass::FromTypeDefinitionIndex(RelicSmartSuitCalculationResultData___c_TypeDefinitionIndex)->GetStaticField(0x17428);
		}
		static ::System::Comparison_1<::RPG::Client::RelicSmartSuit::RelicSmartSuitResultRelicInfo*>** StaticGet___9__32_0()
		{
			return (::System::Comparison_1<::RPG::Client::RelicSmartSuit::RelicSmartSuitResultRelicInfo*>**)Il2CppClass::FromTypeDefinitionIndex(RelicSmartSuitCalculationResultData___c_TypeDefinitionIndex)->GetStaticField(0x17430);
		}
