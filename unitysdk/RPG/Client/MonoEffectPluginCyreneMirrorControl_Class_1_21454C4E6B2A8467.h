...
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_CLASS_1_21454C4E6B2A8467_GET_TRACKER_OFFSET UNITYSDK_OFFSET(0x97F2F00)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_CLASS_1_21454C4E6B2A8467_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x97F1750)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_CLASS_1_21454C4E6B2A8467_SET_TRACKER_OFFSET UNITYSDK_OFFSET(0x97F2F10)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_CLASS_1_21454C4E6B2A8467__CTOR_OFFSET UNITYSDK_OFFSET(0x97F2350)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCyreneMirrorControl_Class_1_21454C4E6B2A8467_TypeDefinitionIndex = 55700;
