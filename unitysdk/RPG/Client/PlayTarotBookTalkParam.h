...
#define RPG_CLIENT_PLAYTAROTBOOKTALKPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x9B10B90)

namespace RPG::Client
{
	inline static constexpr unsigned int PlayTarotBookTalkParam_TypeDefinitionIndex = 53988;
