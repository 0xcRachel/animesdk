...
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0xA19BEE0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_LATETICK_OFFSET UNITYSDK_OFFSET(0xA19BB40)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0xA19BBA0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_119B32705B42FBD9_OFFSET UNITYSDK_OFFSET(0xA19C6A0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_228E3444D290BEE7_OFFSET UNITYSDK_OFFSET(0xA19B370)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_3BFE3B9EF8374F61_OFFSET UNITYSDK_OFFSET(0xA19B800)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xA19B680)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0xA19B6E0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0xA19B740)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xA19B620)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0xA19CF20)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_5790A55946AA509D_2_OFFSET UNITYSDK_OFFSET(0xA19CF80)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_5790A55946AA509D_3_OFFSET UNITYSDK_OFFSET(0xA19CFE0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_5790A55946AA509D_4_OFFSET UNITYSDK_OFFSET(0xA19D040)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_5790A55946AA509D_5_OFFSET UNITYSDK_OFFSET(0xA19D0A0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xA19CEC0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_5A50C1842B2C85AF_OFFSET UNITYSDK_OFFSET(0xA19C150)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_704FAC4600717444_OFFSET UNITYSDK_OFFSET(0xA19B3E0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_84895CD37C104CC6_OFFSET UNITYSDK_OFFSET(0xA19C970)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xA19B2A0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_C2F69B077374B167_OFFSET UNITYSDK_OFFSET(0xA19BF50)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0xA19B7A0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xA19CE80)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR__FLIPLEFTPAGE_B__25_0_OFFSET UNITYSDK_OFFSET(0xA19CEA0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR__FLIPRIGHTPAGE_B__24_0_OFFSET UNITYSDK_OFFSET(0xA19CE90)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR__UPDATE_B__27_0_OFFSET UNITYSDK_OFFSET(0xA19CEB0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR___IFIXBASEPROXY_LATETICK_OFFSET UNITYSDK_OFFSET(0xA19D170)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0xA19D100)

namespace RPG::Client
{
	inline static constexpr unsigned int UIAutoFlipBehavior_TypeDefinitionIndex = 56610;
