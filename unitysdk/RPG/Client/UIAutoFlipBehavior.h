...
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0xA67FEF0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_LATETICK_OFFSET UNITYSDK_OFFSET(0xA67FB50)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0xA67FBB0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_119B32705B42FBD9_OFFSET UNITYSDK_OFFSET(0xA6806B0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_228E3444D290BEE7_OFFSET UNITYSDK_OFFSET(0xA67F380)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_3BFE3B9EF8374F61_OFFSET UNITYSDK_OFFSET(0xA67F810)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xA67F690)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0xA67F6F0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0xA67F750)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xA67F630)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0xA680F30)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_5790A55946AA509D_2_OFFSET UNITYSDK_OFFSET(0xA680F90)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_5790A55946AA509D_3_OFFSET UNITYSDK_OFFSET(0xA680FF0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_5790A55946AA509D_4_OFFSET UNITYSDK_OFFSET(0xA681050)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_5790A55946AA509D_5_OFFSET UNITYSDK_OFFSET(0xA6810C0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xA680ED0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_5A50C1842B2C85AF_OFFSET UNITYSDK_OFFSET(0xA680160)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_704FAC4600717444_OFFSET UNITYSDK_OFFSET(0xA67F3F0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_84895CD37C104CC6_OFFSET UNITYSDK_OFFSET(0xA680980)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xA67F2B0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_C2F69B077374B167_OFFSET UNITYSDK_OFFSET(0xA67FF60)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0xA67F7B0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xA680E90)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR__FLIPLEFTPAGE_B__25_0_OFFSET UNITYSDK_OFFSET(0xA680EB0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR__FLIPRIGHTPAGE_B__24_0_OFFSET UNITYSDK_OFFSET(0xA680EA0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR__UPDATE_B__27_0_OFFSET UNITYSDK_OFFSET(0xA680EC0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR___IFIXBASEPROXY_LATETICK_OFFSET UNITYSDK_OFFSET(0xA6811A0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0xA681130)
