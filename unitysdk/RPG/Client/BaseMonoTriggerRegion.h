...
#define RPG_CLIENT_BASEMONOTRIGGERREGION_GETTRIGGER_OFFSET UNITYSDK_OFFSET(0xF398BB0)
#define RPG_CLIENT_BASEMONOTRIGGERREGION_OVERLAPPOINT_OFFSET UNITYSDK_OFFSET(0xF398BF0)
#define RPG_CLIENT_BASEMONOTRIGGERREGION_OVERLAP_OFFSET UNITYSDK_OFFSET(0xF398C50)
#define RPG_CLIENT_BASEMONOTRIGGERREGION_SETTRIGGER_OFFSET UNITYSDK_OFFSET(0xF398B40)
#define RPG_CLIENT_BASEMONOTRIGGERREGION_SYNCTRANSFORM_OFFSET UNITYSDK_OFFSET(0xF398CA0)
#define RPG_CLIENT_BASEMONOTRIGGERREGION__CTOR_OFFSET UNITYSDK_OFFSET(0xF398DF0)
...
namespace RPG::Client
{
	...
	{
	public:
		::Class_0_16E4307DCC419505_520* Field_5_0; // 0x18
		...
		::System::Void SetTrigger(::Class_0_16E4307DCC419505_520* a1, ::System::Boolean a2)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_520*, ::System::Boolean))((::PBYTE)hIl2Cpp + RPG_CLIENT_BASEMONOTRIGGERREGION_SETTRIGGER_OFFSET))(this, a1, a2);
		}

		::Class_0_16E4307DCC419505_520* GetTrigger()
		{
			return ((::Class_0_16E4307DCC419505_520*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_BASEMONOTRIGGERREGION_GETTRIGGER_OFFSET))(this);
		}
