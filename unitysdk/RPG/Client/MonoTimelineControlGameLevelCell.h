...
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELCELL_CREATEGAMEWORLDLEVELCELL_OFFSET UNITYSDK_OFFSET(0x98667B0)
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELCELL_DRAWFLOOR_OFFSET UNITYSDK_OFFSET(0x9867370)
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELCELL_DRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x9866AB0)
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELCELL_GET_DEBUGINFO_OFFSET UNITYSDK_OFFSET(0x9867B90)
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELCELL__CTOR_OFFSET UNITYSDK_OFFSET(0x9867BA0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoTimelineControlGameLevelCell_TypeDefinitionIndex = 47850;
	...
	public:
		...
		::Class_2_54AE1C44DE8123D2* CreateGameWorldLevelCell(::Class_2_F9A00379C2678C49* a1, ::Class_1_65ECD476422B13F6* a2)
		{
			return ((::Class_2_54AE1C44DE8123D2*(*)(::PVOID, ::Class_2_F9A00379C2678C49*, ::Class_1_65ECD476422B13F6*))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELCELL_CREATEGAMEWORLDLEVELCELL_OFFSET))(this, a1, a2);
		}
