...
#define RPG_CLIENT_GRIDFIGHTMODULE___C__DISPLAYCLASS209_0__CTOR_OFFSET UNITYSDK_OFFSET(0x986FF40)
#define RPG_CLIENT_GRIDFIGHTMODULE___C__DISPLAYCLASS209_0___TRYGETCURDATABYCDN_B__0_OFFSET UNITYSDK_OFFSET(0x9877C10)
#define RPG_CLIENT_GRIDFIGHTMODULE___C__DISPLAYCLASS209_0___TRYGETCURDATABYCDN_B__1_OFFSET UNITYSDK_OFFSET(0x9877C90)
#define RPG_CLIENT_GRIDFIGHTMODULE___C__DISPLAYCLASS209_0___TRYGETCURDATABYCDN_B__2_OFFSET UNITYSDK_OFFSET(0x9877E00)
#define RPG_CLIENT_GRIDFIGHTMODULE___C__DISPLAYCLASS209_0___TRYGETCURDATABYCDN_B__3_OFFSET UNITYSDK_OFFSET(0x9877D60)
