...
#define RPG_CLIENT_FTC_FTCUTILS_ALLOWCOMMUNITY_OFFSET UNITYSDK_OFFSET(0x9729AE0)
#define RPG_CLIENT_FTC_FTCUTILS_CANCHANGENICKNAME_OFFSET UNITYSDK_OFFSET(0x9729C90)
#define RPG_CLIENT_FTC_FTCUTILS_GETFTCPRODUCTDATA_OFFSET UNITYSDK_OFFSET(0x9729DE0)
#define RPG_CLIENT_FTC_FTCUTILS_GETGACHAPOOLFTCDESC_OFFSET UNITYSDK_OFFSET(0x972A010)
#define RPG_CLIENT_FTC_FTCUTILS_GETSHOWRESBARKEY_OFFSET UNITYSDK_OFFSET(0x9729D50)
#define RPG_CLIENT_FTC_FTCUTILS_ISFTCOPEN_OFFSET UNITYSDK_OFFSET(0x97299D0)
#define RPG_CLIENT_FTC_FTCUTILS__ISUNDER13YEARSOLD_OFFSET UNITYSDK_OFFSET(0x9729C10)

namespace RPG::Client::Ftc
{
	inline static constexpr unsigned int FtcUtils_TypeDefinitionIndex = 61505;
