...
#define RPG_CLIENT_TRANSFORMSCREENADAPTER_METHOD_1_03634C321C72FBE4_OFFSET UNITYSDK_OFFSET(0xA103E80)
#define RPG_CLIENT_TRANSFORMSCREENADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0xA105B10)

namespace RPG::Client
{
	inline static constexpr unsigned int TransformScreenAdapter_TypeDefinitionIndex = 56019;
