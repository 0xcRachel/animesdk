...
#define RPG_CLIENT_EVOLVEBUILDUTILS___C__DISPLAYCLASS2_1__CTOR_OFFSET UNITYSDK_OFFSET(0x17DCA1C0)
#define RPG_CLIENT_EVOLVEBUILDUTILS___C__DISPLAYCLASS2_1__SORTWEAPONLIST_B__1_OFFSET UNITYSDK_OFFSET(0x17DCA1E0)
#define RPG_CLIENT_EVOLVEBUILDUTILS___C__DISPLAYCLASS2_1__SORTWEAPONLIST_B__2_OFFSET UNITYSDK_OFFSET(0x17DCA210)
