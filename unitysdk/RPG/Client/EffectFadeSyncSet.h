...
#define RPG_CLIENT_EFFECTFADESYNCSET__CTOR_OFFSET UNITYSDK_OFFSET(0x9093990)

namespace RPG::Client
{
	inline static constexpr unsigned int EffectFadeSyncSet_TypeDefinitionIndex = 55591;
