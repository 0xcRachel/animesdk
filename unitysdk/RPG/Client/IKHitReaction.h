...
#define RPG_CLIENT_IKHITREACTION_METHOD_1_1B3D8773D1869301_OFFSET UNITYSDK_OFFSET(0x94BC730)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x94BDF40)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_2566AD459572DFC3_OFFSET UNITYSDK_OFFSET(0x94BEE20)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_4BE13EEB6DEF71F5_OFFSET UNITYSDK_OFFSET(0x94BFBE0)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_5B0C21255CD96FEA_OFFSET UNITYSDK_OFFSET(0x94BC660)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_5D3D37F2BAE9FB65_OFFSET UNITYSDK_OFFSET(0x94BDFA0)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_62D279C79F0018EF_OFFSET UNITYSDK_OFFSET(0x94BCAF0)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_7248DB1A337B706C_OFFSET UNITYSDK_OFFSET(0x94BE140)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_91C638630F1EEE79_1_OFFSET UNITYSDK_OFFSET(0x94C0530)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_91C638630F1EEE79_2_OFFSET UNITYSDK_OFFSET(0x94C05C0)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_91C638630F1EEE79_OFFSET UNITYSDK_OFFSET(0x94BF7E0)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_9B5A8342063042C5_OFFSET UNITYSDK_OFFSET(0x94BDC60)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_B2F5FC39AA96B863_OFFSET UNITYSDK_OFFSET(0x94BF5E0)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_BE4EBC8FF4054312_OFFSET UNITYSDK_OFFSET(0x94BC870)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_C3B113AF6205EF51_OFFSET UNITYSDK_OFFSET(0x94C0300)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_C66E15B631BB1D0F_OFFSET UNITYSDK_OFFSET(0x94BFAF0)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_C796A0B42720FBD3_OFFSET UNITYSDK_OFFSET(0x94BECC0)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_EBACF9DE1FDD063D_OFFSET UNITYSDK_OFFSET(0x94BD9A0)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_EC00644AF39B5DED_OFFSET UNITYSDK_OFFSET(0x94BF4A0)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_FA1B171818AF9953_OFFSET UNITYSDK_OFFSET(0x94BF870)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_FD12EB6765049173_OFFSET UNITYSDK_OFFSET(0x94BCDA0)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_FD1EFD5A6E481F5B_OFFSET UNITYSDK_OFFSET(0x94C04C0)
#define RPG_CLIENT_IKHITREACTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x94C0690)
#define RPG_CLIENT_IKHITREACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x94C0650)

namespace RPG::Client
{
	inline static constexpr unsigned int IKHitReaction_TypeDefinitionIndex = 54333;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::Class_1_53196D6FF2C19831*>**)Il2CppClass::FromTypeDefinitionIndex(IKHitReaction_TypeDefinitionIndex)->GetStaticField(0x13FD0);
		}
		static ::System::Collections::Generic::List_1<::UnityEngine::Transform*>** StaticGet__ChainTargetCache()
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Transform*>**)Il2CppClass::FromTypeDefinitionIndex(IKHitReaction_TypeDefinitionIndex)->GetStaticField(0x13FD8);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::UnityEngine::Transform*, ::RPG::Client::IKHitReaction_Struct_2_CC346D804C45C8EA_1>**)Il2CppClass::FromTypeDefinitionIndex(IKHitReaction_TypeDefinitionIndex)->GetStaticField(0x13FE0);
		}
		...
		::System::Void Method_1_7248DB1A337B706C(::System::Single a1)
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_IKHITREACTION_METHOD_1_7248DB1A337B706C_OFFSET))(this, a1);
		}
