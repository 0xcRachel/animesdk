...
#define RPG_CLIENT_IKHITREACTION_METHOD_1_1B3D8773D1869301_OFFSET UNITYSDK_OFFSET(0x993FF50)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x9941750)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_2566AD459572DFC3_OFFSET UNITYSDK_OFFSET(0x9942640)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_2DF0EFFDA2B6622E_OFFSET UNITYSDK_OFFSET(0x9941960)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_4BE13EEB6DEF71F5_OFFSET UNITYSDK_OFFSET(0x9943410)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_5B0C21255CD96FEA_OFFSET UNITYSDK_OFFSET(0x993FE80)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_5D3D37F2BAE9FB65_OFFSET UNITYSDK_OFFSET(0x99417B0)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_62D279C79F0018EF_OFFSET UNITYSDK_OFFSET(0x9940310)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_91C638630F1EEE79_1_OFFSET UNITYSDK_OFFSET(0x9943D70)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_91C638630F1EEE79_2_OFFSET UNITYSDK_OFFSET(0x9943E00)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_91C638630F1EEE79_OFFSET UNITYSDK_OFFSET(0x9943010)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_9B5A8342063042C5_OFFSET UNITYSDK_OFFSET(0x9941470)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_B2F5FC39AA96B863_OFFSET UNITYSDK_OFFSET(0x9942E10)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_BE4EBC8FF4054312_OFFSET UNITYSDK_OFFSET(0x9940090)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_C3B113AF6205EF51_OFFSET UNITYSDK_OFFSET(0x9943B40)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_C66E15B631BB1D0F_OFFSET UNITYSDK_OFFSET(0x9943320)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_C796A0B42720FBD3_OFFSET UNITYSDK_OFFSET(0x99424E0)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_EBACF9DE1FDD063D_OFFSET UNITYSDK_OFFSET(0x99411C0)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_EC00644AF39B5DED_OFFSET UNITYSDK_OFFSET(0x9942CD0)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_FA1B171818AF9953_OFFSET UNITYSDK_OFFSET(0x99430A0)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_FD12EB6765049173_OFFSET UNITYSDK_OFFSET(0x99405C0)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_FD1EFD5A6E481F5B_OFFSET UNITYSDK_OFFSET(0x9943D00)
#define RPG_CLIENT_IKHITREACTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x9943ED0)
#define RPG_CLIENT_IKHITREACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x9943E90)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::UnityEngine::Transform*, ::RPG::Client::IKHitReaction_Struct_2_CC346D804C45C8EA_1>**)Il2CppClass::FromTypeDefinitionIndex(IKHitReaction_TypeDefinitionIndex)->GetStaticField(0x282A0);
		}
		static ::System::Collections::Generic::List_1<::UnityEngine::Transform*>** StaticGet__ChainTargetCache()
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Transform*>**)Il2CppClass::FromTypeDefinitionIndex(IKHitReaction_TypeDefinitionIndex)->GetStaticField(0x282A8);
		}
		static ::System::Collections::Generic::List_1<::Class_1_53196D6FF2C19831*>** StaticGet__ChainCache()
		{
			return (::System::Collections::Generic::List_1<::Class_1_53196D6FF2C19831*>**)Il2CppClass::FromTypeDefinitionIndex(IKHitReaction_TypeDefinitionIndex)->GetStaticField(0x282B0);
		}
