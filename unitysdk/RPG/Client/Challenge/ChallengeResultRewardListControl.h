...
#define RPG_CLIENT_CHALLENGE_CHALLENGERESULTREWARDLISTCONTROL_GET_ITEMS_OFFSET UNITYSDK_OFFSET(0x18FC0030)
#define RPG_CLIENT_CHALLENGE_CHALLENGERESULTREWARDLISTCONTROL_METHOD_5_705F9CF4D4ACC29E_OFFSET UNITYSDK_OFFSET(0x18FC0210)
#define RPG_CLIENT_CHALLENGE_CHALLENGERESULTREWARDLISTCONTROL_METHOD_5_E11AC65AA0DC2249_OFFSET UNITYSDK_OFFSET(0x18FC0090)
#define RPG_CLIENT_CHALLENGE_CHALLENGERESULTREWARDLISTCONTROL_SET_ITEMS_OFFSET UNITYSDK_OFFSET(0x18FC0040)
#define RPG_CLIENT_CHALLENGE_CHALLENGERESULTREWARDLISTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x18FC0480)
#define RPG_CLIENT_CHALLENGE_CHALLENGERESULTREWARDLISTCONTROL___REFRESH_B__5_0_OFFSET UNITYSDK_OFFSET(0x18FC0490)

namespace RPG::Client::Challenge
{
	inline static constexpr unsigned int ChallengeResultRewardListControl_TypeDefinitionIndex = 74076;
