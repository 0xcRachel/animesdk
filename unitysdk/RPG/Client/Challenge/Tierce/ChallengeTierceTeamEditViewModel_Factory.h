...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITVIEWMODEL_FACTORY_CREATE_OFFSET UNITYSDK_OFFSET(0x181CB3B0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITVIEWMODEL_FACTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x181CB370)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceTeamEditViewModel_Factory_TypeDefinitionIndex = 74282;

	class ChallengeTierceTeamEditViewModel_Factory : public ::System::Object
	{
	public:
		::Class_1_56190D054EB32434* _Repository; // 0x10
		::RPG::Client::Challenge::Tierce::ChallengeTierceStatisticsLineupRecommendationViewModel_Factory* _StatisticsRecommendationFactory; // 0x18
		...
		::Class_1_7D46F1066EF90FA6_3* _ObtainedAvatarService; // 0x38
		::RPG::Client::Challenge::Tierce::ChallengeTierceFriendLineupRecommendationViewModel_Factory* _FriendRecommendationFactory; // 0x40
