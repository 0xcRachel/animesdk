...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEMAZEPROGRESSHINTVIEWMODEL_GET_GROUPTYPE_OFFSET UNITYSDK_OFFSET(0x181A8B40)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEMAZEPROGRESSHINTVIEWMODEL_GET_LEFTROUNDCOUNT_OFFSET UNITYSDK_OFFSET(0x181A8B60)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEMAZEPROGRESSHINTVIEWMODEL_GET_OBTAINEDSCORE_OFFSET UNITYSDK_OFFSET(0x181A8B70)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEMAZEPROGRESSHINTVIEWMODEL_GET_STAGEINDEX_OFFSET UNITYSDK_OFFSET(0x181A8B50)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEMAZEPROGRESSHINTVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x181A8B80)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEMAZEPROGRESSHINTVIEWMODEL__GETLEFTROUNDCOUNT_OFFSET UNITYSDK_OFFSET(0x181A8BF0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEMAZEPROGRESSHINTVIEWMODEL__GETOBTAINEDSCORE_OFFSET UNITYSDK_OFFSET(0x181A8E60)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceMazeProgressHintViewModel_TypeDefinitionIndex = 74241;

	class ChallengeTierceMazeProgressHintViewModel : public ::System::Object
	{
	public:
		::System::Nullable_1<::System::Int32> _ObtainedScore_k__BackingField; // 0x10
