...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCEUNLOCKCONTROL_METHOD_5_A769C9FD65C21655_OFFSET UNITYSDK_OFFSET(0x181A5110)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCEUNLOCKCONTROL_METHOD_5_CEAC08E56A1C04F1_OFFSET UNITYSDK_OFFSET(0x181A51A0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCEUNLOCKCONTROL_METHOD_5_E17D7B2B77BDD1D5_OFFSET UNITYSDK_OFFSET(0x181A5150)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCEUNLOCKCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x181A5320)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceEntranceUnlockControl_TypeDefinitionIndex = 74193;
