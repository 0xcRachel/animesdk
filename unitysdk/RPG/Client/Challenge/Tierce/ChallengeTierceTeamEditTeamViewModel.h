...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_ADD_ONMODIFIEDBUFFIDCHANGED_OFFSET UNITYSDK_OFFSET(0x181C8AA0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x181C90D0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_GETMODIFIEDAVATARBYSLOT_OFFSET UNITYSDK_OFFSET(0x181C9120)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_GET_COUNTOFSLOT_OFFSET UNITYSDK_OFFSET(0x181C89D0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_GET_ISNEEDFORCESAVE_OFFSET UNITYSDK_OFFSET(0x181C87C0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_GET_MODIFIEDBUFFID_OFFSET UNITYSDK_OFFSET(0x181C8A00)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_GET_RELATEDSTAGE_OFFSET UNITYSDK_OFFSET(0x181C87B0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_ITERATEMODIFIEDAVATARROLEIDS_OFFSET UNITYSDK_OFFSET(0x181C91A0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_ITERATEMODIFIEDAVATARS_OFFSET UNITYSDK_OFFSET(0x181C92F0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_REMOVE_ONMODIFIEDBUFFIDCHANGED_OFFSET UNITYSDK_OFFSET(0x181C8B00)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_SETMODIFIEDAVATARBYSLOT_OFFSET UNITYSDK_OFFSET(0x181C9440)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_SET_MODIFIEDBUFFID_OFFSET UNITYSDK_OFFSET(0x181C8A10)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL__CHECKISLINEUPCHANGED_OFFSET UNITYSDK_OFFSET(0x181C8860)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x181C8B60)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceTeamEditTeamViewModel_TypeDefinitionIndex = 74277;
	...
	public:
		...
		::RPG::Client::Challenge::Tierce::ChallengeTierceStageViewModel* _RelatedStage_k__BackingField; // 0x30
