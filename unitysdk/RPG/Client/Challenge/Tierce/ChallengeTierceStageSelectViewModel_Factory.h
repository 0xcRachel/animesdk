...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTVIEWMODEL_FACTORY_CREATE_OFFSET UNITYSDK_OFFSET(0x181C3C10)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTVIEWMODEL_FACTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x181C3BF0)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceStageSelectViewModel_Factory_TypeDefinitionIndex = 74276;
	...
	public:
		...
		::Class_0_16E4307DCC419505_1222* _WindowService; // 0x30
