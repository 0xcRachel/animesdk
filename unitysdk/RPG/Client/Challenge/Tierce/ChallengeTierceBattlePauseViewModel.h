...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_GETSTAGERESULT_OFFSET UNITYSDK_OFFSET(0x18FC3DD0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_GET_CHALLENGEDATAREF_OFFSET UNITYSDK_OFFSET(0x18FC3BF0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_GET_CURRENTSTAGEBUFFID_OFFSET UNITYSDK_OFFSET(0x18FC3C70)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_GET_CURRENTSTAGEINDEX_OFFSET UNITYSDK_OFFSET(0x18FC3C50)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_GET_GROUPCONFIG_OFFSET UNITYSDK_OFFSET(0x18FC3BD0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_GET_ISPASSED_OFFSET UNITYSDK_OFFSET(0x18FC3C30)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_GET_STAGECOUNT_OFFSET UNITYSDK_OFFSET(0x18FC3CB0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_GET_STAGES_OFFSET UNITYSDK_OFFSET(0x18FC3C90)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_GET_TARGETS_OFFSET UNITYSDK_OFFSET(0x18FC3C10)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_SET_CHALLENGEDATAREF_OFFSET UNITYSDK_OFFSET(0x18FC3C00)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_SET_CURRENTSTAGEBUFFID_OFFSET UNITYSDK_OFFSET(0x18FC3C80)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_SET_CURRENTSTAGEINDEX_OFFSET UNITYSDK_OFFSET(0x18FC3C60)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_SET_GROUPCONFIG_OFFSET UNITYSDK_OFFSET(0x18FC3BE0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_SET_ISPASSED_OFFSET UNITYSDK_OFFSET(0x18FC3C40)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_SET_STAGES_OFFSET UNITYSDK_OFFSET(0x18FC3CA0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_SET_TARGETS_OFFSET UNITYSDK_OFFSET(0x18FC3C20)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_TRYGETMEMORYCONFIGTOTALROUNDCOUNT_OFFSET UNITYSDK_OFFSET(0x18FC3EE0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_TRYGETSTORYCONFIGCLEARSCORE_OFFSET UNITYSDK_OFFSET(0x18FC3FA0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_TRYGETSTORYCONFIGFEVERBUFFIDS_OFFSET UNITYSDK_OFFSET(0x18FC4060)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x18FC3DC0)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceBattlePauseViewModel_TypeDefinitionIndex = 74217;
	...
	public:
		...
		::Class_1_97E659ED8D5D259C_20* _GroupConfig_k__BackingField; // 0x28
		::System::Int32 _CurrentStageIndex_k__BackingField; // 0x30
