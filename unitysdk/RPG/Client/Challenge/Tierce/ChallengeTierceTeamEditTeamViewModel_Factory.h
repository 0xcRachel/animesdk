...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_FACTORY_CREATEALL_OFFSET UNITYSDK_OFFSET(0x181C96C0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_FACTORY_CREATEONE_OFFSET UNITYSDK_OFFSET(0x181C95F0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_FACTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x181C95E0)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceTeamEditTeamViewModel_Factory_TypeDefinitionIndex = 74278;
	...
	public:
		...
		::RPG::Client::Challenge::Tierce::ChallengeTierceStageViewModel_Factory* _StageFactory; // 0x20
