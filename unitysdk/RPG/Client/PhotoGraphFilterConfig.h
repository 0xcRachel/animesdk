...
#define RPG_CLIENT_PHOTOGRAPHFILTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9A7BF10)

namespace RPG::Client
{
	inline static constexpr unsigned int PhotoGraphFilterConfig_TypeDefinitionIndex = 55185;
