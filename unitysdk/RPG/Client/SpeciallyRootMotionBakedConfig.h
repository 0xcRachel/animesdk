...
#define RPG_CLIENT_SPECIALLYROOTMOTIONBAKEDCONFIG_AWAKE_OFFSET UNITYSDK_OFFSET(0x9F9F4A0)
#define RPG_CLIENT_SPECIALLYROOTMOTIONBAKEDCONFIG_METHOD_3_D312AC433EF9B2FD_OFFSET UNITYSDK_OFFSET(0x9F9F500)
#define RPG_CLIENT_SPECIALLYROOTMOTIONBAKEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9F9F610)

namespace RPG::Client
{
	inline static constexpr unsigned int SpeciallyRootMotionBakedConfig_TypeDefinitionIndex = 47581;
