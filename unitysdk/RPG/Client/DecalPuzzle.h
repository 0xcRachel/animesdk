...
#define RPG_CLIENT_DECALPUZZLE_AWAKE_OFFSET UNITYSDK_OFFSET(0x8FFABB0)
#define RPG_CLIENT_DECALPUZZLE_GET_ARTBOUNDFULL_OFFSET UNITYSDK_OFFSET(0x8FFAE80)
#define RPG_CLIENT_DECALPUZZLE_GET_ARTBOUND_OFFSET UNITYSDK_OFFSET(0x8FFAE00)
#define RPG_CLIENT_DECALPUZZLE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x8FFAD00)
#define RPG_CLIENT_DECALPUZZLE_RESET_OFFSET UNITYSDK_OFFSET(0x8FFA950)
#define RPG_CLIENT_DECALPUZZLE_SETACTIVE_OFFSET UNITYSDK_OFFSET(0x8FFAA90)
#define RPG_CLIENT_DECALPUZZLE_START_OFFSET UNITYSDK_OFFSET(0x8FFADA0)
#define RPG_CLIENT_DECALPUZZLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x8FFACA0)
#define RPG_CLIENT_DECALPUZZLE__CTOR_OFFSET UNITYSDK_OFFSET(0x8FFAEA0)

namespace RPG::Client
{
	inline static constexpr unsigned int DecalPuzzle_TypeDefinitionIndex = 54513;
