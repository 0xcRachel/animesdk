...
#define RPG_CLIENT_MONOEFFECTPLUGINSELECTOUTLINE_METHOD_8_D78B51BFDA4B8B32_OFFSET UNITYSDK_OFFSET(0x9807360)
#define RPG_CLIENT_MONOEFFECTPLUGINSELECTOUTLINE_METHOD_8_ED29F23CD1CAE89E_OFFSET UNITYSDK_OFFSET(0x9806FE0)
#define RPG_CLIENT_MONOEFFECTPLUGINSELECTOUTLINE_SETSTENCIL_OFFSET UNITYSDK_OFFSET(0x98071C0)
#define RPG_CLIENT_MONOEFFECTPLUGINSELECTOUTLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x98072A0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginSelectOutline_TypeDefinitionIndex = 55725;
