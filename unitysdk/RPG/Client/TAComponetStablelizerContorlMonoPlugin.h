...
#define RPG_CLIENT_TACOMPONETSTABLELIZERCONTORLMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xA019F10)
#define RPG_CLIENT_TACOMPONETSTABLELIZERCONTORLMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xA019F60)
#define RPG_CLIENT_TACOMPONETSTABLELIZERCONTORLMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xA019F80)

namespace RPG::Client
{
	inline static constexpr unsigned int TAComponetStablelizerContorlMonoPlugin_TypeDefinitionIndex = 56396;
