...
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_CHECKISCANTAKEMISSION_OFFSET UNITYSDK_OFFSET(0x9BBF5C0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_CHECKISMIDDLEMISSIONSTATE_OFFSET UNITYSDK_OFFSET(0x9BBF760)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9BBE480)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GETCURPROCESSINGMISSIONDATA_OFFSET UNITYSDK_OFFSET(0x9BBF580)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GETSTORYLINEID_OFFSET UNITYSDK_OFFSET(0x9BBF7A0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_BELONGLINE_OFFSET UNITYSDK_OFFSET(0x9BBFFB0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_COMPATIONPARTNERLIST_OFFSET UNITYSDK_OFFSET(0x9BC0340)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_CUSTOMSHOWCONDITIONLIST_OFFSET UNITYSDK_OFFSET(0x9BC0560)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_CUSTOMUNLOCKCONDITIONCONFIGLIST_OFFSET UNITYSDK_OFFSET(0x9BC0380)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0x9BBFF90)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_IMAGEPATH_OFFSET UNITYSDK_OFFSET(0x9BC0160)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_ISBASELINE_OFFSET UNITYSDK_OFFSET(0x9BC03B0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_ISBELONGNOWORLD_OFFSET UNITYSDK_OFFSET(0x9BBFFF0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_ISEARLYACCESSEFFECTED_OFFSET UNITYSDK_OFFSET(0x9BC0510)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_ISEARLYACCESS_OFFSET UNITYSDK_OFFSET(0x9BC04F0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_ISFORCEEXPAND_OFFSET UNITYSDK_OFFSET(0x9BC0530)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_ISPREDICTIONSHOWTYPE_OFFSET UNITYSDK_OFFSET(0x9BC03D0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_ISSKIPTYPE_OFFSET UNITYSDK_OFFSET(0x9BBFDC0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_MAINMISSIONDATA_OFFSET UNITYSDK_OFFSET(0x9BBF670)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_MAINMISSIONID_OFFSET UNITYSDK_OFFSET(0x9BC0090)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_MAINMISSIONTYPE_OFFSET UNITYSDK_OFFSET(0x9BC0070)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_MISSIONCONCLUSION_OFFSET UNITYSDK_OFFSET(0x9BC0320)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_MISSIONTYPECOLOR_OFFSET UNITYSDK_OFFSET(0x9BC0300)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_MISSIONTYPEICONPATH_OFFSET UNITYSDK_OFFSET(0x9BC02E0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_MULTIMISSIONIDLIST_OFFSET UNITYSDK_OFFSET(0x9BC0360)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_NODENAMEPARAM_OFFSET UNITYSDK_OFFSET(0x9BC0100)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x9BC0050)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_ORIGINMAINMISSIONID_OFFSET UNITYSDK_OFFSET(0x9BC0390)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_POSX_OFFSET UNITYSDK_OFFSET(0x9BC0010)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_POSY_OFFSET UNITYSDK_OFFSET(0x9BC0030)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_STARTMISSIONID_OFFSET UNITYSDK_OFFSET(0x9BC0120)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x9BBF660)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_STORYLINEID_OFFSET UNITYSDK_OFFSET(0x9BC0480)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_TITLE_OFFSET UNITYSDK_OFFSET(0x9BC0140)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_WORLDID_OFFSET UNITYSDK_OFFSET(0x9BBFFD0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_WORLDPATHDATA_OFFSET UNITYSDK_OFFSET(0x9BC0550)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_ISCANSTEPNEXTPATH_OFFSET UNITYSDK_OFFSET(0x9BBF500)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_ISCONNECTMISSIONFINISH_OFFSET UNITYSDK_OFFSET(0x9BBF540)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_ISCUSTOMCONDITIONSHOW_OFFSET UNITYSDK_OFFSET(0x9BBF8A0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_ISSHOWEARLYACCESSEFFECTED_OFFSET UNITYSDK_OFFSET(0x9BBF7E0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_ISWORLDUNLOCK_OFFSET UNITYSDK_OFFSET(0x9BBF860)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_REGISTERCHECKPREFSCALLBACK_OFFSET UNITYSDK_OFFSET(0x9BBE580)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SETDATA_OFFSET UNITYSDK_OFFSET(0x9BBE5D0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SETMOCKFINISHNODEDATA_OFFSET UNITYSDK_OFFSET(0x9BBF4B0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_BELONGLINE_OFFSET UNITYSDK_OFFSET(0x9BBFFC0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_COMPATIONPARTNERLIST_OFFSET UNITYSDK_OFFSET(0x9BC0350)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_CUSTOMSHOWCONDITIONLIST_OFFSET UNITYSDK_OFFSET(0x9BC0570)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0x9BBFFA0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_ISBASELINE_OFFSET UNITYSDK_OFFSET(0x9BC03C0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_ISBELONGNOWORLD_OFFSET UNITYSDK_OFFSET(0x9BC0000)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_ISEARLYACCESSEFFECTED_OFFSET UNITYSDK_OFFSET(0x9BC0520)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_ISEARLYACCESS_OFFSET UNITYSDK_OFFSET(0x9BC0500)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_ISFORCEEXPAND_OFFSET UNITYSDK_OFFSET(0x9BC0540)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_MAINMISSIONTYPE_OFFSET UNITYSDK_OFFSET(0x9BC0080)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_MISSIONCONCLUSION_OFFSET UNITYSDK_OFFSET(0x9BC0330)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_MISSIONTYPECOLOR_OFFSET UNITYSDK_OFFSET(0x9BC0310)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_MISSIONTYPEICONPATH_OFFSET UNITYSDK_OFFSET(0x9BC02F0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_MULTIMISSIONIDLIST_OFFSET UNITYSDK_OFFSET(0x9BC0370)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_NODENAMEPARAM_OFFSET UNITYSDK_OFFSET(0x9BC0110)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x9BC0060)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_ORIGINMAINMISSIONID_OFFSET UNITYSDK_OFFSET(0x9BC03A0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_POSX_OFFSET UNITYSDK_OFFSET(0x9BC0020)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_POSY_OFFSET UNITYSDK_OFFSET(0x9BC0040)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_STARTMISSIONID_OFFSET UNITYSDK_OFFSET(0x9BC0130)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_TITLE_OFFSET UNITYSDK_OFFSET(0x9BC0150)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_WORLDID_OFFSET UNITYSDK_OFFSET(0x9BBFFE0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA__CHECKISMISSIONDISABLE_OFFSET UNITYSDK_OFFSET(0x9BBF930)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA__CHECKISMISSIONIDEARLYACCESS_OFFSET UNITYSDK_OFFSET(0x9BBF9E0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA__CHECKISWORLDEARLYACCESS_OFFSET UNITYSDK_OFFSET(0x9BBFC10)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9BBE400)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA__GETCURCHRONICLESTATUS_OFFSET UNITYSDK_OFFSET(0x9BBF8F0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA__SETCOMPATIONPARTNERLIST_OFFSET UNITYSDK_OFFSET(0x9BBEE10)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA__SETCUSTOMSHOWCONDITIONCONFIGLIST_OFFSET UNITYSDK_OFFSET(0x9BBF380)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA__SETCUSTOMUNLOCKCONDITIONCONFIGLIST_OFFSET UNITYSDK_OFFSET(0x9BBF240)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA__SETMAINMISSIONID_OFFSET UNITYSDK_OFFSET(0x9BBE830)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA__SETMISSIONCONCLUSION_OFFSET UNITYSDK_OFFSET(0x9BBED70)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA__SETMISSIONTYPECOLOR_OFFSET UNITYSDK_OFFSET(0x9BBFE10)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA__SETMISSIONTYPE_OFFSET UNITYSDK_OFFSET(0x9BBEBA0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA__SETMULTIMISSIONIDLIST_OFFSET UNITYSDK_OFFSET(0x9BBEF70)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA__SETTITLE_OFFSET UNITYSDK_OFFSET(0x9BBE8E0)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Collections::Generic::List_1<::System::UInt32>* _MultiMissionIDList_k__BackingField; // 0x18
		::System::Collections::Generic::List_1<::System::UInt32>* _CompationPartnerList_k__BackingField; // 0x20
		::System::String* _BaseImagePath; // 0x28
		::System::Action* _CheckPrefsCallback; // 0x30
		::System::String* _MissionTypeColor_k__BackingField; // 0x38
		::System::String* _FemaleImagePath; // 0x40
		...
		::System::String* _MissionTypeIconPath_k__BackingField; // 0x50
		::System::UInt32 _NodeNameParam_k__BackingField; // 0x58
		...
		::RPG::GameCore::MainMissionType _MainMissionType_k__BackingField; // 0x78
		::System::Boolean _IsForceExpand_k__BackingField; // 0x7C
		::System::Boolean _IsBaseLine_k__BackingField; // 0x7D
		::System::Boolean _IsBelongNoWorld_k__BackingField; // 0x7E
		::System::Boolean _IsEarlyAccess_k__BackingField; // 0x7F
		::System::Boolean _IsEarlyAccessEffected_k__BackingField; // 0x80
		::System::UInt32 _BelongLine_k__BackingField; // 0x84
		::System::UInt32 _OriginMainMissionID_k__BackingField; // 0x88
		::System::Int32 _StoryLineID; // 0x8C
		::System::UInt32 _StartMissionID_k__BackingField; // 0x90
		::System::Int32 _PosY_k__BackingField; // 0x94
		::RPG::GameCore::ChronicleNodeType _NodeType_k__BackingField; // 0x98
