...
#define RPG_CLIENT_GRIDFIGHTGAMETRAIT___C__DISPLAYCLASS28_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1754BF50)
#define RPG_CLIENT_GRIDFIGHTGAMETRAIT___C__DISPLAYCLASS28_0___TRYGETFRONTBACKSWITCHROLE_B__0_OFFSET UNITYSDK_OFFSET(0x1754C200)
#define RPG_CLIENT_GRIDFIGHTGAMETRAIT___C__DISPLAYCLASS28_0___TRYGETFRONTBACKSWITCHROLE_B__1_OFFSET UNITYSDK_OFFSET(0x1754C230)
