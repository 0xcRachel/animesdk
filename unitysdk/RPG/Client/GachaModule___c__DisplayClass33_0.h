...
#define RPG_CLIENT_GACHAMODULE___C__DISPLAYCLASS33_0__CTOR_OFFSET UNITYSDK_OFFSET(0x160038D0)
#define RPG_CLIENT_GACHAMODULE___C__DISPLAYCLASS33_0__GETGACHAPOOLDATA_B__0_OFFSET UNITYSDK_OFFSET(0x160076C0)
