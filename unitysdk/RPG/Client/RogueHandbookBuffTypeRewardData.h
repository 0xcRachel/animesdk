...
#define RPG_CLIENT_ROGUEHANDBOOKBUFFTYPEREWARDDATA_HASREWARDCANTAKE_OFFSET UNITYSDK_OFFSET(0x9DF3B00)
#define RPG_CLIENT_ROGUEHANDBOOKBUFFTYPEREWARDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9DF3AF0)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueHandbookBuffTypeRewardData_TypeDefinitionIndex = 53538;
