...
#define RPG_CLIENT_MONO_FIVEDIMTRIGGERREGIONPLUGIN_INIT_OFFSET UNITYSDK_OFFSET(0x97785E0)
#define RPG_CLIENT_MONO_FIVEDIMTRIGGERREGIONPLUGIN_METHOD_5_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x9778830)
#define RPG_CLIENT_MONO_FIVEDIMTRIGGERREGIONPLUGIN_METHOD_5_F783C72ABA154251_OFFSET UNITYSDK_OFFSET(0x9778660)
#define RPG_CLIENT_MONO_FIVEDIMTRIGGERREGIONPLUGIN_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x97787B0)
#define RPG_CLIENT_MONO_FIVEDIMTRIGGERREGIONPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x97789C0)

namespace RPG::Client::Mono
{
	inline static constexpr unsigned int FiveDimTriggerRegionPlugin_TypeDefinitionIndex = 60098;
