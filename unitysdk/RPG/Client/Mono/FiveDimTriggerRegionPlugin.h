...
#define RPG_CLIENT_MONO_FIVEDIMTRIGGERREGIONPLUGIN_INIT_OFFSET UNITYSDK_OFFSET(0x152B9B50)
#define RPG_CLIENT_MONO_FIVEDIMTRIGGERREGIONPLUGIN_METHOD_5_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x152B9DA0)
#define RPG_CLIENT_MONO_FIVEDIMTRIGGERREGIONPLUGIN_METHOD_5_F783C72ABA154251_OFFSET UNITYSDK_OFFSET(0x152B9BD0)
#define RPG_CLIENT_MONO_FIVEDIMTRIGGERREGIONPLUGIN_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x152B9D20)
#define RPG_CLIENT_MONO_FIVEDIMTRIGGERREGIONPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x152B9EA0)

namespace RPG::Client::Mono
{
	inline static constexpr unsigned int FiveDimTriggerRegionPlugin_TypeDefinitionIndex = 69789;
