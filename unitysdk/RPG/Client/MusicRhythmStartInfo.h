...
#define RPG_CLIENT_MUSICRHYTHMSTARTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x15F2A5C0)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 TotalScore; // 0x14
		::System::UInt32 CountDown; // 0x18
		::System::Boolean IsPuMan; // 0x1C
		::System::Boolean ShowCircle; // 0x1D
		::System::Single GoodInputTime; // 0x20
		::System::Boolean LineVisible; // 0x24
		::System::Boolean HintVisible; // 0x25
		::System::Boolean IsTutorial; // 0x26
		::System::Single CircleOffset; // 0x28
		::System::Int32 BeatCount; // 0x2C
		::System::Single MusicTotalTime; // 0x30
