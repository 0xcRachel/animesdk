...
#define RPG_CLIENT_UINODECOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xA1E4900)

namespace RPG::Client
{
	inline static constexpr unsigned int UINodeCollection_TypeDefinitionIndex = 54905;
