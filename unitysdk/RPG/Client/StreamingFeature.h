...
#define RPG_CLIENT_STREAMINGFEATURE__CTOR_OFFSET UNITYSDK_OFFSET(0x9FD7490)

namespace RPG::Client
{
	inline static constexpr unsigned int StreamingFeature_TypeDefinitionIndex = 53884;
