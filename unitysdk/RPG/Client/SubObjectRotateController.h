...
#define RPG_CLIENT_SUBOBJECTROTATECONTROLLER_CLEAR_OFFSET UNITYSDK_OFFSET(0x17BFFC10)
#define RPG_CLIENT_SUBOBJECTROTATECONTROLLER_COMPARETO_OFFSET UNITYSDK_OFFSET(0x17BFFB20)
#define RPG_CLIENT_SUBOBJECTROTATECONTROLLER_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x17BFFA40)
#define RPG_CLIENT_SUBOBJECTROTATECONTROLLER_METHOD_5_0DD61B7EBFB9E6E3_OFFSET UNITYSDK_OFFSET(0x17BFFFC0)
#define RPG_CLIENT_SUBOBJECTROTATECONTROLLER_METHOD_5_F46E56E08575ED2C_OFFSET UNITYSDK_OFFSET(0x17BFFF40)
#define RPG_CLIENT_SUBOBJECTROTATECONTROLLER_PROCESS_OFFSET UNITYSDK_OFFSET(0x17BFFA50)
#define RPG_CLIENT_SUBOBJECTROTATECONTROLLER_SETSUBOBJECTROTATION_OFFSET UNITYSDK_OFFSET(0x17BFFD10)
#define RPG_CLIENT_SUBOBJECTROTATECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17C00190)
