...
#define RPG_CLIENT_MATCHTHREEPROPITEMPANEL_AWAKE_OFFSET UNITYSDK_OFFSET(0x9B58CE0)
#define RPG_CLIENT_MATCHTHREEPROPITEMPANEL_GET_ONBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x9B58CA0)
#define RPG_CLIENT_MATCHTHREEPROPITEMPANEL_GET_PROPINFO_OFFSET UNITYSDK_OFFSET(0x9B58CC0)
#define RPG_CLIENT_MATCHTHREEPROPITEMPANEL_INIT_OFFSET UNITYSDK_OFFSET(0x9B58E10)
#define RPG_CLIENT_MATCHTHREEPROPITEMPANEL_METHOD_5_9A6DA36CCAE7D188_OFFSET UNITYSDK_OFFSET(0x9B59010)
#define RPG_CLIENT_MATCHTHREEPROPITEMPANEL_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x9B58E60)
#define RPG_CLIENT_MATCHTHREEPROPITEMPANEL_SET_ONBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x9B58CB0)
#define RPG_CLIENT_MATCHTHREEPROPITEMPANEL_SET_PROPINFO_OFFSET UNITYSDK_OFFSET(0x9B58CD0)
#define RPG_CLIENT_MATCHTHREEPROPITEMPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0x9B59060)
