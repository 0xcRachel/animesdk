...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMEETINGCATEGORYINFO_GET_BASERATIO_OFFSET UNITYSDK_OFFSET(0xA60A000)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMEETINGCATEGORYINFO_GET_BASESCORE_OFFSET UNITYSDK_OFFSET(0xA609F90)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMEETINGCATEGORYINFO_GET_CATEGORYROW_OFFSET UNITYSDK_OFFSET(0xA609F30)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMEETINGCATEGORYINFO_GET_CATEGORYTYPE_OFFSET UNITYSDK_OFFSET(0xA609ED0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMEETINGCATEGORYINFO_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0xA60A020)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMEETINGCATEGORYINFO_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xA609EF0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMEETINGCATEGORYINFO_GET_RATIO_OFFSET UNITYSDK_OFFSET(0xA609FA0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMEETINGCATEGORYINFO_GET_SCOREROW_OFFSET UNITYSDK_OFFSET(0xA609F10)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMEETINGCATEGORYINFO_SET_CATEGORYTYPE_OFFSET UNITYSDK_OFFSET(0xA609EE0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMEETINGCATEGORYINFO_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0xA609F00)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMEETINGCATEGORYINFO_SET_SCOREROW_OFFSET UNITYSDK_OFFSET(0xA609F20)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMEETINGCATEGORYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xA609E70)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartyMeetingCategoryInfo_TypeDefinitionIndex = 61111;
