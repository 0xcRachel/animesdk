...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYNORMALITEM_EQUALS_OFFSET UNITYSDK_OFFSET(0x177F6F50)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYNORMALITEM_GET_ACQUIREDTIME_OFFSET UNITYSDK_OFFSET(0x177F7400)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYNORMALITEM_GET_ISACTIVITY_OFFSET UNITYSDK_OFFSET(0x177F72E0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYNORMALITEM_GET_ITEMID_OFFSET UNITYSDK_OFFSET(0x177F7350)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYNORMALITEM_GET_ITEMRARITY_OFFSET UNITYSDK_OFFSET(0x177F7370)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYNORMALITEM_GET_PREFABPATH_OFFSET UNITYSDK_OFFSET(0x177F7390)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYNORMALITEM_GET_REDDOTID_OFFSET UNITYSDK_OFFSET(0x177F72C0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYNORMALITEM_GET_REDDOTKEY_OFFSET UNITYSDK_OFFSET(0x177F72D0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYNORMALITEM_GET__REDDOTIDS_OFFSET UNITYSDK_OFFSET(0x177F7240)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYNORMALITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0x177F6E60)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYNORMALITEM_INITDATA_OFFSET UNITYSDK_OFFSET(0x177F6C10)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYNORMALITEM_SET_ACQUIREDTIME_OFFSET UNITYSDK_OFFSET(0x177F7410)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYNORMALITEM_SET_ITEMID_OFFSET UNITYSDK_OFFSET(0x177F7360)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYNORMALITEM_SET_ITEMRARITY_OFFSET UNITYSDK_OFFSET(0x177F7380)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYNORMALITEM_SYNC_OFFSET UNITYSDK_OFFSET(0x177F6EC0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYNORMALITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x177F7420)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYNORMALITEM__INITTAGFLAGS_OFFSET UNITYSDK_OFFSET(0x177F6FD0)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartyBuildDIYNormalItem_TypeDefinitionIndex = 68578;
