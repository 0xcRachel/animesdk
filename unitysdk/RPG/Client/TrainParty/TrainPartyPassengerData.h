...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_CLEARGAMEPLAYDATA_OFFSET UNITYSDK_OFFSET(0x17817A10)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x178175D0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_AVATARNAMETEXT_OFFSET UNITYSDK_OFFSET(0x1780F0A0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_CANBELEADER_OFFSET UNITYSDK_OFFSET(0x17817BD0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_CARDPREFABPATH_OFFSET UNITYSDK_OFFSET(0x178183A0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_CHALLENGETIMES_OFFSET UNITYSDK_OFFSET(0x17818410)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_ISLEADER_OFFSET UNITYSDK_OFFSET(0x17816D60)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_ISNEW_OFFSET UNITYSDK_OFFSET(0x17817BF0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_ISONTRAIN_OFFSET UNITYSDK_OFFSET(0x17817E30)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0x17817BB0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_ITEMICONPATH_OFFSET UNITYSDK_OFFSET(0x17818090)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_MEETINGCARDPREFABPATH_OFFSET UNITYSDK_OFFSET(0x17818330)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_MINIICONPATH_OFFSET UNITYSDK_OFFSET(0x178181E0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x17817E50)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_PASSENGERID_OFFSET UNITYSDK_OFFSET(0x17817B20)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_REMAINSTEPNUM_OFFSET UNITYSDK_OFFSET(0x17817B40)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_ROUNDICONBGPATH_OFFSET UNITYSDK_OFFSET(0x17818020)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_ROUNDICONPATH_OFFSET UNITYSDK_OFFSET(0x17817ED0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0x17817B50)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_STATRATIO_OFFSET UNITYSDK_OFFSET(0x17818430)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_SETISUNLOCK_OFFSET UNITYSDK_OFFSET(0x17817AD0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_SET_CANBELEADER_OFFSET UNITYSDK_OFFSET(0x17817BE0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_SET_CHALLENGETIMES_OFFSET UNITYSDK_OFFSET(0x17818420)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_SET_ISNEW_OFFSET UNITYSDK_OFFSET(0x17817D10)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_SET_ISONTRAIN_OFFSET UNITYSDK_OFFSET(0x17817E40)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_SET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0x17817BC0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_SET_PASSENGERID_OFFSET UNITYSDK_OFFSET(0x17817B30)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_SET_STATRATIO_OFFSET UNITYSDK_OFFSET(0x17818440)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_SYNCPERSISTENTINFO_OFFSET UNITYSDK_OFFSET(0x178177A0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_SYNC_OFFSET UNITYSDK_OFFSET(0x178176A0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17817570)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x178174D0)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartyPassengerData_TypeDefinitionIndex = 68612;
	...
	public:
		...
		::System::Boolean _CanBeLeader_k__BackingField; // 0x2C
		::System::Boolean _IsOnTrain_k__BackingField; // 0x2D
		::System::Boolean _IsUnlock_k__BackingField; // 0x2E
