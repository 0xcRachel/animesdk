...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_CLEARGAMEPLAYDATA_OFFSET UNITYSDK_OFFSET(0xA6118F0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xA6114B0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_AVATARNAMETEXT_OFFSET UNITYSDK_OFFSET(0xA60ECC0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_CANBELEADER_OFFSET UNITYSDK_OFFSET(0xA611AB0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_CARDPREFABPATH_OFFSET UNITYSDK_OFFSET(0xA612570)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_CHALLENGETIMES_OFFSET UNITYSDK_OFFSET(0xA6125E0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_ISLEADER_OFFSET UNITYSDK_OFFSET(0xA610C40)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_ISNEW_OFFSET UNITYSDK_OFFSET(0xA611AD0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_ISONTRAIN_OFFSET UNITYSDK_OFFSET(0xA611D10)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0xA611A90)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_ITEMICONPATH_OFFSET UNITYSDK_OFFSET(0xA6120E0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_MEETINGCARDPREFABPATH_OFFSET UNITYSDK_OFFSET(0xA612500)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_MINIICONPATH_OFFSET UNITYSDK_OFFSET(0xA6122F0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xA611D30)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_PASSENGERID_OFFSET UNITYSDK_OFFSET(0xA611A00)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_REMAINSTEPNUM_OFFSET UNITYSDK_OFFSET(0xA611A20)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_ROUNDICONBGPATH_OFFSET UNITYSDK_OFFSET(0xA612070)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_ROUNDICONPATH_OFFSET UNITYSDK_OFFSET(0xA611DB0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0xA611A30)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_GET_STATRATIO_OFFSET UNITYSDK_OFFSET(0xA612600)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_SETISUNLOCK_OFFSET UNITYSDK_OFFSET(0xA6119B0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_SET_CANBELEADER_OFFSET UNITYSDK_OFFSET(0xA611AC0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_SET_CHALLENGETIMES_OFFSET UNITYSDK_OFFSET(0xA6125F0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_SET_ISNEW_OFFSET UNITYSDK_OFFSET(0xA611BF0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_SET_ISONTRAIN_OFFSET UNITYSDK_OFFSET(0xA611D20)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_SET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0xA611AA0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_SET_PASSENGERID_OFFSET UNITYSDK_OFFSET(0xA611A10)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_SET_STATRATIO_OFFSET UNITYSDK_OFFSET(0xA612610)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_SYNCPERSISTENTINFO_OFFSET UNITYSDK_OFFSET(0xA611680)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA_SYNC_OFFSET UNITYSDK_OFFSET(0xA611580)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0xA611450)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA6113B0)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartyPassengerData_TypeDefinitionIndex = 61125;
