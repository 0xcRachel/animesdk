...
#define RPG_CLIENT_TRAINPARTY_BADGEWALL_TRAINPARTYBUILDBADGEDETAILVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x151758D0)
#define RPG_CLIENT_TRAINPARTY_BADGEWALL_TRAINPARTYBUILDBADGEDETAILVIEWMODEL_GET_DESC_OFFSET UNITYSDK_OFFSET(0x15175CC0)
#define RPG_CLIENT_TRAINPARTY_BADGEWALL_TRAINPARTYBUILDBADGEDETAILVIEWMODEL_GET_TIP_OFFSET UNITYSDK_OFFSET(0x15175CE0)
#define RPG_CLIENT_TRAINPARTY_BADGEWALL_TRAINPARTYBUILDBADGEDETAILVIEWMODEL_SET_DESC_OFFSET UNITYSDK_OFFSET(0x15175CD0)
#define RPG_CLIENT_TRAINPARTY_BADGEWALL_TRAINPARTYBUILDBADGEDETAILVIEWMODEL_SET_TIP_OFFSET UNITYSDK_OFFSET(0x15175CF0)
#define RPG_CLIENT_TRAINPARTY_BADGEWALL_TRAINPARTYBUILDBADGEDETAILVIEWMODEL_UPDATEDATA_OFFSET UNITYSDK_OFFSET(0x15175950)
#define RPG_CLIENT_TRAINPARTY_BADGEWALL_TRAINPARTYBUILDBADGEDETAILVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x15175940)

namespace RPG::Client::TrainParty::BadgeWall
{
	inline static constexpr unsigned int TrainPartyBuildBadgeDetailViewModel_TypeDefinitionIndex = 68647;
