...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSKILLANIMINFO_GET_SKILLID_OFFSET UNITYSDK_OFFSET(0xA61A3E0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSKILLANIMINFO_GET_SKILLPARAM_OFFSET UNITYSDK_OFFSET(0xA61A3C0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSKILLANIMINFO_GET_SKILLTYPE_OFFSET UNITYSDK_OFFSET(0xA61A3A0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSKILLANIMINFO_SET_SKILLID_OFFSET UNITYSDK_OFFSET(0xA61A3F0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSKILLANIMINFO_SET_SKILLPARAM_OFFSET UNITYSDK_OFFSET(0xA61A3D0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSKILLANIMINFO_SET_SKILLTYPE_OFFSET UNITYSDK_OFFSET(0xA61A3B0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSKILLANIMINFO_SYNC_OFFSET UNITYSDK_OFFSET(0xA60FC40)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSKILLANIMINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xA61A390)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartySkillAnimInfo_TypeDefinitionIndex = 61121;

	class TrainPartySkillAnimInfo : public ::System::Object
	{
	public:
		::System::UInt32 _SkillParam_k__BackingField; // 0x10
		::Enum_3_4608E37A1B3D374A_36 _SkillType_k__BackingField; // 0x14
