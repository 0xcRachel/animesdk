...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_CLONE_OFFSET UNITYSDK_OFFSET(0x1781AEE0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_CREATEDEFAULTSKILL_OFFSET UNITYSDK_OFFSET(0x1781AE50)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_CREATESKILLWITHLEVEL_OFFSET UNITYSDK_OFFSET(0x17819670)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_GETDESCTEXT_OFFSET UNITYSDK_OFFSET(0x1781AF60)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_GET_EFFECTIDARR_OFFSET UNITYSDK_OFFSET(0x178144D0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_GET_ISLEVELMAX_OFFSET UNITYSDK_OFFSET(0x1781B1E0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1781B1A0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_GET_MAXLEVEL_OFFSET UNITYSDK_OFFSET(0x1781B1C0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_GET_SKILLID_OFFSET UNITYSDK_OFFSET(0x1781B180)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_GET_SKILLROW_OFFSET UNITYSDK_OFFSET(0x17814F30)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1781B1B0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_SET_MAXLEVEL_OFFSET UNITYSDK_OFFSET(0x1781B1D0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_SET_SKILLID_OFFSET UNITYSDK_OFFSET(0x1781B190)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_SYNC_OFFSET UNITYSDK_OFFSET(0x178195A0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_UPDATESKILL_OFFSET UNITYSDK_OFFSET(0x17819610)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1781AE40)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x17819590)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartyPassengerSkillInfo_TypeDefinitionIndex = 68621;
