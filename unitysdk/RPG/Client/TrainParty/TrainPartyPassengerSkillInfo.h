...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_CLONE_OFFSET UNITYSDK_OFFSET(0xA0F13E0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_CREATEDEFAULTSKILL_OFFSET UNITYSDK_OFFSET(0xA0F1350)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_CREATESKILLWITHLEVEL_OFFSET UNITYSDK_OFFSET(0xA0EFB70)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_GETDESCTEXT_OFFSET UNITYSDK_OFFSET(0xA0F1460)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_GET_EFFECTIDARR_OFFSET UNITYSDK_OFFSET(0xA0EA610)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_GET_ISLEVELMAX_OFFSET UNITYSDK_OFFSET(0xA0F1720)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xA0F16E0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_GET_MAXLEVEL_OFFSET UNITYSDK_OFFSET(0xA0F1700)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_GET_SKILLID_OFFSET UNITYSDK_OFFSET(0xA0F16C0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_GET_SKILLROW_OFFSET UNITYSDK_OFFSET(0xA0EB1B0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0xA0F16F0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_SET_MAXLEVEL_OFFSET UNITYSDK_OFFSET(0xA0F1710)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_SET_SKILLID_OFFSET UNITYSDK_OFFSET(0xA0F16D0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_SYNC_OFFSET UNITYSDK_OFFSET(0xA0EFAA0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_UPDATESKILL_OFFSET UNITYSDK_OFFSET(0xA0EFB10)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0xA0F1340)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xA0EFA90)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartyPassengerSkillInfo_TypeDefinitionIndex = 59381;
	...
	public:
		...
		::System::Void Sync(::Class_1_120319518E6F6581_116* serverInfo)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_120319518E6F6581_116*))((::PBYTE)hIl2Cpp + RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_SYNC_OFFSET))(this, serverInfo);
		}

		::System::Void UpdateSkill(::Class_1_120319518E6F6581_116* serverInfo)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_120319518E6F6581_116*))((::PBYTE)hIl2Cpp + RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_UPDATESKILL_OFFSET))(this, serverInfo);
		}
