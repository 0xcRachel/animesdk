...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_CLONE_OFFSET UNITYSDK_OFFSET(0xA615D50)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_CREATEDEFAULTSKILL_OFFSET UNITYSDK_OFFSET(0xA615CC0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_CREATESKILLWITHLEVEL_OFFSET UNITYSDK_OFFSET(0xA6142A0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_GETDESCTEXT_OFFSET UNITYSDK_OFFSET(0xA615DD0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_GET_EFFECTIDARR_OFFSET UNITYSDK_OFFSET(0xA60E210)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_GET_ISLEVELMAX_OFFSET UNITYSDK_OFFSET(0xA616050)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xA616010)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_GET_MAXLEVEL_OFFSET UNITYSDK_OFFSET(0xA616030)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_GET_SKILLID_OFFSET UNITYSDK_OFFSET(0xA615FF0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_GET_SKILLROW_OFFSET UNITYSDK_OFFSET(0xA60EC60)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0xA616020)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_SET_MAXLEVEL_OFFSET UNITYSDK_OFFSET(0xA616040)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_SET_SKILLID_OFFSET UNITYSDK_OFFSET(0xA616000)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_SYNC_OFFSET UNITYSDK_OFFSET(0xA614010)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO_UPDATESKILL_OFFSET UNITYSDK_OFFSET(0xA614070)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0xA615CB0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xA614000)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartyPassengerSkillInfo_TypeDefinitionIndex = 61134;
