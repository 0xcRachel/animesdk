...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_CLEARGAMEPLAYDATA_OFFSET UNITYSDK_OFFSET(0x17808020)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_CLEARPAMDIARYREDDOT_OFFSET UNITYSDK_OFFSET(0x17819AC0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_CLEARSKILLSETTLEDATA_OFFSET UNITYSDK_OFFSET(0x1780C440)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17809EA0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_GETALLPASSENGERLIST_OFFSET UNITYSDK_OFFSET(0x1781A420)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_GETINVITABLEPASSENGERCOUNT_OFFSET UNITYSDK_OFFSET(0x17819C20)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_GETINVITABLEPASSENGERDATALIST_OFFSET UNITYSDK_OFFSET(0x17819850)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_GETPASSENGERDATABYID_OFFSET UNITYSDK_OFFSET(0x17808FE0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_GETPASSENGERDATALIST_OFFSET UNITYSDK_OFFSET(0x1780C0A0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_GETPASSENGERSTATUSRANKCONFIGBYEXP_OFFSET UNITYSDK_OFFSET(0x17819D40)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_GETPASSENGERSTATUSRANKCONFIGBYVALUE_OFFSET UNITYSDK_OFFSET(0x1781A330)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_GETSKILLINFOS_OFFSET UNITYSDK_OFFSET(0x17813ED0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_GET_LEADERPASSENGERDATA_OFFSET UNITYSDK_OFFSET(0x1781AA60)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_GET_LEADERPASSENGERID_OFFSET UNITYSDK_OFFSET(0x1781AA40)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_GET_LEADERWORKINGBUFFID_OFFSET UNITYSDK_OFFSET(0x1781ABB0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_GET_PLAYERPASSENGERID_OFFSET UNITYSDK_OFFSET(0x1781AB90)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_GET_REMAINSTEPNUM_OFFSET UNITYSDK_OFFSET(0x1781A9F0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_GET_SKILLSETTLEDATA_OFFSET UNITYSDK_OFFSET(0x1781AC30)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_GET_TEAMID_OFFSET UNITYSDK_OFFSET(0x1781A970)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_GET_TEAMROW_OFFSET UNITYSDK_OFFSET(0x1781A990)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_GET_WORKINGBUFFROW_OFFSET UNITYSDK_OFFSET(0x1781ABD0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_HANDLEREPLACESKILLACTION_OFFSET UNITYSDK_OFFSET(0x1780DB20)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_HASANYREWARDCANTAKE_OFFSET UNITYSDK_OFFSET(0x1781A580)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0x17809A20)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_ONREPLACESKILL_OFFSET UNITYSDK_OFFSET(0x1780B910)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_ONSHOWSETTLEFINISH_OFFSET UNITYSDK_OFFSET(0x1780C7F0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_SET_LEADERPASSENGERID_OFFSET UNITYSDK_OFFSET(0x1781AA50)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_SET_LEADERWORKINGBUFFID_OFFSET UNITYSDK_OFFSET(0x1781ABC0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_SET_PLAYERPASSENGERID_OFFSET UNITYSDK_OFFSET(0x1781ABA0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_SET_SKILLSETTLEDATA_OFFSET UNITYSDK_OFFSET(0x1781AC40)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_SET_TEAMID_OFFSET UNITYSDK_OFFSET(0x1781A980)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_SYNCDIARYINFO_OFFSET UNITYSDK_OFFSET(0x178098B0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_SYNCPERSISTENTDATA_OFFSET UNITYSDK_OFFSET(0x17809730)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_SYNCPERSISTENT_OFFSET UNITYSDK_OFFSET(0x17807A50)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_SYNCSKILLLIST_OFFSET UNITYSDK_OFFSET(0x17809860)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_SYNC_OFFSET UNITYSDK_OFFSET(0x17807F50)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_UPDATEPASSEDSTEPNUM_OFFSET UNITYSDK_OFFSET(0x178090C0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER_UPDATESKILLINFO_OFFSET UNITYSDK_OFFSET(0x178094F0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x178099B0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER__DISPLAYPASSENGERSORTFUNC_OFFSET UNITYSDK_OFFSET(0x1781A830)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER__GETONTRAINPASSENGERDATALIST_OFFSET UNITYSDK_OFFSET(0x178196F0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER__GETUNLOCKPASSENGERDATALIST_OFFSET UNITYSDK_OFFSET(0x17819960)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER__INITALLPASSENGERS_OFFSET UNITYSDK_OFFSET(0x17818800)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER__INITPASSENGERSTATUSRANKCONFIG_OFFSET UNITYSDK_OFFSET(0x17819E50)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER__INVITATIONPASSENGERSORTFUNC_OFFSET UNITYSDK_OFFSET(0x1781A8D0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER__SYNCPASSENGERLIST_OFFSET UNITYSDK_OFFSET(0x17818A50)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER__SYNCPERSISTENTDATALIST_OFFSET UNITYSDK_OFFSET(0x178190C0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERMANAGER__SYNCSKILLINFOS_OFFSET UNITYSDK_OFFSET(0x17818E40)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartyPassengerManager_TypeDefinitionIndex = 68615;
	...
	public:
		...
		::System::Collections::Generic::List_1<::RPG::Client::TrainParty::TrainPartyPassengerSkillInfo*>* _SkillList; // 0x18
		...
		::RPG::Client::TrainParty::TrainPartyPassengerDiaryInfo* DiaryInfo; // 0x30
		...
		::System::UInt32 _PassedStepNum; // 0x44
