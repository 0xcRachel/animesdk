...
#define RPG_CLIENT_TRAINPARTY_MAPPING_SLOTPOSMAPPING_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x177EF370)
#define RPG_CLIENT_TRAINPARTY_MAPPING_SLOTPOSMAPPING_GET_SLOTID_OFFSET UNITYSDK_OFFSET(0x177EF350)
#define RPG_CLIENT_TRAINPARTY_MAPPING_SLOTPOSMAPPING_METHOD_5_AECF8BEC293ED42A_OFFSET UNITYSDK_OFFSET(0x177EF2A0)
#define RPG_CLIENT_TRAINPARTY_MAPPING_SLOTPOSMAPPING_METHOD_5_C638E91FC0D3A13A_OFFSET UNITYSDK_OFFSET(0x177EF040)
#define RPG_CLIENT_TRAINPARTY_MAPPING_SLOTPOSMAPPING_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x177EEFF0)
#define RPG_CLIENT_TRAINPARTY_MAPPING_SLOTPOSMAPPING_REGISTER_OFFSET UNITYSDK_OFFSET(0x177EF190)
#define RPG_CLIENT_TRAINPARTY_MAPPING_SLOTPOSMAPPING_SET_OFFSET_OFFSET UNITYSDK_OFFSET(0x177EF390)
#define RPG_CLIENT_TRAINPARTY_MAPPING_SLOTPOSMAPPING_SET_SLOTID_OFFSET UNITYSDK_OFFSET(0x177EF360)
#define RPG_CLIENT_TRAINPARTY_MAPPING_SLOTPOSMAPPING__CTOR_OFFSET UNITYSDK_OFFSET(0x177EF3A0)

namespace RPG::Client::TrainParty::Mapping
{
	inline static constexpr unsigned int SlotPosMapping_TypeDefinitionIndex = 68645;
