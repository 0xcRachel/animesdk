...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERCHANGEINFO_ADDSTATUS_OFFSET UNITYSDK_OFFSET(0x17816E20)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERCHANGEINFO_GETCHANGESTATUSTYPEINT_OFFSET UNITYSDK_OFFSET(0x17817030)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERCHANGEINFO_GETCURSTATUSVAL_OFFSET UNITYSDK_OFFSET(0x17817320)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERCHANGEINFO_GETOLDSTATUSINFO_OFFSET UNITYSDK_OFFSET(0x17817450)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERCHANGEINFO_GETOLDSTATUSVAL_OFFSET UNITYSDK_OFFSET(0x17817270)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERCHANGEINFO_GET_ISLEADER_OFFSET UNITYSDK_OFFSET(0x178174B0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERCHANGEINFO_GET_PASSENGERID_OFFSET UNITYSDK_OFFSET(0x17817490)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERCHANGEINFO_GET_RELATEDPASSENGERDATA_OFFSET UNITYSDK_OFFSET(0x178171A0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERCHANGEINFO_HASCHANGE_OFFSET UNITYSDK_OFFSET(0x17816FE0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERCHANGEINFO_INIT_OFFSET UNITYSDK_OFFSET(0x17816A50)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERCHANGEINFO_SET_ISLEADER_OFFSET UNITYSDK_OFFSET(0x178174C0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERCHANGEINFO_SET_PASSENGERID_OFFSET UNITYSDK_OFFSET(0x178174A0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERCHANGEINFO_SUBSTATUS_OFFSET UNITYSDK_OFFSET(0x17816EF0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERCHANGEINFO_SYNCPASSENGERDATA_OFFSET UNITYSDK_OFFSET(0x17816BE0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERCHANGEINFO_SYNC_OFFSET UNITYSDK_OFFSET(0x17816AA0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERCHANGEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x17816A20)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartyPassengerChangeInfo_TypeDefinitionIndex = 68611;
