...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERCHANGEINFO_ADDSTATUS_OFFSET UNITYSDK_OFFSET(0xA610D00)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERCHANGEINFO_GETCHANGESTATUSTYPEINT_OFFSET UNITYSDK_OFFSET(0xA610F10)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERCHANGEINFO_GETCURSTATUSVAL_OFFSET UNITYSDK_OFFSET(0xA611200)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERCHANGEINFO_GETOLDSTATUSINFO_OFFSET UNITYSDK_OFFSET(0xA611330)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERCHANGEINFO_GETOLDSTATUSVAL_OFFSET UNITYSDK_OFFSET(0xA611150)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERCHANGEINFO_GET_ISLEADER_OFFSET UNITYSDK_OFFSET(0xA611390)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERCHANGEINFO_GET_PASSENGERID_OFFSET UNITYSDK_OFFSET(0xA611370)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERCHANGEINFO_GET_RELATEDPASSENGERDATA_OFFSET UNITYSDK_OFFSET(0xA611080)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERCHANGEINFO_HASCHANGE_OFFSET UNITYSDK_OFFSET(0xA610EC0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERCHANGEINFO_INIT_OFFSET UNITYSDK_OFFSET(0xA6108D0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERCHANGEINFO_SET_ISLEADER_OFFSET UNITYSDK_OFFSET(0xA6113A0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERCHANGEINFO_SET_PASSENGERID_OFFSET UNITYSDK_OFFSET(0xA611380)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERCHANGEINFO_SUBSTATUS_OFFSET UNITYSDK_OFFSET(0xA610DD0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERCHANGEINFO_SYNCPASSENGERDATA_OFFSET UNITYSDK_OFFSET(0xA610AC0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERCHANGEINFO_SYNC_OFFSET UNITYSDK_OFFSET(0xA610920)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERCHANGEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xA6108A0)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartyPassengerChangeInfo_TypeDefinitionIndex = 61124;
