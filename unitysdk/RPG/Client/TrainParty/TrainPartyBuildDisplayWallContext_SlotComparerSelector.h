...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDISPLAYWALLCONTEXT_SLOTCOMPARERSELECTOR_GETCOMPARER_OFFSET UNITYSDK_OFFSET(0x177F85E0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDISPLAYWALLCONTEXT_SLOTCOMPARERSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x177F8840)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartyBuildDisplayWallContext_SlotComparerSelector_TypeDefinitionIndex = 68560;
