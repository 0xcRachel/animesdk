...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYPHOTOITEM_EQUALS_OFFSET UNITYSDK_OFFSET(0x177EF930)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYPHOTOITEM_GETFILTERTYPEID_OFFSET UNITYSDK_OFFSET(0x177EFA50)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYPHOTOITEM_GET_ISACTIVITY_OFFSET UNITYSDK_OFFSET(0x177F76E0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYPHOTOITEM_GET_REDDOTID_OFFSET UNITYSDK_OFFSET(0x177F76D0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYPHOTOITEM_GET_SHOWICONPATH_OFFSET UNITYSDK_OFFSET(0x177F76F0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYPHOTOITEM_GET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0x177F7710)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYPHOTOITEM_INITDATA_OFFSET UNITYSDK_OFFSET(0x177EF610)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYPHOTOITEM_SET_SHOWICONPATH_OFFSET UNITYSDK_OFFSET(0x177F7700)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYPHOTOITEM_SET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0x177F7720)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYPHOTOITEM_SYNC_OFFSET UNITYSDK_OFFSET(0x177F7430)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYPHOTOITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x177EF900)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYPHOTOITEM__INITTAGFLAGS_OFFSET UNITYSDK_OFFSET(0x177F74D0)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartyBuildDIYPhotoItem_TypeDefinitionIndex = 68557;
