...
#define RPG_CLIENT_CURSORSCRIPT_START_OFFSET UNITYSDK_OFFSET(0x8FE5AD0)
#define RPG_CLIENT_CURSORSCRIPT_UPDATE_OFFSET UNITYSDK_OFFSET(0x8FE5D10)
#define RPG_CLIENT_CURSORSCRIPT__CTOR_OFFSET UNITYSDK_OFFSET(0x8FE68C0)

namespace RPG::Client
{
	inline static constexpr unsigned int CursorScript_TypeDefinitionIndex = 58376;
