...
#define RPG_CLIENT_LUAUICONTROLLER_CALLLUAFUNC_OFFSET UNITYSDK_OFFSET(0x9A871B0)
#define RPG_CLIENT_LUAUICONTROLLER_GET_LUATABLE_OFFSET UNITYSDK_OFFSET(0x9A8AAA0)
#define RPG_CLIENT_LUAUICONTROLLER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x9A8A9B0)
#define RPG_CLIENT_LUAUICONTROLLER_ISCONTROLLERVALID_OFFSET UNITYSDK_OFFSET(0x9A86E90)
#define RPG_CLIENT_LUAUICONTROLLER_LUAASYNCSHOW_OFFSET UNITYSDK_OFFSET(0x9A87060)
#define RPG_CLIENT_LUAUICONTROLLER_LUASYNCSHOW_OFFSET UNITYSDK_OFFSET(0x9A86F40)
#define RPG_CLIENT_LUAUICONTROLLER_ONENTERZOOM_OFFSET UNITYSDK_OFFSET(0x9A89C10)
#define RPG_CLIENT_LUAUICONTROLLER_ONEXITZOOM_OFFSET UNITYSDK_OFFSET(0x9A89F40)
#define RPG_CLIENT_LUAUICONTROLLER_ONGOTFOCUS_OFFSET UNITYSDK_OFFSET(0x9A88F30)
#define RPG_CLIENT_LUAUICONTROLLER_ONINCONTROLACTIONCLICK_OFFSET UNITYSDK_OFFSET(0x9A89700)
#define RPG_CLIENT_LUAUICONTROLLER_ONINCONTROLACTIONPRESS_OFFSET UNITYSDK_OFFSET(0x9A898C0)
#define RPG_CLIENT_LUAUICONTROLLER_ONINCONTROLCLICK_OFFSET UNITYSDK_OFFSET(0x9A89210)
#define RPG_CLIENT_LUAUICONTROLLER_ONINCONTROLEXIT_OFFSET UNITYSDK_OFFSET(0x9A86CF0)
#define RPG_CLIENT_LUAUICONTROLLER_ONINCONTROLINPUTSWITCH_OFFSET UNITYSDK_OFFSET(0x9A88C30)
#define RPG_CLIENT_LUAUICONTROLLER_ONINCONTROLPRESS_OFFSET UNITYSDK_OFFSET(0x9A89550)
#define RPG_CLIENT_LUAUICONTROLLER_ONINCONTRORELEASED_OFFSET UNITYSDK_OFFSET(0x9A893A0)
#define RPG_CLIENT_LUAUICONTROLLER_ONKEYBOARDCLICK_OFFSET UNITYSDK_OFFSET(0x9A89A80)
#define RPG_CLIENT_LUAUICONTROLLER_ONLEFTSTICKRELEASE_OFFSET UNITYSDK_OFFSET(0x9A8A660)
#define RPG_CLIENT_LUAUICONTROLLER_ONLOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x9A890A0)
#define RPG_CLIENT_LUAUICONTROLLER_ONLUAVIEWLOADED_OFFSET UNITYSDK_OFFSET(0x9A86EF0)
#define RPG_CLIENT_LUAUICONTROLLER_ONMOUSEWHEELROLL_OFFSET UNITYSDK_OFFSET(0x9A8A800)
#define RPG_CLIENT_LUAUICONTROLLER_ONRETURNTOTOP_OFFSET UNITYSDK_OFFSET(0x9A88DC0)
#define RPG_CLIENT_LUAUICONTROLLER_ONRIGHTSTICKRELEASE_OFFSET UNITYSDK_OFFSET(0x9A8A4C0)
#define RPG_CLIENT_LUAUICONTROLLER_TONEXTZOOM_OFFSET UNITYSDK_OFFSET(0x9A8A220)
#define RPG_CLIENT_LUAUICONTROLLER_TOPREZOOM_OFFSET UNITYSDK_OFFSET(0x9A8A370)
#define RPG_CLIENT_LUAUICONTROLLER_VIEWPREFABPATH_OFFSET UNITYSDK_OFFSET(0x9A878D0)
#define RPG_CLIENT_LUAUICONTROLLER__BEFORELOADVIEW_OFFSET UNITYSDK_OFFSET(0x9A87520)
#define RPG_CLIENT_LUAUICONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9A86C80)
#define RPG_CLIENT_LUAUICONTROLLER__CUSTOMFADEINANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0x9A87EB0)
#define RPG_CLIENT_LUAUICONTROLLER__CUSTOMFADEOUTANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0x9A88050)
#define RPG_CLIENT_LUAUICONTROLLER__DOONCHILDDIALOGCLOSE_OFFSET UNITYSDK_OFFSET(0x9A881F0)
#define RPG_CLIENT_LUAUICONTROLLER__DOONCHILDDIALOGOPEN_OFFSET UNITYSDK_OFFSET(0x9A87CA0)
#define RPG_CLIENT_LUAUICONTROLLER__ENABLEASYNCINSTANTIATE_OFFSET UNITYSDK_OFFSET(0x9A887A0)
#define RPG_CLIENT_LUAUICONTROLLER__ONAFTERVIEWLOADED_OFFSET UNITYSDK_OFFSET(0x9A87640)
#define RPG_CLIENT_LUAUICONTROLLER__ONALLRESOURCESLOADED_OFFSET UNITYSDK_OFFSET(0x9A87760)
#define RPG_CLIENT_LUAUICONTROLLER__ONENTRANCEANIMEND_OFFSET UNITYSDK_OFFSET(0x9A87B30)
#define RPG_CLIENT_LUAUICONTROLLER__ONEXITFINALSTEP_OFFSET UNITYSDK_OFFSET(0x9A88640)
#define RPG_CLIENT_LUAUICONTROLLER__ONEXITPRESTEP_OFFSET UNITYSDK_OFFSET(0x9A88520)
#define RPG_CLIENT_LUAUICONTROLLER__ONRECONNECT_OFFSET UNITYSDK_OFFSET(0x9A888F0)
#define RPG_CLIENT_LUAUICONTROLLER__ONSETVIEWACTIVE_OFFSET UNITYSDK_OFFSET(0x9A87A00)
#define RPG_CLIENT_LUAUICONTROLLER__ONSTARTEXIT_OFFSET UNITYSDK_OFFSET(0x9A88400)
#define RPG_CLIENT_LUAUICONTROLLER__ONUISCREENSIZECHANGED_OFFSET UNITYSDK_OFFSET(0x9A88A90)
#define RPG_CLIENT_LUAUICONTROLLER__ONVIEWSET_OFFSET UNITYSDK_OFFSET(0x9A87400)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_GET_NAME_OFFSET UNITYSDK_OFFSET(0x9A8B5F0)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_ONENTERZOOM_OFFSET UNITYSDK_OFFSET(0x9A8B380)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_ONEXITZOOM_OFFSET UNITYSDK_OFFSET(0x9A8B3F0)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_ONGOTFOCUS_OFFSET UNITYSDK_OFFSET(0x9A8B1E0)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_ONINCONTROLACTIONCLICK_OFFSET UNITYSDK_OFFSET(0x9A8B230)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_ONINCONTROLACTIONPRESS_OFFSET UNITYSDK_OFFSET(0x9A8B2A0)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_ONINCONTROLCLICK_OFFSET UNITYSDK_OFFSET(0x9A8B200)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_ONINCONTROLEXIT_OFFSET UNITYSDK_OFFSET(0x9A8AAC0)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_ONINCONTROLINPUTSWITCH_OFFSET UNITYSDK_OFFSET(0x9A8B1C0)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_ONINCONTROLPRESS_OFFSET UNITYSDK_OFFSET(0x9A8B220)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_ONINCONTRORELEASED_OFFSET UNITYSDK_OFFSET(0x9A8B210)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_ONKEYBOARDCLICK_OFFSET UNITYSDK_OFFSET(0x9A8B310)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_ONLEFTSTICKRELEASE_OFFSET UNITYSDK_OFFSET(0x9A8B580)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_ONLOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x9A8B1F0)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_ONMOUSEWHEELROLL_OFFSET UNITYSDK_OFFSET(0x9A8B5E0)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_ONRETURNTOTOP_OFFSET UNITYSDK_OFFSET(0x9A8B1D0)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_ONRIGHTSTICKRELEASE_OFFSET UNITYSDK_OFFSET(0x9A8B520)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_TONEXTZOOM_OFFSET UNITYSDK_OFFSET(0x9A8B460)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_TOPREZOOM_OFFSET UNITYSDK_OFFSET(0x9A8B4C0)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_VIEWPREFABPATH_OFFSET UNITYSDK_OFFSET(0x9A8AC90)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY__BEFORELOADVIEW_OFFSET UNITYSDK_OFFSET(0x9A8ABC0)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY__CUSTOMFADEINANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0x9A8AE00)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY__CUSTOMFADEOUTANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0x9A8AE70)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY__DOONCHILDDIALOGCLOSE_OFFSET UNITYSDK_OFFSET(0x9A8AEE0)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY__DOONCHILDDIALOGOPEN_OFFSET UNITYSDK_OFFSET(0x9A8AD90)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY__ENABLEASYNCINSTANTIATE_OFFSET UNITYSDK_OFFSET(0x9A8B070)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY__ONAFTERVIEWLOADED_OFFSET UNITYSDK_OFFSET(0x9A8AC20)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY__ONALLRESOURCESLOADED_OFFSET UNITYSDK_OFFSET(0x9A8AC30)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY__ONENTRANCEANIMEND_OFFSET UNITYSDK_OFFSET(0x9A8AD30)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY__ONEXITFINALSTEP_OFFSET UNITYSDK_OFFSET(0x9A8B010)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY__ONEXITPRESTEP_OFFSET UNITYSDK_OFFSET(0x9A8AFB0)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY__ONRECONNECT_OFFSET UNITYSDK_OFFSET(0x9A8B0E0)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY__ONSETVIEWACTIVE_OFFSET UNITYSDK_OFFSET(0x9A8AD20)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY__ONSTARTEXIT_OFFSET UNITYSDK_OFFSET(0x9A8AF50)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY__ONUISCREENSIZECHANGED_OFFSET UNITYSDK_OFFSET(0x9A8B140)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY__ONVIEWSET_OFFSET UNITYSDK_OFFSET(0x9A8AB30)
