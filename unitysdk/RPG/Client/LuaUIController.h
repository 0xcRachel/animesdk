...
#define RPG_CLIENT_LUAUICONTROLLER_CALLLUAFUNC_OFFSET UNITYSDK_OFFSET(0x1695D0A0)
#define RPG_CLIENT_LUAUICONTROLLER_GET_LUATABLE_OFFSET UNITYSDK_OFFSET(0x16960980)
#define RPG_CLIENT_LUAUICONTROLLER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x16960890)
#define RPG_CLIENT_LUAUICONTROLLER_ISCONTROLLERVALID_OFFSET UNITYSDK_OFFSET(0x1695CD80)
#define RPG_CLIENT_LUAUICONTROLLER_LUAASYNCSHOW_OFFSET UNITYSDK_OFFSET(0x1695CF50)
#define RPG_CLIENT_LUAUICONTROLLER_LUASYNCSHOW_OFFSET UNITYSDK_OFFSET(0x1695CE30)
#define RPG_CLIENT_LUAUICONTROLLER_ONENTERZOOM_OFFSET UNITYSDK_OFFSET(0x1695FB00)
#define RPG_CLIENT_LUAUICONTROLLER_ONEXITZOOM_OFFSET UNITYSDK_OFFSET(0x1695FE30)
#define RPG_CLIENT_LUAUICONTROLLER_ONGOTFOCUS_OFFSET UNITYSDK_OFFSET(0x1695EE20)
#define RPG_CLIENT_LUAUICONTROLLER_ONINCONTROLACTIONCLICK_OFFSET UNITYSDK_OFFSET(0x1695F5F0)
#define RPG_CLIENT_LUAUICONTROLLER_ONINCONTROLACTIONPRESS_OFFSET UNITYSDK_OFFSET(0x1695F7B0)
#define RPG_CLIENT_LUAUICONTROLLER_ONINCONTROLCLICK_OFFSET UNITYSDK_OFFSET(0x1695F100)
#define RPG_CLIENT_LUAUICONTROLLER_ONINCONTROLEXIT_OFFSET UNITYSDK_OFFSET(0x1695CBE0)
#define RPG_CLIENT_LUAUICONTROLLER_ONINCONTROLINPUTSWITCH_OFFSET UNITYSDK_OFFSET(0x1695EB20)
#define RPG_CLIENT_LUAUICONTROLLER_ONINCONTROLPRESS_OFFSET UNITYSDK_OFFSET(0x1695F440)
#define RPG_CLIENT_LUAUICONTROLLER_ONINCONTRORELEASED_OFFSET UNITYSDK_OFFSET(0x1695F290)
#define RPG_CLIENT_LUAUICONTROLLER_ONKEYBOARDCLICK_OFFSET UNITYSDK_OFFSET(0x1695F970)
#define RPG_CLIENT_LUAUICONTROLLER_ONLEFTSTICKRELEASE_OFFSET UNITYSDK_OFFSET(0x16960540)
#define RPG_CLIENT_LUAUICONTROLLER_ONLOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x1695EF90)
#define RPG_CLIENT_LUAUICONTROLLER_ONLUAVIEWLOADED_OFFSET UNITYSDK_OFFSET(0x1695CDE0)
#define RPG_CLIENT_LUAUICONTROLLER_ONMOUSEWHEELROLL_OFFSET UNITYSDK_OFFSET(0x169606E0)
#define RPG_CLIENT_LUAUICONTROLLER_ONRETURNTOTOP_OFFSET UNITYSDK_OFFSET(0x1695ECB0)
#define RPG_CLIENT_LUAUICONTROLLER_ONRIGHTSTICKRELEASE_OFFSET UNITYSDK_OFFSET(0x169603A0)
#define RPG_CLIENT_LUAUICONTROLLER_TONEXTZOOM_OFFSET UNITYSDK_OFFSET(0x16960100)
#define RPG_CLIENT_LUAUICONTROLLER_TOPREZOOM_OFFSET UNITYSDK_OFFSET(0x16960250)
#define RPG_CLIENT_LUAUICONTROLLER_VIEWPREFABPATH_OFFSET UNITYSDK_OFFSET(0x1695D7C0)
#define RPG_CLIENT_LUAUICONTROLLER__BEFORELOADVIEW_OFFSET UNITYSDK_OFFSET(0x1695D410)
#define RPG_CLIENT_LUAUICONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1695CB70)
#define RPG_CLIENT_LUAUICONTROLLER__CUSTOMFADEINANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0x1695DDA0)
#define RPG_CLIENT_LUAUICONTROLLER__CUSTOMFADEOUTANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0x1695DF40)
#define RPG_CLIENT_LUAUICONTROLLER__DOONCHILDDIALOGCLOSE_OFFSET UNITYSDK_OFFSET(0x1695E0E0)
#define RPG_CLIENT_LUAUICONTROLLER__DOONCHILDDIALOGOPEN_OFFSET UNITYSDK_OFFSET(0x1695DB90)
#define RPG_CLIENT_LUAUICONTROLLER__ENABLEASYNCINSTANTIATE_OFFSET UNITYSDK_OFFSET(0x1695E690)
#define RPG_CLIENT_LUAUICONTROLLER__ONAFTERVIEWLOADED_OFFSET UNITYSDK_OFFSET(0x1695D530)
#define RPG_CLIENT_LUAUICONTROLLER__ONALLRESOURCESLOADED_OFFSET UNITYSDK_OFFSET(0x1695D650)
#define RPG_CLIENT_LUAUICONTROLLER__ONENTRANCEANIMEND_OFFSET UNITYSDK_OFFSET(0x1695DA20)
#define RPG_CLIENT_LUAUICONTROLLER__ONEXITFINALSTEP_OFFSET UNITYSDK_OFFSET(0x1695E530)
#define RPG_CLIENT_LUAUICONTROLLER__ONEXITPRESTEP_OFFSET UNITYSDK_OFFSET(0x1695E410)
#define RPG_CLIENT_LUAUICONTROLLER__ONRECONNECT_OFFSET UNITYSDK_OFFSET(0x1695E7E0)
#define RPG_CLIENT_LUAUICONTROLLER__ONSETVIEWACTIVE_OFFSET UNITYSDK_OFFSET(0x1695D8F0)
#define RPG_CLIENT_LUAUICONTROLLER__ONSTARTEXIT_OFFSET UNITYSDK_OFFSET(0x1695E2F0)
#define RPG_CLIENT_LUAUICONTROLLER__ONUISCREENSIZECHANGED_OFFSET UNITYSDK_OFFSET(0x1695E980)
#define RPG_CLIENT_LUAUICONTROLLER__ONVIEWSET_OFFSET UNITYSDK_OFFSET(0x1695D2F0)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_GET_NAME_OFFSET UNITYSDK_OFFSET(0x169614D0)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_ONENTERZOOM_OFFSET UNITYSDK_OFFSET(0x16961260)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_ONEXITZOOM_OFFSET UNITYSDK_OFFSET(0x169612D0)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_ONGOTFOCUS_OFFSET UNITYSDK_OFFSET(0x169610C0)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_ONINCONTROLACTIONCLICK_OFFSET UNITYSDK_OFFSET(0x16961110)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_ONINCONTROLACTIONPRESS_OFFSET UNITYSDK_OFFSET(0x16961180)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_ONINCONTROLCLICK_OFFSET UNITYSDK_OFFSET(0x169610E0)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_ONINCONTROLEXIT_OFFSET UNITYSDK_OFFSET(0x169609A0)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_ONINCONTROLINPUTSWITCH_OFFSET UNITYSDK_OFFSET(0x169610A0)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_ONINCONTROLPRESS_OFFSET UNITYSDK_OFFSET(0x16961100)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_ONINCONTRORELEASED_OFFSET UNITYSDK_OFFSET(0x169610F0)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_ONKEYBOARDCLICK_OFFSET UNITYSDK_OFFSET(0x169611F0)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_ONLEFTSTICKRELEASE_OFFSET UNITYSDK_OFFSET(0x16961460)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_ONLOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x169610D0)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_ONMOUSEWHEELROLL_OFFSET UNITYSDK_OFFSET(0x169614C0)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_ONRETURNTOTOP_OFFSET UNITYSDK_OFFSET(0x169610B0)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_ONRIGHTSTICKRELEASE_OFFSET UNITYSDK_OFFSET(0x16961400)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_TONEXTZOOM_OFFSET UNITYSDK_OFFSET(0x16961340)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_TOPREZOOM_OFFSET UNITYSDK_OFFSET(0x169613A0)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY_VIEWPREFABPATH_OFFSET UNITYSDK_OFFSET(0x16960B70)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY__BEFORELOADVIEW_OFFSET UNITYSDK_OFFSET(0x16960AA0)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY__CUSTOMFADEINANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0x16960CE0)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY__CUSTOMFADEOUTANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0x16960D50)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY__DOONCHILDDIALOGCLOSE_OFFSET UNITYSDK_OFFSET(0x16960DC0)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY__DOONCHILDDIALOGOPEN_OFFSET UNITYSDK_OFFSET(0x16960C70)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY__ENABLEASYNCINSTANTIATE_OFFSET UNITYSDK_OFFSET(0x16960F50)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY__ONAFTERVIEWLOADED_OFFSET UNITYSDK_OFFSET(0x16960B00)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY__ONALLRESOURCESLOADED_OFFSET UNITYSDK_OFFSET(0x16960B10)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY__ONENTRANCEANIMEND_OFFSET UNITYSDK_OFFSET(0x16960C10)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY__ONEXITFINALSTEP_OFFSET UNITYSDK_OFFSET(0x16960EF0)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY__ONEXITPRESTEP_OFFSET UNITYSDK_OFFSET(0x16960E90)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY__ONRECONNECT_OFFSET UNITYSDK_OFFSET(0x16960FC0)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY__ONSETVIEWACTIVE_OFFSET UNITYSDK_OFFSET(0x16960C00)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY__ONSTARTEXIT_OFFSET UNITYSDK_OFFSET(0x16960E30)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY__ONUISCREENSIZECHANGED_OFFSET UNITYSDK_OFFSET(0x16961020)
#define RPG_CLIENT_LUAUICONTROLLER___IFIXBASEPROXY__ONVIEWSET_OFFSET UNITYSDK_OFFSET(0x16960A10)
