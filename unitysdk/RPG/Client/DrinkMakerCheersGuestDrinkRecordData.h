...
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_DRINKDATA_OFFSET UNITYSDK_OFFSET(0x9071FE0)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_DRINKID_OFFSET UNITYSDK_OFFSET(0x90720F0)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_DRINKNAME_OFFSET UNITYSDK_OFFSET(0x9071FC0)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_DRINKTAG_OFFSET UNITYSDK_OFFSET(0x9072090)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x9072110)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_HASOTHERGUESTMAKE_OFFSET UNITYSDK_OFFSET(0x9072250)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_HASSEENUNLOCKSTATE_OFFSET UNITYSDK_OFFSET(0x9072190)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_ISMAINSTORYDRINK_OFFSET UNITYSDK_OFFSET(0x90720D0)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0x9071E90)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_PERFORMANCEIDAFTERSUMMARY_OFFSET UNITYSDK_OFFSET(0x9072170)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_PERFORMANCEIDGIVEDRINKNAME_OFFSET UNITYSDK_OFFSET(0x9072150)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_PERFORMANCEIDLISTAFTERGIVEDRINK_OFFSET UNITYSDK_OFFSET(0x9072130)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_SET_DRINKID_OFFSET UNITYSDK_OFFSET(0x9072100)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_SET_GROUPID_OFFSET UNITYSDK_OFFSET(0x9072120)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_SET_ISMAINSTORYDRINK_OFFSET UNITYSDK_OFFSET(0x90720E0)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_SET_PERFORMANCEIDAFTERSUMMARY_OFFSET UNITYSDK_OFFSET(0x9072180)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_SET_PERFORMANCEIDGIVEDRINKNAME_OFFSET UNITYSDK_OFFSET(0x9072160)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_SET_PERFORMANCEIDLISTAFTERGIVEDRINK_OFFSET UNITYSDK_OFFSET(0x9072140)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9071FA0)

namespace RPG::Client
{
	inline static constexpr unsigned int DrinkMakerCheersGuestDrinkRecordData_TypeDefinitionIndex = 50534;
	...
	public:
		...
		::System::UInt32 _PerformanceIDGiveDrinkName_k__BackingField; // 0x24
