...
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_DRINKDATA_OFFSET UNITYSDK_OFFSET(0x9518D40)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_DRINKID_OFFSET UNITYSDK_OFFSET(0x951F570)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_DRINKNAME_OFFSET UNITYSDK_OFFSET(0x951F4F0)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_DRINKTAG_OFFSET UNITYSDK_OFFSET(0x951F510)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x951F590)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_HASOTHERGUESTMAKE_OFFSET UNITYSDK_OFFSET(0x951F6D0)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_HASSEENUNLOCKSTATE_OFFSET UNITYSDK_OFFSET(0x951F610)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_ISMAINSTORYDRINK_OFFSET UNITYSDK_OFFSET(0x951F550)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0x951F3E0)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_PERFORMANCEIDAFTERSUMMARY_OFFSET UNITYSDK_OFFSET(0x951F5F0)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_PERFORMANCEIDGIVEDRINKNAME_OFFSET UNITYSDK_OFFSET(0x951F5D0)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_PERFORMANCEIDLISTAFTERGIVEDRINK_OFFSET UNITYSDK_OFFSET(0x951F5B0)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_SET_DRINKID_OFFSET UNITYSDK_OFFSET(0x951F580)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_SET_GROUPID_OFFSET UNITYSDK_OFFSET(0x951F5A0)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_SET_ISMAINSTORYDRINK_OFFSET UNITYSDK_OFFSET(0x951F560)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_SET_PERFORMANCEIDAFTERSUMMARY_OFFSET UNITYSDK_OFFSET(0x951F600)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_SET_PERFORMANCEIDGIVEDRINKNAME_OFFSET UNITYSDK_OFFSET(0x951F5E0)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_SET_PERFORMANCEIDLISTAFTERGIVEDRINK_OFFSET UNITYSDK_OFFSET(0x951F5C0)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x951A800)
