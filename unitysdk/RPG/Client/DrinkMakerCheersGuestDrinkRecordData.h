...
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_DRINKDATA_OFFSET UNITYSDK_OFFSET(0x160BB1F0)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_DRINKID_OFFSET UNITYSDK_OFFSET(0x160C1DB0)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_DRINKNAME_OFFSET UNITYSDK_OFFSET(0x160C1D30)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_DRINKTAG_OFFSET UNITYSDK_OFFSET(0x160C1D50)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x160C1DD0)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_HASOTHERGUESTMAKE_OFFSET UNITYSDK_OFFSET(0x160C1F10)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_HASSEENUNLOCKSTATE_OFFSET UNITYSDK_OFFSET(0x160C1E50)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_ISMAINSTORYDRINK_OFFSET UNITYSDK_OFFSET(0x160C1D90)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0x160C1C20)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_PERFORMANCEIDAFTERSUMMARY_OFFSET UNITYSDK_OFFSET(0x160C1E30)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_PERFORMANCEIDGIVEDRINKNAME_OFFSET UNITYSDK_OFFSET(0x160C1E10)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_GET_PERFORMANCEIDLISTAFTERGIVEDRINK_OFFSET UNITYSDK_OFFSET(0x160C1DF0)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_SET_DRINKID_OFFSET UNITYSDK_OFFSET(0x160C1DC0)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_SET_GROUPID_OFFSET UNITYSDK_OFFSET(0x160C1DE0)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_SET_ISMAINSTORYDRINK_OFFSET UNITYSDK_OFFSET(0x160C1DA0)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_SET_PERFORMANCEIDAFTERSUMMARY_OFFSET UNITYSDK_OFFSET(0x160C1E40)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_SET_PERFORMANCEIDGIVEDRINKNAME_OFFSET UNITYSDK_OFFSET(0x160C1E20)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA_SET_PERFORMANCEIDLISTAFTERGIVEDRINK_OFFSET UNITYSDK_OFFSET(0x160C1E00)
#define RPG_CLIENT_DRINKMAKERCHEERSGUESTDRINKRECORDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x160BCCB0)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 _PerformanceIDAfterSummary_k__BackingField; // 0x28
