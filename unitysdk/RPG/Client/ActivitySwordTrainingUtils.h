...
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKACTIONCNTGREATEROREQUAL_OFFSET UNITYSDK_OFFSET(0x103D3140)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKACTIONCNTLESS_OFFSET UNITYSDK_OFFSET(0x103D3630)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKASSISTPARTNERUNLOCK_OFFSET UNITYSDK_OFFSET(0x103D49E0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0x103D25B0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKCURACTIONLEVELLESSOREQUAL_OFFSET UNITYSDK_OFFSET(0x103D3050)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKCURACTIONTYPE_OFFSET UNITYSDK_OFFSET(0x103D2F60)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKCURDAILYPHASETYPE_OFFSET UNITYSDK_OFFSET(0x103D2E50)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKCURSTORYLINE_OFFSET UNITYSDK_OFFSET(0x103D3C70)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKCURTURNGREATEROREQUAL_OFFSET UNITYSDK_OFFSET(0x103D3D60)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKCURTURN_OFFSET UNITYSDK_OFFSET(0x103D3B90)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKPARTNERASSISTTIME_OFFSET UNITYSDK_OFFSET(0x103D2D70)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKPLANACTIONCNTGREATEROREQUAL_OFFSET UNITYSDK_OFFSET(0x103D34D0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKPLANACTIONTYPEGREATEROREQUAL_OFFSET UNITYSDK_OFFSET(0x103D3E40)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKPLANACTIONTYPELESSOREQUAL_OFFSET UNITYSDK_OFFSET(0x103D37E0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKSIMPLEPERFORMANCEUNLOCK_OFFSET UNITYSDK_OFFSET(0x103D4CB0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKSIMPLIFIEDCOMICANIMUNLOCK_OFFSET UNITYSDK_OFFSET(0x103D4BC0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKSKILLENTRANCEUNLOCK_OFFSET UNITYSDK_OFFSET(0x103D4810)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKSPECIFICACTIONLASTTIMES_OFFSET UNITYSDK_OFFSET(0x103D3880)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKSTATUESGREATEROREQUAL_OFFSET UNITYSDK_OFFSET(0x103D2DE0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKTODAYACTIONCNTLESSOREQUAL_OFFSET UNITYSDK_OFFSET(0x103D3320)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKTRAVELACTIONUNLOCK_OFFSET UNITYSDK_OFFSET(0x103D4AD0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_FILLSWORDTRAININGBATTLESTATISTICDATABYLASTBATTLERESULT_OFFSET UNITYSDK_OFFSET(0x103D54D0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETACTIONCNTBEFORECURPHASE_OFFSET UNITYSDK_OFFSET(0x103D4E80)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETACTIVITYLIMITTIME_OFFSET UNITYSDK_OFFSET(0x103D5000)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETCONSTUINTVALUE_OFFSET UNITYSDK_OFFSET(0x103D4900)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETCURPHASEACTIONCNT_OFFSET UNITYSDK_OFFSET(0x103D4D40)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETEFFECTTYPE_OFFSET UNITYSDK_OFFSET(0x103D2530)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETEIDOLONREWARDQUESTIDLIST_OFFSET UNITYSDK_OFFSET(0x103D5AF0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETMAINCHARACTERID_OFFSET UNITYSDK_OFFSET(0x103D5190)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETPARTNERASSISTCOUNT_OFFSET UNITYSDK_OFFSET(0x103D3EE0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETPARTNERASSISTTARGETNUM_OFFSET UNITYSDK_OFFSET(0x103D3FD0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETSKILLPOINTITEMID_OFFSET UNITYSDK_OFFSET(0x103D5390)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETSPECIALCHARACTERID_OFFSET UNITYSDK_OFFSET(0x103D5290)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETSTATUESGREATEROREQUALTARGETNUM_OFFSET UNITYSDK_OFFSET(0x103D4310)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETSTATUESGREATEROREQUALVALUE_OFFSET UNITYSDK_OFFSET(0x103D4040)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETSTATUSTYPECOUNT_OFFSET UNITYSDK_OFFSET(0x103D5490)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETTIMELIMITREWARDID_OFFSET UNITYSDK_OFFSET(0x103D6390)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_HIDETRANSFERPAGE_OFFSET UNITYSDK_OFFSET(0x103D66D0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_ISACTIVITYOUTOFLIMITTIME_OFFSET UNITYSDK_OFFSET(0x103D50F0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_ISALLEIDOLONREWARDTAKEN_OFFSET UNITYSDK_OFFSET(0x103D5E00)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_ISANYEIDOLONREWARDCANTAKE_OFFSET UNITYSDK_OFFSET(0x103D6000)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_ISANYENDINGREWARDCANTAKE_OFFSET UNITYSDK_OFFSET(0x103D6200)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_ISEIDOLONREWARDCANTAKE_OFFSET UNITYSDK_OFFSET(0x103D58F0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_ISMARCHSEVENCLICKED_OFFSET UNITYSDK_OFFSET(0x103D6A90)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_ISTUTORIALSKILLCANLEARN_OFFSET UNITYSDK_OFFSET(0x103D6400)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_ONENTERGAME_OFFSET UNITYSDK_OFFSET(0x103D03A0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_SHOWTRANSFERPAGEWITHTIME_OFFSET UNITYSDK_OFFSET(0x103D0490)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_STARTBGM_OFFSET UNITYSDK_OFFSET(0x103D0570)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_STARTSHOWTRAININGPAGEPROCESS_OFFSET UNITYSDK_OFFSET(0x103D6520)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_STOPBGM_OFFSET UNITYSDK_OFFSET(0x103D2320)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_TELEPORTTOACTIVITYENTRANCE_OFFSET UNITYSDK_OFFSET(0x103D6770)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x103D73A0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS__CHECKACTIONFLAG_OFFSET UNITYSDK_OFFSET(0x103D4FB0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS__CHECKSINGLECONDITION_OFFSET UNITYSDK_OFFSET(0x103D27F0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS__GETACTIONCNT_OFFSET UNITYSDK_OFFSET(0x103D43D0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS__GETPLANACTIONTYPECNT_OFFSET UNITYSDK_OFFSET(0x103D45B0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS__UNIONACTIONFLAG_OFFSET UNITYSDK_OFFSET(0x103D4380)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::RaycastHit>**)Il2CppClass::FromTypeDefinitionIndex(ActivitySwordTrainingUtils_TypeDefinitionIndex)->GetStaticField(0x52A00);
		}
		static ::System::Collections::Generic::List_1<::System::UInt32>** StaticGet__EidolonRewardQuestDataIDList()
		{
			return (::System::Collections::Generic::List_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(ActivitySwordTrainingUtils_TypeDefinitionIndex)->GetStaticField(0x52A08);
		}
