...
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKACTIONCNTGREATEROREQUAL_OFFSET UNITYSDK_OFFSET(0x8BCCF00)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKACTIONCNTLESS_OFFSET UNITYSDK_OFFSET(0x8BCD620)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKASSISTPARTNERUNLOCK_OFFSET UNITYSDK_OFFSET(0x8BCE300)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0x8BCBF00)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKCURACTIONLEVELLESSOREQUAL_OFFSET UNITYSDK_OFFSET(0x8BCC9B0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKCURACTIONTYPE_OFFSET UNITYSDK_OFFSET(0x8BCC8B0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKCURDAILYPHASETYPE_OFFSET UNITYSDK_OFFSET(0x8BCC7A0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKCURSTORYLINE_OFFSET UNITYSDK_OFFSET(0x8BCDEC0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKCURTURNGREATEROREQUAL_OFFSET UNITYSDK_OFFSET(0x8BCDFB0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKCURTURN_OFFSET UNITYSDK_OFFSET(0x8BCDDE0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKPARTNERASSISTTIME_OFFSET UNITYSDK_OFFSET(0x8BCC6C0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKPLANACTIONCNTGREATEROREQUAL_OFFSET UNITYSDK_OFFSET(0x8BCD4C0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKPLANACTIONTYPEGREATEROREQUAL_OFFSET UNITYSDK_OFFSET(0x8BCE090)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKPLANACTIONTYPELESSOREQUAL_OFFSET UNITYSDK_OFFSET(0x8BCD7D0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKSIMPLEPERFORMANCEUNLOCK_OFFSET UNITYSDK_OFFSET(0x8BCE5D0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKSIMPLIFIEDCOMICANIMUNLOCK_OFFSET UNITYSDK_OFFSET(0x8BCE4E0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKSKILLENTRANCEUNLOCK_OFFSET UNITYSDK_OFFSET(0x8BCE130)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKSPECIFICACTIONLASTTIMES_OFFSET UNITYSDK_OFFSET(0x8BCDAD0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKSTATUESGREATEROREQUAL_OFFSET UNITYSDK_OFFSET(0x8BCC730)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKTODAYACTIONCNTLESSOREQUAL_OFFSET UNITYSDK_OFFSET(0x8BCD310)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKTRAVELACTIONUNLOCK_OFFSET UNITYSDK_OFFSET(0x8BCE3F0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_FILLSWORDTRAININGBATTLESTATISTICDATABYLASTBATTLERESULT_OFFSET UNITYSDK_OFFSET(0x8BCF130)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETACTIONCNTBEFORECURPHASE_OFFSET UNITYSDK_OFFSET(0x8BCEAE0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETACTIVITYLIMITTIME_OFFSET UNITYSDK_OFFSET(0x8BCEC60)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETCONSTUINTVALUE_OFFSET UNITYSDK_OFFSET(0x8BCE220)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETCURPHASEACTIONCNT_OFFSET UNITYSDK_OFFSET(0x8BCE9A0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETEFFECTTYPE_OFFSET UNITYSDK_OFFSET(0x8BCBE80)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETEIDOLONREWARDQUESTIDLIST_OFFSET UNITYSDK_OFFSET(0x8BCF670)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETMAINCHARACTERID_OFFSET UNITYSDK_OFFSET(0x8BCEDF0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETPARTNERASSISTCOUNT_OFFSET UNITYSDK_OFFSET(0x8BCCAB0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETPARTNERASSISTTARGETNUM_OFFSET UNITYSDK_OFFSET(0x8BCCB90)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETSKILLPOINTITEMID_OFFSET UNITYSDK_OFFSET(0x8BCEFF0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETSPECIALCHARACTERID_OFFSET UNITYSDK_OFFSET(0x8BCEEF0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETSTATUESGREATEROREQUALTARGETNUM_OFFSET UNITYSDK_OFFSET(0x8BCE930)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETSTATUESGREATEROREQUALVALUE_OFFSET UNITYSDK_OFFSET(0x8BCE660)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETSTATUSTYPECOUNT_OFFSET UNITYSDK_OFFSET(0x8BCF0F0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETTIMELIMITREWARDID_OFFSET UNITYSDK_OFFSET(0x8BCFF10)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_HIDETRANSFERPAGE_OFFSET UNITYSDK_OFFSET(0x8BD0250)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_ISACTIVITYOUTOFLIMITTIME_OFFSET UNITYSDK_OFFSET(0x8BCED50)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_ISALLEIDOLONREWARDTAKEN_OFFSET UNITYSDK_OFFSET(0x8BCF980)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_ISANYEIDOLONREWARDCANTAKE_OFFSET UNITYSDK_OFFSET(0x8BCFB80)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_ISANYENDINGREWARDCANTAKE_OFFSET UNITYSDK_OFFSET(0x8BCFD80)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_ISEIDOLONREWARDCANTAKE_OFFSET UNITYSDK_OFFSET(0x8BCF470)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_ISMARCHSEVENCLICKED_OFFSET UNITYSDK_OFFSET(0x8BD0700)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_ISTUTORIALSKILLCANLEARN_OFFSET UNITYSDK_OFFSET(0x8BCFF80)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_ONENTERGAME_OFFSET UNITYSDK_OFFSET(0x8BD0BE0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_SHOWTRANSFERPAGEWITHTIME_OFFSET UNITYSDK_OFFSET(0x8BD02F0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_STARTBGM_OFFSET UNITYSDK_OFFSET(0x8BD0CD0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_STARTSHOWTRAININGPAGEPROCESS_OFFSET UNITYSDK_OFFSET(0x8BD00A0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_STOPBGM_OFFSET UNITYSDK_OFFSET(0x8BD10E0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_TELEPORTTOACTIVITYENTRANCE_OFFSET UNITYSDK_OFFSET(0x8BD03D0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x8BD1540)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS__CHECKACTIONFLAG_OFFSET UNITYSDK_OFFSET(0x8BCEC10)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS__CHECKSINGLECONDITION_OFFSET UNITYSDK_OFFSET(0x8BCC140)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS__GETACTIONCNT_OFFSET UNITYSDK_OFFSET(0x8BCD130)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS__GETPLANACTIONTYPECNT_OFFSET UNITYSDK_OFFSET(0x8BCD870)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS__UNIONACTIONFLAG_OFFSET UNITYSDK_OFFSET(0x8BCD0E0)

namespace RPG::Client
{
	inline static constexpr unsigned int ActivitySwordTrainingUtils_TypeDefinitionIndex = 49129;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::RaycastHit>**)Il2CppClass::FromTypeDefinitionIndex(ActivitySwordTrainingUtils_TypeDefinitionIndex)->GetStaticField(0x264D0);
		}
		static ::System::Collections::Generic::List_1<::System::UInt32>** StaticGet__EidolonRewardQuestDataIDList()
		{
			return (::System::Collections::Generic::List_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(ActivitySwordTrainingUtils_TypeDefinitionIndex)->GetStaticField(0x264D8);
		}
