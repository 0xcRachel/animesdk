...
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKACTIONCNTGREATEROREQUAL_OFFSET UNITYSDK_OFFSET(0x8FCDCA0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKACTIONCNTLESS_OFFSET UNITYSDK_OFFSET(0x8FCE190)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKASSISTPARTNERUNLOCK_OFFSET UNITYSDK_OFFSET(0x8FCF530)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0x8FCD110)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKCURACTIONLEVELLESSOREQUAL_OFFSET UNITYSDK_OFFSET(0x8FCDBB0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKCURACTIONTYPE_OFFSET UNITYSDK_OFFSET(0x8FCDAC0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKCURDAILYPHASETYPE_OFFSET UNITYSDK_OFFSET(0x8FCD9B0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKCURSTORYLINE_OFFSET UNITYSDK_OFFSET(0x8FCE7D0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKCURTURNGREATEROREQUAL_OFFSET UNITYSDK_OFFSET(0x8FCE8C0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKCURTURN_OFFSET UNITYSDK_OFFSET(0x8FCE6F0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKPARTNERASSISTTIME_OFFSET UNITYSDK_OFFSET(0x8FCD8D0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKPLANACTIONCNTGREATEROREQUAL_OFFSET UNITYSDK_OFFSET(0x8FCE030)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKPLANACTIONTYPEGREATEROREQUAL_OFFSET UNITYSDK_OFFSET(0x8FCE9A0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKPLANACTIONTYPELESSOREQUAL_OFFSET UNITYSDK_OFFSET(0x8FCE340)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKSIMPLEPERFORMANCEUNLOCK_OFFSET UNITYSDK_OFFSET(0x8FCF800)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKSIMPLIFIEDCOMICANIMUNLOCK_OFFSET UNITYSDK_OFFSET(0x8FCF710)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKSKILLENTRANCEUNLOCK_OFFSET UNITYSDK_OFFSET(0x8FCF360)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKSPECIFICACTIONLASTTIMES_OFFSET UNITYSDK_OFFSET(0x8FCE3E0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKSTATUESGREATEROREQUAL_OFFSET UNITYSDK_OFFSET(0x8FCD940)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKTODAYACTIONCNTLESSOREQUAL_OFFSET UNITYSDK_OFFSET(0x8FCDE80)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_CHECKTRAVELACTIONUNLOCK_OFFSET UNITYSDK_OFFSET(0x8FCF620)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_FILLSWORDTRAININGBATTLESTATISTICDATABYLASTBATTLERESULT_OFFSET UNITYSDK_OFFSET(0x8FD0020)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETACTIONCNTBEFORECURPHASE_OFFSET UNITYSDK_OFFSET(0x8FCF9D0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETACTIVITYLIMITTIME_OFFSET UNITYSDK_OFFSET(0x8FCFB50)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETCONSTUINTVALUE_OFFSET UNITYSDK_OFFSET(0x8FCF450)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETCURPHASEACTIONCNT_OFFSET UNITYSDK_OFFSET(0x8FCF890)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETEFFECTTYPE_OFFSET UNITYSDK_OFFSET(0x8FCD090)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETEIDOLONREWARDQUESTIDLIST_OFFSET UNITYSDK_OFFSET(0x8FD0640)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETMAINCHARACTERID_OFFSET UNITYSDK_OFFSET(0x8FCFCE0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETPARTNERASSISTCOUNT_OFFSET UNITYSDK_OFFSET(0x8FCEA40)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETPARTNERASSISTTARGETNUM_OFFSET UNITYSDK_OFFSET(0x8FCEB20)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETSKILLPOINTITEMID_OFFSET UNITYSDK_OFFSET(0x8FCFEE0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETSPECIALCHARACTERID_OFFSET UNITYSDK_OFFSET(0x8FCFDE0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETSTATUESGREATEROREQUALTARGETNUM_OFFSET UNITYSDK_OFFSET(0x8FCEE60)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETSTATUESGREATEROREQUALVALUE_OFFSET UNITYSDK_OFFSET(0x8FCEB90)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETSTATUSTYPECOUNT_OFFSET UNITYSDK_OFFSET(0x8FCFFE0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_GETTIMELIMITREWARDID_OFFSET UNITYSDK_OFFSET(0x8FD0EE0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_HIDETRANSFERPAGE_OFFSET UNITYSDK_OFFSET(0x8FD1220)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_ISACTIVITYOUTOFLIMITTIME_OFFSET UNITYSDK_OFFSET(0x8FCFC40)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_ISALLEIDOLONREWARDTAKEN_OFFSET UNITYSDK_OFFSET(0x8FD0950)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_ISANYEIDOLONREWARDCANTAKE_OFFSET UNITYSDK_OFFSET(0x8FD0B50)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_ISANYENDINGREWARDCANTAKE_OFFSET UNITYSDK_OFFSET(0x8FD0D50)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_ISEIDOLONREWARDCANTAKE_OFFSET UNITYSDK_OFFSET(0x8FD0440)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_ISMARCHSEVENCLICKED_OFFSET UNITYSDK_OFFSET(0x8FD1570)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_ISTUTORIALSKILLCANLEARN_OFFSET UNITYSDK_OFFSET(0x8FD0F50)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_ONENTERGAME_OFFSET UNITYSDK_OFFSET(0x8FCAF00)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_SHOWTRANSFERPAGEWITHTIME_OFFSET UNITYSDK_OFFSET(0x8FCAFF0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_STARTBGM_OFFSET UNITYSDK_OFFSET(0x8FCB0D0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_STARTSHOWTRAININGPAGEPROCESS_OFFSET UNITYSDK_OFFSET(0x8FD1070)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_STOPBGM_OFFSET UNITYSDK_OFFSET(0x8FCCE80)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS_TELEPORTTOACTIVITYENTRANCE_OFFSET UNITYSDK_OFFSET(0x8FD12C0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x8FD1A50)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS__CHECKACTIONFLAG_OFFSET UNITYSDK_OFFSET(0x8FCFB00)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS__CHECKSINGLECONDITION_OFFSET UNITYSDK_OFFSET(0x8FCD350)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS__GETACTIONCNT_OFFSET UNITYSDK_OFFSET(0x8FCEF20)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS__GETPLANACTIONTYPECNT_OFFSET UNITYSDK_OFFSET(0x8FCF100)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGUTILS__UNIONACTIONFLAG_OFFSET UNITYSDK_OFFSET(0x8FCEED0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::RaycastHit>**)Il2CppClass::FromTypeDefinitionIndex(ActivitySwordTrainingUtils_TypeDefinitionIndex)->GetStaticField(0x37CA0);
		}
		static ::System::Collections::Generic::List_1<::System::UInt32>** StaticGet__EidolonRewardQuestDataIDList()
		{
			return (::System::Collections::Generic::List_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(ActivitySwordTrainingUtils_TypeDefinitionIndex)->GetStaticField(0x37CA8);
		}
