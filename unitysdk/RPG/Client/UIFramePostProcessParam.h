...
#define RPG_CLIENT_UIFRAMEPOSTPROCESSPARAM_CLONE_OFFSET UNITYSDK_OFFSET(0xA1B8850)
#define RPG_CLIENT_UIFRAMEPOSTPROCESSPARAM_CREATEBLURPOSTPROCESSPARAM_OFFSET UNITYSDK_OFFSET(0xA1B87C0)
#define RPG_CLIENT_UIFRAMEPOSTPROCESSPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xA1B8840)

namespace RPG::Client
{
	inline static constexpr unsigned int UIFramePostProcessParam_TypeDefinitionIndex = 58231;
