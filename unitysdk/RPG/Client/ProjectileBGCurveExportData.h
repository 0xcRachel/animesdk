...
#define RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA_METHOD_1_210CB3660FB375EC_OFFSET UNITYSDK_OFFSET(0x9B35590)
#define RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA_METHOD_1_7ABAA176B11E9110_OFFSET UNITYSDK_OFFSET(0x9B35130)
#define RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA_METHOD_1_B07554F28042D3EB_OFFSET UNITYSDK_OFFSET(0x9B351B0)
#define RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA_METHOD_1_F98CED9BA5F7F9AC_OFFSET UNITYSDK_OFFSET(0x9B35290)
#define RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9B35990)

namespace RPG::Client
{
	inline static constexpr unsigned int ProjectileBGCurveExportData_TypeDefinitionIndex = 55836;
	...
	public:
		...
		{
			return ((::System::Single(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA_METHOD_1_F98CED9BA5F7F9AC_OFFSET))(this);
		}

		::UnityEngine::Vector3 Method_1_B07554F28042D3EB(::System::Single a1)
		{
			return ((::UnityEngine::Vector3(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA_METHOD_1_B07554F28042D3EB_OFFSET))(this, a1);
		}
