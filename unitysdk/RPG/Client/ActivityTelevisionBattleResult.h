...
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_CLONE_OFFSET UNITYSDK_OFFSET(0x8FD2D50)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_CREATE_OFFSET UNITYSDK_OFFSET(0x8FD2C90)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8FD2DC0)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_GET_BASESCORE_OFFSET UNITYSDK_OFFSET(0x8FD2E60)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_GET_BUFFLAYER_OFFSET UNITYSDK_OFFSET(0x8FD2ED0)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_GET_EXTRASCORE_OFFSET UNITYSDK_OFFSET(0x8FD2E40)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_GET_ISNEWSCORERECORD_OFFSET UNITYSDK_OFFSET(0x8FD2EF0)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_GET_LEFTROUNDCNT_OFFSET UNITYSDK_OFFSET(0x8FD2EB0)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_GET_MAXSCORE_OFFSET UNITYSDK_OFFSET(0x8FD2E00)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_GET_TOTALSCORE_OFFSET UNITYSDK_OFFSET(0x8FD2E20)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_SET_BUFFLAYER_OFFSET UNITYSDK_OFFSET(0x8FD2EE0)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_SET_EXTRASCORE_OFFSET UNITYSDK_OFFSET(0x8FD2E50)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_SET_ISNEWSCORERECORD_OFFSET UNITYSDK_OFFSET(0x8FD2F00)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_SET_LEFTROUNDCNT_OFFSET UNITYSDK_OFFSET(0x8FD2EC0)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_SET_MAXSCORE_OFFSET UNITYSDK_OFFSET(0x8FD2E10)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_SET_TOTALSCORE_OFFSET UNITYSDK_OFFSET(0x8FD2E30)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x8FD2D40)
