...
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_CLONE_OFFSET UNITYSDK_OFFSET(0x103D8960)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_CREATE_OFFSET UNITYSDK_OFFSET(0x103D88A0)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x103D89D0)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_GET_BASESCORE_OFFSET UNITYSDK_OFFSET(0x103D8A70)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_GET_BUFFLAYER_OFFSET UNITYSDK_OFFSET(0x103D8AE0)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_GET_EXTRASCORE_OFFSET UNITYSDK_OFFSET(0x103D8A50)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_GET_ISNEWSCORERECORD_OFFSET UNITYSDK_OFFSET(0x103D8B00)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_GET_LEFTROUNDCNT_OFFSET UNITYSDK_OFFSET(0x103D8AC0)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_GET_MAXSCORE_OFFSET UNITYSDK_OFFSET(0x103D8A10)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_GET_TOTALSCORE_OFFSET UNITYSDK_OFFSET(0x103D8A30)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_SET_BUFFLAYER_OFFSET UNITYSDK_OFFSET(0x103D8AF0)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_SET_EXTRASCORE_OFFSET UNITYSDK_OFFSET(0x103D8A60)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_SET_ISNEWSCORERECORD_OFFSET UNITYSDK_OFFSET(0x103D8B10)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_SET_LEFTROUNDCNT_OFFSET UNITYSDK_OFFSET(0x103D8AD0)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_SET_MAXSCORE_OFFSET UNITYSDK_OFFSET(0x103D8A20)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_SET_TOTALSCORE_OFFSET UNITYSDK_OFFSET(0x103D8A40)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x103D8950)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 _TotalScore_k__BackingField; // 0x14
		...
		::System::UInt32 _BuffLayer_k__BackingField; // 0x24
