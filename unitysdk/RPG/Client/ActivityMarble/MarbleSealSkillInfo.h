...
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALSKILLINFO_GETDESCCONTENT_OFFSET UNITYSDK_OFFSET(0x8B788E0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALSKILLINFO_GET_DESCPARAMS_OFFSET UNITYSDK_OFFSET(0x8B78AD0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALSKILLINFO_GET_DESC_OFFSET UNITYSDK_OFFSET(0x8B78A50)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALSKILLINFO_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x8B78BC0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALSKILLINFO_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x8B78C30)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALSKILLINFO_GET_ID_OFFSET UNITYSDK_OFFSET(0x8B78B40)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALSKILLINFO_GET_NAME_OFFSET UNITYSDK_OFFSET(0x8B78CA0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALSKILLINFO_GET_ROW_OFFSET UNITYSDK_OFFSET(0x8B78B60)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALSKILLINFO_GET_UPDESCCONTENT_OFFSET UNITYSDK_OFFSET(0x8B78D20)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALSKILLINFO_SETUPDESCCONTENT_OFFSET UNITYSDK_OFFSET(0x8B75AE0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALSKILLINFO_SET_ID_OFFSET UNITYSDK_OFFSET(0x8B78B50)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALSKILLINFO_SET_UPDESCCONTENT_OFFSET UNITYSDK_OFFSET(0x8B78D30)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALSKILLINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x8B75AC0)

namespace RPG::Client::ActivityMarble
{
	inline static constexpr unsigned int MarbleSealSkillInfo_TypeDefinitionIndex = 59671;
