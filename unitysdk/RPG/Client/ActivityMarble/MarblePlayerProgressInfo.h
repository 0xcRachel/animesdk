...
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_CREATEMATCHCONTEXT_OFFSET UNITYSDK_OFFSET(0x8F75F30)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_FETCHDEPENDANTSUBMISSIONIDS_OFFSET UNITYSDK_OFFSET(0x8F75730)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_GETCURMAINMISSIONDATA_OFFSET UNITYSDK_OFFSET(0x8F76390)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_GET_CANSTART_OFFSET UNITYSDK_OFFSET(0x8F76950)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_GET_CURRENTSTAGETYPE_OFFSET UNITYSDK_OFFSET(0x8F76820)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_GET_CURRENTSTAGE_OFFSET UNITYSDK_OFFSET(0x8F76800)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_GET_ENEMYPLAYER_OFFSET UNITYSDK_OFFSET(0x8F760D0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x8F76930)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_GET_PROGRESSID_OFFSET UNITYSDK_OFFSET(0x8F753B0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_INIT_OFFSET UNITYSDK_OFFSET(0x8F74E80)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_ISFINALMATCHOFSTAGE_OFFSET UNITYSDK_OFFSET(0x8F761E0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_ISPVPUNLOCKMISSIONFINISH_OFFSET UNITYSDK_OFFSET(0x8F6FC00)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_OPENSETTLEMENTRANKVIEW_OFFSET UNITYSDK_OFFSET(0x8F75BA0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_OPENSTAGEINFOVIEW_OFFSET UNITYSDK_OFFSET(0x8F758A0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_SET_CURRENTSTAGE_OFFSET UNITYSDK_OFFSET(0x8F76810)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_SET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x8F76940)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_STARTPVEMATCH_OFFSET UNITYSDK_OFFSET(0x8F75CB0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_UPDATEPROGRESS_OFFSET UNITYSDK_OFFSET(0x8F74F50)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO__CREATESTAGEDATA_OFFSET UNITYSDK_OFFSET(0x8F766A0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x8F76A00)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO__GETCURRENTPROGRESSID_OFFSET UNITYSDK_OFFSET(0x8F75030)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO__UPDATESTAGE_OFFSET UNITYSDK_OFFSET(0x8F75400)

namespace RPG::Client::ActivityMarble
{
	inline static constexpr unsigned int MarblePlayerProgressInfo_TypeDefinitionIndex = 61445;
