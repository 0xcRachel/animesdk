...
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_CREATEMATCHCONTEXT_OFFSET UNITYSDK_OFFSET(0x8B74860)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_FETCHDEPENDANTSUBMISSIONIDS_OFFSET UNITYSDK_OFFSET(0x8B74060)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_GETCURMAINMISSIONDATA_OFFSET UNITYSDK_OFFSET(0x8B74C60)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_GET_CANSTART_OFFSET UNITYSDK_OFFSET(0x8B75220)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_GET_CURRENTSTAGETYPE_OFFSET UNITYSDK_OFFSET(0x8B750F0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_GET_CURRENTSTAGE_OFFSET UNITYSDK_OFFSET(0x8B750D0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_GET_ENEMYPLAYER_OFFSET UNITYSDK_OFFSET(0x8B74A00)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x8B75200)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_GET_PROGRESSID_OFFSET UNITYSDK_OFFSET(0x8B73CE0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_INIT_OFFSET UNITYSDK_OFFSET(0x8B737B0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_ISFINALMATCHOFSTAGE_OFFSET UNITYSDK_OFFSET(0x8B74AB0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_ISPVPUNLOCKMISSIONFINISH_OFFSET UNITYSDK_OFFSET(0x8B6E830)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_OPENSETTLEMENTRANKVIEW_OFFSET UNITYSDK_OFFSET(0x8B744D0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_OPENSTAGEINFOVIEW_OFFSET UNITYSDK_OFFSET(0x8B741D0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_SET_CURRENTSTAGE_OFFSET UNITYSDK_OFFSET(0x8B750E0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_SET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x8B75210)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_STARTPVEMATCH_OFFSET UNITYSDK_OFFSET(0x8B745E0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO_UPDATEPROGRESS_OFFSET UNITYSDK_OFFSET(0x8B73880)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO__CREATESTAGEDATA_OFFSET UNITYSDK_OFFSET(0x8B74F70)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x8B752D0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO__GETCURRENTPROGRESSID_OFFSET UNITYSDK_OFFSET(0x8B73960)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO__UPDATESTAGE_OFFSET UNITYSDK_OFFSET(0x8B73D30)

namespace RPG::Client::ActivityMarble
{
	inline static constexpr unsigned int MarblePlayerProgressInfo_TypeDefinitionIndex = 59689;
