...
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8F69860)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR_GETMARBLESEALROOT_OFFSET UNITYSDK_OFFSET(0x8F6A0F0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR_GET_MARBLESUBSEALID_OFFSET UNITYSDK_OFFSET(0x8F6A6B0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR_LOADMARBLESEAL_OFFSET UNITYSDK_OFFSET(0x8F6A590)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR_LOADMARBLESUBSEAL_OFFSET UNITYSDK_OFFSET(0x8F6A7C0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR_RELEASEMARBLESEAL_OFFSET UNITYSDK_OFFSET(0x8F6A460)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR_RELEASEMARBLESUBSEAL_OFFSET UNITYSDK_OFFSET(0x8F6A6D0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR_SETSCALE_OFFSET UNITYSDK_OFFSET(0x8F6A2D0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR__BINDSUBSEALROTATOR_OFFSET UNITYSDK_OFFSET(0x8F6AF40)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR__CTOR_OFFSET UNITYSDK_OFFSET(0x8F6A280)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR__GETMARBLESEALENTITY_OFFSET UNITYSDK_OFFSET(0x8F6A890)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR__ONMODELLOADED_OFFSET UNITYSDK_OFFSET(0x8F6A950)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR__ONSWIMRINGLOADED_OFFSET UNITYSDK_OFFSET(0x8F6B110)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR__TRIGGERANIM_OFFSET UNITYSDK_OFFSET(0x8F6AE30)

namespace RPG::Client::ActivityMarble
{
	inline static constexpr unsigned int MarbleMatchController_MarbleSealAnchor_TypeDefinitionIndex = 61421;
	...
	public:
		...
		::RPG::GameCore::GameEntity* _MarbleSealEntity; // 0x28
