...
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1700EBC0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR_GETMARBLESEALROOT_OFFSET UNITYSDK_OFFSET(0x1700F450)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR_GET_MARBLESUBSEALID_OFFSET UNITYSDK_OFFSET(0x1700FA10)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR_LOADMARBLESEAL_OFFSET UNITYSDK_OFFSET(0x1700F8F0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR_LOADMARBLESUBSEAL_OFFSET UNITYSDK_OFFSET(0x1700FB20)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR_RELEASEMARBLESEAL_OFFSET UNITYSDK_OFFSET(0x1700F7C0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR_RELEASEMARBLESUBSEAL_OFFSET UNITYSDK_OFFSET(0x1700FA30)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR_SETSCALE_OFFSET UNITYSDK_OFFSET(0x1700F630)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR__BINDSUBSEALROTATOR_OFFSET UNITYSDK_OFFSET(0x170102A0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1700F5E0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR__GETMARBLESEALENTITY_OFFSET UNITYSDK_OFFSET(0x1700FBF0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR__ONMODELLOADED_OFFSET UNITYSDK_OFFSET(0x1700FCB0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR__ONSWIMRINGLOADED_OFFSET UNITYSDK_OFFSET(0x17010470)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR__TRIGGERANIM_OFFSET UNITYSDK_OFFSET(0x17010190)

namespace RPG::Client::ActivityMarble
{
	inline static constexpr unsigned int MarbleMatchController_MarbleSealAnchor_TypeDefinitionIndex = 68927;
	...
	public:
		...
		::MarbleSubSealRotator* _MarbleSubSealRotator; // 0x20
		::RPG::GameCore::AnchorInfo* AnchorInfo; // 0x28
		::RPG::GameCore::CharacterModelComponent* _ModelCmpt; // 0x30
