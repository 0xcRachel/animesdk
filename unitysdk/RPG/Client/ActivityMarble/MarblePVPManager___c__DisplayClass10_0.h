...
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPVPMANAGER___C__DISPLAYCLASS10_0__CTOR_OFFSET UNITYSDK_OFFSET(0x8B6DF10)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPVPMANAGER___C__DISPLAYCLASS10_0__EXITPVPLOBBYPROMISE_B__0_OFFSET UNITYSDK_OFFSET(0x8B714F0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPVPMANAGER___C__DISPLAYCLASS10_0__EXITPVPLOBBYPROMISE_B__1_OFFSET UNITYSDK_OFFSET(0x8B71650)

namespace RPG::Client::ActivityMarble
{
	inline static constexpr unsigned int MarblePVPManager___c__DisplayClass10_0_TypeDefinitionIndex = 59694;
