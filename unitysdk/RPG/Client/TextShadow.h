...
#define RPG_CLIENT_TEXTSHADOW_GET_ADDBASEMESH_OFFSET UNITYSDK_OFFSET(0xA59F6E0)
#define RPG_CLIENT_TEXTSHADOW_METHOD_8_F2EA038FAE2982C3_OFFSET UNITYSDK_OFFSET(0xA59FA30)
#define RPG_CLIENT_TEXTSHADOW_MODIFYMESH_1_OFFSET UNITYSDK_OFFSET(0xA59F7F0)
#define RPG_CLIENT_TEXTSHADOW_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0xA59F7A0)
#define RPG_CLIENT_TEXTSHADOW__CTOR_OFFSET UNITYSDK_OFFSET(0xA59F6F0)
#define RPG_CLIENT_TEXTSHADOW___IFIXBASEPROXY_MODIFYMESH_1_OFFSET UNITYSDK_OFFSET(0xA5A0EE0)
#define RPG_CLIENT_TEXTSHADOW___IFIXBASEPROXY_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0xA5A0E90)

namespace RPG::Client
{
	inline static constexpr unsigned int TextShadow_TypeDefinitionIndex = 59573;
