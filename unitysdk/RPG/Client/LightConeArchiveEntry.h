...
#define RPG_CLIENT_LIGHTCONEARCHIVEENTRY_GET_ROW_OFFSET UNITYSDK_OFFSET(0x9504D30)
#define RPG_CLIENT_LIGHTCONEARCHIVEENTRY_GET_SORTID_OFFSET UNITYSDK_OFFSET(0x9505110)
#define RPG_CLIENT_LIGHTCONEARCHIVEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x9505010)
#define RPG_CLIENT_LIGHTCONEARCHIVEENTRY___IFIXBASEPROXY_GET_SORTID_OFFSET UNITYSDK_OFFSET(0x95051C0)

namespace RPG::Client
{
	inline static constexpr unsigned int LightConeArchiveEntry_TypeDefinitionIndex = 49586;
