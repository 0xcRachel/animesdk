...
#define RPG_CLIENT_CAMERAFIGHTSTATESELECTDARKTEAMENTITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x8E5D2D0)

namespace RPG::Client
{
	inline static constexpr unsigned int CameraFightStateSelectDarkTeamEntityConfig_TypeDefinitionIndex = 55313;
