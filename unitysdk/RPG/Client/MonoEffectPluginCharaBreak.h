...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARABREAK_METHOD_8_5835DC16FC46989B_OFFSET UNITYSDK_OFFSET(0x97C4930)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARABREAK_METHOD_8_D78B51BFDA4B8B32_OFFSET UNITYSDK_OFFSET(0x97C4B20)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARABREAK__CTOR_OFFSET UNITYSDK_OFFSET(0x97C4A60)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaBreak_TypeDefinitionIndex = 55648;
