...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPCRYSTAL_INIT_OFFSET UNITYSDK_OFFSET(0x97D6FB0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPCRYSTAL_UNINIT_OFFSET UNITYSDK_OFFSET(0x97D8180)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPCRYSTAL_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x97D7050)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPCRYSTAL__CTOR_OFFSET UNITYSDK_OFFSET(0x97D8290)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPCRYSTAL___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x97D82B0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropCrystal_TypeDefinitionIndex = 55663;
