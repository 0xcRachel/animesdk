...
#define RPG_CLIENT_ROGUEMODULE___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x163522F0)
#define RPG_CLIENT_ROGUEMODULE___C__CTOR_OFFSET UNITYSDK_OFFSET(0x16352330)
#define RPG_CLIENT_ROGUEMODULE___C__HASROGUEENDLESSINDOING_B__25_0_OFFSET UNITYSDK_OFFSET(0x16352340)
#define RPG_CLIENT_ROGUEMODULE___C___SHOWBUFFAEONFIRSTTALK_B__130_0_OFFSET UNITYSDK_OFFSET(0x163523A0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Func_2<::RPG::Client::RogueEndlessAreaData*, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(RogueModule___c_TypeDefinitionIndex)->GetStaticField(0x26D30);
		}
		static ::System::Action** StaticGet___9__130_0()
		{
			return (::System::Action**)Il2CppClass::FromTypeDefinitionIndex(RogueModule___c_TypeDefinitionIndex)->GetStaticField(0x26D38);
		}
		static ::RPG::Client::RogueModule___c** StaticGet___9()
		{
			return (::RPG::Client::RogueModule___c**)Il2CppClass::FromTypeDefinitionIndex(RogueModule___c_TypeDefinitionIndex)->GetStaticField(0x26D40);
		}
