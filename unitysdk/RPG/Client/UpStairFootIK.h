...
#define RPG_CLIENT_UPSTAIRFOOTIK_GET_ISPROCESSABLE_OFFSET UNITYSDK_OFFSET(0x15984970)
#define RPG_CLIENT_UPSTAIRFOOTIK_METHOD_5_301EC52F4A09A83B_OFFSET UNITYSDK_OFFSET(0x15985C70)
#define RPG_CLIENT_UPSTAIRFOOTIK_METHOD_5_6900CC9794727188_OFFSET UNITYSDK_OFFSET(0x15985760)
#define RPG_CLIENT_UPSTAIRFOOTIK_METHOD_5_F92EA6C247440E32_OFFSET UNITYSDK_OFFSET(0x15985EB0)
#define RPG_CLIENT_UPSTAIRFOOTIK_PREPROCESS_OFFSET UNITYSDK_OFFSET(0x159851A0)
#define RPG_CLIENT_UPSTAIRFOOTIK_PROCESS_OFFSET UNITYSDK_OFFSET(0x159852C0)
#define RPG_CLIENT_UPSTAIRFOOTIK_RESETUPSTAIR_OFFSET UNITYSDK_OFFSET(0x15984920)
#define RPG_CLIENT_UPSTAIRFOOTIK_SAFEINIT_OFFSET UNITYSDK_OFFSET(0x159849D0)
#define RPG_CLIENT_UPSTAIRFOOTIK_SETUPUPSTAIR_OFFSET UNITYSDK_OFFSET(0x159848A0)
#define RPG_CLIENT_UPSTAIRFOOTIK__CTOR_OFFSET UNITYSDK_OFFSET(0x15986220)
