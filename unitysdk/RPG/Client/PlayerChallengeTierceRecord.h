...
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_GET_BRIEFRECORD_OFFSET UNITYSDK_OFFSET(0x194F0D20)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_GET_CHALLENGETIMES_OFFSET UNITYSDK_OFFSET(0x194F0CC0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x194EF5E0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_GET_STAGERECORDS_OFFSET UNITYSDK_OFFSET(0x194F0D30)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_GET_STARCOUNT_OFFSET UNITYSDK_OFFSET(0x194F0CA0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_GET_TOTALSCORE_OFFSET UNITYSDK_OFFSET(0x194F0D00)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_GET_TOTALUSEROUNDS_OFFSET UNITYSDK_OFFSET(0x194F0CE0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_RESET_OFFSET UNITYSDK_OFFSET(0x194EF6E0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_SET_CHALLENGETIMES_OFFSET UNITYSDK_OFFSET(0x194F0CD0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_SET_STARCOUNT_OFFSET UNITYSDK_OFFSET(0x194F0CB0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_SET_TOTALSCORE_OFFSET UNITYSDK_OFFSET(0x194F0D10)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_SET_TOTALUSEROUNDS_OFFSET UNITYSDK_OFFSET(0x194F0CF0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_SYNC_OFFSET UNITYSDK_OFFSET(0x194EF7B0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD__CTOR_OFFSET UNITYSDK_OFFSET(0x194F0240)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD__SYNCSTAGES_OFFSET UNITYSDK_OFFSET(0x194F0D40)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 _StarCount_k__BackingField; // 0x2C
