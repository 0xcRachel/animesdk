...
#define RPG_CLIENT_SPRITEPRESETAPPLIER_GET_PRESETNAME_OFFSET UNITYSDK_OFFSET(0xA4C0200)
#define RPG_CLIENT_SPRITEPRESETAPPLIER_METHOD_1_016E85CEDEE00FF4_OFFSET UNITYSDK_OFFSET(0xA4BFFA0)
#define RPG_CLIENT_SPRITEPRESETAPPLIER_METHOD_1_1B819E8662A63D41_1_OFFSET UNITYSDK_OFFSET(0xA4C0030)
#define RPG_CLIENT_SPRITEPRESETAPPLIER_METHOD_1_1B819E8662A63D41_OFFSET UNITYSDK_OFFSET(0xA4BFD90)
#define RPG_CLIENT_SPRITEPRESETAPPLIER_SET_PRESETNAME_OFFSET UNITYSDK_OFFSET(0xA4C0210)
#define RPG_CLIENT_SPRITEPRESETAPPLIER__CTOR_OFFSET UNITYSDK_OFFSET(0xA4C0220)
