...
#define RPG_CLIENT_SPRITEPRESETAPPLIER_GET_PRESETNAME_OFFSET UNITYSDK_OFFSET(0x16C35F80)
#define RPG_CLIENT_SPRITEPRESETAPPLIER_METHOD_1_016E85CEDEE00FF4_OFFSET UNITYSDK_OFFSET(0x16C35D20)
#define RPG_CLIENT_SPRITEPRESETAPPLIER_METHOD_1_1B819E8662A63D41_1_OFFSET UNITYSDK_OFFSET(0x16C35DB0)
#define RPG_CLIENT_SPRITEPRESETAPPLIER_METHOD_1_1B819E8662A63D41_OFFSET UNITYSDK_OFFSET(0x16C35B10)
#define RPG_CLIENT_SPRITEPRESETAPPLIER_SET_PRESETNAME_OFFSET UNITYSDK_OFFSET(0x16C35F90)
#define RPG_CLIENT_SPRITEPRESETAPPLIER__CTOR_OFFSET UNITYSDK_OFFSET(0x16C35FA0)
