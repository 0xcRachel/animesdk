...
#define RPG_CLIENT_TREASUREDUNGEONEXITPARAM_SYNC_OFFSET UNITYSDK_OFFSET(0x16843A90)
#define RPG_CLIENT_TREASUREDUNGEONEXITPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x168446C0)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 TotalUltraItemFound; // 0x38
		::System::UInt32 AttackAdd; // 0x3C
		::System::UInt32 TotalAttackItemFound; // 0x40
		::System::UInt32 TotalBuffFound; // 0x44
		::System::UInt32 CurFloor; // 0x48
		::System::Boolean IsFinish; // 0x4C
		::System::Boolean IsWin; // 0x4D
		::System::Boolean IsAllDead; // 0x4E
		::System::UInt32 MaxFloor; // 0x50
		::System::UInt32 AttackExAdd; // 0x54
		::System::UInt32 TotalTrialAvatarFound; // 0x58
