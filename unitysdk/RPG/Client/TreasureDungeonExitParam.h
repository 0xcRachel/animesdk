...
#define RPG_CLIENT_TREASUREDUNGEONEXITPARAM_SYNC_OFFSET UNITYSDK_OFFSET(0x185C49A0)
#define RPG_CLIENT_TREASUREDUNGEONEXITPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x185C5400)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 TotalUltraItemFound; // 0x28
		::System::UInt32 TotalTrialAvatarFound; // 0x2C
		::System::UInt32 GroupID; // 0x30
		::System::UInt32 TotalBuffFound; // 0x34
		::System::UInt32 TotalDefenceItemFound; // 0x38
		::System::Boolean IsAllDead; // 0x3C
		::System::Boolean IsWin; // 0x3D
		::System::Boolean IsFinish; // 0x3E
		::System::UInt32 AttackAdd; // 0x40
		::System::UInt32 TotalAttackItemFound; // 0x44
		::System::UInt32 CurFloor; // 0x48
		::System::UInt32 TotalEnemyKilled; // 0x4C
		::System::UInt32 MaxFloor; // 0x50
		::System::UInt32 TotalExploreUsed; // 0x54
		::System::UInt32 DefenceAdd; // 0x58
		::System::UInt32 AttackExAdd; // 0x5C
