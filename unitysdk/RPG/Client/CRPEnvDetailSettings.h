...
#define RPG_CLIENT_CRPENVDETAILSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x8E138E0)

namespace RPG::Client
{
	inline static constexpr unsigned int CRPEnvDetailSettings_TypeDefinitionIndex = 53877;
