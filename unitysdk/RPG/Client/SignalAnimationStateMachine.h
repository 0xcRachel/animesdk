...
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_GET_PREVIOUSSIGNAL_OFFSET UNITYSDK_OFFSET(0xA487ED0)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xA488460)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_1524BBDF654AD3DF_OFFSET UNITYSDK_OFFSET(0xA4882D0)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_229CEF33F0AF9039_OFFSET UNITYSDK_OFFSET(0xA488580)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_35C4A143193C04DA_OFFSET UNITYSDK_OFFSET(0xA4883A0)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0xA488400)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_56CE4AFC5339F746_OFFSET UNITYSDK_OFFSET(0xA487F70)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_71597673BC6D185F_OFFSET UNITYSDK_OFFSET(0xA487760)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_7646FFE662147970_OFFSET UNITYSDK_OFFSET(0xA488870)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xA488520)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_9846A80F070E0F0C_OFFSET UNITYSDK_OFFSET(0xA488050)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_A9E445C5683F09FE_OFFSET UNITYSDK_OFFSET(0xA487EF0)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_SET_PREVIOUSSIGNAL_OFFSET UNITYSDK_OFFSET(0xA487EE0)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE__CTOR_OFFSET UNITYSDK_OFFSET(0xA488B40)
