...
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_GET_PREVIOUSSIGNAL_OFFSET UNITYSDK_OFFSET(0x1534CF50)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x1534D4E0)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_1524BBDF654AD3DF_OFFSET UNITYSDK_OFFSET(0x1534D350)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_229CEF33F0AF9039_OFFSET UNITYSDK_OFFSET(0x1534D600)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_35C4A143193C04DA_OFFSET UNITYSDK_OFFSET(0x1534D420)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0x1534D480)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_56CE4AFC5339F746_OFFSET UNITYSDK_OFFSET(0x1534CFF0)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_71597673BC6D185F_OFFSET UNITYSDK_OFFSET(0x1534C7E0)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_7646FFE662147970_OFFSET UNITYSDK_OFFSET(0x1534D8F0)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1534D5A0)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_9846A80F070E0F0C_OFFSET UNITYSDK_OFFSET(0x1534D0D0)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_A9E445C5683F09FE_OFFSET UNITYSDK_OFFSET(0x1534CF70)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_SET_PREVIOUSSIGNAL_OFFSET UNITYSDK_OFFSET(0x1534CF60)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1534DBC0)
