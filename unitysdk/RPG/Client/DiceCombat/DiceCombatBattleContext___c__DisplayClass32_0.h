...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLECONTEXT___C__DISPLAYCLASS32_0__ADDBATTLEEVENTHANDLER_B__0_OFFSET UNITYSDK_OFFSET(0x901F4F0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLECONTEXT___C__DISPLAYCLASS32_0__CTOR_OFFSET UNITYSDK_OFFSET(0x901E3A0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatBattleContext___c__DisplayClass32_0_TypeDefinitionIndex = 60112;

	class DiceCombatBattleContext___c__DisplayClass32_0 : public ::System::Object
	{
	public:
		::XLua::LuaTable* target; // 0x10
		::System::Action_2<::XLua::LuaTable*, ::Class_0_16E4307DCC419505_301*>* eventHandler; // 0x18
