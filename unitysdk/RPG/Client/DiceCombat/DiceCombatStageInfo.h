...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_CHECKPRESETSTAGESKIP_OFFSET UNITYSDK_OFFSET(0x9494060)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_CREATE_OFFSET UNITYSDK_OFFSET(0x94937D0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_CAMPAIGNPROGRESSTITLE_OFFSET UNITYSDK_OFFSET(0x9494410)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_CAMPAIGNPROGRESS_OFFSET UNITYSDK_OFFSET(0x94943B0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ENEMYAVATARID_OFFSET UNITYSDK_OFFSET(0x94941D0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ENEMYAVATARINFO_OFFSET UNITYSDK_OFFSET(0x9493E80)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ENEMYAVATARLEVEL_OFFSET UNITYSDK_OFFSET(0x94941F0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ENEMYICONPATH_OFFSET UNITYSDK_OFFSET(0x9493D20)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ENEMYMAINPAGEIMGPATH_OFFSET UNITYSDK_OFFSET(0x94942F0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ENEMYMAINPAGESILHOUETTEPATH_OFFSET UNITYSDK_OFFSET(0x9494350)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ENEMYNAME_OFFSET UNITYSDK_OFFSET(0x9485B60)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ENEMYPROGRESSICONPATH_OFFSET UNITYSDK_OFFSET(0x9493E20)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ENTERPROGRESSBOAST_OFFSET UNITYSDK_OFFSET(0x9494490)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_EXITMAINPAGEONFINISH_OFFSET UNITYSDK_OFFSET(0x9494690)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_EXITPROGRESSBOAST_OFFSET UNITYSDK_OFFSET(0x9494610)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_FIRSTTYPE_OFFSET UNITYSDK_OFFSET(0x9494250)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_GROUPENTITYID_OFFSET UNITYSDK_OFFSET(0x9494290)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_HARDLEVEL_OFFSET UNITYSDK_OFFSET(0x9494230)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_HASSPECIALRULE_OFFSET UNITYSDK_OFFSET(0x9493EA0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ISCAMPAIGN_OFFSET UNITYSDK_OFFSET(0x9493B30)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ISDONE_OFFSET UNITYSDK_OFFSET(0x948CB10)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ISPRESETSTAGE_OFFSET UNITYSDK_OFFSET(0x9494050)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ISREWARDTAKEN_OFFSET UNITYSDK_OFFSET(0x9493F70)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_LOSEBATTLEBOAST_OFFSET UNITYSDK_OFFSET(0x9494510)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_MUSTLOSE_OFFSET UNITYSDK_OFFSET(0x94946F0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_PLAYERINITAVATARINFO_OFFSET UNITYSDK_OFFSET(0x94939F0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_RECOMMENDAVATARLIST_OFFSET UNITYSDK_OFFSET(0x9494270)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_REWARDID_OFFSET UNITYSDK_OFFSET(0x9494210)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_SPECIALRULEGROUPDATAS_OFFSET UNITYSDK_OFFSET(0x9493F00)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_STAGEID_OFFSET UNITYSDK_OFFSET(0x9494030)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_SUBMISSONID_OFFSET UNITYSDK_OFFSET(0x9493F10)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_WINBATTLEBOAST_OFFSET UNITYSDK_OFFSET(0x9494590)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET__DICECOMBATMODULE_OFFSET UNITYSDK_OFFSET(0x9493B40)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_SETNOTINACTIVITYENEMYNAME_OFFSET UNITYSDK_OFFSET(0x9494170)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_SET_ENEMYAVATARINFO_OFFSET UNITYSDK_OFFSET(0x9493E90)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x94939C0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatStageInfo_TypeDefinitionIndex = 61930;

	class DiceCombatStageInfo : public ::System::Object
	{
	public:
		::RPG::Client::DiceCombat::DiceCombatConfigAvatarInfo* _PresetPlayerAvatarInfo; // 0x10
