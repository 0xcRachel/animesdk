...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATEVENTPROXY_GETATTACKANIMATION_OFFSET UNITYSDK_OFFSET(0x9025D40)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATEVENTPROXY_GETIGNOREDEFENDPOINTVALUE_OFFSET UNITYSDK_OFFSET(0x9025DC0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATEVENTPROXY_GETSPECIALHINTCONTENT_OFFSET UNITYSDK_OFFSET(0x9025E20)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATEVENTPROXY_GETSTATMAXVALUE_OFFSET UNITYSDK_OFFSET(0x9025CD0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATEVENTPROXY_GETSTATVALUE_OFFSET UNITYSDK_OFFSET(0x9025C60)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATEVENTPROXY_GET_BUFFID_OFFSET UNITYSDK_OFFSET(0x9025F20)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATEVENTPROXY_GET_DIRECTDAMAGESTYLE_OFFSET UNITYSDK_OFFSET(0x9026570)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATEVENTPROXY_GET_DIRECTDAMAGEVALUE_OFFSET UNITYSDK_OFFSET(0x9026510)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATEVENTPROXY_GET_EVENTTYPE_OFFSET UNITYSDK_OFFSET(0x9025EE0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATEVENTPROXY_GET_HEALVALUE_OFFSET UNITYSDK_OFFSET(0x90264B0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATEVENTPROXY_GET_HITDAMAGE_OFFSET UNITYSDK_OFFSET(0x9026070)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATEVENTPROXY_GET_ICEEFFECTTARGETUID_OFFSET UNITYSDK_OFFSET(0x9026450)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATEVENTPROXY_GET_ISHIT_OFFSET UNITYSDK_OFFSET(0x9026000)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATEVENTPROXY_GET_ISKILL_OFFSET UNITYSDK_OFFSET(0x9025FE0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATEVENTPROXY_GET_ISLOCALPLAYER_OFFSET UNITYSDK_OFFSET(0x9025F00)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATEVENTPROXY_GET_NEWWEATHER_OFFSET UNITYSDK_OFFSET(0x9026260)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATEVENTPROXY_GET_OLDWEATHER_OFFSET UNITYSDK_OFFSET(0x90260E0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATEVENTPROXY_GET_OVERRIDEDICEMODELTRANS_OFFSET UNITYSDK_OFFSET(0x90265D0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATEVENTPROXY_GET_OVERRIDEDICETYPE_OFFSET UNITYSDK_OFFSET(0x90265F0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATEVENTPROXY_GET_WEATHERCHANGE_OFFSET UNITYSDK_OFFSET(0x90263E0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATEVENTPROXY_GET_WEATHERIDRECORDDICT_OFFSET UNITYSDK_OFFSET(0x9026380)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATEVENTPROXY_SET_ISKILL_OFFSET UNITYSDK_OFFSET(0x9025FF0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATEVENTPROXY_SET_ISLOCALPLAYER_OFFSET UNITYSDK_OFFSET(0x9025F10)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATEVENTPROXY_SET_OVERRIDEDICEMODELTRANS_OFFSET UNITYSDK_OFFSET(0x90265E0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATEVENTPROXY_SET_OVERRIDEDICETYPE_OFFSET UNITYSDK_OFFSET(0x9026600)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATEVENTPROXY_SYNC_OFFSET UNITYSDK_OFFSET(0x901E5A0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATEVENTPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x901E590)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatEventProxy_TypeDefinitionIndex = 60106;

	class DiceCombatEventProxy : public ::System::Object
	{
	public:
		::Class_1_43BD383C98B4C0C5_8* _Event; // 0x10
		::UnityEngine::Transform* _OverrideDiceModelTrans_k__BackingField; // 0x18
		::Class_3_E5B65FD9338F9400* _OwnerGameInstance; // 0x20
		...
		::System::Void _ctor(::Class_3_E5B65FD9338F9400* gameInstance)
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_E5B65FD9338F9400*))((::PBYTE)hIl2Cpp + RPG_CLIENT_DICECOMBAT_DICECOMBATEVENTPROXY__CTOR_OFFSET))(this, gameInstance);
		}
