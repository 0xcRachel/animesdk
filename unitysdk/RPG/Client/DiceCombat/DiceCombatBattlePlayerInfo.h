...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_ADDBUFF_OFFSET UNITYSDK_OFFSET(0x947CBD0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_ADDDICE_OFFSET UNITYSDK_OFFSET(0x947D0E0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_CHANGEDICE_OFFSET UNITYSDK_OFFSET(0x947D420)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_CREATE_OFFSET UNITYSDK_OFFSET(0x9478BA0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_GETALLLIMITEDDICEAVAILABLECOUNT_OFFSET UNITYSDK_OFFSET(0x947D6D0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_GETDICEDISPLAYINFOS_OFFSET UNITYSDK_OFFSET(0x947D500)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_GETDICELIST_OFFSET UNITYSDK_OFFSET(0x947CD80)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_GETPLAYERPLATFORMINFO_OFFSET UNITYSDK_OFFSET(0x947D990)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_GETSELECTEDDICECOUNT_OFFSET UNITYSDK_OFFSET(0x947CF60)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_GETSKILLDESC_OFFSET UNITYSDK_OFFSET(0x947CC80)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_GET_CARDINFO_OFFSET UNITYSDK_OFFSET(0x947DC10)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_GET_CURRENTROLLCOUNT_OFFSET UNITYSDK_OFFSET(0x947DC40)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_GET_DICECONTROLLER_OFFSET UNITYSDK_OFFSET(0x947A400)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_GET_ENTITY_OFFSET UNITYSDK_OFFSET(0x947DC30)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_GET_GLOSSARYTERMIDS_OFFSET UNITYSDK_OFFSET(0x947DBE0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_GET_HASUSELIMITDICECURRENTTURN_OFFSET UNITYSDK_OFFSET(0x947DE20)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x947DBC0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_GET_ISLIMITDICEUNLOCK_OFFSET UNITYSDK_OFFSET(0x947E040)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_GET_ISUNSELECTABLE_OFFSET UNITYSDK_OFFSET(0x947DF60)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_GET_LIMITDICEAVAILABLECOUNT_OFFSET UNITYSDK_OFFSET(0x947DD60)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_GET_LIMITDICEID_OFFSET UNITYSDK_OFFSET(0x947DCA0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_GET_NAME_OFFSET UNITYSDK_OFFSET(0x947DBA0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_GET_PVPSCORE_OFFSET UNITYSDK_OFFSET(0x947E190)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_GET_UID_OFFSET UNITYSDK_OFFSET(0x947DB80)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_INITDICEANCHORS_OFFSET UNITYSDK_OFFSET(0x947D000)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_INITDICEPHYSIMPARAM_OFFSET UNITYSDK_OFFSET(0x947D5A0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_ISSPECIALDICE_OFFSET UNITYSDK_OFFSET(0x947D3A0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_ISVISUALEVENTALLFINISHED_OFFSET UNITYSDK_OFFSET(0x947E1B0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_ONRESETDICES_OFFSET UNITYSDK_OFFSET(0x947D8F0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_REFRESHHOLDDICEPOS_OFFSET UNITYSDK_OFFSET(0x947D850)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_REFRESHUIAPPEARDICEINFO_OFFSET UNITYSDK_OFFSET(0x947D770)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_REMOVEBUFF_OFFSET UNITYSDK_OFFSET(0x947D640)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_SETDICESELECTEDCHANGEDCALLBACK_OFFSET UNITYSDK_OFFSET(0x947CDE0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_SET_CARDINFO_OFFSET UNITYSDK_OFFSET(0x947DC20)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x947DBD0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO_SET_NAME_OFFSET UNITYSDK_OFFSET(0x947DBB0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLEPLAYERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x947CB40)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatBattlePlayerInfo_TypeDefinitionIndex = 61899;
	...
	public:
		...
		::RPG::Client::DiceCombat::DiceCombatBattleAvatarInfo* _CardInfo_k__BackingField; // 0x28
		::Class_2_569DE47525C5FD32* _Entity; // 0x30
		::Class_1_DBCFFD8B921CBC69* _PlayerInfo; // 0x38
