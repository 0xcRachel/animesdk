...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATPVPMANAGER___C__DISPLAYCLASS10_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9488B50)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATPVPMANAGER___C__DISPLAYCLASS10_0__JOININVITATIONLOBBY_B__0_OFFSET UNITYSDK_OFFSET(0x948B490)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATPVPMANAGER___C__DISPLAYCLASS10_0__JOININVITATIONLOBBY_B__1_OFFSET UNITYSDK_OFFSET(0x948B4C0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatPVPManager___c__DisplayClass10_0_TypeDefinitionIndex = 61976;
