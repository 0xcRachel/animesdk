...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE_ACCEPTINVITATION_OFFSET UNITYSDK_OFFSET(0x17F0A790)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE_CHECKCANENTERMPGAME_OFFSET UNITYSDK_OFFSET(0x17F09A40)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE_CREATEMPPLAYEREXTINFO_OFFSET UNITYSDK_OFFSET(0x17F0A0E0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE_CREATEMPROOMEXTINFO_OFFSET UNITYSDK_OFFSET(0x17F0A570)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE_GET_GAMEMODE_OFFSET UNITYSDK_OFFSET(0x17F09A30)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE_GET_INVITETOASTUIPATH_OFFSET UNITYSDK_OFFSET(0x17F0A750)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE_ISINACTIVITYGAME_OFFSET UNITYSDK_OFFSET(0x17F0A9E0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE_ONGENERALNOTIFY_OFFSET UNITYSDK_OFFSET(0x17F0A060)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE_ONONGENERALRSP_OFFSET UNITYSDK_OFFSET(0x17F09FE0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE_ONSERVERCONNECTED_OFFSET UNITYSDK_OFFSET(0x17F09F80)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE_ONSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x17F09BE0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE_REGISTERGUEST_OFFSET UNITYSDK_OFFSET(0x17F0ABD0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE_SETINVITEROBOTID_OFFSET UNITYSDK_OFFSET(0x17F0AD50)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE_UNREGISTERGUEST_OFFSET UNITYSDK_OFFSET(0x17F0AC90)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x17F09A20)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE__GETPLAYERAVATARID_OFFSET UNITYSDK_OFFSET(0x17F0A510)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE__GETPVPSTAGEID_OFFSET UNITYSDK_OFFSET(0x17F0A6C0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE__ONENTERLOBBY_OFFSET UNITYSDK_OFFSET(0x17F09C50)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE___IFIXBASEPROXY_ACCEPTINVITATION_OFFSET UNITYSDK_OFFSET(0x17F0B000)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE___IFIXBASEPROXY_CHECKCANENTERMPGAME_OFFSET UNITYSDK_OFFSET(0x17F0AE20)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE___IFIXBASEPROXY_ONGENERALNOTIFY_OFFSET UNITYSDK_OFFSET(0x17F0AFA0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE___IFIXBASEPROXY_ONONGENERALRSP_OFFSET UNITYSDK_OFFSET(0x17F0AF40)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE___IFIXBASEPROXY_ONSERVERCONNECTED_OFFSET UNITYSDK_OFFSET(0x17F0AEE0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE___IFIXBASEPROXY_ONSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x17F0AE80)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2MPService_TypeDefinitionIndex = 70777;
	...
	public:
		...
		::System::Action_2<::System::UInt32, ::Google::Protobuf::ByteString*>* _OnGeneralNotify; // 0x28
		::System::Action* _OnServerConnected; // 0x30
