...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE_ACCEPTINVITATION_OFFSET UNITYSDK_OFFSET(0x17A4BB10)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE_CHECKCANENTERMPGAME_OFFSET UNITYSDK_OFFSET(0x17A4B300)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE_CREATEMPPLAYEREXTINFO_OFFSET UNITYSDK_OFFSET(0x17A4B540)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE_CREATEMPROOMEXTINFO_OFFSET UNITYSDK_OFFSET(0x17A4B980)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE_GET_GAMEMODE_OFFSET UNITYSDK_OFFSET(0x17A4B2F0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE_GET_INVITETOASTUIPATH_OFFSET UNITYSDK_OFFSET(0x17A4BAD0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE_ISINACTIVITYGAME_OFFSET UNITYSDK_OFFSET(0x17A4BC00)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE_ONGENERALNOTIFY_OFFSET UNITYSDK_OFFSET(0x17A4B4D0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE_ONONGENERALRSP_OFFSET UNITYSDK_OFFSET(0x17A4B460)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE_ONSERVERCONNECTED_OFFSET UNITYSDK_OFFSET(0x17A4B410)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE_ONSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x17A4B3A0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE_REGISTERGUEST_OFFSET UNITYSDK_OFFSET(0x17A4BDC0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE_SETINVITEROBOTID_OFFSET UNITYSDK_OFFSET(0x17A4BF40)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE_UNREGISTERGUEST_OFFSET UNITYSDK_OFFSET(0x17A4BE80)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x17A4B2E0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE__GETPLAYERAVATARID_OFFSET UNITYSDK_OFFSET(0x170405A0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE__GETPVPSTAGEID_OFFSET UNITYSDK_OFFSET(0x17040600)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE__ONENTERLOBBY_OFFSET UNITYSDK_OFFSET(0x17040120)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE___IFIXBASEPROXY_ACCEPTINVITATION_OFFSET UNITYSDK_OFFSET(0x170408B0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE___IFIXBASEPROXY_CHECKCANENTERMPGAME_OFFSET UNITYSDK_OFFSET(0x17040690)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE___IFIXBASEPROXY_ONGENERALNOTIFY_OFFSET UNITYSDK_OFFSET(0x17040840)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE___IFIXBASEPROXY_ONONGENERALRSP_OFFSET UNITYSDK_OFFSET(0x170407D0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE___IFIXBASEPROXY_ONSERVERCONNECTED_OFFSET UNITYSDK_OFFSET(0x17040770)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MPSERVICE___IFIXBASEPROXY_ONSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x17040700)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2MPService_TypeDefinitionIndex = 69965;
