...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_GETSHOPSUBTABREDDOTKEY_OFFSET UNITYSDK_OFFSET(0x17A2E660)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_GET__DICECOMBATMODULE_OFFSET UNITYSDK_OFFSET(0x17A2C020)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_HASANYNEWGOODSNOTSEENFORSHOPANDGOODTYPE_OFFSET UNITYSDK_OFFSET(0x17A2C110)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_HASANYNEWGOODSNOTSEENFORSHOP_OFFSET UNITYSDK_OFFSET(0x17A2C0A0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_HASANYNEWSHOPGOODNOTSEEN_OFFSET UNITYSDK_OFFSET(0x17A2BDF0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_HASCANBUYAVATARNOTSEENINTEAMEDIT_OFFSET UNITYSDK_OFFSET(0x17A2D840)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_HASOWNEDAVATARNOTSEENINCOLLECTION_OFFSET UNITYSDK_OFFSET(0x17A2DDC0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_HASOWNEDAVATARNOTSEENINTEAMEDIT_OFFSET UNITYSDK_OFFSET(0x17A2CA80)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_HASSHOPGOODNOTSEEN_OFFSET UNITYSDK_OFFSET(0x17A2C320)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_HASTARGETRARITYOWNEDAVATARNOTSEENINCOLLECTION_OFFSET UNITYSDK_OFFSET(0x17A2DAA0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_SETSEENALLOWNEDANDCANBUYAVATARINTEAMEDIT_OFFSET UNITYSDK_OFFSET(0x17A2CF90)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_SETSEENCANBUYAVATARINTEAMEDIT_OFFSET UNITYSDK_OFFSET(0x17A2D600)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_SETSEENOWNEDAVATARINCOLLECTION_OFFSET UNITYSDK_OFFSET(0x17A2E2D0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_SETSEENOWNEDAVATARINTEAMEDIT_OFFSET UNITYSDK_OFFSET(0x17A2CC00)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_SETSEENSHOPGOODSFORSHOPANDGOODTYPE_OFFSET UNITYSDK_OFFSET(0x17A2C4B0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_SETSEENSHOPGOOD_OFFSET UNITYSDK_OFFSET(0x17A2C6F0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_SETSEENSINGLECANBUYAVATARINTEAMEDIT_OFFSET UNITYSDK_OFFSET(0x17A2D950)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_SETSEENSINGLEOWNEDAVATARINCOLLECTION_OFFSET UNITYSDK_OFFSET(0x17A2E510)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_SETSEENSINGLEOWNEDAVATARINTEAMEDIT_OFFSET UNITYSDK_OFFSET(0x17A2CE40)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_SETSEENSINGLESHOPGOOD_OFFSET UNITYSDK_OFFSET(0x17A2C930)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_SETTARGETRARITYOWNEDAVATARSEENINCOLLECTION_OFFSET UNITYSDK_OFFSET(0x17A2DF40)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT__CTOR_OFFSET UNITYSDK_OFFSET(0x17A2BD70)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatRedDot_TypeDefinitionIndex = 69858;
