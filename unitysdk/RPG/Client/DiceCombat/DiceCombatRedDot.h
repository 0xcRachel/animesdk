...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_GETSHOPSUBTABREDDOTKEY_OFFSET UNITYSDK_OFFSET(0x9490950)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_GET__DICECOMBATMODULE_OFFSET UNITYSDK_OFFSET(0x948D980)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_HASANYNEWGOODSNOTSEENFORSHOPANDGOODTYPE_OFFSET UNITYSDK_OFFSET(0x948DA70)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_HASANYNEWGOODSNOTSEENFORSHOP_OFFSET UNITYSDK_OFFSET(0x948DA00)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_HASANYNEWSHOPGOODNOTSEEN_OFFSET UNITYSDK_OFFSET(0x948D750)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_HASCANBUYAVATARNOTSEENINTEAMEDIT_OFFSET UNITYSDK_OFFSET(0x948FA30)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_HASOWNEDAVATARNOTSEENINCOLLECTION_OFFSET UNITYSDK_OFFSET(0x94900B0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_HASOWNEDAVATARNOTSEENINTEAMEDIT_OFFSET UNITYSDK_OFFSET(0x948E8F0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_HASSHOPGOODNOTSEEN_OFFSET UNITYSDK_OFFSET(0x948DD80)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_HASTARGETRARITYOWNEDAVATARNOTSEENINCOLLECTION_OFFSET UNITYSDK_OFFSET(0x948FC90)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_SETSEENALLOWNEDANDCANBUYAVATARINTEAMEDIT_OFFSET UNITYSDK_OFFSET(0x948EE00)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_SETSEENCANBUYAVATARINTEAMEDIT_OFFSET UNITYSDK_OFFSET(0x948F7F0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_SETSEENOWNEDAVATARINCOLLECTION_OFFSET UNITYSDK_OFFSET(0x94905C0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_SETSEENOWNEDAVATARINTEAMEDIT_OFFSET UNITYSDK_OFFSET(0x948EA70)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_SETSEENSHOPGOODSFORSHOPANDGOODTYPE_OFFSET UNITYSDK_OFFSET(0x948E320)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_SETSEENSHOPGOOD_OFFSET UNITYSDK_OFFSET(0x948E560)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_SETSEENSINGLECANBUYAVATARINTEAMEDIT_OFFSET UNITYSDK_OFFSET(0x948FB40)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_SETSEENSINGLEOWNEDAVATARINCOLLECTION_OFFSET UNITYSDK_OFFSET(0x9490800)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_SETSEENSINGLEOWNEDAVATARINTEAMEDIT_OFFSET UNITYSDK_OFFSET(0x948ECB0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_SETSEENSINGLESHOPGOOD_OFFSET UNITYSDK_OFFSET(0x948E7A0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT_SETTARGETRARITYOWNEDAVATARSEENINCOLLECTION_OFFSET UNITYSDK_OFFSET(0x9490230)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATREDDOT__CTOR_OFFSET UNITYSDK_OFFSET(0x948D6D0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatRedDot_TypeDefinitionIndex = 61935;
