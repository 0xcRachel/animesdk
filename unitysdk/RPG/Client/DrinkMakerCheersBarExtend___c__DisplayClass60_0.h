...
#define RPG_CLIENT_DRINKMAKERCHEERSBAREXTEND___C__DISPLAYCLASS60_0__CTOR_OFFSET UNITYSDK_OFFSET(0x18CDFA00)
#define RPG_CLIENT_DRINKMAKERCHEERSBAREXTEND___C__DISPLAYCLASS60_0__PLAYDRINKGIVENAMEPERFORMANCEAFTERINVITEGUESTGIVEDRINK_B__0_OFFSET UNITYSDK_OFFSET(0x18CE1160)
