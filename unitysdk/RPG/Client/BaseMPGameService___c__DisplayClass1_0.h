...
#define RPG_CLIENT_BASEMPGAMESERVICE___C__DISPLAYCLASS1_0__CREATELOBBY_B__0_OFFSET UNITYSDK_OFFSET(0x15E66860)
#define RPG_CLIENT_BASEMPGAMESERVICE___C__DISPLAYCLASS1_0__CREATELOBBY_B__1_OFFSET UNITYSDK_OFFSET(0x15E668B0)
#define RPG_CLIENT_BASEMPGAMESERVICE___C__DISPLAYCLASS1_0__CREATELOBBY_B__2_OFFSET UNITYSDK_OFFSET(0x15E66A90)
#define RPG_CLIENT_BASEMPGAMESERVICE___C__DISPLAYCLASS1_0__CREATELOBBY_B__3_OFFSET UNITYSDK_OFFSET(0x15E66AC0)
#define RPG_CLIENT_BASEMPGAMESERVICE___C__DISPLAYCLASS1_0__CREATELOBBY_B__4_OFFSET UNITYSDK_OFFSET(0x15E66A40)
#define RPG_CLIENT_BASEMPGAMESERVICE___C__DISPLAYCLASS1_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15E650B0)
...
namespace RPG::Client
{
	...
	{
	public:
		::Class_1_E7DB216A3FFF6C29* roomExtInfo; // 0x10
		::System::Func_1<::RPG::Client::Promises::IPromise_1<::RPG::Client::BaseLobby*>*>* __9__4; // 0x18
		::RPG::Client::BaseMPGameService* __4__this; // 0x20
