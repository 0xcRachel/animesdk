...
#define RPG_CLIENT_CHALLENGEBOSSSINGLENODEINFO_CREATE_OFFSET UNITYSDK_OFFSET(0x15F81730)
#define RPG_CLIENT_CHALLENGEBOSSSINGLENODEINFO_GETAVATARDATALIST_OFFSET UNITYSDK_OFFSET(0x15F81910)
#define RPG_CLIENT_CHALLENGEBOSSSINGLENODEINFO_SYNC_OFFSET UNITYSDK_OFFSET(0x15F815F0)
#define RPG_CLIENT_CHALLENGEBOSSSINGLENODEINFO_TRYGETAVATAR_OFFSET UNITYSDK_OFFSET(0x15F818B0)
#define RPG_CLIENT_CHALLENGEBOSSSINGLENODEINFO_UPDATEBATTLERESULT_OFFSET UNITYSDK_OFFSET(0x15F816B0)
#define RPG_CLIENT_CHALLENGEBOSSSINGLENODEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x15F818A0)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Boolean HasTeamInfo; // 0x2C
		::System::Boolean HasBeenChallenged; // 0x2D
		::System::Boolean IsPass; // 0x2E
