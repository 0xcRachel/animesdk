...
#define RPG_CLIENT_CHALLENGEGROUPSTATISTICSDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x17A20000)
#define RPG_CLIENT_CHALLENGEGROUPSTATISTICSDATA_GET_ISSPECIALTARGETACHIEVED_OFFSET UNITYSDK_OFFSET(0x3830200)
#define RPG_CLIENT_CHALLENGEGROUPSTATISTICSDATA_GET_ISTIERCE_OFFSET UNITYSDK_OFFSET(0x378A6F0)
#define RPG_CLIENT_CHALLENGEGROUPSTATISTICSDATA_SET_ISSPECIALTARGETACHIEVED_OFFSET UNITYSDK_OFFSET(0x3830210)
#define RPG_CLIENT_CHALLENGEGROUPSTATISTICSDATA_SET_ISTIERCE_OFFSET UNITYSDK_OFFSET(0x37A4CD0)
#define RPG_CLIENT_CHALLENGEGROUPSTATISTICSDATA__GETNORMALMODEMAXLEVELSTARNUM_OFFSET UNITYSDK_OFFSET(0x17A20E40)
#define RPG_CLIENT_CHALLENGEGROUPSTATISTICSDATA__GETNORMALMODEMAXLEVEL_OFFSET UNITYSDK_OFFSET(0x17A20C90)
#define RPG_CLIENT_CHALLENGEGROUPSTATISTICSDATA__GETTIERCESTARSTATE_OFFSET UNITYSDK_OFFSET(0x17A20970)
#define RPG_CLIENT_CHALLENGEGROUPSTATISTICSDATA__GETTOTALCHALLENGETIMES_OFFSET UNITYSDK_OFFSET(0x17A20810)
#define RPG_CLIENT_CHALLENGEGROUPSTATISTICSDATA__SETLINEUP_OFFSET UNITYSDK_OFFSET(0x3830230)
#define RPG_CLIENT_CHALLENGEGROUPSTATISTICSDATA__SETTIERCESTATISTICS_OFFSET UNITYSDK_OFFSET(0x3830220)
