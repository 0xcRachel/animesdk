...
#define RPG_CLIENT_CHALLENGEGROUPSTATISTICSDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x15F8BDB0)
#define RPG_CLIENT_CHALLENGEGROUPSTATISTICSDATA_SETLINEUP_OFFSET UNITYSDK_OFFSET(0x2258EB0)
