...
#define RPG_CLIENT_CHALLENGEGROUPSTATISTICSDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x92D41E0)
#define RPG_CLIENT_CHALLENGEGROUPSTATISTICSDATA_SETLINEUP_OFFSET UNITYSDK_OFFSET(0x7C5D0)
