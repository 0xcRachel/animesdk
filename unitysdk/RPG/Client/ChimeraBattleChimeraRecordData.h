...
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x177A6A50)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_GET_ATK_OFFSET UNITYSDK_OFFSET(0x177A69B0)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_GET_CHIMERAID_OFFSET UNITYSDK_OFFSET(0x177A68F0)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_GET_DECREASEDATK_OFFSET UNITYSDK_OFFSET(0x177A6A30)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_GET_DECREASEDHP_OFFSET UNITYSDK_OFFSET(0x177A69F0)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_GET_HP_OFFSET UNITYSDK_OFFSET(0x177A6990)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_GET_INCREASEDATK_OFFSET UNITYSDK_OFFSET(0x177A6A10)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_GET_INCREASEDHP_OFFSET UNITYSDK_OFFSET(0x177A69D0)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_GET_ISALIVE_OFFSET UNITYSDK_OFFSET(0x177A6910)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_GET_TEAMINDEX_OFFSET UNITYSDK_OFFSET(0x177A6920)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_SET_ATK_OFFSET UNITYSDK_OFFSET(0x177A69C0)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_SET_CHIMERAID_OFFSET UNITYSDK_OFFSET(0x177A6900)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_SET_DECREASEDATK_OFFSET UNITYSDK_OFFSET(0x177A6A40)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_SET_DECREASEDHP_OFFSET UNITYSDK_OFFSET(0x177A6A00)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_SET_HP_OFFSET UNITYSDK_OFFSET(0x177A69A0)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_SET_INCREASEDATK_OFFSET UNITYSDK_OFFSET(0x177A6A20)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_SET_INCREASEDHP_OFFSET UNITYSDK_OFFSET(0x177A69E0)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_SET_TEAMINDEX_OFFSET UNITYSDK_OFFSET(0x177A6930)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_UPDATE_OFFSET UNITYSDK_OFFSET(0x177A6BF0)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x177A6BE0)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Int32 _DecreasedHP_k__BackingField; // 0x20
		::System::Int32 _TeamIndex; // 0x24
		::System::Int32 _DecreasedATK_k__BackingField; // 0x28
		::System::Int32 _IncreasedATK_k__BackingField; // 0x2C
