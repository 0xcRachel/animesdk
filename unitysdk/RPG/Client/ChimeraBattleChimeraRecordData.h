...
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x8EF2F20)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_GET_ATK_OFFSET UNITYSDK_OFFSET(0x8EF2E80)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_GET_CHIMERAID_OFFSET UNITYSDK_OFFSET(0x8EF2DC0)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_GET_DECREASEDATK_OFFSET UNITYSDK_OFFSET(0x8EF2F00)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_GET_DECREASEDHP_OFFSET UNITYSDK_OFFSET(0x8EF2EC0)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_GET_HP_OFFSET UNITYSDK_OFFSET(0x8EF2E60)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_GET_INCREASEDATK_OFFSET UNITYSDK_OFFSET(0x8EF2EE0)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_GET_INCREASEDHP_OFFSET UNITYSDK_OFFSET(0x8EF2EA0)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_GET_ISALIVE_OFFSET UNITYSDK_OFFSET(0x8EF2DE0)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_GET_TEAMINDEX_OFFSET UNITYSDK_OFFSET(0x8EF2DF0)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_SET_ATK_OFFSET UNITYSDK_OFFSET(0x8EF2E90)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_SET_CHIMERAID_OFFSET UNITYSDK_OFFSET(0x8EF2DD0)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_SET_DECREASEDATK_OFFSET UNITYSDK_OFFSET(0x8EF2F10)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_SET_DECREASEDHP_OFFSET UNITYSDK_OFFSET(0x8EF2ED0)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_SET_HP_OFFSET UNITYSDK_OFFSET(0x8EF2E70)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_SET_INCREASEDATK_OFFSET UNITYSDK_OFFSET(0x8EF2EF0)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_SET_INCREASEDHP_OFFSET UNITYSDK_OFFSET(0x8EF2EB0)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_SET_TEAMINDEX_OFFSET UNITYSDK_OFFSET(0x8EF2E00)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_UPDATE_OFFSET UNITYSDK_OFFSET(0x8EF30D0)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8EF30C0)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraBattleChimeraRecordData_TypeDefinitionIndex = 50384;

	class ChimeraBattleChimeraRecordData : public ::System::Object
	{
	public:
		::System::Int32 _DecreasedHP_k__BackingField; // 0x10
		::System::Int32 _IncreasedATK_k__BackingField; // 0x14
		::System::Int32 _TeamIndex; // 0x18
		::System::Int32 _IncreasedHP_k__BackingField; // 0x1C
