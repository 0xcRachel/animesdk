...
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x9396860)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_GET_ATK_OFFSET UNITYSDK_OFFSET(0x93967C0)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_GET_CHIMERAID_OFFSET UNITYSDK_OFFSET(0x9396700)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_GET_DECREASEDATK_OFFSET UNITYSDK_OFFSET(0x9396840)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_GET_DECREASEDHP_OFFSET UNITYSDK_OFFSET(0x9396800)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_GET_HP_OFFSET UNITYSDK_OFFSET(0x93967A0)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_GET_INCREASEDATK_OFFSET UNITYSDK_OFFSET(0x9396820)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_GET_INCREASEDHP_OFFSET UNITYSDK_OFFSET(0x93967E0)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_GET_ISALIVE_OFFSET UNITYSDK_OFFSET(0x9396720)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_GET_TEAMINDEX_OFFSET UNITYSDK_OFFSET(0x9396730)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_SET_ATK_OFFSET UNITYSDK_OFFSET(0x93967D0)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_SET_CHIMERAID_OFFSET UNITYSDK_OFFSET(0x9396710)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_SET_DECREASEDATK_OFFSET UNITYSDK_OFFSET(0x9396850)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_SET_DECREASEDHP_OFFSET UNITYSDK_OFFSET(0x9396810)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_SET_HP_OFFSET UNITYSDK_OFFSET(0x93967B0)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_SET_INCREASEDATK_OFFSET UNITYSDK_OFFSET(0x9396830)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_SET_INCREASEDHP_OFFSET UNITYSDK_OFFSET(0x93967F0)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_SET_TEAMINDEX_OFFSET UNITYSDK_OFFSET(0x9396740)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA_UPDATE_OFFSET UNITYSDK_OFFSET(0x9396A00)
#define RPG_CLIENT_CHIMERABATTLECHIMERARECORDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x93969F0)
