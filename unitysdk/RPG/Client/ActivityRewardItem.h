...
#define RPG_CLIENT_ACTIVITYREWARDITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x8BB7D10)

namespace RPG::Client
{
	inline static constexpr unsigned int ActivityRewardItem_TypeDefinitionIndex = 48922;
