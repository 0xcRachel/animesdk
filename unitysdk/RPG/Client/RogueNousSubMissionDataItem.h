...
#define RPG_CLIENT_ROGUENOUSSUBMISSIONDATAITEM_ADDNEXTSUBSTORY_OFFSET UNITYSDK_OFFSET(0x1635D140)
#define RPG_CLIENT_ROGUENOUSSUBMISSIONDATAITEM_GETAREAREQUIREMENTTEXT_OFFSET UNITYSDK_OFFSET(0x1635DEA0)
#define RPG_CLIENT_ROGUENOUSSUBMISSIONDATAITEM_GETTRIGGERCONDITIONTEXT_OFFSET UNITYSDK_OFFSET(0x1635D9B0)
#define RPG_CLIENT_ROGUENOUSSUBMISSIONDATAITEM_GET_ISFIRSTLAYER_OFFSET UNITYSDK_OFFSET(0x1635D1D0)
#define RPG_CLIENT_ROGUENOUSSUBMISSIONDATAITEM_GET_ISLASTLAYER_OFFSET UNITYSDK_OFFSET(0x1635E450)
#define RPG_CLIENT_ROGUENOUSSUBMISSIONDATAITEM_GET_ISNEW_OFFSET UNITYSDK_OFFSET(0x1635E4D0)
#define RPG_CLIENT_ROGUENOUSSUBMISSIONDATAITEM_GET_ISUNLOCKEDWITHALLNEXT_OFFSET UNITYSDK_OFFSET(0x1635E430)
#define RPG_CLIENT_ROGUENOUSSUBMISSIONDATAITEM_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0x1635E230)
#define RPG_CLIENT_ROGUENOUSSUBMISSIONDATAITEM_GET_LAYER_OFFSET UNITYSDK_OFFSET(0x1635E0D0)
#define RPG_CLIENT_ROGUENOUSSUBMISSIONDATAITEM_GET_LEVELGRAPHPATH_OFFSET UNITYSDK_OFFSET(0x1635D8B0)
#define RPG_CLIENT_ROGUENOUSSUBMISSIONDATAITEM_GET_MAXNOUSVALUE_OFFSET UNITYSDK_OFFSET(0x1635DE50)
#define RPG_CLIENT_ROGUENOUSSUBMISSIONDATAITEM_GET_MINDIFFICULTYREQUIREMENT_OFFSET UNITYSDK_OFFSET(0x1635E4F0)
#define RPG_CLIENT_ROGUENOUSSUBMISSIONDATAITEM_GET_MINNOUSVALUE_OFFSET UNITYSDK_OFFSET(0x1635DE00)
#define RPG_CLIENT_ROGUENOUSSUBMISSIONDATAITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1635E120)
#define RPG_CLIENT_ROGUENOUSSUBMISSIONDATAITEM_GET_NEXTLAYERIDARRAY_OFFSET UNITYSDK_OFFSET(0x1635D050)
#define RPG_CLIENT_ROGUENOUSSUBMISSIONDATAITEM_GET_NEXTSUBSTORIES_OFFSET UNITYSDK_OFFSET(0x1635E4C0)
#define RPG_CLIENT_ROGUENOUSSUBMISSIONDATAITEM_GET_PRELAYERID_OFFSET UNITYSDK_OFFSET(0x1635E080)
#define RPG_CLIENT_ROGUENOUSSUBMISSIONDATAITEM_GET_PREVSUBSTORY_OFFSET UNITYSDK_OFFSET(0x1635E4B0)
#define RPG_CLIENT_ROGUENOUSSUBMISSIONDATAITEM_GET_QUESTID_OFFSET UNITYSDK_OFFSET(0x1635E1E0)
#define RPG_CLIENT_ROGUENOUSSUBMISSIONDATAITEM_GET_QUESTSTATUS_OFFSET UNITYSDK_OFFSET(0x1635E250)
#define RPG_CLIENT_ROGUENOUSSUBMISSIONDATAITEM_GET_REWARDID_OFFSET UNITYSDK_OFFSET(0x1635E360)
#define RPG_CLIENT_ROGUENOUSSUBMISSIONDATAITEM_GET_SUBSTORYID_OFFSET UNITYSDK_OFFSET(0x1635E070)
#define RPG_CLIENT_ROGUENOUSSUBMISSIONDATAITEM_REFRESHUNLOCKWITHALLNEXTTOCHILD_OFFSET UNITYSDK_OFFSET(0x1635D1E0)
#define RPG_CLIENT_ROGUENOUSSUBMISSIONDATAITEM_REPLAY_OFFSET UNITYSDK_OFFSET(0x1635D730)
#define RPG_CLIENT_ROGUENOUSSUBMISSIONDATAITEM_SETPREVSUBSTORY_OFFSET UNITYSDK_OFFSET(0x1635D0F0)
#define RPG_CLIENT_ROGUENOUSSUBMISSIONDATAITEM_SET_ISNEW_OFFSET UNITYSDK_OFFSET(0x1635E4E0)
#define RPG_CLIENT_ROGUENOUSSUBMISSIONDATAITEM_SET_ISUNLOCKEDWITHALLNEXT_OFFSET UNITYSDK_OFFSET(0x1635E440)
#define RPG_CLIENT_ROGUENOUSSUBMISSIONDATAITEM_SET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0x1635E240)
#define RPG_CLIENT_ROGUENOUSSUBMISSIONDATAITEM_SYNC_OFFSET UNITYSDK_OFFSET(0x1635C970)
#define RPG_CLIENT_ROGUENOUSSUBMISSIONDATAITEM_UPDATEREDDOTSTATE_OFFSET UNITYSDK_OFFSET(0x1635DF90)
#define RPG_CLIENT_ROGUENOUSSUBMISSIONDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1635D0B0)
#define RPG_CLIENT_ROGUENOUSSUBMISSIONDATAITEM__REFRESHUNLOCKWITHALLNEXTTOROOT_OFFSET UNITYSDK_OFFSET(0x1635D910)
