...
#define RPG_CLIENT_MONOUIMATERIALTEXTURELOADER_AWAKE_OFFSET UNITYSDK_OFFSET(0x9876FE0)
#define RPG_CLIENT_MONOUIMATERIALTEXTURELOADER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9877120)
#define RPG_CLIENT_MONOUIMATERIALTEXTURELOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x9877290)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoUIMaterialTextureLoader_TypeDefinitionIndex = 54780;
