...
#define RPG_CLIENT_PROPSELECTIONMATERIALCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9D1F9C0)

namespace RPG::Client
{
	inline static constexpr unsigned int PropSelectionMaterialConfig_TypeDefinitionIndex = 47714;
