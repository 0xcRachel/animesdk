...
#define RPG_CLIENT_TAROTBOOKMAILMANAGER___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xA039DC0)
#define RPG_CLIENT_TAROTBOOKMAILMANAGER___C__CTOR_OFFSET UNITYSDK_OFFSET(0xA039E00)
#define RPG_CLIENT_TAROTBOOKMAILMANAGER___C__MARKSEENANDGETALLDATA_B__9_0_OFFSET UNITYSDK_OFFSET(0xA039E10)

namespace RPG::Client
{
	inline static constexpr unsigned int TarotBookMailManager___c_TypeDefinitionIndex = 53987;
	...
	public:
		...
		{
			return (::System::Comparison_1<::RPG::Client::TarotMailData*>**)Il2CppClass::FromTypeDefinitionIndex(TarotBookMailManager___c_TypeDefinitionIndex)->GetStaticField(0x243A0);
		}
		static ::RPG::Client::TarotBookMailManager___c** StaticGet___9()
		{
			return (::RPG::Client::TarotBookMailManager___c**)Il2CppClass::FromTypeDefinitionIndex(TarotBookMailManager___c_TypeDefinitionIndex)->GetStaticField(0x243A8);
		}
