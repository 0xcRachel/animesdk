...
#define RPG_CLIENT_ROOTMOTIONBAKER__CTOR_OFFSET UNITYSDK_OFFSET(0x9F39460)

namespace RPG::Client
{
	inline static constexpr unsigned int RootMotionBaker_TypeDefinitionIndex = 54654;
