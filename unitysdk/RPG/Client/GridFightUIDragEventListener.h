...
#define RPG_CLIENT_GRIDFIGHTUIDRAGEVENTLISTENER_METHOD_5_691A1C2F360A8C86_OFFSET UNITYSDK_OFFSET(0x946A8A0)
#define RPG_CLIENT_GRIDFIGHTUIDRAGEVENTLISTENER_METHOD_5_B7C6DAE40A066421_OFFSET UNITYSDK_OFFSET(0x946A5E0)
#define RPG_CLIENT_GRIDFIGHTUIDRAGEVENTLISTENER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x946AB60)
#define RPG_CLIENT_GRIDFIGHTUIDRAGEVENTLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x946AC10)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightUIDragEventListener_TypeDefinitionIndex = 58226;
