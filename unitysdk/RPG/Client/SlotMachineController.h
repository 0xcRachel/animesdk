...
#define RPG_CLIENT_SLOTMACHINECONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x17C0FC50)
#define RPG_CLIENT_SLOTMACHINECONTROLLER_SETTARGETNUMIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0x17C0FCD0)
#define RPG_CLIENT_SLOTMACHINECONTROLLER_SETTARGETNUM_OFFSET UNITYSDK_OFFSET(0x17C0FD30)
#define RPG_CLIENT_SLOTMACHINECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17C0FE10)
#define RPG_CLIENT_SLOTMACHINECONTROLLER__RESETNUM_OFFSET UNITYSDK_OFFSET(0x17C0FDC0)
