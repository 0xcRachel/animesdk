...
#define RPG_CLIENT_MONOEFFECTPLUGINVIEWMODECONTROL_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0x980D550)
#define RPG_CLIENT_MONOEFFECTPLUGINVIEWMODECONTROL_MANUALLYINVOKE_OFFSET UNITYSDK_OFFSET(0x980D600)
#define RPG_CLIENT_MONOEFFECTPLUGINVIEWMODECONTROL_METHOD_6_352B61CD747EF90A_1_OFFSET UNITYSDK_OFFSET(0x980D840)
#define RPG_CLIENT_MONOEFFECTPLUGINVIEWMODECONTROL_METHOD_6_352B61CD747EF90A_OFFSET UNITYSDK_OFFSET(0x980D7E0)
#define RPG_CLIENT_MONOEFFECTPLUGINVIEWMODECONTROL_METHOD_6_D78B51BFDA4B8B32_OFFSET UNITYSDK_OFFSET(0x980D8A0)
#define RPG_CLIENT_MONOEFFECTPLUGINVIEWMODECONTROL_METHOD_6_FF9358EE342FB1E1_OFFSET UNITYSDK_OFFSET(0x980D650)
#define RPG_CLIENT_MONOEFFECTPLUGINVIEWMODECONTROL_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0x980D4A0)
#define RPG_CLIENT_MONOEFFECTPLUGINVIEWMODECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x980DAD0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginViewModeControl_TypeDefinitionIndex = 55727;
