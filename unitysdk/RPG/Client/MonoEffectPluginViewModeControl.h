...
#define RPG_CLIENT_MONOEFFECTPLUGINVIEWMODECONTROL_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0x116755E0)
#define RPG_CLIENT_MONOEFFECTPLUGINVIEWMODECONTROL_MANUALLYINVOKE_OFFSET UNITYSDK_OFFSET(0x116756C0)
#define RPG_CLIENT_MONOEFFECTPLUGINVIEWMODECONTROL_METHOD_6_352B61CD747EF90A_1_OFFSET UNITYSDK_OFFSET(0x11675900)
#define RPG_CLIENT_MONOEFFECTPLUGINVIEWMODECONTROL_METHOD_6_352B61CD747EF90A_OFFSET UNITYSDK_OFFSET(0x116758A0)
#define RPG_CLIENT_MONOEFFECTPLUGINVIEWMODECONTROL_METHOD_6_D78B51BFDA4B8B32_OFFSET UNITYSDK_OFFSET(0x11675960)
#define RPG_CLIENT_MONOEFFECTPLUGINVIEWMODECONTROL_METHOD_6_FF9358EE342FB1E1_OFFSET UNITYSDK_OFFSET(0x11675710)
#define RPG_CLIENT_MONOEFFECTPLUGINVIEWMODECONTROL_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0x11675500)
#define RPG_CLIENT_MONOEFFECTPLUGINVIEWMODECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x11675B90)
