...
#define RPG_CLIENT_MONOEFFECTPLUGINVIEWMODECONTROL_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CEFB80)
#define RPG_CLIENT_MONOEFFECTPLUGINVIEWMODECONTROL_MANUALLYINVOKE_OFFSET UNITYSDK_OFFSET(0x9CEFC60)
#define RPG_CLIENT_MONOEFFECTPLUGINVIEWMODECONTROL_METHOD_6_352B61CD747EF90A_1_OFFSET UNITYSDK_OFFSET(0x9CEFEA0)
#define RPG_CLIENT_MONOEFFECTPLUGINVIEWMODECONTROL_METHOD_6_352B61CD747EF90A_OFFSET UNITYSDK_OFFSET(0x9CEFE40)
#define RPG_CLIENT_MONOEFFECTPLUGINVIEWMODECONTROL_METHOD_6_D78B51BFDA4B8B32_OFFSET UNITYSDK_OFFSET(0x9CEFF00)
#define RPG_CLIENT_MONOEFFECTPLUGINVIEWMODECONTROL_METHOD_6_FF9358EE342FB1E1_OFFSET UNITYSDK_OFFSET(0x9CEFCB0)
#define RPG_CLIENT_MONOEFFECTPLUGINVIEWMODECONTROL_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CEFAA0)
#define RPG_CLIENT_MONOEFFECTPLUGINVIEWMODECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x9CF0130)
