...
#define RPG_CLIENT_SIGNALCURVEPOOLMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x9F76490)

namespace RPG::Client
{
	inline static constexpr unsigned int SignalCurvePoolMonoPlugin_TypeDefinitionIndex = 56542;
