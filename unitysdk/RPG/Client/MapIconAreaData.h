...
#define RPG_CLIENT_MAPICONAREADATA_CLEAR_OFFSET UNITYSDK_OFFSET(0x158D0A80)
#define RPG_CLIENT_MAPICONAREADATA__CTOR_OFFSET UNITYSDK_OFFSET(0x158D0A60)
...
namespace RPG::Client
{
	...
	{
	public:
		::RPG::GameCore::MinimapAreaType MapAreaType; // 0x10
		::System::Int32 AreaID; // 0x14
