...
#define RPG_CLIENT_PARKOURSETCOUNTDOWNANIMSPEED_METHOD_3_AD749595B9849A2E_OFFSET UNITYSDK_OFFSET(0x19879770)
#define RPG_CLIENT_PARKOURSETCOUNTDOWNANIMSPEED_METHOD_3_F2371ACD59D5E15F_OFFSET UNITYSDK_OFFSET(0x198797F0)
#define RPG_CLIENT_PARKOURSETCOUNTDOWNANIMSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x198797C0)
