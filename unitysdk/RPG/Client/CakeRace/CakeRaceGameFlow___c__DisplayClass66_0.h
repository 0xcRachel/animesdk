...
#define RPG_CLIENT_CAKERACE_CAKERACEGAMEFLOW___C__DISPLAYCLASS66_0__CTOR_OFFSET UNITYSDK_OFFSET(0x8E22FC0)
#define RPG_CLIENT_CAKERACE_CAKERACEGAMEFLOW___C__DISPLAYCLASS66_0___HANDLESHOWINVITEFRIEND_B__0_OFFSET UNITYSDK_OFFSET(0x8E244A0)

namespace RPG::Client::CakeRace
{
	inline static constexpr unsigned int CakeRaceGameFlow___c__DisplayClass66_0_TypeDefinitionIndex = 60242;
