...
#define RPG_CLIENT_SIMPRTXGROUP_METHOD_1_19B91D58E02869BC_OFFSET UNITYSDK_OFFSET(0x9F7D4F0)
#define RPG_CLIENT_SIMPRTXGROUP_METHOD_1_9DBC9E6BCD10AD9A_OFFSET UNITYSDK_OFFSET(0x9F7D380)
#define RPG_CLIENT_SIMPRTXGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x9F7D690)

namespace RPG::Client
{
	inline static constexpr unsigned int SimpRTXGroup_TypeDefinitionIndex = 55884;
