...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACERIM_INIT_OFFSET UNITYSDK_OFFSET(0x97E1900)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACERIM_UNINIT_OFFSET UNITYSDK_OFFSET(0x97E1CA0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACERIM_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x97E19A0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACERIM__CTOR_OFFSET UNITYSDK_OFFSET(0x97E1D40)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACERIM___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x97E1D60)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACERIM___IFIXBASEPROXY_UNINIT_OFFSET UNITYSDK_OFFSET(0x97E1D70)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropFaceRim_TypeDefinitionIndex = 55673;
