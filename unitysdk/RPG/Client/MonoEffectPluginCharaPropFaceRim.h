...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACERIM_INIT_OFFSET UNITYSDK_OFFSET(0x9CC3340)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACERIM_UNINIT_OFFSET UNITYSDK_OFFSET(0x9CC36E0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACERIM_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x9CC33E0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACERIM__CTOR_OFFSET UNITYSDK_OFFSET(0x9CC3780)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACERIM___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x9CC37A0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACERIM___IFIXBASEPROXY_UNINIT_OFFSET UNITYSDK_OFFSET(0x9CC37B0)
