...
#define RPG_CLIENT_PHOTOGRAPHDECALCONTAINER_PHOTOGRAPHDECALCONTAINERINITPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x146DF0B0)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Single DecalScale; // 0x20
		::System::Single MaxDepthTestVariance; // 0x24
		::System::Single DepthBufferSampleRadiusRatio; // 0x28
		::System::Single PreviewDecalCD; // 0x2C
		::System::Single MaxRaycastLength; // 0x30
		::System::Single FadeOutAnimeSpeed; // 0x34
		::System::Int32 MaxDecalCount; // 0x38
		::System::Single MaxDepthVariance; // 0x3C
