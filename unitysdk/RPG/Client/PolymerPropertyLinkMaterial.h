...
#define RPG_CLIENT_POLYMERPROPERTYLINKMATERIAL_METHOD_2_06DA6E0DDE64BF55_OFFSET UNITYSDK_OFFSET(0x9B2D660)
#define RPG_CLIENT_POLYMERPROPERTYLINKMATERIAL_METHOD_2_17BD30EFE8176014_OFFSET UNITYSDK_OFFSET(0x9B2ACB0)
#define RPG_CLIENT_POLYMERPROPERTYLINKMATERIAL_METHOD_2_1E13A8A5C0FF7D62_OFFSET UNITYSDK_OFFSET(0x9B2D2F0)
#define RPG_CLIENT_POLYMERPROPERTYLINKMATERIAL_METHOD_2_8E12E04EC393F9E8_OFFSET UNITYSDK_OFFSET(0x9B2D650)
#define RPG_CLIENT_POLYMERPROPERTYLINKMATERIAL_METHOD_2_C4A12E8170668C9E_OFFSET UNITYSDK_OFFSET(0x9B2AB30)
#define RPG_CLIENT_POLYMERPROPERTYLINKMATERIAL_METHOD_2_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x9B2D5D0)
#define RPG_CLIENT_POLYMERPROPERTYLINKMATERIAL_METHOD_2_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x9B2D610)
#define RPG_CLIENT_POLYMERPROPERTYLINKMATERIAL_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x9B2D590)
#define RPG_CLIENT_POLYMERPROPERTYLINKMATERIAL_METHOD_2_DB67EEFB041425EC_OFFSET UNITYSDK_OFFSET(0x9B2AEC0)
#define RPG_CLIENT_POLYMERPROPERTYLINKMATERIAL_METHOD_2_F3F81422062393C9_OFFSET UNITYSDK_OFFSET(0x9B2A860)
#define RPG_CLIENT_POLYMERPROPERTYLINKMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x9B2D290)

namespace RPG::Client
{
	inline static constexpr unsigned int PolymerPropertyLinkMaterial_TypeDefinitionIndex = 55982;
