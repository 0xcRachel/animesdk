...
#define RPG_CLIENT_POLYMERPROPERTYLINKMATERIAL_METHOD_2_06DA6E0DDE64BF55_OFFSET UNITYSDK_OFFSET(0x9FFEF20)
#define RPG_CLIENT_POLYMERPROPERTYLINKMATERIAL_METHOD_2_17BD30EFE8176014_OFFSET UNITYSDK_OFFSET(0x9FFC570)
#define RPG_CLIENT_POLYMERPROPERTYLINKMATERIAL_METHOD_2_1E13A8A5C0FF7D62_OFFSET UNITYSDK_OFFSET(0x9FFEBB0)
#define RPG_CLIENT_POLYMERPROPERTYLINKMATERIAL_METHOD_2_8E12E04EC393F9E8_OFFSET UNITYSDK_OFFSET(0x9FFEF10)
#define RPG_CLIENT_POLYMERPROPERTYLINKMATERIAL_METHOD_2_C4A12E8170668C9E_OFFSET UNITYSDK_OFFSET(0x9FFC3F0)
#define RPG_CLIENT_POLYMERPROPERTYLINKMATERIAL_METHOD_2_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x9FFEE90)
#define RPG_CLIENT_POLYMERPROPERTYLINKMATERIAL_METHOD_2_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x9FFEED0)
#define RPG_CLIENT_POLYMERPROPERTYLINKMATERIAL_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x9FFEE50)
#define RPG_CLIENT_POLYMERPROPERTYLINKMATERIAL_METHOD_2_DB67EEFB041425EC_OFFSET UNITYSDK_OFFSET(0x9FFC780)
#define RPG_CLIENT_POLYMERPROPERTYLINKMATERIAL_METHOD_2_F3F81422062393C9_OFFSET UNITYSDK_OFFSET(0x9FFC120)
#define RPG_CLIENT_POLYMERPROPERTYLINKMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x9FFEB50)
