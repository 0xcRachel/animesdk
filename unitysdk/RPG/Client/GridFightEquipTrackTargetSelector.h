...
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKTARGETSELECTOR_GETSELECTORTARGET_OFFSET UNITYSDK_OFFSET(0x9356920)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKTARGETSELECTOR__COMPAREROLE_OFFSET UNITYSDK_OFFSET(0x9360B90)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKTARGETSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x9357780)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightEquipTrackTargetSelector_TypeDefinitionIndex = 51936;
