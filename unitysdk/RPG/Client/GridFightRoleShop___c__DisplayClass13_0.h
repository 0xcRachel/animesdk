...
#define RPG_CLIENT_GRIDFIGHTROLESHOP___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x93E6F10)
#define RPG_CLIENT_GRIDFIGHTROLESHOP___C__DISPLAYCLASS13_0__TRYBUYROLE_B__0_OFFSET UNITYSDK_OFFSET(0x93EA120)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightRoleShop___c__DisplayClass13_0_TypeDefinitionIndex = 51836;
