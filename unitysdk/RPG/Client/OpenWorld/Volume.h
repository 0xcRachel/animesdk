...
#define RPG_CLIENT_OPENWORLD_VOLUME_FROMSTAGECONFIG_1_OFFSET UNITYSDK_OFFSET(0x9EBD340)
#define RPG_CLIENT_OPENWORLD_VOLUME_FROMSTAGECONFIG_OFFSET UNITYSDK_OFFSET(0x9EBC580)
#define RPG_CLIENT_OPENWORLD_VOLUME_GET_ATTACHREGIONVOLUMEINDEX_OFFSET UNITYSDK_OFFSET(0x9EBE210)
#define RPG_CLIENT_OPENWORLD_VOLUME_GET_ATTACHREGION_OFFSET UNITYSDK_OFFSET(0x9EBE1F0)
#define RPG_CLIENT_OPENWORLD_VOLUME_METHOD_6_0C452A919F54661B_OFFSET UNITYSDK_OFFSET(0x9EBCFF0)
#define RPG_CLIENT_OPENWORLD_VOLUME_METHOD_6_553318531FFFA4F6_OFFSET UNITYSDK_OFFSET(0x9EBCB00)
#define RPG_CLIENT_OPENWORLD_VOLUME_METHOD_6_5E024B5F1C148C13_OFFSET UNITYSDK_OFFSET(0x9EBCF00)
#define RPG_CLIENT_OPENWORLD_VOLUME_METHOD_6_8C3DB70FFBBF01C7_OFFSET UNITYSDK_OFFSET(0x9EBD940)
#define RPG_CLIENT_OPENWORLD_VOLUME_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9EBD860)
#define RPG_CLIENT_OPENWORLD_VOLUME_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x9EBD7E0)
#define RPG_CLIENT_OPENWORLD_VOLUME_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9EBD750)
#define RPG_CLIENT_OPENWORLD_VOLUME_SET_ATTACHREGIONVOLUMEINDEX_OFFSET UNITYSDK_OFFSET(0x9EBE220)
#define RPG_CLIENT_OPENWORLD_VOLUME_SET_ATTACHREGION_OFFSET UNITYSDK_OFFSET(0x9EBE200)
#define RPG_CLIENT_OPENWORLD_VOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x9EBE230)

namespace RPG::Client::OpenWorld
{
	inline static constexpr unsigned int Volume_TypeDefinitionIndex = 60652;
