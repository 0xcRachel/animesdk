...
#define RPG_CLIENT_OPENWORLD_VOLUME_FROMSTAGECONFIG_1_OFFSET UNITYSDK_OFFSET(0x162AA630)
#define RPG_CLIENT_OPENWORLD_VOLUME_FROMSTAGECONFIG_OFFSET UNITYSDK_OFFSET(0x162A9860)
#define RPG_CLIENT_OPENWORLD_VOLUME_GET_ATTACHREGIONVOLUMEINDEX_OFFSET UNITYSDK_OFFSET(0x162AB550)
#define RPG_CLIENT_OPENWORLD_VOLUME_GET_ATTACHREGION_OFFSET UNITYSDK_OFFSET(0x162AB530)
#define RPG_CLIENT_OPENWORLD_VOLUME_GET_OWNERSTAGE_OFFSET UNITYSDK_OFFSET(0x162AB510)
#define RPG_CLIENT_OPENWORLD_VOLUME_METHOD_6_0C452A919F54661B_OFFSET UNITYSDK_OFFSET(0x162AA2D0)
#define RPG_CLIENT_OPENWORLD_VOLUME_METHOD_6_553318531FFFA4F6_OFFSET UNITYSDK_OFFSET(0x162A9DE0)
#define RPG_CLIENT_OPENWORLD_VOLUME_METHOD_6_5E024B5F1C148C13_OFFSET UNITYSDK_OFFSET(0x162AA1E0)
#define RPG_CLIENT_OPENWORLD_VOLUME_METHOD_6_61EC2AC0BD93363E_OFFSET UNITYSDK_OFFSET(0x162AAC30)
#define RPG_CLIENT_OPENWORLD_VOLUME_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x162AAB50)
#define RPG_CLIENT_OPENWORLD_VOLUME_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x162AAAD0)
#define RPG_CLIENT_OPENWORLD_VOLUME_ONENABLE_OFFSET UNITYSDK_OFFSET(0x162AAA40)
#define RPG_CLIENT_OPENWORLD_VOLUME_SET_ATTACHREGIONVOLUMEINDEX_OFFSET UNITYSDK_OFFSET(0x162AB560)
#define RPG_CLIENT_OPENWORLD_VOLUME_SET_ATTACHREGION_OFFSET UNITYSDK_OFFSET(0x162AB540)
#define RPG_CLIENT_OPENWORLD_VOLUME_SET_OWNERSTAGE_OFFSET UNITYSDK_OFFSET(0x162AB520)
#define RPG_CLIENT_OPENWORLD_VOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x162AB570)

namespace RPG::Client::OpenWorld
{
	inline static constexpr unsigned int Volume_TypeDefinitionIndex = 68093;
