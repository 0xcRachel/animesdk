...
{
	inline static constexpr unsigned int VolumeComponentTransition_1_TypeDefinitionIndex = 58949;

	template <typename T>
	class VolumeComponentTransition_1 : public ::Class_1_43BD383C98B4C0C5_162
	{
	public:
		T _Last; // 0x0
		T _Target; // 0x0
