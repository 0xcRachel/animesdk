...
#define RPG_CLIENT_OPENWORLD_STREAMINGLAYERSETTING_METHOD_3_22BD8D72769270B8_OFFSET UNITYSDK_OFFSET(0x9A1C0F0)
#define RPG_CLIENT_OPENWORLD_STREAMINGLAYERSETTING_METHOD_3_3D21ABACCE7E1D6F_OFFSET UNITYSDK_OFFSET(0x9A1C230)
#define RPG_CLIENT_OPENWORLD_STREAMINGLAYERSETTING_METHOD_3_C01E7BA2861FC0AA_OFFSET UNITYSDK_OFFSET(0x9A1C3D0)
#define RPG_CLIENT_OPENWORLD_STREAMINGLAYERSETTING_METHOD_3_E9A11033FF6FC2DF_OFFSET UNITYSDK_OFFSET(0x9A1C560)
#define RPG_CLIENT_OPENWORLD_STREAMINGLAYERSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x9A1C610)

namespace RPG::Client::OpenWorld
{
	inline static constexpr unsigned int StreamingLayerSetting_TypeDefinitionIndex = 58732;
