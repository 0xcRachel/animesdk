...
#define RPG_CLIENT_OPENWORLD_STREAMINGLAYERSETTING_METHOD_3_22BD8D72769270B8_OFFSET UNITYSDK_OFFSET(0x9EBB760)
#define RPG_CLIENT_OPENWORLD_STREAMINGLAYERSETTING_METHOD_3_3D21ABACCE7E1D6F_OFFSET UNITYSDK_OFFSET(0x9EBB8A0)
#define RPG_CLIENT_OPENWORLD_STREAMINGLAYERSETTING_METHOD_3_C01E7BA2861FC0AA_OFFSET UNITYSDK_OFFSET(0x9EBBA40)
#define RPG_CLIENT_OPENWORLD_STREAMINGLAYERSETTING_METHOD_3_E9A11033FF6FC2DF_OFFSET UNITYSDK_OFFSET(0x9EBBBD0)
#define RPG_CLIENT_OPENWORLD_STREAMINGLAYERSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x9EBBC80)

namespace RPG::Client::OpenWorld
{
	inline static constexpr unsigned int StreamingLayerSetting_TypeDefinitionIndex = 60475;
