...
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLSUBDATA_METHOD_1_5BDCCAF28C3D308E_OFFSET UNITYSDK_OFFSET(0x9EAF860)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLSUBDATA_METHOD_1_A49AB36D595249BF_OFFSET UNITYSDK_OFFSET(0x9EB00B0)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLSUBDATA_METHOD_1_A67EAA4D4BE9011F_OFFSET UNITYSDK_OFFSET(0x9EAF730)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLSUBDATA_METHOD_1_A770233E6C6576B2_OFFSET UNITYSDK_OFFSET(0x9EAF4E0)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLSUBDATA_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x9EB0120)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLSUBDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9EAF440)

namespace RPG::Client::OpenWorld
{
	inline static constexpr unsigned int OfflineCullingCellSubData_TypeDefinitionIndex = 60468;
