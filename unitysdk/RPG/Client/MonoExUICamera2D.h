...
#define RPG_CLIENT_MONOEXUICAMERA2D_INITCANVASRANGE_OFFSET UNITYSDK_OFFSET(0x9D0B440)
#define RPG_CLIENT_MONOEXUICAMERA2D_INIT_OFFSET UNITYSDK_OFFSET(0x9D0A6B0)
#define RPG_CLIENT_MONOEXUICAMERA2D_MANUALUPDATE_OFFSET UNITYSDK_OFFSET(0x9D0AAB0)
#define RPG_CLIENT_MONOEXUICAMERA2D_SETENABLEMOVE_OFFSET UNITYSDK_OFFSET(0x9D0A860)
#define RPG_CLIENT_MONOEXUICAMERA2D_SETENABLEZOOM_OFFSET UNITYSDK_OFFSET(0x9D0A8D0)
#define RPG_CLIENT_MONOEXUICAMERA2D_SETLOCKPOSITIONANDZOOM_OFFSET UNITYSDK_OFFSET(0x9D0A940)
#define RPG_CLIENT_MONOEXUICAMERA2D__CONVERTSCALEFROMPOSZ_OFFSET UNITYSDK_OFFSET(0x9D0B490)
#define RPG_CLIENT_MONOEXUICAMERA2D__CTOR_OFFSET UNITYSDK_OFFSET(0x9D0B570)
#define RPG_CLIENT_MONOEXUICAMERA2D__INITEXUICAMERA_OFFSET UNITYSDK_OFFSET(0x9D0A700)
#define RPG_CLIENT_MONOEXUICAMERA2D__UPDATECONTENTRECT_OFFSET UNITYSDK_OFFSET(0x9D0AED0)
#define RPG_CLIENT_MONOEXUICAMERA2D__UPDATECONTENTZOOM_OFFSET UNITYSDK_OFFSET(0x9D0B1B0)
#define RPG_CLIENT_MONOEXUICAMERA2D__UPDATEPARAM_OFFSET UNITYSDK_OFFSET(0x9D0ABA0)
#define RPG_CLIENT_MONOEXUICAMERA2D__UPDATEPOSITION_OFFSET UNITYSDK_OFFSET(0x9D0AC80)
#define RPG_CLIENT_MONOEXUICAMERA2D__UPDATESWIPESPEEDRATIO_OFFSET UNITYSDK_OFFSET(0x9D0B250)
#define RPG_CLIENT_MONOEXUICAMERA2D__UPDATE_OFFSET UNITYSDK_OFFSET(0x9D0AB30)
#define RPG_CLIENT_MONOEXUICAMERA2D___IFIXBASEPROXY_INITCANVASRANGE_OFFSET UNITYSDK_OFFSET(0x9D0B730)
#define RPG_CLIENT_MONOEXUICAMERA2D___IFIXBASEPROXY__UPDATE_OFFSET UNITYSDK_OFFSET(0x9D0B690)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoExUICamera2D_TypeDefinitionIndex = 59828;
