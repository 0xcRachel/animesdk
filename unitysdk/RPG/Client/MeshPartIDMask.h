...
#define RPG_CLIENT_MESHPARTIDMASK_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x96F3E10)
#define RPG_CLIENT_MESHPARTIDMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x96F3EC0)

namespace RPG::Client
{
	inline static constexpr unsigned int MeshPartIDMask_TypeDefinitionIndex = 55477;
