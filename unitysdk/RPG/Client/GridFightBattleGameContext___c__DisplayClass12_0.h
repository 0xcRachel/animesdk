...
#define RPG_CLIENT_GRIDFIGHTBATTLEGAMECONTEXT___C__DISPLAYCLASS12_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9324D20)
#define RPG_CLIENT_GRIDFIGHTBATTLEGAMECONTEXT___C__DISPLAYCLASS12_0__GETEQUIPBYUID_B__0_OFFSET UNITYSDK_OFFSET(0x9327C10)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightBattleGameContext___c__DisplayClass12_0_TypeDefinitionIndex = 51166;
