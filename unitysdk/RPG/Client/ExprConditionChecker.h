...
#define RPG_CLIENT_EXPRCONDITIONCHECKER_CREATE_OFFSET UNITYSDK_OFFSET(0x18253AB0)
#define RPG_CLIENT_EXPRCONDITIONCHECKER_DOSYNCCHECK_OFFSET UNITYSDK_OFFSET(0x18253CA0)
#define RPG_CLIENT_EXPRCONDITIONCHECKER__CTOR_OFFSET UNITYSDK_OFFSET(0x18253B50)
#define RPG_CLIENT_EXPRCONDITIONCHECKER__PARSEEXPR_OFFSET UNITYSDK_OFFSET(0x18253BA0)
#define RPG_CLIENT_EXPRCONDITIONCHECKER___IFIXBASEPROXY_DOSYNCCHECK_OFFSET UNITYSDK_OFFSET(0x18253D80)
