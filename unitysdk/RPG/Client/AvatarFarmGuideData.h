...
#define RPG_CLIENT_AVATARFARMGUIDEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8CF5890)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarFarmGuideData_TypeDefinitionIndex = 52174;
