...
#define RPG_CLIENT_CHESSROGUEAREAINFO___C__DISPLAYCLASS17_0__CTOR_OFFSET UNITYSDK_OFFSET(0x8ECFC70)
#define RPG_CLIENT_CHESSROGUEAREAINFO___C__DISPLAYCLASS17_0__GETACCESSIBLEAREADATALIST_B__0_OFFSET UNITYSDK_OFFSET(0x8ED0E20)

namespace RPG::Client
{
	inline static constexpr unsigned int ChessRogueAreaInfo___c__DisplayClass17_0_TypeDefinitionIndex = 53288;
