...
#define RPG_CLIENT_LINEGLOWLIGHTMONOPLUGIN_SETTSC_OFFSET UNITYSDK_OFFSET(0x950BD10)
#define RPG_CLIENT_LINEGLOWLIGHTMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x950BD90)

namespace RPG::Client
{
	inline static constexpr unsigned int LineGlowLightMonoPlugin_TypeDefinitionIndex = 56419;
