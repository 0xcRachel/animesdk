...
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL___C__DISPLAYCLASS21_0__CTOR_OFFSET UNITYSDK_OFFSET(0x939D450)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL___C__DISPLAYCLASS21_0___CREATEFORCHALLENGEBATTLE_B__0_OFFSET UNITYSDK_OFFSET(0x939F150)
...
namespace RPG::Client
{
	...
	public:
		...
		::RPG::Client::ChimeraDuelBattlePageViewModel_TeamViewModel* allyTeam; // 0x18
