...
#define RPG_CLIENT_AIRSHIPCAR_AWAKE_OFFSET UNITYSDK_OFFSET(0x8C50030)
#define RPG_CLIENT_AIRSHIPCAR_GET_ACCELTRIGGER_OFFSET UNITYSDK_OFFSET(0x8C4FFF0)
#define RPG_CLIENT_AIRSHIPCAR_GET_AUDIO_OFFSET UNITYSDK_OFFSET(0x8C4FFB0)
#define RPG_CLIENT_AIRSHIPCAR_GET_AVOIDTRIGGER_OFFSET UNITYSDK_OFFSET(0x8C4FFD0)
#define RPG_CLIENT_AIRSHIPCAR_GET_COLLISION_OFFSET UNITYSDK_OFFSET(0x8C50010)
#define RPG_CLIENT_AIRSHIPCAR_METHOD_5_6C3479A4B494BBB2_OFFSET UNITYSDK_OFFSET(0x8C507A0)
#define RPG_CLIENT_AIRSHIPCAR_METHOD_5_DBB33931C8926D5D_OFFSET UNITYSDK_OFFSET(0x8C509F0)
#define RPG_CLIENT_AIRSHIPCAR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x8C50340)
#define RPG_CLIENT_AIRSHIPCAR_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x8C502A0)
#define RPG_CLIENT_AIRSHIPCAR_ONENABLE_OFFSET UNITYSDK_OFFSET(0x8C50200)
#define RPG_CLIENT_AIRSHIPCAR_RELEASEARTMODEL_OFFSET UNITYSDK_OFFSET(0x8C50620)
#define RPG_CLIENT_AIRSHIPCAR_SETTIMESCALE_OFFSET UNITYSDK_OFFSET(0x8C50710)
#define RPG_CLIENT_AIRSHIPCAR_SETUP_OFFSET UNITYSDK_OFFSET(0x8C50430)
#define RPG_CLIENT_AIRSHIPCAR_SET_ACCELTRIGGER_OFFSET UNITYSDK_OFFSET(0x8C50000)
#define RPG_CLIENT_AIRSHIPCAR_SET_AUDIO_OFFSET UNITYSDK_OFFSET(0x8C4FFC0)
#define RPG_CLIENT_AIRSHIPCAR_SET_AVOIDTRIGGER_OFFSET UNITYSDK_OFFSET(0x8C4FFE0)
#define RPG_CLIENT_AIRSHIPCAR_SET_COLLISION_OFFSET UNITYSDK_OFFSET(0x8C50020)
#define RPG_CLIENT_AIRSHIPCAR__CTOR_OFFSET UNITYSDK_OFFSET(0x8C50AB0)
#define RPG_CLIENT_AIRSHIPCAR__SETUP_B__45_0_OFFSET UNITYSDK_OFFSET(0x8C50B00)
#define RPG_CLIENT_AIRSHIPCAR__SETUP_B__45_1_OFFSET UNITYSDK_OFFSET(0x8C50B10)

namespace RPG::Client
{
	inline static constexpr unsigned int AirshipCar_TypeDefinitionIndex = 47345;
