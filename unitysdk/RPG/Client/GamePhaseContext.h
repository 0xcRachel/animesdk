...
#define RPG_CLIENT_GAMEPHASECONTEXT_ENTERLIANJIWANFA_OFFSET UNITYSDK_OFFSET(0x92F7BA0)
#define RPG_CLIENT_GAMEPHASECONTEXT_GET_TIMESINCELEVELLOADED_OFFSET UNITYSDK_OFFSET(0x92F7FF0)
#define RPG_CLIENT_GAMEPHASECONTEXT_ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x92F7970)
#define RPG_CLIENT_GAMEPHASECONTEXT_ONENTERMAP_OFFSET UNITYSDK_OFFSET(0x92F7A90)
#define RPG_CLIENT_GAMEPHASECONTEXT_ONFIRSTENTERMAPFINISH_OFFSET UNITYSDK_OFFSET(0x92F7B00)
#define RPG_CLIENT_GAMEPHASECONTEXT_ONINIT_OFFSET UNITYSDK_OFFSET(0x92F7130)
#define RPG_CLIENT_GAMEPHASECONTEXT_ONTICK_OFFSET UNITYSDK_OFFSET(0x92F78E0)
#define RPG_CLIENT_GAMEPHASECONTEXT_SHOWLEVELTOAST_OFFSET UNITYSDK_OFFSET(0x92F7690)
#define RPG_CLIENT_GAMEPHASECONTEXT__CCTOR_OFFSET UNITYSDK_OFFSET(0x92F8050)
#define RPG_CLIENT_GAMEPHASECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x92F8040)
#define RPG_CLIENT_GAMEPHASECONTEXT__ONPSNLOGOUTHANDLER_OFFSET UNITYSDK_OFFSET(0x92F7E40)
#define RPG_CLIENT_GAMEPHASECONTEXT__ONSETSESSIONHANDLER_OFFSET UNITYSDK_OFFSET(0x92F7DA0)
#define RPG_CLIENT_GAMEPHASECONTEXT__ON_ADVENTURE_PHASE_ENTER_OFFSET UNITYSDK_OFFSET(0x92F7820)
#define RPG_CLIENT_GAMEPHASECONTEXT___IFIXBASEPROXY_ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x92F8140)
#define RPG_CLIENT_GAMEPHASECONTEXT___IFIXBASEPROXY_ONENTERMAP_OFFSET UNITYSDK_OFFSET(0x92F81A0)
#define RPG_CLIENT_GAMEPHASECONTEXT___IFIXBASEPROXY_ONFIRSTENTERMAPFINISH_OFFSET UNITYSDK_OFFSET(0x92F8200)
#define RPG_CLIENT_GAMEPHASECONTEXT___IFIXBASEPROXY_ONINIT_OFFSET UNITYSDK_OFFSET(0x92F8070)
#define RPG_CLIENT_GAMEPHASECONTEXT___IFIXBASEPROXY_ONTICK_OFFSET UNITYSDK_OFFSET(0x92F80D0)

namespace RPG::Client
{
	inline static constexpr unsigned int GamePhaseContext_TypeDefinitionIndex = 48437;
	...
	public:
		...
		{
			return (::RPG::Client::RPGProfilerMarker**)Il2CppClass::FromTypeDefinitionIndex(GamePhaseContext_TypeDefinitionIndex)->GetStaticField(0x43AF0);
		}
