...
#define RPG_CLIENT_REWARDGROUPDISPLAYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9DCF490)

namespace RPG::Client
{
	inline static constexpr unsigned int RewardGroupDisplayData_TypeDefinitionIndex = 52240;
