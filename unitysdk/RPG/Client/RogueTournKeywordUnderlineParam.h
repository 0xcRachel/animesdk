...
#define RPG_CLIENT_ROGUETOURNKEYWORDUNDERLINEPARAM_CREATE_OFFSET UNITYSDK_OFFSET(0x175612F0)
#define RPG_CLIENT_ROGUETOURNKEYWORDUNDERLINEPARAM_EQUALS_OFFSET UNITYSDK_OFFSET(0x17561230)
#define RPG_CLIENT_ROGUETOURNKEYWORDUNDERLINEPARAM_GET_DESC_OFFSET UNITYSDK_OFFSET(0x17561200)
#define RPG_CLIENT_ROGUETOURNKEYWORDUNDERLINEPARAM_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x17561140)
#define RPG_CLIENT_ROGUETOURNKEYWORDUNDERLINEPARAM_GET_KEYWORD_OFFSET UNITYSDK_OFFSET(0x17561220)
#define RPG_CLIENT_ROGUETOURNKEYWORDUNDERLINEPARAM_GET_NAME_OFFSET UNITYSDK_OFFSET(0x175611C0)
#define RPG_CLIENT_ROGUETOURNKEYWORDUNDERLINEPARAM_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x17561130)
#define RPG_CLIENT_ROGUETOURNKEYWORDUNDERLINEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x17561370)
