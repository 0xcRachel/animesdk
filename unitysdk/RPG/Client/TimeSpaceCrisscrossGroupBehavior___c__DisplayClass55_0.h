...
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPBEHAVIOR___C__DISPLAYCLASS55_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1514C110)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPBEHAVIOR___C__DISPLAYCLASS55_0__UPDATETSCSTATE_B__0_OFFSET UNITYSDK_OFFSET(0x1514CBF0)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPBEHAVIOR___C__DISPLAYCLASS55_0__UPDATETSCSTATE_B__1_OFFSET UNITYSDK_OFFSET(0x1514CC20)
