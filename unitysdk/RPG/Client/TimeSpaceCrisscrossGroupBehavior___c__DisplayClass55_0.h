...
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPBEHAVIOR___C__DISPLAYCLASS55_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA5D45F0)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPBEHAVIOR___C__DISPLAYCLASS55_0__UPDATETSCSTATE_B__0_OFFSET UNITYSDK_OFFSET(0xA5D4600)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPBEHAVIOR___C__DISPLAYCLASS55_0__UPDATETSCSTATE_B__1_OFFSET UNITYSDK_OFFSET(0xA5D4630)
