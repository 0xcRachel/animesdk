...
#define RPG_CLIENT_DATA_NAMEID_COMPARETO_1_OFFSET UNITYSDK_OFFSET(0x7CDE0)
#define RPG_CLIENT_DATA_NAMEID_COMPARETO_OFFSET UNITYSDK_OFFSET(0x7CDD0)
#define RPG_CLIENT_DATA_NAMEID_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x7CE40)
#define RPG_CLIENT_DATA_NAMEID_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x7CE90)
#define RPG_CLIENT_DATA_NAMEID_EQUALS_OFFSET UNITYSDK_OFFSET(0x7CD60)
#define RPG_CLIENT_DATA_NAMEID_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7CD70)
#define RPG_CLIENT_DATA_NAMEID_OP_EQUALITY_1_OFFSET UNITYSDK_OFFSET(0x9453AC0)
#define RPG_CLIENT_DATA_NAMEID_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x9453990)
#define RPG_CLIENT_DATA_NAMEID_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x9451EE0)
#define RPG_CLIENT_DATA_NAMEID_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x94539E0)
#define RPG_CLIENT_DATA_NAMEID_OP_INEQUALITY_1_OFFSET UNITYSDK_OFFSET(0x9453C10)
#define RPG_CLIENT_DATA_NAMEID_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x9452B40)
#define RPG_CLIENT_DATA_NAMEID_TOSTRING_OFFSET UNITYSDK_OFFSET(0x7CDC0)
#define RPG_CLIENT_DATA_NAMEID__CCTOR_OFFSET UNITYSDK_OFFSET(0x9453D60)
#define RPG_CLIENT_DATA_NAMEID__CTOR_OFFSET UNITYSDK_OFFSET(0x7CCA0)
#define RPG_CLIENT_DATA_NAMEID___IFIXBASEPROXY_EQUALS_OFFSET UNITYSDK_OFFSET(0x7CEA0)
#define RPG_CLIENT_DATA_NAMEID___IFIXBASEPROXY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7CEE0)
#define RPG_CLIENT_DATA_NAMEID___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x7CF20)

namespace RPG::Client::Data
{
	inline static constexpr unsigned int NameID_TypeDefinitionIndex = 60191;

	struct alignas(4) NameID
	{
		static ::RPG::Client::Data::NameID* StaticGet_Empty()
		{
			return (::RPG::Client::Data::NameID*)Il2CppClass::FromTypeDefinitionIndex(NameID_TypeDefinitionIndex)->GetStaticField(0xA5E0);
		}
		static ::System::Int32* StaticGet__emptyHash()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(NameID_TypeDefinitionIndex)->GetStaticField(0xA5E4);
		}
