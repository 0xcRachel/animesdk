...
#define RPG_CLIENT_DATA_EVENTINDEX_ISADD_OFFSET UNITYSDK_OFFSET(0x7CB50)
#define RPG_CLIENT_DATA_EVENTINDEX_ISMATCHED_OFFSET UNITYSDK_OFFSET(0x7CBF0)
#define RPG_CLIENT_DATA_EVENTINDEX_ISPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x7CB00)
#define RPG_CLIENT_DATA_EVENTINDEX_ISREMOVE_OFFSET UNITYSDK_OFFSET(0x7CBA0)
#define RPG_CLIENT_DATA_EVENTINDEX_TOSTRING_OFFSET UNITYSDK_OFFSET(0x7CAE0)
#define RPG_CLIENT_DATA_EVENTINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x7CAF0)
#define RPG_CLIENT_DATA_EVENTINDEX___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x7CC20)

namespace RPG::Client::Data
{
	inline static constexpr unsigned int EventIndex_TypeDefinitionIndex = 60187;
