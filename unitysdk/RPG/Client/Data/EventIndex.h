...
#define RPG_CLIENT_DATA_EVENTINDEX_ISADD_OFFSET UNITYSDK_OFFSET(0xCC430)
#define RPG_CLIENT_DATA_EVENTINDEX_ISMATCHED_OFFSET UNITYSDK_OFFSET(0xCC4D0)
#define RPG_CLIENT_DATA_EVENTINDEX_ISPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xCC3E0)
#define RPG_CLIENT_DATA_EVENTINDEX_ISREMOVE_OFFSET UNITYSDK_OFFSET(0xCC480)
#define RPG_CLIENT_DATA_EVENTINDEX_TOSTRING_OFFSET UNITYSDK_OFFSET(0xCC3C0)
#define RPG_CLIENT_DATA_EVENTINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0xCC3D0)
#define RPG_CLIENT_DATA_EVENTINDEX___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0xCC500)

namespace RPG::Client::Data
{
	inline static constexpr unsigned int EventIndex_TypeDefinitionIndex = 58467;
