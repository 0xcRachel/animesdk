...
#define RPG_CLIENT_SILVERWOLFUNLOCKMISSIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9F7C630)

namespace RPG::Client
{
	inline static constexpr unsigned int SilverWolfUnlockMissionData_TypeDefinitionIndex = 53899;
