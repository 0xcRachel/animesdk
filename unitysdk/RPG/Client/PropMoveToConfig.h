...
#define RPG_CLIENT_PROPMOVETOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9D1CA30)

namespace RPG::Client
{
	inline static constexpr unsigned int PropMoveToConfig_TypeDefinitionIndex = 54503;
