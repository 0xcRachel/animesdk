...
#define RPG_CLIENT_EARLYACCESSCONTENT___C__DISPLAYCLASS22_0__CONTAINSDIMENSION_B__0_OFFSET UNITYSDK_OFFSET(0x908AF80)
#define RPG_CLIENT_EARLYACCESSCONTENT___C__DISPLAYCLASS22_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9089660)

namespace RPG::Client
{
	inline static constexpr unsigned int EarlyAccessContent___c__DisplayClass22_0_TypeDefinitionIndex = 50556;
