...
#define RPG_CLIENT_LONGTEXT_SUBTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x151AFC80)

namespace RPG::Client
{
	inline static constexpr unsigned int LongText_SubText_TypeDefinitionIndex = 67804;
