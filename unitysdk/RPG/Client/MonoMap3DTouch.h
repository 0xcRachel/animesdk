...
#define RPG_CLIENT_MONOMAP3DTOUCH_ISPAGENOTFOCUSED_OFFSET UNITYSDK_OFFSET(0x17AD75F0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_0DC794B6E3A200E7_OFFSET UNITYSDK_OFFSET(0x17AD77C0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_2958B160D1DF7640_OFFSET UNITYSDK_OFFSET(0x17AD7B20)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_2C5421072C50A323_OFFSET UNITYSDK_OFFSET(0x17AD8280)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_3E06E2491B129B22_OFFSET UNITYSDK_OFFSET(0x17AD70D0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_42CE8882317DE3CD_1_OFFSET UNITYSDK_OFFSET(0x17AD8900)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_42CE8882317DE3CD_OFFSET UNITYSDK_OFFSET(0x17AD82D0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x17AD7300)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0x17ADA650)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x17AD9980)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_49A086C8E6F42C45_OFFSET UNITYSDK_OFFSET(0x17AD9B70)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_67E989182507B304_OFFSET UNITYSDK_OFFSET(0x17AD7D90)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_7A73F165001BC325_1_OFFSET UNITYSDK_OFFSET(0x17ADA2C0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_7A73F165001BC325_OFFSET UNITYSDK_OFFSET(0x17ADA0B0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_7FBD7054FC0495F3_1_OFFSET UNITYSDK_OFFSET(0x17AD8760)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_7FBD7054FC0495F3_2_OFFSET UNITYSDK_OFFSET(0x17AD8830)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_7FBD7054FC0495F3_OFFSET UNITYSDK_OFFSET(0x17AD8690)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_842C2C83BCD87BDA_OFFSET UNITYSDK_OFFSET(0x17AD8050)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_94A2F63DE8B7DB51_OFFSET UNITYSDK_OFFSET(0x17AD7770)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x17ADA4D0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_C08EA6252F773E6C_1_OFFSET UNITYSDK_OFFSET(0x17AD8520)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_C08EA6252F773E6C_OFFSET UNITYSDK_OFFSET(0x17AD83B0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_D2A08F3D951A0C1D_OFFSET UNITYSDK_OFFSET(0x17ADA560)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_F70DC5473DF715AD_OFFSET UNITYSDK_OFFSET(0x17AD9DE0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_FBF2CB29FD3B55E6_OFFSET UNITYSDK_OFFSET(0x17AD7490)
#define RPG_CLIENT_MONOMAP3DTOUCH_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17AD98D0)
#define RPG_CLIENT_MONOMAP3DTOUCH_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x17AD9160)
#define RPG_CLIENT_MONOMAP3DTOUCH_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17AD89E0)
#define RPG_CLIENT_MONOMAP3DTOUCH_REFRESH_OFFSET UNITYSDK_OFFSET(0x17AD6EF0)
#define RPG_CLIENT_MONOMAP3DTOUCH_RESETTOUCH_OFFSET UNITYSDK_OFFSET(0x17AD9A70)
#define RPG_CLIENT_MONOMAP3DTOUCH_SUBSCRIBEEVENT_OFFSET UNITYSDK_OFFSET(0x17AD8A60)
#define RPG_CLIENT_MONOMAP3DTOUCH_UNSUBSCRIBEEVENT_OFFSET UNITYSDK_OFFSET(0x17AD91D0)
#define RPG_CLIENT_MONOMAP3DTOUCH_UPDATE_OFFSET UNITYSDK_OFFSET(0x17AD7070)
#define RPG_CLIENT_MONOMAP3DTOUCH__CTOR_OFFSET UNITYSDK_OFFSET(0x17ADA6B0)
