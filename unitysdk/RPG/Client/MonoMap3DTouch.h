...
#define RPG_CLIENT_MONOMAP3DTOUCH_ISPAGENOTFOCUSED_OFFSET UNITYSDK_OFFSET(0x116ABD00)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_0DA2C55EA555FBD4_OFFSET UNITYSDK_OFFSET(0x116AC9F0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_0DC794B6E3A200E7_OFFSET UNITYSDK_OFFSET(0x116ABE80)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_232E79648899E21B_OFFSET UNITYSDK_OFFSET(0x116AEA00)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_3E06E2491B129B22_OFFSET UNITYSDK_OFFSET(0x116AB7F0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x116ABA20)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x116ADEA0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_49A086C8E6F42C45_OFFSET UNITYSDK_OFFSET(0x116AE0B0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_4A997C91819DC81F_OFFSET UNITYSDK_OFFSET(0x116AC480)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_53F9EED4C485B1BF_1_OFFSET UNITYSDK_OFFSET(0x116AD040)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_53F9EED4C485B1BF_OFFSET UNITYSDK_OFFSET(0x116ACA40)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_7A73F165001BC325_1_OFFSET UNITYSDK_OFFSET(0x116AE7F0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_7A73F165001BC325_OFFSET UNITYSDK_OFFSET(0x116AE5D0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_81B573871B4EA4D9_OFFSET UNITYSDK_OFFSET(0x116AC1F0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_92CF8E9074F633FA_OFFSET UNITYSDK_OFFSET(0x116AC730)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_94A2F63DE8B7DB51_OFFSET UNITYSDK_OFFSET(0x116ABE30)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_9A6DA36CCAE7D188_OFFSET UNITYSDK_OFFSET(0x116AEB70)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_C08EA6252F773E6C_1_OFFSET UNITYSDK_OFFSET(0x116ACC90)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_C08EA6252F773E6C_OFFSET UNITYSDK_OFFSET(0x116ACB20)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_D2A08F3D951A0C1D_OFFSET UNITYSDK_OFFSET(0x116AEA80)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_D37935A0927E84C3_1_OFFSET UNITYSDK_OFFSET(0x116ACEC0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_D37935A0927E84C3_2_OFFSET UNITYSDK_OFFSET(0x116ACF80)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_D37935A0927E84C3_OFFSET UNITYSDK_OFFSET(0x116ACE00)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_F70DC5473DF715AD_OFFSET UNITYSDK_OFFSET(0x116AE310)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_FBF2CB29FD3B55E6_OFFSET UNITYSDK_OFFSET(0x116ABBB0)
#define RPG_CLIENT_MONOMAP3DTOUCH_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x116ADDF0)
#define RPG_CLIENT_MONOMAP3DTOUCH_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x116AD790)
#define RPG_CLIENT_MONOMAP3DTOUCH_ONENABLE_OFFSET UNITYSDK_OFFSET(0x116AD120)
#define RPG_CLIENT_MONOMAP3DTOUCH_REFRESH_OFFSET UNITYSDK_OFFSET(0x116AB610)
#define RPG_CLIENT_MONOMAP3DTOUCH_RESETTOUCH_OFFSET UNITYSDK_OFFSET(0x116ADF90)
#define RPG_CLIENT_MONOMAP3DTOUCH_SUBSCRIBEEVENT_OFFSET UNITYSDK_OFFSET(0x116AD1A0)
#define RPG_CLIENT_MONOMAP3DTOUCH_UNSUBSCRIBEEVENT_OFFSET UNITYSDK_OFFSET(0x116AD800)
#define RPG_CLIENT_MONOMAP3DTOUCH_UPDATE_OFFSET UNITYSDK_OFFSET(0x116AB790)
#define RPG_CLIENT_MONOMAP3DTOUCH__CTOR_OFFSET UNITYSDK_OFFSET(0x116AEBC0)
