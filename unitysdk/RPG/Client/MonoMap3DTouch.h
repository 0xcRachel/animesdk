...
#define RPG_CLIENT_MONOMAP3DTOUCH_ISPAGENOTFOCUSED_OFFSET UNITYSDK_OFFSET(0x9D260B0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_0DA2C55EA555FBD4_OFFSET UNITYSDK_OFFSET(0x9D26DA0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_0DC794B6E3A200E7_OFFSET UNITYSDK_OFFSET(0x9D26230)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_232E79648899E21B_OFFSET UNITYSDK_OFFSET(0x9D28DA0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_3E06E2491B129B22_OFFSET UNITYSDK_OFFSET(0x9D25BA0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x9D25DD0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x9D28250)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_49A086C8E6F42C45_OFFSET UNITYSDK_OFFSET(0x9D28460)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_4A997C91819DC81F_OFFSET UNITYSDK_OFFSET(0x9D26830)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_53F9EED4C485B1BF_1_OFFSET UNITYSDK_OFFSET(0x9D273F0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_53F9EED4C485B1BF_OFFSET UNITYSDK_OFFSET(0x9D26DF0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_7A73F165001BC325_1_OFFSET UNITYSDK_OFFSET(0x9D28B90)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_7A73F165001BC325_OFFSET UNITYSDK_OFFSET(0x9D28980)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_81B573871B4EA4D9_OFFSET UNITYSDK_OFFSET(0x9D265A0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_92CF8E9074F633FA_OFFSET UNITYSDK_OFFSET(0x9D26AE0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_94A2F63DE8B7DB51_OFFSET UNITYSDK_OFFSET(0x9D261E0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_9A6DA36CCAE7D188_OFFSET UNITYSDK_OFFSET(0x9D28F10)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_C08EA6252F773E6C_1_OFFSET UNITYSDK_OFFSET(0x9D27040)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_C08EA6252F773E6C_OFFSET UNITYSDK_OFFSET(0x9D26ED0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_D2A08F3D951A0C1D_OFFSET UNITYSDK_OFFSET(0x9D28E20)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_D37935A0927E84C3_1_OFFSET UNITYSDK_OFFSET(0x9D27270)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_D37935A0927E84C3_2_OFFSET UNITYSDK_OFFSET(0x9D27330)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_D37935A0927E84C3_OFFSET UNITYSDK_OFFSET(0x9D271B0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_F70DC5473DF715AD_OFFSET UNITYSDK_OFFSET(0x9D286C0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_FBF2CB29FD3B55E6_OFFSET UNITYSDK_OFFSET(0x9D25F60)
#define RPG_CLIENT_MONOMAP3DTOUCH_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9D281A0)
#define RPG_CLIENT_MONOMAP3DTOUCH_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x9D27B40)
#define RPG_CLIENT_MONOMAP3DTOUCH_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9D274D0)
#define RPG_CLIENT_MONOMAP3DTOUCH_REFRESH_OFFSET UNITYSDK_OFFSET(0x9D259C0)
#define RPG_CLIENT_MONOMAP3DTOUCH_RESETTOUCH_OFFSET UNITYSDK_OFFSET(0x9D28340)
#define RPG_CLIENT_MONOMAP3DTOUCH_SUBSCRIBEEVENT_OFFSET UNITYSDK_OFFSET(0x9D27550)
#define RPG_CLIENT_MONOMAP3DTOUCH_UNSUBSCRIBEEVENT_OFFSET UNITYSDK_OFFSET(0x9D27BB0)
#define RPG_CLIENT_MONOMAP3DTOUCH_UPDATE_OFFSET UNITYSDK_OFFSET(0x9D25B40)
#define RPG_CLIENT_MONOMAP3DTOUCH__CTOR_OFFSET UNITYSDK_OFFSET(0x9D28F60)
