...
#define RPG_CLIENT_RECOMMENDRELICGROWTHGUIDEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9D7E7D0)

namespace RPG::Client
{
	inline static constexpr unsigned int RecommendRelicGrowthGuideItem_TypeDefinitionIndex = 52096;
