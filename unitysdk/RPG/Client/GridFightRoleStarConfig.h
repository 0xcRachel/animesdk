...
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GETORIGINALAVATARSKILLID_OFFSET UNITYSDK_OFFSET(0x93ED260)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GETORIGINALSERVANTSKILLID_OFFSET UNITYSDK_OFFSET(0x93ED310)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_BACKPOWERBASE_OFFSET UNITYSDK_OFFSET(0x93EF310)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_BACKSHOWSKILLIDLIST_OFFSET UNITYSDK_OFFSET(0x93EC5C0)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_BACKSKILLCONFIG_OFFSET UNITYSDK_OFFSET(0x93ED000)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_BACKSPEEDMODIFIER_OFFSET UNITYSDK_OFFSET(0x93EF620)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_BACKSPMODIFIER_OFFSET UNITYSDK_OFFSET(0x93EF630)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_DEFAULTSKILLCONFIG_OFFSET UNITYSDK_OFFSET(0x93EF250)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_ENERGYBAR_OFFSET UNITYSDK_OFFSET(0x93EF3D0)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_FRONTPOWERBASE_OFFSET UNITYSDK_OFFSET(0x93EF2F0)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_FRONTSHOWSKILLIDLIST_OFFSET UNITYSDK_OFFSET(0x93EC240)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_FRONTSKILLCONFIG_OFFSET UNITYSDK_OFFSET(0x93ECF30)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_FRONTSPECIALSPCONFIG_OFFSET UNITYSDK_OFFSET(0x93EF2C0)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_GENERALPROPERTYMODIFIERS_OFFSET UNITYSDK_OFFSET(0x93EF600)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_HASFRONTSPECIALSPCONFIG_OFFSET UNITYSDK_OFFSET(0x93EF2E0)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_HEALBASE_OFFSET UNITYSDK_OFFSET(0x93EF370)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_HPADDEDRATIO2_OFFSET UNITYSDK_OFFSET(0x93EF3F0)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_INITIALENERGYBAR_OFFSET UNITYSDK_OFFSET(0x93EF3B0)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_INITIALSPECIALSP_OFFSET UNITYSDK_OFFSET(0x93EF5A0)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_LUCKCHANCE_OFFSET UNITYSDK_OFFSET(0x93EF330)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_LUCKDAMAGE_OFFSET UNITYSDK_OFFSET(0x93EF350)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_SERVANTSHOWSKILLIDLIST_OFFSET UNITYSDK_OFFSET(0x93EC3D0)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_SHIELDBASE_OFFSET UNITYSDK_OFFSET(0x93EF390)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_SPECIALMAXSP_OFFSET UNITYSDK_OFFSET(0x93EF540)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_SET_FRONTSPECIALSPCONFIG_OFFSET UNITYSDK_OFFSET(0x93EF2D0)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x93E31F0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightRoleStarConfig_TypeDefinitionIndex = 51739;

	class GridFightRoleStarConfig : public ::System::Object
	{
	public:
		::Class_0_16E4307DCC419505_543* _BackSPModifier_k__BackingField; // 0x10
		::RPG::Client::GridFightRoleSkillConfig* _BackSkillConfig; // 0x18
		::Class_0_16E4307DCC419505_543* _BackSpeedModifier_k__BackingField; // 0x20
		...
		::Class_0_16E4307DCC419505_543* get_BackSpeedModifier()
		{
			return ((::Class_0_16E4307DCC419505_543*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_BACKSPEEDMODIFIER_OFFSET))(this);
		}

		::Class_0_16E4307DCC419505_543* get_BackSPModifier()
		{
			return ((::Class_0_16E4307DCC419505_543*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_BACKSPMODIFIER_OFFSET))(this);
		}
	};
}
