...
#define RPG_CLIENT_AIRLINESTATIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x8C48FD0)

namespace RPG::Client
{
	inline static constexpr unsigned int AirlineStationInfo_TypeDefinitionIndex = 47311;
