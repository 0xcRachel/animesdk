...
#define RPG_CLIENT_MONOBACKDYNAMICCONTROL_AWAKE_OFFSET UNITYSDK_OFFSET(0x152BD860)
#define RPG_CLIENT_MONOBACKDYNAMICCONTROL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x152BD9A0)
#define RPG_CLIENT_MONOBACKDYNAMICCONTROL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x152BD8D0)
#define RPG_CLIENT_MONOBACKDYNAMICCONTROL_SETBOARDSCRIPT_OFFSET UNITYSDK_OFFSET(0x152BDA30)
#define RPG_CLIENT_MONOBACKDYNAMICCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0x152BD930)
#define RPG_CLIENT_MONOBACKDYNAMICCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x152BDA90)
