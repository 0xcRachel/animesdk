...
#define RPG_CLIENT_ENTERGAMEPHASE___C__DISPLAYCLASS16_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9160030)
#define RPG_CLIENT_ENTERGAMEPHASE___C__DISPLAYCLASS16_0___CHECKMISSIONRES_B__0_OFFSET UNITYSDK_OFFSET(0x9162030)

namespace RPG::Client
{
	inline static constexpr unsigned int EnterGamePhase___c__DisplayClass16_0_TypeDefinitionIndex = 48476;
