...
#define RPG_CLIENT_AVATAREFFECTRENDERER___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x15882F70)
#define RPG_CLIENT_AVATAREFFECTRENDERER___C__CTOR_OFFSET UNITYSDK_OFFSET(0x15882FB0)
#define RPG_CLIENT_AVATAREFFECTRENDERER___C__GET_MATERIALS_B__3_0_OFFSET UNITYSDK_OFFSET(0x15882FC0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Func_2<::RPG::Client::AvatarEffectRendererBehavior_AvatarEffectMat*, ::UnityEngine::Material*>**)Il2CppClass::FromTypeDefinitionIndex(AvatarEffectRenderer___c_TypeDefinitionIndex)->GetStaticField(0x5BEC0);
		}
		static ::RPG::Client::AvatarEffectRenderer___c** StaticGet___9()
		{
			return (::RPG::Client::AvatarEffectRenderer___c**)Il2CppClass::FromTypeDefinitionIndex(AvatarEffectRenderer___c_TypeDefinitionIndex)->GetStaticField(0x5BEC8);
		}
