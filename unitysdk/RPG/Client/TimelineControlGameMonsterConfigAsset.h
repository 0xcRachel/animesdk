...
#define RPG_CLIENT_TIMELINECONTROLGAMEMONSTERCONFIGASSET__CTOR_OFFSET UNITYSDK_OFFSET(0xA0BFD40)

namespace RPG::Client
{
	inline static constexpr unsigned int TimelineControlGameMonsterConfigAsset_TypeDefinitionIndex = 47847;
