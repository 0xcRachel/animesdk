...
#define RPG_CLIENT_FIXSTRETCHUVBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0x970B8B0)
#define RPG_CLIENT_FIXSTRETCHUVBEHAVIOR_METHOD_3_05837CF6F50C82A3_OFFSET UNITYSDK_OFFSET(0x970B650)
#define RPG_CLIENT_FIXSTRETCHUVBEHAVIOR_METHOD_3_30C97F4D4FBEECDF_OFFSET UNITYSDK_OFFSET(0x970AF50)
#define RPG_CLIENT_FIXSTRETCHUVBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x970A7B0)
#define RPG_CLIENT_FIXSTRETCHUVBEHAVIOR_METHOD_3_44AC3F3C85C7CAA3_OFFSET UNITYSDK_OFFSET(0x970B2F0)
#define RPG_CLIENT_FIXSTRETCHUVBEHAVIOR_METHOD_3_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x970B900)
#define RPG_CLIENT_FIXSTRETCHUVBEHAVIOR_METHOD_3_CD9F3CEFB366C27A_OFFSET UNITYSDK_OFFSET(0x970A820)
#define RPG_CLIENT_FIXSTRETCHUVBEHAVIOR_METHOD_3_EF791A79C773DCBB_OFFSET UNITYSDK_OFFSET(0x970B5A0)
#define RPG_CLIENT_FIXSTRETCHUVBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0x970AED0)
#define RPG_CLIENT_FIXSTRETCHUVBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x970B8F0)
#define RPG_CLIENT_FIXSTRETCHUVBEHAVIOR___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x970B960)
