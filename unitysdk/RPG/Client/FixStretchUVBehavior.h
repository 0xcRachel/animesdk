...
#define RPG_CLIENT_FIXSTRETCHUVBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0x9296170)
#define RPG_CLIENT_FIXSTRETCHUVBEHAVIOR_METHOD_3_05837CF6F50C82A3_OFFSET UNITYSDK_OFFSET(0x9295F10)
#define RPG_CLIENT_FIXSTRETCHUVBEHAVIOR_METHOD_3_30C97F4D4FBEECDF_OFFSET UNITYSDK_OFFSET(0x9295810)
#define RPG_CLIENT_FIXSTRETCHUVBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x9295070)
#define RPG_CLIENT_FIXSTRETCHUVBEHAVIOR_METHOD_3_44AC3F3C85C7CAA3_OFFSET UNITYSDK_OFFSET(0x9295BB0)
#define RPG_CLIENT_FIXSTRETCHUVBEHAVIOR_METHOD_3_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x92961C0)
#define RPG_CLIENT_FIXSTRETCHUVBEHAVIOR_METHOD_3_CD9F3CEFB366C27A_OFFSET UNITYSDK_OFFSET(0x92950E0)
#define RPG_CLIENT_FIXSTRETCHUVBEHAVIOR_METHOD_3_EF791A79C773DCBB_OFFSET UNITYSDK_OFFSET(0x9295E60)
#define RPG_CLIENT_FIXSTRETCHUVBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0x9295790)
#define RPG_CLIENT_FIXSTRETCHUVBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x92961B0)
#define RPG_CLIENT_FIXSTRETCHUVBEHAVIOR___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x9296220)

namespace RPG::Client
{
	inline static constexpr unsigned int FixStretchUVBehavior_TypeDefinitionIndex = 56242;
