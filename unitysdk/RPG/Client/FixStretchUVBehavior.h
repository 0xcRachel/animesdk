...
#define RPG_CLIENT_FIXSTRETCHUVBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0x159443E0)
#define RPG_CLIENT_FIXSTRETCHUVBEHAVIOR_METHOD_3_37AACA8481A4B501_OFFSET UNITYSDK_OFFSET(0x15943CB0)
#define RPG_CLIENT_FIXSTRETCHUVBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x15942F00)
#define RPG_CLIENT_FIXSTRETCHUVBEHAVIOR_METHOD_3_4857357D5C1BFCE8_OFFSET UNITYSDK_OFFSET(0x15942F70)
#define RPG_CLIENT_FIXSTRETCHUVBEHAVIOR_METHOD_3_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x15944430)
#define RPG_CLIENT_FIXSTRETCHUVBEHAVIOR_METHOD_3_74F16A204699EDE8_OFFSET UNITYSDK_OFFSET(0x15944010)
#define RPG_CLIENT_FIXSTRETCHUVBEHAVIOR_METHOD_3_A98241A42A1BCFD0_OFFSET UNITYSDK_OFFSET(0x15943F50)
#define RPG_CLIENT_FIXSTRETCHUVBEHAVIOR_METHOD_3_B182E4E61DD67E67_OFFSET UNITYSDK_OFFSET(0x159437B0)
#define RPG_CLIENT_FIXSTRETCHUVBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0x15943730)
#define RPG_CLIENT_FIXSTRETCHUVBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x15944420)
#define RPG_CLIENT_FIXSTRETCHUVBEHAVIOR___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x15944490)
