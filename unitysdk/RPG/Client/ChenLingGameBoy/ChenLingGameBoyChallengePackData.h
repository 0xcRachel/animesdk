...
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYCHALLENGEPACKDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x8EC47A0)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYCHALLENGEPACKDATA_GET_CHEATCHALLENGEDATA_OFFSET UNITYSDK_OFFSET(0x8EC4920)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYCHALLENGEPACKDATA_GET_HARDCHALLENGEDATA_OFFSET UNITYSDK_OFFSET(0x8EC4900)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYCHALLENGEPACKDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0x8EC48D0)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYCHALLENGEPACKDATA_GET_ISCOMPLETE_OFFSET UNITYSDK_OFFSET(0x8EC4960)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYCHALLENGEPACKDATA_GET_REWARDID_OFFSET UNITYSDK_OFFSET(0x8EC4940)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYCHALLENGEPACKDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0x8EC48E0)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYCHALLENGEPACKDATA_GET_STATETHISGAME_OFFSET UNITYSDK_OFFSET(0x8EC4990)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYCHALLENGEPACKDATA_GET_STATE_OFFSET UNITYSDK_OFFSET(0x8EC4970)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYCHALLENGEPACKDATA_SET_CHEATCHALLENGEDATA_OFFSET UNITYSDK_OFFSET(0x8EC4930)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYCHALLENGEPACKDATA_SET_HARDCHALLENGEDATA_OFFSET UNITYSDK_OFFSET(0x8EC4910)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYCHALLENGEPACKDATA_SET_ROW_OFFSET UNITYSDK_OFFSET(0x8EC48F0)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYCHALLENGEPACKDATA_SET_STATETHISGAME_OFFSET UNITYSDK_OFFSET(0x8EC49A0)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYCHALLENGEPACKDATA_SET_STATE_OFFSET UNITYSDK_OFFSET(0x8EC4980)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYCHALLENGEPACKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8EC4820)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYCHALLENGEPACKDATA__INIT_OFFSET UNITYSDK_OFFSET(0x8EC4830)

namespace RPG::Client::ChenLingGameBoy
{
	inline static constexpr unsigned int ChenLingGameBoyChallengePackData_TypeDefinitionIndex = 59754;
