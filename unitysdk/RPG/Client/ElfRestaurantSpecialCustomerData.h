...
#define RPG_CLIENT_ELFRESTAURANTSPECIALCUSTOMERDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x15AC0CA0)
#define RPG_CLIENT_ELFRESTAURANTSPECIALCUSTOMERDATA_GET_CUSTOMERID_OFFSET UNITYSDK_OFFSET(0x15AD32C0)
#define RPG_CLIENT_ELFRESTAURANTSPECIALCUSTOMERDATA_GET_EVENTCONFIGPATH_OFFSET UNITYSDK_OFFSET(0x15ACFCF0)
#define RPG_CLIENT_ELFRESTAURANTSPECIALCUSTOMERDATA_GET_SELECTEVENTID_OFFSET UNITYSDK_OFFSET(0x15AD3390)
#define RPG_CLIENT_ELFRESTAURANTSPECIALCUSTOMERDATA_GET_SPECIALCUSTOMERID_OFFSET UNITYSDK_OFFSET(0x15AD32A0)
#define RPG_CLIENT_ELFRESTAURANTSPECIALCUSTOMERDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x15AD3330)
#define RPG_CLIENT_ELFRESTAURANTSPECIALCUSTOMERDATA_SET_SPECIALCUSTOMERID_OFFSET UNITYSDK_OFFSET(0x15AD32B0)
#define RPG_CLIENT_ELFRESTAURANTSPECIALCUSTOMERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x15AD3290)
