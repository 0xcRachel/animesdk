...
#define RPG_CLIENT_ELFRESTAURANTSPECIALCUSTOMERDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x914E5C0)
#define RPG_CLIENT_ELFRESTAURANTSPECIALCUSTOMERDATA_GET_CUSTOMERID_OFFSET UNITYSDK_OFFSET(0x914E650)
#define RPG_CLIENT_ELFRESTAURANTSPECIALCUSTOMERDATA_GET_EVENTCONFIGPATH_OFFSET UNITYSDK_OFFSET(0x9149EA0)
#define RPG_CLIENT_ELFRESTAURANTSPECIALCUSTOMERDATA_GET_SELECTEVENTID_OFFSET UNITYSDK_OFFSET(0x914E720)
#define RPG_CLIENT_ELFRESTAURANTSPECIALCUSTOMERDATA_GET_SPECIALCUSTOMERID_OFFSET UNITYSDK_OFFSET(0x914E630)
#define RPG_CLIENT_ELFRESTAURANTSPECIALCUSTOMERDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x914E6C0)
#define RPG_CLIENT_ELFRESTAURANTSPECIALCUSTOMERDATA_SET_SPECIALCUSTOMERID_OFFSET UNITYSDK_OFFSET(0x914E640)
#define RPG_CLIENT_ELFRESTAURANTSPECIALCUSTOMERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x914E620)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfRestaurantSpecialCustomerData_TypeDefinitionIndex = 50666;
