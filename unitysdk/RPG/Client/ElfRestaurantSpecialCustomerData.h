...
#define RPG_CLIENT_ELFRESTAURANTSPECIALCUSTOMERDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x95EAED0)
#define RPG_CLIENT_ELFRESTAURANTSPECIALCUSTOMERDATA_GET_CUSTOMERID_OFFSET UNITYSDK_OFFSET(0x95FC120)
#define RPG_CLIENT_ELFRESTAURANTSPECIALCUSTOMERDATA_GET_EVENTCONFIGPATH_OFFSET UNITYSDK_OFFSET(0x95F9650)
#define RPG_CLIENT_ELFRESTAURANTSPECIALCUSTOMERDATA_GET_SELECTEVENTID_OFFSET UNITYSDK_OFFSET(0x95FC1F0)
#define RPG_CLIENT_ELFRESTAURANTSPECIALCUSTOMERDATA_GET_SPECIALCUSTOMERID_OFFSET UNITYSDK_OFFSET(0x95FC100)
#define RPG_CLIENT_ELFRESTAURANTSPECIALCUSTOMERDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x95FC190)
#define RPG_CLIENT_ELFRESTAURANTSPECIALCUSTOMERDATA_SET_SPECIALCUSTOMERID_OFFSET UNITYSDK_OFFSET(0x95FC110)
#define RPG_CLIENT_ELFRESTAURANTSPECIALCUSTOMERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x95FC0F0)
