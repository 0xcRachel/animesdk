...
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE_GETDEFAULTSKILLPRELOADTYPE_OFFSET UNITYSDK_OFFSET(0xF3AC400)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE_GETSKILLCONFIG_OFFSET UNITYSDK_OFFSET(0xF3ABFA0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE_GET_ADVMODELITEMNAME_OFFSET UNITYSDK_OFFSET(0xF3ABDD0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE_GET_ADVMODELPATH_OFFSET UNITYSDK_OFFSET(0xF3ABDB0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE_GET_BATTLEINSLOTSKILLS_OFFSET UNITYSDK_OFFSET(0xF3ABDF0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE_GET_BATTLEMODELITEMNAME_OFFSET UNITYSDK_OFFSET(0xF3ABDC0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE_GET_BATTLEMODELPATH_OFFSET UNITYSDK_OFFSET(0xF3ABDA0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE_GET_CURRENTULTRPRELOADTYPE_OFFSET UNITYSDK_OFFSET(0xF3ACDD0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE_GET_DISABLEALLPRELOAD_OFFSET UNITYSDK_OFFSET(0xF3AD2A0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE_GET_DISABLEULTRAPRELOAD_OFFSET UNITYSDK_OFFSET(0xF3AD550)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE_GET_ISENABLE_OFFSET UNITYSDK_OFFSET(0xF3AA6A0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE_GET_ULTRAPRELOADTYPE_OFFSET UNITYSDK_OFFSET(0xF3ABDE0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE_INITBATTLENORMALSKILLPRELOADTYPE_OFFSET UNITYSDK_OFFSET(0xF3A99F0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE_INITBATTLESKILLCONFIG_OFFSET UNITYSDK_OFFSET(0xF3A6A50)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE_REFRESHBATTLEINSLOTSKILLS_OFFSET UNITYSDK_OFFSET(0xF3A97D0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE_RELEASEEFFECTINSTANCEOFTYPE_OFFSET UNITYSDK_OFFSET(0xF3ACAB0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE_RELEASEULTRAEFFECTINSTANCE_OFFSET UNITYSDK_OFFSET(0xF3ACC10)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE_RESETNOTINSLOTBATTLENORMALSKILLPRELOADTYPE_OFFSET UNITYSDK_OFFSET(0xF3AC190)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE_SET_DISABLEALLPRELOAD_OFFSET UNITYSDK_OFFSET(0xF3AD2E0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE_SET_DISABLEULTRAPRELOAD_OFFSET UNITYSDK_OFFSET(0xF3AD590)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE_UPDATEADVMODEL_OFFSET UNITYSDK_OFFSET(0xF3AC560)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE_UPDATEBATTLEMODEL_OFFSET UNITYSDK_OFFSET(0xF3A8C40)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE_UPDATEEFFECTOFTYPES_OFFSET UNITYSDK_OFFSET(0xF3AC770)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE_UPDATEULTRAEFFECTPRELOAD_OFFSET UNITYSDK_OFFSET(0xF3ACC70)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE__CCTOR_OFFSET UNITYSDK_OFFSET(0xF3AD810)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE__COMPUTEPRELOADITEMFLAG_OFFSET UNITYSDK_OFFSET(0xF3ACEC0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xF3AA580)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE__GETDEFAULTADVMODELPATH_OFFSET UNITYSDK_OFFSET(0xF3AAD50)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE__GETDEFAULTBATTLEMODELPATH_OFFSET UNITYSDK_OFFSET(0xF3AACD0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE__ISHITEFFECT_OFFSET UNITYSDK_OFFSET(0xF3AD1B0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE__ISIGNOREITEMNAME_OFFSET UNITYSDK_OFFSET(0xF3ACDE0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE__ISVALIDINSSLOTSKILL_OFFSET UNITYSDK_OFFSET(0xF3AC070)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0xF3A6D10)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE__PRELOADTIMELINE_OFFSET UNITYSDK_OFFSET(0xF3A9BD0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE__REGISTERALLPRELOADEFFECTS_OFFSET UNITYSDK_OFFSET(0xF3A8720)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE__RELEASERESOURCEIMPL_OFFSET UNITYSDK_OFFSET(0xF3A8BC0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE__RELEASETIMELINE_OFFSET UNITYSDK_OFFSET(0xF3ABE00)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE___IFIXBASEPROXY__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0xF3AD880)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHARACTERPRELOADGROUPBASE___IFIXBASEPROXY__RELEASERESOURCEIMPL_OFFSET UNITYSDK_OFFSET(0xF3AD8C0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Text::RegularExpressions::Regex**)Il2CppClass::FromTypeDefinitionIndex(BattleAssetPreload_CharacterPreloadGroupBase_TypeDefinitionIndex)->GetStaticField(0x5DA50);
		}
		static ::System::Boolean* StaticGet__DisableUltraPreload()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(BattleAssetPreload_CharacterPreloadGroupBase_TypeDefinitionIndex)->GetStaticField(0x101A0);
		}
		static ::System::Boolean* StaticGet__DisableAllPreload()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(BattleAssetPreload_CharacterPreloadGroupBase_TypeDefinitionIndex)->GetStaticField(0x101A1);
		}
		::RPG::GameCore::CharacterPreloadConfigBase* _PreloadConfig; // 0x58
		::System::String* _UltraPreloadType; // 0x60
		::System::String* _AdvModelPath; // 0x68
		::System::Collections::Generic::List_1<::System::String*>* _BattleInSlotSkills; // 0x70
		::System::String* _BattleModelPath; // 0x78
		::System::String* _AdvModelItemName; // 0x80
		::System::String* _BattleModelItemName; // 0x88
