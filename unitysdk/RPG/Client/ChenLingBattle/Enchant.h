...
#define RPG_CLIENT_CHENLINGBATTLE_ENCHANT_CREATE_OFFSET UNITYSDK_OFFSET(0x18DC5E60)
#define RPG_CLIENT_CHENLINGBATTLE_ENCHANT_GETDESC_OFFSET UNITYSDK_OFFSET(0x18DC5F60)
#define RPG_CLIENT_CHENLINGBATTLE_ENCHANT_GET_CONFIGID_OFFSET UNITYSDK_OFFSET(0x18DC6010)
#define RPG_CLIENT_CHENLINGBATTLE_ENCHANT_GET_DESC_OFFSET UNITYSDK_OFFSET(0x18DC6060)
#define RPG_CLIENT_CHENLINGBATTLE_ENCHANT_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x18DC60B0)
#define RPG_CLIENT_CHENLINGBATTLE_ENCHANT_GET_MAXLEVEL_OFFSET UNITYSDK_OFFSET(0x18DC60D0)
#define RPG_CLIENT_CHENLINGBATTLE_ENCHANT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x18DC6030)
#define RPG_CLIENT_CHENLINGBATTLE_ENCHANT_GET_SMALLICONPATH_OFFSET UNITYSDK_OFFSET(0x18DC6090)
#define RPG_CLIENT_CHENLINGBATTLE_ENCHANT_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x18DC60C0)
#define RPG_CLIENT_CHENLINGBATTLE_ENCHANT_SET_MAXLEVEL_OFFSET UNITYSDK_OFFSET(0x18DC60E0)
#define RPG_CLIENT_CHENLINGBATTLE_ENCHANT__CTOR_OFFSET UNITYSDK_OFFSET(0x18DC5F10)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int Enchant_TypeDefinitionIndex = 70935;
