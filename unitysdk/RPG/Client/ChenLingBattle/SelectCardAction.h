...
#define RPG_CLIENT_CHENLINGBATTLE_SELECTCARDACTION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17CB2400)
#define RPG_CLIENT_CHENLINGBATTLE_SELECTCARDACTION_ONENTER_OFFSET UNITYSDK_OFFSET(0x17CB1F30)
#define RPG_CLIENT_CHENLINGBATTLE_SELECTCARDACTION_SELECTCARD_OFFSET UNITYSDK_OFFSET(0x17CB24F0)
#define RPG_CLIENT_CHENLINGBATTLE_SELECTCARDACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x17CB1F20)
#define RPG_CLIENT_CHENLINGBATTLE_SELECTCARDACTION__ONCHENLINGPENDINGACTIONSELECTCARDSCRSP_OFFSET UNITYSDK_OFFSET(0x17CB26E0)
#define RPG_CLIENT_CHENLINGBATTLE_SELECTCARDACTION___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17CB2910)
#define RPG_CLIENT_CHENLINGBATTLE_SELECTCARDACTION___IFIXBASEPROXY_ONENTER_OFFSET UNITYSDK_OFFSET(0x17CB2890)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int SelectCardAction_TypeDefinitionIndex = 70047;
