...
#define RPG_CLIENT_SKILLTREEGROWTHGUIDEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9F896F0)

namespace RPG::Client
{
	inline static constexpr unsigned int SkillTreeGrowthGuideItem_TypeDefinitionIndex = 52099;

	class SkillTreeGrowthGuideItem : public ::RPG::Client::BaseGrowthGuideItem
	{
	public:
		::RPG::GameCore::AvatarSkillTreeRow* PointData; // 0x20
		::System::Func_1<::System::String*>* GetPriorityDesc; // 0x28
		::System::String* Icon; // 0x30
		::System::String* Name; // 0x38
		::System::Func_1<::System::String*>* GetGuideDesc; // 0x40
