...
#define RPG_CLIENT_ROGUEHANDBOOKMODULE___C__DISPLAYCLASS18_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9DFAC10)
#define RPG_CLIENT_ROGUEHANDBOOKMODULE___C__DISPLAYCLASS18_0__ISBUFFTYPEREWARDCANTAKE_B__0_OFFSET UNITYSDK_OFFSET(0x9DFAC20)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueHandbookModule___c__DisplayClass18_0_TypeDefinitionIndex = 53544;
