...
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x8C3B830)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_GET_BELONGSPIRITAVATARID_OFFSET UNITYSDK_OFFSET(0x8C3BA90)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x8C3BA70)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x8C3BB20)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_GET_PARAMARRAY_OFFSET UNITYSDK_OFFSET(0x8C3BEE0)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0x8C3BAB0)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_GET_SIMPLEPARAMARRAY_OFFSET UNITYSDK_OFFSET(0x8C3BE60)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_GET_SIMPLESKILLDESC_OFFSET UNITYSDK_OFFSET(0x8C3BD40)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_GET_SKILLATTACKTYPE_OFFSET UNITYSDK_OFFSET(0x8C3BBB0)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_GET_SKILLDESC_OFFSET UNITYSDK_OFFSET(0x8C3BDD0)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_GET_SKILLICONPATH_OFFSET UNITYSDK_OFFSET(0x8C3BC30)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_GET_SKILLID_OFFSET UNITYSDK_OFFSET(0x8C3BA50)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_GET_SKILLTAG_OFFSET UNITYSDK_OFFSET(0x8C3BF60)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_GET_SKILLTRIGGERKEY_OFFSET UNITYSDK_OFFSET(0x8C3B9D0)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_GET_SKILLTYPEDESC_OFFSET UNITYSDK_OFFSET(0x8C3BCB0)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_ISSHOW_OFFSET UNITYSDK_OFFSET(0x8C3B960)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_SET_BELONGSPIRITAVATARID_OFFSET UNITYSDK_OFFSET(0x8C3BAA0)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x8C3BA80)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_SET_SKILLID_OFFSET UNITYSDK_OFFSET(0x8C3BA60)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8C3B8C0)

namespace RPG::Client
{
	inline static constexpr unsigned int AetherMonsterAvatarSkillSingleData_TypeDefinitionIndex = 49403;
	...
	public:
		...
		::System::UInt32 _BelongSpiritAvatarID_k__BackingField; // 0x24
