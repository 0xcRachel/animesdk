...
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x10ADD880)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_GET_BELONGSPIRITAVATARID_OFFSET UNITYSDK_OFFSET(0x10ADDAE0)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x10ADDAC0)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x10ADDB70)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_GET_PARAMARRAY_OFFSET UNITYSDK_OFFSET(0x10ADDF30)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0x10ADDB00)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_GET_SIMPLEPARAMARRAY_OFFSET UNITYSDK_OFFSET(0x10ADDEB0)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_GET_SIMPLESKILLDESC_OFFSET UNITYSDK_OFFSET(0x10ADDD90)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_GET_SKILLATTACKTYPE_OFFSET UNITYSDK_OFFSET(0x10ADDC00)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_GET_SKILLDESC_OFFSET UNITYSDK_OFFSET(0x10ADDE20)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_GET_SKILLICONPATH_OFFSET UNITYSDK_OFFSET(0x10ADDC80)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_GET_SKILLID_OFFSET UNITYSDK_OFFSET(0x10ADDAA0)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_GET_SKILLTAG_OFFSET UNITYSDK_OFFSET(0x10ADDFB0)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_GET_SKILLTRIGGERKEY_OFFSET UNITYSDK_OFFSET(0x10ADDA20)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_GET_SKILLTYPEDESC_OFFSET UNITYSDK_OFFSET(0x10ADDD00)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_ISSHOW_OFFSET UNITYSDK_OFFSET(0x10ADD9B0)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_SET_BELONGSPIRITAVATARID_OFFSET UNITYSDK_OFFSET(0x10ADDAF0)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x10ADDAD0)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA_SET_SKILLID_OFFSET UNITYSDK_OFFSET(0x10ADDAB0)
#define RPG_CLIENT_AETHERMONSTERAVATARSKILLSINGLEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x10ADD910)
