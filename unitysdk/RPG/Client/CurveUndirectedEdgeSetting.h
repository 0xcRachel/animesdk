...
#define RPG_CLIENT_CURVEUNDIRECTEDEDGESETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x8FED9F0)

namespace RPG::Client
{
	inline static constexpr unsigned int CurveUndirectedEdgeSetting_TypeDefinitionIndex = 54428;
