...
#define RPG_CLIENT_BATTLESHOWUIPAGEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x179086B0)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleShowUIPageParam_TypeDefinitionIndex = 67152;
