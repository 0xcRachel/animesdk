...
#define RPG_CLIENT_UIFRAMECAPTUREPARAM_CLONE_OFFSET UNITYSDK_OFFSET(0x144081C0)
#define RPG_CLIENT_UIFRAMECAPTUREPARAM_CREATEDEFAULTCAPTUREPARAM_OFFSET UNITYSDK_OFFSET(0x14408670)
#define RPG_CLIENT_UIFRAMECAPTUREPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x144087F0)

namespace RPG::Client
{
	inline static constexpr unsigned int UIFrameCaptureParam_TypeDefinitionIndex = 68230;

	class UIFrameCaptureParam : public ::System::Object
	{
	public:
		::RPG::Client::FrameCaptureManager_CaptureUsage CaptureUsage; // 0x10
		::RPG::CustomRP::FrameCapture_CaptureType CaptureType; // 0x14
		::RPG::CustomRP::FrameCapture_CaptureFeature CaptureFeature; // 0x18
		::System::Nullable_1<::System::Single> RenderScale; // 0x1C
