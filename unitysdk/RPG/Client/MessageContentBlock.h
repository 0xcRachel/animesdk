...
#define RPG_CLIENT_MESSAGECONTENTBLOCK_EQUALS_OFFSET UNITYSDK_OFFSET(0x96F6FC0)
#define RPG_CLIENT_MESSAGECONTENTBLOCK_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x96F6F70)
#define RPG_CLIENT_MESSAGECONTENTBLOCK_GET_ISCONTEXT_OFFSET UNITYSDK_OFFSET(0x96F6DC0)
#define RPG_CLIENT_MESSAGECONTENTBLOCK_GET_ISLASTMESSAGE_OFFSET UNITYSDK_OFFSET(0x96F6E20)
#define RPG_CLIENT_MESSAGECONTENTBLOCK_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x96F7050)
#define RPG_CLIENT_MESSAGECONTENTBLOCK_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x96F70D0)
#define RPG_CLIENT_MESSAGECONTENTBLOCK_SETMESSAGE_OFFSET UNITYSDK_OFFSET(0x96F6F20)
#define RPG_CLIENT_MESSAGECONTENTBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x96F6AE0)
#define RPG_CLIENT_MESSAGECONTENTBLOCK___IFIXBASEPROXY_EQUALS_OFFSET UNITYSDK_OFFSET(0x96F7180)
#define RPG_CLIENT_MESSAGECONTENTBLOCK___IFIXBASEPROXY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x96F7170)

namespace RPG::Client
{
	inline static constexpr unsigned int MessageContentBlock_TypeDefinitionIndex = 50186;

	class MessageContentBlock : public ::System::Object
	{
	public:
		::Class_0_16E4307DCC419505_570* _Message; // 0x10
		...
		::System::Void SetMessage(::Class_0_16E4307DCC419505_570* message)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_570*))((::PBYTE)hIl2Cpp + RPG_CLIENT_MESSAGECONTENTBLOCK_SETMESSAGE_OFFSET))(this, message);
		}
