...
#define RPG_CLIENT_OPEUTIL___C__DISPLAYCLASS32_0__CONVERTEVENTURL_B__0_OFFSET UNITYSDK_OFFSET(0x16FCF990)
#define RPG_CLIENT_OPEUTIL___C__DISPLAYCLASS32_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16FCBC10)
...
namespace RPG::Client
{
	...
	public:
		...
		::RPG::Client::ParseUrlCallBack* callBack; // 0x18
