...
#define RPG_CLIENT_OPEUTIL___C__DISPLAYCLASS32_0__CONVERTEVENTURL_B__0_OFFSET UNITYSDK_OFFSET(0x9EAD000)
#define RPG_CLIENT_OPEUTIL___C__DISPLAYCLASS32_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9EA91F0)
...
namespace RPG::Client
{
	...
	{
	public:
		::System::String* baseUrl; // 0x10
		::System::String* sourceUrl; // 0x18
		::RPG::Client::ParseUrlCallBack* callBack; // 0x20
