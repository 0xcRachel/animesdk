...
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION_ACCUMULATEDIVISIONEFFECTDESC_OFFSET UNITYSDK_OFFSET(0x16F16A40)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16F16820)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION_GETDIVISIONDATA_OFFSET UNITYSDK_OFFSET(0x16F16890)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION_GET_CURACCUMULATEEFFECTDESC_OFFSET UNITYSDK_OFFSET(0x16F17440)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION_GET_CURDIVISIONDATA_OFFSET UNITYSDK_OFFSET(0x16F171A0)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION_GET_CURDIVISIONLEVEL_OFFSET UNITYSDK_OFFSET(0x16F17160)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION_GET_CURDIVISIONPROGRESS_OFFSET UNITYSDK_OFFSET(0x16F17180)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION_GET_DIVISIONDATALIST_OFFSET UNITYSDK_OFFSET(0x16F169C0)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION_GET_ISDIVISIONMAX_OFFSET UNITYSDK_OFFSET(0x16F173E0)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION_GET_MAXDIVISIONDATA_OFFSET UNITYSDK_OFFSET(0x16F171F0)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION_GET_SEENDIVISIONINHERITMAINTOURNID_OFFSET UNITYSDK_OFFSET(0x16F17490)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION_SETNEWDIVISIONINHERITMAINTOURNID_OFFSET UNITYSDK_OFFSET(0x16F16CD0)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION_SET_CURDIVISIONLEVEL_OFFSET UNITYSDK_OFFSET(0x16F17170)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION_SET_CURDIVISIONPROGRESS_OFFSET UNITYSDK_OFFSET(0x16F17190)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION_SET_SEENDIVISIONINHERITMAINTOURNID_OFFSET UNITYSDK_OFFSET(0x16F16D20)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION_SYNC_OFFSET UNITYSDK_OFFSET(0x16F167C0)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16F167B0)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION__GENERATEDIVISIONINFO_OFFSET UNITYSDK_OFFSET(0x16F16E40)
