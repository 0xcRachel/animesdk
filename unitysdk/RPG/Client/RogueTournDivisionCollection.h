...
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION_ACCUMULATEDIVISIONEFFECTDESC_OFFSET UNITYSDK_OFFSET(0xA395A30)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA395810)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION_GETDIVISIONDATA_OFFSET UNITYSDK_OFFSET(0xA395880)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION_GET_CURACCUMULATEEFFECTDESC_OFFSET UNITYSDK_OFFSET(0xA396430)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION_GET_CURDIVISIONDATA_OFFSET UNITYSDK_OFFSET(0xA396190)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION_GET_CURDIVISIONLEVEL_OFFSET UNITYSDK_OFFSET(0xA396150)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION_GET_CURDIVISIONPROGRESS_OFFSET UNITYSDK_OFFSET(0xA396170)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION_GET_DIVISIONDATALIST_OFFSET UNITYSDK_OFFSET(0xA3959B0)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION_GET_ISDIVISIONMAX_OFFSET UNITYSDK_OFFSET(0xA3963D0)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION_GET_MAXDIVISIONDATA_OFFSET UNITYSDK_OFFSET(0xA3961E0)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION_GET_SEENDIVISIONINHERITMAINTOURNID_OFFSET UNITYSDK_OFFSET(0xA396480)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION_SETNEWDIVISIONINHERITMAINTOURNID_OFFSET UNITYSDK_OFFSET(0xA395CC0)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION_SET_CURDIVISIONLEVEL_OFFSET UNITYSDK_OFFSET(0xA396160)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION_SET_CURDIVISIONPROGRESS_OFFSET UNITYSDK_OFFSET(0xA396180)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION_SET_SEENDIVISIONINHERITMAINTOURNID_OFFSET UNITYSDK_OFFSET(0xA395D10)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION_SYNC_OFFSET UNITYSDK_OFFSET(0xA3957B0)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xA3957A0)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION__GENERATEDIVISIONINFO_OFFSET UNITYSDK_OFFSET(0xA395E30)
