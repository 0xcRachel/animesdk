...
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_EXITSUPEREVENTCAMERA_OFFSET UNITYSDK_OFFSET(0x15ABAB50)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_FOCUSSUPEREVENTCAMERA_OFFSET UNITYSDK_OFFSET(0x15ABA880)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETALLFACILITIES_OFFSET UNITYSDK_OFFSET(0x15AB5560)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETCHEFENTITYGROUP_OFFSET UNITYSDK_OFFSET(0x15AB63D0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETCUSTOMERENTITYGROUP_OFFSET UNITYSDK_OFFSET(0x15AB6500)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETEMPLOYEEENTITYGROUP_OFFSET UNITYSDK_OFFSET(0x15AB62A0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETENTITYWITHRUNTIMEID_OFFSET UNITYSDK_OFFSET(0x15AB23C0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETENTRYPOSITION_OFFSET UNITYSDK_OFFSET(0x15AB7090)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETGAMEENTITY_OFFSET UNITYSDK_OFFSET(0x15AB7120)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETGLOBALPROPERTY_OFFSET UNITYSDK_OFFSET(0x15AB7180)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETHEADWAITERENTITY_OFFSET UNITYSDK_OFFSET(0x15AB6630)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETONSITCUSTOMERCOUNT_OFFSET UNITYSDK_OFFSET(0x15AB68B0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETSTATETREEROOT_OFFSET UNITYSDK_OFFSET(0x15AB21D0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETTOTALSITCOUNT_OFFSET UNITYSDK_OFFSET(0x15AB6BC0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GET_GAMECONFIG_OFFSET UNITYSDK_OFFSET(0x15AB7310)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GET_SERVICES_OFFSET UNITYSDK_OFFSET(0x15AB7300)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_ONENTERRESTAURANTBUILD_OFFSET UNITYSDK_OFFSET(0x15AB3560)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_ONEXITRESTAURANTBUILD_OFFSET UNITYSDK_OFFSET(0x15AB3BA0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_PAUSEGAME_OFFSET UNITYSDK_OFFSET(0x15AB7380)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_RESUMEGAME_OFFSET UNITYSDK_OFFSET(0x15AB7830)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_SETGLOBALPROPERTY_OFFSET UNITYSDK_OFFSET(0x15AB7230)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_SETPREVIEWFACILITYACTIVE_OFFSET UNITYSDK_OFFSET(0x15ABB660)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_UPGRADEFACILITY_OFFSET UNITYSDK_OFFSET(0x15AB4580)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__ADDNOTIFY_OFFSET UNITYSDK_OFFSET(0x15AB2BE0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__APPLYTRANSPARENTMATERIAL_1_OFFSET UNITYSDK_OFFSET(0x15ABB2B0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__APPLYTRANSPARENTMATERIAL_OFFSET UNITYSDK_OFFSET(0x15ABB1F0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__CACHEORIGINALMATERIALS_1_OFFSET UNITYSDK_OFFSET(0x15ABAFB0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__CACHEORIGINALMATERIALS_OFFSET UNITYSDK_OFFSET(0x15ABAEF0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__CCTOR_OFFSET UNITYSDK_OFFSET(0x15ABBFB0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__CLEARTABLEOUTLINE_OFFSET UNITYSDK_OFFSET(0x15AB8F40)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__CREATEGAMECONTEXT_OFFSET UNITYSDK_OFFSET(0x15AB25D0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x15ABBEB0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__DESTROYGAMECONTEXT_OFFSET UNITYSDK_OFFSET(0x15AB3310)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__DISPOSEUIMEDIATOR_OFFSET UNITYSDK_OFFSET(0x15AB9AB0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__EXITCAMERA_OFFSET UNITYSDK_OFFSET(0x15AB3C00)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__EXITGAME_OFFSET UNITYSDK_OFFSET(0x15ABA610)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__FINISHGAME_OFFSET UNITYSDK_OFFSET(0x15ABA050)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__FOCUSRESTAURANTBUILDCAMERA_OFFSET UNITYSDK_OFFSET(0x15AB35C0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__FOCUSRESTAURANTCAMERA_OFFSET UNITYSDK_OFFSET(0x15AB85D0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__INITUIMEDIATOR_OFFSET UNITYSDK_OFFSET(0x15AB8360)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__ONCLEAR_OFFSET UNITYSDK_OFFSET(0x15AB30A0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__ONGAMERUN_OFFSET UNITYSDK_OFFSET(0x15AB9510)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__ONGROUPEVENT_OFFSET UNITYSDK_OFFSET(0x15ABAE20)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__ONINIT_OFFSET UNITYSDK_OFFSET(0x15AB2480)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__ONSCREENSIZECHANGED_OFFSET UNITYSDK_OFFSET(0x15ABA800)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__ONSTART_OFFSET UNITYSDK_OFFSET(0x15AB2D20)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__ONTICK_OFFSET UNITYSDK_OFFSET(0x15AB34B0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__PAUSEGAME_OFFSET UNITYSDK_OFFSET(0x15AB73E0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__PREPAREBUILDINGGAME_OFFSET UNITYSDK_OFFSET(0x15AB2DB0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__REAPPLYMATERIALS_1_OFFSET UNITYSDK_OFFSET(0x15ABBD60)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__REAPPLYMATERIALS_OFFSET UNITYSDK_OFFSET(0x15ABBB10)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__REMOVENOTIFY_OFFSET UNITYSDK_OFFSET(0x15AB31D0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__REMOVEUNPURCHASEDFACILITIES_OFFSET UNITYSDK_OFFSET(0x15AB3D60)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__RESETFACILITIES_OFFSET UNITYSDK_OFFSET(0x15ABA180)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__SETUPBOARD_OFFSET UNITYSDK_OFFSET(0x15AB7890)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__SETUPDECORATORS_OFFSET UNITYSDK_OFFSET(0x15AB7980)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__SETUPDEVICES_OFFSET UNITYSDK_OFFSET(0x15AB7B90)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__SETUPEMPLOYEES_OFFSET UNITYSDK_OFFSET(0x15AB8A00)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__SETUPGAMEENTITY_OFFSET UNITYSDK_OFFSET(0x15AB84B0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__SETUPLEVELCONFIG_OFFSET UNITYSDK_OFFSET(0x15AB2E10)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__SETUPNEXTUNPURCHASEDDECORATOR_OFFSET UNITYSDK_OFFSET(0x15ABB430)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__SETUPOBSTACLES_OFFSET UNITYSDK_OFFSET(0x15AB8D70)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__SETUPSMARTOBJECTENTITIES_OFFSET UNITYSDK_OFFSET(0x15AB8910)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__SETUPTABLES_OFFSET UNITYSDK_OFFSET(0x15AB7DA0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__SETUPUNPURCHASEDFACILITIES_OFFSET UNITYSDK_OFFSET(0x15AB3710)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__STARTGAME_OFFSET UNITYSDK_OFFSET(0x15AB80B0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__TRIGGERGROUPEVENT_OFFSET UNITYSDK_OFFSET(0x15ABA760)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__UPGRADEDECORATOR_OFFSET UNITYSDK_OFFSET(0x15AB4D30)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__UPGRADEDEVICE_OFFSET UNITYSDK_OFFSET(0x15AB5130)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__UPGRADETABLE_OFFSET UNITYSDK_OFFSET(0x15AB4610)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE___IFIXBASEPROXY_GETSTATETREEROOT_OFFSET UNITYSDK_OFFSET(0x15ABC180)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE___IFIXBASEPROXY__ONCLEAR_OFFSET UNITYSDK_OFFSET(0x15ABC2C0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE___IFIXBASEPROXY__ONINIT_OFFSET UNITYSDK_OFFSET(0x15ABC1F0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE___IFIXBASEPROXY__ONSTART_OFFSET UNITYSDK_OFFSET(0x15ABC260)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE___IFIXBASEPROXY__ONTICK_OFFSET UNITYSDK_OFFSET(0x15ABC320)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE___SETUPUNPURCHASEDFACILITIES_B__56_0_OFFSET UNITYSDK_OFFSET(0x15ABBFF0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(ElfRestaurantGameInstance_TypeDefinitionIndex)->GetStaticField(0x8D60);
		}
		...
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::Class_1_9CBC71DC5240DC00*>* _RendererCacheMap; // 0xA8
		::RPG::Client::LittleGame::ElfRestaurantGameEntity* _BoardEntity; // 0xB0
