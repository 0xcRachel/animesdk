...
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_EXITSUPEREVENTCAMERA_OFFSET UNITYSDK_OFFSET(0x95E5320)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_FOCUSSUPEREVENTCAMERA_OFFSET UNITYSDK_OFFSET(0x95E5050)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETALLFACILITIES_OFFSET UNITYSDK_OFFSET(0x95DFDA0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETCHEFENTITYGROUP_OFFSET UNITYSDK_OFFSET(0x95E0C10)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETCUSTOMERENTITYGROUP_OFFSET UNITYSDK_OFFSET(0x95E0D40)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETEMPLOYEEENTITYGROUP_OFFSET UNITYSDK_OFFSET(0x95E0AE0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETENTITYWITHRUNTIMEID_OFFSET UNITYSDK_OFFSET(0x95DCBF0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETENTRYPOSITION_OFFSET UNITYSDK_OFFSET(0x95E18D0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETGAMEENTITY_OFFSET UNITYSDK_OFFSET(0x95E1960)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETGLOBALPROPERTY_OFFSET UNITYSDK_OFFSET(0x95E19C0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETHEADWAITERENTITY_OFFSET UNITYSDK_OFFSET(0x95E0E70)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETONSITCUSTOMERCOUNT_OFFSET UNITYSDK_OFFSET(0x95E10F0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETSTATETREEROOT_OFFSET UNITYSDK_OFFSET(0x95DCA00)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETTOTALSITCOUNT_OFFSET UNITYSDK_OFFSET(0x95E1400)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GET_GAMECONFIG_OFFSET UNITYSDK_OFFSET(0x95E1B50)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GET_SERVICES_OFFSET UNITYSDK_OFFSET(0x95E1B40)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_ONENTERRESTAURANTBUILD_OFFSET UNITYSDK_OFFSET(0x95DDDA0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_ONEXITRESTAURANTBUILD_OFFSET UNITYSDK_OFFSET(0x95DE3E0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_PAUSEGAME_OFFSET UNITYSDK_OFFSET(0x95E1BC0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_RESUMEGAME_OFFSET UNITYSDK_OFFSET(0x95E2070)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_SETGLOBALPROPERTY_OFFSET UNITYSDK_OFFSET(0x95E1A70)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_SETPREVIEWFACILITYACTIVE_OFFSET UNITYSDK_OFFSET(0x95E5E30)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_UPGRADEFACILITY_OFFSET UNITYSDK_OFFSET(0x95DEDC0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__ADDNOTIFY_OFFSET UNITYSDK_OFFSET(0x95DD420)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__APPLYTRANSPARENTMATERIAL_1_OFFSET UNITYSDK_OFFSET(0x95E5A80)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__APPLYTRANSPARENTMATERIAL_OFFSET UNITYSDK_OFFSET(0x95E59C0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__CACHEORIGINALMATERIALS_1_OFFSET UNITYSDK_OFFSET(0x95E5780)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__CACHEORIGINALMATERIALS_OFFSET UNITYSDK_OFFSET(0x95E56C0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__CCTOR_OFFSET UNITYSDK_OFFSET(0x95E6780)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__CLEARTABLEOUTLINE_OFFSET UNITYSDK_OFFSET(0x95E3760)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__CREATEGAMECONTEXT_OFFSET UNITYSDK_OFFSET(0x95DCE00)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x95E6680)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__DESTROYGAMECONTEXT_OFFSET UNITYSDK_OFFSET(0x95DDB50)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__DISPOSEUIMEDIATOR_OFFSET UNITYSDK_OFFSET(0x95E4280)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__EXITCAMERA_OFFSET UNITYSDK_OFFSET(0x95DE440)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__EXITGAME_OFFSET UNITYSDK_OFFSET(0x95E4DE0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__FINISHGAME_OFFSET UNITYSDK_OFFSET(0x95E4820)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__FOCUSRESTAURANTBUILDCAMERA_OFFSET UNITYSDK_OFFSET(0x95DDE00)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__FOCUSRESTAURANTCAMERA_OFFSET UNITYSDK_OFFSET(0x95E2E00)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__INITUIMEDIATOR_OFFSET UNITYSDK_OFFSET(0x95E2B90)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__ONCLEAR_OFFSET UNITYSDK_OFFSET(0x95DD8E0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__ONGAMERUN_OFFSET UNITYSDK_OFFSET(0x95E3CE0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__ONGROUPEVENT_OFFSET UNITYSDK_OFFSET(0x95E55F0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__ONINIT_OFFSET UNITYSDK_OFFSET(0x95DCCB0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__ONSCREENSIZECHANGED_OFFSET UNITYSDK_OFFSET(0x95E4FD0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__ONSTART_OFFSET UNITYSDK_OFFSET(0x95DD560)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__ONTICK_OFFSET UNITYSDK_OFFSET(0x95DDCF0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__PAUSEGAME_OFFSET UNITYSDK_OFFSET(0x95E1C20)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__PREPAREBUILDINGGAME_OFFSET UNITYSDK_OFFSET(0x95DD5F0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__REAPPLYMATERIALS_1_OFFSET UNITYSDK_OFFSET(0x95E6530)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__REAPPLYMATERIALS_OFFSET UNITYSDK_OFFSET(0x95E62E0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__REMOVENOTIFY_OFFSET UNITYSDK_OFFSET(0x95DDA10)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__REMOVEUNPURCHASEDFACILITIES_OFFSET UNITYSDK_OFFSET(0x95DE5A0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__RESETFACILITIES_OFFSET UNITYSDK_OFFSET(0x95E4950)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__SETUPBOARD_OFFSET UNITYSDK_OFFSET(0x95E20D0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__SETUPDECORATORS_OFFSET UNITYSDK_OFFSET(0x95E21C0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__SETUPDEVICES_OFFSET UNITYSDK_OFFSET(0x95E23D0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__SETUPEMPLOYEES_OFFSET UNITYSDK_OFFSET(0x95E3220)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__SETUPGAMEENTITY_OFFSET UNITYSDK_OFFSET(0x95E2CE0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__SETUPLEVELCONFIG_OFFSET UNITYSDK_OFFSET(0x95DD650)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__SETUPNEXTUNPURCHASEDDECORATOR_OFFSET UNITYSDK_OFFSET(0x95E5C00)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__SETUPOBSTACLES_OFFSET UNITYSDK_OFFSET(0x95E3590)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__SETUPSMARTOBJECTENTITIES_OFFSET UNITYSDK_OFFSET(0x95E3130)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__SETUPTABLES_OFFSET UNITYSDK_OFFSET(0x95E25E0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__SETUPUNPURCHASEDFACILITIES_OFFSET UNITYSDK_OFFSET(0x95DDF50)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__STARTGAME_OFFSET UNITYSDK_OFFSET(0x95E28E0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__TRIGGERGROUPEVENT_OFFSET UNITYSDK_OFFSET(0x95E4F30)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__UPGRADEDECORATOR_OFFSET UNITYSDK_OFFSET(0x95DF570)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__UPGRADEDEVICE_OFFSET UNITYSDK_OFFSET(0x95DF970)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__UPGRADETABLE_OFFSET UNITYSDK_OFFSET(0x95DEE50)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE___IFIXBASEPROXY_GETSTATETREEROOT_OFFSET UNITYSDK_OFFSET(0x95E6950)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE___IFIXBASEPROXY__ONCLEAR_OFFSET UNITYSDK_OFFSET(0x95E6A90)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE___IFIXBASEPROXY__ONINIT_OFFSET UNITYSDK_OFFSET(0x95E69C0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE___IFIXBASEPROXY__ONSTART_OFFSET UNITYSDK_OFFSET(0x95E6A30)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE___IFIXBASEPROXY__ONTICK_OFFSET UNITYSDK_OFFSET(0x95E6AF0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE___SETUPUNPURCHASEDFACILITIES_B__56_0_OFFSET UNITYSDK_OFFSET(0x95E67C0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(ElfRestaurantGameInstance_TypeDefinitionIndex)->GetStaticField(0xE450);
		}
		::RPG::Client::LittleGame::ElfRestaurantGameEntity* _BoardEntity; // 0x78
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::Class_1_9CBC71DC5240DC00*>* _RendererCacheMap; // 0x80
		::Class_3_68E4C4E7E4DEB30E* _UpdateSystems; // 0x88
		::RPG::Client::ElfRestaurantModule* _ElfRestaurantModule; // 0x90
		::Class_1_867B6CE75953535A* _Contexts; // 0x98
