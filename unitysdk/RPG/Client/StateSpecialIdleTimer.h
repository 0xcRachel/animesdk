...
#define RPG_CLIENT_STATESPECIALIDLETIMER_METHOD_5_00B48D91709955E0_OFFSET UNITYSDK_OFFSET(0x9FC75E0)
#define RPG_CLIENT_STATESPECIALIDLETIMER_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9FC7450)
#define RPG_CLIENT_STATESPECIALIDLETIMER__CTOR_OFFSET UNITYSDK_OFFSET(0x9FC7670)
#define RPG_CLIENT_STATESPECIALIDLETIMER___IFIXBASEPROXY_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9FC7680)

namespace RPG::Client
{
	inline static constexpr unsigned int StateSpecialIdleTimer_TypeDefinitionIndex = 54681;
