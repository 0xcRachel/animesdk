...
#define RPG_CLIENT_ROGUETOURNMODULE___C__DISPLAYCLASS61_0__APPLYROGUETOURNBUILDREF_B__0_OFFSET UNITYSDK_OFFSET(0x17576C30)
#define RPG_CLIENT_ROGUETOURNMODULE___C__DISPLAYCLASS61_0__APPLYROGUETOURNBUILDREF_B__1_OFFSET UNITYSDK_OFFSET(0x17576CD0)
#define RPG_CLIENT_ROGUETOURNMODULE___C__DISPLAYCLASS61_0__APPLYROGUETOURNBUILDREF_B__2_OFFSET UNITYSDK_OFFSET(0x17576860)
#define RPG_CLIENT_ROGUETOURNMODULE___C__DISPLAYCLASS61_0__APPLYROGUETOURNBUILDREF_B__3_OFFSET UNITYSDK_OFFSET(0x17576C10)
#define RPG_CLIENT_ROGUETOURNMODULE___C__DISPLAYCLASS61_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1756B2E0)
