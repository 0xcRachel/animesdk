...
#define RPG_CLIENT_UIAUTOFLIPMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xA19D1E0)
#define RPG_CLIENT_UIAUTOFLIPMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xA19D230)
#define RPG_CLIENT_UIAUTOFLIPMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xA19D250)

namespace RPG::Client
{
	inline static constexpr unsigned int UIAutoFlipMonoPlugin_TypeDefinitionIndex = 56611;
