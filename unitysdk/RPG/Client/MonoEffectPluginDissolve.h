...
#define RPG_CLIENT_MONOEFFECTPLUGINDISSOLVE_METHOD_8_43D99DDD80B1E30C_OFFSET UNITYSDK_OFFSET(0x97F8740)
#define RPG_CLIENT_MONOEFFECTPLUGINDISSOLVE_METHOD_8_749948B663FCCCEF_OFFSET UNITYSDK_OFFSET(0x97F95B0)
#define RPG_CLIENT_MONOEFFECTPLUGINDISSOLVE_METHOD_8_A03BCE6471ADC02C_OFFSET UNITYSDK_OFFSET(0x97F9020)
#define RPG_CLIENT_MONOEFFECTPLUGINDISSOLVE_METHOD_8_E41B6A823556FEEA_OFFSET UNITYSDK_OFFSET(0x97F94A0)
#define RPG_CLIENT_MONOEFFECTPLUGINDISSOLVE_METHOD_8_F4ADC37B63F4E9EF_OFFSET UNITYSDK_OFFSET(0x97F9630)
#define RPG_CLIENT_MONOEFFECTPLUGINDISSOLVE_METHOD_8_F5447CD65612575D_OFFSET UNITYSDK_OFFSET(0x97F95A0)
#define RPG_CLIENT_MONOEFFECTPLUGINDISSOLVE__CTOR_OFFSET UNITYSDK_OFFSET(0x97F9540)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginDissolve_TypeDefinitionIndex = 55713;
