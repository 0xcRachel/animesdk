...
#define RPG_CLIENT_ROGUETOURNSETTLETOURNEXPINFOITEM_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0xA3E11C0)
#define RPG_CLIENT_ROGUETOURNSETTLETOURNEXPINFOITEM_GET_ISREACHLIMIT_OFFSET UNITYSDK_OFFSET(0xA3E0C20)
#define RPG_CLIENT_ROGUETOURNSETTLETOURNEXPINFOITEM_GET_TOTALVALUEBEFORE_OFFSET UNITYSDK_OFFSET(0xA3E1040)
#define RPG_CLIENT_ROGUETOURNSETTLETOURNEXPINFOITEM_GET_TOTALVALUE_OFFSET UNITYSDK_OFFSET(0xA3E1020)
#define RPG_CLIENT_ROGUETOURNSETTLETOURNEXPINFOITEM_GET_VALUEEXTRA_OFFSET UNITYSDK_OFFSET(0xA3E0F70)
#define RPG_CLIENT_ROGUETOURNSETTLETOURNEXPINFOITEM_GET_VALUE_OFFSET UNITYSDK_OFFSET(0xA3E0EC0)
#define RPG_CLIENT_ROGUETOURNSETTLETOURNEXPINFOITEM_SET_TOTALVALUE_OFFSET UNITYSDK_OFFSET(0xA3E1030)
#define RPG_CLIENT_ROGUETOURNSETTLETOURNEXPINFOITEM_SYNCTOURNEXP_OFFSET UNITYSDK_OFFSET(0xA3DFE20)
#define RPG_CLIENT_ROGUETOURNSETTLETOURNEXPINFOITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xA3DE0A0)
