...
#define RPG_CLIENT_ROGUETOURNSETTLETOURNEXPINFOITEM_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x172EBBF0)
#define RPG_CLIENT_ROGUETOURNSETTLETOURNEXPINFOITEM_GET_ISREACHLIMIT_OFFSET UNITYSDK_OFFSET(0x172EB650)
#define RPG_CLIENT_ROGUETOURNSETTLETOURNEXPINFOITEM_GET_TOTALVALUEBEFORE_OFFSET UNITYSDK_OFFSET(0x172EBA70)
#define RPG_CLIENT_ROGUETOURNSETTLETOURNEXPINFOITEM_GET_TOTALVALUE_OFFSET UNITYSDK_OFFSET(0x172EBA50)
#define RPG_CLIENT_ROGUETOURNSETTLETOURNEXPINFOITEM_GET_VALUEEXTRA_OFFSET UNITYSDK_OFFSET(0x172EB9A0)
#define RPG_CLIENT_ROGUETOURNSETTLETOURNEXPINFOITEM_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x172EB8F0)
#define RPG_CLIENT_ROGUETOURNSETTLETOURNEXPINFOITEM_SET_TOTALVALUE_OFFSET UNITYSDK_OFFSET(0x172EBA60)
#define RPG_CLIENT_ROGUETOURNSETTLETOURNEXPINFOITEM_SYNCTOURNEXP_OFFSET UNITYSDK_OFFSET(0x172EA850)
#define RPG_CLIENT_ROGUETOURNSETTLETOURNEXPINFOITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x172E8AD0)
