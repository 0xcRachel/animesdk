...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::Class_1_F5630E87DACEF386_DelegateParseBinary_1<::RPG::Client::GamePlayLockTarget>**)Il2CppClass::FromTypeDefinitionIndex(LockTargetConfigList___O_TypeDefinitionIndex)->GetStaticField(0x53C60);
		}
	};
}
