...
#define RPG_CLIENT_ACTIVEACTIVITYPANELDATA_GET_ACTIVEACTIVITYDATA_OFFSET UNITYSDK_OFFSET(0x8ADC910)
#define RPG_CLIENT_ACTIVEACTIVITYPANELDATA_ISEXTRACONDSATISFY_OFFSET UNITYSDK_OFFSET(0x8ADC8C0)
#define RPG_CLIENT_ACTIVEACTIVITYPANELDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x8ADCA40)
#define RPG_CLIENT_ACTIVEACTIVITYPANELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8ADC8B0)
#define RPG_CLIENT_ACTIVEACTIVITYPANELDATA__ISNEEDSHOWDAILYREDDOT_OFFSET UNITYSDK_OFFSET(0x8ADCA00)
#define RPG_CLIENT_ACTIVEACTIVITYPANELDATA__ONACTIVITYOPENEDCUSTOM_OFFSET UNITYSDK_OFFSET(0x8ADCBC0)
#define RPG_CLIENT_ACTIVEACTIVITYPANELDATA___IFIXBASEPROXY_ISEXTRACONDSATISFY_OFFSET UNITYSDK_OFFSET(0x8ADCE70)
#define RPG_CLIENT_ACTIVEACTIVITYPANELDATA___IFIXBASEPROXY_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x8ADCEF0)
#define RPG_CLIENT_ACTIVEACTIVITYPANELDATA___IFIXBASEPROXY__ISNEEDSHOWDAILYREDDOT_OFFSET UNITYSDK_OFFSET(0x8ADCEE0)
#define RPG_CLIENT_ACTIVEACTIVITYPANELDATA___IFIXBASEPROXY__ONACTIVITYOPENEDCUSTOM_OFFSET UNITYSDK_OFFSET(0x8ADCF60)

namespace RPG::Client
{
	inline static constexpr unsigned int ActiveActivityPanelData_TypeDefinitionIndex = 48819;
