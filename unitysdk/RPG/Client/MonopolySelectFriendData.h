...
#define RPG_CLIENT_MONOPOLYSELECTFRIENDDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x98A1CC0)
#define RPG_CLIENT_MONOPOLYSELECTFRIENDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x98A1D50)

namespace RPG::Client
{
	inline static constexpr unsigned int MonopolySelectFriendData_TypeDefinitionIndex = 52730;
