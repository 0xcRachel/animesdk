...
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_DEBUG_UPDATEALLSPEEDREGIONINFO_OFFSET UNITYSDK_OFFSET(0x9A3A130)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_61D63D85BCB76B0E_OFFSET UNITYSDK_OFFSET(0x9A3A4A0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_72D8343319FB1CDB_OFFSET UNITYSDK_OFFSET(0x9A39BB0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_853E3C989ACA913F_OFFSET UNITYSDK_OFFSET(0x9A38FC0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_921B5EE2DA323FBF_OFFSET UNITYSDK_OFFSET(0x9A3CC90)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_CA9AD3D703CC4954_OFFSET UNITYSDK_OFFSET(0x9A3CEF0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_EBA1FCD99A55B4C2_OFFSET UNITYSDK_OFFSET(0x9A39AB0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_F908AFB307A0D324_OFFSET UNITYSDK_OFFSET(0x9A3B270)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_FC9369A30C0BC9DC_OFFSET UNITYSDK_OFFSET(0x9A3C7A0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x9A385F0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_UPDATEENDPOINTPYNEXTCONNECTIONSTART_OFFSET UNITYSDK_OFFSET(0x9A3B160)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_UPDATEGENERATE_OFFSET UNITYSDK_OFFSET(0x9A3BED0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_UPDATENEXTCONNECTIONSTARTPOINT_OFFSET UNITYSDK_OFFSET(0x9A3A2B0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD__CTOR_OFFSET UNITYSDK_OFFSET(0x9A3D070)

namespace RPG::Client::ParkourGame
{
	inline static constexpr unsigned int MonoParkourRoad_TypeDefinitionIndex = 59061;
