...
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_DEBUG_UPDATEALLSPEEDREGIONINFO_OFFSET UNITYSDK_OFFSET(0x162CB470)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_61D63D85BCB76B0E_OFFSET UNITYSDK_OFFSET(0x162CB7E0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_72D8343319FB1CDB_OFFSET UNITYSDK_OFFSET(0x162CAEF0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_853E3C989ACA913F_OFFSET UNITYSDK_OFFSET(0x162CA300)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_921B5EE2DA323FBF_OFFSET UNITYSDK_OFFSET(0x162CDFD0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_CA9AD3D703CC4954_OFFSET UNITYSDK_OFFSET(0x162CE240)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_EBA1FCD99A55B4C2_OFFSET UNITYSDK_OFFSET(0x162CADF0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_F908AFB307A0D324_OFFSET UNITYSDK_OFFSET(0x162CC5B0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_FC9369A30C0BC9DC_OFFSET UNITYSDK_OFFSET(0x162CDAE0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x162C9930)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_UPDATEENDPOINTPYNEXTCONNECTIONSTART_OFFSET UNITYSDK_OFFSET(0x162CC4A0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_UPDATEGENERATE_OFFSET UNITYSDK_OFFSET(0x162CD210)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_UPDATENEXTCONNECTIONSTARTPOINT_OFFSET UNITYSDK_OFFSET(0x162CB5F0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD__CTOR_OFFSET UNITYSDK_OFFSET(0x162CE3F0)

namespace RPG::Client::ParkourGame
{
	inline static constexpr unsigned int MonoParkourRoad_TypeDefinitionIndex = 68262;
