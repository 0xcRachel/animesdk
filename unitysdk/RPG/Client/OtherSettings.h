...
#define RPG_CLIENT_OTHERSETTINGS_GET_AUTOBATTLEOPEN_OFFSET UNITYSDK_OFFSET(0x9A24060)
#define RPG_CLIENT_OTHERSETTINGS_GET_BOTTOMSHORTCUTHINTFORCONTROLLER_OFFSET UNITYSDK_OFFSET(0x9A24440)
#define RPG_CLIENT_OTHERSETTINGS_GET_BOTTOMSHORTCUTHINT_OFFSET UNITYSDK_OFFSET(0x9A24350)
#define RPG_CLIENT_OTHERSETTINGS_GET_CAMERAROTATIONSPEEDRATIOGEARFORCONTROLLER_OFFSET UNITYSDK_OFFSET(0x9A23F70)
#define RPG_CLIENT_OTHERSETTINGS_GET_CAMERAROTATIONSPEEDRATIOGEARFORPC_OFFSET UNITYSDK_OFFSET(0x9A23D90)
#define RPG_CLIENT_OTHERSETTINGS_GET_CAMERAROTATIONSPEEDRATIOGEARFORPHONE_OFFSET UNITYSDK_OFFSET(0x9A23E80)
#define RPG_CLIENT_OTHERSETTINGS_GET_CAMERAXAXISINVERSIONSWITCH_OFFSET UNITYSDK_OFFSET(0x9A24250)
#define RPG_CLIENT_OTHERSETTINGS_GET_CAMERAYAXISINVERSIONSWITCH_OFFSET UNITYSDK_OFFSET(0x9A24150)
#define RPG_CLIENT_OTHERSETTINGS_GET_DRAGDISTANCEGEARFORCHANGETARGET_OFFSET UNITYSDK_OFFSET(0x9A239D0)
#define RPG_CLIENT_OTHERSETTINGS_GET_FASTRUNSWITCHFORPC_OFFSET UNITYSDK_OFFSET(0x9A23820)
#define RPG_CLIENT_OTHERSETTINGS_GET_FIVEDIMPHONEMOVEINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x9A24620)
#define RPG_CLIENT_OTHERSETTINGS_GET_ISAICONSIDERULTRASKILL_OFFSET UNITYSDK_OFFSET(0x9A23070)
#define RPG_CLIENT_OTHERSETTINGS_GET_ISFORBIDBATTLELOG_OFFSET UNITYSDK_OFFSET(0x9A23370)
#define RPG_CLIENT_OTHERSETTINGS_GET_ISFORBIDUNITYLOG_OFFSET UNITYSDK_OFFSET(0x9A23280)
#define RPG_CLIENT_OTHERSETTINGS_GET_ISREPLAYTALKDEFAULTAUTOSELECT_OFFSET UNITYSDK_OFFSET(0x9A23640)
#define RPG_CLIENT_OTHERSETTINGS_GET_ISREPLAYTALKDEFAULTAUTO_OFFSET UNITYSDK_OFFSET(0x9A23550)
#define RPG_CLIENT_OTHERSETTINGS_GET_ISSAVEBATTLESPEED_OFFSET UNITYSDK_OFFSET(0x9A23190)
#define RPG_CLIENT_OTHERSETTINGS_GET_ISTALKDEFAULTAUTO_OFFSET UNITYSDK_OFFSET(0x9A23460)
#define RPG_CLIENT_OTHERSETTINGS_GET_SHOWBATTLEACTIONDELAY_OFFSET UNITYSDK_OFFSET(0x9A23730)
#define RPG_CLIENT_OTHERSETTINGS_GET_USEDEFAULTPAMSKININSTORYPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x9A24530)
#define RPG_CLIENT_OTHERSETTINGS_GET_VIBRATIONINTENSITYFORCONTROLLER_OFFSET UNITYSDK_OFFSET(0x9A24710)
#define RPG_CLIENT_OTHERSETTINGS_GET_ZOOMSPEEDRATIOGEARFORCONTROLLER_OFFSET UNITYSDK_OFFSET(0x9A23CA0)
#define RPG_CLIENT_OTHERSETTINGS_GET_ZOOMSPEEDRATIOGEARFORPC_OFFSET UNITYSDK_OFFSET(0x9A23BB0)
#define RPG_CLIENT_OTHERSETTINGS_GET_ZOOMSPEEDRATIOGEARFORPHONE_OFFSET UNITYSDK_OFFSET(0x9A23AC0)
#define RPG_CLIENT_OTHERSETTINGS_SET_AUTOBATTLEOPEN_OFFSET UNITYSDK_OFFSET(0x9A240D0)
#define RPG_CLIENT_OTHERSETTINGS_SET_BOTTOMSHORTCUTHINTFORCONTROLLER_OFFSET UNITYSDK_OFFSET(0x9A244B0)
#define RPG_CLIENT_OTHERSETTINGS_SET_BOTTOMSHORTCUTHINT_OFFSET UNITYSDK_OFFSET(0x9A243C0)
#define RPG_CLIENT_OTHERSETTINGS_SET_CAMERAROTATIONSPEEDRATIOGEARFORCONTROLLER_OFFSET UNITYSDK_OFFSET(0x9A23FE0)
#define RPG_CLIENT_OTHERSETTINGS_SET_CAMERAROTATIONSPEEDRATIOGEARFORPC_OFFSET UNITYSDK_OFFSET(0x9A23E00)
#define RPG_CLIENT_OTHERSETTINGS_SET_CAMERAROTATIONSPEEDRATIOGEARFORPHONE_OFFSET UNITYSDK_OFFSET(0x9A23EF0)
#define RPG_CLIENT_OTHERSETTINGS_SET_CAMERAXAXISINVERSIONSWITCH_OFFSET UNITYSDK_OFFSET(0x9A242C0)
#define RPG_CLIENT_OTHERSETTINGS_SET_CAMERAYAXISINVERSIONSWITCH_OFFSET UNITYSDK_OFFSET(0x9A241C0)
#define RPG_CLIENT_OTHERSETTINGS_SET_DRAGDISTANCEGEARFORCHANGETARGET_OFFSET UNITYSDK_OFFSET(0x9A23A40)
#define RPG_CLIENT_OTHERSETTINGS_SET_FASTRUNSWITCHFORPC_OFFSET UNITYSDK_OFFSET(0x9A238E0)
#define RPG_CLIENT_OTHERSETTINGS_SET_FIVEDIMPHONEMOVEINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x9A24690)
#define RPG_CLIENT_OTHERSETTINGS_SET_ISAICONSIDERULTRASKILL_OFFSET UNITYSDK_OFFSET(0x9A230E0)
#define RPG_CLIENT_OTHERSETTINGS_SET_ISFORBIDBATTLELOG_OFFSET UNITYSDK_OFFSET(0x9A233E0)
#define RPG_CLIENT_OTHERSETTINGS_SET_ISFORBIDUNITYLOG_OFFSET UNITYSDK_OFFSET(0x9A232F0)
#define RPG_CLIENT_OTHERSETTINGS_SET_ISREPLAYTALKDEFAULTAUTOSELECT_OFFSET UNITYSDK_OFFSET(0x9A236B0)
#define RPG_CLIENT_OTHERSETTINGS_SET_ISREPLAYTALKDEFAULTAUTO_OFFSET UNITYSDK_OFFSET(0x9A235C0)
#define RPG_CLIENT_OTHERSETTINGS_SET_ISSAVEBATTLESPEED_OFFSET UNITYSDK_OFFSET(0x9A23200)
#define RPG_CLIENT_OTHERSETTINGS_SET_ISTALKDEFAULTAUTO_OFFSET UNITYSDK_OFFSET(0x9A234D0)
#define RPG_CLIENT_OTHERSETTINGS_SET_SHOWBATTLEACTIONDELAY_OFFSET UNITYSDK_OFFSET(0x9A237A0)
#define RPG_CLIENT_OTHERSETTINGS_SET_USEDEFAULTPAMSKININSTORYPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x9A245A0)
#define RPG_CLIENT_OTHERSETTINGS_SET_VIBRATIONINTENSITYFORCONTROLLER_OFFSET UNITYSDK_OFFSET(0x9A24780)
#define RPG_CLIENT_OTHERSETTINGS_SET_ZOOMSPEEDRATIOGEARFORCONTROLLER_OFFSET UNITYSDK_OFFSET(0x9A23D10)
#define RPG_CLIENT_OTHERSETTINGS_SET_ZOOMSPEEDRATIOGEARFORPC_OFFSET UNITYSDK_OFFSET(0x9A23C20)
#define RPG_CLIENT_OTHERSETTINGS_SET_ZOOMSPEEDRATIOGEARFORPHONE_OFFSET UNITYSDK_OFFSET(0x9A23B30)
#define RPG_CLIENT_OTHERSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x9A22FF0)

namespace RPG::Client
{
	inline static constexpr unsigned int OtherSettings_TypeDefinitionIndex = 46933;
