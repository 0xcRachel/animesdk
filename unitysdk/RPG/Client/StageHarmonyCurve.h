...
#define RPG_CLIENT_STAGEHARMONYCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x9FA79C0)

namespace RPG::Client
{
	inline static constexpr unsigned int StageHarmonyCurve_TypeDefinitionIndex = 56558;
