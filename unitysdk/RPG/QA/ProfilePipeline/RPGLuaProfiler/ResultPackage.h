...
#define RPG_QA_PROFILEPIPELINE_RPGLUAPROFILER_RESULTPACKAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xA5C8BA0)

namespace RPG::QA::ProfilePipeline::RPGLuaProfiler
{
	inline static constexpr unsigned int ResultPackage_TypeDefinitionIndex = 40814;
