...
#define RPG_QA_QAMANAGER_LOGINFOSENDER_SENDLOG_OFFSET UNITYSDK_OFFSET(0xA5CAD50)
#define RPG_QA_QAMANAGER_LOGINFOSENDER__CTOR_OFFSET UNITYSDK_OFFSET(0xA5CA5A0)

namespace RPG::QA
{
	inline static constexpr unsigned int QAManager_LogInfoSender_TypeDefinitionIndex = 40807;
