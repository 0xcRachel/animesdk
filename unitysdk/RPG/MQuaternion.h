...
#define RPG_MQUATERNION_ANGLE_OFFSET UNITYSDK_OFFSET(0x172BC1A0)
#define RPG_MQUATERNION_CREATEQUATERNIONFROMAXISQUATERNIONS_OFFSET UNITYSDK_OFFSET(0x172BCBF0)
#define RPG_MQUATERNION_DOT_OFFSET UNITYSDK_OFFSET(0x172BC130)
#define RPG_MQUATERNION_EQUALS_OFFSET UNITYSDK_OFFSET(0x2028180)
#define RPG_MQUATERNION_EULER_OFFSET UNITYSDK_OFFSET(0x172BC9F0)
#define RPG_MQUATERNION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2020090)
#define RPG_MQUATERNION_GET_EULERANGLES_OFFSET UNITYSDK_OFFSET(0x2028160)
#define RPG_MQUATERNION_GET_IDENTITY_OFFSET UNITYSDK_OFFSET(0x172BBF00)
#define RPG_MQUATERNION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x2028000)
#define RPG_MQUATERNION_INTERNAL_MAKEPOSITIVE_OFFSET UNITYSDK_OFFSET(0x172BC200)
#define RPG_MQUATERNION_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x172BC0F0)
#define RPG_MQUATERNION_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x172BC160)
#define RPG_MQUATERNION_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x172BBFC0)
#define RPG_MQUATERNION_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x172BBF10)
#define RPG_MQUATERNION_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x20280B0)
#define RPG_MQUATERNION_SET_OFFSET UNITYSDK_OFFSET(0x24C90)
#define RPG_MQUATERNION_TOEULERANGLE_OFFSET UNITYSDK_OFFSET(0x172BBB90)
#define RPG_MQUATERNION_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x2028290)
#define RPG_MQUATERNION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x2028280)
#define RPG_MQUATERNION__CCTOR_OFFSET UNITYSDK_OFFSET(0x172BCDA0)
#define RPG_MQUATERNION__CTOR_OFFSET UNITYSDK_OFFSET(0x24C90)

namespace RPG
{
	inline static constexpr unsigned int MQuaternion_TypeDefinitionIndex = 8574;

	struct alignas(4) MQuaternion
	{
		static ::RPG::MQuaternion* StaticGet_identityQuaternion()
		{
			return (::RPG::MQuaternion*)Il2CppClass::FromTypeDefinitionIndex(MQuaternion_TypeDefinitionIndex)->GetStaticField(0xABD0);
		}
