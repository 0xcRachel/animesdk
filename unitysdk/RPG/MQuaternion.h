...
#define RPG_MQUATERNION_ANGLE_OFFSET UNITYSDK_OFFSET(0x17A78360)
#define RPG_MQUATERNION_CREATEQUATERNIONFROMAXISQUATERNIONS_OFFSET UNITYSDK_OFFSET(0x17A78DB0)
#define RPG_MQUATERNION_DOT_OFFSET UNITYSDK_OFFSET(0x17A782F0)
#define RPG_MQUATERNION_EQUALS_OFFSET UNITYSDK_OFFSET(0x20FE550)
#define RPG_MQUATERNION_EULER_OFFSET UNITYSDK_OFFSET(0x17A78BB0)
#define RPG_MQUATERNION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x20F7890)
#define RPG_MQUATERNION_GET_EULERANGLES_OFFSET UNITYSDK_OFFSET(0x20FE530)
#define RPG_MQUATERNION_GET_IDENTITY_OFFSET UNITYSDK_OFFSET(0x17A780C0)
#define RPG_MQUATERNION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x20FE3D0)
#define RPG_MQUATERNION_INTERNAL_MAKEPOSITIVE_OFFSET UNITYSDK_OFFSET(0x17A783C0)
#define RPG_MQUATERNION_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x17A782B0)
#define RPG_MQUATERNION_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x17A78320)
#define RPG_MQUATERNION_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x17A78180)
#define RPG_MQUATERNION_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x17A780D0)
#define RPG_MQUATERNION_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x20FE480)
#define RPG_MQUATERNION_SET_OFFSET UNITYSDK_OFFSET(0x24C40)
#define RPG_MQUATERNION_TOEULERANGLE_OFFSET UNITYSDK_OFFSET(0x17A77D50)
#define RPG_MQUATERNION_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x20FE660)
#define RPG_MQUATERNION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x20FE650)
#define RPG_MQUATERNION__CCTOR_OFFSET UNITYSDK_OFFSET(0x17A78F60)
...
namespace RPG
{
	...
	struct alignas(4) MQuaternion
	{
		...
		{
			return (::RPG::MQuaternion*)Il2CppClass::FromTypeDefinitionIndex(MQuaternion_TypeDefinitionIndex)->GetStaticField(0xDE70);
		}
