...
#define RPG_VIEW_CHIMERADUELBATTLECHIMERACONTROL_METHOD_6_7F5A09121F2469EC_OFFSET UNITYSDK_OFFSET(0xA5DDBA0)
#define RPG_VIEW_CHIMERADUELBATTLECHIMERACONTROL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA5DDB20)
#define RPG_VIEW_CHIMERADUELBATTLECHIMERACONTROL_SHOWATKVALUECHANGE_OFFSET UNITYSDK_OFFSET(0xA5DDF10)
#define RPG_VIEW_CHIMERADUELBATTLECHIMERACONTROL_SHOWHPVALUECHANGE_OFFSET UNITYSDK_OFFSET(0xA5DDCD0)
#define RPG_VIEW_CHIMERADUELBATTLECHIMERACONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0xA5DE150)
#define RPG_VIEW_CHIMERADUELBATTLECHIMERACONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xA5DE480)
#define RPG_VIEW_CHIMERADUELBATTLECHIMERACONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA5DCB10)
#define RPG_VIEW_CHIMERADUELBATTLECHIMERACONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xA5DC5F0)
#define RPG_VIEW_CHIMERADUELBATTLECHIMERACONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA5DE4F0)
#define RPG_VIEW_CHIMERADUELBATTLECHIMERACONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xA5DE490)

namespace RPG::View
{
	inline static constexpr unsigned int ChimeraDuelBattleChimeraControl_TypeDefinitionIndex = 40875;
