...
#define RPG_VIEW_DIRECTDELIVERYAVATARREWARDTOASTWINDOW__CTOR_OFFSET UNITYSDK_OFFSET(0x16F2F2A0)
#define RPG_VIEW_DIRECTDELIVERYAVATARREWARDTOASTWINDOW__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16F2F340)
#define RPG_VIEW_DIRECTDELIVERYAVATARREWARDTOASTWINDOW__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x16F2F840)
#define RPG_VIEW_DIRECTDELIVERYAVATARREWARDTOASTWINDOW___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16F2F980)
#define RPG_VIEW_DIRECTDELIVERYAVATARREWARDTOASTWINDOW___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x16F2F9E0)
