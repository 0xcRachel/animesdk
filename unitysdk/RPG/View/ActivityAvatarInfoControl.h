...
#define RPG_VIEW_ACTIVITYAVATARINFOCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xA5DC4D0)
#define RPG_VIEW_ACTIVITYAVATARINFOCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA5DAFA0)
#define RPG_VIEW_ACTIVITYAVATARINFOCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xA5DC2B0)
#define RPG_VIEW_ACTIVITYAVATARINFOCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA5DC4E0)
#define RPG_VIEW_ACTIVITYAVATARINFOCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xA5DC540)

namespace RPG::View
{
	inline static constexpr unsigned int ActivityAvatarInfoControl_TypeDefinitionIndex = 40878;
