...
#define RPG_MMATHF_ABS_1_OFFSET UNITYSDK_OFFSET(0x17A76BA0)
#define RPG_MMATHF_ABS_OFFSET UNITYSDK_OFFSET(0x17A46540)
#define RPG_MMATHF_ACOS_OFFSET UNITYSDK_OFFSET(0x17A6C340)
#define RPG_MMATHF_APPROXIMATELY_OFFSET UNITYSDK_OFFSET(0x17A77850)
#define RPG_MMATHF_ASIN_OFFSET UNITYSDK_OFFSET(0x17A76B40)
#define RPG_MMATHF_ATAN2_OFFSET UNITYSDK_OFFSET(0x17A76B80)
#define RPG_MMATHF_ATAN_OFFSET UNITYSDK_OFFSET(0x17A76B60)
#define RPG_MMATHF_CEILTOINT_OFFSET UNITYSDK_OFFSET(0x17A77340)
#define RPG_MMATHF_CEIL_OFFSET UNITYSDK_OFFSET(0x17A77270)
#define RPG_MMATHF_CLAMP01_OFFSET UNITYSDK_OFFSET(0x17A76AE0)
#define RPG_MMATHF_CLAMP_1_OFFSET UNITYSDK_OFFSET(0x17A77470)
#define RPG_MMATHF_CLAMP_OFFSET UNITYSDK_OFFSET(0x17A77450)
#define RPG_MMATHF_COS_OFFSET UNITYSDK_OFFSET(0x17A5D5C0)
#define RPG_MMATHF_DELTAANGLE_OFFSET UNITYSDK_OFFSET(0x17A77710)
#define RPG_MMATHF_EXP_OFFSET UNITYSDK_OFFSET(0x17A77160)
#define RPG_MMATHF_FLOORTOINT_OFFSET UNITYSDK_OFFSET(0x17A77360)
#define RPG_MMATHF_FLOOR_OFFSET UNITYSDK_OFFSET(0x17A77280)
#define RPG_MMATHF_GAMMA_OFFSET UNITYSDK_OFFSET(0x17A777D0)
#define RPG_MMATHF_INVERSELERP_OFFSET UNITYSDK_OFFSET(0x17A77900)
#define RPG_MMATHF_LERPANGLE_OFFSET UNITYSDK_OFFSET(0x17A774C0)
#define RPG_MMATHF_LERPUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x17A774B0)
#define RPG_MMATHF_LERP_OFFSET UNITYSDK_OFFSET(0x17A77480)
#define RPG_MMATHF_LINEINTERSECTION_OFFSET UNITYSDK_OFFSET(0x17A77940)
#define RPG_MMATHF_LINESEGMENTINTERSECTION_OFFSET UNITYSDK_OFFSET(0x17A77A30)
#define RPG_MMATHF_LOG10_OFFSET UNITYSDK_OFFSET(0x17A77250)
#define RPG_MMATHF_LOG_1_OFFSET UNITYSDK_OFFSET(0x17A77230)
#define RPG_MMATHF_LOG_OFFSET UNITYSDK_OFFSET(0x17A77180)
#define RPG_MMATHF_MAX_1_OFFSET UNITYSDK_OFFSET(0x17A76E90)
#define RPG_MMATHF_MAX_2_OFFSET UNITYSDK_OFFSET(0x17A76F60)
#define RPG_MMATHF_MAX_3_OFFSET UNITYSDK_OFFSET(0x17A76F70)
#define RPG_MMATHF_MAX_OFFSET UNITYSDK_OFFSET(0x17A76E80)
#define RPG_MMATHF_MIN_1_OFFSET UNITYSDK_OFFSET(0x17A76BC0)
#define RPG_MMATHF_MIN_2_OFFSET UNITYSDK_OFFSET(0x17A76C90)
#define RPG_MMATHF_MIN_3_OFFSET UNITYSDK_OFFSET(0x17A76CA0)
#define RPG_MMATHF_MIN_4_OFFSET UNITYSDK_OFFSET(0x17A76CB0)
#define RPG_MMATHF_MIN_OFFSET UNITYSDK_OFFSET(0x17A76BB0)
#define RPG_MMATHF_MOVETOWARDSANGLE_OFFSET UNITYSDK_OFFSET(0x17A77610)
#define RPG_MMATHF_MOVETOWARDS_OFFSET UNITYSDK_OFFSET(0x17A775C0)
#define RPG_MMATHF_PINGPONG_OFFSET UNITYSDK_OFFSET(0x17A77890)
#define RPG_MMATHF_POW_OFFSET UNITYSDK_OFFSET(0x17A77140)
#define RPG_MMATHF_RANDOMTOLONG_OFFSET UNITYSDK_OFFSET(0x17A77B40)
#define RPG_MMATHF_REPEAT_OFFSET UNITYSDK_OFFSET(0x17A77570)
#define RPG_MMATHF_ROUNDTOINT_OFFSET UNITYSDK_OFFSET(0x17A77380)
#define RPG_MMATHF_ROUND_OFFSET UNITYSDK_OFFSET(0x17A77290)
#define RPG_MMATHF_SIGN_OFFSET UNITYSDK_OFFSET(0x17A77430)
#define RPG_MMATHF_SIN_OFFSET UNITYSDK_OFFSET(0x17A5D5A0)
#define RPG_MMATHF_SMOOTHSTEP_OFFSET UNITYSDK_OFFSET(0x17A77780)
#define RPG_MMATHF_SQRT_OFFSET UNITYSDK_OFFSET(0x17A46360)
#define RPG_MMATHF_TAN_OFFSET UNITYSDK_OFFSET(0x17A76B20)
#define RPG_MMATHF__CCTOR_OFFSET UNITYSDK_OFFSET(0x17A77BD0)
...
namespace RPG
{
	...
	struct alignas(1) MMathf
	{
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(MMathf_TypeDefinitionIndex)->GetStaticField(0xA490);
		}
