...
#define RPG_MMATHF_ABS_1_OFFSET UNITYSDK_OFFSET(0x172BAA70)
#define RPG_MMATHF_ABS_OFFSET UNITYSDK_OFFSET(0x1727E2F0)
#define RPG_MMATHF_ACOS_OFFSET UNITYSDK_OFFSET(0x1728A940)
#define RPG_MMATHF_APPROXIMATELY_OFFSET UNITYSDK_OFFSET(0x1728BAA0)
#define RPG_MMATHF_ASIN_OFFSET UNITYSDK_OFFSET(0x172BAA30)
#define RPG_MMATHF_ATAN2_OFFSET UNITYSDK_OFFSET(0x172AB840)
#define RPG_MMATHF_ATAN_OFFSET UNITYSDK_OFFSET(0x172BAA50)
#define RPG_MMATHF_CEILTOINT_OFFSET UNITYSDK_OFFSET(0x172BB1C0)
#define RPG_MMATHF_CEIL_OFFSET UNITYSDK_OFFSET(0x172BB0F0)
#define RPG_MMATHF_CLAMP01_OFFSET UNITYSDK_OFFSET(0x172BA9D0)
#define RPG_MMATHF_CLAMP_1_OFFSET UNITYSDK_OFFSET(0x172BB2F0)
#define RPG_MMATHF_CLAMP_OFFSET UNITYSDK_OFFSET(0x172BB2D0)
#define RPG_MMATHF_COS_OFFSET UNITYSDK_OFFSET(0x172983C0)
#define RPG_MMATHF_DELTAANGLE_OFFSET UNITYSDK_OFFSET(0x172BB590)
#define RPG_MMATHF_EXP_OFFSET UNITYSDK_OFFSET(0x172BB000)
#define RPG_MMATHF_FLOORTOINT_OFFSET UNITYSDK_OFFSET(0x172BB1E0)
#define RPG_MMATHF_FLOOR_OFFSET UNITYSDK_OFFSET(0x172BB100)
#define RPG_MMATHF_GAMMA_OFFSET UNITYSDK_OFFSET(0x172BB650)
#define RPG_MMATHF_INVERSELERP_OFFSET UNITYSDK_OFFSET(0x172BB740)
#define RPG_MMATHF_LERPANGLE_OFFSET UNITYSDK_OFFSET(0x172BB340)
#define RPG_MMATHF_LERPUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x172BB330)
#define RPG_MMATHF_LERP_OFFSET UNITYSDK_OFFSET(0x172BB300)
#define RPG_MMATHF_LINEINTERSECTION_OFFSET UNITYSDK_OFFSET(0x172BB780)
#define RPG_MMATHF_LINESEGMENTINTERSECTION_OFFSET UNITYSDK_OFFSET(0x172BB870)
#define RPG_MMATHF_LOG10_OFFSET UNITYSDK_OFFSET(0x172BB0D0)
#define RPG_MMATHF_LOG_1_OFFSET UNITYSDK_OFFSET(0x172ACA40)
#define RPG_MMATHF_LOG_OFFSET UNITYSDK_OFFSET(0x172BB020)
#define RPG_MMATHF_MAX_1_OFFSET UNITYSDK_OFFSET(0x172BAD50)
#define RPG_MMATHF_MAX_2_OFFSET UNITYSDK_OFFSET(0x172BAE20)
#define RPG_MMATHF_MAX_3_OFFSET UNITYSDK_OFFSET(0x172BAE30)
#define RPG_MMATHF_MAX_OFFSET UNITYSDK_OFFSET(0x172BAD40)
#define RPG_MMATHF_MIN_1_OFFSET UNITYSDK_OFFSET(0x172BAA80)
#define RPG_MMATHF_MIN_2_OFFSET UNITYSDK_OFFSET(0x172BAB50)
#define RPG_MMATHF_MIN_3_OFFSET UNITYSDK_OFFSET(0x172BAB60)
#define RPG_MMATHF_MIN_4_OFFSET UNITYSDK_OFFSET(0x172BAB70)
#define RPG_MMATHF_MIN_OFFSET UNITYSDK_OFFSET(0x1728B930)
#define RPG_MMATHF_MOVETOWARDSANGLE_OFFSET UNITYSDK_OFFSET(0x172BB490)
#define RPG_MMATHF_MOVETOWARDS_OFFSET UNITYSDK_OFFSET(0x172BB440)
#define RPG_MMATHF_PINGPONG_OFFSET UNITYSDK_OFFSET(0x172BB6D0)
#define RPG_MMATHF_POW_OFFSET UNITYSDK_OFFSET(0x172AB820)
#define RPG_MMATHF_RANDOMTOLONG_OFFSET UNITYSDK_OFFSET(0x172BB980)
#define RPG_MMATHF_REPEAT_OFFSET UNITYSDK_OFFSET(0x172BB3F0)
#define RPG_MMATHF_ROUNDTOINT_OFFSET UNITYSDK_OFFSET(0x172BB200)
#define RPG_MMATHF_ROUND_OFFSET UNITYSDK_OFFSET(0x172BB110)
#define RPG_MMATHF_SIGN_OFFSET UNITYSDK_OFFSET(0x172BB2B0)
#define RPG_MMATHF_SIN_OFFSET UNITYSDK_OFFSET(0x172983A0)
#define RPG_MMATHF_SMOOTHSTEP_OFFSET UNITYSDK_OFFSET(0x172BB600)
#define RPG_MMATHF_SQRT_OFFSET UNITYSDK_OFFSET(0x17287AF0)
#define RPG_MMATHF_TAN_OFFSET UNITYSDK_OFFSET(0x172BAA10)
#define RPG_MMATHF__CCTOR_OFFSET UNITYSDK_OFFSET(0x172BBA10)

namespace RPG
{
	inline static constexpr unsigned int MMathf_TypeDefinitionIndex = 8571;

	struct alignas(1) MMathf
	{
		static ::System::Single* StaticGet_Epsilon()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(MMathf_TypeDefinitionIndex)->GetStaticField(0x23D0);
		}
