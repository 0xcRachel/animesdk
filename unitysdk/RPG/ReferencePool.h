...
#define RPG_REFERENCEPOOL_ACQUIRE_OFFSET UNITYSDK_OFFSET(0x15DFB380)
#define RPG_REFERENCEPOOL_ADD_OFFSET UNITYSDK_OFFSET(0x15DFB8C0)
#define RPG_REFERENCEPOOL_CLEARALL_OFFSET UNITYSDK_OFFSET(0x15DFB1C0)
#define RPG_REFERENCEPOOL_GETREFERENCECOLLECTION_OFFSET UNITYSDK_OFFSET(0x15DFB560)
#define RPG_REFERENCEPOOL_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x15DFB190)
#define RPG_REFERENCEPOOL_GET_ENABLESTRICTCHECK_OFFSET UNITYSDK_OFFSET(0x15DFB170)
#define RPG_REFERENCEPOOL_INTERNALCHECKREFERENCETYPE_OFFSET UNITYSDK_OFFSET(0x15DFB3B0)
#define RPG_REFERENCEPOOL_RELEASEALLAUTORELEASEREFERENCE_OFFSET UNITYSDK_OFFSET(0x15DFAC10)
#define RPG_REFERENCEPOOL_RELEASE_OFFSET UNITYSDK_OFFSET(0x15DFB850)
#define RPG_REFERENCEPOOL_REMOVEALL_OFFSET UNITYSDK_OFFSET(0x15DFBB70)
#define RPG_REFERENCEPOOL_REMOVE_OFFSET UNITYSDK_OFFSET(0x15DFBA70)
#define RPG_REFERENCEPOOL_SET_ENABLESTRICTCHECK_OFFSET UNITYSDK_OFFSET(0x15DFB180)
#define RPG_REFERENCEPOOL__CCTOR_OFFSET UNITYSDK_OFFSET(0x15DFBCB0)

namespace RPG
{
	inline static constexpr unsigned int ReferencePool_TypeDefinitionIndex = 6285;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::RuntimeTypeHandle, ::RPG::ReferencePool_ReferenceCollection*>**)Il2CppClass::FromTypeDefinitionIndex(ReferencePool_TypeDefinitionIndex)->GetStaticField(0x4E0);
		}
		...
		{
			return (::System::Collections::Generic::List_1<::RPG::ReferencePool_AutoReleaseReferenceObjectDatas>**)Il2CppClass::FromTypeDefinitionIndex(ReferencePool_TypeDefinitionIndex)->GetStaticField(0x4E8);
		}
		static ::System::Boolean* StaticGet_m_EnableStrictCheck()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ReferencePool_TypeDefinitionIndex)->GetStaticField(0x340);
		}
