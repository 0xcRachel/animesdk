...
#define RPG_REFERENCEPOOL_ACQUIRESTRINGBUILDER_OFFSET UNITYSDK_OFFSET(0x1B5757C0)
#define RPG_REFERENCEPOOL_ACQUIRE_OFFSET UNITYSDK_OFFSET(0x1B5752E0)
#define RPG_REFERENCEPOOL_ADD_OFFSET UNITYSDK_OFFSET(0x1B575880)
#define RPG_REFERENCEPOOL_CLEARALL_OFFSET UNITYSDK_OFFSET(0x1B575160)
#define RPG_REFERENCEPOOL_GETREFERENCECOLLECTION_OFFSET UNITYSDK_OFFSET(0x1B5754B0)
#define RPG_REFERENCEPOOL_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1B575130)
#define RPG_REFERENCEPOOL_GET_ENABLESTRICTCHECK_OFFSET UNITYSDK_OFFSET(0x1B575110)
#define RPG_REFERENCEPOOL_INTERNALCHECKREFERENCETYPE_OFFSET UNITYSDK_OFFSET(0x1B575310)
#define RPG_REFERENCEPOOL_RELEASEALLAUTORELEASEREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B574C10)
#define RPG_REFERENCEPOOL_RELEASE_OFFSET UNITYSDK_OFFSET(0x1B575810)
#define RPG_REFERENCEPOOL_REMOVEALL_OFFSET UNITYSDK_OFFSET(0x1B575B10)
#define RPG_REFERENCEPOOL_REMOVE_OFFSET UNITYSDK_OFFSET(0x1B575A20)
#define RPG_REFERENCEPOOL_SET_ENABLESTRICTCHECK_OFFSET UNITYSDK_OFFSET(0x1B575120)
#define RPG_REFERENCEPOOL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B575C30)
