...
#define ZENFULCRUM_EMBEDDEDBROWSER_COOKIEMANAGER_COOKIEFETCH__CTOR_OFFSET UNITYSDK_OFFSET(0x18472040)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int CookieManager_CookieFetch_TypeDefinitionIndex = 29657;
	...
	public:
		...
		::System::Collections::Generic::List_1<::ZenFulcrum::EmbeddedBrowser::Cookie*>* result; // 0x28
