...
namespace ZenFulcrum::EmbeddedBrowser
{
	...
	public:
		...
		{
			return (::ZenFulcrum::EmbeddedBrowser::BrowserNative_NewRequestFunc**)Il2CppClass::FromTypeDefinitionIndex(BrowserNative___O_TypeDefinitionIndex)->GetStaticField(0x67B50);
		}
		static ::ZenFulcrum::EmbeddedBrowser::BrowserNative_MessageFunc** StaticGet__0___LogCallback()
		{
			return (::ZenFulcrum::EmbeddedBrowser::BrowserNative_MessageFunc**)Il2CppClass::FromTypeDefinitionIndex(BrowserNative___O_TypeDefinitionIndex)->GetStaticField(0x67B58);
		}
	};
}
