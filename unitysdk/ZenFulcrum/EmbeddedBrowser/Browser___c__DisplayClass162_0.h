...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSER___C__DISPLAYCLASS162_0__CTOR_OFFSET UNITYSDK_OFFSET(0x18C663A0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSER___C__DISPLAYCLASS162_0__WHENREADY_B__0_OFFSET UNITYSDK_OFFSET(0x18C78900)
...
namespace ZenFulcrum::EmbeddedBrowser
{
	...
	public:
		...
		::ZenFulcrum::EmbeddedBrowser::BrowserNative_ReadyFunc* func; // 0x20
