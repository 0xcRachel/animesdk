...
namespace ZenFulcrum::EmbeddedBrowser
{
	...
	public:
		...
		{
			return (::ZenFulcrum::EmbeddedBrowser::BrowserNative_GetCookieFunc**)Il2CppClass::FromTypeDefinitionIndex(CookieManager___O_TypeDefinitionIndex)->GetStaticField(0x631E0);
		}
	};
}
