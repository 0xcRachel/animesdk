...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYMOUSESCALE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x184C0B90)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYMOUSESCALE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x184C0C20)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYMOUSESCALE_INVOKE_OFFSET UNITYSDK_OFFSET(0x184C06C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYMOUSESCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x184C06A0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__GetOverlayMouseScale_TypeDefinitionIndex = 29274;
