...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__COMPUTEOVERLAYINTERSECTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CCBBB0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__COMPUTEOVERLAYINTERSECTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CCBC60)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__COMPUTEOVERLAYINTERSECTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CCB810)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__COMPUTEOVERLAYINTERSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18CCB7F0)
