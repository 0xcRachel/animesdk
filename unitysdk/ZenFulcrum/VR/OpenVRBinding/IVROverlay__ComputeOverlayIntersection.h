...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__COMPUTEOVERLAYINTERSECTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x184B9900)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__COMPUTEOVERLAYINTERSECTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x184B99B0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__COMPUTEOVERLAYINTERSECTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x184B9400)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__COMPUTEOVERLAYINTERSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x184B93E0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__ComputeOverlayIntersection_TypeDefinitionIndex = 29276;
