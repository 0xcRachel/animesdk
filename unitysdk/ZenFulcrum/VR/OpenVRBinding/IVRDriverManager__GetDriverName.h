...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRDRIVERMANAGER__GETDRIVERNAME_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x184B6AB0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRDRIVERMANAGER__GETDRIVERNAME_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x184B6B30)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRDRIVERMANAGER__GETDRIVERNAME_INVOKE_OFFSET UNITYSDK_OFFSET(0x184B65D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRDRIVERMANAGER__GETDRIVERNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x184B65B0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRDriverManager__GetDriverName_TypeDefinitionIndex = 29355;
