...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETDASHBOARDOVERLAYSCENEPROCESS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x184CA8D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETDASHBOARDOVERLAYSCENEPROCESS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x184CA940)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETDASHBOARDOVERLAYSCENEPROCESS_INVOKE_OFFSET UNITYSDK_OFFSET(0x184CA400)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETDASHBOARDOVERLAYSCENEPROCESS__CTOR_OFFSET UNITYSDK_OFFSET(0x184CA3E0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__SetDashboardOverlaySceneProcess_TypeDefinitionIndex = 29293;
