...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__ACKNOWLEDGEQUIT_USERPROMPT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17896CC0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__ACKNOWLEDGEQUIT_USERPROMPT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17896CF0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__ACKNOWLEDGEQUIT_USERPROMPT_INVOKE_OFFSET UNITYSDK_OFFSET(0x17896A20)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__ACKNOWLEDGEQUIT_USERPROMPT__CTOR_OFFSET UNITYSDK_OFFSET(0x17896A00)
