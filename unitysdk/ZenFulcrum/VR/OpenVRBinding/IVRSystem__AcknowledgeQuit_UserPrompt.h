...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__ACKNOWLEDGEQUIT_USERPROMPT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x184E9CE0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__ACKNOWLEDGEQUIT_USERPROMPT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x184E9D10)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__ACKNOWLEDGEQUIT_USERPROMPT_INVOKE_OFFSET UNITYSDK_OFFSET(0x184E9910)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__ACKNOWLEDGEQUIT_USERPROMPT__CTOR_OFFSET UNITYSDK_OFFSET(0x184E98F0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__AcknowledgeQuit_UserPrompt_TypeDefinitionIndex = 29101;
