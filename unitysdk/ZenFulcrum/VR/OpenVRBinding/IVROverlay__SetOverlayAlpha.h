...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYALPHA_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x184CC390)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYALPHA_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x184CC410)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYALPHA_INVOKE_OFFSET UNITYSDK_OFFSET(0x184CBF40)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYALPHA__CTOR_OFFSET UNITYSDK_OFFSET(0x184CBF20)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__SetOverlayAlpha_TypeDefinitionIndex = 29242;
