...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYINPUTMETHOD_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x184BFF70)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYINPUTMETHOD_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x184C0000)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYINPUTMETHOD_INVOKE_OFFSET UNITYSDK_OFFSET(0x184BFAA0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYINPUTMETHOD__CTOR_OFFSET UNITYSDK_OFFSET(0x184BFA80)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__GetOverlayInputMethod_TypeDefinitionIndex = 29272;
