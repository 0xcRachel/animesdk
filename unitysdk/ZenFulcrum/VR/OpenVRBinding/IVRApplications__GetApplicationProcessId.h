...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONPROCESSID_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x184A5A50)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONPROCESSID_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x184A5A80)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONPROCESSID_INVOKE_OFFSET UNITYSDK_OFFSET(0x1848F930)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONPROCESSID__CTOR_OFFSET UNITYSDK_OFFSET(0x184A5A30)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRApplications__GetApplicationProcessId_TypeDefinitionIndex = 29132;
