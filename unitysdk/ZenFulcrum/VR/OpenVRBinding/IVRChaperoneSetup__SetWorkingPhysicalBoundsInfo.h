...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__SETWORKINGPHYSICALBOUNDSINFO_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x184A79F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__SETWORKINGPHYSICALBOUNDSINFO_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x184A7A50)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__SETWORKINGPHYSICALBOUNDSINFO_INVOKE_OFFSET UNITYSDK_OFFSET(0x1849E5A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__SETWORKINGPHYSICALBOUNDSINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x184A79D0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRChaperoneSetup__SetWorkingPhysicalBoundsInfo_TypeDefinitionIndex = 29177;
