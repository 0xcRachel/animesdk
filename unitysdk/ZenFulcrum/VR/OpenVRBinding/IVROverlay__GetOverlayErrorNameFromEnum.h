...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYERRORNAMEFROMENUM_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x184BE780)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYERRORNAMEFROMENUM_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x184BE7F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYERRORNAMEFROMENUM_INVOKE_OFFSET UNITYSDK_OFFSET(0x184BE360)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYERRORNAMEFROMENUM__CTOR_OFFSET UNITYSDK_OFFSET(0x184BE340)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__GetOverlayErrorNameFromEnum_TypeDefinitionIndex = 29235;
