...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYALPHA_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x184BD650)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYALPHA_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x184BD6C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYALPHA_INVOKE_OFFSET UNITYSDK_OFFSET(0x184BD180)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYALPHA__CTOR_OFFSET UNITYSDK_OFFSET(0x184BD160)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__GetOverlayAlpha_TypeDefinitionIndex = 29243;
