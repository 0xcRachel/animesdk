...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYFROMFILE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x184CDA80)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYFROMFILE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x184CDAF0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYFROMFILE_INVOKE_OFFSET UNITYSDK_OFFSET(0x184CD5B0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYFROMFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x184CD590)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__SetOverlayFromFile_TypeDefinitionIndex = 29286;
