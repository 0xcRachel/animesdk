...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__COMPOSITORGOTOBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x184AA330)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__COMPOSITORGOTOBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x184AA360)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__COMPOSITORGOTOBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x184A9F60)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__COMPOSITORGOTOBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x184A9F40)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRCompositor__CompositorGoToBack_TypeDefinitionIndex = 29201;
