...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYSORTORDER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x184D0E80)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYSORTORDER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x184D0EF0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYSORTORDER_INVOKE_OFFSET UNITYSDK_OFFSET(0x184D09B0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYSORTORDER__CTOR_OFFSET UNITYSDK_OFFSET(0x184D0990)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__SetOverlaySortOrder_TypeDefinitionIndex = 29246;
