...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYSORTORDER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CDD8D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYSORTORDER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CDD940)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYSORTORDER_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CDD560)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYSORTORDER__CTOR_OFFSET UNITYSDK_OFFSET(0x18CDD540)
