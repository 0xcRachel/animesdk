...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYWIDTHINMETERS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x184C6620)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYWIDTHINMETERS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x184C6690)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYWIDTHINMETERS_INVOKE_OFFSET UNITYSDK_OFFSET(0x184C6150)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYWIDTHINMETERS__CTOR_OFFSET UNITYSDK_OFFSET(0x184C6130)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__GetOverlayWidthInMeters_TypeDefinitionIndex = 29249;
