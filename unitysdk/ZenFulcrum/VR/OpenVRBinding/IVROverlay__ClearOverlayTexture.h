...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__CLEAROVERLAYTEXTURE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x184B8F30)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__CLEAROVERLAYTEXTURE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x184B8F80)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__CLEAROVERLAYTEXTURE_INVOKE_OFFSET UNITYSDK_OFFSET(0x184B8B10)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__CLEAROVERLAYTEXTURE__CTOR_OFFSET UNITYSDK_OFFSET(0x184B8AF0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__ClearOverlayTexture_TypeDefinitionIndex = 29284;
