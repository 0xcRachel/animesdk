...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETGAMEPADFOCUSOVERLAY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x184CADB0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETGAMEPADFOCUSOVERLAY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x184CAE00)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETGAMEPADFOCUSOVERLAY_INVOKE_OFFSET UNITYSDK_OFFSET(0x184CA990)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETGAMEPADFOCUSOVERLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x184CA970)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__SetGamepadFocusOverlay_TypeDefinitionIndex = 29280;
