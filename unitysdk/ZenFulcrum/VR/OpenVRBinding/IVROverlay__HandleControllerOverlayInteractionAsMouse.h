...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__HANDLECONTROLLEROVERLAYINTERACTIONASMOUSE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x184C7680)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__HANDLECONTROLLEROVERLAYINTERACTIONASMOUSE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x184C76F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__HANDLECONTROLLEROVERLAYINTERACTIONASMOUSE_INVOKE_OFFSET UNITYSDK_OFFSET(0x184C71B0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__HANDLECONTROLLEROVERLAYINTERACTIONASMOUSE__CTOR_OFFSET UNITYSDK_OFFSET(0x184C7190)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__HandleControllerOverlayInteractionAsMouse_TypeDefinitionIndex = 29277;
