...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__CAPTUREINPUTFOCUS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x184EA6F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__CAPTUREINPUTFOCUS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x184EA720)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__CAPTUREINPUTFOCUS_INVOKE_OFFSET UNITYSDK_OFFSET(0x184EA320)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__CAPTUREINPUTFOCUS__CTOR_OFFSET UNITYSDK_OFFSET(0x184EA300)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__CaptureInputFocus_TypeDefinitionIndex = 29095;
