...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETDASHBOARDOVERLAYSCENEPROCESS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x184BBFC0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETDASHBOARDOVERLAYSCENEPROCESS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x184BC030)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETDASHBOARDOVERLAYSCENEPROCESS_INVOKE_OFFSET UNITYSDK_OFFSET(0x184BBAF0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETDASHBOARDOVERLAYSCENEPROCESS__CTOR_OFFSET UNITYSDK_OFFSET(0x184BBAD0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__GetDashboardOverlaySceneProcess_TypeDefinitionIndex = 29294;
