...
#define CLASS_1_2C6772C82ACCC0A3_EXECUTE_OFFSET UNITYSDK_OFFSET(0x162FA1B0)
#define CLASS_1_2C6772C82ACCC0A3_METHOD_1_00A454A4D5714920_OFFSET UNITYSDK_OFFSET(0x162FC1E0)
#define CLASS_1_2C6772C82ACCC0A3_METHOD_1_03C4FFAD29DE0852_OFFSET UNITYSDK_OFFSET(0x162FEFA0)
#define CLASS_1_2C6772C82ACCC0A3_METHOD_1_0F3B50C3D1B05BB5_OFFSET UNITYSDK_OFFSET(0x162FCBC0)
#define CLASS_1_2C6772C82ACCC0A3_METHOD_1_214C04EEA791FCB5_OFFSET UNITYSDK_OFFSET(0x162FE500)
#define CLASS_1_2C6772C82ACCC0A3_METHOD_1_2372762F4122DEB8_OFFSET UNITYSDK_OFFSET(0x162FC160)
#define CLASS_1_2C6772C82ACCC0A3_METHOD_1_287C184DCE9CC54F_OFFSET UNITYSDK_OFFSET(0x162FD390)
#define CLASS_1_2C6772C82ACCC0A3_METHOD_1_39C75ED00C6629F7_OFFSET UNITYSDK_OFFSET(0x162FE430)
#define CLASS_1_2C6772C82ACCC0A3_METHOD_1_3BCF0226A6CDC13B_OFFSET UNITYSDK_OFFSET(0x162FD960)
#define CLASS_1_2C6772C82ACCC0A3_METHOD_1_3DEAA876881764E8_OFFSET UNITYSDK_OFFSET(0x162FC3A0)
#define CLASS_1_2C6772C82ACCC0A3_METHOD_1_40A9AF7B6AE5F77E_OFFSET UNITYSDK_OFFSET(0x162FE7B0)
#define CLASS_1_2C6772C82ACCC0A3_METHOD_1_453B88EA0D03EE65_OFFSET UNITYSDK_OFFSET(0x162FC940)
#define CLASS_1_2C6772C82ACCC0A3_METHOD_1_49D44F568C742CC9_OFFSET UNITYSDK_OFFSET(0x162FE4A0)
#define CLASS_1_2C6772C82ACCC0A3_METHOD_1_4B4D3CC697868CA9_OFFSET UNITYSDK_OFFSET(0x162FD280)
#define CLASS_1_2C6772C82ACCC0A3_METHOD_1_51073F93B4DC0EAE_OFFSET UNITYSDK_OFFSET(0x162FE6D0)
#define CLASS_1_2C6772C82ACCC0A3_METHOD_1_53BD888AED7AAE33_OFFSET UNITYSDK_OFFSET(0x162FE100)
#define CLASS_1_2C6772C82ACCC0A3_METHOD_1_5D9794CEF432D881_OFFSET UNITYSDK_OFFSET(0x162FC710)
#define CLASS_1_2C6772C82ACCC0A3_METHOD_1_683F35A5670243E8_OFFSET UNITYSDK_OFFSET(0x162FD050)
#define CLASS_1_2C6772C82ACCC0A3_METHOD_1_7E9C4D81D04C3024_OFFSET UNITYSDK_OFFSET(0x162FF3C0)
#define CLASS_1_2C6772C82ACCC0A3_METHOD_1_995B4AEB9D9468D5_OFFSET UNITYSDK_OFFSET(0x162FF320)
#define CLASS_1_2C6772C82ACCC0A3_METHOD_1_9E7DEA01847BED05_OFFSET UNITYSDK_OFFSET(0x162FCD80)
#define CLASS_1_2C6772C82ACCC0A3_METHOD_1_9EB9F2083A266861_OFFSET UNITYSDK_OFFSET(0x162FE9B0)
#define CLASS_1_2C6772C82ACCC0A3_METHOD_1_A26E815EE2AA9047_OFFSET UNITYSDK_OFFSET(0x162FA570)
#define CLASS_1_2C6772C82ACCC0A3_METHOD_1_A74F1CF3E25BC135_OFFSET UNITYSDK_OFFSET(0x162FD5D0)
#define CLASS_1_2C6772C82ACCC0A3_METHOD_1_C54410EC0B98D111_OFFSET UNITYSDK_OFFSET(0x162FC550)
#define CLASS_1_2C6772C82ACCC0A3_METHOD_1_CE889B4C90308205_OFFSET UNITYSDK_OFFSET(0x162FCE80)
#define CLASS_1_2C6772C82ACCC0A3_METHOD_1_D545E2F706415F81_OFFSET UNITYSDK_OFFSET(0x162FAC70)
#define CLASS_1_2C6772C82ACCC0A3_METHOD_1_DE45EA3A177BC33B_OFFSET UNITYSDK_OFFSET(0x162FE390)
#define CLASS_1_2C6772C82ACCC0A3_METHOD_1_E3F0876823C41AE9_OFFSET UNITYSDK_OFFSET(0x162FD7A0)
#define CLASS_1_2C6772C82ACCC0A3_METHOD_1_EDCDEA50000D48BF_OFFSET UNITYSDK_OFFSET(0x162FBE10)
#define CLASS_1_2C6772C82ACCC0A3__CTOR_OFFSET UNITYSDK_OFFSET(0x162FA040)

inline static constexpr unsigned int Class_1_2C6772C82ACCC0A3_TypeDefinitionIndex = 31858;
...
public:
	...
	::System::Collections::Generic::List_1<::Class_1_3D8DD98F0436E6C5*>* Field_1_3; // 0x20
	...
	::System::Void Method_1_683F35A5670243E8(::Class_1_5E0FF7764DCED633* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_5E0FF7764DCED633*))((::PBYTE)hIl2Cpp + CLASS_1_2C6772C82ACCC0A3_METHOD_1_683F35A5670243E8_OFFSET))(this, a1);
	}

	::System::Void Method_1_EDCDEA50000D48BF(::Class_1_5E0FF7764DCED633* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_5E0FF7764DCED633*))((::PBYTE)hIl2Cpp + CLASS_1_2C6772C82ACCC0A3_METHOD_1_EDCDEA50000D48BF_OFFSET))(this, a1);
	}

	::System::Void Method_1_A26E815EE2AA9047(::Class_1_5E0FF7764DCED633* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_5E0FF7764DCED633*))((::PBYTE)hIl2Cpp + CLASS_1_2C6772C82ACCC0A3_METHOD_1_A26E815EE2AA9047_OFFSET))(this, a1);
	}
	...
	::Class_1_6698EBFD99A3F560* Method_1_4B4D3CC697868CA9(::Class_1_5E0FF7764DCED633* a1, ::System::ValueTuple_2<::System::UInt32, ::System::UInt32> a2)
	{
		return ((::Class_1_6698EBFD99A3F560*(*)(::PVOID, ::Class_1_5E0FF7764DCED633*, ::System::ValueTuple_2<::System::UInt32, ::System::UInt32>))((::PBYTE)hIl2Cpp + CLASS_1_2C6772C82ACCC0A3_METHOD_1_4B4D3CC697868CA9_OFFSET))(this, a1, a2);
	}
