...
#define CLASS_1_8B7E7C2DCDDA55DF_EXECUTE_OFFSET UNITYSDK_OFFSET(0x14A74D00)
#define CLASS_1_8B7E7C2DCDDA55DF_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x14A74180)
#define CLASS_1_8B7E7C2DCDDA55DF_LATEEXECUTE_OFFSET UNITYSDK_OFFSET(0x14A7AE00)
#define CLASS_1_8B7E7C2DCDDA55DF_METHOD_1_076E1E2A0183A470_OFFSET UNITYSDK_OFFSET(0x14A76910)
#define CLASS_1_8B7E7C2DCDDA55DF_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x14A74110)
#define CLASS_1_8B7E7C2DCDDA55DF_METHOD_1_18188D67877F2AFB_OFFSET UNITYSDK_OFFSET(0x14A7C950)
#define CLASS_1_8B7E7C2DCDDA55DF_METHOD_1_4988666BECC8CE44_OFFSET UNITYSDK_OFFSET(0x14A80510)
#define CLASS_1_8B7E7C2DCDDA55DF_METHOD_1_52DC9CC69AE40BFA_OFFSET UNITYSDK_OFFSET(0x14A76A40)
#define CLASS_1_8B7E7C2DCDDA55DF_METHOD_1_7EC249F73AD3704B_OFFSET UNITYSDK_OFFSET(0x14A7D2F0)
#define CLASS_1_8B7E7C2DCDDA55DF_METHOD_1_91B48388F4BFAF76_OFFSET UNITYSDK_OFFSET(0x14A77CD0)
#define CLASS_1_8B7E7C2DCDDA55DF_METHOD_1_A37E414ACE798D5C_OFFSET UNITYSDK_OFFSET(0x14A7B520)
#define CLASS_1_8B7E7C2DCDDA55DF_METHOD_1_B1EA412ACAE87C15_OFFSET UNITYSDK_OFFSET(0x14A808B0)
#define CLASS_1_8B7E7C2DCDDA55DF_METHOD_1_C88D2212B860B209_OFFSET UNITYSDK_OFFSET(0x14A7CAF0)
#define CLASS_1_8B7E7C2DCDDA55DF_METHOD_1_D308836DB54415C3_OFFSET UNITYSDK_OFFSET(0x14A7AE50)
#define CLASS_1_8B7E7C2DCDDA55DF_METHOD_1_E41FCF4CAFD9C569_OFFSET UNITYSDK_OFFSET(0x14A806F0)
#define CLASS_1_8B7E7C2DCDDA55DF_TEARDOWN_OFFSET UNITYSDK_OFFSET(0x14A747C0)
#define CLASS_1_8B7E7C2DCDDA55DF__CCTOR_OFFSET UNITYSDK_OFFSET(0x14A80C90)
#define CLASS_1_8B7E7C2DCDDA55DF__CTOR_OFFSET UNITYSDK_OFFSET(0x14A73E20)
#define CLASS_1_8B7E7C2DCDDA55DF___ADD2DBRICKTUTORIALTRIGGER_B__16_0_OFFSET UNITYSDK_OFFSET(0x14A80CE0)

inline static constexpr unsigned int Class_1_8B7E7C2DCDDA55DF_TypeDefinitionIndex = 71345;
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_8B7E7C2DCDDA55DF_TypeDefinitionIndex)->GetStaticField(0x9110);
	}
	static ::System::Boolean* StaticGet_Field_1_1()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_1_8B7E7C2DCDDA55DF_TypeDefinitionIndex)->GetStaticField(0x9114);
	}
	static ::System::Int32* StaticGet_Field_1_2()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_8B7E7C2DCDDA55DF_TypeDefinitionIndex)->GetStaticField(0x9118);
	}
	// static const ::System::String* Field_1_3; // 0x0
	::System::Collections::Generic::List_1<::UnityEngine::Coroutine*>* Field_1_4; // 0x10
	::System::Collections::Generic::Dictionary_2<::Class_2_B8E38BF47138A2E5*, ::Class_1_8B7E7C2DCDDA55DF_Class_1_F2D17E30E1E79D69*>* Field_1_5; // 0x18
	::UnityEngine::Transform* Field_1_6; // 0x20
	::RPG::Client::LittleGame::FourRotateVoxel::FourRotateVoxelRuntimeInspector* Field_1_7; // 0x28
	...
	::RPG::Client::LittleGame::FourRotateVoxel::FourRotateVoxelGlobalData* Field_1_9; // 0x38
	::Class_3_D6E9A038FA23103A* Field_1_10; // 0x40
	::System::Collections::Generic::List_1<::FiveDimRenderingPanelRuntime*>* Field_1_11; // 0x48
	::System::Collections::Generic::Dictionary_2<::Class_2_1A8148841049062A*, ::System::Tuple_2<::UnityEngine::GameObject*, ::BansheeGz::BGSpline::Curve::BGCurve*>*>* Field_1_12; // 0x50
	::System::Collections::Generic::HashSet_1<::RPG::Client::LittleGame::FourRotateVoxel::FourRotateVoxelStructGameView*>* Field_1_13; // 0x58
	::UnityEngine::Coroutine* Field_1_14; // 0x60
	::System::Collections::Generic::Dictionary_2<::Class_2_1A8148841049062A*, ::Class_2_1A8148841049062A*>* Field_1_15; // 0x68
	::UnityEngine::Transform* Field_1_16; // 0x70
