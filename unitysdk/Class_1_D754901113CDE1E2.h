...
#define CLASS_1_D754901113CDE1E2__CTOR_OFFSET UNITYSDK_OFFSET(0x18F7C0E0)
...
public:
	...
	::RPG::Client::LittleGame::ChenLing::ChenLingSoldierState Field_1_3; // 0x18
	::System::Boolean Field_1_5; // 0x1C
	::RPG::GameCore::ChenLingSoldierScale Field_1_2; // 0x20
