...
#define CLASS_1_D754901113CDE1E2__CTOR_OFFSET UNITYSDK_OFFSET(0x169FBAB0)
...
{
public:
	::RPG::Client::LittleGame::ChenLing::ChenLingSoldierState Field_1_3; // 0x10
	::RPG::GameCore::ChenLingSoldierScale Field_1_2; // 0x14
	::RPG::GameCore::ChenLingBattleInitPosition Field_1_4; // 0x18
