...
#define SCENENLIGHTMANAGER_BLOCKENVEXPORTDATA_FINALIZE_OFFSET UNITYSDK_OFFSET(0xABCB1F0)
#define SCENENLIGHTMANAGER_BLOCKENVEXPORTDATA_METHOD_3_16E2BC73E2904F2F_OFFSET UNITYSDK_OFFSET(0xABCC9A0)
#define SCENENLIGHTMANAGER_BLOCKENVEXPORTDATA_METHOD_3_9B4CB6A2D6A8932F_OFFSET UNITYSDK_OFFSET(0xABCC680)
#define SCENENLIGHTMANAGER_BLOCKENVEXPORTDATA_METHOD_3_DAF6BB5E3A6072BA_OFFSET UNITYSDK_OFFSET(0xABCB200)
#define SCENENLIGHTMANAGER_BLOCKENVEXPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xABCB060)
