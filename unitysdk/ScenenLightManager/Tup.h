...
#define SCENENLIGHTMANAGER_TUP_EQUALS_OFFSET UNITYSDK_OFFSET(0x1775D2C0)
#define SCENENLIGHTMANAGER_TUP_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1775D360)
#define SCENENLIGHTMANAGER_TUP_METHOD_1_AF094A37CE984E72_OFFSET UNITYSDK_OFFSET(0x1775D340)
#define SCENENLIGHTMANAGER_TUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1775D2B0)
