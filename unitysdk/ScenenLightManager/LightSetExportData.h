...
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATA_EQUALS_OFFSET UNITYSDK_OFFSET(0xABCE270)
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xABCE530)
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATA_METHOD_1_90EA99C5B55095D8_OFFSET UNITYSDK_OFFSET(0xABCDFB0)
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xABCDF40)
