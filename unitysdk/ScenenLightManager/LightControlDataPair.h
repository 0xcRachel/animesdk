...
#define SCENENLIGHTMANAGER_LIGHTCONTROLDATAPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0xA686430)

namespace ScenenLightManager
{
	inline static constexpr unsigned int LightControlDataPair_TypeDefinitionIndex = 38866;
