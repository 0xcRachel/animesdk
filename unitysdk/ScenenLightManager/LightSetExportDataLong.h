...
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATALONG_EQUALS_OFFSET UNITYSDK_OFFSET(0xABCEBF0)
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATALONG_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xABCEEB0)
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATALONG_METHOD_1_7172FE331F6185E2_OFFSET UNITYSDK_OFFSET(0xABCE930)
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATALONG__CTOR_OFFSET UNITYSDK_OFFSET(0xABCE880)
