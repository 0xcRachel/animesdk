...
#define SCENENLIGHTMANAGER_LOCALFOGSPHEREINSTANCE_EXPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA6882D0)

namespace ScenenLightManager
{
	inline static constexpr unsigned int LocalFogSphereInstance_ExportData_TypeDefinitionIndex = 38816;
