...
#define CLASS_1_EF0E638FDA49C9A1_5_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x181045A0)
#define CLASS_1_EF0E638FDA49C9A1_5_CLONE_OFFSET UNITYSDK_OFFSET(0x181040B0)
#define CLASS_1_EF0E638FDA49C9A1_5_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x181041D0)
#define CLASS_1_EF0E638FDA49C9A1_5_EQUALS_OFFSET UNITYSDK_OFFSET(0x18104170)
#define CLASS_1_EF0E638FDA49C9A1_5_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x181042E0)
#define CLASS_1_EF0E638FDA49C9A1_5_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x181048A0)
#define CLASS_1_EF0E638FDA49C9A1_5_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x18104770)
#define CLASS_1_EF0E638FDA49C9A1_5_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x18104150)
#define CLASS_1_EF0E638FDA49C9A1_5_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x18104130)
#define CLASS_1_EF0E638FDA49C9A1_5_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x18104110)
#define CLASS_1_EF0E638FDA49C9A1_5_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x18104100)
#define CLASS_1_EF0E638FDA49C9A1_5_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x18104160)
#define CLASS_1_EF0E638FDA49C9A1_5_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x18104140)
#define CLASS_1_EF0E638FDA49C9A1_5_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x18104120)
#define CLASS_1_EF0E638FDA49C9A1_5_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x18103F20)
#define CLASS_1_EF0E638FDA49C9A1_5_TOSTRING_OFFSET UNITYSDK_OFFSET(0x18104400)
#define CLASS_1_EF0E638FDA49C9A1_5_WRITETO_OFFSET UNITYSDK_OFFSET(0x18104460)
#define CLASS_1_EF0E638FDA49C9A1_5__CCTOR_OFFSET UNITYSDK_OFFSET(0x181049C0)
#define CLASS_1_EF0E638FDA49C9A1_5__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18103F80)
#define CLASS_1_EF0E638FDA49C9A1_5__CTOR_OFFSET UNITYSDK_OFFSET(0x18103F30)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_352A8B3482C80E7D_57*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_EF0E638FDA49C9A1_5_TypeDefinitionIndex)->GetStaticField(0x3C1C0);
	}
	...
	::Class_1_352A8B3482C80E7D_57* Field_1_5; // 0x18
