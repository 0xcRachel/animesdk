...
#define CLASS_1_5B567C8A01BAEDFE_358_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A228960)
#define CLASS_1_5B567C8A01BAEDFE_358_CLONE_OFFSET UNITYSDK_OFFSET(0x1A228770)
#define CLASS_1_5B567C8A01BAEDFE_358_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A228870)
#define CLASS_1_5B567C8A01BAEDFE_358_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A2287E0)
#define CLASS_1_5B567C8A01BAEDFE_358_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A2288C0)
#define CLASS_1_5B567C8A01BAEDFE_358_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A2289B0)
#define CLASS_1_5B567C8A01BAEDFE_358_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A228980)
#define CLASS_1_5B567C8A01BAEDFE_358_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A2286C0)
#define CLASS_1_5B567C8A01BAEDFE_358_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A228720)
#define CLASS_1_5B567C8A01BAEDFE_358_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A2288F0)
#define CLASS_1_5B567C8A01BAEDFE_358_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A228950)
#define CLASS_1_5B567C8A01BAEDFE_358__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A228A00)
#define CLASS_1_5B567C8A01BAEDFE_358__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A228740)
#define CLASS_1_5B567C8A01BAEDFE_358__CTOR_OFFSET UNITYSDK_OFFSET(0x1A228730)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_358*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_358_TypeDefinitionIndex)->GetStaticField(0x5BD50);
	}
