...
#define CLASS_1_C2C9A7740D1A7E61_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17F7BFA0)
#define CLASS_1_C2C9A7740D1A7E61_CLONE_OFFSET UNITYSDK_OFFSET(0x17F7BB10)
#define CLASS_1_C2C9A7740D1A7E61_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17F7BC70)
#define CLASS_1_C2C9A7740D1A7E61_EQUALS_OFFSET UNITYSDK_OFFSET(0x17F7BBB0)
#define CLASS_1_C2C9A7740D1A7E61_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17F7BD20)
#define CLASS_1_C2C9A7740D1A7E61_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x17F7C1A0)
#define CLASS_1_C2C9A7740D1A7E61_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x17F7C140)
#define CLASS_1_C2C9A7740D1A7E61_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x17F7BB40)
#define CLASS_1_C2C9A7740D1A7E61_METHOD_1_3DACC45AC8150727_OFFSET UNITYSDK_OFFSET(0x17F7BB70)
#define CLASS_1_C2C9A7740D1A7E61_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x17F7BB80)
#define CLASS_1_C2C9A7740D1A7E61_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x17F7BB50)
#define CLASS_1_C2C9A7740D1A7E61_METHOD_1_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x17F7BB60)
#define CLASS_1_C2C9A7740D1A7E61_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x17F7BBA0)
#define CLASS_1_C2C9A7740D1A7E61_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x17F7BB90)
#define CLASS_1_C2C9A7740D1A7E61_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17F7BA10)
#define CLASS_1_C2C9A7740D1A7E61_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17F7BE30)
#define CLASS_1_C2C9A7740D1A7E61_WRITETO_OFFSET UNITYSDK_OFFSET(0x17F7BE90)
#define CLASS_1_C2C9A7740D1A7E61__CCTOR_OFFSET UNITYSDK_OFFSET(0x17F7C2A0)
#define CLASS_1_C2C9A7740D1A7E61__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17F7BA70)
#define CLASS_1_C2C9A7740D1A7E61__CTOR_OFFSET UNITYSDK_OFFSET(0x17F7BA20)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_C2C9A7740D1A7E61_TypeDefinitionIndex)->GetStaticField(0x403B0);
	}
	...
	::Enum_3_0A3761FE34514D6C_44 Field_1_4; // 0x28
