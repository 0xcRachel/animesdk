...
#define CLASS_1_E008CE606C0CBC65_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14C34460)
#define CLASS_1_E008CE606C0CBC65_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x14C33F30)
#define CLASS_1_E008CE606C0CBC65_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x14C344E0)
#define CLASS_1_E008CE606C0CBC65_METHOD_1_3A68DB68020E5E2D_OFFSET UNITYSDK_OFFSET(0x14C33FB0)
#define CLASS_1_E008CE606C0CBC65_METHOD_1_96826B3FCA681BFB_OFFSET UNITYSDK_OFFSET(0x14C34040)
#define CLASS_1_E008CE606C0CBC65_METHOD_1_9C06C768B25E4E13_OFFSET UNITYSDK_OFFSET(0x14C33F50)
#define CLASS_1_E008CE606C0CBC65_METHOD_1_AA169839CB93802A_1_OFFSET UNITYSDK_OFFSET(0x14C34190)
#define CLASS_1_E008CE606C0CBC65_METHOD_1_AA169839CB93802A_OFFSET UNITYSDK_OFFSET(0x14C340E0)
#define CLASS_1_E008CE606C0CBC65_METHOD_1_C1B4662E5F4E0C15_OFFSET UNITYSDK_OFFSET(0x14C34240)
#define CLASS_1_E008CE606C0CBC65_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x14C33F40)
#define CLASS_1_E008CE606C0CBC65__CTOR_OFFSET UNITYSDK_OFFSET(0x14C342D0)

inline static constexpr unsigned int Class_1_E008CE606C0CBC65_TypeDefinitionIndex = 74357;
...
public:
	...
	{
		return (::Class_1_E008CE606C0CBC65**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E008CE606C0CBC65_TypeDefinitionIndex)->GetStaticField(0x574B0);
	}
	::Il2CppArray<::Class_0_16E4307DCC419505_1228*>* Field_1_1; // 0x10
