...
#define SPINE_POLYGON_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x17BA1AE0)
#define SPINE_POLYGON_GET_VERTICES_OFFSET UNITYSDK_OFFSET(0x17BA1AC0)
#define SPINE_POLYGON_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x17BA1AF0)
#define SPINE_POLYGON_SET_VERTICES_OFFSET UNITYSDK_OFFSET(0x17BA1AD0)
#define SPINE_POLYGON__CTOR_OFFSET UNITYSDK_OFFSET(0x17BA1B00)

namespace Spine
{
	inline static constexpr unsigned int Polygon_TypeDefinitionIndex = 29857;
