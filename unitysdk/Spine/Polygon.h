...
#define SPINE_POLYGON_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x183BAD70)
#define SPINE_POLYGON_GET_VERTICES_OFFSET UNITYSDK_OFFSET(0x183BAD50)
#define SPINE_POLYGON_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x183BAD80)
#define SPINE_POLYGON_SET_VERTICES_OFFSET UNITYSDK_OFFSET(0x183BAD60)
#define SPINE_POLYGON__CTOR_OFFSET UNITYSDK_OFFSET(0x183BAD90)
