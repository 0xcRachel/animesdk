...
#define SPINE_SLOT_CLAMPCOLOR_OFFSET UNITYSDK_OFFSET(0x17B88AB0)
#define SPINE_SLOT_CLAMPSECONDCOLOR_OFFSET UNITYSDK_OFFSET(0x17BA2B00)
#define SPINE_SLOT_GET_ATTACHMENT_OFFSET UNITYSDK_OFFSET(0x17BDE910)
#define SPINE_SLOT_GET_A_OFFSET UNITYSDK_OFFSET(0x17BDE850)
#define SPINE_SLOT_GET_B2_OFFSET UNITYSDK_OFFSET(0x17BDE8B0)
#define SPINE_SLOT_GET_BONE_OFFSET UNITYSDK_OFFSET(0x17BDE7C0)
#define SPINE_SLOT_GET_B_OFFSET UNITYSDK_OFFSET(0x17BDE830)
#define SPINE_SLOT_GET_DATA_OFFSET UNITYSDK_OFFSET(0x17BDE7B0)
#define SPINE_SLOT_GET_DEFORM_OFFSET UNITYSDK_OFFSET(0x17BDE940)
#define SPINE_SLOT_GET_G2_OFFSET UNITYSDK_OFFSET(0x17BDE890)
#define SPINE_SLOT_GET_G_OFFSET UNITYSDK_OFFSET(0x17BDE810)
#define SPINE_SLOT_GET_HASSECONDCOLOR_OFFSET UNITYSDK_OFFSET(0x17BDE8D0)
#define SPINE_SLOT_GET_R2_OFFSET UNITYSDK_OFFSET(0x17BDE870)
#define SPINE_SLOT_GET_R_OFFSET UNITYSDK_OFFSET(0x17BDE7F0)
#define SPINE_SLOT_GET_SEQUENCEINDEX_OFFSET UNITYSDK_OFFSET(0x17BDE920)
#define SPINE_SLOT_GET_SKELETON_OFFSET UNITYSDK_OFFSET(0x17BDE7D0)
#define SPINE_SLOT_SETTOSETUPPOSE_OFFSET UNITYSDK_OFFSET(0x17BAC0C0)
#define SPINE_SLOT_SET_ATTACHMENT_OFFSET UNITYSDK_OFFSET(0x17B8D7F0)
#define SPINE_SLOT_SET_A_OFFSET UNITYSDK_OFFSET(0x17BDE860)
#define SPINE_SLOT_SET_B2_OFFSET UNITYSDK_OFFSET(0x17BDE8C0)
#define SPINE_SLOT_SET_B_OFFSET UNITYSDK_OFFSET(0x17BDE840)
#define SPINE_SLOT_SET_DEFORM_OFFSET UNITYSDK_OFFSET(0x17BDE950)
#define SPINE_SLOT_SET_G2_OFFSET UNITYSDK_OFFSET(0x17BDE8A0)
#define SPINE_SLOT_SET_G_OFFSET UNITYSDK_OFFSET(0x17BDE820)
#define SPINE_SLOT_SET_HASSECONDCOLOR_OFFSET UNITYSDK_OFFSET(0x17BDE8F0)
#define SPINE_SLOT_SET_R2_OFFSET UNITYSDK_OFFSET(0x17BDE880)
#define SPINE_SLOT_SET_R_OFFSET UNITYSDK_OFFSET(0x17BDE800)
#define SPINE_SLOT_SET_SEQUENCEINDEX_OFFSET UNITYSDK_OFFSET(0x17BDE930)
#define SPINE_SLOT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17BDE9D0)
#define SPINE_SLOT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17BAA6C0)
#define SPINE_SLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x17BA9380)

namespace Spine
{
	inline static constexpr unsigned int Slot_TypeDefinitionIndex = 29867;
