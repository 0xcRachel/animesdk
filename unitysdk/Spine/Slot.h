...
#define SPINE_SLOT_CLAMPCOLOR_OFFSET UNITYSDK_OFFSET(0x183A2280)
#define SPINE_SLOT_CLAMPSECONDCOLOR_OFFSET UNITYSDK_OFFSET(0x183BBD30)
#define SPINE_SLOT_GET_ATTACHMENT_OFFSET UNITYSDK_OFFSET(0x183F7A70)
#define SPINE_SLOT_GET_A_OFFSET UNITYSDK_OFFSET(0x183F79B0)
#define SPINE_SLOT_GET_B2_OFFSET UNITYSDK_OFFSET(0x183F7A10)
#define SPINE_SLOT_GET_BONE_OFFSET UNITYSDK_OFFSET(0x183F7920)
#define SPINE_SLOT_GET_B_OFFSET UNITYSDK_OFFSET(0x183F7990)
#define SPINE_SLOT_GET_DATA_OFFSET UNITYSDK_OFFSET(0x183F7910)
#define SPINE_SLOT_GET_DEFORM_OFFSET UNITYSDK_OFFSET(0x183F7AA0)
#define SPINE_SLOT_GET_G2_OFFSET UNITYSDK_OFFSET(0x183F79F0)
#define SPINE_SLOT_GET_G_OFFSET UNITYSDK_OFFSET(0x183F7970)
#define SPINE_SLOT_GET_HASSECONDCOLOR_OFFSET UNITYSDK_OFFSET(0x183F7A30)
#define SPINE_SLOT_GET_R2_OFFSET UNITYSDK_OFFSET(0x183F79D0)
#define SPINE_SLOT_GET_R_OFFSET UNITYSDK_OFFSET(0x183F7950)
#define SPINE_SLOT_GET_SEQUENCEINDEX_OFFSET UNITYSDK_OFFSET(0x183F7A80)
#define SPINE_SLOT_GET_SKELETON_OFFSET UNITYSDK_OFFSET(0x183F7930)
#define SPINE_SLOT_SETTOSETUPPOSE_OFFSET UNITYSDK_OFFSET(0x183C51E0)
#define SPINE_SLOT_SET_ATTACHMENT_OFFSET UNITYSDK_OFFSET(0x183A6B30)
#define SPINE_SLOT_SET_A_OFFSET UNITYSDK_OFFSET(0x183F79C0)
#define SPINE_SLOT_SET_B2_OFFSET UNITYSDK_OFFSET(0x183F7A20)
#define SPINE_SLOT_SET_B_OFFSET UNITYSDK_OFFSET(0x183F79A0)
#define SPINE_SLOT_SET_DEFORM_OFFSET UNITYSDK_OFFSET(0x183F7AB0)
#define SPINE_SLOT_SET_G2_OFFSET UNITYSDK_OFFSET(0x183F7A00)
#define SPINE_SLOT_SET_G_OFFSET UNITYSDK_OFFSET(0x183F7980)
#define SPINE_SLOT_SET_HASSECONDCOLOR_OFFSET UNITYSDK_OFFSET(0x183F7A50)
#define SPINE_SLOT_SET_R2_OFFSET UNITYSDK_OFFSET(0x183F79E0)
#define SPINE_SLOT_SET_R_OFFSET UNITYSDK_OFFSET(0x183F7960)
#define SPINE_SLOT_SET_SEQUENCEINDEX_OFFSET UNITYSDK_OFFSET(0x183F7A90)
#define SPINE_SLOT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x183F7B30)
#define SPINE_SLOT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x183C3830)
#define SPINE_SLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x183C2520)
