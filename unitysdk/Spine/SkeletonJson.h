...
#define SPINE_SKELETONJSON_FINDSLOTINDEX_OFFSET UNITYSDK_OFFSET(0x17BC7B50)
#define SPINE_SKELETONJSON_GETBOOLEAN_OFFSET UNITYSDK_OFFSET(0x17BC7890)
#define SPINE_SKELETONJSON_GETFLOATARRAY_OFFSET UNITYSDK_OFFSET(0x17BDC8D0)
#define SPINE_SKELETONJSON_GETFLOAT_OFFSET UNITYSDK_OFFSET(0x17BC7710)
#define SPINE_SKELETONJSON_GETINTARRAY_OFFSET UNITYSDK_OFFSET(0x17BDCB10)
#define SPINE_SKELETONJSON_GETINT_1_OFFSET UNITYSDK_OFFSET(0x17BDCC60)
#define SPINE_SKELETONJSON_GETINT_OFFSET UNITYSDK_OFFSET(0x17BC7A70)
#define SPINE_SKELETONJSON_GETSTRING_OFFSET UNITYSDK_OFFSET(0x17BC7800)
#define SPINE_SKELETONJSON_READANIMATION_OFFSET UNITYSDK_OFFSET(0x17BC8D60)
#define SPINE_SKELETONJSON_READATTACHMENT_OFFSET UNITYSDK_OFFSET(0x17BC7CB0)
#define SPINE_SKELETONJSON_READCURVE_OFFSET UNITYSDK_OFFSET(0x17BDCDB0)
#define SPINE_SKELETONJSON_READSEQUENCE_OFFSET UNITYSDK_OFFSET(0x17BDC190)
#define SPINE_SKELETONJSON_READSKELETONDATA_1_OFFSET UNITYSDK_OFFSET(0x17BBF930)
#define SPINE_SKELETONJSON_READSKELETONDATA_OFFSET UNITYSDK_OFFSET(0x17BBF6E0)
#define SPINE_SKELETONJSON_READTIMELINE_1_OFFSET UNITYSDK_OFFSET(0x17BDD4F0)
#define SPINE_SKELETONJSON_READTIMELINE_OFFSET UNITYSDK_OFFSET(0x17BDD180)
#define SPINE_SKELETONJSON_READVERTICES_OFFSET UNITYSDK_OFFSET(0x17BDC280)
#define SPINE_SKELETONJSON_SETBEZIER_OFFSET UNITYSDK_OFFSET(0x17BDD8C0)
#define SPINE_SKELETONJSON_TOCOLOR_OFFSET UNITYSDK_OFFSET(0x17BC7970)
#define SPINE_SKELETONJSON__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17BBF6D0)
#define SPINE_SKELETONJSON__CTOR_OFFSET UNITYSDK_OFFSET(0x17BBF650)

namespace Spine
{
	inline static constexpr unsigned int SkeletonJson_TypeDefinitionIndex = 29860;
