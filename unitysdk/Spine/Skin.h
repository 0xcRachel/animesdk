...
#define SPINE_SKIN_ADDSKIN_OFFSET UNITYSDK_OFFSET(0x15700F30)
#define SPINE_SKIN_ATTACHALL_OFFSET UNITYSDK_OFFSET(0x156CFA50)
#define SPINE_SKIN_CLEAR_OFFSET UNITYSDK_OFFSET(0x15701AA0)
#define SPINE_SKIN_COPYSKIN_OFFSET UNITYSDK_OFFSET(0x15701380)
#define SPINE_SKIN_GETATTACHMENTS_OFFSET UNITYSDK_OFFSET(0x157018C0)
#define SPINE_SKIN_GETATTACHMENT_OFFSET UNITYSDK_OFFSET(0x156CFD70)
#define SPINE_SKIN_GET_ATTACHMENTS_OFFSET UNITYSDK_OFFSET(0x156CEA90)
#define SPINE_SKIN_GET_BONES_OFFSET UNITYSDK_OFFSET(0x15700DF0)
#define SPINE_SKIN_GET_CONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x15700E00)
#define SPINE_SKIN_GET_NAME_OFFSET UNITYSDK_OFFSET(0x15700DE0)
#define SPINE_SKIN_REMOVEATTACHMENT_OFFSET UNITYSDK_OFFSET(0x15701860)
#define SPINE_SKIN_SETATTACHMENT_OFFSET UNITYSDK_OFFSET(0x156DD210)
#define SPINE_SKIN_TOSTRING_OFFSET UNITYSDK_OFFSET(0x15701B80)
#define SPINE_SKIN__CTOR_OFFSET UNITYSDK_OFFSET(0x156DC1E0)
...
namespace Spine
{
	...
	public:
		...
		::Spine::ExposedList_1<::Spine::BoneData*>* bones; // 0x18
