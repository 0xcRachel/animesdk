...
#define SPINE_SKIN_ADDSKIN_OFFSET UNITYSDK_OFFSET(0x183F6C10)
#define SPINE_SKIN_ATTACHALL_OFFSET UNITYSDK_OFFSET(0x183C57B0)
#define SPINE_SKIN_CLEAR_OFFSET UNITYSDK_OFFSET(0x183F7780)
#define SPINE_SKIN_COPYSKIN_OFFSET UNITYSDK_OFFSET(0x183F7060)
#define SPINE_SKIN_GETATTACHMENTS_OFFSET UNITYSDK_OFFSET(0x183F75A0)
#define SPINE_SKIN_GETATTACHMENT_OFFSET UNITYSDK_OFFSET(0x183C5AD0)
#define SPINE_SKIN_GET_ATTACHMENTS_OFFSET UNITYSDK_OFFSET(0x183C47C0)
#define SPINE_SKIN_GET_BONES_OFFSET UNITYSDK_OFFSET(0x183F6AD0)
#define SPINE_SKIN_GET_CONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x183F6AE0)
#define SPINE_SKIN_GET_NAME_OFFSET UNITYSDK_OFFSET(0x183F6AC0)
#define SPINE_SKIN_REMOVEATTACHMENT_OFFSET UNITYSDK_OFFSET(0x183F7540)
#define SPINE_SKIN_SETATTACHMENT_OFFSET UNITYSDK_OFFSET(0x183D2F90)
#define SPINE_SKIN_TOSTRING_OFFSET UNITYSDK_OFFSET(0x183F7860)
#define SPINE_SKIN__CTOR_OFFSET UNITYSDK_OFFSET(0x183D1F70)
...
namespace Spine
{
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::Spine::Skin_SkinKey, ::Spine::Skin_SkinEntry>* attachments; // 0x28
