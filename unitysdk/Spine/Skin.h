...
#define SPINE_SKIN_ADDSKIN_OFFSET UNITYSDK_OFFSET(0x12BC9B50)
#define SPINE_SKIN_ATTACHALL_OFFSET UNITYSDK_OFFSET(0x12B983F0)
#define SPINE_SKIN_CLEAR_OFFSET UNITYSDK_OFFSET(0x12BCA660)
#define SPINE_SKIN_COPYSKIN_OFFSET UNITYSDK_OFFSET(0x12BC9F50)
#define SPINE_SKIN_GETATTACHMENTS_OFFSET UNITYSDK_OFFSET(0x12BCA440)
#define SPINE_SKIN_GETATTACHMENT_OFFSET UNITYSDK_OFFSET(0x12B98620)
#define SPINE_SKIN_GET_ATTACHMENTS_OFFSET UNITYSDK_OFFSET(0x12B97520)
#define SPINE_SKIN_GET_BONES_OFFSET UNITYSDK_OFFSET(0x12BC9A10)
#define SPINE_SKIN_GET_CONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x12BC9A20)
#define SPINE_SKIN_GET_NAME_OFFSET UNITYSDK_OFFSET(0x12BC9A00)
#define SPINE_SKIN_REMOVEATTACHMENT_OFFSET UNITYSDK_OFFSET(0x12BCA3E0)
#define SPINE_SKIN_SETATTACHMENT_OFFSET UNITYSDK_OFFSET(0x12BA6690)
#define SPINE_SKIN_TOSTRING_OFFSET UNITYSDK_OFFSET(0x12BCA730)
#define SPINE_SKIN__CTOR_OFFSET UNITYSDK_OFFSET(0x12BA56B0)
