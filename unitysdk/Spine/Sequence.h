...
#define SPINE_SEQUENCE_APPLY_OFFSET UNITYSDK_OFFSET(0x183B58A0)
#define SPINE_SEQUENCE_GETPATH_OFFSET UNITYSDK_OFFSET(0x183AC540)
#define SPINE_SEQUENCE_GET_DIGITS_OFFSET UNITYSDK_OFFSET(0x183BFDF0)
#define SPINE_SEQUENCE_GET_ID_OFFSET UNITYSDK_OFFSET(0x183BFE40)
#define SPINE_SEQUENCE_GET_REGIONS_OFFSET UNITYSDK_OFFSET(0x183BFE30)
#define SPINE_SEQUENCE_GET_SETUPINDEX_OFFSET UNITYSDK_OFFSET(0x183BFE10)
#define SPINE_SEQUENCE_GET_START_OFFSET UNITYSDK_OFFSET(0x183BFDD0)
#define SPINE_SEQUENCE_SET_DIGITS_OFFSET UNITYSDK_OFFSET(0x183BFE00)
#define SPINE_SEQUENCE_SET_SETUPINDEX_OFFSET UNITYSDK_OFFSET(0x183BFE20)
#define SPINE_SEQUENCE_SET_START_OFFSET UNITYSDK_OFFSET(0x183BFDE0)
#define SPINE_SEQUENCE__CCTOR_OFFSET UNITYSDK_OFFSET(0x183BFFA0)
#define SPINE_SEQUENCE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x183B51B0)
#define SPINE_SEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x183BFE50)
...
namespace Spine
{
	...
	public:
		...
		{
			return (::System::Object**)Il2CppClass::FromTypeDefinitionIndex(Sequence_TypeDefinitionIndex)->GetStaticField(0x443C0);
		}
		static ::System::Int32* StaticGet_nextID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Sequence_TypeDefinitionIndex)->GetStaticField(0x11980);
		}
