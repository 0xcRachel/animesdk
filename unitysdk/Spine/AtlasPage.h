...
#define SPINE_ATLASPAGE_CLONE_OFFSET UNITYSDK_OFFSET(0x17B93B30)
#define SPINE_ATLASPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x17B91CA0)

namespace Spine
{
	inline static constexpr unsigned int AtlasPage_TypeDefinitionIndex = 29813;
