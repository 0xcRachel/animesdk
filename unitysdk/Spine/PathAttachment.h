...
#define SPINE_PATHATTACHMENT_COPY_OFFSET UNITYSDK_OFFSET(0x17B9CAC0)
#define SPINE_PATHATTACHMENT_GET_CLOSED_OFFSET UNITYSDK_OFFSET(0x17B9C9E0)
#define SPINE_PATHATTACHMENT_GET_CONSTANTSPEED_OFFSET UNITYSDK_OFFSET(0x17B9CA00)
#define SPINE_PATHATTACHMENT_GET_LENGTHS_OFFSET UNITYSDK_OFFSET(0x17B9C9C0)
#define SPINE_PATHATTACHMENT_SET_CLOSED_OFFSET UNITYSDK_OFFSET(0x17B9C9F0)
#define SPINE_PATHATTACHMENT_SET_CONSTANTSPEED_OFFSET UNITYSDK_OFFSET(0x17B9CA10)
#define SPINE_PATHATTACHMENT_SET_LENGTHS_OFFSET UNITYSDK_OFFSET(0x17B9C9D0)
#define SPINE_PATHATTACHMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17B9CA20)
#define SPINE_PATHATTACHMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x17B93980)

namespace Spine
{
	inline static constexpr unsigned int PathAttachment_TypeDefinitionIndex = 29824;
