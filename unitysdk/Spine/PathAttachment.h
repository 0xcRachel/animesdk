...
#define SPINE_PATHATTACHMENT_COPY_OFFSET UNITYSDK_OFFSET(0x183B5D30)
#define SPINE_PATHATTACHMENT_GET_CLOSED_OFFSET UNITYSDK_OFFSET(0x183B5C50)
#define SPINE_PATHATTACHMENT_GET_CONSTANTSPEED_OFFSET UNITYSDK_OFFSET(0x183B5C70)
#define SPINE_PATHATTACHMENT_GET_LENGTHS_OFFSET UNITYSDK_OFFSET(0x183B5C30)
#define SPINE_PATHATTACHMENT_SET_CLOSED_OFFSET UNITYSDK_OFFSET(0x183B5C60)
#define SPINE_PATHATTACHMENT_SET_CONSTANTSPEED_OFFSET UNITYSDK_OFFSET(0x183B5C80)
#define SPINE_PATHATTACHMENT_SET_LENGTHS_OFFSET UNITYSDK_OFFSET(0x183B5C40)
#define SPINE_PATHATTACHMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x183B5C90)
#define SPINE_PATHATTACHMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x183ACC00)
