...
#define SPINE_EVENT_GET_BALANCE_OFFSET UNITYSDK_OFFSET(0x183B1CE0)
#define SPINE_EVENT_GET_DATA_OFFSET UNITYSDK_OFFSET(0x183B1C40)
#define SPINE_EVENT_GET_FLOAT_OFFSET UNITYSDK_OFFSET(0x183B1C80)
#define SPINE_EVENT_GET_INT_OFFSET UNITYSDK_OFFSET(0x183B1C60)
#define SPINE_EVENT_GET_STRING_OFFSET UNITYSDK_OFFSET(0x183B1CA0)
#define SPINE_EVENT_GET_TIME_OFFSET UNITYSDK_OFFSET(0x183B1C50)
#define SPINE_EVENT_GET_VOLUME_OFFSET UNITYSDK_OFFSET(0x183B1CC0)
#define SPINE_EVENT_SET_BALANCE_OFFSET UNITYSDK_OFFSET(0x183B1CF0)
#define SPINE_EVENT_SET_FLOAT_OFFSET UNITYSDK_OFFSET(0x183B1C90)
#define SPINE_EVENT_SET_INT_OFFSET UNITYSDK_OFFSET(0x183B1C70)
#define SPINE_EVENT_SET_STRING_OFFSET UNITYSDK_OFFSET(0x183B1CB0)
#define SPINE_EVENT_SET_VOLUME_OFFSET UNITYSDK_OFFSET(0x183B1CD0)
#define SPINE_EVENT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x183B1D90)
#define SPINE_EVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x183B1D00)
