...
#define SPINE_EVENT_GET_BALANCE_OFFSET UNITYSDK_OFFSET(0x156BBF40)
#define SPINE_EVENT_GET_DATA_OFFSET UNITYSDK_OFFSET(0x156BBEA0)
#define SPINE_EVENT_GET_FLOAT_OFFSET UNITYSDK_OFFSET(0x156BBEE0)
#define SPINE_EVENT_GET_INT_OFFSET UNITYSDK_OFFSET(0x156BBEC0)
#define SPINE_EVENT_GET_STRING_OFFSET UNITYSDK_OFFSET(0x156BBF00)
#define SPINE_EVENT_GET_TIME_OFFSET UNITYSDK_OFFSET(0x156BBEB0)
#define SPINE_EVENT_GET_VOLUME_OFFSET UNITYSDK_OFFSET(0x156BBF20)
#define SPINE_EVENT_SET_BALANCE_OFFSET UNITYSDK_OFFSET(0x156BBF50)
#define SPINE_EVENT_SET_FLOAT_OFFSET UNITYSDK_OFFSET(0x156BBEF0)
#define SPINE_EVENT_SET_INT_OFFSET UNITYSDK_OFFSET(0x156BBED0)
#define SPINE_EVENT_SET_STRING_OFFSET UNITYSDK_OFFSET(0x156BBF10)
#define SPINE_EVENT_SET_VOLUME_OFFSET UNITYSDK_OFFSET(0x156BBF30)
#define SPINE_EVENT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x156BBFF0)
#define SPINE_EVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x156BBF60)
