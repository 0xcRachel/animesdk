...
#define SPINE_EVENT_GET_BALANCE_OFFSET UNITYSDK_OFFSET(0x12B86600)
#define SPINE_EVENT_GET_DATA_OFFSET UNITYSDK_OFFSET(0x12B86560)
#define SPINE_EVENT_GET_FLOAT_OFFSET UNITYSDK_OFFSET(0x12B865A0)
#define SPINE_EVENT_GET_INT_OFFSET UNITYSDK_OFFSET(0x12B86580)
#define SPINE_EVENT_GET_STRING_OFFSET UNITYSDK_OFFSET(0x12B865C0)
#define SPINE_EVENT_GET_TIME_OFFSET UNITYSDK_OFFSET(0x12B86570)
#define SPINE_EVENT_GET_VOLUME_OFFSET UNITYSDK_OFFSET(0x12B865E0)
#define SPINE_EVENT_SET_BALANCE_OFFSET UNITYSDK_OFFSET(0x12B86610)
#define SPINE_EVENT_SET_FLOAT_OFFSET UNITYSDK_OFFSET(0x12B865B0)
#define SPINE_EVENT_SET_INT_OFFSET UNITYSDK_OFFSET(0x12B86590)
#define SPINE_EVENT_SET_STRING_OFFSET UNITYSDK_OFFSET(0x12B865D0)
#define SPINE_EVENT_SET_VOLUME_OFFSET UNITYSDK_OFFSET(0x12B865F0)
#define SPINE_EVENT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x12B866B0)
#define SPINE_EVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x12B86620)
