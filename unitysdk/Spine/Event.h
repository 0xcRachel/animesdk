...
#define SPINE_EVENT_GET_BALANCE_OFFSET UNITYSDK_OFFSET(0x17B98AF0)
#define SPINE_EVENT_GET_DATA_OFFSET UNITYSDK_OFFSET(0x17B98A50)
#define SPINE_EVENT_GET_FLOAT_OFFSET UNITYSDK_OFFSET(0x17B98A90)
#define SPINE_EVENT_GET_INT_OFFSET UNITYSDK_OFFSET(0x17B98A70)
#define SPINE_EVENT_GET_STRING_OFFSET UNITYSDK_OFFSET(0x17B98AB0)
#define SPINE_EVENT_GET_TIME_OFFSET UNITYSDK_OFFSET(0x17B98A60)
#define SPINE_EVENT_GET_VOLUME_OFFSET UNITYSDK_OFFSET(0x17B98AD0)
#define SPINE_EVENT_SET_BALANCE_OFFSET UNITYSDK_OFFSET(0x17B98B00)
#define SPINE_EVENT_SET_FLOAT_OFFSET UNITYSDK_OFFSET(0x17B98AA0)
#define SPINE_EVENT_SET_INT_OFFSET UNITYSDK_OFFSET(0x17B98A80)
#define SPINE_EVENT_SET_STRING_OFFSET UNITYSDK_OFFSET(0x17B98AC0)
#define SPINE_EVENT_SET_VOLUME_OFFSET UNITYSDK_OFFSET(0x17B98AE0)
#define SPINE_EVENT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17B98BA0)
#define SPINE_EVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x17B98B10)

namespace Spine
{
	inline static constexpr unsigned int Event_TypeDefinitionIndex = 29835;
