...
#define SPINE_SKELETON_FINDBONE_OFFSET UNITYSDK_OFFSET(0x12B97FC0)
#define SPINE_SKELETON_FINDIKCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x12B989E0)
#define SPINE_SKELETON_FINDPATHCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x12B98C20)
#define SPINE_SKELETON_FINDSLOT_OFFSET UNITYSDK_OFFSET(0x12B980E0)
#define SPINE_SKELETON_FINDTRANSFORMCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x12B98B00)
#define SPINE_SKELETON_GETATTACHMENT_1_OFFSET UNITYSDK_OFFSET(0x12B7AD30)
#define SPINE_SKELETON_GETATTACHMENT_OFFSET UNITYSDK_OFFSET(0x12B986B0)
#define SPINE_SKELETON_GETBOUNDS_OFFSET UNITYSDK_OFFSET(0x12B98D40)
#define SPINE_SKELETON_GET_A_OFFSET UNITYSDK_OFFSET(0x12B94B80)
#define SPINE_SKELETON_GET_BONES_OFFSET UNITYSDK_OFFSET(0x12B94890)
#define SPINE_SKELETON_GET_B_OFFSET UNITYSDK_OFFSET(0x12B94B60)
#define SPINE_SKELETON_GET_DATA_OFFSET UNITYSDK_OFFSET(0x12B94880)
#define SPINE_SKELETON_GET_DRAWORDER_OFFSET UNITYSDK_OFFSET(0x12B948C0)
#define SPINE_SKELETON_GET_FLIPX_OFFSET UNITYSDK_OFFSET(0x12B94C10)
#define SPINE_SKELETON_GET_FLIPY_OFFSET UNITYSDK_OFFSET(0x12B94C60)
#define SPINE_SKELETON_GET_G_OFFSET UNITYSDK_OFFSET(0x12B94B40)
#define SPINE_SKELETON_GET_IKCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x12B948D0)
#define SPINE_SKELETON_GET_PATHCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x12B948E0)
#define SPINE_SKELETON_GET_ROOTBONE_OFFSET UNITYSDK_OFFSET(0x12B94CB0)
#define SPINE_SKELETON_GET_R_OFFSET UNITYSDK_OFFSET(0x12B94B20)
#define SPINE_SKELETON_GET_SCALEX_OFFSET UNITYSDK_OFFSET(0x12B94BE0)
#define SPINE_SKELETON_GET_SCALEY_OFFSET UNITYSDK_OFFSET(0x12B83530)
#define SPINE_SKELETON_GET_SKIN_OFFSET UNITYSDK_OFFSET(0x12B94900)
#define SPINE_SKELETON_GET_SLOTS_OFFSET UNITYSDK_OFFSET(0x12B948B0)
#define SPINE_SKELETON_GET_TRANSFORMCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x12B948F0)
#define SPINE_SKELETON_GET_UPDATECACHELIST_OFFSET UNITYSDK_OFFSET(0x12B948A0)
#define SPINE_SKELETON_GET_X_OFFSET UNITYSDK_OFFSET(0x12B94BA0)
#define SPINE_SKELETON_GET_Y_OFFSET UNITYSDK_OFFSET(0x12B94BC0)
#define SPINE_SKELETON_SETATTACHMENT_OFFSET UNITYSDK_OFFSET(0x12B98800)
#define SPINE_SKELETON_SETBONESTOSETUPPOSE_OFFSET UNITYSDK_OFFSET(0x12B97B90)
#define SPINE_SKELETON_SETSKIN_1_OFFSET UNITYSDK_OFFSET(0x12B94920)
#define SPINE_SKELETON_SETSKIN_OFFSET UNITYSDK_OFFSET(0x12B98200)
#define SPINE_SKELETON_SETSLOTSTOSETUPPOSE_OFFSET UNITYSDK_OFFSET(0x12B97E30)
#define SPINE_SKELETON_SETTOSETUPPOSE_OFFSET UNITYSDK_OFFSET(0x12B97B70)
#define SPINE_SKELETON_SET_A_OFFSET UNITYSDK_OFFSET(0x12B94B90)
#define SPINE_SKELETON_SET_B_OFFSET UNITYSDK_OFFSET(0x12B94B70)
#define SPINE_SKELETON_SET_FLIPX_OFFSET UNITYSDK_OFFSET(0x12B94C20)
#define SPINE_SKELETON_SET_FLIPY_OFFSET UNITYSDK_OFFSET(0x12B94C70)
#define SPINE_SKELETON_SET_G_OFFSET UNITYSDK_OFFSET(0x12B94B50)
#define SPINE_SKELETON_SET_R_OFFSET UNITYSDK_OFFSET(0x12B94B30)
#define SPINE_SKELETON_SET_SCALEX_OFFSET UNITYSDK_OFFSET(0x12B94BF0)
#define SPINE_SKELETON_SET_SCALEY_OFFSET UNITYSDK_OFFSET(0x12B94C00)
#define SPINE_SKELETON_SET_SKIN_OFFSET UNITYSDK_OFFSET(0x12B94910)
#define SPINE_SKELETON_SET_X_OFFSET UNITYSDK_OFFSET(0x12B94BB0)
#define SPINE_SKELETON_SET_Y_OFFSET UNITYSDK_OFFSET(0x12B94BD0)
#define SPINE_SKELETON_SORTBONE_OFFSET UNITYSDK_OFFSET(0x12B96F00)
#define SPINE_SKELETON_SORTIKCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x12B967C0)
#define SPINE_SKELETON_SORTPATHCONSTRAINTATTACHMENT_1_OFFSET UNITYSDK_OFFSET(0x12B973B0)
#define SPINE_SKELETON_SORTPATHCONSTRAINTATTACHMENT_OFFSET UNITYSDK_OFFSET(0x12B96FF0)
#define SPINE_SKELETON_SORTPATHCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x12B96C50)
#define SPINE_SKELETON_SORTRESET_OFFSET UNITYSDK_OFFSET(0x12B96F60)
#define SPINE_SKELETON_SORTTRANSFORMCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x12B969D0)
#define SPINE_SKELETON_UPDATECACHE_OFFSET UNITYSDK_OFFSET(0x12B956E0)
#define SPINE_SKELETON_UPDATEWORLDTRANSFORM_1_OFFSET UNITYSDK_OFFSET(0x12B97780)
#define SPINE_SKELETON_UPDATEWORLDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x12B975B0)
#define SPINE_SKELETON__CTOR_1_OFFSET UNITYSDK_OFFSET(0x12B95AA0)
#define SPINE_SKELETON__CTOR_OFFSET UNITYSDK_OFFSET(0x12B94D00)
