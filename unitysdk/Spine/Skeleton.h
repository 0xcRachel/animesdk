...
#define SPINE_SKELETON_FINDBONE_OFFSET UNITYSDK_OFFSET(0x183C5350)
#define SPINE_SKELETON_FINDIKCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x183C5F30)
#define SPINE_SKELETON_FINDPATHCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x183C6170)
#define SPINE_SKELETON_FINDSLOT_OFFSET UNITYSDK_OFFSET(0x183C5470)
#define SPINE_SKELETON_FINDTRANSFORMCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x183C6050)
#define SPINE_SKELETON_GETATTACHMENT_1_OFFSET UNITYSDK_OFFSET(0x183A6840)
#define SPINE_SKELETON_GETATTACHMENT_OFFSET UNITYSDK_OFFSET(0x183C5B60)
#define SPINE_SKELETON_GETBOUNDS_OFFSET UNITYSDK_OFFSET(0x183C6290)
#define SPINE_SKELETON_GET_A_OFFSET UNITYSDK_OFFSET(0x183C18E0)
#define SPINE_SKELETON_GET_BONES_OFFSET UNITYSDK_OFFSET(0x183C1530)
#define SPINE_SKELETON_GET_B_OFFSET UNITYSDK_OFFSET(0x183C18C0)
#define SPINE_SKELETON_GET_DATA_OFFSET UNITYSDK_OFFSET(0x183C1520)
#define SPINE_SKELETON_GET_DRAWORDER_OFFSET UNITYSDK_OFFSET(0x183C1560)
#define SPINE_SKELETON_GET_FLIPX_OFFSET UNITYSDK_OFFSET(0x183C1970)
#define SPINE_SKELETON_GET_FLIPY_OFFSET UNITYSDK_OFFSET(0x183C19C0)
#define SPINE_SKELETON_GET_G_OFFSET UNITYSDK_OFFSET(0x183C18A0)
#define SPINE_SKELETON_GET_IKCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x183C1570)
#define SPINE_SKELETON_GET_PATHCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x183C1580)
#define SPINE_SKELETON_GET_ROOTBONE_OFFSET UNITYSDK_OFFSET(0x183C1A10)
#define SPINE_SKELETON_GET_R_OFFSET UNITYSDK_OFFSET(0x183C1880)
#define SPINE_SKELETON_GET_SCALEX_OFFSET UNITYSDK_OFFSET(0x183C1940)
#define SPINE_SKELETON_GET_SCALEY_OFFSET UNITYSDK_OFFSET(0x183AE6A0)
#define SPINE_SKELETON_GET_SKIN_OFFSET UNITYSDK_OFFSET(0x183C15A0)
#define SPINE_SKELETON_GET_SLOTS_OFFSET UNITYSDK_OFFSET(0x183C1550)
#define SPINE_SKELETON_GET_TRANSFORMCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x183C1590)
#define SPINE_SKELETON_GET_UPDATECACHELIST_OFFSET UNITYSDK_OFFSET(0x183C1540)
#define SPINE_SKELETON_GET_X_OFFSET UNITYSDK_OFFSET(0x183C1900)
#define SPINE_SKELETON_GET_Y_OFFSET UNITYSDK_OFFSET(0x183C1920)
#define SPINE_SKELETON_SETATTACHMENT_OFFSET UNITYSDK_OFFSET(0x183C5CB0)
#define SPINE_SKELETON_SETBONESTOSETUPPOSE_OFFSET UNITYSDK_OFFSET(0x183C4E80)
#define SPINE_SKELETON_SETSKIN_1_OFFSET UNITYSDK_OFFSET(0x183C15C0)
#define SPINE_SKELETON_SETSKIN_OFFSET UNITYSDK_OFFSET(0x183C5590)
#define SPINE_SKELETON_SETSLOTSTOSETUPPOSE_OFFSET UNITYSDK_OFFSET(0x183C5150)
#define SPINE_SKELETON_SETTOSETUPPOSE_OFFSET UNITYSDK_OFFSET(0x183C4E60)
#define SPINE_SKELETON_SET_A_OFFSET UNITYSDK_OFFSET(0x183C18F0)
#define SPINE_SKELETON_SET_B_OFFSET UNITYSDK_OFFSET(0x183C18D0)
#define SPINE_SKELETON_SET_FLIPX_OFFSET UNITYSDK_OFFSET(0x183C1980)
#define SPINE_SKELETON_SET_FLIPY_OFFSET UNITYSDK_OFFSET(0x183C19D0)
#define SPINE_SKELETON_SET_G_OFFSET UNITYSDK_OFFSET(0x183C18B0)
#define SPINE_SKELETON_SET_R_OFFSET UNITYSDK_OFFSET(0x183C1890)
#define SPINE_SKELETON_SET_SCALEX_OFFSET UNITYSDK_OFFSET(0x183C1950)
#define SPINE_SKELETON_SET_SCALEY_OFFSET UNITYSDK_OFFSET(0x183C1960)
#define SPINE_SKELETON_SET_SKIN_OFFSET UNITYSDK_OFFSET(0x183C15B0)
#define SPINE_SKELETON_SET_X_OFFSET UNITYSDK_OFFSET(0x183C1910)
#define SPINE_SKELETON_SET_Y_OFFSET UNITYSDK_OFFSET(0x183C1930)
#define SPINE_SKELETON_SORTBONE_OFFSET UNITYSDK_OFFSET(0x183C41A0)
#define SPINE_SKELETON_SORTIKCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x183C39C0)
#define SPINE_SKELETON_SORTPATHCONSTRAINTATTACHMENT_1_OFFSET UNITYSDK_OFFSET(0x183C4640)
#define SPINE_SKELETON_SORTPATHCONSTRAINTATTACHMENT_OFFSET UNITYSDK_OFFSET(0x183C4290)
#define SPINE_SKELETON_SORTPATHCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x183C3EC0)
#define SPINE_SKELETON_SORTRESET_OFFSET UNITYSDK_OFFSET(0x183C4200)
#define SPINE_SKELETON_SORTTRANSFORMCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x183C3C00)
#define SPINE_SKELETON_UPDATECACHE_OFFSET UNITYSDK_OFFSET(0x183C2620)
#define SPINE_SKELETON_UPDATEWORLDTRANSFORM_1_OFFSET UNITYSDK_OFFSET(0x183C4A40)
#define SPINE_SKELETON_UPDATEWORLDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x183C4850)
#define SPINE_SKELETON__CTOR_1_OFFSET UNITYSDK_OFFSET(0x183C2A40)
#define SPINE_SKELETON__CTOR_OFFSET UNITYSDK_OFFSET(0x183C1A60)
