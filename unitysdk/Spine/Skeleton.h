...
#define SPINE_SKELETON_FINDBONE_OFFSET UNITYSDK_OFFSET(0x17BAC230)
#define SPINE_SKELETON_FINDIKCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x17BACE10)
#define SPINE_SKELETON_FINDPATHCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x17BAD050)
#define SPINE_SKELETON_FINDSLOT_OFFSET UNITYSDK_OFFSET(0x17BAC350)
#define SPINE_SKELETON_FINDTRANSFORMCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x17BACF30)
#define SPINE_SKELETON_GETATTACHMENT_1_OFFSET UNITYSDK_OFFSET(0x17B8D500)
#define SPINE_SKELETON_GETATTACHMENT_OFFSET UNITYSDK_OFFSET(0x17BACA40)
#define SPINE_SKELETON_GETBOUNDS_OFFSET UNITYSDK_OFFSET(0x17BAD170)
#define SPINE_SKELETON_GET_A_OFFSET UNITYSDK_OFFSET(0x17BA8740)
#define SPINE_SKELETON_GET_BONES_OFFSET UNITYSDK_OFFSET(0x17BA8390)
#define SPINE_SKELETON_GET_B_OFFSET UNITYSDK_OFFSET(0x17BA8720)
#define SPINE_SKELETON_GET_DATA_OFFSET UNITYSDK_OFFSET(0x17BA8380)
#define SPINE_SKELETON_GET_DRAWORDER_OFFSET UNITYSDK_OFFSET(0x17BA83C0)
#define SPINE_SKELETON_GET_FLIPX_OFFSET UNITYSDK_OFFSET(0x17BA87D0)
#define SPINE_SKELETON_GET_FLIPY_OFFSET UNITYSDK_OFFSET(0x17BA8820)
#define SPINE_SKELETON_GET_G_OFFSET UNITYSDK_OFFSET(0x17BA8700)
#define SPINE_SKELETON_GET_IKCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x17BA83D0)
#define SPINE_SKELETON_GET_PATHCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x17BA83E0)
#define SPINE_SKELETON_GET_ROOTBONE_OFFSET UNITYSDK_OFFSET(0x17BA8870)
#define SPINE_SKELETON_GET_R_OFFSET UNITYSDK_OFFSET(0x17BA86E0)
#define SPINE_SKELETON_GET_SCALEX_OFFSET UNITYSDK_OFFSET(0x17BA87A0)
#define SPINE_SKELETON_GET_SCALEY_OFFSET UNITYSDK_OFFSET(0x17B95460)
#define SPINE_SKELETON_GET_SKIN_OFFSET UNITYSDK_OFFSET(0x17BA8400)
#define SPINE_SKELETON_GET_SLOTS_OFFSET UNITYSDK_OFFSET(0x17BA83B0)
#define SPINE_SKELETON_GET_TRANSFORMCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x17BA83F0)
#define SPINE_SKELETON_GET_UPDATECACHELIST_OFFSET UNITYSDK_OFFSET(0x17BA83A0)
#define SPINE_SKELETON_GET_X_OFFSET UNITYSDK_OFFSET(0x17BA8760)
#define SPINE_SKELETON_GET_Y_OFFSET UNITYSDK_OFFSET(0x17BA8780)
#define SPINE_SKELETON_SETATTACHMENT_OFFSET UNITYSDK_OFFSET(0x17BACB90)
#define SPINE_SKELETON_SETBONESTOSETUPPOSE_OFFSET UNITYSDK_OFFSET(0x17BABD30)
#define SPINE_SKELETON_SETSKIN_1_OFFSET UNITYSDK_OFFSET(0x17BA8420)
#define SPINE_SKELETON_SETSKIN_OFFSET UNITYSDK_OFFSET(0x17BAC470)
#define SPINE_SKELETON_SETSLOTSTOSETUPPOSE_OFFSET UNITYSDK_OFFSET(0x17BAC030)
#define SPINE_SKELETON_SETTOSETUPPOSE_OFFSET UNITYSDK_OFFSET(0x17BABD10)
#define SPINE_SKELETON_SET_A_OFFSET UNITYSDK_OFFSET(0x17BA8750)
#define SPINE_SKELETON_SET_B_OFFSET UNITYSDK_OFFSET(0x17BA8730)
#define SPINE_SKELETON_SET_FLIPX_OFFSET UNITYSDK_OFFSET(0x17BA87E0)
#define SPINE_SKELETON_SET_FLIPY_OFFSET UNITYSDK_OFFSET(0x17BA8830)
#define SPINE_SKELETON_SET_G_OFFSET UNITYSDK_OFFSET(0x17BA8710)
#define SPINE_SKELETON_SET_R_OFFSET UNITYSDK_OFFSET(0x17BA86F0)
#define SPINE_SKELETON_SET_SCALEX_OFFSET UNITYSDK_OFFSET(0x17BA87B0)
#define SPINE_SKELETON_SET_SCALEY_OFFSET UNITYSDK_OFFSET(0x17BA87C0)
#define SPINE_SKELETON_SET_SKIN_OFFSET UNITYSDK_OFFSET(0x17BA8410)
#define SPINE_SKELETON_SET_X_OFFSET UNITYSDK_OFFSET(0x17BA8770)
#define SPINE_SKELETON_SET_Y_OFFSET UNITYSDK_OFFSET(0x17BA8790)
#define SPINE_SKELETON_SORTBONE_OFFSET UNITYSDK_OFFSET(0x17BAB040)
#define SPINE_SKELETON_SORTIKCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x17BAA860)
#define SPINE_SKELETON_SORTPATHCONSTRAINTATTACHMENT_1_OFFSET UNITYSDK_OFFSET(0x17BAB4E0)
#define SPINE_SKELETON_SORTPATHCONSTRAINTATTACHMENT_OFFSET UNITYSDK_OFFSET(0x17BAB130)
#define SPINE_SKELETON_SORTPATHCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x17BAAD60)
#define SPINE_SKELETON_SORTRESET_OFFSET UNITYSDK_OFFSET(0x17BAB0A0)
#define SPINE_SKELETON_SORTTRANSFORMCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x17BAAAA0)
#define SPINE_SKELETON_UPDATECACHE_OFFSET UNITYSDK_OFFSET(0x17BA9480)
#define SPINE_SKELETON_UPDATEWORLDTRANSFORM_1_OFFSET UNITYSDK_OFFSET(0x17BAB8E0)
#define SPINE_SKELETON_UPDATEWORLDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x17BAB6F0)
#define SPINE_SKELETON__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17BA98A0)
#define SPINE_SKELETON__CTOR_OFFSET UNITYSDK_OFFSET(0x17BA88C0)

namespace Spine
{
	inline static constexpr unsigned int Skeleton_TypeDefinitionIndex = 29852;
