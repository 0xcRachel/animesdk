...
#define SPINE_POWOUT_APPLY_OFFSET UNITYSDK_OFFSET(0x17BA1C00)
#define SPINE_POWOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x17B99490)

namespace Spine
{
	inline static constexpr unsigned int PowOut_TypeDefinitionIndex = 29846;
