...
#define SPINE_BONEMATRIX_CALCULATESETUPWORLD_OFFSET UNITYSDK_OFFSET(0x17BEB300)
#define SPINE_BONEMATRIX_GETINHERITEDINTERNAL_OFFSET UNITYSDK_OFFSET(0x17BEB3B0)
#define SPINE_BONEMATRIX_TRANSFORMMATRIX_OFFSET UNITYSDK_OFFSET(0x202C3C0)
#define SPINE_BONEMATRIX__CTOR_1_OFFSET UNITYSDK_OFFSET(0x202C2B0)
#define SPINE_BONEMATRIX__CTOR_OFFSET UNITYSDK_OFFSET(0x202C1A0)

namespace Spine
{
	inline static constexpr unsigned int BoneMatrix_TypeDefinitionIndex = 33741;
