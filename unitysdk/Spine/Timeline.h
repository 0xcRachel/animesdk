...
#define SPINE_TIMELINE_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x183F7DE0)
#define SPINE_TIMELINE_GET_FRAMECOUNT_OFFSET UNITYSDK_OFFSET(0x183F7DB0)
#define SPINE_TIMELINE_GET_FRAMEENTRIES_OFFSET UNITYSDK_OFFSET(0x183F7DA0)
#define SPINE_TIMELINE_GET_FRAMES_OFFSET UNITYSDK_OFFSET(0x183F7D90)
#define SPINE_TIMELINE_GET_PROPERTYIDS_OFFSET UNITYSDK_OFFSET(0x183F7D80)
#define SPINE_TIMELINE_SEARCH_1_OFFSET UNITYSDK_OFFSET(0x183F7E80)
#define SPINE_TIMELINE_SEARCH_OFFSET UNITYSDK_OFFSET(0x183F7E30)
#define SPINE_TIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x183F7D00)
