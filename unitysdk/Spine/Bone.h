...
#define SPINE_BONE_GET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x12B823A0)
#define SPINE_BONE_GET_APPLIEDROTATION_OFFSET UNITYSDK_OFFSET(0x12B82490)
#define SPINE_BONE_GET_ASCALEX_OFFSET UNITYSDK_OFFSET(0x12B824F0)
#define SPINE_BONE_GET_ASCALEY_OFFSET UNITYSDK_OFFSET(0x12B82510)
#define SPINE_BONE_GET_ASHEARX_OFFSET UNITYSDK_OFFSET(0x12B82530)
#define SPINE_BONE_GET_ASHEARY_OFFSET UNITYSDK_OFFSET(0x12B82550)
#define SPINE_BONE_GET_AX_OFFSET UNITYSDK_OFFSET(0x12B824B0)
#define SPINE_BONE_GET_AY_OFFSET UNITYSDK_OFFSET(0x12B824D0)
#define SPINE_BONE_GET_A_OFFSET UNITYSDK_OFFSET(0x12B82570)
#define SPINE_BONE_GET_B_OFFSET UNITYSDK_OFFSET(0x12B82590)
#define SPINE_BONE_GET_CHILDREN_OFFSET UNITYSDK_OFFSET(0x12B82390)
#define SPINE_BONE_GET_C_OFFSET UNITYSDK_OFFSET(0x12B825B0)
#define SPINE_BONE_GET_DATA_OFFSET UNITYSDK_OFFSET(0x12B82360)
#define SPINE_BONE_GET_D_OFFSET UNITYSDK_OFFSET(0x12B825D0)
#define SPINE_BONE_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x12B82380)
#define SPINE_BONE_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x12B823F0)
#define SPINE_BONE_GET_SCALEX_OFFSET UNITYSDK_OFFSET(0x12B82410)
#define SPINE_BONE_GET_SCALEY_OFFSET UNITYSDK_OFFSET(0x12B82430)
#define SPINE_BONE_GET_SHEARX_OFFSET UNITYSDK_OFFSET(0x12B82450)
#define SPINE_BONE_GET_SHEARY_OFFSET UNITYSDK_OFFSET(0x12B82470)
#define SPINE_BONE_GET_SKELETON_OFFSET UNITYSDK_OFFSET(0x12B82370)
#define SPINE_BONE_GET_WORLDROTATIONX_OFFSET UNITYSDK_OFFSET(0x12B82630)
#define SPINE_BONE_GET_WORLDROTATIONY_OFFSET UNITYSDK_OFFSET(0x12B826B0)
#define SPINE_BONE_GET_WORLDSCALEX_OFFSET UNITYSDK_OFFSET(0x12B82710)
#define SPINE_BONE_GET_WORLDSCALEY_OFFSET UNITYSDK_OFFSET(0x12B82740)
#define SPINE_BONE_GET_WORLDTOLOCALROTATIONX_OFFSET UNITYSDK_OFFSET(0x12B83A80)
#define SPINE_BONE_GET_WORLDTOLOCALROTATIONY_OFFSET UNITYSDK_OFFSET(0x12B83B60)
#define SPINE_BONE_GET_WORLDX_OFFSET UNITYSDK_OFFSET(0x12B825F0)
#define SPINE_BONE_GET_WORLDY_OFFSET UNITYSDK_OFFSET(0x12B82610)
#define SPINE_BONE_GET_X_OFFSET UNITYSDK_OFFSET(0x12B823B0)
#define SPINE_BONE_GET_Y_OFFSET UNITYSDK_OFFSET(0x12B823D0)
#define SPINE_BONE_LOCALTOWORLDROTATION_OFFSET UNITYSDK_OFFSET(0x12B83D00)
#define SPINE_BONE_LOCALTOWORLD_OFFSET UNITYSDK_OFFSET(0x12B83A40)
#define SPINE_BONE_ROTATEWORLD_OFFSET UNITYSDK_OFFSET(0x12B83DD0)
#define SPINE_BONE_SETTOSETUPPOSE_OFFSET UNITYSDK_OFFSET(0x12B82880)
#define SPINE_BONE_SET_APPLIEDROTATION_OFFSET UNITYSDK_OFFSET(0x12B824A0)
#define SPINE_BONE_SET_ASCALEX_OFFSET UNITYSDK_OFFSET(0x12B82500)
#define SPINE_BONE_SET_ASCALEY_OFFSET UNITYSDK_OFFSET(0x12B82520)
#define SPINE_BONE_SET_ASHEARX_OFFSET UNITYSDK_OFFSET(0x12B82540)
#define SPINE_BONE_SET_ASHEARY_OFFSET UNITYSDK_OFFSET(0x12B82560)
#define SPINE_BONE_SET_AX_OFFSET UNITYSDK_OFFSET(0x12B824C0)
#define SPINE_BONE_SET_AY_OFFSET UNITYSDK_OFFSET(0x12B824E0)
#define SPINE_BONE_SET_A_OFFSET UNITYSDK_OFFSET(0x12B82580)
#define SPINE_BONE_SET_B_OFFSET UNITYSDK_OFFSET(0x12B825A0)
#define SPINE_BONE_SET_C_OFFSET UNITYSDK_OFFSET(0x12B825C0)
#define SPINE_BONE_SET_D_OFFSET UNITYSDK_OFFSET(0x12B825E0)
#define SPINE_BONE_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x12B82400)
#define SPINE_BONE_SET_SCALEX_OFFSET UNITYSDK_OFFSET(0x12B82420)
#define SPINE_BONE_SET_SCALEY_OFFSET UNITYSDK_OFFSET(0x12B82440)
#define SPINE_BONE_SET_SHEARX_OFFSET UNITYSDK_OFFSET(0x12B82460)
#define SPINE_BONE_SET_SHEARY_OFFSET UNITYSDK_OFFSET(0x12B82480)
#define SPINE_BONE_SET_WORLDX_OFFSET UNITYSDK_OFFSET(0x12B82600)
#define SPINE_BONE_SET_WORLDY_OFFSET UNITYSDK_OFFSET(0x12B82620)
#define SPINE_BONE_SET_X_OFFSET UNITYSDK_OFFSET(0x12B823C0)
#define SPINE_BONE_SET_Y_OFFSET UNITYSDK_OFFSET(0x12B823E0)
#define SPINE_BONE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x12B83EF0)
#define SPINE_BONE_UPDATEAPPLIEDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x12B835D0)
#define SPINE_BONE_UPDATEWORLDTRANSFORM_1_OFFSET UNITYSDK_OFFSET(0x12B82A80)
#define SPINE_BONE_UPDATEWORLDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x12B834D0)
#define SPINE_BONE_UPDATE_OFFSET UNITYSDK_OFFSET(0x12B82A20)
#define SPINE_BONE_WORLDTOLOCALROTATION_OFFSET UNITYSDK_OFFSET(0x12B83C40)
#define SPINE_BONE_WORLDTOLOCAL_OFFSET UNITYSDK_OFFSET(0x12B839D0)
#define SPINE_BONE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x12B828E0)
#define SPINE_BONE__CTOR_OFFSET UNITYSDK_OFFSET(0x12B82770)
...
namespace Spine
{
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Bone_TypeDefinitionIndex)->GetStaticField(0x1100);
		}
