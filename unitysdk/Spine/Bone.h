...
#define SPINE_BONE_GET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x156B7700)
#define SPINE_BONE_GET_APPLIEDROTATION_OFFSET UNITYSDK_OFFSET(0x156B77F0)
#define SPINE_BONE_GET_ASCALEX_OFFSET UNITYSDK_OFFSET(0x156B7850)
#define SPINE_BONE_GET_ASCALEY_OFFSET UNITYSDK_OFFSET(0x156B7870)
#define SPINE_BONE_GET_ASHEARX_OFFSET UNITYSDK_OFFSET(0x156B7890)
#define SPINE_BONE_GET_ASHEARY_OFFSET UNITYSDK_OFFSET(0x156B78B0)
#define SPINE_BONE_GET_AX_OFFSET UNITYSDK_OFFSET(0x156B7810)
#define SPINE_BONE_GET_AY_OFFSET UNITYSDK_OFFSET(0x156B7830)
#define SPINE_BONE_GET_A_OFFSET UNITYSDK_OFFSET(0x156B78D0)
#define SPINE_BONE_GET_B_OFFSET UNITYSDK_OFFSET(0x156B78F0)
#define SPINE_BONE_GET_CHILDREN_OFFSET UNITYSDK_OFFSET(0x156B76F0)
#define SPINE_BONE_GET_C_OFFSET UNITYSDK_OFFSET(0x156B7910)
#define SPINE_BONE_GET_DATA_OFFSET UNITYSDK_OFFSET(0x156B76C0)
#define SPINE_BONE_GET_D_OFFSET UNITYSDK_OFFSET(0x156B7930)
#define SPINE_BONE_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x156B76E0)
#define SPINE_BONE_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x156B7750)
#define SPINE_BONE_GET_SCALEX_OFFSET UNITYSDK_OFFSET(0x156B7770)
#define SPINE_BONE_GET_SCALEY_OFFSET UNITYSDK_OFFSET(0x156B7790)
#define SPINE_BONE_GET_SHEARX_OFFSET UNITYSDK_OFFSET(0x156B77B0)
#define SPINE_BONE_GET_SHEARY_OFFSET UNITYSDK_OFFSET(0x156B77D0)
#define SPINE_BONE_GET_SKELETON_OFFSET UNITYSDK_OFFSET(0x156B76D0)
#define SPINE_BONE_GET_WORLDROTATIONX_OFFSET UNITYSDK_OFFSET(0x156B7990)
#define SPINE_BONE_GET_WORLDROTATIONY_OFFSET UNITYSDK_OFFSET(0x156B7A10)
#define SPINE_BONE_GET_WORLDSCALEX_OFFSET UNITYSDK_OFFSET(0x156B7A70)
#define SPINE_BONE_GET_WORLDSCALEY_OFFSET UNITYSDK_OFFSET(0x156B7AA0)
#define SPINE_BONE_GET_WORLDTOLOCALROTATIONX_OFFSET UNITYSDK_OFFSET(0x156B8DD0)
#define SPINE_BONE_GET_WORLDTOLOCALROTATIONY_OFFSET UNITYSDK_OFFSET(0x156B8EB0)
#define SPINE_BONE_GET_WORLDX_OFFSET UNITYSDK_OFFSET(0x156B7950)
#define SPINE_BONE_GET_WORLDY_OFFSET UNITYSDK_OFFSET(0x156B7970)
#define SPINE_BONE_GET_X_OFFSET UNITYSDK_OFFSET(0x156B7710)
#define SPINE_BONE_GET_Y_OFFSET UNITYSDK_OFFSET(0x156B7730)
#define SPINE_BONE_LOCALTOWORLDROTATION_OFFSET UNITYSDK_OFFSET(0x156B9050)
#define SPINE_BONE_LOCALTOWORLD_OFFSET UNITYSDK_OFFSET(0x156B8D90)
#define SPINE_BONE_ROTATEWORLD_OFFSET UNITYSDK_OFFSET(0x156B9120)
#define SPINE_BONE_SETTOSETUPPOSE_OFFSET UNITYSDK_OFFSET(0x156B7BE0)
#define SPINE_BONE_SET_APPLIEDROTATION_OFFSET UNITYSDK_OFFSET(0x156B7800)
#define SPINE_BONE_SET_ASCALEX_OFFSET UNITYSDK_OFFSET(0x156B7860)
#define SPINE_BONE_SET_ASCALEY_OFFSET UNITYSDK_OFFSET(0x156B7880)
#define SPINE_BONE_SET_ASHEARX_OFFSET UNITYSDK_OFFSET(0x156B78A0)
#define SPINE_BONE_SET_ASHEARY_OFFSET UNITYSDK_OFFSET(0x156B78C0)
#define SPINE_BONE_SET_AX_OFFSET UNITYSDK_OFFSET(0x156B7820)
#define SPINE_BONE_SET_AY_OFFSET UNITYSDK_OFFSET(0x156B7840)
#define SPINE_BONE_SET_A_OFFSET UNITYSDK_OFFSET(0x156B78E0)
#define SPINE_BONE_SET_B_OFFSET UNITYSDK_OFFSET(0x156B7900)
#define SPINE_BONE_SET_C_OFFSET UNITYSDK_OFFSET(0x156B7920)
#define SPINE_BONE_SET_D_OFFSET UNITYSDK_OFFSET(0x156B7940)
#define SPINE_BONE_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x156B7760)
#define SPINE_BONE_SET_SCALEX_OFFSET UNITYSDK_OFFSET(0x156B7780)
#define SPINE_BONE_SET_SCALEY_OFFSET UNITYSDK_OFFSET(0x156B77A0)
#define SPINE_BONE_SET_SHEARX_OFFSET UNITYSDK_OFFSET(0x156B77C0)
#define SPINE_BONE_SET_SHEARY_OFFSET UNITYSDK_OFFSET(0x156B77E0)
#define SPINE_BONE_SET_WORLDX_OFFSET UNITYSDK_OFFSET(0x156B7960)
#define SPINE_BONE_SET_WORLDY_OFFSET UNITYSDK_OFFSET(0x156B7980)
#define SPINE_BONE_SET_X_OFFSET UNITYSDK_OFFSET(0x156B7720)
#define SPINE_BONE_SET_Y_OFFSET UNITYSDK_OFFSET(0x156B7740)
#define SPINE_BONE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x156B9240)
#define SPINE_BONE_UPDATEAPPLIEDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x156B8920)
#define SPINE_BONE_UPDATEWORLDTRANSFORM_1_OFFSET UNITYSDK_OFFSET(0x156B7DD0)
#define SPINE_BONE_UPDATEWORLDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x156B8820)
#define SPINE_BONE_UPDATE_OFFSET UNITYSDK_OFFSET(0x156B7D70)
#define SPINE_BONE_WORLDTOLOCALROTATION_OFFSET UNITYSDK_OFFSET(0x156B8F90)
#define SPINE_BONE_WORLDTOLOCAL_OFFSET UNITYSDK_OFFSET(0x156B8D20)
#define SPINE_BONE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x156B7C40)
#define SPINE_BONE__CTOR_OFFSET UNITYSDK_OFFSET(0x156B7AD0)
...
namespace Spine
{
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Bone_TypeDefinitionIndex)->GetStaticField(0x1E60);
		}
