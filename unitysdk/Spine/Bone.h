...
#define SPINE_BONE_GET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x183AD560)
#define SPINE_BONE_GET_APPLIEDROTATION_OFFSET UNITYSDK_OFFSET(0x183AD650)
#define SPINE_BONE_GET_ASCALEX_OFFSET UNITYSDK_OFFSET(0x183AD6B0)
#define SPINE_BONE_GET_ASCALEY_OFFSET UNITYSDK_OFFSET(0x183AD6D0)
#define SPINE_BONE_GET_ASHEARX_OFFSET UNITYSDK_OFFSET(0x183AD6F0)
#define SPINE_BONE_GET_ASHEARY_OFFSET UNITYSDK_OFFSET(0x183AD710)
#define SPINE_BONE_GET_AX_OFFSET UNITYSDK_OFFSET(0x183AD670)
#define SPINE_BONE_GET_AY_OFFSET UNITYSDK_OFFSET(0x183AD690)
#define SPINE_BONE_GET_A_OFFSET UNITYSDK_OFFSET(0x183AD730)
#define SPINE_BONE_GET_B_OFFSET UNITYSDK_OFFSET(0x183AD750)
#define SPINE_BONE_GET_CHILDREN_OFFSET UNITYSDK_OFFSET(0x183AD550)
#define SPINE_BONE_GET_C_OFFSET UNITYSDK_OFFSET(0x183AD770)
#define SPINE_BONE_GET_DATA_OFFSET UNITYSDK_OFFSET(0x183AD520)
#define SPINE_BONE_GET_D_OFFSET UNITYSDK_OFFSET(0x183AD790)
#define SPINE_BONE_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x183AD540)
#define SPINE_BONE_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x183AD5B0)
#define SPINE_BONE_GET_SCALEX_OFFSET UNITYSDK_OFFSET(0x183AD5D0)
#define SPINE_BONE_GET_SCALEY_OFFSET UNITYSDK_OFFSET(0x183AD5F0)
#define SPINE_BONE_GET_SHEARX_OFFSET UNITYSDK_OFFSET(0x183AD610)
#define SPINE_BONE_GET_SHEARY_OFFSET UNITYSDK_OFFSET(0x183AD630)
#define SPINE_BONE_GET_SKELETON_OFFSET UNITYSDK_OFFSET(0x183AD530)
#define SPINE_BONE_GET_WORLDROTATIONX_OFFSET UNITYSDK_OFFSET(0x183AD7F0)
#define SPINE_BONE_GET_WORLDROTATIONY_OFFSET UNITYSDK_OFFSET(0x183AD870)
#define SPINE_BONE_GET_WORLDSCALEX_OFFSET UNITYSDK_OFFSET(0x183AD8D0)
#define SPINE_BONE_GET_WORLDSCALEY_OFFSET UNITYSDK_OFFSET(0x183AD900)
#define SPINE_BONE_GET_WORLDTOLOCALROTATIONX_OFFSET UNITYSDK_OFFSET(0x183AEBF0)
#define SPINE_BONE_GET_WORLDTOLOCALROTATIONY_OFFSET UNITYSDK_OFFSET(0x183AECB0)
#define SPINE_BONE_GET_WORLDX_OFFSET UNITYSDK_OFFSET(0x183AD7B0)
#define SPINE_BONE_GET_WORLDY_OFFSET UNITYSDK_OFFSET(0x183AD7D0)
#define SPINE_BONE_GET_X_OFFSET UNITYSDK_OFFSET(0x183AD570)
#define SPINE_BONE_GET_Y_OFFSET UNITYSDK_OFFSET(0x183AD590)
#define SPINE_BONE_LOCALTOWORLDROTATION_OFFSET UNITYSDK_OFFSET(0x183AEE20)
#define SPINE_BONE_LOCALTOWORLD_OFFSET UNITYSDK_OFFSET(0x183AEBB0)
#define SPINE_BONE_ROTATEWORLD_OFFSET UNITYSDK_OFFSET(0x183AEEF0)
#define SPINE_BONE_SETTOSETUPPOSE_OFFSET UNITYSDK_OFFSET(0x183ADA40)
#define SPINE_BONE_SET_APPLIEDROTATION_OFFSET UNITYSDK_OFFSET(0x183AD660)
#define SPINE_BONE_SET_ASCALEX_OFFSET UNITYSDK_OFFSET(0x183AD6C0)
#define SPINE_BONE_SET_ASCALEY_OFFSET UNITYSDK_OFFSET(0x183AD6E0)
#define SPINE_BONE_SET_ASHEARX_OFFSET UNITYSDK_OFFSET(0x183AD700)
#define SPINE_BONE_SET_ASHEARY_OFFSET UNITYSDK_OFFSET(0x183AD720)
#define SPINE_BONE_SET_AX_OFFSET UNITYSDK_OFFSET(0x183AD680)
#define SPINE_BONE_SET_AY_OFFSET UNITYSDK_OFFSET(0x183AD6A0)
#define SPINE_BONE_SET_A_OFFSET UNITYSDK_OFFSET(0x183AD740)
#define SPINE_BONE_SET_B_OFFSET UNITYSDK_OFFSET(0x183AD760)
#define SPINE_BONE_SET_C_OFFSET UNITYSDK_OFFSET(0x183AD780)
#define SPINE_BONE_SET_D_OFFSET UNITYSDK_OFFSET(0x183AD7A0)
#define SPINE_BONE_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x183AD5C0)
#define SPINE_BONE_SET_SCALEX_OFFSET UNITYSDK_OFFSET(0x183AD5E0)
#define SPINE_BONE_SET_SCALEY_OFFSET UNITYSDK_OFFSET(0x183AD600)
#define SPINE_BONE_SET_SHEARX_OFFSET UNITYSDK_OFFSET(0x183AD620)
#define SPINE_BONE_SET_SHEARY_OFFSET UNITYSDK_OFFSET(0x183AD640)
#define SPINE_BONE_SET_WORLDX_OFFSET UNITYSDK_OFFSET(0x183AD7C0)
#define SPINE_BONE_SET_WORLDY_OFFSET UNITYSDK_OFFSET(0x183AD7E0)
#define SPINE_BONE_SET_X_OFFSET UNITYSDK_OFFSET(0x183AD580)
#define SPINE_BONE_SET_Y_OFFSET UNITYSDK_OFFSET(0x183AD5A0)
#define SPINE_BONE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x183AEFE0)
#define SPINE_BONE_UPDATEAPPLIEDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x183AE740)
#define SPINE_BONE_UPDATEWORLDTRANSFORM_1_OFFSET UNITYSDK_OFFSET(0x183ADC20)
#define SPINE_BONE_UPDATEWORLDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x183AE640)
#define SPINE_BONE_UPDATE_OFFSET UNITYSDK_OFFSET(0x183ADBC0)
#define SPINE_BONE_WORLDTOLOCALROTATION_OFFSET UNITYSDK_OFFSET(0x183AED70)
#define SPINE_BONE_WORLDTOLOCAL_OFFSET UNITYSDK_OFFSET(0x183AEB40)
#define SPINE_BONE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x183ADAA0)
#define SPINE_BONE__CTOR_OFFSET UNITYSDK_OFFSET(0x183AD930)
...
namespace Spine
{
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Bone_TypeDefinitionIndex)->GetStaticField(0x119A0);
		}
