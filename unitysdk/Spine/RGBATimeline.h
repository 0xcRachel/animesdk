...
#define SPINE_RGBATIMELINE_APPLY_OFFSET UNITYSDK_OFFSET(0x183BD040)
#define SPINE_RGBATIMELINE_GET_FRAMEENTRIES_OFFSET UNITYSDK_OFFSET(0x183BCF50)
#define SPINE_RGBATIMELINE_GET_SLOTINDEX_OFFSET UNITYSDK_OFFSET(0x183BCF60)
#define SPINE_RGBATIMELINE_SETFRAME_OFFSET UNITYSDK_OFFSET(0x183BCF70)
#define SPINE_RGBATIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x183BCDE0)
