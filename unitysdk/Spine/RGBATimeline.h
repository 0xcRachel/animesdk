...
#define SPINE_RGBATIMELINE_APPLY_OFFSET UNITYSDK_OFFSET(0x17BA3E20)
#define SPINE_RGBATIMELINE_GET_FRAMEENTRIES_OFFSET UNITYSDK_OFFSET(0x17BA3D30)
#define SPINE_RGBATIMELINE_GET_SLOTINDEX_OFFSET UNITYSDK_OFFSET(0x17BA3D40)
#define SPINE_RGBATIMELINE_SETFRAME_OFFSET UNITYSDK_OFFSET(0x17BA3D50)
#define SPINE_RGBATIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x17BA3BC0)

namespace Spine
{
	inline static constexpr unsigned int RGBATimeline_TypeDefinitionIndex = 29780;
