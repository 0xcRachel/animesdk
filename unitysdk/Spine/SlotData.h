...
#define SPINE_SLOTDATA_GET_ATTACHMENTNAME_OFFSET UNITYSDK_OFFSET(0x12BCAB50)
#define SPINE_SLOTDATA_GET_A_OFFSET UNITYSDK_OFFSET(0x12BCAAB0)
#define SPINE_SLOTDATA_GET_B2_OFFSET UNITYSDK_OFFSET(0x12BCAB10)
#define SPINE_SLOTDATA_GET_BLENDMODE_OFFSET UNITYSDK_OFFSET(0x12BCAB70)
#define SPINE_SLOTDATA_GET_BONEDATA_OFFSET UNITYSDK_OFFSET(0x12BCAA40)
#define SPINE_SLOTDATA_GET_B_OFFSET UNITYSDK_OFFSET(0x12BCAA90)
#define SPINE_SLOTDATA_GET_G2_OFFSET UNITYSDK_OFFSET(0x12BCAAF0)
#define SPINE_SLOTDATA_GET_G_OFFSET UNITYSDK_OFFSET(0x12BCAA70)
#define SPINE_SLOTDATA_GET_HASSECONDCOLOR_OFFSET UNITYSDK_OFFSET(0x12BCAB30)
#define SPINE_SLOTDATA_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x12BCAA20)
#define SPINE_SLOTDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x12BCAA30)
#define SPINE_SLOTDATA_GET_R2_OFFSET UNITYSDK_OFFSET(0x12BCAAD0)
#define SPINE_SLOTDATA_GET_R_OFFSET UNITYSDK_OFFSET(0x12BCAA50)
#define SPINE_SLOTDATA_SET_ATTACHMENTNAME_OFFSET UNITYSDK_OFFSET(0x12BCAB60)
#define SPINE_SLOTDATA_SET_A_OFFSET UNITYSDK_OFFSET(0x12BCAAC0)
#define SPINE_SLOTDATA_SET_B2_OFFSET UNITYSDK_OFFSET(0x12BCAB20)
#define SPINE_SLOTDATA_SET_BLENDMODE_OFFSET UNITYSDK_OFFSET(0x12BCAB80)
#define SPINE_SLOTDATA_SET_B_OFFSET UNITYSDK_OFFSET(0x12BCAAA0)
#define SPINE_SLOTDATA_SET_G2_OFFSET UNITYSDK_OFFSET(0x12BCAB00)
#define SPINE_SLOTDATA_SET_G_OFFSET UNITYSDK_OFFSET(0x12BCAA80)
#define SPINE_SLOTDATA_SET_HASSECONDCOLOR_OFFSET UNITYSDK_OFFSET(0x12BCAB40)
#define SPINE_SLOTDATA_SET_R2_OFFSET UNITYSDK_OFFSET(0x12BCAAE0)
#define SPINE_SLOTDATA_SET_R_OFFSET UNITYSDK_OFFSET(0x12BCAA60)
#define SPINE_SLOTDATA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x12BCAB90)
#define SPINE_SLOTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x12B9C720)
