...
#define SPINE_RGBA2TIMELINE_APPLY_OFFSET UNITYSDK_OFFSET(0x17BA2EE0)
#define SPINE_RGBA2TIMELINE_GET_FRAMEENTRIES_OFFSET UNITYSDK_OFFSET(0x17BA2D50)
#define SPINE_RGBA2TIMELINE_GET_SLOTINDEX_OFFSET UNITYSDK_OFFSET(0x17BA2D60)
#define SPINE_RGBA2TIMELINE_SETFRAME_OFFSET UNITYSDK_OFFSET(0x17BA2D70)
#define SPINE_RGBA2TIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x17BA2B90)

namespace Spine
{
	inline static constexpr unsigned int RGBA2Timeline_TypeDefinitionIndex = 29783;
