...
#define SPINE_BONEDATA_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x183AF000)
#define SPINE_BONEDATA_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x183AF030)
#define SPINE_BONEDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x183AF010)
#define SPINE_BONEDATA_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x183AF020)
#define SPINE_BONEDATA_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x183AF090)
#define SPINE_BONEDATA_GET_SCALEX_OFFSET UNITYSDK_OFFSET(0x183AF0B0)
#define SPINE_BONEDATA_GET_SCALEY_OFFSET UNITYSDK_OFFSET(0x183AF0D0)
#define SPINE_BONEDATA_GET_SHEARX_OFFSET UNITYSDK_OFFSET(0x183AF0F0)
#define SPINE_BONEDATA_GET_SHEARY_OFFSET UNITYSDK_OFFSET(0x183AF110)
#define SPINE_BONEDATA_GET_SKINREQUIRED_OFFSET UNITYSDK_OFFSET(0x183AF150)
#define SPINE_BONEDATA_GET_TRANSFORMMODE_OFFSET UNITYSDK_OFFSET(0x183AF130)
#define SPINE_BONEDATA_GET_X_OFFSET UNITYSDK_OFFSET(0x183AF050)
#define SPINE_BONEDATA_GET_Y_OFFSET UNITYSDK_OFFSET(0x183AF070)
#define SPINE_BONEDATA_SET_LENGTH_OFFSET UNITYSDK_OFFSET(0x183AF040)
#define SPINE_BONEDATA_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x183AF0A0)
#define SPINE_BONEDATA_SET_SCALEX_OFFSET UNITYSDK_OFFSET(0x183AF0C0)
#define SPINE_BONEDATA_SET_SCALEY_OFFSET UNITYSDK_OFFSET(0x183AF0E0)
#define SPINE_BONEDATA_SET_SHEARX_OFFSET UNITYSDK_OFFSET(0x183AF100)
#define SPINE_BONEDATA_SET_SHEARY_OFFSET UNITYSDK_OFFSET(0x183AF120)
#define SPINE_BONEDATA_SET_SKINREQUIRED_OFFSET UNITYSDK_OFFSET(0x183AF160)
#define SPINE_BONEDATA_SET_TRANSFORMMODE_OFFSET UNITYSDK_OFFSET(0x183AF140)
#define SPINE_BONEDATA_SET_X_OFFSET UNITYSDK_OFFSET(0x183AF060)
#define SPINE_BONEDATA_SET_Y_OFFSET UNITYSDK_OFFSET(0x183AF080)
#define SPINE_BONEDATA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x183AF210)
#define SPINE_BONEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x183AF170)
