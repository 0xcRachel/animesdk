...
#define SPINE_MATHUTILS_ATAN2_OFFSET UNITYSDK_OFFSET(0x183AD850)
#define SPINE_MATHUTILS_CLAMP_OFFSET UNITYSDK_OFFSET(0x183B4A50)
#define SPINE_MATHUTILS_COSDEG_OFFSET UNITYSDK_OFFSET(0x183AE6C0)
#define SPINE_MATHUTILS_COS_OFFSET UNITYSDK_OFFSET(0x183AE700)
#define SPINE_MATHUTILS_RANDOMTRIANGLE_1_OFFSET UNITYSDK_OFFSET(0x183B4B90)
#define SPINE_MATHUTILS_RANDOMTRIANGLE_OFFSET UNITYSDK_OFFSET(0x183B4A70)
#define SPINE_MATHUTILS_SINDEG_OFFSET UNITYSDK_OFFSET(0x183AE6E0)
#define SPINE_MATHUTILS_SIN_OFFSET UNITYSDK_OFFSET(0x183AE720)
#define SPINE_MATHUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x183B4CA0)
...
namespace Spine
{
	...
	public:
		...
		{
			return (::System::Random**)Il2CppClass::FromTypeDefinitionIndex(MathUtils_TypeDefinitionIndex)->GetStaticField(0x43E70);
		}
