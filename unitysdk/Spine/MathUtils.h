...
#define SPINE_MATHUTILS_ATAN2_OFFSET UNITYSDK_OFFSET(0x17B945D0)
#define SPINE_MATHUTILS_CLAMP_OFFSET UNITYSDK_OFFSET(0x17B9B7F0)
#define SPINE_MATHUTILS_COSDEG_OFFSET UNITYSDK_OFFSET(0x17B95480)
#define SPINE_MATHUTILS_COS_OFFSET UNITYSDK_OFFSET(0x17B954C0)
#define SPINE_MATHUTILS_RANDOMTRIANGLE_1_OFFSET UNITYSDK_OFFSET(0x17B9B930)
#define SPINE_MATHUTILS_RANDOMTRIANGLE_OFFSET UNITYSDK_OFFSET(0x17B9B810)
#define SPINE_MATHUTILS_SINDEG_OFFSET UNITYSDK_OFFSET(0x17B954A0)
#define SPINE_MATHUTILS_SIN_OFFSET UNITYSDK_OFFSET(0x17B954E0)
#define SPINE_MATHUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x17B9BA40)

namespace Spine
{
	inline static constexpr unsigned int MathUtils_TypeDefinitionIndex = 29843;
	...
	public:
		...
		{
			return (::System::Random**)Il2CppClass::FromTypeDefinitionIndex(MathUtils_TypeDefinitionIndex)->GetStaticField(0x42250);
		}
