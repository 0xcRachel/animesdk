...
#define SPINE_ATLASREGION_CLONE_OFFSET UNITYSDK_OFFSET(0x17B93C60)
#define SPINE_ATLASREGION_GET_ORIGINALHEIGHT_OFFSET UNITYSDK_OFFSET(0x17B93C50)
#define SPINE_ATLASREGION_GET_ORIGINALWIDTH_OFFSET UNITYSDK_OFFSET(0x17B93C40)
#define SPINE_ATLASREGION_GET_PACKEDHEIGHT_OFFSET UNITYSDK_OFFSET(0x17B93C20)
#define SPINE_ATLASREGION_GET_PACKEDWIDTH_OFFSET UNITYSDK_OFFSET(0x17B93C00)
#define SPINE_ATLASREGION_SET_PACKEDHEIGHT_OFFSET UNITYSDK_OFFSET(0x17B93C30)
#define SPINE_ATLASREGION_SET_PACKEDWIDTH_OFFSET UNITYSDK_OFFSET(0x17B93C10)
#define SPINE_ATLASREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x17B91CC0)

namespace Spine
{
	inline static constexpr unsigned int AtlasRegion_TypeDefinitionIndex = 29814;
	...
	public:
		...
		::System::Int32 y; // 0x60
		::System::Int32 originalWidth; // 0x64
