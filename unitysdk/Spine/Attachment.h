...
#define SPINE_ATTACHMENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x17B93D30)
#define SPINE_ATTACHMENT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17B93DB0)
#define SPINE_ATTACHMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17B93D90)
#define SPINE_ATTACHMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x17B93D40)

namespace Spine
{
	inline static constexpr unsigned int Attachment_TypeDefinitionIndex = 29817;
