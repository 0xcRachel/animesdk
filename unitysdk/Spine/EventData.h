...
#define SPINE_EVENTDATA_GET_AUDIOPATH_OFFSET UNITYSDK_OFFSET(0x17B98C30)
#define SPINE_EVENTDATA_GET_BALANCE_OFFSET UNITYSDK_OFFSET(0x17B98C70)
#define SPINE_EVENTDATA_GET_FLOAT_OFFSET UNITYSDK_OFFSET(0x17B98BF0)
#define SPINE_EVENTDATA_GET_INT_OFFSET UNITYSDK_OFFSET(0x17B98BD0)
#define SPINE_EVENTDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x17B98BC0)
#define SPINE_EVENTDATA_GET_STRING_OFFSET UNITYSDK_OFFSET(0x17B98C10)
#define SPINE_EVENTDATA_GET_VOLUME_OFFSET UNITYSDK_OFFSET(0x17B98C50)
#define SPINE_EVENTDATA_SET_AUDIOPATH_OFFSET UNITYSDK_OFFSET(0x17B98C40)
#define SPINE_EVENTDATA_SET_BALANCE_OFFSET UNITYSDK_OFFSET(0x17B98C80)
#define SPINE_EVENTDATA_SET_FLOAT_OFFSET UNITYSDK_OFFSET(0x17B98C00)
#define SPINE_EVENTDATA_SET_INT_OFFSET UNITYSDK_OFFSET(0x17B98BE0)
#define SPINE_EVENTDATA_SET_STRING_OFFSET UNITYSDK_OFFSET(0x17B98C20)
#define SPINE_EVENTDATA_SET_VOLUME_OFFSET UNITYSDK_OFFSET(0x17B98C60)
#define SPINE_EVENTDATA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17B98D00)
#define SPINE_EVENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17B98C90)

namespace Spine
{
	inline static constexpr unsigned int EventData_TypeDefinitionIndex = 29836;
