...
#define EFFECT_FAKEBILLBOARD_ONENABLE_OFFSET UNITYSDK_OFFSET(0xDEE4310)
#define EFFECT_FAKEBILLBOARD_RESET_OFFSET UNITYSDK_OFFSET(0xDEE3F70)
#define EFFECT_FAKEBILLBOARD_START_OFFSET UNITYSDK_OFFSET(0xDEE4360)
#define EFFECT_FAKEBILLBOARD_UPDATE_OFFSET UNITYSDK_OFFSET(0xDEE43B0)
#define EFFECT_FAKEBILLBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xDEE4970)

inline static constexpr unsigned int Effect_FakeBillboard_TypeDefinitionIndex = 37352;
