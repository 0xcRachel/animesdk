...
#define CLASS_2_850C234AA2B8A0A3_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11614C60)
#define CLASS_2_850C234AA2B8A0A3_GET_DISPOSED_OFFSET UNITYSDK_OFFSET(0x1161C9B0)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_029F0C6DBB8AC745_OFFSET UNITYSDK_OFFSET(0x1161C780)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_06608D365EA50724_OFFSET UNITYSDK_OFFSET(0x1161B0A0)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_143476BE61E30980_OFFSET UNITYSDK_OFFSET(0x11614DB0)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_1792F44D8A28BBA5_OFFSET UNITYSDK_OFFSET(0x1161AD80)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_199CB10F8BF6CEF4_OFFSET UNITYSDK_OFFSET(0x11618FA0)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_20D2EE25D15C1A41_OFFSET UNITYSDK_OFFSET(0x1161AC30)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_29EF15CD94593AAE_OFFSET UNITYSDK_OFFSET(0x11617300)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_416B804F4ABC78EC_OFFSET UNITYSDK_OFFSET(0x116179C0)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_4F4AFFC911B3D4AA_OFFSET UNITYSDK_OFFSET(0x11617F80)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_5110E061C0DF5692_OFFSET UNITYSDK_OFFSET(0x11615000)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_51BE7F0CD6759F40_OFFSET UNITYSDK_OFFSET(0x11617B40)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_53BD888AED7AAE33_OFFSET UNITYSDK_OFFSET(0x116166B0)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_79335F97BF9F9923_OFFSET UNITYSDK_OFFSET(0x1161B5C0)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_7EE311423AAF2EBA_OFFSET UNITYSDK_OFFSET(0x1161C5E0)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_87B3FEE9DCD52DFC_OFFSET UNITYSDK_OFFSET(0x11618980)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_B6066EDABA9658FF_1_OFFSET UNITYSDK_OFFSET(0x11617DB0)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_B6066EDABA9658FF_OFFSET UNITYSDK_OFFSET(0x11617BE0)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_C2DEBF51B6B0C21F_OFFSET UNITYSDK_OFFSET(0x116181C0)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_C693EE9B34491FF7_OFFSET UNITYSDK_OFFSET(0x1161AF00)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_D0AE1786157F8347_OFFSET UNITYSDK_OFFSET(0x11617390)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_E61B723F9C6B7CFD_OFFSET UNITYSDK_OFFSET(0x116185D0)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_F09F3B003393B142_OFFSET UNITYSDK_OFFSET(0x11616510)
#define CLASS_2_850C234AA2B8A0A3_METHOD_2_F12E7C59B11C586B_OFFSET UNITYSDK_OFFSET(0x11619650)
#define CLASS_2_850C234AA2B8A0A3_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11615120)
#define CLASS_2_850C234AA2B8A0A3_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x11617910)
#define CLASS_2_850C234AA2B8A0A3_SET_DISPOSED_OFFSET UNITYSDK_OFFSET(0x1161C9C0)
#define CLASS_2_850C234AA2B8A0A3_TICK_OFFSET UNITYSDK_OFFSET(0x11617960)
#define CLASS_2_850C234AA2B8A0A3__CTOR_OFFSET UNITYSDK_OFFSET(0x11614B90)
...
{
public:
	::RPG::GameCore::DamageByAttackProperty* Field_2_1; // 0x18
	::Class_3_5775A4FEC79026BC* Field_2_4; // 0x20
	::System::Collections::Generic::List_1<::Class_1_C1EF032BF58D5C23*>* Field_2_5; // 0x28
