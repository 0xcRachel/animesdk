...
#define CLASS_2_1C197C0BC1350FA5_DISPOSE_OFFSET UNITYSDK_OFFSET(0xFDE6AB0)
#define CLASS_2_1C197C0BC1350FA5_METHOD_2_A5C4135A88AD533A_OFFSET UNITYSDK_OFFSET(0xFDE6CF0)
#define CLASS_2_1C197C0BC1350FA5_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xFDE6AF0)
#define CLASS_2_1C197C0BC1350FA5_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xFDE6BF0)
#define CLASS_2_1C197C0BC1350FA5_TICK_OFFSET UNITYSDK_OFFSET(0xFDE6C90)
#define CLASS_2_1C197C0BC1350FA5__CTOR_OFFSET UNITYSDK_OFFSET(0xFDE6AA0)

inline static constexpr unsigned int Class_2_1C197C0BC1350FA5_TypeDefinitionIndex = 42132;
