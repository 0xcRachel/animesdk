...
#define CLASS_2_64EBCC631FDE953D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x111EF660)
#define CLASS_2_64EBCC631FDE953D_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x111EF440)
#define CLASS_2_64EBCC631FDE953D_METHOD_2_BD83D9A311EA4A81_OFFSET UNITYSDK_OFFSET(0x111EF590)
#define CLASS_2_64EBCC631FDE953D_ONSKIP_OFFSET UNITYSDK_OFFSET(0x111EF450)
#define CLASS_2_64EBCC631FDE953D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x111EF700)
#define CLASS_2_64EBCC631FDE953D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x111EF870)
#define CLASS_2_64EBCC631FDE953D_TICK_OFFSET UNITYSDK_OFFSET(0x111EF6A0)
#define CLASS_2_64EBCC631FDE953D__CTOR_OFFSET UNITYSDK_OFFSET(0x111EF430)

inline static constexpr unsigned int Class_2_64EBCC631FDE953D_TypeDefinitionIndex = 41600;
