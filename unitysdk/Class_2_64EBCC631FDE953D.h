...
#define CLASS_2_64EBCC631FDE953D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16C23970)
#define CLASS_2_64EBCC631FDE953D_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x16C23780)
#define CLASS_2_64EBCC631FDE953D_METHOD_2_BD83D9A311EA4A81_OFFSET UNITYSDK_OFFSET(0x16C238A0)
#define CLASS_2_64EBCC631FDE953D_ONSKIP_OFFSET UNITYSDK_OFFSET(0x16C23790)
#define CLASS_2_64EBCC631FDE953D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x16C23A10)
#define CLASS_2_64EBCC631FDE953D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x16C23B50)
#define CLASS_2_64EBCC631FDE953D_TICK_OFFSET UNITYSDK_OFFSET(0x16C239B0)
#define CLASS_2_64EBCC631FDE953D__CTOR_OFFSET UNITYSDK_OFFSET(0x16C23770)
...
public:
	...
	::RPG::GameCore::ClockParkStoryTriggerAsideDialog* Field_2_1; // 0x20
