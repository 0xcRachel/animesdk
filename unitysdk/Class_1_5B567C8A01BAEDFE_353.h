...
#define CLASS_1_5B567C8A01BAEDFE_353_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1AEE9B70)
#define CLASS_1_5B567C8A01BAEDFE_353_CLONE_OFFSET UNITYSDK_OFFSET(0x1AEE99E0)
#define CLASS_1_5B567C8A01BAEDFE_353_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1AEE9A80)
#define CLASS_1_5B567C8A01BAEDFE_353_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AEE9A20)
#define CLASS_1_5B567C8A01BAEDFE_353_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AEE9AD0)
#define CLASS_1_5B567C8A01BAEDFE_353_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1AEE9BC0)
#define CLASS_1_5B567C8A01BAEDFE_353_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1AEE9B90)
#define CLASS_1_5B567C8A01BAEDFE_353_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1AEE9960)
#define CLASS_1_5B567C8A01BAEDFE_353_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1AEE9990)
#define CLASS_1_5B567C8A01BAEDFE_353_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AEE9B00)
#define CLASS_1_5B567C8A01BAEDFE_353_WRITETO_OFFSET UNITYSDK_OFFSET(0x1AEE9B60)
#define CLASS_1_5B567C8A01BAEDFE_353__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AEE9C10)
#define CLASS_1_5B567C8A01BAEDFE_353__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AEE99B0)
#define CLASS_1_5B567C8A01BAEDFE_353__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEE99A0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_353*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_353_TypeDefinitionIndex)->GetStaticField(0x37F00);
	}
