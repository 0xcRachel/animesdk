...
#define CLASS_1_5B567C8A01BAEDFE_353_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A2E1360)
#define CLASS_1_5B567C8A01BAEDFE_353_CLONE_OFFSET UNITYSDK_OFFSET(0x1A2E1170)
#define CLASS_1_5B567C8A01BAEDFE_353_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A2E1270)
#define CLASS_1_5B567C8A01BAEDFE_353_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A2E11E0)
#define CLASS_1_5B567C8A01BAEDFE_353_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A2E12C0)
#define CLASS_1_5B567C8A01BAEDFE_353_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A2E13B0)
#define CLASS_1_5B567C8A01BAEDFE_353_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A2E1380)
#define CLASS_1_5B567C8A01BAEDFE_353_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A2E10C0)
#define CLASS_1_5B567C8A01BAEDFE_353_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A2E1120)
#define CLASS_1_5B567C8A01BAEDFE_353_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A2E12F0)
#define CLASS_1_5B567C8A01BAEDFE_353_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A2E1350)
#define CLASS_1_5B567C8A01BAEDFE_353__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A2E1400)
#define CLASS_1_5B567C8A01BAEDFE_353__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A2E1140)
#define CLASS_1_5B567C8A01BAEDFE_353__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2E1130)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_353*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_353_TypeDefinitionIndex)->GetStaticField(0x3BD40);
	}
