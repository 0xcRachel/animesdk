...
#define CLASS_1_EF7A5DF238C10B96_METHOD_1_B5EA5DD8B4C0957C_OFFSET UNITYSDK_OFFSET(0xE3F0C20)
#define CLASS_1_EF7A5DF238C10B96__CTOR_OFFSET UNITYSDK_OFFSET(0xE3F0CA0)
...
public:
	...
	::Struct_2_3C72212260A8C076 Field_1_5; // 0x1C
	::RPG::GameCore::MoveToPositionUpdateMode Field_1_0; // 0x3C
	::RPG::MVector3 Field_1_1; // 0x40
