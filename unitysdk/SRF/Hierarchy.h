...
#define SRF_HIERARCHY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x17C669F0)
#define SRF_HIERARCHY_GET_OFFSET UNITYSDK_OFFSET(0x17C66A20)
#define SRF_HIERARCHY_RUNTIMEINITIALIZE_OFFSET UNITYSDK_OFFSET(0x17C66D40)
#define SRF_HIERARCHY__CCTOR_OFFSET UNITYSDK_OFFSET(0x17C66DF0)
#define SRF_HIERARCHY__CTOR_OFFSET UNITYSDK_OFFSET(0x17C66DE0)

namespace SRF
{
	inline static constexpr unsigned int Hierarchy_TypeDefinitionIndex = 26925;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::UnityEngine::Transform*>**)Il2CppClass::FromTypeDefinitionIndex(Hierarchy_TypeDefinitionIndex)->GetStaticField(0x23120);
		}
		static ::Il2CppArray<::System::Char>** StaticGet_Seperator()
		{
			return (::Il2CppArray<::System::Char>**)Il2CppClass::FromTypeDefinitionIndex(Hierarchy_TypeDefinitionIndex)->GetStaticField(0x23128);
		}
