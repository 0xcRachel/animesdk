...
#define SRF_SERVICE_SERVICESELECTORATTRIBUTE_GET_SERVICETYPE_OFFSET UNITYSDK_OFFSET(0x17C6CF40)
#define SRF_SERVICE_SERVICESELECTORATTRIBUTE_SET_SERVICETYPE_OFFSET UNITYSDK_OFFSET(0x17C6CF50)
#define SRF_SERVICE_SERVICESELECTORATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x17C6CF30)

namespace SRF::Service
{
	inline static constexpr unsigned int ServiceSelectorAttribute_TypeDefinitionIndex = 26959;
