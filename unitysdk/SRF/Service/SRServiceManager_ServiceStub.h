...
#define SRF_SERVICE_SRSERVICEMANAGER_SERVICESTUB_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17C6CDC0)
#define SRF_SERVICE_SRSERVICEMANAGER_SERVICESTUB__CTOR_OFFSET UNITYSDK_OFFSET(0x17C6BDA0)

namespace SRF::Service
{
	inline static constexpr unsigned int SRServiceManager_ServiceStub_TypeDefinitionIndex = 26969;
