...
#define SRF_UI_SRTEXT_ADD_LAYOUTDIRTY_OFFSET UNITYSDK_OFFSET(0x1B2D1000)
#define SRF_UI_SRTEXT_REMOVE_LAYOUTDIRTY_OFFSET UNITYSDK_OFFSET(0x1B2D12B0)
#define SRF_UI_SRTEXT_SETLAYOUTDIRTY_OFFSET UNITYSDK_OFFSET(0x1B2D7CB0)
#define SRF_UI_SRTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2D7CF0)
