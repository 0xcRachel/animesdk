...
#define SRF_UI_SRSPINNER_SPINEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x17C73C00)

namespace SRF::UI
{
	inline static constexpr unsigned int SRSpinner_SpinEvent_TypeDefinitionIndex = 26945;
