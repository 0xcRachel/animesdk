...
#define SRF_COROUTINES_WAITFORSECONDSREALTIME_OFFSET UNITYSDK_OFFSET(0x17C654F0)

namespace SRF
{
	inline static constexpr unsigned int Coroutines_TypeDefinitionIndex = 26917;
