...
#define CLASS_2_DC2210CD3B7AF82B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x85A7970)
#define CLASS_2_DC2210CD3B7AF82B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x85A79B0)
#define CLASS_2_DC2210CD3B7AF82B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x85A7B60)
#define CLASS_2_DC2210CD3B7AF82B_TICK_OFFSET UNITYSDK_OFFSET(0x85A7BB0)
#define CLASS_2_DC2210CD3B7AF82B__CTOR_OFFSET UNITYSDK_OFFSET(0x85A7960)

inline static constexpr unsigned int Class_2_DC2210CD3B7AF82B_TypeDefinitionIndex = 46174;

class Class_2_DC2210CD3B7AF82B : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::Client::LoopScene* Field_2_2; // 0x20
	::RPG::GameCore::SetLoopSceneCameraSpeed* Field_2_0; // 0x28
