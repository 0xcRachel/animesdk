...
#define CLASS_4_C42FA8E003EE7719_METHOD_4_690EB21B07B220FD_OFFSET UNITYSDK_OFFSET(0x16A299B0)
#define CLASS_4_C42FA8E003EE7719_METHOD_4_8A83AFE4D802260F_OFFSET UNITYSDK_OFFSET(0x16A29A90)
#define CLASS_4_C42FA8E003EE7719__CTOR_OFFSET UNITYSDK_OFFSET(0x16A29A30)

inline static constexpr unsigned int Class_4_C42FA8E003EE7719_TypeDefinitionIndex = 19981;

class Class_4_C42FA8E003EE7719 : public ::RPG::GameCore::AdvWaitingEventBase
{
public:
	::System::String* Field_4_2; // 0x20
	::RPG::GameCore::DynamicFloat* Field_4_0; // 0x28
	::Il2CppArray<::RPG::GameCore::TaskConfig*>* Field_4_1; // 0x30
