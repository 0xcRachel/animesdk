...
#define BOUNDSDRAWER_GET_CULLINGSTATUS_OFFSET UNITYSDK_OFFSET(0x8FDAD60)
#define BOUNDSDRAWER_GET_LODTEMPLATECFG_OFFSET UNITYSDK_OFFSET(0x8FDAD80)
#define BOUNDSDRAWER_GET_PRELOADCULLINGSTATUS_OFFSET UNITYSDK_OFFSET(0x8FDAD40)
#define BOUNDSDRAWER_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x8FDA690)
#define BOUNDSDRAWER_SETBOUND_OFFSET UNITYSDK_OFFSET(0x8FDA510)
#define BOUNDSDRAWER_SETOWNERINSTANCE_OFFSET UNITYSDK_OFFSET(0x8FDA590)
#define BOUNDSDRAWER_SET_CULLINGSTATUS_OFFSET UNITYSDK_OFFSET(0x8FDAD70)
#define BOUNDSDRAWER_SET_PRELOADCULLINGSTATUS_OFFSET UNITYSDK_OFFSET(0x8FDAD50)
#define BOUNDSDRAWER_START_OFFSET UNITYSDK_OFFSET(0x8FDA5E0)
#define BOUNDSDRAWER__CTOR_OFFSET UNITYSDK_OFFSET(0x8FDADE0)
