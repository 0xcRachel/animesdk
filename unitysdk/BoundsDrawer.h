...
#define BOUNDSDRAWER_GET_CULLINGSTATUS_OFFSET UNITYSDK_OFFSET(0x8AAA9B0)
#define BOUNDSDRAWER_GET_LODTEMPLATECFG_OFFSET UNITYSDK_OFFSET(0x8AAA9D0)
#define BOUNDSDRAWER_GET_PRELOADCULLINGSTATUS_OFFSET UNITYSDK_OFFSET(0x8AAA990)
#define BOUNDSDRAWER_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x8AAA2E0)
#define BOUNDSDRAWER_SETBOUND_OFFSET UNITYSDK_OFFSET(0x8AAA160)
#define BOUNDSDRAWER_SETOWNERINSTANCE_OFFSET UNITYSDK_OFFSET(0x8AAA1E0)
#define BOUNDSDRAWER_SET_CULLINGSTATUS_OFFSET UNITYSDK_OFFSET(0x8AAA9C0)
#define BOUNDSDRAWER_SET_PRELOADCULLINGSTATUS_OFFSET UNITYSDK_OFFSET(0x8AAA9A0)
#define BOUNDSDRAWER_START_OFFSET UNITYSDK_OFFSET(0x8AAA230)
#define BOUNDSDRAWER__CTOR_OFFSET UNITYSDK_OFFSET(0x8AAAA30)

inline static constexpr unsigned int BoundsDrawer_TypeDefinitionIndex = 37229;
