...
#define CLASS_1_B8B6DDBC8B69EE28_GET_CONDITIONTYPE_OFFSET UNITYSDK_OFFSET(0xF7881E0)
#define CLASS_1_B8B6DDBC8B69EE28_GET_ID_OFFSET UNITYSDK_OFFSET(0xF788160)
#define CLASS_1_B8B6DDBC8B69EE28_GET_TARGETGRIDTYPE_OFFSET UNITYSDK_OFFSET(0xF7881C0)
#define CLASS_1_B8B6DDBC8B69EE28_GET_TOAST_OFFSET UNITYSDK_OFFSET(0xF788200)
#define CLASS_1_B8B6DDBC8B69EE28_GET_USECARDID_OFFSET UNITYSDK_OFFSET(0xF7881A0)
#define CLASS_1_B8B6DDBC8B69EE28_GET_USECARDTYPE_OFFSET UNITYSDK_OFFSET(0xF788180)
#define CLASS_1_B8B6DDBC8B69EE28_METHOD_1_F3E869ED418D765A_OFFSET UNITYSDK_OFFSET(0xF788220)
#define CLASS_1_B8B6DDBC8B69EE28_SET_CONDITIONTYPE_OFFSET UNITYSDK_OFFSET(0xF7881F0)
#define CLASS_1_B8B6DDBC8B69EE28_SET_ID_OFFSET UNITYSDK_OFFSET(0xF788170)
#define CLASS_1_B8B6DDBC8B69EE28_SET_TARGETGRIDTYPE_OFFSET UNITYSDK_OFFSET(0xF7881D0)
#define CLASS_1_B8B6DDBC8B69EE28_SET_TOAST_OFFSET UNITYSDK_OFFSET(0xF788210)
#define CLASS_1_B8B6DDBC8B69EE28_SET_USECARDID_OFFSET UNITYSDK_OFFSET(0xF7881B0)
#define CLASS_1_B8B6DDBC8B69EE28_SET_USECARDTYPE_OFFSET UNITYSDK_OFFSET(0xF788190)
#define CLASS_1_B8B6DDBC8B69EE28__CTOR_OFFSET UNITYSDK_OFFSET(0xF7882D0)

inline static constexpr unsigned int Class_1_B8B6DDBC8B69EE28_TypeDefinitionIndex = 70106;

class Class_1_B8B6DDBC8B69EE28 : public ::System::Object
{
public:
	::System::UInt32 _UseCardID_k__BackingField; // 0x10
	::RPG::GameCore::ChenLingGridStatus _TargetGridType_k__BackingField; // 0x14
