...
#define PVSSTAGEOCCLUDERHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x8AC86C0)

inline static constexpr unsigned int PvsStageOccluderHandle_TypeDefinitionIndex = 37302;
