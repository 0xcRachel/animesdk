...
#define CLASS_1_588846AE6AA4F4B4_GETSKILLROWDATABYID_OFFSET UNITYSDK_OFFSET(0xD4D9840)
#define CLASS_1_588846AE6AA4F4B4_GETSKILLROWDATABYNAME_OFFSET UNITYSDK_OFFSET(0xD4D9740)
#define CLASS_1_588846AE6AA4F4B4_GETSKILLROWDATA_OFFSET UNITYSDK_OFFSET(0xD4D9600)
#define CLASS_1_588846AE6AA4F4B4_GET_ACTIONICONPATH_OFFSET UNITYSDK_OFFSET(0xD4D91B0)
#define CLASS_1_588846AE6AA4F4B4_GET_AIPATH_OFFSET UNITYSDK_OFFSET(0xD4D89F0)
#define CLASS_1_588846AE6AA4F4B4_GET_AVATARSIDEICONPATH_OFFSET UNITYSDK_OFFSET(0xD4D9470)
#define CLASS_1_588846AE6AA4F4B4_GET_CHARACTERNAME_OFFSET UNITYSDK_OFFSET(0xD4D8ED0)
#define CLASS_1_588846AE6AA4F4B4_GET_CONFIGID_OFFSET UNITYSDK_OFFSET(0xD4D8890)
#define CLASS_1_588846AE6AA4F4B4_GET_DAMAGETYPERESISTANCE_OFFSET UNITYSDK_OFFSET(0xD4D8D60)
#define CLASS_1_588846AE6AA4F4B4_GET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0xD4D8CB0)
#define CLASS_1_588846AE6AA4F4B4_GET_HAVEACTIONDELAY_OFFSET UNITYSDK_OFFSET(0xD4D8EC0)
#define CLASS_1_588846AE6AA4F4B4_GET_HEADICONPATH_OFFSET UNITYSDK_OFFSET(0xD4D9100)
#define CLASS_1_588846AE6AA4F4B4_GET_INTRODUCTION_OFFSET UNITYSDK_OFFSET(0xD4D8F90)
#define CLASS_1_588846AE6AA4F4B4_GET_JSONPATH_OFFSET UNITYSDK_OFFSET(0xD4D8940)
#define CLASS_1_588846AE6AA4F4B4_GET_JSON_OFFSET UNITYSDK_OFFSET(0xD4D87E0)
#define CLASS_1_588846AE6AA4F4B4_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xD4D8AA0)
#define CLASS_1_588846AE6AA4F4B4_GET_MODELPATH_OFFSET UNITYSDK_OFFSET(0xD4D9050)
#define CLASS_1_588846AE6AA4F4B4_GET_NATUREID_OFFSET UNITYSDK_OFFSET(0xD4D8C00)
#define CLASS_1_588846AE6AA4F4B4_GET_ROUNDICONPATH_OFFSET UNITYSDK_OFFSET(0xD4D93C0)
#define CLASS_1_588846AE6AA4F4B4_GET_ROW_OFFSET UNITYSDK_OFFSET(0xD4D86E0)
#define CLASS_1_588846AE6AA4F4B4_GET_SIDEAVATARHEADICONPATH_OFFSET UNITYSDK_OFFSET(0xD4D9260)
#define CLASS_1_588846AE6AA4F4B4_GET_SKILLROWDATAS_OFFSET UNITYSDK_OFFSET(0xD4D8B50)
#define CLASS_1_588846AE6AA4F4B4_GET_SPNEED_OFFSET UNITYSDK_OFFSET(0xD4D8E10)
#define CLASS_1_588846AE6AA4F4B4_GET_WAITINGAVATARHEADICONPATH_OFFSET UNITYSDK_OFFSET(0xD4D9310)
#define CLASS_1_588846AE6AA4F4B4_METHOD_1_CE35BF94C300261B_OFFSET UNITYSDK_OFFSET(0xD4D86D0)
#define CLASS_1_588846AE6AA4F4B4_OVERRIDEDATA_OFFSET UNITYSDK_OFFSET(0xD4D95A0)
#define CLASS_1_588846AE6AA4F4B4_OVERRIDEDISPLAY_OFFSET UNITYSDK_OFFSET(0xD4D9520)
#define CLASS_1_588846AE6AA4F4B4_SET_ROW_OFFSET UNITYSDK_OFFSET(0xD4D8790)
#define CLASS_1_588846AE6AA4F4B4__CTOR_OFFSET UNITYSDK_OFFSET(0xD4D86C0)
