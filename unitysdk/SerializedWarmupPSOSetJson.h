...
#define SERIALIZEDWARMUPPSOSETJSON__CTOR_OFFSET UNITYSDK_OFFSET(0xA68AEF0)

inline static constexpr unsigned int SerializedWarmupPSOSetJson_TypeDefinitionIndex = 37322;
