...
#define CLASS_2_CD958893D2F7EAE2_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x173F6D10)
#define CLASS_2_CD958893D2F7EAE2_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x173F6F20)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_0865E94460F11643_OFFSET UNITYSDK_OFFSET(0x173F35D0)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_134017AC3A2C19AD_OFFSET UNITYSDK_OFFSET(0x173F5C80)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x173F2F20)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_18A7BF8B592973BC_OFFSET UNITYSDK_OFFSET(0x173F57D0)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x173F3220)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_2AED1A1868B40387_OFFSET UNITYSDK_OFFSET(0x173F3760)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_2E07D057E72DE76A_OFFSET UNITYSDK_OFFSET(0x173F55B0)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_3A1D2B4F74743724_OFFSET UNITYSDK_OFFSET(0x173F65C0)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_3AF1A3002090D320_OFFSET UNITYSDK_OFFSET(0x173F3A10)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_40E64ED64652D825_OFFSET UNITYSDK_OFFSET(0x173F6850)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x173F3230)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_460F8AE6EF9687FD_OFFSET UNITYSDK_OFFSET(0x173F5080)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_4857357D5C1BFCE8_OFFSET UNITYSDK_OFFSET(0x173F3FD0)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0x173F7200)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_5790A55946AA509D_2_OFFSET UNITYSDK_OFFSET(0x173F72C0)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x173F71A0)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_676CD2ECA00B10AF_OFFSET UNITYSDK_OFFSET(0x173F4A70)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_95780ED94B90ED36_1_OFFSET UNITYSDK_OFFSET(0x173F6560)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x173F6500)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_9D6C586EC30ADBDA_OFFSET UNITYSDK_OFFSET(0x173F6410)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_9E38127F40B34F1F_OFFSET UNITYSDK_OFFSET(0x173F59C0)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_A1781348F0A89177_OFFSET UNITYSDK_OFFSET(0x173F5370)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_A27D06F9481FAFDB_1_OFFSET UNITYSDK_OFFSET(0x173F6A90)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_A27D06F9481FAFDB_2_OFFSET UNITYSDK_OFFSET(0x173F6B30)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_A27D06F9481FAFDB_3_OFFSET UNITYSDK_OFFSET(0x173F6BD0)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_A27D06F9481FAFDB_4_OFFSET UNITYSDK_OFFSET(0x173F6C70)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0x173F69F0)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_AC1BFDB3D2FC0C79_OFFSET UNITYSDK_OFFSET(0x173F30E0)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x173F5910)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_B37C805F1A4DBCFB_OFFSET UNITYSDK_OFFSET(0x173F36C0)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_C9F59B9D8CCA4DFF_OFFSET UNITYSDK_OFFSET(0x173F4C10)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x173F3360)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_D3E970D78BB8886D_OFFSET UNITYSDK_OFFSET(0x173F5150)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_D77F7476BCD66744_OFFSET UNITYSDK_OFFSET(0x173F2FF0)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_E5D1955A389D1F9C_OFFSET UNITYSDK_OFFSET(0x173F6730)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_EEEA24B88E52471C_OFFSET UNITYSDK_OFFSET(0x173F3D30)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_F206290BA342BA13_OFFSET UNITYSDK_OFFSET(0x173F3400)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_F25D2DE7181D2805_1_OFFSET UNITYSDK_OFFSET(0x173F6390)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_F25D2DE7181D2805_OFFSET UNITYSDK_OFFSET(0x173F5C00)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_FD45AB35B857FF73_OFFSET UNITYSDK_OFFSET(0x173F5F80)
#define CLASS_2_CD958893D2F7EAE2__CTOR_OFFSET UNITYSDK_OFFSET(0x173F7100)
#define CLASS_2_CD958893D2F7EAE2__ONBIND_OFFSET UNITYSDK_OFFSET(0x173F2C40)
#define CLASS_2_CD958893D2F7EAE2__ONTICK_OFFSET UNITYSDK_OFFSET(0x173F33A0)
#define CLASS_2_CD958893D2F7EAE2___IFIXBASEPROXY_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x173F7320)
#define CLASS_2_CD958893D2F7EAE2___IFIXBASEPROXY_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x173F7380)
#define CLASS_2_CD958893D2F7EAE2___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0x173F7140)
#define CLASS_2_CD958893D2F7EAE2___IFIXBASEPROXY__ONTICK_OFFSET UNITYSDK_OFFSET(0x173F7260)

inline static constexpr unsigned int Class_2_CD958893D2F7EAE2_TypeDefinitionIndex = 67555;
...
public:
	...
	::RPG::GameCore::SkillData* Field_2_8; // 0x78
	::UnityEngine::Transform* Field_2_9; // 0x80
	::UnityEngine::UI::Text* Field_2_10; // 0x88
	::RPG::Client::LongPressEvent* Field_2_11; // 0x90
	...
	::UnityEngine::UI::Image* Field_2_17; // 0xC0
	::RPG::GameCore::BattleInstance* Field_2_18; // 0xC8
	::Class_2_40491F513F4A6F01* Field_2_19; // 0xD0
	::Class_1_274386B6ECA5E606* Field_2_20; // 0xD8
	::UnityEngine::ParticleSystem* Field_2_21; // 0xE0
	::RPG::GameCore::TurnBasedAbilityComponent* Field_2_22; // 0xE8
	::RPG::GameCore::SkillCharacterComponent* Field_2_23; // 0xF0
	::UnityEngine::ParticleSystem* Field_2_24; // 0xF8
	::RPG::Client::PrefabLoadMeta* Field_2_25; // 0x100
	::UnityEngine::Transform* Field_2_26; // 0x108
	::UnityEngine::Animation* Field_2_27; // 0x110
	::Class_2_D650D0F10A391A4C* Field_2_28; // 0x118
	::RPG::GameCore::GameEntity* Field_2_29; // 0x120
	::Class_2_1A0F91E4CE01E769* Field_2_30; // 0x128
	::UnityEngine::UI::Image* Field_2_31; // 0x130
	::RPG::GameCore::SkillData* Field_2_32; // 0x138
	::RPG::GameCore::CharacterDataComponent* Field_2_33; // 0x140
