...
#define CLASS_3_E9B4A16C3CC1D841_METHOD_3_8C3DB70FFBBF01C7_OFFSET UNITYSDK_OFFSET(0x155B09F0)
#define CLASS_3_E9B4A16C3CC1D841__CTOR_OFFSET UNITYSDK_OFFSET(0x155B0750)
#define CLASS_3_E9B4A16C3CC1D841__REGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x155B08D0)
#define CLASS_3_E9B4A16C3CC1D841__UNREGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x155B0960)
#define CLASS_3_E9B4A16C3CC1D841___IFIXBASEPROXY__REGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x155B0AF0)
#define CLASS_3_E9B4A16C3CC1D841___IFIXBASEPROXY__UNREGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x155B0B00)
