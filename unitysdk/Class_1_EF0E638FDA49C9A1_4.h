...
#define CLASS_1_EF0E638FDA49C9A1_4_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17CFE220)
#define CLASS_1_EF0E638FDA49C9A1_4_CLONE_OFFSET UNITYSDK_OFFSET(0x17CFDDA0)
#define CLASS_1_EF0E638FDA49C9A1_4_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17CFDE70)
#define CLASS_1_EF0E638FDA49C9A1_4_EQUALS_OFFSET UNITYSDK_OFFSET(0x17CFDE40)
#define CLASS_1_EF0E638FDA49C9A1_4_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17CFDF80)
#define CLASS_1_EF0E638FDA49C9A1_4_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x17CFE4F0)
#define CLASS_1_EF0E638FDA49C9A1_4_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x17CFE3E0)
#define CLASS_1_EF0E638FDA49C9A1_4_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x17CFDE20)
#define CLASS_1_EF0E638FDA49C9A1_4_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x17CFDDD0)
#define CLASS_1_EF0E638FDA49C9A1_4_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x17CFDE00)
#define CLASS_1_EF0E638FDA49C9A1_4_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x17CFDDF0)
#define CLASS_1_EF0E638FDA49C9A1_4_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x17CFDE30)
#define CLASS_1_EF0E638FDA49C9A1_4_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x17CFDDE0)
#define CLASS_1_EF0E638FDA49C9A1_4_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x17CFDE10)
#define CLASS_1_EF0E638FDA49C9A1_4_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17CFDC80)
#define CLASS_1_EF0E638FDA49C9A1_4_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17CFE090)
#define CLASS_1_EF0E638FDA49C9A1_4_WRITETO_OFFSET UNITYSDK_OFFSET(0x17CFE0F0)
#define CLASS_1_EF0E638FDA49C9A1_4__CCTOR_OFFSET UNITYSDK_OFFSET(0x17CFE600)
#define CLASS_1_EF0E638FDA49C9A1_4__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17CFDCD0)
#define CLASS_1_EF0E638FDA49C9A1_4__CTOR_OFFSET UNITYSDK_OFFSET(0x17CFDC90)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_352A8B3482C80E7D_55*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_EF0E638FDA49C9A1_4_TypeDefinitionIndex)->GetStaticField(0xBED0);
	}
	...
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_352A8B3482C80E7D_55*>* Field_1_5; // 0x20
