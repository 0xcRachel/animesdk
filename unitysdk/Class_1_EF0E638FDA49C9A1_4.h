...
#define CLASS_1_EF0E638FDA49C9A1_4_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17545400)
#define CLASS_1_EF0E638FDA49C9A1_4_CLONE_OFFSET UNITYSDK_OFFSET(0x17544F20)
#define CLASS_1_EF0E638FDA49C9A1_4_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17545040)
#define CLASS_1_EF0E638FDA49C9A1_4_EQUALS_OFFSET UNITYSDK_OFFSET(0x17544FE0)
#define CLASS_1_EF0E638FDA49C9A1_4_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17545150)
#define CLASS_1_EF0E638FDA49C9A1_4_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x175456F0)
#define CLASS_1_EF0E638FDA49C9A1_4_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x175455D0)
#define CLASS_1_EF0E638FDA49C9A1_4_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x17544FC0)
#define CLASS_1_EF0E638FDA49C9A1_4_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x17544F90)
#define CLASS_1_EF0E638FDA49C9A1_4_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x17544F70)
#define CLASS_1_EF0E638FDA49C9A1_4_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x17544FB0)
#define CLASS_1_EF0E638FDA49C9A1_4_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x17544FD0)
#define CLASS_1_EF0E638FDA49C9A1_4_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x17544FA0)
#define CLASS_1_EF0E638FDA49C9A1_4_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x17544F80)
#define CLASS_1_EF0E638FDA49C9A1_4_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17544D90)
#define CLASS_1_EF0E638FDA49C9A1_4_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17545270)
#define CLASS_1_EF0E638FDA49C9A1_4_WRITETO_OFFSET UNITYSDK_OFFSET(0x175452D0)
#define CLASS_1_EF0E638FDA49C9A1_4__CCTOR_OFFSET UNITYSDK_OFFSET(0x17545810)
#define CLASS_1_EF0E638FDA49C9A1_4__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17544DF0)
#define CLASS_1_EF0E638FDA49C9A1_4__CTOR_OFFSET UNITYSDK_OFFSET(0x17544DA0)

inline static constexpr unsigned int Class_1_EF0E638FDA49C9A1_4_TypeDefinitionIndex = 26467;

class Class_1_EF0E638FDA49C9A1_4 : public ::System::Object
{
public:
	static ::Google::Protobuf::FieldCodec_1<::Class_1_352A8B3482C80E7D_55*>** StaticGet_Field_1_6()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_352A8B3482C80E7D_55*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_EF0E638FDA49C9A1_4_TypeDefinitionIndex)->GetStaticField(0xB620);
	}
	// static const ::System::Int32 Field_1_1 = 0x2; // 0x0
	// static const ::System::Int32 Field_1_3 = 0x8; // 0x0
	// static const ::System::Int32 Field_1_5 = 0x9; // 0x0
	// static const ::System::Int32 Field_1_8 = 0x3; // 0x0
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_352A8B3482C80E7D_55*>* Field_1_7; // 0x10
	::Google::Protobuf::UnknownFieldSet* Field_1_0; // 0x18
	::Class_1_352A8B3482C80E7D_55* Field_1_2; // 0x20
	...
	{
		return ((::Class_1_352A8B3482C80E7D_55*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_EF0E638FDA49C9A1_4_METHOD_1_24748FC20F375725_OFFSET))(this);
	}

	::System::Void Method_1_8C8625211DA811AE(::Class_1_352A8B3482C80E7D_55* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_352A8B3482C80E7D_55*))((::PBYTE)hIl2Cpp + CLASS_1_EF0E638FDA49C9A1_4_METHOD_1_8C8625211DA811AE_OFFSET))(this, a1);
	}
