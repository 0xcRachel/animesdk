...
#define CLASS_2_AE3324B39236349E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1110A7F0)
#define CLASS_2_AE3324B39236349E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1110A830)
#define CLASS_2_AE3324B39236349E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1110AB60)
#define CLASS_2_AE3324B39236349E_TICK_OFFSET UNITYSDK_OFFSET(0x1110ABB0)
#define CLASS_2_AE3324B39236349E__CTOR_OFFSET UNITYSDK_OFFSET(0x1110A7E0)

inline static constexpr unsigned int Class_2_AE3324B39236349E_TypeDefinitionIndex = 42920;

class Class_2_AE3324B39236349E : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::CharacterEnableEmptyModel* Field_2_0; // 0x20
