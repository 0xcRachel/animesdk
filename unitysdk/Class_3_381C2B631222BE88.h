...
#define CLASS_3_381C2B631222BE88_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10A420F0)
#define CLASS_3_381C2B631222BE88__CTOR_OFFSET UNITYSDK_OFFSET(0x10A420C0)

inline static constexpr unsigned int Class_3_381C2B631222BE88_TypeDefinitionIndex = 45774;
