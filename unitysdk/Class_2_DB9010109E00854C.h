...
#define CLASS_2_DB9010109E00854C_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1142C1B0)
#define CLASS_2_DB9010109E00854C_METHOD_2_3779201892A01BB4_OFFSET UNITYSDK_OFFSET(0x11432D00)
#define CLASS_2_DB9010109E00854C_METHOD_2_4D71BCFB74C16073_OFFSET UNITYSDK_OFFSET(0x114335E0)
#define CLASS_2_DB9010109E00854C_METHOD_2_53108F187541F144_OFFSET UNITYSDK_OFFSET(0x11432ED0)
#define CLASS_2_DB9010109E00854C_METHOD_2_6E0D227FDEAA8A41_OFFSET UNITYSDK_OFFSET(0x1142C9D0)
#define CLASS_2_DB9010109E00854C_METHOD_2_7B411317D337F87A_OFFSET UNITYSDK_OFFSET(0x1142F610)
#define CLASS_2_DB9010109E00854C_METHOD_2_7B611711B291982E_OFFSET UNITYSDK_OFFSET(0x1142F340)
#define CLASS_2_DB9010109E00854C_METHOD_2_92E07EF7AC627659_OFFSET UNITYSDK_OFFSET(0x11433130)
#define CLASS_2_DB9010109E00854C_METHOD_2_937F8473216A3162_OFFSET UNITYSDK_OFFSET(0x1142C420)
#define CLASS_2_DB9010109E00854C_METHOD_2_A8FA1D5DD9DF46A1_OFFSET UNITYSDK_OFFSET(0x1142F4C0)
#define CLASS_2_DB9010109E00854C_METHOD_2_D5111B6AECEE40BA_OFFSET UNITYSDK_OFFSET(0x114332E0)
#define CLASS_2_DB9010109E00854C_METHOD_2_EEBB7BA0EB4C8B79_OFFSET UNITYSDK_OFFSET(0x11433450)
#define CLASS_2_DB9010109E00854C__CCTOR_OFFSET UNITYSDK_OFFSET(0x114335F0)
#define CLASS_2_DB9010109E00854C__CTOR_OFFSET UNITYSDK_OFFSET(0x1142BDC0)
#define CLASS_2_DB9010109E00854C__GETMONOVIEW_OFFSET UNITYSDK_OFFSET(0x1142C7C0)
#define CLASS_2_DB9010109E00854C__ONRELEASEVIEW_OFFSET UNITYSDK_OFFSET(0x1142C670)
#define CLASS_2_DB9010109E00854C___ADDREVERTALL2DVOXELINTERACTTRIGGER_B__7_0_OFFSET UNITYSDK_OFFSET(0x11433650)
#define CLASS_2_DB9010109E00854C___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11433890)

inline static constexpr unsigned int Class_2_DB9010109E00854C_TypeDefinitionIndex = 62460;
...
public:
	...
	{
		return (::System::Collections::Generic::List_1<::Class_2_0C58AD91B0F4D809*>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_DB9010109E00854C_TypeDefinitionIndex)->GetStaticField(0x17300);
	}
	static ::System::Int32* StaticGet_Field_2_7()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_2_DB9010109E00854C_TypeDefinitionIndex)->GetStaticField(0x9190);
	}
	::System::Collections::Generic::Dictionary_2<::FiveDimRenderingItem*, ::UnityEngine::Vector3>* Field_2_1; // 0x30
	::System::Collections::Generic::Dictionary_2<::FiveDimRenderingItem*, ::Il2CppArray<::System::Single>*>* Field_2_4; // 0x38
	::Class_1_867B6CE75953535A_1* Field_2_9; // 0x40
	::System::Collections::Generic::HashSet_1<::Class_2_0C58AD91B0F4D809*>* Field_2_0; // 0x48
	::System::Collections::Generic::List_1<::FiveDimRenderingItem*>* Field_2_5; // 0x50
	::Class_2_AF4E89503EBBCCA0* Field_2_10; // 0x58
	::System::Collections::Generic::HashSet_1<::FiveDimRenderingPanelRuntime*>* Field_2_8; // 0x60
	::System::Collections::Generic::Dictionary_2<::FiveDimRenderingItem*, ::RPG::Client::LittleGame::FourRotateVoxel::FourRotateVoxelGameViewCoord>* Field_2_3; // 0x68
	::System::Collections::Generic::Dictionary_2<::FiveDimRenderingItem*, ::System::Single>* Field_2_2; // 0x70
