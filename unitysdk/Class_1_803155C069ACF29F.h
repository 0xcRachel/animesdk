...
#define CLASS_1_803155C069ACF29F__CTOR_OFFSET UNITYSDK_OFFSET(0x1A266130)
...
{
public:
	::RPG::Client::LittleGame::TRFAction Field_1_0; // 0x10
	::RPG::Client::LittleGame::TRFOperate Field_1_1; // 0x14
