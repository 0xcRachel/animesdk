...
#define CLASS_3_2644CA4EEB7C3351_GETAPPLYSTREAMINGLAYER_OFFSET UNITYSDK_OFFSET(0x172B7C10)
#define CLASS_3_2644CA4EEB7C3351_GETBOUNDCENTER_OFFSET UNITYSDK_OFFSET(0x172B7AC0)
#define CLASS_3_2644CA4EEB7C3351_GETBOUNDSIZE_OFFSET UNITYSDK_OFFSET(0x172B7B30)
#define CLASS_3_2644CA4EEB7C3351_GETRECT_OFFSET UNITYSDK_OFFSET(0x172B7BB0)
#define CLASS_3_2644CA4EEB7C3351_GET_TRANSFORMDIRTY_OFFSET UNITYSDK_OFFSET(0x172B8160)
#define CLASS_3_2644CA4EEB7C3351_METHOD_3_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x172B7F40)
#define CLASS_3_2644CA4EEB7C3351_METHOD_3_40E490E2772D5D75_OFFSET UNITYSDK_OFFSET(0x172B7CC0)
#define CLASS_3_2644CA4EEB7C3351_METHOD_3_4D4A0BA9A7BB9B54_OFFSET UNITYSDK_OFFSET(0x172B7FA0)
#define CLASS_3_2644CA4EEB7C3351_METHOD_3_655848934A326660_OFFSET UNITYSDK_OFFSET(0x172B80A0)
#define CLASS_3_2644CA4EEB7C3351_METHOD_3_975EF494C5CDCB0F_OFFSET UNITYSDK_OFFSET(0x172B8100)
#define CLASS_3_2644CA4EEB7C3351_METHOD_3_9E0A56377B0CA690_OFFSET UNITYSDK_OFFSET(0x172B7D30)
#define CLASS_3_2644CA4EEB7C3351_METHOD_3_B4D8211180DC3A20_OFFSET UNITYSDK_OFFSET(0x172B8030)
#define CLASS_3_2644CA4EEB7C3351_METHOD_3_EDCA216BAAE60E47_OFFSET UNITYSDK_OFFSET(0x172B7E10)
#define CLASS_3_2644CA4EEB7C3351_SET_TRANSFORMDIRTY_OFFSET UNITYSDK_OFFSET(0x172B8170)
#define CLASS_3_2644CA4EEB7C3351__CCTOR_OFFSET UNITYSDK_OFFSET(0x172B8180)
#define CLASS_3_2644CA4EEB7C3351__CTOR_OFFSET UNITYSDK_OFFSET(0x172B79F0)
#define CLASS_3_2644CA4EEB7C3351___IFIXBASEPROXY_GETAPPLYSTREAMINGLAYER_OFFSET UNITYSDK_OFFSET(0x172B8370)
#define CLASS_3_2644CA4EEB7C3351___IFIXBASEPROXY_GETBOUNDCENTER_OFFSET UNITYSDK_OFFSET(0x172B81C0)
#define CLASS_3_2644CA4EEB7C3351___IFIXBASEPROXY_GETBOUNDSIZE_OFFSET UNITYSDK_OFFSET(0x172B8250)
#define CLASS_3_2644CA4EEB7C3351___IFIXBASEPROXY_GETRECT_OFFSET UNITYSDK_OFFSET(0x172B82F0)

inline static constexpr unsigned int Class_3_2644CA4EEB7C3351_TypeDefinitionIndex = 68939;
...
public:
	...
	{
		return (::RPG::GameCore::BlockNodeConfig**)Il2CppClass::FromTypeDefinitionIndex(Class_3_2644CA4EEB7C3351_TypeDefinitionIndex)->GetStaticField(0x5AFD0);
	}
	::UnityEngine::Rect Field_3_1; // 0xD8
	::UnityEngine::Vector3 Field_3_2; // 0xE8
	::UnityEngine::Vector3 Field_3_3; // 0xF4
	::System::Boolean _TransformDirty_k__BackingField; // 0x100
