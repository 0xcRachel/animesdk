...
#define CLASS_1_5A55E8BED8FA46A4_1_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19EBBB60)
#define CLASS_1_5A55E8BED8FA46A4_1_CLONE_OFFSET UNITYSDK_OFFSET(0x19EBB670)
#define CLASS_1_5A55E8BED8FA46A4_1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19EBB760)
#define CLASS_1_5A55E8BED8FA46A4_1_EQUALS_OFFSET UNITYSDK_OFFSET(0x19EBB700)
#define CLASS_1_5A55E8BED8FA46A4_1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19EBB820)
#define CLASS_1_5A55E8BED8FA46A4_1_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19EBBD00)
#define CLASS_1_5A55E8BED8FA46A4_1_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19EBBC90)
#define CLASS_1_5A55E8BED8FA46A4_1_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x19EBB6C0)
#define CLASS_1_5A55E8BED8FA46A4_1_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19EBB480)
#define CLASS_1_5A55E8BED8FA46A4_1_METHOD_1_554199E0076172C5_1_OFFSET UNITYSDK_OFFSET(0x19EBB6F0)
#define CLASS_1_5A55E8BED8FA46A4_1_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x19EBB6E0)
#define CLASS_1_5A55E8BED8FA46A4_1_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x19EBB6D0)
#define CLASS_1_5A55E8BED8FA46A4_1_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19EBB4E0)
#define CLASS_1_5A55E8BED8FA46A4_1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19EBBA00)
#define CLASS_1_5A55E8BED8FA46A4_1_WRITETO_OFFSET UNITYSDK_OFFSET(0x19EBBA60)
#define CLASS_1_5A55E8BED8FA46A4_1__CCTOR_OFFSET UNITYSDK_OFFSET(0x19EBBE40)
#define CLASS_1_5A55E8BED8FA46A4_1__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19EBB580)
#define CLASS_1_5A55E8BED8FA46A4_1__CTOR_OFFSET UNITYSDK_OFFSET(0x19EBB4F0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5A55E8BED8FA46A4_1*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5A55E8BED8FA46A4_1_TypeDefinitionIndex)->GetStaticField(0x14640);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_8()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5A55E8BED8FA46A4_1_TypeDefinitionIndex)->GetStaticField(0x14648);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_5()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5A55E8BED8FA46A4_1_TypeDefinitionIndex)->GetStaticField(0x14650);
	}
