...
#define STAGEHARMONYTRANSFORMLINKSLOT_METHOD_2_25DEA5C65A602671_1_OFFSET UNITYSDK_OFFSET(0xA6A4A00)
#define STAGEHARMONYTRANSFORMLINKSLOT_METHOD_2_25DEA5C65A602671_OFFSET UNITYSDK_OFFSET(0xA6A4820)
#define STAGEHARMONYTRANSFORMLINKSLOT_METHOD_2_3CF43707BF2E9BBA_OFFSET UNITYSDK_OFFSET(0xA6A4BC0)
#define STAGEHARMONYTRANSFORMLINKSLOT_METHOD_2_674D9307054D0ED0_OFFSET UNITYSDK_OFFSET(0xA6A4D90)
#define STAGEHARMONYTRANSFORMLINKSLOT_METHOD_2_AD23FDCC7576BB32_OFFSET UNITYSDK_OFFSET(0xA6A4D00)
#define STAGEHARMONYTRANSFORMLINKSLOT__CTOR_OFFSET UNITYSDK_OFFSET(0xA6A5080)

inline static constexpr unsigned int StageHarmonyTransformLinkSlot_TypeDefinitionIndex = 37445;
