...
#define CLASS_2_58FD2A9D83B4433D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10567B80)
#define CLASS_2_58FD2A9D83B4433D_METHOD_2_0D7638DBC93E5002_OFFSET UNITYSDK_OFFSET(0x10567E40)
#define CLASS_2_58FD2A9D83B4433D_METHOD_2_2185F8A39E7E07F0_OFFSET UNITYSDK_OFFSET(0x10567F60)
#define CLASS_2_58FD2A9D83B4433D_METHOD_2_2934FD95900E25B5_OFFSET UNITYSDK_OFFSET(0x10567FB0)
#define CLASS_2_58FD2A9D83B4433D_METHOD_2_96BDC4B57CCFE000_OFFSET UNITYSDK_OFFSET(0x10568010)
#define CLASS_2_58FD2A9D83B4433D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10567CE0)
#define CLASS_2_58FD2A9D83B4433D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10567DF0)
#define CLASS_2_58FD2A9D83B4433D_TICK_OFFSET UNITYSDK_OFFSET(0x10567C80)
#define CLASS_2_58FD2A9D83B4433D__CTOR_OFFSET UNITYSDK_OFFSET(0x10567B70)

inline static constexpr unsigned int Class_2_58FD2A9D83B4433D_TypeDefinitionIndex = 46086;

class Class_2_58FD2A9D83B4433D : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::CharacterModelComponent* Field_2_3; // 0x18
	::RPG::GameCore::TaskContext* Field_2_1; // 0x20
	::RPG::GameCore::RogueDLC1Dot3CompassProcess* Field_2_0; // 0x28
	::RPG::Client::Prop::RogueDLCCompass* Field_2_2; // 0x30
