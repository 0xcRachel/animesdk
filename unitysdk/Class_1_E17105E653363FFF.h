...
#define CLASS_1_E17105E653363FFF__CTOR_OFFSET UNITYSDK_OFFSET(0x10A093A0)
...
public:
	...
	::Il2CppArray<::RPG::GameCore::JsonEnum*>* Field_1_5; // 0x28
	::RPG::GameCore::FixVec3 Field_1_3; // 0x30
	::RPG::GameCore::FixPoint Field_1_4; // 0x48
	::RPG::GameCore::TeamType Field_1_1; // 0x50
