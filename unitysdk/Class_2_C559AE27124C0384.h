...
#define CLASS_2_C559AE27124C0384_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8510660)
#define CLASS_2_C559AE27124C0384_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x8510700)
#define CLASS_2_C559AE27124C0384_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x8510770)
#define CLASS_2_C559AE27124C0384_TICK_OFFSET UNITYSDK_OFFSET(0x85106A0)
#define CLASS_2_C559AE27124C0384__CTOR_OFFSET UNITYSDK_OFFSET(0x8510650)

inline static constexpr unsigned int Class_2_C559AE27124C0384_TypeDefinitionIndex = 46105;

class Class_2_C559AE27124C0384 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::RogueShowSelectMainPage* Field_2_0; // 0x18
