...
#define CLASS_2_FE9EBB2A1BFDA2B3_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1043F640)
#define CLASS_2_FE9EBB2A1BFDA2B3_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1043F680)
#define CLASS_2_FE9EBB2A1BFDA2B3_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1043F730)
#define CLASS_2_FE9EBB2A1BFDA2B3_TICK_OFFSET UNITYSDK_OFFSET(0x1043F780)
#define CLASS_2_FE9EBB2A1BFDA2B3__CTOR_OFFSET UNITYSDK_OFFSET(0x1043F630)

inline static constexpr unsigned int Class_2_FE9EBB2A1BFDA2B3_TypeDefinitionIndex = 43536;
