...
#define CLASS_1_735612C94F558EAE_35_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x173E82F0)
#define CLASS_1_735612C94F558EAE_35_CLONE_OFFSET UNITYSDK_OFFSET(0x173E7DD0)
#define CLASS_1_735612C94F558EAE_35_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x173E7F20)
#define CLASS_1_735612C94F558EAE_35_EQUALS_OFFSET UNITYSDK_OFFSET(0x173E7E40)
#define CLASS_1_735612C94F558EAE_35_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x173E7FD0)
#define CLASS_1_735612C94F558EAE_35_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x173E8420)
#define CLASS_1_735612C94F558EAE_35_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x173E83C0)
#define CLASS_1_735612C94F558EAE_35_METHOD_1_554199E0076172C5_1_OFFSET UNITYSDK_OFFSET(0x173E7E30)
#define CLASS_1_735612C94F558EAE_35_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x173E7E20)
#define CLASS_1_735612C94F558EAE_35_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x173E7C50)
#define CLASS_1_735612C94F558EAE_35_TOSTRING_OFFSET UNITYSDK_OFFSET(0x173E81B0)
#define CLASS_1_735612C94F558EAE_35_WRITETO_OFFSET UNITYSDK_OFFSET(0x173E8210)
#define CLASS_1_735612C94F558EAE_35__CCTOR_OFFSET UNITYSDK_OFFSET(0x173E8560)
#define CLASS_1_735612C94F558EAE_35__CTOR_1_OFFSET UNITYSDK_OFFSET(0x173E7CF0)
#define CLASS_1_735612C94F558EAE_35__CTOR_OFFSET UNITYSDK_OFFSET(0x173E7C60)

inline static constexpr unsigned int Class_1_735612C94F558EAE_35_TypeDefinitionIndex = 24380;
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_735612C94F558EAE_35_TypeDefinitionIndex)->GetStaticField(0x2D080);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_5()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_735612C94F558EAE_35_TypeDefinitionIndex)->GetStaticField(0x2D088);
	}
