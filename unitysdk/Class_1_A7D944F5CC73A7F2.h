...
#define CLASS_1_A7D944F5CC73A7F2_DISPOSE_OFFSET UNITYSDK_OFFSET(0x111FCCB0)
#define CLASS_1_A7D944F5CC73A7F2_GET_FILEPATH_OFFSET UNITYSDK_OFFSET(0x111FD230)
#define CLASS_1_A7D944F5CC73A7F2_METHOD_1_23E92C6A3ADF7CF0_OFFSET UNITYSDK_OFFSET(0x111FCDA0)
#define CLASS_1_A7D944F5CC73A7F2_METHOD_1_59D634CA8DD784B2_OFFSET UNITYSDK_OFFSET(0x111FD130)
#define CLASS_1_A7D944F5CC73A7F2_METHOD_1_739DB9F245C7FAD0_OFFSET UNITYSDK_OFFSET(0x111FC4A0)
#define CLASS_1_A7D944F5CC73A7F2_METHOD_1_DCC3812E870317C4_OFFSET UNITYSDK_OFFSET(0x111FC310)
#define CLASS_1_A7D944F5CC73A7F2__CTOR_OFFSET UNITYSDK_OFFSET(0x111FC360)
...
public:
	...
	::System::IO::MemoryStream* Field_1_7; // 0x10
	::System::IO::BinaryReader* Field_1_8; // 0x18
	::Il2CppArray<::System::Byte>* Field_1_6; // 0x20
	::System::String* _FilePath_k__BackingField; // 0x28
	::Class_0_16E4307DCC419505_253* Field_1_2; // 0x30
	...
	::System::Boolean Method_1_23E92C6A3ADF7CF0(::RPGTools::Octree::Generation::OctreeNodeNativeData& a1)
	{
		return ((::System::Boolean(*)(::PVOID, ::RPGTools::Octree::Generation::OctreeNodeNativeData&))((::PBYTE)hIl2Cpp + CLASS_1_A7D944F5CC73A7F2_METHOD_1_23E92C6A3ADF7CF0_OFFSET))(this, a1);
	}
