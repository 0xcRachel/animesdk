...
#define CLASS_1_FFE26F0A05349163_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17B76CC0)
#define CLASS_1_FFE26F0A05349163_CLONE_OFFSET UNITYSDK_OFFSET(0x17B768F0)
#define CLASS_1_FFE26F0A05349163_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17B769B0)
#define CLASS_1_FFE26F0A05349163_EQUALS_OFFSET UNITYSDK_OFFSET(0x17B76980)
#define CLASS_1_FFE26F0A05349163_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17B76AA0)
#define CLASS_1_FFE26F0A05349163_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x17B76F30)
#define CLASS_1_FFE26F0A05349163_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x17B76E90)
#define CLASS_1_FFE26F0A05349163_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x17B76950)
#define CLASS_1_FFE26F0A05349163_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x17B76920)
#define CLASS_1_FFE26F0A05349163_METHOD_1_217A4C673B33B3F5_OFFSET UNITYSDK_OFFSET(0x17B76940)
#define CLASS_1_FFE26F0A05349163_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x17B76960)
#define CLASS_1_FFE26F0A05349163_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x17B76930)
#define CLASS_1_FFE26F0A05349163_METHOD_1_EA98AC27B86895E5_OFFSET UNITYSDK_OFFSET(0x17B76970)
#define CLASS_1_FFE26F0A05349163_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17B767B0)
#define CLASS_1_FFE26F0A05349163_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17B76B30)
#define CLASS_1_FFE26F0A05349163_WRITETO_OFFSET UNITYSDK_OFFSET(0x17B76B90)
#define CLASS_1_FFE26F0A05349163__CCTOR_OFFSET UNITYSDK_OFFSET(0x17B77070)
#define CLASS_1_FFE26F0A05349163__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17B76810)
#define CLASS_1_FFE26F0A05349163__CTOR_OFFSET UNITYSDK_OFFSET(0x17B767C0)
...
public:
	...
	{
		return (::Google::Protobuf::Collections::MapField_2_Codec<::System::UInt32, ::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_FFE26F0A05349163_TypeDefinitionIndex)->GetStaticField(0x44A90);
	}
	static ::Google::Protobuf::Collections::MapField_2_Codec<::System::UInt32, ::Class_1_DBE1913405A6C120_2*>** StaticGet_Field_1_4()
	{
		return (::Google::Protobuf::Collections::MapField_2_Codec<::System::UInt32, ::Class_1_DBE1913405A6C120_2*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_FFE26F0A05349163_TypeDefinitionIndex)->GetStaticField(0x44A98);
	}
	...
	::Google::Protobuf::Collections::MapField_2<::System::UInt32, ::Class_1_DBE1913405A6C120_2*>* Field_1_5; // 0x18
