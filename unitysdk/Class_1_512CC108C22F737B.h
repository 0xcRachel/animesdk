...
#define CLASS_1_512CC108C22F737B_CLEAR_OFFSET UNITYSDK_OFFSET(0xD227120)
#define CLASS_1_512CC108C22F737B__CTOR_OFFSET UNITYSDK_OFFSET(0xD227190)

inline static constexpr unsigned int Class_1_512CC108C22F737B_TypeDefinitionIndex = 44806;
