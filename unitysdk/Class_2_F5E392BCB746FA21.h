...
#define CLASS_2_F5E392BCB746FA21_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10C15F10)
#define CLASS_2_F5E392BCB746FA21_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10C15FA0)
#define CLASS_2_F5E392BCB746FA21_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10C15F50)
#define CLASS_2_F5E392BCB746FA21_TICK_OFFSET UNITYSDK_OFFSET(0x10C16140)
#define CLASS_2_F5E392BCB746FA21__CTOR_OFFSET UNITYSDK_OFFSET(0x10C15F00)

inline static constexpr unsigned int Class_2_F5E392BCB746FA21_TypeDefinitionIndex = 43551;

class Class_2_F5E392BCB746FA21 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_2; // 0x18
	::RPG::GameCore::SwitchEffectBattleArea* Field_2_1; // 0x20
	::Class_1_56FF45D7B2C55655* Field_2_0; // 0x28
