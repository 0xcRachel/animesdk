...
#define CLASS_2_9CFDF8348B5C64D8_GET_NEEDTICK_OFFSET UNITYSDK_OFFSET(0x10FA0620)
#define CLASS_2_9CFDF8348B5C64D8_METHOD_2_1622EF55C818E85D_1_OFFSET UNITYSDK_OFFSET(0x10FA08F0)
#define CLASS_2_9CFDF8348B5C64D8_METHOD_2_1622EF55C818E85D_OFFSET UNITYSDK_OFFSET(0x10FA0A20)
#define CLASS_2_9CFDF8348B5C64D8_METHOD_2_18B9B03FE50F05CA_OFFSET UNITYSDK_OFFSET(0x10FA0E10)
#define CLASS_2_9CFDF8348B5C64D8_METHOD_2_33625085E5D6A31B_OFFSET UNITYSDK_OFFSET(0x10FA0630)
#define CLASS_2_9CFDF8348B5C64D8_METHOD_2_49C06B1CBEC6567D_OFFSET UNITYSDK_OFFSET(0x10FA0B50)
#define CLASS_2_9CFDF8348B5C64D8_METHOD_2_6E520D7D4D494BBE_OFFSET UNITYSDK_OFFSET(0x10FA0360)
#define CLASS_2_9CFDF8348B5C64D8_METHOD_2_7F5A09121F2469EC_1_OFFSET UNITYSDK_OFFSET(0x10FA1AC0)
#define CLASS_2_9CFDF8348B5C64D8_METHOD_2_7F5A09121F2469EC_2_OFFSET UNITYSDK_OFFSET(0x10FA1CB0)
#define CLASS_2_9CFDF8348B5C64D8_METHOD_2_7F5A09121F2469EC_3_OFFSET UNITYSDK_OFFSET(0x10FA1EA0)
#define CLASS_2_9CFDF8348B5C64D8_METHOD_2_7F5A09121F2469EC_OFFSET UNITYSDK_OFFSET(0x10FA18D0)
#define CLASS_2_9CFDF8348B5C64D8_METHOD_2_B1445E8504415D4D_OFFSET UNITYSDK_OFFSET(0x10FA2090)
#define CLASS_2_9CFDF8348B5C64D8_METHOD_2_B7F8E0B4AF22DEA3_OFFSET UNITYSDK_OFFSET(0x10FA1740)
#define CLASS_2_9CFDF8348B5C64D8_ONINIT_OFFSET UNITYSDK_OFFSET(0x10F9FAD0)
#define CLASS_2_9CFDF8348B5C64D8_ONUNINIT_OFFSET UNITYSDK_OFFSET(0x10F9FF70)
#define CLASS_2_9CFDF8348B5C64D8__CCTOR_OFFSET UNITYSDK_OFFSET(0x10FA20B0)
#define CLASS_2_9CFDF8348B5C64D8__CTOR_OFFSET UNITYSDK_OFFSET(0x10FA20A0)
#define CLASS_2_9CFDF8348B5C64D8___IFIXBASEPROXY_ONINIT_OFFSET UNITYSDK_OFFSET(0x10FA2160)
#define CLASS_2_9CFDF8348B5C64D8___IFIXBASEPROXY_ONUNINIT_OFFSET UNITYSDK_OFFSET(0x10FA21C0)

inline static constexpr unsigned int Class_2_9CFDF8348B5C64D8_TypeDefinitionIndex = 47740;
...
public:
	...
	{
		return (::Il2CppArray<::UnityEngine::Collider*>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_9CFDF8348B5C64D8_TypeDefinitionIndex)->GetStaticField(0x37DE0);
	}
	static ::Il2CppArray<::System::UInt32>** StaticGet_Field_2_4()
	{
		return (::Il2CppArray<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_9CFDF8348B5C64D8_TypeDefinitionIndex)->GetStaticField(0x37DE8);
	}
