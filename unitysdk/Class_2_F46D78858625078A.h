...
#define CLASS_2_F46D78858625078A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9455E30)
#define CLASS_2_F46D78858625078A_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x9455E70)
#define CLASS_2_F46D78858625078A_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x9455F10)
#define CLASS_2_F46D78858625078A_TICK_OFFSET UNITYSDK_OFFSET(0x9455F60)
#define CLASS_2_F46D78858625078A__CTOR_OFFSET UNITYSDK_OFFSET(0x9455E20)

inline static constexpr unsigned int Class_2_F46D78858625078A_TypeDefinitionIndex = 46323;

class Class_2_F46D78858625078A : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::StartBattle* Field_2_0; // 0x20
