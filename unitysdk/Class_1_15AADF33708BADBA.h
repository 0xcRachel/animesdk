...
#define CLASS_1_15AADF33708BADBA_METHOD_1_097468641FDED14E_OFFSET UNITYSDK_OFFSET(0x10E84DC0)
#define CLASS_1_15AADF33708BADBA__CTOR_OFFSET UNITYSDK_OFFSET(0x10E84E40)

inline static constexpr unsigned int Class_1_15AADF33708BADBA_TypeDefinitionIndex = 44704;

class Class_1_15AADF33708BADBA : public ::System::Object
{
public:
	::RPG::GameCore::DotBarTypeConfig* Field_1_6; // 0x10
	::RPG::GameCore::NumBarTypeConfig* Field_1_8; // 0x18
	::RPG::GameCore::ProgressBarTypeConfig* Field_1_7; // 0x20
	...
	::RPG::GameCore::SummonerEnergyBarType Field_1_2; // 0x3C
