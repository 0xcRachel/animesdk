...
#define AKITERATOR_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x183A4460)
#define AKITERATOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x183A4370)
#define AKITERATOR_FINALIZE_OFFSET UNITYSDK_OFFSET(0x183A43F0)
#define AKITERATOR_GETCPTR_OFFSET UNITYSDK_OFFSET(0x183A4260)
#define AKITERATOR_GETITEM_OFFSET UNITYSDK_OFFSET(0x183A4A30)
#define AKITERATOR_GET_PITEM_OFFSET UNITYSDK_OFFSET(0x183A4720)
#define AKITERATOR_ISDIFFERENTFROM_OFFSET UNITYSDK_OFFSET(0x183A4C50)
#define AKITERATOR_ISEQUALTO_OFFSET UNITYSDK_OFFSET(0x183A4B30)
#define AKITERATOR_NEXTITER_OFFSET UNITYSDK_OFFSET(0x183A4830)
#define AKITERATOR_PREVITER_OFFSET UNITYSDK_OFFSET(0x183A4930)
#define AKITERATOR_SETCPTR_OFFSET UNITYSDK_OFFSET(0x183A42B0)
#define AKITERATOR_SET_PITEM_OFFSET UNITYSDK_OFFSET(0x183A4600)
#define AKITERATOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x183A4D70)
#define AKITERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x183A4250)

inline static constexpr unsigned int AkIterator_TypeDefinitionIndex = 33495;
