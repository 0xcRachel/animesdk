...
#define AKITERATOR_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x18BC90E0)
#define AKITERATOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18BC8FF0)
#define AKITERATOR_FINALIZE_OFFSET UNITYSDK_OFFSET(0x18BC9070)
#define AKITERATOR_GETCPTR_OFFSET UNITYSDK_OFFSET(0x18BC8EE0)
#define AKITERATOR_GETITEM_OFFSET UNITYSDK_OFFSET(0x18BC96B0)
#define AKITERATOR_GET_PITEM_OFFSET UNITYSDK_OFFSET(0x18BC93A0)
#define AKITERATOR_ISDIFFERENTFROM_OFFSET UNITYSDK_OFFSET(0x18BC98D0)
#define AKITERATOR_ISEQUALTO_OFFSET UNITYSDK_OFFSET(0x18BC97B0)
#define AKITERATOR_NEXTITER_OFFSET UNITYSDK_OFFSET(0x18BC94B0)
#define AKITERATOR_PREVITER_OFFSET UNITYSDK_OFFSET(0x18BC95B0)
#define AKITERATOR_SETCPTR_OFFSET UNITYSDK_OFFSET(0x18BC8F30)
#define AKITERATOR_SET_PITEM_OFFSET UNITYSDK_OFFSET(0x18BC9280)
#define AKITERATOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18BC99F0)
#define AKITERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x18BC8ED0)
