...
#define CLASS_2_8BBC140D9AC9B0C2_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11212240)
#define CLASS_2_8BBC140D9AC9B0C2_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11212280)
#define CLASS_2_8BBC140D9AC9B0C2_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x11212330)
#define CLASS_2_8BBC140D9AC9B0C2_TICK_OFFSET UNITYSDK_OFFSET(0x11212380)
#define CLASS_2_8BBC140D9AC9B0C2__CTOR_OFFSET UNITYSDK_OFFSET(0x11212230)

inline static constexpr unsigned int Class_2_8BBC140D9AC9B0C2_TypeDefinitionIndex = 42092;

class Class_2_8BBC140D9AC9B0C2 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::ShowMissionInfo* Field_2_0; // 0x18
