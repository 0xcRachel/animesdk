...
#define CLASS_1_8E5011686777C86C_DISPOSE_OFFSET UNITYSDK_OFFSET(0xE5E6A60)
#define CLASS_1_8E5011686777C86C_GETALLAPPLYLIST_OFFSET UNITYSDK_OFFSET(0xE5E56F0)
#define CLASS_1_8E5011686777C86C_GETALLFRIENDDATA_OFFSET UNITYSDK_OFFSET(0xE5E49C0)
#define CLASS_1_8E5011686777C86C_GETAPPLYLIST_OFFSET UNITYSDK_OFFSET(0xE5E5430)
#define CLASS_1_8E5011686777C86C_GETDEMANDCARDPIECELIST_OFFSET UNITYSDK_OFFSET(0xE5E4DD0)
#define CLASS_1_8E5011686777C86C_GETEXTRALCARDPIECESNAPSHOT_OFFSET UNITYSDK_OFFSET(0xE5DFA90)
#define CLASS_1_8E5011686777C86C_GETFREEAPPLYLIST_OFFSET UNITYSDK_OFFSET(0xE5E59D0)
#define CLASS_1_8E5011686777C86C_GETFRIENDDATA_OFFSET UNITYSDK_OFFSET(0xE5E4CB0)
#define CLASS_1_8E5011686777C86C_GETOFFERLISTWITHOUTCHECK_OFFSET UNITYSDK_OFFSET(0xE5E6000)
#define CLASS_1_8E5011686777C86C_GETOFFERLIST_OFFSET UNITYSDK_OFFSET(0xE5E5DA0)
#define CLASS_1_8E5011686777C86C_GETPERMISSIONTYPE_OFFSET UNITYSDK_OFFSET(0xE5E4970)
#define CLASS_1_8E5011686777C86C_GETPERSONALRANK_OFFSET UNITYSDK_OFFSET(0xE5E6360)
#define CLASS_1_8E5011686777C86C_GETPRESENTCARDPIECELIST_OFFSET UNITYSDK_OFFSET(0xE5E4FB0)
#define CLASS_1_8E5011686777C86C_GETPRESENTLISTWITHOUTCHECK_OFFSET UNITYSDK_OFFSET(0xE5E53A0)
#define CLASS_1_8E5011686777C86C_GETPRESENTLIST_OFFSET UNITYSDK_OFFSET(0xE5E5170)
#define CLASS_1_8E5011686777C86C_GETRANK_OFFSET UNITYSDK_OFFSET(0xE5E6140)
#define CLASS_1_8E5011686777C86C_GETTODAYAPPLYCOUNT_OFFSET UNITYSDK_OFFSET(0xE5E60C0)
#define CLASS_1_8E5011686777C86C_GETTODAYPRESENTCOUNT_OFFSET UNITYSDK_OFFSET(0xE5E6100)
#define CLASS_1_8E5011686777C86C_GETTOTALCARDPIECESNAPSHOT_OFFSET UNITYSDK_OFFSET(0xE5DFA20)
#define CLASS_1_8E5011686777C86C_METHOD_1_01EFA4CAA7BDD96D_OFFSET UNITYSDK_OFFSET(0xE5E3290)
#define CLASS_1_8E5011686777C86C_METHOD_1_097468641FDED14E_OFFSET UNITYSDK_OFFSET(0xE5E41E0)
#define CLASS_1_8E5011686777C86C_METHOD_1_13696A527CD9CA86_OFFSET UNITYSDK_OFFSET(0xE5E3450)
#define CLASS_1_8E5011686777C86C_METHOD_1_21F62A08D3150D01_OFFSET UNITYSDK_OFFSET(0xE5E1A60)
#define CLASS_1_8E5011686777C86C_METHOD_1_3B5C6D652C514B37_OFFSET UNITYSDK_OFFSET(0xE5E4830)
#define CLASS_1_8E5011686777C86C_METHOD_1_44215C0DEE24CEF9_OFFSET UNITYSDK_OFFSET(0xE5E63A0)
#define CLASS_1_8E5011686777C86C_METHOD_1_5AD578FCE9CF19D4_OFFSET UNITYSDK_OFFSET(0xE5DF9B0)
#define CLASS_1_8E5011686777C86C_METHOD_1_65EC817A848CC5A3_OFFSET UNITYSDK_OFFSET(0xE5E4AF0)
#define CLASS_1_8E5011686777C86C_METHOD_1_6815AD8D97959763_OFFSET UNITYSDK_OFFSET(0xE5E1370)
#define CLASS_1_8E5011686777C86C_METHOD_1_6BFEA84DA411C1A5_1_OFFSET UNITYSDK_OFFSET(0xE5E2600)
#define CLASS_1_8E5011686777C86C_METHOD_1_6BFEA84DA411C1A5_OFFSET UNITYSDK_OFFSET(0xE5E2370)
#define CLASS_1_8E5011686777C86C_METHOD_1_7B2415EF3B4401A0_OFFSET UNITYSDK_OFFSET(0xE5E5C90)
#define CLASS_1_8E5011686777C86C_METHOD_1_7DD84EAFF333A1E4_OFFSET UNITYSDK_OFFSET(0xE5E6A00)
#define CLASS_1_8E5011686777C86C_METHOD_1_8A295C6FC3A23A45_OFFSET UNITYSDK_OFFSET(0xE5E1750)
#define CLASS_1_8E5011686777C86C_METHOD_1_B20A72151139C4FB_OFFSET UNITYSDK_OFFSET(0xE5E1980)
#define CLASS_1_8E5011686777C86C_METHOD_1_B214F97C7AAA732F_OFFSET UNITYSDK_OFFSET(0xE5E3C30)
#define CLASS_1_8E5011686777C86C_METHOD_1_B61FF41D45EBDE24_OFFSET UNITYSDK_OFFSET(0xE5E4240)
#define CLASS_1_8E5011686777C86C_METHOD_1_B877181B6123B7F6_1_OFFSET UNITYSDK_OFFSET(0xE5E6600)
#define CLASS_1_8E5011686777C86C_METHOD_1_B877181B6123B7F6_2_OFFSET UNITYSDK_OFFSET(0xE5E6800)
#define CLASS_1_8E5011686777C86C_METHOD_1_B877181B6123B7F6_OFFSET UNITYSDK_OFFSET(0xE5E6400)
#define CLASS_1_8E5011686777C86C_METHOD_1_C88D7CA1372C568F_OFFSET UNITYSDK_OFFSET(0xE5E2890)
#define CLASS_1_8E5011686777C86C_METHOD_1_CCB4431A86AEC681_OFFSET UNITYSDK_OFFSET(0xE5DFB00)
#define CLASS_1_8E5011686777C86C_METHOD_1_DBAFB3822F104C31_OFFSET UNITYSDK_OFFSET(0xE5E3CE0)
#define CLASS_1_8E5011686777C86C_METHOD_1_E6A464C09590E175_OFFSET UNITYSDK_OFFSET(0xE5E0AA0)
#define CLASS_1_8E5011686777C86C_METHOD_1_F7097473EC9DE578_OFFSET UNITYSDK_OFFSET(0xE5E2940)
#define CLASS_1_8E5011686777C86C_METHOD_1_F8D1399F1CCCBB77_1_OFFSET UNITYSDK_OFFSET(0xE5E1270)
#define CLASS_1_8E5011686777C86C_METHOD_1_F8D1399F1CCCBB77_OFFSET UNITYSDK_OFFSET(0xE5E1180)
#define CLASS_1_8E5011686777C86C__CTOR_OFFSET UNITYSDK_OFFSET(0xE5DF680)
...
{
public:
	::System::Collections::Generic::Dictionary_2<::System::UInt64, ::RPG::Client::PlanetFesTradingCardOfferItem*>* Field_1_9; // 0x10
	::RPG::Client::Promises::Promise* Field_1_15; // 0x18
	::System::Collections::Generic::List_1<::RPG::Client::PlanetFesTradingCardApplyItem*>* Field_1_4; // 0x20
	::RPG::Client::PlanetFesRankDataItem* Field_1_7; // 0x28
	::System::Collections::Generic::List_1<::RPG::Client::PlanetFesRankDataItem*>* Field_1_6; // 0x30
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::PlanetFesTradingCardFriendsItem*>* Field_1_8; // 0x38
	::System::Collections::Generic::List_1<::Class_1_DE147B6E78BA2BC2*>* Field_1_5; // 0x40
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::PlanetFesTradingCardApplyItem*>* Field_1_3; // 0x48
	::RPG::Client::Promises::Promise* Field_1_18; // 0x50
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::UInt32>* Field_1_1; // 0x58
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::UInt32>* Field_1_0; // 0x60
	...
	::Enum_3_0A3761FE34514D6C_10 Field_1_2; // 0x88
	...
	::System::Void Method_1_F7097473EC9DE578(::Class_1_BB4B99DE4C2501EC_9* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_BB4B99DE4C2501EC_9*))((::PBYTE)hIl2Cpp + CLASS_1_8E5011686777C86C_METHOD_1_F7097473EC9DE578_OFFSET))(this, a1);
	}
