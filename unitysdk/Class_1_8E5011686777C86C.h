...
#define CLASS_1_8E5011686777C86C_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10A56AF0)
#define CLASS_1_8E5011686777C86C_GETALLAPPLYLIST_OFFSET UNITYSDK_OFFSET(0x10A55780)
#define CLASS_1_8E5011686777C86C_GETALLFRIENDDATA_OFFSET UNITYSDK_OFFSET(0x10A54A50)
#define CLASS_1_8E5011686777C86C_GETAPPLYLIST_OFFSET UNITYSDK_OFFSET(0x10A554C0)
#define CLASS_1_8E5011686777C86C_GETDEMANDCARDPIECELIST_OFFSET UNITYSDK_OFFSET(0x10A54E60)
#define CLASS_1_8E5011686777C86C_GETEXTRALCARDPIECESNAPSHOT_OFFSET UNITYSDK_OFFSET(0x10A4FB20)
#define CLASS_1_8E5011686777C86C_GETFREEAPPLYLIST_OFFSET UNITYSDK_OFFSET(0x10A55A60)
#define CLASS_1_8E5011686777C86C_GETFRIENDDATA_OFFSET UNITYSDK_OFFSET(0x10A54D40)
#define CLASS_1_8E5011686777C86C_GETOFFERLISTWITHOUTCHECK_OFFSET UNITYSDK_OFFSET(0x10A56090)
#define CLASS_1_8E5011686777C86C_GETOFFERLIST_OFFSET UNITYSDK_OFFSET(0x10A55E30)
#define CLASS_1_8E5011686777C86C_GETPERMISSIONTYPE_OFFSET UNITYSDK_OFFSET(0x10A54A10)
#define CLASS_1_8E5011686777C86C_GETPERSONALRANK_OFFSET UNITYSDK_OFFSET(0x10A563F0)
#define CLASS_1_8E5011686777C86C_GETPRESENTCARDPIECELIST_OFFSET UNITYSDK_OFFSET(0x10A55040)
#define CLASS_1_8E5011686777C86C_GETPRESENTLISTWITHOUTCHECK_OFFSET UNITYSDK_OFFSET(0x10A55430)
#define CLASS_1_8E5011686777C86C_GETPRESENTLIST_OFFSET UNITYSDK_OFFSET(0x10A55200)
#define CLASS_1_8E5011686777C86C_GETRANK_OFFSET UNITYSDK_OFFSET(0x10A561D0)
#define CLASS_1_8E5011686777C86C_GETTODAYAPPLYCOUNT_OFFSET UNITYSDK_OFFSET(0x10A56150)
#define CLASS_1_8E5011686777C86C_GETTODAYPRESENTCOUNT_OFFSET UNITYSDK_OFFSET(0x10A56190)
#define CLASS_1_8E5011686777C86C_GETTOTALCARDPIECESNAPSHOT_OFFSET UNITYSDK_OFFSET(0x10A4FAB0)
#define CLASS_1_8E5011686777C86C_METHOD_1_01EFA4CAA7BDD96D_OFFSET UNITYSDK_OFFSET(0x10A53320)
#define CLASS_1_8E5011686777C86C_METHOD_1_097468641FDED14E_OFFSET UNITYSDK_OFFSET(0x10A54280)
#define CLASS_1_8E5011686777C86C_METHOD_1_13696A527CD9CA86_OFFSET UNITYSDK_OFFSET(0x10A534F0)
#define CLASS_1_8E5011686777C86C_METHOD_1_21F62A08D3150D01_OFFSET UNITYSDK_OFFSET(0x10A51AF0)
#define CLASS_1_8E5011686777C86C_METHOD_1_3B5C6D652C514B37_OFFSET UNITYSDK_OFFSET(0x10A548D0)
#define CLASS_1_8E5011686777C86C_METHOD_1_44215C0DEE24CEF9_OFFSET UNITYSDK_OFFSET(0x10A56430)
#define CLASS_1_8E5011686777C86C_METHOD_1_5AD578FCE9CF19D4_OFFSET UNITYSDK_OFFSET(0x10A4FA40)
#define CLASS_1_8E5011686777C86C_METHOD_1_65EC817A848CC5A3_OFFSET UNITYSDK_OFFSET(0x10A54B80)
#define CLASS_1_8E5011686777C86C_METHOD_1_6815AD8D97959763_OFFSET UNITYSDK_OFFSET(0x10A51400)
#define CLASS_1_8E5011686777C86C_METHOD_1_6BFEA84DA411C1A5_1_OFFSET UNITYSDK_OFFSET(0x10A52690)
#define CLASS_1_8E5011686777C86C_METHOD_1_6BFEA84DA411C1A5_OFFSET UNITYSDK_OFFSET(0x10A52400)
#define CLASS_1_8E5011686777C86C_METHOD_1_7B2415EF3B4401A0_OFFSET UNITYSDK_OFFSET(0x10A55D20)
#define CLASS_1_8E5011686777C86C_METHOD_1_7DD84EAFF333A1E4_OFFSET UNITYSDK_OFFSET(0x10A56AA0)
#define CLASS_1_8E5011686777C86C_METHOD_1_8A295C6FC3A23A45_OFFSET UNITYSDK_OFFSET(0x10A517E0)
#define CLASS_1_8E5011686777C86C_METHOD_1_B20A72151139C4FB_OFFSET UNITYSDK_OFFSET(0x10A51A10)
#define CLASS_1_8E5011686777C86C_METHOD_1_B214F97C7AAA732F_OFFSET UNITYSDK_OFFSET(0x10A53CD0)
#define CLASS_1_8E5011686777C86C_METHOD_1_B61FF41D45EBDE24_OFFSET UNITYSDK_OFFSET(0x10A542E0)
#define CLASS_1_8E5011686777C86C_METHOD_1_B877181B6123B7F6_1_OFFSET UNITYSDK_OFFSET(0x10A56690)
#define CLASS_1_8E5011686777C86C_METHOD_1_B877181B6123B7F6_2_OFFSET UNITYSDK_OFFSET(0x10A568A0)
#define CLASS_1_8E5011686777C86C_METHOD_1_B877181B6123B7F6_OFFSET UNITYSDK_OFFSET(0x10A56490)
#define CLASS_1_8E5011686777C86C_METHOD_1_C88D7CA1372C568F_OFFSET UNITYSDK_OFFSET(0x10A52920)
#define CLASS_1_8E5011686777C86C_METHOD_1_CCB4431A86AEC681_OFFSET UNITYSDK_OFFSET(0x10A4FB90)
#define CLASS_1_8E5011686777C86C_METHOD_1_DBAFB3822F104C31_OFFSET UNITYSDK_OFFSET(0x10A53D80)
#define CLASS_1_8E5011686777C86C_METHOD_1_E6A464C09590E175_OFFSET UNITYSDK_OFFSET(0x10A50B30)
#define CLASS_1_8E5011686777C86C_METHOD_1_F7097473EC9DE578_OFFSET UNITYSDK_OFFSET(0x10A529D0)
#define CLASS_1_8E5011686777C86C_METHOD_1_F8D1399F1CCCBB77_1_OFFSET UNITYSDK_OFFSET(0x10A51300)
#define CLASS_1_8E5011686777C86C_METHOD_1_F8D1399F1CCCBB77_OFFSET UNITYSDK_OFFSET(0x10A51210)
#define CLASS_1_8E5011686777C86C__CTOR_OFFSET UNITYSDK_OFFSET(0x10A4F710)
...
{
public:
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::PlanetFesTradingCardApplyItem*>* Field_1_3; // 0x10
	...
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::UInt32>* Field_1_0; // 0x30
	::RPG::Client::Promises::Promise* Field_1_18; // 0x38
	::System::Collections::Generic::List_1<::Class_1_DE147B6E78BA2BC2*>* Field_1_5; // 0x40
	::System::Collections::Generic::Dictionary_2<::System::UInt64, ::RPG::Client::PlanetFesTradingCardOfferItem*>* Field_1_9; // 0x48
	::System::Collections::Generic::List_1<::RPG::Client::PlanetFesRankDataItem*>* Field_1_6; // 0x50
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::PlanetFesTradingCardFriendsItem*>* Field_1_8; // 0x58
	...
	::Enum_3_0A3761FE34514D6C_10 Field_1_2; // 0x74
