...
#define CLASS_2_03D383319883919D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15430120)
#define CLASS_2_03D383319883919D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1542FF20)
#define CLASS_2_03D383319883919D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x154300B0)
#define CLASS_2_03D383319883919D_TICK_OFFSET UNITYSDK_OFFSET(0x15430190)
#define CLASS_2_03D383319883919D__CTOR_OFFSET UNITYSDK_OFFSET(0x1542FE10)
...
public:
	...
	::RPG::GameCore::SwordTrainingCheckIfGameStarted* Field_2_1; // 0x20
