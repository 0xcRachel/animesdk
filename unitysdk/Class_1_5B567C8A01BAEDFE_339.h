...
#define CLASS_1_5B567C8A01BAEDFE_339_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A4933A0)
#define CLASS_1_5B567C8A01BAEDFE_339_CLONE_OFFSET UNITYSDK_OFFSET(0x1A493210)
#define CLASS_1_5B567C8A01BAEDFE_339_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A4932B0)
#define CLASS_1_5B567C8A01BAEDFE_339_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A493250)
#define CLASS_1_5B567C8A01BAEDFE_339_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A493300)
#define CLASS_1_5B567C8A01BAEDFE_339_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A4933F0)
#define CLASS_1_5B567C8A01BAEDFE_339_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A4933C0)
#define CLASS_1_5B567C8A01BAEDFE_339_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A493190)
#define CLASS_1_5B567C8A01BAEDFE_339_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A4931C0)
#define CLASS_1_5B567C8A01BAEDFE_339_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A493330)
#define CLASS_1_5B567C8A01BAEDFE_339_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A493390)
#define CLASS_1_5B567C8A01BAEDFE_339__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A493440)
#define CLASS_1_5B567C8A01BAEDFE_339__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A4931E0)
#define CLASS_1_5B567C8A01BAEDFE_339__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4931D0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_339*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_339_TypeDefinitionIndex)->GetStaticField(0x296C0);
	}
