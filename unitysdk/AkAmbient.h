...
#define AKAMBIENT_BUILDAKPOSITIONARRAY_OFFSET UNITYSDK_OFFSET(0x18B9D490)
#define AKAMBIENT_BUILDMULTIDIRECTIONARRAY_OFFSET UNITYSDK_OFFSET(0x18B9CBD0)
#define AKAMBIENT_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x18B9DE90)
#define AKAMBIENT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x18B9DBF0)
#define AKAMBIENT_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x18B9E5D0)
#define AKAMBIENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18B9C720)
#define AKAMBIENT_START_OFFSET UNITYSDK_OFFSET(0x18B9D140)
#define AKAMBIENT__CCTOR_OFFSET UNITYSDK_OFFSET(0x18B9EC20)
#define AKAMBIENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18B9EAE0)
#define AKAMBIENT___IFIXBASEPROXY_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x18B9ED70)
#define AKAMBIENT___IFIXBASEPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18B9ECC0)
#define AKAMBIENT___IFIXBASEPROXY_START_OFFSET UNITYSDK_OFFSET(0x18B9ED60)
...
public:
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::AkMultiPosEvent*>**)Il2CppClass::FromTypeDefinitionIndex(AkAmbient_TypeDefinitionIndex)->GetStaticField(0x28530);
	}
