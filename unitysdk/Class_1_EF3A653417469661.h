...
#define CLASS_1_EF3A653417469661_EXECUTE_OFFSET UNITYSDK_OFFSET(0x171945C0)
#define CLASS_1_EF3A653417469661_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x17193870)
#define CLASS_1_EF3A653417469661_METHOD_1_00DC6C482249EA10_OFFSET UNITYSDK_OFFSET(0x17194DD0)
#define CLASS_1_EF3A653417469661_METHOD_1_01509228E3A9577B_OFFSET UNITYSDK_OFFSET(0x17194280)
#define CLASS_1_EF3A653417469661_METHOD_1_0BCA929F38D4D7DB_OFFSET UNITYSDK_OFFSET(0x17195860)
#define CLASS_1_EF3A653417469661_METHOD_1_125126BF7ACBDD51_OFFSET UNITYSDK_OFFSET(0x17192150)
#define CLASS_1_EF3A653417469661_METHOD_1_1615E74BDA0D0348_OFFSET UNITYSDK_OFFSET(0x17193330)
#define CLASS_1_EF3A653417469661_METHOD_1_168CDBBDB08BE45E_OFFSET UNITYSDK_OFFSET(0x17193560)
#define CLASS_1_EF3A653417469661_METHOD_1_2416EE8102DF21CF_OFFSET UNITYSDK_OFFSET(0x17192FC0)
#define CLASS_1_EF3A653417469661_METHOD_1_2DC2C8C0FD03A63B_OFFSET UNITYSDK_OFFSET(0x171922E0)
#define CLASS_1_EF3A653417469661_METHOD_1_370656FAA772EE39_OFFSET UNITYSDK_OFFSET(0x17195CB0)
#define CLASS_1_EF3A653417469661_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x171953E0)
#define CLASS_1_EF3A653417469661_METHOD_1_3956F98173A4FAEA_OFFSET UNITYSDK_OFFSET(0x17195900)
#define CLASS_1_EF3A653417469661_METHOD_1_3A2C43EC5E188AEB_OFFSET UNITYSDK_OFFSET(0x17195420)
#define CLASS_1_EF3A653417469661_METHOD_1_48CB2A397A1C56C8_OFFSET UNITYSDK_OFFSET(0x171955F0)
#define CLASS_1_EF3A653417469661_METHOD_1_8714CF4AE9195CA2_OFFSET UNITYSDK_OFFSET(0x17193E40)
#define CLASS_1_EF3A653417469661_METHOD_1_94CBD0C21A609187_OFFSET UNITYSDK_OFFSET(0x17192370)
#define CLASS_1_EF3A653417469661_METHOD_1_C75A94AFCA1341AB_OFFSET UNITYSDK_OFFSET(0x171932B0)
#define CLASS_1_EF3A653417469661_METHOD_1_CD64FADAE3A9747A_OFFSET UNITYSDK_OFFSET(0x17193670)
#define CLASS_1_EF3A653417469661_METHOD_1_DC8592C913491D4B_OFFSET UNITYSDK_OFFSET(0x17194020)
#define CLASS_1_EF3A653417469661_METHOD_1_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0x171944F0)
#define CLASS_1_EF3A653417469661_METHOD_1_FC15BAFC5717F4C6_OFFSET UNITYSDK_OFFSET(0x17192AB0)
#define CLASS_1_EF3A653417469661_TEARDOWN_OFFSET UNITYSDK_OFFSET(0x171950C0)
#define CLASS_1_EF3A653417469661__CCTOR_OFFSET UNITYSDK_OFFSET(0x17195F20)
#define CLASS_1_EF3A653417469661__CTOR_OFFSET UNITYSDK_OFFSET(0x17191D50)
#define CLASS_1_EF3A653417469661__EXECUTE_B__13_0_OFFSET UNITYSDK_OFFSET(0x17195F80)
#define CLASS_1_EF3A653417469661___ONSHOWRAREREWARDHINTDIALOG_B__12_0_OFFSET UNITYSDK_OFFSET(0x17195F60)

inline static constexpr unsigned int Class_1_EF3A653417469661_TypeDefinitionIndex = 71309;
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_EF3A653417469661_TypeDefinitionIndex)->GetStaticField(0x5B0D0);
	}
	::Class_1_2CDF619C23140440* Field_1_1; // 0x10
	::Entitas::IGroup_1<::Class_2_B8E38BF47138A2E5*>* Field_1_2; // 0x18
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_2_B8E38BF47138A2E5*>* Field_1_3; // 0x20
	::System::Collections::Generic::Dictionary_2<::System::Int32, ::Class_1_EF3A653417469661_Class_3_C0D189AA62C8FC80_1*>* Field_1_4; // 0x28
	::System::Collections::Generic::Dictionary_2<::Class_2_B8E38BF47138A2E5*, ::RPG::Client::LittleGame::FourRotateVoxel::FourRotateVoxelAnimalAttachBillboardData*>* Field_1_5; // 0x30
	::System::Collections::Generic::List_1<::Class_2_B8E38BF47138A2E5*>* Field_1_6; // 0x38
	::RPG::GameCore::FourRotateVoxelPortalConfig* Field_1_7; // 0x40
	::Entitas::IGroup_1<::Class_2_B8E38BF47138A2E5*>* Field_1_8; // 0x48
	::RPG::Client::LittleGame::FourRotateVoxel::FourRotateVoxelGlobalData* Field_1_9; // 0x50
	...
	::Class_3_D6E9A038FA23103A* Field_1_11; // 0x60
