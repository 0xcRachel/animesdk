...
#define CLASS_2_E0A6B9E6B06D2795_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10C073F0)
#define CLASS_2_E0A6B9E6B06D2795_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10C072F0)
#define CLASS_2_E0A6B9E6B06D2795_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10C07340)
#define CLASS_2_E0A6B9E6B06D2795_TICK_OFFSET UNITYSDK_OFFSET(0x10C07390)
#define CLASS_2_E0A6B9E6B06D2795__CTOR_OFFSET UNITYSDK_OFFSET(0x10C072E0)

inline static constexpr unsigned int Class_2_E0A6B9E6B06D2795_TypeDefinitionIndex = 41870;
