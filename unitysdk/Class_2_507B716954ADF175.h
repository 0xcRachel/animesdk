...
#define CLASS_2_507B716954ADF175_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x115A0230)
#define CLASS_2_507B716954ADF175_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x115A0520)
#define CLASS_2_507B716954ADF175_GET_PROGRESSCHANGEANIMENDPROMISE_OFFSET UNITYSDK_OFFSET(0x1159FF90)
#define CLASS_2_507B716954ADF175_GET_SCEPTERDATA_OFFSET UNITYSDK_OFFSET(0x1159FDC0)
#define CLASS_2_507B716954ADF175_METHOD_2_1C6AD2DA62FB6EB1_OFFSET UNITYSDK_OFFSET(0x1159F230)
#define CLASS_2_507B716954ADF175_METHOD_2_458DAEAB6170C584_OFFSET UNITYSDK_OFFSET(0x1159F910)
#define CLASS_2_507B716954ADF175_METHOD_2_479759059E440327_OFFSET UNITYSDK_OFFSET(0x1159FEB0)
#define CLASS_2_507B716954ADF175_METHOD_2_480EACF8B499351F_OFFSET UNITYSDK_OFFSET(0x1159FDE0)
#define CLASS_2_507B716954ADF175_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x115A0A60)
#define CLASS_2_507B716954ADF175_METHOD_2_6774EDC23D24BE2B_OFFSET UNITYSDK_OFFSET(0x1159F7E0)
#define CLASS_2_507B716954ADF175_METHOD_2_7AD1599C042263A6_OFFSET UNITYSDK_OFFSET(0x1159F350)
#define CLASS_2_507B716954ADF175_METHOD_2_7BBBC241D67B44B9_OFFSET UNITYSDK_OFFSET(0x1159F870)
#define CLASS_2_507B716954ADF175_METHOD_2_A27D06F9481FAFDB_1_OFFSET UNITYSDK_OFFSET(0x115A0170)
#define CLASS_2_507B716954ADF175_METHOD_2_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0x115A00B0)
#define CLASS_2_507B716954ADF175_METHOD_2_DA4B4F9A7740A91B_OFFSET UNITYSDK_OFFSET(0x1159F5B0)
#define CLASS_2_507B716954ADF175_METHOD_2_DF2A78D8DB25ED05_1_OFFSET UNITYSDK_OFFSET(0x115A0050)
#define CLASS_2_507B716954ADF175_METHOD_2_DF2A78D8DB25ED05_OFFSET UNITYSDK_OFFSET(0x1159FE50)
#define CLASS_2_507B716954ADF175_METHOD_2_E9A5CB8132825E13_OFFSET UNITYSDK_OFFSET(0x1159FFB0)
#define CLASS_2_507B716954ADF175_METHOD_2_F867677DC9D486C7_OFFSET UNITYSDK_OFFSET(0x1159FAA0)
#define CLASS_2_507B716954ADF175_SET_PROGRESSCHANGEANIMENDPROMISE_OFFSET UNITYSDK_OFFSET(0x1159FFA0)
#define CLASS_2_507B716954ADF175_SET_SCEPTERDATA_OFFSET UNITYSDK_OFFSET(0x1159FDD0)
#define CLASS_2_507B716954ADF175__CTOR_OFFSET UNITYSDK_OFFSET(0x115A07E0)
#define CLASS_2_507B716954ADF175__ONBIND_OFFSET UNITYSDK_OFFSET(0x1159EC70)
#define CLASS_2_507B716954ADF175___IFIXBASEPROXY_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x115A0AC0)
#define CLASS_2_507B716954ADF175___IFIXBASEPROXY_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x115A0B20)
#define CLASS_2_507B716954ADF175___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0x115A0A00)
#define CLASS_2_507B716954ADF175___PLAYSPCHANGEANIM_B__22_0_OFFSET UNITYSDK_OFFSET(0x115A0810)

inline static constexpr unsigned int Class_2_507B716954ADF175_TypeDefinitionIndex = 59226;
...
public:
	...
	::RPG::Client::RPGAnimationEvent* Field_2_10; // 0x78
	::UnityEngine::Transform* Field_2_0; // 0x80
	::RPG::Client::UIValueChangeAnimation* Field_2_9; // 0x88
	...
	::RPG::Client::Promises::Promise* Field_2_16; // 0xB0
	::UnityEngine::Coroutine* Field_2_15; // 0xB8
	::UnityEngine::Transform* Field_2_11; // 0xC0
	::UnityEngine::Animation* Field_2_7; // 0xC8
	::RPG::Client::RogueMagicScepterDataItem* _ScepterData_k__BackingField; // 0xD0
	::RPG::Client::Promises::Promise* _ProgressChangeAnimEndPromise_k__BackingField; // 0xD8
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_2_507B716954ADF175_METHOD_2_458DAEAB6170C584_OFFSET))(this);
	}
