...
#define CLASS_2_507B716954ADF175_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xD1E6640)
#define CLASS_2_507B716954ADF175_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xD1E68F0)
#define CLASS_2_507B716954ADF175_GET_PROGRESSCHANGEANIMENDPROMISE_OFFSET UNITYSDK_OFFSET(0xD1E63A0)
#define CLASS_2_507B716954ADF175_GET_SCEPTERDATA_OFFSET UNITYSDK_OFFSET(0xD1E61D0)
#define CLASS_2_507B716954ADF175_METHOD_2_1C6AD2DA62FB6EB1_OFFSET UNITYSDK_OFFSET(0xD1E5620)
#define CLASS_2_507B716954ADF175_METHOD_2_479759059E440327_OFFSET UNITYSDK_OFFSET(0xD1E62C0)
#define CLASS_2_507B716954ADF175_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xD1E6DE0)
#define CLASS_2_507B716954ADF175_METHOD_2_6774EDC23D24BE2B_OFFSET UNITYSDK_OFFSET(0xD1E5BD0)
#define CLASS_2_507B716954ADF175_METHOD_2_7AD1599C042263A6_OFFSET UNITYSDK_OFFSET(0xD1E5740)
#define CLASS_2_507B716954ADF175_METHOD_2_7BBBC241D67B44B9_OFFSET UNITYSDK_OFFSET(0xD1E5C60)
#define CLASS_2_507B716954ADF175_METHOD_2_A27D06F9481FAFDB_1_OFFSET UNITYSDK_OFFSET(0xD1E6580)
#define CLASS_2_507B716954ADF175_METHOD_2_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0xD1E64C0)
#define CLASS_2_507B716954ADF175_METHOD_2_C706B1EC6D2E1C64_OFFSET UNITYSDK_OFFSET(0xD1E5D00)
#define CLASS_2_507B716954ADF175_METHOD_2_DA4B4F9A7740A91B_OFFSET UNITYSDK_OFFSET(0xD1E59A0)
#define CLASS_2_507B716954ADF175_METHOD_2_DF2A78D8DB25ED05_1_OFFSET UNITYSDK_OFFSET(0xD1E6460)
#define CLASS_2_507B716954ADF175_METHOD_2_DF2A78D8DB25ED05_OFFSET UNITYSDK_OFFSET(0xD1E6260)
#define CLASS_2_507B716954ADF175_METHOD_2_E9A5CB8132825E13_OFFSET UNITYSDK_OFFSET(0xD1E63C0)
#define CLASS_2_507B716954ADF175_METHOD_2_ED5FC1D8B47FC436_OFFSET UNITYSDK_OFFSET(0xD1E61F0)
#define CLASS_2_507B716954ADF175_METHOD_2_F867677DC9D486C7_OFFSET UNITYSDK_OFFSET(0xD1E5EC0)
#define CLASS_2_507B716954ADF175_SET_PROGRESSCHANGEANIMENDPROMISE_OFFSET UNITYSDK_OFFSET(0xD1E63B0)
#define CLASS_2_507B716954ADF175_SET_SCEPTERDATA_OFFSET UNITYSDK_OFFSET(0xD1E61E0)
#define CLASS_2_507B716954ADF175__CTOR_OFFSET UNITYSDK_OFFSET(0xD1E6B60)
#define CLASS_2_507B716954ADF175__ONBIND_OFFSET UNITYSDK_OFFSET(0xD1E52F0)
#define CLASS_2_507B716954ADF175___IFIXBASEPROXY_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xD1E6E40)
#define CLASS_2_507B716954ADF175___IFIXBASEPROXY_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xD1E6EA0)
#define CLASS_2_507B716954ADF175___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0xD1E6D80)
#define CLASS_2_507B716954ADF175___PLAYSPCHANGEANIM_B__22_0_OFFSET UNITYSDK_OFFSET(0xD1E6B90)

inline static constexpr unsigned int Class_2_507B716954ADF175_TypeDefinitionIndex = 66619;

class Class_2_507B716954ADF175 : public ::Class_1_CA217ABF4E3B4F3F
{
public:
	::RPG::Client::RPGAnimationEvent* Field_2_10; // 0x60
	::RPG::Client::Promises::Promise* _ProgressChangeAnimEndPromise_k__BackingField; // 0x68
	::RPG::Client::Promises::Promise* Field_2_16; // 0x70
	::RPG::Client::UIValueChangeAnimation* Field_2_9; // 0x78
	::UnityEngine::UI::Image* Field_2_4; // 0x80
	::UnityEngine::Coroutine* Field_2_15; // 0x88
	::RPG::Client::UIValueChangeAnimation* Field_2_8; // 0x90
	::UnityEngine::Transform* Field_2_0; // 0x98
	::UnityEngine::Transform* Field_2_6; // 0xA0
	::UnityEngine::Animation* Field_2_7; // 0xA8
	...
	::RPG::Client::RogueMagicScepterDataItem* _ScepterData_k__BackingField; // 0xD8
