...
#define MONO_NET_SECURITY_ASYNCPROTOCOLREQUEST__INNERREAD_D__25_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3868E70)
#define MONO_NET_SECURITY_ASYNCPROTOCOLREQUEST__INNERREAD_D__25_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x35CA000)
...
namespace Mono::Net::Security
{
	...
	struct alignas(8) AsyncProtocolRequest__InnerRead_d__25
	{
		...
		::System::Int32 _requestedSize_5__1; // 0x54
