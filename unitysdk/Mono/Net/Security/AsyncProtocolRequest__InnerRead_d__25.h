...
#define MONO_NET_SECURITY_ASYNCPROTOCOLREQUEST__INNERREAD_D__25_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x2031AE0)
#define MONO_NET_SECURITY_ASYNCPROTOCOLREQUEST__INNERREAD_D__25_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0xCDD10)

namespace Mono::Net::Security
{
	inline static constexpr unsigned int AsyncProtocolRequest__InnerRead_d__25_TypeDefinitionIndex = 2412;
	...
	struct alignas(8) AsyncProtocolRequest__InnerRead_d__25
	{
		...
		::System::Nullable_1<::System::Int32> _totalRead_5__2; // 0x48
		::System::Int32 _requestedSize_5__1; // 0x50
