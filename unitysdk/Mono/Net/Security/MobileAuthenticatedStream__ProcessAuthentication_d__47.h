...
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM__PROCESSAUTHENTICATION_D__47_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x2107C90)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM__PROCESSAUTHENTICATION_D__47_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0xC5FF20)
...
namespace Mono::Net::Security
{
	...
	struct alignas(8) MobileAuthenticatedStream__ProcessAuthentication_d__47
	{
		...
		::System::Boolean serverMode; // 0x5D
		::System::Boolean clientCertRequired; // 0x5E
