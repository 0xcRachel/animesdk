...
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM__PROCESSAUTHENTICATION_D__47_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x22CB670)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM__PROCESSAUTHENTICATION_D__47_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x22CB630)
...
namespace Mono::Net::Security
{
	...
	struct alignas(8) MobileAuthenticatedStream__ProcessAuthentication_d__47
	{
		...
		::System::Boolean clientCertRequired; // 0x5C
		::System::Boolean runSynchronously; // 0x5D
