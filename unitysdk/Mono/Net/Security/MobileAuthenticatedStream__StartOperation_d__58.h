...
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM__STARTOPERATION_D__58_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x2107CA0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM__STARTOPERATION_D__58_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2107CB0)
...
namespace Mono::Net::Security
{
	...
	struct alignas(8) MobileAuthenticatedStream__StartOperation_d__58
	{
		...
		::Mono::Net::Security::AsyncProtocolRequest* asyncRequest; // 0x30
