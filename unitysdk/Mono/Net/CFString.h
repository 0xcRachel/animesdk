...
#define MONO_NET_CFSTRING_ASSTRING_OFFSET UNITYSDK_OFFSET(0x17E42E50)
#define MONO_NET_CFSTRING_CFSTRINGCREATEWITHCHARACTERS_OFFSET UNITYSDK_OFFSET(0x17E43A30)
#define MONO_NET_CFSTRING_CFSTRINGGETCHARACTERSPTR_OFFSET UNITYSDK_OFFSET(0x17E43B40)
#define MONO_NET_CFSTRING_CFSTRINGGETCHARACTERS_OFFSET UNITYSDK_OFFSET(0x17E43BC0)
#define MONO_NET_CFSTRING_CFSTRINGGETLENGTH_OFFSET UNITYSDK_OFFSET(0x17E43AC0)
#define MONO_NET_CFSTRING_CREATE_OFFSET UNITYSDK_OFFSET(0x17E3F070)
#define MONO_NET_CFSTRING_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17E43C60)
#define MONO_NET_CFSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x17E439A0)

namespace Mono::Net
{
	inline static constexpr unsigned int CFString_TypeDefinitionIndex = 2393;
