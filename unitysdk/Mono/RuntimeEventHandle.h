...
#define MONO_RUNTIMEEVENTHANDLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x225E4D0)
#define MONO_RUNTIMEEVENTHANDLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x608A20)
#define MONO_RUNTIMEEVENTHANDLE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x5078B0)
#define MONO_RUNTIMEEVENTHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x6163B0)
