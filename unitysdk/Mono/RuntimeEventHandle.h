...
#define MONO_RUNTIMEEVENTHANDLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x3755540)
#define MONO_RUNTIMEEVENTHANDLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x72BBF0)
#define MONO_RUNTIMEEVENTHANDLE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x66AF90)
#define MONO_RUNTIMEEVENTHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x66AF20)
