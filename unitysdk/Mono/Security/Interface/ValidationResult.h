...
#define MONO_SECURITY_INTERFACE_VALIDATIONRESULT_GET_TRUSTED_OFFSET UNITYSDK_OFFSET(0x194111D0)
#define MONO_SECURITY_INTERFACE_VALIDATIONRESULT_GET_USERDENIED_OFFSET UNITYSDK_OFFSET(0x194111E0)
#define MONO_SECURITY_INTERFACE_VALIDATIONRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x194111B0)
...
namespace Mono::Security::Interface
{
	...
	public:
		...
		::System::Boolean user_denied; // 0x1C
		::System::Boolean trusted; // 0x1D
