...
#define MONO_SECURITY_X509_X509CERTIFICATECOLLECTION_X509CERTIFICATEENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x15A99D90)
#define MONO_SECURITY_X509_X509CERTIFICATECOLLECTION_X509CERTIFICATEENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x15A9A270)
#define MONO_SECURITY_X509_X509CERTIFICATECOLLECTION_X509CERTIFICATEENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x15AA46D0)
#define MONO_SECURITY_X509_X509CERTIFICATECOLLECTION_X509CERTIFICATEENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x15AA4780)
#define MONO_SECURITY_X509_X509CERTIFICATECOLLECTION_X509CERTIFICATEENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x15AA4830)
#define MONO_SECURITY_X509_X509CERTIFICATECOLLECTION_X509CERTIFICATEENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x15AA4550)

namespace Mono::Security::X509
{
	inline static constexpr unsigned int X509CertificateCollection_X509CertificateEnumerator_TypeDefinitionIndex = 2252;
