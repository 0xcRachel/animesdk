...
#define CLASS_3_F4E8621A4C671A78_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10AFA400)
#define CLASS_3_F4E8621A4C671A78_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10AFA440)
#define CLASS_3_F4E8621A4C671A78_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10AFA530)
#define CLASS_3_F4E8621A4C671A78_TICK_OFFSET UNITYSDK_OFFSET(0x10AFA580)
#define CLASS_3_F4E8621A4C671A78__CTOR_OFFSET UNITYSDK_OFFSET(0x10AFA3D0)
#define CLASS_3_F4E8621A4C671A78___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10AFA5E0)
#define CLASS_3_F4E8621A4C671A78___IFIXBASEPROXY_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10AFA620)
#define CLASS_3_F4E8621A4C671A78___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x10AFA670)

inline static constexpr unsigned int Class_3_F4E8621A4C671A78_TypeDefinitionIndex = 41714;

class Class_3_F4E8621A4C671A78 : public ::RPG::GameCore::ImmediateTaskBase_1<::Class_3_85CDC97563BA896D*>
{
public:
	::Class_3_85CDC97563BA896D* Field_3_1; // 0x28
