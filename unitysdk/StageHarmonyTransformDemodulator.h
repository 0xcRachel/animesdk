...
#define STAGEHARMONYTRANSFORMDEMODULATOR_METHOD_3_4BF7DA9CA52F7891_OFFSET UNITYSDK_OFFSET(0xA6A4440)
#define STAGEHARMONYTRANSFORMDEMODULATOR_METHOD_3_F4B1CC0F7E08D926_OFFSET UNITYSDK_OFFSET(0xA6A4760)
#define STAGEHARMONYTRANSFORMDEMODULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xA6A47B0)

inline static constexpr unsigned int StageHarmonyTransformDemodulator_TypeDefinitionIndex = 37427;
