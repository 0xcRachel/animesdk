...
#define CLASS_2_57DB7853174FF319_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10CD7F00)
#define CLASS_2_57DB7853174FF319_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x10CD84C0)
#define CLASS_2_57DB7853174FF319_ONFINISHIMMEDIATELYINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x10CD8440)
#define CLASS_2_57DB7853174FF319_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10CD7F40)
#define CLASS_2_57DB7853174FF319_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10CD8390)
#define CLASS_2_57DB7853174FF319_TICK_OFFSET UNITYSDK_OFFSET(0x10CD83E0)
#define CLASS_2_57DB7853174FF319__CTOR_OFFSET UNITYSDK_OFFSET(0x10CD7EF0)

inline static constexpr unsigned int Class_2_57DB7853174FF319_TypeDefinitionIndex = 46287;

class Class_2_57DB7853174FF319 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::ShowReading* Field_2_0; // 0x20
