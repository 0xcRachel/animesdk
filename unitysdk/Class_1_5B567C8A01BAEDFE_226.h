...
#define CLASS_1_5B567C8A01BAEDFE_226_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A25C950)
#define CLASS_1_5B567C8A01BAEDFE_226_CLONE_OFFSET UNITYSDK_OFFSET(0x1A25C7C0)
#define CLASS_1_5B567C8A01BAEDFE_226_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A25C860)
#define CLASS_1_5B567C8A01BAEDFE_226_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A25C800)
#define CLASS_1_5B567C8A01BAEDFE_226_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A25C8B0)
#define CLASS_1_5B567C8A01BAEDFE_226_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A25C9A0)
#define CLASS_1_5B567C8A01BAEDFE_226_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A25C970)
#define CLASS_1_5B567C8A01BAEDFE_226_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A25C740)
#define CLASS_1_5B567C8A01BAEDFE_226_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A25C770)
#define CLASS_1_5B567C8A01BAEDFE_226_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A25C8E0)
#define CLASS_1_5B567C8A01BAEDFE_226_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A25C940)
#define CLASS_1_5B567C8A01BAEDFE_226__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A25C9F0)
#define CLASS_1_5B567C8A01BAEDFE_226__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A25C790)
#define CLASS_1_5B567C8A01BAEDFE_226__CTOR_OFFSET UNITYSDK_OFFSET(0x1A25C780)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_226*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_226_TypeDefinitionIndex)->GetStaticField(0x17380);
	}
