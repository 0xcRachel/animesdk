...
#define INCONTROL_BINDINGLISTENOPTIONS_CALLONBINDINGADDED_OFFSET UNITYSDK_OFFSET(0x16401B60)
#define INCONTROL_BINDINGLISTENOPTIONS_CALLONBINDINGENDED_OFFSET UNITYSDK_OFFSET(0x16401BB0)
#define INCONTROL_BINDINGLISTENOPTIONS_CALLONBINDINGFOUND_OFFSET UNITYSDK_OFFSET(0x16401B40)
#define INCONTROL_BINDINGLISTENOPTIONS_CALLONBINDINGREJECTED_OFFSET UNITYSDK_OFFSET(0x16401B80)
#define INCONTROL_BINDINGLISTENOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x16401BD0)
...
namespace InControl
{
	...
	public:
		...
		::System::Boolean IncludeMouseButtons; // 0x38
		::System::Boolean IncludeKeys; // 0x39
		::System::Boolean IncludeUnknownControllers; // 0x3A
		::System::Boolean IncludeControllers; // 0x3B
		::System::Boolean IncludeNonStandardControls; // 0x3C
		...
		::System::Boolean UnsetDuplicateBindingsOnSet; // 0x46
		::System::Boolean IncludeMouseScrollWheel; // 0x47
