...
#define INCONTROL_TOUCHINPUTDEVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x155075B0)

namespace InControl
{
	inline static constexpr unsigned int TouchInputDevice_TypeDefinitionIndex = 30596;
