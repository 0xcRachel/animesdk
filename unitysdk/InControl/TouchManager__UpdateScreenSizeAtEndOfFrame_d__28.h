...
#define INCONTROL_TOUCHMANAGER__UPDATESCREENSIZEATENDOFFRAME_D__28_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1550B1D0)
#define INCONTROL_TOUCHMANAGER__UPDATESCREENSIZEATENDOFFRAME_D__28_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1550B2C0)
#define INCONTROL_TOUCHMANAGER__UPDATESCREENSIZEATENDOFFRAME_D__28_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1550B320)
#define INCONTROL_TOUCHMANAGER__UPDATESCREENSIZEATENDOFFRAME_D__28_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1550B2D0)
#define INCONTROL_TOUCHMANAGER__UPDATESCREENSIZEATENDOFFRAME_D__28_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1550B1C0)
#define INCONTROL_TOUCHMANAGER__UPDATESCREENSIZEATENDOFFRAME_D__28__CTOR_OFFSET UNITYSDK_OFFSET(0x155089C0)

namespace InControl
{
	inline static constexpr unsigned int TouchManager__UpdateScreenSizeAtEndOfFrame_d__28_TypeDefinitionIndex = 30599;
