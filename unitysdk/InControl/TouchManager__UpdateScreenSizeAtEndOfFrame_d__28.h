...
#define INCONTROL_TOUCHMANAGER__UPDATESCREENSIZEATENDOFFRAME_D__28_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x15C24FC0)
#define INCONTROL_TOUCHMANAGER__UPDATESCREENSIZEATENDOFFRAME_D__28_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x15C250B0)
#define INCONTROL_TOUCHMANAGER__UPDATESCREENSIZEATENDOFFRAME_D__28_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x15C25110)
#define INCONTROL_TOUCHMANAGER__UPDATESCREENSIZEATENDOFFRAME_D__28_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x15C250C0)
#define INCONTROL_TOUCHMANAGER__UPDATESCREENSIZEATENDOFFRAME_D__28_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15C24FB0)
#define INCONTROL_TOUCHMANAGER__UPDATESCREENSIZEATENDOFFRAME_D__28__CTOR_OFFSET UNITYSDK_OFFSET(0x15C227A0)
