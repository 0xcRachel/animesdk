...
#define INCONTROL_OPTIONALFLOAT_APPROXIMATELYEQUALS_OFFSET UNITYSDK_OFFSET(0x21777B0)
#define INCONTROL_OPTIONALFLOAT_CLEAR_OFFSET UNITYSDK_OFFSET(0x2177600)
#define INCONTROL_OPTIONALFLOAT_COMBINEHASHCODES_OFFSET UNITYSDK_OFFSET(0x13BCBB60)
#define INCONTROL_OPTIONALFLOAT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x2177690)
#define INCONTROL_OPTIONALFLOAT_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x21776E0)
#define INCONTROL_OPTIONALFLOAT_EQUALS_OFFSET UNITYSDK_OFFSET(0x2177630)
#define INCONTROL_OPTIONALFLOAT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2177720)
#define INCONTROL_OPTIONALFLOAT_GETVALUEORDEFAULT_OFFSET UNITYSDK_OFFSET(0x2177610)
#define INCONTROL_OPTIONALFLOAT_GETVALUEORZERO_OFFSET UNITYSDK_OFFSET(0x2177620)
#define INCONTROL_OPTIONALFLOAT_GET_HASNOVALUE_OFFSET UNITYSDK_OFFSET(0x2177580)
#define INCONTROL_OPTIONALFLOAT_GET_HASVALUE_OFFSET UNITYSDK_OFFSET(0x608B40)
#define INCONTROL_OPTIONALFLOAT_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x2177590)
#define INCONTROL_OPTIONALFLOAT_ISAPPROXIMATELYEQUAL_OFFSET UNITYSDK_OFFSET(0x13BCB9D0)
#define INCONTROL_OPTIONALFLOAT_OP_EQUALITY_1_OFFSET UNITYSDK_OFFSET(0x13BCBAE0)
#define INCONTROL_OPTIONALFLOAT_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x13BCBA40)
#define INCONTROL_OPTIONALFLOAT_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x13BCBC10)
#define INCONTROL_OPTIONALFLOAT_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x13BCBC00)
#define INCONTROL_OPTIONALFLOAT_OP_INEQUALITY_1_OFFSET UNITYSDK_OFFSET(0x13BCBB20)
#define INCONTROL_OPTIONALFLOAT_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x13BCBA90)
#define INCONTROL_OPTIONALFLOAT_SETVALUE_OFFSET UNITYSDK_OFFSET(0x2177570)
#define INCONTROL_OPTIONALFLOAT_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x2177570)
#define INCONTROL_OPTIONALFLOAT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x2177750)
#define INCONTROL_OPTIONALFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x2177570)
