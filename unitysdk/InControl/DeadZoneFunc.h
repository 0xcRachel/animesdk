...
#define INCONTROL_DEADZONEFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15460E80)
#define INCONTROL_DEADZONEFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15460F30)
#define INCONTROL_DEADZONEFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x15460980)
#define INCONTROL_DEADZONEFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x15460960)

namespace InControl
{
	inline static constexpr unsigned int DeadZoneFunc_TypeDefinitionIndex = 30526;
