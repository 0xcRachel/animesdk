...
#define INCONTROL_NATIVE_GETANALOGGLYPHNAME_OFFSET UNITYSDK_OFFSET(0x15B954F0)
#define INCONTROL_NATIVE_GETBUTTONGLYPHNAME_OFFSET UNITYSDK_OFFSET(0x15B95580)
#define INCONTROL_NATIVE_GETDEVICEEVENTS_OFFSET UNITYSDK_OFFSET(0x15B95230)
#define INCONTROL_NATIVE_GETDEVICEINFO_OFFSET UNITYSDK_OFFSET(0x15B95060)
#define INCONTROL_NATIVE_GETDEVICESTATE_OFFSET UNITYSDK_OFFSET(0x15B951A0)
#define INCONTROL_NATIVE_GETVERSIONINFO_OFFSET UNITYSDK_OFFSET(0x15B94FE0)
#define INCONTROL_NATIVE_INIT_OFFSET UNITYSDK_OFFSET(0x15B94ED0)
#define INCONTROL_NATIVE_SETHAPTICSTATE_OFFSET UNITYSDK_OFFSET(0x15B952B0)
#define INCONTROL_NATIVE_SETLIGHTCOLOR_OFFSET UNITYSDK_OFFSET(0x15B953D0)
#define INCONTROL_NATIVE_SETLIGHTFLASH_OFFSET UNITYSDK_OFFSET(0x15B95460)
#define INCONTROL_NATIVE_SETTRIGGERSHAPTICSTATE_OFFSET UNITYSDK_OFFSET(0x15B95340)
#define INCONTROL_NATIVE_STOP_OFFSET UNITYSDK_OFFSET(0x15B94F60)
