...
#define INCONTROL_NATIVE_GETANALOGGLYPHNAME_OFFSET UNITYSDK_OFFSET(0x1547B6F0)
#define INCONTROL_NATIVE_GETBUTTONGLYPHNAME_OFFSET UNITYSDK_OFFSET(0x1547B780)
#define INCONTROL_NATIVE_GETDEVICEEVENTS_OFFSET UNITYSDK_OFFSET(0x1547B430)
#define INCONTROL_NATIVE_GETDEVICEINFO_OFFSET UNITYSDK_OFFSET(0x1547B260)
#define INCONTROL_NATIVE_GETDEVICESTATE_OFFSET UNITYSDK_OFFSET(0x1547B3A0)
#define INCONTROL_NATIVE_GETVERSIONINFO_OFFSET UNITYSDK_OFFSET(0x1547B1E0)
#define INCONTROL_NATIVE_INIT_OFFSET UNITYSDK_OFFSET(0x1547B0D0)
#define INCONTROL_NATIVE_SETHAPTICSTATE_OFFSET UNITYSDK_OFFSET(0x1547B4B0)
#define INCONTROL_NATIVE_SETLIGHTCOLOR_OFFSET UNITYSDK_OFFSET(0x1547B5D0)
#define INCONTROL_NATIVE_SETLIGHTFLASH_OFFSET UNITYSDK_OFFSET(0x1547B660)
#define INCONTROL_NATIVE_SETTRIGGERSHAPTICSTATE_OFFSET UNITYSDK_OFFSET(0x1547B540)
#define INCONTROL_NATIVE_STOP_OFFSET UNITYSDK_OFFSET(0x1547B160)

namespace InControl
{
	inline static constexpr unsigned int Native_TypeDefinitionIndex = 30574;
