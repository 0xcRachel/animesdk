...
#define INCONTROL_UNITYINPUTDEVICEMANAGER___C__DISPLAYCLASS20_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15608A50)
#define INCONTROL_UNITYINPUTDEVICEMANAGER___C__DISPLAYCLASS20_0__DETECTDEVICE_B__0_OFFSET UNITYSDK_OFFSET(0x15608AB0)
#define INCONTROL_UNITYINPUTDEVICEMANAGER___C__DISPLAYCLASS20_0__DETECTDEVICE_B__1_OFFSET UNITYSDK_OFFSET(0x15608B80)
#define INCONTROL_UNITYINPUTDEVICEMANAGER___C__DISPLAYCLASS20_0__DETECTDEVICE_B__2_OFFSET UNITYSDK_OFFSET(0x15608C50)
#define INCONTROL_UNITYINPUTDEVICEMANAGER___C__DISPLAYCLASS20_0__DETECTDEVICE_B__3_OFFSET UNITYSDK_OFFSET(0x15608D20)

namespace InControl
{
	inline static constexpr unsigned int UnityInputDeviceManager___c__DisplayClass20_0_TypeDefinitionIndex = 30608;
