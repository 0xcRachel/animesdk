...
#define INCONTROL_INPUTDEVICEMANAGER_DESTROY_OFFSET UNITYSDK_OFFSET(0x15471D90)
#define INCONTROL_INPUTDEVICEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x15471DA0)

namespace InControl
{
	inline static constexpr unsigned int InputDeviceManager_TypeDefinitionIndex = 30550;
