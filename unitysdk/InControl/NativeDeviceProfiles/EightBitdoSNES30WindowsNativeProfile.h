...
#define INCONTROL_NATIVEDEVICEPROFILES_EIGHTBITDOSNES30WINDOWSNATIVEPROFILE_DEFINE_OFFSET UNITYSDK_OFFSET(0x1642FB70)
#define INCONTROL_NATIVEDEVICEPROFILES_EIGHTBITDOSNES30WINDOWSNATIVEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x164306D0)
