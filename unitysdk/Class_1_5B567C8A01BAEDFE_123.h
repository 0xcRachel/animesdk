...
#define CLASS_1_5B567C8A01BAEDFE_123_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x198BE650)
#define CLASS_1_5B567C8A01BAEDFE_123_CLONE_OFFSET UNITYSDK_OFFSET(0x198BE460)
#define CLASS_1_5B567C8A01BAEDFE_123_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x198BE560)
#define CLASS_1_5B567C8A01BAEDFE_123_EQUALS_OFFSET UNITYSDK_OFFSET(0x198BE4D0)
#define CLASS_1_5B567C8A01BAEDFE_123_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x198BE5B0)
#define CLASS_1_5B567C8A01BAEDFE_123_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x198BE6A0)
#define CLASS_1_5B567C8A01BAEDFE_123_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x198BE670)
#define CLASS_1_5B567C8A01BAEDFE_123_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x198BE3B0)
#define CLASS_1_5B567C8A01BAEDFE_123_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x198BE410)
#define CLASS_1_5B567C8A01BAEDFE_123_TOSTRING_OFFSET UNITYSDK_OFFSET(0x198BE5E0)
#define CLASS_1_5B567C8A01BAEDFE_123_WRITETO_OFFSET UNITYSDK_OFFSET(0x198BE640)
#define CLASS_1_5B567C8A01BAEDFE_123__CCTOR_OFFSET UNITYSDK_OFFSET(0x198BE6F0)
#define CLASS_1_5B567C8A01BAEDFE_123__CTOR_1_OFFSET UNITYSDK_OFFSET(0x198BE430)
#define CLASS_1_5B567C8A01BAEDFE_123__CTOR_OFFSET UNITYSDK_OFFSET(0x198BE420)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_123*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_123_TypeDefinitionIndex)->GetStaticField(0x4E460);
	}
