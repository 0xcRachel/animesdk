...
#define CLASS_1_5B567C8A01BAEDFE_123_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A681850)
#define CLASS_1_5B567C8A01BAEDFE_123_CLONE_OFFSET UNITYSDK_OFFSET(0x1A681660)
#define CLASS_1_5B567C8A01BAEDFE_123_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A681760)
#define CLASS_1_5B567C8A01BAEDFE_123_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A6816D0)
#define CLASS_1_5B567C8A01BAEDFE_123_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A6817B0)
#define CLASS_1_5B567C8A01BAEDFE_123_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A6818A0)
#define CLASS_1_5B567C8A01BAEDFE_123_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A681870)
#define CLASS_1_5B567C8A01BAEDFE_123_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A6815B0)
#define CLASS_1_5B567C8A01BAEDFE_123_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A681610)
#define CLASS_1_5B567C8A01BAEDFE_123_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A6817E0)
#define CLASS_1_5B567C8A01BAEDFE_123_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A681840)
#define CLASS_1_5B567C8A01BAEDFE_123__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A6818F0)
#define CLASS_1_5B567C8A01BAEDFE_123__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A681630)
#define CLASS_1_5B567C8A01BAEDFE_123__CTOR_OFFSET UNITYSDK_OFFSET(0x1A681620)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_123*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_123_TypeDefinitionIndex)->GetStaticField(0x13070);
	}
