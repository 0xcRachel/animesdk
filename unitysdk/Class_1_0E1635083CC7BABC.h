...
#define CLASS_1_0E1635083CC7BABC_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A3B4520)
#define CLASS_1_0E1635083CC7BABC_CLONE_OFFSET UNITYSDK_OFFSET(0x1A3B4170)
#define CLASS_1_0E1635083CC7BABC_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A3B42F0)
#define CLASS_1_0E1635083CC7BABC_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A3B4240)
#define CLASS_1_0E1635083CC7BABC_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A3B43A0)
#define CLASS_1_0E1635083CC7BABC_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A3B46F0)
#define CLASS_1_0E1635083CC7BABC_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A3B4630)
#define CLASS_1_0E1635083CC7BABC_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x1A3B4220)
#define CLASS_1_0E1635083CC7BABC_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A3B40A0)
#define CLASS_1_0E1635083CC7BABC_METHOD_1_846EDF57F2A478CA_OFFSET UNITYSDK_OFFSET(0x1A3B4200)
#define CLASS_1_0E1635083CC7BABC_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x1A3B4230)
#define CLASS_1_0E1635083CC7BABC_METHOD_1_CBA8E20523A95EF1_OFFSET UNITYSDK_OFFSET(0x1A3B4210)
#define CLASS_1_0E1635083CC7BABC_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A3B40D0)
#define CLASS_1_0E1635083CC7BABC_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A3B4430)
#define CLASS_1_0E1635083CC7BABC_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A3B4490)
#define CLASS_1_0E1635083CC7BABC__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A3B4780)
#define CLASS_1_0E1635083CC7BABC__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3B40F0)
#define CLASS_1_0E1635083CC7BABC__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3B40E0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_0E1635083CC7BABC*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_0E1635083CC7BABC_TypeDefinitionIndex)->GetStaticField(0x4B730);
	}
	// static const ::System::Int32 Field_1_2 = 0x2; // 0x0
	// static const ::System::Int32 Field_1_4 = 0x4; // 0x0
	::Class_1_C9E417278351157F* Field_1_5; // 0x10
