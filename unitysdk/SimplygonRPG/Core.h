...
#define SIMPLYGONRPG_CORE_GET_SIMPLYGONINSTANCE_OFFSET UNITYSDK_OFFSET(0x8628840)
#define SIMPLYGONRPG_CORE_REDUCE_OFFSET UNITYSDK_OFFSET(0x8629910)
#define SIMPLYGONRPG_CORE_REMESH_OFFSET UNITYSDK_OFFSET(0x8629940)
#define SIMPLYGONRPG_CORE_RUNPIPELINE_OFFSET UNITYSDK_OFFSET(0x86298A0)
#define SIMPLYGONRPG_CORE__CHECKLOG_OFFSET UNITYSDK_OFFSET(0x8628A60)
#define SIMPLYGONRPG_CORE__CTOR_OFFSET UNITYSDK_OFFSET(0x8629970)
#define SIMPLYGONRPG_CORE__LOADSCENE_OFFSET UNITYSDK_OFFSET(0x8628770)
#define SIMPLYGONRPG_CORE__RUNPIPELINE_OFFSET UNITYSDK_OFFSET(0x86284E0)
#define SIMPLYGONRPG_CORE__RUNREDUCTION_OFFSET UNITYSDK_OFFSET(0x8628ED0)
#define SIMPLYGONRPG_CORE__RUNREMESHING_OFFSET UNITYSDK_OFFSET(0x8629190)
#define SIMPLYGONRPG_CORE__SAVESCENE_OFFSET UNITYSDK_OFFSET(0x8628990)
