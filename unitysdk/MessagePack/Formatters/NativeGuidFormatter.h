...
#define MESSAGEPACK_FORMATTERS_NATIVEGUIDFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x15631E10)
#define MESSAGEPACK_FORMATTERS_NATIVEGUIDFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x15631D20)
#define MESSAGEPACK_FORMATTERS_NATIVEGUIDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x15632080)
#define MESSAGEPACK_FORMATTERS_NATIVEGUIDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x15631D10)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int NativeGuidFormatter_TypeDefinitionIndex = 9842;
	...
	public:
		...
		{
			return (::MessagePack::Formatters::IMessagePackFormatter_1<::System::Guid>**)Il2CppClass::FromTypeDefinitionIndex(NativeGuidFormatter_TypeDefinitionIndex)->GetStaticField(0x23E10);
		}
