...
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_COMPILEDMETHODS_GETMETHOD_OFFSET UNITYSDK_OFFSET(0x19629200)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_COMPILEDMETHODS_GET_PREFERINTERPRETATION_OFFSET UNITYSDK_OFFSET(0x196291B0)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_COMPILEDMETHODS_THROWREFSTRUCTNOTSUPPORTED_OFFSET UNITYSDK_OFFSET(0x19629460)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_COMPILEDMETHODS__CTOR_OFFSET UNITYSDK_OFFSET(0x19625280)
...
namespace MessagePack
{
	...
	{
	public:
		::MessagePack::MessagePackSerializer_CompiledMethods_MessagePackReaderDeserialize* Deserialize_MessagePackReader_Options; // 0x10
		...
		::System::Func_4<::System::IO::Stream*, ::MessagePack::MessagePackSerializerOptions*, ::System::Threading::CancellationToken, ::System::Threading::Tasks::ValueTask_1<::System::Object*>>* DeserializeAsync_Stream_Options_CancellationToken; // 0x30
