...
#define MESSAGEPACK_INTERNAL_FARMHASH_FETCH32_OFFSET UNITYSDK_OFFSET(0x15662DE0)
#define MESSAGEPACK_INTERNAL_FARMHASH_FETCH64_OFFSET UNITYSDK_OFFSET(0x15663680)
#define MESSAGEPACK_INTERNAL_FARMHASH_FMIX_OFFSET UNITYSDK_OFFSET(0x15662E50)
#define MESSAGEPACK_INTERNAL_FARMHASH_H32_OFFSET UNITYSDK_OFFSET(0x15663B60)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASH32LEN0TO4_OFFSET UNITYSDK_OFFSET(0x15662ED0)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASH32LEN13TO24_OFFSET UNITYSDK_OFFSET(0x15663170)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASH32LEN5TO12_OFFSET UNITYSDK_OFFSET(0x156630A0)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASH32_1_OFFSET UNITYSDK_OFFSET(0x15663270)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASH32_OFFSET UNITYSDK_OFFSET(0x15662C90)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASH64NA_OFFSET UNITYSDK_OFFSET(0x15664050)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASH64UO_OFFSET UNITYSDK_OFFSET(0x15664870)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASH64_1_OFFSET UNITYSDK_OFFSET(0x15663730)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASH64_OFFSET UNITYSDK_OFFSET(0x15663600)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASHLEN0TO16_OFFSET UNITYSDK_OFFSET(0x15663980)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASHLEN16_OFFSET UNITYSDK_OFFSET(0x15663700)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASHLEN17TO32_OFFSET UNITYSDK_OFFSET(0x15663AA0)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASHLEN33TO64_OFFSET UNITYSDK_OFFSET(0x15663C30)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASHLEN65TO96_OFFSET UNITYSDK_OFFSET(0x15663D60)
#define MESSAGEPACK_INTERNAL_FARMHASH_H_OFFSET UNITYSDK_OFFSET(0x156647E0)
#define MESSAGEPACK_INTERNAL_FARMHASH_MUR_OFFSET UNITYSDK_OFFSET(0x15662E80)
#define MESSAGEPACK_INTERNAL_FARMHASH_ROTATE32_OFFSET UNITYSDK_OFFSET(0x15662DF0)
#define MESSAGEPACK_INTERNAL_FARMHASH_ROTATE64_OFFSET UNITYSDK_OFFSET(0x15663690)
#define MESSAGEPACK_INTERNAL_FARMHASH_SHIFTMIX_OFFSET UNITYSDK_OFFSET(0x156636F0)
#define MESSAGEPACK_INTERNAL_FARMHASH_SWAP_OFFSET UNITYSDK_OFFSET(0x15663670)
#define MESSAGEPACK_INTERNAL_FARMHASH_WEAKHASHLEN32WITHSEEDS_1_OFFSET UNITYSDK_OFFSET(0x15663FA0)
#define MESSAGEPACK_INTERNAL_FARMHASH_WEAKHASHLEN32WITHSEEDS_OFFSET UNITYSDK_OFFSET(0x15663F00)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int FarmHash_TypeDefinitionIndex = 9590;
