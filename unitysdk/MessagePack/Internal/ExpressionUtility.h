...
#define MESSAGEPACK_INTERNAL_EXPRESSIONUTILITY_GETMETHODINFOCORE_OFFSET UNITYSDK_OFFSET(0x15662BE0)
#define MESSAGEPACK_INTERNAL_EXPRESSIONUTILITY_GETMETHODINFO_OFFSET UNITYSDK_OFFSET(0x15662C80)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int ExpressionUtility_TypeDefinitionIndex = 9589;
