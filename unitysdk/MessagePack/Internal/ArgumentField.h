...
#define MESSAGEPACK_INTERNAL_ARGUMENTFIELD_EMITLDARGA_OFFSET UNITYSDK_OFFSET(0x1FF85F0)
#define MESSAGEPACK_INTERNAL_ARGUMENTFIELD_EMITLDARG_OFFSET UNITYSDK_OFFSET(0x1FF85E0)
#define MESSAGEPACK_INTERNAL_ARGUMENTFIELD_EMITLOAD_OFFSET UNITYSDK_OFFSET(0x1FF85C0)
#define MESSAGEPACK_INTERNAL_ARGUMENTFIELD_EMITSTORE_OFFSET UNITYSDK_OFFSET(0x1FF8600)
#define MESSAGEPACK_INTERNAL_ARGUMENTFIELD__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1FF84A0)
#define MESSAGEPACK_INTERNAL_ARGUMENTFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x1FF8490)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int ArgumentField_TypeDefinitionIndex = 9593;
