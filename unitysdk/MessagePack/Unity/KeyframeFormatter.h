...
#define MESSAGEPACK_UNITY_KEYFRAMEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1561C230)
#define MESSAGEPACK_UNITY_KEYFRAMEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1561C1D0)
#define MESSAGEPACK_UNITY_KEYFRAMEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1561C6A0)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int KeyframeFormatter_TypeDefinitionIndex = 33927;
