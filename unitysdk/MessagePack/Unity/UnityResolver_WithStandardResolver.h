...
#define MESSAGEPACK_UNITY_UNITYRESOLVER_WITHSTANDARDRESOLVER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B507B40)
#define MESSAGEPACK_UNITY_UNITYRESOLVER_WITHSTANDARDRESOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B507B30)
