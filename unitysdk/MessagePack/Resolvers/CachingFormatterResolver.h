...
#define MESSAGEPACK_RESOLVERS_CACHINGFORMATTERRESOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1569C8C0)

namespace MessagePack::Resolvers
{
	inline static constexpr unsigned int CachingFormatterResolver_TypeDefinitionIndex = 9509;
