...
#define MESSAGEPACK_RESOLVERS_EXPANDOOBJECTRESOLVER_PRIMITIVEOBJECTWITHEXPANDOMAPS_DESERIALIZEMAP_OFFSET UNITYSDK_OFFSET(0x156A3220)
#define MESSAGEPACK_RESOLVERS_EXPANDOOBJECTRESOLVER_PRIMITIVEOBJECTWITHEXPANDOMAPS__CTOR_OFFSET UNITYSDK_OFFSET(0x156A31D0)

namespace MessagePack::Resolvers
{
	inline static constexpr unsigned int ExpandoObjectResolver_PrimitiveObjectWithExpandoMaps_TypeDefinitionIndex = 9538;
