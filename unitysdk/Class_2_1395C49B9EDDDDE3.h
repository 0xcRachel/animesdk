...
#define CLASS_2_1395C49B9EDDDDE3_GET_CHARACTERUNIQUENAME_OFFSET UNITYSDK_OFFSET(0xC2A4C80)
#define CLASS_2_1395C49B9EDDDDE3_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xC2A4CA0)
#define CLASS_2_1395C49B9EDDDDE3_SET_CHARACTERUNIQUENAME_OFFSET UNITYSDK_OFFSET(0xC2A4C90)
#define CLASS_2_1395C49B9EDDDDE3__CTOR_OFFSET UNITYSDK_OFFSET(0xC2A4D90)
#define CLASS_2_1395C49B9EDDDDE3___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xC2A4DA0)
