...
#define CLASS_2_1395C49B9EDDDDE3_GET_CHARACTERUNIQUENAME_OFFSET UNITYSDK_OFFSET(0xDEB15E0)
#define CLASS_2_1395C49B9EDDDDE3_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xDEB1600)
#define CLASS_2_1395C49B9EDDDDE3_SET_CHARACTERUNIQUENAME_OFFSET UNITYSDK_OFFSET(0xDEB15F0)
#define CLASS_2_1395C49B9EDDDDE3__CTOR_OFFSET UNITYSDK_OFFSET(0xDEB16F0)
#define CLASS_2_1395C49B9EDDDDE3___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xDEB1700)

inline static constexpr unsigned int Class_2_1395C49B9EDDDDE3_TypeDefinitionIndex = 37971;
