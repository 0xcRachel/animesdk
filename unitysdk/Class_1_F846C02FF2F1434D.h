...
#define CLASS_1_F846C02FF2F1434D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x143AC550)
#define CLASS_1_F846C02FF2F1434D_METHOD_1_1B9CC121BDC8766D_OFFSET UNITYSDK_OFFSET(0x143AC4E0)
#define CLASS_1_F846C02FF2F1434D_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x143AC5A0)
#define CLASS_1_F846C02FF2F1434D_METHOD_1_6C1396468F16E3FE_OFFSET UNITYSDK_OFFSET(0x143AC670)
#define CLASS_1_F846C02FF2F1434D_METHOD_1_8425AE8B450CC8A4_OFFSET UNITYSDK_OFFSET(0x143AC740)
#define CLASS_1_F846C02FF2F1434D_METHOD_1_99AE60B687EAE694_OFFSET UNITYSDK_OFFSET(0x143AC5F0)
#define CLASS_1_F846C02FF2F1434D_METHOD_1_AA10046B48295FA3_OFFSET UNITYSDK_OFFSET(0x143AC8B0)
#define CLASS_1_F846C02FF2F1434D_METHOD_1_ED34DCC6F6541B09_OFFSET UNITYSDK_OFFSET(0x143AC9B0)
#define CLASS_1_F846C02FF2F1434D__CCTOR_OFFSET UNITYSDK_OFFSET(0x143ACB00)
#define CLASS_1_F846C02FF2F1434D__CTOR_OFFSET UNITYSDK_OFFSET(0x143AC3D0)
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_F846C02FF2F1434D_TypeDefinitionIndex)->GetStaticField(0xA8C0);
	}
	::Il2CppArray<::System::Int32>* Field_1_1; // 0x10
	::Il2CppArray<::UnityEngine::ShaderGroupAlloc>* Field_1_2; // 0x18
