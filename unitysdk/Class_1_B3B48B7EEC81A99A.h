...
#define CLASS_1_B3B48B7EEC81A99A_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17F30C60)
#define CLASS_1_B3B48B7EEC81A99A_CLONE_OFFSET UNITYSDK_OFFSET(0x17F30760)
#define CLASS_1_B3B48B7EEC81A99A_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17F30850)
#define CLASS_1_B3B48B7EEC81A99A_EQUALS_OFFSET UNITYSDK_OFFSET(0x17F307F0)
#define CLASS_1_B3B48B7EEC81A99A_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17F30910)
#define CLASS_1_B3B48B7EEC81A99A_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x17F30E40)
#define CLASS_1_B3B48B7EEC81A99A_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x17F30DD0)
#define CLASS_1_B3B48B7EEC81A99A_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x17F307C0)
#define CLASS_1_B3B48B7EEC81A99A_METHOD_1_554199E0076172C5_1_OFFSET UNITYSDK_OFFSET(0x17F307E0)
#define CLASS_1_B3B48B7EEC81A99A_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x17F307B0)
#define CLASS_1_B3B48B7EEC81A99A_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x17F307D0)
#define CLASS_1_B3B48B7EEC81A99A_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17F305D0)
#define CLASS_1_B3B48B7EEC81A99A_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17F30AF0)
#define CLASS_1_B3B48B7EEC81A99A_WRITETO_OFFSET UNITYSDK_OFFSET(0x17F30B50)
#define CLASS_1_B3B48B7EEC81A99A__CCTOR_OFFSET UNITYSDK_OFFSET(0x17F30F70)
#define CLASS_1_B3B48B7EEC81A99A__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17F30670)
#define CLASS_1_B3B48B7EEC81A99A__CTOR_OFFSET UNITYSDK_OFFSET(0x17F305E0)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B3B48B7EEC81A99A_TypeDefinitionIndex)->GetStaticField(0x44220);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_7()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B3B48B7EEC81A99A_TypeDefinitionIndex)->GetStaticField(0x44228);
	}
