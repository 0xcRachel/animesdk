...
#define INTERACTPROXY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x10ADCAA0)
#define INTERACTPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x10ADCA80)

inline static constexpr unsigned int InteractProxy_TypeDefinitionIndex = 37391;
