...
#define CLASS_3_206F177A6C7E89E8_ADD_OFFSET UNITYSDK_OFFSET(0x12035D90)
#define CLASS_3_206F177A6C7E89E8_METHOD_3_6C0D3BB3C6621FFD_OFFSET UNITYSDK_OFFSET(0x12036400)
#define CLASS_3_206F177A6C7E89E8_METHOD_3_7017C9D6C32E7D7F_OFFSET UNITYSDK_OFFSET(0x120358C0)
#define CLASS_3_206F177A6C7E89E8_METHOD_3_8AF8767FA79BAF65_OFFSET UNITYSDK_OFFSET(0x12036710)
#define CLASS_3_206F177A6C7E89E8_METHOD_3_DD784213055292FB_OFFSET UNITYSDK_OFFSET(0x120367B0)
#define CLASS_3_206F177A6C7E89E8_METHOD_3_F4BACB8E9D45997B_OFFSET UNITYSDK_OFFSET(0x12035F30)
#define CLASS_3_206F177A6C7E89E8__CTOR_OFFSET UNITYSDK_OFFSET(0x12036970)
#define CLASS_3_206F177A6C7E89E8___IFIXBASEPROXY_ADD_OFFSET UNITYSDK_OFFSET(0x12036A50)

inline static constexpr unsigned int Class_3_206F177A6C7E89E8_TypeDefinitionIndex = 71454;

class Class_3_206F177A6C7E89E8 : public ::Class_2_1792A4214A514F27
{
public:
	::Class_1_7F2ABDAFDCEC0543* Field_3_0; // 0x30
	::Class_1_0EE68920FE366BFF_2* Field_3_1; // 0x38
	::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_1162*>* Field_3_2; // 0x40
	::Class_1_3FF87F4926CD1B22* Field_3_3; // 0x48
	::Class_2_2FF2986CE7F8FBE1* Field_3_4; // 0x50
	::System::Collections::Generic::List_1<::System::String*>* Field_3_5; // 0x58
	::Class_1_4FAE3CBDEA4A599A* Field_3_6; // 0x60
	::Class_1_FE0E300FA55D1287* Field_3_7; // 0x68
