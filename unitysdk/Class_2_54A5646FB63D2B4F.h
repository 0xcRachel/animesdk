...
#define CLASS_2_54A5646FB63D2B4F_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10B0C730)
#define CLASS_2_54A5646FB63D2B4F_METHOD_2_12AAD2426D38E65C_OFFSET UNITYSDK_OFFSET(0x10B0CFF0)
#define CLASS_2_54A5646FB63D2B4F_METHOD_2_134017AC3A2C19AD_OFFSET UNITYSDK_OFFSET(0x10B0BAA0)
#define CLASS_2_54A5646FB63D2B4F_METHOD_2_1CB1FB01B77423C6_OFFSET UNITYSDK_OFFSET(0x10B0BCD0)
#define CLASS_2_54A5646FB63D2B4F_METHOD_2_1E974712462AF02E_OFFSET UNITYSDK_OFFSET(0x10B0D2D0)
#define CLASS_2_54A5646FB63D2B4F_METHOD_2_219EE22F13B5AC99_OFFSET UNITYSDK_OFFSET(0x10B0C250)
#define CLASS_2_54A5646FB63D2B4F_METHOD_2_2BCCE168DA1FAC42_OFFSET UNITYSDK_OFFSET(0x10B0CD30)
#define CLASS_2_54A5646FB63D2B4F_METHOD_2_396F2E6BD61E3D00_1_OFFSET UNITYSDK_OFFSET(0x10B0C1E0)
#define CLASS_2_54A5646FB63D2B4F_METHOD_2_396F2E6BD61E3D00_OFFSET UNITYSDK_OFFSET(0x10B0BEB0)
#define CLASS_2_54A5646FB63D2B4F_METHOD_2_4EF542E7E88B2090_OFFSET UNITYSDK_OFFSET(0x10B0D7D0)
#define CLASS_2_54A5646FB63D2B4F_METHOD_2_52A04EBF0FB72D33_OFFSET UNITYSDK_OFFSET(0x10B0C370)
#define CLASS_2_54A5646FB63D2B4F_METHOD_2_5B54271BAB4A079D_OFFSET UNITYSDK_OFFSET(0x10B0CC00)
#define CLASS_2_54A5646FB63D2B4F_METHOD_2_7984DE422163E6B4_OFFSET UNITYSDK_OFFSET(0x10B0D6F0)
#define CLASS_2_54A5646FB63D2B4F_METHOD_2_8483E8C5D58A000D_OFFSET UNITYSDK_OFFSET(0x10B0C590)
#define CLASS_2_54A5646FB63D2B4F_METHOD_2_881CCFB5CB7FF9E8_OFFSET UNITYSDK_OFFSET(0x10B0D1C0)
#define CLASS_2_54A5646FB63D2B4F_METHOD_2_8923446497E3D0C5_OFFSET UNITYSDK_OFFSET(0x10B0C8C0)
#define CLASS_2_54A5646FB63D2B4F_METHOD_2_8A32FA5EA368CF64_OFFSET UNITYSDK_OFFSET(0x10B0D440)
#define CLASS_2_54A5646FB63D2B4F_METHOD_2_B60A372A6443812A_OFFSET UNITYSDK_OFFSET(0x10B0B8A0)
#define CLASS_2_54A5646FB63D2B4F_METHOD_2_D2D7B9347E6957CF_OFFSET UNITYSDK_OFFSET(0x10B0BF20)
#define CLASS_2_54A5646FB63D2B4F_METHOD_2_D8E4A0D579A74A4E_OFFSET UNITYSDK_OFFSET(0x10B0C500)
#define CLASS_2_54A5646FB63D2B4F_METHOD_2_E0FE6023AC32F0D5_OFFSET UNITYSDK_OFFSET(0x10B0CAC0)
#define CLASS_2_54A5646FB63D2B4F_METHOD_2_E6184566299DAB0F_OFFSET UNITYSDK_OFFSET(0x10B0C6E0)
#define CLASS_2_54A5646FB63D2B4F_METHOD_2_FFD866DD4928D1D9_OFFSET UNITYSDK_OFFSET(0x10B0CDE0)
#define CLASS_2_54A5646FB63D2B4F__CTOR_OFFSET UNITYSDK_OFFSET(0x10B0B630)

inline static constexpr unsigned int Class_2_54A5646FB63D2B4F_TypeDefinitionIndex = 67942;

class Class_2_54A5646FB63D2B4F : public ::Class_1_7256E7A2FB36A46D
{
public:
	// static const ::System::Int32 Field_2_0 = 0x3; // 0x0
	::System::Collections::Generic::List_1<::Class_2_54A5646FB63D2B4F_Struct_2_A5FF422FCBA8618D>* Field_2_4; // 0x18
	::System::Collections::Generic::Dictionary_2<::UnityEngine::GameObject*, ::RPG::Client::OpenWorld::StreamingItemData*>* Field_2_2; // 0x20
	::System::Collections::Generic::Dictionary_2<::RPG::Client::OpenWorld::StreamingItemData*, ::Class_2_54A5646FB63D2B4F_Struct_2_160AFE2A48B833F5>* Field_2_3; // 0x28
	::System::Action_4<::Class_1_8A6989C352B0F0F0*, ::Class_1_303D5A33D1401D59*, ::UnityEngine::GameObject*, ::RPG::Client::OpenWorld::StreamingInstanceNotifyType>* Field_2_1; // 0x30
	::System::Collections::Generic::HashSet_1<::Class_1_303D5A33D1401D59*>* Field_2_6; // 0x38
