...
#define CLASS_1_43BD383C98B4C0C5_159_DISPOSE_OFFSET UNITYSDK_OFFSET(0x135323A0)
#define CLASS_1_43BD383C98B4C0C5_159__CTOR_OFFSET UNITYSDK_OFFSET(0x13532390)
...
public:
	...
	::Struct_2_F15D3B4A9D0D9701 Field_1_1; // 0xC0
	::Struct_2_9337153130FDFA1E Field_1_2; // 0xF8
	::Struct_2_1E36AD6D9A5F486C Field_1_3; // 0x130
	::Struct_2_05A67A9E2D5889AA Field_1_4; // 0x370
	::RPG::GameCore::GameEntity* Field_1_5; // 0x578
	::Struct_2_B87BAA35D432DB99 Field_1_6; // 0x580
	::RootMotion::FinalIK::GrounderIKThreadSolver Field_1_7; // 0x5A8
