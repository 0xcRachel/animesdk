...
#define CLASS_2_2D9A1A7180E45AD3_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9940BA0)
#define CLASS_2_2D9A1A7180E45AD3_METHOD_2_0155A6B299E59B4F_OFFSET UNITYSDK_OFFSET(0x99416A0)
#define CLASS_2_2D9A1A7180E45AD3_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x9940BE0)
#define CLASS_2_2D9A1A7180E45AD3_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x9941AB0)
#define CLASS_2_2D9A1A7180E45AD3_TICK_OFFSET UNITYSDK_OFFSET(0x9941B00)
#define CLASS_2_2D9A1A7180E45AD3__CTOR_OFFSET UNITYSDK_OFFSET(0x9940B90)

inline static constexpr unsigned int Class_2_2D9A1A7180E45AD3_TypeDefinitionIndex = 43069;
