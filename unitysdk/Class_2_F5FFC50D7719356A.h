...
#define CLASS_2_F5FFC50D7719356A_GET_ALLOWMEMBERPLAY_OFFSET UNITYSDK_OFFSET(0xC2B78C0)
#define CLASS_2_F5FFC50D7719356A_GET_DROPINFOS_OFFSET UNITYSDK_OFFSET(0xC2B7820)
#define CLASS_2_F5FFC50D7719356A_GET_INTERSECTIONINFO_OFFSET UNITYSDK_OFFSET(0xC2B77C0)
#define CLASS_2_F5FFC50D7719356A_GET_ISPLAYERENTRY_OFFSET UNITYSDK_OFFSET(0xC2B78D0)
#define CLASS_2_F5FFC50D7719356A_GET_SLOTS_OFFSET UNITYSDK_OFFSET(0xC2B77B0)
#define CLASS_2_F5FFC50D7719356A_GET_STAGE_OFFSET UNITYSDK_OFFSET(0xC2B77E0)
#define CLASS_2_F5FFC50D7719356A_GET_TRIGGERHANDLER_OFFSET UNITYSDK_OFFSET(0xC2B7800)
#define CLASS_2_F5FFC50D7719356A_GET_WORLDINVERSEROTATION_OFFSET UNITYSDK_OFFSET(0xC2B78A0)
#define CLASS_2_F5FFC50D7719356A_GET_WORLDROTATION_OFFSET UNITYSDK_OFFSET(0xC2B7890)
#define CLASS_2_F5FFC50D7719356A_GET_WORLDUP_OFFSET UNITYSDK_OFFSET(0xC2B7870)
#define CLASS_2_F5FFC50D7719356A_METHOD_2_011527D8FB36A26F_OFFSET UNITYSDK_OFFSET(0xC2B9BD0)
#define CLASS_2_F5FFC50D7719356A_METHOD_2_18ABA27B5DEF4779_OFFSET UNITYSDK_OFFSET(0xC2BACA0)
#define CLASS_2_F5FFC50D7719356A_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xC2BAEC0)
#define CLASS_2_F5FFC50D7719356A_METHOD_2_62D75ADFFEE4BD8B_OFFSET UNITYSDK_OFFSET(0xC2B9D90)
#define CLASS_2_F5FFC50D7719356A_METHOD_2_63B9BBBA908A65B9_OFFSET UNITYSDK_OFFSET(0xC2B9F20)
#define CLASS_2_F5FFC50D7719356A_METHOD_2_669256140B61F98F_OFFSET UNITYSDK_OFFSET(0xC2BAD40)
#define CLASS_2_F5FFC50D7719356A_METHOD_2_718C533A69423C28_OFFSET UNITYSDK_OFFSET(0xC2B9960)
#define CLASS_2_F5FFC50D7719356A_METHOD_2_7EFCA0110EC7145F_OFFSET UNITYSDK_OFFSET(0xC2BA7C0)
#define CLASS_2_F5FFC50D7719356A_METHOD_2_9C331001414329EA_OFFSET UNITYSDK_OFFSET(0xC2B8FF0)
#define CLASS_2_F5FFC50D7719356A_METHOD_2_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0xC2BA720)
#define CLASS_2_F5FFC50D7719356A_METHOD_2_B5BD32B0C4CFDB0D_OFFSET UNITYSDK_OFFSET(0xC2BA2A0)
#define CLASS_2_F5FFC50D7719356A_METHOD_2_BE4EBC8FF4054312_OFFSET UNITYSDK_OFFSET(0xC2B9590)
#define CLASS_2_F5FFC50D7719356A_METHOD_2_C2022A7619B3D99E_OFFSET UNITYSDK_OFFSET(0xC2B9820)
#define CLASS_2_F5FFC50D7719356A_METHOD_2_C3C9BF311C318908_OFFSET UNITYSDK_OFFSET(0xC2B7920)
#define CLASS_2_F5FFC50D7719356A_METHOD_2_C561FF611C07A44C_OFFSET UNITYSDK_OFFSET(0xC2BAE00)
#define CLASS_2_F5FFC50D7719356A_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xC2BADB0)
#define CLASS_2_F5FFC50D7719356A_METHOD_2_D64FD9A228A1C4E0_OFFSET UNITYSDK_OFFSET(0xC2B9500)
#define CLASS_2_F5FFC50D7719356A_METHOD_2_DE2BC44ACB86CE8C_OFFSET UNITYSDK_OFFSET(0xC2B8DA0)
#define CLASS_2_F5FFC50D7719356A_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xC2B78B0)
#define CLASS_2_F5FFC50D7719356A_METHOD_2_FB4BE762B6186C23_1_OFFSET UNITYSDK_OFFSET(0xC2B78F0)
#define CLASS_2_F5FFC50D7719356A_METHOD_2_FB4BE762B6186C23_OFFSET UNITYSDK_OFFSET(0xC2B7840)
#define CLASS_2_F5FFC50D7719356A_METHOD_2_FEA241CA014F8043_OFFSET UNITYSDK_OFFSET(0xC2B9310)
#define CLASS_2_F5FFC50D7719356A_METHOD_2_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0xC2B9EB0)
#define CLASS_2_F5FFC50D7719356A_SET_DROPINFOS_OFFSET UNITYSDK_OFFSET(0xC2B7830)
#define CLASS_2_F5FFC50D7719356A_SET_INTERSECTIONINFO_OFFSET UNITYSDK_OFFSET(0xC2B77D0)
#define CLASS_2_F5FFC50D7719356A_SET_ISPLAYERENTRY_OFFSET UNITYSDK_OFFSET(0xC2B78E0)
#define CLASS_2_F5FFC50D7719356A_SET_STAGE_OFFSET UNITYSDK_OFFSET(0xC2B77F0)
#define CLASS_2_F5FFC50D7719356A_SET_TRIGGERHANDLER_OFFSET UNITYSDK_OFFSET(0xC2B7810)
#define CLASS_2_F5FFC50D7719356A__CTOR_OFFSET UNITYSDK_OFFSET(0xC2B7930)
...
public:
	...
	::System::Collections::Generic::List_1<::Class_1_9AAC3BB4FD7CE6FE*>* Field_2_12; // 0x80
	::System::Collections::Generic::Dictionary_2<::Class_1_9AAC3BB4FD7CE6FE*, ::System::Int32>* Field_2_10; // 0x88
	::Il2CppArray<::UnityEngine::Vector3>* _Slots_k__BackingField; // 0x90
	::Il2CppArray<::Struct_2_085541A9CFF64383>* Field_2_15; // 0x98
	::Il2CppArray<::Class_2_F5FFC50D7719356A_Class_1_236E27A066C766AA*>* _DropInfos_k__BackingField; // 0xA0
	::RPG::Client::Stage* _Stage_k__BackingField; // 0xA8
	::System::Collections::Generic::List_1<::System::Int32>* Field_2_11; // 0xB0
	...
	::UnityEngine::Quaternion _WorldInverseRotation_k__BackingField; // 0xD0
	::System::Single Field_2_13; // 0xE0
	::UnityEngine::Vector3 _WorldUp_k__BackingField; // 0xE4
	::System::Boolean _AllowMemberPlay_k__BackingField; // 0xF0
	::System::Boolean _IsPlayerEntry_k__BackingField; // 0xF1
