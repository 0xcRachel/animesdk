...
#define CLASS_2_BC64DF9A816B750A___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xCCC7270)
#define CLASS_2_BC64DF9A816B750A___C__CTOR_OFFSET UNITYSDK_OFFSET(0xCCC72A0)
#define CLASS_2_BC64DF9A816B750A___C__TICK_B__4_0_OFFSET UNITYSDK_OFFSET(0xCCC72B0)
...
public:
	...
	{
		return (::System::Func_2<::RPG::GameCore::Triple_3<::System::Boolean, ::RPG::GameCore::TurnBasedAbilityComponent*, ::RPG::GameCore::GameEntityList*>*, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_BC64DF9A816B750A___c_TypeDefinitionIndex)->GetStaticField(0x5C20);
	}
	static ::Class_2_BC64DF9A816B750A___c** StaticGet___9()
	{
		return (::Class_2_BC64DF9A816B750A___c**)Il2CppClass::FromTypeDefinitionIndex(Class_2_BC64DF9A816B750A___c_TypeDefinitionIndex)->GetStaticField(0x5C28);
	}
