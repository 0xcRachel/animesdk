...
#define CLASS_2_CBAB1DBCB9F76F94_DISPOSE_OFFSET UNITYSDK_OFFSET(0x109C8990)
#define CLASS_2_CBAB1DBCB9F76F94_METHOD_2_538A4AD7B1F24D2D_OFFSET UNITYSDK_OFFSET(0x109C8C80)
#define CLASS_2_CBAB1DBCB9F76F94_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x109C8AA0)
#define CLASS_2_CBAB1DBCB9F76F94_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x109C8B60)
#define CLASS_2_CBAB1DBCB9F76F94_SETNEXTTASK_OFFSET UNITYSDK_OFFSET(0x109C8A50)
#define CLASS_2_CBAB1DBCB9F76F94_TICK_OFFSET UNITYSDK_OFFSET(0x109C8C20)
#define CLASS_2_CBAB1DBCB9F76F94__CTOR_OFFSET UNITYSDK_OFFSET(0x109C8980)
