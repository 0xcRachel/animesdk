...
#define CLASS_3_5C01DB3813C27EF2___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x148E1C00)
#define CLASS_3_5C01DB3813C27EF2___C__CTOR_OFFSET UNITYSDK_OFFSET(0x148E1C40)
#define CLASS_3_5C01DB3813C27EF2___C___CTOR_B__0_0_OFFSET UNITYSDK_OFFSET(0x148E1C50)
...
public:
	...
	{
		return (::Class_3_5C01DB3813C27EF2___c**)Il2CppClass::FromTypeDefinitionIndex(Class_3_5C01DB3813C27EF2___c_TypeDefinitionIndex)->GetStaticField(0x10340);
	}
	static ::System::Action_1<::Class_3_5C01DB3813C27EF2*>** StaticGet___9__0_0()
	{
		return (::System::Action_1<::Class_3_5C01DB3813C27EF2*>**)Il2CppClass::FromTypeDefinitionIndex(Class_3_5C01DB3813C27EF2___c_TypeDefinitionIndex)->GetStaticField(0x10348);
	}
