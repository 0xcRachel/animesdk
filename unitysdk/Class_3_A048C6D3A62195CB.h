...
#define CLASS_3_A048C6D3A62195CB_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1606EE20)
#define CLASS_3_A048C6D3A62195CB_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1606EEE0)
#define CLASS_3_A048C6D3A62195CB__CTOR_OFFSET UNITYSDK_OFFSET(0x1606EE00)

inline static constexpr unsigned int Class_3_A048C6D3A62195CB_TypeDefinitionIndex = 27953;
