...
#define PLUGINMSGRECEIVER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x15D717A0)
#define PLUGINMSGRECEIVER_SENDPLUGINMSG_OFFSET UNITYSDK_OFFSET(0x15D71860)
#define PLUGINMSGRECEIVER_START_OFFSET UNITYSDK_OFFSET(0x15D716E0)
#define PLUGINMSGRECEIVER__CTOR_OFFSET UNITYSDK_OFFSET(0x15D719C0)

inline static constexpr unsigned int PluginMsgReceiver_TypeDefinitionIndex = 31049;
