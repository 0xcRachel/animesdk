...
#define CLASS_1_5D5D871C878FD105_GET_ISDONE_OFFSET UNITYSDK_OFFSET(0x1107C350)
#define CLASS_1_5D5D871C878FD105_METHOD_1_CB3646FA399CB619_OFFSET UNITYSDK_OFFSET(0x1107C270)
#define CLASS_1_5D5D871C878FD105_SET_ISDONE_OFFSET UNITYSDK_OFFSET(0x1107C360)
#define CLASS_1_5D5D871C878FD105__CTOR_OFFSET UNITYSDK_OFFSET(0x1107C260)

inline static constexpr unsigned int Class_1_5D5D871C878FD105_TypeDefinitionIndex = 49580;
