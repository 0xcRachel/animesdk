...
#define CLASS_2_C3B0D41544DB2379_DISPOSE_OFFSET UNITYSDK_OFFSET(0x154D0C40)
#define CLASS_2_C3B0D41544DB2379_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x154D0C80)
#define CLASS_2_C3B0D41544DB2379_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x154D0D80)
#define CLASS_2_C3B0D41544DB2379_TICK_OFFSET UNITYSDK_OFFSET(0x154D0DD0)
#define CLASS_2_C3B0D41544DB2379__CTOR_OFFSET UNITYSDK_OFFSET(0x154D0C30)
