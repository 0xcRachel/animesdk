...
#define CLASS_2_C3B0D41544DB2379_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11206520)
#define CLASS_2_C3B0D41544DB2379_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11206560)
#define CLASS_2_C3B0D41544DB2379_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x11206660)
#define CLASS_2_C3B0D41544DB2379_TICK_OFFSET UNITYSDK_OFFSET(0x112066B0)
#define CLASS_2_C3B0D41544DB2379__CTOR_OFFSET UNITYSDK_OFFSET(0x11206510)

inline static constexpr unsigned int Class_2_C3B0D41544DB2379_TypeDefinitionIndex = 43086;
