...
#define CLASS_1_5B567C8A01BAEDFE_276_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19BEE760)
#define CLASS_1_5B567C8A01BAEDFE_276_CLONE_OFFSET UNITYSDK_OFFSET(0x19BEE5D0)
#define CLASS_1_5B567C8A01BAEDFE_276_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19BEE670)
#define CLASS_1_5B567C8A01BAEDFE_276_EQUALS_OFFSET UNITYSDK_OFFSET(0x19BEE610)
#define CLASS_1_5B567C8A01BAEDFE_276_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19BEE6C0)
#define CLASS_1_5B567C8A01BAEDFE_276_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19BEE7B0)
#define CLASS_1_5B567C8A01BAEDFE_276_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19BEE780)
#define CLASS_1_5B567C8A01BAEDFE_276_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19BEE550)
#define CLASS_1_5B567C8A01BAEDFE_276_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19BEE580)
#define CLASS_1_5B567C8A01BAEDFE_276_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19BEE6F0)
#define CLASS_1_5B567C8A01BAEDFE_276_WRITETO_OFFSET UNITYSDK_OFFSET(0x19BEE750)
#define CLASS_1_5B567C8A01BAEDFE_276__CCTOR_OFFSET UNITYSDK_OFFSET(0x19BEE800)
#define CLASS_1_5B567C8A01BAEDFE_276__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19BEE5A0)
#define CLASS_1_5B567C8A01BAEDFE_276__CTOR_OFFSET UNITYSDK_OFFSET(0x19BEE590)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_276*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_276_TypeDefinitionIndex)->GetStaticField(0x157F0);
	}
