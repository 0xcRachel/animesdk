...
#define CLASS_1_946C8BC94E6B6DA1_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A61C500)
#define CLASS_1_946C8BC94E6B6DA1_CLONE_OFFSET UNITYSDK_OFFSET(0x1A61C150)
#define CLASS_1_946C8BC94E6B6DA1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A61C300)
#define CLASS_1_946C8BC94E6B6DA1_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A61C240)
#define CLASS_1_946C8BC94E6B6DA1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A61C3B0)
#define CLASS_1_946C8BC94E6B6DA1_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A61C6F0)
#define CLASS_1_946C8BC94E6B6DA1_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A61C660)
#define CLASS_1_946C8BC94E6B6DA1_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1A61C220)
#define CLASS_1_946C8BC94E6B6DA1_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1A61C200)
#define CLASS_1_946C8BC94E6B6DA1_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x1A61C1E0)
#define CLASS_1_946C8BC94E6B6DA1_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A61C080)
#define CLASS_1_946C8BC94E6B6DA1_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1A61C230)
#define CLASS_1_946C8BC94E6B6DA1_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1A61C210)
#define CLASS_1_946C8BC94E6B6DA1_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x1A61C1F0)
#define CLASS_1_946C8BC94E6B6DA1_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A61C0B0)
#define CLASS_1_946C8BC94E6B6DA1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A61C400)
#define CLASS_1_946C8BC94E6B6DA1_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A61C460)
#define CLASS_1_946C8BC94E6B6DA1__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A61C8B0)
#define CLASS_1_946C8BC94E6B6DA1__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A61C0D0)
#define CLASS_1_946C8BC94E6B6DA1__CTOR_OFFSET UNITYSDK_OFFSET(0x1A61C0C0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_946C8BC94E6B6DA1*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_946C8BC94E6B6DA1_TypeDefinitionIndex)->GetStaticField(0x32B20);
	}
	...
	{
		return ((::Class_1_E591DF54310AABF5*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_946C8BC94E6B6DA1_METHOD_1_24748FC20F375725_OFFSET))(this);
	}

	::System::Void Method_1_8C8625211DA811AE(::Class_1_E591DF54310AABF5* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_E591DF54310AABF5*))((::PBYTE)hIl2Cpp + CLASS_1_946C8BC94E6B6DA1_METHOD_1_8C8625211DA811AE_OFFSET))(this, a1);
	}
