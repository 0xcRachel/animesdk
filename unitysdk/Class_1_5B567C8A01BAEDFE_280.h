...
#define CLASS_1_5B567C8A01BAEDFE_280_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A3B7A10)
#define CLASS_1_5B567C8A01BAEDFE_280_CLONE_OFFSET UNITYSDK_OFFSET(0x1A3B7880)
#define CLASS_1_5B567C8A01BAEDFE_280_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A3B7920)
#define CLASS_1_5B567C8A01BAEDFE_280_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A3B78C0)
#define CLASS_1_5B567C8A01BAEDFE_280_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A3B7970)
#define CLASS_1_5B567C8A01BAEDFE_280_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A3B7A60)
#define CLASS_1_5B567C8A01BAEDFE_280_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A3B7A30)
#define CLASS_1_5B567C8A01BAEDFE_280_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A3B7800)
#define CLASS_1_5B567C8A01BAEDFE_280_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A3B7830)
#define CLASS_1_5B567C8A01BAEDFE_280_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A3B79A0)
#define CLASS_1_5B567C8A01BAEDFE_280_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A3B7A00)
#define CLASS_1_5B567C8A01BAEDFE_280__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A3B7AB0)
#define CLASS_1_5B567C8A01BAEDFE_280__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3B7850)
#define CLASS_1_5B567C8A01BAEDFE_280__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3B7840)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_280*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_280_TypeDefinitionIndex)->GetStaticField(0x4BC60);
	}
