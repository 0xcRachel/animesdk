...
#define CLASS_2_B94A7D59C6C20C91_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x145D8420)
#define CLASS_2_B94A7D59C6C20C91_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x145D8660)
#define CLASS_2_B94A7D59C6C20C91_METHOD_2_0CC4BC19C602BCD0_OFFSET UNITYSDK_OFFSET(0x145D6B40)
#define CLASS_2_B94A7D59C6C20C91_METHOD_2_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x145D6E40)
#define CLASS_2_B94A7D59C6C20C91_METHOD_2_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0x145D8C60)
#define CLASS_2_B94A7D59C6C20C91_METHOD_2_5790A55946AA509D_2_OFFSET UNITYSDK_OFFSET(0x145D8CC0)
#define CLASS_2_B94A7D59C6C20C91_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x145D8C00)
#define CLASS_2_B94A7D59C6C20C91_METHOD_2_5A124CAF1E48B74F_OFFSET UNITYSDK_OFFSET(0x145D6FB0)
#define CLASS_2_B94A7D59C6C20C91_METHOD_2_AFAC481DD0C65A52_OFFSET UNITYSDK_OFFSET(0x145D76D0)
#define CLASS_2_B94A7D59C6C20C91_METHOD_2_C450A961450309C9_1_OFFSET UNITYSDK_OFFSET(0x145D81E0)
#define CLASS_2_B94A7D59C6C20C91_METHOD_2_C450A961450309C9_OFFSET UNITYSDK_OFFSET(0x145D8060)
#define CLASS_2_B94A7D59C6C20C91_METHOD_2_F37CDBD6D46274D2_1_OFFSET UNITYSDK_OFFSET(0x145D7FE0)
#define CLASS_2_B94A7D59C6C20C91_METHOD_2_F37CDBD6D46274D2_2_OFFSET UNITYSDK_OFFSET(0x145D8360)
#define CLASS_2_B94A7D59C6C20C91_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x145D7F60)
#define CLASS_2_B94A7D59C6C20C91__CTOR_OFFSET UNITYSDK_OFFSET(0x145D8860)
#define CLASS_2_B94A7D59C6C20C91__ONBIND_OFFSET UNITYSDK_OFFSET(0x145D61D0)
#define CLASS_2_B94A7D59C6C20C91___IFIXBASEPROXY_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x145D8D20)
#define CLASS_2_B94A7D59C6C20C91___IFIXBASEPROXY_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x145D8D80)
#define CLASS_2_B94A7D59C6C20C91___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0x145D8BA0)

inline static constexpr unsigned int Class_2_B94A7D59C6C20C91_TypeDefinitionIndex = 67364;
...
public:
	...
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::FeverTimePeriodType, ::UnityEngine::Transform*>* Field_2_2; // 0x70
	::RPG::Client::ActivityFeverTimePileToast* Field_2_3; // 0x78
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::FeverTimePeriodType, ::RPG::Client::ProgressBar*>* Field_2_4; // 0x80
	...
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::FeverTimePeriodType, ::UnityEngine::UI::SmoothMask*>* Field_2_7; // 0x98
	::System::String* Field_2_8; // 0xA0
	::RPG::GameCore::LevelUIComponent* Field_2_9; // 0xA8
	::UnityEngine::Transform* Field_2_10; // 0xB0
	::UnityEngine::UI::Button* Field_2_11; // 0xB8
	::UnityEngine::UI::Text* Field_2_12; // 0xC0
	::UnityEngine::UI::Text* Field_2_13; // 0xC8
	::UnityEngine::Animator* Field_2_14; // 0xD0
	::UnityEngine::UI::Button* Field_2_15; // 0xD8
	::UnityEngine::UI::Button* Field_2_16; // 0xE0
	::UnityEngine::UI::Button* Field_2_17; // 0xE8
	::UnityEngine::Transform* Field_2_18; // 0xF0
	::UnityEngine::Animation* Field_2_19; // 0xF8
	::System::UInt32 Field_2_20; // 0x100
	::System::UInt32 Field_2_21; // 0x104
	::System::Int32 Field_2_22; // 0x108
	::System::Boolean Field_2_23; // 0x10C
	::RPG::GameCore::FeverTimePeriodType Field_2_24; // 0x110
