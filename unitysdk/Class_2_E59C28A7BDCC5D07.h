...
#define CLASS_2_E59C28A7BDCC5D07_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1048A380)
#define CLASS_2_E59C28A7BDCC5D07_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x1048B4D0)
#define CLASS_2_E59C28A7BDCC5D07_METHOD_2_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x1048A930)
#define CLASS_2_E59C28A7BDCC5D07_METHOD_2_30A2382C3FCC5386_OFFSET UNITYSDK_OFFSET(0x1048A3D0)
#define CLASS_2_E59C28A7BDCC5D07_METHOD_2_AB4165C786F28621_OFFSET UNITYSDK_OFFSET(0x1048AE10)
#define CLASS_2_E59C28A7BDCC5D07_ONFINISHIMMEDIATELYINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x1048B470)
#define CLASS_2_E59C28A7BDCC5D07_ONSKIP_OFFSET UNITYSDK_OFFSET(0x1048B2B0)
#define CLASS_2_E59C28A7BDCC5D07_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1048AA20)
#define CLASS_2_E59C28A7BDCC5D07_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1048AE70)
#define CLASS_2_E59C28A7BDCC5D07_TICK_OFFSET UNITYSDK_OFFSET(0x1048AEC0)
#define CLASS_2_E59C28A7BDCC5D07__CTOR_OFFSET UNITYSDK_OFFSET(0x1048A360)

inline static constexpr unsigned int Class_2_E59C28A7BDCC5D07_TypeDefinitionIndex = 41327;

class Class_2_E59C28A7BDCC5D07 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::AdventureCharacterController* Field_2_5; // 0x18
	::RPG::GameCore::TransformComponent* Field_2_4; // 0x20
	::RPG::GameCore::AdvEnablePropDialogMode* Field_2_1; // 0x28
	::RPG::GameCore::GameEntity* Field_2_2; // 0x30
	::RPG::GameCore::TaskContext* Field_2_0; // 0x38
	::RPG::GameCore::GameEntity* Field_2_3; // 0x40
	::RPG::Client::CameraDataAndFlags* Field_2_7; // 0x48
	::System::Single Field_2_11; // 0x50
	::System::Single Field_2_10; // 0x54
	::System::Nullable_1<::UnityEngine::Vector3> Field_2_9; // 0x58
