...
#define CLASS_1_43FD8409C86BAFF2_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A377A40)
#define CLASS_1_43FD8409C86BAFF2_CLONE_OFFSET UNITYSDK_OFFSET(0x1A3775E0)
#define CLASS_1_43FD8409C86BAFF2_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A377710)
#define CLASS_1_43FD8409C86BAFF2_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A377640)
#define CLASS_1_43FD8409C86BAFF2_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A3777E0)
#define CLASS_1_43FD8409C86BAFF2_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A377B60)
#define CLASS_1_43FD8409C86BAFF2_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A377AE0)
#define CLASS_1_43FD8409C86BAFF2_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x1A377620)
#define CLASS_1_43FD8409C86BAFF2_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1A377610)
#define CLASS_1_43FD8409C86BAFF2_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A377440)
#define CLASS_1_43FD8409C86BAFF2_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x1A377630)
#define CLASS_1_43FD8409C86BAFF2_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A377470)
#define CLASS_1_43FD8409C86BAFF2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A377940)
#define CLASS_1_43FD8409C86BAFF2_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A3779A0)
#define CLASS_1_43FD8409C86BAFF2__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A377C30)
#define CLASS_1_43FD8409C86BAFF2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3774D0)
#define CLASS_1_43FD8409C86BAFF2__CTOR_OFFSET UNITYSDK_OFFSET(0x1A377480)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_43FD8409C86BAFF2*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_43FD8409C86BAFF2_TypeDefinitionIndex)->GetStaticField(0x52ED0);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_3()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_43FD8409C86BAFF2_TypeDefinitionIndex)->GetStaticField(0x52ED8);
	}
