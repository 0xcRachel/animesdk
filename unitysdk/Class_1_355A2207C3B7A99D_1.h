...
#define CLASS_1_355A2207C3B7A99D_1_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A0D3540)
#define CLASS_1_355A2207C3B7A99D_1_CLONE_OFFSET UNITYSDK_OFFSET(0x1A0D31B0)
#define CLASS_1_355A2207C3B7A99D_1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A0D3390)
#define CLASS_1_355A2207C3B7A99D_1_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A0D32C0)
#define CLASS_1_355A2207C3B7A99D_1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A0D3430)
#define CLASS_1_355A2207C3B7A99D_1_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A0D36A0)
#define CLASS_1_355A2207C3B7A99D_1_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A0D35A0)
#define CLASS_1_355A2207C3B7A99D_1_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x1A0D32A0)
#define CLASS_1_355A2207C3B7A99D_1_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A0D3080)
#define CLASS_1_355A2207C3B7A99D_1_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x1A0D32B0)
#define CLASS_1_355A2207C3B7A99D_1_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A0D30E0)
#define CLASS_1_355A2207C3B7A99D_1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A0D3480)
#define CLASS_1_355A2207C3B7A99D_1_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A0D34E0)
#define CLASS_1_355A2207C3B7A99D_1__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A0D3830)
#define CLASS_1_355A2207C3B7A99D_1__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0D3100)
#define CLASS_1_355A2207C3B7A99D_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0D30F0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_355A2207C3B7A99D_1*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_355A2207C3B7A99D_1_TypeDefinitionIndex)->GetStaticField(0x11320);
	}
	// static const ::System::Int32 Field_1_1 = 0x1; // 0x0
	::Class_1_60477073911AC4F6* Field_1_2; // 0x10
