...
#define CLASS_2_8F3D949759BC929D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1247C860)
#define CLASS_2_8F3D949759BC929D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1247C900)
#define CLASS_2_8F3D949759BC929D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1247C980)
#define CLASS_2_8F3D949759BC929D_TICK_OFFSET UNITYSDK_OFFSET(0x1247C8A0)
#define CLASS_2_8F3D949759BC929D__CTOR_OFFSET UNITYSDK_OFFSET(0x1247C850)
