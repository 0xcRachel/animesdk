...
#define CLASS_2_CE1B1B80A3029ACE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xFCC7C20)
#define CLASS_2_CE1B1B80A3029ACE_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xFCC7780)
#define CLASS_2_CE1B1B80A3029ACE_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xFCC7B70)
#define CLASS_2_CE1B1B80A3029ACE_TICK_OFFSET UNITYSDK_OFFSET(0xFCC7BC0)
#define CLASS_2_CE1B1B80A3029ACE__CTOR_OFFSET UNITYSDK_OFFSET(0xFCC7770)
