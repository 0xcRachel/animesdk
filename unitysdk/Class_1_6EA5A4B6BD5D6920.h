...
#define CLASS_1_6EA5A4B6BD5D6920_CLEAR_OFFSET UNITYSDK_OFFSET(0x15378050)
#define CLASS_1_6EA5A4B6BD5D6920_GETALLSLOTCOUNT_OFFSET UNITYSDK_OFFSET(0x15377D70)
#define CLASS_1_6EA5A4B6BD5D6920_GETLOCKEDUNITS_OFFSET UNITYSDK_OFFSET(0x15377D10)
#define CLASS_1_6EA5A4B6BD5D6920_GETSLOTUNITDATAITEM_OFFSET UNITYSDK_OFFSET(0x15377DD0)
#define CLASS_1_6EA5A4B6BD5D6920_GETSLOTUNITUID_OFFSET UNITYSDK_OFFSET(0x15377F00)
#define CLASS_1_6EA5A4B6BD5D6920_GET_BASICPOWER_OFFSET UNITYSDK_OFFSET(0x15377B90)
#define CLASS_1_6EA5A4B6BD5D6920_GET_EFFECTTYPES_OFFSET UNITYSDK_OFFSET(0x15377CB0)
#define CLASS_1_6EA5A4B6BD5D6920_GET_FUNCTYPE_OFFSET UNITYSDK_OFFSET(0x15377B30)
#define CLASS_1_6EA5A4B6BD5D6920_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x15377B10)
#define CLASS_1_6EA5A4B6BD5D6920_GET_LIMITRANGETYPE_OFFSET UNITYSDK_OFFSET(0x15377C50)
#define CLASS_1_6EA5A4B6BD5D6920_GET_SCEPTERID_OFFSET UNITYSDK_OFFSET(0x15377AF0)
#define CLASS_1_6EA5A4B6BD5D6920_GET_STYLETYPE_OFFSET UNITYSDK_OFFSET(0x15377BF0)
#define CLASS_1_6EA5A4B6BD5D6920_METHOD_1_7569C64E71BFAC8F_OFFSET UNITYSDK_OFFSET(0x15378190)
#define CLASS_1_6EA5A4B6BD5D6920_METHOD_1_B279EAC5AEAF0B47_OFFSET UNITYSDK_OFFSET(0x153780F0)
#define CLASS_1_6EA5A4B6BD5D6920__CTOR_OFFSET UNITYSDK_OFFSET(0x15378270)
