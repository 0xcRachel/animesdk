...
#define CLASS_2_E532346413C9047E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1045B3E0)
#define CLASS_2_E532346413C9047E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1045B160)
#define CLASS_2_E532346413C9047E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1045B350)
#define CLASS_2_E532346413C9047E_TICK_OFFSET UNITYSDK_OFFSET(0x1045B1B0)
#define CLASS_2_E532346413C9047E__CTOR_OFFSET UNITYSDK_OFFSET(0x1045B150)

inline static constexpr unsigned int Class_2_E532346413C9047E_TypeDefinitionIndex = 46429;
