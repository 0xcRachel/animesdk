...
#define CLASS_2_E532346413C9047E_DISPOSE_OFFSET UNITYSDK_OFFSET(0xF474B30)
#define CLASS_2_E532346413C9047E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xF4748B0)
#define CLASS_2_E532346413C9047E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xF474AA0)
#define CLASS_2_E532346413C9047E_TICK_OFFSET UNITYSDK_OFFSET(0xF474900)
#define CLASS_2_E532346413C9047E__CTOR_OFFSET UNITYSDK_OFFSET(0xF4748A0)
...
public:
	...
	::RPG::GameCore::UIMonopolyWaitMainPage* Field_2_0; // 0x20
