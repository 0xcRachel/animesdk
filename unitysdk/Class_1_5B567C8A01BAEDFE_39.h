...
#define CLASS_1_5B567C8A01BAEDFE_39_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19DEB340)
#define CLASS_1_5B567C8A01BAEDFE_39_CLONE_OFFSET UNITYSDK_OFFSET(0x19DEB150)
#define CLASS_1_5B567C8A01BAEDFE_39_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19DEB250)
#define CLASS_1_5B567C8A01BAEDFE_39_EQUALS_OFFSET UNITYSDK_OFFSET(0x19DEB1C0)
#define CLASS_1_5B567C8A01BAEDFE_39_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19DEB2A0)
#define CLASS_1_5B567C8A01BAEDFE_39_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19DEB390)
#define CLASS_1_5B567C8A01BAEDFE_39_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19DEB360)
#define CLASS_1_5B567C8A01BAEDFE_39_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19DEB0A0)
#define CLASS_1_5B567C8A01BAEDFE_39_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19DEB100)
#define CLASS_1_5B567C8A01BAEDFE_39_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19DEB2D0)
#define CLASS_1_5B567C8A01BAEDFE_39_WRITETO_OFFSET UNITYSDK_OFFSET(0x19DEB330)
#define CLASS_1_5B567C8A01BAEDFE_39__CCTOR_OFFSET UNITYSDK_OFFSET(0x19DEB3E0)
#define CLASS_1_5B567C8A01BAEDFE_39__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19DEB120)
#define CLASS_1_5B567C8A01BAEDFE_39__CTOR_OFFSET UNITYSDK_OFFSET(0x19DEB110)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_39*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_39_TypeDefinitionIndex)->GetStaticField(0x76F0);
	}
