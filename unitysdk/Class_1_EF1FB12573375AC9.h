...
#define CLASS_1_EF1FB12573375AC9_GETFIGHTSTATECONFIG_OFFSET UNITYSDK_OFFSET(0xEF8ACF0)
#define CLASS_1_EF1FB12573375AC9_INIT_OFFSET UNITYSDK_OFFSET(0xEF8AD30)
#define CLASS_1_EF1FB12573375AC9_METHOD_1_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xEF8C080)
#define CLASS_1_EF1FB12573375AC9_METHOD_1_507A5122CD01412B_OFFSET UNITYSDK_OFFSET(0xEF8B920)
#define CLASS_1_EF1FB12573375AC9_METHOD_1_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0xEF8B160)
#define CLASS_1_EF1FB12573375AC9_REFRESH_OFFSET UNITYSDK_OFFSET(0xEF8AE20)
#define CLASS_1_EF1FB12573375AC9_RESET_OFFSET UNITYSDK_OFFSET(0xEF8ADD0)
#define CLASS_1_EF1FB12573375AC9__CTOR_OFFSET UNITYSDK_OFFSET(0xEF8C290)
...
{
public:
	::RPG::Client::CameraFightStateCastAnimationConfig* Field_1_2; // 0x10
