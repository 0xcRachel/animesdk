...
#define CLASS_2_8F9E80B05C92C989_COMPARETO_OFFSET UNITYSDK_OFFSET(0xE3F3D30)
#define CLASS_2_8F9E80B05C92C989_TOSTRING_OFFSET UNITYSDK_OFFSET(0xE3F3D90)
#define CLASS_2_8F9E80B05C92C989__CTOR_OFFSET UNITYSDK_OFFSET(0xE3F3CF0)
#define CLASS_2_8F9E80B05C92C989___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0xE3F3E40)
