...
#define CLASS_2_8F9E80B05C92C989_COMPARETO_OFFSET UNITYSDK_OFFSET(0x10608720)
#define CLASS_2_8F9E80B05C92C989_TOSTRING_OFFSET UNITYSDK_OFFSET(0x10608780)
#define CLASS_2_8F9E80B05C92C989__CTOR_OFFSET UNITYSDK_OFFSET(0x106086E0)
#define CLASS_2_8F9E80B05C92C989___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x10608830)
