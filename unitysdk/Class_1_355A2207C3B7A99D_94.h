...
#define CLASS_1_355A2207C3B7A99D_94_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A288FC0)
#define CLASS_1_355A2207C3B7A99D_94_CLONE_OFFSET UNITYSDK_OFFSET(0x1A288BF0)
#define CLASS_1_355A2207C3B7A99D_94_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A288DE0)
#define CLASS_1_355A2207C3B7A99D_94_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A288D10)
#define CLASS_1_355A2207C3B7A99D_94_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A288E80)
#define CLASS_1_355A2207C3B7A99D_94_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A289090)
#define CLASS_1_355A2207C3B7A99D_94_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A289020)
#define CLASS_1_355A2207C3B7A99D_94_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x1A288CF0)
#define CLASS_1_355A2207C3B7A99D_94_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A288AB0)
#define CLASS_1_355A2207C3B7A99D_94_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x1A288D00)
#define CLASS_1_355A2207C3B7A99D_94_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A288B10)
#define CLASS_1_355A2207C3B7A99D_94_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A288F00)
#define CLASS_1_355A2207C3B7A99D_94_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A288F60)
#define CLASS_1_355A2207C3B7A99D_94__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A289120)
#define CLASS_1_355A2207C3B7A99D_94__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A288B30)
#define CLASS_1_355A2207C3B7A99D_94__CTOR_OFFSET UNITYSDK_OFFSET(0x1A288B20)

inline static constexpr unsigned int Class_1_355A2207C3B7A99D_94_TypeDefinitionIndex = 31139;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_355A2207C3B7A99D_94*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_355A2207C3B7A99D_94_TypeDefinitionIndex)->GetStaticField(0xB9B0);
	}
	...
	{
		return ((::Class_1_F11CBE4D3C7DF06D_1*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_355A2207C3B7A99D_94_METHOD_1_24748FC20F375725_OFFSET))(this);
	}

	::System::Void Method_1_8C8625211DA811AE(::Class_1_F11CBE4D3C7DF06D_1* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_F11CBE4D3C7DF06D_1*))((::PBYTE)hIl2Cpp + CLASS_1_355A2207C3B7A99D_94_METHOD_1_8C8625211DA811AE_OFFSET))(this, a1);
	}
