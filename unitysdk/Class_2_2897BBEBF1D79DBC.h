...
#define CLASS_2_2897BBEBF1D79DBC__CTOR_OFFSET UNITYSDK_OFFSET(0x11453BE0)
#define CLASS_2_2897BBEBF1D79DBC__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x11453C80)
#define CLASS_2_2897BBEBF1D79DBC__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x11454180)
#define CLASS_2_2897BBEBF1D79DBC___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x114542C0)
#define CLASS_2_2897BBEBF1D79DBC___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x11454320)
...
public:
	...
	::RPG::View::ActivityAvatarInfoControl* Field_2_0; // 0x48
