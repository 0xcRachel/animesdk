...
#define CLASS_1_A696AB4980B3D7B5_DISPOSE_OFFSET UNITYSDK_OFFSET(0x153274D0)
#define CLASS_1_A696AB4980B3D7B5_DOONENTER_OFFSET UNITYSDK_OFFSET(0x15328C40)
#define CLASS_1_A696AB4980B3D7B5_DOONEXIT_OFFSET UNITYSDK_OFFSET(0x15328CD0)
#define CLASS_1_A696AB4980B3D7B5_GET_CHECKPROPINTERACTMUSTNOTINDANGER_OFFSET UNITYSDK_OFFSET(0x15329E90)
#define CLASS_1_A696AB4980B3D7B5_GET_FORCETRIGGERINDANGERSTATUS_OFFSET UNITYSDK_OFFSET(0x15329F20)
#define CLASS_1_A696AB4980B3D7B5_GET_IGNOREFAKEAVATAR_OFFSET UNITYSDK_OFFSET(0x15329ED0)
#define CLASS_1_A696AB4980B3D7B5_GET_ISNAMEDTRIGGER_OFFSET UNITYSDK_OFFSET(0x15329F40)
#define CLASS_1_A696AB4980B3D7B5_GET_ONLYTRIGGERBYFAKEAVATAR_OFFSET UNITYSDK_OFFSET(0x15329EB0)
#define CLASS_1_A696AB4980B3D7B5_GET__TRIGGERREGION_OFFSET UNITYSDK_OFFSET(0x15329F00)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_00DEF5A164D9A9D5_OFFSET UNITYSDK_OFFSET(0x15329160)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_29689D7471055A3F_OFFSET UNITYSDK_OFFSET(0x153296B0)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_2B3EFEA1C6FD0AA4_OFFSET UNITYSDK_OFFSET(0x15328360)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_3411EC0F4D7F3117_OFFSET UNITYSDK_OFFSET(0x15329D70)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_3993B6742487D922_OFFSET UNITYSDK_OFFSET(0x15327AE0)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_3CAD92CFB876DBF6_OFFSET UNITYSDK_OFFSET(0x15329090)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_3FB378AD48E4B10B_OFFSET UNITYSDK_OFFSET(0x15329340)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_51BB44919003ED8C_OFFSET UNITYSDK_OFFSET(0x15329F60)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_5A42C23111EA7B3C_OFFSET UNITYSDK_OFFSET(0x15328490)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0x15329A90)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_6643AA032101239A_OFFSET UNITYSDK_OFFSET(0x153280B0)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_68337B7DC92048C0_OFFSET UNITYSDK_OFFSET(0x1532A330)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_6E6682ED9FD6F719_OFFSET UNITYSDK_OFFSET(0x15328220)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_6FE6E0587E8D1F5C_OFFSET UNITYSDK_OFFSET(0x153276A0)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_72161A3E817450BF_OFFSET UNITYSDK_OFFSET(0x15328A10)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_75174CC1DC3AB58D_OFFSET UNITYSDK_OFFSET(0x15327480)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_77A5BD15625084BD_OFFSET UNITYSDK_OFFSET(0x1532A520)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_795059A0162B7B8D_OFFSET UNITYSDK_OFFSET(0x15329B80)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_7BEDCFDAB5E3F6D3_OFFSET UNITYSDK_OFFSET(0x153294D0)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_86D9DADC38211793_OFFSET UNITYSDK_OFFSET(0x15328DC0)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_8B6F11557B375B74_1_OFFSET UNITYSDK_OFFSET(0x15327B80)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_8B6F11557B375B74_OFFSET UNITYSDK_OFFSET(0x15327B20)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_8CA05BCD86E125DF_OFFSET UNITYSDK_OFFSET(0x153275D0)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_8E21B63E1A7B6A25_OFFSET UNITYSDK_OFFSET(0x15327870)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_9816C66A3786670A_OFFSET UNITYSDK_OFFSET(0x15329B20)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0x15327F80)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_A5BBC63CF87EB78F_OFFSET UNITYSDK_OFFSET(0x15327BE0)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_A75B4838E132C727_OFFSET UNITYSDK_OFFSET(0x15327970)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_BCDCE74455CC103E_OFFSET UNITYSDK_OFFSET(0x153294C0)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_C0FF32B4D2022F8C_OFFSET UNITYSDK_OFFSET(0x15328010)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_C348049DE90BD88C_1_OFFSET UNITYSDK_OFFSET(0x153299E0)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_C348049DE90BD88C_OFFSET UNITYSDK_OFFSET(0x15329930)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_C7C8E8CA7C1063A4_OFFSET UNITYSDK_OFFSET(0x15329E00)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_D9136EC4788E091A_OFFSET UNITYSDK_OFFSET(0x15327A90)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_E8302C157AFBAD54_OFFSET UNITYSDK_OFFSET(0x15328D60)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_F434B801DC06B848_OFFSET UNITYSDK_OFFSET(0x1532A210)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_FB7E543833A43955_OFFSET UNITYSDK_OFFSET(0x15329EF0)
#define CLASS_1_A696AB4980B3D7B5_METHOD_1_FC0E494BF9D6301C_OFFSET UNITYSDK_OFFSET(0x1532A0D0)
#define CLASS_1_A696AB4980B3D7B5_ONTRIGGEREDLOGICFINISH_OFFSET UNITYSDK_OFFSET(0x15328870)
#define CLASS_1_A696AB4980B3D7B5_SET_CHECKPROPINTERACTMUSTNOTINDANGER_OFFSET UNITYSDK_OFFSET(0x15329EA0)
#define CLASS_1_A696AB4980B3D7B5_SET_FORCETRIGGERINDANGERSTATUS_OFFSET UNITYSDK_OFFSET(0x15329F30)
#define CLASS_1_A696AB4980B3D7B5_SET_IGNOREFAKEAVATAR_OFFSET UNITYSDK_OFFSET(0x15329EE0)
#define CLASS_1_A696AB4980B3D7B5_SET_ISNAMEDTRIGGER_OFFSET UNITYSDK_OFFSET(0x15329F50)
#define CLASS_1_A696AB4980B3D7B5_SET_ONLYTRIGGERBYFAKEAVATAR_OFFSET UNITYSDK_OFFSET(0x15329EC0)
#define CLASS_1_A696AB4980B3D7B5_SET__TRIGGERREGION_OFFSET UNITYSDK_OFFSET(0x15329F10)
#define CLASS_1_A696AB4980B3D7B5_TICK_OFFSET UNITYSDK_OFFSET(0x153288F0)
#define CLASS_1_A696AB4980B3D7B5__CCTOR_OFFSET UNITYSDK_OFFSET(0x1532A740)
#define CLASS_1_A696AB4980B3D7B5__CTOR_OFFSET UNITYSDK_OFFSET(0x153272F0)
...
public:
	...
	{
		return (::RPG::GameCore::TriggerValidGuestConfig**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A696AB4980B3D7B5_TypeDefinitionIndex)->GetStaticField(0x17920);
	}
	::System::Predicate_1<::RPG::GameCore::GameEntity*>* Field_1_1; // 0x10
	::RPG::GameCore::PredicateConfig* Field_1_2; // 0x18
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::GameCore::GameEntity*>* Field_1_3; // 0x20
	::System::Action_2<::Class_0_16E4307DCC419505_546*, ::System::Boolean>* Field_1_4; // 0x28
	::RPG::Client::BaseMonoTriggerRegion* __TriggerRegion_k__BackingField; // 0x30
	::UnityEngine::Coroutine* Field_1_6; // 0x38
	::RPG::GameCore::TriggerValidGuestConfig* Field_1_7; // 0x40
	::RPG::GameCore::ColliderTriggerComponent* Field_1_8; // 0x48
	::Il2CppArray<::System::UInt32>* Field_1_9; // 0x50
	::System::Action_3<::Class_1_A696AB4980B3D7B5*, ::RPG::GameCore::GameEntity*, ::System::Boolean>* Field_1_10; // 0x58
	::RPG::GameCore::PredicateConfig* Field_1_11; // 0x60
	...
	::System::Boolean _CheckPropInteractMustNotInDanger_k__BackingField; // 0x88
	::System::Boolean Field_1_17; // 0x89
	::System::Boolean Field_1_18; // 0x8A
	::System::Boolean _IsNamedTrigger_k__BackingField; // 0x8B
	...
	::System::Boolean _OnlyTriggerByFakeAvatar_k__BackingField; // 0x93
