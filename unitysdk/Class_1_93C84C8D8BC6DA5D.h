...
#define CLASS_1_93C84C8D8BC6DA5D_GET_SORTLISTS_OFFSET UNITYSDK_OFFSET(0x10C77C40)
#define CLASS_1_93C84C8D8BC6DA5D_METHOD_1_5B81A347C4B6B422_OFFSET UNITYSDK_OFFSET(0x10C77BF0)
#define CLASS_1_93C84C8D8BC6DA5D_SET_SORTLISTS_OFFSET UNITYSDK_OFFSET(0x10C77C50)
#define CLASS_1_93C84C8D8BC6DA5D__CTOR_OFFSET UNITYSDK_OFFSET(0x10C77C60)

inline static constexpr unsigned int Class_1_93C84C8D8BC6DA5D_TypeDefinitionIndex = 42311;
