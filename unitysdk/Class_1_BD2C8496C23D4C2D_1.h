...
#define CLASS_1_BD2C8496C23D4C2D_1_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17BBBD30)
#define CLASS_1_BD2C8496C23D4C2D_1_CLONE_OFFSET UNITYSDK_OFFSET(0x17BBB9F0)
#define CLASS_1_BD2C8496C23D4C2D_1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17BBBB50)
#define CLASS_1_BD2C8496C23D4C2D_1_EQUALS_OFFSET UNITYSDK_OFFSET(0x17BBBA90)
#define CLASS_1_BD2C8496C23D4C2D_1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17BBBBE0)
#define CLASS_1_BD2C8496C23D4C2D_1_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x17BBBE20)
#define CLASS_1_BD2C8496C23D4C2D_1_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x17BBBDD0)
#define CLASS_1_BD2C8496C23D4C2D_1_METHOD_1_EA98AC27B86895E5_OFFSET UNITYSDK_OFFSET(0x17BBBA80)
#define CLASS_1_BD2C8496C23D4C2D_1_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17BBB940)
#define CLASS_1_BD2C8496C23D4C2D_1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17BBBC20)
#define CLASS_1_BD2C8496C23D4C2D_1_WRITETO_OFFSET UNITYSDK_OFFSET(0x17BBBC80)
#define CLASS_1_BD2C8496C23D4C2D_1__CCTOR_OFFSET UNITYSDK_OFFSET(0x17BBBEF0)
#define CLASS_1_BD2C8496C23D4C2D_1__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17BBB980)
#define CLASS_1_BD2C8496C23D4C2D_1__CTOR_OFFSET UNITYSDK_OFFSET(0x17BBB950)
...
public:
	...
	{
		return (::Google::Protobuf::Collections::MapField_2_Codec<::System::UInt32, ::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_BD2C8496C23D4C2D_1_TypeDefinitionIndex)->GetStaticField(0x380E0);
	}
