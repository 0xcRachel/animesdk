...
#define CLASS_1_5B567C8A01BAEDFE_115_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19B54E30)
#define CLASS_1_5B567C8A01BAEDFE_115_CLONE_OFFSET UNITYSDK_OFFSET(0x19B54CA0)
#define CLASS_1_5B567C8A01BAEDFE_115_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19B54D40)
#define CLASS_1_5B567C8A01BAEDFE_115_EQUALS_OFFSET UNITYSDK_OFFSET(0x19B54CE0)
#define CLASS_1_5B567C8A01BAEDFE_115_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19B54D90)
#define CLASS_1_5B567C8A01BAEDFE_115_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19B54E80)
#define CLASS_1_5B567C8A01BAEDFE_115_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19B54E50)
#define CLASS_1_5B567C8A01BAEDFE_115_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19B54C20)
#define CLASS_1_5B567C8A01BAEDFE_115_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19B54C50)
#define CLASS_1_5B567C8A01BAEDFE_115_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19B54DC0)
#define CLASS_1_5B567C8A01BAEDFE_115_WRITETO_OFFSET UNITYSDK_OFFSET(0x19B54E20)
#define CLASS_1_5B567C8A01BAEDFE_115__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B54ED0)
#define CLASS_1_5B567C8A01BAEDFE_115__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19B54C70)
#define CLASS_1_5B567C8A01BAEDFE_115__CTOR_OFFSET UNITYSDK_OFFSET(0x19B54C60)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_115*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_115_TypeDefinitionIndex)->GetStaticField(0x575D0);
	}
