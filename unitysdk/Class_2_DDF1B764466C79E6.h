...
#define CLASS_2_DDF1B764466C79E6_METHOD_2_16E792B668863BDD_OFFSET UNITYSDK_OFFSET(0xEEC79F0)
#define CLASS_2_DDF1B764466C79E6__CTOR_OFFSET UNITYSDK_OFFSET(0xEEC7A70)

inline static constexpr unsigned int Class_2_DDF1B764466C79E6_TypeDefinitionIndex = 71257;

class Class_2_DDF1B764466C79E6 : public ::Class_1_43BD383C98B4C0C5_182
{
public:
	::RPG::Client::LittleGame::ChimeraDuel::ChimeraDuelChimeraCache* Field_2_0; // 0x10
	::RPG::GameCore::ChimeraDuelCreateChimeraNode* Field_2_2; // 0x18
	::System::Collections::Generic::List_1<::RPG::Client::LittleGame::ChimeraDuel::ChimeraDuelChimeraCache*>* Field_2_1; // 0x20
