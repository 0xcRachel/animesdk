...
#define CLASS_2_A34849047BC566C5_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB2C9E50)
#define CLASS_2_A34849047BC566C5_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xB2CA4E0)
#define CLASS_2_A34849047BC566C5_METHOD_2_B952F274CF4C33C6_OFFSET UNITYSDK_OFFSET(0xB2CA410)
#define CLASS_2_A34849047BC566C5_METHOD_2_E5D433C7A574E387_OFFSET UNITYSDK_OFFSET(0xB2CA080)
#define CLASS_2_A34849047BC566C5_METHOD_2_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0xB2CA170)
#define CLASS_2_A34849047BC566C5_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB2C9F30)
#define CLASS_2_A34849047BC566C5_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB2C9EE0)
#define CLASS_2_A34849047BC566C5_TICK_OFFSET UNITYSDK_OFFSET(0xB2CA270)
#define CLASS_2_A34849047BC566C5__CTOR_OFFSET UNITYSDK_OFFSET(0xB2C9DD0)

inline static constexpr unsigned int Class_2_A34849047BC566C5_TypeDefinitionIndex = 42266;

class Class_2_A34849047BC566C5 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::WaitPropDestroy* Field_2_1; // 0x18
