...
#define CLASS_2_ECF1340EBC7B24C4_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB8B6C20)
#define CLASS_2_ECF1340EBC7B24C4_METHOD_2_7B0A407379BA27E7_OFFSET UNITYSDK_OFFSET(0xB8B6D50)
#define CLASS_2_ECF1340EBC7B24C4_METHOD_2_DAE67D4DC8B67113_1_OFFSET UNITYSDK_OFFSET(0xB8B73A0)
#define CLASS_2_ECF1340EBC7B24C4_METHOD_2_DAE67D4DC8B67113_OFFSET UNITYSDK_OFFSET(0xB8B7210)
#define CLASS_2_ECF1340EBC7B24C4_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB8B6C70)
#define CLASS_2_ECF1340EBC7B24C4_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB8B7150)
#define CLASS_2_ECF1340EBC7B24C4_TICK_OFFSET UNITYSDK_OFFSET(0xB8B71B0)
#define CLASS_2_ECF1340EBC7B24C4__CTOR_OFFSET UNITYSDK_OFFSET(0xB8B6B50)
...
public:
	...
	::RPG::GameCore::AdventureSkillCharacterComponent* Field_2_2; // 0x30
