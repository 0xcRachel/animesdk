...
#define CLASS_2_ECF1340EBC7B24C4_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB2D7B90)
#define CLASS_2_ECF1340EBC7B24C4_METHOD_2_7B0A407379BA27E7_OFFSET UNITYSDK_OFFSET(0xB2D7CC0)
#define CLASS_2_ECF1340EBC7B24C4_METHOD_2_DAE67D4DC8B67113_1_OFFSET UNITYSDK_OFFSET(0xB2D8310)
#define CLASS_2_ECF1340EBC7B24C4_METHOD_2_DAE67D4DC8B67113_OFFSET UNITYSDK_OFFSET(0xB2D8180)
#define CLASS_2_ECF1340EBC7B24C4_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB2D7BE0)
#define CLASS_2_ECF1340EBC7B24C4_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB2D80C0)
#define CLASS_2_ECF1340EBC7B24C4_TICK_OFFSET UNITYSDK_OFFSET(0xB2D8120)
#define CLASS_2_ECF1340EBC7B24C4__CTOR_OFFSET UNITYSDK_OFFSET(0xB2D7AC0)

inline static constexpr unsigned int Class_2_ECF1340EBC7B24C4_TypeDefinitionIndex = 41417;

class Class_2_ECF1340EBC7B24C4 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::AdventureSkillCharacterComponent* Field_2_2; // 0x18
