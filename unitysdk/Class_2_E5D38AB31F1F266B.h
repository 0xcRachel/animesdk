...
#define CLASS_2_E5D38AB31F1F266B_METHOD_2_BB96740FC520E8ED_OFFSET UNITYSDK_OFFSET(0x16E30020)
#define CLASS_2_E5D38AB31F1F266B__CTOR_OFFSET UNITYSDK_OFFSET(0x16E30410)

inline static constexpr unsigned int Class_2_E5D38AB31F1F266B_TypeDefinitionIndex = 20513;

class Class_2_E5D38AB31F1F266B : public ::RPG::GameCore::JsonConfig
{
public:
	::RPG::GameCore::DynamicFloat* Field_2_1; // 0x10
	::RPG::GameCore::DynamicFloat* Field_2_3; // 0x18
	::RPG::GameCore::DynamicFloat* Field_2_5; // 0x20
	::RPG::GameCore::DynamicFloat* Field_2_0; // 0x28
	::RPG::GameCore::DynamicFloat* Field_2_4; // 0x30
	::RPG::GameCore::DynamicFloat* Field_2_2; // 0x38
