...
#define CLASS_2_7C9D4383288836B4_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17F4FAD0)
#define CLASS_2_7C9D4383288836B4_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17F4FB10)
#define CLASS_2_7C9D4383288836B4_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x17F4FBB0)
#define CLASS_2_7C9D4383288836B4_TICK_OFFSET UNITYSDK_OFFSET(0x17F4FC00)
#define CLASS_2_7C9D4383288836B4__CTOR_OFFSET UNITYSDK_OFFSET(0x17F4FAC0)
...
public:
	...
	::RPG::GameCore::ShowBattleUI* Field_2_1; // 0x18
