...
#define CLASS_2_F7A78C4D86B65E8D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1035B230)
#define CLASS_2_F7A78C4D86B65E8D_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x1035BB60)
#define CLASS_2_F7A78C4D86B65E8D_METHOD_2_5D99099B99F1668A_OFFSET UNITYSDK_OFFSET(0x1035B7D0)
#define CLASS_2_F7A78C4D86B65E8D_METHOD_2_688BE5E8E681071A_OFFSET UNITYSDK_OFFSET(0x1035B290)
#define CLASS_2_F7A78C4D86B65E8D_METHOD_2_A7DA7E520D3F52A3_OFFSET UNITYSDK_OFFSET(0x1035B700)
#define CLASS_2_F7A78C4D86B65E8D_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1035BBE0)
#define CLASS_2_F7A78C4D86B65E8D_METHOD_2_DF4A3B8481FEB8BF_OFFSET UNITYSDK_OFFSET(0x1035B320)
#define CLASS_2_F7A78C4D86B65E8D_ONSKIP_OFFSET UNITYSDK_OFFSET(0x1035BB70)
#define CLASS_2_F7A78C4D86B65E8D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1035B3A0)
#define CLASS_2_F7A78C4D86B65E8D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1035BA90)
#define CLASS_2_F7A78C4D86B65E8D_SETNEXTTASK_OFFSET UNITYSDK_OFFSET(0x1035B2D0)
#define CLASS_2_F7A78C4D86B65E8D_TICK_OFFSET UNITYSDK_OFFSET(0x1035BB00)
#define CLASS_2_F7A78C4D86B65E8D__CTOR_OFFSET UNITYSDK_OFFSET(0x1035B210)

inline static constexpr unsigned int Class_2_F7A78C4D86B65E8D_TypeDefinitionIndex = 42237;

class Class_2_F7A78C4D86B65E8D : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::TriggerPerformance* Field_2_0; // 0x20
	::Class_3_BCCE950C2E8DF1F0* Field_2_3; // 0x28
	::RPG::Client::PerformanceManager* Field_2_5; // 0x30
	::Class_1_5F51D4049EA87B7B* Field_2_2; // 0x38
	::RPG::Client::AdventurePhase* Field_2_4; // 0x40
