...
#define CLASS_2_FC15238330920B22_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA1FA9D0)
#define CLASS_2_FC15238330920B22_METHOD_2_6096CA3BC11444EA_OFFSET UNITYSDK_OFFSET(0xA1FAA90)
#define CLASS_2_FC15238330920B22_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xA1FA8E0)
#define CLASS_2_FC15238330920B22_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xA1FA980)
#define CLASS_2_FC15238330920B22_TICK_OFFSET UNITYSDK_OFFSET(0xA1FAC60)
#define CLASS_2_FC15238330920B22__CTOR_OFFSET UNITYSDK_OFFSET(0xA1FA850)
...
{
public:
	::RPG::GameCore::MarbleSimulateListener* Field_2_1; // 0x18
