...
#define CLASS_2_B8BC9DA575C7FD8D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11381F40)
#define CLASS_2_B8BC9DA575C7FD8D_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x11381F80)
#define CLASS_2_B8BC9DA575C7FD8D_ONSKIP_OFFSET UNITYSDK_OFFSET(0x11382100)
#define CLASS_2_B8BC9DA575C7FD8D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11381F90)
#define CLASS_2_B8BC9DA575C7FD8D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x11382000)
#define CLASS_2_B8BC9DA575C7FD8D_TICK_OFFSET UNITYSDK_OFFSET(0x11382050)
#define CLASS_2_B8BC9DA575C7FD8D__CTOR_OFFSET UNITYSDK_OFFSET(0x11381F30)
...
public:
	...
	::RPG::GameCore::WaitFrame* Field_2_0; // 0x20
