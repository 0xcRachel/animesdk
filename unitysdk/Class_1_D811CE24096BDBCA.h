...
#define CLASS_1_D811CE24096BDBCA_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A6715B0)
#define CLASS_1_D811CE24096BDBCA_CLONE_OFFSET UNITYSDK_OFFSET(0x1A671200)
#define CLASS_1_D811CE24096BDBCA_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A6713D0)
#define CLASS_1_D811CE24096BDBCA_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A6712F0)
#define CLASS_1_D811CE24096BDBCA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A671480)
#define CLASS_1_D811CE24096BDBCA_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A671790)
#define CLASS_1_D811CE24096BDBCA_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A671680)
#define CLASS_1_D811CE24096BDBCA_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1A6712D0)
#define CLASS_1_D811CE24096BDBCA_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x1A6712B0)
#define CLASS_1_D811CE24096BDBCA_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A671110)
#define CLASS_1_D811CE24096BDBCA_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1A6712E0)
#define CLASS_1_D811CE24096BDBCA_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x1A6712C0)
#define CLASS_1_D811CE24096BDBCA_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A671170)
#define CLASS_1_D811CE24096BDBCA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A6714D0)
#define CLASS_1_D811CE24096BDBCA_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A671530)
#define CLASS_1_D811CE24096BDBCA__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A671960)
#define CLASS_1_D811CE24096BDBCA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A671190)
#define CLASS_1_D811CE24096BDBCA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A671180)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_D811CE24096BDBCA*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_D811CE24096BDBCA_TypeDefinitionIndex)->GetStaticField(0x11FF0);
	}
	// static const ::System::Int32 Field_1_1 = 0xA; // 0x0
	// static const ::System::Int32 Field_1_2 = 0x4; // 0x0
	::Class_1_7E9AC8675DA072FB* Field_1_3; // 0x10
