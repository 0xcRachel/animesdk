...
#define CLASS_1_0AD6129525BF5F86_DISPOSE_OFFSET UNITYSDK_OFFSET(0x96CE300)
#define CLASS_1_0AD6129525BF5F86_GET_DATABEHAVIORTYPE_OFFSET UNITYSDK_OFFSET(0x96CFDD0)
#define CLASS_1_0AD6129525BF5F86_GET_DATAREF_OFFSET UNITYSDK_OFFSET(0x96CFDB0)
#define CLASS_1_0AD6129525BF5F86_GET_ENSURECALLBACKORDER_OFFSET UNITYSDK_OFFSET(0x96CFE70)
#define CLASS_1_0AD6129525BF5F86_GET_ID_OFFSET UNITYSDK_OFFSET(0x96CFF10)
#define CLASS_1_0AD6129525BF5F86_GET_ISHIT_OFFSET UNITYSDK_OFFSET(0x96CFDF0)
#define CLASS_1_0AD6129525BF5F86_GET_ONPROJECTILEHIT_OFFSET UNITYSDK_OFFSET(0x96CFE10)
#define CLASS_1_0AD6129525BF5F86_GET_ONPROJECTILELIFETIMEFINISH_OFFSET UNITYSDK_OFFSET(0x96CFE30)
#define CLASS_1_0AD6129525BF5F86_GET_OWNERABILITYREF_OFFSET UNITYSDK_OFFSET(0x96CFD90)
#define CLASS_1_0AD6129525BF5F86_GET_OWNERENTITY_OFFSET UNITYSDK_OFFSET(0x96CFD70)
#define CLASS_1_0AD6129525BF5F86_GET_PREVIOUSPROJECTILE_OFFSET UNITYSDK_OFFSET(0x96CFE90)
#define CLASS_1_0AD6129525BF5F86_GET_SKILLCONTEXT_OFFSET UNITYSDK_OFFSET(0x96CFE50)
#define CLASS_1_0AD6129525BF5F86_GET_STATE_OFFSET UNITYSDK_OFFSET(0x96CFD10)
#define CLASS_1_0AD6129525BF5F86_GET_TARGETENTITY_OFFSET UNITYSDK_OFFSET(0x96CFD30)
#define CLASS_1_0AD6129525BF5F86_GET_TARGETPOSENTITY_OFFSET UNITYSDK_OFFSET(0x96CFD50)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_0522806FC511AD84_OFFSET UNITYSDK_OFFSET(0x96CE9E0)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x96CFEB0)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_21378A7EB1BCB13B_OFFSET UNITYSDK_OFFSET(0x96D15F0)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_218F2836DA51D562_OFFSET UNITYSDK_OFFSET(0x96CFC00)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_21F6EDFB46EAF49A_OFFSET UNITYSDK_OFFSET(0x96CDCA0)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x96CFC40)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x96D1190)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_4E140453C4B32F06_OFFSET UNITYSDK_OFFSET(0x96CE570)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_82D02CA55C2C5E94_OFFSET UNITYSDK_OFFSET(0x96CE760)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x96CE660)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_8AB82AB9C7395DBE_OFFSET UNITYSDK_OFFSET(0x96CE890)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_8FAD57395F26ACC4_OFFSET UNITYSDK_OFFSET(0x96CE5E0)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x96CDBB0)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_A1F9BFB7EBB25DAC_OFFSET UNITYSDK_OFFSET(0x96D12B0)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_A6544B958241856F_OFFSET UNITYSDK_OFFSET(0x96CE3E0)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_ACA976655D1FA5D6_OFFSET UNITYSDK_OFFSET(0x96CEED0)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x96CE6E0)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_C38DE0E34C398638_OFFSET UNITYSDK_OFFSET(0x96D1540)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x96CE9A0)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_CE1B8140CA2F0094_OFFSET UNITYSDK_OFFSET(0x96CEC70)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_E039AACD19FA80B7_OFFSET UNITYSDK_OFFSET(0x96CFF30)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_E07E9A00A7781C2A_OFFSET UNITYSDK_OFFSET(0x96CFC90)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_F550433FDBCEA79D_OFFSET UNITYSDK_OFFSET(0x96D0710)
#define CLASS_1_0AD6129525BF5F86_SET_DATABEHAVIORTYPE_OFFSET UNITYSDK_OFFSET(0x96CFDE0)
#define CLASS_1_0AD6129525BF5F86_SET_DATAREF_OFFSET UNITYSDK_OFFSET(0x96CFDC0)
#define CLASS_1_0AD6129525BF5F86_SET_ENSURECALLBACKORDER_OFFSET UNITYSDK_OFFSET(0x96CFE80)
#define CLASS_1_0AD6129525BF5F86_SET_ID_OFFSET UNITYSDK_OFFSET(0x96CFF20)
#define CLASS_1_0AD6129525BF5F86_SET_ISHIT_OFFSET UNITYSDK_OFFSET(0x96CFE00)
#define CLASS_1_0AD6129525BF5F86_SET_ONPROJECTILEHIT_OFFSET UNITYSDK_OFFSET(0x96CFE20)
#define CLASS_1_0AD6129525BF5F86_SET_ONPROJECTILELIFETIMEFINISH_OFFSET UNITYSDK_OFFSET(0x96CFE40)
#define CLASS_1_0AD6129525BF5F86_SET_OWNERABILITYREF_OFFSET UNITYSDK_OFFSET(0x96CFDA0)
#define CLASS_1_0AD6129525BF5F86_SET_OWNERENTITY_OFFSET UNITYSDK_OFFSET(0x96CFD80)
#define CLASS_1_0AD6129525BF5F86_SET_PREVIOUSPROJECTILE_OFFSET UNITYSDK_OFFSET(0x96CFEA0)
#define CLASS_1_0AD6129525BF5F86_SET_SKILLCONTEXT_OFFSET UNITYSDK_OFFSET(0x96CFE60)
#define CLASS_1_0AD6129525BF5F86_SET_STATE_OFFSET UNITYSDK_OFFSET(0x96CFD20)
#define CLASS_1_0AD6129525BF5F86_SET_TARGETENTITY_OFFSET UNITYSDK_OFFSET(0x96CFD40)
#define CLASS_1_0AD6129525BF5F86_SET_TARGETPOSENTITY_OFFSET UNITYSDK_OFFSET(0x96CFD60)
#define CLASS_1_0AD6129525BF5F86__CCTOR_OFFSET UNITYSDK_OFFSET(0x96D1800)
#define CLASS_1_0AD6129525BF5F86__CTOR_OFFSET UNITYSDK_OFFSET(0x96CDE20)
#define CLASS_1_0AD6129525BF5F86___CTOR_B__4_0_OFFSET UNITYSDK_OFFSET(0x96D18C0)

inline static constexpr unsigned int Class_1_0AD6129525BF5F86_TypeDefinitionIndex = 42771;
...
public:
	...
	{
		return (::RPG::GameCore::ProjectileTemplateConfig**)Il2CppClass::FromTypeDefinitionIndex(Class_1_0AD6129525BF5F86_TypeDefinitionIndex)->GetStaticField(0x42CD0);
	}
	static ::RPG::GameCore::ColliderConfig** StaticGet_Field_1_0()
	{
		return (::RPG::GameCore::ColliderConfig**)Il2CppClass::FromTypeDefinitionIndex(Class_1_0AD6129525BF5F86_TypeDefinitionIndex)->GetStaticField(0x42CD8);
	}
	static ::System::String** StaticGet_Field_1_39()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_0AD6129525BF5F86_TypeDefinitionIndex)->GetStaticField(0x42CE0);
	}
	static ::Il2CppArray<::UnityEngine::Collider*>** StaticGet_Field_1_42()
	{
		return (::Il2CppArray<::UnityEngine::Collider*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_0AD6129525BF5F86_TypeDefinitionIndex)->GetStaticField(0x42CE8);
	}
	static ::System::Int32* StaticGet_Field_1_33()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_0AD6129525BF5F86_TypeDefinitionIndex)->GetStaticField(0xF6C0);
	}
	static ::System::Int32* StaticGet_Field_1_40()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_0AD6129525BF5F86_TypeDefinitionIndex)->GetStaticField(0xF6C4);
	}
	::Class_3_98C806684F7CC372_8* _OnProjectileLifetimeFinish_k__BackingField; // 0x10
	::Class_1_A2D8E5AB4B623162* _OwnerAbilityRef_k__BackingField; // 0x18
	::RPG::GameCore::GameEntity* _TargetEntity_k__BackingField; // 0x20
	::Class_1_2B8E0B4950FE44E7* _SkillContext_k__BackingField; // 0x28
	::UnityEngine::Rigidbody* Field_1_37; // 0x30
	::RPG::GameCore::GameEntity* _OwnerEntity_k__BackingField; // 0x38
	::Class_3_98C806684F7CC372_7* _OnProjectileHit_k__BackingField; // 0x40
	::UnityEngine::GameObject* Field_1_30; // 0x48
	::System::String* Field_1_15; // 0x50
	::Class_1_1835888C1E19F013* Field_1_26; // 0x58
	::RPG::GameCore::NewProjectileConfig* _DataRef_k__BackingField; // 0x60
	::Class_1_0AD6129525BF5F86* _PreviousProjectile_k__BackingField; // 0x68
	::System::String* Field_1_27; // 0x70
	::UnityEngine::Transform* Field_1_31; // 0x78
	::RPG::Client::MonoProjectileEffect* Field_1_28; // 0x80
	::UnityEngine::Animator* Field_1_36; // 0x88
	::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* Field_1_34; // 0x90
	::RPG::GameCore::GameEntity* _TargetPosEntity_k__BackingField; // 0x98
	::UnityEngine::Vector3 Field_1_22; // 0xA0
	::System::Int32 _ID_k__BackingField; // 0xAC
	::UnityEngine::Vector3 Field_1_16; // 0xB0
	::UnityEngine::Vector3 Field_1_17; // 0xBC
	::UnityEngine::Vector3 Field_1_21; // 0xC8
	::UnityEngine::Vector3 Field_1_25; // 0xD4
	::Struct_2_1C6CD3A917B08105 Field_1_41; // 0xE0
	::UnityEngine::Vector3 Field_1_23; // 0xE8
	::UnityEngine::Vector3 Field_1_19; // 0xF4
	::RPG::GameCore::ProjectileState _State_k__BackingField; // 0x100
	::System::Int32 Field_1_38; // 0x104
	::UnityEngine::Vector3 Field_1_24; // 0x108
	::System::Single Field_1_35; // 0x114
	::UnityEngine::Vector3 Field_1_18; // 0x118
	::UnityEngine::Vector3 Field_1_20; // 0x124
	::RPG::GameCore::ProjectileMoveBehavior _DataBehaviorType_k__BackingField; // 0x130
	::System::Boolean Field_1_29; // 0x134
	::System::Boolean _EnsureCallbackOrder_k__BackingField; // 0x135
	::System::Boolean _IsHit_k__BackingField; // 0x136
	...
	::Class_0_16E4307DCC419505_304* Method_1_218F2836DA51D562()
	{
		return ((::Class_0_16E4307DCC419505_304*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_0AD6129525BF5F86_METHOD_1_218F2836DA51D562_OFFSET))(this);
	}
