...
#define CLASS_1_0AD6129525BF5F86_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8C86820)
#define CLASS_1_0AD6129525BF5F86_GET_DATABEHAVIORTYPE_OFFSET UNITYSDK_OFFSET(0x8C88300)
#define CLASS_1_0AD6129525BF5F86_GET_DATAREF_OFFSET UNITYSDK_OFFSET(0x8C882E0)
#define CLASS_1_0AD6129525BF5F86_GET_ENSURECALLBACKORDER_OFFSET UNITYSDK_OFFSET(0x8C883A0)
#define CLASS_1_0AD6129525BF5F86_GET_ID_OFFSET UNITYSDK_OFFSET(0x8C88440)
#define CLASS_1_0AD6129525BF5F86_GET_ISHIT_OFFSET UNITYSDK_OFFSET(0x8C88320)
#define CLASS_1_0AD6129525BF5F86_GET_ONPROJECTILEHIT_OFFSET UNITYSDK_OFFSET(0x8C88340)
#define CLASS_1_0AD6129525BF5F86_GET_ONPROJECTILELIFETIMEFINISH_OFFSET UNITYSDK_OFFSET(0x8C88360)
#define CLASS_1_0AD6129525BF5F86_GET_OWNERABILITYREF_OFFSET UNITYSDK_OFFSET(0x8C882C0)
#define CLASS_1_0AD6129525BF5F86_GET_OWNERENTITY_OFFSET UNITYSDK_OFFSET(0x8C882A0)
#define CLASS_1_0AD6129525BF5F86_GET_PREVIOUSPROJECTILE_OFFSET UNITYSDK_OFFSET(0x8C883C0)
#define CLASS_1_0AD6129525BF5F86_GET_SKILLCONTEXT_OFFSET UNITYSDK_OFFSET(0x8C88380)
#define CLASS_1_0AD6129525BF5F86_GET_STATE_OFFSET UNITYSDK_OFFSET(0x8C88240)
#define CLASS_1_0AD6129525BF5F86_GET_TARGETENTITY_OFFSET UNITYSDK_OFFSET(0x8C88260)
#define CLASS_1_0AD6129525BF5F86_GET_TARGETPOSENTITY_OFFSET UNITYSDK_OFFSET(0x8C88280)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_0522806FC511AD84_OFFSET UNITYSDK_OFFSET(0x8C86F10)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x8C883E0)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_21378A7EB1BCB13B_OFFSET UNITYSDK_OFFSET(0x8C89B70)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_218F2836DA51D562_OFFSET UNITYSDK_OFFSET(0x8C88130)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_21F6EDFB46EAF49A_OFFSET UNITYSDK_OFFSET(0x8C861A0)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x8C88170)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x8C89720)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_4E140453C4B32F06_OFFSET UNITYSDK_OFFSET(0x8C86AA0)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_82D02CA55C2C5E94_OFFSET UNITYSDK_OFFSET(0x8C86C90)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x8C86B90)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_8AB82AB9C7395DBE_OFFSET UNITYSDK_OFFSET(0x8C86DC0)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_8FAD57395F26ACC4_OFFSET UNITYSDK_OFFSET(0x8C86B10)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x8C860B0)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_A1F9BFB7EBB25DAC_OFFSET UNITYSDK_OFFSET(0x8C89840)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_A6544B958241856F_OFFSET UNITYSDK_OFFSET(0x8C86900)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_ACA976655D1FA5D6_OFFSET UNITYSDK_OFFSET(0x8C87400)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x8C86C10)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_C38DE0E34C398638_OFFSET UNITYSDK_OFFSET(0x8C89AC0)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x8C86ED0)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_CE1B8140CA2F0094_OFFSET UNITYSDK_OFFSET(0x8C871A0)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_E039AACD19FA80B7_OFFSET UNITYSDK_OFFSET(0x8C88460)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_E07E9A00A7781C2A_OFFSET UNITYSDK_OFFSET(0x8C881C0)
#define CLASS_1_0AD6129525BF5F86_METHOD_1_F550433FDBCEA79D_OFFSET UNITYSDK_OFFSET(0x8C88CA0)
#define CLASS_1_0AD6129525BF5F86_SET_DATABEHAVIORTYPE_OFFSET UNITYSDK_OFFSET(0x8C88310)
#define CLASS_1_0AD6129525BF5F86_SET_DATAREF_OFFSET UNITYSDK_OFFSET(0x8C882F0)
#define CLASS_1_0AD6129525BF5F86_SET_ENSURECALLBACKORDER_OFFSET UNITYSDK_OFFSET(0x8C883B0)
#define CLASS_1_0AD6129525BF5F86_SET_ID_OFFSET UNITYSDK_OFFSET(0x8C88450)
#define CLASS_1_0AD6129525BF5F86_SET_ISHIT_OFFSET UNITYSDK_OFFSET(0x8C88330)
#define CLASS_1_0AD6129525BF5F86_SET_ONPROJECTILEHIT_OFFSET UNITYSDK_OFFSET(0x8C88350)
#define CLASS_1_0AD6129525BF5F86_SET_ONPROJECTILELIFETIMEFINISH_OFFSET UNITYSDK_OFFSET(0x8C88370)
#define CLASS_1_0AD6129525BF5F86_SET_OWNERABILITYREF_OFFSET UNITYSDK_OFFSET(0x8C882D0)
#define CLASS_1_0AD6129525BF5F86_SET_OWNERENTITY_OFFSET UNITYSDK_OFFSET(0x8C882B0)
#define CLASS_1_0AD6129525BF5F86_SET_PREVIOUSPROJECTILE_OFFSET UNITYSDK_OFFSET(0x8C883D0)
#define CLASS_1_0AD6129525BF5F86_SET_SKILLCONTEXT_OFFSET UNITYSDK_OFFSET(0x8C88390)
#define CLASS_1_0AD6129525BF5F86_SET_STATE_OFFSET UNITYSDK_OFFSET(0x8C88250)
#define CLASS_1_0AD6129525BF5F86_SET_TARGETENTITY_OFFSET UNITYSDK_OFFSET(0x8C88270)
#define CLASS_1_0AD6129525BF5F86_SET_TARGETPOSENTITY_OFFSET UNITYSDK_OFFSET(0x8C88290)
#define CLASS_1_0AD6129525BF5F86__CCTOR_OFFSET UNITYSDK_OFFSET(0x8C89D80)
#define CLASS_1_0AD6129525BF5F86__CTOR_OFFSET UNITYSDK_OFFSET(0x8C86320)
#define CLASS_1_0AD6129525BF5F86___CTOR_B__4_0_OFFSET UNITYSDK_OFFSET(0x8C89E40)
...
public:
	...
	{
		return (::RPG::GameCore::ColliderConfig**)Il2CppClass::FromTypeDefinitionIndex(Class_1_0AD6129525BF5F86_TypeDefinitionIndex)->GetStaticField(0x5040);
	}
	static ::System::String** StaticGet_Field_1_39()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_0AD6129525BF5F86_TypeDefinitionIndex)->GetStaticField(0x5048);
	}
	static ::RPG::GameCore::ProjectileTemplateConfig** StaticGet_Field_1_1()
	{
		return (::RPG::GameCore::ProjectileTemplateConfig**)Il2CppClass::FromTypeDefinitionIndex(Class_1_0AD6129525BF5F86_TypeDefinitionIndex)->GetStaticField(0x5050);
	}
	static ::Il2CppArray<::UnityEngine::Collider*>** StaticGet_Field_1_42()
	{
		return (::Il2CppArray<::UnityEngine::Collider*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_0AD6129525BF5F86_TypeDefinitionIndex)->GetStaticField(0x5058);
	}
	...
	::Class_1_0AD6129525BF5F86* _PreviousProjectile_k__BackingField; // 0x10
	::System::String* Field_1_27; // 0x18
	::RPG::GameCore::GameEntity* _TargetEntity_k__BackingField; // 0x20
	::UnityEngine::Animator* Field_1_36; // 0x28
	::Class_1_2B8E0B4950FE44E7* _SkillContext_k__BackingField; // 0x30
	::Class_3_98C806684F7CC372_8* _OnProjectileLifetimeFinish_k__BackingField; // 0x38
	::Class_1_A2D8E5AB4B623162* _OwnerAbilityRef_k__BackingField; // 0x40
	::Class_1_1835888C1E19F013* Field_1_26; // 0x48
	::UnityEngine::Rigidbody* Field_1_37; // 0x50
	::UnityEngine::Transform* Field_1_31; // 0x58
	::Class_3_98C806684F7CC372_7* _OnProjectileHit_k__BackingField; // 0x60
	::System::String* Field_1_15; // 0x68
	::UnityEngine::GameObject* Field_1_30; // 0x70
	::RPG::GameCore::GameEntity* _TargetPosEntity_k__BackingField; // 0x78
	...
	::RPG::Client::MonoProjectileEffect* Field_1_28; // 0x98
	::RPG::GameCore::ProjectileMoveBehavior _DataBehaviorType_k__BackingField; // 0xA0
	::System::Single Field_1_35; // 0xA4
	::UnityEngine::Vector3 Field_1_16; // 0xA8
	::System::Int32 Field_1_38; // 0xB4
	::System::Boolean Field_1_29; // 0xB8
	::System::Boolean _IsHit_k__BackingField; // 0xB9
	::System::Boolean _EnsureCallbackOrder_k__BackingField; // 0xBA
	::RPG::GameCore::ProjectileState _State_k__BackingField; // 0xBC
	::Struct_2_1C6CD3A917B08105 Field_1_41; // 0xC0
	::UnityEngine::Vector3 Field_1_22; // 0xC8
	::UnityEngine::Vector3 Field_1_24; // 0xD4
	::System::Int32 _ID_k__BackingField; // 0xE0
	::UnityEngine::Vector3 Field_1_25; // 0xE4
	::UnityEngine::Vector3 Field_1_17; // 0xF0
	::UnityEngine::Vector3 Field_1_18; // 0xFC
	::UnityEngine::Vector3 Field_1_21; // 0x108
	::UnityEngine::Vector3 Field_1_23; // 0x114
	::UnityEngine::Vector3 Field_1_19; // 0x120
