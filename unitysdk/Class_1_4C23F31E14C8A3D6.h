...
#define CLASS_1_4C23F31E14C8A3D6_METHOD_1_0C7CBCE710B3F112_OFFSET UNITYSDK_OFFSET(0x164C32E0)
#define CLASS_1_4C23F31E14C8A3D6_METHOD_1_1821B67E0666A564_OFFSET UNITYSDK_OFFSET(0x164C2D70)
#define CLASS_1_4C23F31E14C8A3D6_METHOD_1_1899066B20554A0B_OFFSET UNITYSDK_OFFSET(0x164C2EF0)
#define CLASS_1_4C23F31E14C8A3D6_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x164C3100)
#define CLASS_1_4C23F31E14C8A3D6_METHOD_1_60842E075CD9FD9B_OFFSET UNITYSDK_OFFSET(0x164C3330)
#define CLASS_1_4C23F31E14C8A3D6_METHOD_1_6B72D4EE8C6E907F_OFFSET UNITYSDK_OFFSET(0x164C2AC0)
#define CLASS_1_4C23F31E14C8A3D6_METHOD_1_741C3FA1FB37DB8E_OFFSET UNITYSDK_OFFSET(0x164C2A40)
#define CLASS_1_4C23F31E14C8A3D6_METHOD_1_8CCA9E762DC3BDC4_OFFSET UNITYSDK_OFFSET(0x164C3690)
#define CLASS_1_4C23F31E14C8A3D6_METHOD_1_AD31DD9682084C83_OFFSET UNITYSDK_OFFSET(0x164C31A0)
#define CLASS_1_4C23F31E14C8A3D6_METHOD_1_CE34EA208837238D_OFFSET UNITYSDK_OFFSET(0x164C2D10)
#define CLASS_1_4C23F31E14C8A3D6_METHOD_1_F0E307B84478A272_OFFSET UNITYSDK_OFFSET(0x164C30C0)
#define CLASS_1_4C23F31E14C8A3D6_METHOD_1_F2E1599CBB58B20F_OFFSET UNITYSDK_OFFSET(0x164C3240)
#define CLASS_1_4C23F31E14C8A3D6__CCTOR_OFFSET UNITYSDK_OFFSET(0x164C3780)

inline static constexpr unsigned int Class_1_4C23F31E14C8A3D6_TypeDefinitionIndex = 13535;
...
public:
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::RPG::GameCore::CommonIndexKey, ::RPG::GameCore::RogueMagicScepterRow*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_4C23F31E14C8A3D6_TypeDefinitionIndex)->GetStaticField(0x34E40);
	}
	static ::Il2CppArray<::System::String*>** StaticGet_Field_1_4()
	{
		return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_4C23F31E14C8A3D6_TypeDefinitionIndex)->GetStaticField(0x34E48);
	}
	static ::System::Action_1<::Class_1_7A22A3DBEEDD1F80*>** StaticGet_Field_1_3()
	{
		return (::System::Action_1<::Class_1_7A22A3DBEEDD1F80*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_4C23F31E14C8A3D6_TypeDefinitionIndex)->GetStaticField(0x34E50);
	}
	static ::System::Boolean* StaticGet_Field_1_1()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_1_4C23F31E14C8A3D6_TypeDefinitionIndex)->GetStaticField(0xCC20);
	}
	static ::System::Byte* StaticGet_Field_1_2()
	{
		return (::System::Byte*)Il2CppClass::FromTypeDefinitionIndex(Class_1_4C23F31E14C8A3D6_TypeDefinitionIndex)->GetStaticField(0xCC21);
	}
