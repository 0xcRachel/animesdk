...
#define CLASS_1_3C58D309C7A040F5_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17A3E940)
#define CLASS_1_3C58D309C7A040F5_CLONE_OFFSET UNITYSDK_OFFSET(0x17A3E4D0)
#define CLASS_1_3C58D309C7A040F5_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17A3E640)
#define CLASS_1_3C58D309C7A040F5_EQUALS_OFFSET UNITYSDK_OFFSET(0x17A3E550)
#define CLASS_1_3C58D309C7A040F5_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17A3E710)
#define CLASS_1_3C58D309C7A040F5_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x17A3EB60)
#define CLASS_1_3C58D309C7A040F5_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x17A3EAB0)
#define CLASS_1_3C58D309C7A040F5_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x17A3E530)
#define CLASS_1_3C58D309C7A040F5_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x17A3E510)
#define CLASS_1_3C58D309C7A040F5_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x17A3E500)
#define CLASS_1_3C58D309C7A040F5_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x17A3E540)
#define CLASS_1_3C58D309C7A040F5_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x17A3E520)
#define CLASS_1_3C58D309C7A040F5_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17A3E3E0)
#define CLASS_1_3C58D309C7A040F5_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17A3E810)
#define CLASS_1_3C58D309C7A040F5_WRITETO_OFFSET UNITYSDK_OFFSET(0x17A3E870)
#define CLASS_1_3C58D309C7A040F5__CCTOR_OFFSET UNITYSDK_OFFSET(0x17A3ECC0)
#define CLASS_1_3C58D309C7A040F5__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17A3E430)
#define CLASS_1_3C58D309C7A040F5__CTOR_OFFSET UNITYSDK_OFFSET(0x17A3E3F0)

inline static constexpr unsigned int Class_1_3C58D309C7A040F5_TypeDefinitionIndex = 22563;
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_48AADA497C3F117F_2*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_3C58D309C7A040F5_TypeDefinitionIndex)->GetStaticField(0x16540);
	}
	// static const ::System::Int32 Field_1_1 = 0x1; // 0x0
	// static const ::System::Int32 Field_1_4 = 0x2; // 0x0
	// static const ::System::Int32 Field_1_6 = 0x3; // 0x0
	::Google::Protobuf::UnknownFieldSet* Field_1_0; // 0x10
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_48AADA497C3F117F_2*>* Field_1_3; // 0x18
