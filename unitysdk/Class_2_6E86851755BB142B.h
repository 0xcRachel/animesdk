...
#define CLASS_2_6E86851755BB142B_METHOD_2_0C60A530AA0118C2_OFFSET UNITYSDK_OFFSET(0x1194E670)
#define CLASS_2_6E86851755BB142B_METHOD_2_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x1194EAE0)
#define CLASS_2_6E86851755BB142B_METHOD_2_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x1194E730)
#define CLASS_2_6E86851755BB142B_METHOD_2_746322D065084F77_OFFSET UNITYSDK_OFFSET(0x1194E6C0)
#define CLASS_2_6E86851755BB142B_METHOD_2_8F8D080EF5D1D761_OFFSET UNITYSDK_OFFSET(0x1194EE70)
#define CLASS_2_6E86851755BB142B_METHOD_2_9079FE2639801498_OFFSET UNITYSDK_OFFSET(0x1194ED00)
#define CLASS_2_6E86851755BB142B_METHOD_2_C73972D70B679A3D_OFFSET UNITYSDK_OFFSET(0x1194EC40)
#define CLASS_2_6E86851755BB142B_METHOD_2_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0x1194E8E0)
#define CLASS_2_6E86851755BB142B__CTOR_OFFSET UNITYSDK_OFFSET(0x1194EFE0)
#define CLASS_2_6E86851755BB142B__ONBIND_OFFSET UNITYSDK_OFFSET(0x1194E470)
#define CLASS_2_6E86851755BB142B___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0x1194F010)

inline static constexpr unsigned int Class_2_6E86851755BB142B_TypeDefinitionIndex = 66583;

class Class_2_6E86851755BB142B : public ::Class_1_CA217ABF4E3B4F3F
{
public:
	// static const ::System::String* Field_2_0; // 0x0
	::Class_1_9015B34004B876E5* Field_2_9; // 0x60
	::RPG::Client::GridFightRole* Field_2_7; // 0x68
	::UnityEngine::UI::Image* Field_2_4; // 0x70
	::Class_2_D80D1FE3E32C9633* Field_2_3; // 0x78
	::Class_2_D029B21B05075340* Field_2_1; // 0x80
	::RPG::GameCore::BattleGridFightTeamTraitData* Field_2_8; // 0x88
	::UnityEngine::UI::Button* Field_2_5; // 0x90
	::Class_1_6D3A625BE1D0B270* Field_2_6; // 0x98
	::Class_2_5D383A48C6769A2A* Field_2_2; // 0xA0
