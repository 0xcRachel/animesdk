...
#define CLASS_1_7C0B3E09008393BC_METHOD_1_0C7CBCE710B3F112_OFFSET UNITYSDK_OFFSET(0x18994230)
#define CLASS_1_7C0B3E09008393BC_METHOD_1_1D94F57F1A24BA75_OFFSET UNITYSDK_OFFSET(0x18993C90)
#define CLASS_1_7C0B3E09008393BC_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x18994050)
#define CLASS_1_7C0B3E09008393BC_METHOD_1_33DD04F07848101E_OFFSET UNITYSDK_OFFSET(0x18993E40)
#define CLASS_1_7C0B3E09008393BC_METHOD_1_6B72D4EE8C6E907F_OFFSET UNITYSDK_OFFSET(0x189939E0)
#define CLASS_1_7C0B3E09008393BC_METHOD_1_89CC7A85C1BDE880_OFFSET UNITYSDK_OFFSET(0x18993960)
#define CLASS_1_7C0B3E09008393BC_METHOD_1_AD31DD9682084C83_OFFSET UNITYSDK_OFFSET(0x189940F0)
#define CLASS_1_7C0B3E09008393BC_METHOD_1_CE34EA208837238D_OFFSET UNITYSDK_OFFSET(0x18993C30)
#define CLASS_1_7C0B3E09008393BC_METHOD_1_F0E307B84478A272_OFFSET UNITYSDK_OFFSET(0x18994010)
#define CLASS_1_7C0B3E09008393BC_METHOD_1_F2E1599CBB58B20F_OFFSET UNITYSDK_OFFSET(0x18994190)
#define CLASS_1_7C0B3E09008393BC_METHOD_1_FA0D7B739BDD63AC_OFFSET UNITYSDK_OFFSET(0x18994280)
#define CLASS_1_7C0B3E09008393BC__CCTOR_OFFSET UNITYSDK_OFFSET(0x189945E0)
...
public:
	...
	{
		return (::System::Action_1<::Class_1_7A22A3DBEEDD1F80*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_7C0B3E09008393BC_TypeDefinitionIndex)->GetStaticField(0x3B180);
	}
	static ::Il2CppArray<::System::String*>** StaticGet_Field_1_4()
	{
		return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_7C0B3E09008393BC_TypeDefinitionIndex)->GetStaticField(0x3B188);
	}
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::RPG::GameCore::CommonIndexKey, ::RPG::GameCore::TarotMailDataRow*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_7C0B3E09008393BC_TypeDefinitionIndex)->GetStaticField(0x3B190);
	}
	static ::System::Byte* StaticGet_Field_1_2()
	{
		return (::System::Byte*)Il2CppClass::FromTypeDefinitionIndex(Class_1_7C0B3E09008393BC_TypeDefinitionIndex)->GetStaticField(0xB800);
	}
	static ::System::Boolean* StaticGet_Field_1_1()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_1_7C0B3E09008393BC_TypeDefinitionIndex)->GetStaticField(0xB801);
	}
