...
#define CLASS_2_AE85D05D86CD33B9_GET_ISULTRAMODE_OFFSET UNITYSDK_OFFSET(0x10AABD20)
#define CLASS_2_AE85D05D86CD33B9_METHOD_2_0FD0EC313FAAB75A_OFFSET UNITYSDK_OFFSET(0x10AABB70)
#define CLASS_2_AE85D05D86CD33B9_METHOD_2_1E27A7B84BD57C4A_OFFSET UNITYSDK_OFFSET(0x10AABB20)
#define CLASS_2_AE85D05D86CD33B9_METHOD_2_3E7178C5ECF017DB_1_OFFSET UNITYSDK_OFFSET(0x10AABCD0)
#define CLASS_2_AE85D05D86CD33B9_METHOD_2_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x10AABC80)
#define CLASS_2_AE85D05D86CD33B9_SET_ISULTRAMODE_OFFSET UNITYSDK_OFFSET(0x10AABD30)
#define CLASS_2_AE85D05D86CD33B9__CTOR_OFFSET UNITYSDK_OFFSET(0x10AABD40)
#define CLASS_2_AE85D05D86CD33B9__ONBIND_OFFSET UNITYSDK_OFFSET(0x10AABAC0)
#define CLASS_2_AE85D05D86CD33B9___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0x10AABD70)

inline static constexpr unsigned int Class_2_AE85D05D86CD33B9_TypeDefinitionIndex = 56926;

class Class_2_AE85D05D86CD33B9 : public ::Class_1_CA217ABF4E3B4F3F
{
public:
	::RPG::GameCore::GameEntity* Field_2_3; // 0x60
	::RPG::GameCore::AetherSpiritTypeRow* Field_2_2; // 0x68
