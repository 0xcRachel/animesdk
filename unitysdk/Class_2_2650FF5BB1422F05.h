...
#define CLASS_2_2650FF5BB1422F05_DISPOSE_OFFSET UNITYSDK_OFFSET(0x103C3230)
#define CLASS_2_2650FF5BB1422F05_METHOD_2_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0x103C34E0)
#define CLASS_2_2650FF5BB1422F05_METHOD_2_5B0531D5B96D6B96_OFFSET UNITYSDK_OFFSET(0x103C3900)
#define CLASS_2_2650FF5BB1422F05_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x103C3620)
#define CLASS_2_2650FF5BB1422F05_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x103C3790)
#define CLASS_2_2650FF5BB1422F05_TICK_OFFSET UNITYSDK_OFFSET(0x103C3370)
#define CLASS_2_2650FF5BB1422F05__CTOR_OFFSET UNITYSDK_OFFSET(0x103C31A0)

inline static constexpr unsigned int Class_2_2650FF5BB1422F05_TypeDefinitionIndex = 42159;
...
public:
	...
	::RPG::GameCore::OnTimeRewindParentPropStateChangeEnd* Field_2_1; // 0x28
	...
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_347*))((::PBYTE)hIl2Cpp + CLASS_2_2650FF5BB1422F05_METHOD_2_5B0531D5B96D6B96_OFFSET))(this, a1);
	}
