...
#define CLASS_3_C6C803F6D2DDE4D8_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x116C1B30)
#define CLASS_3_C6C803F6D2DDE4D8_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x116C1B60)
#define CLASS_3_C6C803F6D2DDE4D8_INVOKE_OFFSET UNITYSDK_OFFSET(0x116C15E0)
#define CLASS_3_C6C803F6D2DDE4D8__CTOR_OFFSET UNITYSDK_OFFSET(0x116C15C0)

inline static constexpr unsigned int Class_3_C6C803F6D2DDE4D8_TypeDefinitionIndex = 63493;
