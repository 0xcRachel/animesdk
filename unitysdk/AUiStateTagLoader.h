...
#define AUISTATETAGLOADER_GET_STATETAGLIST_OFFSET UNITYSDK_OFFSET(0x1055D610)
#define AUISTATETAGLOADER_ISFALSE_OFFSET UNITYSDK_OFFSET(0x1055CB70)
#define AUISTATETAGLOADER_ISTRUE_OFFSET UNITYSDK_OFFSET(0x1055D210)
#define AUISTATETAGLOADER_METHOD_6_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0x1055D140)
#define AUISTATETAGLOADER_SET_STATETAGLIST_OFFSET UNITYSDK_OFFSET(0x1055D620)
#define AUISTATETAGLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1055D630)

inline static constexpr unsigned int AUiStateTagLoader_TypeDefinitionIndex = 37475;
