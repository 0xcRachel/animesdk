...
#define AUISTATETAGLOADER_GET_STATETAGLIST_OFFSET UNITYSDK_OFFSET(0xF960E30)
#define AUISTATETAGLOADER_ISFALSE_OFFSET UNITYSDK_OFFSET(0xF960390)
#define AUISTATETAGLOADER_ISTRUE_OFFSET UNITYSDK_OFFSET(0xF960A30)
#define AUISTATETAGLOADER_METHOD_6_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0xF960960)
#define AUISTATETAGLOADER_SET_STATETAGLIST_OFFSET UNITYSDK_OFFSET(0xF960E40)
#define AUISTATETAGLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0xF960E50)
