...
#define CLASS_2_99C157A714CC0090_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB2C4E90)
#define CLASS_2_99C157A714CC0090_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xB2C4F20)
#define CLASS_2_99C157A714CC0090_METHOD_2_A088A6C0EFC42F07_OFFSET UNITYSDK_OFFSET(0xB2C5070)
#define CLASS_2_99C157A714CC0090_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB2C5170)
#define CLASS_2_99C157A714CC0090_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB2C4ED0)
#define CLASS_2_99C157A714CC0090_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB2C4FC0)
#define CLASS_2_99C157A714CC0090_TICK_OFFSET UNITYSDK_OFFSET(0xB2C5010)
#define CLASS_2_99C157A714CC0090__CTOR_OFFSET UNITYSDK_OFFSET(0xB2C4E80)

inline static constexpr unsigned int Class_2_99C157A714CC0090_TypeDefinitionIndex = 46279;

class Class_2_99C157A714CC0090 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::Client::LuaUIController* Field_2_2; // 0x18
	::RPG::GameCore::ShowMuseumMarketPage* Field_2_0; // 0x20
