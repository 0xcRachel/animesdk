...
#define CLASS_1_5B567C8A01BAEDFE_17_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19DA8E60)
#define CLASS_1_5B567C8A01BAEDFE_17_CLONE_OFFSET UNITYSDK_OFFSET(0x19DA8CD0)
#define CLASS_1_5B567C8A01BAEDFE_17_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19DA8D70)
#define CLASS_1_5B567C8A01BAEDFE_17_EQUALS_OFFSET UNITYSDK_OFFSET(0x19DA8D10)
#define CLASS_1_5B567C8A01BAEDFE_17_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19DA8DC0)
#define CLASS_1_5B567C8A01BAEDFE_17_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19DA8EB0)
#define CLASS_1_5B567C8A01BAEDFE_17_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19DA8E80)
#define CLASS_1_5B567C8A01BAEDFE_17_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19DA8C50)
#define CLASS_1_5B567C8A01BAEDFE_17_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19DA8C80)
#define CLASS_1_5B567C8A01BAEDFE_17_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19DA8DF0)
#define CLASS_1_5B567C8A01BAEDFE_17_WRITETO_OFFSET UNITYSDK_OFFSET(0x19DA8E50)
#define CLASS_1_5B567C8A01BAEDFE_17__CCTOR_OFFSET UNITYSDK_OFFSET(0x19DA8F00)
#define CLASS_1_5B567C8A01BAEDFE_17__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19DA8CA0)
#define CLASS_1_5B567C8A01BAEDFE_17__CTOR_OFFSET UNITYSDK_OFFSET(0x19DA8C90)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_17*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_17_TypeDefinitionIndex)->GetStaticField(0x25000);
	}
