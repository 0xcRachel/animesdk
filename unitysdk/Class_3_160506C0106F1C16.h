...
#define CLASS_3_160506C0106F1C16_GETAPPLYSTREAMINGLAYER_OFFSET UNITYSDK_OFFSET(0x1536DDD0)
#define CLASS_3_160506C0106F1C16_GETASSETPATH_OFFSET UNITYSDK_OFFSET(0x1536DC70)
#define CLASS_3_160506C0106F1C16__CTOR_OFFSET UNITYSDK_OFFSET(0x1536DC30)
#define CLASS_3_160506C0106F1C16___IFIXBASEPROXY_GETAPPLYSTREAMINGLAYER_OFFSET UNITYSDK_OFFSET(0x1536DE30)
#define CLASS_3_160506C0106F1C16___IFIXBASEPROXY_GETASSETPATH_OFFSET UNITYSDK_OFFSET(0x1536DE20)

inline static constexpr unsigned int Class_3_160506C0106F1C16_TypeDefinitionIndex = 68891;
