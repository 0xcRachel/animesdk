...
#define CLASS_1_C9374C34A234A2B9_METHOD_1_9A263B7DE0D16163_OFFSET UNITYSDK_OFFSET(0xD7F25D0)
#define CLASS_1_C9374C34A234A2B9__CCTOR_OFFSET UNITYSDK_OFFSET(0xD7F25A0)
...
public:
	...
	{
		return (::Il2CppArray<::RPG::GameCore::TurnBasedModifierEventScope>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_C9374C34A234A2B9_TypeDefinitionIndex)->GetStaticField(0x13200);
	}
