...
#define CLASS_3_CA0748123C4DCB29_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x148B8140)
#define CLASS_3_CA0748123C4DCB29_METHOD_3_62D1BD926C7A660C_OFFSET UNITYSDK_OFFSET(0x148B81A0)
#define CLASS_3_CA0748123C4DCB29_METHOD_3_6A0EBEECA245A27C_OFFSET UNITYSDK_OFFSET(0x148B7C20)
#define CLASS_3_CA0748123C4DCB29_ONSKIP_OFFSET UNITYSDK_OFFSET(0x148B8150)
#define CLASS_3_CA0748123C4DCB29_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x148B7BD0)
#define CLASS_3_CA0748123C4DCB29__CTOR_OFFSET UNITYSDK_OFFSET(0x148B7BA0)
