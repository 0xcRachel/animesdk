...
#define CLASS_3_CA0748123C4DCB29_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0xB2C4D60)
#define CLASS_3_CA0748123C4DCB29_METHOD_3_62D1BD926C7A660C_OFFSET UNITYSDK_OFFSET(0xB2C4DC0)
#define CLASS_3_CA0748123C4DCB29_METHOD_3_EAD10B3E55E2C4C5_OFFSET UNITYSDK_OFFSET(0xB2C4840)
#define CLASS_3_CA0748123C4DCB29_ONSKIP_OFFSET UNITYSDK_OFFSET(0xB2C4D70)
#define CLASS_3_CA0748123C4DCB29_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB2C47F0)
#define CLASS_3_CA0748123C4DCB29__CTOR_OFFSET UNITYSDK_OFFSET(0xB2C47C0)

inline static constexpr unsigned int Class_3_CA0748123C4DCB29_TypeDefinitionIndex = 45813;
