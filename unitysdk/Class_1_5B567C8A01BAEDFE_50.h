...
#define CLASS_1_5B567C8A01BAEDFE_50_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19C8BF50)
#define CLASS_1_5B567C8A01BAEDFE_50_CLONE_OFFSET UNITYSDK_OFFSET(0x19C8BDC0)
#define CLASS_1_5B567C8A01BAEDFE_50_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19C8BE60)
#define CLASS_1_5B567C8A01BAEDFE_50_EQUALS_OFFSET UNITYSDK_OFFSET(0x19C8BE00)
#define CLASS_1_5B567C8A01BAEDFE_50_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19C8BEB0)
#define CLASS_1_5B567C8A01BAEDFE_50_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19C8BFA0)
#define CLASS_1_5B567C8A01BAEDFE_50_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19C8BF70)
#define CLASS_1_5B567C8A01BAEDFE_50_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19C8BD40)
#define CLASS_1_5B567C8A01BAEDFE_50_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19C8BD70)
#define CLASS_1_5B567C8A01BAEDFE_50_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19C8BEE0)
#define CLASS_1_5B567C8A01BAEDFE_50_WRITETO_OFFSET UNITYSDK_OFFSET(0x19C8BF40)
#define CLASS_1_5B567C8A01BAEDFE_50__CCTOR_OFFSET UNITYSDK_OFFSET(0x19C8BFF0)
#define CLASS_1_5B567C8A01BAEDFE_50__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19C8BD90)
#define CLASS_1_5B567C8A01BAEDFE_50__CTOR_OFFSET UNITYSDK_OFFSET(0x19C8BD80)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_50*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_50_TypeDefinitionIndex)->GetStaticField(0x3BAB0);
	}
