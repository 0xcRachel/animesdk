...
#define CLASS_1_355A2207C3B7A99D_57_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1AB76770)
#define CLASS_1_355A2207C3B7A99D_57_CLONE_OFFSET UNITYSDK_OFFSET(0x1AB76430)
#define CLASS_1_355A2207C3B7A99D_57_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1AB765B0)
#define CLASS_1_355A2207C3B7A99D_57_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AB76500)
#define CLASS_1_355A2207C3B7A99D_57_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AB76650)
#define CLASS_1_355A2207C3B7A99D_57_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1AB768A0)
#define CLASS_1_355A2207C3B7A99D_57_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1AB767D0)
#define CLASS_1_355A2207C3B7A99D_57_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x1AB764E0)
#define CLASS_1_355A2207C3B7A99D_57_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1AB76340)
#define CLASS_1_355A2207C3B7A99D_57_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x1AB764F0)
#define CLASS_1_355A2207C3B7A99D_57_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1AB76370)
#define CLASS_1_355A2207C3B7A99D_57_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AB766B0)
#define CLASS_1_355A2207C3B7A99D_57_WRITETO_OFFSET UNITYSDK_OFFSET(0x1AB76710)
#define CLASS_1_355A2207C3B7A99D_57__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AB76A30)
#define CLASS_1_355A2207C3B7A99D_57__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AB76390)
#define CLASS_1_355A2207C3B7A99D_57__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB76380)

inline static constexpr unsigned int Class_1_355A2207C3B7A99D_57_TypeDefinitionIndex = 29202;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_355A2207C3B7A99D_57*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_355A2207C3B7A99D_57_TypeDefinitionIndex)->GetStaticField(0x12B70);
	}
	...
	{
		return ((::Class_1_66C20D6C355B068E_5*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_355A2207C3B7A99D_57_METHOD_1_24748FC20F375725_OFFSET))(this);
	}

	::System::Void Method_1_8C8625211DA811AE(::Class_1_66C20D6C355B068E_5* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_66C20D6C355B068E_5*))((::PBYTE)hIl2Cpp + CLASS_1_355A2207C3B7A99D_57_METHOD_1_8C8625211DA811AE_OFFSET))(this, a1);
	}
