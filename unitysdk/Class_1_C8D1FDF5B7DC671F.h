...
#define CLASS_1_C8D1FDF5B7DC671F_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8D14690)
#define CLASS_1_C8D1FDF5B7DC671F_GET_ENDCONNECTINTERSECTION_OFFSET UNITYSDK_OFFSET(0x8D16630)
#define CLASS_1_C8D1FDF5B7DC671F_GET_HASINVISIBLESEGMENT_OFFSET UNITYSDK_OFFSET(0x8D167D0)
#define CLASS_1_C8D1FDF5B7DC671F_GET_PEDESTRIANMAXCOUNT_OFFSET UNITYSDK_OFFSET(0x8D16660)
#define CLASS_1_C8D1FDF5B7DC671F_GET_POINTCOUNT_OFFSET UNITYSDK_OFFSET(0x8D164C0)
#define CLASS_1_C8D1FDF5B7DC671F_GET_POINTENDINDEX_OFFSET UNITYSDK_OFFSET(0x8D164E0)
#define CLASS_1_C8D1FDF5B7DC671F_GET_POINTSTARTINDEX_OFFSET UNITYSDK_OFFSET(0x8D164D0)
#define CLASS_1_C8D1FDF5B7DC671F_GET_ROADINDEX_OFFSET UNITYSDK_OFFSET(0x8D164B0)
#define CLASS_1_C8D1FDF5B7DC671F_GET_STARTCONNECTINTERSECTION_OFFSET UNITYSDK_OFFSET(0x8D16610)
#define CLASS_1_C8D1FDF5B7DC671F_METHOD_1_030D215FD570A70B_OFFSET UNITYSDK_OFFSET(0x8D14E90)
#define CLASS_1_C8D1FDF5B7DC671F_METHOD_1_124E7DAB85EAFECD_OFFSET UNITYSDK_OFFSET(0x8D166D0)
#define CLASS_1_C8D1FDF5B7DC671F_METHOD_1_14E13B239161F445_OFFSET UNITYSDK_OFFSET(0x8D152A0)
#define CLASS_1_C8D1FDF5B7DC671F_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x8D16650)
#define CLASS_1_C8D1FDF5B7DC671F_METHOD_1_31B71B6D307F7F0C_1_OFFSET UNITYSDK_OFFSET(0x8D16580)
#define CLASS_1_C8D1FDF5B7DC671F_METHOD_1_31B71B6D307F7F0C_OFFSET UNITYSDK_OFFSET(0x8D164F0)
#define CLASS_1_C8D1FDF5B7DC671F_METHOD_1_36199BBD14A68CEC_OFFSET UNITYSDK_OFFSET(0x8D153A0)
#define CLASS_1_C8D1FDF5B7DC671F_METHOD_1_3976AB8D58C7574A_OFFSET UNITYSDK_OFFSET(0x8D157B0)
#define CLASS_1_C8D1FDF5B7DC671F_METHOD_1_5F6398776E49CD87_1_OFFSET UNITYSDK_OFFSET(0x8D15240)
#define CLASS_1_C8D1FDF5B7DC671F_METHOD_1_5F6398776E49CD87_OFFSET UNITYSDK_OFFSET(0x8D163F0)
#define CLASS_1_C8D1FDF5B7DC671F_METHOD_1_6798E56998F469DB_OFFSET UNITYSDK_OFFSET(0x8D15610)
#define CLASS_1_C8D1FDF5B7DC671F_METHOD_1_6B47CDE3B34D5A39_1_OFFSET UNITYSDK_OFFSET(0x8D14C60)
#define CLASS_1_C8D1FDF5B7DC671F_METHOD_1_6B47CDE3B34D5A39_OFFSET UNITYSDK_OFFSET(0x8D14BE0)
#define CLASS_1_C8D1FDF5B7DC671F_METHOD_1_6CE471172CD2B7AA_OFFSET UNITYSDK_OFFSET(0x8D158D0)
#define CLASS_1_C8D1FDF5B7DC671F_METHOD_1_71DB3F326B4AC8CD_1_OFFSET UNITYSDK_OFFSET(0x8D14960)
#define CLASS_1_C8D1FDF5B7DC671F_METHOD_1_71DB3F326B4AC8CD_2_OFFSET UNITYSDK_OFFSET(0x8D14A00)
#define CLASS_1_C8D1FDF5B7DC671F_METHOD_1_71DB3F326B4AC8CD_3_OFFSET UNITYSDK_OFFSET(0x8D14AA0)
#define CLASS_1_C8D1FDF5B7DC671F_METHOD_1_71DB3F326B4AC8CD_4_OFFSET UNITYSDK_OFFSET(0x8D14B40)
#define CLASS_1_C8D1FDF5B7DC671F_METHOD_1_71DB3F326B4AC8CD_OFFSET UNITYSDK_OFFSET(0x8D148C0)
#define CLASS_1_C8D1FDF5B7DC671F_METHOD_1_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x8D16680)
#define CLASS_1_C8D1FDF5B7DC671F_METHOD_1_9D5BEBE295BE65D4_OFFSET UNITYSDK_OFFSET(0x8D14710)
#define CLASS_1_C8D1FDF5B7DC671F_METHOD_1_9E1615EC5DA5116E_OFFSET UNITYSDK_OFFSET(0x8D154A0)
#define CLASS_1_C8D1FDF5B7DC671F_METHOD_1_A17B38030E623502_OFFSET UNITYSDK_OFFSET(0x8D14D00)
#define CLASS_1_C8D1FDF5B7DC671F_METHOD_1_B429CB2480CB0B1D_OFFSET UNITYSDK_OFFSET(0x8D14E00)
#define CLASS_1_C8D1FDF5B7DC671F_METHOD_1_BA1A163457250A51_OFFSET UNITYSDK_OFFSET(0x8D15430)
#define CLASS_1_C8D1FDF5B7DC671F_METHOD_1_D38CD9F4ED9A008E_OFFSET UNITYSDK_OFFSET(0x8D15C30)
#define CLASS_1_C8D1FDF5B7DC671F_METHOD_1_D40B9084A09E068D_OFFSET UNITYSDK_OFFSET(0x8D16020)
#define CLASS_1_C8D1FDF5B7DC671F_METHOD_1_D7DDA895983CCCB2_1_OFFSET UNITYSDK_OFFSET(0x8D15BE0)
#define CLASS_1_C8D1FDF5B7DC671F_METHOD_1_D7DDA895983CCCB2_OFFSET UNITYSDK_OFFSET(0x8D14860)
#define CLASS_1_C8D1FDF5B7DC671F_METHOD_1_EFEBD2410784C1EC_OFFSET UNITYSDK_OFFSET(0x8D14F80)
#define CLASS_1_C8D1FDF5B7DC671F_METHOD_1_F8ECF45606EE91F8_OFFSET UNITYSDK_OFFSET(0x8D16450)
#define CLASS_1_C8D1FDF5B7DC671F_SET_ENDCONNECTINTERSECTION_OFFSET UNITYSDK_OFFSET(0x8D16640)
#define CLASS_1_C8D1FDF5B7DC671F_SET_PEDESTRIANMAXCOUNT_OFFSET UNITYSDK_OFFSET(0x8D16670)
#define CLASS_1_C8D1FDF5B7DC671F_SET_STARTCONNECTINTERSECTION_OFFSET UNITYSDK_OFFSET(0x8D16620)
#define CLASS_1_C8D1FDF5B7DC671F__CTOR_OFFSET UNITYSDK_OFFSET(0x8D13AC0)

inline static constexpr unsigned int Class_1_C8D1FDF5B7DC671F_TypeDefinitionIndex = 55079;
...
public:
	...
	::Class_1_6F0BD58264D71C62* Field_1_11; // 0x10
	::Class_1_D706B4E43D460E85* _EndConnectIntersection_k__BackingField; // 0x18
	::UnityEngine::GameObject* Field_1_10; // 0x20
	::Class_1_D706B4E43D460E85* _StartConnectIntersection_k__BackingField; // 0x28
	::RPG::GameCore::LevelPedestrianV2RoadInfo* Field_1_12; // 0x30
	::Il2CppArray<::Class_1_C8D1FDF5B7DC671F_Struct_2_337F30C7300DA789>* Field_1_13; // 0x38
	::System::Collections::Generic::HashSet_1<::Class_1_9AAC3BB4FD7CE6FE*>* Field_1_14; // 0x40
	...
	::System::Int32 _PointEndIndex_k__BackingField; // 0x54
	::System::Boolean _HasInvisibleSegment_k__BackingField; // 0x58
	::System::Int32 _PedestrianMaxCount_k__BackingField; // 0x5C

	::System::Void _ctor(::Class_1_6F0BD58264D71C62* a1, ::RPG::GameCore::LevelPedestrianV2RoadInfo* a2, ::System::Int32 a3, ::UnityEngine::Transform* a4)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_6F0BD58264D71C62*, ::RPG::GameCore::LevelPedestrianV2RoadInfo*, ::System::Int32, ::UnityEngine::Transform*))((::PBYTE)hIl2Cpp + CLASS_1_C8D1FDF5B7DC671F__CTOR_OFFSET))(this, a1, a2, a3, a4);
	}
	...
	{
		return ((::System::Single(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_C8D1FDF5B7DC671F_METHOD_1_9D5BEBE295BE65D4_OFFSET))(this);
	}
	...
	::Class_1_D706B4E43D460E85* Method_1_F8ECF45606EE91F8(::System::Boolean a1)
	{
		return ((::Class_1_D706B4E43D460E85*(*)(::PVOID, ::System::Boolean))((::PBYTE)hIl2Cpp + CLASS_1_C8D1FDF5B7DC671F_METHOD_1_F8ECF45606EE91F8_OFFSET))(this, a1);
	}
	...
	::Class_1_D706B4E43D460E85* get_StartConnectIntersection()
	{
		return ((::Class_1_D706B4E43D460E85*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_C8D1FDF5B7DC671F_GET_STARTCONNECTINTERSECTION_OFFSET))(this);
	}

	::System::Void set_StartConnectIntersection(::Class_1_D706B4E43D460E85* value)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_D706B4E43D460E85*))((::PBYTE)hIl2Cpp + CLASS_1_C8D1FDF5B7DC671F_SET_STARTCONNECTINTERSECTION_OFFSET))(this, value);
	}

	::Class_1_D706B4E43D460E85* get_EndConnectIntersection()
	{
		return ((::Class_1_D706B4E43D460E85*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_C8D1FDF5B7DC671F_GET_ENDCONNECTINTERSECTION_OFFSET))(this);
	}

	::System::Void set_EndConnectIntersection(::Class_1_D706B4E43D460E85* value)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_D706B4E43D460E85*))((::PBYTE)hIl2Cpp + CLASS_1_C8D1FDF5B7DC671F_SET_ENDCONNECTINTERSECTION_OFFSET))(this, value);
	}

	::Class_1_6F0BD58264D71C62* Method_1_24748FC20F375725()
	{
		return ((::Class_1_6F0BD58264D71C62*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_C8D1FDF5B7DC671F_METHOD_1_24748FC20F375725_OFFSET))(this);
	}
