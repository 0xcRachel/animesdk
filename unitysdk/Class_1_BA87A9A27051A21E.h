...
#define CLASS_1_BA87A9A27051A21E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10AF4D40)
#define CLASS_1_BA87A9A27051A21E_GET_BEGINPOSITION_OFFSET UNITYSDK_OFFSET(0x10AF5890)
#define CLASS_1_BA87A9A27051A21E_GET_DESTINATIONPOSITION_OFFSET UNITYSDK_OFFSET(0x10AF58B0)
#define CLASS_1_BA87A9A27051A21E_METHOD_1_561A73CC360FE0AB_OFFSET UNITYSDK_OFFSET(0x10AF4E50)
#define CLASS_1_BA87A9A27051A21E_METHOD_1_59FB090BEA43C095_OFFSET UNITYSDK_OFFSET(0x10AF5790)
#define CLASS_1_BA87A9A27051A21E_METHOD_1_8599237FE4129E81_OFFSET UNITYSDK_OFFSET(0x10AF5250)
#define CLASS_1_BA87A9A27051A21E_METHOD_1_A51E2774D1B55326_OFFSET UNITYSDK_OFFSET(0x10AF5550)
#define CLASS_1_BA87A9A27051A21E_METHOD_1_BB97A48D5BCE3F55_OFFSET UNITYSDK_OFFSET(0x10AF5110)
#define CLASS_1_BA87A9A27051A21E_METHOD_1_E11AC65AA0DC2249_OFFSET UNITYSDK_OFFSET(0x10AF4F50)
#define CLASS_1_BA87A9A27051A21E_METHOD_1_F17676F976AEF1D8_OFFSET UNITYSDK_OFFSET(0x10AF55F0)
#define CLASS_1_BA87A9A27051A21E_SET_BEGINPOSITION_OFFSET UNITYSDK_OFFSET(0x10AF58A0)
#define CLASS_1_BA87A9A27051A21E_SET_DESTINATIONPOSITION_OFFSET UNITYSDK_OFFSET(0x10AF58C0)
#define CLASS_1_BA87A9A27051A21E__CCTOR_OFFSET UNITYSDK_OFFSET(0x10AF58D0)
#define CLASS_1_BA87A9A27051A21E__CTOR_OFFSET UNITYSDK_OFFSET(0x10AF4D90)

inline static constexpr unsigned int Class_1_BA87A9A27051A21E_TypeDefinitionIndex = 63967;
...
public:
	...
	{
		return (::UnityEngine::Vector2Int*)Il2CppClass::FromTypeDefinitionIndex(Class_1_BA87A9A27051A21E_TypeDefinitionIndex)->GetStaticField(0x12720);
	}
	static ::UnityEngine::Vector2Int* StaticGet_Field_1_11()
	{
		return (::UnityEngine::Vector2Int*)Il2CppClass::FromTypeDefinitionIndex(Class_1_BA87A9A27051A21E_TypeDefinitionIndex)->GetStaticField(0x12728);
	}
	static ::UnityEngine::Vector2Int* StaticGet_Field_1_10()
	{
		return (::UnityEngine::Vector2Int*)Il2CppClass::FromTypeDefinitionIndex(Class_1_BA87A9A27051A21E_TypeDefinitionIndex)->GetStaticField(0x12730);
	}
	static ::UnityEngine::Vector2Int* StaticGet_Field_1_9()
	{
		return (::UnityEngine::Vector2Int*)Il2CppClass::FromTypeDefinitionIndex(Class_1_BA87A9A27051A21E_TypeDefinitionIndex)->GetStaticField(0x12738);
	}
