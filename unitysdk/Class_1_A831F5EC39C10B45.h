...
#define CLASS_1_A831F5EC39C10B45_EXECUTE_OFFSET UNITYSDK_OFFSET(0x8BC1C40)
#define CLASS_1_A831F5EC39C10B45_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x8BC1300)
#define CLASS_1_A831F5EC39C10B45_METHOD_1_00A4B38C951C5BD5_OFFSET UNITYSDK_OFFSET(0x8BC1100)
#define CLASS_1_A831F5EC39C10B45_METHOD_1_0BCA929F38D4D7DB_OFFSET UNITYSDK_OFFSET(0x8BC2EE0)
#define CLASS_1_A831F5EC39C10B45_METHOD_1_125126BF7ACBDD51_OFFSET UNITYSDK_OFFSET(0x8BBFB80)
#define CLASS_1_A831F5EC39C10B45_METHOD_1_168CDBBDB08BE45E_OFFSET UNITYSDK_OFFSET(0x8BC0FC0)
#define CLASS_1_A831F5EC39C10B45_METHOD_1_1DAEA1372099E262_OFFSET UNITYSDK_OFFSET(0x8BC0C90)
#define CLASS_1_A831F5EC39C10B45_METHOD_1_2416EE8102DF21CF_OFFSET UNITYSDK_OFFSET(0x8BC09A0)
#define CLASS_1_A831F5EC39C10B45_METHOD_1_2DC2C8C0FD03A63B_OFFSET UNITYSDK_OFFSET(0x8BBFD10)
#define CLASS_1_A831F5EC39C10B45_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x8BC2A30)
#define CLASS_1_A831F5EC39C10B45_METHOD_1_59779BE96F16C058_OFFSET UNITYSDK_OFFSET(0x8BC2F80)
#define CLASS_1_A831F5EC39C10B45_METHOD_1_6A664DCBFEADE56F_OFFSET UNITYSDK_OFFSET(0x8BC2C40)
#define CLASS_1_A831F5EC39C10B45_METHOD_1_8714CF4AE9195CA2_OFFSET UNITYSDK_OFFSET(0x8BC1870)
#define CLASS_1_A831F5EC39C10B45_METHOD_1_94CBD0C21A609187_OFFSET UNITYSDK_OFFSET(0x8BBFDA0)
#define CLASS_1_A831F5EC39C10B45_METHOD_1_B3EC426F9661E4D1_OFFSET UNITYSDK_OFFSET(0x8BC0D10)
#define CLASS_1_A831F5EC39C10B45_METHOD_1_C9072C01C81FE8E4_OFFSET UNITYSDK_OFFSET(0x8BC2A70)
#define CLASS_1_A831F5EC39C10B45_METHOD_1_DAEB27AB569ACC67_OFFSET UNITYSDK_OFFSET(0x8BC3300)
#define CLASS_1_A831F5EC39C10B45_METHOD_1_DE1C1F4DF5D06882_OFFSET UNITYSDK_OFFSET(0x8BC1A50)
#define CLASS_1_A831F5EC39C10B45_METHOD_1_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0x8BC25B0)
#define CLASS_1_A831F5EC39C10B45_METHOD_1_FC15BAFC5717F4C6_OFFSET UNITYSDK_OFFSET(0x8BC0470)
#define CLASS_1_A831F5EC39C10B45_TEARDOWN_OFFSET UNITYSDK_OFFSET(0x8BC2680)
#define CLASS_1_A831F5EC39C10B45__CCTOR_OFFSET UNITYSDK_OFFSET(0x8BC3470)
#define CLASS_1_A831F5EC39C10B45__CTOR_OFFSET UNITYSDK_OFFSET(0x8BBF6C0)
#define CLASS_1_A831F5EC39C10B45__EXECUTE_B__12_0_OFFSET UNITYSDK_OFFSET(0x8BC34B0)

inline static constexpr unsigned int Class_1_A831F5EC39C10B45_TypeDefinitionIndex = 62483;
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A831F5EC39C10B45_TypeDefinitionIndex)->GetStaticField(0x467B0);
	}
	::Entitas::IGroup_1<::Class_2_0C58AD91B0F4D809*>* Field_1_17; // 0x10
	::RPG::Client::LittleGame::FourRotateVoxel::FourRotateVoxelGlobalData* Field_1_9; // 0x18
	::System::Collections::Generic::Dictionary_2<::System::Int32, ::Class_1_A831F5EC39C10B45_Class_3_42C3ADEFE001CF00_1*>* Field_1_15; // 0x20
	::Entitas::IGroup_1<::Class_2_0C58AD91B0F4D809*>* Field_1_2; // 0x28
	::Class_1_867B6CE75953535A_1* Field_1_0; // 0x30
	::System::Collections::Generic::Dictionary_2<::Class_2_0C58AD91B0F4D809*, ::RPG::Client::LittleGame::FourRotateVoxel::FourRotateVoxelAnimalAttachBillboardData*>* Field_1_16; // 0x38
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_2_0C58AD91B0F4D809*>* Field_1_4; // 0x40
	::Class_3_D6E9A038FA23103A* Field_1_1; // 0x48
	::System::Collections::Generic::List_1<::Class_2_0C58AD91B0F4D809*>* Field_1_13; // 0x50
	::System::Collections::Generic::Dictionary_2<::Class_2_0C58AD91B0F4D809*, ::RPG::Client::LittleGame::FourRotateVoxel::FourRotateVoxelProgressTipsData*>* Field_1_5; // 0x58
	::RPG::GameCore::FourRotateVoxelPortalConfig* Field_1_12; // 0x60
