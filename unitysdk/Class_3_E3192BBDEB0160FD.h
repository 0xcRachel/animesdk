...
#define CLASS_3_E3192BBDEB0160FD_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10254330)
#define CLASS_3_E3192BBDEB0160FD_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10254370)
#define CLASS_3_E3192BBDEB0160FD__CTOR_OFFSET UNITYSDK_OFFSET(0x10254300)
#define CLASS_3_E3192BBDEB0160FD___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x102548F0)

inline static constexpr unsigned int Class_3_E3192BBDEB0160FD_TypeDefinitionIndex = 43227;
