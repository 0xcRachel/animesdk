...
#define CLASS_2_60E87BC9A034C702_GET_MESSAGE_OFFSET UNITYSDK_OFFSET(0xE4A9500)
#define CLASS_2_60E87BC9A034C702__CTOR_OFFSET UNITYSDK_OFFSET(0xE4A9490)
#define CLASS_2_60E87BC9A034C702___IFIXBASEPROXY_GET_MESSAGE_OFFSET UNITYSDK_OFFSET(0xE4A9590)
