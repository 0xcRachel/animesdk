...
#define CLASS_1_A291A0C2D65983FA_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17D0E1D0)
#define CLASS_1_A291A0C2D65983FA_CLONE_OFFSET UNITYSDK_OFFSET(0x17D0DDA0)
#define CLASS_1_A291A0C2D65983FA_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17D0DF40)
#define CLASS_1_A291A0C2D65983FA_EQUALS_OFFSET UNITYSDK_OFFSET(0x17D0DE60)
#define CLASS_1_A291A0C2D65983FA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17D0DFF0)
#define CLASS_1_A291A0C2D65983FA_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x17D0E3D0)
#define CLASS_1_A291A0C2D65983FA_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x17D0E360)
#define CLASS_1_A291A0C2D65983FA_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x17D0DE10)
#define CLASS_1_A291A0C2D65983FA_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x17D0DDF0)
#define CLASS_1_A291A0C2D65983FA_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x17D0DE20)
#define CLASS_1_A291A0C2D65983FA_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x17D0DE00)
#define CLASS_1_A291A0C2D65983FA_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x17D0DE40)
#define CLASS_1_A291A0C2D65983FA_METHOD_1_EA98AC27B86895E5_OFFSET UNITYSDK_OFFSET(0x17D0DE50)
#define CLASS_1_A291A0C2D65983FA_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x17D0DE30)
#define CLASS_1_A291A0C2D65983FA_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17D0DCE0)
#define CLASS_1_A291A0C2D65983FA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17D0E040)
#define CLASS_1_A291A0C2D65983FA_WRITETO_OFFSET UNITYSDK_OFFSET(0x17D0E0A0)
#define CLASS_1_A291A0C2D65983FA__CCTOR_OFFSET UNITYSDK_OFFSET(0x17D0E4E0)
#define CLASS_1_A291A0C2D65983FA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17D0DD20)
#define CLASS_1_A291A0C2D65983FA__CTOR_OFFSET UNITYSDK_OFFSET(0x17D0DCF0)
...
public:
	...
	{
		return (::Google::Protobuf::Collections::MapField_2_Codec<::System::UInt32, ::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A291A0C2D65983FA_TypeDefinitionIndex)->GetStaticField(0xD310);
	}
