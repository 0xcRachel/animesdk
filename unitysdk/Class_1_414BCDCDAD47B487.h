...
#define CLASS_1_414BCDCDAD47B487_GET_DISTANCE_OFFSET UNITYSDK_OFFSET(0x14BFA230)
#define CLASS_1_414BCDCDAD47B487_GET_DITHERSWITCH_OFFSET UNITYSDK_OFFSET(0x14BFA290)
#define CLASS_1_414BCDCDAD47B487_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x14BFA210)
#define CLASS_1_414BCDCDAD47B487_GET_ISAUTOGEN_OFFSET UNITYSDK_OFFSET(0x14BFA2B0)
#define CLASS_1_414BCDCDAD47B487_GET_ISPERSISTENT_OFFSET UNITYSDK_OFFSET(0x14BFA220)
#define CLASS_1_414BCDCDAD47B487_GET_LAYERTYPE_OFFSET UNITYSDK_OFFSET(0x14BFA280)
#define CLASS_1_414BCDCDAD47B487_GET_LAYER_OFFSET UNITYSDK_OFFSET(0x14BFA270)
#define CLASS_1_414BCDCDAD47B487_GET_LODDETAILLIST_OFFSET UNITYSDK_OFFSET(0x14BFA260)
#define CLASS_1_414BCDCDAD47B487_GET_NAME_OFFSET UNITYSDK_OFFSET(0x14BFA200)
#define CLASS_1_414BCDCDAD47B487_GET_NORMDISTANCE_OFFSET UNITYSDK_OFFSET(0x14BFA240)
#define CLASS_1_414BCDCDAD47B487_GET_OBJECTSIZE_OFFSET UNITYSDK_OFFSET(0x14BFA250)
#define CLASS_1_414BCDCDAD47B487_GET_SOURCELODTEMPLATE_OFFSET UNITYSDK_OFFSET(0x14BFA2D0)
#define CLASS_1_414BCDCDAD47B487_GET_SOURCENORMDISTANCETEMPLATE_OFFSET UNITYSDK_OFFSET(0x14BFA2E0)
#define CLASS_1_414BCDCDAD47B487_GET_SOURCETYPE_OFFSET UNITYSDK_OFFSET(0x14BFA2C0)
#define CLASS_1_414BCDCDAD47B487_GET_USEAABBDIST_OFFSET UNITYSDK_OFFSET(0x14BFA2A0)
#define CLASS_1_414BCDCDAD47B487_METHOD_1_2A2D5F8C97A46780_OFFSET UNITYSDK_OFFSET(0x14BFA0E0)
#define CLASS_1_414BCDCDAD47B487_METHOD_1_ADE7EC82E13C7741_OFFSET UNITYSDK_OFFSET(0x14BF9FB0)
#define CLASS_1_414BCDCDAD47B487_METHOD_1_CFE6FB160FFF5938_OFFSET UNITYSDK_OFFSET(0x14BFA040)
#define CLASS_1_414BCDCDAD47B487_METHOD_1_F026F9F94BAA5E1F_OFFSET UNITYSDK_OFFSET(0x14BFA3B0)
#define CLASS_1_414BCDCDAD47B487_METHOD_1_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0x14BFA410)
#define CLASS_1_414BCDCDAD47B487_METHOD_1_FB4BE762B6186C23_OFFSET UNITYSDK_OFFSET(0x14BFA2F0)
#define CLASS_1_414BCDCDAD47B487_METHOD_1_FD97D7184557CB1A_1_OFFSET UNITYSDK_OFFSET(0x14BFA310)
#define CLASS_1_414BCDCDAD47B487_METHOD_1_FD97D7184557CB1A_2_OFFSET UNITYSDK_OFFSET(0x14BFA360)
#define CLASS_1_414BCDCDAD47B487_METHOD_1_FD97D7184557CB1A_OFFSET UNITYSDK_OFFSET(0x14BFA1A0)
#define CLASS_1_414BCDCDAD47B487__CTOR_1_OFFSET UNITYSDK_OFFSET(0x14BF9D60)
#define CLASS_1_414BCDCDAD47B487__CTOR_OFFSET UNITYSDK_OFFSET(0x14BF9C60)

inline static constexpr unsigned int Class_1_414BCDCDAD47B487_TypeDefinitionIndex = 68978;
...
public:
	...
	::RPG::GameCore::NormDistanceLodTemplate* _SourceNormDistanceTemplate_k__BackingField; // 0x28
	::Class_1_F756B10AB29D1235* Field_1_4; // 0x30
	::RPG::GameCore::LodTemplate* _SourceLodTemplate_k__BackingField; // 0x38
	::System::Boolean _IsPersistent_k__BackingField; // 0x40
	::System::Boolean _DitherSwitch_k__BackingField; // 0x41
	::System::Boolean _IsAutoGen_k__BackingField; // 0x42
	::System::Boolean _UseAABBDist_k__BackingField; // 0x43
	::System::Single _Distance_k__BackingField; // 0x44
	::System::Int32 _Index_k__BackingField; // 0x48
	::RPG::GameCore::StreamingLayerType _LayerType_k__BackingField; // 0x4C
	::System::Single _NormDistance_k__BackingField; // 0x50
	::RPG::Client::OpenWorld::LodTemplateSourceType _SourceType_k__BackingField; // 0x54
	::System::Single _ObjectSize_k__BackingField; // 0x58
