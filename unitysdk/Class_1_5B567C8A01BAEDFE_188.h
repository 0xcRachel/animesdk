...
#define CLASS_1_5B567C8A01BAEDFE_188_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A443AA0)
#define CLASS_1_5B567C8A01BAEDFE_188_CLONE_OFFSET UNITYSDK_OFFSET(0x1A443910)
#define CLASS_1_5B567C8A01BAEDFE_188_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A4439B0)
#define CLASS_1_5B567C8A01BAEDFE_188_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A443950)
#define CLASS_1_5B567C8A01BAEDFE_188_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A443A00)
#define CLASS_1_5B567C8A01BAEDFE_188_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A443AF0)
#define CLASS_1_5B567C8A01BAEDFE_188_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A443AC0)
#define CLASS_1_5B567C8A01BAEDFE_188_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A443890)
#define CLASS_1_5B567C8A01BAEDFE_188_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A4438C0)
#define CLASS_1_5B567C8A01BAEDFE_188_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A443A30)
#define CLASS_1_5B567C8A01BAEDFE_188_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A443A90)
#define CLASS_1_5B567C8A01BAEDFE_188__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A443B40)
#define CLASS_1_5B567C8A01BAEDFE_188__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A4438E0)
#define CLASS_1_5B567C8A01BAEDFE_188__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4438D0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_188*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_188_TypeDefinitionIndex)->GetStaticField(0xCF50);
	}
