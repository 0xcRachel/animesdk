...
#define CLASS_1_5B567C8A01BAEDFE_13_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A178630)
#define CLASS_1_5B567C8A01BAEDFE_13_CLONE_OFFSET UNITYSDK_OFFSET(0x1A1784A0)
#define CLASS_1_5B567C8A01BAEDFE_13_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A178540)
#define CLASS_1_5B567C8A01BAEDFE_13_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A1784E0)
#define CLASS_1_5B567C8A01BAEDFE_13_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A178590)
#define CLASS_1_5B567C8A01BAEDFE_13_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A178680)
#define CLASS_1_5B567C8A01BAEDFE_13_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A178650)
#define CLASS_1_5B567C8A01BAEDFE_13_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A178420)
#define CLASS_1_5B567C8A01BAEDFE_13_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A178450)
#define CLASS_1_5B567C8A01BAEDFE_13_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A1785C0)
#define CLASS_1_5B567C8A01BAEDFE_13_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A178620)
#define CLASS_1_5B567C8A01BAEDFE_13__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1786D0)
#define CLASS_1_5B567C8A01BAEDFE_13__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A178470)
#define CLASS_1_5B567C8A01BAEDFE_13__CTOR_OFFSET UNITYSDK_OFFSET(0x1A178460)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_13*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_13_TypeDefinitionIndex)->GetStaticField(0x168B0);
	}
