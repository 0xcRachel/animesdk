...
#define CLASS_1_E0A0A2422B605BDB_METHOD_1_943A3CE8BB953879_OFFSET UNITYSDK_OFFSET(0x104319C0)
#define CLASS_1_E0A0A2422B605BDB_METHOD_1_F22E7E7C9FC01A6F_OFFSET UNITYSDK_OFFSET(0x10431BA0)
#define CLASS_1_E0A0A2422B605BDB__CCTOR_OFFSET UNITYSDK_OFFSET(0x10431C80)
...
public:
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::UnityEngine::PrimitiveType, ::UnityEngine::Mesh*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E0A0A2422B605BDB_TypeDefinitionIndex)->GetStaticField(0x68900);
	}
