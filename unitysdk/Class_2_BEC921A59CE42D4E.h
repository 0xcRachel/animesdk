...
#define CLASS_2_BEC921A59CE42D4E_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x8922EC0)
#define CLASS_2_BEC921A59CE42D4E_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x8923360)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_0E90C422C1085C42_OFFSET UNITYSDK_OFFSET(0x8921800)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_1622EF55C818E85D_OFFSET UNITYSDK_OFFSET(0x8921AF0)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_1947BC35B7A7FCB8_OFFSET UNITYSDK_OFFSET(0x8921C30)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_26E509975F92479C_OFFSET UNITYSDK_OFFSET(0x8920450)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_33B23A505F8C30B9_OFFSET UNITYSDK_OFFSET(0x89205A0)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x8920860)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x89206F0)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_479759059E440327_OFFSET UNITYSDK_OFFSET(0x89223A0)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_47F50B259C23D1F5_OFFSET UNITYSDK_OFFSET(0x8922170)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_489E3BF8986E4AAB_OFFSET UNITYSDK_OFFSET(0x8920BB0)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0x89238C0)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x8923860)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_668B9BDA71E41E56_OFFSET UNITYSDK_OFFSET(0x8921070)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_6A88390AF1F85B81_OFFSET UNITYSDK_OFFSET(0x8921F90)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_84516C3E776F194F_OFFSET UNITYSDK_OFFSET(0x89216E0)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x8922570)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_973AD2983CC3B48D_OFFSET UNITYSDK_OFFSET(0x8920CF0)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_A27D06F9481FAFDB_1_OFFSET UNITYSDK_OFFSET(0x8922790)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_A27D06F9481FAFDB_2_OFFSET UNITYSDK_OFFSET(0x8922850)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_A27D06F9481FAFDB_3_OFFSET UNITYSDK_OFFSET(0x8922910)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_A27D06F9481FAFDB_4_OFFSET UNITYSDK_OFFSET(0x89229D0)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_A27D06F9481FAFDB_5_OFFSET UNITYSDK_OFFSET(0x8922A90)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_A27D06F9481FAFDB_6_OFFSET UNITYSDK_OFFSET(0x8922AF0)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_A27D06F9481FAFDB_7_OFFSET UNITYSDK_OFFSET(0x8922B50)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_A27D06F9481FAFDB_8_OFFSET UNITYSDK_OFFSET(0x8922D30)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0x89226D0)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_A41DCE32DA5A80B1_OFFSET UNITYSDK_OFFSET(0x89211E0)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_AAD21DE195D05736_OFFSET UNITYSDK_OFFSET(0x8921770)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x89224E0)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_CFC95121222309BD_OFFSET UNITYSDK_OFFSET(0x8921EC0)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x8922430)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_D53F77FB0786250F_OFFSET UNITYSDK_OFFSET(0x8921980)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_DA1BF2C227DC3D86_1_OFFSET UNITYSDK_OFFSET(0x8922630)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_DA1BF2C227DC3D86_2_OFFSET UNITYSDK_OFFSET(0x8922680)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0x89225E0)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_E8007A2462D4E38D_OFFSET UNITYSDK_OFFSET(0x8920F00)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_F37CDBD6D46274D2_1_OFFSET UNITYSDK_OFFSET(0x8922DF0)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x8922C10)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_F978A1D172468895_OFFSET UNITYSDK_OFFSET(0x89221C0)
#define CLASS_2_BEC921A59CE42D4E_METHOD_2_FB9C56D85A195632_OFFSET UNITYSDK_OFFSET(0x8920C50)
#define CLASS_2_BEC921A59CE42D4E_ONACQUIRE_OFFSET UNITYSDK_OFFSET(0x89203F0)
#define CLASS_2_BEC921A59CE42D4E_ONRETURN_OFFSET UNITYSDK_OFFSET(0x8920690)
#define CLASS_2_BEC921A59CE42D4E__CTOR_OFFSET UNITYSDK_OFFSET(0x89237D0)
#define CLASS_2_BEC921A59CE42D4E__ONBIND_OFFSET UNITYSDK_OFFSET(0x891F8C0)
#define CLASS_2_BEC921A59CE42D4E__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x8920A10)
#define CLASS_2_BEC921A59CE42D4E__ONTICK_OFFSET UNITYSDK_OFFSET(0x8920A70)
#define CLASS_2_BEC921A59CE42D4E___IFIXBASEPROXY_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x89239F0)
#define CLASS_2_BEC921A59CE42D4E___IFIXBASEPROXY_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x8923A50)
#define CLASS_2_BEC921A59CE42D4E___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0x8923800)
#define CLASS_2_BEC921A59CE42D4E___IFIXBASEPROXY__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x8923920)
#define CLASS_2_BEC921A59CE42D4E___IFIXBASEPROXY__ONTICK_OFFSET UNITYSDK_OFFSET(0x8923980)

inline static constexpr unsigned int Class_2_BEC921A59CE42D4E_TypeDefinitionIndex = 59052;
...
public:
	...
	::Class_3_06E3452A211FC6E5* Field_2_38; // 0x60
	::Class_2_5909B42D62F4BAE7* Field_2_4; // 0x68
	::RPG::GameCore::BattleInstance* Field_2_21; // 0x70
	::RPG::Client::PrefabLoadMeta* Field_2_17; // 0x78
	::UnityEngine::Animation* Field_2_12; // 0x80
	::UnityEngine::Transform* Field_2_8; // 0x88
	::UnityEngine::Transform* Field_2_9; // 0x90
	::RPG::GameCore::GameEntity* Field_2_22; // 0x98
	::UnityEngine::Animation* Field_2_14; // 0xA0
	::UnityEngine::Transform* Field_2_7; // 0xA8
	::Class_2_6E096A5FCBA7A3BD* Field_2_1; // 0xB0
	::Class_2_E0065B933D71D9A9* Field_2_19; // 0xB8
	::RPG::GameCore::LevelUIComponent* Field_2_20; // 0xC0
	::RPG::GameCore::CharacterDataComponent* Field_2_23; // 0xC8
	::UnityEngine::Transform* Field_2_5; // 0xD0
	::UnityEngine::Animation* Field_2_13; // 0xD8
	::UnityEngine::UI::Image* Field_2_6; // 0xE0
	::UnityEngine::GameObject* Field_2_18; // 0xE8
	::Class_2_BEBFA6F35799FF11* Field_2_0; // 0xF0
	::RPG::Client::MonoInControlTip* Field_2_16; // 0xF8
	::Class_2_1DBA4BCA19BD1EB4* Field_2_2; // 0x100
	::Class_2_23479FD4B2E122E9* Field_2_3; // 0x108
	::UnityEngine::Transform* Field_2_10; // 0x110
	::UnityEngine::Transform* Field_2_11; // 0x118
	::Class_2_78405B03A0233CB3* Field_2_24; // 0x120
	::Class_2_D3061860904844A0* Field_2_15; // 0x128
	...
	::System::Boolean Field_2_28; // 0x142
	::System::Boolean Field_2_25; // 0x143
