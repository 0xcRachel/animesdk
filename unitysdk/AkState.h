...
#define AKSTATE_GET_GROUPGUID_OFFSET UNITYSDK_OFFSET(0x18410440)
#define AKSTATE_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x18410280)
#define AKSTATE_GET_VALUEGUID_OFFSET UNITYSDK_OFFSET(0x184102E0)
#define AKSTATE_GET_VALUEID_OFFSET UNITYSDK_OFFSET(0x18410200)
#define AKSTATE_GET_WWISETYPE_OFFSET UNITYSDK_OFFSET(0x18410010)
#define AKSTATE_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x184101A0)
#define AKSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x184105A0)

inline static constexpr unsigned int AkState_TypeDefinitionIndex = 33702;
