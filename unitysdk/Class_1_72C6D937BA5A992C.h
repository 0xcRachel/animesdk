...
#define CLASS_1_72C6D937BA5A992C_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A4E1F50)
#define CLASS_1_72C6D937BA5A992C_CLONE_OFFSET UNITYSDK_OFFSET(0x1A4E1A50)
#define CLASS_1_72C6D937BA5A992C_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A4E1BD0)
#define CLASS_1_72C6D937BA5A992C_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A4E1B10)
#define CLASS_1_72C6D937BA5A992C_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A4E1C90)
#define CLASS_1_72C6D937BA5A992C_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A4E22D0)
#define CLASS_1_72C6D937BA5A992C_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A4E2260)
#define CLASS_1_72C6D937BA5A992C_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1A4E1AD0)
#define CLASS_1_72C6D937BA5A992C_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1A4E1AB0)
#define CLASS_1_72C6D937BA5A992C_METHOD_1_3163C288F3AE2966_OFFSET UNITYSDK_OFFSET(0x1A4E1A90)
#define CLASS_1_72C6D937BA5A992C_METHOD_1_4C4B9DFE092840D4_OFFSET UNITYSDK_OFFSET(0x1A4E1B00)
#define CLASS_1_72C6D937BA5A992C_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1A4E1AA0)
#define CLASS_1_72C6D937BA5A992C_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A4E1920)
#define CLASS_1_72C6D937BA5A992C_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1A4E1AE0)
#define CLASS_1_72C6D937BA5A992C_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1A4E1AC0)
#define CLASS_1_72C6D937BA5A992C_METHOD_1_7ADD5F1F5E247E3B_OFFSET UNITYSDK_OFFSET(0x1A4E1AF0)
#define CLASS_1_72C6D937BA5A992C_METHOD_1_CE81D059476B1F49_OFFSET UNITYSDK_OFFSET(0x1A4E1A80)
#define CLASS_1_72C6D937BA5A992C_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A4E1950)
#define CLASS_1_72C6D937BA5A992C_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A4E1DD0)
#define CLASS_1_72C6D937BA5A992C_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A4E1E30)
#define CLASS_1_72C6D937BA5A992C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A4E23E0)
#define CLASS_1_72C6D937BA5A992C__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A4E19B0)
#define CLASS_1_72C6D937BA5A992C__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4E1960)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_72C6D937BA5A992C*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_72C6D937BA5A992C_TypeDefinitionIndex)->GetStaticField(0xACA0);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_5()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_72C6D937BA5A992C_TypeDefinitionIndex)->GetStaticField(0xACA8);
	}
