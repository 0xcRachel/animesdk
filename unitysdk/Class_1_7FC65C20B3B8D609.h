...
#define CLASS_1_7FC65C20B3B8D609_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19BF6F40)
#define CLASS_1_7FC65C20B3B8D609_CLONE_OFFSET UNITYSDK_OFFSET(0x19BF6A60)
#define CLASS_1_7FC65C20B3B8D609_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19BF6C90)
#define CLASS_1_7FC65C20B3B8D609_EQUALS_OFFSET UNITYSDK_OFFSET(0x19BF6BB0)
#define CLASS_1_7FC65C20B3B8D609_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19BF6D60)
#define CLASS_1_7FC65C20B3B8D609_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19BF7310)
#define CLASS_1_7FC65C20B3B8D609_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19BF7250)
#define CLASS_1_7FC65C20B3B8D609_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x19BF6B50)
#define CLASS_1_7FC65C20B3B8D609_METHOD_1_02A3D10A9D535169_2_OFFSET UNITYSDK_OFFSET(0x19BF6B70)
#define CLASS_1_7FC65C20B3B8D609_METHOD_1_02A3D10A9D535169_3_OFFSET UNITYSDK_OFFSET(0x19BF6B90)
#define CLASS_1_7FC65C20B3B8D609_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x19BF6B30)
#define CLASS_1_7FC65C20B3B8D609_METHOD_1_3163C288F3AE2966_OFFSET UNITYSDK_OFFSET(0x19BF6B00)
#define CLASS_1_7FC65C20B3B8D609_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19BF6990)
#define CLASS_1_7FC65C20B3B8D609_METHOD_1_686CBC4FBD0AAA58_OFFSET UNITYSDK_OFFSET(0x19BF6B20)
#define CLASS_1_7FC65C20B3B8D609_METHOD_1_6BD2A2909D8CFAD3_OFFSET UNITYSDK_OFFSET(0x19BF6B10)
#define CLASS_1_7FC65C20B3B8D609_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x19BF6B60)
#define CLASS_1_7FC65C20B3B8D609_METHOD_1_7786DC814C2FC3BE_2_OFFSET UNITYSDK_OFFSET(0x19BF6B80)
#define CLASS_1_7FC65C20B3B8D609_METHOD_1_7786DC814C2FC3BE_3_OFFSET UNITYSDK_OFFSET(0x19BF6BA0)
#define CLASS_1_7FC65C20B3B8D609_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x19BF6B40)
#define CLASS_1_7FC65C20B3B8D609_METHOD_1_CE81D059476B1F49_OFFSET UNITYSDK_OFFSET(0x19BF6AF0)
#define CLASS_1_7FC65C20B3B8D609_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19BF69C0)
#define CLASS_1_7FC65C20B3B8D609_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19BF6DC0)
#define CLASS_1_7FC65C20B3B8D609_WRITETO_OFFSET UNITYSDK_OFFSET(0x19BF6E20)
#define CLASS_1_7FC65C20B3B8D609__CCTOR_OFFSET UNITYSDK_OFFSET(0x19BF7440)
#define CLASS_1_7FC65C20B3B8D609__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19BF69E0)
#define CLASS_1_7FC65C20B3B8D609__CTOR_OFFSET UNITYSDK_OFFSET(0x19BF69D0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_7FC65C20B3B8D609*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_7FC65C20B3B8D609_TypeDefinitionIndex)->GetStaticField(0x15F40);
	}
