...
#define DEBUGINFORENDERINGDETAIL__CTOR_OFFSET UNITYSDK_OFFSET(0xB2BD3D0)

inline static constexpr unsigned int DebugInfoRenderingDetail_TypeDefinitionIndex = 37479;
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DebugInfoRenderingDetail_TypeDefinitionIndex)->GetStaticField(0x12B40);
	}
