...
#define CLASS_2_D8A9B7E75FE2A68B_2_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xE0B9B50)
#define CLASS_2_D8A9B7E75FE2A68B_2_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xE0B9C90)
#define CLASS_2_D8A9B7E75FE2A68B_2_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xE0B76D0)
#define CLASS_2_D8A9B7E75FE2A68B_2_METHOD_2_01509228E3A9577B_OFFSET UNITYSDK_OFFSET(0xE0B9A60)
#define CLASS_2_D8A9B7E75FE2A68B_2_METHOD_2_0DB3B52F010E39B1_OFFSET UNITYSDK_OFFSET(0xE0B85E0)
#define CLASS_2_D8A9B7E75FE2A68B_2_METHOD_2_17BD30EFE8176014_OFFSET UNITYSDK_OFFSET(0xE0B7FE0)
#define CLASS_2_D8A9B7E75FE2A68B_2_METHOD_2_17F2CC8F872A04EE_OFFSET UNITYSDK_OFFSET(0xE0B8BF0)
#define CLASS_2_D8A9B7E75FE2A68B_2_METHOD_2_2EE5451A8927066E_OFFSET UNITYSDK_OFFSET(0xE0B8D70)
#define CLASS_2_D8A9B7E75FE2A68B_2_METHOD_2_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0xE0B9020)
#define CLASS_2_D8A9B7E75FE2A68B_2_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xE0B83A0)
#define CLASS_2_D8A9B7E75FE2A68B_2_METHOD_2_507A5122CD01412B_1_OFFSET UNITYSDK_OFFSET(0xE0B9750)
#define CLASS_2_D8A9B7E75FE2A68B_2_METHOD_2_507A5122CD01412B_OFFSET UNITYSDK_OFFSET(0xE0B92A0)
#define CLASS_2_D8A9B7E75FE2A68B_2_METHOD_2_56FE2EA783DDD2BA_OFFSET UNITYSDK_OFFSET(0xE0B8940)
#define CLASS_2_D8A9B7E75FE2A68B_2_METHOD_2_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0xE0B9FD0)
#define CLASS_2_D8A9B7E75FE2A68B_2_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xE0B9F70)
#define CLASS_2_D8A9B7E75FE2A68B_2_METHOD_2_67600FA8688BAD61_OFFSET UNITYSDK_OFFSET(0xE0B8830)
#define CLASS_2_D8A9B7E75FE2A68B_2_METHOD_2_7AEA4B2B25797605_OFFSET UNITYSDK_OFFSET(0xE0B93C0)
#define CLASS_2_D8A9B7E75FE2A68B_2_METHOD_2_7AFC74ADCC2A9C7A_OFFSET UNITYSDK_OFFSET(0xE0B89E0)
#define CLASS_2_D8A9B7E75FE2A68B_2_METHOD_2_848FDD59AB054F3D_OFFSET UNITYSDK_OFFSET(0xE0B8AA0)
#define CLASS_2_D8A9B7E75FE2A68B_2_METHOD_2_87A50CA00FA4E23D_OFFSET UNITYSDK_OFFSET(0xE0B8E90)
#define CLASS_2_D8A9B7E75FE2A68B_2_METHOD_2_8A0FE0FA78BDB613_OFFSET UNITYSDK_OFFSET(0xE0B9440)
#define CLASS_2_D8A9B7E75FE2A68B_2_METHOD_2_8C3DB70FFBBF01C7_1_OFFSET UNITYSDK_OFFSET(0xE0B8450)
#define CLASS_2_D8A9B7E75FE2A68B_2_METHOD_2_8C3DB70FFBBF01C7_OFFSET UNITYSDK_OFFSET(0xE0B8210)
#define CLASS_2_D8A9B7E75FE2A68B_2_METHOD_2_9477221A6F70535F_OFFSET UNITYSDK_OFFSET(0xE0B9580)
#define CLASS_2_D8A9B7E75FE2A68B_2_METHOD_2_A27D06F9481FAFDB_1_OFFSET UNITYSDK_OFFSET(0xE0B9940)
#define CLASS_2_D8A9B7E75FE2A68B_2_METHOD_2_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0xE0B98A0)
#define CLASS_2_D8A9B7E75FE2A68B_2_METHOD_2_C20A7E9DF3996211_OFFSET UNITYSDK_OFFSET(0xE0B81A0)
#define CLASS_2_D8A9B7E75FE2A68B_2_METHOD_2_CE34EA208837238D_OFFSET UNITYSDK_OFFSET(0xE0B96C0)
#define CLASS_2_D8A9B7E75FE2A68B_2_METHOD_2_DDBFE8E9D8449B5F_OFFSET UNITYSDK_OFFSET(0xE0B8150)
#define CLASS_2_D8A9B7E75FE2A68B_2_METHOD_2_F0880AD023811E29_OFFSET UNITYSDK_OFFSET(0xE0BA0A0)
#define CLASS_2_D8A9B7E75FE2A68B_2_METHOD_2_FDE09C8D62639E3E_OFFSET UNITYSDK_OFFSET(0xE0B8B30)
#define CLASS_2_D8A9B7E75FE2A68B_2_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xE0B7710)
#define CLASS_2_D8A9B7E75FE2A68B_2__CTOR_OFFSET UNITYSDK_OFFSET(0xE0B9DB0)
#define CLASS_2_D8A9B7E75FE2A68B_2__ONBIND_OFFSET UNITYSDK_OFFSET(0xE0B7750)
#define CLASS_2_D8A9B7E75FE2A68B_2__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0xE0B7F70)
#define CLASS_2_D8A9B7E75FE2A68B_2__ONTICK_OFFSET UNITYSDK_OFFSET(0xE0B9070)
#define CLASS_2_D8A9B7E75FE2A68B_2___IFIXBASEPROXY_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xE0BA110)
#define CLASS_2_D8A9B7E75FE2A68B_2___IFIXBASEPROXY_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xE0BA170)
#define CLASS_2_D8A9B7E75FE2A68B_2___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0xE0B9EB0)
#define CLASS_2_D8A9B7E75FE2A68B_2___IFIXBASEPROXY__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0xE0B9F10)
#define CLASS_2_D8A9B7E75FE2A68B_2___IFIXBASEPROXY__ONTICK_OFFSET UNITYSDK_OFFSET(0xE0BA030)

inline static constexpr unsigned int Class_2_D8A9B7E75FE2A68B_2_TypeDefinitionIndex = 66567;
...
public:
	...
	{
		return (::Class_2_D8A9B7E75FE2A68B_2**)Il2CppClass::FromTypeDefinitionIndex(Class_2_D8A9B7E75FE2A68B_2_TypeDefinitionIndex)->GetStaticField(0x53960);
	}
	...
	::Class_2_764C2D7D755EF63E* Field_2_7; // 0x60
	::UnityEngine::Transform* Field_2_2; // 0x68
	::System::Collections::Generic::Stack_1<::Class_2_ED349B47CFEDF9B8*>* Field_2_21; // 0x70
	::UnityEngine::RectTransform* Field_2_11; // 0x78
	::System::Collections::Generic::Stack_1<::Class_2_ED349B47CFEDF9B8*>* Field_2_22; // 0x80
	::RPG::Client::BattleGamePhase* Field_2_16; // 0x88
	::UnityEngine::Transform* Field_2_3; // 0x90
	::Class_2_2B7D66B6C432C71D* Field_2_6; // 0x98
	::RPG::UINavigation::UINavigationZoneManager* Field_2_15; // 0xA0
	::UnityEngine::Transform* Field_2_10; // 0xA8
	::UnityEngine::UI::Button* Field_2_4; // 0xB0
	::UnityEngine::Animation* Field_2_8; // 0xB8
	::RPG::Client::MonoClickOutsideDetect* Field_2_12; // 0xC0
