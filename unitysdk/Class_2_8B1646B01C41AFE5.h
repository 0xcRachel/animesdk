...
#define CLASS_2_8B1646B01C41AFE5_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10DEFA70)
#define CLASS_2_8B1646B01C41AFE5_METHOD_2_C2422E9C86913F34_OFFSET UNITYSDK_OFFSET(0x10DEFB60)
#define CLASS_2_8B1646B01C41AFE5_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10DEFAB0)
#define CLASS_2_8B1646B01C41AFE5_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10DEFBF0)
#define CLASS_2_8B1646B01C41AFE5_TICK_OFFSET UNITYSDK_OFFSET(0x10DEFC40)
#define CLASS_2_8B1646B01C41AFE5__CTOR_OFFSET UNITYSDK_OFFSET(0x10DEFA60)

inline static constexpr unsigned int Class_2_8B1646B01C41AFE5_TypeDefinitionIndex = 42423;
