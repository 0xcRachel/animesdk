...
#define CLASS_3_A000EDE5E4958479_GET_DEFAULTCOMMENTID_OFFSET UNITYSDK_OFFSET(0xE380660)
#define CLASS_3_A000EDE5E4958479_GET_GUID_OFFSET UNITYSDK_OFFSET(0xE380680)
#define CLASS_3_A000EDE5E4958479_GET_ONBTNCLOSE_OFFSET UNITYSDK_OFFSET(0xE380600)
#define CLASS_3_A000EDE5E4958479_GET_ONBTNGO_OFFSET UNITYSDK_OFFSET(0xE3805E0)
#define CLASS_3_A000EDE5E4958479_GET_ONBTNIMAGE_OFFSET UNITYSDK_OFFSET(0xE380620)
#define CLASS_3_A000EDE5E4958479_GET_POSTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xE380640)
#define CLASS_3_A000EDE5E4958479_METHOD_3_6E57D3559C10FFA9_OFFSET UNITYSDK_OFFSET(0xE37FEE0)
#define CLASS_3_A000EDE5E4958479_METHOD_3_8542E37E74FDE1B5_OFFSET UNITYSDK_OFFSET(0xE3803A0)
#define CLASS_3_A000EDE5E4958479_METHOD_3_A1781348F0A89177_OFFSET UNITYSDK_OFFSET(0xE37FE60)
#define CLASS_3_A000EDE5E4958479_METHOD_3_F57897F4F0D3A2CD_OFFSET UNITYSDK_OFFSET(0xE37FF30)
#define CLASS_3_A000EDE5E4958479_SET_DEFAULTCOMMENTID_OFFSET UNITYSDK_OFFSET(0xE380670)
#define CLASS_3_A000EDE5E4958479_SET_GUID_OFFSET UNITYSDK_OFFSET(0xE380690)
#define CLASS_3_A000EDE5E4958479_SET_ONBTNCLOSE_OFFSET UNITYSDK_OFFSET(0xE380610)
#define CLASS_3_A000EDE5E4958479_SET_ONBTNGO_OFFSET UNITYSDK_OFFSET(0xE3805F0)
#define CLASS_3_A000EDE5E4958479_SET_ONBTNIMAGE_OFFSET UNITYSDK_OFFSET(0xE380630)
#define CLASS_3_A000EDE5E4958479_SET_POSTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xE380650)
#define CLASS_3_A000EDE5E4958479__CTOR_OFFSET UNITYSDK_OFFSET(0xE37FD30)
#define CLASS_3_A000EDE5E4958479___CTOR_B__0_0_OFFSET UNITYSDK_OFFSET(0xE3806A0)
#define CLASS_3_A000EDE5E4958479___CTOR_B__0_1_OFFSET UNITYSDK_OFFSET(0xE380750)
#define CLASS_3_A000EDE5E4958479___CTOR_B__0_2_OFFSET UNITYSDK_OFFSET(0xE380760)

inline static constexpr unsigned int Class_3_A000EDE5E4958479_TypeDefinitionIndex = 68421;

class Class_3_A000EDE5E4958479 : public ::Class_2_E77EE8BE0A609DD9
{
public:
	::RPG::Client::MVVM::Service::LimaoNewsTutorialService* Field_3_6; // 0x20
	::RPG::Client::MVVM::ViewModel::LimaoNewsPostViewModel* _PostViewModel_k__BackingField; // 0x28
	::Class_1_ADBE1843AD1E672A* _OnBtnGo_k__BackingField; // 0x30
	::Class_1_ADBE1843AD1E672A* _OnBtnImage_k__BackingField; // 0x38
	::Class_1_029A7EDCBF9933C8* Field_3_7; // 0x40
