...
#define CLASS_1_AD5A9DCE6DAC51CE_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A3AA880)
#define CLASS_1_AD5A9DCE6DAC51CE_CLONE_OFFSET UNITYSDK_OFFSET(0x1A3AA3A0)
#define CLASS_1_AD5A9DCE6DAC51CE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A3AA480)
#define CLASS_1_AD5A9DCE6DAC51CE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A3AA450)
#define CLASS_1_AD5A9DCE6DAC51CE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A3AA5F0)
#define CLASS_1_AD5A9DCE6DAC51CE_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A3AA9B0)
#define CLASS_1_AD5A9DCE6DAC51CE_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A3AA940)
#define CLASS_1_AD5A9DCE6DAC51CE_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1A3AA3F0)
#define CLASS_1_AD5A9DCE6DAC51CE_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A3AA310)
#define CLASS_1_AD5A9DCE6DAC51CE_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1A3AA400)
#define CLASS_1_AD5A9DCE6DAC51CE_METHOD_1_8633AE51B23EBDFD_1_OFFSET UNITYSDK_OFFSET(0x1A3AA440)
#define CLASS_1_AD5A9DCE6DAC51CE_METHOD_1_8633AE51B23EBDFD_OFFSET UNITYSDK_OFFSET(0x1A3AA420)
#define CLASS_1_AD5A9DCE6DAC51CE_METHOD_1_C229FF62B898C0B2_1_OFFSET UNITYSDK_OFFSET(0x1A3AA430)
#define CLASS_1_AD5A9DCE6DAC51CE_METHOD_1_C229FF62B898C0B2_OFFSET UNITYSDK_OFFSET(0x1A3AA410)
#define CLASS_1_AD5A9DCE6DAC51CE_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A3AA340)
#define CLASS_1_AD5A9DCE6DAC51CE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A3AA740)
#define CLASS_1_AD5A9DCE6DAC51CE_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A3AA7A0)
#define CLASS_1_AD5A9DCE6DAC51CE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A3AAAB0)
#define CLASS_1_AD5A9DCE6DAC51CE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3AA360)
#define CLASS_1_AD5A9DCE6DAC51CE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3AA350)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_AD5A9DCE6DAC51CE*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_AD5A9DCE6DAC51CE_TypeDefinitionIndex)->GetStaticField(0x12C30);
	}
