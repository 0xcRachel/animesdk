...
#define CLASS_1_5B567C8A01BAEDFE_73_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A2F1B90)
#define CLASS_1_5B567C8A01BAEDFE_73_CLONE_OFFSET UNITYSDK_OFFSET(0x1A2F19A0)
#define CLASS_1_5B567C8A01BAEDFE_73_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A2F1AA0)
#define CLASS_1_5B567C8A01BAEDFE_73_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A2F1A10)
#define CLASS_1_5B567C8A01BAEDFE_73_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A2F1AF0)
#define CLASS_1_5B567C8A01BAEDFE_73_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A2F1BE0)
#define CLASS_1_5B567C8A01BAEDFE_73_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A2F1BB0)
#define CLASS_1_5B567C8A01BAEDFE_73_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A2F18F0)
#define CLASS_1_5B567C8A01BAEDFE_73_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A2F1950)
#define CLASS_1_5B567C8A01BAEDFE_73_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A2F1B20)
#define CLASS_1_5B567C8A01BAEDFE_73_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A2F1B80)
#define CLASS_1_5B567C8A01BAEDFE_73__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A2F1C30)
#define CLASS_1_5B567C8A01BAEDFE_73__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A2F1970)
#define CLASS_1_5B567C8A01BAEDFE_73__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2F1960)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_73*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_73_TypeDefinitionIndex)->GetStaticField(0x52E0);
	}
