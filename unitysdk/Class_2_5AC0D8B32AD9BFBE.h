...
#define CLASS_2_5AC0D8B32AD9BFBE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10F7ADD0)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_1CD1133DC003C11C_OFFSET UNITYSDK_OFFSET(0x10F7C0D0)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_2A0C956B013A2B79_OFFSET UNITYSDK_OFFSET(0x10F7C1C0)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_2DDA66E72D33DB14_1_OFFSET UNITYSDK_OFFSET(0x10F7BD60)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_2DDA66E72D33DB14_2_OFFSET UNITYSDK_OFFSET(0x10F7BDC0)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_2DDA66E72D33DB14_OFFSET UNITYSDK_OFFSET(0x10F7BA60)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_4450635DBE779CA8_OFFSET UNITYSDK_OFFSET(0x10F7CA30)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x10F7D080)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_61929A3103595552_OFFSET UNITYSDK_OFFSET(0x10F7C080)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_6456C72D58F785DE_OFFSET UNITYSDK_OFFSET(0x10F7BE20)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_6A4DA97832E39276_OFFSET UNITYSDK_OFFSET(0x10F7C020)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_6E84F2A9745B9B2D_OFFSET UNITYSDK_OFFSET(0x10F7CEC0)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_70437D85C11C5222_OFFSET UNITYSDK_OFFSET(0x10F7ACE0)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_7352AE24442C691D_OFFSET UNITYSDK_OFFSET(0x10F7C710)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_7D905CC30A55BF61_1_OFFSET UNITYSDK_OFFSET(0x10F7C430)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_7D905CC30A55BF61_2_OFFSET UNITYSDK_OFFSET(0x10F7C480)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_7D905CC30A55BF61_3_OFFSET UNITYSDK_OFFSET(0x10F7C4E0)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_7D905CC30A55BF61_OFFSET UNITYSDK_OFFSET(0x10F7C3E0)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_867FEC4BB85307F1_OFFSET UNITYSDK_OFFSET(0x10F7D0E0)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_992B88E0E0E3EDAE_OFFSET UNITYSDK_OFFSET(0x10F7C530)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_AB9E4CB56E834359_OFFSET UNITYSDK_OFFSET(0x10F7AF50)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_B1E62D978A54E884_OFFSET UNITYSDK_OFFSET(0x10F7B480)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_C3CC026A96540DAB_1_OFFSET UNITYSDK_OFFSET(0x10F7D1F0)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_C3CC026A96540DAB_2_OFFSET UNITYSDK_OFFSET(0x10F7D260)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_C3CC026A96540DAB_OFFSET UNITYSDK_OFFSET(0x10F7D180)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_E2CDB6B22CCEBA97_OFFSET UNITYSDK_OFFSET(0x10F7CFB0)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_E503D7CA4797F8D1_OFFSET UNITYSDK_OFFSET(0x10F7BAC0)
#define CLASS_2_5AC0D8B32AD9BFBE_METHOD_2_EAD10B3E55E2C4C5_OFFSET UNITYSDK_OFFSET(0x10F7B0C0)
#define CLASS_2_5AC0D8B32AD9BFBE__CTOR_OFFSET UNITYSDK_OFFSET(0x10F7CFA0)
#define CLASS_2_5AC0D8B32AD9BFBE___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10F7D020)

inline static constexpr unsigned int Class_2_5AC0D8B32AD9BFBE_TypeDefinitionIndex = 48003;

class Class_2_5AC0D8B32AD9BFBE : public ::Class_1_D5DA62FC7DE2D532
{
public:
	// static const ::System::String* Field_2_8; // 0x0
	::Class_2_36C95D73718D07B1* Field_2_1; // 0x10
	::RPG::GameCore::PlayerEnergyConfig* Field_2_2; // 0x18
	::RPG::Client::AdventurePhase* Field_2_3; // 0x20
	::RPG::GameCore::MapRotationCameraConfig* Field_2_4; // 0x28
