...
#define ZXING_ONED_CODE93WRITER_APPENDPATTERN_OFFSET UNITYSDK_OFFSET(0x13CDD540)
#define ZXING_ONED_CODE93WRITER_COMPUTECHECKSUMINDEX_OFFSET UNITYSDK_OFFSET(0x13CDD680)
#define ZXING_ONED_CODE93WRITER_ENCODE_1_OFFSET UNITYSDK_OFFSET(0x13CDC620)
#define ZXING_ONED_CODE93WRITER_ENCODE_OFFSET UNITYSDK_OFFSET(0x13CDC580)
#define ZXING_ONED_CODE93WRITER_TOINTARRAY_OFFSET UNITYSDK_OFFSET(0x13CDD480)
#define ZXING_ONED_CODE93WRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x13CD4B20)
