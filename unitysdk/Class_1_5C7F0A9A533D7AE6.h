...
#define CLASS_1_5C7F0A9A533D7AE6_CLEAR_OFFSET UNITYSDK_OFFSET(0x88E0250)
#define CLASS_1_5C7F0A9A533D7AE6_METHOD_1_14CC93689192A32B_OFFSET UNITYSDK_OFFSET(0x88E0730)
#define CLASS_1_5C7F0A9A533D7AE6_METHOD_1_1991A7B40B7BA36D_OFFSET UNITYSDK_OFFSET(0x88E0350)
#define CLASS_1_5C7F0A9A533D7AE6_METHOD_1_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x88E0F70)
#define CLASS_1_5C7F0A9A533D7AE6_METHOD_1_976CDF5EF06E0838_OFFSET UNITYSDK_OFFSET(0x88E1070)
#define CLASS_1_5C7F0A9A533D7AE6_METHOD_1_9AE63F0E1E9BDA2F_OFFSET UNITYSDK_OFFSET(0x88E03B0)
#define CLASS_1_5C7F0A9A533D7AE6_METHOD_1_9B61E6AE99113B3F_OFFSET UNITYSDK_OFFSET(0x88E0100)
#define CLASS_1_5C7F0A9A533D7AE6_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x88E0B40)
#define CLASS_1_5C7F0A9A533D7AE6_METHOD_1_A5624AB15FE32AEC_OFFSET UNITYSDK_OFFSET(0x88E0CB0)
#define CLASS_1_5C7F0A9A533D7AE6_METHOD_1_B8739D0DE156F9EB_OFFSET UNITYSDK_OFFSET(0x88E0B90)
#define CLASS_1_5C7F0A9A533D7AE6_METHOD_1_BF5E2DCAE0BF038A_OFFSET UNITYSDK_OFFSET(0x88E0FF0)
#define CLASS_1_5C7F0A9A533D7AE6_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x88E0C30)
#define CLASS_1_5C7F0A9A533D7AE6_METHOD_1_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x88E0C70)
#define CLASS_1_5C7F0A9A533D7AE6_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x88E0BF0)
#define CLASS_1_5C7F0A9A533D7AE6_METHOD_1_D71F1E82F429310A_OFFSET UNITYSDK_OFFSET(0x88DFFF0)
#define CLASS_1_5C7F0A9A533D7AE6__CCTOR_OFFSET UNITYSDK_OFFSET(0x88E11F0)
#define CLASS_1_5C7F0A9A533D7AE6__CTOR_OFFSET UNITYSDK_OFFSET(0x88E11A0)

inline static constexpr unsigned int Class_1_5C7F0A9A533D7AE6_TypeDefinitionIndex = 48167;
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5C7F0A9A533D7AE6_TypeDefinitionIndex)->GetStaticField(0x42B40);
	}
	::UnityEngine::SphereCollider* Field_1_3; // 0x10
	::RPG::GameCore::TransformComponent* Field_1_1; // 0x18
	::Class_1_4E1996B50E2373CB* Field_1_6; // 0x20
	::System::Collections::Generic::List_1<::Class_1_4E1996B50E2373CB*>* Field_1_8; // 0x28
	::RPG::GameCore::GameEntity* Field_1_0; // 0x30
	::Class_1_F65DC6656DEF8159* Field_1_9; // 0x38
	::RPG::GameCore::CharacterModelComponent* Field_1_2; // 0x40
	::RPG::GameCore::TimeRewindState Field_1_4; // 0x48
