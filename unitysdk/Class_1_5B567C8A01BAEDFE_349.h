...
#define CLASS_1_5B567C8A01BAEDFE_349_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19DAA810)
#define CLASS_1_5B567C8A01BAEDFE_349_CLONE_OFFSET UNITYSDK_OFFSET(0x19DAA620)
#define CLASS_1_5B567C8A01BAEDFE_349_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19DAA720)
#define CLASS_1_5B567C8A01BAEDFE_349_EQUALS_OFFSET UNITYSDK_OFFSET(0x19DAA690)
#define CLASS_1_5B567C8A01BAEDFE_349_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19DAA770)
#define CLASS_1_5B567C8A01BAEDFE_349_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19DAA860)
#define CLASS_1_5B567C8A01BAEDFE_349_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19DAA830)
#define CLASS_1_5B567C8A01BAEDFE_349_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19DAA570)
#define CLASS_1_5B567C8A01BAEDFE_349_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19DAA5D0)
#define CLASS_1_5B567C8A01BAEDFE_349_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19DAA7A0)
#define CLASS_1_5B567C8A01BAEDFE_349_WRITETO_OFFSET UNITYSDK_OFFSET(0x19DAA800)
#define CLASS_1_5B567C8A01BAEDFE_349__CCTOR_OFFSET UNITYSDK_OFFSET(0x19DAA8B0)
#define CLASS_1_5B567C8A01BAEDFE_349__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19DAA5F0)
#define CLASS_1_5B567C8A01BAEDFE_349__CTOR_OFFSET UNITYSDK_OFFSET(0x19DAA5E0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_349*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_349_TypeDefinitionIndex)->GetStaticField(0x25190);
	}
