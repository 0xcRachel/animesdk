...
#define AKMIDIPOST_CLONE_OFFSET UNITYSDK_OFFSET(0x1A271B70)
#define AKMIDIPOST_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A271600)
#define AKMIDIPOST_GETCPTR_OFFSET UNITYSDK_OFFSET(0x1A2714E0)
#define AKMIDIPOST_GETSIZEOF_OFFSET UNITYSDK_OFFSET(0x1A271C90)
#define AKMIDIPOST_GET_UOFFSET_OFFSET UNITYSDK_OFFSET(0x1A2718B0)
#define AKMIDIPOST_POSTONEVENT_OFFSET UNITYSDK_OFFSET(0x1A271960)
#define AKMIDIPOST_SETCPTR_OFFSET UNITYSDK_OFFSET(0x1A271530)
#define AKMIDIPOST_SET_UOFFSET_OFFSET UNITYSDK_OFFSET(0x1A2717F0)
#define AKMIDIPOST__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A271D40)
#define AKMIDIPOST__CTOR_OFFSET UNITYSDK_OFFSET(0x1A271450)
#define AKMIDIPOST___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A271E50)
#define AKMIDIPOST___IFIXBASEPROXY_SETCPTR_OFFSET UNITYSDK_OFFSET(0x1A271E40)
