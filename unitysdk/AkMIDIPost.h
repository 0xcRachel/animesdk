...
#define AKMIDIPOST_CLONE_OFFSET UNITYSDK_OFFSET(0x196E5730)
#define AKMIDIPOST_DISPOSE_OFFSET UNITYSDK_OFFSET(0x196E5200)
#define AKMIDIPOST_GETCPTR_OFFSET UNITYSDK_OFFSET(0x196E50E0)
#define AKMIDIPOST_GETSIZEOF_OFFSET UNITYSDK_OFFSET(0x196E5850)
#define AKMIDIPOST_GET_UOFFSET_OFFSET UNITYSDK_OFFSET(0x196E5470)
#define AKMIDIPOST_POSTONEVENT_OFFSET UNITYSDK_OFFSET(0x196E5520)
#define AKMIDIPOST_SETCPTR_OFFSET UNITYSDK_OFFSET(0x196E5130)
#define AKMIDIPOST_SET_UOFFSET_OFFSET UNITYSDK_OFFSET(0x196E53B0)
#define AKMIDIPOST__CTOR_1_OFFSET UNITYSDK_OFFSET(0x196E5900)
#define AKMIDIPOST__CTOR_OFFSET UNITYSDK_OFFSET(0x196E5050)
#define AKMIDIPOST___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x196E5A10)
#define AKMIDIPOST___IFIXBASEPROXY_SETCPTR_OFFSET UNITYSDK_OFFSET(0x196E5A00)
