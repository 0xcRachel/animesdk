...
#define AKMIDIPOST_CLONE_OFFSET UNITYSDK_OFFSET(0x183AC750)
#define AKMIDIPOST_DISPOSE_OFFSET UNITYSDK_OFFSET(0x183AC220)
#define AKMIDIPOST_GETCPTR_OFFSET UNITYSDK_OFFSET(0x183AC100)
#define AKMIDIPOST_GETSIZEOF_OFFSET UNITYSDK_OFFSET(0x183AC870)
#define AKMIDIPOST_GET_UOFFSET_OFFSET UNITYSDK_OFFSET(0x183AC490)
#define AKMIDIPOST_POSTONEVENT_OFFSET UNITYSDK_OFFSET(0x183AC540)
#define AKMIDIPOST_SETCPTR_OFFSET UNITYSDK_OFFSET(0x183AC150)
#define AKMIDIPOST_SET_UOFFSET_OFFSET UNITYSDK_OFFSET(0x183AC3D0)
#define AKMIDIPOST__CTOR_1_OFFSET UNITYSDK_OFFSET(0x183AC920)
#define AKMIDIPOST__CTOR_OFFSET UNITYSDK_OFFSET(0x183AC070)
#define AKMIDIPOST___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x183ACA30)
#define AKMIDIPOST___IFIXBASEPROXY_SETCPTR_OFFSET UNITYSDK_OFFSET(0x183ACA20)

inline static constexpr unsigned int AkMIDIPost_TypeDefinitionIndex = 33507;
