...
#define AKMIDIPOST_CLONE_OFFSET UNITYSDK_OFFSET(0x18BD11E0)
#define AKMIDIPOST_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18BD0CB0)
#define AKMIDIPOST_GETCPTR_OFFSET UNITYSDK_OFFSET(0x18BD0B90)
#define AKMIDIPOST_GETSIZEOF_OFFSET UNITYSDK_OFFSET(0x18BD1300)
#define AKMIDIPOST_GET_UOFFSET_OFFSET UNITYSDK_OFFSET(0x18BD0F20)
#define AKMIDIPOST_POSTONEVENT_OFFSET UNITYSDK_OFFSET(0x18BD0FD0)
#define AKMIDIPOST_SETCPTR_OFFSET UNITYSDK_OFFSET(0x18BD0BE0)
#define AKMIDIPOST_SET_UOFFSET_OFFSET UNITYSDK_OFFSET(0x18BD0E60)
#define AKMIDIPOST__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18BD13B0)
#define AKMIDIPOST__CTOR_OFFSET UNITYSDK_OFFSET(0x18BD0B00)
#define AKMIDIPOST___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18BD14C0)
#define AKMIDIPOST___IFIXBASEPROXY_SETCPTR_OFFSET UNITYSDK_OFFSET(0x18BD14B0)
