...
#define CLASS_1_A2D8E5AB4B623162_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8646990)
#define CLASS_1_A2D8E5AB4B623162_GET_ABILITYGLOBALUSEID_OFFSET UNITYSDK_OFFSET(0x86491D0)
#define CLASS_1_A2D8E5AB4B623162_GET_DYNAMICSTRINGS_OFFSET UNITYSDK_OFFSET(0x8649190)
#define CLASS_1_A2D8E5AB4B623162_GET_DYNAMICVALUES_OFFSET UNITYSDK_OFFSET(0x86491B0)
#define CLASS_1_A2D8E5AB4B623162_GET_ISINTRIGGER_OFFSET UNITYSDK_OFFSET(0x8649170)
#define CLASS_1_A2D8E5AB4B623162_GET_SKILLPOINTENTITY_OFFSET UNITYSDK_OFFSET(0x8649150)
#define CLASS_1_A2D8E5AB4B623162_GET_TAG_OFFSET UNITYSDK_OFFSET(0x8649210)
#define CLASS_1_A2D8E5AB4B623162_GET_TARGETLISTINDEX_OFFSET UNITYSDK_OFFSET(0x8649130)
#define CLASS_1_A2D8E5AB4B623162_GET_TIMEFROMSTART_OFFSET UNITYSDK_OFFSET(0x8649400)
#define CLASS_1_A2D8E5AB4B623162_GET_USEOPTION_OFFSET UNITYSDK_OFFSET(0x8649420)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0x86491F0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_1F21C95ADDAECD68_OFFSET UNITYSDK_OFFSET(0x86477D0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_1FC86D2BFE10815E_OFFSET UNITYSDK_OFFSET(0x8648980)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_241FCB0507EB9FA1_OFFSET UNITYSDK_OFFSET(0x8648A70)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_25544F1138889090_OFFSET UNITYSDK_OFFSET(0x8648C60)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_27FE160831643A26_OFFSET UNITYSDK_OFFSET(0x8649110)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x8649060)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_47D88335E404DE12_OFFSET UNITYSDK_OFFSET(0x8649310)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_6764CB4AA84396FC_OFFSET UNITYSDK_OFFSET(0x8648720)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_68FB99B33E7C7AEB_OFFSET UNITYSDK_OFFSET(0x8649370)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_6D93101E4CE10A96_OFFSET UNITYSDK_OFFSET(0x8646E00)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_70ABAF7F0B6E54DF_OFFSET UNITYSDK_OFFSET(0x8649120)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_8377BC0DCBA8CDB6_OFFSET UNITYSDK_OFFSET(0x8649240)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_84952E9528E25353_OFFSET UNITYSDK_OFFSET(0x8648F30)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x8646C10)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_8C704EC832EDEFC8_1_OFFSET UNITYSDK_OFFSET(0x86484C0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_8C704EC832EDEFC8_OFFSET UNITYSDK_OFFSET(0x8648460)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_8E37FF4EF1D584B4_OFFSET UNITYSDK_OFFSET(0x8648AB0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_918892D3041414DB_OFFSET UNITYSDK_OFFSET(0x8648D80)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_93A145ED6F5562B4_OFFSET UNITYSDK_OFFSET(0x8648E50)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x8646CD0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_9BADE3E301981C8B_OFFSET UNITYSDK_OFFSET(0x8646D50)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_9F8F6511E8EF1235_OFFSET UNITYSDK_OFFSET(0x8647210)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_A758883D9873F01E_OFFSET UNITYSDK_OFFSET(0x86478F0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_A8D78AA5E0EAC774_OFFSET UNITYSDK_OFFSET(0x8649230)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_A9B16756059F6D47_OFFSET UNITYSDK_OFFSET(0x8648880)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_B1445E8504415D4D_OFFSET UNITYSDK_OFFSET(0x8649100)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_C5BCCB84D9F819F3_OFFSET UNITYSDK_OFFSET(0x8648D90)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_C6BD7598FB8E5123_OFFSET UNITYSDK_OFFSET(0x86474A0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_C783EE0A4CAB17F8_OFFSET UNITYSDK_OFFSET(0x8647790)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x8646BC0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_CA94882F410B6995_OFFSET UNITYSDK_OFFSET(0x86467F0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_CC9C9A9047B24E05_OFFSET UNITYSDK_OFFSET(0x86492B0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_D41F2EAAA87E2BFD_OFFSET UNITYSDK_OFFSET(0x8649250)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_DAC6E1EE61939DC7_OFFSET UNITYSDK_OFFSET(0x8648520)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_DBAADCCDBE5B4E3B_OFFSET UNITYSDK_OFFSET(0x8648560)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_DF79B89DB8ADD51C_OFFSET UNITYSDK_OFFSET(0x86485C0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_F2E045B3786178E0_OFFSET UNITYSDK_OFFSET(0x8647530)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_F4E96B4DEA400C5A_OFFSET UNITYSDK_OFFSET(0x8646FA0)
#define CLASS_1_A2D8E5AB4B623162_SET_ABILITYGLOBALUSEID_OFFSET UNITYSDK_OFFSET(0x86491E0)
#define CLASS_1_A2D8E5AB4B623162_SET_DYNAMICSTRINGS_OFFSET UNITYSDK_OFFSET(0x86491A0)
#define CLASS_1_A2D8E5AB4B623162_SET_DYNAMICVALUES_OFFSET UNITYSDK_OFFSET(0x86491C0)
#define CLASS_1_A2D8E5AB4B623162_SET_ISINTRIGGER_OFFSET UNITYSDK_OFFSET(0x8649180)
#define CLASS_1_A2D8E5AB4B623162_SET_SKILLPOINTENTITY_OFFSET UNITYSDK_OFFSET(0x8649160)
#define CLASS_1_A2D8E5AB4B623162_SET_TAG_OFFSET UNITYSDK_OFFSET(0x8649220)
#define CLASS_1_A2D8E5AB4B623162_SET_TARGETLISTINDEX_OFFSET UNITYSDK_OFFSET(0x8649140)
#define CLASS_1_A2D8E5AB4B623162_SET_TIMEFROMSTART_OFFSET UNITYSDK_OFFSET(0x8649410)
#define CLASS_1_A2D8E5AB4B623162_SET_USEOPTION_OFFSET UNITYSDK_OFFSET(0x8649430)
#define CLASS_1_A2D8E5AB4B623162__CTOR_OFFSET UNITYSDK_OFFSET(0x8646390)

inline static constexpr unsigned int Class_1_A2D8E5AB4B623162_TypeDefinitionIndex = 42434;
...
public:
	...
	::RPG::GameCore::GameEntityList* Field_1_12; // 0x18
	::Class_3_BCCE950C2E8DF1F0* Field_1_16; // 0x20
	::RPG::GameCore::GameEntity* Field_1_17; // 0x28
	::Class_1_2CAAA2FDF9170110* _DynamicValues_k__BackingField; // 0x30
	::System::Collections::Generic::List_1<::Class_1_0AD6129525BF5F86*>* Field_1_13; // 0x38
	::Class_3_BCCE950C2E8DF1F0* Field_1_15; // 0x40
	::RPG::GameCore::AbilityComponent* Field_1_9; // 0x48
	::RPG::GameCore::TaskContext* Field_1_18; // 0x50
	::RPG::GameCore::GameEntity* _SkillPointEntity_k__BackingField; // 0x58
	::RPG::GameCore::JsonEnum* _Tag_k__BackingField; // 0x60
	::RPG::GameCore::AbilityConfig* Field_1_10; // 0x68
	::Class_3_BCCE950C2E8DF1F0* Field_1_14; // 0x70
	::System::Single _TimeFromStart_k__BackingField; // 0x78
	::RPG::GameCore::AbilityInstanceState Field_1_11; // 0x7C
	::RPG::GameCore::UseAbilityOption _UseOption_k__BackingField; // 0x80
	::System::Boolean _IsInTrigger_k__BackingField; // 0x84
	...
	::Class_0_16E4307DCC419505_304* Method_1_D41F2EAAA87E2BFD()
	{
		return ((::Class_0_16E4307DCC419505_304*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_A2D8E5AB4B623162_METHOD_1_D41F2EAAA87E2BFD_OFFSET))(this);
	}

	::System::Void Method_1_CC9C9A9047B24E05(::Class_0_16E4307DCC419505_304* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_304*))((::PBYTE)hIl2Cpp + CLASS_1_A2D8E5AB4B623162_METHOD_1_CC9C9A9047B24E05_OFFSET))(this, a1);
	}
