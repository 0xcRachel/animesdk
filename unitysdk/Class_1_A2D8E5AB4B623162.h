...
#define CLASS_1_A2D8E5AB4B623162_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10BD9D40)
#define CLASS_1_A2D8E5AB4B623162_GET_ABILITYGLOBALUSEID_OFFSET UNITYSDK_OFFSET(0x10BDC560)
#define CLASS_1_A2D8E5AB4B623162_GET_DYNAMICSTRINGS_OFFSET UNITYSDK_OFFSET(0x10BDC520)
#define CLASS_1_A2D8E5AB4B623162_GET_DYNAMICVALUES_OFFSET UNITYSDK_OFFSET(0x10BDC540)
#define CLASS_1_A2D8E5AB4B623162_GET_ISINTRIGGER_OFFSET UNITYSDK_OFFSET(0x10BDC500)
#define CLASS_1_A2D8E5AB4B623162_GET_SKILLPOINTENTITY_OFFSET UNITYSDK_OFFSET(0x10BDC4E0)
#define CLASS_1_A2D8E5AB4B623162_GET_TAG_OFFSET UNITYSDK_OFFSET(0x10BDC5A0)
#define CLASS_1_A2D8E5AB4B623162_GET_TARGETLISTINDEX_OFFSET UNITYSDK_OFFSET(0x10BDC4C0)
#define CLASS_1_A2D8E5AB4B623162_GET_TIMEFROMSTART_OFFSET UNITYSDK_OFFSET(0x10BDC790)
#define CLASS_1_A2D8E5AB4B623162_GET_USEOPTION_OFFSET UNITYSDK_OFFSET(0x10BDC7B0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0x10BDC580)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_1F21C95ADDAECD68_OFFSET UNITYSDK_OFFSET(0x10BDAB60)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_1FC86D2BFE10815E_OFFSET UNITYSDK_OFFSET(0x10BDBD10)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_241FCB0507EB9FA1_OFFSET UNITYSDK_OFFSET(0x10BDBE00)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_25544F1138889090_OFFSET UNITYSDK_OFFSET(0x10BDBFF0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_27FE160831643A26_OFFSET UNITYSDK_OFFSET(0x10BDC4A0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x10BDC3F0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_47D88335E404DE12_OFFSET UNITYSDK_OFFSET(0x10BDC6A0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_6764CB4AA84396FC_OFFSET UNITYSDK_OFFSET(0x10BDBAB0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_68FB99B33E7C7AEB_OFFSET UNITYSDK_OFFSET(0x10BDC700)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_6D93101E4CE10A96_OFFSET UNITYSDK_OFFSET(0x10BDA190)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_70ABAF7F0B6E54DF_OFFSET UNITYSDK_OFFSET(0x10BDC4B0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_8377BC0DCBA8CDB6_OFFSET UNITYSDK_OFFSET(0x10BDC5D0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_84952E9528E25353_OFFSET UNITYSDK_OFFSET(0x10BDC2C0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x10BD9FB0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_8C704EC832EDEFC8_1_OFFSET UNITYSDK_OFFSET(0x10BDB850)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_8C704EC832EDEFC8_OFFSET UNITYSDK_OFFSET(0x10BDB7F0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_8E37FF4EF1D584B4_OFFSET UNITYSDK_OFFSET(0x10BDBE40)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_918892D3041414DB_OFFSET UNITYSDK_OFFSET(0x10BDC110)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_93A145ED6F5562B4_OFFSET UNITYSDK_OFFSET(0x10BDC1E0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x10BDA060)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_9BADE3E301981C8B_OFFSET UNITYSDK_OFFSET(0x10BDA0E0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_9F8F6511E8EF1235_OFFSET UNITYSDK_OFFSET(0x10BDA5A0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_A758883D9873F01E_OFFSET UNITYSDK_OFFSET(0x10BDAC80)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_A8D78AA5E0EAC774_OFFSET UNITYSDK_OFFSET(0x10BDC5C0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_A9B16756059F6D47_OFFSET UNITYSDK_OFFSET(0x10BDBC10)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_B1445E8504415D4D_OFFSET UNITYSDK_OFFSET(0x10BDC490)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_C5BCCB84D9F819F3_OFFSET UNITYSDK_OFFSET(0x10BDC120)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_C6BD7598FB8E5123_OFFSET UNITYSDK_OFFSET(0x10BDA830)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_C783EE0A4CAB17F8_OFFSET UNITYSDK_OFFSET(0x10BDAB20)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x10BD9F60)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_CA94882F410B6995_OFFSET UNITYSDK_OFFSET(0x10BD9BA0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_CC9C9A9047B24E05_OFFSET UNITYSDK_OFFSET(0x10BDC640)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_D41F2EAAA87E2BFD_OFFSET UNITYSDK_OFFSET(0x10BDC5E0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_DAC6E1EE61939DC7_OFFSET UNITYSDK_OFFSET(0x10BDB8B0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_DBAADCCDBE5B4E3B_OFFSET UNITYSDK_OFFSET(0x10BDB8F0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_DF79B89DB8ADD51C_OFFSET UNITYSDK_OFFSET(0x10BDB950)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_F2E045B3786178E0_OFFSET UNITYSDK_OFFSET(0x10BDA8C0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_F4E96B4DEA400C5A_OFFSET UNITYSDK_OFFSET(0x10BDA330)
#define CLASS_1_A2D8E5AB4B623162_SET_ABILITYGLOBALUSEID_OFFSET UNITYSDK_OFFSET(0x10BDC570)
#define CLASS_1_A2D8E5AB4B623162_SET_DYNAMICSTRINGS_OFFSET UNITYSDK_OFFSET(0x10BDC530)
#define CLASS_1_A2D8E5AB4B623162_SET_DYNAMICVALUES_OFFSET UNITYSDK_OFFSET(0x10BDC550)
#define CLASS_1_A2D8E5AB4B623162_SET_ISINTRIGGER_OFFSET UNITYSDK_OFFSET(0x10BDC510)
#define CLASS_1_A2D8E5AB4B623162_SET_SKILLPOINTENTITY_OFFSET UNITYSDK_OFFSET(0x10BDC4F0)
#define CLASS_1_A2D8E5AB4B623162_SET_TAG_OFFSET UNITYSDK_OFFSET(0x10BDC5B0)
#define CLASS_1_A2D8E5AB4B623162_SET_TARGETLISTINDEX_OFFSET UNITYSDK_OFFSET(0x10BDC4D0)
#define CLASS_1_A2D8E5AB4B623162_SET_TIMEFROMSTART_OFFSET UNITYSDK_OFFSET(0x10BDC7A0)
#define CLASS_1_A2D8E5AB4B623162_SET_USEOPTION_OFFSET UNITYSDK_OFFSET(0x10BDC7C0)
#define CLASS_1_A2D8E5AB4B623162__CTOR_OFFSET UNITYSDK_OFFSET(0x10BD9740)
...
{
public:
	::Class_3_5775A4FEC79026BC* Field_1_14; // 0x10
	::Class_3_5775A4FEC79026BC* Field_1_16; // 0x18
	::RPG::GameCore::JsonEnum* _Tag_k__BackingField; // 0x20
	::RPG::GameCore::GameEntity* Field_1_17; // 0x28
	::RPG::GameCore::AbilityConfig* Field_1_10; // 0x30
	...
	::Class_1_2CAAA2FDF9170110* _DynamicValues_k__BackingField; // 0x50
	::Class_3_5775A4FEC79026BC* Field_1_15; // 0x58
	::RPG::GameCore::GameEntityList* Field_1_12; // 0x60
	::RPG::GameCore::AbilityComponent* Field_1_9; // 0x68
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::StringHash, ::System::String*>* _DynamicStrings_k__BackingField; // 0x70
	::RPG::GameCore::AbilityInstanceState Field_1_11; // 0x78
	::System::Single _TimeFromStart_k__BackingField; // 0x7C
	::System::Int32 _TargetListIndex_k__BackingField; // 0x80
