...
#define CLASS_1_D4E2A0605A71F3AC_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD7DDEA0)
#define CLASS_1_D4E2A0605A71F3AC_METHOD_1_122508E459F25D87_OFFSET UNITYSDK_OFFSET(0xD7DF060)
#define CLASS_1_D4E2A0605A71F3AC_METHOD_1_37C92C97E7CF34AA_OFFSET UNITYSDK_OFFSET(0xD7DEC60)
#define CLASS_1_D4E2A0605A71F3AC_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xD7DEBF0)
#define CLASS_1_D4E2A0605A71F3AC_METHOD_1_6747250BC2D13457_OFFSET UNITYSDK_OFFSET(0xD7DE710)
#define CLASS_1_D4E2A0605A71F3AC_METHOD_1_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0xD7DDEF0)
#define CLASS_1_D4E2A0605A71F3AC_METHOD_1_9C22BF803F744161_OFFSET UNITYSDK_OFFSET(0xD7DE350)
#define CLASS_1_D4E2A0605A71F3AC_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0xD7DF000)
#define CLASS_1_D4E2A0605A71F3AC_METHOD_1_BB881F05E41D3A04_OFFSET UNITYSDK_OFFSET(0xD7DE0A0)
#define CLASS_1_D4E2A0605A71F3AC_METHOD_1_D67046CBB357BF79_OFFSET UNITYSDK_OFFSET(0xD7DF8A0)
#define CLASS_1_D4E2A0605A71F3AC_METHOD_1_E681B6D41E5607D0_1_OFFSET UNITYSDK_OFFSET(0xD7DF7F0)
#define CLASS_1_D4E2A0605A71F3AC_METHOD_1_E681B6D41E5607D0_OFFSET UNITYSDK_OFFSET(0xD7DF740)
#define CLASS_1_D4E2A0605A71F3AC_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xD7DEFF0)
#define CLASS_1_D4E2A0605A71F3AC__CCTOR_OFFSET UNITYSDK_OFFSET(0xD7DFA30)
#define CLASS_1_D4E2A0605A71F3AC__CTOR_OFFSET UNITYSDK_OFFSET(0xD7DDE90)

inline static constexpr unsigned int Class_1_D4E2A0605A71F3AC_TypeDefinitionIndex = 67928;
...
public:
	...
	{
		return (::RPG::Client::RPGProfilerMarker**)Il2CppClass::FromTypeDefinitionIndex(Class_1_D4E2A0605A71F3AC_TypeDefinitionIndex)->GetStaticField(0x246F0);
	}
	// static const ::System::Single Field_1_0; // 0x0
	// static const ::System::Single Field_1_1; // 0x0
	::Class_0_16E4307DCC419505_1028* Field_1_5; // 0x10
	::UnityEngine::GameObject* Field_1_4; // 0x18
	::Class_1_9CBC71DC5240DC00* Field_1_8; // 0x20
	::Class_2_8443F308FD8840B9* Field_1_12; // 0x28
	::Class_0_16E4307DCC419505_1028* Field_1_6; // 0x30
	::UnityEngine::GameObject* Field_1_3; // 0x38
	::Class_1_9CBC71DC5240DC00* Field_1_7; // 0x40
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_D4E2A0605A71F3AC_METHOD_1_BB881F05E41D3A04_OFFSET))(this);
	}
	...
	::System::Void Method_1_37C92C97E7CF34AA(::System::Boolean a1)
	{
		return ((::System::Void(*)(::PVOID, ::System::Boolean))((::PBYTE)hIl2Cpp + CLASS_1_D4E2A0605A71F3AC_METHOD_1_37C92C97E7CF34AA_OFFSET))(this, a1);
	}
