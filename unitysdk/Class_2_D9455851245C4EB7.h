...
#define CLASS_2_D9455851245C4EB7_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCCC8250)
#define CLASS_2_D9455851245C4EB7_METHOD_2_7A642F973B3AE691_OFFSET UNITYSDK_OFFSET(0xCCC8C60)
#define CLASS_2_D9455851245C4EB7_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xCCC82A0)
#define CLASS_2_D9455851245C4EB7_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xCCC8E80)
#define CLASS_2_D9455851245C4EB7_TICK_OFFSET UNITYSDK_OFFSET(0xCCC8ED0)
#define CLASS_2_D9455851245C4EB7__CTOR_OFFSET UNITYSDK_OFFSET(0xCCC81B0)
...
public:
	...
	::RPG::GameCore::CreateBattleCharacter* Field_2_2; // 0x30
