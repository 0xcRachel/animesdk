...
#define CLASS_2_2957BF86A7FB499A_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x104CC870)
#define CLASS_2_2957BF86A7FB499A_METHOD_2_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x104CCA60)
#define CLASS_2_2957BF86A7FB499A__CTOR_OFFSET UNITYSDK_OFFSET(0x104CCAD0)

inline static constexpr unsigned int Class_2_2957BF86A7FB499A_TypeDefinitionIndex = 57973;

class Class_2_2957BF86A7FB499A : public ::Class_1_89D8044AB73F8F6D
{
public:
	::RPG::Client::CustomButton* Field_2_11; // 0x18
	::RPG::Client::LocalizedText* Field_2_5; // 0x20
	::RPG::Client::CustomButton* Field_2_10; // 0x28
	::RPG::Client::CustomButton* Field_2_7; // 0x30
	::RPG::Client::CustomButton* Field_2_9; // 0x38
	::RPG::Client::CustomButton* Field_2_8; // 0x40
	::UnityEngine::Transform* Field_2_0; // 0x48
	::RPG::Client::LocalizedText* Field_2_12; // 0x50
	::RPG::Client::LocalizedText* Field_2_4; // 0x58
	::RPG::Client::CustomButton* Field_2_6; // 0x60
	::RPG::Client::LocalizedText* Field_2_13; // 0x68
