...
#define CLASS_3_B5C2C12AD29C85F7_METHOD_3_E00DE0D06B14AE3A_OFFSET UNITYSDK_OFFSET(0x10BC89B0)
#define CLASS_3_B5C2C12AD29C85F7_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10BC7820)
#define CLASS_3_B5C2C12AD29C85F7__CTOR_OFFSET UNITYSDK_OFFSET(0x10BC77F0)

inline static constexpr unsigned int Class_3_B5C2C12AD29C85F7_TypeDefinitionIndex = 43141;
...
public:
	...
	{
		return ((::RPG::GameCore::SkillData*(*)(::PVOID, ::RPG::GameCore::GameEntity*))((::PBYTE)hIl2Cpp + CLASS_3_B5C2C12AD29C85F7_METHOD_3_E00DE0D06B14AE3A_OFFSET))(this, a1);
	}
};
