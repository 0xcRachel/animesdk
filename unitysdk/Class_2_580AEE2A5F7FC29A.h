...
#define CLASS_2_580AEE2A5F7FC29A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10C87C80)
#define CLASS_2_580AEE2A5F7FC29A_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10C87CC0)
#define CLASS_2_580AEE2A5F7FC29A_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10C880D0)
#define CLASS_2_580AEE2A5F7FC29A_TICK_OFFSET UNITYSDK_OFFSET(0x10C88120)
#define CLASS_2_580AEE2A5F7FC29A__CTOR_OFFSET UNITYSDK_OFFSET(0x10C87C70)
