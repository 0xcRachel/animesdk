...
#define CLASS_1_5B567C8A01BAEDFE_29_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A53C6F0)
#define CLASS_1_5B567C8A01BAEDFE_29_CLONE_OFFSET UNITYSDK_OFFSET(0x1A53C560)
#define CLASS_1_5B567C8A01BAEDFE_29_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A53C600)
#define CLASS_1_5B567C8A01BAEDFE_29_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A53C5A0)
#define CLASS_1_5B567C8A01BAEDFE_29_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A53C650)
#define CLASS_1_5B567C8A01BAEDFE_29_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A53C740)
#define CLASS_1_5B567C8A01BAEDFE_29_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A53C710)
#define CLASS_1_5B567C8A01BAEDFE_29_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A53C4E0)
#define CLASS_1_5B567C8A01BAEDFE_29_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A53C510)
#define CLASS_1_5B567C8A01BAEDFE_29_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A53C680)
#define CLASS_1_5B567C8A01BAEDFE_29_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A53C6E0)
#define CLASS_1_5B567C8A01BAEDFE_29__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A53C790)
#define CLASS_1_5B567C8A01BAEDFE_29__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A53C530)
#define CLASS_1_5B567C8A01BAEDFE_29__CTOR_OFFSET UNITYSDK_OFFSET(0x1A53C520)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_29*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_29_TypeDefinitionIndex)->GetStaticField(0x31390);
	}
