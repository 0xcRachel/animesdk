...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TOUCHDOWNHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x113098C0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TOUCHDOWNHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x113098F0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TOUCHDOWNHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x112F5710)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TOUCHDOWNHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x113098A0)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int EasyTouch_TouchDownHandler_TypeDefinitionIndex = 30433;
