...
#define HEDGEHOGTEAM_EASYTOUCH_FINGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1918F560)
...
namespace HedgehogTeam::EasyTouch
{
	...
	{
	public:
		::System::Single startTimeAction; // 0x78
		...
		::HedgehogTeam::EasyTouch::EasyTouch_SwipeDirection oldSwipeType; // 0x90
