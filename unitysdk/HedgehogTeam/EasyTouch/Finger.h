...
#define HEDGEHOGTEAM_EASYTOUCH_FINGER__CTOR_OFFSET UNITYSDK_OFFSET(0x198E8590)
...
namespace HedgehogTeam::EasyTouch
{
	...
	public:
		...
		::HedgehogTeam::EasyTouch::EasyTouch_GestureType gesture; // 0x7C
		::System::Single startTimeAction; // 0x80
		::UnityEngine::Vector2 oldPosition; // 0x84
