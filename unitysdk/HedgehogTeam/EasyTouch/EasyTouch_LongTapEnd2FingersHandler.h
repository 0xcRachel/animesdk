...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_LONGTAPEND2FINGERSHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x11309140)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_LONGTAPEND2FINGERSHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x11309170)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_LONGTAPEND2FINGERSHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x112FE810)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_LONGTAPEND2FINGERSHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11309120)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int EasyTouch_LongTapEnd2FingersHandler_TypeDefinitionIndex = 30453;
