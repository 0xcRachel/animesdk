...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_LONGTAPENDHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x113091A0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_LONGTAPENDHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x113091D0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_LONGTAPENDHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x112F8290)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_LONGTAPENDHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11309180)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int EasyTouch_LongTapEndHandler_TypeDefinitionIndex = 30439;
