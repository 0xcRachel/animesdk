...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_SIMPLETAPHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x11309560)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_SIMPLETAPHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x11309590)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_SIMPLETAPHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x112F6590)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_SIMPLETAPHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11309540)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int EasyTouch_SimpleTapHandler_TypeDefinitionIndex = 30435;
