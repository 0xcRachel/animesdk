...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_DOUBLETAPHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x11308DE0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_DOUBLETAPHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x11308E10)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_DOUBLETAPHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x112F6CD0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_DOUBLETAPHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11308DC0)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int EasyTouch_DoubleTapHandler_TypeDefinitionIndex = 30436;
