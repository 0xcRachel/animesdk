...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_DRAGSTART2FINGERSHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x11308FC0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_DRAGSTART2FINGERSHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x11308FF0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_DRAGSTART2FINGERSHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x11301AD0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_DRAGSTART2FINGERSHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11308FA0)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int EasyTouch_DragStart2FingersHandler_TypeDefinitionIndex = 30460;
