...
#define CLASS_1_5B567C8A01BAEDFE_187_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A438280)
#define CLASS_1_5B567C8A01BAEDFE_187_CLONE_OFFSET UNITYSDK_OFFSET(0x1A4380F0)
#define CLASS_1_5B567C8A01BAEDFE_187_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A438190)
#define CLASS_1_5B567C8A01BAEDFE_187_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A438130)
#define CLASS_1_5B567C8A01BAEDFE_187_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A4381E0)
#define CLASS_1_5B567C8A01BAEDFE_187_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A4382D0)
#define CLASS_1_5B567C8A01BAEDFE_187_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A4382A0)
#define CLASS_1_5B567C8A01BAEDFE_187_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A438070)
#define CLASS_1_5B567C8A01BAEDFE_187_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A4380A0)
#define CLASS_1_5B567C8A01BAEDFE_187_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A438210)
#define CLASS_1_5B567C8A01BAEDFE_187_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A438270)
#define CLASS_1_5B567C8A01BAEDFE_187__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A438320)
#define CLASS_1_5B567C8A01BAEDFE_187__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A4380C0)
#define CLASS_1_5B567C8A01BAEDFE_187__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4380B0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_187*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_187_TypeDefinitionIndex)->GetStaticField(0x11E70);
	}
