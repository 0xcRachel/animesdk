...
#define FLIPBOOKOPERATION_METHOD_3_6454AD7212B2C6DE_1_OFFSET UNITYSDK_OFFSET(0xFE840D0)
#define FLIPBOOKOPERATION_METHOD_3_6454AD7212B2C6DE_OFFSET UNITYSDK_OFFSET(0xFE83CA0)
#define FLIPBOOKOPERATION_METHOD_3_85FE18173B52F41D_OFFSET UNITYSDK_OFFSET(0xFE84000)
#define FLIPBOOKOPERATION_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0xFE843D0)
#define FLIPBOOKOPERATION__CCTOR_OFFSET UNITYSDK_OFFSET(0xFE84440)
#define FLIPBOOKOPERATION__CTOR_OFFSET UNITYSDK_OFFSET(0xFE84420)

inline static constexpr unsigned int FlipBookOperation_TypeDefinitionIndex = 37074;
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(FlipBookOperation_TypeDefinitionIndex)->GetStaticField(0x4AE0);
	}
