...
#define CLASS_2_4A058F68D5B2A14B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10CC36D0)
#define CLASS_2_4A058F68D5B2A14B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10CC3180)
#define CLASS_2_4A058F68D5B2A14B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10CC3620)
#define CLASS_2_4A058F68D5B2A14B_TICK_OFFSET UNITYSDK_OFFSET(0x10CC3670)
#define CLASS_2_4A058F68D5B2A14B__CTOR_OFFSET UNITYSDK_OFFSET(0x10CC3170)

inline static constexpr unsigned int Class_2_4A058F68D5B2A14B_TypeDefinitionIndex = 45840;
...
public:
	...
	::RPG::GameCore::GetWormCompassResult* Field_2_1; // 0x28
