...
#define CLASS_1_5B567C8A01BAEDFE_375_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A199510)
#define CLASS_1_5B567C8A01BAEDFE_375_CLONE_OFFSET UNITYSDK_OFFSET(0x1A199380)
#define CLASS_1_5B567C8A01BAEDFE_375_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A199420)
#define CLASS_1_5B567C8A01BAEDFE_375_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A1993C0)
#define CLASS_1_5B567C8A01BAEDFE_375_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A199470)
#define CLASS_1_5B567C8A01BAEDFE_375_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A199560)
#define CLASS_1_5B567C8A01BAEDFE_375_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A199530)
#define CLASS_1_5B567C8A01BAEDFE_375_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A199300)
#define CLASS_1_5B567C8A01BAEDFE_375_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A199330)
#define CLASS_1_5B567C8A01BAEDFE_375_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A1994A0)
#define CLASS_1_5B567C8A01BAEDFE_375_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A199500)
#define CLASS_1_5B567C8A01BAEDFE_375__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1995B0)
#define CLASS_1_5B567C8A01BAEDFE_375__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A199350)
#define CLASS_1_5B567C8A01BAEDFE_375__CTOR_OFFSET UNITYSDK_OFFSET(0x1A199340)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_375*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_375_TypeDefinitionIndex)->GetStaticField(0x8160);
	}
