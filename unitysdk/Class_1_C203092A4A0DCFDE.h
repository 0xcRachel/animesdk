...
#define CLASS_1_C203092A4A0DCFDE_METHOD_1_BA928C31B09C0D39_OFFSET UNITYSDK_OFFSET(0x182B7810)
#define CLASS_1_C203092A4A0DCFDE__CTOR_OFFSET UNITYSDK_OFFSET(0x182B7C50)
...
public:
	...
	::RPG::GameCore::LimaoNewsOfficeEventPriorityType Field_1_1; // 0x50
