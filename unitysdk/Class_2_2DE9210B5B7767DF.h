...
#define CLASS_2_2DE9210B5B7767DF_DISPOSE_OFFSET UNITYSDK_OFFSET(0x895C830)
#define CLASS_2_2DE9210B5B7767DF_METHOD_2_229CEF33F0AF9039_OFFSET UNITYSDK_OFFSET(0x895CE10)
#define CLASS_2_2DE9210B5B7767DF_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x895C8E0)
#define CLASS_2_2DE9210B5B7767DF_METHOD_2_D2EE4B89376BEC3B_OFFSET UNITYSDK_OFFSET(0x895CAF0)
#define CLASS_2_2DE9210B5B7767DF_METHOD_2_D3129FE8DF635B48_OFFSET UNITYSDK_OFFSET(0x895C880)
#define CLASS_2_2DE9210B5B7767DF_METHOD_2_F79D5EC57FBF426E_OFFSET UNITYSDK_OFFSET(0x895CFB0)
#define CLASS_2_2DE9210B5B7767DF_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x895C970)
#define CLASS_2_2DE9210B5B7767DF_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x895CEE0)
#define CLASS_2_2DE9210B5B7767DF_TICK_OFFSET UNITYSDK_OFFSET(0x895CF30)
#define CLASS_2_2DE9210B5B7767DF__CTOR_OFFSET UNITYSDK_OFFSET(0x895C820)
...
{
public:
	::RPG::GameCore::NotifyShowFuncBtnParam* Field_2_2; // 0x18
	::RPG::GameCore::TaskContext* Field_2_1; // 0x20
	::RPG::GameCore::ShowFuncBtn* Field_2_0; // 0x28
