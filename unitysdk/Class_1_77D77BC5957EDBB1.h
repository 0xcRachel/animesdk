...
#define CLASS_1_77D77BC5957EDBB1_GETFIGHTSTATECONFIG_OFFSET UNITYSDK_OFFSET(0x16F54EF0)
#define CLASS_1_77D77BC5957EDBB1_GET_MARKDISABLE_OFFSET UNITYSDK_OFFSET(0x16F52B10)
#define CLASS_1_77D77BC5957EDBB1_INIT_OFFSET UNITYSDK_OFFSET(0x16F52B30)
#define CLASS_1_77D77BC5957EDBB1_METHOD_1_0CC1EA4372265873_OFFSET UNITYSDK_OFFSET(0x16F52DA0)
#define CLASS_1_77D77BC5957EDBB1_METHOD_1_1B8A7D152370AD2C_OFFSET UNITYSDK_OFFSET(0x16F548A0)
#define CLASS_1_77D77BC5957EDBB1_METHOD_1_1D897375118954FE_OFFSET UNITYSDK_OFFSET(0x16F56070)
#define CLASS_1_77D77BC5957EDBB1_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x16F54F30)
#define CLASS_1_77D77BC5957EDBB1_METHOD_1_49085A3FC0F13F5E_OFFSET UNITYSDK_OFFSET(0x16F52BD0)
#define CLASS_1_77D77BC5957EDBB1_METHOD_1_5F1978205E005603_OFFSET UNITYSDK_OFFSET(0x16F53130)
#define CLASS_1_77D77BC5957EDBB1_METHOD_1_5F9F5EB6A660BE4E_OFFSET UNITYSDK_OFFSET(0x16F54FA0)
#define CLASS_1_77D77BC5957EDBB1_METHOD_1_862ACF0AE239B7AE_OFFSET UNITYSDK_OFFSET(0x16F53E30)
#define CLASS_1_77D77BC5957EDBB1_METHOD_1_920DE8F4A8DAE754_OFFSET UNITYSDK_OFFSET(0x16F53DD0)
#define CLASS_1_77D77BC5957EDBB1_METHOD_1_999B8B439422C7E7_OFFSET UNITYSDK_OFFSET(0x16F561D0)
#define CLASS_1_77D77BC5957EDBB1_METHOD_1_CC324EA2E7C18FE7_OFFSET UNITYSDK_OFFSET(0x16F53280)
#define CLASS_1_77D77BC5957EDBB1_METHOD_1_E1C8EBE68635D7A7_OFFSET UNITYSDK_OFFSET(0x16F53180)
#define CLASS_1_77D77BC5957EDBB1_METHOD_1_ED79705457B92B5C_OFFSET UNITYSDK_OFFSET(0x16F534D0)
#define CLASS_1_77D77BC5957EDBB1_REFRESH_OFFSET UNITYSDK_OFFSET(0x16F53590)
#define CLASS_1_77D77BC5957EDBB1_RESET_OFFSET UNITYSDK_OFFSET(0x16F52F40)
#define CLASS_1_77D77BC5957EDBB1_SET_MARKDISABLE_OFFSET UNITYSDK_OFFSET(0x16F52B20)
#define CLASS_1_77D77BC5957EDBB1__CTOR_OFFSET UNITYSDK_OFFSET(0x16F56260)
...
public:
	...
	::Class_1_B2388953D46D7EF4* Field_1_2; // 0x10
	::RPG::Client::CameraFightStateOrbitCruiseConfig* Field_1_3; // 0x18
	::Class_2_898DC1EA1181F3B8* Field_1_4; // 0x20
	::System::Collections::Generic::Dictionary_2<::System::String*, ::UnityEngine::AnimationCurve*>* Field_1_5; // 0x28
	::UnityEngine::Transform* Field_1_6; // 0x30
	::RPG::Client::CameraDataAndFlags* Field_1_7; // 0x38
	::RPG::Client::CameraFightStateOrbitCruiseConfigData* Field_1_8; // 0x40
	::UnityEngine::Transform* Field_1_9; // 0x48
	::System::String* Field_1_10; // 0x50
	::UnityEngine::Transform* Field_1_11; // 0x58
	::Class_1_77D77BC5957EDBB1_Class_1_0768C4BEC10E6AAD* Field_1_12; // 0x60
	::UnityEngine::AnimationCurve* Field_1_13; // 0x68
	::Class_1_B2388953D46D7EF4* Field_1_14; // 0x70
	::UnityEngine::Vector3 Field_1_15; // 0x78
	::RPG::MVector3 Field_1_16; // 0x84
	::RPG::MVector3 Field_1_17; // 0x90
	...
	::System::Boolean _MarkDisable_k__BackingField; // 0xBB
