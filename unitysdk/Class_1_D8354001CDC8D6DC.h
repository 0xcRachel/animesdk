...
#define CLASS_1_D8354001CDC8D6DC_GET_ASYNCLATENCYWINDOWSIZE_OFFSET UNITYSDK_OFFSET(0x16768140)
#define CLASS_1_D8354001CDC8D6DC_GET_DEFAULTTOPN_OFFSET UNITYSDK_OFFSET(0x16768160)
#define CLASS_1_D8354001CDC8D6DC_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x16768120)
#define CLASS_1_D8354001CDC8D6DC_SET_ASYNCLATENCYWINDOWSIZE_OFFSET UNITYSDK_OFFSET(0x16768150)
#define CLASS_1_D8354001CDC8D6DC_SET_DEFAULTTOPN_OFFSET UNITYSDK_OFFSET(0x16768170)
#define CLASS_1_D8354001CDC8D6DC_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x16768130)
#define CLASS_1_D8354001CDC8D6DC__CTOR_OFFSET UNITYSDK_OFFSET(0x16768180)

inline static constexpr unsigned int Class_1_D8354001CDC8D6DC_TypeDefinitionIndex = 72361;
