...
#define CLASS_3_4C10A2521611B0C6_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10306030)
#define CLASS_3_4C10A2521611B0C6_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10306230)
#define CLASS_3_4C10A2521611B0C6_TICK_OFFSET UNITYSDK_OFFSET(0x103061D0)
#define CLASS_3_4C10A2521611B0C6__CTOR_OFFSET UNITYSDK_OFFSET(0x10306000)
#define CLASS_3_4C10A2521611B0C6___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x103062A0)

inline static constexpr unsigned int Class_3_4C10A2521611B0C6_TypeDefinitionIndex = 41266;
