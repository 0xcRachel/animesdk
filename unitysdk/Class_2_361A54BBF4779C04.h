...
#define CLASS_2_361A54BBF4779C04_DISPOSE_OFFSET UNITYSDK_OFFSET(0x84360B0)
#define CLASS_2_361A54BBF4779C04_METHOD_2_D012DDA5D8AEAA70_OFFSET UNITYSDK_OFFSET(0x84364A0)
#define CLASS_2_361A54BBF4779C04_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x84360F0)
#define CLASS_2_361A54BBF4779C04_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x84367D0)
#define CLASS_2_361A54BBF4779C04_TICK_OFFSET UNITYSDK_OFFSET(0x8436820)
#define CLASS_2_361A54BBF4779C04__CTOR_OFFSET UNITYSDK_OFFSET(0x8435FE0)

inline static constexpr unsigned int Class_2_361A54BBF4779C04_TypeDefinitionIndex = 43353;

class Class_2_361A54BBF4779C04 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::SetDynamicValueByModifierValue* Field_2_1; // 0x18
	::RPG::GameCore::TaskContext* Field_2_2; // 0x20
	::RPG::GameCore::ArrayPoolWrapper_1<::RPG::GameCore::TurnBasedModifierInstance*> Field_2_0; // 0x28
