...
#define CLASS_1_0F0E59A49B342472_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10BE2E70)
#define CLASS_1_0F0E59A49B342472_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x10BE3E30)
#define CLASS_1_0F0E59A49B342472_GET_PREFABPATH_OFFSET UNITYSDK_OFFSET(0x10BE3E40)
#define CLASS_1_0F0E59A49B342472_GET_TIMESCALE_OFFSET UNITYSDK_OFFSET(0x10BE3E50)
#define CLASS_1_0F0E59A49B342472_METHOD_1_01244C5D42565CB2_OFFSET UNITYSDK_OFFSET(0x10BE3070)
#define CLASS_1_0F0E59A49B342472_METHOD_1_1B9CC121BDC8766D_OFFSET UNITYSDK_OFFSET(0x10BE3000)
#define CLASS_1_0F0E59A49B342472_METHOD_1_2185F8A39E7E07F0_OFFSET UNITYSDK_OFFSET(0x10BE3CE0)
#define CLASS_1_0F0E59A49B342472_METHOD_1_353C4EDCC7A6E9F8_OFFSET UNITYSDK_OFFSET(0x10BE3B30)
#define CLASS_1_0F0E59A49B342472_METHOD_1_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x10BE3D60)
#define CLASS_1_0F0E59A49B342472_METHOD_1_4CF46725A6B2AC31_OFFSET UNITYSDK_OFFSET(0x10BE3340)
#define CLASS_1_0F0E59A49B342472_METHOD_1_62167C28EC14CC63_OFFSET UNITYSDK_OFFSET(0x10BE2B20)
#define CLASS_1_0F0E59A49B342472_METHOD_1_68C5DD35C3F86CD6_OFFSET UNITYSDK_OFFSET(0x10BE3570)
#define CLASS_1_0F0E59A49B342472_METHOD_1_87E0654B98D0D63C_OFFSET UNITYSDK_OFFSET(0x10BE2DE0)
#define CLASS_1_0F0E59A49B342472_METHOD_1_CD28994AFE636FFF_OFFSET UNITYSDK_OFFSET(0x10BE2620)
#define CLASS_1_0F0E59A49B342472_METHOD_1_D126A9270C6BEF9E_OFFSET UNITYSDK_OFFSET(0x10BE3A80)
#define CLASS_1_0F0E59A49B342472_METHOD_1_E57CD88B2E873CCA_OFFSET UNITYSDK_OFFSET(0x10BE2A70)
#define CLASS_1_0F0E59A49B342472_SET_TIMESCALE_OFFSET UNITYSDK_OFFSET(0x10BE3E60)
#define CLASS_1_0F0E59A49B342472__CCTOR_OFFSET UNITYSDK_OFFSET(0x10BE3EE0)
#define CLASS_1_0F0E59A49B342472__CTOR_OFFSET UNITYSDK_OFFSET(0x10BE2410)
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_0F0E59A49B342472_TypeDefinitionIndex)->GetStaticField(0xF2D0);
	}
	::System::Collections::Generic::List_1<::Struct_2_F93DE209E992FF0D>* Field_1_9; // 0x10
	::System::Collections::Generic::List_1<::Struct_2_F93DE209E992FF0D>* Field_1_8; // 0x18
	::Class_1_FD711FBD7923B1D0* Field_1_6; // 0x20
	::System::String* Field_1_2; // 0x28
	::System::Collections::Generic::List_1<::Class_1_FD711FBD7923B1D0*>* Field_1_7; // 0x30
	::RPG::Client::AirshipBirdEmitter* Field_1_5; // 0x38
	::RPG::Client::AirlineBirdWay* Field_1_4; // 0x40
