...
#define DESPERATEDEVS_CODEGENERATION_CODEGENERATOR_UNITY_EDITOR_COMPILE__CTOR_OFFSET UNITYSDK_OFFSET(0x800E0A0)

namespace DesperateDevs::CodeGeneration::CodeGenerator::Unity::Editor
{
	inline static constexpr unsigned int Compile_TypeDefinitionIndex = 37007;
