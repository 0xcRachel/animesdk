...
#define DESPERATEDEVS_UTILS_ATTRIBUTEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x112E6D50)

namespace DesperateDevs::Utils
{
	inline static constexpr unsigned int AttributeInfo_TypeDefinitionIndex = 8776;
