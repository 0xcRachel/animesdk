...
#define CLASS_3_CF934C3D1EE4DC2D_GET_ISDIRTY_OFFSET UNITYSDK_OFFSET(0x110A9E10)
#define CLASS_3_CF934C3D1EE4DC2D_GET_URL_OFFSET UNITYSDK_OFFSET(0x110A9DF0)
#define CLASS_3_CF934C3D1EE4DC2D_SET_ISDIRTY_OFFSET UNITYSDK_OFFSET(0x110A9E20)
#define CLASS_3_CF934C3D1EE4DC2D_SET_URL_OFFSET UNITYSDK_OFFSET(0x110A9E00)
#define CLASS_3_CF934C3D1EE4DC2D__CTOR_OFFSET UNITYSDK_OFFSET(0x110A9E30)

inline static constexpr unsigned int Class_3_CF934C3D1EE4DC2D_TypeDefinitionIndex = 38696;
