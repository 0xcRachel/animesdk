...
#define CLASS_1_7174CBF551B30FEB_CLEAR_OFFSET UNITYSDK_OFFSET(0x169F4510)
#define CLASS_1_7174CBF551B30FEB_ONALLOC_OFFSET UNITYSDK_OFFSET(0x169F4490)
#define CLASS_1_7174CBF551B30FEB_ONRECYCLE_OFFSET UNITYSDK_OFFSET(0x169F44D0)
#define CLASS_1_7174CBF551B30FEB__CTOR_OFFSET UNITYSDK_OFFSET(0x169F4660)
...
{
public:
	::Struct_2_9BF8902D61AE1796 Field_1_6; // 0x10
	::UnityEngine::Transform* Field_1_1; // 0xA0
	::UnityEngine::Collider* Field_1_0; // 0xA8
	::UnityEngine::Bounds Field_1_3; // 0xB0
	::System::Boolean Field_1_5; // 0xC8
	::System::Boolean Field_1_4; // 0xC9
	::UnityEngine::Bounds Field_1_2; // 0xCC
