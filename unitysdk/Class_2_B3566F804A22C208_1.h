...
#define CLASS_2_B3566F804A22C208_1_LOCK_OFFSET UNITYSDK_OFFSET(0x10A2D700)
#define CLASS_2_B3566F804A22C208_1_UNLOCK_OFFSET UNITYSDK_OFFSET(0x10A2D870)
#define CLASS_2_B3566F804A22C208_1__CTOR_OFFSET UNITYSDK_OFFSET(0x10A2D6F0)
#define CLASS_2_B3566F804A22C208_1___IFIXBASEPROXY_LOCK_OFFSET UNITYSDK_OFFSET(0x10A2D9E0)
#define CLASS_2_B3566F804A22C208_1___IFIXBASEPROXY_UNLOCK_OFFSET UNITYSDK_OFFSET(0x10A2DA50)

inline static constexpr unsigned int Class_2_B3566F804A22C208_1_TypeDefinitionIndex = 59720;
...
public:
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_262*>*))((::PBYTE)hIl2Cpp + CLASS_2_B3566F804A22C208_1__CTOR_OFFSET))(this, a1);
	}
