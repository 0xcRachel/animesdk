...
#define CLASS_1_0A58DDD24CA46B3B_METHOD_1_071850D2764E9D4C_OFFSET UNITYSDK_OFFSET(0x14259940)
#define CLASS_1_0A58DDD24CA46B3B_METHOD_1_18982EFD3B740683_OFFSET UNITYSDK_OFFSET(0x14258230)
#define CLASS_1_0A58DDD24CA46B3B_METHOD_1_18EAC247268E01AB_OFFSET UNITYSDK_OFFSET(0x142595D0)
#define CLASS_1_0A58DDD24CA46B3B_METHOD_1_2045BA2947DBDBCE_OFFSET UNITYSDK_OFFSET(0x14258050)
#define CLASS_1_0A58DDD24CA46B3B_METHOD_1_25EC451C0EA68F53_OFFSET UNITYSDK_OFFSET(0x14259CA0)
#define CLASS_1_0A58DDD24CA46B3B_METHOD_1_343AEC10F51D93D4_OFFSET UNITYSDK_OFFSET(0x1425A1A0)
#define CLASS_1_0A58DDD24CA46B3B_METHOD_1_4021FBCAADF57CEB_OFFSET UNITYSDK_OFFSET(0x14259520)
#define CLASS_1_0A58DDD24CA46B3B_METHOD_1_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x14258840)
#define CLASS_1_0A58DDD24CA46B3B_METHOD_1_5EF2AC29261F6A43_OFFSET UNITYSDK_OFFSET(0x14258DF0)
#define CLASS_1_0A58DDD24CA46B3B_METHOD_1_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0x14259C20)
#define CLASS_1_0A58DDD24CA46B3B_METHOD_1_62FC2DCD2EF869D5_OFFSET UNITYSDK_OFFSET(0x14258E80)
#define CLASS_1_0A58DDD24CA46B3B_METHOD_1_68DE647BC0AFC803_OFFSET UNITYSDK_OFFSET(0x14259E60)
#define CLASS_1_0A58DDD24CA46B3B_METHOD_1_6F73A40265D5B980_OFFSET UNITYSDK_OFFSET(0x14259690)
#define CLASS_1_0A58DDD24CA46B3B_METHOD_1_834FC35654ED968C_OFFSET UNITYSDK_OFFSET(0x14258AD0)
#define CLASS_1_0A58DDD24CA46B3B_METHOD_1_97965634D89B0F68_OFFSET UNITYSDK_OFFSET(0x14259F00)
#define CLASS_1_0A58DDD24CA46B3B_METHOD_1_9D9CF8F6C2342EE5_OFFSET UNITYSDK_OFFSET(0x14258B20)
#define CLASS_1_0A58DDD24CA46B3B_METHOD_1_AA169839CB93802A_1_OFFSET UNITYSDK_OFFSET(0x1425A090)
#define CLASS_1_0A58DDD24CA46B3B_METHOD_1_AA169839CB93802A_OFFSET UNITYSDK_OFFSET(0x14258400)
#define CLASS_1_0A58DDD24CA46B3B_METHOD_1_B8A8F4F120B2F6D5_OFFSET UNITYSDK_OFFSET(0x14258CD0)
#define CLASS_1_0A58DDD24CA46B3B_METHOD_1_BA1BB49741CFDFE1_OFFSET UNITYSDK_OFFSET(0x14258710)
#define CLASS_1_0A58DDD24CA46B3B_METHOD_1_CD8EB704BDED69B6_OFFSET UNITYSDK_OFFSET(0x14258500)
#define CLASS_1_0A58DDD24CA46B3B_METHOD_1_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0x14258940)
#define CLASS_1_0A58DDD24CA46B3B_METHOD_1_E41B6A823556FEEA_OFFSET UNITYSDK_OFFSET(0x142587F0)
#define CLASS_1_0A58DDD24CA46B3B_METHOD_1_FD7514C64FB1B043_OFFSET UNITYSDK_OFFSET(0x142585F0)
#define CLASS_1_0A58DDD24CA46B3B__CTOR_OFFSET UNITYSDK_OFFSET(0x14257F70)
#define CLASS_1_0A58DDD24CA46B3B__ONVIDEOBEGIN_B__46_0_OFFSET UNITYSDK_OFFSET(0x1425A470)
#define CLASS_1_0A58DDD24CA46B3B__ONVIDEOBEGIN_B__46_1_OFFSET UNITYSDK_OFFSET(0x1425A480)
#define CLASS_1_0A58DDD24CA46B3B__WAITRESTARTPLAYVIDEO_B__37_0_OFFSET UNITYSDK_OFFSET(0x1425A450)

inline static constexpr unsigned int Class_1_0A58DDD24CA46B3B_TypeDefinitionIndex = 68372;

class Class_1_0A58DDD24CA46B3B : public ::System::Object
{
public:
	// static const ::System::Int32 Field_1_0 = 0x2; // 0x0
	::System::Action_3<::RPG::Client::OpenWorld::StreamingItemData*, ::UnityEngine::GameObject*, ::System::Boolean>* Field_1_1; // 0x10
	::UnityEngine::MeshRenderer* Field_1_2; // 0x18
	::RPG::Client::OpenWorld::StreamingItemData* Field_1_3; // 0x20
	::UnityEngine::Coroutine* Field_1_4; // 0x28
	::RPG::GameCore::PlayVideoSequence* Field_1_5; // 0x30
	::Il2CppArray<::CriWare::CriManaMovieController*>* Field_1_6; // 0x38
	::UnityEngine::GameObject* Field_1_7; // 0x40
	::UnityEngine::Coroutine* Field_1_8; // 0x48
	::System::Action_3<::RPG::Client::OpenWorld::StreamingItemData*, ::UnityEngine::GameObject*, ::UnityEngine::GameObject*>* Field_1_9; // 0x50
	::CriWare::CriManaMovieController* Field_1_10; // 0x58
	::CriWare::CriManaMovieController* Field_1_11; // 0x60
	...
	::CriWare::CriMana::Player_Status Field_1_22; // 0x88
