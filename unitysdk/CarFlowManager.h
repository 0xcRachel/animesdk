...
#define CARFLOWMANAGER_AWAKE_OFFSET UNITYSDK_OFFSET(0x994F6D0)
#define CARFLOWMANAGER_GETNEXTROUTE_OFFSET UNITYSDK_OFFSET(0x9952710)
#define CARFLOWMANAGER_METHOD_5_195132A6B7DBCC49_OFFSET UNITYSDK_OFFSET(0x9952500)
#define CARFLOWMANAGER_METHOD_5_2DF1E18DDFFAC256_OFFSET UNITYSDK_OFFSET(0x9951870)
#define CARFLOWMANAGER_METHOD_5_43E290A0B26B39F6_OFFSET UNITYSDK_OFFSET(0x9952A10)
#define CARFLOWMANAGER_METHOD_5_45872D1C931761E1_OFFSET UNITYSDK_OFFSET(0x9951900)
#define CARFLOWMANAGER_METHOD_5_6CB03087A432B09A_OFFSET UNITYSDK_OFFSET(0x9952CE0)
#define CARFLOWMANAGER_METHOD_5_821464E984634C6E_OFFSET UNITYSDK_OFFSET(0x9950DF0)
#define CARFLOWMANAGER_METHOD_5_821BBDC04720A2EB_OFFSET UNITYSDK_OFFSET(0x994F720)
#define CARFLOWMANAGER_METHOD_5_8733DFFCA9EEC7D2_OFFSET UNITYSDK_OFFSET(0x9952D70)
#define CARFLOWMANAGER_METHOD_5_88F9BC8E268D0A52_OFFSET UNITYSDK_OFFSET(0x9952F20)
#define CARFLOWMANAGER_METHOD_5_8A6C2C736DC20164_OFFSET UNITYSDK_OFFSET(0x99519A0)
#define CARFLOWMANAGER_METHOD_5_B49A4A1E363BAFEA_OFFSET UNITYSDK_OFFSET(0x9951DD0)
#define CARFLOWMANAGER_METHOD_5_B6F5D79000487284_OFFSET UNITYSDK_OFFSET(0x99520F0)
#define CARFLOWMANAGER_METHOD_5_F685193FC87DD88F_OFFSET UNITYSDK_OFFSET(0x9951B80)
#define CARFLOWMANAGER_SPAWNCAR_OFFSET UNITYSDK_OFFSET(0x99509B0)
#define CARFLOWMANAGER_START_OFFSET UNITYSDK_OFFSET(0x9950190)
#define CARFLOWMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x99501D0)
#define CARFLOWMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x9953120)
#define CARFLOWMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x9953100)

inline static constexpr unsigned int CarFlowManager_TypeDefinitionIndex = 37038;
...
public:
	...
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(CarFlowManager_TypeDefinitionIndex)->GetStaticField(0xF9B0);
	}
	static ::System::Single* StaticGet_DefaultStaticCarMinDistance()
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(CarFlowManager_TypeDefinitionIndex)->GetStaticField(0xF9B4);
	}
