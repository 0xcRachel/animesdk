...
#define CLASS_1_5B567C8A01BAEDFE_282_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A8B4EA0)
#define CLASS_1_5B567C8A01BAEDFE_282_CLONE_OFFSET UNITYSDK_OFFSET(0x1A8B4CB0)
#define CLASS_1_5B567C8A01BAEDFE_282_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A8B4DB0)
#define CLASS_1_5B567C8A01BAEDFE_282_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A8B4D20)
#define CLASS_1_5B567C8A01BAEDFE_282_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A8B4E00)
#define CLASS_1_5B567C8A01BAEDFE_282_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A8B4EF0)
#define CLASS_1_5B567C8A01BAEDFE_282_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A8B4EC0)
#define CLASS_1_5B567C8A01BAEDFE_282_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A8B4C00)
#define CLASS_1_5B567C8A01BAEDFE_282_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A8B4C60)
#define CLASS_1_5B567C8A01BAEDFE_282_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A8B4E30)
#define CLASS_1_5B567C8A01BAEDFE_282_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A8B4E90)
#define CLASS_1_5B567C8A01BAEDFE_282__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A8B4F40)
#define CLASS_1_5B567C8A01BAEDFE_282__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A8B4C80)
#define CLASS_1_5B567C8A01BAEDFE_282__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8B4C70)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_282*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_282_TypeDefinitionIndex)->GetStaticField(0x43570);
	}
