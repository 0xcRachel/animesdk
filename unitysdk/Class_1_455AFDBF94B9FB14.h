...
#define CLASS_1_455AFDBF94B9FB14_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1B0C8DC0)
#define CLASS_1_455AFDBF94B9FB14_CLONE_OFFSET UNITYSDK_OFFSET(0x1B0C8990)
#define CLASS_1_455AFDBF94B9FB14_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1B0C8AA0)
#define CLASS_1_455AFDBF94B9FB14_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B0C8A40)
#define CLASS_1_455AFDBF94B9FB14_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B0C8BF0)
#define CLASS_1_455AFDBF94B9FB14_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1B0C9160)
#define CLASS_1_455AFDBF94B9FB14_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1B0C8F70)
#define CLASS_1_455AFDBF94B9FB14_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1B0C8A00)
#define CLASS_1_455AFDBF94B9FB14_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1B0C89E0)
#define CLASS_1_455AFDBF94B9FB14_METHOD_1_2ACF2A61FB239D23_OFFSET UNITYSDK_OFFSET(0x1B0C8A20)
#define CLASS_1_455AFDBF94B9FB14_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1B0C87C0)
#define CLASS_1_455AFDBF94B9FB14_METHOD_1_358A144584A5DBFC_OFFSET UNITYSDK_OFFSET(0x1B0C8910)
#define CLASS_1_455AFDBF94B9FB14_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1B0C8A10)
#define CLASS_1_455AFDBF94B9FB14_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1B0C89F0)
#define CLASS_1_455AFDBF94B9FB14_METHOD_1_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x1B0C8A30)
#define CLASS_1_455AFDBF94B9FB14_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x1B0C8970)
#define CLASS_1_455AFDBF94B9FB14_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1B0C8820)
#define CLASS_1_455AFDBF94B9FB14_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B0C8C80)
#define CLASS_1_455AFDBF94B9FB14_WRITETO_OFFSET UNITYSDK_OFFSET(0x1B0C8CE0)
#define CLASS_1_455AFDBF94B9FB14__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B0C9420)
#define CLASS_1_455AFDBF94B9FB14__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B0C8840)
#define CLASS_1_455AFDBF94B9FB14__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C8830)

inline static constexpr unsigned int Class_1_455AFDBF94B9FB14_TypeDefinitionIndex = 30007;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_455AFDBF94B9FB14*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_455AFDBF94B9FB14_TypeDefinitionIndex)->GetStaticField(0x300A0);
	}
	...
	{
		return ((::Class_1_6FC4D75D938BC053_3*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_455AFDBF94B9FB14_METHOD_1_358A144584A5DBFC_OFFSET))(this);
	}

	::System::Void Method_1_8C8625211DA811AE(::Class_1_6FC4D75D938BC053_3* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_6FC4D75D938BC053_3*))((::PBYTE)hIl2Cpp + CLASS_1_455AFDBF94B9FB14_METHOD_1_8C8625211DA811AE_OFFSET))(this, a1);
	}
