...
#define CLASS_2_6EA46D8AA3E7D5E2_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8D267B0)
#define CLASS_2_6EA46D8AA3E7D5E2_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x8D267F0)
#define CLASS_2_6EA46D8AA3E7D5E2_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x8D26DF0)
#define CLASS_2_6EA46D8AA3E7D5E2_TICK_OFFSET UNITYSDK_OFFSET(0x8D26E40)
#define CLASS_2_6EA46D8AA3E7D5E2__CTOR_OFFSET UNITYSDK_OFFSET(0x8D267A0)

inline static constexpr unsigned int Class_2_6EA46D8AA3E7D5E2_TypeDefinitionIndex = 43229;

class Class_2_6EA46D8AA3E7D5E2 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::RemoveModifier* Field_2_1; // 0x18
	::RPG::GameCore::TaskContext* Field_2_2; // 0x20
	::RPG::GameCore::ArrayPoolWrapper_1<::Class_0_16E4307DCC419505_302*> Field_2_0; // 0x28
