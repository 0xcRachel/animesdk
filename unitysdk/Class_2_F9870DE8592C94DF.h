...
#define CLASS_2_F9870DE8592C94DF__CREATETRIGGER_OFFSET UNITYSDK_OFFSET(0x83D6C80)
#define CLASS_2_F9870DE8592C94DF__CTOR_OFFSET UNITYSDK_OFFSET(0x83D67C0)
#define CLASS_2_F9870DE8592C94DF__REMOVETRIGGER_OFFSET UNITYSDK_OFFSET(0x83D7160)
#define CLASS_2_F9870DE8592C94DF__TEARDOWN_OFFSET UNITYSDK_OFFSET(0x83D6AA0)
#define CLASS_2_F9870DE8592C94DF___IFIXBASEPROXY__TEARDOWN_OFFSET UNITYSDK_OFFSET(0x83D72B0)

inline static constexpr unsigned int Class_2_F9870DE8592C94DF_TypeDefinitionIndex = 60765;
