...
#define CLASS_2_F9870DE8592C94DF__CREATETRIGGER_OFFSET UNITYSDK_OFFSET(0xA9DC910)
#define CLASS_2_F9870DE8592C94DF__CTOR_OFFSET UNITYSDK_OFFSET(0xA9DC450)
#define CLASS_2_F9870DE8592C94DF__REMOVETRIGGER_OFFSET UNITYSDK_OFFSET(0xA9DCDF0)
#define CLASS_2_F9870DE8592C94DF__TEARDOWN_OFFSET UNITYSDK_OFFSET(0xA9DC730)
#define CLASS_2_F9870DE8592C94DF___IFIXBASEPROXY__TEARDOWN_OFFSET UNITYSDK_OFFSET(0xA9DCF40)

inline static constexpr unsigned int Class_2_F9870DE8592C94DF_TypeDefinitionIndex = 62757;
