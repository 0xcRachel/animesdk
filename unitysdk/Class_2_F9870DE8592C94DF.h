...
#define CLASS_2_F9870DE8592C94DF__CREATETRIGGER_OFFSET UNITYSDK_OFFSET(0xDE94480)
#define CLASS_2_F9870DE8592C94DF__CTOR_OFFSET UNITYSDK_OFFSET(0xDE93FC0)
#define CLASS_2_F9870DE8592C94DF__REMOVETRIGGER_OFFSET UNITYSDK_OFFSET(0xDE949C0)
#define CLASS_2_F9870DE8592C94DF__TEARDOWN_OFFSET UNITYSDK_OFFSET(0xDE942A0)
#define CLASS_2_F9870DE8592C94DF___IFIXBASEPROXY__TEARDOWN_OFFSET UNITYSDK_OFFSET(0xDE94B10)

inline static constexpr unsigned int Class_2_F9870DE8592C94DF_TypeDefinitionIndex = 70777;
