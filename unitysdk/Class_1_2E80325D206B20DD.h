...
#define CLASS_1_2E80325D206B20DD_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0x99E85D0)
#define CLASS_1_2E80325D206B20DD_METHOD_1_4FC4A701F8CB8BD3_OFFSET UNITYSDK_OFFSET(0x99E8610)
#define CLASS_1_2E80325D206B20DD__CCTOR_OFFSET UNITYSDK_OFFSET(0x99E8A80)
#define CLASS_1_2E80325D206B20DD__CTOR_OFFSET UNITYSDK_OFFSET(0x99E8A70)

inline static constexpr unsigned int Class_1_2E80325D206B20DD_TypeDefinitionIndex = 60124;
...
public:
	...
	{
		return (::System::Text::RegularExpressions::Regex**)Il2CppClass::FromTypeDefinitionIndex(Class_1_2E80325D206B20DD_TypeDefinitionIndex)->GetStaticField(0x37B90);
	}
	static ::System::Text::RegularExpressions::Regex** StaticGet_Field_1_0()
	{
		return (::System::Text::RegularExpressions::Regex**)Il2CppClass::FromTypeDefinitionIndex(Class_1_2E80325D206B20DD_TypeDefinitionIndex)->GetStaticField(0x37B98);
	}
