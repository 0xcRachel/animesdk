...
#define STRUCT_2_7C3EF1FF302C26DE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x20E7AB0)
#define STRUCT_2_7C3EF1FF302C26DE_EQUALS_OFFSET UNITYSDK_OFFSET(0x20E7A70)
#define STRUCT_2_7C3EF1FF302C26DE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x20E7B90)
#define STRUCT_2_7C3EF1FF302C26DE_METHOD_2_57A8E11FECF10345_1_OFFSET UNITYSDK_OFFSET(0x16797CA0)
#define STRUCT_2_7C3EF1FF302C26DE_METHOD_2_57A8E11FECF10345_OFFSET UNITYSDK_OFFSET(0x16797BE0)
#define STRUCT_2_7C3EF1FF302C26DE___IFIXBASEPROXY_EQUALS_OFFSET UNITYSDK_OFFSET(0x20E7BA0)
#define STRUCT_2_7C3EF1FF302C26DE___IFIXBASEPROXY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x20E7C20)
