...
#define STRUCT_2_7C3EF1FF302C26DE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x2016140)
#define STRUCT_2_7C3EF1FF302C26DE_EQUALS_OFFSET UNITYSDK_OFFSET(0x2016100)
#define STRUCT_2_7C3EF1FF302C26DE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2016220)
#define STRUCT_2_7C3EF1FF302C26DE_METHOD_2_57A8E11FECF10345_1_OFFSET UNITYSDK_OFFSET(0x162AF3A0)
#define STRUCT_2_7C3EF1FF302C26DE_METHOD_2_57A8E11FECF10345_OFFSET UNITYSDK_OFFSET(0x162AF2E0)
#define STRUCT_2_7C3EF1FF302C26DE___IFIXBASEPROXY_EQUALS_OFFSET UNITYSDK_OFFSET(0x2016230)
#define STRUCT_2_7C3EF1FF302C26DE___IFIXBASEPROXY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x20162B0)

inline static constexpr unsigned int Struct_2_7C3EF1FF302C26DE_TypeDefinitionIndex = 31383;
