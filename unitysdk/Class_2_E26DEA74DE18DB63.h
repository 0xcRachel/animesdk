...
#define CLASS_2_E26DEA74DE18DB63_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10B38900)
#define CLASS_2_E26DEA74DE18DB63_METHOD_2_41F6DC01B08A4539_OFFSET UNITYSDK_OFFSET(0x10B38D30)
#define CLASS_2_E26DEA74DE18DB63_METHOD_2_5F562E77E2FF7144_OFFSET UNITYSDK_OFFSET(0x10B3A0B0)
#define CLASS_2_E26DEA74DE18DB63_METHOD_2_62593EE2FE331D20_OFFSET UNITYSDK_OFFSET(0x10B38A70)
#define CLASS_2_E26DEA74DE18DB63_METHOD_2_68A6005A5B7867EA_OFFSET UNITYSDK_OFFSET(0x10B3A2C0)
#define CLASS_2_E26DEA74DE18DB63_METHOD_2_7646FFE662147970_OFFSET UNITYSDK_OFFSET(0x10B3AB00)
#define CLASS_2_E26DEA74DE18DB63_METHOD_2_8E4ED9FA27613068_OFFSET UNITYSDK_OFFSET(0x10B3B3F0)
#define CLASS_2_E26DEA74DE18DB63_METHOD_2_92305E9AE4A347EA_OFFSET UNITYSDK_OFFSET(0x10B3AF90)
#define CLASS_2_E26DEA74DE18DB63_METHOD_2_A3C36642AA77866E_OFFSET UNITYSDK_OFFSET(0x10B39740)
#define CLASS_2_E26DEA74DE18DB63_METHOD_2_A957F695E7113877_OFFSET UNITYSDK_OFFSET(0x10B3AE00)
#define CLASS_2_E26DEA74DE18DB63_METHOD_2_BF8EB4D2FA94E326_OFFSET UNITYSDK_OFFSET(0x10B3B190)
#define CLASS_2_E26DEA74DE18DB63_METHOD_2_DB363EF7E0980811_OFFSET UNITYSDK_OFFSET(0x10B39F30)
#define CLASS_2_E26DEA74DE18DB63_METHOD_2_DD62DFBF7F57337D_OFFSET UNITYSDK_OFFSET(0x10B38E10)
#define CLASS_2_E26DEA74DE18DB63_METHOD_2_F1DF4E805CDFCBA9_1_OFFSET UNITYSDK_OFFSET(0x10B3A480)
#define CLASS_2_E26DEA74DE18DB63_METHOD_2_F1DF4E805CDFCBA9_OFFSET UNITYSDK_OFFSET(0x10B3A8D0)
#define CLASS_2_E26DEA74DE18DB63_METHOD_2_F47E666AE443C437_OFFSET UNITYSDK_OFFSET(0x10B3A6B0)
#define CLASS_2_E26DEA74DE18DB63_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10B38AC0)
#define CLASS_2_E26DEA74DE18DB63_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10B393A0)
#define CLASS_2_E26DEA74DE18DB63_TICK_OFFSET UNITYSDK_OFFSET(0x10B39440)
#define CLASS_2_E26DEA74DE18DB63__CTOR_OFFSET UNITYSDK_OFFSET(0x10B388F0)

inline static constexpr unsigned int Class_2_E26DEA74DE18DB63_TypeDefinitionIndex = 46267;

class Class_2_E26DEA74DE18DB63 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::System::Collections::Generic::IList_1<::System::String*>* Field_2_7; // 0x18
	::Class_1_B407606E338E5818* Field_2_3; // 0x20
	::RPG::GameCore::TaskContext* Field_2_1; // 0x28
	::Class_1_53F0644B4D7513CF* Field_2_2; // 0x30
	::RPG::GameCore::ShowGuideHintWithText* Field_2_0; // 0x38
	::Class_1_69FF5DE516C87A66* Field_2_5; // 0x40
	::Class_0_16E4307DCC419505_439* Field_2_4; // 0x48
