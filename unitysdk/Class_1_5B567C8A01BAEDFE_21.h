...
#define CLASS_1_5B567C8A01BAEDFE_21_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A2673C0)
#define CLASS_1_5B567C8A01BAEDFE_21_CLONE_OFFSET UNITYSDK_OFFSET(0x1A2671D0)
#define CLASS_1_5B567C8A01BAEDFE_21_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A2672D0)
#define CLASS_1_5B567C8A01BAEDFE_21_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A267240)
#define CLASS_1_5B567C8A01BAEDFE_21_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A267320)
#define CLASS_1_5B567C8A01BAEDFE_21_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A267410)
#define CLASS_1_5B567C8A01BAEDFE_21_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A2673E0)
#define CLASS_1_5B567C8A01BAEDFE_21_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A267120)
#define CLASS_1_5B567C8A01BAEDFE_21_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A267180)
#define CLASS_1_5B567C8A01BAEDFE_21_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A267350)
#define CLASS_1_5B567C8A01BAEDFE_21_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A2673B0)
#define CLASS_1_5B567C8A01BAEDFE_21__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A267460)
#define CLASS_1_5B567C8A01BAEDFE_21__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A2671A0)
#define CLASS_1_5B567C8A01BAEDFE_21__CTOR_OFFSET UNITYSDK_OFFSET(0x1A267190)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_21*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_21_TypeDefinitionIndex)->GetStaticField(0x17E20);
	}
