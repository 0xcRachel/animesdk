...
#define CLASS_2_3616FDE8A71D0590_GETLITTLEGAMECONFIGMATCHER_OFFSET UNITYSDK_OFFSET(0x1306BFA0)
#define CLASS_2_3616FDE8A71D0590_GETREPLICATEDMATCHER_OFFSET UNITYSDK_OFFSET(0x1306C040)
#define CLASS_2_3616FDE8A71D0590_GETTRANSFORMMATCHER_OFFSET UNITYSDK_OFFSET(0x1306C0E0)
#define CLASS_2_3616FDE8A71D0590__CTOR_OFFSET UNITYSDK_OFFSET(0x1306C180)
