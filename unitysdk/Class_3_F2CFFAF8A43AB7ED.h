...
#define CLASS_3_F2CFFAF8A43AB7ED_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x15FE1610)
#define CLASS_3_F2CFFAF8A43AB7ED_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x15FE1720)
#define CLASS_3_F2CFFAF8A43AB7ED__CTOR_OFFSET UNITYSDK_OFFSET(0x15FE15F0)

inline static constexpr unsigned int Class_3_F2CFFAF8A43AB7ED_TypeDefinitionIndex = 27944;
