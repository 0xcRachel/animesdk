...
#define EFFECT_SETRANDOMANIMTIME_AWAKE_OFFSET UNITYSDK_OFFSET(0xFB8C8B0)
#define EFFECT_SETRANDOMANIMTIME_GET_RANDOMSEED_OFFSET UNITYSDK_OFFSET(0xFB8C960)
#define EFFECT_SETRANDOMANIMTIME_ONENABLE_OFFSET UNITYSDK_OFFSET(0xFB8C900)
#define EFFECT_SETRANDOMANIMTIME__CTOR_OFFSET UNITYSDK_OFFSET(0xFB8CAD0)
