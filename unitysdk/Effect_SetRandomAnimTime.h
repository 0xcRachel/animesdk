...
#define EFFECT_SETRANDOMANIMTIME_AWAKE_OFFSET UNITYSDK_OFFSET(0x13BAA960)
#define EFFECT_SETRANDOMANIMTIME_GET_RANDOMSEED_OFFSET UNITYSDK_OFFSET(0x13BAAA10)
#define EFFECT_SETRANDOMANIMTIME_ONENABLE_OFFSET UNITYSDK_OFFSET(0x13BAA9B0)
#define EFFECT_SETRANDOMANIMTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x13BAAB80)
