...
#define EFFECT_SETRANDOMANIMTIME_AWAKE_OFFSET UNITYSDK_OFFSET(0xC31C830)
#define EFFECT_SETRANDOMANIMTIME_GET_RANDOMSEED_OFFSET UNITYSDK_OFFSET(0xC31C8E0)
#define EFFECT_SETRANDOMANIMTIME_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC31C880)
#define EFFECT_SETRANDOMANIMTIME__CTOR_OFFSET UNITYSDK_OFFSET(0xC31CA50)
