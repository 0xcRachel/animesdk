...
#define CLASS_1_5B567C8A01BAEDFE_361_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A1D6860)
#define CLASS_1_5B567C8A01BAEDFE_361_CLONE_OFFSET UNITYSDK_OFFSET(0x1A1D6670)
#define CLASS_1_5B567C8A01BAEDFE_361_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A1D6770)
#define CLASS_1_5B567C8A01BAEDFE_361_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A1D66E0)
#define CLASS_1_5B567C8A01BAEDFE_361_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A1D67C0)
#define CLASS_1_5B567C8A01BAEDFE_361_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A1D68B0)
#define CLASS_1_5B567C8A01BAEDFE_361_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A1D6880)
#define CLASS_1_5B567C8A01BAEDFE_361_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A1D65C0)
#define CLASS_1_5B567C8A01BAEDFE_361_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A1D6620)
#define CLASS_1_5B567C8A01BAEDFE_361_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A1D67F0)
#define CLASS_1_5B567C8A01BAEDFE_361_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A1D6850)
#define CLASS_1_5B567C8A01BAEDFE_361__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1D6900)
#define CLASS_1_5B567C8A01BAEDFE_361__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A1D6640)
#define CLASS_1_5B567C8A01BAEDFE_361__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1D6630)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_361*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_361_TypeDefinitionIndex)->GetStaticField(0x5ECD0);
	}
