...
#define CLASS_1_5B567C8A01BAEDFE_361_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1B1B4F00)
#define CLASS_1_5B567C8A01BAEDFE_361_CLONE_OFFSET UNITYSDK_OFFSET(0x1B1B4D10)
#define CLASS_1_5B567C8A01BAEDFE_361_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1B1B4E10)
#define CLASS_1_5B567C8A01BAEDFE_361_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B1B4D80)
#define CLASS_1_5B567C8A01BAEDFE_361_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B1B4E60)
#define CLASS_1_5B567C8A01BAEDFE_361_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1B1B4F50)
#define CLASS_1_5B567C8A01BAEDFE_361_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1B1B4F20)
#define CLASS_1_5B567C8A01BAEDFE_361_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1B1B4C60)
#define CLASS_1_5B567C8A01BAEDFE_361_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1B1B4CC0)
#define CLASS_1_5B567C8A01BAEDFE_361_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B1B4E90)
#define CLASS_1_5B567C8A01BAEDFE_361_WRITETO_OFFSET UNITYSDK_OFFSET(0x1B1B4EF0)
#define CLASS_1_5B567C8A01BAEDFE_361__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B1B4FA0)
#define CLASS_1_5B567C8A01BAEDFE_361__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B1B4CE0)
#define CLASS_1_5B567C8A01BAEDFE_361__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1B4CD0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_361*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_361_TypeDefinitionIndex)->GetStaticField(0x32370);
	}
