...
#define CLASS_1_8798F0B45D811416_DOFAILED_OFFSET UNITYSDK_OFFSET(0xA61A5D0)
#define CLASS_1_8798F0B45D811416_DOSUCCEED_OFFSET UNITYSDK_OFFSET(0xA61A030)
#define CLASS_1_8798F0B45D811416_EXECUTE_OFFSET UNITYSDK_OFFSET(0xA6193A0)
#define CLASS_1_8798F0B45D811416_GETTYPENAME_OFFSET UNITYSDK_OFFSET(0xA618E60)
#define CLASS_1_8798F0B45D811416_GET_ACTIONSYSTEM_OFFSET UNITYSDK_OFFSET(0xA618F10)
#define CLASS_1_8798F0B45D811416_GET_FAILURECOUNT_OFFSET UNITYSDK_OFFSET(0xA618F60)
#define CLASS_1_8798F0B45D811416_GET_FINISHCOUNT_OFFSET UNITYSDK_OFFSET(0xA618F80)
#define CLASS_1_8798F0B45D811416_GET_ID_OFFSET UNITYSDK_OFFSET(0xA618ED0)
#define CLASS_1_8798F0B45D811416_GET_ONFAILED_OFFSET UNITYSDK_OFFSET(0xA618FE0)
#define CLASS_1_8798F0B45D811416_GET_ONFINISH_OFFSET UNITYSDK_OFFSET(0xA619000)
#define CLASS_1_8798F0B45D811416_GET_ONITEMFAILED_OFFSET UNITYSDK_OFFSET(0xA619060)
#define CLASS_1_8798F0B45D811416_GET_ONITEMSTARTING_OFFSET UNITYSDK_OFFSET(0xA619020)
#define CLASS_1_8798F0B45D811416_GET_ONITEMSUCCEED_OFFSET UNITYSDK_OFFSET(0xA619040)
#define CLASS_1_8798F0B45D811416_GET_ONSTARTING_OFFSET UNITYSDK_OFFSET(0xA618FA0)
#define CLASS_1_8798F0B45D811416_GET_ONSUCCEED_OFFSET UNITYSDK_OFFSET(0xA618FC0)
#define CLASS_1_8798F0B45D811416_GET_ROOTQUEUE_OFFSET UNITYSDK_OFFSET(0xA618F00)
#define CLASS_1_8798F0B45D811416_GET_SUCCESSCOUNT_OFFSET UNITYSDK_OFFSET(0xA618F40)
#define CLASS_1_8798F0B45D811416_GET_TOTALCOUNT_OFFSET UNITYSDK_OFFSET(0xA618F20)
#define CLASS_1_8798F0B45D811416_METHOD_1_03A81715BD2AFEF3_OFFSET UNITYSDK_OFFSET(0xA61A440)
#define CLASS_1_8798F0B45D811416_METHOD_1_3ED8334571FBD7F7_OFFSET UNITYSDK_OFFSET(0xA61A970)
#define CLASS_1_8798F0B45D811416_METHOD_1_6B4CC9FEC403294B_OFFSET UNITYSDK_OFFSET(0xA61A770)
#define CLASS_1_8798F0B45D811416_METHOD_1_7ADD5F1F5E247E3B_OFFSET UNITYSDK_OFFSET(0xA618EF0)
#define CLASS_1_8798F0B45D811416_METHOD_1_87D163BDED423A4D_OFFSET UNITYSDK_OFFSET(0xA61A4B0)
#define CLASS_1_8798F0B45D811416_METHOD_1_D58849E1895DD394_OFFSET UNITYSDK_OFFSET(0xA61A1A0)
#define CLASS_1_8798F0B45D811416_METHOD_1_DA9E3DBF4B5803A3_OFFSET UNITYSDK_OFFSET(0xA619230)
#define CLASS_1_8798F0B45D811416_SET_FAILURECOUNT_OFFSET UNITYSDK_OFFSET(0xA618F70)
#define CLASS_1_8798F0B45D811416_SET_FINISHCOUNT_OFFSET UNITYSDK_OFFSET(0xA618F90)
#define CLASS_1_8798F0B45D811416_SET_ID_OFFSET UNITYSDK_OFFSET(0xA618EE0)
#define CLASS_1_8798F0B45D811416_SET_ONFAILED_OFFSET UNITYSDK_OFFSET(0xA618FF0)
#define CLASS_1_8798F0B45D811416_SET_ONFINISH_OFFSET UNITYSDK_OFFSET(0xA619010)
#define CLASS_1_8798F0B45D811416_SET_ONITEMFAILED_OFFSET UNITYSDK_OFFSET(0xA619070)
#define CLASS_1_8798F0B45D811416_SET_ONITEMSTARTING_OFFSET UNITYSDK_OFFSET(0xA619030)
#define CLASS_1_8798F0B45D811416_SET_ONITEMSUCCEED_OFFSET UNITYSDK_OFFSET(0xA619050)
#define CLASS_1_8798F0B45D811416_SET_ONSTARTING_OFFSET UNITYSDK_OFFSET(0xA618FB0)
#define CLASS_1_8798F0B45D811416_SET_ONSUCCEED_OFFSET UNITYSDK_OFFSET(0xA618FD0)
#define CLASS_1_8798F0B45D811416_SET_SUCCESSCOUNT_OFFSET UNITYSDK_OFFSET(0xA618F50)
#define CLASS_1_8798F0B45D811416_SET_TOTALCOUNT_OFFSET UNITYSDK_OFFSET(0xA618F30)
#define CLASS_1_8798F0B45D811416_UPDATEPROGRESS_OFFSET UNITYSDK_OFFSET(0xA61A910)
#define CLASS_1_8798F0B45D811416__CTOR_OFFSET UNITYSDK_OFFSET(0xA619080)
...
public:
	...
	::Class_2_54CCD44980580DB7* Field_1_13; // 0x18
	::RPG::Client::ActionEvent_1<::Class_2_2690241A4D35989E*>* _OnItemFailed_k__BackingField; // 0x20
	::Class_1_280047DF9F661B14* Field_1_2; // 0x28
	::RPG::Client::ActionEvent_4<::Class_0_16E4307DCC419505_557*, ::Class_0_16E4307DCC419505_559*, ::System::Object*, ::RPG::Client::ExeCode>* _OnFinish_k__BackingField; // 0x30
	::RPG::Client::ActionEvent_1<::Class_2_2690241A4D35989E*>* _OnFailed_k__BackingField; // 0x38
	...
	::RPG::Client::ActionEvent_3<::Class_0_16E4307DCC419505_557*, ::Class_0_16E4307DCC419505_559*, ::System::Object*>* _OnItemSucceed_k__BackingField; // 0x58
	::Class_1_8C3AC9786B6764EF* Field_1_4; // 0x60
	::System::String* Field_1_6; // 0x68
	::RPG::Client::ActionEvent_3<::Class_0_16E4307DCC419505_557*, ::Class_0_16E4307DCC419505_559*, ::System::Object*>* _OnItemStarting_k__BackingField; // 0x70
	::RPG::Client::NotifyType Field_1_7; // 0x78
	::System::Int32 _FailureCount_k__BackingField; // 0x7C
	::System::Int32 _TotalCount_k__BackingField; // 0x80
	::RPG::Client::NotifyType Field_1_10; // 0x84
	::System::Int32 _SuccessCount_k__BackingField; // 0x88
	::System::Int32 _FinishCount_k__BackingField; // 0x8C
	::System::Int64 Field_1_3; // 0x90
	::RPG::Client::TextID Field_1_5; // 0x98
	::System::Boolean Field_1_11; // 0xA8
	::RPG::Client::ProgressID _ID_k__BackingField; // 0xAC
	::RPG::Client::TextID Field_1_8; // 0xB0
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_8798F0B45D811416_METHOD_1_03A81715BD2AFEF3_OFFSET))(this);
	}
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::Boolean))((::PBYTE)hIl2Cpp + CLASS_1_8798F0B45D811416_METHOD_1_87D163BDED423A4D_OFFSET))(this, a1);
	}
