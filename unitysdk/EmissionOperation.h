...
#define EMISSIONOPERATION_METHOD_3_6454AD7212B2C6DE_1_OFFSET UNITYSDK_OFFSET(0xDEE7350)
#define EMISSIONOPERATION_METHOD_3_6454AD7212B2C6DE_OFFSET UNITYSDK_OFFSET(0xDEE6F60)
#define EMISSIONOPERATION_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0xDEE7650)
#define EMISSIONOPERATION_METHOD_3_A4A57157C453DC3A_OFFSET UNITYSDK_OFFSET(0xDEE7240)
#define EMISSIONOPERATION__CCTOR_OFFSET UNITYSDK_OFFSET(0xDEE76C0)
#define EMISSIONOPERATION__CTOR_OFFSET UNITYSDK_OFFSET(0xDEE76A0)

inline static constexpr unsigned int EmissionOperation_TypeDefinitionIndex = 37077;
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EmissionOperation_TypeDefinitionIndex)->GetStaticField(0xFD90);
	}
