...
#define CLASS_2_C73AB3362B307540_METHOD_2_E4EE4D98EE55C81B_OFFSET UNITYSDK_OFFSET(0x187EEBF0)
#define CLASS_2_C73AB3362B307540__CTOR_OFFSET UNITYSDK_OFFSET(0x187EED40)
...
{
public:
	::RPG::GameCore::STDetectNPCMonsterType Field_2_1; // 0x10
