...
#define CLASS_2_1172AC0FAD3B4A1D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x168C3E00)
#define CLASS_2_1172AC0FAD3B4A1D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x168C3F20)
#define CLASS_2_1172AC0FAD3B4A1D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x168C3E50)
#define CLASS_2_1172AC0FAD3B4A1D_TICK_OFFSET UNITYSDK_OFFSET(0x168C4270)
#define CLASS_2_1172AC0FAD3B4A1D__CTOR_OFFSET UNITYSDK_OFFSET(0x168C3DF0)
...
{
public:
	::RPG::GameCore::ShowHintEffect* Field_2_0; // 0x18
