...
#define CLASS_1_DC8A0C24D0ECD3C7_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13050610)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_02B68B82FF44DF2C_OFFSET UNITYSDK_OFFSET(0x13050AF0)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_0D4E90EB2BAE52F1_OFFSET UNITYSDK_OFFSET(0x13052000)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_1DCE88F6D8787162_OFFSET UNITYSDK_OFFSET(0x130513C0)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_1DF31017248D14E0_OFFSET UNITYSDK_OFFSET(0x13050820)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_3ECE83CEE6E43F60_OFFSET UNITYSDK_OFFSET(0x130515E0)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_513F60E1612756A9_OFFSET UNITYSDK_OFFSET(0x1304AE70)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_65DEDF82214A60DE_OFFSET UNITYSDK_OFFSET(0x130509A0)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_87D87DF807B38FEA_OFFSET UNITYSDK_OFFSET(0x13051E10)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_8B22B8793DA332D5_OFFSET UNITYSDK_OFFSET(0x13051370)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_8F54650C0C7FD373_OFFSET UNITYSDK_OFFSET(0x1304ADA0)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_95780ED94B90ED36_1_OFFSET UNITYSDK_OFFSET(0x130510C0)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x13050690)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_97DC0DC73F43C590_OFFSET UNITYSDK_OFFSET(0x130506E0)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_9CDC04708737375E_OFFSET UNITYSDK_OFFSET(0x13051290)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_A1C1658F78437BD8_OFFSET UNITYSDK_OFFSET(0x13050BF0)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_B741B9730EBACFC0_OFFSET UNITYSDK_OFFSET(0x13051C70)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_BF6431F148CDB0D3_OFFSET UNITYSDK_OFFSET(0x13050E50)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_C47B6761592C4423_OFFSET UNITYSDK_OFFSET(0x130514F0)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0x13051280)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_C90B5126E6A14193_OFFSET UNITYSDK_OFFSET(0x13051940)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_F879B5DF2C7EBED0_OFFSET UNITYSDK_OFFSET(0x13051130)
#define CLASS_1_DC8A0C24D0ECD3C7__CCTOR_OFFSET UNITYSDK_OFFSET(0x130520A0)
#define CLASS_1_DC8A0C24D0ECD3C7__CTOR_OFFSET UNITYSDK_OFFSET(0x1304AC50)
...
public:
	...
	{
		return (::System::Object**)Il2CppClass::FromTypeDefinitionIndex(Class_1_DC8A0C24D0ECD3C7_TypeDefinitionIndex)->GetStaticField(0x1AA20);
	}
	static ::System::Object** StaticGet_Field_1_1()
	{
		return (::System::Object**)Il2CppClass::FromTypeDefinitionIndex(Class_1_DC8A0C24D0ECD3C7_TypeDefinitionIndex)->GetStaticField(0x1AA28);
	}
	...
	::Il2CppArray<::Struct_2_F6CF28892F8E6FF1>* Field_1_5; // 0x10
	::Il2CppArray<::Struct_2_7DEC15197331BC9B>* Field_1_6; // 0x18
	::Class_1_DC8A0C24D0ECD3C7_Class_1_4192656C7657C1B2* Field_1_7; // 0x20
	::Class_1_DC8A0C24D0ECD3C7_Class_1_4192656C7657C1B2* Field_1_8; // 0x28
	::Class_1_DC8A0C24D0ECD3C7_Class_1_4192656C7657C1B2* Field_1_9; // 0x30
	::System::Collections::Generic::HashSet_1<::System::UInt64>* Field_1_10; // 0x38
	::Class_1_49280AAF81D53F7B* Field_1_11; // 0x40
	::Il2CppArray<::System::Int32>* Field_1_12; // 0x48
	::Il2CppArray<::Class_1_2626D71FD1EE4F41*>* Field_1_13; // 0x50
	::Class_1_DC8A0C24D0ECD3C7_Class_1_4192656C7657C1B2* Field_1_14; // 0x58
	::Il2CppArray<::System::Boolean>* Field_1_15; // 0x60
	::Class_1_1B9BBF1B9A8CC806* Field_1_16; // 0x68
	::RPG::GameCore::UnmanagedStructArray_1<::Struct_2_0864311C6F08EEE8>* Field_1_17; // 0x70
	...
	::System::Boolean Field_1_23; // 0x86
