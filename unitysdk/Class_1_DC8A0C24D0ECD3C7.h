...
#define CLASS_1_DC8A0C24D0ECD3C7_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15E00530)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_02B68B82FF44DF2C_OFFSET UNITYSDK_OFFSET(0x15E01560)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_0D4E90EB2BAE52F1_OFFSET UNITYSDK_OFFSET(0x15E04020)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_1DF31017248D14E0_OFFSET UNITYSDK_OFFSET(0x15E00E80)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_3ECE83CEE6E43F60_OFFSET UNITYSDK_OFFSET(0x15E03010)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_513F60E1612756A9_OFFSET UNITYSDK_OFFSET(0x15E008E0)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_65DEDF82214A60DE_OFFSET UNITYSDK_OFFSET(0x15E01190)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_87D87DF807B38FEA_OFFSET UNITYSDK_OFFSET(0x15E03CC0)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_8B22B8793DA332D5_OFFSET UNITYSDK_OFFSET(0x15E02700)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_8F54650C0C7FD373_OFFSET UNITYSDK_OFFSET(0x15E006A0)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_95780ED94B90ED36_1_OFFSET UNITYSDK_OFFSET(0x15E020D0)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x15E00AD0)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_97DC0DC73F43C590_OFFSET UNITYSDK_OFFSET(0x15E00B20)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_9CDC04708737375E_OFFSET UNITYSDK_OFFSET(0x15E02410)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_A1C1658F78437BD8_OFFSET UNITYSDK_OFFSET(0x15E01820)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_B741B9730EBACFC0_OFFSET UNITYSDK_OFFSET(0x15E039A0)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_BEFB9334CC46BC96_OFFSET UNITYSDK_OFFSET(0x15E02A00)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_BF6431F148CDB0D3_OFFSET UNITYSDK_OFFSET(0x15E01C40)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_C47B6761592C4423_OFFSET UNITYSDK_OFFSET(0x15E02C60)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0x15E02400)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_C90B5126E6A14193_OFFSET UNITYSDK_OFFSET(0x15E034E0)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_F879B5DF2C7EBED0_OFFSET UNITYSDK_OFFSET(0x15E02140)
#define CLASS_1_DC8A0C24D0ECD3C7__CCTOR_OFFSET UNITYSDK_OFFSET(0x15E04350)
#define CLASS_1_DC8A0C24D0ECD3C7__CTOR_OFFSET UNITYSDK_OFFSET(0x15E041F0)

inline static constexpr unsigned int Class_1_DC8A0C24D0ECD3C7_TypeDefinitionIndex = 31152;
...
public:
	...
	{
		return (::System::Object**)Il2CppClass::FromTypeDefinitionIndex(Class_1_DC8A0C24D0ECD3C7_TypeDefinitionIndex)->GetStaticField(0x36940);
	}
	static ::System::Object** StaticGet_Field_1_10()
	{
		return (::System::Object**)Il2CppClass::FromTypeDefinitionIndex(Class_1_DC8A0C24D0ECD3C7_TypeDefinitionIndex)->GetStaticField(0x36948);
	}
	...
	::System::Collections::Generic::HashSet_1<::System::UInt64>* Field_1_21; // 0x10
	::Class_1_DC8A0C24D0ECD3C7_Class_1_4192656C7657C1B2* Field_1_15; // 0x18
	::Class_1_DC8A0C24D0ECD3C7_Class_1_4192656C7657C1B2* Field_1_17; // 0x20
	::Class_1_695986DCCF48052E* Field_1_0; // 0x28
	::Class_1_1B9BBF1B9A8CC806* Field_1_6; // 0x30
	::Class_1_DC8A0C24D0ECD3C7_Class_1_4192656C7657C1B2* Field_1_16; // 0x38
	::Il2CppArray<::Class_1_2626D71FD1EE4F41*>* Field_1_4; // 0x40
	::Class_1_DC8A0C24D0ECD3C7_Class_1_4192656C7657C1B2* Field_1_14; // 0x48
	::Il2CppArray<::Struct_2_F6CF28892F8E6FF1>* Field_1_24; // 0x50
	::RPG::GameCore::UnmanagedStructArray_1<::Struct_2_0864311C6F08EEE8>* Field_1_8; // 0x58
	::Il2CppArray<::System::Int32>* Field_1_20; // 0x60
	::Il2CppArray<::System::Boolean>* Field_1_5; // 0x68
	::Il2CppArray<::Struct_2_7DEC15197331BC9B>* Field_1_7; // 0x70
	...
	::System::Int32 Method_1_BEFB9334CC46BC96(::System::String* a1)
	{
		return ((::System::Int32(*)(::PVOID, ::System::String*))((::PBYTE)hIl2Cpp + CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_BEFB9334CC46BC96_OFFSET))(this, a1);
	}
	...
	::System::Boolean Method_1_3ECE83CEE6E43F60(::System::String* a1, ::Class_0_16E4307DCC419505_45* a2)
	{
		return ((::System::Boolean(*)(::PVOID, ::System::String*, ::Class_0_16E4307DCC419505_45*))((::PBYTE)hIl2Cpp + CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_3ECE83CEE6E43F60_OFFSET))(this, a1, a2);
	}

	::System::Boolean Method_1_C90B5126E6A14193(::System::UInt64 a1, ::Class_0_16E4307DCC419505_45* a2)
	{
		return ((::System::Boolean(*)(::PVOID, ::System::UInt64, ::Class_0_16E4307DCC419505_45*))((::PBYTE)hIl2Cpp + CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_C90B5126E6A14193_OFFSET))(this, a1, a2);
	}
