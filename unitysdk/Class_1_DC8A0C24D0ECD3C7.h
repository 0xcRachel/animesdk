...
#define CLASS_1_DC8A0C24D0ECD3C7_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16550C40)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_02B68B82FF44DF2C_OFFSET UNITYSDK_OFFSET(0x16551150)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_0D4E90EB2BAE52F1_OFFSET UNITYSDK_OFFSET(0x16552800)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_1DCE88F6D8787162_OFFSET UNITYSDK_OFFSET(0x16551B90)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_1DF31017248D14E0_OFFSET UNITYSDK_OFFSET(0x16550E50)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_3ECE83CEE6E43F60_OFFSET UNITYSDK_OFFSET(0x16551DC0)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_513F60E1612756A9_OFFSET UNITYSDK_OFFSET(0x16528280)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_65DEDF82214A60DE_OFFSET UNITYSDK_OFFSET(0x16550FF0)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_87D87DF807B38FEA_OFFSET UNITYSDK_OFFSET(0x16552610)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_8B22B8793DA332D5_OFFSET UNITYSDK_OFFSET(0x16551A00)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_8F54650C0C7FD373_OFFSET UNITYSDK_OFFSET(0x165281A0)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_95780ED94B90ED36_1_OFFSET UNITYSDK_OFFSET(0x16551750)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x16550CB0)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_97DC0DC73F43C590_OFFSET UNITYSDK_OFFSET(0x16550D00)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_9CDC04708737375E_OFFSET UNITYSDK_OFFSET(0x16551920)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_A1C1658F78437BD8_OFFSET UNITYSDK_OFFSET(0x16551260)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_B741B9730EBACFC0_OFFSET UNITYSDK_OFFSET(0x16552450)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_BF6431F148CDB0D3_OFFSET UNITYSDK_OFFSET(0x165514D0)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_C47B6761592C4423_OFFSET UNITYSDK_OFFSET(0x16551CC0)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0x16551910)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_C90B5126E6A14193_OFFSET UNITYSDK_OFFSET(0x16552120)
#define CLASS_1_DC8A0C24D0ECD3C7_METHOD_1_F879B5DF2C7EBED0_OFFSET UNITYSDK_OFFSET(0x165517C0)
#define CLASS_1_DC8A0C24D0ECD3C7__CCTOR_OFFSET UNITYSDK_OFFSET(0x16552890)
#define CLASS_1_DC8A0C24D0ECD3C7__CTOR_OFFSET UNITYSDK_OFFSET(0x16527C90)
...
public:
	...
	{
		return (::System::Object**)Il2CppClass::FromTypeDefinitionIndex(Class_1_DC8A0C24D0ECD3C7_TypeDefinitionIndex)->GetStaticField(0x4D70);
	}
	static ::System::Object** StaticGet_Field_1_23()
	{
		return (::System::Object**)Il2CppClass::FromTypeDefinitionIndex(Class_1_DC8A0C24D0ECD3C7_TypeDefinitionIndex)->GetStaticField(0x4D78);
	}
	...
	::Class_1_DC8A0C24D0ECD3C7_Class_1_4192656C7657C1B2* Field_1_15; // 0x10
	::Il2CppArray<::System::Int32>* Field_1_20; // 0x18
	::System::Collections::Generic::HashSet_1<::System::UInt64>* Field_1_21; // 0x20
	::Class_1_1B9BBF1B9A8CC806* Field_1_6; // 0x28
	::RPG::GameCore::UnmanagedStructArray_1<::Struct_2_0864311C6F08EEE8>* Field_1_8; // 0x30
	::Class_1_DC8A0C24D0ECD3C7_Class_1_4192656C7657C1B2* Field_1_16; // 0x38
	::Il2CppArray<::Struct_2_7DEC15197331BC9B>* Field_1_7; // 0x40
	::Class_1_49280AAF81D53F7B* Field_1_0; // 0x48
	::Il2CppArray<::Struct_2_F6CF28892F8E6FF1>* Field_1_24; // 0x50
	::Class_1_DC8A0C24D0ECD3C7_Class_1_4192656C7657C1B2* Field_1_14; // 0x58
	::Il2CppArray<::Class_1_2626D71FD1EE4F41*>* Field_1_4; // 0x60
	::Il2CppArray<::System::Boolean>* Field_1_5; // 0x68
	::Class_1_DC8A0C24D0ECD3C7_Class_1_4192656C7657C1B2* Field_1_17; // 0x70
	::System::Int32 Field_1_22; // 0x78
	::System::Int32 Field_1_18; // 0x7C
	::System::Int32 Field_1_9; // 0x80
	::System::Boolean Field_1_1; // 0x84
	::System::Boolean Field_1_3; // 0x85
