...
#define CLASS_1_5B567C8A01BAEDFE_75_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A436750)
#define CLASS_1_5B567C8A01BAEDFE_75_CLONE_OFFSET UNITYSDK_OFFSET(0x1A436560)
#define CLASS_1_5B567C8A01BAEDFE_75_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A436660)
#define CLASS_1_5B567C8A01BAEDFE_75_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A4365D0)
#define CLASS_1_5B567C8A01BAEDFE_75_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A4366B0)
#define CLASS_1_5B567C8A01BAEDFE_75_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A4367A0)
#define CLASS_1_5B567C8A01BAEDFE_75_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A436770)
#define CLASS_1_5B567C8A01BAEDFE_75_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A4364B0)
#define CLASS_1_5B567C8A01BAEDFE_75_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A436510)
#define CLASS_1_5B567C8A01BAEDFE_75_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A4366E0)
#define CLASS_1_5B567C8A01BAEDFE_75_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A436740)
#define CLASS_1_5B567C8A01BAEDFE_75__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A4367F0)
#define CLASS_1_5B567C8A01BAEDFE_75__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A436530)
#define CLASS_1_5B567C8A01BAEDFE_75__CTOR_OFFSET UNITYSDK_OFFSET(0x1A436520)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_75*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_75_TypeDefinitionIndex)->GetStaticField(0x11C20);
	}
