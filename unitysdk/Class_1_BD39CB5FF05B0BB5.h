...
#define CLASS_1_BD39CB5FF05B0BB5__CTOR_OFFSET UNITYSDK_OFFSET(0x17C934C0)
...
{
public:
	::Struct_2_FCD0D88D13269531 Field_1_1; // 0x10
	::RPG::GameCore::FiveDimSwitchPlatformConfig* Field_1_0; // 0x28
