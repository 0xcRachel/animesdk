...
#define CLASS_2_327654700DEA38B4_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1472FA30)
#define CLASS_2_327654700DEA38B4_METHOD_2_A0C13191B8508BD3_OFFSET UNITYSDK_OFFSET(0x147303C0)
#define CLASS_2_327654700DEA38B4_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1472FC80)
#define CLASS_2_327654700DEA38B4_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1472FB30)
#define CLASS_2_327654700DEA38B4_TICK_OFFSET UNITYSDK_OFFSET(0x14730210)
#define CLASS_2_327654700DEA38B4__CTOR_OFFSET UNITYSDK_OFFSET(0x1472F900)
...
{
public:
	::RPG::Client::Prop::MonoPushDownObject* Field_2_0; // 0x18
	::Class_3_07C3C4D2990C49EE* Field_2_1; // 0x20
	::RPG::GameCore::TaskContext* Field_2_2; // 0x28
	::Class_3_07C3C4D2990C49EE* Field_2_3; // 0x30
	::RPG::GameCore::AdvPlayerPushDownProp* Field_2_4; // 0x38
