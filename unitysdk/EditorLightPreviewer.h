...
#define EDITORLIGHTPREVIEWER_CANCELPINCURRENTCAMPOS_OFFSET UNITYSDK_OFFSET(0xDEE0F80)
#define EDITORLIGHTPREVIEWER_CHANGEENV_OFFSET UNITYSDK_OFFSET(0xDEE0CF0)
#define EDITORLIGHTPREVIEWER_CHANGEQUALITY_OFFSET UNITYSDK_OFFSET(0xDEE0A70)
#define EDITORLIGHTPREVIEWER_EXITLIGHTPREVIEW_OFFSET UNITYSDK_OFFSET(0xDEE24F0)
#define EDITORLIGHTPREVIEWER_EXITPREVIEW_OFFSET UNITYSDK_OFFSET(0xDEDFB90)
#define EDITORLIGHTPREVIEWER_GETCIDFROMOBJ_OFFSET UNITYSDK_OFFSET(0xDEDFAA0)
#define EDITORLIGHTPREVIEWER_GETLIGHTFGAMEOBJECTFROMCONTROLID_OFFSET UNITYSDK_OFFSET(0xDEE1280)
#define EDITORLIGHTPREVIEWER_GET_INPREVIEW_OFFSET UNITYSDK_OFFSET(0xDEE26D0)
#define EDITORLIGHTPREVIEWER_ISALIVE_OFFSET UNITYSDK_OFFSET(0xDEDFA10)
#define EDITORLIGHTPREVIEWER_ISINLIGHTPREVIEW_OFFSET UNITYSDK_OFFSET(0xDEE2640)
#define EDITORLIGHTPREVIEWER_LOADHEADER_OFFSET UNITYSDK_OFFSET(0xDEE05A0)
#define EDITORLIGHTPREVIEWER_METHOD_5_00605CD46BC5ED28_OFFSET UNITYSDK_OFFSET(0xDEE24B0)
#define EDITORLIGHTPREVIEWER_METHOD_5_14014646206E49EF_OFFSET UNITYSDK_OFFSET(0xDEE0FD0)
#define EDITORLIGHTPREVIEWER_METHOD_5_58DF4ECFAC9D8302_OFFSET UNITYSDK_OFFSET(0xDEE1D70)
#define EDITORLIGHTPREVIEWER_METHOD_5_5E288D22F52E3FF4_OFFSET UNITYSDK_OFFSET(0xDEE1880)
#define EDITORLIGHTPREVIEWER_METHOD_5_648BBA11A4556807_OFFSET UNITYSDK_OFFSET(0xDEE1400)
#define EDITORLIGHTPREVIEWER_METHOD_5_739DB9F245C7FAD0_OFFSET UNITYSDK_OFFSET(0xDEDE830)
#define EDITORLIGHTPREVIEWER_METHOD_5_96980C17A8BB1F06_OFFSET UNITYSDK_OFFSET(0xDEE00F0)
#define EDITORLIGHTPREVIEWER_METHOD_5_A955AFA55B1D8C49_OFFSET UNITYSDK_OFFSET(0xDEE1A30)
#define EDITORLIGHTPREVIEWER_METHOD_5_AFFFB1DD57EDD0F7_OFFSET UNITYSDK_OFFSET(0xDEE1B80)
#define EDITORLIGHTPREVIEWER_METHOD_5_B10D028FBFD259C7_OFFSET UNITYSDK_OFFSET(0xDEE2360)
#define EDITORLIGHTPREVIEWER_METHOD_5_BA18886DD7F7CF46_OFFSET UNITYSDK_OFFSET(0xDEE20E0)
#define EDITORLIGHTPREVIEWER_METHOD_5_C1CFF8CC0530F137_OFFSET UNITYSDK_OFFSET(0xDEE2260)
#define EDITORLIGHTPREVIEWER_METHOD_5_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xDEE0EA0)
#define EDITORLIGHTPREVIEWER_METHOD_5_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0xDEE1D30)
#define EDITORLIGHTPREVIEWER_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xDEE0E60)
#define EDITORLIGHTPREVIEWER_METHOD_5_DA3CBF6C9A16A2EA_OFFSET UNITYSDK_OFFSET(0xDEE1730)
#define EDITORLIGHTPREVIEWER_METHOD_5_F3B08E53C999F05B_OFFSET UNITYSDK_OFFSET(0xDEE15B0)
#define EDITORLIGHTPREVIEWER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xDEE25F0)
#define EDITORLIGHTPREVIEWER_PINCURRENTCAMPOS_OFFSET UNITYSDK_OFFSET(0xDEE0EE0)
#define EDITORLIGHTPREVIEWER_RESETLIGHTSCENE_OFFSET UNITYSDK_OFFSET(0xDEDFD90)
#define EDITORLIGHTPREVIEWER_STARTLIGHTPREVIEW_OFFSET UNITYSDK_OFFSET(0xDEE23C0)
#define EDITORLIGHTPREVIEWER_STARTPREVIEW_OFFSET UNITYSDK_OFFSET(0xDEE0420)
#define EDITORLIGHTPREVIEWER_UPDATE_OFFSET UNITYSDK_OFFSET(0xDEDE7E0)
#define EDITORLIGHTPREVIEWER__CTOR_OFFSET UNITYSDK_OFFSET(0xDEE2790)

inline static constexpr unsigned int EditorLightPreviewer_TypeDefinitionIndex = 37278;
...
public:
	...
	{
		return (::EditorLightPreviewer**)Il2CppClass::FromTypeDefinitionIndex(EditorLightPreviewer_TypeDefinitionIndex)->GetStaticField(0x44150);
	}
	...
	::RPG::Client::OpenWorld::StreamingLightEnum Method_5_DA3CBF6C9A16A2EA(::System::String* a1)
	{
		return ((::RPG::Client::OpenWorld::StreamingLightEnum(*)(::PVOID, ::System::String*))((::PBYTE)hIl2Cpp + EDITORLIGHTPREVIEWER_METHOD_5_DA3CBF6C9A16A2EA_OFFSET))(this, a1);
	}
