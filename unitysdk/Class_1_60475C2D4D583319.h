...
#define CLASS_1_60475C2D4D583319_METHOD_1_2313407289FC2813_OFFSET UNITYSDK_OFFSET(0x1630CA90)
#define CLASS_1_60475C2D4D583319_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x1630BB20)
#define CLASS_1_60475C2D4D583319_METHOD_1_3978A63BC8CCDBF6_OFFSET UNITYSDK_OFFSET(0x1630BC40)
#define CLASS_1_60475C2D4D583319_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x1630BAA0)
#define CLASS_1_60475C2D4D583319_METHOD_1_57D80B372834C5D1_OFFSET UNITYSDK_OFFSET(0x1630B940)
#define CLASS_1_60475C2D4D583319_METHOD_1_C75FBCF88EADEF52_OFFSET UNITYSDK_OFFSET(0x1630BDE0)
#define CLASS_1_60475C2D4D583319_METHOD_1_DB724851FEB3D97C_OFFSET UNITYSDK_OFFSET(0x1630B9B0)
#define CLASS_1_60475C2D4D583319_METHOD_1_DDF954C8FE9E6001_OFFSET UNITYSDK_OFFSET(0x1630BEE0)
#define CLASS_1_60475C2D4D583319_METHOD_1_EDCA216BAAE60E47_OFFSET UNITYSDK_OFFSET(0x1630BB70)
#define CLASS_1_60475C2D4D583319__CCTOR_OFFSET UNITYSDK_OFFSET(0x1630CD90)
#define CLASS_1_60475C2D4D583319__CTOR_OFFSET UNITYSDK_OFFSET(0x1630B8A0)
...
public:
	...
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_1_60475C2D4D583319_TypeDefinitionIndex)->GetStaticField(0xB040);
	}
	::RPG::GameCore::TransformComponent* Field_1_1; // 0x10
	::Class_2_199C92B758EE3BC4* Field_1_2; // 0x18
	...
	::RPG::GameCore::AdvancedFollowType Field_1_8; // 0x48
