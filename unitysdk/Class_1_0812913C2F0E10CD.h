...
#define CLASS_1_0812913C2F0E10CD_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8529620)
#define CLASS_1_0812913C2F0E10CD_GET_CONSUMABLEINFO_OFFSET UNITYSDK_OFFSET(0x8529C40)
#define CLASS_1_0812913C2F0E10CD_METHOD_1_0C71B3D90959F4AF_OFFSET UNITYSDK_OFFSET(0x8529750)
#define CLASS_1_0812913C2F0E10CD_METHOD_1_0CF31CF921E2FE82_OFFSET UNITYSDK_OFFSET(0x85297A0)
#define CLASS_1_0812913C2F0E10CD_METHOD_1_396F46901992D11C_OFFSET UNITYSDK_OFFSET(0x8529A80)
#define CLASS_1_0812913C2F0E10CD_METHOD_1_5B29DA456999EE50_OFFSET UNITYSDK_OFFSET(0x8529BE0)
#define CLASS_1_0812913C2F0E10CD_METHOD_1_7FCBDBDAB52F7048_OFFSET UNITYSDK_OFFSET(0x8529890)
#define CLASS_1_0812913C2F0E10CD_METHOD_1_A971EFFD33514A78_OFFSET UNITYSDK_OFFSET(0x8529A20)
#define CLASS_1_0812913C2F0E10CD_METHOD_1_B5429DC31A682ECD_OFFSET UNITYSDK_OFFSET(0x8529940)
#define CLASS_1_0812913C2F0E10CD_METHOD_1_DBB501E5ACF0CA39_1_OFFSET UNITYSDK_OFFSET(0x85296E0)
#define CLASS_1_0812913C2F0E10CD_METHOD_1_DBB501E5ACF0CA39_OFFSET UNITYSDK_OFFSET(0x8529670)
#define CLASS_1_0812913C2F0E10CD_METHOD_1_E892861EE594315C_OFFSET UNITYSDK_OFFSET(0x8529B60)
#define CLASS_1_0812913C2F0E10CD__CTOR_OFFSET UNITYSDK_OFFSET(0x8529600)

inline static constexpr unsigned int Class_1_0812913C2F0E10CD_TypeDefinitionIndex = 51910;

class Class_1_0812913C2F0E10CD : public ::System::Object
{
public:
	::RPG::Client::GridFightPlayer* Field_1_2; // 0x10
	::System::Action_2<::System::Object*, ::System::Collections::Specialized::NotifyCollectionChangedEventArgs*>* Field_1_4; // 0x18
	...
	::RPG::Client::GridFightRole* Method_1_7FCBDBDAB52F7048(::System::UInt32 a1)
	{
		return ((::RPG::Client::GridFightRole*(*)(::PVOID, ::System::UInt32))((::PBYTE)hIl2Cpp + CLASS_1_0812913C2F0E10CD_METHOD_1_7FCBDBDAB52F7048_OFFSET))(this, a1);
	}
