...
#define CLASS_2_6F5D1B064142CE66_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11180010)
#define CLASS_2_6F5D1B064142CE66_METHOD_2_08A500CCFA7B1882_OFFSET UNITYSDK_OFFSET(0x11180670)
#define CLASS_2_6F5D1B064142CE66_METHOD_2_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x11180740)
#define CLASS_2_6F5D1B064142CE66_METHOD_2_AC7CD4175E0A3EF8_OFFSET UNITYSDK_OFFSET(0x11180390)
#define CLASS_2_6F5D1B064142CE66_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11180100)
#define CLASS_2_6F5D1B064142CE66_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x111804E0)
#define CLASS_2_6F5D1B064142CE66_TICK_OFFSET UNITYSDK_OFFSET(0x111805B0)
#define CLASS_2_6F5D1B064142CE66__CTOR_OFFSET UNITYSDK_OFFSET(0x1117FC00)
...
{
public:
	::Class_2_3F4D673D3F90D12C* Field_2_8; // 0x18
	::RPG::GameCore::NPCComponent* Field_2_5; // 0x20
	::RPG::GameCore::AdvNPCGoback* Field_2_0; // 0x28
	::Class_2_469A56953483CA0D* Field_2_6; // 0x30
	::RPG::GameCore::AdventureCharacterController* Field_2_4; // 0x38
	::Class_1_69FF5DE516C87A66* Field_2_3; // 0x40
	::Class_1_69FF5DE516C87A66* Field_2_2; // 0x48
	::RPG::GameCore::TaskContext* Field_2_1; // 0x50
	::Class_2_A0580152EB393340* Field_2_7; // 0x58
