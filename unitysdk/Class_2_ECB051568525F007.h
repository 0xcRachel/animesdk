...
#define CLASS_2_ECB051568525F007_METHOD_2_55B50F0EBC3528C6_OFFSET UNITYSDK_OFFSET(0x920B080)
#define CLASS_2_ECB051568525F007__CTOR_OFFSET UNITYSDK_OFFSET(0x920AF60)

inline static constexpr unsigned int Class_2_ECB051568525F007_TypeDefinitionIndex = 43975;

class Class_2_ECB051568525F007 : public ::Class_1_7E61104234A02BD7
{
public:
	::Class_1_2CAAA2FDF9170110* Field_2_8; // 0x48
	::RPG::GameCore::FloatCurve* Field_2_5; // 0x50
	::RPG::GameCore::FloatCurve* Field_2_6; // 0x58
	::RPG::GameCore::FloatCurve* Field_2_4; // 0x60
	::System::Single Field_2_1; // 0x68
	::System::Single Field_2_0; // 0x6C
