...
#define CLASS_1_E7979366C02BFBA4_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19B4D220)
#define CLASS_1_E7979366C02BFBA4_CLONE_OFFSET UNITYSDK_OFFSET(0x19B4CCC0)
#define CLASS_1_E7979366C02BFBA4_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19B4CD90)
#define CLASS_1_E7979366C02BFBA4_EQUALS_OFFSET UNITYSDK_OFFSET(0x19B4CD30)
#define CLASS_1_E7979366C02BFBA4_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19B4CFA0)
#define CLASS_1_E7979366C02BFBA4_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19B4D620)
#define CLASS_1_E7979366C02BFBA4_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19B4D370)
#define CLASS_1_E7979366C02BFBA4_METHOD_1_2ACF2A61FB239D23_OFFSET UNITYSDK_OFFSET(0x19B4CD10)
#define CLASS_1_E7979366C02BFBA4_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19B4C9E0)
#define CLASS_1_E7979366C02BFBA4_METHOD_1_358A144584A5DBFC_1_OFFSET UNITYSDK_OFFSET(0x19B4CC40)
#define CLASS_1_E7979366C02BFBA4_METHOD_1_358A144584A5DBFC_OFFSET UNITYSDK_OFFSET(0x19B4CBC0)
#define CLASS_1_E7979366C02BFBA4_METHOD_1_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x19B4CD20)
#define CLASS_1_E7979366C02BFBA4_METHOD_1_8C8625211DA811AE_1_OFFSET UNITYSDK_OFFSET(0x19B4CCA0)
#define CLASS_1_E7979366C02BFBA4_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x19B4CC20)
#define CLASS_1_E7979366C02BFBA4_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19B4CA40)
#define CLASS_1_E7979366C02BFBA4_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19B4D0C0)
#define CLASS_1_E7979366C02BFBA4_WRITETO_OFFSET UNITYSDK_OFFSET(0x19B4D120)
#define CLASS_1_E7979366C02BFBA4__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B4D840)
#define CLASS_1_E7979366C02BFBA4__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19B4CA60)
#define CLASS_1_E7979366C02BFBA4__CTOR_OFFSET UNITYSDK_OFFSET(0x19B4CA50)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_E7979366C02BFBA4*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E7979366C02BFBA4_TypeDefinitionIndex)->GetStaticField(0x287A0);
	}
