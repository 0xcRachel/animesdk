...
#define CLASS_1_B224D8D429173940_GET_FACEID_OFFSET UNITYSDK_OFFSET(0x101049A0)
#define CLASS_1_B224D8D429173940_GET_FOGOFWARCONFIG_OFFSET UNITYSDK_OFFSET(0x10104A80)
#define CLASS_1_B224D8D429173940_GET_ISSHOWEMPTYMAP_OFFSET UNITYSDK_OFFSET(0x10104A40)
#define CLASS_1_B224D8D429173940_GET_PATH_OFFSET UNITYSDK_OFFSET(0x101049E0)
#define CLASS_1_B224D8D429173940_GET_SHOWLEVELVARNAME_OFFSET UNITYSDK_OFFSET(0x10104A00)
#define CLASS_1_B224D8D429173940_GET_SHOWLEVELVARVALUES_OFFSET UNITYSDK_OFFSET(0x10104A20)
#define CLASS_1_B224D8D429173940_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x101049C0)
#define CLASS_1_B224D8D429173940_GET_SURFACELIST_OFFSET UNITYSDK_OFFSET(0x10104A60)
#define CLASS_1_B224D8D429173940_METHOD_1_3BB10D8AFBD077A1_OFFSET UNITYSDK_OFFSET(0x10104690)
#define CLASS_1_B224D8D429173940_METHOD_1_87C596CDD22516C5_OFFSET UNITYSDK_OFFSET(0x10104900)
#define CLASS_1_B224D8D429173940_METHOD_1_8E6F790317C6F21C_OFFSET UNITYSDK_OFFSET(0x10104190)
#define CLASS_1_B224D8D429173940_METHOD_1_C8FAB59C3EE3846E_OFFSET UNITYSDK_OFFSET(0x10104AA0)
#define CLASS_1_B224D8D429173940_METHOD_1_F0B313FE8ADD51CF_OFFSET UNITYSDK_OFFSET(0x10104600)
#define CLASS_1_B224D8D429173940_METHOD_1_F72BBD82B554E5AA_OFFSET UNITYSDK_OFFSET(0x10104420)
#define CLASS_1_B224D8D429173940_SET_FACEID_OFFSET UNITYSDK_OFFSET(0x101049B0)
#define CLASS_1_B224D8D429173940_SET_FOGOFWARCONFIG_OFFSET UNITYSDK_OFFSET(0x10104A90)
#define CLASS_1_B224D8D429173940_SET_ISSHOWEMPTYMAP_OFFSET UNITYSDK_OFFSET(0x10104A50)
#define CLASS_1_B224D8D429173940_SET_PATH_OFFSET UNITYSDK_OFFSET(0x101049F0)
#define CLASS_1_B224D8D429173940_SET_SHOWLEVELVARNAME_OFFSET UNITYSDK_OFFSET(0x10104A10)
#define CLASS_1_B224D8D429173940_SET_SHOWLEVELVARVALUES_OFFSET UNITYSDK_OFFSET(0x10104A30)
#define CLASS_1_B224D8D429173940_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x101049D0)
#define CLASS_1_B224D8D429173940_SET_SURFACELIST_OFFSET UNITYSDK_OFFSET(0x10104A70)
#define CLASS_1_B224D8D429173940__CTOR_OFFSET UNITYSDK_OFFSET(0x10104410)

inline static constexpr unsigned int Class_1_B224D8D429173940_TypeDefinitionIndex = 68895;

class Class_1_B224D8D429173940 : public ::System::Object
{
public:
	::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_1072*>* _SurfaceList_k__BackingField; // 0x10
	::Class_1_A7A4B83BB51BED0E* _FogOfWarConfig_k__BackingField; // 0x18
	::System::String* _Path_k__BackingField; // 0x20
	::System::String* _ShowLevelVarName_k__BackingField; // 0x28
	::Il2CppArray<::System::Int16>* _ShowLevelVarValues_k__BackingField; // 0x30
