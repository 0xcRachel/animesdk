...
#define AKOBJECTINFO_CLEAR_OFFSET UNITYSDK_OFFSET(0x183B1290)
#define AKOBJECTINFO_CLONE_OFFSET UNITYSDK_OFFSET(0x183B13F0)
#define AKOBJECTINFO_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x183B0CA0)
#define AKOBJECTINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0x183B0BB0)
#define AKOBJECTINFO_FINALIZE_OFFSET UNITYSDK_OFFSET(0x183B0C30)
#define AKOBJECTINFO_GETCPTR_OFFSET UNITYSDK_OFFSET(0x183B0AA0)
#define AKOBJECTINFO_GETSIZEOF_OFFSET UNITYSDK_OFFSET(0x183B1340)
#define AKOBJECTINFO_GET_IDEPTH_OFFSET UNITYSDK_OFFSET(0x183B11E0)
#define AKOBJECTINFO_GET_OBJID_OFFSET UNITYSDK_OFFSET(0x183B0F00)
#define AKOBJECTINFO_GET_PARENTID_OFFSET UNITYSDK_OFFSET(0x183B1070)
#define AKOBJECTINFO_SETCPTR_OFFSET UNITYSDK_OFFSET(0x183B0AF0)
#define AKOBJECTINFO_SET_IDEPTH_OFFSET UNITYSDK_OFFSET(0x183B1120)
#define AKOBJECTINFO_SET_OBJID_OFFSET UNITYSDK_OFFSET(0x183B0E40)
#define AKOBJECTINFO_SET_PARENTID_OFFSET UNITYSDK_OFFSET(0x183B0FB0)
#define AKOBJECTINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x183B1510)
#define AKOBJECTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x183B0A90)

inline static constexpr unsigned int AkObjectInfo_TypeDefinitionIndex = 33517;
