...
#define CLASS_2_9A5A56983985339D_GET_DRAGDELTARATIO_OFFSET UNITYSDK_OFFSET(0x16FAF270)
#define CLASS_2_9A5A56983985339D_GET_GAMEPADDRAGSPEED_OFFSET UNITYSDK_OFFSET(0x16FAF280)
#define CLASS_2_9A5A56983985339D_METHOD_2_2607E225A39E6739_OFFSET UNITYSDK_OFFSET(0x16FAF290)
#define CLASS_2_9A5A56983985339D_METHOD_2_6A44D992A1239C6A_OFFSET UNITYSDK_OFFSET(0x16FAF2A0)
#define CLASS_2_9A5A56983985339D_METHOD_2_84B92802FDAFF6C8_OFFSET UNITYSDK_OFFSET(0x16FAF5F0)
#define CLASS_2_9A5A56983985339D_METHOD_2_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x16FAF850)
#define CLASS_2_9A5A56983985339D_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x16FAF5B0)
#define CLASS_2_9A5A56983985339D_METHOD_2_CA6BDDCC5F7CE11E_OFFSET UNITYSDK_OFFSET(0x16FAF4D0)
#define CLASS_2_9A5A56983985339D_ONDRAG_OFFSET UNITYSDK_OFFSET(0x16FAF550)
#define CLASS_2_9A5A56983985339D__CTOR_OFFSET UNITYSDK_OFFSET(0x16FAF320)

inline static constexpr unsigned int Class_2_9A5A56983985339D_TypeDefinitionIndex = 72545;

class Class_2_9A5A56983985339D : public ::Class_1_9CE416D6C625B711
{
public:
	::System::Single Field_2_0; // 0x28
	::System::Single _GamepadDragSpeed_k__BackingField; // 0x2C
