...
#define CLASS_3_21CAE020DCE843C2_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x103DD870)
#define CLASS_3_21CAE020DCE843C2_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x103DD8C0)
#define CLASS_3_21CAE020DCE843C2_TICK_OFFSET UNITYSDK_OFFSET(0x103DD910)
#define CLASS_3_21CAE020DCE843C2__CTOR_OFFSET UNITYSDK_OFFSET(0x103DD7F0)
#define CLASS_3_21CAE020DCE843C2___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x103DD9A0)

inline static constexpr unsigned int Class_3_21CAE020DCE843C2_TypeDefinitionIndex = 41107;
...
public:
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + CLASS_3_21CAE020DCE843C2___IFIXBASEPROXY_TICK_OFFSET))(this, P0);
	}
};
