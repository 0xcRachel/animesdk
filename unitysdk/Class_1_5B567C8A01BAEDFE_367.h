...
#define CLASS_1_5B567C8A01BAEDFE_367_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A0B8180)
#define CLASS_1_5B567C8A01BAEDFE_367_CLONE_OFFSET UNITYSDK_OFFSET(0x1A0B7F90)
#define CLASS_1_5B567C8A01BAEDFE_367_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A0B8090)
#define CLASS_1_5B567C8A01BAEDFE_367_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A0B8000)
#define CLASS_1_5B567C8A01BAEDFE_367_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A0B80E0)
#define CLASS_1_5B567C8A01BAEDFE_367_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A0B81D0)
#define CLASS_1_5B567C8A01BAEDFE_367_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A0B81A0)
#define CLASS_1_5B567C8A01BAEDFE_367_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A0B7EE0)
#define CLASS_1_5B567C8A01BAEDFE_367_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A0B7F40)
#define CLASS_1_5B567C8A01BAEDFE_367_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A0B8110)
#define CLASS_1_5B567C8A01BAEDFE_367_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A0B8170)
#define CLASS_1_5B567C8A01BAEDFE_367__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A0B8220)
#define CLASS_1_5B567C8A01BAEDFE_367__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0B7F60)
#define CLASS_1_5B567C8A01BAEDFE_367__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0B7F50)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_367*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_367_TypeDefinitionIndex)->GetStaticField(0xF720);
	}
