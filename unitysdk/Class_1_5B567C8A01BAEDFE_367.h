...
#define CLASS_1_5B567C8A01BAEDFE_367_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A010820)
#define CLASS_1_5B567C8A01BAEDFE_367_CLONE_OFFSET UNITYSDK_OFFSET(0x1A010630)
#define CLASS_1_5B567C8A01BAEDFE_367_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A010730)
#define CLASS_1_5B567C8A01BAEDFE_367_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A0106A0)
#define CLASS_1_5B567C8A01BAEDFE_367_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A010780)
#define CLASS_1_5B567C8A01BAEDFE_367_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A010870)
#define CLASS_1_5B567C8A01BAEDFE_367_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A010840)
#define CLASS_1_5B567C8A01BAEDFE_367_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A010580)
#define CLASS_1_5B567C8A01BAEDFE_367_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A0105E0)
#define CLASS_1_5B567C8A01BAEDFE_367_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A0107B0)
#define CLASS_1_5B567C8A01BAEDFE_367_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A010810)
#define CLASS_1_5B567C8A01BAEDFE_367__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A0108C0)
#define CLASS_1_5B567C8A01BAEDFE_367__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A010600)
#define CLASS_1_5B567C8A01BAEDFE_367__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0105F0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_367*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_367_TypeDefinitionIndex)->GetStaticField(0x40DC0);
	}
