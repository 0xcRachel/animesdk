...
#define SUPERSCROLLVIEW_ITEMINDEXDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA6E89B0)

namespace SuperScrollView
{
	inline static constexpr unsigned int ItemIndexData_TypeDefinitionIndex = 37571;
