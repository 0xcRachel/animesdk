...
#define SUPERSCROLLVIEW_STAGGEREDGRIDITEMPREFABCONFDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA729540)

namespace SuperScrollView
{
	inline static constexpr unsigned int StaggeredGridItemPrefabConfData_TypeDefinitionIndex = 37569;
