...
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_ITEMRANGEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA6FFD30)

namespace SuperScrollView
{
	inline static constexpr unsigned int LoopGridView_ItemRangeData_TypeDefinitionIndex = 37553;

	class LoopGridView_ItemRangeData : public ::System::Object
	{
	public:
		::UnityEngine::Vector2 mCheckedPosition; // 0x10
		::System::Int32 mMaxColumn; // 0x18
