...
#define CLASS_2_3C52CBA38EA0D0A3_CLEAR_OFFSET UNITYSDK_OFFSET(0x1205C030)
#define CLASS_2_3C52CBA38EA0D0A3_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1205C0F0)
#define CLASS_2_3C52CBA38EA0D0A3_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1205C0A0)
#define CLASS_2_3C52CBA38EA0D0A3_METHOD_2_B7A27F8F43AB5662_OFFSET UNITYSDK_OFFSET(0x1205BFC0)
#define CLASS_2_3C52CBA38EA0D0A3__CTOR_OFFSET UNITYSDK_OFFSET(0x1205C140)
#define CLASS_2_3C52CBA38EA0D0A3___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0x1205C150)
