...
#define CLASS_2_4436360A3A829112_DISPOSE_OFFSET UNITYSDK_OFFSET(0x109F4820)
#define CLASS_2_4436360A3A829112_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x109F48E0)
#define CLASS_2_4436360A3A829112_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x109F49C0)
#define CLASS_2_4436360A3A829112_TICK_OFFSET UNITYSDK_OFFSET(0x109F4AA0)
#define CLASS_2_4436360A3A829112__CTOR_OFFSET UNITYSDK_OFFSET(0x109F45A0)

inline static constexpr unsigned int Class_2_4436360A3A829112_TypeDefinitionIndex = 41453;

class Class_2_4436360A3A829112 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::Class_2_6BFAFA494F2D1E4B* Field_2_1; // 0x18
	::Class_1_5F51D4049EA87B7B* Field_2_3; // 0x20
	::RPG::GameCore::AdvRunStateTree* Field_2_0; // 0x28
	::Class_2_E2910CE9CBBA0DE5* Field_2_2; // 0x30
