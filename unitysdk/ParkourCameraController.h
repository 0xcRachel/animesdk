...
#define PARKOURCAMERACONTROLLER_MANUALEND_OFFSET UNITYSDK_OFFSET(0x8A86080)
#define PARKOURCAMERACONTROLLER_MANUALSTART_OFFSET UNITYSDK_OFFSET(0x8A85DE0)
#define PARKOURCAMERACONTROLLER_MANUALUPDATE_OFFSET UNITYSDK_OFFSET(0x8A860D0)
#define PARKOURCAMERACONTROLLER_METHOD_5_6226389E87D2F955_OFFSET UNITYSDK_OFFSET(0x8A86180)
#define PARKOURCAMERACONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8A86560)

inline static constexpr unsigned int ParkourCameraController_TypeDefinitionIndex = 37213;
