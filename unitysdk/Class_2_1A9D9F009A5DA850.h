...
#define CLASS_2_1A9D9F009A5DA850_DISPOSE_OFFSET UNITYSDK_OFFSET(0x109F3A10)
#define CLASS_2_1A9D9F009A5DA850_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x109F3A50)
#define CLASS_2_1A9D9F009A5DA850_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x109F3AD0)
#define CLASS_2_1A9D9F009A5DA850_TICK_OFFSET UNITYSDK_OFFSET(0x109F3B10)
#define CLASS_2_1A9D9F009A5DA850__CTOR_OFFSET UNITYSDK_OFFSET(0x109F3A00)

inline static constexpr unsigned int Class_2_1A9D9F009A5DA850_TypeDefinitionIndex = 45884;
