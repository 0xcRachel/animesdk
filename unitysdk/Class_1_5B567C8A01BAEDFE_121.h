...
#define CLASS_1_5B567C8A01BAEDFE_121_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A1E7DE0)
#define CLASS_1_5B567C8A01BAEDFE_121_CLONE_OFFSET UNITYSDK_OFFSET(0x1A1E7C50)
#define CLASS_1_5B567C8A01BAEDFE_121_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A1E7CF0)
#define CLASS_1_5B567C8A01BAEDFE_121_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A1E7C90)
#define CLASS_1_5B567C8A01BAEDFE_121_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A1E7D40)
#define CLASS_1_5B567C8A01BAEDFE_121_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A1E7E30)
#define CLASS_1_5B567C8A01BAEDFE_121_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A1E7E00)
#define CLASS_1_5B567C8A01BAEDFE_121_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A1E7BD0)
#define CLASS_1_5B567C8A01BAEDFE_121_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A1E7C00)
#define CLASS_1_5B567C8A01BAEDFE_121_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A1E7D70)
#define CLASS_1_5B567C8A01BAEDFE_121_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A1E7DD0)
#define CLASS_1_5B567C8A01BAEDFE_121__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1E7E80)
#define CLASS_1_5B567C8A01BAEDFE_121__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A1E7C20)
#define CLASS_1_5B567C8A01BAEDFE_121__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1E7C10)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_121*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_121_TypeDefinitionIndex)->GetStaticField(0x11B00);
	}
