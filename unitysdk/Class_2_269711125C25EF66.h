...
#define CLASS_2_269711125C25EF66_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11982570)
#define CLASS_2_269711125C25EF66_GET_CURRENTSKILLSUBTARGETLIST_OFFSET UNITYSDK_OFFSET(0x11982BA0)
#define CLASS_2_269711125C25EF66_GET_CURRENTSKILLTARGETLIST_OFFSET UNITYSDK_OFFSET(0x11982B90)
#define CLASS_2_269711125C25EF66_GET_SKILLACTUALATTACKER_OFFSET UNITYSDK_OFFSET(0x11982BD0)
#define CLASS_2_269711125C25EF66_GET_SKILLPOINTENTITY_OFFSET UNITYSDK_OFFSET(0x11982BB0)
#define CLASS_2_269711125C25EF66_METHOD_2_073EE5AA44CF85E2_OFFSET UNITYSDK_OFFSET(0x11981F50)
#define CLASS_2_269711125C25EF66_METHOD_2_27FE160831643A26_OFFSET UNITYSDK_OFFSET(0x11982C00)
#define CLASS_2_269711125C25EF66_METHOD_2_5012DEB7320C101A_OFFSET UNITYSDK_OFFSET(0x119825F0)
#define CLASS_2_269711125C25EF66_METHOD_2_5D0E5E1D16E3CA12_OFFSET UNITYSDK_OFFSET(0x11982A20)
#define CLASS_2_269711125C25EF66_METHOD_2_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x11982B50)
#define CLASS_2_269711125C25EF66_METHOD_2_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0x119829A0)
#define CLASS_2_269711125C25EF66_METHOD_2_A3B36CD562D22DD5_OFFSET UNITYSDK_OFFSET(0x11981FF0)
#define CLASS_2_269711125C25EF66_METHOD_2_B1445E8504415D4D_OFFSET UNITYSDK_OFFSET(0x11982BF0)
#define CLASS_2_269711125C25EF66_METHOD_2_DA690F4E562414B2_OFFSET UNITYSDK_OFFSET(0x11982690)
#define CLASS_2_269711125C25EF66_SET_SKILLACTUALATTACKER_OFFSET UNITYSDK_OFFSET(0x11982BE0)
#define CLASS_2_269711125C25EF66_SET_SKILLPOINTENTITY_OFFSET UNITYSDK_OFFSET(0x11982BC0)
#define CLASS_2_269711125C25EF66__CTOR_OFFSET UNITYSDK_OFFSET(0x11982C10)
...
public:
	...
	::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* _CurrentSkillSubTargetList_k__BackingField; // 0x20
	::RPG::GameCore::ChessCharacterConfig* Field_2_7; // 0x28
	::Class_2_EA46C5F9F8D34AB4* Field_2_6; // 0x30
	::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>* Field_2_9; // 0x38
	::RPG::GameCore::TaskContext* Field_2_0; // 0x40
	::RPG::GameCore::GameEntity* _SkillActualAttacker_k__BackingField; // 0x48
	::System::Collections::Generic::List_1<::Class_1_778FF519F0E154E3*>* Field_2_8; // 0x50
	::RPG::GameCore::GameEntity* Field_2_5; // 0x58
