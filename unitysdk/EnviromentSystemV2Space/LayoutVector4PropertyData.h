...
#define ENVIROMENTSYSTEMV2SPACE_LAYOUTVECTOR4PROPERTYDATA_METHOD_4_528BD4865C714C5C_OFFSET UNITYSDK_OFFSET(0xE510340)
#define ENVIROMENTSYSTEMV2SPACE_LAYOUTVECTOR4PROPERTYDATA_METHOD_4_F2B94768004EB1C1_OFFSET UNITYSDK_OFFSET(0xE510260)
#define ENVIROMENTSYSTEMV2SPACE_LAYOUTVECTOR4PROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xE510330)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int LayoutVector4PropertyData_TypeDefinitionIndex = 39078;
	...
	public:
		...
		{
			return ((::Class_1_EAF7984A8FAD6BE4*(*)(::PVOID))((::PBYTE)hIl2Cpp + ENVIROMENTSYSTEMV2SPACE_LAYOUTVECTOR4PROPERTYDATA_METHOD_4_528BD4865C714C5C_OFFSET))(this);
		}
	};
}
