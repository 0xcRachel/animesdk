...
#define ENVIROMENTSYSTEMV2SPACE_TEXTCURVEPROPERTYDATA_METHOD_3_080F02908C048D30_OFFSET UNITYSDK_OFFSET(0xEE9DAC0)
#define ENVIROMENTSYSTEMV2SPACE_TEXTCURVEPROPERTYDATA_METHOD_3_87C0E26F1D61379E_OFFSET UNITYSDK_OFFSET(0xEE9DA50)
#define ENVIROMENTSYSTEMV2SPACE_TEXTCURVEPROPERTYDATA_METHOD_3_BD4FC714E5BBCF11_OFFSET UNITYSDK_OFFSET(0xEE9DD00)
#define ENVIROMENTSYSTEMV2SPACE_TEXTCURVEPROPERTYDATA_METHOD_3_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0xEE9DD50)
#define ENVIROMENTSYSTEMV2SPACE_TEXTCURVEPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xEE9DCF0)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int TextCurvePropertyData_TypeDefinitionIndex = 39107;
