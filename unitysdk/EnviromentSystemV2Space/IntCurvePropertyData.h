...
#define ENVIROMENTSYSTEMV2SPACE_INTCURVEPROPERTYDATA_METHOD_2_526FB29047B22B50_OFFSET UNITYSDK_OFFSET(0x1257C850)
#define ENVIROMENTSYSTEMV2SPACE_INTCURVEPROPERTYDATA_METHOD_2_87C0E26F1D61379E_OFFSET UNITYSDK_OFFSET(0x1257C7E0)
#define ENVIROMENTSYSTEMV2SPACE_INTCURVEPROPERTYDATA_METHOD_2_BD4FC714E5BBCF11_OFFSET UNITYSDK_OFFSET(0x1257C990)
#define ENVIROMENTSYSTEMV2SPACE_INTCURVEPROPERTYDATA_METHOD_2_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0x1257C9E0)
#define ENVIROMENTSYSTEMV2SPACE_INTCURVEPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1257C980)
