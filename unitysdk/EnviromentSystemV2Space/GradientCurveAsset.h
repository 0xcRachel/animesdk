...
#define ENVIROMENTSYSTEMV2SPACE_GRADIENTCURVEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0xE50D680)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int GradientCurveAsset_TypeDefinitionIndex = 39189;
