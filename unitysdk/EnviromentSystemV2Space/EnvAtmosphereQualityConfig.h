...
#define ENVIROMENTSYSTEMV2SPACE_ENVATMOSPHEREQUALITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xE4F6A00)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int EnvAtmosphereQualityConfig_TypeDefinitionIndex = 39006;
