...
#define ENVIROMENTSYSTEMV2SPACE_ENVRESOURCECURVEPROPERTYDATA_METHOD_3_1A1283E6D869BB8A_OFFSET UNITYSDK_OFFSET(0x1391CC20)
#define ENVIROMENTSYSTEMV2SPACE_ENVRESOURCECURVEPROPERTYDATA_METHOD_3_2FE5140487F63CFB_OFFSET UNITYSDK_OFFSET(0x1391CE70)
#define ENVIROMENTSYSTEMV2SPACE_ENVRESOURCECURVEPROPERTYDATA_METHOD_3_7BFF527DB4C449CA_OFFSET UNITYSDK_OFFSET(0x1391CE80)
#define ENVIROMENTSYSTEMV2SPACE_ENVRESOURCECURVEPROPERTYDATA_METHOD_3_A034FB093FB7C7DD_OFFSET UNITYSDK_OFFSET(0x1391CD30)
#define ENVIROMENTSYSTEMV2SPACE_ENVRESOURCECURVEPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1391CE50)
