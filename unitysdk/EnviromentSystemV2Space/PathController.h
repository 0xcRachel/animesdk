...
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_ADDPOINT_OFFSET UNITYSDK_OFFSET(0xE5112A0)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_GETCURRENTDISTANCE_OFFSET UNITYSDK_OFFSET(0xE511210)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_GETCURRENTPERCENTAGE_OFFSET UNITYSDK_OFFSET(0xE5111C0)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_GETCURRENTSEGMENTINDEX_OFFSET UNITYSDK_OFFSET(0xE511260)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_METHOD_5_64193BDBED1866DF_OFFSET UNITYSDK_OFFSET(0xE510D60)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_METHOD_5_7E832D0C2C340C33_OFFSET UNITYSDK_OFFSET(0xE5109E0)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_METHOD_5_98AC2CF495AAE24C_OFFSET UNITYSDK_OFFSET(0xE510AC0)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_METHOD_5_AFE7065CF0B70674_OFFSET UNITYSDK_OFFSET(0xE510FF0)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_METHOD_5_C6159FCF4A6D407A_OFFSET UNITYSDK_OFFSET(0xE5105D0)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_METHOD_5_F4F1E7D1CC26024A_OFFSET UNITYSDK_OFFSET(0xE510760)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xE5108F0)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xE510710)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xE5103B0)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_REMOVEPOINT_OFFSET UNITYSDK_OFFSET(0xE511330)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0xE510580)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xE510940)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xE5113B0)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int PathController_TypeDefinitionIndex = 39261;
	...
	public:
		...
		::System::Void Method_5_F4F1E7D1CC26024A(::System::Boolean a1)
		{
			return ((::System::Void(*)(::PVOID, ::System::Boolean))((::PBYTE)hIl2Cpp + ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_METHOD_5_F4F1E7D1CC26024A_OFFSET))(this, a1);
		}
