...
#define ENVIROMENTSYSTEMV2SPACE_FLOATCURVEPROPERTYDATA_METHOD_3_4F816AD42E79C1BC_OFFSET UNITYSDK_OFFSET(0x10381270)
#define ENVIROMENTSYSTEMV2SPACE_FLOATCURVEPROPERTYDATA_METHOD_3_CF780FC3D0CB1833_OFFSET UNITYSDK_OFFSET(0x10381170)
#define ENVIROMENTSYSTEMV2SPACE_FLOATCURVEPROPERTYDATA_METHOD_3_F04EA340514506C2_OFFSET UNITYSDK_OFFSET(0x10381280)
#define ENVIROMENTSYSTEMV2SPACE_FLOATCURVEPROPERTYDATA_METHOD_3_F6AE0F54C683F5CD_OFFSET UNITYSDK_OFFSET(0x10381090)
#define ENVIROMENTSYSTEMV2SPACE_FLOATCURVEPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x10381250)
