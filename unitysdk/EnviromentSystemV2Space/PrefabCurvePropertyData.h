...
#define ENVIROMENTSYSTEMV2SPACE_PREFABCURVEPROPERTYDATA_METHOD_4_35F88F8F0390DB9A_OFFSET UNITYSDK_OFFSET(0xE5114A0)
#define ENVIROMENTSYSTEMV2SPACE_PREFABCURVEPROPERTYDATA_METHOD_4_4F816AD42E79C1BC_OFFSET UNITYSDK_OFFSET(0xE511630)
#define ENVIROMENTSYSTEMV2SPACE_PREFABCURVEPROPERTYDATA_METHOD_4_9BADE3E301981C8B_OFFSET UNITYSDK_OFFSET(0xE511740)
#define ENVIROMENTSYSTEMV2SPACE_PREFABCURVEPROPERTYDATA_METHOD_4_E3DABABAFC459BA9_OFFSET UNITYSDK_OFFSET(0xE511450)
#define ENVIROMENTSYSTEMV2SPACE_PREFABCURVEPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xE511610)

namespace EnviromentSystemV2Space
{
	inline static constexpr unsigned int PrefabCurvePropertyData_TypeDefinitionIndex = 39106;
