...
#define ENVIROMENTSYSTEMV2SPACE_LLGKEYVALUEPAIRS_METHOD_2_CFABCDD7F1E57666_OFFSET UNITYSDK_OFFSET(0x1257D020)
#define ENVIROMENTSYSTEMV2SPACE_LLGKEYVALUEPAIRS_METHOD_2_EA7889976177D748_OFFSET UNITYSDK_OFFSET(0x1257CEC0)
#define ENVIROMENTSYSTEMV2SPACE_LLGKEYVALUEPAIRS_METHOD_2_FD979FE11778F9B5_1_OFFSET UNITYSDK_OFFSET(0x1257DA30)
#define ENVIROMENTSYSTEMV2SPACE_LLGKEYVALUEPAIRS_METHOD_2_FD979FE11778F9B5_OFFSET UNITYSDK_OFFSET(0x1257CF10)
#define ENVIROMENTSYSTEMV2SPACE_LLGKEYVALUEPAIRS_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1257CD60)
#define ENVIROMENTSYSTEMV2SPACE_LLGKEYVALUEPAIRS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1257CBE0)
#define ENVIROMENTSYSTEMV2SPACE_LLGKEYVALUEPAIRS__CTOR_OFFSET UNITYSDK_OFFSET(0x1257CBA0)
#define ENVIROMENTSYSTEMV2SPACE_LLGKEYVALUEPAIRS___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1257DB40)
