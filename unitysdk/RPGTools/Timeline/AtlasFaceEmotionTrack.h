...
#define RPGTOOLS_TIMELINE_ATLASFACEEMOTIONTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xA5EA020)
#define RPGTOOLS_TIMELINE_ATLASFACEEMOTIONTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xA5EA120)
#define RPGTOOLS_TIMELINE_ATLASFACEEMOTIONTRACK___IFIXBASEPROXY_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xA5EA130)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int AtlasFaceEmotionTrack_TypeDefinitionIndex = 37917;
