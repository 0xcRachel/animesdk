...
#define RPGTOOLS_TIMELINE_CHARACTERBODYCONTROLTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xA5FB890)
#define RPGTOOLS_TIMELINE_CHARACTERBODYCONTROLTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xA5FBA50)
#define RPGTOOLS_TIMELINE_CHARACTERBODYCONTROLTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xA5FBFD0)
#define RPGTOOLS_TIMELINE_CHARACTERBODYCONTROLTRACK___IFIXBASEPROXY_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xA5FC190)
#define RPGTOOLS_TIMELINE_CHARACTERBODYCONTROLTRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xA5FC1D0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterBodyControlTrack_TypeDefinitionIndex = 37831;
