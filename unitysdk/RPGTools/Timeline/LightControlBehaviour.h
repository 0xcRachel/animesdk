...
#define RPGTOOLS_TIMELINE_LIGHTCONTROLBEHAVIOUR_GET_ISCLOSECHARACTERSHADOW_OFFSET UNITYSDK_OFFSET(0x18C3D820)
#define RPGTOOLS_TIMELINE_LIGHTCONTROLBEHAVIOUR_METHOD_3_41F5D9C0F0A306F5_OFFSET UNITYSDK_OFFSET(0x18C3AB80)
#define RPGTOOLS_TIMELINE_LIGHTCONTROLBEHAVIOUR_METHOD_3_4D9E1AC61B60D577_OFFSET UNITYSDK_OFFSET(0x18C3B850)
#define RPGTOOLS_TIMELINE_LIGHTCONTROLBEHAVIOUR_METHOD_3_52607DE4C357D269_OFFSET UNITYSDK_OFFSET(0x18C3C890)
#define RPGTOOLS_TIMELINE_LIGHTCONTROLBEHAVIOUR_METHOD_3_7D21D8548943D577_OFFSET UNITYSDK_OFFSET(0x18C3C840)
#define RPGTOOLS_TIMELINE_LIGHTCONTROLBEHAVIOUR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x18C3A950)
#define RPGTOOLS_TIMELINE_LIGHTCONTROLBEHAVIOUR_METHOD_3_BB2928BEC244DEB7_OFFSET UNITYSDK_OFFSET(0x18C3D910)
#define RPGTOOLS_TIMELINE_LIGHTCONTROLBEHAVIOUR_METHOD_3_C982C8295D29DA97_OFFSET UNITYSDK_OFFSET(0x18C3D710)
#define RPGTOOLS_TIMELINE_LIGHTCONTROLBEHAVIOUR_METHOD_3_E727F9956B5BD78B_OFFSET UNITYSDK_OFFSET(0x18C3C6F0)
#define RPGTOOLS_TIMELINE_LIGHTCONTROLBEHAVIOUR_METHOD_3_F4DD08A31BA3F883_OFFSET UNITYSDK_OFFSET(0x18C3AAD0)
#define RPGTOOLS_TIMELINE_LIGHTCONTROLBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x18C3C760)
#define RPGTOOLS_TIMELINE_LIGHTCONTROLBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x18C3A8B0)
#define RPGTOOLS_TIMELINE_LIGHTCONTROLBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x18C3A9F0)
#define RPGTOOLS_TIMELINE_LIGHTCONTROLBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x18C3D840)
#define RPGTOOLS_TIMELINE_LIGHTCONTROLBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x18C3D900)
#define RPGTOOLS_TIMELINE_LIGHTCONTROLBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x18C3D8E0)
#define RPGTOOLS_TIMELINE_LIGHTCONTROLBEHAVIOUR___IFIXBASEPROXY_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x18C3D8F0)
...
namespace RPGTools::Timeline
{
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(LightControlBehaviour_TypeDefinitionIndex)->GetStaticField(0x45A0);
		}
