...
#define RPGTOOLS_TIMELINE_AUTOBLINKTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xA5ECEA0)
#define RPGTOOLS_TIMELINE_AUTOBLINKTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xA5ED080)
#define RPGTOOLS_TIMELINE_AUTOBLINKTRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xA5ED090)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int AutoBlinkTrack_TypeDefinitionIndex = 37762;
