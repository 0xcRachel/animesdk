...
#define RPGTOOLS_TIMELINE_QTEMISSIONCUSTOMVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0xA65CB40)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int QTEMissionCustomValue_TypeDefinitionIndex = 38127;
