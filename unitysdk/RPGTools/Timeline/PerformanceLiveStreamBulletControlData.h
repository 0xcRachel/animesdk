...
#define RPGTOOLS_TIMELINE_PERFORMANCELIVESTREAMBULLETCONTROLDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA644DF0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int PerformanceLiveStreamBulletControlData_TypeDefinitionIndex = 38035;
