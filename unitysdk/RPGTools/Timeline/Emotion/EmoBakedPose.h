...
#define RPGTOOLS_TIMELINE_EMOTION_EMOBAKEDPOSE__CTOR_OFFSET UNITYSDK_OFFSET(0xA61FD70)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int EmoBakedPose_TypeDefinitionIndex = 38543;
