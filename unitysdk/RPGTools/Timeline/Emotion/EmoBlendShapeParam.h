...
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xA621FC0)

namespace RPGTools::Timeline::Emotion
{
	inline static constexpr unsigned int EmoBlendShapeParam_TypeDefinitionIndex = 38533;
