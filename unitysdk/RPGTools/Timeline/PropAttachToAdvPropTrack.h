...
#define RPGTOOLS_TIMELINE_PROPATTACHTOADVPROPTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xA65B150)
#define RPGTOOLS_TIMELINE_PROPATTACHTOADVPROPTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xA65B290)
#define RPGTOOLS_TIMELINE_PROPATTACHTOADVPROPTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xA65B300)
#define RPGTOOLS_TIMELINE_PROPATTACHTOADVPROPTRACK___IFIXBASEPROXY_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xA65B310)
#define RPGTOOLS_TIMELINE_PROPATTACHTOADVPROPTRACK___IFIXBASEPROXY_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xA65B350)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int PropAttachToAdvPropTrack_TypeDefinitionIndex = 38104;
