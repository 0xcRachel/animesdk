...
#define RPGTOOLS_TIMELINE_NPCPOSSESSIONTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xA642D70)
#define RPGTOOLS_TIMELINE_NPCPOSSESSIONTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xA642E80)
#define RPGTOOLS_TIMELINE_NPCPOSSESSIONTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xA642EF0)
#define RPGTOOLS_TIMELINE_NPCPOSSESSIONTRACK___IFIXBASEPROXY_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xA642F10)
#define RPGTOOLS_TIMELINE_NPCPOSSESSIONTRACK___IFIXBASEPROXY_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xA642F50)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int NpcPossessionTrack_TypeDefinitionIndex = 38078;
