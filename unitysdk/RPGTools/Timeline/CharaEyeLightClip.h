...
#define RPGTOOLS_TIMELINE_CHARAEYELIGHTCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xA5FABF0)
#define RPGTOOLS_TIMELINE_CHARAEYELIGHTCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xA5FABE0)
#define RPGTOOLS_TIMELINE_CHARAEYELIGHTCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xA5FADF0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharaEyeLightClip_TypeDefinitionIndex = 37820;
