...
#define RPGTOOLS_TIMELINE_CRPCAMERATEMPLATETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x198C47A0)
#define RPGTOOLS_TIMELINE_CRPCAMERATEMPLATETRACK_METHOD_5_869969E7E2EDA429_OFFSET UNITYSDK_OFFSET(0x198C4980)
#define RPGTOOLS_TIMELINE_CRPCAMERATEMPLATETRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x198C4E70)
#define RPGTOOLS_TIMELINE_CRPCAMERATEMPLATETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x198C4EE0)
#define RPGTOOLS_TIMELINE_CRPCAMERATEMPLATETRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x198C4FC0)
#define RPGTOOLS_TIMELINE_CRPCAMERATEMPLATETRACK___IFIXBASEPROXY_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x198C5060)
