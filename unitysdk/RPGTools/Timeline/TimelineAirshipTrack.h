...
#define RPGTOOLS_TIMELINE_TIMELINEAIRSHIPTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xA674180)
#define RPGTOOLS_TIMELINE_TIMELINEAIRSHIPTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xA6743E0)
#define RPGTOOLS_TIMELINE_TIMELINEAIRSHIPTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xA674500)
#define RPGTOOLS_TIMELINE_TIMELINEAIRSHIPTRACK___IFIXBASEPROXY_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xA6745E0)
#define RPGTOOLS_TIMELINE_TIMELINEAIRSHIPTRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xA674620)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int TimelineAirshipTrack_TypeDefinitionIndex = 37747;
