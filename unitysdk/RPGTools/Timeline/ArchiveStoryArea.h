...
#define RPGTOOLS_TIMELINE_ARCHIVESTORYAREA_METHOD_4_35B1D6F5AD964588_OFFSET UNITYSDK_OFFSET(0xA5E9BB0)
#define RPGTOOLS_TIMELINE_ARCHIVESTORYAREA_METHOD_4_F8CFE1100A85137E_OFFSET UNITYSDK_OFFSET(0xA5E9AD0)
#define RPGTOOLS_TIMELINE_ARCHIVESTORYAREA__CTOR_OFFSET UNITYSDK_OFFSET(0xA5E9BA0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ArchiveStoryArea_TypeDefinitionIndex = 38328;
