...
#define RPGTOOLS_TIMELINE_ARCHIVESTORYAREA_METHOD_4_0E98210FFD41D920_OFFSET UNITYSDK_OFFSET(0x198B53A0)
#define RPGTOOLS_TIMELINE_ARCHIVESTORYAREA_METHOD_4_784C221F8D8DF4FC_OFFSET UNITYSDK_OFFSET(0x198B52C0)
#define RPGTOOLS_TIMELINE_ARCHIVESTORYAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x198B5390)
