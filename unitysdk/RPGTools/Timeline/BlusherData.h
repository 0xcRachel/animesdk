...
#define RPGTOOLS_TIMELINE_BLUSHERDATA_METHOD_1_0039B43FD4E0E048_OFFSET UNITYSDK_OFFSET(0xA5F33D0)
#define RPGTOOLS_TIMELINE_BLUSHERDATA_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xA5F2FB0)
#define RPGTOOLS_TIMELINE_BLUSHERDATA_METHOD_1_33796CF18653C823_OFFSET UNITYSDK_OFFSET(0xA5F3150)
#define RPGTOOLS_TIMELINE_BLUSHERDATA_METHOD_1_66C16B4A540CB1F6_OFFSET UNITYSDK_OFFSET(0xA5F34C0)
#define RPGTOOLS_TIMELINE_BLUSHERDATA_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA5F3300)
#define RPGTOOLS_TIMELINE_BLUSHERDATA_METHOD_1_E60BEBC26BA58440_OFFSET UNITYSDK_OFFSET(0xA5F3030)
#define RPGTOOLS_TIMELINE_BLUSHERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA5F3140)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int BlusherData_TypeDefinitionIndex = 37990;
