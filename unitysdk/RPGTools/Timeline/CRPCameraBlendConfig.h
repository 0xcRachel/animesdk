...
#define RPGTOOLS_TIMELINE_CRPCAMERABLENDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA5F4E00)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CRPCameraBlendConfig_TypeDefinitionIndex = 37780;
