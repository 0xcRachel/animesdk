...
#define RPGTOOLS_TIMELINE_ARCHIVELEVELBLOCK_METHOD_4_35B1D6F5AD964588_OFFSET UNITYSDK_OFFSET(0xA5E9A30)
#define RPGTOOLS_TIMELINE_ARCHIVELEVELBLOCK_METHOD_4_F8CFE1100A85137E_OFFSET UNITYSDK_OFFSET(0xA5E9920)
#define RPGTOOLS_TIMELINE_ARCHIVELEVELBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0xA5E9A20)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ArchiveLevelBlock_TypeDefinitionIndex = 38327;
