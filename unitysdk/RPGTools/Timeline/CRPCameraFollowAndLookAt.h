...
#define RPGTOOLS_TIMELINE_CRPCAMERAFOLLOWANDLOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0xA5F4FF0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CRPCameraFollowAndLookAt_TypeDefinitionIndex = 37779;
