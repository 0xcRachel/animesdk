...
#define RPGTOOLS_TIMELINE_SWITCHCHARACTERANCHORTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xA66F780)
#define RPGTOOLS_TIMELINE_SWITCHCHARACTERANCHORTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xA66F890)
#define RPGTOOLS_TIMELINE_SWITCHCHARACTERANCHORTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xA66FB40)
#define RPGTOOLS_TIMELINE_SWITCHCHARACTERANCHORTRACK___IFIXBASEPROXY_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xA66FB50)
#define RPGTOOLS_TIMELINE_SWITCHCHARACTERANCHORTRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xA66FB90)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int SwitchCharacterAnchorTrack_TypeDefinitionIndex = 38206;
