...
#define RPGTOOLS_TIMELINE_HIDELEVELSTAGEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xA632AD0)
#define RPGTOOLS_TIMELINE_HIDELEVELSTAGEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xA632D00)
#define RPGTOOLS_TIMELINE_HIDELEVELSTAGEBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xA632D10)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int HideLevelStageBehaviour_TypeDefinitionIndex = 38269;
