...
#define RPGTOOLS_TIMELINE_MESHSHOWHIDEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xA63E730)
#define RPGTOOLS_TIMELINE_MESHSHOWHIDEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xA63E9B0)
#define RPGTOOLS_TIMELINE_MESHSHOWHIDEBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xA63E9C0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int MeshShowHideBehaviour_TypeDefinitionIndex = 38050;
