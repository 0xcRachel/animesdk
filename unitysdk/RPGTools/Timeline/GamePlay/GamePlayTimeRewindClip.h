...
#define RPGTOOLS_TIMELINE_GAMEPLAY_GAMEPLAYTIMEREWINDCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x17E209A0)
#define RPGTOOLS_TIMELINE_GAMEPLAY_GAMEPLAYTIMEREWINDCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x17E20990)
#define RPGTOOLS_TIMELINE_GAMEPLAY_GAMEPLAYTIMEREWINDCLIP_GET_END_OFFSET UNITYSDK_OFFSET(0x17E20970)
#define RPGTOOLS_TIMELINE_GAMEPLAY_GAMEPLAYTIMEREWINDCLIP_SET_END_OFFSET UNITYSDK_OFFSET(0x17E20980)
#define RPGTOOLS_TIMELINE_GAMEPLAY_GAMEPLAYTIMEREWINDCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x17E20B90)
