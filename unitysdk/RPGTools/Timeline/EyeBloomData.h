...
#define RPGTOOLS_TIMELINE_EYEBLOOMDATA_METHOD_1_0545A2E78AEF671D_OFFSET UNITYSDK_OFFSET(0xA62EF50)
#define RPGTOOLS_TIMELINE_EYEBLOOMDATA_METHOD_1_06C6B0B16AF9B0B4_OFFSET UNITYSDK_OFFSET(0xA62EBC0)
#define RPGTOOLS_TIMELINE_EYEBLOOMDATA_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xA62EB60)
#define RPGTOOLS_TIMELINE_EYEBLOOMDATA_METHOD_1_741732AF4195334C_OFFSET UNITYSDK_OFFSET(0xA62EE40)
#define RPGTOOLS_TIMELINE_EYEBLOOMDATA_METHOD_1_865DD755B8787C08_OFFSET UNITYSDK_OFFSET(0xA62EC60)
#define RPGTOOLS_TIMELINE_EYEBLOOMDATA_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA62EDD0)
#define RPGTOOLS_TIMELINE_EYEBLOOMDATA_METHOD_1_DCE8D7B2E8135673_OFFSET UNITYSDK_OFFSET(0xA62F0E0)
#define RPGTOOLS_TIMELINE_EYEBLOOMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA62EC50)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int EyeBloomData_TypeDefinitionIndex = 37986;
