...
#define RPGTOOLS_TIMELINE_ARCHIVECHARACTER_GET_ENTITY_OFFSET UNITYSDK_OFFSET(0xA5E9770)
#define RPGTOOLS_TIMELINE_ARCHIVECHARACTER_GET_ISPLAYER_OFFSET UNITYSDK_OFFSET(0xA5E9700)
#define RPGTOOLS_TIMELINE_ARCHIVECHARACTER_METHOD_4_35B1D6F5AD964588_OFFSET UNITYSDK_OFFSET(0xA5E9880)
#define RPGTOOLS_TIMELINE_ARCHIVECHARACTER_METHOD_4_F8CFE1100A85137E_OFFSET UNITYSDK_OFFSET(0xA5E9790)
#define RPGTOOLS_TIMELINE_ARCHIVECHARACTER_SET_ENTITY_OFFSET UNITYSDK_OFFSET(0xA5E9780)
#define RPGTOOLS_TIMELINE_ARCHIVECHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0xA5E9860)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ArchiveCharacter_TypeDefinitionIndex = 38326;
