...
#define RPGTOOLS_TIMELINE_CHARACTEREYELOOKATBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xA5FD3A0)
#define RPGTOOLS_TIMELINE_CHARACTEREYELOOKATBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xA5FD710)
#define RPGTOOLS_TIMELINE_CHARACTEREYELOOKATBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xA5FD720)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterEyeLookAtBehaviour_TypeDefinitionIndex = 37859;
