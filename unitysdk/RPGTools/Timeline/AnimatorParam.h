...
#define RPGTOOLS_TIMELINE_ANIMATORPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xA5E9630)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int AnimatorParam_TypeDefinitionIndex = 37992;
