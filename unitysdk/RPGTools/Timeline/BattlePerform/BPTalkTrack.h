...
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPTALKTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xA5F1C30)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPTALKTRACK_METHOD_5_C441C887BCDF806F_OFFSET UNITYSDK_OFFSET(0xA5F1E40)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPTALKTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xA5F20F0)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPTALKTRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xA5F21D0)

namespace RPGTools::Timeline::BattlePerform
{
	inline static constexpr unsigned int BPTalkTrack_TypeDefinitionIndex = 38611;
