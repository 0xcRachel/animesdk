...
#define RPGTOOLS_TIMELINE_BLOCKSETVISIBILITYTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xA5F2BD0)
#define RPGTOOLS_TIMELINE_BLOCKSETVISIBILITYTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xA5F2DB0)
#define RPGTOOLS_TIMELINE_BLOCKSETVISIBILITYTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xA5F2E20)
#define RPGTOOLS_TIMELINE_BLOCKSETVISIBILITYTRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xA5F2F00)
#define RPGTOOLS_TIMELINE_BLOCKSETVISIBILITYTRACK___IFIXBASEPROXY_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xA5F2FA0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int BlockSetVisibilityTrack_TypeDefinitionIndex = 37770;
