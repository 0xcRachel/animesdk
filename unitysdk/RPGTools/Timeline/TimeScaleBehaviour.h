...
#define RPGTOOLS_TIMELINE_TIMESCALEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xA673A30)
#define RPGTOOLS_TIMELINE_TIMESCALEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xA673BD0)
#define RPGTOOLS_TIMELINE_TIMESCALEBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xA673BE0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int TimeScaleBehaviour_TypeDefinitionIndex = 38338;
