...
#define RPGTOOLS_TIMELINE_YCORRECTIONENABLETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xA67FEE0)
#define RPGTOOLS_TIMELINE_YCORRECTIONENABLETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xA680040)
#define RPGTOOLS_TIMELINE_YCORRECTIONENABLETRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xA680120)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int YCorrectionEnableTrack_TypeDefinitionIndex = 38254;
