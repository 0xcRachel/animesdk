...
#define RPGTOOLS_TIMELINE_QTETRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xA65E4C0)
#define RPGTOOLS_TIMELINE_QTETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xA65E620)
#define RPGTOOLS_TIMELINE_QTETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xA65E800)
#define RPGTOOLS_TIMELINE_QTETRACK___IFIXBASEPROXY_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xA65E8E0)
#define RPGTOOLS_TIMELINE_QTETRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xA65E920)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int QTETrack_TypeDefinitionIndex = 38128;
