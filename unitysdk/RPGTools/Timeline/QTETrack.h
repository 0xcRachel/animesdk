...
#define RPGTOOLS_TIMELINE_QTETRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xABA4C70)
#define RPGTOOLS_TIMELINE_QTETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xABA4DD0)
#define RPGTOOLS_TIMELINE_QTETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xABA4FB0)
#define RPGTOOLS_TIMELINE_QTETRACK___IFIXBASEPROXY_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xABA5090)
#define RPGTOOLS_TIMELINE_QTETRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xABA50D0)
