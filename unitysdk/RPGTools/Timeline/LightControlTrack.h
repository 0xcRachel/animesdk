...
#define RPGTOOLS_TIMELINE_LIGHTCONTROLTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xA63ABB0)
#define RPGTOOLS_TIMELINE_LIGHTCONTROLTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xA63B020)
#define RPGTOOLS_TIMELINE_LIGHTCONTROLTRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xA63B100)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int LightControlTrack_TypeDefinitionIndex = 38276;
