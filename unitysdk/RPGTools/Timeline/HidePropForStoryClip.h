...
#define RPGTOOLS_TIMELINE_HIDEPROPFORSTORYCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xA633CC0)
#define RPGTOOLS_TIMELINE_HIDEPROPFORSTORYCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xA633CB0)
#define RPGTOOLS_TIMELINE_HIDEPROPFORSTORYCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xA633E80)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int HidePropForStoryClip_TypeDefinitionIndex = 38006;
