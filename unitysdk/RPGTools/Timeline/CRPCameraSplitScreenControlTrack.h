...
#define RPGTOOLS_TIMELINE_CRPCAMERASPLITSCREENCONTROLTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xA5F7740)
#define RPGTOOLS_TIMELINE_CRPCAMERASPLITSCREENCONTROLTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xA5F78F0)
#define RPGTOOLS_TIMELINE_CRPCAMERASPLITSCREENCONTROLTRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xA5F79D0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CRPCameraSplitScreenControlTrack_TypeDefinitionIndex = 37800;
