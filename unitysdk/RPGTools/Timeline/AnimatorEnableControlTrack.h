...
#define RPGTOOLS_TIMELINE_ANIMATORENABLECONTROLTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xA5E84A0)
#define RPGTOOLS_TIMELINE_ANIMATORENABLECONTROLTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xA5E8550)
#define RPGTOOLS_TIMELINE_ANIMATORENABLECONTROLTRACK_GET_USEUNIQUECHARACTERNAME_OFFSET UNITYSDK_OFFSET(0xA5E8B30)
#define RPGTOOLS_TIMELINE_ANIMATORENABLECONTROLTRACK_ONINSPECTOR_OFFSET UNITYSDK_OFFSET(0xA5E8B40)
#define RPGTOOLS_TIMELINE_ANIMATORENABLECONTROLTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xA5E9530)
#define RPGTOOLS_TIMELINE_ANIMATORENABLECONTROLTRACK___IFIXBASEPROXY_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xA5E9540)
#define RPGTOOLS_TIMELINE_ANIMATORENABLECONTROLTRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xA5E9580)
#define RPGTOOLS_TIMELINE_ANIMATORENABLECONTROLTRACK___IFIXBASEPROXY_ONINSPECTOR_OFFSET UNITYSDK_OFFSET(0xA5E9620)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int AnimatorEnableControlTrack_TypeDefinitionIndex = 38065;
