...
#define RPGTOOLS_TIMELINE_EMOEYECTRLDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA615080)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int EmoEyeCtrlData_TypeDefinitionIndex = 37981;
