...
#define RPGTOOLS_TIMELINE_NPCRIDECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xA641790)
#define RPGTOOLS_TIMELINE_NPCRIDECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xA641780)
#define RPGTOOLS_TIMELINE_NPCRIDECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xA641980)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int NPCRideClip_TypeDefinitionIndex = 38068;
