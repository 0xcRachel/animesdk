...
#define RPGTOOLS_TIMELINE_CHARACTERDITHERCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xA5FCF30)
#define RPGTOOLS_TIMELINE_CHARACTERDITHERCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xA5FCF20)
#define RPGTOOLS_TIMELINE_CHARACTERDITHERCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xA5FD0F0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterDitherClip_TypeDefinitionIndex = 37836;
