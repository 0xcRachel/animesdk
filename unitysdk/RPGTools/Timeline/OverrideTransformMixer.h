...
#define RPGTOOLS_TIMELINE_OVERRIDETRANSFORMMIXER_METHOD_2_2B28B4A9AA4D9A25_OFFSET UNITYSDK_OFFSET(0xA6436F0)
#define RPGTOOLS_TIMELINE_OVERRIDETRANSFORMMIXER_METHOD_2_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xA644390)
#define RPGTOOLS_TIMELINE_OVERRIDETRANSFORMMIXER_METHOD_2_85E770997A59B4B6_OFFSET UNITYSDK_OFFSET(0xA643E30)
#define RPGTOOLS_TIMELINE_OVERRIDETRANSFORMMIXER_METHOD_2_9076BB310BB6989E_OFFSET UNITYSDK_OFFSET(0xA643D70)
#define RPGTOOLS_TIMELINE_OVERRIDETRANSFORMMIXER_METHOD_2_A61B8BC4D1AB144C_OFFSET UNITYSDK_OFFSET(0xA6443E0)
#define RPGTOOLS_TIMELINE_OVERRIDETRANSFORMMIXER_METHOD_2_D8E6DC0B27699F85_OFFSET UNITYSDK_OFFSET(0xA643EA0)
#define RPGTOOLS_TIMELINE_OVERRIDETRANSFORMMIXER_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0xA643FD0)
#define RPGTOOLS_TIMELINE_OVERRIDETRANSFORMMIXER_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xA644030)
#define RPGTOOLS_TIMELINE_OVERRIDETRANSFORMMIXER_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xA6440A0)
#define RPGTOOLS_TIMELINE_OVERRIDETRANSFORMMIXER__CTOR_OFFSET UNITYSDK_OFFSET(0xA644830)
#define RPGTOOLS_TIMELINE_OVERRIDETRANSFORMMIXER___IFIXBASEPROXY_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0xA644840)
#define RPGTOOLS_TIMELINE_OVERRIDETRANSFORMMIXER___IFIXBASEPROXY_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xA644850)
#define RPGTOOLS_TIMELINE_OVERRIDETRANSFORMMIXER___IFIXBASEPROXY_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xA644860)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int OverrideTransformMixer_TypeDefinitionIndex = 37883;
	...
	public:
		...
		::System::Void Method_2_2B28B4A9AA4D9A25(::UnityEngine::Timeline::TrackAsset* a1, ::UnityEngine::GameObject* a2, ::RPGTools::Timeline::OverrideTransform_ControlType a3)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Timeline::TrackAsset*, ::UnityEngine::GameObject*, ::RPGTools::Timeline::OverrideTransform_ControlType))((::PBYTE)hIl2Cpp + RPGTOOLS_TIMELINE_OVERRIDETRANSFORMMIXER_METHOD_2_2B28B4A9AA4D9A25_OFFSET))(this, a1, a2, a3);
		}
