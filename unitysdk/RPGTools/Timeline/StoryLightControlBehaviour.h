...
#define RPGTOOLS_TIMELINE_STORYLIGHTCONTROLBEHAVIOUR_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xA669000)
#define RPGTOOLS_TIMELINE_STORYLIGHTCONTROLBEHAVIOUR_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xA669110)
#define RPGTOOLS_TIMELINE_STORYLIGHTCONTROLBEHAVIOUR_METHOD_2_A871253BFD471C99_OFFSET UNITYSDK_OFFSET(0xA669D40)
#define RPGTOOLS_TIMELINE_STORYLIGHTCONTROLBEHAVIOUR_METHOD_2_AA169839CB93802A_1_OFFSET UNITYSDK_OFFSET(0xA668F00)
#define RPGTOOLS_TIMELINE_STORYLIGHTCONTROLBEHAVIOUR_METHOD_2_AA169839CB93802A_OFFSET UNITYSDK_OFFSET(0xA66BC10)
#define RPGTOOLS_TIMELINE_STORYLIGHTCONTROLBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xA668E00)
#define RPGTOOLS_TIMELINE_STORYLIGHTCONTROLBEHAVIOUR_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0xA6691B0)
#define RPGTOOLS_TIMELINE_STORYLIGHTCONTROLBEHAVIOUR_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0xA669210)
#define RPGTOOLS_TIMELINE_STORYLIGHTCONTROLBEHAVIOUR_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0xA6690B0)
#define RPGTOOLS_TIMELINE_STORYLIGHTCONTROLBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xA669E40)
#define RPGTOOLS_TIMELINE_STORYLIGHTCONTROLBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xA66BCE0)
#define RPGTOOLS_TIMELINE_STORYLIGHTCONTROLBEHAVIOUR___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xA66BE00)
#define RPGTOOLS_TIMELINE_STORYLIGHTCONTROLBEHAVIOUR___IFIXBASEPROXY_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0xA66BE20)
#define RPGTOOLS_TIMELINE_STORYLIGHTCONTROLBEHAVIOUR___IFIXBASEPROXY_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0xA66BE30)
#define RPGTOOLS_TIMELINE_STORYLIGHTCONTROLBEHAVIOUR___IFIXBASEPROXY_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0xA66BE10)
#define RPGTOOLS_TIMELINE_STORYLIGHTCONTROLBEHAVIOUR___IFIXBASEPROXY_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xA66BE40)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int StoryLightControlBehaviour_TypeDefinitionIndex = 38188;
	...
	public:
		...
		::System::Boolean _OriIsSyncSceneLight; // 0x174
		::RPG::Client::EnvironmentSystem* _EnvSystem; // 0x178
		::System::Int32 _TargetPriority; // 0x180
		::System::Boolean _FirstFrame; // 0x184
		::System::Boolean AutoReset; // 0x185
