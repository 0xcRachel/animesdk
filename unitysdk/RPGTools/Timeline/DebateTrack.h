...
#define RPGTOOLS_TIMELINE_DEBATETRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xA60EA50)
#define RPGTOOLS_TIMELINE_DEBATETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xA60EB00)
#define RPGTOOLS_TIMELINE_DEBATETRACK_METHOD_5_8869F3D8889ADABB_OFFSET UNITYSDK_OFFSET(0xA60ED60)
#define RPGTOOLS_TIMELINE_DEBATETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xA60F180)
#define RPGTOOLS_TIMELINE_DEBATETRACK___IFIXBASEPROXY_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xA60F260)
#define RPGTOOLS_TIMELINE_DEBATETRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xA60F2A0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int DebateTrack_TypeDefinitionIndex = 37950;
