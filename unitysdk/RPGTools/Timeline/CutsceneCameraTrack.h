...
#define RPGTOOLS_TIMELINE_CUTSCENECAMERATRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xA60D620)
#define RPGTOOLS_TIMELINE_CUTSCENECAMERATRACK_GET_USEUNIQUECHARACTERNAME_OFFSET UNITYSDK_OFFSET(0xA60DD90)
#define RPGTOOLS_TIMELINE_CUTSCENECAMERATRACK_METHOD_5_A0358A0F0CEEA8AA_OFFSET UNITYSDK_OFFSET(0xA60DC60)
#define RPGTOOLS_TIMELINE_CUTSCENECAMERATRACK_METHOD_5_F821272A6F60651E_OFFSET UNITYSDK_OFFSET(0xA60DB70)
#define RPGTOOLS_TIMELINE_CUTSCENECAMERATRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xA60DDA0)
#define RPGTOOLS_TIMELINE_CUTSCENECAMERATRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xA60DE90)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CutsceneCameraTrack_TypeDefinitionIndex = 37946;
