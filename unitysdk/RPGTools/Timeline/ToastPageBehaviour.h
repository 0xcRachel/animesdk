...
#define RPGTOOLS_TIMELINE_TOASTPAGEBEHAVIOUR_METHOD_3_51AC7912135C5E23_OFFSET UNITYSDK_OFFSET(0xA675300)
#define RPGTOOLS_TIMELINE_TOASTPAGEBEHAVIOUR_METHOD_3_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xA675380)
#define RPGTOOLS_TIMELINE_TOASTPAGEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xA675370)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ToastPageBehaviour_TypeDefinitionIndex = 38246;
