...
#define RPGTOOLS_TIMELINE_CHARACTERSTOPBODYCONTROLBEHAVIOUR_METHOD_3_84B92802FDAFF6C8_OFFSET UNITYSDK_OFFSET(0xA602780)
#define RPGTOOLS_TIMELINE_CHARACTERSTOPBODYCONTROLBEHAVIOUR_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA602930)
#define RPGTOOLS_TIMELINE_CHARACTERSTOPBODYCONTROLBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xA602920)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int CharacterStopBodyControlBehaviour_TypeDefinitionIndex = 37833;
