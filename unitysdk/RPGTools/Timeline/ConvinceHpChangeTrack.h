...
#define RPGTOOLS_TIMELINE_CONVINCEHPCHANGETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xA60B930)
#define RPGTOOLS_TIMELINE_CONVINCEHPCHANGETRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xA60BB10)
#define RPGTOOLS_TIMELINE_CONVINCEHPCHANGETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xA60BB80)
#define RPGTOOLS_TIMELINE_CONVINCEHPCHANGETRACK___IFIXBASEPROXY_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xA60BC60)
#define RPGTOOLS_TIMELINE_CONVINCEHPCHANGETRACK___IFIXBASEPROXY_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xA60BD00)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int ConvinceHpChangeTrack_TypeDefinitionIndex = 37932;
