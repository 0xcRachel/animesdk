...
#define RPGTOOLS_TIMELINE_EFFECTPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0xA612D80)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int EffectParameter_TypeDefinitionIndex = 38256;
