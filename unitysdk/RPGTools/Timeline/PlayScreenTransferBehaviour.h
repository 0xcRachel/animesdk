...
#define RPGTOOLS_TIMELINE_PLAYSCREENTRANSFERBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xA6453F0)

namespace RPGTools::Timeline
{
	inline static constexpr unsigned int PlayScreenTransferBehaviour_TypeDefinitionIndex = 38080;
