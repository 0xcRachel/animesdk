...
#define RPGTOOLS_SCREENRECORDER_AWAKE_OFFSET UNITYSDK_OFFSET(0x198ADBB0)
#define RPGTOOLS_SCREENRECORDER_ENDRECORD_OFFSET UNITYSDK_OFFSET(0x198ADFA0)
#define RPGTOOLS_SCREENRECORDER_METHOD_5_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x198AE610)
#define RPGTOOLS_SCREENRECORDER_METHOD_5_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x198ADDC0)
#define RPGTOOLS_SCREENRECORDER_METHOD_5_2CEBCCAF54FB984A_OFFSET UNITYSDK_OFFSET(0x198AE050)
#define RPGTOOLS_SCREENRECORDER_METHOD_5_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0x198ADF20)
#define RPGTOOLS_SCREENRECORDER_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x198ADE20)
#define RPGTOOLS_SCREENRECORDER_STARTRECORD_OFFSET UNITYSDK_OFFSET(0x198ADFF0)
#define RPGTOOLS_SCREENRECORDER_UPDATE_OFFSET UNITYSDK_OFFSET(0x198ADBF0)
#define RPGTOOLS_SCREENRECORDER__CTOR_OFFSET UNITYSDK_OFFSET(0x198AE6E0)
