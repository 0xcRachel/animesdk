...
#define RPGTOOLS_STORY_SETBLOCKVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0xA5E2F50)

namespace RPGTools::Story
{
	inline static constexpr unsigned int SetBlockVisible_TypeDefinitionIndex = 38693;
