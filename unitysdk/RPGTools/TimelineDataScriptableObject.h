...
#define RPGTOOLS_TIMELINEDATASCRIPTABLEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0xA6801D0)

namespace RPGTools
{
	inline static constexpr unsigned int TimelineDataScriptableObject_TypeDefinitionIndex = 37700;
