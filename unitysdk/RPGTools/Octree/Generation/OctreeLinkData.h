...
#define RPGTOOLS_OCTREE_GENERATION_OCTREELINKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA5E0530)

namespace RPGTools::Octree::Generation
{
	inline static constexpr unsigned int OctreeLinkData_TypeDefinitionIndex = 38648;
