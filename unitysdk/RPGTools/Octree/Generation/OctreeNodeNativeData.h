...
#define RPGTOOLS_OCTREE_GENERATION_OCTREENODENATIVEDATA_METHOD_2_C8288CA38627F3DC_OFFSET UNITYSDK_OFFSET(0xD7C00)
#define RPGTOOLS_OCTREE_GENERATION_OCTREENODENATIVEDATA_METHOD_2_E613829602ABB720_OFFSET UNITYSDK_OFFSET(0xD7C10)
#define RPGTOOLS_OCTREE_GENERATION_OCTREENODENATIVEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD7B90)

namespace RPGTools::Octree::Generation
{
	inline static constexpr unsigned int OctreeNodeNativeData_TypeDefinitionIndex = 38652;
