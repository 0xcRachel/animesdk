...
#define CLASS_3_524C7B39734B3AFD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD178310)
#define CLASS_3_524C7B39734B3AFD_METHOD_3_2576376AC7F6B15D_OFFSET UNITYSDK_OFFSET(0xD179200)
#define CLASS_3_524C7B39734B3AFD_METHOD_3_DB915699370309DA_OFFSET UNITYSDK_OFFSET(0xD1794C0)
#define CLASS_3_524C7B39734B3AFD_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xD178360)
#define CLASS_3_524C7B39734B3AFD__CTOR_OFFSET UNITYSDK_OFFSET(0xD1781B0)
#define CLASS_3_524C7B39734B3AFD___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD179830)
...
public:
	...
	::RPG::GameCore::GameEntity* Field_3_7; // 0x30
	::RPG::GameCore::ModifierCustomEventConfig* Field_3_6; // 0x38
	::RPG::PoolList_1<::RPG::GameCore::TurnBasedModifierInstance*>* Field_3_5; // 0x40
	::RPG::GameCore::GameEntity* Field_3_8; // 0x48
	::RPG::GameCore::StringHash Field_3_1; // 0x50
