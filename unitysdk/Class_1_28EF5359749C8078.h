...
#define CLASS_1_28EF5359749C8078_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x199000C0)
#define CLASS_1_28EF5359749C8078_CLONE_OFFSET UNITYSDK_OFFSET(0x198FF9A0)
#define CLASS_1_28EF5359749C8078_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x198FFA90)
#define CLASS_1_28EF5359749C8078_EQUALS_OFFSET UNITYSDK_OFFSET(0x198FFA30)
#define CLASS_1_28EF5359749C8078_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x198FFB90)
#define CLASS_1_28EF5359749C8078_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19900280)
#define CLASS_1_28EF5359749C8078_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x199001F0)
#define CLASS_1_28EF5359749C8078_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x198FF650)
#define CLASS_1_28EF5359749C8078_METHOD_1_554199E0076172C5_1_OFFSET UNITYSDK_OFFSET(0x198FFA00)
#define CLASS_1_28EF5359749C8078_METHOD_1_554199E0076172C5_2_OFFSET UNITYSDK_OFFSET(0x198FFA10)
#define CLASS_1_28EF5359749C8078_METHOD_1_554199E0076172C5_3_OFFSET UNITYSDK_OFFSET(0x198FFA20)
#define CLASS_1_28EF5359749C8078_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x198FF9F0)
#define CLASS_1_28EF5359749C8078_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x198FF6B0)
#define CLASS_1_28EF5359749C8078_TOSTRING_OFFSET UNITYSDK_OFFSET(0x198FFF20)
#define CLASS_1_28EF5359749C8078_WRITETO_OFFSET UNITYSDK_OFFSET(0x198FFF80)
#define CLASS_1_28EF5359749C8078__CCTOR_OFFSET UNITYSDK_OFFSET(0x19900470)
#define CLASS_1_28EF5359749C8078__CTOR_1_OFFSET UNITYSDK_OFFSET(0x198FF7E0)
#define CLASS_1_28EF5359749C8078__CTOR_OFFSET UNITYSDK_OFFSET(0x198FF6C0)

inline static constexpr unsigned int Class_1_28EF5359749C8078_TypeDefinitionIndex = 24163;
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_28EF5359749C8078_TypeDefinitionIndex)->GetStaticField(0x353C0);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_28EF5359749C8078*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_28EF5359749C8078*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_28EF5359749C8078_TypeDefinitionIndex)->GetStaticField(0x353C8);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_9()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_28EF5359749C8078_TypeDefinitionIndex)->GetStaticField(0x353D0);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_12()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_28EF5359749C8078_TypeDefinitionIndex)->GetStaticField(0x353D8);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_3()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_28EF5359749C8078_TypeDefinitionIndex)->GetStaticField(0x353E0);
	}
