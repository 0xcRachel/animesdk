...
#define CLASS_1_0272D5A0C4F089B0__CTOR_OFFSET UNITYSDK_OFFSET(0x167224E0)
...
{
public:
	::RPG::GameCore::DiceCombatSkillConfig* Field_1_1; // 0x10
	::RPG::GameCore::DiceCombatWeatherSkillConfig* Field_1_3; // 0x18
	::RPG::GameCore::ActivityDiceCombatAIGroupRow* Field_1_7; // 0x20
	::RPG::GameCore::ActivityDiceCombatSpecialRuleRow* Field_1_2; // 0x28
	::Class_1_15B3DD195FDC216E* Field_1_0; // 0x30
