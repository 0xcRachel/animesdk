...
#define CLASS_2_DA76A9A749C6373D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8A63820)
#define CLASS_2_DA76A9A749C6373D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x8A63860)
#define CLASS_2_DA76A9A749C6373D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x8A638E0)
#define CLASS_2_DA76A9A749C6373D_TICK_OFFSET UNITYSDK_OFFSET(0x8A63930)
#define CLASS_2_DA76A9A749C6373D__CTOR_OFFSET UNITYSDK_OFFSET(0x8A63810)

inline static constexpr unsigned int Class_2_DA76A9A749C6373D_TypeDefinitionIndex = 46216;

class Class_2_DA76A9A749C6373D : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::ShowAdventureLevelPage* Field_2_0; // 0x20
