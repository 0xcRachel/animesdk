...
#define STRUCT_2_2EC37637598BC283_DISPOSE_OFFSET UNITYSDK_OFFSET(0x171C0E0)
#define STRUCT_2_2EC37637598BC283_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x171C040)
#define STRUCT_2_2EC37637598BC283_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x171C120)
#define STRUCT_2_2EC37637598BC283_RESET_OFFSET UNITYSDK_OFFSET(0x171C1A0)
#define STRUCT_2_2EC37637598BC283_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x171C090)
#define STRUCT_2_2EC37637598BC283__CTOR_OFFSET UNITYSDK_OFFSET(0x171BFC0)

inline static constexpr unsigned int Struct_2_2EC37637598BC283_TypeDefinitionIndex = 69122;
