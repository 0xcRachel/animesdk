...
#define CLASS_1_C75DDA89CCB3A76B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x140C06B0)
#define CLASS_1_C75DDA89CCB3A76B_GET_NEXT_OFFSET UNITYSDK_OFFSET(0x140C0800)
#define CLASS_1_C75DDA89CCB3A76B_GET_PREV_OFFSET UNITYSDK_OFFSET(0x140C07E0)
#define CLASS_1_C75DDA89CCB3A76B_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x140C0830)
#define CLASS_1_C75DDA89CCB3A76B_METHOD_1_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0x140C0820)
#define CLASS_1_C75DDA89CCB3A76B_METHOD_1_C8D6B29192F288ED_OFFSET UNITYSDK_OFFSET(0x140C0840)
#define CLASS_1_C75DDA89CCB3A76B_SET_NEXT_OFFSET UNITYSDK_OFFSET(0x140C0810)
#define CLASS_1_C75DDA89CCB3A76B_SET_PREV_OFFSET UNITYSDK_OFFSET(0x140C07F0)
#define CLASS_1_C75DDA89CCB3A76B__CTOR_1_OFFSET UNITYSDK_OFFSET(0x140C0690)
#define CLASS_1_C75DDA89CCB3A76B__CTOR_OFFSET UNITYSDK_OFFSET(0x140C0660)
...
{
public:
	::Class_0_16E4307DCC419505_470* _Next_k__BackingField; // 0x10
	::System::Collections::Generic::IEnumerable_1<::RPG::GameCore::TaskConfig*>* Field_1_1; // 0x18
	::RPG::GameCore::TaskContext* Field_1_2; // 0x20
	::Class_0_16E4307DCC419505_470* _Prev_k__BackingField; // 0x28
