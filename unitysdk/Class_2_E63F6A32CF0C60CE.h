...
#define CLASS_2_E63F6A32CF0C60CE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x111C9CA0)
#define CLASS_2_E63F6A32CF0C60CE_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x111C9E30)
#define CLASS_2_E63F6A32CF0C60CE_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x111CA1E0)
#define CLASS_2_E63F6A32CF0C60CE_TICK_OFFSET UNITYSDK_OFFSET(0x111C9CE0)
#define CLASS_2_E63F6A32CF0C60CE__CTOR_OFFSET UNITYSDK_OFFSET(0x111C9C90)

inline static constexpr unsigned int Class_2_E63F6A32CF0C60CE_TypeDefinitionIndex = 42223;
