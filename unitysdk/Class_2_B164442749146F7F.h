...
#define CLASS_2_B164442749146F7F_DISPOSE_OFFSET UNITYSDK_OFFSET(0x116C1BC0)
#define CLASS_2_B164442749146F7F_METHOD_2_0EA837295AE4519F_OFFSET UNITYSDK_OFFSET(0x116C2A40)
#define CLASS_2_B164442749146F7F_METHOD_2_28C532CD321F20DC_OFFSET UNITYSDK_OFFSET(0x116C1D60)
#define CLASS_2_B164442749146F7F_METHOD_2_2A539F1403D9A5F7_OFFSET UNITYSDK_OFFSET(0x116C2B80)
#define CLASS_2_B164442749146F7F_METHOD_2_4DA6D4A624E42CAB_OFFSET UNITYSDK_OFFSET(0x116C2960)
#define CLASS_2_B164442749146F7F_METHOD_2_81FEFD1B22CE37A2_OFFSET UNITYSDK_OFFSET(0x116C2F50)
#define CLASS_2_B164442749146F7F_METHOD_2_921C3C3E09D59CD4_OFFSET UNITYSDK_OFFSET(0x116C24F0)
#define CLASS_2_B164442749146F7F_METHOD_2_EBEF4B6C71D9E0F7_OFFSET UNITYSDK_OFFSET(0x116C2CE0)
#define CLASS_2_B164442749146F7F_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x116C1C10)
#define CLASS_2_B164442749146F7F_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x116C26C0)
#define CLASS_2_B164442749146F7F_TICK_OFFSET UNITYSDK_OFFSET(0x116C2740)
#define CLASS_2_B164442749146F7F__CTOR_OFFSET UNITYSDK_OFFSET(0x116C1B70)
...
{
public:
	::RPG::GameCore::WaveMonster* Field_2_0; // 0x18
	::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* Field_2_2; // 0x20
	::Class_1_2B2C39A45CFC5540* Field_2_3; // 0x28
