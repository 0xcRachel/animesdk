...
#define CLASS_1_312DDC926E545863__CTOR_OFFSET UNITYSDK_OFFSET(0x10FA26C0)
...
public:
	...
	::RPG::GameCore::BattleEventConfig* Field_1_9; // 0x20
	::Class_0_16E4307DCC419505_345* Field_1_0; // 0x28
	::RPG::GameCore::StageRow* Field_1_4; // 0x30
	::RPG::GameCore::GameEntity* Field_1_2; // 0x38
	::RPG::GameCore::GameEntity* Field_1_3; // 0x40
	::RPG::GameCore::BattleEventCreateType Field_1_10; // 0x48
