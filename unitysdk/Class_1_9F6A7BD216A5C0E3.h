...
#define CLASS_1_9F6A7BD216A5C0E3_METHOD_1_707355BB5CCD728C_OFFSET UNITYSDK_OFFSET(0x8A00090)
#define CLASS_1_9F6A7BD216A5C0E3__CTOR_OFFSET UNITYSDK_OFFSET(0x8A00180)
...
{
public:
	::RPG::Client::CameraNamedDynamicOffset* Field_1_1; // 0x10
