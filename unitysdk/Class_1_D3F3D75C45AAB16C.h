...
#define CLASS_1_D3F3D75C45AAB16C_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A5D4220)
#define CLASS_1_D3F3D75C45AAB16C_CLONE_OFFSET UNITYSDK_OFFSET(0x1A5D3E90)
#define CLASS_1_D3F3D75C45AAB16C_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A5D4050)
#define CLASS_1_D3F3D75C45AAB16C_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A5D3F70)
#define CLASS_1_D3F3D75C45AAB16C_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A5D4100)
#define CLASS_1_D3F3D75C45AAB16C_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A5D4310)
#define CLASS_1_D3F3D75C45AAB16C_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A5D4280)
#define CLASS_1_D3F3D75C45AAB16C_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x1A5D3F50)
#define CLASS_1_D3F3D75C45AAB16C_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A5D3DA0)
#define CLASS_1_D3F3D75C45AAB16C_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x1A5D3F60)
#define CLASS_1_D3F3D75C45AAB16C_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1A5D3F40)
#define CLASS_1_D3F3D75C45AAB16C_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1A5D3F30)
#define CLASS_1_D3F3D75C45AAB16C_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A5D3E00)
#define CLASS_1_D3F3D75C45AAB16C_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A5D4140)
#define CLASS_1_D3F3D75C45AAB16C_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A5D41A0)
#define CLASS_1_D3F3D75C45AAB16C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A5D44D0)
#define CLASS_1_D3F3D75C45AAB16C__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A5D3E20)
#define CLASS_1_D3F3D75C45AAB16C__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5D3E10)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_D3F3D75C45AAB16C*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_D3F3D75C45AAB16C_TypeDefinitionIndex)->GetStaticField(0x3C580);
	}
