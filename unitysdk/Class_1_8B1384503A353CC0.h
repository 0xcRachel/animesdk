...
#define CLASS_1_8B1384503A353CC0_CLEAR_OFFSET UNITYSDK_OFFSET(0x154EC8C0)
#define CLASS_1_8B1384503A353CC0_METHOD_1_017C915772AE00E9_OFFSET UNITYSDK_OFFSET(0x154EB830)
#define CLASS_1_8B1384503A353CC0_METHOD_1_0E8C38831B017A2A_OFFSET UNITYSDK_OFFSET(0x154EB9F0)
#define CLASS_1_8B1384503A353CC0_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x154ED2A0)
#define CLASS_1_8B1384503A353CC0_METHOD_1_805C56F44231AEF9_OFFSET UNITYSDK_OFFSET(0x154ECE70)
#define CLASS_1_8B1384503A353CC0_METHOD_1_A021497730B2DA95_OFFSET UNITYSDK_OFFSET(0x154EC6E0)
#define CLASS_1_8B1384503A353CC0_METHOD_1_BC53D0C0E999F7DD_OFFSET UNITYSDK_OFFSET(0x154EB8B0)
#define CLASS_1_8B1384503A353CC0_METHOD_1_C53A61ACE6CB7DDE_OFFSET UNITYSDK_OFFSET(0x154EA8E0)
#define CLASS_1_8B1384503A353CC0_METHOD_1_CD116544C97BFD78_1_OFFSET UNITYSDK_OFFSET(0x154EC0F0)
#define CLASS_1_8B1384503A353CC0_METHOD_1_CD116544C97BFD78_OFFSET UNITYSDK_OFFSET(0x154EBB60)
#define CLASS_1_8B1384503A353CC0_METHOD_1_D3E55D75AF9C2BFF_OFFSET UNITYSDK_OFFSET(0x154EBAF0)
#define CLASS_1_8B1384503A353CC0_METHOD_1_D7DDA895983CCCB2_OFFSET UNITYSDK_OFFSET(0x154EC680)
#define CLASS_1_8B1384503A353CC0_METHOD_1_F356CEEA92A146D8_OFFSET UNITYSDK_OFFSET(0x154EA9A0)
#define CLASS_1_8B1384503A353CC0_METHOD_1_F471C870A246D440_OFFSET UNITYSDK_OFFSET(0x154ECEE0)
#define CLASS_1_8B1384503A353CC0__CTOR_OFFSET UNITYSDK_OFFSET(0x154EA7D0)

inline static constexpr unsigned int Class_1_8B1384503A353CC0_TypeDefinitionIndex = 68865;

class Class_1_8B1384503A353CC0 : public ::System::Object
{
public:
	::System::Collections::Generic::List_1<::Class_1_E136401E1657CFD7*>* Field_1_0; // 0x10
	::RPG::GameCore::JsonOfflineCullingCellSerializeData* Field_1_1; // 0x18
	::Collections::Pooled::PooledSet_1<::System::Int32>* Field_1_2; // 0x20
	::Collections::Pooled::PooledSet_1<::System::Int32>* Field_1_3; // 0x28
	::Class_1_E136401E1657CFD7* Field_1_4; // 0x30
	::System::Collections::Generic::List_1<::Class_1_E136401E1657CFD7*>* Field_1_5; // 0x38
	::RPG::Client::OpenWorld::OfflineCullingCellSerializeData* Field_1_6; // 0x40
	::Collections::Pooled::PooledSet_1<::System::Int32>* Field_1_7; // 0x48
	::System::Collections::Generic::List_1<::Class_1_E136401E1657CFD7*>* Field_1_8; // 0x50
	::Collections::Pooled::PooledSet_1<::System::Int32>* Field_1_9; // 0x58
	::System::Collections::Generic::List_1<::Class_1_E136401E1657CFD7*>* Field_1_10; // 0x60
