...
#define CLASS_1_5B567C8A01BAEDFE_129_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A4E4860)
#define CLASS_1_5B567C8A01BAEDFE_129_CLONE_OFFSET UNITYSDK_OFFSET(0x1A4E46D0)
#define CLASS_1_5B567C8A01BAEDFE_129_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A4E4770)
#define CLASS_1_5B567C8A01BAEDFE_129_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A4E4710)
#define CLASS_1_5B567C8A01BAEDFE_129_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A4E47C0)
#define CLASS_1_5B567C8A01BAEDFE_129_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A4E48B0)
#define CLASS_1_5B567C8A01BAEDFE_129_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A4E4880)
#define CLASS_1_5B567C8A01BAEDFE_129_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A4E4650)
#define CLASS_1_5B567C8A01BAEDFE_129_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A4E4680)
#define CLASS_1_5B567C8A01BAEDFE_129_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A4E47F0)
#define CLASS_1_5B567C8A01BAEDFE_129_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A4E4850)
#define CLASS_1_5B567C8A01BAEDFE_129__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A4E4900)
#define CLASS_1_5B567C8A01BAEDFE_129__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A4E46A0)
#define CLASS_1_5B567C8A01BAEDFE_129__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4E4690)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_129*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_129_TypeDefinitionIndex)->GetStaticField(0xB0F0);
	}
