...
#define CLASS_2_5CCD0ECCAE145BCF_DISPOSE_OFFSET UNITYSDK_OFFSET(0x111BAF10)
#define CLASS_2_5CCD0ECCAE145BCF_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x111BAF50)
#define CLASS_2_5CCD0ECCAE145BCF_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x111BB660)
#define CLASS_2_5CCD0ECCAE145BCF_TICK_OFFSET UNITYSDK_OFFSET(0x111BB6B0)
#define CLASS_2_5CCD0ECCAE145BCF__CTOR_OFFSET UNITYSDK_OFFSET(0x111BAF00)

inline static constexpr unsigned int Class_2_5CCD0ECCAE145BCF_TypeDefinitionIndex = 45753;

class Class_2_5CCD0ECCAE145BCF : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::CreateCharacter* Field_2_0; // 0x18
