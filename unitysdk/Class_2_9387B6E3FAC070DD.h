...
#define CLASS_2_9387B6E3FAC070DD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBC24390)
#define CLASS_2_9387B6E3FAC070DD_METHOD_2_0D372435D9CAE4BC_OFFSET UNITYSDK_OFFSET(0xBC25E90)
#define CLASS_2_9387B6E3FAC070DD_METHOD_2_684096009AF9FA5C_OFFSET UNITYSDK_OFFSET(0xBC26AC0)
#define CLASS_2_9387B6E3FAC070DD_METHOD_2_7854AA0B7A17DA18_OFFSET UNITYSDK_OFFSET(0xBC26C30)
#define CLASS_2_9387B6E3FAC070DD_METHOD_2_DE52A0B32F251F68_OFFSET UNITYSDK_OFFSET(0xBC26790)
#define CLASS_2_9387B6E3FAC070DD_METHOD_2_EE02094EA9F1E247_OFFSET UNITYSDK_OFFSET(0xBC26020)
#define CLASS_2_9387B6E3FAC070DD_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xBC24640)
#define CLASS_2_9387B6E3FAC070DD_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xBC27310)
#define CLASS_2_9387B6E3FAC070DD_TICK_OFFSET UNITYSDK_OFFSET(0xBC245E0)
#define CLASS_2_9387B6E3FAC070DD__CTOR_OFFSET UNITYSDK_OFFSET(0xBC242A0)
...
{
public:
	::Class_2_35DC892F466147D4* Field_2_8; // 0x18
	::RPG::GameCore::GameEntity* Field_2_7; // 0x20
	::RPG::PoolList_1<::Struct_2_0347AE3FB0036865>* Field_2_6; // 0x28
	::RPG::GameCore::SetSkillTargetFormationByPos* Field_2_1; // 0x30
	::RPG::GameCore::TaskContext* Field_2_2; // 0x38
	::System::Collections::Generic::LinkedList_1<::Class_1_3DE83D320AD4AA4D_Class_1_A4B66D97A840228A*>* Field_2_5; // 0x40
	::System::Collections::Generic::LinkedListNode_1<::Class_1_3DE83D320AD4AA4D_Class_1_A4B66D97A840228A*>* Field_2_10; // 0x48
	::Struct_2_CBD6D7DB1AA269CF Field_2_9; // 0x50
	::System::Collections::Generic::LinkedListNode_1<::RPG::GameCore::TargetFormationPosConfig*>* Field_2_4; // 0x78
	::System::Collections::Generic::LinkedList_1<::RPG::GameCore::TargetFormationPosConfig*>* Field_2_3; // 0x80
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::GameEntity*, ::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>*>* Field_2_11; // 0x88
