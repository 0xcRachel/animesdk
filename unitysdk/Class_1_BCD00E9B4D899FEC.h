...
#define CLASS_1_BCD00E9B4D899FEC_GET_ACHIEVEMENTID_OFFSET UNITYSDK_OFFSET(0x10076080)
#define CLASS_1_BCD00E9B4D899FEC_GET_DISPOSED_OFFSET UNITYSDK_OFFSET(0x10076060)
#define CLASS_1_BCD00E9B4D899FEC_METHOD_1_12C08677E41D9EF9_OFFSET UNITYSDK_OFFSET(0x10075990)
#define CLASS_1_BCD00E9B4D899FEC_METHOD_1_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x10075CA0)
#define CLASS_1_BCD00E9B4D899FEC_METHOD_1_C50A2293958CA940_OFFSET UNITYSDK_OFFSET(0x10075DD0)
#define CLASS_1_BCD00E9B4D899FEC_METHOD_1_C638E91FC0D3A13A_OFFSET UNITYSDK_OFFSET(0x10075F30)
#define CLASS_1_BCD00E9B4D899FEC_METHOD_1_CB613A5EF970C11B_OFFSET UNITYSDK_OFFSET(0x10075D50)
#define CLASS_1_BCD00E9B4D899FEC_METHOD_1_D2809205008ACF99_OFFSET UNITYSDK_OFFSET(0x10075E50)
#define CLASS_1_BCD00E9B4D899FEC_SET_ACHIEVEMENTID_OFFSET UNITYSDK_OFFSET(0x10076090)
#define CLASS_1_BCD00E9B4D899FEC_SET_DISPOSED_OFFSET UNITYSDK_OFFSET(0x10076070)
#define CLASS_1_BCD00E9B4D899FEC__CTOR_OFFSET UNITYSDK_OFFSET(0x10075C20)

inline static constexpr unsigned int Class_1_BCD00E9B4D899FEC_TypeDefinitionIndex = 48677;
...
public:
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_BCD00E9B4D899FEC_METHOD_1_C638E91FC0D3A13A_OFFSET))(this);
	}
