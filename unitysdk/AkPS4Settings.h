...
#define AKPS4SETTINGS_GETADVANCEDSETTINGS_OFFSET UNITYSDK_OFFSET(0x183B4610)
#define AKPS4SETTINGS_GETCOMMSSETTINGS_OFFSET UNITYSDK_OFFSET(0x183B4650)
#define AKPS4SETTINGS_GETUSERSETTINGS_OFFSET UNITYSDK_OFFSET(0x183B45D0)
#define AKPS4SETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x183B4440)

inline static constexpr unsigned int AkPS4Settings_TypeDefinitionIndex = 33642;
