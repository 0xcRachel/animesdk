...
#define CLASS_1_5B567C8A01BAEDFE_162_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A0BE5C0)
#define CLASS_1_5B567C8A01BAEDFE_162_CLONE_OFFSET UNITYSDK_OFFSET(0x1A0BE3D0)
#define CLASS_1_5B567C8A01BAEDFE_162_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A0BE4D0)
#define CLASS_1_5B567C8A01BAEDFE_162_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A0BE440)
#define CLASS_1_5B567C8A01BAEDFE_162_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A0BE520)
#define CLASS_1_5B567C8A01BAEDFE_162_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A0BE610)
#define CLASS_1_5B567C8A01BAEDFE_162_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A0BE5E0)
#define CLASS_1_5B567C8A01BAEDFE_162_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A0BE320)
#define CLASS_1_5B567C8A01BAEDFE_162_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A0BE380)
#define CLASS_1_5B567C8A01BAEDFE_162_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A0BE550)
#define CLASS_1_5B567C8A01BAEDFE_162_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A0BE5B0)
#define CLASS_1_5B567C8A01BAEDFE_162__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A0BE660)
#define CLASS_1_5B567C8A01BAEDFE_162__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0BE3A0)
#define CLASS_1_5B567C8A01BAEDFE_162__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0BE390)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_162*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_162_TypeDefinitionIndex)->GetStaticField(0x25140);
	}
