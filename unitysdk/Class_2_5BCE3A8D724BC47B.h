...
#define CLASS_2_5BCE3A8D724BC47B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x86D3870)
#define CLASS_2_5BCE3A8D724BC47B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x86D38B0)
#define CLASS_2_5BCE3A8D724BC47B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x86D3900)
#define CLASS_2_5BCE3A8D724BC47B_TICK_OFFSET UNITYSDK_OFFSET(0x86D3950)
#define CLASS_2_5BCE3A8D724BC47B__CTOR_OFFSET UNITYSDK_OFFSET(0x86D3860)

inline static constexpr unsigned int Class_2_5BCE3A8D724BC47B_TypeDefinitionIndex = 44148;

class Class_2_5BCE3A8D724BC47B : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::ChessWaitAllProjectileFinish* Field_2_0; // 0x20
