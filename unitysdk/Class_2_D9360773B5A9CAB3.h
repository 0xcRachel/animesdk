...
#define CLASS_2_D9360773B5A9CAB3_DISPOSE_OFFSET UNITYSDK_OFFSET(0xFCB7D40)
#define CLASS_2_D9360773B5A9CAB3_METHOD_2_23C3681AC9E5D438_OFFSET UNITYSDK_OFFSET(0xFCB8140)
#define CLASS_2_D9360773B5A9CAB3_METHOD_2_7CE0DB94FAA9E316_OFFSET UNITYSDK_OFFSET(0xFCB8200)
#define CLASS_2_D9360773B5A9CAB3_METHOD_2_D78B51BFDA4B8B32_OFFSET UNITYSDK_OFFSET(0xFCB7E90)
#define CLASS_2_D9360773B5A9CAB3_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xFCB7DE0)
#define CLASS_2_D9360773B5A9CAB3_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xFCB81B0)
#define CLASS_2_D9360773B5A9CAB3_TICK_OFFSET UNITYSDK_OFFSET(0xFCB7D80)
#define CLASS_2_D9360773B5A9CAB3__CTOR_OFFSET UNITYSDK_OFFSET(0xFCB7D30)
...
{
public:
	::RPG::GameCore::TeamAction* Field_2_1; // 0x18
