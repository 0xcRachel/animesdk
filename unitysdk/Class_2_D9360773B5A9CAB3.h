...
#define CLASS_2_D9360773B5A9CAB3_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1607B890)
#define CLASS_2_D9360773B5A9CAB3_METHOD_2_0707DF3DD83417D8_OFFSET UNITYSDK_OFFSET(0x1607BD50)
#define CLASS_2_D9360773B5A9CAB3_METHOD_2_44D54B0829C8FEF6_OFFSET UNITYSDK_OFFSET(0x1607BC90)
#define CLASS_2_D9360773B5A9CAB3_METHOD_2_D78B51BFDA4B8B32_OFFSET UNITYSDK_OFFSET(0x1607B9E0)
#define CLASS_2_D9360773B5A9CAB3_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1607B930)
#define CLASS_2_D9360773B5A9CAB3_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1607BD00)
#define CLASS_2_D9360773B5A9CAB3_TICK_OFFSET UNITYSDK_OFFSET(0x1607B8D0)
#define CLASS_2_D9360773B5A9CAB3__CTOR_OFFSET UNITYSDK_OFFSET(0x1607B880)
