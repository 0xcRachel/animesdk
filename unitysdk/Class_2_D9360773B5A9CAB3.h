...
#define CLASS_2_D9360773B5A9CAB3_DISPOSE_OFFSET UNITYSDK_OFFSET(0x83F8CC0)
#define CLASS_2_D9360773B5A9CAB3_METHOD_2_23C3681AC9E5D438_OFFSET UNITYSDK_OFFSET(0x83F90C0)
#define CLASS_2_D9360773B5A9CAB3_METHOD_2_7CE0DB94FAA9E316_OFFSET UNITYSDK_OFFSET(0x83F9180)
#define CLASS_2_D9360773B5A9CAB3_METHOD_2_D78B51BFDA4B8B32_OFFSET UNITYSDK_OFFSET(0x83F8E10)
#define CLASS_2_D9360773B5A9CAB3_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x83F8D60)
#define CLASS_2_D9360773B5A9CAB3_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x83F9130)
#define CLASS_2_D9360773B5A9CAB3_TICK_OFFSET UNITYSDK_OFFSET(0x83F8D00)
#define CLASS_2_D9360773B5A9CAB3__CTOR_OFFSET UNITYSDK_OFFSET(0x83F8CB0)

inline static constexpr unsigned int Class_2_D9360773B5A9CAB3_TypeDefinitionIndex = 43563;
