...
#define CLASS_1_3F6460165989C3EF___WAITSTREAMING_D__11_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x8995B50)
#define CLASS_1_3F6460165989C3EF___WAITSTREAMING_D__11_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x8995D20)
#define CLASS_1_3F6460165989C3EF___WAITSTREAMING_D__11_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x8995D80)
#define CLASS_1_3F6460165989C3EF___WAITSTREAMING_D__11_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x8995D30)
#define CLASS_1_3F6460165989C3EF___WAITSTREAMING_D__11_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8995B40)
#define CLASS_1_3F6460165989C3EF___WAITSTREAMING_D__11__CTOR_OFFSET UNITYSDK_OFFSET(0x8995140)

inline static constexpr unsigned int Class_1_3F6460165989C3EF___WaitStreaming_d__11_TypeDefinitionIndex = 47940;
