...
#define CLASS_2_A3D1913B1053B833_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10F01FC0)
#define CLASS_2_A3D1913B1053B833_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x10F02080)
#define CLASS_2_A3D1913B1053B833_METHOD_2_3C56C1AF247AC1EC_OFFSET UNITYSDK_OFFSET(0x10F02140)
#define CLASS_2_A3D1913B1053B833_ONSKIP_OFFSET UNITYSDK_OFFSET(0x10F02090)
#define CLASS_2_A3D1913B1053B833_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10F021D0)
#define CLASS_2_A3D1913B1053B833_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10F02330)
#define CLASS_2_A3D1913B1053B833_TICK_OFFSET UNITYSDK_OFFSET(0x10F023C0)
#define CLASS_2_A3D1913B1053B833__CTOR_OFFSET UNITYSDK_OFFSET(0x10F01E20)

inline static constexpr unsigned int Class_2_A3D1913B1053B833_TypeDefinitionIndex = 43184;

class Class_2_A3D1913B1053B833 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::Class_3_BCCE950C2E8DF1F0* Field_2_4; // 0x18
	::RPG::GameCore::PredicateTaskList* Field_2_0; // 0x20
