...
#define CLASS_1_0C527859D2A4D822_EXECUTE_OFFSET UNITYSDK_OFFSET(0x15CAA000)
#define CLASS_1_0C527859D2A4D822_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x15CA94A0)
#define CLASS_1_0C527859D2A4D822_METHOD_1_02C19192C3EFC3FA_OFFSET UNITYSDK_OFFSET(0x15CAC540)
#define CLASS_1_0C527859D2A4D822_METHOD_1_2AF3A9FB6FC2B7D3_OFFSET UNITYSDK_OFFSET(0x15CAE860)
#define CLASS_1_0C527859D2A4D822_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x15CABA10)
#define CLASS_1_0C527859D2A4D822_METHOD_1_3AE139567F45F2CA_OFFSET UNITYSDK_OFFSET(0x15CAD8C0)
#define CLASS_1_0C527859D2A4D822_METHOD_1_3FCC4C002DC2D451_OFFSET UNITYSDK_OFFSET(0x15CABAD0)
#define CLASS_1_0C527859D2A4D822_METHOD_1_411D8A50B429935B_OFFSET UNITYSDK_OFFSET(0x15CAE300)
#define CLASS_1_0C527859D2A4D822_METHOD_1_4E0A24C845EC6FB4_OFFSET UNITYSDK_OFFSET(0x15CAD250)
#define CLASS_1_0C527859D2A4D822_METHOD_1_5510AD63C455B78C_OFFSET UNITYSDK_OFFSET(0x15CAE620)
#define CLASS_1_0C527859D2A4D822_METHOD_1_59493E05A11A51B6_OFFSET UNITYSDK_OFFSET(0x15CACB90)
#define CLASS_1_0C527859D2A4D822_METHOD_1_66F12D48C275BB66_OFFSET UNITYSDK_OFFSET(0x15CAF1C0)
#define CLASS_1_0C527859D2A4D822_METHOD_1_739DB9F245C7FAD0_OFFSET UNITYSDK_OFFSET(0x15CAC4F0)
#define CLASS_1_0C527859D2A4D822_METHOD_1_8DA3FEE3379AFF0E_OFFSET UNITYSDK_OFFSET(0x15CAD190)
#define CLASS_1_0C527859D2A4D822_METHOD_1_9D66BACF8DC0F570_OFFSET UNITYSDK_OFFSET(0x15CAEEF0)
#define CLASS_1_0C527859D2A4D822_METHOD_1_A77870C566864FEA_OFFSET UNITYSDK_OFFSET(0x15CA9730)
#define CLASS_1_0C527859D2A4D822_METHOD_1_AE60CA4DC1D191FA_OFFSET UNITYSDK_OFFSET(0x15CAF580)
#define CLASS_1_0C527859D2A4D822_METHOD_1_AEEC2CD468679168_OFFSET UNITYSDK_OFFSET(0x15CAEC60)
#define CLASS_1_0C527859D2A4D822_METHOD_1_B3D2B69EB51C0319_OFFSET UNITYSDK_OFFSET(0x15CADA70)
#define CLASS_1_0C527859D2A4D822_METHOD_1_BEF13FC990763FD7_OFFSET UNITYSDK_OFFSET(0x15CAFB80)
#define CLASS_1_0C527859D2A4D822_METHOD_1_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0x15CAFCC0)
#define CLASS_1_0C527859D2A4D822_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x15CAE7B0)
#define CLASS_1_0C527859D2A4D822_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x15CADA30)
#define CLASS_1_0C527859D2A4D822_METHOD_1_E1AA70E07AA740FC_OFFSET UNITYSDK_OFFSET(0x15CABDB0)
#define CLASS_1_0C527859D2A4D822_METHOD_1_E224D5BA9A7D3068_OFFSET UNITYSDK_OFFSET(0x15CA9D30)
#define CLASS_1_0C527859D2A4D822_METHOD_1_EC90259991730611_OFFSET UNITYSDK_OFFSET(0x15CA9CE0)
#define CLASS_1_0C527859D2A4D822_METHOD_1_ED34DCC6F6541B09_OFFSET UNITYSDK_OFFSET(0x15CACB00)
#define CLASS_1_0C527859D2A4D822_TEARDOWN_OFFSET UNITYSDK_OFFSET(0x15CA9670)
#define CLASS_1_0C527859D2A4D822__CCTOR_OFFSET UNITYSDK_OFFSET(0x15CAFCD0)
#define CLASS_1_0C527859D2A4D822__CTOR_OFFSET UNITYSDK_OFFSET(0x15CA9360)

inline static constexpr unsigned int Class_1_0C527859D2A4D822_TypeDefinitionIndex = 71339;
...
public:
	...
	::Class_1_0C527859D2A4D822_Class_1_7C9CCB80E1B5D6D9* Field_1_1; // 0x10
	::Class_1_2CDF619C23140440* Field_1_2; // 0x18
	::Class_3_D6E9A038FA23103A* Field_1_3; // 0x20
	::Class_1_0C527859D2A4D822_Class_1_222A701F7C5EBAAC* Field_1_4; // 0x28
	::RPG::Client::LittleGame::FourRotateVoxel::FourRotateVoxelGlobalData* Field_1_5; // 0x30
	::UnityEngine::Transform* Field_1_6; // 0x38
	::UnityEngine::Transform* Field_1_7; // 0x40
	::Class_1_0C527859D2A4D822_Class_1_D8F4631EC8CFC015* Field_1_8; // 0x48
	...
	::System::Boolean Field_1_17; // 0x67
