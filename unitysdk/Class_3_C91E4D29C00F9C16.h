...
#define CLASS_3_C91E4D29C00F9C16_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x15FDDCE0)
#define CLASS_3_C91E4D29C00F9C16_ONSKIP_OFFSET UNITYSDK_OFFSET(0x15FDDCF0)
#define CLASS_3_C91E4D29C00F9C16_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x15FDDC30)
#define CLASS_3_C91E4D29C00F9C16__CTOR_OFFSET UNITYSDK_OFFSET(0x15FDDC00)
