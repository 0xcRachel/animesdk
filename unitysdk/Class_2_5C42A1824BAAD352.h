...
#define CLASS_2_5C42A1824BAAD352_DISPOSE_OFFSET UNITYSDK_OFFSET(0x884F510)
#define CLASS_2_5C42A1824BAAD352_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x884F550)
#define CLASS_2_5C42A1824BAAD352_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x884FA00)
#define CLASS_2_5C42A1824BAAD352_TICK_OFFSET UNITYSDK_OFFSET(0x884FA50)
#define CLASS_2_5C42A1824BAAD352__CTOR_OFFSET UNITYSDK_OFFSET(0x884F440)
...
{
public:
	::RPG::GameCore::SetDynamicEntityParam* Field_2_1; // 0x18
