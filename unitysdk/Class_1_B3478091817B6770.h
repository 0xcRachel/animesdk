...
#define CLASS_1_B3478091817B6770__CTOR_OFFSET UNITYSDK_OFFSET(0x159D52B0)
...
public:
	...
	::RPG::GameCore::GridFightTraitEffectChangeHintType Field_1_4; // 0x38
	::RPG::GameCore::GridFightTraitEffectChargeType Field_1_5; // 0x3C
