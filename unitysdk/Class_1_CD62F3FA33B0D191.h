...
#define CLASS_1_CD62F3FA33B0D191_GET_UPGRADEAVATARREPOSITORY_OFFSET UNITYSDK_OFFSET(0x10065100)
#define CLASS_1_CD62F3FA33B0D191_GET_UPGRADER_OFFSET UNITYSDK_OFFSET(0x100650E0)
#define CLASS_1_CD62F3FA33B0D191_METHOD_1_39ACF78FCAAF11A6_OFFSET UNITYSDK_OFFSET(0x10065210)
#define CLASS_1_CD62F3FA33B0D191_METHOD_1_544B12A5C10413F4_OFFSET UNITYSDK_OFFSET(0x10065120)
#define CLASS_1_CD62F3FA33B0D191_METHOD_1_9B73A6616A276412_OFFSET UNITYSDK_OFFSET(0x100652B0)
#define CLASS_1_CD62F3FA33B0D191_METHOD_1_DEB6FE86ADD2489D_OFFSET UNITYSDK_OFFSET(0x10065330)
#define CLASS_1_CD62F3FA33B0D191_SET_UPGRADEAVATARREPOSITORY_OFFSET UNITYSDK_OFFSET(0x10065110)
#define CLASS_1_CD62F3FA33B0D191_SET_UPGRADER_OFFSET UNITYSDK_OFFSET(0x100650F0)
#define CLASS_1_CD62F3FA33B0D191__CTOR_OFFSET UNITYSDK_OFFSET(0x10065470)

inline static constexpr unsigned int Class_1_CD62F3FA33B0D191_TypeDefinitionIndex = 49867;

class Class_1_CD62F3FA33B0D191 : public ::System::Object
{
public:
	::Class_0_16E4307DCC419505_559* _Upgrader_k__BackingField; // 0x10
	::Class_1_35EF8ACF9B94E295_1* _UpgradeAvatarRepository_k__BackingField; // 0x18
	...
	::Class_0_16E4307DCC419505_559* get_Upgrader()
	{
		return ((::Class_0_16E4307DCC419505_559*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_CD62F3FA33B0D191_GET_UPGRADER_OFFSET))(this);
	}

	::System::Void set_Upgrader(::Class_0_16E4307DCC419505_559* value)
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_559*))((::PBYTE)hIl2Cpp + CLASS_1_CD62F3FA33B0D191_SET_UPGRADER_OFFSET))(this, value);
	}
