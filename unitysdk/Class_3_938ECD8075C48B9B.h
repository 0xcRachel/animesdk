...
#define CLASS_3_938ECD8075C48B9B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10E236E0)
#define CLASS_3_938ECD8075C48B9B_METHOD_3_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x10E24D20)
#define CLASS_3_938ECD8075C48B9B_METHOD_3_8DF47EF45ABD2A6C_OFFSET UNITYSDK_OFFSET(0x10E24150)
#define CLASS_3_938ECD8075C48B9B_METHOD_3_AFC8215C57A0845A_OFFSET UNITYSDK_OFFSET(0x10E23BB0)
#define CLASS_3_938ECD8075C48B9B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10E237C0)
#define CLASS_3_938ECD8075C48B9B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10E240D0)
#define CLASS_3_938ECD8075C48B9B__CTOR_OFFSET UNITYSDK_OFFSET(0x10E23590)
#define CLASS_3_938ECD8075C48B9B___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10E24BB0)
#define CLASS_3_938ECD8075C48B9B___IFIXBASEPROXY_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10E24C50)
#define CLASS_3_938ECD8075C48B9B___IFIXBASEPROXY_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10E24CB0)

inline static constexpr unsigned int Class_3_938ECD8075C48B9B_TypeDefinitionIndex = 43242;

class Class_3_938ECD8075C48B9B : public ::Class_2_C6F81DCE38B0EBC4
{
public:
	::Class_3_BCCE950C2E8DF1F0* Field_3_1; // 0x30
	::Class_4_B1B95644AD770E5F* Field_3_2; // 0x38
	::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* Field_3_0; // 0x40
