...
#define CLASS_2_F8C893847DC1857A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x145F2D40)
#define CLASS_2_F8C893847DC1857A_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x145F2D80)
#define CLASS_2_F8C893847DC1857A_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x145F2E30)
#define CLASS_2_F8C893847DC1857A_TICK_OFFSET UNITYSDK_OFFSET(0x145F2E70)
#define CLASS_2_F8C893847DC1857A__CTOR_OFFSET UNITYSDK_OFFSET(0x145F2D30)
...
{
public:
	::RPG::GameCore::StartChimeraWorkRound* Field_2_0; // 0x18
