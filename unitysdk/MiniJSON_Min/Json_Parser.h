...
#define MINIJSON_MIN_JSON_PARSER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15D6F850)
#define MINIJSON_MIN_JSON_PARSER_EATWHITESPACE_OFFSET UNITYSDK_OFFSET(0x15D6F770)
#define MINIJSON_MIN_JSON_PARSER_GET_NEXTCHAR_OFFSET UNITYSDK_OFFSET(0x15D6F2A0)
#define MINIJSON_MIN_JSON_PARSER_GET_NEXTTOKEN_OFFSET UNITYSDK_OFFSET(0x15D6F4A0)
#define MINIJSON_MIN_JSON_PARSER_GET_NEXTWORD_OFFSET UNITYSDK_OFFSET(0x15D6F300)
#define MINIJSON_MIN_JSON_PARSER_GET_PEEKCHAR_OFFSET UNITYSDK_OFFSET(0x15D6F240)
#define MINIJSON_MIN_JSON_PARSER_PARSEARRAY_OFFSET UNITYSDK_OFFSET(0x15D6FFA0)
#define MINIJSON_MIN_JSON_PARSER_PARSEBYTOKEN_OFFSET UNITYSDK_OFFSET(0x15D70050)
#define MINIJSON_MIN_JSON_PARSER_PARSENUMBER_OFFSET UNITYSDK_OFFSET(0x15D700F0)
#define MINIJSON_MIN_JSON_PARSER_PARSEOBJECT_OFFSET UNITYSDK_OFFSET(0x15D6F8E0)
#define MINIJSON_MIN_JSON_PARSER_PARSESTRING_OFFSET UNITYSDK_OFFSET(0x15D6FA90)
#define MINIJSON_MIN_JSON_PARSER_PARSEVALUE_OFFSET UNITYSDK_OFFSET(0x15D6F8C0)
#define MINIJSON_MIN_JSON_PARSER_PARSE_OFFSET UNITYSDK_OFFSET(0x15D6EF40)
#define MINIJSON_MIN_JSON_PARSER__CTOR_OFFSET UNITYSDK_OFFSET(0x15D6F1C0)

namespace MiniJSON_Min
{
	inline static constexpr unsigned int Json_Parser_TypeDefinitionIndex = 31051;
