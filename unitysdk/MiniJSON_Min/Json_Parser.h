...
#define MINIJSON_MIN_JSON_PARSER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16436730)
#define MINIJSON_MIN_JSON_PARSER_EATWHITESPACE_OFFSET UNITYSDK_OFFSET(0x16436650)
#define MINIJSON_MIN_JSON_PARSER_GET_NEXTCHAR_OFFSET UNITYSDK_OFFSET(0x16436180)
#define MINIJSON_MIN_JSON_PARSER_GET_NEXTTOKEN_OFFSET UNITYSDK_OFFSET(0x16436380)
#define MINIJSON_MIN_JSON_PARSER_GET_NEXTWORD_OFFSET UNITYSDK_OFFSET(0x164361E0)
#define MINIJSON_MIN_JSON_PARSER_GET_PEEKCHAR_OFFSET UNITYSDK_OFFSET(0x16436120)
#define MINIJSON_MIN_JSON_PARSER_PARSEARRAY_OFFSET UNITYSDK_OFFSET(0x16436E80)
#define MINIJSON_MIN_JSON_PARSER_PARSEBYTOKEN_OFFSET UNITYSDK_OFFSET(0x16436F30)
#define MINIJSON_MIN_JSON_PARSER_PARSENUMBER_OFFSET UNITYSDK_OFFSET(0x16436FD0)
#define MINIJSON_MIN_JSON_PARSER_PARSEOBJECT_OFFSET UNITYSDK_OFFSET(0x164367C0)
#define MINIJSON_MIN_JSON_PARSER_PARSESTRING_OFFSET UNITYSDK_OFFSET(0x16436970)
#define MINIJSON_MIN_JSON_PARSER_PARSEVALUE_OFFSET UNITYSDK_OFFSET(0x164367A0)
#define MINIJSON_MIN_JSON_PARSER_PARSE_OFFSET UNITYSDK_OFFSET(0x16435E20)
#define MINIJSON_MIN_JSON_PARSER__CTOR_OFFSET UNITYSDK_OFFSET(0x164360A0)
