...
#define CLASS_2_C9BE3A943B19E203_DISPOSE_OFFSET UNITYSDK_OFFSET(0xE5B6A20)
#define CLASS_2_C9BE3A943B19E203_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0xE5B7400)
#define CLASS_2_C9BE3A943B19E203_METHOD_2_5021D4F5CE511BA1_OFFSET UNITYSDK_OFFSET(0xE5B6C60)
#define CLASS_2_C9BE3A943B19E203_ONSKIP_OFFSET UNITYSDK_OFFSET(0xE5B7410)
#define CLASS_2_C9BE3A943B19E203_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xE5B6A70)
#define CLASS_2_C9BE3A943B19E203_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xE5B7330)
#define CLASS_2_C9BE3A943B19E203_TICK_OFFSET UNITYSDK_OFFSET(0xE5B7390)
#define CLASS_2_C9BE3A943B19E203__CTOR_OFFSET UNITYSDK_OFFSET(0xE5B69D0)
...
{
public:
	::Class_2_705B862E649BF345* Field_2_4; // 0x18
