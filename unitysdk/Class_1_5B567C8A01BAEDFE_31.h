...
#define CLASS_1_5B567C8A01BAEDFE_31_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A467580)
#define CLASS_1_5B567C8A01BAEDFE_31_CLONE_OFFSET UNITYSDK_OFFSET(0x1A467390)
#define CLASS_1_5B567C8A01BAEDFE_31_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A467490)
#define CLASS_1_5B567C8A01BAEDFE_31_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A467400)
#define CLASS_1_5B567C8A01BAEDFE_31_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A4674E0)
#define CLASS_1_5B567C8A01BAEDFE_31_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A4675D0)
#define CLASS_1_5B567C8A01BAEDFE_31_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A4675A0)
#define CLASS_1_5B567C8A01BAEDFE_31_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A4672E0)
#define CLASS_1_5B567C8A01BAEDFE_31_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A467340)
#define CLASS_1_5B567C8A01BAEDFE_31_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A467510)
#define CLASS_1_5B567C8A01BAEDFE_31_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A467570)
#define CLASS_1_5B567C8A01BAEDFE_31__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A467620)
#define CLASS_1_5B567C8A01BAEDFE_31__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A467360)
#define CLASS_1_5B567C8A01BAEDFE_31__CTOR_OFFSET UNITYSDK_OFFSET(0x1A467350)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_31*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_31_TypeDefinitionIndex)->GetStaticField(0x41B70);
	}
