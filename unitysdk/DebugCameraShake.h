...
#define DEBUGCAMERASHAKE_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xB2BD340)
#define DEBUGCAMERASHAKE_METHOD_5_DA9EBD5F5A0C0204_OFFSET UNITYSDK_OFFSET(0xB2BD0A0)
#define DEBUGCAMERASHAKE_START_OFFSET UNITYSDK_OFFSET(0xB2BCD80)
#define DEBUGCAMERASHAKE_UPDATE_OFFSET UNITYSDK_OFFSET(0xB2BCF20)
#define DEBUGCAMERASHAKE__CTOR_OFFSET UNITYSDK_OFFSET(0xB2BD3C0)

inline static constexpr unsigned int DebugCameraShake_TypeDefinitionIndex = 37188;
