...
#define CLASS_4_B6AACEC5D32C6DA3_GETQUALITYFILTER_OFFSET UNITYSDK_OFFSET(0x10474B10)
#define CLASS_4_B6AACEC5D32C6DA3_GETTYPEID_OFFSET UNITYSDK_OFFSET(0x104752E0)
#define CLASS_4_B6AACEC5D32C6DA3_ONBEGINSCENELIGHTLODFADING_OFFSET UNITYSDK_OFFSET(0x10474FD0)
#define CLASS_4_B6AACEC5D32C6DA3_ONENDSCENELIGHTLODFADING_OFFSET UNITYSDK_OFFSET(0x10475040)
#define CLASS_4_B6AACEC5D32C6DA3_ONOBJECTENABLE_OFFSET UNITYSDK_OFFSET(0x10474C80)
#define CLASS_4_B6AACEC5D32C6DA3_ONSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x10474D50)
#define CLASS_4_B6AACEC5D32C6DA3_ONSCENELIGHTLODFADING_OFFSET UNITYSDK_OFFSET(0x10474EF0)
#define CLASS_4_B6AACEC5D32C6DA3_ONSETSCENELIGHTLOD_OFFSET UNITYSDK_OFFSET(0x104751A0)
#define CLASS_4_B6AACEC5D32C6DA3_UNSERIALIZEASYNC_OFFSET UNITYSDK_OFFSET(0x10474B60)
#define CLASS_4_B6AACEC5D32C6DA3__CTOR_OFFSET UNITYSDK_OFFSET(0x10474B00)
#define CLASS_4_B6AACEC5D32C6DA3___IFIXBASEPROXY_GETQUALITYFILTER_OFFSET UNITYSDK_OFFSET(0x10475330)
#define CLASS_4_B6AACEC5D32C6DA3___IFIXBASEPROXY_GETTYPEID_OFFSET UNITYSDK_OFFSET(0x10475420)
#define CLASS_4_B6AACEC5D32C6DA3___IFIXBASEPROXY_ONBEGINSCENELIGHTLODFADING_OFFSET UNITYSDK_OFFSET(0x104753F0)
#define CLASS_4_B6AACEC5D32C6DA3___IFIXBASEPROXY_ONENDSCENELIGHTLODFADING_OFFSET UNITYSDK_OFFSET(0x10475400)
#define CLASS_4_B6AACEC5D32C6DA3___IFIXBASEPROXY_ONOBJECTENABLE_OFFSET UNITYSDK_OFFSET(0x104753C0)
#define CLASS_4_B6AACEC5D32C6DA3___IFIXBASEPROXY_ONSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x104753D0)
#define CLASS_4_B6AACEC5D32C6DA3___IFIXBASEPROXY_ONSCENELIGHTLODFADING_OFFSET UNITYSDK_OFFSET(0x104753E0)
#define CLASS_4_B6AACEC5D32C6DA3___IFIXBASEPROXY_ONSETSCENELIGHTLOD_OFFSET UNITYSDK_OFFSET(0x10475410)
#define CLASS_4_B6AACEC5D32C6DA3___IFIXBASEPROXY_UNSERIALIZEASYNC_OFFSET UNITYSDK_OFFSET(0x104753B0)

inline static constexpr unsigned int Class_4_B6AACEC5D32C6DA3_TypeDefinitionIndex = 38759;
