...
#define CLASS_1_6B68BF08CE41EC5F_GET_UNIQUENAME_OFFSET UNITYSDK_OFFSET(0x167342B0)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_01BDAF089E563EBF_OFFSET UNITYSDK_OFFSET(0x16734200)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_02FE3E91638825D2_OFFSET UNITYSDK_OFFSET(0x16732AC0)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x167310A0)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_099C229CF1BB9083_OFFSET UNITYSDK_OFFSET(0x16733200)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_0B3092ADB189C6A2_OFFSET UNITYSDK_OFFSET(0x16731DD0)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_0F8B0C0D6923A506_OFFSET UNITYSDK_OFFSET(0x16732C30)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x16731920)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_1B9CC121BDC8766D_OFFSET UNITYSDK_OFFSET(0x16731360)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_1E325D3CDDFBC683_OFFSET UNITYSDK_OFFSET(0x16732310)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_24243725469ECB40_OFFSET UNITYSDK_OFFSET(0x167339C0)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_2566AD459572DFC3_OFFSET UNITYSDK_OFFSET(0x167321A0)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_26E509975F92479C_OFFSET UNITYSDK_OFFSET(0x16731680)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_283228DCA08F69C7_1_OFFSET UNITYSDK_OFFSET(0x16732B70)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_283228DCA08F69C7_OFFSET UNITYSDK_OFFSET(0x16732940)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_29E4C9AAAC329E6C_OFFSET UNITYSDK_OFFSET(0x16731FA0)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_33AC9EB73CAD7838_OFFSET UNITYSDK_OFFSET(0x167308F0)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_3CCEFF635DC9EF7B_OFFSET UNITYSDK_OFFSET(0x16732800)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_3CE8A1831DA14AB7_OFFSET UNITYSDK_OFFSET(0x16732570)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_46DF29ACE60986D7_OFFSET UNITYSDK_OFFSET(0x16731540)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_4A37AFB19C9B61F8_OFFSET UNITYSDK_OFFSET(0x16732220)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_4AB9012B5D01108B_OFFSET UNITYSDK_OFFSET(0x16734120)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_4BD2BFB48FF90060_OFFSET UNITYSDK_OFFSET(0x167310F0)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_5D3D37F2BAE9FB65_OFFSET UNITYSDK_OFFSET(0x16732E60)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_6C2FB5ADB3B81368_OFFSET UNITYSDK_OFFSET(0x16731A10)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_6E57D3559C10FFA9_OFFSET UNITYSDK_OFFSET(0x16733C90)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_6F592BA490B2EB87_OFFSET UNITYSDK_OFFSET(0x16732370)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_7865C2E7793795CC_OFFSET UNITYSDK_OFFSET(0x167328B0)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_79734A163132F053_OFFSET UNITYSDK_OFFSET(0x16732720)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_7C398F4FA6AEBB51_OFFSET UNITYSDK_OFFSET(0x16732440)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_82FDFD4FAE50986E_OFFSET UNITYSDK_OFFSET(0x16731210)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_8B5DB4ACDAC4F04A_OFFSET UNITYSDK_OFFSET(0x167324D0)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_921C3C3E09D59CD4_OFFSET UNITYSDK_OFFSET(0x167306E0)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_96A53A17AC5D0E93_OFFSET UNITYSDK_OFFSET(0x16731050)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_96E11419209C03EC_OFFSET UNITYSDK_OFFSET(0x16732B30)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_96F674FB9A99092A_OFFSET UNITYSDK_OFFSET(0x16732F20)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_A36150C5DCC8409E_1_OFFSET UNITYSDK_OFFSET(0x16733CE0)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x16731630)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_A66A64149D4F3438_OFFSET UNITYSDK_OFFSET(0x167309A0)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_AA357C2E4B6A63F8_OFFSET UNITYSDK_OFFSET(0x167337B0)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_AF769CD15806BD66_OFFSET UNITYSDK_OFFSET(0x16731980)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x167305C0)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_B4F2C80C7DC7A0B7_OFFSET UNITYSDK_OFFSET(0x16732FA0)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_C0B9D1B2E5611154_OFFSET UNITYSDK_OFFSET(0x167313D0)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_C3C02139EBFD4E4B_OFFSET UNITYSDK_OFFSET(0x167329D0)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_C5E2379477D97516_OFFSET UNITYSDK_OFFSET(0x16733410)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_C7BF9C1E6A78DCAB_OFFSET UNITYSDK_OFFSET(0x16733D30)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_C8AA73BEAA347C1E_OFFSET UNITYSDK_OFFSET(0x16733AF0)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_C9258AAEB225D88E_OFFSET UNITYSDK_OFFSET(0x167309F0)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x16730550)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x16730500)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_CD70A8B191B64E41_OFFSET UNITYSDK_OFFSET(0x16733290)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_DF249C0E36759C3F_OFFSET UNITYSDK_OFFSET(0x16732620)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_EADDF1782C977BCA_OFFSET UNITYSDK_OFFSET(0x167317F0)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_F4FDA15C28A64059_OFFSET UNITYSDK_OFFSET(0x16733100)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_F8DF86D6D932C67A_OFFSET UNITYSDK_OFFSET(0x16733350)
#define CLASS_1_6B68BF08CE41EC5F_METHOD_1_FD97D2244C0FF5A9_OFFSET UNITYSDK_OFFSET(0x167314E0)
#define CLASS_1_6B68BF08CE41EC5F_SET_UNIQUENAME_OFFSET UNITYSDK_OFFSET(0x167342C0)
#define CLASS_1_6B68BF08CE41EC5F__CTOR_OFFSET UNITYSDK_OFFSET(0x167342D0)

inline static constexpr unsigned int Class_1_6B68BF08CE41EC5F_TypeDefinitionIndex = 70410;
...
public:
	...
	::RPG::GameCore::CharacterModelComponent* Field_1_3; // 0x18
	::System::String* _UniqueName_k__BackingField; // 0x20
	::RPG::Client::AttachPointMapping* Field_1_5; // 0x28
	::Il2CppArray<::System::String*>* Field_1_6; // 0x30
	::RPG::GameCore::ModifyAdventureCharacterRunSpeedRatio* Field_1_7; // 0x38
	::RPG::GameCore::GameEntity* Field_1_8; // 0x40
	::System::Collections::Generic::List_1<::Class_1_82D1CF7388B55201*>* Field_1_9; // 0x48
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::Boolean))((::PBYTE)hIl2Cpp + CLASS_1_6B68BF08CE41EC5F_METHOD_1_6C2FB5ADB3B81368_OFFSET))(this, a1);
	}

	::System::Void Method_1_29E4C9AAAC329E6C(::System::String* a1, ::System::Boolean a2, ::System::Boolean a3)
	{
		return ((::System::Void(*)(::PVOID, ::System::String*, ::System::Boolean, ::System::Boolean))((::PBYTE)hIl2Cpp + CLASS_1_6B68BF08CE41EC5F_METHOD_1_29E4C9AAAC329E6C_OFFSET))(this, a1, a2, a3);
	}

	::System::Void Method_1_2566AD459572DFC3()
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_6B68BF08CE41EC5F_METHOD_1_2566AD459572DFC3_OFFSET))(this);
	}

	::RPG::GameCore::TaskContext* Method_1_4A37AFB19C9B61F8()
	{
		return ((::RPG::GameCore::TaskContext*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_6B68BF08CE41EC5F_METHOD_1_4A37AFB19C9B61F8_OFFSET))(this);
	}
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::String*, ::System::String*))((::PBYTE)hIl2Cpp + CLASS_1_6B68BF08CE41EC5F_METHOD_1_B4F2C80C7DC7A0B7_OFFSET))(this, a1, a2);
	}

	::System::Void Method_1_F4FDA15C28A64059(::System::Single a1)
	{
		return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + CLASS_1_6B68BF08CE41EC5F_METHOD_1_F4FDA15C28A64059_OFFSET))(this, a1);
	}
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::Int32, ::System::Action_2<::RPG::GameCore::CharacterInputData*, ::System::Single>*))((::PBYTE)hIl2Cpp + CLASS_1_6B68BF08CE41EC5F_METHOD_1_CD70A8B191B64E41_OFFSET))(this, a1, a2);
	}

	::System::Void Method_1_F8DF86D6D932C67A(::System::Int32 a1)
	{
		return ((::System::Void(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + CLASS_1_6B68BF08CE41EC5F_METHOD_1_F8DF86D6D932C67A_OFFSET))(this, a1);
	}

	::System::Void Method_1_C5E2379477D97516(::RPG::GameCore::GameEntity* a1, ::System::String* a2, ::RPG::MVector3 a3)
	{
		return ((::System::Void(*)(::PVOID, ::RPG::GameCore::GameEntity*, ::System::String*, ::RPG::MVector3))((::PBYTE)hIl2Cpp + CLASS_1_6B68BF08CE41EC5F_METHOD_1_C5E2379477D97516_OFFSET))(this, a1, a2, a3);
	}

	::System::Void Method_1_AA357C2E4B6A63F8(::RPG::GameCore::GameEntity* a1)
	{
		return ((::System::Void(*)(::PVOID, ::RPG::GameCore::GameEntity*))((::PBYTE)hIl2Cpp + CLASS_1_6B68BF08CE41EC5F_METHOD_1_AA357C2E4B6A63F8_OFFSET))(this, a1);
	}
