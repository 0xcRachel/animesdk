...
#define CLASS_2_B66B2B4A7689CC14_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10FEDCE0)
#define CLASS_2_B66B2B4A7689CC14_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10FEDC40)
#define CLASS_2_B66B2B4A7689CC14_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10FEDC90)
#define CLASS_2_B66B2B4A7689CC14_TICK_OFFSET UNITYSDK_OFFSET(0x10FEDD70)
#define CLASS_2_B66B2B4A7689CC14__CTOR_OFFSET UNITYSDK_OFFSET(0x10FEDAA0)

inline static constexpr unsigned int Class_2_B66B2B4A7689CC14_TypeDefinitionIndex = 46037;

class Class_2_B66B2B4A7689CC14 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::PropComponent* Field_2_0; // 0x18
	::RPG::GameCore::PuzzleBoxmanInBoard* Field_2_3; // 0x20
	::Class_1_69FF5DE516C87A66* Field_2_6; // 0x28
	::Class_3_BCCE950C2E8DF1F0* Field_2_5; // 0x30
	::Class_1_69FF5DE516C87A66* Field_2_7; // 0x38
	::RPG::Client::Prop::BoxmanPuzzleBoard* Field_2_1; // 0x40
