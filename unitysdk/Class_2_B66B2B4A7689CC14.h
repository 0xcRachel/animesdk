...
#define CLASS_2_B66B2B4A7689CC14_DISPOSE_OFFSET UNITYSDK_OFFSET(0x145D58F0)
#define CLASS_2_B66B2B4A7689CC14_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x145D5850)
#define CLASS_2_B66B2B4A7689CC14_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x145D58A0)
#define CLASS_2_B66B2B4A7689CC14_TICK_OFFSET UNITYSDK_OFFSET(0x145D5980)
#define CLASS_2_B66B2B4A7689CC14__CTOR_OFFSET UNITYSDK_OFFSET(0x145D56B0)
...
public:
	...
	::RPG::Client::Prop::BoxmanPuzzleBoard* Field_2_4; // 0x38
	::RPG::GameCore::PuzzleBoxmanInBoard* Field_2_5; // 0x40
