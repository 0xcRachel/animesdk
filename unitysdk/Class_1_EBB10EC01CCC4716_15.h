...
#define CLASS_1_EBB10EC01CCC4716_15_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17B1BAD0)
#define CLASS_1_EBB10EC01CCC4716_15_CLONE_OFFSET UNITYSDK_OFFSET(0x17B1B460)
#define CLASS_1_EBB10EC01CCC4716_15_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17B1B680)
#define CLASS_1_EBB10EC01CCC4716_15_EQUALS_OFFSET UNITYSDK_OFFSET(0x17B1B620)
#define CLASS_1_EBB10EC01CCC4716_15_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17B1B7D0)
#define CLASS_1_EBB10EC01CCC4716_15_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x17B1BE90)
#define CLASS_1_EBB10EC01CCC4716_15_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x17B1BDF0)
#define CLASS_1_EBB10EC01CCC4716_15_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x17B1B520)
#define CLASS_1_EBB10EC01CCC4716_15_METHOD_1_02A3D10A9D535169_2_OFFSET UNITYSDK_OFFSET(0x17B1B560)
#define CLASS_1_EBB10EC01CCC4716_15_METHOD_1_02A3D10A9D535169_3_OFFSET UNITYSDK_OFFSET(0x17B1B5A0)
#define CLASS_1_EBB10EC01CCC4716_15_METHOD_1_02A3D10A9D535169_4_OFFSET UNITYSDK_OFFSET(0x17B1B5C0)
#define CLASS_1_EBB10EC01CCC4716_15_METHOD_1_02A3D10A9D535169_5_OFFSET UNITYSDK_OFFSET(0x17B1B5E0)
#define CLASS_1_EBB10EC01CCC4716_15_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x17B1B500)
#define CLASS_1_EBB10EC01CCC4716_15_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x17B1B530)
#define CLASS_1_EBB10EC01CCC4716_15_METHOD_1_7786DC814C2FC3BE_2_OFFSET UNITYSDK_OFFSET(0x17B1B570)
#define CLASS_1_EBB10EC01CCC4716_15_METHOD_1_7786DC814C2FC3BE_3_OFFSET UNITYSDK_OFFSET(0x17B1B5B0)
#define CLASS_1_EBB10EC01CCC4716_15_METHOD_1_7786DC814C2FC3BE_4_OFFSET UNITYSDK_OFFSET(0x17B1B5D0)
#define CLASS_1_EBB10EC01CCC4716_15_METHOD_1_7786DC814C2FC3BE_5_OFFSET UNITYSDK_OFFSET(0x17B1B5F0)
#define CLASS_1_EBB10EC01CCC4716_15_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x17B1B510)
#define CLASS_1_EBB10EC01CCC4716_15_METHOD_1_8633AE51B23EBDFD_OFFSET UNITYSDK_OFFSET(0x17B1B590)
#define CLASS_1_EBB10EC01CCC4716_15_METHOD_1_C229FF62B898C0B2_OFFSET UNITYSDK_OFFSET(0x17B1B580)
#define CLASS_1_EBB10EC01CCC4716_15_METHOD_1_C74E50CBD41F0264_1_OFFSET UNITYSDK_OFFSET(0x17B1B610)
#define CLASS_1_EBB10EC01CCC4716_15_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x17B1B550)
#define CLASS_1_EBB10EC01CCC4716_15_METHOD_1_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0x17B1B600)
#define CLASS_1_EBB10EC01CCC4716_15_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x17B1B540)
#define CLASS_1_EBB10EC01CCC4716_15_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17B1B3E0)
#define CLASS_1_EBB10EC01CCC4716_15_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17B1B890)
#define CLASS_1_EBB10EC01CCC4716_15_WRITETO_OFFSET UNITYSDK_OFFSET(0x17B1B8F0)
#define CLASS_1_EBB10EC01CCC4716_15__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17B1B400)
#define CLASS_1_EBB10EC01CCC4716_15__CTOR_OFFSET UNITYSDK_OFFSET(0x17B1B3F0)
...
public:
	...
	::System::Boolean Field_1_18; // 0x25
