...
#define CLASS_1_735612C94F558EAE_1_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x178FB020)
#define CLASS_1_735612C94F558EAE_1_CLONE_OFFSET UNITYSDK_OFFSET(0x178FAB00)
#define CLASS_1_735612C94F558EAE_1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x178FAC50)
#define CLASS_1_735612C94F558EAE_1_EQUALS_OFFSET UNITYSDK_OFFSET(0x178FAB70)
#define CLASS_1_735612C94F558EAE_1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x178FAD00)
#define CLASS_1_735612C94F558EAE_1_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x178FB150)
#define CLASS_1_735612C94F558EAE_1_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x178FB0F0)
#define CLASS_1_735612C94F558EAE_1_METHOD_1_554199E0076172C5_1_OFFSET UNITYSDK_OFFSET(0x178FAB60)
#define CLASS_1_735612C94F558EAE_1_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x178FAB50)
#define CLASS_1_735612C94F558EAE_1_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x178FA980)
#define CLASS_1_735612C94F558EAE_1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x178FAEE0)
#define CLASS_1_735612C94F558EAE_1_WRITETO_OFFSET UNITYSDK_OFFSET(0x178FAF40)
#define CLASS_1_735612C94F558EAE_1__CCTOR_OFFSET UNITYSDK_OFFSET(0x178FB290)
#define CLASS_1_735612C94F558EAE_1__CTOR_1_OFFSET UNITYSDK_OFFSET(0x178FAA20)
#define CLASS_1_735612C94F558EAE_1__CTOR_OFFSET UNITYSDK_OFFSET(0x178FA990)

inline static constexpr unsigned int Class_1_735612C94F558EAE_1_TypeDefinitionIndex = 22504;
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_735612C94F558EAE_1_TypeDefinitionIndex)->GetStaticField(0x35970);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_5()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_735612C94F558EAE_1_TypeDefinitionIndex)->GetStaticField(0x35978);
	}
	...
	{
		return ((::Google::Protobuf::Collections::RepeatedField_1<::System::UInt32>*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_735612C94F558EAE_1_METHOD_1_554199E0076172C5_1_OFFSET))(this);
	}
