...
#define CLASS_3_2A374247BAE4A43F_EVALUATE_OFFSET UNITYSDK_OFFSET(0x12434110)
#define CLASS_3_2A374247BAE4A43F__CTOR_OFFSET UNITYSDK_OFFSET(0x12434030)
...
public:
	...
	::Class_2_C14C025AFA60DCA2* Field_3_2; // 0x30
