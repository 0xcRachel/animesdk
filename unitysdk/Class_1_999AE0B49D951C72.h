...
#define CLASS_1_999AE0B49D951C72_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x110049C0)
#define CLASS_1_999AE0B49D951C72_GET_ID_OFFSET UNITYSDK_OFFSET(0x110049B0)
#define CLASS_1_999AE0B49D951C72_METHOD_1_BCD1E469DC98ED41_OFFSET UNITYSDK_OFFSET(0x11004B00)
#define CLASS_1_999AE0B49D951C72_METHOD_1_F5ED99163B68DD63_OFFSET UNITYSDK_OFFSET(0x110049D0)
#define CLASS_1_999AE0B49D951C72__CTOR_OFFSET UNITYSDK_OFFSET(0x11004AF0)

inline static constexpr unsigned int Class_1_999AE0B49D951C72_TypeDefinitionIndex = 49684;

class Class_1_999AE0B49D951C72 : public ::System::Object
{
public:
	::RPG::GameCore::AvatarOutfitModelConfig* _Config_k__BackingField; // 0x10
	::RPG::GameCore::PlayerOutfitDetailRow* Field_1_0; // 0x18
