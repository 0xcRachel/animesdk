...
class Class_1_625758145D6457D4;
namespace RPG::GameCore { class DebateTestimonySetting; }
namespace RPG::GameCore { class TaskContext; }

#define CLASS_1_683BE54A4D4D4711_DISPOSE_OFFSET UNITYSDK_OFFSET(0xFD6BD30)
#define CLASS_1_683BE54A4D4D4711_GET_INDEX_OFFSET UNITYSDK_OFFSET(0xFD6CCB0)
#define CLASS_1_683BE54A4D4D4711_METHOD_1_09526F48C04056C9_OFFSET UNITYSDK_OFFSET(0xFD6C940)
#define CLASS_1_683BE54A4D4D4711_METHOD_1_3B7145E79424FB75_OFFSET UNITYSDK_OFFSET(0xFD6CAA0)
#define CLASS_1_683BE54A4D4D4711_METHOD_1_47FCE72550F759BF_OFFSET UNITYSDK_OFFSET(0xFD6C4F0)
#define CLASS_1_683BE54A4D4D4711_METHOD_1_7646FFE662147970_OFFSET UNITYSDK_OFFSET(0xFD6C650)
#define CLASS_1_683BE54A4D4D4711_METHOD_1_AC50AFCF33BB0AFB_OFFSET UNITYSDK_OFFSET(0xFD6C450)
#define CLASS_1_683BE54A4D4D4711_METHOD_1_F74C54985EDEDC9A_OFFSET UNITYSDK_OFFSET(0xFD6BFA0)
#define CLASS_1_683BE54A4D4D4711_SET_INDEX_OFFSET UNITYSDK_OFFSET(0xFD6CCC0)
#define CLASS_1_683BE54A4D4D4711__CTOR_OFFSET UNITYSDK_OFFSET(0xFD6BD20)

inline static constexpr unsigned int Class_1_683BE54A4D4D4711_TypeDefinitionIndex = 48084;

class Class_1_683BE54A4D4D4711 : public ::System::Object
{
public:
	::Class_1_310D67B31C67B0C3* Field_1_4; // 0x10
	::RPG::GameCore::TaskContext* Field_1_3; // 0x18
	::Class_1_625758145D6457D4* Field_1_1; // 0x20
	::Class_1_625758145D6457D4* Field_1_2; // 0x28
	...
	::Class_1_625758145D6457D4* Method_1_47FCE72550F759BF()
	{
		return ((::Class_1_625758145D6457D4*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_683BE54A4D4D4711_METHOD_1_47FCE72550F759BF_OFFSET))(this);
	}
