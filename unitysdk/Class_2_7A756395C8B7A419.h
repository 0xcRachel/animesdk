...
#define CLASS_2_7A756395C8B7A419_DISPOSE_OFFSET UNITYSDK_OFFSET(0x840FF80)
#define CLASS_2_7A756395C8B7A419_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x8410020)
#define CLASS_2_7A756395C8B7A419_METHOD_2_937F8473216A3162_OFFSET UNITYSDK_OFFSET(0x840FED0)
#define CLASS_2_7A756395C8B7A419_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x840FD10)
#define CLASS_2_7A756395C8B7A419_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x840FF30)
#define CLASS_2_7A756395C8B7A419_TICK_OFFSET UNITYSDK_OFFSET(0x840FFC0)
#define CLASS_2_7A756395C8B7A419__CTOR_OFFSET UNITYSDK_OFFSET(0x840FD00)

inline static constexpr unsigned int Class_2_7A756395C8B7A419_TypeDefinitionIndex = 45949;
...
public:
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_2_7A756395C8B7A419_METHOD_2_937F8473216A3162_OFFSET))(this);
	}
