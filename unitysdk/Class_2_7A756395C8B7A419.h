...
#define CLASS_2_7A756395C8B7A419_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14BD79B0)
#define CLASS_2_7A756395C8B7A419_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x14BD7A50)
#define CLASS_2_7A756395C8B7A419_METHOD_2_ABE7715DB28B2DD1_OFFSET UNITYSDK_OFFSET(0x14BD7900)
#define CLASS_2_7A756395C8B7A419_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x14BD76B0)
#define CLASS_2_7A756395C8B7A419_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x14BD7960)
#define CLASS_2_7A756395C8B7A419_TICK_OFFSET UNITYSDK_OFFSET(0x14BD79F0)
#define CLASS_2_7A756395C8B7A419__CTOR_OFFSET UNITYSDK_OFFSET(0x14BD76A0)
...
public:
	...
	::RPG::GameCore::PlayScreenCrack* Field_2_2; // 0x20
