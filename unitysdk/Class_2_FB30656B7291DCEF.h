...
#define CLASS_2_FB30656B7291DCEF_GET_FLAG_OFFSET UNITYSDK_OFFSET(0x1728B3E0)
#define CLASS_2_FB30656B7291DCEF_METHOD_2_05876B4B6F216569_OFFSET UNITYSDK_OFFSET(0x1728A9D0)
#define CLASS_2_FB30656B7291DCEF_METHOD_2_1269AF86FE25AECE_OFFSET UNITYSDK_OFFSET(0x1728B580)
#define CLASS_2_FB30656B7291DCEF_METHOD_2_3EDC18A5268B65E7_OFFSET UNITYSDK_OFFSET(0x1728B460)
#define CLASS_2_FB30656B7291DCEF_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x1728B520)
#define CLASS_2_FB30656B7291DCEF_METHOD_2_57B295B3B9273ACF_OFFSET UNITYSDK_OFFSET(0x1728B450)
#define CLASS_2_FB30656B7291DCEF_METHOD_2_775B6D644F07B554_OFFSET UNITYSDK_OFFSET(0x1728B440)
#define CLASS_2_FB30656B7291DCEF_METHOD_2_83693FD94A4D8C98_OFFSET UNITYSDK_OFFSET(0x1728AEB0)
#define CLASS_2_FB30656B7291DCEF_METHOD_2_9A90752C43418F0C_OFFSET UNITYSDK_OFFSET(0x1728A5D0)
#define CLASS_2_FB30656B7291DCEF_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x1728A930)
#define CLASS_2_FB30656B7291DCEF_METHOD_2_BBE3E1E8BB1B6701_OFFSET UNITYSDK_OFFSET(0x1728B4C0)
#define CLASS_2_FB30656B7291DCEF_METHOD_2_D9EF75A2D048B8A1_OFFSET UNITYSDK_OFFSET(0x1728AD20)
#define CLASS_2_FB30656B7291DCEF_METHOD_2_E41B6A823556FEEA_OFFSET UNITYSDK_OFFSET(0x1728A4C0)
#define CLASS_2_FB30656B7291DCEF_METHOD_2_E88DC1D3D084A0F1_OFFSET UNITYSDK_OFFSET(0x1728A520)
#define CLASS_2_FB30656B7291DCEF_METHOD_2_F6EB917C5A67C7BA_OFFSET UNITYSDK_OFFSET(0x1728A8E0)
#define CLASS_2_FB30656B7291DCEF_METHOD_2_F978A1D172468895_OFFSET UNITYSDK_OFFSET(0x1728AAD0)
#define CLASS_2_FB30656B7291DCEF__CCTOR_OFFSET UNITYSDK_OFFSET(0x1728B3F0)
#define CLASS_2_FB30656B7291DCEF__CTOR_OFFSET UNITYSDK_OFFSET(0x1728A420)
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_2_FB30656B7291DCEF_TypeDefinitionIndex)->GetStaticField(0x9CD0);
	}
	static ::System::Int32* StaticGet_Field_2_1()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_2_FB30656B7291DCEF_TypeDefinitionIndex)->GetStaticField(0x9CD4);
	}
	::RPG::GameCore::AdventureCharacterController* Field_2_2; // 0x68
	::RPG::GameCore::AdventureCharacterDataComponent* Field_2_3; // 0x70
	::RPG::GameCore::NPCComponent* Field_2_4; // 0x78
	::RPG::GameCore::TransformComponent* Field_2_5; // 0x80
