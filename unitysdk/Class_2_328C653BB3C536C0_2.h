...
#define CLASS_2_328C653BB3C536C0_2_GET_CASTER_OFFSET UNITYSDK_OFFSET(0xCE73230)
#define CLASS_2_328C653BB3C536C0_2_SET_CASTER_OFFSET UNITYSDK_OFFSET(0xCE73240)
#define CLASS_2_328C653BB3C536C0_2__CTOR_OFFSET UNITYSDK_OFFSET(0xCE73250)

inline static constexpr unsigned int Class_2_328C653BB3C536C0_2_TypeDefinitionIndex = 71165;
