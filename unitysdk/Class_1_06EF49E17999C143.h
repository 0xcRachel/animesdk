...
#define CLASS_1_06EF49E17999C143_GET_ENDBLACKCLOSEDELAYTIME_OFFSET UNITYSDK_OFFSET(0x10AF7200)
#define CLASS_1_06EF49E17999C143_GET_ENDMASKTALKSENTENCEID_OFFSET UNITYSDK_OFFSET(0x10AF7220)
#define CLASS_1_06EF49E17999C143_METHOD_1_0F30679B05E70FC1_OFFSET UNITYSDK_OFFSET(0x10AF7310)
#define CLASS_1_06EF49E17999C143_METHOD_1_18C3B129F2E38CCF_OFFSET UNITYSDK_OFFSET(0x10AF7700)
#define CLASS_1_06EF49E17999C143_METHOD_1_1D4018D4200358D0_1_OFFSET UNITYSDK_OFFSET(0x10AF7110)
#define CLASS_1_06EF49E17999C143_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x10AF70C0)
#define CLASS_1_06EF49E17999C143_METHOD_1_2418FEFB981244F8_OFFSET UNITYSDK_OFFSET(0x10AF81B0)
#define CLASS_1_06EF49E17999C143_METHOD_1_5D3D37F2BAE9FB65_OFFSET UNITYSDK_OFFSET(0x10AF7690)
#define CLASS_1_06EF49E17999C143_METHOD_1_73B8E5A7C1BFCA1F_OFFSET UNITYSDK_OFFSET(0x10AF7070)
#define CLASS_1_06EF49E17999C143_METHOD_1_8CC4F51B52E2959B_OFFSET UNITYSDK_OFFSET(0x10AF7980)
#define CLASS_1_06EF49E17999C143_METHOD_1_9B0C43B0B6D3BA9B_OFFSET UNITYSDK_OFFSET(0x10AF74D0)
#define CLASS_1_06EF49E17999C143_METHOD_1_9D88A62CD6A4BE52_1_OFFSET UNITYSDK_OFFSET(0x10AF71B0)
#define CLASS_1_06EF49E17999C143_METHOD_1_9D88A62CD6A4BE52_OFFSET UNITYSDK_OFFSET(0x10AF7160)
#define CLASS_1_06EF49E17999C143_METHOD_1_ABFE6A357B89C69A_OFFSET UNITYSDK_OFFSET(0x10AF7240)
#define CLASS_1_06EF49E17999C143_METHOD_1_B459C80289411CB8_OFFSET UNITYSDK_OFFSET(0x10AF8750)
#define CLASS_1_06EF49E17999C143_METHOD_1_C56C2DA0C65B5B18_OFFSET UNITYSDK_OFFSET(0x10AF7C30)
#define CLASS_1_06EF49E17999C143_METHOD_1_D872496C150B19B6_1_OFFSET UNITYSDK_OFFSET(0x10AF7020)
#define CLASS_1_06EF49E17999C143_METHOD_1_D872496C150B19B6_OFFSET UNITYSDK_OFFSET(0x10AF6FD0)
#define CLASS_1_06EF49E17999C143_METHOD_1_DC429EC719556AD7_OFFSET UNITYSDK_OFFSET(0x10AF8480)
#define CLASS_1_06EF49E17999C143_METHOD_1_DDDEE766A0E3D16C_OFFSET UNITYSDK_OFFSET(0x10AF75B0)
#define CLASS_1_06EF49E17999C143_METHOD_1_E4EC0FD7A76783C9_OFFSET UNITYSDK_OFFSET(0x10AF7620)
#define CLASS_1_06EF49E17999C143_METHOD_1_FE626CEDCE963542_OFFSET UNITYSDK_OFFSET(0x10AF7EF0)
#define CLASS_1_06EF49E17999C143_SET_ENDBLACKCLOSEDELAYTIME_OFFSET UNITYSDK_OFFSET(0x10AF7210)
#define CLASS_1_06EF49E17999C143_SET_ENDMASKTALKSENTENCEID_OFFSET UNITYSDK_OFFSET(0x10AF7230)
#define CLASS_1_06EF49E17999C143__CCTOR_OFFSET UNITYSDK_OFFSET(0x10AF8AE0)
#define CLASS_1_06EF49E17999C143__CTOR_OFFSET UNITYSDK_OFFSET(0x10AF8A10)
...
public:
	...
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_1_06EF49E17999C143_TypeDefinitionIndex)->GetStaticField(0xE530);
	}
	static ::System::Boolean* StaticGet_Field_1_1()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_1_06EF49E17999C143_TypeDefinitionIndex)->GetStaticField(0xE534);
	}
	// static const ::System::UInt32 Field_1_0 = 0x0; // 0x0
	::RPG::GameCore::PerformanceMaskStack_1<::RPG::GameCore::ScreenTransferType>* Field_1_9; // 0x10
	::RPG::GameCore::PerformanceMaskStack_1<::System::Boolean>* Field_1_11; // 0x18
	::RPG::GameCore::PerformanceMaskStack_1<::RPG::GameCore::CustomScreenTransferType>* Field_1_13; // 0x20
	::System::String* Field_1_15; // 0x28
	::RPG::GameCore::PerformanceMaskStack_1<::System::Boolean>* Field_1_10; // 0x30
	::RPG::GameCore::PerformanceMaskStack_1<::RPG::GameCore::StoryBlackType>* Field_1_8; // 0x38
	::RPG::GameCore::PerformanceMaskStack_1<::RPG::GameCore::StoryBlackType>* Field_1_7; // 0x40
	::RPG::GameCore::PerformanceMaskStack_1<::RPG::GameCore::CustomScreenTransferType>* Field_1_12; // 0x48
	::System::String* Field_1_4; // 0x50
	::RPG::GameCore::PerformanceSkipType Field_1_5; // 0x58
	::RPG::GameCore::ELevelPerformanceType Field_1_2; // 0x5C
	::System::UInt32 Field_1_3; // 0x60
	::System::UInt32 _EndMaskTalkSentenceID_k__BackingField; // 0x64
	::RPG::GameCore::PerformanceChangePlayerType Field_1_14; // 0x68
	::System::Single _EndBlackCloseDelayTime_k__BackingField; // 0x6C
