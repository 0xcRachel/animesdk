...
#define CLASS_1_06EF49E17999C143_GET_ENDBLACKCLOSEDELAYTIME_OFFSET UNITYSDK_OFFSET(0x86B23F0)
#define CLASS_1_06EF49E17999C143_GET_ENDMASKTALKSENTENCEID_OFFSET UNITYSDK_OFFSET(0x86B2410)
#define CLASS_1_06EF49E17999C143_METHOD_1_18C3B129F2E38CCF_OFFSET UNITYSDK_OFFSET(0x86B2900)
#define CLASS_1_06EF49E17999C143_METHOD_1_1D4018D4200358D0_1_OFFSET UNITYSDK_OFFSET(0x86B2300)
#define CLASS_1_06EF49E17999C143_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x86B22B0)
#define CLASS_1_06EF49E17999C143_METHOD_1_2418FEFB981244F8_OFFSET UNITYSDK_OFFSET(0x86B33B0)
#define CLASS_1_06EF49E17999C143_METHOD_1_5D3D37F2BAE9FB65_OFFSET UNITYSDK_OFFSET(0x86B2890)
#define CLASS_1_06EF49E17999C143_METHOD_1_73B8E5A7C1BFCA1F_OFFSET UNITYSDK_OFFSET(0x86B2260)
#define CLASS_1_06EF49E17999C143_METHOD_1_87B9DBEA11CD8D35_OFFSET UNITYSDK_OFFSET(0x86B27B0)
#define CLASS_1_06EF49E17999C143_METHOD_1_8CC4F51B52E2959B_OFFSET UNITYSDK_OFFSET(0x86B2B80)
#define CLASS_1_06EF49E17999C143_METHOD_1_970D5059FCBAD470_OFFSET UNITYSDK_OFFSET(0x86B2820)
#define CLASS_1_06EF49E17999C143_METHOD_1_9B0C43B0B6D3BA9B_1_OFFSET UNITYSDK_OFFSET(0x86B26D0)
#define CLASS_1_06EF49E17999C143_METHOD_1_9B0C43B0B6D3BA9B_OFFSET UNITYSDK_OFFSET(0x86B2500)
#define CLASS_1_06EF49E17999C143_METHOD_1_9D88A62CD6A4BE52_1_OFFSET UNITYSDK_OFFSET(0x86B23A0)
#define CLASS_1_06EF49E17999C143_METHOD_1_9D88A62CD6A4BE52_OFFSET UNITYSDK_OFFSET(0x86B2350)
#define CLASS_1_06EF49E17999C143_METHOD_1_ABFE6A357B89C69A_OFFSET UNITYSDK_OFFSET(0x86B2430)
#define CLASS_1_06EF49E17999C143_METHOD_1_B459C80289411CB8_OFFSET UNITYSDK_OFFSET(0x86B3950)
#define CLASS_1_06EF49E17999C143_METHOD_1_C56C2DA0C65B5B18_OFFSET UNITYSDK_OFFSET(0x86B2E30)
#define CLASS_1_06EF49E17999C143_METHOD_1_D872496C150B19B6_1_OFFSET UNITYSDK_OFFSET(0x86B2210)
#define CLASS_1_06EF49E17999C143_METHOD_1_D872496C150B19B6_OFFSET UNITYSDK_OFFSET(0x86B21C0)
#define CLASS_1_06EF49E17999C143_METHOD_1_DC429EC719556AD7_OFFSET UNITYSDK_OFFSET(0x86B3680)
#define CLASS_1_06EF49E17999C143_METHOD_1_FE626CEDCE963542_OFFSET UNITYSDK_OFFSET(0x86B30F0)
#define CLASS_1_06EF49E17999C143_SET_ENDBLACKCLOSEDELAYTIME_OFFSET UNITYSDK_OFFSET(0x86B2400)
#define CLASS_1_06EF49E17999C143_SET_ENDMASKTALKSENTENCEID_OFFSET UNITYSDK_OFFSET(0x86B2420)
#define CLASS_1_06EF49E17999C143__CCTOR_OFFSET UNITYSDK_OFFSET(0x86B3CE0)
#define CLASS_1_06EF49E17999C143__CTOR_OFFSET UNITYSDK_OFFSET(0x86B3C10)

inline static constexpr unsigned int Class_1_06EF49E17999C143_TypeDefinitionIndex = 42293;
...
public:
	...
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_1_06EF49E17999C143_TypeDefinitionIndex)->GetStaticField(0x66F0);
	}
	static ::System::Single* StaticGet_Field_1_16()
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_1_06EF49E17999C143_TypeDefinitionIndex)->GetStaticField(0x66F4);
	}
	// static const ::System::UInt32 Field_1_0 = 0x0; // 0x0
	::System::String* Field_1_15; // 0x10
	::RPG::GameCore::PerformanceMaskStack_1<::RPG::GameCore::ScreenTransferType>* Field_1_9; // 0x18
	::RPG::GameCore::PerformanceMaskStack_1<::System::Boolean>* Field_1_10; // 0x20
	::RPG::GameCore::PerformanceMaskStack_1<::RPG::GameCore::StoryBlackType>* Field_1_8; // 0x28
	::RPG::GameCore::PerformanceMaskStack_1<::RPG::GameCore::CustomScreenTransferType>* Field_1_13; // 0x30
	::RPG::GameCore::PerformanceMaskStack_1<::RPG::GameCore::StoryBlackType>* Field_1_7; // 0x38
	::RPG::GameCore::PerformanceMaskStack_1<::System::Boolean>* Field_1_11; // 0x40
	::System::String* Field_1_4; // 0x48
	::RPG::GameCore::PerformanceMaskStack_1<::RPG::GameCore::CustomScreenTransferType>* Field_1_12; // 0x50
	::System::Single _EndBlackCloseDelayTime_k__BackingField; // 0x58
	::RPG::GameCore::ELevelPerformanceType Field_1_2; // 0x5C
	::System::UInt32 Field_1_3; // 0x60
	::System::Boolean Field_1_6; // 0x64
	::RPG::GameCore::PerformanceSkipType Field_1_5; // 0x68
	::System::UInt32 _EndMaskTalkSentenceID_k__BackingField; // 0x6C
	::RPG::GameCore::PerformanceChangePlayerType Field_1_14; // 0x70
	...
	{
		return ((::System::Boolean(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_06EF49E17999C143_METHOD_1_87B9DBEA11CD8D35_OFFSET))(this);
	}
