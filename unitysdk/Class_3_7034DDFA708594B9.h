...
#define CLASS_3_7034DDFA708594B9_METHOD_3_00DC6C482249EA10_OFFSET UNITYSDK_OFFSET(0x109E8D60)
#define CLASS_3_7034DDFA708594B9_METHOD_3_84B92802FDAFF6C8_OFFSET UNITYSDK_OFFSET(0x109E8BE0)
#define CLASS_3_7034DDFA708594B9_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x109E8240)
#define CLASS_3_7034DDFA708594B9_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10C7FB10)
#define CLASS_3_7034DDFA708594B9_TICK_OFFSET UNITYSDK_OFFSET(0x109E88B0)
#define CLASS_3_7034DDFA708594B9__CTOR_OFFSET UNITYSDK_OFFSET(0x109E8220)
#define CLASS_3_7034DDFA708594B9___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x10C7FB60)

inline static constexpr unsigned int Class_3_7034DDFA708594B9_TypeDefinitionIndex = 41146;
...
public:
	...
	::RPG::Client::ElfRestaurantGameInstance* Field_3_8; // 0x38
	::Class_1_ADC27DBA8547EDD7* Field_3_3; // 0x40
	::RPG::Client::LittleGame::ElfRestaurantGameEntity* Field_3_2; // 0x48
	::RPG::Client::LittleGame::ElfRestaurantGameEntity* Field_3_7; // 0x50
