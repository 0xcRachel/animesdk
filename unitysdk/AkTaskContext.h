...
#define AKTASKCONTEXT_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x18415AE0)
#define AKTASKCONTEXT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x184159F0)
#define AKTASKCONTEXT_FINALIZE_OFFSET UNITYSDK_OFFSET(0x18415A70)
#define AKTASKCONTEXT_GETCPTR_OFFSET UNITYSDK_OFFSET(0x184158E0)
#define AKTASKCONTEXT_GET_UIDXTHREAD_OFFSET UNITYSDK_OFFSET(0x18415D40)
#define AKTASKCONTEXT_SETCPTR_OFFSET UNITYSDK_OFFSET(0x18415930)
#define AKTASKCONTEXT_SET_UIDXTHREAD_OFFSET UNITYSDK_OFFSET(0x18415C80)
#define AKTASKCONTEXT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18415DF0)
#define AKTASKCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x184158D0)

inline static constexpr unsigned int AkTaskContext_TypeDefinitionIndex = 33539;
