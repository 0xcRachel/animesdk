...
#define CLASS_2_DFC3EFB2BCCFA5C4_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD05C420)
#define CLASS_2_DFC3EFB2BCCFA5C4_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xD05C2D0)
#define CLASS_2_DFC3EFB2BCCFA5C4_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xD05C3D0)
#define CLASS_2_DFC3EFB2BCCFA5C4_TICK_OFFSET UNITYSDK_OFFSET(0xD05C480)
#define CLASS_2_DFC3EFB2BCCFA5C4__CTOR_OFFSET UNITYSDK_OFFSET(0xD05C2C0)
...
{
public:
	::RPG::GameCore::PropFastDeliverStartAim* Field_2_1; // 0x18
