...
#define CLASS_2_F6D6BC7033B88293_1_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x147BDDA0)
#define CLASS_2_F6D6BC7033B88293_1_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x147BDD50)
#define CLASS_2_F6D6BC7033B88293_1_METHOD_2_A2AA1AEE9C77D4D0_OFFSET UNITYSDK_OFFSET(0x147BDCA0)
#define CLASS_2_F6D6BC7033B88293_1__CTOR_OFFSET UNITYSDK_OFFSET(0x147BDDF0)
...
{
public:
	::Class_3_E566EAF4730F7493* Field_2_0; // 0x18
	::RPG::GameCore::GameEntity* Field_2_1; // 0x20
	::Class_1_70CCABA9DB985F52* Field_2_2; // 0x28
