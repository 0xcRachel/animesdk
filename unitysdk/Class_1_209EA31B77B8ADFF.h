...
#define CLASS_1_209EA31B77B8ADFF__CTOR_OFFSET UNITYSDK_OFFSET(0x190633C0)
...
public:
	...
	::RPG::GameCore::TRFCubeType Field_1_2; // 0x1C
	::RPG::Client::LittleGame::TRFOccupyType Field_1_3; // 0x20
