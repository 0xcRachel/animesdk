...
#define CLASS_3_CE63BD8467392821_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10F89EC0)
#define CLASS_3_CE63BD8467392821_ENTER_OFFSET UNITYSDK_OFFSET(0x10F89FD0)
#define CLASS_3_CE63BD8467392821_GETENVIRONMENTSYSTEM_OFFSET UNITYSDK_OFFSET(0x10F8A2A0)
#define CLASS_3_CE63BD8467392821_GETEVENTMANAGER_OFFSET UNITYSDK_OFFSET(0x10F8A3C0)
#define CLASS_3_CE63BD8467392821_GETGAMEPHASETYPE_OFFSET UNITYSDK_OFFSET(0x10F8A250)
#define CLASS_3_CE63BD8467392821_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x10F8A4B0)
#define CLASS_3_CE63BD8467392821_LEAVE_OFFSET UNITYSDK_OFFSET(0x10F8A050)
#define CLASS_3_CE63BD8467392821_METHOD_3_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x10F8A590)
#define CLASS_3_CE63BD8467392821_METHOD_3_AA169839CB93802A_OFFSET UNITYSDK_OFFSET(0x10F8A0D0)
#define CLASS_3_CE63BD8467392821_METHOD_3_B49D88BC9A93B09A_OFFSET UNITYSDK_OFFSET(0x10F8A540)
#define CLASS_3_CE63BD8467392821_TICK_OFFSET UNITYSDK_OFFSET(0x10F8A420)
#define CLASS_3_CE63BD8467392821__CTOR_OFFSET UNITYSDK_OFFSET(0x10F89CE0)

inline static constexpr unsigned int Class_3_CE63BD8467392821_TypeDefinitionIndex = 48399;

class Class_3_CE63BD8467392821 : public ::RPG::Client::GamePhase
{
public:
	::Class_1_2E7E8FCA88CEACA0* Field_3_1; // 0x18
	::Class_1_CAA8B23EA64BF072* Field_3_2; // 0x20
	::Class_1_1A41AEC3FE4CE438* Field_3_0; // 0x28
