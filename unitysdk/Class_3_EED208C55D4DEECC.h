...
#define CLASS_3_EED208C55D4DEECC_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11137520)
#define CLASS_3_EED208C55D4DEECC_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11137560)
#define CLASS_3_EED208C55D4DEECC__CTOR_OFFSET UNITYSDK_OFFSET(0x111374F0)
#define CLASS_3_EED208C55D4DEECC___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x111377A0)
