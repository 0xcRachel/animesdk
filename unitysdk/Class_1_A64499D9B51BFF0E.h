...
#define CLASS_1_A64499D9B51BFF0E_GET_AUTOBUBBLE_OFFSET UNITYSDK_OFFSET(0x9EFA8A0)
#define CLASS_1_A64499D9B51BFF0E_GET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x9EFA960)
#define CLASS_1_A64499D9B51BFF0E_GET_FAILINPUT_OFFSET UNITYSDK_OFFSET(0x9EFAA40)
#define CLASS_1_A64499D9B51BFF0E_GET_IGNORELOOP_OFFSET UNITYSDK_OFFSET(0x9EFA9E0)
#define CLASS_1_A64499D9B51BFF0E_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x9EFA860)
#define CLASS_1_A64499D9B51BFF0E_GET_INPUTNOTECOUNT_OFFSET UNITYSDK_OFFSET(0x9EFA8E0)
#define CLASS_1_A64499D9B51BFF0E_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x9EFA880)
#define CLASS_1_A64499D9B51BFF0E_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x9EFA9C0)
#define CLASS_1_A64499D9B51BFF0E_GET_ISFINISH_OFFSET UNITYSDK_OFFSET(0x9EFA9A0)
#define CLASS_1_A64499D9B51BFF0E_GET_OWNERMODE_OFFSET UNITYSDK_OFFSET(0x9EFA8C0)
#define CLASS_1_A64499D9B51BFF0E_GET_PERFECTINPUT_OFFSET UNITYSDK_OFFSET(0x9EFAA20)
#define CLASS_1_A64499D9B51BFF0E_GET_REALENDTIME_OFFSET UNITYSDK_OFFSET(0x9EFA920)
#define CLASS_1_A64499D9B51BFF0E_GET_REALSTARTTIME_OFFSET UNITYSDK_OFFSET(0x9EFA900)
#define CLASS_1_A64499D9B51BFF0E_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x9EFA940)
#define CLASS_1_A64499D9B51BFF0E_GET_SUCCESSINPUT_OFFSET UNITYSDK_OFFSET(0x9EFAA00)
#define CLASS_1_A64499D9B51BFF0E_GET_TUTORIALSCORE_OFFSET UNITYSDK_OFFSET(0x9EFA980)
#define CLASS_1_A64499D9B51BFF0E_METHOD_1_0A7E56A59F184B0A_OFFSET UNITYSDK_OFFSET(0x9EFA4B0)
#define CLASS_1_A64499D9B51BFF0E_METHOD_1_1D73A0E5F2CC5EAE_OFFSET UNITYSDK_OFFSET(0x9EFA280)
#define CLASS_1_A64499D9B51BFF0E_METHOD_1_391A84BCD9F51317_1_OFFSET UNITYSDK_OFFSET(0x9EFA800)
#define CLASS_1_A64499D9B51BFF0E_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x9EFA7B0)
#define CLASS_1_A64499D9B51BFF0E_METHOD_1_483116EDCB78C64A_OFFSET UNITYSDK_OFFSET(0x9EFA0D0)
#define CLASS_1_A64499D9B51BFF0E_METHOD_1_4E140453C4B32F06_OFFSET UNITYSDK_OFFSET(0x9EF9FD0)
#define CLASS_1_A64499D9B51BFF0E_METHOD_1_704182D469158D60_OFFSET UNITYSDK_OFFSET(0x9EF9A00)
#define CLASS_1_A64499D9B51BFF0E_METHOD_1_7EACFD3740004695_OFFSET UNITYSDK_OFFSET(0x9EFA440)
#define CLASS_1_A64499D9B51BFF0E_METHOD_1_8A0A7598F40AF704_OFFSET UNITYSDK_OFFSET(0x9EFA5A0)
#define CLASS_1_A64499D9B51BFF0E_METHOD_1_A9E21AEFB7D4CB48_OFFSET UNITYSDK_OFFSET(0x9EF9F20)
#define CLASS_1_A64499D9B51BFF0E_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x9EFA080)
#define CLASS_1_A64499D9B51BFF0E_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x9EFA030)
#define CLASS_1_A64499D9B51BFF0E_SET_AUTOBUBBLE_OFFSET UNITYSDK_OFFSET(0x9EFA8B0)
#define CLASS_1_A64499D9B51BFF0E_SET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x9EFA970)
#define CLASS_1_A64499D9B51BFF0E_SET_FAILINPUT_OFFSET UNITYSDK_OFFSET(0x9EFAA50)
#define CLASS_1_A64499D9B51BFF0E_SET_IGNORELOOP_OFFSET UNITYSDK_OFFSET(0x9EFA9F0)
#define CLASS_1_A64499D9B51BFF0E_SET_INDEX_OFFSET UNITYSDK_OFFSET(0x9EFA870)
#define CLASS_1_A64499D9B51BFF0E_SET_INPUTNOTECOUNT_OFFSET UNITYSDK_OFFSET(0x9EFA8F0)
#define CLASS_1_A64499D9B51BFF0E_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x9EFA890)
#define CLASS_1_A64499D9B51BFF0E_SET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x9EFA9D0)
#define CLASS_1_A64499D9B51BFF0E_SET_ISFINISH_OFFSET UNITYSDK_OFFSET(0x9EFA9B0)
#define CLASS_1_A64499D9B51BFF0E_SET_OWNERMODE_OFFSET UNITYSDK_OFFSET(0x9EFA8D0)
#define CLASS_1_A64499D9B51BFF0E_SET_PERFECTINPUT_OFFSET UNITYSDK_OFFSET(0x9EFAA30)
#define CLASS_1_A64499D9B51BFF0E_SET_REALENDTIME_OFFSET UNITYSDK_OFFSET(0x9EFA930)
#define CLASS_1_A64499D9B51BFF0E_SET_REALSTARTTIME_OFFSET UNITYSDK_OFFSET(0x9EFA910)
#define CLASS_1_A64499D9B51BFF0E_SET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x9EFA950)
#define CLASS_1_A64499D9B51BFF0E_SET_SUCCESSINPUT_OFFSET UNITYSDK_OFFSET(0x9EFAA10)
#define CLASS_1_A64499D9B51BFF0E_SET_TUTORIALSCORE_OFFSET UNITYSDK_OFFSET(0x9EFA990)
#define CLASS_1_A64499D9B51BFF0E__CCTOR_OFFSET UNITYSDK_OFFSET(0x9EFAA60)
#define CLASS_1_A64499D9B51BFF0E__CTOR_OFFSET UNITYSDK_OFFSET(0x9EF9020)
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A64499D9B51BFF0E_TypeDefinitionIndex)->GetStaticField(0x441A0);
	}
	::RPG::GameCore::GameEntity* Field_1_16; // 0x10
	::Il2CppArray<::System::String*>* Field_1_22; // 0x18
	::Il2CppArray<::System::String*>* Field_1_21; // 0x20
	::Class_1_C27C170A2F991DAF* _OwnerMode_k__BackingField; // 0x28
	::System::Collections::Generic::List_1<::System::Int32>* Field_1_14; // 0x30
	::System::Collections::Generic::List_1<::Class_1_502BA065E26E8F2F*>* Field_1_13; // 0x38
	::System::String* Field_1_23; // 0x40
	::System::UInt32 _InputNoteCount_k__BackingField; // 0x48
	::System::Int32 _PerfectInput_k__BackingField; // 0x4C
	::System::Single Field_1_25; // 0x50
	::System::Single Field_1_24; // 0x54
	::System::Boolean _TutorialScore_k__BackingField; // 0x58
	::System::Boolean _IsEmpty_k__BackingField; // 0x59
	::System::Boolean _IsFinish_k__BackingField; // 0x5A
	::System::Boolean _IgnoreLoop_k__BackingField; // 0x5B
	::System::Int32 Field_1_17; // 0x5C
	::System::Int32 _Index_k__BackingField; // 0x60
	::System::Int32 _SuccessInput_k__BackingField; // 0x64
	::System::Int32 _FailInput_k__BackingField; // 0x68
	...
	::System::Boolean _AutoBubble_k__BackingField; // 0x75
	::System::Single _EndTime_k__BackingField; // 0x78
	::System::Single _RealStartTime_k__BackingField; // 0x7C
