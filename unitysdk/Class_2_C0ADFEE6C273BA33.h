...
#define CLASS_2_C0ADFEE6C273BA33_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10E07190)
#define CLASS_2_C0ADFEE6C273BA33_METHOD_2_4389275F4099DE36_OFFSET UNITYSDK_OFFSET(0x10E06E20)
#define CLASS_2_C0ADFEE6C273BA33_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10E06BB0)
#define CLASS_2_C0ADFEE6C273BA33_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10E07100)
#define CLASS_2_C0ADFEE6C273BA33_TICK_OFFSET UNITYSDK_OFFSET(0x10E06C00)
#define CLASS_2_C0ADFEE6C273BA33__CTOR_OFFSET UNITYSDK_OFFSET(0x10E06BA0)

inline static constexpr unsigned int Class_2_C0ADFEE6C273BA33_TypeDefinitionIndex = 46428;

class Class_2_C0ADFEE6C273BA33 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::UIMonopolyTryTriggerTeleport* Field_2_0; // 0x20
