...
#define CLASS_1_B278F2E496DACE9A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10BE2EF0)
#define CLASS_1_B278F2E496DACE9A_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0x10BE2C10)
#define CLASS_1_B278F2E496DACE9A_METHOD_1_B877181B6123B7F6_OFFSET UNITYSDK_OFFSET(0x10BE2E30)
#define CLASS_1_B278F2E496DACE9A_METHOD_1_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0x10BE2C90)
#define CLASS_1_B278F2E496DACE9A_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x10BE2CA0)
#define CLASS_1_B278F2E496DACE9A_METHOD_1_F0E307B84478A272_1_OFFSET UNITYSDK_OFFSET(0x10BE2C70)
#define CLASS_1_B278F2E496DACE9A_METHOD_1_F0E307B84478A272_OFFSET UNITYSDK_OFFSET(0x10BE2C30)
#define CLASS_1_B278F2E496DACE9A_METHOD_1_FB4BE762B6186C23_OFFSET UNITYSDK_OFFSET(0x10BE2C50)
#define CLASS_1_B278F2E496DACE9A__CTOR_OFFSET UNITYSDK_OFFSET(0x10BE2CB0)

inline static constexpr unsigned int Class_1_B278F2E496DACE9A_TypeDefinitionIndex = 45051;

class Class_1_B278F2E496DACE9A : public ::System::Object
{
public:
	::Class_3_BCCE950C2E8DF1F0* Field_1_2; // 0x10
	::Class_1_D7003CCDED916330* Field_1_3; // 0x18
	::RPG::GameCore::FreeStyleAnimEventConfig* Field_1_0; // 0x20
