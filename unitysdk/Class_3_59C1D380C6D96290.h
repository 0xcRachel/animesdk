...
#define CLASS_3_59C1D380C6D96290_METHOD_3_80B76CA3BC860A58_OFFSET UNITYSDK_OFFSET(0x168B9EA0)
#define CLASS_3_59C1D380C6D96290__CTOR_OFFSET UNITYSDK_OFFSET(0x168B9BF0)
#define CLASS_3_59C1D380C6D96290__REGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x168B9D60)
#define CLASS_3_59C1D380C6D96290__UNREGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x168B9E00)
#define CLASS_3_59C1D380C6D96290___IFIXBASEPROXY__REGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x168BA070)
#define CLASS_3_59C1D380C6D96290___IFIXBASEPROXY__UNREGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x168BA080)
