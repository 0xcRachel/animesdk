...
#define MIHOYO_SDK_CONSOLEDELEGATE_SETSESSIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15800120)
#define MIHOYO_SDK_CONSOLEDELEGATE_SETSESSIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15800160)
#define MIHOYO_SDK_CONSOLEDELEGATE_SETSESSIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x157FF900)
#define MIHOYO_SDK_CONSOLEDELEGATE_SETSESSIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x157FF8E0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_SetSessionDelegate_TypeDefinitionIndex = 6525;
