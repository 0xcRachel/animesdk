...
#define MIHOYO_SDK_PROTOCOL_AWAKE_OFFSET UNITYSDK_OFFSET(0x158F28F0)
#define MIHOYO_SDK_PROTOCOL_CLICKACCEPTBUTTON_OFFSET UNITYSDK_OFFSET(0x158F3A50)
#define MIHOYO_SDK_PROTOCOL_CLICKREFUSEBUTTON_OFFSET UNITYSDK_OFFSET(0x158F3940)
#define MIHOYO_SDK_PROTOCOL_HIDE_OFFSET UNITYSDK_OFFSET(0x158F2840)
#define MIHOYO_SDK_PROTOCOL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x158F3BB0)
#define MIHOYO_SDK_PROTOCOL_ONHREFCLICK_OFFSET UNITYSDK_OFFSET(0x158F3A70)
#define MIHOYO_SDK_PROTOCOL_SHOW_OFFSET UNITYSDK_OFFSET(0x158F26F0)
#define MIHOYO_SDK_PROTOCOL_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x158F2E80)
#define MIHOYO_SDK_PROTOCOL__CLICKREFUSEBUTTON_B__30_0_OFFSET UNITYSDK_OFFSET(0x158F3C30)
#define MIHOYO_SDK_PROTOCOL__CTOR_OFFSET UNITYSDK_OFFSET(0x158F3BF0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int Protocol_TypeDefinitionIndex = 7118;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Protocol**)Il2CppClass::FromTypeDefinitionIndex(Protocol_TypeDefinitionIndex)->GetStaticField(0x172C0);
		}
		...
		::System::Action* OnUserAgreement; // 0x90
		::System::Action* OnUserPrivacy; // 0x98
		::System::Action* OnTeenagerUserAgreement; // 0xA0
		::System::Action* OnThirdPrivacy; // 0xA8
		::System::Boolean isUpdate; // 0xB0
		...
		::System::Void _ClickRefuseButton_b__30_0(::MiHoYo::SDK::Confirm_ConfirmResult result)
		{
			return ((::System::Void(*)(::PVOID, ::MiHoYo::SDK::Confirm_ConfirmResult))((::PBYTE)hIl2Cpp + MIHOYO_SDK_PROTOCOL__CLICKREFUSEBUTTON_B__30_0_OFFSET))(this, result);
		}
	};
}
