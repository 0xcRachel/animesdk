...
#define MIHOYO_SDK_MIHOYOSDKCONFIGMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x81C25C0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKConfigModel_TypeDefinitionIndex = 36166;
