...
#define MIHOYO_SDK_CONSOLE_OS_LOGINMANAGERCX_GENERATEACCESSTOKEN_OFFSET UNITYSDK_OFFSET(0x1578B2B0)
#define MIHOYO_SDK_CONSOLE_OS_LOGINMANAGERCX_GETPROTOCOLCHANNEL_OFFSET UNITYSDK_OFFSET(0x157899D0)
#define MIHOYO_SDK_CONSOLE_OS_LOGINMANAGERCX_GETUSERUNIQUEID_OFFSET UNITYSDK_OFFSET(0x1578B240)
#define MIHOYO_SDK_CONSOLE_OS_LOGINMANAGERCX_ISBINDINGACCOUNTSWITCHON_OFFSET UNITYSDK_OFFSET(0x1578B550)
#define MIHOYO_SDK_CONSOLE_OS_LOGINMANAGERCX_LOGREPORT_OFFSET UNITYSDK_OFFSET(0x1578B5B0)
#define MIHOYO_SDK_CONSOLE_OS_LOGINMANAGERCX_ONCONSOLELOGINCALLBACK_OFFSET UNITYSDK_OFFSET(0x157899E0)
#define MIHOYO_SDK_CONSOLE_OS_LOGINMANAGERCX_OPENURL_OFFSET UNITYSDK_OFFSET(0x1578B4C0)
#define MIHOYO_SDK_CONSOLE_OS_LOGINMANAGERCX_REQUESTSYNCFRIENDLIST_OFFSET UNITYSDK_OFFSET(0x1578BD50)
#define MIHOYO_SDK_CONSOLE_OS_LOGINMANAGERCX_SYNCFRIENDLIST_OFFSET UNITYSDK_OFFSET(0x1578B820)
#define MIHOYO_SDK_CONSOLE_OS_LOGINMANAGERCX__CTOR_OFFSET UNITYSDK_OFFSET(0x15766CE0)
#define MIHOYO_SDK_CONSOLE_OS_LOGINMANAGERCX__REQUESTSYNCFRIENDLIST_B__12_0_OFFSET UNITYSDK_OFFSET(0x1578C460)

namespace MiHoYo::SDK::Console::OS
{
	inline static constexpr unsigned int LoginManagerCX_TypeDefinitionIndex = 7571;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::String*))((::PBYTE)hIl2Cpp + MIHOYO_SDK_CONSOLE_OS_LOGINMANAGERCX_SYNCFRIENDLIST_OFFSET))(this, jsonString);
		}

		::System::Void RequestSyncFriendList(::System::String* token)
		{
			return ((::System::Void(*)(::PVOID, ::System::String*))((::PBYTE)hIl2Cpp + MIHOYO_SDK_CONSOLE_OS_LOGINMANAGERCX_REQUESTSYNCFRIENDLIST_OFFSET))(this, token);
		}

		::System::Void _RequestSyncFriendList_b__12_0(::MiHoYo::SDK::NetworkResponseModel* response)
		{
			return ((::System::Void(*)(::PVOID, ::MiHoYo::SDK::NetworkResponseModel*))((::PBYTE)hIl2Cpp + MIHOYO_SDK_CONSOLE_OS_LOGINMANAGERCX__REQUESTSYNCFRIENDLIST_B__12_0_OFFSET))(this, response);
		}
	};
}
