...
#define MIHOYO_SDK_MIHOYOSDKLINKIMAGETEXT_HREFINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x81D79E0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKLinkImageText_HrefInfo_TypeDefinitionIndex = 36285;
