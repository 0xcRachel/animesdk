...
#define MIHOYO_SDK_OVERSEAPROTOCOL___C__DISPLAYCLASS40_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15879AF0)
#define MIHOYO_SDK_OVERSEAPROTOCOL___C__DISPLAYCLASS40_0__SHOW_B__0_OFFSET UNITYSDK_OFFSET(0x1587CAE0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int OverseaProtocol___c__DisplayClass40_0_TypeDefinitionIndex = 7121;
