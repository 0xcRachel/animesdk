...
#define MIHOYO_SDK_WIN_COMBOMANAGER___C__DISPLAYCLASS36_0__CTOR_OFFSET UNITYSDK_OFFSET(0x159CDB80)
#define MIHOYO_SDK_WIN_COMBOMANAGER___C__DISPLAYCLASS36_0__SWITCHROLE_B__0_OFFSET UNITYSDK_OFFSET(0x159DC740)
#define MIHOYO_SDK_WIN_COMBOMANAGER___C__DISPLAYCLASS36_0__SWITCHROLE_B__1_OFFSET UNITYSDK_OFFSET(0x159DC860)
#define MIHOYO_SDK_WIN_COMBOMANAGER___C__DISPLAYCLASS36_0__SWITCHROLE_B__2_OFFSET UNITYSDK_OFFSET(0x159DC980)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int ComboManager___c__DisplayClass36_0_TypeDefinitionIndex = 7904;
