...
#define MIHOYO_SDK_WIN_REALNAMEMANAGER___C__DISPLAYCLASS34_0__CTOR_OFFSET UNITYSDK_OFFSET(0x157A6030)
#define MIHOYO_SDK_WIN_REALNAMEMANAGER___C__DISPLAYCLASS34_0__SHOWGRANTPHONEPLUGINUI_B__0_OFFSET UNITYSDK_OFFSET(0x157A8EF0)
#define MIHOYO_SDK_WIN_REALNAMEMANAGER___C__DISPLAYCLASS34_0__SHOWGRANTPHONEPLUGINUI_B__1_OFFSET UNITYSDK_OFFSET(0x157A8F10)
#define MIHOYO_SDK_WIN_REALNAMEMANAGER___C__DISPLAYCLASS34_0__SHOWGRANTPHONEPLUGINUI_B__2_OFFSET UNITYSDK_OFFSET(0x157A8F40)
#define MIHOYO_SDK_WIN_REALNAMEMANAGER___C__DISPLAYCLASS34_0__SHOWGRANTPHONEPLUGINUI_B__3_OFFSET UNITYSDK_OFFSET(0x157A9290)
#define MIHOYO_SDK_WIN_REALNAMEMANAGER___C__DISPLAYCLASS34_0__SHOWGRANTPHONEPLUGINUI_B__4_OFFSET UNITYSDK_OFFSET(0x157A92D0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int RealNameManager___c__DisplayClass34_0_TypeDefinitionIndex = 7837;
