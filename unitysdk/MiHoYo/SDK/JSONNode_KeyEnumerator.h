...
#define MIHOYO_SDK_JSONNODE_KEYENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x27670)
#define MIHOYO_SDK_JSONNODE_KEYENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1FFCA50)
...
{
	inline static constexpr unsigned int JSONNode_KeyEnumerator_TypeDefinitionIndex = 6999;
