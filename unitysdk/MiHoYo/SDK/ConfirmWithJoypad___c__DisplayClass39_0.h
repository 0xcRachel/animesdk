...
#define MIHOYO_SDK_CONFIRMWITHJOYPAD___C__DISPLAYCLASS39_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15731B10)
#define MIHOYO_SDK_CONFIRMWITHJOYPAD___C__DISPLAYCLASS39_0__SHOW_B__0_OFFSET UNITYSDK_OFFSET(0x15732EA0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConfirmWithJoypad___c__DisplayClass39_0_TypeDefinitionIndex = 6878;

	class ConfirmWithJoypad___c__DisplayClass39_0 : public ::System::Object
	{
	public:
		::System::String* strAcceptBtnText; // 0x10
		::MiHoYo::SDK::ConfirmWithJoypad_OnConfirmDelegate* callback; // 0x18
		::System::String* strContent; // 0x20
