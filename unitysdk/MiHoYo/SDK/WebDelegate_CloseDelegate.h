...
#define MIHOYO_SDK_WEBDELEGATE_CLOSEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15984930)
#define MIHOYO_SDK_WEBDELEGATE_CLOSEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15984960)
#define MIHOYO_SDK_WEBDELEGATE_CLOSEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15970E90)
#define MIHOYO_SDK_WEBDELEGATE_CLOSEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15984910)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_CloseDelegate_TypeDefinitionIndex = 6717;
