...
#define MIHOYO_SDK_HOYOSDKNETWORKINTERFACE_HTTPREQUESTPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x819D660)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HoYoSDKNetworkInterface_HttpRequestParams_TypeDefinitionIndex = 35952;

	class HoYoSDKNetworkInterface_HttpRequestParams : public ::System::Object
	{
	public:
		::System::String* m_strOptions; // 0x10
