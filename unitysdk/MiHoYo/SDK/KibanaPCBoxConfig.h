...
#define MIHOYO_SDK_KIBANAPCBOXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1584C2C0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int KibanaPCBoxConfig_TypeDefinitionIndex = 6801;
