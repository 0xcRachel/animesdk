...
#define STRUCT_2_84E8631222D334C4_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3824A10)
#define STRUCT_2_84E8631222D334C4_EQUALS_OFFSET UNITYSDK_OFFSET(0x38249A0)
#define STRUCT_2_84E8631222D334C4_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3824A20)
#define STRUCT_2_84E8631222D334C4_METHOD_2_46B919E408B0796B_OFFSET UNITYSDK_OFFSET(0x17512410)
#define STRUCT_2_84E8631222D334C4_METHOD_2_4FCB296A66368662_OFFSET UNITYSDK_OFFSET(0x17512510)
#define STRUCT_2_84E8631222D334C4_METHOD_2_512BE93F3A938825_OFFSET UNITYSDK_OFFSET(0x175122B0)
#define STRUCT_2_84E8631222D334C4_METHOD_2_D9271727AFC41EC6_OFFSET UNITYSDK_OFFSET(0x17512470)
#define STRUCT_2_84E8631222D334C4_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3824990)
#define STRUCT_2_84E8631222D334C4__CCTOR_OFFSET UNITYSDK_OFFSET(0x17512630)
#define STRUCT_2_84E8631222D334C4__CTOR_OFFSET UNITYSDK_OFFSET(0xA18540)
#define STRUCT_2_84E8631222D334C4___IFIXBASEPROXY_EQUALS_OFFSET UNITYSDK_OFFSET(0x3824B00)
#define STRUCT_2_84E8631222D334C4___IFIXBASEPROXY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3824B60)
#define STRUCT_2_84E8631222D334C4___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3824A80)
...
struct alignas(4) Struct_2_84E8631222D334C4
{
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_84E8631222D334C4_TypeDefinitionIndex)->GetStaticField(0x8FF0);
	}
	static ::Struct_2_84E8631222D334C4* StaticGet_Field_2_1()
	{
		return (::Struct_2_84E8631222D334C4*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_84E8631222D334C4_TypeDefinitionIndex)->GetStaticField(0x8FF4);
	}
