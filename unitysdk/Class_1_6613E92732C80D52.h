...
#define CLASS_1_6613E92732C80D52_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x120591B0)
#define CLASS_1_6613E92732C80D52_GET_BURNPOWER_OFFSET UNITYSDK_OFFSET(0x12057B90)
#define CLASS_1_6613E92732C80D52_GET_CHARGEPOWER_OFFSET UNITYSDK_OFFSET(0x12057BF0)
#define CLASS_1_6613E92732C80D52_GET_COOLDOWN_OFFSET UNITYSDK_OFFSET(0x12057B30)
#define CLASS_1_6613E92732C80D52_GET_DAMAGEPOWER_OFFSET UNITYSDK_OFFSET(0x12057B50)
#define CLASS_1_6613E92732C80D52_GET_HASTEPOWER_OFFSET UNITYSDK_OFFSET(0x12057BD0)
#define CLASS_1_6613E92732C80D52_GET_JAMPOWER_OFFSET UNITYSDK_OFFSET(0x12057C10)
#define CLASS_1_6613E92732C80D52_GET_MULTIPOWER_OFFSET UNITYSDK_OFFSET(0x12057BB0)
#define CLASS_1_6613E92732C80D52_GET_SHIELDPOWER_OFFSET UNITYSDK_OFFSET(0x12057B70)
#define CLASS_1_6613E92732C80D52_METHOD_1_621F8E54F3755EEC_OFFSET UNITYSDK_OFFSET(0x12058CC0)
#define CLASS_1_6613E92732C80D52_METHOD_1_633B64919EFDE65C_OFFSET UNITYSDK_OFFSET(0x12058D60)
#define CLASS_1_6613E92732C80D52_METHOD_1_E04788E18124DA4E_OFFSET UNITYSDK_OFFSET(0x12058220)
#define CLASS_1_6613E92732C80D52_METHOD_1_E66E75DC21E4F544_OFFSET UNITYSDK_OFFSET(0x12058800)
#define CLASS_1_6613E92732C80D52_METHOD_1_EC5A942F906ED2A6_OFFSET UNITYSDK_OFFSET(0x120581A0)
#define CLASS_1_6613E92732C80D52_METHOD_1_FECF6B2037779CA0_OFFSET UNITYSDK_OFFSET(0x12057C30)
#define CLASS_1_6613E92732C80D52_SET_BURNPOWER_OFFSET UNITYSDK_OFFSET(0x12057BA0)
#define CLASS_1_6613E92732C80D52_SET_CHARGEPOWER_OFFSET UNITYSDK_OFFSET(0x12057C00)
#define CLASS_1_6613E92732C80D52_SET_COOLDOWN_OFFSET UNITYSDK_OFFSET(0x12057B40)
#define CLASS_1_6613E92732C80D52_SET_DAMAGEPOWER_OFFSET UNITYSDK_OFFSET(0x12057B60)
#define CLASS_1_6613E92732C80D52_SET_HASTEPOWER_OFFSET UNITYSDK_OFFSET(0x12057BE0)
#define CLASS_1_6613E92732C80D52_SET_JAMPOWER_OFFSET UNITYSDK_OFFSET(0x12057C20)
#define CLASS_1_6613E92732C80D52_SET_MULTIPOWER_OFFSET UNITYSDK_OFFSET(0x12057BC0)
#define CLASS_1_6613E92732C80D52_SET_SHIELDPOWER_OFFSET UNITYSDK_OFFSET(0x12057B80)
#define CLASS_1_6613E92732C80D52__CTOR_OFFSET UNITYSDK_OFFSET(0x12058190)

inline static constexpr unsigned int Class_1_6613E92732C80D52_TypeDefinitionIndex = 73704;
...
public:
	...
	::RPG::GameCore::FixPoint _ChargePower_k__BackingField; // 0x20
	::RPG::GameCore::FixPoint _CoolDown_k__BackingField; // 0x28
	::RPG::GameCore::FixPoint _ShieldPower_k__BackingField; // 0x30
	::RPG::GameCore::FixPoint _JamPower_k__BackingField; // 0x38
	::RPG::GameCore::FixPoint _HastePower_k__BackingField; // 0x40
	::RPG::GameCore::FixPoint _DamagePower_k__BackingField; // 0x48
	::RPG::GameCore::FixPoint _MultiPower_k__BackingField; // 0x50
	::RPG::GameCore::FixPoint _BurnPower_k__BackingField; // 0x58
