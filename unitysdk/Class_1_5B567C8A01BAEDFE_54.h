...
#define CLASS_1_5B567C8A01BAEDFE_54_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A4E5750)
#define CLASS_1_5B567C8A01BAEDFE_54_CLONE_OFFSET UNITYSDK_OFFSET(0x1A4E55C0)
#define CLASS_1_5B567C8A01BAEDFE_54_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A4E5660)
#define CLASS_1_5B567C8A01BAEDFE_54_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A4E5600)
#define CLASS_1_5B567C8A01BAEDFE_54_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A4E56B0)
#define CLASS_1_5B567C8A01BAEDFE_54_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A4E57A0)
#define CLASS_1_5B567C8A01BAEDFE_54_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A4E5770)
#define CLASS_1_5B567C8A01BAEDFE_54_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A4E5540)
#define CLASS_1_5B567C8A01BAEDFE_54_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A4E5570)
#define CLASS_1_5B567C8A01BAEDFE_54_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A4E56E0)
#define CLASS_1_5B567C8A01BAEDFE_54_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A4E5740)
#define CLASS_1_5B567C8A01BAEDFE_54__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A4E57F0)
#define CLASS_1_5B567C8A01BAEDFE_54__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A4E5590)
#define CLASS_1_5B567C8A01BAEDFE_54__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4E5580)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_54*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_54_TypeDefinitionIndex)->GetStaticField(0xB190);
	}
