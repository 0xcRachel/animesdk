...
#define CLASS_1_79A623255817C58C_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A367900)
#define CLASS_1_79A623255817C58C_CLONE_OFFSET UNITYSDK_OFFSET(0x1A3673F0)
#define CLASS_1_79A623255817C58C_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A3674E0)
#define CLASS_1_79A623255817C58C_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A367480)
#define CLASS_1_79A623255817C58C_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A3675D0)
#define CLASS_1_79A623255817C58C_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A367B30)
#define CLASS_1_79A623255817C58C_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A367A70)
#define CLASS_1_79A623255817C58C_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1A367450)
#define CLASS_1_79A623255817C58C_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A3671C0)
#define CLASS_1_79A623255817C58C_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1A367470)
#define CLASS_1_79A623255817C58C_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x1A367440)
#define CLASS_1_79A623255817C58C_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1A367460)
#define CLASS_1_79A623255817C58C_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A367220)
#define CLASS_1_79A623255817C58C_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A367790)
#define CLASS_1_79A623255817C58C_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A3677F0)
#define CLASS_1_79A623255817C58C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A367C80)
#define CLASS_1_79A623255817C58C__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3672C0)
#define CLASS_1_79A623255817C58C__CTOR_OFFSET UNITYSDK_OFFSET(0x1A367230)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_79A623255817C58C_TypeDefinitionIndex)->GetStaticField(0x36260);
	}
	static ::Google::Protobuf::FieldCodec_1<::Class_1_1CBA230307F9C289_12*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_1CBA230307F9C289_12*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_79A623255817C58C_TypeDefinitionIndex)->GetStaticField(0x36268);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_79A623255817C58C*>** StaticGet_Field_1_2()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_79A623255817C58C*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_79A623255817C58C_TypeDefinitionIndex)->GetStaticField(0x36270);
	}
	...
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_1CBA230307F9C289_12*>* Field_1_8; // 0x20
