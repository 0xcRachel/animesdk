...
#define CLASS_2_764C2D7D755EF63E_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x9EF4ED0)
#define CLASS_2_764C2D7D755EF63E_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x9EF5010)
#define CLASS_2_764C2D7D755EF63E_METHOD_2_2FF79950A677C64B_OFFSET UNITYSDK_OFFSET(0x9EF29C0)
#define CLASS_2_764C2D7D755EF63E_METHOD_2_3D813D05865A080E_OFFSET UNITYSDK_OFFSET(0x9EF3FD0)
#define CLASS_2_764C2D7D755EF63E_METHOD_2_60E1F7F58CCF739F_OFFSET UNITYSDK_OFFSET(0x9EF35E0)
#define CLASS_2_764C2D7D755EF63E_METHOD_2_83DA3EC57FF907F4_OFFSET UNITYSDK_OFFSET(0x9EF2BD0)
#define CLASS_2_764C2D7D755EF63E_METHOD_2_8F8D080EF5D1D761_OFFSET UNITYSDK_OFFSET(0x9EF38A0)
#define CLASS_2_764C2D7D755EF63E_METHOD_2_93190E731E31C79A_OFFSET UNITYSDK_OFFSET(0x9EF3210)
#define CLASS_2_764C2D7D755EF63E_METHOD_2_9AB55F553C4AC6E8_OFFSET UNITYSDK_OFFSET(0x9EF2440)
#define CLASS_2_764C2D7D755EF63E_METHOD_2_A27D06F9481FAFDB_1_OFFSET UNITYSDK_OFFSET(0x9EF4E10)
#define CLASS_2_764C2D7D755EF63E_METHOD_2_A27D06F9481FAFDB_2_OFFSET UNITYSDK_OFFSET(0x9EF4E70)
#define CLASS_2_764C2D7D755EF63E_METHOD_2_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0x9EF4DB0)
#define CLASS_2_764C2D7D755EF63E_METHOD_2_A27DC2C5A103933A_OFFSET UNITYSDK_OFFSET(0x9EF3A10)
#define CLASS_2_764C2D7D755EF63E_METHOD_2_B710AD145420A84D_OFFSET UNITYSDK_OFFSET(0x9EF4A30)
#define CLASS_2_764C2D7D755EF63E_METHOD_2_BDAC3726B2B73008_OFFSET UNITYSDK_OFFSET(0x9EF40A0)
#define CLASS_2_764C2D7D755EF63E_METHOD_2_CE34EA208837238D_OFFSET UNITYSDK_OFFSET(0x9EF3180)
#define CLASS_2_764C2D7D755EF63E_METHOD_2_D737CD2779D51A4E_1_OFFSET UNITYSDK_OFFSET(0x9EF4410)
#define CLASS_2_764C2D7D755EF63E_METHOD_2_D737CD2779D51A4E_2_OFFSET UNITYSDK_OFFSET(0x9EF45F0)
#define CLASS_2_764C2D7D755EF63E_METHOD_2_D737CD2779D51A4E_OFFSET UNITYSDK_OFFSET(0x9EF4230)
#define CLASS_2_764C2D7D755EF63E_METHOD_2_DC10435BBECEAA26_OFFSET UNITYSDK_OFFSET(0x9EF2CE0)
#define CLASS_2_764C2D7D755EF63E_METHOD_2_E4F1C8A9FE0B98DF_1_OFFSET UNITYSDK_OFFSET(0x9EF4C70)
#define CLASS_2_764C2D7D755EF63E_METHOD_2_E4F1C8A9FE0B98DF_OFFSET UNITYSDK_OFFSET(0x9EF47D0)
#define CLASS_2_764C2D7D755EF63E__CTOR_OFFSET UNITYSDK_OFFSET(0x9EF5130)
#define CLASS_2_764C2D7D755EF63E__ONBIND_OFFSET UNITYSDK_OFFSET(0x9EF25A0)
#define CLASS_2_764C2D7D755EF63E__ONTICK_OFFSET UNITYSDK_OFFSET(0x9EF2390)
#define CLASS_2_764C2D7D755EF63E___IFIXBASEPROXY_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x9EF5370)
#define CLASS_2_764C2D7D755EF63E___IFIXBASEPROXY_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x9EF53D0)
#define CLASS_2_764C2D7D755EF63E___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0x9EF5310)
#define CLASS_2_764C2D7D755EF63E___IFIXBASEPROXY__ONTICK_OFFSET UNITYSDK_OFFSET(0x9EF52A0)

inline static constexpr unsigned int Class_2_764C2D7D755EF63E_TypeDefinitionIndex = 57574;
...
public:
	...
	::System::Collections::Generic::List_1<::Class_2_81A5344B7B5B2DAF*>* Field_2_9; // 0x70
	::UnityEngine::Transform* Field_2_2; // 0x78
	::UnityEngine::Transform* Field_2_0; // 0x80
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::UInt32>* Field_2_11; // 0x88
	::UnityEngine::UI::Button* Field_2_6; // 0x90
	::UnityEngine::UI::Button* Field_2_5; // 0x98
	::UnityEngine::Transform* Field_2_1; // 0xA0
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::GridFightTraitConfigBase*>* Field_2_10; // 0xA8
	::System::Collections::Generic::List_1<::Class_2_625068BFCA65C354*>* Field_2_8; // 0xB0
