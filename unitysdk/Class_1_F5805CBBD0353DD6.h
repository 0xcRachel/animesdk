...
#define CLASS_1_F5805CBBD0353DD6_CLEAR_OFFSET UNITYSDK_OFFSET(0x170203D0)
#define CLASS_1_F5805CBBD0353DD6_GET_ATMOSPHERECONFIG_OFFSET UNITYSDK_OFFSET(0x17020D40)
#define CLASS_1_F5805CBBD0353DD6_GET_SHOWEFFECT_OFFSET UNITYSDK_OFFSET(0x17020C30)
#define CLASS_1_F5805CBBD0353DD6_METHOD_1_6B72D4EE8C6E907F_OFFSET UNITYSDK_OFFSET(0x17020920)
#define CLASS_1_F5805CBBD0353DD6_METHOD_1_7646FFE662147970_OFFSET UNITYSDK_OFFSET(0x170208D0)
#define CLASS_1_F5805CBBD0353DD6_METHOD_1_A0FB610937DDCECC_OFFSET UNITYSDK_OFFSET(0x17020C50)
#define CLASS_1_F5805CBBD0353DD6_METHOD_1_BCCEF225A11BDA90_OFFSET UNITYSDK_OFFSET(0x17020520)
#define CLASS_1_F5805CBBD0353DD6_METHOD_1_D460460D84D0F4A2_OFFSET UNITYSDK_OFFSET(0x17020610)
#define CLASS_1_F5805CBBD0353DD6_METHOD_1_E9D89E37393D6CD0_OFFSET UNITYSDK_OFFSET(0x170207B0)
#define CLASS_1_F5805CBBD0353DD6_METHOD_1_F0BD65B017F2AC0B_OFFSET UNITYSDK_OFFSET(0x17020440)
#define CLASS_1_F5805CBBD0353DD6_SET_ATMOSPHERECONFIG_OFFSET UNITYSDK_OFFSET(0x17020D50)
#define CLASS_1_F5805CBBD0353DD6_SET_SHOWEFFECT_OFFSET UNITYSDK_OFFSET(0x17020C40)
#define CLASS_1_F5805CBBD0353DD6__CCTOR_OFFSET UNITYSDK_OFFSET(0x17020DA0)
#define CLASS_1_F5805CBBD0353DD6__CTOR_OFFSET UNITYSDK_OFFSET(0x17020D60)

inline static constexpr unsigned int Class_1_F5805CBBD0353DD6_TypeDefinitionIndex = 67449;

class Class_1_F5805CBBD0353DD6 : public ::System::Object
{
public:
	static ::System::Collections::Generic::Dictionary_2<::RPG::GameCore::ElationTimeAtmosphereType, ::Class_0_16E4307DCC419505_1031*>** StaticGet_Field_1_0()
	{
		return (::System::Collections::Generic::Dictionary_2<::RPG::GameCore::ElationTimeAtmosphereType, ::Class_0_16E4307DCC419505_1031*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_F5805CBBD0353DD6_TypeDefinitionIndex)->GetStaticField(0x617D0);
	}
	static ::Class_0_16E4307DCC419505_1031** StaticGet_Field_1_1()
	{
		return (::Class_0_16E4307DCC419505_1031**)Il2CppClass::FromTypeDefinitionIndex(Class_1_F5805CBBD0353DD6_TypeDefinitionIndex)->GetStaticField(0x617D8);
	}
