...
#define CLASS_1_5B567C8A01BAEDFE_335_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19C64CD0)
#define CLASS_1_5B567C8A01BAEDFE_335_CLONE_OFFSET UNITYSDK_OFFSET(0x19C64B40)
#define CLASS_1_5B567C8A01BAEDFE_335_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19C64BE0)
#define CLASS_1_5B567C8A01BAEDFE_335_EQUALS_OFFSET UNITYSDK_OFFSET(0x19C64B80)
#define CLASS_1_5B567C8A01BAEDFE_335_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19C64C30)
#define CLASS_1_5B567C8A01BAEDFE_335_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19C64D20)
#define CLASS_1_5B567C8A01BAEDFE_335_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19C64CF0)
#define CLASS_1_5B567C8A01BAEDFE_335_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19C64AC0)
#define CLASS_1_5B567C8A01BAEDFE_335_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19C64AF0)
#define CLASS_1_5B567C8A01BAEDFE_335_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19C64C60)
#define CLASS_1_5B567C8A01BAEDFE_335_WRITETO_OFFSET UNITYSDK_OFFSET(0x19C64CC0)
#define CLASS_1_5B567C8A01BAEDFE_335__CCTOR_OFFSET UNITYSDK_OFFSET(0x19C64D70)
#define CLASS_1_5B567C8A01BAEDFE_335__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19C64B10)
#define CLASS_1_5B567C8A01BAEDFE_335__CTOR_OFFSET UNITYSDK_OFFSET(0x19C64B00)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_335*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_335_TypeDefinitionIndex)->GetStaticField(0x18690);
	}
