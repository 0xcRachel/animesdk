...
#define CLASS_1_EC79926A4E5993F7_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17CFBBA0)
#define CLASS_1_EC79926A4E5993F7_CLONE_OFFSET UNITYSDK_OFFSET(0x17CFB530)
#define CLASS_1_EC79926A4E5993F7_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17CFB630)
#define CLASS_1_EC79926A4E5993F7_EQUALS_OFFSET UNITYSDK_OFFSET(0x17CFB5D0)
#define CLASS_1_EC79926A4E5993F7_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17CFB780)
#define CLASS_1_EC79926A4E5993F7_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x17CFBED0)
#define CLASS_1_EC79926A4E5993F7_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x17CFBD10)
#define CLASS_1_EC79926A4E5993F7_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x17CFB5A0)
#define CLASS_1_EC79926A4E5993F7_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x17CFB590)
#define CLASS_1_EC79926A4E5993F7_METHOD_1_6E1EC2DF63D7020F_1_OFFSET UNITYSDK_OFFSET(0x17CFB5C0)
#define CLASS_1_EC79926A4E5993F7_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x17CFB580)
#define CLASS_1_EC79926A4E5993F7_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x17CFB5B0)
#define CLASS_1_EC79926A4E5993F7_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17CFB350)
#define CLASS_1_EC79926A4E5993F7_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17CFBA00)
#define CLASS_1_EC79926A4E5993F7_WRITETO_OFFSET UNITYSDK_OFFSET(0x17CFBA60)
#define CLASS_1_EC79926A4E5993F7__CCTOR_OFFSET UNITYSDK_OFFSET(0x17CFC0C0)
#define CLASS_1_EC79926A4E5993F7__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17CFB410)
#define CLASS_1_EC79926A4E5993F7__CTOR_OFFSET UNITYSDK_OFFSET(0x17CFB360)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_C8A33C9C75E4FF8B*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_EC79926A4E5993F7_TypeDefinitionIndex)->GetStaticField(0xBEA0);
	}
	static ::Google::Protobuf::FieldCodec_1<::Class_1_5EB756264B1E13D9_3*>** StaticGet_Field_1_10()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_5EB756264B1E13D9_3*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_EC79926A4E5993F7_TypeDefinitionIndex)->GetStaticField(0xBEA8);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_5()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_EC79926A4E5993F7_TypeDefinitionIndex)->GetStaticField(0xBEB0);
	}
	...
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_C8A33C9C75E4FF8B*>* Field_1_3; // 0x10
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_5EB756264B1E13D9_3*>* Field_1_11; // 0x18
	::Class_1_6E708EAB438EC183_66* Field_1_8; // 0x20
