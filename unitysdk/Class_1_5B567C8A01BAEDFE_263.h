...
#define CLASS_1_5B567C8A01BAEDFE_263_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A2B2230)
#define CLASS_1_5B567C8A01BAEDFE_263_CLONE_OFFSET UNITYSDK_OFFSET(0x1A2B20A0)
#define CLASS_1_5B567C8A01BAEDFE_263_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A2B2140)
#define CLASS_1_5B567C8A01BAEDFE_263_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A2B20E0)
#define CLASS_1_5B567C8A01BAEDFE_263_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A2B2190)
#define CLASS_1_5B567C8A01BAEDFE_263_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A2B2280)
#define CLASS_1_5B567C8A01BAEDFE_263_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A2B2250)
#define CLASS_1_5B567C8A01BAEDFE_263_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A2B2020)
#define CLASS_1_5B567C8A01BAEDFE_263_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A2B2050)
#define CLASS_1_5B567C8A01BAEDFE_263_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A2B21C0)
#define CLASS_1_5B567C8A01BAEDFE_263_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A2B2220)
#define CLASS_1_5B567C8A01BAEDFE_263__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A2B22D0)
#define CLASS_1_5B567C8A01BAEDFE_263__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A2B2070)
#define CLASS_1_5B567C8A01BAEDFE_263__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2B2060)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_263*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_263_TypeDefinitionIndex)->GetStaticField(0x4A4A0);
	}
