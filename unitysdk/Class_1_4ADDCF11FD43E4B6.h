...
#define CLASS_1_4ADDCF11FD43E4B6_METHOD_1_0E62A1F7315AFBE8_OFFSET UNITYSDK_OFFSET(0x16436B40)
#define CLASS_1_4ADDCF11FD43E4B6_METHOD_1_FC218EB9B8045D08_OFFSET UNITYSDK_OFFSET(0x16436BB0)
#define CLASS_1_4ADDCF11FD43E4B6__CCTOR_OFFSET UNITYSDK_OFFSET(0x16436C20)
#define CLASS_1_4ADDCF11FD43E4B6__CTOR_OFFSET UNITYSDK_OFFSET(0x16436C10)

inline static constexpr unsigned int Class_1_4ADDCF11FD43E4B6_TypeDefinitionIndex = 21919;
...
public:
	...
	{
		return (::System::Collections::Generic::HashSet_1<::RPG::GameCore::TurnBasedModifierEvent>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_4ADDCF11FD43E4B6_TypeDefinitionIndex)->GetStaticField(0x2B4D0);
	}
	static ::System::Collections::Generic::HashSet_1<::System::Type*>** StaticGet_Field_1_0()
	{
		return (::System::Collections::Generic::HashSet_1<::System::Type*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_4ADDCF11FD43E4B6_TypeDefinitionIndex)->GetStaticField(0x2B4D8);
	}
