...
#define CLASS_2_3C8C00F3F8D7A848_GETSERVERBLOCKMANIFESTNAME_OFFSET UNITYSDK_OFFSET(0x109358E0)
#define CLASS_2_3C8C00F3F8D7A848_GETTYPENAME_OFFSET UNITYSDK_OFFSET(0x10935700)
#define CLASS_2_3C8C00F3F8D7A848_GET_BLOCKMANIFESTNAME_OFFSET UNITYSDK_OFFSET(0x109357E0)
#define CLASS_2_3C8C00F3F8D7A848_GET_BLOCKVERSIONNAME_OFFSET UNITYSDK_OFFSET(0x109357D0)
#define CLASS_2_3C8C00F3F8D7A848_GET_BUNDLEMANIFESTNAME_OFFSET UNITYSDK_OFFSET(0x109357C0)
#define CLASS_2_3C8C00F3F8D7A848_GET_BUNDLEVERSIONNAME_OFFSET UNITYSDK_OFFSET(0x109357B0)
#define CLASS_2_3C8C00F3F8D7A848_GET_DEFAULTABSOLUTEPATH_OFFSET UNITYSDK_OFFSET(0x10935750)
#define CLASS_2_3C8C00F3F8D7A848_GET_ISENABLE_OFFSET UNITYSDK_OFFSET(0x109357F0)
#define CLASS_2_3C8C00F3F8D7A848_GET_RELATIVEPATH_OFFSET UNITYSDK_OFFSET(0x10935780)
#define CLASS_2_3C8C00F3F8D7A848_METHOD_2_E815DACFC7B4951E_OFFSET UNITYSDK_OFFSET(0x10935A40)
#define CLASS_2_3C8C00F3F8D7A848_ONALLSUCCEED_OFFSET UNITYSDK_OFFSET(0x10935AD0)
#define CLASS_2_3C8C00F3F8D7A848_SET_ISENABLE_OFFSET UNITYSDK_OFFSET(0x10935800)
#define CLASS_2_3C8C00F3F8D7A848__CTOR_OFFSET UNITYSDK_OFFSET(0x10935B20)
#define CLASS_2_3C8C00F3F8D7A848__LOADINDEXINFO_OFFSET UNITYSDK_OFFSET(0x10935810)
#define CLASS_2_3C8C00F3F8D7A848___IFIXBASEPROXY_GETSERVERBLOCKMANIFESTNAME_OFFSET UNITYSDK_OFFSET(0x10935B50)
