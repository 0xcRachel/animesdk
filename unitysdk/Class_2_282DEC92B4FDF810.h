...
#define CLASS_2_282DEC92B4FDF810_GET_CLIENTPREDICATETIMESTAMPMS_OFFSET UNITYSDK_OFFSET(0x108E1F70)
#define CLASS_2_282DEC92B4FDF810_GET_CLIENTREPLAYTIMESTAMPMS_OFFSET UNITYSDK_OFFSET(0x108E1F90)
#define CLASS_2_282DEC92B4FDF810_GET_ISPAUSEREPLAY_OFFSET UNITYSDK_OFFSET(0x108E1FB0)
#define CLASS_2_282DEC92B4FDF810_METHOD_2_02DC14AEDD53F663_OFFSET UNITYSDK_OFFSET(0x108E10D0)
#define CLASS_2_282DEC92B4FDF810_METHOD_2_102A1038C38883F3_OFFSET UNITYSDK_OFFSET(0x108E1D30)
#define CLASS_2_282DEC92B4FDF810_METHOD_2_17BD30EFE8176014_OFFSET UNITYSDK_OFFSET(0x108E0ED0)
#define CLASS_2_282DEC92B4FDF810_METHOD_2_2F5AC4358F4D89A9_OFFSET UNITYSDK_OFFSET(0x108E1F50)
#define CLASS_2_282DEC92B4FDF810_METHOD_2_3C029C534AE1FB6B_OFFSET UNITYSDK_OFFSET(0x108E1820)
#define CLASS_2_282DEC92B4FDF810_METHOD_2_4484591CA1060976_OFFSET UNITYSDK_OFFSET(0x108E1530)
#define CLASS_2_282DEC92B4FDF810_METHOD_2_4E84FD21E7EECC5B_OFFSET UNITYSDK_OFFSET(0x108E13E0)
#define CLASS_2_282DEC92B4FDF810_METHOD_2_8F4CDE31FF46216D_1_OFFSET UNITYSDK_OFFSET(0x108E1C60)
#define CLASS_2_282DEC92B4FDF810_METHOD_2_8F4CDE31FF46216D_OFFSET UNITYSDK_OFFSET(0x108E1B90)
#define CLASS_2_282DEC92B4FDF810_METHOD_2_9407410AABC43F0E_OFFSET UNITYSDK_OFFSET(0x108E1F60)
#define CLASS_2_282DEC92B4FDF810_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x108E0830)
#define CLASS_2_282DEC92B4FDF810_METHOD_2_E5695720AB0F6E98_OFFSET UNITYSDK_OFFSET(0x108E1220)
#define CLASS_2_282DEC92B4FDF810_METHOD_2_F239777256F9BA8F_1_OFFSET UNITYSDK_OFFSET(0x108E1FE0)
#define CLASS_2_282DEC92B4FDF810_METHOD_2_F239777256F9BA8F_OFFSET UNITYSDK_OFFSET(0x108E1FD0)
#define CLASS_2_282DEC92B4FDF810_SET_CLIENTPREDICATETIMESTAMPMS_OFFSET UNITYSDK_OFFSET(0x108E1F80)
#define CLASS_2_282DEC92B4FDF810_SET_CLIENTREPLAYTIMESTAMPMS_OFFSET UNITYSDK_OFFSET(0x108E1FA0)
#define CLASS_2_282DEC92B4FDF810_SET_ISPAUSEREPLAY_OFFSET UNITYSDK_OFFSET(0x108E1FC0)
#define CLASS_2_282DEC92B4FDF810__CANLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x108E1630)
#define CLASS_2_282DEC92B4FDF810__CTOR_OFFSET UNITYSDK_OFFSET(0x108E1FF0)
#define CLASS_2_282DEC92B4FDF810__ONCLEAR_OFFSET UNITYSDK_OFFSET(0x108E1A90)
#define CLASS_2_282DEC92B4FDF810__ONINIT_OFFSET UNITYSDK_OFFSET(0x108E0870)
#define CLASS_2_282DEC92B4FDF810__ONLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x108E1670)
#define CLASS_2_282DEC92B4FDF810__ONSTART_OFFSET UNITYSDK_OFFSET(0x108E0A70)
#define CLASS_2_282DEC92B4FDF810__ONTICK_OFFSET UNITYSDK_OFFSET(0x108E0B90)
#define CLASS_2_282DEC92B4FDF810___IFIXBASEPROXY__CANLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x108E2280)
#define CLASS_2_282DEC92B4FDF810___IFIXBASEPROXY__ONCLEAR_OFFSET UNITYSDK_OFFSET(0x108E21B0)
#define CLASS_2_282DEC92B4FDF810___IFIXBASEPROXY__ONINIT_OFFSET UNITYSDK_OFFSET(0x108E20E0)
#define CLASS_2_282DEC92B4FDF810___IFIXBASEPROXY__ONLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x108E22F0)
#define CLASS_2_282DEC92B4FDF810___IFIXBASEPROXY__ONSTART_OFFSET UNITYSDK_OFFSET(0x108E2150)
#define CLASS_2_282DEC92B4FDF810___IFIXBASEPROXY__ONTICK_OFFSET UNITYSDK_OFFSET(0x108E2210)

inline static constexpr unsigned int Class_2_282DEC92B4FDF810_TypeDefinitionIndex = 49052;

class Class_2_282DEC92B4FDF810 : public ::Class_1_151B93D9C4BBDCA4
{
public:
	::System::Action* Field_2_2; // 0x78
	::Class_0_16E4307DCC419505_30* Field_2_10; // 0x80
	::System::Action_2<::System::UInt32, ::Google::Protobuf::ByteString*>* Field_2_0; // 0x88
	::System::Action_2<::System::UInt32, ::Google::Protobuf::ByteString*>* Field_2_1; // 0x90
	::Class_3_C66DEDBB208C643C* Field_2_8; // 0x98
	::Class_3_C96CADB16834C680* Field_2_9; // 0xA0
	::System::Collections::Generic::List_1<::System::Int32>* Field_2_12; // 0xA8
	::System::UInt32 Field_2_14; // 0xB0
	::System::UInt32 Field_2_13; // 0xB4
	::System::UInt64 _ClientPredicateTimeStampMs_k__BackingField; // 0xB8
	::Class_1_3DA1D1484278689C_ReceiveMode Field_2_11; // 0xC0
	::System::UInt32 Field_2_15; // 0xC4
	::System::UInt64 _ClientReplayTimeStampMs_k__BackingField; // 0xC8
	::System::Boolean Field_2_6; // 0xD0
	::RPG::Client::LittleGameShare::LittleGameClientNetMode Field_2_7; // 0xD1
	::System::Boolean _IsPauseReplay_k__BackingField; // 0xD2
