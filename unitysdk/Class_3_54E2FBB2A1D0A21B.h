...
#define CLASS_3_54E2FBB2A1D0A21B_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x13599070)
#define CLASS_3_54E2FBB2A1D0A21B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x13598AE0)
#define CLASS_3_54E2FBB2A1D0A21B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x135990C0)
#define CLASS_3_54E2FBB2A1D0A21B__CTOR_OFFSET UNITYSDK_OFFSET(0x13598AB0)
