...
#define CLASS_3_54E2FBB2A1D0A21B_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x1459B360)
#define CLASS_3_54E2FBB2A1D0A21B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1459ADF0)
#define CLASS_3_54E2FBB2A1D0A21B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1459B3B0)
#define CLASS_3_54E2FBB2A1D0A21B__CTOR_OFFSET UNITYSDK_OFFSET(0x1459ADC0)
