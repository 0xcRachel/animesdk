...
#define SKIRTIK_AWAKE_OFFSET UNITYSDK_OFFSET(0xA68F290)
#define SKIRTIK_COLLECTTHREADDATA_OFFSET UNITYSDK_OFFSET(0xA68C2B0)
#define SKIRTIK_DISABLEHAIRCUSTOMCURVEOFFSET_OFFSET UNITYSDK_OFFSET(0xA68F1F0)
#define SKIRTIK_FLUSHTHREADDATA_OFFSET UNITYSDK_OFFSET(0xA68E840)
#define SKIRTIK_GETCURVEEVALUATEVALUE_OFFSET UNITYSDK_OFFSET(0xA691B80)
#define SKIRTIK_GETPERFORMANCERUNTIMECACHE_OFFSET UNITYSDK_OFFSET(0xA68BE10)
#define SKIRTIK_GETREFERENCETRANSFORMS_OFFSET UNITYSDK_OFFSET(0xA68BF30)
#define SKIRTIK_GETWEIGHT_OFFSET UNITYSDK_OFFSET(0xA691A80)
#define SKIRTIK_GET_ISPROCESSABLE_OFFSET UNITYSDK_OFFSET(0xA68E910)
#define SKIRTIK_METHOD_5_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0xA68F4B0)
#define SKIRTIK_METHOD_5_1F16A901C7196AE0_OFFSET UNITYSDK_OFFSET(0xA691F70)
#define SKIRTIK_METHOD_5_22D0ADB352880F38_OFFSET UNITYSDK_OFFSET(0xA691D00)
#define SKIRTIK_METHOD_5_2D95DBC40C7D5B7C_OFFSET UNITYSDK_OFFSET(0xA692F00)
#define SKIRTIK_METHOD_5_34AB4F926DABC1DA_OFFSET UNITYSDK_OFFSET(0xA68F720)
#define SKIRTIK_METHOD_5_35942D7A8A374AB0_OFFSET UNITYSDK_OFFSET(0xA68EE70)
#define SKIRTIK_METHOD_5_50C6F82CE7A6278C_OFFSET UNITYSDK_OFFSET(0xA693970)
#define SKIRTIK_METHOD_5_54C4999AD8BA51B0_OFFSET UNITYSDK_OFFSET(0xA693A50)
#define SKIRTIK_METHOD_5_6068163BEEE00EFE_OFFSET UNITYSDK_OFFSET(0xA693BA0)
#define SKIRTIK_METHOD_5_8295FA3648427122_OFFSET UNITYSDK_OFFSET(0xA691C60)
#define SKIRTIK_METHOD_5_8AEAC92E3736F3D4_OFFSET UNITYSDK_OFFSET(0xA690BB0)
#define SKIRTIK_METHOD_5_96F4DD40F689F030_OFFSET UNITYSDK_OFFSET(0xA6919B0)
#define SKIRTIK_METHOD_5_98CD66A7F3C102A5_OFFSET UNITYSDK_OFFSET(0xA694B00)
#define SKIRTIK_METHOD_5_99CF361B540397A6_OFFSET UNITYSDK_OFFSET(0xA693B00)
#define SKIRTIK_METHOD_5_A08017A2F974EDA8_OFFSET UNITYSDK_OFFSET(0xA691D90)
#define SKIRTIK_METHOD_5_B9A97467188E4B69_OFFSET UNITYSDK_OFFSET(0xA6951C0)
#define SKIRTIK_METHOD_5_C5F9823D509784CD_1_OFFSET UNITYSDK_OFFSET(0xA6918D0)
#define SKIRTIK_METHOD_5_C5F9823D509784CD_OFFSET UNITYSDK_OFFSET(0xA6917F0)
#define SKIRTIK_METHOD_5_DFA27085F7A73D0B_OFFSET UNITYSDK_OFFSET(0xA693880)
#define SKIRTIK_PREPROCESS_OFFSET UNITYSDK_OFFSET(0xA68EAE0)
#define SKIRTIK_PROCESS_OFFSET UNITYSDK_OFFSET(0xA68EDB0)
#define SKIRTIK_RECORDBEFOREIK_OFFSET UNITYSDK_OFFSET(0xA68EEF0)
#define SKIRTIK_SAFEINIT_OFFSET UNITYSDK_OFFSET(0xA68E9B0)
#define SKIRTIK_SETHAIRCUSTOMCURVEOFFSET_OFFSET UNITYSDK_OFFSET(0xA68F140)
#define SKIRTIK_START_OFFSET UNITYSDK_OFFSET(0xA68F300)
#define SKIRTIK_UPDATESKIRTIKSERIALIZEDATAFROMASSET_OFFSET UNITYSDK_OFFSET(0xA68ECA0)
#define SKIRTIK_UPDATESKIRTIKSERIALIZEDATA_OFFSET UNITYSDK_OFFSET(0xA68F240)
#define SKIRTIK__CTOR_OFFSET UNITYSDK_OFFSET(0xA695210)

inline static constexpr unsigned int SkirtIK_TypeDefinitionIndex = 37194;
...
public:
	...
	::System::Boolean GetPerformanceRuntimeCache(::System::String*& a1, ::Class_0_16E4307DCC419505_259*& a2)
	{
		return ((::System::Boolean(*)(::PVOID, ::System::String*&, ::Class_0_16E4307DCC419505_259*&))((::PBYTE)hIl2Cpp + SKIRTIK_GETPERFORMANCERUNTIMECACHE_OFFSET))(this, a1, a2);
	}
