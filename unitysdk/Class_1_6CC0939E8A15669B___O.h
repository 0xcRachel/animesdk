...
public:
	...
	{
		return (::Class_1_6CC0939E8A15669B_Class_3_C9ABD9C89B357622**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6CC0939E8A15669B___O_TypeDefinitionIndex)->GetStaticField(0x4F9A0);
	}
};
