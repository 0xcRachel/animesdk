...
#define CLASS_2_C846295C9E4472FE_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xCB1BB60)
#define CLASS_2_C846295C9E4472FE_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xCB1BE70)
#define CLASS_2_C846295C9E4472FE_METHOD_2_00D9C214C63942A7_OFFSET UNITYSDK_OFFSET(0xCB1B300)
#define CLASS_2_C846295C9E4472FE_METHOD_2_18982EFD3B740683_OFFSET UNITYSDK_OFFSET(0xC5130A0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_1A7F9F3B13A09C96_OFFSET UNITYSDK_OFFSET(0xC512F00)
#define CLASS_2_C846295C9E4472FE_METHOD_2_1DF1FA98B6A6B5EE_OFFSET UNITYSDK_OFFSET(0xC513790)
#define CLASS_2_C846295C9E4472FE_METHOD_2_229E068D4C618706_OFFSET UNITYSDK_OFFSET(0xCB19EC0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_39845204DD04FC33_OFFSET UNITYSDK_OFFSET(0xC5134F0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_3CE8A1831DA14AB7_OFFSET UNITYSDK_OFFSET(0xC5133B0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_3F620310DEF68809_OFFSET UNITYSDK_OFFSET(0xCB1A3B0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_45E1B5C827BB0063_OFFSET UNITYSDK_OFFSET(0xC513050)
#define CLASS_2_C846295C9E4472FE_METHOD_2_48DCE3E9EBCCF56D_OFFSET UNITYSDK_OFFSET(0xCB19870)
#define CLASS_2_C846295C9E4472FE_METHOD_2_4927ACC1FFCD0949_OFFSET UNITYSDK_OFFSET(0xC514210)
#define CLASS_2_C846295C9E4472FE_METHOD_2_494DEE1E2F1B0134_OFFSET UNITYSDK_OFFSET(0xC513F50)
#define CLASS_2_C846295C9E4472FE_METHOD_2_4EF39E24235C05BA_OFFSET UNITYSDK_OFFSET(0xC5135D0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0xCB1C2A0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xCB1C1D0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_5B176AC622BC2444_OFFSET UNITYSDK_OFFSET(0xC514150)
#define CLASS_2_C846295C9E4472FE_METHOD_2_5E6C171886C48967_OFFSET UNITYSDK_OFFSET(0xCB1A930)
#define CLASS_2_C846295C9E4472FE_METHOD_2_64B7F5DF4C560641_OFFSET UNITYSDK_OFFSET(0xC514280)
#define CLASS_2_C846295C9E4472FE_METHOD_2_679BB2AF51138481_OFFSET UNITYSDK_OFFSET(0xC513340)
#define CLASS_2_C846295C9E4472FE_METHOD_2_6BEB244CD2E6EADC_OFFSET UNITYSDK_OFFSET(0xCB19C50)
#define CLASS_2_C846295C9E4472FE_METHOD_2_8C3DB70FFBBF01C7_OFFSET UNITYSDK_OFFSET(0xCB1B6F0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_8C40D8A084322E50_OFFSET UNITYSDK_OFFSET(0xC513910)
#define CLASS_2_C846295C9E4472FE_METHOD_2_95D5F1592312589E_1_OFFSET UNITYSDK_OFFSET(0xC513EB0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_95D5F1592312589E_OFFSET UNITYSDK_OFFSET(0xC513970)
#define CLASS_2_C846295C9E4472FE_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xCB1B260)
#define CLASS_2_C846295C9E4472FE_METHOD_2_9805F2901C5A7FC1_OFFSET UNITYSDK_OFFSET(0xCB1B350)
#define CLASS_2_C846295C9E4472FE_METHOD_2_A27D06F9481FAFDB_1_OFFSET UNITYSDK_OFFSET(0xCB1B990)
#define CLASS_2_C846295C9E4472FE_METHOD_2_A27D06F9481FAFDB_2_OFFSET UNITYSDK_OFFSET(0xCB1BB00)
#define CLASS_2_C846295C9E4472FE_METHOD_2_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0xCB1B7D0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0xCB1B660)
#define CLASS_2_C846295C9E4472FE_METHOD_2_A80EDC4C30C0B325_OFFSET UNITYSDK_OFFSET(0xC513A00)
#define CLASS_2_C846295C9E4472FE_METHOD_2_A88B36294D55B85C_OFFSET UNITYSDK_OFFSET(0xC512940)
#define CLASS_2_C846295C9E4472FE_METHOD_2_AA957E371B77E633_OFFSET UNITYSDK_OFFSET(0xCB1B450)
#define CLASS_2_C846295C9E4472FE_METHOD_2_B81305259F90066A_OFFSET UNITYSDK_OFFSET(0xCB1AD70)
#define CLASS_2_C846295C9E4472FE_METHOD_2_BC9D09BED49A4927_OFFSET UNITYSDK_OFFSET(0xCB1A640)
#define CLASS_2_C846295C9E4472FE_METHOD_2_C1C0CB2C8B6124DE_OFFSET UNITYSDK_OFFSET(0xCB1B9F0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xC512EC0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_D5E5EC1B4538DDD1_OFFSET UNITYSDK_OFFSET(0xCB1C300)
#define CLASS_2_C846295C9E4472FE_METHOD_2_E28394F67B2A3D25_OFFSET UNITYSDK_OFFSET(0xC514790)
#define CLASS_2_C846295C9E4472FE_METHOD_2_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0xC5137F0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_EEAEEB43B404284D_OFFSET UNITYSDK_OFFSET(0xCB1AAD0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_EF791A79C773DCBB_OFFSET UNITYSDK_OFFSET(0xCB1ABB0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_F343645A04DC6AEF_OFFSET UNITYSDK_OFFSET(0xC515010)
#define CLASS_2_C846295C9E4472FE_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0xCB1B8A0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_F6B522B422985D1A_OFFSET UNITYSDK_OFFSET(0xCB1ACE0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_F7460366379D5568_OFFSET UNITYSDK_OFFSET(0xC514D50)
#define CLASS_2_C846295C9E4472FE_METHOD_2_F7BA13C72A6B3F58_OFFSET UNITYSDK_OFFSET(0xC512CA0)
#define CLASS_2_C846295C9E4472FE__CTOR_OFFSET UNITYSDK_OFFSET(0xCB1C140)
#define CLASS_2_C846295C9E4472FE__ONBIND_OFFSET UNITYSDK_OFFSET(0xC512890)
#define CLASS_2_C846295C9E4472FE__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0xC512FF0)
#define CLASS_2_C846295C9E4472FE__ONTICK_OFFSET UNITYSDK_OFFSET(0xC512C40)
#define CLASS_2_C846295C9E4472FE___IFIXBASEPROXY_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xCB1C3D0)
#define CLASS_2_C846295C9E4472FE___IFIXBASEPROXY_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xCB1C430)
#define CLASS_2_C846295C9E4472FE___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0xCB1C170)
#define CLASS_2_C846295C9E4472FE___IFIXBASEPROXY__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0xCB1C370)
#define CLASS_2_C846295C9E4472FE___IFIXBASEPROXY__ONTICK_OFFSET UNITYSDK_OFFSET(0xCB1C230)

inline static constexpr unsigned int Class_2_C846295C9E4472FE_TypeDefinitionIndex = 58992;

class Class_2_C846295C9E4472FE : public ::Class_1_CA217ABF4E3B4F3F
{
public:
	::RPG::GameCore::EntityManager* Field_2_4; // 0x60
	...
	::RPG::Client::ScreenEventHandler* Field_2_0; // 0x80
	...
	::RPG::GameCore::GameModeState Field_2_6; // 0xA0
	...
	::UnityEngine::Vector2 Field_2_16; // 0xCC
	::System::Boolean Field_2_13; // 0xD4
	::System::Boolean Field_2_22; // 0xD5
	::System::Boolean Field_2_18; // 0xD6
	::System::Boolean Field_2_12; // 0xD7
