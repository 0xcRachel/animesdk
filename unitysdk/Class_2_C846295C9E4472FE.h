...
#define CLASS_2_C846295C9E4472FE_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xC4D9500)
#define CLASS_2_C846295C9E4472FE_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xC4D97E0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_00D9C214C63942A7_OFFSET UNITYSDK_OFFSET(0xC4D7100)
#define CLASS_2_C846295C9E4472FE_METHOD_2_18982EFD3B740683_OFFSET UNITYSDK_OFFSET(0xC4D4A40)
#define CLASS_2_C846295C9E4472FE_METHOD_2_1A7F9F3B13A09C96_OFFSET UNITYSDK_OFFSET(0xC4D48A0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_1DF1FA98B6A6B5EE_OFFSET UNITYSDK_OFFSET(0xC4D5120)
#define CLASS_2_C846295C9E4472FE_METHOD_2_229E068D4C618706_OFFSET UNITYSDK_OFFSET(0xC4D7D40)
#define CLASS_2_C846295C9E4472FE_METHOD_2_39845204DD04FC33_OFFSET UNITYSDK_OFFSET(0xC4D4E90)
#define CLASS_2_C846295C9E4472FE_METHOD_2_3CE8A1831DA14AB7_OFFSET UNITYSDK_OFFSET(0xC4D4D50)
#define CLASS_2_C846295C9E4472FE_METHOD_2_3F620310DEF68809_OFFSET UNITYSDK_OFFSET(0xC4D8520)
#define CLASS_2_C846295C9E4472FE_METHOD_2_45E1B5C827BB0063_OFFSET UNITYSDK_OFFSET(0xC4D49F0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_48DCE3E9EBCCF56D_OFFSET UNITYSDK_OFFSET(0xC4D87B0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_4927ACC1FFCD0949_OFFSET UNITYSDK_OFFSET(0xC4D5BB0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_494DEE1E2F1B0134_OFFSET UNITYSDK_OFFSET(0xC4D58E0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_4EF39E24235C05BA_OFFSET UNITYSDK_OFFSET(0xC4D4F70)
#define CLASS_2_C846295C9E4472FE_METHOD_2_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0xC4D9BE0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xC4D9B10)
#define CLASS_2_C846295C9E4472FE_METHOD_2_5B176AC622BC2444_OFFSET UNITYSDK_OFFSET(0xC4D5AE0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_5E6C171886C48967_OFFSET UNITYSDK_OFFSET(0xC4D8E00)
#define CLASS_2_C846295C9E4472FE_METHOD_2_64B7F5DF4C560641_OFFSET UNITYSDK_OFFSET(0xC4D5C20)
#define CLASS_2_C846295C9E4472FE_METHOD_2_679BB2AF51138481_OFFSET UNITYSDK_OFFSET(0xC4D4CE0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_6BEB244CD2E6EADC_OFFSET UNITYSDK_OFFSET(0xC4D8B90)
#define CLASS_2_C846295C9E4472FE_METHOD_2_8C3DB70FFBBF01C7_OFFSET UNITYSDK_OFFSET(0xC4D9100)
#define CLASS_2_C846295C9E4472FE_METHOD_2_8C40D8A084322E50_OFFSET UNITYSDK_OFFSET(0xC4D52A0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_95D5F1592312589E_1_OFFSET UNITYSDK_OFFSET(0xC4D5840)
#define CLASS_2_C846295C9E4472FE_METHOD_2_95D5F1592312589E_OFFSET UNITYSDK_OFFSET(0xC4D5300)
#define CLASS_2_C846295C9E4472FE_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xC4D6130)
#define CLASS_2_C846295C9E4472FE_METHOD_2_9805F2901C5A7FC1_OFFSET UNITYSDK_OFFSET(0xC4D7C40)
#define CLASS_2_C846295C9E4472FE_METHOD_2_A27D06F9481FAFDB_1_OFFSET UNITYSDK_OFFSET(0xC4D9330)
#define CLASS_2_C846295C9E4472FE_METHOD_2_A27D06F9481FAFDB_2_OFFSET UNITYSDK_OFFSET(0xC4D94A0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0xC4D91B0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0xC4D9080)
#define CLASS_2_C846295C9E4472FE_METHOD_2_A80EDC4C30C0B325_OFFSET UNITYSDK_OFFSET(0xC4D5390)
#define CLASS_2_C846295C9E4472FE_METHOD_2_A88B36294D55B85C_OFFSET UNITYSDK_OFFSET(0xC4D40C0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_AA957E371B77E633_OFFSET UNITYSDK_OFFSET(0xC4D4430)
#define CLASS_2_C846295C9E4472FE_METHOD_2_B81305259F90066A_OFFSET UNITYSDK_OFFSET(0xC4D6390)
#define CLASS_2_C846295C9E4472FE_METHOD_2_BC9D09BED49A4927_OFFSET UNITYSDK_OFFSET(0xC4D8230)
#define CLASS_2_C846295C9E4472FE_METHOD_2_C1C0CB2C8B6124DE_OFFSET UNITYSDK_OFFSET(0xC4D9390)
#define CLASS_2_C846295C9E4472FE_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xC4D4860)
#define CLASS_2_C846295C9E4472FE_METHOD_2_D5E5EC1B4538DDD1_OFFSET UNITYSDK_OFFSET(0xC4D9C40)
#define CLASS_2_C846295C9E4472FE_METHOD_2_E28394F67B2A3D25_OFFSET UNITYSDK_OFFSET(0xC4D6880)
#define CLASS_2_C846295C9E4472FE_METHOD_2_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0xC4D5180)
#define CLASS_2_C846295C9E4472FE_METHOD_2_EEAEEB43B404284D_OFFSET UNITYSDK_OFFSET(0xC4D8FA0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_EF791A79C773DCBB_OFFSET UNITYSDK_OFFSET(0xC4D6260)
#define CLASS_2_C846295C9E4472FE_METHOD_2_F343645A04DC6AEF_OFFSET UNITYSDK_OFFSET(0xC4D7150)
#define CLASS_2_C846295C9E4472FE_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0xC4D9260)
#define CLASS_2_C846295C9E4472FE_METHOD_2_F6B522B422985D1A_OFFSET UNITYSDK_OFFSET(0xC4D61D0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_F7460366379D5568_OFFSET UNITYSDK_OFFSET(0xC4D6E40)
#define CLASS_2_C846295C9E4472FE_METHOD_2_F7BA13C72A6B3F58_OFFSET UNITYSDK_OFFSET(0xC4D4640)
#define CLASS_2_C846295C9E4472FE__CTOR_OFFSET UNITYSDK_OFFSET(0xC4D9A80)
#define CLASS_2_C846295C9E4472FE__ONBIND_OFFSET UNITYSDK_OFFSET(0xC4D4060)
#define CLASS_2_C846295C9E4472FE__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0xC4D4990)
#define CLASS_2_C846295C9E4472FE__ONTICK_OFFSET UNITYSDK_OFFSET(0xC4D43D0)
#define CLASS_2_C846295C9E4472FE___IFIXBASEPROXY_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xC4D9D10)
#define CLASS_2_C846295C9E4472FE___IFIXBASEPROXY_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xC4D9D70)
#define CLASS_2_C846295C9E4472FE___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0xC4D9AB0)
#define CLASS_2_C846295C9E4472FE___IFIXBASEPROXY__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0xC4D9CB0)
#define CLASS_2_C846295C9E4472FE___IFIXBASEPROXY__ONTICK_OFFSET UNITYSDK_OFFSET(0xC4D9B70)

inline static constexpr unsigned int Class_2_C846295C9E4472FE_TypeDefinitionIndex = 66363;
...
public:
	...
	::RPG::GameCore::EntityManager* Field_2_4; // 0x90
	::System::Single Field_2_9; // 0x98
	::UnityEngine::Vector2 Field_2_16; // 0x9C
	::System::Single Field_2_8; // 0xA4
	::System::Single Field_2_15; // 0xA8
	::System::Boolean Field_2_17; // 0xAC
	::System::Boolean Field_2_13; // 0xAD
	::System::UInt32 Field_2_14; // 0xB0
	::System::Single Field_2_21; // 0xB4
	::System::Single Field_2_7; // 0xB8
	::RPG::GameCore::GameModeState Field_2_6; // 0xBC
