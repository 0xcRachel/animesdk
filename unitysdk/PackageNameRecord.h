...
#define PACKAGENAMERECORD_METHOD_5_B8FAD8726C647FA2_OFFSET UNITYSDK_OFFSET(0x8A85950)
#define PACKAGENAMERECORD_METHOD_5_BBE2D28D8A6AFB06_OFFSET UNITYSDK_OFFSET(0x8A858C0)
#define PACKAGENAMERECORD_WRITEANDUPLOADBRANCHDATA_OFFSET UNITYSDK_OFFSET(0x8A851E0)
#define PACKAGENAMERECORD__CTOR_OFFSET UNITYSDK_OFFSET(0x8A859F0)

inline static constexpr unsigned int PackageNameRecord_TypeDefinitionIndex = 37477;
