...
#define WWISEGROUPVALUEOBJECTREFERENCE_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x191071A0)
#define WWISEGROUPVALUEOBJECTREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x19107240)
#define WWISEGROUPVALUEOBJECTREFERENCE___IFIXBASEPROXY_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x19107260)
