...
class Class_1_E789CA7741B3EFE8;
class Class_2_B5BF53FFA523B5C8;
namespace RPG::Client { class MockAnimator; }
namespace UnityEngine { class Animator; }

#define CLASS_2_13661480B6BE936D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10B2A6A0)
#define CLASS_2_13661480B6BE936D_GETUNEVALUATEDNEXTSTATE_OFFSET UNITYSDK_OFFSET(0x10B2AAA0)
#define CLASS_2_13661480B6BE936D_GETUNITYANIMATOR_OFFSET UNITYSDK_OFFSET(0x10B2AB30)
#define CLASS_2_13661480B6BE936D_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x10B2A770)
#define CLASS_2_13661480B6BE936D_METHOD_2_6EACC4FF4EF827F8_OFFSET UNITYSDK_OFFSET(0x10B2A870)
#define CLASS_2_13661480B6BE936D_METHOD_2_78CA97F77C3FE5CD_OFFSET UNITYSDK_OFFSET(0x10B2A800)
#define CLASS_2_13661480B6BE936D_METHOD_2_85F768A977081C2D_OFFSET UNITYSDK_OFFSET(0x10B2AA30)
#define CLASS_2_13661480B6BE936D_METHOD_2_BF7707C04361A205_OFFSET UNITYSDK_OFFSET(0x10B2AB80)
#define CLASS_2_13661480B6BE936D_METHOD_2_C73D3AF9E27E83D8_OFFSET UNITYSDK_OFFSET(0x10B2A910)
#define CLASS_2_13661480B6BE936D_METHOD_2_EBEE0D0A222A8264_OFFSET UNITYSDK_OFFSET(0x10B2A580)
#define CLASS_2_13661480B6BE936D_QUERYSTATENORAMLIZEDSTARTTIME_OFFSET UNITYSDK_OFFSET(0x10B2AAE0)
#define CLASS_2_13661480B6BE936D__CTOR_OFFSET UNITYSDK_OFFSET(0x10B2AB90)
#define CLASS_2_13661480B6BE936D___IFIXBASEPROXY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x10B2ABA0)

inline static constexpr unsigned int Class_2_13661480B6BE936D_TypeDefinitionIndex = 44178;

class Class_2_13661480B6BE936D : public ::RPG::GameCore::GameComponentBase
{
public:
	::Class_2_B5BF53FFA523B5C8* Field_2_2; // 0x18
	::Class_1_E789CA7741B3EFE8* Field_2_1; // 0x20
	...
	::System::Void Method_2_6EACC4FF4EF827F8(::Class_0_16E4307DCC419505_394* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_394*))((::PBYTE)hIl2Cpp + CLASS_2_13661480B6BE936D_METHOD_2_6EACC4FF4EF827F8_OFFSET))(this, a1);
	}

	::System::Void Method_2_C73D3AF9E27E83D8(::Class_0_16E4307DCC419505_394* a1, ::RPG::GameCore::ChessMoveStopReason a2)
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_394*, ::RPG::GameCore::ChessMoveStopReason))((::PBYTE)hIl2Cpp + CLASS_2_13661480B6BE936D_METHOD_2_C73D3AF9E27E83D8_OFFSET))(this, a1, a2);
	}
