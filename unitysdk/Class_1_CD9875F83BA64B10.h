...
#define CLASS_1_CD9875F83BA64B10_GET_ASSISTSCORE_OFFSET UNITYSDK_OFFSET(0xA6B6C00)
#define CLASS_1_CD9875F83BA64B10_GET_AVATARLIST_OFFSET UNITYSDK_OFFSET(0xA6B6BE0)
#define CLASS_1_CD9875F83BA64B10_GET_BATTLEREPLAYKEY_OFFSET UNITYSDK_OFFSET(0xA6B6BC0)
#define CLASS_1_CD9875F83BA64B10_GET_DAMAGEHP_OFFSET UNITYSDK_OFFSET(0xA6B6B60)
#define CLASS_1_CD9875F83BA64B10_GET_DAMAGESCORE_OFFSET UNITYSDK_OFFSET(0xA6B6C20)
#define CLASS_1_CD9875F83BA64B10_GET_FINALHITSCORE_OFFSET UNITYSDK_OFFSET(0xA6B6C40)
#define CLASS_1_CD9875F83BA64B10_GET_ISFINALHIT_OFFSET UNITYSDK_OFFSET(0xA6B6B80)
#define CLASS_1_CD9875F83BA64B10_GET_OVERKILLDAMAGEHP_OFFSET UNITYSDK_OFFSET(0xA6B6BA0)
#define CLASS_1_CD9875F83BA64B10_GET_UID_OFFSET UNITYSDK_OFFSET(0xA6B6B40)
#define CLASS_1_CD9875F83BA64B10_METHOD_1_4DDD3DE2D159DC6E_OFFSET UNITYSDK_OFFSET(0xA6B66F0)
#define CLASS_1_CD9875F83BA64B10_METHOD_1_A85A5A4F484E8E77_OFFSET UNITYSDK_OFFSET(0xA6B6A50)
#define CLASS_1_CD9875F83BA64B10_SET_ASSISTSCORE_OFFSET UNITYSDK_OFFSET(0xA6B6C10)
#define CLASS_1_CD9875F83BA64B10_SET_AVATARLIST_OFFSET UNITYSDK_OFFSET(0xA6B6BF0)
#define CLASS_1_CD9875F83BA64B10_SET_BATTLEREPLAYKEY_OFFSET UNITYSDK_OFFSET(0xA6B6BD0)
#define CLASS_1_CD9875F83BA64B10_SET_DAMAGEHP_OFFSET UNITYSDK_OFFSET(0xA6B6B70)
#define CLASS_1_CD9875F83BA64B10_SET_DAMAGESCORE_OFFSET UNITYSDK_OFFSET(0xA6B6C30)
#define CLASS_1_CD9875F83BA64B10_SET_FINALHITSCORE_OFFSET UNITYSDK_OFFSET(0xA6B6C50)
#define CLASS_1_CD9875F83BA64B10_SET_ISFINALHIT_OFFSET UNITYSDK_OFFSET(0xA6B6B90)
#define CLASS_1_CD9875F83BA64B10_SET_OVERKILLDAMAGEHP_OFFSET UNITYSDK_OFFSET(0xA6B6BB0)
#define CLASS_1_CD9875F83BA64B10_SET_UID_OFFSET UNITYSDK_OFFSET(0xA6B6B50)
#define CLASS_1_CD9875F83BA64B10__CTOR_OFFSET UNITYSDK_OFFSET(0xA6B6B30)

inline static constexpr unsigned int Class_1_CD9875F83BA64B10_TypeDefinitionIndex = 53172;
...
public:
	...
	::System::UInt32 _FinalHitScore_k__BackingField; // 0x24
	::System::UInt32 _DamageHp_k__BackingField; // 0x28
	::System::UInt32 _Uid_k__BackingField; // 0x2C
	::System::UInt32 _AssistScore_k__BackingField; // 0x30
	::System::Boolean _IsFinalHit_k__BackingField; // 0x34
	::System::UInt32 _OverKillDamageHp_k__BackingField; // 0x38
	...
	static ::System::Collections::Generic::List_1<::Class_1_CD9875F83BA64B10*>* Method_1_4DDD3DE2D159DC6E(::System::Collections::Generic::IEnumerable_1<::Class_1_21DCD4640D389503_6*>* a1)
	{
		return ((::System::Collections::Generic::List_1<::Class_1_CD9875F83BA64B10*>*(*)(::System::Collections::Generic::IEnumerable_1<::Class_1_21DCD4640D389503_6*>*))((::PBYTE)hIl2Cpp + CLASS_1_CD9875F83BA64B10_METHOD_1_4DDD3DE2D159DC6E_OFFSET))(a1);
	}

	static ::Class_1_CD9875F83BA64B10* Method_1_A85A5A4F484E8E77(::Class_1_21DCD4640D389503_6* a1)
	{
		return ((::Class_1_CD9875F83BA64B10*(*)(::Class_1_21DCD4640D389503_6*))((::PBYTE)hIl2Cpp + CLASS_1_CD9875F83BA64B10_METHOD_1_A85A5A4F484E8E77_OFFSET))(a1);
	}
