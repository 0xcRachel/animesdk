...
#define CLASS_1_AF1D3AB140C98E6B_EXECUTE_OFFSET UNITYSDK_OFFSET(0x142A3FB0)
#define CLASS_1_AF1D3AB140C98E6B_GET_ALLCHIMERAS_OFFSET UNITYSDK_OFFSET(0x142A4340)
#define CLASS_1_AF1D3AB140C98E6B_TICK_OFFSET UNITYSDK_OFFSET(0x142A42E0)
#define CLASS_1_AF1D3AB140C98E6B__CTOR_OFFSET UNITYSDK_OFFSET(0x142A3D20)

inline static constexpr unsigned int Class_1_AF1D3AB140C98E6B_TypeDefinitionIndex = 72173;
