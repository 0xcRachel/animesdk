...
#define CLASS_1_5B567C8A01BAEDFE_57_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A3C1210)
#define CLASS_1_5B567C8A01BAEDFE_57_CLONE_OFFSET UNITYSDK_OFFSET(0x1A3C1020)
#define CLASS_1_5B567C8A01BAEDFE_57_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A3C1120)
#define CLASS_1_5B567C8A01BAEDFE_57_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A3C1090)
#define CLASS_1_5B567C8A01BAEDFE_57_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A3C1170)
#define CLASS_1_5B567C8A01BAEDFE_57_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A3C1260)
#define CLASS_1_5B567C8A01BAEDFE_57_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A3C1230)
#define CLASS_1_5B567C8A01BAEDFE_57_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A3C0F70)
#define CLASS_1_5B567C8A01BAEDFE_57_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A3C0FD0)
#define CLASS_1_5B567C8A01BAEDFE_57_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A3C11A0)
#define CLASS_1_5B567C8A01BAEDFE_57_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A3C1200)
#define CLASS_1_5B567C8A01BAEDFE_57__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A3C12B0)
#define CLASS_1_5B567C8A01BAEDFE_57__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3C0FF0)
#define CLASS_1_5B567C8A01BAEDFE_57__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3C0FE0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_57*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_57_TypeDefinitionIndex)->GetStaticField(0x4C860);
	}
