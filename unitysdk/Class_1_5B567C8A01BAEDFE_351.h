...
#define CLASS_1_5B567C8A01BAEDFE_351_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A4A5CC0)
#define CLASS_1_5B567C8A01BAEDFE_351_CLONE_OFFSET UNITYSDK_OFFSET(0x1A4A5B30)
#define CLASS_1_5B567C8A01BAEDFE_351_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A4A5BD0)
#define CLASS_1_5B567C8A01BAEDFE_351_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A4A5B70)
#define CLASS_1_5B567C8A01BAEDFE_351_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A4A5C20)
#define CLASS_1_5B567C8A01BAEDFE_351_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A4A5D10)
#define CLASS_1_5B567C8A01BAEDFE_351_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A4A5CE0)
#define CLASS_1_5B567C8A01BAEDFE_351_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A4A5AB0)
#define CLASS_1_5B567C8A01BAEDFE_351_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A4A5AE0)
#define CLASS_1_5B567C8A01BAEDFE_351_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A4A5C50)
#define CLASS_1_5B567C8A01BAEDFE_351_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A4A5CB0)
#define CLASS_1_5B567C8A01BAEDFE_351__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A4A5D60)
#define CLASS_1_5B567C8A01BAEDFE_351__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A4A5B00)
#define CLASS_1_5B567C8A01BAEDFE_351__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4A5AF0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_351*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_351_TypeDefinitionIndex)->GetStaticField(0x23F10);
	}
