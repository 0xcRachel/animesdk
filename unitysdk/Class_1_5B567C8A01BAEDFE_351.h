...
#define CLASS_1_5B567C8A01BAEDFE_351_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19DD2CC0)
#define CLASS_1_5B567C8A01BAEDFE_351_CLONE_OFFSET UNITYSDK_OFFSET(0x19DD2AD0)
#define CLASS_1_5B567C8A01BAEDFE_351_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19DD2BD0)
#define CLASS_1_5B567C8A01BAEDFE_351_EQUALS_OFFSET UNITYSDK_OFFSET(0x19DD2B40)
#define CLASS_1_5B567C8A01BAEDFE_351_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19DD2C20)
#define CLASS_1_5B567C8A01BAEDFE_351_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19DD2D10)
#define CLASS_1_5B567C8A01BAEDFE_351_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19DD2CE0)
#define CLASS_1_5B567C8A01BAEDFE_351_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19DD2A20)
#define CLASS_1_5B567C8A01BAEDFE_351_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19DD2A80)
#define CLASS_1_5B567C8A01BAEDFE_351_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19DD2C50)
#define CLASS_1_5B567C8A01BAEDFE_351_WRITETO_OFFSET UNITYSDK_OFFSET(0x19DD2CB0)
#define CLASS_1_5B567C8A01BAEDFE_351__CCTOR_OFFSET UNITYSDK_OFFSET(0x19DD2D60)
#define CLASS_1_5B567C8A01BAEDFE_351__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19DD2AA0)
#define CLASS_1_5B567C8A01BAEDFE_351__CTOR_OFFSET UNITYSDK_OFFSET(0x19DD2A90)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_351*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_351_TypeDefinitionIndex)->GetStaticField(0x31EC0);
	}
