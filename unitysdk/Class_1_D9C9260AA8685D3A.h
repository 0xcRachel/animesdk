...
#define CLASS_1_D9C9260AA8685D3A_GETQUALITYFILTER_OFFSET UNITYSDK_OFFSET(0xD7CAEA0)
#define CLASS_1_D9C9260AA8685D3A_GETTYPEID_OFFSET UNITYSDK_OFFSET(0xD7CAE00)
#define CLASS_1_D9C9260AA8685D3A_GET_LIGHTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xD7CAC80)
#define CLASS_1_D9C9260AA8685D3A_METHOD_1_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0xD7CAD20)
#define CLASS_1_D9C9260AA8685D3A_METHOD_1_56DA2DEC73AA9CE8_OFFSET UNITYSDK_OFFSET(0xD7CAEF0)
#define CLASS_1_D9C9260AA8685D3A_METHOD_1_8CC9D262040F004A_OFFSET UNITYSDK_OFFSET(0xD7CAF70)
#define CLASS_1_D9C9260AA8685D3A_METHOD_1_9519692C1DBF10E6_1_OFFSET UNITYSDK_OFFSET(0xD7CB080)
#define CLASS_1_D9C9260AA8685D3A_METHOD_1_9519692C1DBF10E6_OFFSET UNITYSDK_OFFSET(0xD7CB020)
#define CLASS_1_D9C9260AA8685D3A_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xD7CACE0)
#define CLASS_1_D9C9260AA8685D3A_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xD7CAC90)
#define CLASS_1_D9C9260AA8685D3A_ONBEGINSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0xD7CB7D0)
#define CLASS_1_D9C9260AA8685D3A_ONBEGINSCENELIGHTLODFADING_OFFSET UNITYSDK_OFFSET(0xD7CB9A0)
#define CLASS_1_D9C9260AA8685D3A_ONENDSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0xD7CB860)
#define CLASS_1_D9C9260AA8685D3A_ONENDSCENELIGHTLODFADING_OFFSET UNITYSDK_OFFSET(0xD7CBA40)
#define CLASS_1_D9C9260AA8685D3A_ONGETFROMPOOLASYNC_OFFSET UNITYSDK_OFFSET(0xD7CB520)
#define CLASS_1_D9C9260AA8685D3A_ONOBJECTCREATEDASYNC_OFFSET UNITYSDK_OFFSET(0xD7CADB0)
#define CLASS_1_D9C9260AA8685D3A_ONOBJECTDESTROY_OFFSET UNITYSDK_OFFSET(0xD7CAD70)
#define CLASS_1_D9C9260AA8685D3A_ONOBJECTENABLE_OFFSET UNITYSDK_OFFSET(0xD7CBC80)
#define CLASS_1_D9C9260AA8685D3A_ONPREUNSERIALIZEASYNC_OFFSET UNITYSDK_OFFSET(0xD7CBBF0)
#define CLASS_1_D9C9260AA8685D3A_ONPUTTOPOOL_OFFSET UNITYSDK_OFFSET(0xD7CB4A0)
#define CLASS_1_D9C9260AA8685D3A_ONRELEASE_OFFSET UNITYSDK_OFFSET(0xD7CB5B0)
#define CLASS_1_D9C9260AA8685D3A_ONSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0xD7CB730)
#define CLASS_1_D9C9260AA8685D3A_ONSCENELIGHTLODFADING_OFFSET UNITYSDK_OFFSET(0xD7CB8F0)
#define CLASS_1_D9C9260AA8685D3A_ONSETSCENELIGHTLOD_OFFSET UNITYSDK_OFFSET(0xD7CBAE0)
#define CLASS_1_D9C9260AA8685D3A_ONTURNOFF_OFFSET UNITYSDK_OFFSET(0xD7CB6B0)
#define CLASS_1_D9C9260AA8685D3A_ONTURNON_OFFSET UNITYSDK_OFFSET(0xD7CB630)
#define CLASS_1_D9C9260AA8685D3A_ONUNSERIALIZEFINISH_OFFSET UNITYSDK_OFFSET(0xD7CBB70)
#define CLASS_1_D9C9260AA8685D3A_SETHOSTMANAGEDLIGHT_OFFSET UNITYSDK_OFFSET(0xD7CAE50)
#define CLASS_1_D9C9260AA8685D3A_UNSERIALIZEASYNC_OFFSET UNITYSDK_OFFSET(0xD7CB0E0)
#define CLASS_1_D9C9260AA8685D3A__CTOR_OFFSET UNITYSDK_OFFSET(0xD7CACD0)
#define CLASS_1_D9C9260AA8685D3A__UNSERIALIZEASYNC_B__21_0_OFFSET UNITYSDK_OFFSET(0xD7CBD00)
#define CLASS_1_D9C9260AA8685D3A__UNSERIALIZEASYNC_B__21_1_OFFSET UNITYSDK_OFFSET(0xD7CBD60)
...
{
public:
	::UnityEngine::ReflectionProbe* Field_1_3; // 0x10
	::RPG::CustomRP::CRPProbe* Field_1_4; // 0x18
	::RPG::CustomRP::CRPProbe* Field_1_5; // 0x20
	::UnityEngine::ReflectionProbe* Field_1_2; // 0x28
