...
#define BGCURVEEXTENTION_GETDISTANCE_1_OFFSET UNITYSDK_OFFSET(0x1628A810)
#define BGCURVEEXTENTION_GETDISTANCE_OFFSET UNITYSDK_OFFSET(0x1628A780)
#define BGCURVEEXTENTION_GETLENGTHBYSTARTEND_OFFSET UNITYSDK_OFFSET(0x1628B910)
#define BGCURVEEXTENTION_GETNORMALBYDISTANCE_OFFSET UNITYSDK_OFFSET(0x1628B450)
#define BGCURVEEXTENTION_GETPOSITIONBYDISTANCE_OFFSET UNITYSDK_OFFSET(0x1628AAA0)
#define BGCURVEEXTENTION_GETPOSITIONINFOBYDISTANCE_OFFSET UNITYSDK_OFFSET(0x1628A8A0)
#define BGCURVEEXTENTION_GETQUATERNIONBYDISTANCE_OFFSET UNITYSDK_OFFSET(0x1628B320)
#define BGCURVEEXTENTION_GETTANGENTBYDISTANCE_OFFSET UNITYSDK_OFFSET(0x1628B250)
#define BGCURVEEXTENTION_GETTWIRLANGLEBYDISTANCE_OFFSET UNITYSDK_OFFSET(0x1628C300)
#define BGCURVEEXTENTION_GETTWIRLTYPEBYDISTANCE_OFFSET UNITYSDK_OFFSET(0x1628B7C0)
#define BGCURVEEXTENTION_GET_CURBGCURVE_OFFSET UNITYSDK_OFFSET(0x1628A470)
#define BGCURVEEXTENTION_METHOD_5_0A7E3B5497F578CD_OFFSET UNITYSDK_OFFSET(0x1628A520)
#define BGCURVEEXTENTION_METHOD_5_6B80A6E41CC40DCF_OFFSET UNITYSDK_OFFSET(0x1628C5E0)
#define BGCURVEEXTENTION_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1628A6B0)
#define BGCURVEEXTENTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1628C690)
