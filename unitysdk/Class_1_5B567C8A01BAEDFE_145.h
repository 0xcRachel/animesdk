...
#define CLASS_1_5B567C8A01BAEDFE_145_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19B6D8B0)
#define CLASS_1_5B567C8A01BAEDFE_145_CLONE_OFFSET UNITYSDK_OFFSET(0x19B6D6C0)
#define CLASS_1_5B567C8A01BAEDFE_145_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19B6D7C0)
#define CLASS_1_5B567C8A01BAEDFE_145_EQUALS_OFFSET UNITYSDK_OFFSET(0x19B6D730)
#define CLASS_1_5B567C8A01BAEDFE_145_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19B6D810)
#define CLASS_1_5B567C8A01BAEDFE_145_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19B6D900)
#define CLASS_1_5B567C8A01BAEDFE_145_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19B6D8D0)
#define CLASS_1_5B567C8A01BAEDFE_145_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19B6D610)
#define CLASS_1_5B567C8A01BAEDFE_145_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19B6D670)
#define CLASS_1_5B567C8A01BAEDFE_145_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19B6D840)
#define CLASS_1_5B567C8A01BAEDFE_145_WRITETO_OFFSET UNITYSDK_OFFSET(0x19B6D8A0)
#define CLASS_1_5B567C8A01BAEDFE_145__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B6D950)
#define CLASS_1_5B567C8A01BAEDFE_145__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19B6D690)
#define CLASS_1_5B567C8A01BAEDFE_145__CTOR_OFFSET UNITYSDK_OFFSET(0x19B6D680)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_145*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_145_TypeDefinitionIndex)->GetStaticField(0x4F2D0);
	}
