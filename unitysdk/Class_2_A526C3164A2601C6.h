...
#define CLASS_2_A526C3164A2601C6_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1585AF70)
#define CLASS_2_A526C3164A2601C6_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x1585B230)
#define CLASS_2_A526C3164A2601C6_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x158597D0)
#define CLASS_2_A526C3164A2601C6_GET_TRANS_OFFSET UNITYSDK_OFFSET(0x158597F0)
#define CLASS_2_A526C3164A2601C6_METHOD_2_00BE5A24F02298DC_OFFSET UNITYSDK_OFFSET(0x1585A4C0)
#define CLASS_2_A526C3164A2601C6_METHOD_2_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0x1585A970)
#define CLASS_2_A526C3164A2601C6_METHOD_2_2C95AFAD0256302F_OFFSET UNITYSDK_OFFSET(0x15859B60)
#define CLASS_2_A526C3164A2601C6_METHOD_2_2ED6C3773AA1E488_OFFSET UNITYSDK_OFFSET(0x15859970)
#define CLASS_2_A526C3164A2601C6_METHOD_2_32B2368221A04800_OFFSET UNITYSDK_OFFSET(0x15859FC0)
#define CLASS_2_A526C3164A2601C6_METHOD_2_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x15859800)
#define CLASS_2_A526C3164A2601C6_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x15859D40)
#define CLASS_2_A526C3164A2601C6_METHOD_2_489E0B827662C211_OFFSET UNITYSDK_OFFSET(0x15859460)
#define CLASS_2_A526C3164A2601C6_METHOD_2_4D5351A5CDAC34BC_OFFSET UNITYSDK_OFFSET(0x1585AED0)
#define CLASS_2_A526C3164A2601C6_METHOD_2_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0x1585B610)
#define CLASS_2_A526C3164A2601C6_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x1585B5B0)
#define CLASS_2_A526C3164A2601C6_METHOD_2_58BFC52E546ECE1F_OFFSET UNITYSDK_OFFSET(0x1585A460)
#define CLASS_2_A526C3164A2601C6_METHOD_2_5D868F3D6A3DAB13_OFFSET UNITYSDK_OFFSET(0x1585A1D0)
#define CLASS_2_A526C3164A2601C6_METHOD_2_8B2D6636BADD098E_OFFSET UNITYSDK_OFFSET(0x1585A760)
#define CLASS_2_A526C3164A2601C6_METHOD_2_A27D06F9481FAFDB_1_OFFSET UNITYSDK_OFFSET(0x1585AE30)
#define CLASS_2_A526C3164A2601C6_METHOD_2_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0x1585AD90)
#define CLASS_2_A526C3164A2601C6_METHOD_2_A5148EA9298F38F2_OFFSET UNITYSDK_OFFSET(0x1585AB40)
#define CLASS_2_A526C3164A2601C6_METHOD_2_A5ADA4706DA592FA_OFFSET UNITYSDK_OFFSET(0x15859E10)
#define CLASS_2_A526C3164A2601C6_METHOD_2_AAE61ABAE8899086_OFFSET UNITYSDK_OFFSET(0x1585A080)
#define CLASS_2_A526C3164A2601C6_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x1585AA50)
#define CLASS_2_A526C3164A2601C6_METHOD_2_BCA794728913022B_OFFSET UNITYSDK_OFFSET(0x1585A2D0)
#define CLASS_2_A526C3164A2601C6_METHOD_2_C91E5170F9E36EED_OFFSET UNITYSDK_OFFSET(0x1585B670)
#define CLASS_2_A526C3164A2601C6_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1585AAE0)
#define CLASS_2_A526C3164A2601C6_METHOD_2_CB7604B59F367726_OFFSET UNITYSDK_OFFSET(0x15859C20)
#define CLASS_2_A526C3164A2601C6_METHOD_2_F4F5C92AD8354C0C_OFFSET UNITYSDK_OFFSET(0x1585A9E0)
#define CLASS_2_A526C3164A2601C6_METHOD_2_FDE09C8D62639E3E_OFFSET UNITYSDK_OFFSET(0x15859C90)
#define CLASS_2_A526C3164A2601C6_SET_INDEX_OFFSET UNITYSDK_OFFSET(0x158597E0)
#define CLASS_2_A526C3164A2601C6__CCTOR_OFFSET UNITYSDK_OFFSET(0x1585B510)
#define CLASS_2_A526C3164A2601C6__CTOR_OFFSET UNITYSDK_OFFSET(0x1585B4C0)
#define CLASS_2_A526C3164A2601C6__ONBIND_OFFSET UNITYSDK_OFFSET(0x15859350)
#define CLASS_2_A526C3164A2601C6__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x15859F80)
#define CLASS_2_A526C3164A2601C6__ONTICK_OFFSET UNITYSDK_OFFSET(0x15859DB0)
#define CLASS_2_A526C3164A2601C6___IFIXBASEPROXY_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1585B790)
#define CLASS_2_A526C3164A2601C6___IFIXBASEPROXY_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x1585B7F0)
#define CLASS_2_A526C3164A2601C6___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0x1585B550)
#define CLASS_2_A526C3164A2601C6___IFIXBASEPROXY__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x1585B730)
#define CLASS_2_A526C3164A2601C6___IFIXBASEPROXY__ONTICK_OFFSET UNITYSDK_OFFSET(0x1585B6D0)

inline static constexpr unsigned int Class_2_A526C3164A2601C6_TypeDefinitionIndex = 66896;
...
public:
	...
	{
		return (::RPG::GameCore::BattleScoringDisplayType*)Il2CppClass::FromTypeDefinitionIndex(Class_2_A526C3164A2601C6_TypeDefinitionIndex)->GetStaticField(0x12F40);
	}
	static ::RPG::Client::TextID* StaticGet_Field_2_1()
	{
		return (::RPG::Client::TextID*)Il2CppClass::FromTypeDefinitionIndex(Class_2_A526C3164A2601C6_TypeDefinitionIndex)->GetStaticField(0x12F48);
	}
	...
	::RPG::GameCore::BattleInstance* Field_2_9; // 0x68
	::UnityEngine::Animation* Field_2_10; // 0x70
	::UnityEngine::UI::Text* Field_2_11; // 0x78
	::UnityEngine::Animation* Field_2_12; // 0x80
	::Il2CppArray<::Class_2_DEB067F815EC1625*>* Field_2_13; // 0x88
	::UnityEngine::AnimationState* Field_2_14; // 0x90
	::RPG::GameCore::LevelDataComponent* Field_2_15; // 0x98
	::System::Single Field_2_16; // 0xA0
	::System::Boolean Field_2_17; // 0xA4
	::System::Boolean Field_2_18; // 0xA5
	...
	::Class_2_A526C3164A2601C6_ModifyValueStatus Field_2_23; // 0xB4
	::System::Int32 Field_2_24; // 0xB8
	::RPG::GameCore::ScoringShowType Field_2_25; // 0xBC
