...
#define CLASS_1_F1E790FCE2711921__CTOR_OFFSET UNITYSDK_OFFSET(0x16878D20)
...
public:
	...
	::RPG::Client::LittleGame::TimelineControlGameCharacterMovementConfig Field_1_3; // 0x2C
