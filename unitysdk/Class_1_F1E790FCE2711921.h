...
#define CLASS_1_F1E790FCE2711921__CTOR_OFFSET UNITYSDK_OFFSET(0x167F28B0)
...
public:
	...
	::RPG::Client::LittleGame::ETimelineControlGameCharacterMoveDirection Field_1_4; // 0x34
	::RPG::Client::LittleGame::TimelineControlGameCharacterMovementConfig Field_1_5; // 0x38
