...
#define CLASS_1_F591FD2BDE985BAF_6_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x182C3650)
#define CLASS_1_F591FD2BDE985BAF_6_CLONE_OFFSET UNITYSDK_OFFSET(0x182C32E0)
#define CLASS_1_F591FD2BDE985BAF_6_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x182C34A0)
#define CLASS_1_F591FD2BDE985BAF_6_EQUALS_OFFSET UNITYSDK_OFFSET(0x182C33D0)
#define CLASS_1_F591FD2BDE985BAF_6_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x182C3540)
#define CLASS_1_F591FD2BDE985BAF_6_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x182C37B0)
#define CLASS_1_F591FD2BDE985BAF_6_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x182C36B0)
#define CLASS_1_F591FD2BDE985BAF_6_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x182C33B0)
#define CLASS_1_F591FD2BDE985BAF_6_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x182C33C0)
#define CLASS_1_F591FD2BDE985BAF_6_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x182C3230)
#define CLASS_1_F591FD2BDE985BAF_6_TOSTRING_OFFSET UNITYSDK_OFFSET(0x182C3590)
#define CLASS_1_F591FD2BDE985BAF_6_WRITETO_OFFSET UNITYSDK_OFFSET(0x182C35F0)
#define CLASS_1_F591FD2BDE985BAF_6__CTOR_1_OFFSET UNITYSDK_OFFSET(0x182C3250)
#define CLASS_1_F591FD2BDE985BAF_6__CTOR_OFFSET UNITYSDK_OFFSET(0x182C3240)
