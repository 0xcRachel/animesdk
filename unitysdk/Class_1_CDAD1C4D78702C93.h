...
#define CLASS_1_CDAD1C4D78702C93_GET_AXISVALUEXCHANGESPEED_OFFSET UNITYSDK_OFFSET(0x10B011D0)
#define CLASS_1_CDAD1C4D78702C93_GET_CAMERATYPE_OFFSET UNITYSDK_OFFSET(0x10B01040)
#define CLASS_1_CDAD1C4D78702C93_GET_FOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0x10B01100)
#define CLASS_1_CDAD1C4D78702C93_GET_FREELOOKDRAGMODE_OFFSET UNITYSDK_OFFSET(0x10B011F0)
#define CLASS_1_CDAD1C4D78702C93_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x10B010A0)
#define CLASS_1_CDAD1C4D78702C93_GET_ISAVAILABLEFORREUSE_OFFSET UNITYSDK_OFFSET(0x10B010E0)
#define CLASS_1_CDAD1C4D78702C93_GET_ISCREATED_OFFSET UNITYSDK_OFFSET(0x10B01080)
#define CLASS_1_CDAD1C4D78702C93_GET_ISDESTROYED_OFFSET UNITYSDK_OFFSET(0x10B010C0)
#define CLASS_1_CDAD1C4D78702C93_GET_LOOKATTARGET_OFFSET UNITYSDK_OFFSET(0x10B01120)
#define CLASS_1_CDAD1C4D78702C93_GET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0x10B01060)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_03E2B9212B4B6EAF_1_OFFSET UNITYSDK_OFFSET(0x10AFDC90)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_03E2B9212B4B6EAF_OFFSET UNITYSDK_OFFSET(0x10AFDC50)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_07A25883744F618C_OFFSET UNITYSDK_OFFSET(0x10AFED90)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_1658BEB5EC339408_OFFSET UNITYSDK_OFFSET(0x10AFFDB0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_18982EFD3B740683_OFFSET UNITYSDK_OFFSET(0x10B00590)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_19CCC07C980409E4_1_OFFSET UNITYSDK_OFFSET(0x10AFD040)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0x10AFCFD0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_1D4018D4200358D0_1_OFFSET UNITYSDK_OFFSET(0x10AFEC20)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x10AFEBC0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x10B01220)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x10B01190)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_3A9C03366E936C66_OFFSET UNITYSDK_OFFSET(0x10AFFF10)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_3F5F0BE9AFB2990C_OFFSET UNITYSDK_OFFSET(0x10AFE0D0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x10AFD890)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_46D5C4F0EA172C6A_OFFSET UNITYSDK_OFFSET(0x10AFE9F0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_4BD2BFB48FF90060_OFFSET UNITYSDK_OFFSET(0x10B00A30)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_4E66CC6A96439F85_OFFSET UNITYSDK_OFFSET(0x10AFE510)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_60A0F5EC9777EFB9_OFFSET UNITYSDK_OFFSET(0x10AFD7C0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_6105334A729F22E3_1_OFFSET UNITYSDK_OFFSET(0x10AFDD60)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_6105334A729F22E3_2_OFFSET UNITYSDK_OFFSET(0x10AFDE40)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_6105334A729F22E3_3_OFFSET UNITYSDK_OFFSET(0x10AFDED0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_6105334A729F22E3_4_OFFSET UNITYSDK_OFFSET(0x10AFE580)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_6105334A729F22E3_5_OFFSET UNITYSDK_OFFSET(0x10B008F0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_6105334A729F22E3_OFFSET UNITYSDK_OFFSET(0x10AFDCD0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_684E8D76BF9D5255_OFFSET UNITYSDK_OFFSET(0x10B008B0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_7301533EE4FBBAD2_OFFSET UNITYSDK_OFFSET(0x10AFE410)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_737220D2233A9067_OFFSET UNITYSDK_OFFSET(0x10B00770)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_739DB9F245C7FAD0_OFFSET UNITYSDK_OFFSET(0x10B00BB0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_7F612AA2F04984D6_OFFSET UNITYSDK_OFFSET(0x10B01210)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_86914B28476494AF_1_OFFSET UNITYSDK_OFFSET(0x10AFF810)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_86914B28476494AF_OFFSET UNITYSDK_OFFSET(0x10AFF6F0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_8C3EF9C039C5859D_OFFSET UNITYSDK_OFFSET(0x10AFD310)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_96347D126BE5AFBC_OFFSET UNITYSDK_OFFSET(0x10B00CF0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_96DCADC783ACF0D4_OFFSET UNITYSDK_OFFSET(0x10AFF290)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_9C66B07446448FC6_OFFSET UNITYSDK_OFFSET(0x10AFE610)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_A03C765EBC5D1677_OFFSET UNITYSDK_OFFSET(0x10B009A0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x10B01140)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_AF001DB8752C7089_OFFSET UNITYSDK_OFFSET(0x10AFE7A0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_B2A8785E9E1BD2C1_OFFSET UNITYSDK_OFFSET(0x10AFE260)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_B3895AA881B3EBB9_OFFSET UNITYSDK_OFFSET(0x10AFEC80)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_B74D29C43104A205_OFFSET UNITYSDK_OFFSET(0x10AFDFB0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_B7592B2BDF345A00_OFFSET UNITYSDK_OFFSET(0x10AFEAC0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_BA904CAFF6C7217F_OFFSET UNITYSDK_OFFSET(0x10AFD710)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_BC46FCF99873D9DD_OFFSET UNITYSDK_OFFSET(0x10AFD8F0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_C411E5881DF297DE_OFFSET UNITYSDK_OFFSET(0x10AFE150)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_C7D881C292ED8D3D_OFFSET UNITYSDK_OFFSET(0x10AFF930)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_C98BEB16ED641BC0_1_OFFSET UNITYSDK_OFFSET(0x10AFE390)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_C98BEB16ED641BC0_OFFSET UNITYSDK_OFFSET(0x10AFE310)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x10AFEA50)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CA6BDDCC5F7CE11E_1_OFFSET UNITYSDK_OFFSET(0x10AFF140)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CA6BDDCC5F7CE11E_OFFSET UNITYSDK_OFFSET(0x10AFF070)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CAAD3899EE103AC7_OFFSET UNITYSDK_OFFSET(0x10AFC450)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CB613A5EF970C11B_OFFSET UNITYSDK_OFFSET(0x10AFD930)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CBDC22058B67F0FE_OFFSET UNITYSDK_OFFSET(0x10AFD9A0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CF0080D9D0A33EA9_1_OFFSET UNITYSDK_OFFSET(0x10AFF200)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CF0080D9D0A33EA9_OFFSET UNITYSDK_OFFSET(0x10AFED00)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_D64FD9A228A1C4E0_OFFSET UNITYSDK_OFFSET(0x10B00710)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_D87A7D8243E04FD7_OFFSET UNITYSDK_OFFSET(0x10AFD0B0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_D920CA000FAB6C31_OFFSET UNITYSDK_OFFSET(0x10AFF4D0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_DDF4E6AEE2216B17_OFFSET UNITYSDK_OFFSET(0x10AFE990)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_E7E9C69965F5C461_OFFSET UNITYSDK_OFFSET(0x10AFE860)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_E7F61176CF07E702_OFFSET UNITYSDK_OFFSET(0x10AFE1F0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_F28136982D1084AB_OFFSET UNITYSDK_OFFSET(0x10AFEFD0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_FD7514C64FB1B043_OFFSET UNITYSDK_OFFSET(0x10AFDAF0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_FF7B2911BBACA4A9_1_OFFSET UNITYSDK_OFFSET(0x10AFF1B0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0x10AFF0E0)
#define CLASS_1_CDAD1C4D78702C93_SET_AXISVALUEXCHANGESPEED_OFFSET UNITYSDK_OFFSET(0x10B011E0)
#define CLASS_1_CDAD1C4D78702C93_SET_CAMERATYPE_OFFSET UNITYSDK_OFFSET(0x10B01050)
#define CLASS_1_CDAD1C4D78702C93_SET_FOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0x10B01110)
#define CLASS_1_CDAD1C4D78702C93_SET_FREELOOKDRAGMODE_OFFSET UNITYSDK_OFFSET(0x10B01200)
#define CLASS_1_CDAD1C4D78702C93_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x10B010B0)
#define CLASS_1_CDAD1C4D78702C93_SET_ISAVAILABLEFORREUSE_OFFSET UNITYSDK_OFFSET(0x10B010F0)
#define CLASS_1_CDAD1C4D78702C93_SET_ISCREATED_OFFSET UNITYSDK_OFFSET(0x10B01090)
#define CLASS_1_CDAD1C4D78702C93_SET_ISDESTROYED_OFFSET UNITYSDK_OFFSET(0x10B010D0)
#define CLASS_1_CDAD1C4D78702C93_SET_LOOKATTARGET_OFFSET UNITYSDK_OFFSET(0x10B01130)
#define CLASS_1_CDAD1C4D78702C93_SET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0x10B01070)
#define CLASS_1_CDAD1C4D78702C93__CTOR_OFFSET UNITYSDK_OFFSET(0x10AFC430)
...
{
public:
	::RPG::Client::CameraBlendCurve* Field_1_16; // 0x10
	::RPG::Client::RPGCinemachineZoom* Field_1_19; // 0x18
	::UnityEngine::GameObject* Field_1_10; // 0x20
	::RPG::Client::RPGCinemachineOldFreelook3rdBlend* Field_1_20; // 0x28
	::Cinemachine::CinemachineFreeLook* Field_1_11; // 0x30
	::UnityEngine::GameObject* Field_1_12; // 0x38
	::UnityEngine::Transform* _FollowTarget_k__BackingField; // 0x40
	::Class_1_7ACD8E31992CDE1A_1* Field_1_24; // 0x48
	::UnityEngine::Transform* _LookAtTarget_k__BackingField; // 0x50
	::System::Single Field_1_17; // 0x58
	::System::Nullable_1<::UnityEngine::Vector2> Field_1_13; // 0x5C
	::System::Nullable_1<::UnityEngine::Vector2> Field_1_14; // 0x68
	::System::Single Field_1_23; // 0x74
	::System::Boolean _IsCreated_k__BackingField; // 0x78
	::System::Boolean Field_1_21; // 0x79
	::System::Boolean _IsDestroyed_k__BackingField; // 0x7A
	::System::UInt32 _RuntimeID_k__BackingField; // 0x7C
	::System::Single Field_1_18; // 0x80
	::System::Single _AxisValueXChangeSpeed_k__BackingField; // 0x84
	::Class_1_CD9533418F3B6F39_VCameraType _CameraType_k__BackingField; // 0x88
	::System::Single Field_1_15; // 0x8C
	::System::Boolean _IsAvailableForReuse_k__BackingField; // 0x90
	::System::Boolean _FreelookDragMode_k__BackingField; // 0x91
	::System::Boolean Field_1_22; // 0x92
	::System::Boolean _IsActive_k__BackingField; // 0x93
