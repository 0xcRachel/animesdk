...
#define CPUTEXTUREBUFFER_GET_DATACOUNT_OFFSET UNITYSDK_OFFSET(0xA6FFB90)
#define CPUTEXTUREBUFFER_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0xA6FFB80)
#define CPUTEXTUREBUFFER_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0xA6FFB70)
#define CPUTEXTUREBUFFER_METHOD_3_053D00406C3D70A8_OFFSET UNITYSDK_OFFSET(0xA6FFC60)
#define CPUTEXTUREBUFFER_METHOD_3_5DE9667DA47C9DE0_OFFSET UNITYSDK_OFFSET(0xA6FFE00)
#define CPUTEXTUREBUFFER_METHOD_3_627557CE4CD0ABB4_OFFSET UNITYSDK_OFFSET(0xA700010)
#define CPUTEXTUREBUFFER_METHOD_3_9FE4AB7E2BDAE9CB_OFFSET UNITYSDK_OFFSET(0xA6FFBE0)
#define CPUTEXTUREBUFFER_METHOD_3_BA7EA81739AE87D6_OFFSET UNITYSDK_OFFSET(0xA700090)
#define CPUTEXTUREBUFFER_METHOD_3_E88B5CB549D7264A_OFFSET UNITYSDK_OFFSET(0xA6FFED0)
#define CPUTEXTUREBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0xA700390)
