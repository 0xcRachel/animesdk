...
#define CLASS_1_5B567C8A01BAEDFE_225_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A33C8E0)
#define CLASS_1_5B567C8A01BAEDFE_225_CLONE_OFFSET UNITYSDK_OFFSET(0x1A33C750)
#define CLASS_1_5B567C8A01BAEDFE_225_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A33C7F0)
#define CLASS_1_5B567C8A01BAEDFE_225_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A33C790)
#define CLASS_1_5B567C8A01BAEDFE_225_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A33C840)
#define CLASS_1_5B567C8A01BAEDFE_225_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A33C930)
#define CLASS_1_5B567C8A01BAEDFE_225_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A33C900)
#define CLASS_1_5B567C8A01BAEDFE_225_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A33C6D0)
#define CLASS_1_5B567C8A01BAEDFE_225_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A33C700)
#define CLASS_1_5B567C8A01BAEDFE_225_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A33C870)
#define CLASS_1_5B567C8A01BAEDFE_225_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A33C8D0)
#define CLASS_1_5B567C8A01BAEDFE_225__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A33C980)
#define CLASS_1_5B567C8A01BAEDFE_225__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A33C720)
#define CLASS_1_5B567C8A01BAEDFE_225__CTOR_OFFSET UNITYSDK_OFFSET(0x1A33C710)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_225*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_225_TypeDefinitionIndex)->GetStaticField(0x1BD50);
	}
