...
#define CLASS_1_F515ED1A4C8C8A9C_METHOD_1_B6E221A5FAF0AF49_OFFSET UNITYSDK_OFFSET(0x11837F20)
#define CLASS_1_F515ED1A4C8C8A9C__CCTOR_OFFSET UNITYSDK_OFFSET(0x11838080)
...
public:
	...
	{
		return (::Il2CppArray<::Class_0_16E4307DCC419505_429*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_F515ED1A4C8C8A9C_TypeDefinitionIndex)->GetStaticField(0x46240);
	}
