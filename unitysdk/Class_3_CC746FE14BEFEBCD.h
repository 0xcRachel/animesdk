...
#define CLASS_3_CC746FE14BEFEBCD_METHOD_3_BE513DA00D254FDB_OFFSET UNITYSDK_OFFSET(0x18777660)
#define CLASS_3_CC746FE14BEFEBCD_METHOD_3_FCE92D332F1E367F_OFFSET UNITYSDK_OFFSET(0x187775C0)
#define CLASS_3_CC746FE14BEFEBCD__CTOR_OFFSET UNITYSDK_OFFSET(0x18777620)
...
public:
	...
	::RPG::GameCore::ProjectileData* Field_3_6; // 0x20
	::RPG::GameCore::TargetEvaluator* Field_3_0; // 0x28
	::RPG::GameCore::PredicateConfig* Field_3_2; // 0x30
	::RPG::GameCore::NewProjectileConfig* Field_3_7; // 0x38
	::System::Boolean Field_3_9; // 0x40
	::System::Boolean Field_3_5; // 0x41
	::RPG::GameCore::AliveStateMask Field_3_1; // 0x42
