...
#define CLASS_1_06E38C65842C3B24_ADD_ONBESTRECORDCHANGED_OFFSET UNITYSDK_OFFSET(0x17C58B50)
#define CLASS_1_06E38C65842C3B24_ADD_ONCURRENTSESSIONCHANGED_OFFSET UNITYSDK_OFFSET(0x17C58900)
#define CLASS_1_06E38C65842C3B24_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x17C58870)
#define CLASS_1_06E38C65842C3B24_GET_HASOBTAINEDBADGE_OFFSET UNITYSDK_OFFSET(0x17C58C10)
#define CLASS_1_06E38C65842C3B24_GET_HASTAKENSPECIALREWARD_OFFSET UNITYSDK_OFFSET(0x17C58C30)
#define CLASS_1_06E38C65842C3B24_GET_ISPASSED_OFFSET UNITYSDK_OFFSET(0x17C589C0)
#define CLASS_1_06E38C65842C3B24_METHOD_1_03BFDB1C3240A55A_OFFSET UNITYSDK_OFFSET(0x17C58D10)
#define CLASS_1_06E38C65842C3B24_METHOD_1_0AB718BEE9EA06D7_OFFSET UNITYSDK_OFFSET(0x17C58890)
#define CLASS_1_06E38C65842C3B24_METHOD_1_114781D79D91EA39_1_OFFSET UNITYSDK_OFFSET(0x17C58AC0)
#define CLASS_1_06E38C65842C3B24_METHOD_1_114781D79D91EA39_OFFSET UNITYSDK_OFFSET(0x17C589E0)
#define CLASS_1_06E38C65842C3B24_METHOD_1_129210A1EA004483_OFFSET UNITYSDK_OFFSET(0x166EC960)
#define CLASS_1_06E38C65842C3B24_METHOD_1_13F68F21231161ED_OFFSET UNITYSDK_OFFSET(0x17C59030)
#define CLASS_1_06E38C65842C3B24_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x17C58880)
#define CLASS_1_06E38C65842C3B24_METHOD_1_2DFFCEC5BAFFBDEA_OFFSET UNITYSDK_OFFSET(0x17C58AD0)
#define CLASS_1_06E38C65842C3B24_METHOD_1_364C696688C525C0_OFFSET UNITYSDK_OFFSET(0x166EBF10)
#define CLASS_1_06E38C65842C3B24_METHOD_1_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x17C59130)
#define CLASS_1_06E38C65842C3B24_METHOD_1_5F1CE4B44626D198_OFFSET UNITYSDK_OFFSET(0x17C58AE0)
#define CLASS_1_06E38C65842C3B24_METHOD_1_617F2795F0D73EAD_OFFSET UNITYSDK_OFFSET(0x166EC520)
#define CLASS_1_06E38C65842C3B24_METHOD_1_70437D85C11C5222_OFFSET UNITYSDK_OFFSET(0x166EC350)
#define CLASS_1_06E38C65842C3B24_METHOD_1_822031E522673D19_OFFSET UNITYSDK_OFFSET(0x166EC420)
#define CLASS_1_06E38C65842C3B24_METHOD_1_87984A3AD7457DDD_OFFSET UNITYSDK_OFFSET(0x17C58F40)
#define CLASS_1_06E38C65842C3B24_METHOD_1_A871253BFD471C99_OFFSET UNITYSDK_OFFSET(0x17C589F0)
#define CLASS_1_06E38C65842C3B24_METHOD_1_C893A4E557146E6C_OFFSET UNITYSDK_OFFSET(0x166EC7A0)
#define CLASS_1_06E38C65842C3B24_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x166ECB20)
#define CLASS_1_06E38C65842C3B24_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x166ECAE0)
#define CLASS_1_06E38C65842C3B24_METHOD_1_CFC95121222309BD_OFFSET UNITYSDK_OFFSET(0x166EC6F0)
#define CLASS_1_06E38C65842C3B24_METHOD_1_F6EB917C5A67C7BA_OFFSET UNITYSDK_OFFSET(0x166ECA80)
#define CLASS_1_06E38C65842C3B24_REMOVE_ONBESTRECORDCHANGED_OFFSET UNITYSDK_OFFSET(0x17C58BB0)
#define CLASS_1_06E38C65842C3B24_REMOVE_ONCURRENTSESSIONCHANGED_OFFSET UNITYSDK_OFFSET(0x17C58960)
#define CLASS_1_06E38C65842C3B24_SET_HASOBTAINEDBADGE_OFFSET UNITYSDK_OFFSET(0x17C58C20)
#define CLASS_1_06E38C65842C3B24_SET_HASTAKENSPECIALREWARD_OFFSET UNITYSDK_OFFSET(0x17C58C40)
#define CLASS_1_06E38C65842C3B24_SET_ISPASSED_OFFSET UNITYSDK_OFFSET(0x17C589D0)
#define CLASS_1_06E38C65842C3B24__CTOR_OFFSET UNITYSDK_OFFSET(0x17C58C50)
#define CLASS_1_06E38C65842C3B24__STARTNEWENGAGEMENTFROMSTAGE_B__50_0_OFFSET UNITYSDK_OFFSET(0x166ECB60)

inline static constexpr unsigned int Class_1_06E38C65842C3B24_TypeDefinitionIndex = 74096;

class Class_1_06E38C65842C3B24 : public ::System::Object
{
public:
	::System::Action* OnBestRecordChanged; // 0x10
	::Class_0_16E4307DCC419505_1214* Field_1_1; // 0x18
	::System::Action* OnCurrentSessionChanged; // 0x20
	...
	::Class_1_608D5748B6FB2DB7* Field_1_5; // 0x38
	::System::Collections::Generic::List_1<::System::UInt32>* Field_1_6; // 0x40
	::Class_0_16E4307DCC419505_1215* Field_1_7; // 0x48
	::Class_1_52DE58AEA447C9CD* _Config_k__BackingField; // 0x50
	::System::Boolean _HasObtainedBadge_k__BackingField; // 0x58
	::System::Boolean _IsPassed_k__BackingField; // 0x59
	::System::Boolean _HasTakenSpecialReward_k__BackingField; // 0x5A

	::System::Void _ctor(::Class_1_52DE58AEA447C9CD* a1, ::Class_0_16E4307DCC419505_1215* a2, ::Class_0_16E4307DCC419505_1214* a3)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_52DE58AEA447C9CD*, ::Class_0_16E4307DCC419505_1215*, ::Class_0_16E4307DCC419505_1214*))((::PBYTE)hIl2Cpp + CLASS_1_06E38C65842C3B24__CTOR_OFFSET))(this, a1, a2, a3);
	}
