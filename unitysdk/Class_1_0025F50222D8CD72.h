...
#define CLASS_1_0025F50222D8CD72_GET_ANCHORTYPE_OFFSET UNITYSDK_OFFSET(0x102CEE50)
#define CLASS_1_0025F50222D8CD72_GET_EFFECTPATH2V1LOCALPLAYER_OFFSET UNITYSDK_OFFSET(0x102CEE20)
#define CLASS_1_0025F50222D8CD72_GET_EFFECTPATH2V1TEAMMATE_OFFSET UNITYSDK_OFFSET(0x102CEE30)
#define CLASS_1_0025F50222D8CD72_GET_EFFECTPATHENEMY_OFFSET UNITYSDK_OFFSET(0x102CEE10)
#define CLASS_1_0025F50222D8CD72_GET_EFFECTPATH_OFFSET UNITYSDK_OFFSET(0x102CEE00)
#define CLASS_1_0025F50222D8CD72_GET_EFFECTROOT_OFFSET UNITYSDK_OFFSET(0x102CEE60)
#define CLASS_1_0025F50222D8CD72_GET_FADEINANIMATION_OFFSET UNITYSDK_OFFSET(0x102CEE80)
#define CLASS_1_0025F50222D8CD72_GET_FADEOUTANIMATION_OFFSET UNITYSDK_OFFSET(0x102CEE90)
#define CLASS_1_0025F50222D8CD72_GET_HAS2V1SPECIALVERSION_OFFSET UNITYSDK_OFFSET(0x102CEE40)
#define CLASS_1_0025F50222D8CD72_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x102CEBA0)
#define CLASS_1_0025F50222D8CD72_METHOD_1_B64782115EFE4597_OFFSET UNITYSDK_OFFSET(0x102CEAB0)
#define CLASS_1_0025F50222D8CD72_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x102CEC00)
#define CLASS_1_0025F50222D8CD72_METHOD_1_CA6BDDCC5F7CE11E_OFFSET UNITYSDK_OFFSET(0x102CEB30)
#define CLASS_1_0025F50222D8CD72_METHOD_1_DA37DFE3A5BDA9F4_OFFSET UNITYSDK_OFFSET(0x102CEC50)
#define CLASS_1_0025F50222D8CD72_METHOD_1_FA58824BA12F6F62_OFFSET UNITYSDK_OFFSET(0x102CED30)
#define CLASS_1_0025F50222D8CD72_SET_EFFECTROOT_OFFSET UNITYSDK_OFFSET(0x102CEE70)
#define CLASS_1_0025F50222D8CD72__CTOR_OFFSET UNITYSDK_OFFSET(0x102CE990)

inline static constexpr unsigned int Class_1_0025F50222D8CD72_TypeDefinitionIndex = 69803;

class Class_1_0025F50222D8CD72 : public ::System::Object
{
public:
	::UnityEngine::GameObject* _EffectRoot_k__BackingField; // 0x10
	::System::String* _FadeInAnimation_k__BackingField; // 0x18
	::System::String* _EffectPath_k__BackingField; // 0x20
	::System::String* _EffectPath2v1LocalPlayer_k__BackingField; // 0x28
	::System::String* _EffectPathEnemy_k__BackingField; // 0x30
	::System::String* _FadeOutAnimation_k__BackingField; // 0x38
	::System::String* _EffectPath2v1Teammate_k__BackingField; // 0x40
