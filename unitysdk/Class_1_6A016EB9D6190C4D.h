...
#define CLASS_1_6A016EB9D6190C4D_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17B426B0)
#define CLASS_1_6A016EB9D6190C4D_CLONE_OFFSET UNITYSDK_OFFSET(0x17B422C0)
#define CLASS_1_6A016EB9D6190C4D_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17B423D0)
#define CLASS_1_6A016EB9D6190C4D_EQUALS_OFFSET UNITYSDK_OFFSET(0x17B42370)
#define CLASS_1_6A016EB9D6190C4D_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17B424A0)
#define CLASS_1_6A016EB9D6190C4D_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x17B42900)
#define CLASS_1_6A016EB9D6190C4D_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x17B42880)
#define CLASS_1_6A016EB9D6190C4D_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x17B42340)
#define CLASS_1_6A016EB9D6190C4D_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x17B42310)
#define CLASS_1_6A016EB9D6190C4D_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x17B42350)
#define CLASS_1_6A016EB9D6190C4D_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x17B42320)
#define CLASS_1_6A016EB9D6190C4D_METHOD_1_EA98AC27B86895E5_OFFSET UNITYSDK_OFFSET(0x17B42330)
#define CLASS_1_6A016EB9D6190C4D_METHOD_1_F64A1871C5AC5ACE_OFFSET UNITYSDK_OFFSET(0x17B42360)
#define CLASS_1_6A016EB9D6190C4D_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17B42170)
#define CLASS_1_6A016EB9D6190C4D_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17B42500)
#define CLASS_1_6A016EB9D6190C4D_WRITETO_OFFSET UNITYSDK_OFFSET(0x17B42560)
#define CLASS_1_6A016EB9D6190C4D__CCTOR_OFFSET UNITYSDK_OFFSET(0x17B42A60)
#define CLASS_1_6A016EB9D6190C4D__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17B421F0)
#define CLASS_1_6A016EB9D6190C4D__CTOR_OFFSET UNITYSDK_OFFSET(0x17B42180)
...
public:
	...
	{
		return (::Google::Protobuf::Collections::MapField_2_Codec<::System::UInt32, ::System::Double>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6A016EB9D6190C4D_TypeDefinitionIndex)->GetStaticField(0x3DBF0);
	}
	static ::Google::Protobuf::Collections::MapField_2_Codec<::System::UInt32, ::System::UInt32>** StaticGet_Field_1_4()
	{
		return (::Google::Protobuf::Collections::MapField_2_Codec<::System::UInt32, ::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6A016EB9D6190C4D_TypeDefinitionIndex)->GetStaticField(0x3DBF8);
	}
	...
	::Google::Protobuf::Collections::MapField_2<::System::UInt32, ::System::Double>* Field_1_10; // 0x20
