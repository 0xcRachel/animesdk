...
#define CLASS_1_6A016EB9D6190C4D_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1795BA80)
#define CLASS_1_6A016EB9D6190C4D_CLONE_OFFSET UNITYSDK_OFFSET(0x1795B690)
#define CLASS_1_6A016EB9D6190C4D_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1795B7A0)
#define CLASS_1_6A016EB9D6190C4D_EQUALS_OFFSET UNITYSDK_OFFSET(0x1795B740)
#define CLASS_1_6A016EB9D6190C4D_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1795B870)
#define CLASS_1_6A016EB9D6190C4D_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1795BCD0)
#define CLASS_1_6A016EB9D6190C4D_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1795BC50)
#define CLASS_1_6A016EB9D6190C4D_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1795B710)
#define CLASS_1_6A016EB9D6190C4D_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1795B6E0)
#define CLASS_1_6A016EB9D6190C4D_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1795B720)
#define CLASS_1_6A016EB9D6190C4D_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1795B6F0)
#define CLASS_1_6A016EB9D6190C4D_METHOD_1_EA98AC27B86895E5_OFFSET UNITYSDK_OFFSET(0x1795B700)
#define CLASS_1_6A016EB9D6190C4D_METHOD_1_F64A1871C5AC5ACE_OFFSET UNITYSDK_OFFSET(0x1795B730)
#define CLASS_1_6A016EB9D6190C4D_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1795B540)
#define CLASS_1_6A016EB9D6190C4D_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1795B8D0)
#define CLASS_1_6A016EB9D6190C4D_WRITETO_OFFSET UNITYSDK_OFFSET(0x1795B930)
#define CLASS_1_6A016EB9D6190C4D__CCTOR_OFFSET UNITYSDK_OFFSET(0x1795BE30)
#define CLASS_1_6A016EB9D6190C4D__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1795B5C0)
#define CLASS_1_6A016EB9D6190C4D__CTOR_OFFSET UNITYSDK_OFFSET(0x1795B550)

inline static constexpr unsigned int Class_1_6A016EB9D6190C4D_TypeDefinitionIndex = 22522;
...
public:
	...
	{
		return (::Google::Protobuf::Collections::MapField_2_Codec<::System::UInt32, ::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6A016EB9D6190C4D_TypeDefinitionIndex)->GetStaticField(0x3C850);
	}
	static ::Google::Protobuf::Collections::MapField_2_Codec<::System::UInt32, ::System::Double>** StaticGet_Field_1_9()
	{
		return (::Google::Protobuf::Collections::MapField_2_Codec<::System::UInt32, ::System::Double>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6A016EB9D6190C4D_TypeDefinitionIndex)->GetStaticField(0x3C858);
	}
