...
#define SRMATH_ANGLE_OFFSET UNITYSDK_OFFSET(0x1A325D60)
#define SRMATH_AVERAGE_OFFSET UNITYSDK_OFFSET(0x1A325D50)
#define SRMATH_EASE_OFFSET UNITYSDK_OFFSET(0x1A322920)
#define SRMATH_FACINGNORMALIZED_OFFSET UNITYSDK_OFFSET(0x1A3259C0)
#define SRMATH_LERPUNCLAMPED_1_OFFSET UNITYSDK_OFFSET(0x1A325970)
#define SRMATH_LERPUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x1A325950)
#define SRMATH_NEARESTANGLE_OFFSET UNITYSDK_OFFSET(0x1A325B30)
#define SRMATH_SMOOTHCLAMP_OFFSET UNITYSDK_OFFSET(0x1A3257C0)
#define SRMATH_SPRINGLERP_1_OFFSET UNITYSDK_OFFSET(0x1A3251B0)
#define SRMATH_SPRINGLERP_2_OFFSET UNITYSDK_OFFSET(0x1A325380)
#define SRMATH_SPRINGLERP_3_OFFSET UNITYSDK_OFFSET(0x1A3255A0)
#define SRMATH_SPRINGLERP_OFFSET UNITYSDK_OFFSET(0x1A325010)
#define SRMATH_WRAPANGLE_OFFSET UNITYSDK_OFFSET(0x1A325B00)
#define SRMATH_WRAP_1_OFFSET UNITYSDK_OFFSET(0x1A325D20)
#define SRMATH_WRAP_OFFSET UNITYSDK_OFFSET(0x1A325C70)
