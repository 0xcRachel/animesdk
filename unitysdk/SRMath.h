...
#define SRMATH_ANGLE_OFFSET UNITYSDK_OFFSET(0x1848E1A0)
#define SRMATH_AVERAGE_OFFSET UNITYSDK_OFFSET(0x1848E190)
#define SRMATH_EASE_OFFSET UNITYSDK_OFFSET(0x1848AD60)
#define SRMATH_FACINGNORMALIZED_OFFSET UNITYSDK_OFFSET(0x1848DE00)
#define SRMATH_LERPUNCLAMPED_1_OFFSET UNITYSDK_OFFSET(0x1848DDB0)
#define SRMATH_LERPUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x1848DD90)
#define SRMATH_NEARESTANGLE_OFFSET UNITYSDK_OFFSET(0x1848DF70)
#define SRMATH_SMOOTHCLAMP_OFFSET UNITYSDK_OFFSET(0x1848DC00)
#define SRMATH_SPRINGLERP_1_OFFSET UNITYSDK_OFFSET(0x1848D5F0)
#define SRMATH_SPRINGLERP_2_OFFSET UNITYSDK_OFFSET(0x1848D7C0)
#define SRMATH_SPRINGLERP_3_OFFSET UNITYSDK_OFFSET(0x1848D9E0)
#define SRMATH_SPRINGLERP_OFFSET UNITYSDK_OFFSET(0x1848D450)
#define SRMATH_WRAPANGLE_OFFSET UNITYSDK_OFFSET(0x1848DF40)
#define SRMATH_WRAP_1_OFFSET UNITYSDK_OFFSET(0x1848E160)
#define SRMATH_WRAP_OFFSET UNITYSDK_OFFSET(0x1848E0B0)
