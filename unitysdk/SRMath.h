...
#define SRMATH_ANGLE_OFFSET UNITYSDK_OFFSET(0x1B2DC620)
#define SRMATH_AVERAGE_OFFSET UNITYSDK_OFFSET(0x1B2DC610)
#define SRMATH_EASE_OFFSET UNITYSDK_OFFSET(0x1B2D91E0)
#define SRMATH_FACINGNORMALIZED_OFFSET UNITYSDK_OFFSET(0x1B2DC280)
#define SRMATH_LERPUNCLAMPED_1_OFFSET UNITYSDK_OFFSET(0x1B2DC230)
#define SRMATH_LERPUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x1B2DC210)
#define SRMATH_NEARESTANGLE_OFFSET UNITYSDK_OFFSET(0x1B2DC3F0)
#define SRMATH_SMOOTHCLAMP_OFFSET UNITYSDK_OFFSET(0x1B2DC080)
#define SRMATH_SPRINGLERP_1_OFFSET UNITYSDK_OFFSET(0x1B2DBA70)
#define SRMATH_SPRINGLERP_2_OFFSET UNITYSDK_OFFSET(0x1B2DBC40)
#define SRMATH_SPRINGLERP_3_OFFSET UNITYSDK_OFFSET(0x1B2DBE60)
#define SRMATH_SPRINGLERP_OFFSET UNITYSDK_OFFSET(0x1B2DB8D0)
#define SRMATH_WRAPANGLE_OFFSET UNITYSDK_OFFSET(0x1B2DC3C0)
#define SRMATH_WRAP_1_OFFSET UNITYSDK_OFFSET(0x1B2DC5E0)
#define SRMATH_WRAP_OFFSET UNITYSDK_OFFSET(0x1B2DC530)
