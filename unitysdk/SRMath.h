...
#define SRMATH_ANGLE_OFFSET UNITYSDK_OFFSET(0x17C78530)
#define SRMATH_AVERAGE_OFFSET UNITYSDK_OFFSET(0x17C78520)
#define SRMATH_EASE_OFFSET UNITYSDK_OFFSET(0x17C750F0)
#define SRMATH_FACINGNORMALIZED_OFFSET UNITYSDK_OFFSET(0x17C78190)
#define SRMATH_LERPUNCLAMPED_1_OFFSET UNITYSDK_OFFSET(0x17C78140)
#define SRMATH_LERPUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x17C78120)
#define SRMATH_NEARESTANGLE_OFFSET UNITYSDK_OFFSET(0x17C78300)
#define SRMATH_SMOOTHCLAMP_OFFSET UNITYSDK_OFFSET(0x17C77F90)
#define SRMATH_SPRINGLERP_1_OFFSET UNITYSDK_OFFSET(0x17C77980)
#define SRMATH_SPRINGLERP_2_OFFSET UNITYSDK_OFFSET(0x17C77B50)
#define SRMATH_SPRINGLERP_3_OFFSET UNITYSDK_OFFSET(0x17C77D70)
#define SRMATH_SPRINGLERP_OFFSET UNITYSDK_OFFSET(0x17C777E0)
#define SRMATH_WRAPANGLE_OFFSET UNITYSDK_OFFSET(0x17C782D0)
#define SRMATH_WRAP_1_OFFSET UNITYSDK_OFFSET(0x17C784F0)
#define SRMATH_WRAP_OFFSET UNITYSDK_OFFSET(0x17C78440)

inline static constexpr unsigned int SRMath_TypeDefinitionIndex = 26903;
