...
#define CLASS_1_3EE9A6D817C1ADA3_ADD_ONRECORDCHANGED_OFFSET UNITYSDK_OFFSET(0x145F62E0)
#define CLASS_1_3EE9A6D817C1ADA3_DISPOSE_OFFSET UNITYSDK_OFFSET(0x145F6760)
#define CLASS_1_3EE9A6D817C1ADA3_METHOD_1_2DFFCEC5BAFFBDEA_OFFSET UNITYSDK_OFFSET(0x145F6260)
#define CLASS_1_3EE9A6D817C1ADA3_METHOD_1_5F1CE4B44626D198_OFFSET UNITYSDK_OFFSET(0x145F6270)
#define CLASS_1_3EE9A6D817C1ADA3_METHOD_1_775B6D644F07B554_OFFSET UNITYSDK_OFFSET(0x145F6950)
#define CLASS_1_3EE9A6D817C1ADA3_METHOD_1_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x145F6520)
#define CLASS_1_3EE9A6D817C1ADA3_METHOD_1_F0BD65B017F2AC0B_1_OFFSET UNITYSDK_OFFSET(0x145F69B0)
#define CLASS_1_3EE9A6D817C1ADA3_METHOD_1_F0BD65B017F2AC0B_OFFSET UNITYSDK_OFFSET(0x145F6900)
#define CLASS_1_3EE9A6D817C1ADA3_METHOD_1_FD407F543E29DD0C_OFFSET UNITYSDK_OFFSET(0x145F65D0)
#define CLASS_1_3EE9A6D817C1ADA3_REMOVE_ONRECORDCHANGED_OFFSET UNITYSDK_OFFSET(0x145F6340)
#define CLASS_1_3EE9A6D817C1ADA3__CTOR_OFFSET UNITYSDK_OFFSET(0x145F63A0)

inline static constexpr unsigned int Class_1_3EE9A6D817C1ADA3_TypeDefinitionIndex = 74226;

class Class_1_3EE9A6D817C1ADA3 : public ::System::Object
{
public:
	::Class_1_06E38C65842C3B24* Field_1_0; // 0x10
	::RPG::Client::Challenge::Tierce::ChallengeTierceRecordBase* Field_1_1; // 0x18
	::Class_1_608D5748B6FB2DB7* Field_1_2; // 0x20
