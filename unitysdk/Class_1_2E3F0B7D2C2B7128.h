...
#define CLASS_1_2E3F0B7D2C2B7128_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1786D3C0)
#define CLASS_1_2E3F0B7D2C2B7128_CLONE_OFFSET UNITYSDK_OFFSET(0x1786CF90)
#define CLASS_1_2E3F0B7D2C2B7128_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1786D0E0)
#define CLASS_1_2E3F0B7D2C2B7128_EQUALS_OFFSET UNITYSDK_OFFSET(0x1786CFF0)
#define CLASS_1_2E3F0B7D2C2B7128_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1786D190)
#define CLASS_1_2E3F0B7D2C2B7128_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1786D5C0)
#define CLASS_1_2E3F0B7D2C2B7128_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1786D520)
#define CLASS_1_2E3F0B7D2C2B7128_METHOD_1_3DACC45AC8150727_OFFSET UNITYSDK_OFFSET(0x1786CFE0)
#define CLASS_1_2E3F0B7D2C2B7128_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x1786CFC0)
#define CLASS_1_2E3F0B7D2C2B7128_METHOD_1_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x1786CFD0)
#define CLASS_1_2E3F0B7D2C2B7128_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1786CE70)
#define CLASS_1_2E3F0B7D2C2B7128_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1786D280)
#define CLASS_1_2E3F0B7D2C2B7128_WRITETO_OFFSET UNITYSDK_OFFSET(0x1786D2E0)
#define CLASS_1_2E3F0B7D2C2B7128__CCTOR_OFFSET UNITYSDK_OFFSET(0x1786D6A0)
#define CLASS_1_2E3F0B7D2C2B7128__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1786CED0)
#define CLASS_1_2E3F0B7D2C2B7128__CTOR_OFFSET UNITYSDK_OFFSET(0x1786CE80)

inline static constexpr unsigned int Class_1_2E3F0B7D2C2B7128_TypeDefinitionIndex = 25007;
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_F381659723E3F143_1*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_2E3F0B7D2C2B7128_TypeDefinitionIndex)->GetStaticField(0x43720);
	}
	...
	{
		return ((::Enum_3_F80BFD5B986D5503_4(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_2E3F0B7D2C2B7128_METHOD_1_A96DCA30C6927810_OFFSET))(this);
	}

	::System::Void Method_1_3DACC45AC8150727(::Enum_3_F80BFD5B986D5503_4 a1)
	{
		return ((::System::Void(*)(::PVOID, ::Enum_3_F80BFD5B986D5503_4))((::PBYTE)hIl2Cpp + CLASS_1_2E3F0B7D2C2B7128_METHOD_1_3DACC45AC8150727_OFFSET))(this, a1);
	}
