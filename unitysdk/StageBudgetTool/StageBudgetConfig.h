...
#define STAGEBUDGETTOOL_STAGEBUDGETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA69F1E0)

namespace StageBudgetTool
{
	inline static constexpr unsigned int StageBudgetConfig_TypeDefinitionIndex = 37641;
