...
#define STAGEBUDGETTOOL_ROOM_METHOD_1_66FF6A49D33160A6_OFFSET UNITYSDK_OFFSET(0xA69EF40)
#define STAGEBUDGETTOOL_ROOM__CTOR_OFFSET UNITYSDK_OFFSET(0xA69F1C0)

namespace StageBudgetTool
{
	inline static constexpr unsigned int Room_TypeDefinitionIndex = 37638;
