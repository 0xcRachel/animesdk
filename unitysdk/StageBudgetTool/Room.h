...
#define STAGEBUDGETTOOL_ROOM_METHOD_1_66FF6A49D33160A6_OFFSET UNITYSDK_OFFSET(0xABE6AE0)
#define STAGEBUDGETTOOL_ROOM__CTOR_OFFSET UNITYSDK_OFFSET(0xABE6D60)
