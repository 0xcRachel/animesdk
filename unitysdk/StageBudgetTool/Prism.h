...
#define STAGEBUDGETTOOL_PRISM_METHOD_1_5E3A735B29A1B5B0_OFFSET UNITYSDK_OFFSET(0xA69EC20)
#define STAGEBUDGETTOOL_PRISM_METHOD_1_E6E9E20688D7143D_OFFSET UNITYSDK_OFFSET(0xA69EAB0)
#define STAGEBUDGETTOOL_PRISM_METHOD_1_FF2FC2568C8F242F_OFFSET UNITYSDK_OFFSET(0xA69EAE0)
#define STAGEBUDGETTOOL_PRISM__CTOR_OFFSET UNITYSDK_OFFSET(0xA69EF30)

namespace StageBudgetTool
{
	inline static constexpr unsigned int Prism_TypeDefinitionIndex = 37633;
