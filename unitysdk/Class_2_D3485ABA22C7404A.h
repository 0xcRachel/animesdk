...
#define CLASS_2_D3485ABA22C7404A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x110B9950)
#define CLASS_2_D3485ABA22C7404A_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x110B9990)
#define CLASS_2_D3485ABA22C7404A_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x110B9CC0)
#define CLASS_2_D3485ABA22C7404A_TICK_OFFSET UNITYSDK_OFFSET(0x110B9D10)
#define CLASS_2_D3485ABA22C7404A__CTOR_OFFSET UNITYSDK_OFFSET(0x110B9940)

inline static constexpr unsigned int Class_2_D3485ABA22C7404A_TypeDefinitionIndex = 41637;
