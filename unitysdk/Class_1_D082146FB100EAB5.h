...
#define CLASS_1_D082146FB100EAB5_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1158F260)
#define CLASS_1_D082146FB100EAB5_METHOD_1_01726C54B7142C95_1_OFFSET UNITYSDK_OFFSET(0x1158E8F0)
#define CLASS_1_D082146FB100EAB5_METHOD_1_01726C54B7142C95_OFFSET UNITYSDK_OFFSET(0x1158E830)
#define CLASS_1_D082146FB100EAB5_METHOD_1_0563A943CEE0E418_OFFSET UNITYSDK_OFFSET(0x1158E9B0)
#define CLASS_1_D082146FB100EAB5_METHOD_1_1D00B9E1ACC7B624_OFFSET UNITYSDK_OFFSET(0x11590AD0)
#define CLASS_1_D082146FB100EAB5_METHOD_1_216CF377002E5879_OFFSET UNITYSDK_OFFSET(0x1158EC80)
#define CLASS_1_D082146FB100EAB5_METHOD_1_42F8058155D4014E_OFFSET UNITYSDK_OFFSET(0x115909D0)
#define CLASS_1_D082146FB100EAB5_METHOD_1_57F50D8CDD0407CC_OFFSET UNITYSDK_OFFSET(0x1158F5D0)
#define CLASS_1_D082146FB100EAB5_METHOD_1_6E57D3559C10FFA9_OFFSET UNITYSDK_OFFSET(0x11590980)
#define CLASS_1_D082146FB100EAB5_METHOD_1_969A0AACBC751E99_1_OFFSET UNITYSDK_OFFSET(0x11590B50)
#define CLASS_1_D082146FB100EAB5_METHOD_1_969A0AACBC751E99_OFFSET UNITYSDK_OFFSET(0x11590A60)
#define CLASS_1_D082146FB100EAB5_METHOD_1_AC7CD4175E0A3EF8_OFFSET UNITYSDK_OFFSET(0x1158F000)
#define CLASS_1_D082146FB100EAB5_METHOD_1_B4224E05991AB5BC_OFFSET UNITYSDK_OFFSET(0x1158E680)
#define CLASS_1_D082146FB100EAB5_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1158EFA0)
#define CLASS_1_D082146FB100EAB5_METHOD_1_DF3C54A5ADEABAF1_OFFSET UNITYSDK_OFFSET(0x115905A0)
#define CLASS_1_D082146FB100EAB5_METHOD_1_E9DB72A36580DE31_OFFSET UNITYSDK_OFFSET(0x1158EA90)
#define CLASS_1_D082146FB100EAB5_METHOD_1_F63FE1AA9633F811_OFFSET UNITYSDK_OFFSET(0x1158F800)
#define CLASS_1_D082146FB100EAB5__CTOR_OFFSET UNITYSDK_OFFSET(0x1158ED80)
...
{
public:
	::RPG::Client::LoadingTipsRandomPool_1<::RPG::GameCore::LoadingDescGroup>* Field_1_8; // 0x10
	::RPG::Client::LoadingTipsRandomPool_1<::RPG::GameCore::LoadingDescGroup>* Field_1_9; // 0x18
	::System::Collections::Generic::List_1<::RPG::GameCore::LoadingDescRow*>* Field_1_12; // 0x20
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::LoadingDescGroup, ::RPG::Client::LoadingTipsRandomPool_1<::RPG::GameCore::LoadingDescRow*>*>* Field_1_11; // 0x28
	::RPG::GameCore::LoadingFuncConfigRow* Field_1_1; // 0x30
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::LoadingDescGroup, ::RPG::Client::LoadingTipsRandomPool_1<::RPG::GameCore::LoadingDescRow*>*>* Field_1_10; // 0x38
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::LoadingDescGroup, ::System::Collections::Generic::List_1<::RPG::GameCore::LoadingDescRow*>*>* Field_1_0; // 0x40
	...
	::RPG::GameCore::GameModeType Field_1_4; // 0x60
