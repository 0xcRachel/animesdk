...
#define CLASS_2_CD5BE680213AC89D_METHOD_2_0E142E3463F30350_OFFSET UNITYSDK_OFFSET(0x114B5610)
#define CLASS_2_CD5BE680213AC89D_METHOD_2_1C445AC4C0C0F33D_OFFSET UNITYSDK_OFFSET(0x114B5950)
#define CLASS_2_CD5BE680213AC89D_METHOD_2_20D5AB6FDFA560A6_OFFSET UNITYSDK_OFFSET(0x114B6590)
#define CLASS_2_CD5BE680213AC89D_METHOD_2_323F95926A2F616E_OFFSET UNITYSDK_OFFSET(0x114B5550)
#define CLASS_2_CD5BE680213AC89D_METHOD_2_3EE230755518F80C_OFFSET UNITYSDK_OFFSET(0x114B5750)
#define CLASS_2_CD5BE680213AC89D_METHOD_2_9E5E9518D01FCB25_OFFSET UNITYSDK_OFFSET(0x114B6050)
#define CLASS_2_CD5BE680213AC89D_METHOD_2_A2AF0CC0E6C54833_OFFSET UNITYSDK_OFFSET(0x114B59F0)
#define CLASS_2_CD5BE680213AC89D_METHOD_2_B555E07014FDD9D7_OFFSET UNITYSDK_OFFSET(0x114B5EA0)
#define CLASS_2_CD5BE680213AC89D_METHOD_2_BF622B900A7F3625_OFFSET UNITYSDK_OFFSET(0x114B4810)
#define CLASS_2_CD5BE680213AC89D_METHOD_2_D4A8C612F49B404B_OFFSET UNITYSDK_OFFSET(0x114B5AA0)
#define CLASS_2_CD5BE680213AC89D_METHOD_2_EE5A48E669E88C75_OFFSET UNITYSDK_OFFSET(0x114B6410)
#define CLASS_2_CD5BE680213AC89D__CTOR_OFFSET UNITYSDK_OFFSET(0x114B3F70)
#define CLASS_2_CD5BE680213AC89D__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x114B48C0)
#define CLASS_2_CD5BE680213AC89D__ONEXITFINALSTEP_OFFSET UNITYSDK_OFFSET(0x114B5C30)
#define CLASS_2_CD5BE680213AC89D__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x114B4080)
#define CLASS_2_CD5BE680213AC89D__ONTICK_OFFSET UNITYSDK_OFFSET(0x114B55C0)
#define CLASS_2_CD5BE680213AC89D___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x114B6910)
#define CLASS_2_CD5BE680213AC89D___IFIXBASEPROXY__ONEXITFINALSTEP_OFFSET UNITYSDK_OFFSET(0x114B69D0)
#define CLASS_2_CD5BE680213AC89D___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x114B68B0)
#define CLASS_2_CD5BE680213AC89D___IFIXBASEPROXY__ONTICK_OFFSET UNITYSDK_OFFSET(0x114B6970)
#define CLASS_2_CD5BE680213AC89D___SUBSCRIBEMESSAGE_B__9_0_OFFSET UNITYSDK_OFFSET(0x114B6770)

inline static constexpr unsigned int Class_2_CD5BE680213AC89D_TypeDefinitionIndex = 60992;

class Class_2_CD5BE680213AC89D : public ::Sofa::BaseSofaWindow
{
public:
	::UnityEngine::UI::ScrollRect* Field_2_10; // 0x40
	::SuperScrollView::LoopListView2* Field_2_6; // 0x48
	::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Single>* Field_2_1; // 0x50
