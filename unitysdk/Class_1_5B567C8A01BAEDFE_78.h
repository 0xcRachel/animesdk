...
#define CLASS_1_5B567C8A01BAEDFE_78_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A7A7990)
#define CLASS_1_5B567C8A01BAEDFE_78_CLONE_OFFSET UNITYSDK_OFFSET(0x1A7A77A0)
#define CLASS_1_5B567C8A01BAEDFE_78_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A7A78A0)
#define CLASS_1_5B567C8A01BAEDFE_78_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A7A7810)
#define CLASS_1_5B567C8A01BAEDFE_78_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A7A78F0)
#define CLASS_1_5B567C8A01BAEDFE_78_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A7A79E0)
#define CLASS_1_5B567C8A01BAEDFE_78_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A7A79B0)
#define CLASS_1_5B567C8A01BAEDFE_78_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A7A76F0)
#define CLASS_1_5B567C8A01BAEDFE_78_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A7A7750)
#define CLASS_1_5B567C8A01BAEDFE_78_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A7A7920)
#define CLASS_1_5B567C8A01BAEDFE_78_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A7A7980)
#define CLASS_1_5B567C8A01BAEDFE_78__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A7A7A30)
#define CLASS_1_5B567C8A01BAEDFE_78__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A7A7770)
#define CLASS_1_5B567C8A01BAEDFE_78__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7A7760)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_78*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_78_TypeDefinitionIndex)->GetStaticField(0x5FE80);
	}
