...
#define CLASS_1_5B567C8A01BAEDFE_78_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x193D9D00)
#define CLASS_1_5B567C8A01BAEDFE_78_CLONE_OFFSET UNITYSDK_OFFSET(0x193D9B10)
#define CLASS_1_5B567C8A01BAEDFE_78_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x193D9C10)
#define CLASS_1_5B567C8A01BAEDFE_78_EQUALS_OFFSET UNITYSDK_OFFSET(0x193D9B80)
#define CLASS_1_5B567C8A01BAEDFE_78_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x193D9C60)
#define CLASS_1_5B567C8A01BAEDFE_78_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x193D9D50)
#define CLASS_1_5B567C8A01BAEDFE_78_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x193D9D20)
#define CLASS_1_5B567C8A01BAEDFE_78_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x193D9A60)
#define CLASS_1_5B567C8A01BAEDFE_78_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x193D9AC0)
#define CLASS_1_5B567C8A01BAEDFE_78_TOSTRING_OFFSET UNITYSDK_OFFSET(0x193D9C90)
#define CLASS_1_5B567C8A01BAEDFE_78_WRITETO_OFFSET UNITYSDK_OFFSET(0x193D9CF0)
#define CLASS_1_5B567C8A01BAEDFE_78__CCTOR_OFFSET UNITYSDK_OFFSET(0x193D9DA0)
#define CLASS_1_5B567C8A01BAEDFE_78__CTOR_1_OFFSET UNITYSDK_OFFSET(0x193D9AE0)
#define CLASS_1_5B567C8A01BAEDFE_78__CTOR_OFFSET UNITYSDK_OFFSET(0x193D9AD0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_78*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_78_TypeDefinitionIndex)->GetStaticField(0x1E5C0);
	}
