...
#define CLASS_2_78A99DA90E2A2419_DISPOSE_OFFSET UNITYSDK_OFFSET(0x104B3A60)
#define CLASS_2_78A99DA90E2A2419_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x104B38E0)
#define CLASS_2_78A99DA90E2A2419_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x104B3A10)
#define CLASS_2_78A99DA90E2A2419_TICK_OFFSET UNITYSDK_OFFSET(0x104B3AC0)
#define CLASS_2_78A99DA90E2A2419__CTOR_OFFSET UNITYSDK_OFFSET(0x104B38D0)

inline static constexpr unsigned int Class_2_78A99DA90E2A2419_TypeDefinitionIndex = 45611;

class Class_2_78A99DA90E2A2419 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::AdvSpawnMoney* Field_2_1; // 0x18
