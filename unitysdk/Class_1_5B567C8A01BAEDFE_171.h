...
#define CLASS_1_5B567C8A01BAEDFE_171_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19C365B0)
#define CLASS_1_5B567C8A01BAEDFE_171_CLONE_OFFSET UNITYSDK_OFFSET(0x19C363C0)
#define CLASS_1_5B567C8A01BAEDFE_171_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19C364C0)
#define CLASS_1_5B567C8A01BAEDFE_171_EQUALS_OFFSET UNITYSDK_OFFSET(0x19C36430)
#define CLASS_1_5B567C8A01BAEDFE_171_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19C36510)
#define CLASS_1_5B567C8A01BAEDFE_171_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A211090)
#define CLASS_1_5B567C8A01BAEDFE_171_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A211060)
#define CLASS_1_5B567C8A01BAEDFE_171_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19C36310)
#define CLASS_1_5B567C8A01BAEDFE_171_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19C36370)
#define CLASS_1_5B567C8A01BAEDFE_171_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19C36540)
#define CLASS_1_5B567C8A01BAEDFE_171_WRITETO_OFFSET UNITYSDK_OFFSET(0x19C365A0)
#define CLASS_1_5B567C8A01BAEDFE_171__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A2110E0)
#define CLASS_1_5B567C8A01BAEDFE_171__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19C36390)
#define CLASS_1_5B567C8A01BAEDFE_171__CTOR_OFFSET UNITYSDK_OFFSET(0x19C36380)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_171*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_171_TypeDefinitionIndex)->GetStaticField(0x5B100);
	}
