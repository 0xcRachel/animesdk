...
#define CLASS_3_5C01DB3813C27EF2_DISPOSE_OFFSET UNITYSDK_OFFSET(0x148E1740)
#define CLASS_3_5C01DB3813C27EF2__CTOR_OFFSET UNITYSDK_OFFSET(0x148E14A0)
#define CLASS_3_5C01DB3813C27EF2__PREPAREDATA_OFFSET UNITYSDK_OFFSET(0x148E1790)
#define CLASS_3_5C01DB3813C27EF2__REGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x148E1810)
#define CLASS_3_5C01DB3813C27EF2__UNREGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x148E19A0)
#define CLASS_3_5C01DB3813C27EF2___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x148E1B10)
#define CLASS_3_5C01DB3813C27EF2___IFIXBASEPROXY__PREPAREDATA_OFFSET UNITYSDK_OFFSET(0x148E1B60)
#define CLASS_3_5C01DB3813C27EF2___IFIXBASEPROXY__REGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x148E1BE0)
#define CLASS_3_5C01DB3813C27EF2___IFIXBASEPROXY__UNREGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x148E1BF0)
