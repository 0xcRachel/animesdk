...
#define CLASS_1_5B567C8A01BAEDFE_120_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1B0E09D0)
#define CLASS_1_5B567C8A01BAEDFE_120_CLONE_OFFSET UNITYSDK_OFFSET(0x1B0E07E0)
#define CLASS_1_5B567C8A01BAEDFE_120_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1B0E08E0)
#define CLASS_1_5B567C8A01BAEDFE_120_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B0E0850)
#define CLASS_1_5B567C8A01BAEDFE_120_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B0E0930)
#define CLASS_1_5B567C8A01BAEDFE_120_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1B0E0A20)
#define CLASS_1_5B567C8A01BAEDFE_120_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1B0E09F0)
#define CLASS_1_5B567C8A01BAEDFE_120_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1B0E0730)
#define CLASS_1_5B567C8A01BAEDFE_120_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1B0E0790)
#define CLASS_1_5B567C8A01BAEDFE_120_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B0E0960)
#define CLASS_1_5B567C8A01BAEDFE_120_WRITETO_OFFSET UNITYSDK_OFFSET(0x1B0E09C0)
#define CLASS_1_5B567C8A01BAEDFE_120__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B0E0A70)
#define CLASS_1_5B567C8A01BAEDFE_120__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B0E07B0)
#define CLASS_1_5B567C8A01BAEDFE_120__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0E07A0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_120*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_120_TypeDefinitionIndex)->GetStaticField(0x52C60);
	}
