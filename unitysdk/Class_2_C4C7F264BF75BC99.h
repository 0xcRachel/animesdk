...
#define CLASS_2_C4C7F264BF75BC99_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10A2C070)
#define CLASS_2_C4C7F264BF75BC99_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10A2C0B0)
#define CLASS_2_C4C7F264BF75BC99_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10A2C8A0)
#define CLASS_2_C4C7F264BF75BC99_TICK_OFFSET UNITYSDK_OFFSET(0x10A2C2C0)
#define CLASS_2_C4C7F264BF75BC99__CTOR_OFFSET UNITYSDK_OFFSET(0x10A2C020)

inline static constexpr unsigned int Class_2_C4C7F264BF75BC99_TypeDefinitionIndex = 41312;

class Class_2_C4C7F264BF75BC99 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::AdvCharacterSteerToInputDir* Field_2_1; // 0x18
