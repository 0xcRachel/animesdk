...
#define CLASS_3_A3B6E3101528C82F_METHOD_3_D0B0E8495E8A13B8_OFFSET UNITYSDK_OFFSET(0xFE40C20)
#define CLASS_3_A3B6E3101528C82F_METHOD_3_EBEE0D0A222A8264_OFFSET UNITYSDK_OFFSET(0xFE410B0)
#define CLASS_3_A3B6E3101528C82F_ONCLEAR_OFFSET UNITYSDK_OFFSET(0xFE40CB0)
#define CLASS_3_A3B6E3101528C82F_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0xFE40D40)
#define CLASS_3_A3B6E3101528C82F__CTOR_OFFSET UNITYSDK_OFFSET(0xFE41100)
#define CLASS_3_A3B6E3101528C82F___IFIXBASEPROXY_ONCLEAR_OFFSET UNITYSDK_OFFSET(0xFE41110)
#define CLASS_3_A3B6E3101528C82F___IFIXBASEPROXY_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0xFE41170)

inline static constexpr unsigned int Class_3_A3B6E3101528C82F_TypeDefinitionIndex = 52343;
...
public:
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_3_A3B6E3101528C82F_METHOD_3_EBEE0D0A222A8264_OFFSET))(this);
	}
