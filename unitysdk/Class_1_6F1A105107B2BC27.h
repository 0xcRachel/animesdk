...
#define CLASS_1_6F1A105107B2BC27_GET_FIGUREICONPATH_OFFSET UNITYSDK_OFFSET(0xD7C21E0)
#define CLASS_1_6F1A105107B2BC27_GET_GENDER_OFFSET UNITYSDK_OFFSET(0xD7C2100)
#define CLASS_1_6F1A105107B2BC27_GET_HASITEMDISPLAY_OFFSET UNITYSDK_OFFSET(0xD7C2120)
#define CLASS_1_6F1A105107B2BC27_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xD7C21C0)
#define CLASS_1_6F1A105107B2BC27_GET_ITEMBGDESC_OFFSET UNITYSDK_OFFSET(0xD7C21A0)
#define CLASS_1_6F1A105107B2BC27_GET_ITEMCURRENCYICONPATH_OFFSET UNITYSDK_OFFSET(0xD7C2200)
#define CLASS_1_6F1A105107B2BC27_GET_ITEMDESC_OFFSET UNITYSDK_OFFSET(0xD7C2180)
#define CLASS_1_6F1A105107B2BC27_GET_ITEMNAME_OFFSET UNITYSDK_OFFSET(0xD7C2160)
#define CLASS_1_6F1A105107B2BC27_GET_JSONPATH_OFFSET UNITYSDK_OFFSET(0xD7C2220)
#define CLASS_1_6F1A105107B2BC27_GET_RARITY_OFFSET UNITYSDK_OFFSET(0xD7C2140)
#define CLASS_1_6F1A105107B2BC27_SET_FIGUREICONPATH_OFFSET UNITYSDK_OFFSET(0xD7C21F0)
#define CLASS_1_6F1A105107B2BC27_SET_GENDER_OFFSET UNITYSDK_OFFSET(0xD7C2110)
#define CLASS_1_6F1A105107B2BC27_SET_HASITEMDISPLAY_OFFSET UNITYSDK_OFFSET(0xD7C2130)
#define CLASS_1_6F1A105107B2BC27_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xD7C21D0)
#define CLASS_1_6F1A105107B2BC27_SET_ITEMBGDESC_OFFSET UNITYSDK_OFFSET(0xD7C21B0)
#define CLASS_1_6F1A105107B2BC27_SET_ITEMCURRENCYICONPATH_OFFSET UNITYSDK_OFFSET(0xD7C2210)
#define CLASS_1_6F1A105107B2BC27_SET_ITEMDESC_OFFSET UNITYSDK_OFFSET(0xD7C2190)
#define CLASS_1_6F1A105107B2BC27_SET_ITEMNAME_OFFSET UNITYSDK_OFFSET(0xD7C2170)
#define CLASS_1_6F1A105107B2BC27_SET_JSONPATH_OFFSET UNITYSDK_OFFSET(0xD7C2230)
#define CLASS_1_6F1A105107B2BC27_SET_RARITY_OFFSET UNITYSDK_OFFSET(0xD7C2150)
#define CLASS_1_6F1A105107B2BC27__CTOR_OFFSET UNITYSDK_OFFSET(0xD7C2240)
...
public:
	...
	::RPG::Client::TextID _ItemBGDesc_k__BackingField; // 0x40
	::RPG::GameCore::ItemRarity _Rarity_k__BackingField; // 0x50
	::System::Boolean _HasItemDisplay_k__BackingField; // 0x54
