...
#define CLASS_1_6F1A105107B2BC27_GET_FIGUREICONPATH_OFFSET UNITYSDK_OFFSET(0xEB43A30)
#define CLASS_1_6F1A105107B2BC27_GET_GENDER_OFFSET UNITYSDK_OFFSET(0xEB43950)
#define CLASS_1_6F1A105107B2BC27_GET_HASITEMDISPLAY_OFFSET UNITYSDK_OFFSET(0xEB43970)
#define CLASS_1_6F1A105107B2BC27_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xEB43A10)
#define CLASS_1_6F1A105107B2BC27_GET_ITEMBGDESC_OFFSET UNITYSDK_OFFSET(0xEB439F0)
#define CLASS_1_6F1A105107B2BC27_GET_ITEMCURRENCYICONPATH_OFFSET UNITYSDK_OFFSET(0xEB43A50)
#define CLASS_1_6F1A105107B2BC27_GET_ITEMDESC_OFFSET UNITYSDK_OFFSET(0xEB439D0)
#define CLASS_1_6F1A105107B2BC27_GET_ITEMNAME_OFFSET UNITYSDK_OFFSET(0xEB439B0)
#define CLASS_1_6F1A105107B2BC27_GET_JSONPATH_OFFSET UNITYSDK_OFFSET(0xEB43A70)
#define CLASS_1_6F1A105107B2BC27_GET_RARITY_OFFSET UNITYSDK_OFFSET(0xEB43990)
#define CLASS_1_6F1A105107B2BC27_SET_FIGUREICONPATH_OFFSET UNITYSDK_OFFSET(0xEB43A40)
#define CLASS_1_6F1A105107B2BC27_SET_GENDER_OFFSET UNITYSDK_OFFSET(0xEB43960)
#define CLASS_1_6F1A105107B2BC27_SET_HASITEMDISPLAY_OFFSET UNITYSDK_OFFSET(0xEB43980)
#define CLASS_1_6F1A105107B2BC27_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xEB43A20)
#define CLASS_1_6F1A105107B2BC27_SET_ITEMBGDESC_OFFSET UNITYSDK_OFFSET(0xEB43A00)
#define CLASS_1_6F1A105107B2BC27_SET_ITEMCURRENCYICONPATH_OFFSET UNITYSDK_OFFSET(0xEB43A60)
#define CLASS_1_6F1A105107B2BC27_SET_ITEMDESC_OFFSET UNITYSDK_OFFSET(0xEB439E0)
#define CLASS_1_6F1A105107B2BC27_SET_ITEMNAME_OFFSET UNITYSDK_OFFSET(0xEB439C0)
#define CLASS_1_6F1A105107B2BC27_SET_JSONPATH_OFFSET UNITYSDK_OFFSET(0xEB43A80)
#define CLASS_1_6F1A105107B2BC27_SET_RARITY_OFFSET UNITYSDK_OFFSET(0xEB439A0)
#define CLASS_1_6F1A105107B2BC27__CTOR_OFFSET UNITYSDK_OFFSET(0xEB43A90)
...
public:
	...
	::System::String* _ItemCurrencyIconPath_k__BackingField; // 0x18
	...
	::RPG::Client::TextID _ItemDesc_k__BackingField; // 0x40
	::System::Boolean _HasItemDisplay_k__BackingField; // 0x50
	::RPG::GameCore::TargetGenderType _Gender_k__BackingField; // 0x54
	::RPG::GameCore::ItemRarity _Rarity_k__BackingField; // 0x58
	::RPG::Client::TextID _ItemName_k__BackingField; // 0x60
