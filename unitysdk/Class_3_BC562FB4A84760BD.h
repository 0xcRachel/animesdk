...
#define CLASS_3_BC562FB4A84760BD_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1473C7A0)
#define CLASS_3_BC562FB4A84760BD_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1473C7E0)
#define CLASS_3_BC562FB4A84760BD__CTOR_OFFSET UNITYSDK_OFFSET(0x1473C770)
#define CLASS_3_BC562FB4A84760BD___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1473C920)
