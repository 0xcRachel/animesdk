...
#define CLASS_1_3C8633E8E5B2C464_METHOD_1_08649C2797B37F9D_OFFSET UNITYSDK_OFFSET(0x18571C80)
#define CLASS_1_3C8633E8E5B2C464_METHOD_1_2354B2A6C34F7200_OFFSET UNITYSDK_OFFSET(0x18571370)
#define CLASS_1_3C8633E8E5B2C464_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x18571AA0)
#define CLASS_1_3C8633E8E5B2C464_METHOD_1_3FC219F9B98DD2A4_OFFSET UNITYSDK_OFFSET(0x18571CD0)
#define CLASS_1_3C8633E8E5B2C464_METHOD_1_43195D5898A20AE8_OFFSET UNITYSDK_OFFSET(0x18571850)
#define CLASS_1_3C8633E8E5B2C464_METHOD_1_4A49C238E4E4CE31_OFFSET UNITYSDK_OFFSET(0x185716A0)
#define CLASS_1_3C8633E8E5B2C464_METHOD_1_6B72D4EE8C6E907F_OFFSET UNITYSDK_OFFSET(0x185713F0)
#define CLASS_1_3C8633E8E5B2C464_METHOD_1_AD31DD9682084C83_OFFSET UNITYSDK_OFFSET(0x18571B40)
#define CLASS_1_3C8633E8E5B2C464_METHOD_1_CE34EA208837238D_OFFSET UNITYSDK_OFFSET(0x18571640)
#define CLASS_1_3C8633E8E5B2C464_METHOD_1_F0E307B84478A272_OFFSET UNITYSDK_OFFSET(0x18571A60)
#define CLASS_1_3C8633E8E5B2C464_METHOD_1_F2E1599CBB58B20F_OFFSET UNITYSDK_OFFSET(0x18571BE0)
#define CLASS_1_3C8633E8E5B2C464__CCTOR_OFFSET UNITYSDK_OFFSET(0x18572080)
...
public:
	...
	{
		return (::System::Action_1<::Class_1_7A22A3DBEEDD1F80*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_3C8633E8E5B2C464_TypeDefinitionIndex)->GetStaticField(0x33B90);
	}
	static ::Il2CppArray<::System::String*>** StaticGet_Field_1_4()
	{
		return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_3C8633E8E5B2C464_TypeDefinitionIndex)->GetStaticField(0x33B98);
	}
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::RPG::GameCore::CommonIndexKey, ::RPG::GameCore::ILCombatAdvantageGroupConfigRow*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_3C8633E8E5B2C464_TypeDefinitionIndex)->GetStaticField(0x33BA0);
	}
	static ::System::Byte* StaticGet_Field_1_2()
	{
		return (::System::Byte*)Il2CppClass::FromTypeDefinitionIndex(Class_1_3C8633E8E5B2C464_TypeDefinitionIndex)->GetStaticField(0x9C20);
	}
	static ::System::Boolean* StaticGet_Field_1_1()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_1_3C8633E8E5B2C464_TypeDefinitionIndex)->GetStaticField(0x9C21);
	}
