...
#define CLASS_2_631094C36C844CC2_DISPOSE_OFFSET UNITYSDK_OFFSET(0x889ECC0)
#define CLASS_2_631094C36C844CC2_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x889EF50)
#define CLASS_2_631094C36C844CC2_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x889ED60)
#define CLASS_2_631094C36C844CC2_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x889EF00)
#define CLASS_2_631094C36C844CC2_TICK_OFFSET UNITYSDK_OFFSET(0x889ED00)
#define CLASS_2_631094C36C844CC2__CTOR_OFFSET UNITYSDK_OFFSET(0x889ECB0)
