...
#define CLASS_1_526C2C5F58C0A6C2_DISPOSE_OFFSET UNITYSDK_OFFSET(0x103CD7B0)
#define CLASS_1_526C2C5F58C0A6C2_GET_CURRENTMOVESTATE_OFFSET UNITYSDK_OFFSET(0x103CD790)
#define CLASS_1_526C2C5F58C0A6C2_METHOD_1_03E2B9212B4B6EAF_OFFSET UNITYSDK_OFFSET(0x103CE230)
#define CLASS_1_526C2C5F58C0A6C2_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x103CE410)
#define CLASS_1_526C2C5F58C0A6C2_METHOD_1_451E963CAA3A78BF_1_OFFSET UNITYSDK_OFFSET(0x103CE310)
#define CLASS_1_526C2C5F58C0A6C2_METHOD_1_451E963CAA3A78BF_OFFSET UNITYSDK_OFFSET(0x103CDD70)
#define CLASS_1_526C2C5F58C0A6C2_METHOD_1_85377D41FEE05B66_OFFSET UNITYSDK_OFFSET(0x103CE470)
#define CLASS_1_526C2C5F58C0A6C2_METHOD_1_86395FEE565F7ED9_OFFSET UNITYSDK_OFFSET(0x103CD8F0)
#define CLASS_1_526C2C5F58C0A6C2_METHOD_1_9681042564541CD6_1_OFFSET UNITYSDK_OFFSET(0x103CE710)
#define CLASS_1_526C2C5F58C0A6C2_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x103CD860)
#define CLASS_1_526C2C5F58C0A6C2_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x103CE2B0)
#define CLASS_1_526C2C5F58C0A6C2_METHOD_1_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x103CE3D0)
#define CLASS_1_526C2C5F58C0A6C2_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x103CE270)
#define CLASS_1_526C2C5F58C0A6C2_METHOD_1_DDA8A2337932DF10_OFFSET UNITYSDK_OFFSET(0x103CDC30)
#define CLASS_1_526C2C5F58C0A6C2_METHOD_1_DE4BD3007909A465_OFFSET UNITYSDK_OFFSET(0x103CDB80)
#define CLASS_1_526C2C5F58C0A6C2_SET_CURRENTMOVESTATE_OFFSET UNITYSDK_OFFSET(0x103CD7A0)
#define CLASS_1_526C2C5F58C0A6C2__CTOR_OFFSET UNITYSDK_OFFSET(0x103CE790)

inline static constexpr unsigned int Class_1_526C2C5F58C0A6C2_TypeDefinitionIndex = 42350;

class Class_1_526C2C5F58C0A6C2 : public ::System::Object
{
public:
	::UnityEngine::Animator* Field_1_3; // 0x10
	::Il2CppArray<::RPGTools::Timeline::CharacterStoryMove::StoryMoveSequenceClip*>* Field_1_1; // 0x18
