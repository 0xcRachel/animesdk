...
#define CLASS_2_B99A4A3093028660_DISPOSE_OFFSET UNITYSDK_OFFSET(0x897BFC0)
#define CLASS_2_B99A4A3093028660_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x897C000)
#define CLASS_2_B99A4A3093028660_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x897C2C0)
#define CLASS_2_B99A4A3093028660_TICK_OFFSET UNITYSDK_OFFSET(0x897C310)
#define CLASS_2_B99A4A3093028660__CTOR_OFFSET UNITYSDK_OFFSET(0x897BFB0)
