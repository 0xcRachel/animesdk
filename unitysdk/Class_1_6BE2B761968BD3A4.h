...
#define CLASS_1_6BE2B761968BD3A4_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17DDBB70)
#define CLASS_1_6BE2B761968BD3A4_CLONE_OFFSET UNITYSDK_OFFSET(0x17DDB650)
#define CLASS_1_6BE2B761968BD3A4_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17DDB820)
#define CLASS_1_6BE2B761968BD3A4_EQUALS_OFFSET UNITYSDK_OFFSET(0x17DDB6D0)
#define CLASS_1_6BE2B761968BD3A4_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17DDB910)
#define CLASS_1_6BE2B761968BD3A4_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x17DDBD60)
#define CLASS_1_6BE2B761968BD3A4_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x17DDBC50)
#define CLASS_1_6BE2B761968BD3A4_METHOD_1_4C96E9A31DDA1BDD_OFFSET UNITYSDK_OFFSET(0x17DDB6A0)
#define CLASS_1_6BE2B761968BD3A4_METHOD_1_AF79E24951DBBA50_OFFSET UNITYSDK_OFFSET(0x17DDB6C0)
#define CLASS_1_6BE2B761968BD3A4_METHOD_1_E8F5A96D93A6544B_OFFSET UNITYSDK_OFFSET(0x17DDB6B0)
#define CLASS_1_6BE2B761968BD3A4_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17DDB530)
#define CLASS_1_6BE2B761968BD3A4_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17DDBA30)
#define CLASS_1_6BE2B761968BD3A4_WRITETO_OFFSET UNITYSDK_OFFSET(0x17DDBA90)
#define CLASS_1_6BE2B761968BD3A4__CCTOR_OFFSET UNITYSDK_OFFSET(0x17DDBE50)
#define CLASS_1_6BE2B761968BD3A4__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17DDB580)
#define CLASS_1_6BE2B761968BD3A4__CTOR_OFFSET UNITYSDK_OFFSET(0x17DDB540)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Proto::PileItem*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6BE2B761968BD3A4_TypeDefinitionIndex)->GetStaticField(0x15240);
	}
