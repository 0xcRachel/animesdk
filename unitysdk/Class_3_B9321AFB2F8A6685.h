...
#define CLASS_3_B9321AFB2F8A6685_DISPOSE_OFFSET UNITYSDK_OFFSET(0x855DE60)
#define CLASS_3_B9321AFB2F8A6685_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x855DB40)
#define CLASS_3_B9321AFB2F8A6685_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x855DD60)
#define CLASS_3_B9321AFB2F8A6685__CTOR_OFFSET UNITYSDK_OFFSET(0x855DB10)
#define CLASS_3_B9321AFB2F8A6685___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x855DFD0)
#define CLASS_3_B9321AFB2F8A6685___IFIXBASEPROXY_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x855DFC0)

inline static constexpr unsigned int Class_3_B9321AFB2F8A6685_TypeDefinitionIndex = 41625;

class Class_3_B9321AFB2F8A6685 : public ::RPG::GameCore::ImmediateTaskBase_1<::RPG::GameCore::CreateFMChannelSource*>
{
public:
	::Class_0_16E4307DCC419505_350* Field_3_0; // 0x28
