...
#define CLASS_1_5B567C8A01BAEDFE_28_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1B1A5610)
#define CLASS_1_5B567C8A01BAEDFE_28_CLONE_OFFSET UNITYSDK_OFFSET(0x1B1A5420)
#define CLASS_1_5B567C8A01BAEDFE_28_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1B1A5520)
#define CLASS_1_5B567C8A01BAEDFE_28_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B1A5490)
#define CLASS_1_5B567C8A01BAEDFE_28_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B1A5570)
#define CLASS_1_5B567C8A01BAEDFE_28_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1B1A5660)
#define CLASS_1_5B567C8A01BAEDFE_28_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1B1A5630)
#define CLASS_1_5B567C8A01BAEDFE_28_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1B1A5370)
#define CLASS_1_5B567C8A01BAEDFE_28_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1B1A53D0)
#define CLASS_1_5B567C8A01BAEDFE_28_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B1A55A0)
#define CLASS_1_5B567C8A01BAEDFE_28_WRITETO_OFFSET UNITYSDK_OFFSET(0x1B1A5600)
#define CLASS_1_5B567C8A01BAEDFE_28__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B1A56B0)
#define CLASS_1_5B567C8A01BAEDFE_28__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B1A53F0)
#define CLASS_1_5B567C8A01BAEDFE_28__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1A53E0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_28*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_28_TypeDefinitionIndex)->GetStaticField(0x31060);
	}
