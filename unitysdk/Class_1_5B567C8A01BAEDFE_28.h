...
#define CLASS_1_5B567C8A01BAEDFE_28_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19C15740)
#define CLASS_1_5B567C8A01BAEDFE_28_CLONE_OFFSET UNITYSDK_OFFSET(0x19C15550)
#define CLASS_1_5B567C8A01BAEDFE_28_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19C15650)
#define CLASS_1_5B567C8A01BAEDFE_28_EQUALS_OFFSET UNITYSDK_OFFSET(0x19C155C0)
#define CLASS_1_5B567C8A01BAEDFE_28_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19C156A0)
#define CLASS_1_5B567C8A01BAEDFE_28_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19C15790)
#define CLASS_1_5B567C8A01BAEDFE_28_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19C15760)
#define CLASS_1_5B567C8A01BAEDFE_28_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19C154A0)
#define CLASS_1_5B567C8A01BAEDFE_28_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19C15500)
#define CLASS_1_5B567C8A01BAEDFE_28_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19C156D0)
#define CLASS_1_5B567C8A01BAEDFE_28_WRITETO_OFFSET UNITYSDK_OFFSET(0x19C15730)
#define CLASS_1_5B567C8A01BAEDFE_28__CCTOR_OFFSET UNITYSDK_OFFSET(0x19C157E0)
#define CLASS_1_5B567C8A01BAEDFE_28__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19C15520)
#define CLASS_1_5B567C8A01BAEDFE_28__CTOR_OFFSET UNITYSDK_OFFSET(0x19C15510)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_28*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_28_TypeDefinitionIndex)->GetStaticField(0x3A960);
	}
