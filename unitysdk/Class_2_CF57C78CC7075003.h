...
#define CLASS_2_CF57C78CC7075003_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xFC7C670)
#define CLASS_2_CF57C78CC7075003_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xFC7C7C0)
#define CLASS_2_CF57C78CC7075003_METHOD_2_048FA601E6EC5C91_OFFSET UNITYSDK_OFFSET(0xFC7BFE0)
#define CLASS_2_CF57C78CC7075003_METHOD_2_123DFB09BD2C9B9E_OFFSET UNITYSDK_OFFSET(0xFC7BE30)
#define CLASS_2_CF57C78CC7075003_METHOD_2_229CEF33F0AF9039_OFFSET UNITYSDK_OFFSET(0xFC7BCB0)
#define CLASS_2_CF57C78CC7075003_METHOD_2_39A9FE040505BFA5_OFFSET UNITYSDK_OFFSET(0xFC7BEA0)
#define CLASS_2_CF57C78CC7075003_METHOD_2_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xFC7B3C0)
#define CLASS_2_CF57C78CC7075003_METHOD_2_49864B3B164A1961_OFFSET UNITYSDK_OFFSET(0xFC7B710)
#define CLASS_2_CF57C78CC7075003_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xFC7C970)
#define CLASS_2_CF57C78CC7075003_METHOD_2_77A1C88EE6B459EB_OFFSET UNITYSDK_OFFSET(0xFC7B580)
#define CLASS_2_CF57C78CC7075003_METHOD_2_8CA1933EC1F9B137_OFFSET UNITYSDK_OFFSET(0xFC7B530)
#define CLASS_2_CF57C78CC7075003_METHOD_2_A27D06F9481FAFDB_1_OFFSET UNITYSDK_OFFSET(0xFC7C4C0)
#define CLASS_2_CF57C78CC7075003_METHOD_2_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0xFC7C410)
#define CLASS_2_CF57C78CC7075003_METHOD_2_CEE2550285AA5985_OFFSET UNITYSDK_OFFSET(0xFC7C560)
#define CLASS_2_CF57C78CC7075003_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0xFC7C340)
#define CLASS_2_CF57C78CC7075003_METHOD_2_FD1726F5C8763865_OFFSET UNITYSDK_OFFSET(0xFC7B770)
#define CLASS_2_CF57C78CC7075003_METHOD_2_FEE7938AD36467E5_OFFSET UNITYSDK_OFFSET(0xFC7BD10)
#define CLASS_2_CF57C78CC7075003__CTOR_OFFSET UNITYSDK_OFFSET(0xFC7C8E0)
#define CLASS_2_CF57C78CC7075003___IFIXBASEPROXY_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xFC7C9D0)
#define CLASS_2_CF57C78CC7075003___IFIXBASEPROXY_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xFC7CA30)

inline static constexpr unsigned int Class_2_CF57C78CC7075003_TypeDefinitionIndex = 66359;

class Class_2_CF57C78CC7075003 : public ::Class_1_CA217ABF4E3B4F3F
{
public:
	::RPG::GameCore::BattleInstance* Field_2_0; // 0x60
	::Il2CppArray<::RPG::GameCore::BattleTargetConfigType>* Field_2_2; // 0x68
	::RPG::GameCore::LevelDataComponent* Field_2_1; // 0x70
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_2_CF57C78CC7075003_METHOD_2_FEE7938AD36467E5_OFFSET))(this);
	}
