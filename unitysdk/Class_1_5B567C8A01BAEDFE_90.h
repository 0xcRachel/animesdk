...
#define CLASS_1_5B567C8A01BAEDFE_90_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1B07AD10)
#define CLASS_1_5B567C8A01BAEDFE_90_CLONE_OFFSET UNITYSDK_OFFSET(0x1B07AB80)
#define CLASS_1_5B567C8A01BAEDFE_90_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1B07AC20)
#define CLASS_1_5B567C8A01BAEDFE_90_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B07ABC0)
#define CLASS_1_5B567C8A01BAEDFE_90_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B07AC70)
#define CLASS_1_5B567C8A01BAEDFE_90_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1B07AD60)
#define CLASS_1_5B567C8A01BAEDFE_90_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1B07AD30)
#define CLASS_1_5B567C8A01BAEDFE_90_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1B07AB00)
#define CLASS_1_5B567C8A01BAEDFE_90_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1B07AB30)
#define CLASS_1_5B567C8A01BAEDFE_90_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B07ACA0)
#define CLASS_1_5B567C8A01BAEDFE_90_WRITETO_OFFSET UNITYSDK_OFFSET(0x1B07AD00)
#define CLASS_1_5B567C8A01BAEDFE_90__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B07ADB0)
#define CLASS_1_5B567C8A01BAEDFE_90__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B07AB50)
#define CLASS_1_5B567C8A01BAEDFE_90__CTOR_OFFSET UNITYSDK_OFFSET(0x1B07AB40)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_90*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_90_TypeDefinitionIndex)->GetStaticField(0x153C0);
	}
