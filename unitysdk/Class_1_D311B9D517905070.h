...
#define CLASS_1_D311B9D517905070_METHOD_1_1F29F81CADD13A09_OFFSET UNITYSDK_OFFSET(0x166EAFC0)
#define CLASS_1_D311B9D517905070__CTOR_OFFSET UNITYSDK_OFFSET(0x166EB490)

inline static constexpr unsigned int Class_1_D311B9D517905070_TypeDefinitionIndex = 10449;
...
public:
	...
	::RPG::GameCore::DiceCombatDiceType Field_1_3; // 0x34
	::RPG::GameCore::DiceCombatDiceRare Field_1_4; // 0x38
	::RPG::Client::TextID Field_1_1; // 0x40
	::System::UInt32 Field_1_0; // 0x50
	::RPG::GameCore::DiceCombatDiceValidTurnType Field_1_6; // 0x54
