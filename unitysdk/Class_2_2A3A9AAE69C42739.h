...
#define CLASS_2_2A3A9AAE69C42739_EXECUTE_OFFSET UNITYSDK_OFFSET(0x14050510)
#define CLASS_2_2A3A9AAE69C42739__CTOR_OFFSET UNITYSDK_OFFSET(0x140505C0)
#define CLASS_2_2A3A9AAE69C42739___IFIXBASEPROXY_EXECUTE_OFFSET UNITYSDK_OFFSET(0x140505D0)
