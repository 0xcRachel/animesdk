...
#define CLASS_2_CBDF63BA2C3715C3_ALIASMARK_OFFSET UNITYSDK_OFFSET(0xEEACD00)
#define CLASS_2_CBDF63BA2C3715C3_GETAPPLYSTREAMINGLAYER_OFFSET UNITYSDK_OFFSET(0xEEAC9D0)
#define CLASS_2_CBDF63BA2C3715C3_GETASSETPATH_OFFSET UNITYSDK_OFFSET(0xEEACDB0)
#define CLASS_2_CBDF63BA2C3715C3_GETBOUNDCENTER_OFFSET UNITYSDK_OFFSET(0xEEAC870)
#define CLASS_2_CBDF63BA2C3715C3_GETBOUNDSIZE_OFFSET UNITYSDK_OFFSET(0xEEAC8F0)
#define CLASS_2_CBDF63BA2C3715C3_GETRECT_OFFSET UNITYSDK_OFFSET(0xEEAC970)
#define CLASS_2_CBDF63BA2C3715C3_GET_ALIAS_OFFSET UNITYSDK_OFFSET(0xEEACFF0)
#define CLASS_2_CBDF63BA2C3715C3_METHOD_2_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0xEEACD60)
#define CLASS_2_CBDF63BA2C3715C3_METHOD_2_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0xEEAD010)
#define CLASS_2_CBDF63BA2C3715C3_METHOD_2_1D4018D4200358D0_1_OFFSET UNITYSDK_OFFSET(0xEEAD250)
#define CLASS_2_CBDF63BA2C3715C3_METHOD_2_1D4018D4200358D0_2_OFFSET UNITYSDK_OFFSET(0xEEAD370)
#define CLASS_2_CBDF63BA2C3715C3_METHOD_2_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xEEAD130)
#define CLASS_2_CBDF63BA2C3715C3_METHOD_2_5AEC8C9EE262F230_OFFSET UNITYSDK_OFFSET(0xEEAD0D0)
#define CLASS_2_CBDF63BA2C3715C3_METHOD_2_5C549BF7442375BC_1_OFFSET UNITYSDK_OFFSET(0xEEAD2D0)
#define CLASS_2_CBDF63BA2C3715C3_METHOD_2_5C549BF7442375BC_2_OFFSET UNITYSDK_OFFSET(0xEEAD3F0)
#define CLASS_2_CBDF63BA2C3715C3_METHOD_2_5C549BF7442375BC_OFFSET UNITYSDK_OFFSET(0xEEAD1B0)
#define CLASS_2_CBDF63BA2C3715C3_METHOD_2_CA986D13693BCA0B_OFFSET UNITYSDK_OFFSET(0xEEAC010)
#define CLASS_2_CBDF63BA2C3715C3_SET_ALIAS_OFFSET UNITYSDK_OFFSET(0xEEAD000)
#define CLASS_2_CBDF63BA2C3715C3__CTOR_OFFSET UNITYSDK_OFFSET(0xEEAC080)
#define CLASS_2_CBDF63BA2C3715C3___IFIXBASEPROXY_ALIASMARK_OFFSET UNITYSDK_OFFSET(0xEEAD500)
#define CLASS_2_CBDF63BA2C3715C3___IFIXBASEPROXY_GETASSETPATH_OFFSET UNITYSDK_OFFSET(0xEEAD490)

inline static constexpr unsigned int Class_2_CBDF63BA2C3715C3_TypeDefinitionIndex = 68016;

class Class_2_CBDF63BA2C3715C3 : public ::RPG::Client::OpenWorld::StreamingItemData
{
public:
	::System::String* _Alias_k__BackingField; // 0xA8
	::Class_1_563415D37D4EDE07* Field_2_1; // 0xB0
