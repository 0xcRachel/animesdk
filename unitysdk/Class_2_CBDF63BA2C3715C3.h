...
#define CLASS_2_CBDF63BA2C3715C3_ALIASMARK_OFFSET UNITYSDK_OFFSET(0x10B44BC0)
#define CLASS_2_CBDF63BA2C3715C3_GETAPPLYSTREAMINGLAYER_OFFSET UNITYSDK_OFFSET(0x10B44890)
#define CLASS_2_CBDF63BA2C3715C3_GETASSETPATH_OFFSET UNITYSDK_OFFSET(0x10B44C70)
#define CLASS_2_CBDF63BA2C3715C3_GETBOUNDCENTER_OFFSET UNITYSDK_OFFSET(0x10B44740)
#define CLASS_2_CBDF63BA2C3715C3_GETBOUNDSIZE_OFFSET UNITYSDK_OFFSET(0x10B447B0)
#define CLASS_2_CBDF63BA2C3715C3_GETRECT_OFFSET UNITYSDK_OFFSET(0x10B44830)
#define CLASS_2_CBDF63BA2C3715C3_GET_ALIAS_OFFSET UNITYSDK_OFFSET(0x10B44EB0)
#define CLASS_2_CBDF63BA2C3715C3_METHOD_2_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x10B44C20)
#define CLASS_2_CBDF63BA2C3715C3_METHOD_2_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x10B44ED0)
#define CLASS_2_CBDF63BA2C3715C3_METHOD_2_1D4018D4200358D0_1_OFFSET UNITYSDK_OFFSET(0x10B45110)
#define CLASS_2_CBDF63BA2C3715C3_METHOD_2_1D4018D4200358D0_2_OFFSET UNITYSDK_OFFSET(0x10B45230)
#define CLASS_2_CBDF63BA2C3715C3_METHOD_2_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x10B44FF0)
#define CLASS_2_CBDF63BA2C3715C3_METHOD_2_5AEC8C9EE262F230_OFFSET UNITYSDK_OFFSET(0x10B44F90)
#define CLASS_2_CBDF63BA2C3715C3_METHOD_2_5C549BF7442375BC_1_OFFSET UNITYSDK_OFFSET(0x10B45190)
#define CLASS_2_CBDF63BA2C3715C3_METHOD_2_5C549BF7442375BC_2_OFFSET UNITYSDK_OFFSET(0x10B452B0)
#define CLASS_2_CBDF63BA2C3715C3_METHOD_2_5C549BF7442375BC_OFFSET UNITYSDK_OFFSET(0x10B45070)
#define CLASS_2_CBDF63BA2C3715C3_METHOD_2_CA986D13693BCA0B_OFFSET UNITYSDK_OFFSET(0x10B43EE0)
#define CLASS_2_CBDF63BA2C3715C3_SET_ALIAS_OFFSET UNITYSDK_OFFSET(0x10B44EC0)
#define CLASS_2_CBDF63BA2C3715C3__CTOR_OFFSET UNITYSDK_OFFSET(0x10B43F50)
#define CLASS_2_CBDF63BA2C3715C3___IFIXBASEPROXY_ALIASMARK_OFFSET UNITYSDK_OFFSET(0x10B453C0)
#define CLASS_2_CBDF63BA2C3715C3___IFIXBASEPROXY_GETASSETPATH_OFFSET UNITYSDK_OFFSET(0x10B45350)

inline static constexpr unsigned int Class_2_CBDF63BA2C3715C3_TypeDefinitionIndex = 60579;

class Class_2_CBDF63BA2C3715C3 : public ::RPG::Client::OpenWorld::StreamingItemData
{
public:
	::Class_1_563415D37D4EDE07* Field_2_1; // 0xA0
	::System::String* _Alias_k__BackingField; // 0xA8
