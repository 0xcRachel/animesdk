...
#define CLASS_2_B799AE57F99AD856_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8AB06A0)
#define CLASS_2_B799AE57F99AD856_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x8AB09F0)
#define CLASS_2_B799AE57F99AD856_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x8AB0A40)
#define CLASS_2_B799AE57F99AD856_TICK_OFFSET UNITYSDK_OFFSET(0x8AB0740)
#define CLASS_2_B799AE57F99AD856__CTOR_OFFSET UNITYSDK_OFFSET(0x8AB0500)
...
{
public:
	::RPG::Client::Prop::BlockPuzzleBase* Field_2_1; // 0x18
	::Class_1_69FF5DE516C87A66* Field_2_7; // 0x20
	::Class_3_5775A4FEC79026BC* Field_2_4; // 0x28
	::RPG::GameCore::TaskContext* Field_2_2; // 0x30
	::Class_1_69FF5DE516C87A66* Field_2_6; // 0x38
	::RPG::GameCore::CommonBoardPuzzleInBoard* Field_2_3; // 0x40
	::RPG::GameCore::PropComponent* Field_2_0; // 0x48
