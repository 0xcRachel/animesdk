...
#define CLASS_2_B799AE57F99AD856_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9BECAF0)
#define CLASS_2_B799AE57F99AD856_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x9BECE40)
#define CLASS_2_B799AE57F99AD856_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x9BECE90)
#define CLASS_2_B799AE57F99AD856_TICK_OFFSET UNITYSDK_OFFSET(0x9BECB90)
#define CLASS_2_B799AE57F99AD856__CTOR_OFFSET UNITYSDK_OFFSET(0x9BEC960)

inline static constexpr unsigned int Class_2_B799AE57F99AD856_TypeDefinitionIndex = 45742;

class Class_2_B799AE57F99AD856 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::CommonBoardPuzzleInBoard* Field_2_3; // 0x18
	::Class_3_BCCE950C2E8DF1F0* Field_2_5; // 0x20
	::Class_3_BCCE950C2E8DF1F0* Field_2_4; // 0x28
	::RPG::GameCore::TaskContext* Field_2_2; // 0x30
	::RPG::GameCore::PropComponent* Field_2_0; // 0x38
	::Class_1_69FF5DE516C87A66* Field_2_6; // 0x40
