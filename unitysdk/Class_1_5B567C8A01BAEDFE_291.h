...
#define CLASS_1_5B567C8A01BAEDFE_291_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A272240)
#define CLASS_1_5B567C8A01BAEDFE_291_CLONE_OFFSET UNITYSDK_OFFSET(0x1A272050)
#define CLASS_1_5B567C8A01BAEDFE_291_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A272150)
#define CLASS_1_5B567C8A01BAEDFE_291_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A2720C0)
#define CLASS_1_5B567C8A01BAEDFE_291_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A2721A0)
#define CLASS_1_5B567C8A01BAEDFE_291_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A272290)
#define CLASS_1_5B567C8A01BAEDFE_291_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A272260)
#define CLASS_1_5B567C8A01BAEDFE_291_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A271FA0)
#define CLASS_1_5B567C8A01BAEDFE_291_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A272000)
#define CLASS_1_5B567C8A01BAEDFE_291_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A2721D0)
#define CLASS_1_5B567C8A01BAEDFE_291_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A272230)
#define CLASS_1_5B567C8A01BAEDFE_291__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A2722E0)
#define CLASS_1_5B567C8A01BAEDFE_291__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A272020)
#define CLASS_1_5B567C8A01BAEDFE_291__CTOR_OFFSET UNITYSDK_OFFSET(0x1A272010)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_291*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_291_TypeDefinitionIndex)->GetStaticField(0x2B3D0);
	}
