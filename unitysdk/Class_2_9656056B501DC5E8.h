...
#define CLASS_2_9656056B501DC5E8_GET_COMMAND_OFFSET UNITYSDK_OFFSET(0x10EB3A40)
#define CLASS_2_9656056B501DC5E8_METHOD_2_BC1A57474C8A653B_OFFSET UNITYSDK_OFFSET(0x10EB3AC0)
#define CLASS_2_9656056B501DC5E8_METHOD_2_DF3E6C4E87C9A21C_OFFSET UNITYSDK_OFFSET(0x10EB3A60)
#define CLASS_2_9656056B501DC5E8_SET_COMMAND_OFFSET UNITYSDK_OFFSET(0x10EB3A50)
#define CLASS_2_9656056B501DC5E8__CTOR_OFFSET UNITYSDK_OFFSET(0x10EB3AB0)
#define CLASS_2_9656056B501DC5E8___ONEXECUTE_B__6_0_OFFSET UNITYSDK_OFFSET(0x10EB3E90)

inline static constexpr unsigned int Class_2_9656056B501DC5E8_TypeDefinitionIndex = 61372;

class Class_2_9656056B501DC5E8 : public ::Class_1_E2D539C29BA420F0
{
public:
	::Class_0_16E4307DCC419505_299* _Command_k__BackingField; // 0x18
	...
	::Class_0_16E4307DCC419505_299* get_Command()
	{
		return ((::Class_0_16E4307DCC419505_299*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_2_9656056B501DC5E8_GET_COMMAND_OFFSET))(this);
	}

	::System::Void set_Command(::Class_0_16E4307DCC419505_299* value)
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_299*))((::PBYTE)hIl2Cpp + CLASS_2_9656056B501DC5E8_SET_COMMAND_OFFSET))(this, value);
	}
