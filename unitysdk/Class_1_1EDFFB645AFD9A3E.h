...
#define CLASS_1_1EDFFB645AFD9A3E_METHOD_1_A8B5DD81FACB4C81_OFFSET UNITYSDK_OFFSET(0xF3EE6C0)
#define CLASS_1_1EDFFB645AFD9A3E_METHOD_1_ADF45F4E823CC047_OFFSET UNITYSDK_OFFSET(0xF3EE9D0)
#define CLASS_1_1EDFFB645AFD9A3E_ONPLUGININIT_OFFSET UNITYSDK_OFFSET(0xF3EE440)
#define CLASS_1_1EDFFB645AFD9A3E_ONPLUGINUNINIT_OFFSET UNITYSDK_OFFSET(0xF3EE4D0)
#define CLASS_1_1EDFFB645AFD9A3E__CTOR_OFFSET UNITYSDK_OFFSET(0xF3EEAB0)

inline static constexpr unsigned int Class_1_1EDFFB645AFD9A3E_TypeDefinitionIndex = 66388;
