...
#define CLASS_2_B29F3A4CD99EA989_DISPOSE_OFFSET UNITYSDK_OFFSET(0x876B8C0)
#define CLASS_2_B29F3A4CD99EA989_METHOD_2_92235057BAF7B12C_OFFSET UNITYSDK_OFFSET(0x876C790)
#define CLASS_2_B29F3A4CD99EA989_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x8769F60)
#define CLASS_2_B29F3A4CD99EA989_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x876B7E0)
#define CLASS_2_B29F3A4CD99EA989_TICK_OFFSET UNITYSDK_OFFSET(0x876B910)
#define CLASS_2_B29F3A4CD99EA989__CCTOR_OFFSET UNITYSDK_OFFSET(0x876C980)
#define CLASS_2_B29F3A4CD99EA989__CTOR_OFFSET UNITYSDK_OFFSET(0x8769CA0)
...
public:
	...
	{
		return (::System::Type**)Il2CppClass::FromTypeDefinitionIndex(Class_2_B29F3A4CD99EA989_TypeDefinitionIndex)->GetStaticField(0x13270);
	}
	::Il2CppArray<::Class_1_5F51D4049EA87B7B*>* Field_2_5; // 0x18
	::RPG::GameCore::TriggerParallelAbility* Field_2_1; // 0x20
	::Class_1_07A210D994F284D8_3* Field_2_3; // 0x28
	::System::Collections::Generic::List_1<::RPG::GameCore::Triple_3<::System::Boolean, ::RPG::GameCore::TurnBasedAbilityComponent*, ::RPG::GameCore::GameEntityList*>*>* Field_2_8; // 0x30
