...
#define CLASS_1_041CA627B6BC03C3_METHOD_1_250DD1D84F42E8C9_1_OFFSET UNITYSDK_OFFSET(0x1193C5B0)
#define CLASS_1_041CA627B6BC03C3_METHOD_1_250DD1D84F42E8C9_OFFSET UNITYSDK_OFFSET(0x1193C500)
#define CLASS_1_041CA627B6BC03C3_METHOD_1_3588E14461059324_OFFSET UNITYSDK_OFFSET(0x1193C360)
#define CLASS_1_041CA627B6BC03C3_METHOD_1_3A5882E7FD121FDD_OFFSET UNITYSDK_OFFSET(0x1193C270)
#define CLASS_1_041CA627B6BC03C3_METHOD_1_401D9792CCB3DD84_OFFSET UNITYSDK_OFFSET(0x1193C660)
#define CLASS_1_041CA627B6BC03C3_METHOD_1_472DB64F0A6BC7CE_OFFSET UNITYSDK_OFFSET(0x1193C400)
#define CLASS_1_041CA627B6BC03C3_METHOD_1_99A5531F4A7DF520_OFFSET UNITYSDK_OFFSET(0x1193C730)
#define CLASS_1_041CA627B6BC03C3__CTOR_OFFSET UNITYSDK_OFFSET(0x1193C200)

inline static constexpr unsigned int Class_1_041CA627B6BC03C3_TypeDefinitionIndex = 69290;

class Class_1_041CA627B6BC03C3 : public ::System::Object
{
public:
	::System::Collections::Generic::List_1<::RPG::Client::ActivityIdleLive::SpecialEquip*>* Field_1_1; // 0x10
	::RPG::Client::ActivityIdleLive::BaseSpEquipInventoryDisplayData* Field_1_0; // 0x18
