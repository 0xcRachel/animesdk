...
#define YCORRECTION_GET_ENABLEYCORRECTION_OFFSET UNITYSDK_OFFSET(0xFD12720)
#define YCORRECTION_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xFD12740)
#define YCORRECTION_SET_ENABLEYCORRECTION_OFFSET UNITYSDK_OFFSET(0xFD12730)
#define YCORRECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xFD12AA0)

inline static constexpr unsigned int YCorrection_TypeDefinitionIndex = 37465;
