...
#define YCORRECTION_GET_ENABLEYCORRECTION_OFFSET UNITYSDK_OFFSET(0x104A9930)
#define YCORRECTION_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x104A9950)
#define YCORRECTION_SET_ENABLEYCORRECTION_OFFSET UNITYSDK_OFFSET(0x104A9940)
#define YCORRECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x104A9CB0)
