...
#define AKMIDIEVENT_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x183A6020)
#define AKMIDIEVENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x183A5F30)
#define AKMIDIEVENT_FINALIZE_OFFSET UNITYSDK_OFFSET(0x183A5FB0)
#define AKMIDIEVENT_GETCPTR_OFFSET UNITYSDK_OFFSET(0x183A5E20)
#define AKMIDIEVENT_GET_BYAFTERTOUCHNOTE_OFFSET UNITYSDK_OFFSET(0x183A7FF0)
#define AKMIDIEVENT_GET_BYCCVALUE_OFFSET UNITYSDK_OFFSET(0x183A7BA0)
#define AKMIDIEVENT_GET_BYCC_OFFSET UNITYSDK_OFFSET(0x183A7A30)
#define AKMIDIEVENT_GET_BYCHANAFTERTOUCHVALUE_OFFSET UNITYSDK_OFFSET(0x183A82D0)
#define AKMIDIEVENT_GET_BYCHAN_OFFSET UNITYSDK_OFFSET(0x183A6280)
#define AKMIDIEVENT_GET_BYNOTEAFTERTOUCHVALUE_OFFSET UNITYSDK_OFFSET(0x183A8160)
#define AKMIDIEVENT_GET_BYONOFFNOTE_OFFSET UNITYSDK_OFFSET(0x183A7750)
#define AKMIDIEVENT_GET_BYPROGRAMNUM_OFFSET UNITYSDK_OFFSET(0x183A8440)
#define AKMIDIEVENT_GET_BYTYPE_OFFSET UNITYSDK_OFFSET(0x183A75E0)
#define AKMIDIEVENT_GET_BYVALUELSB_OFFSET UNITYSDK_OFFSET(0x183A7D10)
#define AKMIDIEVENT_GET_BYVALUEMSB_OFFSET UNITYSDK_OFFSET(0x183A7E80)
#define AKMIDIEVENT_GET_BYVELOCITY_OFFSET UNITYSDK_OFFSET(0x183A78C0)
#define AKMIDIEVENT_GET_CC_OFFSET UNITYSDK_OFFSET(0x183A6730)
#define AKMIDIEVENT_GET_CHANAFTERTOUCH_OFFSET UNITYSDK_OFFSET(0x183A7170)
#define AKMIDIEVENT_GET_GEN_OFFSET UNITYSDK_OFFSET(0x183A64A0)
#define AKMIDIEVENT_GET_NOTEAFTERTOUCH_OFFSET UNITYSDK_OFFSET(0x183A6EE0)
#define AKMIDIEVENT_GET_NOTEONOFF_OFFSET UNITYSDK_OFFSET(0x183A69C0)
#define AKMIDIEVENT_GET_PITCHBEND_OFFSET UNITYSDK_OFFSET(0x183A6C50)
#define AKMIDIEVENT_GET_PROGRAMCHANGE_OFFSET UNITYSDK_OFFSET(0x183A7400)
#define AKMIDIEVENT_SETCPTR_OFFSET UNITYSDK_OFFSET(0x183A5E70)
#define AKMIDIEVENT_SET_BYAFTERTOUCHNOTE_OFFSET UNITYSDK_OFFSET(0x183A7F30)
#define AKMIDIEVENT_SET_BYCCVALUE_OFFSET UNITYSDK_OFFSET(0x183A7AE0)
#define AKMIDIEVENT_SET_BYCC_OFFSET UNITYSDK_OFFSET(0x183A7970)
#define AKMIDIEVENT_SET_BYCHANAFTERTOUCHVALUE_OFFSET UNITYSDK_OFFSET(0x183A8210)
#define AKMIDIEVENT_SET_BYCHAN_OFFSET UNITYSDK_OFFSET(0x183A61C0)
#define AKMIDIEVENT_SET_BYNOTEAFTERTOUCHVALUE_OFFSET UNITYSDK_OFFSET(0x183A80A0)
#define AKMIDIEVENT_SET_BYONOFFNOTE_OFFSET UNITYSDK_OFFSET(0x183A7690)
#define AKMIDIEVENT_SET_BYPROGRAMNUM_OFFSET UNITYSDK_OFFSET(0x183A8380)
#define AKMIDIEVENT_SET_BYTYPE_OFFSET UNITYSDK_OFFSET(0x183A7520)
#define AKMIDIEVENT_SET_BYVALUELSB_OFFSET UNITYSDK_OFFSET(0x183A7C50)
#define AKMIDIEVENT_SET_BYVALUEMSB_OFFSET UNITYSDK_OFFSET(0x183A7DC0)
#define AKMIDIEVENT_SET_BYVELOCITY_OFFSET UNITYSDK_OFFSET(0x183A7800)
#define AKMIDIEVENT_SET_CC_OFFSET UNITYSDK_OFFSET(0x183A65C0)
#define AKMIDIEVENT_SET_CHANAFTERTOUCH_OFFSET UNITYSDK_OFFSET(0x183A7000)
#define AKMIDIEVENT_SET_GEN_OFFSET UNITYSDK_OFFSET(0x183A6330)
#define AKMIDIEVENT_SET_NOTEAFTERTOUCH_OFFSET UNITYSDK_OFFSET(0x183A6D70)
#define AKMIDIEVENT_SET_NOTEONOFF_OFFSET UNITYSDK_OFFSET(0x183A6850)
#define AKMIDIEVENT_SET_PITCHBEND_OFFSET UNITYSDK_OFFSET(0x183A6AE0)
#define AKMIDIEVENT_SET_PROGRAMCHANGE_OFFSET UNITYSDK_OFFSET(0x183A7290)
#define AKMIDIEVENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x183A84F0)
#define AKMIDIEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x183A5E10)

inline static constexpr unsigned int AkMIDIEvent_TypeDefinitionIndex = 33497;
