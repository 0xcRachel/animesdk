...
#define CLASS_2_3A7E8C13A23D1E83_DISPOSE_OFFSET UNITYSDK_OFFSET(0xFED3520)
#define CLASS_2_3A7E8C13A23D1E83_METHOD_2_F1C870D01294DAF7_OFFSET UNITYSDK_OFFSET(0xFED36E0)
#define CLASS_2_3A7E8C13A23D1E83_METHOD_2_F5447CD65612575D_OFFSET UNITYSDK_OFFSET(0xFED3320)
#define CLASS_2_3A7E8C13A23D1E83_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xFED3290)
#define CLASS_2_3A7E8C13A23D1E83_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xFED35F0)
#define CLASS_2_3A7E8C13A23D1E83_TICK_OFFSET UNITYSDK_OFFSET(0xFED3640)
#define CLASS_2_3A7E8C13A23D1E83__CTOR_OFFSET UNITYSDK_OFFSET(0xFED3280)

inline static constexpr unsigned int Class_2_3A7E8C13A23D1E83_TypeDefinitionIndex = 45657;

class Class_2_3A7E8C13A23D1E83 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_3; // 0x18
	::RPG::GameCore::BackToMainPage* Field_2_0; // 0x20
	::Class_0_16E4307DCC419505_437* Field_2_2; // 0x28
