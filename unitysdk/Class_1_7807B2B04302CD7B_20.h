...
#define CLASS_1_7807B2B04302CD7B_20__CCTOR_OFFSET UNITYSDK_OFFSET(0xDD7BF40)
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_7807B2B04302CD7B_20_TypeDefinitionIndex)->GetStaticField(0x5730);
	}
