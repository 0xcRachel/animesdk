...
#define CLASS_3_6D2614470ADC7B5C_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x110071E0)
#define CLASS_3_6D2614470ADC7B5C__CTOR_OFFSET UNITYSDK_OFFSET(0x110071B0)

inline static constexpr unsigned int Class_3_6D2614470ADC7B5C_TypeDefinitionIndex = 46057;
