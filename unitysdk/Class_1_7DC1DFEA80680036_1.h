...
#define CLASS_1_7DC1DFEA80680036_1_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10BF3760)
#define CLASS_1_7DC1DFEA80680036_1_GET_ANCHORDEF_OFFSET UNITYSDK_OFFSET(0x10BF37D0)
#define CLASS_1_7DC1DFEA80680036_1_GET_AREAID_OFFSET UNITYSDK_OFFSET(0x10BF3C90)
#define CLASS_1_7DC1DFEA80680036_1_GET_CANTINT_OFFSET UNITYSDK_OFFSET(0x10BF3890)
#define CLASS_1_7DC1DFEA80680036_1_GET_CIRCLECOLOR_OFFSET UNITYSDK_OFFSET(0x10BF39F0)
#define CLASS_1_7DC1DFEA80680036_1_GET_COLOR_OFFSET UNITYSDK_OFFSET(0x10BF3870)
#define CLASS_1_7DC1DFEA80680036_1_GET_ENTITYDEF_OFFSET UNITYSDK_OFFSET(0x10BF37B0)
#define CLASS_1_7DC1DFEA80680036_1_GET_HASH_OFFSET UNITYSDK_OFFSET(0x10BF3810)
#define CLASS_1_7DC1DFEA80680036_1_GET_ICONID_OFFSET UNITYSDK_OFFSET(0x10BF3850)
#define CLASS_1_7DC1DFEA80680036_1_GET_ICONTYPE_OFFSET UNITYSDK_OFFSET(0x10BF3A40)
#define CLASS_1_7DC1DFEA80680036_1_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x10BF37F0)
#define CLASS_1_7DC1DFEA80680036_1_GET_ISSTATIC_OFFSET UNITYSDK_OFFSET(0x10BF3910)
#define CLASS_1_7DC1DFEA80680036_1_GET_ISTRACKINGMAPPINGINFO_OFFSET UNITYSDK_OFFSET(0x10BF3950)
#define CLASS_1_7DC1DFEA80680036_1_GET_ISTRACKINGMISSION_OFFSET UNITYSDK_OFFSET(0x10BF3930)
#define CLASS_1_7DC1DFEA80680036_1_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x10BF3A10)
#define CLASS_1_7DC1DFEA80680036_1_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x10BF3830)
#define CLASS_1_7DC1DFEA80680036_1_GET_RANGERADIUS_OFFSET UNITYSDK_OFFSET(0x10BF3990)
#define CLASS_1_7DC1DFEA80680036_1_GET_RAWPOSITION_OFFSET UNITYSDK_OFFSET(0x10BF3EB0)
#define CLASS_1_7DC1DFEA80680036_1_GET_RAWROTATION_OFFSET UNITYSDK_OFFSET(0x10BF3E90)
#define CLASS_1_7DC1DFEA80680036_1_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x10BF3970)
#define CLASS_1_7DC1DFEA80680036_1_GET_WAYPOINTSHOWRANGEMAX_OFFSET UNITYSDK_OFFSET(0x10BF39D0)
#define CLASS_1_7DC1DFEA80680036_1_GET_WAYPOINTSHOWRANGEMIN_OFFSET UNITYSDK_OFFSET(0x10BF39B0)
#define CLASS_1_7DC1DFEA80680036_1_METHOD_1_03BE804B9317DF84_OFFSET UNITYSDK_OFFSET(0x10BF3630)
#define CLASS_1_7DC1DFEA80680036_1_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x10BF3BD0)
#define CLASS_1_7DC1DFEA80680036_1_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x10BF38B0)
#define CLASS_1_7DC1DFEA80680036_1_METHOD_1_222640CE7F3FC014_OFFSET UNITYSDK_OFFSET(0x10BF3090)
#define CLASS_1_7DC1DFEA80680036_1_METHOD_1_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x10BF3710)
#define CLASS_1_7DC1DFEA80680036_1_METHOD_1_44D6FA8CAA4B79D4_OFFSET UNITYSDK_OFFSET(0x10BF4010)
#define CLASS_1_7DC1DFEA80680036_1_METHOD_1_4737D68B509F6660_OFFSET UNITYSDK_OFFSET(0x10BF3480)
#define CLASS_1_7DC1DFEA80680036_1_METHOD_1_4AADAF19CDCB660E_OFFSET UNITYSDK_OFFSET(0x10BF3EE0)
#define CLASS_1_7DC1DFEA80680036_1_METHOD_1_507A5122CD01412B_OFFSET UNITYSDK_OFFSET(0x10BF3D50)
#define CLASS_1_7DC1DFEA80680036_1_METHOD_1_91B8F7110D8178C8_OFFSET UNITYSDK_OFFSET(0x10BF3A60)
#define CLASS_1_7DC1DFEA80680036_1_METHOD_1_BA7E6ED6D84A35AD_OFFSET UNITYSDK_OFFSET(0x10BF4020)
#define CLASS_1_7DC1DFEA80680036_1_METHOD_1_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0x10BF3FF0)
#define CLASS_1_7DC1DFEA80680036_1_METHOD_1_D30FF8DA38644CB5_OFFSET UNITYSDK_OFFSET(0x10BF33B0)
#define CLASS_1_7DC1DFEA80680036_1_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x10BF4000)
#define CLASS_1_7DC1DFEA80680036_1_SET_ANCHORDEF_OFFSET UNITYSDK_OFFSET(0x10BF37E0)
#define CLASS_1_7DC1DFEA80680036_1_SET_CANTINT_OFFSET UNITYSDK_OFFSET(0x10BF38A0)
#define CLASS_1_7DC1DFEA80680036_1_SET_CIRCLECOLOR_OFFSET UNITYSDK_OFFSET(0x10BF3A00)
#define CLASS_1_7DC1DFEA80680036_1_SET_COLOR_OFFSET UNITYSDK_OFFSET(0x10BF3880)
#define CLASS_1_7DC1DFEA80680036_1_SET_ENTITYDEF_OFFSET UNITYSDK_OFFSET(0x10BF37C0)
#define CLASS_1_7DC1DFEA80680036_1_SET_HASH_OFFSET UNITYSDK_OFFSET(0x10BF3820)
#define CLASS_1_7DC1DFEA80680036_1_SET_ICONID_OFFSET UNITYSDK_OFFSET(0x10BF3860)
#define CLASS_1_7DC1DFEA80680036_1_SET_ICONTYPE_OFFSET UNITYSDK_OFFSET(0x10BF3A50)
#define CLASS_1_7DC1DFEA80680036_1_SET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x10BF3800)
#define CLASS_1_7DC1DFEA80680036_1_SET_ISSTATIC_OFFSET UNITYSDK_OFFSET(0x10BF3920)
#define CLASS_1_7DC1DFEA80680036_1_SET_ISTRACKINGMAPPINGINFO_OFFSET UNITYSDK_OFFSET(0x10BF3960)
#define CLASS_1_7DC1DFEA80680036_1_SET_ISTRACKINGMISSION_OFFSET UNITYSDK_OFFSET(0x10BF3940)
#define CLASS_1_7DC1DFEA80680036_1_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x10BF3A30)
#define CLASS_1_7DC1DFEA80680036_1_SET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x10BF3840)
#define CLASS_1_7DC1DFEA80680036_1_SET_RANGERADIUS_OFFSET UNITYSDK_OFFSET(0x10BF39A0)
#define CLASS_1_7DC1DFEA80680036_1_SET_RAWPOSITION_OFFSET UNITYSDK_OFFSET(0x10BF3ED0)
#define CLASS_1_7DC1DFEA80680036_1_SET_RAWROTATION_OFFSET UNITYSDK_OFFSET(0x10BF3EA0)
#define CLASS_1_7DC1DFEA80680036_1_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x10BF3980)
#define CLASS_1_7DC1DFEA80680036_1_SET_WAYPOINTSHOWRANGEMAX_OFFSET UNITYSDK_OFFSET(0x10BF39E0)
#define CLASS_1_7DC1DFEA80680036_1_SET_WAYPOINTSHOWRANGEMIN_OFFSET UNITYSDK_OFFSET(0x10BF39C0)
#define CLASS_1_7DC1DFEA80680036_1__CTOR_OFFSET UNITYSDK_OFFSET(0x10BF41F0)

inline static constexpr unsigned int Class_1_7DC1DFEA80680036_1_TypeDefinitionIndex = 48035;
...
public:
	...
	::System::UInt32 _IconID_k__BackingField; // 0x24
	::System::Int32 _Identifier_k__BackingField; // 0x28
	::UnityEngine::Vector3 _RawPosition_k__BackingField; // 0x2C
	::System::Single _Rotation_k__BackingField; // 0x38
	::System::Single _RawRotation_k__BackingField; // 0x3C
	::UnityEngine::Color _CircleColor_k__BackingField; // 0x40
	::UnityEngine::Color _Color_k__BackingField; // 0x50
	::System::Single _WayPointShowRangeMax_k__BackingField; // 0x60
	::System::Single _WayPointShowRangeMin_k__BackingField; // 0x64
	::System::Boolean _CanTint_k__BackingField; // 0x68
	::System::Boolean _IsStatic_k__BackingField; // 0x69
	::UnityEngine::Vector3 _Position_k__BackingField; // 0x6C
	::System::Int32 _Priority_k__BackingField; // 0x78
	::System::Nullable_1<::System::Boolean> Field_1_21; // 0x7C
	::System::Boolean _IsTrackingMission_k__BackingField; // 0x7E
	::System::Boolean Field_1_20; // 0x7F
	::System::Boolean _IsTrackingMappingInfo_k__BackingField; // 0x80
	::RPG::Client::MiniMapIconType _IconType_k__BackingField; // 0x84
	::System::Single _RangeRadius_k__BackingField; // 0x88
	...
	{
		return ((::System::Boolean(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_7DC1DFEA80680036_1_METHOD_1_507A5122CD01412B_OFFSET))(this);
	}
	...
	::UnityEngine::Vector2 Method_1_44D6FA8CAA4B79D4()
	{
		return ((::UnityEngine::Vector2(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_7DC1DFEA80680036_1_METHOD_1_44D6FA8CAA4B79D4_OFFSET))(this);
	}

	::UnityEngine::Vector2 Method_1_BA7E6ED6D84A35AD()
	{
		return ((::UnityEngine::Vector2(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_7DC1DFEA80680036_1_METHOD_1_BA7E6ED6D84A35AD_OFFSET))(this);
	}
};
