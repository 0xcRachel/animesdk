...
#define CLASS_1_301DCAC3D7B2DD34_METHOD_1_2547181A9D5D9FA5_OFFSET UNITYSDK_OFFSET(0xF36F780)
#define CLASS_1_301DCAC3D7B2DD34_METHOD_1_AF4A3BC093299516_OFFSET UNITYSDK_OFFSET(0xF36F3E0)
#define CLASS_1_301DCAC3D7B2DD34_METHOD_1_B0477DCBC1EE3A9F_OFFSET UNITYSDK_OFFSET(0xF36F460)
#define CLASS_1_301DCAC3D7B2DD34__CCTOR_OFFSET UNITYSDK_OFFSET(0xF370120)
...
public:
	...
	{
		return (::RPG::GameCore::IVec2*)Il2CppClass::FromTypeDefinitionIndex(Class_1_301DCAC3D7B2DD34_TypeDefinitionIndex)->GetStaticField(0x3EB0);
	}
	static ::RPG::GameCore::FixPoint* StaticGet_Field_1_2()
	{
		return (::RPG::GameCore::FixPoint*)Il2CppClass::FromTypeDefinitionIndex(Class_1_301DCAC3D7B2DD34_TypeDefinitionIndex)->GetStaticField(0x3EB8);
	}
	static ::RPG::GameCore::FixPoint* StaticGet_Field_1_1()
	{
		return (::RPG::GameCore::FixPoint*)Il2CppClass::FromTypeDefinitionIndex(Class_1_301DCAC3D7B2DD34_TypeDefinitionIndex)->GetStaticField(0x3EC0);
	}
