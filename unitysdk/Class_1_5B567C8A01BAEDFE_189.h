...
#define CLASS_1_5B567C8A01BAEDFE_189_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19EFB0C0)
#define CLASS_1_5B567C8A01BAEDFE_189_CLONE_OFFSET UNITYSDK_OFFSET(0x19EFAF30)
#define CLASS_1_5B567C8A01BAEDFE_189_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19EFAFD0)
#define CLASS_1_5B567C8A01BAEDFE_189_EQUALS_OFFSET UNITYSDK_OFFSET(0x19EFAF70)
#define CLASS_1_5B567C8A01BAEDFE_189_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19EFB020)
#define CLASS_1_5B567C8A01BAEDFE_189_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19EFB110)
#define CLASS_1_5B567C8A01BAEDFE_189_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19EFB0E0)
#define CLASS_1_5B567C8A01BAEDFE_189_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19EFAEB0)
#define CLASS_1_5B567C8A01BAEDFE_189_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19EFAEE0)
#define CLASS_1_5B567C8A01BAEDFE_189_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19EFB050)
#define CLASS_1_5B567C8A01BAEDFE_189_WRITETO_OFFSET UNITYSDK_OFFSET(0x19EFB0B0)
#define CLASS_1_5B567C8A01BAEDFE_189__CCTOR_OFFSET UNITYSDK_OFFSET(0x19EFB160)
#define CLASS_1_5B567C8A01BAEDFE_189__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19EFAF00)
#define CLASS_1_5B567C8A01BAEDFE_189__CTOR_OFFSET UNITYSDK_OFFSET(0x19EFAEF0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_189*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_189_TypeDefinitionIndex)->GetStaticField(0x40590);
	}
