...
#define CLASS_2_B193B57BE9796FEE_GET_CHARACTERUNIQUENAME_OFFSET UNITYSDK_OFFSET(0x1006AE20)
#define CLASS_2_B193B57BE9796FEE_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1006AE40)
#define CLASS_2_B193B57BE9796FEE_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0x1006AF70)
#define CLASS_2_B193B57BE9796FEE_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1006AFE0)
#define CLASS_2_B193B57BE9796FEE_SET_CHARACTERUNIQUENAME_OFFSET UNITYSDK_OFFSET(0x1006AE30)
#define CLASS_2_B193B57BE9796FEE__CTOR_OFFSET UNITYSDK_OFFSET(0x1006B400)
#define CLASS_2_B193B57BE9796FEE___IFIXBASEPROXY_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1006B410)
#define CLASS_2_B193B57BE9796FEE___IFIXBASEPROXY_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0x1006B420)
#define CLASS_2_B193B57BE9796FEE___IFIXBASEPROXY_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1006B430)

inline static constexpr unsigned int Class_2_B193B57BE9796FEE_TypeDefinitionIndex = 37763;
