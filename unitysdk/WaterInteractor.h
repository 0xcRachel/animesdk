...
#define WATERINTERACTOR_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xAC7F420)
#define WATERINTERACTOR_TRIGGERWAVE_OFFSET UNITYSDK_OFFSET(0xAC7F3C0)
#define WATERINTERACTOR__CTOR_OFFSET UNITYSDK_OFFSET(0xAC7F470)
#define WATERINTERACTOR___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xAC7F4A0)
