...
#define WATERINTERACTOR_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xA73EB00)
#define WATERINTERACTOR_TRIGGERWAVE_OFFSET UNITYSDK_OFFSET(0xA73EAA0)
#define WATERINTERACTOR__CTOR_OFFSET UNITYSDK_OFFSET(0xA73EB50)
#define WATERINTERACTOR___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xA73EB80)

inline static constexpr unsigned int WaterInteractor_TypeDefinitionIndex = 37383;
