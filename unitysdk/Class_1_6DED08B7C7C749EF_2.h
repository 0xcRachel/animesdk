...
#define CLASS_1_6DED08B7C7C749EF_2_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A915EA0)
#define CLASS_1_6DED08B7C7C749EF_2_CLONE_OFFSET UNITYSDK_OFFSET(0x1A9158B0)
#define CLASS_1_6DED08B7C7C749EF_2_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A915AA0)
#define CLASS_1_6DED08B7C7C749EF_2_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A9159B0)
#define CLASS_1_6DED08B7C7C749EF_2_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A915B70)
#define CLASS_1_6DED08B7C7C749EF_2_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A9161A0)
#define CLASS_1_6DED08B7C7C749EF_2_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A916130)
#define CLASS_1_6DED08B7C7C749EF_2_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1A915930)
#define CLASS_1_6DED08B7C7C749EF_2_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1A915910)
#define CLASS_1_6DED08B7C7C749EF_2_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x1A915960)
#define CLASS_1_6DED08B7C7C749EF_2_METHOD_1_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x1A915950)
#define CLASS_1_6DED08B7C7C749EF_2_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A915740)
#define CLASS_1_6DED08B7C7C749EF_2_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1A915900)
#define CLASS_1_6DED08B7C7C749EF_2_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1A915940)
#define CLASS_1_6DED08B7C7C749EF_2_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1A915920)
#define CLASS_1_6DED08B7C7C749EF_2_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A9157A0)
#define CLASS_1_6DED08B7C7C749EF_2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A915CF0)
#define CLASS_1_6DED08B7C7C749EF_2_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A915D50)
#define CLASS_1_6DED08B7C7C749EF_2__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A9162E0)
#define CLASS_1_6DED08B7C7C749EF_2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A915810)
#define CLASS_1_6DED08B7C7C749EF_2__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9157B0)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6DED08B7C7C749EF_2_TypeDefinitionIndex)->GetStaticField(0x1AD20);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_6DED08B7C7C749EF_2*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_6DED08B7C7C749EF_2*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6DED08B7C7C749EF_2_TypeDefinitionIndex)->GetStaticField(0x1AD28);
	}
