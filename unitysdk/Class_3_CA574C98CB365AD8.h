...
#define CLASS_3_CA574C98CB365AD8_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10F2CBE0)
#define CLASS_3_CA574C98CB365AD8__CTOR_OFFSET UNITYSDK_OFFSET(0x10F2CBB0)

inline static constexpr unsigned int Class_3_CA574C98CB365AD8_TypeDefinitionIndex = 37500;
