...
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_CLEAR_OFFSET UNITYSDK_OFFSET(0x111ED950)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_ENABLEIRISHADOW_OFFSET UNITYSDK_OFFSET(0x111EC090)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_FLASHLIGHT_OFFSET UNITYSDK_OFFSET(0x111EF290)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0x111EB8B0)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_ISENABLEIRISHADOW_OFFSET UNITYSDK_OFFSET(0x111EC0C0)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_LOADENVPROFILE_OFFSET UNITYSDK_OFFSET(0x111EBD00)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_METHOD_5_2B9D478141E0F891_OFFSET UNITYSDK_OFFSET(0x111EA800)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_METHOD_5_5AFFA079DA8B20AA_OFFSET UNITYSDK_OFFSET(0x111EF350)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_METHOD_5_6DDC67928C034C6F_OFFSET UNITYSDK_OFFSET(0x111EA720)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_METHOD_5_737220D2233A9067_OFFSET UNITYSDK_OFFSET(0x111EF050)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_METHOD_5_7BF32EC41F6B4DD6_OFFSET UNITYSDK_OFFSET(0x111EB340)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_METHOD_5_813C8FDB3E66B6BF_OFFSET UNITYSDK_OFFSET(0x111EB560)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_METHOD_5_D14D1C669EDC2D6B_OFFSET UNITYSDK_OFFSET(0x111ED530)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_METHOD_5_E16066A129C758CD_OFFSET UNITYSDK_OFFSET(0x111EB750)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_METHOD_5_E402C04CEC1622AF_OFFSET UNITYSDK_OFFSET(0x111EC0F0)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_METHOD_5_E41B6A823556FEEA_OFFSET UNITYSDK_OFFSET(0x111EADE0)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_METHOD_5_E67B8EE7D04609D0_OFFSET UNITYSDK_OFFSET(0x111EA630)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_METHOD_5_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0x111EBF70)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_METHOD_5_EC90259991730611_OFFSET UNITYSDK_OFFSET(0x111EAFF0)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x111ED7E0)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_STARTHOTRELOADSERVER_OFFSET UNITYSDK_OFFSET(0x111EA9B0)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_START_OFFSET UNITYSDK_OFFSET(0x111EB7F0)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_STOPHOTRELOADSERVER_OFFSET UNITYSDK_OFFSET(0x111EACC0)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_TURNLIGHT_OFFSET UNITYSDK_OFFSET(0x111EF150)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x111EBD70)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x111EF3B0)
...
namespace IRIClusterBuilder::Test
{
	...
	public:
		...
		{
			return (::IRIClusterBuilder::Test::IRICarTestManager**)Il2CppClass::FromTypeDefinitionIndex(IRICarTestManager_TypeDefinitionIndex)->GetStaticField(0x48E40);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_METHOD_5_D14D1C669EDC2D6B_OFFSET))(this);
		}
