...
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_CLEAR_OFFSET UNITYSDK_OFFSET(0x10AD8160)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_ENABLEIRISHADOW_OFFSET UNITYSDK_OFFSET(0x10AD68A0)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_FLASHLIGHT_OFFSET UNITYSDK_OFFSET(0x10AD9AA0)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0x10AD60D0)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_ISENABLEIRISHADOW_OFFSET UNITYSDK_OFFSET(0x10AD68D0)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_LOADENVPROFILE_OFFSET UNITYSDK_OFFSET(0x10AD6520)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_METHOD_5_1B9BAFE25893B138_OFFSET UNITYSDK_OFFSET(0x10AD7D40)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_METHOD_5_2B9D478141E0F891_OFFSET UNITYSDK_OFFSET(0x10AD5030)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_METHOD_5_5AFFA079DA8B20AA_OFFSET UNITYSDK_OFFSET(0x10AD9B90)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_METHOD_5_6DDC67928C034C6F_OFFSET UNITYSDK_OFFSET(0x10AD4F50)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_METHOD_5_737220D2233A9067_OFFSET UNITYSDK_OFFSET(0x10AD9860)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_METHOD_5_813C8FDB3E66B6BF_OFFSET UNITYSDK_OFFSET(0x10AD5D80)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_METHOD_5_83E361AE37D8A749_OFFSET UNITYSDK_OFFSET(0x10AD5B90)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_METHOD_5_E11AC65AA0DC2249_OFFSET UNITYSDK_OFFSET(0x10AD5610)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_METHOD_5_E16066A129C758CD_OFFSET UNITYSDK_OFFSET(0x10AD5F70)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_METHOD_5_E402C04CEC1622AF_OFFSET UNITYSDK_OFFSET(0x10AD6900)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_METHOD_5_E67B8EE7D04609D0_OFFSET UNITYSDK_OFFSET(0x10AD4E60)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_METHOD_5_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0x10AD6790)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_METHOD_5_EC90259991730611_OFFSET UNITYSDK_OFFSET(0x10AD5840)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x10AD7FF0)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_STARTHOTRELOADSERVER_OFFSET UNITYSDK_OFFSET(0x10AD51E0)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_START_OFFSET UNITYSDK_OFFSET(0x10AD6010)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_STOPHOTRELOADSERVER_OFFSET UNITYSDK_OFFSET(0x10AD54F0)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_TURNLIGHT_OFFSET UNITYSDK_OFFSET(0x10AD9960)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x10AD6590)
#define IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x10AD9BF0)

namespace IRIClusterBuilder::Test
{
	inline static constexpr unsigned int IRICarTestManager_TypeDefinitionIndex = 37674;
	...
	public:
		...
		{
			return (::IRIClusterBuilder::Test::IRICarTestManager**)Il2CppClass::FromTypeDefinitionIndex(IRICarTestManager_TypeDefinitionIndex)->GetStaticField(0x43C00);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + IRICLUSTERBUILDER_TEST_IRICARTESTMANAGER_METHOD_5_E11AC65AA0DC2249_OFFSET))(this);
		}
