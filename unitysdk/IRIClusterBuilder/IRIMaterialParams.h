...
#define IRICLUSTERBUILDER_IRIMATERIALPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x10AD40B0)

namespace IRIClusterBuilder
{
	inline static constexpr unsigned int IRIMaterialParams_TypeDefinitionIndex = 37660;
