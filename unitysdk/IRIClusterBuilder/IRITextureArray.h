...
#define IRICLUSTERBUILDER_IRITEXTUREARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x10AD4E40)

namespace IRIClusterBuilder
{
	inline static constexpr unsigned int IRITextureArray_TypeDefinitionIndex = 37667;
