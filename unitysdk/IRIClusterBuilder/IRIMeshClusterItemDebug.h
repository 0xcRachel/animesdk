...
#define IRICLUSTERBUILDER_IRIMESHCLUSTERITEMDEBUG__CTOR_OFFSET UNITYSDK_OFFSET(0x10AD4DA0)

namespace IRIClusterBuilder
{
	inline static constexpr unsigned int IRIMeshClusterItemDebug_TypeDefinitionIndex = 37664;
