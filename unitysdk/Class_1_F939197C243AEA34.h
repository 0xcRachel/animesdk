...
#define CLASS_1_F939197C243AEA34_CLEAR_OFFSET UNITYSDK_OFFSET(0x19062A90)
#define CLASS_1_F939197C243AEA34__CTOR_OFFSET UNITYSDK_OFFSET(0x19062B10)
...
public:
	...
	::Class_1_16B880A4F3B9C288* Field_1_1; // 0x18
