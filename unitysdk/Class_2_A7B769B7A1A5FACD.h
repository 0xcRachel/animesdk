...
#define CLASS_2_A7B769B7A1A5FACD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCD1F4A0)
#define CLASS_2_A7B769B7A1A5FACD_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xCD1F4E0)
#define CLASS_2_A7B769B7A1A5FACD_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xCD1F5D0)
#define CLASS_2_A7B769B7A1A5FACD_TICK_OFFSET UNITYSDK_OFFSET(0xCD1F620)
#define CLASS_2_A7B769B7A1A5FACD__CTOR_OFFSET UNITYSDK_OFFSET(0xCD1F490)
