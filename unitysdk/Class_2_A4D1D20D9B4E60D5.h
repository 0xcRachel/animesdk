...
#define CLASS_2_A4D1D20D9B4E60D5_DISPOSE_OFFSET UNITYSDK_OFFSET(0x85797A0)
#define CLASS_2_A4D1D20D9B4E60D5_METHOD_2_3CDD0248353333ED_OFFSET UNITYSDK_OFFSET(0x8579830)
#define CLASS_2_A4D1D20D9B4E60D5_METHOD_2_F7300E87EC49A206_OFFSET UNITYSDK_OFFSET(0x8579600)
#define CLASS_2_A4D1D20D9B4E60D5_METHOD_2_FB92C5E10C2076F0_OFFSET UNITYSDK_OFFSET(0x8579890)
#define CLASS_2_A4D1D20D9B4E60D5_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x85795B0)
#define CLASS_2_A4D1D20D9B4E60D5_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x85796F0)
#define CLASS_2_A4D1D20D9B4E60D5_TICK_OFFSET UNITYSDK_OFFSET(0x8579740)
#define CLASS_2_A4D1D20D9B4E60D5__CTOR_OFFSET UNITYSDK_OFFSET(0x85795A0)

inline static constexpr unsigned int Class_2_A4D1D20D9B4E60D5_TypeDefinitionIndex = 46389;

class Class_2_A4D1D20D9B4E60D5 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TriggerLeaveChessRogue* Field_2_0; // 0x18
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::Boolean))((::PBYTE)hIl2Cpp + CLASS_2_A4D1D20D9B4E60D5_METHOD_2_3CDD0248353333ED_OFFSET))(this, a1);
	}
