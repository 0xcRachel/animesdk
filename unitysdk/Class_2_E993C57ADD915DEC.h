...
#define CLASS_2_E993C57ADD915DEC_GET_NEEDTICK_OFFSET UNITYSDK_OFFSET(0x1196D4C0)
#define CLASS_2_E993C57ADD915DEC_METHOD_2_13DF26DF0C119634_OFFSET UNITYSDK_OFFSET(0x1196D4D0)
#define CLASS_2_E993C57ADD915DEC_METHOD_2_1622EF55C818E85D_1_OFFSET UNITYSDK_OFFSET(0x1196D720)
#define CLASS_2_E993C57ADD915DEC_METHOD_2_1622EF55C818E85D_OFFSET UNITYSDK_OFFSET(0x1196D850)
#define CLASS_2_E993C57ADD915DEC_METHOD_2_18B9B03FE50F05CA_OFFSET UNITYSDK_OFFSET(0x1196DC40)
#define CLASS_2_E993C57ADD915DEC_METHOD_2_49C06B1CBEC6567D_OFFSET UNITYSDK_OFFSET(0x1196D980)
#define CLASS_2_E993C57ADD915DEC_METHOD_2_6E520D7D4D494BBE_OFFSET UNITYSDK_OFFSET(0x1196D200)
#define CLASS_2_E993C57ADD915DEC_METHOD_2_7F5A09121F2469EC_1_OFFSET UNITYSDK_OFFSET(0x1196E8E0)
#define CLASS_2_E993C57ADD915DEC_METHOD_2_7F5A09121F2469EC_2_OFFSET UNITYSDK_OFFSET(0x1196EAC0)
#define CLASS_2_E993C57ADD915DEC_METHOD_2_7F5A09121F2469EC_3_OFFSET UNITYSDK_OFFSET(0x1196ECA0)
#define CLASS_2_E993C57ADD915DEC_METHOD_2_7F5A09121F2469EC_OFFSET UNITYSDK_OFFSET(0x1196E700)
#define CLASS_2_E993C57ADD915DEC_METHOD_2_B1445E8504415D4D_OFFSET UNITYSDK_OFFSET(0x1196EE80)
#define CLASS_2_E993C57ADD915DEC_METHOD_2_B7F8E0B4AF22DEA3_OFFSET UNITYSDK_OFFSET(0x1196E570)
#define CLASS_2_E993C57ADD915DEC_ONINIT_OFFSET UNITYSDK_OFFSET(0x1196C970)
#define CLASS_2_E993C57ADD915DEC_ONUNINIT_OFFSET UNITYSDK_OFFSET(0x1196CE10)
#define CLASS_2_E993C57ADD915DEC__CCTOR_OFFSET UNITYSDK_OFFSET(0x1196EEA0)
#define CLASS_2_E993C57ADD915DEC__CTOR_OFFSET UNITYSDK_OFFSET(0x1196EE90)
#define CLASS_2_E993C57ADD915DEC___IFIXBASEPROXY_ONINIT_OFFSET UNITYSDK_OFFSET(0x1196EF50)
#define CLASS_2_E993C57ADD915DEC___IFIXBASEPROXY_ONUNINIT_OFFSET UNITYSDK_OFFSET(0x1196EFB0)
...
public:
	...
	{
		return (::Il2CppArray<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_E993C57ADD915DEC_TypeDefinitionIndex)->GetStaticField(0x48D10);
	}
	static ::Il2CppArray<::UnityEngine::Collider*>** StaticGet_Field_2_3()
	{
		return (::Il2CppArray<::UnityEngine::Collider*>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_E993C57ADD915DEC_TypeDefinitionIndex)->GetStaticField(0x48D18);
	}
	// static const ::System::UInt32 Field_2_5 = 0x5C0224; // 0x0
	::RPG::GameCore::GameEntity* Field_2_1; // 0x20
	::Struct_2_7734F33592BF49F6 Field_2_2; // 0x28
	...
	{
		return ((::System::Boolean(*)(::PVOID, ::UnityEngine::Vector3))((::PBYTE)hIl2Cpp + CLASS_2_E993C57ADD915DEC_METHOD_2_18B9B03FE50F05CA_OFFSET))(this, a1);
	}
