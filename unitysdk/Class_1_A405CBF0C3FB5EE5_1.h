...
#define CLASS_1_A405CBF0C3FB5EE5_1_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19C98190)
#define CLASS_1_A405CBF0C3FB5EE5_1_CLONE_OFFSET UNITYSDK_OFFSET(0x19C97D20)
#define CLASS_1_A405CBF0C3FB5EE5_1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19C97E80)
#define CLASS_1_A405CBF0C3FB5EE5_1_EQUALS_OFFSET UNITYSDK_OFFSET(0x19C97DA0)
#define CLASS_1_A405CBF0C3FB5EE5_1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19C97F50)
#define CLASS_1_A405CBF0C3FB5EE5_1_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19C98360)
#define CLASS_1_A405CBF0C3FB5EE5_1_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19C982B0)
#define CLASS_1_A405CBF0C3FB5EE5_1_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x19C97D60)
#define CLASS_1_A405CBF0C3FB5EE5_1_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x19C97D50)
#define CLASS_1_A405CBF0C3FB5EE5_1_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19C97BD0)
#define CLASS_1_A405CBF0C3FB5EE5_1_METHOD_1_686CBC4FBD0AAA58_OFFSET UNITYSDK_OFFSET(0x19C97D90)
#define CLASS_1_A405CBF0C3FB5EE5_1_METHOD_1_6BD2A2909D8CFAD3_OFFSET UNITYSDK_OFFSET(0x19C97D80)
#define CLASS_1_A405CBF0C3FB5EE5_1_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x19C97D70)
#define CLASS_1_A405CBF0C3FB5EE5_1_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19C97C00)
#define CLASS_1_A405CBF0C3FB5EE5_1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19C98060)
#define CLASS_1_A405CBF0C3FB5EE5_1_WRITETO_OFFSET UNITYSDK_OFFSET(0x19C980C0)
#define CLASS_1_A405CBF0C3FB5EE5_1__CCTOR_OFFSET UNITYSDK_OFFSET(0x19C98480)
#define CLASS_1_A405CBF0C3FB5EE5_1__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19C97C60)
#define CLASS_1_A405CBF0C3FB5EE5_1__CTOR_OFFSET UNITYSDK_OFFSET(0x19C97C10)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_A405CBF0C3FB5EE5_1*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A405CBF0C3FB5EE5_1_TypeDefinitionIndex)->GetStaticField(0x3CE80);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_3()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A405CBF0C3FB5EE5_1_TypeDefinitionIndex)->GetStaticField(0x3CE88);
	}
