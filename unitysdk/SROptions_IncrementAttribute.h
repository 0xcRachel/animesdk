...
#define SROPTIONS_INCREMENTATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x82B2590)

inline static constexpr unsigned int SROptions_IncrementAttribute_TypeDefinitionIndex = 34159;
