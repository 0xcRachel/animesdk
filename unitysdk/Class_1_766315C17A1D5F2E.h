...
#define CLASS_1_766315C17A1D5F2E_CLEAR_OFFSET UNITYSDK_OFFSET(0x16A71F20)
#define CLASS_1_766315C17A1D5F2E_GETUNEVALUATEDNEXTSTATE_OFFSET UNITYSDK_OFFSET(0x16A723E0)
#define CLASS_1_766315C17A1D5F2E_GETUNITYANIMATOR_OFFSET UNITYSDK_OFFSET(0x16A72470)
#define CLASS_1_766315C17A1D5F2E_GET_ANIMATORMOVECALLBACKORDER_OFFSET UNITYSDK_OFFSET(0x16A724B0)
#define CLASS_1_766315C17A1D5F2E_GET_ANIMATORNOTINIT_OFFSET UNITYSDK_OFFSET(0x16A72350)
#define CLASS_1_766315C17A1D5F2E_GET_DYNAMICANIMEVENTDATALIST_OFFSET UNITYSDK_OFFSET(0x16A723B0)
#define CLASS_1_766315C17A1D5F2E_GET_ENABLEANIMATORMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x16A724C0)
#define CLASS_1_766315C17A1D5F2E_GET_NEEDRESETEVENT_OFFSET UNITYSDK_OFFSET(0x16A72370)
#define CLASS_1_766315C17A1D5F2E_GET_ONANIMATIONSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x16A72390)
#define CLASS_1_766315C17A1D5F2E_GET_ONANIMATORMOVECALLBACKMAP_OFFSET UNITYSDK_OFFSET(0x16A723D0)
#define CLASS_1_766315C17A1D5F2E_GET_REENTRYCOUNTER_OFFSET UNITYSDK_OFFSET(0x16A72330)
#define CLASS_1_766315C17A1D5F2E_GET_TASKCONTEXT_OFFSET UNITYSDK_OFFSET(0x16A722A0)
#define CLASS_1_766315C17A1D5F2E_GET_WORLDREF_OFFSET UNITYSDK_OFFSET(0x16A72270)
#define CLASS_1_766315C17A1D5F2E_METHOD_1_0C2F125F54C32BE5_OFFSET UNITYSDK_OFFSET(0x16A71BA0)
#define CLASS_1_766315C17A1D5F2E_METHOD_1_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x16A721D0)
#define CLASS_1_766315C17A1D5F2E_METHOD_1_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x16A722C0)
#define CLASS_1_766315C17A1D5F2E_METHOD_1_892D0C7F01734DAA_OFFSET UNITYSDK_OFFSET(0x16A71D70)
#define CLASS_1_766315C17A1D5F2E_METHOD_1_AC6344B47CF49F47_OFFSET UNITYSDK_OFFSET(0x16A71E50)
#define CLASS_1_766315C17A1D5F2E_METHOD_1_B1445E8504415D4D_OFFSET UNITYSDK_OFFSET(0x16A72290)
#define CLASS_1_766315C17A1D5F2E_METHOD_1_FAC3436B3B22B430_OFFSET UNITYSDK_OFFSET(0x16A72100)
#define CLASS_1_766315C17A1D5F2E_ONANIMATORMOVE_OFFSET UNITYSDK_OFFSET(0x16A724D0)
#define CLASS_1_766315C17A1D5F2E_QUERYSTATENORAMLIZEDSTARTTIME_OFFSET UNITYSDK_OFFSET(0x16A72420)
#define CLASS_1_766315C17A1D5F2E_SET_ANIMATORNOTINIT_OFFSET UNITYSDK_OFFSET(0x16A72360)
#define CLASS_1_766315C17A1D5F2E_SET_DYNAMICANIMEVENTDATALIST_OFFSET UNITYSDK_OFFSET(0x16A723C0)
#define CLASS_1_766315C17A1D5F2E_SET_NEEDRESETEVENT_OFFSET UNITYSDK_OFFSET(0x16A72380)
#define CLASS_1_766315C17A1D5F2E_SET_ONANIMATIONSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x16A723A0)
#define CLASS_1_766315C17A1D5F2E_SET_REENTRYCOUNTER_OFFSET UNITYSDK_OFFSET(0x16A72340)
#define CLASS_1_766315C17A1D5F2E_SET_TASKCONTEXT_OFFSET UNITYSDK_OFFSET(0x16A722B0)
#define CLASS_1_766315C17A1D5F2E_SET_WORLDREF_OFFSET UNITYSDK_OFFSET(0x16A72280)
#define CLASS_1_766315C17A1D5F2E__CCTOR_OFFSET UNITYSDK_OFFSET(0x16A727E0)
#define CLASS_1_766315C17A1D5F2E__CTOR_OFFSET UNITYSDK_OFFSET(0x16A726E0)

inline static constexpr unsigned int Class_1_766315C17A1D5F2E_TypeDefinitionIndex = 71854;
...
public:
	...
	{
		return (::Unity::Profiling::ProfilerMarkerWithObject*)Il2CppClass::FromTypeDefinitionIndex(Class_1_766315C17A1D5F2E_TypeDefinitionIndex)->GetStaticField(0x10340);
	}
	::RPG::GameCore::TaskContext* _TaskContext_k__BackingField; // 0x10
	::System::Collections::Generic::Dictionary_2<::System::String*, ::Class_0_16E4307DCC419505_405_Class_3_410EEB4A0F592FBB*>* _OnAnimatorMoveCallbackMap_k__BackingField; // 0x18
	::Entitas::IEntity* Field_1_3; // 0x20
	::Struct_2_2B16FFFF87B43037 Field_1_4; // 0x28
	::UnityEngine::Animator* Field_1_5; // 0x38
	::Il2CppArray<::System::String*>* Field_1_6; // 0x40
	::System::Collections::Generic::List_1<::Class_1_38A5D85D4AE9F24D*>* _DynamicAnimEventDataList_k__BackingField; // 0x48
	::Il2CppArray<::System::String*>* Field_1_8; // 0x50
	::Class_1_FD7BA687A1A99180* Field_1_9; // 0x58
	::RPG::GameCore::GameEntity* Field_1_10; // 0x60
	::Class_0_16E4307DCC419505_405_Class_3_363670394F299996* _OnAnimationStateChange_k__BackingField; // 0x68
	::RPG::GameCore::GameWorld* _WorldRef_k__BackingField; // 0x70
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_0_16E4307DCC419505_96*>* Field_1_13; // 0x78
