...
#define STRUCT_2_EDE247AF05B200CA_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x73670)
#define STRUCT_2_EDE247AF05B200CA_EQUALS_OFFSET UNITYSDK_OFFSET(0x735F0)
#define STRUCT_2_EDE247AF05B200CA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x73680)
...
#define STRUCT_2_EDE247AF05B200CA__CTOR_OFFSET UNITYSDK_OFFSET(0x735E0)
#define STRUCT_2_EDE247AF05B200CA___IFIXBASEPROXY_EQUALS_OFFSET UNITYSDK_OFFSET(0x736F0)
#define STRUCT_2_EDE247AF05B200CA___IFIXBASEPROXY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x73760)

inline static constexpr unsigned int Struct_2_EDE247AF05B200CA_TypeDefinitionIndex = 40936;
