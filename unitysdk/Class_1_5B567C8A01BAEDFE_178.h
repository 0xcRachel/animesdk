...
#define CLASS_1_5B567C8A01BAEDFE_178_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A3B5270)
#define CLASS_1_5B567C8A01BAEDFE_178_CLONE_OFFSET UNITYSDK_OFFSET(0x1A3B5080)
#define CLASS_1_5B567C8A01BAEDFE_178_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A3B5180)
#define CLASS_1_5B567C8A01BAEDFE_178_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A3B50F0)
#define CLASS_1_5B567C8A01BAEDFE_178_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A3B51D0)
#define CLASS_1_5B567C8A01BAEDFE_178_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A3B52C0)
#define CLASS_1_5B567C8A01BAEDFE_178_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A3B5290)
#define CLASS_1_5B567C8A01BAEDFE_178_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A3B4FD0)
#define CLASS_1_5B567C8A01BAEDFE_178_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A3B5030)
#define CLASS_1_5B567C8A01BAEDFE_178_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A3B5200)
#define CLASS_1_5B567C8A01BAEDFE_178_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A3B5260)
#define CLASS_1_5B567C8A01BAEDFE_178__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A3B5310)
#define CLASS_1_5B567C8A01BAEDFE_178__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3B5050)
#define CLASS_1_5B567C8A01BAEDFE_178__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3B5040)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_178*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_178_TypeDefinitionIndex)->GetStaticField(0x4B800);
	}
