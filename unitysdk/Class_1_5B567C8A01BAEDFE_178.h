...
#define CLASS_1_5B567C8A01BAEDFE_178_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A48BE20)
#define CLASS_1_5B567C8A01BAEDFE_178_CLONE_OFFSET UNITYSDK_OFFSET(0x1A48BC90)
#define CLASS_1_5B567C8A01BAEDFE_178_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A48BD30)
#define CLASS_1_5B567C8A01BAEDFE_178_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A48BCD0)
#define CLASS_1_5B567C8A01BAEDFE_178_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A48BD80)
#define CLASS_1_5B567C8A01BAEDFE_178_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A48BE70)
#define CLASS_1_5B567C8A01BAEDFE_178_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A48BE40)
#define CLASS_1_5B567C8A01BAEDFE_178_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A48BC10)
#define CLASS_1_5B567C8A01BAEDFE_178_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A48BC40)
#define CLASS_1_5B567C8A01BAEDFE_178_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A48BDB0)
#define CLASS_1_5B567C8A01BAEDFE_178_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A48BE10)
#define CLASS_1_5B567C8A01BAEDFE_178__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A48BEC0)
#define CLASS_1_5B567C8A01BAEDFE_178__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A48BC60)
#define CLASS_1_5B567C8A01BAEDFE_178__CTOR_OFFSET UNITYSDK_OFFSET(0x1A48BC50)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_178*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_178_TypeDefinitionIndex)->GetStaticField(0x175B0);
	}
