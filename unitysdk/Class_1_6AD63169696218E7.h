...
#define CLASS_1_6AD63169696218E7_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A118740)
#define CLASS_1_6AD63169696218E7_CLONE_OFFSET UNITYSDK_OFFSET(0x1A1181B0)
#define CLASS_1_6AD63169696218E7_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A118260)
#define CLASS_1_6AD63169696218E7_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A118230)
#define CLASS_1_6AD63169696218E7_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A1183B0)
#define CLASS_1_6AD63169696218E7_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A118A00)
#define CLASS_1_6AD63169696218E7_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A118880)
#define CLASS_1_6AD63169696218E7_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x1A118210)
#define CLASS_1_6AD63169696218E7_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A117FA0)
#define CLASS_1_6AD63169696218E7_METHOD_1_6E1EC2DF63D7020F_1_OFFSET UNITYSDK_OFFSET(0x1A118200)
#define CLASS_1_6AD63169696218E7_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x1A1181E0)
#define CLASS_1_6AD63169696218E7_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x1A118220)
#define CLASS_1_6AD63169696218E7_METHOD_1_EA98AC27B86895E5_OFFSET UNITYSDK_OFFSET(0x1A1181F0)
#define CLASS_1_6AD63169696218E7_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A117FD0)
#define CLASS_1_6AD63169696218E7_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A1185A0)
#define CLASS_1_6AD63169696218E7_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A118600)
#define CLASS_1_6AD63169696218E7__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A118B90)
#define CLASS_1_6AD63169696218E7__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A118060)
#define CLASS_1_6AD63169696218E7__CTOR_OFFSET UNITYSDK_OFFSET(0x1A117FE0)
...
public:
	...
	{
		return (::Google::Protobuf::Collections::MapField_2_Codec<::System::UInt32, ::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6AD63169696218E7_TypeDefinitionIndex)->GetStaticField(0x3ADE0);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_6AD63169696218E7*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_6AD63169696218E7*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6AD63169696218E7_TypeDefinitionIndex)->GetStaticField(0x3ADE8);
	}
	static ::Google::Protobuf::FieldCodec_1<::Class_1_D1E0AD3915BCCF29_105*>** StaticGet_Field_1_3()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_D1E0AD3915BCCF29_105*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6AD63169696218E7_TypeDefinitionIndex)->GetStaticField(0x3ADF0);
	}
	static ::Google::Protobuf::FieldCodec_1<::Class_1_D17272E82AE804C2_806*>** StaticGet_Field_1_9()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_D17272E82AE804C2_806*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6AD63169696218E7_TypeDefinitionIndex)->GetStaticField(0x3ADF8);
	}
	...
	::Class_1_D17272E82AE804C2_805* Field_1_12; // 0x18
	::Google::Protobuf::UnknownFieldSet* Field_1_1; // 0x20
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_D1E0AD3915BCCF29_105*>* Field_1_4; // 0x28
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_D17272E82AE804C2_806*>* Field_1_10; // 0x30
