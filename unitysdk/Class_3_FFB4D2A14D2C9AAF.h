...
#define CLASS_3_FFB4D2A14D2C9AAF_METHOD_3_11B65C8014633802_OFFSET UNITYSDK_OFFSET(0x15C97AB0)
#define CLASS_3_FFB4D2A14D2C9AAF_ONCLEAR_OFFSET UNITYSDK_OFFSET(0x15C97BE0)
#define CLASS_3_FFB4D2A14D2C9AAF_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x15C97B40)
#define CLASS_3_FFB4D2A14D2C9AAF__CTOR_OFFSET UNITYSDK_OFFSET(0x15C97C50)
#define CLASS_3_FFB4D2A14D2C9AAF___IFIXBASEPROXY_ONCLEAR_OFFSET UNITYSDK_OFFSET(0x15C97CC0)
#define CLASS_3_FFB4D2A14D2C9AAF___IFIXBASEPROXY_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x15C97C60)

inline static constexpr unsigned int Class_3_FFB4D2A14D2C9AAF_TypeDefinitionIndex = 72692;
