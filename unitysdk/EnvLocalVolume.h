...
#define ENVLOCALVOLUME_GETENVIROMENTPROFILESLIST_OFFSET UNITYSDK_OFFSET(0xFB8DE10)
#define ENVLOCALVOLUME_GETENVIROMENTPROFILE_OFFSET UNITYSDK_OFFSET(0xFB8DDD0)
#define ENVLOCALVOLUME_GETINSIDE_OFFSET UNITYSDK_OFFSET(0xFB8E1A0)
#define ENVLOCALVOLUME_METHOD_6_193E00E83BC3E6E8_OFFSET UNITYSDK_OFFSET(0xFB8DF50)
#define ENVLOCALVOLUME_METHOD_6_3FEC31896EE03459_OFFSET UNITYSDK_OFFSET(0xFB8DFD0)
#define ENVLOCALVOLUME_METHOD_6_7131FDE42F1B27F4_OFFSET UNITYSDK_OFFSET(0xFB8E110)
#define ENVLOCALVOLUME_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xFB8DF00)
#define ENVLOCALVOLUME_ONENABLE_OFFSET UNITYSDK_OFFSET(0xFB8DEB0)
#define ENVLOCALVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0xFB8E560)
