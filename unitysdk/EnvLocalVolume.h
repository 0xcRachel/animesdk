...
#define ENVLOCALVOLUME_GETENVIROMENTPROFILESLIST_OFFSET UNITYSDK_OFFSET(0xC31DD90)
#define ENVLOCALVOLUME_GETENVIROMENTPROFILE_OFFSET UNITYSDK_OFFSET(0xC31DD50)
#define ENVLOCALVOLUME_GETINSIDE_OFFSET UNITYSDK_OFFSET(0xC31E120)
#define ENVLOCALVOLUME_METHOD_6_193E00E83BC3E6E8_OFFSET UNITYSDK_OFFSET(0xC31DED0)
#define ENVLOCALVOLUME_METHOD_6_3FEC31896EE03459_OFFSET UNITYSDK_OFFSET(0xC31DF50)
#define ENVLOCALVOLUME_METHOD_6_7131FDE42F1B27F4_OFFSET UNITYSDK_OFFSET(0xC31E090)
#define ENVLOCALVOLUME_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC31DE80)
#define ENVLOCALVOLUME_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC31DE30)
#define ENVLOCALVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0xC31E4E0)
