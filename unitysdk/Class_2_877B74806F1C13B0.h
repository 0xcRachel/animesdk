...
#define CLASS_2_877B74806F1C13B0_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9941B70)
#define CLASS_2_877B74806F1C13B0_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x9941BB0)
#define CLASS_2_877B74806F1C13B0_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x9941C30)
#define CLASS_2_877B74806F1C13B0_TICK_OFFSET UNITYSDK_OFFSET(0x9941C80)
#define CLASS_2_877B74806F1C13B0__CTOR_OFFSET UNITYSDK_OFFSET(0x9941B60)

inline static constexpr unsigned int Class_2_877B74806F1C13B0_TypeDefinitionIndex = 42126;

class Class_2_877B74806F1C13B0 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::SwitchHandShowPuzzleFinishToast* Field_2_0; // 0x20
