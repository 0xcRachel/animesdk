...
#define EFFECT_LIQUID_METHOD_5_18C814F7EBE15C92_OFFSET UNITYSDK_OFFSET(0xDEE4CE0)
#define EFFECT_LIQUID_METHOD_5_35A1A641353400E6_OFFSET UNITYSDK_OFFSET(0xDEE5BA0)
#define EFFECT_LIQUID_METHOD_5_6BA807A89A617D97_OFFSET UNITYSDK_OFFSET(0xDEE4D70)
#define EFFECT_LIQUID_METHOD_5_8CA88D55ECEFAD59_1_OFFSET UNITYSDK_OFFSET(0xDEE4B90)
#define EFFECT_LIQUID_METHOD_5_8CA88D55ECEFAD59_OFFSET UNITYSDK_OFFSET(0xDEE4A00)
#define EFFECT_LIQUID_METHOD_5_C0ED0C6E5E939750_OFFSET UNITYSDK_OFFSET(0xDEE5A20)
#define EFFECT_LIQUID_START_OFFSET UNITYSDK_OFFSET(0xDEE49B0)
#define EFFECT_LIQUID_UPDATE_OFFSET UNITYSDK_OFFSET(0xDEE4E80)
#define EFFECT_LIQUID__CTOR_OFFSET UNITYSDK_OFFSET(0xDEE5E10)

inline static constexpr unsigned int Effect_Liquid_TypeDefinitionIndex = 37353;
