...
#define CLASS_2_47B96B4A8C7B4A85_DISPOSE_OFFSET UNITYSDK_OFFSET(0x843A340)
#define CLASS_2_47B96B4A8C7B4A85_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x843A390)
#define CLASS_2_47B96B4A8C7B4A85_METHOD_2_8131D4D8C02BAA62_OFFSET UNITYSDK_OFFSET(0x843A800)
#define CLASS_2_47B96B4A8C7B4A85_ONSKIP_OFFSET UNITYSDK_OFFSET(0x843A3A0)
#define CLASS_2_47B96B4A8C7B4A85_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x843A8A0)
#define CLASS_2_47B96B4A8C7B4A85_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x843AAB0)
#define CLASS_2_47B96B4A8C7B4A85_TICK_OFFSET UNITYSDK_OFFSET(0x843A540)
#define CLASS_2_47B96B4A8C7B4A85__CTOR_OFFSET UNITYSDK_OFFSET(0x843A330)

inline static constexpr unsigned int Class_2_47B96B4A8C7B4A85_TypeDefinitionIndex = 41595;
...
public:
	...
	::RPG::Client::MonoClockParkStoryCharacter* Field_2_2; // 0x20
