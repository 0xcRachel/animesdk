...
#define CLASS_2_4B12DF909ABFF25F_DISPOSE_OFFSET UNITYSDK_OFFSET(0x12676BA0)
#define CLASS_2_4B12DF909ABFF25F_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x12676BE0)
#define CLASS_2_4B12DF909ABFF25F_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x12676C40)
#define CLASS_2_4B12DF909ABFF25F_TICK_OFFSET UNITYSDK_OFFSET(0x12676C90)
#define CLASS_2_4B12DF909ABFF25F__CTOR_OFFSET UNITYSDK_OFFSET(0x12676B90)
...
{
public:
	::RPG::GameCore::ShowBattleEventTips* Field_2_0; // 0x18
