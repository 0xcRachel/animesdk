...
#define CLASS_1_C222160220C38EC4_GET_ASSISTSCORE_OFFSET UNITYSDK_OFFSET(0x162908D0)
#define CLASS_1_C222160220C38EC4_GET_AVATARLIST_OFFSET UNITYSDK_OFFSET(0x162908B0)
#define CLASS_1_C222160220C38EC4_GET_BATTLEREPLAYKEY_OFFSET UNITYSDK_OFFSET(0x16290890)
#define CLASS_1_C222160220C38EC4_GET_DAMAGEHP_OFFSET UNITYSDK_OFFSET(0x16290830)
#define CLASS_1_C222160220C38EC4_GET_DAMAGESCORE_OFFSET UNITYSDK_OFFSET(0x162908F0)
#define CLASS_1_C222160220C38EC4_GET_FINALHITSCORE_OFFSET UNITYSDK_OFFSET(0x16290910)
#define CLASS_1_C222160220C38EC4_GET_ISFINALHIT_OFFSET UNITYSDK_OFFSET(0x16290850)
#define CLASS_1_C222160220C38EC4_GET_OVERKILLDAMAGEHP_OFFSET UNITYSDK_OFFSET(0x16290870)
#define CLASS_1_C222160220C38EC4_GET_UID_OFFSET UNITYSDK_OFFSET(0x16290810)
#define CLASS_1_C222160220C38EC4_METHOD_1_A85A5A4F484E8E77_OFFSET UNITYSDK_OFFSET(0x16290720)
#define CLASS_1_C222160220C38EC4_METHOD_1_E07A4E6DDA4C1AF7_OFFSET UNITYSDK_OFFSET(0x16290350)
#define CLASS_1_C222160220C38EC4_SET_ASSISTSCORE_OFFSET UNITYSDK_OFFSET(0x162908E0)
#define CLASS_1_C222160220C38EC4_SET_AVATARLIST_OFFSET UNITYSDK_OFFSET(0x162908C0)
#define CLASS_1_C222160220C38EC4_SET_BATTLEREPLAYKEY_OFFSET UNITYSDK_OFFSET(0x162908A0)
#define CLASS_1_C222160220C38EC4_SET_DAMAGEHP_OFFSET UNITYSDK_OFFSET(0x16290840)
#define CLASS_1_C222160220C38EC4_SET_DAMAGESCORE_OFFSET UNITYSDK_OFFSET(0x16290900)
#define CLASS_1_C222160220C38EC4_SET_FINALHITSCORE_OFFSET UNITYSDK_OFFSET(0x16290920)
#define CLASS_1_C222160220C38EC4_SET_ISFINALHIT_OFFSET UNITYSDK_OFFSET(0x16290860)
#define CLASS_1_C222160220C38EC4_SET_OVERKILLDAMAGEHP_OFFSET UNITYSDK_OFFSET(0x16290880)
#define CLASS_1_C222160220C38EC4_SET_UID_OFFSET UNITYSDK_OFFSET(0x16290820)
#define CLASS_1_C222160220C38EC4__CTOR_OFFSET UNITYSDK_OFFSET(0x16290800)
...
public:
	...
	::System::Collections::Generic::List_1<::Class_1_54D5CCE1D19D93EF_1*>* _AvatarList_k__BackingField; // 0x18
	::System::UInt32 _Uid_k__BackingField; // 0x20
	::System::UInt32 _DamageHp_k__BackingField; // 0x24
	::System::UInt32 _AssistScore_k__BackingField; // 0x28
	::System::Boolean _IsFinalHit_k__BackingField; // 0x2C
	::System::UInt32 _OverKillDamageHp_k__BackingField; // 0x30
