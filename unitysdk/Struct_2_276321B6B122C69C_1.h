...
#define STRUCT_2_276321B6B122C69C_1_DECONSTRUCT_OFFSET UNITYSDK_OFFSET(0x3753AD0)
#define STRUCT_2_276321B6B122C69C_1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x6C5D00)
#define STRUCT_2_276321B6B122C69C_1_EQUALS_OFFSET UNITYSDK_OFFSET(0x3833D60)
#define STRUCT_2_276321B6B122C69C_1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x37539B0)
#define STRUCT_2_276321B6B122C69C_1_GET_ID_OFFSET UNITYSDK_OFFSET(0x72BBF0)
#define STRUCT_2_276321B6B122C69C_1_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x72B7E0)
#define STRUCT_2_276321B6B122C69C_1_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x17C6B0B0)
#define STRUCT_2_276321B6B122C69C_1_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x17C6AF90)
#define STRUCT_2_276321B6B122C69C_1_PRINTMEMBERS_OFFSET UNITYSDK_OFFSET(0x3833D40)
#define STRUCT_2_276321B6B122C69C_1_SET_ID_OFFSET UNITYSDK_OFFSET(0xA18540)
#define STRUCT_2_276321B6B122C69C_1_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0xFD2470)
#define STRUCT_2_276321B6B122C69C_1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3833D30)
#define STRUCT_2_276321B6B122C69C_1__CTOR_OFFSET UNITYSDK_OFFSET(0x6BD370)
