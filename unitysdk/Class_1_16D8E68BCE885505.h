...
#define CLASS_1_16D8E68BCE885505_GET_ADVENTUREPLAYERID_OFFSET UNITYSDK_OFFSET(0x10E5E1A0)
#define CLASS_1_16D8E68BCE885505_GET_AICONFIGPATH_OFFSET UNITYSDK_OFFSET(0x10E5E2E0)
#define CLASS_1_16D8E68BCE885505_GET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0x10E5E120)
#define CLASS_1_16D8E68BCE885505_GET_ENGLISHNAME_OFFSET UNITYSDK_OFFSET(0x10E5E160)
#define CLASS_1_16D8E68BCE885505_GET_EXPGROUP_OFFSET UNITYSDK_OFFSET(0x10E5E240)
#define CLASS_1_16D8E68BCE885505_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x10E5E0F0)
#define CLASS_1_16D8E68BCE885505_GET_JSONCONFIGPATH_OFFSET UNITYSDK_OFFSET(0x10E5E1E0)
#define CLASS_1_16D8E68BCE885505_GET_MAXPROMOTIONLEVEL_OFFSET UNITYSDK_OFFSET(0x10E5E260)
#define CLASS_1_16D8E68BCE885505_GET_MAXRANK_OFFSET UNITYSDK_OFFSET(0x10E5E280)
#define CLASS_1_16D8E68BCE885505_GET_MAXSP_OFFSET UNITYSDK_OFFSET(0x10E5E220)
#define CLASS_1_16D8E68BCE885505_GET_NAME_OFFSET UNITYSDK_OFFSET(0x10E5E140)
#define CLASS_1_16D8E68BCE885505_GET_NATUREID_OFFSET UNITYSDK_OFFSET(0x10E5E200)
#define CLASS_1_16D8E68BCE885505_GET_PATH_OFFSET UNITYSDK_OFFSET(0x10E5E100)
#define CLASS_1_16D8E68BCE885505_GET_RANKIDS_OFFSET UNITYSDK_OFFSET(0x10E5E2A0)
#define CLASS_1_16D8E68BCE885505_GET_RARITY_OFFSET UNITYSDK_OFFSET(0x10E5E1C0)
#define CLASS_1_16D8E68BCE885505_GET_SKILLIDS_OFFSET UNITYSDK_OFFSET(0x10E5E2C0)
#define CLASS_1_16D8E68BCE885505_GET_SPECIALULTRASKILLENERGYLACKTIPS_OFFSET UNITYSDK_OFFSET(0x10E5E360)
#define CLASS_1_16D8E68BCE885505_GET_SPECIALULTRASKILLRESOURCEPATH_OFFSET UNITYSDK_OFFSET(0x10E5E340)
#define CLASS_1_16D8E68BCE885505_GET_TRACETREEPREFABPATH_OFFSET UNITYSDK_OFFSET(0x10E5E300)
#define CLASS_1_16D8E68BCE885505_GET_ULTRASKILLTYPE_OFFSET UNITYSDK_OFFSET(0x10E5E320)
#define CLASS_1_16D8E68BCE885505_GET_VOTAG_OFFSET UNITYSDK_OFFSET(0x10E5E180)
#define CLASS_1_16D8E68BCE885505_SET_ADVENTUREPLAYERID_OFFSET UNITYSDK_OFFSET(0x10E5E1B0)
#define CLASS_1_16D8E68BCE885505_SET_AICONFIGPATH_OFFSET UNITYSDK_OFFSET(0x10E5E2F0)
#define CLASS_1_16D8E68BCE885505_SET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0x10E5E130)
#define CLASS_1_16D8E68BCE885505_SET_ENGLISHNAME_OFFSET UNITYSDK_OFFSET(0x10E5E170)
#define CLASS_1_16D8E68BCE885505_SET_EXPGROUP_OFFSET UNITYSDK_OFFSET(0x10E5E250)
#define CLASS_1_16D8E68BCE885505_SET_JSONCONFIGPATH_OFFSET UNITYSDK_OFFSET(0x10E5E1F0)
#define CLASS_1_16D8E68BCE885505_SET_MAXPROMOTIONLEVEL_OFFSET UNITYSDK_OFFSET(0x10E5E270)
#define CLASS_1_16D8E68BCE885505_SET_MAXRANK_OFFSET UNITYSDK_OFFSET(0x10E5E290)
#define CLASS_1_16D8E68BCE885505_SET_MAXSP_OFFSET UNITYSDK_OFFSET(0x10E5E230)
#define CLASS_1_16D8E68BCE885505_SET_NAME_OFFSET UNITYSDK_OFFSET(0x10E5E150)
#define CLASS_1_16D8E68BCE885505_SET_NATUREID_OFFSET UNITYSDK_OFFSET(0x10E5E210)
#define CLASS_1_16D8E68BCE885505_SET_PATH_OFFSET UNITYSDK_OFFSET(0x10E5E110)
#define CLASS_1_16D8E68BCE885505_SET_RANKIDS_OFFSET UNITYSDK_OFFSET(0x10E5E2B0)
#define CLASS_1_16D8E68BCE885505_SET_RARITY_OFFSET UNITYSDK_OFFSET(0x10E5E1D0)
#define CLASS_1_16D8E68BCE885505_SET_SKILLIDS_OFFSET UNITYSDK_OFFSET(0x10E5E2D0)
#define CLASS_1_16D8E68BCE885505_SET_SPECIALULTRASKILLENERGYLACKTIPS_OFFSET UNITYSDK_OFFSET(0x10E5E370)
#define CLASS_1_16D8E68BCE885505_SET_SPECIALULTRASKILLRESOURCEPATH_OFFSET UNITYSDK_OFFSET(0x10E5E350)
#define CLASS_1_16D8E68BCE885505_SET_TRACETREEPREFABPATH_OFFSET UNITYSDK_OFFSET(0x10E5E310)
#define CLASS_1_16D8E68BCE885505_SET_ULTRASKILLTYPE_OFFSET UNITYSDK_OFFSET(0x10E5E330)
#define CLASS_1_16D8E68BCE885505_SET_VOTAG_OFFSET UNITYSDK_OFFSET(0x10E5E190)
#define CLASS_1_16D8E68BCE885505__CTOR_OFFSET UNITYSDK_OFFSET(0x10E5E380)

inline static constexpr unsigned int Class_1_16D8E68BCE885505_TypeDefinitionIndex = 40952;

class Class_1_16D8E68BCE885505 : public ::System::Object
{
public:
	::System::String* _AIConfigPath_k__BackingField; // 0x10
	::Class_1_E2F5AEB140BB7868* _DamageType_k__BackingField; // 0x18
	::System::String* _JsonConfigPath_k__BackingField; // 0x20
	::System::String* _SpecialUltraSkillResourcePath_k__BackingField; // 0x28
	::Il2CppArray<::System::UInt32>* _SkillIDs_k__BackingField; // 0x30
	::Class_1_68A7E1D93E15255C* _Path_k__BackingField; // 0x38
	::System::String* _TraceTreePrefabPath_k__BackingField; // 0x40
	::System::String* _VOTag_k__BackingField; // 0x48
	::Il2CppArray<::System::UInt32>* _RankIDs_k__BackingField; // 0x50
	::RPG::Client::TextID _SpecialUltraSkillEnergyLackTips_k__BackingField; // 0x58
	::System::UInt32 _ExpGroup_k__BackingField; // 0x68
	::RPG::GameCore::AvatarSpecialUltraType _UltraSkillType_k__BackingField; // 0x6C
	::RPG::GameCore::CombatPowerAvatarRarityType _Rarity_k__BackingField; // 0x70
	::System::UInt32 _MaxRank_k__BackingField; // 0x74
	::System::UInt32 _NatureID_k__BackingField; // 0x78
	::Struct_2_BC950E36747FB4C9 _Identifier_k__BackingField; // 0x7C
	::System::UInt32 _AdventurePlayerID_k__BackingField; // 0x84
	::System::UInt32 _MaxPromotionLevel_k__BackingField; // 0x88
	::RPG::Client::TextID _Name_k__BackingField; // 0x90
	::RPG::GameCore::FixPoint _MaxSP_k__BackingField; // 0xA0
	::RPG::Client::TextID _EnglishName_k__BackingField; // 0xA8
