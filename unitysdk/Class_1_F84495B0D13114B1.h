...
#define CLASS_1_F84495B0D13114B1_DISPOSE_OFFSET UNITYSDK_OFFSET(0x84A3A80)
#define CLASS_1_F84495B0D13114B1_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x84A3B00)
#define CLASS_1_F84495B0D13114B1__CTOR_OFFSET UNITYSDK_OFFSET(0x84A3B60)

inline static constexpr unsigned int Class_1_F84495B0D13114B1_TypeDefinitionIndex = 61814;

class Class_1_F84495B0D13114B1 : public ::System::Object
{
public:
	::Class_1_16CA124888A687A8* Field_1_0; // 0x10
	::RPG::Client::Prop::DestroyRootPuzzleBlockType Field_1_2; // 0x18
	::UnityEngine::Vector2Int Field_1_3; // 0x1C
	::UnityEngine::Vector2Int Field_1_1; // 0x24
