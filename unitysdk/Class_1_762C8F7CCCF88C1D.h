...
#define CLASS_1_762C8F7CCCF88C1D_GET_ADDCOIN_OFFSET UNITYSDK_OFFSET(0x104B2FA0)
#define CLASS_1_762C8F7CCCF88C1D_GET_DAMAGEINFOS_OFFSET UNITYSDK_OFFSET(0x104B2FE0)
#define CLASS_1_762C8F7CCCF88C1D_GET_ISWIN_OFFSET UNITYSDK_OFFSET(0x104B2F80)
#define CLASS_1_762C8F7CCCF88C1D_GET_SOLDIERDEADCNT_OFFSET UNITYSDK_OFFSET(0x104B2FC0)
#define CLASS_1_762C8F7CCCF88C1D_SET_ADDCOIN_OFFSET UNITYSDK_OFFSET(0x104B2FB0)
#define CLASS_1_762C8F7CCCF88C1D_SET_DAMAGEINFOS_OFFSET UNITYSDK_OFFSET(0x104B2FF0)
#define CLASS_1_762C8F7CCCF88C1D_SET_ISWIN_OFFSET UNITYSDK_OFFSET(0x104B2F90)
#define CLASS_1_762C8F7CCCF88C1D_SET_SOLDIERDEADCNT_OFFSET UNITYSDK_OFFSET(0x104B2FD0)
#define CLASS_1_762C8F7CCCF88C1D__CTOR_OFFSET UNITYSDK_OFFSET(0x104B2F60)

inline static constexpr unsigned int Class_1_762C8F7CCCF88C1D_TypeDefinitionIndex = 62075;
