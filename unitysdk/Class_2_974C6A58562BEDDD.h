...
#define CLASS_2_974C6A58562BEDDD_CLEARSERVERCACHE_OFFSET UNITYSDK_OFFSET(0x99EFDD0)
#define CLASS_2_974C6A58562BEDDD_GETSERVERBLOCKMANIFESTNAME_OFFSET UNITYSDK_OFFSET(0x99EFBB0)
#define CLASS_2_974C6A58562BEDDD_GETTYPENAME_OFFSET UNITYSDK_OFFSET(0x99EF790)
#define CLASS_2_974C6A58562BEDDD_GET_BASEABSOLUTEPATH_OFFSET UNITYSDK_OFFSET(0x99EF810)
#define CLASS_2_974C6A58562BEDDD_GET_BLOCKMANIFESTNAME_OFFSET UNITYSDK_OFFSET(0x99EF980)
#define CLASS_2_974C6A58562BEDDD_GET_BLOCKVERSIONNAME_OFFSET UNITYSDK_OFFSET(0x99EF970)
#define CLASS_2_974C6A58562BEDDD_GET_BUNDLEMANIFESTNAME_OFFSET UNITYSDK_OFFSET(0x99EF960)
#define CLASS_2_974C6A58562BEDDD_GET_BUNDLEVERSIONNAME_OFFSET UNITYSDK_OFFSET(0x99EF950)
#define CLASS_2_974C6A58562BEDDD_GET_DEFAULTABSOLUTEPATH_OFFSET UNITYSDK_OFFSET(0x99EF7E0)
#define CLASS_2_974C6A58562BEDDD_GET_ISENABLE_OFFSET UNITYSDK_OFFSET(0x99EF990)
#define CLASS_2_974C6A58562BEDDD_GET_RELATIVEPATH_OFFSET UNITYSDK_OFFSET(0x99EF920)
#define CLASS_2_974C6A58562BEDDD_METHOD_2_1F55D6FEF27052D4_OFFSET UNITYSDK_OFFSET(0x99EF9B0)
#define CLASS_2_974C6A58562BEDDD_METHOD_2_346F1B59FFBBF26A_OFFSET UNITYSDK_OFFSET(0x99EFFE0)
#define CLASS_2_974C6A58562BEDDD_METHOD_2_4DF4D9162AD406FC_OFFSET UNITYSDK_OFFSET(0x99EFE70)
#define CLASS_2_974C6A58562BEDDD_METHOD_2_726FF441D405FD0E_OFFSET UNITYSDK_OFFSET(0x99EFA80)
#define CLASS_2_974C6A58562BEDDD_METHOD_2_A27577C98E9715A0_OFFSET UNITYSDK_OFFSET(0x99F0290)
#define CLASS_2_974C6A58562BEDDD_METHOD_2_E815DACFC7B4951E_OFFSET UNITYSDK_OFFSET(0x99F0200)
#define CLASS_2_974C6A58562BEDDD_ONALLSUCCEED_OFFSET UNITYSDK_OFFSET(0x99F04D0)
#define CLASS_2_974C6A58562BEDDD_ONENUMBLOCKITEMS_OFFSET UNITYSDK_OFFSET(0x99EFF50)
#define CLASS_2_974C6A58562BEDDD_RESET_OFFSET UNITYSDK_OFFSET(0x99EFD00)
#define CLASS_2_974C6A58562BEDDD_SET_ISENABLE_OFFSET UNITYSDK_OFFSET(0x99EF9A0)
#define CLASS_2_974C6A58562BEDDD__CTOR_OFFSET UNITYSDK_OFFSET(0x99F05D0)
#define CLASS_2_974C6A58562BEDDD__LOADINDEXINFO_OFFSET UNITYSDK_OFFSET(0x99EFB60)
#define CLASS_2_974C6A58562BEDDD___IFIXBASEPROXY_CLEARSERVERCACHE_OFFSET UNITYSDK_OFFSET(0x99F06F0)
#define CLASS_2_974C6A58562BEDDD___IFIXBASEPROXY_GETSERVERBLOCKMANIFESTNAME_OFFSET UNITYSDK_OFFSET(0x99F0610)
#define CLASS_2_974C6A58562BEDDD___IFIXBASEPROXY_GET_BASEABSOLUTEPATH_OFFSET UNITYSDK_OFFSET(0x99F0600)
#define CLASS_2_974C6A58562BEDDD___IFIXBASEPROXY_ONENUMBLOCKITEMS_OFFSET UNITYSDK_OFFSET(0x99F0790)
#define CLASS_2_974C6A58562BEDDD___IFIXBASEPROXY_RESET_OFFSET UNITYSDK_OFFSET(0x99F0620)
