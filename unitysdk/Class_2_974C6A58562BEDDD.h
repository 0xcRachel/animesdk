...
#define CLASS_2_974C6A58562BEDDD_CLEARSERVERCACHE_OFFSET UNITYSDK_OFFSET(0x152C8030)
#define CLASS_2_974C6A58562BEDDD_GETSERVERBLOCKMANIFESTNAME_OFFSET UNITYSDK_OFFSET(0x152C7E10)
#define CLASS_2_974C6A58562BEDDD_GETTYPENAME_OFFSET UNITYSDK_OFFSET(0x152C79F0)
#define CLASS_2_974C6A58562BEDDD_GET_BASEABSOLUTEPATH_OFFSET UNITYSDK_OFFSET(0x152C7A70)
#define CLASS_2_974C6A58562BEDDD_GET_BLOCKMANIFESTNAME_OFFSET UNITYSDK_OFFSET(0x152C7BE0)
#define CLASS_2_974C6A58562BEDDD_GET_BLOCKVERSIONNAME_OFFSET UNITYSDK_OFFSET(0x152C7BD0)
#define CLASS_2_974C6A58562BEDDD_GET_BUNDLEMANIFESTNAME_OFFSET UNITYSDK_OFFSET(0x152C7BC0)
#define CLASS_2_974C6A58562BEDDD_GET_BUNDLEVERSIONNAME_OFFSET UNITYSDK_OFFSET(0x152C7BB0)
#define CLASS_2_974C6A58562BEDDD_GET_DEFAULTABSOLUTEPATH_OFFSET UNITYSDK_OFFSET(0x152C7A40)
#define CLASS_2_974C6A58562BEDDD_GET_ISENABLE_OFFSET UNITYSDK_OFFSET(0x152C7BF0)
#define CLASS_2_974C6A58562BEDDD_GET_RELATIVEPATH_OFFSET UNITYSDK_OFFSET(0x152C7B80)
#define CLASS_2_974C6A58562BEDDD_METHOD_2_1F55D6FEF27052D4_OFFSET UNITYSDK_OFFSET(0x152C7C10)
#define CLASS_2_974C6A58562BEDDD_METHOD_2_346F1B59FFBBF26A_OFFSET UNITYSDK_OFFSET(0x152C8210)
#define CLASS_2_974C6A58562BEDDD_METHOD_2_4DF4D9162AD406FC_OFFSET UNITYSDK_OFFSET(0x152C80D0)
#define CLASS_2_974C6A58562BEDDD_METHOD_2_726FF441D405FD0E_OFFSET UNITYSDK_OFFSET(0x152C7CE0)
#define CLASS_2_974C6A58562BEDDD_METHOD_2_A27577C98E9715A0_OFFSET UNITYSDK_OFFSET(0x152C84C0)
#define CLASS_2_974C6A58562BEDDD_METHOD_2_E815DACFC7B4951E_OFFSET UNITYSDK_OFFSET(0x152C8430)
#define CLASS_2_974C6A58562BEDDD_ONALLSUCCEED_OFFSET UNITYSDK_OFFSET(0x152C8700)
#define CLASS_2_974C6A58562BEDDD_ONENUMBLOCKITEMS_OFFSET UNITYSDK_OFFSET(0x152C8180)
#define CLASS_2_974C6A58562BEDDD_RESET_OFFSET UNITYSDK_OFFSET(0x152C7F60)
#define CLASS_2_974C6A58562BEDDD_SET_ISENABLE_OFFSET UNITYSDK_OFFSET(0x152C7C00)
#define CLASS_2_974C6A58562BEDDD__CTOR_OFFSET UNITYSDK_OFFSET(0x152C8800)
#define CLASS_2_974C6A58562BEDDD__LOADINDEXINFO_OFFSET UNITYSDK_OFFSET(0x152C7DC0)
#define CLASS_2_974C6A58562BEDDD___IFIXBASEPROXY_CLEARSERVERCACHE_OFFSET UNITYSDK_OFFSET(0x152C8920)
#define CLASS_2_974C6A58562BEDDD___IFIXBASEPROXY_GETSERVERBLOCKMANIFESTNAME_OFFSET UNITYSDK_OFFSET(0x152C8840)
#define CLASS_2_974C6A58562BEDDD___IFIXBASEPROXY_GET_BASEABSOLUTEPATH_OFFSET UNITYSDK_OFFSET(0x152C8830)
#define CLASS_2_974C6A58562BEDDD___IFIXBASEPROXY_ONENUMBLOCKITEMS_OFFSET UNITYSDK_OFFSET(0x152C89C0)
#define CLASS_2_974C6A58562BEDDD___IFIXBASEPROXY_RESET_OFFSET UNITYSDK_OFFSET(0x152C8850)
