...
#define CLASS_1_88EBDD9953F3B5A7_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1B0C2DE0)
#define CLASS_1_88EBDD9953F3B5A7_CLONE_OFFSET UNITYSDK_OFFSET(0x1B0C2A20)
#define CLASS_1_88EBDD9953F3B5A7_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1B0C2BE0)
#define CLASS_1_88EBDD9953F3B5A7_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B0C2B20)
#define CLASS_1_88EBDD9953F3B5A7_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B0C2C90)
#define CLASS_1_88EBDD9953F3B5A7_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1B0C3010)
#define CLASS_1_88EBDD9953F3B5A7_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1B0C2F70)
#define CLASS_1_88EBDD9953F3B5A7_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1B0C2AC0)
#define CLASS_1_88EBDD9953F3B5A7_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x1B0C2B00)
#define CLASS_1_88EBDD9953F3B5A7_METHOD_1_4C4B9DFE092840D4_OFFSET UNITYSDK_OFFSET(0x1B0C2AF0)
#define CLASS_1_88EBDD9953F3B5A7_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1B0C2940)
#define CLASS_1_88EBDD9953F3B5A7_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1B0C2AD0)
#define CLASS_1_88EBDD9953F3B5A7_METHOD_1_7ADD5F1F5E247E3B_OFFSET UNITYSDK_OFFSET(0x1B0C2AE0)
#define CLASS_1_88EBDD9953F3B5A7_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x1B0C2B10)
#define CLASS_1_88EBDD9953F3B5A7_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1B0C2970)
#define CLASS_1_88EBDD9953F3B5A7_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B0C2CE0)
#define CLASS_1_88EBDD9953F3B5A7_WRITETO_OFFSET UNITYSDK_OFFSET(0x1B0C2D40)
#define CLASS_1_88EBDD9953F3B5A7__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B0C31D0)
#define CLASS_1_88EBDD9953F3B5A7__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B0C2990)
#define CLASS_1_88EBDD9953F3B5A7__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C2980)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_88EBDD9953F3B5A7*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_88EBDD9953F3B5A7_TypeDefinitionIndex)->GetStaticField(0x2F9A0);
	}
