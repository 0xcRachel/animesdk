...
#define CLASS_1_5B567C8A01BAEDFE_41_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A1C6A60)
#define CLASS_1_5B567C8A01BAEDFE_41_CLONE_OFFSET UNITYSDK_OFFSET(0x1A1C6870)
#define CLASS_1_5B567C8A01BAEDFE_41_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A1C6970)
#define CLASS_1_5B567C8A01BAEDFE_41_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A1C68E0)
#define CLASS_1_5B567C8A01BAEDFE_41_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A1C69C0)
#define CLASS_1_5B567C8A01BAEDFE_41_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A1C6AB0)
#define CLASS_1_5B567C8A01BAEDFE_41_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A1C6A80)
#define CLASS_1_5B567C8A01BAEDFE_41_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A1C67C0)
#define CLASS_1_5B567C8A01BAEDFE_41_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A1C6820)
#define CLASS_1_5B567C8A01BAEDFE_41_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A1C69F0)
#define CLASS_1_5B567C8A01BAEDFE_41_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A1C6A50)
#define CLASS_1_5B567C8A01BAEDFE_41__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1C6B00)
#define CLASS_1_5B567C8A01BAEDFE_41__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A1C6840)
#define CLASS_1_5B567C8A01BAEDFE_41__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1C6830)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_41*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_41_TypeDefinitionIndex)->GetStaticField(0x1CEB0);
	}
