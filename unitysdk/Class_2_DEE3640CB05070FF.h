...
#define CLASS_2_DEE3640CB05070FF_DELETEKEY_OFFSET UNITYSDK_OFFSET(0x192AA590)
#define CLASS_2_DEE3640CB05070FF_FLUSH_OFFSET UNITYSDK_OFFSET(0x192A9FA0)
#define CLASS_2_DEE3640CB05070FF_GET_ISPARTIALSAVE_OFFSET UNITYSDK_OFFSET(0x192AA5A0)
#define CLASS_2_DEE3640CB05070FF_LOAD_OFFSET UNITYSDK_OFFSET(0x192A9A80)
#define CLASS_2_DEE3640CB05070FF__CTOR_OFFSET UNITYSDK_OFFSET(0x19284070)
