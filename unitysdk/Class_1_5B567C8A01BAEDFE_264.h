...
#define CLASS_1_5B567C8A01BAEDFE_264_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19BC2E60)
#define CLASS_1_5B567C8A01BAEDFE_264_CLONE_OFFSET UNITYSDK_OFFSET(0x19BC2C70)
#define CLASS_1_5B567C8A01BAEDFE_264_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19BC2D70)
#define CLASS_1_5B567C8A01BAEDFE_264_EQUALS_OFFSET UNITYSDK_OFFSET(0x19BC2CE0)
#define CLASS_1_5B567C8A01BAEDFE_264_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19BC2DC0)
#define CLASS_1_5B567C8A01BAEDFE_264_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19BC2EB0)
#define CLASS_1_5B567C8A01BAEDFE_264_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19BC2E80)
#define CLASS_1_5B567C8A01BAEDFE_264_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19BC2BC0)
#define CLASS_1_5B567C8A01BAEDFE_264_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19BC2C20)
#define CLASS_1_5B567C8A01BAEDFE_264_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19BC2DF0)
#define CLASS_1_5B567C8A01BAEDFE_264_WRITETO_OFFSET UNITYSDK_OFFSET(0x19BC2E50)
#define CLASS_1_5B567C8A01BAEDFE_264__CCTOR_OFFSET UNITYSDK_OFFSET(0x19BC2F00)
#define CLASS_1_5B567C8A01BAEDFE_264__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19BC2C40)
#define CLASS_1_5B567C8A01BAEDFE_264__CTOR_OFFSET UNITYSDK_OFFSET(0x19BC2C30)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_264*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_264_TypeDefinitionIndex)->GetStaticField(0x20620);
	}
