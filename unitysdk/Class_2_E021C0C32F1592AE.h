...
#define CLASS_2_E021C0C32F1592AE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8792C90)
#define CLASS_2_E021C0C32F1592AE_METHOD_2_7DD84EAFF333A1E4_OFFSET UNITYSDK_OFFSET(0x8792F00)
#define CLASS_2_E021C0C32F1592AE_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x8792D20)
#define CLASS_2_E021C0C32F1592AE_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x8792E50)
#define CLASS_2_E021C0C32F1592AE_TICK_OFFSET UNITYSDK_OFFSET(0x8792EA0)
#define CLASS_2_E021C0C32F1592AE__CTOR_OFFSET UNITYSDK_OFFSET(0x8792C10)

inline static constexpr unsigned int Class_2_E021C0C32F1592AE_TypeDefinitionIndex = 46500;
