...
#define CLASS_2_A439DD16FC7D149C_DISPOSE_OFFSET UNITYSDK_OFFSET(0x89770B0)
#define CLASS_2_A439DD16FC7D149C_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x8977140)
#define CLASS_2_A439DD16FC7D149C_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x8977300)
#define CLASS_2_A439DD16FC7D149C_TICK_OFFSET UNITYSDK_OFFSET(0x8977350)
#define CLASS_2_A439DD16FC7D149C__CTOR_OFFSET UNITYSDK_OFFSET(0x8976F80)

inline static constexpr unsigned int Class_2_A439DD16FC7D149C_TypeDefinitionIndex = 46486;
...
public:
	...
	::RPG::GameCore::WaitForWithTaskList* Field_2_0; // 0x30
