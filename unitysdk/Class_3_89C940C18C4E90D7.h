...
#define CLASS_3_89C940C18C4E90D7_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x942ED80)
#define CLASS_3_89C940C18C4E90D7__CTOR_OFFSET UNITYSDK_OFFSET(0x942ED50)

inline static constexpr unsigned int Class_3_89C940C18C4E90D7_TypeDefinitionIndex = 42811;
