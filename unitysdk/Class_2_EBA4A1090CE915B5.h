...
#define CLASS_2_EBA4A1090CE915B5_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB900280)
#define CLASS_2_EBA4A1090CE915B5_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB900320)
#define CLASS_2_EBA4A1090CE915B5_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB9003D0)
#define CLASS_2_EBA4A1090CE915B5_TICK_OFFSET UNITYSDK_OFFSET(0xB9002C0)
#define CLASS_2_EBA4A1090CE915B5__CTOR_OFFSET UNITYSDK_OFFSET(0xB900270)

inline static constexpr unsigned int Class_2_EBA4A1090CE915B5_TypeDefinitionIndex = 42225;

class Class_2_EBA4A1090CE915B5 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::TravelShipResetState* Field_2_0; // 0x20
