...
#define CLASS_2_EBA4A1090CE915B5_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1077A980)
#define CLASS_2_EBA4A1090CE915B5_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1077AA20)
#define CLASS_2_EBA4A1090CE915B5_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1077AAD0)
#define CLASS_2_EBA4A1090CE915B5_TICK_OFFSET UNITYSDK_OFFSET(0x1077A9C0)
#define CLASS_2_EBA4A1090CE915B5__CTOR_OFFSET UNITYSDK_OFFSET(0x1077A970)
