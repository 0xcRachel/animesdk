...
#define CLASS_1_5B567C8A01BAEDFE_182_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19DBECA0)
#define CLASS_1_5B567C8A01BAEDFE_182_CLONE_OFFSET UNITYSDK_OFFSET(0x19DBEB10)
#define CLASS_1_5B567C8A01BAEDFE_182_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19DBEBB0)
#define CLASS_1_5B567C8A01BAEDFE_182_EQUALS_OFFSET UNITYSDK_OFFSET(0x19DBEB50)
#define CLASS_1_5B567C8A01BAEDFE_182_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19DBEC00)
#define CLASS_1_5B567C8A01BAEDFE_182_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19DBECF0)
#define CLASS_1_5B567C8A01BAEDFE_182_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19DBECC0)
#define CLASS_1_5B567C8A01BAEDFE_182_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19DBEA90)
#define CLASS_1_5B567C8A01BAEDFE_182_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19DBEAC0)
#define CLASS_1_5B567C8A01BAEDFE_182_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19DBEC30)
#define CLASS_1_5B567C8A01BAEDFE_182_WRITETO_OFFSET UNITYSDK_OFFSET(0x19DBEC90)
#define CLASS_1_5B567C8A01BAEDFE_182__CCTOR_OFFSET UNITYSDK_OFFSET(0x19DBED40)
#define CLASS_1_5B567C8A01BAEDFE_182__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19DBEAE0)
#define CLASS_1_5B567C8A01BAEDFE_182__CTOR_OFFSET UNITYSDK_OFFSET(0x19DBEAD0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_182*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_182_TypeDefinitionIndex)->GetStaticField(0x2DBE0);
	}
