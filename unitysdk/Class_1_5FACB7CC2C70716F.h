...
#define CLASS_1_5FACB7CC2C70716F_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19F3E4E0)
#define CLASS_1_5FACB7CC2C70716F_CLONE_OFFSET UNITYSDK_OFFSET(0x19F3DFD0)
#define CLASS_1_5FACB7CC2C70716F_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19F3E170)
#define CLASS_1_5FACB7CC2C70716F_EQUALS_OFFSET UNITYSDK_OFFSET(0x19F3E090)
#define CLASS_1_5FACB7CC2C70716F_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19F3E220)
#define CLASS_1_5FACB7CC2C70716F_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19F3E790)
#define CLASS_1_5FACB7CC2C70716F_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19F3E730)
#define CLASS_1_5FACB7CC2C70716F_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x19F3E070)
#define CLASS_1_5FACB7CC2C70716F_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x19F3E030)
#define CLASS_1_5FACB7CC2C70716F_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19F3DE70)
#define CLASS_1_5FACB7CC2C70716F_METHOD_1_3DACC45AC8150727_OFFSET UNITYSDK_OFFSET(0x19F3E060)
#define CLASS_1_5FACB7CC2C70716F_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x19F3E020)
#define CLASS_1_5FACB7CC2C70716F_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x19F3E080)
#define CLASS_1_5FACB7CC2C70716F_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x19F3E040)
#define CLASS_1_5FACB7CC2C70716F_METHOD_1_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x19F3E050)
#define CLASS_1_5FACB7CC2C70716F_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19F3DED0)
#define CLASS_1_5FACB7CC2C70716F_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19F3E330)
#define CLASS_1_5FACB7CC2C70716F_WRITETO_OFFSET UNITYSDK_OFFSET(0x19F3E390)
#define CLASS_1_5FACB7CC2C70716F__CCTOR_OFFSET UNITYSDK_OFFSET(0x19F3E8A0)
#define CLASS_1_5FACB7CC2C70716F__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19F3DF30)
#define CLASS_1_5FACB7CC2C70716F__CTOR_OFFSET UNITYSDK_OFFSET(0x19F3DEE0)

inline static constexpr unsigned int Class_1_5FACB7CC2C70716F_TypeDefinitionIndex = 27666;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5FACB7CC2C70716F*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5FACB7CC2C70716F_TypeDefinitionIndex)->GetStaticField(0x4BD50);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_3()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5FACB7CC2C70716F_TypeDefinitionIndex)->GetStaticField(0x4BD58);
	}
	...
	{
		return ((::Enum_3_DB663931210BBC27_37(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_5FACB7CC2C70716F_METHOD_1_A96DCA30C6927810_OFFSET))(this);
	}

	::System::Void Method_1_3DACC45AC8150727(::Enum_3_DB663931210BBC27_37 a1)
	{
		return ((::System::Void(*)(::PVOID, ::Enum_3_DB663931210BBC27_37))((::PBYTE)hIl2Cpp + CLASS_1_5FACB7CC2C70716F_METHOD_1_3DACC45AC8150727_OFFSET))(this, a1);
	}
