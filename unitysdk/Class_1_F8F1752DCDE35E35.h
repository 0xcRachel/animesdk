...
#define CLASS_1_F8F1752DCDE35E35_DISPOSE_OFFSET UNITYSDK_OFFSET(0xE3A2490)
#define CLASS_1_F8F1752DCDE35E35_GET_INSPECIALSTATE_OFFSET UNITYSDK_OFFSET(0xE3A2470)
#define CLASS_1_F8F1752DCDE35E35_METHOD_1_0BC5386E06CF8A2C_OFFSET UNITYSDK_OFFSET(0xE3A18C0)
#define CLASS_1_F8F1752DCDE35E35_METHOD_1_169C5280D338BD7B_OFFSET UNITYSDK_OFFSET(0xE3A1D40)
#define CLASS_1_F8F1752DCDE35E35_METHOD_1_1806079A447FCB36_OFFSET UNITYSDK_OFFSET(0xE3A1610)
#define CLASS_1_F8F1752DCDE35E35_METHOD_1_2450CFC043E97F54_OFFSET UNITYSDK_OFFSET(0xE3A20D0)
#define CLASS_1_F8F1752DCDE35E35_METHOD_1_3D8F0F1C6E55B9B6_OFFSET UNITYSDK_OFFSET(0xE3A2EF0)
#define CLASS_1_F8F1752DCDE35E35_METHOD_1_3DA91C9B57824EE6_OFFSET UNITYSDK_OFFSET(0xE3A1A30)
#define CLASS_1_F8F1752DCDE35E35_METHOD_1_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0xE3A2420)
#define CLASS_1_F8F1752DCDE35E35_METHOD_1_41222BE43C0D6E56_OFFSET UNITYSDK_OFFSET(0xE3A1FC0)
#define CLASS_1_F8F1752DCDE35E35_METHOD_1_4F6CB99543AF5BF6_OFFSET UNITYSDK_OFFSET(0xE3A1E80)
#define CLASS_1_F8F1752DCDE35E35_METHOD_1_510C3C62CAC002C3_OFFSET UNITYSDK_OFFSET(0xE3A1F20)
#define CLASS_1_F8F1752DCDE35E35_METHOD_1_5757B3ADFA1F6ECF_OFFSET UNITYSDK_OFFSET(0xE3A26E0)
#define CLASS_1_F8F1752DCDE35E35_METHOD_1_5AD578FCE9CF19D4_1_OFFSET UNITYSDK_OFFSET(0xE3A21D0)
#define CLASS_1_F8F1752DCDE35E35_METHOD_1_5AD578FCE9CF19D4_2_OFFSET UNITYSDK_OFFSET(0xE3A1990)
#define CLASS_1_F8F1752DCDE35E35_METHOD_1_5AD578FCE9CF19D4_OFFSET UNITYSDK_OFFSET(0xE3A1850)
#define CLASS_1_F8F1752DCDE35E35_METHOD_1_7889E856344009E9_OFFSET UNITYSDK_OFFSET(0xE3A24F0)
#define CLASS_1_F8F1752DCDE35E35_METHOD_1_7DD84EAFF333A1E4_1_OFFSET UNITYSDK_OFFSET(0xE3A23C0)
#define CLASS_1_F8F1752DCDE35E35_METHOD_1_7DD84EAFF333A1E4_OFFSET UNITYSDK_OFFSET(0xE3A2360)
#define CLASS_1_F8F1752DCDE35E35_METHOD_1_82E78E5C348471FD_1_OFFSET UNITYSDK_OFFSET(0xE3A2240)
#define CLASS_1_F8F1752DCDE35E35_METHOD_1_82E78E5C348471FD_OFFSET UNITYSDK_OFFSET(0xE3A1E10)
#define CLASS_1_F8F1752DCDE35E35_METHOD_1_96BDC4B57CCFE000_OFFSET UNITYSDK_OFFSET(0xE3A22B0)
#define CLASS_1_F8F1752DCDE35E35_METHOD_1_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0xE3A2050)
#define CLASS_1_F8F1752DCDE35E35_METHOD_1_B12B4E4A39A083D2_OFFSET UNITYSDK_OFFSET(0xE3A2570)
#define CLASS_1_F8F1752DCDE35E35_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xE3A2F40)
#define CLASS_1_F8F1752DCDE35E35_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xE3A2EB0)
#define CLASS_1_F8F1752DCDE35E35_METHOD_1_CEDFBBF689E64233_OFFSET UNITYSDK_OFFSET(0xE3A2F90)
#define CLASS_1_F8F1752DCDE35E35_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xE3A3640)
#define CLASS_1_F8F1752DCDE35E35_SET_INSPECIALSTATE_OFFSET UNITYSDK_OFFSET(0xE3A2480)
#define CLASS_1_F8F1752DCDE35E35__CCTOR_OFFSET UNITYSDK_OFFSET(0xE3A3650)
#define CLASS_1_F8F1752DCDE35E35__CTOR_OFFSET UNITYSDK_OFFSET(0xE3A1570)
...
public:
	...
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_1_F8F1752DCDE35E35_TypeDefinitionIndex)->GetStaticField(0x4470);
	}
	::Class_2_523C55AEA55804D8* Field_1_15; // 0x10
	::Class_2_A0580152EB393340* Field_1_13; // 0x18
	::RPG::GameCore::AdventureCharacterController* Field_1_14; // 0x20
	::RPG::GameCore::AdventureCharacterController* Field_1_18; // 0x28
	::RPG::GameCore::GameEntity* Field_1_16; // 0x30
	::RPG::GameCore::TransformComponent* Field_1_12; // 0x38
	::RPG::GameCore::TransformComponent* Field_1_17; // 0x40
	::RPG::GameCore::GameEntity* Field_1_11; // 0x48
	::RPG::GameCore::FollowState Field_1_19; // 0x50
	...
	::System::Boolean Field_1_23; // 0x5C
	...
	::System::Boolean Field_1_9; // 0x7A
	::System::Boolean Field_1_1; // 0x7B
