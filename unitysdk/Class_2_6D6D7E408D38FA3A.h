...
#define CLASS_2_6D6D7E408D38FA3A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x85D8C60)
#define CLASS_2_6D6D7E408D38FA3A_METHOD_2_50DAA2D68A6C09FD_OFFSET UNITYSDK_OFFSET(0x85D9710)
#define CLASS_2_6D6D7E408D38FA3A_METHOD_2_6B268AC3E897EA46_OFFSET UNITYSDK_OFFSET(0x85D93D0)
#define CLASS_2_6D6D7E408D38FA3A_METHOD_2_96BDC4B57CCFE000_OFFSET UNITYSDK_OFFSET(0x85D9260)
#define CLASS_2_6D6D7E408D38FA3A_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x85D8D60)
#define CLASS_2_6D6D7E408D38FA3A_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x85D98D0)
#define CLASS_2_6D6D7E408D38FA3A_TICK_OFFSET UNITYSDK_OFFSET(0x85D9800)
#define CLASS_2_6D6D7E408D38FA3A__CTOR_OFFSET UNITYSDK_OFFSET(0x85D8C50)

inline static constexpr unsigned int Class_2_6D6D7E408D38FA3A_TypeDefinitionIndex = 41301;

class Class_2_6D6D7E408D38FA3A : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::AddSneakEffect* Field_2_1; // 0x18
	::RPG::GameCore::CharacterVisibleComponent* Field_2_3; // 0x20
