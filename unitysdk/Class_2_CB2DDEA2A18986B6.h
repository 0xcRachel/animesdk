...
#define CLASS_2_CB2DDEA2A18986B6_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x10CAC860)
#define CLASS_2_CB2DDEA2A18986B6_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x10CAC940)
#define CLASS_2_CB2DDEA2A18986B6_METHOD_2_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0x10CAC4E0)
#define CLASS_2_CB2DDEA2A18986B6_METHOD_2_870AF3CD1D0A67B1_OFFSET UNITYSDK_OFFSET(0x10CAC5F0)
#define CLASS_2_CB2DDEA2A18986B6_METHOD_2_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0x10CAC700)
#define CLASS_2_CB2DDEA2A18986B6_METHOD_2_A57FA722AB2A8938_OFFSET UNITYSDK_OFFSET(0x10CAC640)
#define CLASS_2_CB2DDEA2A18986B6_METHOD_2_C1C0CB2C8B6124DE_OFFSET UNITYSDK_OFFSET(0x10CAC790)
#define CLASS_2_CB2DDEA2A18986B6_VIEWPREFABPATH_OFFSET UNITYSDK_OFFSET(0x10CAC190)
#define CLASS_2_CB2DDEA2A18986B6__CTOR_OFFSET UNITYSDK_OFFSET(0x10CAC150)
#define CLASS_2_CB2DDEA2A18986B6__CUSTOMBINDVIEW_OFFSET UNITYSDK_OFFSET(0x10CAC1E0)
#define CLASS_2_CB2DDEA2A18986B6__SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x10CAC490)
#define CLASS_2_CB2DDEA2A18986B6__UNBINDVIEW_OFFSET UNITYSDK_OFFSET(0x10CAC450)
#define CLASS_2_CB2DDEA2A18986B6___IFIXBASEPROXY_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x10CACBA0)
#define CLASS_2_CB2DDEA2A18986B6___IFIXBASEPROXY_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x10CACC00)
#define CLASS_2_CB2DDEA2A18986B6___IFIXBASEPROXY_VIEWPREFABPATH_OFFSET UNITYSDK_OFFSET(0x10CAC9F0)
#define CLASS_2_CB2DDEA2A18986B6___IFIXBASEPROXY__CUSTOMBINDVIEW_OFFSET UNITYSDK_OFFSET(0x10CACA80)
#define CLASS_2_CB2DDEA2A18986B6___IFIXBASEPROXY__SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x10CACB40)
#define CLASS_2_CB2DDEA2A18986B6___IFIXBASEPROXY__UNBINDVIEW_OFFSET UNITYSDK_OFFSET(0x10CACAE0)

inline static constexpr unsigned int Class_2_CB2DDEA2A18986B6_TypeDefinitionIndex = 57156;
...
public:
	...
	::UnityEngine::UI::Image* Field_2_1; // 0x180
	::RPG::GameCore::LevelUIComponent* Field_2_2; // 0x188
