...
#define CLASS_1_138B3D83B0A9D7A8_DELTATIMEWITHIGNOREINDEX_OFFSET UNITYSDK_OFFSET(0x159F3260)
#define CLASS_1_138B3D83B0A9D7A8_DELTATIME_OFFSET UNITYSDK_OFFSET(0x159F31B0)
#define CLASS_1_138B3D83B0A9D7A8_DISPOSE_OFFSET UNITYSDK_OFFSET(0x159F36C0)
#define CLASS_1_138B3D83B0A9D7A8_FIXEDDELTATIME_OFFSET UNITYSDK_OFFSET(0x159F30A0)
#define CLASS_1_138B3D83B0A9D7A8_METHOD_1_230FE7F4B4EA88A5_OFFSET UNITYSDK_OFFSET(0x159F32E0)
#define CLASS_1_138B3D83B0A9D7A8_TIMESCALE_OFFSET UNITYSDK_OFFSET(0x159F3150)
#define CLASS_1_138B3D83B0A9D7A8__CTOR_OFFSET UNITYSDK_OFFSET(0x159F3090)

inline static constexpr unsigned int Class_1_138B3D83B0A9D7A8_TypeDefinitionIndex = 71406;
