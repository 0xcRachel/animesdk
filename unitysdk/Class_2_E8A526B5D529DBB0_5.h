...
#define CLASS_2_E8A526B5D529DBB0_5_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xD418710)
#define CLASS_2_E8A526B5D529DBB0_5_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xD4187D0)
#define CLASS_2_E8A526B5D529DBB0_5_GET_INDEX_OFFSET UNITYSDK_OFFSET(0xD4176D0)
#define CLASS_2_E8A526B5D529DBB0_5_GET_TRANS_OFFSET UNITYSDK_OFFSET(0xD4176F0)
#define CLASS_2_E8A526B5D529DBB0_5_METHOD_2_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xD417700)
#define CLASS_2_E8A526B5D529DBB0_5_METHOD_2_4481198A108EDE21_OFFSET UNITYSDK_OFFSET(0xD418630)
#define CLASS_2_E8A526B5D529DBB0_5_METHOD_2_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0xD417A00)
#define CLASS_2_E8A526B5D529DBB0_5_METHOD_2_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0xD418960)
#define CLASS_2_E8A526B5D529DBB0_5_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xD418900)
#define CLASS_2_E8A526B5D529DBB0_5_METHOD_2_6E6682ED9FD6F719_OFFSET UNITYSDK_OFFSET(0xD417C90)
#define CLASS_2_E8A526B5D529DBB0_5_METHOD_2_82E992240300FB30_OFFSET UNITYSDK_OFFSET(0xD417B10)
#define CLASS_2_E8A526B5D529DBB0_5_METHOD_2_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0xD418680)
#define CLASS_2_E8A526B5D529DBB0_5_METHOD_2_CD8EB704BDED69B6_OFFSET UNITYSDK_OFFSET(0xD418240)
#define CLASS_2_E8A526B5D529DBB0_5_METHOD_2_E5B2D19C36637166_OFFSET UNITYSDK_OFFSET(0xD417870)
#define CLASS_2_E8A526B5D529DBB0_5_SET_INDEX_OFFSET UNITYSDK_OFFSET(0xD4176E0)
#define CLASS_2_E8A526B5D529DBB0_5__CTOR_OFFSET UNITYSDK_OFFSET(0xD418870)
#define CLASS_2_E8A526B5D529DBB0_5__ONBIND_OFFSET UNITYSDK_OFFSET(0xD4172A0)
#define CLASS_2_E8A526B5D529DBB0_5___IFIXBASEPROXY_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xD4189C0)
#define CLASS_2_E8A526B5D529DBB0_5___IFIXBASEPROXY_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xD418A20)
#define CLASS_2_E8A526B5D529DBB0_5___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0xD4188A0)

inline static constexpr unsigned int Class_2_E8A526B5D529DBB0_5_TypeDefinitionIndex = 66424;
...
public:
	...
	::RPG::GameCore::LevelUIComponent* Field_2_19; // 0xC0
	::UnityEngine::Transform* Field_2_1; // 0xC8
	::UnityEngine::UI::Text* Field_2_8; // 0xD0
	::UnityEngine::UI::Image* Field_2_5; // 0xD8
	::UnityEngine::UI::Text* Field_2_14; // 0xE0
	::RPG::Client::HPBar* Field_2_16; // 0xE8
