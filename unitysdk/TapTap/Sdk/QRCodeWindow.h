...
#define TAPTAP_SDK_QRCODEWINDOW_AUTOCHECK_OFFSET UNITYSDK_OFFSET(0x17F6F460)
#define TAPTAP_SDK_QRCODEWINDOW_AWAKE_OFFSET UNITYSDK_OFFSET(0x17F6CDF0)
#define TAPTAP_SDK_QRCODEWINDOW_CHECK_OFFSET UNITYSDK_OFFSET(0x17F6ED40)
#define TAPTAP_SDK_QRCODEWINDOW_CLOSE_OFFSET UNITYSDK_OFFSET(0x17F6DDF0)
#define TAPTAP_SDK_QRCODEWINDOW_DELETEWHITE_OFFSET UNITYSDK_OFFSET(0x17F6F160)
#define TAPTAP_SDK_QRCODEWINDOW_ENCODEQRIMAGE_OFFSET UNITYSDK_OFFSET(0x17F6ED50)
#define TAPTAP_SDK_QRCODEWINDOW_GETAUTHORIZATIONHEADER_OFFSET UNITYSDK_OFFSET(0x17F6E140)
#define TAPTAP_SDK_QRCODEWINDOW_GETCODE_OFFSET UNITYSDK_OFFSET(0x17F6D9E0)
#define TAPTAP_SDK_QRCODEWINDOW_GETPROFILE_OFFSET UNITYSDK_OFFSET(0x17F6DFB0)
#define TAPTAP_SDK_QRCODEWINDOW_GET_EXTRA_OFFSET UNITYSDK_OFFSET(0x17F6CD10)
#define TAPTAP_SDK_QRCODEWINDOW_GOTOTAPTAPPAGE_OFFSET UNITYSDK_OFFSET(0x17F6DEC0)
#define TAPTAP_SDK_QRCODEWINDOW_ONENTER_OFFSET UNITYSDK_OFFSET(0x17F6D8D0)
#define TAPTAP_SDK_QRCODEWINDOW_ONEXIT_OFFSET UNITYSDK_OFFSET(0x17F6DD80)
#define TAPTAP_SDK_QRCODEWINDOW_REFRESHCODE_OFFSET UNITYSDK_OFFSET(0x17F6DF10)
#define TAPTAP_SDK_QRCODEWINDOW_SET_EXTRA_OFFSET UNITYSDK_OFFSET(0x17F6CD20)
#define TAPTAP_SDK_QRCODEWINDOW_STARTCHECK_OFFSET UNITYSDK_OFFSET(0x17F6F3E0)
#define TAPTAP_SDK_QRCODEWINDOW_STOPCHECK_OFFSET UNITYSDK_OFFSET(0x17F6F420)
#define TAPTAP_SDK_QRCODEWINDOW_UPDATE_OFFSET UNITYSDK_OFFSET(0x17F6D8C0)
#define TAPTAP_SDK_QRCODEWINDOW__CCTOR_OFFSET UNITYSDK_OFFSET(0x17F6F4E0)
#define TAPTAP_SDK_QRCODEWINDOW__CTOR_OFFSET UNITYSDK_OFFSET(0x17F6F4C0)
#define TAPTAP_SDK_QRCODEWINDOW__GETCODE_B__32_0_OFFSET UNITYSDK_OFFSET(0x17F6F560)
#define TAPTAP_SDK_QRCODEWINDOW__GETCODE_B__32_1_OFFSET UNITYSDK_OFFSET(0x17F6FD50)

namespace TapTap::Sdk
{
	inline static constexpr unsigned int QRCodeWindow_TypeDefinitionIndex = 6305;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(QRCodeWindow_TypeDefinitionIndex)->GetStaticField(0x560);
		}
		static ::System::String** StaticGet_TEXT_CLICK_TO_REFRESH()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(QRCodeWindow_TypeDefinitionIndex)->GetStaticField(0x568);
		}
		static ::System::String** StaticGet_TEXT_CONFIRM_ON_PHONE()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(QRCodeWindow_TypeDefinitionIndex)->GetStaticField(0x570);
		}
		static ::System::String** StaticGet_TEXT_PLEASE_RESCRAN()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(QRCodeWindow_TypeDefinitionIndex)->GetStaticField(0x578);
		}
