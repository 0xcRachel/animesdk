...
#define CLASS_2_FFBC8C99F6B84D8F_METHOD_2_E4EE4D98EE55C81B_OFFSET UNITYSDK_OFFSET(0x18694440)
#define CLASS_2_FFBC8C99F6B84D8F__CTOR_OFFSET UNITYSDK_OFFSET(0x18694590)
...
{
public:
	::RPG::GameCore::STDetectMoneyType Field_2_1; // 0x10
