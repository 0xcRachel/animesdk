...
#define CLASS_2_523C55AEA55804D8_DISPOSE_OFFSET UNITYSDK_OFFSET(0x110CA5E0)
#define CLASS_2_523C55AEA55804D8_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x110CBA30)
#define CLASS_2_523C55AEA55804D8_METHOD_2_124E7DAB85EAFECD_OFFSET UNITYSDK_OFFSET(0x110CD200)
#define CLASS_2_523C55AEA55804D8_METHOD_2_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x110CD2E0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_1EBA51A89D5A0DB5_OFFSET UNITYSDK_OFFSET(0x110CA6B0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_1FFE4260A7179061_OFFSET UNITYSDK_OFFSET(0x110CD420)
#define CLASS_2_523C55AEA55804D8_METHOD_2_299EFA4949973FDA_OFFSET UNITYSDK_OFFSET(0x110CB5C0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_2ABF98E64A5AC026_OFFSET UNITYSDK_OFFSET(0x110CC780)
#define CLASS_2_523C55AEA55804D8_METHOD_2_387F7E46E5E4387A_OFFSET UNITYSDK_OFFSET(0x110CB330)
#define CLASS_2_523C55AEA55804D8_METHOD_2_3A9BDB056AF13046_OFFSET UNITYSDK_OFFSET(0x110CBAB0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_3B4FCCB1316C6ED8_OFFSET UNITYSDK_OFFSET(0x110CB0F0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_3CAC93BF77250DAD_OFFSET UNITYSDK_OFFSET(0x110CD400)
#define CLASS_2_523C55AEA55804D8_METHOD_2_4AB9012B5D01108B_OFFSET UNITYSDK_OFFSET(0x110CD150)
#define CLASS_2_523C55AEA55804D8_METHOD_2_57D80B372834C5D1_OFFSET UNITYSDK_OFFSET(0x110CBD40)
#define CLASS_2_523C55AEA55804D8_METHOD_2_595E641DF1B4387D_OFFSET UNITYSDK_OFFSET(0x110CB470)
#define CLASS_2_523C55AEA55804D8_METHOD_2_7FCED9DBE84C0CF1_OFFSET UNITYSDK_OFFSET(0x110CBF70)
#define CLASS_2_523C55AEA55804D8_METHOD_2_9046EE9CC7F055C3_OFFSET UNITYSDK_OFFSET(0x110CB3D0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_B1445E8504415D4D_OFFSET UNITYSDK_OFFSET(0x110CD410)
#define CLASS_2_523C55AEA55804D8_METHOD_2_BE4EBC8FF4054312_OFFSET UNITYSDK_OFFSET(0x110CB9D0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_C0A2DE8417347362_OFFSET UNITYSDK_OFFSET(0x110CAB70)
#define CLASS_2_523C55AEA55804D8_METHOD_2_C114A1F8E08B6F92_OFFSET UNITYSDK_OFFSET(0x110CD460)
#define CLASS_2_523C55AEA55804D8_METHOD_2_C436A2848092EB88_OFFSET UNITYSDK_OFFSET(0x110CC690)
#define CLASS_2_523C55AEA55804D8_METHOD_2_C74CF020AA42ED85_1_OFFSET UNITYSDK_OFFSET(0x110CD4C0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0x110CD450)
#define CLASS_2_523C55AEA55804D8_METHOD_2_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x110CBF20)
#define CLASS_2_523C55AEA55804D8_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x110CBED0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_CAE55D2F30F9F997_OFFSET UNITYSDK_OFFSET(0x110CBBB0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_CE34EA208837238D_OFFSET UNITYSDK_OFFSET(0x110CD480)
#define CLASS_2_523C55AEA55804D8_METHOD_2_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x110CBDA0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0x110CA510)
#define CLASS_2_523C55AEA55804D8_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x110CD470)
#define CLASS_2_523C55AEA55804D8_ONMODELROOTLOADED_OFFSET UNITYSDK_OFFSET(0x110CAF00)
#define CLASS_2_523C55AEA55804D8_ONMODELROOTUNLOADED_OFFSET UNITYSDK_OFFSET(0x110CB2C0)
#define CLASS_2_523C55AEA55804D8__CCTOR_OFFSET UNITYSDK_OFFSET(0x110CD4D0)
#define CLASS_2_523C55AEA55804D8__CTOR_OFFSET UNITYSDK_OFFSET(0x110CA480)
#define CLASS_2_523C55AEA55804D8___IFIXBASEPROXY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x110CD500)

inline static constexpr unsigned int Class_2_523C55AEA55804D8_TypeDefinitionIndex = 44884;
...
public:
	...
	{
		return (::Il2CppArray<::UnityEngine::RaycastHit>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_523C55AEA55804D8_TypeDefinitionIndex)->GetStaticField(0x41C70);
	}
	static ::System::Boolean* StaticGet_Field_2_0()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_2_523C55AEA55804D8_TypeDefinitionIndex)->GetStaticField(0xF290);
	}
	// static const ::System::Single Field_2_16; // 0x0
	::Class_0_16E4307DCC419505_411* Field_2_13; // 0x18
	::Class_3_2B2F6402EA3EAA0F* Field_2_1; // 0x20
	::UnityEngine::Collider* Field_2_12; // 0x28
	::Class_1_51EED7CD291B614D* Field_2_23; // 0x30
	::System::Action* Field_2_3; // 0x38
	::System::Action* Field_2_2; // 0x40
	::RPG::GameCore::GameEntity* Field_2_14; // 0x48
	::RPG::GameCore::TransformComponent* Field_2_7; // 0x50
	::UnityEngine::Collider* Field_2_8; // 0x58
	::System::Action_2<::UnityEngine::Vector3, ::UnityEngine::Quaternion>* Field_2_4; // 0x60
	::Class_1_56FF45D7B2C55655* Field_2_24; // 0x68
	::System::Action_1<::RPG::GameCore::GameEntity*>* Field_2_19; // 0x70
	::System::Int32 Field_2_15; // 0x78
	::UnityEngine::Vector3 Field_2_22; // 0x7C
	::System::Boolean Field_2_6; // 0x88
	::System::Boolean Field_2_5; // 0x89
	::System::Boolean Field_2_20; // 0x8A
	::UnityEngine::RaycastHit Field_2_11; // 0x8C
	::System::Int32 Field_2_18; // 0xBC
	::System::Int32 Field_2_9; // 0xC0
	::UnityEngine::Vector3 Field_2_10; // 0xC4
