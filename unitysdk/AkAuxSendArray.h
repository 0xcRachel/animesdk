...
#define AKAUXSENDARRAY_ADD_1_OFFSET UNITYSDK_OFFSET(0x1837FE10)
#define AKAUXSENDARRAY_ADD_OFFSET UNITYSDK_OFFSET(0x1837FBB0)
#define AKAUXSENDARRAY_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0x183801F0)
#define AKAUXSENDARRAY_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1837FFA0)
#define AKAUXSENDARRAY_COUNT_OFFSET UNITYSDK_OFFSET(0x183806B0)
#define AKAUXSENDARRAY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1837FA50)
#define AKAUXSENDARRAY_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1837FAB0)
#define AKAUXSENDARRAY_GETBUFFER_OFFSET UNITYSDK_OFFSET(0x18380670)
#define AKAUXSENDARRAY_GETOBJECTPTR_OFFSET UNITYSDK_OFFSET(0x1837F990)
#define AKAUXSENDARRAY_GETVALUES_OFFSET UNITYSDK_OFFSET(0x183804E0)
#define AKAUXSENDARRAY_GET_ISFULL_OFFSET UNITYSDK_OFFSET(0x1837FA00)
#define AKAUXSENDARRAY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1837F8A0)
#define AKAUXSENDARRAY_RESET_OFFSET UNITYSDK_OFFSET(0x1837FB60)
#define AKAUXSENDARRAY_SETVALUES_OFFSET UNITYSDK_OFFSET(0x18380360)
#define AKAUXSENDARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1837F800)

inline static constexpr unsigned int AkAuxSendArray_TypeDefinitionIndex = 33608;
