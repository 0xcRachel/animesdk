...
#define CLASS_2_26C9DBCC8AEB0F7C_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA9C98D0)
#define CLASS_2_26C9DBCC8AEB0F7C_METHOD_2_61EC2AC0BD93363E_OFFSET UNITYSDK_OFFSET(0xA9C9B00)
#define CLASS_2_26C9DBCC8AEB0F7C_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xA9C9910)
#define CLASS_2_26C9DBCC8AEB0F7C_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xA9C9A00)
#define CLASS_2_26C9DBCC8AEB0F7C_TICK_OFFSET UNITYSDK_OFFSET(0xA9C9AA0)
#define CLASS_2_26C9DBCC8AEB0F7C__CTOR_OFFSET UNITYSDK_OFFSET(0xA9C98A0)
...
public:
	...
	::RPG::GameCore::WaitConditionString* Field_2_0; // 0x20
