...
#define CLASS_2_98CF7261B6FD45E3_DISPOSE_OFFSET UNITYSDK_OFFSET(0x877C430)
#define CLASS_2_98CF7261B6FD45E3_METHOD_2_67D41ACFEF39E84E_OFFSET UNITYSDK_OFFSET(0x877C610)
#define CLASS_2_98CF7261B6FD45E3_METHOD_2_7744894CEC41BF06_OFFSET UNITYSDK_OFFSET(0x877CE50)
#define CLASS_2_98CF7261B6FD45E3_METHOD_2_C450A961450309C9_OFFSET UNITYSDK_OFFSET(0x877CCD0)
#define CLASS_2_98CF7261B6FD45E3_METHOD_2_E52129E82CD2D7F8_OFFSET UNITYSDK_OFFSET(0x877C930)
#define CLASS_2_98CF7261B6FD45E3_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x877C530)
#define CLASS_2_98CF7261B6FD45E3_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x877CAB0)
#define CLASS_2_98CF7261B6FD45E3_TICK_OFFSET UNITYSDK_OFFSET(0x877CB90)
#define CLASS_2_98CF7261B6FD45E3__CTOR_OFFSET UNITYSDK_OFFSET(0x877C340)

inline static constexpr unsigned int Class_2_98CF7261B6FD45E3_TypeDefinitionIndex = 41606;
...
public:
	...
	::RPG::GameCore::SubMissionRow* Field_2_5; // 0x18
	::Class_3_BCCE950C2E8DF1F0* Field_2_4; // 0x20
	::Class_3_BCCE950C2E8DF1F0* Field_2_3; // 0x28
	::RPG::GameCore::ConsumeMissionItemPerformance* Field_2_0; // 0x30
