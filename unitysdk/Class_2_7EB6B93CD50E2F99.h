...
#define CLASS_2_7EB6B93CD50E2F99_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xE5C47E0)
#define CLASS_2_7EB6B93CD50E2F99_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xE5C48A0)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_06C0B66EEDBE72A8_OFFSET UNITYSDK_OFFSET(0xE5C1640)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_0837352686C2ECEC_OFFSET UNITYSDK_OFFSET(0xE5C2420)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_137119B83AB96A00_OFFSET UNITYSDK_OFFSET(0xE5C4430)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_14F3D539C275A6D3_OFFSET UNITYSDK_OFFSET(0xE5C45A0)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_213F1233DC2106C8_OFFSET UNITYSDK_OFFSET(0xE5C39C0)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_289F28027FF47717_OFFSET UNITYSDK_OFFSET(0xE5C2F70)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_3B9C56AB1AF0D588_OFFSET UNITYSDK_OFFSET(0xE5C2C20)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_3D38B90746E3FB3F_OFFSET UNITYSDK_OFFSET(0xE5C4290)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_3EDD7416F9416F69_OFFSET UNITYSDK_OFFSET(0xE5C2930)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_42A121C686C73935_OFFSET UNITYSDK_OFFSET(0xE5C32C0)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_43EA95365AF8ADDE_OFFSET UNITYSDK_OFFSET(0xE5C3AA0)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_44CE4196FD08AB6A_OFFSET UNITYSDK_OFFSET(0xE5C2300)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_478C9D82AA77A23C_OFFSET UNITYSDK_OFFSET(0xE5C34E0)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_50A46C2E1D594B5E_OFFSET UNITYSDK_OFFSET(0xE5C28A0)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_548835A4BE337BAE_OFFSET UNITYSDK_OFFSET(0xE5C3360)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xE5C4A40)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_7485CCD7E60F1CBC_OFFSET UNITYSDK_OFFSET(0xE5C3430)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_7AFA6337C157B435_OFFSET UNITYSDK_OFFSET(0xE5C41C0)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_7DFA4D0453DAD789_OFFSET UNITYSDK_OFFSET(0xE5C3740)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_7FBAA229ED524F8E_OFFSET UNITYSDK_OFFSET(0xE5C2EE0)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_8C77CC5EC838CD07_OFFSET UNITYSDK_OFFSET(0xE5C1BC0)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_9C1042B30380AA62_OFFSET UNITYSDK_OFFSET(0xE5C38A0)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_9F30F370AA7FFDB0_OFFSET UNITYSDK_OFFSET(0xE5C4690)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_A2140754BB277C2F_OFFSET UNITYSDK_OFFSET(0xE5C31F0)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0xE5C4740)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_A3C36642AA77866E_OFFSET UNITYSDK_OFFSET(0xE5C17E0)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_A4DBB07F1ECFF71E_OFFSET UNITYSDK_OFFSET(0xE5C35B0)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_A727EDC5A74B3CE3_OFFSET UNITYSDK_OFFSET(0xE5C1880)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_AC7CD4175E0A3EF8_OFFSET UNITYSDK_OFFSET(0xE5C1B60)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_AE30D8621FD9E0AB_OFFSET UNITYSDK_OFFSET(0xE5C4110)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_C37EE151D005EDA7_OFFSET UNITYSDK_OFFSET(0xE5C3B60)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_C450A961450309C9_OFFSET UNITYSDK_OFFSET(0xE5C3930)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_CCC6A3002C391211_OFFSET UNITYSDK_OFFSET(0xE5C1480)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_D1367138CEC8E0AD_OFFSET UNITYSDK_OFFSET(0xE5C1E80)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_D4684D4E31B8D8A0_OFFSET UNITYSDK_OFFSET(0xE5C26D0)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_E4D422DD274C36BD_OFFSET UNITYSDK_OFFSET(0xE5C1900)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0xE5C3010)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_FEF062A2DC4257FF_OFFSET UNITYSDK_OFFSET(0xE5C1250)
#define CLASS_2_7EB6B93CD50E2F99__CTOR_OFFSET UNITYSDK_OFFSET(0xE5C4940)
#define CLASS_2_7EB6B93CD50E2F99__ONBIND_OFFSET UNITYSDK_OFFSET(0xE5C0A50)
#define CLASS_2_7EB6B93CD50E2F99___IFIXBASEPROXY_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xE5C4AA0)
#define CLASS_2_7EB6B93CD50E2F99___IFIXBASEPROXY_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xE5C4B00)
#define CLASS_2_7EB6B93CD50E2F99___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0xE5C49E0)
#define CLASS_2_7EB6B93CD50E2F99___ONBINDHANDLERS_B__36_1_OFFSET UNITYSDK_OFFSET(0xE5C4970)

inline static constexpr unsigned int Class_2_7EB6B93CD50E2F99_TypeDefinitionIndex = 65730;
...
public:
	...
	::RPG::GameCore::LevelUIComponent* Field_2_35; // 0x78
	::UnityEngine::Transform* Field_2_11; // 0x80
	::UnityEngine::Animation* Field_2_28; // 0x88
	::UnityEngine::Transform* Field_2_8; // 0x90
	::UnityEngine::UI::Text* Field_2_14; // 0x98
	::UnityEngine::UI::Text* Field_2_17; // 0xA0
	::UnityEngine::UI::ScrollRect* Field_2_20; // 0xA8
	::RPG::Client::LocalizedText* Field_2_23; // 0xB0
	::UnityEngine::UI::Button* Field_2_29; // 0xB8
	::UnityEngine::Transform* Field_2_7; // 0xC0
	::RPG::Client::NodeListViewPanel_1<::Class_2_A12205C602394C2F*>* Field_2_27; // 0xC8
	::Class_1_DDDB57AA67C3A9EA* Field_2_31; // 0xD0
	::UnityEngine::Transform* Field_2_30; // 0xD8
	::UnityEngine::Transform* Field_2_3; // 0xE0
	::UnityEngine::UI::Text* Field_2_16; // 0xE8
	::Class_2_4BD56C05450EB359* Field_2_21; // 0xF0
	::RPG::Client::NodeListViewPanel_1<::Class_2_37D655FAABC4D43A*>* Field_2_24; // 0xF8
	::UnityEngine::Transform* Field_2_10; // 0x100
	::UnityEngine::Transform* Field_2_22; // 0x108
	::UnityEngine::Transform* Field_2_18; // 0x110
	::UnityEngine::Transform* Field_2_2; // 0x118
	::UnityEngine::Transform* Field_2_9; // 0x120
	::UnityEngine::Transform* Field_2_25; // 0x128
	::UnityEngine::RectTransform* Field_2_19; // 0x130
	::UnityEngine::Transform* Field_2_12; // 0x138
	::UnityEngine::UI::Text* Field_2_15; // 0x140
	::UnityEngine::UI::Image* Field_2_5; // 0x148
	::UnityEngine::UI::Button* Field_2_26; // 0x150
	::UnityEngine::UI::Button* Field_2_0; // 0x158
	::UnityEngine::UI::Text* Field_2_13; // 0x160
