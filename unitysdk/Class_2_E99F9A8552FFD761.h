...
#define CLASS_2_E99F9A8552FFD761_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10CDA3A0)
#define CLASS_2_E99F9A8552FFD761_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x10CDB120)
#define CLASS_2_E99F9A8552FFD761_METHOD_2_2E7C9236490EC44C_OFFSET UNITYSDK_OFFSET(0x10CDA5E0)
#define CLASS_2_E99F9A8552FFD761_METHOD_2_B67A7D5A7BB42B14_OFFSET UNITYSDK_OFFSET(0x10CDA790)
#define CLASS_2_E99F9A8552FFD761_METHOD_2_F15BB39D73E654DD_OFFSET UNITYSDK_OFFSET(0x10CDA8E0)
#define CLASS_2_E99F9A8552FFD761_ONSKIP_OFFSET UNITYSDK_OFFSET(0x10CDB130)
#define CLASS_2_E99F9A8552FFD761_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10CDA3E0)
#define CLASS_2_E99F9A8552FFD761_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10CDAAE0)
#define CLASS_2_E99F9A8552FFD761_TICK_OFFSET UNITYSDK_OFFSET(0x10CDAB40)
#define CLASS_2_E99F9A8552FFD761__CTOR_OFFSET UNITYSDK_OFFSET(0x10CDA300)

inline static constexpr unsigned int Class_2_E99F9A8552FFD761_TypeDefinitionIndex = 43656;

class Class_2_E99F9A8552FFD761 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::Class_0_16E4307DCC419505_374* Field_2_3; // 0x18
