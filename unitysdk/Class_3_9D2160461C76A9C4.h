...
#define CLASS_3_9D2160461C76A9C4_GETAPPLYSTREAMINGLAYER_OFFSET UNITYSDK_OFFSET(0x8CE0CA0)
#define CLASS_3_9D2160461C76A9C4_GETASSETPATH_OFFSET UNITYSDK_OFFSET(0x8CE0B40)
#define CLASS_3_9D2160461C76A9C4__CTOR_OFFSET UNITYSDK_OFFSET(0x8CE0B30)
#define CLASS_3_9D2160461C76A9C4___IFIXBASEPROXY_GETAPPLYSTREAMINGLAYER_OFFSET UNITYSDK_OFFSET(0x8CE0D00)
#define CLASS_3_9D2160461C76A9C4___IFIXBASEPROXY_GETASSETPATH_OFFSET UNITYSDK_OFFSET(0x8CE0CF0)

inline static constexpr unsigned int Class_3_9D2160461C76A9C4_TypeDefinitionIndex = 60503;
