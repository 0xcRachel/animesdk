...
#define CLASS_3_9D2160461C76A9C4_GETAPPLYSTREAMINGLAYER_OFFSET UNITYSDK_OFFSET(0x12458830)
#define CLASS_3_9D2160461C76A9C4_GETASSETPATH_OFFSET UNITYSDK_OFFSET(0x124586D0)
#define CLASS_3_9D2160461C76A9C4__CTOR_OFFSET UNITYSDK_OFFSET(0x124586C0)
#define CLASS_3_9D2160461C76A9C4___IFIXBASEPROXY_GETAPPLYSTREAMINGLAYER_OFFSET UNITYSDK_OFFSET(0x12458890)
#define CLASS_3_9D2160461C76A9C4___IFIXBASEPROXY_GETASSETPATH_OFFSET UNITYSDK_OFFSET(0x12458880)

inline static constexpr unsigned int Class_3_9D2160461C76A9C4_TypeDefinitionIndex = 67933;
