...
#define CLASS_3_9D2160461C76A9C4_GETAPPLYSTREAMINGLAYER_OFFSET UNITYSDK_OFFSET(0xA6B6DD0)
#define CLASS_3_9D2160461C76A9C4_GETASSETPATH_OFFSET UNITYSDK_OFFSET(0xA6B6C70)
#define CLASS_3_9D2160461C76A9C4__CTOR_OFFSET UNITYSDK_OFFSET(0xA6B6C60)
#define CLASS_3_9D2160461C76A9C4___IFIXBASEPROXY_GETAPPLYSTREAMINGLAYER_OFFSET UNITYSDK_OFFSET(0xA6B6E30)
#define CLASS_3_9D2160461C76A9C4___IFIXBASEPROXY_GETASSETPATH_OFFSET UNITYSDK_OFFSET(0xA6B6E20)

inline static constexpr unsigned int Class_3_9D2160461C76A9C4_TypeDefinitionIndex = 58760;

class Class_3_9D2160461C76A9C4 : public ::Class_2_CBDF63BA2C3715C3
{
public:
	::Class_1_DA7373FBD5F460E0* Field_3_0; // 0xC0
	::Class_1_DA7373FBD5F460E0* Field_3_1; // 0xC8
