...
#define CLASS_3_EBA8D0B1B31A7A99_DISPOSE_OFFSET UNITYSDK_OFFSET(0xF58A680)
#define CLASS_3_EBA8D0B1B31A7A99_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xF58A6E0)
#define CLASS_3_EBA8D0B1B31A7A99__CTOR_OFFSET UNITYSDK_OFFSET(0xF58A650)
#define CLASS_3_EBA8D0B1B31A7A99___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xF58ADB0)

inline static constexpr unsigned int Class_3_EBA8D0B1B31A7A99_TypeDefinitionIndex = 45754;
