...
#define CLASS_2_8F1E02E759DC4F8A_CLONE_OFFSET UNITYSDK_OFFSET(0x1052BFC0)
#define CLASS_2_8F1E02E759DC4F8A_METHOD_2_28EB11670A8E5A86_OFFSET UNITYSDK_OFFSET(0x1052BDE0)
#define CLASS_2_8F1E02E759DC4F8A_METHOD_2_735EE20B25F86BF4_OFFSET UNITYSDK_OFFSET(0x1052BCB0)
#define CLASS_2_8F1E02E759DC4F8A__CTOR_OFFSET UNITYSDK_OFFSET(0x1052C180)
#define CLASS_2_8F1E02E759DC4F8A__GETSELFINSTANCE_OFFSET UNITYSDK_OFFSET(0x1052C120)
#define CLASS_2_8F1E02E759DC4F8A___IFIXBASEPROXY_CLONE_OFFSET UNITYSDK_OFFSET(0x1052C490)
#define CLASS_2_8F1E02E759DC4F8A___IFIXBASEPROXY__GETSELFINSTANCE_OFFSET UNITYSDK_OFFSET(0x1052C520)
...
public:
	...
	::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Single>* Field_2_3; // 0xA8
	...
	::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* Field_2_6; // 0xC8
	::RPG::GameCore::GameEntity* Field_2_14; // 0xD0
	...
	::System::Collections::Generic::List_1<::Struct_2_263B64D8FC8C9763>* Field_2_11; // 0xE8
	::System::Collections::Generic::List_1<::System::UInt32>* Field_2_8; // 0xF0
	::System::Collections::Generic::List_1<::System::UInt32>* Field_2_12; // 0xF8
	::RPG::MVector3 Field_2_0; // 0x100
	::System::Boolean Field_2_4; // 0x10C
	::System::Boolean Field_2_2; // 0x10D
	::System::Boolean Field_2_13; // 0x10E
	::UnityEngine::Vector3 Field_2_17; // 0x110
	::RPG::MVector3 Field_2_1; // 0x11C
