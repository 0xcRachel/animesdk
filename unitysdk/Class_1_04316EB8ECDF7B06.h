...
#define CLASS_1_04316EB8ECDF7B06_GET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x148A5910)
#define CLASS_1_04316EB8ECDF7B06_GET_HASKEYDOWN_OFFSET UNITYSDK_OFFSET(0x148A5850)
#define CLASS_1_04316EB8ECDF7B06_GET_HASKEYUP_OFFSET UNITYSDK_OFFSET(0x148A5870)
#define CLASS_1_04316EB8ECDF7B06_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x148A5810)
#define CLASS_1_04316EB8ECDF7B06_GET_INPUTTYPE_OFFSET UNITYSDK_OFFSET(0x148A5950)
#define CLASS_1_04316EB8ECDF7B06_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x148A5830)
#define CLASS_1_04316EB8ECDF7B06_GET_KEYDOWNRESULT_OFFSET UNITYSDK_OFFSET(0x148A5890)
#define CLASS_1_04316EB8ECDF7B06_GET_KEYUPRESULT_OFFSET UNITYSDK_OFFSET(0x148A58B0)
#define CLASS_1_04316EB8ECDF7B06_GET_NOTETYPE_OFFSET UNITYSDK_OFFSET(0x148A5930)
#define CLASS_1_04316EB8ECDF7B06_GET_OWNERGROUP_OFFSET UNITYSDK_OFFSET(0x148A58D0)
#define CLASS_1_04316EB8ECDF7B06_GET_PRESSTIME_OFFSET UNITYSDK_OFFSET(0x148A5970)
#define CLASS_1_04316EB8ECDF7B06_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x148A58F0)
#define CLASS_1_04316EB8ECDF7B06_METHOD_1_0D76431CBEEBAC68_OFFSET UNITYSDK_OFFSET(0x148A4620)
#define CLASS_1_04316EB8ECDF7B06_METHOD_1_4DF98D928623DEE3_OFFSET UNITYSDK_OFFSET(0x148A4120)
#define CLASS_1_04316EB8ECDF7B06_METHOD_1_4E140453C4B32F06_OFFSET UNITYSDK_OFFSET(0x148A5050)
#define CLASS_1_04316EB8ECDF7B06_METHOD_1_A9E21AEFB7D4CB48_1_OFFSET UNITYSDK_OFFSET(0x148A55A0)
#define CLASS_1_04316EB8ECDF7B06_METHOD_1_A9E21AEFB7D4CB48_OFFSET UNITYSDK_OFFSET(0x148A4FA0)
#define CLASS_1_04316EB8ECDF7B06_METHOD_1_AAFE8DC44E675A0C_OFFSET UNITYSDK_OFFSET(0x148A5150)
#define CLASS_1_04316EB8ECDF7B06_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x148A5100)
#define CLASS_1_04316EB8ECDF7B06_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x148A50B0)
#define CLASS_1_04316EB8ECDF7B06_METHOD_1_EBB9073DE8DED836_OFFSET UNITYSDK_OFFSET(0x148A5360)
#define CLASS_1_04316EB8ECDF7B06_METHOD_1_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0x148A5790)
#define CLASS_1_04316EB8ECDF7B06_SET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x148A5920)
#define CLASS_1_04316EB8ECDF7B06_SET_HASKEYDOWN_OFFSET UNITYSDK_OFFSET(0x148A5860)
#define CLASS_1_04316EB8ECDF7B06_SET_HASKEYUP_OFFSET UNITYSDK_OFFSET(0x148A5880)
#define CLASS_1_04316EB8ECDF7B06_SET_INDEX_OFFSET UNITYSDK_OFFSET(0x148A5820)
#define CLASS_1_04316EB8ECDF7B06_SET_INPUTTYPE_OFFSET UNITYSDK_OFFSET(0x148A5960)
#define CLASS_1_04316EB8ECDF7B06_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x148A5840)
#define CLASS_1_04316EB8ECDF7B06_SET_KEYDOWNRESULT_OFFSET UNITYSDK_OFFSET(0x148A58A0)
#define CLASS_1_04316EB8ECDF7B06_SET_KEYUPRESULT_OFFSET UNITYSDK_OFFSET(0x148A58C0)
#define CLASS_1_04316EB8ECDF7B06_SET_NOTETYPE_OFFSET UNITYSDK_OFFSET(0x148A5940)
#define CLASS_1_04316EB8ECDF7B06_SET_OWNERGROUP_OFFSET UNITYSDK_OFFSET(0x148A58E0)
#define CLASS_1_04316EB8ECDF7B06_SET_PRESSTIME_OFFSET UNITYSDK_OFFSET(0x148A5980)
#define CLASS_1_04316EB8ECDF7B06_SET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x148A5900)
#define CLASS_1_04316EB8ECDF7B06__CTOR_OFFSET UNITYSDK_OFFSET(0x148A3330)
...
public:
	...
	::System::Single _EndTime_k__BackingField; // 0x64
	...
	::System::Boolean _HasKeyUp_k__BackingField; // 0x85
	::System::Boolean _HasKeyDown_k__BackingField; // 0x86
	::System::Boolean _IsActive_k__BackingField; // 0x87
