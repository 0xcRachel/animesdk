...
#define CLASS_3_432FCE410B4A2709_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10433F70)
#define CLASS_3_432FCE410B4A2709__CTOR_OFFSET UNITYSDK_OFFSET(0x10433F40)

inline static constexpr unsigned int Class_3_432FCE410B4A2709_TypeDefinitionIndex = 46400;
