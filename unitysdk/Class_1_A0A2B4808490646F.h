...
#define CLASS_1_A0A2B4808490646F_CLEAR_OFFSET UNITYSDK_OFFSET(0xA430B60)
#define CLASS_1_A0A2B4808490646F_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0xA430C60)
#define CLASS_1_A0A2B4808490646F_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xA430C80)
#define CLASS_1_A0A2B4808490646F_METHOD_1_A538D7DBA7BF5017_OFFSET UNITYSDK_OFFSET(0xA430BB0)
#define CLASS_1_A0A2B4808490646F_METHOD_1_F3B68CBB8AE22AB6_OFFSET UNITYSDK_OFFSET(0xA430AE0)
#define CLASS_1_A0A2B4808490646F_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0xA430C70)
#define CLASS_1_A0A2B4808490646F_SET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xA430C90)
#define CLASS_1_A0A2B4808490646F__CTOR_OFFSET UNITYSDK_OFFSET(0xA430CA0)
