...
#define CLASS_1_A0A2B4808490646F_CLEAR_OFFSET UNITYSDK_OFFSET(0xFEECA40)
#define CLASS_1_A0A2B4808490646F_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0xFEECB40)
#define CLASS_1_A0A2B4808490646F_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xFEECB60)
#define CLASS_1_A0A2B4808490646F_METHOD_1_A538D7DBA7BF5017_OFFSET UNITYSDK_OFFSET(0xFEECA90)
#define CLASS_1_A0A2B4808490646F_METHOD_1_F3B68CBB8AE22AB6_OFFSET UNITYSDK_OFFSET(0xFEEC9C0)
#define CLASS_1_A0A2B4808490646F_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0xFEECB50)
#define CLASS_1_A0A2B4808490646F_SET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xFEECB70)
#define CLASS_1_A0A2B4808490646F__CTOR_OFFSET UNITYSDK_OFFSET(0xFEECB80)

inline static constexpr unsigned int Class_1_A0A2B4808490646F_TypeDefinitionIndex = 44715;
