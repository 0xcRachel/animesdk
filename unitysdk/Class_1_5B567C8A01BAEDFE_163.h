...
#define CLASS_1_5B567C8A01BAEDFE_163_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A003800)
#define CLASS_1_5B567C8A01BAEDFE_163_CLONE_OFFSET UNITYSDK_OFFSET(0x1A003610)
#define CLASS_1_5B567C8A01BAEDFE_163_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A003710)
#define CLASS_1_5B567C8A01BAEDFE_163_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A003680)
#define CLASS_1_5B567C8A01BAEDFE_163_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A003760)
#define CLASS_1_5B567C8A01BAEDFE_163_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A003850)
#define CLASS_1_5B567C8A01BAEDFE_163_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A003820)
#define CLASS_1_5B567C8A01BAEDFE_163_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A003560)
#define CLASS_1_5B567C8A01BAEDFE_163_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A0035C0)
#define CLASS_1_5B567C8A01BAEDFE_163_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A003790)
#define CLASS_1_5B567C8A01BAEDFE_163_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A0037F0)
#define CLASS_1_5B567C8A01BAEDFE_163__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A0038A0)
#define CLASS_1_5B567C8A01BAEDFE_163__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0035E0)
#define CLASS_1_5B567C8A01BAEDFE_163__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0035D0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_163*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_163_TypeDefinitionIndex)->GetStaticField(0x3F800);
	}
