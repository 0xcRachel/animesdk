...
#define CLASS_1_EBB880A8D2C9B0D4_GET_REQUIRESUBMISSIONIDS_OFFSET UNITYSDK_OFFSET(0x113AE500)
#define CLASS_1_EBB880A8D2C9B0D4_GET_SUBNAVGRAPHINFO_OFFSET UNITYSDK_OFFSET(0x113AE4E0)
#define CLASS_1_EBB880A8D2C9B0D4_GET_SURFACELIST_OFFSET UNITYSDK_OFFSET(0x113AE4D0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_09A1BD26EB158047_OFFSET UNITYSDK_OFFSET(0x113A86A0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_0A33F6FE49CC944A_OFFSET UNITYSDK_OFFSET(0x113AD9A0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_243BEAA857EE5299_OFFSET UNITYSDK_OFFSET(0x113A7230)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_283DA224BE06DA9F_OFFSET UNITYSDK_OFFSET(0x113A56C0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_2D84C0C580E710CA_OFFSET UNITYSDK_OFFSET(0x113AE1A0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_316098F2824CF764_OFFSET UNITYSDK_OFFSET(0x113AD5C0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_3254D409AD76C2E2_OFFSET UNITYSDK_OFFSET(0x113AE010)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_3543E185ADE7267F_OFFSET UNITYSDK_OFFSET(0x113AD120)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_414C8F92528E4746_OFFSET UNITYSDK_OFFSET(0x113A5A80)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_489E0B827662C211_OFFSET UNITYSDK_OFFSET(0x113A9980)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_4DE65AB3A4860CEB_OFFSET UNITYSDK_OFFSET(0x113A6DE0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_4FD30F236AB3F0D4_OFFSET UNITYSDK_OFFSET(0x113A6710)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_525C11E1C03A03AA_OFFSET UNITYSDK_OFFSET(0x113A8940)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_5427D429B5D2766F_OFFSET UNITYSDK_OFFSET(0x113AE510)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_55F2BCAC640061D3_OFFSET UNITYSDK_OFFSET(0x113ACFE0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_5CD57035BDDE5369_OFFSET UNITYSDK_OFFSET(0x113ABE70)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_5F2528715070ADC0_OFFSET UNITYSDK_OFFSET(0x113A80F0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_602E1CCD3AA8E1F1_OFFSET UNITYSDK_OFFSET(0x113A7BD0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_626E1E7A59ADB775_OFFSET UNITYSDK_OFFSET(0x113AC9A0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_67D262B21B9B459D_OFFSET UNITYSDK_OFFSET(0x113A9300)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_7A097E7EF929F289_OFFSET UNITYSDK_OFFSET(0x113A6C20)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_7B02396350AF3AC1_OFFSET UNITYSDK_OFFSET(0x113A7AF0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_809094DEBF13B21A_OFFSET UNITYSDK_OFFSET(0x113A6510)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_81D122F3EBFE3B2D_OFFSET UNITYSDK_OFFSET(0x113ADEF0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_85B87F15DE7D9577_OFFSET UNITYSDK_OFFSET(0x113AC4E0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_8EB834389429CDAD_OFFSET UNITYSDK_OFFSET(0x113A8C30)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_94F202012C4866F0_OFFSET UNITYSDK_OFFSET(0x113A5430)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_956F8BBA61BA4CBA_OFFSET UNITYSDK_OFFSET(0x113AC1C0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_95FF180A965BC00B_OFFSET UNITYSDK_OFFSET(0x113ADB30)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_96087D675A0A6BF2_OFFSET UNITYSDK_OFFSET(0x113AE330)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_9B4043903C569F54_OFFSET UNITYSDK_OFFSET(0x113A7C40)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_9DF520971B8F09EA_OFFSET UNITYSDK_OFFSET(0x113AC0A0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_A9F21234A9F13159_OFFSET UNITYSDK_OFFSET(0x113AD220)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_AE80CBC984AADFD5_OFFSET UNITYSDK_OFFSET(0x113AA260)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_BBD36158AE50EC8B_OFFSET UNITYSDK_OFFSET(0x113A6FA0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_BF07FECBF7CF9E7C_1_OFFSET UNITYSDK_OFFSET(0x113A7F50)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_BF07FECBF7CF9E7C_OFFSET UNITYSDK_OFFSET(0x113A7DB0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_CA99028638214CFF_OFFSET UNITYSDK_OFFSET(0x113A7050)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_D29CB62E2602F1AC_OFFSET UNITYSDK_OFFSET(0x113A89F0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_D308836DB54415C3_OFFSET UNITYSDK_OFFSET(0x113A9490)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_D826D49B6EAB49B3_OFFSET UNITYSDK_OFFSET(0x113AD080)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_D978819B0A4871A0_OFFSET UNITYSDK_OFFSET(0x113AE4B0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_DA5C74D0B5008ECB_OFFSET UNITYSDK_OFFSET(0x113AC3F0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_DAECDCD3FF53DE14_OFFSET UNITYSDK_OFFSET(0x113AD840)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_DC76497A3CA272B5_OFFSET UNITYSDK_OFFSET(0x113A8320)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_E41A0A8438B1F519_OFFSET UNITYSDK_OFFSET(0x113AE520)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_E48192ED77C2189D_OFFSET UNITYSDK_OFFSET(0x113A7000)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_E643356DEDBA29E8_OFFSET UNITYSDK_OFFSET(0x113A8500)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_EF79C60756C35D5F_OFFSET UNITYSDK_OFFSET(0x113AA1A0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_F4AD6DE35B09EAA8_OFFSET UNITYSDK_OFFSET(0x113A71F0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_F7300E87EC49A206_OFFSET UNITYSDK_OFFSET(0x113A9140)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_F8C816D8A562BDA9_OFFSET UNITYSDK_OFFSET(0x113A8D10)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_F9C90F9ECA68885E_OFFSET UNITYSDK_OFFSET(0x113A5C60)
#define CLASS_1_EBB880A8D2C9B0D4_SET_SUBNAVGRAPHINFO_OFFSET UNITYSDK_OFFSET(0x113AE4F0)
#define CLASS_1_EBB880A8D2C9B0D4__CCTOR_OFFSET UNITYSDK_OFFSET(0x113AE770)
#define CLASS_1_EBB880A8D2C9B0D4__CTOR_OFFSET UNITYSDK_OFFSET(0x113AE530)
...
public:
	...
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_1_EBB880A8D2C9B0D4_TypeDefinitionIndex)->GetStaticField(0x8BC0);
	}
	::System::Collections::Generic::List_1<::System::UInt32>* Field_1_5; // 0x10
	::RPG::GameCore::LevelLittleGameInfo* Field_1_8; // 0x18
	::RPG::GameCore::RuntimeGroupInfo* Field_1_10; // 0x20
	::System::Collections::Generic::HashSet_1<::System::UInt32>* _RequireSubMissionIDs_k__BackingField; // 0x28
	::Class_1_2EAB25208BF9561B* _SubNavGraphInfo_k__BackingField; // 0x30
	...
	::System::Collections::Generic::List_1<::UnityEngine::Vector2>* Field_1_13; // 0x48
	...
	::RPG::GameCore::FiveDimLevelSettings* Field_1_7; // 0x70
