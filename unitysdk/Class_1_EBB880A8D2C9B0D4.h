...
#define CLASS_1_EBB880A8D2C9B0D4_GET_REQUIRESUBMISSIONIDS_OFFSET UNITYSDK_OFFSET(0xB543260)
#define CLASS_1_EBB880A8D2C9B0D4_GET_SUBNAVGRAPHINFO_OFFSET UNITYSDK_OFFSET(0xB543240)
#define CLASS_1_EBB880A8D2C9B0D4_GET_SURFACELIST_OFFSET UNITYSDK_OFFSET(0xB543230)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_09A1BD26EB158047_OFFSET UNITYSDK_OFFSET(0xB540530)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_0A33F6FE49CC944A_OFFSET UNITYSDK_OFFSET(0xB542700)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_243BEAA857EE5299_OFFSET UNITYSDK_OFFSET(0xB53F0C0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_283DA224BE06DA9F_OFFSET UNITYSDK_OFFSET(0xB53A460)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_2D84C0C580E710CA_OFFSET UNITYSDK_OFFSET(0xB542F00)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_316098F2824CF764_OFFSET UNITYSDK_OFFSET(0xB542320)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_3254D409AD76C2E2_OFFSET UNITYSDK_OFFSET(0xB542D70)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_37641CB56E59A096_OFFSET UNITYSDK_OFFSET(0xB540BA0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_414C8F92528E4746_OFFSET UNITYSDK_OFFSET(0xB53A820)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_489E0B827662C211_OFFSET UNITYSDK_OFFSET(0xB53C240)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_4DE65AB3A4860CEB_OFFSET UNITYSDK_OFFSET(0xB53CA60)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_4FD30F236AB3F0D4_OFFSET UNITYSDK_OFFSET(0xB53B4C0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_525C11E1C03A03AA_OFFSET UNITYSDK_OFFSET(0xB5407D0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_5427D429B5D2766F_OFFSET UNITYSDK_OFFSET(0xB543270)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_55F2BCAC640061D3_OFFSET UNITYSDK_OFFSET(0xB541E20)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_5CD57035BDDE5369_OFFSET UNITYSDK_OFFSET(0xB5412F0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_5F2528715070ADC0_OFFSET UNITYSDK_OFFSET(0xB53FF80)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_602E1CCD3AA8E1F1_OFFSET UNITYSDK_OFFSET(0xB53FA60)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_626E1E7A59ADB775_OFFSET UNITYSDK_OFFSET(0xB53E8A0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_67D262B21B9B459D_OFFSET UNITYSDK_OFFSET(0xB5410B0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_7A097E7EF929F289_OFFSET UNITYSDK_OFFSET(0xB53B9D0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_7B02396350AF3AC1_OFFSET UNITYSDK_OFFSET(0xB53F980)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_809094DEBF13B21A_OFFSET UNITYSDK_OFFSET(0xB53B2C0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_81D122F3EBFE3B2D_OFFSET UNITYSDK_OFFSET(0xB542C50)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_85B87F15DE7D9577_OFFSET UNITYSDK_OFFSET(0xB541960)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_8EB834389429CDAD_OFFSET UNITYSDK_OFFSET(0xB540AC0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_94F202012C4866F0_OFFSET UNITYSDK_OFFSET(0xB539F90)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_956F8BBA61BA4CBA_OFFSET UNITYSDK_OFFSET(0xB541640)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_95FF180A965BC00B_OFFSET UNITYSDK_OFFSET(0xB542890)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_96087D675A0A6BF2_OFFSET UNITYSDK_OFFSET(0xB543090)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_9B4043903C569F54_OFFSET UNITYSDK_OFFSET(0xB53FAD0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_9DF520971B8F09EA_OFFSET UNITYSDK_OFFSET(0xB541520)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_A9F21234A9F13159_OFFSET UNITYSDK_OFFSET(0xB541F80)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_AE80CBC984AADFD5_OFFSET UNITYSDK_OFFSET(0xB53CC80)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_BBD36158AE50EC8B_OFFSET UNITYSDK_OFFSET(0xB53CC20)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_BF07FECBF7CF9E7C_1_OFFSET UNITYSDK_OFFSET(0xB53FDE0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_BF07FECBF7CF9E7C_OFFSET UNITYSDK_OFFSET(0xB53FC40)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_CA99028638214CFF_OFFSET UNITYSDK_OFFSET(0xB53EEE0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_D29CB62E2602F1AC_OFFSET UNITYSDK_OFFSET(0xB540880)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_D308836DB54415C3_OFFSET UNITYSDK_OFFSET(0xB53BD50)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_D826D49B6EAB49B3_OFFSET UNITYSDK_OFFSET(0xB541ED0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_D978819B0A4871A0_OFFSET UNITYSDK_OFFSET(0xB543210)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_DA5C74D0B5008ECB_OFFSET UNITYSDK_OFFSET(0xB541870)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_DAECDCD3FF53DE14_OFFSET UNITYSDK_OFFSET(0xB5425A0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_DC76497A3CA272B5_OFFSET UNITYSDK_OFFSET(0xB5401B0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_E41A0A8438B1F519_OFFSET UNITYSDK_OFFSET(0xB543280)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_E48192ED77C2189D_OFFSET UNITYSDK_OFFSET(0xB53E850)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_E643356DEDBA29E8_OFFSET UNITYSDK_OFFSET(0xB540390)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_EF79C60756C35D5F_OFFSET UNITYSDK_OFFSET(0xB541230)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_F4AD6DE35B09EAA8_OFFSET UNITYSDK_OFFSET(0xB53F080)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_F7300E87EC49A206_OFFSET UNITYSDK_OFFSET(0xB53BB90)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_F8C816D8A562BDA9_OFFSET UNITYSDK_OFFSET(0xB540C80)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_F9C90F9ECA68885E_OFFSET UNITYSDK_OFFSET(0xB53AA00)
#define CLASS_1_EBB880A8D2C9B0D4_SET_SUBNAVGRAPHINFO_OFFSET UNITYSDK_OFFSET(0xB543250)
#define CLASS_1_EBB880A8D2C9B0D4__CCTOR_OFFSET UNITYSDK_OFFSET(0xB543290)
#define CLASS_1_EBB880A8D2C9B0D4__CTOR_OFFSET UNITYSDK_OFFSET(0xB53A220)
...
public:
	...
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_1_EBB880A8D2C9B0D4_TypeDefinitionIndex)->GetStaticField(0xEFF0);
	}
	::RPG::GameCore::FiveDimNavMapConfig* Field_1_12; // 0x10
	::RPG::GameCore::RuntimeGroupInfo* Field_1_10; // 0x18
	::System::Collections::Generic::HashSet_1<::System::UInt32>* _RequireSubMissionIDs_k__BackingField; // 0x20
	::System::Collections::Generic::List_1<::Class_1_99D526797741C2F2*>* _SurfaceList_k__BackingField; // 0x28
	::RPG::GameCore::FiveDimLevelSettings* Field_1_7; // 0x30
	::RPG::GameCore::LevelLittleGameInfo* Field_1_8; // 0x38
	::System::Collections::Generic::List_1<::UnityEngine::Vector2>* Field_1_13; // 0x40
	::System::Collections::Generic::List_1<::System::UInt32>* Field_1_5; // 0x48
	::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Int16>* Field_1_9; // 0x50
	::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>* Field_1_4; // 0x58
	::Class_1_2EAB25208BF9561B* _SubNavGraphInfo_k__BackingField; // 0x60
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_99D526797741C2F2*>* Field_1_3; // 0x68
	::RPG::GameCore::LittleGameLevelConfig* Field_1_6; // 0x70
