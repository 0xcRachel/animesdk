...
#define CLASS_1_EBB880A8D2C9B0D4_GET_REQUIRESUBMISSIONIDS_OFFSET UNITYSDK_OFFSET(0x154FD040)
#define CLASS_1_EBB880A8D2C9B0D4_GET_SUBNAVGRAPHINFO_OFFSET UNITYSDK_OFFSET(0x154FD020)
#define CLASS_1_EBB880A8D2C9B0D4_GET_SURFACELIST_OFFSET UNITYSDK_OFFSET(0x154FD010)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_029507C9854F63E7_OFFSET UNITYSDK_OFFSET(0x154F9390)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_09A1BD26EB158047_OFFSET UNITYSDK_OFFSET(0x154FA220)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_15ECFC1966D216D9_OFFSET UNITYSDK_OFFSET(0x154F8170)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_2566AD459572DFC3_OFFSET UNITYSDK_OFFSET(0x154F6160)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_2747314AC091C528_OFFSET UNITYSDK_OFFSET(0x154FC5E0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_28695814746C5E4E_OFFSET UNITYSDK_OFFSET(0x154FA9A0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_2930745D6F02D733_OFFSET UNITYSDK_OFFSET(0x154F9FB0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_297321ACFDDF5650_OFFSET UNITYSDK_OFFSET(0x154F8A70)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_2AA2AEA4ADAE7DAC_1_OFFSET UNITYSDK_OFFSET(0x154F95A0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_2AA2AEA4ADAE7DAC_OFFSET UNITYSDK_OFFSET(0x154F9400)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_35C22FC4636C6636_OFFSET UNITYSDK_OFFSET(0x154FB3A0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_37641CB56E59A096_OFFSET UNITYSDK_OFFSET(0x154FA8D0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_3BC8B8F2BB08C1C2_OFFSET UNITYSDK_OFFSET(0x154F5AA0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_3C713D5FB6FF9D5F_OFFSET UNITYSDK_OFFSET(0x154FC190)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_4147F14EBAE37DB9_OFFSET UNITYSDK_OFFSET(0x154F3E30)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_414C8F92528E4746_OFFSET UNITYSDK_OFFSET(0x154F46A0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_4FD30F236AB3F0D4_OFFSET UNITYSDK_OFFSET(0x154F53B0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_513B28E8F5D79998_OFFSET UNITYSDK_OFFSET(0x154F92E0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_525C11E1C03A03AA_OFFSET UNITYSDK_OFFSET(0x154FA4B0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_5427D429B5D2766F_OFFSET UNITYSDK_OFFSET(0x154FD050)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_55F2BCAC640061D3_OFFSET UNITYSDK_OFFSET(0x154FBC80)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_56E0415ED61DFBD8_OFFSET UNITYSDK_OFFSET(0x154F88C0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_5CDE1879A5E27BE2_OFFSET UNITYSDK_OFFSET(0x154FB6F0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_5F2528715070ADC0_OFFSET UNITYSDK_OFFSET(0x154F99E0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_809094DEBF13B21A_OFFSET UNITYSDK_OFFSET(0x154F5170)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_816DE7054F759A6D_OFFSET UNITYSDK_OFFSET(0x154FC3F0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_81D122F3EBFE3B2D_OFFSET UNITYSDK_OFFSET(0x154FCA40)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_89EF21CA0414B145_OFFSET UNITYSDK_OFFSET(0x154F42F0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_902E5094ED6E20A2_OFFSET UNITYSDK_OFFSET(0x154F4870)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_96087D675A0A6BF2_OFFSET UNITYSDK_OFFSET(0x154FCE70)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_AE80CBC984AADFD5_OFFSET UNITYSDK_OFFSET(0x154F6AE0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_B43C848B078B3C34_OFFSET UNITYSDK_OFFSET(0x154F58C0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_BB71BF1E162694DE_OFFSET UNITYSDK_OFFSET(0x154FB070)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_BBD36158AE50EC8B_OFFSET UNITYSDK_OFFSET(0x154F6A80)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_C2CB9E57ED704256_OFFSET UNITYSDK_OFFSET(0x154FA7A0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_C3A97DC040BD7DD3_OFFSET UNITYSDK_OFFSET(0x154FBDC0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_C3EAACDE46DF8E59_1_OFFSET UNITYSDK_OFFSET(0x154F9890)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_C3EAACDE46DF8E59_OFFSET UNITYSDK_OFFSET(0x154F9740)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_C6F6C6236F015996_OFFSET UNITYSDK_OFFSET(0x154FC730)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_CE76B71EB4CF1D47_OFFSET UNITYSDK_OFFSET(0x154F9DF0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_D29CB62E2602F1AC_OFFSET UNITYSDK_OFFSET(0x154FA560)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_D308836DB54415C3_OFFSET UNITYSDK_OFFSET(0x154F5C60)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_D826D49B6EAB49B3_OFFSET UNITYSDK_OFFSET(0x154FBD20)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_D978819B0A4871A0_OFFSET UNITYSDK_OFFSET(0x154FCFF0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_DA5C74D0B5008ECB_OFFSET UNITYSDK_OFFSET(0x154FB600)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_DC76497A3CA272B5_OFFSET UNITYSDK_OFFSET(0x154F9C10)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_DDC113A5E50536E5_OFFSET UNITYSDK_OFFSET(0x154FAE00)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_E043C8441683C3E5_OFFSET UNITYSDK_OFFSET(0x154FCCE0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_E05D8B64DF84735B_OFFSET UNITYSDK_OFFSET(0x154FB210)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_E41A0A8438B1F519_OFFSET UNITYSDK_OFFSET(0x154FD060)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_E4E4DA7D7BA3197D_OFFSET UNITYSDK_OFFSET(0x154FCB50)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_E824431C22EF9361_OFFSET UNITYSDK_OFFSET(0x154F68D0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_E837E0D7D3838D2B_OFFSET UNITYSDK_OFFSET(0x154F81C0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_EF79C60756C35D5F_OFFSET UNITYSDK_OFFSET(0x154FAFB0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_F4AD6DE35B09EAA8_OFFSET UNITYSDK_OFFSET(0x154F8A30)
#define CLASS_1_EBB880A8D2C9B0D4_SET_SUBNAVGRAPHINFO_OFFSET UNITYSDK_OFFSET(0x154FD030)
#define CLASS_1_EBB880A8D2C9B0D4__CCTOR_OFFSET UNITYSDK_OFFSET(0x154FD070)
#define CLASS_1_EBB880A8D2C9B0D4__CTOR_OFFSET UNITYSDK_OFFSET(0x154F40B0)
...
public:
	...
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_1_EBB880A8D2C9B0D4_TypeDefinitionIndex)->GetStaticField(0xC0B0);
	}
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_A1EDFD8801F68886*>* Field_1_1; // 0x10
	::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Int16>* Field_1_2; // 0x18
	...
	::RPG::GameCore::RuntimeGroupInfo* Field_1_7; // 0x40
	::RPG::GameCore::LittleGameLevelConfig* Field_1_8; // 0x48
	::System::Collections::Generic::List_1<::UnityEngine::Vector2>* Field_1_9; // 0x50
	...
	::RPG::GameCore::LevelLittleGameInfo* Field_1_13; // 0x70
