...
#define CLASS_1_5B567C8A01BAEDFE_318_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A0EFE60)
#define CLASS_1_5B567C8A01BAEDFE_318_CLONE_OFFSET UNITYSDK_OFFSET(0x1A0EFC70)
#define CLASS_1_5B567C8A01BAEDFE_318_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A0EFD70)
#define CLASS_1_5B567C8A01BAEDFE_318_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A0EFCE0)
#define CLASS_1_5B567C8A01BAEDFE_318_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A0EFDC0)
#define CLASS_1_5B567C8A01BAEDFE_318_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A0EFEB0)
#define CLASS_1_5B567C8A01BAEDFE_318_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A0EFE80)
#define CLASS_1_5B567C8A01BAEDFE_318_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A0EFBC0)
#define CLASS_1_5B567C8A01BAEDFE_318_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A0EFC20)
#define CLASS_1_5B567C8A01BAEDFE_318_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A0EFDF0)
#define CLASS_1_5B567C8A01BAEDFE_318_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A0EFE50)
#define CLASS_1_5B567C8A01BAEDFE_318__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A0EFF00)
#define CLASS_1_5B567C8A01BAEDFE_318__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0EFC40)
#define CLASS_1_5B567C8A01BAEDFE_318__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0EFC30)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_318*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_318_TypeDefinitionIndex)->GetStaticField(0x35BD0);
	}
