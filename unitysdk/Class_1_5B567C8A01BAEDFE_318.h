...
#define CLASS_1_5B567C8A01BAEDFE_318_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1B26AE40)
#define CLASS_1_5B567C8A01BAEDFE_318_CLONE_OFFSET UNITYSDK_OFFSET(0x1B26ACB0)
#define CLASS_1_5B567C8A01BAEDFE_318_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1B26AD50)
#define CLASS_1_5B567C8A01BAEDFE_318_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B26ACF0)
#define CLASS_1_5B567C8A01BAEDFE_318_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B26ADA0)
#define CLASS_1_5B567C8A01BAEDFE_318_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1B26AE90)
#define CLASS_1_5B567C8A01BAEDFE_318_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1B26AE60)
#define CLASS_1_5B567C8A01BAEDFE_318_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1B26AC30)
#define CLASS_1_5B567C8A01BAEDFE_318_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1B26AC60)
#define CLASS_1_5B567C8A01BAEDFE_318_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B26ADD0)
#define CLASS_1_5B567C8A01BAEDFE_318_WRITETO_OFFSET UNITYSDK_OFFSET(0x1B26AE30)
#define CLASS_1_5B567C8A01BAEDFE_318__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B26AEE0)
#define CLASS_1_5B567C8A01BAEDFE_318__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B26AC80)
#define CLASS_1_5B567C8A01BAEDFE_318__CTOR_OFFSET UNITYSDK_OFFSET(0x1B26AC70)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_318*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_318_TypeDefinitionIndex)->GetStaticField(0x6300);
	}
