...
#define CLASS_1_7A7E21E3A9C2156C_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1730C7D0)
#define CLASS_1_7A7E21E3A9C2156C_CLONE_OFFSET UNITYSDK_OFFSET(0x1730C470)
#define CLASS_1_7A7E21E3A9C2156C_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1730C600)
#define CLASS_1_7A7E21E3A9C2156C_EQUALS_OFFSET UNITYSDK_OFFSET(0x1730C550)
#define CLASS_1_7A7E21E3A9C2156C_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1730C670)
#define CLASS_1_7A7E21E3A9C2156C_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1730CA50)
#define CLASS_1_7A7E21E3A9C2156C_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1730CA00)
#define CLASS_1_7A7E21E3A9C2156C_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1730C530)
#define CLASS_1_7A7E21E3A9C2156C_METHOD_1_4C4B9DFE092840D4_1_OFFSET UNITYSDK_OFFSET(0x1730C520)
#define CLASS_1_7A7E21E3A9C2156C_METHOD_1_4C4B9DFE092840D4_OFFSET UNITYSDK_OFFSET(0x1730C500)
#define CLASS_1_7A7E21E3A9C2156C_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1730C540)
#define CLASS_1_7A7E21E3A9C2156C_METHOD_1_7ADD5F1F5E247E3B_1_OFFSET UNITYSDK_OFFSET(0x1730C510)
#define CLASS_1_7A7E21E3A9C2156C_METHOD_1_7ADD5F1F5E247E3B_OFFSET UNITYSDK_OFFSET(0x1730C4F0)
#define CLASS_1_7A7E21E3A9C2156C_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1730C410)
#define CLASS_1_7A7E21E3A9C2156C_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1730C6D0)
#define CLASS_1_7A7E21E3A9C2156C_WRITETO_OFFSET UNITYSDK_OFFSET(0x1730C730)
#define CLASS_1_7A7E21E3A9C2156C__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1730C430)
#define CLASS_1_7A7E21E3A9C2156C__CTOR_OFFSET UNITYSDK_OFFSET(0x1730C420)

inline static constexpr unsigned int Class_1_7A7E21E3A9C2156C_TypeDefinitionIndex = 22721;
