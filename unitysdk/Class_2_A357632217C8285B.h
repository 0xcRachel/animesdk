...
#define CLASS_2_A357632217C8285B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x153B1DA0)
#define CLASS_2_A357632217C8285B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x153B1DE0)
#define CLASS_2_A357632217C8285B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x153B1FA0)
#define CLASS_2_A357632217C8285B_TICK_OFFSET UNITYSDK_OFFSET(0x153B1FF0)
#define CLASS_2_A357632217C8285B__CTOR_OFFSET UNITYSDK_OFFSET(0x153B1D90)
