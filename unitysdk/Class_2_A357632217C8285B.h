...
#define CLASS_2_A357632217C8285B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10574AD0)
#define CLASS_2_A357632217C8285B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10574B10)
#define CLASS_2_A357632217C8285B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10574CC0)
#define CLASS_2_A357632217C8285B_TICK_OFFSET UNITYSDK_OFFSET(0x10574D10)
#define CLASS_2_A357632217C8285B__CTOR_OFFSET UNITYSDK_OFFSET(0x10574AC0)
