...
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_087FFA4E2EF101BB_OFFSET UNITYSDK_OFFSET(0xC5C2780)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_099B5F018AFCBEEB_OFFSET UNITYSDK_OFFSET(0xC5B50C0)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_0A37C445B2C9D335_OFFSET UNITYSDK_OFFSET(0xC5C00E0)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_0D13C86B964761EF_1_OFFSET UNITYSDK_OFFSET(0xC5C1B80)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_0D13C86B964761EF_OFFSET UNITYSDK_OFFSET(0xC5C1A80)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_0D959FF260B17021_OFFSET UNITYSDK_OFFSET(0xC5C3A60)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_18BDE1E9B35E197E_1_OFFSET UNITYSDK_OFFSET(0xC5C0CF0)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_18BDE1E9B35E197E_OFFSET UNITYSDK_OFFSET(0xC5C0250)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_2818B682042525E5_OFFSET UNITYSDK_OFFSET(0xC5C4320)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_285139CF2057D827_OFFSET UNITYSDK_OFFSET(0xC5B33C0)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_2C4CACFCB85F415D_OFFSET UNITYSDK_OFFSET(0xC5C3EE0)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_2FAA66412964EB29_OFFSET UNITYSDK_OFFSET(0xC5B3300)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_383D782CE381494B_OFFSET UNITYSDK_OFFSET(0xC5BE740)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_3BFFE341217F7AF3_OFFSET UNITYSDK_OFFSET(0xC5BE280)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_45A75B2F0BB0B141_OFFSET UNITYSDK_OFFSET(0xC5C2B50)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_49F0D97618C02893_OFFSET UNITYSDK_OFFSET(0xC5BF730)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_5455C42C8DC1139B_OFFSET UNITYSDK_OFFSET(0xC5BEA10)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_6133764619ACBC4F_OFFSET UNITYSDK_OFFSET(0xC5BE1F0)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_67D7A937E29DF16D_OFFSET UNITYSDK_OFFSET(0xC5BE0F0)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_6934B72928B52064_OFFSET UNITYSDK_OFFSET(0xC5BF9A0)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_6AFE210826458058_OFFSET UNITYSDK_OFFSET(0xC5C0650)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_73351D543AC31E3E_OFFSET UNITYSDK_OFFSET(0xC5BE3F0)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_758973C01527E3E1_OFFSET UNITYSDK_OFFSET(0xC5B3200)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_774A6D14EC723538_OFFSET UNITYSDK_OFFSET(0xC5BE330)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_77BF2B0088EAE91E_1_OFFSET UNITYSDK_OFFSET(0xC5C2490)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_77BF2B0088EAE91E_OFFSET UNITYSDK_OFFSET(0xC5B3360)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_7E9CB8126341F58E_OFFSET UNITYSDK_OFFSET(0xC5C1C80)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_8504B85E12A3EF82_OFFSET UNITYSDK_OFFSET(0xC5C2090)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_8A36779EBCCBE76B_OFFSET UNITYSDK_OFFSET(0xC5C40A0)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_90BFB6E215043556_OFFSET UNITYSDK_OFFSET(0xC5BEBB0)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_92619A5B9759D762_OFFSET UNITYSDK_OFFSET(0xC5C1E80)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_9AA4A9615DE62887_OFFSET UNITYSDK_OFFSET(0xC5BE5D0)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_9B00B5FC3ACDA9A3_OFFSET UNITYSDK_OFFSET(0xC5C2A10)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_9B743AF1DAFBABCC_OFFSET UNITYSDK_OFFSET(0xC5BE840)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_9E04F794F384F5D1_OFFSET UNITYSDK_OFFSET(0xC5C2120)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_ACE0DD830C752340_OFFSET UNITYSDK_OFFSET(0xC5C2690)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_AFBEA473EA40629E_OFFSET UNITYSDK_OFFSET(0xC5C07E0)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_B22D7820050876E3_OFFSET UNITYSDK_OFFSET(0xC5BE4B0)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_C8EA8053CB98B931_OFFSET UNITYSDK_OFFSET(0xC5C24F0)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_CE18697B63E52504_OFFSET UNITYSDK_OFFSET(0xC5C39C0)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_D26EAF38DD9B3015_OFFSET UNITYSDK_OFFSET(0xC5C25F0)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_D4A934B47A862E52_OFFSET UNITYSDK_OFFSET(0xC5BE680)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_EB754F983527AB71_OFFSET UNITYSDK_OFFSET(0xC5BDF90)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_F054547EE8FC0772_1_OFFSET UNITYSDK_OFFSET(0xC5C17B0)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_F054547EE8FC0772_OFFSET UNITYSDK_OFFSET(0xC5C14E0)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_F2AA42404B4DCA14_OFFSET UNITYSDK_OFFSET(0xC5C10F0)
#define CLASS_1_4C3EA8CBA8A5645C_METHOD_1_F2F0F4CC93A31EF9_OFFSET UNITYSDK_OFFSET(0xC5BFCF0)
#define CLASS_1_4C3EA8CBA8A5645C__CCTOR_OFFSET UNITYSDK_OFFSET(0xC5C43B0)
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_4C3EA8CBA8A5645C_TypeDefinitionIndex)->GetStaticField(0x8B80);
	}
	static ::Class_2_43D1AA62A6D00FFF** StaticGet_Field_1_11()
	{
		return (::Class_2_43D1AA62A6D00FFF**)Il2CppClass::FromTypeDefinitionIndex(Class_1_4C3EA8CBA8A5645C_TypeDefinitionIndex)->GetStaticField(0x8B88);
	}
	static ::RPG::Client::ElfRestaurantGameInstance** StaticGet_Field_1_10()
	{
		return (::RPG::Client::ElfRestaurantGameInstance**)Il2CppClass::FromTypeDefinitionIndex(Class_1_4C3EA8CBA8A5645C_TypeDefinitionIndex)->GetStaticField(0x8B90);
	}
	static ::System::String** StaticGet_Field_1_3()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_4C3EA8CBA8A5645C_TypeDefinitionIndex)->GetStaticField(0x8B98);
	}
	static ::System::String** StaticGet_Field_1_6()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_4C3EA8CBA8A5645C_TypeDefinitionIndex)->GetStaticField(0x8BA0);
	}
	static ::System::String** StaticGet_Field_1_5()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_4C3EA8CBA8A5645C_TypeDefinitionIndex)->GetStaticField(0x8BA8);
	}
	static ::System::String** StaticGet_Field_1_4()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_4C3EA8CBA8A5645C_TypeDefinitionIndex)->GetStaticField(0x8BB0);
	}
	static ::System::String** StaticGet_Field_1_1()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_4C3EA8CBA8A5645C_TypeDefinitionIndex)->GetStaticField(0x8BB8);
	}
	static ::System::String** StaticGet_Field_1_2()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_4C3EA8CBA8A5645C_TypeDefinitionIndex)->GetStaticField(0x8BC0);
	}
	static ::System::Boolean* StaticGet_Field_1_9()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_1_4C3EA8CBA8A5645C_TypeDefinitionIndex)->GetStaticField(0x3E90);
	}
	...
	static ::System::Void Method_1_2FAA66412964EB29(::RPG::Client::LittleGame::ElfRestaurant::ElfRestaurantEventParams* a1)
	{
		return ((::System::Void(*)(::RPG::Client::LittleGame::ElfRestaurant::ElfRestaurantEventParams*))((::PBYTE)hIl2Cpp + CLASS_1_4C3EA8CBA8A5645C_METHOD_1_2FAA66412964EB29_OFFSET))(a1);
	}
