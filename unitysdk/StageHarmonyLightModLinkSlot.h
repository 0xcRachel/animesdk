...
#define STAGEHARMONYLIGHTMODLINKSLOT_METHOD_2_4316FC6BDA5848E8_OFFSET UNITYSDK_OFFSET(0xA6A3580)
#define STAGEHARMONYLIGHTMODLINKSLOT_METHOD_2_4DA6D4A624E42CAB_OFFSET UNITYSDK_OFFSET(0xA6A35D0)
#define STAGEHARMONYLIGHTMODLINKSLOT_METHOD_2_8A260B95B64FA5E2_OFFSET UNITYSDK_OFFSET(0xA6A34D0)
#define STAGEHARMONYLIGHTMODLINKSLOT_METHOD_2_A5344E5AFEB20260_OFFSET UNITYSDK_OFFSET(0xA6A3690)
#define STAGEHARMONYLIGHTMODLINKSLOT_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA6A3650)
#define STAGEHARMONYLIGHTMODLINKSLOT__CTOR_OFFSET UNITYSDK_OFFSET(0xA6A36F0)

inline static constexpr unsigned int StageHarmonyLightModLinkSlot_TypeDefinitionIndex = 37436;
