...
#define CLASS_2_3C4B0FEB52CBED85_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10FAF080)
#define CLASS_2_3C4B0FEB52CBED85_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x10FAE9B0)
#define CLASS_2_3C4B0FEB52CBED85_ONFINISHIMMEDIATELYINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x10FAF1E0)
#define CLASS_2_3C4B0FEB52CBED85_ONSKIP_OFFSET UNITYSDK_OFFSET(0x10FAF190)
#define CLASS_2_3C4B0FEB52CBED85_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10FAE9D0)
#define CLASS_2_3C4B0FEB52CBED85_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10FAF0C0)
#define CLASS_2_3C4B0FEB52CBED85_TICK_OFFSET UNITYSDK_OFFSET(0x10FAF110)
#define CLASS_2_3C4B0FEB52CBED85__CTOR_OFFSET UNITYSDK_OFFSET(0x10FAE9C0)
...
public:
	...
	::RPG::GameCore::CharacterHeadLookAt* Field_2_1; // 0x28
