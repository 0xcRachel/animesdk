...
#define CLASS_2_3C4B0FEB52CBED85_DISPOSE_OFFSET UNITYSDK_OFFSET(0x860C2E0)
#define CLASS_2_3C4B0FEB52CBED85_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x860BC00)
#define CLASS_2_3C4B0FEB52CBED85_ONFINISHIMMEDIATELYINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x860C440)
#define CLASS_2_3C4B0FEB52CBED85_ONSKIP_OFFSET UNITYSDK_OFFSET(0x860C3F0)
#define CLASS_2_3C4B0FEB52CBED85_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x860BC20)
#define CLASS_2_3C4B0FEB52CBED85_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x860C320)
#define CLASS_2_3C4B0FEB52CBED85_TICK_OFFSET UNITYSDK_OFFSET(0x860C370)
#define CLASS_2_3C4B0FEB52CBED85__CTOR_OFFSET UNITYSDK_OFFSET(0x860BC10)

inline static constexpr unsigned int Class_2_3C4B0FEB52CBED85_TypeDefinitionIndex = 45711;
