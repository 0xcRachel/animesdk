...
#define CLASS_2_6A1A3FF7CC972356_DISPOSE_OFFSET UNITYSDK_OFFSET(0x86D6F30)
#define CLASS_2_6A1A3FF7CC972356_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x86D6F70)
#define CLASS_2_6A1A3FF7CC972356_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x86D7180)
#define CLASS_2_6A1A3FF7CC972356_TICK_OFFSET UNITYSDK_OFFSET(0x86D71D0)
#define CLASS_2_6A1A3FF7CC972356__CTOR_OFFSET UNITYSDK_OFFSET(0x86D6F00)

inline static constexpr unsigned int Class_2_6A1A3FF7CC972356_TypeDefinitionIndex = 42845;
