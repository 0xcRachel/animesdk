...
#define CLASS_3_3EED698C7D00D221_METHOD_3_620F752B8758282A_OFFSET UNITYSDK_OFFSET(0x176D7980)
#define CLASS_3_3EED698C7D00D221_METHOD_3_E024E0080A08A9C9_OFFSET UNITYSDK_OFFSET(0x176D7A10)
#define CLASS_3_3EED698C7D00D221__CTOR_OFFSET UNITYSDK_OFFSET(0x176D79E0)

inline static constexpr unsigned int Class_3_3EED698C7D00D221_TypeDefinitionIndex = 21783;

class Class_3_3EED698C7D00D221 : public ::RPG::GameCore::TaskConfig
{
public:
	::RPG::GameCore::DynamicFloat* Field_3_5; // 0x18
	::Class_2_720948D49026633D* Field_3_8; // 0x20
	::System::String* Field_3_10; // 0x28
	::RPG::GameCore::DynamicFloat* Field_3_11; // 0x30
	::RPG::GameCore::DynamicFloat* Field_3_3; // 0x38
	::RPG::GameCore::DynamicFloat* Field_3_2; // 0x40
	::RPG::GameCore::DynamicFloat* Field_3_4; // 0x48
	::RPG::GameCore::DynamicFloat* Field_3_6; // 0x50
