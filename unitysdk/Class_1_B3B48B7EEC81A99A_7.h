...
#define CLASS_1_B3B48B7EEC81A99A_7_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x178C1C80)
#define CLASS_1_B3B48B7EEC81A99A_7_CLONE_OFFSET UNITYSDK_OFFSET(0x178C1810)
#define CLASS_1_B3B48B7EEC81A99A_7_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x178C18B0)
#define CLASS_1_B3B48B7EEC81A99A_7_EQUALS_OFFSET UNITYSDK_OFFSET(0x178C1880)
#define CLASS_1_B3B48B7EEC81A99A_7_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x178C1970)
#define CLASS_1_B3B48B7EEC81A99A_7_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x178C1E00)
#define CLASS_1_B3B48B7EEC81A99A_7_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x178C1D90)
#define CLASS_1_B3B48B7EEC81A99A_7_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x178C1840)
#define CLASS_1_B3B48B7EEC81A99A_7_METHOD_1_554199E0076172C5_1_OFFSET UNITYSDK_OFFSET(0x178C1870)
#define CLASS_1_B3B48B7EEC81A99A_7_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x178C1860)
#define CLASS_1_B3B48B7EEC81A99A_7_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x178C1850)
#define CLASS_1_B3B48B7EEC81A99A_7_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x178C1680)
#define CLASS_1_B3B48B7EEC81A99A_7_TOSTRING_OFFSET UNITYSDK_OFFSET(0x178C1B50)
#define CLASS_1_B3B48B7EEC81A99A_7_WRITETO_OFFSET UNITYSDK_OFFSET(0x178C1BB0)
#define CLASS_1_B3B48B7EEC81A99A_7__CCTOR_OFFSET UNITYSDK_OFFSET(0x178C1F10)
#define CLASS_1_B3B48B7EEC81A99A_7__CTOR_1_OFFSET UNITYSDK_OFFSET(0x178C1720)
#define CLASS_1_B3B48B7EEC81A99A_7__CTOR_OFFSET UNITYSDK_OFFSET(0x178C1690)

inline static constexpr unsigned int Class_1_B3B48B7EEC81A99A_7_TypeDefinitionIndex = 25658;
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B3B48B7EEC81A99A_7_TypeDefinitionIndex)->GetStaticField(0x341D0);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_4()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B3B48B7EEC81A99A_7_TypeDefinitionIndex)->GetStaticField(0x341D8);
	}
