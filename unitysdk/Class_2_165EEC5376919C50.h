...
#define CLASS_2_165EEC5376919C50_DISPOSE_OFFSET UNITYSDK_OFFSET(0x97A22E0)
#define CLASS_2_165EEC5376919C50_METHOD_2_1F130271093617A5_OFFSET UNITYSDK_OFFSET(0x97A2C90)
#define CLASS_2_165EEC5376919C50_METHOD_2_AB88190D695EBEA9_OFFSET UNITYSDK_OFFSET(0x97A25F0)
#define CLASS_2_165EEC5376919C50_METHOD_2_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0x97A2A50)
#define CLASS_2_165EEC5376919C50_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x97A2330)
#define CLASS_2_165EEC5376919C50_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x97A2B90)
#define CLASS_2_165EEC5376919C50_TICK_OFFSET UNITYSDK_OFFSET(0x97A2C00)
#define CLASS_2_165EEC5376919C50__CCTOR_OFFSET UNITYSDK_OFFSET(0x97A2F00)
#define CLASS_2_165EEC5376919C50__CTOR_OFFSET UNITYSDK_OFFSET(0x97A22D0)
...
public:
	...
	{
		return (::Class_1_08ACCB48C394B420**)Il2CppClass::FromTypeDefinitionIndex(Class_2_165EEC5376919C50_TypeDefinitionIndex)->GetStaticField(0x33F60);
	}
	// static const ::System::Single Field_2_9; // 0x0
	::Class_3_1A92845FAFA5EC77* Field_2_4; // 0x18
	::RPG::Client::FiveDimGameInstance* Field_2_3; // 0x20
	::Il2CppArray<::Struct_2_16A256D5A30981C7>* Field_2_8; // 0x28
	::RPG::Client::FiveDimTrainModeDisplayInfos* Field_2_11; // 0x30
	::Class_3_F9B1A966737DB03F* Field_2_2; // 0x38
