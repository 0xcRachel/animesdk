...
#define CLASS_2_8C456C3AA7689A49_DISPOSE_OFFSET UNITYSDK_OFFSET(0xDEB4B50)
#define CLASS_2_8C456C3AA7689A49_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xDEB4C00)
#define CLASS_2_8C456C3AA7689A49_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xDEB4D70)
#define CLASS_2_8C456C3AA7689A49_TICK_OFFSET UNITYSDK_OFFSET(0xDEB4BA0)
#define CLASS_2_8C456C3AA7689A49__CTOR_OFFSET UNITYSDK_OFFSET(0xDEB4B40)

inline static constexpr unsigned int Class_2_8C456C3AA7689A49_TypeDefinitionIndex = 41578;

class Class_2_8C456C3AA7689A49 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::CaptureCurrentInteractProp* Field_2_0; // 0x18
