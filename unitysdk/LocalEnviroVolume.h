...
#define LOCALENVIROVOLUME_AWAKE_OFFSET UNITYSDK_OFFSET(0x110142F0)
#define LOCALENVIROVOLUME_METHOD_5_735EE20B25F86BF4_OFFSET UNITYSDK_OFFSET(0x110143D0)
#define LOCALENVIROVOLUME_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x11014C80)
#define LOCALENVIROVOLUME_ONENABLE_OFFSET UNITYSDK_OFFSET(0x11014C00)
#define LOCALENVIROVOLUME_ONLIGHTWEIGHTACTIVATE_OFFSET UNITYSDK_OFFSET(0x11014D00)
#define LOCALENVIROVOLUME_ONLIGHTWEIGHTDEACTIVATE_OFFSET UNITYSDK_OFFSET(0x11014DA0)
#define LOCALENVIROVOLUME_START_OFFSET UNITYSDK_OFFSET(0x11014350)
#define LOCALENVIROVOLUME_UPDATE_OFFSET UNITYSDK_OFFSET(0x11014E30)
#define LOCALENVIROVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x11014FF0)

inline static constexpr unsigned int LocalEnviroVolume_TypeDefinitionIndex = 37368;
...
public:
	...
	{
		return (::UnityEngine::Rendering::ShaderKeyword*)Il2CppClass::FromTypeDefinitionIndex(LocalEnviroVolume_TypeDefinitionIndex)->GetStaticField(0xE930);
	}
	static ::System::Int32* StaticGet_Field_5_23()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LocalEnviroVolume_TypeDefinitionIndex)->GetStaticField(0xE934);
	}
