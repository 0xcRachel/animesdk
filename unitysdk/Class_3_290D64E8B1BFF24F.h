...
#define CLASS_3_290D64E8B1BFF24F_GET_ALLTABVIEWMODELS_OFFSET UNITYSDK_OFFSET(0xE117FC0)
#define CLASS_3_290D64E8B1BFF24F_GET_ONBTNSELECTLEFT_OFFSET UNITYSDK_OFFSET(0xE118020)
#define CLASS_3_290D64E8B1BFF24F_GET_ONBTNSELECTRIGHT_OFFSET UNITYSDK_OFFSET(0xE118040)
#define CLASS_3_290D64E8B1BFF24F_GET_ONBTNSUBMIT_OFFSET UNITYSDK_OFFSET(0xE118000)
#define CLASS_3_290D64E8B1BFF24F_GET_ONBTNTABCLICK_OFFSET UNITYSDK_OFFSET(0xE117FE0)
#define CLASS_3_290D64E8B1BFF24F_GET_SHOWISSUESUBMITWINDOW_OFFSET UNITYSDK_OFFSET(0xE118060)
#define CLASS_3_290D64E8B1BFF24F_GET_SURVEYTYPEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xE118080)
#define CLASS_3_290D64E8B1BFF24F_METHOD_3_078D85152011B919_OFFSET UNITYSDK_OFFSET(0xE117BE0)
#define CLASS_3_290D64E8B1BFF24F_METHOD_3_07C90678D45BAD7B_OFFSET UNITYSDK_OFFSET(0xE117EA0)
#define CLASS_3_290D64E8B1BFF24F_METHOD_3_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0xE1180A0)
#define CLASS_3_290D64E8B1BFF24F_METHOD_3_8A7DA65CB9DF4CEB_OFFSET UNITYSDK_OFFSET(0xE1179E0)
#define CLASS_3_290D64E8B1BFF24F_METHOD_3_A76A07E68FFF9CDC_OFFSET UNITYSDK_OFFSET(0xE117F60)
#define CLASS_3_290D64E8B1BFF24F_METHOD_3_BF58BAE678CCAF91_OFFSET UNITYSDK_OFFSET(0xE117D30)
#define CLASS_3_290D64E8B1BFF24F_METHOD_3_C981714813BD5547_OFFSET UNITYSDK_OFFSET(0xE117C50)
#define CLASS_3_290D64E8B1BFF24F_METHOD_3_CB1D11B974BF8E9A_OFFSET UNITYSDK_OFFSET(0xE117CC0)
#define CLASS_3_290D64E8B1BFF24F_METHOD_3_D366BD72C4282426_OFFSET UNITYSDK_OFFSET(0xE117850)
#define CLASS_3_290D64E8B1BFF24F_METHOD_3_DFCFDE5A7E6EE4D0_OFFSET UNITYSDK_OFFSET(0xE117B40)
#define CLASS_3_290D64E8B1BFF24F_METHOD_3_F8974D388F52CD5E_OFFSET UNITYSDK_OFFSET(0xE117A80)
#define CLASS_3_290D64E8B1BFF24F_SET_ALLTABVIEWMODELS_OFFSET UNITYSDK_OFFSET(0xE117FD0)
#define CLASS_3_290D64E8B1BFF24F_SET_ONBTNSELECTLEFT_OFFSET UNITYSDK_OFFSET(0xE118030)
#define CLASS_3_290D64E8B1BFF24F_SET_ONBTNSELECTRIGHT_OFFSET UNITYSDK_OFFSET(0xE118050)
#define CLASS_3_290D64E8B1BFF24F_SET_ONBTNSUBMIT_OFFSET UNITYSDK_OFFSET(0xE118010)
#define CLASS_3_290D64E8B1BFF24F_SET_ONBTNTABCLICK_OFFSET UNITYSDK_OFFSET(0xE117FF0)
#define CLASS_3_290D64E8B1BFF24F_SET_SHOWISSUESUBMITWINDOW_OFFSET UNITYSDK_OFFSET(0xE118070)
#define CLASS_3_290D64E8B1BFF24F_SET_SURVEYTYPEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xE118090)
#define CLASS_3_290D64E8B1BFF24F__CTOR_OFFSET UNITYSDK_OFFSET(0xE1174E0)

inline static constexpr unsigned int Class_3_290D64E8B1BFF24F_TypeDefinitionIndex = 68409;

class Class_3_290D64E8B1BFF24F : public ::Class_2_E77EE8BE0A609DD9
{
public:
	::RPG::Client::MVVM::Model::LimaoNewsOfficeSurveyTypeData* _SurveyTypeViewModel_k__BackingField; // 0x20
	::RPG::Client::MVVM::Service::LimaoNewsIssueService* Field_3_10; // 0x28
	::RPG::Client::MVVM::Service::LimaoNewsWindowService* Field_3_11; // 0x30
	::RPG::Client::MVVM::Service::LimaoNewsNetworkService* Field_3_9; // 0x38
	::Class_1_ADBE1843AD1E672A* _OnBtnSubmit_k__BackingField; // 0x40
	::Class_1_ADBE1843AD1E672A* _OnBtnSelectRight_k__BackingField; // 0x48
	::Class_1_029A7EDCBF9933C8* Field_3_12; // 0x50
	::Class_1_ADBE1843AD1E672A* _OnBtnSelectLeft_k__BackingField; // 0x58
	::Class_1_ADBE1843AD1E672A* _ShowIssueSubmitWindow_k__BackingField; // 0x60
	::Class_1_BF01A723AB4005C0<::System::Int32>* _OnBtnTabClick_k__BackingField; // 0x68
	::System::Collections::Generic::List_1<::RPG::Client::MVVM::Model::LimaoNewsIssueData*>* Field_3_8; // 0x70
	::System::Collections::Generic::List_1<::Class_3_72B51E713EDE563F*>* _AllTabViewModels_k__BackingField; // 0x78
	...
	::Class_3_6CDB80D69CE03A28* Method_3_D366BD72C4282426(::System::Int32 a1)
	{
		return ((::Class_3_6CDB80D69CE03A28*(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + CLASS_3_290D64E8B1BFF24F_METHOD_3_D366BD72C4282426_OFFSET))(this, a1);
	}
