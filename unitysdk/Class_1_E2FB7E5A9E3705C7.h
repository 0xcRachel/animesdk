...
#define CLASS_1_E2FB7E5A9E3705C7_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x164A8180)
#define CLASS_1_E2FB7E5A9E3705C7_GET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0x164A8140)
#define CLASS_1_E2FB7E5A9E3705C7_GET_TEXTID_OFFSET UNITYSDK_OFFSET(0x164A8160)
#define CLASS_1_E2FB7E5A9E3705C7_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x164A8190)
#define CLASS_1_E2FB7E5A9E3705C7_SET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0x164A8150)
#define CLASS_1_E2FB7E5A9E3705C7_SET_TEXTID_OFFSET UNITYSDK_OFFSET(0x164A8170)
#define CLASS_1_E2FB7E5A9E3705C7__CTOR_OFFSET UNITYSDK_OFFSET(0x164A81A0)
