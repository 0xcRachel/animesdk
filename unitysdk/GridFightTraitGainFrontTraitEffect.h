...
#define GRIDFIGHTTRAITGAINFRONTTRAITEFFECT_GETFRONTTRAITS_OFFSET UNITYSDK_OFFSET(0xED556B0)
#define GRIDFIGHTTRAITGAINFRONTTRAITEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xED556A0)
#define GRIDFIGHTTRAITGAINFRONTTRAITEFFECT__GETFRONTTRAITS_B__1_0_OFFSET UNITYSDK_OFFSET(0xED559A0)
