...
#define CLASS_1_34DCA844BEF5C0C7_EXECUTE_OFFSET UNITYSDK_OFFSET(0x14365480)
#define CLASS_1_34DCA844BEF5C0C7_TICK_OFFSET UNITYSDK_OFFSET(0x14365500)
#define CLASS_1_34DCA844BEF5C0C7__CTOR_OFFSET UNITYSDK_OFFSET(0x14365470)

inline static constexpr unsigned int Class_1_34DCA844BEF5C0C7_TypeDefinitionIndex = 72864;
