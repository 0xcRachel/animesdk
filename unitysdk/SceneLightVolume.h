...
#define SCENELIGHTVOLUME_AWAKE_OFFSET UNITYSDK_OFFSET(0x16E1E670)
#define SCENELIGHTVOLUME_GETLIGHTMODE_OFFSET UNITYSDK_OFFSET(0x16E1F0B0)
#define SCENELIGHTVOLUME_GET_GAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x16E1E660)
#define SCENELIGHTVOLUME_INVOLUME_OFFSET UNITYSDK_OFFSET(0x16E1EFB0)
#define SCENELIGHTVOLUME_ISALLHIDEOBJECTS_OFFSET UNITYSDK_OFFSET(0x16E1EAC0)
#define SCENELIGHTVOLUME_ISHIDEOBJECTS_OFFSET UNITYSDK_OFFSET(0x16E1E9D0)
#define SCENELIGHTVOLUME_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x16E1ED30)
#define SCENELIGHTVOLUME_ONENABLE_OFFSET UNITYSDK_OFFSET(0x16E1ECB0)
#define SCENELIGHTVOLUME_ONMAPROTATED_OFFSET UNITYSDK_OFFSET(0x16E1EDB0)
#define SCENELIGHTVOLUME_ONRESET_OFFSET UNITYSDK_OFFSET(0x16E1EBA0)
#define SCENELIGHTVOLUME_REGENINDEXER_OFFSET UNITYSDK_OFFSET(0x16E1E770)
#define SCENELIGHTVOLUME_SETBLOCKS_OFFSET UNITYSDK_OFFSET(0x16E1F190)
#define SCENELIGHTVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x16E1F4A0)
