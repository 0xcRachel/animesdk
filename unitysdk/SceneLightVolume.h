...
#define SCENELIGHTVOLUME_AWAKE_OFFSET UNITYSDK_OFFSET(0xA681B80)
#define SCENELIGHTVOLUME_GETLIGHTMODE_OFFSET UNITYSDK_OFFSET(0xA6821B0)
#define SCENELIGHTVOLUME_GET_GAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xA681B70)
#define SCENELIGHTVOLUME_INVOLUME_OFFSET UNITYSDK_OFFSET(0xA6820B0)
#define SCENELIGHTVOLUME_ISALLHIDEOBJECTS_OFFSET UNITYSDK_OFFSET(0xA681FD0)
#define SCENELIGHTVOLUME_ISHIDEOBJECTS_OFFSET UNITYSDK_OFFSET(0xA681EE0)
#define SCENELIGHTVOLUME_REGENINDEXER_OFFSET UNITYSDK_OFFSET(0xA681C80)
#define SCENELIGHTVOLUME_SETBLOCKS_OFFSET UNITYSDK_OFFSET(0xA682290)
#define SCENELIGHTVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0xA6825A0)

inline static constexpr unsigned int SceneLightVolume_TypeDefinitionIndex = 37297;
