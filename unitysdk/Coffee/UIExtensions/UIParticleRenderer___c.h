...
#define COFFEE_UIEXTENSIONS_UIPARTICLERENDERER___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A5FCD20)
#define COFFEE_UIEXTENSIONS_UIPARTICLERENDERER___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5FCD50)
#define COFFEE_UIEXTENSIONS_UIPARTICLERENDERER___C__GETMODIFIEDMATERIAL_B__32_0_OFFSET UNITYSDK_OFFSET(0x1A5FCD60)
