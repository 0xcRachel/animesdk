...
#define COFFEE_UIEXTENSIONS_UIPARTICLERENDERER___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B422330)
#define COFFEE_UIEXTENSIONS_UIPARTICLERENDERER___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1B422360)
#define COFFEE_UIEXTENSIONS_UIPARTICLERENDERER___C__GETMODIFIEDMATERIAL_B__32_0_OFFSET UNITYSDK_OFFSET(0x1B422370)
