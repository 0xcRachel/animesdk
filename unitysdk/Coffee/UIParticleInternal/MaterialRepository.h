...
#define COFFEE_UIPARTICLEINTERNAL_MATERIALREPOSITORY_GET_1_OFFSET UNITYSDK_OFFSET(0x1127E1A0)
#define COFFEE_UIPARTICLEINTERNAL_MATERIALREPOSITORY_GET_2_OFFSET UNITYSDK_OFFSET(0x1127E320)
#define COFFEE_UIPARTICLEINTERNAL_MATERIALREPOSITORY_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1127E040)
#define COFFEE_UIPARTICLEINTERNAL_MATERIALREPOSITORY_GET_OFFSET UNITYSDK_OFFSET(0x1127E0F0)
#define COFFEE_UIPARTICLEINTERNAL_MATERIALREPOSITORY_RELEASE_OFFSET UNITYSDK_OFFSET(0x11279160)
#define COFFEE_UIPARTICLEINTERNAL_MATERIALREPOSITORY_VALID_OFFSET UNITYSDK_OFFSET(0x112799B0)
#define COFFEE_UIPARTICLEINTERNAL_MATERIALREPOSITORY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1127E4B0)

namespace Coffee::UIParticleInternal
{
	inline static constexpr unsigned int MaterialRepository_TypeDefinitionIndex = 33881;
	...
	public:
		...
		{
			return (::Coffee::UIParticleInternal::ObjectRepository_1<::UnityEngine::Material*>**)Il2CppClass::FromTypeDefinitionIndex(MaterialRepository_TypeDefinitionIndex)->GetStaticField(0x3150);
		}
