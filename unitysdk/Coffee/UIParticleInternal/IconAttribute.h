...
#define COFFEE_UIPARTICLEINTERNAL_ICONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1127DF30)

namespace Coffee::UIParticleInternal
{
	inline static constexpr unsigned int IconAttribute_TypeDefinitionIndex = 33884;
