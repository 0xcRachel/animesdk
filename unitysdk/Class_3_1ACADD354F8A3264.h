...
#define CLASS_3_1ACADD354F8A3264_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1268BFB0)
#define CLASS_3_1ACADD354F8A3264__CTOR_OFFSET UNITYSDK_OFFSET(0x1268BE20)
#define CLASS_3_1ACADD354F8A3264___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1268C030)

inline static constexpr unsigned int Class_3_1ACADD354F8A3264_TypeDefinitionIndex = 69696;

class Class_3_1ACADD354F8A3264 : public ::RPG::Client::LittleGame::Services_1<::Class_2_7AF1D57CA4301272*>
{
public:
	::Class_1_819B021DF635F679* Field_3_2; // 0x90
	::Class_1_3B1EA953A4067E26_1* Field_3_0; // 0x98
	::Class_1_07F3159234271541* Field_3_3; // 0xA0
